...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("9805bddf-df4c-4745-bf70-517e33187ff5")]
        ...
        l_0x6157:
            ...
            ii(0x6175, 2);    if(jaw(0x617a, 0x3)) goto l_0x617a;       /* ja 0x692a */
        ...
        l_0x617a:
            ...
            ii(0x6198, 2);    jmpw(0x619e, 0x4); goto l_0x619e;         /* jmp 0x694e */
        l_0x619a:
            ii(0x619a, 4);    add(edi, 0x4);                            /* add edi, 0x4 */
        l_0x619e:
            ii(0x619e, 3);    cmp(edi, ecx);                            /* cmp edi, ecx */
            ii(0x61a1, 2);    if(jaew(0x61be, 0x1b)) goto l_0x61be;     /* jae 0x696e */
            ii(0x61a3, 5);    mov(edx, memd_a32[es, edi]);              /* mov edx, [es:edi] */
            ii(0x61a8, 3);    test(dh, 0x4);                            /* test dh, 0x4 */
            ii(0x61ab, 2);    if(jnzw(0x619a, -0x13)) goto l_0x619a;    /* jnz 0x694a */
            ...
            ii(0x61b7, 2);    if(jnzw(0x619a, -0x1f)) goto l_0x619a;    /* jnz 0x694a */
            ii(0x61b9, 3);    callw(0x6101, -0xbb);                     /* call 0x68b1 */
            ii(0x61bc, 2);    jmpw(0x619e, -0x20); goto l_0x619e;       /* jmp 0x694e */
        l_0x61be:
            ii(0x61be, 5);    test(memb_a16[ds, 0x47], 0x80);           /* test byte [0x47], 0x80 */
            ii(0x61c3, 2);    if(jzw(0x61ca, 0x5)) goto l_0x61ca;       /* jz 0x697a */
        ...
        l_0x61ca:
            ...
            ii(0x61d3, 2);    if(jzw(0x61db, 0x6)) goto l_0x61db;       /* jz 0x698b */
