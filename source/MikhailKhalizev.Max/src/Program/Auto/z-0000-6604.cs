...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("0x6604-531dcba8")]
        public void Method_0000_6604()
        {
            ii(0x6604, 1);    push(ax);                                 /* push ax */
            ii(0x6605, 1);    push(bx);                                 /* push bx */
            ii(0x6606, 4);    mov(bx, memw[ds, 0x9b4]);                 /* mov bx, [0x9b4] */
            ii(0x660a, 1);    cli();                                    /* cli */
        ...
        l_0x661c:
            ...
            ii(0x6640, 5);    mov(memb[ds, 0xdfe], 1);                  /* mov byte [0xdfe], 0x1 */
