...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x19_1c53, 4); enter(0x6, 0);                            /* enter 0x6, 0x0 */
        ...
        l_0x19_1c7b:
            ...
            ii(0x19_1c86, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ...
            ii(0x19_1c91, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
        ...
        l_0x19_1ca4:
            ii(0x19_1ca4, 5); mov(memw[ss, bp - 0x6], 0xffff);          /* mov word [bp-0x6], 0xffff */
        l_0x19_1ca9:
            ii(0x19_1ca9, 3); mov(bx, memw[ss, bp - 0x6]);              /* mov bx, [bp-0x6] */
            ii(0x19_1cac, 2); shl(bx, 0x1);                             /* shl bx, 1 */
            ii(0x19_1cae, 6); mov(memw[ds, bx + 0x3a3a], 0);            /* mov word [bx+0x3a3a], 0x0 */
            ii(0x19_1cb4, 3); inc(memw[ss, bp - 0x6]);                  /* inc word [bp-0x6] */
            ii(0x19_1cb7, 4); cmp(memw[ss, bp - 0x6], 0x3);             /* cmp word [bp-0x6], 0x3 */
            ii(0x19_1cbb, 2); if(jle(0x19_1ca9, -0x14)) goto l_0x19_1ca9; /* jle 0x1ca9 */
            ii(0x19_1cbd, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x19_1cc0, 3); mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ...
            ii(0x19_1cd0, 3); retf(0x4);                                /* retf 0x4 */
        }
    }
}
