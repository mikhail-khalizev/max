...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_033a()
        {
            ...
            ii(0x19_0345, 4);  mov(ecx, memd[ds, si + 58]);            /* mov ecx, [si+0x3a] */
            ...
            ii(0x19_037a, 3);  push(memw[ds, si + 10]);                /* push word [si+0xa] */
            ii(0x19_037d, 2);  pop(gs);                                /* pop gs */
            ii(0x19_037f, 4);  mov(eax, memd[ds, si + 40]);            /* mov eax, [si+0x28] */
            ii(0x19_0383, 4);  mov(ebx, memd[ds, si + 28]);            /* mov ebx, [si+0x1c] */
            ii(0x19_0387, 4);  mov(ecx, memd[ds, si + 36]);            /* mov ecx, [si+0x24] */
            ii(0x19_038b, 4);  mov(edx, memd[ds, si + 32]);            /* mov edx, [si+0x20] */
            ii(0x19_038f, 4);  mov(ebp, memd[ds, si + 20]);            /* mov ebp, [si+0x14] */
            ii(0x19_0393, 4);  mov(edi, memd[ds, si + 12]);            /* mov edi, [si+0xc] */
            ii(0x19_0397, 4);  mov(esi, memd[ds, si + 16]);            /* mov esi, [si+0x10] */
