...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_5150()
        {
            ...
            ii(0x1010_5168, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
        l_0x1010_516b:
            ii(0x1010_516b, 5); mov(eax, 0x1388);                       /* mov eax, 0x1388 */
            ii(0x1010_5170, 5); call(Definitions.sys_new_arr, 0x6_0e9b); /* call 0x10166010 */
            ii(0x1010_5175, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1010_5178, 4); cmp(memd[ss, ebp - 0xc], 0);            /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1010_517c, 2); if(jnz(0x1010_5187, 0x9)) goto l_0x1010_5187; /* jnz 0x10105187 */
            ii(0x1010_517e, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x1010_5182, 5); jmp(0x1010_5275, 0xee); goto l_0x1010_5275; /* jmp 0x10105275 */
        l_0x1010_5187:
            ii(0x1010_5187, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_518a, 3); mov(edx, memd[ds, eax + 0x43]);         /* mov edx, [eax+0x43] */
            ii(0x1010_518d, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1010_5190, 3); shl(edx, 0x2);                          /* shl edx, 0x2 */
            ii(0x1010_5193, 3); add(edx, memd[ss, ebp - 0x4]);          /* add edx, [ebp-0x4] */
            ii(0x1010_5196, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1010_5199, 3); mov(memd[ds, edx + 0x47], eax);         /* mov [edx+0x47], eax */
            ii(0x1010_519c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_519f, 4); inc(memw[ds, eax + 0x45]);              /* inc word [eax+0x45] */
            ii(0x1010_51a3, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1010_51a6, 3); mov(memb[ds, eax], 0);                  /* mov byte [eax], 0x0 */
        l_0x1010_51a9:
            ii(0x1010_51a9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_51b5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_51b8, 3); mov(eax, memd[ds, eax + 0x43]);         /* mov eax, [eax+0x43] */
            ii(0x1010_51bb, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1010_51be, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_51c1, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1010_51c4, 3); mov(eax, memd[ds, eax + 0x43]);         /* mov eax, [eax+0x43] */
            ii(0x1010_51c7, 3); cmp(eax, memd[ss, ebp - 0xc]);          /* cmp eax, [ebp-0xc] */
            ii(0x1010_51ca, 2); if(jz(0x1010_51d2, 0x6)) goto l_0x1010_51d2; /* jz 0x101051d2 */
            ii(0x1010_51cc, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
            ii(0x1010_51d0, 2); jmp(0x1010_51d6, 0x4); goto l_0x1010_51d6; /* jmp 0x101051d6 */
        l_0x1010_51d2:
            ii(0x1010_51d2, 4); mov(memb[ss, ebp - 0x10], 0);           /* mov byte [ebp-0x10], 0x0 */
        l_0x1010_51d6:
            ii(0x1010_51d6, 3); mov(al, memb[ss, ebp - 0x10]);          /* mov al, [ebp-0x10] */
            ii(0x1010_51d9, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
        ...
        l_0x1010_51e1:
            ...
            ii(0x1010_51e6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_51fa, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1010_5209:
            ii(0x1010_5209, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_520c, 3); mov(eax, memd[ds, eax + 0x43]);         /* mov eax, [eax+0x43] */
            ii(0x1010_520f, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1010_5212, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_5215, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1010_5218, 3); mov(eax, memd[ds, eax + 0x43]);         /* mov eax, [eax+0x43] */
            ii(0x1010_521b, 3); cmp(eax, memd[ss, ebp - 0xc]);          /* cmp eax, [ebp-0xc] */
            ii(0x1010_521e, 2); if(jz(0x1010_5226, 0x6)) goto l_0x1010_5226; /* jz 0x10105226 */
            ii(0x1010_5220, 4); mov(memb[ss, ebp - 0x14], 0x1);         /* mov byte [ebp-0x14], 0x1 */
            ii(0x1010_5224, 2); jmp(0x1010_522a, 0x4); goto l_0x1010_522a; /* jmp 0x1010522a */
        l_0x1010_5226:
            ii(0x1010_5226, 4); mov(memb[ss, ebp - 0x14], 0);           /* mov byte [ebp-0x14], 0x0 */
        l_0x1010_522a:
            ii(0x1010_522a, 3); mov(al, memb[ss, ebp - 0x14]);          /* mov al, [ebp-0x14] */
            ii(0x1010_522d, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
        ...
        l_0x1010_5232:
            ...
            ii(0x1010_5237, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_5246, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1010_5249, 3); add(edx, 0x6f);                         /* add edx, 0x6f */
            ii(0x1010_524c, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1010_524f, 5); call(Definitions.sys_strcat, 0x6_0cdd); /* call 0x10165f31 */
            ii(0x1010_5254, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_5262, 3); add(memd[ss, ebp - 0xc], eax);          /* add [ebp-0xc], eax */
            ii(0x1010_5265, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
        ...
        l_0x1010_5275:
            ii(0x1010_5275, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
