...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("38d7706b-bfbf-429f-bcfc-2a8207c05ca8")]
        public void Method_1014_6a6d()
        {
            ...
            ii(0x1014_6a7a, 1); pushd(esi);                             /* push esi */
            ii(0x1014_6a7b, 1); pushd(edi);                             /* push edi */
            ii(0x1014_6a7c, 1); pushd(ebp);                             /* push ebp */
            ii(0x1014_6a7d, 2); mov(ebp, esp);                          /* mov ebp, esp */
            ii(0x1014_6a7f, 6); sub(esp, 0x1c);                         /* sub esp, 0x1c */
            ii(0x1014_6a85, 4); or(memb_a32[ss, ebp - 0x4], 0x1);       /* or byte [ebp-0x4], 0x1 */
            ii(0x1014_6a89, 3); lea(eax, ebp - 0x14);                   /* lea eax, [ebp-0x14] */
            ii(0x1014_6a8c, 5); calld(Definitions.my_string_ctor, -0x4fa9); /* call 0x10141ae8 */
            ii(0x1014_6a91, 3); mov(memd_a32[ss, ebp - 0x10], eax);     /* mov [ebp-0x10], eax */
            ii(0x1014_6a94, 4); and(memb_a32[ss, ebp - 0x4], -0x2 /* 0xfe */); /* and byte [ebp-0x4], 0xfe */
            ii(0x1014_6a98, 3); lea(eax, ebp + 0x24);                   /* lea eax, [ebp+0x24] */
            ii(0x1014_6a9b, 3); mov(memd_a32[ss, ebp - 0xc], eax);      /* mov [ebp-0xc], eax */
            ii(0x1014_6a9e, 3); lea(ecx, ebp - 0xc);                    /* lea ecx, [ebp-0xc] */
            ii(0x1014_6aa1, 3); mov(ebx, memd_a32[ss, ebp + 0x20]);     /* mov ebx, [ebp+0x20] */
            ...
            ii(0x1014_6ad8, 3); mov(eax, memd_a32[ss, ebp + 0x1c]);     /* mov eax, [ebp+0x1c] */
            ii(0x1014_6adb, 3); mov(eax, memd_a32[ds, eax + 0x18]);     /* mov eax, [eax+0x18] */
            ii(0x1014_6ade, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1014_6ae1, 1); pushd(eax);                             /* push eax */
            ii(0x1014_6ae2, 3); mov(ecx, memd_a32[ss, ebp + 0x1c]);     /* mov ecx, [ebp+0x1c] */
            ...
            ii(0x1014_6b2a, 5); calld(Definitions.my_string_dtor, -0x5005); /* call 0x10141b2a */
            ii(0x1014_6b2f, 2); mov(esp, ebp);                          /* mov esp, ebp */
            ii(0x1014_6b31, 1); popd(ebp);                              /* pop ebp */
            ii(0x1014_6b32, 1); popd(edi);                              /* pop edi */
            ii(0x1014_6b33, 1); popd(esi);                              /* pop esi */
            ii(0x1014_6b34, 1); popd(edx);                              /* pop edx */
            ii(0x1014_6b35, 1); popd(ecx);                              /* pop ecx */
            ii(0x1014_6b36, 1); popd(ebx);                              /* pop ebx */
            ii(0x1014_6b37, 1); retd(); return;                         /* ret */
        }
    }
}
