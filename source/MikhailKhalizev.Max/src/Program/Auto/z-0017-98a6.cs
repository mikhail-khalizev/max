...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x17_98a6, 4); enter(0x2, 0);                            /* enter 0x2, 0x0 */
            ii(0x17_98aa, 1); push(ds);                                 /* push ds */
            ii(0x17_98ab, 3); mov(ax, 0x3e68);                          /* mov ax, 0x3e68 */
            ii(0x17_98ae, 2); mov(ds, ax);                              /* mov ds, ax */
            ii(0x17_98b0, 5); mov(memw[ss, bp - 0x2], 0x1);             /* mov word [bp-0x2], 0x1 */
            ii(0x17_98b5, 1); cld();                                    /* cld */
            ii(0x17_98b6, 3); mov(al, memb[ss, bp + 0xa]);              /* mov al, [bp+0xa] */
        ...
        l_0x17_98c0:
            ii(0x17_98c0, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x17_98c3, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x17_98c6, 1); push(cs);                                 /* push cs */
            ii(0x17_98c7, 3); call(0x17_b040, 0x1776);                  /* call 0xb040 */
            ii(0x17_98ca, 3); add(sp, 0x4);                             /* add sp, 0x4 */
            ii(0x17_98cd, 5); mov(memw[ss, bp - 0x2], 0);               /* mov word [bp-0x2], 0x0 */
            ii(0x17_98d2, 2); jmp(0x17_98fa, 0x26); goto l_0x17_98fa;   /* jmp 0x98fa */
        l_0x17_98d4:
            ii(0x17_98d4, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x17_98d7, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x17_98da, 1); push(cs);                                 /* push cs */
            ii(0x17_98db, 3); call(0x17_b20c, 0x192e);                  /* call 0xb20c */
            ii(0x17_98de, 3); add(sp, 0x4);                             /* add sp, 0x4 */
            ii(0x17_98e1, 5); mov(memw[ss, bp - 0x2], 0);               /* mov word [bp-0x2], 0x0 */
            ii(0x17_98e6, 2); jmp(0x17_98fa, 0x12); goto l_0x17_98fa;   /* jmp 0x98fa */
        //  ii(0x17_98e8, 2); jmp(0x17_98fa, 0x10); goto l_0x17_98fa;   /* jmp 0x98fa */
        l_0x17_98ea:
        ...
        l_0x17_98fa:
            ii(0x17_98fa, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
