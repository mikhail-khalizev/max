...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_d5a3()
        {
            ...
            ii(0x1017_d5ae, 4); mov(memd[ss, esp + 0x4], ecx);          /* mov [esp+0x4], ecx */
            ii(0x1017_d5b2, 2); test(edx, edx);                         /* test edx, edx */
            ii(0x1017_d5b4, 2); if(jz(0x1017_d5b8, 0x2)) goto l_0x1017_d5b8; /* jz 0x1017d5b8 */
        ...
        l_0x1017_d5bb:
            ...
            ii(0x1017_d5d1, 2); if(jz(0x1017_d5d6, 0x3)) goto l_0x1017_d5d6; /* jz 0x1017d5d6 */
        ...
        l_0x1017_d5d6:
            ...
            ii(0x1017_d5dd, 2); if(jz(0x1017_d5e4, 0x5)) goto l_0x1017_d5e4; /* jz 0x1017d5e4 */
            ii(0x1017_d5df, 3); cmp(eax, 0x2d);                         /* cmp eax, 0x2d */
            ii(0x1017_d5e2, 2); if(jnz(0x1017_d5e5, 0x1)) goto l_0x1017_d5e5; /* jnz 0x1017d5e5 */
        l_0x1017_d5e4:
        ...
        l_0x1017_d5e5:
            ...
            ii(0x1017_d5f4, 3); mov(al, memb[ds, edx + 0x1]);           /* mov al, [edx+0x1] */
            ii(0x1017_d5f7, 3); cmp(eax, 0x78);                         /* cmp eax, 0x78 */
            ii(0x1017_d5fa, 2); if(jz(0x1017_d601, 0x5)) goto l_0x1017_d601; /* jz 0x1017d601 */
            ii(0x1017_d5fc, 3); cmp(eax, 0x58);                         /* cmp eax, 0x58 */
            ii(0x1017_d5ff, 2); if(jnz(0x1017_d608, 0x7)) goto l_0x1017_d608; /* jnz 0x1017d608 */
        l_0x1017_d601:
        ...
        l_0x1017_d608:
            ...
            ii(0x1017_d60f, 2); if(jnz(0x1017_d618, 0x7)) goto l_0x1017_d618; /* jnz 0x1017d618 */
            ii(0x1017_d611, 5); mov(esi, 0x8);                          /* mov esi, 0x8 */
            ii(0x1017_d616, 2); jmp(0x1017_d61d, 0x5); goto l_0x1017_d61d; /* jmp 0x1017d61d */
        l_0x1017_d618:
            ii(0x1017_d618, 5); mov(esi, 0xa);                          /* mov esi, 0xa */
        l_0x1017_d61d:
            ii(0x1017_d61d, 3); cmp(esi, 0x2);                          /* cmp esi, 0x2 */
            ii(0x1017_d620, 2); if(jl(0x1017_d627, 0x5)) goto l_0x1017_d627; /* jl 0x1017d627 */
        ...
        l_0x1017_d638:
            ...
            ii(0x1017_d648, 3); mov(al, memb[ds, edx + 0x1]);           /* mov al, [edx+0x1] */
            ii(0x1017_d64b, 3); cmp(eax, 0x78);                         /* cmp eax, 0x78 */
            ii(0x1017_d64e, 2); if(jz(0x1017_d655, 0x5)) goto l_0x1017_d655; /* jz 0x1017d655 */
            ii(0x1017_d650, 3); cmp(eax, 0x58);                         /* cmp eax, 0x58 */
            ii(0x1017_d653, 2); if(jnz(0x1017_d658, 0x3)) goto l_0x1017_d658; /* jnz 0x1017d658 */
        l_0x1017_d655:
            ii(0x1017_d655, 3); add(edx, 0x2);                          /* add edx, 0x2 */
        l_0x1017_d658:
            ii(0x1017_d658, 4); mov(memd[ss, esp + 0x8], edx);          /* mov [esp+0x8], edx */
        ...
        l_0x1017_d665:
            ...
            ii(0x1017_d67c, 2); if(jbe(0x1017_d680, 0x2)) goto l_0x1017_d680; /* jbe 0x1017d680 */
        ...
        l_0x1017_d680:
            ...
            ii(0x1017_d68b, 2); if(jae(0x1017_d68f, 0x2)) goto l_0x1017_d68f; /* jae 0x1017d68f */
        ...
        l_0x1017_d692:
            ii(0x1017_d692, 4); cmp(edx, memd[ss, esp + 0x8]);          /* cmp edx, [esp+0x8] */
            ii(0x1017_d696, 2); if(jnz(0x1017_d69b, 0x3)) goto l_0x1017_d69b; /* jnz 0x1017d69b */
            ii(0x1017_d698, 3); mov(edx, memd[ss, esp]);                /* mov edx, [esp] */
        l_0x1017_d69b:
            ii(0x1017_d69b, 2); test(ebp, ebp);                         /* test ebp, ebp */
            ii(0x1017_d69d, 2); if(jz(0x1017_d6a2, 0x3)) goto l_0x1017_d6a2; /* jz 0x1017d6a2 */
            ii(0x1017_d69f, 3); mov(memd[ss, ebp + 0], edx);            /* mov [ebp], edx */
        l_0x1017_d6a2:
            ii(0x1017_d6a2, 5); cmp(memd[ss, esp + 0x4], 0x1);          /* cmp dword [esp+0x4], 0x1 */
            ...
            ii(0x1017_d6b1, 2); if(jnz(0x1017_d6bc, 0x9)) goto l_0x1017_d6bc; /* jnz 0x1017d6bc */
            ii(0x1017_d6b3, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1017_d6b5, 2); mov(al, ch);                            /* mov al, ch */
            ii(0x1017_d6b7, 3); cmp(eax, 0x2d);                         /* cmp eax, 0x2d */
            ii(0x1017_d6ba, 2); if(jz(0x1017_d6be, 0x2)) goto l_0x1017_d6be; /* jz 0x1017d6be */
        l_0x1017_d6bc:
        ...
        l_0x1017_d6be:
            ...
            ii(0x1017_d6c7, 4); mov(ebp, memd[ss, esp + 0x4]);          /* mov ebp, [esp+0x4] */
            ii(0x1017_d6cb, 5); call(/* sys */ 0x1018_d3bf, 0xfcef);    /* call 0x1018d3bf */
            ii(0x1017_d6d0, 2); test(ebp, ebp);                         /* test ebp, ebp */
            ii(0x1017_d6d2, 2); if(jnz(0x1017_d6db, 0x7)) goto l_0x1017_d6db; /* jnz 0x1017d6db */
        ...
        l_0x1017_d6db:
            ...
            ii(0x1017_d6e2, 2); if(jnz(0x1017_d6eb, 0x7)) goto l_0x1017_d6eb; /* jnz 0x1017d6eb */
        ...
        l_0x1017_d6f2:
            ...
            ii(0x1017_d6f9, 2); if(jnz(0x1017_d6fd, 0x2)) goto l_0x1017_d6fd; /* jnz 0x1017d6fd */
