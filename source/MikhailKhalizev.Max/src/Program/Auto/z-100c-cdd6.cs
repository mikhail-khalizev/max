...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_cdd6()
        {
            ...
            ii(0x100c_cdec, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100c_cdef, 3); mov(memd[ss, ebp - 8], edx);            /* mov [ebp-0x8], edx */
            ii(0x100c_cdf2, 3); mov(memb[ss, ebp - 4], bl);             /* mov [ebp-0x4], bl */
            ii(0x100c_cdf5, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100c_cdf8, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x100c_cdfb, 4); cmp(memb[ss, ebp - 4], 2);              /* cmp byte [ebp-0x4], 0x2 */
            ii(0x100c_cdff, 2); if(jnz(0x100c_ce0b, 0xa)) goto l_0x100c_ce0b; /* jnz 0x100cce0b */
            ii(0x100c_ce01, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
        ...
        l_0x100c_ce0b:
            ii(0x100c_ce0b, 4); cmp(memb[ss, ebp - 4], 0);              /* cmp byte [ebp-0x4], 0x0 */
            ii(0x100c_ce0f, 2); if(jnz(0x100c_ce23, 0x12)) goto l_0x100c_ce23; /* jnz 0x100cce23 */
            ii(0x100c_ce11, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100c_ce14, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x100c_ce17, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x100c_ce1a, 3); mov(edx, memd[ds, eax + 2]);            /* mov edx, [eax+0x2] */
            ii(0x100c_ce1d, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x100c_ce20, 3); call_abs(memd[ds, edx + 60]);           /* call dword [edx+0x3c] */
        l_0x100c_ce23:
