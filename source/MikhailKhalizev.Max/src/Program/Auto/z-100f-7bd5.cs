...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_7bd5()
        {
            ...
            ii(0x100f_7bfe, 4); cmp(memb[ds, eax + 0x3d], 1);           /* cmp byte [eax+0x3d], 0x1 */
        ...
        l_0x100f_7c06:
            ...
            ii(0x100f_7c09, 4); cmp(memb[ds, eax + 0x3d], 3);           /* cmp byte [eax+0x3d], 0x3 */
        ...
        l_0x100f_7c11:
            ...
            ii(0x100f_7c14, 4); cmp(memb[ds, eax + 0x3d], 9);           /* cmp byte [eax+0x3d], 0x9 */
        ...
        l_0x100f_7c39:
            ...
            ii(0x100f_7c56, 7); mov(memd[ss, ebp - 0xc], 1);            /* mov dword [ebp-0xc], 0x1 */
        l_0x100f_7c5d:
