...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_679b()
        {
            ...
            ii(0x1013_67b2, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_67b5, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_67b8, 5); mov(ebx, 0x26);                         /* mov ebx, 0x26 */
            ii(0x1013_67bd, 5); mov(edx, 0x6e5);                        /* mov edx, 0x6e5 */
            ii(0x1013_67c2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_67c5, 5); call(0x100d_68a3, -0x5_ff27);           /* call 0x100d68a3 */
            ii(0x1013_67ca, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_67cd, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1013_67d0, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ii(0x1013_67d3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_67d6, 7); mov(memd[ds, eax + 0x13], 0x101b_6e7c); /* mov dword [eax+0x13], 0x101b6e7c */
            ...
            ii(0x1013_67f0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_67f3, 5); call(0x100d_6adf, -0x5_fd19);           /* call 0x100d6adf */
            ii(0x1013_67f8, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1013_67fb, 3); add(edx, 0x17);                         /* add edx, 0x17 */
            ii(0x1013_67fe, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_6801, 5); call(0x100d_6a11, -0x5_fdf5);           /* call 0x100d6a11 */
            ii(0x1013_6806, 5); mov(edx, 0x101c_3678);                  /* mov edx, 0x101c3678 */
            ii(0x1013_680b, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ...
            ii(0x1013_6826, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_6829, 3); mov(eax, memd[ds, eax + 0x25]);         /* mov eax, [eax+0x25] */
            ...
            ii(0x1013_6837, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1013_683a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1013_684f, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1013_6852, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x1013_6855, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1013_6858, 4); cmp(memd[ss, ebp - 0x20], 0);           /* cmp dword [ebp-0x20], 0x0 */
            ...
            ii(0x1013_6879, 3); lea(eax, memd[ss, ebp - 0x38]);         /* lea eax, [ebp-0x38] */
            ...
            ii(0x1013_6898, 3); lea(eax, memd[ss, ebp - 0x48]);         /* lea eax, [ebp-0x48] */
            ii(0x1013_689b, 5); call(0x1008_b148, -0xa_b758);           /* call 0x1008b148 */
            ii(0x1013_68a0, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x1013_68a2, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1013_68a5, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x1013_68a8, 2); mov(ecx, esi);                          /* mov ecx, esi */
            ii(0x1013_68aa, 5); call(0x100d_7706, -0x5_f1a9);           /* call 0x100d7706 */
            ii(0x1013_68af, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x1013_68b2, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x1013_68b5, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1013_68b8, 2); jmp(0x1013_68c0, 0x6); goto l_0x1013_68c0; /* jmp 0x101368c0 */
        l_0x1013_68ba:
            ii(0x1013_68ba, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1013_68bd, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
        l_0x1013_68c0:
            ii(0x1013_68c0, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1013_68c3, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1013_68c6, 3); mov(memd[ds, edx + 0x31], eax);         /* mov [edx+0x31], eax */
            ii(0x1013_68c9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_68cc, 3); mov(eax, memd[ds, eax + 0x31]);         /* mov eax, [eax+0x31] */
            ii(0x1013_68cf, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1013_68d2, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1013_68d5, 3); mov(edx, memd[ds, eax + 0x27]);         /* mov edx, [eax+0x27] */
            ii(0x1013_68d8, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1013_68db, 3); call_abs(memd[ds, edx + 0x4]);          /* call dword [edx+0x4] */
            ii(0x1013_68de, 5); mov(edx, 0x64);                         /* mov edx, 0x64 */
            ii(0x1013_68e3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_68e6, 3); mov(eax, memd[ds, eax + 0x31]);         /* mov eax, [eax+0x31] */
            ii(0x1013_68e9, 5); call(0x100d_6f8b, -0x5_f963);           /* call 0x100d6f8b */
            ii(0x1013_68ee, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_68f0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_68f3, 3); mov(eax, memd[ds, eax + 0x31]);         /* mov eax, [eax+0x31] */
            ii(0x1013_68f6, 5); call(0x100d_6f2d, -0x5_f9ce);           /* call 0x100d6f2d */
            ii(0x1013_68fb, 5); mov(edx, 0x224);                        /* mov edx, 0x224 */
            ii(0x1013_6900, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_6903, 3); mov(eax, memd[ds, eax + 0x31]);         /* mov eax, [eax+0x31] */
            ii(0x1013_6906, 5); call(0x100e_0adc, -0x5_5e2f);           /* call 0x100e0adc */
            ii(0x1013_690b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_690e, 3); mov(eax, memd[ds, eax + 0x31]);         /* mov eax, [eax+0x31] */
            ii(0x1013_6911, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1013_6914, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1013_6917, 3); mov(edx, memd[ds, eax + 0x27]);         /* mov edx, [eax+0x27] */
            ii(0x1013_691a, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1013_691d, 3); call_abs(memd[ds, edx + 0x8]);          /* call dword [edx+0x8] */
            ii(0x1013_6920, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1013_6923, 3); add(edx, 0x17);                         /* add edx, 0x17 */
            ii(0x1013_6926, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_6929, 3); mov(eax, memd[ds, eax + 0x29]);         /* mov eax, [eax+0x29] */
            ii(0x1013_692c, 5); call(Definitions.sys_display_draw_1, 0x3_0b77); /* call 0x101674a8 */
            ii(0x1013_6931, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_6934, 3); mov(memd[ss, ebp - 0x4c], eax);         /* mov [ebp-0x4c], eax */
            ii(0x1013_6937, 3); mov(eax, memd[ss, ebp - 0x4c]);         /* mov eax, [ebp-0x4c] */
