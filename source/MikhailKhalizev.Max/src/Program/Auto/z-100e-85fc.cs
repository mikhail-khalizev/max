...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("fd22abe5-f61a-4816-9997-187219b6fcdd")]
        public void Method_100e_85fc()
        {
            ii(0x100e_85fc, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x100e_8601, 5); calld(Definitions.sys_check_available_stack_size, 0x7d74c); /* call 0x10165d52 */
            ...
            ii(0x100e_8625, 5); calld(0x1013_b0f9, 0x52acf);            /* call 0x1013b0f9 */
            ...
            ii(0x100e_8630, 1); retd(); return;                         /* ret */
        }
    }
}
