...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_796c()
        {
            ...
            ii(0x100a_7983, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_7986, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_7989, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_798c, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x100a_79a4, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100a_79a7, 5); call(0x100a_a9b0, 0x3004);              /* call 0x100aa9b0 */
            ii(0x100a_79ac, 3); movsx(ebx, ax);                         /* movsx ebx, ax */
            ii(0x100a_79af, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100a_79b2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_79b5, 3); add(eax, 0x14);                         /* add eax, 0x14 */
            ii(0x100a_79b8, 5); call(0x100a_a8c4, 0x2f07);              /* call 0x100aa8c4 */
            ii(0x100a_79bd, 4); cmp(memd[ss, ebp - 0x10], 0);           /* cmp dword [ebp-0x10], 0x0 */
            ii(0x100a_79c1, 2); if(jz(0x100a_7a18, 0x55)) goto l_0x100a_7a18; /* jz 0x100a7a18 */
            ii(0x100a_79c3, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x100a_79ca, 2); jmp(0x100a_79d2, 0x6); goto l_0x100a_79d2; /* jmp 0x100a79d2 */
        l_0x100a_79cc:
            ii(0x100a_79cc, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100a_79cf, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x100a_79d2:
            ii(0x100a_79d2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_79d5, 3); add(eax, 0x6);                          /* add eax, 0x6 */
            ii(0x100a_79d8, 5); call(Definitions.my_3_get_count, -0x1_c55d); /* call 0x1008b480 */
            ii(0x100a_79dd, 4); cmp(ax, memw[ss, ebp - 0xc]);           /* cmp ax, [ebp-0xc] */
            ii(0x100a_79e1, 2); if(jle(0x100a_7a18, 0x35)) goto l_0x100a_7a18; /* jle 0x100a7a18 */
            ii(0x100a_79e3, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100a_79e7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_79f8, 3); add(ebx, memd[ss, ebp - 0x10]);         /* add ebx, [ebp-0x10] */
            ii(0x100a_79fb, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100a_79ff, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_7a13, 3); or(memb[ds, eax], 0x8);                 /* or byte [eax], 0x8 */
        ...
        l_0x100a_7a18:
            ...
            ii(0x100a_7a21, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
