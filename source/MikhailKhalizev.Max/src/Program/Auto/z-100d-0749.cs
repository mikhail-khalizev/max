...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_0749()
        {
            ...
            ii(0x100d_0761, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100d_0764, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_0778, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_077b, 3); mov(edx, memd[ds, eax + 0x24]);         /* mov edx, [eax+0x24] */
            ii(0x100d_077e, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_0781, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_0784, 3); add(eax, 0x1e);                         /* add eax, 0x1e */
            ii(0x100d_0787, 5); call(0x1008_b32c, -0x4_5460);           /* call 0x1008b32c */
            ii(0x100d_078c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_0799, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_079c, 4); cmp(dx, memw[ds, eax + 0x26]);          /* cmp dx, [eax+0x26] */
            ii(0x100d_07a0, 2); if(jg(0x100d_07cd, 0x2b)) goto l_0x100d_07cd; /* jg 0x100d07cd */
            ii(0x100d_07a2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_07af, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_07b2, 1); dec(edx);                               /* dec edx */
            ii(0x100d_07b3, 4); mov(memw[ds, eax + 0x26], dx);          /* mov [eax+0x26], dx */
            ii(0x100d_07b7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_07ba, 3); mov(eax, memd[ds, eax + 0x24]);         /* mov eax, [eax+0x24] */
            ii(0x100d_07bd, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100d_07c0, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100d_07c2, 2); if(jge(0x100d_07cd, 0x9)) goto l_0x100d_07cd; /* jge 0x100d07cd */
            ii(0x100d_07c4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_07c7, 6); mov(memw[ds, eax + 0x26], 0);           /* mov word [eax+0x26], 0x0 */
        l_0x100d_07cd:
            ii(0x100d_07cd, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100d_07cf, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_07d2, 5); call(0x100d_0617, -0x1c0);              /* call 0x100d0617 */
            ii(0x100d_07d7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_07da, 3); mov(edx, memd[ds, eax + 0x24]);         /* mov edx, [eax+0x24] */
            ii(0x100d_07dd, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_07e0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_07e3, 5); call(0x100d_01a3, -0x645);              /* call 0x100d01a3 */
            ii(0x100d_07e8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_07eb, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_07ee, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_07f1, 3); mov(edx, memd[ds, eax + 0x40]);         /* mov edx, [eax+0x40] */
            ii(0x100d_07f4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_07f7, 3); call_abs(memd[ds, edx + 0x10]);         /* call dword [edx+0x10] */
        l_0x100d_07fa:
