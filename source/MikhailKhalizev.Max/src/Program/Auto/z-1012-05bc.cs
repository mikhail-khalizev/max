...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("396420a7-8dfc-4e1e-8b22-76ca783bff14")]
        public void Method_1012_05bc()
        {
            ii(0x1012_05bc, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x1012_05c1, 5); calld(Definitions.sys_check_available_stack_size, 0x4578c); /* call 0x10165d52 */
            ...
            ii(0x1012_05e5, 5); calld(0x100c_d990, -0x52c5a);           /* call 0x100cd990 */
