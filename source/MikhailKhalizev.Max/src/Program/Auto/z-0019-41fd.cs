...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_41fd()
        {
            ...
            ii(0x19_4202, 3); lds(bx, memw[ss, bp + 0xa]);              /* lds bx, [bp+0xa] */
            ii(0x19_4205, 3); mov(ax, memw[ss, bp + 0xe]);              /* mov ax, [bp+0xe] */
            ii(0x19_4208, 2); mov(memw[ds, bx], ax);                    /* mov [bx], ax */
            ii(0x19_420a, 3); mov(ax, memw[ss, bp + 0x10]);             /* mov ax, [bp+0x10] */
            ii(0x19_420d, 3); mov(memw[ds, bx + 0x2], ax);              /* mov [bx+0x2], ax */
            ii(0x19_4210, 1); push(ds);                                 /* push ds */
            ii(0x19_4211, 1); push(bx);                                 /* push bx */
            ii(0x19_4212, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x19_4215, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
