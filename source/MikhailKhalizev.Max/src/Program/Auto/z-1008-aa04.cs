...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_aa04()
        {
            ...
            ii(0x1008_aa1c, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_aa1f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_aa22, 6); mov(eax, memd[ds, eax + 0xa1]);         /* mov eax, [eax+0xa1] */
            ii(0x1008_aa28, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1008_aa2b, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1008_aa2d, 2); if(jle(0x1008_aa35, 0x6)) goto l_0x1008_aa35; /* jle 0x1008aa35 */
            ii(0x1008_aa2f, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x1008_aa33, 2); jmp(0x1008_aa39, 0x4); goto l_0x1008_aa39; /* jmp 0x1008aa39 */
        l_0x1008_aa35:
            ii(0x1008_aa35, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x1008_aa39:
            ii(0x1008_aa39, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x1008_aa3c, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x1008_aa3f, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
