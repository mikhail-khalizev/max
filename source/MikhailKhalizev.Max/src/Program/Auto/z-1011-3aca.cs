...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_3aca()
        {
            ...
            ii(0x1011_3ae1, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_3ae4, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ...
            ii(0x1011_3aff, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ii(0x1011_3b02, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x1011_3b05, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_3b08, 2); mov(ebx, memd[ds, eax]);                /* mov ebx, [eax] */
            ii(0x1011_3b0a, 3); mov(ebx, memd[ds, ebx + 0xe]);          /* mov ebx, [ebx+0xe] */
            ii(0x1011_3b0d, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1011_3b10, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1011_3b2e, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ...
            ii(0x1011_3b5e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_3b61, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1011_3b63, 5); call(0x100e_ab9d, -0x2_8fcb);           /* call 0x100eab9d */
            ii(0x1011_3b68, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_3b6b, 9); mov(memw[ds, eax + 0x5d5], 0xffff);     /* mov word [eax+0x5d5], 0xffff */
            ii(0x1011_3b74, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
