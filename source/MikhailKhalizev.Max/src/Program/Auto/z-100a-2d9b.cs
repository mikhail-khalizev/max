...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_2d9b()
        {
            ...
            ii(0x100a_2db3, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_2db6, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_2db8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_2dc7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_2dca, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x100a_2dcd, 5); call(0x1008_af28, -0x1_7eaa);           /* call 0x1008af28 */
            ii(0x100a_2dd2, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100a_2dd5, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100a_2dd8, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x100a_2ddb, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100a_2dde, 3); call_abs(memd[ds, edx + 0x24]);         /* call dword [edx+0x24] */
            ii(0x100a_2de1, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x100a_2de4, 2); jmp(0x100a_2dea, 0x4); goto l_0x100a_2dea; /* jmp 0x100a2dea */
        l_0x100a_2de6:
            ii(0x100a_2de6, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
        l_0x100a_2dea:
            ii(0x100a_2dea, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
