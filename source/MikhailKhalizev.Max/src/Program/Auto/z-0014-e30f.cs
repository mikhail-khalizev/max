...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0014_e30f()
        {
            ...
            ii(0x14_e312, 2); if(jbw_func(0x14_e2b3, -0x61)) return;    /* jb 0xe2b3 */
            ii(0x14_e314, 2); if(jcxzw_func(0x14_e2b3, -0x63)) return;  /* jcxz 0xe2b3 */
            ...
            ii(0x14_e325, 2); if(jnzw_func(0x14_e306, -0x21)) return;   /* jnz 0xe306 */
            ii(0x14_e327, 5); test(memb_a32[ds, esi + 0x5], 0x7f);      /* test byte [esi+0x5], 0x7f */
            ii(0x14_e32c, 2); if(jzw_func(0x14_e306, -0x28)) return;    /* jz 0xe306 */
            ii(0x14_e32e, 3); if(jmpw_func(0x14_e062, -0x2cf)) return;  /* jmp 0xe062 */
        }
    }
}
