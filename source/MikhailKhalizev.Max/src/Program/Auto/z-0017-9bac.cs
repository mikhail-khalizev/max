...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_9bac()
        {
            ...
            ii(0x17_9bcc, 5); or(memb[es, bx + 0x2c], 1);               /* or byte [es:bx+0x2c], 0x1 */
        ...
        l_0x17_9bd4:
            ...
            ii(0x17_9bf7, 5); or(memb[es, bx + 0x2c], 1);               /* or byte [es:bx+0x2c], 0x1 */
        ...
        l_0x17_9c02:
            ...
            ii(0x17_9c0f, 5); and(memb[es, bx + 0x2c], -2 /* 0xfe */);  /* and byte [es:bx+0x2c], 0xfe */
