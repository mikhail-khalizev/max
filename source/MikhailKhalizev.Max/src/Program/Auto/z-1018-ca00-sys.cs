...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_ca00()
        {
            ...
            ii(0x1018_ca0f, 3); lea(eax, memd[ss, ebp - 0x34]);         /* lea eax, [ebp-0x34] */
            ...
            ii(0x1018_ca22, 3); mov(memb[ss, ebp - 0x17], ah);          /* mov [ebp-0x17], ah */
            ii(0x1018_ca25, 3); mov(memb[ss, ebp - 0x18], dl);          /* mov [ebp-0x18], dl */
            ii(0x1018_ca28, 6); mov(ax, memw[ds, 0x1020_b708]);         /* mov ax, [0x1020b708] */
            ii(0x1018_ca2e, 5); mov(edx, 0x800);                        /* mov edx, 0x800 */
            ii(0x1018_ca33, 4); mov(memw[ss, ebp - 0x4], ax);           /* mov [ebp-0x4], ax */
            ii(0x1018_ca37, 4); mov(memw[ss, ebp - 0x6], dx);           /* mov [ebp-0x6], dx */
            ii(0x1018_ca3b, 2); mov(dh, 0x1);                           /* mov dh, 0x1 */
            ii(0x1018_ca3d, 3); mov(al, memb[ss, ebp + 0x8]);           /* mov al, [ebp+0x8] */
            ii(0x1018_ca40, 3); mov(memb[ss, ebp - 0x23], dh);          /* mov [ebp-0x23], dh */
            ii(0x1018_ca43, 3); mov(memb[ss, ebp - 0x24], al);          /* mov [ebp-0x24], al */
            ii(0x1018_ca46, 5); mov(eax, 0x10);                         /* mov eax, 0x10 */
            ii(0x1018_ca4b, 3); lea(edx, memd[ss, ebp - 0x34]);         /* lea edx, [ebp-0x34] */
            ii(0x1018_ca4e, 5); call(/* sys */ 0x1019_4540, 0x7aed);    /* call 0x10194540 */
            ii(0x1018_ca53, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1018_ca55, 2); if(jz(0x1018_ca5e, 0x7)) goto l_0x1018_ca5e; /* jz 0x1018ca5e */
            ii(0x1018_ca57, 5); cmp(memw[ss, ebp - 0x18], 0x4f);        /* cmp word [ebp-0x18], 0x4f */
            ii(0x1018_ca5c, 2); if(jz(0x1018_ca64, 0x6)) goto l_0x1018_ca64; /* jz 0x1018ca64 */
        l_0x1018_ca5e:
        ...
        l_0x1018_ca64:
            ...
            ii(0x1018_ca66, 3); mov(edx, memd[ss, ebp + 0xc]);          /* mov edx, [ebp+0xc] */
            ii(0x1018_ca69, 4); mov(ax, memw[ss, ebp - 0x20]);          /* mov ax, [ebp-0x20] */
