...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x17_4820, 4); enter(0x4, 0);                            /* enter 0x4, 0x0 */
            ...
            ii(0x17_482d, 2); jmp(0x17_4831, 0x2); goto l_0x17_4831;    /* jmp 0x4831 */
        ...
        l_0x17_4831:
            ...
            ii(0x17_4844, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_4847, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
