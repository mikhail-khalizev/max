...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_7a48()
        {
            ...
            ii(0x100b_7a5a, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100b_7a60, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100b_7a63, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100b_7a66, 5); call(0x1007_6c30, -0x4_0e3b);           /* call 0x10076c30 */
            ii(0x100b_7a6b, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100b_7a6e, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
