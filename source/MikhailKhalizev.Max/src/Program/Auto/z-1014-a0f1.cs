...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_a0f1()
        {
            ...
            ii(0x1014_a10f, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
        ...
        l_0x1014_a14a:
            ii(0x1014_a14a, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1014_a14d, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1014_a150, 5); cmp(memw[ss, ebp - 16], 0x21);          /* cmp word [ebp-0x10], 0x21 */
            ii(0x1014_a155, 6); if(jb(0x1014_a1ab, 0x50)) goto l_0x1014_a1ab; /* jb 0x1014a1ab */
            ii(0x1014_a15b, 5); cmp(memw[ss, ebp - 16], 0x21);          /* cmp word [ebp-0x10], 0x21 */
            ii(0x1014_a160, 2); if(jbe(0x1014_a11d, -0x45)) goto l_0x1014_a11d; /* jbe 0x1014a11d */
            ii(0x1014_a162, 5); cmp(memw[ss, ebp - 16], 0x55);          /* cmp word [ebp-0x10], 0x55 */
            ii(0x1014_a167, 2); if(jb(0x1014_a189, 0x20)) goto l_0x1014_a189; /* jb 0x1014a189 */
            ii(0x1014_a169, 5); cmp(memw[ss, ebp - 16], 0x55);          /* cmp word [ebp-0x10], 0x55 */
            ii(0x1014_a16e, 2); if(jbe(0x1014_a114, -0x5c)) goto l_0x1014_a114; /* jbe 0x1014a114 */
            ii(0x1014_a170, 5); cmp(memw[ss, ebp - 16], 0x5a);          /* cmp word [ebp-0x10], 0x5a */
            ii(0x1014_a175, 2); if(jb(0x1014_a187, 0x10)) goto l_0x1014_a187; /* jb 0x1014a187 */
            ii(0x1014_a177, 5); cmp(memw[ss, ebp - 16], 0x5a);          /* cmp word [ebp-0x10], 0x5a */
            ii(0x1014_a17c, 2); if(jbe(0x1014_a114, -0x6a)) goto l_0x1014_a114; /* jbe 0x1014a114 */
            ii(0x1014_a17e, 5); cmp(memw[ss, ebp - 16], 0x5c);          /* cmp word [ebp-0x10], 0x5c */
        ...
        l_0x1014_a189:
            ii(0x1014_a189, 5); cmp(memw[ss, ebp - 16], 0x27);          /* cmp word [ebp-0x10], 0x27 */
            ii(0x1014_a18e, 2); if(jb(0x1014_a1a9, 0x19)) goto l_0x1014_a1a9; /* jb 0x1014a1a9 */
            ii(0x1014_a190, 5); cmp(memw[ss, ebp - 16], 0x27);          /* cmp word [ebp-0x10], 0x27 */
            ii(0x1014_a195, 2); if(jbe(0x1014_a126, -0x71)) goto l_0x1014_a126; /* jbe 0x1014a126 */
            ii(0x1014_a197, 5); cmp(memw[ss, ebp - 16], 0x29);          /* cmp word [ebp-0x10], 0x29 */
            ii(0x1014_a19c, 2); if(jb(0x1014_a1a7, 9)) goto l_0x1014_a1a7; /* jb 0x1014a1a7 */
            ii(0x1014_a19e, 5); cmp(memw[ss, ebp - 16], 0x2a);          /* cmp word [ebp-0x10], 0x2a */
        ...
        l_0x1014_a1ab:
            ii(0x1014_a1ab, 5); cmp(memw[ss, ebp - 16], 0x11);          /* cmp word [ebp-0x10], 0x11 */
            ii(0x1014_a1b0, 2); if(jb(0x1014_a1dd, 0x2b)) goto l_0x1014_a1dd; /* jb 0x1014a1dd */
            ii(0x1014_a1b2, 5); cmp(memw[ss, ebp - 16], 0x12);          /* cmp word [ebp-0x10], 0x12 */
            ii(0x1014_a1b7, 6); if(jbe(0x1014_a126, -0x97)) goto l_0x1014_a126; /* jbe 0x1014a126 */
            ii(0x1014_a1bd, 5); cmp(memw[ss, ebp - 16], 0x14);          /* cmp word [ebp-0x10], 0x14 */
        ...
        l_0x1014_a1dd:
            ...
            ii(0x1014_a1e4, 5); cmp(memw[ss, ebp - 16], 0xe);           /* cmp word [ebp-0x10], 0xe */
