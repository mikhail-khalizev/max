...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_a0f1()
        {
            ...
            ii(0x1014_a109, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_a10c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1014_a114:
            ii(0x1014_a114, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x1014_a118, 5); jmp(0x1014_a1f9, 0xdc); goto l_0x1014_a1f9; /* jmp 0x1014a1f9 */
        l_0x1014_a11d:
            ii(0x1014_a11d, 4); mov(memb[ss, ebp - 0x8], 0x2);          /* mov byte [ebp-0x8], 0x2 */
            ii(0x1014_a121, 5); jmp(0x1014_a1f9, 0xd3); goto l_0x1014_a1f9; /* jmp 0x1014a1f9 */
        l_0x1014_a126:
            ii(0x1014_a126, 4); mov(memb[ss, ebp - 0x8], 0x3);          /* mov byte [ebp-0x8], 0x3 */
            ii(0x1014_a12a, 5); jmp(0x1014_a1f9, 0xca); goto l_0x1014_a1f9; /* jmp 0x1014a1f9 */
        l_0x1014_a12f:
            ii(0x1014_a12f, 4); mov(memb[ss, ebp - 0x8], 0x4);          /* mov byte [ebp-0x8], 0x4 */
            ii(0x1014_a133, 5); jmp(0x1014_a1f9, 0xc1); goto l_0x1014_a1f9; /* jmp 0x1014a1f9 */
        l_0x1014_a138:
            ii(0x1014_a138, 4); mov(memb[ss, ebp - 0x8], 0x5);          /* mov byte [ebp-0x8], 0x5 */
            ii(0x1014_a13c, 5); jmp(0x1014_a1f9, 0xb8); goto l_0x1014_a1f9; /* jmp 0x1014a1f9 */
        l_0x1014_a141:
            ii(0x1014_a141, 4); mov(memb[ss, ebp - 0x8], 0x6);          /* mov byte [ebp-0x8], 0x6 */
        ...
        l_0x1014_a189:
            ...
            ii(0x1014_a19c, 2); if(jb(0x1014_a1a7, 0x9)) goto l_0x1014_a1a7; /* jb 0x1014a1a7 */
        ...
        l_0x1014_a1f9:
            ii(0x1014_a1f9, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
