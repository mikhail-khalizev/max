...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_2a58()
        {
            ...
            ii(0x1010_2a6a, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1010_2a70, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_2a73, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_2a76, 5);  call(0x1007_6c30, -0x8_be4b);         /* call 0x10076c30 */
            ii(0x1010_2a7b, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_2a7e, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
