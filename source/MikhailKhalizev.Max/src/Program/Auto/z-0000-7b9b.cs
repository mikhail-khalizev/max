...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_7b9b()
        {
            ...
            ii(0x7b9e, 4);    cmp(memw[ss, bp + 0x4], 0x30);            /* cmp word [bp+0x4], 0x30 */
            ii(0x7ba2, 2);    if(jl(0x7baf, 0xb)) goto l_0x7baf;        /* jl 0x7baf */
            ii(0x7ba4, 4);    cmp(memw[ss, bp + 0x4], 0x39);            /* cmp word [bp+0x4], 0x39 */
            ii(0x7ba8, 2);    if(jg(0x7baf, 0x5)) goto l_0x7baf;        /* jg 0x7baf */
