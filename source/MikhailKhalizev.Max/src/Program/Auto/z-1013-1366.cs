...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_1366()
        {
            ...
            ii(0x1013_137d, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_1380, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_1383, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_1386, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1013_1389, 7); mov(memb[ds, 0x101c_61b3], 0);          /* mov byte [0x101c61b3], 0x0 */
            ii(0x1013_1390, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_1393, 5); call(0x1012_f003, -0x2395);             /* call 0x1012f003 */
            ii(0x1013_1398, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_139b, 4); cmp(memb[ds, eax + 0x17], 0);           /* cmp byte [eax+0x17], 0x0 */
            ii(0x1013_139f, 2); if(jz(0x1013_13aa, 0x9)) goto l_0x1013_13aa; /* jz 0x101313aa */
            ii(0x1013_13a1, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_13a4, 4); cmp(memb[ds, eax + 0x17], 0x1);         /* cmp byte [eax+0x17], 0x1 */
            ii(0x1013_13a8, 2); if(jnz(0x1013_13b7, 0xd)) goto l_0x1013_13b7; /* jnz 0x101313b7 */
        l_0x1013_13aa:
            ii(0x1013_13aa, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x1013_13af, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
