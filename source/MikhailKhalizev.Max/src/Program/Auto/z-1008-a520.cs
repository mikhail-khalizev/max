...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_a520()
        {
            ...
            ii(0x1008_a538, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1008_a53b, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1008_a53e, 3); cmp(memd[ds, eax], 0);                  /* cmp dword [eax], 0x0 */
            ii(0x1008_a541, 2); if(jz(0x1008_a54c, 9)) goto l_0x1008_a54c; /* jz 0x1008a54c */
            ii(0x1008_a543, 7); mov(memd[ss, ebp - 8], 0);              /* mov dword [ebp-0x8], 0x0 */
        ...
        l_0x1008_a54c:
            ...
            ii(0x1008_a562, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
        l_0x1008_a565:
            ii(0x1008_a565, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1008_a568, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1008_a56a, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1008_a56d, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
