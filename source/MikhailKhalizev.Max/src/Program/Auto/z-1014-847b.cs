...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_847b()
        {
            ...
            ii(0x1014_849a, 2); if(jz(0x1014_84a5, 0x9)) goto l_0x1014_84a5; /* jz 0x101484a5 */
            ii(0x1014_849c, 7); mov(memd[ss, ebp - 0x4], 0xffff_ffff);  /* mov dword [ebp-0x4], 0xffffffff */
        ...
        l_0x1014_84a5:
            ...
            ii(0x1014_84ea, 10); mov(memd[ds, 0x101c_8138], 0x1);       /* mov dword [0x101c8138], 0x1 */
            ii(0x1014_84f4, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
        l_0x1014_84fb:
            ii(0x1014_84fb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
