...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_0c8c()
        {
            ...
            ii(0x1017_0c9c, 2); if(jnz(0x1017_0ca6, 0x8)) goto l_0x1017_0ca6; /* jnz 0x10170ca6 */
        ...
        l_0x1017_0ca6:
            ...
            ii(0x1017_0cbb, 3); lea(eax, memd[ds, ecx + 0x2]);          /* lea eax, [ecx+0x2] */
            ...
            ii(0x1017_0cd6, 4); mov(memb[ds, ebx + 0x10], 0x1);         /* mov byte [ebx+0x10], 0x1 */
        ...
        l_0x1017_0cdb:
            ...
            ii(0x1017_0ce3, 3); mov(al, memb[ds, esi + 0x1]);           /* mov al, [esi+0x1] */
            ii(0x1017_0ce6, 3); add(esi, 0x2);                          /* add esi, 0x2 */
            ii(0x1017_0ce9, 3); mov(memb[ds, edi + 0x1], al);           /* mov [edi+0x1], al */
        ...
        l_0x1017_0cf3:
            ...
            ii(0x1017_0cf9, 4); cmp(memb[ds, eax - 0x1], 0x5c);         /* cmp byte [eax-0x1], 0x5c */
            ...
            ii(0x1017_0d05, 5); mov(memb[ds, ecx + eax + 0x1], 0);      /* mov byte [ecx+eax+0x1], 0x0 */
