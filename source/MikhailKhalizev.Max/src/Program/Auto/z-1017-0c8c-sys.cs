...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_0c8c()
        {
            ...
            ii(0x1017_0c9e, 3); mov(memd[ds, eax + 12], edx);           /* mov [eax+0xc], edx */
        ...
        l_0x1017_0ca6:
            ...
            ii(0x1017_0cca, 3); mov(memd[ds, ebx + 12], eax);           /* mov [ebx+0xc], eax */
            ...
            ii(0x1017_0cd3, 3); mov(edi, memd[ds, ebx + 12]);           /* mov edi, [ebx+0xc] */
            ii(0x1017_0cd6, 4); mov(memb[ds, ebx + 16], 1);             /* mov byte [ebx+0x10], 0x1 */
        ...
        l_0x1017_0cf3:
            ...
            ii(0x1017_0cf4, 3); mov(eax, memd[ds, ebx + 12]);           /* mov eax, [ebx+0xc] */
            ...
            ii(0x1017_0d02, 3); mov(eax, memd[ds, ebx + 12]);           /* mov eax, [ebx+0xc] */
        ...
        l_0x1017_0d11:
            ii(0x1017_0d11, 7); mov(memd[ds, ebx + 12], StringDefinitions.Empty3); /* mov dword [ebx+0xc], 0x101b2f00 */
        l_0x1017_0d18:
