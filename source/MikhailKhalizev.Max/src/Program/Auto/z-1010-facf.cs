...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_facf()
        {
            ...
            ii(0x1010_fae6, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_fae9, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x1010_faec, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_faef, 4); cmp(memd[ds, eax + 0x15], 0);           /* cmp dword [eax+0x15], 0x0 */
            ii(0x1010_faf3, 6); if(jz(0x1010_fcc5, 0x1cc)) goto l_0x1010_fcc5; /* jz 0x1010fcc5 */
            ii(0x1010_faf9, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ii(0x1010_fafd, 6); if(jz(0x1010_fc57, 0x154)) goto l_0x1010_fc57; /* jz 0x1010fc57 */
            ii(0x1010_fb03, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_fb06, 3); mov(eax, memd[ds, eax + 0x15]);         /* mov eax, [eax+0x15] */
            ii(0x1010_fb09, 5); call(0x100e_b68a, -0x2_4484);           /* call 0x100eb68a */
            ii(0x1010_fb0e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_fb11, 3); mov(eax, memd[ds, eax + 0x10]);         /* mov eax, [eax+0x10] */
            ii(0x1010_fb14, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1010_fb17, 5); jmp(0x1010_fc44, 0x128); goto l_0x1010_fc44; /* jmp 0x1010fc44 */
        l_0x1010_fb1c:
            ii(0x1010_fb1c, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1010_fb1f, 6); add(edx, 0xe9);                         /* add edx, 0xe9 */
            ii(0x1010_fb25, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1010_fb37, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1010_fb4e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1010_fb5d:
            ...
            ii(0x1010_fb62, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1010_fb79, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1010_fb8b:
            ii(0x1010_fb8b, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1010_fb8e, 6); add(edx, 0xe9);                         /* add edx, 0xe9 */
            ii(0x1010_fb94, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1010_fba6:
            ii(0x1010_fba6, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1010_fba9, 6); add(edx, 0xe9);                         /* add edx, 0xe9 */
            ii(0x1010_fbaf, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1010_fbc1:
            ii(0x1010_fbc1, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1010_fbc4, 6); add(edx, 0xe9);                         /* add edx, 0xe9 */
            ii(0x1010_fbca, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1010_fbdc:
            ii(0x1010_fbdc, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1010_fbdf, 6); add(edx, 0xe9);                         /* add edx, 0xe9 */
            ii(0x1010_fbe5, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1010_fbf4:
            ii(0x1010_fbf4, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1010_fbf7, 6); add(edx, 0xe9);                         /* add edx, 0xe9 */
            ii(0x1010_fbfd, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1010_fc0c:
            ii(0x1010_fc0c, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1010_fc0f, 6); add(edx, 0xe9);                         /* add edx, 0xe9 */
            ii(0x1010_fc15, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1010_fc44:
            ii(0x1010_fc44, 4); cmp(memd[ss, ebp - 0xc], 0x6);          /* cmp dword [ebp-0xc], 0x6 */
            ii(0x1010_fc48, 2); if(ja(0x1010_fc24, -0x26)) goto l_0x1010_fc24; /* ja 0x1010fc24 */
            ii(0x1010_fc4a, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
        ...
        l_0x1010_fc57:
            ...
            ii(0x1010_fc59, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_fc5c, 3); mov(eax, memd[ds, eax + 0x10]);         /* mov eax, [eax+0x10] */
            ii(0x1010_fc5f, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_fc62, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x1010_fc65, 3); mov(eax, memd[ds, eax + 0x19]);         /* mov eax, [eax+0x19] */
            ii(0x1010_fc68, 5); call(0x100c_fb73, -0x4_00fa);           /* call 0x100cfb73 */
            ii(0x1010_fc6d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_fc70, 3); mov(eax, memd[ds, eax + 0x15]);         /* mov eax, [eax+0x15] */
            ii(0x1010_fc73, 5); call(0x100e_b226, -0x2_4a52);           /* call 0x100eb226 */
            ii(0x1010_fc78, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_fc7b, 4); cmp(memd[ds, eax + 0x15], 0);           /* cmp dword [eax+0x15], 0x0 */
            ii(0x1010_fc7f, 2); if(jz(0x1010_fcb5, 0x34)) goto l_0x1010_fcb5; /* jz 0x1010fcb5 */
            ii(0x1010_fc81, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_fc84, 3); mov(eax, memd[ds, eax + 0x15]);         /* mov eax, [eax+0x15] */
            ii(0x1010_fc87, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1010_fc8a, 4); cmp(memd[ss, ebp - 0x10], 0);           /* cmp dword [ebp-0x10], 0x0 */
            ii(0x1010_fc8e, 2); if(jz(0x1010_fca4, 0x14)) goto l_0x1010_fca4; /* jz 0x1010fca4 */
            ii(0x1010_fc90, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_fc92, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x1010_fc9f, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1010_fca2, 2); jmp(0x1010_fcab, 0x7); goto l_0x1010_fcab; /* jmp 0x1010fcab */
        l_0x1010_fca4:
            ii(0x1010_fca4, 7); mov(memd[ss, ebp - 0x14], 0);           /* mov dword [ebp-0x14], 0x0 */
        l_0x1010_fcab:
            ii(0x1010_fcab, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_fcae, 7); mov(memd[ds, eax + 0x15], 0);           /* mov dword [eax+0x15], 0x0 */
        l_0x1010_fcb5:
            ii(0x1010_fcb5, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_fcb8, 5); call(0x1010_f23d, -0xa80);              /* call 0x1010f23d */
            ii(0x1010_fcbd, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
