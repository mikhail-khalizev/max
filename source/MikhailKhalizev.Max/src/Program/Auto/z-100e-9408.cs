...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_9408()
        {
            ...
            ii(0x100e_941a, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100e_9420, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100e_9423, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100e_9426, 5); mov(memw[ds, eax], 0);                  /* mov word [eax], 0x0 */
            ii(0x100e_942b, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100e_942e, 6); mov(memw[ds, eax + 2], 0);              /* mov word [eax+0x2], 0x0 */
            ii(0x100e_9434, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100e_9437, 7); mov(memd[ds, eax + 4], 0);              /* mov dword [eax+0x4], 0x0 */
            ii(0x100e_943e, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100e_9441, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100e_9444, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
