...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_df7d()
        {
            ...
            ii(0x1017_df8a, 4); mov(memw[ss, ebp - 0x10], dx);          /* mov [ebp-0x10], dx */
            ii(0x1017_df8e, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ...
            ii(0x1017_df9a, 7); mov(memd[ss, ebp - 0xc], 0x3);          /* mov dword [ebp-0xc], 0x3 */
            ii(0x1017_dfa1, 5); jmp(0x1017_e0a2, 0xfc); goto l_0x1017_e0a2; /* jmp 0x1017e0a2 */
        l_0x1017_dfa6:
            ii(0x1017_dfa6, 7); mov(memd[ss, ebp - 0x8], 0x2c);         /* mov dword [ebp-0x8], 0x2c */
            ii(0x1017_dfad, 4); cmp(memd[ss, ebp - 0x14], 0);           /* cmp dword [ebp-0x14], 0x0 */
            ii(0x1017_dfb1, 2); if(jnz(0x1017_dfba, 0x7)) goto l_0x1017_dfba; /* jnz 0x1017dfba */
            ii(0x1017_dfb3, 5); cmp(memw[ss, ebp - 0x10], 0);           /* cmp word [ebp-0x10], 0x0 */
            ii(0x1017_dfb8, 2); if(jz(0x1017_dfd8, 0x1e)) goto l_0x1017_dfd8; /* jz 0x1017dfd8 */
        l_0x1017_dfba:
            ii(0x1017_dfba, 3); mov(edx, memd[ss, ebp - 0x14]);         /* mov edx, [ebp-0x14] */
        ...
        l_0x1017_dfe7:
            ...
            ii(0x1017_dfff, 7); cmp(memd[ds, 0x1020_a13c], -0x1 /* 0xff */); /* cmp dword [0x1020a13c], 0xffffffff */
            ii(0x1017_e006, 2); if(jnz(0x1017_e014, 0xc)) goto l_0x1017_e014; /* jnz 0x1017e014 */
            ii(0x1017_e008, 7); mov(memd[ss, ebp - 0xc], 0xf);          /* mov dword [ebp-0xc], 0xf */
            ii(0x1017_e00f, 5); jmp(0x1017_e0a2, 0x8e); goto l_0x1017_e0a2; /* jmp 0x1017e0a2 */
        l_0x1017_e014:
            ii(0x1017_e014, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ...
            ii(0x1017_e02b, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x1017_e091, 10); mov(memd[ds, 0x101b_e4e8], 0x1);       /* mov dword [0x101be4e8], 0x1 */
            ii(0x1017_e09b, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
        l_0x1017_e0a2:
            ii(0x1017_e0a2, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
