...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void my_get_res_data_by_id()
        {
            ...
            ii(0x1013_3ff0, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1013_3ff3, 4); movsx(eax, memw[ss, ebp - 4]);          /* movsx eax, word [ebp-0x4] */
            ii(0x1013_3ff7, 3); cmp(eax, -1 /* 0xff */);                /* cmp eax, 0xffffffff */
            ii(0x1013_3ffa, 2); if(jnz(0x1013_4008, 0xc)) goto l_0x1013_4008; /* jnz 0x10134008 */
            ii(0x1013_3ffc, 7); mov(memd[ss, ebp - 8], 0);              /* mov dword [ebp-0x8], 0x0 */
            ii(0x1013_4003, 5); jmp(0x1013_414b, 0x143); goto l_0x1013_414b; /* jmp 0x1013414b */
        l_0x1013_4008:
            ii(0x1013_4008, 6); cmp(memw[ss, ebp - 4], 0x38e);          /* cmp word [ebp-0x4], 0x38e */
            ii(0x1013_400e, 2); if(jge(0x1013_4019, 9)) goto l_0x1013_4019; /* jge 0x10134019 */
            ii(0x1013_4010, 7); mov(memd[ss, ebp - 12], 0);             /* mov dword [ebp-0xc], 0x0 */
        ...
        l_0x1013_4019:
            ...
            ii(0x1013_402f, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
        l_0x1013_4032:
            ii(0x1013_4032, 4); movsx(eax, memw[ss, ebp - 4]);          /* movsx eax, word [ebp-0x4] */
            ii(0x1013_4036, 3); imul(edx, eax, 7);                      /* imul edx, eax, 0x7 */
            ...
            ii(0x1013_4043, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1013_4046, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x1013_404a, 3); cmp(eax, -1 /* 0xff */);                /* cmp eax, 0xffffffff */
            ii(0x1013_404d, 2); if(jnz(0x1013_405b, 0xc)) goto l_0x1013_405b; /* jnz 0x1013405b */
            ii(0x1013_404f, 7); mov(memd[ss, ebp - 8], 0);              /* mov dword [ebp-0x8], 0x0 */
            ii(0x1013_4056, 5); jmp(0x1013_414b, 0xf0); goto l_0x1013_414b; /* jmp 0x1013414b */
        l_0x1013_405b:
            ii(0x1013_405b, 4); movsx(eax, memw[ss, ebp - 4]);          /* movsx eax, word [ebp-0x4] */
            ii(0x1013_405f, 3); imul(edx, eax, 7);                      /* imul edx, eax, 0x7 */
            ...
            ii(0x1013_4069, 3); mov(eax, memd[ds, eax + 2]);            /* mov eax, [eax+0x2] */
            ii(0x1013_406c, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1013_406f, 4); cmp(memd[ss, ebp - 20], 0);             /* cmp dword [ebp-0x14], 0x0 */
            ii(0x1013_4073, 6); if(jnz(0x1013_4145, 0xcc)) goto l_0x1013_4145; /* jnz 0x10134145 */
            ii(0x1013_4079, 4); movsx(eax, memw[ss, ebp - 4]);          /* movsx eax, word [ebp-0x4] */
            ii(0x1013_407d, 3); imul(eax, eax, 7);                      /* imul eax, eax, 0x7 */
            ...
            ii(0x1013_4088, 3); mov(al, memb[ds, eax + 6]);             /* mov al, [eax+0x6] */
            ii(0x1013_408b, 3); mov(memb[ss, ebp - 24], al);            /* mov [ebp-0x18], al */
            ii(0x1013_408e, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1013_4090, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ii(0x1013_4094, 3); shl(edx, 4);                            /* shl edx, 0x4 */
            ii(0x1013_4097, 5); mov(eax, memd[ds, Definitions.ptr_arr_meta]); /* mov eax, [0x101c70f0] */
            ii(0x1013_409c, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1013_409e, 3); mov(edx, memd[ds, edx + 8]);            /* mov edx, [edx+0x8] */
            ii(0x1013_40a1, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1013_40a3, 3); mov(al, memb[ss, ebp - 24]);            /* mov al, [ebp-0x18] */
            ii(0x1013_40a6, 3); shl(eax, 2);                            /* shl eax, 0x2 */
            ...
            ii(0x1013_40b4, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x1013_40b8, 3); shl(eax, 4);                            /* shl eax, 0x4 */
            ii(0x1013_40bb, 6); mov(edx, memd[ds, Definitions.ptr_arr_meta]); /* mov edx, [0x101c70f0] */
            ii(0x1013_40c1, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1013_40c3, 3); mov(eax, memd[ds, eax + 12]);           /* mov eax, [eax+0xc] */
            ii(0x1013_40c6, 5); call(Definitions.sys_new_arr, 0x3_1f45); /* call 0x10166010 */
            ii(0x1013_40cb, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1013_40ce, 4); cmp(memd[ss, ebp - 20], 0);             /* cmp dword [ebp-0x14], 0x0 */
            ii(0x1013_40d2, 2); if(jnz(0x1013_40de, 0xa)) goto l_0x1013_40de; /* jnz 0x101340de */
            ii(0x1013_40d4, 5); mov(eax, 3);                            /* mov eax, 0x3 */
            ii(0x1013_40d9, 5); call(0x100e_f3a0, -0x4_4d3e);           /* call 0x100ef3a0 */
        l_0x1013_40de:
            ii(0x1013_40de, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1013_40e0, 3); mov(al, memb[ss, ebp - 24]);            /* mov al, [ebp-0x18] */
            ii(0x1013_40e3, 3); shl(eax, 2);                            /* shl eax, 0x2 */
            ii(0x1013_40e6, 6); mov(ecx, memd[ds, eax + Definitions.arr_res_file]); /* mov ecx, [eax+0x101c70d0] */
            ii(0x1013_40ec, 5); mov(ebx, 1);                            /* mov ebx, 0x1 */
            ii(0x1013_40f1, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x1013_40f5, 3); shl(eax, 4);                            /* shl eax, 0x4 */
            ii(0x1013_40f8, 6); mov(edx, memd[ds, Definitions.ptr_arr_meta]); /* mov edx, [0x101c70f0] */
            ii(0x1013_40fe, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1013_4100, 3); mov(edx, memd[ds, eax + 12]);           /* mov edx, [eax+0xc] */
            ii(0x1013_4103, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ...
            ii(0x1013_410f, 5); mov(eax, 7);                            /* mov eax, 0x7 */
            ii(0x1013_4114, 5); call(0x100e_f3a0, -0x4_4d79);           /* call 0x100ef3a0 */
        l_0x1013_4119:
            ii(0x1013_4119, 4); movsx(edx, memw[ss, ebp - 4]);          /* movsx edx, word [ebp-0x4] */
            ii(0x1013_411d, 3); imul(edx, edx, 7);                      /* imul edx, edx, 0x7 */
            ...
            ii(0x1013_4127, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x1013_412a, 3); mov(memd[ds, edx + 2], eax);            /* mov [edx+0x2], eax */
            ii(0x1013_412d, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x1013_4131, 3); shl(eax, 4);                            /* shl eax, 0x4 */
            ii(0x1013_4134, 6); mov(edx, memd[ds, Definitions.ptr_arr_meta]); /* mov edx, [0x101c70f0] */
            ii(0x1013_413a, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1013_413c, 3); mov(eax, memd[ds, eax + 12]);           /* mov eax, [eax+0xc] */
            ii(0x1013_413f, 6); add(memd[ds, 0x101c_70dc], eax);        /* add [0x101c70dc], eax */
        l_0x1013_4145:
            ii(0x1013_4145, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x1013_4148, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
        l_0x1013_414b:
            ii(0x1013_414b, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
