...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_a26b()
        {
            ...
            ii(0x1010_a27c, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1010_a282, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_a285, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1010_a288, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_a28b, 2);  mov(edx, memd[ds, eax]);              /* mov edx, [eax] */
            ii(0x1010_a28d, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1010_a291, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x1010_a294, 3);  add(eax, memd[ss, ebp - 8]);          /* add eax, [ebp-0x8] */
            ii(0x1010_a297, 6);  mov(eax, memd[ds, eax + 880]);        /* mov eax, [eax+0x370] */
            ...
            ii(0x1010_a2ad, 5);  mov(ecx, 1);                          /* mov ecx, 0x1 */
            ii(0x1010_a2b2, 5);  mov(ebx, 0x1_0002);                   /* mov ebx, 0x10002 */
            ii(0x1010_a2b7, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1010_a2c5, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
