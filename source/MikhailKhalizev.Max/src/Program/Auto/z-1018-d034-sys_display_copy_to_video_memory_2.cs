...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ sys_display_copy_to_video_memory_2()
        {
            ...
            ii(0x1018_d040, 3); mov(eax, memd[ss, ebp + 0x1c]);         /* mov eax, [ebp+0x1c] */
            ii(0x1018_d043, 3); shr(eax, 0x2);                          /* shr eax, 0x2 */
            ii(0x1018_d046, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1018_d049, 3); mov(eax, memd[ss, ebp + 0xc]);          /* mov eax, [ebp+0xc] */
            ii(0x1018_d04c, 3); sub(eax, memd[ss, ebp + 0x1c]);         /* sub eax, [ebp+0x1c] */
            ii(0x1018_d04f, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1018_d052, 5); mov(eax, memd[ds, 0x1020_88f8]);        /* mov eax, [0x102088f8] */
            ii(0x1018_d057, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1018_d05a, 3); sub(eax, memd[ss, ebp + 0x1c]);         /* sub eax, [ebp+0x1c] */
            ii(0x1018_d05d, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1018_d060, 3); mov(eax, memd[ss, ebp + 0x18]);         /* mov eax, [ebp+0x18] */
            ii(0x1018_d063, 3); mul(memd[ss, ebp + 0xc]);               /* mul dword [ebp+0xc] */
            ii(0x1018_d066, 3); add(eax, memd[ss, ebp + 0x14]);         /* add eax, [ebp+0x14] */
            ii(0x1018_d069, 3); add(memd[ss, ebp + 0x8], eax);          /* add [ebp+0x8], eax */
            ...
            ii(0x1018_d07b, 3); mov(eax, memd[ss, ebp + 0x28]);         /* mov eax, [ebp+0x28] */
            ii(0x1018_d07e, 3); mul(memd[ss, ebp - 0x10]);              /* mul dword [ebp-0x10] */
            ii(0x1018_d081, 3); add(eax, memd[ss, ebp + 0x24]);         /* add eax, [ebp+0x24] */
            ii(0x1018_d084, 2); add(edi, eax);                          /* add edi, eax */
            ii(0x1018_d086, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1018_d089, 3); mov(edx, memd[ss, ebp - 0x14]);         /* mov edx, [ebp-0x14] */
            ii(0x1018_d08c, 3); mov(esi, memd[ss, ebp + 0x8]);          /* mov esi, [ebp+0x8] */
            ii(0x1018_d08f, 3); mov(ebx, memd[ss, ebp + 0x20]);         /* mov ebx, [ebp+0x20] */
        l_0x1018_d092:
            ii(0x1018_d092, 3); mov(ecx, memd[ss, ebp - 0x8]);          /* mov ecx, [ebp-0x8] */
        ...
        l_0x1018_d0a3:
            ii(0x1018_d0a3, 3); mov(esi, memd[ss, ebp + 0x8]);          /* mov esi, [ebp+0x8] */
            ii(0x1018_d0a6, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1018_d0a9, 3); mul(memd[ss, ebp + 0x28]);              /* mul dword [ebp+0x28] */
            ii(0x1018_d0ac, 3); add(eax, memd[ss, ebp + 0x24]);         /* add eax, [ebp+0x24] */
            ii(0x1018_d0af, 5); mov(edx, 0);                            /* mov edx, 0x0 */
            ii(0x1018_d0b4, 6); div(memd[ds, 0x1020_8908]);             /* div dword [0x10208908] */
            ii(0x1018_d0ba, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x1018_d0cd, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x1018_d0d6:
            ...
            ii(0x1018_d0dd, 3); add(eax, memd[ss, ebp - 0x10]);         /* add eax, [ebp-0x10] */
            ii(0x1018_d0e0, 3); sub(eax, memd[ss, ebp + 0x1c]);         /* sub eax, [ebp+0x1c] */
            ii(0x1018_d0e3, 5); mov(edx, 0);                            /* mov edx, 0x0 */
            ii(0x1018_d0e8, 3); div(memd[ss, ebp - 0x10]);              /* div dword [ebp-0x10] */
            ii(0x1018_d0eb, 3); cmp(memd[ss, ebp + 0x20], eax);         /* cmp [ebp+0x20], eax */
            ii(0x1018_d0ee, 2); if(jae(0x1018_d0f3, 0x3)) goto l_0x1018_d0f3; /* jae 0x1018d0f3 */
            ii(0x1018_d0f0, 3); mov(eax, memd[ss, ebp + 0x20]);         /* mov eax, [ebp+0x20] */
        l_0x1018_d0f3:
            ii(0x1018_d0f3, 2); or(eax, eax);                           /* or eax, eax */
            ii(0x1018_d0f5, 2); if(jz(0x1018_d10c, 0x15)) goto l_0x1018_d10c; /* jz 0x1018d10c */
            ii(0x1018_d0f7, 3); sub(memd[ss, ebp + 0x20], eax);         /* sub [ebp+0x20], eax */
            ii(0x1018_d0fa, 3); mov(ebx, memd[ss, ebp - 0xc]);          /* mov ebx, [ebp-0xc] */
            ii(0x1018_d0fd, 3); mov(edx, memd[ss, ebp - 0x14]);         /* mov edx, [ebp-0x14] */
        l_0x1018_d100:
            ii(0x1018_d100, 3); mov(ecx, memd[ss, ebp - 0x8]);          /* mov ecx, [ebp-0x8] */
        ...
        l_0x1018_d10c:
            ii(0x1018_d10c, 3); or(eax, memd[ss, ebp + 0x20]);          /* or eax, [ebp+0x20] */
            ...
            ii(0x1018_d11c, 2); if(jns(0x1018_d123, 0x5)) goto l_0x1018_d123; /* jns 0x1018d123 */
        ...
        l_0x1018_d123:
            ...
            ii(0x1018_d12b, 3); add(memd[ss, ebp - 0x4], eax);          /* add [ebp-0x4], eax */
            ...
            ii(0x1018_d13c, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1018_d13f, 6); call_abs(memd[ds, 0x1020_88fc]);        /* call dword [0x102088fc] */ /* Вызов '0x1018_cda8'. */
            ii(0x1018_d145, 1); pop(eax);                               /* pop eax */
            ii(0x1018_d146, 3); mov(ecx, memd[ss, ebp - 0x8]);          /* mov ecx, [ebp-0x8] */
            ii(0x1018_d149, 2); sub(ecx, eax);                          /* sub ecx, eax */
            ii(0x1018_d14b, 2); rep(() => movsd());                     /* rep movsd */
            ii(0x1018_d14d, 3); add(esi, memd[ss, ebp - 0xc]);          /* add esi, [ebp-0xc] */
            ii(0x1018_d150, 3); add(edi, memd[ss, ebp - 0x14]);         /* add edi, [ebp-0x14] */
            ii(0x1018_d153, 3); dec(memd[ss, ebp + 0x20]);              /* dec dword [ebp+0x20] */
