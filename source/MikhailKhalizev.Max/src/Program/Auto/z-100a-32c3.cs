...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_32c3()
        {
            ...
            ii(0x100a_32e5, 3); mov(al, memb[ds, edx + 38]);            /* mov al, [edx+0x26] */
            ...
            ii(0x100a_32f5, 3); mov(memd[ss, ebp - 12], edx);           /* mov [ebp-0xc], edx */
            ii(0x100a_32f8, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x100a_32fb, 3); mov(ebx, memd[ds, edx + 26]);           /* mov ebx, [edx+0x1a] */
            ii(0x100a_32fe, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100a_3301, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x100a_3304, 3); mov(edx, memd[ds, edx + 24]);           /* mov edx, [edx+0x18] */
            ii(0x100a_3307, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100a_330a, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ...
            ii(0x100a_3317, 3); mov(al, memb[ds, edx + 77]);            /* mov al, [edx+0x4d] */
            ii(0x100a_331a, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ...
            ii(0x100a_3329, 4); mov(memb[ss, ebp - 24], 1);             /* mov byte [ebp-0x18], 0x1 */
        ...
        l_0x100a_3332:
            ...
            ii(0x100a_3338, 7); mov(memd[ss, ebp - 20], 1);             /* mov dword [ebp-0x14], 0x1 */
        l_0x100a_333f:
            ...
            ii(0x100a_3349, 3); lea(edx, memd[ss, ebp - 16]);           /* lea edx, [ebp-0x10] */
            ii(0x100a_334c, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ii(0x100a_334f, 5); call(0x1007_5e64, -0x2_d4f0);           /* call 0x10075e64 */
            ii(0x100a_3354, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x100a_3357, 3); mov(esi, memd[ss, ebp - 12]);           /* mov esi, [ebp-0xc] */
            ...
            ii(0x100a_3363, 4); cmp(ax, memw[ss, ebp - 20]);            /* cmp ax, [ebp-0x14] */
            ii(0x100a_3367, 2); if(jge(0x100a_3372, 9)) goto l_0x100a_3372; /* jge 0x100a3372 */
            ii(0x100a_3369, 4); mov(memb[ss, ebp - 24], 0);             /* mov byte [ebp-0x18], 0x0 */
        ...
        l_0x100a_3372:
            ...
            ii(0x100a_3375, 3); mov(al, memb[ds, eax + 78]);            /* mov al, [eax+0x4e] */
            ...
            ii(0x100a_3381, 4); mov(memb[ss, ebp - 24], 1);             /* mov byte [ebp-0x18], 0x1 */
        ...
        l_0x100a_338a:
            ...
            ii(0x100a_3396, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100a_3399, 5); call(0x100c_1fd4, 0x1_ec36);            /* call 0x100c1fd4 */
            ii(0x100a_339e, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
            ii(0x100a_33a1, 4); cmp(memd[ss, ebp - 32], 0);             /* cmp dword [ebp-0x20], 0x0 */
            ii(0x100a_33a5, 2); if(jnz(0x100a_33b0, 9)) goto l_0x100a_33b0; /* jnz 0x100a33b0 */
            ii(0x100a_33a7, 4); mov(memb[ss, ebp - 24], 0);             /* mov byte [ebp-0x18], 0x0 */
        ...
        l_0x100a_33b0:
            ...
            ii(0x100a_33b3, 3); mov(al, memb[ds, eax + 78]);            /* mov al, [eax+0x4e] */
            ii(0x100a_33b6, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x100a_33b8, 3); movsx(ebx, ax);                         /* movsx ebx, ax */
            ii(0x100a_33bb, 3); lea(edx, memd[ss, ebp - 16]);           /* lea edx, [ebp-0x10] */
            ii(0x100a_33be, 3); lea(eax, memd[ss, ebp - 36]);           /* lea eax, [ebp-0x24] */
            ii(0x100a_33c1, 5); call(0x1007_5e64, -0x2_d562);           /* call 0x10075e64 */
            ii(0x100a_33c6, 3); lea(ecx, memd[ss, ebp - 52]);           /* lea ecx, [ebp-0x34] */
        ...
        l_0x100a_33d2:
            ii(0x100a_33d2, 3); lea(eax, memd[ss, ebp - 52]);           /* lea eax, [ebp-0x34] */
            ...
            ii(0x100a_33e0, 3); add(edx, memd[ss, ebp - 32]);           /* add edx, [ebp-0x20] */
            ii(0x100a_33e3, 3); lea(eax, memd[ss, ebp - 52]);           /* lea eax, [ebp-0x34] */
            ...
            ii(0x100a_33f5, 4); cmp(ax, memw[ss, ebp - 20]);            /* cmp ax, [ebp-0x14] */
            ...
            ii(0x100a_3401, 3); lea(eax, memd[ss, ebp - 52]);           /* lea eax, [ebp-0x34] */
            ii(0x100a_3404, 5); call(0x1008_982c, -0x1_9bdd);           /* call 0x1008982c */
            ii(0x100a_3409, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x100a_340c, 3); lea(eax, memd[ss, ebp - 52]);           /* lea eax, [ebp-0x34] */
            ...
            ii(0x100a_341a, 3); mov(al, memb[ds, eax + 38]);            /* mov al, [eax+0x26] */
        ...
        l_0x100a_3437:
            ii(0x100a_3437, 4); mov(memb[ss, ebp - 24], 0);             /* mov byte [ebp-0x18], 0x0 */
            ii(0x100a_343b, 2); jmp(0x100a_345f, 0x22); goto l_0x100a_345f; /* jmp 0x100a345f */
        l_0x100a_343d:
            ii(0x100a_343d, 3); lea(eax, memd[ss, ebp - 52]);           /* lea eax, [ebp-0x34] */
            ...
            ii(0x100a_345b, 4); mov(memb[ss, ebp - 24], 1);             /* mov byte [ebp-0x18], 0x1 */
        l_0x100a_345f:
            ii(0x100a_345f, 3); mov(al, memb[ss, ebp - 24]);            /* mov al, [ebp-0x18] */
