...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_32c3()
        {
            ...
            ii(0x100a_32da, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_32dd, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x100a_32e0, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x100a_32f8, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100a_32fb, 3); mov(ebx, memd[ds, edx + 0x1a]);         /* mov ebx, [edx+0x1a] */
            ii(0x100a_32fe, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100a_3301, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x100a_3314, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100a_3317, 3); mov(al, memb[ds, edx + 0x4d]);          /* mov al, [edx+0x4d] */
            ii(0x100a_331a, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100a_331d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_3320, 5); call(0x1008_aa80, -0x1_88a5);           /* call 0x1008aa80 */
            ii(0x100a_3325, 2); test(al, 0x1);                          /* test al, 0x1 */
            ii(0x100a_3327, 2); if(jz(0x100a_3332, 0x9)) goto l_0x100a_3332; /* jz 0x100a3332 */
            ii(0x100a_3329, 4); mov(memb[ss, ebp - 0x18], 0x1);         /* mov byte [ebp-0x18], 0x1 */
            ii(0x100a_332d, 5); jmp(0x100a_345f, 0x12d); goto l_0x100a_345f; /* jmp 0x100a345f */
        l_0x100a_3332:
            ii(0x100a_3332, 4); cmp(memb[ss, ebp - 0x4], 0x3);          /* cmp byte [ebp-0x4], 0x3 */
            ii(0x100a_3336, 2); if(jnz(0x100a_333f, 0x7)) goto l_0x100a_333f; /* jnz 0x100a333f */
            ii(0x100a_3338, 7); mov(memd[ss, ebp - 0x14], 0x1);         /* mov dword [ebp-0x14], 0x1 */
        l_0x100a_333f:
            ii(0x100a_333f, 5); mov(eax, 0x1);                          /* mov eax, 0x1 */
            ii(0x100a_3344, 1); push(eax);                              /* push eax */
            ii(0x100a_3345, 4); movsx(ecx, memb[ss, ebp - 0x4]);        /* movsx ecx, byte [ebp-0x4] */
            ...
            ii(0x100a_3354, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x100a_3367, 2); if(jge(0x100a_3372, 0x9)) goto l_0x100a_3372; /* jge 0x100a3372 */
        ...
        l_0x100a_3372:
            ii(0x100a_3372, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_337f, 2); if(jnz(0x100a_338a, 0x9)) goto l_0x100a_338a; /* jnz 0x100a338a */
            ii(0x100a_3381, 4); mov(memb[ss, ebp - 0x18], 0x1);         /* mov byte [ebp-0x18], 0x1 */
            ii(0x100a_3385, 5); jmp(0x100a_345f, 0xd5); goto l_0x100a_345f; /* jmp 0x100a345f */
        l_0x100a_338a:
            ii(0x100a_338a, 5); mov(ecx, 0x1);                          /* mov ecx, 0x1 */
            ii(0x100a_338f, 4); movsx(ebx, memb[ss, ebp - 0x4]);        /* movsx ebx, byte [ebp-0x4] */
            ii(0x100a_3393, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x100a_33a5, 2); if(jnz(0x100a_33b0, 0x9)) goto l_0x100a_33b0; /* jnz 0x100a33b0 */
        ...
        l_0x100a_33b0:
            ii(0x100a_33b0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100a_33d2:
            ...
            ii(0x100a_3417, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_3422, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_3425, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x100a_3433, 2); if(jnz(0x100a_3437, 0x2)) goto l_0x100a_3437; /* jnz 0x100a3437 */
        l_0x100a_3435:
            ii(0x100a_3435, 2); jmp(0x100a_343d, 0x6); goto l_0x100a_343d; /* jmp 0x100a343d */
        l_0x100a_3437:
        ...
        l_0x100a_343d:
            ...
            ii(0x100a_3453, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_3456, 5); call(0x100a_b120, 0x7cc5);              /* call 0x100ab120 */
            ii(0x100a_345b, 4); mov(memb[ss, ebp - 0x18], 0x1);         /* mov byte [ebp-0x18], 0x1 */
        l_0x100a_345f:
