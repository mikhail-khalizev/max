...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_d94c()
        {
            ...
            ii(0x1007_d962, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1007_d965, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1007_d968, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
