...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_4788()
        {
            ...
            ii(0x1016_479f, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1016_47a2, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1016_47a5, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_47a8, 2); mov(ebx, memd[ds, eax]);                /* mov ebx, [eax] */
            ii(0x1016_47aa, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1016_47ad, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1016_47b0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_47b3, 5); call(0x1016_47c0, 0x8);                 /* call 0x101647c0 */
