...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_e116()
        {
            ...
            ii(0x1017_e122, 3); mov(memd[ss, ebp - 0x2c], eax);         /* mov [ebp-0x2c], eax */
            ii(0x1017_e125, 4); mov(memw[ss, ebp - 0x30], cx);          /* mov [ebp-0x30], cx */
            ii(0x1017_e129, 3); mov(memd[ss, ebp - 0x34], ebx);         /* mov [ebp-0x34], ebx */
            ii(0x1017_e12c, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1017_e133, 7); mov(memd[ss, ebp - 0x14], 0x30);        /* mov dword [ebp-0x14], 0x30 */
            ii(0x1017_e13a, 7); mov(memd[ss, ebp - 0x20], 0);           /* mov dword [ebp-0x20], 0x0 */
            ii(0x1017_e141, 7); mov(memd[ss, ebp - 0x24], 0);           /* mov dword [ebp-0x24], 0x0 */
            ii(0x1017_e148, 4); cmp(memd[ss, ebp - 0x34], 0);           /* cmp dword [ebp-0x34], 0x0 */
            ii(0x1017_e14c, 2); if(jnz(0x1017_e161, 0x13)) goto l_0x1017_e161; /* jnz 0x1017e161 */
            ii(0x1017_e14e, 5); cmp(memw[ss, ebp - 0x30], 0);           /* cmp word [ebp-0x30], 0x0 */
            ii(0x1017_e153, 2); if(jnz(0x1017_e161, 0xc)) goto l_0x1017_e161; /* jnz 0x1017e161 */
            ii(0x1017_e155, 7); mov(memd[ss, ebp - 0x28], 0x2);         /* mov dword [ebp-0x28], 0x2 */
            ii(0x1017_e15c, 5); jmp(0x1017_e387, 0x226); goto l_0x1017_e387; /* jmp 0x1017e387 */
        l_0x1017_e161:
            ii(0x1017_e161, 7); cmp(memd[ss, ebp - 0x2c], 0xe000);      /* cmp dword [ebp-0x2c], 0xe000 */
            ii(0x1017_e168, 2); if(jb(0x1017_e173, 0x9)) goto l_0x1017_e173; /* jb 0x1017e173 */
            ii(0x1017_e16a, 7); cmp(memd[ss, ebp - 0x2c], 0xe200);      /* cmp dword [ebp-0x2c], 0xe200 */
            ii(0x1017_e171, 2); if(jbe(0x1017_e17f, 0xc)) goto l_0x1017_e17f; /* jbe 0x1017e17f */
        l_0x1017_e173:
            ii(0x1017_e173, 7); mov(memd[ss, ebp - 0x28], 0x6);         /* mov dword [ebp-0x28], 0x6 */
            ii(0x1017_e17a, 5); jmp(0x1017_e387, 0x208); goto l_0x1017_e387; /* jmp 0x1017e387 */
        l_0x1017_e17f:
            ii(0x1017_e17f, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1017_e186, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
        ...
        l_0x1017_e1af:
            ii(0x1017_e1af, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1017_e1b2, 6); cmp(eax, memd[ds, 0x1020_a12c]);        /* cmp eax, [0x1020a12c] */
            ii(0x1017_e1b8, 2); if(ja(0x1017_e1c0, 0x6)) goto l_0x1017_e1c0; /* ja 0x1017e1c0 */
            ii(0x1017_e1ba, 4); cmp(memd[ss, ebp - 0xc], 0);            /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1017_e1be, 2); if(jz(0x1017_e1c5, 0x5)) goto l_0x1017_e1c5; /* jz 0x1017e1c5 */
        l_0x1017_e1c0:
        ...
        l_0x1017_e1c5:
            ...
            ii(0x1017_e1d6, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1017_e1d9, 3); mov(ebx, memd[ss, ebp - 0x14]);         /* mov ebx, [ebp-0x14] */
            ...
            ii(0x1017_e1f0, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1017_e1f3, 5); mov(eax, memd[ds, 0x1020_a104]);        /* mov eax, [0x1020a104] */
            ii(0x1017_e1f8, 3); cmp(eax, memd[ss, ebp - 0x2c]);         /* cmp eax, [ebp-0x2c] */
            ii(0x1017_e1fb, 2); if(jnz(0x1017_e206, 0x9)) goto l_0x1017_e206; /* jnz 0x1017e206 */
            ii(0x1017_e1fd, 7); test(memb[ds, 0x1020_a109], 0x80);      /* test byte [0x1020a109], 0x80 */
            ii(0x1017_e204, 2); if(jnz(0x1017_e208, 0x2)) goto l_0x1017_e208; /* jnz 0x1017e208 */
        l_0x1017_e206:
            ii(0x1017_e206, 2); jmp(0x1017_e235, 0x2d); goto l_0x1017_e235; /* jmp 0x1017e235 */
        l_0x1017_e208:
            ii(0x1017_e208, 7); mov(memd[ss, ebp - 0xc], 0x1);          /* mov dword [ebp-0xc], 0x1 */
            ii(0x1017_e20f, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1017_e212, 1); push(eax);                              /* push eax */
            ii(0x1017_e213, 3); mov(esi, memd[ss, ebp - 0x4]);          /* mov esi, [ebp-0x4] */
        ...
        l_0x1017_e235:
            ...
            ii(0x1017_e23a, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x1017_e247:
            ii(0x1017_e247, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
            ii(0x1017_e24a, 5); jmp(0x1017_e1af, -0xa0); goto l_0x1017_e1af; /* jmp 0x1017e1af */
        l_0x1017_e24f:
            ii(0x1017_e24f, 4); cmp(memd[ss, ebp - 0xc], 0x1);          /* cmp dword [ebp-0xc], 0x1 */
            ...
            ii(0x1017_e289, 7); test(memb[ds, 0x1020_a17d], 0x1);       /* test byte [0x1020a17d], 0x1 */
            ...
            ii(0x1017_e2b6, 7); mov(memd[ss, ebp - 0x20], 0);           /* mov dword [ebp-0x20], 0x0 */
        l_0x1017_e2bd:
            ii(0x1017_e2bd, 3); push(memd[ss, ebp - 0x20]);             /* push dword [ebp-0x20] */
            ...
            ii(0x1017_e2cc, 3); push(memd[ss, ebp - 0x20]);             /* push dword [ebp-0x20] */
            ...
            ii(0x1017_e2dc, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x1017_e2df, 3); push(memd[ss, ebp - 0x24]);             /* push dword [ebp-0x24] */
            ii(0x1017_e2e2, 3); push(memd[ss, ebp - 0x20]);             /* push dword [ebp-0x20] */
            ii(0x1017_e2e5, 5); call(/* sys */ 0x1019_5231, 0x1_6f47);  /* call 0x10195231 */
            ii(0x1017_e2ea, 3); add(esp, 0x8);                          /* add esp, 0x8 */
            ii(0x1017_e2ed, 3); inc(memd[ss, ebp - 0x20]);              /* inc dword [ebp-0x20] */
        ...
        l_0x1017_e2f2:
            ...
            ii(0x1017_e316, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1017_e319, 4); cmp(memd[ss, ebp - 0x10], 0);           /* cmp dword [ebp-0x10], 0x0 */
            ii(0x1017_e31d, 2); if(jz(0x1017_e377, 0x58)) goto l_0x1017_e377; /* jz 0x1017e377 */
            ii(0x1017_e31f, 4); movzx(eax, memw[ss, ebp - 0x30]);       /* movzx eax, word [ebp-0x30] */
            ii(0x1017_e323, 1); push(eax);                              /* push eax */
            ii(0x1017_e324, 3); push(memd[ss, ebp - 0x34]);             /* push dword [ebp-0x34] */
            ...
            ii(0x1017_e34b, 3); mov(eax, memd[ss, ebp - 0x30]);         /* mov eax, [ebp-0x30] */
            ii(0x1017_e34e, 6); mov(memw[ds, 0x1020_a1b4], ax);         /* mov [0x1020a1b4], ax */
            ii(0x1017_e354, 3); mov(eax, memd[ss, ebp - 0x34]);         /* mov eax, [ebp-0x34] */
            ii(0x1017_e357, 5); mov(memd[ds, 0x1020_a1b0], eax);        /* mov [0x1020a1b0], eax */
            ii(0x1017_e35c, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1017_e35f, 4); lgs(edx, memd[ss, ebp + 0x14]);         /* lgs edx, [ebp+0x14] */
            ii(0x1017_e363, 3); mov(memd[gs, edx], eax);                /* mov [gs:edx], eax */
            ii(0x1017_e366, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1017_e369, 5); mov(memd[ds, 0x1020_a138], eax);        /* mov [0x1020a138], eax */
            ii(0x1017_e36e, 7); mov(memd[ss, ebp - 0x28], 0);           /* mov dword [ebp-0x28], 0x0 */
            ii(0x1017_e375, 2); jmp(0x1017_e387, 0x10); goto l_0x1017_e387; /* jmp 0x1017e387 */
        l_0x1017_e377:
            ii(0x1017_e377, 7); mov(memd[ss, ebp - 0x28], 0x8);         /* mov dword [ebp-0x28], 0x8 */
            ii(0x1017_e37e, 2); jmp(0x1017_e387, 0x7); goto l_0x1017_e387; /* jmp 0x1017e387 */
        l_0x1017_e380:
            ii(0x1017_e380, 7); mov(memd[ss, ebp - 0x28], 0x7);         /* mov dword [ebp-0x28], 0x7 */
        l_0x1017_e387:
            ii(0x1017_e387, 3); mov(eax, memd[ss, ebp - 0x28]);         /* mov eax, [ebp-0x28] */
            ...
            ii(0x1017_e38e, 3); ret(0x8);                               /* ret 0x8 */
        }
    }
}
