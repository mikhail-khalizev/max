...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_267a()
        {
            ...
            ii(0x100a_2692, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_2695, 5); mov(ebx, StringDefinitions.Computer);   /* mov ebx, 0x101a0c17 */
            ii(0x100a_269a, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ...
            ii(0x100a_26ac, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100a_26c2, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x100a_26c5, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
