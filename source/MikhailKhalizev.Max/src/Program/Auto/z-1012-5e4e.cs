...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_5e4e()
        {
            ...
            ii(0x1012_5e65, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_5e68, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1012_5e6b, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_5e6e, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1012_5e71, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1012_5e74, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_5e77, 5);  call(0x1012_5d66, -0x116);            /* call 0x10125d66 */
            ii(0x1012_5e7c, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1012_5e88, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1012_5e8b, 6);  mov(memw[ds, eax + 5], 0);            /* mov word [eax+0x5], 0x0 */
            ii(0x1012_5e91, 2);  jmp(0x1012_5ea9, 0x16); goto l_0x1012_5ea9;/* jmp 0x10125ea9 */
        l_0x1012_5e93:
            ii(0x1012_5e93, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1012_5ea2, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1012_5ea5, 4);  mov(memw[ds, eax + 5], dx);           /* mov [eax+0x5], dx */
        l_0x1012_5ea9:
            ii(0x1012_5ea9, 7);  mov(memd[ss, ebp - 12], 7);           /* mov dword [ebp-0xc], 0x7 */
            ii(0x1012_5eb0, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
