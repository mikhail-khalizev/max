...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_ac03()
        {
            ...
            ii(0x1013_ac1a, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_ac1d, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_ac20, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_ac23, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x1013_ac25, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_ac28, 2); mov(memd[ds, eax], edx);                /* mov [eax], edx */
            ii(0x1013_ac2a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_ac2d, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1013_ac2f, 5); call(0x1013_ae28, 0x1f4);               /* call 0x1013ae28 */
            ii(0x1013_ac34, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_ac37, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1013_ac3a, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
