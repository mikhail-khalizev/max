...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("761ceef7-ce8e-49f3-9482-1cf937608950")]
        public void Method_0000_9076_v2()
        {
            ...
            ii(0x95c0, 2);    xor(cx, cx);                              /* xor cx, cx */
            ii(0x95c2, 2);    mov(di, ax);                              /* mov di, ax */
            ii(0x95c4, 2);    test(ax, ax);                             /* test ax, ax */
            ii(0x95c6, 2);    if(jnzw(0x95cf, 0x7)) goto l_0x95cf;      /* jnz 0x95cf */
            ii(0x95c8, 2);    xor(si, si);                              /* xor si, si */
            ii(0x95ca, 3);    jmpw(0x9ba8, 0x5db); goto l_0x9ba8;       /* jmp 0x9ba8 */
        //    ii(0x95cd, 2);    add(memb_a16[ds, bx + si], al);           /* add [bx+si], al */
        l_0x95cf:
            ii(0x95cf, 2);    xor(si, si);                              /* xor si, si */
            ii(0x95d1, 2);    xor(dx, dx);                              /* xor dx, dx */
        l_0x95d3:
            ii(0x95d3, 2);    mov(ax, di);                              /* mov ax, di */
            ii(0x95d5, 3);    callw(0x1_0566, 0x6f8e);                  /* call 0x566 */
            ii(0x95d8, 2);    add(memb_a16[ds, bx + si], al);           /* add [bx+si], al */
            ii(0x95da, 4);    mov(memw_a16[ds, si + 0x14], ax);         /* mov [si+0x14], ax */
            ii(0x95de, 2);    add(memw_a16[ds, bx + si], ax);           /* add [bx+si], ax */
            ii(0x95e0, 4);    add(memb_a16[ss, bp + di - 0x8], al);     /* add [bp+di-0x8], al */
            ii(0x95e4, 2);    if(jzw(0x95ef, 0x9)) goto l_0x95ef;       /* jz 0x95ef */
            ii(0x95e6, 3);    add(dx, 0x4);                             /* add dx, 0x4 */
            ii(0x95e9, 1);    inc(si);                                  /* inc si */
            ii(0x95ea, 3);    cmp(dx, 0x10);                            /* cmp dx, 0x10 */
            ii(0x95ed, 2);    if(jlw(0x95d3, -0x1c)) goto l_0x95d3;     /* jl 0x95d3 */
        l_0x95ef:
            ii(0x95ef, 3);    cmp(si, 0x4);                             /* cmp si, 0x4 */
            ii(0x95f2, 2);    if(jgew(0x960c, 0x18)) goto l_0x960c;     /* jge 0x960c */
            ii(0x95f4, 2);    mov(ax, di);                              /* mov ax, di */
            ii(0x95f6, 3);    callw(0x2536, -0x70c3);                   /* call 0x2536 */
            ii(0x95f9, 2);    add(memb_a16[ds, bx + si], al);           /* add [bx+si], al */
            ii(0x95fb, 2);    xor(si, si);                              /* xor si, si */
            ii(0x95fd, 2);    mov(ax, si);                              /* mov ax, si */
            ii(0x95ff, 4);    add(sp, 0x12c);                           /* add sp, 0x12c */
            ii(0x9603, 2);    add(memb_a16[ds, bx + si], al);           /* add [bx+si], al */
            ii(0x9605, 1);    popw(bp);                                 /* pop bp */
            ii(0x9606, 1);    popw(di);                                 /* pop di */
            ii(0x9607, 1);    popw(si);                                 /* pop si */
            ii(0x9608, 1);    popw(dx);                                 /* pop dx */
            ii(0x9609, 1);    popw(cx);                                 /* pop cx */
            ii(0x960a, 1);    popw(bx);                                 /* pop bx */
            ii(0x960b, 1);    retw(); return;                           /* ret */
        l_0x960c:
            ii(0x960c, 4);    mov(ax, memw_a16[ds, si + 0x424]);        /* mov ax, [si+0x424] */
            ii(0x9610, 2);    add(memw_a16[ds, bx + si], ax);           /* add [bx+si], ax */
            ii(0x9612, 4);    add(memb_a16[ds, bx + di + 0x2484], cl);  /* add [bx+di+0x2484], cl */
            ii(0x9616, 2);    add(memb_a16[ds, bx + di], al);           /* add [bx+di], al */
            ii(0x9618, 2);    add(memb_a16[ds, bx + si], al);           /* add [bx+si], al */
            ii(0x961a, 4);    mov(ax, memw_a16[ds, si + 0x824]);        /* mov ax, [si+0x824] */
            ii(0x961e, 2);    add(memw_a16[ds, bx + si], ax);           /* add [bx+si], ax */
            ii(0x9620, 4);    add(memb_a16[ds, bx + di + 0x2484], cl);  /* add [bx+di+0x2484], cl */
            ii(0x9624, 2);    add(al, 0x1);                             /* add al, 0x1 */
            ii(0x9626, 2);    add(memb_a16[ds, bx + si], al);           /* add [bx+si], al */
            ii(0x9628, 4);    mov(ax, memw_a16[ds, si + 0xc24]);        /* mov ax, [si+0xc24] */
            ii(0x962c, 2);    add(memw_a16[ds, bx + si], ax);           /* add [bx+si], ax */
            ii(0x962e, 4);    add(memb_a16[ds, bx + di + 0x2484], cl);  /* add [bx+di+0x2484], cl */
            ii(0x9632, 2);    or(memb_a16[ds, bx + di], al);            /* or [bx+di], al */
            ii(0x9634, 2);    add(memb_a16[ds, bx + si], al);           /* add [bx+si], al */
            ii(0x9636, 2);    mov(ax, di);                              /* mov ax, di */
            ii(0x9638, 3);    callw(0x1_0566, 0x6f2b);                  /* call 0x566 */
            ii(0x963b, 2);    add(memb_a16[ds, bx + si], al);           /* add [bx+si], al */
            ii(0x963d, 4);    mov(memw_a16[ds, si + 0xc24], ax);        /* mov [si+0xc24], ax */
            ii(0x9641, 2);    add(memw_a16[ds, bx + si], ax);           /* add [bx+si], ax */
            ii(0x9643, 4);    add(memb_a16[ss, bp + di - 0x8], al);     /* add [bp+di-0x8], al */
            ii(0x9647, 2);    if(jzw(0x966c, 0x23)) goto l_0x966c;      /* jz 0x966c */
            ii(0x9649, 5);    cmp(memw_a16[ds, si + 0x24], 0x1);        /* cmp word [si+0x24], 0x1 */
            ii(0x964e, 2);    add(memb_a16[ds, bx + si], al);           /* add [bx+si], al */
            ii(0x9650, 1);    inc(dx);                                  /* inc dx */
            ii(0x9651, 2);    if(jnzw(0x960c, -0x47)) goto l_0x960c;    /* jnz 0x960c */
            ii(0x9653, 5);    cmp(memw_a16[ds, si + 0x424], 0x1);       /* cmp word [si+0x424], 0x1 */
            ii(0x9658, 2);    add(memb_a16[ds, bx + si], al);           /* add [bx+si], al */
            ii(0x965a, 1);    dec(bp);                                  /* dec bp */
            ii(0x965b, 2);    if(jnzw(0x960c, -0x51)) goto l_0x960c;    /* jnz 0x960c */
            ii(0x965d, 5);    cmp(memw_a16[ds, si + 0x824], 0x1);       /* cmp word [si+0x824], 0x1 */
            ii(0x9662, 2);    add(memb_a16[ds, bx + si], al);           /* add [bx+si], al */
            ii(0x9664, 1);    dec(ax);                                  /* dec ax */
            ii(0x9665, 2);    if(jnzw(0x960c, -0x5b)) goto l_0x960c;    /* jnz 0x960c */
            ii(0x9667, 3);    cmp(ax, 0x44);                            /* cmp ax, 0x44 */
            ii(0x966a, 2);    if(jnzw(0x960c, -0x60)) goto l_0x960c;    /* jnz 0x960c */
        l_0x966c:
            ii(0x966c, 5);    cmp(memw_a16[ds, si + 0xc24], 0x1);       /* cmp word [si+0xc24], 0x1 */
            ii(0x9671, 2);    add(memb_a16[ds, bx + si], al);           /* add [bx+si], al */
            ii(0x9673, 3);    pushw(memw_a16[ds, di + 0x18]);           /* push word [di+0x18] */
            ii(0x9676, 2);    mov(ax, di);                              /* mov ax, di */
            ii(0x9678, 3);    callw(0x2536, -0x7145);                   /* call 0x2536 */
            ii(0x967b, 2);    add(memb_a16[ds, bx + si], al);           /* add [bx+si], al */
            ii(0x967d, 2);    xor(si, si);                              /* xor si, si */
            ii(0x967f, 2);    mov(ax, si);                              /* mov ax, si */
            ii(0x9681, 4);    add(sp, 0x12c);                           /* add sp, 0x12c */
            ii(0x9685, 2);    add(memb_a16[ds, bx + si], al);           /* add [bx+si], al */
            ii(0x9687, 1);    popw(bp);                                 /* pop bp */
            ii(0x9688, 1);    popw(di);                                 /* pop di */
            ii(0x9689, 1);    popw(si);                                 /* pop si */
            ii(0x968a, 1);    popw(dx);                                 /* pop dx */
            ii(0x968b, 1);    popw(cx);                                 /* pop cx */
            ii(0x968c, 1);    popw(bx);                                 /* pop bx */
            ii(0x968d, 1);    retw(); return;                           /* ret */
        //  ii(0x968e, 1306); Недостижимый (и не декодированный) код.
        l_0x9ba8:
            ii(0x9ba8, 2);    add(memb_a16[ds, bx + si], al);           /* add [bx+si], al */
            ii(0x9baa, 2);    mov(ax, si);                              /* mov ax, si */
            ii(0x9bac, 4);    add(sp, 0x12c);                           /* add sp, 0x12c */
            ii(0x9bb0, 2);    add(memb_a16[ds, bx + si], al);           /* add [bx+si], al */
            ii(0x9bb2, 1);    popw(bp);                                 /* pop bp */
            ii(0x9bb3, 1);    popw(di);                                 /* pop di */
            ii(0x9bb4, 1);    popw(si);                                 /* pop si */
            ii(0x9bb5, 1);    popw(dx);                                 /* pop dx */
            ii(0x9bb6, 1);    popw(cx);                                 /* pop cx */
            ii(0x9bb7, 1);    popw(bx);                                 /* pop bx */
            ii(0x9bb8, 1);    retw(); return;                           /* ret */
        }
    }
}
