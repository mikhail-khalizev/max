...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_acc5()
        {
            ...
            ii(0x1013_acdc, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_acdf, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_ace2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_ace5, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1013_ace7, 5); call(0x1013_ae28, 0x13c);               /* call 0x1013ae28 */
            ii(0x1013_acec, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_acef, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1013_acf1, 5); call(0x1013_add4, 0xde);                /* call 0x1013add4 */
            ii(0x1013_acf6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_acf9, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x1013_acfb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_acfe, 2); mov(memd[ds, eax], edx);                /* mov [eax], edx */
            ii(0x1013_ad00, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_ad03, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1013_ad06, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
