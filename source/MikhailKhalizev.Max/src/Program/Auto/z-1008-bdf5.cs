...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_bdf5()
        {
            ...
            ii(0x1008_be0d, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_be10, 4); mov(memb[ss, ebp - 0x8], 0x12);         /* mov byte [ebp-0x8], 0x12 */
            ii(0x1008_be14, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
