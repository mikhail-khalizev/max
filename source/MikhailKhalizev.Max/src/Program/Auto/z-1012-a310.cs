...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_a310()
        {
            ...
            ii(0x1012_a33d, 5); mov(eax, 0x101a_83e4);                  /* mov eax, 0x101a83e4 */ /* "out of sync:  local , host\n" */
        ...
        l_0x1012_a37a:
            ...
            ii(0x1012_a3b9, 5); mov(eax, 0x101a_8400);                  /* mov eax, 0x101a8400 */ /* "    %s team       %s, %s\n" */
        ...
        l_0x1012_a3d4:
            ...
            ii(0x1012_a3f5, 5); mov(eax, 0x101a_841a);                  /* mov eax, 0x101a841a */ /* "   %s team %s\n" */
        ...
        l_0x1012_a447:
            ii(0x1012_a447, 5); mov(ecx, 0x101a_8429);                  /* mov ecx, 0x101a8429 */ /* " unitOrders      %i, %i\n" */
        ...
        l_0x1012_a471:
            ...
            ii(0x1012_a49f, 5); mov(eax, 0x101a_8442);                  /* mov eax, 0x101a8442 */ /* " unitOrders      %s, %s\n" */
        ...
        l_0x1012_a4c9:
            ii(0x1012_a4c9, 5); mov(ecx, 0x101a_845b);                  /* mov ecx, 0x101a845b */ /* " unitState       %i, %i\n" */
            ...
            ii(0x1012_a4f2, 5); mov(ecx, 0x101a_8474);                  /* mov ecx, 0x101a8474 */ /* " Map X           %i, %i\n" */
            ...
            ii(0x1012_a517, 5); mov(ecx, 0x101a_848d);                  /* mov ecx, 0x101a848d */ /* " Map Y           %i, %i\n" */
            ...
            ii(0x1012_a545, 5); mov(ecx, 0x101a_84a6);                  /* mov ecx, 0x101a84a6 */ /* " Build turns     %i, %i\n" */
            ...
            ii(0x1012_a56c, 5); mov(ecx, 0x101a_84bf);                  /* mov ecx, 0x101a84bf */ /* " Build rate      %i, %i\n" */
        ...
        l_0x1012_a593:
            ii(0x1012_a593, 5); mov(ecx, 0x101a_84d8);                  /* mov ecx, 0x101a84d8 */ /* " priorOrders     %i, %i\n" */
            ...
            ii(0x1012_a5bc, 5); mov(ecx, 0x101a_84f1);                  /* mov ecx, 0x101a84f1 */ /* " parent unit     %s, %s\n" */
            ...
            ii(0x1012_a5e2, 5); mov(ecx, 0x101a_850a);                  /* mov ecx, 0x101a850a */ /* " targetGridX     %i, %i\n" */
            ...
            ii(0x1012_a607, 5); mov(ecx, 0x101a_8523);                  /* mov ecx, 0x101a8523 */ /* " targetGridY,    %i, %i\n" */
            ...
            ii(0x1012_a62c, 5); mov(ecx, 0x101a_853c);                  /* mov ecx, 0x101a853c */ /* " production tot  %i, %i\n" */
            ...
            ii(0x1012_a655, 5); mov(ecx, 0x101a_8555);                  /* mov ecx, 0x101a8555 */ /* " material alloc  %i, %i\n" */
            ...
            ii(0x1012_a67e, 5); mov(ecx, 0x101a_856e);                  /* mov ecx, 0x101a856e */ /* " fuel alloc      %i, %i\n" */
            ...
            ii(0x1012_a6a7, 5); mov(ecx, 0x101a_8587);                  /* mov ecx, 0x101a8587 */ /* " gold alloc      %i, %i\n" */
            ...
            ii(0x1012_a6d0, 5); mov(ecx, 0x101a_85a0);                  /* mov ecx, 0x101a85a0 */ /* " Hits            %i, %i\n" */
            ...
            ii(0x1012_a6f7, 5); mov(ecx, 0x101a_85b9);                  /* mov ecx, 0x101a85b9 */ /* " Speed           %i, %i\n" */
            ...
            ii(0x1012_a71e, 5); mov(ecx, 0x101a_85d2);                  /* mov ecx, 0x101a85d2 */ /* " Rounds          %i, %i\n" */
            ...
            ii(0x1012_a75a, 5); mov(ecx, 0x101a_85eb);                  /* mov ecx, 0x101a85eb */ /* " Storage         %i, %i\n" */
        ...
        l_0x1012_a77f:
            ii(0x1012_a77f, 5); mov(ecx, 0x101a_8604);                  /* mov ecx, 0x101a8604 */ /* " Ammo            %i, %i\n" */
            ...
            ii(0x1012_a7a6, 5); mov(ecx, 0x101a_861d);                  /* mov ecx, 0x101a861d */ /* " Team ID         %i, %i\n" */
