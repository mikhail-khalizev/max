...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x1a_03cb, 4); enter(0x2, 0);                            /* enter 0x2, 0x0 */
        ...
        l_0x1a_03d7:
            ii(0x1a_03d7, 3); mov(ax, memw[ss, bp + 0xe]);              /* mov ax, [bp+0xe] */
            ii(0x1a_03da, 3); mov(dx, memw[ss, bp + 0x10]);             /* mov dx, [bp+0x10] */
            ii(0x1a_03dd, 3); mov(cl, memb[ss, bp + 0xa]);              /* mov cl, [bp+0xa] */
            ...
            ii(0x1a_03f1, 3); les(bx, memw[ss, bp + 0x6]);              /* les bx, [bp+0x6] */
            ii(0x1a_03f4, 3); inc(memw[ss, bp + 0x6]);                  /* inc word [bp+0x6] */
            ii(0x1a_03f7, 3); mov(memb[es, bx], al);                    /* mov [es:bx], al */
        l_0x1a_03fa:
            ii(0x1a_03fa, 3); mov(ax, memw[ss, bp + 0xa]);              /* mov ax, [bp+0xa] */
            ii(0x1a_03fd, 3); dec(memw[ss, bp + 0xa]);                  /* dec word [bp+0xa] */
