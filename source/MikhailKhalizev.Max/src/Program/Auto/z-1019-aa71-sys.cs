...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_aa71()
        {
            ...
            ii(0x1019_aa85, 3); or(dl, 4);                              /* or dl, 0x4 */
        ...
        l_0x1019_aa95:
            ii(0x1019_aa95, 5); mov(eax, 8);                            /* mov eax, 0x8 */
            ...
            ii(0x1019_aaa5, 5); mov(eax, 8);                            /* mov eax, 0x8 */
            ...
            ii(0x1019_aab5, 5); mov(edx, 1);                            /* mov edx, 0x1 */
        ...
        l_0x1019_aac4:
            ...
            ii(0x1019_aac9, 3); mov(memd[ds, ebx + 4], ecx);            /* mov [ebx+0x4], ecx */
        ...
        l_0x1019_aad7:
            ii(0x1019_aad7, 3); mov(edx, memd[ds, ecx + 12]);           /* mov edx, [ecx+0xc] */
