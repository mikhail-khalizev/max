...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_6125()
        {
            ...
            ii(0x100a_613c, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_613f, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_6142, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x100a_6149, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x100a_6150, 2); jmp(0x100a_6158, 0x6); goto l_0x100a_6158; /* jmp 0x100a6158 */
        l_0x100a_6152:
            ii(0x100a_6152, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100a_6155, 3); inc(memd[ss, ebp - 0x10]);              /* inc dword [ebp-0x10] */
        l_0x100a_6158:
            ii(0x100a_6158, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_615b, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100a_615e, 5); call(Definitions.my_2_get_count, -0x1_adfb); /* call 0x1008b368 */
            ii(0x100a_6163, 4); cmp(ax, memw[ss, ebp - 0x10]);          /* cmp ax, [ebp-0x10] */
            ii(0x100a_6167, 2); if(jle(0x100a_6189, 0x20)) goto l_0x100a_6189; /* jle 0x100a6189 */
            ii(0x100a_6169, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x100a_616d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_617b, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ii(0x100a_617f, 2); if(jnz(0x100a_6187, 0x6)) goto l_0x100a_6187; /* jnz 0x100a6187 */
            ii(0x100a_6181, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100a_6184, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x100a_6187:
            ii(0x100a_6187, 2); jmp(0x100a_6152, -0x37); goto l_0x100a_6152; /* jmp 0x100a6152 */
        l_0x100a_6189:
            ii(0x100a_6189, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100a_618c, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100a_618f, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
