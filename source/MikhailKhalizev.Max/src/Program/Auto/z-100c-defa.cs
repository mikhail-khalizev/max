...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_defa()
        {
            ...
            ii(0x100c_df15, 7);  mov(memd[ss, ebp - 20], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x100c_df1c, 7);  mov(memd[ss, ebp - 8], 0x4b);         /* mov dword [ebp-0x8], 0x4b */
        l_0x100c_df23:
            ii(0x100c_df23, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ...
            ii(0x100c_df2c, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100c_df2f, 3);  inc(memd[ss, ebp - 20]);              /* inc dword [ebp-0x14] */
            ...
            ii(0x100c_df3c, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100c_df3f, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100c_df42, 3);  inc(memd[ss, ebp - 20]);              /* inc dword [ebp-0x14] */
            ...
            ii(0x100c_df4f, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
        l_0x100c_df52:
            ii(0x100c_df52, 3);  dec(memd[ss, ebp - 16]);              /* dec dword [ebp-0x10] */
            ii(0x100c_df55, 5);  cmp(memw[ss, ebp - 16], -1 /* 0xff */);/* cmp word [ebp-0x10], 0xffff */
            ii(0x100c_df5a, 2);  if(jz(0x100c_df80, 0x24)) goto l_0x100c_df80;/* jz 0x100cdf80 */
            ii(0x100c_df5c, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100c_df5f, 3);  inc(memd[ss, ebp - 20]);              /* inc dword [ebp-0x14] */
            ...
            ii(0x100c_df76, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100c_df79, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
        ...
        l_0x100c_df82:
            ii(0x100c_df82, 7);  mov(memd[ss, ebp - 24], 0xffff_ffff); /* mov dword [ebp-0x18], 0xffffffff */
        l_0x100c_df89:
            ii(0x100c_df89, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
