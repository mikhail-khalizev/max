...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_defa()
        {
            ...
            ii(0x100c_df12, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_df15, 7); mov(memd[ss, ebp - 0x14], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x100c_df1c, 7); mov(memd[ss, ebp - 0x8], 0x4b);         /* mov dword [ebp-0x8], 0x4b */
        l_0x100c_df23:
            ii(0x100c_df23, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x100c_df26, 4); cmp(ax, memw[ss, ebp - 0x8]);           /* cmp ax, [ebp-0x8] */
        ...
        l_0x100c_df52:
            ...
            ii(0x100c_df55, 5); cmp(memw[ss, ebp - 0x10], -0x1 /* 0xff */); /* cmp word [ebp-0x10], 0xffff */
            ...
            ii(0x100c_df6e, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100c_df72, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x100c_df74, 2); if(jnz(0x100c_df7e, 0x8)) goto l_0x100c_df7e; /* jnz 0x100cdf7e */
