...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_b2e0()
        {
            ...
            ii(0x1007_b2f8, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_b2fb, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_b2fd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_b30c, 7); mov(memd[ss, ebp - 0x1c], 0);           /* mov dword [ebp-0x1c], 0x0 */
            ii(0x1007_b313, 5); jmp(0x1007_b4a6, 0x18e); goto l_0x1007_b4a6; /* jmp 0x1007b4a6 */
        l_0x1007_b318:
            ii(0x1007_b318, 3); lea(edx, memd[ss, ebp - 0x20]);         /* lea edx, [ebp-0x20] */
            ii(0x1007_b31b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_b32b, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ...
            ii(0x1007_b339, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ...
            ii(0x1007_b352, 3); lea(eax, memd[ss, ebp - 0x38]);         /* lea eax, [ebp-0x38] */
            ...
            ii(0x1007_b366, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_b369, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1007_b381, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ii(0x1007_b384, 4); cmp(memd[ss, ebp - 0x28], 0);           /* cmp dword [ebp-0x28], 0x0 */
            ii(0x1007_b388, 2); if(jnz(0x1007_b396, 0xc)) goto l_0x1007_b396; /* jnz 0x1007b396 */
            ii(0x1007_b38a, 7); mov(memd[ss, ebp - 0x1c], 0);           /* mov dword [ebp-0x1c], 0x0 */
            ii(0x1007_b391, 5); jmp(0x1007_b4a6, 0x110); goto l_0x1007_b4a6; /* jmp 0x1007b4a6 */
        l_0x1007_b396:
            ii(0x1007_b396, 7); mov(memd[ss, ebp - 0x8], 0x1);          /* mov dword [ebp-0x8], 0x1 */
            ii(0x1007_b39d, 2); jmp(0x1007_b3a5, 0x6); goto l_0x1007_b3a5; /* jmp 0x1007b3a5 */
        l_0x1007_b39f:
            ii(0x1007_b39f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_b3a2, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x1007_b3a5:
            ii(0x1007_b3a5, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_b3a8, 4); cmp(ax, memw[ss, ebp - 0x10]);          /* cmp ax, [ebp-0x10] */
            ii(0x1007_b3ac, 6); if(jge(0x1007_b4a0, 0xee)) goto l_0x1007_b4a0; /* jge 0x1007b4a0 */
            ii(0x1007_b3b2, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1007_b3b5, 3); sub(eax, memd[ss, ebp - 0x8]);          /* sub eax, [ebp-0x8] */
            ii(0x1007_b3b8, 4); mov(memw[ss, ebp - 0x24], ax);          /* mov [ebp-0x24], ax */
            ii(0x1007_b3bc, 3); mov(eax, memd[ss, ebp - 0x1e]);         /* mov eax, [ebp-0x1e] */
            ii(0x1007_b3bf, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x1007_b3c2, 4); mov(memw[ss, ebp - 0x22], ax);          /* mov [ebp-0x22], ax */
            ii(0x1007_b3c6, 7); mov(memd[ss, ebp - 0x18], 0);           /* mov dword [ebp-0x18], 0x0 */
            ii(0x1007_b3cd, 2); jmp(0x1007_b3d3, 0x4); goto l_0x1007_b3d3; /* jmp 0x1007b3d3 */
        l_0x1007_b3cf:
            ii(0x1007_b3cf, 4); add(memd[ss, ebp - 0x18], 0x2);         /* add dword [ebp-0x18], 0x2 */
        l_0x1007_b3d3:
            ii(0x1007_b3d3, 4); movsx(eax, memw[ss, ebp - 0x18]);       /* movsx eax, word [ebp-0x18] */
            ii(0x1007_b3d7, 3); cmp(eax, 0x8);                          /* cmp eax, 0x8 */
            ii(0x1007_b3da, 6); if(jge(0x1007_b49b, 0xbb)) goto l_0x1007_b49b; /* jge 0x1007b49b */
            ii(0x1007_b3e0, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1007_b3e7, 2); jmp(0x1007_b3ef, 0x6); goto l_0x1007_b3ef; /* jmp 0x1007b3ef */
        l_0x1007_b3e9:
            ii(0x1007_b3e9, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1007_b3ec, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x1007_b3ef:
            ii(0x1007_b3ef, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1007_b3f3, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x1007_b3f5, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x1007_b3f9, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x1007_b3fb, 6); if(jge(0x1007_b496, 0x95)) goto l_0x1007_b496; /* jge 0x1007b496 */
            ii(0x1007_b401, 4); movsx(edx, memw[ss, ebp - 0x18]);       /* movsx edx, word [ebp-0x18] */
            ...
            ii(0x1007_b40f, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ii(0x1007_b412, 5); call(0x1008_b1a4, 0xfd8d);              /* call 0x1008b1a4 */
            ii(0x1007_b417, 3); lea(edx, memd[ss, ebp - 0x24]);         /* lea edx, [ebp-0x24] */
            ii(0x1007_b41a, 3); lea(eax, memd[ss, ebp - 0x38]);         /* lea eax, [ebp-0x38] */
            ...
            ii(0x1007_b426, 4); movsx(eax, memw[ss, ebp - 0x24]);       /* movsx eax, word [ebp-0x24] */
            ii(0x1007_b42a, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1007_b42d, 3); add(eax, memd[ss, ebp - 0x28]);         /* add eax, [ebp-0x28] */
            ii(0x1007_b430, 4); movsx(edx, memw[ss, ebp - 0x22]);       /* movsx edx, word [ebp-0x22] */
            ...
            ii(0x1007_b43f, 2); if(jle(0x1007_b443, 0x2)) goto l_0x1007_b443; /* jle 0x1007b443 */
        l_0x1007_b441:
            ii(0x1007_b441, 2); jmp(0x1007_b491, 0x4e); goto l_0x1007_b491; /* jmp 0x1007b491 */
        l_0x1007_b443:
            ii(0x1007_b443, 3); lea(edx, memd[ss, ebp - 0x24]);         /* lea edx, [ebp-0x24] */
            ii(0x1007_b446, 3); lea(eax, memd[ss, ebp - 0x3c]);         /* lea eax, [ebp-0x3c] */
            ii(0x1007_b449, 5); call(0x1007_5e64, -0x55ea);             /* call 0x10075e64 */
            ii(0x1007_b44e, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x1007_b450, 3); lea(edx, memd[ss, ebp - 0x20]);         /* lea edx, [ebp-0x20] */
            ii(0x1007_b453, 3); lea(eax, memd[ss, ebp - 0x40]);         /* lea eax, [ebp-0x40] */
            ...
            ii(0x1007_b46e, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1007_b471, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1007_b474, 4); cmp(ax, memw[ss, ebp - 0x10]);          /* cmp ax, [ebp-0x10] */
            ii(0x1007_b478, 2); if(jge(0x1007_b491, 0x17)) goto l_0x1007_b491; /* jge 0x1007b491 */
            ii(0x1007_b47a, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1007_b47d, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1007_b480, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_b483, 4); cmp(ax, memw[ss, ebp - 0x10]);          /* cmp ax, [ebp-0x10] */
            ii(0x1007_b487, 2); if(jl(0x1007_b491, 0x8)) goto l_0x1007_b491; /* jl 0x1007b491 */
            ii(0x1007_b489, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1007_b48c, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
        ...
        l_0x1007_b4a0:
            ii(0x1007_b4a0, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1007_b4a3, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
        l_0x1007_b4a6:
            ii(0x1007_b4a6, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
