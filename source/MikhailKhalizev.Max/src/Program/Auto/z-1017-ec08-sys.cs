...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_ec08()
        {
            ...
            ii(0x1017_ec10, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1017_ec16, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1017_ec19, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1017_ec1c, 3); shl(eax, 2);                            /* shl eax, 0x2 */
            ii(0x1017_ec1f, 6); mov(eax, memd[ds, eax + 0x101b_e4f4]);  /* mov eax, [eax+0x101be4f4] */
            ii(0x1017_ec25, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1017_ec28, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
