...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_9a74()
        {
            ...
            ii(0x1008_9a8c, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_9a8f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_9a92, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x1008_9a95, 5); call(0x1007_6338, -0x1_3762);           /* call 0x10076338 */
            ii(0x1008_9a9a, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_9a9d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
