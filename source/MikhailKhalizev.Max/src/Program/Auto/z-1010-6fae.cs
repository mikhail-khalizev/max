...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_6fae()
        {
            ...
            ii(0x1010_6fc0, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1010_6fc6, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1010_6fc9, 5); mov(ebx, 6);                            /* mov ebx, 0x6 */
            ii(0x1010_6fce, 5); mov(edx, 0x101c_4da4);                  /* mov edx, 0x101c4da4 */
            ii(0x1010_6fd3, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_6fe0, 2); if(jz(0x1010_6feb, 9)) goto l_0x1010_6feb; /* jz 0x10106feb */
            ii(0x1010_6fe2, 7); cmp(memb[ds, 0x101c_5630], 0);          /* cmp byte [0x101c5630], 0x0 */
            ii(0x1010_6fe9, 2); if(jnz(0x1010_6ff4, 9)) goto l_0x1010_6ff4; /* jnz 0x10106ff4 */
        l_0x1010_6feb:
            ii(0x1010_6feb, 7); mov(memd[ss, ebp - 8], 0);              /* mov dword [ebp-0x8], 0x0 */
            ii(0x1010_6ff2, 2); jmp(0x1010_7014, 0x20); goto l_0x1010_7014; /* jmp 0x10107014 */
        l_0x1010_6ff4:
            ii(0x1010_6ff4, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_6ff7, 4); mov(ax, memw[ds, eax + 76]);            /* mov ax, [eax+0x4c] */
            ii(0x1010_6ffb, 7); cmp(ax, memw[ds, 0x101c_40d0]);         /* cmp ax, [0x101c40d0] */
            ii(0x1010_7002, 2); if(jz(0x1010_700d, 9)) goto l_0x1010_700d; /* jz 0x1010700d */
            ii(0x1010_7004, 7); mov(memd[ss, ebp - 8], 0);              /* mov dword [ebp-0x8], 0x0 */
            ii(0x1010_700b, 2); jmp(0x1010_7014, 7); goto l_0x1010_7014; /* jmp 0x10107014 */
        l_0x1010_700d:
            ii(0x1010_700d, 7); mov(memd[ss, ebp - 8], 1);              /* mov dword [ebp-0x8], 0x1 */
        l_0x1010_7014:
            ii(0x1010_7014, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
