...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_4a9e()
        {
            ...
            ii(0x100d_4abc, 4);  test(memb[ds, eax + 19], 2);          /* test byte [eax+0x13], 0x2 */
            ...
            ii(0x100d_4ac9, 6);  lea(eax, memd[ss, ebp - 188]);        /* lea eax, [ebp-0xbc] */
            ii(0x100d_4acf, 5);  call(0x100d_3395, -0x173f);           /* call 0x100d3395 */
            ii(0x100d_4ad4, 6);  mov(memd[ss, ebp - 192], eax);        /* mov [ebp-0xc0], eax */
            ii(0x100d_4ada, 4);  and(memb[ss, ebp - 8], -2 /* 0xfe */);/* and byte [ebp-0x8], 0xfe */
            ii(0x100d_4ade, 6);  lea(eax, memd[ss, ebp - 188]);        /* lea eax, [ebp-0xbc] */
            ii(0x100d_4ae4, 5);  call(0x100d_42d8, -0x811);            /* call 0x100d42d8 */
            ii(0x100d_4ae9, 6);  lea(eax, memd[ss, ebp - 188]);        /* lea eax, [ebp-0xbc] */
            ii(0x100d_4aef, 5);  call(0x100d_2504, -0x25f0);           /* call 0x100d2504 */
            ii(0x100d_4af4, 5);  and(eax, 0xff);                       /* and eax, 0xff */
            ii(0x100d_4af9, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x100d_4afc, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100d_4afe, 6);  lea(eax, memd[ss, ebp - 188]);        /* lea eax, [ebp-0xbc] */
        ...
        l_0x100d_4b0b:
            ...
            ii(0x100d_4b12, 6);  lea(eax, memd[ss, ebp - 328]);        /* lea eax, [ebp-0x148] */
            ii(0x100d_4b18, 5);  call(0x100d_25d4, -0x2549);           /* call 0x100d25d4 */
            ii(0x100d_4b1d, 6);  mov(memd[ss, ebp - 332], eax);        /* mov [ebp-0x14c], eax */
            ii(0x100d_4b23, 4);  and(memb[ss, ebp - 8], -2 /* 0xfe */);/* and byte [ebp-0x8], 0xfe */
            ii(0x100d_4b27, 6);  lea(eax, memd[ss, ebp - 328]);        /* lea eax, [ebp-0x148] */
            ii(0x100d_4b2d, 5);  call(0x100d_1447, -0x36eb);           /* call 0x100d1447 */
            ii(0x100d_4b32, 6);  lea(eax, memd[ss, ebp - 328]);        /* lea eax, [ebp-0x148] */
            ii(0x100d_4b38, 5);  call(0x100d_2504, -0x2639);           /* call 0x100d2504 */
            ii(0x100d_4b3d, 5);  and(eax, 0xff);                       /* and eax, 0xff */
            ii(0x100d_4b42, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x100d_4b45, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100d_4b47, 6);  lea(eax, memd[ss, ebp - 328]);        /* lea eax, [ebp-0x148] */
            ii(0x100d_4b4d, 5);  call(0x100d_4e00, 0x2ae);             /* call 0x100d4e00 */
        l_0x100d_4b52:
            ii(0x100d_4b52, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_4b55, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100d_4b58, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
