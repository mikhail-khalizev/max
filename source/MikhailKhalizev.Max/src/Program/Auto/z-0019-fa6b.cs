...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x19_fa6b, 4); enter(0x8, 0);                            /* enter 0x8, 0x0 */
            ...
            ii(0x19_fa77, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x19_fa7a, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ii(0x19_fa7d, 3); call(0x19_fa33, -0x4d);                   /* call 0xfa33 */
            ii(0x19_fa80, 2); or(ax, ax);                               /* or ax, ax */
            ii(0x19_fa82, 2); if(jnz(0x19_fa89, 0x5)) goto l_0x19_fa89; /* jnz 0xfa89 */
        ...
        l_0x19_fa89:
            ...
            ii(0x19_fa90, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
        ...
        l_0x19_faa1:
            ...
            ii(0x19_faa6, 3); mov(bx, memw[ss, bp - 0x2]);              /* mov bx, [bp-0x2] */
            ...
            ii(0x19_fac1, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x19_fac4, 3); mov(ax, memw[ss, bp - 0x8]);              /* mov ax, [bp-0x8] */
        l_0x19_fac7:
            ii(0x19_fac7, 1); pop(ds);                                  /* pop ds */
            ii(0x19_fac8, 1); pop(si);                                  /* pop si */
            ii(0x19_fac9, 1); pop(di);                                  /* pop di */
            ii(0x19_faca, 1); leave();                                  /* leave */
            ii(0x19_facb, 3); ret(0x4);                                 /* ret 0x4 */
        }
    }
}
