...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_319e()
        {
            ...
            ii(0x1013_31be, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1013_31c1, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_31c4, 4); mov(memb[ds, eax + 29], 1);             /* mov byte [eax+0x1d], 0x1 */
