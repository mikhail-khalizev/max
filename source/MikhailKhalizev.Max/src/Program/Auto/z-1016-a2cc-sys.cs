...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x1016_a2cc, 1); push(ebx);                              /* push ebx */
            ii(0x1016_a2cd, 1); push(ecx);                              /* push ecx */
            ii(0x1016_a2ce, 1); push(esi);                              /* push esi */
            ii(0x1016_a2cf, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x1016_a2d1, 2); mov(esi, edx);                          /* mov esi, edx */
            ii(0x1016_a2d3, 6); mov(edx, memd[ds, 0x101b_dde8]);        /* mov edx, [0x101bdde8] */
        ...
        l_0x1016_a2ee:
            ...
            ii(0x1016_a2f6, 6); cmp(ebx, memd[ds, eax + 0x101c_f7b0]);  /* cmp ebx, [eax+0x101cf7b0] */
            ii(0x1016_a2fc, 2); if(jg(0x1016_a30e, 0x10)) goto l_0x1016_a30e; /* jg 0x1016a30e */
        ...
        l_0x1016_a30e:
            ...
            ii(0x1016_a313, 2); if(jl(0x1016_a2ee, -0x27)) goto l_0x1016_a2ee; /* jl 0x1016a2ee */
        l_0x1016_a315:
            ii(0x1016_a315, 2); xor(edx, edx);                          /* xor edx, edx */
        l_0x1016_a317:
            ii(0x1016_a317, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x1016_a319, 1); pop(esi);                               /* pop esi */
            ii(0x1016_a31a, 1); pop(ecx);                               /* pop ecx */
            ii(0x1016_a31b, 1); pop(ebx);                               /* pop ebx */
            ii(0x1016_a31c, 1); ret();                                  /* ret */
        }
    }
}
