...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_a2ae()
        {
            ...
            ii(0x1012_a2c3, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1012_a2c6, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1012_a2c9, 3); mov(memd[ss, ebp - 8], ebx);            /* mov [ebp-0x8], ebx */
            ii(0x1012_a2cc, 3); mov(memd[ss, ebp - 12], ecx);           /* mov [ebp-0xc], ecx */
            ii(0x1012_a2cf, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1012_a2d2, 4); cmp(ax, memw[ss, ebp - 8]);             /* cmp ax, [ebp-0x8] */
            ii(0x1012_a2d6, 2); if(jz(0x1012_a303, 0x2b)) goto l_0x1012_a303; /* jz 0x1012a303 */
            ii(0x1012_a2d8, 4); movsx(eax, memw[ss, ebp - 8]);          /* movsx eax, word [ebp-0x8] */
            ii(0x1012_a2dc, 1); push(eax);                              /* push eax */
            ii(0x1012_a2dd, 4); movsx(eax, memw[ss, ebp - 4]);          /* movsx eax, word [ebp-0x4] */
            ii(0x1012_a2e1, 1); push(eax);                              /* push eax */
            ii(0x1012_a2e2, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1012_a2e5, 1); push(eax);                              /* push eax */
            ii(0x1012_a2e6, 3); lea(eax, memd[ss, ebp - 100]);          /* lea eax, [ebp-0x64] */
            ...
            ii(0x1012_a2f2, 3); lea(edx, memd[ss, ebp - 100]);          /* lea edx, [ebp-0x64] */
            ii(0x1012_a2f5, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1012_a2f8, 5); call(Definitions.sys_strcat, 0x3_bc34); /* call 0x10165f31 */
            ii(0x1012_a2fd, 4); mov(memb[ss, ebp - 20], 1);             /* mov byte [ebp-0x14], 0x1 */
            ii(0x1012_a301, 2); jmp(0x1012_a307, 4); goto l_0x1012_a307; /* jmp 0x1012a307 */
        l_0x1012_a303:
            ii(0x1012_a303, 4); mov(memb[ss, ebp - 20], 0);             /* mov byte [ebp-0x14], 0x0 */
        l_0x1012_a307:
            ii(0x1012_a307, 3); mov(al, memb[ss, ebp - 20]);            /* mov al, [ebp-0x14] */
