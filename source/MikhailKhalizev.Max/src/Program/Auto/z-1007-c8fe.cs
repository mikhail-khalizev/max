...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_c8fe()
        {
            ...
            ii(0x1007_c915, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_c918, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1007_c91b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_c91e, 5); call(0x1008_9f70, 0xd64d);              /* call 0x10089f70 */
            ii(0x1007_c923, 3); cmp(eax, memd[ss, ebp - 0x4]);          /* cmp eax, [ebp-0x4] */
            ii(0x1007_c926, 2); if(jnz(0x1007_c999, 0x71)) goto l_0x1007_c999; /* jnz 0x1007c999 */
            ii(0x1007_c928, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_c92b, 3); add(eax, 0x19);                         /* add eax, 0x19 */
            ii(0x1007_c92e, 5); call(0x1007_6338, -0x65fb);             /* call 0x10076338 */
            ii(0x1007_c933, 3); lea(ebx, memd[ss, ebp - 0x10]);         /* lea ebx, [ebp-0x10] */
            ...
            ii(0x1007_c93f, 2); jmp(0x1007_c949, 0x8); goto l_0x1007_c949; /* jmp 0x1007c949 */
        l_0x1007_c941:
            ii(0x1007_c941, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1007_c944, 5); call(0x1007_6bf8, -0x5d51);             /* call 0x10076bf8 */
        l_0x1007_c949:
            ii(0x1007_c949, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_c94b, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x1007_c95c, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1007_c972:
            ii(0x1007_c972, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_c975, 3); add(eax, 0x19);                         /* add eax, 0x19 */
            ii(0x1007_c978, 5); call(0x1013_a6f4, 0xb_dd77);            /* call 0x1013a6f4 */
            ii(0x1007_c97d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_c980, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1007_c983, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1007_c986, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x1007_c989, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1007_c98c, 3); call_abs(memd[ds, edx + 0x48]);         /* call dword [edx+0x48] */
            ii(0x1007_c98f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_c991, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
