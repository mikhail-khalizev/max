...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_27dd()
        {
            ...
            ii(0x1007_27f5, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_27f8, 5); mov(edx, 0x101c_8184);                  /* mov edx, 0x101c8184 */
            ii(0x1007_27fd, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1007_2801, 5); call(0x1007_2746, -0xc0);               /* call 0x10072746 */
            ii(0x1007_2806, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1007_2808, 2); if(jz(0x1007_2813, 0x9)) goto l_0x1007_2813; /* jz 0x10072813 */
            ii(0x1007_280a, 7); mov(memd[ss, ebp - 0x8], 0x1);          /* mov dword [ebp-0x8], 0x1 */
        ...
        l_0x1007_2813:
            ...
            ii(0x1007_2818, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1007_281c, 5); call(0x1007_2746, -0xdb);               /* call 0x10072746 */
            ii(0x1007_2821, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1007_2823, 2); if(jz(0x1007_282e, 0x9)) goto l_0x1007_282e; /* jz 0x1007282e */
            ii(0x1007_2825, 7); mov(memd[ss, ebp - 0x8], 0x1);          /* mov dword [ebp-0x8], 0x1 */
        ...
        l_0x1007_282e:
            ...
            ii(0x1007_2833, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1007_2837, 5); call(0x1007_2746, -0xf6);               /* call 0x10072746 */
            ii(0x1007_283c, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x1007_283f:
            ii(0x1007_283f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
