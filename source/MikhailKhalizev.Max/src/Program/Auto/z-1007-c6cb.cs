...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_c6cb()
        {
            ...
            ii(0x1007_c6dd, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1007_c6e3, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_c6e6, 4);  mov(memb[ss, ebp - 8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x1007_c6ea, 3);  mov(al, memb[ss, ebp - 8]);           /* mov al, [ebp-0x8] */
