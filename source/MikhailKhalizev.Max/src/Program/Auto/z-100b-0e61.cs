...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_0e61()
        {
            ...
            ii(0x100b_0e79, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_0e7c, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_0e7e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_0e8d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_0e9b, 2); if(jg(0x100b_0e9f, 0x2)) goto l_0x100b_0e9f; /* jg 0x100b0e9f */
        l_0x100b_0e9d:
            ii(0x100b_0e9d, 2); jmp(0x100b_0ea5, 0x6); goto l_0x100b_0ea5; /* jmp 0x100b0ea5 */
        l_0x100b_0e9f:
            ii(0x100b_0e9f, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x100b_0ea3, 2); jmp(0x100b_0ea9, 0x4); goto l_0x100b_0ea9; /* jmp 0x100b0ea9 */
        l_0x100b_0ea5:
            ii(0x100b_0ea5, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x100b_0ea9:
            ii(0x100b_0ea9, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x100b_0eac, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x100b_0eaf, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
