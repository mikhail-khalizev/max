...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_0c7e()
        {
            ...
            ii(0x100d_0c95, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_0c98, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_0c9b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_0c9e, 6); mov(memw[ds, eax + 0x26], 0);           /* mov word [eax+0x26], 0x0 */
        l_0x100d_0ca4:
            ii(0x100d_0ca4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_0ca7, 3); mov(edx, memd[ds, eax + 0x24]);         /* mov edx, [eax+0x24] */
            ii(0x100d_0caa, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_0cad, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_0cbb, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ii(0x100d_0cbf, 2); if(jz(0x100d_0cca, 0x9)) goto l_0x100d_0cca; /* jz 0x100d0cca */
            ii(0x100d_0cc1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_0cc4, 4); inc(memw[ds, eax + 0x26]);              /* inc word [eax+0x26] */
            ii(0x100d_0cc8, 2); jmp(0x100d_0ca4, -0x26); goto l_0x100d_0ca4; /* jmp 0x100d0ca4 */
        l_0x100d_0cca:
            ii(0x100d_0cca, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_0ccd, 3); mov(edx, memd[ds, eax + 0x24]);         /* mov edx, [eax+0x24] */
            ii(0x100d_0cd0, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_0cd3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
