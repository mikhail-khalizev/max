...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_4e3d()
        {
            ...
            ii(0x1019_4e4d, 2); push(fs);                               /* push fs */
            ii(0x1019_4e4f, 2); push(gs);                               /* push gs */
            ii(0x1019_4e51, 1); push(es);                               /* push es */
            ...
            ii(0x1019_4e5d, 1); pop(es);                                /* pop es */
            ii(0x1019_4e5e, 2); pop(gs);                                /* pop gs */
            ii(0x1019_4e60, 2); pop(fs);                                /* pop fs */
