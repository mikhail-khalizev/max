...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_7a3d()
        {
            ...
            ii(0x7a46, 3);    mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
            ii(0x7a49, 2);    sub(dx, dx);                              /* sub dx, dx */
            ii(0x7a4b, 2);    mov(cx, ax);                              /* mov cx, ax */
            ii(0x7a4d, 2);    mov(bx, dx);                              /* mov bx, dx */
            ii(0x7a4f, 3);    mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
            ii(0x7a52, 3);    mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x7a55, 3);    sub(ax, 0x8);                             /* sub ax, 0x8 */
            ii(0x7a58, 3);    mov(memw[ss, bp - 0xe], dx);              /* mov [bp-0xe], dx */
            ii(0x7a5b, 3);    mov(memw[ss, bp - 0xc], ax);              /* mov [bp-0xc], ax */
        ...
        l_0x7a6d:
            ...
            ii(0x7a71, 3);    add(bx, memw[ss, bp - 0xe]);              /* add bx, [bp-0xe] */
            ii(0x7a74, 3);    mov(es, memw[ss, bp - 0xc]);              /* mov es, [bp-0xc] */
            ...
            ii(0x7a80, 3);    cmp(memw[ss, bp + 0x6], di);              /* cmp [bp+0x6], di */
            ii(0x7a83, 2);    if(jnz(0x7a92, 0xd)) goto l_0x7a92;       /* jnz 0x7a92 */
            ii(0x7a85, 3);    mov(ax, memw[ss, bp + 0x8]);              /* mov ax, [bp+0x8] */
            ii(0x7a88, 2);    mov(bx, si);                              /* mov bx, si */
            ii(0x7a8a, 2);    shl(bx, 0x1);                             /* shl bx, 1 */
            ii(0x7a8c, 3);    add(bx, memw[ss, bp - 0xe]);              /* add bx, [bp-0xe] */
            ii(0x7a8f, 3);    mov(memw[es, bx], ax);                    /* mov [es:bx], ax */
        l_0x7a92:
            ii(0x7a92, 3);    mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x7a95, 2);    mov(bx, si);                              /* mov bx, si */
            ii(0x7a97, 2);    shl(bx, 0x1);                             /* shl bx, 1 */
            ii(0x7a99, 3);    add(bx, memw[ss, bp - 0x6]);              /* add bx, [bp-0x6] */
            ii(0x7a9c, 3);    mov(es, memw[ss, bp - 0x4]);              /* mov es, [bp-0x4] */
            ii(0x7a9f, 3);    mov(bx, memw[es, bx]);                    /* mov bx, [es:bx] */
            ii(0x7aa2, 2);    mov(cx, di);                              /* mov cx, di */
            ii(0x7aa4, 2);    mov(es, cx);                              /* mov es, cx */
            ii(0x7aa6, 3);    mov(memw[ss, bp - 0x12], bx);             /* mov [bp-0x12], bx */
            ii(0x7aa9, 3);    mov(memw[ss, bp - 0x10], es);             /* mov [bp-0x10], es */
            ...
            ii(0x7abc, 4);    mov(al, memb[es, bx + 0x5]);              /* mov al, [es:bx+0x5] */
            ii(0x7ac0, 3);    mov(memb[ss, bp - 0x2], al);              /* mov [bp-0x2], al */
            ii(0x7ac3, 5);    mov(memb[es, bx + 0x5], 0xf2);            /* mov byte [es:bx+0x5], 0xf2 */
            ii(0x7ac8, 3);    mov(ax, memw[ss, bp + 0x8]);              /* mov ax, [bp+0x8] */
            ii(0x7acb, 2);    mov(cx, bx);                              /* mov cx, bx */
            ii(0x7acd, 2);    mov(dx, es);                              /* mov dx, es */
            ii(0x7acf, 3);    les(bx, memw[ss, bp - 0x12]);             /* les bx, [bp-0x12] */
            ii(0x7ad2, 3);    mov(memw[es, bx], ax);                    /* mov [es:bx], ax */
            ii(0x7ad5, 3);    mov(al, memb[ss, bp - 0x2]);              /* mov al, [bp-0x2] */
            ii(0x7ad8, 2);    mov(es, dx);                              /* mov es, dx */
            ii(0x7ada, 2);    mov(bx, cx);                              /* mov bx, cx */
            ii(0x7adc, 4);    mov(memb[es, bx + 0x5], al);              /* mov [es:bx+0x5], al */
        l_0x7ae0:
            ii(0x7ae0, 1);    dec(si);                                  /* dec si */
            ii(0x7ae1, 2);    if(jns(0x7a6d, -0x76)) goto l_0x7a6d;     /* jns 0x7a6d */
            ii(0x7ae3, 3);    mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ...
            ii(0x7aef, 5);    mov(memb[es, bx + 0x5], 0x80);            /* mov byte [es:bx+0x5], 0x80 */
            ii(0x7af4, 3);    mov(ax, memw[ss, bp + 0x8]);              /* mov ax, [bp+0x8] */
            ii(0x7af7, 4);    mov(memw[es, bx + 0x6], ax);              /* mov [es:bx+0x6], ax */
