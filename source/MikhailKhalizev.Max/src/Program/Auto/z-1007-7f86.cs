...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_7f86()
        {
            ...
            ii(0x1007_7f9d, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_7fa0, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1007_7fa3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_7fa6, 5); call(0x1007_623c, -0x1d6f);             /* call 0x1007623c */
            ii(0x1007_7fab, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1007_7fae, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1007_7fb1, 3); mov(edx, memd[ds, eax + 0x8]);          /* mov edx, [eax+0x8] */
            ii(0x1007_7fb4, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1007_7fb7, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1007_7fbb, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1007_7fbd, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_7fc0, 3); mov(al, memb[ds, eax + 0x4d]);          /* mov al, [eax+0x4d] */
            ...
            ii(0x1007_7fcc, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1007_7fcf, 3); mov(edx, memd[ds, edx + 0x6]);          /* mov edx, [edx+0x6] */
            ii(0x1007_7fd2, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1007_7fd5, 3); imul(edx, eax);                         /* imul edx, eax */
            ii(0x1007_7fd8, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1007_7fdb, 3); mov(ebx, memd[ds, eax + 0x8]);          /* mov ebx, [eax+0x8] */
            ...
            ii(0x1007_7fe8, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1007_7feb, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
