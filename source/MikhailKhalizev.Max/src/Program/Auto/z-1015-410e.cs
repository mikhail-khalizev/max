...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_410e()
        {
            ...
            ii(0x1015_4126, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_4129, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_412c, 3); mov(al, memb[ds, eax + 0x5e]);          /* mov al, [eax+0x5e] */
            ...
            ii(0x1015_413d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_4140, 5); call(0x1007_6d98, -0xd_d3ad);           /* call 0x10076d98 */
            ii(0x1015_4145, 2); test(al, al);                           /* test al, al */
            ii(0x1015_4147, 2); if(jnz(0x1015_414b, 0x2)) goto l_0x1015_414b; /* jnz 0x1015414b */
        l_0x1015_4149:
        ...
        l_0x1015_414b:
            ...
            ii(0x1015_4159, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1015_415c, 5); mov(eax, 0x101c_7278);                  /* mov eax, 0x101c7278 */
            ii(0x1015_4161, 5); call(0x1013_d5c0, -0x1_6ba6);           /* call 0x1013d5c0 */
        l_0x1015_4166:
            ii(0x1015_4166, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_4169, 5); call(0x1014_9fa8, -0xa1c6);             /* call 0x10149fa8 */
            ii(0x1015_416e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_4171, 3); mov(dl, memb[ds, eax + 0x5e]);          /* mov dl, [eax+0x5e] */
            ii(0x1015_4174, 2); inc(dl);                                /* inc dl */
            ii(0x1015_4176, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_4179, 3); and(dl, 0x3f);                          /* and dl, 0x3f */
            ii(0x1015_417c, 3); mov(memb[ds, eax + 0x5e], dl);          /* mov [eax+0x5e], dl */
            ii(0x1015_417f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_4182, 3); mov(al, memb[ds, eax + 0x5e]);          /* mov al, [eax+0x5e] */
            ...
            ii(0x1015_418f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_4192, 8); add(memw[ds, eax + 0xd9], 0x8);         /* add word [eax+0xd9], 0x8 */
            ii(0x1015_419a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_419d, 8); add(memw[ds, eax + 0xdb], 0x8);         /* add word [eax+0xdb], 0x8 */
            ii(0x1015_41a5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_41a8, 5); call(0x1014_9cd1, -0xa4dc);             /* call 0x10149cd1 */
            ii(0x1015_41ad, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_41b0, 5); call(0x1014_9fa8, -0xa20d);             /* call 0x10149fa8 */
            ii(0x1015_41b5, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x1015_41b9, 2); jmp(0x1015_41ce, 0x13); goto l_0x1015_41ce; /* jmp 0x101541ce */
        l_0x1015_41bb:
            ii(0x1015_41bb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_41be, 4); and(memb[ds, eax + 0x14], -0x2 /* 0xfe */); /* and byte [eax+0x14], 0xfe */
            ii(0x1015_41c2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_41c5, 5); call(0x1015_48ba, 0x6f0);               /* call 0x101548ba */
            ii(0x1015_41ca, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
        l_0x1015_41ce:
            ii(0x1015_41ce, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
