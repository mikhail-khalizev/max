...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1015_4166:
            ...
            ii(0x1015_4192, 8); add(memw[ds, eax + 0xd9], 8);           /* add word [eax+0xd9], 0x8 */
            ii(0x1015_419a, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1015_419d, 8); add(memw[ds, eax + 0xdb], 8);           /* add word [eax+0xdb], 0x8 */
        ...
        l_0x1015_41bb:
            ...
            ii(0x1015_41be, 4); and(memb[ds, eax + 0x14], -2 /* 0xfe */); /* and byte [eax+0x14], 0xfe */
