...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x17_8ba6, 4); enter(0x6, 0);                            /* enter 0x6, 0x0 */
            ...
            ii(0x17_8bb1, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x17_8bb4, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ...
            ii(0x17_8bd2, 3); cmp(dx, memw[ss, bp + 0x8]);              /* cmp dx, [bp+0x8] */
            ii(0x17_8bd5, 2); if(jb(0x17_8be4, 0xd)) goto l_0x17_8be4;  /* jb 0x8be4 */
            ii(0x17_8bd7, 2); if(ja(0x17_8bde, 0x5)) goto l_0x17_8bde;  /* ja 0x8bde */
            ii(0x17_8bd9, 3); cmp(ax, memw[ss, bp + 0x6]);              /* cmp ax, [bp+0x6] */
            ii(0x17_8bdc, 2); if(jbe(0x17_8be4, 0x6)) goto l_0x17_8be4; /* jbe 0x8be4 */
        l_0x17_8bde:
            ii(0x17_8bde, 3); mov(memw[ss, bp + 0x6], ax);              /* mov [bp+0x6], ax */
            ii(0x17_8be1, 3); mov(memw[ss, bp + 0x8], dx);              /* mov [bp+0x8], dx */
        l_0x17_8be4:
            ii(0x17_8be4, 3); mov(ax, memw[ds, 0x1f50]);                /* mov ax, [0x1f50] */
            ii(0x17_8be7, 4); mov(dx, memw[ds, 0x1f52]);                /* mov dx, [0x1f52] */
            ii(0x17_8beb, 3); add(ax, memw[ss, bp + 0x6]);              /* add ax, [bp+0x6] */
            ii(0x17_8bee, 3); adc(dx, memw[ss, bp + 0x8]);              /* adc dx, [bp+0x8] */
            ii(0x17_8bf1, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_8bf4, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ...
            ii(0x17_8c0b, 2); if(ja(0x17_8c11, 0x4)) goto l_0x17_8c11;  /* ja 0x8c11 */
            ii(0x17_8c0d, 2); cmp(ax, cx);                              /* cmp ax, cx */
            ii(0x17_8c0f, 2); if(jbe(0x17_8c18, 0x7)) goto l_0x17_8c18; /* jbe 0x8c18 */
        l_0x17_8c11:
        ...
        l_0x17_8c18:
            ...
            ii(0x17_8c39, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0x17_8c3c, 3); mov(dx, memw[ss, bp - 0x2]);              /* mov dx, [bp-0x2] */
            ...
            ii(0x17_8c6d, 2); push(0x1);                                /* push 0x1 */
        ...
        l_0x17_8cc0:
            ...
            ii(0x17_8cc4, 3); mov(dx, memw[ss, bp - 0x2]);              /* mov dx, [bp-0x2] */
