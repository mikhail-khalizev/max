...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_6e18()
        {
            ...
            ii(0x6e1d, 3);  mov(memw[ds, bx + 30], sp);                /* mov [bx+0x1e], sp */
            ii(0x6e20, 3);  mov(ax, memw[ss, bp + 38]);                /* mov ax, [bp+0x26] */
            ii(0x6e23, 3);  mov(memw[ds, bx - 18], ax);                /* mov [bx-0x12], ax */
            ii(0x6e26, 3);  mov(ax, 0x20);                             /* mov ax, 0x20 */
            ii(0x6e29, 2);  mov(ss, ax);                               /* mov ss, ax */
            ii(0x6e2b, 3);  lea(sp, memw[ds, bx - 18]);                /* lea sp, [bx-0x12] */
            ii(0x6e2e, 5);  mov(memb[ds, 0x9cc], 0x21);                /* mov byte [0x9cc], 0x21 */
            ii(0x6e33, 3);  call(0x66dc, -0x75a);                      /* call 0x66dc */
            ii(0x6e36, 3);  lea(ax, memw[ds, bx + 24]);                /* lea ax, [bx+0x18] */
            ii(0x6e39, 4);  mov(memw[cs, 0x1064], ax);                 /* mov [cs:0x1064], ax */
            ii(0x6e3d, 3);  mov(ax, memw[ds, bx + 22]);                /* mov ax, [bx+0x16] */
            ii(0x6e40, 6);  mov(memb[cs, 6], 0x21);                    /* mov byte [cs:0x6], 0x21 */
            ii(0x6e46, 5);  mov(memb[cs, 7], ah);                      /* mov [cs:0x7], ah */
            ii(0x6e4b, 3);  push(memw[ds, bx + 16]);                   /* push word [bx+0x10] */
            ii(0x6e4e, 3);  mov(cx, memw[ds, bx + 20]);                /* mov cx, [bx+0x14] */
            ii(0x6e51, 3);  mov(dx, memw[ds, bx + 18]);                /* mov dx, [bx+0x12] */
            ii(0x6e54, 3);  mov(bp, memw[ds, bx + 12]);                /* mov bp, [bx+0xc] */
            ii(0x6e57, 3);  mov(si, memw[ds, bx + 10]);                /* mov si, [bx+0xa] */
