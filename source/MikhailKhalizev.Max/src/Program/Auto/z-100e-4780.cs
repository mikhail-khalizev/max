...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_4780()
        {
            ...
            ii(0x100e_47b2, 6); mov(memw[ss, ebp - 0x2c], 0x7);         /* mov word [ebp-0x2c], 0x7 */
            ii(0x100e_47b8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_47bb, 4); mov(memw[ss, ebp - 0x28], ax);          /* mov [ebp-0x28], ax */
            ii(0x100e_47bf, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_47c2, 3); shr(eax, 0x10);                         /* shr eax, 0x10 */
            ii(0x100e_47c5, 4); mov(memw[ss, ebp - 0x24], ax);          /* mov [ebp-0x24], ax */
            ii(0x100e_47c9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100e_47e4, 2); if(jz(0x100e_47ef, 0x9)) goto l_0x100e_47ef; /* jz 0x100e47ef */
            ii(0x100e_47e6, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x100e_47ed, 2); jmp(0x100e_47f6, 0x7); goto l_0x100e_47f6; /* jmp 0x100e47f6 */
        l_0x100e_47ef:
            ii(0x100e_47ef, 7); mov(memd[ss, ebp - 0xc], 0x1);          /* mov dword [ebp-0xc], 0x1 */
        l_0x100e_47f6:
