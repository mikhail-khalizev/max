...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_4780()
        {
            ...
            ii(0x100e_479a, 3); mov(memd[ss, ebp - 16], edx);           /* mov [ebp-0x10], edx */
            ii(0x100e_479d, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ...
            ii(0x100e_47aa, 3); lea(eax, memd[ss, ebp - 44]);           /* lea eax, [ebp-0x2c] */
            ii(0x100e_47ad, 5); call(Definitions.sys_memset, 0x8_162e); /* call 0x10165de0 */
            ii(0x100e_47b2, 6); mov(memw[ss, ebp - 44], 7);             /* mov word [ebp-0x2c], 0x7 */
            ii(0x100e_47b8, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100e_47bb, 4); mov(memw[ss, ebp - 40], ax);            /* mov [ebp-0x28], ax */
            ii(0x100e_47bf, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100e_47c2, 3); shr(eax, 0x10);                         /* shr eax, 0x10 */
            ii(0x100e_47c5, 4); mov(memw[ss, ebp - 36], ax);            /* mov [ebp-0x24], ax */
            ii(0x100e_47c9, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100e_47cc, 4); mov(memw[ss, ebp - 32], ax);            /* mov [ebp-0x20], ax */
            ii(0x100e_47d0, 3); lea(ebx, memd[ss, ebp - 44]);           /* lea ebx, [ebp-0x2c] */
            ii(0x100e_47d3, 3); lea(edx, memd[ss, ebp - 44]);           /* lea edx, [ebp-0x2c] */
            ii(0x100e_47d6, 5); mov(eax, 0x31);                         /* mov eax, 0x31 */
            ii(0x100e_47db, 5); call(/* sys */ 0x1016_c606, 0x8_7e26);  /* call 0x1016c606 */
            ii(0x100e_47e0, 4); cmp(memd[ss, ebp - 20], 0);             /* cmp dword [ebp-0x14], 0x0 */
            ii(0x100e_47e4, 2); if(jz(0x100e_47ef, 9)) goto l_0x100e_47ef; /* jz 0x100e47ef */
            ii(0x100e_47e6, 7); mov(memd[ss, ebp - 12], 0);             /* mov dword [ebp-0xc], 0x0 */
            ii(0x100e_47ed, 2); jmp(0x100e_47f6, 7); goto l_0x100e_47f6; /* jmp 0x100e47f6 */
        l_0x100e_47ef:
            ii(0x100e_47ef, 7); mov(memd[ss, ebp - 12], 1);             /* mov dword [ebp-0xc], 0x1 */
        l_0x100e_47f6:
            ii(0x100e_47f6, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
