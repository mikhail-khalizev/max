...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_97c3()
        {
            ...
            ii(0x97dd, 3);    mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ...
            ii(0x9809, 3);    mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ...
            ii(0x9816, 4);    test(memb[ss, bp - 0x2], 0x1);            /* test byte [bp-0x2], 0x1 */
            ii(0x981a, 2);    if(jz(0x9821, 0x5)) goto l_0x9821;        /* jz 0x9821 */
