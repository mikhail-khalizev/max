...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_2f1a()
        {
            ...
            ii(0x1013_2f38, 4); mov(memb[ds, eax + 29], 0);             /* mov byte [eax+0x1d], 0x0 */
        l_0x1013_2f3c:
            ii(0x1013_2f3c, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_2f3f, 4); cmp(memb[ds, eax + 29], 0);             /* cmp byte [eax+0x1d], 0x0 */
        ...
        l_0x1013_2f5c:
            ...
            ii(0x1013_2f5f, 4); mov(memb[ds, eax + 29], 1);             /* mov byte [eax+0x1d], 0x1 */
        l_0x1013_2f63:
