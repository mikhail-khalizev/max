...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_2f1a()
        {
            ...
            ii(0x1013_2f32, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1013_2f35, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_2f38, 4); mov(memb[ds, eax + 0x1d], 0);           /* mov byte [eax+0x1d], 0x0 */
        l_0x1013_2f3c:
            ii(0x1013_2f3c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1013_2f4a, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_2f4d, 7); cmp(memb[ds, 0x101c_37d2], 0);          /* cmp byte [0x101c37d2], 0x0 */
            ii(0x1013_2f54, 2); if(jnz(0x1013_2f5c, 0x6)) goto l_0x1013_2f5c; /* jnz 0x10132f5c */
            ii(0x1013_2f56, 4); cmp(memd[ss, ebp - 0x8], 0x1b);         /* cmp dword [ebp-0x8], 0x1b */
            ii(0x1013_2f5a, 2); if(jnz(0x1013_2f63, 0x7)) goto l_0x1013_2f63; /* jnz 0x10132f63 */
        l_0x1013_2f5c:
            ii(0x1013_2f5c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_2f5f, 4); mov(memb[ds, eax + 0x1d], 0x1);         /* mov byte [eax+0x1d], 0x1 */
        l_0x1013_2f63:
