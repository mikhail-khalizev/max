...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_4412()
        {
            ...
            ii(0x19_4427, 3); mov(ax, memw[ss, bp + 8]);                /* mov ax, [bp+0x8] */
            ii(0x19_442a, 3); mov(memw[ss, bp - 16], ax);               /* mov [bp-0x10], ax */
            ii(0x19_442d, 3); push(memw[ss, bp + 10]);                  /* push word [bp+0xa] */
            ii(0x19_4430, 2); push(0);                                  /* push 0x0 */
            ii(0x19_4432, 3); lea(ax, memw[ss, bp - 20]);               /* lea ax, [bp-0x14] */
            ii(0x19_4435, 1); push(ss);                                 /* push ss */
            ii(0x19_4436, 1); push(ax);                                 /* push ax */
            ii(0x19_4437, 3); push(memw[ss, bp + 6]);                   /* push word [bp+0x6] */
        ...
        l_0x19_4446:
            ...
            ii(0x19_4449, 3); mov(memw[ss, bp - 26], ax);               /* mov [bp-0x1a], ax */
            ii(0x19_444c, 5); mov(memw[ss, bp - 28], 0);                /* mov word [bp-0x1c], 0x0 */
            ii(0x19_4451, 3); mov(ax, memw[ss, bp + 6]);                /* mov ax, [bp+0x6] */
            ii(0x19_4454, 2); and(al, 0xf8);                            /* and al, 0xf8 */
            ii(0x19_4456, 3); add(ax, memw[ss, bp - 28]);               /* add ax, [bp-0x1c] */
            ii(0x19_4459, 3); mov(dx, memw[ss, bp - 26]);               /* mov dx, [bp-0x1a] */
            ii(0x19_445c, 3); mov(memw[ss, bp - 24], ax);               /* mov [bp-0x18], ax */
            ii(0x19_445f, 3); mov(memw[ss, bp - 22], dx);               /* mov [bp-0x16], dx */
            ii(0x19_4462, 3); les(bx, memw[ss, bp + 8]);                /* les bx, [bp+0x8] */
            ...
            ii(0x19_4471, 3); les(bx, memw[ss, bp - 24]);               /* les bx, [bp-0x18] */
            ii(0x19_4474, 5); cmp(memb[es, bx + 5], 1);                 /* cmp byte [es:bx+0x5], 0x1 */
            ii(0x19_4479, 2); sbb(ax, ax);                              /* sbb ax, ax */
            ii(0x19_447b, 1); inc(ax);                                  /* inc ax */
        l_0x19_447c:
            ii(0x19_447c, 3); mov(memw[ss, bp + 6], ax);                /* mov [bp+0x6], ax */
