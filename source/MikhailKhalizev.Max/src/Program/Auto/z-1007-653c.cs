...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_653c()
        {
            ...
            ii(0x1007_6554, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_6557, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_655a, 3); add(eax, 0x6);                          /* add eax, 0x6 */
            ii(0x1007_655d, 5); call(0x1007_6dd0, 0x86e);               /* call 0x10076dd0 */
            ii(0x1007_6562, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_6565, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
