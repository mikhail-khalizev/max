...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("b3e1abb3-d9f8-47f0-a7ef-dfd520ae18e6")]
        public void Method_1007_5e64()
        {
            ii(0x1007_5e64, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x1007_5e69, 5); calld(Definitions.sys_check_available_stack_size, 0xefee4); /* call 0x10165d52 */
            ...
            ii(0x1007_5eab, 1); retd(); return;                         /* ret */
        }
    }
}
