...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_65d8()
        {
            ...
            ii(0x1013_6612, 10); mov(memd[ds, 0x101b_d364], 0x1);       /* mov dword [0x101bd364], 0x1 */
            ...
            ii(0x1013_6634, 10); mov(memd[ds, 0x101b_d364], 0x2);       /* mov dword [0x101bd364], 0x2 */
            ...
            ii(0x1013_6656, 10); mov(memd[ds, 0x101b_d364], 0x3);       /* mov dword [0x101bd364], 0x3 */
            ...
            ii(0x1013_6678, 10); mov(memd[ds, 0x101b_d364], 0x4);       /* mov dword [0x101bd364], 0x4 */
            ...
            ii(0x1013_669a, 10); mov(memd[ds, 0x101b_d364], 0x5);       /* mov dword [0x101bd364], 0x5 */
            ...
            ii(0x1013_66bc, 10); mov(memd[ds, 0x101b_d364], 0x6);       /* mov dword [0x101bd364], 0x6 */
            ...
            ii(0x1013_66de, 10); mov(memd[ds, 0x101b_d364], 0x7);       /* mov dword [0x101bd364], 0x7 */
            ...
            ii(0x1013_6700, 10); mov(memd[ds, 0x101b_d364], 0x8);       /* mov dword [0x101bd364], 0x8 */
            ...
            ii(0x1013_6722, 10); mov(memd[ds, 0x101b_d364], 0x9);       /* mov dword [0x101bd364], 0x9 */
            ...
            ii(0x1013_6763, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ...
            ii(0x1013_6785, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
