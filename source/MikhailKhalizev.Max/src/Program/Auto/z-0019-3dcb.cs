...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_3dcb()
        {
            ...
            ii(0x19_3dcd, 4); test(memb[ds, bx + 0x2], 0x4);            /* test byte [bx+0x2], 0x4 */
            ii(0x19_3dd1, 2); if(jz(0x19_3de2, 0xf)) goto l_0x19_3de2;  /* jz 0x3de2 */
            ii(0x19_3dd3, 1); dec(dx);                                  /* dec dx */
            ii(0x19_3dd4, 3); mov(si, memw[ds, bx + 0x4]);              /* mov si, [bx+0x4] */
            ii(0x19_3dd7, 1); dec(si);                                  /* dec si */
            ii(0x19_3dd8, 2); cmp(dx, si);                              /* cmp dx, si */
            ii(0x19_3dda, 2); if(jb(0x19_3de1, 0x5)) goto l_0x19_3de1;  /* jb 0x3de1 */
            ii(0x19_3ddc, 3); cmp(memw[ds, bx - 0x2], dx);              /* cmp [bx-0x2], dx */
        ...
        l_0x19_3de2:
            ...
            ii(0x19_3dec, 2); if(jnz(0x19_3df1, 0x3)) goto l_0x19_3df1; /* jnz 0x3df1 */
            ii(0x19_3dee, 3); mov(ax, 0x1000);                          /* mov ax, 0x1000 */
        l_0x19_3df1:
            ii(0x19_3df1, 4); test(memb[ds, bx + 0x2], 0x4);            /* test byte [bx+0x2], 0x4 */
        ...
        l_0x19_3e01:
            ...
            ii(0x19_3e0d, 4); test(memb[ds, bx + 0x2], 0x4);            /* test byte [bx+0x2], 0x4 */
            ii(0x19_3e11, 2); if(jz(0x19_3e17, 0x4)) goto l_0x19_3e17;  /* jz 0x3e17 */
            ii(0x19_3e13, 1); dec(dx);                                  /* dec dx */
            ii(0x19_3e14, 3); mov(memw[ds, bx - 0x2], dx);              /* mov [bx-0x2], dx */
        l_0x19_3e17:
            ii(0x19_3e17, 1); clc();                                    /* clc */
            ii(0x19_3e18, 2); jmp(0x19_3e1b, 0x1); goto l_0x19_3e1b;    /* jmp 0x3e1b */
