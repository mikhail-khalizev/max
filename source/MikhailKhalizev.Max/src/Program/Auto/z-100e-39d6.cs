...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_39d6()
        {
            ...
            ii(0x100e_39f6, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100e_39f9, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100e_39fc, 3); mov(edx, memd[ds, eax + 36]);           /* mov edx, [eax+0x24] */
            ii(0x100e_39ff, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100e_3a02, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100e_3a05, 3); mov(eax, memd[ds, eax + 38]);           /* mov eax, [eax+0x26] */
            ii(0x100e_3a08, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100e_3a0b, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x100e_3a0d, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x100e_3a1d, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100e_3a20, 4); mov(dx, memw[ds, eax + 40]);            /* mov dx, [eax+0x28] */
            ii(0x100e_3a24, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100e_3a27, 4); add(memw[ds, eax + 38], dx);            /* add [eax+0x26], dx */
            ii(0x100e_3a2b, 5); mov(edx, 1);                            /* mov edx, 0x1 */
            ii(0x100e_3a30, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
