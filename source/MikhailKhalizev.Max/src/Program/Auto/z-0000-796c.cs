...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x796c, 4);    enter(0x8, 0);                            /* enter 0x8, 0x0 */
            ii(0x7970, 1);    push(di);                                 /* push di */
            ii(0x7971, 1);    push(si);                                 /* push si */
            ii(0x7972, 5);    mov(memw[ss, bp - 0x8], 0);               /* mov word [bp-0x8], 0x0 */
            ii(0x7977, 3);    call(0x572a, -0x2250);                    /* call 0x572a */
            ii(0x797a, 5);    mov(memw[ss, bp - 0x6], 0);               /* mov word [bp-0x6], 0x0 */
            ii(0x797f, 5);    mov(memw[ss, bp - 0x4], 0x8);             /* mov word [bp-0x4], 0x8 */
            ii(0x7984, 4);    cmp(memw[ss, bp + 0x4], 0);               /* cmp word [bp+0x4], 0x0 */
            ...
            ii(0x7997, 3);    mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
            ii(0x799a, 3);    add(ax, 0x10);                            /* add ax, 0x10 */
            ii(0x799d, 3);    mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ii(0x79a0, 2);    jmp(0x79ab, 0x9); goto l_0x79ab;          /* jmp 0x79ab */
        l_0x79a2:
            ii(0x79a2, 3);    cmp(memw[ss, bp - 0x2], si);              /* cmp [bp-0x2], si */
            ii(0x79a5, 2);    if(jl(0x79aa, 0x3)) goto l_0x79aa;        /* jl 0x79aa */
        ...
        l_0x79ab:
            ...
            ii(0x79b0, 3);    add(bx, memw[ss, bp - 0x6]);              /* add bx, [bp-0x6] */
            ii(0x79b3, 3);    mov(es, memw[ss, bp - 0x4]);              /* mov es, [bp-0x4] */
            ii(0x79b6, 5);    cmp(memb[es, bx + 0x5], 0);               /* cmp byte [es:bx+0x5], 0x0 */
            ii(0x79bb, 2);    if(jnz(0x79a2, -0x1b)) goto l_0x79a2;     /* jnz 0x79a2 */
            ii(0x79bd, 3);    mov(di, memw[ss, bp + 0x4]);              /* mov di, [bp+0x4] */
            ii(0x79c0, 1);    dec(di);                                  /* dec di */
        l_0x79c1:
            ii(0x79c1, 1);    dec(di);                                  /* dec di */
            ii(0x79c2, 2);    if(jns(0x79c9, 0x5)) goto l_0x79c9;       /* jns 0x79c9 */
        l_0x79c4:
            ii(0x79c4, 3);    mov(memw[ss, bp - 0x8], si);              /* mov [bp-0x8], si */
        ...
        l_0x79c9:
            ...
            ii(0x79cf, 3);    add(bx, memw[ss, bp - 0x6]);              /* add bx, [bp-0x6] */
            ii(0x79d2, 3);    mov(es, memw[ss, bp - 0x4]);              /* mov es, [bp-0x4] */
            ii(0x79d5, 5);    cmp(memb[es, bx + 0x5], 0);               /* cmp byte [es:bx+0x5], 0x0 */
        ...
        l_0x79de:
            ...
            ii(0x79ed, 3);    mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
        ...
        l_0x79f5:
            ...
            ii(0x79fa, 3);    add(bx, memw[ss, bp - 0x6]);              /* add bx, [bp-0x6] */
            ii(0x79fd, 5);    cmp(memb[es, bx + 0x5], 0);               /* cmp byte [es:bx+0x5], 0x0 */
            ii(0x7a02, 2);    if(jnz(0x7a25, 0x21)) goto l_0x7a25;      /* jnz 0x7a25 */
            ii(0x7a04, 3);    mov(di, memw[ss, bp + 0x4]);              /* mov di, [bp+0x4] */
        ...
        l_0x7a0b:
            ...
            ii(0x7a11, 3);    add(bx, memw[ss, bp - 0x6]);              /* add bx, [bp-0x6] */
            ii(0x7a14, 3);    mov(es, memw[ss, bp - 0x4]);              /* mov es, [bp-0x4] */
            ii(0x7a17, 5);    cmp(memb[es, bx + 0x5], 0);               /* cmp byte [es:bx+0x5], 0x0 */
        ...
        l_0x7a25:
            ...
            ii(0x7a26, 3);    cmp(memw[ss, bp - 0x2], si);              /* cmp [bp-0x2], si */
            ii(0x7a29, 2);    if(jg(0x79f5, -0x36)) goto l_0x79f5;      /* jg 0x79f5 */
            ii(0x7a2b, 2);    jmp(0x7a33, 0x6); goto l_0x7a33;          /* jmp 0x7a33 */
        l_0x7a2d:
            ii(0x7a2d, 4);    cmp(memw[ss, bp - 0x8], 0);               /* cmp word [bp-0x8], 0x0 */
            ii(0x7a31, 2);    if(jz(0x79f5, -0x3e)) goto l_0x79f5;      /* jz 0x79f5 */
        l_0x7a33:
            ii(0x7a33, 3);    call(0x4f61, -0x2ad5);                    /* call 0x4f61 */
            ii(0x7a36, 3);    mov(ax, memw[ss, bp - 0x8]);              /* mov ax, [bp-0x8] */
