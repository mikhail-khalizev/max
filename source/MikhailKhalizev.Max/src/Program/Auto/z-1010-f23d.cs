...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_f23d()
        {
            ...
            ii(0x1010_f255, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_f258, 7); mov(memd[ss, ebp - 0x8], 0xa);          /* mov dword [ebp-0x8], 0xa */
        l_0x1010_f25f:
            ii(0x1010_f25f, 3); dec(memd[ss, ebp - 0x8]);               /* dec dword [ebp-0x8] */
            ii(0x1010_f262, 5); cmp(memw[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp word [ebp-0x8], 0xffff */
            ii(0x1010_f267, 2); if(jz(0x1010_f2c6, 0x5d)) goto l_0x1010_f2c6; /* jz 0x1010f2c6 */
            ii(0x1010_f269, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_f26d, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_f270, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1010_f273, 7); cmp(memd[ds, eax + 0x1d9], 0);          /* cmp dword [eax+0x1d9], 0x0 */
            ii(0x1010_f27a, 2); if(jz(0x1010_f2c4, 0x48)) goto l_0x1010_f2c4; /* jz 0x1010f2c4 */
            ii(0x1010_f27c, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_f280, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_f283, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1010_f286, 6); mov(eax, memd[ds, eax + 0x1d9]);        /* mov eax, [eax+0x1d9] */
            ii(0x1010_f28c, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1010_f28f, 4); cmp(memd[ss, ebp - 0xc], 0);            /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1010_f293, 2); if(jz(0x1010_f2a9, 0x14)) goto l_0x1010_f2a9; /* jz 0x1010f2a9 */
            ii(0x1010_f295, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_f297, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1010_f2a4, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1010_f2a7, 2); jmp(0x1010_f2b0, 0x7); goto l_0x1010_f2b0; /* jmp 0x1010f2b0 */
        l_0x1010_f2a9:
            ii(0x1010_f2a9, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
        l_0x1010_f2b0:
            ii(0x1010_f2b0, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_f2b4, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_f2b7, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1010_f2ba, 10); mov(memd[ds, eax + 0x1d9], 0);         /* mov dword [eax+0x1d9], 0x0 */
        l_0x1010_f2c4:
