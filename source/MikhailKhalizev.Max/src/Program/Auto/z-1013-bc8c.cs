...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("732823de-e3a0-4f58-bd52-365cfee225cf")]
        public void Method_1013_bc8c()
        {
            ii(0x1013_bc8c, 5); pushd(0x3c);                            /* push 0x3c */
            ii(0x1013_bc91, 5); calld(Definitions.sys_check_available_stack_size, 0x2a0bc); /* call 0x10165d52 */
        ...
        l_0x1013_bcc9:
            ...
            ii(0x1013_bccf, 5); calld(Definitions.my_1_get_count, -0x907fc); /* call 0x100ab4d8 */
        ...
        l_0x1013_bcf4:
            ...
            ii(0x1013_bcfa, 5); calld(Definitions.my_1_get_count, -0x90827); /* call 0x100ab4d8 */
        ...
        l_0x1013_bd0f:
            ...
            ii(0x1013_bd14, 5); mov(ebx, 0x101a_cc63);                  /* mov ebx, 0x101acc63 */ /* "smrtfile.cpp" */
            ii(0x1013_bd19, 5); mov(edx, 0x101a_cc70);                  /* mov edx, 0x101acc70 */ /* "object_index == read_objects.GetCount() + 1" */
        ...
        l_0x1013_bd47:
            ...
            ii(0x1013_bd4c, 5); mov(ebx, 0x101a_cc9c);                  /* mov ebx, 0x101acc9c */ /* "smrtfile.cpp" */
            ii(0x1013_bd51, 5); mov(edx, 0x101a_cca9);                  /* mov edx, 0x101acca9 */ /* "type_index != 0" */
        ...
        l_0x1013_bd60:
            ...
            ii(0x1013_bd65, 5); calld(Definitions.my_1_get_count, -0x90892); /* call 0x100ab4d8 */
        ...
        l_0x1013_bd79:
            ...
            ii(0x1013_bd7e, 5); mov(ebx, 0x101a_ccb9);                  /* mov ebx, 0x101accb9 */ /* "smrtfile.cpp" */
            ii(0x1013_bd83, 5); mov(edx, 0x101a_ccc6);                  /* mov edx, 0x101accc6 */ /* "type_index <= registered_classes->GetCount()" */
