...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_e2d3()
        {
            ...
            ii(0x1007_e2ea, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_e2ed, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1007_e2f0, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1007_e2f7, 2); jmp(0x1007_e2ff, 0x6); goto l_0x1007_e2ff; /* jmp 0x1007e2ff */
        l_0x1007_e2f9:
            ii(0x1007_e2f9, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1007_e2fc, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x1007_e2ff:
            ii(0x1007_e2ff, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1007_e303, 3); cmp(eax, 0x8);                          /* cmp eax, 0x8 */
            ii(0x1007_e306, 2); if(jge(0x1007_e33c, 0x34)) goto l_0x1007_e33c; /* jge 0x1007e33c */
            ii(0x1007_e308, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_e30b, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1007_e30f, 3); imul(eax, eax, 0x16);                   /* imul eax, eax, 0x16 */
            ii(0x1007_e312, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ...
            ii(0x1007_e323, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1007_e326, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_e329, 5); call(0x1015_27ed, 0xd_44bf);            /* call 0x101527ed */
            ii(0x1007_e32e, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_e330, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_e333, 5); call(0x1015_2605, 0xd_42cd);            /* call 0x10152605 */
            ii(0x1007_e338, 2); jmp(0x1007_e33c, 0x2); goto l_0x1007_e33c; /* jmp 0x1007e33c */
        l_0x1007_e33a:
