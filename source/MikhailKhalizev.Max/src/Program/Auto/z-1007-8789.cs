...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_8789()
        {
            ...
            ii(0x1007_87a0, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1007_87a3, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1007_87a6, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1007_87a9, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x1007_87b7, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1007_87ba, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1007_87bd, 5); call(0x1015_d211, 0xe_4a4f);            /* call 0x1015d211 */
            ii(0x1007_87c2, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1007_87c5, 2); jmp(0x1007_87f4, 0x2d); goto l_0x1007_87f4; /* jmp 0x100787f4 */
        l_0x1007_87c7:
            ii(0x1007_87c7, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1007_87ca, 2); xor(ecx, ecx);                          /* xor ecx, ecx */
            ii(0x1007_87cc, 3); mov(cl, memb[ds, edx + 77]);            /* mov cl, [edx+0x4d] */
            ii(0x1007_87cf, 5); mov(ebx, 0x19);                         /* mov ebx, 0x19 */
            ii(0x1007_87d4, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1007_87d7, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x1007_87f1, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
        l_0x1007_87f4:
            ii(0x1007_87f4, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
