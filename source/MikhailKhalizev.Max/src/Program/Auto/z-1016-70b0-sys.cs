...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_70b0()
        {
            ...
            ii(0x1016_70b6, 4); mov(esi, memd[ss, esp + 0x14]);         /* mov esi, [esp+0x14] */
            ...
            ii(0x1016_70cf, 5); test(memb[ss, esp + 0x19], 0xff);       /* test byte [esp+0x19], 0xff */
            ii(0x1016_70d4, 2); if(jz(0x1016_7102, 0x2c)) goto l_0x1016_7102; /* jz 0x10167102 */
            ii(0x1016_70d6, 4); mov(eax, memd[ss, esp + 0x18]);         /* mov eax, [esp+0x18] */
            ...
            ii(0x1016_70ec, 4); mov(ebp, memd[ss, esp + 0x18]);         /* mov ebp, [esp+0x18] */
            ...
            ii(0x1016_7100, 2); jmp(0x1016_7109, 0x7); goto l_0x1016_7109; /* jmp 0x10167109 */
        l_0x1016_7102:
            ii(0x1016_7102, 4); mov(eax, memd[ss, esp + 0x18]);         /* mov eax, [esp+0x18] */
        ...
        l_0x1016_7109:
            ...
            ii(0x1016_710e, 2); if(jge(0x1016_7116, 0x6)) goto l_0x1016_7116; /* jge 0x10167116 */
        ...
        l_0x1016_7116:
            ...
            ii(0x1016_7118, 2); if(jge(0x1016_7120, 0x6)) goto l_0x1016_7120; /* jge 0x10167120 */
        ...
        l_0x1016_7120:
            ...
            ii(0x1016_7122, 3); mov(eax, memd[ds, edi + 0x2c]);         /* mov eax, [edi+0x2c] */
            ii(0x1016_7125, 1); push(ecx);                              /* push ecx */
            ii(0x1016_7126, 3); mov(esi, memd[ds, edi + 0x18]);         /* mov esi, [edi+0x18] */
        ...
        l_0x1016_7134:
            ...
            ii(0x1016_713a, 3); ret(0x8);                               /* ret 0x8 */
        }
    }
}
