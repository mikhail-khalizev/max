...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_a059()
        {
            ...
            ii(0x1011_a071, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_a074, 5); mov(eax, 0x101c_5316);                  /* mov eax, 0x101c5316 */
            ii(0x1011_a079, 5); call(0x1012_0d64, 0x6ce6);              /* call 0x10120d64 */
            ii(0x1011_a07e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_a081, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
