...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_accb()
        {
            ...
            ii(0x1012_acf0, 4); mov(ax, memw[ds, ebx + 0xc]);           /* mov ax, [ebx+0xc] */
            ...
            ii(0x1012_ad03, 7); mov(memd[ss, ebp - 0x4], 0x101c_5c21);  /* mov dword [ebp-0x4], 0x101c5c21 */
            ii(0x1012_ad0a, 5); mov(ebx, 0x18);                         /* mov ebx, 0x18 */
            ii(0x1012_ad0f, 5); mov(edx, 0x101c_4090);                  /* mov edx, 0x101c4090 */
            ii(0x1012_ad14, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
