...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_80e4()
        {
            ...
            ii(0x1014_80fc, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_80ff, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_8102, 3); add(eax, 0x6);                          /* add eax, 0x6 */
            ii(0x1014_8105, 5); call(0x1014_81a4, 0x9a);                /* call 0x101481a4 */
            ii(0x1014_810a, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_810d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
