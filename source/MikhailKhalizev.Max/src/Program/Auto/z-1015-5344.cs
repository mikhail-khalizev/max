...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("b21fbb2b-a269-49fd-9ce3-298e16f3f506")]
        public void Method_1015_5344()
        {
            ii(0x1015_5344, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x1015_5349, 5); calld(Definitions.sys_check_available_stack_size, 0x1_0a04); /* call 0x10165d52 */
            ...
            ii(0x1015_5367, 5); calld(0x1013_acc5, -0x1_a6a7);          /* call 0x1013acc5 */
