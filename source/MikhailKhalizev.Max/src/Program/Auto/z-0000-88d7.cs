...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x88d7, 4);  enter(8, 0);                               /* enter 0x8, 0x0 */
            ii(0x88db, 5);  mov(memw[ss, bp - 4], 0x47b2);             /* mov word [bp-0x4], 0x47b2 */
            ii(0x88e0, 5);  mov(memw[ss, bp - 2], 0x35f);              /* mov word [bp-0x2], 0x35f */
            ii(0x88e5, 3);  mov(memw[ss, bp - 6], ds);                 /* mov [bp-0x6], ds */
            ii(0x88e8, 5);  cmp(memw[ds, 0xe70], 0);                   /* cmp word [0xe70], 0x0 */
            ii(0x88ed, 2);  if(jge(0x88f6, 7)) goto l_0x88f6;          /* jge 0x88f6 */
        ...
        l_0x88f6:
            ...
            ii(0x88fb, 2);  if(jge(0x8903, 6)) goto l_0x8903;          /* jge 0x8903 */
            ii(0x88fd, 2);  push(-8 /* 0xf8 */);                       /* push 0xfff8 */
            ii(0x88ff, 3);  call(0x604d, -0x28b5);                     /* call 0x604d */
            ii(0x8902, 1);  pop(bx);                                   /* pop bx */
        l_0x8903:
            ii(0x8903, 3);  mov(ax, memw[ds, 0xc26]);                  /* mov ax, [0xc26] */
            ii(0x8906, 3);  mov(memw[ss, bp - 2], ax);                 /* mov [bp-0x2], ax */
            ii(0x8909, 1);  push(ds);                                  /* push ds */
            ii(0x890a, 3);  push(memw[ss, bp + 4]);                    /* push word [bp+0x4] */
            ii(0x890d, 2);  push(0);                                   /* push 0x0 */
            ii(0x890f, 3);  call_far_ind(memw[ss, bp - 4]);            /* call far word [bp-0x4] */
            ii(0x8912, 3);  mov(ax, memw[ss, bp - 6]);                 /* mov ax, [bp-0x6] */
