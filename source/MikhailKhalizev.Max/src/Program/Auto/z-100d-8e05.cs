...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_8e05()
        {
            ...
            ii(0x100d_8e1d, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100d_8e20, 4); or(memb[ss, ebp - 0x8], 0x1);           /* or byte [ebp-0x8], 0x1 */
            ii(0x100d_8e24, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x100d_8e27, 5); call(0x100c_a02c, -0xee00);             /* call 0x100ca02c */
            ii(0x100d_8e2c, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100d_8e2f, 4); and(memb[ss, ebp - 0x8], -0x2 /* 0xfe */); /* and byte [ebp-0x8], 0xfe */
            ii(0x100d_8e33, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_8e36, 7); cmp(memd[ds, eax + 0x345], 0);          /* cmp dword [eax+0x345], 0x0 */
            ii(0x100d_8e3d, 2); if(jz(0x100d_8e48, 0x9)) goto l_0x100d_8e48; /* jz 0x100d8e48 */
            ii(0x100d_8e3f, 7); mov(memd[ss, ebp - 0x1c], 0);           /* mov dword [ebp-0x1c], 0x0 */
        ...
        l_0x100d_8e48:
            ...
            ii(0x100d_8e5e, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
        l_0x100d_8e61:
            ii(0x100d_8e61, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x100d_8e68, 2); jmp(0x100d_8e70, 0x6); goto l_0x100d_8e70; /* jmp 0x100d8e70 */
        l_0x100d_8e6a:
            ii(0x100d_8e6a, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_8e6d, 3); inc(memd[ss, ebp - 0x10]);              /* inc dword [ebp-0x10] */
        l_0x100d_8e70:
            ii(0x100d_8e70, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x100d_8e74, 3); cmp(eax, 0x5d);                         /* cmp eax, 0x5d */
            ii(0x100d_8e77, 2); if(jge(0x100d_8e9c, 0x23)) goto l_0x100d_8e9c; /* jge 0x100d8e9c */
            ii(0x100d_8e79, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x100d_8e7d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_8e89, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_8e8c, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x100d_8e8f, 3); lea(edx, memd[ss, ebp - 0x20]);         /* lea edx, [ebp-0x20] */
            ii(0x100d_8e92, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
        ...
        l_0x100d_8e9c:
            ii(0x100d_8e9c, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x100d_8ea3, 2); jmp(0x100d_8eab, 0x6); goto l_0x100d_8eab; /* jmp 0x100d8eab */
        l_0x100d_8ea5:
            ii(0x100d_8ea5, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_8ea8, 3); inc(memd[ss, ebp - 0x10]);              /* inc dword [ebp-0x10] */
        l_0x100d_8eab:
            ii(0x100d_8eab, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x100d_8eae, 5); call(Definitions.my_2_get_count, -0x4_db4b); /* call 0x1008b368 */
            ii(0x100d_8eb3, 1); cwde();                                 /* cwde */
            ii(0x100d_8eb4, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x100d_8ec1, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_8ec4, 1); inc(eax);                               /* inc eax */
            ii(0x100d_8ec5, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100d_8ec8, 2); jmp(0x100d_8ed0, 0x6); goto l_0x100d_8ed0; /* jmp 0x100d8ed0 */
        l_0x100d_8eca:
            ii(0x100d_8eca, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100d_8ecd, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x100d_8ed0:
            ii(0x100d_8ed0, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x100d_8ed3, 5); call(Definitions.my_2_get_count, -0x4_db70); /* call 0x1008b368 */
            ii(0x100d_8ed8, 4); cmp(ax, memw[ss, ebp - 0xc]);           /* cmp ax, [ebp-0xc] */
            ii(0x100d_8edc, 2); if(jle(0x100d_8f52, 0x74)) goto l_0x100d_8f52; /* jle 0x100d8f52 */
            ii(0x100d_8ede, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100d_8ee2, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x100d_8ee5, 5); call(0x1008_b228, -0x4_dcc2);           /* call 0x1008b228 */
            ii(0x100d_8eea, 3); movsx(ebx, memw[ds, eax]);              /* movsx ebx, word [eax] */
            ii(0x100d_8eed, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x100d_8ef1, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x100d_8f07, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x100d_8f0b, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x100d_8f0e, 5); call(0x1008_b228, -0x4_dceb);           /* call 0x1008b228 */
            ii(0x100d_8f13, 3); mov(ax, memw[ds, eax]);                 /* mov ax, [eax] */
            ii(0x100d_8f16, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x100d_8f19, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100d_8f1d, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x100d_8f20, 5); call(0x1008_b228, -0x4_dcfd);           /* call 0x1008b228 */
            ii(0x100d_8f25, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x100d_8f27, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x100d_8f2b, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x100d_8f39, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100d_8f3d, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x100d_8f40, 5); call(0x1008_b228, -0x4_dd1d);           /* call 0x1008b228 */
            ii(0x100d_8f45, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100d_8f47, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
        ...
        l_0x100d_8f57:
            ii(0x100d_8f57, 3); lea(edx, memd[ss, ebp - 0x18]);         /* lea edx, [ebp-0x18] */
            ii(0x100d_8f5a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_8f5d, 6); mov(eax, memd[ds, eax + 0x345]);        /* mov eax, [eax+0x345] */
            ii(0x100d_8f63, 5); call(0x100d_0264, -0x8d04);             /* call 0x100d0264 */
            ii(0x100d_8f68, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100d_8f6a, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
