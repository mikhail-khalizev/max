...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_b5c8()
        {
            ...
            ii(0x1018_b5cf, 3); mov(memd[ss, ebp + 0x8], eax);          /* mov [ebp+0x8], eax */
            ii(0x1018_b5d2, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1018_b5d4, 3); mov(memd[ss, ebp + 0xc], ebx);          /* mov [ebp+0xc], ebx */
            ii(0x1018_b5d7, 3); mov(memd[ss, ebp + 0x4], edx);          /* mov [ebp+0x4], edx */
        ...
        l_0x1018_b5f5:
            ii(0x1018_b5f5, 3); mov(ebx, memd[ss, ebp + 0x8]);          /* mov ebx, [ebp+0x8] */
            ...
            ii(0x1018_b611, 2); jmp(0x1018_b616, 0x3); goto l_0x1018_b616; /* jmp 0x1018b616 */
        l_0x1018_b613:
            ii(0x1018_b613, 3); mov(memd[ss, ebp + 0x20], ebx);         /* mov [ebp+0x20], ebx */
        l_0x1018_b616:
            ii(0x1018_b616, 3); cmp(edx, -0x1 /* 0xff */);              /* cmp edx, 0xffffffff */
            ii(0x1018_b619, 2); if(jz(0x1018_b622, 0x7)) goto l_0x1018_b622; /* jz 0x1018b622 */
            ii(0x1018_b61b, 7); mov(memd[ss, ebp + 0], 0xfeba_feba);    /* mov dword [ebp], 0xfebafeba */
        l_0x1018_b622:
