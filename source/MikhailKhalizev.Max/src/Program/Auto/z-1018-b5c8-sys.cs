...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_b5c8()
        {
            ...
            ii(0x1018_b5d4, 3);  mov(memd[ss, ebp + 12], ebx);         /* mov [ebp+0xc], ebx */
            ...
            ii(0x1018_b5e0, 3);  lea(edi, memd[ss, ebp + 16]);         /* lea edi, [ebp+0x10] */
        ...
        l_0x1018_b5e9:
            ii(0x1018_b5e9, 3);  mov(memd[ss, ebp + 16], edx);         /* mov [ebp+0x10], edx */
            ii(0x1018_b5ec, 3);  mov(memd[ss, ebp + 20], edx);         /* mov [ebp+0x14], edx */
            ii(0x1018_b5ef, 3);  mov(memd[ss, ebp + 24], edx);         /* mov [ebp+0x18], edx */
            ii(0x1018_b5f2, 3);  mov(memd[ss, ebp + 28], edx);         /* mov [ebp+0x1c], edx */
        l_0x1018_b5f5:
            ...
            ii(0x1018_b605, 3);  mov(memd[ss, ebp + 32], eax);         /* mov [ebp+0x20], eax */
        ...
        l_0x1018_b613:
            ii(0x1018_b613, 3);  mov(memd[ss, ebp + 32], ebx);         /* mov [ebp+0x20], ebx */
        l_0x1018_b616:
