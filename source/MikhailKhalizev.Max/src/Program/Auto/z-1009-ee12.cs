...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_ee12()
        {
            ...
            ii(0x1009_ee28, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1009_ee2b, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1009_ee2e, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1009_ee31, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1009_ee34, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1009_ee4c, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1009_ee4f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_ee52, 5); cmp(memw[ds, eax + 0x8], 0x44);         /* cmp word [eax+0x8], 0x44 */
            ii(0x1009_ee57, 2); if(jz(0x1009_ee63, 0xa)) goto l_0x1009_ee63; /* jz 0x1009ee63 */
            ii(0x1009_ee59, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_ee5c, 5); cmp(memw[ds, eax + 0x8], 0x47);         /* cmp word [eax+0x8], 0x47 */
            ii(0x1009_ee61, 2); if(jnz(0x1009_ee9d, 0x3a)) goto l_0x1009_ee9d; /* jnz 0x1009ee9d */
        l_0x1009_ee63:
            ii(0x1009_ee63, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_ee76, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_ee90, 2); if(jz(0x1009_ee9b, 0x9)) goto l_0x1009_ee9b; /* jz 0x1009ee9b */
            ii(0x1009_ee92, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
        ...
        l_0x1009_ee9d:
            ii(0x1009_ee9d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_eeb0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_eeca, 2); if(jz(0x1009_eed2, 0x6)) goto l_0x1009_eed2; /* jz 0x1009eed2 */
            ii(0x1009_eecc, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
            ii(0x1009_eed0, 2); jmp(0x1009_ef09, 0x37); goto l_0x1009_ef09; /* jmp 0x1009ef09 */
        l_0x1009_eed2:
            ii(0x1009_eed2, 4); cmp(memd[ss, ebp - 0x14], 0);           /* cmp dword [ebp-0x14], 0x0 */
            ii(0x1009_eed6, 2); if(jz(0x1009_eef7, 0x1f)) goto l_0x1009_eef7; /* jz 0x1009eef7 */
            ii(0x1009_eed8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_eedb, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x1009_eede, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1009_eee1, 3); mov(edx, memd[ss, ebp - 0x14]);         /* mov edx, [ebp-0x14] */
            ii(0x1009_eee4, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1009_eee6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_eef2, 3); test(memb[ds, eax], 0x1);               /* test byte [eax], 0x1 */
            ii(0x1009_eef5, 2); if(jnz(0x1009_eef9, 0x2)) goto l_0x1009_eef9; /* jnz 0x1009eef9 */
        l_0x1009_eef7:
            ii(0x1009_eef7, 2); jmp(0x1009_eeff, 0x6); goto l_0x1009_eeff; /* jmp 0x1009eeff */
        l_0x1009_eef9:
            ii(0x1009_eef9, 4); mov(memb[ss, ebp - 0x18], 0x1);         /* mov byte [ebp-0x18], 0x1 */
            ii(0x1009_eefd, 2); jmp(0x1009_ef03, 0x4); goto l_0x1009_ef03; /* jmp 0x1009ef03 */
        l_0x1009_eeff:
            ii(0x1009_eeff, 4); mov(memb[ss, ebp - 0x18], 0);           /* mov byte [ebp-0x18], 0x0 */
        l_0x1009_ef03:
            ii(0x1009_ef03, 3); mov(al, memb[ss, ebp - 0x18]);          /* mov al, [ebp-0x18] */
            ii(0x1009_ef06, 3); mov(memb[ss, ebp - 0x10], al);          /* mov [ebp-0x10], al */
        l_0x1009_ef09:
            ii(0x1009_ef09, 3); mov(al, memb[ss, ebp - 0x10]);          /* mov al, [ebp-0x10] */
