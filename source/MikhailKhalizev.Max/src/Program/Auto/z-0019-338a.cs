...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_338a()
        {
            ...
            ii(0x19_3390, 3); mov(ds, memw[ss, bp + 0x6]);              /* mov ds, [bp+0x6] */
            ii(0x19_3393, 3); mov(si, memw[ss, bp + 0x8]);              /* mov si, [bp+0x8] */
            ii(0x19_3396, 3); mov(es, memw[ss, bp + 0xa]);              /* mov es, [bp+0xa] */
            ii(0x19_3399, 3); mov(di, memw[ss, bp + 0xc]);              /* mov di, [bp+0xc] */
            ii(0x19_339c, 3); mov(cx, memw[ss, bp + 0xe]);              /* mov cx, [bp+0xe] */
