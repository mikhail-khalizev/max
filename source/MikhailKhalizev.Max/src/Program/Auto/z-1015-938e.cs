...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_938e()
        {
            ...
            ii(0x1015_93a6, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_93a9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_93ac, 4); cmp(memb[ds, eax + 0x3d], 0x4);         /* cmp byte [eax+0x3d], 0x4 */
            ii(0x1015_93b0, 2); if(jnz(0x1015_93bb, 0x9)) goto l_0x1015_93bb; /* jnz 0x101593bb */
            ii(0x1015_93b2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_93b5, 4); cmp(memb[ds, eax + 0x3e], 0x1f);        /* cmp byte [eax+0x3e], 0x1f */
            ii(0x1015_93b9, 2); if(jz(0x1015_93bd, 0x2)) goto l_0x1015_93bd; /* jz 0x101593bd */
        l_0x1015_93bb:
            ii(0x1015_93bb, 2); jmp(0x1015_93c3, 0x6); goto l_0x1015_93c3; /* jmp 0x101593c3 */
        l_0x1015_93bd:
            ii(0x1015_93bd, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x1015_93c1, 2); jmp(0x1015_93ce, 0xb); goto l_0x1015_93ce; /* jmp 0x101593ce */
        l_0x1015_93c3:
            ii(0x1015_93c3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_93c6, 5); call(0x1015_7c72, -0x1759);             /* call 0x10157c72 */
            ii(0x1015_93cb, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
        l_0x1015_93ce:
            ii(0x1015_93ce, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
