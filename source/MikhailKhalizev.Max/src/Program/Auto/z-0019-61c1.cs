...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_61c1()
        {
            ...
            ii(0x19_61ce, 3); add(sp, 2);                               /* add sp, 0x2 */
            ii(0x19_61d1, 3); push(memw[ss, bp + 8]);                   /* push word [bp+0x8] */
            ii(0x19_61d4, 3); push(memw[ss, bp + 6]);                   /* push word [bp+0x6] */
            ii(0x19_61d7, 3); push(memw[ss, bp + 4]);                   /* push word [bp+0x4] */
            ii(0x19_61da, 5); if(call_far_abs_up(0x80, 0xbe4)) return;  /* call word 0x80:0xbe4 */
