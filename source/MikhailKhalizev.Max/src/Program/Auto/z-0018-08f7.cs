...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x18_08f7, 4); enter(0x4, 0);                            /* enter 0x4, 0x0 */
            ...
            ii(0x18_0908, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ...
            ii(0x18_0913, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x18_0916, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x18_0919, 1); pop(ds);                                  /* pop ds */
            ii(0x18_091a, 1); pop(ds);                                  /* pop ds */
            ii(0x18_091b, 1); leave();                                  /* leave */
            ii(0x18_091c, 3); retf(0x4);                                /* retf 0x4 */
        }
    }
}
