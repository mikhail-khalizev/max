...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_3eb4()
        {
            ...
            ii(0x100c_3ecc, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_3ecf, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_3ed2, 3); mov(al, memb[ds, eax + 0x2]);           /* mov al, [eax+0x2] */
            ii(0x100c_3ed5, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
        ...
        l_0x100c_3edd:
            ...
            ii(0x100c_3eea, 2); if(jnz(0x100c_3ef5, 0x9)) goto l_0x100c_3ef5; /* jnz 0x100c3ef5 */
            ii(0x100c_3eec, 7); mov(memd[ss, ebp - 0xc], 0x8);          /* mov dword [ebp-0xc], 0x8 */
            ii(0x100c_3ef3, 2); jmp(0x100c_3efc, 0x7); goto l_0x100c_3efc; /* jmp 0x100c3efc */
        l_0x100c_3ef5:
            ii(0x100c_3ef5, 7); mov(memd[ss, ebp - 0xc], 0x7);          /* mov dword [ebp-0xc], 0x7 */
        l_0x100c_3efc:
        ...
        l_0x100c_3f01:
            ...
            ii(0x100c_3f0e, 2); if(jnz(0x100c_3f19, 0x9)) goto l_0x100c_3f19; /* jnz 0x100c3f19 */
            ii(0x100c_3f10, 7); mov(memd[ss, ebp - 0xc], 0x8);          /* mov dword [ebp-0xc], 0x8 */
            ii(0x100c_3f17, 2); jmp(0x100c_3f20, 0x7); goto l_0x100c_3f20; /* jmp 0x100c3f20 */
        l_0x100c_3f19:
            ii(0x100c_3f19, 7); mov(memd[ss, ebp - 0xc], 0x4);          /* mov dword [ebp-0xc], 0x4 */
        l_0x100c_3f20:
        ...
        l_0x100c_3f25:
            ...
            ii(0x100c_3f32, 2); if(jnz(0x100c_3f3d, 0x9)) goto l_0x100c_3f3d; /* jnz 0x100c3f3d */
            ii(0x100c_3f34, 7); mov(memd[ss, ebp - 0xc], 0x8);          /* mov dword [ebp-0xc], 0x8 */
            ii(0x100c_3f3b, 2); jmp(0x100c_3f44, 0x7); goto l_0x100c_3f44; /* jmp 0x100c3f44 */
        l_0x100c_3f3d:
            ii(0x100c_3f3d, 7); mov(memd[ss, ebp - 0xc], 0x1);          /* mov dword [ebp-0xc], 0x1 */
        l_0x100c_3f44:
        ...
        l_0x100c_3f49:
            ...
            ii(0x100c_3f56, 2); if(jnz(0x100c_3f61, 0x9)) goto l_0x100c_3f61; /* jnz 0x100c3f61 */
            ii(0x100c_3f58, 7); mov(memd[ss, ebp - 0xc], 0x8);          /* mov dword [ebp-0xc], 0x8 */
            ii(0x100c_3f5f, 2); jmp(0x100c_3f68, 0x7); goto l_0x100c_3f68; /* jmp 0x100c3f68 */
        l_0x100c_3f61:
            ii(0x100c_3f61, 7); mov(memd[ss, ebp - 0xc], 0x2);          /* mov dword [ebp-0xc], 0x2 */
        l_0x100c_3f68:
            ii(0x100c_3f68, 5); jmp(0x100c_4021, 0xb4); goto l_0x100c_4021; /* jmp 0x100c4021 */
        l_0x100c_3f6d:
            ii(0x100c_3f6d, 7); mov(memd[ss, ebp - 0xc], 0x6);          /* mov dword [ebp-0xc], 0x6 */
            ii(0x100c_3f74, 5); jmp(0x100c_4021, 0xa8); goto l_0x100c_4021; /* jmp 0x100c4021 */
        l_0x100c_3f79:
            ii(0x100c_3f79, 7); mov(memd[ss, ebp - 0xc], 0x5);          /* mov dword [ebp-0xc], 0x5 */
            ii(0x100c_3f80, 5); jmp(0x100c_4021, 0x9c); goto l_0x100c_4021; /* jmp 0x100c4021 */
        l_0x100c_3f85:
            ii(0x100c_3f85, 7); mov(memd[ss, ebp - 0xc], 0x6);          /* mov dword [ebp-0xc], 0x6 */
        ...
        l_0x100c_3f91:
            ...
            ii(0x100c_3f9e, 2); if(jnz(0x100c_3fa9, 0x9)) goto l_0x100c_3fa9; /* jnz 0x100c3fa9 */
            ii(0x100c_3fa0, 7); mov(memd[ss, ebp - 0xc], 0x8);          /* mov dword [ebp-0xc], 0x8 */
        ...
        l_0x100c_3fbc:
            ...
            ii(0x100c_3fc9, 2); if(jnz(0x100c_3fd4, 0x9)) goto l_0x100c_3fd4; /* jnz 0x100c3fd4 */
            ii(0x100c_3fcb, 7); mov(memd[ss, ebp - 0xc], 0x8);          /* mov dword [ebp-0xc], 0x8 */
            ii(0x100c_3fd2, 2); jmp(0x100c_3fdb, 0x7); goto l_0x100c_3fdb; /* jmp 0x100c3fdb */
        l_0x100c_3fd4:
            ii(0x100c_3fd4, 7); mov(memd[ss, ebp - 0xc], 0x3);          /* mov dword [ebp-0xc], 0x3 */
        l_0x100c_3fdb:
        ...
        l_0x100c_4004:
            ii(0x100c_4004, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x100c_4007, 2); dec(al);                                /* dec al */
            ii(0x100c_4009, 3); mov(memb[ss, ebp - 0x14], al);          /* mov [ebp-0x14], al */
            ii(0x100c_400c, 4); cmp(memb[ss, ebp - 0x14], 0x8);         /* cmp byte [ebp-0x14], 0x8 */
            ii(0x100c_4010, 2); if(ja(0x100c_3fdd, -0x35)) goto l_0x100c_3fdd; /* ja 0x100c3fdd */
            ii(0x100c_4012, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x100c_4014, 3); mov(al, memb[ss, ebp - 0x14]);          /* mov al, [ebp-0x14] */
        ...
        l_0x100c_4021:
            ii(0x100c_4021, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100c_4025, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_4034, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_4037, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x100c_403a, 5); call(0x1013_602e, 0x7_1fef);            /* call 0x1013602e */
            ii(0x100c_403f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100c_4042, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100c_4045, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
