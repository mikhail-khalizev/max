...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x100c_3edd:
            ...
            ii(0x100c_3eec, 7); mov(memd[ss, ebp - 0xc], 8);            /* mov dword [ebp-0xc], 0x8 */
            ii(0x100c_3ef3, 2); jmp(0x100c_3efc, 7); goto l_0x100c_3efc; /* jmp 0x100c3efc */
        l_0x100c_3ef5:
            ii(0x100c_3ef5, 7); mov(memd[ss, ebp - 0xc], 7);            /* mov dword [ebp-0xc], 0x7 */
        l_0x100c_3efc:
        ...
        l_0x100c_3f01:
            ...
            ii(0x100c_3f10, 7); mov(memd[ss, ebp - 0xc], 8);            /* mov dword [ebp-0xc], 0x8 */
            ii(0x100c_3f17, 2); jmp(0x100c_3f20, 7); goto l_0x100c_3f20; /* jmp 0x100c3f20 */
        l_0x100c_3f19:
            ii(0x100c_3f19, 7); mov(memd[ss, ebp - 0xc], 4);            /* mov dword [ebp-0xc], 0x4 */
        l_0x100c_3f20:
        ...
        l_0x100c_3f25:
            ...
            ii(0x100c_3f34, 7); mov(memd[ss, ebp - 0xc], 8);            /* mov dword [ebp-0xc], 0x8 */
            ii(0x100c_3f3b, 2); jmp(0x100c_3f44, 7); goto l_0x100c_3f44; /* jmp 0x100c3f44 */
        l_0x100c_3f3d:
            ii(0x100c_3f3d, 7); mov(memd[ss, ebp - 0xc], 1);            /* mov dword [ebp-0xc], 0x1 */
        l_0x100c_3f44:
        ...
        l_0x100c_3f49:
            ...
            ii(0x100c_3f58, 7); mov(memd[ss, ebp - 0xc], 8);            /* mov dword [ebp-0xc], 0x8 */
            ii(0x100c_3f5f, 2); jmp(0x100c_3f68, 7); goto l_0x100c_3f68; /* jmp 0x100c3f68 */
        l_0x100c_3f61:
            ii(0x100c_3f61, 7); mov(memd[ss, ebp - 0xc], 2);            /* mov dword [ebp-0xc], 0x2 */
        l_0x100c_3f68:
            ii(0x100c_3f68, 5); jmp(0x100c_4021, 0xb4); goto l_0x100c_4021; /* jmp 0x100c4021 */
        l_0x100c_3f6d:
            ii(0x100c_3f6d, 7); mov(memd[ss, ebp - 0xc], 6);            /* mov dword [ebp-0xc], 0x6 */
            ii(0x100c_3f74, 5); jmp(0x100c_4021, 0xa8); goto l_0x100c_4021; /* jmp 0x100c4021 */
        l_0x100c_3f79:
            ii(0x100c_3f79, 7); mov(memd[ss, ebp - 0xc], 5);            /* mov dword [ebp-0xc], 0x5 */
            ii(0x100c_3f80, 5); jmp(0x100c_4021, 0x9c); goto l_0x100c_4021; /* jmp 0x100c4021 */
        l_0x100c_3f85:
            ii(0x100c_3f85, 7); mov(memd[ss, ebp - 0xc], 6);            /* mov dword [ebp-0xc], 0x6 */
        ...
        l_0x100c_3f91:
            ...
            ii(0x100c_3fa0, 7); mov(memd[ss, ebp - 0xc], 8);            /* mov dword [ebp-0xc], 0x8 */
        ...
        l_0x100c_3fbc:
            ...
            ii(0x100c_3fcb, 7); mov(memd[ss, ebp - 0xc], 8);            /* mov dword [ebp-0xc], 0x8 */
            ii(0x100c_3fd2, 2); jmp(0x100c_3fdb, 7); goto l_0x100c_3fdb; /* jmp 0x100c3fdb */
        l_0x100c_3fd4:
            ii(0x100c_3fd4, 7); mov(memd[ss, ebp - 0xc], 3);            /* mov dword [ebp-0xc], 0x3 */
        l_0x100c_3fdb:
        ...
        l_0x100c_4004:
            ...
            ii(0x100c_400c, 4); cmp(memb[ss, ebp - 0x14], 8);           /* cmp byte [ebp-0x14], 0x8 */
