...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_b4fd()
        {
            ...
            ii(0x100f_b50e, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x100f_b514, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100f_b517, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100f_b51a, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100f_b52d, 3);  mov(al, memb[ss, ebp - 8]);           /* mov al, [ebp-0x8] */
        ...
        l_0x100f_b548:
            ii(0x100f_b548, 2);  jmp(0x100f_b551, 7); goto l_0x100f_b551;/* jmp 0x100fb551 */
        l_0x100f_b54a:
