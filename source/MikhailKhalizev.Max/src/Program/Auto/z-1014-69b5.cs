...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_69b5()
        {
            ...
            ii(0x1014_69cd, 4); or(memb[ss, ebp - 0x4], 0x1);           /* or byte [ebp-0x4], 0x1 */
            ii(0x1014_69d1, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_69d4, 5); call(Definitions.my_string_ctor, -0x4ef1); /* call 0x10141ae8 */
            ii(0x1014_69d9, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1014_69dc, 4); and(memb[ss, ebp - 0x4], -0x2 /* 0xfe */); /* and byte [ebp-0x4], 0xfe */
            ...
            ii(0x1014_69eb, 3); lea(eax, memd[ss, ebp + 0x24]);         /* lea eax, [ebp+0x24] */
            ii(0x1014_69ee, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_69f1, 3); lea(ecx, memd[ss, ebp - 0xc]);          /* lea ecx, [ebp-0xc] */
            ii(0x1014_69f4, 3); mov(ebx, memd[ss, ebp + 0x20]);         /* mov ebx, [ebp+0x20] */
            ii(0x1014_69f7, 5); mov(edx, 0x12c);                        /* mov edx, 0x12c */
            ii(0x1014_69fc, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_69ff, 5); call(0x1014_20d7, -0x492d);             /* call 0x101420d7 */
            ii(0x1014_6a04, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1014_6a0b, 3); mov(eax, memd[ss, ebp + 0x1c]);         /* mov eax, [ebp+0x1c] */
            ii(0x1014_6a0e, 3); mov(eax, memd[ds, eax + 0x18]);         /* mov eax, [eax+0x18] */
            ii(0x1014_6a11, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1014_6a14, 1); push(eax);                              /* push eax */
            ii(0x1014_6a15, 3); mov(eax, memd[ss, ebp + 0x1c]);         /* mov eax, [ebp+0x1c] */
            ii(0x1014_6a18, 3); mov(ecx, memd[ds, eax + 0x16]);         /* mov ecx, [eax+0x16] */
            ii(0x1014_6a1b, 3); mov(eax, memd[ss, ebp + 0x1c]);         /* mov eax, [ebp+0x1c] */
            ...
            ii(0x1014_6a28, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_6a2b, 5); call(Definitions.my_strobj_c_str_v2, -0xb_d268); /* call 0x100897c8 */
            ii(0x1014_6a30, 3); lea(esi, memd[ss, ebp - 0x8]);          /* lea esi, [ebp-0x8] */
            ...
            ii(0x1014_6a48, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x1014_6a5c, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
