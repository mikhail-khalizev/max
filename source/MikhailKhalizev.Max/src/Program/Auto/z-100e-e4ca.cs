...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_e4ca()
        {
            ...
            ii(0x100e_e4e2, 7); mov(memd[ss, ebp - 0x8], 0x9);          /* mov dword [ebp-0x8], 0x9 */
            ii(0x100e_e4e9, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x100e_e4f8, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ...
            ii(0x100e_e509, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ii(0x100e_e50c, 5); call(Definitions.my_string_ctor_char_ptr, 0x5_352a); /* call 0x10141a3b */
            ii(0x100e_e511, 4); or(memb[ss, ebp - 0x4], 0x1);           /* or byte [ebp-0x4], 0x1 */
            ii(0x100e_e515, 3); lea(eax, memd[ss, ebp - 0x20]);         /* lea eax, [ebp-0x20] */
            ii(0x100e_e518, 5); call(Definitions.my_string_ctor, 0x5_35cb); /* call 0x10141ae8 */
            ii(0x100e_e51d, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100e_e520, 4); and(memb[ss, ebp - 0x4], -0x2 /* 0xfe */); /* and byte [ebp-0x4], 0xfe */
            ii(0x100e_e524, 4); or(memb[ss, ebp - 0x4], 0x1);           /* or byte [ebp-0x4], 0x1 */
            ii(0x100e_e528, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x100e_e52b, 5); call(Definitions.my_string_ctor, 0x5_35b8); /* call 0x10141ae8 */
            ii(0x100e_e530, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100e_e533, 4); and(memb[ss, ebp - 0x4], -0x2 /* 0xfe */); /* and byte [ebp-0x4], 0xfe */
            ...
            ii(0x100e_e54c, 3); lea(eax, memd[ss, ebp - 0x20]);         /* lea eax, [ebp-0x20] */
            ...
            ii(0x100e_e558, 3); lea(edx, memd[ss, ebp - 0x20]);         /* lea edx, [ebp-0x20] */
            ii(0x100e_e55b, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ...
            ii(0x100e_e568, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
        ...
        l_0x100e_e5a1:
            ii(0x100e_e5a1, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100e_e5a4, 5); call(/* sys */ 0x1017_1f05, 0x8_395c);  /* call 0x10171f05 */
            ii(0x100e_e5a9, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100e_e5ac, 4); cmp(memd[ss, ebp - 0xc], -0x1 /* 0xff */); /* cmp dword [ebp-0xc], 0xffffffff */
            ii(0x100e_e5b0, 2); if(jz(0x100e_e5c1, 0xf)) goto l_0x100e_e5c1; /* jz 0x100ee5c1 */
            ii(0x100e_e5b2, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100e_e5b4, 3); mov(dl, memb[ss, ebp - 0xc]);           /* mov dl, [ebp-0xc] */
            ii(0x100e_e5b7, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
        ...
        l_0x100e_e5c1:
            ii(0x100e_e5c1, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100e_e5c4, 5); call(Definitions.sys_fclose, 0x8_3aa0); /* call 0x10172069 */
            ii(0x100e_e5c9, 4); or(memb[ss, ebp - 0x4], 0x1);           /* or byte [ebp-0x4], 0x1 */
            ii(0x100e_e5cd, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x100e_e5dc, 3); lea(eax, memd[ss, ebp - 0x3c]);         /* lea eax, [ebp-0x3c] */
            ii(0x100e_e5df, 5); call(0x100d_67d8, -0x1_7e0c);           /* call 0x100d67d8 */
            ii(0x100e_e5e4, 3); mov(memd[ss, ebp - 0x40], eax);         /* mov [ebp-0x40], eax */
            ii(0x100e_e5e7, 4); and(memb[ss, ebp - 0x4], -0x2 /* 0xfe */); /* and byte [ebp-0x4], 0xfe */
            ii(0x100e_e5eb, 5); mov(edx, 0x10);                         /* mov edx, 0x10 */
            ii(0x100e_e5f0, 3); lea(eax, memd[ss, ebp - 0x3c]);         /* lea eax, [ebp-0x3c] */
            ...
            ii(0x100e_e607, 3); lea(eax, memd[ss, ebp - 0x3c]);         /* lea eax, [ebp-0x3c] */
            ...
            ii(0x100e_e618, 3); lea(eax, memd[ss, ebp - 0x3c]);         /* lea eax, [ebp-0x3c] */
            ii(0x100e_e61b, 5); call(0x100d_6adf, -0x1_7b41);           /* call 0x100d6adf */
            ii(0x100e_e620, 3); lea(edx, memd[ss, ebp - 0x5c]);         /* lea edx, [ebp-0x5c] */
            ii(0x100e_e623, 3); lea(eax, memd[ss, ebp - 0x3c]);         /* lea eax, [ebp-0x3c] */
            ii(0x100e_e626, 5); call(0x100d_6a11, -0x1_7c1a);           /* call 0x100d6a11 */
            ii(0x100e_e62b, 3); mov(eax, memd[ss, ebp - 0x4a]);         /* mov eax, [ebp-0x4a] */
            ...
            ii(0x100e_e685, 3); mov(memd[ss, ebp - 0x60], eax);         /* mov [ebp-0x60], eax */
            ii(0x100e_e688, 3); mov(eax, memd[ss, ebp - 0x60]);         /* mov eax, [ebp-0x60] */
            ii(0x100e_e68b, 3); mov(memd[ss, ebp - 0x64], eax);         /* mov [ebp-0x64], eax */
            ii(0x100e_e68e, 4); cmp(memd[ss, ebp - 0x64], 0);           /* cmp dword [ebp-0x64], 0x0 */
            ...
            ii(0x100e_e6a9, 3); mov(eax, memd[ss, ebp - 0x60]);         /* mov eax, [ebp-0x60] */
            ii(0x100e_e6ac, 5); call(Definitions.my_ctor_c17, -0x2_02a2); /* call 0x100ce40f */
            ii(0x100e_e6b1, 3); mov(memd[ss, ebp - 0x68], eax);         /* mov [ebp-0x68], eax */
            ii(0x100e_e6b4, 3); mov(eax, memd[ss, ebp - 0x68]);         /* mov eax, [ebp-0x68] */
            ii(0x100e_e6b7, 3); mov(memd[ss, ebp - 0x6c], eax);         /* mov [ebp-0x6c], eax */
            ii(0x100e_e6ba, 2); jmp(0x100e_e6c2, 0x6); goto l_0x100e_e6c2; /* jmp 0x100ee6c2 */
        l_0x100e_e6bc:
            ii(0x100e_e6bc, 3); mov(eax, memd[ss, ebp - 0x64]);         /* mov eax, [ebp-0x64] */
            ii(0x100e_e6bf, 3); mov(memd[ss, ebp - 0x6c], eax);         /* mov [ebp-0x6c], eax */
        l_0x100e_e6c2:
            ii(0x100e_e6c2, 3); mov(eax, memd[ss, ebp - 0x6c]);         /* mov eax, [ebp-0x6c] */
            ii(0x100e_e6c5, 3); mov(memd[ss, ebp - 0x70], eax);         /* mov [ebp-0x70], eax */
            ii(0x100e_e6c8, 3); lea(eax, memd[ss, ebp - 0x74]);         /* lea eax, [ebp-0x74] */
            ii(0x100e_e6cb, 5); call(0x100d_5224, -0x1_94ac);           /* call 0x100d5224 */
            ii(0x100e_e6d0, 1); push(eax);                              /* push eax */
            ii(0x100e_e6d1, 3); lea(eax, memd[ss, ebp - 0x78]);         /* lea eax, [ebp-0x78] */
            ii(0x100e_e6d4, 5); call(0x100d_5250, -0x1_9489);           /* call 0x100d5250 */
            ii(0x100e_e6d9, 1); push(eax);                              /* push eax */
            ii(0x100e_e6da, 3); lea(eax, memd[ss, ebp - 0x7c]);         /* lea eax, [ebp-0x7c] */
            ii(0x100e_e6dd, 5); call(0x100d_527c, -0x1_9466);           /* call 0x100d527c */
            ii(0x100e_e6e2, 1); push(eax);                              /* push eax */
            ii(0x100e_e6e3, 3); lea(eax, memd[ss, ebp - 0x80]);         /* lea eax, [ebp-0x80] */
            ...
            ii(0x100e_e701, 3); mov(eax, memd[ss, ebp - 0x70]);         /* mov eax, [ebp-0x70] */
            ...
            ii(0x100e_e718, 3); mov(eax, memd[ss, ebp - 0x70]);         /* mov eax, [ebp-0x70] */
            ii(0x100e_e71b, 5); call(0x100d_5134, -0x1_95ec);           /* call 0x100d5134 */
            ii(0x100e_e720, 3); mov(edx, memd[ss, ebp - 0x4a]);         /* mov edx, [ebp-0x4a] */
            ii(0x100e_e723, 3); mov(eax, memd[ss, ebp - 0x70]);         /* mov eax, [ebp-0x70] */
            ii(0x100e_e726, 5); call(0x100c_f85c, -0x1_eecf);           /* call 0x100cf85c */
            ii(0x100e_e72b, 3); mov(eax, memd[ss, ebp - 0x4a]);         /* mov eax, [ebp-0x4a] */
            ii(0x100e_e72e, 5); call(Definitions.sys_display_draw_0, 0x7_8d51); /* call 0x10167484 */
            ii(0x100e_e733, 7); mov(memb[ss, ebp - 0x84], 0);           /* mov byte [ebp-0x84], 0x0 */
        l_0x100e_e73a:
            ii(0x100e_e73a, 5); call(/* sys */ 0x1016_b208, 0x7_cac9);  /* call 0x1016b208 */
            ii(0x100e_e73f, 6); mov(memd[ss, ebp - 0x88], eax);         /* mov [ebp-0x88], eax */
            ii(0x100e_e745, 5); jmp(0x100e_e7d9, 0x8f); goto l_0x100e_e7d9; /* jmp 0x100ee7d9 */
        l_0x100e_e74a:
            ii(0x100e_e74a, 7); mov(memb[ss, ebp - 0x84], 0x1);         /* mov byte [ebp-0x84], 0x1 */
            ii(0x100e_e751, 5); jmp(0x100e_e80d, 0xb7); goto l_0x100e_e80d; /* jmp 0x100ee80d */
        l_0x100e_e756:
            ii(0x100e_e756, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x100e_e764, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ...
            ii(0x100e_e77d, 4); movsx(ebx, memw[ss, ebp - 0x4c]);       /* movsx ebx, word [ebp-0x4c] */
            ii(0x100e_e781, 3); lea(edx, memd[ss, ebp - 0x5c]);         /* lea edx, [ebp-0x5c] */
            ii(0x100e_e784, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x100e_e7bb, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x100e_e7be, 5); call(Definitions.my_strobj_c_str_v2, -0x6_4ffb); /* call 0x100897c8 */
            ii(0x100e_e7c3, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100e_e7c5, 3); lea(eax, memd[ss, ebp - 0x5c]);         /* lea eax, [ebp-0x5c] */
            ii(0x100e_e7c8, 5); call(0x100e_d950, -0xe7d);              /* call 0x100ed950 */
            ii(0x100e_e7cd, 3); mov(eax, memd[ss, ebp - 0x4a]);         /* mov eax, [ebp-0x4a] */
        ...
        l_0x100e_e7d9:
            ii(0x100e_e7d9, 7); cmp(memd[ss, ebp - 0x88], 0x1b);        /* cmp dword [ebp-0x88], 0x1b */
            ii(0x100e_e7e0, 2); if(jb(0x100e_e7fe, 0x1c)) goto l_0x100e_e7fe; /* jb 0x100ee7fe */
            ii(0x100e_e7e2, 7); cmp(memd[ss, ebp - 0x88], 0x1b);        /* cmp dword [ebp-0x88], 0x1b */
            ii(0x100e_e7e9, 6); if(jbe(0x100e_e74a, -0xa5)) goto l_0x100e_e74a; /* jbe 0x100ee74a */
            ii(0x100e_e7ef, 7); cmp(memd[ss, ebp - 0x88], 0x20);        /* cmp dword [ebp-0x88], 0x20 */
        ...
        l_0x100e_e7fe:
            ii(0x100e_e7fe, 7); cmp(memd[ss, ebp - 0x88], 0xd);         /* cmp dword [ebp-0x88], 0xd */
        ...
        l_0x100e_e80d:
            ii(0x100e_e80d, 7); cmp(memb[ss, ebp - 0x84], 0);           /* cmp byte [ebp-0x84], 0x0 */
            ii(0x100e_e814, 6); if(jz(0x100e_e73a, -0xe0)) goto l_0x100e_e73a; /* jz 0x100ee73a */
            ii(0x100e_e81a, 3); mov(eax, memd[ss, ebp - 0x70]);         /* mov eax, [ebp-0x70] */
            ii(0x100e_e81d, 6); mov(memd[ss, ebp - 0x8c], eax);         /* mov [ebp-0x8c], eax */
            ii(0x100e_e823, 7); cmp(memd[ss, ebp - 0x8c], 0);           /* cmp dword [ebp-0x8c], 0x0 */
            ii(0x100e_e82a, 2); if(jz(0x100e_e846, 0x1a)) goto l_0x100e_e846; /* jz 0x100ee846 */
            ii(0x100e_e82c, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100e_e82e, 6); mov(eax, memd[ss, ebp - 0x8c]);         /* mov eax, [ebp-0x8c] */
