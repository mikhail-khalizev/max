...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_b490()
        {
            ...
            ii(0x100c_b4a2, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x100c_b4a8, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_b4ab, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_b4ae, 4);  mov(ax, memw[ds, eax + 17]);          /* mov ax, [eax+0x11] */
            ii(0x100c_b4b2, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_b4b5, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
