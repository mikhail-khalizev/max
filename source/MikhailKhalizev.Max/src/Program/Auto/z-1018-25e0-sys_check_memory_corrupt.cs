...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ sys_check_memory_corrupt()
        {
            ...
            ii(0x1018_25e8, 3); mov(ecx, memd[ds, eax + 4]);            /* mov ecx, [eax+0x4] */
            ii(0x1018_25eb, 3); add(eax, 4);                            /* add eax, 0x4 */
            ...
            ii(0x1018_2600, 3); add(esp, 4);                            /* add esp, 0x4 */
        l_0x1018_2603:
            ii(0x1018_2603, 2); add(edx, memd[ds, ebx]);                /* add edx, [ebx] */
            ii(0x1018_2605, 3); mov(edi, memd[ds, edx - 4]);            /* mov edi, [edx-0x4] */
            ii(0x1018_2608, 3); sub(edx, 4);                            /* sub edx, 0x4 */
            ...
            ii(0x1018_261d, 3); add(esp, 4);                            /* add esp, 0x4 */
        l_0x1018_2620:
