...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1028_c504()
        {
            ...
            ii(0x1028_c512, 4);  movzx(eax, memw[ds, esi + 86]);       /* movzx eax, word [esi+0x56] */
            ii(0x1028_c516, 4);  add(memw[ds, esi + 84], ax);          /* add [esi+0x54], ax */
            ii(0x1028_c51a, 4);  movzx(eax, memw[ds, esi + 84]);       /* movzx eax, word [esi+0x54] */
            ...
            ii(0x1028_c52d, 2);  if(jnz(0x1028_c533, 4)) goto l_0x1028_c533;/* jnz 0x1028c533 */
            ii(0x1028_c52f, 2);  mov(ecx, eax);                        /* mov ecx, eax */
            ii(0x1028_c531, 2);  jmp(0x1028_c53a, 7); goto l_0x1028_c53a;/* jmp 0x1028c53a */
        l_0x1028_c533:
            ii(0x1028_c533, 5);  mov(ebx, 0xffff);                     /* mov ebx, 0xffff */
            ii(0x1028_c538, 2);  sub(ebx, eax);                        /* sub ebx, eax */
        l_0x1028_c53a:
            ii(0x1028_c53a, 4);  movzx(eax, memw[ds, esi + 50]);       /* movzx eax, word [esi+0x32] */
            ...
            ii(0x1028_c554, 4);  movzx(eax, memw[ds, esi + 50]);       /* movzx eax, word [esi+0x32] */
            ...
            ii(0x1028_c56e, 4);  movzx(eax, memw[ds, esi + 50]);       /* movzx eax, word [esi+0x32] */
            ...
            ii(0x1028_c58a, 3);  shr(ecx, 2);                          /* shr ecx, 0x2 */
            ii(0x1028_c58d, 6);  mov(memd[ds, 0x1344], ecx);           /* mov [0x1344], ecx */
            ii(0x1028_c593, 3);  lds(esi, memd[ds, esi + 8]);          /* lds esi, [esi+0x8] */
        ...
        l_0x1028_c5a7:
            ...
            ii(0x1028_c5c0, 2);  if(jl(0x1028_c5c9, 7)) goto l_0x1028_c5c9;/* jl 0x1028c5c9 */
            ii(0x1028_c5c2, 5);  mov(eax, 0x8000);                     /* mov eax, 0x8000 */
            ii(0x1028_c5c7, 2);  jmp(0x1028_c5ce, 5); goto l_0x1028_c5ce;/* jmp 0x1028c5ce */
        l_0x1028_c5c9:
            ii(0x1028_c5c9, 5);  mov(eax, 0x7fff);                     /* mov eax, 0x7fff */
        l_0x1028_c5ce:
            ii(0x1028_c5ce, 4);  mov(memw[es, edi], ax);               /* mov [es:edi], ax */
            ii(0x1028_c5d2, 3);  add(edi, 2);                          /* add edi, 0x2 */
            ii(0x1028_c5d5, 3);  movzx(eax, memw[ds, esi]);            /* movzx eax, word [esi] */
            ii(0x1028_c5d8, 3);  add(esi, 2);                          /* add esi, 0x2 */
            ...
            ii(0x1028_c5f1, 2);  if(jl(0x1028_c5fa, 7)) goto l_0x1028_c5fa;/* jl 0x1028c5fa */
            ii(0x1028_c5f3, 5);  mov(eax, 0x8000);                     /* mov eax, 0x8000 */
            ii(0x1028_c5f8, 2);  jmp(0x1028_c5ff, 5); goto l_0x1028_c5ff;/* jmp 0x1028c5ff */
        l_0x1028_c5fa:
            ii(0x1028_c5fa, 5);  mov(eax, 0x7fff);                     /* mov eax, 0x7fff */
        l_0x1028_c5ff:
            ii(0x1028_c5ff, 4);  mov(memw[es, edi], ax);               /* mov [es:edi], ax */
            ii(0x1028_c603, 3);  add(edi, 2);                          /* add edi, 0x2 */
            ii(0x1028_c606, 8);  sub(memd[fs, 0x1344], 1);             /* sub dword [fs:0x1344], 0x1 */
        ...
        l_0x1028_c614:
            ...
            ii(0x1028_c61a, 3);  shr(eax, 2);                          /* shr eax, 0x2 */
        ...
        l_0x1028_c630:
            ...
            ii(0x1028_c649, 2);  if(jl(0x1028_c652, 7)) goto l_0x1028_c652;/* jl 0x1028c652 */
            ii(0x1028_c64b, 5);  mov(eax, 0x8000);                     /* mov eax, 0x8000 */
            ii(0x1028_c650, 2);  jmp(0x1028_c657, 5); goto l_0x1028_c657;/* jmp 0x1028c657 */
        l_0x1028_c652:
            ii(0x1028_c652, 5);  mov(eax, 0x7fff);                     /* mov eax, 0x7fff */
        l_0x1028_c657:
            ii(0x1028_c657, 4);  mov(memw[es, edi], ax);               /* mov [es:edi], ax */
            ii(0x1028_c65b, 3);  add(edi, 2);                          /* add edi, 0x2 */
            ii(0x1028_c65e, 3);  movzx(eax, memw[ds, esi]);            /* movzx eax, word [esi] */
            ii(0x1028_c661, 3);  add(esi, 2);                          /* add esi, 0x2 */
            ...
            ii(0x1028_c67a, 2);  if(jl(0x1028_c683, 7)) goto l_0x1028_c683;/* jl 0x1028c683 */
            ii(0x1028_c67c, 5);  mov(eax, 0x8000);                     /* mov eax, 0x8000 */
            ii(0x1028_c681, 2);  jmp(0x1028_c688, 5); goto l_0x1028_c688;/* jmp 0x1028c688 */
        l_0x1028_c683:
            ii(0x1028_c683, 5);  mov(eax, 0x7fff);                     /* mov eax, 0x7fff */
        l_0x1028_c688:
            ii(0x1028_c688, 4);  mov(memw[es, edi], ax);               /* mov [es:edi], ax */
            ii(0x1028_c68c, 3);  add(edi, 2);                          /* add edi, 0x2 */
            ii(0x1028_c68f, 8);  sub(memd[fs, 0x134c], 1);             /* sub dword [fs:0x134c], 0x1 */
