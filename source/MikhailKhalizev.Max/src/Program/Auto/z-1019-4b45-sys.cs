...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_4b45()
        {
            ...
            ii(0x1019_4b4c, 2); push(fs);                               /* push fs */
            ii(0x1019_4b4e, 2); push(gs);                               /* push gs */
            ii(0x1019_4b50, 1); push(es);                               /* push es */
        ...
        l_0x1019_4b66:
            ii(0x1019_4b66, 1); pop(es);                                /* pop es */
            ii(0x1019_4b67, 2); pop(gs);                                /* pop gs */
            ii(0x1019_4b69, 2); pop(fs);                                /* pop fs */
