...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_a582()
        {
            ...
            ii(0x1014_a599, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_a59c, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_a59f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a5a2, 4); test(memb[ds, eax + 0x15], 0x10);       /* test byte [eax+0x15], 0x10 */
            ii(0x1014_a5a6, 6); if(jz(0x1014_a862, 0x2b6)) goto l_0x1014_a862; /* jz 0x1014a862 */
            ii(0x1014_a5ac, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_a5af, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1014_a5b2, 4); add(memw[ds, edx + 0x52], ax);          /* add [edx+0x52], ax */
            ii(0x1014_a5b6, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1014_a5b9, 3); mov(edx, memd[ds, edx + 0x50]);         /* mov edx, [edx+0x50] */
            ...
            ii(0x1014_a5d2, 4); mov(memb[ss, ebp - 0x10], 0);           /* mov byte [ebp-0x10], 0x0 */
            ii(0x1014_a5d6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a5d9, 3); mov(edx, memd[ds, eax + 0x6]);          /* mov edx, [eax+0x6] */
            ii(0x1014_a5dc, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1014_a5df, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a5e2, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ...
            ii(0x1014_a607, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_a614, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a617, 3); mov(edx, memd[ds, eax + 0x6]);          /* mov edx, [eax+0x6] */
            ii(0x1014_a61a, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1014_a61d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a620, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ...
            ii(0x1014_a644, 4); mov(al, memb[ds, eax + ebp - 0x1c]);    /* mov al, [eax+ebp-0x1c] */
            ii(0x1014_a648, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x1014_a64b, 4); movsx(ebx, memb[ss, ebp - 0xc]);        /* movsx ebx, byte [ebp-0xc] */
            ii(0x1014_a64f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a652, 3); mov(edx, memd[ds, eax + 0x6]);          /* mov edx, [eax+0x6] */
            ii(0x1014_a655, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1014_a658, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a65b, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ii(0x1014_a65e, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1014_a660, 1); cwde();                                 /* cwde */
            ii(0x1014_a661, 5); call(0x100d_fdf9, -0x6_a86d);           /* call 0x100dfdf9 */
            ii(0x1014_a666, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
        l_0x1014_a669:
            ii(0x1014_a669, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1014_a66c, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1014_a66f, 4); cmp(ax, memw[ds, edx + 0x52]);          /* cmp ax, [edx+0x52] */
            ii(0x1014_a673, 6); if(jg(0x1014_a743, 0xca)) goto l_0x1014_a743; /* jg 0x1014a743 */
            ii(0x1014_a679, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1014_a67c, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1014_a67f, 4); sub(memw[ds, edx + 0x52], ax);          /* sub [edx+0x52], ax */
            ii(0x1014_a683, 4); cmp(memb[ss, ebp - 0x10], 0);           /* cmp byte [ebp-0x10], 0x0 */
            ...
            ii(0x1014_a693, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x1014_a696, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x1014_a699, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ii(0x1014_a69c, 4); cmp(memd[ss, ebp - 0x28], 0);           /* cmp dword [ebp-0x28], 0x0 */
            ii(0x1014_a6a0, 2); if(jz(0x1014_a6c2, 0x20)) goto l_0x1014_a6c2; /* jz 0x1014a6c2 */
            ii(0x1014_a6a2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_a6af, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x1014_a6b2, 5); call(0x100c_a2f8, -0x8_03bf);           /* call 0x100ca2f8 */
            ii(0x1014_a6b7, 3); mov(memd[ss, ebp - 0x2c], eax);         /* mov [ebp-0x2c], eax */
            ii(0x1014_a6ba, 3); mov(eax, memd[ss, ebp - 0x2c]);         /* mov eax, [ebp-0x2c] */
            ii(0x1014_a6bd, 3); mov(memd[ss, ebp - 0x30], eax);         /* mov [ebp-0x30], eax */
            ii(0x1014_a6c0, 2); jmp(0x1014_a6c8, 0x6); goto l_0x1014_a6c8; /* jmp 0x1014a6c8 */
        l_0x1014_a6c2:
            ii(0x1014_a6c2, 3); mov(eax, memd[ss, ebp - 0x28]);         /* mov eax, [ebp-0x28] */
            ii(0x1014_a6c5, 3); mov(memd[ss, ebp - 0x30], eax);         /* mov [ebp-0x30], eax */
        l_0x1014_a6c8:
            ii(0x1014_a6c8, 3); mov(edx, memd[ss, ebp - 0x30]);         /* mov edx, [ebp-0x30] */
            ii(0x1014_a6cb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a6ce, 3); add(eax, 0x6c);                         /* add eax, 0x6c */
            ii(0x1014_a6d1, 5); call(0x100c_b77c, -0x7_ef5a);           /* call 0x100cb77c */
        l_0x1014_a6d6:
            ii(0x1014_a6d6, 4); movsx(edx, memb[ss, ebp - 0xc]);        /* movsx edx, byte [ebp-0xc] */
            ii(0x1014_a6da, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_a6ec, 4); movsx(ebx, memb[ss, ebp - 0xc]);        /* movsx ebx, byte [ebp-0xc] */
            ii(0x1014_a6f0, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1014_a6f3, 3); mov(edx, memd[ds, edx + 0x6]);          /* mov edx, [edx+0x6] */
            ii(0x1014_a6f6, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1014_a6f9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a6fc, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ...
            ii(0x1014_a715, 4); mov(al, memb[ds, eax + ebp - 0x1c]);    /* mov al, [eax+ebp-0x1c] */
            ii(0x1014_a719, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x1014_a71c, 4); movsx(ebx, memb[ss, ebp - 0xc]);        /* movsx ebx, byte [ebp-0xc] */
            ii(0x1014_a720, 3); mov(ecx, memd[ss, ebp - 0x8]);          /* mov ecx, [ebp-0x8] */
            ii(0x1014_a723, 3); mov(edx, memd[ds, ecx + 0x6]);          /* mov edx, [ecx+0x6] */
            ii(0x1014_a726, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1014_a729, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a72c, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ii(0x1014_a72f, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1014_a731, 1); cwde();                                 /* cwde */
            ii(0x1014_a732, 5); call(0x100d_fdf9, -0x6_a93e);           /* call 0x100dfdf9 */
            ii(0x1014_a737, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1014_a73a, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
            ii(0x1014_a73e, 5); jmp(0x1014_a669, -0xda); goto l_0x1014_a669; /* jmp 0x1014a669 */
        l_0x1014_a743:
            ii(0x1014_a743, 4); cmp(memb[ss, ebp - 0x10], 0);           /* cmp byte [ebp-0x10], 0x0 */
            ii(0x1014_a747, 6); if(jz(0x1014_a829, 0xdc)) goto l_0x1014_a829; /* jz 0x1014a829 */
            ii(0x1014_a74d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a750, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_a752, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ...
            ii(0x1014_a760, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a763, 3); mov(ebx, memd[ds, eax + 0x1a]);         /* mov ebx, [eax+0x1a] */
            ii(0x1014_a766, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1014_a769, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a76c, 3); mov(edx, memd[ds, eax + 0x18]);         /* mov edx, [eax+0x18] */
            ...
            ii(0x1014_a77c, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ii(0x1014_a77f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_a781, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a784, 3); mov(eax, memd[ds, eax + 0x1a]);         /* mov eax, [eax+0x1a] */
            ii(0x1014_a787, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1014_a78a, 1); inc(eax);                               /* inc eax */
            ii(0x1014_a78b, 1); push(eax);                              /* push eax */
            ii(0x1014_a78c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a78f, 3); mov(eax, memd[ds, eax + 0x18]);         /* mov eax, [eax+0x18] */
            ii(0x1014_a792, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1014_a795, 1); inc(eax);                               /* inc eax */
            ii(0x1014_a796, 1); push(eax);                              /* push eax */
            ii(0x1014_a797, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a79a, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
        ...
        l_0x1014_a7da:
            ii(0x1014_a7da, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_a7ef, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_a806, 2); if(jz(0x1014_a810, 0x8)) goto l_0x1014_a810; /* jz 0x1014a810 */
            ii(0x1014_a808, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a80b, 5); call(0x1012_8bb2, -0x2_1c5e);           /* call 0x10128bb2 */
        l_0x1014_a810:
            ii(0x1014_a810, 5); mov(edx, 0x101c_37bc);                  /* mov edx, 0x101c37bc */
            ii(0x1014_a815, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a818, 5); call(0x1007_6d98, -0xd_3a85);           /* call 0x10076d98 */
            ii(0x1014_a81d, 2); test(al, al);                           /* test al, al */
            ii(0x1014_a81f, 2); if(jz(0x1014_a829, 0x8)) goto l_0x1014_a829; /* jz 0x1014a829 */
            ii(0x1014_a821, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1014_a829:
            ...
            ii(0x1014_a833, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a836, 3); mov(edx, memd[ds, eax + 0x6]);          /* mov edx, [eax+0x6] */
            ii(0x1014_a839, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1014_a83c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_a83f, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
