...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_dad6()
        {
            ...
            ii(0x17_dae1, 3); mov(di, memw[ss, bp + 0x6]);              /* mov di, [bp+0x6] */
            ii(0x17_dae4, 2); xor(ax, ax);                              /* xor ax, ax */
            ii(0x17_dae6, 3); mov(cx, 0xffff);                          /* mov cx, 0xffff */
            ii(0x17_dae9, 2); repne(() => scasb());                     /* repne scasb */
            ii(0x17_daeb, 3); lea(si, memw[ds, di - 0x1]);              /* lea si, [di-0x1] */
            ii(0x17_daee, 3); mov(di, memw[ss, bp + 0x8]);              /* mov di, [bp+0x8] */
            ...
            ii(0x17_dafc, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_daff, 4); test(si, 0x1);                            /* test si, 0x1 */
            ii(0x17_db03, 2); if(jz(0x17_db07, 0x2)) goto l_0x17_db07;  /* jz 0xdb07 */
