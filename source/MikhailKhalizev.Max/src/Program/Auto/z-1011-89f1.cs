...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_89f1()
        {
            ...
            ii(0x1011_8a08, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1011_8a0b, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1011_8a0e, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1011_8a11, 3); mov(edx, memd[ds, edx + 20]);           /* mov edx, [edx+0x14] */
            ii(0x1011_8a14, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1011_8a17, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1011_8a1a, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1011_8a1c, 3); mov(bl, memb[ds, eax + 42]);            /* mov bl, [eax+0x2a] */
            ii(0x1011_8a1f, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x1011_8a21, 3); sar(edx, 0x1f);                         /* sar edx, 0x1f */
            ii(0x1011_8a24, 2); idiv(ebx);                              /* idiv ebx */
            ii(0x1011_8a26, 3); shl(eax, 2);                            /* shl eax, 0x2 */
            ii(0x1011_8a29, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1011_8a2c, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
