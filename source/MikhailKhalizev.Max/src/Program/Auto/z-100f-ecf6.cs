...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("51204991-eea7-48d8-8480-7dd9194c4c0d")]
        public void Method_100f_ecf6()
        {
            ii(0x100f_ecf6, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x100f_ecfb, 5); calld(Definitions.sys_check_available_stack_size, 0x6_7052); /* call 0x10165d52 */
            ...
            ii(0x100f_ed16, 5); calld(0x1007_6338, -0x8_89e3);          /* call 0x10076338 */
            ii(0x100f_ed1b, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100f_ed1d, 3); lea(eax, ebp - 0xc);                    /* lea eax, [ebp-0xc] */
            ii(0x100f_ed20, 5); calld(0x1007_64b8, -0x8_886d);          /* call 0x100764b8 */
        l_0x100f_ed25:
            ii(0x100f_ed25, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100f_ed27, 3); lea(eax, ebp - 0xc);                    /* lea eax, [ebp-0xc] */
            ii(0x100f_ed2a, 5); calld(0x1013_ad71, 0x3_c042);           /* call 0x1013ad71 */
            ...
            ii(0x100f_ed36, 5); calld(0x1007_63a0, -0x8_899b);          /* call 0x100763a0 */
            ...
            ii(0x100f_ed4b, 5); calld(0x1007_63a0, -0x8_89b0);          /* call 0x100763a0 */
            ii(0x100f_ed50, 5); calld(0x1015_0413, 0x5_16be);           /* call 0x10150413 */
        l_0x100f_ed55:
            ii(0x100f_ed55, 3); lea(eax, ebp - 0xc);                    /* lea eax, [ebp-0xc] */
            ii(0x100f_ed58, 5); calld(0x1007_6bf8, -0x8_8165);          /* call 0x10076bf8 */
        ...
        l_0x100f_ed5f:
            ...
            ii(0x100f_ed64, 5); calld(0x1007_5f6c, -0x8_8dfd);          /* call 0x10075f6c */
