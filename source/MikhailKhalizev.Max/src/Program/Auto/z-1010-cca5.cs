...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("a89cceaa-1ac6-4d51-b95a-e207bd42d3bb")]
        public void Method_1010_cca5()
        {
            ii(0x1010_cca5, 5); pushd(0x6c);                            /* push 0x6c */
            ii(0x1010_ccaa, 5); calld(Definitions.sys_check_available_stack_size, 0x590a3); /* call 0x10165d52 */
            ...
            ii(0x1010_ccc5, 5); calld(/* sys */ 0x1016_a24c, 0x5d582);  /* call 0x1016a24c */
            ...
            ii(0x1010_cd07, 5); calld(Definitions.sys_new, 0x590f4);    /* call 0x10165e00 */
            ...
            ii(0x1010_cd4f, 5); calld(0x100d_7bdc, -0x35178);           /* call 0x100d7bdc */
        ...
        l_0x1010_cd65:
            ...
            ii(0x1010_cd79, 5); calld(0x100d_7d74, -0x3500a);           /* call 0x100d7d74 */
        l_0x1010_cd7e:
            ...
            ii(0x1010_cd89, 5); calld(0x100d_7f6c, -0x34e22);           /* call 0x100d7f6c */
            ...
            ii(0x1010_cdd4, 5); calld(0x100d_7f6c, -0x34e6d);           /* call 0x100d7f6c */
        ...
        l_0x1010_ce1f:
            ...
            ii(0x1010_ce29, 5); calld(0x100d_51e4, -0x37c4a);           /* call 0x100d51e4 */
            ii(0x1010_ce2e, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1010_ce30, 2); mov(bl, al);                            /* mov bl, al */
            ii(0x1010_ce32, 5); calld(0x100d_5204, -0x37c33);           /* call 0x100d5204 */
            ...
            ii(0x1010_ce48, 5); calld(0x100c_fa7c, -0x3d3d1);           /* call 0x100cfa7c */
        ...
        l_0x1010_ce4f:
            ...
            ii(0x1010_ce63, 5); calld(0x100d_7f6c, -0x34efc);           /* call 0x100d7f6c */
            ...
            ii(0x1010_ce7c, 5); calld(Definitions.my_dtor_d3, -0x3514e); /* call 0x100d7d33 */
            ii(0x1010_ce81, 5); calld(Definitions.sys_delete, 0x590de); /* call 0x10165f64 */
        ...
        l_0x1010_ce9c:
            ...
            ii(0x1010_cefd, 5); calld(Definitions.sys_new, 0x58efe);    /* call 0x10165e00 */
            ...
            ii(0x1010_cf2f, 5); calld(0x100d_7bdc, -0x35358);           /* call 0x100d7bdc */
        ...
        l_0x1010_cf45:
            ...
            ii(0x1010_cf59, 5); calld(0x100d_7d74, -0x351ea);           /* call 0x100d7d74 */
            ...
            ii(0x1010_cf85, 5); calld(/* sys */ 0x1016_a68c, 0x5d702);  /* call 0x1016a68c */
            ...
            ii(0x1010_cfb7, 5); calld(/* sys */ 0x1016_a68c, 0x5d6d0);  /* call 0x1016a68c */
            ...
            ii(0x1010_cfc4, 5); calld(Definitions.sys_display_draw_0, 0x5a4bb); /* call 0x10167484 */
            ...
            ii(0x1010_cfd1, 1); retd(); return;                         /* ret */
        }
    }
}
