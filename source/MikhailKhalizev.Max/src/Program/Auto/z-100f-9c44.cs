...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x100f_9c44, 7); test(memb[ds, 0x101c_38d4], 0x1);       /* test byte [0x101c38d4], 0x1 */
            ...
            ii(0x100f_9c5b, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100f_9c5e, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ...
            ii(0x100f_9c6c, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x100f_9c6f, 4); mov(ax, memw[ds, eax + 0x8]);           /* mov ax, [eax+0x8] */
            ii(0x100f_9c73, 3); mov(edx, memd[ss, ebp - 0x14]);         /* mov edx, [ebp-0x14] */
            ii(0x100f_9c76, 3); sub(ax, memw[ds, edx]);                 /* sub ax, [edx] */
            ii(0x100f_9c79, 3); sub(eax, 0x1e);                         /* sub eax, 0x1e */
            ii(0x100f_9c7c, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
        ...
        l_0x100f_9c92:
            ii(0x100f_9c92, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x100f_9c96, 6); cmp(eax, memd[ds, 0x101c_38cc]);        /* cmp eax, [0x101c38cc] */
            ii(0x100f_9c9c, 2); if(jge(0x100f_9ca7, 0x9)) goto l_0x100f_9ca7; /* jge 0x100f9ca7 */
            ii(0x100f_9c9e, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
        ...
        l_0x100f_9ca7:
            ...
            ii(0x100f_9cae, 4); movsx(ebx, memw[ss, ebp - 0xc]);        /* movsx ebx, word [ebp-0xc] */
            ...
            ii(0x100f_9cc2, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100f_9cc5, 2); xor(ecx, ecx);                          /* xor ecx, ecx */
            ii(0x100f_9cc7, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x100f_9cc9, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100f_9ccd, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x100f_9ccf, 5); call(0x1010_1620, 0x794c);              /* call 0x10101620 */
            ii(0x100f_9cd4, 5); if(jmp_func(0x100f_a7df, 0xb06)) return; /* jmp 0x100fa7df */
        }
    }
}
