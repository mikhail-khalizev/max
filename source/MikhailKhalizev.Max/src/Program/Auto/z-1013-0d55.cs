...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_0d55()
        {
            ...
            ii(0x1013_0d6c, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_0d6f, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_0d72, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_0d75, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1013_0d78, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_0d7b, 4); cmp(memb[ds, eax + 0x17], 0x2);         /* cmp byte [eax+0x17], 0x2 */
            ii(0x1013_0d7f, 2); if(jz(0x1013_0d95, 0x14)) goto l_0x1013_0d95; /* jz 0x10130d95 */
            ii(0x1013_0d81, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_0d84, 4); mov(memb[ds, eax + 0x17], 0x2);         /* mov byte [eax+0x17], 0x2 */
            ii(0x1013_0d88, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x1013_0d8d, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
