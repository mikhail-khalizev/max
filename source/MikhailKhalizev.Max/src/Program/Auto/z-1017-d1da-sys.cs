...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("4066d901-eaba-420b-be4d-42249a4d59ad")]
        public void /* sys */ Method_1017_d1da()
        {
            ...
            ii(0x1017_d1e4, 6); jbed_func(0x1018_d6b2, 0x104c8);        /* jbe 0x1018d6b2 */
        l_0x1017_d1ea:
            ii(0x1017_d1ea, 5); mov(eax, 0x4);                          /* mov eax, 0x4 */
            ii(0x1017_d1ef, 5); calld(/* sys */ 0x1018_d3bf, 0x101cb);  /* call 0x1018d3bf */
            ii(0x1017_d1f4, 5); mov(eax, 0xffff_ffff);                  /* mov eax, 0xffffffff */
            ii(0x1017_d1f9, 1); retd(); return;                         /* ret */
        }
    }
}
