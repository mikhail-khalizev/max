...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_4578()
        {
            ...
            ii(0x1011_4590, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_4593, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1011_4596, 6); add(edx, 0x3b0);                        /* add edx, 0x3b0 */
            ii(0x1011_459c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_459f, 5); add(eax, 0x1a2);                        /* add eax, 0x1a2 */
            ii(0x1011_45a4, 5); call(Definitions.sys_strcpy, 0x5_1926); /* call 0x10165ecf */
            ii(0x1011_45a9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_45ac, 6); mov(edx, memd[ds, eax + 0x19a]);        /* mov edx, [eax+0x19a] */
            ii(0x1011_45b2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_45b5, 6); mov(memd[ds, eax + 0x19e], edx);        /* mov [eax+0x19e], edx */
            ii(0x1011_45bb, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1011_45be, 6); add(edx, 0x1a2);                        /* add edx, 0x1a2 */
            ii(0x1011_45c4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_45c7, 6); mov(eax, memd[ds, eax + 0x19e]);        /* mov eax, [eax+0x19e] */
            ...
            ii(0x1011_45db, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_45de, 6); mov(eax, memd[ds, eax + 0x19e]);        /* mov eax, [eax+0x19e] */
            ii(0x1011_45e4, 5); call(0x100e_b5e1, -0x2_9008);           /* call 0x100eb5e1 */
            ii(0x1011_45e9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_45ec, 6); mov(eax, memd[ds, eax + 0x19e]);        /* mov eax, [eax+0x19e] */
            ii(0x1011_45f2, 5); call(0x100e_b1b2, -0x2_9445);           /* call 0x100eb1b2 */
            ii(0x1011_45f7, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x1011_45fc, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_45ff, 3); mov(eax, memd[ds, eax + 0x5a]);         /* mov eax, [eax+0x5a] */
