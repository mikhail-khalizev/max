...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_8594()
        {
            ...
            ii(0x859b, 5);    cmp(memb[ds, 0xcee], 0x3);                /* cmp byte [0xcee], 0x3 */
            ...
            ii(0x85a8, 2);    if(jb(0x85ae, 0x4)) goto l_0x85ae;        /* jb 0x85ae */
            ii(0x85aa, 2);    mov(al, 0x5);                             /* mov al, 0x5 */
            ii(0x85ac, 2);    jmp(0x85b4, 0x6); goto l_0x85b4;          /* jmp 0x85b4 */
        l_0x85ae:
            ii(0x85ae, 2);    cmp(al, 0x13);                            /* cmp al, 0x13 */
            ii(0x85b0, 2);    if(jbe(0x85b4, 0x2)) goto l_0x85b4;       /* jbe 0x85b4 */
        l_0x85b2:
        ...
        l_0x85bd:
            ...
            ii(0x85bf, 2);    jmp(0x85b8, -0x9); goto l_0x85b8;         /* jmp 0x85b8 */
        }
    }
}
