...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_5976()
        {
            ...
            ii(0x1019_5984, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1019_5987, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1019_598a, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1019_598d, 6); push(memd[ds, eax + 0x101c_029c]);      /* push dword [eax+0x101c029c] */
            ii(0x1019_5993, 4); imul(eax, memd[ss, ebp - 0x8], 0x6);    /* imul eax, [ebp-0x8], 0x6 */
            ...
            ii(0x1019_59ad, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1019_59b0, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1019_59b3, 6); push(memd[ds, eax + 0x101c_029c]);      /* push dword [eax+0x101c029c] */
            ii(0x1019_59b9, 4); imul(eax, memd[ss, ebp - 0x8], 0x6);    /* imul eax, [ebp-0x8], 0x6 */
            ...
            ii(0x1019_59d3, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x1019_59da, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
