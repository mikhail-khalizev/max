...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_6b8f()
        {
            ...
            ii(0x100a_6ba7, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_6baa, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_6bb7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_6bba, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x100a_6bbd, 5); call(0x1008_afe4, -0x1_bbde);           /* call 0x1008afe4 */
            ii(0x100a_6bc2, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
