...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_7640()
        {
            ...
            ii(0x17_764c, 5);  mov(memw[ss, bp - 16], 1);              /* mov word [bp-0x10], 0x1 */
            ii(0x17_7651, 5);  mov(memw[ss, bp - 14], 0x70);           /* mov word [bp-0xe], 0x70 */
            ii(0x17_7656, 5);  mov(memw[ss, bp - 12], 0x10);           /* mov word [bp-0xc], 0x10 */
            ii(0x17_765b, 3);  mov(ax, 0x70);                          /* mov ax, 0x70 */
            ii(0x17_765e, 3);  mov(dx, 0x10);                          /* mov dx, 0x10 */
            ii(0x17_7661, 1);  push(ds);                               /* push ds */
            ii(0x17_7662, 3);  lea(di, memw[ss, bp - 28]);             /* lea di, [bp-0x1c] */
            ...
            ii(0x17_768d, 3);  les(bx, memw[ss, bp + 10]);             /* les bx, [bp+0xa] */
            ii(0x17_7690, 4);  push(memw[es, bx + 34]);                /* push word [es:bx+0x22] */
            ii(0x17_7694, 4);  push(memw[es, bx + 32]);                /* push word [es:bx+0x20] */
            ii(0x17_7698, 4);  push(memw[es, bx + 76]);                /* push word [es:bx+0x4c] */
            ...
            ii(0x17_76da, 3);  les(bx, memw[ss, bp + 10]);             /* les bx, [bp+0xa] */
            ii(0x17_76dd, 4);  mov(ax, memw[es, bx + 32]);             /* mov ax, [es:bx+0x20] */
            ii(0x17_76e1, 4);  mov(dx, memw[es, bx + 34]);             /* mov dx, [es:bx+0x22] */
            ...
            ii(0x17_76f1, 3);  les(bx, memw[ss, bp + 10]);             /* les bx, [bp+0xa] */
            ii(0x17_76f4, 4);  mov(ax, memw[es, bx + 76]);             /* mov ax, [es:bx+0x4c] */
            ii(0x17_76f8, 4);  les(bx, memw[ds, 0x4fc4]);              /* les bx, [0x4fc4] */
            ii(0x17_76fc, 4);  mov(memw[es, bx + 10], ax);             /* mov [es:bx+0xa], ax */
        ...
        l_0x17_7713:
            ...
            ii(0x17_7731, 3);  mov(memw[ss, bp - 10], ax);             /* mov [bp-0xa], ax */
            ...
            ii(0x17_773b, 3);  mov(memw[ss, bp - 30], ax);             /* mov [bp-0x1e], ax */
            ...
            ii(0x17_775c, 3);  lea(si, memw[ss, bp - 28]);             /* lea si, [bp-0x1c] */
            ii(0x17_775f, 2);  mov(ax, ss);                            /* mov ax, ss */
            ii(0x17_7761, 2);  mov(ds, ax);                            /* mov ds, ax */
            ii(0x17_7763, 3);  les(di, memw[ss, bp - 14]);             /* les di, [bp-0xe] */
            ...
            ii(0x17_776b, 3);  mov(ax, memw[ss, bp - 16]);             /* mov ax, [bp-0x10] */
        ...
        l_0x17_7774:
            ...
            ii(0x17_77bc, 3);  push(memw[ss, bp - 10]);                /* push word [bp-0xa] */
            ...
            ii(0x17_77d5, 3);  lea(si, memw[ss, bp - 28]);             /* lea si, [bp-0x1c] */
            ii(0x17_77d8, 2);  mov(ax, ss);                            /* mov ax, ss */
            ii(0x17_77da, 2);  mov(ds, ax);                            /* mov ds, ax */
            ii(0x17_77dc, 3);  les(di, memw[ss, bp - 14]);             /* les di, [bp-0xe] */
            ...
            ii(0x17_77e4, 3);  mov(ax, memw[ss, bp - 16]);             /* mov ax, [bp-0x10] */
        ...
        l_0x17_77ec:
            ii(0x17_77ec, 3);  les(bx, memw[ss, bp + 10]);             /* les bx, [bp+0xa] */
            ii(0x17_77ef, 4);  mov(ax, memw[es, bx + 80]);             /* mov ax, [es:bx+0x50] */
            ii(0x17_77f3, 3);  mov(dx, 8);                             /* mov dx, 0x8 */
            ii(0x17_77f6, 3);  mov(memw[ss, bp - 20], ax);             /* mov [bp-0x14], ax */
            ii(0x17_77f9, 3);  mov(memw[ss, bp - 18], dx);             /* mov [bp-0x12], dx */
            ...
            ii(0x17_7819, 3);  mov(memw[ss, bp - 10], ax);             /* mov [bp-0xa], ax */
            ...
            ii(0x17_7826, 3);  les(bx, memw[ss, bp + 10]);             /* les bx, [bp+0xa] */
            ii(0x17_7829, 4);  add(ax, memw[es, bx + 56]);             /* add ax, [es:bx+0x38] */
            ii(0x17_782d, 4);  adc(dx, memw[es, bx + 58]);             /* adc dx, [es:bx+0x3a] */
            ii(0x17_7831, 3);  sub(ax, 0x14);                          /* sub ax, 0x14 */
            ii(0x17_7834, 3);  sbb(dx, 0);                             /* sbb dx, 0x0 */
            ii(0x17_7837, 3);  mov(memw[ss, bp - 10], ax);             /* mov [bp-0xa], ax */
            ii(0x17_783a, 3);  mov(memw[ss, bp - 8], dx);              /* mov [bp-0x8], dx */
            ii(0x17_783d, 2);  jmp(0x17_7854, 0x15); goto l_0x17_7854; /* jmp 0x7854 */
        //  ii(0x17_783f, 1);  Недостижимый код.
        l_0x17_7840:
            ii(0x17_7840, 3);  les(bx, memw[ss, bp + 10]);             /* les bx, [bp+0xa] */
            ii(0x17_7843, 4);  mov(ax, memw[es, bx + 56]);             /* mov ax, [es:bx+0x38] */
            ii(0x17_7847, 2);  sub(dx, dx);                            /* sub dx, dx */
            ii(0x17_7849, 3);  sub(ax, 0x14);                          /* sub ax, 0x14 */
            ii(0x17_784c, 2);  sbb(dx, dx);                            /* sbb dx, dx */
            ii(0x17_784e, 3);  add(memw[ss, bp - 10], ax);             /* add [bp-0xa], ax */
            ii(0x17_7851, 3);  adc(memw[ss, bp - 8], dx);              /* adc [bp-0x8], dx */
        l_0x17_7854:
            ii(0x17_7854, 2);  push(0xc);                              /* push 0xc */
            ii(0x17_7856, 3);  lea(ax, memw[ss, bp - 10]);             /* lea ax, [bp-0xa] */
        ...
        l_0x17_7867:
            ...
            ii(0x17_7883, 3);  mov(memw[ss, bp - 34], ax);             /* mov [bp-0x22], ax */
            ii(0x17_7886, 3);  mov(memw[ss, bp - 32], dx);             /* mov [bp-0x20], dx */
            ii(0x17_7889, 4);  test(memb[ss, bp - 34], 1);             /* test byte [bp-0x22], 0x1 */
            ...
            ii(0x17_7893, 3);  mov(memw[ss, bp - 30], ax);             /* mov [bp-0x1e], ax */
        ...
        l_0x17_78ac:
            ...
            ii(0x17_78ae, 3);  push(memw[ss, bp - 30]);                /* push word [bp-0x1e] */
            ii(0x17_78b1, 3);  push(memw[ss, bp - 8]);                 /* push word [bp-0x8] */
            ii(0x17_78b4, 3);  push(memw[ss, bp - 10]);                /* push word [bp-0xa] */
            ...
            ii(0x17_78c7, 3);  push(memw[ss, bp - 10]);                /* push word [bp-0xa] */
        ...
        l_0x17_78d5:
            ...
            ii(0x17_78f2, 3);  lea(si, memw[ss, bp - 28]);             /* lea si, [bp-0x1c] */
            ii(0x17_78f5, 2);  mov(ax, ss);                            /* mov ax, ss */
            ii(0x17_78f7, 2);  mov(ds, ax);                            /* mov ds, ax */
            ii(0x17_78f9, 3);  les(di, memw[ss, bp - 14]);             /* les di, [bp-0xe] */
