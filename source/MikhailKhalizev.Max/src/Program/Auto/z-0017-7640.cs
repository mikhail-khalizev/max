...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_7640()
        {
            ...
            ii(0x17_764c, 5); mov(memw[ss, bp - 0x10], 0x1);            /* mov word [bp-0x10], 0x1 */
            ...
            ii(0x17_769c, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x17_769f, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ...
            ii(0x17_76c4, 4); mov(memb[es, bx + 0x1], al);              /* mov [es:bx+0x1], al */
            ii(0x17_76c8, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_76cb, 3); mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ii(0x17_76ce, 4); les(bx, ds, 0x4fc4);                      /* les bx, [0x4fc4] */
            ii(0x17_76d2, 4); mov(memw[es, bx + 0x2], ax);              /* mov [es:bx+0x2], ax */
            ii(0x17_76d6, 4); mov(memw[es, bx + 0x4], dx);              /* mov [es:bx+0x4], dx */
            ...
            ii(0x17_76e9, 4); mov(memw[es, si + 0x6], ax);              /* mov [es:si+0x6], ax */
            ii(0x17_76ed, 4); mov(memw[es, si + 0x8], dx);              /* mov [es:si+0x8], dx */
        ...
        l_0x17_7713:
            ii(0x17_7713, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_7716, 3); mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ...
            ii(0x17_7734, 3); mov(memw[ss, bp - 0x8], dx);              /* mov [bp-0x8], dx */
            ...
            ii(0x17_7743, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x17_7746, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
        ...
        l_0x17_7774:
            ...
            ii(0x17_7788, 3); push(memw[ss, bp - 0x8]);                 /* push word [bp-0x8] */
            ...
            ii(0x17_7798, 3); mov(dx, memw[ss, bp - 0x8]);              /* mov dx, [bp-0x8] */
            ...
            ii(0x17_77b1, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
            ii(0x17_77b4, 3); mov(memw[ss, bp - 0x4], dx);              /* mov [bp-0x4], dx */
            ii(0x17_77b7, 1); push(dx);                                 /* push dx */
            ii(0x17_77b8, 1); push(ax);                                 /* push ax */
            ii(0x17_77b9, 3); push(memw[ss, bp - 0x8]);                 /* push word [bp-0x8] */
            ...
            ii(0x17_77c6, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
        ...
        l_0x17_77ec:
            ...
            ii(0x17_7800, 4); mov(cx, memw[es, bx + 0x2]);              /* mov cx, [es:bx+0x2] */
            ii(0x17_7804, 4); mov(al, memb[es, bx + 0x4]);              /* mov al, [es:bx+0x4] */
            ii(0x17_7808, 4); mov(dl, memb[es, bx + 0x7]);              /* mov dl, [es:bx+0x7] */
            ...
            ii(0x17_781c, 3); mov(memw[ss, bp - 0x8], dx);              /* mov [bp-0x8], dx */
            ii(0x17_781f, 5); test(memb[es, bx + 0x6], 0x40);           /* test byte [es:bx+0x6], 0x40 */
            ...
            ii(0x17_783a, 3); mov(memw[ss, bp - 0x8], dx);              /* mov [bp-0x8], dx */
        ...
        l_0x17_7840:
            ...
            ii(0x17_7851, 3); adc(memw[ss, bp - 0x8], dx);              /* adc [bp-0x8], dx */
        l_0x17_7854:
        ...
        l_0x17_7867:
            ...
            ii(0x17_787d, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
            ii(0x17_7880, 3); mov(memw[ss, bp - 0x4], dx);              /* mov [bp-0x4], dx */
            ii(0x17_7883, 3); mov(memw[ss, bp - 0x22], ax);             /* mov [bp-0x22], ax */
            ii(0x17_7886, 3); mov(memw[ss, bp - 0x20], dx);             /* mov [bp-0x20], dx */
            ii(0x17_7889, 4); test(memb[ss, bp - 0x22], 0x1);           /* test byte [bp-0x22], 0x1 */
            ...
            ii(0x17_789b, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x17_789e, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
        ...
        l_0x17_78ac:
            ...
            ii(0x17_78b1, 3); push(memw[ss, bp - 0x8]);                 /* push word [bp-0x8] */
            ...
            ii(0x17_78be, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ii(0x17_78c1, 3); push(memw[ss, bp - 0x6]);                 /* push word [bp-0x6] */
            ii(0x17_78c4, 3); push(memw[ss, bp - 0x8]);                 /* push word [bp-0x8] */
