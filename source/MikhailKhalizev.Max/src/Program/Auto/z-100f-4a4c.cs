...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("12731bda-3722-48c5-ba6b-35b9afd34f9b")]
        public void Method_100f_4a4c()
        {
            ii(0x100f_4a4c, 5); pushd(0x1c);                            /* push 0x1c */
            ii(0x100f_4a51, 5); calld(Definitions.sys_check_available_stack_size, 0x7_12fc); /* call 0x10165d52 */
            ...
            ii(0x100f_4a6b, 5); calld(0x100c_fb73, -0x2_4efd);          /* call 0x100cfb73 */
            ...
            ii(0x100f_4a79, 5); calld(0x100d_4e6c, -0x1_fc12);          /* call 0x100d4e6c */
            ...
            ii(0x100f_4a8c, 5); calld(0x1010_5b00, 0x1_106f);           /* call 0x10105b00 */
            ii(0x100f_4a91, 2); jmpd(0x100f_4aab, 0x18); goto l_0x100f_4aab; /* jmp 0x100f4aab */
        l_0x100f_4a93:
            ii(0x100f_4a93, 5); calld(0x100d_4e6c, -0x1_fc2c);          /* call 0x100d4e6c */
            ...
            ii(0x100f_4aa6, 5); calld(0x1010_5b00, 0x1_1055);           /* call 0x10105b00 */
        l_0x100f_4aab:
