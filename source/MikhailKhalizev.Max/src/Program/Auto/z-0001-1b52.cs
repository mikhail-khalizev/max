...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x1_1b52, 3);  mov(dx, memw[ss, bp + 0x4]);              /* mov dx, [bp+0x4] */
            ii(0x1_1b55, 3);  mov(cx, memw[ss, bp + 0x6]);              /* mov cx, [bp+0x6] */
            ...
            ii(0x1_1b71, 2);  push(0x8);                                /* push 0x8 */
            ii(0x1_1b73, 1);  pop(ds);                                  /* pop ds */
            ii(0x1_1b74, 3);  mov(memw[ds, bx + 0x2], dx);              /* mov [bx+0x2], dx */
            ii(0x1_1b77, 3);  mov(memb[ds, bx + 0x4], cl);              /* mov [bx+0x4], cl */
            ii(0x1_1b7a, 3);  mov(memb[ds, bx + 0x7], ch);              /* mov [bx+0x7], ch */
        l_0x1_1b7d:
            ii(0x1_1b7d, 2);  mov(ds, bx);                              /* mov ds, bx */
            ii(0x1_1b7f, 3);  mov(bx, memw[ss, bp + 0x8]);              /* mov bx, [bp+0x8] */
