...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_6710()
        {
            ...
            ii(0x100d_6722, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x100d_6728, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x100d_6739, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_673c, 3);  mov(memw[ds, eax], dx);               /* mov [eax], dx */
            ii(0x100d_673f, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_6742, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_6745, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
