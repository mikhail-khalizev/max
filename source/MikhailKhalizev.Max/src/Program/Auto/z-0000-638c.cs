...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_638c()
        {
            ...
            ii(0x63ae, 3);    mov(bx, memw[ss, bp + 0x6]);              /* mov bx, [bp+0x6] */
            ...
            ii(0x63d7, 2);    if(jnz(0x63dc, 0x3)) goto l_0x63dc;       /* jnz 0x63dc */
            ii(0x63d9, 3);    jmp(0x6470, 0x94); goto l_0x6470;         /* jmp 0x6470 */
        l_0x63dc:
            ii(0x63dc, 4);    cmp(memw[ss, bp + 0x4], 0x1);             /* cmp word [bp+0x4], 0x1 */
            ii(0x63e0, 2);    if(jg(0x63e5, 0x3)) goto l_0x63e5;        /* jg 0x63e5 */
            ii(0x63e2, 3);    jmp(0x6470, 0x8b); goto l_0x6470;         /* jmp 0x6470 */
        l_0x63e5:
            ii(0x63e5, 3);    mov(bx, memw[ss, bp + 0x6]);              /* mov bx, [bp+0x6] */
            ii(0x63e8, 3);    push(memw[ds, bx + 0x2]);                 /* push word [bx+0x2] */
            ...
            ii(0x63fe, 3);    mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x6401, 3);    mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
            ...
            ii(0x640d, 3);    mov(memw[ss, bp - 0xa], cx);              /* mov [bp-0xa], cx */
            ii(0x6410, 1);    inc(ax);                                  /* inc ax */
            ii(0x6411, 3);    mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x6414, 3);    mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x6417, 2);    jmp(0x6421, 0x8); goto l_0x6421;          /* jmp 0x6421 */
        l_0x6419:
            ii(0x6419, 3);    dec(memw[ss, bp - 0xa]);                  /* dec word [bp-0xa] */
            ii(0x641c, 2);    if(js(0x643c, 0x1e)) goto l_0x643c;       /* js 0x643c */
            ii(0x641e, 3);    inc(memw[ss, bp - 0x4]);                  /* inc word [bp-0x4] */
        l_0x6421:
            ii(0x6421, 3);    les(bx, memw[ss, bp - 0x4]);              /* les bx, [bp-0x4] */
            ...
            ii(0x6432, 2);    jmp(0x643c, 0x8); goto l_0x643c;          /* jmp 0x643c */
        l_0x6434:
            ii(0x6434, 3);    dec(memw[ss, bp - 0xa]);                  /* dec word [bp-0xa] */
            ii(0x6437, 2);    if(js(0x644d, 0x14)) goto l_0x644d;       /* js 0x644d */
            ii(0x6439, 3);    inc(memw[ss, bp - 0x4]);                  /* inc word [bp-0x4] */
        l_0x643c:
            ii(0x643c, 3);    les(bx, memw[ss, bp - 0x4]);              /* les bx, [bp-0x4] */
        ...
        l_0x644d:
            ii(0x644d, 3);    mov(al, memb[ss, bp - 0xa]);              /* mov al, [bp-0xa] */
            ii(0x6450, 3);    les(bx, memw[ss, bp - 0x8]);              /* les bx, [bp-0x8] */
            ii(0x6453, 3);    mov(memb[es, bx], al);                    /* mov [es:bx], al */
        l_0x6456:
            ii(0x6456, 3);    les(bx, memw[ss, bp - 0x4]);              /* les bx, [bp-0x4] */
            ii(0x6459, 3);    inc(memw[ss, bp - 0x4]);                  /* inc word [bp-0x4] */
            ii(0x645c, 3);    mov(al, memb[es, bx]);                    /* mov al, [es:bx] */
            ii(0x645f, 3);    inc(memw[ss, bp - 0x8]);                  /* inc word [bp-0x8] */
            ii(0x6462, 3);    les(bx, memw[ss, bp - 0x8]);              /* les bx, [bp-0x8] */
            ii(0x6465, 3);    mov(memb[es, bx], al);                    /* mov [es:bx], al */
            ii(0x6468, 3);    dec(memw[ss, bp - 0xa]);                  /* dec word [bp-0xa] */
        ...
        l_0x6470:
            ...
            ii(0x6477, 3);    mov(bx, memw[ss, bp + 0x6]);              /* mov bx, [bp+0x6] */
            ...
            ii(0x6483, 2);    if(jnz(0x648b, 0x6)) goto l_0x648b;       /* jnz 0x648b */
            ii(0x6485, 3);    call(0x6333, -0x155);                     /* call 0x6333 */
            ii(0x6488, 3);    call(0x8f82, 0x2af7);                     /* call 0x8f82 */
        l_0x648b:
            ii(0x648b, 5);    cmp(memb[ds, 0x2f], 0x3);                 /* cmp byte [0x2f], 0x3 */
            ii(0x6490, 2);    if(jge(0x649a, 0x8)) goto l_0x649a;       /* jge 0x649a */
