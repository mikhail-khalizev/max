...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_be00()
        {
            ...
            ii(0x100a_be18, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_be1b, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_be1d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_be2c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100a_be3c:
            ...
            ii(0x100a_be3e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_be4b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_be4e, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x100a_be51, 5); call(0x1008_afe4, -0x2_0e72);           /* call 0x1008afe4 */
            ii(0x100a_be56, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
