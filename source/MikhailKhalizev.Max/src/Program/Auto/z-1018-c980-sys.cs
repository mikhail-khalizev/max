...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_c980()
        {
            ...
            ii(0x1018_c98f, 3); lea(eax, memd[ss, ebp - 0x34]);         /* lea eax, [ebp-0x34] */
            ...
            ii(0x1018_c9a2, 3); mov(memb[ss, ebp - 0x17], ah);          /* mov [ebp-0x17], ah */
            ii(0x1018_c9a5, 3); mov(memb[ss, ebp - 0x18], dl);          /* mov [ebp-0x18], dl */
            ii(0x1018_c9a8, 6); mov(ax, memw[ds, 0x1020_b708]);         /* mov ax, [0x1020b708] */
            ii(0x1018_c9ae, 5); mov(edx, 0x800);                        /* mov edx, 0x800 */
            ii(0x1018_c9b3, 4); mov(memw[ss, ebp - 0x4], ax);           /* mov [ebp-0x4], ax */
            ii(0x1018_c9b7, 4); mov(memw[ss, ebp - 0x6], dx);           /* mov [ebp-0x6], dx */
            ii(0x1018_c9bb, 2); xor(dh, dh);                            /* xor dh, dh */
            ii(0x1018_c9bd, 3); mov(al, memb[ss, ebp + 0x8]);           /* mov al, [ebp+0x8] */
            ii(0x1018_c9c0, 3); mov(memb[ss, ebp - 0x23], dh);          /* mov [ebp-0x23], dh */
            ii(0x1018_c9c3, 3); mov(memb[ss, ebp - 0x24], al);          /* mov [ebp-0x24], al */
            ii(0x1018_c9c6, 3); mov(eax, memd[ss, ebp + 0xc]);          /* mov eax, [ebp+0xc] */
            ii(0x1018_c9c9, 3); lea(edx, memd[ss, ebp - 0x34]);         /* lea edx, [ebp-0x34] */
            ii(0x1018_c9cc, 4); mov(memw[ss, ebp - 0x20], ax);          /* mov [ebp-0x20], ax */
            ...
            ii(0x1018_c9dc, 2); if(jz(0x1018_c9e5, 0x7)) goto l_0x1018_c9e5; /* jz 0x1018c9e5 */
            ii(0x1018_c9de, 5); cmp(memw[ss, ebp - 0x18], 0x4f);        /* cmp word [ebp-0x18], 0x4f */
            ii(0x1018_c9e3, 2); if(jz(0x1018_c9eb, 0x6)) goto l_0x1018_c9eb; /* jz 0x1018c9eb */
        l_0x1018_c9e5:
