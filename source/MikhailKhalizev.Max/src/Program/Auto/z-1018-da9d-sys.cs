...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_da9d()
        {
            ...
            ii(0x1018_dab0, 4); mov(memd[ss, esp + 0x4], edx);          /* mov [esp+0x4], edx */
        l_0x1018_dab4:
            ...
            ii(0x1018_dabb, 2); if(jz(0x1018_dac2, 0x5)) goto l_0x1018_dac2; /* jz 0x1018dac2 */
            ii(0x1018_dabd, 3); cmp(ebx, 0x9);                          /* cmp ebx, 0x9 */
            ii(0x1018_dac0, 2); if(jnz(0x1018_dac5, 0x3)) goto l_0x1018_dac5; /* jnz 0x1018dac5 */
        l_0x1018_dac2:
        ...
        l_0x1018_dac5:
            ...
            ii(0x1018_dad2, 2); if(jnz(0x1018_dad7, 0x3)) goto l_0x1018_dad7; /* jnz 0x1018dad7 */
        ...
        l_0x1018_dadc:
            ...
            ii(0x1018_daf4, 2); if(jnz(0x1018_dafb, 0x5)) goto l_0x1018_dafb; /* jnz 0x1018dafb */
        ...
        l_0x1018_dafb:
            ...
            ii(0x1018_dafe, 2); if(jnz(0x1018_db05, 0x5)) goto l_0x1018_db05; /* jnz 0x1018db05 */
        ...
        l_0x1018_db05:
            ...
            ii(0x1018_db0c, 2); if(jz(0x1018_db13, 0x5)) goto l_0x1018_db13; /* jz 0x1018db13 */
            ii(0x1018_db0e, 3); cmp(ecx, 0x9);                          /* cmp ecx, 0x9 */
            ii(0x1018_db11, 2); if(jnz(0x1018_db17, 0x4)) goto l_0x1018_db17; /* jnz 0x1018db17 */
        l_0x1018_db13:
        ...
        l_0x1018_db17:
            ...
            ii(0x1018_db2c, 3); mov(cl, memb[ds, eax + 0x1]);           /* mov cl, [eax+0x1] */
        ...
        l_0x1018_db36:
            ...
            ii(0x1018_db3d, 3); mov(cl, memb[ds, eax + 0x1]);           /* mov cl, [eax+0x1] */
        ...
        l_0x1018_db4a:
            ...
            ii(0x1018_db4c, 3); mov(cl, memb[ds, eax + 0x1]);           /* mov cl, [eax+0x1] */
            ii(0x1018_db4f, 3); cmp(ecx, 0x22);                         /* cmp ecx, 0x22 */
            ii(0x1018_db52, 2); if(jnz(0x1018_db55, 0x1)) goto l_0x1018_db55; /* jnz 0x1018db55 */
        l_0x1018_db54:
        ...
        l_0x1018_db64:
            ...
            ii(0x1018_db68, 4); mov(ecx, memd[ss, esp + 0x4]);          /* mov ecx, [esp+0x4] */
            ...
            ii(0x1018_db73, 4); mov(memd[ss, esp + 0x4], ecx);          /* mov [esp+0x4], ecx */
            ii(0x1018_db77, 2); mov(cl, memb[ds, eax]);                 /* mov cl, [eax] */
            ii(0x1018_db79, 2); test(cl, cl);                           /* test cl, cl */
            ii(0x1018_db7b, 2); if(jnz(0x1018_db81, 0x4)) goto l_0x1018_db81; /* jnz 0x1018db81 */
        ...
        l_0x1018_db8a:
            ii(0x1018_db8a, 4); inc(memd[ss, esp + 0x4]);               /* inc dword [esp+0x4] */
        ...
        l_0x1018_db97:
            ii(0x1018_db97, 3); mov(memd[ss, ebp + 0], eax);            /* mov [ebp], eax */
            ii(0x1018_db9a, 4); mov(eax, memd[ss, esp + 0x4]);          /* mov eax, [esp+0x4] */
