...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_4263()
        {
            ...
            ii(0x1012_4280, 3); mov(eax, memd[ss, ebp + 24]);           /* mov eax, [ebp+0x18] */
            ii(0x1012_4283, 1); push(eax);                              /* push eax */
            ii(0x1012_4284, 3); mov(eax, memd[ss, ebp + 20]);           /* mov eax, [ebp+0x14] */
            ...
            ii(0x1012_4294, 7); mov(memd[ss, ebp - 12], 0);             /* mov dword [ebp-0xc], 0x0 */
            ii(0x1012_429b, 2); jmp(0x1012_430f, 0x72); goto l_0x1012_430f; /* jmp 0x1012430f */
        l_0x1012_429d:
            ii(0x1012_429d, 3); mov(eax, memd[ss, ebp + 20]);           /* mov eax, [ebp+0x14] */
            ii(0x1012_42a0, 6); mov(eax, memd[ds, eax + 156]);          /* mov eax, [eax+0x9c] */
        ...
        l_0x1012_42c3:
            ...
            ii(0x1012_42c9, 3); mov(eax, memd[ss, ebp + 20]);           /* mov eax, [ebp+0x14] */
            ii(0x1012_42cc, 6); mov(edx, memd[ds, eax + 132]);          /* mov edx, [eax+0x84] */
            ii(0x1012_42d2, 3); mov(eax, memd[ss, ebp + 20]);           /* mov eax, [ebp+0x14] */
            ii(0x1012_42d5, 6); mov(eax, memd[ds, eax + 136]);          /* mov eax, [eax+0x88] */
            ...
            ii(0x1012_42f8, 3); mov(edx, memd[ss, ebp + 20]);           /* mov edx, [ebp+0x14] */
            ii(0x1012_42fb, 6); sub(memd[ds, edx + 136], eax);          /* sub [edx+0x88], eax */
            ii(0x1012_4301, 3); mov(eax, memd[ss, ebp + 20]);           /* mov eax, [ebp+0x14] */
            ii(0x1012_4304, 4); or(memb[ds, eax + 1], -0x80 /* 0x80 */); /* or byte [eax+0x1], 0x80 */
            ii(0x1012_4308, 7); mov(memd[ss, ebp - 12], 1);             /* mov dword [ebp-0xc], 0x1 */
        l_0x1012_430f:
            ii(0x1012_430f, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
