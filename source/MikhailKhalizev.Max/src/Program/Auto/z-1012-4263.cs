...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_4263()
        {
            ...
            ii(0x1012_4279, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ...
            ii(0x1012_4292, 2); if(jnz(0x1012_429d, 0x9)) goto l_0x1012_429d; /* jnz 0x1012429d */
        ...
        l_0x1012_429d:
            ...
            ii(0x1012_42a6, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x1012_42a9:
            ii(0x1012_42a9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_42ac, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ...
            ii(0x1012_42b9, 2); if(jz(0x1012_42c3, 0x8)) goto l_0x1012_42c3; /* jz 0x101242c3 */
            ii(0x1012_42bb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_42be, 3); inc(memd[ss, ebp - 0x4]);               /* inc dword [ebp-0x4] */
            ii(0x1012_42c1, 2); jmp(0x1012_42a9, -0x1a); goto l_0x1012_42a9; /* jmp 0x101242a9 */
        l_0x1012_42c3:
            ii(0x1012_42c3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_42c6, 3); inc(memd[ss, ebp - 0x4]);               /* inc dword [ebp-0x4] */
            ...
            ii(0x1012_42dd, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ii(0x1012_42e0, 3); add(ebx, memd[ss, ebp - 0x4]);          /* add ebx, [ebp-0x4] */
            ii(0x1012_42e3, 2); sub(eax, ebx);                          /* sub eax, ebx */
            ii(0x1012_42e5, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x1012_42e7, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1012_42ea, 3); add(edx, memd[ss, ebp - 0x4]);          /* add edx, [ebp-0x4] */
            ii(0x1012_42ed, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_42f0, 5); call(/* sys */ 0x1016_6177, 0x4_1e82);  /* call 0x10166177 */
            ii(0x1012_42f5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1012_4304, 4); or(memb[ds, eax + 0x1], -0x80 /* 0x80 */); /* or byte [eax+0x1], 0x80 */
            ii(0x1012_4308, 7); mov(memd[ss, ebp - 0xc], 0x1);          /* mov dword [ebp-0xc], 0x1 */
        l_0x1012_430f:
