...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_8b4a()
        {
            ...
            ii(0x1015_8b6a, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1015_8b6d, 5);  mov(eax, 1);                          /* mov eax, 0x1 */
            ii(0x1015_8b72, 5);  call(0x100f_448c, -0x6_46eb);         /* call 0x100f448c */
            ii(0x1015_8b77, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1015_8b7a, 4);  cmp(memb[ds, eax + 91], 0);           /* cmp byte [eax+0x5b], 0x0 */
            ii(0x1015_8b7e, 2);  if(jnz(0x1015_8b86, 6)) goto l_0x1015_8b86;/* jnz 0x10158b86 */
            ii(0x1015_8b80, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
            ii(0x1015_8b84, 2);  jmp(0x1015_8b8a, 4); goto l_0x1015_8b8a;/* jmp 0x10158b8a */
        l_0x1015_8b86:
            ii(0x1015_8b86, 4);  mov(memb[ss, ebp - 12], 0);           /* mov byte [ebp-0xc], 0x0 */
        l_0x1015_8b8a:
            ii(0x1015_8b8a, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
            ii(0x1015_8b8d, 3);  mov(edx, memd[ss, ebp - 16]);         /* mov edx, [ebp-0x10] */
            ii(0x1015_8b90, 3);  mov(memb[ds, edx + 91], al);          /* mov [edx+0x5b], al */
            ii(0x1015_8b93, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1015_8b96, 4);  cmp(memb[ds, eax + 61], 0xc);         /* cmp byte [eax+0x3d], 0xc */
            ...
            ii(0x1015_8ba3, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1015_8ba6, 5);  call(0x1016_3053, 0xa4a8);            /* call 0x10163053 */
        l_0x1015_8bab:
            ii(0x1015_8bab, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
