...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_08dc()
        {
            ...
            ii(0x100c_08f2, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100c_08f5, 3); mov(memd[ss, ebp - 8], edx);            /* mov [ebp-0x8], edx */
            ii(0x100c_08f8, 3); mov(memb[ss, ebp - 4], bl);             /* mov [ebp-0x4], bl */
            ii(0x100c_08fb, 5); mov(ecx, 0x101c_8184);                  /* mov ecx, 0x101c8184 */
            ii(0x100c_0900, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100c_0903, 3); movsx(ebx, memw[ds, eax]);              /* movsx ebx, word [eax] */
            ii(0x100c_0906, 4); movsx(edx, memb[ss, ebp - 4]);          /* movsx edx, byte [ebp-0x4] */
            ii(0x100c_090a, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_0919, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100c_091c, 3); movsx(ebx, memw[ds, eax]);              /* movsx ebx, word [eax] */
            ii(0x100c_091f, 4); movsx(edx, memb[ss, ebp - 4]);          /* movsx edx, byte [ebp-0x4] */
            ii(0x100c_0923, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100c_0926, 5); call(0x100c_0837, -0xf4);               /* call 0x100c0837 */
            ii(0x100c_092b, 2); add(esi, eax);                          /* add esi, eax */
            ii(0x100c_092d, 3); mov(memd[ss, ebp - 16], esi);           /* mov [ebp-0x10], esi */
            ii(0x100c_0930, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
