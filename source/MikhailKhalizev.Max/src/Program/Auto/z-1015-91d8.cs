...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_91d8()
        {
            ...
            ii(0x1015_91ef, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_91f2, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1015_91f5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_91f8, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1015_91fb, 5); mov(eax, 0x1);                          /* mov eax, 0x1 */
            ii(0x1015_9200, 5); call(0x100f_448c, -0x6_4d79);           /* call 0x100f448c */
            ii(0x1015_9205, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_9208, 4); cmp(memb[ds, eax + 0x57], 0x4);         /* cmp byte [eax+0x57], 0x4 */
            ii(0x1015_920c, 2); if(jnz(0x1015_9217, 0x9)) goto l_0x1015_9217; /* jnz 0x10159217 */
            ii(0x1015_920e, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_9211, 4); mov(memb[ds, eax + 0x57], 0);           /* mov byte [eax+0x57], 0x0 */
            ii(0x1015_9215, 2); jmp(0x1015_921e, 0x7); goto l_0x1015_921e; /* jmp 0x1015921e */
        l_0x1015_9217:
            ii(0x1015_9217, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_921a, 4); mov(memb[ds, eax + 0x57], 0x4);         /* mov byte [eax+0x57], 0x4 */
        l_0x1015_921e:
