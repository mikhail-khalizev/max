...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_604d()
        {
            ...
            ii(0x6056, 5);    mov(memw[ss, bp - 2], 0);                 /* mov word [bp-0x2], 0x0 */
            ii(0x605b, 4);    cmp(memw[ss, bp + 4], 0);                 /* cmp word [bp+0x4], 0x0 */
            ii(0x605f, 2);    if(jge(0x6069, 8)) goto l_0x6069;         /* jge 0x6069 */
            ii(0x6061, 5);    mov(memw[ss, bp - 2], 1);                 /* mov word [bp-0x2], 0x1 */
            ii(0x6066, 3);    neg(memw[ss, bp + 4]);                    /* neg word [bp+0x4] */
        l_0x6069:
            ii(0x6069, 3);    mov(ax, memw[ss, bp + 4]);                /* mov ax, [bp+0x4] */
            ii(0x606c, 4);    mov(memw[ss, bp - 154], ax);              /* mov [bp-0x9a], ax */
            ii(0x6070, 4);    lea(si, memw[ss, bp - 152]);              /* lea si, [bp-0x98] */
            ii(0x6074, 5);    cmp(memb[ds, 0xf21], 1);                  /* cmp byte [0xf21], 0x1 */
            ii(0x6079, 2);    if(jz(0x60cd, 0x52)) goto l_0x60cd;       /* jz 0x60cd */
            ii(0x607b, 5);    mov(memb[ss, bp - 152], 0x5b);            /* mov byte [bp-0x98], 0x5b */
            ii(0x6080, 4);    lea(si, memw[ss, bp - 151]);              /* lea si, [bp-0x97] */
        l_0x6084:
            ii(0x6084, 1);    inc(si);                                  /* inc si */
            ii(0x6085, 3);    mov(cx, 0xa);                             /* mov cx, 0xa */
            ii(0x6088, 4);    mov(ax, memw[ss, bp - 154]);              /* mov ax, [bp-0x9a] */
            ii(0x608c, 1);    cwd();                                    /* cwd */
            ii(0x608d, 2);    idiv(cx);                                 /* idiv cx */
            ii(0x608f, 4);    mov(memw[ss, bp - 154], ax);              /* mov [bp-0x9a], ax */
            ii(0x6093, 2);    or(ax, ax);                               /* or ax, ax */
            ii(0x6095, 2);    if(jnz(0x6084, -0x13)) goto l_0x6084;     /* jnz 0x6084 */
            ii(0x6097, 2);    mov(di, si);                              /* mov di, si */
            ii(0x6099, 3);    mov(ax, memw[ss, bp + 4]);                /* mov ax, [bp+0x4] */
            ii(0x609c, 4);    mov(memw[ss, bp - 154], ax);              /* mov [bp-0x9a], ax */
        l_0x60a0:
            ii(0x60a0, 1);    cwd();                                    /* cwd */
            ii(0x60a1, 2);    idiv(cx);                                 /* idiv cx */
            ii(0x60a3, 2);    mov(bx, dx);                              /* mov bx, dx */
            ii(0x60a5, 4);    mov(al, memb[ds, bx + 2736]);             /* mov al, [bx+0xab0] */
            ii(0x60a9, 1);    dec(di);                                  /* dec di */
            ii(0x60aa, 2);    mov(memb[ds, di], al);                    /* mov [di], al */
            ii(0x60ac, 4);    mov(ax, memw[ss, bp - 154]);              /* mov ax, [bp-0x9a] */
            ii(0x60b0, 1);    cwd();                                    /* cwd */
            ii(0x60b1, 2);    idiv(cx);                                 /* idiv cx */
            ii(0x60b3, 4);    mov(memw[ss, bp - 154], ax);              /* mov [bp-0x9a], ax */
            ii(0x60b7, 2);    or(ax, ax);                               /* or ax, ax */
            ii(0x60b9, 2);    if(jnz(0x60a0, -0x1b)) goto l_0x60a0;     /* jnz 0x60a0 */
            ii(0x60bb, 1);    inc(si);                                  /* inc si */
            ii(0x60bc, 4);    mov(memb[ds, si - 1], 0x5d);              /* mov byte [si-0x1], 0x5d */
            ii(0x60c0, 1);    inc(si);                                  /* inc si */
            ii(0x60c1, 4);    mov(memb[ds, si - 1], 0x20);              /* mov byte [si-0x1], 0x20 */
            ii(0x60c5, 1);    inc(si);                                  /* inc si */
            ii(0x60c6, 4);    mov(memb[ds, si - 1], 0x20);              /* mov byte [si-0x1], 0x20 */
        ...
        l_0x60d2:
            ...
            ii(0x60d8, 3);    cmp(ax, memw[ss, bp + 4]);                /* cmp ax, [bp+0x4] */
            ii(0x60db, 2);    if(jnz(0x60e6, 9)) goto l_0x60e6;         /* jnz 0x60e6 */
        ...
        l_0x610e:
            ...
            ii(0x6111, 4);    lea(ax, memw[ss, bp - 152]);              /* lea ax, [bp-0x98] */
