...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_c8f0()
        {
            ...
            ii(0x1015_c908, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_c90b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_c90e, 5); call(0x1007_611c, -0xe_67f7);           /* call 0x1007611c */
            ii(0x1015_c913, 3); lea(ebx, memd[ss, ebp - 0x10]);         /* lea ebx, [ebp-0x10] */
            ...
            ii(0x1015_c91f, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1015_c922, 5); call(0x1007_6600, -0xe_6327);           /* call 0x10076600 */
            ii(0x1015_c927, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1015_c92a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_c92d, 3); mov(ebx, memd[ds, eax + 0x3a]);         /* mov ebx, [eax+0x3a] */
            ii(0x1015_c930, 3); sar(ebx, 0x18);                         /* sar ebx, 0x18 */
            ii(0x1015_c933, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1015_c936, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_c939, 5); call(0x1015_c75a, -0x1e4);              /* call 0x1015c75a */
            ii(0x1015_c93e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_c941, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_c944, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ii(0x1015_c947, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_c94a, 3); cmp(dl, memb[ds, eax + 0x26]);          /* cmp dl, [eax+0x26] */
            ii(0x1015_c94d, 2); if(jnz(0x1015_c965, 0x16)) goto l_0x1015_c965; /* jnz 0x1015c965 */
            ii(0x1015_c94f, 7); mov(memd[ss, ebp - 0x14], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x1015_c956, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_c958, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1015_c965:
            ...
            ii(0x1015_c96e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_c971, 3); dec(memb[ds, eax + 0x50]);              /* dec byte [eax+0x50] */
            ii(0x1015_c974, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_c977, 3); mov(al, memb[ds, eax + 0x50]);          /* mov al, [eax+0x50] */
            ii(0x1015_c97a, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x1015_c97f, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1015_c981, 2); if(jnz(0x1015_c98a, 0x7)) goto l_0x1015_c98a; /* jnz 0x1015c98a */
            ii(0x1015_c983, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_c986, 4); mov(memb[ds, eax + 0x57], 0);           /* mov byte [eax+0x57], 0x0 */
        l_0x1015_c98a:
            ii(0x1015_c98a, 5); mov(edx, 0x101c_37bc);                  /* mov edx, 0x101c37bc */
            ii(0x1015_c98f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1015_c9aa:
            ii(0x1015_c9aa, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_c9ad, 4); mov(ax, memw[ds, eax + 0x41]);          /* mov ax, [eax+0x41] */
            ii(0x1015_c9b1, 4); cmp(ax, memw[ss, ebp - 0x8]);           /* cmp ax, [ebp-0x8] */
            ii(0x1015_c9b5, 2); if(jg(0x1015_c9fd, 0x46)) goto l_0x1015_c9fd; /* jg 0x1015c9fd */
            ii(0x1015_c9b7, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_c9ba, 4); cmp(memb[ds, eax + 0x3d], 0x1a);        /* cmp byte [eax+0x3d], 0x1a */
            ii(0x1015_c9be, 2); if(jz(0x1015_c9c7, 0x7)) goto l_0x1015_c9c7; /* jz 0x1015c9c7 */
            ii(0x1015_c9c0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_c9c3, 4); inc(memw[ds, eax + 0x52]);              /* inc word [eax+0x52] */
        l_0x1015_c9c7:
            ii(0x1015_c9c7, 5); mov(edx, 0x101c_37bc);                  /* mov edx, 0x101c37bc */
            ii(0x1015_c9cc, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1015_c9e7:
            ii(0x1015_c9e7, 7); mov(memd[ss, ebp - 0x14], 0x1);         /* mov dword [ebp-0x14], 0x1 */
            ii(0x1015_c9ee, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_c9f0, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1015_c9fd:
            ii(0x1015_c9fd, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1015_ca00, 5); call(0x1007_6574, -0xe_6491);           /* call 0x10076574 */
            ii(0x1015_ca05, 4); cmp(memb[ds, eax + 0x3d], 0x1a);        /* cmp byte [eax+0x3d], 0x1a */
            ii(0x1015_ca09, 6); if(jnz(0x1015_ca9f, 0x90)) goto l_0x1015_ca9f; /* jnz 0x1015ca9f */
            ii(0x1015_ca0f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_ca12, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_ca14, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ...
            ii(0x1015_ca22, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_ca25, 4); cmp(memb[ds, eax + 0x3d], 0x18);        /* cmp byte [eax+0x3d], 0x18 */
            ii(0x1015_ca29, 2); if(jnz(0x1015_ca5b, 0x30)) goto l_0x1015_ca5b; /* jnz 0x1015ca5b */
            ii(0x1015_ca2b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_ca2e, 3); mov(ebx, memd[ds, eax + 0x1a]);         /* mov ebx, [eax+0x1a] */
            ii(0x1015_ca31, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1015_ca34, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1015_ca37, 3); mov(edx, memd[ds, edx + 0x18]);         /* mov edx, [edx+0x18] */
            ii(0x1015_ca3a, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1015_ca3d, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1015_ca40, 5); call(0x1007_6aac, -0xe_5f99);           /* call 0x10076aac */
            ii(0x1015_ca45, 2); mov(ecx, memd[ds, eax]);                /* mov ecx, [eax] */
            ii(0x1015_ca47, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
        ...
        l_0x1015_ca5b:
            ii(0x1015_ca5b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_ca5e, 3); mov(ebx, memd[ds, eax + 0x1a]);         /* mov ebx, [eax+0x1a] */
            ii(0x1015_ca61, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1015_ca64, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1015_ca67, 3); mov(edx, memd[ds, edx + 0x18]);         /* mov edx, [edx+0x18] */
            ii(0x1015_ca6a, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1015_ca6d, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_ca70, 5); call(0x1007_6aac, -0xe_5fc9);           /* call 0x10076aac */
            ii(0x1015_ca75, 2); mov(ecx, memd[ds, eax]);                /* mov ecx, [eax] */
            ii(0x1015_ca77, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
        ...
        l_0x1015_ca89:
            ii(0x1015_ca89, 7); mov(memd[ss, ebp - 0x14], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x1015_ca90, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_ca92, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1015_ca9f:
            ii(0x1015_ca9f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_caa2, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ii(0x1015_caa5, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1015_caa7, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1015_caaa, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_caad, 5); call(0x1014_f634, -0xd47e);             /* call 0x1014f634 */
            ii(0x1015_cab2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_cab5, 5); call(0x1007_15df, -0xe_b4db);           /* call 0x100715df */
            ii(0x1015_caba, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_cabd, 5); call(0x1014_9fa8, -0x1_2b1a);           /* call 0x10149fa8 */
            ii(0x1015_cac2, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_cac5, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_cac7, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ...
            ii(0x1015_cad5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_cad8, 4); cmp(memb[ds, eax + 0x3d], 0x18);        /* cmp byte [eax+0x3d], 0x18 */
            ii(0x1015_cadc, 2); if(jnz(0x1015_caed, 0xf)) goto l_0x1015_caed; /* jnz 0x1015caed */
            ii(0x1015_cade, 5); mov(edx, 0x4);                          /* mov edx, 0x4 */
            ii(0x1015_cae3, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
        ...
        l_0x1015_caed:
            ...
            ii(0x1015_caf2, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
        ...
        l_0x1015_caff:
            ii(0x1015_caff, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_cb02, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_cb04, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ...
            ii(0x1015_cb16, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_cb19, 4); cmp(memb[ds, eax + 0x3d], 0x18);        /* cmp byte [eax+0x3d], 0x18 */
            ii(0x1015_cb1d, 2); if(jnz(0x1015_cb4f, 0x30)) goto l_0x1015_cb4f; /* jnz 0x1015cb4f */
            ii(0x1015_cb1f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_cb22, 3); mov(ebx, memd[ds, eax + 0x1a]);         /* mov ebx, [eax+0x1a] */
            ii(0x1015_cb25, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1015_cb28, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1015_cb2b, 3); mov(edx, memd[ds, edx + 0x18]);         /* mov edx, [edx+0x18] */
            ii(0x1015_cb2e, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1015_cb31, 3); lea(eax, memd[ss, ebp - 0x20]);         /* lea eax, [ebp-0x20] */
            ii(0x1015_cb34, 5); call(0x1007_6aac, -0xe_608d);           /* call 0x10076aac */
            ii(0x1015_cb39, 2); mov(ecx, memd[ds, eax]);                /* mov ecx, [eax] */
            ii(0x1015_cb3b, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
        ...
        l_0x1015_cb4f:
            ii(0x1015_cb4f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_cb52, 3); mov(ebx, memd[ds, eax + 0x1a]);         /* mov ebx, [eax+0x1a] */
            ii(0x1015_cb55, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1015_cb58, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1015_cb5b, 3); mov(edx, memd[ds, edx + 0x18]);         /* mov edx, [edx+0x18] */
            ii(0x1015_cb5e, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1015_cb61, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ii(0x1015_cb64, 5); call(0x1007_6aac, -0xe_60bd);           /* call 0x10076aac */
            ii(0x1015_cb69, 2); mov(ecx, memd[ds, eax]);                /* mov ecx, [eax] */
            ii(0x1015_cb6b, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
        ...
        l_0x1015_cb99:
            ii(0x1015_cb99, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_cb9c, 5); call(0x1015_c802, -0x39f);              /* call 0x1015c802 */
            ii(0x1015_cba1, 7); mov(memd[ss, ebp - 0x14], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x1015_cba8, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_cbaa, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
        ...
        //  ii(0x1015_cbb6, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
        //  ii(0x1015_cbb9, 5); call(0x1007_5f2c, -0xe_6c92);           /* call 0x10075f2c */
        l_0x1015_cbbe:
            ii(0x1015_cbbe, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
