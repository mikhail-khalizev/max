...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_6d9b()
        {
            ...
            ii(0x1018_6dc6, 4); mov(memw[ds, eax + 0x2], si);           /* mov [eax+0x2], si */
        l_0x1018_6dca:
            ...
            ii(0x1018_6dd1, 3); lea(edx, memd[ds, eax + 0x8]);          /* lea edx, [eax+0x8] */
            ii(0x1018_6dd4, 3); sub(ebx, 0x8);                          /* sub ebx, 0x8 */
            ii(0x1018_6dd7, 2); mov(memd[ds, edx], ebx);                /* mov [edx], ebx */
            ii(0x1018_6dd9, 7); mov(memd[ds, eax + 0x4], 0);            /* mov dword [eax+0x4], 0x0 */
        ...
        l_0x1018_6dfc:
            ...
            ii(0x1018_6e57, 3); mov(memd[ds, eax - 0x4], esi);          /* mov [eax-0x4], esi */
            ii(0x1018_6e5a, 3); sub(edx, 0x8);                          /* sub edx, 0x8 */
            ii(0x1018_6e5d, 2); mov(memd[ds, eax], edx);                /* mov [eax], edx */
            ii(0x1018_6e5f, 2); if(jmp_func(0x1018_6e63, 0x2)) return;  /* jmp 0x10186e63 */
        l_0x1018_6e61:
