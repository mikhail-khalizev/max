...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("fe3ae0b7-6691-439b-a060-b9a1a5a4204c")]
        ...
        //    ii(0x1012_2c28, 2); if(loopned_a32_func(0x1012_2c55, 0x2b)) return; /* loopne 0x10122c55 */ /* Адрес перехода делит инструкцию в этой функции пополам. */
