...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_e158()
        {
            ...
            ii(0x1009_e171, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1009_e174, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ii(0x1009_e177, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1009_e17a, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1009_e17d, 4); cmp(memb[ss, ebp - 0x4], 0x2);          /* cmp byte [ebp-0x4], 0x2 */
            ...
            ii(0x1009_e18b, 2); jmp(0x1009_e195, 0x8); goto l_0x1009_e195; /* jmp 0x1009e195 */
        l_0x1009_e18d:
            ii(0x1009_e18d, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1009_e190, 5); call(0x1009_e19c, 0x7);                 /* call 0x1009e19c */
        l_0x1009_e195:
