...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_246b()
        {
            ...
            ii(0x100f_2483, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x100f_24a3, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ...
            ii(0x100f_24af, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100f_24c6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100f_24d3, 2); if(jnz(0x100f_24db, 0x6)) goto l_0x100f_24db; /* jnz 0x100f24db */
            ii(0x100f_24d5, 4); mov(memb[ss, ebp - 0x24], 0x1);         /* mov byte [ebp-0x24], 0x1 */
            ii(0x100f_24d9, 2); jmp(0x100f_24df, 0x4); goto l_0x100f_24df; /* jmp 0x100f24df */
        l_0x100f_24db:
            ii(0x100f_24db, 4); mov(memb[ss, ebp - 0x24], 0);           /* mov byte [ebp-0x24], 0x0 */
        l_0x100f_24df:
            ii(0x100f_24df, 3); mov(al, memb[ss, ebp - 0x24]);          /* mov al, [ebp-0x24] */
            ii(0x100f_24e2, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x100f_24e5, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x100f_2500, 2); if(jg(0x100f_2508, 0x6)) goto l_0x100f_2508; /* jg 0x100f2508 */
            ii(0x100f_2502, 4); mov(memb[ss, ebp - 0x20], 0x1);         /* mov byte [ebp-0x20], 0x1 */
            ii(0x100f_2506, 2); jmp(0x100f_250c, 0x4); goto l_0x100f_250c; /* jmp 0x100f250c */
        l_0x100f_2508:
        ...
        l_0x100f_2512:
            ii(0x100f_2512, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100f_251d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100f_252a, 2); if(jnz(0x100f_2532, 0x6)) goto l_0x100f_2532; /* jnz 0x100f2532 */
            ii(0x100f_252c, 4); mov(memb[ss, ebp - 0x28], 0x1);         /* mov byte [ebp-0x28], 0x1 */
            ii(0x100f_2530, 2); jmp(0x100f_2536, 0x4); goto l_0x100f_2536; /* jmp 0x100f2536 */
        l_0x100f_2532:
        ...
        l_0x100f_253c:
            ii(0x100f_253c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100f_254b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100f_2556, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x100f_256d, 2); if(jg(0x100f_2575, 0x6)) goto l_0x100f_2575; /* jg 0x100f2575 */
            ii(0x100f_256f, 4); mov(memb[ss, ebp - 0x2c], 0x1);         /* mov byte [ebp-0x2c], 0x1 */
            ii(0x100f_2573, 2); jmp(0x100f_2579, 0x4); goto l_0x100f_2579; /* jmp 0x100f2579 */
        l_0x100f_2575:
        ...
        l_0x100f_257f:
            ii(0x100f_257f, 4); cmp(memb[ss, ebp - 0x8], 0);            /* cmp byte [ebp-0x8], 0x0 */
        ...
        l_0x100f_25e7:
            ...
            ii(0x100f_25ed, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x100f_2644:
            ii(0x100f_2644, 4); cmp(memb[ss, ebp - 0x8], 0);            /* cmp byte [ebp-0x8], 0x0 */
            ii(0x100f_2648, 2); if(jnz(0x100f_2650, 0x6)) goto l_0x100f_2650; /* jnz 0x100f2650 */
            ii(0x100f_264a, 4); cmp(memb[ss, ebp - 0xc], 0);            /* cmp byte [ebp-0xc], 0x0 */
            ii(0x100f_264e, 2); if(jz(0x100f_2652, 0x2)) goto l_0x100f_2652; /* jz 0x100f2652 */
        l_0x100f_2650:
            ii(0x100f_2650, 2); jmp(0x100f_2658, 0x6); goto l_0x100f_2658; /* jmp 0x100f2658 */
        l_0x100f_2652:
            ii(0x100f_2652, 4); cmp(memb[ss, ebp - 0x10], 0);           /* cmp byte [ebp-0x10], 0x0 */
            ii(0x100f_2656, 2); if(jz(0x100f_265a, 0x2)) goto l_0x100f_265a; /* jz 0x100f265a */
        l_0x100f_2658:
            ii(0x100f_2658, 2); jmp(0x100f_2660, 0x6); goto l_0x100f_2660; /* jmp 0x100f2660 */
        l_0x100f_265a:
            ii(0x100f_265a, 4); cmp(memb[ss, ebp - 0x14], 0);           /* cmp byte [ebp-0x14], 0x0 */
            ii(0x100f_265e, 2); if(jz(0x100f_2665, 0x5)) goto l_0x100f_2665; /* jz 0x100f2665 */
        l_0x100f_2660:
            ii(0x100f_2660, 5); jmp(0x100f_2899, 0x234); goto l_0x100f_2899; /* jmp 0x100f2899 */
        l_0x100f_2665:
            ii(0x100f_2665, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_2668, 5); cmp(memw[ds, eax + 0x8], 0x39);         /* cmp word [eax+0x8], 0x39 */
        ...
        l_0x100f_2690:
            ii(0x100f_2690, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100f_26ba:
            ii(0x100f_26ba, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_26bd, 4); cmp(memb[ds, eax + 0x3d], 0);           /* cmp byte [eax+0x3d], 0x0 */
            ii(0x100f_26c1, 2); if(jz(0x100f_26cc, 0x9)) goto l_0x100f_26cc; /* jz 0x100f26cc */
            ii(0x100f_26c3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_26c6, 4); cmp(memb[ds, eax + 0x3d], 0x2);         /* cmp byte [eax+0x3d], 0x2 */
            ii(0x100f_26ca, 2); if(jnz(0x100f_26d8, 0xc)) goto l_0x100f_26d8; /* jnz 0x100f26d8 */
        l_0x100f_26cc:
            ii(0x100f_26cc, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_26cf, 5); call(0x1008_aa4c, -0x6_7c88);           /* call 0x1008aa4c */
            ii(0x100f_26d4, 2); cmp(al, 0x2);                           /* cmp al, 0x2 */
            ii(0x100f_26d6, 2); if(jz(0x100f_26da, 0x2)) goto l_0x100f_26da; /* jz 0x100f26da */
        l_0x100f_26d8:
        ...
        l_0x100f_26fb:
            ii(0x100f_26fb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_26fe, 4); cmp(memb[ds, eax + 0x3d], 0);           /* cmp byte [eax+0x3d], 0x0 */
            ii(0x100f_2702, 2); if(jz(0x100f_270d, 0x9)) goto l_0x100f_270d; /* jz 0x100f270d */
            ii(0x100f_2704, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_2707, 4); cmp(memb[ds, eax + 0x3d], 0x2);         /* cmp byte [eax+0x3d], 0x2 */
            ii(0x100f_270b, 2); if(jnz(0x100f_2719, 0xc)) goto l_0x100f_2719; /* jnz 0x100f2719 */
        l_0x100f_270d:
            ii(0x100f_270d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_2710, 5); call(0x1008_aa4c, -0x6_7cc9);           /* call 0x1008aa4c */
            ii(0x100f_2715, 2); cmp(al, 0x1);                           /* cmp al, 0x1 */
            ii(0x100f_2717, 2); if(jz(0x100f_271b, 0x2)) goto l_0x100f_271b; /* jz 0x100f271b */
        l_0x100f_2719:
        ...
        l_0x100f_273c:
            ii(0x100f_273c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100f_2766:
            ii(0x100f_2766, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100f_276f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_2772, 6); test(memw[ds, eax + 0x12], 0x1c0);      /* test word [eax+0x12], 0x1c0 */
            ii(0x100f_2778, 2); if(jnz(0x100f_277c, 0x2)) goto l_0x100f_277c; /* jnz 0x100f277c */
        l_0x100f_277a:
        ...
        l_0x100f_279d:
            ii(0x100f_279d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_27a0, 4); cmp(memb[ds, eax + 0x3d], 0x4);         /* cmp byte [eax+0x3d], 0x4 */
            ii(0x100f_27a4, 2); if(jnz(0x100f_2815, 0x6f)) goto l_0x100f_2815; /* jnz 0x100f2815 */
            ii(0x100f_27a6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100f_27cd:
            ii(0x100f_27cd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100f_2815:
            ii(0x100f_2815, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_2818, 5); cmp(memw[ds, eax + 0x8], 0x1d);         /* cmp word [eax+0x8], 0x1d */
            ii(0x100f_281d, 2); if(jnz(0x100f_2828, 0x9)) goto l_0x100f_2828; /* jnz 0x100f2828 */
            ii(0x100f_281f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_2822, 4); cmp(memb[ds, eax + 0x3d], 0x7);         /* cmp byte [eax+0x3d], 0x7 */
            ii(0x100f_2826, 2); if(jz(0x100f_282a, 0x2)) goto l_0x100f_282a; /* jz 0x100f282a */
        l_0x100f_2828:
            ii(0x100f_2828, 2); jmp(0x100f_2852, 0x28); goto l_0x100f_2852; /* jmp 0x100f2852 */
        l_0x100f_282a:
            ii(0x100f_282a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100f_283b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100f_2850, 2); if(jz(0x100f_2854, 0x2)) goto l_0x100f_2854; /* jz 0x100f2854 */
        l_0x100f_2852:
        ...
        l_0x100f_2872:
            ii(0x100f_2872, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
