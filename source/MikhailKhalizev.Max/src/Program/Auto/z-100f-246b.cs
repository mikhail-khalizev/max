...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_246b()
        {
            ...
            ii(0x100f_249f, 4);  mov(memb[ss, ebp - 12], 0);           /* mov byte [ebp-0xc], 0x0 */
            ii(0x100f_24a3, 4);  mov(memb[ss, ebp - 8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x100f_24a7, 4);  mov(memb[ss, ebp - 16], 0);           /* mov byte [ebp-0x10], 0x0 */
            ii(0x100f_24ab, 4);  mov(memb[ss, ebp - 20], 0);           /* mov byte [ebp-0x14], 0x0 */
            ii(0x100f_24af, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_24b2, 5);  call(0x1007_623c, -0x7_c27b);         /* call 0x1007623c */
            ii(0x100f_24b7, 4);  mov(ax, memw[ds, eax + 27]);          /* mov ax, [eax+0x1b] */
            ii(0x100f_24bb, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x100f_24be, 4);  movsx(eax, memw[ss, ebp - 24]);       /* movsx eax, word [ebp-0x18] */
            ...
            ii(0x100f_24c9, 3);  mov(al, memb[ds, eax + 84]);          /* mov al, [eax+0x54] */
            ...
            ii(0x100f_24d5, 4);  mov(memb[ss, ebp - 36], 1);           /* mov byte [ebp-0x24], 0x1 */
            ii(0x100f_24d9, 2);  jmp(0x100f_24df, 4); goto l_0x100f_24df;/* jmp 0x100f24df */
        l_0x100f_24db:
            ii(0x100f_24db, 4);  mov(memb[ss, ebp - 36], 0);           /* mov byte [ebp-0x24], 0x0 */
        l_0x100f_24df:
            ii(0x100f_24df, 3);  mov(al, memb[ss, ebp - 36]);          /* mov al, [ebp-0x24] */
            ...
            ii(0x100f_24ea, 3);  mov(bl, memb[ds, edx + 84]);          /* mov bl, [edx+0x54] */
            ii(0x100f_24ed, 4);  movsx(edx, memw[ss, ebp - 24]);       /* movsx edx, word [ebp-0x18] */
            ...
            ii(0x100f_2502, 4);  mov(memb[ss, ebp - 32], 1);           /* mov byte [ebp-0x20], 0x1 */
            ii(0x100f_2506, 2);  jmp(0x100f_250c, 4); goto l_0x100f_250c;/* jmp 0x100f250c */
        l_0x100f_2508:
            ii(0x100f_2508, 4);  mov(memb[ss, ebp - 32], 0);           /* mov byte [ebp-0x20], 0x0 */
        l_0x100f_250c:
            ii(0x100f_250c, 3);  mov(al, memb[ss, ebp - 32]);          /* mov al, [ebp-0x20] */
            ii(0x100f_250f, 3);  mov(memb[ss, ebp - 12], al);          /* mov [ebp-0xc], al */
        l_0x100f_2512:
            ii(0x100f_2512, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_2515, 6);  test(memw[ds, eax + 18], 0x1c0);      /* test word [eax+0x12], 0x1c0 */
            ...
            ii(0x100f_2520, 3);  mov(al, memb[ds, eax + 78]);          /* mov al, [eax+0x4e] */
            ...
            ii(0x100f_252c, 4);  mov(memb[ss, ebp - 40], 1);           /* mov byte [ebp-0x28], 0x1 */
            ii(0x100f_2530, 2);  jmp(0x100f_2536, 4); goto l_0x100f_2536;/* jmp 0x100f2536 */
        l_0x100f_2532:
            ii(0x100f_2532, 4);  mov(memb[ss, ebp - 40], 0);           /* mov byte [ebp-0x28], 0x0 */
        l_0x100f_2536:
            ii(0x100f_2536, 3);  mov(al, memb[ss, ebp - 40]);          /* mov al, [ebp-0x28] */
            ii(0x100f_2539, 3);  mov(memb[ss, ebp - 16], al);          /* mov [ebp-0x10], al */
        l_0x100f_253c:
            ii(0x100f_253c, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_253f, 5);  call(0x1007_623c, -0x7_c308);         /* call 0x1007623c */
            ii(0x100f_2544, 4);  mov(ax, memw[ds, eax + 10]);          /* mov ax, [eax+0xa] */
            ii(0x100f_2548, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100f_254b, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_254e, 6);  test(memw[ds, eax + 18], 0x3c0);      /* test word [eax+0x12], 0x3c0 */
            ...
            ii(0x100f_255b, 3);  mov(bl, memb[ds, edx + 77]);          /* mov bl, [edx+0x4d] */
            ii(0x100f_255e, 4);  movsx(edx, memw[ss, ebp - 28]);       /* movsx edx, word [ebp-0x1c] */
            ...
            ii(0x100f_256f, 4);  mov(memb[ss, ebp - 44], 1);           /* mov byte [ebp-0x2c], 0x1 */
            ii(0x100f_2573, 2);  jmp(0x100f_2579, 4); goto l_0x100f_2579;/* jmp 0x100f2579 */
        l_0x100f_2575:
            ii(0x100f_2575, 4);  mov(memb[ss, ebp - 44], 0);           /* mov byte [ebp-0x2c], 0x0 */
        l_0x100f_2579:
            ii(0x100f_2579, 3);  mov(al, memb[ss, ebp - 44]);          /* mov al, [ebp-0x2c] */
            ii(0x100f_257c, 3);  mov(memb[ss, ebp - 20], al);          /* mov [ebp-0x14], al */
        l_0x100f_257f:
        ...
        l_0x100f_25a3:
            ii(0x100f_25a3, 4);  cmp(memb[ss, ebp - 12], 0);           /* cmp byte [ebp-0xc], 0x0 */
        ...
        l_0x100f_25c5:
            ii(0x100f_25c5, 4);  cmp(memb[ss, ebp - 16], 0);           /* cmp byte [ebp-0x10], 0x0 */
        ...
        l_0x100f_25e7:
            ii(0x100f_25e7, 4);  cmp(memb[ss, ebp - 20], 0);           /* cmp byte [ebp-0x14], 0x0 */
            ...
            ii(0x100f_25f2, 3);  mov(bl, memb[ds, edx + 77]);          /* mov bl, [edx+0x4d] */
            ii(0x100f_25f5, 4);  movsx(edx, memw[ss, ebp - 28]);       /* movsx edx, word [ebp-0x1c] */
        ...
        l_0x100f_2644:
            ...
            ii(0x100f_264a, 4);  cmp(memb[ss, ebp - 12], 0);           /* cmp byte [ebp-0xc], 0x0 */
        ...
        l_0x100f_2652:
            ii(0x100f_2652, 4);  cmp(memb[ss, ebp - 16], 0);           /* cmp byte [ebp-0x10], 0x0 */
        ...
        l_0x100f_265a:
            ii(0x100f_265a, 4);  cmp(memb[ss, ebp - 20], 0);           /* cmp byte [ebp-0x14], 0x0 */
        ...
        l_0x100f_2690:
            ...
            ii(0x100f_2693, 4);  cmp(memb[ds, eax + 61], 0x1e);        /* cmp byte [eax+0x3d], 0x1e */
        ...
        l_0x100f_26ba:
            ...
            ii(0x100f_26bd, 4);  cmp(memb[ds, eax + 61], 0);           /* cmp byte [eax+0x3d], 0x0 */
            ...
            ii(0x100f_26c6, 4);  cmp(memb[ds, eax + 61], 2);           /* cmp byte [eax+0x3d], 0x2 */
        ...
        l_0x100f_26fb:
            ...
            ii(0x100f_26fe, 4);  cmp(memb[ds, eax + 61], 0);           /* cmp byte [eax+0x3d], 0x0 */
            ...
            ii(0x100f_2707, 4);  cmp(memb[ds, eax + 61], 2);           /* cmp byte [eax+0x3d], 0x2 */
        ...
        l_0x100f_273c:
            ...
            ii(0x100f_273f, 4);  cmp(memb[ds, eax + 61], 0xb);         /* cmp byte [eax+0x3d], 0xb */
        ...
        l_0x100f_2766:
            ...
            ii(0x100f_2769, 4);  cmp(memb[ds, eax + 61], 0xc);         /* cmp byte [eax+0x3d], 0xc */
            ...
            ii(0x100f_2772, 6);  test(memw[ds, eax + 18], 0x1c0);      /* test word [eax+0x12], 0x1c0 */
        ...
        l_0x100f_279d:
            ...
            ii(0x100f_27a0, 4);  cmp(memb[ds, eax + 61], 4);           /* cmp byte [eax+0x3d], 0x4 */
            ...
            ii(0x100f_27a9, 4);  cmp(memb[ds, eax + 62], 0x1e);        /* cmp byte [eax+0x3e], 0x1e */
        ...
        l_0x100f_27cd:
            ...
            ii(0x100f_27d0, 4);  cmp(memb[ds, eax + 62], 0x1f);        /* cmp byte [eax+0x3e], 0x1f */
        ...
        l_0x100f_2815:
            ...
            ii(0x100f_2822, 4);  cmp(memb[ds, eax + 61], 7);           /* cmp byte [eax+0x3d], 0x7 */
        ...
        l_0x100f_282a:
            ...
            ii(0x100f_282d, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ...
            ii(0x100f_283e, 3);  mov(eax, memd[ds, eax + 90]);         /* mov eax, [eax+0x5a] */
        ...
        l_0x100f_2872:
            ...
            ii(0x100f_2875, 6);  test(memw[ds, eax + 18], 0x1c0);      /* test word [eax+0x12], 0x1c0 */
