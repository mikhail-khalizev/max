...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_e900()
        {
            ...
            ii(0x1015_e918, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_e91b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_e930, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1015_e953:
            ...
            ii(0x1015_e967, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_e96a, 3); mov(ebx, memd[ds, eax + 0x1a]);         /* mov ebx, [eax+0x1a] */
            ii(0x1015_e96d, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1015_e970, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1015_e973, 3); mov(edx, memd[ds, edx + 0x18]);         /* mov edx, [edx+0x18] */
            ii(0x1015_e976, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1015_e979, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1015_e97c, 5); call(0x1007_6600, -0xe_8381);           /* call 0x10076600 */
            ii(0x1015_e981, 5); call(0x1015_bd55, -0x2c31);             /* call 0x1015bd55 */
            ii(0x1015_e986, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x1015_e998, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x1015_e9db, 2); if(jnz(0x1015_e9e4, 0x7)) goto l_0x1015_e9e4; /* jnz 0x1015e9e4 */
            ii(0x1015_e9dd, 7); mov(memb[ds, 0x101c_391b], 0x1);        /* mov byte [0x101c391b], 0x1 */
        l_0x1015_e9e4:
            ii(0x1015_e9e4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_e9e7, 4); dec(memw[ds, eax + 0x52]);              /* dec word [eax+0x52] */
            ii(0x1015_e9eb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_e9ee, 4); mov(memb[ds, eax + 0x5e], 0);           /* mov byte [eax+0x5e], 0x0 */
            ii(0x1015_e9f2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_e9f5, 4); mov(memb[ds, eax + 0x3e], 0x12);        /* mov byte [eax+0x3e], 0x12 */
            ii(0x1015_e9f9, 5); mov(edx, 0x101c_37bc);                  /* mov edx, 0x101c37bc */
            ii(0x1015_e9fe, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_ea01, 5); call(0x1007_6d98, -0xe_7c6e);           /* call 0x10076d98 */
            ii(0x1015_ea06, 2); test(al, al);                           /* test al, al */
            ii(0x1015_ea08, 2); if(jz(0x1015_ea12, 0x8)) goto l_0x1015_ea12; /* jz 0x1015ea12 */
            ii(0x1015_ea0a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_ea0d, 5); call(0x1010_094d, -0x5_e0c5);           /* call 0x1010094d */
        l_0x1015_ea12:
            ii(0x1015_ea12, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_ea14, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
