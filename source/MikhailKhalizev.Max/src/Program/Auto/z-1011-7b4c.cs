...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_7b4c()
        {
            ...
            ii(0x1011_7b63, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_7b66, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1011_7b69, 5); mov(ebx, 0x101b_66dc);                  /* mov ebx, 0x101b66dc */
            ii(0x1011_7b6e, 5); mov(edx, 0x4);                          /* mov edx, 0x4 */
            ii(0x1011_7b73, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_7b76, 5); call(Definitions.sys_call_dtor_arr_v2, 0x4_e465); /* call 0x10165fe0 */
            ii(0x1011_7b7b, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1011_7b7e, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
