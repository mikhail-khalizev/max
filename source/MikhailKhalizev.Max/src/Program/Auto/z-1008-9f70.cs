...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_9f70()
        {
            ...
            ii(0x1008_9f82, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1008_9f88, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_9f8b, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_9f8d, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_9f9a, 2);  if(jz(0x1008_9fa5, 9)) goto l_0x1008_9fa5;/* jz 0x10089fa5 */
            ii(0x1008_9f9c, 7);  mov(memd[ss, ebp - 8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1008_9fa3, 2);  jmp(0x1008_9fb8, 0x13); goto l_0x1008_9fb8;/* jmp 0x10089fb8 */
        l_0x1008_9fa5:
            ii(0x1008_9fa5, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_9fb5, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
        l_0x1008_9fb8:
            ii(0x1008_9fb8, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
