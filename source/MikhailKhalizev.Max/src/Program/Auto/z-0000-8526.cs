...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_8526()
        {
            ...
            ii(0x852f, 3);    mov(di, memw[ss, bp + 0x4]);              /* mov di, [bp+0x4] */
            ii(0x8532, 2);    mov(bx, di);                              /* mov bx, di */
            ii(0x8534, 3);    mov(cx, memw[ss, bp + 0x8]);              /* mov cx, [bp+0x8] */
            ii(0x8537, 2);    if(jcxz(0x854e, 0x15)) goto l_0x854e;     /* jcxz 0x854e */
            ii(0x8539, 3);    mov(al, memb[ss, bp + 0x6]);              /* mov al, [bp+0x6] */
            ii(0x853c, 2);    mov(ah, al);                              /* mov ah, al */
            ii(0x853e, 4);    test(di, 0x1);                            /* test di, 0x1 */
            ii(0x8542, 2);    if(jz(0x8546, 0x2)) goto l_0x8546;        /* jz 0x8546 */
