...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_c747()
        {
            ...
            ii(0x100d_c75e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_c761, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_c764, 7); test(memd[ss, ebp - 0x4], 0x4);         /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x100d_c772, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_c781:
            ii(0x100d_c781, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_c784, 7); mov(memd[ds, eax + 0x40], 0x101b_5f04); /* mov dword [eax+0x40], 0x101b5f04 */
            ii(0x100d_c78b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_c78e, 3); mov(eax, memd[ds, eax + 0x44]);         /* mov eax, [eax+0x44] */
            ii(0x100d_c791, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100d_c794, 4); cmp(memd[ss, ebp - 0x14], 0);           /* cmp dword [ebp-0x14], 0x0 */
            ii(0x100d_c798, 2); if(jz(0x100d_c7ae, 0x14)) goto l_0x100d_c7ae; /* jz 0x100dc7ae */
            ii(0x100d_c79a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100d_c79c, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ...
            ii(0x100d_c7a9, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100d_c7ac, 2); jmp(0x100d_c7b5, 0x7); goto l_0x100d_c7b5; /* jmp 0x100dc7b5 */
        l_0x100d_c7ae:
            ii(0x100d_c7ae, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
        l_0x100d_c7b5:
            ii(0x100d_c7b5, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x100d_c7ba, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_c7bd, 5); call(0x100d_00b2, -0xc710);             /* call 0x100d00b2 */
            ii(0x100d_c7c2, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_c7c5, 7); test(memd[ss, ebp - 0x4], 0x2);         /* test dword [ebp-0x4], 0x2 */
            ii(0x100d_c7cc, 2); if(jz(0x100d_c7d6, 0x8)) goto l_0x100d_c7d6; /* jz 0x100dc7d6 */
            ii(0x100d_c7ce, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_c7d1, 5); call(Definitions.sys_delete, 0x8_978e); /* call 0x10165f64 */
        l_0x100d_c7d6:
            ii(0x100d_c7d6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_c7d9, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100d_c7dc, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
