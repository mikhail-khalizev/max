...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_b436()
        {
            ...
            ii(0xb45a, 2);    if(jl(0xb460, 0x4)) goto l_0xb460;        /* jl 0xb460 */
            ii(0xb45c, 2);    cmp(cx, ax);                              /* cmp cx, ax */
            ii(0xb45e, 2);    if(jae(0xb466, 0x6)) goto l_0xb466;       /* jae 0xb466 */
        l_0xb460:
        ...
        l_0xb466:
            ...
            ii(0xb474, 3);    mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ...
            ii(0xb481, 3);    mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ...
            ii(0xb48d, 2);    if(jz(0xb494, 0x5)) goto l_0xb494;        /* jz 0xb494 */
            ii(0xb48f, 3);    mov(ax, 0x395c);                          /* mov ax, 0x395c */
            ii(0xb492, 2);    jmp(0xb497, 0x3); goto l_0xb497;          /* jmp 0xb497 */
        l_0xb494:
        ...
        l_0xb497:
            ...
            ii(0xb4b2, 2);    if(jnz(0xb4ba, 0x6)) goto l_0xb4ba;       /* jnz 0xb4ba */
        ...
        l_0xb4ba:
            ...
            ii(0xb5ba, 3);    mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ...
            ii(0xb5c7, 2);    if(jnz(0xb5cf, 0x6)) goto l_0xb5cf;       /* jnz 0xb5cf */
        ...
        l_0xb5e3:
            ii(0xb5e3, 2);    push(-0x1 /* 0xff */);                    /* push 0xffff */
            ii(0xb5e5, 3);    push(0xe000);                             /* push 0xe000 */
            ii(0xb5e8, 3);    mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
        ...
        l_0xb5f6:
            ii(0xb5f6, 3);    dec(memw[ss, bp - 0x4]);                  /* dec word [bp-0x4] */
            ii(0xb5f9, 2);    if(jns(0xb5e3, -0x18)) goto l_0xb5e3;     /* jns 0xb5e3 */
            ii(0xb5fb, 5);    shl(memw[ds, 0xf54], 0x3);                /* shl word [0xf54], 0x3 */
            ii(0xb600, 5);    cmp(memb[ds, 0x2f], 0x3);                 /* cmp byte [0x2f], 0x3 */
            ii(0xb605, 2);    if(jl(0xb638, 0x31)) goto l_0xb638;       /* jl 0xb638 */
            ii(0xb607, 3);    mov(ax, 0x3);                             /* mov ax, 0x3 */
            ii(0xb60a, 3);    mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
        ...
        l_0xb61b:
            ii(0xb61b, 2);    push(-0x1 /* 0xff */);                    /* push 0xffff */
            ii(0xb61d, 3);    push(0xd000);                             /* push 0xd000 */
            ii(0xb620, 3);    mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
        ...
        l_0xb62e:
            ii(0xb62e, 3);    dec(memw[ss, bp - 0x4]);                  /* dec word [bp-0x4] */
            ii(0xb631, 2);    if(jns(0xb61b, -0x18)) goto l_0xb61b;     /* jns 0xb61b */
            ii(0xb633, 5);    shl(memw[ds, 0xa87], 0x3);                /* shl word [0xa87], 0x3 */
        l_0xb638:
            ...
            ii(0xb64d, 2);    if(jnz(0xb658, 0x9)) goto l_0xb658;       /* jnz 0xb658 */
            ii(0xb64f, 4);    cmp(memw[ds, 0xae], dx);                  /* cmp [0xae], dx */
            ii(0xb653, 2);    if(jnz(0xb658, 0x3)) goto l_0xb658;       /* jnz 0xb658 */
        ...
        l_0xb658:
            ...
            ii(0xb65f, 2);    push(0x3);                                /* push 0x3 */
            ii(0xb661, 3);    call(0x997c, -0x1ce8);                    /* call 0x997c */
            ii(0xb664, 1);    pop(bx);                                  /* pop bx */
            ii(0xb665, 3);    mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0xb668, 2);    or(ax, ax);                               /* or ax, ax */
            ii(0xb66a, 2);    if(jnz(0xb672, 0x6)) goto l_0xb672;       /* jnz 0xb672 */
        ...
        l_0xb672:
            ...
            ii(0xb677, 3);    mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
