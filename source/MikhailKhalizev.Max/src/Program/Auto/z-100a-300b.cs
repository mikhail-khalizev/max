...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_300b()
        {
            ...
            ii(0x100a_3021, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100a_3024, 3); mov(memd[ss, ebp - 8], edx);            /* mov [ebp-0x8], edx */
            ii(0x100a_3027, 3); mov(memd[ss, ebp - 4], ebx);            /* mov [ebp-0x4], ebx */
