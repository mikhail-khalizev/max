...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_bc9f()
        {
            ...
            ii(0x1008_bcb6, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_bcb9, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1008_bcbc, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1008_bcc3, 2); jmp(0x1008_bccb, 0x6); goto l_0x1008_bccb; /* jmp 0x1008bccb */
        l_0x1008_bcc5:
            ii(0x1008_bcc5, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1008_bcc8, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x1008_bccb:
            ii(0x1008_bccb, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1008_bcce, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1008_bcd1, 4); cmp(ax, memw[ds, edx + 0x4]);           /* cmp ax, [edx+0x4] */
            ii(0x1008_bcd5, 2); if(jge(0x1008_bcf0, 0x19)) goto l_0x1008_bcf0; /* jge 0x1008bcf0 */
            ii(0x1008_bcd7, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1008_bcdb, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1008_bcde, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1008_bce0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1008_bcf0:
            ii(0x1008_bcf0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_bcf3, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1008_bcf5, 5); call(Definitions.sys_delete, 0xd_a26a); /* call 0x10165f64 */
            ii(0x1008_bcfa, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_bcfd, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1008_bd00, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
