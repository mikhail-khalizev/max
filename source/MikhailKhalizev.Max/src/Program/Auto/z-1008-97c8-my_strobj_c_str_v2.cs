...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void my_strobj_c_str_v2()
        {
            ...
            ii(0x1008_97e0, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_97e3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_97e6, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1008_97e8, 5); call(Definitions.my_strobj_c_str, 0xf); /* call 0x100897fc */
            ii(0x1008_97ed, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_97f0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
