...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_2c42()
        {
            ...
            ii(0x100a_2c59, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_2c5c, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_2c5f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_2c62, 5); call(0x1007_623c, -0x2_ca2b);           /* call 0x1007623c */
            ii(0x100a_2c67, 4); cmp(memb[ds, eax + 0x16], 0);           /* cmp byte [eax+0x16], 0x0 */
            ...
            ii(0x100a_2c7a, 2); if(jge(0x100a_2c7e, 0x2)) goto l_0x100a_2c7e; /* jge 0x100a2c7e */
        l_0x100a_2c7c:
            ii(0x100a_2c7c, 2); jmp(0x100a_2c99, 0x1b); goto l_0x100a_2c99; /* jmp 0x100a2c99 */
        l_0x100a_2c7e:
            ii(0x100a_2c7e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_2c81, 3); mov(al, memb[ds, eax + 0x50]);          /* mov al, [eax+0x50] */
            ii(0x100a_2c84, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100a_2c89, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100a_2c8b, 2); if(jnz(0x100a_2c93, 0x6)) goto l_0x100a_2c93; /* jnz 0x100a2c93 */
            ii(0x100a_2c8d, 4); mov(memb[ss, ebp - 0xc], 0x3);          /* mov byte [ebp-0xc], 0x3 */
            ii(0x100a_2c91, 2); jmp(0x100a_2cac, 0x19); goto l_0x100a_2cac; /* jmp 0x100a2cac */
        l_0x100a_2c93:
            ii(0x100a_2c93, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x100a_2c97, 2); jmp(0x100a_2cac, 0x13); goto l_0x100a_2cac; /* jmp 0x100a2cac */
        l_0x100a_2c99:
            ii(0x100a_2c99, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_2c9c, 4); cmp(memb[ds, eax + 0x54], 0);           /* cmp byte [eax+0x54], 0x0 */
            ii(0x100a_2ca0, 2); if(jz(0x100a_2ca8, 0x6)) goto l_0x100a_2ca8; /* jz 0x100a2ca8 */
            ii(0x100a_2ca2, 4); mov(memb[ss, ebp - 0xc], 0x2);          /* mov byte [ebp-0xc], 0x2 */
            ii(0x100a_2ca6, 2); jmp(0x100a_2cac, 0x4); goto l_0x100a_2cac; /* jmp 0x100a2cac */
        l_0x100a_2ca8:
            ii(0x100a_2ca8, 4); mov(memb[ss, ebp - 0xc], 0x3);          /* mov byte [ebp-0xc], 0x3 */
        l_0x100a_2cac:
            ii(0x100a_2cac, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
