...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x100a_2c7e:
            ...
            ii(0x100a_2c8d, 4); mov(memb[ss, ebp - 0xc], 3);            /* mov byte [ebp-0xc], 0x3 */
            ii(0x100a_2c91, 2); jmp(0x100a_2cac, 0x19); goto l_0x100a_2cac; /* jmp 0x100a2cac */
        l_0x100a_2c93:
            ii(0x100a_2c93, 4); mov(memb[ss, ebp - 0xc], 1);            /* mov byte [ebp-0xc], 0x1 */
        ...
        l_0x100a_2c99:
            ...
            ii(0x100a_2ca2, 4); mov(memb[ss, ebp - 0xc], 2);            /* mov byte [ebp-0xc], 0x2 */
            ii(0x100a_2ca6, 2); jmp(0x100a_2cac, 4); goto l_0x100a_2cac; /* jmp 0x100a2cac */
        l_0x100a_2ca8:
            ii(0x100a_2ca8, 4); mov(memb[ss, ebp - 0xc], 3);            /* mov byte [ebp-0xc], 0x3 */
        l_0x100a_2cac:
