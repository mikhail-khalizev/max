...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_0aae()
        {
            ...
            ii(0x100c_0ac9, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x100c_0acc, 3); mov(memd[ss, ebp - 0x4], ecx);          /* mov [ebp-0x4], ecx */
            ...
            ii(0x100c_0ad8, 2); if(jle(0x100c_0ae3, 0x9)) goto l_0x100c_0ae3; /* jle 0x100c0ae3 */
        ...
        l_0x100c_0ae3:
            ...
            ii(0x100c_0b05, 5); cmp(memw[ds, eax + 0x8], 0x47);         /* cmp word [eax+0x8], 0x47 */
            ...
            ii(0x100c_0b0f, 5); cmp(memw[ds, eax + 0x8], 0x45);         /* cmp word [eax+0x8], 0x45 */
            ii(0x100c_0b14, 2); if(jnz(0x100c_0b1c, 0x6)) goto l_0x100c_0b1c; /* jnz 0x100c0b1c */
        l_0x100c_0b16:
            ii(0x100c_0b16, 4); mov(memb[ss, ebp - 0x1c], 0x1);         /* mov byte [ebp-0x1c], 0x1 */
            ii(0x100c_0b1a, 2); jmp(0x100c_0b20, 0x4); goto l_0x100c_0b20; /* jmp 0x100c0b20 */
        l_0x100c_0b1c:
        ...
        l_0x100c_0b20:
            ...
            ii(0x100c_0b30, 4); movsx(ebx, memw[ss, ebp - 0x4]);        /* movsx ebx, word [ebp-0x4] */
            ii(0x100c_0b34, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
        ...
        l_0x100c_0b4b:
            ...
            ii(0x100c_0b73, 3); test(memb[ds, eax], 0x6);               /* test byte [eax], 0x6 */
            ...
            ii(0x100c_0b87, 3); mov(edx, memd[ds, edx + 0x4]);          /* mov edx, [edx+0x4] */
            ...
            ii(0x100c_0bb2, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
        ...
        l_0x100c_0bde:
            ...
            ii(0x100c_0be8, 4); movsx(ebx, memw[ss, ebp - 0x4]);        /* movsx ebx, word [ebp-0x4] */
            ii(0x100c_0bec, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x100c_0bfc, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
            ...
            ii(0x100c_0c0b, 4); movsx(ebx, memw[ss, ebp - 0x4]);        /* movsx ebx, word [ebp-0x4] */
            ii(0x100c_0c0f, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x100c_0c1f, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
