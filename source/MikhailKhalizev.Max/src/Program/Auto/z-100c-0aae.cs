...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_0aae()
        {
            ...
            ii(0x100c_0ac3, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x100c_0ac6, 3);  mov(memd[ss, ebp - 12], edx);         /* mov [ebp-0xc], edx */
            ii(0x100c_0ac9, 3);  mov(memd[ss, ebp - 8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x100c_0acc, 3);  mov(memd[ss, ebp - 4], ecx);          /* mov [ebp-0x4], ecx */
            ii(0x100c_0acf, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ii(0x100c_0ad2, 3);  mov(edx, memd[ss, ebp + 24]);         /* mov edx, [ebp+0x18] */
            ii(0x100c_0ad5, 3);  cmp(ax, memw[ds, edx]);               /* cmp ax, [edx] */
            ii(0x100c_0ad8, 2);  if(jle(0x100c_0ae3, 9)) goto l_0x100c_0ae3;/* jle 0x100c0ae3 */
            ii(0x100c_0ada, 3);  mov(eax, memd[ss, ebp + 24]);         /* mov eax, [ebp+0x18] */
            ii(0x100c_0add, 3);  mov(ax, memw[ds, eax]);               /* mov ax, [eax] */
            ii(0x100c_0ae0, 3);  mov(memd[ss, ebp + 20], eax);         /* mov [ebp+0x14], eax */
        l_0x100c_0ae3:
            ii(0x100c_0ae3, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ii(0x100c_0ae6, 3);  mov(edx, memd[ss, ebp + 24]);         /* mov edx, [ebp+0x18] */
            ii(0x100c_0ae9, 3);  sub(memw[ds, edx], ax);               /* sub [edx], ax */
            ii(0x100c_0aec, 3);  mov(eax, memd[ss, ebp + 16]);         /* mov eax, [ebp+0x10] */
            ii(0x100c_0aef, 4);  imul(eax, memd[ss, ebp + 20]);        /* imul eax, [ebp+0x14] */
            ii(0x100c_0af3, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x100c_0af6, 4);  movsx(edx, memw[ss, ebp - 24]);       /* movsx edx, word [ebp-0x18] */
            ii(0x100c_0afa, 2);  test(edx, edx);                       /* test edx, edx */
            ii(0x100c_0afc, 6);  if(jle(0x100c_0c27, 0x125)) goto l_0x100c_0c27;/* jle 0x100c0c27 */
            ii(0x100c_0b02, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x100c_0b0c, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
        ...
        l_0x100c_0b16:
            ii(0x100c_0b16, 4);  mov(memb[ss, ebp - 28], 1);           /* mov byte [ebp-0x1c], 0x1 */
            ii(0x100c_0b1a, 2);  jmp(0x100c_0b20, 4); goto l_0x100c_0b20;/* jmp 0x100c0b20 */
        l_0x100c_0b1c:
            ii(0x100c_0b1c, 4);  mov(memb[ss, ebp - 28], 0);           /* mov byte [ebp-0x1c], 0x0 */
        l_0x100c_0b20:
            ii(0x100c_0b20, 3);  mov(al, memb[ss, ebp - 28]);          /* mov al, [ebp-0x1c] */
            ii(0x100c_0b23, 3);  mov(memb[ss, ebp - 20], al);          /* mov [ebp-0x14], al */
            ii(0x100c_0b26, 4);  cmp(memb[ss, ebp - 20], 0);           /* cmp byte [ebp-0x14], 0x0 */
            ...
            ii(0x100c_0b37, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x100c_0b3a, 5);  call(0x1007_5e64, -0x4_acdb);         /* call 0x10075e64 */
            ii(0x100c_0b3f, 3);  lea(ecx, memd[ss, ebp - 48]);         /* lea ecx, [ebp-0x30] */
        ...
        l_0x100c_0b4b:
            ii(0x100c_0b4b, 3);  lea(eax, memd[ss, ebp - 48]);         /* lea eax, [ebp-0x30] */
            ...
            ii(0x100c_0b60, 3);  lea(eax, memd[ss, ebp - 48]);         /* lea eax, [ebp-0x30] */
            ...
            ii(0x100c_0b78, 3);  lea(eax, memd[ss, ebp - 48]);         /* lea eax, [ebp-0x30] */
            ...
            ii(0x100c_0b84, 3);  mov(edx, memd[ss, ebp - 16]);         /* mov edx, [ebp-0x10] */
            ii(0x100c_0b87, 3);  mov(edx, memd[ds, edx + 4]);          /* mov edx, [edx+0x4] */
            ii(0x100c_0b8a, 2);  add(edx, eax);                        /* add edx, eax */
            ii(0x100c_0b8c, 3);  lea(eax, memd[ss, ebp - 48]);         /* lea eax, [ebp-0x30] */
            ...
            ii(0x100c_0b9b, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x100c_0b9e, 3);  add(memw[ds, edx], ax);               /* add [edx], ax */
            ii(0x100c_0ba1, 3);  lea(eax, memd[ss, ebp - 48]);         /* lea eax, [ebp-0x30] */
            ...
            ii(0x100c_0baf, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100c_0bb2, 3);  mov(eax, memd[ds, eax + 8]);          /* mov eax, [eax+0x8] */
            ii(0x100c_0bb5, 2);  add(edx, eax);                        /* add edx, eax */
            ii(0x100c_0bb7, 3);  lea(eax, memd[ss, ebp - 48]);         /* lea eax, [ebp-0x30] */
            ...
            ii(0x100c_0bc6, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ii(0x100c_0bc9, 3);  add(memw[ds, edx], ax);               /* add [edx], ax */
        l_0x100c_0bcc:
            ii(0x100c_0bcc, 3);  lea(eax, memd[ss, ebp - 48]);         /* lea eax, [ebp-0x30] */
