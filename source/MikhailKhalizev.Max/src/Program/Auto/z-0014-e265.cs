...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("8bea73d0-d054-4fae-b1dd-23c176cfc610")]
        public void Method_0014_e265()
        {
            ii(0x14_e265, 3); callw(0x14_e070, -0x1f8);                 /* call 0xe070 */
            ii(0x14_e268, 4); if(jbw_func(0x14_e2b3, 0x47)) return;     /* jb 0xe2b3 */
            ii(0x14_e26c, 2); if(jcxzw_func(0x14_e2b3, 0x45)) return;   /* jcxz 0xe2b3 */
        ...
        l_0x14_e29c:
            ...
            ii(0x14_e2a7, 3); if(jmpw_func(0x14_e067, -0x243)) return;  /* jmp 0xe067 */
        l_0x14_e2aa:
            ii(0x14_e2aa, 4); mov(ax, memw_a32[ss, ebp + 0x18]);        /* mov ax, [ebp+0x18] */
            ii(0x14_e2ae, 2); mov(memw_a16[ds, bx], ax);                /* mov [bx], ax */
            ii(0x14_e2b0, 3); if(jmpw_func(0x14_e067, -0x24c)) return;  /* jmp 0xe067 */
        }
    }
}
