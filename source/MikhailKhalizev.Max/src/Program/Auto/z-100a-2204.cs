...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("81db89e6-9671-4ab0-92ff-a70c7a78d64d")]
        ...
        //    ii(0x100a_23ca, 5); calld(0x100a_a698, 0x82c9);             /* call 0x100aa698 */
        //    ii(0x100a_23cf, 2); xor(edx, edx);                          /* xor edx, edx */
        //    ii(0x100a_23d1, 3); lea(eax, ebp - 0x18);                   /* lea eax, [ebp-0x18] */
        //    ii(0x100a_23d4, 5); calld(0x1007_5f6c, -0x2_c46d);          /* call 0x10075f6c */
        l_0x100a_23d9:
