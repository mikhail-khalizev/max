...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("bce2362e-b9c6-43a6-bc98-a8d4e85bc131")]
        public void Method_100a_2204()
        {
            ii(0x100a_2204, 5); pushd(0x3b0);                           /* push 0x3b0 */
            ii(0x100a_2209, 5); calld(Definitions.sys_check_available_stack_size, 0xc3b44); /* call 0x10165d52 */
            ...
            ii(0x100a_2228, 5); calld(0x1007_64fc, -0x2bd31);           /* call 0x100764fc */
            ...
            ii(0x100a_225d, 5); calld(0x1007_6338, -0x2bf2a);           /* call 0x10076338 */
            ...
            ii(0x100a_2269, 5); calld(0x1007_643c, -0x2be32);           /* call 0x1007643c */
        l_0x100a_226e:
            ii(0x100a_226e, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_2270, 3); lea(eax, ebp - 0x18);                   /* lea eax, [ebp-0x18] */
            ii(0x100a_2273, 5); calld(0x1013_ad71, 0x98af9);            /* call 0x1013ad71 */
        ...
        l_0x100a_228c:
            ...
            ii(0x100a_228f, 5); calld(0x1007_63a0, -0x2bef4);           /* call 0x100763a0 */
            ii(0x100a_2294, 5); calld(0x1007_6204, -0x2c095);           /* call 0x10076204 */
            ...
            ii(0x100a_22a1, 5); calld(0x1007_63a0, -0x2bf06);           /* call 0x100763a0 */
        ...
        l_0x100a_22ae:
            ...
            ii(0x100a_22b1, 5); calld(0x1007_63a0, -0x2bf16);           /* call 0x100763a0 */
        ...
        l_0x100a_22c2:
            ...
            ii(0x100a_22c5, 5); calld(0x1007_63a0, -0x2bf2a);           /* call 0x100763a0 */
            ii(0x100a_22ca, 5); calld(0x1015_14ef, 0xaf220);            /* call 0x101514ef */
            ii(0x100a_22cf, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x100a_22d2, 3); lea(eax, ebp - 0x18);                   /* lea eax, [ebp-0x18] */
            ii(0x100a_22d5, 5); calld(0x1007_63a0, -0x2bf3a);           /* call 0x100763a0 */
            ii(0x100a_22da, 3); mov(eax, memd_a32[ds, eax + 0x6]);      /* mov eax, [eax+0x6] */
            ii(0x100a_22dd, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100a_22e0, 5); calld(0x1007_1e00, -0x304e5);           /* call 0x10071e00 */
        ...
        l_0x100a_22f0:
            ...
            ii(0x100a_22f3, 5); calld(0x1007_63a0, -0x2bf58);           /* call 0x100763a0 */
            ii(0x100a_22f8, 3); mov(eax, memd_a32[ds, eax + 0x6]);      /* mov eax, [eax+0x6] */
            ii(0x100a_22fb, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100a_22fe, 5); calld(0x1007_1ff5, -0x3030e);           /* call 0x10071ff5 */
        ...
        l_0x100a_2311:
            ...
            ii(0x100a_2314, 5); calld(0x1007_63a0, -0x2bf79);           /* call 0x100763a0 */
            ii(0x100a_2319, 3); mov(eax, memd_a32[ds, eax + 0x6]);      /* mov eax, [eax+0x6] */
            ii(0x100a_231c, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100a_231f, 5); calld(0x1007_1f2e, -0x303f6);           /* call 0x10071f2e */
        ...
        l_0x100a_2398:
            ...
            ii(0x100a_23bb, 5); calld(0x1007_5f6c, -0x2c454);           /* call 0x10075f6c */
