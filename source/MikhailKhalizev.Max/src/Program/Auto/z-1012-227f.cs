...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_227f()
        {
            ...
            ii(0x1012_229d, 6);  cmp(memw[ds, eax + 64], 0x6cd);       /* cmp word [eax+0x40], 0x6cd */
            ii(0x1012_22a3, 2);  if(jnz(0x1012_22ae, 9)) goto l_0x1012_22ae;/* jnz 0x101222ae */
            ii(0x1012_22a5, 7);  mov(memd[ss, ebp - 12], 0x14);        /* mov dword [ebp-0xc], 0x14 */
            ii(0x1012_22ac, 2);  jmp(0x1012_22b5, 7); goto l_0x1012_22b5;/* jmp 0x101222b5 */
        l_0x1012_22ae:
            ii(0x1012_22ae, 7);  mov(memd[ss, ebp - 12], 0xffff_ffec); /* mov dword [ebp-0xc], 0xffffffec */
        l_0x1012_22b5:
        ...
        l_0x1012_22c4:
            ...
            ii(0x1012_22df, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ...
            ii(0x1012_22ef, 3);  mov(memb[ss, ebp - 16], al);          /* mov [ebp-0x10], al */
            ii(0x1012_22f2, 4);  cmp(memb[ss, ebp - 16], 0x40);        /* cmp byte [ebp-0x10], 0x40 */
            ...
            ii(0x1012_22fb, 6);  cmp(memw[ds, eax + 64], 0x6c1);       /* cmp word [eax+0x40], 0x6c1 */
            ii(0x1012_2301, 6);  if(jnz(0x1012_2450, 0x149)) goto l_0x1012_2450;/* jnz 0x10122450 */
        l_0x1012_2307:
            ii(0x1012_2307, 4);  movsx(eax, memw[ss, ebp - 20]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1012_230b, 3);  cmp(eax, 0x19);                       /* cmp eax, 0x19 */
            ii(0x1012_230e, 2);  if(jnz(0x1012_2314, 4)) goto l_0x1012_2314;/* jnz 0x10122314 */
            ii(0x1012_2310, 4);  add(memd[ss, ebp - 12], 0x14);        /* add dword [ebp-0xc], 0x14 */
        l_0x1012_2314:
            ...
            ii(0x1012_2328, 4);  movsx(eax, memb[ss, ebp - 16]);       /* movsx eax, byte [ebp-0x10] */
            ...
            ii(0x1012_2368, 3);  mov(memb[ss, ebp - 24], al);          /* mov [ebp-0x18], al */
            ii(0x1012_236b, 5);  jmp(0x1012_23fc, 0x8c); goto l_0x1012_23fc;/* jmp 0x101223fc */
        l_0x1012_2370:
            ii(0x1012_2370, 4);  movsx(ecx, memw[ss, ebp - 12]);       /* movsx ecx, word [ebp-0xc] */
            ii(0x1012_2374, 4);  movsx(ebx, memw[ss, ebp - 20]);       /* movsx ebx, word [ebp-0x14] */
        ...
        l_0x1012_2389:
            ii(0x1012_2389, 4);  movsx(ecx, memw[ss, ebp - 12]);       /* movsx ecx, word [ebp-0xc] */
            ii(0x1012_238d, 4);  movsx(ebx, memw[ss, ebp - 20]);       /* movsx ebx, word [ebp-0x14] */
            ...
            ii(0x1012_23b1, 3);  sub(memd[ss, ebp - 12], eax);         /* sub [ebp-0xc], eax */
            ii(0x1012_23b4, 2);  jmp(0x1012_2419, 0x63); goto l_0x1012_2419;/* jmp 0x10122419 */
        l_0x1012_23b6:
            ii(0x1012_23b6, 4);  movsx(ecx, memw[ss, ebp - 12]);       /* movsx ecx, word [ebp-0xc] */
            ii(0x1012_23ba, 4);  movsx(ebx, memw[ss, ebp - 20]);       /* movsx ebx, word [ebp-0x14] */
        ...
        l_0x1012_23cc:
            ii(0x1012_23cc, 4);  movsx(ecx, memw[ss, ebp - 12]);       /* movsx ecx, word [ebp-0xc] */
            ii(0x1012_23d0, 4);  movsx(ebx, memw[ss, ebp - 20]);       /* movsx ebx, word [ebp-0x14] */
        ...
        l_0x1012_23fc:
            ii(0x1012_23fc, 3);  mov(al, memb[ss, ebp - 24]);          /* mov al, [ebp-0x18] */
            ii(0x1012_23ff, 2);  dec(al);                              /* dec al */
            ii(0x1012_2401, 3);  mov(memb[ss, ebp - 28], al);          /* mov [ebp-0x1c], al */
            ii(0x1012_2404, 4);  cmp(memb[ss, ebp - 28], 5);           /* cmp byte [ebp-0x1c], 0x5 */
            ii(0x1012_2408, 2);  if(ja(0x1012_23e2, -0x28)) goto l_0x1012_23e2;/* ja 0x101223e2 */
            ii(0x1012_240a, 2);  xor(eax, eax);                        /* xor eax, eax */
            ii(0x1012_240c, 3);  mov(al, memb[ss, ebp - 28]);          /* mov al, [ebp-0x1c] */
            ii(0x1012_240f, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x1012_2412, 7);  /* jmp dword [cs:eax+0x101223e4] */
        ...
        l_0x1012_241b:
            ...
            ii(0x1012_241e, 6);  cmp(memw[ds, eax + 64], 0x6c1);       /* cmp word [eax+0x40], 0x6c1 */
            ii(0x1012_2424, 2);  if(jnz(0x1012_242c, 6)) goto l_0x1012_242c;/* jnz 0x1012242c */
            ii(0x1012_2426, 4);  cmp(memb[ss, ebp - 16], 0x31);        /* cmp byte [ebp-0x10], 0x31 */
        ...
        l_0x1012_242e:
            ...
            ii(0x1012_2434, 4);  mov(memw[ds, edx + 73], ax);          /* mov [edx+0x49], ax */
            ii(0x1012_2438, 2);  jmp(0x1012_2455, 0x1b); goto l_0x1012_2455;/* jmp 0x10122455 */
        l_0x1012_243a:
            ii(0x1012_243a, 4);  cmp(memb[ss, ebp - 16], 0);           /* cmp byte [ebp-0x10], 0x0 */
            ...
            ii(0x1012_2446, 4);  mov(memw[ds, edx + 73], ax);          /* mov [edx+0x49], ax */
            ii(0x1012_244a, 2);  jmp(0x1012_2455, 9); goto l_0x1012_2455;/* jmp 0x10122455 */
        l_0x1012_244c:
            ii(0x1012_244c, 4);  add(memd[ss, ebp - 12], 0x14);        /* add dword [ebp-0xc], 0x14 */
        l_0x1012_2450:
