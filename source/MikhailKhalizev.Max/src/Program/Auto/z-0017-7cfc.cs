...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x17_7cfc, 4); enter(0x2, 0);                            /* enter 0x2, 0x0 */
            ...
            ii(0x17_7d1c, 4); mov(memb[es, bx + 0x1], al);              /* mov [es:bx+0x1], al */
            ii(0x17_7d20, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_7d23, 3); mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ...
            ii(0x17_7d42, 4); mov(memw[es, bx + 0x2], ax);              /* mov [es:bx+0x2], ax */
            ii(0x17_7d46, 4); mov(memw[es, bx + 0x4], dx);              /* mov [es:bx+0x4], dx */
            ...
            ii(0x17_7d56, 2); push(0x6);                                /* push 0x6 */
            ii(0x17_7d58, 1); nop();                                    /* nop */
            ii(0x17_7d59, 1); push(cs);                                 /* push cs */
            ii(0x17_7d5a, 3); call(0x17_0864, -0x74f9);                 /* call 0x864 */
        l_0x17_7d5d:
            ii(0x17_7d5d, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_7d60, 3); mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ...
            ii(0x17_7d79, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ...
            ii(0x17_7d91, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x17_7d94, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x17_7d97, 2); push(0);                                  /* push 0x0 */
            ii(0x17_7d99, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x17_7d9c, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x17_7d9f, 4); call_far_ind(ds, bx + 0x2020);            /* call far word [bx+0x2020] */
