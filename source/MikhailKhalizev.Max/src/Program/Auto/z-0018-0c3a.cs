...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_0c3a()
        {
            ...
            ii(0x18_0c43, 3); push(memw[ss, bp + 0xc]);                 /* push word [bp+0xc] */
            ii(0x18_0c46, 3); push(memw[ss, bp + 0xa]);                 /* push word [bp+0xa] */
            ii(0x18_0c49, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x18_0c4c, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x18_0c4f, 3); call(0x18_0bfe, -0x54);                   /* call 0xbfe */
            ii(0x18_0c52, 1); pop(ds);                                  /* pop ds */
            ii(0x18_0c53, 1); leave();                                  /* leave */
            ii(0x18_0c54, 3); retf(0x8);                                /* retf 0x8 */
        }
    }
}
