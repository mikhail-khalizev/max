...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_ceac()
        {
            ...
            ii(0x17_cefa, 6); push(memd_a32[es, ebp + 0x8]);            /* push dword [es:ebp+0x8] */
            ii(0x17_cf00, 6); push(memd_a32[es, ebp + 0x4]);            /* push dword [es:ebp+0x4] */
            ii(0x17_cf06, 5); push(memw_a32[es, ebp + 0x2]);            /* push word [es:ebp+0x2] */
            ii(0x17_cf0b, 5); push(memw_a32[es, ebp + 0]);              /* push word [es:ebp] */
            ii(0x17_cf10, 6); push(memd_a32[es, ebp - 0x4]);            /* push dword [es:ebp-0x4] */
