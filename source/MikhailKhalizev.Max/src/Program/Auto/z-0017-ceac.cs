...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_ceac()
        {
            ...
            ii(0x17_ceb5, 3);  mov(memw[ds, si + 121], ss);            /* mov [si+0x79], ss */
            ii(0x17_ceb8, 1);  push(ss);                               /* push ss */
            ii(0x17_ceb9, 1);  pop(es);                                /* pop es */
            ii(0x17_ceba, 4);  mov(memd[ds, si + 117], esp);           /* mov [si+0x75], esp */
            ii(0x17_cebe, 4);  lss(sp, memw[ds, si + 123]);            /* lss sp, [si+0x7b] */
            ii(0x17_cec2, 2);  mov(ds, cx);                            /* mov ds, cx */
            ii(0x17_cec4, 6);  push(memd_a32[es, ebp + 44]);           /* push dword [es:ebp+0x2c] */
            ii(0x17_ceca, 6);  push(memd_a32[es, ebp + 40]);           /* push dword [es:ebp+0x28] */
            ii(0x17_ced0, 6);  push(memd_a32[es, ebp + 36]);           /* push dword [es:ebp+0x24] */
            ii(0x17_ced6, 6);  push(memd_a32[es, ebp + 32]);           /* push dword [es:ebp+0x20] */
            ii(0x17_cedc, 6);  push(memd_a32[es, ebp + 28]);           /* push dword [es:ebp+0x1c] */
            ii(0x17_cee2, 6);  push(memd_a32[es, ebp + 24]);           /* push dword [es:ebp+0x18] */
            ii(0x17_cee8, 6);  push(memd_a32[es, ebp + 20]);           /* push dword [es:ebp+0x14] */
            ii(0x17_ceee, 6);  push(memd_a32[es, ebp + 16]);           /* push dword [es:ebp+0x10] */
            ii(0x17_cef4, 6);  push(memd_a32[es, ebp + 12]);           /* push dword [es:ebp+0xc] */
