...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_284c()
        {
            ...
            ii(0x100a_2863, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_2866, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_2869, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_286c, 7); mov(memd[ds, eax + 0x2], 0x101b_4f54);  /* mov dword [eax+0x2], 0x101b4f54 */
            ii(0x100a_2873, 7); dec(memw[ds, 0x101c_31b6]);             /* dec word [0x101c31b6] */
            ii(0x100a_287a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_287c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_288a, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_288d, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x100a_2892, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_2895, 5); call(0x1013_ab27, 0x9_828d);            /* call 0x1013ab27 */
            ii(0x100a_289a, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_289d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_28a0, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100a_28a3, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
