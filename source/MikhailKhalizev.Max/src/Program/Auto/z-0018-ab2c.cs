...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_ab2c()
        {
            ...
            ii(0x18_ab2f, 3); mov(bl, memb[ss, bp + 0x16]);             /* mov bl, [bp+0x16] */
            ii(0x18_ab32, 3); mov(dl, memb[ss, bp + 0x12]);             /* mov dl, [bp+0x12] */
            ii(0x18_ab35, 2); mov(di, bx);                              /* mov di, bx */
            ii(0x18_ab37, 3); shl(bx, 0x3);                             /* shl bx, 0x3 */
            ii(0x18_ab3a, 3); lea(ax, memw[ds, bx - 0x40]);             /* lea ax, [bx-0x40] */
            ...
            ii(0x18_ab4b, 4); mov(memb[ds, di + 0x10be], dl);           /* mov [di+0x10be], dl */
            ...
            ii(0x18_ab5a, 2); if(jnz(0x18_ab64, 0x8)) goto l_0x18_ab64; /* jnz 0xab64 */
            ii(0x18_ab5c, 4); mov(ax, memw[ds, bx + 0xf6a]);            /* mov ax, [bx+0xf6a] */
            ii(0x18_ab60, 4); mov(si, memw[ds, bx + 0xf6c]);            /* mov si, [bx+0xf6c] */
        l_0x18_ab64:
            ii(0x18_ab64, 4); mov(es, memw[ds, 0xc2e]);                 /* mov es, [0xc2e] */
            ii(0x18_ab68, 3); mov(memw[es, bx], ax);                    /* mov [es:bx], ax */
            ii(0x18_ab6b, 4); mov(memw[es, bx + 0x2], si);              /* mov [es:bx+0x2], si */
        l_0x18_ab6f:
