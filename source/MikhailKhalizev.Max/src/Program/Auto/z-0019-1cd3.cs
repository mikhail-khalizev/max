...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_1cd3()
        {
            ...
            ii(0x19_1cd9, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x19_1cdc, 3); mov(memw[ss, bp - 0xa], ax);              /* mov [bp-0xa], ax */
            ii(0x19_1cdf, 3); les(bx, memw[ss, bp + 0x4]);              /* les bx, [bp+0x4] */
            ii(0x19_1ce2, 3); mov(ax, memw[es, bx]);                    /* mov ax, [es:bx] */
            ii(0x19_1ce5, 4); mov(dx, memw[es, bx + 0x2]);              /* mov dx, [es:bx+0x2] */
            ii(0x19_1ce9, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_1cec, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
        ...
        l_0x19_1cf1:
            ...
            ii(0x19_1cfd, 3); lea(cx, memw[ss, bp - 0xa]);              /* lea cx, [bp-0xa] */
            ...
            ii(0x19_1d07, 3); mov(al, memb[ss, bp - 0x6]);              /* mov al, [bp-0x6] */
            ii(0x19_1d0a, 1); cbw();                                    /* cbw */
            ii(0x19_1d0b, 3); sub(ax, 0x30);                            /* sub ax, 0x30 */
            ii(0x19_1d0e, 1); cwd();                                    /* cwd */
            ii(0x19_1d0f, 3); add(memw[ss, bp - 0xa], ax);              /* add [bp-0xa], ax */
            ii(0x19_1d12, 3); adc(memw[ss, bp - 0x8], dx);              /* adc [bp-0x8], dx */
            ii(0x19_1d15, 3); inc(memw[ss, bp - 0x4]);                  /* inc word [bp-0x4] */
        l_0x19_1d18:
            ii(0x19_1d18, 3); les(bx, memw[ss, bp - 0x4]);              /* les bx, [bp-0x4] */
            ii(0x19_1d1b, 3); mov(al, memb[es, bx]);                    /* mov al, [es:bx] */
            ii(0x19_1d1e, 3); mov(memb[ss, bp - 0x6], al);              /* mov [bp-0x6], al */
        ...
        l_0x19_1d25:
            ...
            ii(0x19_1d29, 3); les(bx, memw[ss, bp + 0x4]);              /* les bx, [bp+0x4] */
            ii(0x19_1d2c, 3); mov(memw[es, bx], ax);                    /* mov [es:bx], ax */
            ii(0x19_1d2f, 4); mov(memw[es, bx + 0x2], dx);              /* mov [es:bx+0x2], dx */
            ii(0x19_1d33, 3); mov(ax, memw[ss, bp - 0xa]);              /* mov ax, [bp-0xa] */
            ii(0x19_1d36, 3); mov(dx, memw[ss, bp - 0x8]);              /* mov dx, [bp-0x8] */
