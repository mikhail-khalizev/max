...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_e77a()
        {
            ...
            ii(0x17_e784, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_e787, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
            ...
            ii(0x17_e793, 2); push(-0x1 /* 0xff */);                    /* push 0xffff */
            ...
            ii(0x17_e79d, 3); mov(ah, memb[ss, bp - 0x2]);              /* mov ah, [bp-0x2] */
