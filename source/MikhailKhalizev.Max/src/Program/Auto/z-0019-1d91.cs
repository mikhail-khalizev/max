...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_1d91()
        {
            ...
            ii(0x19_1d94, 4); cmp(memw[ss, bp + 0x4], 0x1);             /* cmp word [bp+0x4], 0x1 */
            ...
            ii(0x19_1da4, 2); if(jnz(0x19_1da9, 0x3)) goto l_0x19_1da9; /* jnz 0x1da9 */
            ii(0x19_1da6, 3); call(0x19_1d7c, -0x2d);                   /* call 0x1d7c */
        l_0x19_1da9:
            ii(0x19_1da9, 4); cmp(memw[ss, bp + 0x4], 0);               /* cmp word [bp+0x4], 0x0 */
            ii(0x19_1dad, 2); if(jz(0x19_1dbd, 0xe)) goto l_0x19_1dbd;  /* jz 0x1dbd */
            ii(0x19_1daf, 3); mov(al, memb[ss, bp + 0x4]);              /* mov al, [bp+0x4] */
