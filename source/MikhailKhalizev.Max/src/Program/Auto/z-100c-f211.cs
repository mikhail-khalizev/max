...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_f211()
        {
            ...
            ii(0x100c_f228, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_f22b, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100c_f22e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_f237, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_f258, 2); jmp(0x100c_f261, 0x7); goto l_0x100c_f261; /* jmp 0x100cf261 */
        l_0x100c_f25a:
        ...
        l_0x100c_f261:
            ...
            ii(0x100c_f27a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_f27d, 3); mov(ecx, memd[ds, eax + 0x4]);          /* mov ecx, [eax+0x4] */
            ii(0x100c_f280, 3); sar(ecx, 0x10);                         /* sar ecx, 0x10 */
            ii(0x100c_f283, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_f286, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x100c_f289, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100c_f28c, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ...
            ii(0x100c_f2a1, 2); jmp(0x100c_f2a9, 0x6); goto l_0x100c_f2a9; /* jmp 0x100cf2a9 */
        l_0x100c_f2a3:
        ...
        l_0x100c_f2a9:
            ...
            ii(0x100c_f2ac, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
