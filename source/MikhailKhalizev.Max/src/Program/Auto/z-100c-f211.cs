...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_f211()
        {
            ...
            ii(0x100c_f231, 4); cmp(memd[ds, eax + 16], 0);             /* cmp dword [eax+0x10], 0x0 */
            ...
            ii(0x100c_f23a, 3); mov(eax, memd[ds, eax + 16]);           /* mov eax, [eax+0x10] */
            ii(0x100c_f23d, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100c_f240, 4); cmp(memd[ss, ebp - 12], 0);             /* cmp dword [ebp-0xc], 0x0 */
            ii(0x100c_f244, 2); if(jz(0x100c_f25a, 0x14)) goto l_0x100c_f25a; /* jz 0x100cf25a */
            ii(0x100c_f246, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100c_f248, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x100c_f255, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x100c_f258, 2); jmp(0x100c_f261, 7); goto l_0x100c_f261; /* jmp 0x100cf261 */
        l_0x100c_f25a:
            ii(0x100c_f25a, 7); mov(memd[ss, ebp - 16], 0);             /* mov dword [ebp-0x10], 0x0 */
        l_0x100c_f261:
            ii(0x100c_f261, 5); mov(eax, 0xd);                          /* mov eax, 0xd */
            ii(0x100c_f266, 5); call(Definitions.sys_new, 0x9_6b95);    /* call 0x10165e00 */
            ii(0x100c_f26b, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x100c_f26e, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x100c_f271, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x100c_f274, 4); cmp(memd[ss, ebp - 24], 0);             /* cmp dword [ebp-0x18], 0x0 */
            ...
            ii(0x100c_f290, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x100c_f293, 5); call(Definitions.my_ctor_c19, 0x89c6);  /* call 0x100d7c5e */
            ii(0x100c_f298, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x100c_f29b, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x100c_f29e, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
            ii(0x100c_f2a1, 2); jmp(0x100c_f2a9, 6); goto l_0x100c_f2a9; /* jmp 0x100cf2a9 */
        l_0x100c_f2a3:
            ii(0x100c_f2a3, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x100c_f2a6, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
        l_0x100c_f2a9:
            ii(0x100c_f2a9, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
            ii(0x100c_f2ac, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x100c_f2af, 3); mov(memd[ds, edx + 16], eax);           /* mov [edx+0x10], eax */
