...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_80c8()
        {
            ...
            ii(0x100e_80e0, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100e_80e3, 5); call(0x100e_85b8, 0x4d0);               /* call 0x100e85b8 */
            ii(0x100e_80e8, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x100e_80eb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_80ee, 5); call(0x100e_8564, 0x471);               /* call 0x100e8564 */
            ii(0x100e_80f3, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_80f6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
