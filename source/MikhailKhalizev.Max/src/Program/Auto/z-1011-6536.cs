...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("ad71bb22-4018-4699-b4bd-fc4a6b22d56c")]
        public void Method_1011_6536()
        {
            ii(0x1011_6536, 5); pushd(0x44);                            /* push 0x44 */
            ii(0x1011_653b, 5); calld(Definitions.sys_check_available_stack_size, 0x4_f812); /* call 0x10165d52 */
            ...
            ii(0x1011_6564, 5); calld(Definitions.sys_call_dtor_arr, 0x4_fa4f); /* call 0x10165fb8 */
            ii(0x1011_6569, 5); calld(Definitions.sys_delete_arr, 0x4_fa6a); /* call 0x10165fd8 */
        ...
        l_0x1011_6573:
            ...
            ii(0x1011_6591, 5); calld(Definitions.my_dtor_d2, -0x4_805e); /* call 0x100ce538 */
            ii(0x1011_6596, 5); calld(Definitions.sys_delete, 0x4_f9c9); /* call 0x10165f64 */
        ...
        l_0x1011_65a7:
            ...
            ii(0x1011_65bb, 5); calld(Definitions.sys_call_dtor_arr, 0x4_f9f8); /* call 0x10165fb8 */
            ii(0x1011_65c0, 5); calld(Definitions.sys_delete_arr, 0x4_fa13); /* call 0x10165fd8 */
        l_0x1011_65c5:
            ...
            ii(0x1011_65e2, 5); calld(Definitions.my_dtor_d2, -0x4_80af); /* call 0x100ce538 */
            ii(0x1011_65e7, 5); calld(Definitions.sys_delete, 0x4_f978); /* call 0x10165f64 */
        ...
        l_0x1011_65f8:
            ...
            ii(0x1011_6615, 5); calld(Definitions.my_dtor_d2, -0x4_80e2); /* call 0x100ce538 */
            ii(0x1011_661a, 5); calld(Definitions.sys_delete, 0x4_f945); /* call 0x10165f64 */
        ...
        l_0x1011_662b:
            ...
            ii(0x1011_6648, 5); calld(Definitions.my_dtor_d3, -0x3_e91a); /* call 0x100d7d33 */
            ii(0x1011_664d, 5); calld(Definitions.sys_delete, 0x4_f912); /* call 0x10165f64 */
        ...
        l_0x1011_665e:
            ii(0x1011_665e, 5); calld(0x100e_a903, -0x2_bd60);          /* call 0x100ea903 */
            ii(0x1011_6663, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x1011_6668, 3); mov(eax, memd_a32[ss, ebp - 0x8]);      /* mov eax, [ebp-0x8] */
            ii(0x1011_666b, 5); calld(0x100d_6999, -0x3_fcd7);          /* call 0x100d6999 */
            ...
            ii(0x1011_667f, 5); calld(Definitions.sys_delete, 0x4_f8e0); /* call 0x10165f64 */
        l_0x1011_6684:
