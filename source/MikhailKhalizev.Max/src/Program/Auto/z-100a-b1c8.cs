...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_b1c8()
        {
            ...
            ii(0x100a_b1d9, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100a_b1df, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100a_b1e2, 3); mov(memb[ss, ebp - 4], dl);             /* mov [ebp-0x4], dl */
            ii(0x100a_b1e5, 3); mov(al, memb[ss, ebp - 4]);             /* mov al, [ebp-0x4] */
            ii(0x100a_b1e8, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x100a_b1eb, 3); mov(memb[ds, edx + 8], al);             /* mov [edx+0x8], al */
