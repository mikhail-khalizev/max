...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_1dca()
        {
            ...
            ii(0x100a_1de2, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_1de5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_1de8, 3); mov(al, memb[ds, eax + 0x4d]);          /* mov al, [eax+0x4d] */
            ...
            ii(0x100a_1df9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100a_1e04:
            ...
            ii(0x100a_1e0f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_1e12, 3); mov(ebx, memd[ds, eax + 0x6]);          /* mov ebx, [eax+0x6] */
            ii(0x100a_1e15, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100a_1e18, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_1e1b, 3); mov(edx, memd[ds, eax + 0x1e]);         /* mov edx, [eax+0x1e] */
            ii(0x100a_1e1e, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100a_1e21, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_1e37, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_1e3a, 3); mov(ebx, memd[ds, eax + 0x8]);          /* mov ebx, [eax+0x8] */
            ii(0x100a_1e3d, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100a_1e40, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_1e43, 3); mov(edx, memd[ds, eax + 0x20]);         /* mov edx, [eax+0x20] */
            ii(0x100a_1e46, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100a_1e49, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_1e5f, 3); mov(ecx, memd[ss, ebp - 0x4]);          /* mov ecx, [ebp-0x4] */
            ii(0x100a_1e62, 3); mov(ebx, memd[ds, ecx + 0x4]);          /* mov ebx, [ecx+0x4] */
            ii(0x100a_1e65, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100a_1e68, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100a_1e6b, 3); mov(edx, memd[ds, edx + 0x1c]);         /* mov edx, [edx+0x1c] */
            ii(0x100a_1e6e, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100a_1e71, 3); mov(esi, memd[ss, ebp - 0x4]);          /* mov esi, [ebp-0x4] */
            ...
            ii(0x100a_1e8f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
