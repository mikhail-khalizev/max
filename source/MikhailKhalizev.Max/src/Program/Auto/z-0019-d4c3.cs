...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_d4c3()
        {
            ...
            ii(0x19_d4cc, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x19_d4cf, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ii(0x19_d4d2, 3); push(memw[ss, bp + 0xa]);                 /* push word [bp+0xa] */
            ii(0x19_d4d5, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ...
            ii(0x19_d4e4, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x19_d4e7, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ii(0x19_d4ea, 5); call_far_abs(0x80, 0x440a);               /* call word 0x80:0x440a */
            ii(0x19_d4ef, 2); mov(sp, bp);                              /* mov sp, bp */
            ii(0x19_d4f1, 3); mov(memw[ss, bp + 0x8], ax);              /* mov [bp+0x8], ax */
            ii(0x19_d4f4, 3); mov(memw[ss, bp + 0xa], dx);              /* mov [bp+0xa], dx */
            ii(0x19_d4f7, 2); mov(ax, dx);                              /* mov ax, dx */
            ii(0x19_d4f9, 3); or(ax, memw[ss, bp + 0x8]);               /* or ax, [bp+0x8] */
            ii(0x19_d4fc, 2); if(jz(0x19_d514, 0x16)) goto l_0x19_d514; /* jz 0xd514 */
            ii(0x19_d4fe, 3); les(bx, memw[ss, bp + 0x8]);              /* les bx, [bp+0x8] */
            ii(0x19_d501, 4); mov(memb[es, bx], 0);                     /* mov byte [es:bx], 0x0 */
            ii(0x19_d505, 2); jmp(0x19_d514, 0xd); goto l_0x19_d514;    /* jmp 0xd514 */
        l_0x19_d507:
            ii(0x19_d507, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x19_d50a, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
        ...
        l_0x19_d514:
            ...
            ii(0x19_d515, 3); ret(0x8);                                 /* ret 0x8 */
        }
    }
}
