...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_5df2()
        {
            ...
            ii(0x1014_5e08, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_5e0b, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1014_5e0e, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1014_5e11, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ii(0x1014_5e14, 3); lea(edx, memd[ss, ebp - 0x1c]);         /* lea edx, [ebp-0x1c] */
            ii(0x1014_5e17, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1014_5e1a, 5); call(0x1014_630a, 0x4eb);               /* call 0x1014630a */
            ii(0x1014_5e1f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_5e21, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1014_5e2d, 4); mov(memb[ss, ebp - 0x10], 0);           /* mov byte [ebp-0x10], 0x0 */
            ii(0x1014_5e31, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_5e33, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
        ...
        l_0x1014_5e3d:
            ...
            ii(0x1014_5e42, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1014_5e45, 5); call(0x100e_0760, -0x6_56ea);           /* call 0x100e0760 */
            ii(0x1014_5e4a, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1014_5e4d, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1014_5e50, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x1014_5e53, 3); lea(edx, memd[ss, ebp - 0x18]);         /* lea edx, [ebp-0x18] */
            ii(0x1014_5e56, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1014_5e59, 3); call_abs(memd[ds, ebx + 0xc]);          /* call dword [ebx+0xc] */
            ...
            ii(0x1014_5e6a, 2); if(jnz(0x1014_5e72, 0x6)) goto l_0x1014_5e72; /* jnz 0x10145e72 */
            ii(0x1014_5e6c, 4); mov(memb[ss, ebp - 0x20], 0x1);         /* mov byte [ebp-0x20], 0x1 */
            ii(0x1014_5e70, 2); jmp(0x1014_5e76, 0x4); goto l_0x1014_5e76; /* jmp 0x10145e76 */
        l_0x1014_5e72:
            ii(0x1014_5e72, 4); mov(memb[ss, ebp - 0x20], 0);           /* mov byte [ebp-0x20], 0x0 */
        l_0x1014_5e76:
            ii(0x1014_5e76, 3); mov(al, memb[ss, ebp - 0x20]);          /* mov al, [ebp-0x20] */
            ii(0x1014_5e79, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_5e7c, 2); mov(memb[ds, edx], al);                 /* mov [edx], al */
            ii(0x1014_5e7e, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_5e80, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1014_5e83, 5); call(Definitions.my_string_dtor, -0x435e); /* call 0x10141b2a */
            ii(0x1014_5e88, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
            ii(0x1014_5e8c, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_5e8e, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
        ...
        //  ii(0x1014_5e9a, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
        //  ii(0x1014_5e9d, 5); call(0x100e_03bc, -0x6_5ae6);           /* call 0x100e03bc */
        l_0x1014_5ea2:
            ii(0x1014_5ea2, 3); mov(al, memb[ss, ebp - 0x10]);          /* mov al, [ebp-0x10] */
