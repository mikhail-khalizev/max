...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_0369()
        {
            ...
            ii(0x1015_0387, 3); mov(eax, memd[ds, eax + 80]);           /* mov eax, [eax+0x50] */
            ii(0x1015_038a, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1015_038d, 3); imul(eax, eax, 0xa);                    /* imul eax, eax, 0xa */
            ii(0x1015_0390, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1015_0393, 3); fild(memd[ss, ebp - 16]);               /* fild dword [ebp-0x10] */
            ...
            ii(0x1015_03a6, 3); fistp(memd[ss, ebp - 16]);              /* fistp dword [ebp-0x10] */
            ii(0x1015_03a9, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1015_03ac, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1015_03af, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x1015_03b3, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1015_03b5, 2); if(jge(0x1015_03be, 7)) goto l_0x1015_03be; /* jge 0x101503be */
            ii(0x1015_03b7, 7); mov(memd[ss, ebp - 12], 0);             /* mov dword [ebp-0xc], 0x0 */
        l_0x1015_03be:
            ii(0x1015_03be, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
