...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_51e7()
        {
            ...
            ii(0x1019_51ee, 2); push(fs);                               /* push fs */
            ii(0x1019_51f0, 2); push(gs);                               /* push gs */
            ii(0x1019_51f2, 1); push(es);                               /* push es */
            ii(0x1019_51f3, 1); push(ds);                               /* push ds */
            ii(0x1019_51f4, 1); push(ds);                               /* push ds */
            ii(0x1019_51f5, 1); pop(es);                                /* pop es */
            ii(0x1019_51f6, 5); mov(edi, 0x101c_1a60);                  /* mov edi, 0x101c1a60 */
            ii(0x1019_51fb, 3); mov(ebx, memd[ss, ebp + 0x8]);          /* mov ebx, [ebp+0x8] */
            ...
            ii(0x1019_5212, 1); pop(ds);                                /* pop ds */
        ...
        l_0x1019_5218:
            ...
            ii(0x1019_5220, 1); pop(ds);                                /* pop ds */
            ii(0x1019_5221, 5); mov(eax, 0x101c_1a60);                  /* mov eax, 0x101c1a60 */
        l_0x1019_5226:
            ii(0x1019_5226, 1); pop(es);                                /* pop es */
            ii(0x1019_5227, 2); pop(gs);                                /* pop gs */
            ii(0x1019_5229, 2); pop(fs);                                /* pop fs */
