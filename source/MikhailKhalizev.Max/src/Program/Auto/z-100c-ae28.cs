...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("147b5076-a6e0-48b2-8916-1aabe1573f76")]
        public void Method_100c_ae28()
        {
            ii(0x100c_ae28, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x100c_ae2d, 5); calld(Definitions.sys_check_available_stack_size, 0x9_af20); /* call 0x10165d52 */
            ...
            ii(0x100c_ae46, 5); calld(0x1008_b410, -0x3_fa3b);          /* call 0x1008b410 */
            ii(0x100c_ae4b, 3); add(eax, 0x6);                          /* add eax, 0x6 */
            ii(0x100c_ae4e, 5); calld(Definitions.my_3_get_count, -0x3_f9d3); /* call 0x1008b480 */
