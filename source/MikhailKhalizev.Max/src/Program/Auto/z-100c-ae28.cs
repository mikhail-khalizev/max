...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_ae28()
        {
            ...
            ii(0x100c_ae3a, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x100c_ae40, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_ae43, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_ae46, 5);  call(0x1008_b410, -0x3_fa3b);         /* call 0x1008b410 */
            ii(0x100c_ae4b, 3);  add(eax, 6);                          /* add eax, 0x6 */
            ii(0x100c_ae4e, 5);  call(Definitions.my_3_get_count, -0x3_f9d3);/* call 0x1008b480 */
            ii(0x100c_ae53, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_ae56, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
