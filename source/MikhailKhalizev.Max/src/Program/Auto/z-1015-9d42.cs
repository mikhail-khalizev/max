...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_9d42()
        {
            ...
            ii(0x1015_9d59, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_9d5c, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1015_9d5f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_9d62, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1015_9d65, 5); mov(eax, 0x1);                          /* mov eax, 0x1 */
            ii(0x1015_9d6a, 5); call(0x100f_448c, -0x6_58e3);           /* call 0x100f448c */
            ii(0x1015_9d6f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_9d72, 4); cmp(memb[ds, eax + 0x3d], 0x8);         /* cmp byte [eax+0x3d], 0x8 */
            ii(0x1015_9d76, 2); if(jnz(0x1015_9d84, 0xc)) goto l_0x1015_9d84; /* jnz 0x10159d84 */
            ii(0x1015_9d78, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x1015_9d84:
            ...
            ii(0x1015_9d89, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_9d8c, 5); call(0x1014_48cc, -0x1_54c5);           /* call 0x101448cc */
            ii(0x1015_9d91, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
