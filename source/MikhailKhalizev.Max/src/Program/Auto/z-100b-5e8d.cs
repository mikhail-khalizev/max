...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_5e8d()
        {
            ...
            ii(0x100b_5ea4, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_5ea7, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100b_5eaa, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_5ead, 3); mov(eax, memd[ds, eax + 0x50]);         /* mov eax, [eax+0x50] */
            ii(0x100b_5eb0, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100b_5eb3, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100b_5eb5, 2); if(jnz(0x100b_5ebd, 0x6)) goto l_0x100b_5ebd; /* jnz 0x100b5ebd */
            ii(0x100b_5eb7, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x100b_5ebb, 2); jmp(0x100b_5ec1, 0x4); goto l_0x100b_5ec1; /* jmp 0x100b5ec1 */
        l_0x100b_5ebd:
            ii(0x100b_5ebd, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
        l_0x100b_5ec1:
            ii(0x100b_5ec1, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
            ii(0x100b_5ec4, 3); mov(memb[ss, ebp - 0x10], al);          /* mov [ebp-0x10], al */
            ii(0x100b_5ec7, 3); mov(al, memb[ss, ebp - 0x10]);          /* mov al, [ebp-0x10] */
