...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_1db8()
        {
            ...
            ii(0x1018_1dc2, 4);  lea(eax, memd[ss, esp + 4]);          /* lea eax, [esp+0x4] */
            ii(0x1018_1dc6, 5);  call(/* sys */ 0x1019_5c56, 0x1_3e8b);/* call 0x10195c56 */
            ii(0x1018_1dcb, 3);  mov(eax, memd[ss, esp]);              /* mov eax, [esp] */
            ii(0x1018_1dce, 4);  mov(memd[ss, esp + 13], eax);         /* mov [esp+0xd], eax */
            ii(0x1018_1dd2, 2);  test(ebx, ebx);                       /* test ebx, ebx */
            ii(0x1018_1dd4, 2);  if(jz(0x1018_1ddf, 9)) goto l_0x1018_1ddf;/* jz 0x10181ddf */
            ii(0x1018_1dd6, 4);  lea(eax, memd[ss, esp + 4]);          /* lea eax, [esp+0x4] */
            ii(0x1018_1dda, 5);  call(/* sys */ 0x1019_5c77, 0x1_3e98);/* call 0x10195c77 */
        l_0x1018_1ddf:
            ii(0x1018_1ddf, 4);  lea(eax, memd[ss, esp + 4]);          /* lea eax, [esp+0x4] */
            ii(0x1018_1de3, 3);  mov(ebp, memd[ds, edi + 4]);          /* mov ebp, [edi+0x4] */
            ii(0x1018_1de6, 5);  call(/* sys */ 0x1018_1d24, -0xc7);   /* call 0x10181d24 */
            ii(0x1018_1deb, 4);  mov(memd[ss, esp + 20], eax);         /* mov [esp+0x14], eax */
        ...
        l_0x1018_1df6:
            ii(0x1018_1df6, 3);  mov(eax, memd[ss, ebp]);              /* mov eax, [ebp] */
            ...
            ii(0x1018_1e04, 3);  call_abs(memd[ds, ecx + 4]);          /* call dword [ecx+0x4] */
            ii(0x1018_1e07, 3);  mov(ebx, memd[ds, esi + 10]);         /* mov ebx, [esi+0xa] */
            ii(0x1018_1e0a, 3);  mov(edx, memd[ds, esi + 6]);          /* mov edx, [esi+0x6] */
            ii(0x1018_1e0d, 3);  add(eax, memd[ds, esi + 2]);          /* add eax, [esi+0x2] */
        l_0x1018_1e10:
        ...
        l_0x1018_1e1c:
            ii(0x1018_1e1c, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
        ...
        l_0x1018_1e40:
            ii(0x1018_1e40, 3);  mov(eax, memd[ds, esi + 2]);          /* mov eax, [esi+0x2] */
            ii(0x1018_1e43, 4);  mov(ebx, memd[ds, edi + eax + 4]);    /* mov ebx, [edi+eax+0x4] */
            ii(0x1018_1e47, 4);  mov(edx, memd[ds, edi + eax + 8]);    /* mov edx, [edi+eax+0x8] */
        ...
        l_0x1018_1e50:
            ii(0x1018_1e50, 3);  mov(eax, memd[ds, esi + 2]);          /* mov eax, [esi+0x2] */
        l_0x1018_1e53:
            ii(0x1018_1e53, 3);  mov(eax, memd[ds, edi + eax]);        /* mov eax, [edi+eax] */
            ii(0x1018_1e56, 3);  call_abs(memd[ds, esi + 6]);          /* call dword [esi+0x6] */
        l_0x1018_1e59:
            ii(0x1018_1e59, 4);  mov(eax, memd[ss, esp + 8]);          /* mov eax, [esp+0x8] */
            ii(0x1018_1e5d, 3);  cmp(eax, memd[ss, esp]);              /* cmp eax, [esp] */
            ii(0x1018_1e60, 6);  if(jz(0x1018_1edd, 0x77)) goto l_0x1018_1edd;/* jz 0x10181edd */
            ii(0x1018_1e66, 2);  if(jae(0x1018_1e6d, 5)) goto l_0x1018_1e6d;/* jae 0x10181e6d */
            ii(0x1018_1e68, 5);  call(/* sys */ 0x1019_5dab, 0x1_3f3e);/* call 0x10195dab */
        l_0x1018_1e6d:
            ii(0x1018_1e6d, 4);  lea(eax, memd[ss, esp + 4]);          /* lea eax, [esp+0x4] */
            ii(0x1018_1e71, 4);  mov(ebx, memd[ss, esp + 8]);          /* mov ebx, [esp+0x8] */
            ii(0x1018_1e75, 5);  call(/* sys */ 0x1019_5c7c, 0x1_3e02);/* call 0x10195c7c */
            ii(0x1018_1e7a, 4);  lea(eax, memd[ss, esp + 4]);          /* lea eax, [esp+0x4] */
            ii(0x1018_1e7e, 4);  mov(edx, memd[ss, esp + 20]);         /* mov edx, [esp+0x14] */
            ii(0x1018_1e82, 5);  call(/* sys */ 0x1018_1d24, -0x163);  /* call 0x10181d24 */
            ii(0x1018_1e87, 4);  mov(memd[ss, esp + 20], eax);         /* mov [esp+0x14], eax */
            ii(0x1018_1e8b, 4);  mov(eax, memd[ss, esp + 8]);          /* mov eax, [esp+0x8] */
            ii(0x1018_1e8f, 3);  mov(memd[ds, edi + 8], eax);          /* mov [edi+0x8], eax */
            ii(0x1018_1e92, 2);  mov(eax, memd[ds, edx]);              /* mov eax, [edx] */
            ii(0x1018_1e94, 4);  mov(memd[ss, esp + 24], eax);         /* mov [esp+0x18], eax */
        ...
        l_0x1018_1e9e:
            ii(0x1018_1e9e, 3);  mov(eax, memd[ds, esi + 2]);          /* mov eax, [esi+0x2] */
            ii(0x1018_1ea1, 3);  mov(edx, memd[ds, esi + 10]);         /* mov edx, [esi+0xa] */
            ii(0x1018_1ea4, 2);  jmp(0x1018_1e53, -0x53); goto l_0x1018_1e53;/* jmp 0x10181e53 */
        l_0x1018_1ea6:
            ii(0x1018_1ea6, 3);  mov(esi, memd[ds, edx + 4]);          /* mov esi, [edx+0x4] */
            ...
            ii(0x1018_1eb9, 8);  /* jmp dword [cs:eax*4+0x10181d88] */
        ...
        l_0x1018_1ec1:
            ii(0x1018_1ec1, 3);  mov(esi, memd[ss, ebp]);              /* mov esi, [ebp] */
            ...
            ii(0x1018_1ecf, 3);  call_abs(memd[ds, esi + 4]);          /* call dword [esi+0x4] */
            ii(0x1018_1ed2, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1018_1ed4, 4);  call_abs(memd[ss, esp + 24]);         /* call dword [esp+0x18] */
            ii(0x1018_1ed8, 5);  jmp(0x1018_1e59, -0x84); goto l_0x1018_1e59;/* jmp 0x10181e59 */
        l_0x1018_1edd:
            ii(0x1018_1edd, 3);  mov(memd[ds, edi + 8], eax);          /* mov [edi+0x8], eax */
