...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x19_9e8b, 4); enter(0x8, 0);                            /* enter 0x8, 0x0 */
            ...
            ii(0x19_9e9c, 4); push(memw[es, bx + 0x32]);                /* push word [es:bx+0x32] */
            ii(0x19_9ea0, 4); push(memw[es, bx + 0x36]);                /* push word [es:bx+0x36] */
            ii(0x19_9ea4, 4); push(memw[es, bx + 0x34]);                /* push word [es:bx+0x34] */
            ii(0x19_9ea8, 5); call_far_abs(0x80, 0x56e0);               /* call word 0x80:0x56e0 */
            ii(0x19_9ead, 3); add(sp, 0x6);                             /* add sp, 0x6 */
            ii(0x19_9eb0, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_9eb3, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x19_9eb6, 2); or(dx, ax);                               /* or dx, ax */
            ii(0x19_9eb8, 2); if(jz(0x19_9ecd, 0x13)) goto l_0x19_9ecd; /* jz 0x9ecd */
            ii(0x19_9eba, 3); les(bx, memw[ss, bp - 0x4]);              /* les bx, [bp-0x4] */
            ii(0x19_9ebd, 3); mov(si, memw[ss, bp + 0x4]);              /* mov si, [bp+0x4] */
        ...
        l_0x19_9ecd:
            ...
            ii(0x19_9ecf, 3); ret(0x2);                                 /* ret 0x2 */
        }
    }
}
