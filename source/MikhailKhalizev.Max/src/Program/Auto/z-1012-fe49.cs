...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_fe49()
        {
            ...
            ii(0x1012_fe61, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1012_fe64, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_fe67, 3);  mov(ebx, memd[ds, eax + 56]);         /* mov ebx, [eax+0x38] */
            ii(0x1012_fe6a, 3);  sar(ebx, 0x10);                       /* sar ebx, 0x10 */
            ii(0x1012_fe6d, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_fe70, 6);  mov(eax, memd[ds, eax + 222]);        /* mov eax, [eax+0xde] */
            ...
            ii(0x1012_fe85, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1012_fe88, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_fe8b, 6);  mov(eax, memd[ds, eax + 222]);        /* mov eax, [eax+0xde] */
            ii(0x1012_fe91, 5);  call(0x100d_4ef0, -0x5_afa6);         /* call 0x100d4ef0 */
            ii(0x1012_fe96, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1012_fe99, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1012_fea5, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1012_fea8, 3);  mov(ecx, memd[ds, edx + 56]);         /* mov ecx, [edx+0x38] */
            ii(0x1012_feab, 3);  sar(ecx, 0x10);                       /* sar ecx, 0x10 */
            ii(0x1012_feae, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1012_feb1, 3);  mov(ebx, memd[ds, edx + 46]);         /* mov ebx, [edx+0x2e] */
            ...
            ii(0x1012_fec2, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1012_fec5, 3);  lea(edx, memd[ss, ebp - 52]);         /* lea edx, [ebp-0x34] */
            ii(0x1012_fec8, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_fecb, 5);  call(0x100d_6a11, -0x5_94bf);         /* call 0x100d6a11 */
            ii(0x1012_fed0, 4);  movsx(edx, memw[ss, ebp - 24]);       /* movsx edx, word [ebp-0x18] */
            ...
            ii(0x1012_fede, 2);  sar(eax, 1);                          /* sar eax, 1 */
            ii(0x1012_fee0, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1012_fee2, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_fee5, 6);  mov(eax, memd[ds, eax + 222]);        /* mov eax, [eax+0xde] */
            ...
            ii(0x1012_fef3, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_fef6, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_fef9, 4);  mov(ax, memw[ds, eax + 48]);          /* mov ax, [eax+0x30] */
            ii(0x1012_fefd, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1012_ff00, 2);  jmp(0x1012_ff08, 6); goto l_0x1012_ff08;/* jmp 0x1012ff08 */
        l_0x1012_ff02:
            ii(0x1012_ff02, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1012_ff05, 3);  inc(memd[ss, ebp - 20]);              /* inc dword [ebp-0x14] */
        l_0x1012_ff08:
            ii(0x1012_ff08, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1012_ff0b, 4);  cmp(ax, memw[ss, ebp - 12]);          /* cmp ax, [ebp-0xc] */
            ii(0x1012_ff0f, 6);  if(jge(0x1013_01b0, 0x29b)) goto l_0x1013_01b0;/* jge 0x101301b0 */
            ii(0x1012_ff15, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_ff18, 5);  add(eax, 0x19);                       /* add eax, 0x19 */
            ii(0x1012_ff1d, 1);  cwde();                               /* cwde */
            ii(0x1012_ff1e, 1);  push(eax);                            /* push eax */
            ii(0x1012_ff1f, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x1012_ff33, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ii(0x1012_ff37, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_ff3a, 3);  add(eax, 0x18);                       /* add eax, 0x18 */
            ii(0x1012_ff3d, 5);  call(0x100e_8634, -0x4_790e);         /* call 0x100e8634 */
            ii(0x1012_ff42, 3);  mov(ebx, memd[ds, eax + 6]);          /* mov ebx, [eax+0x6] */
            ii(0x1012_ff45, 3);  sar(ebx, 0x10);                       /* sar ebx, 0x10 */
            ii(0x1012_ff48, 4);  movsx(edx, memw[ss, ebp - 36]);       /* movsx edx, word [ebp-0x24] */
            ii(0x1012_ff4c, 3);  mov(eax, memd[ss, ebp - 30]);         /* mov eax, [ebp-0x1e] */
            ii(0x1012_ff4f, 5);  call(0x1012_b6af, -0x48a5);           /* call 0x1012b6af */
            ii(0x1012_ff54, 3);  lea(ecx, memd[ss, ebp - 104]);        /* lea ecx, [ebp-0x68] */
            ii(0x1012_ff57, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ii(0x1012_ff5b, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1012_ff6d, 5);  mov(eax, 5);                          /* mov eax, 0x5 */
            ...
            ii(0x1012_ff96, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1012_ff9a, 1);  push(eax);                            /* push eax */
            ii(0x1012_ff9b, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1012_ff9e, 5);  add(eax, 0x23);                       /* add eax, 0x23 */
            ii(0x1012_ffa3, 3);  movsx(ecx, ax);                       /* movsx ecx, ax */
            ii(0x1012_ffa6, 3);  lea(ebx, memd[ss, ebp - 104]);        /* lea ebx, [ebp-0x68] */
            ii(0x1012_ffa9, 4);  movsx(edx, memw[ss, ebp - 36]);       /* movsx edx, word [ebp-0x24] */
            ii(0x1012_ffad, 3);  mov(eax, memd[ss, ebp - 30]);         /* mov eax, [ebp-0x1e] */
            ii(0x1012_ffb0, 5);  call(0x100e_9ae5, -0x4_64d0);         /* call 0x100e9ae5 */
            ii(0x1012_ffb5, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1012_ffb9, 3);  add(eax, 0x75);                       /* add eax, 0x75 */
            ii(0x1012_ffbc, 3);  mov(memd[ss, ebp - 120], eax);        /* mov [ebp-0x78], eax */
            ii(0x1012_ffbf, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1012_ffc3, 3);  mov(memd[ss, ebp - 116], eax);        /* mov [ebp-0x74], eax */
            ii(0x1012_ffc6, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1012_ffca, 5);  add(eax, 0x104);                      /* add eax, 0x104 */
            ii(0x1012_ffcf, 3);  mov(memd[ss, ebp - 112], eax);        /* mov [ebp-0x70], eax */
            ii(0x1012_ffd2, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1012_ffd6, 3);  add(eax, 0x32);                       /* add eax, 0x32 */
            ii(0x1012_ffd9, 3);  mov(memd[ss, ebp - 108], eax);        /* mov [ebp-0x6c], eax */
            ii(0x1012_ffdc, 3);  lea(ebx, memd[ss, ebp - 120]);        /* lea ebx, [ebp-0x78] */
            ii(0x1012_ffdf, 3);  mov(ecx, memd[ss, ebp - 34]);         /* mov ecx, [ebp-0x22] */
            ii(0x1012_ffe2, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ii(0x1012_ffe6, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1012_fff8, 5);  mov(eax, 5);                          /* mov eax, 0x5 */
            ...
            ii(0x1013_000d, 5);  mov(eax, 1);                          /* mov eax, 0x1 */
            ...
            ii(0x1013_0024, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1013_0028, 1);  push(eax);                            /* push eax */
            ii(0x1013_0029, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1013_002c, 5);  add(eax, 0x109);                      /* add eax, 0x109 */
            ii(0x1013_0031, 3);  movsx(ecx, ax);                       /* movsx ecx, ax */
            ii(0x1013_0034, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ii(0x1013_0038, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_003b, 3);  add(eax, 0x18);                       /* add eax, 0x18 */
            ii(0x1013_003e, 5);  call(0x100e_8634, -0x4_7a0f);         /* call 0x100e8634 */
            ii(0x1013_0043, 3);  mov(eax, memd[ds, eax + 26]);         /* mov eax, [eax+0x1a] */
            ii(0x1013_0046, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x1013_0049, 1);  inc(eax);                             /* inc eax */
            ii(0x1013_004a, 1);  push(eax);                            /* push eax */
            ii(0x1013_004b, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ii(0x1013_004f, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_0052, 3);  add(eax, 0x18);                       /* add eax, 0x18 */
            ii(0x1013_0055, 5);  call(0x100e_8634, -0x4_7a26);         /* call 0x100e8634 */
            ii(0x1013_005a, 3);  mov(eax, memd[ds, eax + 24]);         /* mov eax, [eax+0x18] */
            ...
            ii(0x1013_006e, 3);  lea(eax, memd[ss, ebp - 124]);        /* lea eax, [ebp-0x7c] */
            ...
            ii(0x1013_0084, 4);  movsx(edx, memw[ss, ebp - 36]);       /* movsx edx, word [ebp-0x24] */
            ii(0x1013_0088, 3);  mov(esi, memd[ss, ebp - 30]);         /* mov esi, [ebp-0x1e] */
            ...
            ii(0x1013_0096, 3);  lea(eax, memd[ss, ebp - 124]);        /* lea eax, [ebp-0x7c] */
            ...
            ii(0x1013_00a4, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_00a7, 6);  mov(eax, memd[ds, eax + 222]);        /* mov eax, [eax+0xde] */
            ...
            ii(0x1013_00ba, 4);  movsx(ecx, memw[ss, ebp - 8]);        /* movsx ecx, word [ebp-0x8] */
            ii(0x1013_00be, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1013_00c1, 5);  add(eax, 0x136);                      /* add eax, 0x136 */
            ii(0x1013_00c6, 3);  movsx(ebx, ax);                       /* movsx ebx, ax */
            ii(0x1013_00c9, 3);  lea(esi, memd[ss, ebp - 52]);         /* lea esi, [ebp-0x34] */
            ii(0x1013_00cc, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ii(0x1013_00d0, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1013_00e7, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ii(0x1013_00eb, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1013_010f, 3);  mov(memd[ss, ebp - 128], eax);        /* mov [ebp-0x80], eax */
            ii(0x1013_0112, 3);  push(memd[ss, ebp - 128]);            /* push dword [ebp-0x80] */
            ii(0x1013_0115, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ii(0x1013_0119, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_011c, 3);  add(eax, 0x18);                       /* add eax, 0x18 */
            ii(0x1013_011f, 5);  call(0x100e_8634, -0x4_7af0);         /* call 0x100e8634 */
            ii(0x1013_0124, 3);  mov(eax, memd[ds, eax + 18]);         /* mov eax, [eax+0x12] */
            ii(0x1013_0127, 3);  and(eax, 0x10);                       /* and eax, 0x10 */
            ii(0x1013_012a, 6);  mov(memd[ss, ebp - 132], eax);        /* mov [ebp-0x84], eax */
            ii(0x1013_0130, 6);  push(memd[ss, ebp - 132]);            /* push dword [ebp-0x84] */
            ii(0x1013_0136, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ii(0x1013_013a, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_013d, 3);  add(eax, 0x18);                       /* add eax, 0x18 */
            ii(0x1013_0140, 5);  call(0x100e_8634, -0x4_7b11);         /* call 0x100e8634 */
            ii(0x1013_0145, 4);  test(memb[ds, eax + 18], 0x10);       /* test byte [eax+0x12], 0x10 */
            ii(0x1013_0149, 2);  if(jz(0x1013_0157, 0xc)) goto l_0x1013_0157;/* jz 0x10130157 */
            ii(0x1013_014b, 10);  mov(memd[ss, ebp - 136], 0x4_0000);  /* mov dword [ebp-0x88], 0x40000 */
            ii(0x1013_0155, 2);  jmp(0x1013_0161, 0xa); goto l_0x1013_0161;/* jmp 0x10130161 */
        l_0x1013_0157:
            ii(0x1013_0157, 10);  mov(memd[ss, ebp - 136], 0x2_0000);  /* mov dword [ebp-0x88], 0x20000 */
        l_0x1013_0161:
            ii(0x1013_0161, 6);  push(memd[ss, ebp - 136]);            /* push dword [ebp-0x88] */
            ii(0x1013_0167, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_016a, 5);  add(eax, 0x29);                       /* add eax, 0x29 */
            ii(0x1013_016f, 1);  cwde();                               /* cwde */
            ii(0x1013_0170, 1);  push(eax);                            /* push eax */
            ii(0x1013_0171, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1013_0174, 5);  add(eax, 0x20);                       /* add eax, 0x20 */
            ii(0x1013_0179, 1);  cwde();                               /* cwde */
            ii(0x1013_017a, 1);  push(eax);                            /* push eax */
            ii(0x1013_017b, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_017e, 5);  add(eax, 9);                          /* add eax, 0x9 */
            ii(0x1013_0183, 1);  cwde();                               /* cwde */
            ii(0x1013_0184, 1);  push(eax);                            /* push eax */
            ii(0x1013_0185, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1013_0189, 1);  push(eax);                            /* push eax */
            ii(0x1013_018a, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_018d, 5);  add(eax, 9);                          /* add eax, 0x9 */
            ii(0x1013_0192, 3);  movsx(ecx, ax);                       /* movsx ecx, ax */
            ii(0x1013_0195, 4);  movsx(ebx, memw[ss, ebp - 16]);       /* movsx ebx, word [ebp-0x10] */
            ii(0x1013_0199, 4);  movsx(edx, memw[ss, ebp - 36]);       /* movsx edx, word [ebp-0x24] */
            ii(0x1013_019d, 3);  mov(eax, memd[ss, ebp - 30]);         /* mov eax, [ebp-0x1e] */
            ii(0x1013_01a0, 5);  call(0x1010_2273, -0x2_df32);         /* call 0x10102273 */
        l_0x1013_01a5:
            ii(0x1013_01a5, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x1013_01a8, 3);  add(memd[ss, ebp - 8], eax);          /* add [ebp-0x8], eax */
        ...
        l_0x1013_01b0:
            ...
            ii(0x1013_01ba, 6);  mov(memd[ss, ebp - 140], eax);        /* mov [ebp-0x8c], eax */
            ii(0x1013_01c0, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_01c3, 3);  mov(eax, memd[ds, eax + 46]);         /* mov eax, [eax+0x2e] */
            ii(0x1013_01c6, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x1013_01c9, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x1013_01cb, 2);  if(jle(0x1013_01d6, 9)) goto l_0x1013_01d6;/* jle 0x101301d6 */
            ii(0x1013_01cd, 7);  mov(memb[ss, ebp - 144], 1);          /* mov byte [ebp-0x90], 0x1 */
            ii(0x1013_01d4, 2);  jmp(0x1013_01dd, 7); goto l_0x1013_01dd;/* jmp 0x101301dd */
        l_0x1013_01d6:
            ii(0x1013_01d6, 7);  mov(memb[ss, ebp - 144], 0);          /* mov byte [ebp-0x90], 0x0 */
        l_0x1013_01dd:
            ii(0x1013_01dd, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1013_01df, 6);  mov(dl, memb[ss, ebp - 144]);         /* mov dl, [ebp-0x90] */
            ii(0x1013_01e5, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_01e8, 6);  mov(eax, memd[ds, eax + 206]);        /* mov eax, [eax+0xce] */
            ii(0x1013_01ee, 6);  mov(ebx, memd[ss, ebp - 140]);        /* mov ebx, [ebp-0x8c] */
            ...
            ii(0x1013_0203, 6);  mov(memd[ss, ebp - 148], eax);        /* mov [ebp-0x94], eax */
            ii(0x1013_0209, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_020c, 3);  mov(edx, memd[ds, eax + 46]);         /* mov edx, [eax+0x2e] */
            ii(0x1013_020f, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x1013_0212, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_0215, 3);  mov(eax, memd[ds, eax + 56]);         /* mov eax, [eax+0x38] */
            ii(0x1013_0218, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x1013_021b, 2);  add(edx, eax);                        /* add edx, eax */
            ii(0x1013_021d, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1013_022b, 2);  if(jge(0x1013_0236, 9)) goto l_0x1013_0236;/* jge 0x10130236 */
            ii(0x1013_022d, 7);  mov(memb[ss, ebp - 152], 1);          /* mov byte [ebp-0x98], 0x1 */
            ii(0x1013_0234, 2);  jmp(0x1013_023d, 7); goto l_0x1013_023d;/* jmp 0x1013023d */
        l_0x1013_0236:
            ii(0x1013_0236, 7);  mov(memb[ss, ebp - 152], 0);          /* mov byte [ebp-0x98], 0x0 */
        l_0x1013_023d:
            ii(0x1013_023d, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1013_023f, 6);  mov(dl, memb[ss, ebp - 152]);         /* mov dl, [ebp-0x98] */
            ii(0x1013_0245, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_0248, 6);  mov(eax, memd[ds, eax + 210]);        /* mov eax, [eax+0xd2] */
            ii(0x1013_024e, 6);  mov(ebx, memd[ss, ebp - 148]);        /* mov ebx, [ebp-0x94] */
