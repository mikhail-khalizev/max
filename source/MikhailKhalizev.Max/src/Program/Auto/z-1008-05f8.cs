...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_05f8()
        {
            ...
            ii(0x1008_0610, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_0613, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_0623, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_0626, 5); call(0x1007_f659, -0xfd2);              /* call 0x1007f659 */
            ii(0x1008_062b, 2); jmp(0x1008_0635, 0x8); goto l_0x1008_0635; /* jmp 0x10080635 */
        l_0x1008_062d:
            ii(0x1008_062d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
