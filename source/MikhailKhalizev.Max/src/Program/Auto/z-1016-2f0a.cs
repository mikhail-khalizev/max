...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_2f0a()
        {
            ...
            ii(0x1016_2f21, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1016_2f24, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x1016_2f27, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_2f2a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1016_2f2c, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ...
            ii(0x1016_2f44, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1016_2f47, 4); cmp(memb[ss, ebp - 0x4], 0x20);         /* cmp byte [ebp-0x4], 0x20 */
            ii(0x1016_2f4b, 2); if(jnz(0x1016_2f53, 0x6)) goto l_0x1016_2f53; /* jnz 0x10162f53 */
            ii(0x1016_2f4d, 4); mov(memb[ss, ebp - 0x10], 0xa);         /* mov byte [ebp-0x10], 0xa */
            ii(0x1016_2f51, 2); jmp(0x1016_2f57, 0x4); goto l_0x1016_2f57; /* jmp 0x10162f57 */
        l_0x1016_2f53:
            ii(0x1016_2f53, 4); mov(memb[ss, ebp - 0x10], 0x9);         /* mov byte [ebp-0x10], 0x9 */
        l_0x1016_2f57:
            ii(0x1016_2f57, 3); mov(ebx, memd[ss, ebp - 0x13]);         /* mov ebx, [ebp-0x13] */
            ii(0x1016_2f5a, 3); sar(ebx, 0x18);                         /* sar ebx, 0x18 */
            ii(0x1016_2f5d, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1016_2f60, 5); mov(eax, 0x101c_7278);                  /* mov eax, 0x101c7278 */
            ii(0x1016_2f65, 3); mov(ecx, memd[ss, ebp - 0xc]);          /* mov ecx, [ebp-0xc] */
            ii(0x1016_2f68, 5); call(0x1013_d5c0, -0x2_59ad);           /* call 0x1013d5c0 */
        l_0x1016_2f6d:
            ii(0x1016_2f6d, 4); movsx(ebx, memb[ss, ebp - 0x4]);        /* movsx ebx, byte [ebp-0x4] */
            ii(0x1016_2f71, 5); mov(edx, 0x16);                         /* mov edx, 0x16 */
            ii(0x1016_2f76, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_2f79, 5); call(0x1016_2f96, 0x18);                /* call 0x10162f96 */
            ii(0x1016_2f7e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_2f81, 5); call(0x1014_9cd1, -0x1_92b5);           /* call 0x10149cd1 */
            ii(0x1016_2f86, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
