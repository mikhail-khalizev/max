...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_a68c()
        {
            ...
            ii(0x1016_a68f, 3);  sub(esp, 4);                          /* sub esp, 0x4 */
            ...
            ii(0x1016_a69b, 4);  mov(edx, memd[ss, esp + 28]);         /* mov edx, [esp+0x1c] */
            ii(0x1016_a69f, 1);  push(edx);                            /* push edx */
            ii(0x1016_a6a0, 1);  push(ecx);                            /* push ecx */
            ii(0x1016_a6a1, 4);  mov(ebx, memd[ss, esp + 28]);         /* mov ebx, [esp+0x1c] */
            ii(0x1016_a6a5, 1);  push(ebx);                            /* push ebx */
            ii(0x1016_a6a6, 2);  mov(edx, edi);                        /* mov edx, edi */
            ii(0x1016_a6a8, 4);  mov(ebx, memd[ss, esp + 12]);         /* mov ebx, [esp+0xc] */
            ii(0x1016_a6ac, 5);  call(/* sys */ 0x1016_a5a0, -0x111);  /* call 0x1016a5a0 */
            ii(0x1016_a6b1, 4);  mov(ecx, memd[ss, esp + 28]);         /* mov ecx, [esp+0x1c] */
            ii(0x1016_a6b5, 1);  push(ecx);                            /* push ecx */
            ii(0x1016_a6b6, 4);  mov(eax, memd[ss, esp + 28]);         /* mov eax, [esp+0x1c] */
            ii(0x1016_a6ba, 4);  mov(edx, memd[ss, esp + 24]);         /* mov edx, [esp+0x18] */
            ii(0x1016_a6be, 1);  push(eax);                            /* push eax */
            ii(0x1016_a6bf, 4);  mov(ebx, memd[ss, esp + 8]);          /* mov ebx, [esp+0x8] */
            ...
            ii(0x1016_a6cf, 4);  mov(ebx, memd[ss, esp + 28]);         /* mov ebx, [esp+0x1c] */
            ii(0x1016_a6d3, 1);  push(ebx);                            /* push ebx */
            ii(0x1016_a6d4, 4);  mov(ecx, memd[ss, esp + 28]);         /* mov ecx, [esp+0x1c] */
            ii(0x1016_a6d8, 4);  mov(eax, memd[ss, esp + 4]);          /* mov eax, [esp+0x4] */
            ...
            ii(0x1016_a6eb, 4);  mov(edx, memd[ss, esp + 28]);         /* mov edx, [esp+0x1c] */
            ii(0x1016_a6ef, 1);  push(edx);                            /* push edx */
            ii(0x1016_a6f0, 4);  mov(ebx, memd[ss, esp + 28]);         /* mov ebx, [esp+0x1c] */
            ii(0x1016_a6f4, 4);  mov(ecx, memd[ss, esp + 24]);         /* mov ecx, [esp+0x18] */
