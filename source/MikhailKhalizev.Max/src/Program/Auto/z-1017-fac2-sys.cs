...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_fac2()
        {
            ...
            ii(0x1017_face, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1017_fad1, 3); mov(memd[ss, ebp - 0x18], edx);         /* mov [ebp-0x18], edx */
            ii(0x1017_fad4, 3); mov(memd[ss, ebp - 0x20], ebx);         /* mov [ebp-0x20], ebx */
            ...
            ii(0x1017_fae6, 3); lea(ebx, memd[ss, ebp - 0x14]);         /* lea ebx, [ebp-0x14] */
            ii(0x1017_fae9, 3); lea(edx, memd[ss, ebp - 0x10]);         /* lea edx, [ebp-0x10] */
            ii(0x1017_faec, 3); lea(eax, memd[ss, ebp - 0x28]);         /* lea eax, [ebp-0x28] */
            ...
            ii(0x1017_faf8, 6); mov(memw[ss, ebp - 0x2c], 0);           /* mov word [ebp-0x2c], 0x0 */
            ii(0x1017_fafe, 7); mov(memd[ss, ebp - 0x30], 0);           /* mov dword [ebp-0x30], 0x0 */
            ii(0x1017_fb05, 5); jmp(0x1017_fb90, 0x86); goto l_0x1017_fb90; /* jmp 0x1017fb90 */
        l_0x1017_fb0a:
            ii(0x1017_fb0a, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1017_fb0d, 3); mov(edx, memd[ss, ebp - 0x18]);         /* mov edx, [ebp-0x18] */
            ii(0x1017_fb10, 2); mov(memd[ds, edx], eax);                /* mov [edx], eax */
            ii(0x1017_fb12, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1017_fb15, 3); mov(edx, memd[ss, ebp - 0x20]);         /* mov edx, [ebp-0x20] */
            ii(0x1017_fb18, 2); mov(memd[ds, edx], eax);                /* mov [edx], eax */
            ii(0x1017_fb1a, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x1017_fb1d, 4); mov(memw[ss, ebp - 0x2c], ax);          /* mov [ebp-0x2c], ax */
            ii(0x1017_fb21, 3); mov(eax, memd[ss, ebp - 0x28]);         /* mov eax, [ebp-0x28] */
            ii(0x1017_fb24, 3); mov(memd[ss, ebp - 0x30], eax);         /* mov [ebp-0x30], eax */
            ii(0x1017_fb27, 2); jmp(0x1017_fb90, 0x67); goto l_0x1017_fb90; /* jmp 0x1017fb90 */
        l_0x1017_fb29:
            ii(0x1017_fb29, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1017_fb2c, 1); push(eax);                              /* push eax */
            ii(0x1017_fb2d, 3); lea(eax, memd[ss, ebp - 0x4]);          /* lea eax, [ebp-0x4] */
            ii(0x1017_fb30, 1); push(eax);                              /* push eax */
            ii(0x1017_fb31, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ...
            ii(0x1017_fb43, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1017_fb46, 3); mov(edx, memd[ss, ebp - 0x18]);         /* mov edx, [ebp-0x18] */
            ii(0x1017_fb49, 2); mov(memd[ds, edx], eax);                /* mov [edx], eax */
        l_0x1017_fb4b:
            ii(0x1017_fb4b, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1017_fb4e, 6); and(edx, 0xffff);                       /* and edx, 0xffff */
            ii(0x1017_fb54, 5); mov(eax, 0xffff);                       /* mov eax, 0xffff */
            ii(0x1017_fb59, 3); sub(eax, memd[ss, ebp - 0x1c]);         /* sub eax, [ebp-0x1c] */
            ii(0x1017_fb5c, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x1017_fb5e, 2); if(jbe(0x1017_fb84, 0x24)) goto l_0x1017_fb84; /* jbe 0x1017fb84 */
            ii(0x1017_fb60, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1017_fb63, 1); push(eax);                              /* push eax */
            ii(0x1017_fb64, 3); lea(eax, memd[ss, ebp - 0x4]);          /* lea eax, [ebp-0x4] */
            ii(0x1017_fb67, 1); push(eax);                              /* push eax */
            ii(0x1017_fb68, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ...
            ii(0x1017_fb7a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1017_fb7d, 3); mov(edx, memd[ss, ebp - 0x18]);         /* mov edx, [ebp-0x18] */
        ...
        l_0x1017_fb84:
            ...
            ii(0x1017_fb86, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1017_fb89, 4); mov(memw[ss, ebp - 0x2c], ax);          /* mov [ebp-0x2c], ax */
            ii(0x1017_fb8d, 3); mov(memd[ss, ebp - 0x30], edx);         /* mov [ebp-0x30], edx */
        l_0x1017_fb90:
            ii(0x1017_fb90, 3); mov(edx, memd[ss, ebp - 0x2c]);         /* mov edx, [ebp-0x2c] */
            ii(0x1017_fb93, 3); mov(eax, memd[ss, ebp - 0x30]);         /* mov eax, [ebp-0x30] */
