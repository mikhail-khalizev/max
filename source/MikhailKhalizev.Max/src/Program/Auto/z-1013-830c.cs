...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_830c()
        {
            ...
            ii(0x1013_8321, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1013_8324, 3); mov(memd[ss, ebp - 12], edx);           /* mov [ebp-0xc], edx */
            ii(0x1013_8327, 3); mov(memd[ss, ebp - 8], ebx);            /* mov [ebp-0x8], ebx */
            ii(0x1013_832a, 3); mov(memb[ss, ebp - 4], cl);             /* mov [ebp-0x4], cl */
            ii(0x1013_832d, 5); mov(eax, 0x4ff);                        /* mov eax, 0x4ff */
            ii(0x1013_8332, 5); call(0x1013_82da, -0x5d);               /* call 0x101382da */
            ii(0x1013_8337, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
        ...
        l_0x1013_8363:
            ...
            ii(0x1013_83ab, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_83ae, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x1013_83b1, 3); imul(eax, eax, 0x53);                   /* imul eax, eax, 0x53 */
            ii(0x1013_83b4, 3); add(eax, memd[ss, ebp - 16]);           /* add eax, [ebp-0x10] */
            ii(0x1013_83b7, 3); mov(eax, memd[ds, eax + 79]);           /* mov eax, [eax+0x4f] */
            ii(0x1013_83ba, 5); call(0x100e_b14d, -0x4_d272);           /* call 0x100eb14d */
        l_0x1013_83bf:
            ii(0x1013_83bf, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_83c2, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x1013_83c5, 3); imul(eax, eax, 0x53);                   /* imul eax, eax, 0x53 */
            ii(0x1013_83c8, 3); add(eax, memd[ss, ebp - 16]);           /* add eax, [ebp-0x10] */
