...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_f659()
        {
            ...
            ii(0x1007_f671, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_f674, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_f681, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x1007_f684, 5);  call(0x1007_64b8, -0x91d1);           /* call 0x100764b8 */
            ii(0x1007_f689, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_f68c, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
            ii(0x1007_f68f, 5);  call(0x1008_b060, 0xb9cc);            /* call 0x1008b060 */
            ii(0x1007_f694, 2);  jmp(0x1007_f69e, 8); goto l_0x1007_f69e;/* jmp 0x1007f69e */
        l_0x1007_f696:
            ii(0x1007_f696, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x1007_f699, 5);  call(0x1007_6bf8, -0x8aa6);           /* call 0x10076bf8 */
        l_0x1007_f69e:
            ii(0x1007_f69e, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_f6a0, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ...
            ii(0x1007_f6ac, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ...
            ii(0x1007_f6c2, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_f6c5, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
        ...
        l_0x1007_f6d4:
            ...
            ii(0x1007_f6f6, 2);  jmp(0x1007_f700, 8); goto l_0x1007_f700;/* jmp 0x1007f700 */
        l_0x1007_f6f8:
            ii(0x1007_f6f8, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x1007_f6fb, 5);  call(0x1007_6bf8, -0x8b08);           /* call 0x10076bf8 */
        l_0x1007_f700:
            ii(0x1007_f700, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_f702, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ...
            ii(0x1007_f70e, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ...
            ii(0x1007_f724, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_f727, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
        ...
        l_0x1007_f736:
            ii(0x1007_f736, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_f739, 3);  add(eax, 0x22);                       /* add eax, 0x22 */
            ii(0x1007_f73c, 5);  call(0x1013_a6f4, 0xb_afb3);          /* call 0x1013a6f4 */
            ii(0x1007_f741, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1007_f750, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
            ii(0x1007_f753, 5);  call(0x1008_8b7c, 0x9424);            /* call 0x10088b7c */
            ii(0x1007_f758, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_f75a, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
