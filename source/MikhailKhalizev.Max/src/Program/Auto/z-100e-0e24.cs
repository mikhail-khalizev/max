...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_0e24()
        {
            ...
            ii(0x100e_0e3a, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100e_0e3d, 3); mov(memb[ss, ebp - 0x8], dl);           /* mov [ebp-0x8], dl */
            ii(0x100e_0e40, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
        l_0x100e_0e43:
            ii(0x100e_0e43, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100e_0e46, 3); mov(al, memb[ds, eax + 0x3d]);          /* mov al, [eax+0x3d] */
            ii(0x100e_0e49, 3); cmp(al, memb[ss, ebp - 0x8]);           /* cmp al, [ebp-0x8] */
            ...
            ii(0x100e_0e59, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
