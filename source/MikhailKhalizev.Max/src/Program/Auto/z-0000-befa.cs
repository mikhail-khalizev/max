...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_befa()
        {
            ...
            ii(0xbf04, 3);    mov(di, memw[ss, bp + 0x6]);              /* mov di, [bp+0x6] */
            ...
            ii(0xbf14, 3);    mov(memw[ss, bp - 0x2], cx);              /* mov [bp-0x2], cx */
            ii(0xbf17, 3);    mov(di, memw[ss, bp + 0x4]);              /* mov di, [bp+0x4] */
            ...
            ii(0xbf28, 3);    sub(dx, memw[ss, bp - 0x2]);              /* sub dx, [bp-0x2] */
            ii(0xbf2b, 2);    if(jbe(0xbf52, 0x25)) goto l_0xbf52;      /* jbe 0xbf52 */
            ii(0xbf2d, 2);    mov(di, bx);                              /* mov di, bx */
        l_0xbf2f:
            ii(0xbf2f, 3);    mov(si, memw[ss, bp + 0x6]);              /* mov si, [bp+0x6] */
            ...
            ii(0xbf3f, 3);    mov(cx, memw[ss, bp - 0x2]);              /* mov cx, [bp-0x2] */
            ii(0xbf42, 2);    if(jcxz(0xbf48, 0x4)) goto l_0xbf48;      /* jcxz 0xbf48 */
            ii(0xbf44, 2);    repe(() => cmpsb());                      /* repe cmpsb */
            ii(0xbf46, 2);    if(jnz(0xbf2f, -0x19)) goto l_0xbf2f;     /* jnz 0xbf2f */
        l_0xbf48:
            ii(0xbf48, 3);    lea(ax, memw[ds, bx - 0x1]);              /* lea ax, [bx-0x1] */
            ii(0xbf4b, 2);    jmp(0xbf54, 0x7); goto l_0xbf54;          /* jmp 0xbf54 */
        l_0xbf4d:
            ii(0xbf4d, 3);    mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
            ii(0xbf50, 2);    jmp(0xbf54, 0x2); goto l_0xbf54;          /* jmp 0xbf54 */
        l_0xbf52:
