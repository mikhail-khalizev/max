...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("d89f25c8-4cc5-4936-9b41-e629d8d80640")]
        public void Method_100f_c072()
        {
            ii(0x100f_c072, 5); pushd(0x28);                            /* push 0x28 */
            ii(0x100f_c077, 5); calld(Definitions.sys_check_available_stack_size, 0x69cd6); /* call 0x10165d52 */
        ...
        l_0x100f_c144:
            ...
            ii(0x100f_c14f, 1); retd(); return;                         /* ret */
        }
    }
}
