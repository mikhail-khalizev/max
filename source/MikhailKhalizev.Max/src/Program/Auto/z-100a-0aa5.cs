...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_0aa5()
        {
            ...
            ii(0x100a_0abe, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100a_0ac1, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x100a_0ac4, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x100a_0ad5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_0ad8, 3); cmp(eax, memd[ss, ebp - 0x10]);         /* cmp eax, [ebp-0x10] */
            ii(0x100a_0adb, 2); if(jle(0x100a_0ae3, 0x6)) goto l_0x100a_0ae3; /* jle 0x100a0ae3 */
            ii(0x100a_0add, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100a_0ae0, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
        l_0x100a_0ae3:
            ii(0x100a_0ae3, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x100a_0af4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_0af7, 3); cmp(eax, memd[ss, ebp - 0x10]);         /* cmp eax, [ebp-0x10] */
            ii(0x100a_0afa, 2); if(jle(0x100a_0b02, 0x6)) goto l_0x100a_0b02; /* jle 0x100a0b02 */
            ii(0x100a_0afc, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100a_0aff, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
        l_0x100a_0b02:
            ii(0x100a_0b02, 4); cmp(memd[ss, ebp - 0x4], 0);            /* cmp dword [ebp-0x4], 0x0 */
            ii(0x100a_0b06, 2); if(jg(0x100a_0b11, 0x9)) goto l_0x100a_0b11; /* jg 0x100a0b11 */
        ...
        l_0x100a_0b11:
            ii(0x100a_0b11, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ii(0x100a_0b14, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x100a_0b27, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ii(0x100a_0b2a, 2); neg(ebx);                               /* neg ebx */
            ii(0x100a_0b2c, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100a_0b2f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100a_0b32, 5); call(0x100a_0a0a, -0x12d);              /* call 0x100a0a0a */
            ii(0x100a_0b37, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
