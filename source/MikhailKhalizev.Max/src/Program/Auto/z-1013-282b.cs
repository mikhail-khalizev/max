...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_282b()
        {
            ...
            ii(0x1013_2842, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_2845, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_2848, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_284b, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1013_284e, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1013_2851, 3); mov(eax, memd[ds, eax + 0x1b]);         /* mov eax, [eax+0x1b] */
            ii(0x1013_2854, 5); call(0x100d_4f58, -0x5_d901);           /* call 0x100d4f58 */
            ii(0x1013_2859, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1013_285c, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ...
            ii(0x1013_286b, 3); lea(ebx, memd[ss, ebp - 0x10]);         /* lea ebx, [ebp-0x10] */
            ii(0x1013_286e, 3); lea(edx, memd[ss, ebp - 0x14]);         /* lea edx, [ebp-0x14] */
            ii(0x1013_2871, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1013_2874, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1013_2876, 5); call(0x100d_6a92, -0x5_bde9);           /* call 0x100d6a92 */
            ii(0x1013_287b, 3); mov(edx, memd[ss, ebp - 0x18]);         /* mov edx, [ebp-0x18] */
            ii(0x1013_287e, 3); mov(eax, memd[ds, edx + 0x1b]);         /* mov eax, [edx+0x1b] */
            ii(0x1013_2881, 5); call(0x100d_4ef0, -0x5_d996);           /* call 0x100d4ef0 */
            ii(0x1013_2886, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x1013_2889, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1013_288c, 2); sub(eax, ecx);                          /* sub eax, ecx */
            ii(0x1013_288e, 2); mov(ecx, eax);                          /* mov ecx, eax */
            ii(0x1013_2890, 3); mov(edx, memd[ss, ebp - 0x18]);         /* mov edx, [ebp-0x18] */
            ...
            ii(0x1013_28a0, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x1013_28b0, 4); movsx(ebx, memw[ss, ebp - 0xc]);        /* movsx ebx, word [ebp-0xc] */
            ii(0x1013_28b4, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x1013_28b6, 3); sar(edx, 0x1f);                         /* sar edx, 0x1f */
            ii(0x1013_28b9, 2); idiv(ebx);                              /* idiv ebx */
            ii(0x1013_28bb, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1013_28be, 4); movsx(edx, memw[ss, ebp - 0x14]);       /* movsx edx, word [ebp-0x14] */
            ii(0x1013_28c2, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
