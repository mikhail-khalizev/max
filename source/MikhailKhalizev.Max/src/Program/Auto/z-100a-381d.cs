...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_381d()
        {
            ...
            ii(0x100a_382f, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100a_3835, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100a_3838, 7); mov(memd[ss, ebp - 8], 0);              /* mov dword [ebp-0x8], 0x0 */
            ii(0x100a_383f, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
