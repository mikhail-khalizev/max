...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_7d8b()
        {
            ...
            ii(0x1007_7da0, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1007_7da3, 3);  mov(memd[ss, ebp - 12], edx);         /* mov [ebp-0xc], edx */
            ii(0x1007_7da6, 3);  mov(memd[ss, ebp - 8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1007_7da9, 3);  mov(memb[ss, ebp - 4], cl);           /* mov [ebp-0x4], cl */
            ii(0x1007_7dac, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1007_7daf, 5);  call(0x1007_6338, -0x1a7c);           /* call 0x10076338 */
            ii(0x1007_7db4, 3);  lea(ebx, memd[ss, ebp - 24]);         /* lea ebx, [ebp-0x18] */
            ...
            ii(0x1007_7dc0, 4);  mov(memb[ss, ebp - 28], 0);           /* mov byte [ebp-0x1c], 0x0 */
            ii(0x1007_7dc4, 4);  movsx(edx, memw[ss, ebp - 8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1007_7dc8, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x1007_7de7, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1007_7deb, 2);  cmp(edx, eax);                        /* cmp edx, eax */
            ii(0x1007_7ded, 2);  if(jnz(0x1007_7df1, 2)) goto l_0x1007_7df1;/* jnz 0x10077df1 */
        l_0x1007_7def:
            ii(0x1007_7def, 2);  jmp(0x1007_7e04, 0x13); goto l_0x1007_7e04;/* jmp 0x10077e04 */
        l_0x1007_7df1:
            ii(0x1007_7df1, 4);  mov(memb[ss, ebp - 20], 0);           /* mov byte [ebp-0x14], 0x0 */
            ii(0x1007_7df5, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_7df7, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        ...
        l_0x1007_7e04:
            ii(0x1007_7e04, 2);  jmp(0x1007_7e0e, 8); goto l_0x1007_7e0e;/* jmp 0x10077e0e */
        l_0x1007_7e06:
            ii(0x1007_7e06, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_7e09, 5);  call(0x1007_6bf8, -0x1216);           /* call 0x10076bf8 */
        l_0x1007_7e0e:
            ii(0x1007_7e0e, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_7e10, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x1007_7e20, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_7e23, 5);  call(0x1007_63a0, -0x1a88);           /* call 0x100763a0 */
            ii(0x1007_7e28, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_7e2a, 3);  mov(dl, memb[ds, eax + 38]);          /* mov dl, [eax+0x26] */
            ii(0x1007_7e2d, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1007_7e31, 2);  cmp(edx, eax);                        /* cmp edx, eax */
            ii(0x1007_7e33, 2);  if(jnz(0x1007_7e43, 0xe)) goto l_0x1007_7e43;/* jnz 0x10077e43 */
            ii(0x1007_7e35, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_7e38, 5);  call(0x1007_63a0, -0x1a9d);           /* call 0x100763a0 */
            ii(0x1007_7e3d, 4);  cmp(memb[ds, eax + 80], 0);           /* cmp byte [eax+0x50], 0x0 */
            ii(0x1007_7e41, 2);  if(jnz(0x1007_7e45, 2)) goto l_0x1007_7e45;/* jnz 0x10077e45 */
        l_0x1007_7e43:
            ii(0x1007_7e43, 2);  jmp(0x1007_7e56, 0x11); goto l_0x1007_7e56;/* jmp 0x10077e56 */
        l_0x1007_7e45:
            ii(0x1007_7e45, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x1007_7e54, 2);  if(jnz(0x1007_7e58, 2)) goto l_0x1007_7e58;/* jnz 0x10077e58 */
        l_0x1007_7e56:
            ii(0x1007_7e56, 2);  jmp(0x1007_7e6c, 0x14); goto l_0x1007_7e6c;/* jmp 0x10077e6c */
        l_0x1007_7e58:
            ii(0x1007_7e58, 3);  mov(edx, memd[ss, ebp - 16]);         /* mov edx, [ebp-0x10] */
            ii(0x1007_7e5b, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        ...
        l_0x1007_7eba:
            ...
            ii(0x1007_7efb, 3);  cmp(eax, 2);                          /* cmp eax, 0x2 */
            ii(0x1007_7efe, 2);  if(jge(0x1007_7f48, 0x48)) goto l_0x1007_7f48;/* jge 0x10077f48 */
        l_0x1007_7f00:
            ii(0x1007_7f00, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_7f03, 5);  call(0x1007_63a0, -0x1b68);           /* call 0x100763a0 */
            ii(0x1007_7f08, 4);  movzx(edi, memb[ds, eax + 77]);       /* movzx edi, byte [eax+0x4d] */
            ii(0x1007_7f0c, 5);  mov(eax, 1);                          /* mov eax, 0x1 */
            ii(0x1007_7f11, 1);  push(eax);                            /* push eax */
            ii(0x1007_7f12, 4);  movsx(ecx, memb[ss, ebp - 4]);        /* movsx ecx, byte [ebp-0x4] */
            ii(0x1007_7f16, 3);  lea(edx, memd[ss, ebp - 32]);         /* lea edx, [ebp-0x20] */
            ii(0x1007_7f19, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
            ii(0x1007_7f1c, 5);  call(0x1007_5e64, -0x20bd);           /* call 0x10075e64 */
            ii(0x1007_7f21, 2);  mov(ebx, eax);                        /* mov ebx, eax */
            ii(0x1007_7f23, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_7f26, 5);  call(0x1007_63d4, -0x1b57);           /* call 0x100763d4 */
            ii(0x1007_7f2b, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1007_7f2d, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
        ...
        l_0x1007_7f48:
            ii(0x1007_7f48, 4);  mov(memb[ss, ebp - 28], 1);           /* mov byte [ebp-0x1c], 0x1 */
            ii(0x1007_7f4c, 3);  mov(edx, memd[ss, ebp - 16]);         /* mov edx, [ebp-0x10] */
            ii(0x1007_7f4f, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        ...
        l_0x1007_7f61:
            ii(0x1007_7f61, 3);  mov(al, memb[ss, ebp - 28]);          /* mov al, [ebp-0x1c] */
            ii(0x1007_7f64, 3);  mov(memb[ss, ebp - 20], al);          /* mov [ebp-0x14], al */
            ii(0x1007_7f67, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_7f69, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        ...
        //  ii(0x1007_7f75, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        //  ii(0x1007_7f78, 5);  call(0x1007_5f6c, -0x2011);           /* call 0x10075f6c */
        l_0x1007_7f7d:
            ii(0x1007_7f7d, 3);  mov(al, memb[ss, ebp - 20]);          /* mov al, [ebp-0x14] */
