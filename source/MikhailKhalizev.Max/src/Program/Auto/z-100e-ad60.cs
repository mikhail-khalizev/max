...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_ad60()
        {
            ...
            ii(0x100e_ad77, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_ad7a, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100e_ad7d, 7); test(memd[ss, ebp - 0x4], 0x4);         /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x100e_ad8b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100e_ad9a:
            ...
            ii(0x100e_ad9f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_ada2, 5); call(0x100c_d916, -0x1_d491);           /* call 0x100cd916 */
            ii(0x100e_ada7, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_adaa, 7); test(memd[ss, ebp - 0x4], 0x2);         /* test dword [ebp-0x4], 0x2 */
            ii(0x100e_adb1, 2); if(jz(0x100e_adbb, 0x8)) goto l_0x100e_adbb; /* jz 0x100eadbb */
            ii(0x100e_adb3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_adb6, 5); call(Definitions.sys_delete, 0x7_b1a9); /* call 0x10165f64 */
        l_0x100e_adbb:
            ii(0x100e_adbb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
