...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_6e00()
        {
            ...
            ii(0x1007_6e17, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_6e1a, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1007_6e1d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_6e20, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1007_6e22, 3); cmp(eax, memd[ss, ebp - 0x4]);          /* cmp eax, [ebp-0x4] */
            ii(0x1007_6e25, 2); if(jnz(0x1007_6e2d, 0x6)) goto l_0x1007_6e2d; /* jnz 0x10076e2d */
            ii(0x1007_6e27, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1007_6e2b, 2); jmp(0x1007_6e31, 0x4); goto l_0x1007_6e31; /* jmp 0x10076e31 */
        l_0x1007_6e2d:
            ii(0x1007_6e2d, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
        l_0x1007_6e31:
            ii(0x1007_6e31, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
            ii(0x1007_6e34, 3); mov(memb[ss, ebp - 0x10], al);          /* mov [ebp-0x10], al */
            ii(0x1007_6e37, 3); mov(al, memb[ss, ebp - 0x10]);          /* mov al, [ebp-0x10] */
