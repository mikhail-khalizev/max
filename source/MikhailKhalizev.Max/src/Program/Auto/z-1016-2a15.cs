...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_2a15()
        {
            ...
            ii(0x1016_2a27, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1016_2a2d, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1016_2a30, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1016_2a33, 5); call(0x1007_6338, -0xe_c700);           /* call 0x10076338 */
            ii(0x1016_2a38, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1016_2a3a, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
            ii(0x1016_2a3d, 5); call(0x1007_64b8, -0xe_c58a);           /* call 0x100764b8 */
            ii(0x1016_2a42, 2); jmp(0x1016_2a4c, 8); goto l_0x1016_2a4c; /* jmp 0x10162a4c */
        l_0x1016_2a44:
            ii(0x1016_2a44, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
            ii(0x1016_2a47, 5); call(0x1007_6bf8, -0xe_be54);           /* call 0x10076bf8 */
        l_0x1016_2a4c:
            ii(0x1016_2a4c, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1016_2a4e, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
            ...
            ii(0x1016_2a5a, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
            ...
            ii(0x1016_2a69, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
        ...
        l_0x1016_2a78:
            ...
            ii(0x1016_2a7a, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
