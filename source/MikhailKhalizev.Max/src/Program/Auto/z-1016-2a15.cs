...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_2a15()
        {
            ...
            ii(0x1016_2a3a, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
        ...
        l_0x1016_2a44:
            ii(0x1016_2a44, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1016_2a47, 5); call(0x1007_6bf8, -0xe_be54);           /* call 0x10076bf8 */
        l_0x1016_2a4c:
            ii(0x1016_2a4c, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1016_2a4e, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x1016_2a5a, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x1016_2a69, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
        ...
        l_0x1016_2a78:
            ...
            ii(0x1016_2a7a, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
