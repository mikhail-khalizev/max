...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_3a31()
        {
            ...
            ii(0x100a_3a49, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_3a4c, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_3a4e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_3a5e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_3a61, 3); add(eax, 0x6);                          /* add eax, 0x6 */
            ii(0x100a_3a64, 5); call(0x1008_af28, -0x1_8b41);           /* call 0x1008af28 */
            ii(0x100a_3a69, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_3a6c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_3a6f, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x100a_3a72, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_3a75, 3); call_abs(memd[ds, edx + 0x3c]);         /* call dword [edx+0x3c] */
