...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_ffc8()
        {
            ...
            ii(0x100a_ffde, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100a_ffe1, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100a_ffe4, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ii(0x100a_ffe7, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x100a_ffea, 3); add(edx, 0x3c);                         /* add edx, 0x3c */
            ii(0x100a_ffed, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_fffb, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
        ...
        l_0x100b_0006:
            ...
            ii(0x100b_0008, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100b_0017, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ii(0x100b_001b, 2); if(jnz(0x100b_0026, 0x9)) goto l_0x100b_0026; /* jnz 0x100b0026 */
            ii(0x100b_001d, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100b_0020, 4); cmp(memb[ds, eax + 0x45], 0);           /* cmp byte [eax+0x45], 0x0 */
            ii(0x100b_0024, 2); if(jnz(0x100b_0028, 0x2)) goto l_0x100b_0028; /* jnz 0x100b0028 */
        l_0x100b_0026:
            ii(0x100b_0026, 2); jmp(0x100b_0034, 0xc); goto l_0x100b_0034; /* jmp 0x100b0034 */
        l_0x100b_0028:
            ii(0x100b_0028, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_002a, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
        ...
        l_0x100b_0034:
            ...
            ii(0x100b_0039, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
