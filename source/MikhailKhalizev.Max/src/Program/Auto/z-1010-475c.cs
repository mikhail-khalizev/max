...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("a35bea90-bc74-4b09-8117-e4189b29db68")]
        public void Method_1010_475c()
        {
            ii(0x1010_475c, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x1010_4761, 5); calld(Definitions.sys_check_available_stack_size, 0x615ec); /* call 0x10165d52 */
            ...
            ii(0x1010_478c, 1); retd(); return;                         /* ret */
        }
    }
}
