...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_07a7()
        {
            ...
            ii(0x1018_07b3, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1018_07b6, 3); mov(memd[ss, ebp - 16], edx);           /* mov [ebp-0x10], edx */
            ii(0x1018_07b9, 3); mov(memd[ss, ebp - 12], ebx);           /* mov [ebp-0xc], ebx */
            ii(0x1018_07bc, 7); imul(edx, memd[ss, ebp - 20], 0xc0);    /* imul edx, [ebp-0x14], 0xc0 */
            ii(0x1018_07c3, 4); imul(eax, memd[ss, ebp - 16], 6);       /* imul eax, [ebp-0x10], 0x6 */
            ii(0x1018_07c7, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1018_07c9, 7); lgs(eax, memd[ds, eax + 0x1020_b718]);  /* lgs eax, [eax+0x1020b718] */
            ii(0x1018_07d0, 5); movsx(eax, memw[gs, eax + 48]);         /* movsx eax, word [gs:eax+0x30] */
            ii(0x1018_07d5, 3); test(ah, 0x80);                         /* test ah, 0x80 */
            ii(0x1018_07d8, 2); if(jz(0x1018_0814, 0x3a)) goto l_0x1018_0814; /* jz 0x10180814 */
            ii(0x1018_07da, 7); imul(eax, memd[ss, ebp - 20], 0xc0);    /* imul eax, [ebp-0x14], 0xc0 */
            ii(0x1018_07e1, 4); imul(edx, memd[ss, ebp - 16], 6);       /* imul edx, [ebp-0x10], 0x6 */
            ii(0x1018_07e5, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1018_07e7, 7); lgs(eax, memd[ds, eax + 0x1020_b718]);  /* lgs eax, [eax+0x1020b718] */
            ii(0x1018_07ee, 5); movsx(eax, memw[gs, eax + 50]);         /* movsx eax, word [gs:eax+0x32] */
            ii(0x1018_07f3, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1018_07f6, 7); imul(edx, memd[ss, ebp - 20], 0xc0);    /* imul edx, [ebp-0x14], 0xc0 */
            ii(0x1018_07fd, 4); imul(eax, memd[ss, ebp - 16], 6);       /* imul eax, [ebp-0x10], 0x6 */
            ii(0x1018_0801, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1018_0803, 7); lgs(edx, memd[ds, edx + 0x1020_b718]);  /* lgs edx, [edx+0x1020b718] */
            ii(0x1018_080a, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1018_080d, 5); mov(memw[gs, edx + 50], ax);            /* mov [gs:edx+0x32], ax */
