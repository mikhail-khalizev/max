...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_07a7()
        {
            ...
            ii(0x1018_07c3, 4); imul(eax, memd[ss, ebp - 0x10], 0x6);   /* imul eax, [ebp-0x10], 0x6 */
            ...
            ii(0x1018_07e1, 4); imul(edx, memd[ss, ebp - 0x10], 0x6);   /* imul edx, [ebp-0x10], 0x6 */
            ...
            ii(0x1018_07f3, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1018_07f6, 7); imul(edx, memd[ss, ebp - 0x14], 0xc0);  /* imul edx, [ebp-0x14], 0xc0 */
            ii(0x1018_07fd, 4); imul(eax, memd[ss, ebp - 0x10], 0x6);   /* imul eax, [ebp-0x10], 0x6 */
            ...
            ii(0x1018_0812, 2); jmp(0x1018_081d, 0x9); goto l_0x1018_081d; /* jmp 0x1018081d */
        l_0x1018_0814:
            ii(0x1018_0814, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1018_081b, 2); jmp(0x1018_0823, 0x6); goto l_0x1018_0823; /* jmp 0x10180823 */
        l_0x1018_081d:
            ii(0x1018_081d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1018_0820, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x1018_0823:
            ii(0x1018_0823, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
