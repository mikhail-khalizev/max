...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_d0ac()
        {
            ...
            ii(0x18_d0b4, 3); lea(ax, memw[ss, bp - 0xa]);              /* lea ax, [bp-0xa] */
            ii(0x18_d0b7, 1); push(ax);                                 /* push ax */
            ii(0x18_d0b8, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ...
            ii(0x18_d0c4, 4); test(memb[ss, bp - 0x2], 0x7f);           /* test byte [bp-0x2], 0x7f */
            ii(0x18_d0c8, 2); if(jz(0x18_d0f4, 0x2a)) goto l_0x18_d0f4; /* jz 0xd0f4 */
            ii(0x18_d0ca, 2); push(0x1);                                /* push 0x1 */
            ...
            ii(0x18_d0d6, 3); mov(al, memb[ss, bp + 0x6]);              /* mov al, [bp+0x6] */
            ii(0x18_d0d9, 3); mov(memb[ss, bp - 0x2], al);              /* mov [bp-0x2], al */
            ii(0x18_d0dc, 3); lea(ax, memw[ss, bp - 0xa]);              /* lea ax, [bp-0xa] */
            ...
            ii(0x18_d0e6, 3); mov(bx, memw[ss, bp + 0x4]);              /* mov bx, [bp+0x4] */
