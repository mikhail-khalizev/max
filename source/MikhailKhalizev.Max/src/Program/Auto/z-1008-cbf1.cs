...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_cbf1()
        {
            ...
            ii(0x1008_cc51, 5); jmpd(0x1008_cd68, 0x112); goto l_0x1008_cd68; /* jmp 0x1008cd68 */
        l_0x1008_cc56:
            ii(0x1008_cc56, 5); mov(edx, StringDefinitions.Initializing); /* mov edx, 0x101a048d */
            ii(0x1008_cc5b, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1008_cc5e, 5); calld(Definitions.sys_strcat, 0xd_92ce); /* call 0x10165f31 */
            ii(0x1008_cc63, 5); jmpd(0x1008_cd83, 0x11b); goto l_0x1008_cd83; /* jmp 0x1008cd83 */
        l_0x1008_cc68:
            ii(0x1008_cc68, 5); mov(edx, StringDefinitions.RemovingMines2); /* mov edx, 0x101a049c */
            ii(0x1008_cc6d, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1008_cc70, 5); calld(Definitions.sys_strcat, 0xd_92bc); /* call 0x10165f31 */
            ii(0x1008_cc75, 5); jmpd(0x1008_cd83, 0x109); goto l_0x1008_cd83; /* jmp 0x1008cd83 */
        l_0x1008_cc7a:
            ii(0x1008_cc7a, 5); mov(edx, StringDefinitions.WaitingForPlatform); /* mov edx, 0x101a04ad */
            ii(0x1008_cc7f, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1008_cc82, 5); calld(Definitions.sys_strcat, 0xd_92aa); /* call 0x10165f31 */
            ii(0x1008_cc87, 5); jmpd(0x1008_cd83, 0xf7); goto l_0x1008_cd83; /* jmp 0x1008cd83 */
        l_0x1008_cc8c:
            ii(0x1008_cc8c, 5); mov(edx, StringDefinitions.GetBuilder); /* mov edx, 0x101a04c4 */
            ii(0x1008_cc91, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1008_cc94, 5); calld(Definitions.sys_strcat, 0xd_9298); /* call 0x10165f31 */
            ii(0x1008_cc99, 5); jmpd(0x1008_cd83, 0xe5); goto l_0x1008_cd83; /* jmp 0x1008cd83 */
        l_0x1008_cc9e:
            ii(0x1008_cc9e, 5); mov(edx, StringDefinitions.GetMaterials); /* mov edx, 0x101a04d2 */
            ii(0x1008_cca3, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1008_cca6, 5); calld(Definitions.sys_strcat, 0xd_9286); /* call 0x10165f31 */
            ii(0x1008_ccab, 5); jmpd(0x1008_cd83, 0xd3); goto l_0x1008_cd83; /* jmp 0x1008cd83 */
        l_0x1008_ccb0:
            ii(0x1008_ccb0, 5); mov(edx, StringDefinitions.MoveToSite); /* mov edx, 0x101a04e2 */
            ii(0x1008_ccb5, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1008_ccb8, 5); calld(Definitions.sys_strcat, 0xd_9274); /* call 0x10165f31 */
            ii(0x1008_ccbd, 5); jmpd(0x1008_cd83, 0xc1); goto l_0x1008_cd83; /* jmp 0x1008cd83 */
        l_0x1008_ccc2:
            ii(0x1008_ccc2, 5); mov(edx, StringDefinitions.EvaluatingSite); /* mov edx, 0x101a04f1 */
            ii(0x1008_ccc7, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1008_ccca, 5); calld(Definitions.sys_strcat, 0xd_9262); /* call 0x10165f31 */
            ii(0x1008_cccf, 5); jmpd(0x1008_cd83, 0xaf); goto l_0x1008_cd83; /* jmp 0x1008cd83 */
        l_0x1008_ccd4:
            ii(0x1008_ccd4, 5); mov(edx, StringDefinitions.SiteBlocked); /* mov edx, 0x101a0503 */
            ii(0x1008_ccd9, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1008_ccdc, 5); calld(Definitions.sys_strcat, 0xd_9250); /* call 0x10165f31 */
            ii(0x1008_cce1, 5); jmpd(0x1008_cd83, 0x9d); goto l_0x1008_cd83; /* jmp 0x1008cd83 */
        l_0x1008_cce6:
            ii(0x1008_cce6, 5); mov(edx, StringDefinitions.ClearSite);  /* mov edx, 0x101a0512 */
            ii(0x1008_cceb, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1008_ccee, 5); calld(Definitions.sys_strcat, 0xd_923e); /* call 0x10165f31 */
            ii(0x1008_ccf3, 5); jmpd(0x1008_cd83, 0x8b); goto l_0x1008_cd83; /* jmp 0x1008cd83 */
        l_0x1008_ccf8:
            ii(0x1008_ccf8, 5); mov(edx, StringDefinitions.Building3);  /* mov edx, 0x101a051f */
            ii(0x1008_ccfd, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1008_cd00, 5); calld(Definitions.sys_strcat, 0xd_922c); /* call 0x10165f31 */
            ii(0x1008_cd05, 5); jmpd(0x1008_cd83, 0x79); goto l_0x1008_cd83; /* jmp 0x1008cd83 */
        l_0x1008_cd0a:
            ii(0x1008_cd0a, 5); mov(edx, StringDefinitions.MoveOffSite); /* mov edx, 0x101a052a */
            ii(0x1008_cd0f, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1008_cd12, 5); calld(Definitions.sys_strcat, 0xd_921a); /* call 0x10165f31 */
            ii(0x1008_cd17, 2); jmpd(0x1008_cd83, 0x6a); goto l_0x1008_cd83; /* jmp 0x1008cd83 */
        l_0x1008_cd19:
            ii(0x1008_cd19, 5); mov(edx, StringDefinitions.Finished3);  /* mov edx, 0x101a053a */
            ii(0x1008_cd1e, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1008_cd21, 5); calld(Definitions.sys_strcat, 0xd_920b); /* call 0x10165f31 */
            ii(0x1008_cd26, 2); jmpd(0x1008_cd83, 0x5b); goto l_0x1008_cd83; /* jmp 0x1008cd83 */
        l_0x1008_cd28:
            ...
            ii(0x1008_cd35, 2); jmpd(0x1008_cd83, 0x4c); goto l_0x1008_cd83; /* jmp 0x1008cd83 */
        ...
        l_0x1008_cd68:
            ...
            ii(0x1008_cd72, 2); if(jad(0x1008_cd28, -0x4c)) goto l_0x1008_cd28; /* ja 0x1008cd28 */
            ...
            ii(0x1008_cd7c, 7); 
            switch (jmpd_abs_switch(memd_a32[cs, eax + 0x1008_cd38]))
            {
                case 0x1008_cc56:
                    goto l_0x1008_cc56;
                case 0x1008_cc68:
