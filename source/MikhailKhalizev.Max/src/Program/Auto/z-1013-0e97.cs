...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_0e97()
        {
            ...
            ii(0x1013_0eae, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1013_0eb1, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1013_0eb4, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_0eb7, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1013_0eba, 7); mov(memb[ds, 0x101b_b48d], 1);          /* mov byte [0x101bb48d], 0x1 */
            ii(0x1013_0ec1, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_0ec4, 5); call(0x1012_f003, -0x1ec6);             /* call 0x1012f003 */
            ii(0x1013_0ec9, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_0ecc, 4); cmp(memb[ds, eax + 23], 0);             /* cmp byte [eax+0x17], 0x0 */
            ii(0x1013_0ed0, 2); if(jz(0x1013_0edb, 9)) goto l_0x1013_0edb; /* jz 0x10130edb */
            ii(0x1013_0ed2, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_0ed5, 4); cmp(memb[ds, eax + 23], 1);             /* cmp byte [eax+0x17], 0x1 */
            ii(0x1013_0ed9, 2); if(jnz(0x1013_0ee8, 0xd)) goto l_0x1013_0ee8; /* jnz 0x10130ee8 */
        l_0x1013_0edb:
            ii(0x1013_0edb, 5); mov(edx, 1);                            /* mov edx, 0x1 */
            ii(0x1013_0ee0, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
