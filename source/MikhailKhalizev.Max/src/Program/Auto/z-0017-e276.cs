...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_e276()
        {
            ...
            ii(0x17_e27d, 3); mov(cx, memw[ss, bp + 0xa]);              /* mov cx, [bp+0xa] */
            ii(0x17_e280, 2); if(jcxz(0x17_e2a8, 0x26)) goto l_0x17_e2a8; /* jcxz 0xe2a8 */
            ii(0x17_e282, 2); mov(bx, cx);                              /* mov bx, cx */
            ii(0x17_e284, 3); mov(di, memw[ss, bp + 0x6]);              /* mov di, [bp+0x6] */
            ...
            ii(0x17_e293, 3); mov(si, memw[ss, bp + 0x8]);              /* mov si, [bp+0x8] */
            ii(0x17_e296, 2); repe(() => cmpsb());                      /* repe cmpsb */
            ii(0x17_e298, 3); mov(al, memb[ds, si - 0x1]);              /* mov al, [si-0x1] */
            ii(0x17_e29b, 2); xor(cx, cx);                              /* xor cx, cx */
            ii(0x17_e29d, 3); cmp(al, memb[ds, di - 0x1]);              /* cmp al, [di-0x1] */
            ii(0x17_e2a0, 2); if(ja(0x17_e2a6, 0x4)) goto l_0x17_e2a6;  /* ja 0xe2a6 */
            ii(0x17_e2a2, 2); if(jz(0x17_e2a8, 0x4)) goto l_0x17_e2a8;  /* jz 0xe2a8 */
