...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_3e62()
        {
            ...
            ii(0x1016_3e7a, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1016_3e7d, 5); mov(eax, 0x101c_b11a);                  /* mov eax, 0x101cb11a */
            ii(0x1016_3e82, 5); call(0x1012_0d64, -0x4_3123);           /* call 0x10120d64 */
            ii(0x1016_3e87, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1016_3e8a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
