...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_08ce()
        {
            ...
            ii(0x100a_08e6, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_08e9, 4); or(memb[ss, ebp - 0x8], 0x1);           /* or byte [ebp-0x8], 0x1 */
            ii(0x100a_08ed, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x100a_08f0, 5); call(0x1007_64fc, -0x2_a3f9);           /* call 0x100764fc */
            ii(0x100a_08f5, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100a_08f8, 4); and(memb[ss, ebp - 0x8], -0x2 /* 0xfe */); /* and byte [ebp-0x8], 0xfe */
            ...
            ii(0x100a_0908, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x100a_090b, 5); call(0x1007_643c, -0x2_a4d4);           /* call 0x1007643c */
            ii(0x100a_0910, 2); jmp(0x100a_091a, 0x8); goto l_0x100a_091a; /* jmp 0x100a091a */
        l_0x100a_0912:
            ii(0x100a_0912, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x100a_0915, 5); call(0x1007_6bf8, -0x2_9d22);           /* call 0x10076bf8 */
        l_0x100a_091a:
            ii(0x100a_091a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_091c, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x100a_0928, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100a_092b, 3); add(edx, 0x44);                         /* add edx, 0x44 */
            ii(0x100a_092e, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x100a_093f, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x100a_0942, 5); call(0x1007_6408, -0x2_a53f);           /* call 0x10076408 */
            ii(0x100a_0947, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100a_0949, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100a_0953:
            ...
            ii(0x100a_0955, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_0964, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_0971, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_0974, 5); call(0x100a_0833, -0x146);              /* call 0x100a0833 */
        l_0x100a_0979:
            ii(0x100a_0979, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_097b, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
