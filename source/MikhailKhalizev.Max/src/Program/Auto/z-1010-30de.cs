...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("59eea859-2a47-4e5b-972a-2db54a7d7b22")]
        public void Method_1010_30de()
        {
            ii(0x1010_30de, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x1010_30e3, 5); calld(Definitions.sys_check_available_stack_size, 0x62c6a); /* call 0x10165d52 */
            ...
            ii(0x1010_3104, 5); calld(0x1013_bb7b, 0x38a72);            /* call 0x1013bb7b */
            ...
            ii(0x1010_3112, 5); calld(0x1013_bb7b, 0x38a64);            /* call 0x1013bb7b */
