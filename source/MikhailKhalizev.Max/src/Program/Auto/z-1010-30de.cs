...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_30de()
        {
            ...
            ii(0x1010_30f5, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_30f8, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1010_30fb, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1010_30fe, 3); add(edx, 0x10);                         /* add edx, 0x10 */
            ii(0x1010_3101, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_3104, 5); call(0x1013_bb7b, 0x3_8a72);            /* call 0x1013bb7b */
            ii(0x1010_3109, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1010_310c, 3); add(edx, 0x12);                         /* add edx, 0x12 */
            ii(0x1010_310f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_3112, 5); call(0x1013_bb7b, 0x3_8a64);            /* call 0x1013bb7b */
            ii(0x1010_3117, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1010_311a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
