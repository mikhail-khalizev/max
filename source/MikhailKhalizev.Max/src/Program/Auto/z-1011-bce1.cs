...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_bce1()
        {
            ...
            ii(0x1011_bcf8, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_bcfb, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1011_bcfe, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ii(0x1011_bd01, 3); add(ebx, 0x16);                         /* add ebx, 0x16 */
            ii(0x1011_bd04, 5); mov(edx, StringDefinitions.X7);         /* mov edx, 0x101a7d96 */
            ii(0x1011_bd09, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_bd0c, 5); call(0x1014_5c2e, 0x2_9f1d);            /* call 0x10145c2e */
            ii(0x1011_bd11, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ii(0x1011_bd14, 3); add(ebx, 0x18);                         /* add ebx, 0x18 */
            ii(0x1011_bd17, 5); mov(edx, StringDefinitions.Y5);         /* mov edx, 0x101a7d98 */
            ii(0x1011_bd1c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
