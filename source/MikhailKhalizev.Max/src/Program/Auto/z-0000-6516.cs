...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_6516()
        {
            ...
            ii(0x651f, 3);    mov(di, memw[ss, bp + 4]);                /* mov di, [bp+0x4] */
            ii(0x6522, 2);    mov(bx, di);                              /* mov bx, di */
            ii(0x6524, 3);    mov(cx, memw[ss, bp + 8]);                /* mov cx, [bp+0x8] */
            ii(0x6527, 2);    if(jcxz(0x653e, 0x15)) goto l_0x653e;     /* jcxz 0x653e */
            ii(0x6529, 3);    mov(al, memb[ss, bp + 6]);                /* mov al, [bp+0x6] */
            ii(0x652c, 2);    mov(ah, al);                              /* mov ah, al */
            ii(0x652e, 4);    test(di, 1);                              /* test di, 0x1 */
            ii(0x6532, 2);    if(jz(0x6536, 2)) goto l_0x6536;          /* jz 0x6536 */
            ii(0x6534, 1);    stosb();                                  /* stosb */
            ii(0x6535, 1);    dec(cx);                                  /* dec cx */
        l_0x6536:
            ii(0x6536, 2);    shr(cx, 1);                               /* shr cx, 1 */
