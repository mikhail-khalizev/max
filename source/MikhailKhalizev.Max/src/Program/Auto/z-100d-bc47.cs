...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_bc47()
        {
            ...
            ii(0x100d_bc5e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_bc61, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_bc64, 7); test(memd[ss, ebp - 0x4], 0x4);         /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x100d_bc72, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_bc81:
            ii(0x100d_bc81, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_bca6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_bcb8, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_bcbb, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x100d_bcc0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_bcc3, 5); call(0x100d_9a4a, -0x227e);             /* call 0x100d9a4a */
            ii(0x100d_bcc8, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_bccb, 7); test(memd[ss, ebp - 0x4], 0x2);         /* test dword [ebp-0x4], 0x2 */
            ii(0x100d_bcd2, 2); if(jz(0x100d_bcdc, 0x8)) goto l_0x100d_bcdc; /* jz 0x100dbcdc */
            ii(0x100d_bcd4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_bcd7, 5); call(Definitions.sys_delete, 0x8_a288); /* call 0x10165f64 */
        l_0x100d_bcdc:
            ii(0x100d_bcdc, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
