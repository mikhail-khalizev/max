...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("ea48b7b1-44f2-43b4-a101-333c34dec1bf")]
        public void Method_1007_69d8()
        {
            ii(0x1007_69d8, 5); pushd(0x28);                            /* push 0x28 */
            ii(0x1007_69dd, 5); calld(Definitions.sys_check_available_stack_size, 0xe_f370); /* call 0x10165d52 */
        ...
        l_0x1007_6a04:
            ...
            ii(0x1007_6a15, 5); calld(Definitions.sys_assert, 0xe_f378); /* call 0x10165d92 */
