...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_aaec()
        {
            ...
            ii(0x100b_ab03, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_ab06, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100b_ab09, 5);  mov(ebx, 0x101c_819c);                /* mov ebx, 0x101c819c */
            ii(0x100b_ab0e, 4);  movsx(edx, memw[ss, ebp - 4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x100b_ab12, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x100b_ab15, 5);  call(0x100b_a9e8, -0x132);            /* call 0x100ba9e8 */
            ii(0x100b_ab1a, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x100b_ab1e, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x100b_ab20, 2);  if(jnz(0x100b_ab2a, 8)) goto l_0x100b_ab2a;/* jnz 0x100bab2a */
            ii(0x100b_ab22, 4);  movsx(eax, memw[ss, ebp - 10]);       /* movsx eax, word [ebp-0xa] */
            ii(0x100b_ab26, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x100b_ab28, 2);  if(jz(0x100b_ab2c, 2)) goto l_0x100b_ab2c;/* jz 0x100bab2c */
        l_0x100b_ab2a:
        ...
        l_0x100b_ab2c:
            ...
            ii(0x100b_ab31, 4);  movsx(edx, memw[ss, ebp - 4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x100b_ab35, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x100b_ab38, 5);  call(0x100b_a9e8, -0x155);            /* call 0x100ba9e8 */
            ii(0x100b_ab3d, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x100b_ab3f, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x100b_ab42, 5);  call(0x1008_8b44, -0x3_2003);         /* call 0x10088b44 */
        l_0x100b_ab47:
            ii(0x100b_ab47, 3);  lea(edx, memd[ss, ebp - 12]);         /* lea edx, [ebp-0xc] */
            ii(0x100b_ab4a, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_ab4d, 5);  call(0x1007_5e64, -0x4_4cee);         /* call 0x10075e64 */
            ii(0x100b_ab52, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
