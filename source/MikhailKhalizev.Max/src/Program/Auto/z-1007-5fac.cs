...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("bb04cd54-6938-48ef-901e-5ae1c16fe655")]
        public void Method_1007_5fac()
        {
            ii(0x1007_5fac, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x1007_5fb1, 5); calld(Definitions.sys_check_available_stack_size, 0xefd9c); /* call 0x10165d52 */
            ...
            ii(0x1007_5fcf, 5); calld(0x1013_a2ab, 0xc42d7);            /* call 0x1013a2ab */
            ...
            ii(0x1007_5fdb, 1); retd(); return;                         /* ret */
        }
    }
}
