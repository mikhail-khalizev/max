...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("6714ff99-1d21-4440-8de7-94e249687598")]
        public void /* sys */ Method_1018_dcc4()
        {
            ii(0x1018_dcc4, 1); pushd(ebx);                             /* push ebx */
            ii(0x1018_dcc5, 5); mov(ecx, 0);                            /* mov ecx, 0x0 */
            ii(0x1018_dcca, 7); cmp(memd_a32[ds, 0x101b_e420], 0);      /* cmp dword [0x101be420], 0x0 */
            ii(0x1018_dcd1, 2); if(jsd(0x1018_dcda, 0x7)) goto l_0x1018_dcda; /* js 0x1018dcda */
            ii(0x1018_dcd3, 2); jmpd(0x1018_dcfe, 0x29); goto l_0x1018_dcfe; /* jmp 0x1018dcfe */
        l_0x1018_dcd5:
        ...
        l_0x1018_dcda:
            ...
            ii(0x1018_dceb, 7); mov(bx, memw_a32[ds, 0x1020_9dd0]);     /* mov bx, [0x10209dd0] */
            ii(0x1018_dcf2, 3); sub(bx, ax);                            /* sub bx, ax */
            ii(0x1018_dcf5, 6); add(ebx, memd_a32[ds, 0x101b_e420]);    /* add ebx, [0x101be420] */
            ii(0x1018_dcfb, 1); sti();                                  /* sti */
            ii(0x1018_dcfc, 2); if(jsd(0x1018_dcd5, -0x29)) goto l_0x1018_dcd5; /* js 0x1018dcd5 */
        l_0x1018_dcfe:
