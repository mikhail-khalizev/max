...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("a5e204b5-f2bd-4024-8b0a-4c1581b5acef")]
        public void Method_100f_bbed()
        {
            ii(0x100f_bbed, 5); pushd(0x6c);                            /* push 0x6c */
            ii(0x100f_bbf2, 5); calld(Definitions.sys_check_available_stack_size, 0x6_a15b); /* call 0x10165d52 */
            ...
            ii(0x100f_bc1f, 5); calld(Definitions.my_ctor_0x101b_38d0, -0x8_53e0); /* call 0x10076844 */
            ...
            ii(0x100f_bc35, 5); calld(0x100c_aa00, -0x3_123a);          /* call 0x100caa00 */
            ii(0x100f_bc3a, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100f_bc3f, 1); pushd(eax);                             /* push eax */
            ii(0x100f_bc40, 5); calld(0x100c_aa20, -0x3_1225);          /* call 0x100caa20 */
            ...
            ii(0x100f_bc52, 5); calld(0x1011_5d23, 0x1_a0cc);           /* call 0x10115d23 */
            ii(0x100f_bc57, 5); calld(0x100d_5470, -0x2_67ec);          /* call 0x100d5470 */
            ...
            ii(0x100f_bc6e, 5); calld(0x1013_daea, 0x4_1e77);           /* call 0x1013daea */
            ii(0x100f_bc73, 2); if(jmpd_func(0x100f_bc79, 0x4)) return; /* jmp 0x100fbc79 */
        l_0x100f_bc75:
