...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_4fa5()
        {
            ...
            ii(0x1012_4fbd, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1012_4fc0, 4); cmp(memd[ss, ebp - 0x4], 0);            /* cmp dword [ebp-0x4], 0x0 */
            ii(0x1012_4fc4, 2); if(jnz(0x1012_4fd2, 0xc)) goto l_0x1012_4fd2; /* jnz 0x10124fd2 */
            ii(0x1012_4fc6, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1012_4fcd, 5); jmp(0x1012_511c, 0x14a); goto l_0x1012_511c; /* jmp 0x1012511c */
        l_0x1012_4fd2:
            ii(0x1012_4fd2, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1012_4fd5, 3); add(edx, 0x4);                          /* add edx, 0x4 */
            ii(0x1012_4fd8, 2); sub(eax, eax);                          /* sub eax, eax */
            ii(0x1012_4fda, 1); inb(al, dx);                            /* in al, dx */
            ii(0x1012_4fdb, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1012_4fde, 5); mov(eax, 0x1f);                         /* mov eax, 0x1f */
            ii(0x1012_4fe3, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1012_4ff5, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1012_4ff8, 3); add(edx, 0x6);                          /* add edx, 0x6 */
            ii(0x1012_4ffb, 2); sub(eax, eax);                          /* sub eax, eax */
            ii(0x1012_4ffd, 1); inb(al, dx);                            /* in al, dx */
            ii(0x1012_4ffe, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1012_5001, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1012_5004, 3); add(edx, 0x6);                          /* add edx, 0x6 */
            ii(0x1012_5007, 2); sub(eax, eax);                          /* sub eax, eax */
            ii(0x1012_5009, 1); inb(al, dx);                            /* in al, dx */
            ii(0x1012_500a, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1012_500d, 1); sti();                                  /* sti */
            ii(0x1012_500e, 1); cld();                                  /* cld */
            ii(0x1012_500f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1012_501a, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1012_5021, 5); jmp(0x1012_511c, 0xf6); goto l_0x1012_511c; /* jmp 0x1012511c */
        l_0x1012_5026:
            ii(0x1012_5026, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1012_5029, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1012_503a, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1012_503d, 3); add(edx, 0x7);                          /* add edx, 0x7 */
            ii(0x1012_5040, 2); sub(eax, eax);                          /* sub eax, eax */
            ii(0x1012_5042, 1); inb(al, dx);                            /* in al, dx */
            ii(0x1012_5043, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1012_5046, 5); mov(eax, 0x55);                         /* mov eax, 0x55 */
            ii(0x1012_504b, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1012_505c, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1012_506a, 7); mov(memd[ss, ebp - 0x8], 0x1);          /* mov dword [ebp-0x8], 0x1 */
            ii(0x1012_5071, 5); jmp(0x1012_511c, 0xa6); goto l_0x1012_511c; /* jmp 0x1012511c */
        l_0x1012_5076:
            ii(0x1012_5076, 5); mov(eax, 0xaa);                         /* mov eax, 0xaa */
            ii(0x1012_507b, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1012_508c, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1012_509c, 7); mov(memd[ss, ebp - 0x8], 0x1);          /* mov dword [ebp-0x8], 0x1 */
            ii(0x1012_50a3, 5); jmp(0x1012_511c, 0x74); goto l_0x1012_511c; /* jmp 0x1012511c */
        l_0x1012_50a8:
            ii(0x1012_50a8, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1012_50ab, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1012_50c1, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1012_50d2, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1012_50d5, 3); add(edx, 0x2);                          /* add edx, 0x2 */
            ii(0x1012_50d8, 2); sub(eax, eax);                          /* sub eax, eax */
            ii(0x1012_50da, 1); inb(al, dx);                            /* in al, dx */
            ii(0x1012_50db, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1012_50de, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1012_50e0, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1012_50f1, 7); test(memd[ss, ebp - 0x10], 0x80);       /* test dword [ebp-0x10], 0x80 */
            ii(0x1012_50f8, 2); if(jnz(0x1012_5103, 0x9)) goto l_0x1012_5103; /* jnz 0x10125103 */
            ii(0x1012_50fa, 7); mov(memd[ss, ebp - 0x8], 0x2);          /* mov dword [ebp-0x8], 0x2 */
            ii(0x1012_5101, 2); jmp(0x1012_511c, 0x19); goto l_0x1012_511c; /* jmp 0x1012511c */
        l_0x1012_5103:
            ii(0x1012_5103, 7); test(memd[ss, ebp - 0x10], 0x40);       /* test dword [ebp-0x10], 0x40 */
            ii(0x1012_510a, 2); if(jnz(0x1012_5115, 0x9)) goto l_0x1012_5115; /* jnz 0x10125115 */
            ii(0x1012_510c, 7); mov(memd[ss, ebp - 0x8], 0x3);          /* mov dword [ebp-0x8], 0x3 */
            ii(0x1012_5113, 2); jmp(0x1012_511c, 0x7); goto l_0x1012_511c; /* jmp 0x1012511c */
        l_0x1012_5115:
            ii(0x1012_5115, 7); mov(memd[ss, ebp - 0x8], 0x3);          /* mov dword [ebp-0x8], 0x3 */
        l_0x1012_511c:
            ii(0x1012_511c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
