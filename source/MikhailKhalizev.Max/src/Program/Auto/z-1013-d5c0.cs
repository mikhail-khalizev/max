...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_d5c0()
        {
            ...
            ii(0x1013_d5f4, 4); mov(memb[ss, ebp - 0x18], 1);           /* mov byte [ebp-0x18], 0x1 */
        l_0x1013_d5f8:
            ii(0x1013_d5f8, 4); test(memb[ss, ebp - 0x18], 2);          /* test byte [ebp-0x18], 0x2 */
        ...
        l_0x1013_d7dd:
            ii(0x1013_d7dd, 4); test(memb[ss, ebp - 0x18], 2);          /* test byte [ebp-0x18], 0x2 */
            ii(0x1013_d7e1, 2); if(jz(0x1013_d7e9, 6)) goto l_0x1013_d7e9; /* jz 0x1013d7e9 */
            ii(0x1013_d7e3, 4); mov(memb[ss, ebp - 0x38], 1);           /* mov byte [ebp-0x38], 0x1 */
        ...
        l_0x1013_d7ed:
            ...
            ii(0x1013_d810, 4); test(memb[ss, ebp - 0x18], 4);          /* test byte [ebp-0x18], 0x4 */
        ...
        l_0x1013_d826:
            ...
            ii(0x1013_d8d2, 4); mov(memb[ss, ebp - 0x34], 1);           /* mov byte [ebp-0x34], 0x1 */
