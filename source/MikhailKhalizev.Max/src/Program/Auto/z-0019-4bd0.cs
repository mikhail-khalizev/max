...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_4bd0()
        {
            ...
            ii(0x19_4be1, 5); mov(memw[ss, bp - 0x4], 0x1);             /* mov word [bp-0x4], 0x1 */
            ii(0x19_4be6, 2); push(0);                                  /* push 0x0 */
            ii(0x19_4be8, 2); push(0);                                  /* push 0x0 */
            ii(0x19_4bea, 3); lea(ax, memw[ss, bp - 0x14]);             /* lea ax, [bp-0x14] */
            ...
            ii(0x19_4bfd, 2); if(jnz(0x19_4c04, 0x5)) goto l_0x19_4c04; /* jnz 0x4c04 */
            ii(0x19_4bff, 2); sub(ax, ax);                              /* sub ax, ax */
            ii(0x19_4c01, 1); pop(ds);                                  /* pop ds */
            ii(0x19_4c02, 1); leave();                                  /* leave */
            ii(0x19_4c03, 1); retf(); return;                           /* retf */
        l_0x19_4c04:
            ii(0x19_4c04, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0x19_4c07, 1); pop(ds);                                  /* pop ds */
            ii(0x19_4c08, 1); leave();                                  /* leave */
            ii(0x19_4c09, 1); retf(); return;                           /* retf */
        l_0x19_4c0a:
            ii(0x19_4c0a, 5); mov(memw[ss, bp - 0x4], 0x2);             /* mov word [bp-0x4], 0x2 */
            ii(0x19_4c0f, 5); mov(memw[ss, bp - 0x8], 0xa000);          /* mov word [bp-0x8], 0xa000 */
            ii(0x19_4c14, 5); mov(memw[ss, bp - 0x6], 0xa00);           /* mov word [bp-0x6], 0xa00 */
            ii(0x19_4c19, 2); push(0);                                  /* push 0x0 */
            ii(0x19_4c1b, 2); push(0);                                  /* push 0x0 */
            ii(0x19_4c1d, 3); lea(ax, memw[ss, bp - 0x14]);             /* lea ax, [bp-0x14] */
            ...
            ii(0x19_4c2d, 3); mov(ax, memw[ss, bp - 0x12]);             /* mov ax, [bp-0x12] */
