...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_1575()
        {
            ...
            ii(0x1008_158c, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_158f, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1008_1592, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1008_1599, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_159c, 3); add(eax, 0x2a);                         /* add eax, 0x2a */
            ii(0x1008_159f, 5); call(0x1008_9dd8, 0x8834);              /* call 0x10089dd8 */
            ii(0x1008_15a4, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1008_15a7, 4); cmp(memd[ss, ebp - 0xc], 0);            /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1008_15ab, 2); if(jz(0x1008_15b9, 0xc)) goto l_0x1008_15b9; /* jz 0x100815b9 */
            ii(0x1008_15ad, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1008_15b0, 5); call(0x1008_9f70, 0x89bb);              /* call 0x10089f70 */
            ii(0x1008_15b5, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1008_15b7, 2); if(jz(0x1008_15bb, 0x2)) goto l_0x1008_15bb; /* jz 0x100815bb */
        l_0x1008_15b9:
            ii(0x1008_15b9, 2); jmp(0x1008_15c2, 0x7); goto l_0x1008_15c2; /* jmp 0x100815c2 */
        l_0x1008_15bb:
            ii(0x1008_15bb, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
        l_0x1008_15c2:
            ii(0x1008_15c2, 4); cmp(memd[ss, ebp - 0xc], 0);            /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1008_15c6, 2); if(jnz(0x1008_15d8, 0x10)) goto l_0x1008_15d8; /* jnz 0x100815d8 */
            ii(0x1008_15c8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1008_15d6, 2); if(jg(0x1008_15da, 0x2)) goto l_0x1008_15da; /* jg 0x100815da */
        l_0x1008_15d8:
            ii(0x1008_15d8, 2); jmp(0x1008_15ea, 0x10); goto l_0x1008_15ea; /* jmp 0x100815ea */
        l_0x1008_15da:
            ii(0x1008_15da, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_15dc, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_15df, 3); add(eax, 0x20);                         /* add eax, 0x20 */
            ii(0x1008_15e2, 5); call(0x1008_9c68, 0x8681);              /* call 0x10089c68 */
            ii(0x1008_15e7, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
        l_0x1008_15ea:
            ii(0x1008_15ea, 4); cmp(memd[ss, ebp - 0xc], 0);            /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1008_15ee, 2); if(jz(0x1008_15fc, 0xc)) goto l_0x1008_15fc; /* jz 0x100815fc */
            ii(0x1008_15f0, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1008_15f3, 5); call(0x1008_9f70, 0x8978);              /* call 0x10089f70 */
            ii(0x1008_15f8, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1008_15fa, 2); if(jz(0x1008_15fe, 0x2)) goto l_0x1008_15fe; /* jz 0x100815fe */
        l_0x1008_15fc:
            ii(0x1008_15fc, 2); jmp(0x1008_1605, 0x7); goto l_0x1008_1605; /* jmp 0x10081605 */
        l_0x1008_15fe:
            ii(0x1008_15fe, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
        l_0x1008_1605:
            ii(0x1008_1605, 4); cmp(memd[ss, ebp - 0xc], 0);            /* cmp dword [ebp-0xc], 0x0 */
            ...
            ii(0x1008_1610, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1008_161d:
            ii(0x1008_161d, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1008_1620, 5); call(Definitions.my_ctor_0x101b_4184, -0xab35); /* call 0x10076af0 */
            ii(0x1008_1625, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_1628, 3); mov(al, memb[ds, eax + 0x15]);          /* mov al, [eax+0x15] */
            ii(0x1008_162b, 3); mov(memb[ss, ebp - 0x14], al);          /* mov [ebp-0x14], al */
            ii(0x1008_162e, 5); jmp(0x1008_16a8, 0x75); goto l_0x1008_16a8; /* jmp 0x100816a8 */
        l_0x1008_1633:
            ii(0x1008_1633, 7); mov(memd[ss, ebp - 0x1c], StringDefinitions.InitAttackOn); /* mov dword [ebp-0x1c], 0x101a0228 */
            ii(0x1008_163a, 5); jmp(0x1008_16c3, 0x84); goto l_0x1008_16c3; /* jmp 0x100816c3 */
        l_0x1008_163f:
            ii(0x1008_163f, 7); mov(memd[ss, ebp - 0x1c], StringDefinitions.WaitToAttack); /* mov dword [ebp-0x1c], 0x101a0239 */
            ii(0x1008_1646, 5); jmp(0x1008_16c3, 0x78); goto l_0x1008_16c3; /* jmp 0x100816c3 */
        l_0x1008_164b:
            ii(0x1008_164b, 7); mov(memd[ss, ebp - 0x1c], StringDefinitions.GatherAttackOn); /* mov dword [ebp-0x1c], 0x101a0249 */
            ii(0x1008_1652, 5); jmp(0x1008_16c3, 0x6c); goto l_0x1008_16c3; /* jmp 0x100816c3 */
        l_0x1008_1657:
            ii(0x1008_1657, 7); mov(memd[ss, ebp - 0x1c], StringDefinitions.AdvOn); /* mov dword [ebp-0x1c], 0x101a025a */
            ii(0x1008_165e, 2); jmp(0x1008_16c3, 0x63); goto l_0x1008_16c3; /* jmp 0x100816c3 */
        l_0x1008_1660:
            ii(0x1008_1660, 7); mov(memd[ss, ebp - 0x1c], StringDefinitions.AdvWTransOn); /* mov dword [ebp-0x1c], 0x101a0263 */
            ii(0x1008_1667, 2); jmp(0x1008_16c3, 0x5a); goto l_0x1008_16c3; /* jmp 0x100816c3 */
        l_0x1008_1669:
            ii(0x1008_1669, 7); mov(memd[ss, ebp - 0x1c], StringDefinitions.SearchFor); /* mov dword [ebp-0x1c], 0x101a0273 */
            ii(0x1008_1670, 2); jmp(0x1008_16c3, 0x51); goto l_0x1008_16c3; /* jmp 0x100816c3 */
        l_0x1008_1672:
            ii(0x1008_1672, 7); mov(memd[ss, ebp - 0x1c], StringDefinitions.BoldSearchFor); /* mov dword [ebp-0x1c], 0x101a027f */
            ii(0x1008_1679, 2); jmp(0x1008_16c3, 0x48); goto l_0x1008_16c3; /* jmp 0x100816c3 */
        l_0x1008_167b:
            ii(0x1008_167b, 7); mov(memd[ss, ebp - 0x1c], StringDefinitions.Attack6); /* mov dword [ebp-0x1c], 0x101a0290 */
        ...
        l_0x1008_16a8:
            ii(0x1008_16a8, 3); mov(al, memb[ss, ebp - 0x14]);          /* mov al, [ebp-0x14] */
            ii(0x1008_16ab, 3); mov(memb[ss, ebp - 0x20], al);          /* mov [ebp-0x20], al */
            ii(0x1008_16ae, 4); cmp(memb[ss, ebp - 0x20], 0x7);         /* cmp byte [ebp-0x20], 0x7 */
            ii(0x1008_16b2, 2); if(ja(0x1008_1684, -0x30)) goto l_0x1008_1684; /* ja 0x10081684 */
            ii(0x1008_16b4, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1008_16b6, 3); mov(al, memb[ss, ebp - 0x20]);          /* mov al, [ebp-0x20] */
        ...
        l_0x1008_16c3:
            ii(0x1008_16c3, 3); lea(edx, memd[ss, ebp - 0x24]);         /* lea edx, [ebp-0x24] */
            ii(0x1008_16c6, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1008_16c9, 5); call(0x100a_2d3d, 0x2_166f);            /* call 0x100a2d3d */
            ii(0x1008_16ce, 3); lea(ebx, memd[ss, ebp - 0x18]);         /* lea ebx, [ebp-0x18] */
            ...
            ii(0x1008_16da, 4); movsx(eax, memw[ss, ebp - 0x16]);       /* movsx eax, word [ebp-0x16] */
            ii(0x1008_16de, 1); inc(eax);                               /* inc eax */
            ii(0x1008_16df, 1); push(eax);                              /* push eax */
            ii(0x1008_16e0, 4); movsx(eax, memw[ss, ebp - 0x18]);       /* movsx eax, word [ebp-0x18] */
            ii(0x1008_16e4, 1); inc(eax);                               /* inc eax */
            ii(0x1008_16e5, 1); push(eax);                              /* push eax */
            ii(0x1008_16e6, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1008_16e9, 5); call(0x1008_9f70, 0x8882);              /* call 0x10089f70 */
            ii(0x1008_16ee, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1008_16fd, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ...
            ii(0x1008_1707, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_1715, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1008_177e, 6); lea(eax, memd[ss, ebp - 0x88]);         /* lea eax, [ebp-0x88] */
            ...
            ii(0x1008_178d, 6); lea(edx, memd[ss, ebp - 0x88]);         /* lea edx, [ebp-0x88] */
            ii(0x1008_1793, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_1796, 5); call(Definitions.sys_strcat, 0xe_4796); /* call 0x10165f31 */
        l_0x1008_179b:
            ii(0x1008_179b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_179e, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1008_17a1, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
