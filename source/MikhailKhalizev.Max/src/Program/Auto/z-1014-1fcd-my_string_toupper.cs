...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void my_string_toupper()
        {
            ...
            ii(0x1014_1fe5, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_1fe8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_1feb, 5); call(Definitions.my_string_make_single_ref, 0x36c); /* call 0x1014235c */
            ii(0x1014_1ff0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_1ffa, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_1ffd, 2); jmp(0x1014_2005, 0x6); goto l_0x1014_2005; /* jmp 0x10142005 */
        l_0x1014_1fff:
            ii(0x1014_1fff, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_2002, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x1014_2005:
            ii(0x1014_2005, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_200d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_201e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_2021, 2); mov(memb[ds, eax], dl);                 /* mov [eax], dl */
            ii(0x1014_2023, 2); jmp(0x1014_1fff, -0x26); goto l_0x1014_1fff; /* jmp 0x10141fff */
        l_0x1014_2025:
            ii(0x1014_2025, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_2028, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_202b, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
