...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_d5fb()
        {
            ...
            ii(0x1008_d613, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x1008_d621, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_d624, 3); add(eax, 0x15);                         /* add eax, 0x15 */
            ii(0x1008_d627, 5); call(0x1007_6574, -0x1_70b8);           /* call 0x10076574 */
            ii(0x1008_d62c, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ...
            ii(0x1008_d63e, 2); if(jnz(0x1008_d642, 0x2)) goto l_0x1008_d642; /* jnz 0x1008d642 */
        l_0x1008_d640:
            ii(0x1008_d640, 2); jmp(0x1008_d644, 0x2); goto l_0x1008_d644; /* jmp 0x1008d644 */
        l_0x1008_d642:
        ...
        l_0x1008_d644:
            ...
            ii(0x1008_d650, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_d65d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_d660, 3); add(eax, 0x15);                         /* add eax, 0x15 */
            ii(0x1008_d663, 5); call(0x1007_6574, -0x1_70f4);           /* call 0x10076574 */
            ii(0x1008_d668, 4); mov(dx, memw[ds, edx + 0x1a]);          /* mov dx, [edx+0x1a] */
            ii(0x1008_d66c, 4); mov(memw[ds, eax + 0x41], dx);          /* mov [eax+0x41], dx */
            ii(0x1008_d670, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_d67d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_d680, 3); add(eax, 0x15);                         /* add eax, 0x15 */
            ii(0x1008_d683, 5); call(0x1007_6574, -0x1_7114);           /* call 0x10076574 */
            ii(0x1008_d688, 4); mov(dx, memw[ds, edx + 0x1c]);          /* mov dx, [edx+0x1c] */
            ii(0x1008_d68c, 4); mov(memw[ds, eax + 0x43], dx);          /* mov [eax+0x43], dx */
            ii(0x1008_d690, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_d693, 4); mov(memb[ds, eax + 0x25], 0x7);         /* mov byte [eax+0x25], 0x7 */
            ii(0x1008_d697, 5); mov(ebx, 0xd);                          /* mov ebx, 0xd */
            ii(0x1008_d69c, 5); mov(edx, 0x4);                          /* mov edx, 0x4 */
            ii(0x1008_d6a1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
