...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_96ae()
        {
            ...
            ii(0x1012_96c4, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_96c7, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1012_96ca, 3); mov(memd[ss, ebp - 0xc], ebx);          /* mov [ebp-0xc], ebx */
            ii(0x1012_96cd, 5); mov(edx, 0x225);                        /* mov edx, 0x225 */
            ii(0x1012_96d2, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1012_96df, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1012_96e2, 5); cmp(memw[ss, ebp - 0x10], 0);           /* cmp word [ebp-0x10], 0x0 */
            ii(0x1012_96e7, 2); if(jz(0x1012_96f2, 0x9)) goto l_0x1012_96f2; /* jz 0x101296f2 */
            ii(0x1012_96e9, 7); cmp(memd[ds, 0x101c_5624], 0);          /* cmp dword [0x101c5624], 0x0 */
            ii(0x1012_96f0, 2); if(jnz(0x1012_96f4, 0x2)) goto l_0x1012_96f4; /* jnz 0x101296f4 */
        l_0x1012_96f2:
            ii(0x1012_96f2, 2); jmp(0x1012_974c, 0x58); goto l_0x1012_974c; /* jmp 0x1012974c */
        l_0x1012_96f4:
            ii(0x1012_96f4, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1012_96f7, 3); inc(memd[ss, ebp - 0x10]);              /* inc dword [ebp-0x10] */
            ii(0x1012_96fa, 1); cwde();                                 /* cwde */
            ii(0x1012_96fb, 3); add(eax, memd[ss, ebp - 0xc]);          /* add eax, [ebp-0xc] */
            ...
            ii(0x1012_9708, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_970b, 6); mov(memw[ds, 0x101c_5c1d], ax);         /* mov [0x101c5c1d], ax */
            ii(0x1012_9711, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1012_9714, 6); mov(memw[ds, 0x101c_5c1f], ax);         /* mov [0x101c5c1f], ax */
            ii(0x1012_971a, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ...
            ii(0x1012_972c, 3); lea(ebx, memd[ss, ebp - 0x30]);         /* lea ebx, [ebp-0x30] */
            ...
            ii(0x1012_9743, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
