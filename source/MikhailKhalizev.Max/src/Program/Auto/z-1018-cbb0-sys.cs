...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_cbb0()
        {
            ...
            ii(0x1018_cbc6, 3);  lea(eax, memd[ss, ebp - 64]);         /* lea eax, [ebp-0x40] */
            ...
            ii(0x1018_cbd7, 2);  mov(dl, 7);                           /* mov dl, 0x7 */
            ii(0x1018_cbd9, 4);  mov(memw[ss, ebp - 40], si);          /* mov [ebp-0x28], si */
            ii(0x1018_cbdd, 3);  mov(memb[ss, ebp - 35], ah);          /* mov [ebp-0x23], ah */
            ii(0x1018_cbe0, 3);  mov(memb[ss, ebp - 36], dl);          /* mov [ebp-0x24], dl */
            ii(0x1018_cbe3, 6);  mov(ax, memw[ds, 0x1020_b708]);       /* mov ax, [0x1020b708] */
            ii(0x1018_cbe9, 5);  mov(edx, 0x800);                      /* mov edx, 0x800 */
            ii(0x1018_cbee, 4);  mov(memw[ss, ebp - 16], ax);          /* mov [ebp-0x10], ax */
            ii(0x1018_cbf2, 4);  mov(memw[ss, ebp - 18], dx);          /* mov [ebp-0x12], dx */
            ii(0x1018_cbf6, 2);  xor(dh, dh);                          /* xor dh, dh */
            ii(0x1018_cbf8, 5);  mov(eax, 0x10);                       /* mov eax, 0x10 */
            ii(0x1018_cbfd, 3);  mov(memb[ss, ebp - 47], dh);          /* mov [ebp-0x2f], dh */
            ii(0x1018_cc00, 3);  mov(memb[ss, ebp - 48], dh);          /* mov [ebp-0x30], dh */
            ii(0x1018_cc03, 3);  lea(edx, memd[ss, ebp - 64]);         /* lea edx, [ebp-0x40] */
            ii(0x1018_cc06, 4);  mov(memw[ss, ebp - 44], cx);          /* mov [ebp-0x2c], cx */
            ii(0x1018_cc0a, 5);  call(/* sys */ 0x1019_4540, 0x7931);  /* call 0x10194540 */
            ii(0x1018_cc0f, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x1018_cc11, 2);  if(jz(0x1018_cc1a, 7)) goto l_0x1018_cc1a;/* jz 0x1018cc1a */
            ii(0x1018_cc13, 5);  cmp(memw[ss, ebp - 36], 0x4f);        /* cmp word [ebp-0x24], 0x4f */
            ii(0x1018_cc18, 2);  if(jz(0x1018_cc1e, 4)) goto l_0x1018_cc1e;/* jz 0x1018cc1e */
        l_0x1018_cc1a:
            ii(0x1018_cc1a, 2);  xor(eax, eax);                        /* xor eax, eax */
            ii(0x1018_cc1c, 2);  jmp(0x1018_cc23, 5); goto l_0x1018_cc23;/* jmp 0x1018cc23 */
        l_0x1018_cc1e:
            ii(0x1018_cc1e, 5);  mov(eax, 1);                          /* mov eax, 0x1 */
        l_0x1018_cc23:
            ii(0x1018_cc23, 3);  lea(esp, memd[ss, ebp - 12]);         /* lea esp, [ebp-0xc] */
