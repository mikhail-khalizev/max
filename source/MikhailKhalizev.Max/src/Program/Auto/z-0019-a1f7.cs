...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("2fe741d3-5676-4ebb-9bba-710ffee9d7fd")]
        public void Method_0019_a1f7()
        {
            ii(0x19_a1f7, 4); enterw(0x34, 0);                          /* enter 0x34, 0x0 */
            ii(0x19_a1fb, 1); pushw(si);                                /* push si */
            ii(0x19_a1fc, 3); pushw(memw_a16[ss, bp + 0x4]);            /* push word [bp+0x4] */
            ii(0x19_a1ff, 3); callw(0x19_a14c, -0xb6);                  /* call 0xa14c */
            ii(0x19_a202, 3); mov(memw_a16[ss, bp - 0x30], ax);         /* mov [bp-0x30], ax */
            ii(0x19_a205, 3); mov(memw_a16[ss, bp - 0x2e], dx);         /* mov [bp-0x2e], dx */
            ii(0x19_a208, 2); or(dx, ax);                               /* or dx, ax */
            ii(0x19_a20a, 2); if(jnzw(0x19_a20f, 0x3)) goto l_0x19_a20f; /* jnz 0xa20f */
            ii(0x19_a20c, 3); jmpw(0x19_a49c, 0x28d); goto l_0x19_a49c; /* jmp 0xa49c */
        l_0x19_a20f:
            ii(0x19_a20f, 3); mov(memw_a16[ss, bp - 0x32], ax);         /* mov [bp-0x32], ax */
            ii(0x19_a212, 4); mov(cx, memw_a16[ds, 0x3292]);            /* mov cx, [0x3292] */
            ii(0x19_a216, 4); or(cx, memw_a16[ds, 0x3290]);             /* or cx, [0x3290] */
            ii(0x19_a21a, 2); if(jzw(0x19_a22f, 0x13)) goto l_0x19_a22f; /* jz 0xa22f */
            ii(0x19_a21c, 2); mov(bx, ax);                              /* mov bx, ax */
            ii(0x19_a21e, 3); mov(es, memw_a16[ss, bp - 0x2e]);         /* mov es, [bp-0x2e] */
            ii(0x19_a221, 6); cmp(memw_a16[es, bx + 0x12a], -0x1 /* 0xff */); /* cmp word [es:bx+0x12a], 0xffff */
            ii(0x19_a227, 2); if(jzw(0x19_a22f, 0x6)) goto l_0x19_a22f; /* jz 0xa22f */
            ii(0x19_a229, 4); mov(memb_a16[ss, bp - 0x34], 0x1);        /* mov byte [bp-0x34], 0x1 */
            ii(0x19_a22d, 2); jmpw(0x19_a233, 0x4); goto l_0x19_a233;   /* jmp 0xa233 */
        l_0x19_a22f:
            ii(0x19_a22f, 4); mov(memb_a16[ss, bp - 0x34], 0);          /* mov byte [bp-0x34], 0x0 */
        l_0x19_a233:
            ii(0x19_a233, 3); mov(ax, memw_a16[ss, bp - 0x32]);         /* mov ax, [bp-0x32] */
            ii(0x19_a236, 3); add(ax, 0xea);                            /* add ax, 0xea */
            ii(0x19_a239, 3); pushw(memw_a16[ss, bp - 0x2e]);           /* push word [bp-0x2e] */
            ii(0x19_a23c, 1); pushw(ax);                                /* push ax */
            ii(0x19_a23d, 3); pushw(memw_a16[ss, bp + 0x4]);            /* push word [bp+0x4] */
            ii(0x19_a240, 1); pushw(ds);                                /* push ds */
            ii(0x19_a241, 3); pushw(0x1fd4);                            /* push 0x1fd4 */
            ii(0x19_a244, 3); callw(0x1a_1066, 0x6e1f);                 /* call 0x1066 */
            ii(0x19_a247, 3); add(sp, 0xa);                             /* add sp, 0xa */
            ii(0x19_a24a, 3); mov(es, memw_a16[ss, bp - 0x2e]);         /* mov es, [bp-0x2e] */
            ii(0x19_a24d, 3); mov(bx, memw_a16[ss, bp - 0x32]);         /* mov bx, [bp-0x32] */
            ii(0x19_a250, 4); mov(ax, memw_a16[es, bx + 0x38]);         /* mov ax, [es:bx+0x38] */
            ii(0x19_a254, 4); mov(dx, memw_a16[es, bx + 0x3a]);         /* mov dx, [es:bx+0x3a] */
            ii(0x19_a258, 3); mov(memw_a16[ss, bp - 0x2a], ax);         /* mov [bp-0x2a], ax */
            ii(0x19_a25b, 3); mov(memw_a16[ss, bp - 0x28], dx);         /* mov [bp-0x28], dx */
            ii(0x19_a25e, 2); or(dx, ax);                               /* or dx, ax */
            ii(0x19_a260, 2); if(jzw(0x19_a2a8, 0x46)) goto l_0x19_a2a8; /* jz 0xa2a8 */
            ii(0x19_a262, 3); les(bx, ss, bp - 0x2a);                   /* les bx, [bp-0x2a] */
            ii(0x19_a265, 5); cmp(memw_a16[es, bx + 0x4], 0);           /* cmp word [es:bx+0x4], 0x0 */
            ii(0x19_a26a, 2); if(jzw(0x19_a294, 0x28)) goto l_0x19_a294; /* jz 0xa294 */
            ii(0x19_a26c, 3); lea(ax, bp - 0x26);                       /* lea ax, [bp-0x26] */
            ii(0x19_a26f, 1); pushw(ss);                                /* push ss */
            ii(0x19_a270, 1); pushw(ax);                                /* push ax */
            ii(0x19_a271, 3); callw(0x19_e2de, 0x406a);                 /* call 0xe2de */
            ii(0x19_a274, 3); mov(ax, memw_a16[ss, bp - 0x2a]);         /* mov ax, [bp-0x2a] */
            ii(0x19_a277, 3); mov(dx, memw_a16[ss, bp - 0x28]);         /* mov dx, [bp-0x28] */
            ii(0x19_a27a, 3); add(ax, 0x6);                             /* add ax, 0x6 */
            ii(0x19_a27d, 1); pushw(dx);                                /* push dx */
            ii(0x19_a27e, 1); pushw(ax);                                /* push ax */
            ii(0x19_a27f, 3); callw(0x19_e33a, 0x40b8);                 /* call 0xe33a */
            ii(0x19_a282, 3); les(bx, ss, bp - 0x2a);                   /* les bx, [bp-0x2a] */
            ii(0x19_a285, 4); pushw(memw_a16[es, bx + 0x4]);            /* push word [es:bx+0x4] */
            ii(0x19_a289, 3); callw(0x19_febc, 0x5c30);                 /* call 0xfebc */
