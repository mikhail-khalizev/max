...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_aa28()
        {
            ...
            ii(0x100a_aa3f, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_aa42, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_aa45, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100a_aa49, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100a_aa4c, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100a_aa4e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_aa51, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
