...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_35d0()
        {
            ...
            ii(0x1016_35e8, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1016_35eb, 5); mov(eax, 0x101c_b100);                  /* mov eax, 0x101cb100 */
            ii(0x1016_35f0, 5); call(0x1012_0d64, -0x4_2891);           /* call 0x10120d64 */
            ii(0x1016_35f5, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1016_35f8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
