...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_5360()
        {
            ...
            ii(0x100d_5368, 6); sub(esp, 4);                            /* sub esp, 0x4 */
            ii(0x100d_536e, 7); mov(memd[ss, ebp - 4], 0xffff_ffff);    /* mov dword [ebp-0x4], 0xffffffff */
            ii(0x100d_5375, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
