...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_7e7a()
        {
            ...
            ii(0x100a_7e91, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100a_7e94, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x100a_7e97, 7); mov(memd[ss, ebp - 16], 0);             /* mov dword [ebp-0x10], 0x0 */
            ii(0x100a_7e9e, 2); jmp(0x100a_7ea6, 6); goto l_0x100a_7ea6; /* jmp 0x100a7ea6 */
        l_0x100a_7ea0:
            ii(0x100a_7ea0, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_7ea3, 3); inc(memd[ss, ebp - 16]);                /* inc dword [ebp-0x10] */
        l_0x100a_7ea6:
            ii(0x100a_7ea6, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100a_7ea9, 3); add(eax, 0x3e);                         /* add eax, 0x3e */
            ii(0x100a_7eac, 5); call(Definitions.my_3_get_count, -0x1_ca31); /* call 0x1008b480 */
            ii(0x100a_7eb1, 4); cmp(ax, memw[ss, ebp - 16]);            /* cmp ax, [ebp-0x10] */
            ii(0x100a_7eb5, 2); if(jle(0x100a_7ede, 0x27)) goto l_0x100a_7ede; /* jle 0x100a7ede */
            ii(0x100a_7eb7, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ii(0x100a_7ebb, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100a_7ebe, 3); add(eax, 0x3e);                         /* add eax, 0x3e */
            ii(0x100a_7ec1, 5); call(0x100a_aa28, 0x2b62);              /* call 0x100aaa28 */
            ii(0x100a_7ec6, 3); mov(ebx, memd[ss, ebp - 4]);            /* mov ebx, [ebp-0x4] */
            ...
            ii(0x100a_7ed4, 2); if(jz(0x100a_7edc, 6)) goto l_0x100a_7edc; /* jz 0x100a7edc */
            ii(0x100a_7ed6, 4); mov(memb[ss, ebp - 12], 0);             /* mov byte [ebp-0xc], 0x0 */
        ...
        l_0x100a_7ede:
            ii(0x100a_7ede, 7); mov(memd[ss, ebp - 16], 0);             /* mov dword [ebp-0x10], 0x0 */
            ii(0x100a_7ee5, 2); jmp(0x100a_7eed, 6); goto l_0x100a_7eed; /* jmp 0x100a7eed */
        l_0x100a_7ee7:
            ii(0x100a_7ee7, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_7eea, 3); inc(memd[ss, ebp - 16]);                /* inc dword [ebp-0x10] */
        l_0x100a_7eed:
            ii(0x100a_7eed, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100a_7ef0, 3); add(eax, 0x1e);                         /* add eax, 0x1e */
            ii(0x100a_7ef3, 5); call(Definitions.my_3_get_count, -0x1_ca78); /* call 0x1008b480 */
            ii(0x100a_7ef8, 4); cmp(ax, memw[ss, ebp - 16]);            /* cmp ax, [ebp-0x10] */
            ii(0x100a_7efc, 2); if(jle(0x100a_7f25, 0x27)) goto l_0x100a_7f25; /* jle 0x100a7f25 */
            ii(0x100a_7efe, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ii(0x100a_7f02, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100a_7f05, 3); add(eax, 0x1e);                         /* add eax, 0x1e */
            ii(0x100a_7f08, 5); call(0x100a_a700, 0x27f3);              /* call 0x100aa700 */
            ii(0x100a_7f0d, 3); mov(ebx, memd[ss, ebp - 4]);            /* mov ebx, [ebp-0x4] */
            ...
            ii(0x100a_7f1b, 2); if(jz(0x100a_7f23, 6)) goto l_0x100a_7f23; /* jz 0x100a7f23 */
            ii(0x100a_7f1d, 4); mov(memb[ss, ebp - 12], 0);             /* mov byte [ebp-0xc], 0x0 */
            ii(0x100a_7f21, 2); jmp(0x100a_7f29, 6); goto l_0x100a_7f29; /* jmp 0x100a7f29 */
        l_0x100a_7f23:
            ii(0x100a_7f23, 2); jmp(0x100a_7ee7, -0x3e); goto l_0x100a_7ee7; /* jmp 0x100a7ee7 */
        l_0x100a_7f25:
            ii(0x100a_7f25, 4); mov(memb[ss, ebp - 12], 1);             /* mov byte [ebp-0xc], 0x1 */
        l_0x100a_7f29:
            ii(0x100a_7f29, 3); mov(al, memb[ss, ebp - 12]);            /* mov al, [ebp-0xc] */
