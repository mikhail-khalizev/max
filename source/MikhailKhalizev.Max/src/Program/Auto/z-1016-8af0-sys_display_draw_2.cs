...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1016_8b0a:
            ...
            ii(0x1016_8b10, 2); if(jnz(0x1016_8b16, 0x4)) goto l_0x1016_8b16; /* jnz 0x10168b16 */
        ...
        l_0x1016_8b16:
            ...
            ii(0x1016_8b20, 3); ret(0x4); return;                       /* ret 0x4 */
        l_0x1016_8b23:
            ...
            ii(0x1016_8b3a, 3); ret(0x4); return;                       /* ret 0x4 */
        l_0x1016_8b3d:
            ii(0x1016_8b3d, 4); test(memb[ds, eax + 0x6], 0x1);         /* test byte [eax+0x6], 0x1 */
            ...
            ii(0x1016_8b4d, 3); ret(0x4); return;                       /* ret 0x4 */
        l_0x1016_8b50:
            ii(0x1016_8b50, 3); mov(edx, memd[ds, eax + 0x48]);         /* mov edx, [eax+0x48] */
            ii(0x1016_8b53, 3); cmp(edx, memd[ds, eax + 0x30]);         /* cmp edx, [eax+0x30] */
            ii(0x1016_8b56, 2); if(jnz(0x1016_8b5d, 0x5)) goto l_0x1016_8b5d; /* jnz 0x10168b5d */
            ii(0x1016_8b58, 3); mov(memd[ds, eax + 0x48], edi);         /* mov [eax+0x48], edi */
            ii(0x1016_8b5b, 2); jmp(0x1016_8b6f, 0x12); goto l_0x1016_8b6f; /* jmp 0x10168b6f */
        l_0x1016_8b5d:
            ii(0x1016_8b5d, 3); cmp(edx, memd[ds, eax + 0x34]);         /* cmp edx, [eax+0x34] */
            ii(0x1016_8b60, 2); if(jnz(0x1016_8b67, 0x5)) goto l_0x1016_8b67; /* jnz 0x10168b67 */
            ii(0x1016_8b62, 3); mov(memd[ds, eax + 0x48], ebx);         /* mov [eax+0x48], ebx */
            ii(0x1016_8b65, 2); jmp(0x1016_8b6f, 0x8); goto l_0x1016_8b6f; /* jmp 0x10168b6f */
        l_0x1016_8b67:
            ii(0x1016_8b67, 3); cmp(edx, memd[ds, eax + 0x38]);         /* cmp edx, [eax+0x38] */
            ii(0x1016_8b6a, 2); if(jnz(0x1016_8b6f, 0x3)) goto l_0x1016_8b6f; /* jnz 0x10168b6f */
            ii(0x1016_8b6c, 3); mov(memd[ds, eax + 0x48], ecx);         /* mov [eax+0x48], ecx */
        l_0x1016_8b6f:
            ii(0x1016_8b6f, 3); mov(memd[ds, esi + 0x30], edi);         /* mov [esi+0x30], edi */
            ii(0x1016_8b72, 2); push(0);                                /* push 0x0 */
            ii(0x1016_8b74, 3); mov(memd[ds, esi + 0x34], ebx);         /* mov [esi+0x34], ebx */
            ii(0x1016_8b77, 2); mov(eax, esi);                          /* mov eax, esi */
            ii(0x1016_8b79, 3); mov(memd[ds, esi + 0x38], ecx);         /* mov [esi+0x38], ecx */
            ii(0x1016_8b7c, 4); mov(ecx, memd[ss, esp + 0x14]);         /* mov ecx, [esp+0x14] */
            ii(0x1016_8b80, 4); mov(edx, memd[ss, esp + 0x4]);          /* mov edx, [esp+0x4] */
            ii(0x1016_8b84, 3); mov(ebx, memd[ds, esi + 0x48]);         /* mov ebx, [esi+0x48] */
        ...
        l_0x1016_8b8e:
            ...
            ii(0x1016_8b93, 3); ret(0x4);                               /* ret 0x4 */
        }
    }
}
