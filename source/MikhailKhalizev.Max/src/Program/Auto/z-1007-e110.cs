...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_e110()
        {
            ...
            ii(0x1007_e128, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_e12b, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1007_e132, 2); jmp(0x1007_e13a, 0x6); goto l_0x1007_e13a; /* jmp 0x1007e13a */
        l_0x1007_e134:
            ii(0x1007_e134, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_e137, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x1007_e13a:
            ii(0x1007_e13a, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1007_e13e, 3); cmp(eax, 0x8);                          /* cmp eax, 0x8 */
            ii(0x1007_e141, 2); if(jge(0x1007_e159, 0x16)) goto l_0x1007_e159; /* jge 0x1007e159 */
            ii(0x1007_e143, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1007_e147, 3); imul(edx, eax, 0x16);                   /* imul edx, eax, 0x16 */
            ii(0x1007_e14a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1007_e159:
            ...
            ii(0x1007_e15b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_e15e, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x1007_e161, 5); call(0x1008_afe4, 0xce7e);              /* call 0x1008afe4 */
            ii(0x1007_e166, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
