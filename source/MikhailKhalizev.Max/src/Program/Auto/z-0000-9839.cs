...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x9857:
            ...
            ii(0x9861, 4);    cmp(memw[ss, bp + 0x6], 0);               /* cmp word [bp+0x6], 0x0 */
            ii(0x9865, 2);    if(jz(0x987a, 0x13)) goto l_0x987a;       /* jz 0x987a */
            ii(0x9867, 2);    push(0);                                  /* push 0x0 */
            ii(0x9869, 3);    push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x986c, 3);    push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x986f, 3);    push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
        ...
        l_0x9883:
            ii(0x9883, 3);    mov(si, memw[ss, bp + 0x8]);              /* mov si, [bp+0x8] */
            ii(0x9886, 2);    cmp(si, di);                              /* cmp si, di */
            ii(0x9888, 2);    if(ja(0x988e, 0x4)) goto l_0x988e;        /* ja 0x988e */
            ii(0x988a, 2);    or(si, si);                               /* or si, si */
            ii(0x988c, 2);    if(jnz(0x9890, 0x2)) goto l_0x9890;       /* jnz 0x9890 */
        l_0x988e:
            ii(0x988e, 2);    mov(si, di);                              /* mov si, di */
        l_0x9890:
            ii(0x9890, 1);    push(si);                                 /* push si */
            ii(0x9891, 3);    push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x9894, 3);    push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ...
            ii(0x98a3, 3);    add(memw[ss, bp + 0x6], si);              /* add [bp+0x6], si */
            ii(0x98a6, 4);    add(memw[ds, 0x11d0], si);                /* add [0x11d0], si */
            ii(0x98aa, 3);    sub(memw[ss, bp + 0x8], si);              /* sub [bp+0x8], si */
            ii(0x98ad, 2);    if(jnz(0x984a, -0x65)) goto l_0x984a;     /* jnz 0x984a */
            ii(0x98af, 2);    jmp(0x98b8, 0x7); goto l_0x98b8;          /* jmp 0x98b8 */
        l_0x98b1:
        ...
        l_0x98b8:
            ii(0x98b8, 3);    mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ...
            ii(0x98c6, 3);    mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
