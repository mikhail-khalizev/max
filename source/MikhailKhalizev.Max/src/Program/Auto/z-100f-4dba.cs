...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("690fccc4-df64-44cc-b73c-6f78b59a7bcb")]
        public void Method_100f_4dba()
        {
            ii(0x100f_4dba, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x100f_4dbf, 5); calld(Definitions.sys_check_available_stack_size, 0x7_0f8e); /* call 0x10165d52 */
            ...
            ii(0x100f_4dd9, 5); calld(0x100c_fb73, -0x2_526b);          /* call 0x100cfb73 */
            ...
            ii(0x100f_4e36, 5); calld(0x1007_5fdc, -0x7_ee5f);          /* call 0x10075fdc */
            ii(0x100f_4e3b, 5); mov(memb_a32[ds, 0x101c_37c9], al);     /* mov [0x101c37c9], al */
            ii(0x100f_4e40, 5); calld(0x1012_93c3, 0x3_457e);           /* call 0x101293c3 */
        l_0x100f_4e45:
            ii(0x100f_4e45, 5); mov(eax, 0x2);                          /* mov eax, 0x2 */
            ii(0x100f_4e4a, 5); calld(0x1007_5fdc, -0x7_ee73);          /* call 0x10075fdc */
            ...
            ii(0x100f_4e60, 5); calld(0x1007_5fdc, -0x7_ee89);          /* call 0x10075fdc */
            ii(0x100f_4e65, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100f_4e6a, 5); calld(0x1007_1cca, -0x8_31a5);          /* call 0x10071cca */
        l_0x100f_4e6f:
        ...
        l_0x100f_4e76:
            ...
            ii(0x100f_4e8d, 5); calld(0x1007_5fdc, -0x7_eeb6);          /* call 0x10075fdc */
        ...
        l_0x100f_4ea6:
            ...
            ii(0x100f_4eab, 5); calld(0x1007_65d0, -0x7_e8e0);          /* call 0x100765d0 */
