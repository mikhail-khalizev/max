...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0xb012, 4);    enter(0x4, 0);                            /* enter 0x4, 0x0 */
            ii(0xb016, 5);    test(memb[ds, 0x47], 0x2);                /* test byte [0x47], 0x2 */
            ii(0xb01b, 2);    if(jz(0xb095, 0x78)) goto l_0xb095;       /* jz 0xb095 */
            ii(0xb01d, 5);    mov(memw[ss, bp - 0x4], 0xa000);          /* mov word [bp-0x4], 0xa000 */
            ii(0xb022, 5);    mov(memw[ss, bp - 0x2], 0xf);             /* mov word [bp-0x2], 0xf */
        l_0xb027:
            ii(0xb027, 4);    cmp(memw[ss, bp - 0x2], 0xf);             /* cmp word [bp-0x2], 0xf */
            ii(0xb02b, 2);    if(jg(0xb07e, 0x51)) goto l_0xb07e;       /* jg 0xb07e */
            ii(0xb02d, 2);    if(jl(0xb035, 0x6)) goto l_0xb035;        /* jl 0xb035 */
            ii(0xb02f, 4);    cmp(memw[ss, bp - 0x4], -0x1 /* 0xff */); /* cmp word [bp-0x4], 0xffff */
            ii(0xb033, 2);    if(jae(0xb07e, 0x49)) goto l_0xb07e;      /* jae 0xb07e */
        l_0xb035:
            ii(0xb035, 3);    push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0xb038, 3);    push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0xb044, 3);    mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0xb047, 3);    mov(dx, memw[ss, bp - 0x2]);              /* mov dx, [bp-0x2] */
            ...
            ii(0xb060, 3);    mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0xb063, 3);    mov(dx, memw[ss, bp - 0x2]);              /* mov dx, [bp-0x2] */
            ...
            ii(0xb073, 5);    add(memw[ss, bp - 0x4], 0x400);           /* add word [bp-0x4], 0x400 */
            ii(0xb078, 4);    adc(memw[ss, bp - 0x2], 0);               /* adc word [bp-0x2], 0x0 */
            ii(0xb07c, 2);    jmp(0xb027, -0x57); goto l_0xb027;        /* jmp 0xb027 */
        l_0xb07e:
            ii(0xb07e, 3);    mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0xb081, 3);    add(ah, 0x60);                            /* add ah, 0x60 */
            ii(0xb084, 3);    mov(bx, memw[ss, bp + 0x4]);              /* mov bx, [bp+0x4] */
            ii(0xb087, 2);    mov(memw[ds, bx], ax);                    /* mov [bx], ax */
            ii(0xb089, 2);    or(ax, ax);                               /* or ax, ax */
            ii(0xb08b, 2);    if(jz(0xb095, 0x8)) goto l_0xb095;        /* jz 0xb095 */
        ...
        l_0xb095:
            ii(0xb095, 5);    and(memb[ds, 0x47], -0x3 /* 0xfd */);     /* and byte [0x47], 0xfd */
