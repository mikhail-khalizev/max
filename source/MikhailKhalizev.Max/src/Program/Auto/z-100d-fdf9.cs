...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_fdf9()
        {
            ...
            ii(0x100d_fe0f, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100d_fe12, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100d_fe15, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ii(0x100d_fe18, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100d_fe1c, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x100d_fe35, 3); lea(ebx, memd[ss, ebp - 0x14]);         /* lea ebx, [ebp-0x14] */
            ...
            ii(0x100d_fe41, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100d_fe45, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x100d_fe5c, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x100d_fe5f, 5); call(0x1007_6800, -0x6_9664);           /* call 0x10076800 */
            ii(0x100d_fe64, 4); movsx(ebx, memb[ss, ebp - 0x4]);        /* movsx ebx, byte [ebp-0x4] */
            ii(0x100d_fe68, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100d_fe6c, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x100d_fe70, 5); call(0x100d_fd69, -0x10c);              /* call 0x100dfd69 */
            ii(0x100d_fe75, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100d_fe78, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ii(0x100d_fe7b, 3); mov(memb[ss, ebp - 0x10], al);          /* mov [ebp-0x10], al */
            ii(0x100d_fe7e, 5); jmp(0x100d_ff58, 0xd5); goto l_0x100d_ff58; /* jmp 0x100dff58 */
        l_0x100d_fe83:
            ii(0x100d_fe83, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
            ii(0x100d_fe87, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100d_fe89, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x100d_fe8d, 5); call(0x1013_3743, 0x5_38b1);            /* call 0x10133743 */
            ii(0x100d_fe92, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x100d_fe95, 5); jmp(0x100d_ff75, 0xdb); goto l_0x100d_ff75; /* jmp 0x100dff75 */
        l_0x100d_fe9a:
            ii(0x100d_fe9a, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
            ii(0x100d_fe9e, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x100d_fea3, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x100d_fea7, 5); call(0x1013_3743, 0x5_3897);            /* call 0x10133743 */
            ii(0x100d_feac, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x100d_feaf, 5); jmp(0x100d_ff75, 0xc1); goto l_0x100d_ff75; /* jmp 0x100dff75 */
        l_0x100d_feb4:
            ii(0x100d_feb4, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
            ii(0x100d_feb8, 5); mov(edx, 0x2);                          /* mov edx, 0x2 */
            ii(0x100d_febd, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x100d_fec1, 5); call(0x1013_3743, 0x5_387d);            /* call 0x10133743 */
            ii(0x100d_fec6, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x100d_fec9, 5); jmp(0x100d_ff75, 0xa7); goto l_0x100d_ff75; /* jmp 0x100dff75 */
        l_0x100d_fece:
            ii(0x100d_fece, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
            ii(0x100d_fed2, 5); mov(edx, 0x3);                          /* mov edx, 0x3 */
            ii(0x100d_fed7, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x100d_fedb, 5); call(0x1013_3743, 0x5_3863);            /* call 0x10133743 */
            ii(0x100d_fee0, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x100d_fee3, 5); jmp(0x100d_ff75, 0x8d); goto l_0x100d_ff75; /* jmp 0x100dff75 */
        l_0x100d_fee8:
            ii(0x100d_fee8, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
            ii(0x100d_feec, 5); mov(edx, 0x4);                          /* mov edx, 0x4 */
            ii(0x100d_fef1, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x100d_fef5, 5); call(0x1013_3743, 0x5_3849);            /* call 0x10133743 */
            ii(0x100d_fefa, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x100d_fefd, 5); jmp(0x100d_ff75, 0x73); goto l_0x100d_ff75; /* jmp 0x100dff75 */
        l_0x100d_ff02:
            ii(0x100d_ff02, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
            ii(0x100d_ff06, 5); mov(edx, 0x6);                          /* mov edx, 0x6 */
            ii(0x100d_ff0b, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x100d_ff0f, 5); call(0x1013_3743, 0x5_382f);            /* call 0x10133743 */
            ii(0x100d_ff14, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x100d_ff17, 2); jmp(0x100d_ff75, 0x5c); goto l_0x100d_ff75; /* jmp 0x100dff75 */
        l_0x100d_ff19:
            ii(0x100d_ff19, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
            ii(0x100d_ff1d, 5); mov(edx, 0x5);                          /* mov edx, 0x5 */
            ii(0x100d_ff22, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x100d_ff26, 5); call(0x1013_3743, 0x5_3818);            /* call 0x10133743 */
            ii(0x100d_ff2b, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
        l_0x100d_ff2e:
            ii(0x100d_ff2e, 7); mov(memd[ss, ebp - 0x20], 0);           /* mov dword [ebp-0x20], 0x0 */
        ...
        l_0x100d_ff58:
            ii(0x100d_ff58, 3); mov(al, memb[ss, ebp - 0x10]);          /* mov al, [ebp-0x10] */
            ii(0x100d_ff5b, 2); dec(al);                                /* dec al */
            ii(0x100d_ff5d, 3); mov(memb[ss, ebp - 0x24], al);          /* mov [ebp-0x24], al */
            ii(0x100d_ff60, 4); cmp(memb[ss, ebp - 0x24], 0x7);         /* cmp byte [ebp-0x24], 0x7 */
            ii(0x100d_ff64, 2); if(ja(0x100d_ff2e, -0x38)) goto l_0x100d_ff2e; /* ja 0x100dff2e */
            ii(0x100d_ff66, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x100d_ff68, 3); mov(al, memb[ss, ebp - 0x24]);          /* mov al, [ebp-0x24] */
        ...
        l_0x100d_ff75:
            ii(0x100d_ff75, 4); movsx(edx, memb[ss, ebp - 0x4]);        /* movsx edx, byte [ebp-0x4] */
            ii(0x100d_ff79, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x100d_ff89, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ii(0x100d_ff8c, 4); movsx(edx, memb[ss, ebp - 0x4]);        /* movsx edx, byte [ebp-0x4] */
            ii(0x100d_ff90, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x100d_ffa0, 3); mov(memd[ss, ebp - 0x2c], eax);         /* mov [ebp-0x2c], eax */
            ii(0x100d_ffa3, 4); movsx(ecx, memw[ss, ebp - 0x28]);       /* movsx ecx, word [ebp-0x28] */
            ii(0x100d_ffa7, 4); movsx(ebx, memw[ss, ebp - 0x20]);       /* movsx ebx, word [ebp-0x20] */
            ii(0x100d_ffab, 4); movsx(edx, memw[ss, ebp - 0x2c]);       /* movsx edx, word [ebp-0x2c] */
            ii(0x100d_ffaf, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ii(0x100d_ffb3, 5); call(0x100d_8248, -0x7d70);             /* call 0x100d8248 */
            ii(0x100d_ffb8, 3); mov(memd[ss, ebp - 0x30], eax);         /* mov [ebp-0x30], eax */
            ii(0x100d_ffbb, 4); cmp(memb[ss, ebp - 0x4], 0x9);          /* cmp byte [ebp-0x4], 0x9 */
            ii(0x100d_ffbf, 2); if(jnz(0x100d_ffc9, 0x8)) goto l_0x100d_ffc9; /* jnz 0x100dffc9 */
            ii(0x100d_ffc1, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x100d_ffc4, 3); sub(memd[ss, ebp - 0x2c], eax);         /* sub [ebp-0x2c], eax */
            ii(0x100d_ffc7, 2); jmp(0x100d_ffcf, 0x6); goto l_0x100d_ffcf; /* jmp 0x100dffcf */
        l_0x100d_ffc9:
            ii(0x100d_ffc9, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x100d_ffcc, 3); add(memd[ss, ebp - 0x2c], eax);         /* add [ebp-0x2c], eax */
        l_0x100d_ffcf:
            ii(0x100d_ffcf, 4); movsx(edx, memb[ss, ebp - 0x4]);        /* movsx edx, byte [ebp-0x4] */
            ii(0x100d_ffd3, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x100d_ffe3, 4); movsx(ebx, memw[ss, ebp - 0x20]);       /* movsx ebx, word [ebp-0x20] */
            ii(0x100d_ffe7, 4); movsx(edx, memw[ss, ebp - 0x2c]);       /* movsx edx, word [ebp-0x2c] */
            ii(0x100d_ffeb, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ii(0x100d_ffef, 5); call(0x100d_8248, -0x7dac);             /* call 0x100d8248 */
            ii(0x100d_fff4, 3); sub(eax, memd[ss, ebp - 0x30]);         /* sub eax, [ebp-0x30] */
            ii(0x100d_fff7, 3); mov(memd[ss, ebp - 0x30], eax);         /* mov [ebp-0x30], eax */
            ii(0x100d_fffa, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x100e_0022, 3); mov(memd[ss, ebp - 0x34], eax);         /* mov [ebp-0x34], eax */
            ii(0x100e_0025, 2); jmp(0x100e_0071, 0x4a); goto l_0x100e_0071; /* jmp 0x100e0071 */
        l_0x100e_0027:
            ii(0x100e_0027, 4); movsx(edx, memw[ss, ebp - 0x30]);       /* movsx edx, word [ebp-0x30] */
            ...
            ii(0x100e_003b, 3); mov(memd[ss, ebp - 0x30], eax);         /* mov [ebp-0x30], eax */
            ii(0x100e_003e, 2); jmp(0x100e_008d, 0x4d); goto l_0x100e_008d; /* jmp 0x100e008d */
        l_0x100e_0040:
            ii(0x100e_0040, 4); movsx(edx, memw[ss, ebp - 0x30]);       /* movsx edx, word [ebp-0x30] */
            ...
            ii(0x100e_0053, 3); mov(memd[ss, ebp - 0x30], eax);         /* mov [ebp-0x30], eax */
            ii(0x100e_0056, 2); jmp(0x100e_008d, 0x35); goto l_0x100e_008d; /* jmp 0x100e008d */
        l_0x100e_0058:
            ii(0x100e_0058, 4); movsx(edx, memw[ss, ebp - 0x30]);       /* movsx edx, word [ebp-0x30] */
            ...
            ii(0x100e_006a, 3); mov(memd[ss, ebp - 0x30], eax);         /* mov [ebp-0x30], eax */
        ...
        l_0x100e_0071:
            ii(0x100e_0071, 4); cmp(memd[ss, ebp - 0x34], 0x4);         /* cmp dword [ebp-0x34], 0x4 */
            ii(0x100e_0075, 2); if(jb(0x100e_0085, 0xe)) goto l_0x100e_0085; /* jb 0x100e0085 */
            ii(0x100e_0077, 4); cmp(memd[ss, ebp - 0x34], 0x4);         /* cmp dword [ebp-0x34], 0x4 */
            ii(0x100e_007b, 2); if(jbe(0x100e_0040, -0x3d)) goto l_0x100e_0040; /* jbe 0x100e0040 */
            ii(0x100e_007d, 4); cmp(memd[ss, ebp - 0x34], 0x5);         /* cmp dword [ebp-0x34], 0x5 */
        ...
        l_0x100e_0085:
            ii(0x100e_0085, 4); cmp(memd[ss, ebp - 0x34], 0);           /* cmp dword [ebp-0x34], 0x0 */
        ...
        l_0x100e_008d:
            ii(0x100e_008d, 4); movsx(eax, memw[ss, ebp - 0x30]);       /* movsx eax, word [ebp-0x30] */
            ii(0x100e_0091, 3); cmp(eax, 0x1);                          /* cmp eax, 0x1 */
            ii(0x100e_0094, 2); if(jge(0x100e_009d, 0x7)) goto l_0x100e_009d; /* jge 0x100e009d */
            ii(0x100e_0096, 7); mov(memd[ss, ebp - 0x30], 0x1);         /* mov dword [ebp-0x30], 0x1 */
        l_0x100e_009d:
            ii(0x100e_009d, 3); mov(eax, memd[ss, ebp - 0x30]);         /* mov eax, [ebp-0x30] */
            ii(0x100e_00a0, 3); mov(memd[ss, ebp - 0x38], eax);         /* mov [ebp-0x38], eax */
            ii(0x100e_00a3, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100e_00a5, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x100e_00a8, 5); call(0x1007_5eec, -0x6_a1c1);           /* call 0x10075eec */
            ii(0x100e_00ad, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100e_00af, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
        ...
        //  ii(0x100e_00bb, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
        //  ii(0x100e_00be, 5); call(0x1007_5eec, -0x6_a1d7);           /* call 0x10075eec */
        //  ii(0x100e_00c3, 2); xor(edx, edx);                          /* xor edx, edx */
        //  ii(0x100e_00c5, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
        //  ii(0x100e_00c8, 5); call(0x1007_5eec, -0x6_a1e1);           /* call 0x10075eec */
        l_0x100e_00cd:
            ii(0x100e_00cd, 3); mov(eax, memd[ss, ebp - 0x38]);         /* mov eax, [ebp-0x38] */
