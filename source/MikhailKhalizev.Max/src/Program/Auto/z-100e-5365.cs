...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("94cd57aa-7858-4c93-abc2-f388906076d5")]
        public void Method_100e_5365()
        {
            ii(0x100e_5365, 5); pushd(0x28);                            /* push 0x28 */
            ii(0x100e_536a, 5); calld(Definitions.sys_check_available_stack_size, 0x809e3); /* call 0x10165d52 */
            ...
            ii(0x100e_53a7, 1); retd(); return;                         /* ret */
        }
    }
}
