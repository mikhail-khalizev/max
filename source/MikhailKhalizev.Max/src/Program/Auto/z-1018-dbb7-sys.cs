...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_dbb7()
        {
            ...
            ii(0x1018_dbd5, 3); cmp(eax, 3);                            /* cmp eax, 0x3 */
            ...
            ii(0x1018_dbe1, 2); if(jnz(0x1018_dbe7, 4)) goto l_0x1018_dbe7; /* jnz 0x1018dbe7 */
        ...
        l_0x1018_dbe7:
            ...
            ii(0x1018_dbea, 2); if(jl(0x1018_dbf0, 4)) goto l_0x1018_dbf0; /* jl 0x1018dbf0 */
            ii(0x1018_dbec, 2); mov(dl, 0x13);                          /* mov dl, 0x13 */
            ii(0x1018_dbee, 2); jmp(0x1018_dbf7, 7); goto l_0x1018_dbf7; /* jmp 0x1018dbf7 */
        l_0x1018_dbf0:
            ii(0x1018_dbf0, 3); cmp(ebx, 0x20);                         /* cmp ebx, 0x20 */
            ii(0x1018_dbf3, 2); if(jl(0x1018_dbf7, 2)) goto l_0x1018_dbf7; /* jl 0x1018dbf7 */
            ii(0x1018_dbf5, 2); mov(dl, 5);                             /* mov dl, 0x5 */
        l_0x1018_dbf7:
            ii(0x1018_dbf7, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1018_dbf9, 2); mov(al, dl);                            /* mov al, dl */
            ii(0x1018_dbfb, 3); cmp(eax, 0x13);                         /* cmp eax, 0x13 */
            ii(0x1018_dbfe, 2); if(jle(0x1018_dc02, 2)) goto l_0x1018_dc02; /* jle 0x1018dc02 */
        ...
        l_0x1018_dc11:
            ...
            ii(0x1018_dc13, 3); shr(eax, 8);                            /* shr eax, 0x8 */
