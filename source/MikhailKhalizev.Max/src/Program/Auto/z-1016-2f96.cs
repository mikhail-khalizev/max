...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_2f96()
        {
            ...
            ii(0x1016_2faf, 3); mov(memb[ss, ebp - 0x8], dl);           /* mov [ebp-0x8], dl */
            ii(0x1016_2fb2, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ii(0x1016_2fb5, 4); mov(memb[ss, ebp - 0x10], 0);           /* mov byte [ebp-0x10], 0x0 */
            ii(0x1016_2fb9, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1016_2fbc, 4); cmp(memb[ds, eax + 0x3d], 0x9);         /* cmp byte [eax+0x3d], 0x9 */
            ii(0x1016_2fc0, 2); if(jz(0x1016_2fcb, 0x9)) goto l_0x1016_2fcb; /* jz 0x10162fcb */
            ii(0x1016_2fc2, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1016_2fc5, 4); cmp(memb[ds, eax + 0x3e], 0xe);         /* cmp byte [eax+0x3e], 0xe */
            ii(0x1016_2fc9, 2); if(jnz(0x1016_2fd0, 0x5)) goto l_0x1016_2fd0; /* jnz 0x10162fd0 */
        l_0x1016_2fcb:
        ...
        l_0x1016_2fd0:
            ...
            ii(0x1016_2fd7, 2); if(jnz(0x1016_2fe1, 0x8)) goto l_0x1016_2fe1; /* jnz 0x10162fe1 */
        ...
        l_0x1016_2fe1:
            ...
            ii(0x1016_2ff4, 4); mov(memb[ds, eax + 0x3e], 0x1);         /* mov byte [eax+0x3e], 0x1 */
            ii(0x1016_2ff8, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
        l_0x1016_2ffc:
            ii(0x1016_2ffc, 4); cmp(memb[ss, ebp - 0x8], 0x9);          /* cmp byte [ebp-0x8], 0x9 */
            ii(0x1016_3000, 2); if(jz(0x1016_300b, 0x9)) goto l_0x1016_300b; /* jz 0x1016300b */
            ii(0x1016_3002, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1016_3005, 4); cmp(memb[ds, eax + 0x3d], 0x3);         /* cmp byte [eax+0x3d], 0x3 */
        ...
        l_0x1016_300b:
            ...
            ii(0x1016_300e, 4); cmp(memb[ds, eax + 0x3d], 0x6);         /* cmp byte [eax+0x3d], 0x6 */
        ...
        l_0x1016_303e:
            ...
            ii(0x1016_3042, 2); if(jz(0x1016_304c, 0x8)) goto l_0x1016_304c; /* jz 0x1016304c */
