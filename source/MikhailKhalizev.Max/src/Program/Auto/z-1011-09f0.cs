...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("71f26572-f531-4a10-b07e-b2903956ac70")]
        public void Method_1011_09f0()
        {
            ii(0x1011_09f0, 5); pushd(0xb4);                            /* push 0xb4 */
            ii(0x1011_09f5, 5); calld(Definitions.sys_check_available_stack_size, 0x55358); /* call 0x10165d52 */
            ...
            ii(0x1011_0a25, 5); calld(Definitions.sys_call_dtor_arr, 0x5558e); /* call 0x10165fb8 */
            ii(0x1011_0a2a, 5); calld(Definitions.sys_delete_arr, 0x555a9); /* call 0x10165fd8 */
        ...
        l_0x1011_0a90:
            ...
            ii(0x1011_0aba, 5); mov(eax, 0x101a_4672);                  /* mov eax, 0x101a4672 */ /* "%sdescr%i.%s" */
            ii(0x1011_0abf, 1); pushd(eax);                             /* push eax */
            ii(0x1011_0ac0, 3); lea(eax, ebp - 0x80);                   /* lea eax, [ebp-0x80] */
            ii(0x1011_0ac3, 1); pushd(eax);                             /* push eax */
            ii(0x1011_0ac4, 5); calld(Definitions.sys_sprintf, 0x55438); /* call 0x10165f01 */
            ii(0x1011_0ac9, 3); add(esp, 0x14);                         /* add esp, 0x14 */
            ii(0x1011_0acc, 5); mov(edx, 0x101a_467f);                  /* mov edx, 0x101a467f */ /* "rt" */
            ii(0x1011_0ad1, 3); lea(eax, ebp - 0x80);                   /* lea eax, [ebp-0x80] */
            ii(0x1011_0ad4, 5); calld(Definitions.my_fopen, -0x216ba);  /* call 0x100ef41f */
            ...
            ii(0x1011_0ae3, 5); calld(Definitions.my_string_ctor, 0x31000); /* call 0x10141ae8 */
        ...
        l_0x1011_0af5:
            ...
            ii(0x1011_0af8, 5); calld(/* sys */ 0x1017_1f05, 0x61408);  /* call 0x10171f05 */
            ...
            ii(0x1011_0b17, 5); calld(Definitions.my_string_append_char, 0x312ce); /* call 0x10141dea */
        ...
        l_0x1011_0b1e:
            ...
            ii(0x1011_0b21, 5); calld(Definitions.sys_fclose, 0x61543); /* call 0x10172069 */
        l_0x1011_0b26:
            ii(0x1011_0b26, 5); mov(eax, 0x5);                          /* mov eax, 0x5 */
            ii(0x1011_0b2b, 5); calld(/* sys */ 0x1016_a24c, 0x5971c);  /* call 0x1016a24c */
            ...
            ii(0x1011_0b93, 5); calld(Definitions.my_strobj_c_str_v2, -0x873d0); /* call 0x100897c8 */
            ii(0x1011_0b98, 5); calld(0x100e_969d, -0x27500);           /* call 0x100e969d */
        ...
        l_0x1011_0ba8:
            ...
            ii(0x1011_0bad, 5); calld(Definitions.my_string_dtor, 0x30f78); /* call 0x10141b2a */
        l_0x1011_0bb2:
