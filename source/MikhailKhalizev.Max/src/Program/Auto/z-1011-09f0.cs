...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_09f0()
        {
            ...
            ii(0x1011_0a08, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_0a0b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0a0e, 7); cmp(memd[ds, eax + 0x144], 0);          /* cmp dword [eax+0x144], 0x0 */
            ...
            ii(0x1011_0a1c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0a1f, 6); mov(eax, memd[ds, eax + 0x144]);        /* mov eax, [eax+0x144] */
            ...
            ii(0x1011_0a2f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0a32, 10); mov(memd[ds, eax + 0x144], 0);         /* mov dword [eax+0x144], 0x0 */
            ii(0x1011_0a3c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0a3f, 9); mov(memw[ds, eax + 0x14a], 0);          /* mov word [eax+0x14a], 0x0 */
        l_0x1011_0a48:
            ii(0x1011_0a48, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0a4b, 6); mov(al, memb[ds, eax + 0x141]);         /* mov al, [eax+0x141] */
            ...
            ii(0x1011_0a5e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0a61, 7); cmp(memb[ds, eax + 0x143], 0x2);        /* cmp byte [eax+0x143], 0x2 */
            ii(0x1011_0a68, 2); if(jnz(0x1011_0a90, 0x26)) goto l_0x1011_0a90; /* jnz 0x10110a90 */
            ii(0x1011_0a6a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0a6d, 6); mov(dl, memb[ds, eax + 0x142]);         /* mov dl, [eax+0x142] */
            ii(0x1011_0a73, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0a76, 6); cmp(dl, memb[ds, eax + 0x141]);         /* cmp dl, [eax+0x141] */
            ii(0x1011_0a7c, 2); if(jbe(0x1011_0a90, 0x12)) goto l_0x1011_0a90; /* jbe 0x10110a90 */
            ii(0x1011_0a7e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0a81, 6); mov(dl, memb[ds, eax + 0x141]);         /* mov dl, [eax+0x141] */
            ii(0x1011_0a87, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0a8a, 6); mov(memb[ds, eax + 0x142], dl);         /* mov [eax+0x142], dl */
        l_0x1011_0a90:
            ii(0x1011_0a90, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0a93, 6); mov(eax, memd[ds, eax + 0x140]);        /* mov eax, [eax+0x140] */
            ...
            ii(0x1011_0aa5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0aa8, 6); mov(al, memb[ds, eax + 0x142]);         /* mov al, [eax+0x142] */
            ...
            ii(0x1011_0ac0, 3); lea(eax, memd[ss, ebp - 0x80]);         /* lea eax, [ebp-0x80] */
            ...
            ii(0x1011_0ad1, 3); lea(eax, memd[ss, ebp - 0x80]);         /* lea eax, [ebp-0x80] */
            ii(0x1011_0ad4, 5); call(Definitions.my_fopen, -0x2_16ba);  /* call 0x100ef41f */
            ii(0x1011_0ad9, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1011_0adc, 4); or(memb[ss, ebp - 0x8], 0x1);           /* or byte [ebp-0x8], 0x1 */
            ii(0x1011_0ae0, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1011_0ae3, 5); call(Definitions.my_string_ctor, 0x3_1000); /* call 0x10141ae8 */
            ii(0x1011_0ae8, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1011_0aeb, 4); and(memb[ss, ebp - 0x8], -0x2 /* 0xfe */); /* and byte [ebp-0x8], 0xfe */
            ii(0x1011_0aef, 4); cmp(memd[ss, ebp - 0x18], 0);           /* cmp dword [ebp-0x18], 0x0 */
            ii(0x1011_0af3, 2); if(jz(0x1011_0b26, 0x31)) goto l_0x1011_0b26; /* jz 0x10110b26 */
        l_0x1011_0af5:
            ii(0x1011_0af5, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1011_0af8, 5); call(/* sys */ 0x1017_1f05, 0x6_1408);  /* call 0x10171f05 */
            ii(0x1011_0afd, 6); mov(memd[ss, ebp - 0x84], eax);         /* mov [ebp-0x84], eax */
            ii(0x1011_0b03, 7); cmp(memd[ss, ebp - 0x84], -0x1 /* 0xff */); /* cmp dword [ebp-0x84], 0xffffffff */
            ii(0x1011_0b0a, 2); if(jz(0x1011_0b1e, 0x12)) goto l_0x1011_0b1e; /* jz 0x10110b1e */
            ii(0x1011_0b0c, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_0b0e, 6); mov(dl, memb[ss, ebp - 0x84]);          /* mov dl, [ebp-0x84] */
            ii(0x1011_0b14, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x1011_0b1e:
            ii(0x1011_0b1e, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
        ...
        l_0x1011_0b26:
            ...
            ii(0x1011_0b3e, 3); mov(memd[ss, ebp - 0x10], edx);         /* mov [ebp-0x10], edx */
            ...
            ii(0x1011_0b4f, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x1011_0b52, 6); call_abs(memd[ds, 0x101b_ddf0]);        /* call dword [0x101bddf0] */
            ii(0x1011_0b58, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x1011_0b5a, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x1011_0b5e, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x1011_0b60, 3); sar(edx, 0x1f);                         /* sar edx, 0x1f */
            ii(0x1011_0b63, 2); idiv(ebx);                              /* idiv ebx */
            ii(0x1011_0b65, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1011_0b68, 7); mov(memw[ds, edx + 0x14c], ax);         /* mov [edx+0x14c], ax */
            ii(0x1011_0b6f, 4); cmp(memd[ss, ebp - 0x18], 0);           /* cmp dword [ebp-0x18], 0x0 */
            ii(0x1011_0b73, 2); if(jz(0x1011_0ba8, 0x33)) goto l_0x1011_0ba8; /* jz 0x10110ba8 */
            ii(0x1011_0b75, 3); mov(ecx, memd[ss, ebp - 0x4]);          /* mov ecx, [ebp-0x4] */
            ii(0x1011_0b78, 6); add(ecx, 0x148);                        /* add ecx, 0x148 */
            ii(0x1011_0b7e, 4); movsx(ebx, memw[ss, ebp - 0x10]);       /* movsx ebx, word [ebp-0x10] */
            ii(0x1011_0b82, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0b85, 8); imul(ax, memw[ds, eax + 0x14c], 0x3);   /* imul ax, [eax+0x14c], 0x3 */
            ii(0x1011_0b8d, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1011_0b90, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1011_0b9f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0ba2, 6); mov(memd[ds, eax + 0x144], edx);        /* mov [eax+0x144], edx */
        l_0x1011_0ba8:
            ii(0x1011_0ba8, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_0baa, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
