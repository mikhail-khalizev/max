...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_a068()
        {
            ...
            ii(0x100c_a06d, 5); calld(Definitions.sys_check_available_stack_size, 0x9bce0); /* call 0x10165d52 */
            ...
            ii(0x100c_a083, 5); calld(0x100a_ab28, -0x1f560);           /* call 0x100aab28 */
            ii(0x100c_a088, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x100c_a08b, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x100c_a08e, 5); calld(0x100a_aad4, -0x1f5bf);           /* call 0x100aaad4 */
