...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_a068()
        {
            ...
            ii(0x100c_a080, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_a083, 5); call(0x100a_ab28, -0x1_f560);           /* call 0x100aab28 */
            ii(0x100c_a088, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x100c_a08b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_a08e, 5); call(0x100a_aad4, -0x1_f5bf);           /* call 0x100aaad4 */
            ii(0x100c_a093, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_a096, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
