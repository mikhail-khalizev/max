...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1019_6759:
            ii(0x1019_6759, 4); cmp(memd[ds, edi + 0x8], 0);            /* cmp dword [edi+0x8], 0x0 */
            ii(0x1019_675d, 2); if(jnz(0x1019_6766, 0x7)) goto l_0x1019_6766; /* jnz 0x10196766 */
            ii(0x1019_675f, 7); mov(memd[ds, edi + 0x8], 0x1);          /* mov dword [edi+0x8], 0x1 */
        l_0x1019_6766:
        ...
        l_0x1019_676e:
            ...
            ii(0x1019_6775, 3); mov(eax, memd[ds, ecx - 0x8]);          /* mov eax, [ecx-0x8] */
            ii(0x1019_6778, 3); mov(memd[ss, esp], eax);                /* mov [esp], eax */
            ii(0x1019_677b, 3); mov(eax, memd[ds, ecx - 0x4]);          /* mov eax, [ecx-0x4] */
            ii(0x1019_677e, 4); mov(memd[ss, esp + 0x4], eax);          /* mov [esp+0x4], eax */
            ii(0x1019_6782, 4); cmp(memd[ds, edi + 0x8], -0x1 /* 0xff */); /* cmp dword [edi+0x8], 0xffffffff */
            ii(0x1019_6786, 2); if(jnz(0x1019_678f, 0x7)) goto l_0x1019_678f; /* jnz 0x1019678f */
            ii(0x1019_6788, 7); mov(memd[ds, edi + 0x8], 0x6);          /* mov dword [edi+0x8], 0x6 */
        l_0x1019_678f:
            ...
            ii(0x1019_679f, 2); push(0x3);                              /* push 0x3 */
            ii(0x1019_67a1, 1); push(ebp);                              /* push ebp */
            ii(0x1019_67a2, 3); mov(ebx, memd[ds, edi + 0x8]);          /* mov ebx, [edi+0x8] */
            ...
            ii(0x1019_67be, 2); if(jnz(0x1019_67c4, 0x4)) goto l_0x1019_67c4; /* jnz 0x101967c4 */
        ...
        l_0x1019_67cb:
            ...
            ii(0x1019_67d2, 2); if(jnz(0x1019_67d7, 0x3)) goto l_0x1019_67d7; /* jnz 0x101967d7 */
        ...
        l_0x1019_67d7:
            ...
            ii(0x1019_67e4, 7); mov(memd[ds, edi + 0x8], 0xffff_ffff);  /* mov dword [edi+0x8], 0xffffffff */
        l_0x1019_67eb:
