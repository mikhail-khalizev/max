...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_973a()
        {
            ...
            ii(0x9744, 3);    mov(di, memw[ss, bp + 0x6]);              /* mov di, [bp+0x6] */
            ...
            ii(0x9754, 3);    mov(memw[ss, bp - 0x2], cx);              /* mov [bp-0x2], cx */
            ii(0x9757, 3);    mov(di, memw[ss, bp + 0x4]);              /* mov di, [bp+0x4] */
            ...
            ii(0x9768, 3);    sub(dx, memw[ss, bp - 0x2]);              /* sub dx, [bp-0x2] */
            ii(0x976b, 2);    if(jbe(0x9792, 0x25)) goto l_0x9792;      /* jbe 0x9792 */
            ii(0x976d, 2);    mov(di, bx);                              /* mov di, bx */
        l_0x976f:
            ii(0x976f, 3);    mov(si, memw[ss, bp + 0x6]);              /* mov si, [bp+0x6] */
            ...
            ii(0x977f, 3);    mov(cx, memw[ss, bp - 0x2]);              /* mov cx, [bp-0x2] */
            ii(0x9782, 2);    if(jcxz(0x9788, 0x4)) goto l_0x9788;      /* jcxz 0x9788 */
            ii(0x9784, 2);    repe(() => cmpsb());                      /* repe cmpsb */
            ii(0x9786, 2);    if(jnz(0x976f, -0x19)) goto l_0x976f;     /* jnz 0x976f */
        l_0x9788:
            ii(0x9788, 3);    lea(ax, memw[ds, bx - 0x1]);              /* lea ax, [bx-0x1] */
            ii(0x978b, 2);    jmp(0x9794, 0x7); goto l_0x9794;          /* jmp 0x9794 */
        l_0x978d:
            ii(0x978d, 3);    mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
            ii(0x9790, 2);    jmp(0x9794, 0x2); goto l_0x9794;          /* jmp 0x9794 */
        l_0x9792:
