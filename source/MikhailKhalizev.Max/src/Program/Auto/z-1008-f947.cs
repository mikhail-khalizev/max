...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_f947()
        {
            ...
            ii(0x1008_f95e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_f961, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1008_f964, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_f966, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1008_f975, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_f978, 3); add(eax, 0x15);                         /* add eax, 0x15 */
            ii(0x1008_f97b, 5); call(0x1007_6574, -0x1_940c);           /* call 0x10076574 */
            ii(0x1008_f980, 4); mov(dx, memw[ds, eax + 0x8]);           /* mov dx, [eax+0x8] */
            ii(0x1008_f984, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_f987, 4); cmp(dx, memw[ds, eax + 0x8]);           /* cmp dx, [eax+0x8] */
            ii(0x1008_f98b, 2); if(jz(0x1008_f98f, 0x2)) goto l_0x1008_f98f; /* jz 0x1008f98f */
        l_0x1008_f98d:
            ii(0x1008_f98d, 2); jmp(0x1008_f998, 0x9); goto l_0x1008_f998; /* jmp 0x1008f998 */
        l_0x1008_f98f:
            ii(0x1008_f98f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_f992, 4); cmp(memb[ds, eax + 0x25], 0x9);         /* cmp byte [eax+0x25], 0x9 */
            ii(0x1008_f996, 2); if(jl(0x1008_f9a1, 0x9)) goto l_0x1008_f9a1; /* jl 0x1008f9a1 */
        l_0x1008_f998:
            ii(0x1008_f998, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
            ii(0x1008_f99c, 5); jmp(0x1008_fa30, 0x8f); goto l_0x1008_fa30; /* jmp 0x1008fa30 */
        l_0x1008_f9a1:
            ii(0x1008_f9a1, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1008_f9a4, 3); add(edx, 0x21);                         /* add edx, 0x21 */
            ii(0x1008_f9a7, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1008_f9aa, 5); call(0x1007_5e64, -0x1_9b4b);           /* call 0x10075e64 */
            ii(0x1008_f9af, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1008_f9b1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1008_f9c3, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1008_f9c6, 3); add(edx, 0x21);                         /* add edx, 0x21 */
            ii(0x1008_f9c9, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1008_f9cc, 5); call(0x1007_5e64, -0x1_9b6d);           /* call 0x10075e64 */
            ii(0x1008_f9d1, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1008_f9d3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_f9d6, 5); call(0x1007_0ca1, -0x1_ed3a);           /* call 0x10070ca1 */
            ii(0x1008_f9db, 3); cmp(bx, ax);                            /* cmp bx, ax */
            ii(0x1008_f9de, 2); if(jg(0x1008_f9e6, 0x6)) goto l_0x1008_f9e6; /* jg 0x1008f9e6 */
            ii(0x1008_f9e0, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
        ...
        l_0x1008_f9e6:
            ...
            ii(0x1008_f9ef, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1008_fa08, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1008_fa17, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_fa1a, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1008_fa1d, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1008_fa20, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x1008_fa23, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_fa26, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1008_fa29, 3); call_abs(memd[ds, ebx + 0x2c]);         /* call dword [ebx+0x2c] */
        l_0x1008_fa2c:
            ii(0x1008_fa2c, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
        l_0x1008_fa30:
            ii(0x1008_fa30, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
