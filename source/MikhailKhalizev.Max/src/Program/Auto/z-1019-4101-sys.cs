...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_4101()
        {
            ...
            ii(0x1019_4106, 3); mov(eax, memd[ss, ebp + 0xc]);          /* mov eax, [ebp+0xc] */
            ii(0x1019_4109, 3); mov(ecx, memd[ss, ebp + 0x10]);         /* mov ecx, [ebp+0x10] */
            ii(0x1019_410c, 3); mov(esi, memd[ss, ebp + 0x8]);          /* mov esi, [ebp+0x8] */
            ii(0x1019_410f, 5); cmp(eax, 0x100);                        /* cmp eax, 0x100 */
            ii(0x1019_4114, 2); if(jb(0x1019_411a, 0x4)) goto l_0x1019_411a; /* jb 0x1019411a */
        ...
        l_0x1019_411a:
            ...
            ii(0x1019_4123, 2); if(jbe(0x1019_412c, 0x7)) goto l_0x1019_412c; /* jbe 0x1019412c */
