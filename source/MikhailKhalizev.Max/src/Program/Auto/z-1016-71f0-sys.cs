...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_71f0()
        {
            ...
            ii(0x1016_71f3, 3); sub(esp, 4);                            /* sub esp, 0x4 */
            ...
            ii(0x1016_721a, 4); mov(ebx, memd[ss, esp + 24]);           /* mov ebx, [esp+0x18] */
        ...
        l_0x1016_7241:
            ii(0x1016_7241, 3); mov(ecx, memd[ds, eax + 40]);           /* mov ecx, [eax+0x28] */
            ii(0x1016_7244, 2); add(ecx, edi);                          /* add ecx, edi */
            ii(0x1016_7246, 1); push(ecx);                              /* push ecx */
            ii(0x1016_7247, 3); mov(ecx, memd[ds, eax + 36]);           /* mov ecx, [eax+0x24] */
            ...
            ii(0x1016_7254, 3); mov(ecx, memd[ds, eax + 24]);           /* mov ecx, [eax+0x18] */
            ii(0x1016_7257, 2); mov(edx, edi);                          /* mov edx, edi */
            ii(0x1016_7259, 3); imul(edx, ecx);                         /* imul edx, ecx */
            ii(0x1016_725c, 3); mov(eax, memd[ds, eax + 44]);           /* mov eax, [eax+0x2c] */
            ii(0x1016_725f, 4); mov(ebx, memd[ss, esp + 32]);           /* mov ebx, [esp+0x20] */
        ...
        l_0x1016_7270:
            ii(0x1016_7270, 5); test(memb[ss, esp + 25], 0xff);         /* test byte [esp+0x19], 0xff */
            ...
            ii(0x1016_7297, 2); jmp(0x1016_729b, 2); goto l_0x1016_729b; /* jmp 0x1016729b */
        l_0x1016_7299:
            ii(0x1016_7299, 2); mov(eax, ebx);                          /* mov eax, ebx */
        l_0x1016_729b:
            ii(0x1016_729b, 4); mov(memd[ss, esp + 24], eax);           /* mov [esp+0x18], eax */
        l_0x1016_729f:
            ii(0x1016_729f, 4); mov(ebx, memd[ss, esp + 24]);           /* mov ebx, [esp+0x18] */
            ...
            ii(0x1016_72ae, 3); mov(ecx, memd[ds, ecx + 24]);           /* mov ecx, [ecx+0x18] */
