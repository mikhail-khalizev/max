...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_5144()
        {
            ...
            ii(0x1009_517d, 4); mov(ax, memw[ds, eax + 12]);            /* mov ax, [eax+0xc] */
            ...
            ii(0x1009_51bc, 3); lea(eax, memd[ss, ebp - 40]);           /* lea eax, [ebp-0x28] */
            ...
            ii(0x1009_51cd, 3); lea(eax, memd[ss, ebp - 56]);           /* lea eax, [ebp-0x38] */
        ...
        l_0x1009_51d7:
            ii(0x1009_51d7, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ii(0x1009_51da, 5); call(0x1007_6bf8, -0x1_e5e7);           /* call 0x10076bf8 */
        l_0x1009_51df:
            ii(0x1009_51df, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_51e1, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ...
            ii(0x1009_51ed, 3); lea(edx, memd[ss, ebp - 56]);           /* lea edx, [ebp-0x38] */
            ii(0x1009_51f0, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ii(0x1009_51f3, 5); call(0x1007_63a0, -0x1_ee58);           /* call 0x100763a0 */
            ii(0x1009_51f8, 5); call(0x1015_2532, 0xb_d335);            /* call 0x10152532 */
            ii(0x1009_51fd, 3); lea(ebx, memd[ss, ebp - 40]);           /* lea ebx, [ebp-0x28] */
            ii(0x1009_5200, 3); lea(edx, memd[ss, ebp - 56]);           /* lea edx, [ebp-0x38] */
        ...
        l_0x1009_520d:
            ii(0x1009_520d, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1009_5210, 3); add(eax, 0x21);                         /* add eax, 0x21 */
            ii(0x1009_5213, 5); call(0x1009_c6c8, 0x74b0);              /* call 0x1009c6c8 */
            ii(0x1009_5218, 3); lea(ebx, memd[ss, ebp - 20]);           /* lea ebx, [ebp-0x14] */
        ...
        l_0x1009_5226:
            ii(0x1009_5226, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1009_5229, 5); call(0x1007_6bf8, -0x1_e636);           /* call 0x10076bf8 */
        l_0x1009_522e:
            ii(0x1009_522e, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_5230, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ...
            ii(0x1009_523c, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1009_523f, 5); call(0x1009_c4f8, 0x72b4);              /* call 0x1009c4f8 */
            ii(0x1009_5244, 3); mov(memd[ss, ebp - 60], eax);           /* mov [ebp-0x3c], eax */
            ii(0x1009_5247, 3); mov(eax, memd[ss, ebp - 60]);           /* mov eax, [ebp-0x3c] */
            ii(0x1009_524a, 3); mov(edx, memd[ds, eax + 2]);            /* mov edx, [eax+0x2] */
            ii(0x1009_524d, 3); mov(eax, memd[ss, ebp - 60]);           /* mov eax, [ebp-0x3c] */
            ii(0x1009_5250, 3); call_abs(memd[ds, edx + 116]);          /* call dword [edx+0x74] */
            ii(0x1009_5253, 2); test(al, al);                           /* test al, al */
            ii(0x1009_5255, 2); if(jz(0x1009_527f, 0x28)) goto l_0x1009_527f; /* jz 0x1009527f */
            ii(0x1009_5257, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1009_525a, 5); call(0x1009_c4f8, 0x7299);              /* call 0x1009c4f8 */
            ii(0x1009_525f, 3); mov(memd[ss, ebp - 64], eax);           /* mov [ebp-0x40], eax */
            ii(0x1009_5262, 3); mov(eax, memd[ss, ebp - 64]);           /* mov eax, [ebp-0x40] */
            ii(0x1009_5265, 3); mov(ebx, memd[ds, eax + 2]);            /* mov ebx, [eax+0x2] */
            ii(0x1009_5268, 3); lea(edx, memd[ss, ebp - 56]);           /* lea edx, [ebp-0x38] */
            ii(0x1009_526b, 3); mov(eax, memd[ss, ebp - 64]);           /* mov eax, [ebp-0x40] */
            ii(0x1009_526e, 3); call_abs(memd[ds, ebx + 28]);           /* call dword [ebx+0x1c] */
            ii(0x1009_5271, 3); lea(ebx, memd[ss, ebp - 40]);           /* lea ebx, [ebp-0x28] */
            ii(0x1009_5274, 3); lea(edx, memd[ss, ebp - 56]);           /* lea edx, [ebp-0x38] */
        ...
        l_0x1009_52ad:
            ...
            ii(0x1009_52c5, 3); sub(eax, memd[ss, ebp - 36]);           /* sub eax, [ebp-0x24] */
            ii(0x1009_52c8, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
        l_0x1009_52cb:
            ii(0x1009_52cb, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1009_52ce, 3); mov(edx, memd[ss, ebp - 28]);           /* mov edx, [ebp-0x1c] */
            ii(0x1009_52d1, 3); sub(edx, memd[ds, eax + 12]);           /* sub edx, [eax+0xc] */
            ii(0x1009_52d4, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x1009_52d6, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ii(0x1009_52da, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x1009_52dc, 2); if(jle(0x1009_52eb, 0xd)) goto l_0x1009_52eb; /* jle 0x100952eb */
            ii(0x1009_52de, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x1009_52e1, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1009_52e4, 4); sub(ax, memw[ds, edx + 12]);            /* sub ax, [edx+0xc] */
            ii(0x1009_52e8, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
        l_0x1009_52eb:
            ii(0x1009_52eb, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1009_52ee, 3); inc(memd[ss, ebp - 16]);                /* inc dword [ebp-0x10] */
            ii(0x1009_52f1, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ...
            ii(0x1009_52fd, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
        ...
        l_0x1009_5305:
            ...
            ii(0x1009_5307, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1009_530a, 5); call(0x1009_ba6c, 0x675d);              /* call 0x1009ba6c */
            ii(0x1009_530f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_5311, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
        ...
        l_0x1009_531e:
            ...
            ii(0x1009_5330, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ii(0x1009_5334, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x1009_5336, 2); if(jge(0x1009_5341, 9)) goto l_0x1009_5341; /* jge 0x10095341 */
            ii(0x1009_5338, 7); mov(memd[ss, ebp - 68], 0);             /* mov dword [ebp-0x44], 0x0 */
        ...
        l_0x1009_5341:
            ...
            ii(0x1009_5357, 3); mov(memd[ss, ebp - 68], eax);           /* mov [ebp-0x44], eax */
        l_0x1009_535a:
            ii(0x1009_535a, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1009_535d, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1009_535f, 3); sub(eax, memd[ss, ebp - 40]);           /* sub eax, [ebp-0x28] */
            ii(0x1009_5362, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x1009_5371, 3); mov(eax, memd[ds, eax + 10]);           /* mov eax, [eax+0xa] */
            ...
            ii(0x1009_5387, 4); movsx(edx, memw[ss, ebp - 40]);         /* movsx edx, word [ebp-0x28] */
            ii(0x1009_538b, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1009_538e, 5); call(0x1009_4fea, -0x3a9);              /* call 0x10094fea */
        l_0x1009_5393:
            ii(0x1009_5393, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1009_5396, 3); mov(edx, memd[ss, ebp - 32]);           /* mov edx, [ebp-0x20] */
            ii(0x1009_5399, 3); sub(edx, memd[ds, eax + 8]);            /* sub edx, [eax+0x8] */
            ii(0x1009_539c, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x1009_539e, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x1009_53ad, 3); mov(eax, memd[ds, eax + 10]);           /* mov eax, [eax+0xa] */
            ii(0x1009_53b0, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1009_53b3, 1); push(eax);                              /* push eax */
            ii(0x1009_53b4, 4); movsx(ecx, memw[ss, ebp - 32]);         /* movsx ecx, word [ebp-0x20] */
            ...
            ii(0x1009_53ca, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
        ...
        l_0x1009_53d2:
            ...
            ii(0x1009_53d8, 3); sub(eax, memd[ss, ebp - 36]);           /* sub eax, [ebp-0x24] */
            ii(0x1009_53db, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x1009_53fa, 4); movsx(ebx, memw[ss, ebp - 36]);         /* movsx ebx, word [ebp-0x24] */
            ii(0x1009_53fe, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1009_5401, 3); movsx(edx, memw[ds, eax]);              /* movsx edx, word [eax] */
            ii(0x1009_5404, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1009_5407, 5); call(0x1009_4fea, -0x422);              /* call 0x10094fea */
        l_0x1009_540c:
            ii(0x1009_540c, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1009_540f, 3); mov(edx, memd[ss, ebp - 28]);           /* mov edx, [ebp-0x1c] */
            ii(0x1009_5412, 3); sub(edx, memd[ds, eax + 12]);           /* sub edx, [eax+0xc] */
            ii(0x1009_5415, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x1009_5417, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x1009_5423, 4); movsx(eax, memw[ss, ebp - 28]);         /* movsx eax, word [ebp-0x1c] */
            ...
            ii(0x1009_5434, 3); mov(ebx, memd[ds, eax + 10]);           /* mov ebx, [eax+0xa] */
