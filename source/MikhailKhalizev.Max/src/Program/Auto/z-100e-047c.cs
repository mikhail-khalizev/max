...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_047c()
        {
            ...
            ii(0x100e_048e, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x100e_0494, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100e_0497, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_049a, 5);  call(0x1007_6c30, -0x6_986f);         /* call 0x10076c30 */
            ii(0x100e_049f, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_04a2, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
