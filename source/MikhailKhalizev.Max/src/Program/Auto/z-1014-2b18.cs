...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_2b18()
        {
            ...
            ii(0x1014_2b30, 3);  mov(memd[ss, ebp - 16], edx);         /* mov [ebp-0x10], edx */
            ii(0x1014_2b33, 3);  mov(memd[ss, ebp - 4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1014_2b36, 3);  mov(memd[ss, ebp - 12], ecx);         /* mov [ebp-0xc], ecx */
            ii(0x1014_2b39, 4);  movsx(eax, memw[ss, ebp + 32]);       /* movsx eax, word [ebp+0x20] */
            ...
            ii(0x1014_2b4a, 3);  mov(memd[ss, ebp - 28], edx);         /* mov [ebp-0x1c], edx */
            ii(0x1014_2b4d, 3);  mov(eax, memd[ss, ebp + 16]);         /* mov eax, [ebp+0x10] */
            ii(0x1014_2b50, 5);  mov(memw[ds, eax], 0);                /* mov word [eax], 0x0 */
            ii(0x1014_2b55, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ii(0x1014_2b58, 5);  mov(memw[ds, eax], 0);                /* mov word [eax], 0x0 */
            ii(0x1014_2b5d, 3);  mov(eax, memd[ss, ebp + 24]);         /* mov eax, [ebp+0x18] */
            ii(0x1014_2b60, 5);  mov(memw[ds, eax], 0);                /* mov word [eax], 0x0 */
            ii(0x1014_2b65, 5);  cmp(memw[ss, ebp + 28], 0);           /* cmp word [ebp+0x1c], 0x0 */
            ii(0x1014_2b6a, 2);  if(jz(0x1014_2b75, 9)) goto l_0x1014_2b75;/* jz 0x10142b75 */
            ii(0x1014_2b6c, 7);  mov(memd[ss, ebp - 32], 0xffff);      /* mov dword [ebp-0x20], 0xffff */
            ii(0x1014_2b73, 2);  jmp(0x1014_2b7c, 7); goto l_0x1014_2b7c;/* jmp 0x10142b7c */
        l_0x1014_2b75:
            ii(0x1014_2b75, 7);  mov(memd[ss, ebp - 32], 0);           /* mov dword [ebp-0x20], 0x0 */
        l_0x1014_2b7c:
            ii(0x1014_2b7c, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x1014_2b7f, 6);  mov(eax, memd[ds, eax + 250]);        /* mov eax, [eax+0xfa] */
            ii(0x1014_2b85, 3);  mov(ax, memw[ds, eax]);               /* mov ax, [eax] */
            ii(0x1014_2b88, 5);  and(eax, 0xffff);                     /* and eax, 0xffff */
            ii(0x1014_2b8d, 3);  or(eax, memd[ss, ebp - 32]);          /* or eax, [ebp-0x20] */
            ii(0x1014_2b90, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1014_2b93, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_2b96, 3);  mov(memd[ss, ebp - 36], eax);         /* mov [ebp-0x24], eax */
            ii(0x1014_2b99, 2);  jmp(0x1014_2ba1, 6); goto l_0x1014_2ba1;/* jmp 0x10142ba1 */
        l_0x1014_2b9b:
            ii(0x1014_2b9b, 3);  mov(eax, memd[ss, ebp - 36]);         /* mov eax, [ebp-0x24] */
            ii(0x1014_2b9e, 3);  inc(memd[ss, ebp - 36]);              /* inc dword [ebp-0x24] */
        l_0x1014_2ba1:
            ...
            ii(0x1014_2bb7, 4);  movsx(edx, memw[ss, ebp - 36]);       /* movsx edx, word [ebp-0x24] */
            ii(0x1014_2bbb, 2);  cmp(edx, eax);                        /* cmp edx, eax */
            ii(0x1014_2bbd, 6);  if(jg(0x1014_2cc4, 0x101)) goto l_0x1014_2cc4;/* jg 0x10142cc4 */
            ii(0x1014_2bc3, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1014_2bc6, 3);  mov(memd[ss, ebp - 40], eax);         /* mov [ebp-0x28], eax */
            ii(0x1014_2bc9, 2);  jmp(0x1014_2bd1, 6); goto l_0x1014_2bd1;/* jmp 0x10142bd1 */
        l_0x1014_2bcb:
            ii(0x1014_2bcb, 3);  mov(eax, memd[ss, ebp - 40]);         /* mov eax, [ebp-0x28] */
            ii(0x1014_2bce, 3);  inc(memd[ss, ebp - 40]);              /* inc dword [ebp-0x28] */
        l_0x1014_2bd1:
            ...
            ii(0x1014_2bdb, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x1014_2be7, 4);  movsx(edx, memw[ss, ebp - 40]);       /* movsx edx, word [ebp-0x28] */
            ii(0x1014_2beb, 2);  cmp(edx, eax);                        /* cmp edx, eax */
            ii(0x1014_2bed, 6);  if(jg(0x1014_2cbf, 0xcc)) goto l_0x1014_2cbf;/* jg 0x10142cbf */
            ii(0x1014_2bf3, 4);  movsx(edx, memw[ss, ebp - 40]);       /* movsx edx, word [ebp-0x28] */
            ...
            ii(0x1014_2c02, 4);  movsx(eax, memw[ss, ebp - 36]);       /* movsx eax, word [ebp-0x24] */
            ...
            ii(0x1014_2c15, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1014_2c18, 4);  movsx(edx, memw[ss, ebp - 24]);       /* movsx edx, word [ebp-0x18] */
            ii(0x1014_2c1c, 2);  xor(eax, eax);                        /* xor eax, eax */
            ii(0x1014_2c1e, 4);  mov(ax, memw[ss, ebp - 20]);          /* mov ax, [ebp-0x14] */
            ii(0x1014_2c22, 2);  test(edx, eax);                       /* test edx, eax */
            ii(0x1014_2c24, 2);  if(jz(0x1014_2c53, 0x2d)) goto l_0x1014_2c53;/* jz 0x10142c53 */
            ii(0x1014_2c26, 4);  movsx(edx, memw[ss, ebp - 40]);       /* movsx edx, word [ebp-0x28] */
            ii(0x1014_2c2a, 4);  movsx(eax, memw[ss, ebp - 36]);       /* movsx eax, word [ebp-0x24] */
            ...
            ii(0x1014_2c3d, 7);  mov(memd[ss, ebp - 44], 1);           /* mov dword [ebp-0x2c], 0x1 */
            ii(0x1014_2c44, 2);  jmp(0x1014_2c4d, 7); goto l_0x1014_2c4d;/* jmp 0x10142c4d */
        l_0x1014_2c46:
            ii(0x1014_2c46, 7);  mov(memd[ss, ebp - 44], 0);           /* mov dword [ebp-0x2c], 0x0 */
        l_0x1014_2c4d:
            ii(0x1014_2c4d, 4);  cmp(memd[ss, ebp - 44], 0);           /* cmp dword [ebp-0x2c], 0x0 */
        ...
        l_0x1014_2c55:
            ii(0x1014_2c55, 6);  test(memw[ss, ebp - 24], 0x40);       /* test word [ebp-0x18], 0x40 */
            ii(0x1014_2c5b, 2);  if(jz(0x1014_2c7a, 0x1d)) goto l_0x1014_2c7a;/* jz 0x10142c7a */
            ii(0x1014_2c5d, 5);  mov(edx, 0x10);                       /* mov edx, 0x10 */
            ii(0x1014_2c62, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
        ...
        l_0x1014_2c7a:
            ...
            ii(0x1014_2c97, 3);  mov(eax, memd[ss, ebp + 24]);         /* mov eax, [ebp+0x18] */
        ...
        l_0x1014_2c9f:
            ...
            ii(0x1014_2ca4, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ...
            ii(0x1014_2cb4, 3);  mov(eax, memd[ss, ebp + 16]);         /* mov eax, [ebp+0x10] */
        ...
        l_0x1014_2cc4:
            ii(0x1014_2cc4, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ii(0x1014_2cc7, 3);  mov(ax, memw[ds, eax]);               /* mov ax, [eax] */
            ii(0x1014_2cca, 4);  cmp(ax, memw[ss, ebp - 12]);          /* cmp ax, [ebp-0xc] */
            ii(0x1014_2cce, 2);  if(jle(0x1014_2cd9, 9)) goto l_0x1014_2cd9;/* jle 0x10142cd9 */
            ii(0x1014_2cd0, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_2cd3, 3);  mov(edx, memd[ss, ebp + 20]);         /* mov edx, [ebp+0x14] */
            ii(0x1014_2cd6, 3);  mov(memw[ds, edx], ax);               /* mov [edx], ax */
        l_0x1014_2cd9:
            ii(0x1014_2cd9, 3);  mov(eax, memd[ss, ebp + 24]);         /* mov eax, [ebp+0x18] */
            ii(0x1014_2cdc, 3);  mov(ax, memw[ds, eax]);               /* mov ax, [eax] */
            ii(0x1014_2cdf, 4);  cmp(ax, memw[ss, ebp - 12]);          /* cmp ax, [ebp-0xc] */
            ii(0x1014_2ce3, 2);  if(jle(0x1014_2cee, 9)) goto l_0x1014_2cee;/* jle 0x10142cee */
            ii(0x1014_2ce5, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_2ce8, 3);  mov(edx, memd[ss, ebp + 24]);         /* mov edx, [ebp+0x18] */
            ii(0x1014_2ceb, 3);  mov(memw[ds, edx], ax);               /* mov [edx], ax */
        l_0x1014_2cee:
            ii(0x1014_2cee, 3);  mov(eax, memd[ss, ebp + 16]);         /* mov eax, [ebp+0x10] */
            ii(0x1014_2cf1, 3);  mov(ax, memw[ds, eax]);               /* mov ax, [eax] */
            ii(0x1014_2cf4, 4);  cmp(ax, memw[ss, ebp - 12]);          /* cmp ax, [ebp-0xc] */
            ii(0x1014_2cf8, 2);  if(jle(0x1014_2d03, 9)) goto l_0x1014_2d03;/* jle 0x10142d03 */
            ii(0x1014_2cfa, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_2cfd, 3);  mov(edx, memd[ss, ebp + 16]);         /* mov edx, [ebp+0x10] */
