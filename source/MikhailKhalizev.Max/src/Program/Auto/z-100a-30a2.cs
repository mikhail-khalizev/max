...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_30a2()
        {
            ...
            ii(0x100a_30ca, 7); mov(memd[ss, ebp - 0x14], 2);           /* mov dword [ebp-0x14], 0x2 */
            ii(0x100a_30d1, 2); jmp(0x100a_30da, 7); goto l_0x100a_30da; /* jmp 0x100a30da */
        l_0x100a_30d3:
            ii(0x100a_30d3, 7); mov(memd[ss, ebp - 0x14], 1);           /* mov dword [ebp-0x14], 0x1 */
        l_0x100a_30da:
        ...
        l_0x100a_3132:
            ii(0x100a_3132, 4); mov(memb[ss, ebp - 0x18], 1);           /* mov byte [ebp-0x18], 0x1 */
