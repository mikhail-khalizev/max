...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_5f65()
        {
            ...
            ii(0x100a_5f7c, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_5f7f, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_5f82, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100a_5f86, 5); call(/* sys */ 0x1016_5df8, 0xb_fe6d);  /* call 0x10165df8 */
            ii(0x100a_5f8b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_5f8e, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100a_5f92, 5); call(/* sys */ 0x1016_5df8, 0xb_fe61);  /* call 0x10165df8 */
            ii(0x100a_5f97, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_5f9a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_5f9d, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ii(0x100a_5fa1, 2); if(jge(0x100a_5fb2, 0xf)) goto l_0x100a_5fb2; /* jge 0x100a5fb2 */
            ii(0x100a_5fa3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_5fa6, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x100a_5fa8, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100a_5fab, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x100a_5fad, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x100a_5fb0, 2); jmp(0x100a_5fbf, 0xd); goto l_0x100a_5fbf; /* jmp 0x100a5fbf */
        l_0x100a_5fb2:
            ii(0x100a_5fb2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_5fb5, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x100a_5fb7, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100a_5fba, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x100a_5fbc, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
        l_0x100a_5fbf:
            ii(0x100a_5fbf, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
