...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1007_78d7:
            ...
            ii(0x1007_78da, 4); test(memb[ds, eax + 0x14], 1);          /* test byte [eax+0x14], 0x1 */
        ...
        l_0x1007_78e2:
            ...
            ii(0x1007_78ee, 4); test(memb[ds, eax + 0x13], 2);          /* test byte [eax+0x13], 0x2 */
        ...
        l_0x1007_78f8:
            ii(0x1007_78f8, 4); mov(memb[ss, ebp - 0xc], 1);            /* mov byte [ebp-0xc], 0x1 */
