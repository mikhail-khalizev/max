...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_d585()
        {
            ...
            ii(0x18_d58b, 3); mov(bx, memw[ss, bp + 0x4]);              /* mov bx, [bp+0x4] */
            ...
            ii(0x18_d5a1, 3); xor(al, memb[ss, bp + 0x4]);              /* xor al, [bp+0x4] */
            ii(0x18_d5a4, 3); and(ax, 0x7);                             /* and ax, 0x7 */
            ii(0x18_d5a7, 2); xor(si, ax);                              /* xor si, ax */
            ii(0x18_d5a9, 4); mov(memb[ss, bp - 0x2], 0);               /* mov byte [bp-0x2], 0x0 */
            ii(0x18_d5ad, 2); jmp(0x18_d5f8, 0x49); goto l_0x18_d5f8;   /* jmp 0xd5f8 */
        l_0x18_d5af:
            ii(0x18_d5af, 3); lea(ax, memw[ss, bp - 0xc]);              /* lea ax, [bp-0xc] */
            ...
            ii(0x18_d5bd, 4); test(memb[ss, bp - 0x4], 0x10);           /* test byte [bp-0x4], 0x10 */
            ii(0x18_d5c1, 2); if(jz(0x18_d5f8, 0x35)) goto l_0x18_d5f8; /* jz 0xd5f8 */
            ii(0x18_d5c3, 3); mov(ax, memw[ss, bp - 0xc]);              /* mov ax, [bp-0xc] */
            ii(0x18_d5c6, 3); mov(dx, memw[ss, bp - 0xa]);              /* mov dx, [bp-0xa] */
            ii(0x18_d5c9, 3); sub(ax, memw[ss, bp + 0x6]);              /* sub ax, [bp+0x6] */
            ii(0x18_d5cc, 3); sbb(dx, memw[ss, bp + 0x8]);              /* sbb dx, [bp+0x8] */
            ii(0x18_d5cf, 3); mov(cx, memw[ss, bp + 0xa]);              /* mov cx, [bp+0xa] */
            ...
            ii(0x18_d5d8, 2); if(jb(0x18_d5de, 0x4)) goto l_0x18_d5de;  /* jb 0xd5de */
            ii(0x18_d5da, 2); cmp(ax, cx);                              /* cmp ax, cx */
            ii(0x18_d5dc, 2); if(ja(0x18_d5f8, 0x1a)) goto l_0x18_d5f8; /* ja 0xd5f8 */
        l_0x18_d5de:
            ii(0x18_d5de, 3); add(ax, memw[ss, bp + 0xc]);              /* add ax, [bp+0xc] */
            ii(0x18_d5e1, 3); adc(dx, memw[ss, bp + 0xe]);              /* adc dx, [bp+0xe] */
            ii(0x18_d5e4, 3); mov(memw[ss, bp - 0xc], ax);              /* mov [bp-0xc], ax */
            ii(0x18_d5e7, 3); mov(memw[ss, bp - 0xa], dx);              /* mov [bp-0xa], dx */
            ii(0x18_d5ea, 3); lea(ax, memw[ss, bp - 0xc]);              /* lea ax, [bp-0xc] */
            ...
            ii(0x18_d5f4, 4); mov(memb[ss, bp - 0x2], 0x1);             /* mov byte [bp-0x2], 0x1 */
        l_0x18_d5f8:
            ...
            ii(0x18_d601, 4); cmp(memb[ss, bp - 0x2], 0);               /* cmp byte [bp-0x2], 0x0 */
            ii(0x18_d605, 2); if(jnz(0x18_d615, 0xe)) goto l_0x18_d615; /* jnz 0xd615 */
            ii(0x18_d607, 3); mov(bx, memw[ss, bp + 0x4]);              /* mov bx, [bp+0x4] */
