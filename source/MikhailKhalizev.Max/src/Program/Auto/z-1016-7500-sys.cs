...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_7500()
        {
            ...
            ii(0x1016_750b, 4); mov(memd[ss, esp + 0x28], ebx);         /* mov [esp+0x28], ebx */
            ii(0x1016_750f, 4); test(memb[ds, eax + 0x4], 0x8);         /* test byte [eax+0x4], 0x8 */
            ii(0x1016_7513, 6); if(jnz(0x1016_7ab5, 0x59c)) goto l_0x1016_7ab5; /* jnz 0x10167ab5 */
            ii(0x1016_7519, 4); test(memb[ds, esi + 0x4], 0x20);        /* test byte [esi+0x4], 0x20 */
            ...
            ii(0x1016_754a, 3); mov(eax, memd[ss, ebp + 0x8]);          /* mov eax, [ebp+0x8] */
            ii(0x1016_754d, 3); sub(eax, memd[ss, ebp + 0]);            /* sub eax, [ebp] */
            ii(0x1016_7550, 1); inc(eax);                               /* inc eax */
            ii(0x1016_7551, 3); mov(edi, memd[ss, ebp + 0x4]);          /* mov edi, [ebp+0x4] */
            ii(0x1016_7554, 4); mov(memd[ss, esp + 0x1c], eax);         /* mov [esp+0x1c], eax */
            ii(0x1016_7558, 3); mov(eax, memd[ss, ebp + 0xc]);          /* mov eax, [ebp+0xc] */
            ii(0x1016_755b, 2); sub(eax, edi);                          /* sub eax, edi */
            ii(0x1016_755d, 3); lea(edi, memd[ds, eax + 0x1]);          /* lea edi, [eax+0x1] */
            ...
            ii(0x1016_756d, 3); mov(ecx, memd[ss, ebp + 0xc]);          /* mov ecx, [ebp+0xc] */
            ii(0x1016_7570, 3); mov(ebx, memd[ss, ebp + 0x8]);          /* mov ebx, [ebp+0x8] */
            ii(0x1016_7573, 3); mov(edx, memd[ss, ebp + 0x4]);          /* mov edx, [ebp+0x4] */
            ii(0x1016_7576, 3); mov(eax, memd[ss, ebp + 0]);            /* mov eax, [ebp] */
            ...
            ii(0x1016_759b, 4); mov(memd[ss, esp + 0x10], eax);         /* mov [esp+0x10], eax */
        ...
        l_0x1016_75a9:
            ...
            ii(0x1016_75da, 3); mov(edx, memd[ss, ebp + 0x4]);          /* mov edx, [ebp+0x4] */
            ii(0x1016_75dd, 1); push(edi);                              /* push edi */
            ii(0x1016_75de, 4); mov(edi, memd[ss, esp + 0x38]);         /* mov edi, [esp+0x38] */
            ...
            ii(0x1016_75ea, 3); mov(edi, memd[ss, ebp + 0]);            /* mov edi, [ebp] */
            ...
            ii(0x1016_7607, 4); mov(ebx, memd[ss, esp + 0x14]);         /* mov ebx, [esp+0x14] */
        ...
        l_0x1016_761c:
            ...
            ii(0x1016_7625, 3); mov(eax, memd[ss, ebp + 0x4]);          /* mov eax, [ebp+0x4] */
            ii(0x1016_7628, 1); push(eax);                              /* push eax */
            ii(0x1016_7629, 3); mov(edx, memd[ss, ebp + 0]);            /* mov edx, [ebp] */
            ii(0x1016_762c, 1); push(edx);                              /* push edx */
            ii(0x1016_762d, 1); push(edi);                              /* push edi */
            ii(0x1016_762e, 4); mov(ebx, memd[ss, esp + 0x28]);         /* mov ebx, [esp+0x28] */
        ...
        l_0x1016_7651:
            ...
            ii(0x1016_7656, 4); mov(memd[ss, esp + 0x10], eax);         /* mov [esp+0x10], eax */
            ii(0x1016_765a, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1016_765c, 6); if(jz(0x1016_7ab5, 0x453)) goto l_0x1016_7ab5; /* jz 0x10167ab5 */
            ii(0x1016_7662, 7); mov(memd[ds, eax + 0x10], 0);           /* mov dword [eax+0x10], 0x0 */
            ii(0x1016_7669, 3); lea(eax, memd[ds, esi + 0x8]);          /* lea eax, [esi+0x8] */
            ii(0x1016_766c, 3); mov(ecx, memd[ss, ebp + 0]);            /* mov ecx, [ebp] */
            ii(0x1016_766f, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x1016_7671, 2); cmp(edx, ecx);                          /* cmp edx, ecx */
            ii(0x1016_7673, 2); if(jge(0x1016_767d, 0x8)) goto l_0x1016_767d; /* jge 0x1016767d */
            ii(0x1016_7675, 4); mov(ebx, memd[ss, esp + 0x10]);         /* mov ebx, [esp+0x10] */
            ii(0x1016_7679, 2); mov(memd[ds, ebx], ecx);                /* mov [ebx], ecx */
            ii(0x1016_767b, 2); jmp(0x1016_7683, 0x6); goto l_0x1016_7683; /* jmp 0x10167683 */
        l_0x1016_767d:
            ii(0x1016_767d, 4); mov(ebx, memd[ss, esp + 0x10]);         /* mov ebx, [esp+0x10] */
            ii(0x1016_7681, 2); mov(memd[ds, ebx], edx);                /* mov [ebx], edx */
        l_0x1016_7683:
            ii(0x1016_7683, 3); mov(edx, memd[ds, eax + 0x4]);          /* mov edx, [eax+0x4] */
            ii(0x1016_7686, 3); mov(edi, memd[ss, ebp + 0x4]);          /* mov edi, [ebp+0x4] */
            ii(0x1016_7689, 2); cmp(edx, edi);                          /* cmp edx, edi */
            ii(0x1016_768b, 2); if(jge(0x1016_7696, 0x9)) goto l_0x1016_7696; /* jge 0x10167696 */
            ii(0x1016_768d, 4); mov(edx, memd[ss, esp + 0x10]);         /* mov edx, [esp+0x10] */
            ii(0x1016_7691, 3); mov(memd[ds, edx + 0x4], edi);          /* mov [edx+0x4], edi */
            ii(0x1016_7694, 2); jmp(0x1016_769f, 0x9); goto l_0x1016_769f; /* jmp 0x1016769f */
        l_0x1016_7696:
            ii(0x1016_7696, 2); mov(ebx, edx);                          /* mov ebx, edx */
            ii(0x1016_7698, 4); mov(edx, memd[ss, esp + 0x10]);         /* mov edx, [esp+0x10] */
            ii(0x1016_769c, 3); mov(memd[ds, edx + 0x4], ebx);          /* mov [edx+0x4], ebx */
        l_0x1016_769f:
            ii(0x1016_769f, 3); mov(edx, memd[ds, eax + 0x8]);          /* mov edx, [eax+0x8] */
            ii(0x1016_76a2, 3); mov(ebx, memd[ss, ebp + 0x8]);          /* mov ebx, [ebp+0x8] */
            ii(0x1016_76a5, 2); cmp(edx, ebx);                          /* cmp edx, ebx */
            ii(0x1016_76a7, 2); if(jle(0x1016_76ab, 0x2)) goto l_0x1016_76ab; /* jle 0x101676ab */
            ii(0x1016_76a9, 2); mov(edx, ebx);                          /* mov edx, ebx */
        l_0x1016_76ab:
            ii(0x1016_76ab, 4); mov(ebx, memd[ss, esp + 0x10]);         /* mov ebx, [esp+0x10] */
            ii(0x1016_76af, 3); mov(memd[ds, ebx + 0x8], edx);          /* mov [ebx+0x8], edx */
            ii(0x1016_76b2, 3); mov(edx, memd[ds, eax + 0xc]);          /* mov edx, [eax+0xc] */
            ii(0x1016_76b5, 3); mov(ecx, memd[ss, ebp + 0xc]);          /* mov ecx, [ebp+0xc] */
            ii(0x1016_76b8, 2); cmp(edx, ecx);                          /* cmp edx, ecx */
            ii(0x1016_76ba, 2); if(jle(0x1016_76c5, 0x9)) goto l_0x1016_76c5; /* jle 0x101676c5 */
            ii(0x1016_76bc, 4); mov(eax, memd[ss, esp + 0x10]);         /* mov eax, [esp+0x10] */
            ii(0x1016_76c0, 3); mov(memd[ds, eax + 0xc], ecx);          /* mov [eax+0xc], ecx */
            ii(0x1016_76c3, 2); jmp(0x1016_76cc, 0x7); goto l_0x1016_76cc; /* jmp 0x101676cc */
        l_0x1016_76c5:
            ii(0x1016_76c5, 4); mov(eax, memd[ss, esp + 0x10]);         /* mov eax, [esp+0x10] */
            ii(0x1016_76c9, 3); mov(memd[ds, eax + 0xc], edx);          /* mov [eax+0xc], edx */
        l_0x1016_76cc:
            ii(0x1016_76cc, 4); mov(eax, memd[ss, esp + 0x10]);         /* mov eax, [esp+0x10] */
            ii(0x1016_76d0, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x1016_76d2, 3); cmp(edx, memd[ds, eax + 0x8]);          /* cmp edx, [eax+0x8] */
            ii(0x1016_76d5, 2); if(jg(0x1016_76df, 0x8)) goto l_0x1016_76df; /* jg 0x101676df */
            ii(0x1016_76d7, 3); mov(edx, memd[ds, eax + 0x4]);          /* mov edx, [eax+0x4] */
            ii(0x1016_76da, 3); cmp(edx, memd[ds, eax + 0xc]);          /* cmp edx, [eax+0xc] */
            ii(0x1016_76dd, 2); if(jle(0x1016_76f0, 0x11)) goto l_0x1016_76f0; /* jle 0x101676f0 */
        l_0x1016_76df:
            ii(0x1016_76df, 4); mov(eax, memd[ss, esp + 0x10]);         /* mov eax, [esp+0x10] */
        ...
        l_0x1016_76f0:
            ii(0x1016_76f0, 5); cmp(memd[ss, esp + 0x28], 0);           /* cmp dword [esp+0x28], 0x0 */
            ii(0x1016_76f5, 2); if(jz(0x1016_7702, 0xb)) goto l_0x1016_7702; /* jz 0x10167702 */
            ii(0x1016_76f7, 3); mov(eax, memd[ss, ebp + 0x8]);          /* mov eax, [ebp+0x8] */
            ii(0x1016_76fa, 3); sub(eax, memd[ss, ebp + 0]);            /* sub eax, [ebp] */
            ii(0x1016_76fd, 1); inc(eax);                               /* inc eax */
            ii(0x1016_76fe, 4); mov(memd[ss, esp + 0x24], eax);         /* mov [esp+0x24], eax */
        l_0x1016_7702:
            ii(0x1016_7702, 4); mov(ebx, memd[ss, esp + 0x28]);         /* mov ebx, [esp+0x28] */
            ii(0x1016_7706, 4); lea(edx, memd[ss, esp + 0x10]);         /* lea edx, [esp+0x10] */
            ...
            ii(0x1016_771a, 4); mov(esi, memd[ss, esp + 0x10]);         /* mov esi, [esp+0x10] */
            ii(0x1016_771e, 2); test(esi, esi);                         /* test esi, esi */
            ii(0x1016_7720, 6); if(jz(0x1016_7a10, 0x2ea)) goto l_0x1016_7a10; /* jz 0x10167a10 */
        l_0x1016_7726:
            ii(0x1016_7726, 3); mov(eax, memd[ds, esi + 0x10]);         /* mov eax, [esi+0x10] */
            ii(0x1016_7729, 2); mov(edi, memd[ds, esi]);                /* mov edi, [esi] */
            ii(0x1016_772b, 4); mov(memd[ss, esp + 0x20], eax);         /* mov [esp+0x20], eax */
            ii(0x1016_772f, 3); mov(eax, memd[ds, esi + 0x8]);          /* mov eax, [esi+0x8] */
            ii(0x1016_7732, 2); sub(eax, edi);                          /* sub eax, edi */
            ii(0x1016_7734, 3); lea(edi, memd[ds, eax + 0x1]);          /* lea edi, [eax+0x1] */
            ii(0x1016_7737, 3); mov(edx, memd[ds, esi + 0x4]);          /* mov edx, [esi+0x4] */
            ii(0x1016_773a, 3); mov(eax, memd[ds, esi + 0xc]);          /* mov eax, [esi+0xc] */
            ii(0x1016_773d, 2); sub(eax, edx);                          /* sub eax, edx */
            ii(0x1016_773f, 1); inc(eax);                               /* inc eax */
            ii(0x1016_7740, 4); mov(memd[ss, esp + 0x2c], eax);         /* mov [esp+0x2c], eax */
            ii(0x1016_7744, 3); imul(eax, edi);                         /* imul eax, edi */
            ii(0x1016_7747, 5); call(Definitions.sys_malloc_internal, 0x1_aba4); /* call 0x101822f0 */
            ii(0x1016_774c, 4); mov(memd[ss, esp + 0x30], eax);         /* mov [esp+0x30], eax */
            ii(0x1016_7750, 4); mov(memd[ss, esp + 0x18], eax);         /* mov [esp+0x18], eax */
            ...
            ii(0x1016_7762, 4); mov(ebx, memd[ss, esp + 0x2c]);         /* mov ebx, [esp+0x2c] */
            ...
            ii(0x1016_7770, 5); cmp(memd[ss, esp + 0x28], 0);           /* cmp dword [esp+0x28], 0x0 */
            ...
            ii(0x1016_778d, 3); mov(ebx, memd[ds, esi + 0x4]);          /* mov ebx, [esi+0x4] */
        ...
        l_0x1016_77af:
            ...
            ii(0x1016_77c0, 4); mov(ecx, memd[ss, esp + 0x50]);         /* mov ecx, [esp+0x50] */
        ...
        l_0x1016_77d0:
            ii(0x1016_77d0, 3); mov(eax, memd[ds, esi + 0x4]);          /* mov eax, [esi+0x4] */
            ii(0x1016_77d3, 3); mov(ebx, memd[ss, ebp + 0x4]);          /* mov ebx, [ebp+0x4] */
            ii(0x1016_77d6, 4); mov(edx, memd[ss, esp + 0x24]);         /* mov edx, [esp+0x24] */
            ii(0x1016_77da, 2); sub(eax, ebx);                          /* sub eax, ebx */
            ii(0x1016_77dc, 3); imul(eax, edx);                         /* imul eax, edx */
            ii(0x1016_77df, 1); push(edx);                              /* push edx */
            ii(0x1016_77e0, 4); mov(edx, memd[ss, esp + 0x2c]);         /* mov edx, [esp+0x2c] */
            ii(0x1016_77e4, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1016_77e6, 2); mov(eax, memd[ds, esi]);                /* mov eax, [esi] */
            ii(0x1016_77e8, 3); sub(eax, memd[ss, ebp + 0]);            /* sub eax, [ebp] */
            ii(0x1016_77eb, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1016_77ed, 1); push(eax);                              /* push eax */
            ii(0x1016_77ee, 1); push(edi);                              /* push edi */
            ii(0x1016_77ef, 4); mov(eax, memd[ss, esp + 0x38]);         /* mov eax, [esp+0x38] */
            ii(0x1016_77f3, 1); push(eax);                              /* push eax */
            ii(0x1016_77f4, 1); push(edi);                              /* push edi */
            ii(0x1016_77f5, 4); mov(edx, memd[ss, esp + 0x44]);         /* mov edx, [esp+0x44] */
        ...
        l_0x1016_7802:
            ii(0x1016_7802, 4); mov(eax, memd[ss, esp + 0x18]);         /* mov eax, [esp+0x18] */
            ii(0x1016_7806, 5); call(Definitions.sys_free_internal, 0x1_ac49); /* call 0x10182454 */
        l_0x1016_780b:
            ii(0x1016_780b, 4); mov(esi, memd[ss, esp + 0x20]);         /* mov esi, [esp+0x20] */
        ...
        l_0x1016_781c:
            ii(0x1016_781c, 4); mov(ebx, memd[ss, esp + 0x10]);         /* mov ebx, [esp+0x10] */
        ...
        l_0x1016_7828:
            ...
            ii(0x1016_782c, 3); mov(edi, memd[ds, ebx + 0x10]);         /* mov edi, [ebx+0x10] */
            ii(0x1016_782f, 5); call(/* sys */ 0x1016_9da0, 0x256c);    /* call 0x10169da0 */
            ii(0x1016_7834, 5); cmp(memd[ss, esp + 0x28], 0);           /* cmp dword [esp+0x28], 0x0 */
            ...
            ii(0x1016_7857, 3); mov(cl, memb[ds, esi + 0x4]);           /* mov cl, [esi+0x4] */
            ...
            ii(0x1016_7860, 3); mov(ecx, memd[ds, ebx + 0x4]);          /* mov ecx, [ebx+0x4] */
            ...
            ii(0x1016_7872, 3); mov(edx, memd[ds, ebx + 0x4]);          /* mov edx, [ebx+0x4] */
            ii(0x1016_7875, 3); mov(eax, memd[ds, ebx + 0xc]);          /* mov eax, [ebx+0xc] */
            ii(0x1016_7878, 3); mov(ecx, memd[ds, esi + 0x18]);         /* mov ecx, [esi+0x18] */
            ...
            ii(0x1016_7882, 3); mov(eax, memd[ds, ebx + 0x8]);          /* mov eax, [ebx+0x8] */
            ...
            ii(0x1016_788b, 3); mov(edx, memd[ds, esi + 0xc]);          /* mov edx, [esi+0xc] */
            ii(0x1016_788e, 3); mov(ecx, memd[ds, esi + 0x18]);         /* mov ecx, [esi+0x18] */
            ...
            ii(0x1016_7898, 3); mov(ebx, memd[ds, esi + 0x8]);          /* mov ebx, [esi+0x8] */
            ii(0x1016_789b, 3); mov(edx, memd[ds, esi + 0x2c]);         /* mov edx, [esi+0x2c] */
            ...
            ii(0x1016_78a5, 3); call_abs(memd[ds, esi + 0x40]);         /* call dword [esi+0x40] */
            ii(0x1016_78a8, 5); jmp(0x1016_7a03, 0x156); goto l_0x1016_7a03; /* jmp 0x10167a03 */
        l_0x1016_78ad:
            ii(0x1016_78ad, 3); mov(edx, memd[ds, ebx + 0x4]);          /* mov edx, [ebx+0x4] */
            ...
            ii(0x1016_78c1, 3); mov(eax, memd[ds, esi + 0x18]);         /* mov eax, [esi+0x18] */
            ii(0x1016_78c4, 3); mov(edx, memd[ds, ebx + 0x4]);          /* mov edx, [ebx+0x4] */
            ii(0x1016_78c7, 1); push(eax);                              /* push eax */
            ii(0x1016_78c8, 3); mov(eax, memd[ds, ebx + 0xc]);          /* mov eax, [ebx+0xc] */
            ii(0x1016_78cb, 2); sub(eax, edx);                          /* sub eax, edx */
            ii(0x1016_78cd, 1); inc(eax);                               /* inc eax */
            ii(0x1016_78ce, 1); push(eax);                              /* push eax */
            ii(0x1016_78cf, 3); mov(eax, memd[ds, ebx + 0x8]);          /* mov eax, [ebx+0x8] */
            ...
            ii(0x1016_78d8, 3); mov(edx, memd[ds, esi + 0xc]);          /* mov edx, [esi+0xc] */
            ii(0x1016_78db, 3); mov(ecx, memd[ds, esi + 0x18]);         /* mov ecx, [esi+0x18] */
            ...
            ii(0x1016_78e5, 3); mov(ebx, memd[ds, esi + 0x8]);          /* mov ebx, [esi+0x8] */
            ii(0x1016_78e8, 3); mov(edx, memd[ds, esi + 0x2c]);         /* mov edx, [esi+0x2c] */
        ...
        l_0x1016_78f6:
            ii(0x1016_78f6, 3); mov(eax, memd[ds, ebx + 0x4]);          /* mov eax, [ebx+0x4] */
            ii(0x1016_78f9, 3); mov(ecx, memd[ds, ebx + 0x4]);          /* mov ecx, [ebx+0x4] */
            ii(0x1016_78fc, 1); push(eax);                              /* push eax */
            ii(0x1016_78fd, 3); mov(eax, memd[ds, ebx + 0xc]);          /* mov eax, [ebx+0xc] */
            ...
            ii(0x1016_7905, 3); lea(edx, memd[ds, eax + 0x1]);          /* lea edx, [eax+0x1] */
            ii(0x1016_7908, 2); mov(ecx, memd[ds, ebx]);                /* mov ecx, [ebx] */
            ii(0x1016_790a, 3); mov(eax, memd[ds, ebx + 0x8]);          /* mov eax, [ebx+0x8] */
            ...
            ii(0x1016_7917, 3); mov(eax, memd[ds, esi + 0x18]);         /* mov eax, [esi+0x18] */
            ii(0x1016_791a, 1); push(eax);                              /* push eax */
            ii(0x1016_791b, 3); mov(edx, memd[ds, esi + 0xc]);          /* mov edx, [esi+0xc] */
            ii(0x1016_791e, 3); mov(eax, memd[ds, ebx + 0x4]);          /* mov eax, [ebx+0x4] */
            ii(0x1016_7921, 3); mov(ecx, memd[ds, esi + 0x18]);         /* mov ecx, [esi+0x18] */
            ...
            ii(0x1016_792b, 3); mov(ebx, memd[ds, esi + 0x8]);          /* mov ebx, [esi+0x8] */
            ii(0x1016_792e, 3); mov(edx, memd[ds, esi + 0x2c]);         /* mov edx, [esi+0x2c] */
        ...
        l_0x1016_7946:
            ...
            ii(0x1016_794f, 4); test(memb[ds, esi + 0x4], 0x20);        /* test byte [esi+0x4], 0x20 */
            ii(0x1016_7953, 2); if(jz(0x1016_79ad, 0x58)) goto l_0x1016_79ad; /* jz 0x101679ad */
            ii(0x1016_7955, 3); mov(eax, memd[ds, ebx + 0x4]);          /* mov eax, [ebx+0x4] */
            ii(0x1016_7958, 3); mov(edx, memd[ss, ebp + 0x4]);          /* mov edx, [ebp+0x4] */
            ii(0x1016_795b, 4); mov(ecx, memd[ss, esp + 0x24]);         /* mov ecx, [esp+0x24] */
            ii(0x1016_795f, 2); sub(eax, edx);                          /* sub eax, edx */
            ii(0x1016_7961, 3); imul(eax, ecx);                         /* imul eax, ecx */
            ii(0x1016_7964, 1); push(ecx);                              /* push ecx */
            ii(0x1016_7965, 4); mov(edx, memd[ss, esp + 0x2c]);         /* mov edx, [esp+0x2c] */
            ii(0x1016_7969, 3); mov(ecx, memd[ss, ebp + 0]);            /* mov ecx, [ebp] */
            ...
            ii(0x1016_7975, 3); mov(eax, memd[ds, esi + 0x18]);         /* mov eax, [esi+0x18] */
            ii(0x1016_7978, 3); mov(edx, memd[ds, ebx + 0x4]);          /* mov edx, [ebx+0x4] */
            ii(0x1016_797b, 1); push(eax);                              /* push eax */
            ii(0x1016_797c, 3); mov(eax, memd[ds, ebx + 0xc]);          /* mov eax, [ebx+0xc] */
            ...
            ii(0x1016_7985, 3); mov(eax, memd[ds, ebx + 0x8]);          /* mov eax, [ebx+0x8] */
            ...
            ii(0x1016_798e, 3); mov(edx, memd[ds, esi + 0xc]);          /* mov edx, [esi+0xc] */
            ii(0x1016_7991, 3); mov(ecx, memd[ds, esi + 0x18]);         /* mov ecx, [esi+0x18] */
            ...
            ii(0x1016_799b, 3); mov(ebx, memd[ds, esi + 0x8]);          /* mov ebx, [esi+0x8] */
            ii(0x1016_799e, 3); mov(edx, memd[ds, esi + 0x2c]);         /* mov edx, [esi+0x2c] */
            ...
            ii(0x1016_79a8, 3); call_abs(memd[ds, esi + 0x40]);         /* call dword [esi+0x40] */
            ii(0x1016_79ab, 2); jmp(0x1016_7a03, 0x56); goto l_0x1016_7a03; /* jmp 0x10167a03 */
        l_0x1016_79ad:
            ii(0x1016_79ad, 3); mov(eax, memd[ds, ebx + 0x4]);          /* mov eax, [ebx+0x4] */
            ii(0x1016_79b0, 3); mov(edx, memd[ss, ebp + 0x4]);          /* mov edx, [ebp+0x4] */
            ii(0x1016_79b3, 4); mov(ecx, memd[ss, esp + 0x24]);         /* mov ecx, [esp+0x24] */
            ii(0x1016_79b7, 2); sub(eax, edx);                          /* sub eax, edx */
            ii(0x1016_79b9, 3); imul(eax, ecx);                         /* imul eax, ecx */
            ii(0x1016_79bc, 1); push(ecx);                              /* push ecx */
            ii(0x1016_79bd, 4); mov(edx, memd[ss, esp + 0x2c]);         /* mov edx, [esp+0x2c] */
            ii(0x1016_79c1, 3); mov(ecx, memd[ss, ebp + 0]);            /* mov ecx, [ebp] */
            ...
            ii(0x1016_79cd, 3); mov(eax, memd[ds, esi + 0x18]);         /* mov eax, [esi+0x18] */
            ii(0x1016_79d0, 3); mov(edx, memd[ds, ebx + 0x4]);          /* mov edx, [ebx+0x4] */
            ii(0x1016_79d3, 1); push(eax);                              /* push eax */
            ii(0x1016_79d4, 3); mov(eax, memd[ds, ebx + 0xc]);          /* mov eax, [ebx+0xc] */
            ...
            ii(0x1016_79dd, 3); mov(eax, memd[ds, ebx + 0x8]);          /* mov eax, [ebx+0x8] */
            ...
            ii(0x1016_79e6, 3); sub(eax, memd[ds, esi + 0xc]);          /* sub eax, [esi+0xc] */
            ii(0x1016_79e9, 3); mov(edx, memd[ds, esi + 0x18]);         /* mov edx, [esi+0x18] */
            ii(0x1016_79ec, 3); imul(edx, eax);                         /* imul edx, eax */
            ii(0x1016_79ef, 3); mov(ebx, memd[ds, esi + 0x8]);          /* mov ebx, [esi+0x8] */
            ii(0x1016_79f2, 2); mov(eax, ecx);                          /* mov eax, ecx */
            ii(0x1016_79f4, 2); sub(eax, ebx);                          /* sub eax, ebx */
            ii(0x1016_79f6, 3); mov(ebx, memd[ds, esi + 0x2c]);         /* mov ebx, [esi+0x2c] */
        ...
        l_0x1016_7a10:
            ii(0x1016_7a10, 4); mov(ebx, memd[ss, esp + 0x10]);         /* mov ebx, [esp+0x10] */
        ...
        l_0x1016_7a18:
            ...
            ii(0x1016_7a1e, 3); mov(edi, memd[ds, ebx + 0x10]);         /* mov edi, [ebx+0x10] */
            ii(0x1016_7a21, 2); test(ecx, ecx);                         /* test ecx, ecx */
            ii(0x1016_7a23, 2); if(jz(0x1016_7a75, 0x50)) goto l_0x1016_7a75; /* jz 0x10167a75 */
            ii(0x1016_7a25, 5); cmp(memd[ss, esp + 0x28], 0);           /* cmp dword [esp+0x28], 0x0 */
            ii(0x1016_7a2a, 2); if(jnz(0x1016_7a75, 0x49)) goto l_0x1016_7a75; /* jnz 0x10167a75 */
            ii(0x1016_7a2c, 3); mov(eax, memd[ds, ebx + 0x4]);          /* mov eax, [ebx+0x4] */
            ii(0x1016_7a2f, 3); mov(ecx, memd[ds, ebx + 0x4]);          /* mov ecx, [ebx+0x4] */
            ii(0x1016_7a32, 1); push(eax);                              /* push eax */
            ii(0x1016_7a33, 3); mov(eax, memd[ds, ebx + 0xc]);          /* mov eax, [ebx+0xc] */
            ii(0x1016_7a36, 2); sub(eax, ecx);                          /* sub eax, ecx */
            ii(0x1016_7a38, 3); lea(esi, memd[ds, eax + 0x1]);          /* lea esi, [eax+0x1] */
            ii(0x1016_7a3b, 2); mov(edx, memd[ds, ebx]);                /* mov edx, [ebx] */
            ii(0x1016_7a3d, 3); mov(eax, memd[ds, ebx + 0x8]);          /* mov eax, [ebx+0x8] */
            ...
            ii(0x1016_7a53, 3); mov(edx, memd[ds, ebx + 0x4]);          /* mov edx, [ebx+0x4] */
        ...
        l_0x1016_7a82:
            ...
            ii(0x1016_7a8b, 5); cmp(memd[ss, esp + 0x28], 0);           /* cmp dword [esp+0x28], 0x0 */
            ...
            ii(0x1016_7a9b, 3); mov(ecx, memd[ss, ebp + 0xc]);          /* mov ecx, [ebp+0xc] */
            ii(0x1016_7a9e, 3); mov(ebx, memd[ss, ebp + 0x8]);          /* mov ebx, [ebp+0x8] */
            ii(0x1016_7aa1, 3); mov(edx, memd[ss, ebp + 0x4]);          /* mov edx, [ebp+0x4] */
            ii(0x1016_7aa4, 3); mov(eax, memd[ss, ebp + 0]);            /* mov eax, [ebp] */
            ii(0x1016_7aa7, 5); call(/* sys */ 0x1016_c184, 0x46d8);    /* call 0x1016c184 */
            ii(0x1016_7aac, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1016_7aae, 2); if(jz(0x1016_7ab5, 0x5)) goto l_0x1016_7ab5; /* jz 0x10167ab5 */
