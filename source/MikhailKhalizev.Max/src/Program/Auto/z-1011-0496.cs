...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_0496()
        {
            ...
            ii(0x1011_04ae, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_04b1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_04b4, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1011_04b6, 5); call(0x1010_edfe, -0x16bd);             /* call 0x1010edfe */
            ii(0x1011_04bb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_04be, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1011_04c0, 5); call(0x1010_eda6, -0x171f);             /* call 0x1010eda6 */
            ii(0x1011_04c5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_04c8, 6); mov(al, memb[ds, eax + 0x141]);         /* mov al, [eax+0x141] */
            ...
            ii(0x1011_04db, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_04de, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_04e0, 6); mov(dl, memb[ds, eax + 0x142]);         /* mov dl, [eax+0x142] */
            ii(0x1011_04e6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_04e9, 6); mov(al, memb[ds, eax + 0x140]);         /* mov al, [eax+0x140] */
            ii(0x1011_04ef, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1011_04f1, 2); sub(edx, eax);                          /* sub edx, eax */
            ii(0x1011_04f3, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1011_04f6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_04f9, 6); mov(dl, memb[ds, eax + 0x142]);         /* mov dl, [eax+0x142] */
            ii(0x1011_04ff, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0502, 6); cmp(dl, memb[ds, eax + 0x140]);         /* cmp dl, [eax+0x140] */
            ii(0x1011_0508, 2); if(jb(0x1011_052a, 0x20)) goto l_0x1011_052a; /* jb 0x1011052a */
            ii(0x1011_050a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_050d, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_050f, 6); mov(dl, memb[ds, eax + 0x140]);         /* mov dl, [eax+0x140] */
            ii(0x1011_0515, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0518, 6); mov(al, memb[ds, eax + 0x142]);         /* mov al, [eax+0x142] */
            ...
            ii(0x1011_0528, 2); if(jl(0x1011_052c, 0x2)) goto l_0x1011_052c; /* jl 0x1011052c */
        l_0x1011_052a:
            ii(0x1011_052a, 2); jmp(0x1011_0554, 0x28); goto l_0x1011_0554; /* jmp 0x10110554 */
        l_0x1011_052c:
            ii(0x1011_052c, 5); mov(ebx, 0x4);                          /* mov ebx, 0x4 */
            ii(0x1011_0531, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1011_0535, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0538, 5); call(0x1011_0296, -0x2a7);              /* call 0x10110296 */
            ii(0x1011_053d, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
        ...
        l_0x1011_0554:
            ...
            ii(0x1011_057d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0580, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1011_0582, 5); call(0x1010_8a05, -0x7b82);             /* call 0x10108a05 */
            ii(0x1011_0587, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_058a, 5); call(0x1011_0357, -0x238);              /* call 0x10110357 */
        l_0x1011_058f:
            ii(0x1011_058f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0592, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1011_0594, 3); mov(eax, memd[ds, eax + 0x12]);         /* mov eax, [eax+0x12] */
