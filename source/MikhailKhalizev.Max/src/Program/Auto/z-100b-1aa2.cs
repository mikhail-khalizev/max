...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_1aa2()
        {
            ...
            ii(0x100b_1aba, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_1abd, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_1abf, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_1ace, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_1ad1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_1ae3, 2); if(jnz(0x100b_1ae7, 0x2)) goto l_0x100b_1ae7; /* jnz 0x100b1ae7 */
        l_0x100b_1ae5:
            ii(0x100b_1ae5, 2); jmp(0x100b_1b06, 0x1f); goto l_0x100b_1b06; /* jmp 0x100b1b06 */
        l_0x100b_1ae7:
            ii(0x100b_1ae7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_1aea, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_1aed, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_1af0, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x100b_1af3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_1b00, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_1b03, 3); call_abs(memd[ds, ebx + 0x44]);         /* call dword [ebx+0x44] */
        l_0x100b_1b06:
