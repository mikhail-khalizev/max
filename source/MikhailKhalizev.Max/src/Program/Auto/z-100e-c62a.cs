...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_c62a()
        {
            ...
            ii(0x100e_c65b, 2); jmp(0x100e_c665, 0x8); goto l_0x100e_c665; /* jmp 0x100ec665 */
        l_0x100e_c65d:
            ii(0x100e_c65d, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x100e_c660, 5); call(0x1007_6bf8, -0x7_5a6d);           /* call 0x10076bf8 */
        l_0x100e_c665:
            ii(0x100e_c665, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100e_c667, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ...
            ii(0x100e_c673, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x100e_c676, 5); call(0x1007_63a0, -0x7_62db);           /* call 0x100763a0 */
            ii(0x100e_c67b, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100e_c67d, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ii(0x100e_c680, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100e_c684, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x100e_c686, 2); if(jnz(0x100e_c697, 0xf)) goto l_0x100e_c697; /* jnz 0x100ec697 */
            ii(0x100e_c688, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x100e_c68b, 5); call(0x1007_63a0, -0x7_62f0);           /* call 0x100763a0 */
            ii(0x100e_c690, 5); cmp(memw[ds, eax + 0x8], 0x33);         /* cmp word [eax+0x8], 0x33 */
            ii(0x100e_c695, 2); if(jz(0x100e_c699, 0x2)) goto l_0x100e_c699; /* jz 0x100ec699 */
        l_0x100e_c697:
            ii(0x100e_c697, 2); jmp(0x100e_c6b1, 0x18); goto l_0x100e_c6b1; /* jmp 0x100ec6b1 */
        l_0x100e_c699:
            ii(0x100e_c699, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ...
            ii(0x100e_c6af, 2); if(jg(0x100e_c6b3, 0x2)) goto l_0x100e_c6b3; /* jg 0x100ec6b3 */
        l_0x100e_c6b1:
            ii(0x100e_c6b1, 2); jmp(0x100e_c6c3, 0x10); goto l_0x100e_c6c3; /* jmp 0x100ec6c3 */
        l_0x100e_c6b3:
            ii(0x100e_c6b3, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x100e_c6b7, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100e_c6b9, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
        ...
        l_0x100e_c6c5:
            ii(0x100e_c6c5, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x100e_c6c9, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100e_c6cb, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
        ...
        //  ii(0x100e_c6d7, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
        //  ii(0x100e_c6da, 5); call(0x1007_5f6c, -0x7_6773);           /* call 0x10075f6c */
        l_0x100e_c6df:
            ii(0x100e_c6df, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
