...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_9395()
        {
            ...
            ii(0x100a_93c9, 2); if(jle(0x100a_93d1, 0x6)) goto l_0x100a_93d1; /* jle 0x100a93d1 */
        l_0x100a_93cb:
            ii(0x100a_93cb, 4); mov(memb[ss, ebp - 0x4], 0x1);          /* mov byte [ebp-0x4], 0x1 */
            ii(0x100a_93cf, 2); jmp(0x100a_93d9, 0x8); goto l_0x100a_93d9; /* jmp 0x100a93d9 */
        l_0x100a_93d1:
            ii(0x100a_93d1, 5); mov(al, memb[ds, 0x101c_9448]);         /* mov al, [0x101c9448] */
            ii(0x100a_93d6, 3); mov(memb[ss, ebp - 0x4], al);           /* mov [ebp-0x4], al */
        l_0x100a_93d9:
            ii(0x100a_93d9, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
