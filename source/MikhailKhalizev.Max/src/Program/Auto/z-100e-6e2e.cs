...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_6e2e()
        {
            ...
            ii(0x100e_6e44, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100e_6e47, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100e_6e4a, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x100e_6e4d, 5); mov(eax, 0x26);                         /* mov eax, 0x26 */
            ii(0x100e_6e52, 5); call(0x100e_883d, 0x19e6);              /* call 0x100e883d */
            ii(0x100e_6e57, 3); mov(eax, memd[ds, eax + 0x16]);         /* mov eax, [eax+0x16] */
            ii(0x100e_6e5a, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x100e_6e5d, 7); mov(memd[ss, ebp - 0x1c], 0x280);       /* mov dword [ebp-0x1c], 0x280 */
            ii(0x100e_6e64, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100e_6e67, 4); test(memb[ds, eax + 0x12], 0x10);       /* test byte [eax+0x12], 0x10 */
            ii(0x100e_6e6b, 2); if(jz(0x100e_6e76, 0x9)) goto l_0x100e_6e76; /* jz 0x100e6e76 */
            ii(0x100e_6e6d, 7); mov(memd[ss, ebp - 0x10], 0x80);        /* mov dword [ebp-0x10], 0x80 */
            ii(0x100e_6e74, 2); jmp(0x100e_6e7d, 0x7); goto l_0x100e_6e7d; /* jmp 0x100e6e7d */
        l_0x100e_6e76:
            ii(0x100e_6e76, 7); mov(memd[ss, ebp - 0x10], 0x40);        /* mov dword [ebp-0x10], 0x40 */
        l_0x100e_6e7d:
            ii(0x100e_6e7d, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100e_6e80, 3); mov(ebx, memd[ds, eax + 0x14]);         /* mov ebx, [eax+0x14] */
            ii(0x100e_6e83, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100e_6e86, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x100e_6e95, 3); mov(memd[ss, ebp - 0x18], ebx);         /* mov [ebp-0x18], ebx */
            ii(0x100e_6e98, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100e_6e9b, 3); mov(ebx, memd[ds, eax + 0x16]);         /* mov ebx, [eax+0x16] */
            ii(0x100e_6e9e, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100e_6ea1, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x100e_6eb2, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100e_6eb5, 4); movsx(edx, memw[ss, ebp - 0x18]);       /* movsx edx, word [ebp-0x18] */
            ...
            ii(0x100e_6ed5, 3); mov(memd[ss, ebp - 0x34], eax);         /* mov [ebp-0x34], eax */
            ii(0x100e_6ed8, 4); movsx(edx, memw[ss, ebp - 0x14]);       /* movsx edx, word [ebp-0x14] */
            ...
            ii(0x100e_6ef8, 3); mov(memd[ss, ebp - 0x30], eax);         /* mov [ebp-0x30], eax */
            ii(0x100e_6efb, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x100e_6f0d, 3); add(eax, memd[ss, ebp - 0x34]);         /* add eax, [ebp-0x34] */
            ii(0x100e_6f10, 3); sub(eax, 0x8);                          /* sub eax, 0x8 */
            ii(0x100e_6f13, 3); mov(memd[ss, ebp - 0x2c], eax);         /* mov [ebp-0x2c], eax */
            ii(0x100e_6f16, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x100e_6f28, 3); add(eax, memd[ss, ebp - 0x30]);         /* add eax, [ebp-0x30] */
            ii(0x100e_6f2b, 3); sub(eax, 0x8);                          /* sub eax, 0x8 */
            ii(0x100e_6f2e, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ii(0x100e_6f31, 3); mov(eax, memd[ss, ebp - 0x34]);         /* mov eax, [ebp-0x34] */
            ii(0x100e_6f34, 3); cmp(eax, memd[ss, ebp - 0x2c]);         /* cmp eax, [ebp-0x2c] */
            ii(0x100e_6f37, 2); if(jge(0x100e_6f41, 0x8)) goto l_0x100e_6f41; /* jge 0x100e6f41 */
            ii(0x100e_6f39, 3); mov(eax, memd[ss, ebp - 0x30]);         /* mov eax, [ebp-0x30] */
            ii(0x100e_6f3c, 3); cmp(eax, memd[ss, ebp - 0x28]);         /* cmp eax, [ebp-0x28] */
            ii(0x100e_6f3f, 2); if(jl(0x100e_6f46, 0x5)) goto l_0x100e_6f46; /* jl 0x100e6f46 */
        l_0x100e_6f41:
        ...
        l_0x100e_6f46:
            ...
            ii(0x100e_6f4b, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x100e_6f4e, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100e_6f51, 4); test(memb[ds, eax + 0x12], 0x10);       /* test byte [eax+0x12], 0x10 */
            ii(0x100e_6f55, 2); if(jnz(0x100e_6f67, 0x10)) goto l_0x100e_6f67; /* jnz 0x100e6f67 */
            ii(0x100e_6f57, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x100e_6f5a, 3); mov(edx, memd[ss, ebp - 0x24]);         /* mov edx, [ebp-0x24] */
            ii(0x100e_6f5d, 3); sar(edx, 0x1f);                         /* sar edx, 0x1f */
            ii(0x100e_6f60, 2); sub(eax, edx);                          /* sub eax, edx */
            ii(0x100e_6f62, 2); sar(eax, 0x1);                          /* sar eax, 1 */
            ii(0x100e_6f64, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
        l_0x100e_6f67:
            ii(0x100e_6f67, 7); mov(memd[ss, ebp - 0x44], 0);           /* mov dword [ebp-0x44], 0x0 */
            ii(0x100e_6f6e, 7); mov(memd[ss, ebp - 0x40], 0);           /* mov dword [ebp-0x40], 0x0 */
            ...
            ii(0x100e_6f8f, 3); mov(memd[ss, ebp - 0x3c], eax);         /* mov [ebp-0x3c], eax */
            ...
            ii(0x100e_6fac, 3); mov(memd[ss, ebp - 0x38], eax);         /* mov [ebp-0x38], eax */
            ii(0x100e_6faf, 4); cmp(memd[ss, ebp - 0x24], 0x2a);        /* cmp dword [ebp-0x24], 0x2a */
        ...
        l_0x100e_6fc1:
            ii(0x100e_6fc1, 4); cmp(memd[ss, ebp - 0x24], 0x18);        /* cmp dword [ebp-0x24], 0x18 */
        ...
        l_0x100e_6fdd:
            ...
            ii(0x100e_6fe3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_6fe6, 1); push(eax);                              /* push eax */
            ii(0x100e_6fe7, 3); lea(eax, memd[ss, ebp - 0x44]);         /* lea eax, [ebp-0x44] */
            ii(0x100e_6fea, 1); push(eax);                              /* push eax */
            ii(0x100e_6feb, 3); lea(ecx, memd[ss, ebp - 0x34]);         /* lea ecx, [ebp-0x34] */
            ii(0x100e_6fee, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ii(0x100e_6ff1, 4); movsx(edx, memw[ss, ebp - 0x1c]);       /* movsx edx, word [ebp-0x1c] */
            ii(0x100e_6ff5, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
