...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_b0d0()
        {
            ...
            ii(0x1017_b0df, 3); mov(memd[ss, ebp - 12], ebx);           /* mov [ebp-0xc], ebx */
            ii(0x1017_b0e2, 3); mov(edx, memd[ss, ebp + 48]);           /* mov edx, [ebp+0x30] */
            ii(0x1017_b0e5, 1); push(edx);                              /* push edx */
            ii(0x1017_b0e6, 3); mov(ebx, memd[ss, ebp + 44]);           /* mov ebx, [ebp+0x2c] */
            ii(0x1017_b0e9, 1); push(ebx);                              /* push ebx */
            ii(0x1017_b0ea, 3); mov(eax, memd[ss, ebp + 40]);           /* mov eax, [ebp+0x28] */
            ii(0x1017_b0ed, 1); push(eax);                              /* push eax */
            ii(0x1017_b0ee, 3); mov(edx, memd[ss, ebp + 36]);           /* mov edx, [ebp+0x24] */
            ii(0x1017_b0f1, 1); push(edx);                              /* push edx */
            ii(0x1017_b0f2, 3); mov(ebx, memd[ss, ebp + 32]);           /* mov ebx, [ebp+0x20] */
            ii(0x1017_b0f5, 1); push(ebx);                              /* push ebx */
            ii(0x1017_b0f6, 3); mov(eax, memd[ss, ebp + 28]);           /* mov eax, [ebp+0x1c] */
            ii(0x1017_b0f9, 1); push(eax);                              /* push eax */
            ii(0x1017_b0fa, 3); mov(edx, memd[ss, ebp + 24]);           /* mov edx, [ebp+0x18] */
            ii(0x1017_b0fd, 1); push(edx);                              /* push edx */
            ii(0x1017_b0fe, 3); mov(ebx, memd[ss, ebp + 20]);           /* mov ebx, [ebp+0x14] */
            ii(0x1017_b101, 1); push(ebx);                              /* push ebx */
            ii(0x1017_b102, 3); mov(eax, memd[ss, ebp + 16]);           /* mov eax, [ebp+0x10] */
            ii(0x1017_b105, 1); push(eax);                              /* push eax */
            ii(0x1017_b106, 3); mov(edx, memd[ss, ebp + 12]);           /* mov edx, [ebp+0xc] */
