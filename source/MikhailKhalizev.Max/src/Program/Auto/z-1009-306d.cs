...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_306d()
        {
            ...
            ii(0x1009_3085, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_3088, 4); mov(memb[ss, ebp - 0x8], 0x15);         /* mov byte [ebp-0x8], 0x15 */
            ii(0x1009_308c, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
