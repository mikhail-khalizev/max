...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_af7a()
        {
            ...
            ii(0x1007_af91, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1007_af94, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1007_af97, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1007_af9a, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1007_af9d, 5); call(0x1007_8789, -0x2819);             /* call 0x10078789 */
            ii(0x1007_afa2, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1007_afa5, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1007_afa8, 5); call(0x1007_623c, -0x4d71);             /* call 0x1007623c */
            ii(0x1007_afad, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1007_afaf, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1007_afb2, 5); imul(ax, memw[ds, edx + 20]);           /* imul ax, [edx+0x14] */
            ii(0x1007_afb7, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1007_afba, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1007_afbd, 5); call(0x1007_623c, -0x4d86);             /* call 0x1007623c */
            ii(0x1007_afc2, 3); mov(eax, memd[ds, eax + 12]);           /* mov eax, [eax+0xc] */
            ...
            ii(0x1007_afcc, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1007_afcf, 5); call(0x1007_623c, -0x4d98);             /* call 0x1007623c */
            ii(0x1007_afd4, 3); mov(eax, memd[ds, eax + 14]);           /* mov eax, [eax+0xe] */
            ...
            ii(0x1007_afde, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1007_afe1, 5); call(0x1007_623c, -0x4daa);             /* call 0x1007623c */
            ii(0x1007_afe6, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1007_afe8, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1007_afeb, 5); call(0x1007_623c, -0x4db4);             /* call 0x1007623c */
            ii(0x1007_aff0, 4); mov(dx, memw[ds, edx + 18]);            /* mov dx, [edx+0x12] */
            ii(0x1007_aff4, 4); cmp(dx, memw[ds, eax + 18]);            /* cmp dx, [eax+0x12] */
            ii(0x1007_aff8, 2); if(jg(0x1007_b015, 0x1b)) goto l_0x1007_b015; /* jg 0x1007b015 */
        l_0x1007_affa:
            ii(0x1007_affa, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1007_affd, 3); mov(edx, memd[ds, eax + 6]);            /* mov edx, [eax+0x6] */
            ii(0x1007_b000, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1007_b003, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1007_b006, 3); mov(eax, memd[ds, eax + 6]);            /* mov eax, [eax+0x6] */
        ...
        l_0x1007_b015:
            ii(0x1007_b015, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1007_b018, 3); mov(al, memb[ds, eax + 77]);            /* mov al, [eax+0x4d] */
            ii(0x1007_b01b, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1007_b01d, 1); dec(eax);                               /* dec eax */
            ii(0x1007_b01e, 3); add(memd[ss, ebp - 12], eax);           /* add [ebp-0xc], eax */
        l_0x1007_b021:
            ii(0x1007_b021, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1007_b024, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1007_b027, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
