...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_cdf8()
        {
            ...
            ii(0x1008_ce10, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_ce13, 4); mov(memb[ss, ebp - 0x8], 0x9);          /* mov byte [ebp-0x8], 0x9 */
            ii(0x1008_ce17, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
