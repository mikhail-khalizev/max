...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("883b32f6-7ddc-4365-9030-6b11dbe66b3f")]
        public void Method_100e_0608()
        {
            ii(0x100e_0608, 5); pushd(0x28);                            /* push 0x28 */
            ii(0x100e_060d, 5); calld(Definitions.sys_check_available_stack_size, 0x85740); /* call 0x10165d52 */
            ...
            ii(0x100e_0626, 5); calld(0x1007_6d58, -0x698d3);           /* call 0x10076d58 */
            ...
            ii(0x100e_0645, 1); retd(); return;                         /* ret */
        }
    }
}
