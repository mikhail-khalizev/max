...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("69566e88-e98f-4ca2-818a-d9bc3ae96734")]
        public void Method_0000_bf5c()
        {
            ii(0xbf5c, 3);    mov(ds, memw_a16[ss, bp + 0x2]);          /* mov ds, [bp+0x2] */
            ii(0xbf5f, 2);    pushd(eax);                               /* push eax */
            ii(0xbf61, 2);    pushd(ebx);                               /* push ebx */
            ii(0xbf63, 5);    lar(ebx, memw_a16[ss, bp + 0x2]);         /* lar ebx, word [bp+0x2] */
            ii(0xbf68, 5);    bt(ebx, 0x16);                            /* bt ebx, 0x16 */
            ii(0xbf6d, 6);    mov(ebx, 0);                              /* mov ebx, 0x0 */
            ii(0xbf73, 2);    if(jaew_func(0xbf76, 0x1)) return;        /* jae 0xbf76 */ /* Адрес перехода делит инструкцию в этой функции пополам. */
            ii(0xbf75, 4);    mov(ebx, memd_a16[ss, bp + 0x2a]);        /* mov ebx, [bp+0x2a] */
