...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_e943()
        {
            ...
            ii(0x1010_e955, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ...
            ii(0x1010_e969, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1010_e96c, 4); cmp(memd[ss, ebp - 8], 0);              /* cmp dword [ebp-0x8], 0x0 */
            ii(0x1010_e970, 2); if(jz(0x1010_e986, 0x14)) goto l_0x1010_e986; /* jz 0x1010e986 */
            ii(0x1010_e972, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_e974, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x1010_e981, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1010_e984, 2); jmp(0x1010_e98d, 7); goto l_0x1010_e98d; /* jmp 0x1010e98d */
        l_0x1010_e986:
            ii(0x1010_e986, 7); mov(memd[ss, ebp - 4], 0);              /* mov dword [ebp-0x4], 0x0 */
        l_0x1010_e98d:
