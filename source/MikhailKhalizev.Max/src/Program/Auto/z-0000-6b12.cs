...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_6b12()
        {
            ...
            ii(0x6b15, 3);    mov(dh, memb[ds, bx + 0x7]);              /* mov dh, [bx+0x7] */
            ii(0x6b18, 3);    mov(dl, memb[ds, bx + 0x4]);              /* mov dl, [bx+0x4] */
            ii(0x6b1b, 3);    mov(bx, memw[ds, bx + 0x2]);              /* mov bx, [bx+0x2] */
            ...
            ii(0x6b2a, 2);    if(jz(0x6b2f, 0x3)) goto l_0x6b2f;        /* jz 0x6b2f */
