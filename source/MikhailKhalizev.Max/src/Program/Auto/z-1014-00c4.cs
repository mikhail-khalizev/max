...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_00c4()
        {
            ...
            ii(0x1014_00d9, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1014_00dc, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_00df, 3);  mov(memd[ss, ebp - 12], ebx);         /* mov [ebp-0xc], ebx */
            ii(0x1014_00e2, 3);  mov(memd[ss, ebp - 8], ecx);          /* mov [ebp-0x8], ecx */
            ii(0x1014_00e5, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x1014_00ea, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1014_00ff, 3);  mov(memd[ss, ebp - 20], edx);         /* mov [ebp-0x14], edx */
            ii(0x1014_0102, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x1014_0107, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1014_0116, 3);  mov(edx, memd[ss, ebp + 16]);         /* mov edx, [ebp+0x10] */
            ii(0x1014_0119, 3);  imul(edx, eax);                       /* imul edx, eax */
            ii(0x1014_011c, 3);  mov(memd[ss, ebp - 24], edx);         /* mov [ebp-0x18], edx */
            ii(0x1014_011f, 4);  movsx(eax, memw[ss, ebp - 20]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1014_0123, 3);  cmp(eax, 1);                          /* cmp eax, 0x1 */
            ii(0x1014_0126, 2);  if(jge(0x1014_012f, 7)) goto l_0x1014_012f;/* jge 0x1014012f */
            ii(0x1014_0128, 7);  mov(memd[ss, ebp - 20], 1);           /* mov dword [ebp-0x14], 0x1 */
        l_0x1014_012f:
            ii(0x1014_012f, 4);  movsx(eax, memw[ss, ebp - 24]);       /* movsx eax, word [ebp-0x18] */
            ii(0x1014_0133, 3);  cmp(eax, 1);                          /* cmp eax, 0x1 */
            ii(0x1014_0136, 2);  if(jge(0x1014_013f, 7)) goto l_0x1014_013f;/* jge 0x1014013f */
            ii(0x1014_0138, 7);  mov(memd[ss, ebp - 24], 1);           /* mov dword [ebp-0x18], 0x1 */
        l_0x1014_013f:
            ii(0x1014_013f, 2);  xor(eax, eax);                        /* xor eax, eax */
            ii(0x1014_0141, 1);  push(eax);                            /* push eax */
            ii(0x1014_0142, 4);  movsx(eax, memw[ss, ebp - 24]);       /* movsx eax, word [ebp-0x18] */
            ii(0x1014_0146, 1);  push(eax);                            /* push eax */
            ii(0x1014_0147, 4);  movsx(ecx, memw[ss, ebp + 28]);       /* movsx ecx, word [ebp+0x1c] */
            ...
            ii(0x1014_0154, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1014_0157, 5);  call(0x1013_f4b0, -0xcac);            /* call 0x1013f4b0 */
            ii(0x1014_015c, 4);  movsx(eax, memw[ss, ebp - 20]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1014_0160, 1);  push(eax);                            /* push eax */
            ii(0x1014_0161, 4);  movsx(eax, memw[ss, ebp - 24]);       /* movsx eax, word [ebp-0x18] */
            ii(0x1014_0165, 1);  push(eax);                            /* push eax */
            ii(0x1014_0166, 4);  movsx(eax, memw[ss, ebp + 24]);       /* movsx eax, word [ebp+0x18] */
            ii(0x1014_016a, 1);  push(eax);                            /* push eax */
            ii(0x1014_016b, 4);  movsx(ecx, memw[ss, ebp + 20]);       /* movsx ecx, word [ebp+0x14] */
            ii(0x1014_016f, 3);  mov(eax, memd[ss, ebp + 28]);         /* mov eax, [ebp+0x1c] */
            ...
            ii(0x1014_017c, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
