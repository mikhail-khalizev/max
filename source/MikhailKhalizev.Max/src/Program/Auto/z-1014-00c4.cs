...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_00c4()
        {
            ...
            ii(0x1014_00dc, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_00df, 3); mov(memd[ss, ebp - 0xc], ebx);          /* mov [ebp-0xc], ebx */
            ii(0x1014_00e2, 3); mov(memd[ss, ebp - 0x8], ecx);          /* mov [ebp-0x8], ecx */
            ...
            ii(0x1014_00f9, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x1014_0126, 2); if(jge(0x1014_012f, 0x7)) goto l_0x1014_012f; /* jge 0x1014012f */
            ii(0x1014_0128, 7); mov(memd[ss, ebp - 0x14], 0x1);         /* mov dword [ebp-0x14], 0x1 */
        l_0x1014_012f:
            ii(0x1014_012f, 4); movsx(eax, memw[ss, ebp - 0x18]);       /* movsx eax, word [ebp-0x18] */
            ii(0x1014_0133, 3); cmp(eax, 0x1);                          /* cmp eax, 0x1 */
            ii(0x1014_0136, 2); if(jge(0x1014_013f, 0x7)) goto l_0x1014_013f; /* jge 0x1014013f */
            ii(0x1014_0138, 7); mov(memd[ss, ebp - 0x18], 0x1);         /* mov dword [ebp-0x18], 0x1 */
        l_0x1014_013f:
            ...
            ii(0x1014_0150, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ...
            ii(0x1014_0178, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
