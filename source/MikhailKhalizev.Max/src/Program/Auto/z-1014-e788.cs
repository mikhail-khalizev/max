...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_e788()
        {
            ...
            ii(0x1014_e79e, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1014_e7a1, 3);  mov(memd[ss, ebp - 8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1014_e7a4, 3);  mov(memb[ss, ebp - 4], bl);           /* mov [ebp-0x4], bl */
            ii(0x1014_e7a7, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x1014_e7ba, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1014_e7bd, 2);  xor(eax, eax);                        /* xor eax, eax */
            ii(0x1014_e7bf, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x1014_e7c2, 3);  mov(al, memb[ds, edx + 41]);          /* mov al, [edx+0x29] */
            ii(0x1014_e7c5, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1014_e7c8, 3);  mov(al, memb[ss, ebp - 8]);           /* mov al, [ebp-0x8] */
            ii(0x1014_e7cb, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x1014_e7ce, 3);  mov(memb[ds, edx + 46], al);          /* mov [edx+0x2e], al */
            ii(0x1014_e7d1, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1014_e7d4, 3);  mov(edx, memd[ds, eax + 6]);          /* mov edx, [eax+0x6] */
            ii(0x1014_e7d7, 4);  movsx(eax, memw[ss, ebp - 20]);       /* movsx eax, word [ebp-0x14] */
            ...
            ii(0x1014_e7e2, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_e7e5, 3);  mov(memb[ds, eax + 47], dl);          /* mov [eax+0x2f], dl */
            ii(0x1014_e7e8, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1014_e7eb, 3);  mov(edx, memd[ds, eax + 6]);          /* mov edx, [eax+0x6] */
            ii(0x1014_e7ee, 4);  movsx(eax, memw[ss, ebp - 20]);       /* movsx eax, word [ebp-0x14] */
            ...
            ii(0x1014_e7f9, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_e7fc, 3);  mov(memb[ds, eax + 48], dl);          /* mov [eax+0x30], dl */
            ...
            ii(0x1014_e805, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_e808, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ii(0x1014_e80b, 4);  add(dx, memw[ds, eax + 53]);          /* add dx, [eax+0x35] */
            ii(0x1014_e80f, 2);  mov(eax, edx);                        /* mov eax, edx */
            ii(0x1014_e811, 3);  movsx(edx, ax);                       /* movsx edx, ax */
            ii(0x1014_e814, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
