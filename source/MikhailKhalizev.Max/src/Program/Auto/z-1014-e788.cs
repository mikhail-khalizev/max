...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_e788()
        {
            ...
            ii(0x1014_e7a1, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1014_e7a4, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ii(0x1014_e7a7, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1014_e7aa, 3); mov(edx, memd[ds, eax + 0x6]);          /* mov edx, [eax+0x6] */
            ...
            ii(0x1014_e7c8, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ...
            ii(0x1014_e7d4, 3); mov(edx, memd[ds, eax + 0x6]);          /* mov edx, [eax+0x6] */
            ...
            ii(0x1014_e7df, 3); mov(dl, memb[ds, eax + 0x8]);           /* mov dl, [eax+0x8] */
            ...
            ii(0x1014_e7eb, 3); mov(edx, memd[ds, eax + 0x6]);          /* mov edx, [eax+0x6] */
            ...
            ii(0x1014_e7f6, 3); mov(dl, memb[ds, eax + 0x9]);           /* mov dl, [eax+0x9] */
            ii(0x1014_e7f9, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1014_e7fc, 3); mov(memb[ds, eax + 0x30], dl);          /* mov [eax+0x30], dl */
            ii(0x1014_e7ff, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ...
            ii(0x1014_e808, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
