...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_19cb()
        {
            ...
            ii(0x1012_19e6, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1012_19e9, 3); mov(memd[ss, ebp - 0x4], ecx);          /* mov [ebp-0x4], ecx */
            ...
            ii(0x1012_1a15, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1012_1a19, 1); push(eax);                              /* push eax */
            ii(0x1012_1a1a, 4); movsx(ecx, memw[ss, ebp - 0x8]);        /* movsx ecx, word [ebp-0x8] */
            ...
            ii(0x1012_1a39, 2); jmp(0x1012_1a41, 0x6); goto l_0x1012_1a41; /* jmp 0x10121a41 */
        l_0x1012_1a3b:
        ...
        l_0x1012_1a41:
            ...
            ii(0x1012_1a84, 2); if(jz(0x1012_1a8c, 0x6)) goto l_0x1012_1a8c; /* jz 0x10121a8c */
            ii(0x1012_1a86, 4); cmp(memb[ss, ebp - 0x14], 0x3a);        /* cmp byte [ebp-0x14], 0x3a */
            ii(0x1012_1a8a, 2); if(jnz(0x1012_1a8e, 0x2)) goto l_0x1012_1a8e; /* jnz 0x10121a8e */
        l_0x1012_1a8c:
            ii(0x1012_1a8c, 2); jmp(0x1012_1a94, 0x6); goto l_0x1012_1a94; /* jmp 0x10121a94 */
        l_0x1012_1a8e:
            ii(0x1012_1a8e, 4); cmp(memb[ss, ebp - 0x14], 0x3b);        /* cmp byte [ebp-0x14], 0x3b */
            ii(0x1012_1a92, 2); if(jnz(0x1012_1a96, 0x2)) goto l_0x1012_1a96; /* jnz 0x10121a96 */
        l_0x1012_1a94:
            ii(0x1012_1a94, 2); jmp(0x1012_1a9c, 0x6); goto l_0x1012_1a9c; /* jmp 0x10121a9c */
        l_0x1012_1a96:
        ...
        l_0x1012_1b0e:
            ...
            ii(0x1012_1b5b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_1b5e, 3); sub(eax, 0x2);                          /* sub eax, 0x2 */
            ii(0x1012_1b61, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x1012_1b64, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
