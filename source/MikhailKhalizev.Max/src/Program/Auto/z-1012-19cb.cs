...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_19cb()
        {
            ...
            ii(0x1012_19e0, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1012_19e3, 3); mov(memd[ss, ebp - 12], edx);           /* mov [ebp-0xc], edx */
            ii(0x1012_19e6, 3); mov(memd[ss, ebp - 8], ebx);            /* mov [ebp-0x8], ebx */
            ii(0x1012_19e9, 3); mov(memd[ss, ebp - 4], ecx);            /* mov [ebp-0x4], ecx */
            ii(0x1012_19ec, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1012_19f9, 3); mov(memb[ss, ebp - 20], al);            /* mov [ebp-0x14], al */
            ii(0x1012_19fc, 5); mov(eax, 0x38);                         /* mov eax, 0x38 */
            ii(0x1012_1a01, 5); call(Definitions.sys_new, 0x4_43fa);    /* call 0x10165e00 */
            ii(0x1012_1a06, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x1012_1a09, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x1012_1a0c, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x1012_1a0f, 4); cmp(memd[ss, ebp - 28], 0);             /* cmp dword [ebp-0x1c], 0x0 */
            ...
            ii(0x1012_1a28, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x1012_1a2b, 5); call(Definitions.my_ctor_c17, -0x5_3621); /* call 0x100ce40f */
            ii(0x1012_1a30, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
            ii(0x1012_1a33, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
            ii(0x1012_1a36, 3); mov(memd[ss, ebp - 36], eax);           /* mov [ebp-0x24], eax */
            ii(0x1012_1a39, 2); jmp(0x1012_1a41, 6); goto l_0x1012_1a41; /* jmp 0x10121a41 */
        l_0x1012_1a3b:
            ii(0x1012_1a3b, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x1012_1a3e, 3); mov(memd[ss, ebp - 36], eax);           /* mov [ebp-0x24], eax */
        l_0x1012_1a41:
            ii(0x1012_1a41, 4); movsx(edx, memw[ss, ebp - 12]);         /* movsx edx, word [ebp-0xc] */
            ii(0x1012_1a45, 3); imul(edx, edx, 0x1c);                   /* imul edx, edx, 0x1c */
            ii(0x1012_1a48, 3); mov(eax, memd[ss, ebp - 36]);           /* mov eax, [ebp-0x24] */
            ii(0x1012_1a4b, 6); mov(memd[ds, edx + 0x101b_b068], eax);  /* mov [edx+0x101bb068], eax */
            ii(0x1012_1a51, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1012_1a54, 3); mov(edx, memd[ds, eax + 41]);           /* mov edx, [eax+0x29] */
            ii(0x1012_1a57, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1012_1a6e, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1012_1a80, 4); cmp(memb[ss, ebp - 20], 0x39);          /* cmp byte [ebp-0x14], 0x39 */
            ii(0x1012_1a84, 2); if(jz(0x1012_1a8c, 6)) goto l_0x1012_1a8c; /* jz 0x10121a8c */
            ii(0x1012_1a86, 4); cmp(memb[ss, ebp - 20], 0x3a);          /* cmp byte [ebp-0x14], 0x3a */
        ...
        l_0x1012_1a8e:
            ii(0x1012_1a8e, 4); cmp(memb[ss, ebp - 20], 0x3b);          /* cmp byte [ebp-0x14], 0x3b */
        ...
        l_0x1012_1a96:
            ii(0x1012_1a96, 4); cmp(memb[ss, ebp - 20], 0x40);          /* cmp byte [ebp-0x14], 0x40 */
            ii(0x1012_1a9a, 2); if(jnz(0x1012_1ad6, 0x3a)) goto l_0x1012_1ad6; /* jnz 0x10121ad6 */
        l_0x1012_1a9c:
            ii(0x1012_1a9c, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x1012_1aa0, 6); lea(edx, memd[ds, eax + 1002]);         /* lea edx, [eax+0x3ea] */
            ii(0x1012_1aa6, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1012_1ab8, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x1012_1abc, 6); lea(edx, memd[ds, eax + 1002]);         /* lea edx, [eax+0x3ea] */
            ii(0x1012_1ac2, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
        ...
        l_0x1012_1ad6:
            ii(0x1012_1ad6, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x1012_1ada, 6); lea(edx, memd[ds, eax + 29674]);        /* lea edx, [eax+0x73ea] */
            ii(0x1012_1ae0, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1012_1af2, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x1012_1af6, 6); lea(edx, memd[ds, eax + 29674]);        /* lea edx, [eax+0x73ea] */
            ii(0x1012_1afc, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
        ...
        l_0x1012_1b0e:
            ...
            ii(0x1012_1b13, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1012_1b25, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1012_1b28, 3); mov(edx, memd[ds, eax + 41]);           /* mov edx, [eax+0x29] */
            ii(0x1012_1b2b, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1012_1b3d, 3); lea(eax, memd[ss, ebp - 40]);           /* lea eax, [ebp-0x28] */
            ...
            ii(0x1012_1b6f, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1012_1b7c, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
