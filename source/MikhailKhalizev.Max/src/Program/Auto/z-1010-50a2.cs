...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_50a2()
        {
            ...
            ii(0x1010_50b8, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1010_50bb, 3);  mov(memd[ss, ebp - 8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1010_50be, 3);  mov(memd[ss, ebp - 4], ebx);          /* mov [ebp-0x4], ebx */
        l_0x1010_50c1:
            ii(0x1010_50c1, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x1010_50cd, 4);  mov(memb[ss, ebp - 16], 0);           /* mov byte [ebp-0x10], 0x0 */
        ...
        l_0x1010_50d6:
            ...
            ii(0x1010_50db, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x1010_50ea, 4);  mov(memb[ss, ebp - 16], 0);           /* mov byte [ebp-0x10], 0x0 */
        ...
        l_0x1010_50f0:
            ...
            ii(0x1010_50f5, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x1010_5104, 3);  lea(ebx, memd[ss, ebp - 32]);         /* lea ebx, [ebp-0x20] */
            ii(0x1010_5107, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x1010_510a, 3);  add(edx, 0x6f);                       /* add edx, 0x6f */
            ii(0x1010_510d, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1010_5110, 5);  call(0x1010_5011, -0x104);            /* call 0x10105011 */
            ii(0x1010_5115, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_5118, 3);  cmp(eax, memd[ss, ebp - 32]);         /* cmp eax, [ebp-0x20] */
            ...
            ii(0x1010_5120, 3);  cmp(eax, memd[ss, ebp - 24]);         /* cmp eax, [ebp-0x18] */
        ...
        l_0x1010_5127:
            ...
            ii(0x1010_512a, 3);  cmp(eax, memd[ss, ebp - 28]);         /* cmp eax, [ebp-0x1c] */
        ...
        l_0x1010_5131:
            ...
            ii(0x1010_5134, 3);  cmp(eax, memd[ss, ebp - 20]);         /* cmp eax, [ebp-0x14] */
        ...
        l_0x1010_513b:
            ii(0x1010_513b, 4);  mov(memb[ss, ebp - 16], 1);           /* mov byte [ebp-0x10], 0x1 */
        ...
        l_0x1010_5146:
            ii(0x1010_5146, 3);  mov(al, memb[ss, ebp - 16]);          /* mov al, [ebp-0x10] */
