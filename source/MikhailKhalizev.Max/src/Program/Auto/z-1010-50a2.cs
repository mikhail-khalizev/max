...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_50a2()
        {
            ...
            ii(0x1010_50bb, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1010_50be, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
        l_0x1010_50c1:
            ...
            ii(0x1010_50cb, 2); if(jnz(0x1010_50d6, 0x9)) goto l_0x1010_50d6; /* jnz 0x101050d6 */
        ...
        l_0x1010_50d6:
            ...
            ii(0x1010_50e8, 2); if(jz(0x1010_50f0, 0x6)) goto l_0x1010_50f0; /* jz 0x101050f0 */
        ...
        l_0x1010_50f0:
            ...
            ii(0x1010_5115, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_5118, 3); cmp(eax, memd[ss, ebp - 0x20]);         /* cmp eax, [ebp-0x20] */
            ii(0x1010_511b, 2); if(jl(0x1010_5125, 0x8)) goto l_0x1010_5125; /* jl 0x10105125 */
            ii(0x1010_511d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_5120, 3); cmp(eax, memd[ss, ebp - 0x18]);         /* cmp eax, [ebp-0x18] */
            ii(0x1010_5123, 2); if(jle(0x1010_5127, 0x2)) goto l_0x1010_5127; /* jle 0x10105127 */
        l_0x1010_5125:
            ii(0x1010_5125, 2); jmp(0x1010_512f, 0x8); goto l_0x1010_512f; /* jmp 0x1010512f */
        l_0x1010_5127:
            ii(0x1010_5127, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_512a, 3); cmp(eax, memd[ss, ebp - 0x1c]);         /* cmp eax, [ebp-0x1c] */
            ii(0x1010_512d, 2); if(jge(0x1010_5131, 0x2)) goto l_0x1010_5131; /* jge 0x10105131 */
        l_0x1010_512f:
            ii(0x1010_512f, 2); jmp(0x1010_5139, 0x8); goto l_0x1010_5139; /* jmp 0x10105139 */
        l_0x1010_5131:
            ii(0x1010_5131, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_5134, 3); cmp(eax, memd[ss, ebp - 0x14]);         /* cmp eax, [ebp-0x14] */
            ii(0x1010_5137, 2); if(jle(0x1010_513b, 0x2)) goto l_0x1010_513b; /* jle 0x1010513b */
        l_0x1010_5139:
            ii(0x1010_5139, 2); jmp(0x1010_5141, 0x6); goto l_0x1010_5141; /* jmp 0x10105141 */
        l_0x1010_513b:
            ii(0x1010_513b, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
            ii(0x1010_513f, 2); jmp(0x1010_5146, 0x5); goto l_0x1010_5146; /* jmp 0x10105146 */
        l_0x1010_5141:
