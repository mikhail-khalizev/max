...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_7476()
        {
            ...
            ii(0x17_7482, 3);  mov(ax, memw[ss, bp + 6]);              /* mov ax, [bp+0x6] */
            ...
            ii(0x17_748f, 3);  sub(ax, 1);                             /* sub ax, 0x1 */
            ii(0x17_7492, 3);  sbb(dx, 0);                             /* sbb dx, 0x0 */
            ii(0x17_7495, 3);  mov(memw[ss, bp - 10], ax);             /* mov [bp-0xa], ax */
            ii(0x17_7498, 3);  mov(memw[ss, bp - 8], dx);              /* mov [bp-0x8], dx */
            ...
            ii(0x17_74a1, 3);  add(sp, 4);                             /* add sp, 0x4 */
            ii(0x17_74a4, 3);  mov(memw[ss, bp - 4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_74a7, 3);  mov(memw[ss, bp - 2], dx);              /* mov [bp-0x2], dx */
            ii(0x17_74aa, 2);  or(dx, ax);                             /* or dx, ax */
            ii(0x17_74ac, 2);  if(jnz(0x17_74b6, 8)) goto l_0x17_74b6; /* jnz 0x74b6 */
        ...
        l_0x17_74b6:
            ii(0x17_74b6, 3);  mov(dx, memw[ss, bp - 2]);              /* mov dx, [bp-0x2] */
            ii(0x17_74b9, 3);  add(memw[ss, bp - 10], ax);             /* add [bp-0xa], ax */
            ii(0x17_74bc, 3);  adc(memw[ss, bp - 8], dx);              /* adc [bp-0x8], dx */
            ii(0x17_74bf, 2);  neg(ax);                                /* neg ax */
            ii(0x17_74c1, 2);  sub(ah, ah);                            /* sub ah, ah */
            ii(0x17_74c3, 3);  mov(memw[ss, bp - 6], ax);              /* mov [bp-0x6], ax */
            ii(0x17_74c6, 2);  sub(dx, dx);                            /* sub dx, dx */
            ii(0x17_74c8, 1);  push(dx);                               /* push dx */
            ii(0x17_74c9, 1);  push(ax);                               /* push ax */
            ii(0x17_74ca, 3);  push(memw[ss, bp - 2]);                 /* push word [bp-0x2] */
            ii(0x17_74cd, 3);  push(memw[ss, bp - 4]);                 /* push word [bp-0x4] */
            ...
            ii(0x17_74d8, 3);  add(sp, 8);                             /* add sp, 0x8 */
            ii(0x17_74db, 3);  mov(al, memb[ss, bp - 10]);             /* mov al, [bp-0xa] */
            ii(0x17_74de, 2);  sub(ah, ah);                            /* sub ah, ah */
            ii(0x17_74e0, 1);  push(di);                               /* push di */
            ii(0x17_74e1, 1);  push(ax);                               /* push ax */
            ii(0x17_74e2, 3);  mov(ax, memw[ss, bp - 10]);             /* mov ax, [bp-0xa] */
            ii(0x17_74e5, 3);  mov(dx, memw[ss, bp - 8]);              /* mov dx, [bp-0x8] */
            ...
            ii(0x17_74f0, 3);  add(sp, 8);                             /* add sp, 0x8 */
            ii(0x17_74f3, 3);  add(memw[ss, bp - 4], si);              /* add [bp-0x4], si */
            ii(0x17_74f6, 3);  adc(memw[ss, bp - 2], di);              /* adc [bp-0x2], di */
            ii(0x17_74f9, 3);  mov(ax, memw[ss, bp - 4]);              /* mov ax, [bp-0x4] */
            ii(0x17_74fc, 3);  mov(dx, memw[ss, bp - 2]);              /* mov dx, [bp-0x2] */
            ii(0x17_74ff, 2);  shl(ax, 1);                             /* shl ax, 1 */
            ii(0x17_7501, 2);  rcl(dx, 1);                             /* rcl dx, 1 */
            ii(0x17_7503, 2);  shl(ax, 1);                             /* shl ax, 1 */
            ii(0x17_7505, 2);  rcl(dx, 1);                             /* rcl dx, 1 */
            ii(0x17_7507, 2);  shl(ax, 1);                             /* shl ax, 1 */
            ii(0x17_7509, 2);  rcl(dx, 1);                             /* rcl dx, 1 */
            ii(0x17_750b, 2);  shl(ax, 1);                             /* shl ax, 1 */
            ii(0x17_750d, 2);  rcl(dx, 1);                             /* rcl dx, 1 */
