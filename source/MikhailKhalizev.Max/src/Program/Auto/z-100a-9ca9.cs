...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_9ca9()
        {
            ...
            ii(0x100a_9cc1, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_9cc4, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x100a_9ccb, 2); jmp(0x100a_9cd3, 0x6); goto l_0x100a_9cd3; /* jmp 0x100a9cd3 */
        l_0x100a_9ccd:
            ii(0x100a_9ccd, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_9cd0, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x100a_9cd3:
            ii(0x100a_9cd3, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100a_9cd7, 3); cmp(eax, 0x4);                          /* cmp eax, 0x4 */
            ii(0x100a_9cda, 2); if(jge(0x100a_9d11, 0x35)) goto l_0x100a_9d11; /* jge 0x100a9d11 */
            ii(0x100a_9cdc, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x100a_9cf6, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100a_9cf9, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
