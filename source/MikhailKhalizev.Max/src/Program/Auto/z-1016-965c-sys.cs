...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_965c()
        {
            ...
            ii(0x1016_9662, 3);  sub(esp, 4);                          /* sub esp, 0x4 */
        ...
        l_0x1016_9678:
            ...
            ii(0x1016_968a, 3);  add(esp, 4);                          /* add esp, 0x4 */
        ...
        l_0x1016_9694:
            ii(0x1016_9694, 3);  mov(ebx, memd[ds, eax + 108]);        /* mov ebx, [eax+0x6c] */
            ii(0x1016_9697, 2);  test(ebx, ebx);                       /* test ebx, ebx */
            ii(0x1016_9699, 2);  if(jnz(0x1016_96a6, 0xb)) goto l_0x1016_96a6;/* jnz 0x101696a6 */
            ii(0x1016_969b, 3);  mov(edx, memd[ds, eax + 112]);        /* mov edx, [eax+0x70] */
            ii(0x1016_969e, 3);  mov(eax, memd[ss, esp]);              /* mov eax, [esp] */
            ii(0x1016_96a1, 3);  mov(memd[ds, eax + 48], edx);         /* mov [eax+0x30], edx */
            ii(0x1016_96a4, 2);  jmp(0x1016_96ac, 6); goto l_0x1016_96ac;/* jmp 0x101696ac */
        l_0x1016_96a6:
            ii(0x1016_96a6, 3);  mov(eax, memd[ds, eax + 112]);        /* mov eax, [eax+0x70] */
            ii(0x1016_96a9, 3);  mov(memd[ds, ebx + 112], eax);        /* mov [ebx+0x70], eax */
        l_0x1016_96ac:
            ii(0x1016_96ac, 3);  mov(ecx, memd[ds, esi + 112]);        /* mov ecx, [esi+0x70] */
            ii(0x1016_96af, 2);  test(ecx, ecx);                       /* test ecx, ecx */
            ii(0x1016_96b1, 2);  if(jz(0x1016_96b9, 6)) goto l_0x1016_96b9;/* jz 0x101696b9 */
            ii(0x1016_96b3, 3);  mov(eax, memd[ds, esi + 108]);        /* mov eax, [esi+0x6c] */
            ii(0x1016_96b6, 3);  mov(memd[ds, ecx + 108], eax);        /* mov [ecx+0x6c], eax */
        l_0x1016_96b9:
            ii(0x1016_96b9, 3);  mov(eax, memd[ss, esp]);              /* mov eax, [esp] */
            ii(0x1016_96bc, 3);  mov(ebp, memd[ds, esi + 12]);         /* mov ebp, [esi+0xc] */
            ii(0x1016_96bf, 3);  mov(edi, memd[ds, eax + 32]);         /* mov edi, [eax+0x20] */
            ii(0x1016_96c2, 3);  mov(eax, memd[ds, esi + 20]);         /* mov eax, [esi+0x14] */
            ii(0x1016_96c5, 2);  sub(eax, ebp);                        /* sub eax, ebp */
            ii(0x1016_96c7, 1);  push(edi);                            /* push edi */
            ii(0x1016_96c8, 1);  inc(eax);                             /* inc eax */
            ii(0x1016_96c9, 3);  mov(edx, memd[ds, esi + 8]);          /* mov edx, [esi+0x8] */
            ii(0x1016_96cc, 1);  push(eax);                            /* push eax */
            ii(0x1016_96cd, 3);  mov(eax, memd[ds, esi + 16]);         /* mov eax, [esi+0x10] */
            ii(0x1016_96d0, 2);  sub(eax, edx);                        /* sub eax, edx */
            ii(0x1016_96d2, 3);  lea(ecx, memd[ds, eax + 1]);          /* lea ecx, [eax+0x1] */
            ii(0x1016_96d5, 4);  mov(eax, memd[ss, esp + 8]);          /* mov eax, [esp+0x8] */
            ...
            ii(0x1016_96e5, 3);  cmp(esi, memd[ds, eax + 52]);         /* cmp esi, [eax+0x34] */
            ii(0x1016_96e8, 2);  if(jnz(0x1016_96f1, 7)) goto l_0x1016_96f1;/* jnz 0x101696f1 */
            ii(0x1016_96ea, 7);  mov(memd[ds, eax + 52], 0);           /* mov dword [eax+0x34], 0x0 */
        l_0x1016_96f1:
            ii(0x1016_96f1, 3);  mov(eax, memd[ss, esp]);              /* mov eax, [esp] */
            ii(0x1016_96f4, 3);  cmp(esi, memd[ds, eax + 56]);         /* cmp esi, [eax+0x38] */
            ii(0x1016_96f7, 2);  if(jnz(0x1016_9700, 7)) goto l_0x1016_9700;/* jnz 0x10169700 */
            ii(0x1016_96f9, 7);  mov(memd[ds, eax + 56], 0);           /* mov dword [eax+0x38], 0x0 */
        l_0x1016_9700:
        ...
        l_0x1016_9709:
            ii(0x1016_9709, 3);  add(esp, 4);                          /* add esp, 0x4 */
