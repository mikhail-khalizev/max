...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("dab0b43b-2c96-4d8d-bb3a-4651fb15dbc4")]
        public void Method_100b_b097()
        {
            ii(0x100b_b097, 5); pushd(0x28);                            /* push 0x28 */
            ii(0x100b_b09c, 5); calld(Definitions.sys_check_available_stack_size, 0xaacb1); /* call 0x10165d52 */
        ...
        l_0x100b_b0ee:
            ...
            ii(0x100b_b0ff, 1); retd(); return;                         /* ret */
        }
    }
}
