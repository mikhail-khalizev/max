...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_8624()
        {
            ...
            ii(0x1016_863c, 3);  test(cl, 1);                          /* test cl, 0x1 */
            ii(0x1016_863f, 2);  if(jz(0x1016_8647, 6)) goto l_0x1016_8647;/* jz 0x10168647 */
        ...
        l_0x1016_8647:
            ...
            ii(0x1016_8650, 3);  test(ch, 1);                          /* test ch, 0x1 */
            ii(0x1016_8653, 2);  if(jz(0x1016_866c, 0x17)) goto l_0x1016_866c;/* jz 0x1016866c */
            ii(0x1016_8655, 5);  mov(memb[ss, esp + 1], 0x74);         /* mov byte [esp+0x1], 0x74 */
        ...
        l_0x1016_8660:
            ii(0x1016_8660, 3);  test(ch, 1);                          /* test ch, 0x1 */
            ii(0x1016_8663, 2);  if(jz(0x1016_866c, 7)) goto l_0x1016_866c;/* jz 0x1016866c */
            ii(0x1016_8665, 5);  mov(memb[ss, esp + 1], 0x74);         /* mov byte [esp+0x1], 0x74 */
            ii(0x1016_866a, 2);  jmp(0x1016_8676, 0xa); goto l_0x1016_8676;/* jmp 0x10168676 */
        l_0x1016_866c:
            ii(0x1016_866c, 3);  test(ch, 2);                          /* test ch, 0x2 */
            ii(0x1016_866f, 2);  if(jz(0x1016_8676, 5)) goto l_0x1016_8676;/* jz 0x10168676 */
            ii(0x1016_8671, 5);  mov(memb[ss, esp + 1], 0x62);         /* mov byte [esp+0x1], 0x62 */
        l_0x1016_8676:
            ...
            ii(0x1016_8681, 2);  if(jnz(0x1016_8688, 5)) goto l_0x1016_8688;/* jnz 0x10168688 */
            ii(0x1016_8683, 5);  mov(eax, 0xffff_ffff);                /* mov eax, 0xffffffff */
        l_0x1016_8688:
            ii(0x1016_8688, 3);  add(esp, 4);                          /* add esp, 0x4 */
