...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_1913()
        {
            ...
            ii(0x100b_192a, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_192d, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100b_1930, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_1932, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_1941, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_1944, 4); mov(dx, memw[ds, eax + 0x8]);           /* mov dx, [eax+0x8] */
            ii(0x100b_1948, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_194b, 4); cmp(dx, memw[ds, eax + 0x13]);          /* cmp dx, [eax+0x13] */
            ii(0x100b_194f, 2); if(jz(0x100b_1953, 0x2)) goto l_0x100b_1953; /* jz 0x100b1953 */
        l_0x100b_1951:
            ii(0x100b_1951, 2); jmp(0x100b_198d, 0x3a); goto l_0x100b_198d; /* jmp 0x100b198d */
        l_0x100b_1953:
            ii(0x100b_1953, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_1956, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_1959, 3); add(eax, 0x15);                         /* add eax, 0x15 */
            ii(0x100b_195c, 5); call(0x1007_6630, -0x3_b331);           /* call 0x10076630 */
            ii(0x100b_1961, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100b_1964, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_1974, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_1985, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
