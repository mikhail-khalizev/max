...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_5ebb()
        {
            ...
            ii(0x1012_5ed2, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_5ed5, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1012_5ed8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_5edb, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1012_5ede, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1012_5ee1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_5ee4, 5); call(0x1012_5dd6, -0x113);              /* call 0x10125dd6 */
            ii(0x1012_5ee9, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1012_5eec, 3); mov(eax, memd[ds, eax + 0x3]);          /* mov eax, [eax+0x3] */
            ...
            ii(0x1012_5ef8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1012_5f02:
            ii(0x1012_5f02, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1012_5f05, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1012_5f07, 4); mov(dx, memw[ds, eax + 0x5]);           /* mov dx, [eax+0x5] */
            ...
            ii(0x1012_5f17, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_5f1a, 5); call(0x1008_a998, -0x9_b587);           /* call 0x1008a998 */
        l_0x1012_5f1f:
            ii(0x1012_5f1f, 7); mov(memd[ss, ebp - 0xc], 0x7);          /* mov dword [ebp-0xc], 0x7 */
            ii(0x1012_5f26, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
