...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("96325f2a-0949-46c7-a113-f31ef7a0a51b")]
        public void Method_100c_a8cc()
        {
            ii(0x100c_a8cc, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x100c_a8d1, 5); calld(Definitions.sys_check_available_stack_size, 0x9b47c); /* call 0x10165d52 */
            ...
            ii(0x100c_a8f5, 5); calld(0x1013_b0f9, 0x707ff);            /* call 0x1013b0f9 */
            ...
            ii(0x100c_a900, 1); retd(); return;                         /* ret */
        }
    }
}
