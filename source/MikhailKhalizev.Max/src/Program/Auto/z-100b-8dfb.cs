...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_8dfb()
        {
            ...
            ii(0x100b_8e13, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_8e16, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_8e19, 3); add(eax, 0xa);                          /* add eax, 0xa */
            ii(0x100b_8e1c, 5); call(0x1008_afb4, -0x2_de6d);           /* call 0x1008afb4 */
            ii(0x100b_8e21, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_8e24, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
