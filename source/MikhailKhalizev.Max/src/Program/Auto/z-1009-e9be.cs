...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_e9be()
        {
            ...
            ii(0x1009_ea24, 4); mov(memb[ds, eax + 0x55], 1);           /* mov byte [eax+0x55], 0x1 */
        ...
        l_0x1009_ea59:
            ii(0x1009_ea59, 4); mov(memb[ss, ebp - 0x14], 1);           /* mov byte [ebp-0x14], 0x1 */
        ...
        l_0x1009_ea8b:
            ii(0x1009_ea8b, 4); mov(memb[ss, ebp - 0x10], 1);           /* mov byte [ebp-0x10], 0x1 */
