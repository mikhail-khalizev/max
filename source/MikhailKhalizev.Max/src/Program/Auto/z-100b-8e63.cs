...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_8e63()
        {
            ...
            ii(0x100b_8e7a, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_8e7d, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100b_8e80, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_8e83, 5); call(0x100b_8f63, 0xdb);                /* call 0x100b8f63 */
            ii(0x100b_8e88, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100b_8e8b, 3); add(edx, 0x10);                         /* add edx, 0x10 */
            ii(0x100b_8e8e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_8e91, 5); call(0x1007_5e64, -0x4_3032);           /* call 0x10075e64 */
            ii(0x100b_8e96, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
