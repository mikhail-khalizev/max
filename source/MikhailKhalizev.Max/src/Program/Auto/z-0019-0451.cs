...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x19_0451, 4); enter(4, 0);                              /* enter 0x4, 0x0 */
            ii(0x19_0455, 1); push(di);                                 /* push di */
            ii(0x19_0456, 1); push(si);                                 /* push si */
            ii(0x19_0457, 4); mov(es, memw[ds, 0x3f9c]);                /* mov es, [0x3f9c] */
            ii(0x19_045b, 3); mov(bx, memw[ss, bp + 6]);                /* mov bx, [bp+0x6] */
            ii(0x19_045e, 5); mov(al, memb[es, bx + 2]);                /* mov al, [es:bx+0x2] */
            ii(0x19_0463, 2); sub(ah, ah);                              /* sub ah, ah */
            ii(0x19_0465, 2); mov(si, ax);                              /* mov si, ax */
        l_0x19_0467:
            ii(0x19_0467, 3); cmp(si, 1);                               /* cmp si, 0x1 */
            ii(0x19_046a, 2); if(jnz(0x19_046f, 3)) goto l_0x19_046f;   /* jnz 0x46f */
        ...
        l_0x19_046f:
            ...
            ii(0x19_047e, 3); shl(cx, 3);                               /* shl cx, 0x3 */
            ii(0x19_0481, 2); add(ax, cx);                              /* add ax, cx */
            ii(0x19_0483, 3); mov(memw[ss, bp - 4], ax);                /* mov [bp-0x4], ax */
            ii(0x19_0486, 3); mov(memw[ss, bp - 2], dx);                /* mov [bp-0x2], dx */
            ii(0x19_0489, 3); mov(ax, memw[ss, bp + 8]);                /* mov ax, [bp+0x8] */
            ii(0x19_048c, 3); les(bx, memw[ss, bp - 4]);                /* les bx, [bp-0x4] */
            ii(0x19_048f, 4); cmp(memw[es, bx + 6], ax);                /* cmp [es:bx+0x6], ax */
        ...
        l_0x19_04aa:
            ii(0x19_04aa, 4); cmp(memw[es, bx + 4], dx);                /* cmp [es:bx+0x4], dx */
            ii(0x19_04ae, 2); if(jz(0x19_04b3, 3)) goto l_0x19_04b3;    /* jz 0x4b3 */
            ii(0x19_04b0, 3); jmp(0x19_04b8, 5); goto l_0x19_04b8;      /* jmp 0x4b8 */
        l_0x19_04b3:
            ii(0x19_04b3, 2); mov(ax, si);                              /* mov ax, si */
            ii(0x19_04b5, 3); jmp(0x19_04cc, 0x14); goto l_0x19_04cc;   /* jmp 0x4cc */
        l_0x19_04b8:
            ii(0x19_04b8, 3); les(bx, memw[ss, bp - 4]);                /* les bx, [bp-0x4] */
            ii(0x19_04bb, 4); mov(al, memb[es, bx + 1]);                /* mov al, [es:bx+0x1] */
