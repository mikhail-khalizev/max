...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_9cd9()
        {
            ...
            ii(0x100f_9cdf, 3); mov(edx, memd[ss, ebp - 20]);           /* mov edx, [ebp-0x14] */
            ii(0x100f_9ce2, 3); sub(ax, memw[ds, edx]);                 /* sub ax, [edx] */
            ii(0x100f_9ce5, 3); mov(memd[ss, ebp - 72], eax);           /* mov [ebp-0x48], eax */
            ii(0x100f_9ce8, 6); mov(ax, memw[ds, 0x101c_38d0]);         /* mov ax, [0x101c38d0] */
            ii(0x100f_9cee, 3); mov(edx, memd[ss, ebp - 20]);           /* mov edx, [ebp-0x14] */
            ii(0x100f_9cf1, 4); sub(ax, memw[ds, edx + 4]);             /* sub ax, [edx+0x4] */
            ii(0x100f_9cf5, 3); mov(memd[ss, ebp - 76], eax);           /* mov [ebp-0x4c], eax */
            ...
            ii(0x100f_9d04, 4); movsx(eax, memw[ss, ebp - 72]);         /* movsx eax, word [ebp-0x48] */
            ...
            ii(0x100f_9d14, 3); mov(memd[ss, ebp - 72], eax);           /* mov [ebp-0x48], eax */
            ii(0x100f_9d17, 5); mov(eax, memd[ds, 0x101c_8172]);        /* mov eax, [0x101c8172] */
            ii(0x100f_9d1c, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100f_9d1f, 3); lea(ebx, memd[ds, eax - 1]);            /* lea ebx, [eax-0x1] */
            ii(0x100f_9d22, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100f_9d24, 4); movsx(eax, memw[ss, ebp - 76]);         /* movsx eax, word [ebp-0x4c] */
            ...
            ii(0x100f_9d34, 3); mov(memd[ss, ebp - 76], eax);           /* mov [ebp-0x4c], eax */
            ...
            ii(0x100f_9d40, 4); movsx(eax, memw[ss, ebp - 72]);         /* movsx eax, word [ebp-0x48] */
            ii(0x100f_9d44, 2); sar(eax, 1);                            /* sar eax, 1 */
            ...
            ii(0x100f_9d52, 3); mov(memd[ss, ebp - 72], eax);           /* mov [ebp-0x48], eax */
            ii(0x100f_9d55, 4); movsx(eax, memw[ss, ebp - 76]);         /* movsx eax, word [ebp-0x4c] */
            ii(0x100f_9d59, 2); sar(eax, 1);                            /* sar eax, 1 */
            ...
            ii(0x100f_9d67, 3); mov(memd[ss, ebp - 76], eax);           /* mov [ebp-0x4c], eax */
        l_0x100f_9d6a:
            ...
            ii(0x100f_9d7c, 4); movsx(ebx, memw[ss, ebp - 76]);         /* movsx ebx, word [ebp-0x4c] */
            ii(0x100f_9d80, 4); movsx(edx, memw[ss, ebp - 72]);         /* movsx edx, word [ebp-0x48] */
            ii(0x100f_9d84, 5); mov(eax, 1);                            /* mov eax, 0x1 */
        ...
        l_0x100f_9d93:
            ...
            ii(0x100f_9da0, 4); movsx(edx, memw[ss, ebp - 76]);         /* movsx edx, word [ebp-0x4c] */
            ii(0x100f_9da4, 4); movsx(eax, memw[ss, ebp - 72]);         /* movsx eax, word [ebp-0x48] */
            ii(0x100f_9da8, 5); call(0x100f_7fb2, -0x1dfb);             /* call 0x100f7fb2 */
            ii(0x100f_9dad, 3); mov(memb[ss, ebp - 80], al);            /* mov [ebp-0x50], al */
            ii(0x100f_9db0, 4); cmp(memb[ss, ebp - 80], 0x14);          /* cmp byte [ebp-0x50], 0x14 */
            ii(0x100f_9db4, 2); if(jz(0x100f_9dbc, 6)) goto l_0x100f_9dbc; /* jz 0x100f9dbc */
            ii(0x100f_9db6, 4); cmp(memb[ss, ebp - 80], 0x16);          /* cmp byte [ebp-0x50], 0x16 */
        ...
        l_0x100f_9dbc:
            ...
            ii(0x100f_9dc6, 4); cmp(memb[ds, eax + 62], 0x1f);          /* cmp byte [eax+0x3e], 0x1f */
            ii(0x100f_9dca, 2); if(jz(0x100f_9e10, 0x44)) goto l_0x100f_9e10; /* jz 0x100f9e10 */
            ii(0x100f_9dcc, 4); movsx(eax, memw[ss, ebp - 76]);         /* movsx eax, word [ebp-0x4c] */
            ii(0x100f_9dd0, 3); mov(memd[ss, ebp - 84], eax);           /* mov [ebp-0x54], eax */
            ii(0x100f_9dd3, 3); push(memd[ss, ebp - 84]);               /* push dword [ebp-0x54] */
            ii(0x100f_9dd6, 4); movsx(eax, memw[ss, ebp - 72]);         /* movsx eax, word [ebp-0x48] */
            ii(0x100f_9dda, 3); mov(memd[ss, ebp - 88], eax);           /* mov [ebp-0x58], eax */
            ii(0x100f_9ddd, 5); mov(eax, 0x101c_37bc);                  /* mov eax, 0x101c37bc */
            ii(0x100f_9de2, 5); call(0x1007_65d0, -0x8_3817);           /* call 0x100765d0 */
            ii(0x100f_9de7, 3); mov(memd[ss, ebp - 92], eax);           /* mov [ebp-0x5c], eax */
            ii(0x100f_9dea, 4); cmp(memb[ss, ebp - 80], 0x14);          /* cmp byte [ebp-0x50], 0x14 */
            ii(0x100f_9dee, 2); if(jnz(0x100f_9df6, 6)) goto l_0x100f_9df6; /* jnz 0x100f9df6 */
            ii(0x100f_9df0, 4); mov(memb[ss, ebp - 96], 0);             /* mov byte [ebp-0x60], 0x0 */
            ii(0x100f_9df4, 2); jmp(0x100f_9dfa, 4); goto l_0x100f_9dfa; /* jmp 0x100f9dfa */
        l_0x100f_9df6:
            ii(0x100f_9df6, 4); mov(memb[ss, ebp - 96], 0x1c);          /* mov byte [ebp-0x60], 0x1c */
        l_0x100f_9dfa:
            ii(0x100f_9dfa, 3); mov(edx, memd[ss, ebp - 99]);           /* mov edx, [ebp-0x63] */
            ii(0x100f_9dfd, 3); sar(edx, 0x18);                         /* sar edx, 0x18 */
            ii(0x100f_9e00, 5); mov(eax, 2);                            /* mov eax, 0x2 */
            ii(0x100f_9e05, 3); mov(ecx, memd[ss, ebp - 88]);           /* mov ecx, [ebp-0x58] */
