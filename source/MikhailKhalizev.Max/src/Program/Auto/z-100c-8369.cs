...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_8369()
        {
            ...
            ii(0x100c_8381, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x100c_8393, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_8396, 3); mov(eax, memd[ds, eax + 0x13]);         /* mov eax, [eax+0x13] */
            ii(0x100c_8399, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x100c_83a9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_83ac, 3); mov(eax, memd[ds, eax + 0x17]);         /* mov eax, [eax+0x17] */
            ii(0x100c_83af, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x100c_83bd, 2); if(jle(0x100c_83c1, 0x2)) goto l_0x100c_83c1; /* jle 0x100c83c1 */
        l_0x100c_83bf:
            ii(0x100c_83bf, 2); jmp(0x100c_83c7, 0x6); goto l_0x100c_83c7; /* jmp 0x100c83c7 */
        l_0x100c_83c1:
            ii(0x100c_83c1, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x100c_83c5, 2); jmp(0x100c_83cb, 0x4); goto l_0x100c_83cb; /* jmp 0x100c83cb */
        l_0x100c_83c7:
            ii(0x100c_83c7, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x100c_83cb:
            ii(0x100c_83cb, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
