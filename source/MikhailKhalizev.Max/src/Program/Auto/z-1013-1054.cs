...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_1054()
        {
            ...
            ii(0x1013_106b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_106e, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_1071, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_1074, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1013_1077, 7); mov(memb[ds, 0x101b_b48f], 0);          /* mov byte [0x101bb48f], 0x0 */
            ii(0x1013_107e, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_1081, 5); call(0x1012_f003, -0x2083);             /* call 0x1012f003 */
            ii(0x1013_1086, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_1089, 4); cmp(memb[ds, eax + 0x17], 0);           /* cmp byte [eax+0x17], 0x0 */
            ii(0x1013_108d, 2); if(jz(0x1013_1098, 0x9)) goto l_0x1013_1098; /* jz 0x10131098 */
            ii(0x1013_108f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_1092, 4); cmp(memb[ds, eax + 0x17], 0x1);         /* cmp byte [eax+0x17], 0x1 */
            ii(0x1013_1096, 2); if(jnz(0x1013_10a5, 0xd)) goto l_0x1013_10a5; /* jnz 0x101310a5 */
        l_0x1013_1098:
            ii(0x1013_1098, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x1013_109d, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
