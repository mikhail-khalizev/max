...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_b664()
        {
            ...
            ii(0x1018_b674, 3); mov(ebx, memd[ds, eax + 0x4]);          /* mov ebx, [eax+0x4] */
        ...
        l_0x1018_b67f:
            ii(0x1018_b67f, 3); mov(eax, memd[ds, ecx + 0x20]);         /* mov eax, [ecx+0x20] */
            ...
            ii(0x1018_b688, 2); if(jz(0x1018_b692, 0x8)) goto l_0x1018_b692; /* jz 0x1018b692 */
        ...
        l_0x1018_b692:
            ii(0x1018_b692, 3); mov(eax, memd[ds, ecx + 0x20]);         /* mov eax, [ecx+0x20] */
            ii(0x1018_b695, 2); add(eax, ebx);                          /* add eax, ebx */
            ii(0x1018_b697, 3); mov(esi, memd[ds, eax + 0x4]);          /* mov esi, [eax+0x4] */
            ii(0x1018_b69a, 2); test(esi, esi);                         /* test esi, esi */
            ii(0x1018_b69c, 2); if(jz(0x1018_b6a6, 0x8)) goto l_0x1018_b6a6; /* jz 0x1018b6a6 */
        ...
        l_0x1018_b6a6:
            ...
            ii(0x1018_b6a7, 3); mov(esi, memd[ds, ecx + 0x4]);          /* mov esi, [ecx+0x4] */
        ...
        l_0x1018_b6b1:
            ii(0x1018_b6b1, 3); mov(edi, memd[ds, ecx + 0x20]);         /* mov edi, [ecx+0x20] */
            ii(0x1018_b6b4, 2); test(edi, edi);                         /* test edi, edi */
            ii(0x1018_b6b6, 2); if(jz(0x1018_b6c0, 0x8)) goto l_0x1018_b6c0; /* jz 0x1018b6c0 */
        ...
        l_0x1018_b6c0:
            ...
            ii(0x1018_b6d0, 2); jmp(0x1018_b6d7, 0x5); goto l_0x1018_b6d7; /* jmp 0x1018b6d7 */
        l_0x1018_b6d2:
