...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_dbe0()
        {
            ...
            ii(0x17_dbea, 3); mov(di, memw[ss, bp + 0x8]);              /* mov di, [bp+0x8] */
            ...
            ii(0x17_dbfa, 3); mov(memw[ss, bp - 0x2], cx);              /* mov [bp-0x2], cx */
            ii(0x17_dbfd, 3); mov(di, memw[ss, bp + 0x6]);              /* mov di, [bp+0x6] */
            ...
            ii(0x17_dc0e, 3); sub(dx, memw[ss, bp - 0x2]);              /* sub dx, [bp-0x2] */
            ii(0x17_dc11, 2); if(jbe(0x17_dc38, 0x25)) goto l_0x17_dc38; /* jbe 0xdc38 */
            ii(0x17_dc13, 2); mov(di, bx);                              /* mov di, bx */
        l_0x17_dc15:
            ii(0x17_dc15, 3); mov(si, memw[ss, bp + 0x8]);              /* mov si, [bp+0x8] */
            ...
            ii(0x17_dc25, 3); mov(cx, memw[ss, bp - 0x2]);              /* mov cx, [bp-0x2] */
            ii(0x17_dc28, 2); if(jcxz(0x17_dc2e, 0x4)) goto l_0x17_dc2e; /* jcxz 0xdc2e */
            ii(0x17_dc2a, 2); repe(() => cmpsb());                      /* repe cmpsb */
            ii(0x17_dc2c, 2); if(jnz(0x17_dc15, -0x19)) goto l_0x17_dc15; /* jnz 0xdc15 */
        l_0x17_dc2e:
            ii(0x17_dc2e, 3); lea(ax, memw[ds, bx - 0x1]);              /* lea ax, [bx-0x1] */
            ii(0x17_dc31, 2); jmp(0x17_dc3a, 0x7); goto l_0x17_dc3a;    /* jmp 0xdc3a */
        l_0x17_dc33:
            ii(0x17_dc33, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_dc36, 2); jmp(0x17_dc3a, 0x2); goto l_0x17_dc3a;    /* jmp 0xdc3a */
        l_0x17_dc38:
