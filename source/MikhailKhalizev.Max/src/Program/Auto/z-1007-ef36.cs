...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_ef36()
        {
            ...
            ii(0x1007_ef4e, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_ef51, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_ef53, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_ef6b, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_ef6e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1007_ef7e:
            ...
            ii(0x1007_ef80, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_ef8d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_ef90, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x1007_ef93, 5); call(0x1008_afe4, 0xc04c);              /* call 0x1008afe4 */
            ii(0x1007_ef98, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
