...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_4162()
        {
            ...
            ii(0x100c_417a, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x100c_418c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_418f, 6); mov(memw[ds, eax + 0x7], 0);            /* mov word [eax+0x7], 0x0 */
            ii(0x100c_4195, 5); jmp(0x100c_42a4, 0x10a); goto l_0x100c_42a4; /* jmp 0x100c42a4 */
        l_0x100c_419a:
            ii(0x100c_419a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_419d, 3); mov(al, memb[ds, eax + 0x2]);           /* mov al, [eax+0x2] */
            ii(0x100c_41a0, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
        ...
        l_0x100c_41a8:
            ...
            ii(0x100c_41c5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_41c8, 4); mov(memw[ds, eax + 0x7], dx);           /* mov [eax+0x7], dx */
        ...
        l_0x100c_41d1:
            ...
            ii(0x100c_41ff, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_4202, 4); mov(memw[ds, eax + 0x7], dx);           /* mov [eax+0x7], dx */
            ii(0x100c_4206, 2); jmp(0x100c_4211, 0x9); goto l_0x100c_4211; /* jmp 0x100c4211 */
        l_0x100c_4208:
            ii(0x100c_4208, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_420b, 6); mov(memw[ds, eax + 0x7], 0);            /* mov word [eax+0x7], 0x0 */
        l_0x100c_4211:
        ...
        l_0x100c_4216:
            ...
            ii(0x100c_4244, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_4247, 4); mov(memw[ds, eax + 0x7], dx);           /* mov [eax+0x7], dx */
            ii(0x100c_424b, 2); jmp(0x100c_4256, 0x9); goto l_0x100c_4256; /* jmp 0x100c4256 */
        l_0x100c_424d:
            ii(0x100c_424d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_4250, 6); mov(memw[ds, eax + 0x7], 0);            /* mov word [eax+0x7], 0x0 */
        l_0x100c_4256:
            ii(0x100c_4256, 2); jmp(0x100c_42a4, 0x4c); goto l_0x100c_42a4; /* jmp 0x100c42a4 */
        l_0x100c_4258:
            ii(0x100c_4258, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_425b, 6); mov(memw[ds, eax + 0x7], 0);            /* mov word [eax+0x7], 0x0 */
        ...
        l_0x100c_4265:
            ii(0x100c_4265, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x100c_4268, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x100c_426b, 4); cmp(memb[ss, ebp - 0xc], 0x3);          /* cmp byte [ebp-0xc], 0x3 */
            ii(0x100c_426f, 2); if(jb(0x100c_428d, 0x1c)) goto l_0x100c_428d; /* jb 0x100c428d */
            ii(0x100c_4271, 4); cmp(memb[ss, ebp - 0xc], 0x4);          /* cmp byte [ebp-0xc], 0x4 */
            ii(0x100c_4275, 6); if(jbe(0x100c_41d1, -0xaa)) goto l_0x100c_41d1; /* jbe 0x100c41d1 */
            ii(0x100c_427b, 4); cmp(memb[ss, ebp - 0xc], 0x6);          /* cmp byte [ebp-0xc], 0x6 */
            ii(0x100c_427f, 2); if(jbe(0x100c_4258, -0x29)) goto l_0x100c_4258; /* jbe 0x100c4258 */
            ii(0x100c_4281, 4); cmp(memb[ss, ebp - 0xc], 0x9);          /* cmp byte [ebp-0xc], 0x9 */
        ...
        //  ii(0x100c_4289, 2); jmp(0x100c_4263, -0x28); goto l_0x100c_4263; /* jmp 0x100c4263 */
        //  ii(0x100c_428b, 2); jmp(0x100c_4263, -0x2a); goto l_0x100c_4263; /* jmp 0x100c4263 */
        l_0x100c_428d:
            ii(0x100c_428d, 4); cmp(memb[ss, ebp - 0xc], 0x1);          /* cmp byte [ebp-0xc], 0x1 */
            ii(0x100c_4291, 2); if(jb(0x100c_42a2, 0xf)) goto l_0x100c_42a2; /* jb 0x100c42a2 */
            ii(0x100c_4293, 4); cmp(memb[ss, ebp - 0xc], 0x1);          /* cmp byte [ebp-0xc], 0x1 */
