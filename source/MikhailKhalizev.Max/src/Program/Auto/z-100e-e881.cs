...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_e881()
        {
            ...
            ii(0x100e_e886, 5); calld(Definitions.sys_check_available_stack_size, 0x774c7); /* call 0x10165d52 */
        ...
        l_0x100e_e8fe:
            ...
            ii(0x100e_e907, 5); calld(0x1012_9753, 0x3ae47);            /* call 0x10129753 */
        l_0x100e_e90c:
        ...
        l_0x100e_e925:
            ...
            ii(0x100e_e932, 5); calld(0x1012_b16c, 0x3c835);            /* call 0x1012b16c */
        l_0x100e_e937:
            ii(0x100e_e937, 4); movsx(edx, memw_a32[ss, ebp - 0x1c]);   /* movsx edx, word [ebp-0x1c] */
            ii(0x100e_e93b, 5); calld(/* sys */ 0x1016_5e9b, 0x7755b);  /* call 0x10165e9b */
            ...
            ii(0x100e_e967, 5); calld(Definitions.my_string_ctor, 0x5317c); /* call 0x10141ae8 */
            ...
            ii(0x100e_e97e, 5); calld(0x1007_5fdc, -0x789a7);           /* call 0x10075fdc */
        ...
        l_0x100e_e98d:
            ...
            ii(0x100e_e995, 5); calld(Definitions.my_string_ctor_char_ptr, 0x530a1); /* call 0x10141a3b */
            ii(0x100e_e99a, 4); or(memb_a32[ss, ebp - 0x38], 0x1);      /* or byte [ebp-0x38], 0x1 */
            ii(0x100e_e99e, 3); lea(eax, ebp - 0x48);                   /* lea eax, [ebp-0x48] */
            ii(0x100e_e9a1, 5); calld(Definitions.my_string_ctor, 0x53142); /* call 0x10141ae8 */
            ...
            ii(0x100e_e9c6, 5); calld(0x1014_2037, 0x5366c);            /* call 0x10142037 */
        ...
        l_0x100e_e9f4:
            ...
            ii(0x100e_e9f7, 5); calld(/* sys */ 0x1017_1f05, 0x83509);  /* call 0x10171f05 */
            ...
            ii(0x100e_ea0d, 5); calld(Definitions.my_string_append_char, 0x533d8); /* call 0x10141dea */
        ...
        l_0x100e_ea14:
            ...
            ii(0x100e_ea17, 5); calld(Definitions.sys_fclose, 0x8364d); /* call 0x10172069 */
        ...
        l_0x100e_ea25:
            ...
            ii(0x100e_ea2a, 5); calld(Definitions.my_string_dtor, 0x530fb); /* call 0x10141b2a */
            ii(0x100e_ea2f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100e_ea31, 3); lea(eax, ebp - 0x44);                   /* lea eax, [ebp-0x44] */
            ii(0x100e_ea34, 5); calld(Definitions.my_string_dtor, 0x530f1); /* call 0x10141b2a */
        l_0x100e_ea39:
            ...
            ii(0x100e_ea4f, 5); calld(0x100d_67d8, -0x1827c);           /* call 0x100d67d8 */
            ...
            ii(0x100e_ea75, 5); calld(0x1013_d08a, 0x4e610);            /* call 0x1013d08a */
            ...
            ii(0x100e_ea93, 5); calld(/* sys */ 0x1016_a24c, 0x7b7b4);  /* call 0x1016a24c */
            ii(0x100e_ea98, 5); mov(eax, 0x1);                          /* mov eax, 0x1 */
            ii(0x100e_ea9d, 5); calld(0x1012_0d94, 0x322f2);            /* call 0x10120d94 */
            ...
            ii(0x100e_eaaf, 5); calld(0x100d_6124, -0x18990);           /* call 0x100d6124 */
            ...
            ii(0x100e_eabb, 5); calld(0x100d_6adf, -0x17fe1);           /* call 0x100d6adf */
            ii(0x100e_eac0, 6); lea(edx, ebp - 0x8c);                   /* lea edx, [ebp-0x8c] */
            ii(0x100e_eac6, 3); lea(eax, ebp - 0x6c);                   /* lea eax, [ebp-0x6c] */
            ii(0x100e_eac9, 5); calld(0x100d_6a11, -0x180bd);           /* call 0x100d6a11 */
        ...
        l_0x100e_ec18:
            ...
            ii(0x100e_ec1e, 5); calld(0x100d_5470, -0x197b3);           /* call 0x100d5470 */
            ...
            ii(0x100e_ec35, 5); calld(0x1013_daea, 0x4eeb0);            /* call 0x1013daea */
            ...
            ii(0x100e_ec46, 5); calld(0x1013_cf8e, 0x4e343);            /* call 0x1013cf8e */
        ...
        l_0x100e_ec4d:
            ...
            ii(0x100e_ec59, 5); calld(0x1013_cf8e, 0x4e330);            /* call 0x1013cf8e */
        l_0x100e_ec5e:
            ...
            ii(0x100e_ec6e, 5); calld(Definitions.sys_display_draw_0, 0x78811); /* call 0x10167484 */
            ...
            ii(0x100e_ec8f, 5); calld(Definitions.my_strobj_c_str_v2, -0x654cc); /* call 0x100897c8 */
        ...
        l_0x100e_ecba:
            ...
            ii(0x100e_ecbf, 5); calld(/* sys */ 0x1016_a24c, 0x7b588);  /* call 0x1016a24c */
            ii(0x100e_ecc4, 5); mov(eax, 0x38);                         /* mov eax, 0x38 */
            ii(0x100e_ecc9, 5); calld(Definitions.sys_new, 0x77132);    /* call 0x10165e00 */
            ...
            ii(0x100e_ed04, 5); calld(Definitions.my_ctor_c17, -0x208fa); /* call 0x100ce40f */
        ...
        l_0x100e_ed29:
            ...
            ii(0x100e_ed3b, 5); calld(0x100d_5224, -0x19b1c);           /* call 0x100d5224 */
            ii(0x100e_ed40, 1); pushd(eax);                             /* push eax */
            ii(0x100e_ed41, 6); lea(eax, ebp - 0xb4);                   /* lea eax, [ebp-0xb4] */
            ii(0x100e_ed47, 5); calld(0x100d_5250, -0x19afc);           /* call 0x100d5250 */
            ii(0x100e_ed4c, 1); pushd(eax);                             /* push eax */
            ii(0x100e_ed4d, 6); lea(eax, ebp - 0xb8);                   /* lea eax, [ebp-0xb8] */
            ii(0x100e_ed53, 5); calld(0x100d_527c, -0x19adc);           /* call 0x100d527c */
            ii(0x100e_ed58, 1); pushd(eax);                             /* push eax */
            ii(0x100e_ed59, 6); lea(eax, ebp - 0xbc);                   /* lea eax, [ebp-0xbc] */
            ii(0x100e_ed5f, 5); calld(0x100d_52a8, -0x19abc);           /* call 0x100d52a8 */
            ii(0x100e_ed64, 1); pushd(eax);                             /* push eax */
            ii(0x100e_ed65, 5); calld(0x100d_52d4, -0x19a96);           /* call 0x100d52d4 */
            ...
            ii(0x100e_ed8a, 5); calld(/* sys */ 0x1016_a24c, 0x7b4bd);  /* call 0x1016a24c */
            ii(0x100e_ed8f, 5); mov(edx, 0x1b);                         /* mov edx, 0x1b */
            ii(0x100e_ed94, 6); mov(eax, memd_a32[ss, ebp - 0xac]);     /* mov eax, [ebp-0xac] */
            ii(0x100e_ed9a, 5); calld(0x100d_5134, -0x19c6b);           /* call 0x100d5134 */
            ...
            ii(0x100e_eda8, 5); calld(0x100c_f85c, -0x1f551);           /* call 0x100cf85c */
            ii(0x100e_edad, 3); mov(eax, memd_a32[ss, ebp - 0x7a]);     /* mov eax, [ebp-0x7a] */
            ii(0x100e_edb0, 5); calld(Definitions.sys_display_draw_0, 0x786cf); /* call 0x10167484 */
            ...
            ii(0x100e_edc3, 5); calld(0x1007_6630, -0x78798);           /* call 0x10076630 */
            ii(0x100e_edc8, 5); calld(0x1014_82f4, 0x59527);            /* call 0x101482f4 */
            ii(0x100e_edcd, 6); mov(memd_a32[ss, ebp - 0xc4], eax);     /* mov [ebp-0xc4], eax */
        l_0x100e_edd3:
            ii(0x100e_edd3, 5); calld(/* sys */ 0x1016_b208, 0x7c430);  /* call 0x1016b208 */
        ...
        l_0x100e_edef:
            ...
            ii(0x100e_ee00, 5); calld(0x100d_533c, -0x19ac9);           /* call 0x100d533c */
            ii(0x100e_ee05, 1); cwde();                                 /* cwde */
            ii(0x100e_ee06, 1); pushd(eax);                             /* push eax */
            ii(0x100e_ee07, 5); calld(0x100d_5360, -0x19aac);           /* call 0x100d5360 */
            ...
            ii(0x100e_ee44, 5); calld(Definitions.sys_display_draw_0, 0x7863b); /* call 0x10167484 */
            ...
            ii(0x100e_ee65, 5); calld(Definitions.my_strobj_c_str_v2, -0x656a2); /* call 0x100897c8 */
        ...
        l_0x100e_ee90:
            ...
            ii(0x100e_ee93, 5); calld(Definitions.sys_display_draw_0, 0x785ec); /* call 0x10167484 */
        ...
        l_0x100e_eed0:
            ...
            ii(0x100e_eefa, 5); calld(Definitions.my_dtor_d2, -0x209c7); /* call 0x100ce538 */
            ii(0x100e_eeff, 5); calld(Definitions.sys_delete, 0x77060); /* call 0x10165f64 */
        ...
        l_0x100e_ef16:
            ...
            ii(0x100e_ef1b, 5); calld(0x100d_6999, -0x18587);           /* call 0x100d6999 */
            ...
            ii(0x100e_ef38, 5); calld(0x1007_5fdc, -0x78f61);           /* call 0x10075fdc */
        ...
        l_0x100e_ef4a:
            ...
            ii(0x100e_ef59, 5); calld(0x100c_aafc, -0x24462);           /* call 0x100caafc */
            ...
            ii(0x100e_ef6c, 5); calld(0x1007_5fdc, -0x78f95);           /* call 0x10075fdc */
            ...
            ii(0x100e_ef86, 5); calld(0x100c_aafc, -0x2448f);           /* call 0x100caafc */
        l_0x100e_ef8b:
            ii(0x100e_ef8b, 5); mov(eax, 0x101c_39c8);                  /* mov eax, 0x101c39c8 */
            ii(0x100e_ef90, 5); calld(0x1010_6084, 0x170ef);            /* call 0x10106084 */
        l_0x100e_ef95:
            ii(0x100e_ef95, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100e_ef97, 3); lea(eax, ebp - 0x3c);                   /* lea eax, [ebp-0x3c] */
            ii(0x100e_ef9a, 5); calld(Definitions.my_string_dtor, 0x52b8b); /* call 0x10141b2a */
