...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_e49a()
        {
            ...
            ii(0x19_e4b1, 3); les(bx, memw[ss, bp + 0x8]);              /* les bx, [bp+0x8] */
            ii(0x19_e4b4, 4); push(memw[es, bx + 0x2]);                 /* push word [es:bx+0x2] */
            ...
            ii(0x19_e4cb, 2); if(jnz(0x19_e4d0, 0x3)) goto l_0x19_e4d0; /* jnz 0xe4d0 */
            ii(0x19_e4cd, 3); jmp(0x19_e559, 0x89); goto l_0x19_e559;   /* jmp 0xe559 */
        l_0x19_e4d0:
            ii(0x19_e4d0, 3); les(bx, memw[ss, bp + 0x8]);              /* les bx, [bp+0x8] */
            ii(0x19_e4d3, 4); push(memw[es, bx + 0x6]);                 /* push word [es:bx+0x6] */
            ii(0x19_e4d7, 4); push(memw[es, bx + 0x4]);                 /* push word [es:bx+0x4] */
            ...
            ii(0x19_e4ef, 3); les(bx, memw[ss, bp + 0xc]);              /* les bx, [bp+0xc] */
            ii(0x19_e4f2, 2); sub(ax, ax);                              /* sub ax, ax */
            ii(0x19_e4f4, 4); mov(memw[es, bx + 0x2], ax);              /* mov [es:bx+0x2], ax */
            ...
            ii(0x19_e505, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_e508, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x19_e50b, 3); les(bx, memw[ss, bp - 0x4]);              /* les bx, [bp-0x4] */
            ii(0x19_e50e, 3); inc(memw[ss, bp - 0x4]);                  /* inc word [bp-0x4] */
            ii(0x19_e511, 3); mov(al, memb[es, bx]);                    /* mov al, [es:bx] */
            ii(0x19_e514, 1); cbw();                                    /* cbw */
            ii(0x19_e515, 3); mov(memw[ss, bp - 0x1a], ax);             /* mov [bp-0x1a], ax */
            ii(0x19_e518, 3); push(memw[ss, bp - 0x1a]);                /* push word [bp-0x1a] */
            ii(0x19_e51b, 3); lea(ax, memw[ss, bp - 0x4]);              /* lea ax, [bp-0x4] */
            ...
            ii(0x19_e528, 3); mov(memw[ss, bp - 0x1a], ax);             /* mov [bp-0x1a], ax */
            ii(0x19_e52b, 3); mov(al, memb[ss, bp - 0x1a]);             /* mov al, [bp-0x1a] */
            ii(0x19_e52e, 4); les(bx, memw[ds, 0x2c22]);                /* les bx, [0x2c22] */
            ii(0x19_e532, 5); mov(memb[es, bx + 0x80], al);             /* mov [es:bx+0x80], al */
            ii(0x19_e537, 3); mov(ax, memw[ss, bp - 0x1a]);             /* mov ax, [bp-0x1a] */
            ii(0x19_e53a, 1); inc(ax);                                  /* inc ax */
            ii(0x19_e53b, 1); push(ax);                                 /* push ax */
            ii(0x19_e53c, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x19_e53f, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
        ...
        l_0x19_e559:
            ii(0x19_e559, 5); mov(memw[ss, bp - 0xa], 0xe00);           /* mov word [bp-0xa], 0xe00 */
            ii(0x19_e55e, 3); lea(ax, memw[ss, bp - 0x18]);             /* lea ax, [bp-0x18] */
            ...
            ii(0x19_e56e, 3); mov(ax, memw[ss, bp - 0x8]);              /* mov ax, [bp-0x8] */
            ii(0x19_e571, 3); mov(cx, memw[ss, bp - 0xc]);              /* mov cx, [bp-0xc] */
            ii(0x19_e574, 3); les(bx, memw[ss, bp + 0xc]);              /* les bx, [bp+0xc] */
            ii(0x19_e577, 3); mov(memw[es, bx], cx);                    /* mov [es:bx], cx */
            ii(0x19_e57a, 4); mov(memw[es, bx + 0x2], ax);              /* mov [es:bx+0x2], ax */
        l_0x19_e57e:
