...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_8054()
        {
            ...
            ii(0x100b_806c, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_806f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_8072, 3); add(eax, 0x16);                         /* add eax, 0x16 */
            ii(0x100b_8075, 5); call(0x1007_65d0, -0x4_1aaa);           /* call 0x100765d0 */
            ii(0x100b_807a, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_807d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
