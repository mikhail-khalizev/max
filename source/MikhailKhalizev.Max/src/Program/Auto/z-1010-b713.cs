...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1010_b74b:
            ...
            ii(0x1010_b793, 5);  mov(edx, 6);                          /* mov edx, 0x6 */
        ...
        l_0x1010_b7a7:
            ...
            ii(0x1010_b7a9, 5);  mov(eax, 9);                          /* mov eax, 0x9 */
            ii(0x1010_b7ae, 5);  call(0x100c_aafc, -0x4_0cb7);         /* call 0x100caafc */
            ii(0x1010_b7b3, 5);  mov(edx, 5);                          /* mov edx, 0x5 */
            ...
            ii(0x1010_b7ef, 5);  mov(edx, 5);                          /* mov edx, 0x5 */
        ...
        l_0x1010_b803:
            ii(0x1010_b803, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x1010_b808, 5);  mov(eax, 9);                          /* mov eax, 0x9 */
            ii(0x1010_b80d, 5);  call(0x100c_aafc, -0x4_0d16);         /* call 0x100caafc */
            ii(0x1010_b812, 5);  mov(edx, 5);                          /* mov edx, 0x5 */
            ...
            ii(0x1010_b84e, 5);  mov(edx, 4);                          /* mov edx, 0x4 */
        ...
        l_0x1010_b861:
            ii(0x1010_b861, 4);  cmp(memd[ss, ebp - 12], 1);           /* cmp dword [ebp-0xc], 0x1 */
            ii(0x1010_b865, 2);  if(jb(0x1010_b879, 0x12)) goto l_0x1010_b879;/* jb 0x1010b879 */
            ii(0x1010_b867, 4);  cmp(memd[ss, ebp - 12], 1);           /* cmp dword [ebp-0xc], 0x1 */
            ii(0x1010_b86b, 6);  if(jbe(0x1010_b7a7, -0xca)) goto l_0x1010_b7a7;/* jbe 0x1010b7a7 */
            ii(0x1010_b871, 4);  cmp(memd[ss, ebp - 12], 2);           /* cmp dword [ebp-0xc], 0x2 */
        ...
        l_0x1010_b879:
            ii(0x1010_b879, 4);  cmp(memd[ss, ebp - 12], 0);           /* cmp dword [ebp-0xc], 0x0 */
        ...
        l_0x1010_b885:
            ...
            ii(0x1010_b88f, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1010_b892, 2);  jmp(0x1010_b8b3, 0x1f); goto l_0x1010_b8b3;/* jmp 0x1010b8b3 */
        l_0x1010_b894:
            ii(0x1010_b894, 4);  add(memd[ss, ebp - 4], 3);            /* add dword [ebp-0x4], 0x3 */
            ii(0x1010_b898, 3);  inc(memd[ss, ebp - 8]);               /* inc dword [ebp-0x8] */
            ii(0x1010_b89b, 2);  jmp(0x1010_b8cf, 0x32); goto l_0x1010_b8cf;/* jmp 0x1010b8cf */
        l_0x1010_b89d:
            ii(0x1010_b89d, 4);  add(memd[ss, ebp - 4], 5);            /* add dword [ebp-0x4], 0x5 */
            ii(0x1010_b8a1, 4);  add(memd[ss, ebp - 8], 2);            /* add dword [ebp-0x8], 0x2 */
            ii(0x1010_b8a5, 2);  jmp(0x1010_b8cf, 0x28); goto l_0x1010_b8cf;/* jmp 0x1010b8cf */
        l_0x1010_b8a7:
            ii(0x1010_b8a7, 4);  add(memd[ss, ebp - 4], 6);            /* add dword [ebp-0x4], 0x6 */
            ii(0x1010_b8ab, 4);  add(memd[ss, ebp - 8], 3);            /* add dword [ebp-0x8], 0x3 */
        ...
        l_0x1010_b8b3:
            ii(0x1010_b8b3, 4);  cmp(memd[ss, ebp - 16], 1);           /* cmp dword [ebp-0x10], 0x1 */
            ii(0x1010_b8b7, 2);  if(jb(0x1010_b8c7, 0xe)) goto l_0x1010_b8c7;/* jb 0x1010b8c7 */
            ii(0x1010_b8b9, 4);  cmp(memd[ss, ebp - 16], 1);           /* cmp dword [ebp-0x10], 0x1 */
            ii(0x1010_b8bd, 2);  if(jbe(0x1010_b89d, -0x22)) goto l_0x1010_b89d;/* jbe 0x1010b89d */
            ii(0x1010_b8bf, 4);  cmp(memd[ss, ebp - 16], 2);           /* cmp dword [ebp-0x10], 0x2 */
        ...
        l_0x1010_b8c7:
            ii(0x1010_b8c7, 4);  cmp(memd[ss, ebp - 16], 0);           /* cmp dword [ebp-0x10], 0x0 */
        ...
        l_0x1010_b8e1:
            ...
            ii(0x1010_b92c, 5);  mov(edx, 6);                          /* mov edx, 0x6 */
        ...
        l_0x1010_b940:
            ...
            ii(0x1010_b98b, 5);  mov(edx, 5);                          /* mov edx, 0x5 */
        ...
        l_0x1010_b99f:
            ...
            ii(0x1010_b9ea, 5);  mov(edx, 4);                          /* mov edx, 0x4 */
        ...
        l_0x1010_b9fd:
            ii(0x1010_b9fd, 4);  cmp(memd[ss, ebp - 20], 1);           /* cmp dword [ebp-0x14], 0x1 */
            ii(0x1010_ba01, 2);  if(jb(0x1010_ba15, 0x12)) goto l_0x1010_ba15;/* jb 0x1010ba15 */
            ii(0x1010_ba03, 4);  cmp(memd[ss, ebp - 20], 1);           /* cmp dword [ebp-0x14], 0x1 */
            ii(0x1010_ba07, 6);  if(jbe(0x1010_b940, -0xcd)) goto l_0x1010_b940;/* jbe 0x1010b940 */
            ii(0x1010_ba0d, 4);  cmp(memd[ss, ebp - 20], 2);           /* cmp dword [ebp-0x14], 0x2 */
        ...
        l_0x1010_ba15:
            ii(0x1010_ba15, 4);  cmp(memd[ss, ebp - 20], 0);           /* cmp dword [ebp-0x14], 0x0 */
        ...
        l_0x1010_ba21:
            ...
            ii(0x1010_ba2b, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1010_ba2e, 2);  jmp(0x1010_ba4f, 0x1f); goto l_0x1010_ba4f;/* jmp 0x1010ba4f */
        l_0x1010_ba30:
            ii(0x1010_ba30, 4);  add(memd[ss, ebp - 4], 2);            /* add dword [ebp-0x4], 0x2 */
            ii(0x1010_ba34, 3);  inc(memd[ss, ebp - 8]);               /* inc dword [ebp-0x8] */
            ii(0x1010_ba37, 2);  jmp(0x1010_ba6b, 0x32); goto l_0x1010_ba6b;/* jmp 0x1010ba6b */
        l_0x1010_ba39:
            ii(0x1010_ba39, 4);  add(memd[ss, ebp - 4], 3);            /* add dword [ebp-0x4], 0x3 */
            ii(0x1010_ba3d, 4);  add(memd[ss, ebp - 8], 2);            /* add dword [ebp-0x8], 0x2 */
            ii(0x1010_ba41, 2);  jmp(0x1010_ba6b, 0x28); goto l_0x1010_ba6b;/* jmp 0x1010ba6b */
        l_0x1010_ba43:
            ii(0x1010_ba43, 4);  add(memd[ss, ebp - 4], 4);            /* add dword [ebp-0x4], 0x4 */
            ii(0x1010_ba47, 4);  add(memd[ss, ebp - 8], 3);            /* add dword [ebp-0x8], 0x3 */
        ...
        l_0x1010_ba4f:
            ii(0x1010_ba4f, 4);  cmp(memd[ss, ebp - 24], 1);           /* cmp dword [ebp-0x18], 0x1 */
            ii(0x1010_ba53, 2);  if(jb(0x1010_ba63, 0xe)) goto l_0x1010_ba63;/* jb 0x1010ba63 */
            ii(0x1010_ba55, 4);  cmp(memd[ss, ebp - 24], 1);           /* cmp dword [ebp-0x18], 0x1 */
            ii(0x1010_ba59, 2);  if(jbe(0x1010_ba39, -0x22)) goto l_0x1010_ba39;/* jbe 0x1010ba39 */
            ii(0x1010_ba5b, 4);  cmp(memd[ss, ebp - 24], 2);           /* cmp dword [ebp-0x18], 0x2 */
        ...
        l_0x1010_ba63:
            ii(0x1010_ba63, 4);  cmp(memd[ss, ebp - 24], 0);           /* cmp dword [ebp-0x18], 0x0 */
        ...
        l_0x1010_ba6b:
            ...
            ii(0x1010_ba83, 3);  mov(memd[ss, ebp - 28], edx);         /* mov [ebp-0x1c], edx */
        ...
        //  ii(0x1010_bae5, 3);  lea(eax, memd[ds, eax]);              /* lea eax, [eax] */
        ...
        l_0x1010_bafc:
            ii(0x1010_bafc, 4);  cmp(memd[ss, ebp - 28], 4);           /* cmp dword [ebp-0x1c], 0x4 */
            ii(0x1010_bb00, 2);  if(ja(0x1010_bae3, -0x1f)) goto l_0x1010_bae3;/* ja 0x1010bae3 */
            ii(0x1010_bb02, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x1010_bb05, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x1010_bb08, 7);  /* jmp dword [cs:eax+0x1010bae8] */
        ...
        l_0x1010_bb0f:
            ...
            ii(0x1010_bb19, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
        ...
        l_0x1010_bb21:
            ...
            ii(0x1010_bb66, 5);  mov(edx, 6);                          /* mov edx, 0x6 */
        ...
        l_0x1010_bb7a:
            ...
            ii(0x1010_bb92, 5);  mov(edx, 8);                          /* mov edx, 0x8 */
            ...
            ii(0x1010_bbbf, 5);  mov(edx, 5);                          /* mov edx, 0x5 */
        ...
        l_0x1010_bbd3:
            ...
            ii(0x1010_bbdf, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ...
            ii(0x1010_bc1b, 5);  mov(edx, 4);                          /* mov edx, 0x4 */
        ...
        l_0x1010_bc2e:
            ii(0x1010_bc2e, 4);  cmp(memd[ss, ebp - 32], 1);           /* cmp dword [ebp-0x20], 0x1 */
            ii(0x1010_bc32, 2);  if(jb(0x1010_bc46, 0x12)) goto l_0x1010_bc46;/* jb 0x1010bc46 */
            ii(0x1010_bc34, 4);  cmp(memd[ss, ebp - 32], 1);           /* cmp dword [ebp-0x20], 0x1 */
            ii(0x1010_bc38, 6);  if(jbe(0x1010_bb7a, -0xc4)) goto l_0x1010_bb7a;/* jbe 0x1010bb7a */
            ii(0x1010_bc3e, 4);  cmp(memd[ss, ebp - 32], 2);           /* cmp dword [ebp-0x20], 0x2 */
        ...
        l_0x1010_bc46:
            ii(0x1010_bc46, 4);  cmp(memd[ss, ebp - 32], 0);           /* cmp dword [ebp-0x20], 0x0 */
        ...
        l_0x1010_bc52:
            ...
            ii(0x1010_bc5c, 3);  mov(memd[ss, ebp - 36], eax);         /* mov [ebp-0x24], eax */
        ...
        l_0x1010_bc63:
            ii(0x1010_bc63, 3);  inc(memd[ss, ebp - 8]);               /* inc dword [ebp-0x8] */
            ii(0x1010_bc66, 2);  jmp(0x1010_bc8f, 0x27); goto l_0x1010_bc8f;/* jmp 0x1010bc8f */
        l_0x1010_bc68:
            ii(0x1010_bc68, 3);  inc(memd[ss, ebp - 4]);               /* inc dword [ebp-0x4] */
            ii(0x1010_bc6b, 4);  add(memd[ss, ebp - 8], 2);            /* add dword [ebp-0x8], 0x2 */
        ...
        l_0x1010_bc73:
            ii(0x1010_bc73, 4);  cmp(memd[ss, ebp - 36], 1);           /* cmp dword [ebp-0x24], 0x1 */
            ii(0x1010_bc77, 2);  if(jb(0x1010_bc87, 0xe)) goto l_0x1010_bc87;/* jb 0x1010bc87 */
            ii(0x1010_bc79, 4);  cmp(memd[ss, ebp - 36], 1);           /* cmp dword [ebp-0x24], 0x1 */
            ii(0x1010_bc7d, 2);  if(jbe(0x1010_bc63, -0x1c)) goto l_0x1010_bc63;/* jbe 0x1010bc63 */
            ii(0x1010_bc7f, 4);  cmp(memd[ss, ebp - 36], 2);           /* cmp dword [ebp-0x24], 0x2 */
        ...
        l_0x1010_bc87:
            ii(0x1010_bc87, 4);  cmp(memd[ss, ebp - 36], 0);           /* cmp dword [ebp-0x24], 0x0 */
        ...
        l_0x1010_bc8f:
            ii(0x1010_bc8f, 4);  movsx(edx, memw[ss, ebp - 4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x1010_bc93, 5);  mov(eax, 0x1c);                       /* mov eax, 0x1c */
            ii(0x1010_bc98, 5);  call(0x100c_aafc, -0x4_11a1);         /* call 0x100caafc */
            ii(0x1010_bc9d, 4);  movsx(edx, memw[ss, ebp - 8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x1010_bcb5, 3);  mov(memd[ss, ebp - 40], eax);         /* mov [ebp-0x28], eax */
        ...
        l_0x1010_bd0a:
            ii(0x1010_bd0a, 4);  cmp(memd[ss, ebp - 40], 1);           /* cmp dword [ebp-0x28], 0x1 */
            ii(0x1010_bd0e, 2);  if(jb(0x1010_bd1e, 0xe)) goto l_0x1010_bd1e;/* jb 0x1010bd1e */
            ii(0x1010_bd10, 4);  cmp(memd[ss, ebp - 40], 1);           /* cmp dword [ebp-0x28], 0x1 */
            ii(0x1010_bd14, 2);  if(jbe(0x1010_bcc8, -0x4e)) goto l_0x1010_bcc8;/* jbe 0x1010bcc8 */
            ii(0x1010_bd16, 4);  cmp(memd[ss, ebp - 40], 2);           /* cmp dword [ebp-0x28], 0x2 */
        ...
        l_0x1010_bd1e:
            ii(0x1010_bd1e, 4);  cmp(memd[ss, ebp - 40], 0);           /* cmp dword [ebp-0x28], 0x0 */
