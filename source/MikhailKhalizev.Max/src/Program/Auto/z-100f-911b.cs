...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_911b()
        {
            ...
            ii(0x100f_9132, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100f_9135, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ...
            ii(0x100f_9141, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_9144, 3); mov(ebx, memd[ds, eax + 0x1a]);         /* mov ebx, [eax+0x1a] */
            ii(0x100f_9147, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100f_914a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_914d, 3); mov(edx, memd[ds, eax + 0x18]);         /* mov edx, [eax+0x18] */
            ii(0x100f_9150, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100f_9153, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_9156, 5); call(0x1007_4c30, -0x8_452b);           /* call 0x10074c30 */
            ii(0x100f_915b, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100f_915e, 4); cmp(memd[ss, ebp - 0x4], 0);            /* cmp dword [ebp-0x4], 0x0 */
            ii(0x100f_9162, 2); if(jz(0x100f_91c3, 0x5f)) goto l_0x100f_91c3; /* jz 0x100f91c3 */
            ii(0x100f_9164, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_9167, 3); mov(al, memb[ds, eax + 0x50]);          /* mov al, [eax+0x50] */
        ...
        l_0x100f_9195:
            ii(0x100f_9195, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100f_9198, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100f_91ad, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_91b0, 4); mov(memw[ds, eax + 0x41], dx);          /* mov [eax+0x41], dx */
            ii(0x100f_91b4, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x100f_91b6, 5); mov(edx, 0x18);                         /* mov edx, 0x18 */
            ii(0x100f_91bb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
