...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_9e59()
        {
            ...
            ii(0x9e5b, 3);    mov(dx, memw[ds, bx + 0x4]);              /* mov dx, [bx+0x4] */
            ii(0x9e5e, 3);    mov(bx, memw[ds, bx + 0x2]);              /* mov bx, [bx+0x2] */
        ...
        l_0x9e6d:
            ...
            ii(0x9e73, 2);    if(jnz(0x9e79, 0x4)) goto l_0x9e79;       /* jnz 0x9e79 */
            ii(0x9e75, 2);    cmp(di, bx);                              /* cmp di, bx */
            ii(0x9e77, 2);    if(jz(0x9e81, 0x8)) goto l_0x9e81;        /* jz 0x9e81 */
        l_0x9e79:
            ii(0x9e79, 2);    if(loop(0x9e6d, -0xe)) goto l_0x9e6d;     /* loop 0x9e6d */
            ii(0x9e7b, 2);    xor(ax, ax);                              /* xor ax, ax */
            ii(0x9e7d, 2);    xor(dx, dx);                              /* xor dx, dx */
            ii(0x9e7f, 2);    jmp(0x9e89, 0x8); goto l_0x9e89;          /* jmp 0x9e89 */
        l_0x9e81:
