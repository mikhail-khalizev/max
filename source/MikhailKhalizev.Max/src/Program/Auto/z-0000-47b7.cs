...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("03f3d821-577d-4cc8-a0ef-9f70abbd35aa")]
        public void Method_0000_47b7()
        {
            ii(0x47b7, 3);    mov(al, memb_a16[ds, 0xa17]);             /* mov al, [0xa17] */
            ii(0x47ba, 2);    cmp(al, -0x1 /* 0xff */);                 /* cmp al, 0xff */
            ii(0x47bc, 2);    if(jzw(0x47cc, 0xe)) goto l_0x47cc;       /* jz 0x47cc */
            ...
            ii(0x47c5, 2);    if(jzw(0x47cc, 0x5)) goto l_0x47cc;       /* jz 0x47cc */
