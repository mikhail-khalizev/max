...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_8ade()
        {
            ...
            ii(0x100e_8af6, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100e_8af9, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100e_8afd, 5); call(Definitions.my_get_res_data_by_id_malloc, 0x4_b6e9); /* call 0x101341eb */
            ii(0x100e_8b02, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_8b05, 4); cmp(memd[ss, ebp - 0x8], 0);            /* cmp dword [ebp-0x8], 0x0 */
            ii(0x100e_8b09, 2); if(jz(0x100e_8b1b, 0x10)) goto l_0x100e_8b1b; /* jz 0x100e8b1b */
            ii(0x100e_8b0b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_8b0e, 5); call(0x100e_8a40, -0xd3);               /* call 0x100e8a40 */
            ii(0x100e_8b13, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
