...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("97a293ae-e5a8-4aaf-997d-170ed9bf63f8")]
        public void Method_100e_8ade()
        {
            ii(0x100e_8ade, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x100e_8ae3, 5); calld(Definitions.sys_check_available_stack_size, 0x7d26a); /* call 0x10165d52 */
            ...
            ii(0x100e_8afd, 5); calld(Definitions.my_get_res_data_by_id_malloc, 0x4b6e9); /* call 0x101341eb */
            ...
            ii(0x100e_8b16, 5); calld(Definitions.sys_delete, 0x7d449); /* call 0x10165f64 */
        l_0x100e_8b1b:
            ...
            ii(0x100e_8b23, 1); retd(); return;                         /* ret */
        }
    }
}
