...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x19_ddfd, 4); enter(8, 0);                              /* enter 0x8, 0x0 */
            ...
            ii(0x19_de0a, 5); mov(memw[ss, bp - 8], 0);                 /* mov word [bp-0x8], 0x0 */
            ii(0x19_de0f, 3); mov(memw[ss, bp - 6], ax);                /* mov [bp-0x6], ax */
            ii(0x19_de12, 3); mov(ax, memw[ss, bp + 4]);                /* mov ax, [bp+0x4] */
            ...
            ii(0x19_de20, 3); mov(memw[ss, bp - 4], ax);                /* mov [bp-0x4], ax */
            ii(0x19_de23, 2); mov(ax, dx);                              /* mov ax, dx */
            ii(0x19_de25, 3); or(ax, memw[ss, bp - 4]);                 /* or ax, [bp-0x4] */
            ii(0x19_de28, 2); if(jz(0x19_de41, 0x17)) goto l_0x19_de41; /* jz 0xde41 */
            ii(0x19_de2a, 2); mov(bx, dx);                              /* mov bx, dx */
            ii(0x19_de2c, 3); shr(bx, 3);                               /* shr bx, 0x3 */
            ii(0x19_de2f, 3); les(si, memw[ss, bp - 8]);                /* les si, [bp-0x8] */
            ii(0x19_de32, 4); or(memb[es, bx + si], 1);                 /* or byte [es:bx+si], 0x1 */
            ii(0x19_de36, 1); push(dx);                                 /* push dx */
            ii(0x19_de37, 3); push(memw[ss, bp - 4]);                   /* push word [bp-0x4] */
