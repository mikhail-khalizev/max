...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_6a90()
        {
            ...
            ii(0x1016_6ab6, 3); mov(ecx, memd[ds, eax + 24]);           /* mov ecx, [eax+0x18] */
            ii(0x1016_6ab9, 3); mov(eax, memd[ds, eax + 44]);           /* mov eax, [eax+0x2c] */
            ii(0x1016_6abc, 3); lea(edx, memd[ds, ecx - 10]);           /* lea edx, [ecx-0xa] */
            ...
            ii(0x1016_6acc, 3); mov(ecx, memd[ds, esi + 24]);           /* mov ecx, [esi+0x18] */
            ii(0x1016_6acf, 3); mov(ebx, memd[ds, esi + 28]);           /* mov ebx, [esi+0x1c] */
            ii(0x1016_6ad2, 3); mov(eax, memd[ds, esi + 44]);           /* mov eax, [esi+0x2c] */
            ii(0x1016_6ad5, 5); call(/* sys */ 0x1016_af44, 0x446a);    /* call 0x1016af44 */
            ii(0x1016_6ada, 3); mov(ecx, memd[ds, esi + 24]);           /* mov ecx, [esi+0x18] */
            ii(0x1016_6add, 3); mov(eax, memd[ds, esi + 44]);           /* mov eax, [esi+0x2c] */
            ii(0x1016_6ae0, 5); mov(edx, 5);                            /* mov edx, 0x5 */
            ii(0x1016_6ae5, 2); add(eax, ecx);                          /* add eax, ecx */
            ii(0x1016_6ae7, 3); mov(ebx, memd[ds, esi + 28]);           /* mov ebx, [esi+0x1c] */
            ii(0x1016_6aea, 3); sub(eax, 5);                            /* sub eax, 0x5 */
            ii(0x1016_6aed, 5); call(/* sys */ 0x1016_af44, 0x4452);    /* call 0x1016af44 */
            ii(0x1016_6af2, 3); mov(ecx, memd[ds, esi + 24]);           /* mov ecx, [esi+0x18] */
            ii(0x1016_6af5, 3); mov(ebx, memd[ds, esi + 28]);           /* mov ebx, [esi+0x1c] */
            ii(0x1016_6af8, 3); lea(edx, memd[ds, ecx - 10]);           /* lea edx, [ecx-0xa] */
            ii(0x1016_6afb, 3); sub(ebx, 5);                            /* sub ebx, 0x5 */
            ii(0x1016_6afe, 3); imul(ebx, ecx);                         /* imul ebx, ecx */
            ii(0x1016_6b01, 3); mov(eax, memd[ds, esi + 44]);           /* mov eax, [esi+0x2c] */
            ...
            ii(0x1016_6b1b, 3); mov(eax, memd[ds, esi + 28]);           /* mov eax, [esi+0x1c] */
            ii(0x1016_6b1e, 1); dec(eax);                               /* dec eax */
            ii(0x1016_6b1f, 1); push(eax);                              /* push eax */
            ii(0x1016_6b20, 3); mov(eax, memd[ds, esi + 24]);           /* mov eax, [esi+0x18] */
            ii(0x1016_6b23, 3); mov(edx, memd[ds, esi + 24]);           /* mov edx, [esi+0x18] */
            ...
            ii(0x1016_6b2c, 3); mov(eax, memd[ds, esi + 44]);           /* mov eax, [esi+0x2c] */
            ...
            ii(0x1016_6b56, 3); mov(eax, memd[ds, esi + 28]);           /* mov eax, [esi+0x1c] */
            ii(0x1016_6b59, 3); sub(eax, 2);                            /* sub eax, 0x2 */
            ii(0x1016_6b5c, 1); push(eax);                              /* push eax */
            ii(0x1016_6b5d, 3); mov(eax, memd[ds, esi + 24]);           /* mov eax, [esi+0x18] */
            ii(0x1016_6b60, 5); mov(ecx, 1);                            /* mov ecx, 0x1 */
            ii(0x1016_6b65, 3); sub(eax, 2);                            /* sub eax, 0x2 */
            ii(0x1016_6b68, 3); mov(edx, memd[ds, esi + 24]);           /* mov edx, [esi+0x18] */
            ii(0x1016_6b6b, 1); push(eax);                              /* push eax */
            ii(0x1016_6b6c, 2); mov(ebx, ecx);                          /* mov ebx, ecx */
            ii(0x1016_6b6e, 3); mov(eax, memd[ds, esi + 44]);           /* mov eax, [esi+0x2c] */
            ...
            ii(0x1016_6b98, 3); mov(eax, memd[ds, esi + 28]);           /* mov eax, [esi+0x1c] */
            ii(0x1016_6b9b, 3); sub(eax, 6);                            /* sub eax, 0x6 */
            ii(0x1016_6b9e, 1); push(eax);                              /* push eax */
            ii(0x1016_6b9f, 3); mov(eax, memd[ds, esi + 24]);           /* mov eax, [esi+0x18] */
            ii(0x1016_6ba2, 5); mov(ecx, 5);                            /* mov ecx, 0x5 */
            ii(0x1016_6ba7, 3); sub(eax, 6);                            /* sub eax, 0x6 */
            ii(0x1016_6baa, 3); mov(edx, memd[ds, esi + 24]);           /* mov edx, [esi+0x18] */
            ii(0x1016_6bad, 1); push(eax);                              /* push eax */
            ii(0x1016_6bae, 2); mov(ebx, ecx);                          /* mov ebx, ecx */
            ii(0x1016_6bb0, 3); mov(eax, memd[ds, esi + 44]);           /* mov eax, [esi+0x2c] */
