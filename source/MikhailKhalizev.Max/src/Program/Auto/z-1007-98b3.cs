...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_98b3()
        {
            ...
            ii(0x1007_98cb, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_98ce, 4); mov(memb[ss, ebp - 0x8], 0x3);          /* mov byte [ebp-0x8], 0x3 */
            ii(0x1007_98d2, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
