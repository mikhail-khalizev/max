...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_3700()
        {
            ...
            ii(0x100b_3716, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100b_3719, 3);  mov(memd[ss, ebp - 8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100b_371c, 3);  mov(memb[ss, ebp - 4], bl);           /* mov [ebp-0x4], bl */
            ii(0x100b_371f, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100b_3722, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x100b_3725, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_3727, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
        ...
        l_0x100b_3742:
            ii(0x100b_3742, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
        ...
        l_0x100b_374c:
            ii(0x100b_374c, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
