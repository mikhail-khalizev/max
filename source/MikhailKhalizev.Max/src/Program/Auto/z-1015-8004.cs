...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_8004()
        {
            ...
            ii(0x1015_8024, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ...
            ii(0x1015_8038, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1015_803b, 3);  add(eax, 0x65);                       /* add eax, 0x65 */
            ii(0x1015_803e, 5);  call(0x1007_6a34, -0xe_160f);         /* call 0x10076a34 */
            ii(0x1015_8043, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1015_8046, 4);  mov(memb[ds, eax + 91], 0);           /* mov byte [eax+0x5b], 0x0 */
            ii(0x1015_804a, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1015_804d, 4);  mov(memb[ds, eax + 92], 0);           /* mov byte [eax+0x5c], 0x0 */
            ...
            ii(0x1015_805a, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1015_805d, 5);  call(0x1012_ae8d, -0x2_d1d5);         /* call 0x1012ae8d */
        l_0x1015_8062:
            ii(0x1015_8062, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1015_8065, 4);  cmp(memb[ds, eax + 61], 0xc);         /* cmp byte [eax+0x3d], 0xc */
            ...
            ii(0x1015_8072, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1015_8075, 5);  call(0x1016_3053, 0xafd9);            /* call 0x10163053 */
            ii(0x1015_807a, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
        ...
        l_0x1015_8084:
            ...
            ii(0x1015_808e, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1015_8091, 5);  call(0x1016_3053, 0xafbd);            /* call 0x10163053 */
            ii(0x1015_8096, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1015_8099, 5);  call(0x1010_094d, -0x5_7751);         /* call 0x1010094d */
            ii(0x1015_809e, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
