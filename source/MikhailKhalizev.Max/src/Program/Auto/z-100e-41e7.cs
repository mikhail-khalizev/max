...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_41e7()
        {
            ...
            ii(0x100e_41fe, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_4201, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x100e_4204, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100e_4211, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x100e_4214, 5); call(0x1007_64b8, -0x6_dd61);           /* call 0x100764b8 */
            ii(0x100e_4219, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_421c, 5); call(0x100e_3fc4, -0x25d);              /* call 0x100e3fc4 */
            ii(0x100e_4221, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x100e_4228, 2); jmp(0x100e_4230, 0x6); goto l_0x100e_4230; /* jmp 0x100e4230 */
        l_0x100e_422a:
            ii(0x100e_422a, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100e_422d, 3); inc(memd[ss, ebp - 0x10]);              /* inc dword [ebp-0x10] */
        l_0x100e_4230:
            ii(0x100e_4230, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100e_4233, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100e_4236, 4); cmp(ax, memw[ds, edx + 0x26]);          /* cmp ax, [edx+0x26] */
            ii(0x100e_423a, 2); if(jge(0x100e_4246, 0xa)) goto l_0x100e_4246; /* jge 0x100e4246 */
            ii(0x100e_423c, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
        ...
        l_0x100e_4246:
            ii(0x100e_4246, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x100e_424d, 2); jmp(0x100e_4255, 0x6); goto l_0x100e_4255; /* jmp 0x100e4255 */
        l_0x100e_424f:
            ii(0x100e_424f, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100e_4252, 3); inc(memd[ss, ebp - 0x10]);              /* inc dword [ebp-0x10] */
        l_0x100e_4255:
            ii(0x100e_4255, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100e_4258, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100e_425b, 4); cmp(ax, memw[ds, edx + 0x28]);          /* cmp ax, [edx+0x28] */
            ii(0x100e_425f, 2); if(jge(0x100e_42b5, 0x54)) goto l_0x100e_42b5; /* jge 0x100e42b5 */
            ii(0x100e_4261, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100e_4263, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ...
            ii(0x100e_4271, 3); mov(bl, memb[ss, ebp - 0x4]);           /* mov bl, [ebp-0x4] */
            ii(0x100e_4274, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100e_4276, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x100e_427a, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100e_427d, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x100e_4280, 3); mov(eax, memd[ds, eax + 0x2c]);         /* mov eax, [eax+0x2c] */
        ...
        l_0x100e_428a:
            ...
            ii(0x100e_428c, 3); mov(bl, memb[ss, ebp - 0x4]);           /* mov bl, [ebp-0x4] */
            ii(0x100e_428f, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x100e_4292, 5); call(0x1007_63d4, -0x6_dec3);           /* call 0x100763d4 */
            ii(0x100e_4297, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100e_4299, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x100e_429d, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100e_42a0, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x100e_42a3, 3); mov(eax, memd[ds, eax + 0x2c]);         /* mov eax, [eax+0x2c] */
            ii(0x100e_42a6, 5); call(0x100e_15b6, -0x2cf5);             /* call 0x100e15b6 */
            ii(0x100e_42ab, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
        ...
        l_0x100e_42b5:
            ii(0x100e_42b5, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_42b8, 3); mov(eax, memd[ds, eax + 0x28]);         /* mov eax, [eax+0x28] */
            ...
            ii(0x100e_42c4, 3); mov(dl, memb[ss, ebp - 0x4]);           /* mov dl, [ebp-0x4] */
            ii(0x100e_42c7, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_42ca, 5); call(0x100e_3e05, -0x4ca);              /* call 0x100e3e05 */
        l_0x100e_42cf:
            ii(0x100e_42cf, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100e_42d1, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
