...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_4f75()
        {
            ...
            ii(0x1019_4f82, 5); mov(eax, 2);                            /* mov eax, 0x2 */
            ii(0x1019_4f87, 4); lfs(edi, memd[ss, ebp + 16]);           /* lfs edi, [ebp+0x10] */
            ii(0x1019_4f8b, 3); call_far_ind(memd[ss, ebp + 8]);        /* call far dword [ebp+0x8] */
            ii(0x1019_4f8e, 1); pushd(ds);                              /* push ds */
            ii(0x1019_4f8f, 3); les(edi, memd[ss, ebp + 24]);           /* les edi, [ebp+0x18] */
            ii(0x1019_4f92, 3); lds(esi, memd[ss, ebp + 16]);           /* lds esi, [ebp+0x10] */
            ...
            ii(0x1019_4f9f, 3); les(edi, memd[ss, ebp + 24]);           /* les edi, [ebp+0x18] */
            ii(0x1019_4fa2, 5); mov(memw[es, edi + 68], ds);            /* mov [es:edi+0x44], ds */
            ii(0x1019_4fa7, 5); mov(memw[es, edi + 76], ds);            /* mov [es:edi+0x4c], ds */
            ii(0x1019_4fac, 5); mov(memw[es, edi + 84], ds);            /* mov [es:edi+0x54], ds */
            ii(0x1019_4fb1, 5); mov(memw[es, edi + 92], ds);            /* mov [es:edi+0x5c], ds */
