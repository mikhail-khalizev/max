...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_7690()
        {
            ...
            ii(0x100b_76a7, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100b_76aa, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x100b_76ad, 7); test(memd[ss, ebp - 4], 4);             /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x100b_76bb, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
        ...
        l_0x100b_76ca:
            ...
            ii(0x100b_76cc, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_76da, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100b_76dd, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_76df, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_76ed, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100b_76f0, 5); mov(edx, 1);                            /* mov edx, 0x1 */
            ii(0x100b_76f5, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100b_76f8, 5); call(0x100a_284c, -0x1_4eb1);           /* call 0x100a284c */
            ii(0x100b_76fd, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100b_7700, 7); test(memd[ss, ebp - 4], 2);             /* test dword [ebp-0x4], 0x2 */
            ii(0x100b_7707, 2); if(jz(0x100b_7711, 8)) goto l_0x100b_7711; /* jz 0x100b7711 */
            ii(0x100b_7709, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100b_770c, 5); call(Definitions.sys_delete, 0xa_e853); /* call 0x10165f64 */
        l_0x100b_7711:
            ii(0x100b_7711, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100b_7714, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100b_7717, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
