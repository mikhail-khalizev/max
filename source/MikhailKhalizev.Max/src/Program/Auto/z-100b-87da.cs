...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_87da()
        {
            ...
            ii(0x100b_87f1, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_87f4, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100b_87f7, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x100b_87fe, 2); jmp(0x100b_8806, 0x6); goto l_0x100b_8806; /* jmp 0x100b8806 */
        l_0x100b_8800:
            ii(0x100b_8800, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100b_8803, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x100b_8806:
            ii(0x100b_8806, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_8809, 5); call(0x1008_a4a0, -0x2_e36e);           /* call 0x1008a4a0 */
            ii(0x100b_880e, 4); cmp(ax, memw[ss, ebp - 0xc]);           /* cmp ax, [ebp-0xc] */
            ii(0x100b_8812, 2); if(jle(0x100b_8840, 0x2c)) goto l_0x100b_8840; /* jle 0x100b8840 */
            ii(0x100b_8814, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100b_8818, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_881b, 5); call(0x1008_a3dc, -0x2_e444);           /* call 0x1008a3dc */
            ii(0x100b_8820, 3); mov(ax, memw[ds, eax]);                 /* mov ax, [eax] */
            ii(0x100b_8823, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ii(0x100b_8827, 2); if(jnz(0x100b_883e, 0x15)) goto l_0x100b_883e; /* jnz 0x100b883e */
            ii(0x100b_8829, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100b_882d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_8830, 5); call(0x1008_a3dc, -0x2_e459);           /* call 0x1008a3dc */
            ii(0x100b_8835, 4); mov(ax, memw[ds, eax + 0x2]);           /* mov ax, [eax+0x2] */
            ii(0x100b_8839, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100b_883c, 2); jmp(0x100b_8847, 0x9); goto l_0x100b_8847; /* jmp 0x100b8847 */
        l_0x100b_883e:
            ii(0x100b_883e, 2); jmp(0x100b_8800, -0x40); goto l_0x100b_8800; /* jmp 0x100b8800 */
        l_0x100b_8840:
            ii(0x100b_8840, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
        l_0x100b_8847:
            ii(0x100b_8847, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
