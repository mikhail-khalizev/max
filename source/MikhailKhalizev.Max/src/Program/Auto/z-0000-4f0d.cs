...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_4f0d()
        {
            ...
            ii(0x4f13, 3);    push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
        ...
        l_0x4f2f:
            ...
            ii(0x4f3e, 2);    if(jnz(0x4f44, 0x4)) goto l_0x4f44;       /* jnz 0x4f44 */
            ii(0x4f40, 4);    mov(memw[ds, 0x11f8], bx);                /* mov [0x11f8], bx */
        l_0x4f44:
            ii(0x4f44, 3);    dec(memw[ss, bp - 0x2]);                  /* dec word [bp-0x2] */
