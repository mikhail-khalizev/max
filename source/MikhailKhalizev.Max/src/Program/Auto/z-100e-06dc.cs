...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("2e5c657a-dfdc-40d4-8d37-bc1fe0b9bc34")]
        public void Method_100e_06dc()
        {
            ii(0x100e_06dc, 5); pushd(0x28);                            /* push 0x28 */
            ii(0x100e_06e1, 5); calld(Definitions.sys_check_available_stack_size, 0x8566c); /* call 0x10165d52 */
            ...
            ii(0x100e_06ff, 5); calld(0x1013_ac03, 0x5a4ff);            /* call 0x1013ac03 */
            ...
            ii(0x100e_071d, 1); retd(); return;                         /* ret */
        }
    }
}
