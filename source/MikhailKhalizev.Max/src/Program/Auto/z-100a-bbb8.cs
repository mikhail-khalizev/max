...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_bbb8()
        {
            ...
            ii(0x100a_bbcd, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100a_bbd0, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x100a_bbd3, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x100a_bbd6, 3); mov(memb[ss, ebp - 0x4], cl);           /* mov [ebp-0x4], cl */
            ii(0x100a_bbd9, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x100a_bbdb, 3); mov(edx, memd[ss, ebp - 0x10]);         /* mov edx, [ebp-0x10] */
            ii(0x100a_bbde, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x100a_bbf5, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ii(0x100a_bbf8, 1); push(eax);                              /* push eax */
            ii(0x100a_bbf9, 3); mov(ecx, memd[ss, ebp - 0x8]);          /* mov ecx, [ebp-0x8] */
            ii(0x100a_bbfc, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x100a_bbff, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x100a_bc02, 5); call(0x1007_5e64, -0x3_5da3);           /* call 0x10075e64 */
            ii(0x100a_bc07, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x100a_bc09, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x100a_bc16, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100a_bc19, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x100a_bc1c, 5); call(0x1008_af84, -0x2_0c9d);           /* call 0x1008af84 */
            ii(0x100a_bc21, 3); mov(esi, memd[ss, ebp - 0x10]);         /* mov esi, [ebp-0x10] */
            ii(0x100a_bc24, 3); call_abs(memd[ds, esi + 0x17]);         /* call dword [esi+0x17] */
            ii(0x100a_bc27, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_bc29, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x100a_bc36, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100a_bc39, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x100a_bc3c, 5); call(0x1008_afe4, -0x2_0c5d);           /* call 0x1008afe4 */
            ii(0x100a_bc41, 3); mov(edx, memd[ss, ebp - 0x10]);         /* mov edx, [ebp-0x10] */
