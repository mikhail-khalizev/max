...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_9729()
        {
            ...
            ii(0x100c_9740, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_9743, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100c_9746, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_9749, 3); mov(edx, memd[ds, eax + 0x11]);         /* mov edx, [eax+0x11] */
            ...
            ii(0x100c_9760, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100c_976a:
            ii(0x100c_976a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_976d, 3); mov(eax, memd[ds, eax + 0x13]);         /* mov eax, [eax+0x13] */
            ii(0x100c_9770, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100c_9773, 1); inc(eax);                               /* inc eax */
            ii(0x100c_9774, 1); push(eax);                              /* push eax */
            ii(0x100c_9775, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_9778, 3); mov(eax, memd[ds, eax + 0x11]);         /* mov eax, [eax+0x11] */
            ...
            ii(0x100c_9786, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100c_9792:
            ii(0x100c_9792, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_9795, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100c_9798, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
