...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_fa7c()
        {
            ...
            ii(0x100c_fa92, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100c_fa95, 3); mov(memb[ss, ebp - 0x8], dl);           /* mov [ebp-0x8], dl */
            ii(0x100c_fa98, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ii(0x100c_fa9b, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x100c_fa9d, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ...
            ii(0x100c_faad, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
        ...
        l_0x100c_fab7:
            ii(0x100c_fab7, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100c_faba, 4); cmp(memb[ds, eax + 0x28], 0);           /* cmp byte [eax+0x28], 0x0 */
            ii(0x100c_fabe, 2); if(jnz(0x100c_faff, 0x3f)) goto l_0x100c_faff; /* jnz 0x100cfaff */
            ii(0x100c_fac0, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100c_fac8, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
        ...
        l_0x100c_faf8:
            ii(0x100c_faf8, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100c_fafb, 4); mov(memb[ds, eax + 0x28], 0x1);         /* mov byte [eax+0x28], 0x1 */
        l_0x100c_faff:
