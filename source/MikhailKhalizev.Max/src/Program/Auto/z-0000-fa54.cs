...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_fa54()
        {
            ...
            ii(0xfa57, 2);    push(0x8);                                /* push 0x8 */
            ii(0xfa59, 1);    pop(ds);                                  /* pop ds */
            ii(0xfa5a, 1);    pushfw();                                 /* pushfw */
            ii(0xfa5b, 1);    cli();                                    /* cli */
            ii(0xfa5c, 3);    mov(bx, memw[ss, bp + 0x4]);              /* mov bx, [bp+0x4] */
            ii(0xfa5f, 3);    and(bl, 0xf8);                            /* and bl, 0xf8 */
            ii(0xfa62, 3);    mov(ax, memw[ss, bp + 0xa]);              /* mov ax, [bp+0xa] */
            ii(0xfa65, 2);    mov(memw[ds, bx], ax);                    /* mov [bx], ax */
            ii(0xfa67, 3);    mov(al, memb[ss, bp + 0xc]);              /* mov al, [bp+0xc] */
            ii(0xfa6a, 3);    mov(memb[ds, bx + 0x5], al);              /* mov [bx+0x5], al */
            ii(0xfa6d, 3);    mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0xfa70, 3);    mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ii(0xfa73, 3);    mov(cx, 0x4);                             /* mov cx, 0x4 */
        l_0xfa76:
            ii(0xfa76, 2);    shl(ax, 0x1);                             /* shl ax, 1 */
            ii(0xfa78, 2);    rcl(dx, 0x1);                             /* rcl dx, 1 */
            ii(0xfa7a, 2);    if(loop(0xfa76, -0x6)) goto l_0xfa76;     /* loop 0xfa76 */
            ii(0xfa7c, 3);    mov(memw[ds, bx + 0x2], ax);              /* mov [bx+0x2], ax */
            ii(0xfa7f, 3);    mov(memb[ds, bx + 0x4], dl);              /* mov [bx+0x4], dl */
            ii(0xfa82, 3);    mov(memb[ds, bx + 0x7], dh);              /* mov [bx+0x7], dh */
