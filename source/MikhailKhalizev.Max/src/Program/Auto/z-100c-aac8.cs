...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("812f5cfe-323b-480e-8420-72c6b633716b")]
        public void Method_100c_aac8()
        {
            ii(0x100c_aac8, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x100c_aacd, 5); calld(Definitions.sys_check_available_stack_size, 0x9b280); /* call 0x10165d52 */
            ...
            ii(0x100c_aae6, 5); calld(0x1008_b410, -0x3f6db);           /* call 0x1008b410 */
            ii(0x100c_aaeb, 3); add(eax, 0x6);                          /* add eax, 0x6 */
            ii(0x100c_aaee, 5); calld(0x1009_cb94, -0x2df5f);           /* call 0x1009cb94 */
