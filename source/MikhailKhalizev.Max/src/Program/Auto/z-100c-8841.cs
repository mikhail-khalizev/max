...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_8841()
        {
            ...
            ii(0x100c_8853, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100c_8859, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100c_885c, 4); mov(memb[ss, ebp - 8], 0x16);           /* mov byte [ebp-0x8], 0x16 */
            ii(0x100c_8860, 3); mov(al, memb[ss, ebp - 8]);             /* mov al, [ebp-0x8] */
