...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_25ae()
        {
            ...
            ii(0x1012_268a, 4); mov(memb[ss, ebp - 0xc], 4);            /* mov byte [ebp-0xc], 0x4 */
        ...
        l_0x1012_2690:
            ...
            ii(0x1012_2699, 4); mov(memb[ss, ebp - 0xc], 2);            /* mov byte [ebp-0xc], 0x2 */
            ii(0x1012_269d, 2); jmp(0x1012_26a3, 4); goto l_0x1012_26a3; /* jmp 0x101226a3 */
        l_0x1012_269f:
            ii(0x1012_269f, 4); mov(memb[ss, ebp - 0xc], 3);            /* mov byte [ebp-0xc], 0x3 */
        l_0x1012_26a3:
