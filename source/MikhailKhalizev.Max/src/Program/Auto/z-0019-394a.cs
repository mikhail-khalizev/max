...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_394a()
        {
            ...
            ii(0x19_3950, 3);  les(di, memw[ss, bp + 6]);              /* les di, [bp+0x6] */
            ii(0x19_3953, 3);  lds(si, memw[ss, bp + 10]);             /* lds si, [bp+0xa] */
            ii(0x19_3956, 2);  mov(bx, di);                            /* mov bx, di */
            ii(0x19_3958, 3);  mov(cx, memw[ss, bp + 14]);             /* mov cx, [bp+0xe] */
        ...
        l_0x19_395d:
            ...
            ii(0x19_3960, 2);  if(jz(0x19_3965, 3)) goto l_0x19_3965;  /* jz 0x3965 */
            ii(0x19_3962, 1);  stosb();                                /* stosb */
            ii(0x19_3963, 2);  if(loop(0x19_395d, -8)) goto l_0x19_395d;/* loop 0x395d */
        l_0x19_3965:
