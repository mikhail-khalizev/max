...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_1f8e()
        {
            ...
            ii(0x1017_1f9a, 2); if(jnz(0x1017_1fa5, 0x9)) goto l_0x1017_1fa5; /* jnz 0x10171fa5 */
        ...
        l_0x1017_1fa5:
            ii(0x1017_1fa5, 3); mov(ebx, memd[ds, edx + 0x4]);          /* mov ebx, [edx+0x4] */
            ii(0x1017_1fa8, 2); mov(ecx, memd[ds, edx]);                /* mov ecx, [edx] */
            ii(0x1017_1faa, 1); dec(ebx);                               /* dec ebx */
            ii(0x1017_1fab, 1); inc(ecx);                               /* inc ecx */
            ii(0x1017_1fac, 3); mov(memd[ds, edx + 0x4], ebx);          /* mov [edx+0x4], ebx */
            ii(0x1017_1faf, 2); mov(memd[ds, edx], ecx);                /* mov [edx], ecx */
            ii(0x1017_1fb1, 3); mov(al, memb[ds, ecx - 0x1]);           /* mov al, [ecx-0x1] */
