...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("c7987a7b-4e22-4434-b41a-0c24d39abb28")]
        public void Method_1010_8794()
        {
            ii(0x1010_8794, 5); pushd(0x30);                            /* push 0x30 */
            ii(0x1010_8799, 5); calld(Definitions.sys_check_available_stack_size, 0x5d5b4); /* call 0x10165d52 */
            ...
            ii(0x1010_87b1, 5); calld(0x100d_533c, -0x3347a);           /* call 0x100d533c */
            ii(0x1010_87b6, 1); cwde();                                 /* cwde */
            ii(0x1010_87b7, 1); pushd(eax);                             /* push eax */
            ii(0x1010_87b8, 5); calld(0x100d_5360, -0x3345d);           /* call 0x100d5360 */
            ...
            ii(0x1010_87ce, 5); calld(0x100e_883d, -0x1ff96);           /* call 0x100e883d */
            ii(0x1010_87d3, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1010_87d5, 4); movsx(eax, memw_a32[ss, ebp - 0x4]);    /* movsx eax, word [ebp-0x4] */
            ii(0x1010_87d9, 5); calld(0x100e_8c51, -0x1fb8d);           /* call 0x100e8c51 */
            ...
            ii(0x1010_87e5, 5); calld(0x1012_0d94, 0x185aa);            /* call 0x10120d94 */
            ii(0x1010_87ea, 5); calld(/* sys */ 0x1016_bcc4, 0x634d5);  /* call 0x1016bcc4 */
            ii(0x1010_87ef, 5); mov(eax, memd_a32[ds, 0x101c_365c]);    /* mov eax, [0x101c365c] */
            ii(0x1010_87f4, 5); calld(Definitions.sys_display_apply_palette, 0x643c3); /* call 0x1016cbbc */
            ii(0x1010_87f9, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1010_87fb, 5); calld(0x100e_883d, -0x1ffc3);           /* call 0x100e883d */
            ii(0x1010_8800, 3); mov(eax, memd_a32[ds, eax + 0x12]);     /* mov eax, [eax+0x12] */
            ii(0x1010_8803, 5); calld(Definitions.sys_display_draw_0, 0x5ec7c); /* call 0x10167484 */
            ii(0x1010_8808, 5); mov(eax, 0x1f4);                        /* mov eax, 0x1f4 */
            ii(0x1010_880d, 5); calld(0x100e_9399, -0x1f479);           /* call 0x100e9399 */
            ii(0x1010_8812, 5); calld(0x1014_82f4, 0x3fadd);            /* call 0x101482f4 */
            ii(0x1010_8817, 3); mov(memd_a32[ss, ebp - 0xc], eax);      /* mov [ebp-0xc], eax */
        l_0x1010_881a:
            ii(0x1010_881a, 3); mov(eax, memd_a32[ss, ebp - 0xc]);      /* mov eax, [ebp-0xc] */
            ii(0x1010_881d, 5); calld(0x1014_85ad, 0x3fd8b);            /* call 0x101485ad */
            ...
            ii(0x1010_8827, 5); calld(/* sys */ 0x1016_b208, 0x629dc);  /* call 0x1016b208 */
        ...
        l_0x1010_8831:
            ii(0x1010_8831, 5); calld(0x100e_88bd, -0x1ff79);           /* call 0x100e88bd */
        l_0x1010_8836:
