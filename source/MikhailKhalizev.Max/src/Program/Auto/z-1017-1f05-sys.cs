...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_1f05()
        {
            ...
            ii(0x1017_1f0b, 4); test(memb[ds, eax + 0xc], 0x1);         /* test byte [eax+0xc], 0x1 */
        ...
        l_0x1017_1f2b:
            ii(0x1017_1f2b, 3); mov(ebx, memd[ds, edx + 0x4]);          /* mov ebx, [edx+0x4] */
            ii(0x1017_1f2e, 1); dec(ebx);                               /* dec ebx */
            ii(0x1017_1f2f, 3); mov(memd[ds, edx + 0x4], ebx);          /* mov [edx+0x4], ebx */
            ii(0x1017_1f32, 2); test(ebx, ebx);                         /* test ebx, ebx */
            ii(0x1017_1f34, 2); if(jge(0x1017_1f3f, 0x9)) goto l_0x1017_1f3f; /* jge 0x10171f3f */
        ...
        l_0x1017_1f4b:
            ...
            ii(0x1017_1f56, 3); mov(esi, memd[ds, edx + 0x4]);          /* mov esi, [edx+0x4] */
            ii(0x1017_1f59, 1); dec(esi);                               /* dec esi */
            ii(0x1017_1f5a, 3); mov(memd[ds, edx + 0x4], esi);          /* mov [edx+0x4], esi */
            ii(0x1017_1f5d, 2); test(esi, esi);                         /* test esi, esi */
            ii(0x1017_1f5f, 2); if(jge(0x1017_1f6a, 0x9)) goto l_0x1017_1f6a; /* jge 0x10171f6a */
