...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("f4316a60-7e3b-4b6a-8f6a-fc8233f6a132")]
        public void Method_0000_6101()
        {
            ...
            ii(0x610b, 2);    if(jnzw(0x6132, 0x25)) goto l_0x6132;     /* jnz 0x68e2 */
        ...
        l_0x6118:
            ...
            ii(0x612e, 2);    if(jnsw(0x6118, -0x18)) goto l_0x6118;    /* jns 0x68c8 */
            ii(0x6130, 1);    popw(cx);                                 /* pop cx */
            ii(0x6131, 1);    retw(); return;                           /* ret */
        l_0x6132:
            ii(0x6132, 3);    mov(ax, 0xdf01);                          /* mov ax, 0xdf01 */
            ii(0x6135, 2);    jmpw(0x6110, -0x27); goto l_0x6110;       /* jmp 0x68c0 */
        }
    }
}
