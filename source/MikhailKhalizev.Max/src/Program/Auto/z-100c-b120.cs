...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_b120()
        {
            ...
            ii(0x100c_b132, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x100c_b138, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_b13b, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_b13e, 5);  call(0x1007_6c30, -0x5_4513);         /* call 0x10076c30 */
            ii(0x100c_b143, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_b146, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
