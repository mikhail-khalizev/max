...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_5920()
        {
            ...
            ii(0x1012_5963, 2); if(jbe(0x1012_596e, 0x9)) goto l_0x1012_596e; /* jbe 0x1012596e */
            ii(0x1012_5965, 7); cmp(memb[ds, 0x101c_59c9], 0);          /* cmp byte [0x101c59c9], 0x0 */
            ii(0x1012_596c, 2); if(jnz(0x1012_5970, 0x2)) goto l_0x1012_5970; /* jnz 0x10125970 */
        l_0x1012_596e:
            ii(0x1012_596e, 2); jmp(0x1012_5975, 0x5); goto l_0x1012_5975; /* jmp 0x10125975 */
        l_0x1012_5970:
            ii(0x1012_5970, 5); call(0x1012_5807, -0x16e);              /* call 0x10125807 */
        l_0x1012_5975:
            ii(0x1012_5975, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
        ...
        l_0x1012_5981:
            ...
            ii(0x1012_59ad, 3); mov(memb[ss, ebp - 0x4], al);           /* mov [ebp-0x4], al */
        ...
        l_0x1012_59d5:
            ...
            ii(0x1012_59d7, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
        ...
        l_0x1012_59ec:
            ii(0x1012_59ec, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ...
            ii(0x1012_59f7, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ii(0x1012_59fa, 5); mov(memb[ds, 0x101c_5634], al);         /* mov [0x101c5634], al */
            ii(0x1012_59ff, 7); mov(memb[ds, 0x101c_5631], 0x1);        /* mov byte [0x101c5631], 0x1 */
            ii(0x1012_5a06, 2); jmp(0x1012_5a0d, 0x5); goto l_0x1012_5a0d; /* jmp 0x10125a0d */
        l_0x1012_5a08:
        ...
        l_0x1012_5a12:
            ...
            ii(0x1012_5a14, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ii(0x1012_5a17, 6); mov(memw[ds, 0x101c_5635], ax);         /* mov [0x101c5635], ax */
            ii(0x1012_5a1d, 7); mov(memb[ds, 0x101c_5631], 0x2);        /* mov byte [0x101c5631], 0x2 */
            ii(0x1012_5a24, 5); jmp(0x1012_5bc7, 0x19e); goto l_0x1012_5bc7; /* jmp 0x10125bc7 */
        l_0x1012_5a29:
            ii(0x1012_5a29, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1012_5a2b, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ...
            ii(0x1012_5a59, 7); mov(memb[ds, 0x101c_5631], 0x3);        /* mov byte [0x101c5631], 0x3 */
            ii(0x1012_5a60, 2); jmp(0x1012_5a67, 0x5); goto l_0x1012_5a67; /* jmp 0x10125a67 */
        l_0x1012_5a62:
        ...
        l_0x1012_5a6c:
            ...
            ii(0x1012_5a9e, 2); if(jnz(0x1012_5aa7, 0x7)) goto l_0x1012_5aa7; /* jnz 0x10125aa7 */
            ii(0x1012_5aa0, 7); mov(memb[ds, 0x101c_5631], 0x4);        /* mov byte [0x101c5631], 0x4 */
        l_0x1012_5aa7:
            ii(0x1012_5aa7, 5); jmp(0x1012_5bc7, 0x11b); goto l_0x1012_5bc7; /* jmp 0x10125bc7 */
        l_0x1012_5aac:
            ii(0x1012_5aac, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1012_5aae, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ii(0x1012_5ab1, 6); mov(memw[ds, 0x101c_5862], ax);         /* mov [0x101c5862], ax */
            ii(0x1012_5ab7, 7); mov(memb[ds, 0x101c_5631], 0x5);        /* mov byte [0x101c5631], 0x5 */
            ii(0x1012_5abe, 5); jmp(0x1012_5bc7, 0x104); goto l_0x1012_5bc7; /* jmp 0x10125bc7 */
        l_0x1012_5ac3:
            ii(0x1012_5ac3, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1012_5ac5, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
        ...
        l_0x1012_5b03:
            ...
            ii(0x1012_5b1d, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
        ...
        l_0x1012_5b29:
            ...
            ii(0x1012_5b4f, 7); mov(memd[ss, ebp - 0x8], 0x1);          /* mov dword [ebp-0x8], 0x1 */
            ii(0x1012_5b56, 5); jmp(0x1012_5bdd, 0x82); goto l_0x1012_5bdd; /* jmp 0x10125bdd */
        l_0x1012_5b5b:
            ii(0x1012_5b5b, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1012_5b5d, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ...
            ii(0x1012_5b76, 2); if(jnz(0x1012_5b7f, 0x7)) goto l_0x1012_5b7f; /* jnz 0x10125b7f */
            ii(0x1012_5b78, 7); mov(memb[ds, 0x101c_5631], 0x7);        /* mov byte [0x101c5631], 0x7 */
        l_0x1012_5b7f:
            ii(0x1012_5b7f, 2); jmp(0x1012_5b88, 0x7); goto l_0x1012_5b88; /* jmp 0x10125b88 */
        l_0x1012_5b81:
            ii(0x1012_5b81, 7); mov(memb[ds, 0x101c_61a8], 0x4);        /* mov byte [0x101c61a8], 0x4 */
        l_0x1012_5b88:
        ...
        l_0x1012_5bac:
            ...
            ii(0x1012_5bb2, 4); cmp(memb[ss, ebp - 0x10], 0x7);         /* cmp byte [ebp-0x10], 0x7 */
        ...
        l_0x1012_5bcc:
            ...
            ii(0x1012_5bd6, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
        l_0x1012_5bdd:
            ii(0x1012_5bdd, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
