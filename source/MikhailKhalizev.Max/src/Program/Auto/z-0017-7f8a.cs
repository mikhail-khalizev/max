...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x17_7f8a, 4); enter(0x8, 0);                            /* enter 0x8, 0x0 */
            ...
            ii(0x17_7f96, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_7f99, 3); mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ...
            ii(0x17_7fb6, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_7fb9, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x17_7fbc, 4); and(memb[ss, bp - 0x4], -0x2 /* 0xfe */); /* and byte [bp-0x4], 0xfe */
            ii(0x17_7fc0, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_7fc3, 3); mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ...
            ii(0x17_7fde, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x17_7fe1, 3); mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
            ii(0x17_7fe4, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_7fe7, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0x17_8001, 4); mov(eax, memd[ss, bp - 0x8]);             /* mov eax, [bp-0x8] */
