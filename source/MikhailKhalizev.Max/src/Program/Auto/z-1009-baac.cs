...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_baac()
        {
            ...
            ii(0x1009_bac3, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1009_bac6, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1009_bac9, 7); test(memd[ss, ebp - 4], 4);             /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x1009_bad7, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
        ...
        l_0x1009_bae6:
            ...
            ii(0x1009_bae8, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x1009_baf6, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1009_baf9, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_bafb, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x1009_bb09, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1009_bb0c, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_bb0e, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x1009_bb1c, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1009_bb1f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_bb21, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x1009_bb2f, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1009_bb32, 5); mov(edx, 1);                            /* mov edx, 0x1 */
            ii(0x1009_bb37, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1009_bb3a, 5); call(0x1009_b998, -0x1a7);              /* call 0x1009b998 */
            ii(0x1009_bb3f, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1009_bb42, 7); test(memd[ss, ebp - 4], 2);             /* test dword [ebp-0x4], 0x2 */
            ii(0x1009_bb49, 2); if(jz(0x1009_bb53, 8)) goto l_0x1009_bb53; /* jz 0x1009bb53 */
            ii(0x1009_bb4b, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1009_bb4e, 5); call(Definitions.sys_delete, 0xc_a411); /* call 0x10165f64 */
        l_0x1009_bb53:
            ii(0x1009_bb53, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1009_bb56, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1009_bb59, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
