...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_4aa0()
        {
            ...
            ii(0x1016_4ab2, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1016_4ab8, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1016_4abb, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1016_4abe, 5); call(0x1007_6b58, -0xe_df6b);           /* call 0x10076b58 */
            ii(0x1016_4ac3, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1016_4ac6, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
