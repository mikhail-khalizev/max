...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_9840()
        {
            ...
            ii(0x1007_9857, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1007_985a, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1007_985d, 5); mov(edx, StringDefinitions.MaintainAnAttackReserve); /* mov edx, 0x101a0120 */
            ii(0x1007_9862, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1007_9865, 5); call(Definitions.sys_strcpy, 0xe_c665); /* call 0x10165ecf */
            ii(0x1007_986a, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1007_986d, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1007_9870, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
