...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_d67c()
        {
            ...
            ii(0x1016_d6a0, 4); mov(memd[ss, esp + 0x8], edx);          /* mov [esp+0x8], edx */
        l_0x1016_d6a4:
            ...
            ii(0x1016_d6cd, 2); if(jbe(0x1016_d6d8, 0x9)) goto l_0x1016_d6d8; /* jbe 0x1016d6d8 */
            ii(0x1016_d6cf, 2); xor(esi, esi);                          /* xor esi, esi */
            ii(0x1016_d6d1, 4); mov(memd[ss, esp + 0x4], edi);          /* mov [esp+0x4], edi */
        ...
        l_0x1016_d6d8:
            ...
            ii(0x1016_d6e0, 2); if(jbe(0x1016_d6eb, 0x9)) goto l_0x1016_d6eb; /* jbe 0x1016d6eb */
            ii(0x1016_d6e2, 2); xor(ebp, ebp);                          /* xor ebp, ebp */
            ii(0x1016_d6e4, 3); mov(memd[ss, esp], ebp);                /* mov [esp], ebp */
            ii(0x1016_d6e7, 4); mov(memd[ss, esp + 0x4], ebp);          /* mov [esp+0x4], ebp */
        l_0x1016_d6eb:
            ii(0x1016_d6eb, 3); fld(memq[ss, esp]);                     /* fld qword [esp] */
            ii(0x1016_d6ee, 4); mov(edx, memd[ss, esp + 0x8]);          /* mov edx, [esp+0x8] */
            ...
            ii(0x1016_d700, 4); mov(memd[ss, esp + 0x8], edx);          /* mov [esp+0x8], edx */
            ...
            ii(0x1016_d722, 3); ret(0x8);                               /* ret 0x8 */
        }
    }
}
