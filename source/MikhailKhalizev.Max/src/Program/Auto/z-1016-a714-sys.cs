...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_a714()
        {
            ...
            ii(0x1016_a717, 3); sub(esp, 4);                            /* sub esp, 0x4 */
            ...
            ii(0x1016_a723, 4); mov(edx, memd[ss, esp + 28]);           /* mov edx, [esp+0x1c] */
            ii(0x1016_a727, 1); push(edx);                              /* push edx */
            ii(0x1016_a728, 1); push(ecx);                              /* push ecx */
            ii(0x1016_a729, 4); mov(ebx, memd[ss, esp + 28]);           /* mov ebx, [esp+0x1c] */
            ii(0x1016_a72d, 1); push(ebx);                              /* push ebx */
            ii(0x1016_a72e, 2); mov(edx, esi);                          /* mov edx, esi */
            ii(0x1016_a730, 4); mov(ebx, memd[ss, esp + 12]);           /* mov ebx, [esp+0xc] */
            ii(0x1016_a734, 5); call(/* sys */ 0x1016_a5a0, -0x199);    /* call 0x1016a5a0 */
            ii(0x1016_a739, 4); mov(ecx, memd[ss, esp + 32]);           /* mov ecx, [esp+0x20] */
            ii(0x1016_a73d, 1); push(ecx);                              /* push ecx */
            ii(0x1016_a73e, 4); mov(eax, memd[ss, esp + 28]);           /* mov eax, [esp+0x1c] */
            ii(0x1016_a742, 4); mov(edx, memd[ss, esp + 24]);           /* mov edx, [esp+0x18] */
            ii(0x1016_a746, 1); push(eax);                              /* push eax */
            ii(0x1016_a747, 4); mov(ebx, memd[ss, esp + 8]);            /* mov ebx, [esp+0x8] */
            ...
            ii(0x1016_a757, 4); mov(ebx, memd[ss, esp + 28]);           /* mov ebx, [esp+0x1c] */
            ii(0x1016_a75b, 1); push(ebx);                              /* push ebx */
            ii(0x1016_a75c, 4); mov(ecx, memd[ss, esp + 28]);           /* mov ecx, [esp+0x1c] */
            ii(0x1016_a760, 4); mov(eax, memd[ss, esp + 4]);            /* mov eax, [esp+0x4] */
            ...
            ii(0x1016_a773, 4); mov(edx, memd[ss, esp + 32]);           /* mov edx, [esp+0x20] */
            ii(0x1016_a777, 1); push(edx);                              /* push edx */
            ii(0x1016_a778, 4); mov(ebx, memd[ss, esp + 28]);           /* mov ebx, [esp+0x1c] */
            ii(0x1016_a77c, 4); mov(ecx, memd[ss, esp + 24]);           /* mov ecx, [esp+0x18] */
