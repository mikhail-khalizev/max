...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_de44()
        {
            ...
            ii(0x1013_de64, 7); cmp(memd[ds, eax + 3493], 0);           /* cmp dword [eax+0xda5], 0x0 */
            ...
            ii(0x1013_de70, 6); mov(eax, memd[ds, eax + 3493]);         /* mov eax, [eax+0xda5] */
        ...
        l_0x1013_de83:
            ...
            ii(0x1013_de86, 6); mov(edx, memd[ds, eax + 3493]);         /* mov edx, [eax+0xda5] */
            ii(0x1013_de8c, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_de8f, 4); mov(ax, memw[ds, eax + 26]);            /* mov ax, [eax+0x1a] */
            ii(0x1013_de93, 4); mov(memw[ds, edx + 7], ax);             /* mov [edx+0x7], ax */
            ii(0x1013_de97, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_de9a, 6); mov(edx, memd[ds, eax + 3493]);         /* mov edx, [eax+0xda5] */
            ii(0x1013_dea0, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_dea3, 4); mov(ax, memw[ds, eax + 28]);            /* mov ax, [eax+0x1c] */
            ...
            ii(0x1013_dec0, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ...
            ii(0x1013_ded8, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1013_dedb, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_dede, 6); mov(eax, memd[ds, eax + 3493]);         /* mov eax, [eax+0xda5] */
            ii(0x1013_dee4, 4); mov(ax, memw[ds, eax + 7]);             /* mov ax, [eax+0x7] */
            ii(0x1013_dee8, 3); sub(eax, memd[ss, ebp - 28]);           /* sub eax, [ebp-0x1c] */
            ii(0x1013_deeb, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1013_deee, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x1013_def2, 5); call(/* sys */ 0x1016_5df8, 0x2_7f01);  /* call 0x10165df8 */
            ii(0x1013_def7, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x1013_defa, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_defd, 6); mov(eax, memd[ds, eax + 3493]);         /* mov eax, [eax+0xda5] */
            ii(0x1013_df03, 3); mov(edx, memd[ds, eax + 7]);            /* mov edx, [eax+0x7] */
            ii(0x1013_df06, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1013_df09, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x1013_df16, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1013_df19, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x1013_df1d, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1013_df1f, 2); if(jge(0x1013_df27, 6)) goto l_0x1013_df27; /* jge 0x1013df27 */
            ii(0x1013_df21, 4); mov(memb[ss, ebp - 36], 1);             /* mov byte [ebp-0x24], 0x1 */
            ii(0x1013_df25, 2); jmp(0x1013_df2b, 4); goto l_0x1013_df2b; /* jmp 0x1013df2b */
        l_0x1013_df27:
            ii(0x1013_df27, 4); mov(memb[ss, ebp - 36], 0);             /* mov byte [ebp-0x24], 0x0 */
        l_0x1013_df2b:
            ii(0x1013_df2b, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_df2d, 3); mov(dl, memb[ss, ebp - 36]);            /* mov dl, [ebp-0x24] */
            ii(0x1013_df30, 4); movsx(eax, memw[ss, ebp - 24]);         /* movsx eax, word [ebp-0x18] */
            ...
            ii(0x1013_df3e, 6); mov(eax, memd[ds, edx + 3493]);         /* mov eax, [edx+0xda5] */
            ii(0x1013_df44, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1013_df46, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1013_df49, 3); mov(ecx, memd[ds, edx + 28]);           /* mov ecx, [edx+0x1c] */
            ...
            ii(0x1013_df58, 6); mov(ebx, memd[ds, ebx + 3493]);         /* mov ebx, [ebx+0xda5] */
            ii(0x1013_df5e, 4); movsx(edx, memw[ss, ebp - 20]);         /* movsx edx, word [ebp-0x14] */
            ii(0x1013_df62, 4); movsx(eax, memw[ss, ebp - 24]);         /* movsx eax, word [ebp-0x18] */
            ii(0x1013_df66, 5); call(0x1007_6e7c, -0xc_70ef);           /* call 0x10076e7c */
            ii(0x1013_df6b, 7); imul(eax, memd[ds, ebx + 131]);         /* imul eax, [ebx+0x83] */
            ...
            ii(0x1013_df7e, 6); mov(edx, memd[ds, edx + 3493]);         /* mov edx, [edx+0xda5] */
            ii(0x1013_df84, 6); mov(edx, memd[ds, edx + 131]);          /* mov edx, [edx+0x83] */
            ii(0x1013_df8a, 2); sub(edx, eax);                          /* sub edx, eax */
            ii(0x1013_df8c, 3); mov(memd[ss, ebp - 32], edx);           /* mov [ebp-0x20], edx */
            ii(0x1013_df8f, 5); mov(eax, 0x37);                         /* mov eax, 0x37 */
            ii(0x1013_df94, 5); call(0x1007_5fdc, -0xc_7fbd);           /* call 0x10075fdc */
            ii(0x1013_df99, 3); mov(edx, memd[ss, ebp - 32]);           /* mov edx, [ebp-0x20] */
            ...
            ii(0x1013_dfab, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
            ii(0x1013_dfae, 3); mov(ebx, memd[ss, ebp - 32]);           /* mov ebx, [ebp-0x20] */
            ii(0x1013_dfb1, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1013_dfb4, 6); mov(eax, memd[ds, edx + 3493]);         /* mov eax, [edx+0xda5] */
            ii(0x1013_dfba, 2); mov(ecx, memd[ds, eax]);                /* mov ecx, [eax] */
            ii(0x1013_dfbc, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1013_dfbf, 3); mov(eax, memd[ds, edx + 28]);           /* mov eax, [edx+0x1c] */
