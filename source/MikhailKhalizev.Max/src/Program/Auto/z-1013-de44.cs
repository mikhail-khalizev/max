...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_de44()
        {
            ...
            ii(0x1013_de5b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_de5e, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_de61, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1013_de6d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_de70, 6); mov(eax, memd[ds, eax + 0xda5]);        /* mov eax, [eax+0xda5] */
            ii(0x1013_de76, 6); cmp(memd[ds, eax], 0xffff);             /* cmp dword [eax], 0xffff */
            ii(0x1013_de7c, 2); if(jnz(0x1013_de83, 0x5)) goto l_0x1013_de83; /* jnz 0x1013de83 */
        l_0x1013_de7e:
            ii(0x1013_de7e, 5); jmp(0x1013_dfc9, 0x146); goto l_0x1013_dfc9; /* jmp 0x1013dfc9 */
        l_0x1013_de83:
            ii(0x1013_de83, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_de86, 6); mov(edx, memd[ds, eax + 0xda5]);        /* mov edx, [eax+0xda5] */
            ii(0x1013_de8c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_de8f, 4); mov(ax, memw[ds, eax + 0x1a]);          /* mov ax, [eax+0x1a] */
            ii(0x1013_de93, 4); mov(memw[ds, edx + 0x7], ax);           /* mov [edx+0x7], ax */
            ii(0x1013_de97, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_de9a, 6); mov(edx, memd[ds, eax + 0xda5]);        /* mov edx, [eax+0xda5] */
            ii(0x1013_dea0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_dea3, 4); mov(ax, memw[ds, eax + 0x1c]);          /* mov ax, [eax+0x1c] */
            ii(0x1013_dea7, 4); mov(memw[ds, edx + 0x9], ax);           /* mov [edx+0x9], ax */
            ...
            ii(0x1013_dedb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_dede, 6); mov(eax, memd[ds, eax + 0xda5]);        /* mov eax, [eax+0xda5] */
            ii(0x1013_dee4, 4); mov(ax, memw[ds, eax + 0x7]);           /* mov ax, [eax+0x7] */
            ...
            ii(0x1013_defa, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_defd, 6); mov(eax, memd[ds, eax + 0xda5]);        /* mov eax, [eax+0xda5] */
            ii(0x1013_df03, 3); mov(edx, memd[ds, eax + 0x7]);          /* mov edx, [eax+0x7] */
            ...
            ii(0x1013_df1f, 2); if(jge(0x1013_df27, 0x6)) goto l_0x1013_df27; /* jge 0x1013df27 */
            ii(0x1013_df21, 4); mov(memb[ss, ebp - 0x24], 0x1);         /* mov byte [ebp-0x24], 0x1 */
            ii(0x1013_df25, 2); jmp(0x1013_df2b, 0x4); goto l_0x1013_df2b; /* jmp 0x1013df2b */
        l_0x1013_df27:
        ...
        l_0x1013_df2b:
            ...
            ii(0x1013_df3b, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1013_df3e, 6); mov(eax, memd[ds, edx + 0xda5]);        /* mov eax, [edx+0xda5] */
            ii(0x1013_df44, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1013_df46, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x1013_df55, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ...
            ii(0x1013_df7b, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x1013_dfb1, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1013_dfb4, 6); mov(eax, memd[ds, edx + 0xda5]);        /* mov eax, [edx+0xda5] */
            ii(0x1013_dfba, 2); mov(ecx, memd[ds, eax]);                /* mov ecx, [eax] */
            ii(0x1013_dfbc, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
