...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_b688()
        {
            ...
            ii(0x1013_b69f, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_b6a2, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_b6a5, 7); test(memd[ss, ebp - 0x4], 0x4);         /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x1013_b6b3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1013_b6c2:
            ...
            ii(0x1013_b6c7, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1013_b6d5, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_b6d8, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x1013_b6dd, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_b6e0, 5); call(0x1013_ab27, -0xbbe);              /* call 0x1013ab27 */
            ii(0x1013_b6e5, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_b6e8, 7); test(memd[ss, ebp - 0x4], 0x2);         /* test dword [ebp-0x4], 0x2 */
            ii(0x1013_b6ef, 2); if(jz(0x1013_b6f9, 0x8)) goto l_0x1013_b6f9; /* jz 0x1013b6f9 */
            ii(0x1013_b6f1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_b6f4, 5); call(Definitions.sys_delete, 0x2_a86b); /* call 0x10165f64 */
        l_0x1013_b6f9:
            ii(0x1013_b6f9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_b6fc, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1013_b6ff, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
