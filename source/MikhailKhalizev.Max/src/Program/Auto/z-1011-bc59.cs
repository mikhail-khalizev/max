...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_bc59()
        {
            ...
            ii(0x1011_bc70, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_bc73, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1011_bc76, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_bc79, 3); add(edx, 0x16);                         /* add edx, 0x16 */
            ii(0x1011_bc7c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_bc7f, 5); call(0x1013_bb7b, 0x1_fef7);            /* call 0x1013bb7b */
            ii(0x1011_bc84, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_bc87, 3); add(edx, 0x18);                         /* add edx, 0x18 */
            ii(0x1011_bc8a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
