...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_2163()
        {
            ...
            ii(0x19_2169, 2); if(jae(0x19_2170, 0x5)) goto l_0x19_2170; /* jae 0x2170 */
        ...
        l_0x19_2170:
            ...
            ii(0x19_2185, 4); mov(memw[ss, bx + 0x4], sp);              /* mov [ss:bx+0x4], sp */
            ...
            ii(0x19_2194, 4); mov(memw[ss, bx + 0x6], sp);              /* mov [ss:bx+0x6], sp */
            ii(0x19_2198, 4); mov(memw[ss, bx + 0x8], sp);              /* mov [ss:bx+0x8], sp */
            ...
            ii(0x19_21bd, 2); if(jcxz(0x19_21c1, 0x2)) goto l_0x19_21c1; /* jcxz 0x21c1 */
