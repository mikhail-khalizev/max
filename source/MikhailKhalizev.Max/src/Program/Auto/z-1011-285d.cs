...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_285d()
        {
            ...
            ii(0x1011_2873, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1011_2876, 3); mov(memb[ss, ebp - 8], dl);             /* mov [ebp-0x8], dl */
            ii(0x1011_2879, 3); mov(memb[ss, ebp - 4], bl);             /* mov [ebp-0x4], bl */
            ii(0x1011_287c, 4); cmp(memb[ss, ebp - 4], 0);              /* cmp byte [ebp-0x4], 0x0 */
            ii(0x1011_2880, 2); if(jz(0x1011_28c4, 0x42)) goto l_0x1011_28c4; /* jz 0x101128c4 */
            ii(0x1011_2882, 4); movsx(eax, memb[ss, ebp - 8]);          /* movsx eax, byte [ebp-0x8] */
            ii(0x1011_2886, 3); shl(eax, 2);                            /* shl eax, 0x2 */
            ii(0x1011_2889, 3); add(eax, memd[ss, ebp - 12]);           /* add eax, [ebp-0xc] */
            ii(0x1011_288c, 4); cmp(memd[ds, eax + 22], 0);             /* cmp dword [eax+0x16], 0x0 */
            ii(0x1011_2890, 2); if(jnz(0x1011_289e, 0xc)) goto l_0x1011_289e; /* jnz 0x1011289e */
            ii(0x1011_2892, 4); movsx(edx, memb[ss, ebp - 8]);          /* movsx edx, byte [ebp-0x8] */
            ii(0x1011_2896, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
        ...
        l_0x1011_289e:
            ...
            ii(0x1011_28b0, 4); movsx(eax, memb[ss, ebp - 8]);          /* movsx eax, byte [ebp-0x8] */
            ii(0x1011_28b4, 3); shl(eax, 2);                            /* shl eax, 0x2 */
            ii(0x1011_28b7, 3); add(eax, memd[ss, ebp - 12]);           /* add eax, [ebp-0xc] */
            ii(0x1011_28ba, 3); mov(eax, memd[ds, eax + 22]);           /* mov eax, [eax+0x16] */
        ...
        l_0x1011_28c4:
            ii(0x1011_28c4, 4); movsx(eax, memb[ss, ebp - 8]);          /* movsx eax, byte [ebp-0x8] */
            ii(0x1011_28c8, 3); shl(eax, 2);                            /* shl eax, 0x2 */
            ii(0x1011_28cb, 3); add(eax, memd[ss, ebp - 12]);           /* add eax, [ebp-0xc] */
            ii(0x1011_28ce, 4); cmp(memd[ds, eax + 22], 0);             /* cmp dword [eax+0x16], 0x0 */
            ...
            ii(0x1011_28dd, 4); movsx(eax, memb[ss, ebp - 8]);          /* movsx eax, byte [ebp-0x8] */
            ii(0x1011_28e1, 3); shl(eax, 2);                            /* shl eax, 0x2 */
            ii(0x1011_28e4, 3); add(eax, memd[ss, ebp - 12]);           /* add eax, [ebp-0xc] */
            ii(0x1011_28e7, 3); mov(eax, memd[ds, eax + 22]);           /* mov eax, [eax+0x16] */
