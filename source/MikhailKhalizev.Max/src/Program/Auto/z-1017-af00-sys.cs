...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1017_af74:
            ...
            ii(0x1017_afff, 7); mov(memd[ds, eax + 0x60], 1);           /* mov dword [eax+0x60], 0x1 */
            ...
            ii(0x1017_b024, 7); mov(memd[ds, eax + 0x6c], 1);           /* mov dword [eax+0x6c], 0x1 */
            ii(0x1017_b02b, 7); mov(memd[ds, eax + 0x70], 1);           /* mov dword [eax+0x70], 0x1 */
            ii(0x1017_b032, 7); mov(memd[ds, eax + 0x74], 1);           /* mov dword [eax+0x74], 0x1 */
            ...
            ii(0x1017_b051, 10); mov(memd[ds, eax + 0x84], 1);          /* mov dword [eax+0x84], 0x1 */
            ii(0x1017_b05b, 10); mov(memd[ds, eax + 0x88], 1);          /* mov dword [eax+0x88], 0x1 */
            ...
            ii(0x1017_b0a1, 10); mov(memd[ds, eax + 0xa4], 1);          /* mov dword [eax+0xa4], 0x1 */
            ii(0x1017_b0ab, 6); and(edx, 0xff);                         /* and edx, 0xff */
            ii(0x1017_b0b1, 10); mov(memd[ds, eax + 0xa8], 1);          /* mov dword [eax+0xa8], 0x1 */
