...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_3794()
        {
            ...
            ii(0x100a_37ab, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_37ae, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_37b1, 7); test(memd[ss, ebp - 0x4], 0x4);         /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x100a_37bf, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100a_37ce:
            ii(0x100a_37ce, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_37d1, 7); mov(memd[ds, eax + 0x2], 0x101b_4f34);  /* mov dword [eax+0x2], 0x101b4f34 */
            ii(0x100a_37d8, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_37da, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_37e8, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_37eb, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x100a_37f0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_37f3, 5); call(0x100a_36c9, -0x12f);              /* call 0x100a36c9 */
            ii(0x100a_37f8, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_37fb, 7); test(memd[ss, ebp - 0x4], 0x2);         /* test dword [ebp-0x4], 0x2 */
            ii(0x100a_3802, 2); if(jz(0x100a_380c, 0x8)) goto l_0x100a_380c; /* jz 0x100a380c */
            ii(0x100a_3804, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_3807, 5); call(Definitions.sys_delete, 0xc_2758); /* call 0x10165f64 */
        l_0x100a_380c:
            ii(0x100a_380c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
