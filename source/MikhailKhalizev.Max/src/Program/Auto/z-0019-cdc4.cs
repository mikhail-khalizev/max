...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_cdc4()
        {
            ...
            ii(0x19_cdc7, 3); push(memw[ss, bp + 6]);                   /* push word [bp+0x6] */
            ii(0x19_cdca, 3); push(memw[ss, bp + 4]);                   /* push word [bp+0x4] */
            ii(0x19_cdcd, 3); push(memw[ss, bp + 10]);                  /* push word [bp+0xa] */
            ii(0x19_cdd0, 3); push(memw[ss, bp + 8]);                   /* push word [bp+0x8] */
            ii(0x19_cdd3, 3); push(memw[ss, bp + 14]);                  /* push word [bp+0xe] */
            ii(0x19_cdd6, 3); push(memw[ss, bp + 12]);                  /* push word [bp+0xc] */
