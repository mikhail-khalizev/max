...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_39cc()
        {
            ...
            ii(0x1013_39f8, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ii(0x1013_39fb, 3); mov(eax, memd[ss, ebp - 0x28]);         /* mov eax, [ebp-0x28] */
            ii(0x1013_39fe, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1013_3a01, 10); mov(memd[ds, 0x101b_b4ec], 0x1);       /* mov dword [0x101bb4ec], 0x1 */
            ii(0x1013_3a0b, 5); mov(eax, 0x101c_64b0);                  /* mov eax, 0x101c64b0 */
            ii(0x1013_3a10, 5); call(0x100d_f25d, -0x5_47b8);           /* call 0x100df25d */
            ii(0x1013_3a15, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x1013_3a18, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x1013_3a1b, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1013_3a1e, 10); mov(memd[ds, 0x101b_b4ec], 0x2);       /* mov dword [0x101bb4ec], 0x2 */
            ii(0x1013_3a28, 5); mov(eax, 0x101c_67ac);                  /* mov eax, 0x101c67ac */
            ii(0x1013_3a2d, 5); call(0x100d_f25d, -0x5_47d5);           /* call 0x100df25d */
            ii(0x1013_3a32, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1013_3a35, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1013_3a38, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1013_3a3b, 10); mov(memd[ds, 0x101b_b4ec], 0x3);       /* mov dword [0x101bb4ec], 0x3 */
            ii(0x1013_3a45, 5); mov(eax, 0x101c_6aa8);                  /* mov eax, 0x101c6aa8 */
            ii(0x1013_3a4a, 5); call(0x100d_f25d, -0x5_47f2);           /* call 0x100df25d */
            ii(0x1013_3a4f, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1013_3a52, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x1013_3a55, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_3a58, 10); mov(memd[ds, 0x101b_b4ec], 0x4);       /* mov dword [0x101bb4ec], 0x4 */
            ii(0x1013_3a62, 5); mov(eax, 0x101c_6da4);                  /* mov eax, 0x101c6da4 */
            ii(0x1013_3a67, 5); call(0x100d_f25d, -0x5_480f);           /* call 0x100df25d */
            ii(0x1013_3a6c, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1013_3a6f, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1013_3a72, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1013_3a75, 10); mov(memd[ds, 0x101b_b4ec], 0x5);       /* mov dword [0x101bb4ec], 0x5 */
