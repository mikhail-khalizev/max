...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_cb28()
        {
            ...
            ii(0x1016_cb32, 7); mov(memd[ss, esp + 0x300], eax);        /* mov [esp+0x300], eax */
            ii(0x1016_cb39, 7); mov(memd[ss, esp + 0x304], edx);        /* mov [esp+0x304], edx */
            ii(0x1016_cb40, 7); mov(memd[ss, esp + 0x308], ebx);        /* mov [esp+0x308], ebx */
        ...
        l_0x1016_cb4d:
            ii(0x1016_cb4d, 7); mov(ecx, memd[ss, esp + 0x304]);        /* mov ecx, [esp+0x304] */
            ii(0x1016_cb54, 7); mov(esi, memd[ss, esp + 0x300]);        /* mov esi, [esp+0x300] */
        ...
        l_0x1016_cb5d:
            ...
            ii(0x1016_cb70, 7); idiv(memd[ss, esp + 0x308]);            /* idiv dword [esp+0x308] */
            ...
            ii(0x1016_cb7e, 4); mov(memb[ss, esp + ebx - 0x1], al);     /* mov [esp+ebx-0x1], al */
            ...
            ii(0x1016_cb8c, 7); mov(ebx, memd[ss, esp + 0x308]);        /* mov ebx, [esp+0x308] */
        ...
        l_0x1016_cb9d:
            ii(0x1016_cb9d, 7); mov(eax, memd[ss, esp + 0x304]);        /* mov eax, [esp+0x304] */
