...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_5151()
        {
            ...
            ii(0x1014_5168, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_516b, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ...
            ii(0x1014_5179, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_517c, 3); mov(eax, memd[ds, eax + 0x10]);         /* mov eax, [eax+0x10] */
            ii(0x1014_517f, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1014_5182, 1); push(eax);                              /* push eax */
            ii(0x1014_5183, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_5186, 3); mov(ecx, memd[ds, eax + 0xe]);          /* mov ecx, [eax+0xe] */
            ii(0x1014_5189, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_518c, 3); add(eax, 0xa);                          /* add eax, 0xa */
            ii(0x1014_518f, 5); call(Definitions.my_strobj_c_str_v2, -0xb_b9cc); /* call 0x100897c8 */
            ii(0x1014_5194, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_5197, 3); lea(esi, memd[ss, ebp - 0xc]);          /* lea esi, [ebp-0xc] */
            ...
            ii(0x1014_51af, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
