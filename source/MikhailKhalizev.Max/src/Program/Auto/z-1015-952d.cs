...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_952d()
        {
            ...
            ii(0x1015_9544, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_9547, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1015_954a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_954d, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1015_9550, 5); mov(eax, 0x1);                          /* mov eax, 0x1 */
            ii(0x1015_9555, 5); call(0x100f_448c, -0x6_50ce);           /* call 0x100f448c */
            ii(0x1015_955a, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_955d, 5); call(0x100f_3f62, -0x6_5600);           /* call 0x100f3f62 */
            ii(0x1015_9562, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
