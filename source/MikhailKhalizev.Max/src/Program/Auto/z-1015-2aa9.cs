...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_2aa9()
        {
            ...
            ii(0x1015_2ac1, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_2ac4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_2ac7, 3); add(eax, 0x6c);                         /* add eax, 0x6c */
            ii(0x1015_2aca, 5); call(0x1007_6730, -0xd_c39f);           /* call 0x10076730 */
            ii(0x1015_2acf, 3); mov(eax, memd[ds, eax + 0x12]);         /* mov eax, [eax+0x12] */
        ...
        l_0x1015_2b2a:
            ...
            ii(0x1015_2b6a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_2b6d, 3); add(eax, 0x6c);                         /* add eax, 0x6c */
            ii(0x1015_2b70, 5); call(0x1007_6730, -0xd_c445);           /* call 0x10076730 */
            ii(0x1015_2b75, 3); mov(eax, memd[ds, eax + 0x10]);         /* mov eax, [eax+0x10] */
            ii(0x1015_2b78, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1015_2b7b, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1015_2b7d, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x1015_2b80:
            ii(0x1015_2b80, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
