...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_a66b()
        {
            ...
            ii(0x1013_a693, 3);  lea(ebx, memd[ss, ebp - 16]);         /* lea ebx, [ebp-0x10] */
            ...
            ii(0x1013_a6a1, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x1013_a6ad, 4);  mov(memb[ss, ebp - 12], 0);           /* mov byte [ebp-0xc], 0x0 */
            ii(0x1013_a6b1, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1013_a6b3, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1013_a6bd:
            ii(0x1013_a6bd, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x1013_a6cf, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
            ii(0x1013_a6d3, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1013_a6d5, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        //  ii(0x1013_a6e1, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        //  ii(0x1013_a6e4, 5);  call(0x1007_5e24, -0xc_48c5);         /* call 0x10075e24 */
        l_0x1013_a6e9:
            ii(0x1013_a6e9, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
