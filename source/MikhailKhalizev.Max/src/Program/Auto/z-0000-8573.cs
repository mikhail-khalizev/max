...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_8573()
        {
            ...
            ii(0x857b, 5);    cmp(memb[ds, 0xcee], 2);                  /* cmp byte [0xcee], 0x2 */
            ii(0x8580, 2);    if(jnz(0x8585, 3)) goto l_0x8585;         /* jnz 0x8585 */
            ii(0x8582, 3);    mov(si, 0x17);                            /* mov si, 0x17 */
        l_0x8585:
            ii(0x8585, 5);    cmp(memb[ds, 0xcee], 3);                  /* cmp byte [0xcee], 0x3 */
            ii(0x858a, 2);    if(jnz(0x8596, 0xa)) goto l_0x8596;       /* jnz 0x8596 */
            ii(0x858c, 5);    cmp(memb[ds, 0xcef], 0);                  /* cmp byte [0xcef], 0x0 */
            ii(0x8591, 2);    if(jnz(0x8596, 3)) goto l_0x8596;         /* jnz 0x8596 */
            ii(0x8593, 3);    mov(si, 0x28);                            /* mov si, 0x28 */
        l_0x8596:
            ii(0x8596, 4);    mov(memb[ss, bp - 13], 0x52);             /* mov byte [bp-0xd], 0x52 */
            ii(0x859a, 3);    lea(ax, memw[ss, bp - 22]);               /* lea ax, [bp-0x16] */
            ii(0x859d, 1);    push(ax);                                 /* push ax */
            ii(0x859e, 3);    lea(cx, memw[ss, bp - 14]);               /* lea cx, [bp-0xe] */
            ii(0x85a1, 1);    push(cx);                                 /* push cx */
            ii(0x85a2, 1);    push(cx);                                 /* push cx */
            ii(0x85a3, 3);    call(0x5d08, -0x289e);                    /* call 0x5d08 */
            ii(0x85a6, 3);    add(sp, 6);                               /* add sp, 0x6 */
            ii(0x85a9, 3);    mov(ax, memw[ss, bp - 12]);               /* mov ax, [bp-0xc] */
            ii(0x85ac, 2);    add(ax, si);                              /* add ax, si */
            ii(0x85ae, 3);    mov(memw[ss, bp - 26], ax);               /* mov [bp-0x1a], ax */
            ii(0x85b1, 3);    mov(ax, memw[ss, bp - 22]);               /* mov ax, [bp-0x16] */
            ii(0x85b4, 3);    mov(memw[ss, bp - 24], ax);               /* mov [bp-0x18], ax */
        ...
        l_0x85bc:
            ...
            ii(0x85bf, 3);    push(memw[ss, bp - 26]);                  /* push word [bp-0x1a] */
            ii(0x85c2, 1);    push(dx);                                 /* push dx */
            ii(0x85c3, 3);    call_abs(memw[ss, bp + 4]);               /* call word [bp+0x4] */
        ...
        l_0x85cc:
            ii(0x85cc, 3);    les(bx, memw[ss, bp - 26]);               /* les bx, [bp-0x1a] */
            ii(0x85cf, 3);    mov(ax, memw[es, bx]);                    /* mov ax, [es:bx] */
            ii(0x85d2, 4);    mov(dx, memw[es, bx + 2]);                /* mov dx, [es:bx+0x2] */
            ii(0x85d6, 3);    mov(memw[ss, bp - 26], ax);               /* mov [bp-0x1a], ax */
            ii(0x85d9, 3);    mov(memw[ss, bp - 24], dx);               /* mov [bp-0x18], dx */
