...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x19_7dc0, 4); enter(0x6, 0);                            /* enter 0x6, 0x0 */
            ii(0x19_7dc4, 1); push(di);                                 /* push di */
            ii(0x19_7dc5, 1); push(si);                                 /* push si */
            ii(0x19_7dc6, 5); mov(memw[ss, bp - 0x2], 0);               /* mov word [bp-0x2], 0x0 */
            ii(0x19_7dcb, 4); cmp(memw[ss, bp + 0x8], 0x1);             /* cmp word [bp+0x8], 0x1 */
            ii(0x19_7dcf, 2); if(jz(0x19_7dd4, 0x3)) goto l_0x19_7dd4;  /* jz 0x7dd4 */
            ii(0x19_7dd1, 3); jmp(0x19_7de4, 0x10); goto l_0x19_7de4;   /* jmp 0x7de4 */
        l_0x19_7dd4:
            ii(0x19_7dd4, 2); push(0);                                  /* push 0x0 */
            ii(0x19_7dd6, 3); mov(al, memb[ss, bp + 0x6]);              /* mov al, [bp+0x6] */
        ...
        l_0x19_7de4:
            ...
            ii(0x19_7de8, 3); mov(bx, memw[ss, bp + 0x6]);              /* mov bx, [bp+0x6] */
            ii(0x19_7deb, 5); mov(al, memb[es, bx + 0x2]);              /* mov al, [es:bx+0x2] */
            ii(0x19_7df0, 2); sub(ah, ah);                              /* sub ah, ah */
            ii(0x19_7df2, 2); mov(si, ax);                              /* mov si, ax */
            ii(0x19_7df4, 3); mov(al, memb[ss, bp + 0x8]);              /* mov al, [bp+0x8] */
            ii(0x19_7df7, 3); mov(bx, memw[ss, bp + 0x6]);              /* mov bx, [bp+0x6] */
            ii(0x19_7dfa, 5); mov(memb[es, bx + 0x2], al);              /* mov [es:bx+0x2], al */
            ii(0x19_7dff, 3); jmp(0x19_7e10, 0xe); goto l_0x19_7e10;    /* jmp 0x7e10 */
        l_0x19_7e02:
            ii(0x19_7e02, 3); les(bx, memw[ss, bp - 0x6]);              /* les bx, [bp-0x6] */
            ii(0x19_7e05, 4); mov(al, memb[es, bx + 0x1]);              /* mov al, [es:bx+0x1] */
            ii(0x19_7e09, 2); sub(ah, ah);                              /* sub ah, ah */
            ii(0x19_7e0b, 2); mov(si, ax);                              /* mov si, ax */
            ii(0x19_7e0d, 3); inc(memw[ss, bp - 0x2]);                  /* inc word [bp-0x2] */
        l_0x19_7e10:
            ii(0x19_7e10, 3); cmp(memw[ss, bp + 0x8], si);              /* cmp [bp+0x8], si */
            ii(0x19_7e13, 2); if(jnz(0x19_7e18, 0x3)) goto l_0x19_7e18; /* jnz 0x7e18 */
        ...
        l_0x19_7e18:
            ...
            ii(0x19_7e2c, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
            ii(0x19_7e2f, 3); mov(memw[ss, bp - 0x4], dx);              /* mov [bp-0x4], dx */
            ii(0x19_7e32, 3); push(memw[ss, bp - 0x6]);                 /* push word [bp-0x6] */
        ...
        l_0x19_7e40:
            ii(0x19_7e40, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
