...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_46a0()
        {
            ...
            ii(0x1016_46b7, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1016_46ba, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1016_46bd, 7); test(memd[ss, ebp - 0x4], 0x4);         /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x1016_46cb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1016_46da:
            ...
            ii(0x1016_46df, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_46e2, 5); call(0x100c_d916, -0x9_6dd1);           /* call 0x100cd916 */
            ii(0x1016_46e7, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1016_46ea, 7); test(memd[ss, ebp - 0x4], 0x2);         /* test dword [ebp-0x4], 0x2 */
            ii(0x1016_46f1, 2); if(jz(0x1016_46fb, 0x8)) goto l_0x1016_46fb; /* jz 0x101646fb */
            ii(0x1016_46f3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_46f6, 5); call(Definitions.sys_delete, 0x1869);   /* call 0x10165f64 */
        l_0x1016_46fb:
            ii(0x1016_46fb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
