...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_0d9d()
        {
            ...
            ii(0x1013_0db4, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_0db7, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_0dba, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_0dbd, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1013_0dc0, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_0dc3, 4); cmp(memb[ds, eax + 0x17], 0x3);         /* cmp byte [eax+0x17], 0x3 */
            ii(0x1013_0dc7, 2); if(jz(0x1013_0ddd, 0x14)) goto l_0x1013_0ddd; /* jz 0x10130ddd */
            ii(0x1013_0dc9, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_0dcc, 4); mov(memb[ds, eax + 0x17], 0x3);         /* mov byte [eax+0x17], 0x3 */
            ii(0x1013_0dd0, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x1013_0dd5, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
