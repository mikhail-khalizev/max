...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_aae3()
        {
            ...
            ii(0x18_aaeb, 3); mov(ax, 8);                               /* mov ax, 0x8 */
            ii(0x18_aaee, 2); mov(es, ax);                              /* mov es, ax */
            ii(0x18_aaf0, 3); and(di, -8 /* 0xf8 */);                   /* and di, 0xfff8 */
            ii(0x18_aaf3, 4); mov(ax, memw[es, di + 2]);                /* mov ax, [es:di+0x2] */
            ii(0x18_aaf7, 4); mov(cl, memb[es, di + 4]);                /* mov cl, [es:di+0x4] */
            ii(0x18_aafb, 4); mov(ch, memb[es, di + 7]);                /* mov ch, [es:di+0x7] */
