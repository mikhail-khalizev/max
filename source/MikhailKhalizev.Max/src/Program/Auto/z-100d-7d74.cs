...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_7d74()
        {
            ...
            ii(0x100d_7d8b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_7d8e, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_7d91, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_7d94, 5); call(0x100d_811c, 0x383);               /* call 0x100d811c */
            ii(0x100d_7d99, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_7d9c, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x100d_7d9f, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100d_7da2, 1); push(eax);                              /* push eax */
            ii(0x100d_7da3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_7da6, 2); push(memd[ds, eax]);                    /* push dword [eax] */
            ii(0x100d_7da8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_7db2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_7db5, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ii(0x100d_7db8, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100d_7dbb, 1); push(eax);                              /* push eax */
            ii(0x100d_7dbc, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_7dbf, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x100d_7dc2, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100d_7dc5, 1); push(eax);                              /* push eax */
            ii(0x100d_7dc6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_7dc9, 3); mov(edx, memd[ds, eax + 0x4]);          /* mov edx, [eax+0x4] */
            ii(0x100d_7dcc, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_7dcf, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_7ddd, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_7de0, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x100d_7de3, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_7de6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
