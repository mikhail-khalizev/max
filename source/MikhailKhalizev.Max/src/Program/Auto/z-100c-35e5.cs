...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_35e5()
        {
            ...
            ii(0x100c_35fc, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_35ff, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100c_3602, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_3605, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100c_3607, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ii(0x100c_360a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_3614, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100c_3617, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_361a, 3); add(eax, 0x4d);                         /* add eax, 0x4d */
            ii(0x100c_361d, 5); call(0x1008_aab4, -0x3_8b6e);           /* call 0x1008aab4 */
            ii(0x100c_3622, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100c_3625, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100c_3635:
            ii(0x100c_3635, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_3638, 3); add(eax, 0x43);                         /* add eax, 0x43 */
            ii(0x100c_363b, 5); call(0x100c_b000, 0x79c0);              /* call 0x100cb000 */
            ii(0x100c_3640, 3); lea(ebx, memd[ss, ebp - 0xc]);          /* lea ebx, [ebp-0xc] */
            ...
            ii(0x100c_364c, 2); jmp(0x100c_3656, 0x8); goto l_0x100c_3656; /* jmp 0x100c3656 */
        l_0x100c_364e:
            ii(0x100c_364e, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x100c_3651, 5); call(0x1007_6bf8, -0x4_ca5e);           /* call 0x10076bf8 */
        l_0x100c_3656:
            ii(0x100c_3656, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100c_3658, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ...
            ii(0x100c_368d, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
        ...
        l_0x100c_3699:
            ...
            ii(0x100c_369b, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
