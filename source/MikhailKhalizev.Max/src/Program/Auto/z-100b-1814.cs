...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_1814()
        {
            ...
            ii(0x100b_182b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_182e, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100b_1831, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_183d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_1840, 5); call(0x100b_7d68, 0x6523);              /* call 0x100b7d68 */
            ii(0x100b_1845, 4); cmp(memb[ds, eax + 0x3d], 0x10);        /* cmp byte [eax+0x3d], 0x10 */
            ii(0x100b_1849, 2); if(jz(0x100b_1855, 0xa)) goto l_0x100b_1855; /* jz 0x100b1855 */
            ii(0x100b_184b, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_184d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_1850, 5); call(0x100a_c66b, -0x51ea);             /* call 0x100ac66b */
        l_0x100b_1855:
            ii(0x100b_1855, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100b_1858, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_185b, 5); call(0x100b_7d68, 0x6508);              /* call 0x100b7d68 */
            ii(0x100b_1860, 5); call(0x1015_27b8, 0xa_0f53);            /* call 0x101527b8 */
        l_0x100b_1865:
            ii(0x100b_1865, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_1868, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
