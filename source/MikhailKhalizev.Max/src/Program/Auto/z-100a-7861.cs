...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_7861()
        {
            ...
            ii(0x100a_7878, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_787b, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_787e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_7881, 4); cmp(memd[ds, eax + 0x52], 0x40);        /* cmp dword [eax+0x52], 0x40 */
            ...
            ii(0x100a_788c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100a_7896:
            ...
            ii(0x100a_789b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_789e, 5); call(Definitions.sys_strcpy, 0xb_e62c); /* call 0x10165ecf */
        l_0x100a_78a3:
            ii(0x100a_78a3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_78a6, 3); mov(al, memb[ds, eax + 0x13]);          /* mov al, [eax+0x13] */
            ii(0x100a_78a9, 3); mov(memb[ss, ebp - 0x10], al);          /* mov [ebp-0x10], al */
        ...
        l_0x100a_78b1:
            ...
            ii(0x100a_78b6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100a_78c3:
            ...
            ii(0x100a_78c8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100a_78d5:
            ...
            ii(0x100a_78da, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100a_78e7:
            ...
            ii(0x100a_78ec, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100a_78f6:
            ...
            ii(0x100a_791d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        //  ii(0x100a_7929, 3); lea(eax, memd[ds, eax + 0]);            /* lea eax, [eax] */
        ...
        l_0x100a_7940:
            ii(0x100a_7940, 3); mov(al, memb[ss, ebp - 0x10]);          /* mov al, [ebp-0x10] */
            ii(0x100a_7943, 3); mov(memb[ss, ebp - 0x14], al);          /* mov [ebp-0x14], al */
            ii(0x100a_7946, 4); cmp(memb[ss, ebp - 0x14], 0x4);         /* cmp byte [ebp-0x14], 0x4 */
            ii(0x100a_794a, 2); if(ja(0x100a_7927, -0x25)) goto l_0x100a_7927; /* ja 0x100a7927 */
            ii(0x100a_794c, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x100a_794e, 3); mov(al, memb[ss, ebp - 0x14]);          /* mov al, [ebp-0x14] */
        ...
        l_0x100a_795b:
            ii(0x100a_795b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_795e, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100a_7961, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
