...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_d45a()
        {
            ...
            ii(0x1009_d472, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_d475, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_d477, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_d486, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_d496, 3); cmp(eax, memd[ss, ebp - 0x4]);          /* cmp eax, [ebp-0x4] */
            ii(0x1009_d499, 2); if(jz(0x1009_d49d, 0x2)) goto l_0x1009_d49d; /* jz 0x1009d49d */
        l_0x1009_d49b:
            ii(0x1009_d49b, 2); jmp(0x1009_d4a5, 0x8); goto l_0x1009_d4a5; /* jmp 0x1009d4a5 */
        l_0x1009_d49d:
            ii(0x1009_d49d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
