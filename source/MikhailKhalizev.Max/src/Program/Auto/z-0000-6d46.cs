...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_6d46()
        {
            ...
            ii(0x6d4c, 3);    cmp(memw[ss, bp + 4], ax);                /* cmp [bp+0x4], ax */
            ii(0x6d4f, 2);    if(jae(0x6d65, 0x14)) goto l_0x6d65;      /* jae 0x6d65 */
            ii(0x6d51, 3);    push(memw[ss, bp + 6]);                   /* push word [bp+0x6] */
            ii(0x6d54, 2);    push(-1 /* 0xff */);                      /* push 0xffff */
            ii(0x6d56, 2);    push(0);                                  /* push 0x0 */
            ii(0x6d58, 3);    push(memw[ss, bp + 4]);                   /* push word [bp+0x4] */
            ii(0x6d5b, 3);    mov(ax, memw[ss, bp + 4]);                /* mov ax, [bp+0x4] */
            ii(0x6d5e, 3);    shr(ax, 3);                               /* shr ax, 0x3 */
