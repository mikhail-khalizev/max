...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_28ea()
        {
            ...
            ii(0x1007_2902, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_2905, 5); mov(eax, 0x101c_819c);                  /* mov eax, 0x101c819c */
            ii(0x1007_290a, 5); call(0x1007_6338, 0x3a29);              /* call 0x10076338 */
            ii(0x1007_290f, 3); lea(ebx, memd[ss, ebp - 0x8]);          /* lea ebx, [ebp-0x8] */
        ...
        l_0x1007_291b:
            ...
            ii(0x1007_291d, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x1007_2929, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1007_292c, 5); call(0x1007_63a0, 0x3a6f);              /* call 0x100763a0 */
            ii(0x1007_2931, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_2933, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ii(0x1007_2936, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1007_293a, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x1007_293c, 2); if(jnz(0x1007_294d, 0xf)) goto l_0x1007_294d; /* jnz 0x1007294d */
            ii(0x1007_293e, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1007_2941, 5); call(0x1007_63a0, 0x3a5a);              /* call 0x100763a0 */
            ii(0x1007_2946, 5); cmp(memw[ds, eax + 0x8], 0x28);         /* cmp word [eax+0x8], 0x28 */
            ii(0x1007_294b, 2); if(jz(0x1007_294f, 0x2)) goto l_0x1007_294f; /* jz 0x1007294f */
        l_0x1007_294d:
            ii(0x1007_294d, 2); jmp(0x1007_2966, 0x17); goto l_0x1007_2966; /* jmp 0x10072966 */
        l_0x1007_294f:
            ii(0x1007_294f, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1007_2952, 5); call(0x1007_6408, 0x3ab1);              /* call 0x10076408 */
            ii(0x1007_2957, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1007_295a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_295c, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
        ...
        l_0x1007_2966:
            ii(0x1007_2966, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
        ...
        l_0x1007_2970:
            ii(0x1007_2970, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1007_2977, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_2979, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
        ...
        //  ii(0x1007_2985, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
        //  ii(0x1007_2988, 5); call(0x1007_5f6c, 0x35df);              /* call 0x10075f6c */
        l_0x1007_298d:
            ii(0x1007_298d, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
