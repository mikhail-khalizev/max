...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_abc3()
        {
            ...
            ii(0x1013_abda, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_abdd, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_abe0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_abe3, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1013_abe6, 2); mov(memd[ds, edx], eax);                /* mov [edx], eax */
            ii(0x1013_abe8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_abeb, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1013_abed, 5); call(0x1013_ae28, 0x236);               /* call 0x1013ae28 */
            ii(0x1013_abf2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
