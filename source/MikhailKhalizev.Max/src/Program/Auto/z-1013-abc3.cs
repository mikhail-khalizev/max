...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("52370c51-1e2e-4ed4-b2ba-2b2f6ae8213e")]
        public void Method_1013_abc3()
        {
            ii(0x1013_abc3, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x1013_abc8, 5); calld(Definitions.sys_check_available_stack_size, 0x2b185); /* call 0x10165d52 */
            ...
            ii(0x1013_ac02, 1); retd(); return;                         /* ret */
        }
    }
}
