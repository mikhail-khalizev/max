...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_ad78()
        {
            ...
            ii(0x1016_ad83, 4); mov(memd[ss, esp + 0x8], ebx);          /* mov [esp+0x8], ebx */
            ii(0x1016_ad87, 4); mov(memd[ss, esp + 0x4], ecx);          /* mov [esp+0x4], ecx */
        ...
        l_0x1016_ad91:
            ...
            ii(0x1016_ad94, 4); mov(eax, memd[ss, esp + 0x1c]);         /* mov eax, [esp+0x1c] */
            ...
            ii(0x1016_adb1, 2); if(jz(0x1016_adb5, 0x2)) goto l_0x1016_adb5; /* jz 0x1016adb5 */
            ii(0x1016_adb3, 2); rep(() => stosd());                     /* rep stosd */
        l_0x1016_adb5:
            ii(0x1016_adb5, 6); test(ebx, 0x3);                         /* test ebx, 0x3 */
            ii(0x1016_adbb, 2); if(jz(0x1016_adc1, 0x4)) goto l_0x1016_adc1; /* jz 0x1016adc1 */
            ii(0x1016_adbd, 2); mov(ecx, ebx);                          /* mov ecx, ebx */
            ii(0x1016_adbf, 2); rep(() => stosb());                     /* rep stosb */
        l_0x1016_adc1:
            ii(0x1016_adc1, 1); inc(ebp);                               /* inc ebp */
            ii(0x1016_adc2, 4); mov(ebx, memd[ss, esp + 0x4]);          /* mov ebx, [esp+0x4] */
            ii(0x1016_adc6, 4); mov(ecx, memd[ss, esp + 0x8]);          /* mov ecx, [esp+0x8] */
        ...
        l_0x1016_add0:
            ...
            ii(0x1016_add6, 3); ret(0x4);                               /* ret 0x4 */
        }
    }
}
