...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_9096()
        {
            ...
            ii(0x1017_90ae, 2);  if(jz(0x1017_90b5, 5)) goto l_0x1017_90b5;/* jz 0x101790b5 */
            ii(0x1017_90b0, 2);  sbb(eax, eax);                        /* sbb eax, eax */
            ii(0x1017_90b2, 3);  sbb(eax, -1 /* 0xff */);              /* sbb eax, 0xffffffff */
        l_0x1017_90b5:
            ii(0x1017_90b5, 1);  popd(es);                             /* pop es */
            ii(0x1017_90b6, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x1017_90b8, 2);  if(jnz(0x1017_90be, 4)) goto l_0x1017_90be;/* jnz 0x101790be */
