...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("d4130a5d-7bde-48c5-a78f-2296814f412e")]
        public void Method_1014_837e()
        {
            ...
            ii(0x1014_839b, 5); calld(/* sys */ 0x1018_0fd2, 0x3_8c32); /* call 0x10180fd2 */
            ...
            ii(0x1014_83b0, 5); calld(/* sys */ 0x1018_0fc8, 0x3_8c13); /* call 0x10180fc8 */
            ii(0x1014_83b5, 5); calld(/* sys */ 0x1018_0fda, 0x3_8c20); /* call 0x10180fda */
            ii(0x1014_83ba, 5); mov(edx, 0xb4);                         /* mov edx, 0xb4 */
            ii(0x1014_83bf, 5); mov(eax, 0x43);                         /* mov eax, 0x43 */
            ii(0x1014_83c4, 5); calld(/* sys */ 0x1018_0fc8, 0x3_8bff); /* call 0x10180fc8 */
            ii(0x1014_83c9, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_83cb, 5); mov(eax, 0x42);                         /* mov eax, 0x42 */
            ii(0x1014_83d0, 5); calld(/* sys */ 0x1018_0fc8, 0x3_8bf3); /* call 0x10180fc8 */
            ii(0x1014_83d5, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_83d7, 5); mov(eax, 0x42);                         /* mov eax, 0x42 */
            ii(0x1014_83dc, 5); calld(/* sys */ 0x1018_0fc8, 0x3_8be7); /* call 0x10180fc8 */
            ii(0x1014_83e1, 5); calld(/* sys */ 0x1018_0fdc, 0x3_8bf6); /* call 0x10180fdc */
            ii(0x1014_83e6, 5); mov(eax, 0x61);                         /* mov eax, 0x61 */
            ii(0x1014_83eb, 5); calld(/* sys */ 0x1018_0fd2, 0x3_8be2); /* call 0x10180fd2 */
            ...
            ii(0x1014_83fd, 5); calld(/* sys */ 0x1018_0fc8, 0x3_8bc6); /* call 0x10180fc8 */
