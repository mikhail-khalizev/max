...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_f600()
        {
            ...
            ii(0x100d_f617, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_f61a, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_f61d, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100d_f620, 3); add(edx, 0x6);                          /* add edx, 0x6 */
            ii(0x100d_f623, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_f626, 5); call(0x1013_bb7b, 0x5_c550);            /* call 0x1013bb7b */
            ii(0x100d_f62b, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x100d_f632, 2); jmp(0x100d_f63a, 0x6); goto l_0x100d_f63a; /* jmp 0x100df63a */
        l_0x100d_f634:
            ii(0x100d_f634, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100d_f637, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x100d_f63a:
            ii(0x100d_f63a, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x100d_f63e, 3); cmp(eax, 0x5d);                         /* cmp eax, 0x5d */
            ii(0x100d_f641, 2); if(jge(0x100d_f667, 0x24)) goto l_0x100d_f667; /* jge 0x100df667 */
            ii(0x100d_f643, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_f646, 5); call(0x1013_bc8c, 0x5_c641);            /* call 0x1013bc8c */
            ii(0x100d_f64b, 4); movsx(ebx, memw[ss, ebp - 0xc]);        /* movsx ebx, word [ebp-0xc] */
            ii(0x100d_f64f, 2); mov(edx, ebx);                          /* mov edx, ebx */
            ii(0x100d_f651, 3); shl(edx, 0x2);                          /* shl edx, 0x2 */
            ii(0x100d_f654, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
        ...
        l_0x100d_f667:
            ii(0x100d_f667, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x100d_f66e, 2); jmp(0x100d_f676, 0x6); goto l_0x100d_f676; /* jmp 0x100df676 */
        l_0x100d_f670:
            ii(0x100d_f670, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100d_f673, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x100d_f676:
            ii(0x100d_f676, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x100d_f67a, 3); cmp(eax, 0x5d);                         /* cmp eax, 0x5d */
            ii(0x100d_f67d, 2); if(jge(0x100d_f6a6, 0x27)) goto l_0x100d_f6a6; /* jge 0x100df6a6 */
            ii(0x100d_f67f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_f682, 5); call(0x1013_bc8c, 0x5_c605);            /* call 0x1013bc8c */
            ii(0x100d_f687, 4); movsx(ebx, memw[ss, ebp - 0xc]);        /* movsx ebx, word [ebp-0xc] */
            ii(0x100d_f68b, 2); mov(edx, ebx);                          /* mov edx, ebx */
            ii(0x100d_f68d, 3); shl(edx, 0x2);                          /* shl edx, 0x2 */
            ii(0x100d_f690, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
        ...
        l_0x100d_f6a6:
            ii(0x100d_f6a6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_f6a9, 5); add(eax, 0x2f0);                        /* add eax, 0x2f0 */
            ii(0x100d_f6ae, 5); call(0x1013_a6f4, 0x5_b041);            /* call 0x1013a6f4 */
            ii(0x100d_f6b3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_f6b6, 5); call(0x1013_bc4f, 0x5_c594);            /* call 0x1013bc4f */
            ii(0x100d_f6bb, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
        l_0x100d_f6be:
            ii(0x100d_f6be, 3); dec(memd[ss, ebp - 0xc]);               /* dec dword [ebp-0xc] */
            ii(0x100d_f6c1, 5); cmp(memw[ss, ebp - 0xc], -0x1 /* 0xff */); /* cmp word [ebp-0xc], 0xffff */
            ii(0x100d_f6c6, 2); if(jz(0x100d_f6e1, 0x19)) goto l_0x100d_f6e1; /* jz 0x100df6e1 */
            ii(0x100d_f6c8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_f6cb, 5); call(0x1013_bc8c, 0x5_c5bc);            /* call 0x1013bc8c */
            ii(0x100d_f6d0, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100d_f6d2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
