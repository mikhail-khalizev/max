...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("67c59006-c45d-430a-9ec7-3d93725d4a95")]
        public void Method_100c_afa0()
        {
            ii(0x100c_afa0, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x100c_afa5, 5); calld(Definitions.sys_check_available_stack_size, 0x9ada8); /* call 0x10165d52 */
            ...
            ii(0x100c_afc3, 5); calld(0x1013_a5af, 0x6f5e7);            /* call 0x1013a5af */
            ...
            ii(0x100c_afcf, 1); retd(); return;                         /* ret */
        }
    }
}
