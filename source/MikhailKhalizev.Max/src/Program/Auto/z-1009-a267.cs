...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_a267()
        {
            ...
            ii(0x1009_a27f, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_a282, 4); mov(memb[ss, ebp - 0x8], 0x23);         /* mov byte [ebp-0x8], 0x23 */
            ii(0x1009_a286, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
