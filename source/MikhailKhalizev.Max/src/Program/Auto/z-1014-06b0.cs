...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_06b0()
        {
            ...
            ii(0x1014_06d0, 3); mov(eax, memd[ds, eax + 54]);           /* mov eax, [eax+0x36] */
            ...
            ii(0x1014_06de, 3); mov(edx, memd[ds, eax + 54]);           /* mov edx, [eax+0x36] */
            ii(0x1014_06e1, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1014_06e4, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1014_06e7, 3); mov(eax, memd[ds, eax + 40]);           /* mov eax, [eax+0x28] */
        ...
        l_0x1014_06f9:
            ...
            ii(0x1014_06ff, 4); add(dx, memw[ds, eax + 38]);            /* add dx, [eax+0x26] */
            ii(0x1014_0703, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1014_0706, 4); sub(dx, memw[ds, eax + 56]);            /* sub dx, [eax+0x38] */
            ii(0x1014_070a, 3); mov(memd[ss, ebp - 16], edx);           /* mov [ebp-0x10], edx */
            ...
            ii(0x1014_0718, 4); cmp(ax, memw[ss, ebp - 16]);            /* cmp ax, [ebp-0x10] */
            ii(0x1014_071c, 2); if(jg(0x1014_0727, 9)) goto l_0x1014_0727; /* jg 0x10140727 */
            ii(0x1014_071e, 4); mov(memb[ss, ebp - 12], 1);             /* mov byte [ebp-0xc], 0x1 */
            ii(0x1014_0722, 5); jmp(0x1014_083a, 0x113); goto l_0x1014_083a; /* jmp 0x1014083a */
        l_0x1014_0727:
            ii(0x1014_0727, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1014_072a, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1014_072d, 4); cmp(ax, memw[ds, edx + 40]);            /* cmp ax, [edx+0x28] */
        ...
        l_0x1014_0736:
            ii(0x1014_0736, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1014_0739, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1014_073c, 4); mov(memw[ds, edx + 40], ax);            /* mov [edx+0x28], ax */
            ii(0x1014_0740, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1014_0743, 3); mov(edx, memd[ds, eax + 38]);           /* mov edx, [eax+0x26] */
        ...
        l_0x1014_0766:
            ii(0x1014_0766, 4); mov(memb[ss, ebp - 12], 1);             /* mov byte [ebp-0xc], 0x1 */
        ...
        l_0x1014_076f:
            ...
            ii(0x1014_0772, 3); mov(eax, memd[ds, eax + 58]);           /* mov eax, [eax+0x3a] */
            ...
            ii(0x1014_07c4, 4); mov(bx, memw[ds, eax + 42]);            /* mov bx, [eax+0x2a] */
            ii(0x1014_07c8, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1014_07cb, 2); sub(edx, ebx);                          /* sub edx, ebx */
            ii(0x1014_07cd, 4); mov(memw[ds, eax + 38], dx);            /* mov [eax+0x26], dx */
            ii(0x1014_07d1, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1014_07d4, 3); mov(eax, memd[ds, eax + 36]);           /* mov eax, [eax+0x24] */
            ...
            ii(0x1014_07e1, 6); mov(memw[ds, eax + 38], 0);             /* mov word [eax+0x26], 0x0 */
        l_0x1014_07e7:
            ii(0x1014_07e7, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1014_07ea, 5); call(0x1014_0958, 0x169);               /* call 0x10140958 */
            ii(0x1014_07ef, 4); mov(memb[ss, ebp - 12], 1);             /* mov byte [ebp-0xc], 0x1 */
        ...
        l_0x1014_07f5:
            ...
            ii(0x1014_07f8, 3); mov(eax, memd[ds, eax + 56]);           /* mov eax, [eax+0x38] */
            ...
            ii(0x1014_0806, 4); mov(dx, memw[ds, eax + 42]);            /* mov dx, [eax+0x2a] */
            ii(0x1014_080a, 1); dec(edx);                               /* dec edx */
            ii(0x1014_080b, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1014_080e, 4); sub(memw[ds, eax + 38], dx);            /* sub [eax+0x26], dx */
            ii(0x1014_0812, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1014_0815, 3); mov(eax, memd[ds, eax + 36]);           /* mov eax, [eax+0x24] */
            ...
            ii(0x1014_0822, 6); mov(memw[ds, eax + 38], 0);             /* mov word [eax+0x26], 0x0 */
        l_0x1014_0828:
            ii(0x1014_0828, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1014_082b, 5); call(0x1014_0958, 0x128);               /* call 0x10140958 */
            ii(0x1014_0830, 4); mov(memb[ss, ebp - 12], 1);             /* mov byte [ebp-0xc], 0x1 */
            ii(0x1014_0834, 2); jmp(0x1014_083a, 4); goto l_0x1014_083a; /* jmp 0x1014083a */
        l_0x1014_0836:
            ii(0x1014_0836, 4); mov(memb[ss, ebp - 12], 0);             /* mov byte [ebp-0xc], 0x0 */
        l_0x1014_083a:
            ii(0x1014_083a, 3); mov(al, memb[ss, ebp - 12]);            /* mov al, [ebp-0xc] */
