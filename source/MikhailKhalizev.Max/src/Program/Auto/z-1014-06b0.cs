...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_06b0()
        {
            ...
            ii(0x1014_06c7, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_06ca, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_06cd, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_06d0, 3); mov(eax, memd[ds, eax + 0x36]);         /* mov eax, [eax+0x36] */
            ii(0x1014_06d3, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1014_06d6, 3); cmp(eax, memd[ss, ebp - 0x4]);          /* cmp eax, [ebp-0x4] */
            ii(0x1014_06d9, 2); if(jg(0x1014_06f4, 0x19)) goto l_0x1014_06f4; /* jg 0x101406f4 */
            ii(0x1014_06db, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_06de, 3); mov(edx, memd[ds, eax + 0x36]);         /* mov edx, [eax+0x36] */
            ii(0x1014_06e1, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1014_06e4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_06ef, 3); cmp(eax, memd[ss, ebp - 0x4]);          /* cmp eax, [ebp-0x4] */
            ii(0x1014_06f2, 2); if(jg(0x1014_06f9, 0x5)) goto l_0x1014_06f9; /* jg 0x101406f9 */
        l_0x1014_06f4:
            ii(0x1014_06f4, 5); jmp(0x1014_076f, 0x76); goto l_0x1014_076f; /* jmp 0x1014076f */
        l_0x1014_06f9:
            ii(0x1014_06f9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_06fc, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_06ff, 4); add(dx, memw[ds, eax + 0x26]);          /* add dx, [eax+0x26] */
            ii(0x1014_0703, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_0706, 4); sub(dx, memw[ds, eax + 0x38]);          /* sub dx, [eax+0x38] */
            ii(0x1014_070a, 3); mov(memd[ss, ebp - 0x10], edx);         /* mov [ebp-0x10], edx */
            ii(0x1014_070d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_071c, 2); if(jg(0x1014_0727, 0x9)) goto l_0x1014_0727; /* jg 0x10140727 */
            ii(0x1014_071e, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
        ...
        l_0x1014_0727:
            ...
            ii(0x1014_072a, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1014_072d, 4); cmp(ax, memw[ds, edx + 0x28]);          /* cmp ax, [edx+0x28] */
            ii(0x1014_0731, 2); if(jnz(0x1014_0736, 0x3)) goto l_0x1014_0736; /* jnz 0x10140736 */
        ...
        l_0x1014_0736:
            ...
            ii(0x1014_0739, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1014_073c, 4); mov(memw[ds, edx + 0x28], ax);          /* mov [edx+0x28], ax */
            ii(0x1014_0740, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_0743, 3); mov(edx, memd[ds, eax + 0x26]);         /* mov edx, [eax+0x26] */
            ii(0x1014_0746, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1014_0749, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1014_076f:
            ...
            ii(0x1014_07a4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_07b4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_07c1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_07c4, 4); mov(bx, memw[ds, eax + 0x2a]);          /* mov bx, [eax+0x2a] */
            ii(0x1014_07c8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_07cb, 2); sub(edx, ebx);                          /* sub edx, ebx */
            ii(0x1014_07cd, 4); mov(memw[ds, eax + 0x26], dx);          /* mov [eax+0x26], dx */
            ii(0x1014_07d1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_07dc, 2); if(jge(0x1014_07e7, 0x9)) goto l_0x1014_07e7; /* jge 0x101407e7 */
            ii(0x1014_07de, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_07e1, 6); mov(memw[ds, eax + 0x26], 0);           /* mov word [eax+0x26], 0x0 */
        l_0x1014_07e7:
            ii(0x1014_07e7, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_07ea, 5); call(0x1014_0958, 0x169);               /* call 0x10140958 */
            ii(0x1014_07ef, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1014_07f3, 2); jmp(0x1014_083a, 0x45); goto l_0x1014_083a; /* jmp 0x1014083a */
        l_0x1014_07f5:
            ii(0x1014_07f5, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_07f8, 3); mov(eax, memd[ds, eax + 0x38]);         /* mov eax, [eax+0x38] */
            ii(0x1014_07fb, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1014_07fe, 3); cmp(eax, memd[ss, ebp - 0x4]);          /* cmp eax, [ebp-0x4] */
            ii(0x1014_0801, 2); if(jnz(0x1014_0836, 0x33)) goto l_0x1014_0836; /* jnz 0x10140836 */
            ii(0x1014_0803, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_0806, 4); mov(dx, memw[ds, eax + 0x2a]);          /* mov dx, [eax+0x2a] */
            ii(0x1014_080a, 1); dec(edx);                               /* dec edx */
            ii(0x1014_080b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_080e, 4); sub(memw[ds, eax + 0x26], dx);          /* sub [eax+0x26], dx */
            ii(0x1014_0812, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_081d, 2); if(jge(0x1014_0828, 0x9)) goto l_0x1014_0828; /* jge 0x10140828 */
            ii(0x1014_081f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_0822, 6); mov(memw[ds, eax + 0x26], 0);           /* mov word [eax+0x26], 0x0 */
        l_0x1014_0828:
            ii(0x1014_0828, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_082b, 5); call(0x1014_0958, 0x128);               /* call 0x10140958 */
            ii(0x1014_0830, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1014_0834, 2); jmp(0x1014_083a, 0x4); goto l_0x1014_083a; /* jmp 0x1014083a */
        l_0x1014_0836:
