...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_0640()
        {
            ...
            ii(0x100b_0655, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x100b_0658, 3); mov(memd[ss, ebp - 12], edx);           /* mov [ebp-0xc], edx */
            ii(0x100b_065b, 3); mov(memd[ss, ebp - 8], ebx);            /* mov [ebp-0x8], ebx */
            ii(0x100b_065e, 3); mov(memd[ss, ebp - 4], ecx);            /* mov [ebp-0x4], ecx */
            ii(0x100b_0661, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100b_0664, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x100b_0667, 4); cmp(memd[ss, ebp - 4], 0);              /* cmp dword [ebp-0x4], 0x0 */
            ii(0x100b_066b, 2); if(jnz(0x100b_0677, 0xa)) goto l_0x100b_0677; /* jnz 0x100b0677 */
            ii(0x100b_066d, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
        ...
        l_0x100b_0677:
            ii(0x100b_0677, 3); mov(edx, memd[ss, ebp - 20]);           /* mov edx, [ebp-0x14] */
            ii(0x100b_067a, 3); add(edx, 0x21);                         /* add edx, 0x21 */
            ii(0x100b_067d, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ii(0x100b_0680, 5); call(0x1007_5e64, -0x3_a821);           /* call 0x10075e64 */
            ii(0x100b_0685, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100b_0687, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ...
            ii(0x100b_0697, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
        ...
        l_0x100b_069f:
            ...
            ii(0x100b_06a4, 3); ret(4);                                 /* ret 0x4 */
        }
    }
}
