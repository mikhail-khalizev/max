...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_09c2()
        {
            ...
            ii(0x1009_09db, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1009_09de, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1009_09e1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1009_09f4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1009_0a05:
            ii(0x1009_0a05, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_0a08, 4); mov(ax, memw[ds, eax + 0x2]);           /* mov ax, [eax+0x2] */
            ii(0x1009_0a0c, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ...
            ii(0x1009_0a1b, 2); if(jnz(0x1009_0a1f, 0x2)) goto l_0x1009_0a1f; /* jnz 0x10090a1f */
        l_0x1009_0a1d:
        ...
        l_0x1009_0a1f:
            ...
            ii(0x1009_0a22, 4); add(memd[ss, ebp - 0x14], 0x2);         /* add dword [ebp-0x14], 0x2 */
            ii(0x1009_0a26, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_0a29, 4); inc(memw[ds, eax + 0x2]);               /* inc word [eax+0x2] */
            ii(0x1009_0a2d, 2); jmp(0x1009_0a05, -0x2a); goto l_0x1009_0a05; /* jmp 0x10090a05 */
        l_0x1009_0a2f:
            ii(0x1009_0a2f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_0a32, 4); mov(ax, memw[ds, eax + 0x2]);           /* mov ax, [eax+0x2] */
