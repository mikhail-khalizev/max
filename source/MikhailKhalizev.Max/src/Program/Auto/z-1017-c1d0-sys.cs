...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_c1d0()
        {
            ...
            ii(0x1017_c1d5, 3);  mov(edx, memd[ss, ebp + 20]);         /* mov edx, [ebp+0x14] */
            ii(0x1017_c1d8, 1);  push(edx);                            /* push edx */
            ii(0x1017_c1d9, 3);  mov(ebx, memd[ss, ebp + 16]);         /* mov ebx, [ebp+0x10] */
            ii(0x1017_c1dc, 1);  push(ebx);                            /* push ebx */
            ii(0x1017_c1dd, 3);  mov(ecx, memd[ss, ebp + 12]);         /* mov ecx, [ebp+0xc] */
            ii(0x1017_c1e0, 1);  push(ecx);                            /* push ecx */
            ii(0x1017_c1e1, 3);  mov(esi, memd[ss, ebp + 8]);          /* mov esi, [ebp+0x8] */
            ...
            ii(0x1017_c1f3, 5);  mov(edi, 1);                          /* mov edi, 0x1 */
        ...
        l_0x1017_c205:
            ...
            ii(0x1017_c20d, 3);  cmp(eax, -1 /* 0xff */);              /* cmp eax, 0xffffffff */
        ...
        l_0x1017_c250:
            ii(0x1017_c250, 3);  cmp(ebx, -1 /* 0xff */);              /* cmp ebx, 0xffffffff */
            ii(0x1017_c253, 2);  if(jnz(0x1017_c257, 2)) goto l_0x1017_c257;/* jnz 0x1017c257 */
            ii(0x1017_c255, 2);  xor(ebx, ebx);                        /* xor ebx, ebx */
        l_0x1017_c257:
            ii(0x1017_c257, 2);  mov(eax, ebx);                        /* mov eax, ebx */
            ii(0x1017_c259, 3);  lea(esp, memd[ss, ebp - 8]);          /* lea esp, [ebp-0x8] */
