...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_5807()
        {
            ...
            ii(0x1012_583d, 7); mov(memb[ds, 0x101c_61a8], 0x4);        /* mov byte [0x101c61a8], 0x4 */
            ...
            ii(0x1012_584e, 2); if(jz(0x1012_5859, 0x9)) goto l_0x1012_5859; /* jz 0x10125859 */
            ii(0x1012_5850, 7); mov(memb[ds, 0x101c_5631], 0x6);        /* mov byte [0x101c5631], 0x6 */
            ii(0x1012_5857, 2); jmp(0x1012_5860, 0x7); goto l_0x1012_5860; /* jmp 0x10125860 */
        l_0x1012_5859:
            ii(0x1012_5859, 7); mov(memb[ds, 0x101c_5631], 0x7);        /* mov byte [0x101c5631], 0x7 */
        l_0x1012_5860:
