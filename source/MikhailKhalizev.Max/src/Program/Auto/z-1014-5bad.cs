...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_5bad()
        {
            ...
            ii(0x1014_5bdf, 3); mov(eax, memd[ds, eax + 20]);           /* mov eax, [eax+0x14] */
            ...
            ii(0x1014_5bec, 3); cmp(dl, memb[ds, eax + 39]);            /* cmp dl, [eax+0x27] */
            ...
            ii(0x1014_5bf4, 3); mov(eax, memd[ds, eax + 20]);           /* mov eax, [eax+0x14] */
        ...
        l_0x1014_5bfe:
            ...
            ii(0x1014_5c01, 3); mov(al, memb[ds, eax + 39]);            /* mov al, [eax+0x27] */
            ...
            ii(0x1014_5c13, 3); push(memd[ds, eax + 20]);               /* push dword [eax+0x14] */
        ...
        l_0x1014_5c1e:
            ...
            ii(0x1014_5c21, 4); mov(memb[ds, eax + 38], 1);             /* mov byte [eax+0x26], 0x1 */
