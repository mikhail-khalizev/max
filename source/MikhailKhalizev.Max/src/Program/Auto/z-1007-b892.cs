...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_b892()
        {
            ...
            ii(0x1007_b8a9, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_b8ac, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ...
            ii(0x1007_b8b8, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1007_b8bb, 3); add(edx, 0x2d);                         /* add edx, 0x2d */
            ii(0x1007_b8be, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_b8c1, 5); call(0x100b_8505, 0x3_cc3f);            /* call 0x100b8505 */
            ii(0x1007_b8c6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
