...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_b9ec()
        {
            ...
            ii(0x1009_ba03, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_ba06, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1009_ba09, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x1009_ba0e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_ba11, 5); call(Definitions.my_dtor_0x101b_6edc, 0x9_f22f); /* call 0x1013ac45 */
            ii(0x1009_ba16, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_ba19, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
