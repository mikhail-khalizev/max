...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("ba01c694-29c9-4248-b992-b218150c1142")]
        public void Method_1013_add4()
        {
            ii(0x1013_add4, 5); pushd(0x28);                            /* push 0x28 */
            ii(0x1013_add9, 5); calld(Definitions.sys_check_available_stack_size, 0x2af74); /* call 0x10165d52 */
        ...
        l_0x1013_ae1e:
            ...
            ii(0x1013_ae26, 1); retd(); return;                         /* ret */
        }
    }
}
