...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_a877()
        {
            ...
            ii(0xa882, 3);    mov(bx, memw[ds, si + 0x1a]);             /* mov bx, [si+0x1a] */
            ...
            ii(0xa88f, 3);    mov(memw[ds, si + 0x18], ax);             /* mov [si+0x18], ax */
            ii(0xa892, 3);    mov(ax, memw[ds, si + 0x34]);             /* mov ax, [si+0x34] */
            ii(0xa895, 3);    mov(memw[ds, si + 0xe], ax);              /* mov [si+0xe], ax */
            ii(0xa898, 3);    mov(ax, memw[ds, si + 0x38]);             /* mov ax, [si+0x38] */
            ii(0xa89b, 3);    mov(memw[ds, si + 0x2], ax);              /* mov [si+0x2], ax */
            ii(0xa89e, 3);    mov(bx, 0xa);                             /* mov bx, 0xa */
            ii(0xa8a1, 2);    jmp(0xa8af, 0xc); goto l_0xa8af;          /* jmp 0xa8af */
        l_0xa8a3:
            ii(0xa8a3, 3);    and(ax, 0x1f);                            /* and ax, 0x1f */
            ii(0xa8a6, 3);    mov(memw[ds, si + 0x18], ax);             /* mov [si+0x18], ax */
        ...
        l_0xa8af:
            ...
            ii(0xa8cc, 3);    mov(memw[ds, si + 0x38], es);             /* mov [si+0x38], es */
            ii(0xa8cf, 3);    mov(memw[ds, si + 0x34], ax);             /* mov [si+0x34], ax */
            ii(0xa8d2, 3);    mov(memw[ds, si + 0x2c], cs);             /* mov [si+0x2c], cs */
            ii(0xa8d5, 5);    mov(memw[ds, si + 0x28], 0x6b51);         /* mov word [si+0x28], 0x6b51 */
            ii(0xa8da, 2);    sub(ax, ax);                              /* sub ax, ax */
            ii(0xa8dc, 3);    mov(memw[ds, si + 0x36], ax);             /* mov [si+0x36], ax */
            ii(0xa8df, 3);    mov(memw[ds, si + 0x2a], ax);             /* mov [si+0x2a], ax */
        ...
        l_0xa8ed:
            ...
            ii(0xa8f4, 4);    cmp(memw[ss, bp + 0x18], 0xd);            /* cmp word [bp+0x18], 0xd */
            ii(0xa8f8, 2);    if(jz(0xa96d, 0x73)) goto l_0xa96d;       /* jz 0xa96d */
            ii(0xa8fa, 5);    if(jmp_far_ind(cs, 0x17be)) return;       /* jmp far word [cs:0x17be] */
        ...
        l_0xa917:
            ...
            ii(0xa92b, 2);    if(jz(0xa931, 0x4)) goto l_0xa931;        /* jz 0xa931 */
        ...
        l_0xa937:
            ii(0xa937, 3);    mov(si, memw[ss, bp + 0x1e]);             /* mov si, [bp+0x1e] */
            ii(0xa93a, 3);    mov(ds, memw[ss, bp + 0x22]);             /* mov ds, [bp+0x22] */
            ...
            ii(0xa944, 1);    cbw();                                    /* cbw */
            ii(0xa945, 3);    add(ax, memw[ss, bp + 0xc]);              /* add ax, [bp+0xc] */
            ii(0xa948, 1);    xchg(si, ax);                             /* xchg si, ax */
            ii(0xa949, 3);    mov(ds, memw[ss, bp + 0x2]);              /* mov ds, [bp+0x2] */
            ii(0xa94c, 3);    mov(bx, memw[ds, si + 0x2]);              /* mov bx, [si+0x2] */
            ...
            ii(0xa960, 3);    mov(memw[ds, si + 0x2], bx);              /* mov [si+0x2], bx */
            ii(0xa963, 1);    inc(ax);                                  /* inc ax */
            ii(0xa964, 2);    @int(0x31);                               /* int 0x31 */
            ii(0xa966, 2);    if(jae(0xa9e6, 0x7e)) goto l_0xa9e6;      /* jae 0xa9e6 */
        l_0xa968:
            ii(0xa968, 5);    if(jmp_far_ind(cs, 0x17be)) return;       /* jmp far word [cs:0x17be] */
        l_0xa96d:
            ii(0xa96d, 4);    lsl(ax, memw[ss, bp + 0x22]);             /* lsl ax, [bp+0x22] */
            ii(0xa971, 3);    sub(ax, memw[ss, bp + 0x1e]);             /* sub ax, [bp+0x1e] */
            ii(0xa974, 2);    if(jbe(0xa968, -0xe)) goto l_0xa968;      /* jbe 0xa968 */
            ii(0xa976, 4);    cmp(memw[ss, bp + 0x1a], 0);              /* cmp word [bp+0x1a], 0x0 */
            ...
            ii(0xa981, 3);    mov(cx, memw[ss, bp + 0x4]);              /* mov cx, [bp+0x4] */
            ii(0xa984, 2);    if(jcxz(0xa968, -0x1e)) goto l_0xa968;    /* jcxz 0xa968 */
            ii(0xa986, 3);    lsl(bx, cx);                              /* lsl bx, cx */
            ii(0xa989, 2);    mov(es, cx);                              /* mov es, cx */
            ii(0xa98b, 3);    mov(si, memw[ss, bp + 0x1e]);             /* mov si, [bp+0x1e] */
            ii(0xa98e, 3);    mov(ds, memw[ss, bp + 0x22]);             /* mov ds, [bp+0x22] */
            ii(0xa991, 1);    cld();                                    /* cld */
            ii(0xa992, 1);    lodsw();                                  /* lodsw */
            ii(0xa993, 3);    mov(cx, 0x2);                             /* mov cx, 0x2 */
            ii(0xa996, 3);    mov(di, memw[ss, bp + 0xa]);              /* mov di, [bp+0xa] */
            ...
            ii(0xa9a0, 3);    mov(dx, memw[ss, bp + 0x16]);             /* mov dx, [bp+0x16] */
            ...
            ii(0xa9c0, 2);    if(jz(0xa9ca, 0x8)) goto l_0xa9ca;        /* jz 0xa9ca */
        ...
        l_0xa9ca:
            ii(0xa9ca, 3);    add(memw[ss, bp + 0x1e], cx);             /* add [bp+0x1e], cx */
            ii(0xa9cd, 3);    mov(bx, memw[ss, bp + 0x4]);              /* mov bx, [bp+0x4] */
