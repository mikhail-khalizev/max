...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_6304()
        {
            ...
            ii(0x1010_631a, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ...
            ii(0x1010_632d, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1010_6330, 5);  mov(eax, 0x4a);                       /* mov eax, 0x4a */
            ii(0x1010_6335, 5);  call(0x1007_5fdc, -0x9_035e);         /* call 0x10075fdc */
            ii(0x1010_633a, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
        ...
        l_0x1010_637e:
            ...
            ii(0x1010_6392, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1010_6395, 5);  call(0x1010_61bb, -0x1df);            /* call 0x101061bb */
            ii(0x1010_639a, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1010_639d, 3);  mov(edx, memd[ss, ebp - 24]);         /* mov edx, [ebp-0x18] */
        ...
        l_0x1010_63aa:
            ...
            ii(0x1010_63af, 3);  lea(ebx, memd[ss, ebp - 56]);         /* lea ebx, [ebp-0x38] */
            ii(0x1010_63b2, 4);  movsx(edx, memb[ss, ebp - 4]);        /* movsx edx, byte [ebp-0x4] */
            ii(0x1010_63b6, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1010_63b9, 5);  call(0x1010_6281, -0x13d);            /* call 0x10106281 */
            ii(0x1010_63be, 5);  mov(ebx, 0x1e);                       /* mov ebx, 0x1e */
            ii(0x1010_63c3, 3);  lea(edx, memd[ss, ebp - 56]);         /* lea edx, [ebp-0x38] */
        ...
        l_0x1010_63d0:
            ii(0x1010_63d0, 4);  movsx(edx, memw[ss, ebp - 16]);       /* movsx edx, word [ebp-0x10] */
            ii(0x1010_63d4, 5);  mov(eax, 0x4b);                       /* mov eax, 0x4b */
            ii(0x1010_63d9, 5);  call(0x100c_aafc, -0x3_b8e2);         /* call 0x100caafc */
            ii(0x1010_63de, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
