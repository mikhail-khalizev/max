...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_f15d()
        {
            ...
            ii(0x1007_f175, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_f178, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_f17a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_f189, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_f18c, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x1007_f18f, 5); call(0x1007_6574, -0x8c20);             /* call 0x10076574 */
            ii(0x1007_f194, 4); cmp(memb[ds, eax + 0x59], 0);           /* cmp byte [eax+0x59], 0x0 */
            ii(0x1007_f198, 2); if(jz(0x1007_f19c, 0x2)) goto l_0x1007_f19c; /* jz 0x1007f19c */
        l_0x1007_f19a:
        ...
        l_0x1007_f19c:
            ...
            ii(0x1007_f1a9, 2); if(jz(0x1007_f1ad, 0x2)) goto l_0x1007_f1ad; /* jz 0x1007f1ad */
        l_0x1007_f1ab:
        ...
        l_0x1007_f1ad:
            ...
            ii(0x1007_f1b8, 2); if(jnz(0x1007_f1bc, 0x2)) goto l_0x1007_f1bc; /* jnz 0x1007f1bc */
        l_0x1007_f1ba:
        ...
        l_0x1007_f1bc:
            ...
            ii(0x1007_f1c5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_f1de, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_f1e1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_f1f3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_f1f6, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x1007_f1f9, 5); call(0x1008_afe4, 0xbde6);              /* call 0x1008afe4 */
            ii(0x1007_f1fe, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_f201, 5); mov(eax, 0x101c_3180);                  /* mov eax, 0x101c3180 */
            ii(0x1007_f206, 5); call(0x100a_5e27, 0x2_6c1c);            /* call 0x100a5e27 */
        l_0x1007_f20b:
            ii(0x1007_f20b, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x1007_f20f, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
