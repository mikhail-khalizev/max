...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_83d6()
        {
            ...
            ii(0x1013_83ec, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1013_83ef, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1013_83f2, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ...
            ii(0x1013_8406, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1013_8429, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1013_842d, 3); imul(eax, eax, 0x53);                   /* imul eax, eax, 0x53 */
            ii(0x1013_8430, 3); add(eax, memd[ss, ebp - 0xc]);          /* add eax, [ebp-0xc] */
