...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_5da2()
        {
            ...
            ii(0x19_5dad, 2); if(jnz(0x19_5db2, 3)) goto l_0x19_5db2;   /* jnz 0x5db2 */
            ii(0x19_5daf, 3); jmp(0x19_5db8, 6); goto l_0x19_5db8;      /* jmp 0x5db8 */
        l_0x19_5db2:
            ii(0x19_5db2, 3); mov(ax, 1);                               /* mov ax, 0x1 */
        ...
        l_0x19_5de8:
            ii(0x19_5de8, 3); inc(memw[ss, bp - 4]);                    /* inc word [bp-0x4] */
        l_0x19_5deb:
            ii(0x19_5deb, 3); lea(ax, memw[ss, bp - 5]);                /* lea ax, [bp-0x5] */
            ii(0x19_5dee, 3); cmp(memw[ss, bp - 4], ax);                /* cmp [bp-0x4], ax */
            ii(0x19_5df1, 2); if(jb(0x19_5df6, 3)) goto l_0x19_5df6;    /* jb 0x5df6 */
            ii(0x19_5df3, 3); jmp(0x19_5e1f, 0x29); goto l_0x19_5e1f;   /* jmp 0x5e1f */
        l_0x19_5df6:
            ii(0x19_5df6, 3); les(bx, memw[ss, bp - 4]);                /* les bx, [bp-0x4] */
            ii(0x19_5df9, 4); cmp(memb[es, bx], 0x57);                  /* cmp byte [es:bx], 0x57 */
            ii(0x19_5dfd, 2); if(jz(0x19_5e02, 3)) goto l_0x19_5e02;    /* jz 0x5e02 */
            ii(0x19_5dff, 3); jmp(0x19_5e1c, 0x1a); goto l_0x19_5e1c;   /* jmp 0x5e1c */
        l_0x19_5e02:
            ii(0x19_5e02, 3); push(memw[ss, bp - 2]);                   /* push word [bp-0x2] */
            ii(0x19_5e05, 3); push(memw[ss, bp - 4]);                   /* push word [bp-0x4] */
            ...
            ii(0x19_5e11, 2); if(jnz(0x19_5e16, 3)) goto l_0x19_5e16;   /* jnz 0x5e16 */
            ii(0x19_5e13, 3); jmp(0x19_5e1c, 6); goto l_0x19_5e1c;      /* jmp 0x5e1c */
        l_0x19_5e16:
            ii(0x19_5e16, 3); mov(ax, 1);                               /* mov ax, 0x1 */
            ii(0x19_5e19, 3); jmp(0x19_5e25, 9); goto l_0x19_5e25;      /* jmp 0x5e25 */
        l_0x19_5e1c:
