...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_6adf()
        {
            ...
            ii(0x100d_6af6, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_6af9, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x100d_6afc, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6aff, 3); cmp(memd[ds, eax], 0);                  /* cmp dword [eax], 0x0 */
            ii(0x100d_6b02, 2); if(jnz(0x100d_6b0d, 0x9)) goto l_0x100d_6b0d; /* jnz 0x100d6b0d */
            ii(0x100d_6b04, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
        ...
        l_0x100d_6b0d:
            ...
            ii(0x100d_6b23, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
        l_0x100d_6b26:
            ii(0x100d_6b26, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6b29, 3); push(memd[ds, eax + 0xc]);              /* push dword [eax+0xc] */
            ii(0x100d_6b2c, 2); push(0);                                /* push 0x0 */
            ii(0x100d_6b2e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6b31, 3); mov(ecx, memd[ds, eax + 0x8]);          /* mov ecx, [eax+0x8] */
            ii(0x100d_6b34, 3); sar(ecx, 0x10);                         /* sar ecx, 0x10 */
            ii(0x100d_6b37, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6b3a, 3); mov(ebx, memd[ds, eax + 0x6]);          /* mov ebx, [eax+0x6] */
            ii(0x100d_6b3d, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100d_6b40, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6b43, 3); mov(edx, memd[ds, eax + 0x4]);          /* mov edx, [eax+0x4] */
            ii(0x100d_6b46, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_6b49, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6b4c, 3); mov(eax, memd[ds, eax + 0x2]);          /* mov eax, [eax+0x2] */
            ...
            ii(0x100d_6b59, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6b5c, 2); mov(memd[ds, eax], edx);                /* mov [eax], edx */
            ii(0x100d_6b5e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6b61, 3); mov(eax, memd[ds, eax + 0xe]);          /* mov eax, [eax+0xe] */
            ...
            ii(0x100d_6b6c, 3); lea(edx, memd[ss, ebp - 0x28]);         /* lea edx, [ebp-0x28] */
            ii(0x100d_6b6f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_6b87, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ii(0x100d_6b8a, 1); push(eax);                              /* push eax */
            ii(0x100d_6b8b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6b8e, 3); mov(al, memb[ds, eax + 0x12]);          /* mov al, [eax+0x12] */
            ii(0x100d_6b91, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x100d_6b93, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x100d_6b96, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6b99, 3); mov(ebx, memd[ds, eax + 0x6]);          /* mov ebx, [eax+0x6] */
            ii(0x100d_6b9c, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100d_6b9f, 3); lea(edx, memd[ss, ebp - 0x28]);         /* lea edx, [ebp-0x28] */
            ii(0x100d_6ba2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6ba5, 3); mov(eax, memd[ds, eax + 0xe]);          /* mov eax, [eax+0xe] */
