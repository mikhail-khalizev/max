...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_001a_01ed()
        {
            ...
            ii(0x1a_01fe, 3); mov(memw[ss, bp - 22], ax);               /* mov [bp-0x16], ax */
            ii(0x1a_0201, 3); mov(memw[ss, bp - 20], dx);               /* mov [bp-0x14], dx */
            ii(0x1a_0204, 3); les(bx, memw[ss, bp + 10]);               /* les bx, [bp+0xa] */
            ii(0x1a_0207, 3); mov(memw[ss, bp - 18], bx);               /* mov [bp-0x12], bx */
            ii(0x1a_020a, 3); mov(memw[ss, bp - 16], es);               /* mov [bp-0x10], es */
            ...
            ii(0x1a_0224, 3); mov(ax, memw[ss, bp - 18]);               /* mov ax, [bp-0x12] */
            ii(0x1a_0227, 3); mov(dx, memw[ss, bp - 16]);               /* mov dx, [bp-0x10] */
            ii(0x1a_022a, 1); inc(ax);                                  /* inc ax */
            ii(0x1a_022b, 1); inc(ax);                                  /* inc ax */
            ii(0x1a_022c, 3); mov(memw[ss, bp - 18], ax);               /* mov [bp-0x12], ax */
        ...
        l_0x1a_0231:
            ...
            ii(0x1a_0235, 3); mov(memb[ss, bp - 14], al);               /* mov [bp-0xe], al */
            ii(0x1a_0238, 3); mov(al, memb[ss, bp - 14]);               /* mov al, [bp-0xe] */
            ii(0x1a_023b, 2); add(al, 0x41);                            /* add al, 0x41 */
            ii(0x1a_023d, 3); les(bx, memw[ss, bp - 22]);               /* les bx, [bp-0x16] */
        ...
        l_0x1a_0243:
            ...
            ii(0x1a_0249, 3); mov(memw[ss, bp - 28], bx);               /* mov [bp-0x1c], bx */
            ii(0x1a_024c, 5); test(memb[ds, bx + 15949], 2);            /* test byte [bx+0x3e4d], 0x2 */
            ii(0x1a_0251, 2); if(jz(0x1a_025a, 7)) goto l_0x1a_025a;    /* jz 0x25a */
            ii(0x1a_0253, 3); mov(al, memb[ss, bp - 28]);               /* mov al, [bp-0x1c] */
            ii(0x1a_0256, 2); sub(al, 0x20);                            /* sub al, 0x20 */
            ii(0x1a_0258, 2); jmp(0x1a_0260, 6); goto l_0x1a_0260;      /* jmp 0x260 */
        l_0x1a_025a:
            ii(0x1a_025a, 3); mov(bx, memw[ss, bp - 22]);               /* mov bx, [bp-0x16] */
        ...
        l_0x1a_0260:
            ...
            ii(0x1a_0265, 3); inc(memw[ss, bp - 22]);                   /* inc word [bp-0x16] */
            ii(0x1a_0268, 3); mov(bx, memw[ss, bp - 22]);               /* mov bx, [bp-0x16] */
            ii(0x1a_026b, 4); mov(memb[es, bx], 0x3a);                  /* mov byte [es:bx], 0x3a */
            ii(0x1a_026f, 3); lea(ax, memw[ds, bx + 1]);                /* lea ax, [bx+0x1] */
            ii(0x1a_0272, 3); mov(memw[ss, bp - 22], ax);               /* mov [bp-0x16], ax */
            ii(0x1a_0275, 3); les(bx, memw[ss, bp - 18]);               /* les bx, [bp-0x12] */
        ...
        l_0x1a_0281:
            ii(0x1a_0281, 3); les(bx, memw[ss, bp - 22]);               /* les bx, [bp-0x16] */
            ii(0x1a_0284, 3); inc(memw[ss, bp - 22]);                   /* inc word [bp-0x16] */
            ii(0x1a_0287, 4); mov(memb[es, bx], 0x5c);                  /* mov byte [es:bx], 0x5c */
            ii(0x1a_028b, 1); push(ds);                                 /* push ds */
            ii(0x1a_028c, 3); mov(ax, memw[ss, bp - 20]);               /* mov ax, [bp-0x14] */
            ii(0x1a_028f, 2); mov(ds, ax);                              /* mov ds, ax */
            ii(0x1a_0291, 3); mov(si, memw[ss, bp - 22]);               /* mov si, [bp-0x16] */
            ...
            ii(0x1a_029c, 3); push(memw[ss, bp - 20]);                  /* push word [bp-0x14] */
            ii(0x1a_029f, 3); push(memw[ss, bp - 22]);                  /* push word [bp-0x16] */
            ...
            ii(0x1a_02a9, 3); add(memw[ss, bp - 22], ax);               /* add [bp-0x16], ax */
            ii(0x1a_02ac, 3); les(bx, memw[ss, bp - 22]);               /* les bx, [bp-0x16] */
            ii(0x1a_02af, 4); mov(memb[es, bx], 0x5c);                  /* mov byte [es:bx], 0x5c */
            ii(0x1a_02b3, 3); lea(ax, memw[ds, bx + 1]);                /* lea ax, [bx+0x1] */
            ii(0x1a_02b6, 3); mov(memw[ss, bp - 22], ax);               /* mov [bp-0x16], ax */
            ii(0x1a_02b9, 3); mov(memw[ss, bp - 20], es);               /* mov [bp-0x14], es */
            ii(0x1a_02bc, 2); jmp(0x1a_0314, 0x56); goto l_0x1a_0314;   /* jmp 0x314 */
        l_0x1a_02be:
            ii(0x1a_02be, 3); mov(ax, memw[ss, bp - 18]);               /* mov ax, [bp-0x12] */
            ii(0x1a_02c1, 3); mov(dx, memw[ss, bp - 16]);               /* mov dx, [bp-0x10] */
            ii(0x1a_02c4, 3); mov(memw[ss, bp - 36], ax);               /* mov [bp-0x24], ax */
            ii(0x1a_02c7, 3); mov(memw[ss, bp - 34], dx);               /* mov [bp-0x22], dx */
            ii(0x1a_02ca, 3); inc(memw[ss, bp - 18]);                   /* inc word [bp-0x12] */
            ii(0x1a_02cd, 3); les(bx, memw[ss, bp - 36]);               /* les bx, [bp-0x24] */
            ii(0x1a_02d0, 4); cmp(memb[es, bx], 0x2e);                  /* cmp byte [es:bx], 0x2e */
            ii(0x1a_02d4, 2); if(jnz(0x1a_0314, 0x3e)) goto l_0x1a_0314; /* jnz 0x314 */
            ii(0x1a_02d6, 3); les(bx, memw[ss, bp - 18]);               /* les bx, [bp-0x12] */
            ii(0x1a_02d9, 4); cmp(memb[es, bx], 0x5c);                  /* cmp byte [es:bx], 0x5c */
            ii(0x1a_02dd, 2); if(jnz(0x1a_02e7, 8)) goto l_0x1a_02e7;   /* jnz 0x2e7 */
            ii(0x1a_02df, 3); inc(memw[ss, bp - 18]);                   /* inc word [bp-0x12] */
            ii(0x1a_02e2, 3); dec(memw[ss, bp - 22]);                   /* dec word [bp-0x16] */
        ...
        l_0x1a_02e7:
            ...
            ii(0x1a_02ed, 3); inc(memw[ss, bp - 18]);                   /* inc word [bp-0x12] */
            ii(0x1a_02f0, 3); mov(bx, memw[ss, bp - 18]);               /* mov bx, [bp-0x12] */
            ii(0x1a_02f3, 4); cmp(memb[es, bx], 0x5c);                  /* cmp byte [es:bx], 0x5c */
            ii(0x1a_02f7, 2); if(jnz(0x1a_0314, 0x1b)) goto l_0x1a_0314; /* jnz 0x314 */
            ii(0x1a_02f9, 4); sub(memw[ss, bp - 22], 3);                /* sub word [bp-0x16], 0x3 */
        ...
        l_0x1a_0308:
            ii(0x1a_0308, 3); dec(memw[ss, bp - 22]);                   /* dec word [bp-0x16] */
            ii(0x1a_030b, 3); les(bx, memw[ss, bp - 22]);               /* les bx, [bp-0x16] */
            ii(0x1a_030e, 4); cmp(memb[es, bx], 0x5c);                  /* cmp byte [es:bx], 0x5c */
            ii(0x1a_0312, 2); if(jnz(0x1a_02ff, -0x15)) goto l_0x1a_02ff; /* jnz 0x2ff */
        l_0x1a_0314:
            ii(0x1a_0314, 3); les(bx, memw[ss, bp - 18]);               /* les bx, [bp-0x12] */
            ii(0x1a_0317, 3); mov(al, memb[es, bx]);                    /* mov al, [es:bx] */
            ii(0x1a_031a, 3); les(si, memw[ss, bp - 22]);               /* les si, [bp-0x16] */
            ii(0x1a_031d, 3); inc(memw[ss, bp - 22]);                   /* inc word [bp-0x16] */
