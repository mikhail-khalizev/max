...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("1d0eb374-d624-4cf2-8869-d18321d10159")]
        public void /* sys */ Method_1016_f6e8()
        {
            ii(0x1016_f6e8, 1); pushd(ebx);                             /* push ebx */
            ii(0x1016_f6e9, 1); pushd(ecx);                             /* push ecx */
            ...
            ii(0x1016_f6fb, 4); mov(memw_a32[ss, esp], ax);             /* mov [esp], ax */
            ...
            ii(0x1016_f712, 5); calld(/* sys */ 0x1016_f63c, -0xdb);    /* call 0x1016f63c */
            ii(0x1016_f717, 3); cmp(eax, -0x1 /* 0xff */);              /* cmp eax, 0xffffffff */
            ii(0x1016_f71a, 2); if(jzd(0x1016_f72a, 0xe)) goto l_0x1016_f72a; /* jz 0x1016f72a */
            ii(0x1016_f71c, 3); mov(al, memb_a32[ss, esp]);             /* mov al, [esp] */
            ii(0x1016_f71f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1016_f721, 2); mov(dl, al);                            /* mov dl, al */
            ii(0x1016_f723, 2); mov(eax, ebx);                          /* mov eax, ebx */
            ii(0x1016_f725, 5); calld(/* sys */ 0x1016_f63c, -0xee);    /* call 0x1016f63c */
        l_0x1016_f72a:
            ii(0x1016_f72a, 3); cmp(eax, -0x1 /* 0xff */);              /* cmp eax, 0xffffffff */
            ii(0x1016_f72d, 2); if(jzd(0x1016_f760, 0x31)) goto l_0x1016_f760; /* jz 0x1016f760 */
            ...
            ii(0x1016_f742, 5); mov(memw_a32[ss, esp + 0x4], cx);       /* mov [esp+0x4], cx */
            ii(0x1016_f747, 5); calld(/* sys */ 0x1016_f63c, -0x110);   /* call 0x1016f63c */
            ii(0x1016_f74c, 3); cmp(eax, -0x1 /* 0xff */);              /* cmp eax, 0xffffffff */
            ii(0x1016_f74f, 2); if(jzd(0x1016_f760, 0xf)) goto l_0x1016_f760; /* jz 0x1016f760 */
            ii(0x1016_f751, 4); mov(al, memb_a32[ss, esp + 0x4]);       /* mov al, [esp+0x4] */
            ii(0x1016_f755, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1016_f757, 2); mov(dl, al);                            /* mov dl, al */
            ii(0x1016_f759, 2); mov(eax, ebx);                          /* mov eax, ebx */
            ii(0x1016_f75b, 5); calld(/* sys */ 0x1016_f63c, -0x124);   /* call 0x1016f63c */
        l_0x1016_f760:
            ii(0x1016_f760, 3); add(esp, 0x8);                          /* add esp, 0x8 */
            ii(0x1016_f763, 1); popd(ecx);                              /* pop ecx */
            ii(0x1016_f764, 1); popd(ebx);                              /* pop ebx */
            ii(0x1016_f765, 1); retd(); return;                         /* ret */
        }
    }
}
