...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_f6e8()
        {
            ...
            ii(0x1016_f6ea, 3);  sub(esp, 8);                          /* sub esp, 0x8 */
            ...
            ii(0x1016_f704, 3);  sar(eax, 8);                          /* sar eax, 0x8 */
            ...
            ii(0x1016_f717, 3);  cmp(eax, -1 /* 0xff */);              /* cmp eax, 0xffffffff */
        ...
        l_0x1016_f72a:
            ii(0x1016_f72a, 3);  cmp(eax, -1 /* 0xff */);              /* cmp eax, 0xffffffff */
            ...
            ii(0x1016_f734, 3);  sar(eax, 8);                          /* sar eax, 0x8 */
            ...
            ii(0x1016_f742, 5);  mov(memw[ss, esp + 4], cx);           /* mov [esp+0x4], cx */
            ii(0x1016_f747, 5);  call(/* sys */ 0x1016_f63c, -0x110);  /* call 0x1016f63c */
            ii(0x1016_f74c, 3);  cmp(eax, -1 /* 0xff */);              /* cmp eax, 0xffffffff */
            ii(0x1016_f74f, 2);  if(jz(0x1016_f760, 0xf)) goto l_0x1016_f760;/* jz 0x1016f760 */
            ii(0x1016_f751, 4);  mov(al, memb[ss, esp + 4]);           /* mov al, [esp+0x4] */
        ...
        l_0x1016_f760:
            ii(0x1016_f760, 3);  add(esp, 8);                          /* add esp, 0x8 */
