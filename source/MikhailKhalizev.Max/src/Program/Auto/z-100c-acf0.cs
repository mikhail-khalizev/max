...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("71547679-d044-4dae-b18c-84289414819a")]
        public void Method_100c_acf0()
        {
            ii(0x100c_acf0, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x100c_acf5, 5); calld(Definitions.sys_check_available_stack_size, 0x9b058); /* call 0x10165d52 */
            ...
            ii(0x100c_ad14, 5); calld(0x1008_b410, -0x3f909);           /* call 0x1008b410 */
            ii(0x100c_ad19, 3); add(eax, 0x6);                          /* add eax, 0x6 */
            ii(0x100c_ad1c, 5); calld(0x1008_b440, -0x3f8e1);           /* call 0x1008b440 */
