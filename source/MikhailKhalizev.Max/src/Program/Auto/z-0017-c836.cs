...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_c836()
        {
            ...
            ii(0x17_c85e, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ii(0x17_c861, 5); test(memw[ss, bp + 0xa], 0xfff);          /* test word [bp+0xa], 0xfff */
            ii(0x17_c866, 2); if(jz(0x17_c86c, 0x4)) goto l_0x17_c86c;  /* jz 0xc86c */
            ii(0x17_c868, 1); inc(ax);                                  /* inc ax */
            ii(0x17_c869, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
        l_0x17_c86c:
            ii(0x17_c86c, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_c86f, 3); mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ...
            ii(0x17_c88a, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ...
            ii(0x17_c8a1, 5); mov(memw[ss, bp - 0x8], 0);               /* mov word [bp-0x8], 0x0 */
            ii(0x17_c8a6, 5); mov(memw[ss, bp - 0x6], 0);               /* mov word [bp-0x6], 0x0 */
            ii(0x17_c8ab, 2); jmp(0x17_c8b4, 0x7); goto l_0x17_c8b4;    /* jmp 0xc8b4 */
        //  ii(0x17_c8ad, 1); nop();                                    /* nop */
        l_0x17_c8ae:
            ii(0x17_c8ae, 3); inc(memw[ss, bp - 0x6]);                  /* inc word [bp-0x6] */
            ii(0x17_c8b1, 3); inc(memw[ss, bp - 0x4]);                  /* inc word [bp-0x4] */
        l_0x17_c8b4:
            ii(0x17_c8b4, 3); mov(ax, memw[ss, bp - 0x6]);              /* mov ax, [bp-0x6] */
            ii(0x17_c8b7, 3); cmp(memw[ss, bp - 0x2], ax);              /* cmp [bp-0x2], ax */
            ...
            ii(0x17_c8c4, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
        ...
        l_0x17_c8d8:
            ...
            ii(0x17_c8db, 3); mov(dx, memw[ss, bp - 0x8]);              /* mov dx, [bp-0x8] */
