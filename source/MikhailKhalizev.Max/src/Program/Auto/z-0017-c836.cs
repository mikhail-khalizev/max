...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_c836()
        {
            ...
            ii(0x17_c840, 3);  mov(ax, memw[ss, bp + 10]);             /* mov ax, [bp+0xa] */
            ii(0x17_c843, 3);  mov(dx, memw[ss, bp + 12]);             /* mov dx, [bp+0xc] */
            ...
            ii(0x17_c861, 5);  test(memw[ss, bp + 10], 0xfff);         /* test word [bp+0xa], 0xfff */
        ...
        l_0x17_c86c:
            ...
            ii(0x17_c89e, 3);  mov(memw[ss, bp - 10], ax);             /* mov [bp-0xa], ax */
        ...
        //  ii(0x17_c8ad, 1);  Недостижимый код.
        l_0x17_c8ae:
        ...
        l_0x17_c8b4:
            ...
            ii(0x17_c8bc, 3);  mov(al, memb[ss, bp + 14]);             /* mov al, [bp+0xe] */
        ...
        //  ii(0x17_c8d7, 1);  Недостижимый код.
        l_0x17_c8d8:
            ii(0x17_c8d8, 3);  mov(ax, memw[ss, bp - 10]);             /* mov ax, [bp-0xa] */
