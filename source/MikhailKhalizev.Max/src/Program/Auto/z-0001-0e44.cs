...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("0d780e15-f2ce-4493-a064-26e564e416e4")]
        public void Method_0001_0e44()
        {
            ii(0x1_0e44, 3);  and(cx, 0x3f);                            /* and cx, 0x3f */
            ii(0x1_0e47, 2);  pushd(ebp);                               /* push ebp */
            ii(0x1_0e49, 2);  pushd(eax);                               /* push eax */
            ii(0x1_0e4b, 2);  mov(bp, ss);                              /* mov bp, ss */
            ii(0x1_0e4d, 4);  lar(ebp, bp);                             /* lar ebp, bp */
            ii(0x1_0e51, 4);  shr(ebp, 0x17);                           /* shr ebp, 0x17 */
            ii(0x1_0e55, 2);  if(jaew_func(0x1_0e58, 0x1)) return;      /* jae 0xe58 */ /* Адрес перехода делит инструкцию в этой функции пополам. */
            ii(0x1_0e57, 3);  mov(ebp, esp);                            /* mov ebp, esp */
