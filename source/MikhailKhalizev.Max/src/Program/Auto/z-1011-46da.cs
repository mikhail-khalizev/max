...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_46da()
        {
            ...
            ii(0x1011_46f7, 4);  mov(memb[ss, ebp - 12], 4);           /* mov byte [ebp-0xc], 0x4 */
            ...
            ii(0x1011_4704, 7);  mov(memb[ds, eax + 1311], 1);         /* mov byte [eax+0x51f], 0x1 */
        l_0x1011_470b:
            ii(0x1011_470b, 3);  dec(memb[ss, ebp - 12]);              /* dec byte [ebp-0xc] */
            ii(0x1011_470e, 4);  cmp(memb[ss, ebp - 12], -1 /* 0xff */);/* cmp byte [ebp-0xc], 0xff */
            ii(0x1011_4712, 2);  if(jz(0x1011_473e, 0x2a)) goto l_0x1011_473e;/* jz 0x1011473e */
            ii(0x1011_4714, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1011_4716, 3);  mov(dl, memb[ss, ebp - 12]);          /* mov dl, [ebp-0xc] */
            ...
            ii(0x1011_4726, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
        ...
        l_0x1011_473e:
            ...
            ii(0x1011_4741, 6);  mov(edx, memd[ds, eax + 166]);        /* mov edx, [eax+0xa6] */
            ii(0x1011_4747, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_474a, 6);  mov(memd[ds, eax + 1433], edx);       /* mov [eax+0x599], edx */
        ...
        l_0x1011_4765:
            ...
            ii(0x1011_4768, 7);  mov(memb[ds, eax + 1311], 0);         /* mov byte [eax+0x51f], 0x0 */
        l_0x1011_476f:
            ii(0x1011_476f, 3);  dec(memb[ss, ebp - 12]);              /* dec byte [ebp-0xc] */
            ii(0x1011_4772, 4);  cmp(memb[ss, ebp - 12], -1 /* 0xff */);/* cmp byte [ebp-0xc], 0xff */
            ii(0x1011_4776, 2);  if(jz(0x1011_478c, 0x14)) goto l_0x1011_478c;/* jz 0x1011478c */
            ii(0x1011_4778, 2);  xor(eax, eax);                        /* xor eax, eax */
            ii(0x1011_477a, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
            ii(0x1011_477d, 3);  imul(eax, eax, 0x1e);                 /* imul eax, eax, 0x1e */
            ii(0x1011_4780, 3);  add(eax, memd[ss, ebp - 8]);          /* add eax, [ebp-0x8] */
            ii(0x1011_4783, 7);  mov(memb[ds, eax + 1312], 0);         /* mov byte [eax+0x520], 0x0 */
        ...
        l_0x1011_478c:
            ...
            ii(0x1011_478f, 7);  mov(memb[ds, eax + 1310], 1);         /* mov byte [eax+0x51e], 0x1 */
