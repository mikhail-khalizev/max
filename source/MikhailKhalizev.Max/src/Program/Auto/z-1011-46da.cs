...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_46da()
        {
            ...
            ii(0x1011_46f1, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_46f4, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1011_46f7, 4); mov(memb[ss, ebp - 0xc], 0x4);          /* mov byte [ebp-0xc], 0x4 */
            ii(0x1011_46fb, 4); cmp(memd[ss, ebp - 0x4], 0);            /* cmp dword [ebp-0x4], 0x0 */
            ii(0x1011_46ff, 2); if(jz(0x1011_4765, 0x64)) goto l_0x1011_4765; /* jz 0x10114765 */
            ii(0x1011_4701, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_4704, 7); mov(memb[ds, eax + 0x51f], 0x1);        /* mov byte [eax+0x51f], 0x1 */
        l_0x1011_470b:
            ii(0x1011_470b, 3); dec(memb[ss, ebp - 0xc]);               /* dec byte [ebp-0xc] */
            ii(0x1011_470e, 4); cmp(memb[ss, ebp - 0xc], -0x1 /* 0xff */); /* cmp byte [ebp-0xc], 0xff */
            ...
            ii(0x1011_471c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_472c, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
        ...
        l_0x1011_473e:
            ii(0x1011_473e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_4741, 6); mov(edx, memd[ds, eax + 0xa6]);         /* mov edx, [eax+0xa6] */
            ii(0x1011_4747, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_474a, 6); mov(memd[ds, eax + 0x599], edx);        /* mov [eax+0x599], edx */
            ii(0x1011_4750, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1011_4753, 3); add(edx, 0x3);                          /* add edx, 0x3 */
            ii(0x1011_4756, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1011_4765:
            ii(0x1011_4765, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_4768, 7); mov(memb[ds, eax + 0x51f], 0);          /* mov byte [eax+0x51f], 0x0 */
        l_0x1011_476f:
            ii(0x1011_476f, 3); dec(memb[ss, ebp - 0xc]);               /* dec byte [ebp-0xc] */
            ii(0x1011_4772, 4); cmp(memb[ss, ebp - 0xc], -0x1 /* 0xff */); /* cmp byte [ebp-0xc], 0xff */
            ...
            ii(0x1011_4780, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
        ...
        l_0x1011_478c:
            ii(0x1011_478c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_478f, 7); mov(memb[ds, eax + 0x51e], 0x1);        /* mov byte [eax+0x51e], 0x1 */
