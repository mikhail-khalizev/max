...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_1444()
        {
            ...
            ii(0x1019_14a4, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1019_14a7, 5); mov(eax, memd[ds, 0x1020_9cc8]);        /* mov eax, [0x10209cc8] */
            ii(0x1019_14ac, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1019_14af, 4); cmp(memd[ss, ebp + 0x10], 0);           /* cmp dword [ebp+0x10], 0x0 */
            ii(0x1019_14b3, 2); if(jnz(0x1019_14bb, 0x6)) goto l_0x1019_14bb; /* jnz 0x101914bb */
        ...
        l_0x1019_14bb:
            ...
            ii(0x1019_14cc, 3); add(memd[ss, ebp - 0x4], eax);          /* add [ebp-0x4], eax */
        l_0x1019_14cf:
            ...
            ii(0x1019_14dd, 3); mov(edi, memd[ss, ebp - 0x4]);          /* mov edi, [ebp-0x4] */
        ...
        l_0x1019_14ed:
            ...
            ii(0x1019_14fd, 3); mov(ebx, memd[ss, ebp + 0x8]);          /* mov ebx, [ebp+0x8] */
            ii(0x1019_1500, 2); mov(al, memb[ds, ebx]);                 /* mov al, [ebx] */
            ii(0x1019_1502, 1); inc(ebx);                               /* inc ebx */
            ii(0x1019_1503, 3); mov(memd[ss, ebp + 0x8], ebx);          /* mov [ebp+0x8], ebx */
        ...
        l_0x1019_1523:
            ii(0x1019_1523, 3); add(edi, memd[ss, ebp - 0x8]);          /* add edi, [ebp-0x8] */
