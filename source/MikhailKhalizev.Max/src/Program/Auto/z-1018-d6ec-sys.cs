...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_d6ec()
        {
            ...
            ii(0x1018_d6f1, 4); test(memb[ds, eax + 0xd], 0x20);        /* test byte [eax+0xd], 0x20 */
            ii(0x1018_d6f5, 2); if(jnz(0x1018_d719, 0x22)) goto l_0x1018_d719; /* jnz 0x1018d719 */
            ii(0x1018_d6f7, 3); mov(eax, memd[ds, edx + 0x10]);         /* mov eax, [edx+0x10] */
            ...
            ii(0x1018_d703, 3); mov(bl, memb[ds, edx + 0xd]);           /* mov bl, [edx+0xd] */
            ii(0x1018_d706, 3); or(bl, 0x20);                           /* or bl, 0x20 */
            ii(0x1018_d709, 3); mov(memb[ds, edx + 0xd], bl);           /* mov [edx+0xd], bl */
            ii(0x1018_d70c, 3); test(bl, 0x7);                          /* test bl, 0x7 */
            ii(0x1018_d70f, 2); if(jnz(0x1018_d719, 0x8)) goto l_0x1018_d719; /* jnz 0x1018d719 */
            ii(0x1018_d711, 2); mov(cl, bl);                            /* mov cl, bl */
            ii(0x1018_d713, 3); or(cl, 0x2);                            /* or cl, 0x2 */
            ii(0x1018_d716, 3); mov(memb[ds, edx + 0xd], cl);           /* mov [edx+0xd], cl */
        l_0x1018_d719:
