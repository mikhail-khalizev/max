...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_d211()
        {
            ...
            ii(0x1015_d22a, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1015_d22d, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1015_d230, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1015_d24e, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1015_d252, 3); cmp(eax, 0x1);                          /* cmp eax, 0x1 */
            ii(0x1015_d255, 2); if(jle(0x1015_d279, 0x22)) goto l_0x1015_d279; /* jle 0x1015d279 */
            ii(0x1015_d257, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
        ...
        l_0x1015_d279:
            ii(0x1015_d279, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_d27c, 5); cmp(memw[ds, eax + 0x8], 0x47);         /* cmp word [eax+0x8], 0x47 */
            ...
            ii(0x1015_d286, 5); cmp(memw[ds, eax + 0x8], 0x4d);         /* cmp word [eax+0x8], 0x4d */
            ...
            ii(0x1015_d290, 5); cmp(memw[ds, eax + 0x8], 0x53);         /* cmp word [eax+0x8], 0x53 */
            ii(0x1015_d295, 2); if(jnz(0x1015_d299, 0x2)) goto l_0x1015_d299; /* jnz 0x1015d299 */
        l_0x1015_d297:
            ii(0x1015_d297, 2); jmp(0x1015_d29b, 0x2); goto l_0x1015_d29b; /* jmp 0x1015d29b */
        l_0x1015_d299:
        ...
        l_0x1015_d2a9:
            ...
            ii(0x1015_d2b0, 2); if(jl(0x1015_d2bb, 0x9)) goto l_0x1015_d2bb; /* jl 0x1015d2bb */
            ii(0x1015_d2b2, 7); mov(memd[ss, ebp - 0x18], 0x1);         /* mov dword [ebp-0x18], 0x1 */
            ii(0x1015_d2b9, 2); jmp(0x1015_d2c4, 0x9); goto l_0x1015_d2c4; /* jmp 0x1015d2c4 */
        l_0x1015_d2bb:
