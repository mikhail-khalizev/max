...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_d211()
        {
            ...
            ii(0x1015_d227, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ...
            ii(0x1015_d238, 4); mov(ax, memw[ds, eax + 12]);            /* mov ax, [eax+0xc] */
            ii(0x1015_d23c, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1015_d23f, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1015_d242, 5); call(0x1007_623c, -0xe_700b);           /* call 0x1007623c */
            ii(0x1015_d247, 4); mov(ax, memw[ds, eax + 14]);            /* mov ax, [eax+0xe] */
            ii(0x1015_d24b, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ...
            ii(0x1015_d262, 4); movsx(eax, memw[ss, ebp - 20]);         /* movsx eax, word [ebp-0x14] */
            ...
            ii(0x1015_d276, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
        l_0x1015_d279:
            ...
            ii(0x1015_d283, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x1015_d28d, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
        ...
        l_0x1015_d29b:
            ii(0x1015_d29b, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x1015_d29e, 2); cwd();                                  /* cwd */
            ii(0x1015_d2a0, 3); sub(ax, dx);                            /* sub ax, dx */
            ii(0x1015_d2a3, 3); sar(ax, 1);                             /* sar ax, 1 */
            ii(0x1015_d2a6, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
        l_0x1015_d2a9:
            ii(0x1015_d2a9, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1015_d2ac, 4); cmp(ax, memw[ss, ebp - 20]);            /* cmp ax, [ebp-0x14] */
            ii(0x1015_d2b0, 2); if(jl(0x1015_d2bb, 9)) goto l_0x1015_d2bb; /* jl 0x1015d2bb */
            ii(0x1015_d2b2, 7); mov(memd[ss, ebp - 24], 1);             /* mov dword [ebp-0x18], 0x1 */
            ii(0x1015_d2b9, 2); jmp(0x1015_d2c4, 9); goto l_0x1015_d2c4; /* jmp 0x1015d2c4 */
        l_0x1015_d2bb:
            ii(0x1015_d2bb, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x1015_d2be, 3); sub(eax, memd[ss, ebp - 16]);           /* sub eax, [ebp-0x10] */
            ii(0x1015_d2c1, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
        l_0x1015_d2c4:
            ii(0x1015_d2c4, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
