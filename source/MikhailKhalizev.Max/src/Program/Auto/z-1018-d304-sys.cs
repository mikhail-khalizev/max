...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_d304()
        {
            ...
            ii(0x1018_d306, 3); cmp(memb[ds, eax], 0x2);                /* cmp byte [eax], 0x2 */
            ii(0x1018_d309, 2); if(jnz(0x1018_d30e, 0x3)) goto l_0x1018_d30e; /* jnz 0x1018d30e */
            ii(0x1018_d30b, 3); mov(eax, memd[ds, eax + 0x1]);          /* mov eax, [eax+0x1] */
        l_0x1018_d30e:
        ...
        l_0x1018_d320:
            ii(0x1018_d320, 4); movzx(edx, memb[ds, eax + 0x1]);        /* movzx edx, byte [eax+0x1] */
        ...
        l_0x1018_d329:
            ii(0x1018_d329, 3); mov(edx, memd[ds, eax + 0xd]);          /* mov edx, [eax+0xd] */
