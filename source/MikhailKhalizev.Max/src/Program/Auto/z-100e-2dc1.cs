...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_2dc1()
        {
            ...
            ii(0x100e_2dd9, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
        l_0x100e_2ddc:
            ii(0x100e_2ddc, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_2ddf, 4); cmp(memb[ds, eax + 0x17], 0);           /* cmp byte [eax+0x17], 0x0 */
            ...
            ii(0x100e_2dee, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_2df1, 7); cmp(memd[ss, ebp - 0x8], 0x119);        /* cmp dword [ebp-0x8], 0x119 */
            ii(0x100e_2df8, 2); if(jnz(0x100e_2dff, 0x5)) goto l_0x100e_2dff; /* jnz 0x100e2dff */
            ii(0x100e_2dfa, 5); call(0x1011_6ba6, 0x3_3da7);            /* call 0x10116ba6 */
        l_0x100e_2dff:
            ii(0x100e_2dff, 4); cmp(memd[ss, ebp - 0x8], 0x3f);         /* cmp dword [ebp-0x8], 0x3f */
            ii(0x100e_2e03, 6); if(jnz(0x100e_2ec5, 0xbc)) goto l_0x100e_2ec5; /* jnz 0x100e2ec5 */
            ii(0x100e_2e09, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_2e0c, 3); add(eax, 0x18);                         /* add eax, 0x18 */
            ii(0x100e_2e0f, 5); call(0x1007_6574, -0x6_c8a0);           /* call 0x10076574 */
            ii(0x100e_2e14, 5); cmp(memw[ds, eax + 0x8], 0xa);          /* cmp word [eax+0x8], 0xa */
        ...
        l_0x100e_2e35:
            ii(0x100e_2e35, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_2e38, 3); add(eax, 0x18);                         /* add eax, 0x18 */
            ii(0x100e_2e3b, 5); call(0x1007_6574, -0x6_c8cc);           /* call 0x10076574 */
            ii(0x100e_2e40, 5); cmp(memw[ds, eax + 0x8], 0xb);          /* cmp word [eax+0x8], 0xb */
        ...
        l_0x100e_2e5e:
            ii(0x100e_2e5e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_2e61, 3); add(eax, 0x18);                         /* add eax, 0x18 */
            ii(0x100e_2e64, 5); call(0x1007_6574, -0x6_c8f5);           /* call 0x10076574 */
            ii(0x100e_2e69, 5); cmp(memw[ds, eax + 0x8], 0x9);          /* cmp word [eax+0x8], 0x9 */
        ...
        l_0x100e_2e87:
            ii(0x100e_2e87, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_2e8a, 3); add(eax, 0x18);                         /* add eax, 0x18 */
            ii(0x100e_2e8d, 5); call(0x1007_6574, -0x6_c91e);           /* call 0x10076574 */
            ii(0x100e_2e92, 5); cmp(memw[ds, eax + 0x8], 0x3);          /* cmp word [eax+0x8], 0x3 */
        ...
        l_0x100e_2ec5:
            ...
            ii(0x100e_2edc, 2); if(jnz(0x100e_2ee4, 0x6)) goto l_0x100e_2ee4; /* jnz 0x100e2ee4 */
            ii(0x100e_2ede, 4); cmp(memd[ss, ebp - 0x8], 0x1b);         /* cmp dword [ebp-0x8], 0x1b */
            ii(0x100e_2ee2, 2); if(jnz(0x100e_2ee6, 0x2)) goto l_0x100e_2ee6; /* jnz 0x100e2ee6 */
        l_0x100e_2ee4:
            ii(0x100e_2ee4, 2); jmp(0x100e_2eec, 0x6); goto l_0x100e_2eec; /* jmp 0x100e2eec */
        l_0x100e_2ee6:
            ii(0x100e_2ee6, 4); cmp(memd[ss, ebp - 0x8], 0xd);          /* cmp dword [ebp-0x8], 0xd */
            ii(0x100e_2eea, 2); if(jnz(0x100e_2ef6, 0xa)) goto l_0x100e_2ef6; /* jnz 0x100e2ef6 */
        l_0x100e_2eec:
            ii(0x100e_2eec, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
