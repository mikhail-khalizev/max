...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_aef0()
        {
            ...
            ii(0x100e_af08, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100e_af0b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_af0e, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x100e_af10, 5); call(Definitions.my_strobj_get_len, 0xf); /* call 0x100eaf24 */
            ii(0x100e_af15, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_af18, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
