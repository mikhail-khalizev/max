...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_09ee()
        {
            ...
            ii(0x100b_0a06, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_0a09, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_0a0c, 3);  add(eax, 0x19);                       /* add eax, 0x19 */
            ii(0x100b_0a0f, 5);  call(0x100b_7c44, 0x7230);            /* call 0x100b7c44 */
            ii(0x100b_0a14, 3);  lea(ebx, memd[ss, ebp - 8]);          /* lea ebx, [ebp-0x8] */
            ...
            ii(0x100b_0a20, 2);  jmp(0x100b_0a2a, 8); goto l_0x100b_0a2a;/* jmp 0x100b0a2a */
        l_0x100b_0a22:
            ii(0x100b_0a22, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
            ii(0x100b_0a25, 5);  call(0x1007_6bf8, -0x3_9e32);         /* call 0x10076bf8 */
        l_0x100b_0a2a:
            ii(0x100b_0a2a, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_0a2c, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x100b_0a38, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x100b_0a49, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_0a4c, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
        ...
        l_0x100b_0a60:
            ii(0x100b_0a60, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_0a6d, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_0a85, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100b_0a9c:
            ...
            ii(0x100b_0a9e, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_0aad, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_0ab0, 3);  add(eax, 0x27);                       /* add eax, 0x27 */
            ii(0x100b_0ab3, 5);  call(0x1008_a7dc, -0x2_62dc);         /* call 0x1008a7dc */
            ii(0x100b_0ab8, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100b_0abb, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100b_0abe, 3);  mov(edx, memd[ds, eax + 2]);          /* mov edx, [eax+0x2] */
            ii(0x100b_0ac1, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100b_0ac4, 3);  call_abs(memd[ds, edx + 72]);         /* call dword [edx+0x48] */
        l_0x100b_0ac7:
            ii(0x100b_0ac7, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_0ac9, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_0ad6, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_0ae3, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_0af0, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_0af3, 3);  add(eax, 0xf);                        /* add eax, 0xf */
            ii(0x100b_0af6, 5);  call(0x1008_afe4, -0x2_5b17);         /* call 0x1008afe4 */
            ii(0x100b_0afb, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x100b_0b0a, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
