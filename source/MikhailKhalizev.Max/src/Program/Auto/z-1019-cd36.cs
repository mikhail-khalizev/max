...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1019_cd36()
        {
            ...
            ii(0x1019_cd3e, 3); mov(ecx, memd[ss, ebp + 0]);            /* mov ecx, [ebp] */
            ii(0x1019_cd41, 3); mov(ebx, memd[ss, ebp + 0x4]);          /* mov ebx, [ebp+0x4] */
            ...
            ii(0x1019_cd5f, 2); if(jbe(0x1019_cd6a, 0x9)) goto l_0x1019_cd6a; /* jbe 0x1019cd6a */
        l_0x1019_cd61:
            ii(0x1019_cd61, 2); shl(ecx, 0x1);                          /* shl ecx, 1 */
            ii(0x1019_cd63, 2); rcl(ebx, 0x1);                          /* rcl ebx, 1 */
            ii(0x1019_cd65, 1); dec(ebp);                               /* dec ebp */
            ii(0x1019_cd66, 2); if(jnz(0x1019_cd61, -0x7)) goto l_0x1019_cd61; /* jnz 0x1019cd61 */
        ...
        l_0x1019_cd6e:
            ...
            ii(0x1019_cd84, 2); if(jnz(0x1019_cd8e, 0x8)) goto l_0x1019_cd8e; /* jnz 0x1019cd8e */
            ii(0x1019_cd86, 6); test(ecx, 0x1);                         /* test ecx, 0x1 */
            ii(0x1019_cd8c, 2); if(jz(0x1019_cd94, 0x6)) goto l_0x1019_cd94; /* jz 0x1019cd94 */
        l_0x1019_cd8e:
            ii(0x1019_cd8e, 3); add(ecx, 0x1);                          /* add ecx, 0x1 */
            ii(0x1019_cd91, 3); adc(ebx, 0);                            /* adc ebx, 0x0 */
        l_0x1019_cd94:
            ii(0x1019_cd94, 1); pop(ebp);                               /* pop ebp */
            ii(0x1019_cd95, 3); mov(memd[ss, ebp + 0], ecx);            /* mov [ebp], ecx */
            ii(0x1019_cd98, 3); mov(memd[ss, ebp + 0x4], ebx);          /* mov [ebp+0x4], ebx */
