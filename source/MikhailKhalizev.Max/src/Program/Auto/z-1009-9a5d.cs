...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_9a5d()
        {
            ...
            ii(0x1009_9a75, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_9a78, 4); mov(memb[ss, ebp - 0x8], 0x1c);         /* mov byte [ebp-0x8], 0x1c */
            ii(0x1009_9a7c, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
