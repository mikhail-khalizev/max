...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_85f1()
        {
            ...
            ii(0x1011_860f, 3); mov(ebx, memd[ds, eax + 26]);           /* mov ebx, [eax+0x1a] */
            ii(0x1011_8612, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1011_8615, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1011_8618, 3); mov(edx, memd[ds, eax + 24]);           /* mov edx, [eax+0x18] */
            ...
            ii(0x1011_8626, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1011_8629, 4); cmp(memd[ss, ebp - 12], 0);             /* cmp dword [ebp-0xc], 0x0 */
        ...
        l_0x1011_8638:
            ii(0x1011_8638, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x1011_8645, 3); mov(al, memb[ds, eax + 38]);            /* mov al, [eax+0x26] */
            ...
            ii(0x1011_8650, 3); mov(edx, memd[ds, eax + 26]);           /* mov edx, [eax+0x1a] */
            ii(0x1011_8653, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1011_8656, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1011_8659, 3); mov(eax, memd[ds, eax + 24]);           /* mov eax, [eax+0x18] */
        ...
        l_0x1011_866a:
            ...
            ii(0x1011_8677, 4); mov(memb[ds, eax + 61], 0xd);           /* mov byte [eax+0x3d], 0xd */
            ii(0x1011_867b, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1011_867e, 4); mov(memb[ds, eax + 62], 0);             /* mov byte [eax+0x3e], 0x0 */
        ...
        l_0x1011_868b:
            ii(0x1011_868b, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x1011_8698, 4); cmp(memb[ds, eax + 61], 0x1b);          /* cmp byte [eax+0x3d], 0x1b */
        ...
        l_0x1011_86a3:
            ii(0x1011_86a3, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1011_86a6, 5); call(0x1007_623c, -0xa_246f);           /* call 0x1007623c */
            ii(0x1011_86ab, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1011_86ae, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1011_86b1, 5); call(0x1007_34d7, -0xa_51df);           /* call 0x100734d7 */
            ii(0x1011_86b6, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1011_86b8, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1011_86bb, 4); cmp(dx, memw[ds, eax + 25]);            /* cmp dx, [eax+0x19] */
            ii(0x1011_86bf, 2); if(jz(0x1011_86f5, 0x34)) goto l_0x1011_86f5; /* jz 0x101186f5 */
            ii(0x1011_86c1, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ...
            ii(0x1011_86cf, 4); mov(memb[ds, eax + 61], 0xd);           /* mov byte [eax+0x3d], 0xd */
            ii(0x1011_86d3, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1011_86d6, 4); mov(memb[ds, eax + 62], 0);             /* mov byte [eax+0x3e], 0x0 */
            ...
            ii(0x1011_86eb, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
        ...
        l_0x1011_86f5:
            ...
            ii(0x1011_86f8, 4); mov(memb[ds, eax + 61], 0);             /* mov byte [eax+0x3d], 0x0 */
            ii(0x1011_86fc, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1011_86ff, 4); mov(memb[ds, eax + 62], 1);             /* mov byte [eax+0x3e], 0x1 */
            ...
            ii(0x1011_8717, 3); mov(ebx, memd[ds, eax + 26]);           /* mov ebx, [eax+0x1a] */
            ii(0x1011_871a, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1011_871d, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1011_8720, 3); mov(edx, memd[ds, edx + 24]);           /* mov edx, [edx+0x18] */
            ii(0x1011_8723, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1011_8726, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
