...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_85f1()
        {
            ...
            ii(0x1011_8609, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_860c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_860f, 3); mov(ebx, memd[ds, eax + 0x1a]);         /* mov ebx, [eax+0x1a] */
            ii(0x1011_8612, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1011_8615, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_8618, 3); mov(edx, memd[ds, eax + 0x18]);         /* mov edx, [eax+0x18] */
            ii(0x1011_861b, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1011_861e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_862d, 2); if(jnz(0x1011_8638, 0x9)) goto l_0x1011_8638; /* jnz 0x10118638 */
            ii(0x1011_862f, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        ...
        l_0x1011_8638:
            ...
            ii(0x1011_863b, 5); cmp(memw[ds, eax + 0x8], 0x16);         /* cmp word [eax+0x8], 0x16 */
            ii(0x1011_8640, 2); if(jnz(0x1011_8668, 0x26)) goto l_0x1011_8668; /* jnz 0x10118668 */
            ii(0x1011_8642, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_864d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_8650, 3); mov(edx, memd[ds, eax + 0x1a]);         /* mov edx, [eax+0x1a] */
            ii(0x1011_8653, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1011_8656, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_8666, 2); if(jz(0x1011_866a, 0x2)) goto l_0x1011_866a; /* jz 0x1011866a */
        l_0x1011_8668:
            ii(0x1011_8668, 2); jmp(0x1011_868b, 0x21); goto l_0x1011_868b; /* jmp 0x1011868b */
        l_0x1011_866a:
            ii(0x1011_866a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_866c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_866f, 5); call(0x1008_a998, -0x8_dcdc);           /* call 0x1008a998 */
            ii(0x1011_8674, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_8677, 4); mov(memb[ds, eax + 0x3d], 0xd);         /* mov byte [eax+0x3d], 0xd */
            ii(0x1011_867b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_867e, 4); mov(memb[ds, eax + 0x3e], 0);           /* mov byte [eax+0x3e], 0x0 */
            ii(0x1011_8682, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
        ...
        l_0x1011_868b:
            ...
            ii(0x1011_868e, 5); cmp(memw[ds, eax + 0x8], 0xa);          /* cmp word [eax+0x8], 0xa */
            ii(0x1011_8693, 2); if(jnz(0x1011_869e, 0x9)) goto l_0x1011_869e; /* jnz 0x1011869e */
            ii(0x1011_8695, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_8698, 4); cmp(memb[ds, eax + 0x3d], 0x1b);        /* cmp byte [eax+0x3d], 0x1b */
            ii(0x1011_869c, 2); if(jz(0x1011_86a3, 0x5)) goto l_0x1011_86a3; /* jz 0x101186a3 */
        l_0x1011_869e:
        ...
        l_0x1011_86f5:
            ii(0x1011_86f5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_86f8, 4); mov(memb[ds, eax + 0x3d], 0);           /* mov byte [eax+0x3d], 0x0 */
            ii(0x1011_86fc, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_86ff, 4); mov(memb[ds, eax + 0x3e], 0x1);         /* mov byte [eax+0x3e], 0x1 */
            ii(0x1011_8703, 5); mov(edx, 0x101c_37bc);                  /* mov edx, 0x101c37bc */
            ii(0x1011_8708, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_8714, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_8717, 3); mov(ebx, memd[ds, eax + 0x1a]);         /* mov ebx, [eax+0x1a] */
            ii(0x1011_871a, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1011_871d, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1011_8730, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
        ...
        l_0x1011_8742:
            ii(0x1011_8742, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x1011_8746, 2); jmp(0x1011_874c, 0x4); goto l_0x1011_874c; /* jmp 0x1011874c */
        l_0x1011_8748:
            ii(0x1011_8748, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x1011_874c:
            ii(0x1011_874c, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
