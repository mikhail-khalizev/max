...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_6f76()
        {
            ...
            ii(0x6f8e, 2);    if(jz(0x6f94, 0x4)) goto l_0x6f94;        /* jz 0x6f94 */
            ii(0x6f90, 4);    mov(si, memw[ds, 0x11d6]);                /* mov si, [0x11d6] */
        l_0x6f94:
            ii(0x6f94, 2);    or(si, si);                               /* or si, si */
            ii(0x6f96, 2);    if(jnz(0x6f9b, 0x3)) goto l_0x6f9b;       /* jnz 0x6f9b */
            ii(0x6f98, 3);    mov(si, 0x800);                           /* mov si, 0x800 */
        l_0x6f9b:
            ii(0x6f9b, 4);    cmp(si, 0x400);                           /* cmp si, 0x400 */
            ii(0x6f9f, 2);    if(jae(0x6fa4, 0x3)) goto l_0x6fa4;       /* jae 0x6fa4 */
        ...
        l_0x6fd4:
            ...
            ii(0x6fe0, 2);    if(jnz(0x6fe8, 0x6)) goto l_0x6fe8;       /* jnz 0x6fe8 */
        l_0x6fe2:
