...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_9060()
        {
            ...
            ii(0x100a_9077, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_907a, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_907d, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100a_9095, 2); if(jnz(0x100a_90a0, 0x9)) goto l_0x100a_90a0; /* jnz 0x100a90a0 */
            ii(0x100a_9097, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_909a, 4); test(memb[ds, eax + 0x14], 0x40);       /* test byte [eax+0x14], 0x40 */
            ii(0x100a_909e, 2); if(jnz(0x100a_90a2, 0x2)) goto l_0x100a_90a2; /* jnz 0x100a90a2 */
        l_0x100a_90a0:
            ii(0x100a_90a0, 2); jmp(0x100a_90bb, 0x19); goto l_0x100a_90bb; /* jmp 0x100a90bb */
        l_0x100a_90a2:
            ii(0x100a_90a2, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100a_90a5, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
        ...
        l_0x100a_90bb:
            ii(0x100a_90bb, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
