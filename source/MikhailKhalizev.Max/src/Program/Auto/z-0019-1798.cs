...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_1798()
        {
            ...
            ii(0x19_179b, 4); cmp(memb[ss, bp + 0x4], 0xa);             /* cmp byte [bp+0x4], 0xa */
            ii(0x19_179f, 2); if(jnz(0x19_17a7, 0x6)) goto l_0x19_17a7; /* jnz 0x17a7 */
            ii(0x19_17a1, 2); push(0xd);                                /* push 0xd */
            ii(0x19_17a3, 3); call(0x19_1798, -0xe);                    /* call 0x1798 */
            ii(0x19_17a6, 1); pop(bx);                                  /* pop bx */
        l_0x19_17a7:
            ii(0x19_17a7, 3); mov(al, memb[ss, bp + 0x4]);              /* mov al, [bp+0x4] */
