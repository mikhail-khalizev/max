...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_50fa()
        {
            ...
            ii(0x510f, 2);    if(jnzw(0x5114, 0x3)) goto l_0x5114;      /* jnz 0x58c4 */
            ii(0x5111, 3);    jmpw(0x521f, 0x10b); goto l_0x521f;       /* jmp 0x59cf */
        l_0x5114:
            ...
            ii(0x512c, 2);    if(jnzw(0x5162, 0x34)) goto l_0x5162;     /* jnz 0x5912 */
            ii(0x512e, 2);    pushw(0x50);                              /* push 0x50 */
            ii(0x5130, 3);    callw(0x522f, 0xfc);                      /* call 0x59df */
            ...
            ii(0x5142, 3);    callw(0x4f8a, -0x1bb);                    /* call 0x573a */
            ii(0x5145, 5);    cmp(memw_a16[ds, 0xa14], 0);              /* cmp word [0xa14], 0x0 */
            ii(0x514a, 2);    if(jnzw(0x514f, 0x3)) goto l_0x514f;      /* jnz 0x58ff */
            ii(0x514c, 3);    callw(0x375c, -0x19f3);                   /* call 0x3f0c */
        l_0x514f:
        ...
        l_0x5162:
            ...
            ii(0x5177, 3);    callw(0x4f7a, -0x200);                    /* call 0x572a */
            ii(0x517a, 2);    pushw(0x1);                               /* push 0x1 */
            ii(0x517c, 3);    callw(0x4856, -0x929);                    /* call 0x5006 */
            ii(0x517f, 1);    popw(bx);                                 /* pop bx */
            ii(0x5180, 2);    jmpw(0x51a0, 0x1e); goto l_0x51a0;        /* jmp 0x5950 */
        l_0x5182:
        ...
        l_0x51a0:
            ...
            ii(0x51a5, 2);    if(jaew(0x5182, -0x25)) goto l_0x5182;    /* jae 0x5932 */
            ...
            ii(0x51b2, 3);    callw(0x50a8, -0x10d);                    /* call 0x5858 */
            ...
            ii(0x51c2, 3);    callw(0x50a8, -0x11d);                    /* call 0x5858 */
            ...
            ii(0x51d1, 2);    if(jnzw(0x51e5, 0x12)) goto l_0x51e5;     /* jnz 0x5995 */
            ii(0x51d3, 5);    test(memb_a16[ds, 0x47], 0x80);           /* test byte [0x47], 0x80 */
            ii(0x51d8, 2);    if(jnzw(0x51e5, 0xb)) goto l_0x51e5;      /* jnz 0x5995 */
            ii(0x51da, 3);    pushw(memw_a16[ss, bp - 0xa]);            /* push word [bp-0xa] */
            ii(0x51dd, 3);    pushw(memw_a16[ss, bp - 0xc]);            /* push word [bp-0xc] */
            ii(0x51e0, 3);    callw(0x50a8, -0x13b);                    /* call 0x5858 */
            ii(0x51e3, 1);    popw(bx);                                 /* pop bx */
            ii(0x51e4, 1);    popw(bx);                                 /* pop bx */
        l_0x51e5:
            ii(0x51e5, 3);    callw(0x4a28, -0x7c0);                    /* call 0x51d8 */
            ii(0x51e8, 3);    callw(0x47b1, -0xa3a);                    /* call 0x4f61 */
            ii(0x51eb, 5);    cmp(memb_a16[ds, 0x11d8], 0);             /* cmp byte [0x11d8], 0x0 */
            ii(0x51f0, 2);    if(jnzw(0x521f, 0x2d)) goto l_0x521f;     /* jnz 0x59cf */
            ii(0x51f2, 3);    mov(ax, memw_a16[ds, 0x990]);             /* mov ax, [0x990] */
            ii(0x51f5, 4);    or(ax, memw_a16[ds, 0x98e]);              /* or ax, [0x98e] */
            ii(0x51f9, 2);    if(jzw(0x521f, 0x24)) goto l_0x521f;      /* jz 0x59cf */
            ii(0x51fb, 5);    cmp(memw_a16[ds, 0x990], 0x10);           /* cmp word [0x990], 0x10 */
            ii(0x5200, 2);    if(jgw(0x521f, 0x1d)) goto l_0x521f;      /* jg 0x59cf */
            ii(0x5202, 2);    if(jgew(0x521f, 0x1b)) goto l_0x521f;     /* jge 0x59cf */
            ...
            ii(0x520d, 3);    callw(0x5da0, 0xb90);                     /* call 0x6550 */
            ii(0x5210, 1);    pushw(ax);                                /* push ax */
            ii(0x5211, 3);    callw(0x5076, -0x19e);                    /* call 0x5826 */
            ii(0x5214, 1);    popw(bx);                                 /* pop bx */
            ii(0x5215, 2);    or(ax, ax);                               /* or ax, ax */
            ii(0x5217, 2);    if(jnzw(0x521f, 0x6)) goto l_0x521f;      /* jnz 0x59cf */
            ii(0x5219, 2);    pushw(0x16);                              /* push 0x16 */
            ii(0x521b, 3);    callw(0x589d, 0x67f);                     /* call 0x604d */
