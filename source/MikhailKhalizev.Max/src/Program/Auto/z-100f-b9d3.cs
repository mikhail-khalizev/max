...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x100f_babd:
            ii(0x100f_babd, 4); mov(memb[ss, ebp - 0xc], 3);            /* mov byte [ebp-0xc], 0x3 */
        ...
        l_0x100f_bad7:
            ii(0x100f_bad7, 4); cmp(memb[ss, ebp - 0x10], 4);           /* cmp byte [ebp-0x10], 0x4 */
            ii(0x100f_badb, 2); if(jnz(0x100f_bae3, 6)) goto l_0x100f_bae3; /* jnz 0x100fbae3 */
            ii(0x100f_badd, 4); cmp(memb[ss, ebp - 0x14], 4);           /* cmp byte [ebp-0x14], 0x4 */
        ...
        l_0x100f_bae7:
            ii(0x100f_bae7, 4); mov(memb[ss, ebp - 0xc], 2);            /* mov byte [ebp-0xc], 0x2 */
