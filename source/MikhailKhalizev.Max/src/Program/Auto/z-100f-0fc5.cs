...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_0fc5()
        {
            ...
            ii(0x100f_0fdd, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x100f_0fe4, 2); jmp(0x100f_0fec, 0x6); goto l_0x100f_0fec; /* jmp 0x100f0fec */
        l_0x100f_0fe6:
            ii(0x100f_0fe6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_0fe9, 3); inc(memd[ss, ebp - 0x4]);               /* inc dword [ebp-0x4] */
        l_0x100f_0fec:
            ii(0x100f_0fec, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_0ff0, 3); cmp(eax, 0x18);                         /* cmp eax, 0x18 */
            ii(0x100f_0ff3, 2); if(jae(0x100f_1049, 0x54)) goto l_0x100f_1049; /* jae 0x100f1049 */
            ii(0x100f_0ff5, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_1005, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_1012, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100f_1015, 4); cmp(memd[ss, ebp - 0x8], 0);            /* cmp dword [ebp-0x8], 0x0 */
            ii(0x100f_1019, 2); if(jz(0x100f_102f, 0x14)) goto l_0x100f_102f; /* jz 0x100f102f */
            ii(0x100f_101b, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100f_101d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100f_102d, 2); jmp(0x100f_1036, 0x7); goto l_0x100f_1036; /* jmp 0x100f1036 */
        l_0x100f_102f:
            ii(0x100f_102f, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
        l_0x100f_1036:
            ii(0x100f_1036, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
