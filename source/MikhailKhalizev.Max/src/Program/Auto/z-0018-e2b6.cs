...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_e2b6()
        {
            ...
            ii(0x18_e2ba, 2); if(jnz(0x18_e2bf, 0x3)) goto l_0x18_e2bf; /* jnz 0xe2bf */
        ...
        l_0x18_e2bf:
            ...
            ii(0x18_e2ce, 3); mov(ax, memw[ds, bx + 0x5]);              /* mov ax, [bx+0x5] */
            ii(0x18_e2d1, 3); and(ax, 0xf00);                           /* and ax, 0xf00 */
            ii(0x18_e2d4, 3); and(ch, 0xf0);                            /* and ch, 0xf0 */
            ii(0x18_e2d7, 2); or(ax, cx);                               /* or ax, cx */
            ii(0x18_e2d9, 3); mov(memw[ds, bx + 0x5], ax);              /* mov [bx+0x5], ax */
            ii(0x18_e2dc, 3); if(jmp_func(0x18_e067, -0x278)) return;   /* jmp 0xe067 */
        }
    }
}
