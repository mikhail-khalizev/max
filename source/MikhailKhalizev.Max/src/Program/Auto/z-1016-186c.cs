...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_186c()
        {
            ...
            ii(0x1016_1884, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1016_1887, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1016_1890, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1016_1899, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_189c, 4); mov(memb[ds, eax + 0x2d], 0);           /* mov byte [eax+0x2d], 0x0 */
            ii(0x1016_18a0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1016_18aa:
            ii(0x1016_18aa, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_18ad, 4); mov(memb[ds, eax + 0x2d], 0x4);         /* mov byte [eax+0x2d], 0x4 */
            ii(0x1016_18b1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
