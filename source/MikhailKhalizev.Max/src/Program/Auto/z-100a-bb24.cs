...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_bb24()
        {
            ...
            ii(0x100a_bb3c, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_bb3f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_bb41, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_bb52, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100a_bb55, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_bb6a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_bb77, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_bb7a, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x100a_bb7d, 5); call(0x1008_af84, -0x2_0bfe);           /* call 0x1008af84 */
            ii(0x100a_bb82, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ii(0x100a_bb85, 3); call_abs(memd[ds, ebx + 0x1b]);         /* call dword [ebx+0x1b] */
            ii(0x100a_bb88, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_bb8a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_bb97, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_bb9a, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x100a_bb9d, 5); call(0x1008_afe4, -0x2_0bbe);           /* call 0x1008afe4 */
            ii(0x100a_bba2, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
