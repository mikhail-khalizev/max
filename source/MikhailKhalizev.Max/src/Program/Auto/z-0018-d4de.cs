...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_d4de()
        {
            ...
            ii(0x18_d4e4, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x18_d4e7, 3); dec(memw[ss, bp + 0x6]);                  /* dec word [bp+0x6] */
            ii(0x18_d4ea, 3); cmp(ax, memw[ss, bp + 0x4]);              /* cmp ax, [bp+0x4] */
            ii(0x18_d4ed, 2); if(jnz(0x18_d4f2, 0x3)) goto l_0x18_d4f2; /* jnz 0xd4f2 */
            ii(0x18_d4ef, 3); jmp(0x18_d581, 0x8f); goto l_0x18_d581;   /* jmp 0xd581 */
        l_0x18_d4f2:
            ii(0x18_d4f2, 3); lea(ax, memw[ss, bp - 0x12]);             /* lea ax, [bp-0x12] */
            ii(0x18_d4f5, 1); push(ax);                                 /* push ax */
            ii(0x18_d4f6, 4); mov(cx, memw[ds, 0xc38]);                 /* mov cx, [0xc38] */
            ii(0x18_d4fa, 3); mov(memw[ss, bp - 0x2], cx);              /* mov [bp-0x2], cx */
            ...
            ii(0x18_d503, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x18_d506, 3); shr(ax, 0xc);                             /* shr ax, 0xc */
            ii(0x18_d509, 3); mov(cx, memw[ss, bp + 0x6]);              /* mov cx, [bp+0x6] */
            ii(0x18_d50c, 3); shl(cx, 0x4);                             /* shl cx, 0x4 */
            ii(0x18_d50f, 3); mov(memw[ss, bp - 0x12], cx);             /* mov [bp-0x12], cx */
            ii(0x18_d512, 3); mov(memw[ss, bp - 0x10], ax);             /* mov [bp-0x10], ax */
            ii(0x18_d515, 3); lea(ax, memw[ss, bp - 0x12]);             /* lea ax, [bp-0x12] */
            ii(0x18_d518, 1); push(ax);                                 /* push ax */
            ii(0x18_d519, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x18_d51c, 3); call(0x18_dc28, 0x709);                   /* call 0xdc28 */
            ii(0x18_d51f, 1); pop(bx);                                  /* pop bx */
            ii(0x18_d520, 1); pop(bx);                                  /* pop bx */
            ii(0x18_d521, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0x18_d524, 2); sub(bx, bx);                              /* sub bx, bx */
            ii(0x18_d526, 2); mov(es, ax);                              /* mov es, ax */
            ii(0x18_d528, 3); mov(memw[ss, bp - 0x8], bx);              /* mov [bp-0x8], bx */
            ii(0x18_d52b, 3); mov(memw[ss, bp - 0x6], es);              /* mov [bp-0x6], es */
            ii(0x18_d52e, 4); cmp(memb[es, bx], 0x4d);                  /* cmp byte [es:bx], 0x4d */
            ii(0x18_d532, 2); if(jz(0x18_d53a, 0x6)) goto l_0x18_d53a;  /* jz 0xd53a */
            ii(0x18_d534, 4); cmp(memb[es, bx], 0x5a);                  /* cmp byte [es:bx], 0x5a */
            ii(0x18_d538, 2); if(jnz(0x18_d581, 0x47)) goto l_0x18_d581; /* jnz 0xd581 */
        l_0x18_d53a:
            ii(0x18_d53a, 3); mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
            ii(0x18_d53d, 3); sub(ax, memw[ss, bp + 0x6]);              /* sub ax, [bp+0x6] */
            ii(0x18_d540, 1); dec(ax);                                  /* dec ax */
            ii(0x18_d541, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x18_d544, 3); shl(ax, 0x4);                             /* shl ax, 0x4 */
            ii(0x18_d547, 3); add(ax, memw[ss, bp - 0x8]);              /* add ax, [bp-0x8] */
            ii(0x18_d54a, 2); mov(dx, es);                              /* mov dx, es */
            ii(0x18_d54c, 3); mov(cx, memw[ss, bp - 0x8]);              /* mov cx, [bp-0x8] */
            ...
            ii(0x18_d568, 3); mov(di, memw[ss, bp - 0x4]);              /* mov di, [bp-0x4] */
            ii(0x18_d56b, 1); dec(di);                                  /* dec di */
            ii(0x18_d56c, 4); mov(memw[es, si + 0x3], di);              /* mov [es:si+0x3], di */
            ii(0x18_d570, 6); mov(memw[es, si + 0x1], 0);               /* mov word [es:si+0x1], 0x0 */
            ii(0x18_d576, 2); mov(es, dx);                              /* mov es, dx */
            ii(0x18_d578, 2); mov(si, ax);                              /* mov si, ax */
            ii(0x18_d57a, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0x18_d57d, 4); sub(memw[es, si + 0x3], ax);              /* sub [es:si+0x3], ax */
        l_0x18_d581:
