...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("fca00c62-9a4a-46b8-aefb-342a34773f7d")]
        public void Method_0000_50a8()
        {
            ...
            ii(0x50b4, 2);    if(jzw(0x50f8, 0x42)) goto l_0x50f8;      /* jz 0x58a8 */
            ...
            ii(0x50c4, 2);    if(jnzw(0x50ca, 0x4)) goto l_0x50ca;      /* jnz 0x587a */
            ii(0x50c6, 2);    or(ax, ax);                               /* or ax, ax */
            ii(0x50c8, 2);    if(jzw(0x50f8, 0x2e)) goto l_0x50f8;      /* jz 0x58a8 */
        l_0x50ca:
            ii(0x50ca, 3);    pushw(memw_a16[es, bx]);                  /* push word [es:bx] */
            ii(0x50cd, 3);    callw(0x47cd, -0x903);                    /* call 0x4f7d */
            ...
            ii(0x50f0, 3);    callw(0x5da0, 0xcad);                     /* call 0x6550 */
            ii(0x50f3, 1);    pushw(dx);                                /* push dx */
            ii(0x50f4, 1);    pushw(ax);                                /* push ax */
            ii(0x50f5, 3);    callw(0x545d, 0x365);                     /* call 0x5c0d */
        l_0x50f8:
