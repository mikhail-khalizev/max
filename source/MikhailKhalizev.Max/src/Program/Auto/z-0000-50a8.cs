...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x50a8, 4);    enter(0x2, 0);                            /* enter 0x2, 0x0 */
            ii(0x50ac, 3);    les(bx, memw[ss, bp + 0x4]);              /* les bx, [bp+0x4] */
            ii(0x50af, 5);    test(memb[es, bx + 0x5], 0x10);           /* test byte [es:bx+0x5], 0x10 */
            ii(0x50b4, 2);    if(jz(0x50f8, 0x42)) goto l_0x50f8;       /* jz 0x50f8 */
            ii(0x50b6, 4);    mov(al, memb[es, bx + 0x7]);              /* mov al, [es:bx+0x7] */
            ii(0x50ba, 2);    sub(ah, ah);                              /* sub ah, ah */
            ii(0x50bc, 3);    mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ii(0x50bf, 5);    test(memb[es, bx + 0x4], 0xf0);           /* test byte [es:bx+0x4], 0xf0 */
            ii(0x50c4, 2);    if(jnz(0x50ca, 0x4)) goto l_0x50ca;       /* jnz 0x50ca */
        ...
        l_0x50ca:
            ...
            ii(0x50d4, 3);    les(bx, memw[ss, bp + 0x4]);              /* les bx, [bp+0x4] */
            ii(0x50d7, 4);    mov(ax, memw[es, bx + 0x2]);              /* mov ax, [es:bx+0x2] */
            ii(0x50db, 4);    mov(dx, memw[es, bx + 0x4]);              /* mov dx, [es:bx+0x4] */
            ii(0x50df, 2);    and(al, 0xf0);                            /* and al, 0xf0 */
            ii(0x50e1, 2);    sub(dh, dh);                              /* sub dh, dh */
            ii(0x50e3, 3);    mov(ch, memb[ss, bp - 0x2]);              /* mov ch, [bp-0x2] */
