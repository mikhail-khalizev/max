...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_4bdf()
        {
            ...
            ii(0x100e_4bf7, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_4bfa, 7); cmp(memd[ds, 0x101b_7f14], 0);          /* cmp dword [0x101b7f14], 0x0 */
            ii(0x100e_4c01, 2); if(jnz(0x100e_4c0c, 0x9)) goto l_0x100e_4c0c; /* jnz 0x100e4c0c */
            ii(0x100e_4c03, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x100e_4c0a, 2); jmp(0x100e_4c26, 0x1a); goto l_0x100e_4c26; /* jmp 0x100e4c26 */
        l_0x100e_4c0c:
            ii(0x100e_4c0c, 7); cmp(memd[ss, ebp - 0x8], 0x400);        /* cmp dword [ebp-0x8], 0x400 */
            ii(0x100e_4c13, 2); if(jbe(0x100e_4c1e, 0x9)) goto l_0x100e_4c1e; /* jbe 0x100e4c1e */
            ii(0x100e_4c15, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x100e_4c1c, 2); jmp(0x100e_4c26, 0x8); goto l_0x100e_4c26; /* jmp 0x100e4c26 */
        l_0x100e_4c1e:
            ii(0x100e_4c1e, 5); mov(eax, memd[ds, 0x101b_7f14]);        /* mov eax, [0x101b7f14] */
            ii(0x100e_4c23, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
        l_0x100e_4c26:
            ii(0x100e_4c26, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
