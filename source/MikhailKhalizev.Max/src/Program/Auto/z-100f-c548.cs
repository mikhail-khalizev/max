...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_c548()
        {
            ...
            ii(0x100f_c568, 3); mov(al, memb[ds, eax + 20]);            /* mov al, [eax+0x14] */
            ...
            ii(0x100f_c57d, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100f_c580, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
