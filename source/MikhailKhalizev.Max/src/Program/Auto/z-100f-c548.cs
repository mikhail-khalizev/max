...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_c548()
        {
            ...
            ii(0x100f_c55f, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100f_c562, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x100f_c565, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_c568, 3); mov(al, memb[ds, eax + 0x14]);          /* mov al, [eax+0x14] */
            ii(0x100f_c56b, 2); sub(al, 0x9);                           /* sub al, 0x9 */
            ii(0x100f_c56d, 3); add(al, memb[ss, ebp - 0x4]);           /* add al, [ebp-0x4] */
