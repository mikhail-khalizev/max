...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_7ca6()
        {
            ...
            ii(0x1008_7cb8, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1008_7cbe, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1008_7cc1, 4); mov(memb[ss, ebp - 8], 0xa);            /* mov byte [ebp-0x8], 0xa */
            ii(0x1008_7cc5, 3); mov(al, memb[ss, ebp - 8]);             /* mov al, [ebp-0x8] */
