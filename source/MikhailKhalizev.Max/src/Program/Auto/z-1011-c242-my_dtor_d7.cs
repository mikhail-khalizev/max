...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void my_dtor_d7()
        {
            ...
            ii(0x1011_c259, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_c25c, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1011_c25f, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1011_c266, 2); jmp(0x1011_c26e, 0x6); goto l_0x1011_c26e; /* jmp 0x1011c26e */
        l_0x1011_c268:
            ii(0x1011_c268, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1011_c26b, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x1011_c26e:
            ii(0x1011_c26e, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1011_c27a, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1011_c27e, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1011_c281, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1011_c283, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1011_c291, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x1011_c295, 3); shl(edx, 0x2);                          /* shl edx, 0x2 */
            ii(0x1011_c298, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_c29b, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
        ...
        l_0x1011_c2a9:
            ii(0x1011_c2a9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_c2ac, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1011_c2ae, 5); call(Definitions.sys_delete, 0x4_9cb1); /* call 0x10165f64 */
            ii(0x1011_c2b3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_c2b6, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
            ii(0x1011_c2b9, 5); call(Definitions.sys_delete, 0x4_9ca6); /* call 0x10165f64 */
            ii(0x1011_c2be, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_c2c1, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ii(0x1011_c2c4, 5); call(Definitions.sys_delete, 0x4_9c9b); /* call 0x10165f64 */
            ii(0x1011_c2c9, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_c2cb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1011_c2d9, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_c2dc, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_c2df, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1011_c2e2, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
