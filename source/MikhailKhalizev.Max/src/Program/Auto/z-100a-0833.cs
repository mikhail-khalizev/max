...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_0833()
        {
            ...
            ii(0x100a_0844, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100a_084a, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100a_084d, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x100a_0850, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_0853, 5); call(0x1007_6204, -0x2_a654);           /* call 0x10076204 */
            ii(0x100a_0858, 3); mov(ebx, memd[ss, ebp - 8]);            /* mov ebx, [ebp-0x8] */
            ii(0x100a_085b, 3); add(ebx, 2);                            /* add ebx, 0x2 */
            ...
            ii(0x100a_086b, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_086e, 3); mov(eax, memd[ds, eax + 6]);            /* mov eax, [eax+0x6] */
            ...
            ii(0x100a_087c, 2); if(jl(0x100a_0880, 2)) goto l_0x100a_0880; /* jl 0x100a0880 */
        l_0x100a_087e:
            ii(0x100a_087e, 2); jmp(0x100a_08c6, 0x46); goto l_0x100a_08c6; /* jmp 0x100a08c6 */
        l_0x100a_0880:
            ii(0x100a_0880, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_0883, 5); cmp(memw[ds, eax + 8], 2);              /* cmp word [eax+0x8], 0x2 */
            ii(0x100a_0888, 2); if(jnz(0x100a_08a9, 0x1f)) goto l_0x100a_08a9; /* jnz 0x100a08a9 */
            ii(0x100a_088a, 3); mov(ecx, memd[ss, ebp - 8]);            /* mov ecx, [ebp-0x8] */
            ii(0x100a_088d, 6); add(ecx, 0x373);                        /* add ecx, 0x373 */
            ii(0x100a_0893, 3); mov(ebx, memd[ss, ebp - 8]);            /* mov ebx, [ebp-0x8] */
            ii(0x100a_0896, 6); add(ebx, 0x36f);                        /* add ebx, 0x36f */
            ii(0x100a_089c, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x100a_089f, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
        ...
        l_0x100a_08a9:
            ii(0x100a_08a9, 3); mov(ecx, memd[ss, ebp - 8]);            /* mov ecx, [ebp-0x8] */
            ii(0x100a_08ac, 6); add(ecx, 0x371);                        /* add ecx, 0x371 */
            ii(0x100a_08b2, 3); mov(ebx, memd[ss, ebp - 8]);            /* mov ebx, [ebp-0x8] */
            ii(0x100a_08b5, 6); add(ebx, 0x36d);                        /* add ebx, 0x36d */
            ii(0x100a_08bb, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x100a_08be, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
