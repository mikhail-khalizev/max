...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_6bc0()
        {
            ...
            ii(0x1007_6bd8, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_6bdb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_6bde, 5); call(0x1007_6c68, 0x85);                /* call 0x10076c68 */
            ii(0x1007_6be3, 3); lea(edx, memd[ds, eax + 0xe]);          /* lea edx, [eax+0xe] */
            ii(0x1007_6be6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
