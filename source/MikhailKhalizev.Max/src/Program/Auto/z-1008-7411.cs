...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_7411()
        {
            ...
            ii(0x1008_7423, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1008_7429, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_742c, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_742f, 3);  add(eax, 0x13);                       /* add eax, 0x13 */
            ii(0x1008_7432, 5);  call(0x1013_a794, 0xb_335d);          /* call 0x1013a794 */
            ii(0x1008_7437, 3);  sub(eax, 6);                          /* sub eax, 0x6 */
            ii(0x1008_743a, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_743d, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
