...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_1bf2()
        {
            ...
            ii(0x100b_1c08, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ...
            ii(0x100b_1c19, 3);  lea(ebx, memd[ss, ebp - 24]);         /* lea ebx, [ebp-0x18] */
            ...
            ii(0x100b_1c25, 3);  lea(edx, memd[ss, ebp - 36]);         /* lea edx, [ebp-0x24] */
            ii(0x100b_1c28, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        ...
        l_0x100b_1c6a:
            ii(0x100b_1c6a, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
        ...
        l_0x100b_1c8c:
            ii(0x100b_1c8c, 4);  mov(memb[ss, ebp - 16], 0);           /* mov byte [ebp-0x10], 0x0 */
            ii(0x100b_1c90, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_1c92, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        ...
        l_0x100b_1c9f:
            ii(0x100b_1c9f, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
            ii(0x100b_1ca2, 4);  cmp(ax, memw[ss, ebp - 36]);          /* cmp ax, [ebp-0x24] */
            ii(0x100b_1ca6, 2);  if(jnz(0x100b_1cb1, 9)) goto l_0x100b_1cb1;/* jnz 0x100b1cb1 */
            ii(0x100b_1ca8, 3);  mov(eax, memd[ss, ebp - 30]);         /* mov eax, [ebp-0x1e] */
            ii(0x100b_1cab, 4);  cmp(ax, memw[ss, ebp - 34]);          /* cmp ax, [ebp-0x22] */
        ...
        l_0x100b_1cb3:
            ii(0x100b_1cb3, 4);  mov(memb[ss, ebp - 16], 0);           /* mov byte [ebp-0x10], 0x0 */
            ii(0x100b_1cb7, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_1cb9, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        ...
        l_0x100b_1cc6:
            ii(0x100b_1cc6, 3);  lea(edx, memd[ss, ebp - 32]);         /* lea edx, [ebp-0x20] */
            ii(0x100b_1cc9, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x100b_1ce1, 4);  mov(memb[ss, ebp - 16], 0);           /* mov byte [ebp-0x10], 0x0 */
            ii(0x100b_1ce5, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_1ce7, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        ...
        l_0x100b_1cf4:
            ii(0x100b_1cf4, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x100b_1cfe, 3);  lea(edx, memd[ss, ebp - 36]);         /* lea edx, [ebp-0x24] */
            ii(0x100b_1d01, 3);  lea(eax, memd[ss, ebp - 40]);         /* lea eax, [ebp-0x28] */
            ...
            ii(0x100b_1d15, 3);  mov(memb[ss, ebp - 16], al);          /* mov [ebp-0x10], al */
            ii(0x100b_1d18, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_1d1a, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        ...
        l_0x100b_1d27:
            ...
            ii(0x100b_1d30, 4);  movsx(eax, memw[ss, ebp - 34]);       /* movsx eax, word [ebp-0x22] */
            ...
            ii(0x100b_1d47, 4);  movsx(eax, memw[ss, ebp - 36]);       /* movsx eax, word [ebp-0x24] */
            ...
            ii(0x100b_1d58, 4);  movsx(eax, memw[ss, ebp - 34]);       /* movsx eax, word [ebp-0x22] */
            ...
            ii(0x100b_1d67, 4);  movsx(eax, memw[ss, ebp - 36]);       /* movsx eax, word [ebp-0x24] */
            ...
            ii(0x100b_1d74, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
            ii(0x100b_1d77, 5);  call(0x1008_b148, -0x2_6c34);         /* call 0x1008b148 */
            ii(0x100b_1d7c, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x100b_1d7f, 5);  call(Definitions.my_ctor_0x101b_4184, -0x3_b294);/* call 0x10076af0 */
            ii(0x100b_1d84, 3);  mov(eax, memd[ss, ebp - 56]);         /* mov eax, [ebp-0x38] */
            ii(0x100b_1d87, 4);  mov(memw[ss, ebp - 20], ax);          /* mov [ebp-0x14], ax */
            ii(0x100b_1d8b, 2);  jmp(0x100b_1d94, 7); goto l_0x100b_1d94;/* jmp 0x100b1d94 */
        l_0x100b_1d8d:
            ii(0x100b_1d8d, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100b_1d90, 4);  inc(memw[ss, ebp - 20]);              /* inc word [ebp-0x14] */
        l_0x100b_1d94:
            ii(0x100b_1d94, 4);  movsx(eax, memw[ss, ebp - 20]);       /* movsx eax, word [ebp-0x14] */
            ii(0x100b_1d98, 3);  cmp(eax, memd[ss, ebp - 48]);         /* cmp eax, [ebp-0x30] */
            ii(0x100b_1d9b, 2);  if(jge(0x100b_1de5, 0x48)) goto l_0x100b_1de5;/* jge 0x100b1de5 */
            ii(0x100b_1d9d, 3);  mov(eax, memd[ss, ebp - 52]);         /* mov eax, [ebp-0x34] */
            ii(0x100b_1da0, 4);  mov(memw[ss, ebp - 18], ax);          /* mov [ebp-0x12], ax */
            ii(0x100b_1da4, 2);  jmp(0x100b_1dad, 7); goto l_0x100b_1dad;/* jmp 0x100b1dad */
        l_0x100b_1da6:
            ii(0x100b_1da6, 3);  mov(eax, memd[ss, ebp - 18]);         /* mov eax, [ebp-0x12] */
            ii(0x100b_1da9, 4);  inc(memw[ss, ebp - 18]);              /* inc word [ebp-0x12] */
        l_0x100b_1dad:
            ii(0x100b_1dad, 4);  movsx(eax, memw[ss, ebp - 18]);       /* movsx eax, word [ebp-0x12] */
            ii(0x100b_1db1, 3);  cmp(eax, memd[ss, ebp - 44]);         /* cmp eax, [ebp-0x2c] */
            ii(0x100b_1db4, 2);  if(jge(0x100b_1de3, 0x2d)) goto l_0x100b_1de3;/* jge 0x100b1de3 */
            ii(0x100b_1db6, 3);  lea(edx, memd[ss, ebp - 20]);         /* lea edx, [ebp-0x14] */
            ii(0x100b_1db9, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
            ...
            ii(0x100b_1dd1, 4);  mov(memb[ss, ebp - 16], 1);           /* mov byte [ebp-0x10], 0x1 */
            ii(0x100b_1dd5, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_1dd7, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        ...
        l_0x100b_1de5:
            ii(0x100b_1de5, 4);  mov(memb[ss, ebp - 16], 0);           /* mov byte [ebp-0x10], 0x0 */
            ii(0x100b_1de9, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_1deb, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        ...
        //  ii(0x100b_1df7, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        //  ii(0x100b_1dfa, 5);  call(0x1008_8d4c, -0x2_90b3);         /* call 0x10088d4c */
        l_0x100b_1dff:
            ii(0x100b_1dff, 3);  mov(al, memb[ss, ebp - 16]);          /* mov al, [ebp-0x10] */
