...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_b434()
        {
            ...
            ii(0x100a_b44b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_b44e, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_b451, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_b454, 3); movsx(edx, memw[ds, eax]);              /* movsx edx, word [eax] */
            ii(0x100a_b457, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_b461, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_b464, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x100a_b466, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100a_b469, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_b473, 2); if(jz(0x100a_b477, 0x2)) goto l_0x100a_b477; /* jz 0x100ab477 */
        l_0x100a_b475:
            ii(0x100a_b475, 2); jmp(0x100a_b47d, 0x6); goto l_0x100a_b47d; /* jmp 0x100ab47d */
        l_0x100a_b477:
            ii(0x100a_b477, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x100a_b47b, 2); jmp(0x100a_b481, 0x4); goto l_0x100a_b481; /* jmp 0x100ab481 */
        l_0x100a_b47d:
            ii(0x100a_b47d, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
        l_0x100a_b481:
            ii(0x100a_b481, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
            ii(0x100a_b484, 3); mov(memb[ss, ebp - 0x10], al);          /* mov [ebp-0x10], al */
            ii(0x100a_b487, 3); mov(al, memb[ss, ebp - 0x10]);          /* mov al, [ebp-0x10] */
