...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("5bb271e8-66c4-4985-a2a6-ee84a25add9d")]
        public void /* sys */ Method_1019_ab72()
        {
            ii(0x1019_ab72, 1); pushd(ebx);                             /* push ebx */
            ii(0x1019_ab73, 1); pushd(ecx);                             /* push ecx */
            ii(0x1019_ab74, 1); pushd(edx);                             /* push edx */
            ii(0x1019_ab75, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x1019_ab77, 3); test(bl, 0x3);                          /* test bl, 0x3 */
            ii(0x1019_ab7a, 2); if(jnzd(0x1019_aba7, 0x2b)) goto l_0x1019_aba7; /* jnz 0x1019aba7 */
            ...
            ii(0x1019_ab8a, 2); if(jzd(0x1019_ab95, 0x9)) goto l_0x1019_ab95; /* jz 0x1019ab95 */
        l_0x1019_ab8c:
            ii(0x1019_ab8c, 5); mov(eax, 0x1);                          /* mov eax, 0x1 */
            ii(0x1019_ab91, 1); popd(edx);                              /* pop edx */
            ii(0x1019_ab92, 1); popd(ecx);                              /* pop ecx */
            ii(0x1019_ab93, 1); popd(ebx);                              /* pop ebx */
            ii(0x1019_ab94, 1); retd(); return;                         /* ret */
        l_0x1019_ab95:
            ...
            ii(0x1019_aba5, 2); if(jzd(0x1019_ab8c, -0x1b)) goto l_0x1019_ab8c; /* jz 0x1019ab8c */
        l_0x1019_aba7:
            ii(0x1019_aba7, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1019_aba9, 1); popd(edx);                              /* pop edx */
            ii(0x1019_abaa, 1); popd(ecx);                              /* pop ecx */
            ii(0x1019_abab, 1); popd(ebx);                              /* pop ebx */
            ii(0x1019_abac, 1); retd(); return;                         /* ret */
        }
    }
}
