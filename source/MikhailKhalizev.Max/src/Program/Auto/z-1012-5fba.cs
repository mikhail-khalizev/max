...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_5fba()
        {
            ...
            ii(0x1012_5fd1, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_5fd4, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1012_5fd7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_5fda, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1012_5fdd, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1012_5fe0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_5fe3, 5); call(0x1012_5ebb, -0x12d);              /* call 0x10125ebb */
            ii(0x1012_5fe8, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1012_5feb, 4); mov(dx, memw[ds, eax + 0x7]);           /* mov dx, [eax+0x7] */
            ii(0x1012_5fef, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_5ff2, 4); mov(memw[ds, eax + 0x41], dx);          /* mov [eax+0x41], dx */
            ii(0x1012_5ff6, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1012_5ff9, 4); mov(dx, memw[ds, eax + 0x9]);           /* mov dx, [eax+0x9] */
            ii(0x1012_5ffd, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_6000, 4); mov(memw[ds, eax + 0x43], dx);          /* mov [eax+0x43], dx */
            ii(0x1012_6004, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1012_6007, 3); mov(eax, memd[ds, eax + 0x9]);          /* mov eax, [eax+0x9] */
            ...
            ii(0x1012_6013, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1012_601d:
            ii(0x1012_601d, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1012_6020, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1012_6022, 4); mov(dx, memw[ds, eax + 0xb]);           /* mov dx, [eax+0xb] */
            ...
            ii(0x1012_6032, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_6035, 5); call(0x1007_60ac, -0xa_ff8e);           /* call 0x100760ac */
        l_0x1012_603a:
            ii(0x1012_603a, 7); mov(memd[ss, ebp - 0xc], 0xd);          /* mov dword [ebp-0xc], 0xd */
            ii(0x1012_6041, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
