...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_433b()
        {
            ...
            ii(0x1016_4353, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1016_4356, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_4359, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x1016_435c, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1016_435f, 3); cmp(eax, 0x47);                         /* cmp eax, 0x47 */
            ii(0x1016_4362, 2); if(jnz(0x1016_436a, 0x6)) goto l_0x1016_436a; /* jnz 0x1016436a */
            ii(0x1016_4364, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x1016_4368, 2); jmp(0x1016_43af, 0x45); goto l_0x1016_43af; /* jmp 0x101643af */
        l_0x1016_436a:
            ii(0x1016_436a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_436d, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1016_4378, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_437b, 3); mov(edx, memd[ds, eax + 0x1a]);         /* mov edx, [eax+0x1a] */
            ii(0x1016_437e, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1016_4381, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_4384, 3); mov(eax, memd[ds, eax + 0x18]);         /* mov eax, [eax+0x18] */
            ...
            ii(0x1016_4397, 2); if(jnz(0x1016_439f, 0x6)) goto l_0x1016_439f; /* jnz 0x1016439f */
            ii(0x1016_4399, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1016_439d, 2); jmp(0x1016_43a3, 0x4); goto l_0x1016_43a3; /* jmp 0x101643a3 */
        l_0x1016_439f:
            ii(0x1016_439f, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
        l_0x1016_43a3:
            ii(0x1016_43a3, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
            ii(0x1016_43a6, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x1016_43a9, 2); jmp(0x1016_43af, 0x4); goto l_0x1016_43af; /* jmp 0x101643af */
        l_0x1016_43ab:
            ii(0x1016_43ab, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x1016_43af:
            ii(0x1016_43af, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
