...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ sys_sqrt()
        {
            ...
            ii(0x1016_6051, 3); fnstsw(memw[ss, ebp - 0x8]);            /* fnstsw word [ebp-0x8] */
            ii(0x1016_6054, 1); wait();                                 /* wait */
            ii(0x1016_6055, 4); xchg(memw[ss, ebp - 0x8], ax);          /* xchg [ebp-0x8], ax */
            ii(0x1016_6059, 1); sahf();                                 /* sahf */
            ii(0x1016_605a, 2); if(jae(0x1016_6075, 0x19)) goto l_0x1016_6075; /* jae 0x10166075 */
            ii(0x1016_605c, 3); fstp(memq[ss, ebp - 0x10]);             /* fstp qword [ebp-0x10] */
            ii(0x1016_605f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_6062, 2); cmp(al, 0x3);                           /* cmp al, 0x3 */
            ii(0x1016_6064, 2); if(jz(0x1016_6069, 0x3)) goto l_0x1016_6069; /* jz 0x10166069 */
            ii(0x1016_6066, 3); fstp(memq[ss, ebp - 0x10]);             /* fstp qword [ebp-0x10] */
        l_0x1016_6069:
            ii(0x1016_6069, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1016_606c, 5); call(/* sys */ 0x1018_1f17, 0x1_bea6);  /* call 0x10181f17 */
            ii(0x1016_6071, 2); mov(al, 0x1);                           /* mov al, 0x1 */
            ii(0x1016_6073, 2); jmp(0x1016_6079, 0x4); goto l_0x1016_6079; /* jmp 0x10166079 */
        l_0x1016_6075:
