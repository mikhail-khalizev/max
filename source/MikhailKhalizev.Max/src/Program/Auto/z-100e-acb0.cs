...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_acb0()
        {
            ...
            ii(0x100e_acc2, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100e_acc8, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100e_accb, 5); call(0x100e_aecc, 0x1fc);               /* call 0x100eaecc */
            ii(0x100e_acd0, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x100e_acd3, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100e_acd6, 5); call(0x100e_ae78, 0x19d);               /* call 0x100eae78 */
            ii(0x100e_acdb, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100e_acde, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
