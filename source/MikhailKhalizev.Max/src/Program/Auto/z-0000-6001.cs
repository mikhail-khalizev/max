...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("0x6001-d36c2e1d")]
        public void Method_0000_6001()
        {
            ii(0x6001, 3);    call(0x5ff6, -0xe);                       /* call 0x5ff6 */
            ii(0x6004, 4);    mov(sp, memw[ds, 0x996]);                 /* mov sp, [0x996] */
            ii(0x6008, 2);    mov(bp, sp);                              /* mov bp, sp */
            ii(0x600a, 3);    mov(di, memw[ss, bp + 0xe]);              /* mov di, [bp+0xe] */
            ii(0x600d, 5);    mov(memw[cs, 0xc], di);                   /* mov [cs:0xc], di */
            ii(0x6012, 3);    mov(ax, memw[ss, bp + 0x2]);              /* mov ax, [bp+0x2] */
            ii(0x6015, 4);    mov(memw[cs, 0xe], ax);                   /* mov [cs:0xe], ax */
            ii(0x6019, 3);    call(0x6040, 0x24);                       /* call 0x6040 */
            ii(0x601c, 3);    lea(si, memw[ss, bp + 0x1e]);             /* lea si, [bp+0x1e] */
            ii(0x601f, 1);    cld();                                    /* cld */
