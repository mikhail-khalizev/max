...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("6c44b795-ebef-4906-8e6f-efeb7491b6f8")]
        public void Method_100f_b82b()
        {
            ii(0x100f_b82b, 5); pushd(0x1c);                            /* push 0x1c */
            ii(0x100f_b830, 5); calld(Definitions.sys_check_available_stack_size, 0x6_a51d); /* call 0x10165d52 */
            ...
            ii(0x100f_b843, 5); calld(/* sys */ 0x1016_be34, 0x7_05ec); /* call 0x1016be34 */
            ii(0x100f_b848, 5); mov(eax, 0x45);                         /* mov eax, 0x45 */
            ii(0x100f_b84d, 5); calld(0x1007_5fdc, -0x8_5876);          /* call 0x10075fdc */
            ii(0x100f_b852, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100f_b857, 5); calld(0x1013_51c1, 0x3_9965);           /* call 0x101351c1 */
            ...
            ii(0x100f_b876, 5); calld(/* sys */ 0x1016_bcc4, 0x7_0449); /* call 0x1016bcc4 */
