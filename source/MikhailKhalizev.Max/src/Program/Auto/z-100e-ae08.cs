...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_ae08()
        {
            ...
            ii(0x100e_ae1f, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_ae22, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100e_ae25, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_ae28, 2); mov(ebx, memd[ds, eax]);                /* mov ebx, [eax] */
            ii(0x100e_ae2a, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100e_ae2d, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100e_ae30, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_ae33, 5); call(0x100e_ae40, 0x8);                 /* call 0x100eae40 */
