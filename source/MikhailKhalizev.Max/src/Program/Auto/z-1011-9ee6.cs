...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_9ee6()
        {
            ...
            ii(0x1011_9efe, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1011_9f01, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1011_9f04, 5); call(0x1011_806d, -0x1e9c);             /* call 0x1011806d */
            ii(0x1011_9f09, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1011_9f0c, 3); lea(eax, memd[ss, ebp - 4]);            /* lea eax, [ebp-0x4] */
            ii(0x1011_9f0f, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1011_9f12, 5); call(0x100b_83a8, -0x6_1b6f);           /* call 0x100b83a8 */
            ii(0x1011_9f17, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1011_9f1a, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_9f28, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1011_9f2b, 3); lea(eax, memd[ss, ebp - 4]);            /* lea eax, [ebp-0x4] */
            ii(0x1011_9f2e, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1011_9f31, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1011_9f34, 7); mov(memd[ds, eax + 2], 0x101b_6924);    /* mov dword [eax+0x2], 0x101b6924 */
            ii(0x1011_9f3b, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1011_9f3e, 6); mov(memw[ds, eax + 22], 0);             /* mov word [eax+0x16], 0x0 */
            ii(0x1011_9f44, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1011_9f47, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1011_9f4a, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
