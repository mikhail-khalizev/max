...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x9736, 1);    push(di);                                 /* push di */
            ii(0x9737, 1);    push(si);                                 /* push si */
            ii(0x9738, 2);    sub(ax, ax);                              /* sub ax, ax */
            ii(0x973a, 3);    mov(memw[ds, 0x11d0], ax);                /* mov [0x11d0], ax */
            ii(0x973d, 3);    mov(memw[ds, 0x1208], ax);                /* mov [0x1208], ax */
            ii(0x9740, 4);    cmp(memw[ds, 0xa], ax);                   /* cmp [0xa], ax */
