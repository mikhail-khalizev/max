...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("6ea5e631-741c-4a02-b93a-64c4ec45c4fb")]
        public void Method_1010_1103()
        {
            ii(0x1010_1103, 5); pushd(0x2c);                            /* push 0x2c */
            ii(0x1010_1108, 5); calld(Definitions.sys_check_available_stack_size, 0x64c45); /* call 0x10165d52 */
        ...
        l_0x1010_11f3:
            ...
            ii(0x1010_11fe, 1); retd(); return;                         /* ret */
        }
    }
}
