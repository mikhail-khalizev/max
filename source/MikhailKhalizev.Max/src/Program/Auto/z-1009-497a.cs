...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_497a()
        {
            ...
            ii(0x1009_4992, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x1009_49a1, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_49a4, 5); call(0x1007_64b8, -0x1_e4f1);           /* call 0x100764b8 */
            ii(0x1009_49a9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_49ac, 3); add(eax, 0x2b);                         /* add eax, 0x2b */
            ii(0x1009_49af, 5); call(0x1007_20e6, -0x2_28ce);           /* call 0x100720e6 */
            ii(0x1009_49b4, 2); jmp(0x1009_49be, 0x8); goto l_0x1009_49be; /* jmp 0x100949be */
        l_0x1009_49b6:
            ii(0x1009_49b6, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_49b9, 5); call(0x1007_6bf8, -0x1_ddc6);           /* call 0x10076bf8 */
        l_0x1009_49be:
            ii(0x1009_49be, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_49c0, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x1009_49d0, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_49d3, 5); call(0x1007_63a0, -0x1_e638);           /* call 0x100763a0 */
            ii(0x1009_49d8, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_49da, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ii(0x1009_49dd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_49e0, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1009_49ea, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_49ed, 5); call(0x1007_63a0, -0x1_e652);           /* call 0x100763a0 */
            ii(0x1009_49f2, 5); cmp(memw[ds, eax + 0x8], 0x3d);         /* cmp word [eax+0x8], 0x3d */
            ii(0x1009_49f7, 2); if(jz(0x1009_4a08, 0xf)) goto l_0x1009_4a08; /* jz 0x10094a08 */
            ii(0x1009_49f9, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_49fc, 5); call(0x1007_63a0, -0x1_e661);           /* call 0x100763a0 */
            ii(0x1009_4a01, 5); cmp(memw[ds, eax + 0x8], 0x31);         /* cmp word [eax+0x8], 0x31 */
            ii(0x1009_4a06, 2); if(jnz(0x1009_4a0a, 0x2)) goto l_0x1009_4a0a; /* jnz 0x10094a0a */
        l_0x1009_4a08:
            ii(0x1009_4a08, 2); jmp(0x1009_4a0c, 0x2); goto l_0x1009_4a0c; /* jmp 0x10094a0c */
        l_0x1009_4a0a:
            ii(0x1009_4a0a, 2); jmp(0x1009_4a40, 0x34); goto l_0x1009_4a40; /* jmp 0x10094a40 */
        l_0x1009_4a0c:
            ii(0x1009_4a0c, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_4a0f, 5); call(0x1007_63a0, -0x1_e674);           /* call 0x100763a0 */
            ii(0x1009_4a14, 4); mov(dx, memw[ds, eax + 0x52]);          /* mov dx, [eax+0x52] */
            ii(0x1009_4a18, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4a1b, 4); add(memw[ds, eax + 0x2d], dx);          /* add [eax+0x2d], dx */
            ii(0x1009_4a1f, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_4a22, 5); call(0x1007_63a0, -0x1_e687);           /* call 0x100763a0 */
            ii(0x1009_4a27, 5); cmp(memw[ds, eax + 0x8], 0x3d);         /* cmp word [eax+0x8], 0x3d */
            ii(0x1009_4a2c, 2); if(jnz(0x1009_4a38, 0xa)) goto l_0x1009_4a38; /* jnz 0x10094a38 */
            ii(0x1009_4a2e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4a31, 5); sub(memw[ds, eax + 0x2d], 0x14);        /* sub word [eax+0x2d], 0x14 */
            ii(0x1009_4a36, 2); jmp(0x1009_4a40, 0x8); goto l_0x1009_4a40; /* jmp 0x10094a40 */
        l_0x1009_4a38:
            ii(0x1009_4a38, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4a3b, 5); sub(memw[ds, eax + 0x2d], 0x28);        /* sub word [eax+0x2d], 0x28 */
        l_0x1009_4a40:
            ii(0x1009_4a40, 5); jmp(0x1009_49b6, -0x8f); goto l_0x1009_49b6; /* jmp 0x100949b6 */
        l_0x1009_4a45:
            ii(0x1009_4a45, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4a48, 3); mov(edx, memd[ds, eax + 0x2b]);         /* mov edx, [eax+0x2b] */
            ...
            ii(0x1009_4a5d, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_4a60, 4); mov(memw[ds, edx + 0x2d], ax);          /* mov [edx+0x2d], ax */
            ii(0x1009_4a64, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4a67, 5); sub(memw[ds, eax + 0x2f], 0x5);         /* sub word [eax+0x2f], 0x5 */
            ...
            ii(0x1009_4a80, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4a83, 4); sub(memw[ds, eax + 0x2b], dx);          /* sub [eax+0x2b], dx */
        l_0x1009_4a87:
            ii(0x1009_4a87, 5); mov(eax, 0x101c_819c);                  /* mov eax, 0x101c819c */
            ii(0x1009_4a8c, 5); call(0x1007_6338, -0x1_e759);           /* call 0x10076338 */
            ii(0x1009_4a91, 3); lea(ebx, memd[ss, ebp - 0x10]);         /* lea ebx, [ebp-0x10] */
            ...
            ii(0x1009_4a9d, 2); jmp(0x1009_4aa7, 0x8); goto l_0x1009_4aa7; /* jmp 0x10094aa7 */
        l_0x1009_4a9f:
            ii(0x1009_4a9f, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_4aa2, 5); call(0x1007_6bf8, -0x1_deaf);           /* call 0x10076bf8 */
        l_0x1009_4aa7:
            ii(0x1009_4aa7, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_4aa9, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x1009_4ab9, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_4abc, 5); call(0x1007_63a0, -0x1_e721);           /* call 0x100763a0 */
            ii(0x1009_4ac1, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_4ac3, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ii(0x1009_4ac6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4ac9, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1009_4adc, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_4adf, 5); call(0x1007_63a0, -0x1_e744);           /* call 0x100763a0 */
            ii(0x1009_4ae4, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1009_4af1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4af4, 4); sub(memw[ds, eax + 0x2d], dx);          /* sub [eax+0x2d], dx */
            ii(0x1009_4af8, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_4afb, 5); call(0x1007_63a0, -0x1_e760);           /* call 0x100763a0 */
            ii(0x1009_4b00, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1009_4b0d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4b10, 4); sub(memw[ds, eax + 0x2f], dx);          /* sub [eax+0x2f], dx */
            ii(0x1009_4b14, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_4b17, 5); call(0x1007_63a0, -0x1_e77c);           /* call 0x100763a0 */
            ii(0x1009_4b1c, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1009_4b29, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4b2c, 4); sub(memw[ds, eax + 0x2b], dx);          /* sub [eax+0x2b], dx */
            ii(0x1009_4b30, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_4b33, 5); call(0x1007_63a0, -0x1_e798);           /* call 0x100763a0 */
            ii(0x1009_4b38, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1009_4b47, 3); mov(memb[ss, ebp - 0x14], al);          /* mov [ebp-0x14], al */
            ii(0x1009_4b4a, 5); jmp(0x1009_4bde, 0x8f); goto l_0x1009_4bde; /* jmp 0x10094bde */
        l_0x1009_4b4f:
            ii(0x1009_4b4f, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_4b52, 5); call(0x1007_63a0, -0x1_e7b7);           /* call 0x100763a0 */
            ii(0x1009_4b57, 3); mov(edx, memd[ds, eax + 0x50]);         /* mov edx, [eax+0x50] */
            ...
            ii(0x1009_4b69, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_4b6c, 3); mov(edx, memd[ds, edx + 0x2b]);         /* mov edx, [edx+0x2b] */
            ii(0x1009_4b6f, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1009_4b72, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1009_4b74, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4b77, 4); mov(memw[ds, eax + 0x2d], dx);          /* mov [eax+0x2d], dx */
            ii(0x1009_4b7b, 5); jmp(0x1009_4c04, 0x84); goto l_0x1009_4c04; /* jmp 0x10094c04 */
        l_0x1009_4b80:
            ii(0x1009_4b80, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_4b83, 5); call(0x1007_63a0, -0x1_e7e8);           /* call 0x100763a0 */
            ii(0x1009_4b88, 3); mov(edx, memd[ds, eax + 0x50]);         /* mov edx, [eax+0x50] */
            ...
            ii(0x1009_4b9a, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_4b9d, 3); mov(edx, memd[ds, edx + 0x2d]);         /* mov edx, [edx+0x2d] */
            ii(0x1009_4ba0, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1009_4ba3, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1009_4ba5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4ba8, 4); mov(memw[ds, eax + 0x2f], dx);          /* mov [eax+0x2f], dx */
            ii(0x1009_4bac, 2); jmp(0x1009_4c04, 0x56); goto l_0x1009_4c04; /* jmp 0x10094c04 */
        l_0x1009_4bae:
            ii(0x1009_4bae, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_4bb1, 5); call(0x1007_63a0, -0x1_e816);           /* call 0x100763a0 */
            ii(0x1009_4bb6, 3); mov(edx, memd[ds, eax + 0x50]);         /* mov edx, [eax+0x50] */
            ...
            ii(0x1009_4bc8, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_4bcb, 3); mov(edx, memd[ds, edx + 0x29]);         /* mov edx, [edx+0x29] */
            ii(0x1009_4bce, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1009_4bd1, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1009_4bd3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4bd6, 4); mov(memw[ds, eax + 0x2b], dx);          /* mov [eax+0x2b], dx */
        ...
        l_0x1009_4bde:
            ii(0x1009_4bde, 3); mov(al, memb[ss, ebp - 0x14]);          /* mov al, [ebp-0x14] */
            ii(0x1009_4be1, 3); mov(memb[ss, ebp - 0x18], al);          /* mov [ebp-0x18], al */
            ii(0x1009_4be4, 4); cmp(memb[ss, ebp - 0x18], 0x2);         /* cmp byte [ebp-0x18], 0x2 */
            ii(0x1009_4be8, 2); if(jb(0x1009_4bf8, 0xe)) goto l_0x1009_4bf8; /* jb 0x10094bf8 */
            ii(0x1009_4bea, 4); cmp(memb[ss, ebp - 0x18], 0x2);         /* cmp byte [ebp-0x18], 0x2 */
            ii(0x1009_4bee, 2); if(jbe(0x1009_4b80, -0x70)) goto l_0x1009_4b80; /* jbe 0x10094b80 */
            ii(0x1009_4bf0, 4); cmp(memb[ss, ebp - 0x18], 0x3);         /* cmp byte [ebp-0x18], 0x3 */
        ...
        l_0x1009_4bf8:
            ii(0x1009_4bf8, 4); cmp(memb[ss, ebp - 0x18], 0x1);         /* cmp byte [ebp-0x18], 0x1 */
        ...
        l_0x1009_4c09:
            ii(0x1009_4c09, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4c0c, 3); add(eax, 0x21);                         /* add eax, 0x21 */
            ii(0x1009_4c0f, 5); call(0x1009_c6c8, 0x7ab4);              /* call 0x1009c6c8 */
            ii(0x1009_4c14, 3); lea(ebx, memd[ss, ebp - 0x1c]);         /* lea ebx, [ebp-0x1c] */
            ...
            ii(0x1009_4c20, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4c23, 4); mov(ax, memw[ds, eax + 0x2b]);          /* mov ax, [eax+0x2b] */
            ii(0x1009_4c27, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_4c2a, 2); jmp(0x1009_4c34, 0x8); goto l_0x1009_4c34; /* jmp 0x10094c34 */
        l_0x1009_4c2c:
            ii(0x1009_4c2c, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1009_4c2f, 5); call(0x1007_6bf8, -0x1_e03c);           /* call 0x10076bf8 */
        l_0x1009_4c34:
            ii(0x1009_4c34, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_4c36, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1009_4c46, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1009_4c59, 3); sub(memd[ss, ebp - 0x8], eax);          /* sub [ebp-0x8], eax */
            ii(0x1009_4c5c, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1009_4c5f, 5); call(0x1009_c4f8, 0x7894);              /* call 0x1009c4f8 */
            ii(0x1009_4c64, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1009_4c67, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1009_4c6a, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x1009_4c6d, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1009_4c70, 3); call_abs(memd[ds, edx + 0x70]);         /* call dword [edx+0x70] */
            ...
            ii(0x1009_4c7c, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1009_4c91, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4c94, 4); sub(memw[ds, eax + 0x2d], dx);          /* sub [eax+0x2d], dx */
            ii(0x1009_4c98, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1009_4cad, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4cb0, 4); sub(memw[ds, eax + 0x2f], dx);          /* sub [eax+0x2f], dx */
            ii(0x1009_4cb4, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1009_4cc9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4ccc, 4); sub(memw[ds, eax + 0x2b], dx);          /* sub [eax+0x2b], dx */
        l_0x1009_4cd0:
        ...
        l_0x1009_4cd5:
            ...
            ii(0x1009_4cdf, 3); lea(ebx, memd[ss, ebp - 0x10]);         /* lea ebx, [ebp-0x10] */
            ...
            ii(0x1009_4ceb, 2); jmp(0x1009_4cf5, 0x8); goto l_0x1009_4cf5; /* jmp 0x10094cf5 */
        l_0x1009_4ced:
            ii(0x1009_4ced, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_4cf0, 5); call(0x1007_6bf8, -0x1_e0fd);           /* call 0x10076bf8 */
        l_0x1009_4cf5:
            ii(0x1009_4cf5, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_4cf7, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x1009_4d07, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_4d0a, 5); call(0x1007_63a0, -0x1_e96f);           /* call 0x100763a0 */
            ii(0x1009_4d0f, 5); cmp(memw[ds, eax + 0x8], 0x28);         /* cmp word [eax+0x8], 0x28 */
            ii(0x1009_4d14, 2); if(jnz(0x1009_4d30, 0x1a)) goto l_0x1009_4d30; /* jnz 0x10094d30 */
            ii(0x1009_4d16, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_4d19, 5); call(0x1007_63a0, -0x1_e97e);           /* call 0x100763a0 */
            ii(0x1009_4d1e, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_4d20, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ii(0x1009_4d23, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4d26, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ii(0x1009_4d29, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1009_4d2c, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x1009_4d2e, 2); if(jz(0x1009_4d32, 0x2)) goto l_0x1009_4d32; /* jz 0x10094d32 */
        l_0x1009_4d30:
            ii(0x1009_4d30, 2); jmp(0x1009_4dac, 0x7a); goto l_0x1009_4dac; /* jmp 0x10094dac */
        l_0x1009_4d32:
            ii(0x1009_4d32, 7); mov(memd[ss, ebp - 0xc], 0x10);         /* mov dword [ebp-0xc], 0x10 */
            ii(0x1009_4d39, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_4d3c, 5); call(0x1007_63a0, -0x1_e9a1);           /* call 0x100763a0 */
            ii(0x1009_4d41, 3); mov(al, memb[ds, eax + 0x4c]);          /* mov al, [eax+0x4c] */
            ii(0x1009_4d44, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1009_4d46, 3); movsx(ebx, ax);                         /* movsx ebx, ax */
            ii(0x1009_4d49, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_4d4c, 3); add(edx, 0x2f);                         /* add edx, 0x2f */
            ii(0x1009_4d4f, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1009_4d52, 5); call(0x1009_490b, -0x44c);              /* call 0x1009490b */
            ii(0x1009_4d57, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_4d5a, 5); call(0x1007_63a0, -0x1_e9bf);           /* call 0x100763a0 */
            ii(0x1009_4d5f, 3); mov(al, memb[ds, eax + 0x4a]);          /* mov al, [eax+0x4a] */
            ii(0x1009_4d62, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1009_4d64, 3); movsx(ebx, ax);                         /* movsx ebx, ax */
            ii(0x1009_4d67, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_4d6a, 3); add(edx, 0x2d);                         /* add edx, 0x2d */
            ii(0x1009_4d6d, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1009_4d70, 5); call(0x1009_490b, -0x46a);              /* call 0x1009490b */
            ii(0x1009_4d75, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_4d78, 5); call(0x1007_63a0, -0x1_e9dd);           /* call 0x100763a0 */
            ii(0x1009_4d7d, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_4d7f, 3); mov(dl, memb[ds, eax + 0x4b]);          /* mov dl, [eax+0x4b] */
            ii(0x1009_4d82, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1009_4d86, 5); call(Definitions.my_min, -0xb607);      /* call 0x10089784 */
            ii(0x1009_4d8b, 3); add(memd[ss, ebp - 0x8], eax);          /* add [ebp-0x8], eax */
            ii(0x1009_4d8e, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_4d91, 5); call(0x1007_63a0, -0x1_e9f6);           /* call 0x100763a0 */
            ii(0x1009_4d96, 3); mov(al, memb[ds, eax + 0x4b]);          /* mov al, [eax+0x4b] */
            ii(0x1009_4d99, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1009_4d9b, 3); movsx(ebx, ax);                         /* movsx ebx, ax */
            ii(0x1009_4d9e, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_4da1, 3); add(edx, 0x2b);                         /* add edx, 0x2b */
            ii(0x1009_4da4, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
        ...
        l_0x1009_4db1:
            ii(0x1009_4db1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4db4, 3); add(eax, 0x21);                         /* add eax, 0x21 */
            ii(0x1009_4db7, 5); call(0x1009_c6c8, 0x790c);              /* call 0x1009c6c8 */
            ii(0x1009_4dbc, 3); lea(ebx, memd[ss, ebp - 0x1c]);         /* lea ebx, [ebp-0x1c] */
            ...
            ii(0x1009_4dc8, 2); jmp(0x1009_4dd2, 0x8); goto l_0x1009_4dd2; /* jmp 0x10094dd2 */
        l_0x1009_4dca:
            ii(0x1009_4dca, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1009_4dcd, 5); call(0x1007_6bf8, -0x1_e1da);           /* call 0x10076bf8 */
        l_0x1009_4dd2:
            ii(0x1009_4dd2, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_4dd4, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1009_4de4, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1009_4dfb, 7); mov(memd[ss, ebp - 0xc], 0x10);         /* mov dword [ebp-0xc], 0x10 */
            ii(0x1009_4e02, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1009_4e05, 5); call(0x1009_c4f8, 0x76ee);              /* call 0x1009c4f8 */
            ii(0x1009_4e0a, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x1009_4e0d, 3); mov(ebx, memd[ss, ebp - 0x24]);         /* mov ebx, [ebp-0x24] */
            ii(0x1009_4e10, 3); mov(ebx, memd[ds, ebx + 0x2]);          /* mov ebx, [ebx+0x2] */
            ii(0x1009_4e13, 3); lea(edx, memd[ss, ebp - 0x34]);         /* lea edx, [ebp-0x34] */
            ii(0x1009_4e16, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x1009_4e19, 3); call_abs(memd[ds, ebx + 0x1c]);         /* call dword [ebx+0x1c] */
            ii(0x1009_4e1c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_4e1f, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1009_4e29, 3); lea(eax, memd[ss, ebp - 0x38]);         /* lea eax, [ebp-0x38] */
            ii(0x1009_4e2c, 1); push(eax);                              /* push eax */
            ii(0x1009_4e2d, 3); lea(eax, memd[ss, ebp - 0x3c]);         /* lea eax, [ebp-0x3c] */
            ii(0x1009_4e30, 1); push(eax);                              /* push eax */
            ii(0x1009_4e31, 3); lea(ecx, memd[ss, ebp - 0x40]);         /* lea ecx, [ebp-0x40] */
            ii(0x1009_4e34, 5); mov(ebx, 0x1);                          /* mov ebx, 0x1 */
            ii(0x1009_4e39, 4); movsx(edx, memw[ss, ebp - 0x30]);       /* movsx edx, word [ebp-0x30] */
            ii(0x1009_4e3d, 4); movsx(eax, memw[ss, ebp - 0x34]);       /* movsx eax, word [ebp-0x34] */
            ii(0x1009_4e41, 5); call(0x1014_2d0b, 0xa_dec5);            /* call 0x10142d0b */
            ii(0x1009_4e46, 4); movsx(ebx, memw[ss, ebp - 0x38]);       /* movsx ebx, word [ebp-0x38] */
            ii(0x1009_4e4a, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_4e4d, 3); add(edx, 0x2f);                         /* add edx, 0x2f */
            ii(0x1009_4e50, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1009_4e53, 5); call(0x1009_490b, -0x54d);              /* call 0x1009490b */
            ii(0x1009_4e58, 4); movsx(ebx, memw[ss, ebp - 0x40]);       /* movsx ebx, word [ebp-0x40] */
            ii(0x1009_4e5c, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_4e5f, 3); add(edx, 0x2d);                         /* add edx, 0x2d */
            ii(0x1009_4e62, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1009_4e65, 5); call(0x1009_490b, -0x55f);              /* call 0x1009490b */
            ii(0x1009_4e6a, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1009_4e6d, 5); call(0x1009_c4f8, 0x7686);              /* call 0x1009c4f8 */
            ii(0x1009_4e72, 3); mov(memd[ss, ebp - 0x44], eax);         /* mov [ebp-0x44], eax */
            ii(0x1009_4e75, 3); mov(edx, memd[ss, ebp - 0x44]);         /* mov edx, [ebp-0x44] */
            ii(0x1009_4e78, 3); mov(edx, memd[ds, edx + 0x2]);          /* mov edx, [edx+0x2] */
            ii(0x1009_4e7b, 3); mov(eax, memd[ss, ebp - 0x44]);         /* mov eax, [ebp-0x44] */
            ii(0x1009_4e7e, 3); call_abs(memd[ds, edx + 0x70]);         /* call dword [edx+0x70] */
            ii(0x1009_4e81, 2); test(al, al);                           /* test al, al */
            ii(0x1009_4e83, 2); if(jz(0x1009_4e95, 0x10)) goto l_0x1009_4e95; /* jz 0x10094e95 */
            ii(0x1009_4e85, 4); movsx(edx, memw[ss, ebp - 0x3c]);       /* movsx edx, word [ebp-0x3c] */
            ii(0x1009_4e89, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1009_4e8d, 5); call(Definitions.my_min, -0xb70e);      /* call 0x10089784 */
            ii(0x1009_4e92, 3); add(memd[ss, ebp - 0x8], eax);          /* add [ebp-0x8], eax */
        l_0x1009_4e95:
            ii(0x1009_4e95, 4); movsx(ebx, memw[ss, ebp - 0x3c]);       /* movsx ebx, word [ebp-0x3c] */
            ii(0x1009_4e99, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_4e9c, 3); add(edx, 0x2b);                         /* add edx, 0x2b */
            ii(0x1009_4e9f, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
