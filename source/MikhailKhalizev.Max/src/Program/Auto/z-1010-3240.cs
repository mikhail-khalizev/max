...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_3240()
        {
            ...
            ii(0x1010_3257, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_325a, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1010_325d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_3260, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1010_3263, 3); mov(memw[ds, edx], ax);                 /* mov [edx], ax */
            ii(0x1010_3266, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_3269, 4); mov(memw[ss, ebp - 0xc], ax);           /* mov [ebp-0xc], ax */
            ii(0x1010_326d, 5); mov(ebx, 0x101b_63ec);                  /* mov ebx, 0x101b63ec */
            ii(0x1010_3272, 3); mov(edx, memd[ss, ebp - 0xe]);          /* mov edx, [ebp-0xe] */
            ii(0x1010_3275, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1010_3278, 3); mov(eax, memd[ss, ebp - 0xe]);          /* mov eax, [ebp-0xe] */
            ...
            ii(0x1010_3290, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_3293, 3); mov(memd[ds, eax + 0x4], edx);          /* mov [eax+0x4], edx */
            ii(0x1010_3296, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_3299, 6); mov(memw[ds, eax + 0x2], 0);            /* mov word [eax+0x2], 0x0 */
        l_0x1010_329f:
            ii(0x1010_329f, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1010_32a3, 5); cmp(eax, 0x80);                         /* cmp eax, 0x80 */
            ii(0x1010_32a8, 2); if(jle(0x1010_32b7, 0xd)) goto l_0x1010_32b7; /* jle 0x101032b7 */
            ii(0x1010_32aa, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_32ad, 4); inc(memw[ds, eax + 0x2]);               /* inc word [eax+0x2] */
            ii(0x1010_32b1, 4); sar(memw[ss, ebp - 0x4], 0x1);          /* sar word [ebp-0x4], 1 */
            ii(0x1010_32b5, 2); jmp(0x1010_329f, -0x18); goto l_0x1010_329f; /* jmp 0x1010329f */
        l_0x1010_32b7:
            ii(0x1010_32b7, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_32ba, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1010_32bd, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
