...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_d916()
        {
            ...
            ii(0x100c_d92d, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_d930, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100c_d933, 7); test(memd[ss, ebp - 0x4], 0x4);         /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x100c_d941, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100c_d950:
            ii(0x100c_d950, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_d953, 7); mov(memd[ds, eax + 0xc], 0x101b_5b7c);  /* mov dword [eax+0xc], 0x101b5b7c */
            ii(0x100c_d95a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_d95d, 4); cmp(memd[ds, eax + 0x8], 0);            /* cmp dword [eax+0x8], 0x0 */
            ii(0x100c_d961, 2); if(jz(0x100c_d96e, 0xb)) goto l_0x100c_d96e; /* jz 0x100cd96e */
            ii(0x100c_d963, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_d966, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ii(0x100c_d969, 5); call(Definitions.sys_delete, 0x9_85f6); /* call 0x10165f64 */
        l_0x100c_d96e:
            ii(0x100c_d96e, 7); test(memd[ss, ebp - 0x4], 0x2);         /* test dword [ebp-0x4], 0x2 */
            ii(0x100c_d975, 2); if(jz(0x100c_d97f, 0x8)) goto l_0x100c_d97f; /* jz 0x100cd97f */
            ii(0x100c_d977, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_d97a, 5); call(Definitions.sys_delete, 0x9_85e5); /* call 0x10165f64 */
        l_0x100c_d97f:
            ii(0x100c_d97f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_d982, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100c_d985, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
