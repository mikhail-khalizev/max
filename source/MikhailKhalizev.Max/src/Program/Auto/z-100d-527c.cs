...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_527c()
        {
            ...
            ii(0x100d_5284, 6); sub(esp, 4);                            /* sub esp, 0x4 */
            ii(0x100d_528a, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100d_528d, 5); mov(edx, 0x101c_35a4);                  /* mov edx, 0x101c35a4 */
            ii(0x100d_5292, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100d_5295, 5); call(0x100d_4d78, -0x522);              /* call 0x100d4d78 */
            ii(0x100d_529a, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
