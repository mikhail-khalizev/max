...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_6204()
        {
            ...
            ii(0x1007_6216, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1007_621c, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1007_621f, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1007_6222, 3); add(eax, 0x70);                         /* add eax, 0x70 */
            ii(0x1007_6225, 5); call(0x1007_68e0, 0x6b6);               /* call 0x100768e0 */
            ii(0x1007_622a, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1007_622d, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
