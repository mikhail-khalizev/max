...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_c25c()
        {
            ...
            ii(0x1013_c273, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_c276, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_c279, 4); cmp(memd[ss, ebp - 0x4], 0);            /* cmp dword [ebp-0x4], 0x0 */
            ii(0x1013_c27d, 2); if(jnz(0x1013_c28b, 0xc)) goto l_0x1013_c28b; /* jnz 0x1013c28b */
            ii(0x1013_c27f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_c281, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1013_c28b:
            ii(0x1013_c28b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1013_c2a6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1013_c2b0:
            ii(0x1013_c2b0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1013_c2c1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_c2c4, 5); call(0x100e_0dc8, -0x5_b501);           /* call 0x100e0dc8 */
            ii(0x1013_c2c9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_c2cc, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1013_c2cf, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1013_c2d2, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x1013_c2d5, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1013_c2d8, 3); call_abs(memd[ds, edx + 0x4]);          /* call dword [edx+0x4] */
            ii(0x1013_c2db, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_c2dd, 3); mov(dx, ax);                            /* mov dx, ax */
            ii(0x1013_c2e0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_c2e3, 5); call(0x100e_0dc8, -0x5_b520);           /* call 0x100e0dc8 */
            ii(0x1013_c2e8, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1013_c2eb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
