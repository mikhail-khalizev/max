...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_0cea()
        {
            ...
            ii(0x1008_0d02, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_0d05, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_0d08, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x1008_0d0b, 5); call(0x1007_6338, -0xa9d8);             /* call 0x10076338 */
            ii(0x1008_0d10, 3); lea(ebx, memd[ss, ebp - 0x8]);          /* lea ebx, [ebp-0x8] */
            ...
            ii(0x1008_0d1c, 2); jmp(0x1008_0d26, 0x8); goto l_0x1008_0d26; /* jmp 0x10080d26 */
        l_0x1008_0d1e:
            ii(0x1008_0d1e, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1008_0d21, 5); call(0x1007_6bf8, -0xa12e);             /* call 0x10076bf8 */
        l_0x1008_0d26:
            ii(0x1008_0d26, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_0d28, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x1008_0d34, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_0d37, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1008_0d3a, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1008_0d3d, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x1008_0d40, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1008_0d43, 5); call(0x1007_63d4, -0xa974);             /* call 0x100763d4 */
            ii(0x1008_0d48, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1008_0d4a, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1008_0d4d, 3); call_abs(memd[ds, ebx + 0x44]);         /* call dword [ebx+0x44] */
            ...
            ii(0x1008_0d56, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
        ...
        l_0x1008_0d62:
            ...
            ii(0x1008_0d64, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
