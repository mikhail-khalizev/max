...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_d26c()
        {
            ...
            ii(0x1009_d284, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_d287, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_d289, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_d2a1, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_d2a4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1009_d2b4:
            ...
            ii(0x1009_d2b6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_d2b9, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x1009_d2bc, 5); call(0x1007_6630, -0x2_6c91);           /* call 0x10076630 */
            ii(0x1009_d2c1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_d2c4, 7); mov(memd[ds, eax + 0x1b], 0);           /* mov dword [eax+0x1b], 0x0 */
            ii(0x1009_d2cb, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_d2cd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_d2d0, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x1009_d2d3, 5); call(0x1008_afe4, -0x1_22f4);           /* call 0x1008afe4 */
            ii(0x1009_d2d8, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
