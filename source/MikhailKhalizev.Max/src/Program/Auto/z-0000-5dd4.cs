...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_5dd4()
        {
            ...
            ii(0x5ddb, 5);    cmp(memb[ds, 0xcee], 0x3);                /* cmp byte [0xcee], 0x3 */
            ...
            ii(0x5de8, 2);    if(jb(0x5dee, 0x4)) goto l_0x5dee;        /* jb 0x5dee */
            ii(0x5dea, 2);    mov(al, 0x5);                             /* mov al, 0x5 */
            ii(0x5dec, 2);    jmp(0x5df4, 0x6); goto l_0x5df4;          /* jmp 0x5df4 */
        l_0x5dee:
            ii(0x5dee, 2);    cmp(al, 0x13);                            /* cmp al, 0x13 */
            ii(0x5df0, 2);    if(jbe(0x5df4, 0x2)) goto l_0x5df4;       /* jbe 0x5df4 */
        l_0x5df2:
        ...
        l_0x5dfd:
            ...
            ii(0x5dff, 2);    jmp(0x5df8, -0x9); goto l_0x5df8;         /* jmp 0x5df8 */
        }
    }
}
