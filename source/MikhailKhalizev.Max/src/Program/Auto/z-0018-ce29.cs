...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x18_ce93:
            ...
            ii(0x18_ce9c, 5); or(memb[es, bx + 0x26], 1);               /* or byte [es:bx+0x26], 0x1 */
            ii(0x18_cea1, 3); jmp(0x18_d052, 0x1ae); goto l_0x18_d052;  /* jmp 0xd052 */
        l_0x18_cea4:
            ii(0x18_cea4, 3); les(bx, memw[ss, bp + 4]);                /* les bx, [bp+0x4] */
            ii(0x18_cea7, 5); and(memb[es, bx + 0x26], -2 /* 0xfe */);  /* and byte [es:bx+0x26], 0xfe */
        ...
        l_0x18_cf12:
            ...
            ii(0x18_cf49, 5); test(memb[es, bx + 0x26], 1);             /* test byte [es:bx+0x26], 0x1 */
