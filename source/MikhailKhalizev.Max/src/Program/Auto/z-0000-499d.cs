...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_499d()
        {
            ...
            ii(0x49af, 4);    cmp(dx, memw[es, bx + 0x2]);              /* cmp dx, [es:bx+0x2] */
            ...
            ii(0x49c1, 2);    if(jz(0x49c8, 0x5)) goto l_0x49c8;        /* jz 0x49c8 */
            ii(0x49c3, 5);    lds(dx, ss, 0xf84);                       /* lds dx, [ss:0xf84] */
        l_0x49c8:
            ii(0x49c8, 1);    cli();                                    /* cli */
            ii(0x49c9, 3);    mov(memw[es, bx], dx);                    /* mov [es:bx], dx */
            ii(0x49cc, 4);    mov(memw[es, bx + 0x2], ds);              /* mov [es:bx+0x2], ds */
            ii(0x49d0, 1);    sti();                                    /* sti */
        ...
        l_0x49d5:
            ...
            ii(0x49d7, 3);    cmp(ax, memw[ds, bx - 0x2]);              /* cmp ax, [bx-0x2] */
            ii(0x49da, 2);    if(jnz(0x4a17, 0x3b)) goto l_0x4a17;      /* jnz 0x4a17 */
            ii(0x49dc, 3);    cmp(bx, memw[ds, bx - 0x4]);              /* cmp bx, [bx-0x4] */
            ii(0x49df, 2);    if(jnz(0x4a17, 0x36)) goto l_0x4a17;      /* jnz 0x4a17 */
            ii(0x49e1, 3);    mov(ax, memw[ds, bx - 0x6]);              /* mov ax, [bx-0x6] */
            ii(0x49e4, 2);    cmp(dx, ax);                              /* cmp dx, ax */
            ii(0x49e6, 2);    if(jz(0x49ed, 0x5)) goto l_0x49ed;        /* jz 0x49ed */
            ii(0x49e8, 3);    mov(bx, memw[ds, bx - 0x8]);              /* mov bx, [bx-0x8] */
            ii(0x49eb, 2);    jmp(0x49d5, -0x18); goto l_0x49d5;        /* jmp 0x49d5 */
        l_0x49ed:
            ii(0x49ed, 4);    mov(ax, memw[cs, 0x12c4]);                /* mov ax, [cs:0x12c4] */
            ii(0x49f1, 1);    cli();                                    /* cli */
            ii(0x49f2, 3);    mov(memw[ds, bx - 0x8], ax);              /* mov [bx-0x8], ax */
            ii(0x49f5, 4);    mov(ax, memw[cs, 0x12c6]);                /* mov ax, [cs:0x12c6] */
            ii(0x49f9, 3);    mov(memw[ds, bx - 0x6], ax);              /* mov [bx-0x6], ax */
            ii(0x49fc, 1);    sti();                                    /* sti */
            ii(0x49fd, 3);    mov(ax, memw[ds, 0]);                     /* mov ax, [0x0] */
            ii(0x4a00, 2);    or(ax, ax);                               /* or ax, ax */
            ii(0x4a02, 2);    if(jnz(0x4a07, 0x3)) goto l_0x4a07;       /* jnz 0x4a07 */
        ...
        l_0x4a07:
            ...
            ii(0x4a11, 4);    cmp(memw[ds, 0x1], ax);                   /* cmp [0x1], ax */
            ii(0x4a15, 2);    if(jz(0x4a1a, 0x3)) goto l_0x4a1a;        /* jz 0x4a1a */
        l_0x4a17:
        ...
        l_0x4a1a:
            ...
            ii(0x4a22, 3);    mov(memw[ds, 0x1], ax);                   /* mov [0x1], ax */
