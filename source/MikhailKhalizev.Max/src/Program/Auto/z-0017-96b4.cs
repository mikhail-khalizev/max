...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x17_96b4, 4); enter(2, 0);                              /* enter 0x2, 0x0 */
            ii(0x17_96b8, 1); push(ds);                                 /* push ds */
            ii(0x17_96b9, 3); mov(ax, 0x3e68);                          /* mov ax, 0x3e68 */
            ii(0x17_96bc, 2); mov(ds, ax);                              /* mov ds, ax */
            ii(0x17_96be, 5); mov(memw[ss, bp - 2], 1);                 /* mov word [bp-0x2], 0x1 */
            ii(0x17_96c3, 1); cld();                                    /* cld */
            ii(0x17_96c4, 3); mov(al, memb[ss, bp + 10]);               /* mov al, [bp+0xa] */
        ...
        l_0x17_96cc:
            ...
            ii(0x17_96cf, 3); les(bx, memw[ss, bp + 6]);                /* les bx, [bp+0x6] */
            ii(0x17_96d2, 4); mov(memw[es, bx + 32], ax);               /* mov [es:bx+0x20], ax */
            ii(0x17_96d6, 3); mov(ax, memw[ds, 0x1f5a]);                /* mov ax, [0x1f5a] */
            ii(0x17_96d9, 2); or(al, 4);                                /* or al, 0x4 */
            ii(0x17_96db, 4); mov(memw[es, bx + 20], ax);               /* mov [es:bx+0x14], ax */
            ii(0x17_96df, 3); mov(ax, memw[ds, 0x1f5c]);                /* mov ax, [0x1f5c] */
            ii(0x17_96e2, 4); mov(memw[es, bx + 28], ax);               /* mov [es:bx+0x1c], ax */
            ii(0x17_96e6, 3); mov(ax, memw[ds, 0x1f5e]);                /* mov ax, [0x1f5e] */
            ii(0x17_96e9, 4); mov(memw[es, bx + 24], ax);               /* mov [es:bx+0x18], ax */
            ii(0x17_96ed, 5); mov(memw[ss, bp - 2], 0);                 /* mov word [bp-0x2], 0x0 */
            ii(0x17_96f2, 2); jmp(0x17_96fc, 8); goto l_0x17_96fc;      /* jmp 0x96fc */
        //  ii(0x17_96f4, 2); jmp(0x17_96fc, 6); goto l_0x17_96fc;      /* jmp 0x96fc */
        l_0x17_96f6:
        ...
        l_0x17_96fc:
            ii(0x17_96fc, 3); mov(ax, memw[ss, bp - 2]);                /* mov ax, [bp-0x2] */
