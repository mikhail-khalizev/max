...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x100d_221e:
            ...
            ii(0x100d_2221, 7);  mov(memb[ds, eax + 134], 0);          /* mov byte [eax+0x86], 0x0 */
        l_0x100d_2228:
            ii(0x100d_2228, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_222b, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
        ...
        l_0x100d_2233:
            ...
            ii(0x100d_2236, 4);  mov(memb[ds, eax + 55], 1);           /* mov byte [eax+0x37], 0x1 */
        l_0x100d_223a:
            ii(0x100d_223a, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_223d, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x100d_2240, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100d_2243, 3);  mov(edx, memd[ds, eax + 19]);         /* mov edx, [eax+0x13] */
            ii(0x100d_2246, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100d_2249, 3);  call_abs(memd[ds, edx + 20]);         /* call dword [edx+0x14] */
        ...
        l_0x100d_2275:
            ...
            ii(0x100d_2278, 3);  mov(eax, memd[ds, eax + 74]);         /* mov eax, [eax+0x4a] */
            ...
            ii(0x100d_228a, 3);  mov(eax, memd[ds, eax + 62]);         /* mov eax, [eax+0x3e] */
        ...
        l_0x100d_22a2:
            ...
            ii(0x100d_22a5, 3);  mov(eax, memd[ds, eax + 74]);         /* mov eax, [eax+0x4a] */
            ...
            ii(0x100d_22b7, 3);  mov(eax, memd[ds, eax + 62]);         /* mov eax, [eax+0x3e] */
        ...
        l_0x100d_22cf:
            ...
            ii(0x100d_22d2, 4);  mov(memb[ds, eax + 54], 1);           /* mov byte [eax+0x36], 0x1 */
        ...
        l_0x100d_22db:
            ...
            ii(0x100d_22de, 6);  mov(memw[ds, eax + 56], 1);           /* mov word [eax+0x38], 0x1 */
            ii(0x100d_22e4, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_22e7, 3);  mov(eax, memd[ds, eax + 94]);         /* mov eax, [eax+0x5e] */
            ii(0x100d_22ea, 5);  call(0x100c_fbbe, -0x2731);           /* call 0x100cfbbe */
            ii(0x100d_22ef, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_22f2, 3);  mov(eax, memd[ds, eax + 62]);         /* mov eax, [eax+0x3e] */
        ...
        l_0x100d_230a:
            ...
            ii(0x100d_230d, 6);  mov(memw[ds, eax + 56], 2);           /* mov word [eax+0x38], 0x2 */
            ii(0x100d_2313, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_2316, 3);  mov(eax, memd[ds, eax + 98]);         /* mov eax, [eax+0x62] */
            ii(0x100d_2319, 5);  call(0x100c_fbbe, -0x2760);           /* call 0x100cfbbe */
            ii(0x100d_231e, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_2321, 3);  mov(eax, memd[ds, eax + 62]);         /* mov eax, [eax+0x3e] */
        ...
        l_0x100d_2339:
            ...
            ii(0x100d_233c, 6);  mov(memw[ds, eax + 56], 4);           /* mov word [eax+0x38], 0x4 */
            ii(0x100d_2342, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_2345, 3);  mov(eax, memd[ds, eax + 102]);        /* mov eax, [eax+0x66] */
            ii(0x100d_2348, 5);  call(0x100c_fbbe, -0x278f);           /* call 0x100cfbbe */
            ii(0x100d_234d, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_2350, 3);  mov(eax, memd[ds, eax + 62]);         /* mov eax, [eax+0x3e] */
        ...
        l_0x100d_2368:
            ...
            ii(0x100d_2378, 7);  cmp(memb[ds, eax + 134], 0);          /* cmp byte [eax+0x86], 0x0 */
            ...
            ii(0x100d_2395, 3);  mov(eax, memd[ds, eax + 78]);         /* mov eax, [eax+0x4e] */
        ...
        l_0x100d_239f:
            ...
            ii(0x100d_23ab, 3);  mov(eax, memd[ds, eax + 82]);         /* mov eax, [eax+0x52] */
        ...
        l_0x100d_23b5:
            ...
            ii(0x100d_23be, 3);  mov(eax, memd[ds, eax + 86]);         /* mov eax, [eax+0x56] */
        ...
        l_0x100d_23c8:
            ...
            ii(0x100d_23d4, 3);  mov(eax, memd[ds, eax + 90]);         /* mov eax, [eax+0x5a] */
        ...
        l_0x100d_23de:
            ...
            ii(0x100d_23e1, 3);  mov(eax, memd[ds, eax + 62]);         /* mov eax, [eax+0x3e] */
            ii(0x100d_23e4, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x100d_23e7, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x100d_23ea, 3);  mov(ebx, memd[ds, eax + 64]);         /* mov ebx, [eax+0x40] */
            ii(0x100d_23ed, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x100d_23f0, 6);  add(edx, 0x7000);                     /* add edx, 0x7000 */
            ii(0x100d_23f6, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x100d_23f9, 3);  call_abs(memd[ds, ebx + 12]);         /* call dword [ebx+0xc] */
        l_0x100d_23fc:
            ii(0x100d_23fc, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_23ff, 7);  mov(memb[ds, eax + 134], 1);          /* mov byte [eax+0x86], 0x1 */
        ...
        l_0x100d_2408:
            ...
            ii(0x100d_240b, 3);  mov(eax, memd[ds, eax + 62]);         /* mov eax, [eax+0x3e] */
            ii(0x100d_240e, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100d_2411, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x100d_2414, 3);  mov(ebx, memd[ds, eax + 64]);         /* mov ebx, [eax+0x40] */
            ii(0x100d_2417, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x100d_241a, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x100d_241d, 3);  call_abs(memd[ds, ebx + 12]);         /* call dword [ebx+0xc] */
            ii(0x100d_2420, 3);  mov(memb[ss, ebp - 12], al);          /* mov [ebp-0xc], al */
        ...
        l_0x100d_242d:
            ii(0x100d_242d, 7);  cmp(memd[ss, ebp - 16], 0x44d);       /* cmp dword [ebp-0x10], 0x44d */
            ii(0x100d_2434, 2);  if(jb(0x100d_2494, 0x5e)) goto l_0x100d_2494;/* jb 0x100d2494 */
            ii(0x100d_2436, 7);  cmp(memd[ss, ebp - 16], 0x44d);       /* cmp dword [ebp-0x10], 0x44d */
            ii(0x100d_243d, 6);  if(jbe(0x100d_22db, -0x168)) goto l_0x100d_22db;/* jbe 0x100d22db */
            ii(0x100d_2443, 7);  cmp(memd[ss, ebp - 16], 0x450);       /* cmp dword [ebp-0x10], 0x450 */
            ii(0x100d_244a, 2);  if(jb(0x100d_247d, 0x31)) goto l_0x100d_247d;/* jb 0x100d247d */
            ii(0x100d_244c, 7);  cmp(memd[ss, ebp - 16], 0x450);       /* cmp dword [ebp-0x10], 0x450 */
            ii(0x100d_2453, 6);  if(jbe(0x100d_2275, -0x1e4)) goto l_0x100d_2275;/* jbe 0x100d2275 */
            ii(0x100d_2459, 7);  cmp(memd[ss, ebp - 16], 0x451);       /* cmp dword [ebp-0x10], 0x451 */
        ...
        l_0x100d_2494:
            ...
            ii(0x100d_249a, 4);  cmp(memd[ss, ebp - 16], 0x3f);        /* cmp dword [ebp-0x10], 0x3f */
            ii(0x100d_249e, 6);  if(jbe(0x100d_225b, -0x249)) goto l_0x100d_225b;/* jbe 0x100d225b */
            ii(0x100d_24a4, 7);  cmp(memd[ss, ebp - 16], 0x119);       /* cmp dword [ebp-0x10], 0x119 */
            ii(0x100d_24ab, 2);  if(jb(0x100d_24cc, 0x1f)) goto l_0x100d_24cc;/* jb 0x100d24cc */
            ii(0x100d_24ad, 7);  cmp(memd[ss, ebp - 16], 0x119);       /* cmp dword [ebp-0x10], 0x119 */
            ii(0x100d_24b4, 6);  if(jbe(0x100d_2251, -0x269)) goto l_0x100d_2251;/* jbe 0x100d2251 */
            ii(0x100d_24ba, 7);  cmp(memd[ss, ebp - 16], 0x44c);       /* cmp dword [ebp-0x10], 0x44c */
        ...
        l_0x100d_24d1:
            ii(0x100d_24d1, 4);  cmp(memd[ss, ebp - 16], 0xd);         /* cmp dword [ebp-0x10], 0xd */
            ii(0x100d_24d5, 2);  if(jb(0x100d_24f0, 0x19)) goto l_0x100d_24f0;/* jb 0x100d24f0 */
            ii(0x100d_24d7, 4);  cmp(memd[ss, ebp - 16], 0xd);         /* cmp dword [ebp-0x10], 0xd */
            ii(0x100d_24db, 6);  if(jbe(0x100d_223a, -0x2a7)) goto l_0x100d_223a;/* jbe 0x100d223a */
            ii(0x100d_24e1, 4);  cmp(memd[ss, ebp - 16], 0x1b);        /* cmp dword [ebp-0x10], 0x1b */
        ...
        l_0x100d_24f5:
            ii(0x100d_24f5, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
        l_0x100d_24f9:
            ii(0x100d_24f9, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
