...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_21f0()
        {
            ...
            ii(0x100d_2207, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_220a, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_220d, 4); cmp(memd[ss, ebp - 0x4], 0);            /* cmp dword [ebp-0x4], 0x0 */
            ii(0x100d_2211, 2); if(jle(0x100d_221c, 0x9)) goto l_0x100d_221c; /* jle 0x100d221c */
            ii(0x100d_2213, 7); cmp(memd[ss, ebp - 0x4], 0x7000);       /* cmp dword [ebp-0x4], 0x7000 */
            ii(0x100d_221a, 2); if(jl(0x100d_221e, 0x2)) goto l_0x100d_221e; /* jl 0x100d221e */
        l_0x100d_221c:
            ii(0x100d_221c, 2); jmp(0x100d_2228, 0xa); goto l_0x100d_2228; /* jmp 0x100d2228 */
        l_0x100d_221e:
            ii(0x100d_221e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_2221, 7); mov(memb[ds, eax + 0x86], 0);           /* mov byte [eax+0x86], 0x0 */
        l_0x100d_2228:
            ii(0x100d_2228, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100d_2233:
            ii(0x100d_2233, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_2236, 4); mov(memb[ds, eax + 0x37], 0x1);         /* mov byte [eax+0x37], 0x1 */
        l_0x100d_223a:
            ii(0x100d_223a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_2275:
            ii(0x100d_2275, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_2278, 3); mov(eax, memd[ds, eax + 0x4a]);         /* mov eax, [eax+0x4a] */
            ii(0x100d_227b, 5); call(0x100c_fbbe, -0x26c2);             /* call 0x100cfbbe */
            ii(0x100d_2280, 7); mov(memb[ds, 0x101b_7ed0], 0x1);        /* mov byte [0x101b7ed0], 0x1 */
            ii(0x100d_2287, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_2295, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_22a2:
            ii(0x100d_22a2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_22b4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_22c2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_22cf:
            ii(0x100d_22cf, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_22d2, 4); mov(memb[ds, eax + 0x36], 0x1);         /* mov byte [eax+0x36], 0x1 */
            ii(0x100d_22d6, 5); jmp(0x100d_24f5, 0x21a); goto l_0x100d_24f5; /* jmp 0x100d24f5 */
        l_0x100d_22db:
            ii(0x100d_22db, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_22de, 6); mov(memw[ds, eax + 0x38], 0x1);         /* mov word [eax+0x38], 0x1 */
            ii(0x100d_22e4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_22e7, 3); mov(eax, memd[ds, eax + 0x5e]);         /* mov eax, [eax+0x5e] */
            ii(0x100d_22ea, 5); call(0x100c_fbbe, -0x2731);             /* call 0x100cfbbe */
            ii(0x100d_22ef, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_22fd, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_230a:
            ii(0x100d_230a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_230d, 6); mov(memw[ds, eax + 0x38], 0x2);         /* mov word [eax+0x38], 0x2 */
            ii(0x100d_2313, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_2316, 3); mov(eax, memd[ds, eax + 0x62]);         /* mov eax, [eax+0x62] */
            ii(0x100d_2319, 5); call(0x100c_fbbe, -0x2760);             /* call 0x100cfbbe */
            ii(0x100d_231e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_232c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_2339:
            ii(0x100d_2339, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_233c, 6); mov(memw[ds, eax + 0x38], 0x4);         /* mov word [eax+0x38], 0x4 */
            ii(0x100d_2342, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_2345, 3); mov(eax, memd[ds, eax + 0x66]);         /* mov eax, [eax+0x66] */
            ii(0x100d_2348, 5); call(0x100c_fbbe, -0x278f);             /* call 0x100cfbbe */
            ii(0x100d_234d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_235b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_2368:
            ii(0x100d_2368, 7); cmp(memd[ss, ebp - 0x4], 0x7000);       /* cmp dword [ebp-0x4], 0x7000 */
            ii(0x100d_236f, 6); if(jl(0x100d_2408, 0x93)) goto l_0x100d_2408; /* jl 0x100d2408 */
            ii(0x100d_2375, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_2385, 7); add(memd[ss, ebp - 0x4], 0xffff_9000);  /* add dword [ebp-0x4], 0xffff9000 */
            ii(0x100d_238c, 4); cmp(memd[ss, ebp - 0x4], 0xd);          /* cmp dword [ebp-0x4], 0xd */
            ii(0x100d_2390, 2); if(jnz(0x100d_239f, 0xd)) goto l_0x100d_239f; /* jnz 0x100d239f */
            ii(0x100d_2392, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_239f:
            ii(0x100d_239f, 7); cmp(memd[ss, ebp - 0x4], 0x44c);        /* cmp dword [ebp-0x4], 0x44c */
            ii(0x100d_23a6, 2); if(jnz(0x100d_23b5, 0xd)) goto l_0x100d_23b5; /* jnz 0x100d23b5 */
            ii(0x100d_23a8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_23b5:
            ii(0x100d_23b5, 4); cmp(memd[ss, ebp - 0x4], 0x1b);         /* cmp dword [ebp-0x4], 0x1b */
            ii(0x100d_23b9, 2); if(jnz(0x100d_23c8, 0xd)) goto l_0x100d_23c8; /* jnz 0x100d23c8 */
            ii(0x100d_23bb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_23c8:
            ii(0x100d_23c8, 7); cmp(memd[ss, ebp - 0x4], 0x452);        /* cmp dword [ebp-0x4], 0x452 */
            ii(0x100d_23cf, 2); if(jnz(0x100d_23de, 0xd)) goto l_0x100d_23de; /* jnz 0x100d23de */
            ii(0x100d_23d1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_23de:
            ii(0x100d_23de, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_23ed, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x100d_23fc:
            ii(0x100d_23fc, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_23ff, 7); mov(memb[ds, eax + 0x86], 0x1);         /* mov byte [eax+0x86], 0x1 */
            ii(0x100d_2406, 2); jmp(0x100d_2428, 0x20); goto l_0x100d_2428; /* jmp 0x100d2428 */
        l_0x100d_2408:
            ii(0x100d_2408, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_2417, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x100d_24f5:
            ii(0x100d_24f5, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
        l_0x100d_24f9:
