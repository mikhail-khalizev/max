...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_cb93()
        {
            ...
            ii(0x1007_cbaa, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_cbad, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1007_cbb0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_cbb3, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x1007_cbb6, 5); call(0x1007_6408, -0x67b3);             /* call 0x10076408 */
            ii(0x1007_cbbb, 3); cmp(eax, memd[ss, ebp - 0x4]);          /* cmp eax, [ebp-0x4] */
            ii(0x1007_cbbe, 2); if(jnz(0x1007_cbc8, 0x8)) goto l_0x1007_cbc8; /* jnz 0x1007cbc8 */
            ii(0x1007_cbc0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
