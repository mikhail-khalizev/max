...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_5f9d()
        {
            ...
            ii(0x100b_5fb5, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_5fb8, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x100b_5fbc, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
