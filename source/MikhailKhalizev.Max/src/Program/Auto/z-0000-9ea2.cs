...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_9ea2()
        {
            ...
            ii(0x9ea8, 3);    mov(ds, memw[ss, bp + 0x4]);              /* mov ds, [bp+0x4] */
            ii(0x9eab, 3);    mov(si, memw[ss, bp + 0x6]);              /* mov si, [bp+0x6] */
            ii(0x9eae, 3);    mov(es, memw[ss, bp + 0x8]);              /* mov es, [bp+0x8] */
            ii(0x9eb1, 3);    mov(di, memw[ss, bp + 0xa]);              /* mov di, [bp+0xa] */
            ii(0x9eb4, 3);    mov(cx, memw[ss, bp + 0xc]);              /* mov cx, [bp+0xc] */
