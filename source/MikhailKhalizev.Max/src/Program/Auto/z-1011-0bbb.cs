...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_0bbb()
        {
            ...
            ii(0x1011_0bd2, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_0bd5, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ...
            ii(0x1011_0be1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_0be4, 2); mov(memd[ds, eax], edx);                /* mov [eax], edx */
            ii(0x1011_0be6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_0be9, 7); mov(memd[ds, eax + 0x4], 0);            /* mov dword [eax+0x4], 0x0 */
            ii(0x1011_0bf0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_0bf3, 7); mov(memd[ds, eax + 0x8], 0);            /* mov dword [eax+0x8], 0x0 */
            ii(0x1011_0bfa, 5); mov(eax, 0x3d);                         /* mov eax, 0x3d */
            ii(0x1011_0bff, 5); call(0x1007_5fdc, -0x9_ac28);           /* call 0x10075fdc */
            ii(0x1011_0c04, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_0c07, 6); mov(memb[ds, edx + 0x142], al);         /* mov [edx+0x142], al */
            ii(0x1011_0c0d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_0c10, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_0c12, 6); mov(dl, memb[ds, eax + 0x142]);         /* mov dl, [eax+0x142] */
            ...
            ii(0x1011_0c29, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_0c2c, 6); mov(memb[ds, edx + 0x140], al);         /* mov [edx+0x140], al */
            ii(0x1011_0c32, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_0c35, 10); mov(memd[ds, edx + 0x144], 0);         /* mov dword [edx+0x144], 0x0 */
            ii(0x1011_0c3f, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_0c42, 9); mov(memw[ds, edx + 0x14a], 0);          /* mov word [edx+0x14a], 0x0 */
            ...
            ii(0x1011_0c63, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ii(0x1011_0c66, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x1011_0c69, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_0c6c, 2); mov(ebx, memd[ds, edx]);                /* mov ebx, [edx] */
            ii(0x1011_0c6e, 3); mov(ebx, memd[ds, ebx + 0xe]);          /* mov ebx, [ebx+0xe] */
            ii(0x1011_0c71, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1011_0c74, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1011_0c83, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_0c86, 7); cmp(memb[ds, edx + 0x143], 0x1);        /* cmp byte [edx+0x143], 0x1 */
            ...
            ii(0x1011_0c94, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1011_0ca0:
            ii(0x1011_0ca0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_0ca3, 7); cmp(memb[ds, eax + 0x143], 0x8);        /* cmp byte [eax+0x143], 0x8 */
            ...
            ii(0x1011_0cb1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1011_0cbd:
            ii(0x1011_0cbd, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_0cc0, 7); cmp(memb[ds, eax + 0x143], 0x2);        /* cmp byte [eax+0x143], 0x2 */
            ...
            ii(0x1011_0cce, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1011_0cda:
            ...
            ii(0x1011_0cdf, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_0ce2, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1011_0ce4, 5); call(0x1010_c628, -0x46c1);             /* call 0x1010c628 */
        l_0x1011_0ce9:
            ii(0x1011_0ce9, 7); mov(memd[ss, ebp - 0xc], 0x13);         /* mov dword [ebp-0xc], 0x13 */
        l_0x1011_0cf0:
            ii(0x1011_0cf0, 3); dec(memd[ss, ebp - 0xc]);               /* dec dword [ebp-0xc] */
            ii(0x1011_0cf3, 5); cmp(memw[ss, ebp - 0xc], -0x1 /* 0xff */); /* cmp word [ebp-0xc], 0xffff */
            ii(0x1011_0cf8, 2); if(jz(0x1011_0d19, 0x1f)) goto l_0x1011_0d19; /* jz 0x10110d19 */
            ii(0x1011_0cfa, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1011_0cfe, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1011_0d01, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x1011_0d04, 7); mov(memd[ds, eax + 0x10], 0);           /* mov dword [eax+0x10], 0x0 */
            ii(0x1011_0d0b, 4); movsx(edx, memb[ss, ebp - 0xc]);        /* movsx edx, byte [ebp-0xc] */
            ii(0x1011_0d0f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1011_0d19:
            ii(0x1011_0d19, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_0d1c, 5); call(0x1011_0812, -0x50f);              /* call 0x10110812 */
            ii(0x1011_0d21, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_0d24, 5); call(0x1011_09f0, -0x339);              /* call 0x101109f0 */
            ii(0x1011_0d29, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
