...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_0bbb()
        {
            ...
            ii(0x1011_0c86, 7); cmp(memb[ds, edx + 0x143], 1);          /* cmp byte [edx+0x143], 0x1 */
        ...
        l_0x1011_0ca0:
            ...
            ii(0x1011_0ca3, 7); cmp(memb[ds, eax + 0x143], 8);          /* cmp byte [eax+0x143], 0x8 */
        ...
        l_0x1011_0cbd:
            ...
            ii(0x1011_0cc0, 7); cmp(memb[ds, eax + 0x143], 2);          /* cmp byte [eax+0x143], 0x2 */
        ...
        l_0x1011_0cf0:
            ...
            ii(0x1011_0cf3, 5); cmp(memw[ss, ebp - 0xc], -1 /* 0xff */); /* cmp word [ebp-0xc], 0xffff */
