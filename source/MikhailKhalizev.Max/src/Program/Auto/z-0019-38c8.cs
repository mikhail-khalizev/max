...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x19_38d6:
            ...
            ii(0x19_38d8, 2); if(jzw(0x19_3907, 0x2d)) goto l_0x19_3907; /* jz 0x3907 */
            ii(0x19_38da, 1); lodsb_a16();                              /* lodsb */
            ii(0x19_38db, 3); mov(ah, memb_a16[es, bx]);                /* mov ah, [es:bx] */
            ii(0x19_38de, 1); inc(bx);                                  /* inc bx */
            ii(0x19_38df, 2); cmp(ah, al);                              /* cmp ah, al */
            ii(0x19_38e1, 2); if(jzw(0x19_38d6, -0xd)) goto l_0x19_38d6; /* jz 0x38d6 */
            ...
            ii(0x19_3901, 2); if(jzw(0x19_38d6, -0x2d)) goto l_0x19_38d6; /* jz 0x38d6 */
            ii(0x19_3903, 2); sbb(al, al);                              /* sbb al, al */
            ii(0x19_3905, 2); sbb(al, -0x1 /* 0xff */);                 /* sbb al, 0xff */
        l_0x19_3907:
            ii(0x19_3907, 1); cbw();                                    /* cbw */
            ii(0x19_3908, 1); popw(ds);                                 /* pop ds */
            ii(0x19_3909, 2); mov(si, dx);                              /* mov si, dx */
            ii(0x19_390b, 1); popw(bp);                                 /* pop bp */
            ii(0x19_390c, 1); retfw(); return;                          /* retf */
        }
    }
}
