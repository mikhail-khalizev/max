...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_dc59()
        {
            ...
            ii(0x1013_dc70, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_dc73, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ...
            ii(0x1013_dc84, 4); mov(memb[ss, ebp - 0x1a], 0x2);         /* mov byte [ebp-0x1a], 0x2 */
            ii(0x1013_dc88, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_dc8b, 4); mov(memw[ss, ebp - 0x24], ax);          /* mov [ebp-0x24], ax */
            ii(0x1013_dc8f, 7); mov(memd[ss, ebp - 0x22], 0x7fff);      /* mov dword [ebp-0x22], 0x7fff */
            ii(0x1013_dc96, 7); mov(memd[ss, ebp - 0x1e], 0x7fff);      /* mov dword [ebp-0x1e], 0x7fff */
            ii(0x1013_dc9d, 7); mov(memd[ss, ebp - 0x19], 0x8000);      /* mov dword [ebp-0x19], 0x8000 */
            ii(0x1013_dca4, 7); mov(memd[ss, ebp - 0x15], 0);           /* mov dword [ebp-0x15], 0x0 */
            ii(0x1013_dcab, 6); mov(memw[ss, ebp - 0x11], 0);           /* mov word [ebp-0x11], 0x0 */
            ii(0x1013_dcb1, 6); mov(memw[ss, ebp - 0xf], 0);            /* mov word [ebp-0xf], 0x0 */
            ii(0x1013_dcb7, 6); mov(memw[ss, ebp - 0xd], 0);            /* mov word [ebp-0xd], 0x0 */
            ii(0x1013_dcbd, 4); mov(memb[ss, ebp - 0xb], 0);            /* mov byte [ebp-0xb], 0x0 */
            ii(0x1013_dcc1, 6); mov(memw[ss, ebp - 0xa], 0xffff);       /* mov word [ebp-0xa], 0xffff */
            ii(0x1013_dcc7, 3); lea(edx, memd[ss, ebp - 0x24]);         /* lea edx, [ebp-0x24] */
            ii(0x1013_dcca, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
