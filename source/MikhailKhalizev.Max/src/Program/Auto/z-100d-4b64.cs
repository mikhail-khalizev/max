...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_4b64()
        {
            ...
            ii(0x100d_4b7b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_4b7e, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ...
            ii(0x100d_4b8f, 7); mov(memd[ss, ebp - 0x10], 0x1);         /* mov dword [ebp-0x10], 0x1 */
            ii(0x100d_4b96, 5); jmp(0x100d_4c5e, 0xc3); goto l_0x100d_4c5e; /* jmp 0x100d4c5e */
        l_0x100d_4b9b:
            ii(0x100d_4b9b, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100d_4bac, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100d_4baf, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100d_4bb3, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x100d_4bb6, 5); call(0x100d_fd2c, 0xb171);              /* call 0x100dfd2c */
            ii(0x100d_4bbb, 4); mov(ax, memw[ds, eax + 0x8]);           /* mov ax, [eax+0x8] */
            ii(0x100d_4bbf, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100d_4bc2, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x100d_4bc5, 3); mov(al, memb[ds, eax + 0x28]);          /* mov al, [eax+0x28] */
            ...
            ii(0x100d_4bd2, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100d_4bd5, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
        ...
        l_0x100d_4bdd:
            ...
            ii(0x100d_4be7, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x100d_4bea, 2); jmp(0x100d_4c3c, 0x50); goto l_0x100d_4c3c; /* jmp 0x100d4c3c */
        l_0x100d_4bec:
            ii(0x100d_4bec, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x100d_4c00, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100d_4c03, 2); jmp(0x100d_4c5e, 0x59); goto l_0x100d_4c5e; /* jmp 0x100d4c5e */
        l_0x100d_4c05:
            ii(0x100d_4c05, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x100d_4c09, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100d_4c0c, 3); lea(edx, memd[ds, eax + 0x2]);          /* lea edx, [eax+0x2] */
            ...
            ii(0x100d_4c1b, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100d_4c1e, 2); jmp(0x100d_4c5e, 0x3e); goto l_0x100d_4c5e; /* jmp 0x100d4c5e */
        l_0x100d_4c20:
            ii(0x100d_4c20, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x100d_4c24, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x100d_4c26, 3); lea(edx, memd[ds, eax + 0x1]);          /* lea edx, [eax+0x1] */
            ...
            ii(0x100d_4c35, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
        ...
        l_0x100d_4c3c:
            ii(0x100d_4c3c, 4); cmp(memd[ss, ebp - 0x18], 0x4);         /* cmp dword [ebp-0x18], 0x4 */
            ii(0x100d_4c40, 2); if(jb(0x100d_4c50, 0xe)) goto l_0x100d_4c50; /* jb 0x100d4c50 */
            ii(0x100d_4c42, 4); cmp(memd[ss, ebp - 0x18], 0x4);         /* cmp dword [ebp-0x18], 0x4 */
            ii(0x100d_4c46, 2); if(jbe(0x100d_4c05, -0x43)) goto l_0x100d_4c05; /* jbe 0x100d4c05 */
            ii(0x100d_4c48, 4); cmp(memd[ss, ebp - 0x18], 0x5);         /* cmp dword [ebp-0x18], 0x5 */
        ...
        l_0x100d_4c50:
            ii(0x100d_4c50, 4); cmp(memd[ss, ebp - 0x18], 0);           /* cmp dword [ebp-0x18], 0x0 */
        ...
        l_0x100d_4c58:
            ii(0x100d_4c58, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100d_4c5b, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
        l_0x100d_4c5e:
            ii(0x100d_4c5e, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
