...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_86b0()
        {
            ...
            ii(0x1016_86b3, 4); mov(ebp, memd[ss, esp + 0x30]);         /* mov ebp, [esp+0x30] */
            ...
            ii(0x1016_86cd, 2); if(jz(0x1016_86d3, 0x4)) goto l_0x1016_86d3; /* jz 0x101686d3 */
        ...
        l_0x1016_86dd:
            ii(0x1016_86dd, 5); cmp(memd[ss, esp + 0x24], 0);           /* cmp dword [esp+0x24], 0x0 */
            ii(0x1016_86e2, 2); if(jnz(0x1016_86fd, 0x19)) goto l_0x1016_86fd; /* jnz 0x101686fd */
            ii(0x1016_86e4, 5); cmp(memd[ss, esp + 0x28], 0);           /* cmp dword [esp+0x28], 0x0 */
            ii(0x1016_86e9, 2); if(jnz(0x1016_86f2, 0x7)) goto l_0x1016_86f2; /* jnz 0x101686f2 */
            ii(0x1016_86eb, 5); cmp(memd[ss, esp + 0x2c], 0);           /* cmp dword [esp+0x2c], 0x0 */
        ...
        l_0x1016_86fd:
            ii(0x1016_86fd, 4); mov(eax, memd[ss, esp + 0x2c]);         /* mov eax, [esp+0x2c] */
            ii(0x1016_8701, 1); push(eax);                              /* push eax */
            ii(0x1016_8702, 4); mov(eax, memd[ss, esp + 0x2c]);         /* mov eax, [esp+0x2c] */
            ii(0x1016_8706, 1); push(eax);                              /* push eax */
            ii(0x1016_8707, 4); mov(eax, memd[ss, esp + 0x2c]);         /* mov eax, [esp+0x2c] */
            ii(0x1016_870b, 1); push(eax);                              /* push eax */
            ii(0x1016_870c, 1); push(ebp);                              /* push ebp */
            ii(0x1016_870d, 4); mov(ebp, memd[ss, esp + 0x30]);         /* mov ebp, [esp+0x30] */
            ii(0x1016_8711, 1); push(ebp);                              /* push ebp */
            ii(0x1016_8712, 4); mov(eax, memd[ss, esp + 0x30]);         /* mov eax, [esp+0x30] */
            ii(0x1016_8716, 1); push(eax);                              /* push eax */
            ii(0x1016_8717, 4); mov(ebp, memd[ss, esp + 0x30]);         /* mov ebp, [esp+0x30] */
            ii(0x1016_871b, 1); push(ebp);                              /* push ebp */
            ii(0x1016_871c, 4); mov(eax, memd[ss, esp + 0x30]);         /* mov eax, [esp+0x30] */
            ii(0x1016_8720, 1); push(eax);                              /* push eax */
            ii(0x1016_8721, 4); mov(ebp, memd[ss, esp + 0x30]);         /* mov ebp, [esp+0x30] */
        ...
        l_0x1016_873e:
            ...
            ii(0x1016_8742, 3); mov(ebx, memd[ds, eax + 0x30]);         /* mov ebx, [eax+0x30] */
