...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_cae7()
        {
            ...
            ii(0x100f_caff, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100f_cb02, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x100f_cb14, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100f_cb17, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x100f_cb1a, 5); call(Definitions.my_ctor_0x101b_4184, -0x8_602f); /* call 0x10076af0 */
            ii(0x100f_cb1f, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x100f_cb23, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_cb26, 3); mov(edx, memd[ds, eax + 0xc]);          /* mov edx, [eax+0xc] */
            ...
            ii(0x100f_cb49, 4); mov(memw[ss, ebp - 0x1c], ax);          /* mov [ebp-0x1c], ax */
            ii(0x100f_cb4d, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100f_cb50, 3); mov(edx, memd[ds, edx + 0xc]);          /* mov edx, [edx+0xc] */
            ...
            ii(0x100f_cb6d, 4); mov(memw[ss, ebp - 0x1a], ax);          /* mov [ebp-0x1a], ax */
            ii(0x100f_cb71, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x100f_cb74, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100f_cb77, 2); jmp(0x100f_cb9a, 0x21); goto l_0x100f_cb9a; /* jmp 0x100fcb9a */
        l_0x100f_cb79:
            ii(0x100f_cb79, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100f_cb7c, 3); mov(edx, memd[ds, edx + 0xc]);          /* mov edx, [edx+0xc] */
            ...
            ii(0x100f_cb91, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100f_cb95, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x100f_cb97, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
        l_0x100f_cb9a:
            ii(0x100f_cb9a, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100f_cbaa, 3); mov(eax, memd[ss, ebp - 0x1a]);         /* mov eax, [ebp-0x1a] */
            ii(0x100f_cbad, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100f_cbb0, 4); cmp(memb[ss, ebp - 0x8], 0);            /* cmp byte [ebp-0x8], 0x0 */
            ii(0x100f_cbb4, 2); if(jz(0x100f_cbd1, 0x1b)) goto l_0x100f_cbd1; /* jz 0x100fcbd1 */
            ii(0x100f_cbb6, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100f_cbb9, 3); mov(edx, memd[ds, edx + 0xc]);          /* mov edx, [edx+0xc] */
            ...
            ii(0x100f_cbc8, 4); movsx(edx, memw[ss, ebp - 0x14]);       /* movsx edx, word [ebp-0x14] */
            ii(0x100f_cbcc, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x100f_cbce, 3); mov(memd[ss, ebp - 0x14], edx);         /* mov [ebp-0x14], edx */
        l_0x100f_cbd1:
            ii(0x100f_cbd1, 2); jmp(0x100f_cbdd, 0xa); goto l_0x100f_cbdd; /* jmp 0x100fcbdd */
        l_0x100f_cbd3:
            ii(0x100f_cbd3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_cbd6, 4); mov(ax, memw[ds, eax + 0xe]);           /* mov ax, [eax+0xe] */
            ii(0x100f_cbda, 3); add(memd[ss, ebp - 0x14], eax);         /* add [ebp-0x14], eax */
        l_0x100f_cbdd:
            ii(0x100f_cbdd, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ...
            ii(0x100f_cbed, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_cbf0, 3); mov(edx, memd[ds, eax + 0xe]);          /* mov edx, [eax+0xe] */
            ii(0x100f_cbf3, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100f_cbf6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_cbf9, 3); mov(eax, memd[ds, eax + 0xe]);          /* mov eax, [eax+0xe] */
            ...
            ii(0x100f_cc0f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_cc12, 3); mov(eax, memd[ds, eax + 0xe]);          /* mov eax, [eax+0xe] */
            ii(0x100f_cc15, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100f_cc18, 2); neg(eax);                               /* neg eax */
            ii(0x100f_cc1a, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x100f_cc1c, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100f_cc20, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x100f_cc22, 4); mov(memw[ss, ebp - 0x18], ax);          /* mov [ebp-0x18], ax */
            ii(0x100f_cc26, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100f_cc29, 3); mov(edx, memd[ds, edx + 0xe]);          /* mov edx, [edx+0xe] */
            ii(0x100f_cc2c, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100f_cc2f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_cc32, 3); mov(eax, memd[ds, eax + 0xe]);          /* mov eax, [eax+0xe] */
            ...
            ii(0x100f_cc48, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_cc4b, 3); mov(eax, memd[ds, eax + 0xe]);          /* mov eax, [eax+0xe] */
            ii(0x100f_cc4e, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100f_cc51, 2); neg(eax);                               /* neg eax */
            ii(0x100f_cc53, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x100f_cc55, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ii(0x100f_cc59, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x100f_cc5b, 4); mov(memw[ss, ebp - 0x16], ax);          /* mov [ebp-0x16], ax */
            ii(0x100f_cc5f, 4); movsx(ecx, memw[ss, ebp - 0x10]);       /* movsx ecx, word [ebp-0x10] */
            ii(0x100f_cc63, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100f_cc71, 3); lea(edx, memd[ss, ebp - 0x18]);         /* lea edx, [ebp-0x18] */
            ii(0x100f_cc74, 3); lea(eax, memd[ss, ebp - 0x20]);         /* lea eax, [ebp-0x20] */
            ii(0x100f_cc77, 5); call(0x1007_5e64, -0x8_6e18);           /* call 0x10075e64 */
            ii(0x100f_cc7c, 3); mov(esi, memd[ss, ebp - 0x4]);          /* mov esi, [ebp-0x4] */
        ...
        l_0x100f_cc8d:
            ii(0x100f_cc8d, 4); cmp(memb[ss, ebp - 0x8], 0);            /* cmp byte [ebp-0x8], 0x0 */
            ii(0x100f_cc91, 2); if(jnz(0x100f_cc99, 0x6)) goto l_0x100f_cc99; /* jnz 0x100fcc99 */
            ii(0x100f_cc93, 4); mov(memb[ss, ebp - 0x24], 0x1);         /* mov byte [ebp-0x24], 0x1 */
            ii(0x100f_cc97, 2); jmp(0x100f_cc9d, 0x4); goto l_0x100f_cc9d; /* jmp 0x100fcc9d */
        l_0x100f_cc99:
            ii(0x100f_cc99, 4); mov(memb[ss, ebp - 0x24], 0);           /* mov byte [ebp-0x24], 0x0 */
        l_0x100f_cc9d:
            ii(0x100f_cc9d, 3); mov(al, memb[ss, ebp - 0x24]);          /* mov al, [ebp-0x24] */
            ii(0x100f_cca0, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
