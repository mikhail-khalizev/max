...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("55b381ef-9cfa-4a3c-97f9-6a7b80767f7c")]
        public void Method_1013_791f()
        {
            ii(0x1013_791f, 5); pushd(0x58);                            /* push 0x58 */
            ii(0x1013_7924, 5); calld(Definitions.sys_check_available_stack_size, 0x2e429); /* call 0x10165d52 */
            ...
            ii(0x1013_7945, 5); calld(Definitions.sys_new, 0x2e4b6);    /* call 0x10165e00 */
            ...
            ii(0x1013_796d, 5); calld(Definitions.my_ctor_c17, -0x69563); /* call 0x100ce40f */
        ...
        l_0x1013_7983:
            ...
            ii(0x1013_7992, 5); calld(0x100d_5224, -0x62773);           /* call 0x100d5224 */
            ii(0x1013_7997, 1); pushd(eax);                             /* push eax */
            ii(0x1013_7998, 3); lea(eax, ebp - 0x2c);                   /* lea eax, [ebp-0x2c] */
            ii(0x1013_799b, 5); calld(0x100d_5250, -0x62750);           /* call 0x100d5250 */
            ii(0x1013_79a0, 1); pushd(eax);                             /* push eax */
            ii(0x1013_79a1, 3); lea(eax, ebp - 0x30);                   /* lea eax, [ebp-0x30] */
            ii(0x1013_79a4, 5); calld(0x100d_527c, -0x6272d);           /* call 0x100d527c */
            ii(0x1013_79a9, 1); pushd(eax);                             /* push eax */
            ii(0x1013_79aa, 3); lea(eax, ebp - 0x34);                   /* lea eax, [ebp-0x34] */
            ii(0x1013_79ad, 5); calld(0x100d_52a8, -0x6270a);           /* call 0x100d52a8 */
            ii(0x1013_79b2, 1); pushd(eax);                             /* push eax */
            ii(0x1013_79b3, 5); calld(0x100d_52d4, -0x626e4);           /* call 0x100d52d4 */
            ii(0x1013_79b8, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x1013_79bb, 5); calld(0x100d_52f8, -0x626c8);           /* call 0x100d52f8 */
            ...
            ii(0x1013_79c9, 5); calld(0x100c_ef64, -0x68a6a);           /* call 0x100cef64 */
        l_0x1013_79ce:
            ii(0x1013_79ce, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_79d0, 3); mov(eax, memd_a32[ss, ebp - 0x24]);     /* mov eax, [ebp-0x24] */
            ii(0x1013_79d3, 5); calld(0x100d_5194, -0x62844);           /* call 0x100d5194 */
            ...
            ii(0x1013_79de, 5); calld(0x100d_5134, -0x628af);           /* call 0x100d5134 */
            ...
            ii(0x1013_79e9, 5); calld(0x100c_f85c, -0x68192);           /* call 0x100cf85c */
            ii(0x1013_79ee, 5); calld(0x100d_51e4, -0x6280f);           /* call 0x100d51e4 */
            ii(0x1013_79f3, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1013_79f5, 2); mov(bl, al);                            /* mov bl, al */
            ii(0x1013_79f7, 5); calld(0x100d_5204, -0x627f8);           /* call 0x100d5204 */
            ...
            ii(0x1013_7a03, 5); calld(0x100c_fa7c, -0x67f8c);           /* call 0x100cfa7c */
