...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void my_string_add_ref()
        {
            ...
            ii(0x1014_2476, 6); sub(esp, 4);                            /* sub esp, 0x4 */
            ii(0x1014_247c, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1014_247f, 4); cmp(memd[ss, ebp - 4], 0);              /* cmp dword [ebp-0x4], 0x0 */
            ii(0x1014_2483, 2); if(jz(0x1014_248b, 6)) goto l_0x1014_248b; /* jz 0x1014248b */
            ii(0x1014_2485, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_2488, 3); inc(memd[ds, eax + 8]);                 /* inc dword [eax+0x8] */
        l_0x1014_248b:
