...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_6b38()
        {
            ...
            ii(0x1014_6b4f, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1014_6b52, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1014_6b55, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1014_6b58, 5); call(0x1014_68e2, -0x27b);              /* call 0x101468e2 */
            ii(0x1014_6b5d, 2); test(al, al);                           /* test al, al */
            ii(0x1014_6b5f, 2); if(jnz(0x1014_6b67, 6)) goto l_0x1014_6b67; /* jnz 0x10146b67 */
            ii(0x1014_6b61, 4); mov(memb[ss, ebp - 12], 0);             /* mov byte [ebp-0xc], 0x0 */
            ii(0x1014_6b65, 2); jmp(0x1014_6bcc, 0x65); goto l_0x1014_6bcc; /* jmp 0x10146bcc */
        l_0x1014_6b67:
            ii(0x1014_6b67, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1014_6b6a, 3); mov(al, memb[ds, eax + 28]);            /* mov al, [eax+0x1c] */
            ...
            ii(0x1014_6b83, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1014_6b86, 1); push(eax);                              /* push eax */
            ii(0x1014_6b87, 5); call(0x1014_69b5, -0x1d7);              /* call 0x101469b5 */
            ii(0x1014_6b8c, 3); add(esp, 8);                            /* add esp, 0x8 */
        l_0x1014_6b8f:
            ii(0x1014_6b8f, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1014_6b92, 3); mov(al, memb[ds, eax + 28]);            /* mov al, [eax+0x1c] */
            ...
            ii(0x1014_6ba3, 2); if(jnz(0x1014_6bae, 9)) goto l_0x1014_6bae; /* jnz 0x10146bae */
            ii(0x1014_6ba5, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1014_6ba8, 4); cmp(memd[ds, eax + 28], 0x5f);          /* cmp dword [eax+0x1c], 0x5f */
            ii(0x1014_6bac, 2); if(jnz(0x1014_6bc8, 0x1a)) goto l_0x1014_6bc8; /* jnz 0x10146bc8 */
        l_0x1014_6bae:
            ii(0x1014_6bae, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1014_6bb1, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_6bb3, 3); mov(dl, memb[ds, eax + 28]);            /* mov dl, [eax+0x1c] */
            ii(0x1014_6bb6, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_6bb9, 5); call(Definitions.my_string_append_char, -0x4dd4); /* call 0x10141dea */
            ii(0x1014_6bbe, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
        ...
        l_0x1014_6bc8:
            ii(0x1014_6bc8, 4); mov(memb[ss, ebp - 12], 1);             /* mov byte [ebp-0xc], 0x1 */
        l_0x1014_6bcc:
            ii(0x1014_6bcc, 3); mov(al, memb[ss, ebp - 12]);            /* mov al, [ebp-0xc] */
