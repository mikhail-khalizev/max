...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("05f3112c-a913-4a00-90d1-ed2f96053566")]
        public void Method_1013_17ac()
        {
            ii(0x1013_17ac, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x1013_17b1, 5); calld(Definitions.sys_check_available_stack_size, 0x3459c); /* call 0x10165d52 */
            ...
            ii(0x1013_17d1, 5); calld(Definitions.my_dtor_0x101b6edc, 0x946f); /* call 0x1013ac45 */
            ...
            ii(0x1013_17e9, 1); retd(); return;                         /* ret */
        }
    }
}
