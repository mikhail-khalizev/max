...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_c858()
        {
            ...
            ii(0x1015_c870, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_c873, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_c876, 3); mov(al, memb[ds, eax + 0x29]);          /* mov al, [eax+0x29] */
            ii(0x1015_c879, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1015_c87b, 5); add(eax, 0xc8);                         /* add eax, 0xc8 */
            ii(0x1015_c880, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1015_c883, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
