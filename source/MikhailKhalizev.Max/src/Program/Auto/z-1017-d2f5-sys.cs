...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_d2f5()
        {
            ...
            ii(0x1017_d306, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
        ...
        l_0x1017_d321:
            ...
            ii(0x1017_d323, 2); if(jnz(0x1017_d32c, 0x7)) goto l_0x1017_d32c; /* jnz 0x1017d32c */
        ...
        l_0x1017_d32c:
            ...
            ii(0x1017_d332, 3); mov(ebx, memd[ss, ebp - 0x1c]);         /* mov ebx, [ebp-0x1c] */
            ...
            ii(0x1017_d34c, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
        ...
        l_0x1017_d353:
            ...
            ii(0x1017_d355, 4); mov(ax, memw[ss, ebp - 0xc]);           /* mov ax, [ebp-0xc] */
        ...
        l_0x1017_d363:
            ii(0x1017_d363, 4); test(memb[ss, ebp - 0x14], 0x40);       /* test byte [ebp-0x14], 0x40 */
            ii(0x1017_d367, 2); if(jz(0x1017_d39e, 0x35)) goto l_0x1017_d39e; /* jz 0x1017d39e */
            ii(0x1017_d369, 3); mov(ecx, memd[ss, ebp - 0x24]);         /* mov ecx, [ebp-0x24] */
            ii(0x1017_d36c, 3); mov(edx, memd[ss, ebp - 0x20]);         /* mov edx, [ebp-0x20] */
            ii(0x1017_d36f, 3); mov(ebx, memd[ss, ebp - 0x1c]);         /* mov ebx, [ebp-0x1c] */
            ...
            ii(0x1017_d37c, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1017_d37f, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1017_d381, 2); if(jl(0x1017_d353, -0x30)) goto l_0x1017_d353; /* jl 0x1017d353 */
            ii(0x1017_d383, 3); cmp(eax, memd[ss, ebp - 0x24]);         /* cmp eax, [ebp-0x24] */
            ...
            ii(0x1017_d396, 3); mov(memd[ss, ebp - 0x24], esi);         /* mov [ebp-0x24], esi */
        ...
        l_0x1017_d39e:
            ...
            ii(0x1017_d3aa, 2); if(jae(0x1017_d3b1, 0x5)) goto l_0x1017_d3b1; /* jae 0x1017d3b1 */
        ...
        l_0x1017_d3c3:
            ...
            ii(0x1017_d3d0, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1017_d3d3, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1017_d3d6, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1017_d3d9, 3); mov(memd[ss, ebp - 0x18], edx);         /* mov [ebp-0x18], edx */
            ii(0x1017_d3dc, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x1017_d3df:
            ii(0x1017_d3df, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1017_d3e2, 3); cmp(eax, memd[ss, ebp - 0x24]);         /* cmp eax, [ebp-0x24] */
            ii(0x1017_d3e5, 6); if(jae(0x1017_d48a, 0x9f)) goto l_0x1017_d48a; /* jae 0x1017d48a */
            ii(0x1017_d3eb, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x1017_d3f7, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x1017_d403, 3); mov(ebx, memd[ss, ebp - 0x1c]);         /* mov ebx, [ebp-0x1c] */
            ...
            ii(0x1017_d414, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
        ...
        l_0x1017_d423:
            ...
            ii(0x1017_d42d, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1017_d430, 2); add(eax, esi);                          /* add eax, esi */
            ii(0x1017_d432, 5); jmp(0x1017_d4c3, 0x8c); goto l_0x1017_d4c3; /* jmp 0x1017d4c3 */
        l_0x1017_d437:
            ii(0x1017_d437, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1017_d43a, 2); xor(esi, edi);                          /* xor esi, edi */
            ii(0x1017_d43c, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
        l_0x1017_d43f:
            ii(0x1017_d43f, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1017_d442, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1017_d445, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ii(0x1017_d448, 3); mov(ecx, memd[ss, ebp - 0x4]);          /* mov ecx, [ebp-0x4] */
            ii(0x1017_d44b, 1); inc(ebx);                               /* inc ebx */
            ii(0x1017_d44c, 1); inc(ecx);                               /* inc ecx */
            ii(0x1017_d44d, 2); mov(dl, memb[ds, edx]);                 /* mov dl, [edx] */
            ii(0x1017_d44f, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1017_d452, 3); mov(memb[ds, esi + eax], dl);           /* mov [esi+eax], dl */
            ii(0x1017_d455, 1); inc(esi);                               /* inc esi */
            ii(0x1017_d456, 3); mov(memd[ss, ebp - 0x4], ecx);          /* mov [ebp-0x4], ecx */
            ii(0x1017_d459, 2); cmp(esi, edi);                          /* cmp esi, edi */
            ii(0x1017_d45b, 2); if(jnz(0x1017_d3df, -0x7e)) goto l_0x1017_d3df; /* jnz 0x1017d3df */
            ii(0x1017_d45d, 3); mov(ebx, memd[ss, ebp - 0x1c]);         /* mov ebx, [ebp-0x1c] */
            ...
            ii(0x1017_d46e, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ...
            ii(0x1017_d47d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1017_d480, 2); xor(esi, edi);                          /* xor esi, edi */
            ii(0x1017_d482, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
        ...
        l_0x1017_d48a:
            ...
            ii(0x1017_d48e, 3); mov(edx, memd[ss, ebp - 0x10]);         /* mov edx, [ebp-0x10] */
            ii(0x1017_d491, 3); mov(ebx, memd[ss, ebp - 0x1c]);         /* mov ebx, [ebp-0x1c] */
            ...
            ii(0x1017_d4a0, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ...
            ii(0x1017_d4b9, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1017_d4bc, 2); add(eax, edi);                          /* add eax, edi */
            ii(0x1017_d4be, 2); jmp(0x1017_d4c3, 0x3); goto l_0x1017_d4c3; /* jmp 0x1017d4c3 */
        l_0x1017_d4c0:
            ii(0x1017_d4c0, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
        l_0x1017_d4c3:
