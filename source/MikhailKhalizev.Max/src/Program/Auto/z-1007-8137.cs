...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_8137()
        {
            ...
            ii(0x1007_814e, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_8151, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ...
            ii(0x1007_816d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1007_817a:
            ...
            ii(0x1007_8181, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_8184, 5); call(Definitions.sys_memset, 0xe_dc57); /* call 0x10165de0 */
            ii(0x1007_8189, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_818c, 4); mov(memb[ds, eax + 0x4], 0x1);          /* mov byte [eax+0x4], 0x1 */
            ii(0x1007_8190, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1007_81a6, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1007_81a9, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1007_81ad, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1007_81af, 2); if(jl(0x1007_81bb, 0xa)) goto l_0x1007_81bb; /* jl 0x100781bb */
            ii(0x1007_81b1, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1007_81b5, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x1007_81b8, 3); mov(memb[ds, eax], 0x1);                /* mov byte [eax], 0x1 */
        l_0x1007_81bb:
            ii(0x1007_81bb, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1007_81c2, 2); jmp(0x1007_81ca, 0x6); goto l_0x1007_81ca; /* jmp 0x100781ca */
        l_0x1007_81c4:
            ii(0x1007_81c4, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1007_81c7, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x1007_81ca:
            ii(0x1007_81ca, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1007_81ce, 3); cmp(eax, 0x4);                          /* cmp eax, 0x4 */
            ii(0x1007_81d1, 6); if(jge(0x1007_825e, 0x87)) goto l_0x1007_825e; /* jge 0x1007825e */
            ii(0x1007_81d7, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1007_81f1, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
        ...
        l_0x1007_820b:
            ii(0x1007_820b, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1007_820f, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x1007_8212, 3); mov(memb[ds, eax], 0x1);                /* mov byte [eax], 0x1 */
            ii(0x1007_8215, 2); jmp(0x1007_8259, 0x42); goto l_0x1007_8259; /* jmp 0x10078259 */
        l_0x1007_8217:
            ii(0x1007_8217, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1007_8231, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1007_8247, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ii(0x1007_824b, 2); if(jz(0x1007_824f, 0x2)) goto l_0x1007_824f; /* jz 0x1007824f */
        l_0x1007_824d:
            ii(0x1007_824d, 2); jmp(0x1007_8259, 0xa); goto l_0x1007_8259; /* jmp 0x10078259 */
        l_0x1007_824f:
            ii(0x1007_824f, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1007_8253, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x1007_8256, 3); mov(memb[ds, eax], 0x1);                /* mov byte [eax], 0x1 */
        l_0x1007_8259:
