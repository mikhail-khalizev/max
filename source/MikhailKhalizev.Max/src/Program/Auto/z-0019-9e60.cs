...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_9e60()
        {
            ...
            ii(0x19_9e64, 5); mov(memw[ss, bp - 0xc], 0);               /* mov word [bp-0xc], 0x0 */
            ii(0x19_9e69, 3); les(bx, memw[ss, bp + 0x4]);              /* les bx, [bp+0x4] */
            ii(0x19_9e6c, 6); cmp(memw[es, bx + 0x12a], 0);             /* cmp word [es:bx+0x12a], 0x0 */
            ii(0x19_9e72, 2); if(jl(0x19_9e84, 0x10)) goto l_0x19_9e84; /* jl 0x9e84 */
            ii(0x19_9e74, 2); push(0x8);                                /* push 0x8 */
            ii(0x19_9e76, 4); lea(ax, memw[ds, bx + 0x12a]);            /* lea ax, [bx+0x12a] */
            ii(0x19_9e7a, 1); push(es);                                 /* push es */
            ii(0x19_9e7b, 1); push(ax);                                 /* push ax */
            ii(0x19_9e7c, 3); lea(ax, memw[ss, bp - 0x22]);             /* lea ax, [bp-0x22] */
        ...
        l_0x19_9e84:
            ...
            ii(0x19_9e85, 3); ret(0x4);                                 /* ret 0x4 */
        }
    }
}
