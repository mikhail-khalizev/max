...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_69a3()
        {
            ...
            ii(0x1008_69bb, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_69be, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_69d5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_69d8, 4); or(memb[ds, eax + 0x3a], 0x40);         /* or byte [eax+0x3a], 0x40 */
            ii(0x1008_69dc, 3); lea(edx, ebp - 0x20);                   /* lea edx, [ebp-0x20] */
            ii(0x1008_69df, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_69e2, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ii(0x1008_69e5, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1008_69e8, 5); call(0x1007_8137, -0xe8b6);             /* call 0x10078137 */
            ii(0x1008_69ed, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_69f0, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1008_6a0b, 2); jmp(0x1008_6a15, 0x8); goto l_0x1008_6a15; /* jmp 0x10086a15 */
        l_0x1008_6a0d:
        ...
        l_0x1008_6a39:
            ii(0x1008_6a39, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_6a3c, 6); mov(memw[ds, eax + 0xd], 0x1f00);       /* mov word [eax+0xd], 0x1f00 */
            ii(0x1008_6a42, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_6a59, 2); jmp(0x1008_6a63, 0x8); goto l_0x1008_6a63; /* jmp 0x10086a63 */
        l_0x1008_6a5b:
        ...
        l_0x1008_6a63:
            ...
            ii(0x1008_6a8f, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ...
            ii(0x1008_6a9f, 5); cmp(memw[ds, eax + 0x8], 0x31);         /* cmp word [eax+0x8], 0x31 */
        ...
        l_0x1008_6aaa:
            ...
            ii(0x1008_6ab8, 2); if(jnz(0x1008_6ac0, 0x6)) goto l_0x1008_6ac0; /* jnz 0x10086ac0 */
            ii(0x1008_6aba, 4); mov(memb[ss, ebp - 0x28], 0x1);         /* mov byte [ebp-0x28], 0x1 */
            ii(0x1008_6abe, 2); jmp(0x1008_6ac4, 0x4); goto l_0x1008_6ac4; /* jmp 0x10086ac4 */
        l_0x1008_6ac0:
            ii(0x1008_6ac0, 4); mov(memb[ss, ebp - 0x28], 0);           /* mov byte [ebp-0x28], 0x0 */
        l_0x1008_6ac4:
            ii(0x1008_6ac4, 3); mov(al, memb[ss, ebp - 0x28]);          /* mov al, [ebp-0x28] */
            ii(0x1008_6ac7, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x1008_6aca, 4); cmp(memb[ss, ebp - 0x8], 0);            /* cmp byte [ebp-0x8], 0x0 */
            ii(0x1008_6ace, 2); if(jz(0x1008_6ae0, 0x10)) goto l_0x1008_6ae0; /* jz 0x10086ae0 */
            ii(0x1008_6ad0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_6ade, 2); if(jg(0x1008_6ae2, 0x2)) goto l_0x1008_6ae2; /* jg 0x10086ae2 */
        l_0x1008_6ae0:
        ...
        l_0x1008_6ae2:
            ...
            ii(0x1008_6ae5, 5); cmp(memw[ds, eax + 0x8], 0x1e);         /* cmp word [eax+0x8], 0x1e */
            ...
            ii(0x1008_6aef, 5); cmp(memw[ds, eax + 0x8], 0x28);         /* cmp word [eax+0x8], 0x28 */
            ii(0x1008_6af4, 2); if(jnz(0x1008_6af8, 0x2)) goto l_0x1008_6af8; /* jnz 0x10086af8 */
        l_0x1008_6af6:
            ii(0x1008_6af6, 2); jmp(0x1008_6afa, 0x2); goto l_0x1008_6afa; /* jmp 0x10086afa */
        l_0x1008_6af8:
            ii(0x1008_6af8, 2); jmp(0x1008_6b21, 0x27); goto l_0x1008_6b21; /* jmp 0x10086b21 */
        l_0x1008_6afa:
            ii(0x1008_6afa, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_6afd, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1008_6b1f, 2); if(jg(0x1008_6b23, 0x2)) goto l_0x1008_6b23; /* jg 0x10086b23 */
        l_0x1008_6b21:
            ii(0x1008_6b21, 2); jmp(0x1008_6b2c, 0x9); goto l_0x1008_6b2c; /* jmp 0x10086b2c */
        l_0x1008_6b23:
            ii(0x1008_6b23, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1008_6b2e:
            ...
            ii(0x1008_6b3c, 2); if(jnz(0x1008_6b44, 0x6)) goto l_0x1008_6b44; /* jnz 0x10086b44 */
            ii(0x1008_6b3e, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
        ...
        l_0x1008_6b44:
            ...
            ii(0x1008_6b47, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_6b4a, 3); mov(edx, memd[ds, eax + 0x7]);          /* mov edx, [eax+0x7] */
            ...
            ii(0x1008_6b5c, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x1008_6b60, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_6b63, 6); mov(memw[ds, eax + 0xd], 0x1000);       /* mov word [eax+0xd], 0x1000 */
        l_0x1008_6b69:
            ii(0x1008_6b69, 4); cmp(memb[ss, ebp - 0x8], 0);            /* cmp byte [ebp-0x8], 0x0 */
            ii(0x1008_6b6d, 2); if(jz(0x1008_6b86, 0x17)) goto l_0x1008_6b86; /* jz 0x10086b86 */
            ii(0x1008_6b6f, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x1008_6b86:
            ...
            ii(0x1008_6b90, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1008_6b9d:
            ii(0x1008_6b9d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_6bb4, 2); jmp(0x1008_6bbe, 0x8); goto l_0x1008_6bbe; /* jmp 0x10086bbe */
        l_0x1008_6bb6:
        ...
        l_0x1008_6bbe:
            ...
            ii(0x1008_6be4, 3); cmp(eax, memd[ss, ebp - 0x4]);          /* cmp eax, [ebp-0x4] */
            ...
            ii(0x1008_6bec, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_6bef, 5); call(0x1008_685e, -0x396);              /* call 0x1008685e */
            ii(0x1008_6bf4, 2); test(al, al);                           /* test al, al */
            ii(0x1008_6bf6, 2); if(jz(0x1008_6bfa, 0x2)) goto l_0x1008_6bfa; /* jz 0x10086bfa */
        l_0x1008_6bf8:
        ...
        l_0x1008_6bfa:
            ...
            ii(0x1008_6c04, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1008_6c0e:
            ii(0x1008_6c0e, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x1008_6c1b:
            ii(0x1008_6c1b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_6c1e, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1008_6c40, 2); jmp(0x1008_6c4a, 0x8); goto l_0x1008_6c4a; /* jmp 0x10086c4a */
        l_0x1008_6c42:
        ...
        l_0x1008_6c4a:
            ...
            ii(0x1008_6c80, 2); if(jz(0x1008_6c84, 0x2)) goto l_0x1008_6c84; /* jz 0x10086c84 */
        l_0x1008_6c82:
        ...
        l_0x1008_6c84:
            ...
            ii(0x1008_6c91, 3); cmp(eax, memd[ss, ebp - 0x4]);          /* cmp eax, [ebp-0x4] */
            ii(0x1008_6c94, 2); if(jnz(0x1008_6c98, 0x2)) goto l_0x1008_6c98; /* jnz 0x10086c98 */
        l_0x1008_6c96:
        ...
        l_0x1008_6c98:
            ...
            ii(0x1008_6ca2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_6ca5, 5); call(0x1008_685e, -0x44c);              /* call 0x1008685e */
            ii(0x1008_6caa, 2); test(al, al);                           /* test al, al */
            ii(0x1008_6cac, 2); if(jnz(0x1008_6cb3, 0x5)) goto l_0x1008_6cb3; /* jnz 0x10086cb3 */
        l_0x1008_6cae:
        ...
        l_0x1008_6cb3:
            ...
            ii(0x1008_6ce6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_6cf9, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1008_6d0d, 2); jmp(0x1008_6d15, 0x6); goto l_0x1008_6d15; /* jmp 0x10086d15 */
        l_0x1008_6d0f:
        ...
        l_0x1008_6d15:
            ...
            ii(0x1008_6d20, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1008_6d3a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1008_6d65:
            ...
            ii(0x1008_6d6f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_6d80, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ...
            ii(0x1008_6d91, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1008_6dd9:
            ii(0x1008_6dd9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_6df0, 2); jmp(0x1008_6dfa, 0x8); goto l_0x1008_6dfa; /* jmp 0x10086dfa */
        l_0x1008_6df2:
        ...
        l_0x1008_6dfa:
            ...
            ii(0x1008_6e08, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
