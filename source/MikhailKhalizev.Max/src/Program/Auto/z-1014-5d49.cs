...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_5d49()
        {
            ...
            ii(0x1014_5d5e, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1014_5d61, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x1014_5d64, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1014_5d67, 3); mov(memd[ss, ebp - 0x4], ecx);          /* mov [ebp-0x4], ecx */
            ii(0x1014_5d6a, 3); mov(ebx, memd[ss, ebp - 0xc]);          /* mov ebx, [ebp-0xc] */
            ii(0x1014_5d6d, 3); lea(edx, memd[ss, ebp - 0x18]);         /* lea edx, [ebp-0x18] */
            ii(0x1014_5d70, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1014_5d73, 5); call(0x1014_630a, 0x592);               /* call 0x1014630a */
            ii(0x1014_5d78, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_5d7a, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x1014_5d86, 4); mov(memb[ss, ebp - 0x14], 0);           /* mov byte [ebp-0x14], 0x0 */
            ii(0x1014_5d8a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_5d8c, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
        ...
        l_0x1014_5d96:
            ii(0x1014_5d96, 4); movsx(ecx, memw[ss, ebp - 0x4]);        /* movsx ecx, word [ebp-0x4] */
            ii(0x1014_5d9a, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1014_5d9d, 5); call(0x100e_0760, -0x6_5642);           /* call 0x100e0760 */
            ii(0x1014_5da2, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1014_5da5, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x1014_5da8, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x1014_5dab, 3); lea(edx, memd[ss, ebp - 0x20]);         /* lea edx, [ebp-0x20] */
            ii(0x1014_5dae, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x1014_5db1, 3); call_abs(memd[ds, ebx + 0x8]);          /* call dword [ebx+0x8] */
            ii(0x1014_5db4, 5); call(Definitions.my_strobj_c_str_v2, -0xb_c5f1); /* call 0x100897c8 */
            ii(0x1014_5db9, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1014_5dbb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_5dc7, 3); lea(eax, memd[ss, ebp - 0x20]);         /* lea eax, [ebp-0x20] */
            ii(0x1014_5dca, 5); call(Definitions.my_string_dtor, -0x42a5); /* call 0x10141b2a */
            ii(0x1014_5dcf, 4); mov(memb[ss, ebp - 0x14], 0x1);         /* mov byte [ebp-0x14], 0x1 */
            ii(0x1014_5dd3, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_5dd5, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
        ...
        //  ii(0x1014_5de1, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
        //  ii(0x1014_5de4, 5); call(0x100e_03bc, -0x6_5a2d);           /* call 0x100e03bc */
        l_0x1014_5de9:
            ii(0x1014_5de9, 3); mov(al, memb[ss, ebp - 0x14]);          /* mov al, [ebp-0x14] */
