...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_1d6e()
        {
            ...
            ii(0x1018_1d71, 3); mov(eax, memd[ds, eax + 0x2]);          /* mov eax, [eax+0x2] */
            ii(0x1018_1d74, 2); add(eax, ebx);                          /* add eax, ebx */
            ii(0x1018_1d76, 4); movzx(ebx, memb[ds, eax + 0x4]);        /* movzx ebx, byte [eax+0x4] */
            ii(0x1018_1d7a, 2); test(ebx, ecx);                         /* test ebx, ecx */
            ii(0x1018_1d7c, 2); if(jnz(0x1018_1d86, 0x8)) goto l_0x1018_1d86; /* jnz 0x10181d86 */
            ii(0x1018_1d7e, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1018_1d80, 3); add(eax, memd[ds, esi + 0x6]);          /* add eax, [esi+0x6] */
