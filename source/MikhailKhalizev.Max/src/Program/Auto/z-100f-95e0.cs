...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_95e0()
        {
            ...
            ii(0x100f_95f7, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100f_95fa, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ...
            ii(0x100f_9609, 2); if(jz(0x100f_9614, 0x9)) goto l_0x100f_9614; /* jz 0x100f9614 */
            ii(0x100f_960b, 7); test(memb[ds, 0x101c_38d4], 0x1);       /* test byte [0x101c38d4], 0x1 */
            ii(0x100f_9612, 2); if(jz(0x100f_9616, 0x2)) goto l_0x100f_9616; /* jz 0x100f9616 */
        l_0x100f_9614:
            ii(0x100f_9614, 2); jmp(0x100f_961f, 0x9); goto l_0x100f_961f; /* jmp 0x100f961f */
        l_0x100f_9616:
            ii(0x100f_9616, 7); cmp(memb[ds, 0x101c_38a2], 0x2);        /* cmp byte [0x101c38a2], 0x2 */
            ii(0x100f_961d, 2); if(jnz(0x100f_9621, 0x2)) goto l_0x100f_9621; /* jnz 0x100f9621 */
        l_0x100f_961f:
            ii(0x100f_961f, 2); jmp(0x100f_9623, 0x2); goto l_0x100f_9623; /* jmp 0x100f9623 */
        l_0x100f_9621:
            ii(0x100f_9621, 2); jmp(0x100f_9635, 0x12); goto l_0x100f_9635; /* jmp 0x100f9635 */
        l_0x100f_9623:
            ii(0x100f_9623, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_9626, 6); mov(memw[ds, 0x101c_3986], ax);         /* mov [0x101c3986], ax */
            ii(0x100f_962c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
