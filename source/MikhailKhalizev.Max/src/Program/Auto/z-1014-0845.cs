...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_0845()
        {
            ...
            ii(0x1014_085a, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1014_085d, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_0860, 3);  mov(memd[ss, ebp - 8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1014_0863, 3);  mov(memd[ss, ebp - 12], ecx);         /* mov [ebp-0xc], ecx */
            ii(0x1014_0866, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_0869, 6);  call_abs(memd[ds, 0x101b_ddf4]);      /* call dword [0x101bddf4] */
            ii(0x1014_086f, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1014_0872, 4);  movsx(eax, memw[ss, ebp + 16]);       /* movsx eax, word [ebp+0x10] */
            ii(0x1014_0876, 1);  push(eax);                            /* push eax */
            ii(0x1014_0877, 3);  mov(ecx, memd[ss, ebp - 16]);         /* mov ecx, [ebp-0x10] */
            ii(0x1014_087a, 3);  mov(ecx, memd[ds, ecx + 14]);         /* mov ecx, [ecx+0xe] */
            ii(0x1014_087d, 3);  sar(ecx, 0x10);                       /* sar ecx, 0x10 */
            ii(0x1014_0880, 3);  mov(edx, memd[ss, ebp - 16]);         /* mov edx, [ebp-0x10] */
            ii(0x1014_0883, 3);  mov(eax, memd[ds, edx + 44]);         /* mov eax, [edx+0x2c] */
            ii(0x1014_0886, 5);  call(0x100d_4f58, -0x6_b933);         /* call 0x100d4f58 */
            ii(0x1014_088b, 3);  movsx(ebx, ax);                       /* movsx ebx, ax */
            ii(0x1014_088e, 3);  mov(esi, memd[ss, ebp - 8]);          /* mov esi, [ebp-0x8] */
            ...
            ii(0x1014_08a0, 2);  sar(eax, 1);                          /* sar eax, 1 */
            ii(0x1014_08a2, 4);  movsx(edx, memw[ss, ebp - 4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x1014_08a6, 2);  add(edx, eax);                        /* add edx, eax */
            ii(0x1014_08a8, 3);  mov(memd[ss, ebp - 24], edx);         /* mov [ebp-0x18], edx */
            ii(0x1014_08ab, 3);  mov(edx, memd[ss, ebp - 16]);         /* mov edx, [ebp-0x10] */
            ii(0x1014_08ae, 3);  mov(eax, memd[ds, edx + 14]);         /* mov eax, [edx+0xe] */
            ii(0x1014_08b1, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x1014_08b4, 4);  imul(eax, memd[ss, ebp - 24]);        /* imul eax, [ebp-0x18] */
            ii(0x1014_08b8, 3);  mov(edx, memd[ss, ebp - 16]);         /* mov edx, [ebp-0x10] */
            ii(0x1014_08bb, 3);  mov(edx, memd[ds, edx + 22]);         /* mov edx, [edx+0x16] */
            ...
            ii(0x1014_08c8, 4);  cmp(memd[ss, ebp - 12], 0);           /* cmp dword [ebp-0xc], 0x0 */
            ...
            ii(0x1014_08e0, 3);  lea(eax, memd[ss, ebp - 124]);        /* lea eax, [ebp-0x7c] */
        ...
        l_0x1014_08ee:
            ii(0x1014_08ee, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_08f1, 3);  mov(memd[ss, ebp - 128], eax);        /* mov [ebp-0x80], eax */
            ii(0x1014_08f4, 3);  mov(eax, memd[ss, ebp - 128]);        /* mov eax, [ebp-0x80] */
            ii(0x1014_08f7, 3);  mov(ebx, memd[ds, eax + 2]);          /* mov ebx, [eax+0x2] */
            ii(0x1014_08fa, 3);  lea(edx, memd[ss, ebp - 124]);        /* lea edx, [ebp-0x7c] */
            ii(0x1014_08fd, 3);  mov(eax, memd[ss, ebp - 128]);        /* mov eax, [ebp-0x80] */
            ii(0x1014_0900, 3);  call_abs(memd[ds, ebx + 24]);         /* call dword [ebx+0x18] */
        l_0x1014_0903:
            ...
            ii(0x1014_0911, 4);  movsx(eax, memw[ss, ebp + 16]);       /* movsx eax, word [ebp+0x10] */
            ...
            ii(0x1014_0920, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1014_0923, 3);  mov(eax, memd[ds, eax + 44]);         /* mov eax, [eax+0x2c] */
            ii(0x1014_0926, 5);  call(0x100d_4f58, -0x6_b9d3);         /* call 0x100d4f58 */
            ii(0x1014_092b, 3);  sub(eax, memd[ss, ebp - 20]);         /* sub eax, [ebp-0x14] */
            ii(0x1014_092e, 1);  cwde();                               /* cwde */
            ii(0x1014_092f, 1);  push(eax);                            /* push eax */
            ii(0x1014_0930, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1014_0934, 1);  push(eax);                            /* push eax */
            ii(0x1014_0935, 4);  movsx(ecx, memw[ss, ebp - 20]);       /* movsx ecx, word [ebp-0x14] */
            ii(0x1014_0939, 3);  lea(ebx, memd[ss, ebp - 124]);        /* lea ebx, [ebp-0x7c] */
            ii(0x1014_093c, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1014_093f, 3);  mov(edx, memd[ds, eax + 14]);         /* mov edx, [eax+0xe] */
            ii(0x1014_0942, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x1014_0945, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1014_0948, 3);  mov(eax, memd[ds, eax + 22]);         /* mov eax, [eax+0x16] */
            ...
            ii(0x1014_0955, 3);  ret(4);                               /* ret 0x4 */
        }
    }
}
