...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1028_c020()
        {
            ...
            ii(0x1028_c022, 1); push(ds);                               /* push ds */
            ii(0x1028_c023, 1); pop(es);                                /* pop es */
        ...
        l_0x1028_c057:
            ...
            ii(0x1028_c072, 5); cmp(memw[ds, ebx + 0x4], 0x1);          /* cmp word [ebx+0x4], 0x1 */
            ii(0x1028_c077, 2); if(jnz(0x1028_c08a, 0x11)) goto l_0x1028_c08a; /* jnz 0x1028c08a */
            ii(0x1028_c079, 7); cmp(memd[ds, 0x1378], -0x1 /* 0xff */); /* cmp dword [0x1378], 0xffffffff */
        ...
        l_0x1028_c08a:
            ii(0x1028_c08a, 5); cmp(memw[ds, ebx + 0x6], 0x1);          /* cmp word [ebx+0x6], 0x1 */
            ...
            ii(0x1028_c0a2, 3); mov(memd[ds, ebx + 0x2], eax);          /* mov [ebx+0x2], eax */
        ...
        l_0x1028_c0b1:
            ii(0x1028_c0b1, 5); cmp(memw[ds, ebx + 0x4], 0x2);          /* cmp word [ebx+0x4], 0x2 */
            ...
            ii(0x1028_c0c5, 3); mov(memd[ds, esi + 0x2], eax);          /* mov [esi+0x2], eax */
        ...
        l_0x1028_c0d6:
            ii(0x1028_c0d6, 5); cmp(memw[ds, ebx + 0x6], 0x2);          /* cmp word [ebx+0x6], 0x2 */
            ii(0x1028_c0db, 6); if(jnz(0x1028_c0f0, 0xf)) goto l_0x1028_c0f0; /* jnz 0x1028c0f0 */
            ii(0x1028_c0e1, 7); cmp(memd[ds, 0x1384], -0x1 /* 0xff */); /* cmp dword [0x1384], 0xffffffff */
            ii(0x1028_c0e8, 2); if(jnz(0x1028_c0f0, 0x6)) goto l_0x1028_c0f0; /* jnz 0x1028c0f0 */
        ...
        l_0x1028_c0f0:
            ...
            ii(0x1028_c0f3, 2); if(jz(0x1028_c0f8, 0x3)) goto l_0x1028_c0f8; /* jz 0x1028c0f8 */
            ii(0x1028_c0f5, 1); stosb();                                /* stosb */
            ii(0x1028_c0f6, 2); jmp(0x1028_c0f0, -0x8); goto l_0x1028_c0f0; /* jmp 0x1028c0f0 */
        l_0x1028_c0f8:
