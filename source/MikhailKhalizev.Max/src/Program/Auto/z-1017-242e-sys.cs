...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_242e()
        {
            ...
            ii(0x1017_2436, 3); cmp(eax, memd[ds, edx + 0x4]);          /* cmp eax, [edx+0x4] */
            ii(0x1017_2439, 2); if(jg(0x1017_245a, 0x1f)) goto l_0x1017_245a; /* jg 0x1017245a */
            ii(0x1017_243b, 3); mov(ebx, memd[ds, edx + 0x8]);          /* mov ebx, [edx+0x8] */
            ...
            ii(0x1017_2446, 3); mov(edi, memd[ds, edx + 0x4]);          /* mov edi, [edx+0x4] */
            ...
            ii(0x1017_2452, 3); mov(memd[ds, edx + 0x4], edi);          /* mov [edx+0x4], edi */
        ...
        l_0x1017_245a:
            ii(0x1017_245a, 3); mov(eax, memd[ds, edx + 0x8]);          /* mov eax, [edx+0x8] */
            ii(0x1017_245d, 7); mov(memd[ds, edx + 0x4], 0);            /* mov dword [edx+0x4], 0x0 */
