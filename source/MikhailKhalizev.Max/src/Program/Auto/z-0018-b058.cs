...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_b058()
        {
            ...
            ii(0x18_b05b, 3); mov(bp, memw[ss, bp + 0x4]);              /* mov bp, [bp+0x4] */
            ii(0x18_b05e, 4); mov(bx, memw[ds, 0x996]);                 /* mov bx, [0x996] */
            ii(0x18_b062, 4); mov(memb[ds, bx + 0x17], 0x48);           /* mov byte [bx+0x17], 0x48 */
            ...
            ii(0x18_b07a, 4); test(memb[ds, bx + 0x26], 0x1);           /* test byte [bx+0x26], 0x1 */
            ii(0x18_b07e, 2); if(jz(0x18_b082, 0x2)) goto l_0x18_b082;  /* jz 0xb082 */
