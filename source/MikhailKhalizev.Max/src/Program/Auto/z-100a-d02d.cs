...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_d02d()
        {
            ...
            ii(0x100a_d044, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_d047, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x100a_d04a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_d04c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_d061, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100a_d064, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_d076, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_d085, 4); movsx(ebx, memb[ss, ebp - 0x4]);        /* movsx ebx, byte [ebp-0x4] */
            ii(0x100a_d089, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_d096, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_d099, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x100a_d09c, 5); call(0x1008_af84, -0x2_211d);           /* call 0x1008af84 */
            ii(0x100a_d0a1, 3); mov(ecx, memd[ss, ebp - 0x8]);          /* mov ecx, [ebp-0x8] */
            ii(0x100a_d0a4, 3); call_abs(memd[ds, ecx + 0x40]);         /* call dword [ecx+0x40] */
        l_0x100a_d0a7:
            ii(0x100a_d0a7, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_d0a9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_d0b6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_d0c3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_d0c6, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x100a_d0c9, 5); call(0x1008_afe4, -0x2_20ea);           /* call 0x1008afe4 */
            ii(0x100a_d0ce, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
