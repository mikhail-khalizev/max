...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_95d0()
        {
            ...
            ii(0x1017_95db, 3); cmp(edi, memd[ds, eax + 0x4]);          /* cmp edi, [eax+0x4] */
            ii(0x1017_95de, 2); if(ja(0x1017_95e4, 0x4)) goto l_0x1017_95e4; /* ja 0x101795e4 */
        ...
        l_0x1017_95e4:
            ...
            ii(0x1017_960e, 7); mov(memd[ds, esi + 0x8], 0);            /* mov dword [esi+0x8], 0x0 */
            ii(0x1017_9615, 2); mov(memd[ds, esi], ebx);                /* mov [esi], ebx */
            ii(0x1017_9617, 3); mov(ecx, memd[ds, esi + 0xc]);          /* mov ecx, [esi+0xc] */
            ii(0x1017_961a, 3); mov(memd[ds, esi + 0x4], edi);          /* mov [esi+0x4], edi */
        ...
        l_0x1017_962c:
            ii(0x1017_962c, 7); mov(memd[ds, esi + 0x8], 0x1);          /* mov dword [esi+0x8], 0x1 */
            ii(0x1017_9633, 2); mov(eax, memd[ds, esi]);                /* mov eax, [esi] */
            ii(0x1017_9635, 3); lea(esp, memd[ss, ebp - 0x10]);         /* lea esp, [ebp-0x10] */
        ...
        l_0x1017_9640:
            ii(0x1017_9640, 3); lea(esp, memd[ss, ebp - 0x10]);         /* lea esp, [ebp-0x10] */
