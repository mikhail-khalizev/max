...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_adca()
        {
            ...
            ii(0x1014_ade2, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_ade5, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_ade7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_adf4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_ae05, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_ae08, 4); mov(memb[ds, eax + 0x3d], 0);           /* mov byte [eax+0x3d], 0x0 */
            ii(0x1014_ae0c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_ae0f, 4); mov(memb[ds, eax + 0x3e], 0x1);         /* mov byte [eax+0x3e], 0x1 */
            ii(0x1014_ae13, 2); jmp(0x1014_ae23, 0xe); goto l_0x1014_ae23; /* jmp 0x1014ae23 */
        l_0x1014_ae15:
            ii(0x1014_ae15, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_ae18, 4); mov(memb[ds, eax + 0x3d], 0x4);         /* mov byte [eax+0x3d], 0x4 */
            ii(0x1014_ae1c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_ae1f, 4); mov(memb[ds, eax + 0x3e], 0x1f);        /* mov byte [eax+0x3e], 0x1f */
        l_0x1014_ae23:
            ii(0x1014_ae23, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
