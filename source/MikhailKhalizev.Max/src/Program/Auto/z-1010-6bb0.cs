...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_6bb0()
        {
            ...
            ii(0x1010_6bc8, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x1010_6bcf, 5); mov(ebx, 0x1c);                         /* mov ebx, 0x1c */
            ii(0x1010_6bd4, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_6bd6, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ii(0x1010_6bd9, 5); call(Definitions.sys_memset, 0x5_f202); /* call 0x10165de0 */
            ii(0x1010_6bde, 7); mov(memd[ss, ebp - 0x24], 0x400);       /* mov dword [ebp-0x24], 0x400 */
            ii(0x1010_6be5, 3); lea(ebx, memd[ss, ebp - 0x24]);         /* lea ebx, [ebp-0x24] */
            ii(0x1010_6be8, 3); lea(edx, memd[ss, ebp - 0x24]);         /* lea edx, [ebp-0x24] */
            ii(0x1010_6beb, 5); mov(eax, 0x31);                         /* mov eax, 0x31 */
            ii(0x1010_6bf0, 5); call(/* sys */ 0x1016_c606, 0x6_5a11);  /* call 0x1016c606 */
            ii(0x1010_6bf5, 4); cmp(memd[ss, ebp - 0xc], 0);            /* cmp dword [ebp-0xc], 0x0 */
            ...
            ii(0x1010_6c02, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ...
            ii(0x1010_6c11, 3); lea(eax, memd[ss, ebp - 0x30]);         /* lea eax, [ebp-0x30] */
            ii(0x1010_6c14, 5); call(Definitions.sys_memset, 0x5_f1c7); /* call 0x10165de0 */
            ii(0x1010_6c19, 7); mov(memd[ss, ebp - 0x24], 0x500);       /* mov dword [ebp-0x24], 0x500 */
            ii(0x1010_6c20, 2); mov(ebx, ss);                           /* mov ebx, ss */
            ii(0x1010_6c22, 3); lea(edx, memd[ss, ebp - 0x60]);         /* lea edx, [ebp-0x60] */
            ...
            ii(0x1010_6c2d, 4); mov(memw[ss, ebp - 0x30], dx);          /* mov [ebp-0x30], dx */
            ii(0x1010_6c31, 3); lea(eax, memd[ss, ebp - 0x60]);         /* lea eax, [ebp-0x60] */
            ii(0x1010_6c34, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1010_6c37, 3); lea(ecx, memd[ss, ebp - 0x30]);         /* lea ecx, [ebp-0x30] */
            ii(0x1010_6c3a, 3); lea(ebx, memd[ss, ebp - 0x24]);         /* lea ebx, [ebp-0x24] */
            ii(0x1010_6c3d, 3); lea(edx, memd[ss, ebp - 0x24]);         /* lea edx, [ebp-0x24] */
            ii(0x1010_6c40, 5); mov(eax, 0x31);                         /* mov eax, 0x31 */
            ii(0x1010_6c45, 5); call(/* sys */ 0x1016_c623, 0x6_59d9);  /* call 0x1016c623 */
            ii(0x1010_6c4a, 3); mov(eax, memd[ss, ebp - 0x48]);         /* mov eax, [ebp-0x48] */
            ii(0x1010_6c4d, 3); shl(eax, 0xc);                          /* shl eax, 0xc */
            ii(0x1010_6c50, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
        l_0x1010_6c53:
            ii(0x1010_6c53, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_6c56, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_6c59, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
