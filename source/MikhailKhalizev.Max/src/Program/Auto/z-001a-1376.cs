...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_001a_1376()
        {
            ...
            ii(0x1a_137f, 3); push(memw[ss, bp + 8]);                   /* push word [bp+0x8] */
            ii(0x1a_1382, 3); push(memw[ss, bp + 6]);                   /* push word [bp+0x6] */
            ii(0x1a_1385, 3); push(memw[ss, bp + 12]);                  /* push word [bp+0xc] */
            ii(0x1a_1388, 3); push(memw[ss, bp + 10]);                  /* push word [bp+0xa] */
            ii(0x1a_138b, 5); call_far_abs(0x80, 0x4544);               /* call word 0x80:0x4544 */
            ii(0x1a_1390, 3); add(sp, 8);                               /* add sp, 0x8 */
            ii(0x1a_1393, 3); push(memw[ss, bp + 12]);                  /* push word [bp+0xc] */
            ii(0x1a_1396, 3); push(memw[ss, bp + 10]);                  /* push word [bp+0xa] */
            ...
            ii(0x1a_13a2, 3); retf(8);                                  /* retf 0x8 */
        }
    }
}
