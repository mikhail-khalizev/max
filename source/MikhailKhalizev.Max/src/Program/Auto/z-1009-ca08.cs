...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_ca08()
        {
            ...
            ii(0x1009_ca1f, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_ca22, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1009_ca25, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_ca28, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_ca2b, 5); call(0x1013_a66b, 0x9_dc3b);            /* call 0x1013a66b */
            ii(0x1009_ca30, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x1009_ca33, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
