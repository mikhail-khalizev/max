...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_97de()
        {
            ...
            ii(0x97e3, 3);    mov(si, memw[ss, bp + 4]);                /* mov si, [bp+0x4] */
        ...
        l_0x97eb:
            ...
            ii(0x97ee, 2);    if(jz(0x97eb, -5)) goto l_0x97eb;         /* jz 0x97eb */
            ii(0x97f0, 2);    cmp(al, 9);                               /* cmp al, 0x9 */
            ii(0x97f2, 2);    if(jz(0x97eb, -9)) goto l_0x97eb;         /* jz 0x97eb */
            ii(0x97f4, 1);    push(ax);                                 /* push ax */
            ii(0x97f5, 2);    cmp(al, 0x2d);                            /* cmp al, 0x2d */
            ii(0x97f7, 2);    if(jz(0x97fd, 4)) goto l_0x97fd;          /* jz 0x97fd */
            ii(0x97f9, 2);    cmp(al, 0x2b);                            /* cmp al, 0x2b */
            ii(0x97fb, 2);    if(jnz(0x97fe, 1)) goto l_0x97fe;         /* jnz 0x97fe */
        l_0x97fd:
        ...
        l_0x97fe:
            ...
            ii(0x9806, 2);    shl(bx, 1);                               /* shl bx, 1 */
            ii(0x9808, 2);    rcl(dx, 1);                               /* rcl dx, 1 */
            ii(0x980a, 2);    mov(cx, bx);                              /* mov cx, bx */
            ii(0x980c, 2);    mov(di, dx);                              /* mov di, dx */
            ii(0x980e, 2);    shl(bx, 1);                               /* shl bx, 1 */
            ii(0x9810, 2);    rcl(dx, 1);                               /* rcl dx, 1 */
            ii(0x9812, 2);    shl(bx, 1);                               /* shl bx, 1 */
            ii(0x9814, 2);    rcl(dx, 1);                               /* rcl dx, 1 */
        ...
        l_0x9821:
            ...
            ii(0x9825, 2);    if(jnz(0x982e, 7)) goto l_0x982e;         /* jnz 0x982e */
