...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_df95()
        {
            ...
            ii(0x100c_dfb2, 7);  mov(memd[ss, ebp - 24], 0);           /* mov dword [ebp-0x18], 0x0 */
            ii(0x100c_dfb9, 4);  or(memb[ss, ebp - 12], 1);            /* or byte [ebp-0xc], 0x1 */
            ii(0x100c_dfbd, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x100c_dfc0, 5);  call(0x100c_a02c, -0x3f99);           /* call 0x100ca02c */
            ii(0x100c_dfc5, 3);  mov(memd[ss, ebp - 36], eax);         /* mov [ebp-0x24], eax */
            ii(0x100c_dfc8, 4);  and(memb[ss, ebp - 12], -2 /* 0xfe */);/* and byte [ebp-0xc], 0xfe */
            ii(0x100c_dfcc, 7);  mov(memd[ss, ebp - 28], 0x4b);        /* mov dword [ebp-0x1c], 0x4b */
        l_0x100c_dfd3:
            ii(0x100c_dfd3, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x100c_dfd6, 4);  cmp(ax, memw[ss, ebp - 28]);          /* cmp ax, [ebp-0x1c] */
            ii(0x100c_dfda, 6);  if(jge(0x100c_e064, 0x84)) goto l_0x100c_e064;/* jge 0x100ce064 */
            ii(0x100c_dfe0, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x100c_dfe3, 3);  inc(memd[ss, ebp - 24]);              /* inc dword [ebp-0x18] */
            ...
            ii(0x100c_dff0, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x100c_dff3, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x100c_dff6, 3);  inc(memd[ss, ebp - 24]);              /* inc dword [ebp-0x18] */
            ...
            ii(0x100c_e003, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x100c_e006, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
        ...
        l_0x100c_e00f:
            ii(0x100c_e00f, 3);  dec(memd[ss, ebp - 20]);              /* dec dword [ebp-0x14] */
            ii(0x100c_e012, 5);  cmp(memw[ss, ebp - 20], -1 /* 0xff */);/* cmp word [ebp-0x14], 0xffff */
            ii(0x100c_e017, 2);  if(jz(0x100c_e039, 0x20)) goto l_0x100c_e039;/* jz 0x100ce039 */
            ii(0x100c_e019, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x100c_e01c, 3);  inc(memd[ss, ebp - 24]);              /* inc dword [ebp-0x18] */
            ...
            ii(0x100c_e029, 3);  mov(memd[ss, ebp - 40], eax);         /* mov [ebp-0x28], eax */
            ii(0x100c_e02c, 3);  lea(edx, memd[ss, ebp - 40]);         /* lea edx, [ebp-0x28] */
            ii(0x100c_e02f, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
        ...
        l_0x100c_e039:
            ...
            ii(0x100c_e042, 3);  lea(edx, memd[ss, ebp - 32]);         /* lea edx, [ebp-0x20] */
            ...
            ii(0x100c_e04f, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
        ...
        l_0x100c_e059:
            ii(0x100c_e059, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100c_e05c, 3);  add(memd[ss, ebp - 24], eax);         /* add [ebp-0x18], eax */
        ...
        l_0x100c_e064:
            ...
            ii(0x100c_e06d, 3);  lea(edx, memd[ss, ebp - 32]);         /* lea edx, [ebp-0x20] */
            ...
            ii(0x100c_e07a, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
        ...
        //  ii(0x100c_e086, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
