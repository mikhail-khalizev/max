...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_35ac()
        {
            ...
            ii(0x1007_35c4, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_35c7, 4); or(memb[ss, ebp - 0x8], 0x1);           /* or byte [ebp-0x8], 0x1 */
            ...
            ii(0x1007_35d6, 4); and(memb[ss, ebp - 0x8], -0x2 /* 0xfe */); /* and byte [ebp-0x8], 0xfe */
            ii(0x1007_35da, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_35dd, 6); mov(memw[ds, eax + 0x8], 0);            /* mov word [eax+0x8], 0x0 */
            ii(0x1007_35e3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_35e6, 6); mov(memw[ds, eax + 0xa], 0);            /* mov word [eax+0xa], 0x0 */
            ii(0x1007_35ec, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_35ef, 6); mov(memw[ds, eax + 0xc], 0);            /* mov word [eax+0xc], 0x0 */
            ii(0x1007_35f5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_35f8, 6); mov(memw[ds, eax + 0xe], 0);            /* mov word [eax+0xe], 0x0 */
            ii(0x1007_35fe, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_361b, 2); jmp(0x1007_3625, 0x8); goto l_0x1007_3625; /* jmp 0x10073625 */
        l_0x1007_361d:
        ...
        l_0x1007_3625:
            ...
            ii(0x1007_3644, 3); cmp(eax, memd[ss, ebp - 0x4]);          /* cmp eax, [ebp-0x4] */
