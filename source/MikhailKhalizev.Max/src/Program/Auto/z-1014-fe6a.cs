...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_fe6a()
        {
            ...
            ii(0x1014_fe81, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_fe84, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_fe87, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_fe8a, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x1014_fe8d, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1014_fe90, 3); imul(eax, eax, 0x33);                   /* imul eax, eax, 0x33 */
            ii(0x1014_fe93, 7); cmp(memb[ds, eax + 0x101c_81d5], 0x2);  /* cmp byte [eax+0x101c81d5], 0x2 */
            ii(0x1014_fe9a, 6); if(jnz(0x1014_ff2e, 0x8e)) goto l_0x1014_ff2e; /* jnz 0x1014ff2e */
            ii(0x1014_fea0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_fea3, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1014_fea6, 4); add(memw[ds, edx + 0x52], ax);          /* add [edx+0x52], ax */
            ii(0x1014_feaa, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_feac, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_febb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_febe, 5); call(0x1007_623c, -0xd_9c87);           /* call 0x1007623c */
            ii(0x1014_fec3, 4); mov(ax, memw[ds, eax + 0x19]);          /* mov ax, [eax+0x19] */
            ii(0x1014_fec7, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_feca, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_fed7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_feda, 4); add(memw[ds, edx + 0xa], ax);           /* add [edx+0xa], ax */
            ii(0x1014_fede, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_fee1, 4); mov(ax, memw[ds, eax + 0x52]);          /* mov ax, [eax+0x52] */
            ii(0x1014_fee5, 4); cmp(ax, memw[ss, ebp - 0xc]);           /* cmp ax, [ebp-0xc] */
            ii(0x1014_fee9, 2); if(jle(0x1014_ff2e, 0x43)) goto l_0x1014_ff2e; /* jle 0x1014ff2e */
            ii(0x1014_feeb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_feee, 4); mov(ax, memw[ds, eax + 0x52]);          /* mov ax, [eax+0x52] */
            ii(0x1014_fef2, 3); sub(eax, memd[ss, ebp - 0xc]);          /* sub eax, [ebp-0xc] */
            ii(0x1014_fef5, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_fef8, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1014_fefb, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1014_fefe, 4); mov(memw[ds, edx + 0x52], ax);          /* mov [edx+0x52], ax */
            ii(0x1014_ff02, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_ff0f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_ff12, 4); sub(memw[ds, edx + 0xa], ax);           /* sub [edx+0xa], ax */
            ii(0x1014_ff16, 2); xor(ecx, ecx);                          /* xor ecx, ecx */
            ii(0x1014_ff18, 4); movsx(ebx, memw[ss, ebp - 0x4]);        /* movsx ebx, word [ebp-0x4] */
            ii(0x1014_ff1c, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_ff1e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
