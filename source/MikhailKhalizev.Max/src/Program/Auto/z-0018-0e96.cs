...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x18_0e96, 4); enter(0x4, 0);                            /* enter 0x4, 0x0 */
            ...
            ii(0x18_0eab, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x18_0eae, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ...
            ii(0x18_0eb9, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ...
            ii(0x18_0ed2, 2); if(jnz(0x18_0edd, 0x9)) goto l_0x18_0edd; /* jnz 0xedd */
        l_0x18_0ed4:
        ...
        l_0x18_0edd:
            ...
            ii(0x18_0ee1, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x18_0ee4, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0x18_0ef6, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x18_0ef9, 3); mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ...
            ii(0x18_0f09, 3); retf(0x4);                                /* retf 0x4 */
        }
    }
}
