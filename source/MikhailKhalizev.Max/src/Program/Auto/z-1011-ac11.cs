...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_ac11()
        {
            ...
            ii(0x1011_ac28, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_ac2b, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1011_ac2e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_ac31, 3); mov(edx, memd[ds, eax + 0x14]);         /* mov edx, [eax+0x14] */
            ii(0x1011_ac34, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1011_ac37, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1011_ac48, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_ac4b, 4); mov(ax, memw[ds, eax + 0x16]);          /* mov ax, [eax+0x16] */
            ii(0x1011_ac4f, 1); inc(eax);                               /* inc eax */
            ii(0x1011_ac50, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1011_ac53, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1011_ac62, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1011_ac65, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_ac68, 4); mov(ax, memw[ds, eax + 0x16]);          /* mov ax, [eax+0x16] */
            ii(0x1011_ac6c, 1); inc(eax);                               /* inc eax */
            ii(0x1011_ac6d, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1011_ac70, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_ac73, 3); add(eax, 0x18);                         /* add eax, 0x18 */
            ii(0x1011_ac76, 5); call(0x100b_827c, -0x6_29ff);           /* call 0x100b827c */
            ii(0x1011_ac7b, 5); movsx(ax, memb[ds, eax + 0x1]);         /* movsx ax, byte [eax+0x1] */
            ii(0x1011_ac80, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1011_ac83, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x1011_ac87, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1011_ac8b, 5); call(0x1011_9e3a, -0xe56);              /* call 0x10119e3a */
            ii(0x1011_ac90, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1011_ac93, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
