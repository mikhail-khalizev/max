...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_0d16()
        {
            ...
            ii(0x1016_0d2e, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1016_0d31, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_0d34, 4); test(memb[ds, eax + 0x15], 0x2);        /* test byte [eax+0x15], 0x2 */
            ii(0x1016_0d38, 2); if(jz(0x1016_0d45, 0xb)) goto l_0x1016_0d45; /* jz 0x10160d45 */
            ii(0x1016_0d3a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_0d3d, 3); mov(al, memb[ds, eax + 0x2e]);          /* mov al, [eax+0x2e] */
            ii(0x1016_0d40, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x1016_0d43, 2); jmp(0x1016_0d4e, 0x9); goto l_0x1016_0d4e; /* jmp 0x10160d4e */
        l_0x1016_0d45:
            ii(0x1016_0d45, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1016_0d4e:
            ...
            ii(0x1016_0d51, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x1016_0d54, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_0d57, 4); mov(ax, memw[ds, eax + 0x41]);          /* mov ax, [eax+0x41] */
            ii(0x1016_0d5b, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1016_0d5e, 4); sub(ax, memw[ds, edx + 0x1a]);          /* sub ax, [edx+0x1a] */
            ii(0x1016_0d62, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1016_0d65, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_0d68, 4); mov(ax, memw[ds, eax + 0x43]);          /* mov ax, [eax+0x43] */
            ii(0x1016_0d6c, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1016_0d88, 3); mov(dl, memb[ss, ebp - 0x8]);           /* mov dl, [ebp-0x8] */
            ...
            ii(0x1016_0d97, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_0d9a, 4); mov(memb[ds, eax + 0x3e], 0x8);         /* mov byte [eax+0x3e], 0x8 */
            ii(0x1016_0d9e, 7); mov(memd[ss, ebp - 0x24], 0);           /* mov dword [ebp-0x24], 0x0 */
            ii(0x1016_0da5, 2); jmp(0x1016_0dad, 0x6); goto l_0x1016_0dad; /* jmp 0x10160dad */
        l_0x1016_0da7:
        ...
        l_0x1016_0dad:
            ...
            ii(0x1016_0dba, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1016_0de4, 2); if(jnz(0x1016_0de8, 0x2)) goto l_0x1016_0de8; /* jnz 0x10160de8 */
        l_0x1016_0de6:
            ii(0x1016_0de6, 2); jmp(0x1016_0e24, 0x3c); goto l_0x1016_0e24; /* jmp 0x10160e24 */
        l_0x1016_0de8:
            ii(0x1016_0de8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1016_0dfc, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1016_0e22, 2); if(jnz(0x1016_0e26, 0x2)) goto l_0x1016_0e26; /* jnz 0x10160e26 */
        l_0x1016_0e24:
        ...
        l_0x1016_0e26:
            ...
            ii(0x1016_0e2a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1016_0e37:
            ii(0x1016_0e37, 7); mov(memd[ss, ebp - 0x20], 0x1);         /* mov dword [ebp-0x20], 0x1 */
            ii(0x1016_0e3e, 5); jmp(0x1016_0eb7, 0x74); goto l_0x1016_0eb7; /* jmp 0x10160eb7 */
        l_0x1016_0e43:
            ii(0x1016_0e43, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1016_0e45, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ...
            ii(0x1016_0e63, 2); if(jle(0x1016_0e6e, 0x9)) goto l_0x1016_0e6e; /* jle 0x10160e6e */
            ii(0x1016_0e65, 7); mov(memd[ss, ebp - 0x14], 0xffff_ffff); /* mov dword [ebp-0x14], 0xffffffff */
            ii(0x1016_0e6c, 2); jmp(0x1016_0e75, 0x7); goto l_0x1016_0e75; /* jmp 0x10160e75 */
        l_0x1016_0e6e:
            ii(0x1016_0e6e, 7); mov(memd[ss, ebp - 0x14], 0x1);         /* mov dword [ebp-0x14], 0x1 */
        l_0x1016_0e75:
            ii(0x1016_0e75, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x1016_0e78, 3); add(al, memb[ss, ebp - 0x14]);          /* add al, [ebp-0x14] */
            ii(0x1016_0e7b, 2); and(al, 0x7);                           /* and al, 0x7 */
            ii(0x1016_0e7d, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x1016_0e80, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_0e83, 4); test(memb[ds, eax + 0x15], 0x2);        /* test byte [eax+0x15], 0x2 */
            ...
            ii(0x1016_0e90, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x1016_0e93, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1016_0e96, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1016_0ea0:
            ...
            ii(0x1016_0ea2, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x1016_0ea5, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1016_0ea8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
