...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_0d16()
        {
            ...
            ii(0x1016_0d34, 4); test(memb[ds, eax + 21], 2);            /* test byte [eax+0x15], 0x2 */
            ...
            ii(0x1016_0d3d, 3); mov(al, memb[ds, eax + 46]);            /* mov al, [eax+0x2e] */
            ii(0x1016_0d40, 3); mov(memb[ss, ebp - 12], al);            /* mov [ebp-0xc], al */
        ...
        l_0x1016_0d45:
            ...
            ii(0x1016_0d48, 3); mov(al, memb[ds, eax + 41]);            /* mov al, [eax+0x29] */
            ii(0x1016_0d4b, 3); mov(memb[ss, ebp - 12], al);            /* mov [ebp-0xc], al */
        l_0x1016_0d4e:
            ii(0x1016_0d4e, 3); mov(al, memb[ss, ebp - 12]);            /* mov al, [ebp-0xc] */
            ii(0x1016_0d51, 3); mov(memb[ss, ebp - 8], al);             /* mov [ebp-0x8], al */
            ii(0x1016_0d54, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1016_0d57, 4); mov(ax, memw[ds, eax + 65]);            /* mov ax, [eax+0x41] */
            ii(0x1016_0d5b, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1016_0d5e, 4); sub(ax, memw[ds, edx + 26]);            /* sub ax, [edx+0x1a] */
            ii(0x1016_0d62, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x1016_0d65, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1016_0d68, 4); mov(ax, memw[ds, eax + 67]);            /* mov ax, [eax+0x43] */
            ii(0x1016_0d6c, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1016_0d6f, 4); sub(ax, memw[ds, edx + 28]);            /* sub ax, [edx+0x1c] */
            ii(0x1016_0d73, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x1016_0d76, 4); movsx(edx, memw[ss, ebp - 24]);         /* movsx edx, word [ebp-0x18] */
            ii(0x1016_0d7a, 4); movsx(eax, memw[ss, ebp - 28]);         /* movsx eax, word [ebp-0x1c] */
            ii(0x1016_0d7e, 5); call(0x1015_c339, -0x4a4a);             /* call 0x1015c339 */
            ii(0x1016_0d83, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1016_0d86, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1016_0d88, 3); mov(dl, memb[ss, ebp - 8]);             /* mov dl, [ebp-0x8] */
            ii(0x1016_0d8b, 4); movsx(eax, memw[ss, ebp - 20]);         /* movsx eax, word [ebp-0x14] */
            ...
            ii(0x1016_0d9a, 4); mov(memb[ds, eax + 62], 8);             /* mov byte [eax+0x3e], 0x8 */
            ii(0x1016_0d9e, 7); mov(memd[ss, ebp - 36], 0);             /* mov dword [ebp-0x24], 0x0 */
            ii(0x1016_0da5, 2); jmp(0x1016_0dad, 6); goto l_0x1016_0dad; /* jmp 0x10160dad */
        l_0x1016_0da7:
            ii(0x1016_0da7, 3); mov(eax, memd[ss, ebp - 36]);           /* mov eax, [ebp-0x24] */
            ii(0x1016_0daa, 3); inc(memd[ss, ebp - 36]);                /* inc dword [ebp-0x24] */
        l_0x1016_0dad:
            ii(0x1016_0dad, 4); movsx(eax, memw[ss, ebp - 36]);         /* movsx eax, word [ebp-0x24] */
            ...
            ii(0x1016_0dbd, 3); mov(al, memb[ds, eax + 38]);            /* mov al, [eax+0x26] */
            ii(0x1016_0dc0, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x1016_0dc5, 4); movsx(edx, memw[ss, ebp - 36]);         /* movsx edx, word [ebp-0x24] */
            ii(0x1016_0dc9, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x1016_0dcb, 2); if(jz(0x1016_0de6, 0x19)) goto l_0x1016_0de6; /* jz 0x10160de6 */
            ii(0x1016_0dcd, 4); movsx(eax, memw[ss, ebp - 36]);         /* movsx eax, word [ebp-0x24] */
        ...
        l_0x1016_0de8:
            ...
            ii(0x1016_0deb, 3); mov(edx, memd[ds, eax + 26]);           /* mov edx, [eax+0x1a] */
            ...
            ii(0x1016_0dff, 3); mov(eax, memd[ds, eax + 24]);           /* mov eax, [eax+0x18] */
            ii(0x1016_0e02, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1016_0e05, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1016_0e07, 4); movsx(eax, memw[ss, ebp - 36]);         /* movsx eax, word [ebp-0x24] */
        ...
        l_0x1016_0e26:
            ii(0x1016_0e26, 4); movsx(edx, memw[ss, ebp - 36]);         /* movsx edx, word [ebp-0x24] */
        ...
        l_0x1016_0e37:
            ii(0x1016_0e37, 7); mov(memd[ss, ebp - 32], 1);             /* mov dword [ebp-0x20], 0x1 */
        ...
        l_0x1016_0e43:
            ...
            ii(0x1016_0e48, 3); mov(edx, memd[ss, ebp - 20]);           /* mov edx, [ebp-0x14] */
            ...
            ii(0x1016_0e59, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1016_0e5c, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x1016_0e60, 3); cmp(eax, 4);                            /* cmp eax, 0x4 */
            ii(0x1016_0e63, 2); if(jle(0x1016_0e6e, 9)) goto l_0x1016_0e6e; /* jle 0x10160e6e */
            ii(0x1016_0e65, 7); mov(memd[ss, ebp - 20], 0xffff_ffff);   /* mov dword [ebp-0x14], 0xffffffff */
            ii(0x1016_0e6c, 2); jmp(0x1016_0e75, 7); goto l_0x1016_0e75; /* jmp 0x10160e75 */
        l_0x1016_0e6e:
            ii(0x1016_0e6e, 7); mov(memd[ss, ebp - 20], 1);             /* mov dword [ebp-0x14], 0x1 */
        l_0x1016_0e75:
            ii(0x1016_0e75, 3); mov(al, memb[ss, ebp - 8]);             /* mov al, [ebp-0x8] */
            ii(0x1016_0e78, 3); add(al, memb[ss, ebp - 20]);            /* add al, [ebp-0x14] */
            ...
            ii(0x1016_0e83, 4); test(memb[ds, eax + 21], 2);            /* test byte [eax+0x15], 0x2 */
        ...
        l_0x1016_0eb0:
            ii(0x1016_0eb0, 7); mov(memd[ss, ebp - 32], 0);             /* mov dword [ebp-0x20], 0x0 */
        l_0x1016_0eb7:
            ii(0x1016_0eb7, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
