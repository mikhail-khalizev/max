...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_001a_1182()
        {
            ...
            ii(0x1a_1197, 3); mov(ax, memw[ss, bp + 0x8]);              /* mov ax, [bp+0x8] */
            ii(0x1a_119a, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
            ii(0x1a_119d, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x1a_11a0, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x1a_11a3, 3); mov(ax, memw[ss, bp + 0xc]);              /* mov ax, [bp+0xc] */
            ii(0x1a_11a6, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ...
            ii(0x1a_11bb, 2); if(jz(0x1a_11c2, 0x5)) goto l_0x1a_11c2;  /* jz 0x11c2 */
            ii(0x1a_11bd, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0x1a_11c0, 2); jmp(0x1a_11c5, 0x3); goto l_0x1a_11c5;    /* jmp 0x11c5 */
        l_0x1a_11c2:
            ii(0x1a_11c2, 3); mov(ax, 0xffff);                          /* mov ax, 0xffff */
        l_0x1a_11c5:
            ii(0x1a_11c5, 1); pop(ds);                                  /* pop ds */
            ii(0x1a_11c6, 1); leave();                                  /* leave */
            ii(0x1a_11c7, 3); retf(0x8);                                /* retf 0x8 */
        }
    }
}
