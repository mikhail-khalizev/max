...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_ff84()
        {
            ...
            ii(0x100a_ff95, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100a_ff9b, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100a_ff9e, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x100a_ffa1, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x100a_ffa4, 3); add(edx, 0x13);                         /* add edx, 0x13 */
            ii(0x100a_ffa7, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_ffb3, 5); mov(edx, 3);                            /* mov edx, 0x3 */
            ii(0x100a_ffb8, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
