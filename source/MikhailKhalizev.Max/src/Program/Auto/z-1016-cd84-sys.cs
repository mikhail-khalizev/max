...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1016_cd95:
            ...
            ii(0x1016_cdc0, 4); mov(memd[ss, esp + 0x8], eax);          /* mov [esp+0x8], eax */
            ii(0x1016_cdc4, 2); mov(eax, edi);                          /* mov eax, edi */
            ii(0x1016_cdc6, 3); imul(eax, edx);                         /* imul eax, edx */
            ii(0x1016_cdc9, 4); mov(ebp, memd[ss, esp + 0x8]);          /* mov ebp, [esp+0x8] */
            ...
            ii(0x1016_cddc, 4); mov(memd[ss, esp + 0x4], eax);          /* mov [esp+0x4], eax */
            ...
            ii(0x1016_cdeb, 4); mov(ebp, memd[ss, esp + 0x4]);          /* mov ebp, [esp+0x4] */
            ...
            ii(0x1016_ce08, 4); sub(ebp, memd[ss, esp + 0x8]);          /* sub ebp, [esp+0x8] */
            ...
            ii(0x1016_ce2b, 4); mov(memd[ss, esp + 0x4], eax);          /* mov [esp+0x4], eax */
            ...
            ii(0x1016_ce3f, 4); mov(ebp, memd[ss, esp + 0x4]);          /* mov ebp, [esp+0x4] */
            ...
            ii(0x1016_ce55, 4); mov(eax, memd[ss, esp + 0x8]);          /* mov eax, [esp+0x8] */
