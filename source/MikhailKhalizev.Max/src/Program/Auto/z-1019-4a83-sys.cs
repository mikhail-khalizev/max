...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("44725b7c-0c3a-4287-ab55-5b950f59dff4")]
        public void /* sys */ Method_1019_4a83()
        {
            ii(0x1019_4a83, 1); pushd(ebp);                             /* push ebp */
            ii(0x1019_4a84, 2); mov(ebp, esp);                          /* mov ebp, esp */
            ii(0x1019_4a86, 1); pushd(esi);                             /* push esi */
            ii(0x1019_4a87, 1); pushd(edi);                             /* push edi */
            ii(0x1019_4a88, 1); pushd(ebx);                             /* push ebx */
            ii(0x1019_4a89, 1); pushd(ecx);                             /* push ecx */
            ii(0x1019_4a8a, 2); pushd(fs);                              /* push fs */
            ii(0x1019_4a8c, 2); pushd(gs);                              /* push gs */
            ii(0x1019_4a8e, 1); pushd(es);                              /* push es */
            ii(0x1019_4a8f, 3); les(edi, ss, ebp + 0xc);                /* les edi, [ebp+0xc] */
            ii(0x1019_4a92, 6); mov(memd_a32[ds, 0x101c_0a38], edi);    /* mov [0x101c0a38], edi */
            ii(0x1019_4a98, 7); mov(memw_a32[ds, 0x101c_0a3c], es);     /* mov [0x101c0a3c], es */
            ii(0x1019_4a9f, 7); mov(memw_a32[ds, 0x101c_0a40], ds);     /* mov [0x101c0a40], ds */
            ii(0x1019_4aa6, 7); mov(memw_a32[ds, 0x101c_0a46], ds);     /* mov [0x101c0a46], ds */
            ii(0x1019_4aad, 7); cmp(memd_a32[ds, 0x101c_1a54], 0);      /* cmp dword [0x101c1a54], 0x0 */
            ii(0x1019_4ab4, 6); if(jzd(0x1019_4b3a, 0x80)) goto l_0x1019_4b3a; /* jz 0x10194b3a */
            ...
            ii(0x1019_4ac2, 7); cmp(memd_a32[ds, 0x101c_1a58], 0);      /* cmp dword [0x101c1a58], 0x0 */
            ii(0x1019_4ac9, 2); if(jzd(0x1019_4af9, 0x2e)) goto l_0x1019_4af9; /* jz 0x10194af9 */
            ...
            ii(0x1019_4ad7, 6); mov(memd_a32[ds, 0x101c_0a2c], edx);    /* mov [0x101c0a2c], edx */
            ii(0x1019_4add, 7); mov(memw_a32[ds, 0x101c_0a30], cx);     /* mov [0x101c0a30], cx */
            ...
            ii(0x1019_4af4, 2); jmpd(0x1019_4b20, 0x2a); goto l_0x1019_4b20; /* jmp 0x10194b20 */
        //  ii(0x1019_4af6, 3); Недостижимый код.
l_0x1019_4af9:
            ii(0x1019_4af9, 4); mov(ax, 0x3508);                        /* mov ax, 0x3508 */
            ii(0x1019_4afd, 2); @int(0x21);                             /* int 0x21 */
            ii(0x1019_4aff, 6); mov(memd_a32[ds, 0x101c_0a2c], ebx);    /* mov [0x101c0a2c], ebx */
            ii(0x1019_4b05, 7); mov(memw_a32[ds, 0x101c_0a30], es);     /* mov [0x101c0a30], es */
        ...
        l_0x1019_4b20:
            ...
            ii(0x1019_4b2b, 3); mov(eax, memd_a32[ss, ebp + 0x8]);      /* mov eax, [ebp+0x8] */
        ...
        l_0x1019_4b3a:
            ...
            ii(0x1019_4b3f, 1); popd(ecx);                              /* pop ecx */
            ii(0x1019_4b40, 1); popd(ebx);                              /* pop ebx */
            ii(0x1019_4b41, 1); popd(edi);                              /* pop edi */
            ii(0x1019_4b42, 1); popd(esi);                              /* pop esi */
            ii(0x1019_4b43, 1); popd(ebp);                              /* pop ebp */
            ii(0x1019_4b44, 1); retd(); return;                         /* ret */
        }
    }
}
