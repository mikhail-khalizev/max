...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x18_0bc2, 4); enter(0x2, 0);                            /* enter 0x2, 0x0 */
            ...
            ii(0x18_0bce, 5); mov(memw[ss, bp - 0x2], 0x1);             /* mov word [bp-0x2], 0x1 */
            ...
            ii(0x18_0bda, 3); mov(di, memw[ss, bp + 0x4]);              /* mov di, [bp+0x4] */
            ii(0x18_0bdd, 3); mov(si, memw[ss, bp + 0x6]);              /* mov si, [bp+0x6] */
            ii(0x18_0be0, 3); mov(cx, memw[ss, bp + 0x8]);              /* mov cx, [bp+0x8] */
            ii(0x18_0be3, 3); mov(bx, memw[ss, bp + 0xa]);              /* mov bx, [bp+0xa] */
            ...
            ii(0x18_0bf1, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
        l_0x18_0bf4:
            ii(0x18_0bf4, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0x18_0bf7, 1); pop(ds);                                  /* pop ds */
            ii(0x18_0bf8, 1); pop(si);                                  /* pop si */
            ii(0x18_0bf9, 1); pop(di);                                  /* pop di */
            ii(0x18_0bfa, 1); leave();                                  /* leave */
            ii(0x18_0bfb, 3); ret(0x8);                                 /* ret 0x8 */
        }
    }
}
