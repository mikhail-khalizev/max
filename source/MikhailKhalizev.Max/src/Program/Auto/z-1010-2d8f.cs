...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("05720052-e6e9-47b8-af55-11d8132e334f")]
        public void Method_1010_2d8f()
        {
            ii(0x1010_2d8f, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x1010_2d94, 5); calld(Definitions.sys_check_available_stack_size, 0x62fb9); /* call 0x10165d52 */
            ...
            ii(0x1010_2daf, 5); calld(0x1007_6b90, -0x8c224);           /* call 0x10076b90 */
            ii(0x1010_2db4, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1010_2db7, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1010_2dba, 5); calld(0x1013_c0fa, 0x3933b);            /* call 0x1013c0fa */
            ii(0x1010_2dbf, 3); mov(eax, memd_a32[ss, ebp - 0x8]);      /* mov eax, [ebp-0x8] */
            ii(0x1010_2dc2, 5); calld(0x1007_6338, -0x8ca8f);           /* call 0x10076338 */
            ...
            ii(0x1010_2dce, 5); calld(0x1007_64b8, -0x8c91b);           /* call 0x100764b8 */
        l_0x1010_2dd3:
            ii(0x1010_2dd3, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_2dd5, 3); lea(eax, ebp - 0xc);                    /* lea eax, [ebp-0xc] */
            ii(0x1010_2dd8, 5); calld(0x1013_ad71, 0x37f94);            /* call 0x1013ad71 */
            ...
            ii(0x1010_2de4, 5); calld(0x1007_6408, -0x8c9e1);           /* call 0x10076408 */
            ii(0x1010_2de9, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1010_2deb, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1010_2dee, 5); calld(0x1013_c25c, 0x39469);            /* call 0x1013c25c */
            ii(0x1010_2df3, 3); lea(eax, ebp - 0xc);                    /* lea eax, [ebp-0xc] */
            ii(0x1010_2df6, 5); calld(0x1007_6bf8, -0x8c203);           /* call 0x10076bf8 */
        ...
        l_0x1010_2dfd:
            ...
            ii(0x1010_2e02, 5); calld(0x1007_5f6c, -0x8ce9b);           /* call 0x10075f6c */
