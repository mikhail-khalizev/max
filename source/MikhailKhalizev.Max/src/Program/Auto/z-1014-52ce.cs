...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_52ce()
        {
            ...
            ii(0x1014_52e5, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_52e8, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_52eb, 5); mov(edx, StringDefinitions.ExpectingAWord2); /* mov edx, 0x101acfcd */
            ii(0x1014_52f0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_52f3, 5); call(0x1014_5151, -0x1a7);              /* call 0x10145151 */
            ii(0x1014_52f8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_52fb, 5); call(Definitions.my_string_ctor, -0x3818); /* call 0x10141ae8 */
            ii(0x1014_5300, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
