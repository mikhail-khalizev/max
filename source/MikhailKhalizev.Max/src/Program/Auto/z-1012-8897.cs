...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_8897()
        {
            ...
            ii(0x1012_88ad, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x1012_88b0, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x1012_88b3, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ii(0x1012_88b6, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ...
            ii(0x1012_88c7, 9); mov(memw[ds, 0x101c_5c1f], 0x1);        /* mov word [0x101c5c1f], 0x1 */
            ii(0x1012_88d0, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
