...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_d2e3()
        {
            ...
            ii(0x100c_d2fb, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_d2fe, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_d301, 5); call(0x100c_bb8b, -0x177b);             /* call 0x100cbb8b */
            ii(0x100c_d306, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_d309, 5); cmp(memw[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp word [ebp-0x8], 0xffff */
            ii(0x100c_d30e, 2); if(jz(0x100c_d31c, 0xc)) goto l_0x100c_d31c; /* jz 0x100cd31c */
            ii(0x100c_d310, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100c_d314, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_d317, 5); call(0x100c_bc91, -0x168b);             /* call 0x100cbc91 */
        l_0x100c_d31c:
            ii(0x100c_d31c, 5); cmp(memw[ss, ebp - 0x8], 0xb);          /* cmp word [ebp-0x8], 0xb */
            ii(0x100c_d321, 2); if(jnz(0x100c_d330, 0xd)) goto l_0x100c_d330; /* jnz 0x100cd330 */
            ii(0x100c_d323, 5); mov(edx, 0x4b);                         /* mov edx, 0x4b */
            ii(0x100c_d328, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_d32b, 5); call(0x100c_bc91, -0x169f);             /* call 0x100cbc91 */
        l_0x100c_d330:
            ii(0x100c_d330, 5); cmp(memw[ss, ebp - 0x8], 0x9);          /* cmp word [ebp-0x8], 0x9 */
            ii(0x100c_d335, 2); if(jz(0x100c_d33e, 0x7)) goto l_0x100c_d33e; /* jz 0x100cd33e */
            ii(0x100c_d337, 5); cmp(memw[ss, ebp - 0x8], 0x3);          /* cmp word [ebp-0x8], 0x3 */
            ii(0x100c_d33c, 2); if(jnz(0x100c_d340, 0x2)) goto l_0x100c_d340; /* jnz 0x100cd340 */
        l_0x100c_d33e:
            ii(0x100c_d33e, 2); jmp(0x100c_d347, 0x7); goto l_0x100c_d347; /* jmp 0x100cd347 */
        l_0x100c_d340:
            ii(0x100c_d340, 5); cmp(memw[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp word [ebp-0x8], 0xffff */
            ii(0x100c_d345, 2); if(jnz(0x100c_d354, 0xd)) goto l_0x100c_d354; /* jnz 0x100cd354 */
        l_0x100c_d347:
            ii(0x100c_d347, 5); mov(edx, 0x3b);                         /* mov edx, 0x3b */
            ii(0x100c_d34c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
