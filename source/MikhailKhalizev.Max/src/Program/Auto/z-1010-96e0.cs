...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("40c0e20b-2e0e-4aae-84b3-3d30aa9d79b4")]
        public void Method_1010_96e0()
        {
            ii(0x1010_96e0, 5); pushd(0x40);                            /* push 0x40 */
            ii(0x1010_96e5, 5); calld(Definitions.sys_check_available_stack_size, 0x5c668); /* call 0x10165d52 */
            ...
            ii(0x1010_9728, 5); calld(0x1008_b148, -0x7e5e5);           /* call 0x1008b148 */
        ...
        l_0x1010_976f:
            ...
            ii(0x1010_9774, 5); calld(/* sys */ 0x1016_a24c, 0x60ad3);  /* call 0x1016a24c */
        ...
        l_0x1010_978a:
            ...
            ii(0x1010_97b5, 5); calld(Definitions.my_strobj_c_str_v2, -0x7fff2); /* call 0x100897c8 */
        ...
        l_0x1010_97ed:
            ...
            ii(0x1010_97f6, 5); calld(Definitions.sys_display_draw_1, 0x5dcad); /* call 0x101674a8 */
        l_0x1010_97fb:
