...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_96e0()
        {
            ...
            ii(0x1010_96f8, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x1010_9708, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_9725, 3); lea(eax, memd[ss, ebp - 0x20]);         /* lea eax, [ebp-0x20] */
            ii(0x1010_9728, 5); call(0x1008_b148, -0x7_e5e5);           /* call 0x1008b148 */
            ii(0x1010_972d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_9730, 3); mov(eax, memd[ds, eax + 0xe]);          /* mov eax, [eax+0xe] */
            ii(0x1010_9733, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1010_9736, 3); mov(edx, memd[ss, ebp - 0x1c]);         /* mov edx, [ebp-0x1c] */
            ii(0x1010_9739, 3); imul(edx, eax);                         /* imul edx, eax */
            ii(0x1010_973c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_973f, 3); mov(eax, memd[ds, eax + 0x16]);         /* mov eax, [eax+0x16] */
            ii(0x1010_9742, 3); add(eax, memd[ss, ebp - 0x20]);         /* add eax, [ebp-0x20] */
            ii(0x1010_9745, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1010_9747, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ...
            ii(0x1010_9757, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1010_975a, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1010_975d, 7); cmp(ax, memw[ds, 0x101c_4dec]);         /* cmp ax, [0x101c4dec] */
            ii(0x1010_9764, 2); if(jle(0x1010_976f, 0x9)) goto l_0x1010_976f; /* jle 0x1010976f */
            ii(0x1010_9766, 6); mov(ax, memw[ds, 0x101c_4dec]);         /* mov ax, [0x101c4dec] */
            ii(0x1010_976c, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
        l_0x1010_976f:
            ...
            ii(0x1010_977f, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_9782, 2); jmp(0x1010_978a, 0x6); goto l_0x1010_978a; /* jmp 0x1010978a */
        l_0x1010_9784:
            ii(0x1010_9784, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_9787, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x1010_978a:
            ii(0x1010_978a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_978d, 4); cmp(ax, memw[ss, ebp - 0xc]);           /* cmp ax, [ebp-0xc] */
            ii(0x1010_9791, 2); if(jge(0x1010_97ed, 0x5a)) goto l_0x1010_97ed; /* jge 0x101097ed */
            ii(0x1010_9793, 5); push(0xa2);                             /* push 0xa2 */
            ii(0x1010_9798, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_979b, 3); mov(ecx, memd[ds, eax + 0xe]);          /* mov ecx, [eax+0xe] */
            ii(0x1010_979e, 3); sar(ecx, 0x10);                         /* sar ecx, 0x10 */
            ii(0x1010_97a1, 5); mov(ebx, 0x128);                        /* mov ebx, 0x128 */
            ii(0x1010_97a6, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1010_97bc, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1010_97d6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_97d9, 3); mov(eax, memd[ds, eax + 0xe]);          /* mov eax, [eax+0xe] */
            ii(0x1010_97dc, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1010_97df, 3); imul(eax, esi);                         /* imul eax, esi */
            ii(0x1010_97e2, 3); add(eax, memd[ss, ebp - 0x10]);         /* add eax, [ebp-0x10] */
        ...
        l_0x1010_97ed:
            ii(0x1010_97ed, 3); lea(edx, memd[ss, ebp - 0x20]);         /* lea edx, [ebp-0x20] */
            ii(0x1010_97f0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_97f3, 3); mov(eax, memd[ds, eax + 0x12]);         /* mov eax, [eax+0x12] */
