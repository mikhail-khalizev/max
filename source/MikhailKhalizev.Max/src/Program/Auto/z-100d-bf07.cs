...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_bf07()
        {
            ...
            ii(0x100d_bf1f, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100d_bf22, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_bf32, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_bf35, 3); mov(edx, memd[ds, eax + 0x24]);         /* mov edx, [eax+0x24] */
            ii(0x100d_bf38, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_bf3b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_bf3e, 3); add(eax, 0x48);                         /* add eax, 0x48 */
            ii(0x100d_bf41, 5); call(0x100e_0934, 0x49ee);              /* call 0x100e0934 */
            ii(0x100d_bf46, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
