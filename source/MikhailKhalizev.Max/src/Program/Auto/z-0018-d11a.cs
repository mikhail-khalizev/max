...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_d11a()
        {
            ...
            ii(0x18_d135, 2); if(jz(0x18_d13d, 0x6)) goto l_0x18_d13d;  /* jz 0xd13d */
            ii(0x18_d137, 4); test(memb[ss, bp - 0xe], 0x10);           /* test byte [bp-0xe], 0x10 */
            ii(0x18_d13b, 2); if(jnz(0x18_d140, 0x3)) goto l_0x18_d140; /* jnz 0xd140 */
        l_0x18_d13d:
            ii(0x18_d13d, 3); jmp(0x18_d1c5, 0x85); goto l_0x18_d1c5;   /* jmp 0xd1c5 */
        l_0x18_d140:
            ii(0x18_d140, 3); mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
            ...
            ii(0x18_d168, 5); mov(memw[ss, bp - 0x8], 0);               /* mov word [bp-0x8], 0x0 */
            ii(0x18_d16d, 5); mov(memw[ss, bp - 0x6], 0x8);             /* mov word [bp-0x6], 0x8 */
            ii(0x18_d172, 3); mov(ax, memw[ds, 0x97c]);                 /* mov ax, [0x97c] */
            ii(0x18_d175, 3); shr(ax, 0x3);                             /* shr ax, 0x3 */
            ii(0x18_d178, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
        ...
        l_0x18_d180:
            ...
            ii(0x18_d188, 3); add(bx, memw[ss, bp - 0x8]);              /* add bx, [bp-0x8] */
            ii(0x18_d18b, 3); mov(es, memw[ss, bp - 0x6]);              /* mov es, [bp-0x6] */
            ii(0x18_d18e, 4); cmp(memw[es, bx + 0x2], ax);              /* cmp [es:bx+0x2], ax */
            ii(0x18_d192, 2); if(jnz(0x18_d1ad, 0x19)) goto l_0x18_d1ad; /* jnz 0xd1ad */
            ii(0x18_d194, 4); mov(al, memb[es, bx + 0x4]);              /* mov al, [es:bx+0x4] */
