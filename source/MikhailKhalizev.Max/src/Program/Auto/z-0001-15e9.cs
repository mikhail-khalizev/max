...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0001_15e9()
        {
            ...
            ii(0x1_15ee, 3);  mov(si, memw[ss, bp + 0x4]);              /* mov si, [bp+0x4] */
        ...
        l_0x1_15fe:
            ...
            ii(0x1_160c, 4);  test(memb[ss, bp - 0x2], 0x10);           /* test byte [bp-0x2], 0x10 */
            ii(0x1_1610, 2);  if(jz(0x1_1632, 0x20)) goto l_0x1_1632;   /* jz 0x1632 */
            ii(0x1_1612, 3);  mov(ax, memw[ss, bp - 0xa]);              /* mov ax, [bp-0xa] */
            ii(0x1_1615, 3);  mov(dx, memw[ss, bp - 0x8]);              /* mov dx, [bp-0x8] */
            ii(0x1_1618, 3);  sub(ax, memw[ss, bp + 0x6]);              /* sub ax, [bp+0x6] */
            ii(0x1_161b, 3);  sbb(dx, memw[ss, bp + 0x8]);              /* sbb dx, [bp+0x8] */
            ...
            ii(0x1_1627, 2);  if(jb(0x1_162d, 0x4)) goto l_0x1_162d;    /* jb 0x162d */
            ii(0x1_1629, 2);  cmp(ax, cx);                              /* cmp ax, cx */
            ii(0x1_162b, 2);  if(ja(0x1_1632, 0x5)) goto l_0x1_1632;    /* ja 0x1632 */
        l_0x1_162d:
