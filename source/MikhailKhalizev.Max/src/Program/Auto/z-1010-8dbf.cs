...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_8dbf()
        {
            ...
            ii(0x1010_8dd7, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_8dda, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_8ddd, 4); mov(ax, memw[ds, eax + 0xd]);           /* mov ax, [eax+0xd] */
            ii(0x1010_8de1, 1); inc(eax);                               /* inc eax */
            ii(0x1010_8de2, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1010_8de5, 4); mov(memw[ds, edx + 0xb], ax);           /* mov [edx+0xb], ax */
            ii(0x1010_8de9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
