...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_9804()
        {
            ...
            ii(0x1010_9809, 5); calld(Definitions.sys_check_available_stack_size, 0x5c544); /* call 0x10165d52 */
            ...
            ii(0x1010_9824, 5); calld(/* sys */ 0x1016_a24c, 0x60a23);  /* call 0x1016a24c */
            ii(0x1010_9829, 5); mov(eax, 0x764);                        /* mov eax, 0x764 */
            ii(0x1010_982e, 5); calld(Definitions.my_get_res_data_by_id_malloc, 0x2a9b8); /* call 0x101341eb */
            ...
            ii(0x1010_986f, 5); calld(0x100e_969d, -0x201d7);           /* call 0x100e969d */
            ...
            ii(0x1010_9887, 5); calld(Definitions.sys_new, 0x5c574);    /* call 0x10165e00 */
            ...
            ii(0x1010_98b3, 5); calld(Definitions.my_ctor_c17, -0x3b4a9); /* call 0x100ce40f */
        ...
        l_0x1010_98c9:
            ...
            ii(0x1010_9909, 5); calld(0x100c_f85c, -0x3a0b2);           /* call 0x100cf85c */
            ii(0x1010_990e, 5); mov(eax, 0x38);                         /* mov eax, 0x38 */
            ii(0x1010_9913, 5); calld(Definitions.sys_new, 0x5c4e8);    /* call 0x10165e00 */
            ...
            ii(0x1010_993f, 5); calld(Definitions.my_ctor_c17, -0x3b535); /* call 0x100ce40f */
        ...
        l_0x1010_9955:
            ...
            ii(0x1010_9967, 5); calld(0x100d_5134, -0x34838);           /* call 0x100d5134 */
            ii(0x1010_996c, 5); mov(edx, 0x73e9);                       /* mov edx, 0x73e9 */
            ii(0x1010_9971, 5); mov(eax, memd_a32[ds, 0x101c_4de4]);    /* mov eax, [0x101c4de4] */
            ii(0x1010_9976, 5); calld(0x100d_5164, -0x34817);           /* call 0x100d5164 */
            ...
            ii(0x1010_9986, 5); calld(0x100c_f85c, -0x3a12f);           /* call 0x100cf85c */
            ...
            ii(0x1010_9999, 5); calld(Definitions.sys_display_draw_0, 0x5dae6); /* call 0x10167484 */
