...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_b33c()
        {
            ...
            ii(0x100a_b34e, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100a_b354, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100a_b357, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_b35a, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x100a_b35c, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100a_b35f, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
