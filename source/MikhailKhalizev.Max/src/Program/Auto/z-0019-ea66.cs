...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x19_ea66, 4); enter(0x4, 0);                            /* enter 0x4, 0x0 */
            ...
            ii(0x19_ea79, 2); if(jnz(0x19_ea7e, 0x3)) goto l_0x19_ea7e; /* jnz 0xea7e */
        ...
        l_0x19_ea7e:
            ...
            ii(0x19_ea8e, 5); call_far_ind(es, 0xd8c);                  /* call far word [es:0xd8c] */
            ii(0x19_ea93, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_ea96, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x19_ea99, 2); or(dx, ax);                               /* or dx, ax */
            ii(0x19_ea9b, 2); if(jnz(0x19_eaa0, 0x3)) goto l_0x19_eaa0; /* jnz 0xeaa0 */
            ii(0x19_ea9d, 3); jmp(0x19_eab8, 0x18); goto l_0x19_eab8;   /* jmp 0xeab8 */
        l_0x19_eaa0:
            ii(0x19_eaa0, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x19_eaa3, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0x19_eab5, 3); jmp(0x19_eabd, 0x5); goto l_0x19_eabd;    /* jmp 0xeabd */
        l_0x19_eab8:
            ii(0x19_eab8, 5); mov(memb[ds, 0xd8a], 0x1);                /* mov byte [0xd8a], 0x1 */
        l_0x19_eabd:
