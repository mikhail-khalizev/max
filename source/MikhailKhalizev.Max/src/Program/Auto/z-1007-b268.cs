...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_b268()
        {
            ...
            ii(0x1007_b280, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_b283, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_b286, 4); mov(dx, memw[ds, eax + 0x27]);          /* mov dx, [eax+0x27] */
            ii(0x1007_b28a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_b295, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_b2a2, 2); if(jnz(0x1007_b2a6, 0x2)) goto l_0x1007_b2a6; /* jnz 0x1007b2a6 */
        l_0x1007_b2a4:
            ii(0x1007_b2a4, 2); jmp(0x1007_b2c2, 0x1c); goto l_0x1007_b2c2; /* jmp 0x1007b2c2 */
        l_0x1007_b2a6:
            ii(0x1007_b2a6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_b2c0, 2); if(jg(0x1007_b2c4, 0x2)) goto l_0x1007_b2c4; /* jg 0x1007b2c4 */
        l_0x1007_b2c2:
            ii(0x1007_b2c2, 2); jmp(0x1007_b2ca, 0x6); goto l_0x1007_b2ca; /* jmp 0x1007b2ca */
        l_0x1007_b2c4:
            ii(0x1007_b2c4, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x1007_b2c8, 2); jmp(0x1007_b2ce, 0x4); goto l_0x1007_b2ce; /* jmp 0x1007b2ce */
        l_0x1007_b2ca:
            ii(0x1007_b2ca, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x1007_b2ce:
            ii(0x1007_b2ce, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
