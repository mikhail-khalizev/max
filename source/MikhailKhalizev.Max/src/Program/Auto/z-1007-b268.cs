...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_b268()
        {
            ...
            ii(0x1007_b286, 4); mov(dx, memw[ds, eax + 39]);            /* mov dx, [eax+0x27] */
            ii(0x1007_b28a, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1007_b28d, 4); cmp(dx, memw[ds, eax + 37]);            /* cmp dx, [eax+0x25] */
        ...
        l_0x1007_b2a6:
            ...
            ii(0x1007_b2b6, 3); mov(al, memb[ds, eax + 77]);            /* mov al, [eax+0x4d] */
        ...
        l_0x1007_b2ce:
            ...
            ii(0x1007_b2d1, 3); mov(memb[ss, ebp - 12], al);            /* mov [ebp-0xc], al */
            ii(0x1007_b2d4, 3); mov(al, memb[ss, ebp - 12]);            /* mov al, [ebp-0xc] */
