...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_11ff()
        {
            ...
            ii(0x1010_1214, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_1217, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x1010_121a, 3); mov(memd[ss, ebp - 0x10], ebx);         /* mov [ebp-0x10], ebx */
            ii(0x1010_121d, 3); mov(memb[ss, ebp - 0x4], cl);           /* mov [ebp-0x4], cl */
            ii(0x1010_1220, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1010_1223, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1010_122d, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1010_1230, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ii(0x1010_1233, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1010_1236, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1010_1238, 2); if(jge(0x1010_123c, 0x2)) goto l_0x1010_123c; /* jge 0x1010123c */
        l_0x1010_123a:
            ii(0x1010_123a, 2); jmp(0x1010_1249, 0xd); goto l_0x1010_1249; /* jmp 0x10101249 */
        l_0x1010_123c:
            ii(0x1010_123c, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1010_123f, 3); mov(eax, memd[ds, eax + 0xc]);          /* mov eax, [eax+0xc] */
            ii(0x1010_1242, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1010_1245, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1010_1247, 2); if(jge(0x1010_124b, 0x2)) goto l_0x1010_124b; /* jge 0x1010124b */
        l_0x1010_1249:
            ii(0x1010_1249, 2); jmp(0x1010_1258, 0xd); goto l_0x1010_1258; /* jmp 0x10101258 */
        l_0x1010_124b:
            ii(0x1010_124b, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1010_124e, 3); mov(eax, memd[ds, eax + 0xe]);          /* mov eax, [eax+0xe] */
            ii(0x1010_1251, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1010_1254, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1010_1256, 2); if(jge(0x1010_125a, 0x2)) goto l_0x1010_125a; /* jge 0x1010125a */
        l_0x1010_1258:
            ii(0x1010_1258, 2); jmp(0x1010_126b, 0x11); goto l_0x1010_126b; /* jmp 0x1010126b */
        l_0x1010_125a:
            ii(0x1010_125a, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1010_125d, 3); mov(eax, memd[ds, eax + 0xa]);          /* mov eax, [eax+0xa] */
        ...
        l_0x1010_126b:
            ii(0x1010_126b, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1010_1283, 2); if(jz(0x1010_128c, 0x7)) goto l_0x1010_128c; /* jz 0x1010128c */
            ii(0x1010_1285, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
        l_0x1010_128c:
            ii(0x1010_128c, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ...
            ii(0x1010_12a6, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1010_12be, 2); if(jz(0x1010_12c2, 0x2)) goto l_0x1010_12c2; /* jz 0x101012c2 */
        l_0x1010_12c0:
        ...
        l_0x1010_12c2:
            ...
            ii(0x1010_12d1, 3); cmp(eax, memd[ss, ebp - 0xc]);          /* cmp eax, [ebp-0xc] */
            ii(0x1010_12d4, 2); if(jz(0x1010_12d8, 0x2)) goto l_0x1010_12d8; /* jz 0x101012d8 */
        l_0x1010_12d6:
            ii(0x1010_12d6, 2); jmp(0x1010_12f7, 0x1f); goto l_0x1010_12f7; /* jmp 0x101012f7 */
        l_0x1010_12d8:
            ii(0x1010_12d8, 2); xor(ecx, ecx);                          /* xor ecx, ecx */
            ii(0x1010_12da, 3); mov(cl, memb[ss, ebp - 0x10]);          /* mov cl, [ebp-0x10] */
            ...
            ii(0x1010_12e9, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1010_12ec, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
        ...
        l_0x1010_12f7:
            ...
            ii(0x1010_12f9, 3); mov(cl, memb[ss, ebp - 0x10]);          /* mov cl, [ebp-0x10] */
            ii(0x1010_12fc, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1010_12fe, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1010_1301, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_1305, 5); call(0x100a_1ea3, -0x5_f467);           /* call 0x100a1ea3 */
        l_0x1010_130a:
            ii(0x1010_130a, 7); mov(memd[ss, ebp - 0x14], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x1010_1311, 2); jmp(0x1010_1323, 0x10); goto l_0x1010_1323; /* jmp 0x10101323 */
        l_0x1010_1313:
            ii(0x1010_1313, 7); mov(memd[ss, ebp - 0x14], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x1010_131a, 2); jmp(0x1010_1323, 0x7); goto l_0x1010_1323; /* jmp 0x10101323 */
        l_0x1010_131c:
            ii(0x1010_131c, 7); mov(memd[ss, ebp - 0x14], 0x1);         /* mov dword [ebp-0x14], 0x1 */
        l_0x1010_1323:
            ii(0x1010_1323, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
