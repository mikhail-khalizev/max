...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_5f8c()
        {
            ...
            ii(0x1018_5f9a, 3); cmp(ecx, memd[ds, edx + 0x8]);          /* cmp ecx, [edx+0x8] */
            ii(0x1018_5f9d, 2); if(jg(0x1018_5fb8, 0x19)) goto l_0x1018_5fb8; /* jg 0x10185fb8 */
            ii(0x1018_5f9f, 3); mov(ecx, memd[ds, eax + 0x8]);          /* mov ecx, [eax+0x8] */
            ...
            ii(0x1018_5fa8, 3); mov(ecx, memd[ds, eax + 0x4]);          /* mov ecx, [eax+0x4] */
            ii(0x1018_5fab, 3); cmp(ecx, memd[ds, edx + 0xc]);          /* cmp ecx, [edx+0xc] */
            ii(0x1018_5fae, 2); if(jg(0x1018_5fb8, 0x8)) goto l_0x1018_5fb8; /* jg 0x10185fb8 */
            ii(0x1018_5fb0, 3); mov(ecx, memd[ds, eax + 0xc]);          /* mov ecx, [eax+0xc] */
            ii(0x1018_5fb3, 3); cmp(ecx, memd[ds, edx + 0x4]);          /* cmp ecx, [edx+0x4] */
        ...
        l_0x1018_5fc2:
            ...
            ii(0x1018_5fc4, 2); if(jle(0x1018_5fc8, 0x2)) goto l_0x1018_5fc8; /* jle 0x10185fc8 */
            ii(0x1018_5fc6, 2); mov(memd[ds, ebx], edi);                /* mov [ebx], edi */
        l_0x1018_5fc8:
            ii(0x1018_5fc8, 3); mov(ecx, memd[ds, eax + 0x8]);          /* mov ecx, [eax+0x8] */
            ii(0x1018_5fcb, 3); mov(ebp, memd[ds, edx + 0x8]);          /* mov ebp, [edx+0x8] */
            ii(0x1018_5fce, 2); cmp(ecx, ebp);                          /* cmp ecx, ebp */
            ii(0x1018_5fd0, 2); if(jle(0x1018_5fd5, 0x3)) goto l_0x1018_5fd5; /* jle 0x10185fd5 */
            ii(0x1018_5fd2, 3); mov(memd[ds, ebx + 0x8], ebp);          /* mov [ebx+0x8], ebp */
        l_0x1018_5fd5:
            ii(0x1018_5fd5, 3); mov(ecx, memd[ds, eax + 0x4]);          /* mov ecx, [eax+0x4] */
            ii(0x1018_5fd8, 3); mov(esi, memd[ds, edx + 0x4]);          /* mov esi, [edx+0x4] */
            ii(0x1018_5fdb, 2); cmp(ecx, esi);                          /* cmp ecx, esi */
            ii(0x1018_5fdd, 2); if(jge(0x1018_5fe2, 0x3)) goto l_0x1018_5fe2; /* jge 0x10185fe2 */
            ii(0x1018_5fdf, 3); mov(memd[ds, ebx + 0x4], esi);          /* mov [ebx+0x4], esi */
        l_0x1018_5fe2:
            ii(0x1018_5fe2, 3); mov(eax, memd[ds, eax + 0xc]);          /* mov eax, [eax+0xc] */
            ii(0x1018_5fe5, 3); mov(edi, memd[ds, edx + 0xc]);          /* mov edi, [edx+0xc] */
            ii(0x1018_5fe8, 2); cmp(eax, edi);                          /* cmp eax, edi */
            ii(0x1018_5fea, 2); if(jle(0x1018_5fef, 0x3)) goto l_0x1018_5fef; /* jle 0x10185fef */
            ii(0x1018_5fec, 3); mov(memd[ds, ebx + 0xc], edi);          /* mov [ebx+0xc], edi */
        l_0x1018_5fef:
