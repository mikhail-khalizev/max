...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_4113()
        {
            ...
            ii(0x1012_413b, 2); if(jnz(0x1012_4146, 0x9)) goto l_0x1012_4146; /* jnz 0x10124146 */
            ii(0x1012_413d, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
        ...
        l_0x1012_4146:
            ...
            ii(0x1012_4158, 2); if(jnz(0x1012_4163, 0x9)) goto l_0x1012_4163; /* jnz 0x10124163 */
            ii(0x1012_415a, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x1012_4161, 2); jmp(0x1012_416a, 0x7); goto l_0x1012_416a; /* jmp 0x1012416a */
        l_0x1012_4163:
            ii(0x1012_4163, 7); mov(memd[ss, ebp - 0x4], 0x1);          /* mov dword [ebp-0x4], 0x1 */
        l_0x1012_416a:
            ii(0x1012_416a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
