...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_deac()
        {
            ...
            ii(0x1016_dec1, 4); mov(memd[ss, esp + 4], edx);            /* mov [esp+0x4], edx */
        ...
        l_0x1016_df83:
            ...
            ii(0x1016_dfa3, 4); mov(memd[ss, esp + 8], eax);            /* mov [esp+0x8], eax */
            ...
            ii(0x1016_dfb2, 3); sub(eax, 4);                            /* sub eax, 0x4 */
        ...
        l_0x1016_dfbb:
            ...
            ii(0x1016_dfbf, 5); mov(ecx, 1);                            /* mov ecx, 0x1 */
        ...
        l_0x1016_dff7:
            ...
            ii(0x1016_dffb, 4); mov(cl, memb[ss, esp + 4]);             /* mov cl, [esp+0x4] */
            ...
            ii(0x1016_e005, 3); sub(eax, 4);                            /* sub eax, 0x4 */
            ii(0x1016_e008, 2); sub(edx, ebx);                          /* sub edx, ebx */
            ii(0x1016_e00a, 3); mov(memb[ds, edi + 1], cl);             /* mov [edi+0x1], cl */
        l_0x1016_e00d:
            ii(0x1016_e00d, 4); cmp(esi, memd[ss, esp + 8]);            /* cmp esi, [esp+0x8] */
