...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("1679b670-fec9-4e30-bdad-8c4143f8bab7")]
        ...
        //    ii(0x1008_b6d9, 5); calld(0x1008_8bbc, -0x2b22);            /* call 0x10088bbc */
        //    ii(0x1008_b6de, 2); xor(edx, edx);                          /* xor edx, edx */
        //    ii(0x1008_b6e0, 3); lea(eax, ebp - 0xc);                    /* lea eax, [ebp-0xc] */
        //    ii(0x1008_b6e3, 5); calld(0x1007_5f6c, -0x1_577c);          /* call 0x10075f6c */
        l_0x1008_b6e8:
