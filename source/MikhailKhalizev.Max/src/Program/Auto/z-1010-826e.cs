...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_826e()
        {
            ...
            ii(0x1010_828d, 2); if(jnz(0x1010_8298, 0x9)) goto l_0x1010_8298; /* jnz 0x10108298 */
            ii(0x1010_828f, 7); mov(memd[ss, ebp - 0x4], 0xffff_ffff);  /* mov dword [ebp-0x4], 0xffffffff */
        ...
        l_0x1010_8298:
            ...
            ii(0x1010_82bb, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
        l_0x1010_82c2:
            ii(0x1010_82c2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
