...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_5231()
        {
            ...
            ii(0x1019_5238, 2); push(fs);                               /* push fs */
            ii(0x1019_523a, 2); push(gs);                               /* push gs */
            ii(0x1019_523c, 1); push(es);                               /* push es */
            ii(0x1019_523d, 6); les(esi, ds, 0x101c_1ab8);              /* les esi, [0x101c1ab8] */
            ii(0x1019_5243, 3); mov(eax, memd[ss, ebp + 0x8]);          /* mov eax, [ebp+0x8] */
            ...
            ii(0x1019_524f, 3); mov(eax, memd[ss, ebp + 0xc]);          /* mov eax, [ebp+0xc] */
            ii(0x1019_5252, 4); mov(memd[es, esi + ebx], eax);          /* mov [es:esi+ebx], eax */
            ii(0x1019_5256, 6); mov(memw[es, esi + ebx + 0x4], ds);     /* mov [es:esi+ebx+0x4], ds */
            ii(0x1019_525c, 1); pop(es);                                /* pop es */
            ii(0x1019_525d, 2); pop(gs);                                /* pop gs */
            ii(0x1019_525f, 2); pop(fs);                                /* pop fs */
