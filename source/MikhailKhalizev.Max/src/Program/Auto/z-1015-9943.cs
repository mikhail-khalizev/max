...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_9943()
        {
            ...
            ii(0x1015_9954, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1015_995a, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1015_995d, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1015_9960, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1015_9963, 4); cmp(memb[ds, eax + 0x3d], 7);           /* cmp byte [eax+0x3d], 0x7 */
            ...
            ii(0x1015_997b, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_9995, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
        ...
        l_0x1015_999f:
            ...
            ii(0x1015_99b1, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1015_99b4, 5); call(0x1015_7ccf, -0x1cea);             /* call 0x10157ccf */
        l_0x1015_99b9:
            ii(0x1015_99b9, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1015_99bc, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
