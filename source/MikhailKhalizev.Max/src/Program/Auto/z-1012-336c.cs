...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_336c()
        {
            ...
            ii(0x1012_3374, 6); sub(esp, 4);                            /* sub esp, 0x4 */
            ii(0x1012_337a, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1012_337d, 5); mov(edx, 0x101c_3678);                  /* mov edx, 0x101c3678 */
            ii(0x1012_3382, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1012_3385, 5); call(0x100d_4d78, -0x4_e612);           /* call 0x100d4d78 */
            ii(0x1012_338a, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
