...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_d996()
        {
            ...
            ii(0x17_d999, 3); sub(sp, 8);                               /* sub sp, 0x8 */
            ii(0x17_d99c, 3); mov(bx, memw[ss, bp + 6]);                /* mov bx, [bp+0x6] */
            ii(0x17_d99f, 4); cmp(bx, memw[ds, 0x1c5b]);                /* cmp bx, [0x1c5b] */
            ii(0x17_d9a3, 2); if(jb(0x17_d9ac, 7)) goto l_0x17_d9ac;    /* jb 0xd9ac */
        ...
        l_0x17_d9ac:
            ...
            ii(0x17_d9b2, 2); if(jnz(0x17_d9b8, 4)) goto l_0x17_d9b8;   /* jnz 0xd9b8 */
            ii(0x17_d9b4, 4); call_abs(memw[ds, 0x1dae]);               /* call word [0x1dae] */
        l_0x17_d9b8:
            ii(0x17_d9b8, 5); test(memb[ds, bx + 7261], 0x20);          /* test byte [bx+0x1c5d], 0x20 */
        ...
        l_0x17_d9ca:
            ii(0x17_d9ca, 5); test(memb[ds, bx + 7261], 0x80);          /* test byte [bx+0x1c5d], 0x80 */
            ii(0x17_d9cf, 2); if(jz(0x17_da41, 0x70)) goto l_0x17_da41; /* jz 0xda41 */
            ii(0x17_d9d1, 3); mov(dx, memw[ss, bp + 8]);                /* mov dx, [bp+0x8] */
            ii(0x17_d9d4, 1); push(ds);                                 /* push ds */
            ii(0x17_d9d5, 1); pop(es);                                  /* pop es */
            ii(0x17_d9d6, 2); xor(ax, ax);                              /* xor ax, ax */
            ii(0x17_d9d8, 3); mov(memw[ss, bp - 2], ax);                /* mov [bp-0x2], ax */
            ii(0x17_d9db, 3); mov(memw[ss, bp - 4], ax);                /* mov [bp-0x4], ax */
            ...
            ii(0x17_d9e5, 3); mov(memw[ss, bp - 8], sp);                /* mov [bp-0x8], sp */
            ii(0x17_d9e8, 3); mov(cx, memw[ss, bp + 10]);               /* mov cx, [bp+0xa] */
        ...
        l_0x17_da0d:
            ...
            ii(0x17_da15, 3); mov(cx, memw[ss, bp + 10]);               /* mov cx, [bp+0xa] */
        l_0x17_da18:
        ...
        l_0x17_da29:
            ...
            ii(0x17_da2d, 2); if(jnz(0x17_da32, 3)) goto l_0x17_da32;   /* jnz 0xda32 */
            ii(0x17_da2f, 3); call(0x17_da4a, 0x18);                    /* call 0xda4a */
        l_0x17_da32:
            ii(0x17_da32, 1); stosb();                                  /* stosb */
            ii(0x17_da33, 2); mov(al, 0xa);                             /* mov al, 0xa */
            ii(0x17_da35, 3); inc(memw[ss, bp - 4]);                    /* inc word [bp-0x4] */
