...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_ba3c()
        {
            ...
            ii(0x1013_ba54, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1013_ba57, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_ba5a, 3); add(eax, 0x4);                          /* add eax, 0x4 */
            ii(0x1013_ba5d, 5); call(0x1013_b325, -0x73d);              /* call 0x1013b325 */
            ii(0x1013_ba62, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
