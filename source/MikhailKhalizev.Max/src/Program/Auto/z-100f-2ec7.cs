...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_2ec7()
        {
            ...
            ii(0x100f_2f06, 6); lea(eax, memd[ss, ebp - 0xc8]);         /* lea eax, [ebp-0xc8] */
            ii(0x100f_2f0c, 5); call(Definitions.sys_memset, 0x7_2ecf); /* call 0x10165de0 */
            ii(0x100f_2f11, 6); lea(ebx, memd[ss, ebp - 0xc8]);         /* lea ebx, [ebp-0xc8] */
            ...
            ii(0x100f_2f25, 6); lea(ebx, memd[ss, ebp - 0xc8]);         /* lea ebx, [ebp-0xc8] */
            ...
            ii(0x100f_2f39, 6); lea(ebx, memd[ss, ebp - 0xc8]);         /* lea ebx, [ebp-0xc8] */
            ...
            ii(0x100f_2f4d, 6); lea(ebx, memd[ss, ebp - 0xc8]);         /* lea ebx, [ebp-0xc8] */
        ...
        l_0x100f_2f8a:
            ii(0x100f_2f8a, 6); lea(eax, memd[ss, ebp - 0xc8]);         /* lea eax, [ebp-0xc8] */
            ii(0x100f_2f90, 5); call(0x100f_2bf4, -0x3a1);              /* call 0x100f2bf4 */
        l_0x100f_2f95:
            ii(0x100f_2f95, 4); or(memb[ss, ebp - 8], 1);               /* or byte [ebp-0x8], 0x1 */
            ii(0x100f_2f99, 6); lea(eax, memd[ss, ebp - 0xcc]);         /* lea eax, [ebp-0xcc] */
            ...
            ii(0x100f_2fbe, 6); lea(eax, memd[ss, ebp - 0xcc]);         /* lea eax, [ebp-0xcc] */
        ...
        l_0x100f_2fcb:
            ii(0x100f_2fcb, 6); lea(eax, memd[ss, ebp - 0xcc]);         /* lea eax, [ebp-0xcc] */
            ii(0x100f_2fd1, 5); call(0x1007_6bf8, -0x7_c3de);           /* call 0x10076bf8 */
        l_0x100f_2fd6:
            ii(0x100f_2fd6, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100f_2fd8, 6); lea(eax, memd[ss, ebp - 0xcc]);         /* lea eax, [ebp-0xcc] */
            ...
            ii(0x100f_2fe7, 6); lea(eax, memd[ss, ebp - 0xcc]);         /* lea eax, [ebp-0xcc] */
            ...
            ii(0x100f_2ffe, 6); lea(eax, memd[ss, ebp - 0xcc]);         /* lea eax, [ebp-0xcc] */
        ...
        l_0x100f_3016:
            ...
            ii(0x100f_301f, 6); lea(eax, memd[ss, ebp - 0xcc]);         /* lea eax, [ebp-0xcc] */
