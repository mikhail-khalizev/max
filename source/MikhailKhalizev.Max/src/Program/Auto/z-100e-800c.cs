...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_800c()
        {
            ...
            ii(0x100e_8024, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x100e_8031, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
        l_0x100e_8034:
            ii(0x100e_8034, 3); dec(memd[ss, ebp - 0xc]);               /* dec dword [ebp-0xc] */
            ii(0x100e_8037, 5); cmp(memw[ss, ebp - 0xc], -0x1 /* 0xff */); /* cmp word [ebp-0xc], 0xffff */
            ii(0x100e_803c, 2); if(jz(0x100e_808e, 0x50)) goto l_0x100e_808e; /* jz 0x100e808e */
            ii(0x100e_803e, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100e_8042, 5); mov(eax, 0x101c_3620);                  /* mov eax, 0x101c3620 */
            ii(0x100e_8047, 5); call(0x100e_84b8, 0x46c);               /* call 0x100e84b8 */
            ii(0x100e_804c, 3); lea(edi, memd[ss, ebp - 0x1c]);         /* lea edi, [ebp-0x1c] */
            ...
            ii(0x100e_8055, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_8058, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ii(0x100e_805b, 3); cmp(eax, memd[ss, ebp - 0x1c]);         /* cmp eax, [ebp-0x1c] */
            ii(0x100e_805e, 2); if(jle(0x100e_806a, 0xa)) goto l_0x100e_806a; /* jle 0x100e806a */
            ii(0x100e_8060, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_8063, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x100e_8065, 3); cmp(eax, memd[ss, ebp - 0x14]);         /* cmp eax, [ebp-0x14] */
            ii(0x100e_8068, 2); if(jl(0x100e_806c, 0x2)) goto l_0x100e_806c; /* jl 0x100e806c */
        l_0x100e_806a:
            ii(0x100e_806a, 2); jmp(0x100e_8077, 0xb); goto l_0x100e_8077; /* jmp 0x100e8077 */
        l_0x100e_806c:
            ii(0x100e_806c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_806f, 3); mov(eax, memd[ds, eax + 0xc]);          /* mov eax, [eax+0xc] */
            ii(0x100e_8072, 3); cmp(eax, memd[ss, ebp - 0x18]);         /* cmp eax, [ebp-0x18] */
            ii(0x100e_8075, 2); if(jg(0x100e_8079, 0x2)) goto l_0x100e_8079; /* jg 0x100e8079 */
        l_0x100e_8077:
            ii(0x100e_8077, 2); jmp(0x100e_8084, 0xb); goto l_0x100e_8084; /* jmp 0x100e8084 */
        l_0x100e_8079:
            ii(0x100e_8079, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_807c, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
            ii(0x100e_807f, 3); cmp(eax, memd[ss, ebp - 0x10]);         /* cmp eax, [ebp-0x10] */
            ii(0x100e_8082, 2); if(jl(0x100e_8086, 0x2)) goto l_0x100e_8086; /* jl 0x100e8086 */
        l_0x100e_8084:
            ii(0x100e_8084, 2); jmp(0x100e_808c, 0x6); goto l_0x100e_808c; /* jmp 0x100e808c */
        l_0x100e_8086:
            ii(0x100e_8086, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x100e_808a, 2); jmp(0x100e_8092, 0x6); goto l_0x100e_8092; /* jmp 0x100e8092 */
        l_0x100e_808c:
            ii(0x100e_808c, 2); jmp(0x100e_8034, -0x5a); goto l_0x100e_8034; /* jmp 0x100e8034 */
        l_0x100e_808e:
            ii(0x100e_808e, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x100e_8092:
            ii(0x100e_8092, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
