...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_cd41()
        {
            ...
            ii(0x1007_cd58, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_cd5b, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1007_cd5e, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_cd61, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1007_cd6d, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1007_cd74, 5); jmp(0x1007_ce0b, 0x92); goto l_0x1007_ce0b; /* jmp 0x1007ce0b */
        l_0x1007_cd79:
            ii(0x1007_cd79, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_cd7c, 3); mov(al, memb[ds, eax + 0x4d]);          /* mov al, [eax+0x4d] */
            ...
            ii(0x1007_cd88, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1007_cd8f, 5); jmp(0x1007_ce0b, 0x77); goto l_0x1007_ce0b; /* jmp 0x1007ce0b */
        l_0x1007_cd94:
            ii(0x1007_cd94, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_cd97, 5); call(0x1007_623c, -0x6b60);             /* call 0x1007623c */
            ii(0x1007_cd9c, 3); mov(ecx, memd[ds, eax + 0x12]);         /* mov ecx, [eax+0x12] */
            ii(0x1007_cd9f, 3); sar(ecx, 0x10);                         /* sar ecx, 0x10 */
            ii(0x1007_cda2, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1007_cda4, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_cda7, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1007_cdb5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_cdb8, 5); call(0x1007_623c, -0x6b81);             /* call 0x1007623c */
            ii(0x1007_cdbd, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1007_cdc9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_cdcc, 3); mov(al, memb[ds, eax + 0x4d]);          /* mov al, [eax+0x4d] */
            ...
            ii(0x1007_cdde, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1007_cde1, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1007_cde5, 3); cmp(eax, 0x1);                          /* cmp eax, 0x1 */
            ii(0x1007_cde8, 2); if(jge(0x1007_cdf3, 0x9)) goto l_0x1007_cdf3; /* jge 0x1007cdf3 */
            ii(0x1007_cdea, 7); mov(memd[ss, ebp - 0xc], 0x1);          /* mov dword [ebp-0xc], 0x1 */
            ii(0x1007_cdf1, 2); jmp(0x1007_ce0b, 0x18); goto l_0x1007_ce0b; /* jmp 0x1007ce0b */
        l_0x1007_cdf3:
            ii(0x1007_cdf3, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1007_cdf7, 3); cmp(eax, 0x7);                          /* cmp eax, 0x7 */
            ii(0x1007_cdfa, 2); if(jle(0x1007_ce05, 0x9)) goto l_0x1007_ce05; /* jle 0x1007ce05 */
            ii(0x1007_cdfc, 7); mov(memd[ss, ebp - 0xc], 0x7);          /* mov dword [ebp-0xc], 0x7 */
            ii(0x1007_ce03, 2); jmp(0x1007_ce0b, 0x6); goto l_0x1007_ce0b; /* jmp 0x1007ce0b */
        l_0x1007_ce05:
            ii(0x1007_ce05, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1007_ce08, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
        l_0x1007_ce0b:
            ii(0x1007_ce0b, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
