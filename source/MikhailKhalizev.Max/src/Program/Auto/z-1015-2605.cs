...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_2605()
        {
            ...
            ii(0x1015_261c, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1015_261f, 3); mov(memb[ss, ebp - 4], dl);             /* mov [ebp-0x4], dl */
            ii(0x1015_2622, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1015_2625, 7); cmp(memb[ds, eax + 165], 0);            /* cmp byte [eax+0xa5], 0x0 */
            ii(0x1015_262c, 2); if(jz(0x1015_267d, 0x4f)) goto l_0x1015_267d; /* jz 0x1015267d */
            ii(0x1015_262e, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1015_2631, 5); add(eax, 0x94);                         /* add eax, 0x94 */
            ii(0x1015_2636, 5); call(0x1008_aef4, -0xc_7747);           /* call 0x1008aef4 */
            ii(0x1015_263b, 3); lea(ebx, memd[ss, ebp - 12]);           /* lea ebx, [ebp-0xc] */
            ...
            ii(0x1015_2647, 2); jmp(0x1015_2651, 8); goto l_0x1015_2651; /* jmp 0x10152651 */
        l_0x1015_2649:
            ii(0x1015_2649, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x1015_264c, 5); call(0x1007_6bf8, -0xd_ba59);           /* call 0x10076bf8 */
        l_0x1015_2651:
            ii(0x1015_2651, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_2653, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ...
            ii(0x1015_265f, 5); mov(edx, 1);                            /* mov edx, 0x1 */
            ii(0x1015_2664, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
        ...
        l_0x1015_2673:
            ...
            ii(0x1015_2675, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x1015_2678, 5); call(0x1008_8bbc, -0xc_9ac1);           /* call 0x10088bbc */
        l_0x1015_267d:
            ii(0x1015_267d, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x1015_2689, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1015_268c, 7); cmp(memb[ds, eax + 165], 0);            /* cmp byte [eax+0xa5], 0x0 */
            ii(0x1015_2693, 2); if(jnz(0x1015_2697, 2)) goto l_0x1015_2697; /* jnz 0x10152697 */
        l_0x1015_2695:
            ii(0x1015_2695, 2); jmp(0x1015_26a4, 0xd); goto l_0x1015_26a4; /* jmp 0x101526a4 */
        l_0x1015_2697:
            ii(0x1015_2697, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_2699, 3); mov(dl, memb[ss, ebp - 4]);             /* mov dl, [ebp-0x4] */
            ii(0x1015_269c, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
