...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_00d8()
        {
            ...
            ii(0x100e_00ef, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_00f2, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100e_00f5, 5); mov(ebx, 0x101b_5ec8);                  /* mov ebx, 0x101b5ec8 */
            ii(0x100e_00fa, 5); mov(edx, 0x4);                          /* mov edx, 0x4 */
            ii(0x100e_00ff, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_0102, 5); call(Definitions.sys_call_dtor_arr_v2, 0x8_5ed9); /* call 0x10165fe0 */
            ii(0x100e_0107, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100e_010a, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
