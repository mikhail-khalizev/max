...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_4e00()
        {
            ...
            ii(0x100d_4e17, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_4e1a, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_4e1d, 7);  test(memd[ss, ebp - 4], 4);           /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x100d_4e2b, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_4e3a:
            ii(0x100d_4e3a, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x100d_4e3f, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_4e42, 5);  call(0x100d_10b2, -0x3d95);           /* call 0x100d10b2 */
            ii(0x100d_4e47, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_4e4a, 7);  test(memd[ss, ebp - 4], 2);           /* test dword [ebp-0x4], 0x2 */
            ii(0x100d_4e51, 2);  if(jz(0x100d_4e5b, 8)) goto l_0x100d_4e5b;/* jz 0x100d4e5b */
            ii(0x100d_4e53, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_4e56, 5);  call(Definitions.sys_delete, 0x9_1109);/* call 0x10165f64 */
        l_0x100d_4e5b:
            ii(0x100d_4e5b, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_4e5e, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100d_4e61, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
