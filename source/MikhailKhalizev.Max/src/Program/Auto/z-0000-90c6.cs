...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_90c6()
        {
            ...
            ii(0x90cf, 3);    cmp(memw[ds, si + 0x2], ax);              /* cmp [si+0x2], ax */
            ...
            ii(0x90e1, 3);    mov(memw[ds, si + 0x2], ax);              /* mov [si+0x2], ax */
            ii(0x90e4, 2);    or(ax, ax);                               /* or ax, ax */
            ii(0x90e6, 2);    if(jg(0x90ed, 0x5)) goto l_0x90ed;        /* jg 0x90ed */
        ...
        l_0x90f1:
            ...
            ii(0x90f3, 3);    mov(al, memb[ds, bx + si + 0x4]);         /* mov al, [bx+si+0x4] */
            ii(0x90f6, 1);    cbw();                                    /* cbw */
