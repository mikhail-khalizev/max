...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_aaef()
        {
            ...
            ii(0x100d_ab05, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ...
            ii(0x100d_ab11, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x100d_ab14, 6); cmp(eax, memd[ds, edx + 837]);          /* cmp eax, [edx+0x345] */
            ...
            ii(0x100d_ab24, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ...
            ii(0x100d_ab2d, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x100d_ab30, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x100d_ab33, 4); cmp(ax, memw[ds, edx + 89]);            /* cmp ax, [edx+0x59] */
        ...
        l_0x100d_ab3b:
            ii(0x100d_ab3b, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100d_ab3e, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x100d_ab41, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x100d_ab44, 3); mov(ebx, memd[ds, eax + 19]);           /* mov ebx, [eax+0x13] */
            ii(0x100d_ab47, 4); movsx(edx, memw[ss, ebp - 20]);         /* movsx edx, word [ebp-0x14] */
            ii(0x100d_ab4b, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x100d_ab4e, 3); call_abs(memd[ds, ebx + 12]);           /* call dword [ebx+0xc] */
            ii(0x100d_ab51, 2); jmp(0x100d_ab69, 0x16); goto l_0x100d_ab69; /* jmp 0x100dab69 */
        l_0x100d_ab53:
            ii(0x100d_ab53, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100d_ab56, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x100d_ab59, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x100d_ab5c, 3); mov(ebx, memd[ds, eax + 19]);           /* mov ebx, [eax+0x13] */
            ii(0x100d_ab5f, 4); movsx(edx, memw[ss, ebp - 20]);         /* movsx edx, word [ebp-0x14] */
            ii(0x100d_ab63, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x100d_ab66, 3); call_abs(memd[ds, ebx + 8]);            /* call dword [ebx+0x8] */
        l_0x100d_ab69:
            ii(0x100d_ab69, 4); mov(memb[ss, ebp - 16], 1);             /* mov byte [ebp-0x10], 0x1 */
            ii(0x100d_ab6d, 2); jmp(0x100d_ab73, 4); goto l_0x100d_ab73; /* jmp 0x100dab73 */
        l_0x100d_ab6f:
            ii(0x100d_ab6f, 4); mov(memb[ss, ebp - 16], 0);             /* mov byte [ebp-0x10], 0x0 */
        l_0x100d_ab73:
            ii(0x100d_ab73, 3); mov(al, memb[ss, ebp - 16]);            /* mov al, [ebp-0x10] */
