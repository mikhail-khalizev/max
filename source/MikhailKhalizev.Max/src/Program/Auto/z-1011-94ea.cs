...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_94ea()
        {
            ...
            ii(0x1011_94ff, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1011_9502, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x1011_9505, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1011_9508, 3); mov(memd[ss, ebp - 0x8], ecx);          /* mov [ebp-0x8], ecx */
            ii(0x1011_950b, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1011_9528, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x1011_952c, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1011_952e, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1011_9531, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1011_954e, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1011_9552, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1011_9554, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1011_9557, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1011_9574, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x1011_9578, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1011_957a, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1011_957d, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1011_959c, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1011_95a0, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1011_95a2, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1011_95a5, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x1011_95c2, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x1011_95c6, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1011_95c8, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x1011_95cb, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1011_95e8, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1011_95ec, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1011_95ee, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ...
            ii(0x1011_95fd, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ...
            ii(0x1011_960d, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ...
            ii(0x1011_961c, 4); movsx(eax, memw[ss, ebp - 0x18]);       /* movsx eax, word [ebp-0x18] */
            ...
            ii(0x1011_962c, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ...
            ii(0x1011_963b, 4); movsx(eax, memw[ss, ebp - 0x1c]);       /* movsx eax, word [ebp-0x1c] */
            ...
            ii(0x1011_964b, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1011_964e, 5); mov(eax, memd[ds, 0x101b_8748]);        /* mov eax, [0x101b8748] */
            ii(0x1011_9653, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1011_9656, 3); lea(ebx, memd[ds, eax - 0x1]);          /* lea ebx, [eax-0x1] */
            ii(0x1011_9659, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_965b, 4); movsx(eax, memw[ss, ebp - 0x20]);       /* movsx eax, word [ebp-0x20] */
            ...
            ii(0x1011_966b, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1011_966e, 5); mov(eax, memd[ds, 0x101b_8746]);        /* mov eax, [0x101b8746] */
            ii(0x1011_9673, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1011_9676, 3); lea(ebx, memd[ds, eax - 0x1]);          /* lea ebx, [eax-0x1] */
            ii(0x1011_9679, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_967b, 4); movsx(eax, memw[ss, ebp - 0x24]);       /* movsx eax, word [ebp-0x24] */
            ...
            ii(0x1011_968b, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x1011_968e, 5); mov(eax, memd[ds, 0x101b_8748]);        /* mov eax, [0x101b8748] */
            ii(0x1011_9693, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1011_9696, 3); lea(ebx, memd[ds, eax - 0x1]);          /* lea ebx, [eax-0x1] */
            ii(0x1011_9699, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_969b, 4); movsx(eax, memw[ss, ebp - 0x28]);       /* movsx eax, word [ebp-0x28] */
            ...
            ii(0x1011_96ab, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ii(0x1011_96ae, 4); movsx(eax, memw[ss, ebp + 0x10]);       /* movsx eax, word [ebp+0x10] */
            ii(0x1011_96b2, 1); push(eax);                              /* push eax */
            ii(0x1011_96b3, 4); movsx(eax, memw[ss, ebp - 0x20]);       /* movsx eax, word [ebp-0x20] */
            ii(0x1011_96b7, 1); push(eax);                              /* push eax */
            ii(0x1011_96b8, 4); movsx(eax, memw[ss, ebp - 0x1c]);       /* movsx eax, word [ebp-0x1c] */
            ii(0x1011_96bc, 1); push(eax);                              /* push eax */
            ii(0x1011_96bd, 4); movsx(ecx, memw[ss, ebp - 0x18]);       /* movsx ecx, word [ebp-0x18] */
            ii(0x1011_96c1, 4); movsx(ebx, memw[ss, ebp - 0x14]);       /* movsx ebx, word [ebp-0x14] */
            ii(0x1011_96c5, 3); mov(edx, memd[ss, ebp - 0x10]);         /* mov edx, [ebp-0x10] */
            ii(0x1011_96c8, 3); mov(edx, memd[ds, edx + 0xe]);          /* mov edx, [edx+0xe] */
            ii(0x1011_96cb, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1011_96ce, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1011_96d1, 3); mov(eax, memd[ds, eax + 0x16]);         /* mov eax, [eax+0x16] */
            ii(0x1011_96d4, 5); call(/* sys */ 0x1016_a5a0, 0x5_0ec7);  /* call 0x1016a5a0 */
            ii(0x1011_96d9, 4); movsx(eax, memw[ss, ebp + 0x10]);       /* movsx eax, word [ebp+0x10] */
            ii(0x1011_96dd, 1); push(eax);                              /* push eax */
            ii(0x1011_96de, 4); movsx(eax, memw[ss, ebp - 0x28]);       /* movsx eax, word [ebp-0x28] */
            ii(0x1011_96e2, 1); push(eax);                              /* push eax */
            ii(0x1011_96e3, 4); movsx(eax, memw[ss, ebp - 0x24]);       /* movsx eax, word [ebp-0x24] */
            ii(0x1011_96e7, 1); push(eax);                              /* push eax */
            ii(0x1011_96e8, 4); movsx(ecx, memw[ss, ebp - 0x20]);       /* movsx ecx, word [ebp-0x20] */
            ii(0x1011_96ec, 4); movsx(ebx, memw[ss, ebp - 0x1c]);       /* movsx ebx, word [ebp-0x1c] */
            ii(0x1011_96f0, 3); mov(edx, memd[ss, ebp - 0x10]);         /* mov edx, [ebp-0x10] */
            ii(0x1011_96f3, 3); mov(edx, memd[ds, edx + 0xe]);          /* mov edx, [edx+0xe] */
            ii(0x1011_96f6, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1011_96f9, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1011_96fc, 3); mov(eax, memd[ds, eax + 0x16]);         /* mov eax, [eax+0x16] */
            ii(0x1011_96ff, 5); call(/* sys */ 0x1016_a5a0, 0x5_0e9c);  /* call 0x1016a5a0 */
            ii(0x1011_9704, 4); movsx(eax, memw[ss, ebp + 0x10]);       /* movsx eax, word [ebp+0x10] */
            ii(0x1011_9708, 1); push(eax);                              /* push eax */
            ii(0x1011_9709, 4); movsx(eax, memw[ss, ebp - 0x18]);       /* movsx eax, word [ebp-0x18] */
            ii(0x1011_970d, 1); push(eax);                              /* push eax */
            ii(0x1011_970e, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1011_9712, 1); push(eax);                              /* push eax */
            ii(0x1011_9713, 4); movsx(ecx, memw[ss, ebp - 0x28]);       /* movsx ecx, word [ebp-0x28] */
            ii(0x1011_9717, 4); movsx(ebx, memw[ss, ebp - 0x24]);       /* movsx ebx, word [ebp-0x24] */
            ii(0x1011_971b, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1011_971e, 3); mov(edx, memd[ds, eax + 0xe]);          /* mov edx, [eax+0xe] */
            ii(0x1011_9721, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1011_9724, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1011_9727, 3); mov(eax, memd[ds, eax + 0x16]);         /* mov eax, [eax+0x16] */
            ...
            ii(0x1011_9734, 3); ret(0x4);                               /* ret 0x4 */
        }
    }
}
