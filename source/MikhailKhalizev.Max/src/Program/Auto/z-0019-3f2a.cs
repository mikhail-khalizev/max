...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_3f2a()
        {
            ...
            ii(0x19_3f30, 3); mov(si, memw[ds, bx + 0x8]);              /* mov si, [bx+0x8] */
            ii(0x19_3f33, 3); mov(bx, memw[ds, bx + 0xa]);              /* mov bx, [bx+0xa] */
        ...
        l_0x19_3f3a:
            ...
            ii(0x19_3f42, 3); mov(si, memw[ds, bx + 0x6]);              /* mov si, [bx+0x6] */
            ii(0x19_3f45, 3); mov(bx, memw[ds, bx + 0x8]);              /* mov bx, [bx+0x8] */
        ...
        l_0x19_3f52:
            ii(0x19_3f52, 3); lea(dx, memw[ds, si - 0x2]);              /* lea dx, [si-0x2] */
        ...
        l_0x19_3f64:
            ...
            ii(0x19_3f7b, 3); mov(memw[ds, si - 0x2], ax);              /* mov [si-0x2], ax */
        ...
        l_0x19_3f83:
            ii(0x19_3f83, 3); mov(ax, memw[ds, bx + 0x6]);              /* mov ax, [bx+0x6] */
            ii(0x19_3f86, 3); mov(memw[ds, bx + 0x8], ax);              /* mov [bx+0x8], ax */
            ii(0x19_3f89, 1); stc();                                    /* stc */
            ii(0x19_3f8a, 2); jmp(0x19_3fa5, 0x19); goto l_0x19_3fa5;   /* jmp 0x3fa5 */
        l_0x19_3f8c:
            ii(0x19_3f8c, 1); pop(bx);                                  /* pop bx */
            ii(0x19_3f8d, 3); mov(memw[ds, si - 0x2], cx);              /* mov [si-0x2], cx */
            ii(0x19_3f90, 2); if(jz(0x19_3f9b, 0x9)) goto l_0x19_3f9b;  /* jz 0x3f9b */
        ...
        l_0x19_3f9b:
            ...
            ii(0x19_3f9d, 3); mov(memw[ds, bx + 0x8], di);              /* mov [bx+0x8], di */
