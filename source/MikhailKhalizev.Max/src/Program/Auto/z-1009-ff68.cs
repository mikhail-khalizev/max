...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_ff68()
        {
            ...
            ii(0x1009_ff7f, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_ff82, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1009_ff85, 7); test(memd[ss, ebp - 0x4], 0x4);         /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x1009_ff93, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1009_ffa2:
            ...
            ii(0x1009_ffa7, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_ffaa, 5); call(0x1009_fdbc, -0x1f3);              /* call 0x1009fdbc */
            ii(0x1009_ffaf, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_ffb2, 7); test(memd[ss, ebp - 0x4], 0x2);         /* test dword [ebp-0x4], 0x2 */
            ii(0x1009_ffb9, 2); if(jz(0x1009_ffc3, 0x8)) goto l_0x1009_ffc3; /* jz 0x1009ffc3 */
            ii(0x1009_ffbb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_ffbe, 5); call(Definitions.sys_delete, 0xc_5fa1); /* call 0x10165f64 */
        l_0x1009_ffc3:
            ii(0x1009_ffc3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_ffc6, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1009_ffc9, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
