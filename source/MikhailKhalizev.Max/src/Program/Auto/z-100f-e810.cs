...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_e810()
        {
            ...
            ii(0x100f_e81a, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x100f_e830, 2); if(jz(0x100f_e83b, 0x9)) goto l_0x100f_e83b; /* jz 0x100fe83b */
            ii(0x100f_e832, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x100f_e836, 5); call(0x100f_e1cd, -0x66e);              /* call 0x100fe1cd */
        l_0x100f_e83b:
            ii(0x100f_e83b, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
            ...
            ii(0x100f_e856, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x100f_e85a, 5); call(0x1007_1d59, -0x8_cb06);           /* call 0x10071d59 */
        l_0x100f_e85f:
            ii(0x100f_e85f, 4); cmp(memb[ss, ebp - 0x8], 0xa);          /* cmp byte [ebp-0x8], 0xa */
            ii(0x100f_e863, 2); if(jz(0x100f_e8a2, 0x3d)) goto l_0x100f_e8a2; /* jz 0x100fe8a2 */
            ii(0x100f_e865, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
        ...
        l_0x100f_e88f:
            ii(0x100f_e88f, 7); cmp(memd[ds, 0x101c_37dc], 0x1);        /* cmp dword [0x101c37dc], 0x1 */
