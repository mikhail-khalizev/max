...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("d5f670d2-4513-49fe-816b-8e2549b066c8")]
        public void Method_0001_2130()
        {
            ...
            ii(0x1_2144, 1);  popw(ds);                                 /* pop ds */
            ii(0x1_2145, 3);  shr(bx, 0x3);                             /* shr bx, 0x3 */
            ii(0x1_2148, 2);  mov(memb_a16[ds, bx], al);                /* mov [bx], al */
            ii(0x1_214a, 4);  mov(cx, memw_a32[ss, ebp + 0]);           /* mov cx, [ebp] */
            ii(0x1_214e, 3);  shr(cx, 0x3);                             /* shr cx, 0x3 */
            ii(0x1_2151, 2);  xor(cx, bx);                              /* xor cx, bx */
            ii(0x1_2153, 4);  if(jnzw(0x1_215b, 0x4)) goto l_0x1_215b;  /* jnz 0x215b */
            ii(0x1_2157, 4);  mov(memw_a32[ss, ebp + 0], cx);           /* mov [ebp], cx */
        l_0x1_215b:
            ii(0x1_215b, 4);  mov(cx, memw_a32[ss, ebp + 0x2]);         /* mov cx, [ebp+0x2] */
            ii(0x1_215f, 3);  shr(cx, 0x3);                             /* shr cx, 0x3 */
            ii(0x1_2162, 2);  xor(cx, bx);                              /* xor cx, bx */
            ii(0x1_2164, 4);  if(jnzw(0x1_216c, 0x4)) goto l_0x1_216c;  /* jnz 0x216c */
            ii(0x1_2168, 4);  mov(memw_a32[ss, ebp + 0x2], cx);         /* mov [ebp+0x2], cx */
        l_0x1_216c:
            ii(0x1_216c, 2);  mov(cx, fs);                              /* mov cx, fs */
            ii(0x1_216e, 3);  shr(cx, 0x3);                             /* shr cx, 0x3 */
            ii(0x1_2171, 2);  xor(cx, bx);                              /* xor cx, bx */
            ii(0x1_2173, 4);  if(jnzw(0x1_2179, 0x2)) goto l_0x1_2179;  /* jnz 0x2179 */
            ii(0x1_2177, 2);  mov(fs, cx);                              /* mov fs, cx */
        l_0x1_2179:
            ii(0x1_2179, 2);  mov(cx, gs);                              /* mov cx, gs */
            ii(0x1_217b, 3);  shr(cx, 0x3);                             /* shr cx, 0x3 */
