...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_c5f2()
        {
            ...
            ii(0x1007_c609, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1007_c60c, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1007_c60f, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1007_c612, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_c620, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x1007_c62d, 2); if(jz(0x1007_c631, 2)) goto l_0x1007_c631; /* jz 0x1007c631 */
        l_0x1007_c62f:
            ii(0x1007_c62f, 2); jmp(0x1007_c640, 0xf); goto l_0x1007_c640; /* jmp 0x1007c640 */
        l_0x1007_c631:
            ii(0x1007_c631, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1007_c634, 3); mov(al, memb[ds, eax + 78]);            /* mov al, [eax+0x4e] */
            ii(0x1007_c637, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x1007_c63c, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1007_c63e, 2); if(jnz(0x1007_c649, 9)) goto l_0x1007_c649; /* jnz 0x1007c649 */
        l_0x1007_c640:
            ii(0x1007_c640, 4); mov(memb[ss, ebp - 12], 0);             /* mov byte [ebp-0xc], 0x0 */
            ii(0x1007_c644, 5); jmp(0x1007_c6c0, 0x77); goto l_0x1007_c6c0; /* jmp 0x1007c6c0 */
        l_0x1007_c649:
            ii(0x1007_c649, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_c64b, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x1007_c65a, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1007_c65d, 5); call(0x1007_623c, -0x6426);             /* call 0x1007623c */
            ii(0x1007_c662, 3); mov(edx, memd[ds, eax + 18]);           /* mov edx, [eax+0x12] */
            ii(0x1007_c665, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1007_c668, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1007_c66b, 3); mov(al, memb[ds, eax + 84]);            /* mov al, [eax+0x54] */
        ...
        l_0x1007_c677:
            ii(0x1007_c677, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1007_c67a, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x1007_c68e, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1007_c691, 5); mov(eax, 0x101c_3180);                  /* mov eax, 0x101c3180 */
            ii(0x1007_c696, 5); call(0x100a_53ac, 0x2_8d11);            /* call 0x100a53ac */
            ii(0x1007_c69b, 4); mov(memb[ss, ebp - 12], 0);             /* mov byte [ebp-0xc], 0x0 */
            ii(0x1007_c69f, 2); jmp(0x1007_c6c0, 0x1f); goto l_0x1007_c6c0; /* jmp 0x1007c6c0 */
        l_0x1007_c6a1:
            ii(0x1007_c6a1, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1007_c6a4, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x1007_c6a7, 5); call(0x1008_afb4, 0xe908);              /* call 0x1008afb4 */
            ii(0x1007_c6ac, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1007_c6af, 3); mov(ebx, memd[ss, ebp - 4]);            /* mov ebx, [ebp-0x4] */
            ii(0x1007_c6b2, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1007_c6b5, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1007_c6b8, 5); call(0x1008_58d6, 0x9219);              /* call 0x100858d6 */
            ii(0x1007_c6bd, 3); mov(memb[ss, ebp - 12], al);            /* mov [ebp-0xc], al */
        l_0x1007_c6c0:
            ii(0x1007_c6c0, 3); mov(al, memb[ss, ebp - 12]);            /* mov al, [ebp-0xc] */
