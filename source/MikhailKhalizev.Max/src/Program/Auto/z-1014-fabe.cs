...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_fabe()
        {
            ...
            ii(0x1014_fad5, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_fad8, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_fadb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_fade, 7); cmp(memd[ds, eax + 0xa7], 0);           /* cmp dword [eax+0xa7], 0x0 */
            ii(0x1014_fae5, 2); if(jz(0x1014_faf5, 0xe)) goto l_0x1014_faf5; /* jz 0x1014faf5 */
            ii(0x1014_fae7, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_faea, 6); mov(eax, memd[ds, eax + 0xa7]);         /* mov eax, [eax+0xa7] */
            ii(0x1014_faf0, 5); call(Definitions.sys_delete, 0x1_646f); /* call 0x10165f64 */
        l_0x1014_faf5:
            ii(0x1014_faf5, 4); cmp(memd[ss, ebp - 0x4], 0);            /* cmp dword [ebp-0x4], 0x0 */
            ii(0x1014_faf9, 2); if(jz(0x1014_fb07, 0xc)) goto l_0x1014_fb07; /* jz 0x1014fb07 */
            ii(0x1014_fafb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1014_fb07:
            ii(0x1014_fb07, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_fb0a, 10); mov(memd[ds, eax + 0xa7], 0);          /* mov dword [eax+0xa7], 0x0 */
            ii(0x1014_fb14, 2); jmp(0x1014_fb40, 0x2a); goto l_0x1014_fb40; /* jmp 0x1014fb40 */
        l_0x1014_fb16:
            ii(0x1014_fb16, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_fb26, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_fb29, 6); mov(memd[ds, eax + 0xa7], edx);         /* mov [eax+0xa7], edx */
            ii(0x1014_fb2f, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_fb32, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_fb35, 6); mov(eax, memd[ds, eax + 0xa7]);         /* mov eax, [eax+0xa7] */
