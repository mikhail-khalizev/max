...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_1f17()
        {
            ...
            ii(0x1018_1f1d, 3); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1018_1f20, 3); mov(dl, memb[ss, ebp + 16]);            /* mov dl, [ebp+0x10] */
            ii(0x1018_1f23, 3); cmp(dl, 1);                             /* cmp dl, 0x1 */
            ii(0x1018_1f26, 2); if(jb(0x1018_1f59, 0x31)) goto l_0x1018_1f59; /* jb 0x10181f59 */
            ii(0x1018_1f28, 3); cmp(dl, 3);                             /* cmp dl, 0x3 */
            ii(0x1018_1f2b, 2); if(jbe(0x1018_1f34, 7)) goto l_0x1018_1f34; /* jbe 0x10181f34 */
            ii(0x1018_1f2d, 3); cmp(dl, 4);                             /* cmp dl, 0x4 */
        ...
        l_0x1018_1f34:
            ...
            ii(0x1018_1f3d, 3); lea(edx, memd[ss, ebp + 8]);            /* lea edx, [ebp+0x8] */
        ...
        l_0x1018_1f45:
            ...
            ii(0x1018_1f47, 3); fcomp(memq[ss, ebp + 8]);               /* fcomp qword [ebp+0x8] */
            ...
            ii(0x1018_1f51, 3); mov(memd[ss, ebp - 20], edx);           /* mov [ebp-0x14], edx */
            ii(0x1018_1f54, 3); mov(memd[ss, ebp - 16], edx);           /* mov [ebp-0x10], edx */
        ...
        l_0x1018_1f59:
            ...
            ii(0x1018_1f64, 3); cmp(edx, 6);                            /* cmp edx, 0x6 */
            ii(0x1018_1f67, 2); if(jnz(0x1018_1f78, 0xf)) goto l_0x1018_1f78; /* jnz 0x10181f78 */
            ii(0x1018_1f69, 2); fldz();                                 /* fldz */
            ii(0x1018_1f6b, 3); fcomp(memq[ss, ebp + 8]);               /* fcomp qword [ebp+0x8] */
            ii(0x1018_1f6e, 2); fnstsw(ax);                             /* fnstsw ax */
            ii(0x1018_1f70, 1); sahf();                                 /* sahf */
            ii(0x1018_1f71, 2); if(jbe(0x1018_1f78, 5)) goto l_0x1018_1f78; /* jbe 0x10181f78 */
            ii(0x1018_1f73, 3); or(dh, 0x11);                           /* or dh, 0x11 */
            ii(0x1018_1f76, 2); mov(ebx, edx);                          /* mov ebx, edx */
        l_0x1018_1f78:
            ii(0x1018_1f78, 3); lea(edx, memd[ss, ebp + 8]);            /* lea edx, [ebp+0x8] */
            ii(0x1018_1f7b, 2); mov(eax, ebx);                          /* mov eax, ebx */
        l_0x1018_1f7d:
            ii(0x1018_1f7d, 5); call(/* sys */ 0x1019_6628, 0x1_46a6);  /* call 0x10196628 */
            ii(0x1018_1f82, 3); fstp(memq[ss, ebp - 20]);               /* fstp qword [ebp-0x14] */
        l_0x1018_1f85:
            ii(0x1018_1f85, 3); fld(memq[ss, ebp - 20]);                /* fld qword [ebp-0x14] */
            ii(0x1018_1f88, 3); lea(esp, memd[ss, ebp - 12]);           /* lea esp, [ebp-0xc] */
