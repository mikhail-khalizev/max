...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("738b4925-92a1-4d65-ae4a-4431445ecf1f")]
        public void Method_100c_409c()
        {
            ii(0x100c_409c, 5); pushd(0x28);                            /* push 0x28 */
            ii(0x100c_40a1, 5); calld(Definitions.sys_check_available_stack_size, 0xa_1cac); /* call 0x10165d52 */
        ...
        l_0x100c_40c2:
            ii(0x100c_40c2, 5); calld(/* sys */ 0x1016_5e9b, 0xa_1dd4); /* call 0x10165e9b */
        ...
        l_0x100c_40dc:
            ii(0x100c_40dc, 5); calld(/* sys */ 0x1016_5e9b, 0xa_1dba); /* call 0x10165e9b */
        ...
        l_0x100c_40f6:
            ii(0x100c_40f6, 5); calld(/* sys */ 0x1016_5e9b, 0xa_1da0); /* call 0x10165e9b */
