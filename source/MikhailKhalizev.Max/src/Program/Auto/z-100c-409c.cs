...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_409c()
        {
            ...
            ii(0x100c_40b4, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_40b7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_40ba, 3); mov(al, memb[ds, eax + 0x2]);           /* mov al, [eax+0x2] */
            ii(0x100c_40bd, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
        ...
        l_0x100c_40c2:
            ...
            ii(0x100c_40cd, 3); lea(edx, memd[ds, eax + 0x7]);          /* lea edx, [eax+0x7] */
            ii(0x100c_40d0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_40d3, 4); mov(memw[ds, eax + 0x5], dx);           /* mov [eax+0x5], dx */
        ...
        l_0x100c_40dc:
            ...
            ii(0x100c_40e7, 3); lea(edx, memd[ds, eax + 0x4]);          /* lea edx, [eax+0x4] */
            ii(0x100c_40ea, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_40ed, 4); mov(memw[ds, eax + 0x5], dx);           /* mov [eax+0x5], dx */
        ...
        l_0x100c_40f6:
            ...
            ii(0x100c_4101, 3); lea(edx, memd[ds, eax + 0x1]);          /* lea edx, [eax+0x1] */
            ii(0x100c_4104, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_4107, 4); mov(memw[ds, eax + 0x5], dx);           /* mov [eax+0x5], dx */
            ii(0x100c_410b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_410e, 6); mov(memw[ds, eax + 0x5], 0x5);          /* mov word [eax+0x5], 0x5 */
            ii(0x100c_4114, 2); jmp(0x100c_4159, 0x43); goto l_0x100c_4159; /* jmp 0x100c4159 */
        l_0x100c_4116:
            ii(0x100c_4116, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_4119, 6); mov(memw[ds, eax + 0x5], 0);            /* mov word [eax+0x5], 0x0 */
            ii(0x100c_411f, 2); jmp(0x100c_4159, 0x38); goto l_0x100c_4159; /* jmp 0x100c4159 */
        l_0x100c_4121:
            ii(0x100c_4121, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x100c_4124, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x100c_4127, 4); cmp(memb[ss, ebp - 0xc], 0x3);          /* cmp byte [ebp-0xc], 0x3 */
            ii(0x100c_412b, 2); if(jb(0x100c_4145, 0x18)) goto l_0x100c_4145; /* jb 0x100c4145 */
            ii(0x100c_412d, 4); cmp(memb[ss, ebp - 0xc], 0x4);          /* cmp byte [ebp-0xc], 0x4 */
            ii(0x100c_4131, 2); if(jbe(0x100c_40c2, -0x71)) goto l_0x100c_40c2; /* jbe 0x100c40c2 */
            ii(0x100c_4133, 4); cmp(memb[ss, ebp - 0xc], 0x6);          /* cmp byte [ebp-0xc], 0x6 */
            ii(0x100c_4137, 2); if(jbe(0x100c_40f6, -0x43)) goto l_0x100c_40f6; /* jbe 0x100c40f6 */
            ii(0x100c_4139, 4); cmp(memb[ss, ebp - 0xc], 0x9);          /* cmp byte [ebp-0xc], 0x9 */
        ...
        l_0x100c_4145:
            ii(0x100c_4145, 4); cmp(memb[ss, ebp - 0xc], 0x1);          /* cmp byte [ebp-0xc], 0x1 */
            ii(0x100c_4149, 2); if(jb(0x100c_4157, 0xc)) goto l_0x100c_4157; /* jb 0x100c4157 */
            ii(0x100c_414b, 4); cmp(memb[ss, ebp - 0xc], 0x1);          /* cmp byte [ebp-0xc], 0x1 */
