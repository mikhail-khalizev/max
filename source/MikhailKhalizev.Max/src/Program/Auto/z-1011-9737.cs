...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_9737()
        {
            ...
            ii(0x1011_9752, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1011_9755, 3); mov(memd[ss, ebp - 0x4], ecx);          /* mov [ebp-0x4], ecx */
            ii(0x1011_9758, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1011_975c, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1011_975e, 2); if(jz(0x1011_9769, 0x9)) goto l_0x1011_9769; /* jz 0x10119769 */
            ii(0x1011_9760, 7); cmp(memb[ds, 0x101c_37cc], 0);          /* cmp byte [0x101c37cc], 0x0 */
            ii(0x1011_9767, 2); if(jnz(0x1011_976e, 0x5)) goto l_0x1011_976e; /* jnz 0x1011976e */
        l_0x1011_9769:
        ...
        l_0x1011_976e:
            ...
            ii(0x1011_97a3, 4); mov(ax, memw[ds, eax + 0x2]);           /* mov ax, [eax+0x2] */
            ...
            ii(0x1011_97c4, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1011_97c8, 5); call(Definitions.my_min, -0x9_0049);    /* call 0x10089784 */
            ii(0x1011_97cd, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_97d0, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1011_97f3, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1011_97f7, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1011_97f9, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1011_97fc, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1011_980e, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x1011_982a, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1011_984b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_984e, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
        l_0x1011_9851:
            ii(0x1011_9851, 3); dec(memd[ss, ebp - 0x1c]);              /* dec dword [ebp-0x1c] */
            ii(0x1011_9854, 5); cmp(memw[ss, ebp - 0x1c], -0x1 /* 0xff */); /* cmp word [ebp-0x1c], 0xffff */
            ...
            ii(0x1011_9879, 2); if(jl(0x1011_987d, 0x2)) goto l_0x1011_987d; /* jl 0x1011987d */
        l_0x1011_987b:
        ...
        l_0x1011_987d:
            ...
            ii(0x1011_9886, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
