...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_cc9f()
        {
            ...
            ii(0x1009_ccb1, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1009_ccb7, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1009_ccba, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1009_ccbd, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1009_ccc0, 5); call(0x1007_6338, -0x2_698d);           /* call 0x10076338 */
            ii(0x1009_ccc5, 3); lea(ebx, memd[ss, ebp - 8]);            /* lea ebx, [ebp-0x8] */
            ...
            ii(0x1009_ccd1, 2); jmp(0x1009_ccdb, 8); goto l_0x1009_ccdb; /* jmp 0x1009ccdb */
        l_0x1009_ccd3:
            ii(0x1009_ccd3, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
            ii(0x1009_ccd6, 5); call(0x1007_6bf8, -0x2_60e3);           /* call 0x10076bf8 */
        l_0x1009_ccdb:
            ii(0x1009_ccdb, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_ccdd, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
            ...
            ii(0x1009_ccf2, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
        ...
        l_0x1009_cd08:
            ii(0x1009_cd08, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_cd15, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1009_cd18, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x1009_cd1b, 5); call(0x1008_afe4, -0x1_1d3c);           /* call 0x1008afe4 */
            ii(0x1009_cd20, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ...
            ii(0x1009_cd2f, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
