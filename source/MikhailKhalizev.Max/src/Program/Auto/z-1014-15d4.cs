...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("761b9533-c797-4ba2-be35-a3d7a1e8e685")]
        public void Method_1014_15d4()
        {
            ii(0x1014_15d4, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x1014_15d9, 5); calld(Definitions.sys_check_available_stack_size, 0x2_4774); /* call 0x10165d52 */
            ...
            ii(0x1014_15f8, 5); calld(0x100a_b494, -0x9_6169);          /* call 0x100ab494 */
