...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_6722()
        {
            ...
            ii(0x1014_673a, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_673d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_6740, 4); cmp(memd[ds, eax + 0x1c], -0x1 /* 0xff */); /* cmp dword [eax+0x1c], 0xffffffff */
            ii(0x1014_6744, 6); if(jz(0x1014_6817, 0xcd)) goto l_0x1014_6817; /* jz 0x10146817 */
            ii(0x1014_674a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_6757, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_675a, 4); cmp(dx, memw[ds, eax + 0x1a]);          /* cmp dx, [eax+0x1a] */
            ii(0x1014_675e, 6); if(jg(0x1014_67f1, 0x8d)) goto l_0x1014_67f1; /* jg 0x101467f1 */
            ii(0x1014_6764, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_6767, 3); inc(memd[ds, eax + 0x16]);              /* inc dword [eax+0x16] */
            ii(0x1014_676a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_676d, 6); mov(memw[ds, eax + 0x1a], 0);           /* mov word [eax+0x1a], 0x0 */
            ii(0x1014_6773, 5); mov(edx, StringDefinitions.Empty11);    /* mov edx, 0x101ad020 */
            ii(0x1014_6778, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_677b, 3); add(eax, 0x12);                         /* add eax, 0x12 */
            ii(0x1014_677e, 5); call(0x1014_21cb, -0x45b8);             /* call 0x101421cb */
            ii(0x1014_6783, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_6786, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1014_6788, 5); call(/* sys */ 0x1017_1f05, 0x2_b778);  /* call 0x10171f05 */
            ii(0x1014_678d, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x1014_6790:
            ii(0x1014_6790, 4); cmp(memd[ss, ebp - 0x8], 0xa);          /* cmp dword [ebp-0x8], 0xa */
            ii(0x1014_6794, 2); if(jz(0x1014_679c, 0x6)) goto l_0x1014_679c; /* jz 0x1014679c */
            ii(0x1014_6796, 4); cmp(memd[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp dword [ebp-0x8], 0xffffffff */
            ii(0x1014_679a, 2); if(jnz(0x1014_679e, 0x2)) goto l_0x1014_679e; /* jnz 0x1014679e */
        l_0x1014_679c:
            ii(0x1014_679c, 2); jmp(0x1014_67bd, 0x1f); goto l_0x1014_67bd; /* jmp 0x101467bd */
        l_0x1014_679e:
            ii(0x1014_679e, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_67a0, 3); mov(dl, memb[ss, ebp - 0x8]);           /* mov dl, [ebp-0x8] */
            ii(0x1014_67a3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_67a6, 3); add(eax, 0x12);                         /* add eax, 0x12 */
            ii(0x1014_67a9, 5); call(Definitions.my_string_append_char, -0x49c4); /* call 0x10141dea */
            ii(0x1014_67ae, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_67b1, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1014_67b3, 5); call(/* sys */ 0x1017_1f05, 0x2_b74d);  /* call 0x10171f05 */
            ii(0x1014_67b8, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_67bb, 2); jmp(0x1014_6790, -0x2d); goto l_0x1014_6790; /* jmp 0x10146790 */
        l_0x1014_67bd:
            ii(0x1014_67bd, 4); cmp(memd[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp dword [ebp-0x8], 0xffffffff */
            ii(0x1014_67c1, 2); if(jz(0x1014_67d5, 0x12)) goto l_0x1014_67d5; /* jz 0x101467d5 */
            ii(0x1014_67c3, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_67c5, 3); mov(dl, memb[ss, ebp - 0x8]);           /* mov dl, [ebp-0x8] */
            ii(0x1014_67c8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1014_67d5:
            ii(0x1014_67d5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_67e5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_67e8, 7); mov(memd[ds, eax + 0x1c], 0xffff_ffff); /* mov dword [eax+0x1c], 0xffffffff */
            ii(0x1014_67ef, 2); jmp(0x1014_6817, 0x26); goto l_0x1014_6817; /* jmp 0x10146817 */
        l_0x1014_67f1:
            ii(0x1014_67f1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_67f4, 4); mov(dx, memw[ds, eax + 0x1a]);          /* mov dx, [eax+0x1a] */
            ii(0x1014_67f8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_67fb, 4); inc(memw[ds, eax + 0x1a]);              /* inc word [eax+0x1a] */
            ii(0x1014_67ff, 3); movsx(edx, dx);                         /* movsx edx, dx */
            ii(0x1014_6802, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_6811, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_6814, 3); mov(memd[ds, eax + 0x1c], edx);         /* mov [eax+0x1c], edx */
        l_0x1014_6817:
