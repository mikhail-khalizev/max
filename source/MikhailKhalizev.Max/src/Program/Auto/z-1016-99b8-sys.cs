...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_99b8()
        {
            ...
            ii(0x1016_99c3, 4); mov(memd[ss, esp + 0x4], ecx);          /* mov [esp+0x4], ecx */
        ...
        l_0x1016_99eb:
            ...
            ii(0x1016_99f9, 7); lea(edi, memd[ds, ebp * 4 + 0]);        /* lea edi, [ebp*4] */
        ...
        l_0x1016_9a02:
            ...
            ii(0x1016_9a1d, 3); mov(memd[ds, eax + 0x68], edx);         /* mov [eax+0x68], edx */
            ii(0x1016_9a20, 4); test(memb[ds, eax + 0x6], 0x2);         /* test byte [eax+0x6], 0x2 */
            ii(0x1016_9a24, 2); if(jz(0x1016_9a2c, 0x6)) goto l_0x1016_9a2c; /* jz 0x10169a2c */
        ...
        l_0x1016_9a36:
            ...
            ii(0x1016_9a45, 4); mov(eax, memd[ss, esp + 0x4]);          /* mov eax, [esp+0x4] */
