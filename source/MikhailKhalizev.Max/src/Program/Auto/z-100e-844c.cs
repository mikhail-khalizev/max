...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_844c()
        {
            ...
            ii(0x100e_8463, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_8466, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100e_8469, 7);  test(memd[ss, ebp - 4], 4);           /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x100e_8477, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100e_8486:
            ii(0x100e_8486, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x100e_848b, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_848e, 5);  call(0x100c_d916, -0x1_ab7d);         /* call 0x100cd916 */
            ii(0x100e_8493, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_8496, 7);  test(memd[ss, ebp - 4], 2);           /* test dword [ebp-0x4], 0x2 */
            ii(0x100e_849d, 2);  if(jz(0x100e_84a7, 8)) goto l_0x100e_84a7;/* jz 0x100e84a7 */
            ii(0x100e_849f, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_84a2, 5);  call(Definitions.sys_delete, 0x7_dabd);/* call 0x10165f64 */
        l_0x100e_84a7:
            ii(0x100e_84a7, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_84aa, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100e_84ad, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
