...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_2ff9()
        {
            ...
            ii(0x1010_3010, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_3013, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1010_3016, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_3019, 5);  call(0x1007_6338, -0x8_cce6);         /* call 0x10076338 */
            ii(0x1010_301e, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1010_3020, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x1010_3023, 5);  call(0x1007_64b8, -0x8_cb70);         /* call 0x100764b8 */
        l_0x1010_3028:
            ii(0x1010_3028, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1010_302a, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ...
            ii(0x1010_3036, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ...
            ii(0x1010_3045, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_3048, 5);  call(0x1014_756a, 0x4_451d);          /* call 0x1014756a */
            ii(0x1010_304d, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
        ...
        l_0x1010_3057:
            ...
            ii(0x1010_3059, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
