...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_f29e()
        {
            ...
            ii(0x1009_f2b4, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1009_f2b7, 3);  mov(memd[ss, ebp - 8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1009_f2ba, 3);  mov(memd[ss, ebp - 4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1009_f2bd, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_f2c0, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x1009_f2c3, 5);  call(0x1007_5e64, -0x2_9464);         /* call 0x10075e64 */
            ii(0x1009_f2c8, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1009_f2ca, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1009_f2cd, 3);  mov(eax, memd[ds, eax + 7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1009_f2e8, 2);  if(jg(0x1009_f2f0, 6)) goto l_0x1009_f2f0;/* jg 0x1009f2f0 */
            ii(0x1009_f2ea, 4);  mov(memb[ss, ebp - 16], 1);           /* mov byte [ebp-0x10], 0x1 */
            ii(0x1009_f2ee, 2);  jmp(0x1009_f2f4, 4); goto l_0x1009_f2f4;/* jmp 0x1009f2f4 */
        l_0x1009_f2f0:
            ii(0x1009_f2f0, 4);  mov(memb[ss, ebp - 16], 0);           /* mov byte [ebp-0x10], 0x0 */
        l_0x1009_f2f4:
            ii(0x1009_f2f4, 3);  mov(al, memb[ss, ebp - 16]);          /* mov al, [ebp-0x10] */
            ii(0x1009_f2f7, 3);  mov(memb[ss, ebp - 20], al);          /* mov [ebp-0x14], al */
            ii(0x1009_f2fa, 3);  mov(al, memb[ss, ebp - 20]);          /* mov al, [ebp-0x14] */
