...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("4642a11a-5178-4e6c-8833-4f5fb350559a")]
        public void Method_0000_a02b()
        {
            ii(0xa02b, 3);    callw(0x49ad, -0x5681);                   /* call 0x49ad */
            ii(0xa02e, 4);    mov(memb_a16[ds, 0x35], cl);              /* mov [0x35], cl */
            ii(0xa032, 4);    mov(memb_a16[ds, 0x37], cl);              /* mov [0x37], cl */
            ii(0xa036, 3);    callw(0x6d43, -0x32f6);                   /* call 0x6d43 */
            ii(0xa039, 5);    cmp(memb_a16[ds, 0x2e], 0);               /* cmp byte [0x2e], 0x0 */
            ii(0xa03e, 2);    if(jzw(0xa063, 0x23)) goto l_0xa063;      /* jz 0xa063 */
            ii(0xa040, 3);    callw(0x573a, -0x4909);                   /* call 0x573a */
            ii(0xa043, 5);    cmp(memb_a16[ds, 0x2e], 0xa);             /* cmp byte [0x2e], 0xa */
            ii(0xa048, 2);    if(jnzw(0xa04d, 0x3)) goto l_0xa04d;      /* jnz 0xa04d */
            ii(0xa04a, 3);    callw(0xa257, 0x20a);                     /* call 0xa257 */
        l_0xa04d:
            ii(0xa04d, 5);    cmp(memb_a16[ds, 0x2e], 0x9);             /* cmp byte [0x2e], 0x9 */
            ii(0xa052, 2);    if(jnzw(0xa057, 0x3)) goto l_0xa057;      /* jnz 0xa057 */
            ii(0xa054, 3);    callw(0xa1bd, 0x166);                     /* call 0xa1bd */
        l_0xa057:
            ii(0xa057, 3);    callw(0x3f0c, -0x614e);                   /* call 0x3f0c */
        ...
        l_0xa063:
            ...
            ii(0xa092, 3);    if(jmpw_func(0x3ff1, -0x60a4)) return;    /* jmp 0x3ff1 */
        l_0xa095:
