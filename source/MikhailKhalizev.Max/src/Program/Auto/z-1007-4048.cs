...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_4048()
        {
            ...
            ii(0x1007_405e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_4061, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ...
            ii(0x1007_4070, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x1007_4074, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1007_4088, 7); mov(memd[ss, ebp - 0x10], 0x1);         /* mov dword [ebp-0x10], 0x1 */
            ii(0x1007_408f, 5); jmp(0x1007_4108, 0x74); goto l_0x1007_4108; /* jmp 0x10074108 */
        l_0x1007_4094:
            ii(0x1007_4094, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_4097, 1); inc(eax);                               /* inc eax */
            ii(0x1007_4098, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1007_409b, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1007_40ac, 2); if(jnz(0x1007_40b7, 0x9)) goto l_0x1007_40b7; /* jnz 0x100740b7 */
            ii(0x1007_40ae, 7); mov(memd[ss, ebp - 0x10], 0x1);         /* mov dword [ebp-0x10], 0x1 */
            ii(0x1007_40b5, 2); jmp(0x1007_4108, 0x51); goto l_0x1007_4108; /* jmp 0x10074108 */
        l_0x1007_40b7:
            ii(0x1007_40b7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_40ba, 1); inc(eax);                               /* inc eax */
            ii(0x1007_40bb, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1007_40be, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1007_40d0, 2); if(jnz(0x1007_40db, 0x9)) goto l_0x1007_40db; /* jnz 0x100740db */
            ii(0x1007_40d2, 7); mov(memd[ss, ebp - 0x10], 0x1);         /* mov dword [ebp-0x10], 0x1 */
            ii(0x1007_40d9, 2); jmp(0x1007_4108, 0x2d); goto l_0x1007_4108; /* jmp 0x10074108 */
        l_0x1007_40db:
            ii(0x1007_40db, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x1007_40df, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1007_40f0, 2); if(jnz(0x1007_40fb, 0x9)) goto l_0x1007_40fb; /* jnz 0x100740fb */
            ii(0x1007_40f2, 7); mov(memd[ss, ebp - 0x14], 0x1);         /* mov dword [ebp-0x14], 0x1 */
            ii(0x1007_40f9, 2); jmp(0x1007_4102, 0x7); goto l_0x1007_4102; /* jmp 0x10074102 */
        l_0x1007_40fb:
