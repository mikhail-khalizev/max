...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_4048()
        {
            ...
            ii(0x1007_4064, 3); mov(memd[ss, ebp - 12], ebx);           /* mov [ebp-0xc], ebx */
            ii(0x1007_4067, 7); test(memd[ss, ebp - 12], 0x10);         /* test dword [ebp-0xc], 0x10 */
            ...
            ii(0x1007_4088, 7); mov(memd[ss, ebp - 16], 1);             /* mov dword [ebp-0x10], 0x1 */
        ...
        l_0x1007_4094:
            ...
            ii(0x1007_40ae, 7); mov(memd[ss, ebp - 16], 1);             /* mov dword [ebp-0x10], 0x1 */
        ...
        l_0x1007_40b7:
            ...
            ii(0x1007_40d2, 7); mov(memd[ss, ebp - 16], 1);             /* mov dword [ebp-0x10], 0x1 */
        ...
        l_0x1007_40db:
            ...
            ii(0x1007_40f2, 7); mov(memd[ss, ebp - 20], 1);             /* mov dword [ebp-0x14], 0x1 */
            ii(0x1007_40f9, 2); jmp(0x1007_4102, 7); goto l_0x1007_4102; /* jmp 0x10074102 */
        l_0x1007_40fb:
            ii(0x1007_40fb, 7); mov(memd[ss, ebp - 20], 0);             /* mov dword [ebp-0x14], 0x0 */
        l_0x1007_4102:
            ii(0x1007_4102, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x1007_4105, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
        l_0x1007_4108:
            ii(0x1007_4108, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
