...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_31d0()
        {
            ...
            ii(0x1013_31e8, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1013_31eb, 4); or(memb[ss, ebp - 8], 1);               /* or byte [ebp-0x8], 0x1 */
            ii(0x1013_31ef, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_31f2, 3); mov(al, memb[ds, eax + 38]);            /* mov al, [eax+0x26] */
            ii(0x1013_31f5, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1013_31f7, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1013_31fa, 6); lea(eax, memd[ss, ebp - 304]);          /* lea eax, [ebp-0x130] */
            ii(0x1013_3200, 5); call(0x1013_28d2, -0x933);              /* call 0x101328d2 */
            ii(0x1013_3205, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1013_3208, 4); and(memb[ss, ebp - 8], -2 /* 0xfe */);  /* and byte [ebp-0x8], 0xfe */
            ii(0x1013_320c, 6); lea(eax, memd[ss, ebp - 304]);          /* lea eax, [ebp-0x130] */
            ii(0x1013_3212, 5); call(0x1013_2f1a, -0x2fd);              /* call 0x10132f1a */
            ii(0x1013_3217, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_3219, 6); lea(eax, memd[ss, ebp - 304]);          /* lea eax, [ebp-0x130] */
