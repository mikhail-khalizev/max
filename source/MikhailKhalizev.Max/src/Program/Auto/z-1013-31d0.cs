...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_31d0()
        {
            ...
            ii(0x1013_31fa, 6); lea(eax, memd[ss, ebp - 0x130]);        /* lea eax, [ebp-0x130] */
            ...
            ii(0x1013_320c, 6); lea(eax, memd[ss, ebp - 0x130]);        /* lea eax, [ebp-0x130] */
            ii(0x1013_3212, 5); call(0x1013_2f1a, -0x2fd);              /* call 0x10132f1a */
            ii(0x1013_3217, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_3219, 6); lea(eax, memd[ss, ebp - 0x130]);        /* lea eax, [ebp-0x130] */
