...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_b9c2()
        {
            ...
            ii(0x1008_b9d8, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_b9db, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x1008_b9de, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ...
            ii(0x1008_b9f3, 2); jmp(0x1008_b9fd, 0x8); goto l_0x1008_b9fd; /* jmp 0x1008b9fd */
        l_0x1008_b9f5:
        ...
        l_0x1008_b9fd:
            ...
            ii(0x1008_ba18, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1008_ba28, 4); mov(ax, memw[ds, eax + 0x8]);           /* mov ax, [eax+0x8] */
            ii(0x1008_ba2c, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ii(0x1008_ba30, 2); if(jz(0x1008_ba34, 0x2)) goto l_0x1008_ba34; /* jz 0x1008ba34 */
        l_0x1008_ba32:
            ii(0x1008_ba32, 2); jmp(0x1008_ba44, 0x10); goto l_0x1008_ba44; /* jmp 0x1008ba44 */
        l_0x1008_ba34:
            ii(0x1008_ba34, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
