...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_b9c2()
        {
            ...
            ii(0x1008_b9db, 3); mov(memd[ss, ebp - 12], edx);           /* mov [ebp-0xc], edx */
            ii(0x1008_b9de, 3); mov(memd[ss, ebp - 4], ebx);            /* mov [ebp-0x4], ebx */
            ii(0x1008_b9e1, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1008_b9e4, 5); call(0x1007_6338, -0x1_56b1);           /* call 0x10076338 */
            ii(0x1008_b9e9, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1008_b9eb, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
        ...
        l_0x1008_b9f5:
            ii(0x1008_b9f5, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1008_b9f8, 5); call(0x1007_6bf8, -0x1_4e05);           /* call 0x10076bf8 */
        l_0x1008_b9fd:
            ii(0x1008_b9fd, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_b9ff, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ...
            ii(0x1008_ba0b, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1008_ba0e, 5); call(0x1007_63a0, -0x1_5673);           /* call 0x100763a0 */
            ii(0x1008_ba13, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_ba15, 3); mov(dl, memb[ds, eax + 38]);            /* mov dl, [eax+0x26] */
            ...
            ii(0x1008_ba20, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
        ...
        l_0x1008_ba34:
            ii(0x1008_ba34, 4); mov(memb[ss, ebp - 16], 1);             /* mov byte [ebp-0x10], 0x1 */
            ii(0x1008_ba38, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_ba3a, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
        ...
        l_0x1008_ba46:
            ii(0x1008_ba46, 4); mov(memb[ss, ebp - 16], 0);             /* mov byte [ebp-0x10], 0x0 */
            ii(0x1008_ba4a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_ba4c, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
        ...
        //  ii(0x1008_ba58, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
        //  ii(0x1008_ba5b, 5); call(0x1007_5f6c, -0x1_5af4);           /* call 0x10075f6c */
        l_0x1008_ba60:
            ii(0x1008_ba60, 3); mov(al, memb[ss, ebp - 16]);            /* mov al, [ebp-0x10] */
