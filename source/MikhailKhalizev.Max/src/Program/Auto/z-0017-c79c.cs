...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x17_c79c, 4); enter(4, 0);                              /* enter 0x4, 0x0 */
            ...
            ii(0x17_c7a8, 3); mov(memw[ss, bp - 2], ax);                /* mov [bp-0x2], ax */
            ii(0x17_c7ab, 3); mov(memw[ss, bp - 4], ax);                /* mov [bp-0x4], ax */
        l_0x17_c7ae:
            ii(0x17_c7ae, 3); mov(ax, memw[ss, bp - 4]);                /* mov ax, [bp-0x4] */
            ii(0x17_c7b1, 3); mov(dx, memw[ss, bp - 2]);                /* mov dx, [bp-0x2] */
            ii(0x17_c7b4, 4); cmp(memw[ds, 0x4fd2], dx);                /* cmp [0x4fd2], dx */
            ii(0x17_c7b8, 2); if(jb(0x17_c7ea, 0x30)) goto l_0x17_c7ea; /* jb 0xc7ea */
            ii(0x17_c7ba, 2); if(ja(0x17_c7c2, 6)) goto l_0x17_c7c2;    /* ja 0xc7c2 */
        ...
        l_0x17_c7c2:
            ...
            ii(0x17_c7cf, 3); add(sp, 8);                               /* add sp, 0x8 */
            ii(0x17_c7d2, 3); cmp(ax, memw[ss, bp + 6]);                /* cmp ax, [bp+0x6] */
            ii(0x17_c7d5, 2); if(jnz(0x17_c7e0, 9)) goto l_0x17_c7e0;   /* jnz 0xc7e0 */
            ii(0x17_c7d7, 3); mov(ax, memw[ss, bp - 4]);                /* mov ax, [bp-0x4] */
            ii(0x17_c7da, 3); mov(dx, memw[ss, bp - 2]);                /* mov dx, [bp-0x2] */
            ii(0x17_c7dd, 1); pop(ds);                                  /* pop ds */
            ii(0x17_c7de, 1); leave();                                  /* leave */
            ii(0x17_c7df, 1); retf(); return;                           /* retf */
        l_0x17_c7e0:
            ii(0x17_c7e0, 4); add(memw[ss, bp - 4], 1);                 /* add word [bp-0x4], 0x1 */
            ii(0x17_c7e4, 4); adc(memw[ss, bp - 2], 0);                 /* adc word [bp-0x2], 0x0 */
