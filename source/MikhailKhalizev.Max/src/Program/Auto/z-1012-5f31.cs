...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_5f31()
        {
            ...
            ii(0x1012_5f48, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_5f4b, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1012_5f4e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_5f51, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1012_5f54, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1012_5f57, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_5f5a, 5); call(0x1012_5e4e, -0x111);              /* call 0x10125e4e */
            ii(0x1012_5f5f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_5f62, 4); mov(dx, memw[ds, eax + 0x41]);          /* mov dx, [eax+0x41] */
            ii(0x1012_5f66, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1012_5f69, 4); mov(memw[ds, eax + 0x7], dx);           /* mov [eax+0x7], dx */
            ii(0x1012_5f6d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_5f70, 4); mov(dx, memw[ds, eax + 0x43]);          /* mov dx, [eax+0x43] */
            ii(0x1012_5f74, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1012_5f77, 4); mov(memw[ds, eax + 0x9], dx);           /* mov [eax+0x9], dx */
            ii(0x1012_5f7b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1012_5f92:
            ii(0x1012_5f92, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
