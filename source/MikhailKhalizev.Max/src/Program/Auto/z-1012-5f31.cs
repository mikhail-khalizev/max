...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_5f31()
        {
            ...
            ii(0x1012_5f51, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ...
            ii(0x1012_5f62, 4); mov(dx, memw[ds, eax + 65]);            /* mov dx, [eax+0x41] */
            ii(0x1012_5f66, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1012_5f69, 4); mov(memw[ds, eax + 7], dx);             /* mov [eax+0x7], dx */
            ii(0x1012_5f6d, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1012_5f70, 4); mov(dx, memw[ds, eax + 67]);            /* mov dx, [eax+0x43] */
            ii(0x1012_5f74, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ...
            ii(0x1012_5f87, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1012_5f8a, 6); mov(memw[ds, eax + 11], 0);             /* mov word [eax+0xb], 0x0 */
        ...
        l_0x1012_5f92:
            ...
            ii(0x1012_5fa1, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1012_5fa4, 4); mov(memw[ds, eax + 11], dx);            /* mov [eax+0xb], dx */
        l_0x1012_5fa8:
            ii(0x1012_5fa8, 7); mov(memd[ss, ebp - 12], 0xd);           /* mov dword [ebp-0xc], 0xd */
            ii(0x1012_5faf, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
