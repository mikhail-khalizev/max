...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_5076()
        {
            ...
            ii(0x507a, 4);    cmp(memw[ss, bp + 0x4], 0);               /* cmp word [bp+0x4], 0x0 */
            ii(0x507e, 2);    if(jnz(0x5085, 0x5)) goto l_0x5085;       /* jnz 0x5085 */
            ii(0x5080, 3);    mov(ax, 0x1);                             /* mov ax, 0x1 */
            ii(0x5083, 1);    leave();                                  /* leave */
            ii(0x5084, 1);    ret(); return;                            /* ret */
        l_0x5085:
            ii(0x5085, 3);    mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
            ...
            ii(0x509e, 3);    mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
