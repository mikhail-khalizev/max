...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_b64f()
        {
            ...
            ii(0x1010_b667, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_b66a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_b66d, 3); mov(eax, memd[ds, eax + 0xd]);          /* mov eax, [eax+0xd] */
            ii(0x1010_b670, 3); add(eax, 0x9);                          /* add eax, 0x9 */
            ii(0x1010_b673, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_b676, 4); imul(eax, memd[ss, ebp - 0x8], 0x14);   /* imul eax, [ebp-0x8], 0x14 */
            ...
            ii(0x1010_b693, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_b696, 5); call(0x1010_a8f7, -0xda4);              /* call 0x1010a8f7 */
            ii(0x1010_b69b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_b69e, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1010_b6a0, 3); mov(eax, memd[ds, eax + 0x12]);         /* mov eax, [eax+0x12] */
