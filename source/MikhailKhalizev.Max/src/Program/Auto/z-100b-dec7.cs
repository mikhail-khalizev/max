...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_dec7()
        {
            ...
            ii(0x100b_df02, 4); mov(memb[ss, ebp - 0xc], 1);            /* mov byte [ebp-0xc], 0x1 */
        ...
        l_0x100b_df35:
            ...
            ii(0x100b_df74, 4); mov(memb[ss, ebp - 0xc], 1);            /* mov byte [ebp-0xc], 0x1 */
        ...
        l_0x100b_dfa9:
            ...
            ii(0x100b_dfe8, 4); mov(memb[ss, ebp - 0xc], 1);            /* mov byte [ebp-0xc], 0x1 */
        ...
        l_0x100b_e01d:
            ...
            ii(0x100b_e05c, 4); mov(memb[ss, ebp - 0xc], 1);            /* mov byte [ebp-0xc], 0x1 */
