...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("c5621ddc-a9a0-4b44-bc9e-78016b2c7d00")]
        public void Method_100b_dec7()
        {
            ii(0x100b_dec7, 5); pushd(0x30);                            /* push 0x30 */
            ii(0x100b_decc, 5); calld(Definitions.sys_check_available_stack_size, 0xa_7e81); /* call 0x10165d52 */
            ...
            ii(0x100b_dee9, 5); calld(0x1007_64fc, -0x4_79f2);          /* call 0x100764fc */
            ...
            ii(0x100b_df0b, 5); calld(0x1007_5f6c, -0x4_7fa4);          /* call 0x10075f6c */
        ...
        l_0x100b_df15:
            ...
            ii(0x100b_df1a, 5); calld(0x1007_6338, -0x4_7be7);          /* call 0x10076338 */
            ...
            ii(0x100b_df26, 5); calld(0x1007_643c, -0x4_7aef);          /* call 0x1007643c */
        ...
        l_0x100b_df2d:
            ...
            ii(0x100b_df30, 5); calld(0x1007_6bf8, -0x4_733d);          /* call 0x10076bf8 */
        l_0x100b_df35:
            ii(0x100b_df35, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_df37, 3); lea(eax, ebp - 0x14);                   /* lea eax, [ebp-0x14] */
            ii(0x100b_df3a, 5); calld(0x1013_ad71, 0x7_ce32);           /* call 0x1013ad71 */
            ...
            ii(0x100b_df46, 5); calld(0x1007_63a0, -0x4_7bab);          /* call 0x100763a0 */
            ...
            ii(0x100b_df5a, 5); calld(0x1008_9aac, -0x3_44b3);          /* call 0x10089aac */
            ...
            ii(0x100b_df66, 5); calld(0x1007_63d4, -0x4_7b97);          /* call 0x100763d4 */
            ii(0x100b_df6b, 5); calld(0x1007_8840, -0x4_5730);          /* call 0x10078840 */
            ...
            ii(0x100b_df7d, 5); calld(0x1007_5f6c, -0x4_8016);          /* call 0x10075f6c */
        ...
        l_0x100b_df89:
            ...
            ii(0x100b_df8e, 5); calld(0x1007_6338, -0x4_7c5b);          /* call 0x10076338 */
            ...
            ii(0x100b_df9a, 5); calld(0x1007_643c, -0x4_7b63);          /* call 0x1007643c */
        ...
        l_0x100b_dfa1:
            ...
            ii(0x100b_dfa4, 5); calld(0x1007_6bf8, -0x4_73b1);          /* call 0x10076bf8 */
        l_0x100b_dfa9:
            ii(0x100b_dfa9, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_dfab, 3); lea(eax, ebp - 0x14);                   /* lea eax, [ebp-0x14] */
            ii(0x100b_dfae, 5); calld(0x1013_ad71, 0x7_cdbe);           /* call 0x1013ad71 */
            ...
            ii(0x100b_dfba, 5); calld(0x1007_63a0, -0x4_7c1f);          /* call 0x100763a0 */
            ...
            ii(0x100b_dfce, 5); calld(0x1008_9aac, -0x3_4527);          /* call 0x10089aac */
            ...
            ii(0x100b_dfda, 5); calld(0x1007_63d4, -0x4_7c0b);          /* call 0x100763d4 */
            ii(0x100b_dfdf, 5); calld(0x1007_8840, -0x4_57a4);          /* call 0x10078840 */
            ...
            ii(0x100b_dff1, 5); calld(0x1007_5f6c, -0x4_808a);          /* call 0x10075f6c */
        ...
        l_0x100b_dffd:
            ...
            ii(0x100b_e002, 5); calld(0x1007_6338, -0x4_7ccf);          /* call 0x10076338 */
            ...
            ii(0x100b_e00e, 5); calld(0x1007_643c, -0x4_7bd7);          /* call 0x1007643c */
        ...
        l_0x100b_e015:
            ...
            ii(0x100b_e018, 5); calld(0x1007_6bf8, -0x4_7425);          /* call 0x10076bf8 */
        l_0x100b_e01d:
            ii(0x100b_e01d, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_e01f, 3); lea(eax, ebp - 0x14);                   /* lea eax, [ebp-0x14] */
            ii(0x100b_e022, 5); calld(0x1013_ad71, 0x7_cd4a);           /* call 0x1013ad71 */
            ...
            ii(0x100b_e02e, 5); calld(0x1007_63a0, -0x4_7c93);          /* call 0x100763a0 */
            ...
            ii(0x100b_e042, 5); calld(0x1008_9aac, -0x3_459b);          /* call 0x10089aac */
            ...
            ii(0x100b_e04e, 5); calld(0x1007_63d4, -0x4_7c7f);          /* call 0x100763d4 */
            ii(0x100b_e053, 5); calld(0x1007_8840, -0x4_5818);          /* call 0x10078840 */
            ...
            ii(0x100b_e065, 5); calld(0x1007_5f6c, -0x4_80fe);          /* call 0x10075f6c */
        ...
        l_0x100b_e06e:
            ...
            ii(0x100b_e077, 5); calld(0x1007_5f6c, -0x4_8110);          /* call 0x10075f6c */
            ii(0x100b_e07c, 2); jmpd(0x100b_e088, 0xa); goto l_0x100b_e088; /* jmp 0x100be088 */
        //    ii(0x100b_e07e, 2); xor(edx, edx);                          /* xor edx, edx */
        //    ii(0x100b_e080, 3); lea(eax, ebp - 0x14);                   /* lea eax, [ebp-0x14] */
        //    ii(0x100b_e083, 5); calld(0x1007_5f6c, -0x4_811c);          /* call 0x10075f6c */
        l_0x100b_e088:
