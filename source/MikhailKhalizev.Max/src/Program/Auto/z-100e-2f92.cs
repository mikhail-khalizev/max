...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_2f92()
        {
            ...
            ii(0x100e_2fa9, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_2fac, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100e_2faf, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_2fb2, 5);  call(0x1007_623c, -0x6_cd7b);         /* call 0x1007623c */
            ii(0x100e_2fb7, 3);  mov(edx, memd[ds, eax + 8]);          /* mov edx, [eax+0x8] */
            ii(0x100e_2fba, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x100e_2fbd, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_2fc0, 3);  mov(al, memb[ds, eax + 77]);          /* mov al, [eax+0x4d] */
            ii(0x100e_2fc3, 5);  and(eax, 0xff);                       /* and eax, 0xff */
            ii(0x100e_2fc8, 2);  cmp(eax, edx);                        /* cmp eax, edx */
            ii(0x100e_2fca, 2);  if(jl(0x100e_2fd2, 6)) goto l_0x100e_2fd2;/* jl 0x100e2fd2 */
            ii(0x100e_2fcc, 4);  mov(memb[ss, ebp - 12], 0);           /* mov byte [ebp-0xc], 0x0 */
            ii(0x100e_2fd0, 2);  jmp(0x100e_3015, 0x43); goto l_0x100e_3015;/* jmp 0x100e3015 */
        l_0x100e_2fd2:
            ii(0x100e_2fd2, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x100e_2fd5, 5);  call(0x1007_20b1, -0x7_0f29);         /* call 0x100720b1 */
            ii(0x100e_2fda, 3);  lea(eax, memd[ss, ebp - 40]);         /* lea eax, [ebp-0x28] */
            ii(0x100e_2fdd, 5);  call(0x1007_20b1, -0x7_0f31);         /* call 0x100720b1 */
            ii(0x100e_2fe2, 3);  lea(ebx, memd[ss, ebp - 40]);         /* lea ebx, [ebp-0x28] */
            ii(0x100e_2fe5, 3);  lea(edx, memd[ss, ebp - 28]);         /* lea edx, [ebp-0x1c] */
            ii(0x100e_2fe8, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100e_2ffd, 4);  movsx(eax, memw[ss, ebp - 26]);       /* movsx eax, word [ebp-0x1a] */
            ii(0x100e_3001, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x100e_3003, 2);  if(jle(0x100e_300b, 6)) goto l_0x100e_300b;/* jle 0x100e300b */
            ii(0x100e_3005, 4);  mov(memb[ss, ebp - 16], 1);           /* mov byte [ebp-0x10], 0x1 */
            ii(0x100e_3009, 2);  jmp(0x100e_300f, 4); goto l_0x100e_300f;/* jmp 0x100e300f */
        l_0x100e_300b:
            ii(0x100e_300b, 4);  mov(memb[ss, ebp - 16], 0);           /* mov byte [ebp-0x10], 0x0 */
        l_0x100e_300f:
            ii(0x100e_300f, 3);  mov(al, memb[ss, ebp - 16]);          /* mov al, [ebp-0x10] */
            ii(0x100e_3012, 3);  mov(memb[ss, ebp - 12], al);          /* mov [ebp-0xc], al */
        l_0x100e_3015:
            ii(0x100e_3015, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
