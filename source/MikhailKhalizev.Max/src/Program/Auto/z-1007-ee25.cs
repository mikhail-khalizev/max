...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_ee25()
        {
            ...
            ii(0x1007_ee3c, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_ee3f, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1007_ee42, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1007_ee49, 2); jmp(0x1007_ee51, 0x6); goto l_0x1007_ee51; /* jmp 0x1007ee51 */
        l_0x1007_ee4b:
