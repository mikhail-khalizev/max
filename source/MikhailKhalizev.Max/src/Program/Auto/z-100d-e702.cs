...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_e702()
        {
            ...
            ii(0x100d_e713, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100d_e719, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100d_e71c, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x100d_e71f, 5); mov(eax, 5);                            /* mov eax, 0x5 */
            ii(0x100d_e724, 5); call(/* sys */ 0x1016_a24c, 0x8_bb23);  /* call 0x1016a24c */
            ii(0x100d_e729, 5); cmp(memw[ss, ebp - 4], -1 /* 0xff */);  /* cmp word [ebp-0x4], 0xffff */
            ii(0x100d_e72e, 6); if(jz(0x100d_e7c2, 0x8e)) goto l_0x100d_e7c2; /* jz 0x100de7c2 */
            ii(0x100d_e734, 3); lea(edx, memd[ss, ebp - 4]);            /* lea edx, [ebp-0x4] */
            ii(0x100d_e737, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_e749, 4); movsx(eax, memw[ss, ebp - 4]);          /* movsx eax, word [ebp-0x4] */
            ii(0x100d_e74d, 3); shl(eax, 2);                            /* shl eax, 0x2 */
            ii(0x100d_e750, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100d_e752, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_e761, 3); mov(ebx, memd[ds, eax + 6]);            /* mov ebx, [eax+0x6] */
            ii(0x100d_e764, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100d_e767, 5); mov(edx, 1);                            /* mov edx, 0x1 */
            ...
            ii(0x100d_e77a, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100d_e77d, 3); mov(eax, memd[ds, eax + 77]);           /* mov eax, [eax+0x4d] */
            ii(0x100d_e780, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100d_e783, 2); cmp(ebx, eax);                          /* cmp ebx, eax */
            ii(0x100d_e785, 2); if(jle(0x100d_e789, 2)) goto l_0x100d_e789; /* jle 0x100de789 */
        l_0x100d_e787:
        ...
        l_0x100d_e789:
            ...
            ii(0x100d_e79b, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100d_e79e, 6); mov(eax, memd[ds, eax + 987]);          /* mov eax, [eax+0x3db] */
        ...
        l_0x100d_e7ab:
            ...
            ii(0x100d_e7b4, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100d_e7b7, 6); mov(eax, memd[ds, eax + 987]);          /* mov eax, [eax+0x3db] */
            ii(0x100d_e7bd, 5); call(0x100c_fb06, -0xecbc);             /* call 0x100cfb06 */
        l_0x100d_e7c2:
            ii(0x100d_e7c2, 4); movsx(edx, memw[ss, ebp - 4]);          /* movsx edx, word [ebp-0x4] */
            ii(0x100d_e7c6, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
