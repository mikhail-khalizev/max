...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_72a5()
        {
            ...
            ii(0x1012_72c2, 3); mov(al, memb[ds, eax + 0x11]);          /* mov al, [eax+0x11] */
            ...
            ii(0x1012_72f1, 7); mov(memb[ds, eax + 0x101c_a490], 0x1);  /* mov byte [eax+0x101ca490], 0x1 */
            ii(0x1012_72f8, 5); mov(eax, memd[ds, 0x101c_59cc]);        /* mov eax, [0x101c59cc] */
            ii(0x1012_72fd, 6); lea(ebx, memd[ds, eax + 0x21a]);        /* lea ebx, [eax+0x21a] */
            ...
            ii(0x1012_7341, 3); mov(memb[ss, ebp - 0x4], al);           /* mov [ebp-0x4], al */
            ii(0x1012_7344, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1012_7346, 3); mov(dl, memb[ss, ebp - 0x4]);           /* mov dl, [ebp-0x4] */
            ...
            ii(0x1012_7366, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ii(0x1012_7369, 6); mov(memb[ds, edx + 0x101c_a4ef], al);   /* mov [edx+0x101ca4ef], al */
            ii(0x1012_736f, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1012_7376, 4); mov(memb[ss, ebp - 0x4], 0x4);          /* mov byte [ebp-0x4], 0x4 */
        l_0x1012_737a:
            ii(0x1012_737a, 3); dec(memb[ss, ebp - 0x4]);               /* dec byte [ebp-0x4] */
            ii(0x1012_737d, 4); cmp(memb[ss, ebp - 0x4], -0x1 /* 0xff */); /* cmp byte [ebp-0x4], 0xff */
            ii(0x1012_7381, 6); if(jz(0x1012_7475, 0xee)) goto l_0x1012_7475; /* jz 0x10127475 */
            ii(0x1012_7387, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1012_7389, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ...
            ii(0x1012_7397, 6); mov(eax, memd[ds, eax + 0x4da]);        /* mov eax, [eax+0x4da] */
            ...
            ii(0x1012_73ab, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ...
            ii(0x1012_73bf, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ...
            ii(0x1012_73d3, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ...
            ii(0x1012_73e6, 7); mov(ax, memw[ds, eax + 0x4dc]);         /* mov ax, [eax+0x4dc] */
            ii(0x1012_73ed, 4); cmp(ax, memw[ds, edx + 0x14]);          /* cmp ax, [edx+0x14] */
            ...
            ii(0x1012_73fa, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ...
            ii(0x1012_740d, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ii(0x1012_7410, 6); imul(eax, eax, 0x247);                  /* imul eax, eax, 0x247 */
            ii(0x1012_7416, 7); mov(memb[ds, eax + 0x101c_a490], 0x3);  /* mov byte [eax+0x101ca490], 0x3 */
            ii(0x1012_741d, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_7420, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x1012_7423:
        ...
        l_0x1012_7425:
            ...
            ii(0x1012_7429, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ...
            ii(0x1012_743c, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
        ...
        l_0x1012_7475:
            ii(0x1012_7475, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
            ii(0x1012_7478, 5); mov(memb[ds, 0x101c_59b8], al);         /* mov [0x101c59b8], al */
            ii(0x1012_747d, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_7480, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_7483, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
