...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x19_5030, 4); enter(4, 0);                              /* enter 0x4, 0x0 */
            ...
            ii(0x19_5046, 4); mov(ax, memw[es, bx + 66]);               /* mov ax, [es:bx+0x42] */
            ii(0x19_504a, 4); mov(dx, memw[es, bx + 68]);               /* mov dx, [es:bx+0x44] */
        l_0x19_504e:
            ii(0x19_504e, 3); mov(memw[ss, bp - 4], ax);                /* mov [bp-0x4], ax */
            ii(0x19_5051, 3); mov(memw[ss, bp - 2], dx);                /* mov [bp-0x2], dx */
            ii(0x19_5054, 2); mov(ax, dx);                              /* mov ax, dx */
            ii(0x19_5056, 3); or(ax, memw[ss, bp - 4]);                 /* or ax, [bp-0x4] */
            ii(0x19_5059, 2); if(jz(0x19_508c, 0x31)) goto l_0x19_508c; /* jz 0x508c */
            ii(0x19_505b, 3); les(bx, memw[ss, bp - 4]);                /* les bx, [bp-0x4] */
            ii(0x19_505e, 4); push(memw[es, bx + 6]);                   /* push word [es:bx+0x6] */
            ii(0x19_5062, 4); push(memw[es, bx + 4]);                   /* push word [es:bx+0x4] */
            ii(0x19_5066, 3); push(memw[ss, bp + 8]);                   /* push word [bp+0x8] */
            ii(0x19_5069, 3); push(memw[ss, bp + 6]);                   /* push word [bp+0x6] */
            ii(0x19_506c, 1); push(cs);                                 /* push cs */
            ii(0x19_506d, 3); call(0x19_4e68, -0x208);                  /* call 0x4e68 */
            ii(0x19_5070, 3); add(sp, 8);                               /* add sp, 0x8 */
            ii(0x19_5073, 2); or(ax, ax);                               /* or ax, ax */
            ii(0x19_5075, 2); if(jz(0x19_5080, 9)) goto l_0x19_5080;    /* jz 0x5080 */
            ii(0x19_5077, 3); mov(ax, memw[ss, bp - 4]);                /* mov ax, [bp-0x4] */
            ii(0x19_507a, 3); mov(dx, memw[ss, bp - 2]);                /* mov dx, [bp-0x2] */
            ii(0x19_507d, 1); pop(ds);                                  /* pop ds */
            ii(0x19_507e, 1); leave();                                  /* leave */
            ii(0x19_507f, 1); retf(); return;                           /* retf */
        l_0x19_5080:
            ii(0x19_5080, 3); les(bx, memw[ss, bp - 4]);                /* les bx, [bp-0x4] */
            ii(0x19_5083, 3); mov(ax, memw[es, bx]);                    /* mov ax, [es:bx] */
            ii(0x19_5086, 4); mov(dx, memw[es, bx + 2]);                /* mov dx, [es:bx+0x2] */
