...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_db09()
        {
            ...
            ii(0x1011_db22, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1011_db25, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1011_db28, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1011_db39, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1011_db48:
            ii(0x1011_db48, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_db4b, 4); mov(ax, memw[ds, eax + 0x2]);           /* mov ax, [eax+0x2] */
            ii(0x1011_db4f, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ...
            ii(0x1011_db5b, 2); if(jz(0x1011_db65, 0x8)) goto l_0x1011_db65; /* jz 0x1011db65 */
            ii(0x1011_db5d, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1011_db60, 3); test(memb[ds, eax], 0x20);              /* test byte [eax], 0x20 */
            ii(0x1011_db63, 2); if(jz(0x1011_db67, 0x2)) goto l_0x1011_db67; /* jz 0x1011db67 */
        l_0x1011_db65:
            ii(0x1011_db65, 2); jmp(0x1011_db69, 0x2); goto l_0x1011_db69; /* jmp 0x1011db69 */
        l_0x1011_db67:
        ...
        l_0x1011_db69:
            ...
            ii(0x1011_db6f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_db72, 4); inc(memw[ds, eax + 0x2]);               /* inc word [eax+0x2] */
            ii(0x1011_db76, 2); jmp(0x1011_db48, -0x30); goto l_0x1011_db48; /* jmp 0x1011db48 */
        l_0x1011_db78:
            ii(0x1011_db78, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_db7b, 4); mov(ax, memw[ds, eax + 0x2]);           /* mov ax, [eax+0x2] */
