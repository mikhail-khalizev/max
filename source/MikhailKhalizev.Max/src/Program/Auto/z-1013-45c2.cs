...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_45c2()
        {
            ...
            ii(0x1013_45d9, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1013_45dc, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1013_45df, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1013_45e3, 3); cmp(eax, -0x1 /* 0xff */);              /* cmp eax, 0xffffffff */
            ii(0x1013_45e6, 2); if(jnz(0x1013_45f1, 0x9)) goto l_0x1013_45f1; /* jnz 0x101345f1 */
            ii(0x1013_45e8, 4); mov(memb[ss, ebp - 0x10], 0);           /* mov byte [ebp-0x10], 0x0 */
            ii(0x1013_45ec, 5); jmp(0x1013_4681, 0x90); goto l_0x1013_4681; /* jmp 0x10134681 */
        l_0x1013_45f1:
            ii(0x1013_45f1, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1013_4602, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1013_4605, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1013_4609, 3); cmp(eax, -0x1 /* 0xff */);              /* cmp eax, 0xffffffff */
            ii(0x1013_460c, 2); if(jnz(0x1013_4614, 0x6)) goto l_0x1013_4614; /* jnz 0x10134614 */
            ii(0x1013_460e, 4); mov(memb[ss, ebp - 0x10], 0);           /* mov byte [ebp-0x10], 0x0 */
            ii(0x1013_4612, 2); jmp(0x1013_4681, 0x6d); goto l_0x1013_4681; /* jmp 0x10134681 */
        l_0x1013_4614:
            ii(0x1013_4614, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1013_4622, 3); mov(al, memb[ds, eax + 0x6]);           /* mov al, [eax+0x6] */
            ii(0x1013_4625, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x1013_4628, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1013_462a, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ...
            ii(0x1013_4639, 3); mov(edx, memd[ds, edx + 0x8]);          /* mov edx, [edx+0x8] */
            ii(0x1013_463c, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1013_463e, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
            ...
            ii(0x1013_4651, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
            ...
            ii(0x1013_4667, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1013_467d:
            ii(0x1013_467d, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
        l_0x1013_4681:
            ii(0x1013_4681, 3); mov(al, memb[ss, ebp - 0x10]);          /* mov al, [ebp-0x10] */
