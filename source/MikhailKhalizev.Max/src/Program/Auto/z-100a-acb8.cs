...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("4ac6ada7-ad6a-45bc-aedf-629263b7b56f")]
        public void Method_100a_acb8()
        {
            ii(0x100a_acb8, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x100a_acbd, 5); calld(Definitions.sys_check_available_stack_size, 0xbb090); /* call 0x10165d52 */
            ...
            ii(0x100a_acdb, 5); calld(0x1013_a66b, 0x8f98b);            /* call 0x1013a66b */
            ...
            ii(0x100a_aced, 1); retd(); return;                         /* ret */
        }
    }
}
