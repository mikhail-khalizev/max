...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_4fba()
        {
            ...
            ii(0x1014_4fd1, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_4fd4, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_4fd7, 7); test(memd[ss, ebp - 0x4], 0x4);         /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x1014_4fe5, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1014_4ff4:
            ii(0x1014_4ff4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_4ff7, 7); mov(memd[ds, eax + 0x2], 0x101b_727c);  /* mov dword [eax+0x2], 0x101b727c */
            ii(0x1014_4ffe, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_5000, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_500e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_5011, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_5013, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_5021, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_5024, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x1014_5029, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_502c, 5); call(0x1013_ab27, -0xa50a);             /* call 0x1013ab27 */
            ii(0x1014_5031, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_5034, 7); test(memd[ss, ebp - 0x4], 0x2);         /* test dword [ebp-0x4], 0x2 */
            ii(0x1014_503b, 2); if(jz(0x1014_5045, 0x8)) goto l_0x1014_5045; /* jz 0x10145045 */
            ii(0x1014_503d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_5040, 5); call(Definitions.sys_delete, 0x2_0f1f); /* call 0x10165f64 */
        l_0x1014_5045:
            ii(0x1014_5045, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_5048, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_504b, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
