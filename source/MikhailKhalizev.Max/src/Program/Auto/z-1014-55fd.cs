...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_55fd()
        {
            ...
            ii(0x1014_560f, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1014_5615, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1014_5618, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_561b, 3); add(eax, 0x14);                         /* add eax, 0x14 */
            ii(0x1014_561e, 5); call(0x1014_7fc0, 0x299d);              /* call 0x10147fc0 */
            ii(0x1014_5623, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1014_5626, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
