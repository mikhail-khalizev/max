...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0001_1a64()
        {
            ...
            ii(0x1_1a67, 2);  push(0x8);                                /* push 0x8 */
            ii(0x1_1a69, 1);  pop(ds);                                  /* pop ds */
            ii(0x1_1a6a, 1);  pushfw();                                 /* pushfw */
            ii(0x1_1a6b, 1);  cli();                                    /* cli */
            ii(0x1_1a6c, 3);  mov(bx, memw[ss, bp + 0x4]);              /* mov bx, [bp+0x4] */
            ...
            ii(0x1_1a7a, 3);  mov(memb[ds, bx + 0x5], al);              /* mov [bx+0x5], al */
            ii(0x1_1a7d, 3);  mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x1_1a80, 3);  mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ii(0x1_1a83, 3);  mov(cx, 0x4);                             /* mov cx, 0x4 */
        l_0x1_1a86:
            ii(0x1_1a86, 2);  shl(ax, 0x1);                             /* shl ax, 1 */
            ii(0x1_1a88, 2);  rcl(dx, 0x1);                             /* rcl dx, 1 */
            ii(0x1_1a8a, 2);  if(loop(0x1_1a86, -0x6)) goto l_0x1_1a86; /* loop 0x1a86 */
            ii(0x1_1a8c, 3);  mov(memw[ds, bx + 0x2], ax);              /* mov [bx+0x2], ax */
            ii(0x1_1a8f, 3);  mov(memb[ds, bx + 0x4], dl);              /* mov [bx+0x4], dl */
            ii(0x1_1a92, 3);  mov(memb[ds, bx + 0x7], dh);              /* mov [bx+0x7], dh */
