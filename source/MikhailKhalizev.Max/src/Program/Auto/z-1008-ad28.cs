...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_ad28()
        {
            ...
            ii(0x1008_ad40, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_ad43, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_ad46, 3); mov(al, memb[ds, eax + 0x8]);           /* mov al, [eax+0x8] */
            ii(0x1008_ad49, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x1008_ad4c, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
