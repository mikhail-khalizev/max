...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_26ac()
        {
            ...
            ii(0x1015_26c4, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_26c7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_26d7, 2); if(jnz(0x1015_26e2, 0x9)) goto l_0x1015_26e2; /* jnz 0x101526e2 */
            ii(0x1015_26d9, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1015_26e0, 2); jmp(0x1015_26f4, 0x12); goto l_0x1015_26f4; /* jmp 0x101526f4 */
        l_0x1015_26e2:
            ii(0x1015_26e2, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_26e4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_26e7, 5); add(eax, 0x8a);                         /* add eax, 0x8a */
            ii(0x1015_26ec, 5); call(0x1015_5164, 0x2a73);              /* call 0x10155164 */
            ii(0x1015_26f1, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x1015_26f4:
            ii(0x1015_26f4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
