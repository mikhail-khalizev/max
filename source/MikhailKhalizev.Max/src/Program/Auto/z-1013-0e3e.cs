...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_0e3e()
        {
            ...
            ii(0x1013_0e55, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_0e58, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_0e5b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_0e5e, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1013_0e61, 7); mov(memb[ds, 0x101b_b48c], 0);          /* mov byte [0x101bb48c], 0x0 */
            ii(0x1013_0e68, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_0e6b, 5); call(0x1012_f003, -0x1e6d);             /* call 0x1012f003 */
            ii(0x1013_0e70, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_0e73, 4); cmp(memb[ds, eax + 0x17], 0);           /* cmp byte [eax+0x17], 0x0 */
            ii(0x1013_0e77, 2); if(jz(0x1013_0e82, 0x9)) goto l_0x1013_0e82; /* jz 0x10130e82 */
            ii(0x1013_0e79, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_0e7c, 4); cmp(memb[ds, eax + 0x17], 0x1);         /* cmp byte [eax+0x17], 0x1 */
            ii(0x1013_0e80, 2); if(jnz(0x1013_0e8f, 0xd)) goto l_0x1013_0e8f; /* jnz 0x10130e8f */
        l_0x1013_0e82:
            ii(0x1013_0e82, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x1013_0e87, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
