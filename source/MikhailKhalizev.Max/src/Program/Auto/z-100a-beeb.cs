...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_beeb()
        {
            ...
            ii(0x100a_bf00, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x100a_bf03, 3); mov(memd[ss, ebp - 12], edx);           /* mov [ebp-0xc], edx */
            ...
            ii(0x100a_bf0f, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ...
            ii(0x100a_bf1d, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x100a_bf20, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_bf23, 5); call(0x1011_d0ea, 0x7_11c2);            /* call 0x1011d0ea */
            ii(0x100a_bf28, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x100a_bf2b, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x100a_bf2e, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x100a_bf31, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ...
            ii(0x100a_bf3f, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x100a_bf42, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x100a_bf45, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x100a_bf48, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_bf4b, 7); mov(memd[ds, eax + 2], 0x101b_5514);    /* mov dword [eax+0x2], 0x101b5514 */
            ii(0x100a_bf52, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_bf55, 4); mov(memb[ds, eax + 30], 0);             /* mov byte [eax+0x1e], 0x0 */
            ii(0x100a_bf59, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_bf5c, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
            ii(0x100a_bf5f, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
