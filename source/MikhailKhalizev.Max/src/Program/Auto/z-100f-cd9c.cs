...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_cd9c()
        {
            ...
            ii(0x100f_cdb3, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100f_cdb6, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100f_cdb9, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_cdbc, 3);  movsx(edx, memw[ds, eax]);            /* movsx edx, word [eax] */
            ii(0x100f_cdbf, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100f_cdd2, 7);  mov(memd[ss, ebp - 20], 2);           /* mov dword [ebp-0x14], 0x2 */
        l_0x100f_cdd9:
            ii(0x100f_cdd9, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_cddc, 3);  dec(memw[ds, eax]);                   /* dec word [eax] */
            ii(0x100f_cddf, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_cde2, 3);  inc(memw[ds, eax]);                   /* inc word [eax] */
            ii(0x100f_cde5, 7);  mov(memd[ss, ebp - 16], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x100f_cdec, 2);  jmp(0x100f_cdf2, 4); goto l_0x100f_cdf2;/* jmp 0x100fcdf2 */
        l_0x100f_cdee:
            ii(0x100f_cdee, 4);  add(memd[ss, ebp - 16], 2);           /* add dword [ebp-0x10], 0x2 */
        l_0x100f_cdf2:
            ii(0x100f_cdf2, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ii(0x100f_cdf6, 3);  cmp(eax, 8);                          /* cmp eax, 0x8 */
            ii(0x100f_cdf9, 2);  if(jge(0x100f_ce54, 0x59)) goto l_0x100f_ce54;/* jge 0x100fce54 */
            ii(0x100f_cdfb, 7);  mov(memd[ss, ebp - 12], 0);           /* mov dword [ebp-0xc], 0x0 */
            ii(0x100f_ce02, 2);  jmp(0x100f_ce0a, 6); goto l_0x100f_ce0a;/* jmp 0x100fce0a */
        l_0x100f_ce04:
            ii(0x100f_ce04, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_ce07, 3);  inc(memd[ss, ebp - 12]);              /* inc dword [ebp-0xc] */
        l_0x100f_ce0a:
            ii(0x100f_ce0a, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_ce0d, 4);  cmp(ax, memw[ss, ebp - 20]);          /* cmp ax, [ebp-0x14] */
            ii(0x100f_ce11, 2);  if(jge(0x100f_ce52, 0x3f)) goto l_0x100f_ce52;/* jge 0x100fce52 */
            ii(0x100f_ce13, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ii(0x100f_ce17, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x100f_ce1a, 7);  mov(dx, memw[ds, eax + 0x101c_5348]); /* mov dx, [eax+0x101c5348] */
            ii(0x100f_ce21, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_ce24, 3);  add(memw[ds, eax], dx);               /* add [eax], dx */
            ii(0x100f_ce27, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ii(0x100f_ce2b, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x100f_ce2e, 7);  mov(dx, memw[ds, eax + 0x101c_534a]); /* mov dx, [eax+0x101c534a] */
            ii(0x100f_ce35, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_ce38, 3);  add(memw[ds, eax], dx);               /* add [eax], dx */
            ii(0x100f_ce3b, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_ce3e, 3);  movsx(edx, memw[ds, eax]);            /* movsx edx, word [eax] */
            ii(0x100f_ce41, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100f_ce54:
            ii(0x100f_ce54, 4);  add(memd[ss, ebp - 20], 2);           /* add dword [ebp-0x14], 0x2 */
