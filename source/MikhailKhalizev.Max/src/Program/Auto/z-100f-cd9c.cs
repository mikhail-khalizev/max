...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_cd9c()
        {
            ...
            ii(0x100f_cdd2, 7); mov(memd[ss, ebp - 0x14], 2);           /* mov dword [ebp-0x14], 0x2 */
        l_0x100f_cdd9:
        ...
        l_0x100f_cdee:
            ii(0x100f_cdee, 4); add(memd[ss, ebp - 0x10], 2);           /* add dword [ebp-0x10], 0x2 */
        l_0x100f_cdf2:
        ...
        l_0x100f_ce54:
            ii(0x100f_ce54, 4); add(memd[ss, ebp - 0x14], 2);           /* add dword [ebp-0x14], 0x2 */
