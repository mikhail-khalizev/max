...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_883d()
        {
            ...
            ii(0x100e_8855, 3); mov(memb[ss, ebp - 0x4], al);           /* mov [ebp-0x4], al */
            ii(0x100e_8858, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ii(0x100e_885c, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100e_885e, 2); if(jge(0x100e_8869, 0x9)) goto l_0x100e_8869; /* jge 0x100e8869 */
            ii(0x100e_8860, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x100e_8867, 2); jmp(0x100e_8885, 0x1c); goto l_0x100e_8885; /* jmp 0x100e8885 */
        l_0x100e_8869:
            ii(0x100e_8869, 4); cmp(memb[ss, ebp - 0x4], 0x3b);         /* cmp byte [ebp-0x4], 0x3b */
            ii(0x100e_886d, 2); if(jge(0x100e_8878, 0x9)) goto l_0x100e_8878; /* jge 0x100e8878 */
            ii(0x100e_886f, 7); mov(memd[ss, ebp - 0xc], 0x1);          /* mov dword [ebp-0xc], 0x1 */
            ii(0x100e_8876, 2); jmp(0x100e_887f, 0x7); goto l_0x100e_887f; /* jmp 0x100e887f */
        l_0x100e_8878:
            ii(0x100e_8878, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
        l_0x100e_887f:
            ii(0x100e_887f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100e_8882, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x100e_8885:
            ii(0x100e_8885, 4); cmp(memd[ss, ebp - 0x8], 0);            /* cmp dword [ebp-0x8], 0x0 */
            ii(0x100e_8889, 2); if(jz(0x100e_889e, 0x13)) goto l_0x100e_889e; /* jz 0x100e889e */
            ii(0x100e_888b, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ...
            ii(0x100e_889c, 2); jmp(0x100e_88a5, 0x7); goto l_0x100e_88a5; /* jmp 0x100e88a5 */
        l_0x100e_889e:
