...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_b50c()
        {
            ...
            ii(0x100a_b524, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_b527, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_b52a, 5);  call(0x1015_2700, 0xa_71d1);          /* call 0x10152700 */
            ii(0x100a_b52f, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x100a_b531, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
            ii(0x100a_b534, 5);  call(0x1008_ae70, -0x2_06c9);         /* call 0x1008ae70 */
            ii(0x100a_b539, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_b53c, 4);  cmp(memb[ds, eax + 61], 0x10);        /* cmp byte [eax+0x3d], 0x10 */
            ii(0x100a_b540, 2);  if(jnz(0x100a_b551, 0xf)) goto l_0x100a_b551;/* jnz 0x100ab551 */
            ii(0x100a_b542, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_b545, 3);  mov(al, memb[ds, eax + 77]);          /* mov al, [eax+0x4d] */
            ii(0x100a_b548, 5);  and(eax, 0xff);                       /* and eax, 0xff */
            ii(0x100a_b54d, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x100a_b54f, 2);  if(jg(0x100a_b553, 2)) goto l_0x100a_b553;/* jg 0x100ab553 */
        l_0x100a_b551:
            ii(0x100a_b551, 2);  jmp(0x100a_b562, 0xf); goto l_0x100a_b562;/* jmp 0x100ab562 */
        l_0x100a_b553:
            ii(0x100a_b553, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100a_b555, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
        ...
        l_0x100a_b562:
            ii(0x100a_b562, 2);  jmp(0x100a_b56c, 8); goto l_0x100a_b56c;/* jmp 0x100ab56c */
        l_0x100a_b564:
            ii(0x100a_b564, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
            ii(0x100a_b567, 5);  call(0x1007_6bf8, -0x3_4974);         /* call 0x10076bf8 */
        l_0x100a_b56c:
            ii(0x100a_b56c, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100a_b56e, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x100a_b57a, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
            ii(0x100a_b57d, 5);  call(0x1008_adc4, -0x2_07be);         /* call 0x1008adc4 */
            ii(0x100a_b582, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100a_b585, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100a_b588, 3);  mov(edx, memd[ds, eax + 2]);          /* mov edx, [eax+0x2] */
            ii(0x100a_b58b, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100a_b58e, 3);  call_abs(memd[ds, edx + 32]);         /* call dword [edx+0x20] */
            ii(0x100a_b591, 2);  cmp(al, 0x17);                        /* cmp al, 0x17 */
            ii(0x100a_b593, 2);  if(jz(0x100a_b5b0, 0x1b)) goto l_0x100a_b5b0;/* jz 0x100ab5b0 */
            ii(0x100a_b595, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
            ii(0x100a_b598, 5);  call(0x1008_adc4, -0x2_07d9);         /* call 0x1008adc4 */
            ii(0x100a_b59d, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x100a_b5a0, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100a_b5a3, 3);  mov(edx, memd[ds, eax + 2]);          /* mov edx, [eax+0x2] */
            ii(0x100a_b5a6, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100a_b5a9, 3);  call_abs(memd[ds, edx + 32]);         /* call dword [edx+0x20] */
        ...
        l_0x100a_b5b0:
            ...
            ii(0x100a_b5b2, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
            ii(0x100a_b5b5, 5);  call(0x100b_81d0, 0xcc16);            /* call 0x100b81d0 */
            ii(0x100a_b5ba, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x100a_b5bc, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_b5bf, 5);  call(0x1015_2962, 0xa_739e);          /* call 0x10152962 */
            ii(0x100a_b5c4, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
            ii(0x100a_b5c7, 5);  call(0x1008_adc4, -0x2_0808);         /* call 0x1008adc4 */
            ii(0x100a_b5cc, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x100a_b5cf, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100a_b5d2, 3);  mov(ebx, memd[ds, eax + 2]);          /* mov ebx, [eax+0x2] */
            ii(0x100a_b5d5, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x100a_b5d8, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100a_b5db, 3);  call_abs(memd[ds, ebx + 84]);         /* call dword [ebx+0x54] */
        l_0x100a_b5de:
            ii(0x100a_b5de, 2);  jmp(0x100a_b564, -0x7c); goto l_0x100a_b564;/* jmp 0x100ab564 */
        l_0x100a_b5e0:
            ii(0x100a_b5e0, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100a_b5e2, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
