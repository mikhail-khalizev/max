...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("e74a6601-c4f7-4b62-a995-4cf1d852b866")]
        public void Method_1013_e1ae()
        {
            ii(0x1013_e1ae, 5); pushd(0xb8);                            /* push 0xb8 */
            ii(0x1013_e1b3, 5); calld(Definitions.sys_check_available_stack_size, 0x27b9a); /* call 0x10165d52 */
        ...
        l_0x1013_e1e9:
            ...
            ii(0x1013_e1f1, 5); calld(Definitions.sys_strcpy, 0x27cd9); /* call 0x10165ecf */
            ii(0x1013_e1f6, 3); mov(edx, memd_a32[ss, ebp - 0xc]);      /* mov edx, [ebp-0xc] */
            ii(0x1013_e1f9, 3); lea(eax, ebp - 0x74);                   /* lea eax, [ebp-0x74] */
            ii(0x1013_e1fc, 5); calld(Definitions.sys_strcat, 0x27d30); /* call 0x10165f31 */
            ii(0x1013_e201, 3); mov(eax, memd_a32[ss, ebp - 0xc]);      /* mov eax, [ebp-0xc] */
            ii(0x1013_e204, 5); calld(Definitions.sys_delete, 0x27d5b); /* call 0x10165f64 */
            ii(0x1013_e209, 5); mov(edx, 0x101a_cd3b);                  /* mov edx, 0x101acd3b */ /* "rb" */
            ii(0x1013_e20e, 3); lea(eax, ebp - 0x74);                   /* lea eax, [ebp-0x74] */
            ii(0x1013_e211, 5); calld(Definitions.my_fopen, -0x4edf7);  /* call 0x100ef41f */
        ...
        l_0x1013_e22b:
            ...
            ii(0x1013_e23e, 5); calld(Definitions.my_fread, -0x4edb4);  /* call 0x100ef48f */
            ...
            ii(0x1013_e24a, 5); calld(Definitions.sys_fclose, 0x33e1a); /* call 0x10172069 */
        ...
        l_0x1013_e25b:
            ...
            ii(0x1013_e260, 5); mov(edx, 0x101a_cd3e);                  /* mov edx, 0x101acd3e */ /* "RIFF" */
            ii(0x1013_e265, 6); lea(eax, ebp - 0x9c);                   /* lea eax, [ebp-0x9c] */
            ii(0x1013_e26b, 5); calld(Definitions.sys_strncmp, 0x3aeec); /* call 0x1017915c */
            ...
            ii(0x1013_e287, 5); calld(Definitions.my_fread, -0x4edfd);  /* call 0x100ef48f */
            ...
            ii(0x1013_e293, 5); calld(Definitions.sys_fclose, 0x33dd1); /* call 0x10172069 */
        ...
        l_0x1013_e2a4:
            ...
            ii(0x1013_e2b5, 5); calld(Definitions.my_fseek, -0x4ee65);  /* call 0x100ef455 */
            ...
            ii(0x1013_e2cd, 5); calld(Definitions.my_fread, -0x4ee43);  /* call 0x100ef48f */
        ...
        l_0x1013_e2dd:
            ...
            ii(0x1013_e2e3, 5); calld(Definitions.sys_fclose, 0x33d81); /* call 0x10172069 */
            ...
            ii(0x1013_e303, 5); calld(Definitions.sys_ftell, 0x3443f);  /* call 0x10172747 */
