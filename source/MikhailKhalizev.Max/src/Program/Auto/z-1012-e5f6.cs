...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_e5f6()
        {
            ...
            ii(0x1012_e60d, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_e610, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1012_e613, 5); mov(eax, 0x5);                          /* mov eax, 0x5 */
            ii(0x1012_e618, 5); call(/* sys */ 0x1016_a24c, 0x3_bc2f);  /* call 0x1016a24c */
            ii(0x1012_e61d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_e620, 2); mov(ebx, memd[ds, eax]);                /* mov ebx, [eax] */
            ii(0x1012_e622, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1012_e625, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_e628, 6); mov(eax, memd[ds, eax + 0xde]);         /* mov eax, [eax+0xde] */
            ...
            ii(0x1012_e64c, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1012_e64f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_e652, 4); mov(ax, memw[ds, eax + 0x34]);          /* mov ax, [eax+0x34] */
            ii(0x1012_e656, 3); add(memd[ss, ebp - 0xc], eax);          /* add [ebp-0xc], eax */
            ii(0x1012_e659, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_e65c, 3); add(eax, 0x26);                         /* add eax, 0x26 */
            ii(0x1012_e65f, 5); call(Definitions.my_1_get_count, -0x8_318c); /* call 0x100ab4d8 */
            ii(0x1012_e664, 4); cmp(ax, memw[ss, ebp - 0xc]);           /* cmp ax, [ebp-0xc] */
            ii(0x1012_e668, 2); if(jle(0x1012_e6a0, 0x36)) goto l_0x1012_e6a0; /* jle 0x1012e6a0 */
            ii(0x1012_e66a, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x1012_e66e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1012_e682, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x1012_e686, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1012_e698, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
