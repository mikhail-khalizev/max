...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("95bc89a9-eff1-413a-80cd-451b4cc012e4")]
        public void Method_0017_e020()
        {
            ii(0x17_e020, 1); pushw(bp);                                /* push bp */
            ii(0x17_e021, 2); mov(bp, sp);                              /* mov bp, sp */
            ii(0x17_e023, 2); mov(dx, si);                              /* mov dx, si */
            ii(0x17_e025, 1); pushw(ds);                                /* push ds */
        ...
        l_0x17_e02e:
            ...
            ii(0x17_e030, 2); if(jzw(0x17_e05f, 0x2d)) goto l_0x17_e05f; /* jz 0xe05f */
            ii(0x17_e032, 1); lodsb_a16();                              /* lodsb */
            ii(0x17_e033, 3); mov(ah, memb_a16[es, bx]);                /* mov ah, [es:bx] */
            ii(0x17_e036, 1); inc(bx);                                  /* inc bx */
            ii(0x17_e037, 2); cmp(ah, al);                              /* cmp ah, al */
            ii(0x17_e039, 2); if(jzw(0x17_e02e, -0xd)) goto l_0x17_e02e; /* jz 0xe02e */
            ...
            ii(0x17_e059, 2); if(jzw(0x17_e02e, -0x2d)) goto l_0x17_e02e; /* jz 0xe02e */
            ii(0x17_e05b, 2); sbb(al, al);                              /* sbb al, al */
            ii(0x17_e05d, 2); sbb(al, -0x1 /* 0xff */);                 /* sbb al, 0xff */
        l_0x17_e05f:
            ii(0x17_e05f, 1); cbw();                                    /* cbw */
            ii(0x17_e060, 1); popw(ds);                                 /* pop ds */
            ii(0x17_e061, 2); mov(si, dx);                              /* mov si, dx */
            ii(0x17_e063, 1); popw(bp);                                 /* pop bp */
            ii(0x17_e064, 1); retfw(); return;                          /* retf */
        }
    }
}
