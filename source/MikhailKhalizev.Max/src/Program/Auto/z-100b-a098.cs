...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_a098()
        {
            ...
            ii(0x100b_a0b0, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_a0b3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_a0b6, 3); add(eax, 0x43);                         /* add eax, 0x43 */
            ii(0x100b_a0b9, 5); call(0x100c_b000, 0x1_0f42);            /* call 0x100cb000 */
            ii(0x100b_a0be, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_a0c1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
