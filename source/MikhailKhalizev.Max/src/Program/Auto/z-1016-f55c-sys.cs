...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_f55c()
        {
            ...
            ii(0x1016_f55e, 3); sub(esp, 4);                            /* sub esp, 0x4 */
            ...
            ii(0x1016_f56b, 3); cmp(eax, -1 /* 0xff */);                /* cmp eax, 0xffffffff */
            ii(0x1016_f56e, 2); if(jz(0x1016_f575, 5)) goto l_0x1016_f575; /* jz 0x1016f575 */
            ii(0x1016_f570, 3); mov(cl, memb[ss, esp]);                 /* mov cl, [esp] */
            ii(0x1016_f573, 2); xor(eax, eax);                          /* xor eax, eax */
        l_0x1016_f575:
            ii(0x1016_f575, 3); cmp(eax, -1 /* 0xff */);                /* cmp eax, 0xffffffff */
            ...
            ii(0x1016_f58a, 3); cmp(eax, -1 /* 0xff */);                /* cmp eax, 0xffffffff */
            ii(0x1016_f58d, 2); if(jz(0x1016_f593, 4)) goto l_0x1016_f593; /* jz 0x1016f593 */
            ii(0x1016_f58f, 2); mov(cl, al);                            /* mov cl, al */
            ii(0x1016_f591, 2); xor(eax, eax);                          /* xor eax, eax */
        l_0x1016_f593:
            ii(0x1016_f593, 3); cmp(eax, -1 /* 0xff */);                /* cmp eax, 0xffffffff */
            ...
            ii(0x1016_f59d, 3); shl(ebx, 8);                            /* shl ebx, 0x8 */
            ...
            ii(0x1016_f5ae, 2); jmp(0x1016_f5b5, 5); goto l_0x1016_f5b5; /* jmp 0x1016f5b5 */
        l_0x1016_f5b0:
            ii(0x1016_f5b0, 5); mov(eax, 0xffff_ffff);                  /* mov eax, 0xffffffff */
        l_0x1016_f5b5:
            ii(0x1016_f5b5, 3); add(esp, 4);                            /* add esp, 0x4 */
