...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_4c8a()
        {
            ...
            ii(0x1019_4c91, 2); push(fs);                               /* push fs */
            ii(0x1019_4c93, 2); push(gs);                               /* push gs */
            ii(0x1019_4c95, 1); push(es);                               /* push es */
            ...
            ii(0x1019_4cac, 1); pop(es);                                /* pop es */
            ii(0x1019_4cad, 2); pop(gs);                                /* pop gs */
            ii(0x1019_4caf, 2); pop(fs);                                /* pop fs */
