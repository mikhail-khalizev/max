...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_bb98()
        {
            ...
            ii(0x1014_bbb0, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_bbb3, 4); or(memb[ss, ebp - 0x8], 0x1);           /* or byte [ebp-0x8], 0x1 */
            ii(0x1014_bbb7, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_bbba, 5); call(0x1007_6998, -0xd_5227);           /* call 0x10076998 */
            ii(0x1014_bbbf, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1014_bbc2, 4); and(memb[ss, ebp - 0x8], -0x2 /* 0xfe */); /* and byte [ebp-0x8], 0xfe */
            ii(0x1014_bbc6, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_bbc8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_bbd7, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_bbda, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_bbec, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_bbef, 3); add(eax, 0x70);                         /* add eax, 0x70 */
            ii(0x1014_bbf2, 5); call(0x100a_b2a8, -0xa_094f);           /* call 0x100ab2a8 */
        l_0x1014_bbf7:
            ii(0x1014_bbf7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_bbfa, 4); test(memb[ds, eax + 0x69], 0x1);        /* test byte [eax+0x69], 0x1 */
            ii(0x1014_bbfe, 2); if(jz(0x1014_bc5a, 0x5a)) goto l_0x1014_bc5a; /* jz 0x1014bc5a */
            ii(0x1014_bc00, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x1014_bc05, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_bc08, 5); call(0x1014_b7be, -0x44f);              /* call 0x1014b7be */
            ii(0x1014_bc0d, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_bc10, 4); cmp(memd[ss, ebp - 0xc], 0);            /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1014_bc14, 2); if(jz(0x1014_bc4a, 0x34)) goto l_0x1014_bc4a; /* jz 0x1014bc4a */
            ii(0x1014_bc16, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_bc18, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1014_bc24, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1014_bc36, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1014_bc46, 2); if(jge(0x1014_bc4a, 0x2)) goto l_0x1014_bc4a; /* jge 0x1014bc4a */
        l_0x1014_bc48:
            ii(0x1014_bc48, 2); jmp(0x1014_bc4c, 0x2); goto l_0x1014_bc4c; /* jmp 0x1014bc4c */
        l_0x1014_bc4a:
            ii(0x1014_bc4a, 2); jmp(0x1014_bc5a, 0xe); goto l_0x1014_bc5a; /* jmp 0x1014bc5a */
        l_0x1014_bc4c:
            ii(0x1014_bc4c, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1014_bc4f, 3); add(edx, 0x70);                         /* add edx, 0x70 */
            ii(0x1014_bc52, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_bc55, 5); call(0x1015_5344, 0x96ea);              /* call 0x10155344 */
        l_0x1014_bc5a:
            ii(0x1014_bc5a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_bc5d, 4); test(memb[ds, eax + 0x69], 0x2);        /* test byte [eax+0x69], 0x2 */
            ii(0x1014_bc61, 2); if(jz(0x1014_bcbd, 0x5a)) goto l_0x1014_bcbd; /* jz 0x1014bcbd */
            ii(0x1014_bc63, 5); mov(edx, 0x2);                          /* mov edx, 0x2 */
            ii(0x1014_bc68, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_bc6b, 5); call(0x1014_b7be, -0x4b2);              /* call 0x1014b7be */
            ii(0x1014_bc70, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_bc73, 4); cmp(memd[ss, ebp - 0xc], 0);            /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1014_bc77, 2); if(jz(0x1014_bcad, 0x34)) goto l_0x1014_bcad; /* jz 0x1014bcad */
            ii(0x1014_bc79, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_bc7b, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1014_bc87, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1014_bc99, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1014_bca9, 2); if(jge(0x1014_bcad, 0x2)) goto l_0x1014_bcad; /* jge 0x1014bcad */
        l_0x1014_bcab:
            ii(0x1014_bcab, 2); jmp(0x1014_bcaf, 0x2); goto l_0x1014_bcaf; /* jmp 0x1014bcaf */
        l_0x1014_bcad:
            ii(0x1014_bcad, 2); jmp(0x1014_bcbd, 0xe); goto l_0x1014_bcbd; /* jmp 0x1014bcbd */
        l_0x1014_bcaf:
            ii(0x1014_bcaf, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1014_bcb2, 3); add(edx, 0x70);                         /* add edx, 0x70 */
            ii(0x1014_bcb5, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_bcb8, 5); call(0x1015_5344, 0x9687);              /* call 0x10155344 */
        l_0x1014_bcbd:
            ii(0x1014_bcbd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_bcc0, 4); test(memb[ds, eax + 0x69], 0x4);        /* test byte [eax+0x69], 0x4 */
            ii(0x1014_bcc4, 2); if(jz(0x1014_bd1c, 0x56)) goto l_0x1014_bd1c; /* jz 0x1014bd1c */
            ii(0x1014_bcc6, 5); mov(edx, 0x4);                          /* mov edx, 0x4 */
            ii(0x1014_bccb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_bcce, 5); call(0x1014_b7be, -0x515);              /* call 0x1014b7be */
            ii(0x1014_bcd3, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_bcd6, 4); cmp(memd[ss, ebp - 0xc], 0);            /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1014_bcda, 2); if(jz(0x1014_bd1c, 0x40)) goto l_0x1014_bd1c; /* jz 0x1014bd1c */
            ii(0x1014_bcdc, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_bcde, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1014_bcea, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1014_bcfc, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x1014_bd0e:
            ii(0x1014_bd0e, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1014_bd11, 3); add(edx, 0x70);                         /* add edx, 0x70 */
            ii(0x1014_bd14, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_bd17, 5); call(0x1015_5344, 0x9628);              /* call 0x10155344 */
        l_0x1014_bd1c:
            ii(0x1014_bd1c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_bd1f, 4); test(memb[ds, eax + 0x69], 0x8);        /* test byte [eax+0x69], 0x8 */
            ii(0x1014_bd23, 2); if(jz(0x1014_bd7b, 0x56)) goto l_0x1014_bd7b; /* jz 0x1014bd7b */
            ii(0x1014_bd25, 5); mov(edx, 0x8);                          /* mov edx, 0x8 */
            ii(0x1014_bd2a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_bd2d, 5); call(0x1014_b7be, -0x574);              /* call 0x1014b7be */
            ii(0x1014_bd32, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_bd35, 4); cmp(memd[ss, ebp - 0xc], 0);            /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1014_bd39, 2); if(jz(0x1014_bd7b, 0x40)) goto l_0x1014_bd7b; /* jz 0x1014bd7b */
            ii(0x1014_bd3b, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_bd3d, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1014_bd49, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1014_bd5b, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x1014_bd6d:
            ii(0x1014_bd6d, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1014_bd70, 3); add(edx, 0x70);                         /* add edx, 0x70 */
            ii(0x1014_bd73, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_bd76, 5); call(0x1015_5344, 0x95c9);              /* call 0x10155344 */
        l_0x1014_bd7b:
            ii(0x1014_bd7b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_bd7e, 4); test(memb[ds, eax + 0x69], 0x20);       /* test byte [eax+0x69], 0x20 */
            ii(0x1014_bd82, 2); if(jz(0x1014_bdda, 0x56)) goto l_0x1014_bdda; /* jz 0x1014bdda */
            ii(0x1014_bd84, 5); mov(edx, 0x20);                         /* mov edx, 0x20 */
            ii(0x1014_bd89, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_bd8c, 5); call(0x1014_b7be, -0x5d3);              /* call 0x1014b7be */
            ii(0x1014_bd91, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_bd94, 4); cmp(memd[ss, ebp - 0xc], 0);            /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1014_bd98, 2); if(jz(0x1014_bdda, 0x40)) goto l_0x1014_bdda; /* jz 0x1014bdda */
            ii(0x1014_bd9a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_bd9c, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1014_bda8, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1014_bdba, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x1014_bdcc:
            ii(0x1014_bdcc, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1014_bdcf, 3); add(edx, 0x70);                         /* add edx, 0x70 */
            ii(0x1014_bdd2, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_bdd5, 5); call(0x1015_5344, 0x956a);              /* call 0x10155344 */
        l_0x1014_bdda:
            ii(0x1014_bdda, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_bddd, 4); test(memb[ds, eax + 0x69], 0x10);       /* test byte [eax+0x69], 0x10 */
            ii(0x1014_bde1, 2); if(jz(0x1014_be39, 0x56)) goto l_0x1014_be39; /* jz 0x1014be39 */
            ii(0x1014_bde3, 5); mov(edx, 0x10);                         /* mov edx, 0x10 */
            ii(0x1014_bde8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_bdeb, 5); call(0x1014_b7be, -0x632);              /* call 0x1014b7be */
            ii(0x1014_bdf0, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_bdf3, 4); cmp(memd[ss, ebp - 0xc], 0);            /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1014_bdf7, 2); if(jz(0x1014_be39, 0x40)) goto l_0x1014_be39; /* jz 0x1014be39 */
            ii(0x1014_bdf9, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_bdfb, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1014_be07, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1014_be19, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x1014_be2b:
            ii(0x1014_be2b, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1014_be2e, 3); add(edx, 0x70);                         /* add edx, 0x70 */
            ii(0x1014_be31, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_be34, 5); call(0x1015_5344, 0x950b);              /* call 0x10155344 */
        l_0x1014_be39:
            ii(0x1014_be39, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_be3c, 4); test(memb[ds, eax + 0x69], 0x80);       /* test byte [eax+0x69], 0x80 */
            ii(0x1014_be40, 2); if(jz(0x1014_be98, 0x56)) goto l_0x1014_be98; /* jz 0x1014be98 */
            ii(0x1014_be42, 5); mov(edx, 0x80);                         /* mov edx, 0x80 */
            ii(0x1014_be47, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_be4a, 5); call(0x1014_b7be, -0x691);              /* call 0x1014b7be */
            ii(0x1014_be4f, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_be52, 4); cmp(memd[ss, ebp - 0xc], 0);            /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1014_be56, 2); if(jz(0x1014_be98, 0x40)) goto l_0x1014_be98; /* jz 0x1014be98 */
            ii(0x1014_be58, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_be5a, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1014_be66, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1014_be78, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x1014_be8a:
            ii(0x1014_be8a, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1014_be8d, 3); add(edx, 0x70);                         /* add edx, 0x70 */
            ii(0x1014_be90, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_be93, 5); call(0x1015_5344, 0x94ac);              /* call 0x10155344 */
        l_0x1014_be98:
            ii(0x1014_be98, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_be9b, 4); test(memb[ds, eax + 0x69], 0x40);       /* test byte [eax+0x69], 0x40 */
            ii(0x1014_be9f, 2); if(jz(0x1014_bef7, 0x56)) goto l_0x1014_bef7; /* jz 0x1014bef7 */
            ii(0x1014_bea1, 5); mov(edx, 0x40);                         /* mov edx, 0x40 */
            ii(0x1014_bea6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_bea9, 5); call(0x1014_b7be, -0x6f0);              /* call 0x1014b7be */
            ii(0x1014_beae, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_beb1, 4); cmp(memd[ss, ebp - 0xc], 0);            /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1014_beb5, 2); if(jz(0x1014_bef7, 0x40)) goto l_0x1014_bef7; /* jz 0x1014bef7 */
            ii(0x1014_beb7, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_beb9, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1014_bec5, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1014_bed7, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x1014_bee9:
            ii(0x1014_bee9, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1014_beec, 3); add(edx, 0x70);                         /* add edx, 0x70 */
            ii(0x1014_beef, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_bef2, 5); call(0x1015_5344, 0x944d);              /* call 0x10155344 */
        l_0x1014_bef7:
            ii(0x1014_bef7, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_bef9, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1014_bf05, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_bf08, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ii(0x1014_bf0b, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1014_bf0d, 1); cwde();                                 /* cwde */
            ii(0x1014_bf0e, 5); call(0x1014_892b, -0x35e8);             /* call 0x1014892b */
            ii(0x1014_bf13, 3); lea(ebx, memd[ss, ebp - 0x14]);         /* lea ebx, [ebp-0x14] */
