...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_6c9d()
        {
            ...
            ii(0x1012_6cb5, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1012_6cb8, 7); mov(memd[ss, ebp - 0x8], 0x101c_59f5);  /* mov dword [ebp-0x8], 0x101c59f5 */
            ii(0x1012_6cbf, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_6cc2, 3); movsx(edx, memw[ds, eax]);              /* movsx edx, word [eax] */
            ii(0x1012_6cc5, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1012_6cda, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x1012_6cde, 6); imul(edx, edx, 0x247);                  /* imul edx, edx, 0x247 */
            ii(0x1012_6ce4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_6ce7, 4); mov(ax, memw[ds, eax + 0x2]);           /* mov ax, [eax+0x2] */
            ii(0x1012_6ceb, 7); mov(memw[ds, edx + 0x101c_a583], ax);   /* mov [edx+0x101ca583], ax */
            ii(0x1012_6cf2, 5); mov(ebx, 0x28);                         /* mov ebx, 0x28 */
            ii(0x1012_6cf7, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1012_6cfa, 3); add(edx, 0x4);                          /* add edx, 0x4 */
            ii(0x1012_6cfd, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1012_6d18, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1012_6d1b, 3); add(edx, 0x4a);                         /* add edx, 0x4a */
            ii(0x1012_6d1e, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1012_6d39, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ii(0x1012_6d3c, 3); add(ebx, 0x2c);                         /* add ebx, 0x2c */
            ii(0x1012_6d3f, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
