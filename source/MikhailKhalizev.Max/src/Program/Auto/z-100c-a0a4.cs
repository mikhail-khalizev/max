...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_a0a4()
        {
            ...
            ii(0x100c_a0bb, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_a0be, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100c_a0c1, 5); mov(ebx, 0x101b_5750);                  /* mov ebx, 0x101b5750 */
            ii(0x100c_a0c6, 5); mov(edx, 0x4);                          /* mov edx, 0x4 */
            ii(0x100c_a0cb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_a0ce, 5); call(Definitions.sys_call_dtor_arr_v2, 0x9_bf0d); /* call 0x10165fe0 */
            ii(0x100c_a0d3, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100c_a0d6, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
