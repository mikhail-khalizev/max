...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_2930()
        {
            ...
            ii(0x1014_2945, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1014_2948, 3); mov(memd[ss, ebp - 12], edx);           /* mov [ebp-0xc], edx */
            ii(0x1014_294b, 3); mov(memd[ss, ebp - 8], ebx);            /* mov [ebp-0x8], ebx */
            ii(0x1014_294e, 3); mov(memd[ss, ebp - 4], ecx);            /* mov [ebp-0x4], ecx */
            ii(0x1014_2951, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x1014_2985, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x1014_2989, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1014_298b, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1014_298e, 5); mov(eax, memd[ds, 0x101c_38f0]);        /* mov eax, [0x101c38f0] */
            ii(0x1014_2993, 3); sar(eax, 6);                            /* sar eax, 0x6 */
            ...
            ii(0x1014_29a1, 4); movsx(eax, memw[ss, ebp - 8]);          /* movsx eax, word [ebp-0x8] */
            ii(0x1014_29a5, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1014_29a7, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1014_29aa, 5); mov(eax, memd[ds, 0x101c_38ec]);        /* mov eax, [0x101c38ec] */
            ii(0x1014_29af, 3); sar(eax, 6);                            /* sar eax, 0x6 */
            ...
            ii(0x1014_29bd, 4); movsx(eax, memw[ss, ebp - 4]);          /* movsx eax, word [ebp-0x4] */
            ii(0x1014_29c1, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1014_29c3, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1014_29c6, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1014_29c9, 1); inc(eax);                               /* inc eax */
            ii(0x1014_29ca, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1014_29cd, 7); cmp(memb[ds, 0x101c_3910], 0);          /* cmp byte [0x101c3910], 0x0 */
            ii(0x1014_29d4, 2); if(jz(0x1014_29df, 9)) goto l_0x1014_29df; /* jz 0x101429df */
            ii(0x1014_29d6, 7); mov(memd[ss, ebp - 48], 0xffff);        /* mov dword [ebp-0x30], 0xffff */
            ii(0x1014_29dd, 2); jmp(0x1014_29e6, 7); goto l_0x1014_29e6; /* jmp 0x101429e6 */
        l_0x1014_29df:
            ii(0x1014_29df, 7); mov(memd[ss, ebp - 48], 0);             /* mov dword [ebp-0x30], 0x0 */
        l_0x1014_29e6:
            ii(0x1014_29e6, 3); mov(eax, memd[ss, ebp - 40]);           /* mov eax, [ebp-0x28] */
            ii(0x1014_29e9, 6); mov(eax, memd[ds, eax + 250]);          /* mov eax, [eax+0xfa] */
            ii(0x1014_29ef, 3); mov(ax, memw[ds, eax]);                 /* mov ax, [eax] */
            ii(0x1014_29f2, 5); and(eax, 0xffff);                       /* and eax, 0xffff */
            ii(0x1014_29f7, 3); or(eax, memd[ss, ebp - 48]);            /* or eax, [ebp-0x30] */
            ii(0x1014_29fa, 3); mov(memd[ss, ebp - 36], eax);           /* mov [ebp-0x24], eax */
            ii(0x1014_29fd, 4); movsx(edx, memw[ss, ebp - 12]);         /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x1014_2a0e, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
            ii(0x1014_2a11, 2); jmp(0x1014_2a19, 6); goto l_0x1014_2a19; /* jmp 0x10142a19 */
        l_0x1014_2a13:
            ii(0x1014_2a13, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
            ii(0x1014_2a16, 3); inc(memd[ss, ebp - 32]);                /* inc dword [ebp-0x20] */
        l_0x1014_2a19:
            ii(0x1014_2a19, 4); movsx(edx, memw[ss, ebp - 4]);          /* movsx edx, word [ebp-0x4] */
            ...
            ii(0x1014_2a2b, 4); movsx(edx, memw[ss, ebp - 32]);         /* movsx edx, word [ebp-0x20] */
            ii(0x1014_2a2f, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x1014_2a31, 6); if(jge(0x1014_2b12, 0xdb)) goto l_0x1014_2b12; /* jge 0x10142b12 */
            ii(0x1014_2a37, 4); movsx(edx, memw[ss, ebp - 8]);          /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x1014_2a48, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x1014_2a4b, 2); jmp(0x1014_2a53, 6); goto l_0x1014_2a53; /* jmp 0x10142a53 */
        l_0x1014_2a4d:
            ii(0x1014_2a4d, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x1014_2a50, 3); inc(memd[ss, ebp - 28]);                /* inc dword [ebp-0x1c] */
        l_0x1014_2a53:
            ii(0x1014_2a53, 4); movsx(edx, memw[ss, ebp - 20]);         /* movsx edx, word [ebp-0x14] */
            ...
            ii(0x1014_2a65, 4); movsx(edx, memw[ss, ebp - 28]);         /* movsx edx, word [ebp-0x1c] */
            ii(0x1014_2a69, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x1014_2a6b, 6); if(jge(0x1014_2b0d, 0x9c)) goto l_0x1014_2b0d; /* jge 0x10142b0d */
            ii(0x1014_2a71, 4); movsx(edx, memw[ss, ebp - 28]);         /* movsx edx, word [ebp-0x1c] */
            ii(0x1014_2a75, 4); movsx(eax, memw[ss, ebp - 32]);         /* movsx eax, word [ebp-0x20] */
            ii(0x1014_2a79, 5); call(0x1007_3d48, -0xc_ed36);           /* call 0x10073d48 */
            ii(0x1014_2a7e, 5); and(eax, 0xffff);                       /* and eax, 0xffff */
            ii(0x1014_2a83, 3); cmp(eax, 8);                            /* cmp eax, 0x8 */
            ii(0x1014_2a86, 2); if(jz(0x1014_2a91, 9)) goto l_0x1014_2a91; /* jz 0x10142a91 */
            ii(0x1014_2a88, 7); mov(memd[ss, ebp - 52], 1);             /* mov dword [ebp-0x34], 0x1 */
            ii(0x1014_2a8f, 2); jmp(0x1014_2a98, 7); goto l_0x1014_2a98; /* jmp 0x10142a98 */
        l_0x1014_2a91:
            ii(0x1014_2a91, 7); mov(memd[ss, ebp - 52], 0);             /* mov dword [ebp-0x34], 0x0 */
        l_0x1014_2a98:
            ii(0x1014_2a98, 4); cmp(memd[ss, ebp - 52], 0);             /* cmp dword [ebp-0x34], 0x0 */
            ii(0x1014_2a9c, 2); if(jz(0x1014_2acc, 0x2e)) goto l_0x1014_2acc; /* jz 0x10142acc */
            ii(0x1014_2a9e, 4); movsx(edx, memw[ss, ebp - 28]);         /* movsx edx, word [ebp-0x1c] */
            ...
            ii(0x1014_2aad, 4); movsx(eax, memw[ss, ebp - 32]);         /* movsx eax, word [ebp-0x20] */
            ...
            ii(0x1014_2ac4, 4); mov(ax, memw[ss, ebp - 36]);            /* mov ax, [ebp-0x24] */
            ii(0x1014_2ac8, 2); test(edx, eax);                         /* test edx, eax */
            ii(0x1014_2aca, 2); if(jnz(0x1014_2ace, 2)) goto l_0x1014_2ace; /* jnz 0x10142ace */
        l_0x1014_2acc:
            ii(0x1014_2acc, 2); jmp(0x1014_2b08, 0x3a); goto l_0x1014_2b08; /* jmp 0x10142b08 */
        l_0x1014_2ace:
            ii(0x1014_2ace, 4); movsx(edx, memw[ss, ebp - 28]);         /* movsx edx, word [ebp-0x1c] */
            ...
            ii(0x1014_2add, 4); movsx(edx, memw[ss, ebp - 32]);         /* movsx edx, word [ebp-0x20] */
            ...
            ii(0x1014_2af1, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x1014_2af4, 4); movsx(ecx, memw[ss, ebp - 24]);         /* movsx ecx, word [ebp-0x18] */
            ii(0x1014_2af8, 4); movsx(ebx, memw[ss, ebp - 28]);         /* movsx ebx, word [ebp-0x1c] */
            ii(0x1014_2afc, 4); movsx(edx, memw[ss, ebp - 32]);         /* movsx edx, word [ebp-0x20] */
            ii(0x1014_2b00, 3); mov(eax, memd[ss, ebp - 44]);           /* mov eax, [ebp-0x2c] */
