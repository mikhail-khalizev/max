...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_de37()
        {
            ...
            ii(0x100c_de4f, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x100c_de5f, 2); if(jz(0x100c_de67, 0x6)) goto l_0x100c_de67; /* jz 0x100cde67 */
            ii(0x100c_de61, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
        ...
        l_0x100c_de67:
            ...
            ii(0x100c_de72, 2); if(jbe(0x100c_de7a, 0x6)) goto l_0x100c_de7a; /* jbe 0x100cde7a */
            ii(0x100c_de74, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
        ...
        l_0x100c_de8e:
            ...
            ii(0x100c_de91, 4); cmp(memw[ds, eax], -0x1 /* 0xff */);    /* cmp word [eax], 0xffff */
            ...
            ii(0x100c_de9d, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ii(0x100c_dea1, 2); if(jnz(0x100c_dea9, 0x6)) goto l_0x100c_dea9; /* jnz 0x100cdea9 */
            ii(0x100c_dea3, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
        ...
        l_0x100c_dea9:
            ...
            ii(0x100c_deac, 4); add(memd[ss, ebp - 0xc], 0x2);          /* add dword [ebp-0xc], 0x2 */
            ii(0x100c_deb0, 2); jmp(0x100c_de8e, -0x24); goto l_0x100c_de8e; /* jmp 0x100cde8e */
        l_0x100c_deb2:
            ii(0x100c_deb2, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x100c_deb6:
            ii(0x100c_deb6, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
