...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_5aaa()
        {
            ...
            ii(0x17_5ab6, 2); push(0x3);                                /* push 0x3 */
            ...
            ii(0x17_5ac0, 3); mov(memw[ss, bp - 0x1c], ax);             /* mov [bp-0x1c], ax */
            ...
            ii(0x17_5aeb, 3); push(memw[ss, bp - 0x1c]);                /* push word [bp-0x1c] */
        ...
        l_0x17_5afc:
            ...
            ii(0x17_5b1a, 2); if(jnz(0x17_5b22, 0x6)) goto l_0x17_5b22; /* jnz 0x5b22 */
            ii(0x17_5b1c, 6); mov(memw[ds, 0x984], 0);                  /* mov word [0x984], 0x0 */
        l_0x17_5b22:
            ii(0x17_5b22, 3); push(memw[ss, bp - 0x1c]);                /* push word [bp-0x1c] */
            ...
            ii(0x17_5b43, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
            ii(0x17_5b46, 2); or(ax, ax);                               /* or ax, ax */
            ii(0x17_5b48, 2); if(jnz(0x17_5b50, 0x6)) goto l_0x17_5b50; /* jnz 0x5b50 */
            ii(0x17_5b4a, 1); inc(ax);                                  /* inc ax */
            ii(0x17_5b4b, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
        ...
        l_0x17_5b50:
            ...
            ii(0x17_5b56, 2); if(jz(0x17_5b5b, 0x3)) goto l_0x17_5b5b;  /* jz 0x5b5b */
            ii(0x17_5b58, 3); inc(memw[ss, bp - 0x6]);                  /* inc word [bp-0x6] */
        l_0x17_5b5b:
            ii(0x17_5b5b, 3); push(memw[ss, bp - 0x6]);                 /* push word [bp-0x6] */
        ...
        l_0x17_5bae:
            ...
            ii(0x17_5bb5, 4); mov(ax, memw[es, bx + 0x12]);             /* mov ax, [es:bx+0x12] */
            ...
            ii(0x17_5bf2, 5); mov(memw[ss, bp - 0x14], 0);              /* mov word [bp-0x14], 0x0 */
            ii(0x17_5bf7, 2); jmp(0x17_5bfd, 0x4); goto l_0x17_5bfd;    /* jmp 0x5bfd */
        //  ii(0x17_5bf9, 1); nop();                                    /* nop */
        l_0x17_5bfa:
            ii(0x17_5bfa, 3); inc(memw[ss, bp - 0x14]);                 /* inc word [bp-0x14] */
        l_0x17_5bfd:
            ii(0x17_5bfd, 5); cmp(memw[ss, bp - 0x14], 0x400);          /* cmp word [bp-0x14], 0x400 */
            ii(0x17_5c02, 2); if(jae(0x17_5c20, 0x1c)) goto l_0x17_5c20; /* jae 0x5c20 */
            ii(0x17_5c04, 3); mov(bx, memw[ss, bp - 0x14]);             /* mov bx, [bp-0x14] */
            ...
            ii(0x17_5c11, 4); mov(dx, memw[es, bx + si + 0x2]);         /* mov dx, [es:bx+si+0x2] */
        ...
        l_0x17_5c20:
            ...
            ii(0x17_5c3f, 3); mov(memw[ss, bp - 0xa], ax);              /* mov [bp-0xa], ax */
            ii(0x17_5c42, 3); mov(memw[ss, bp - 0x8], dx);              /* mov [bp-0x8], dx */
            ii(0x17_5c45, 5); mov(memw[ss, bp - 0x36], 0x3fc);          /* mov word [bp-0x36], 0x3fc */
            ii(0x17_5c4a, 5); mov(memw[ss, bp - 0x34], 0);              /* mov word [bp-0x34], 0x0 */
            ii(0x17_5c4f, 5); mov(memw[ss, bp - 0x14], 0);              /* mov word [bp-0x14], 0x0 */
            ii(0x17_5c54, 2); jmp(0x17_5c69, 0x13); goto l_0x17_5c69;   /* jmp 0x5c69 */
        l_0x17_5c56:
            ii(0x17_5c56, 3); inc(memw[ss, bp - 0x14]);                 /* inc word [bp-0x14] */
            ii(0x17_5c59, 4); add(memw[ss, bp - 0xa], 0x1);             /* add word [bp-0xa], 0x1 */
            ii(0x17_5c5d, 4); adc(memw[ss, bp - 0x8], 0);               /* adc word [bp-0x8], 0x0 */
            ii(0x17_5c61, 4); add(memw[ss, bp - 0x36], 0x1);            /* add word [bp-0x36], 0x1 */
            ii(0x17_5c65, 4); adc(memw[ss, bp - 0x34], 0);              /* adc word [bp-0x34], 0x0 */
        l_0x17_5c69:
            ii(0x17_5c69, 3); mov(ax, memw[ss, bp - 0x6]);              /* mov ax, [bp-0x6] */
            ii(0x17_5c6c, 3); cmp(memw[ss, bp - 0x14], ax);             /* cmp [bp-0x14], ax */
            ii(0x17_5c6f, 2); if(jae(0x17_5cca, 0x59)) goto l_0x17_5cca; /* jae 0x5cca */
            ii(0x17_5c71, 3); mov(ax, memw[ss, bp - 0xa]);              /* mov ax, [bp-0xa] */
            ii(0x17_5c74, 3); mov(dx, memw[ss, bp - 0x8]);              /* mov dx, [bp-0x8] */
            ...
            ii(0x17_5c91, 3); mov(bx, memw[ss, bp - 0x36]);             /* mov bx, [bp-0x36] */
            ...
            ii(0x17_5cac, 4); mov(memw[es, bx + si + 0x2], di);         /* mov [es:bx+si+0x2], di */
            ii(0x17_5cb0, 4); les(si, ds, 0x992);                       /* les si, [0x992] */
            ii(0x17_5cb4, 4); or(memb[es, bx + si], 0x1);               /* or byte [es:bx+si], 0x1 */
            ii(0x17_5cb8, 4); les(si, ds, 0x992);                       /* les si, [0x992] */
            ii(0x17_5cbc, 4); or(memb[es, bx + si], 0x2);               /* or byte [es:bx+si], 0x2 */
            ii(0x17_5cc0, 4); les(si, ds, 0x992);                       /* les si, [0x992] */
            ii(0x17_5cc4, 4); or(memb[es, bx + si], 0x4);               /* or byte [es:bx+si], 0x4 */
        ...
        l_0x17_5cca:
            ...
            ii(0x17_5ccf, 3); mov(ah, memb[ss, bp - 0x6]);              /* mov ah, [bp-0x6] */
            ...
            ii(0x17_5cff, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
            ii(0x17_5d02, 5); mov(memw[ss, bp - 0x2a], 0);              /* mov word [bp-0x2a], 0x0 */
            ii(0x17_5d07, 5); mov(memw[ss, bp - 0x28], 0xff00);         /* mov word [bp-0x28], 0xff00 */
            ...
            ii(0x17_5d23, 3); mov(memw[ss, bp - 0x24], ax);             /* mov [bp-0x24], ax */
            ii(0x17_5d26, 3); mov(memw[ss, bp - 0x22], dx);             /* mov [bp-0x22], dx */
            ...
            ii(0x17_5d31, 3); sub(memw[ss, bp - 0x24], ax);             /* sub [bp-0x24], ax */
            ii(0x17_5d34, 3); sbb(memw[ss, bp - 0x22], dx);             /* sbb [bp-0x22], dx */
            ...
            ii(0x17_5d46, 3); sub(memw[ss, bp - 0x24], cx);             /* sub [bp-0x24], cx */
            ii(0x17_5d49, 3); sbb(memw[ss, bp - 0x22], bx);             /* sbb [bp-0x22], bx */
            ii(0x17_5d4c, 3); cmp(memw[ss, bp - 0x22], dx);             /* cmp [bp-0x22], dx */
            ii(0x17_5d4f, 2); if(jb(0x17_5d5e, 0xd)) goto l_0x17_5d5e;  /* jb 0x5d5e */
            ii(0x17_5d51, 2); if(ja(0x17_5d58, 0x5)) goto l_0x17_5d58;  /* ja 0x5d58 */
            ii(0x17_5d53, 3); cmp(memw[ss, bp - 0x24], ax);             /* cmp [bp-0x24], ax */
            ii(0x17_5d56, 2); if(jbe(0x17_5d5e, 0x6)) goto l_0x17_5d5e; /* jbe 0x5d5e */
        l_0x17_5d58:
            ii(0x17_5d58, 3); mov(memw[ss, bp - 0x24], ax);             /* mov [bp-0x24], ax */
            ii(0x17_5d5b, 3); mov(memw[ss, bp - 0x22], dx);             /* mov [bp-0x22], dx */
        l_0x17_5d5e:
            ii(0x17_5d5e, 3); mov(ax, memw[ss, bp - 0x24]);             /* mov ax, [bp-0x24] */
            ii(0x17_5d61, 3); mov(dx, memw[ss, bp - 0x22]);             /* mov dx, [bp-0x22] */
            ii(0x17_5d64, 4); cmp(memw[ds, 0x36], dx);                  /* cmp [0x36], dx */
            ii(0x17_5d68, 2); if(jb(0x17_5d84, 0x1a)) goto l_0x17_5d84; /* jb 0x5d84 */
            ii(0x17_5d6a, 2); if(ja(0x17_5d72, 0x6)) goto l_0x17_5d72;  /* ja 0x5d72 */
        ...
        l_0x17_5d84:
            ...
            ii(0x17_5d9c, 2); if(jz(0x17_5da6, 0x8)) goto l_0x17_5da6;  /* jz 0x5da6 */
        ...
        l_0x17_5da6:
            ii(0x17_5da6, 5); mov(memw[ss, bp - 0x1a], 0x1);            /* mov word [bp-0x1a], 0x1 */
            ii(0x17_5dab, 2); jmp(0x17_5db1, 0x4); goto l_0x17_5db1;    /* jmp 0x5db1 */
        //  ii(0x17_5dad, 1); nop();                                    /* nop */
        l_0x17_5dae:
            ii(0x17_5dae, 3); inc(memw[ss, bp - 0x1a]);                 /* inc word [bp-0x1a] */
        l_0x17_5db1:
            ii(0x17_5db1, 3); mov(ax, memw[ss, bp - 0x6]);              /* mov ax, [bp-0x6] */
            ii(0x17_5db4, 3); cmp(memw[ss, bp - 0x1a], ax);             /* cmp [bp-0x1a], ax */
            ...
            ii(0x17_5dbd, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_5dc0, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
        ...
        l_0x17_5dde:
            ii(0x17_5dde, 3); mov(bx, memw[ss, bp - 0x1a]);             /* mov bx, [bp-0x1a] */
            ...
            ii(0x17_5deb, 3); xor(ax, memw[ss, bp - 0x4]);              /* xor ax, [bp-0x4] */
            ii(0x17_5dee, 3); and(ah, 0xf);                             /* and ah, 0xf */
            ii(0x17_5df1, 2); sub(dx, dx);                              /* sub dx, dx */
            ii(0x17_5df3, 3); xor(ax, memw[ss, bp - 0x4]);              /* xor ax, [bp-0x4] */
            ii(0x17_5df6, 3); xor(dx, memw[ss, bp - 0x2]);              /* xor dx, [bp-0x2] */
            ii(0x17_5df9, 3); mov(memw[es, bx + si], ax);               /* mov [es:bx+si], ax */
            ii(0x17_5dfc, 4); mov(memw[es, bx + si + 0x2], dx);         /* mov [es:bx+si+0x2], dx */
            ii(0x17_5e00, 4); les(si, ds, 0x4fec);                      /* les si, [0x4fec] */
            ii(0x17_5e04, 4); or(memb[es, bx + si], 0x1);               /* or byte [es:bx+si], 0x1 */
            ii(0x17_5e08, 4); les(si, ds, 0x4fec);                      /* les si, [0x4fec] */
            ii(0x17_5e0c, 4); or(memb[es, bx + si], 0x2);               /* or byte [es:bx+si], 0x2 */
            ii(0x17_5e10, 4); les(si, ds, 0x4fec);                      /* les si, [0x4fec] */
            ii(0x17_5e14, 4); or(memb[es, bx + si], 0x4);               /* or byte [es:bx+si], 0x4 */
            ii(0x17_5e18, 1); nop();                                    /* nop */
            ii(0x17_5e19, 1); push(cs);                                 /* push cs */
            ii(0x17_5e1a, 3); call(0x17_8e97, 0x307a);                  /* call 0x8e97 */
            ii(0x17_5e1d, 5); add(memw[ss, bp - 0x4], 0x1000);          /* add word [bp-0x4], 0x1000 */
            ii(0x17_5e22, 4); adc(memw[ss, bp - 0x2], 0);               /* adc word [bp-0x2], 0x0 */
            ii(0x17_5e26, 2); jmp(0x17_5dae, -0x7a); goto l_0x17_5dae;  /* jmp 0x5dae */
        l_0x17_5e28:
            ii(0x17_5e28, 2); push(-0x1 /* 0xff */);                    /* push 0xffff */
            ...
            ii(0x17_5e37, 3); mov(memw[ss, bp - 0x18], ax);             /* mov [bp-0x18], ax */
            ii(0x17_5e3a, 3); mov(memw[ss, bp - 0x16], dx);             /* mov [bp-0x16], dx */
            ...
            ii(0x17_5e4a, 3); mov(ax, memw[ss, bp - 0x6]);              /* mov ax, [bp-0x6] */
            ...
            ii(0x17_5e55, 3); push(memw[ss, bp - 0x16]);                /* push word [bp-0x16] */
            ...
            ii(0x17_5e85, 3); push(memw[ss, bp - 0x16]);                /* push word [bp-0x16] */
            ...
            ii(0x17_5eab, 3); mov(memw[ss, bp - 0xe], ax);              /* mov [bp-0xe], ax */
            ii(0x17_5eae, 3); mov(memw[ss, bp - 0xc], dx);              /* mov [bp-0xc], dx */
            ...
            ii(0x17_5efc, 2); if(jz(0x17_5f06, 0x8)) goto l_0x17_5f06;  /* jz 0x5f06 */
        ...
        l_0x17_5f06:
            ...
            ii(0x17_5f75, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ii(0x17_5f78, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_5f7b, 2); jmp(0x17_5f86, 0x9); goto l_0x17_5f86;    /* jmp 0x5f86 */
        //  ii(0x17_5f7d, 1); nop();                                    /* nop */
        l_0x17_5f7e:
            ii(0x17_5f7e, 4); add(memw[ss, bp - 0x4], 0x1);             /* add word [bp-0x4], 0x1 */
            ii(0x17_5f82, 4); adc(memw[ss, bp - 0x2], 0);               /* adc word [bp-0x2], 0x0 */
        l_0x17_5f86:
            ii(0x17_5f86, 3); mov(ax, memw[ds, 0x201c]);                /* mov ax, [0x201c] */
            ii(0x17_5f89, 4); mov(dx, memw[ds, 0x201e]);                /* mov dx, [0x201e] */
            ii(0x17_5f8d, 3); cmp(memw[ss, bp - 0x2], dx);              /* cmp [bp-0x2], dx */
            ii(0x17_5f90, 2); if(ja(0x17_5ff8, 0x66)) goto l_0x17_5ff8; /* ja 0x5ff8 */
            ii(0x17_5f92, 2); if(jb(0x17_5f99, 0x5)) goto l_0x17_5f99;  /* jb 0x5f99 */
            ii(0x17_5f94, 3); cmp(memw[ss, bp - 0x4], ax);              /* cmp [bp-0x4], ax */
            ii(0x17_5f97, 2); if(jae(0x17_5ff8, 0x5f)) goto l_0x17_5ff8; /* jae 0x5ff8 */
        l_0x17_5f99:
            ii(0x17_5f99, 2); push(0);                                  /* push 0x0 */
            ii(0x17_5f9b, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_5f9e, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0x17_5fb1, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_5fb4, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0x17_5fc9, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_5fcc, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0x17_5fe1, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_5fe4, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
        ...
        l_0x17_5ff8:
            ii(0x17_5ff8, 2); push(0x1);                                /* push 0x1 */
            ii(0x17_5ffa, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0x17_5ffd, 3); mov(dx, memw[ss, bp - 0x2]);              /* mov dx, [bp-0x2] */
            ...
            ii(0x17_602d, 3); mov(memw[ss, bp - 0x14], ax);             /* mov [bp-0x14], ax */
            ii(0x17_6030, 6); test(memw[ds, 0x201c], 0x3ff);            /* test word [0x201c], 0x3ff */
            ii(0x17_6036, 2); if(jz(0x17_603c, 0x4)) goto l_0x17_603c;  /* jz 0x603c */
            ii(0x17_6038, 1); inc(ax);                                  /* inc ax */
            ii(0x17_6039, 3); mov(memw[ss, bp - 0x14], ax);             /* mov [bp-0x14], ax */
        l_0x17_603c:
            ii(0x17_603c, 4); add(memw[ss, bp - 0x14], 0x40);           /* add word [bp-0x14], 0x40 */
            ii(0x17_6040, 3); mov(ax, memw[ds, 0x4f8c]);                /* mov ax, [0x4f8c] */
            ii(0x17_6043, 4); mov(dx, memw[ds, 0x4f8e]);                /* mov dx, [0x4f8e] */
            ii(0x17_6047, 3); mov(memw[ss, bp - 0xa], ax);              /* mov [bp-0xa], ax */
            ii(0x17_604a, 3); mov(memw[ss, bp - 0x8], dx);              /* mov [bp-0x8], dx */
            ii(0x17_604d, 5); mov(memw[ss, bp - 0x26], 0x40);           /* mov word [bp-0x26], 0x40 */
            ii(0x17_6052, 2); jmp(0x17_6060, 0xc); goto l_0x17_6060;    /* jmp 0x6060 */
        l_0x17_6054:
            ii(0x17_6054, 3); inc(memw[ss, bp - 0x26]);                 /* inc word [bp-0x26] */
            ii(0x17_6057, 5); add(memw[ss, bp - 0xa], 0x1000);          /* add word [bp-0xa], 0x1000 */
            ii(0x17_605c, 4); adc(memw[ss, bp - 0x8], 0);               /* adc word [bp-0x8], 0x0 */
        l_0x17_6060:
            ii(0x17_6060, 3); mov(ax, memw[ss, bp - 0x26]);             /* mov ax, [bp-0x26] */
            ii(0x17_6063, 3); cmp(memw[ss, bp - 0x14], ax);             /* cmp [bp-0x14], ax */
            ii(0x17_6066, 2); if(jbe(0x17_60c2, 0x5a)) goto l_0x17_60c2; /* jbe 0x60c2 */
            ii(0x17_6068, 3); push(memw[ss, bp - 0x8]);                 /* push word [bp-0x8] */
            ii(0x17_606b, 3); push(memw[ss, bp - 0xa]);                 /* push word [bp-0xa] */
            ...
            ii(0x17_608d, 3); mov(bx, memw[ss, bp - 0x26]);             /* mov bx, [bp-0x26] */
            ...
            ii(0x17_60a4, 4); mov(memw[es, bx + si + 0x2], dx);         /* mov [es:bx+si+0x2], dx */
            ii(0x17_60a8, 4); les(si, ds, 0x992);                       /* les si, [0x992] */
            ii(0x17_60ac, 4); or(memb[es, bx + si], 0x1);               /* or byte [es:bx+si], 0x1 */
            ii(0x17_60b0, 4); les(si, ds, 0x992);                       /* les si, [0x992] */
            ii(0x17_60b4, 4); or(memb[es, bx + si], 0x2);               /* or byte [es:bx+si], 0x2 */
            ii(0x17_60b8, 4); les(si, ds, 0x992);                       /* les si, [0x992] */
            ii(0x17_60bc, 4); or(memb[es, bx + si], 0x4);               /* or byte [es:bx+si], 0x4 */
