...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_66b4()
        {
            ...
            ii(0x100d_66ea, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_66ed, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_66f0, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100d_66f3, 10); mov(memd[ds, 0x101b_7eb4], 0x1);       /* mov dword [0x101b7eb4], 0x1 */
            ii(0x100d_66fd, 5); mov(eax, 0x101c_3602);                  /* mov eax, 0x101c3602 */
            ii(0x100d_6702, 5); call(0x100d_6710, 0x9);                 /* call 0x100d6710 */
