...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_af42()
        {
            ...
            ii(0x1014_af5d, 4); or(memb[ss, ebp - 12], 1);              /* or byte [ebp-0xc], 0x1 */
            ii(0x1014_af61, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1014_af64, 5); call(Definitions.my_ctor_0x101b_38f8, -0xd_4879); /* call 0x100766f0 */
            ii(0x1014_af69, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1014_af6c, 4); and(memb[ss, ebp - 12], -2 /* 0xfe */); /* and byte [ebp-0xc], 0xfe */
        l_0x1014_af70:
            ii(0x1014_af70, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_af73, 6); mov(eax, memd[ds, eax + 161]);          /* mov eax, [eax+0xa1] */
            ...
            ii(0x1014_af82, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
        ...
        l_0x1014_af8f:
            ...
            ii(0x1014_af9a, 3); mov(dl, memb[ds, eax + 43]);            /* mov dl, [eax+0x2b] */
            ii(0x1014_af9d, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_afa0, 3); cmp(dl, memb[ds, eax + 42]);            /* cmp dl, [eax+0x2a] */
            ...
            ii(0x1014_afab, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ...
            ii(0x1014_afb7, 7); mov(memd[ss, ebp - 28], 2);             /* mov dword [ebp-0x1c], 0x2 */
            ii(0x1014_afbe, 2); jmp(0x1014_afc7, 7); goto l_0x1014_afc7; /* jmp 0x1014afc7 */
        l_0x1014_afc0:
            ii(0x1014_afc0, 7); mov(memd[ss, ebp - 28], 1);             /* mov dword [ebp-0x1c], 0x1 */
        l_0x1014_afc7:
            ii(0x1014_afc7, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x1014_afca, 2); mov(al, memb[ds, eax]);                 /* mov al, [eax] */
            ii(0x1014_afcc, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x1014_afd1, 3); add(eax, memd[ss, ebp - 28]);           /* add eax, [ebp-0x1c] */
            ii(0x1014_afd4, 3); mov(edx, memd[ss, ebp - 24]);           /* mov edx, [ebp-0x18] */
            ii(0x1014_afd7, 2); mov(memb[ds, edx], al);                 /* mov [edx], al */
        l_0x1014_afd9:
            ii(0x1014_afd9, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_afdc, 3); mov(dl, memb[ds, eax + 43]);            /* mov dl, [eax+0x2b] */
            ii(0x1014_afdf, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_afe2, 3); cmp(dl, memb[ds, eax + 42]);            /* cmp dl, [eax+0x2a] */
            ...
            ii(0x1014_afea, 3); mov(dl, memb[ds, eax + 42]);            /* mov dl, [eax+0x2a] */
            ii(0x1014_afed, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_aff0, 3); mov(memb[ds, eax + 43], dl);            /* mov [eax+0x2b], dl */
        l_0x1014_aff3:
            ...
            ii(0x1014_b00b, 3); mov(al, memb[ds, eax + 78]);            /* mov al, [eax+0x4e] */
            ...
            ii(0x1014_b022, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
            ii(0x1014_b025, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
            ii(0x1014_b028, 3); mov(edx, memd[ds, eax + 2]);            /* mov edx, [eax+0x2] */
            ii(0x1014_b02b, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
            ii(0x1014_b02e, 3); call_abs(memd[ds, edx + 56]);           /* call dword [edx+0x38] */
        ...
        l_0x1014_b053:
            ...
            ii(0x1014_b056, 3); mov(al, memb[ds, eax + 44]);            /* mov al, [eax+0x2c] */
            ...
            ii(0x1014_b066, 3); mov(al, memb[ds, eax + 44]);            /* mov al, [eax+0x2c] */
        ...
        l_0x1014_b090:
            ...
            ii(0x1014_b095, 3); mov(al, memb[ds, edx + 43]);            /* mov al, [edx+0x2b] */
            ii(0x1014_b098, 3); mov(memd[ss, ebp - 36], eax);           /* mov [ebp-0x24], eax */
            ii(0x1014_b09b, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_b09e, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_b0a0, 3); mov(dl, memb[ds, eax + 94]);            /* mov dl, [eax+0x5e] */
            ii(0x1014_b0a3, 4); movsx(eax, memw[ss, ebp - 36]);         /* movsx eax, word [ebp-0x24] */
            ii(0x1014_b0a7, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1014_b0a9, 4); movsx(eax, memw[ss, ebp - 36]);         /* movsx eax, word [ebp-0x24] */
        ...
        l_0x1014_b0e8:
            ...
            ii(0x1014_b0eb, 3); mov(al, memb[ds, eax + 78]);            /* mov al, [eax+0x4e] */
            ...
            ii(0x1014_b102, 3); mov(memd[ss, ebp - 40], eax);           /* mov [ebp-0x28], eax */
            ii(0x1014_b105, 3); mov(eax, memd[ss, ebp - 40]);           /* mov eax, [ebp-0x28] */
            ii(0x1014_b108, 3); mov(edx, memd[ds, eax + 2]);            /* mov edx, [eax+0x2] */
            ii(0x1014_b10b, 3); mov(eax, memd[ss, ebp - 40]);           /* mov eax, [ebp-0x28] */
            ii(0x1014_b10e, 3); call_abs(memd[ds, edx + 56]);           /* call dword [edx+0x38] */
            ii(0x1014_b111, 3); cmp(eax, 1);                            /* cmp eax, 0x1 */
            ii(0x1014_b114, 2); if(jnz(0x1014_b13d, 0x27)) goto l_0x1014_b13d; /* jnz 0x1014b13d */
        l_0x1014_b116:
            ii(0x1014_b116, 4); sar(memw[ss, ebp - 36], 1);             /* sar word [ebp-0x24], 1 */
            ii(0x1014_b11a, 4); movsx(eax, memw[ss, ebp - 36]);         /* movsx eax, word [ebp-0x24] */
            ii(0x1014_b11e, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1014_b120, 2); if(jnz(0x1014_b128, 6)) goto l_0x1014_b128; /* jnz 0x1014b128 */
            ii(0x1014_b122, 3); mov(eax, memd[ss, ebp - 36]);           /* mov eax, [ebp-0x24] */
            ii(0x1014_b125, 3); inc(memd[ss, ebp - 36]);                /* inc dword [ebp-0x24] */
        l_0x1014_b128:
            ii(0x1014_b128, 3); mov(al, memb[ss, ebp - 36]);            /* mov al, [ebp-0x24] */
            ii(0x1014_b12b, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1014_b12e, 3); mov(memb[ds, edx + 43], al);            /* mov [edx+0x2b], al */
            ii(0x1014_b131, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_b134, 3); mov(dl, memb[ds, eax + 43]);            /* mov dl, [eax+0x2b] */
            ii(0x1014_b137, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_b13a, 3); mov(memb[ds, eax + 42], dl);            /* mov [eax+0x2a], dl */
        l_0x1014_b13d:
            ii(0x1014_b13d, 3); mov(al, memb[ss, ebp - 36]);            /* mov al, [ebp-0x24] */
            ii(0x1014_b140, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1014_b143, 3); add(memb[ds, edx + 94], al);            /* add [edx+0x5e], al */
            ii(0x1014_b146, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1014_b149, 3); mov(dl, memb[ds, edx + 41]);            /* mov dl, [edx+0x29] */
            ii(0x1014_b14c, 6); and(edx, 0xff);                         /* and edx, 0xff */
            ii(0x1014_b152, 8); movsx(ax, memb[ds, edx + 0x101b_d914]); /* movsx ax, byte [edx+0x101bd914] */
            ii(0x1014_b15a, 3); mov(memd[ss, ebp - 44], eax);           /* mov [ebp-0x2c], eax */
            ii(0x1014_b15d, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1014_b160, 3); mov(dl, memb[ds, edx + 41]);            /* mov dl, [edx+0x29] */
            ii(0x1014_b163, 6); and(edx, 0xff);                         /* and edx, 0xff */
            ii(0x1014_b169, 8); movsx(ax, memb[ds, edx + 0x101b_d91c]); /* movsx ax, byte [edx+0x101bd91c] */
            ii(0x1014_b171, 3); mov(memd[ss, ebp - 48], eax);           /* mov [ebp-0x30], eax */
            ii(0x1014_b174, 3); mov(eax, memd[ss, ebp - 44]);           /* mov eax, [ebp-0x2c] */
            ii(0x1014_b177, 4); imul(eax, memd[ss, ebp - 36]);          /* imul eax, [ebp-0x24] */
            ii(0x1014_b17b, 3); mov(memd[ss, ebp - 52], eax);           /* mov [ebp-0x34], eax */
            ii(0x1014_b17e, 3); mov(eax, memd[ss, ebp - 48]);           /* mov eax, [ebp-0x30] */
            ii(0x1014_b181, 4); imul(eax, memd[ss, ebp - 36]);          /* imul eax, [ebp-0x24] */
            ii(0x1014_b185, 3); mov(memd[ss, ebp - 56], eax);           /* mov [ebp-0x38], eax */
            ii(0x1014_b188, 4); movsx(eax, memw[ss, ebp - 52]);         /* movsx eax, word [ebp-0x34] */
            ii(0x1014_b18c, 4); movsx(edx, memw[ss, ebp - 44]);         /* movsx edx, word [ebp-0x2c] */
            ii(0x1014_b190, 2); sub(eax, edx);                          /* sub eax, edx */
            ii(0x1014_b192, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1014_b195, 3); mov(edx, memd[ds, edx + 20]);           /* mov edx, [edx+0x14] */
            ...
            ii(0x1014_b1a5, 3); mov(eax, memd[ds, edx + 24]);           /* mov eax, [edx+0x18] */
            ii(0x1014_b1a8, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1014_b1ab, 2); sub(ebx, eax);                          /* sub ebx, eax */
            ii(0x1014_b1ad, 3); mov(memd[ss, ebp - 60], ebx);           /* mov [ebp-0x3c], ebx */
            ii(0x1014_b1b0, 4); movsx(edx, memw[ss, ebp - 56]);         /* movsx edx, word [ebp-0x38] */
            ii(0x1014_b1b4, 4); movsx(eax, memw[ss, ebp - 48]);         /* movsx eax, word [ebp-0x30] */
            ...
            ii(0x1014_b1bf, 3); mov(edx, memd[ds, edx + 22]);           /* mov edx, [edx+0x16] */
            ...
            ii(0x1014_b1cf, 3); mov(eax, memd[ds, edx + 26]);           /* mov eax, [edx+0x1a] */
            ii(0x1014_b1d2, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1014_b1d5, 2); sub(ebx, eax);                          /* sub ebx, eax */
            ii(0x1014_b1d7, 3); mov(memd[ss, ebp - 64], ebx);           /* mov [ebp-0x40], ebx */
            ii(0x1014_b1da, 4); movsx(edx, memw[ss, ebp - 60]);         /* movsx edx, word [ebp-0x3c] */
            ii(0x1014_b1de, 4); movsx(eax, memw[ss, ebp - 64]);         /* movsx eax, word [ebp-0x40] */
            ...
            ii(0x1014_b1e8, 3); lea(edx, memd[ss, ebp - 68]);           /* lea edx, [ebp-0x44] */
            ii(0x1014_b1eb, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_b1ee, 5); call(0x1014_edfa, 0x3c07);              /* call 0x1014edfa */
            ii(0x1014_b1f3, 3); lea(ebx, memd[ss, ebp - 20]);           /* lea ebx, [ebp-0x14] */
            ...
            ii(0x1014_b201, 3); lea(eax, memd[ss, ebp - 68]);           /* lea eax, [ebp-0x44] */
        ...
        l_0x1014_b21e:
            ...
            ii(0x1014_b228, 6); mov(al, memb[ds, eax + 171]);           /* mov al, [eax+0xab] */
            ii(0x1014_b22e, 3); mov(memb[ss, ebp - 8], al);             /* mov [ebp-0x8], al */
            ii(0x1014_b231, 4); movsx(ebx, memw[ss, ebp - 56]);         /* movsx ebx, word [ebp-0x38] */
            ii(0x1014_b235, 4); movsx(edx, memw[ss, ebp - 52]);         /* movsx edx, word [ebp-0x34] */
            ii(0x1014_b239, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_b23c, 5); call(0x1014_9c2f, -0x1612);             /* call 0x10149c2f */
            ii(0x1014_b241, 4); movsx(edx, memw[ss, ebp - 60]);         /* movsx edx, word [ebp-0x3c] */
            ii(0x1014_b245, 4); movsx(eax, memw[ss, ebp - 64]);         /* movsx eax, word [ebp-0x40] */
            ...
            ii(0x1014_b256, 3); mov(eax, memd[ds, eax + 20]);           /* mov eax, [eax+0x14] */
            ...
            ii(0x1014_b264, 4); mov(memw[ds, eax + 26], dx);            /* mov [eax+0x1a], dx */
            ii(0x1014_b268, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_b26b, 3); mov(eax, memd[ds, eax + 22]);           /* mov eax, [eax+0x16] */
            ...
            ii(0x1014_b279, 4); mov(memw[ds, eax + 28], dx);            /* mov [eax+0x1c], dx */
            ...
            ii(0x1014_b299, 3); mov(memd[ss, ebp - 72], eax);           /* mov [ebp-0x48], eax */
            ii(0x1014_b29c, 3); lea(edx, memd[ss, ebp - 76]);           /* lea edx, [ebp-0x4c] */
            ii(0x1014_b29f, 3); mov(eax, memd[ss, ebp - 72]);           /* mov eax, [ebp-0x48] */
            ii(0x1014_b2a2, 5); call(0x100b_8204, -0x9_30a3);           /* call 0x100b8204 */
            ii(0x1014_b2a7, 3); mov(eax, memd[ss, ebp - 72]);           /* mov eax, [ebp-0x48] */
            ii(0x1014_b2aa, 5); call(0x1015_537c, 0xa0cd);              /* call 0x1015537c */
            ii(0x1014_b2af, 3); mov(memd[ss, ebp - 80], eax);           /* mov [ebp-0x50], eax */
            ii(0x1014_b2b2, 4); movsx(edx, memw[ss, ebp - 80]);         /* movsx edx, word [ebp-0x50] */
            ii(0x1014_b2b6, 3); lea(eax, memd[ss, ebp - 76]);           /* lea eax, [ebp-0x4c] */
            ii(0x1014_b2b9, 5); call(0x100b_827c, -0x9_3042);           /* call 0x100b827c */
            ii(0x1014_b2be, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1014_b2c0, 3); mov(al, memb[ss, ebp - 60]);            /* mov al, [ebp-0x3c] */
            ii(0x1014_b2c3, 2); sub(memb[ds, edx], al);                 /* sub [edx], al */
            ii(0x1014_b2c5, 4); movsx(edx, memw[ss, ebp - 80]);         /* movsx edx, word [ebp-0x50] */
            ii(0x1014_b2c9, 3); lea(eax, memd[ss, ebp - 76]);           /* lea eax, [ebp-0x4c] */
            ii(0x1014_b2cc, 5); call(0x100b_827c, -0x9_3055);           /* call 0x100b827c */
            ii(0x1014_b2d1, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1014_b2d3, 3); mov(al, memb[ss, ebp - 64]);            /* mov al, [ebp-0x40] */
            ii(0x1014_b2d6, 3); sub(memb[ds, edx + 1], al);             /* sub [edx+0x1], al */
            ii(0x1014_b2d9, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_b2db, 3); lea(eax, memd[ss, ebp - 76]);           /* lea eax, [ebp-0x4c] */
        ...
        l_0x1014_b2e3:
            ...
            ii(0x1014_b2f2, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
        ...
        l_0x1014_b2ff:
            ...
            ii(0x1014_b309, 7); cmp(memb[ds, eax + 171], 0);            /* cmp byte [eax+0xab], 0x0 */
        ...
        l_0x1014_b341:
            ...
            ii(0x1014_b344, 6); mov(edx, memd[ds, eax + 211]);          /* mov edx, [eax+0xd3] */
            ii(0x1014_b34a, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1014_b34d, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_b350, 3); mov(eax, memd[ds, eax + 57]);           /* mov eax, [eax+0x39] */
            ...
            ii(0x1014_b362, 3); mov(dl, memb[ds, eax + 41]);            /* mov dl, [eax+0x29] */
            ii(0x1014_b365, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_b368, 4); mov(ax, memw[ds, eax + 51]);            /* mov ax, [eax+0x33] */
        ...
        l_0x1014_b37b:
            ...
            ii(0x1014_b37e, 7); mov(ax, memw[ds, eax + 213]);           /* mov ax, [eax+0xd5] */
        ...
        l_0x1014_b395:
            ...
            ii(0x1014_b398, 3); mov(al, memb[ds, eax + 94]);            /* mov al, [eax+0x5e] */
            ...
            ii(0x1014_b3b4, 3); mov(memd[ss, ebp - 84], eax);           /* mov [ebp-0x54], eax */
            ii(0x1014_b3b7, 3); mov(eax, memd[ss, ebp - 84]);           /* mov eax, [ebp-0x54] */
            ii(0x1014_b3ba, 3); mov(ebx, memd[ds, eax + 2]);            /* mov ebx, [eax+0x2] */
            ii(0x1014_b3bd, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1014_b3c0, 3); mov(eax, memd[ss, ebp - 84]);           /* mov eax, [ebp-0x54] */
            ii(0x1014_b3c3, 3); call_abs(memd[ds, ebx + 44]);           /* call dword [ebx+0x2c] */
            ii(0x1014_b3c6, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_b3c9, 4); cmp(memb[ds, eax + 61], 4);             /* cmp byte [eax+0x3d], 0x4 */
        ...
        l_0x1014_b42c:
            ...
            ii(0x1014_b42f, 4); mov(memb[ds, eax + 62], 5);             /* mov byte [eax+0x3e], 0x5 */
        l_0x1014_b433:
            ii(0x1014_b433, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_b436, 4); cmp(memb[ds, eax + 61], 2);             /* cmp byte [eax+0x3d], 0x2 */
            ...
            ii(0x1014_b43f, 4); cmp(memb[ds, eax + 61], 0x1b);          /* cmp byte [eax+0x3d], 0x1b */
        ...
        l_0x1014_b447:
            ...
            ii(0x1014_b44a, 4); cmp(memb[ds, eax + 61], 0x1e);          /* cmp byte [eax+0x3d], 0x1e */
        ...
        l_0x1014_b476:
            ...
            ii(0x1014_b479, 3); mov(al, memb[ds, eax + 38]);            /* mov al, [eax+0x26] */
            ...
            ii(0x1014_b484, 3); mov(ebx, memd[ds, eax + 26]);           /* mov ebx, [eax+0x1a] */
            ii(0x1014_b487, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1014_b48a, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_b48d, 3); mov(edx, memd[ds, eax + 24]);           /* mov edx, [eax+0x18] */
            ii(0x1014_b490, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1014_b493, 3); lea(eax, memd[ss, ebp - 88]);           /* lea eax, [ebp-0x58] */
            ...
            ii(0x1014_b4c4, 3); lea(eax, memd[ss, ebp - 92]);           /* lea eax, [ebp-0x5c] */
            ii(0x1014_b4c7, 5); call(0x1007_66ac, -0xd_4e20);           /* call 0x100766ac */
            ii(0x1014_b4cc, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_b4ce, 3); lea(eax, memd[ss, ebp - 92]);           /* lea eax, [ebp-0x5c] */
            ...
            ii(0x1014_b4de, 3); lea(eax, memd[ss, ebp - 92]);           /* lea eax, [ebp-0x5c] */
            ii(0x1014_b4e1, 5); call(0x1007_6574, -0xd_4f72);           /* call 0x10076574 */
            ii(0x1014_b4e6, 4); mov(memb[ds, eax + 61], 9);             /* mov byte [eax+0x3d], 0x9 */
            ii(0x1014_b4ea, 3); lea(eax, memd[ss, ebp - 92]);           /* lea eax, [ebp-0x5c] */
            ii(0x1014_b4ed, 5); call(0x1007_6574, -0xd_4f7e);           /* call 0x10076574 */
            ii(0x1014_b4f2, 4); mov(memb[ds, eax + 62], 0x1b);          /* mov byte [eax+0x3e], 0x1b */
            ii(0x1014_b4f6, 3); lea(eax, memd[ss, ebp - 92]);           /* lea eax, [ebp-0x5c] */
            ...
            ii(0x1014_b503, 3); mov(al, memb[ds, eax + 38]);            /* mov al, [eax+0x26] */
            ii(0x1014_b506, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x1014_b50b, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1014_b50d, 7); mov(memb[ds, eax + 171], 1);            /* mov byte [eax+0xab], 0x1 */
            ii(0x1014_b514, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_b517, 3); mov(al, memb[ds, eax + 38]);            /* mov al, [eax+0x26] */
            ii(0x1014_b51a, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1014_b51c, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1014_b51f, 3); lea(eax, memd[ss, ebp - 92]);           /* lea eax, [ebp-0x5c] */
            ...
            ii(0x1014_b52f, 4); cmp(memb[ds, eax + 61], 0x1e);          /* cmp byte [eax+0x3d], 0x1e */
            ...
            ii(0x1014_b538, 4); mov(memb[ds, eax + 61], 0);             /* mov byte [eax+0x3d], 0x0 */
        l_0x1014_b53c:
            ...
            ii(0x1014_b54f, 3); lea(eax, memd[ss, ebp - 92]);           /* lea eax, [ebp-0x5c] */
            ii(0x1014_b552, 5); call(0x1007_5f2c, -0xd_562b);           /* call 0x10075f2c */
            ii(0x1014_b557, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_b559, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
        ...
        l_0x1014_b566:
            ...
            ii(0x1014_b569, 7); cmp(memb[ds, eax + 166], 2);            /* cmp byte [eax+0xa6], 0x2 */
        ...
        l_0x1014_b57a:
            ...
            ii(0x1014_b57d, 7); cmp(memb[ds, eax + 166], 1);            /* cmp byte [eax+0xa6], 0x1 */
        ...
        l_0x1014_b58e:
            ...
            ii(0x1014_b590, 3); lea(eax, memd[ss, ebp - 92]);           /* lea eax, [ebp-0x5c] */
        ...
        l_0x1014_b598:
            ...
            ii(0x1014_b5a3, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
        ...
        l_0x1014_b5ad:
            ...
            ii(0x1014_b5b0, 4); cmp(memb[ds, eax + 62], 5);             /* cmp byte [eax+0x3e], 0x5 */
        ...
        l_0x1014_b5c6:
            ...
            ii(0x1014_b5c9, 4); cmp(memb[ds, eax + 62], 6);             /* cmp byte [eax+0x3e], 0x6 */
        ...
        l_0x1014_b5dc:
            ...
            ii(0x1014_b5de, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
