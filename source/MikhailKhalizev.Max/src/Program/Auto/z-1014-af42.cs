...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_af42()
        {
            ...
            ii(0x1014_af5a, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_af5d, 4); or(memb[ss, ebp - 0xc], 0x1);           /* or byte [ebp-0xc], 0x1 */
            ...
            ii(0x1014_af6c, 4); and(memb[ss, ebp - 0xc], -0x2 /* 0xfe */); /* and byte [ebp-0xc], 0xfe */
        l_0x1014_af70:
            ii(0x1014_af70, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1014_af8f:
            ii(0x1014_af8f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_af92, 5); call(0x1014_9fa8, -0xfef);              /* call 0x10149fa8 */
            ii(0x1014_af97, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_af9a, 3); mov(dl, memb[ds, eax + 0x2b]);          /* mov dl, [eax+0x2b] */
            ii(0x1014_af9d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_afa5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_afb5, 2); if(jz(0x1014_afc0, 0x9)) goto l_0x1014_afc0; /* jz 0x1014afc0 */
            ii(0x1014_afb7, 7); mov(memd[ss, ebp - 0x1c], 0x2);         /* mov dword [ebp-0x1c], 0x2 */
            ii(0x1014_afbe, 2); jmp(0x1014_afc7, 0x7); goto l_0x1014_afc7; /* jmp 0x1014afc7 */
        l_0x1014_afc0:
            ii(0x1014_afc0, 7); mov(memd[ss, ebp - 0x1c], 0x1);         /* mov dword [ebp-0x1c], 0x1 */
        l_0x1014_afc7:
        ...
        l_0x1014_afd9:
            ii(0x1014_afd9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_afdc, 3); mov(dl, memb[ds, eax + 0x2b]);          /* mov dl, [eax+0x2b] */
            ii(0x1014_afdf, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_afe7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_afea, 3); mov(dl, memb[ds, eax + 0x2a]);          /* mov dl, [eax+0x2a] */
            ii(0x1014_afed, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_aff0, 3); mov(memb[ds, eax + 0x2b], dl);          /* mov [eax+0x2b], dl */
        l_0x1014_aff3:
            ii(0x1014_aff3, 5); mov(edx, 0x101c_37bc);                  /* mov edx, 0x101c37bc */
            ii(0x1014_aff8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b008, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b017, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b028, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
        ...
        l_0x1014_b036:
            ...
            ii(0x1014_b044, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x1014_b053:
            ii(0x1014_b053, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b063, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b071, 2); if(jnz(0x1014_b075, 0x2)) goto l_0x1014_b075; /* jnz 0x1014b075 */
        l_0x1014_b073:
        ...
        l_0x1014_b075:
            ...
            ii(0x1014_b083, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x1014_b090:
            ...
            ii(0x1014_b0c0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b0d2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b0d5, 5); cmp(memw[ds, eax + 0x8], 0x42);         /* cmp word [eax+0x8], 0x42 */
            ii(0x1014_b0da, 2); if(jz(0x1014_b0e6, 0xa)) goto l_0x1014_b0e6; /* jz 0x1014b0e6 */
            ii(0x1014_b0dc, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b0df, 5); cmp(memw[ds, eax + 0x8], 0x43);         /* cmp word [eax+0x8], 0x43 */
            ii(0x1014_b0e4, 2); if(jnz(0x1014_b0e8, 0x2)) goto l_0x1014_b0e8; /* jnz 0x1014b0e8 */
        l_0x1014_b0e6:
            ii(0x1014_b0e6, 2); jmp(0x1014_b13d, 0x55); goto l_0x1014_b13d; /* jmp 0x1014b13d */
        l_0x1014_b0e8:
            ii(0x1014_b0e8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b0f7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b108, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
        ...
        l_0x1014_b116:
            ii(0x1014_b116, 4); sar(memw[ss, ebp - 0x24], 0x1);         /* sar word [ebp-0x24], 1 */
            ii(0x1014_b11a, 4); movsx(eax, memw[ss, ebp - 0x24]);       /* movsx eax, word [ebp-0x24] */
            ii(0x1014_b11e, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1014_b120, 2); if(jnz(0x1014_b128, 0x6)) goto l_0x1014_b128; /* jnz 0x1014b128 */
        ...
        l_0x1014_b128:
            ...
            ii(0x1014_b12b, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_b12e, 3); mov(memb[ds, edx + 0x2b], al);          /* mov [edx+0x2b], al */
            ii(0x1014_b131, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b134, 3); mov(dl, memb[ds, eax + 0x2b]);          /* mov dl, [eax+0x2b] */
            ii(0x1014_b137, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b13a, 3); mov(memb[ds, eax + 0x2a], dl);          /* mov [eax+0x2a], dl */
        l_0x1014_b13d:
            ii(0x1014_b13d, 3); mov(al, memb[ss, ebp - 0x24]);          /* mov al, [ebp-0x24] */
            ii(0x1014_b140, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_b143, 3); add(memb[ds, edx + 0x5e], al);          /* add [edx+0x5e], al */
            ii(0x1014_b146, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1014_b15d, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1014_b192, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1014_b1a2, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1014_b1bc, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1014_b1cc, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1014_b1eb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1014_b21e:
            ...
            ii(0x1014_b225, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1014_b228, 6); mov(al, memb[ds, eax + 0xab]);          /* mov al, [eax+0xab] */
            ii(0x1014_b22e, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ...
            ii(0x1014_b239, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b253, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b261, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b264, 4); mov(memw[ds, eax + 0x1a], dx);          /* mov [eax+0x1a], dx */
            ii(0x1014_b268, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b276, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b279, 4); mov(memw[ds, eax + 0x1c], dx);          /* mov [eax+0x1c], dx */
            ii(0x1014_b27d, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_b27f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b28e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b2d6, 3); sub(memb[ds, edx + 0x1], al);           /* sub [edx+0x1], al */
        ...
        l_0x1014_b2e3:
            ...
            ii(0x1014_b2e8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1014_b2ff:
            ...
            ii(0x1014_b306, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1014_b309, 7); cmp(memb[ds, eax + 0xab], 0);           /* cmp byte [eax+0xab], 0x0 */
            ii(0x1014_b310, 2); if(jz(0x1014_b316, 0x4)) goto l_0x1014_b316; /* jz 0x1014b316 */
            ii(0x1014_b312, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
        l_0x1014_b316:
            ii(0x1014_b316, 4); cmp(memb[ss, ebp - 0x8], 0);            /* cmp byte [ebp-0x8], 0x0 */
            ii(0x1014_b31a, 2); if(jnz(0x1014_b325, 0x9)) goto l_0x1014_b325; /* jnz 0x1014b325 */
            ii(0x1014_b31c, 7); cmp(memb[ds, 0x101c_3980], 0);          /* cmp byte [0x101c3980], 0x0 */
            ii(0x1014_b323, 2); if(jz(0x1014_b32d, 0x8)) goto l_0x1014_b32d; /* jz 0x1014b32d */
        l_0x1014_b325:
            ii(0x1014_b325, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b328, 5); call(0x1014_9fa8, -0x1385);             /* call 0x10149fa8 */
        l_0x1014_b32d:
            ii(0x1014_b32d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b330, 5); cmp(memw[ds, eax + 0x8], 0x42);         /* cmp word [eax+0x8], 0x42 */
            ii(0x1014_b335, 2); if(jz(0x1014_b341, 0xa)) goto l_0x1014_b341; /* jz 0x1014b341 */
            ii(0x1014_b337, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b33a, 5); cmp(memw[ds, eax + 0x8], 0x43);         /* cmp word [eax+0x8], 0x43 */
            ii(0x1014_b33f, 2); if(jnz(0x1014_b395, 0x54)) goto l_0x1014_b395; /* jnz 0x1014b395 */
        l_0x1014_b341:
            ii(0x1014_b341, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b344, 6); mov(edx, memd[ds, eax + 0xd3]);         /* mov edx, [eax+0xd3] */
            ii(0x1014_b34a, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1014_b34d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b35d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b360, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_b362, 3); mov(dl, memb[ds, eax + 0x29]);          /* mov dl, [eax+0x29] */
            ii(0x1014_b365, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b371, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1014_b37b:
            ii(0x1014_b37b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b38d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b390, 5); call(0x1014_9b07, -0x188e);             /* call 0x10149b07 */
        l_0x1014_b395:
            ii(0x1014_b395, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b3a9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b3ba, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x1014_b3bd, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_b3c0, 3); mov(eax, memd[ss, ebp - 0x54]);         /* mov eax, [ebp-0x54] */
            ii(0x1014_b3c3, 3); call_abs(memd[ds, ebx + 0x2c]);         /* call dword [ebx+0x2c] */
            ii(0x1014_b3c6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b3c9, 4); cmp(memb[ds, eax + 0x3d], 0x4);         /* cmp byte [eax+0x3d], 0x4 */
            ii(0x1014_b3cd, 2); if(jnz(0x1014_b3df, 0x10)) goto l_0x1014_b3df; /* jnz 0x1014b3df */
            ii(0x1014_b3cf, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b3dd, 2); if(jg(0x1014_b3e1, 0x2)) goto l_0x1014_b3e1; /* jg 0x1014b3e1 */
        l_0x1014_b3df:
        ...
        l_0x1014_b3e1:
            ...
            ii(0x1014_b406, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b41e, 2); if(jnz(0x1014_b422, 0x2)) goto l_0x1014_b422; /* jnz 0x1014b422 */
        l_0x1014_b420:
            ii(0x1014_b420, 2); jmp(0x1014_b42c, 0xa); goto l_0x1014_b42c; /* jmp 0x1014b42c */
        l_0x1014_b422:
            ii(0x1014_b422, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b425, 5); call(0x1014_ae37, -0x5f3);              /* call 0x1014ae37 */
            ii(0x1014_b42a, 2); jmp(0x1014_b433, 0x7); goto l_0x1014_b433; /* jmp 0x1014b433 */
        l_0x1014_b42c:
            ii(0x1014_b42c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b42f, 4); mov(memb[ds, eax + 0x3e], 0x5);         /* mov byte [eax+0x3e], 0x5 */
        l_0x1014_b433:
            ii(0x1014_b433, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b436, 4); cmp(memb[ds, eax + 0x3d], 0x2);         /* cmp byte [eax+0x3d], 0x2 */
            ii(0x1014_b43a, 2); if(jz(0x1014_b445, 0x9)) goto l_0x1014_b445; /* jz 0x1014b445 */
            ii(0x1014_b43c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b43f, 4); cmp(memb[ds, eax + 0x3d], 0x1b);        /* cmp byte [eax+0x3d], 0x1b */
            ii(0x1014_b443, 2); if(jnz(0x1014_b447, 0x2)) goto l_0x1014_b447; /* jnz 0x1014b447 */
        l_0x1014_b445:
            ii(0x1014_b445, 2); jmp(0x1014_b450, 0x9); goto l_0x1014_b450; /* jmp 0x1014b450 */
        l_0x1014_b447:
            ii(0x1014_b447, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b44a, 4); cmp(memb[ds, eax + 0x3d], 0x1e);        /* cmp byte [eax+0x3d], 0x1e */
            ii(0x1014_b44e, 2); if(jnz(0x1014_b458, 0x8)) goto l_0x1014_b458; /* jnz 0x1014b458 */
        l_0x1014_b450:
            ii(0x1014_b450, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b453, 5); call(0x1014_f12b, 0x3cd3);              /* call 0x1014f12b */
        l_0x1014_b458:
            ii(0x1014_b458, 5); mov(edx, 0x101c_37bc);                  /* mov edx, 0x101c37bc */
            ii(0x1014_b45d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b469, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_b46c, 5); mov(eax, 0x101c_7278);                  /* mov eax, 0x101c7278 */
            ii(0x1014_b471, 5); call(0x1013_de44, -0xd632);             /* call 0x1013de44 */
        l_0x1014_b476:
            ii(0x1014_b476, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b481, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b484, 3); mov(ebx, memd[ds, eax + 0x1a]);         /* mov ebx, [eax+0x1a] */
            ii(0x1014_b487, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1014_b48a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b4e6, 4); mov(memb[ds, eax + 0x3d], 0x9);         /* mov byte [eax+0x3d], 0x9 */
            ...
            ii(0x1014_b500, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b50d, 7); mov(memb[ds, eax + 0xab], 0x1);         /* mov byte [eax+0xab], 0x1 */
            ii(0x1014_b514, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_b52c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b52f, 4); cmp(memb[ds, eax + 0x3d], 0x1e);        /* cmp byte [eax+0x3d], 0x1e */
            ii(0x1014_b533, 2); if(jnz(0x1014_b53c, 0x7)) goto l_0x1014_b53c; /* jnz 0x1014b53c */
            ii(0x1014_b535, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1014_b53c:
            ...
            ii(0x1014_b545, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1014_b566:
            ii(0x1014_b566, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b569, 7); cmp(memb[ds, eax + 0xa6], 0x2);         /* cmp byte [eax+0xa6], 0x2 */
            ii(0x1014_b570, 2); if(jnz(0x1014_b57a, 0x8)) goto l_0x1014_b57a; /* jnz 0x1014b57a */
            ii(0x1014_b572, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b575, 5); call(0x1015_3997, 0x841d);              /* call 0x10153997 */
        l_0x1014_b57a:
            ii(0x1014_b57a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b57d, 7); cmp(memb[ds, eax + 0xa6], 0x1);         /* cmp byte [eax+0xa6], 0x1 */
            ii(0x1014_b584, 2); if(jnz(0x1014_b58e, 0x8)) goto l_0x1014_b58e; /* jnz 0x1014b58e */
            ii(0x1014_b586, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1014_b5ad:
            ii(0x1014_b5ad, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b5b0, 4); cmp(memb[ds, eax + 0x3e], 0x5);         /* cmp byte [eax+0x3e], 0x5 */
            ii(0x1014_b5b4, 2); if(jnz(0x1014_b5bc, 0x6)) goto l_0x1014_b5bc; /* jnz 0x1014b5bc */
            ii(0x1014_b5b6, 4); cmp(memb[ss, ebp - 0x8], 0);            /* cmp byte [ebp-0x8], 0x0 */
            ii(0x1014_b5ba, 2); if(jz(0x1014_b5be, 0x2)) goto l_0x1014_b5be; /* jz 0x1014b5be */
        l_0x1014_b5bc:
            ii(0x1014_b5bc, 2); jmp(0x1014_b5c6, 0x8); goto l_0x1014_b5c6; /* jmp 0x1014b5c6 */
        l_0x1014_b5be:
            ii(0x1014_b5be, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b5c1, 5); call(0x1014_ac97, -0x92f);              /* call 0x1014ac97 */
        l_0x1014_b5c6:
            ii(0x1014_b5c6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b5c9, 4); cmp(memb[ds, eax + 0x3e], 0x6);         /* cmp byte [eax+0x3e], 0x6 */
            ii(0x1014_b5cd, 2); if(jnz(0x1014_b5d5, 0x6)) goto l_0x1014_b5d5; /* jnz 0x1014b5d5 */
            ii(0x1014_b5cf, 4); cmp(memb[ss, ebp - 0x8], 0);            /* cmp byte [ebp-0x8], 0x0 */
            ii(0x1014_b5d3, 2); if(jz(0x1014_b5d7, 0x2)) goto l_0x1014_b5d7; /* jz 0x1014b5d7 */
        l_0x1014_b5d5:
            ii(0x1014_b5d5, 2); jmp(0x1014_b5dc, 0x5); goto l_0x1014_b5dc; /* jmp 0x1014b5dc */
        l_0x1014_b5d7:
