...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("f02c94be-91fa-4e4a-a05f-5e426009a0ab")]
        public void Method_1009_b834()
        {
            ii(0x1009_b834, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x1009_b839, 5); calld(Definitions.sys_check_available_stack_size, 0xca514); /* call 0x10165d52 */
            ...
            ii(0x1009_b859, 5); calld(0x1013_a1be, 0x9e960);            /* call 0x1013a1be */
