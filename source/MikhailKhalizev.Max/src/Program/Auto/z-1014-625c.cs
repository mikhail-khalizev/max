...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("c7e2f1f8-be4a-4185-998f-1d53f240844f")]
        public void Method_1014_625c()
        {
            ii(0x1014_625c, 5); pushd(0x34);                            /* push 0x34 */
            ii(0x1014_6261, 5); calld(Definitions.sys_check_available_stack_size, 0x1faec); /* call 0x10165d52 */
            ...
            ii(0x1014_6290, 5); calld(0x100e_0720, -0x65b75);           /* call 0x100e0720 */
            ...
            ii(0x1014_62ad, 5); calld(0x100e_0760, -0x65b52);           /* call 0x100e0760 */
