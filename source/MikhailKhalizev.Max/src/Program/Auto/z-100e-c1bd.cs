...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_c1bd()
        {
            ...
            ii(0x100e_c1d5, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x100e_c1f2, 2); if(jz(0x100e_c1f6, 0x2)) goto l_0x100e_c1f6; /* jz 0x100ec1f6 */
        l_0x100e_c1f4:
            ii(0x100e_c1f4, 2); jmp(0x100e_c1fe, 0x8); goto l_0x100e_c1fe; /* jmp 0x100ec1fe */
        l_0x100e_c1f6:
            ii(0x100e_c1f6, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100e_c1fa, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100e_c1fc, 2); if(jz(0x100e_c200, 0x2)) goto l_0x100e_c200; /* jz 0x100ec200 */
        l_0x100e_c1fe:
            ii(0x100e_c1fe, 2); jmp(0x100e_c206, 0x6); goto l_0x100e_c206; /* jmp 0x100ec206 */
        l_0x100e_c200:
            ii(0x100e_c200, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
        ...
        l_0x100e_c206:
            ...
            ii(0x100e_c20b, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100e_c21d, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100e_c221, 5); call(0x100e_bb28, -0x6fe);              /* call 0x100ebb28 */
            ii(0x100e_c226, 2); test(al, al);                           /* test al, al */
            ii(0x100e_c228, 2); if(jz(0x100e_c22c, 0x2)) goto l_0x100e_c22c; /* jz 0x100ec22c */
        l_0x100e_c22a:
        ...
        l_0x100e_c22c:
            ...
            ii(0x100e_c231, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100e_c235, 5); call(0x100e_bb28, -0x712);              /* call 0x100ebb28 */
            ii(0x100e_c23a, 2); test(al, al);                           /* test al, al */
            ii(0x100e_c23c, 2); if(jz(0x100e_c244, 0x6)) goto l_0x100e_c244; /* jz 0x100ec244 */
        l_0x100e_c23e:
            ii(0x100e_c23e, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x100e_c242, 2); jmp(0x100e_c263, 0x1f); goto l_0x100e_c263; /* jmp 0x100ec263 */
        l_0x100e_c244:
            ii(0x100e_c244, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100e_c248, 5); call(0x100e_bd26, -0x527);              /* call 0x100ebd26 */
            ii(0x100e_c24d, 2); test(al, al);                           /* test al, al */
            ii(0x100e_c24f, 2); if(jz(0x100e_c257, 0x6)) goto l_0x100e_c257; /* jz 0x100ec257 */
            ii(0x100e_c251, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x100e_c255, 2); jmp(0x100e_c263, 0xc); goto l_0x100e_c263; /* jmp 0x100ec263 */
        l_0x100e_c257:
            ii(0x100e_c257, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100e_c25b, 5); call(0x100e_bf7b, -0x2e5);              /* call 0x100ebf7b */
            ii(0x100e_c260, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
        l_0x100e_c263:
            ii(0x100e_c263, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
