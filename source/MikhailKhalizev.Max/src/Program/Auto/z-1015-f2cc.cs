...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("fea4cbf7-27f8-4b3a-b2a8-cad117ef048a")]
        public void Method_1015_f2cc()
        {
            ...
            ii(0x1015_f31e, 5); calld(0x1013_d5c0, -0x2_1d63);          /* call 0x1013d5c0 */
            ii(0x1015_f323, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_f325, 5); mov(eax, 0x101c_37bc);                  /* mov eax, 0x101c37bc */
            ii(0x1015_f32a, 5); calld(0x1007_6630, -0xe_8cff);          /* call 0x10076630 */
            ...
            ii(0x1015_f338, 5); calld(0x100f_a835, -0x6_4b08);          /* call 0x100fa835 */
            ii(0x1015_f33d, 5); mov(ebx, 0x1);                          /* mov ebx, 0x1 */
            ii(0x1015_f342, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_f344, 5); mov(eax, 0x6);                          /* mov eax, 0x6 */
            ii(0x1015_f349, 5); calld(0x100f_fca3, -0x5_f6ab);          /* call 0x100ffca3 */
            ii(0x1015_f34e, 5); mov(ebx, 0x1);                          /* mov ebx, 0x1 */
            ii(0x1015_f353, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_f355, 5); mov(eax, 0x9);                          /* mov eax, 0x9 */
            ii(0x1015_f35a, 5); calld(0x100f_fca3, -0x5_f6bc);          /* call 0x100ffca3 */
            ii(0x1015_f35f, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1015_f361, 5); calld(0x100f_448c, -0x6_aeda);          /* call 0x100f448c */
            ii(0x1015_f366, 5); calld(0x100f_f5c1, -0x5_fdaa);          /* call 0x100ff5c1 */
        l_0x1015_f36b:
        ...
        l_0x1015_f3b4:
            ...
            ii(0x1015_f3cc, 5); calld(0x1008_aab4, -0xd_491d);          /* call 0x1008aab4 */
            ii(0x1015_f3d1, 3); lea(eax, ebp - 0x8);                    /* lea eax, [ebp-0x8] */
            ii(0x1015_f3d4, 5); calld(0x1007_6574, -0xe_8e65);          /* call 0x10076574 */
            ii(0x1015_f3d9, 5); calld(0x1014_b6bd, -0x1_3d21);          /* call 0x1014b6bd */
            ii(0x1015_f3de, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_f3e0, 3); lea(eax, ebp - 0x8);                    /* lea eax, [ebp-0x8] */
            ii(0x1015_f3e3, 5); calld(0x1007_6574, -0xe_8e74);          /* call 0x10076574 */
            ii(0x1015_f3e8, 5); calld(0x1008_a998, -0xd_4a55);          /* call 0x1008a998 */
            ii(0x1015_f3ed, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_f3ef, 3); lea(eax, ebp - 0x8);                    /* lea eax, [ebp-0x8] */
            ii(0x1015_f3f2, 5); calld(0x1007_6574, -0xe_8e83);          /* call 0x10076574 */
            ii(0x1015_f3f7, 3); add(eax, 0x65);                         /* add eax, 0x65 */
            ii(0x1015_f3fa, 5); calld(0x1007_6a34, -0xe_89cb);          /* call 0x10076a34 */
            ...
            ii(0x1015_f40a, 5); calld(0x1014_a86a, -0x1_4ba5);          /* call 0x1014a86a */
            ii(0x1015_f40f, 3); mov(edx, memd_a32[ss, ebp - 0x4]);      /* mov edx, [ebp-0x4] */
            ii(0x1015_f412, 5); mov(eax, 0x101c_39b8);                  /* mov eax, 0x101c39b8 */
            ii(0x1015_f417, 5); calld(0x1010_3752, -0x5_bcca);          /* call 0x10103752 */
            ...
            ii(0x1015_f427, 5); calld(0x1014_9fa8, -0x1_5484);          /* call 0x10149fa8 */
            ...
            ii(0x1015_f437, 5); calld(0x1007_6154, -0xe_92e8);          /* call 0x10076154 */
        ...
        l_0x1015_f451:
            ...
            ii(0x1015_f456, 5); calld(0x1007_1838, -0xe_dc23);          /* call 0x10071838 */
        l_0x1015_f45b:
            ii(0x1015_f45b, 3); mov(edx, memd_a32[ss, ebp - 0x4]);      /* mov edx, [ebp-0x4] */
            ii(0x1015_f45e, 5); mov(eax, 0x101c_39c0);                  /* mov eax, 0x101c39c0 */
            ii(0x1015_f463, 5); calld(0x1010_3f75, -0x5_b4f3);          /* call 0x10103f75 */
            ii(0x1015_f468, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1015_f46b, 5); calld(0x1007_6154, -0xe_931c);          /* call 0x10076154 */
        ...
        l_0x1015_f487:
            ...
            ii(0x1015_f48a, 5); calld(0x100a_8e92, -0xb_65fd);          /* call 0x100a8e92 */
        l_0x1015_f48f:
            ii(0x1015_f48f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_f491, 3); lea(eax, ebp - 0x8);                    /* lea eax, [ebp-0x8] */
            ii(0x1015_f494, 5); calld(0x1007_5f2c, -0xe_956d);          /* call 0x10075f2c */
