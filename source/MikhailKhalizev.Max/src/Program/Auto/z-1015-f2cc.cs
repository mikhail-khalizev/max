...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_f2cc()
        {
            ...
            ii(0x1015_f2e4, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_f2e7, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1015_f2ea, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1015_f2ed, 5); call(0x1007_66ac, -0xe_8c46);           /* call 0x100766ac */
            ii(0x1015_f2f2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_f2f5, 5); call(0x1011_fe27, -0x3_f4d3);           /* call 0x1011fe27 */
            ii(0x1015_f2fa, 3); lea(edx, memd[ss, ebp - 0x8]);          /* lea edx, [ebp-0x8] */
            ...
            ii(0x1015_f316, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x1015_f36b:
            ii(0x1015_f36b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_f36e, 4); cmp(memb[ds, eax + 0x3f], 0x3);         /* cmp byte [eax+0x3f], 0x3 */
            ii(0x1015_f372, 2); if(jnz(0x1015_f37d, 0x9)) goto l_0x1015_f37d; /* jnz 0x1015f37d */
            ii(0x1015_f374, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_f377, 4); cmp(memb[ds, eax + 0x40], 0);           /* cmp byte [eax+0x40], 0x0 */
            ii(0x1015_f37b, 2); if(jnz(0x1015_f37f, 0x2)) goto l_0x1015_f37f; /* jnz 0x1015f37f */
        l_0x1015_f37d:
        ...
        l_0x1015_f37f:
            ...
            ii(0x1015_f384, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_f387, 3); mov(ebx, memd[ds, eax + 0x41]);         /* mov ebx, [eax+0x41] */
            ii(0x1015_f38a, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1015_f38d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_f390, 3); mov(edx, memd[ds, eax + 0x3f]);         /* mov edx, [eax+0x3f] */
            ii(0x1015_f393, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1015_f396, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_f399, 5); call(0x1014_e906, -0x1_0a98);           /* call 0x1014e906 */
        l_0x1015_f39e:
            ii(0x1015_f39e, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1015_f3ad, 2); if(jz(0x1015_f3b4, 0x5)) goto l_0x1015_f3b4; /* jz 0x1015f3b4 */
            ii(0x1015_f3af, 5); call(0x100f_f5c1, -0x5_fdf3);           /* call 0x100ff5c1 */
        l_0x1015_f3b4:
            ii(0x1015_f3b4, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1015_f3b7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_f3ba, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ...
            ii(0x1015_f3d1, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x1015_f3e0, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x1015_f3ef, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x1015_f446, 2); if(jnz(0x1015_f451, 0x9)) goto l_0x1015_f451; /* jnz 0x1015f451 */
            ii(0x1015_f448, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_f44b, 4); test(memb[ds, eax + 0x12], 0x22);       /* test byte [eax+0x12], 0x22 */
            ii(0x1015_f44f, 2); if(jz(0x1015_f45b, 0xa)) goto l_0x1015_f45b; /* jz 0x1015f45b */
        l_0x1015_f451:
            ii(0x1015_f451, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_f453, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_f456, 5); call(0x1007_1838, -0xe_dc23);           /* call 0x10071838 */
        l_0x1015_f45b:
            ii(0x1015_f45b, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1015_f45e, 5); mov(eax, 0x101c_39c0);                  /* mov eax, 0x101c39c0 */
            ii(0x1015_f463, 5); call(0x1010_3f75, -0x5_b4f3);           /* call 0x10103f75 */
            ii(0x1015_f468, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_f47a, 2); if(jz(0x1015_f485, 0x9)) goto l_0x1015_f485; /* jz 0x1015f485 */
            ii(0x1015_f47c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_f47f, 4); test(memb[ds, eax + 0x12], 0x22);       /* test byte [eax+0x12], 0x22 */
            ii(0x1015_f483, 2); if(jz(0x1015_f487, 0x2)) goto l_0x1015_f487; /* jz 0x1015f487 */
        l_0x1015_f485:
            ii(0x1015_f485, 2); jmp(0x1015_f48f, 0x8); goto l_0x1015_f48f; /* jmp 0x1015f48f */
        l_0x1015_f487:
            ii(0x1015_f487, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_f48a, 5); call(0x100a_8e92, -0xb_65fd);           /* call 0x100a8e92 */
        l_0x1015_f48f:
            ii(0x1015_f48f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_f491, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
