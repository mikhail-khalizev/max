...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_b1a1()
        {
            ...
            ii(0x1010_b1b9, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_b1bc, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_b1bf, 3); mov(edx, memd[ds, eax + 0xd]);          /* mov edx, [eax+0xd] */
            ...
            ii(0x1010_b1cf, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_b1d2, 5); call(0x1010_a564, -0xc73);              /* call 0x1010a564 */
            ii(0x1010_b1d7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_b1da, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1010_b1dc, 3); mov(eax, memd[ds, eax + 0x12]);         /* mov eax, [eax+0x12] */
