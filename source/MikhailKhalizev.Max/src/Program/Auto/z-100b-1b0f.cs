...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_1b0f()
        {
            ...
            ii(0x100b_1b26, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_1b29, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100b_1b2c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_1b2f, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100b_1b32, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100b_1b35, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x100b_1b38, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100b_1b3b, 3); call_abs(memd[ds, edx + 0x20]);         /* call dword [edx+0x20] */
            ii(0x100b_1b3e, 2); cmp(al, 0x17);                          /* cmp al, 0x17 */
            ii(0x100b_1b40, 6); if(jnz(0x100b_1bcb, 0x85)) goto l_0x100b_1bcb; /* jnz 0x100b1bcb */
            ii(0x100b_1b46, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_1b49, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100b_1b4c, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x100b_1b58, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100b_1b5b, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100b_1b5e, 5); call(0x100b_7d68, 0x6205);              /* call 0x100b7d68 */
            ii(0x100b_1b63, 5); call(0x1015_27b8, 0xa_0c50);            /* call 0x101527b8 */
        l_0x100b_1b68:
            ii(0x100b_1b68, 3); mov(edx, memd[ss, ebp - 0x10]);         /* mov edx, [ebp-0x10] */
            ii(0x100b_1b6b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_1b6e, 3); add(eax, 0x19);                         /* add eax, 0x19 */
            ii(0x100b_1b71, 5); call(0x100b_7bac, 0x6036);              /* call 0x100b7bac */
            ii(0x100b_1b76, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100b_1b79, 3); add(edx, 0x23);                         /* add edx, 0x23 */
            ii(0x100b_1b7c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_1b8a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_1b99, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_1bae, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100b_1bbe:
            ...
            ii(0x100b_1bc0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_1bc3, 3); add(eax, 0x23);                         /* add eax, 0x23 */
            ii(0x100b_1bc6, 5); call(0x100b_7cfc, 0x6131);              /* call 0x100b7cfc */
        l_0x100b_1bcb:
            ii(0x100b_1bcb, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100b_1bce, 3); add(edx, 0x27);                         /* add edx, 0x27 */
            ii(0x100b_1bd1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_1bdf, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
