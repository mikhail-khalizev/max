...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_3fe5()
        {
            ...
            ii(0x1019_3fef, 3); mov(memd[ss, ebp - 44], ecx);           /* mov [ebp-0x2c], ecx */
            ii(0x1019_3ff2, 3); mov(ebx, memd[ss, ebp - 8]);            /* mov ebx, [ebp-0x8] */
            ii(0x1019_3ff5, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ...
            ii(0x1019_4009, 3); cmp(memd[ss, ebp - 44], edi);           /* cmp [ebp-0x2c], edi */
            ...
            ii(0x1019_401d, 3); cmp(memd[ss, ebp - 44], edi);           /* cmp [ebp-0x2c], edi */
            ...
            ii(0x1019_402d, 3); cmp(memd[ss, ebp - 44], edi);           /* cmp [ebp-0x2c], edi */
            ...
            ii(0x1019_403d, 3); cmp(memd[ss, ebp - 44], edi);           /* cmp [ebp-0x2c], edi */
            ...
            ii(0x1019_404d, 3); cmp(memd[ss, ebp - 44], edi);           /* cmp [ebp-0x2c], edi */
            ...
            ii(0x1019_405d, 3); cmp(memd[ss, ebp - 44], edi);           /* cmp [ebp-0x2c], edi */
            ...
            ii(0x1019_406d, 3); cmp(memd[ss, ebp - 44], edi);           /* cmp [ebp-0x2c], edi */
            ...
            ii(0x1019_407d, 3); cmp(memd[ss, ebp - 44], edi);           /* cmp [ebp-0x2c], edi */
        ...
        l_0x1019_4091:
            ...
            ii(0x1019_4094, 3); add(ebx, memd[ss, ebp - 44]);           /* add ebx, [ebp-0x2c] */
            ii(0x1019_4097, 3); add(edx, memd[ss, ebp - 44]);           /* add edx, [ebp-0x2c] */
        ...
        l_0x1019_40a1:
            ...
            ii(0x1019_40b1, 3); add(ebx, memd[ss, ebp - 44]);           /* add ebx, [ebp-0x2c] */
            ii(0x1019_40b4, 3); add(edx, memd[ss, ebp - 44]);           /* add edx, [ebp-0x2c] */
            ii(0x1019_40b7, 1); ret(); return;                          /* ret */
        //  ii(0x1019_40b8, 58); Недостижимый код.
        l_0x1019_40f2:
            ii(0x1019_40f2, 3); sub(esi, memd[ss, ebp - 16]);           /* sub esi, [ebp-0x10] */
            ii(0x1019_40f5, 3); sub(edi, memd[ss, ebp - 20]);           /* sub edi, [ebp-0x14] */
