...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_5011()
        {
            ...
            ii(0x1010_5027, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1010_502a, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1010_502d, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
        l_0x1010_5030:
            ii(0x1010_5030, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_5033, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
            ...
            ii(0x1010_503b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_503e, 5); call(/* sys */ 0x1017_90ce, 0x7_408b);  /* call 0x101790ce */
            ii(0x1010_5043, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1010_5045, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_5048, 2); mov(memd[ds, eax], edx);                /* mov [eax], edx */
        l_0x1010_504a:
            ii(0x1010_504a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_504d, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
            ...
            ii(0x1010_5055, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_5058, 5); call(/* sys */ 0x1017_90ce, 0x7_4071);  /* call 0x101790ce */
            ii(0x1010_505d, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1010_505f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_5062, 3); mov(memd[ds, eax + 0x4], edx);          /* mov [eax+0x4], edx */
        l_0x1010_5065:
            ii(0x1010_5065, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_5068, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
            ...
            ii(0x1010_5070, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_5073, 5); call(/* sys */ 0x1017_90ce, 0x7_4056);  /* call 0x101790ce */
            ii(0x1010_5078, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1010_507a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_507d, 3); mov(memd[ds, eax + 0x8], edx);          /* mov [eax+0x8], edx */
        l_0x1010_5080:
            ii(0x1010_5080, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_5083, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
            ...
            ii(0x1010_508b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_508e, 5); call(/* sys */ 0x1017_90ce, 0x7_403b);  /* call 0x101790ce */
            ii(0x1010_5093, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1010_5095, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_5098, 3); mov(memd[ds, eax + 0xc], edx);          /* mov [eax+0xc], edx */
