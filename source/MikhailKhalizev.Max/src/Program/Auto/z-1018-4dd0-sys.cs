...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1018_4def:
            ...
            ii(0x1018_4df7, 4); mov(memd[ss, esp + 0x10], eax);         /* mov [esp+0x10], eax */
        l_0x1018_4dfb:
            ii(0x1018_4dfb, 3); imul(esi, edi, 0x24);                   /* imul esi, edi, 0x24 */
            ii(0x1018_4dfe, 4); mov(ebx, memd[ss, esp + 0x10]);         /* mov ebx, [esp+0x10] */
            ii(0x1018_4e02, 2); mov(eax, esp);                          /* mov eax, esp */
            ii(0x1018_4e04, 2); add(esi, ebx);                          /* add esi, ebx */
            ii(0x1018_4e06, 1); push(eax);                              /* push eax */
            ii(0x1018_4e07, 3); mov(ecx, memd[ds, esi + 0x20]);         /* mov ecx, [esi+0x20] */
            ii(0x1018_4e0a, 3); mov(eax, memd[ds, esi + 0x1c]);         /* mov eax, [esi+0x1c] */
            ii(0x1018_4e0d, 2); mov(ebx, memd[ds, esi]);                /* mov ebx, [esi] */
            ii(0x1018_4e0f, 1); push(ecx);                              /* push ecx */
            ii(0x1018_4e10, 3); mov(edx, memd[ds, esi + 0x14]);         /* mov edx, [esi+0x14] */
            ii(0x1018_4e13, 3); mov(ecx, memd[ss, ebp + 0x10]);         /* mov ecx, [ebp+0x10] */
            ii(0x1018_4e16, 1); push(eax);                              /* push eax */
            ii(0x1018_4e17, 1); inc(ecx);                               /* inc ecx */
            ii(0x1018_4e18, 3); mov(eax, memd[ds, esi + 0x18]);         /* mov eax, [esi+0x18] */
        ...
        l_0x1018_4e36:
            ...
            ii(0x1018_4e38, 3); mov(edx, memd[ds, esi + 0x20]);         /* mov edx, [esi+0x20] */
            ii(0x1018_4e3b, 1); push(edx);                              /* push edx */
            ii(0x1018_4e3c, 3); mov(ebx, memd[ds, esi + 0x1c]);         /* mov ebx, [esi+0x1c] */
            ii(0x1018_4e3f, 3); mov(ecx, memd[ds, esi + 0x14]);         /* mov ecx, [esi+0x14] */
            ii(0x1018_4e42, 1); push(ebx);                              /* push ebx */
            ii(0x1018_4e43, 4); lea(edx, memd[ss, esp + 0x10]);         /* lea edx, [esp+0x10] */
            ii(0x1018_4e47, 3); mov(ebx, memd[ds, esi + 0x18]);         /* mov ebx, [esi+0x18] */
            ...
            ii(0x1018_4e54, 2); if(jge(0x1018_4e5d, 0x7)) goto l_0x1018_4e5d; /* jge 0x10184e5d */
        ...
        l_0x1018_4e5d:
            ...
            ii(0x1018_4e70, 7); lea(eax, memd[ds, edi * 8 + 0]);        /* lea eax, [edi*8] */
            ii(0x1018_4e77, 2); add(eax, edi);                          /* add eax, edi */
            ii(0x1018_4e79, 4); mov(edx, memd[ss, ebp + eax * 4 + 0x28]); /* mov edx, [ebp+eax*4+0x28] */
        l_0x1018_4e7d:
