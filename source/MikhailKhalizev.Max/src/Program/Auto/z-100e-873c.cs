...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_873c()
        {
            ...
            ii(0x100e_8754, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100e_8757, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_875a, 4); mov(ax, memw[ds, eax + 0x10]);          /* mov ax, [eax+0x10] */
            ii(0x100e_875e, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100e_8761, 4); sub(ax, memw[ds, edx + 0x8]);           /* sub ax, [edx+0x8] */
            ii(0x100e_8765, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_8768, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
