...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_9f96()
        {
            ...
            ii(0x1012_9fae, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1012_9fb1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_9fb4, 5); call(0x1007_6338, -0xb_3c81);           /* call 0x10076338 */
            ii(0x1012_9fb9, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1012_9fbb, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1012_9fbe, 5); call(0x1007_64b8, -0xb_3b0b);           /* call 0x100764b8 */
            ii(0x1012_9fc3, 2); jmp(0x1012_9fcd, 0x8); goto l_0x1012_9fcd; /* jmp 0x10129fcd */
        l_0x1012_9fc5:
            ii(0x1012_9fc5, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1012_9fc8, 5); call(0x1007_6bf8, -0xb_33d5);           /* call 0x10076bf8 */
        l_0x1012_9fcd:
            ii(0x1012_9fcd, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1012_9fcf, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x1012_9fdf, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1012_9fe2, 5); call(0x1007_63a0, -0xb_3c47);           /* call 0x100763a0 */
            ii(0x1012_9fe7, 5); cmp(memw[ds, eax + 0x8], 0x28);         /* cmp word [eax+0x8], 0x28 */
            ii(0x1012_9fec, 6); if(jz(0x1012_a0da, 0xe8)) goto l_0x1012_a0da; /* jz 0x1012a0da */
            ii(0x1012_9ff2, 7); mov(memd[ss, ebp - 0x14], 0x4);         /* mov dword [ebp-0x14], 0x4 */
        l_0x1012_9ff9:
            ii(0x1012_9ff9, 3); dec(memd[ss, ebp - 0x14]);              /* dec dword [ebp-0x14] */
            ii(0x1012_9ffc, 5); cmp(memw[ss, ebp - 0x14], -0x1 /* 0xff */); /* cmp word [ebp-0x14], 0xffff */
            ii(0x1012_a001, 2); if(jz(0x1012_a010, 0xd)) goto l_0x1012_a010; /* jz 0x1012a010 */
            ii(0x1012_a003, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
        ...
        l_0x1012_a010:
            ...
            ii(0x1012_a017, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x1012_a02f, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x1012_a04c, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
        l_0x1012_a050:
            ii(0x1012_a050, 4); cmp(memb[ss, ebp - 0x10], 0);           /* cmp byte [ebp-0x10], 0x0 */
            ii(0x1012_a054, 2); if(jz(0x1012_a05f, 0x9)) goto l_0x1012_a05f; /* jz 0x1012a05f */
            ii(0x1012_a056, 7); cmp(memd[ds, 0x101c_5624], 0);          /* cmp dword [0x101c5624], 0x0 */
            ii(0x1012_a05d, 2); if(jnz(0x1012_a064, 0x5)) goto l_0x1012_a064; /* jnz 0x1012a064 */
        l_0x1012_a05f:
        ...
        l_0x1012_a064:
            ...
            ii(0x1012_a070, 4); mov(memb[ss, ebp - 0x10], 0);           /* mov byte [ebp-0x10], 0x0 */
            ii(0x1012_a074, 7); mov(memd[ss, ebp - 0x14], 0x4);         /* mov dword [ebp-0x14], 0x4 */
        l_0x1012_a07b:
            ii(0x1012_a07b, 3); dec(memd[ss, ebp - 0x14]);              /* dec dword [ebp-0x14] */
            ii(0x1012_a07e, 5); cmp(memw[ss, ebp - 0x14], -0x1 /* 0xff */); /* cmp word [ebp-0x14], 0xffff */
            ii(0x1012_a083, 2); if(jz(0x1012_a0b8, 0x33)) goto l_0x1012_a0b8; /* jz 0x1012a0b8 */
            ii(0x1012_a085, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ...
            ii(0x1012_a09f, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ...
            ii(0x1012_a0b0, 2); if(jnz(0x1012_a0b6, 0x4)) goto l_0x1012_a0b6; /* jnz 0x1012a0b6 */
            ii(0x1012_a0b2, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
        l_0x1012_a0b6:
        ...
        l_0x1012_a0b8:
            ...
            ii(0x1012_a0c2, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1012_a0c9, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1012_a0cb, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
        ...
        l_0x1012_a0df:
            ii(0x1012_a0df, 7); mov(memd[ss, ebp - 0xc], 0x1);          /* mov dword [ebp-0xc], 0x1 */
            ii(0x1012_a0e6, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1012_a0e8, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
        ...
        //  ii(0x1012_a0f4, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
        //  ii(0x1012_a0f7, 5); call(0x1007_5f6c, -0xb_4190);           /* call 0x10075f6c */
        l_0x1012_a0fc:
            ii(0x1012_a0fc, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
