...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_3c73()
        {
            ...
            ii(0x1012_3c89, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
        ...
        l_0x1012_3ce4:
            ...
            ii(0x1012_3cf8, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_3cfb, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
        l_0x1012_3d02:
            ii(0x1012_3d02, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_3d05, 3); cmp(memb[ds, eax], 0x20);               /* cmp byte [eax], 0x20 */
            ii(0x1012_3d08, 2); if(jnz(0x1012_3d12, 0x8)) goto l_0x1012_3d12; /* jnz 0x10123d12 */
        ...
        l_0x1012_3d12:
            ...
            ii(0x1012_3d1f, 2); if(jz(0x1012_3d2a, 0x9)) goto l_0x1012_3d2a; /* jz 0x10123d2a */
            ii(0x1012_3d21, 3); mov(eax, memd[ss, ebp + 0x1c]);         /* mov eax, [ebp+0x1c] */
            ii(0x1012_3d24, 1); dec(eax);                               /* dec eax */
            ii(0x1012_3d25, 3); cmp(eax, memd[ss, ebp - 0x4]);          /* cmp eax, [ebp-0x4] */
            ii(0x1012_3d28, 2); if(ja(0x1012_3d2c, 0x2)) goto l_0x1012_3d2c; /* ja 0x10123d2c */
        l_0x1012_3d2a:
        ...
        l_0x1012_3d2c:
            ...
            ii(0x1012_3d32, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1012_3d35, 3); inc(memd[ss, ebp - 0x4]);               /* inc dword [ebp-0x4] */
        ...
        l_0x1012_3d41:
            ...
            ii(0x1012_3d44, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1012_3d47, 3); mov(memb[ds, eax], 0);                  /* mov byte [eax], 0x0 */
            ii(0x1012_3d4a, 4); add(memd[ss, ebp - 0xc], 0x2);          /* add dword [ebp-0xc], 0x2 */
            ii(0x1012_3d4e, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_3d51, 3); cmp(eax, memd[ss, ebp - 0x8]);          /* cmp eax, [ebp-0x8] */
        ...
        l_0x1012_3d71:
            ii(0x1012_3d71, 7); mov(memd[ss, ebp - 0x10], 0x1);         /* mov dword [ebp-0x10], 0x1 */
        l_0x1012_3d78:
