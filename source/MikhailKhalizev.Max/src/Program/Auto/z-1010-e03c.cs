...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_e03c()
        {
            ...
            ii(0x1010_e054, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_e057, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_e05a, 3); mov(al, memb[ds, eax + 0x10]);          /* mov al, [eax+0x10] */
            ii(0x1010_e05d, 2); add(al, 0x67);                          /* add al, 0x67 */
            ii(0x1010_e05f, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x1010_e062, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_e072, 2); jmp(0x1010_e07a, 0x6); goto l_0x1010_e07a; /* jmp 0x1010e07a */
        l_0x1010_e074:
        ...
        l_0x1010_e07a:
            ...
            ii(0x1010_e09b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_e09e, 5); call(0x1010_dfd1, -0xd2);               /* call 0x1010dfd1 */
            ii(0x1010_e0a3, 4); movsx(eax, memb[ss, ebp - 0x8]);        /* movsx eax, byte [ebp-0x8] */
            ...
            ii(0x1010_e0c7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_e0ca, 5); call(0x1010_dfd1, -0xfe);               /* call 0x1010dfd1 */
            ii(0x1010_e0cf, 2); jmp(0x1010_e0d3, 0x2); goto l_0x1010_e0d3; /* jmp 0x1010e0d3 */
        l_0x1010_e0d1:
            ii(0x1010_e0d1, 2); jmp(0x1010_e074, -0x5f); goto l_0x1010_e074; /* jmp 0x1010e074 */
        l_0x1010_e0d3:
            ii(0x1010_e0d3, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x1010_e0d8, 4); movsx(eax, memb[ss, ebp - 0x8]);        /* movsx eax, byte [ebp-0x8] */
            ii(0x1010_e0dc, 5); call(0x100c_aafc, -0x4_35e5);           /* call 0x100caafc */
            ii(0x1010_e0e1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
