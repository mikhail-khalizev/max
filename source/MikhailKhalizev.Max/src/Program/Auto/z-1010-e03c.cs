...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_e03c()
        {
            ...
            ii(0x1010_e05a, 3);  mov(al, memb[ds, eax + 16]);          /* mov al, [eax+0x10] */
            ...
            ii(0x1010_e065, 4);  cmp(memd[ds, eax + 12], 0);           /* cmp dword [eax+0xc], 0x0 */
            ii(0x1010_e069, 2);  if(jz(0x1010_e0d3, 0x68)) goto l_0x1010_e0d3;/* jz 0x1010e0d3 */
            ii(0x1010_e06b, 7);  mov(memd[ss, ebp - 12], 0);           /* mov dword [ebp-0xc], 0x0 */
            ii(0x1010_e072, 2);  jmp(0x1010_e07a, 6); goto l_0x1010_e07a;/* jmp 0x1010e07a */
        l_0x1010_e074:
            ii(0x1010_e074, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1010_e077, 3);  inc(memd[ss, ebp - 12]);              /* inc dword [ebp-0xc] */
        l_0x1010_e07a:
            ii(0x1010_e07a, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x1010_e07e, 3);  cmp(eax, 4);                          /* cmp eax, 0x4 */
            ii(0x1010_e081, 2);  if(jge(0x1010_e0d3, 0x50)) goto l_0x1010_e0d3;/* jge 0x1010e0d3 */
            ii(0x1010_e083, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
            ...
            ii(0x1010_e097, 4);  movsx(edx, memw[ss, ebp - 12]);       /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x1010_e0ac, 3);  mov(dl, memb[ss, ebp - 12]);          /* mov dl, [ebp-0xc] */
            ...
            ii(0x1010_e0c3, 4);  movsx(edx, memw[ss, ebp - 12]);       /* movsx edx, word [ebp-0xc] */
