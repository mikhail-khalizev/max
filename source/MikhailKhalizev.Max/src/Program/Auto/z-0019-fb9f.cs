...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x19_fb9f, 4); enter(0x2, 0);                            /* enter 0x2, 0x0 */
            ...
            ii(0x19_fbab, 5); mov(memw[ss, bp - 0x2], 0x1);             /* mov word [bp-0x2], 0x1 */
            ...
            ii(0x19_fbb7, 3); mov(di, memw[ss, bp + 0x4]);              /* mov di, [bp+0x4] */
            ii(0x19_fbba, 3); mov(si, memw[ss, bp + 0x6]);              /* mov si, [bp+0x6] */
            ii(0x19_fbbd, 3); mov(cx, memw[ss, bp + 0x8]);              /* mov cx, [bp+0x8] */
            ...
            ii(0x19_fbce, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
        l_0x19_fbd1:
            ii(0x19_fbd1, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0x19_fbd4, 1); pop(ds);                                  /* pop ds */
            ii(0x19_fbd5, 1); pop(si);                                  /* pop si */
            ii(0x19_fbd6, 1); pop(di);                                  /* pop di */
            ii(0x19_fbd7, 1); leave();                                  /* leave */
            ii(0x19_fbd8, 3); ret(0x8);                                 /* ret 0x8 */
        }
    }
}
