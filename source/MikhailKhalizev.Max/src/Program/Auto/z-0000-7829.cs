...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x7847:
            ...
            ii(0x7851, 4);    cmp(memw[ss, bp + 0x6], 0);               /* cmp word [bp+0x6], 0x0 */
            ii(0x7855, 2);    if(jz(0x786a, 0x13)) goto l_0x786a;       /* jz 0x786a */
            ii(0x7857, 2);    push(0);                                  /* push 0x0 */
            ii(0x7859, 3);    push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x785c, 3);    push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x785f, 3);    push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
        ...
        l_0x7873:
            ii(0x7873, 3);    mov(si, memw[ss, bp + 0x8]);              /* mov si, [bp+0x8] */
            ii(0x7876, 2);    cmp(si, di);                              /* cmp si, di */
            ii(0x7878, 2);    if(ja(0x787e, 0x4)) goto l_0x787e;        /* ja 0x787e */
            ii(0x787a, 2);    or(si, si);                               /* or si, si */
            ii(0x787c, 2);    if(jnz(0x7880, 0x2)) goto l_0x7880;       /* jnz 0x7880 */
        l_0x787e:
            ii(0x787e, 2);    mov(si, di);                              /* mov si, di */
        l_0x7880:
            ii(0x7880, 1);    push(si);                                 /* push si */
            ii(0x7881, 3);    push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x7884, 3);    push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ...
            ii(0x7893, 3);    add(memw[ss, bp + 0x6], si);              /* add [bp+0x6], si */
            ii(0x7896, 4);    add(memw[ds, 0x11d0], si);                /* add [0x11d0], si */
            ii(0x789a, 3);    sub(memw[ss, bp + 0x8], si);              /* sub [bp+0x8], si */
            ii(0x789d, 2);    if(jnz(0x783a, -0x65)) goto l_0x783a;     /* jnz 0x783a */
            ii(0x789f, 2);    jmp(0x78a8, 0x7); goto l_0x78a8;          /* jmp 0x78a8 */
        l_0x78a1:
        ...
        l_0x78a8:
            ii(0x78a8, 3);    mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ...
            ii(0x78b6, 3);    mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
