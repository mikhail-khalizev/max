...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_44ee()
        {
            ...
            ii(0x1012_4528, 7); mov(memd[ss, ebp - 0xc], 0x1);          /* mov dword [ebp-0xc], 0x1 */
        ...
        l_0x1012_4534:
            ...
            ii(0x1012_453d, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        ...
        l_0x1012_4576:
            ...
            ii(0x1012_4588, 3); sub(edx, memd[ss, ebp - 0x8]);          /* sub edx, [ebp-0x8] */
            ii(0x1012_458b, 2); mov(ebx, edx);                          /* mov ebx, edx */
            ii(0x1012_458d, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1012_4590, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_4593, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
        ...
        l_0x1012_459b:
            ...
            ii(0x1012_45a9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_45ac, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        ...
        l_0x1012_45bb:
            ...
            ii(0x1012_45be, 4); cmp(memd[ss, ebp + 0x20], -0x1 /* 0xff */); /* cmp dword [ebp+0x20], 0xffffffff */
            ii(0x1012_45c2, 2); if(jz(0x1012_45cf, 0xb)) goto l_0x1012_45cf; /* jz 0x101245cf */
            ii(0x1012_45c4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_45c7, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        ...
        l_0x1012_45cf:
            ii(0x1012_45cf, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_45d2, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
            ii(0x1012_45d5, 3); mov(memb[ds, eax], 0x3d);               /* mov byte [eax], 0x3d */
            ii(0x1012_45d8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_45db, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        ...
        l_0x1012_45e1:
            ...
            ii(0x1012_45ef, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1012_45f2, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        ...
        l_0x1012_45fb:
            ii(0x1012_45fb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_45fe, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
            ii(0x1012_4601, 3); mov(memb[ds, eax], 0xd);                /* mov byte [eax], 0xd */
            ii(0x1012_4604, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_4607, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
            ii(0x1012_460a, 3); mov(memb[ds, eax], 0xa);                /* mov byte [eax], 0xa */
            ii(0x1012_460d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1012_461c, 4); or(memb[ds, eax + 0x1], -0x80 /* 0x80 */); /* or byte [eax+0x1], 0x80 */
            ii(0x1012_4620, 7); mov(memd[ss, ebp - 0xc], 0x1);          /* mov dword [ebp-0xc], 0x1 */
        l_0x1012_4627:
