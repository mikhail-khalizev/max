...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_bbb0()
        {
            ...
            ii(0x1013_bbc1, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1013_bbc7, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_bbca, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_bbcd, 5);  mov(ebx, 2);                          /* mov ebx, 0x2 */
            ii(0x1013_bbd2, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1013_bbd5, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
