...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_94bc()
        {
            ...
            ii(0x1009_94d4, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_94d7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_94da, 4); cmp(memb[ds, eax + 0x1d], 0);           /* cmp byte [eax+0x1d], 0x0 */
            ...
            ii(0x1009_94ee, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1009_94f1, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1009_94f4, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1009_94f7, 4); cmp(memd[ss, ebp - 0x10], 0);           /* cmp dword [ebp-0x10], 0x0 */
            ii(0x1009_94fb, 2); if(jz(0x1009_9519, 0x1c)) goto l_0x1009_9519; /* jz 0x10099519 */
            ii(0x1009_94fd, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ii(0x1009_9500, 3); add(ebx, 0x19);                         /* add ebx, 0x19 */
            ii(0x1009_9503, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_9506, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1009_9509, 5); call(Definitions.my_ctor_c12, 0xcb5e);  /* call 0x100a606c */
            ii(0x1009_950e, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1009_9511, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1009_9514, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_9517, 2); jmp(0x1009_951f, 0x6); goto l_0x1009_951f; /* jmp 0x1009951f */
        l_0x1009_9519:
            ii(0x1009_9519, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1009_951c, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x1009_951f:
            ii(0x1009_951f, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1009_9522, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1009_9525, 5); call(0x1008_a914, -0xec16);             /* call 0x1008a914 */
            ii(0x1009_952a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_952d, 4); mov(memb[ds, eax + 0x1d], 0x1);         /* mov byte [eax+0x1d], 0x1 */
            ii(0x1009_9531, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_9534, 3); mov(eax, memd[ds, eax + 0x11]);         /* mov eax, [eax+0x11] */
            ...
            ii(0x1009_9542, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1009_9545, 5); call(0x1008_a7dc, -0xed6e);             /* call 0x1008a7dc */
            ii(0x1009_954a, 5); call(0x100a_63bc, 0xce6d);              /* call 0x100a63bc */
            ii(0x1009_954f, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x1009_9565, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1009_9568, 5); call(0x1008_8cbc, -0x1_08b1);           /* call 0x10088cbc */
        l_0x1009_956d:
            ii(0x1009_956d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_9570, 4); cmp(memb[ds, eax + 0x1d], 0x5);         /* cmp byte [eax+0x1d], 0x5 */
            ii(0x1009_9574, 2); if(jz(0x1009_957e, 0x8)) goto l_0x1009_957e; /* jz 0x1009957e */
            ii(0x1009_9576, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
