...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_a407()
        {
            ...
            ii(0x100d_a41e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_a421, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_a424, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x100d_a428, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_a42b, 3); mov(eax, memd[ds, eax + 0x49]);         /* mov eax, [eax+0x49] */
            ...
            ii(0x100d_a442, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100d_a445, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100d_a449, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100d_a44c, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x100d_a459, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100d_a45c, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100d_a460, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100d_a463, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100d_a465, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_a474, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100d_a477, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100d_a47a, 4); mov(ax, memw[ds, eax + 0x8]);           /* mov ax, [eax+0x8] */
            ii(0x100d_a47e, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x100d_a481, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100d_a484, 3); mov(eax, memd[ds, eax + 0xe]);          /* mov eax, [eax+0xe] */
            ...
            ii(0x100d_a48e, 4); movsx(ebx, memw[ss, ebp - 0x4]);        /* movsx ebx, word [ebp-0x4] */
            ii(0x100d_a492, 5); mov(edx, 0x5);                          /* mov edx, 0x5 */
            ii(0x100d_a497, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_a49a, 3); mov(eax, memd[ds, eax + 0x49]);         /* mov eax, [eax+0x49] */
            ...
            ii(0x100d_a4a7, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x100d_a4aa, 3); add(eax, 0x10);                         /* add eax, 0x10 */
            ii(0x100d_a4ad, 1); push(eax);                              /* push eax */
            ii(0x100d_a4ae, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_a4b1, 3); mov(ecx, memd[ds, eax + 0xe]);          /* mov ecx, [eax+0xe] */
            ii(0x100d_a4b4, 3); sar(ecx, 0x10);                         /* sar ecx, 0x10 */
            ii(0x100d_a4b7, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100d_a4ba, 3); mov(ebx, memd[ds, eax + 0xe]);          /* mov ebx, [eax+0xe] */
            ii(0x100d_a4bd, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100d_a4c0, 5); mov(edx, 0x8);                          /* mov edx, 0x8 */
            ii(0x100d_a4c5, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
