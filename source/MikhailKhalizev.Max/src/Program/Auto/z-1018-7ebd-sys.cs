...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1018_7ed5:
            ...
            ii(0x1018_7ed9, 3); cmp(memb[ds, esi], 0x2);                /* cmp byte [esi], 0x2 */
            ii(0x1018_7edc, 2); if(jz(0x1018_7ee8, 0xa)) goto l_0x1018_7ee8; /* jz 0x10187ee8 */
            ii(0x1018_7ede, 3); cmp(al, memb[ds, esi + 0x1]);           /* cmp al, [esi+0x1] */
            ii(0x1018_7ee1, 2); if(ja(0x1018_7ee8, 0x5)) goto l_0x1018_7ee8; /* ja 0x10187ee8 */
            ii(0x1018_7ee3, 2); mov(ebx, esi);                          /* mov ebx, esi */
            ii(0x1018_7ee5, 3); mov(al, memb[ds, esi + 0x1]);           /* mov al, [esi+0x1] */
        l_0x1018_7ee8:
