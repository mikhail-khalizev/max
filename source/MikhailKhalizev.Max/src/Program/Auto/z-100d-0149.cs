...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_0149()
        {
            ...
            ii(0x100d_0161, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100d_0164, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_0172, 2); if(jnz(0x100d_017d, 0x9)) goto l_0x100d_017d; /* jnz 0x100d017d */
            ii(0x100d_0174, 7); mov(memd[ss, ebp - 0x8], 0xffff_ffff);  /* mov dword [ebp-0x8], 0xffffffff */
            ii(0x100d_017b, 2); jmp(0x100d_0197, 0x1a); goto l_0x100d_0197; /* jmp 0x100d0197 */
        l_0x100d_017d:
            ii(0x100d_017d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_0180, 3); mov(edx, memd[ds, eax + 0x24]);         /* mov edx, [eax+0x24] */
            ii(0x100d_0183, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_0186, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_0194, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x100d_0197:
            ii(0x100d_0197, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
