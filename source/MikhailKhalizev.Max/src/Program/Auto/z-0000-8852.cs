...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x8852, 4);    enter(4, 0);                              /* enter 0x4, 0x0 */
            ii(0x8856, 5);    test(memb[ds, 0x47], 2);                  /* test byte [0x47], 0x2 */
            ii(0x885b, 2);    if(jz(0x88d5, 0x78)) goto l_0x88d5;       /* jz 0x88d5 */
            ii(0x885d, 5);    mov(memw[ss, bp - 4], 0xa000);            /* mov word [bp-0x4], 0xa000 */
            ii(0x8862, 5);    mov(memw[ss, bp - 2], 0xf);               /* mov word [bp-0x2], 0xf */
        l_0x8867:
            ii(0x8867, 4);    cmp(memw[ss, bp - 2], 0xf);               /* cmp word [bp-0x2], 0xf */
            ii(0x886b, 2);    if(jg(0x88be, 0x51)) goto l_0x88be;       /* jg 0x88be */
            ii(0x886d, 2);    if(jl(0x8875, 6)) goto l_0x8875;          /* jl 0x8875 */
            ii(0x886f, 4);    cmp(memw[ss, bp - 4], -1 /* 0xff */);     /* cmp word [bp-0x4], 0xffff */
            ii(0x8873, 2);    if(jae(0x88be, 0x49)) goto l_0x88be;      /* jae 0x88be */
        l_0x8875:
            ii(0x8875, 3);    push(memw[ss, bp - 2]);                   /* push word [bp-0x2] */
            ii(0x8878, 3);    push(memw[ss, bp - 4]);                   /* push word [bp-0x4] */
            ...
            ii(0x8884, 3);    mov(ax, memw[ss, bp - 4]);                /* mov ax, [bp-0x4] */
            ii(0x8887, 3);    mov(dx, memw[ss, bp - 2]);                /* mov dx, [bp-0x2] */
            ...
            ii(0x88a0, 3);    mov(ax, memw[ss, bp - 4]);                /* mov ax, [bp-0x4] */
            ii(0x88a3, 3);    mov(dx, memw[ss, bp - 2]);                /* mov dx, [bp-0x2] */
            ii(0x88a6, 2);    mov(cl, 4);                               /* mov cl, 0x4 */
            ...
            ii(0x88b0, 3);    add(sp, 8);                               /* add sp, 0x8 */
            ii(0x88b3, 5);    add(memw[ss, bp - 4], 0x400);             /* add word [bp-0x4], 0x400 */
            ii(0x88b8, 4);    adc(memw[ss, bp - 2], 0);                 /* adc word [bp-0x2], 0x0 */
            ii(0x88bc, 2);    jmp(0x8867, -0x57); goto l_0x8867;        /* jmp 0x8867 */
        l_0x88be:
            ii(0x88be, 3);    mov(ax, memw[ss, bp - 4]);                /* mov ax, [bp-0x4] */
            ii(0x88c1, 3);    add(ah, 0x60);                            /* add ah, 0x60 */
            ii(0x88c4, 3);    mov(bx, memw[ss, bp + 4]);                /* mov bx, [bp+0x4] */
            ii(0x88c7, 2);    mov(memw[ds, bx], ax);                    /* mov [bx], ax */
            ii(0x88c9, 2);    or(ax, ax);                               /* or ax, ax */
            ii(0x88cb, 2);    if(jz(0x88d5, 8)) goto l_0x88d5;          /* jz 0x88d5 */
        ...
        l_0x88d5:
            ii(0x88d5, 5);    and(memb[ds, 0x47], -3 /* 0xfd */);       /* and byte [0x47], 0xfd */
