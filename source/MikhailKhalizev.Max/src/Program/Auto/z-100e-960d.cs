...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_960d()
        {
            ...
            ii(0x100e_9625, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100e_9628, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x100e_962f, 2); jmp(0x100e_9637, 0x6); goto l_0x100e_9637; /* jmp 0x100e9637 */
        l_0x100e_9631:
            ii(0x100e_9631, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_9634, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x100e_9637:
            ii(0x100e_9637, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_963a, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100e_963d, 4); cmp(ax, memw[ds, edx + 0x2]);           /* cmp ax, [edx+0x2] */
            ii(0x100e_9641, 2); if(jge(0x100e_965d, 0x1a)) goto l_0x100e_965d; /* jge 0x100e965d */
            ii(0x100e_9643, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100e_9647, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100e_964a, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100e_964c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_964f, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
