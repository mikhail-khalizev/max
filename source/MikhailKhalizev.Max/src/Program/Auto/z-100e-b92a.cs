...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_b92a()
        {
            ...
            ii(0x100e_b942, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100e_b945, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_b948, 4); cmp(memb[ds, eax + 0x32], 0);           /* cmp byte [eax+0x32], 0x0 */
            ii(0x100e_b94c, 2); if(jz(0x100e_b958, 0xa)) goto l_0x100e_b958; /* jz 0x100eb958 */
            ii(0x100e_b94e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100e_b958:
            ii(0x100e_b958, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_b95b, 3); mov(eax, memd[ds, eax + 0x2a]);         /* mov eax, [eax+0x2a] */
            ...
            ii(0x100e_b965, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_b968, 4); dec(memw[ds, eax + 0x2c]);              /* dec word [eax+0x2c] */
            ii(0x100e_b96c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
