...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_894c()
        {
            ...
            ii(0x1012_895e, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1012_8964, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1012_8967, 7); mov(memd[ss, ebp - 8], 0x101c_5c21);    /* mov dword [ebp-0x8], 0x101c5c21 */
            ii(0x1012_896e, 7); mov(memb[ds, 0x101c_5c1c], 9);          /* mov byte [0x101c5c1c], 0x9 */
            ii(0x1012_8975, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1012_8987, 4); movsx(eax, memw[ss, ebp - 4]);          /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1012_899e, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1012_89a1, 3); mov(memw[ds, eax], bx);                 /* mov [eax], bx */
            ii(0x1012_89a4, 4); movsx(eax, memw[ss, ebp - 4]);          /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1012_89b5, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1012_89b8, 4); mov(memw[ds, edx + 2], ax);             /* mov [edx+0x2], ax */
            ii(0x1012_89bc, 5); mov(ebx, 0x28);                         /* mov ebx, 0x28 */
            ii(0x1012_89c1, 4); movsx(eax, memw[ss, ebp - 4]);          /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1012_89d2, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1012_89d5, 3); add(eax, 4);                            /* add eax, 0x4 */
            ii(0x1012_89d8, 5); call(Definitions.sys_memcpy, 0x3_d46e); /* call 0x10165e4b */
            ii(0x1012_89dd, 5); mov(ebx, 0x60);                         /* mov ebx, 0x60 */
            ii(0x1012_89e2, 4); movsx(eax, memw[ss, ebp - 4]);          /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1012_8a09, 3); mov(ebx, memd[ss, ebp - 8]);            /* mov ebx, [ebp-0x8] */
            ii(0x1012_8a0c, 3); add(ebx, 0x2c);                         /* add ebx, 0x2c */
            ii(0x1012_8a0f, 3); mov(al, memb[ss, ebp - 4]);             /* mov al, [ebp-0x4] */
            ...
            ii(0x1012_8a21, 5); mov(eax, 4);                            /* mov eax, 0x4 */
