...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("258bb8c0-05a3-4dfa-9339-373f34e3a1a3")]
        public void Method_1010_3ff1()
        {
            ii(0x1010_3ff1, 5); pushd(0x30);                            /* push 0x30 */
            ii(0x1010_3ff6, 5); calld(Definitions.sys_check_available_stack_size, 0x6_1d57); /* call 0x10165d52 */
            ...
            ii(0x1010_4013, 5); calld(0x1007_64fc, -0x8_db1c);          /* call 0x100764fc */
        ...
        l_0x1010_402e:
            ...
            ii(0x1010_4048, 5); calld(0x1007_6338, -0x8_dd15);          /* call 0x10076338 */
            ii(0x1010_404d, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1010_404f, 3); lea(eax, ebp - 0x14);                   /* lea eax, [ebp-0x14] */
            ii(0x1010_4052, 5); calld(0x1007_643c, -0x8_dc1b);          /* call 0x1007643c */
        ...
        l_0x1010_4059:
            ...
            ii(0x1010_405c, 5); calld(0x1007_6bf8, -0x8_d469);          /* call 0x10076bf8 */
        l_0x1010_4061:
            ii(0x1010_4061, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_4063, 3); lea(eax, ebp - 0x14);                   /* lea eax, [ebp-0x14] */
            ii(0x1010_4066, 5); calld(0x1013_ad71, 0x3_6d06);           /* call 0x1013ad71 */
            ...
            ii(0x1010_4072, 5); calld(0x1007_63a0, -0x8_dcd7);          /* call 0x100763a0 */
            ii(0x1010_4077, 5); calld(0x1014_b6bd, 0x4_7641);           /* call 0x1014b6bd */
            ii(0x1010_407c, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_407e, 3); lea(eax, ebp - 0x14);                   /* lea eax, [ebp-0x14] */
            ii(0x1010_4081, 5); calld(0x1007_63a0, -0x8_dce6);          /* call 0x100763a0 */
            ii(0x1010_4086, 5); calld(0x1008_a998, -0x7_96f3);          /* call 0x1008a998 */
        ...
        l_0x1010_408d:
            ...
            ii(0x1010_409c, 5); calld(0x1013_a6f4, 0x3_6653);           /* call 0x1013a6f4 */
        ...
        l_0x1010_40a3:
            ...
            ii(0x1010_40a8, 5); calld(0x1007_5f6c, -0x8_e141);          /* call 0x10075f6c */
