...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_3ff1()
        {
            ...
            ii(0x1010_4009, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1010_400c, 4); or(memb[ss, ebp - 8], 1);               /* or byte [ebp-0x8], 0x1 */
            ii(0x1010_4010, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1010_4013, 5); call(0x1007_64fc, -0x8_db1c);           /* call 0x100764fc */
            ii(0x1010_4018, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1010_401b, 4); and(memb[ss, ebp - 8], -2 /* 0xfe */);  /* and byte [ebp-0x8], 0xfe */
            ii(0x1010_401f, 7); mov(memd[ss, ebp - 12], 0);             /* mov dword [ebp-0xc], 0x0 */
            ii(0x1010_4026, 2); jmp(0x1010_402e, 6); goto l_0x1010_402e; /* jmp 0x1010402e */
        l_0x1010_4028:
            ii(0x1010_4028, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1010_402b, 3); inc(memd[ss, ebp - 12]);                /* inc dword [ebp-0xc] */
        l_0x1010_402e:
            ii(0x1010_402e, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1010_4031, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1010_4034, 3); cmp(ax, memw[ds, edx]);                 /* cmp ax, [edx] */
            ii(0x1010_4037, 2); if(jge(0x1010_40a3, 0x6a)) goto l_0x1010_40a3; /* jge 0x101040a3 */
            ii(0x1010_4039, 4); movsx(edx, memw[ss, ebp - 12]);         /* movsx edx, word [ebp-0xc] */
            ii(0x1010_403d, 3); imul(edx, edx, 0xa);                    /* imul edx, edx, 0xa */
            ii(0x1010_4040, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_4043, 3); mov(eax, memd[ds, eax + 2]);            /* mov eax, [eax+0x2] */
            ...
            ii(0x1010_404f, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1010_4052, 5); call(0x1007_643c, -0x8_dc1b);           /* call 0x1007643c */
            ii(0x1010_4057, 2); jmp(0x1010_4061, 8); goto l_0x1010_4061; /* jmp 0x10104061 */
        l_0x1010_4059:
            ii(0x1010_4059, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1010_405c, 5); call(0x1007_6bf8, -0x8_d469);           /* call 0x10076bf8 */
        l_0x1010_4061:
            ii(0x1010_4061, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_4063, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ...
            ii(0x1010_406f, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ...
            ii(0x1010_407e, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
        ...
        l_0x1010_408d:
            ii(0x1010_408d, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x1010_4091, 3); imul(edx, eax, 0xa);                    /* imul edx, eax, 0xa */
            ii(0x1010_4094, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_4097, 3); mov(eax, memd[ds, eax + 2]);            /* mov eax, [eax+0x2] */
        ...
        l_0x1010_40a3:
            ...
            ii(0x1010_40a5, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
