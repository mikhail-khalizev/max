...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x17_8ce4, 4);  enter(2, 0);                            /* enter 0x2, 0x0 */
            ii(0x17_8ce8, 1);  push(ds);                               /* push ds */
            ii(0x17_8ce9, 3);  mov(ax, 0x3e68);                        /* mov ax, 0x3e68 */
            ii(0x17_8cec, 2);  mov(ds, ax);                            /* mov ds, ax */
            ii(0x17_8cee, 5);  mov(memw[ss, bp - 2], 0);               /* mov word [bp-0x2], 0x0 */
            ii(0x17_8cf3, 4);  les(bx, memw[ds, 0x1efc]);              /* les bx, [0x1efc] */
            ii(0x17_8cf7, 3);  inc(memb[es, bx]);                      /* inc byte [es:bx] */
            ii(0x17_8cfa, 3);  push(memw[ss, bp + 8]);                 /* push word [bp+0x8] */
            ii(0x17_8cfd, 3);  push(memw[ss, bp + 6]);                 /* push word [bp+0x6] */
            ii(0x17_8d00, 1);  push(cs);                               /* push cs */
            ii(0x17_8d01, 3);  call(0x17_8988, -0x37c);                /* call 0x8988 */
            ii(0x17_8d04, 3);  add(sp, 4);                             /* add sp, 0x4 */
        ...
        l_0x17_8d10:
            ...
            ii(0x17_8d2e, 3);  push(memw[ss, bp + 10]);                /* push word [bp+0xa] */
        ...
        l_0x17_8d54:
            ii(0x17_8d54, 4);  les(bx, memw[ds, 0x1efc]);              /* les bx, [0x1efc] */
            ii(0x17_8d58, 3);  dec(memb[es, bx]);                      /* dec byte [es:bx] */
            ii(0x17_8d5b, 3);  mov(ax, memw[ss, bp - 2]);              /* mov ax, [bp-0x2] */
