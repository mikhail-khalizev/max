...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("327584cc-9084-4a43-b790-9da7f0e8c361")]
        public void Method_1007_5eac()
        {
            ii(0x1007_5eac, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x1007_5eb1, 5); calld(Definitions.sys_check_available_stack_size, 0xefe9c); /* call 0x10165d52 */
            ...
            ii(0x1007_5ed1, 5); calld(Definitions.my_dtor_0x101b6edc, 0xc4d6f); /* call 0x1013ac45 */
            ...
            ii(0x1007_5ee9, 1); retd(); return;                         /* ret */
        }
    }
}
