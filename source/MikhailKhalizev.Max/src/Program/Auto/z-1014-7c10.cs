...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_7c10()
        {
            ...
            ii(0x1014_7c28, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_7c2b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_7c2e, 3); add(eax, 0xe);                          /* add eax, 0xe */
            ii(0x1014_7c31, 5); call(0x1014_8170, 0x53a);               /* call 0x10148170 */
            ii(0x1014_7c36, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_7c39, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
