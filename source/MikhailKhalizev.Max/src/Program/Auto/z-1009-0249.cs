...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_0249()
        {
            ...
            ii(0x1009_025f, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1009_0262, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1009_0265, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ii(0x1009_0268, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1009_026b, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1009_026e, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ...
            ii(0x1009_027d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1009_0287:
            ii(0x1009_0287, 4); cmp(memb[ss, ebp - 0x4], 0x2);          /* cmp byte [ebp-0x4], 0x2 */
            ii(0x1009_028b, 2); if(jnz(0x1009_02f1, 0x64)) goto l_0x1009_02f1; /* jnz 0x100902f1 */
            ii(0x1009_028d, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1009_0290, 4); mov(memb[ds, eax + 0x25], 0x6);         /* mov byte [eax+0x25], 0x6 */
            ii(0x1009_0294, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1009_0297, 3); add(eax, 0x2b);                         /* add eax, 0x2b */
            ii(0x1009_029a, 5); call(0x1008_aef4, -0x53ab);             /* call 0x1008aef4 */
            ii(0x1009_029f, 3); lea(ebx, memd[ss, ebp - 0x14]);         /* lea ebx, [ebp-0x14] */
            ...
            ii(0x1009_02ab, 2); jmp(0x1009_02b5, 0x8); goto l_0x1009_02b5; /* jmp 0x100902b5 */
        l_0x1009_02ad:
            ii(0x1009_02ad, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1009_02b0, 5); call(0x1007_6bf8, -0x1_96bd);           /* call 0x10076bf8 */
        l_0x1009_02b5:
            ii(0x1009_02b5, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_02b7, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1009_02c3, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1009_02c6, 5); call(0x1008_adc4, -0x5507);             /* call 0x1008adc4 */
            ii(0x1009_02cb, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1009_02ce, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1009_02d1, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x1009_02d4, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1009_02d7, 3); call_abs(memd[ds, edx + 0x48]);         /* call dword [edx+0x48] */
            ii(0x1009_02da, 2); jmp(0x1009_02ad, -0x2f); goto l_0x1009_02ad; /* jmp 0x100902ad */
        l_0x1009_02dc:
            ii(0x1009_02dc, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x1009_02e9, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
