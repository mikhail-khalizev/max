...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_118d()
        {
            ...
            ii(0x1013_11ad, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1013_11b0, 7); mov(memb[ds, 0x101c_61b1], 1);          /* mov byte [0x101c61b1], 0x1 */
            ii(0x1013_11b7, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_11b9, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_11bc, 6); mov(eax, memd[ds, eax + 190]);          /* mov eax, [eax+0xbe] */
            ...
            ii(0x1013_11ce, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_11d1, 5); call(0x1012_f003, -0x21d3);             /* call 0x1012f003 */
            ii(0x1013_11d6, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_11d9, 4); cmp(memb[ds, eax + 23], 0);             /* cmp byte [eax+0x17], 0x0 */
            ii(0x1013_11dd, 2); if(jz(0x1013_11e8, 9)) goto l_0x1013_11e8; /* jz 0x101311e8 */
            ii(0x1013_11df, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_11e2, 4); cmp(memb[ds, eax + 23], 1);             /* cmp byte [eax+0x17], 0x1 */
            ii(0x1013_11e6, 2); if(jnz(0x1013_11f5, 0xd)) goto l_0x1013_11f5; /* jnz 0x101311f5 */
        l_0x1013_11e8:
            ii(0x1013_11e8, 5); mov(edx, 1);                            /* mov edx, 0x1 */
            ii(0x1013_11ed, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
