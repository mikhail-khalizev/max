...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_118d()
        {
            ...
            ii(0x1013_11a4, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_11a7, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_11aa, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_11ad, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1013_11b0, 7); mov(memb[ds, 0x101c_61b1], 0x1);        /* mov byte [0x101c61b1], 0x1 */
            ...
            ii(0x1013_11dd, 2); if(jz(0x1013_11e8, 0x9)) goto l_0x1013_11e8; /* jz 0x101311e8 */
            ii(0x1013_11df, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_11e2, 4); cmp(memb[ds, eax + 0x17], 0x1);         /* cmp byte [eax+0x17], 0x1 */
