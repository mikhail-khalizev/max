...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_0e36()
        {
            ...
            ii(0x100b_0e48, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100b_0e4e, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100b_0e51, 4); mov(memb[ss, ebp - 8], 0x2d);           /* mov byte [ebp-0x8], 0x2d */
            ii(0x100b_0e55, 3); mov(al, memb[ss, ebp - 8]);             /* mov al, [ebp-0x8] */
