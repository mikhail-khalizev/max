...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_9c4d()
        {
            ...
            ii(0x1015_9c6d, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1015_9c70, 5); mov(eax, 1);                            /* mov eax, 0x1 */
            ii(0x1015_9c75, 5); call(0x100f_448c, -0x6_57ee);           /* call 0x100f448c */
            ii(0x1015_9c7a, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1015_9c7d, 4); cmp(memb[ds, eax + 87], 7);             /* cmp byte [eax+0x57], 0x7 */
            ii(0x1015_9c81, 2); if(jnz(0x1015_9c8c, 9)) goto l_0x1015_9c8c; /* jnz 0x10159c8c */
            ii(0x1015_9c83, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1015_9c86, 4); mov(memb[ds, eax + 87], 0);             /* mov byte [eax+0x57], 0x0 */
            ii(0x1015_9c8a, 2); jmp(0x1015_9c93, 7); goto l_0x1015_9c93; /* jmp 0x10159c93 */
        l_0x1015_9c8c:
            ii(0x1015_9c8c, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1015_9c8f, 4); mov(memb[ds, eax + 87], 7);             /* mov byte [eax+0x57], 0x7 */
        l_0x1015_9c93:
