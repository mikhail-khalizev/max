...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("14f732e2-83a1-4a2e-9e40-c2acd2a05686")]
        public void Method_1010_de32()
        {
            ii(0x1010_de32, 5); pushd(0x94);                            /* push 0x94 */
            ii(0x1010_de37, 5); calld(Definitions.sys_check_available_stack_size, 0x5_7f16); /* call 0x10165d52 */
        ...
        l_0x1010_de5c:
            ...
            ii(0x1010_de90, 5); calld(Definitions.my_dtor_d2, -0x3_f95d); /* call 0x100ce538 */
            ii(0x1010_de95, 5); calld(Definitions.sys_delete, 0x5_80ca); /* call 0x10165f64 */
        ...
        l_0x1010_deb6:
            ...
            ii(0x1010_debb, 5); calld(/* sys */ 0x1016_a24c, 0x5_c38c); /* call 0x1016a24c */
            ...
            ii(0x1010_ded1, 5); calld(Definitions.sys_strcpy, 0x5_7ff9); /* call 0x10165ecf */
        ...
        l_0x1010_ded8:
            ...
            ii(0x1010_dee0, 5); calld(Definitions.sys_strcpy, 0x5_7fea); /* call 0x10165ecf */
        l_0x1010_dee5:
        ...
        l_0x1010_df33:
            ...
            ii(0x1010_df42, 5); calld(0x100d_51e4, -0x3_8d63);          /* call 0x100d51e4 */
            ii(0x1010_df47, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1010_df49, 2); mov(bl, al);                            /* mov bl, al */
            ii(0x1010_df4b, 5); calld(0x100d_5204, -0x3_8d4c);          /* call 0x100d5204 */
            ...
            ii(0x1010_df61, 5); calld(0x100c_fa7c, -0x3_e4ea);          /* call 0x100cfa7c */
        ...
        l_0x1010_df7a:
            ...
            ii(0x1010_df82, 5); calld(0x1007_5fdc, -0x9_7fab);          /* call 0x10075fdc */
            ...
            ii(0x1010_df91, 5); calld(0x1007_5fdc, -0x9_7fba);          /* call 0x10075fdc */
            ii(0x1010_df96, 3); cmp(eax, 0x9);                          /* cmp eax, 0x9 */
            ii(0x1010_df99, 2); if(jnzd(0x1010_dfb6, 0x1b)) goto l_0x1010_dfb6; /* jnz 0x1010dfb6 */
        l_0x1010_df9b:
            ii(0x1010_df9b, 5); calld(0x100d_51c4, -0x3_8ddc);          /* call 0x100d51c4 */
            ...
            ii(0x1010_dfb1, 5); calld(0x100c_fb06, -0x3_e4b0);          /* call 0x100cfb06 */
        l_0x1010_dfb6:
        ...
        l_0x1010_dfbb:
            ...
            ii(0x1010_dfc3, 5); calld(Definitions.sys_display_draw_0, 0x5_94bc); /* call 0x10167484 */
