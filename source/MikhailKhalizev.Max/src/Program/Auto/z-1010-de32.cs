...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_de32()
        {
            ...
            ii(0x1010_de4a, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_de4d, 7); mov(memd[ss, ebp - 0x8], 0xc);          /* mov dword [ebp-0x8], 0xc */
            ii(0x1010_de54, 2); jmp(0x1010_de5c, 0x6); goto l_0x1010_de5c; /* jmp 0x1010de5c */
        l_0x1010_de56:
            ii(0x1010_de56, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_de59, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x1010_de5c:
            ii(0x1010_de5c, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_de60, 3); cmp(eax, 0x10);                         /* cmp eax, 0x10 */
            ii(0x1010_de63, 2); if(jge(0x1010_deb6, 0x51)) goto l_0x1010_deb6; /* jge 0x1010deb6 */
            ii(0x1010_de65, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_de69, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_de6c, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1010_de6f, 4); cmp(memd[ds, eax + 0x14], 0);           /* cmp dword [eax+0x14], 0x0 */
            ii(0x1010_de73, 2); if(jz(0x1010_dea6, 0x31)) goto l_0x1010_dea6; /* jz 0x1010dea6 */
            ii(0x1010_de75, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_de79, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_de7c, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1010_de7f, 3); mov(eax, memd[ds, eax + 0x14]);         /* mov eax, [eax+0x14] */
            ii(0x1010_de82, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1010_de85, 4); cmp(memd[ss, ebp - 0xc], 0);            /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1010_de89, 2); if(jz(0x1010_de9f, 0x14)) goto l_0x1010_de9f; /* jz 0x1010de9f */
            ii(0x1010_de8b, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_de8d, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1010_de9a, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1010_de9d, 2); jmp(0x1010_dea6, 0x7); goto l_0x1010_dea6; /* jmp 0x1010dea6 */
        l_0x1010_de9f:
            ii(0x1010_de9f, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
        l_0x1010_dea6:
            ii(0x1010_dea6, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1010_dea8, 4); movsx(edx, memb[ss, ebp - 0x8]);        /* movsx edx, byte [ebp-0x8] */
            ii(0x1010_deac, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1010_deb6:
            ...
            ii(0x1010_dec0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_dec3, 4); cmp(memd[ds, eax + 0xc], 0);            /* cmp dword [eax+0xc], 0x0 */
            ...
            ii(0x1010_dece, 3); lea(eax, memd[ss, ebp - 0x74]);         /* lea eax, [ebp-0x74] */
        ...
        l_0x1010_ded8:
            ...
            ii(0x1010_dedd, 3); lea(eax, memd[ss, ebp - 0x74]);         /* lea eax, [ebp-0x74] */
            ii(0x1010_dee0, 5); call(Definitions.sys_strcpy, 0x5_7fea); /* call 0x10165ecf */
        l_0x1010_dee5:
            ii(0x1010_dee5, 3); lea(eax, memd[ss, ebp - 0x74]);         /* lea eax, [ebp-0x74] */
            ii(0x1010_dee8, 5); mov(memd[ds, 0x101b_9b5c], eax);        /* mov [0x101b9b5c], eax */
            ii(0x1010_deed, 6); mov(memw[ss, ebp - 0x8], 0x6);          /* mov word [ebp-0x8], 0x6 */
        l_0x1010_def3:
            ii(0x1010_def3, 4); dec(memw[ss, ebp - 0x8]);               /* dec word [ebp-0x8] */
            ii(0x1010_def7, 5); cmp(memw[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp word [ebp-0x8], 0xffff */
            ...
            ii(0x1010_df13, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1010_df21, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1010_df2d:
            ii(0x1010_df2d, 6); mov(memw[ss, ebp - 0x8], 0x13);         /* mov word [ebp-0x8], 0x13 */
        l_0x1010_df33:
            ii(0x1010_df33, 4); dec(memw[ss, ebp - 0x8]);               /* dec word [ebp-0x8] */
            ii(0x1010_df37, 5); cmp(memw[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp word [ebp-0x8], 0xffff */
            ...
            ii(0x1010_df54, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_df58, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_df5b, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1010_df5e, 3); mov(eax, memd[ds, eax + 0x14]);         /* mov eax, [eax+0x14] */
            ii(0x1010_df61, 5); call(0x100c_fa7c, -0x3_e4ea);           /* call 0x100cfa7c */
            ii(0x1010_df66, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_df6a, 3); cmp(eax, 0xc);                          /* cmp eax, 0xc */
            ii(0x1010_df6d, 2); if(jl(0x1010_df78, 0x9)) goto l_0x1010_df78; /* jl 0x1010df78 */
            ii(0x1010_df6f, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_df73, 3); cmp(eax, 0x10);                         /* cmp eax, 0x10 */
            ii(0x1010_df76, 2); if(jl(0x1010_df7a, 0x2)) goto l_0x1010_df7a; /* jl 0x1010df7a */
        l_0x1010_df78:
            ii(0x1010_df78, 2); jmp(0x1010_dfb6, 0x3c); goto l_0x1010_dfb6; /* jmp 0x1010dfb6 */
        l_0x1010_df7a:
            ii(0x1010_df7a, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
        ...
        l_0x1010_df9b:
            ...
            ii(0x1010_dfa4, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_dfa8, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_dfab, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1010_dfae, 3); mov(eax, memd[ds, eax + 0x14]);         /* mov eax, [eax+0x14] */
        ...
        l_0x1010_dfbb:
            ii(0x1010_dfbb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_dfbe, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1010_dfc0, 3); mov(eax, memd[ds, eax + 0x12]);         /* mov eax, [eax+0x12] */
