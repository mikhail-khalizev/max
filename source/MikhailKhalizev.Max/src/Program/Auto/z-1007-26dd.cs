...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_26dd()
        {
            ...
            ii(0x1007_26f5, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_26f8, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1007_26ff, 2); jmp(0x1007_2707, 0x6); goto l_0x1007_2707; /* jmp 0x10072707 */
        l_0x1007_2701:
            ii(0x1007_2701, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_2704, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x1007_2707:
            ii(0x1007_2707, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1007_270b, 3); cmp(eax, 0x5);                          /* cmp eax, 0x5 */
            ii(0x1007_270e, 2); if(jae(0x1007_2733, 0x23)) goto l_0x1007_2733; /* jae 0x10072733 */
            ii(0x1007_2710, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_2713, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1007_2727, 2); if(jz(0x1007_2731, 0x8)) goto l_0x1007_2731; /* jz 0x10072731 */
            ii(0x1007_2729, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_272c, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1007_272f, 2); jmp(0x1007_273a, 0x9); goto l_0x1007_273a; /* jmp 0x1007273a */
        l_0x1007_2731:
            ii(0x1007_2731, 2); jmp(0x1007_2701, -0x32); goto l_0x1007_2701; /* jmp 0x10072701 */
        l_0x1007_2733:
            ii(0x1007_2733, 7); mov(memd[ss, ebp - 0xc], 0xffff_ffff);  /* mov dword [ebp-0xc], 0xffffffff */
        l_0x1007_273a:
            ii(0x1007_273a, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
