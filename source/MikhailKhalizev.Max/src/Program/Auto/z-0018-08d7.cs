...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_08d7()
        {
            ...
            ii(0x18_08e2, 2); push(-0x1 /* 0xff */);                    /* push 0xffff */
            ii(0x18_08e4, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x18_08e7, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ...
            ii(0x18_08f4, 3); retf(0x4);                                /* retf 0x4 */
        }
    }
}
