...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_60aa()
        {
            ...
            ii(0x1014_60c1, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1014_60c4, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1014_60c7, 3); lea(ebx, memd[ss, ebp - 12]);           /* lea ebx, [ebp-0xc] */
            ii(0x1014_60ca, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1014_60cd, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1014_60d0, 5); call(0x1014_5cbc, -0x419);              /* call 0x10145cbc */
            ii(0x1014_60d5, 2); test(al, al);                           /* test al, al */
            ii(0x1014_60d7, 2); if(jnz(0x1014_60e2, 9)) goto l_0x1014_60e2; /* jnz 0x101460e2 */
            ii(0x1014_60d9, 7); mov(memd[ss, ebp - 16], 0);             /* mov dword [ebp-0x10], 0x0 */
            ii(0x1014_60e0, 2); jmp(0x1014_60e8, 6); goto l_0x1014_60e8; /* jmp 0x101460e8 */
        l_0x1014_60e2:
            ii(0x1014_60e2, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1014_60e5, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
        l_0x1014_60e8:
            ii(0x1014_60e8, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
