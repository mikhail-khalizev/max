...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_fa3b()
        {
            ...
            ii(0x1008_fa53, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_fa56, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_fa58, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_fa65, 2); if(jz(0x1008_fa70, 0x9)) goto l_0x1008_fa70; /* jz 0x1008fa70 */
            ii(0x1008_fa67, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x1008_fa6b, 5); jmp(0x1008_fcba, 0x24a); goto l_0x1008_fcba; /* jmp 0x1008fcba */
        l_0x1008_fa70:
            ii(0x1008_fa70, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x1008_fa75, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fa78, 3); mov(eax, memd[ds, eax + 0x11]);         /* mov eax, [eax+0x11] */
            ...
            ii(0x1008_fa88, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fa8b, 3); mov(edx, memd[ds, eax + 0x11]);         /* mov edx, [eax+0x11] */
            ii(0x1008_fa8e, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1008_fa91, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fa94, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1008_faa2, 2); if(jg(0x1008_faa6, 0x2)) goto l_0x1008_faa6; /* jg 0x1008faa6 */
        l_0x1008_faa4:
            ii(0x1008_faa4, 2); jmp(0x1008_fab8, 0x12); goto l_0x1008_fab8; /* jmp 0x1008fab8 */
        l_0x1008_faa6:
            ii(0x1008_faa6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_faa9, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1008_fab6, 2); if(jnz(0x1008_faba, 0x2)) goto l_0x1008_faba; /* jnz 0x1008faba */
        l_0x1008_fab8:
            ii(0x1008_fab8, 2); jmp(0x1008_faca, 0x10); goto l_0x1008_faca; /* jmp 0x1008faca */
        l_0x1008_faba:
            ii(0x1008_faba, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fabd, 4); mov(memb[ds, eax + 0x25], 0x4);         /* mov byte [eax+0x25], 0x4 */
            ii(0x1008_fac1, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x1008_fac5, 5); jmp(0x1008_fcba, 0x1f0); goto l_0x1008_fcba; /* jmp 0x1008fcba */
        l_0x1008_faca:
            ii(0x1008_faca, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_facd, 3); mov(eax, memd[ds, eax + 0x11]);         /* mov eax, [eax+0x11] */
            ...
            ii(0x1008_fadd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fae0, 3); mov(edx, memd[ds, eax + 0x11]);         /* mov edx, [eax+0x11] */
            ii(0x1008_fae3, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1008_fae6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fae9, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1008_faf7, 2); if(jg(0x1008_fafb, 0x2)) goto l_0x1008_fafb; /* jg 0x1008fafb */
        l_0x1008_faf9:
            ii(0x1008_faf9, 2); jmp(0x1008_fb3b, 0x40); goto l_0x1008_fb3b; /* jmp 0x1008fb3b */
        l_0x1008_fafb:
            ii(0x1008_fafb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fafe, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1008_fb0d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fb10, 5); cmp(memw[ds, eax + 0x13], 0x28);        /* cmp word [eax+0x13], 0x28 */
            ii(0x1008_fb15, 2); if(jz(0x1008_fb29, 0x12)) goto l_0x1008_fb29; /* jz 0x1008fb29 */
            ii(0x1008_fb17, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fb1a, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1008_fb27, 2); if(jnz(0x1008_fb2b, 0x2)) goto l_0x1008_fb2b; /* jnz 0x1008fb2b */
        l_0x1008_fb29:
            ii(0x1008_fb29, 2); jmp(0x1008_fb3b, 0x10); goto l_0x1008_fb3b; /* jmp 0x1008fb3b */
        l_0x1008_fb2b:
            ii(0x1008_fb2b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fb2e, 4); mov(memb[ds, eax + 0x25], 0x4);         /* mov byte [eax+0x25], 0x4 */
            ii(0x1008_fb32, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x1008_fb36, 5); jmp(0x1008_fcba, 0x17f); goto l_0x1008_fcba; /* jmp 0x1008fcba */
        l_0x1008_fb3b:
            ii(0x1008_fb3b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fb3e, 3); mov(eax, memd[ds, eax + 0x11]);         /* mov eax, [eax+0x11] */
            ...
            ii(0x1008_fb4e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fb51, 3); mov(edx, memd[ds, eax + 0x11]);         /* mov edx, [eax+0x11] */
            ii(0x1008_fb54, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1008_fb57, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fb5a, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1008_fb68, 2); if(jg(0x1008_fb6c, 0x2)) goto l_0x1008_fb6c; /* jg 0x1008fb6c */
        l_0x1008_fb6a:
            ii(0x1008_fb6a, 2); jmp(0x1008_fb7e, 0x12); goto l_0x1008_fb7e; /* jmp 0x1008fb7e */
        l_0x1008_fb6c:
            ii(0x1008_fb6c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fb6f, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1008_fb7c, 2); if(jnz(0x1008_fb80, 0x2)) goto l_0x1008_fb80; /* jnz 0x1008fb80 */
        l_0x1008_fb7e:
            ii(0x1008_fb7e, 2); jmp(0x1008_fb90, 0x10); goto l_0x1008_fb90; /* jmp 0x1008fb90 */
        l_0x1008_fb80:
            ii(0x1008_fb80, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fb83, 4); mov(memb[ds, eax + 0x25], 0x4);         /* mov byte [eax+0x25], 0x4 */
            ii(0x1008_fb87, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x1008_fb8b, 5); jmp(0x1008_fcba, 0x12a); goto l_0x1008_fcba; /* jmp 0x1008fcba */
        l_0x1008_fb90:
            ii(0x1008_fb90, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fb93, 3); mov(edx, memd[ds, eax + 0x7]);          /* mov edx, [eax+0x7] */
            ii(0x1008_fb96, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1008_fb99, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fb9c, 3); mov(eax, memd[ds, eax + 0x11]);         /* mov eax, [eax+0x11] */
            ...
            ii(0x1008_fbae, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fbb1, 3); add(eax, 0x15);                         /* add eax, 0x15 */
            ii(0x1008_fbb4, 5); call(0x1007_6574, -0x1_9645);           /* call 0x10076574 */
            ii(0x1008_fbb9, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1008_fbc7, 3); mov(memd[ss, ebp - 0xc], ebx);          /* mov [ebp-0xc], ebx */
            ii(0x1008_fbca, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_fbcd, 3); add(edx, 0x21);                         /* add edx, 0x21 */
            ii(0x1008_fbd0, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1008_fbd3, 5); call(0x1007_5e64, -0x1_9d74);           /* call 0x10075e64 */
            ii(0x1008_fbd8, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1008_fbda, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fbdd, 3); mov(eax, memd[ds, eax + 0x11]);         /* mov eax, [eax+0x11] */
            ...
            ii(0x1008_fbec, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_fc03, 4); cmp(ax, memw[ds, edx + 0x8]);           /* cmp ax, [edx+0x8] */
            ii(0x1008_fc07, 2); if(jz(0x1008_fc0b, 0x2)) goto l_0x1008_fc0b; /* jz 0x1008fc0b */
        l_0x1008_fc09:
            ii(0x1008_fc09, 2); jmp(0x1008_fc41, 0x36); goto l_0x1008_fc41; /* jmp 0x1008fc41 */
        l_0x1008_fc0b:
            ii(0x1008_fc0b, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_fc0e, 3); mov(edx, memd[ds, edx + 0x7]);          /* mov edx, [edx+0x7] */
            ...
            ii(0x1008_fc25, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fc28, 3); add(eax, 0x15);                         /* add eax, 0x15 */
            ii(0x1008_fc2b, 5); call(0x1007_6574, -0x1_96bc);           /* call 0x10076574 */
            ii(0x1008_fc30, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1008_fc3e, 3); add(memd[ss, ebp - 0xc], eax);          /* add [ebp-0xc], eax */
        l_0x1008_fc41:
            ii(0x1008_fc41, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fc44, 3); add(eax, 0x15);                         /* add eax, 0x15 */
            ii(0x1008_fc47, 5); call(0x1007_6574, -0x1_96d8);           /* call 0x10076574 */
            ii(0x1008_fc4c, 4); mov(ax, memw[ds, eax + 0x52]);          /* mov ax, [eax+0x52] */
            ii(0x1008_fc50, 4); cmp(ax, memw[ss, ebp - 0xc]);           /* cmp ax, [ebp-0xc] */
            ii(0x1008_fc54, 2); if(jl(0x1008_fc5c, 0x6)) goto l_0x1008_fc5c; /* jl 0x1008fc5c */
            ii(0x1008_fc56, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x1008_fc5a, 2); jmp(0x1008_fcba, 0x5e); goto l_0x1008_fcba; /* jmp 0x1008fcba */
        l_0x1008_fc5c:
            ii(0x1008_fc5c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_fc5f, 4); mov(memb[ds, eax + 0x25], 0x4);         /* mov byte [eax+0x25], 0x4 */
            ii(0x1008_fc63, 5); mov(eax, 0x21);                         /* mov eax, 0x21 */
            ii(0x1008_fc68, 5); call(Definitions.sys_new, 0xd_6193);    /* call 0x10165e00 */
            ii(0x1008_fc6d, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1008_fc70, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x1008_fc73, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1008_fc76, 4); cmp(memd[ss, ebp - 0x10], 0);           /* cmp dword [ebp-0x10], 0x0 */
            ii(0x1008_fc7a, 2); if(jz(0x1008_fca3, 0x27)) goto l_0x1008_fca3; /* jz 0x1008fca3 */
            ii(0x1008_fc7c, 4); movsx(ecx, memw[ss, ebp - 0xc]);        /* movsx ecx, word [ebp-0xc] */
            ii(0x1008_fc80, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_fc8d, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_fc90, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x1008_fc93, 5); call(0x1008_bd0b, -0x3f8d);             /* call 0x1008bd0b */
            ii(0x1008_fc98, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1008_fc9b, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1008_fc9e, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1008_fca1, 2); jmp(0x1008_fca9, 0x6); goto l_0x1008_fca9; /* jmp 0x1008fca9 */
        l_0x1008_fca3:
            ii(0x1008_fca3, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1008_fca6, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
        l_0x1008_fca9:
            ii(0x1008_fca9, 3); mov(edx, memd[ss, ebp - 0x20]);         /* mov edx, [ebp-0x20] */
            ii(0x1008_fcac, 5); mov(eax, 0x101c_3180);                  /* mov eax, 0x101c3180 */
            ii(0x1008_fcb1, 5); call(0x100a_4d50, 0x1_509a);            /* call 0x100a4d50 */
            ii(0x1008_fcb6, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x1008_fcba:
            ii(0x1008_fcba, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
