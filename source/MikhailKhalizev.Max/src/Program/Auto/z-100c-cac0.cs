...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_cac0()
        {
            ...
            ii(0x100c_cae7, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ii(0x100c_caea, 5); call(0x1007_64b8, -0x5_6637);           /* call 0x100764b8 */
            ii(0x100c_caef, 7); mov(memd[ss, ebp - 20], 0);             /* mov dword [ebp-0x14], 0x0 */
            ii(0x100c_caf6, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100c_caf9, 5); call(0x100c_bb8b, -0xf73);              /* call 0x100cbb8b */
            ii(0x100c_cafe, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x100c_cb01, 5); cmp(memw[ss, ebp - 16], -1 /* 0xff */); /* cmp word [ebp-0x10], 0xffff */
            ii(0x100c_cb06, 2); if(jnz(0x100c_cb1e, 0x16)) goto l_0x100c_cb1e; /* jnz 0x100ccb1e */
            ii(0x100c_cb08, 7); mov(memd[ss, ebp - 28], 0);             /* mov dword [ebp-0x1c], 0x0 */
            ii(0x100c_cb0f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100c_cb11, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
        ...
        l_0x100c_cb20:
            ii(0x100c_cb20, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ii(0x100c_cb23, 5); call(0x1007_6bf8, -0x5_5f30);           /* call 0x10076bf8 */
        l_0x100c_cb28:
            ii(0x100c_cb28, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100c_cb2a, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ...
            ii(0x100c_cb3a, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ii(0x100c_cb3d, 5); call(0x1007_63a0, -0x5_67a2);           /* call 0x100763a0 */
            ii(0x100c_cb42, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100c_cb44, 3); mov(dl, memb[ds, eax + 38]);            /* mov dl, [eax+0x26] */
            ...
            ii(0x100c_cb54, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ii(0x100c_cb57, 5); call(0x1007_63a0, -0x5_67bc);           /* call 0x100763a0 */
            ii(0x100c_cb5c, 4); mov(ax, memw[ds, eax + 8]);             /* mov ax, [eax+0x8] */
            ii(0x100c_cb60, 4); cmp(ax, memw[ss, ebp - 16]);            /* cmp ax, [ebp-0x10] */
        ...
        l_0x100c_cb68:
            ...
            ii(0x100c_cb75, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ...
            ii(0x100c_cb85, 4); cmp(memd[ss, ebp - 20], 0);             /* cmp dword [ebp-0x14], 0x0 */
            ...
            ii(0x100c_cb8e, 4); cmp(ax, memw[ss, ebp - 12]);            /* cmp ax, [ebp-0xc] */
            ii(0x100c_cb92, 2); if(jge(0x100c_cba5, 0x11)) goto l_0x100c_cba5; /* jge 0x100ccba5 */
        l_0x100c_cb94:
            ii(0x100c_cb94, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ii(0x100c_cb97, 5); call(0x1007_63d4, -0x5_67c8);           /* call 0x100763d4 */
            ii(0x100c_cb9c, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x100c_cb9f, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100c_cba2, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
        l_0x100c_cba5:
            ii(0x100c_cba5, 5); jmp(0x100c_cb20, -0x8a); goto l_0x100c_cb20; /* jmp 0x100ccb20 */
        l_0x100c_cbaa:
            ii(0x100c_cbaa, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x100c_cbad, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x100c_cbb0, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100c_cbb2, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
        ...
        //  ii(0x100c_cbbe, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
        //  ii(0x100c_cbc1, 5); call(0x1007_5f6c, -0x5_6c5a);           /* call 0x10075f6c */
        l_0x100c_cbc6:
            ii(0x100c_cbc6, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
