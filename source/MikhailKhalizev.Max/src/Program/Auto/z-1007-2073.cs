...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_2073()
        {
            ...
            ii(0x1007_208b, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_208e, 5); cmp(memw[ss, ebp - 0x4], 0);            /* cmp word [ebp-0x4], 0x0 */
            ii(0x1007_2093, 2); if(jnz(0x1007_209e, 0x9)) goto l_0x1007_209e; /* jnz 0x1007209e */
            ii(0x1007_2095, 7); mov(memd[ss, ebp - 0x8], 0x5);          /* mov dword [ebp-0x8], 0x5 */
            ii(0x1007_209c, 2); jmp(0x1007_20a5, 0x7); goto l_0x1007_20a5; /* jmp 0x100720a5 */
        l_0x1007_209e:
            ii(0x1007_209e, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
        l_0x1007_20a5:
            ii(0x1007_20a5, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
