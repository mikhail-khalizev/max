...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_7474()
        {
            ...
            ii(0x1008_748b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_748e, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1008_7491, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_7493, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1008_74ab, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x1008_74bd:
            ii(0x1008_74bd, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1008_74c0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_74c3, 5); call(0x1015_27ed, 0xc_b325);            /* call 0x101527ed */
            ii(0x1008_74c8, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_74cb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_74ce, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x1008_74d1, 5); call(0x1008_ab1c, 0x3646);              /* call 0x1008ab1c */
            ii(0x1008_74d6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_74d9, 6); mov(memw[ds, eax + 0x1e], 0);           /* mov word [eax+0x1e], 0x0 */
            ii(0x1008_74df, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_74e2, 6); mov(memw[ds, eax + 0x20], 0);           /* mov word [eax+0x20], 0x0 */
            ii(0x1008_74e8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_74eb, 5); cmp(memw[ds, eax + 0x8], 0x4b);         /* cmp word [eax+0x8], 0x4b */
            ii(0x1008_74f0, 2); if(jz(0x1008_74fc, 0xa)) goto l_0x1008_74fc; /* jz 0x100874fc */
            ii(0x1008_74f2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_74f5, 5); cmp(memw[ds, eax + 0x8], 0x3b);         /* cmp word [eax+0x8], 0x3b */
            ii(0x1008_74fa, 2); if(jnz(0x1008_7505, 0x9)) goto l_0x1008_7505; /* jnz 0x10087505 */
        l_0x1008_74fc:
            ii(0x1008_74fc, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_74ff, 6); mov(memw[ds, eax + 0x1d], 0xffff);      /* mov word [eax+0x1d], 0xffff */
        l_0x1008_7505:
            ii(0x1008_7505, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_7508, 5); cmp(memw[ds, eax + 0x8], 0x3f);         /* cmp word [eax+0x8], 0x3f */
            ii(0x1008_750d, 2); if(jnz(0x1008_7518, 0x9)) goto l_0x1008_7518; /* jnz 0x10087518 */
            ii(0x1008_750f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_7512, 6); mov(memw[ds, eax + 0x1f], 0xffff);      /* mov word [eax+0x1f], 0xffff */
        l_0x1008_7518:
            ii(0x1008_7518, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_751b, 5); cmp(memw[ds, eax + 0x8], 0x4b);         /* cmp word [eax+0x8], 0x4b */
            ii(0x1008_7520, 2); if(jz(0x1008_752c, 0xa)) goto l_0x1008_752c; /* jz 0x1008752c */
            ii(0x1008_7522, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_7525, 5); cmp(memw[ds, eax + 0x8], 0x3b);         /* cmp word [eax+0x8], 0x3b */
            ii(0x1008_752a, 2); if(jnz(0x1008_752e, 0x2)) goto l_0x1008_752e; /* jnz 0x1008752e */
        l_0x1008_752c:
            ii(0x1008_752c, 2); jmp(0x1008_7538, 0xa); goto l_0x1008_7538; /* jmp 0x10087538 */
        l_0x1008_752e:
            ii(0x1008_752e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_7531, 5); cmp(memw[ds, eax + 0x8], 0x3f);         /* cmp word [eax+0x8], 0x3f */
            ii(0x1008_7536, 2); if(jnz(0x1008_7546, 0xe)) goto l_0x1008_7546; /* jnz 0x10087546 */
        l_0x1008_7538:
            ii(0x1008_7538, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_7544, 2); if(jl(0x1008_7548, 0x2)) goto l_0x1008_7548; /* jl 0x10087548 */
        l_0x1008_7546:
        ...
        l_0x1008_7548:
            ...
            ii(0x1008_7566, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ii(0x1008_7569, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x1008_757d, 2); jmp(0x1008_7585, 0x6); goto l_0x1008_7585; /* jmp 0x10087585 */
        l_0x1008_757f:
