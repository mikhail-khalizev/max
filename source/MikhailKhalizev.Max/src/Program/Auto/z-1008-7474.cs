...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1008_74bd:
            ...
            ii(0x1008_74d9, 6); mov(memw[ds, eax + 30], 0);             /* mov word [eax+0x1e], 0x0 */
            ii(0x1008_74df, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1008_74e2, 6); mov(memw[ds, eax + 32], 0);             /* mov word [eax+0x20], 0x0 */
        ...
        l_0x1008_74fc:
            ...
            ii(0x1008_74ff, 6); mov(memw[ds, eax + 29], 0xffff);        /* mov word [eax+0x1d], 0xffff */
        l_0x1008_7505:
            ...
            ii(0x1008_7512, 6); mov(memw[ds, eax + 31], 0xffff);        /* mov word [eax+0x1f], 0xffff */
        l_0x1008_7518:
        ...
        l_0x1008_7538:
            ...
            ii(0x1008_753b, 3); mov(eax, memd[ds, eax + 80]);           /* mov eax, [eax+0x50] */
        ...
        l_0x1008_7548:
            ...
            ii(0x1008_7552, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1008_7555, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1008_7558, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1008_755b, 4); cmp(memd[ss, ebp - 16], 0);             /* cmp dword [ebp-0x10], 0x0 */
            ...
            ii(0x1008_756c, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1008_756f, 5); call(0x1008_bd0b, 0x4797);              /* call 0x1008bd0b */
            ii(0x1008_7574, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1008_7577, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x1008_757a, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x1008_757d, 2); jmp(0x1008_7585, 6); goto l_0x1008_7585; /* jmp 0x10087585 */
        l_0x1008_757f:
            ii(0x1008_757f, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1008_7582, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
        l_0x1008_7585:
            ii(0x1008_7585, 3); mov(edx, memd[ss, ebp - 24]);           /* mov edx, [ebp-0x18] */
