...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_1740()
        {
            ...
            ii(0x1015_175e, 4);  mov(ax, memw[ds, eax + 26]);          /* mov ax, [eax+0x1a] */
            ii(0x1015_1762, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1015_1765, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_1768, 4);  mov(ax, memw[ds, eax + 28]);          /* mov ax, [eax+0x1c] */
            ii(0x1015_176c, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ...
            ii(0x1015_178a, 4);  mov(ax, memw[ds, eax + 82]);          /* mov ax, [eax+0x52] */
            ii(0x1015_178e, 3);  mov(memd[ss, ebp - 40], eax);         /* mov [ebp-0x28], eax */
        l_0x1015_1791:
            ii(0x1015_1791, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_1794, 4);  cmp(memb[ds, eax + 62], 6);           /* cmp byte [eax+0x3e], 0x6 */
        ...
        l_0x1015_17a3:
            ...
            ii(0x1015_17b0, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ii(0x1015_17b4, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1015_17c5, 3);  mov(edx, memd[ds, eax + 23]);         /* mov edx, [eax+0x17] */
            ii(0x1015_17c8, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x1015_17cb, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_17ce, 3);  mov(eax, memd[ds, eax + 80]);         /* mov eax, [eax+0x50] */
            ii(0x1015_17d1, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x1015_17d4, 4);  movsx(ebx, memw[ss, ebp - 40]);       /* movsx ebx, word [ebp-0x28] */
            ...
            ii(0x1015_17e4, 4);  mov(memw[ds, eax + 82], dx);          /* mov [eax+0x52], dx */
            ii(0x1015_17e8, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_17eb, 7);  mov(ax, memw[ds, eax + 213]);         /* mov ax, [eax+0xd5] */
            ...
            ii(0x1015_1803, 4);  mov(memb[ds, eax + 61], 0);           /* mov byte [eax+0x3d], 0x0 */
            ii(0x1015_1807, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_180a, 4);  mov(memb[ds, eax + 62], 1);           /* mov byte [eax+0x3e], 0x1 */
            ...
            ii(0x1015_181b, 4);  test(memb[ds, eax + 18], 0x10);       /* test byte [eax+0x12], 0x10 */
            ...
            ii(0x1015_1824, 4);  mov(dx, memw[ds, eax + 26]);          /* mov dx, [eax+0x1a] */
            ii(0x1015_1828, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_182b, 4);  mov(memw[ds, eax + 65], dx);          /* mov [eax+0x41], dx */
            ii(0x1015_182f, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_1832, 4);  mov(dx, memw[ds, eax + 28]);          /* mov dx, [eax+0x1c] */
            ii(0x1015_1836, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_1839, 4);  mov(memw[ds, eax + 67], dx);          /* mov [eax+0x43], dx */
        ...
        l_0x1015_188f:
            ...
            ii(0x1015_1893, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_1896, 5);  call(Definitions.my_ctor_0x101b_38f8, -0xd_b1ab);/* call 0x100766f0 */
            ii(0x1015_189b, 3);  mov(memd[ss, ebp - 36], eax);         /* mov [ebp-0x24], eax */
            ...
            ii(0x1015_18b5, 3);  mov(memd[ss, ebp - 32], edx);         /* mov [ebp-0x20], edx */
            ii(0x1015_18b8, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_18bb, 4);  test(memb[ds, eax + 19], 2);          /* test byte [eax+0x13], 0x2 */
            ...
            ii(0x1015_18d1, 4);  movsx(eax, memw[ss, ebp - 20]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1015_18d5, 1);  push(eax);                            /* push eax */
            ii(0x1015_18d6, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1015_18e8, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ...
            ii(0x1015_1970, 4);  cmp(memb[ds, eax + 122], 0);          /* cmp byte [eax+0x7a], 0x0 */
            ii(0x1015_1974, 2);  if(jz(0x1015_198c, 0x16)) goto l_0x1015_198c;/* jz 0x1015198c */
            ii(0x1015_1976, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
        ...
        l_0x1015_198c:
            ii(0x1015_198c, 3);  lea(edx, memd[ss, ebp - 28]);         /* lea edx, [ebp-0x1c] */
            ...
            ii(0x1015_199f, 6);  mov(memw[ds, eax + 82], 1);           /* mov word [eax+0x52], 0x1 */
            ii(0x1015_19a5, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_19a8, 4);  mov(memb[ds, eax + 61], 4);           /* mov byte [eax+0x3d], 0x4 */
            ii(0x1015_19ac, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_19af, 4);  mov(memb[ds, eax + 62], 0x1f);        /* mov byte [eax+0x3e], 0x1f */
            ii(0x1015_19b3, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_19b6, 3);  mov(edx, memd[ds, eax + 49]);         /* mov edx, [eax+0x31] */
        ...
        l_0x1015_1a02:
            ii(0x1015_1a02, 4);  movsx(ebx, memw[ss, ebp - 20]);       /* movsx ebx, word [ebp-0x14] */
            ii(0x1015_1a06, 4);  movsx(edx, memw[ss, ebp - 12]);       /* movsx edx, word [ebp-0xc] */
            ii(0x1015_1a0a, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_1a0d, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ...
            ii(0x1015_1a1a, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_1a1d, 5);  call(0x1007_6630, -0xd_b3f2);         /* call 0x10076630 */
            ii(0x1015_1a22, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1015_1a24, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1015_1a45, 3);  mov(eax, memd[ds, eax + 26]);         /* mov eax, [eax+0x1a] */
            ...
            ii(0x1015_1a50, 3);  mov(eax, memd[ds, eax + 24]);         /* mov eax, [eax+0x18] */
            ...
            ii(0x1015_1a70, 6);  lea(eax, memd[ss, ebp - 244]);        /* lea eax, [ebp-0xf4] */
            ...
            ii(0x1015_1a81, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1015_1a97, 6);  lea(edx, memd[ss, ebp - 244]);        /* lea edx, [ebp-0xf4] */
        ...
        l_0x1015_1aa7:
            ii(0x1015_1aa7, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_1aaa, 5);  call(0x1007_6574, -0xd_b53b);         /* call 0x10076574 */
            ii(0x1015_1aaf, 4);  mov(ax, memw[ds, eax + 26]);          /* mov ax, [eax+0x1a] */
            ii(0x1015_1ab3, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1015_1ab6, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_1ab9, 5);  call(0x1007_6574, -0xd_b54a);         /* call 0x10076574 */
            ii(0x1015_1abe, 4);  mov(ax, memw[ds, eax + 28]);          /* mov ax, [eax+0x1c] */
            ii(0x1015_1ac2, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ...
            ii(0x1015_1ad1, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1015_1ad5, 1);  push(eax);                            /* push eax */
            ii(0x1015_1ad6, 4);  movsx(eax, memw[ss, ebp - 24]);       /* movsx eax, word [ebp-0x18] */
            ...
            ii(0x1015_1ae0, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
        ...
        l_0x1015_1b31:
            ii(0x1015_1b31, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1015_1b48, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1015_1b5f, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1015_1b79, 7);  mov(ax, memw[ds, eax + 213]);         /* mov ax, [eax+0xd5] */
        ...
        l_0x1015_1b90:
            ...
            ii(0x1015_1b93, 3);  mov(al, memb[ds, eax + 41]);          /* mov al, [eax+0x29] */
        ...
        l_0x1015_1ba3:
            ii(0x1015_1ba3, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1015_1bb2, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
        ...
        l_0x1015_1bc3:
            ii(0x1015_1bc3, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
        ...
        l_0x1015_1bd4:
            ii(0x1015_1bd4, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
        ...
        l_0x1015_1be7:
            ...
            ii(0x1015_1bf1, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ii(0x1015_1bf5, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1015_1c0d, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_1c10, 5);  call(0x1007_6574, -0xd_b6a1);         /* call 0x10076574 */
            ii(0x1015_1c15, 4);  mov(memb[ds, eax + 61], 0);           /* mov byte [eax+0x3d], 0x0 */
            ii(0x1015_1c19, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_1c1c, 5);  call(0x1007_6574, -0xd_b6ad);         /* call 0x10076574 */
            ii(0x1015_1c21, 4);  mov(memb[ds, eax + 62], 1);           /* mov byte [eax+0x3e], 0x1 */
            ii(0x1015_1c25, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1015_1c37, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1015_1c82, 4);  mov(memb[ds, eax + 62], 0x1f);        /* mov byte [eax+0x3e], 0x1f */
        ...
        l_0x1015_1c88:
            ...
            ii(0x1015_1c8b, 4);  mov(memb[ds, eax + 61], 0);           /* mov byte [eax+0x3d], 0x0 */
            ii(0x1015_1c8f, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_1c92, 4);  mov(memb[ds, eax + 62], 1);           /* mov byte [eax+0x3e], 0x1 */
        l_0x1015_1c96:
            ii(0x1015_1c96, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_1c99, 3);  mov(al, memb[ds, eax + 41]);          /* mov al, [eax+0x29] */
            ...
            ii(0x1015_1cbd, 6);  mov(memd[ss, ebp - 252], eax);        /* mov [ebp-0xfc], eax */
            ii(0x1015_1cc3, 6);  mov(eax, memd[ss, ebp - 252]);        /* mov eax, [ebp-0xfc] */
            ii(0x1015_1cc9, 3);  mov(ebx, memd[ds, eax + 2]);          /* mov ebx, [eax+0x2] */
            ii(0x1015_1ccc, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_1ccf, 5);  call(0x1007_6600, -0xd_b6d4);         /* call 0x10076600 */
            ii(0x1015_1cd4, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1015_1cd6, 6);  mov(eax, memd[ss, ebp - 252]);        /* mov eax, [ebp-0xfc] */
            ii(0x1015_1cdc, 3);  call_abs(memd[ds, ebx + 44]);         /* call dword [ebx+0x2c] */
        l_0x1015_1cdf:
        ...
        l_0x1015_1ce1:
            ...
            ii(0x1015_1ce4, 4);  mov(memb[ds, eax + 61], 4);           /* mov byte [eax+0x3d], 0x4 */
            ii(0x1015_1ce8, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_1ceb, 4);  mov(memb[ds, eax + 62], 0x1f);        /* mov byte [eax+0x3e], 0x1f */
            ...
            ii(0x1015_1d05, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
        ...
        l_0x1015_1d12:
            ...
            ii(0x1015_1d14, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
