...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_0439()
        {
            ...
            ii(0x100f_0450, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100f_0453, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100f_0456, 4); cmp(memd[ss, ebp - 0x8], 0);            /* cmp dword [ebp-0x8], 0x0 */
            ii(0x100f_045a, 2); if(jnz(0x100f_0462, 0x6)) goto l_0x100f_0462; /* jnz 0x100f0462 */
            ii(0x100f_045c, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
        ...
        l_0x100f_0462:
            ...
            ii(0x100f_0467, 3); lea(eax, memd[ss, ebp - 0x70]);         /* lea eax, [ebp-0x70] */
            ii(0x100f_046a, 5); call(Definitions.sys_strcpy, 0x7_5a60); /* call 0x10165ecf */
            ii(0x100f_046f, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100f_0472, 3); lea(eax, memd[ss, ebp - 0x70]);         /* lea eax, [ebp-0x70] */
            ...
            ii(0x100f_047f, 3); lea(eax, memd[ss, ebp - 0x70]);         /* lea eax, [ebp-0x70] */
            ii(0x100f_0482, 5); call(Definitions.my_fopen, -0x1068);    /* call 0x100ef41f */
            ii(0x100f_0487, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100f_0489, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_048c, 2); mov(memd[ds, eax], edx);                /* mov [eax], edx */
            ii(0x100f_048e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_0491, 5); call(Definitions.sys_delete, 0x7_5ace); /* call 0x10165f64 */
            ii(0x100f_0496, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_0499, 3); cmp(memd[ds, eax], 0);                  /* cmp dword [eax], 0x0 */
            ii(0x100f_049c, 2); if(jnz(0x100f_04a4, 0x6)) goto l_0x100f_04a4; /* jnz 0x100f04a4 */
            ii(0x100f_049e, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
            ii(0x100f_04a2, 2); jmp(0x100f_04cd, 0x29); goto l_0x100f_04cd; /* jmp 0x100f04cd */
        l_0x100f_04a4:
            ii(0x100f_04a4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100f_04b0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_04b3, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x100f_04b5, 5); call(Definitions.sys_fclose, 0x8_1baf); /* call 0x10172069 */
            ii(0x100f_04ba, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_04bd, 6); mov(memd[ds, eax], 0);                  /* mov dword [eax], 0x0 */
            ii(0x100f_04c3, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
            ii(0x100f_04c7, 2); jmp(0x100f_04cd, 0x4); goto l_0x100f_04cd; /* jmp 0x100f04cd */
        l_0x100f_04c9:
            ii(0x100f_04c9, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
        l_0x100f_04cd:
            ii(0x100f_04cd, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
