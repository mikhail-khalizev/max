...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_b4e9()
        {
            ...
            ii(0x1018_b4f7, 4); test(memb[ds, edx + 0xd], 0x10);        /* test byte [edx+0xd], 0x10 */
            ii(0x1018_b4fb, 2); if(jz(0x1018_b504, 0x7)) goto l_0x1018_b504; /* jz 0x1018b504 */
        l_0x1018_b4fd:
        ...
        l_0x1018_b536:
            ...
            ii(0x1018_b551, 2); if(jz(0x1018_b557, 0x4)) goto l_0x1018_b557; /* jz 0x1018b557 */
            ii(0x1018_b553, 4); or(memb[ds, edx + 0xc], 0x4);           /* or byte [edx+0xc], 0x4 */
        l_0x1018_b557:
            ii(0x1018_b557, 2); mov(eax, memd[ds, edx]);                /* mov eax, [edx] */
        l_0x1018_b559:
            ii(0x1018_b559, 2); mov(memb[ds, eax], bl);                 /* mov [eax], bl */
            ii(0x1018_b55b, 4); and(memb[ds, edx + 0xc], -0x11 /* 0xef */); /* and byte [edx+0xc], 0xef */
