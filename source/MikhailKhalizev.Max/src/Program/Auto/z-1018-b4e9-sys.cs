...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1018_b504:
            ii(0x1018_b504, 4); test(memb[ds, edx + 0xc], 1);           /* test byte [edx+0xc], 0x1 */
        ...
        l_0x1018_b517:
            ...
            ii(0x1018_b527, 4); or(memb[ds, edx + 0xc], 4);             /* or byte [edx+0xc], 0x4 */
        ...
        l_0x1018_b536:
            ...
            ii(0x1018_b553, 4); or(memb[ds, edx + 0xc], 4);             /* or byte [edx+0xc], 0x4 */
        l_0x1018_b557:
