...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("5267cbb7-3b39-4f94-a770-76417b139988")]
        public void /* sys */ Method_1019_afb9()
        {
            ii(0x1019_afb9, 1); pushd(esi);                             /* push esi */
            ii(0x1019_afba, 1); pushd(edi);                             /* push edi */
            ii(0x1019_afbb, 1); pushd(ebp);                             /* push ebp */
            ...
            ii(0x1019_afc8, 2); if(jaed(0x1019_afe6, 0x1c)) goto l_0x1019_afe6; /* jae 0x1019afe6 */
            ii(0x1019_afca, 2); test(ebx, ebx);                         /* test ebx, ebx */
            ii(0x1019_afcc, 2); if(jled(0x1019_afe6, 0x18)) goto l_0x1019_afe6; /* jle 0x1019afe6 */
            ii(0x1019_afce, 6); lea(esi, edx + 0x1_5180);               /* lea esi, [edx+0x15180] */
            ...
            ii(0x1019_afe4, 2); jmpd(0x1019_aff5, 0xf); goto l_0x1019_aff5; /* jmp 0x1019aff5 */
        l_0x1019_afe6:
        ...
        l_0x1019_aff5:
            ...
            ii(0x1019_b00f, 3); mov(memd_a32[ds, ecx + 0x8], eax);      /* mov [ecx+0x8], eax */
            ...
            ii(0x1019_b025, 3); mov(memd_a32[ds, ecx + 0x4], eax);      /* mov [ecx+0x4], eax */
            ...
            ii(0x1019_b033, 2); mov(memd_a32[ds, ecx], edx);            /* mov [ecx], edx */
            ...
            ii(0x1019_b052, 2); if(jbed(0x1019_b05c, 0x8)) goto l_0x1019_b05c; /* jbe 0x1019b05c */
            ii(0x1019_b054, 3); lea(eax, edx - 0x1);                    /* lea eax, [edx-0x1] */
            ii(0x1019_b057, 3); shr(eax, 0x2);                          /* shr eax, 0x2 */
            ii(0x1019_b05a, 2); sub(ebx, eax);                          /* sub ebx, eax */
        l_0x1019_b05c:
            ii(0x1019_b05c, 6); lea(eax, edx + 0x76c);                  /* lea eax, [edx+0x76c] */
            ii(0x1019_b062, 5); calld(/* sys */ 0x1019_ab72, -0x4f5);   /* call 0x1019ab72 */
            ii(0x1019_b067, 5); add(eax, 0x16d);                        /* add eax, 0x16d */
        l_0x1019_b06c:
            ii(0x1019_b06c, 2); cmp(ebx, eax);                          /* cmp ebx, eax */
            ii(0x1019_b06e, 2); if(jbd(0x1019_b075, 0x5)) goto l_0x1019_b075; /* jb 0x1019b075 */
            ii(0x1019_b070, 1); inc(edx);                               /* inc edx */
            ii(0x1019_b071, 2); sub(ebx, eax);                          /* sub ebx, eax */
            ii(0x1019_b073, 2); jmpd(0x1019_b06c, -0x9); goto l_0x1019_b06c; /* jmp 0x1019b06c */
        l_0x1019_b075:
            ii(0x1019_b075, 5); mov(esi, 0x101b_76cc);                  /* mov esi, 0x101b76cc */
            ii(0x1019_b07a, 3); mov(memd_a32[ds, ecx + 0x14], edx);     /* mov [ecx+0x14], edx */
            ii(0x1019_b07d, 6); lea(eax, edx + 0x76c);                  /* lea eax, [edx+0x76c] */
            ii(0x1019_b083, 3); mov(memd_a32[ds, ecx + 0x1c], ebx);     /* mov [ecx+0x1c], ebx */
            ii(0x1019_b086, 5); calld(/* sys */ 0x1019_ab72, -0x519);   /* call 0x1019ab72 */
            ii(0x1019_b08b, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1019_b08d, 2); if(jzd(0x1019_b094, 0x5)) goto l_0x1019_b094; /* jz 0x1019b094 */
        ...
        l_0x1019_b094:
            ...
            ii(0x1019_b0a1, 3); mov(edx, memd_a32[ds, esi + edx * 2]);  /* mov edx, [esi+edx*2] */
            ii(0x1019_b0a4, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1019_b0a7, 2); cmp(ebx, edx);                          /* cmp ebx, edx */
            ii(0x1019_b0a9, 2); if(jbd(0x1019_b0ac, 0x1)) goto l_0x1019_b0ac; /* jb 0x1019b0ac */
            ii(0x1019_b0ab, 1); inc(eax);                               /* inc eax */
        l_0x1019_b0ac:
            ii(0x1019_b0ac, 3); mov(memd_a32[ds, ecx + 0x10], eax);     /* mov [ecx+0x10], eax */
            ii(0x1019_b0af, 4); movsx(eax, memw_a32[ds, esi + eax * 2]); /* movsx eax, word [esi+eax*2] */
            ii(0x1019_b0b3, 2); sub(ebx, eax);                          /* sub ebx, eax */
            ii(0x1019_b0b5, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1019_b0b7, 1); inc(ebx);                               /* inc ebx */
            ii(0x1019_b0b8, 3); lea(eax, edi + 0x1);                    /* lea eax, [edi+0x1] */
            ii(0x1019_b0bb, 3); mov(memd_a32[ds, ecx + 0xc], ebx);      /* mov [ecx+0xc], ebx */
            ii(0x1019_b0be, 5); mov(ebx, 0x7);                          /* mov ebx, 0x7 */
            ii(0x1019_b0c3, 2); div(ebx);                               /* div ebx */
            ii(0x1019_b0c5, 2); mov(eax, ecx);                          /* mov eax, ecx */
            ii(0x1019_b0c7, 3); mov(memd_a32[ds, ecx + 0x18], edx);     /* mov [ecx+0x18], edx */
            ii(0x1019_b0ca, 1); popd(ebp);                              /* pop ebp */
            ii(0x1019_b0cb, 1); popd(edi);                              /* pop edi */
            ii(0x1019_b0cc, 1); popd(esi);                              /* pop esi */
            ii(0x1019_b0cd, 1); retd(); return;                         /* ret */
        }
    }
}
