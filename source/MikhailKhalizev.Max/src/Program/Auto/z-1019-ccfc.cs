...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1019_ccfc()
        {
            ...
            ii(0x1019_cd09, 3); mov(edx, memd[ds, edx + 4]);            /* mov edx, [edx+0x4] */
            ii(0x1019_cd0c, 2); sub(eax, eax);                          /* sub eax, eax */
        l_0x1019_cd0e:
            ii(0x1019_cd0e, 3); cmp(edx, memd[cs, edi]);                /* cmp edx, [cs:edi] */
            ii(0x1019_cd11, 2); if(jnz(0x1019_cd17, 4)) goto l_0x1019_cd17; /* jnz 0x1019cd17 */
            ii(0x1019_cd13, 4); cmp(ecx, memd[cs, edi + 4]);            /* cmp ecx, [cs:edi+0x4] */
        l_0x1019_cd17:
            ii(0x1019_cd17, 2); if(jb(0x1019_cd1f, 6)) goto l_0x1019_cd1f; /* jb 0x1019cd1f */
            ii(0x1019_cd19, 3); add(edi, 8);                            /* add edi, 0x8 */
            ii(0x1019_cd1c, 1); inc(eax);                               /* inc eax */
            ii(0x1019_cd1d, 2); jmp(0x1019_cd0e, -0x11); goto l_0x1019_cd0e; /* jmp 0x1019cd0e */
        l_0x1019_cd1f:
            ii(0x1019_cd1f, 3); sub(edi, 8);                            /* sub edi, 0x8 */
        l_0x1019_cd22:
            ii(0x1019_cd22, 3); cmp(edx, memd[cs, edi]);                /* cmp edx, [cs:edi] */
            ii(0x1019_cd25, 2); if(jnz(0x1019_cd2b, 4)) goto l_0x1019_cd2b; /* jnz 0x1019cd2b */
            ii(0x1019_cd27, 4); cmp(ecx, memd[cs, edi + 4]);            /* cmp ecx, [cs:edi+0x4] */
        l_0x1019_cd2b:
            ii(0x1019_cd2b, 2); if(jae(0x1019_cd33, 6)) goto l_0x1019_cd33; /* jae 0x1019cd33 */
            ii(0x1019_cd2d, 3); sub(edi, 8);                            /* sub edi, 0x8 */
