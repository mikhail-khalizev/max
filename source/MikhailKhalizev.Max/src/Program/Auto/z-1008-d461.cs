...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_d461()
        {
            ...
            ii(0x1008_d479, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_d47c, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_d47e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_d48d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_d490, 3); add(eax, 0x15);                         /* add eax, 0x15 */
            ii(0x1008_d493, 5); call(0x1007_6574, -0x1_6f24);           /* call 0x10076574 */
            ii(0x1008_d498, 4); cmp(memb[ds, eax + 0x3d], 0x4);         /* cmp byte [eax+0x3d], 0x4 */
            ii(0x1008_d49c, 2); if(jz(0x1008_d4a0, 0x2)) goto l_0x1008_d4a0; /* jz 0x1008d4a0 */
        l_0x1008_d49e:
            ii(0x1008_d49e, 2); jmp(0x1008_d4e5, 0x45); goto l_0x1008_d4e5; /* jmp 0x1008d4e5 */
        l_0x1008_d4a0:
            ii(0x1008_d4a0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_d4b2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_d4b5, 3); add(eax, 0x19);                         /* add eax, 0x19 */
            ii(0x1008_d4b8, 5); call(0x1007_6630, -0x1_6e8d);           /* call 0x10076630 */
            ii(0x1008_d4bd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_d4cd, 3); cmp(eax, memd[ss, ebp - 0x4]);          /* cmp eax, [ebp-0x4] */
            ii(0x1008_d4d0, 2); if(jz(0x1008_d4e5, 0x13)) goto l_0x1008_d4e5; /* jz 0x1008d4e5 */
            ii(0x1008_d4d2, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_d4d5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1008_d4e5:
            ii(0x1008_d4e5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_d4e8, 4); mov(memb[ds, eax + 0x25], 0xa);         /* mov byte [eax+0x25], 0xa */
            ii(0x1008_d4ec, 5); mov(eax, 0x1f);                         /* mov eax, 0x1f */
            ii(0x1008_d4f1, 5); call(Definitions.sys_new, 0xd_890a);    /* call 0x10165e00 */
            ii(0x1008_d4f6, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_d4f9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_d4fc, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1008_d4ff, 4); cmp(memd[ss, ebp - 0xc], 0);            /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1008_d503, 2); if(jz(0x1008_d537, 0x32)) goto l_0x1008_d537; /* jz 0x1008d537 */
            ii(0x1008_d505, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_d512, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ii(0x1008_d515, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_d518, 3); add(eax, 0x15);                         /* add eax, 0x15 */
            ii(0x1008_d51b, 5); call(0x1007_65d0, -0x1_6f50);           /* call 0x100765d0 */
            ii(0x1008_d520, 3); mov(esi, memd[ss, ebp - 0x8]);          /* mov esi, [ebp-0x8] */
            ...
            ii(0x1008_d52c, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1008_d52f, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1008_d532, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1008_d535, 2); jmp(0x1008_d53d, 0x6); goto l_0x1008_d53d; /* jmp 0x1008d53d */
        l_0x1008_d537:
            ii(0x1008_d537, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1008_d53a, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
        l_0x1008_d53d:
            ii(0x1008_d53d, 3); mov(edx, memd[ss, ebp - 0x18]);         /* mov edx, [ebp-0x18] */
            ii(0x1008_d540, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1008_d543, 5); call(0x1008_b060, -0x24e8);             /* call 0x1008b060 */
            ii(0x1008_d548, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1008_d55e, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
