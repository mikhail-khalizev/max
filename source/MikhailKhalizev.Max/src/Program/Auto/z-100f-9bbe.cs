...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_9bbe()
        {
            ...
            ii(0x100f_9bc7, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x100f_9bca, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
            ...
            ii(0x100f_9bdf, 2); if(jnz(0x100f_9be7, 0x6)) goto l_0x100f_9be7; /* jnz 0x100f9be7 */
            ii(0x100f_9be1, 4); mov(memb[ss, ebp - 0x44], 0x1);         /* mov byte [ebp-0x44], 0x1 */
            ii(0x100f_9be5, 2); jmp(0x100f_9beb, 0x4); goto l_0x100f_9beb; /* jmp 0x100f9beb */
        l_0x100f_9be7:
            ii(0x100f_9be7, 4); mov(memb[ss, ebp - 0x44], 0);           /* mov byte [ebp-0x44], 0x0 */
        l_0x100f_9beb:
            ii(0x100f_9beb, 3); mov(al, memb[ss, ebp - 0x44]);          /* mov al, [ebp-0x44] */
