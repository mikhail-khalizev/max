...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_1172()
        {
            ...
            ii(0x1015_1189, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_118c, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1015_118f, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1015_119c, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1015_119f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_11a2, 3); mov(ebx, memd[ds, eax + 0x1a]);         /* mov ebx, [eax+0x1a] */
            ii(0x1015_11a5, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1015_11a8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_11ab, 3); mov(edx, memd[ds, eax + 0x18]);         /* mov edx, [eax+0x18] */
            ii(0x1015_11ae, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1015_11b1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_11b4, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ...
            ii(0x1015_11c1, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1015_11c4, 5); call(0x1007_66ac, -0xd_ab1d);           /* call 0x100766ac */
            ii(0x1015_11c9, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1015_11cc, 5); call(0x1007_6574, -0xd_ac5d);           /* call 0x10076574 */
            ii(0x1015_11d1, 3); mov(ebx, memd[ds, eax + 0x1a]);         /* mov ebx, [eax+0x1a] */
            ii(0x1015_11d4, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1015_11d7, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1015_11da, 5); call(0x1007_6574, -0xd_ac6b);           /* call 0x10076574 */
            ii(0x1015_11df, 3); mov(edx, memd[ds, eax + 0x18]);         /* mov edx, [eax+0x18] */
            ii(0x1015_11e2, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1015_11e5, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1015_11e8, 5); call(0x1007_6aac, -0xd_a741);           /* call 0x10076aac */
            ii(0x1015_11ed, 7); test(memd[ss, ebp - 0xc], 0x10);        /* test dword [ebp-0xc], 0x10 */
            ii(0x1015_11f4, 6); if(jz(0x1015_12db, 0xe1)) goto l_0x1015_12db; /* jz 0x101512db */
            ii(0x1015_11fa, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1015_11fd, 5); call(Definitions.my_ctor_0x101b_4184, -0xd_a712); /* call 0x10076af0 */
            ii(0x1015_1202, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1015_1205, 4); mov(memw[ss, ebp - 0x18], ax);          /* mov [ebp-0x18], ax */
            ii(0x1015_1209, 2); jmp(0x1015_1212, 0x7); goto l_0x1015_1212; /* jmp 0x10151212 */
        l_0x1015_120b:
            ii(0x1015_120b, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1015_120e, 4); inc(memw[ss, ebp - 0x18]);              /* inc word [ebp-0x18] */
        l_0x1015_1212:
            ii(0x1015_1212, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1015_1216, 4); movsx(edx, memw[ss, ebp - 0x18]);       /* movsx edx, word [ebp-0x18] */
            ...
            ii(0x1015_1225, 3); mov(eax, memd[ss, ebp - 0x12]);         /* mov eax, [ebp-0x12] */
            ii(0x1015_1228, 4); mov(memw[ss, ebp - 0x16], ax);          /* mov [ebp-0x16], ax */
            ii(0x1015_122c, 2); jmp(0x1015_1235, 0x7); goto l_0x1015_1235; /* jmp 0x10151235 */
        l_0x1015_122e:
            ii(0x1015_122e, 3); mov(eax, memd[ss, ebp - 0x16]);         /* mov eax, [ebp-0x16] */
            ii(0x1015_1231, 4); inc(memw[ss, ebp - 0x16]);              /* inc word [ebp-0x16] */
        l_0x1015_1235:
            ii(0x1015_1235, 4); movsx(eax, memw[ss, ebp - 0x12]);       /* movsx eax, word [ebp-0x12] */
            ii(0x1015_1239, 4); movsx(edx, memw[ss, ebp - 0x16]);       /* movsx edx, word [ebp-0x16] */
            ...
            ii(0x1015_1248, 4); movsx(ebx, memw[ss, ebp - 0x16]);       /* movsx ebx, word [ebp-0x16] */
            ii(0x1015_124c, 4); movsx(edx, memw[ss, ebp - 0x18]);       /* movsx edx, word [ebp-0x18] */
            ...
            ii(0x1015_125c, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_125f, 5); call(0x1007_64b8, -0xd_adac);           /* call 0x100764b8 */
            ii(0x1015_1264, 2); jmp(0x1015_126e, 0x8); goto l_0x1015_126e; /* jmp 0x1015126e */
        l_0x1015_1266:
            ii(0x1015_1266, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_1269, 5); call(0x1007_6bf8, -0xd_a676);           /* call 0x10076bf8 */
        l_0x1015_126e:
            ii(0x1015_126e, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_1270, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1015_127c, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_127f, 5); call(0x1007_63a0, -0xd_aee4);           /* call 0x100763a0 */
            ii(0x1015_1284, 5); cmp(memw[ds, eax + 0x8], 0x42);         /* cmp word [eax+0x8], 0x42 */
            ii(0x1015_1289, 2); if(jz(0x1015_129a, 0xf)) goto l_0x1015_129a; /* jz 0x1015129a */
            ii(0x1015_128b, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_128e, 5); call(0x1007_63a0, -0xd_aef3);           /* call 0x100763a0 */
            ii(0x1015_1293, 5); cmp(memw[ds, eax + 0x8], 0x47);         /* cmp word [eax+0x8], 0x47 */
            ii(0x1015_1298, 2); if(jnz(0x1015_129c, 0x2)) goto l_0x1015_129c; /* jnz 0x1015129c */
        l_0x1015_129a:
            ii(0x1015_129a, 2); jmp(0x1015_12ab, 0xf); goto l_0x1015_12ab; /* jmp 0x101512ab */
        l_0x1015_129c:
            ii(0x1015_129c, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_129f, 5); call(0x1007_63a0, -0xd_af04);           /* call 0x100763a0 */
            ii(0x1015_12a4, 5); cmp(memw[ds, eax + 0x8], 0x41);         /* cmp word [eax+0x8], 0x41 */
            ii(0x1015_12a9, 2); if(jnz(0x1015_12c5, 0x1a)) goto l_0x1015_12c5; /* jnz 0x101512c5 */
        l_0x1015_12ab:
            ii(0x1015_12ab, 3); lea(edx, memd[ss, ebp - 0x14]);         /* lea edx, [ebp-0x14] */
            ii(0x1015_12ae, 3); lea(eax, memd[ss, ebp - 0x20]);         /* lea eax, [ebp-0x20] */
            ii(0x1015_12b1, 5); call(0x1007_5e64, -0xd_b452);           /* call 0x10075e64 */
            ii(0x1015_12b6, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1015_12b8, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
        ...
        l_0x1015_12c7:
            ...
            ii(0x1015_12c9, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
        ...
        l_0x1015_12db:
            ii(0x1015_12db, 7); test(memd[ss, ebp - 0xc], 0x100_0000);  /* test dword [ebp-0xc], 0x1000000 */
            ii(0x1015_12e2, 6); if(jz(0x1015_1387, 0x9f)) goto l_0x1015_1387; /* jz 0x10151387 */
            ii(0x1015_12e8, 7); test(memd[ss, ebp - 0xc], 0x10);        /* test dword [ebp-0xc], 0x10 */
            ii(0x1015_12ef, 2); if(jz(0x1015_12fa, 0x9)) goto l_0x1015_12fa; /* jz 0x101512fa */
            ii(0x1015_12f1, 7); mov(memd[ss, ebp - 0x24], 0x11);        /* mov dword [ebp-0x24], 0x11 */
            ii(0x1015_12f8, 2); jmp(0x1015_1301, 0x7); goto l_0x1015_1301; /* jmp 0x10151301 */
        l_0x1015_12fa:
            ii(0x1015_12fa, 7); mov(memd[ss, ebp - 0x24], 0x12);        /* mov dword [ebp-0x24], 0x12 */
        l_0x1015_1301:
            ii(0x1015_1301, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x1015_1304, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ...
            ii(0x1015_131d, 4); movsx(eax, memw[ss, ebp - 0x28]);       /* movsx eax, word [ebp-0x28] */
            ...
            ii(0x1015_132c, 3); mov(dl, memb[ds, eax + 0x1]);           /* mov dl, [eax+0x1] */
            ...
            ii(0x1015_133c, 4); movsx(eax, memw[ss, ebp - 0x12]);       /* movsx eax, word [ebp-0x12] */
            ii(0x1015_1340, 1); push(eax);                              /* push eax */
            ii(0x1015_1341, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1015_1345, 1); push(eax);                              /* push eax */
            ii(0x1015_1346, 2); xor(ecx, ecx);                          /* xor ecx, ecx */
            ii(0x1015_1348, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1015_134b, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1015_134d, 3); mov(al, memb[ds, edx + 0x26]);          /* mov al, [edx+0x26] */
            ii(0x1015_1350, 3); movsx(ebx, ax);                         /* movsx ebx, ax */
            ii(0x1015_1353, 4); movsx(edx, memw[ss, ebp - 0x28]);       /* movsx edx, word [ebp-0x28] */
            ii(0x1015_1357, 3); lea(eax, memd[ss, ebp - 0x2c]);         /* lea eax, [ebp-0x2c] */
            ii(0x1015_135a, 5); call(0x1015_a2da, 0x8f7b);              /* call 0x1015a2da */
            ii(0x1015_135f, 3); lea(eax, memd[ss, ebp - 0x2c]);         /* lea eax, [ebp-0x2c] */
            ii(0x1015_1362, 5); call(0x1007_6574, -0xd_adf3);           /* call 0x10076574 */
            ii(0x1015_1367, 4); mov(memb[ds, eax + 0x2d], 0x4);         /* mov byte [eax+0x2d], 0x4 */
            ii(0x1015_136b, 5); mov(edx, 0x20);                         /* mov edx, 0x20 */
            ii(0x1015_1370, 3); lea(eax, memd[ss, ebp - 0x2c]);         /* lea eax, [ebp-0x2c] */
            ...
            ii(0x1015_137f, 3); lea(eax, memd[ss, ebp - 0x2c]);         /* lea eax, [ebp-0x2c] */
            ii(0x1015_1382, 5); call(0x1007_5f2c, -0xd_b45b);           /* call 0x10075f2c */
        l_0x1015_1387:
            ii(0x1015_1387, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_1389, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
