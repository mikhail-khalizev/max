...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_07ed()
        {
            ...
            ii(0x1007_0802, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_0805, 3); mov(memd[ss, ebp - 0x10], edx);         /* mov [ebp-0x10], edx */
            ii(0x1007_0808, 3); mov(memd[ss, ebp - 0xc], ebx);          /* mov [ebp-0xc], ebx */
            ii(0x1007_080b, 3); mov(memd[ss, ebp - 0x8], ecx);          /* mov [ebp-0x8], ecx */
            ii(0x1007_080e, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1007_0810, 3); mov(edx, memd[ss, ebp - 0x10]);         /* mov edx, [ebp-0x10] */
            ii(0x1007_0813, 3); mov(al, memb[ds, edx + 0x26]);          /* mov al, [edx+0x26] */
            ii(0x1007_0816, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1007_0819, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1007_081c, 5); call(0x1007_623c, 0x5a1b);              /* call 0x1007623c */
            ii(0x1007_0821, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ii(0x1007_0824, 3); mov(eax, memd[ss, ebp + 0x18]);         /* mov eax, [ebp+0x18] */
            ii(0x1007_0827, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1007_082a, 2); jmp(0x1007_0880, 0x54); goto l_0x1007_0880; /* jmp 0x10070880 */
        l_0x1007_082c:
            ii(0x1007_082c, 7); mov(memd[ss, ebp - 0x18], 0x1);         /* mov dword [ebp-0x18], 0x1 */
            ii(0x1007_0833, 7); mov(memd[ss, ebp - 0x20], 0);           /* mov dword [ebp-0x20], 0x0 */
            ii(0x1007_083a, 2); jmp(0x1007_089d, 0x61); goto l_0x1007_089d; /* jmp 0x1007089d */
        l_0x1007_083c:
            ii(0x1007_083c, 7); mov(memd[ss, ebp - 0x18], 0);           /* mov dword [ebp-0x18], 0x0 */
            ii(0x1007_0843, 7); mov(memd[ss, ebp - 0x20], 0x1);         /* mov dword [ebp-0x20], 0x1 */
            ii(0x1007_084a, 2); jmp(0x1007_089d, 0x51); goto l_0x1007_089d; /* jmp 0x1007089d */
        l_0x1007_084c:
            ii(0x1007_084c, 7); mov(memd[ss, ebp - 0x18], 0xffff_ffff); /* mov dword [ebp-0x18], 0xffffffff */
            ii(0x1007_0853, 7); mov(memd[ss, ebp - 0x20], 0);           /* mov dword [ebp-0x20], 0x0 */
            ii(0x1007_085a, 2); jmp(0x1007_089d, 0x41); goto l_0x1007_089d; /* jmp 0x1007089d */
        l_0x1007_085c:
            ii(0x1007_085c, 7); mov(memd[ss, ebp - 0x18], 0);           /* mov dword [ebp-0x18], 0x0 */
            ii(0x1007_0863, 7); mov(memd[ss, ebp - 0x20], 0xffff_ffff); /* mov dword [ebp-0x20], 0xffffffff */
        ...
        l_0x1007_0880:
            ii(0x1007_0880, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1007_0883, 3); mov(memd[ss, ebp - 0x2c], eax);         /* mov [ebp-0x2c], eax */
            ii(0x1007_0886, 5); cmp(memw[ss, ebp - 0x2c], 0x3);         /* cmp word [ebp-0x2c], 0x3 */
            ii(0x1007_088b, 2); if(ja(0x1007_086c, -0x21)) goto l_0x1007_086c; /* ja 0x1007086c */
            ii(0x1007_088d, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1007_088f, 4); mov(ax, memw[ss, ebp - 0x2c]);          /* mov ax, [ebp-0x2c] */
            ...
            } /* jmp dword [cs:eax+0x10070870] */
        l_0x1007_089d:
            ii(0x1007_089d, 7); mov(memd[ss, ebp - 0x24], 0);           /* mov dword [ebp-0x24], 0x0 */
            ii(0x1007_08a4, 2); jmp(0x1007_08ac, 0x6); goto l_0x1007_08ac; /* jmp 0x100708ac */
        l_0x1007_08a6:
            ii(0x1007_08a6, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x1007_08a9, 3); inc(memd[ss, ebp - 0x24]);              /* inc dword [ebp-0x24] */
        l_0x1007_08ac:
            ii(0x1007_08ac, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x1007_08af, 4); cmp(ax, memw[ss, ebp + 0x10]);          /* cmp ax, [ebp+0x10] */
            ii(0x1007_08b3, 6); if(jge(0x1007_09b2, 0xf9)) goto l_0x1007_09b2; /* jge 0x100709b2 */
            ii(0x1007_08b9, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
        ...
        l_0x1007_08ff:
            ...
            ii(0x1007_0905, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_0908, 3); movsx(ecx, memw[ds, eax]);              /* movsx ecx, word [eax] */
            ii(0x1007_090b, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1007_090e, 3); movsx(ebx, memw[ds, eax]);              /* movsx ebx, word [eax] */
            ii(0x1007_0911, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1007_0914, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ii(0x1007_0917, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1007_0919, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1007_091c, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1007_092a, 7); mov(memd[ss, ebp - 0x34], 0x1);         /* mov dword [ebp-0x34], 0x1 */
        ...
        l_0x1007_0938:
            ...
            ii(0x1007_0941, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_0944, 3); movsx(ebx, memw[ds, eax]);              /* movsx ebx, word [eax] */
            ii(0x1007_0947, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1007_094a, 3); movsx(edx, memw[ds, eax]);              /* movsx edx, word [eax] */
            ii(0x1007_094d, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x1007_0959, 3); mov(eax, memd[ss, ebp - 0x28]);         /* mov eax, [ebp-0x28] */
            ii(0x1007_095c, 3); mov(ecx, memd[ds, eax + 0x10]);         /* mov ecx, [eax+0x10] */
            ii(0x1007_095f, 3); sar(ecx, 0x10);                         /* sar ecx, 0x10 */
            ii(0x1007_0962, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_0965, 3); movsx(ebx, memw[ds, eax]);              /* movsx ebx, word [eax] */
            ii(0x1007_0968, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1007_096b, 3); movsx(edx, memw[ds, eax]);              /* movsx edx, word [eax] */
            ii(0x1007_096e, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1007_0971, 5); call(0x1007_0d68, 0x3f2);               /* call 0x10070d68 */
            ii(0x1007_0976, 3); mov(memd[ss, ebp - 0x34], eax);         /* mov [ebp-0x34], eax */
        ...
        l_0x1007_097f:
            ii(0x1007_097f, 3); mov(eax, memd[ss, ebp - 0x30]);         /* mov eax, [ebp-0x30] */
            ii(0x1007_0982, 3); mov(memd[ss, ebp - 0x38], eax);         /* mov [ebp-0x38], eax */
            ii(0x1007_0985, 5); cmp(memw[ss, ebp - 0x38], 0);           /* cmp word [ebp-0x38], 0x0 */
            ii(0x1007_098a, 6); if(jbe(0x1007_08ff, -0x91)) goto l_0x1007_08ff; /* jbe 0x100708ff */
            ii(0x1007_0990, 5); cmp(memw[ss, ebp - 0x38], 0x1);         /* cmp word [ebp-0x38], 0x1 */
        ...
        l_0x1007_099b:
            ii(0x1007_099b, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1007_099e, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1007_09a1, 3); add(memw[ds, edx], ax);                 /* add [edx], ax */
            ii(0x1007_09a4, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1007_09a7, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1007_09aa, 3); add(memw[ds, edx], ax);                 /* add [edx], ax */
            ii(0x1007_09ad, 5); jmp(0x1007_08a6, -0x10c); goto l_0x1007_08a6; /* jmp 0x100708a6 */
        l_0x1007_09b2:
            ii(0x1007_09b2, 7); mov(memd[ss, ebp - 0x34], 0);           /* mov dword [ebp-0x34], 0x0 */
        l_0x1007_09b9:
            ii(0x1007_09b9, 3); mov(eax, memd[ss, ebp - 0x34]);         /* mov eax, [ebp-0x34] */
