...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_af35()
        {
            ...
            ii(0x100b_af3a, 5); calld(Definitions.sys_check_available_stack_size, 0xaae13); /* call 0x10165d52 */
            ...
            ii(0x100b_af58, 5); calld(0x1007_6b90, -0x443cd);           /* call 0x10076b90 */
        ...
        l_0x100b_af99:
            ...
            ii(0x100b_afa6, 5); calld(0x100c_b000, 0x10055);            /* call 0x100cb000 */
            ...
            ii(0x100b_afb2, 5); calld(0x1008_a1a4, -0x30e13);           /* call 0x1008a1a4 */
        ...
        l_0x100b_afb9:
            ...
            ii(0x100b_afbc, 5); calld(0x1007_6bf8, -0x443c9);           /* call 0x10076bf8 */
        l_0x100b_afc1:
            ii(0x100b_afc1, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_afc3, 3); lea(eax, ebp - 0x10);                   /* lea eax, [ebp-0x10] */
            ii(0x100b_afc6, 5); calld(0x1013_ad71, 0x7fda6);            /* call 0x1013ad71 */
            ...
            ii(0x100b_afd6, 5); calld(0x1008_a0f8, -0x30ee3);           /* call 0x1008a0f8 */
            ii(0x100b_afdb, 5); calld(0x1008_a370, -0x30c70);           /* call 0x1008a370 */
        ...
        l_0x100b_aff5:
            ...
            ii(0x100b_aff8, 5); calld(0x1008_a370, -0x30c8d);           /* call 0x1008a370 */
        ...
        l_0x100b_b004:
            ...
            ii(0x100b_b00a, 5); calld(0x1008_a0f8, -0x30f17);           /* call 0x1008a0f8 */
            ...
            ii(0x100b_b01c, 5); calld(0x1007_5e64, -0x451bd);           /* call 0x10075e64 */
            ii(0x100b_b021, 2); mov(edx, ebx);                          /* mov edx, ebx */
            ii(0x100b_b023, 5); calld(0x100a_5fca, -0x1505e);           /* call 0x100a5fca */
            ...
            ii(0x100b_b03e, 5); calld(0x1008_a370, -0x30cd3);           /* call 0x1008a370 */
        ...
        l_0x100b_b057:
            ...
            ii(0x100b_b05a, 5); calld(0x1008_a12c, -0x30f33);           /* call 0x1008a12c */
        ...
        l_0x100b_b06d:
            ...
            ii(0x100b_b080, 5); calld(0x1008_8b44, -0x32541);           /* call 0x10088b44 */
            ii(0x100b_b085, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_b087, 3); lea(eax, ebp - 0x10);                   /* lea eax, [ebp-0x10] */
            ii(0x100b_b08a, 5); calld(0x1008_8e4c, -0x32243);           /* call 0x10088e4c */
        l_0x100b_b08f:
