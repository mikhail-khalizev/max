...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_caa6()
        {
            ...
            ii(0x100a_cab8, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x100a_cabe, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_cac1, 4);  mov(memb[ss, ebp - 8], 0x17);         /* mov byte [ebp-0x8], 0x17 */
            ii(0x100a_cac5, 3);  mov(al, memb[ss, ebp - 8]);           /* mov al, [ebp-0x8] */
