...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x8dff, 4);    enter(0x2, 0);                            /* enter 0x2, 0x0 */
            ii(0x8e03, 5);    mov(memw[ss, bp - 0x2], 0x2);             /* mov word [bp-0x2], 0x2 */
        l_0x8e08:
            ...
            ii(0x8e15, 3);    push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x8e18, 3);    push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ii(0x8e1b, 3);    call(0xbd92, 0x2f74);                     /* call 0xbd92 */
            ii(0x8e1e, 1);    pop(bx);                                  /* pop bx */
            ii(0x8e1f, 1);    pop(bx);                                  /* pop bx */
            ii(0x8e20, 3);    cmp(ax, memw[ss, bp + 0x8]);              /* cmp ax, [bp+0x8] */
            ii(0x8e23, 2);    if(jnz(0x8e72, 0x4d)) goto l_0x8e72;      /* jnz 0x8e72 */
            ii(0x8e25, 3);    mov(bx, memw[ss, bp + 0x4]);              /* mov bx, [bp+0x4] */
            ii(0x8e28, 3);    cmp(memb[ds, bx], 0x4d);                  /* cmp byte [bx], 0x4d */
            ii(0x8e2b, 2);    if(jnz(0x8e43, 0x16)) goto l_0x8e43;      /* jnz 0x8e43 */
            ii(0x8e2d, 4);    cmp(memb[ds, bx + 0x1], 0x46);            /* cmp byte [bx+0x1], 0x46 */
            ii(0x8e31, 2);    if(jnz(0x8e43, 0x10)) goto l_0x8e43;      /* jnz 0x8e43 */
            ii(0x8e33, 3);    mov(ax, memw[ds, bx + 0x2]);              /* mov ax, [bx+0x2] */
            ii(0x8e36, 3);    mov(dx, memw[ds, bx + 0x4]);              /* mov dx, [bx+0x4] */
        l_0x8e39:
        ...
        l_0x8e43:
            ...
            ii(0x8e48, 4);    cmp(memb[ds, bx + 0x1], 0x5a);            /* cmp byte [bx+0x1], 0x5a */
            ii(0x8e4c, 2);    if(jnz(0x8e55, 0x7)) goto l_0x8e55;       /* jnz 0x8e55 */
        ...
        l_0x8e55:
            ...
            ii(0x8e5a, 4);    cmp(memb[ds, bx + 0x1], 0x57);            /* cmp byte [bx+0x1], 0x57 */
            ii(0x8e5e, 2);    if(jnz(0x8e65, 0x5)) goto l_0x8e65;       /* jnz 0x8e65 */
        ...
        l_0x8e65:
            ...
            ii(0x8e69, 3);    dec(memw[ss, bp - 0x2]);                  /* dec word [bp-0x2] */
        l_0x8e6c:
            ii(0x8e6c, 4);    cmp(memw[ss, bp - 0x2], 0);               /* cmp word [bp-0x2], 0x0 */
            ii(0x8e70, 2);    if(jge(0x8e08, -0x6a)) goto l_0x8e08;     /* jge 0x8e08 */
        l_0x8e72:
            ii(0x8e72, 4);    cmp(memw[ss, bp + 0x6], 0);               /* cmp word [bp+0x6], 0x0 */
            ii(0x8e76, 2);    if(jz(0x8e7e, 0x6)) goto l_0x8e7e;        /* jz 0x8e7e */
            ii(0x8e78, 2);    push(-0x2 /* 0xfe */);                    /* push 0xfffe */
