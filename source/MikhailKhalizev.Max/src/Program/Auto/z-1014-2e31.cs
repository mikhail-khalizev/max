...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_2e31()
        {
            ...
            ii(0x1014_2e46, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1014_2e49, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x1014_2e4c, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1014_2e4f, 3); mov(memd[ss, ebp - 0x8], ecx);          /* mov [ebp-0x8], ecx */
            ii(0x1014_2e52, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1014_2e56, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1014_2e58, 2); if(jle(0x1014_2e8f, 0x35)) goto l_0x1014_2e8f; /* jle 0x10142e8f */
            ii(0x1014_2e5a, 4); movsx(eax, memw[ss, ebp + 0x10]);       /* movsx eax, word [ebp+0x10] */
            ii(0x1014_2e5e, 5); call(Definitions.my_get_res_data_by_id, -0xee8b); /* call 0x10133fd8 */
            ii(0x1014_2e63, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1014_2e66, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1014_2e6a, 1); push(eax);                              /* push eax */
            ii(0x1014_2e6b, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1014_2e6e, 1); push(eax);                              /* push eax */
            ii(0x1014_2e6f, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1014_2e72, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x1014_2e75, 1); push(eax);                              /* push eax */
            ii(0x1014_2e76, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1014_2e7a, 1); push(eax);                              /* push eax */
            ii(0x1014_2e7b, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1014_2e7f, 1); push(eax);                              /* push eax */
            ii(0x1014_2e80, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
        ...
        l_0x1014_2e8f:
            ...
            ii(0x1014_2e94, 3); ret(0x4);                               /* ret 0x4 */
        }
    }
}
