...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0001_1c5e()
        {
            ...
            ii(0x1_1c61, 4);  mov(si, memw[ss, bx + 0x2]);              /* mov si, [ss:bx+0x2] */
            ...
            ii(0x1_1c6d, 4);  mov(bp, memw[ss, bx + 0x4]);              /* mov bp, [ss:bx+0x4] */
            ii(0x1_1c71, 5);  cmp(memb[ds, 0x2e], 0);                   /* cmp byte [0x2e], 0x0 */
            ii(0x1_1c76, 2);  if(jz(0x1_1ca0, 0x28)) goto l_0x1_1ca0;   /* jz 0x1ca0 */
            ii(0x1_1c78, 2);  push(0x8);                                /* push 0x8 */
            ii(0x1_1c7a, 1);  pop(ds);                                  /* pop ds */
            ii(0x1_1c7b, 3);  and(si, -0x8 /* 0xf8 */);                 /* and si, 0xfff8 */
        l_0x1_1c7e:
            ii(0x1_1c7e, 1);  lodsw();                                  /* lodsw */
            ii(0x1_1c7f, 3);  mov(memw[ss, bp + 0x4], ax);              /* mov [bp+0x4], ax */
            ii(0x1_1c82, 1);  lodsw();                                  /* lodsw */
            ii(0x1_1c83, 3);  mov(memw[ss, bp + 0], ax);                /* mov [bp], ax */
            ii(0x1_1c86, 1);  lodsw();                                  /* lodsw */
            ii(0x1_1c87, 3);  mov(memb[ss, bp + 0x2], al);              /* mov [bp+0x2], al */
            ii(0x1_1c8a, 3);  mov(memb[ss, bp + 0x8], ah);              /* mov [bp+0x8], ah */
            ii(0x1_1c8d, 1);  lodsw();                                  /* lodsw */
            ii(0x1_1c8e, 2);  and(al, 0xf0);                            /* and al, 0xf0 */
            ii(0x1_1c90, 3);  mov(memb[ss, bp + 0x9], al);              /* mov [bp+0x9], al */
            ii(0x1_1c93, 3);  mov(memb[ss, bp + 0x3], ah);              /* mov [bp+0x3], ah */
            ii(0x1_1c96, 5);  mov(memw[ss, bp + 0x6], 0);               /* mov word [bp+0x6], 0x0 */
        ...
        l_0x1_1ca0:
            ...
            ii(0x1_1cac, 4);  mov(bx, memw[ss, bx + 0x2]);              /* mov bx, [ss:bx+0x2] */
