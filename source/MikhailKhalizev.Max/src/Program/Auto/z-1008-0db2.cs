...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_0db2()
        {
            ...
            ii(0x1008_0dd2, 3);  mov(al, memb[ds, eax + 78]);          /* mov al, [eax+0x4e] */
        ...
        l_0x1008_0ded:
            ii(0x1008_0ded, 4);  mov(memb[ss, ebp - 12], 0);           /* mov byte [ebp-0xc], 0x0 */
        ...
        l_0x1008_0df6:
            ...
            ii(0x1008_0e0a, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
        ...
        l_0x1008_0e13:
            ...
            ii(0x1008_0e16, 3);  mov(eax, memd[ds, eax + 80]);         /* mov eax, [eax+0x50] */
            ...
            ii(0x1008_0e2a, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1008_0e2d, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1008_0e30, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1008_0e33, 4);  cmp(memd[ss, ebp - 24], 0);           /* cmp dword [ebp-0x18], 0x0 */
            ...
            ii(0x1008_0e41, 3);  mov(ecx, memd[ds, eax + 23]);         /* mov ecx, [eax+0x17] */
            ...
            ii(0x1008_0e4d, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1008_0e50, 5);  call(0x1008_bd0b, 0xaeb6);            /* call 0x1008bd0b */
            ii(0x1008_0e55, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1008_0e58, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x1008_0e5b, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x1008_0e5e, 2);  jmp(0x1008_0e66, 6); goto l_0x1008_0e66;/* jmp 0x10080e66 */
        l_0x1008_0e60:
            ii(0x1008_0e60, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x1008_0e63, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
        l_0x1008_0e66:
            ii(0x1008_0e66, 3);  mov(edx, memd[ss, ebp - 32]);         /* mov edx, [ebp-0x20] */
            ii(0x1008_0e69, 5);  mov(eax, 0x101c_3180);                /* mov eax, 0x101c3180 */
            ii(0x1008_0e6e, 5);  call(0x100a_4d50, 0x2_3edd);          /* call 0x100a4d50 */
            ii(0x1008_0e73, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
        ...
        l_0x1008_0e7c:
            ...
            ii(0x1008_0e97, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1008_0e9a, 4);  cmp(memd[ss, ebp - 16], 0);           /* cmp dword [ebp-0x10], 0x0 */
        ...
        l_0x1008_0ee7:
            ...
            ii(0x1008_0efc, 3);  mov(edx, memd[ds, eax + 24]);         /* mov edx, [eax+0x18] */
            ii(0x1008_0eff, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x1008_0f02, 3);  shl(edx, 2);                          /* shl edx, 0x2 */
            ii(0x1008_0f05, 3);  add(edx, memd[ss, ebp - 16]);         /* add edx, [ebp-0x10] */
            ii(0x1008_0f08, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_0f0b, 3);  mov(eax, memd[ds, eax + 26]);         /* mov eax, [eax+0x1a] */
        ...
        l_0x1008_0f18:
            ii(0x1008_0f18, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
        ...
        l_0x1008_0f21:
            ...
            ii(0x1008_0f3f, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
            ii(0x1008_0f43, 5);  jmp(0x1008_10d8, 0x190); goto l_0x1008_10d8;/* jmp 0x100810d8 */
        l_0x1008_0f48:
            ii(0x1008_0f48, 3);  lea(eax, memd[ss, ebp - 40]);         /* lea eax, [ebp-0x28] */
            ii(0x1008_0f4b, 5);  call(Definitions.my_ctor_0x101b_4184, -0xa460);/* call 0x10076af0 */
            ii(0x1008_0f50, 4);  mov(memb[ss, ebp - 36], 0);           /* mov byte [ebp-0x24], 0x0 */
            ...
            ii(0x1008_0f5e, 7);  mov(memd[ss, ebp - 44], 1);           /* mov dword [ebp-0x2c], 0x1 */
            ii(0x1008_0f65, 2);  jmp(0x1008_0f6e, 7); goto l_0x1008_0f6e;/* jmp 0x10080f6e */
        l_0x1008_0f67:
            ii(0x1008_0f67, 7);  mov(memd[ss, ebp - 44], 2);           /* mov dword [ebp-0x2c], 0x2 */
        l_0x1008_0f6e:
            ii(0x1008_0f6e, 7);  mov(memd[ss, ebp - 48], 0);           /* mov dword [ebp-0x30], 0x0 */
            ii(0x1008_0f75, 2);  jmp(0x1008_0f7d, 6); goto l_0x1008_0f7d;/* jmp 0x10080f7d */
        l_0x1008_0f77:
            ii(0x1008_0f77, 3);  mov(eax, memd[ss, ebp - 48]);         /* mov eax, [ebp-0x30] */
            ii(0x1008_0f7a, 3);  inc(memd[ss, ebp - 48]);              /* inc dword [ebp-0x30] */
        l_0x1008_0f7d:
            ii(0x1008_0f7d, 3);  mov(eax, memd[ss, ebp - 48]);         /* mov eax, [ebp-0x30] */
            ...
            ii(0x1008_0f8d, 7);  mov(memd[ss, ebp - 52], 0);           /* mov dword [ebp-0x34], 0x0 */
            ii(0x1008_0f94, 2);  jmp(0x1008_0f9c, 6); goto l_0x1008_0f9c;/* jmp 0x10080f9c */
        l_0x1008_0f96:
            ii(0x1008_0f96, 3);  mov(eax, memd[ss, ebp - 52]);         /* mov eax, [ebp-0x34] */
            ii(0x1008_0f99, 3);  inc(memd[ss, ebp - 52]);              /* inc dword [ebp-0x34] */
        l_0x1008_0f9c:
            ii(0x1008_0f9c, 3);  mov(eax, memd[ss, ebp - 52]);         /* mov eax, [ebp-0x34] */
            ...
            ii(0x1008_0fac, 4);  movsx(eax, memw[ss, ebp - 48]);       /* movsx eax, word [ebp-0x30] */
            ii(0x1008_0fb0, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x1008_0fb3, 3);  add(eax, memd[ss, ebp - 16]);         /* add eax, [ebp-0x10] */
            ii(0x1008_0fb6, 4);  movsx(edx, memw[ss, ebp - 52]);       /* movsx edx, word [ebp-0x34] */
            ...
            ii(0x1008_0fc3, 4);  movsx(eax, memw[ss, ebp - 48]);       /* movsx eax, word [ebp-0x30] */
            ii(0x1008_0fc7, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x1008_0fca, 3);  add(eax, memd[ss, ebp - 16]);         /* add eax, [ebp-0x10] */
            ii(0x1008_0fcd, 4);  movsx(edx, memw[ss, ebp - 52]);       /* movsx edx, word [ebp-0x34] */
        ...
        l_0x1008_0fdc:
            ii(0x1008_0fdc, 4);  movsx(edx, memw[ss, ebp - 52]);       /* movsx edx, word [ebp-0x34] */
            ii(0x1008_0fe0, 4);  movsx(eax, memw[ss, ebp - 48]);       /* movsx eax, word [ebp-0x30] */
            ...
            ii(0x1008_0fee, 4);  movsx(eax, memw[ss, ebp - 44]);       /* movsx eax, word [ebp-0x2c] */
        ...
        l_0x1008_0ff8:
            ...
            ii(0x1008_0ffb, 4);  mov(ax, memw[ds, eax + 28]);          /* mov ax, [eax+0x1c] */
            ii(0x1008_0fff, 3);  sub(eax, memd[ss, ebp - 52]);         /* sub eax, [ebp-0x34] */
            ii(0x1008_1002, 3);  movsx(edx, ax);                       /* movsx edx, ax */
            ii(0x1008_1005, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_1008, 4);  mov(ax, memw[ds, eax + 26]);          /* mov ax, [eax+0x1a] */
            ii(0x1008_100c, 3);  sub(eax, memd[ss, ebp - 48]);         /* sub eax, [ebp-0x30] */
            ii(0x1008_100f, 1);  cwde();                               /* cwde */
            ii(0x1008_1010, 5);  call(0x100a_5f65, 0x2_4f50);          /* call 0x100a5f65 */
            ii(0x1008_1015, 3);  mov(memd[ss, ebp - 56], eax);         /* mov [ebp-0x38], eax */
            ii(0x1008_1018, 4);  cmp(memb[ss, ebp - 36], 0);           /* cmp byte [ebp-0x24], 0x0 */
            ii(0x1008_101c, 2);  if(jz(0x1008_1027, 9)) goto l_0x1008_1027;/* jz 0x10081027 */
            ii(0x1008_101e, 3);  mov(eax, memd[ss, ebp - 56]);         /* mov eax, [ebp-0x38] */
            ii(0x1008_1021, 4);  cmp(ax, memw[ss, ebp - 60]);          /* cmp ax, [ebp-0x3c] */
            ii(0x1008_1025, 2);  if(jge(0x1008_103f, 0x18)) goto l_0x1008_103f;/* jge 0x1008103f */
        l_0x1008_1027:
            ii(0x1008_1027, 3);  mov(eax, memd[ss, ebp - 48]);         /* mov eax, [ebp-0x30] */
            ii(0x1008_102a, 4);  mov(memw[ss, ebp - 40], ax);          /* mov [ebp-0x28], ax */
            ii(0x1008_102e, 3);  mov(eax, memd[ss, ebp - 52]);         /* mov eax, [ebp-0x34] */
            ii(0x1008_1031, 4);  mov(memw[ss, ebp - 38], ax);          /* mov [ebp-0x26], ax */
            ii(0x1008_1035, 4);  mov(memb[ss, ebp - 36], 1);           /* mov byte [ebp-0x24], 0x1 */
            ii(0x1008_1039, 3);  mov(eax, memd[ss, ebp - 56]);         /* mov eax, [ebp-0x38] */
            ii(0x1008_103c, 3);  mov(memd[ss, ebp - 60], eax);         /* mov [ebp-0x3c], eax */
        l_0x1008_103f:
        ...
        l_0x1008_1049:
            ii(0x1008_1049, 4);  cmp(memb[ss, ebp - 36], 0);           /* cmp byte [ebp-0x24], 0x0 */
            ...
            ii(0x1008_105d, 3);  mov(memd[ss, ebp - 64], eax);         /* mov [ebp-0x40], eax */
            ii(0x1008_1060, 3);  mov(eax, memd[ss, ebp - 64]);         /* mov eax, [ebp-0x40] */
            ii(0x1008_1063, 3);  mov(memd[ss, ebp - 68], eax);         /* mov [ebp-0x44], eax */
            ii(0x1008_1066, 4);  cmp(memd[ss, ebp - 68], 0);           /* cmp dword [ebp-0x44], 0x0 */
            ...
            ii(0x1008_1072, 3);  lea(edx, memd[ss, ebp - 40]);         /* lea edx, [ebp-0x28] */
            ii(0x1008_1075, 3);  lea(eax, memd[ss, ebp - 72]);         /* lea eax, [ebp-0x48] */
            ...
            ii(0x1008_108c, 3);  mov(eax, memd[ss, ebp - 64]);         /* mov eax, [ebp-0x40] */
            ii(0x1008_108f, 5);  call(0x100a_c220, 0x2_b18c);          /* call 0x100ac220 */
            ii(0x1008_1094, 3);  mov(memd[ss, ebp - 76], eax);         /* mov [ebp-0x4c], eax */
            ii(0x1008_1097, 3);  mov(eax, memd[ss, ebp - 76]);         /* mov eax, [ebp-0x4c] */
            ii(0x1008_109a, 3);  mov(memd[ss, ebp - 80], eax);         /* mov [ebp-0x50], eax */
            ii(0x1008_109d, 2);  jmp(0x1008_10a5, 6); goto l_0x1008_10a5;/* jmp 0x100810a5 */
        l_0x1008_109f:
            ii(0x1008_109f, 3);  mov(eax, memd[ss, ebp - 68]);         /* mov eax, [ebp-0x44] */
            ii(0x1008_10a2, 3);  mov(memd[ss, ebp - 80], eax);         /* mov [ebp-0x50], eax */
        l_0x1008_10a5:
            ii(0x1008_10a5, 3);  mov(edx, memd[ss, ebp - 80]);         /* mov edx, [ebp-0x50] */
            ii(0x1008_10a8, 3);  lea(eax, memd[ss, ebp - 84]);         /* lea eax, [ebp-0x54] */
            ii(0x1008_10ab, 5);  call(0x1008_b060, 0x9fb0);            /* call 0x1008b060 */
            ii(0x1008_10b0, 3);  lea(eax, memd[ss, ebp - 84]);         /* lea eax, [ebp-0x54] */
            ...
            ii(0x1008_10c4, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
            ii(0x1008_10c8, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_10ca, 3);  lea(eax, memd[ss, ebp - 84]);         /* lea eax, [ebp-0x54] */
        ...
        l_0x1008_10d4:
            ii(0x1008_10d4, 4);  mov(memb[ss, ebp - 12], 0);           /* mov byte [ebp-0xc], 0x0 */
        l_0x1008_10d8:
            ii(0x1008_10d8, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
