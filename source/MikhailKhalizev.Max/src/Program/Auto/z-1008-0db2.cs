...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_0db2()
        {
            ...
            ii(0x1008_0dc9, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_0dcc, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1008_0dcf, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_0dde, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1008_0de1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_0de4, 5); call(0x1015_2a52, 0xd_1c69);            /* call 0x10152a52 */
            ii(0x1008_0de9, 2); test(al, al);                           /* test al, al */
            ii(0x1008_0deb, 2); if(jnz(0x1008_0df6, 0x9)) goto l_0x1008_0df6; /* jnz 0x10080df6 */
        l_0x1008_0ded:
        ...
        l_0x1008_0df6:
            ...
            ii(0x1008_0dfb, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_0dfe, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_0e01, 5); call(0x100a_3671, 0x2_286b);            /* call 0x100a3671 */
            ii(0x1008_0e06, 2); test(al, al);                           /* test al, al */
            ii(0x1008_0e08, 2); if(jz(0x1008_0e13, 0x9)) goto l_0x1008_0e13; /* jz 0x10080e13 */
            ii(0x1008_0e0a, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1008_0e0e, 5); jmp(0x1008_10d8, 0x2c5); goto l_0x1008_10d8; /* jmp 0x100810d8 */
        l_0x1008_0e13:
            ii(0x1008_0e13, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_0e39, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_0e47, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ii(0x1008_0e4a, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x1008_0e5e, 2); jmp(0x1008_0e66, 0x6); goto l_0x1008_0e66; /* jmp 0x10080e66 */
        l_0x1008_0e60:
        ...
        l_0x1008_0e66:
            ...
            ii(0x1008_0e73, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1008_0e77, 5); jmp(0x1008_10d8, 0x25c); goto l_0x1008_10d8; /* jmp 0x100810d8 */
        l_0x1008_0e7c:
            ii(0x1008_0e7c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_0e7f, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1008_0ea4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_0eb5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_0ec2, 3); test(memb[ds, eax], 0x2);               /* test byte [eax], 0x2 */
            ...
            ii(0x1008_0ed2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_0ed5, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
        ...
        l_0x1008_0ee7:
            ...
            ii(0x1008_0ef1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_0ef4, 5); call(0x1016_3053, 0xe_215a);            /* call 0x10163053 */
            ii(0x1008_0ef9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_0f08, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_0f15, 3); and(memb[ds, eax], -0x3 /* 0xfd */);    /* and byte [eax], 0xfd */
        l_0x1008_0f18:
            ii(0x1008_0f18, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1008_0f1c, 5); jmp(0x1008_10d8, 0x1b7); goto l_0x1008_10d8; /* jmp 0x100810d8 */
        l_0x1008_0f21:
            ii(0x1008_0f21, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_0f37, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_0f3a, 5); call(0x1016_3053, 0xe_2114);            /* call 0x10163053 */
            ii(0x1008_0f3f, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
        ...
        l_0x1008_0f48:
            ...
            ii(0x1008_0f54, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_0f57, 5); cmp(memw[ds, eax + 0x8], 0x38);         /* cmp word [eax+0x8], 0x38 */
            ii(0x1008_0f5c, 2); if(jnz(0x1008_0f67, 0x9)) goto l_0x1008_0f67; /* jnz 0x10080f67 */
            ii(0x1008_0f5e, 7); mov(memd[ss, ebp - 0x2c], 0x1);         /* mov dword [ebp-0x2c], 0x1 */
            ii(0x1008_0f65, 2); jmp(0x1008_0f6e, 0x7); goto l_0x1008_0f6e; /* jmp 0x10080f6e */
        l_0x1008_0f67:
            ii(0x1008_0f67, 7); mov(memd[ss, ebp - 0x2c], 0x2);         /* mov dword [ebp-0x2c], 0x2 */
        l_0x1008_0f6e:
            ii(0x1008_0f6e, 7); mov(memd[ss, ebp - 0x30], 0);           /* mov dword [ebp-0x30], 0x0 */
            ii(0x1008_0f75, 2); jmp(0x1008_0f7d, 0x6); goto l_0x1008_0f7d; /* jmp 0x10080f7d */
        l_0x1008_0f77:
        ...
        l_0x1008_0f7d:
            ...
            ii(0x1008_0f94, 2); jmp(0x1008_0f9c, 0x6); goto l_0x1008_0f9c; /* jmp 0x10080f9c */
        l_0x1008_0f96:
        ...
        l_0x1008_0f9c:
            ...
            ii(0x1008_0fbe, 3); test(memb[ds, eax], 0x2);               /* test byte [eax], 0x2 */
            ...
            ii(0x1008_0fd5, 3); test(memb[ds, eax], 0x8);               /* test byte [eax], 0x8 */
            ii(0x1008_0fd8, 2); if(jz(0x1008_0fdc, 0x2)) goto l_0x1008_0fdc; /* jz 0x10080fdc */
        l_0x1008_0fda:
        ...
        l_0x1008_0fdc:
            ...
            ii(0x1008_0ff4, 2); if(jz(0x1008_0ff8, 0x2)) goto l_0x1008_0ff8; /* jz 0x10080ff8 */
        l_0x1008_0ff6:
            ii(0x1008_0ff6, 2); jmp(0x1008_103f, 0x47); goto l_0x1008_103f; /* jmp 0x1008103f */
        l_0x1008_0ff8:
            ii(0x1008_0ff8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_1005, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_101c, 2); if(jz(0x1008_1027, 0x9)) goto l_0x1008_1027; /* jz 0x10081027 */
        ...
        l_0x1008_1027:
            ...
            ii(0x1008_1035, 4); mov(memb[ss, ebp - 0x24], 0x1);         /* mov byte [ebp-0x24], 0x1 */
        ...
        l_0x1008_1049:
            ...
            ii(0x1008_1086, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ii(0x1008_1089, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1008_109d, 2); jmp(0x1008_10a5, 0x6); goto l_0x1008_10a5; /* jmp 0x100810a5 */
        l_0x1008_109f:
        ...
        l_0x1008_10a5:
            ...
            ii(0x1008_10c4, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ...
            ii(0x1008_10d2, 2); jmp(0x1008_10d8, 0x4); goto l_0x1008_10d8; /* jmp 0x100810d8 */
        l_0x1008_10d4:
