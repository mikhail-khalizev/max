...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1018_1046:
            ...
            ii(0x1018_1048, 2); if(jz(0x1018_1053, 0x9)) goto l_0x1018_1053; /* jz 0x10181053 */
        ...
        l_0x1018_1053:
            ...
            ii(0x1018_1065, 2); if(jz(0x1018_1070, 0x9)) goto l_0x1018_1070; /* jz 0x10181070 */
            ii(0x1018_1067, 3); mov(memb[ds, eax + 0x1], dh);           /* mov [eax+0x1], dh */
            ii(0x1018_106a, 1); dec(ecx);                               /* dec ecx */
            ii(0x1018_106b, 2); if(jz(0x1018_1070, 0x3)) goto l_0x1018_1070; /* jz 0x10181070 */
            ii(0x1018_106d, 3); mov(memb[ds, eax + 0x2], dl);           /* mov [eax+0x2], dl */
        l_0x1018_1070:
