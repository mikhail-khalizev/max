...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x8614, 1);    pushw(ax);                                /* push ax */
            ii(0x8615, 1);    pushw(bx);                                /* push bx */
            ii(0x8616, 4);    mov(bx, memw_a16[ds, 0x9b4]);             /* mov bx, [0x9b4] */
            ii(0x861a, 1);    cli();                                    /* cli */
        ...
        l_0x865a:
            ...
            ii(0x8666, 5);    jmpw_far_abs(0x5db, 0x28bb);              /* jmp word 0x5db:0x28bb */
        }
    }
}
