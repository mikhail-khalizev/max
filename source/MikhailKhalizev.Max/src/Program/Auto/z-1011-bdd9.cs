...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_bdd9()
        {
            ...
            ii(0x1011_bdee, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1011_bdf1, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x1011_bdf4, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1011_bdf7, 3); mov(memd[ss, ebp - 0x4], ecx);          /* mov [ebp-0x4], ecx */
            ii(0x1011_bdfa, 5); mov(eax, 0x26);                         /* mov eax, 0x26 */
            ii(0x1011_bdff, 5); call(0x100e_883d, -0x3_35c7);           /* call 0x100e883d */
            ii(0x1011_be04, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1011_be07, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1011_be0a, 3); shl(eax, 0x6);                          /* shl eax, 0x6 */
            ii(0x1011_be0d, 5); add(eax, 0x20);                         /* add eax, 0x20 */
            ii(0x1011_be12, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1011_be15, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_be18, 3); shl(eax, 0x6);                          /* shl eax, 0x6 */
            ii(0x1011_be1b, 5); add(eax, 0x20);                         /* add eax, 0x20 */
            ii(0x1011_be20, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_be23, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1011_be2f, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1011_be33, 6); cmp(eax, memd[ds, 0x101c_38ec]);        /* cmp eax, [0x101c38ec] */
            ii(0x1011_be39, 2); if(jg(0x1011_be3d, 0x2)) goto l_0x1011_be3d; /* jg 0x1011be3d */
        l_0x1011_be3b:
            ii(0x1011_be3b, 2); jmp(0x1011_be49, 0xc); goto l_0x1011_be49; /* jmp 0x1011be49 */
        l_0x1011_be3d:
            ii(0x1011_be3d, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1011_be41, 6); cmp(eax, memd[ds, 0x101c_38f8]);        /* cmp eax, [0x101c38f8] */
            ii(0x1011_be47, 2); if(jl(0x1011_be4b, 0x2)) goto l_0x1011_be4b; /* jl 0x1011be4b */
        l_0x1011_be49:
            ii(0x1011_be49, 2); jmp(0x1011_be57, 0xc); goto l_0x1011_be57; /* jmp 0x1011be57 */
        l_0x1011_be4b:
            ii(0x1011_be4b, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1011_be4f, 6); cmp(eax, memd[ds, 0x101c_38f0]);        /* cmp eax, [0x101c38f0] */
            ii(0x1011_be55, 2); if(jg(0x1011_be5c, 0x5)) goto l_0x1011_be5c; /* jg 0x1011be5c */
        l_0x1011_be57:
            ii(0x1011_be57, 5); jmp(0x1011_bf0a, 0xae); goto l_0x1011_bf0a; /* jmp 0x1011bf0a */
        l_0x1011_be5c:
            ii(0x1011_be5c, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x1011_be79, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1011_be7c, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x1011_be99, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1011_be9c, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1011_bea0, 1); push(eax);                              /* push eax */
            ii(0x1011_bea1, 4); movsx(ecx, memw[ss, ebp - 0x1c]);       /* movsx ecx, word [ebp-0x1c] */
            ii(0x1011_bea5, 4); movsx(ebx, memw[ss, ebp - 0x18]);       /* movsx ebx, word [ebp-0x18] */
            ii(0x1011_bea9, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x1011_bead, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ...
            ii(0x1011_bebc, 4); movsx(edx, memw[ss, ebp - 0x18]);       /* movsx edx, word [ebp-0x18] */
            ii(0x1011_bec0, 2); sub(edx, eax);                          /* sub edx, eax */
            ii(0x1011_bec2, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1011_bec5, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1011_bec7, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1011_bec9, 3); mov(memd[ss, ebp - 0x2c], eax);         /* mov [ebp-0x2c], eax */
            ii(0x1011_becc, 5); mov(eax, memd[ds, 0x101c_38c0]);        /* mov eax, [0x101c38c0] */
            ii(0x1011_bed1, 2); sar(eax, 0x1);                          /* sar eax, 1 */
            ii(0x1011_bed3, 4); movsx(edx, memw[ss, ebp - 0x1c]);       /* movsx edx, word [ebp-0x1c] */
            ii(0x1011_bed7, 2); sub(edx, eax);                          /* sub edx, eax */
            ii(0x1011_bed9, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1011_bedc, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
            ii(0x1011_bedf, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1011_bee1, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ii(0x1011_bee4, 3); mov(eax, memd[ss, ebp - 0x2c]);         /* mov eax, [ebp-0x2c] */
            ii(0x1011_bee7, 6); add(eax, memd[ds, 0x101c_38c0]);        /* add eax, [0x101c38c0] */
            ii(0x1011_beed, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x1011_bef0, 3); mov(eax, memd[ss, ebp - 0x28]);         /* mov eax, [ebp-0x28] */
            ii(0x1011_bef3, 6); add(eax, memd[ds, 0x101c_38c0]);        /* add eax, [0x101c38c0] */
            ii(0x1011_bef9, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1011_befc, 3); lea(edx, memd[ss, ebp - 0x2c]);         /* lea edx, [ebp-0x2c] */
            ii(0x1011_beff, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1011_bf02, 3); mov(eax, memd[ds, eax + 0x12]);         /* mov eax, [eax+0x12] */
