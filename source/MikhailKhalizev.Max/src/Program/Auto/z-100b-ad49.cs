...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_ad49()
        {
            ...
            ii(0x100b_ad61, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x100b_ad7a, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x100b_ad81, 2); jmp(0x100b_ad89, 0x6); goto l_0x100b_ad89; /* jmp 0x100bad89 */
        l_0x100b_ad83:
            ii(0x100b_ad83, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_ad86, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x100b_ad89:
            ii(0x100b_ad89, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x100b_ad94, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100b_ad98, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100b_ad9b, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
        ...
        l_0x100b_adaa:
            ii(0x100b_adaa, 2); jmp(0x100b_adb4, 0x8); goto l_0x100b_adb4; /* jmp 0x100badb4 */
        l_0x100b_adac:
        ...
        l_0x100b_adb4:
            ...
            ii(0x100b_add5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_adeb, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ...
            ii(0x100b_adf6, 2); if(jz(0x100b_adfd, 0x5)) goto l_0x100b_adfd; /* jz 0x100badfd */
        l_0x100b_adf8:
            ii(0x100b_adf8, 5); jmp(0x100b_af1d, 0x120); goto l_0x100b_af1d; /* jmp 0x100baf1d */
        l_0x100b_adfd:
            ii(0x100b_adfd, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ...
            ii(0x100b_ae12, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
        ...
        l_0x100b_ae1e:
            ii(0x100b_ae1e, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x100b_ae29, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100b_ae2d, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100b_ae30, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ...
            ii(0x100b_ae3f, 2); if(jnz(0x100b_ae43, 0x2)) goto l_0x100b_ae43; /* jnz 0x100bae43 */
        l_0x100b_ae41:
        ...
        l_0x100b_ae43:
            ...
            ii(0x100b_ae47, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100b_ae4b, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100b_ae4e, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ...
            ii(0x100b_ae63, 2); if(jle(0x100b_ae67, 0x2)) goto l_0x100b_ae67; /* jle 0x100bae67 */
        l_0x100b_ae65:
            ii(0x100b_ae65, 2); jmp(0x100b_ae6f, 0x8); goto l_0x100b_ae6f; /* jmp 0x100bae6f */
        l_0x100b_ae67:
            ii(0x100b_ae67, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_ae6a, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
            ii(0x100b_ae6d, 2); jmp(0x100b_ae1e, -0x51); goto l_0x100b_ae1e; /* jmp 0x100bae1e */
        l_0x100b_ae6f:
            ii(0x100b_ae6f, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x100b_ae86, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
        ...
        l_0x100b_ae94:
            ...
            ii(0x100b_ae96, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_aea5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_aeb6, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x100b_aeb9, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x100b_aebc, 3); call_abs(memd[ds, edx + 0x48]);         /* call dword [edx+0x48] */
        l_0x100b_aebf:
            ii(0x100b_aebf, 7); mov(memd[ss, ebp - 0xc], 0x2);          /* mov dword [ebp-0xc], 0x2 */
            ii(0x100b_aec6, 2); jmp(0x100b_aece, 0x6); goto l_0x100b_aece; /* jmp 0x100baece */
        l_0x100b_aec8:
        ...
        l_0x100b_aece:
            ...
            ii(0x100b_aed1, 4); cmp(ax, memw[ss, ebp - 0x8]);           /* cmp ax, [ebp-0x8] */
            ...
            ii(0x100b_aee1, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x100b_aef0, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
        ...
        l_0x100b_aeff:
            ...
            ii(0x100b_af09, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100b_af0d, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100b_af10, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
