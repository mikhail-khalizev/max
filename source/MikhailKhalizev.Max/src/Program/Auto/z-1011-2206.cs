...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_2206()
        {
            ...
            ii(0x1011_221e, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_2221, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_2224, 7); cmp(memd[ds, eax + 0x19e], 0);          /* cmp dword [eax+0x19e], 0x0 */
            ii(0x1011_222b, 6); if(jz(0x1011_2411, 0x1e0)) goto l_0x1011_2411; /* jz 0x10112411 */
            ii(0x1011_2231, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_2234, 6); mov(eax, memd[ds, eax + 0x19e]);        /* mov eax, [eax+0x19e] */
            ii(0x1011_223a, 5); call(0x100e_b68a, -0x2_6bb5);           /* call 0x100eb68a */
            ii(0x1011_223f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_2242, 6); mov(eax, memd[ds, eax + 0x19e]);        /* mov eax, [eax+0x19e] */
            ii(0x1011_2248, 5); call(0x100e_b226, -0x2_7027);           /* call 0x100eb226 */
            ii(0x1011_224d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_2250, 6); mov(edx, memd[ds, eax + 0x19e]);        /* mov edx, [eax+0x19e] */
            ii(0x1011_2256, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_2259, 6); cmp(edx, memd[ds, eax + 0x196]);        /* cmp edx, [eax+0x196] */
            ii(0x1011_225f, 6); if(jnz(0x1011_2385, 0x120)) goto l_0x1011_2385; /* jnz 0x10112385 */
            ii(0x1011_2265, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1011_2268, 6); add(edx, 0x1a2);                        /* add edx, 0x1a2 */
            ii(0x1011_226e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_2271, 5); add(eax, 0x21a);                        /* add eax, 0x21a */
            ii(0x1011_2276, 5); call(Definitions.sys_strcpy, 0x5_3c54); /* call 0x10165ecf */
            ii(0x1011_227b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_2291, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_2294, 5); add(eax, 0x21a);                        /* add eax, 0x21a */
            ii(0x1011_2299, 5); call(Definitions.sys_strcpy, 0x5_3c31); /* call 0x10165ecf */
        l_0x1011_229e:
            ii(0x1011_229e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_22a1, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x1011_22a3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_22a6, 6); mov(eax, memd[ds, eax + 0x5a1]);        /* mov eax, [eax+0x5a1] */
            ...
            ii(0x1011_22cb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_22ce, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1011_22d0, 5); call(0x1010_8a05, -0x98d0);             /* call 0x10108a05 */
            ii(0x1011_22d5, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ...
            ii(0x1011_22ed, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_22f0, 3); mov(al, memb[ds, eax + 0x11]);          /* mov al, [eax+0x11] */
            ...
            ii(0x1011_2303, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_2306, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x1011_2308, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_230b, 3); mov(al, memb[ds, eax + 0x11]);          /* mov al, [eax+0x11] */
            ii(0x1011_230e, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x1011_2313, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1011_2316, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1011_2319, 6); mov(eax, memd[ds, eax + 0x5a9]);        /* mov eax, [eax+0x5a9] */
            ii(0x1011_231f, 5); call(0x100d_7f6c, -0x3_a3b8);           /* call 0x100d7f6c */
            ii(0x1011_2324, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1011_2327, 6); add(edx, 0x21a);                        /* add edx, 0x21a */
            ii(0x1011_232d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_2330, 3); mov(al, memb[ds, eax + 0x11]);          /* mov al, [eax+0x11] */
            ii(0x1011_2333, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x1011_2338, 3); imul(ebx, eax, 0x1e);                   /* imul ebx, eax, 0x1e */
            ii(0x1011_233b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_235c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_235f, 3); mov(al, memb[ds, eax + 0x11]);          /* mov al, [eax+0x11] */
            ...
            ii(0x1011_2374, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1011_2385:
            ii(0x1011_2385, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_2388, 4); cmp(memd[ds, eax + 0x4], 0x1b);         /* cmp dword [eax+0x4], 0x1b */
            ii(0x1011_238c, 2); if(jnz(0x1011_2398, 0xa)) goto l_0x1011_2398; /* jnz 0x10112398 */
            ii(0x1011_238e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_2391, 7); mov(memb[ds, eax + 0x1a2], 0);          /* mov byte [eax+0x1a2], 0x0 */
        l_0x1011_2398:
            ii(0x1011_2398, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_239b, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x1011_239d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_23a0, 6); mov(eax, memd[ds, eax + 0x5b9]);        /* mov eax, [eax+0x5b9] */
            ii(0x1011_23a6, 5); call(0x100d_7f6c, -0x3_a43f);           /* call 0x100d7f6c */
            ii(0x1011_23ab, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1011_23ae, 6); add(edx, 0x1a2);                        /* add edx, 0x1a2 */
            ii(0x1011_23b4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_23db, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_23ec, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_23ef, 3); mov(eax, memd[ds, eax + 0x5a]);         /* mov eax, [eax+0x5a] */
            ii(0x1011_23f2, 5); call(0x100c_fb73, -0x4_2884);           /* call 0x100cfb73 */
        l_0x1011_23f7:
            ii(0x1011_23f7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_23fa, 10); mov(memd[ds, eax + 0x19e], 0);         /* mov dword [eax+0x19e], 0x0 */
            ii(0x1011_2404, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_2407, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1011_2409, 3); mov(eax, memd[ds, eax + 0x12]);         /* mov eax, [eax+0x12] */
