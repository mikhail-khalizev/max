...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("74fa12be-6256-4dc7-9fce-5c69c56b2a95")]
        public void Method_1010_b523()
        {
            ii(0x1010_b523, 5); pushd(0x28);                            /* push 0x28 */
            ii(0x1010_b528, 5); calld(Definitions.sys_check_available_stack_size, 0x5a825); /* call 0x10165d52 */
        ...
        l_0x1010_b585:
            ...
            ii(0x1010_b58e, 5); calld(0x100e_b226, -0x2036d);           /* call 0x100eb226 */
            ...
            ii(0x1010_b5b6, 5); calld(Definitions.my_dtor_d6, -0x204e4); /* call 0x100eb0d7 */
            ii(0x1010_b5bb, 5); calld(Definitions.sys_delete, 0x5a9a4); /* call 0x10165f64 */
        ...
        l_0x1010_b5d9:
            ...
            ii(0x1010_b5f6, 5); calld(Definitions.sys_display_draw_0, 0x5be89); /* call 0x10167484 */
        l_0x1010_b5fb:
            ...
            ii(0x1010_b602, 1); retd(); return;                         /* ret */
        }
    }
}
