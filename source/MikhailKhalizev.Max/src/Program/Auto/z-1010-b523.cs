...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_b523()
        {
            ...
            ii(0x1010_b53a, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_b53d, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x1010_b540, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1010_b550, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ii(0x1010_b554, 2); if(jz(0x1010_b585, 0x2f)) goto l_0x1010_b585; /* jz 0x1010b585 */
            ii(0x1010_b556, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1010_b56c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1010_b585:
            ...
            ii(0x1010_b59f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1010_b5c3, 2); jmp(0x1010_b5cc, 0x7); goto l_0x1010_b5cc; /* jmp 0x1010b5cc */
        l_0x1010_b5c5:
            ii(0x1010_b5c5, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
        l_0x1010_b5cc:
            ii(0x1010_b5cc, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_b5cf, 10); mov(memd[ds, eax + 0x341], 0);         /* mov dword [eax+0x341], 0x0 */
        l_0x1010_b5d9:
            ii(0x1010_b5d9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_b5dc, 10); mov(memd[ds, eax + 0x363], 0);         /* mov dword [eax+0x363], 0x0 */
            ii(0x1010_b5e6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_b5e9, 5); call(0x1010_a69d, -0xf51);              /* call 0x1010a69d */
            ii(0x1010_b5ee, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
