...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_0d94()
        {
            ...
            ii(0x1012_0dac, 3); mov(memb[ss, ebp - 0x4], al);           /* mov [ebp-0x4], al */
            ii(0x1012_0daf, 5); mov(al, memb[ds, 0x101c_5620]);         /* mov al, [0x101c5620] */
            ii(0x1012_0db4, 3); cmp(al, memb[ss, ebp - 0x4]);           /* cmp al, [ebp-0x4] */
            ii(0x1012_0db7, 6); if(jz(0x1012_0ec4, 0x107)) goto l_0x1012_0ec4; /* jz 0x10120ec4 */
            ii(0x1012_0dbd, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ...
            ii(0x1012_0dd1, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ...
            ii(0x1012_0deb, 4); movsx(ecx, memb[ss, ebp - 0x4]);        /* movsx ecx, byte [ebp-0x4] */
            ...
            ii(0x1012_0dfd, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ...
            ii(0x1012_0e0a, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ...
            ii(0x1012_0e17, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ...
            ii(0x1012_0e24, 4); movsx(ecx, memb[ss, ebp - 0x4]);        /* movsx ecx, byte [ebp-0x4] */
            ...
            ii(0x1012_0e33, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ...
            ii(0x1012_0e43, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
        ...
        l_0x1012_0e57:
            ii(0x1012_0e57, 4); movsx(ecx, memb[ss, ebp - 0x4]);        /* movsx ecx, byte [ebp-0x4] */
            ...
            ii(0x1012_0e69, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ...
            ii(0x1012_0e76, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ...
            ii(0x1012_0e83, 4); movsx(ecx, memb[ss, ebp - 0x4]);        /* movsx ecx, byte [ebp-0x4] */
            ...
            ii(0x1012_0e90, 4); movsx(ebx, memb[ss, ebp - 0x4]);        /* movsx ebx, byte [ebp-0x4] */
            ...
            ii(0x1012_0e9d, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ...
            ii(0x1012_0eaa, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
        ...
        l_0x1012_0ebc:
            ii(0x1012_0ebc, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
