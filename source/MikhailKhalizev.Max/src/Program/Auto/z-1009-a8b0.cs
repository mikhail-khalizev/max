...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_a8b0()
        {
            ...
            ii(0x1009_a8c7, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_a8ca, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1009_a8cd, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1009_a8d0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_a8d3, 5); call(0x1015_2a52, 0xb_817a);            /* call 0x10152a52 */
            ii(0x1009_a8d8, 2); test(al, al);                           /* test al, al */
            ii(0x1009_a8da, 2); if(jnz(0x1009_a8e5, 0x9)) goto l_0x1009_a8e5; /* jnz 0x1009a8e5 */
            ii(0x1009_a8dc, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
            ii(0x1009_a8e0, 5); jmp(0x1009_ab4c, 0x267); goto l_0x1009_ab4c; /* jmp 0x1009ab4c */
        l_0x1009_a8e5:
            ii(0x1009_a8e5, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_a8e7, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1009_a8f6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_a8f9, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1009_a8fc, 5); call(0x1007_6574, -0x2_438d);           /* call 0x10076574 */
            ii(0x1009_a901, 3); mov(ebx, memd[ds, eax + 0x1a]);         /* mov ebx, [eax+0x1a] */
            ii(0x1009_a904, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1009_a907, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_a90a, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1009_a90d, 5); call(0x1007_6574, -0x2_439e);           /* call 0x10076574 */
            ii(0x1009_a912, 3); mov(edx, memd[ds, eax + 0x18]);         /* mov edx, [eax+0x18] */
            ii(0x1009_a915, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1009_a918, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_a91b, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ...
            ii(0x1009_a928, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1009_a933:
            ...
            ii(0x1009_a935, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1009_a988:
            ii(0x1009_a988, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_a98b, 5); call(0x1009_a476, -0x51a);              /* call 0x1009a476 */
            ii(0x1009_a990, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1009_a994, 5); jmp(0x1009_ab4c, 0x1b3); goto l_0x1009_ab4c; /* jmp 0x1009ab4c */
        l_0x1009_a999:
            ii(0x1009_a999, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_a99c, 5); call(0x1007_623c, -0x2_4765);           /* call 0x1007623c */
            ii(0x1009_a9a1, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_a9a4, 4); mov(dx, memw[ds, edx + 0x52]);          /* mov dx, [edx+0x52] */
            ii(0x1009_a9a8, 4); cmp(dx, memw[ds, eax + 0x19]);          /* cmp dx, [eax+0x19] */
            ii(0x1009_a9ac, 2); if(jnz(0x1009_a9c1, 0x13)) goto l_0x1009_a9c1; /* jnz 0x1009a9c1 */
            ii(0x1009_a9ae, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_a9b1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_a9b4, 5); call(0x1009_a57f, -0x43a);              /* call 0x1009a57f */
            ii(0x1009_a9b9, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x1009_a9bc, 5); jmp(0x1009_ab4c, 0x18b); goto l_0x1009_ab4c; /* jmp 0x1009ab4c */
        l_0x1009_a9c1:
            ii(0x1009_a9c1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_a9c4, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1009_a9c7, 5); call(0x1007_6574, -0x2_4458);           /* call 0x10076574 */
            ii(0x1009_a9cc, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_a9cf, 4); mov(dx, memw[ds, edx + 0x1a]);          /* mov dx, [edx+0x1a] */
            ii(0x1009_a9d3, 4); cmp(dx, memw[ds, eax + 0x1a]);          /* cmp dx, [eax+0x1a] */
            ii(0x1009_a9d7, 2); if(jnz(0x1009_a9f1, 0x18)) goto l_0x1009_a9f1; /* jnz 0x1009a9f1 */
            ii(0x1009_a9d9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_a9dc, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1009_a9df, 5); call(0x1007_6574, -0x2_4470);           /* call 0x10076574 */
            ii(0x1009_a9e4, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_a9e7, 4); mov(dx, memw[ds, edx + 0x1c]);          /* mov dx, [edx+0x1c] */
            ii(0x1009_a9eb, 4); cmp(dx, memw[ds, eax + 0x1c]);          /* cmp dx, [eax+0x1c] */
            ii(0x1009_a9ef, 2); if(jz(0x1009_a9f6, 0x5)) goto l_0x1009_a9f6; /* jz 0x1009a9f6 */
        l_0x1009_a9f1:
        ...
        l_0x1009_a9f6:
            ...
            ii(0x1009_aa01, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_aa04, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
        ...
        l_0x1009_aa16:
            ii(0x1009_aa16, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1009_aa23, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_aa26, 5); call(0x1008_a998, -0x1_0093);           /* call 0x1008a998 */
            ii(0x1009_aa2b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_aa2e, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1009_aa31, 5); call(0x1007_6574, -0x2_44c2);           /* call 0x10076574 */
            ii(0x1009_aa36, 4); test(memb[ds, eax + 0x12], 0x10);       /* test byte [eax+0x12], 0x10 */
            ii(0x1009_aa3a, 2); if(jz(0x1009_aa45, 0x9)) goto l_0x1009_aa45; /* jz 0x1009aa45 */
            ii(0x1009_aa3c, 7); mov(memd[ss, ebp - 0x28], 0x4);         /* mov dword [ebp-0x28], 0x4 */
            ii(0x1009_aa43, 2); jmp(0x1009_aa4c, 0x7); goto l_0x1009_aa4c; /* jmp 0x1009aa4c */
        l_0x1009_aa45:
            ii(0x1009_aa45, 7); mov(memd[ss, ebp - 0x28], 0x1);         /* mov dword [ebp-0x28], 0x1 */
        l_0x1009_aa4c:
            ii(0x1009_aa4c, 3); mov(al, memb[ss, ebp - 0x28]);          /* mov al, [ebp-0x28] */
            ii(0x1009_aa4f, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_aa52, 3); mov(memb[ds, edx + 0x45], al);          /* mov [edx+0x45], al */
            ii(0x1009_aa55, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1009_aa57, 5); mov(edx, 0xb);                          /* mov edx, 0xb */
            ii(0x1009_aa5c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_aa5f, 5); call(0x1016_3053, 0xc_85ef);            /* call 0x10163053 */
        l_0x1009_aa64:
            ii(0x1009_aa64, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1009_aa68, 5); jmp(0x1009_ab4c, 0xdf); goto l_0x1009_ab4c; /* jmp 0x1009ab4c */
        l_0x1009_aa6d:
            ii(0x1009_aa6d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_aa70, 3); mov(al, memb[ds, eax + 0x4e]);          /* mov al, [eax+0x4e] */
            ii(0x1009_aa73, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x1009_aa78, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1009_aa7a, 2); if(jnz(0x1009_aa85, 0x9)) goto l_0x1009_aa85; /* jnz 0x1009aa85 */
            ii(0x1009_aa7c, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
            ii(0x1009_aa80, 5); jmp(0x1009_ab4c, 0xc7); goto l_0x1009_ab4c; /* jmp 0x1009ab4c */
        l_0x1009_aa85:
            ii(0x1009_aa85, 5); mov(ebx, 0x3);                          /* mov ebx, 0x3 */
            ii(0x1009_aa8a, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_aa8d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_aa90, 5); call(0x100a_3671, 0x8bdc);              /* call 0x100a3671 */
            ii(0x1009_aa95, 2); test(al, al);                           /* test al, al */
            ii(0x1009_aa97, 2); if(jz(0x1009_aaa2, 0x9)) goto l_0x1009_aaa2; /* jz 0x1009aaa2 */
            ii(0x1009_aa99, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
        ...
        l_0x1009_aaa2:
            ...
            ii(0x1009_aaac, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1009_aaaf, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1009_aab2, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x1009_aab5, 4); cmp(memd[ss, ebp - 0x24], 0);           /* cmp dword [ebp-0x24], 0x0 */
            ...
            ii(0x1009_aac1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_aac4, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1009_aac7, 5); call(0x1007_6574, -0x2_4558);           /* call 0x10076574 */
            ii(0x1009_aacc, 3); mov(ebx, memd[ds, eax + 0x1a]);         /* mov ebx, [eax+0x1a] */
            ii(0x1009_aacf, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1009_aad2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_aad5, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1009_aad8, 5); call(0x1007_6574, -0x2_4569);           /* call 0x10076574 */
            ii(0x1009_aadd, 3); mov(edx, memd[ds, eax + 0x18]);         /* mov edx, [eax+0x18] */
            ii(0x1009_aae0, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1009_aae3, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x1009_aaf4, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ii(0x1009_aaf7, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_aafa, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1009_aafd, 5); call(0x100a_c220, 0x1_171e);            /* call 0x100ac220 */
            ii(0x1009_ab02, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1009_ab05, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1009_ab08, 3); mov(memd[ss, ebp - 0x2c], eax);         /* mov [ebp-0x2c], eax */
            ii(0x1009_ab0b, 2); jmp(0x1009_ab13, 0x6); goto l_0x1009_ab13; /* jmp 0x1009ab13 */
        l_0x1009_ab0d:
            ii(0x1009_ab0d, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x1009_ab10, 3); mov(memd[ss, ebp - 0x2c], eax);         /* mov [ebp-0x2c], eax */
        l_0x1009_ab13:
            ii(0x1009_ab13, 3); mov(edx, memd[ss, ebp - 0x2c]);         /* mov edx, [ebp-0x2c] */
            ii(0x1009_ab16, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1009_ab19, 5); call(0x1008_b060, -0xfabe);             /* call 0x1008b060 */
            ii(0x1009_ab1e, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1009_ab32, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1009_ab36, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_ab38, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
        ...
        //  ii(0x1009_ab44, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
        //  ii(0x1009_ab47, 5); call(0x1008_8b7c, -0x1_1fd0);           /* call 0x10088b7c */
        l_0x1009_ab4c:
            ii(0x1009_ab4c, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
