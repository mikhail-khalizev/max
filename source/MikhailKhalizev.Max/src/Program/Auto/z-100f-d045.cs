...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_d045()
        {
            ...
            ii(0x100f_d08e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ...
            ii(0x100f_d09b, 3); lea(eax, memd[ss, ebp - 0x50]);         /* lea eax, [ebp-0x50] */
            ii(0x100f_d09e, 5); call(0x100f_ca4f, -0x654);              /* call 0x100fca4f */
            ii(0x100f_d0a3, 3); lea(eax, memd[ss, ebp - 0x38]);         /* lea eax, [ebp-0x38] */
            ii(0x100f_d0a6, 5); call(0x100f_ca4f, -0x65c);              /* call 0x100fca4f */
            ii(0x100f_d0ab, 3); lea(eax, memd[ss, ebp - 0x20]);         /* lea eax, [ebp-0x20] */
            ii(0x100f_d0ae, 5); call(0x100f_ca4f, -0x664);              /* call 0x100fca4f */
            ii(0x100f_d0b3, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x100f_d0ba, 2); jmp(0x100f_d0c2, 0x6); goto l_0x100f_d0c2; /* jmp 0x100fd0c2 */
        l_0x100f_d0bc:
            ii(0x100f_d0bc, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_d0bf, 3); inc(memd[ss, ebp - 0x4]);               /* inc dword [ebp-0x4] */
        l_0x100f_d0c2:
            ii(0x100f_d0c2, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_d0c6, 3); cmp(eax, 0x4);                          /* cmp eax, 0x4 */
            ii(0x100f_d0c9, 6); if(jge(0x100f_d190, 0xc1)) goto l_0x100f_d190; /* jge 0x100fd190 */
            ii(0x100f_d0cf, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_d0ec, 3); lea(eax, memd[ss, ebp - 0x54]);         /* lea eax, [ebp-0x54] */
            ii(0x100f_d0ef, 5); call(Definitions.my_ctor_0x101b_4184, -0x8_6604); /* call 0x10076af0 */
            ii(0x100f_d0f4, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_d102, 4); mov(memw[ss, ebp - 0x54], ax);          /* mov [ebp-0x54], ax */
            ii(0x100f_d106, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_d114, 4); mov(memw[ss, ebp - 0x52], ax);          /* mov [ebp-0x52], ax */
            ii(0x100f_d118, 3); lea(edx, memd[ss, ebp - 0x52]);         /* lea edx, [ebp-0x52] */
            ii(0x100f_d11b, 3); lea(eax, memd[ss, ebp - 0x54]);         /* lea eax, [ebp-0x54] */
            ii(0x100f_d11e, 5); call(0x100f_cd9c, -0x387);              /* call 0x100fcd9c */
            ii(0x100f_d123, 5); mov(ecx, 0x64);                         /* mov ecx, 0x64 */
            ii(0x100f_d128, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x100f_d141, 3); lea(edx, memd[ss, ebp - 0x54]);         /* lea edx, [ebp-0x54] */
            ii(0x100f_d144, 3); lea(eax, memd[ss, ebp - 0x58]);         /* lea eax, [ebp-0x58] */
            ii(0x100f_d147, 5); call(0x1007_5e64, -0x8_72e8);           /* call 0x10075e64 */
            ii(0x100f_d14c, 3); lea(esi, memd[ss, ebp - 0x50]);         /* lea esi, [ebp-0x50] */
            ...
            ii(0x100f_d15d, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100f_d161, 3); shl(eax, 0x3);                          /* shl eax, 0x3 */
            ii(0x100f_d164, 3); lea(edx, memd[ds, eax + 0xa]);          /* lea edx, [eax+0xa] */
            ...
            ii(0x100f_d176, 3); lea(edx, memd[ss, ebp - 0x54]);         /* lea edx, [ebp-0x54] */
            ii(0x100f_d179, 3); lea(eax, memd[ss, ebp - 0x5c]);         /* lea eax, [ebp-0x5c] */
            ii(0x100f_d17c, 5); call(0x1007_5e64, -0x8_731d);           /* call 0x10075e64 */
            ii(0x100f_d181, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100f_d183, 3); lea(eax, memd[ss, ebp - 0x38]);         /* lea eax, [ebp-0x38] */
        ...
        l_0x100f_d190:
            ii(0x100f_d190, 3); lea(edx, memd[ss, ebp - 0x38]);         /* lea edx, [ebp-0x38] */
            ii(0x100f_d193, 3); lea(eax, memd[ss, ebp - 0x50]);         /* lea eax, [ebp-0x50] */
            ii(0x100f_d196, 5); call(0x100f_ce65, -0x336);              /* call 0x100fce65 */
            ii(0x100f_d19b, 3); lea(eax, memd[ss, ebp - 0x50]);         /* lea eax, [ebp-0x50] */
            ii(0x100f_d19e, 5); call(0x100f_cae7, -0x6bc);              /* call 0x100fcae7 */
            ii(0x100f_d1a3, 3); lea(eax, memd[ss, ebp - 0x38]);         /* lea eax, [ebp-0x38] */
            ii(0x100f_d1a6, 5); call(0x100f_cae7, -0x6c4);              /* call 0x100fcae7 */
            ii(0x100f_d1ab, 3); lea(eax, memd[ss, ebp - 0x20]);         /* lea eax, [ebp-0x20] */
