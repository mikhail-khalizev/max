...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_2f81()
        {
            ...
            ii(0x1013_2fba, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1013_2fbd, 4); mov(memb[ds, eax + 29], 1);             /* mov byte [eax+0x1d], 0x1 */
            ii(0x1013_2fc1, 7); mov(memd[ss, ebp - 12], 0);             /* mov dword [ebp-0xc], 0x0 */
            ii(0x1013_2fc8, 2); jmp(0x1013_2fd0, 6); goto l_0x1013_2fd0; /* jmp 0x10132fd0 */
        l_0x1013_2fca:
            ii(0x1013_2fca, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_2fcd, 3); inc(memd[ss, ebp - 12]);                /* inc dword [ebp-0xc] */
        l_0x1013_2fd0:
            ii(0x1013_2fd0, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x1013_2fd4, 3); cmp(eax, 8);                            /* cmp eax, 0x8 */
            ii(0x1013_2fd7, 2); if(jge(0x1013_2ffc, 0x23)) goto l_0x1013_2ffc; /* jge 0x10132ffc */
            ii(0x1013_2fd9, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x1013_2fdd, 3); imul(eax, eax, 0x1f);                   /* imul eax, eax, 0x1f */
            ii(0x1013_2fe0, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ...
            ii(0x1013_2fef, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x1013_2ff3, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x1013_2ff5, 5); mov(memw[ds, eax + ebp - 36], dx);      /* mov [eax+ebp-0x24], dx */
        ...
        l_0x1013_2ffe:
            ii(0x1013_2ffe, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1013_3001, 5); call(0x1007_6bf8, -0xb_c40e);           /* call 0x10076bf8 */
        l_0x1013_3006:
            ii(0x1013_3006, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_3008, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ...
            ii(0x1013_3018, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1013_301b, 5); call(0x1007_63a0, -0xb_cc80);           /* call 0x100763a0 */
            ii(0x1013_3020, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_3022, 3); mov(dl, memb[ds, eax + 38]);            /* mov dl, [eax+0x26] */
            ii(0x1013_3025, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1013_3028, 3); mov(eax, memd[ds, eax + 21]);           /* mov eax, [eax+0x15] */
            ...
            ii(0x1013_3032, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
        ...
        l_0x1013_3043:
            ii(0x1013_3043, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1013_3046, 5); call(0x1007_63a0, -0xb_ccab);           /* call 0x100763a0 */
            ii(0x1013_304b, 4); cmp(memb[ds, eax + 61], 7);             /* cmp byte [eax+0x3d], 0x7 */
        ...
        l_0x1013_3056:
            ii(0x1013_3056, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1013_3059, 5); call(0x1007_63a0, -0xb_ccbe);           /* call 0x100763a0 */
            ii(0x1013_305e, 3); mov(eax, memd[ds, eax + 90]);           /* mov eax, [eax+0x5a] */
            ii(0x1013_3061, 3); sar(eax, 0x18);                         /* sar eax, 0x18 */
            ii(0x1013_3064, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x1013_3066, 4); mov(eax, memd[ds, eax + ebp - 38]);     /* mov eax, [eax+ebp-0x26] */
            ...
            ii(0x1013_3071, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1013_3074, 5); call(0x1007_63a0, -0xb_ccd9);           /* call 0x100763a0 */
            ii(0x1013_3079, 3); mov(eax, memd[ds, eax + 90]);           /* mov eax, [eax+0x5a] */
            ii(0x1013_307c, 3); sar(eax, 0x18);                         /* sar eax, 0x18 */
            ii(0x1013_307f, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x1013_3081, 5); dec(memw[ds, eax + ebp - 36]);          /* dec word [eax+ebp-0x24] */
            ii(0x1013_3086, 5); jmp(0x1013_312d, 0xa2); goto l_0x1013_312d; /* jmp 0x1013312d */
        l_0x1013_308b:
            ii(0x1013_308b, 7); mov(memd[ss, ebp - 12], 0);             /* mov dword [ebp-0xc], 0x0 */
            ii(0x1013_3092, 2); jmp(0x1013_309a, 6); goto l_0x1013_309a; /* jmp 0x1013309a */
        l_0x1013_3094:
            ii(0x1013_3094, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_3097, 3); inc(memd[ss, ebp - 12]);                /* inc dword [ebp-0xc] */
        l_0x1013_309a:
            ii(0x1013_309a, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x1013_309e, 3); cmp(eax, 8);                            /* cmp eax, 0x8 */
            ii(0x1013_30a1, 2); if(jge(0x1013_30b1, 0xe)) goto l_0x1013_30b1; /* jge 0x101330b1 */
            ii(0x1013_30a3, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x1013_30a7, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x1013_30a9, 6); cmp(memw[ds, eax + ebp - 36], 0);       /* cmp word [eax+ebp-0x24], 0x0 */
            ii(0x1013_30af, 2); if(jz(0x1013_3094, -0x1d)) goto l_0x1013_3094; /* jz 0x10133094 */
        l_0x1013_30b1:
            ii(0x1013_30b1, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1013_30c1, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
        ...
        l_0x1013_30d0:
            ...
            ii(0x1013_30d5, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1013_30d8, 5); call(0x1007_63a0, -0xb_cd3d);           /* call 0x100763a0 */
            ii(0x1013_30dd, 3); mov(edx, memd[ds, eax + 90]);           /* mov edx, [eax+0x5a] */
            ii(0x1013_30e0, 3); sar(edx, 0x18);                         /* sar edx, 0x18 */
            ii(0x1013_30e3, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1013_30e6, 3); mov(eax, memd[ds, eax + 21]);           /* mov eax, [eax+0x15] */
            ii(0x1013_30e9, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1013_30ec, 5); call(0x1013_322d, 0x13c);               /* call 0x1013322d */
            ii(0x1013_30f1, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1013_30f4, 5); call(0x1007_63a0, -0xb_cd59);           /* call 0x100763a0 */
            ii(0x1013_30f9, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1013_30fb, 3); mov(al, memb[ss, ebp - 12]);            /* mov al, [ebp-0xc] */
            ii(0x1013_30fe, 3); mov(memb[ds, edx + 93], al);            /* mov [edx+0x5d], al */
            ii(0x1013_3101, 5); mov(ebx, 1);                            /* mov ebx, 0x1 */
            ii(0x1013_3106, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1013_3109, 5); call(0x1007_63a0, -0xb_cd6e);           /* call 0x100763a0 */
            ii(0x1013_310e, 3); mov(edx, memd[ds, eax + 90]);           /* mov edx, [eax+0x5a] */
            ii(0x1013_3111, 3); sar(edx, 0x18);                         /* sar edx, 0x18 */
            ii(0x1013_3114, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1013_3117, 3); mov(eax, memd[ds, eax + 21]);           /* mov eax, [eax+0x15] */
            ii(0x1013_311a, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1013_311d, 5); call(0x1013_322d, 0x10b);               /* call 0x1013322d */
            ii(0x1013_3122, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x1013_3126, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x1013_3128, 5); dec(memw[ds, eax + ebp - 36]);          /* dec word [eax+ebp-0x24] */
        l_0x1013_312d:
        ...
        l_0x1013_3132:
            ...
            ii(0x1013_313b, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1013_313e, 3); mov(eax, memd[ds, eax + 21]);           /* mov eax, [eax+0x15] */
        ...
        l_0x1013_3149:
            ...
            ii(0x1013_314b, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
