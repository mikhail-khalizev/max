...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_7c48()
        {
            ...
            ii(0x1014_7c60, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_7c63, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_7c66, 3); add(eax, 0x6);                          /* add eax, 0x6 */
            ii(0x1014_7c69, 5); call(0x1014_81a4, 0x536);               /* call 0x101481a4 */
            ii(0x1014_7c6e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_7c71, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
