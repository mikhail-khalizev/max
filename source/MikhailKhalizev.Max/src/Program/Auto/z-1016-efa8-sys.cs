...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_efa8()
        {
            ...
            ii(0x1016_efbd, 4); test(memb[ds, eax + 0x4], 0x4);         /* test byte [eax+0x4], 0x4 */
        ...
        l_0x1016_efd2:
            ii(0x1016_efd2, 3); mov(eax, memd[ds, ecx + 0x4]);          /* mov eax, [ecx+0x4] */
        ...
        l_0x1016_effc:
            ...
            ii(0x1016_f00e, 4); movzx(esi, memb[ds, eax - 0x1]);        /* movzx esi, byte [eax-0x1] */
            ...
            ii(0x1016_f020, 4); test(memb[ds, ecx + 0x4], 0x2);         /* test byte [ecx+0x4], 0x2 */
        ...
        l_0x1016_f054:
            ...
            ii(0x1016_f065, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
            ...
            ii(0x1016_f077, 3); mov(esi, memd[ds, esi + 0x4]);          /* mov esi, [esi+0x4] */
            ii(0x1016_f07a, 3); mov(ebx, memd[ds, esi + 0x4]);          /* mov ebx, [esi+0x4] */
            ii(0x1016_f07d, 2); test(ebx, ebx);                         /* test ebx, ebx */
            ii(0x1016_f07f, 2); if(jle(0x1016_f095, 0x14)) goto l_0x1016_f095; /* jle 0x1016f095 */
            ii(0x1016_f081, 4); test(memb[ds, esi + 0xc], 0x4);         /* test byte [esi+0xc], 0x4 */
            ...
            ii(0x1016_f08e, 2); if(jz(0x1016_f095, 0x5)) goto l_0x1016_f095; /* jz 0x1016f095 */
        ...
        l_0x1016_f095:
            ...
            ii(0x1016_f097, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
        ...
        l_0x1016_f0b7:
            ...
            ii(0x1016_f0c8, 4); test(memb[ds, ecx + 0x4], 0x2);         /* test byte [ecx+0x4], 0x2 */
            ...
            ii(0x1016_f0d9, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
            ii(0x1016_f0dc, 4); cmp(memd[ds, eax + 0x4], 0);            /* cmp dword [eax+0x4], 0x0 */
            ii(0x1016_f0e0, 2); if(jle(0x1016_f0f6, 0x14)) goto l_0x1016_f0f6; /* jle 0x1016f0f6 */
            ii(0x1016_f0e2, 4); test(memb[ds, eax + 0xc], 0x4);         /* test byte [eax+0xc], 0x4 */
            ...
            ii(0x1016_f0ef, 2); if(jz(0x1016_f0f6, 0x5)) goto l_0x1016_f0f6; /* jz 0x1016f0f6 */
        ...
        l_0x1016_f0f6:
            ...
            ii(0x1016_f0f8, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
        ...
        l_0x1016_f102:
            ii(0x1016_f102, 3); dec(memd[ds, eax + 0x4]);               /* dec dword [eax+0x4] */
        ...
        l_0x1016_f128:
            ...
            ii(0x1016_f12a, 3); mov(edx, memd[ds, edx + 0x4]);          /* mov edx, [edx+0x4] */
            ii(0x1016_f12d, 5); call(/* sys */ 0x1018_b4e9, 0x1_c3b7);  /* call 0x1018b4e9 */
        l_0x1016_f132:
            ii(0x1016_f132, 2); mov(eax, memd[ds, ecx]);                /* mov eax, [ecx] */
            ii(0x1016_f134, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
