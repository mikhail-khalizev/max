...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_58d2()
        {
            ...
            ii(0x1011_58e9, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_58ec, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1011_58ef, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1011_58f6, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1011_58fd, 7); mov(memd[ss, ebp - 0x1c], 0x101c_4e64); /* mov dword [ebp-0x1c], 0x101c4e64 */
            ii(0x1011_5904, 4); mov(memb[ss, ebp - 0x13], 0);           /* mov byte [ebp-0x13], 0x0 */
        l_0x1011_5908:
            ii(0x1011_5908, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1011_590c, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ...
            ii(0x1011_591b, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x1011_5964, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ...
            ii(0x1011_597a, 3); mov(memd[ss, ebp - 0x1c], edx);         /* mov [ebp-0x1c], edx */
            ii(0x1011_597d, 5); jmp(0x1011_5a6f, 0xed); goto l_0x1011_5a6f; /* jmp 0x10115a6f */
        l_0x1011_5982:
            ii(0x1011_5982, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1011_5986, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x1011_5989, 2); mov(al, memb[ds, eax]);                 /* mov al, [eax] */
            ii(0x1011_598b, 3); mov(memb[ss, ebp - 0x14], al);          /* mov [ebp-0x14], al */
            ii(0x1011_598e, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1011_5991, 6); call_abs(memd[ds, 0x101b_ddf4]);        /* call dword [0x101bddf4] */
            ii(0x1011_5997, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1011_599a, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x1011_599e, 4); movsx(eax, memw[ss, ebp - 0x18]);       /* movsx eax, word [ebp-0x18] */
            ii(0x1011_59a2, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1011_59a4, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1011_59bb, 3); mov(memd[ss, ebp - 0x20], edx);         /* mov [ebp-0x20], edx */
            ii(0x1011_59be, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1011_59c1, 3); dec(memd[ss, ebp - 0x20]);              /* dec dword [ebp-0x20] */
            ii(0x1011_59c4, 3); mov(memb[ds, eax], 0);                  /* mov byte [eax], 0x0 */
        l_0x1011_59c7:
            ii(0x1011_59c7, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1011_59ca, 3); cmp(memb[ds, eax], 0x20);               /* cmp byte [eax], 0x20 */
            ii(0x1011_59cd, 2); if(jz(0x1011_59d7, 0x8)) goto l_0x1011_59d7; /* jz 0x101159d7 */
            ii(0x1011_59cf, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1011_59d2, 3); dec(memd[ss, ebp - 0x20]);              /* dec dword [ebp-0x20] */
            ii(0x1011_59d5, 2); jmp(0x1011_59c7, -0x10); goto l_0x1011_59c7; /* jmp 0x101159c7 */
        l_0x1011_59d7:
            ii(0x1011_59d7, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1011_59da, 3); mov(memb[ds, eax], 0);                  /* mov byte [eax], 0x0 */
            ii(0x1011_59dd, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x1011_59e0, 6); call_abs(memd[ds, 0x101b_ddf4]);        /* call dword [0x101bddf4] */
            ii(0x1011_59e6, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1011_59e9, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x1011_5a00, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1011_5a03, 1); inc(eax);                               /* inc eax */
            ii(0x1011_5a04, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1011_5a07, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x1011_5a0a, 6); call_abs(memd[ds, 0x101b_ddf4]);        /* call dword [0x101bddf4] */
            ii(0x1011_5a10, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1011_5a13, 8); add(memw[ds, 0x101c_52b4], 0xa);        /* add word [0x101c52b4], 0xa */
        l_0x1011_5a1b:
            ii(0x1011_5a1b, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1011_5a1e, 3); add(memd[ss, ebp - 0xc], eax);          /* add [ebp-0xc], eax */
            ...
            ii(0x1011_5a2e, 2); if(jae(0x1011_5a39, 0x9)) goto l_0x1011_5a39; /* jae 0x10115a39 */
            ii(0x1011_5a30, 7); mov(memd[ss, ebp - 0x24], 0);           /* mov dword [ebp-0x24], 0x0 */
        ...
        l_0x1011_5a39:
            ...
            ii(0x1011_5a4f, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
        l_0x1011_5a52:
            ii(0x1011_5a52, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x1011_5a56, 3); add(edx, memd[ss, ebp - 0x8]);          /* add edx, [ebp-0x8] */
        ...
        l_0x1011_5a6f:
            ii(0x1011_5a6f, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1011_5a72, 3); inc(memd[ss, ebp - 0x10]);              /* inc dword [ebp-0x10] */
            ii(0x1011_5a75, 1); cwde();                                 /* cwde */
            ii(0x1011_5a76, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ...
            ii(0x1011_5a82, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
