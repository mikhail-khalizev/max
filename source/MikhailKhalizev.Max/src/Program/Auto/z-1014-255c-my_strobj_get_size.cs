...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void my_strobj_get_size()
        {
            ...
            ii(0x1014_256e, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1014_2574, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1014_2577, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_257a, 4); mov(ax, memw[ds, eax + 4]);             /* mov ax, [eax+0x4] */
            ii(0x1014_257e, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1014_2581, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
