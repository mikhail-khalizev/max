...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_1d6c()
        {
            ...
            ii(0x1017_1d77, 2); if(jnz(0x1017_1d7d, 0x4)) goto l_0x1017_1d7d; /* jnz 0x10171d7d */
        ...
        l_0x1017_1d7d:
            ...
            ii(0x1017_1d7f, 4); mov(edx, memd[ss, esp + 0x3c]);         /* mov edx, [esp+0x3c] */
            ii(0x1017_1d83, 8); mov(memd[ss, esp + 0x10], 0);           /* mov dword [esp+0x10], 0x0 */
            ii(0x1017_1d8b, 8); mov(memd[ss, esp + 0x14], /* sys */ 0x1017_1d40); /* mov dword [esp+0x14], 0x10171d40 */
            ii(0x1017_1d93, 8); mov(memd[ss, esp + 0x18], 0xffff_ffe4); /* mov dword [esp+0x18], 0xffffffe4 */
            ...
            ii(0x1017_1dc1, 8); mov(memd[ss, esp + 0x2c], /* sys */ 0x1018_d370); /* mov dword [esp+0x2c], 0x1018d370 */
            ii(0x1017_1dc9, 2); jmp(0x1017_1dd3, 0x8); goto l_0x1017_1dd3; /* jmp 0x10171dd3 */
        l_0x1017_1dcb:
            ii(0x1017_1dcb, 8); mov(memd[ss, esp + 0x2c], Definitions.sys_call_ctor_arr_v2); /* mov dword [esp+0x2c], 0x10165f70 */
        l_0x1017_1dd3:
            ii(0x1017_1dd3, 4); mov(eax, memd[ss, esp + 0x8]);          /* mov eax, [esp+0x8] */
            ii(0x1017_1dd7, 2); mov(ebx, esi);                          /* mov ebx, esi */
            ii(0x1017_1dd9, 2); mov(edx, edi);                          /* mov edx, edi */
            ii(0x1017_1ddb, 3); add(eax, 0x4);                          /* add eax, 0x4 */
            ii(0x1017_1dde, 4); call_abs(memd[ss, esp + 0x2c]);         /* call dword [esp+0x2c] */
        ...
        l_0x1017_1de9:
            ...
            ii(0x1017_1df0, 3); ret(0x4);                               /* ret 0x4 */
        }
    }
}
