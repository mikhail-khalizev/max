...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_b24f()
        {
            ...
            ii(0x1013_b266, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_b269, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_b26c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_b26f, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1013_b272, 4); cmp(ax, memw[ds, edx + 0x4]);           /* cmp ax, [edx+0x4] */
            ii(0x1013_b276, 2); if(jge(0x1013_b281, 0x9)) goto l_0x1013_b281; /* jge 0x1013b281 */
            ii(0x1013_b278, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
        ...
        l_0x1013_b281:
            ...
            ii(0x1013_b297, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
        l_0x1013_b29a:
            ii(0x1013_b29a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_b29d, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1013_b2a0, 2); jmp(0x1013_b2a8, 0x6); goto l_0x1013_b2a8; /* jmp 0x1013b2a8 */
        l_0x1013_b2a2:
            ii(0x1013_b2a2, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1013_b2a5, 3); inc(memd[ss, ebp - 0x10]);              /* inc dword [ebp-0x10] */
        l_0x1013_b2a8:
            ii(0x1013_b2a8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_b2ab, 3); mov(eax, memd[ds, eax + 0x2]);          /* mov eax, [eax+0x2] */
            ii(0x1013_b2ae, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1013_b2b1, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x1013_b2ba, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x1013_b2be, 3); shl(edx, 0x2);                          /* shl edx, 0x2 */
            ii(0x1013_b2c1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_b2c4, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x1013_b2c7, 3); add(edx, 0x4);                          /* add edx, 0x4 */
            ii(0x1013_b2ca, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1013_b2cc, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1013_b2d0, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1013_b2d3, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x1013_b2d5, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_b2d8, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
        ...
        l_0x1013_b2e4:
            ...
            ii(0x1013_b2f1, 3); mov(eax, memd[ds, eax + 0x2]);          /* mov eax, [eax+0x2] */
