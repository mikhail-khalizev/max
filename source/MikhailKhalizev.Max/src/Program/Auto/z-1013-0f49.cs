...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_0f49()
        {
            ...
            ii(0x1013_0f60, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1013_0f63, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1013_0f66, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_0f69, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1013_0f6c, 7); mov(memb[ds, 0x101b_b48e], 1);          /* mov byte [0x101bb48e], 0x1 */
            ii(0x1013_0f73, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_0f76, 5); call(0x1012_f003, -0x1f78);             /* call 0x1012f003 */
            ii(0x1013_0f7b, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_0f7e, 4); cmp(memb[ds, eax + 23], 0);             /* cmp byte [eax+0x17], 0x0 */
            ii(0x1013_0f82, 2); if(jz(0x1013_0f8d, 9)) goto l_0x1013_0f8d; /* jz 0x10130f8d */
            ii(0x1013_0f84, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_0f87, 4); cmp(memb[ds, eax + 23], 1);             /* cmp byte [eax+0x17], 0x1 */
            ii(0x1013_0f8b, 2); if(jnz(0x1013_0f9a, 0xd)) goto l_0x1013_0f9a; /* jnz 0x10130f9a */
        l_0x1013_0f8d:
            ii(0x1013_0f8d, 5); mov(edx, 1);                            /* mov edx, 0x1 */
            ii(0x1013_0f92, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
