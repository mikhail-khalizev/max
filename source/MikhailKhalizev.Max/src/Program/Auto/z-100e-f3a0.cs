...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_f3a0()
        {
            ...
            ii(0x100e_f3b8, 3); mov(memb[ss, ebp - 0x4], al);           /* mov [ebp-0x4], al */
            ii(0x100e_f3bb, 5); mov(eax, 0x101c_7278);                  /* mov eax, 0x101c7278 */
            ii(0x100e_f3c0, 5); call(0x1013_d08a, 0x4_dcc5);            /* call 0x1013d08a */
            ii(0x100e_f3c5, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ii(0x100e_f3c9, 2); if(jz(0x100e_f3d1, 0x6)) goto l_0x100e_f3d1; /* jz 0x100ef3d1 */
            ii(0x100e_f3cb, 4); cmp(memb[ss, ebp - 0x4], 0x1);          /* cmp byte [ebp-0x4], 0x1 */
            ii(0x100e_f3cf, 2); if(jnz(0x100e_f3d6, 0x5)) goto l_0x100e_f3d6; /* jnz 0x100ef3d6 */
        l_0x100e_f3d1:
        ...
        l_0x100e_f3d6:
            ...
            ii(0x100e_f3f4, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
