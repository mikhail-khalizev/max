...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("b0f2af46-f606-4459-ad8f-a226cb5d8655")]
        public void Method_100e_f3a0()
        {
            ii(0x100e_f3a0, 5); pushd(0x28);                            /* push 0x28 */
            ii(0x100e_f3a5, 5); calld(Definitions.sys_check_available_stack_size, 0x769a8); /* call 0x10165d52 */
            ...
            ii(0x100e_f3c0, 5); calld(0x1013_d08a, 0x4dcc5);            /* call 0x1013d08a */
        ...
        l_0x100e_f3d1:
            ii(0x100e_f3d1, 5); calld(0x1011_7e14, 0x28a3e);            /* call 0x10117e14 */
        l_0x100e_f3d6:
            ii(0x100e_f3d6, 5); mov(eax, 0x101c_7278);                  /* mov eax, 0x101c7278 */
            ii(0x100e_f3db, 5); calld(0x1013_cd6c, 0x4d98c);            /* call 0x1013cd6c */
            ii(0x100e_f3e0, 5); calld(0x1014_8507, 0x59122);            /* call 0x10148507 */
            ii(0x100e_f3e5, 5); calld(/* sys */ 0x1016_66b0, 0x772c6);  /* call 0x101666b0 */
            ii(0x100e_f3ea, 5); calld(/* sys */ 0x1017_1880, 0x82491);  /* call 0x10171880 */
            ii(0x100e_f3ef, 5); calld(0x1010_826e, 0x18e7a);            /* call 0x1010826e */
            ...
            ii(0x100e_f401, 5); mov(eax, 0x101a_201c);                  /* mov eax, 0x101a201c */ /* "%s" */
            ii(0x100e_f406, 1); pushd(eax);                             /* push eax */
            ii(0x100e_f407, 5); calld(Definitions.sys_printf, 0x7d230); /* call 0x1016c63c */
            ii(0x100e_f40c, 3); add(esp, 0x8);                          /* add esp, 0x8 */
            ii(0x100e_f40f, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x100e_f411, 5); calld(Definitions.sys_exit, 0x7d249);   /* call 0x1016c65f */
            ...
            ii(0x100e_f41e, 1); retd(); return;                         /* ret */
        }
    }
}
