...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_30fa()
        {
            ...
            ii(0x1016_3110, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1016_3113, 3);  mov(memd[ss, ebp - 8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1016_3116, 3);  mov(memd[ss, ebp - 4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1016_3119, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x1016_312c, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1016_312f, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1016_3132, 4);  mov(ax, memw[ds, eax + 8]);           /* mov ax, [eax+0x8] */
            ii(0x1016_3136, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1016_3139, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1016_313c, 5);  call(0x1007_611c, -0xe_d025);         /* call 0x1007611c */
            ii(0x1016_3141, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1016_3143, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x1016_3146, 5);  call(0x1007_66ac, -0xe_ca9f);         /* call 0x100766ac */
            ii(0x1016_314b, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ...
            ii(0x1016_315a, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x1016_3166, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x1016_317a, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x1016_317d, 5);  call(0x1007_6574, -0xe_cc0e);         /* call 0x10076574 */
            ii(0x1016_3182, 5);  call(0x1015_0a9e, -0x1_26e9);         /* call 0x10150a9e */
            ii(0x1016_3187, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
        l_0x1016_318a:
            ii(0x1016_318a, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ...
            ii(0x1016_319a, 4);  movsx(edx, memw[ss, ebp - 16]);       /* movsx edx, word [ebp-0x10] */
            ii(0x1016_319e, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1016_31a1, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ...
            ii(0x1016_31b1, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
        ...
        l_0x1016_31b6:
            ...
            ii(0x1016_31db, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1016_31de, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ii(0x1016_31e1, 2);  xor(ah, ah);                          /* xor ah, ah */
            ii(0x1016_31e3, 3);  movsx(edx, ax);                       /* movsx edx, ax */
            ii(0x1016_31e6, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1016_31ea, 5);  call(0x1007_02b9, -0xf_2f36);         /* call 0x100702b9 */
            ii(0x1016_31ef, 1);  cwde();                               /* cwde */
            ii(0x1016_31f0, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1016_31f3, 2);  jmp(0x1016_31fc, 7); goto l_0x1016_31fc;/* jmp 0x101631fc */
        l_0x1016_31f5:
            ii(0x1016_31f5, 7);  mov(memd[ss, ebp - 28], 0);           /* mov dword [ebp-0x1c], 0x0 */
        l_0x1016_31fc:
            ...
            ii(0x1016_3205, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ...
            ii(0x1016_3214, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x1016_3229, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        ...
        l_0x1016_323d:
            ii(0x1016_323d, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x1016_3240, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x1016_3243, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1016_3245, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        ...
        //  ii(0x1016_3251, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        //  ii(0x1016_3254, 5);  call(0x1007_5f2c, -0xe_d32d);         /* call 0x10075f2c */
        l_0x1016_3259:
            ii(0x1016_3259, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
