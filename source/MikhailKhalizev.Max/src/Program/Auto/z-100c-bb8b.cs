...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_bb8b()
        {
            ...
            ii(0x100c_bba3, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_bba6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_bba9, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100c_bbac, 5); call(0x1007_6574, -0x5_563d);           /* call 0x10076574 */
            ii(0x100c_bbb1, 5); cmp(memw[ds, eax + 0x8], 0x42);         /* cmp word [eax+0x8], 0x42 */
            ii(0x100c_bbb6, 2); if(jz(0x100c_bbca, 0x12)) goto l_0x100c_bbca; /* jz 0x100cbbca */
            ii(0x100c_bbb8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_bbbb, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100c_bbbe, 5); call(0x1007_6574, -0x5_564f);           /* call 0x10076574 */
            ii(0x100c_bbc3, 5); cmp(memw[ds, eax + 0x8], 0x43);         /* cmp word [eax+0x8], 0x43 */
            ii(0x100c_bbc8, 2); if(jnz(0x100c_bbd3, 0x9)) goto l_0x100c_bbd3; /* jnz 0x100cbbd3 */
        l_0x100c_bbca:
            ii(0x100c_bbca, 7); mov(memd[ss, ebp - 0x8], 0x3);          /* mov dword [ebp-0x8], 0x3 */
            ii(0x100c_bbd1, 2); jmp(0x100c_bc28, 0x55); goto l_0x100c_bc28; /* jmp 0x100cbc28 */
        l_0x100c_bbd3:
            ii(0x100c_bbd3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_bbd6, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100c_bbd9, 5); call(0x1007_6574, -0x5_566a);           /* call 0x10076574 */
            ii(0x100c_bbde, 4); test(memb[ds, eax + 0x13], 0x1);        /* test byte [eax+0x13], 0x1 */
            ii(0x100c_bbe2, 2); if(jz(0x100c_bbed, 0x9)) goto l_0x100c_bbed; /* jz 0x100cbbed */
            ii(0x100c_bbe4, 7); mov(memd[ss, ebp - 0x8], 0x9);          /* mov dword [ebp-0x8], 0x9 */
            ii(0x100c_bbeb, 2); jmp(0x100c_bc28, 0x3b); goto l_0x100c_bc28; /* jmp 0x100cbc28 */
        l_0x100c_bbed:
            ii(0x100c_bbed, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_bbf0, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100c_bbf3, 5); call(0x1007_6574, -0x5_5684);           /* call 0x10076574 */
            ii(0x100c_bbf8, 4); test(memb[ds, eax + 0x12], 0x40);       /* test byte [eax+0x12], 0x40 */
            ii(0x100c_bbfc, 2); if(jz(0x100c_bc07, 0x9)) goto l_0x100c_bc07; /* jz 0x100cbc07 */
            ii(0x100c_bbfe, 7); mov(memd[ss, ebp - 0x8], 0xa);          /* mov dword [ebp-0x8], 0xa */
            ii(0x100c_bc05, 2); jmp(0x100c_bc28, 0x21); goto l_0x100c_bc28; /* jmp 0x100cbc28 */
        l_0x100c_bc07:
            ii(0x100c_bc07, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_bc0a, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100c_bc0d, 5); call(0x1007_6574, -0x5_569e);           /* call 0x10076574 */
            ii(0x100c_bc12, 4); test(memb[ds, eax + 0x12], 0x80);       /* test byte [eax+0x12], 0x80 */
            ii(0x100c_bc16, 2); if(jz(0x100c_bc21, 0x9)) goto l_0x100c_bc21; /* jz 0x100cbc21 */
            ii(0x100c_bc18, 7); mov(memd[ss, ebp - 0x8], 0xb);          /* mov dword [ebp-0x8], 0xb */
            ii(0x100c_bc1f, 2); jmp(0x100c_bc28, 0x7); goto l_0x100c_bc28; /* jmp 0x100cbc28 */
        l_0x100c_bc21:
            ii(0x100c_bc21, 7); mov(memd[ss, ebp - 0x8], 0xffff_ffff);  /* mov dword [ebp-0x8], 0xffffffff */
        l_0x100c_bc28:
            ii(0x100c_bc28, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
