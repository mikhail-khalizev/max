...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_1e00()
        {
            ...
            ii(0x1011_1e1f, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1011_1e22, 4);  mov(memb[ss, ebp - 4], 1);            /* mov byte [ebp-0x4], 0x1 */
            ii(0x1011_1e26, 7);  mov(memd[ss, ebp - 8], 1);            /* mov dword [ebp-0x8], 0x1 */
        ...
        l_0x1011_1e71:
            ii(0x1011_1e71, 4);  mov(memb[ss, ebp - 24], 0);           /* mov byte [ebp-0x18], 0x0 */
            ii(0x1011_1e75, 5);  call(0x1014_82f4, 0x3_647a);          /* call 0x101482f4 */
            ii(0x1011_1e7a, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1011_1e7d, 7);  mov(memb[ds, 0x101c_391e], 3);        /* mov byte [0x101c391e], 0x3 */
            ...
            ii(0x1011_1e9c, 3);  mov(al, memb[ss, ebp - 4]);           /* mov al, [ebp-0x4] */
            ii(0x1011_1e9f, 3);  movsx(ecx, ax);                       /* movsx ecx, ax */
            ii(0x1011_1ea2, 5);  mov(ebx, 0x280);                      /* mov ebx, 0x280 */
            ii(0x1011_1ea7, 3);  mov(edx, memd[ss, ebp - 20]);         /* mov edx, [ebp-0x14] */
            ...
            ii(0x1011_1eb9, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ...
            ii(0x1011_1ecc, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1011_1ecf, 5);  call(0x1010_c693, -0x5841);           /* call 0x1010c693 */
            ii(0x1011_1ed4, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ...
            ii(0x1011_1ee4, 5);  mov(edx, 8);                          /* mov edx, 0x8 */
            ...
            ii(0x1011_1f28, 4);  mov(memb[ss, ebp - 32], 0);           /* mov byte [ebp-0x20], 0x0 */
        l_0x1011_1f2c:
            ii(0x1011_1f2c, 2);  xor(eax, eax);                        /* xor eax, eax */
            ii(0x1011_1f2e, 3);  mov(al, memb[ss, ebp - 32]);          /* mov al, [ebp-0x20] */
            ii(0x1011_1f31, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x1011_1f33, 6);  if(jnz(0x1011_2201, 0x2c8)) goto l_0x1011_2201;/* jnz 0x10112201 */
            ii(0x1011_1f39, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ...
            ii(0x1011_1f48, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_1f4b, 3);  mov(memd[ss, ebp - 36], eax);         /* mov [ebp-0x24], eax */
            ii(0x1011_1f4e, 5);  call(0x1010_9b8a, -0x83c9);           /* call 0x10109b8a */
        l_0x1011_1f53:
            ii(0x1011_1f53, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1011_1f57, 5);  call(0x1011_1b8c, -0x3d0);            /* call 0x10111b8c */
            ii(0x1011_1f5c, 3);  mov(memb[ss, ebp - 4], al);           /* mov [ebp-0x4], al */
            ii(0x1011_1f5f, 3);  inc(memd[ss, ebp - 8]);               /* inc dword [ebp-0x8] */
            ii(0x1011_1f62, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1011_1f66, 3);  cmp(eax, 0xa);                        /* cmp eax, 0xa */
            ii(0x1011_1f69, 2);  if(jle(0x1011_1f72, 7)) goto l_0x1011_1f72;/* jle 0x10111f72 */
            ii(0x1011_1f6b, 7);  mov(memd[ss, ebp - 8], 1);            /* mov dword [ebp-0x8], 0x1 */
        l_0x1011_1f72:
            ii(0x1011_1f72, 2);  xor(eax, eax);                        /* xor eax, eax */
            ii(0x1011_1f74, 3);  mov(al, memb[ss, ebp - 4]);           /* mov al, [ebp-0x4] */
            ii(0x1011_1f77, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x1011_1f79, 2);  if(jnz(0x1011_1f84, 9)) goto l_0x1011_1f84;/* jnz 0x10111f84 */
            ii(0x1011_1f7b, 3);  mov(eax, memd[ss, ebp - 36]);         /* mov eax, [ebp-0x24] */
            ii(0x1011_1f7e, 4);  cmp(ax, memw[ss, ebp - 8]);           /* cmp ax, [ebp-0x8] */
            ii(0x1011_1f82, 2);  if(jnz(0x1011_1f86, 2)) goto l_0x1011_1f86;/* jnz 0x10111f86 */
        l_0x1011_1f84:
            ii(0x1011_1f84, 2);  jmp(0x1011_1f88, 2); goto l_0x1011_1f88;/* jmp 0x10111f88 */
        l_0x1011_1f86:
        ...
        l_0x1011_1f8d:
            ...
            ii(0x1011_1f92, 3);  mov(memd[ss, ebp - 40], eax);         /* mov [ebp-0x28], eax */
            ii(0x1011_1f95, 3);  lea(edx, memd[ss, ebp - 44]);         /* lea edx, [ebp-0x2c] */
            ii(0x1011_1f98, 3);  lea(eax, memd[ss, ebp - 48]);         /* lea eax, [ebp-0x30] */
            ii(0x1011_1f9b, 5);  call(/* sys */ 0x1016_c298, 0x5_a2f8);/* call 0x1016c298 */
            ii(0x1011_1fa0, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ii(0x1011_1fa4, 3);  cmp(eax, -1 /* 0xff */);              /* cmp eax, 0xffffffff */
            ii(0x1011_1fa7, 2);  if(jnz(0x1011_1fb1, 8)) goto l_0x1011_1fb1;/* jnz 0x10111fb1 */
            ii(0x1011_1fa9, 3);  mov(eax, memd[ss, ebp - 48]);         /* mov eax, [ebp-0x30] */
            ii(0x1011_1fac, 3);  cmp(eax, memd[ss, ebp - 16]);         /* cmp eax, [ebp-0x10] */
            ii(0x1011_1faf, 2);  if(jz(0x1011_1fb3, 2)) goto l_0x1011_1fb3;/* jz 0x10111fb3 */
        l_0x1011_1fb1:
            ii(0x1011_1fb1, 2);  jmp(0x1011_1fbb, 8); goto l_0x1011_1fbb;/* jmp 0x10111fbb */
        l_0x1011_1fb3:
            ii(0x1011_1fb3, 3);  mov(eax, memd[ss, ebp - 44]);         /* mov eax, [ebp-0x2c] */
            ii(0x1011_1fb6, 3);  cmp(eax, memd[ss, ebp - 12]);         /* cmp eax, [ebp-0xc] */
        ...
        l_0x1011_1fbb:
            ...
            ii(0x1011_1fc0, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1011_1fc3, 3);  mov(eax, memd[ss, ebp - 48]);         /* mov eax, [ebp-0x30] */
            ii(0x1011_1fc6, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1011_1fc9, 3);  mov(eax, memd[ss, ebp - 44]);         /* mov eax, [ebp-0x2c] */
            ii(0x1011_1fcc, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
        l_0x1011_1fcf:
            ii(0x1011_1fcf, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ii(0x1011_1fd3, 5);  call(Definitions.sys_tolower, 0x6_0abd);/* call 0x10172a95 */
            ii(0x1011_1fd8, 3);  mov(memd[ss, ebp - 40], eax);         /* mov [ebp-0x28], eax */
            ii(0x1011_1fdb, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ii(0x1011_1fdf, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x1011_1fe1, 2);  if(jle(0x1011_1fee, 0xb)) goto l_0x1011_1fee;/* jle 0x10111fee */
            ii(0x1011_1fe3, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ii(0x1011_1fe7, 5);  cmp(eax, 0x7000);                     /* cmp eax, 0x7000 */
            ii(0x1011_1fec, 2);  if(jl(0x1011_1ff0, 2)) goto l_0x1011_1ff0;/* jl 0x10111ff0 */
        l_0x1011_1fee:
            ii(0x1011_1fee, 2);  jmp(0x1011_1ff4, 4); goto l_0x1011_1ff4;/* jmp 0x10111ff4 */
        l_0x1011_1ff0:
            ii(0x1011_1ff0, 4);  mov(memb[ss, ebp - 24], 0);           /* mov byte [ebp-0x18], 0x0 */
        l_0x1011_1ff4:
            ii(0x1011_1ff4, 3);  mov(eax, memd[ss, ebp - 40]);         /* mov eax, [ebp-0x28] */
            ii(0x1011_1ff7, 3);  mov(memd[ss, ebp - 52], eax);         /* mov [ebp-0x34], eax */
        ...
        l_0x1011_1fff:
            ...
            ii(0x1011_2009, 3);  mov(memb[ss, ebp - 4], al);           /* mov [ebp-0x4], al */
            ii(0x1011_200c, 4);  cmp(memb[ss, ebp - 4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ii(0x1011_2010, 2);  if(jz(0x1011_201b, 9)) goto l_0x1011_201b;/* jz 0x1011201b */
            ii(0x1011_2012, 9);  mov(memw[ds, 0x101c_4e4e], 0xffff);   /* mov word [0x101c4e4e], 0xffff */
        l_0x1011_201b:
            ii(0x1011_201b, 4);  mov(memb[ss, ebp - 32], 1);           /* mov byte [ebp-0x20], 0x1 */
            ii(0x1011_201f, 5);  jmp(0x1011_21fc, 0x1d8); goto l_0x1011_21fc;/* jmp 0x101121fc */
        l_0x1011_2024:
            ii(0x1011_2024, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ii(0x1011_2028, 3);  cmp(eax, 0xc);                        /* cmp eax, 0xc */
            ii(0x1011_202b, 2);  if(jnz(0x1011_2033, 6)) goto l_0x1011_2033;/* jnz 0x10112033 */
            ii(0x1011_202d, 4);  mov(memb[ss, ebp - 56], 1);           /* mov byte [ebp-0x38], 0x1 */
            ii(0x1011_2031, 2);  jmp(0x1011_2037, 4); goto l_0x1011_2037;/* jmp 0x10112037 */
        l_0x1011_2033:
            ii(0x1011_2033, 4);  mov(memb[ss, ebp - 56], 0);           /* mov byte [ebp-0x38], 0x0 */
        l_0x1011_2037:
            ii(0x1011_2037, 3);  mov(al, memb[ss, ebp - 56]);          /* mov al, [ebp-0x38] */
            ii(0x1011_203a, 3);  mov(memb[ss, ebp - 60], al);          /* mov [ebp-0x3c], al */
            ii(0x1011_203d, 5);  call(0x1010_9b8a, -0x84b8);           /* call 0x10109b8a */
            ii(0x1011_2042, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1011_2044, 3);  mov(dl, memb[ss, ebp - 60]);          /* mov dl, [ebp-0x3c] */
            ii(0x1011_2047, 2);  xor(eax, eax);                        /* xor eax, eax */
            ii(0x1011_2049, 5);  call(0x1013_843f, 0x2_63f1);          /* call 0x1013843f */
            ii(0x1011_204e, 3);  mov(memd[ss, ebp - 40], eax);         /* mov [ebp-0x28], eax */
            ii(0x1011_2051, 5);  cmp(memw[ss, ebp - 40], 0);           /* cmp word [ebp-0x28], 0x0 */
            ii(0x1011_2056, 2);  if(jz(0x1011_208e, 0x36)) goto l_0x1011_208e;/* jz 0x1011208e */
            ii(0x1011_2058, 4);  cmp(memb[ss, ebp - 60], 0);           /* cmp byte [ebp-0x3c], 0x0 */
            ii(0x1011_205c, 2);  if(jz(0x1011_206d, 0xf)) goto l_0x1011_206d;/* jz 0x1011206d */
            ii(0x1011_205e, 5);  mov(edx, 7);                          /* mov edx, 0x7 */
            ii(0x1011_2063, 5);  mov(eax, 0x3e);                       /* mov eax, 0x3e */
            ii(0x1011_2068, 5);  call(0x100c_aafc, -0x4_7571);         /* call 0x100caafc */
        l_0x1011_206d:
            ii(0x1011_206d, 4);  movsx(edx, memw[ss, ebp - 40]);       /* movsx edx, word [ebp-0x28] */
        ...
        l_0x1011_208e:
            ii(0x1011_208e, 4);  mov(memb[ss, ebp - 4], 1);            /* mov byte [ebp-0x4], 0x1 */
            ii(0x1011_2092, 4);  mov(memb[ss, ebp - 32], 1);           /* mov byte [ebp-0x20], 0x1 */
        ...
        l_0x1011_209b:
            ...
            ii(0x1011_20a5, 3);  mov(memb[ss, ebp - 4], al);           /* mov [ebp-0x4], al */
            ii(0x1011_20a8, 4);  cmp(memb[ss, ebp - 4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ii(0x1011_20ac, 2);  if(jz(0x1011_20b7, 9)) goto l_0x1011_20b7;/* jz 0x101120b7 */
            ii(0x1011_20ae, 9);  mov(memw[ds, 0x101c_4e4e], 0xffff);   /* mov word [0x101c4e4e], 0xffff */
        l_0x1011_20b7:
            ii(0x1011_20b7, 4);  mov(memb[ss, ebp - 32], 1);           /* mov byte [ebp-0x20], 0x1 */
        ...
        l_0x1011_20c0:
            ...
            ii(0x1011_20d4, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
        ...
        l_0x1011_20dc:
            ...
            ii(0x1011_20eb, 4);  mov(memb[ss, ebp - 4], 1);            /* mov byte [ebp-0x4], 0x1 */
            ii(0x1011_20ef, 4);  mov(memb[ss, ebp - 32], 1);           /* mov byte [ebp-0x20], 0x1 */
        ...
        l_0x1011_20f8:
            ...
            ii(0x1011_2102, 4);  mov(memb[ss, ebp - 4], 1);            /* mov byte [ebp-0x4], 0x1 */
            ii(0x1011_2106, 4);  mov(memb[ss, ebp - 32], 1);           /* mov byte [ebp-0x20], 0x1 */
        ...
        l_0x1011_210f:
            ...
            ii(0x1011_2114, 5);  mov(eax, 1);                          /* mov eax, 0x1 */
            ii(0x1011_2119, 5);  call(0x100e_f3a0, -0x2_2d7e);         /* call 0x100ef3a0 */
        l_0x1011_211e:
            ii(0x1011_211e, 5);  mov(ebx, 1);                          /* mov ebx, 0x1 */
            ii(0x1011_2123, 5);  mov(edx, 0xffff_ffff);                /* mov edx, 0xffffffff */
            ii(0x1011_2128, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
        ...
        l_0x1011_2135:
            ii(0x1011_2135, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ii(0x1011_2139, 5);  cmp(eax, 0x7000);                     /* cmp eax, 0x7000 */
            ii(0x1011_213e, 2);  if(jl(0x1011_216e, 0x2e)) goto l_0x1011_216e;/* jl 0x1011216e */
            ii(0x1011_2140, 7);  add(memd[ss, ebp - 40], 0xffff_9000); /* add dword [ebp-0x28], 0xffff9000 */
            ii(0x1011_2147, 4);  cmp(memb[ss, ebp - 24], 0);           /* cmp byte [ebp-0x18], 0x0 */
            ii(0x1011_214b, 2);  if(jnz(0x1011_2156, 9)) goto l_0x1011_2156;/* jnz 0x10112156 */
            ii(0x1011_214d, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ii(0x1011_2151, 3);  cmp(eax, 8);                          /* cmp eax, 0x8 */
            ii(0x1011_2154, 2);  if(jb(0x1011_2158, 2)) goto l_0x1011_2158;/* jb 0x10112158 */
        l_0x1011_2156:
            ii(0x1011_2156, 2);  jmp(0x1011_216a, 0x12); goto l_0x1011_216a;/* jmp 0x1011216a */
        l_0x1011_2158:
            ii(0x1011_2158, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
        ...
        l_0x1011_216a:
            ii(0x1011_216a, 4);  mov(memb[ss, ebp - 24], 1);           /* mov byte [ebp-0x18], 0x1 */
        l_0x1011_216e:
            ii(0x1011_216e, 5);  jmp(0x1011_21fc, 0x89); goto l_0x1011_21fc;/* jmp 0x101121fc */
        l_0x1011_2173:
            ii(0x1011_2173, 3);  mov(eax, memd[ss, ebp - 52]);         /* mov eax, [ebp-0x34] */
            ii(0x1011_2176, 3);  mov(memd[ss, ebp - 64], eax);         /* mov [ebp-0x40], eax */
            ii(0x1011_2179, 5);  cmp(memw[ss, ebp - 64], 0x4c);        /* cmp word [ebp-0x40], 0x4c */
            ii(0x1011_217e, 2);  if(jb(0x1011_21ca, 0x4a)) goto l_0x1011_21ca;/* jb 0x101121ca */
            ii(0x1011_2180, 5);  cmp(memw[ss, ebp - 64], 0x4c);        /* cmp word [ebp-0x40], 0x4c */
            ii(0x1011_2185, 6);  if(jbe(0x1011_2024, -0x167)) goto l_0x1011_2024;/* jbe 0x10112024 */
            ii(0x1011_218b, 5);  cmp(memw[ss, ebp - 64], 0x4e);        /* cmp word [ebp-0x40], 0x4e */
            ii(0x1011_2190, 2);  if(jb(0x1011_21c5, 0x33)) goto l_0x1011_21c5;/* jb 0x101121c5 */
            ii(0x1011_2192, 5);  cmp(memw[ss, ebp - 64], 0x4e);        /* cmp word [ebp-0x40], 0x4e */
            ii(0x1011_2197, 6);  if(jbe(0x1011_1fff, -0x19e)) goto l_0x1011_1fff;/* jbe 0x10111fff */
            ii(0x1011_219d, 5);  cmp(memw[ss, ebp - 64], 0x53);        /* cmp word [ebp-0x40], 0x53 */
            ii(0x1011_21a2, 2);  if(jb(0x1011_21c0, 0x1c)) goto l_0x1011_21c0;/* jb 0x101121c0 */
            ii(0x1011_21a4, 5);  cmp(memw[ss, ebp - 64], 0x53);        /* cmp word [ebp-0x40], 0x53 */
            ii(0x1011_21a9, 6);  if(jbe(0x1011_20c0, -0xef)) goto l_0x1011_20c0;/* jbe 0x101120c0 */
            ii(0x1011_21af, 6);  cmp(memw[ss, ebp - 64], 0x148);       /* cmp word [ebp-0x40], 0x148 */
        ...
        l_0x1011_21ca:
            ii(0x1011_21ca, 5);  cmp(memw[ss, ebp - 64], 0x45);        /* cmp word [ebp-0x40], 0x45 */
            ii(0x1011_21cf, 2);  if(jb(0x1011_21ec, 0x1b)) goto l_0x1011_21ec;/* jb 0x101121ec */
            ii(0x1011_21d1, 5);  cmp(memw[ss, ebp - 64], 0x45);        /* cmp word [ebp-0x40], 0x45 */
            ii(0x1011_21d6, 6);  if(jbe(0x1011_210f, -0xcd)) goto l_0x1011_210f;/* jbe 0x1011210f */
            ii(0x1011_21dc, 5);  cmp(memw[ss, ebp - 64], 0x49);        /* cmp word [ebp-0x40], 0x49 */
        ...
        l_0x1011_21ec:
            ii(0x1011_21ec, 5);  cmp(memw[ss, ebp - 64], 0x43);        /* cmp word [ebp-0x40], 0x43 */
