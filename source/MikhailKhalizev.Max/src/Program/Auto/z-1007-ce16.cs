...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_ce16()
        {
            ...
            ii(0x1007_ce2e, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_ce31, 5); mov(ebx, 0x1007_cf16);                  /* mov ebx, 0x1007cf16 */
            ii(0x1007_ce36, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_ce39, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_ce49, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x1007_ce4c, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
