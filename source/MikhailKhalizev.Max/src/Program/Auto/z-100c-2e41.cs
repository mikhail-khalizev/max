...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_2e41()
        {
            ...
            ii(0x100c_2e58, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_2e5b, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100c_2e5e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_2e6b, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ii(0x100c_2e6e, 3); mov(ebx, memd[ds, ebx + 0x1a]);         /* mov ebx, [ebx+0x1a] */
            ii(0x100c_2e71, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100c_2e74, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_2e85, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_2eb2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_2ede, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_2f0a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_2f36, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_2f39, 5); call(0x100c_2d1f, -0x21f);              /* call 0x100c2d1f */
            ii(0x100c_2f3e, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100c_2f40, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_2f75, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_2f8c, 2); jmp(0x100c_2f94, 0x6); goto l_0x100c_2f94; /* jmp 0x100c2f94 */
        l_0x100c_2f8e:
        ...
        l_0x100c_2f94:
            ...
            ii(0x100c_2f97, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_2f9a, 3); add(eax, 0x21);                         /* add eax, 0x21 */
            ii(0x100c_2f9d, 5); call(0x1008_afe4, -0x3_7fbe);           /* call 0x1008afe4 */
            ii(0x100c_2fa2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
