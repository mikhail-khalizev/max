...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_7449()
        {
            ...
            ii(0x1008_7461, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_7464, 4); mov(memb[ss, ebp - 0x8], 0x2a);         /* mov byte [ebp-0x8], 0x2a */
            ii(0x1008_7468, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
