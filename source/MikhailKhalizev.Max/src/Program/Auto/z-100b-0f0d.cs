...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_0f0d()
        {
            ...
            ii(0x100b_0f46, 3); mov(eax, memd[ds, eax + 80]);           /* mov eax, [eax+0x50] */
        ...
        l_0x100b_0f55:
            ...
            ii(0x100b_0f5f, 3); lea(ebx, memd[ss, ebp - 12]);           /* lea ebx, [ebp-0xc] */
        ...
        l_0x100b_0f6d:
            ii(0x100b_0f6d, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x100b_0f70, 5); call(0x1007_6bf8, -0x3_a37d);           /* call 0x10076bf8 */
        l_0x100b_0f75:
            ii(0x100b_0f75, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_0f77, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ...
            ii(0x100b_0f87, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x100b_0f8a, 5); call(0x1007_63a0, -0x3_abef);           /* call 0x100763a0 */
            ii(0x100b_0f8f, 4); cmp(memb[ds, eax + 61], 0x10);          /* cmp byte [eax+0x3d], 0x10 */
            ...
            ii(0x100b_0f9b, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
        ...
        l_0x100b_0fb3:
            ii(0x100b_0fb3, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x100b_0fb6, 5); call(0x1007_63a0, -0x3_ac1b);           /* call 0x100763a0 */
            ii(0x100b_0fbb, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_0fbd, 3); mov(dl, memb[ds, eax + 38]);            /* mov dl, [eax+0x26] */
        ...
        l_0x100b_0fd2:
            ii(0x100b_0fd2, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ...
            ii(0x100b_0fe3, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x100b_0fe6, 5); call(0x1007_63a0, -0x3_ac4b);           /* call 0x100763a0 */
            ii(0x100b_0feb, 5); call(0x1015_26ac, 0xa_16bc);            /* call 0x101526ac */
            ii(0x100b_0ff0, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x100b_0ff3, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100b_0ff6, 3); mov(edx, memd[ds, eax + 2]);            /* mov edx, [eax+0x2] */
            ii(0x100b_0ff9, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100b_0ffc, 3); call_abs(memd[ds, edx + 32]);           /* call dword [edx+0x20] */
        ...
        l_0x100b_1003:
            ...
            ii(0x100b_100d, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x100b_1010, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x100b_1013, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x100b_1016, 4); cmp(memd[ss, ebp - 24], 0);             /* cmp dword [ebp-0x18], 0x0 */
            ...
            ii(0x100b_1021, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x100b_1024, 5); call(0x1007_63d4, -0x3_ac55);           /* call 0x100763d4 */
            ii(0x100b_1029, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100b_102b, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x100b_102e, 5); call(0x100a_c45d, -0x4bd6);             /* call 0x100ac45d */
            ii(0x100b_1033, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x100b_1036, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x100b_1039, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
            ii(0x100b_103c, 2); jmp(0x100b_1044, 6); goto l_0x100b_1044; /* jmp 0x100b1044 */
        l_0x100b_103e:
            ii(0x100b_103e, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x100b_1041, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
        l_0x100b_1044:
            ii(0x100b_1044, 3); mov(edx, memd[ss, ebp - 32]);           /* mov edx, [ebp-0x20] */
            ii(0x100b_1047, 5); mov(eax, 0x101c_3180);                  /* mov eax, 0x101c3180 */
            ii(0x100b_104c, 5); call(0x100a_4d50, -0xc301);             /* call 0x100a4d50 */
        l_0x100b_1051:
            ii(0x100b_1051, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x100b_1054, 5); call(0x1007_63a0, -0x3_acb9);           /* call 0x100763a0 */
            ii(0x100b_1059, 5); call(0x1015_26ac, 0xa_164e);            /* call 0x101526ac */
            ii(0x100b_105e, 3); mov(memd[ss, ebp - 36], eax);           /* mov [ebp-0x24], eax */
            ii(0x100b_1061, 3); mov(eax, memd[ss, ebp - 36]);           /* mov eax, [ebp-0x24] */
            ii(0x100b_1064, 3); mov(edx, memd[ds, eax + 2]);            /* mov edx, [eax+0x2] */
            ii(0x100b_1067, 3); mov(eax, memd[ss, ebp - 36]);           /* mov eax, [ebp-0x24] */
            ii(0x100b_106a, 3); call_abs(memd[ds, edx + 32]);           /* call dword [edx+0x20] */
            ii(0x100b_106d, 2); cmp(al, 0x17);                          /* cmp al, 0x17 */
            ii(0x100b_106f, 2); if(jnz(0x100b_107a, 9)) goto l_0x100b_107a; /* jnz 0x100b107a */
            ii(0x100b_1071, 7); mov(memd[ss, ebp - 40], 0);             /* mov dword [ebp-0x28], 0x0 */
        ...
        l_0x100b_107a:
            ...
            ii(0x100b_1090, 3); mov(memd[ss, ebp - 40], eax);           /* mov [ebp-0x28], eax */
        l_0x100b_1093:
            ii(0x100b_1093, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
        ...
        l_0x100b_10d6:
            ...
            ii(0x100b_10d8, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
