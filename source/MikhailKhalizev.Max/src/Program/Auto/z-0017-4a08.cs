...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x17_4a08, 4); enter(0x4, 0);                            /* enter 0x4, 0x0 */
            ii(0x17_4a0c, 1); push(ds);                                 /* push ds */
            ii(0x17_4a0d, 3); mov(ax, 0x3e68);                          /* mov ax, 0x3e68 */
            ii(0x17_4a10, 2); mov(ds, ax);                              /* mov ds, ax */
            ii(0x17_4a12, 3); mov(dl, memb[ss, bp + 0x6]);              /* mov dl, [bp+0x6] */
            ii(0x17_4a15, 2); mov(ah, 0x36);                            /* mov ah, 0x36 */
            ii(0x17_4a17, 4); call_far_ind(ds, 0x1fe0);                 /* call far word [0x1fe0] */
            ii(0x17_4a1b, 3); cmp(ax, 0xffff);                          /* cmp ax, 0xffff */
            ii(0x17_4a1e, 2); if(jz(0x17_4a26, 0x6)) goto l_0x17_4a26;  /* jz 0x4a26 */
            ii(0x17_4a20, 2); mul(cx);                                  /* mul cx */
            ii(0x17_4a22, 2); mul(bx);                                  /* mul bx */
            ii(0x17_4a24, 2); jmp(0x17_4a2b, 0x5); goto l_0x17_4a2b;    /* jmp 0x4a2b */
        l_0x17_4a26:
            ii(0x17_4a26, 3); mov(ax, 0);                               /* mov ax, 0x0 */
            ii(0x17_4a29, 2); mov(dx, ax);                              /* mov dx, ax */
        l_0x17_4a2b:
            ii(0x17_4a2b, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_4a2e, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x17_4a31, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0x17_4a34, 3); mov(dx, memw[ss, bp - 0x2]);              /* mov dx, [bp-0x2] */
