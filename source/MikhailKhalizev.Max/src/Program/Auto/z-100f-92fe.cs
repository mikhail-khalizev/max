...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("a3ea7bc9-b686-4248-beef-02df204d0442")]
        public void Method_100f_92fe()
        {
            ii(0x100f_92fe, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x100f_9303, 5); calld(Definitions.sys_check_available_stack_size, 0x6ca4a); /* call 0x10165d52 */
        ...
        l_0x100f_9395:
            ...
            ii(0x100f_939d, 1); retd(); return;                         /* ret */
        }
    }
}
