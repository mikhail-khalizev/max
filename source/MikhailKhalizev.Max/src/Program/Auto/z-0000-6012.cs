...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_6012()
        {
            ...
            ii(0x6022, 4);    mov(si, memw[es, bx + 0x2]);              /* mov si, [es:bx+0x2] */
            ii(0x6026, 2);    jmp(0x6029, 0x1); goto l_0x6029;          /* jmp 0x6029 */
        l_0x6028:
            ii(0x6028, 1);    dec(si);                                  /* dec si */
        l_0x6029:
            ii(0x6029, 3);    cmp(si, 0x10);                            /* cmp si, 0x10 */
            ii(0x602c, 2);    if(jl(0x6045, 0x17)) goto l_0x6045;       /* jl 0x6045 */
            ii(0x602e, 3);    mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
            ...
            ii(0x6043, 2);    jmp(0x6047, 0x2); goto l_0x6047;          /* jmp 0x6047 */
        l_0x6045:
