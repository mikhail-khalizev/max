...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_cb2c()
        {
            ...
            ii(0x100a_cb44, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_cb47, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_cb57, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100a_cb5a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_cb6a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_cb80, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_cb83, 5); call(0x100a_2a04, -0xa184);             /* call 0x100a2a04 */
        l_0x100a_cb88:
            ii(0x100a_cb88, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_cb8b, 5); cmp(memw[ds, eax + 0x26], -0x1 /* 0xff */); /* cmp word [eax+0x26], 0xffff */
            ii(0x100a_cb90, 2); if(jnz(0x100a_cba3, 0x11)) goto l_0x100a_cba3; /* jnz 0x100acba3 */
            ii(0x100a_cb92, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_cba1, 2); if(jnz(0x100a_cba5, 0x2)) goto l_0x100a_cba5; /* jnz 0x100acba5 */
        l_0x100a_cba3:
            ii(0x100a_cba3, 2); jmp(0x100a_cbb2, 0xd); goto l_0x100a_cbb2; /* jmp 0x100acbb2 */
        l_0x100a_cba5:
            ii(0x100a_cba5, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x100a_cbaa, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_cbad, 5); call(0x100a_cbbb, 0x9);                 /* call 0x100acbbb */
        l_0x100a_cbb2:
