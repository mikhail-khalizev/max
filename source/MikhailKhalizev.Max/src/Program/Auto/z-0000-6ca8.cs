...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x6ccc:
            ...
            ii(0x6cd7, 3);    mov(memw[ss, bp + 22], cx);               /* mov [bp+0x16], cx */
            ii(0x6cda, 3);    mov(memw[ss, bp + 20], ax);               /* mov [bp+0x14], ax */
