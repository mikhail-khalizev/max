...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_36ad()
        {
            ...
            ii(0x1008_36c5, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_36c8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_36cb, 4); cmp(memb[ds, eax + 0x15], 0x2);         /* cmp byte [eax+0x15], 0x2 */
            ii(0x1008_36cf, 2); if(jle(0x1008_36da, 0x9)) goto l_0x1008_36da; /* jle 0x100836da */
            ii(0x1008_36d1, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x1008_36d5, 5); jmp(0x1008_3749, 0x6f); goto l_0x1008_3749; /* jmp 0x10083749 */
        l_0x1008_36da:
            ii(0x1008_36da, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_36dd, 5); call(0x1008_3558, -0x18a);              /* call 0x10083558 */
            ii(0x1008_36e2, 2); test(al, al);                           /* test al, al */
            ii(0x1008_36e4, 2); if(jnz(0x1008_36ec, 0x6)) goto l_0x1008_36ec; /* jnz 0x100836ec */
            ii(0x1008_36e6, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x1008_36ea, 2); jmp(0x1008_3749, 0x5d); goto l_0x1008_3749; /* jmp 0x10083749 */
        l_0x1008_36ec:
            ii(0x1008_36ec, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_36ee, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_36fd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_370f, 2); if(jnz(0x1008_3717, 0x6)) goto l_0x1008_3717; /* jnz 0x10083717 */
        l_0x1008_3711:
            ii(0x1008_3711, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x1008_3715, 2); jmp(0x1008_3749, 0x32); goto l_0x1008_3749; /* jmp 0x10083749 */
        l_0x1008_3717:
            ii(0x1008_3717, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_371a, 3); mov(edx, memd[ds, eax + 0x7]);          /* mov edx, [eax+0x7] */
            ii(0x1008_371d, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1008_3720, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_3737, 2); if(jnz(0x1008_373f, 0x6)) goto l_0x1008_373f; /* jnz 0x1008373f */
            ii(0x1008_3739, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1008_373d, 2); jmp(0x1008_3743, 0x4); goto l_0x1008_3743; /* jmp 0x10083743 */
        l_0x1008_373f:
            ii(0x1008_373f, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
        l_0x1008_3743:
            ii(0x1008_3743, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
            ii(0x1008_3746, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
        l_0x1008_3749:
            ii(0x1008_3749, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
