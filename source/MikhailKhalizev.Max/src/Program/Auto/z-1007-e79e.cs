...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_e79e()
        {
            ...
            ii(0x1007_e7b5, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1007_e7b8, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1007_e7bb, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1007_e7be, 3); mov(al, memb[ds, eax + 78]);            /* mov al, [eax+0x4e] */
            ...
            ii(0x1007_e7ca, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1007_e7cd, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1007_e7d0, 5); call(0x1015_2a52, 0xd_427d);            /* call 0x10152a52 */
            ii(0x1007_e7d5, 2); test(al, al);                           /* test al, al */
            ii(0x1007_e7d7, 2); if(jnz(0x1007_e7df, 6)) goto l_0x1007_e7df; /* jnz 0x1007e7df */
        l_0x1007_e7d9:
            ii(0x1007_e7d9, 4); mov(memb[ss, ebp - 12], 0);             /* mov byte [ebp-0xc], 0x0 */
        ...
        l_0x1007_e7df:
            ...
            ii(0x1007_e7e4, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1007_e7e7, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1007_e7ea, 5); call(0x1007_8d4a, -0x5aa5);             /* call 0x10078d4a */
            ii(0x1007_e7ef, 2); test(al, al);                           /* test al, al */
            ii(0x1007_e7f1, 2); if(jz(0x1007_e7f9, 6)) goto l_0x1007_e7f9; /* jz 0x1007e7f9 */
            ii(0x1007_e7f3, 4); mov(memb[ss, ebp - 12], 1);             /* mov byte [ebp-0xc], 0x1 */
            ii(0x1007_e7f7, 2); jmp(0x1007_e807, 0xe); goto l_0x1007_e807; /* jmp 0x1007e807 */
        l_0x1007_e7f9:
            ii(0x1007_e7f9, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1007_e7fc, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1007_e7ff, 5); call(0x1007_e812, 0xe);                 /* call 0x1007e812 */
            ii(0x1007_e804, 3); mov(memb[ss, ebp - 12], al);            /* mov [ebp-0xc], al */
        l_0x1007_e807:
            ii(0x1007_e807, 3); mov(al, memb[ss, ebp - 12]);            /* mov al, [ebp-0xc] */
