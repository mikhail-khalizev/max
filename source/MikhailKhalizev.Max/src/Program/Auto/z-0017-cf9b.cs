...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x17_cf9b, 2); push(ebx);                                /* push ebx */
            ii(0x17_cf9d, 5); movzx(bx, memb_a32[ss, ebp + 32]);        /* movzx bx, byte [ebp+0x20] */
            ...
            ii(0x17_cfb9, 3); add(sp, 4);                               /* add sp, 0x4 */
            ii(0x17_cfbc, 3); call(0x17_cf26, -0x99);                   /* call 0xcf26 */
            ii(0x17_cfbf, 2); pop(ebx);                                 /* pop ebx */
            ii(0x17_cfc1, 3); if(jmp_func(0x17_d0b0, 0xec)) return;     /* jmp 0xd0b0 */
        l_0x17_cfc4:
            ii(0x17_cfc4, 2); pop(ebx);                                 /* pop ebx */
            ii(0x17_cfc6, 5); jmp_far_ind(memw[cs, -0x7988]);           /* jmp far word [cs:0x8678] */
        }
    }
}
