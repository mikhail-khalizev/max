...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_8de8()
        {
            ...
            ii(0x1016_8dfd, 4); test(memb[ds, eax + 0x4], 0x1);         /* test byte [eax+0x4], 0x1 */
            ii(0x1016_8e01, 2); if(jz(0x1016_8e10, 0xd)) goto l_0x1016_8e10; /* jz 0x10168e10 */
            ii(0x1016_8e03, 4); test(memb[ds, eax + 0x6], 0x2);         /* test byte [eax+0x6], 0x2 */
            ii(0x1016_8e07, 2); if(jz(0x1016_8e10, 0x7)) goto l_0x1016_8e10; /* jz 0x10168e10 */
