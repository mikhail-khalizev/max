...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_11dc()
        {
            ...
            ii(0x1011_11f4, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_11f7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_11fa, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_11fc, 6); mov(dl, memb[ds, eax + 0x140]);         /* mov dl, [eax+0x140] */
            ii(0x1011_1202, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_1205, 4); mov(ax, memw[ds, eax + 0xc]);           /* mov ax, [eax+0xc] */
            ii(0x1011_1209, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1011_120b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_120e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_1211, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_1213, 6); mov(dl, memb[ds, eax + 0x142]);         /* mov dl, [eax+0x142] */
            ii(0x1011_1219, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1011_121d, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x1011_121f, 2); if(jnz(0x1011_1230, 0xf)) goto l_0x1011_1230; /* jnz 0x10111230 */
            ii(0x1011_1221, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_1224, 7); mov(memd[ds, eax + 0x4], 0x1);          /* mov dword [eax+0x4], 0x1 */
            ii(0x1011_122b, 5); jmp(0x1011_12ac, 0x7c); goto l_0x1011_12ac; /* jmp 0x101112ac */
        l_0x1011_1230:
            ii(0x1011_1230, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_1233, 6); mov(dl, memb[ds, eax + 0x142]);         /* mov dl, [eax+0x142] */
            ii(0x1011_1239, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_123c, 6); cmp(dl, memb[ds, eax + 0x140]);         /* cmp dl, [eax+0x140] */
            ii(0x1011_1242, 2); if(jb(0x1011_1264, 0x20)) goto l_0x1011_1264; /* jb 0x10111264 */
            ii(0x1011_1244, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_1247, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_1249, 6); mov(dl, memb[ds, eax + 0x140]);         /* mov dl, [eax+0x140] */
            ii(0x1011_124f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_1252, 6); mov(al, memb[ds, eax + 0x142]);         /* mov al, [eax+0x142] */
            ...
            ii(0x1011_1262, 2); if(jl(0x1011_1266, 0x2)) goto l_0x1011_1266; /* jl 0x10111266 */
        l_0x1011_1264:
            ii(0x1011_1264, 2); jmp(0x1011_1290, 0x2a); goto l_0x1011_1290; /* jmp 0x10111290 */
        l_0x1011_1266:
            ii(0x1011_1266, 5); mov(ebx, 0x2);                          /* mov ebx, 0x2 */
            ii(0x1011_126b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_126e, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_1270, 6); mov(dl, memb[ds, eax + 0x142]);         /* mov dl, [eax+0x142] */
            ii(0x1011_1276, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_1279, 6); mov(al, memb[ds, eax + 0x140]);         /* mov al, [eax+0x140] */
            ...
            ii(0x1011_1288, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_128b, 5); call(0x1011_0296, -0xffa);              /* call 0x10110296 */
        l_0x1011_1290:
            ii(0x1011_1290, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x1011_1293, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1011_1296, 6); mov(memb[ds, edx + 0x142], al);         /* mov [edx+0x142], al */
            ii(0x1011_129c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_129f, 5); call(0x1011_09f0, -0x8b4);              /* call 0x101109f0 */
            ii(0x1011_12a4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
