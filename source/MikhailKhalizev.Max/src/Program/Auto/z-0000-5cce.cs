...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x5cce, 3);    push(0x9b);                               /* push 0x9b */
            ii(0x5cd1, 3);    call(0x5cc4, -0x10);                      /* call 0x5cc4 */
            ii(0x5cd4, 1);    dec(ax);                                  /* dec ax */
            ii(0x5cd5, 1);    push(ax);                                 /* push ax */
            ii(0x5cd6, 3);    mov(memw[ds, 0x930], ax);                 /* mov [0x930], ax */
            ii(0x5cd9, 4);    mov(dx, memw[ds, 0xa12]);                 /* mov dx, [0xa12] */
        ...
        l_0x5ce5:
            ...
            ii(0x5cf6, 2);    push(0xe);                                /* push 0xe */
            ii(0x5cf8, 3);    call(0x5a4a, -0x2b1);                     /* call 0x5a4a */
