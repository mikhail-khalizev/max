...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_21b6()
        {
            ...
            ii(0x1007_21cd, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_21d0, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1007_21d3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_21d6, 5); call(0x1007_20e6, -0xf5);               /* call 0x100720e6 */
            ii(0x1007_21db, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_21de, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1007_21ed, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x1007_21f0, 2); jmp(0x1007_2223, 0x31); goto l_0x1007_2223; /* jmp 0x10072223 */
        l_0x1007_21f2:
            ii(0x1007_21f2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_21f5, 4); mov(dx, memw[ds, eax + 0x52]);          /* mov dx, [eax+0x52] */
            ii(0x1007_21f9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_21fc, 4); add(memw[ds, eax + 0x2], dx);           /* add [eax+0x2], dx */
            ii(0x1007_2200, 2); jmp(0x1007_2245, 0x43); goto l_0x1007_2245; /* jmp 0x10072245 */
        l_0x1007_2202:
            ii(0x1007_2202, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_2205, 4); mov(dx, memw[ds, eax + 0x52]);          /* mov dx, [eax+0x52] */
            ii(0x1007_2209, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_220c, 4); add(memw[ds, eax + 0x4], dx);           /* add [eax+0x4], dx */
            ii(0x1007_2210, 2); jmp(0x1007_2245, 0x33); goto l_0x1007_2245; /* jmp 0x10072245 */
        l_0x1007_2212:
            ii(0x1007_2212, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_2215, 4); mov(dx, memw[ds, eax + 0x52]);          /* mov dx, [eax+0x52] */
            ii(0x1007_2219, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1007_2223:
            ii(0x1007_2223, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
            ii(0x1007_2226, 3); mov(memb[ss, ebp - 0x14], al);          /* mov [ebp-0x14], al */
            ii(0x1007_2229, 4); cmp(memb[ss, ebp - 0x14], 0x2);         /* cmp byte [ebp-0x14], 0x2 */
            ii(0x1007_222d, 2); if(jb(0x1007_223d, 0xe)) goto l_0x1007_223d; /* jb 0x1007223d */
            ii(0x1007_222f, 4); cmp(memb[ss, ebp - 0x14], 0x2);         /* cmp byte [ebp-0x14], 0x2 */
            ii(0x1007_2233, 2); if(jbe(0x1007_2202, -0x33)) goto l_0x1007_2202; /* jbe 0x10072202 */
            ii(0x1007_2235, 4); cmp(memb[ss, ebp - 0x14], 0x3);         /* cmp byte [ebp-0x14], 0x3 */
        ...
        l_0x1007_223d:
            ii(0x1007_223d, 4); cmp(memb[ss, ebp - 0x14], 0x1);         /* cmp byte [ebp-0x14], 0x1 */
        ...
        l_0x1007_2245:
            ii(0x1007_2245, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_2248, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1007_224b, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
