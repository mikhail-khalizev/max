...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_2c18()
        {
            ...
            ii(0x1010_2c30, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_2c33, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_2c36, 5); add(eax, 0x2f0);                        /* add eax, 0x2f0 */
            ii(0x1010_2c3b, 5); call(0x100e_0cf0, -0x2_1f50);           /* call 0x100e0cf0 */
            ii(0x1010_2c40, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_2c43, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
