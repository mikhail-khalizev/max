...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_85ad()
        {
            ...
            ii(0x1014_85c5, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_85c8, 5); call(0x1014_82f4, -0x2d9);              /* call 0x101482f4 */
            ii(0x1014_85cd, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_85d0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_85d3, 3); cmp(eax, memd[ss, ebp - 0x4]);          /* cmp eax, [ebp-0x4] */
            ii(0x1014_85d6, 2); if(jae(0x1014_85e1, 0x9)) goto l_0x1014_85e1; /* jae 0x101485e1 */
            ii(0x1014_85d8, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1014_85df, 2); jmp(0x1014_85f3, 0x12); goto l_0x1014_85f3; /* jmp 0x101485f3 */
        l_0x1014_85e1:
            ii(0x1014_85e1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_85e4, 3); sub(eax, memd[ss, ebp - 0x4]);          /* sub eax, [ebp-0x4] */
            ii(0x1014_85e7, 5); mov(ebx, 0x4a9);                        /* mov ebx, 0x4a9 */
            ii(0x1014_85ec, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_85ee, 2); div(ebx);                               /* div ebx */
            ii(0x1014_85f0, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
        l_0x1014_85f3:
            ii(0x1014_85f3, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
