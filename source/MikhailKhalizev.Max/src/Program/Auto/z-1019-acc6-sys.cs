...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_acc6()
        {
            ...
            ii(0x1019_acec, 3); mov(ebx, memd[ds, ecx + 0x14]);         /* mov ebx, [ecx+0x14] */
            ii(0x1019_acef, 5); call(/* sys */ 0x1019_ac92, -0x62);     /* call 0x1019ac92 */
            ii(0x1019_acf4, 4); mov(memd[ss, esp + 0x14], eax);         /* mov [esp+0x14], eax */
        ...
        l_0x1019_ad12:
            ii(0x1019_ad12, 3); mov(eax, memd[ds, ecx + 0x14]);         /* mov eax, [ecx+0x14] */
            ii(0x1019_ad15, 5); add(eax, 0x76c);                        /* add eax, 0x76c */
            ii(0x1019_ad1a, 3); mov(ebp, memd[ds, ecx + 0x10]);         /* mov ebp, [ecx+0x10] */
            ii(0x1019_ad1d, 5); call(/* sys */ 0x1019_ab72, -0x1b0);    /* call 0x1019ab72 */
            ii(0x1019_ad22, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1019_ad24, 4); lea(eax, memd[ss, ebp + ebp + 0]);      /* lea eax, [ebp+ebp] */
        ...
        l_0x1019_ad46:
            ...
            ii(0x1019_ad4e, 4); mov(memd[ss, esp + 0xc], edx);          /* mov [esp+0xc], edx */
            ii(0x1019_ad52, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1019_ad54, 3); mov(eax, memd[ds, esi + 0x20]);         /* mov eax, [esi+0x20] */
            ii(0x1019_ad57, 4); mov(memd[ss, esp + 0x10], edx);         /* mov [esp+0x10], edx */
            ii(0x1019_ad5b, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1019_ad5d, 6); if(jnz(0x1019_ae16, 0xb3)) goto l_0x1019_ae16; /* jnz 0x1019ae16 */
            ii(0x1019_ad63, 3); mov(eax, memd[ds, esi + 0x10]);         /* mov eax, [esi+0x10] */
        ...
        l_0x1019_ad74:
            ...
            ii(0x1019_ad7a, 3); mov(edx, memd[ds, ecx + 0x18]);         /* mov edx, [ecx+0x18] */
            ii(0x1019_ad7d, 3); mov(eax, memd[ds, esi + 0x18]);         /* mov eax, [esi+0x18] */
            ii(0x1019_ad80, 3); add(edx, 0x7);                          /* add edx, 0x7 */
            ii(0x1019_ad83, 2); sub(edx, eax);                          /* sub edx, eax */
            ii(0x1019_ad85, 8); mov(memd[ss, esp + 0x18], 0x7);         /* mov dword [esp+0x18], 0x7 */
            ii(0x1019_ad8d, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x1019_ad8f, 3); sar(edx, 0x1f);                         /* sar edx, 0x1f */
            ii(0x1019_ad92, 4); idiv(memd[ss, esp + 0x18]);             /* idiv dword [esp+0x18] */
            ii(0x1019_ad96, 3); mov(eax, memd[ds, ecx + 0xc]);          /* mov eax, [ecx+0xc] */
            ii(0x1019_ad99, 2); sub(eax, edx);                          /* sub eax, edx */
            ii(0x1019_ad9b, 3); mov(edx, memd[ds, ecx + 0x18]);         /* mov edx, [ecx+0x18] */
            ii(0x1019_ad9e, 3); mov(memd[ss, esp], eax);                /* mov [esp], eax */
            ii(0x1019_ada1, 3); add(edx, 0x6);                          /* add edx, 0x6 */
            ii(0x1019_ada4, 3); sub(edx, memd[ds, esi + 0x18]);         /* sub edx, [esi+0x18] */
            ii(0x1019_ada7, 8); mov(memd[ss, esp + 0x18], 0x7);         /* mov dword [esp+0x18], 0x7 */
            ii(0x1019_adaf, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x1019_adb1, 3); sar(edx, 0x1f);                         /* sar edx, 0x1f */
            ii(0x1019_adb4, 4); idiv(memd[ss, esp + 0x18]);             /* idiv dword [esp+0x18] */
            ii(0x1019_adb8, 3); mov(eax, memd[ds, ecx + 0xc]);          /* mov eax, [ecx+0xc] */
            ii(0x1019_adbb, 1); dec(eax);                               /* dec eax */
            ii(0x1019_adbc, 2); sub(eax, edx);                          /* sub eax, edx */
            ii(0x1019_adbe, 3); mov(edx, memd[ds, esi + 0xc]);          /* mov edx, [esi+0xc] */
            ii(0x1019_adc1, 4); mov(memd[ss, esp + 0x8], eax);          /* mov [esp+0x8], eax */
            ii(0x1019_adc5, 3); cmp(edx, 0x5);                          /* cmp edx, 0x5 */
            ii(0x1019_adc8, 2); if(jnz(0x1019_adef, 0x25)) goto l_0x1019_adef; /* jnz 0x1019adef */
            ii(0x1019_adca, 4); mov(eax, memd[ss, esp + 0xc]);          /* mov eax, [esp+0xc] */
            ...
            ii(0x1019_addc, 4); mov(edx, memd[ss, esp + 0x8]);          /* mov edx, [esp+0x8] */
        ...
        l_0x1019_adef:
            ii(0x1019_adef, 3); lea(eax, memd[ds, edx - 0x1]);          /* lea eax, [edx-0x1] */
            ii(0x1019_adf2, 4); mov(memd[ss, esp + 0x18], eax);         /* mov [esp+0x18], eax */
            ii(0x1019_adf6, 4); mov(edx, memd[ss, esp + 0x18]);         /* mov edx, [esp+0x18] */
            ...
            ii(0x1019_ae07, 4); mov(edx, memd[ss, esp + 0x8]);          /* mov edx, [esp+0x8] */
        ...
        l_0x1019_ae16:
            ii(0x1019_ae16, 3); mov(edx, memd[ds, esi + 0x1c]);         /* mov edx, [esi+0x1c] */
            ii(0x1019_ae19, 3); cmp(eax, 0x1);                          /* cmp eax, 0x1 */
            ii(0x1019_ae1c, 2); if(jnz(0x1019_ae3d, 0x1f)) goto l_0x1019_ae3d; /* jnz 0x1019ae3d */
            ii(0x1019_ae1e, 3); mov(eax, memd[ds, ecx + 0x14]);         /* mov eax, [ecx+0x14] */
            ...
            ii(0x1019_ae39, 2); if(jle(0x1019_ae3c, 0x1)) goto l_0x1019_ae3c; /* jle 0x1019ae3c */
            ii(0x1019_ae3b, 1); inc(edx);                               /* inc edx */
        l_0x1019_ae3c:
            ii(0x1019_ae3c, 1); dec(edx);                               /* dec edx */
        l_0x1019_ae3d:
            ii(0x1019_ae3d, 3); mov(eax, memd[ds, ecx + 0x1c]);         /* mov eax, [ecx+0x1c] */
            ...
            ii(0x1019_ae49, 2); if(jnz(0x1019_ae4f, 0x4)) goto l_0x1019_ae4f; /* jnz 0x1019ae4f */
        l_0x1019_ae4b:
            ii(0x1019_ae4b, 4); mov(memd[ss, esp + 0x10], edi);         /* mov [esp+0x10], edi */
        l_0x1019_ae4f:
            ii(0x1019_ae4f, 5); cmp(memd[ss, esp + 0x10], 0);           /* cmp dword [esp+0x10], 0x0 */
        ...
        l_0x1019_ae6c:
            ...
            ii(0x1019_ae70, 4); mov(edx, memd[ss, esp + 0x14]);         /* mov edx, [esp+0x14] */
        ...
        l_0x1019_ae83:
            ii(0x1019_ae83, 3); mov(eax, memd[ds, ebx + 0x20]);         /* mov eax, [ebx+0x20] */
            ...
            ii(0x1019_ae90, 3); mov(eax, memd[ds, ebx + 0x10]);         /* mov eax, [ebx+0x10] */
            ii(0x1019_ae93, 2); cmp(ebp, eax);                          /* cmp ebp, eax */
            ii(0x1019_ae95, 2); if(jle(0x1019_ae9e, 0x7)) goto l_0x1019_ae9e; /* jle 0x1019ae9e */
        ...
        l_0x1019_ae9e:
            ...
            ii(0x1019_aea4, 3); mov(edx, memd[ds, ecx + 0x18]);         /* mov edx, [ecx+0x18] */
            ii(0x1019_aea7, 3); mov(ebp, memd[ds, ebx + 0x18]);         /* mov ebp, [ebx+0x18] */
            ...
            ii(0x1019_aebb, 3); mov(eax, memd[ds, ecx + 0xc]);          /* mov eax, [ecx+0xc] */
            ii(0x1019_aebe, 2); sub(eax, edx);                          /* sub eax, edx */
            ii(0x1019_aec0, 3); mov(edx, memd[ds, ecx + 0x18]);         /* mov edx, [ecx+0x18] */
            ii(0x1019_aec3, 4); mov(memd[ss, esp + 0x4], eax);          /* mov [esp+0x4], eax */
            ii(0x1019_aec7, 3); add(edx, 0x6);                          /* add edx, 0x6 */
            ii(0x1019_aeca, 3); mov(eax, memd[ds, ebx + 0x18]);         /* mov eax, [ebx+0x18] */
            ...
            ii(0x1019_aed6, 3); mov(eax, memd[ds, ecx + 0xc]);          /* mov eax, [ecx+0xc] */
            ii(0x1019_aed9, 1); dec(eax);                               /* dec eax */
            ii(0x1019_aeda, 2); xor(edi, edi);                          /* xor edi, edi */
            ii(0x1019_aedc, 2); sub(eax, edx);                          /* sub eax, edx */
            ii(0x1019_aede, 3); mov(ebp, memd[ds, ebx + 0xc]);          /* mov ebp, [ebx+0xc] */
            ...
            ii(0x1019_aee8, 4); mov(eax, memd[ss, esp + 0xc]);          /* mov eax, [esp+0xc] */
            ii(0x1019_aeec, 4); mov(ebp, memd[ss, esp + 0x4]);          /* mov ebp, [esp+0x4] */
        ...
        l_0x1019_af07:
            ii(0x1019_af07, 3); lea(eax, memd[ss, ebp - 0x1]);          /* lea eax, [ebp-0x1] */
            ii(0x1019_af0a, 4); mov(memd[ss, esp + 0x18], eax);         /* mov [esp+0x18], eax */
            ii(0x1019_af0e, 4); mov(ebp, memd[ss, esp + 0x18]);         /* mov ebp, [esp+0x18] */
            ii(0x1019_af12, 3); shl(eax, 0x3);                          /* shl eax, 0x3 */
            ii(0x1019_af15, 2); sub(eax, ebp);                          /* sub eax, ebp */
            ii(0x1019_af17, 4); mov(ebp, memd[ss, esp + 0x4]);          /* mov ebp, [esp+0x4] */
        ...
        l_0x1019_af26:
            ii(0x1019_af26, 3); mov(edx, memd[ds, ebx + 0x1c]);         /* mov edx, [ebx+0x1c] */
            ii(0x1019_af29, 3); cmp(eax, 0x1);                          /* cmp eax, 0x1 */
            ii(0x1019_af2c, 2); if(jnz(0x1019_af4d, 0x1f)) goto l_0x1019_af4d; /* jnz 0x1019af4d */
            ii(0x1019_af2e, 3); mov(eax, memd[ds, ecx + 0x14]);         /* mov eax, [ecx+0x14] */
            ...
            ii(0x1019_af49, 2); if(jle(0x1019_af4c, 0x1)) goto l_0x1019_af4c; /* jle 0x1019af4c */
            ii(0x1019_af4b, 1); inc(edx);                               /* inc edx */
        l_0x1019_af4c:
            ii(0x1019_af4c, 1); dec(edx);                               /* dec edx */
        l_0x1019_af4d:
            ii(0x1019_af4d, 3); mov(eax, memd[ds, ecx + 0x1c]);         /* mov eax, [ecx+0x1c] */
            ...
            ii(0x1019_af58, 2); if(jnz(0x1019_af5f, 0x5)) goto l_0x1019_af5f; /* jnz 0x1019af5f */
        l_0x1019_af5a:
        ...
        l_0x1019_af6e:
            ii(0x1019_af6e, 4); mov(eax, memd[ss, esp + 0x14]);         /* mov eax, [esp+0x14] */
            ii(0x1019_af72, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1019_af74, 2); if(jz(0x1019_af7a, 0x4)) goto l_0x1019_af7a; /* jz 0x1019af7a */
            ii(0x1019_af76, 2); sub(eax, edi);                          /* sub eax, edi */
            ii(0x1019_af78, 2); mov(edi, eax);                          /* mov edi, eax */
        l_0x1019_af7a:
            ii(0x1019_af7a, 2); mov(eax, edi);                          /* mov eax, edi */
            ii(0x1019_af7c, 3); mov(memd[ds, ecx + 0x20], edi);         /* mov [ecx+0x20], edi */
