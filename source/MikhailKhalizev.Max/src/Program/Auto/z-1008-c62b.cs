...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_c62b()
        {
            ...
            ii(0x1008_c65c, 7);  mov(memd[ss, ebp - 12], 0);           /* mov dword [ebp-0xc], 0x0 */
            ii(0x1008_c663, 2);  jmp(0x1008_c66d, 8); goto l_0x1008_c66d;/* jmp 0x1008c66d */
        l_0x1008_c665:
            ii(0x1008_c665, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1008_c668, 5);  call(0x1007_6bf8, -0x1_5a75);         /* call 0x10076bf8 */
        l_0x1008_c66d:
            ii(0x1008_c66d, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_c66f, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x1008_c67f, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1008_c682, 5);  call(0x1007_63a0, -0x1_62e7);         /* call 0x100763a0 */
            ii(0x1008_c687, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_c689, 3);  mov(dl, memb[ds, eax + 38]);          /* mov dl, [eax+0x26] */
            ii(0x1008_c68c, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_c68f, 3);  mov(eax, memd[ds, eax + 7]);          /* mov eax, [eax+0x7] */
        ...
        l_0x1008_c6df:
            ...
            ii(0x1008_c6f8, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1008_c6fb, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_c708, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x1008_c70b, 5);  call(0x100a_601a, 0x1_990a);          /* call 0x100a601a */
            ii(0x1008_c710, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1008_c713, 4);  cmp(memd[ss, ebp - 12], 0);           /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1008_c717, 2);  if(jz(0x1008_c722, 9)) goto l_0x1008_c722;/* jz 0x1008c722 */
            ii(0x1008_c719, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x1008_c71c, 4);  cmp(ax, memw[ss, ebp - 8]);           /* cmp ax, [ebp-0x8] */
            ii(0x1008_c720, 2);  if(jge(0x1008_c745, 0x23)) goto l_0x1008_c745;/* jge 0x1008c745 */
        l_0x1008_c722:
            ii(0x1008_c722, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x1008_c725, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_c728, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x1008_c72b, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1008_c72e, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1008_c731, 5);  call(0x1007_6408, -0x1_632e);         /* call 0x10076408 */
            ii(0x1008_c736, 3);  mov(ebx, memd[ss, ebp - 4]);          /* mov ebx, [ebp-0x4] */
        ...
        l_0x1008_c74a:
            ii(0x1008_c74a, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1008_c74d, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1008_c750, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_c752, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        //  ii(0x1008_c75e, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        //  ii(0x1008_c761, 5);  call(0x1007_5f6c, -0x1_67fa);         /* call 0x10075f6c */
        l_0x1008_c766:
            ii(0x1008_c766, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
