...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("e898a460-f649-4b8f-b4ec-db3d5945a591")]
        public void Method_100f_2a6f()
        {
            ii(0x100f_2a6f, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x100f_2a74, 5); calld(Definitions.sys_check_available_stack_size, 0x732d9); /* call 0x10165d52 */
        ...
        l_0x100f_2aa0:
            ...
            ii(0x100f_2ab5, 5); calld(0x1007_63a0, -0x7c71a);           /* call 0x100763a0 */
            ...
            ii(0x100f_2ace, 5); calld(0x1007_63a0, -0x7c733);           /* call 0x100763a0 */
            ...
            ii(0x100f_2adc, 5); calld(0x1007_63a0, -0x7c741);           /* call 0x100763a0 */
        ...
        l_0x100f_2ae9:
            ...
            ii(0x100f_2aec, 5); calld(0x1007_63a0, -0x7c751);           /* call 0x100763a0 */
        ...
        l_0x100f_2afc:
            ...
            ii(0x100f_2aff, 5); calld(0x1007_63a0, -0x7c764);           /* call 0x100763a0 */
            ...
            ii(0x100f_2b0c, 5); calld(0x1007_63a0, -0x7c771);           /* call 0x100763a0 */
            ii(0x100f_2b11, 5); calld(0x1009_c9a0, -0x56176);           /* call 0x1009c9a0 */
            ...
            ii(0x100f_2b1e, 5); calld(0x1007_63a0, -0x7c783);           /* call 0x100763a0 */
            ii(0x100f_2b23, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100f_2b25, 3); lea(eax, ebp - 0x10);                   /* lea eax, [ebp-0x10] */
            ii(0x100f_2b28, 5); calld(0x1007_63a0, -0x7c78d);           /* call 0x100763a0 */
            ii(0x100f_2b2d, 5); calld(0x1009_c9a0, -0x56192);           /* call 0x1009c9a0 */
        ...
        l_0x100f_2b37:
            ...
            ii(0x100f_2b3a, 5); calld(0x1007_63a0, -0x7c79f);           /* call 0x100763a0 */
            ii(0x100f_2b3f, 4); mov(memb_a32[ds, eax + 0x45], 0);       /* mov byte [eax+0x45], 0x0 */
            ii(0x100f_2b43, 3); lea(eax, ebp - 0x10);                   /* lea eax, [ebp-0x10] */
            ii(0x100f_2b46, 5); calld(0x1007_63a0, -0x7c7ab);           /* call 0x100763a0 */
            ...
            ii(0x100f_2b55, 5); calld(0x1007_63a0, -0x7c7ba);           /* call 0x100763a0 */
            ii(0x100f_2b5a, 5); calld(0x1015_0a9e, 0x5df3f);            /* call 0x10150a9e */
        ...
        l_0x100f_2b68:
            ...
            ii(0x100f_2b6b, 5); calld(0x1007_63a0, -0x7c7d0);           /* call 0x100763a0 */
            ii(0x100f_2b70, 5); calld(0x1015_1740, 0x5ebcb);            /* call 0x10151740 */
        l_0x100f_2b75:
            ii(0x100f_2b75, 3); lea(eax, ebp - 0x10);                   /* lea eax, [ebp-0x10] */
            ii(0x100f_2b78, 5); calld(0x1007_6bf8, -0x7bf85);           /* call 0x10076bf8 */
        ...
        l_0x100f_2b82:
            ...
            ii(0x100f_2b87, 5); calld(0x1007_5f6c, -0x7cc20);           /* call 0x10075f6c */
            ...
            ii(0x100f_2b92, 1); retd(); return;                         /* ret */
        }
    }
}
