...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_9da4()
        {
            ...
            ii(0x100b_9da9, 5); calld(Definitions.sys_check_available_stack_size, 0xabfa4); /* call 0x10165d52 */
            ...
            ii(0x100b_9dc8, 5); calld(Definitions.my_ctor_0x101b3b58, -0x2ed29); /* call 0x1008b0a4 */
            ...
            ii(0x100b_9dda, 5); calld(0x1007_6b90, -0x4324f);           /* call 0x10076b90 */
            ...
            ii(0x100b_9ded, 5); calld(Definitions.sys_new, 0xac00e);    /* call 0x10165e00 */
            ...
            ii(0x100b_9e07, 5); calld(0x1007_5e64, -0x43fa8);           /* call 0x10075e64 */
            ...
            ii(0x100b_9e17, 5); calld(0x1009_2f1e, -0x26efe);           /* call 0x10092f1e */
        ...
        l_0x100b_9e2d:
            ...
            ii(0x100b_9e33, 5); calld(0x1008_afe4, -0x2ee54);           /* call 0x1008afe4 */
            ii(0x100b_9e38, 3); lea(eax, ebp - 0x14);                   /* lea eax, [ebp-0x14] */
            ii(0x100b_9e3b, 5); calld(0x1008_afb4, -0x2ee8c);           /* call 0x1008afb4 */
            ...
            ii(0x100b_9e48, 5); calld(0x1009_ca40, -0x1d40d);           /* call 0x1009ca40 */
            ii(0x100b_9e4d, 3); lea(eax, ebp - 0x14);                   /* lea eax, [ebp-0x14] */
            ii(0x100b_9e50, 5); calld(0x1008_afb4, -0x2eea1);           /* call 0x1008afb4 */
            ii(0x100b_9e55, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100b_9e57, 5); mov(eax, 0x101c_3180);                  /* mov eax, 0x101c3180 */
            ii(0x100b_9e5c, 5); calld(0x100a_4d50, -0x15111);           /* call 0x100a4d50 */
            ii(0x100b_9e61, 5); mov(eax, 0xd1);                         /* mov eax, 0xd1 */
            ii(0x100b_9e66, 5); calld(Definitions.sys_new, 0xabf95);    /* call 0x10165e00 */
            ...
            ii(0x100b_9e80, 5); calld(0x1007_5e64, -0x44021);           /* call 0x10075e64 */
            ...
            ii(0x100b_9e90, 5); calld(0x1007_dd5a, -0x3c13b);           /* call 0x1007dd5a */
        ...
        l_0x100b_9ea6:
            ...
            ii(0x100b_9eaf, 5); calld(0x1008_afe4, -0x2eed0);           /* call 0x1008afe4 */
            ii(0x100b_9eb4, 5); mov(eax, 0x23);                         /* mov eax, 0x23 */
            ii(0x100b_9eb9, 5); calld(Definitions.sys_new, 0xabf42);    /* call 0x10165e00 */
            ...
            ii(0x100b_9ed3, 5); calld(0x1007_5e64, -0x44074);           /* call 0x10075e64 */
            ...
            ii(0x100b_9ee3, 5); calld(0x1007_963b, -0x408ad);           /* call 0x1007963b */
        ...
        l_0x100b_9f3a:
            ...
            ii(0x100b_9f40, 5); calld(0x1008_aef4, -0x2f051);           /* call 0x1008aef4 */
            ii(0x100b_9f45, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100b_9f47, 3); lea(eax, ebp - 0x58);                   /* lea eax, [ebp-0x58] */
            ii(0x100b_9f4a, 5); calld(0x1008_ae70, -0x2f0df);           /* call 0x1008ae70 */
            ii(0x100b_9f4f, 3); lea(eax, ebp - 0x5c);                   /* lea eax, [ebp-0x5c] */
            ii(0x100b_9f52, 5); calld(Definitions.my_ctor_0x101b4184, -0x43467); /* call 0x10076af0 */
            ii(0x100b_9f57, 3); lea(eax, ebp - 0x58);                   /* lea eax, [ebp-0x58] */
            ii(0x100b_9f5a, 5); calld(0x1008_adf8, -0x2f167);           /* call 0x1008adf8 */
            ii(0x100b_9f5f, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100b_9f61, 3); lea(eax, ebp - 0x14);                   /* lea eax, [ebp-0x14] */
            ii(0x100b_9f64, 5); calld(0x1008_afe4, -0x2ef85);           /* call 0x1008afe4 */
            ii(0x100b_9f69, 3); lea(eax, ebp - 0x14);                   /* lea eax, [ebp-0x14] */
            ii(0x100b_9f6c, 5); calld(0x1008_af28, -0x2f049);           /* call 0x1008af28 */
            ...
            ii(0x100b_9f89, 5); calld(0x1008_8b44, -0x3144a);           /* call 0x10088b44 */
            ...
            ii(0x100b_9f99, 5); calld(0x1007_6aac, -0x434f2);           /* call 0x10076aac */
            ii(0x100b_9f9e, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100b_9fa0, 3); lea(eax, ebp - 0x5c);                   /* lea eax, [ebp-0x5c] */
            ii(0x100b_9fa3, 5); calld(0x1007_6a6c, -0x4353c);           /* call 0x10076a6c */
            ...
            ii(0x100b_9fbe, 5); calld(0x1007_6bf8, -0x433cb);           /* call 0x10076bf8 */
        ...
        l_0x100b_9fc5:
            ...
            ii(0x100b_9fc8, 5); calld(0x1007_6bf8, -0x433d5);           /* call 0x10076bf8 */
        l_0x100b_9fcd:
            ii(0x100b_9fcd, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_9fcf, 3); lea(eax, ebp - 0x58);                   /* lea eax, [ebp-0x58] */
            ii(0x100b_9fd2, 5); calld(0x1013_ad71, 0x80d9a);            /* call 0x1013ad71 */
            ...
            ii(0x100b_9fe2, 5); calld(0x1008_adc4, -0x2f223);           /* call 0x1008adc4 */
            ...
            ii(0x100b_9fff, 5); calld(0x1008_8b44, -0x314c0);           /* call 0x10088b44 */
            ...
            ii(0x100b_a00f, 5); calld(0x1007_6aac, -0x43568);           /* call 0x10076aac */
            ii(0x100b_a014, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100b_a016, 3); lea(eax, ebp - 0x5c);                   /* lea eax, [ebp-0x5c] */
            ii(0x100b_a019, 5); calld(0x1007_6a6c, -0x435b2);           /* call 0x10076a6c */
            ...
            ii(0x100b_a043, 5); calld(0x1008_adf8, -0x2f250);           /* call 0x1008adf8 */
            ...
            ii(0x100b_a04f, 5); calld(0x1008_afe4, -0x2f070);           /* call 0x1008afe4 */
        ...
        l_0x100b_a062:
            ...
            ii(0x100b_a067, 5); calld(0x1008_8bbc, -0x314b0);           /* call 0x10088bbc */
        l_0x100b_a06c:
            ii(0x100b_a06c, 3); lea(eax, ebp - 0x14);                   /* lea eax, [ebp-0x14] */
            ii(0x100b_a06f, 5); calld(0x1008_afb4, -0x2f0c0);           /* call 0x1008afb4 */
            ...
            ii(0x100b_a07c, 5); calld(0x1008_8b7c, -0x31505);           /* call 0x10088b7c */
