...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_c75a()
        {
            ...
            ii(0x1015_c770, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1015_c773, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1015_c776, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ii(0x1015_c779, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1015_c77c, 3); mov(edx, memd[ds, edx + 0x6]);          /* mov edx, [edx+0x6] */
            ii(0x1015_c77f, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1015_c782, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_c785, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ...
            ii(0x1015_c79f, 4); mov(ax, memw[ds, eax + 0x8]);           /* mov ax, [eax+0x8] */
            ii(0x1015_c7a3, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1015_c7a6, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1015_c7b5, 4); movsx(ebx, memw[ss, ebp - 0x10]);       /* movsx ebx, word [ebp-0x10] */
            ii(0x1015_c7b9, 6); lea(edx, memd[ds, eax + 0x280]);        /* lea edx, [eax+0x280] */
            ii(0x1015_c7bf, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x1015_c7c1, 3); sar(edx, 0x1f);                         /* sar edx, 0x1f */
            ii(0x1015_c7c4, 2); idiv(ebx);                              /* idiv ebx */
            ii(0x1015_c7c6, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1015_c7c9, 4); cmp(memb[ss, ebp - 0x4], 0x18);         /* cmp byte [ebp-0x4], 0x18 */
            ii(0x1015_c7cd, 2); if(jnz(0x1015_c7e2, 0x13)) goto l_0x1015_c7e2; /* jnz 0x1015c7e2 */
            ii(0x1015_c7cf, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ...
            ii(0x1015_c7df, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
        l_0x1015_c7e2:
            ii(0x1015_c7e2, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1015_c7e6, 3); cmp(eax, 0x5a);                         /* cmp eax, 0x5a */
            ii(0x1015_c7e9, 2); if(jle(0x1015_c7f2, 0x7)) goto l_0x1015_c7f2; /* jle 0x1015c7f2 */
            ii(0x1015_c7eb, 7); mov(memd[ss, ebp - 0x14], 0x5a);        /* mov dword [ebp-0x14], 0x5a */
        l_0x1015_c7f2:
            ii(0x1015_c7f2, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1015_c7f5, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1015_c7f8, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
