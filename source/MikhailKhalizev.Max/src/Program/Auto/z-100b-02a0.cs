...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_02a0()
        {
            ...
            ii(0x100b_02b8, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_02bb, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_02be, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_02ce, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_02d1, 6); mov(memw[ds, eax + 0x1b], 0x2);         /* mov word [eax+0x1b], 0x2 */
            ii(0x100b_02d7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_02da, 6); mov(memw[ds, eax + 0x1d], 0);           /* mov word [eax+0x1d], 0x0 */
            ii(0x100b_02e0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_02e3, 6); mov(memw[ds, eax + 0x1f], 0x2);         /* mov word [eax+0x1f], 0x2 */
            ii(0x100b_02e9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_02ec, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x100b_02ef, 5); call(0x1007_6574, -0x3_9d80);           /* call 0x10076574 */
            ii(0x100b_02f4, 4); mov(ax, memw[ds, eax + 0x1a]);          /* mov ax, [eax+0x1a] */
            ii(0x100b_02f8, 1); dec(eax);                               /* dec eax */
            ii(0x100b_02f9, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_02fc, 4); mov(memw[ds, edx + 0x21], ax);          /* mov [edx+0x21], ax */
            ii(0x100b_0300, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_0303, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x100b_0306, 5); call(0x1007_6574, -0x3_9d97);           /* call 0x10076574 */
            ii(0x100b_030b, 4); mov(ax, memw[ds, eax + 0x1c]);          /* mov ax, [eax+0x1c] */
            ii(0x100b_030f, 1); inc(eax);                               /* inc eax */
            ii(0x100b_0310, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_0313, 4); mov(memw[ds, edx + 0x23], ax);          /* mov [edx+0x23], ax */
            ii(0x100b_0317, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_031a, 4); mov(memb[ds, eax + 0x25], 0);           /* mov byte [eax+0x25], 0x0 */
            ii(0x100b_031e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
