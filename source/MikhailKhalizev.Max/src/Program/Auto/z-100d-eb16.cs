...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_eb16()
        {
            ...
            ii(0x100d_eb2e, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100d_eb31, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x100d_eb35, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x100d_eb3c, 2); jmp(0x100d_eb44, 0x6); goto l_0x100d_eb44; /* jmp 0x100deb44 */
        l_0x100d_eb3e:
            ii(0x100d_eb3e, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_eb41, 3); inc(memd[ss, ebp - 0x10]);              /* inc dword [ebp-0x10] */
        l_0x100d_eb44:
            ii(0x100d_eb44, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_eb47, 5); add(eax, 0x3b3);                        /* add eax, 0x3b3 */
            ii(0x100d_eb4c, 5); call(Definitions.my_2_get_count, -0x5_37e9); /* call 0x1008b368 */
            ii(0x100d_eb51, 4); cmp(ax, memw[ss, ebp - 0x10]);          /* cmp ax, [ebp-0x10] */
            ii(0x100d_eb55, 6); if(jle(0x100d_ec6b, 0x110)) goto l_0x100d_ec6b; /* jle 0x100dec6b */
            ii(0x100d_eb5b, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x100d_eb5f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_eb72, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x100d_eb82, 4); mov(ax, memw[ds, eax + 0x19]);          /* mov ax, [eax+0x19] */
            ii(0x100d_eb86, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100d_eb89, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x100d_eb8d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_eb9d, 4); cmp(ax, memw[ss, ebp - 0xc]);           /* cmp ax, [ebp-0xc] */
            ii(0x100d_eba1, 6); if(jle(0x100d_ec66, 0xbf)) goto l_0x100d_ec66; /* jle 0x100dec66 */
            ii(0x100d_eba7, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x100d_ebab, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x100d_ebaf, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_ebbf, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x100d_ebd5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_ebd8, 3); mov(eax, memd[ds, eax + 0x4d]);         /* mov eax, [eax+0x4d] */
            ii(0x100d_ebdb, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100d_ebde, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x100d_ebe0, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100d_ebe3, 4); mov(memw[ds, edx + 0x4f], ax);          /* mov [edx+0x4f], ax */
            ii(0x100d_ebe7, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x100d_ebeb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_ebfa, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100d_ebfd, 3); mov(memw[ds, edx], ax);                 /* mov [edx], ax */
            ii(0x100d_ec00, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_ec03, 6); mov(eax, memd[ds, eax + 0x3bb]);        /* mov eax, [eax+0x3bb] */
            ii(0x100d_ec09, 5); call(0x100d_5018, -0x9bf6);             /* call 0x100d5018 */
            ii(0x100d_ec0e, 4); cmp(ax, memw[ss, ebp - 0x10]);          /* cmp ax, [ebp-0x10] */
            ii(0x100d_ec12, 2); if(jnz(0x100d_ec66, 0x52)) goto l_0x100d_ec66; /* jnz 0x100dec66 */
            ii(0x100d_ec14, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x100d_ec27, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_ec2a, 6); mov(eax, memd[ds, eax + 0x3df]);        /* mov eax, [eax+0x3df] */
            ii(0x100d_ec30, 5); call(0x100d_6f8b, -0x7caa);             /* call 0x100d6f8b */
            ii(0x100d_ec35, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x100d_ec39, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_ec58, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_ec5b, 6); mov(eax, memd[ds, eax + 0x3df]);        /* mov eax, [eax+0x3df] */
        ...
        l_0x100d_ec6b:
            ii(0x100d_ec6b, 4); cmp(memb[ss, ebp - 0x8], 0);            /* cmp byte [ebp-0x8], 0x0 */
            ii(0x100d_ec6f, 2); if(jz(0x100d_ec94, 0x23)) goto l_0x100d_ec94; /* jz 0x100dec94 */
            ii(0x100d_ec71, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_ec74, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100d_ec77, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x100d_ec7a, 3); mov(ebx, memd[ds, eax + 0x13]);         /* mov ebx, [eax+0x13] */
            ii(0x100d_ec7d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_ec80, 6); mov(eax, memd[ds, eax + 0x3bb]);        /* mov eax, [eax+0x3bb] */
            ii(0x100d_ec86, 5); call(0x100d_0149, -0xeb42);             /* call 0x100d0149 */
            ii(0x100d_ec8b, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x100d_ec8e, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x100d_ec91, 3); call_abs(memd[ds, ebx + 0x18]);         /* call dword [ebx+0x18] */
        l_0x100d_ec94:
