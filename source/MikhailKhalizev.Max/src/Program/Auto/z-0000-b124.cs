...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("b04c1042-2d8b-4d2a-ac5b-d6f60b88c25c")]
        public void Method_0000_b124()
        {
            ...
            ii(0xb12a, 3);    callw(0xac9b, -0x492);                    /* call 0xac9b */
            ii(0xb12d, 2);    or(bx, bx);                               /* or bx, bx */
            ii(0xb12f, 4);    if(jnzw(0xb13f, 0xc)) goto l_0xb13f;      /* jnz 0xb13f */
            ii(0xb133, 3);    mov(ax, 0xde03);                          /* mov ax, 0xde03 */
            ii(0xb136, 3);    callw(0xac9b, -0x49e);                    /* call 0xac9b */
