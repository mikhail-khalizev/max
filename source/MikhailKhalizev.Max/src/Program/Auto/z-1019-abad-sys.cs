...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_abad()
        {
            ...
            ii(0x1019_abd1, 3); mov(eax, memd[ds, ebx + 16]);           /* mov eax, [ebx+0x10] */
        ...
        l_0x1019_abe4:
            ii(0x1019_abe4, 3); mov(eax, memd[ds, ebx + 16]);           /* mov eax, [ebx+0x10] */
        ...
        l_0x1019_abf5:
            ...
            ii(0x1019_abff, 5); mov(ecx, 1);                            /* mov ecx, 0x1 */
            ii(0x1019_ac04, 3); mov(memd[ss, esp], edi);                /* mov [esp], edi */
            ii(0x1019_ac07, 4); mov(memd[ss, esp + 4], edi);            /* mov [esp+0x4], edi */
            ii(0x1019_ac0b, 4); mov(memd[ss, esp + 8], edi);            /* mov [esp+0x8], edi */
            ii(0x1019_ac0f, 4); mov(memd[ss, esp + 12], ecx);           /* mov [esp+0xc], ecx */
            ii(0x1019_ac13, 3); mov(eax, memd[ds, ebx + 16]);           /* mov eax, [ebx+0x10] */
            ii(0x1019_ac16, 4); mov(memd[ss, esp + 16], eax);           /* mov [esp+0x10], eax */
            ii(0x1019_ac1a, 4); mov(memd[ss, esp + 20], edx);           /* mov [esp+0x14], edx */
            ii(0x1019_ac1e, 2); mov(eax, esp);                          /* mov eax, esp */
            ii(0x1019_ac20, 4); mov(memd[ss, esp + 32], edi);           /* mov [esp+0x20], edi */
            ii(0x1019_ac24, 5); call(/* sys */ 0x1018_d888, -0xd3a1);   /* call 0x1018d888 */
            ii(0x1019_ac29, 4); mov(ebp, memd[ss, esp + 24]);           /* mov ebp, [esp+0x18] */
            ii(0x1019_ac2d, 3); mov(edx, memd[ds, ebx + 24]);           /* mov edx, [ebx+0x18] */
            ii(0x1019_ac30, 2); sub(edx, ebp);                          /* sub edx, ebp */
            ii(0x1019_ac32, 3); add(edx, 7);                            /* add edx, 0x7 */
            ii(0x1019_ac35, 5); mov(ecx, 7);                            /* mov ecx, 0x7 */
            ii(0x1019_ac3a, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x1019_ac3c, 3); sar(edx, 0x1f);                         /* sar edx, 0x1f */
            ii(0x1019_ac3f, 2); idiv(ecx);                              /* idiv ecx */
            ii(0x1019_ac41, 3); mov(eax, memd[ds, ebx + 12]);           /* mov eax, [ebx+0xc] */
            ii(0x1019_ac44, 3); cmp(eax, 5);                            /* cmp eax, 0x5 */
            ii(0x1019_ac47, 2); if(jnz(0x1019_ac68, 0x1f)) goto l_0x1019_ac68; /* jnz 0x1019ac68 */
            ii(0x1019_ac49, 3); lea(ecx, memd[ds, eax - 1]);            /* lea ecx, [eax-0x1] */
            ii(0x1019_ac4c, 2); mov(edi, ecx);                          /* mov edi, ecx */
            ii(0x1019_ac4e, 3); shl(edi, 3);                            /* shl edi, 0x3 */
            ii(0x1019_ac51, 3); lea(eax, memd[ds, edx + 1]);            /* lea eax, [edx+0x1] */
            ii(0x1019_ac54, 2); sub(edi, ecx);                          /* sub edi, ecx */
            ii(0x1019_ac56, 2); add(eax, edi);                          /* add eax, edi */
            ii(0x1019_ac58, 2); cmp(eax, esi);                          /* cmp eax, esi */
            ii(0x1019_ac5a, 2); if(jle(0x1019_ac64, 8)) goto l_0x1019_ac64; /* jle 0x1019ac64 */
            ii(0x1019_ac5c, 3); mov(eax, memd[ds, ebx + 12]);           /* mov eax, [ebx+0xc] */
            ii(0x1019_ac5f, 3); sub(eax, 2);                            /* sub eax, 0x2 */
            ii(0x1019_ac62, 2); jmp(0x1019_ac69, 5); goto l_0x1019_ac69; /* jmp 0x1019ac69 */
        l_0x1019_ac64:
            ii(0x1019_ac64, 2); mov(eax, ecx);                          /* mov eax, ecx */
            ii(0x1019_ac66, 2); jmp(0x1019_ac69, 1); goto l_0x1019_ac69; /* jmp 0x1019ac69 */
        l_0x1019_ac68:
            ii(0x1019_ac68, 1); dec(eax);                               /* dec eax */
        l_0x1019_ac69:
            ii(0x1019_ac69, 4); mov(ebx, memd[ss, esp + 28]);           /* mov ebx, [esp+0x1c] */
            ii(0x1019_ac6d, 2); add(ebx, edx);                          /* add ebx, edx */
            ii(0x1019_ac6f, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1019_ac71, 3); shl(eax, 3);                            /* shl eax, 0x3 */
        ...
        l_0x1019_ac7a:
            ii(0x1019_ac7a, 3); cmp(ecx, 1);                            /* cmp ecx, 0x1 */
            ii(0x1019_ac7d, 2); if(jnz(0x1019_ac86, 7)) goto l_0x1019_ac86; /* jnz 0x1019ac86 */
            ii(0x1019_ac7f, 3); mov(eax, memd[ds, eax + 28]);           /* mov eax, [eax+0x1c] */
            ii(0x1019_ac82, 2); sub(eax, ecx);                          /* sub eax, ecx */
            ii(0x1019_ac84, 2); jmp(0x1019_ac89, 3); goto l_0x1019_ac89; /* jmp 0x1019ac89 */
        l_0x1019_ac86:
            ii(0x1019_ac86, 3); mov(eax, memd[ds, eax + 28]);           /* mov eax, [eax+0x1c] */
        l_0x1019_ac89:
