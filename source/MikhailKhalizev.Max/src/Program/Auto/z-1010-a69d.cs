...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_a69d()
        {
            ...
            ii(0x1010_a6b5, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_a6b8, 5); mov(edx, 0x6);                          /* mov edx, 0x6 */
            ii(0x1010_a6bd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_a6cf, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1010_a6d2, 5); call(0x100d_4d78, -0x3_595f);           /* call 0x100d4d78 */
            ii(0x1010_a6d7, 5); mov(esi, 0x101b_aa48);                  /* mov esi, 0x101baa48 */
            ii(0x1010_a6dc, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1010_a6f6, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1010_a705, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_a719, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_a71c, 5); mov(eax, 0x4b);                         /* mov eax, 0x4b */
            ii(0x1010_a721, 5); call(0x1007_5fdc, -0x9_474a);           /* call 0x10075fdc */
            ii(0x1010_a726, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1010_a729, 5); mov(ebx, 0xa);                          /* mov ebx, 0xa */
            ii(0x1010_a72e, 3); lea(edx, memd[ss, ebp - 0x24]);         /* lea edx, [ebp-0x24] */
            ii(0x1010_a731, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1010_a735, 5); call(/* sys */ 0x1017_93f8, 0x6_ecbe);  /* call 0x101793f8 */
            ii(0x1010_a73a, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_a73e, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1010_a740, 2); if(jnz(0x1010_a79b, 0x59)) goto l_0x1010_a79b; /* jnz 0x1010a79b */
            ii(0x1010_a742, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_a745, 7); cmp(memd[ds, eax + 0x363], 0);          /* cmp dword [eax+0x363], 0x0 */
            ...
            ii(0x1010_a758, 2); jmp(0x1010_a762, 0x8); goto l_0x1010_a762; /* jmp 0x1010a762 */
        l_0x1010_a75a:
            ii(0x1010_a75a, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
        ...
        l_0x1010_a762:
            ...
            ii(0x1010_a76c, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1010_a770, 3); cmp(eax, 0x64);                         /* cmp eax, 0x64 */
            ii(0x1010_a773, 2); if(jg(0x1010_a77e, 0x9)) goto l_0x1010_a77e; /* jg 0x1010a77e */
            ii(0x1010_a775, 7); mov(memd[ss, ebp - 0x8], 0x28);         /* mov dword [ebp-0x8], 0x28 */
            ii(0x1010_a77c, 2); jmp(0x1010_a799, 0x1b); goto l_0x1010_a799; /* jmp 0x1010a799 */
        l_0x1010_a77e:
            ii(0x1010_a77e, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1010_a782, 5); cmp(eax, 0xc8);                         /* cmp eax, 0xc8 */
            ii(0x1010_a787, 2); if(jg(0x1010_a792, 0x9)) goto l_0x1010_a792; /* jg 0x1010a792 */
            ii(0x1010_a789, 7); mov(memd[ss, ebp - 0x8], 0x29);         /* mov dword [ebp-0x8], 0x29 */
            ii(0x1010_a790, 2); jmp(0x1010_a799, 0x7); goto l_0x1010_a799; /* jmp 0x1010a799 */
        l_0x1010_a792:
            ii(0x1010_a792, 7); mov(memd[ss, ebp - 0x8], 0x2a);         /* mov dword [ebp-0x8], 0x2a */
        l_0x1010_a799:
        ...
        l_0x1010_a79b:
            ...
            ii(0x1010_a7a5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_a7a8, 7); cmp(memd[ds, eax + 0x363], 0);          /* cmp dword [eax+0x363], 0x0 */
            ...
            ii(0x1010_a7bb, 2); jmp(0x1010_a7c5, 0x8); goto l_0x1010_a7c5; /* jmp 0x1010a7c5 */
        l_0x1010_a7bd:
            ii(0x1010_a7bd, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ii(0x1010_a7c0, 5); mov(memd[ds, 0x101b_ab0c], eax);        /* mov [0x101bab0c], eax */
        l_0x1010_a7c5:
            ii(0x1010_a7c5, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1010_a7c9, 5); cmp(eax, 0xc8);                         /* cmp eax, 0xc8 */
            ii(0x1010_a7ce, 2); if(jg(0x1010_a7d9, 0x9)) goto l_0x1010_a7d9; /* jg 0x1010a7d9 */
            ii(0x1010_a7d0, 7); mov(memd[ss, ebp - 0x8], 0x2b);         /* mov dword [ebp-0x8], 0x2b */
            ii(0x1010_a7d7, 2); jmp(0x1010_a7f4, 0x1b); goto l_0x1010_a7f4; /* jmp 0x1010a7f4 */
        l_0x1010_a7d9:
            ii(0x1010_a7d9, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1010_a7dd, 5); cmp(eax, 0x190);                        /* cmp eax, 0x190 */
            ii(0x1010_a7e2, 2); if(jg(0x1010_a7ed, 0x9)) goto l_0x1010_a7ed; /* jg 0x1010a7ed */
            ii(0x1010_a7e4, 7); mov(memd[ss, ebp - 0x8], 0x2c);         /* mov dword [ebp-0x8], 0x2c */
            ii(0x1010_a7eb, 2); jmp(0x1010_a7f4, 0x7); goto l_0x1010_a7f4; /* jmp 0x1010a7f4 */
        l_0x1010_a7ed:
            ii(0x1010_a7ed, 7); mov(memd[ss, ebp - 0x8], 0x2d);         /* mov dword [ebp-0x8], 0x2d */
        l_0x1010_a7f4:
            ii(0x1010_a7f4, 4); add(memd[ss, ebp - 0x8], -0x28 /* 0xd8 */); /* add dword [ebp-0x8], 0xffffffd8 */
            ii(0x1010_a7f8, 4); movsx(ecx, memw[ss, ebp - 0x8]);        /* movsx ecx, word [ebp-0x8] */
            ii(0x1010_a7fc, 5); mov(ebx, 0x3d);                         /* mov ebx, 0x3d */
            ii(0x1010_a801, 5); mov(edx, 0x8);                          /* mov edx, 0x8 */
            ii(0x1010_a806, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_a828, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_a84c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_a860, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1010_a863, 5); call(0x100d_4d78, -0x3_5af0);           /* call 0x100d4d78 */
            ii(0x1010_a868, 5); mov(edx, 0x101b_ab10);                  /* mov edx, 0x101bab10 */
            ii(0x1010_a86d, 3); mov(esi, memd[ss, ebp - 0x4]);          /* mov esi, [ebp-0x4] */
            ...
            ii(0x1010_a885, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x1010_a894, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
