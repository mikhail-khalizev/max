...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_ba9b()
        {
            ...
            ii(0x1011_bab2, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1011_bab5, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1011_bab8, 7); mov(memd[ss, ebp - 12], 0x7fff);        /* mov dword [ebp-0xc], 0x7fff */
            ii(0x1011_babf, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
