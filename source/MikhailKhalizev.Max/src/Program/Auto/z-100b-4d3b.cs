...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_4d3b()
        {
            ...
            ii(0x100b_4d4d, 6);  sub(esp, 4);                          /* sub esp, 0x4 */
            ii(0x100b_4d53, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_4d56, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_4d58, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_4d65, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_4d72, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_4d75, 3);  add(eax, 0xf);                        /* add eax, 0xf */
            ii(0x100b_4d78, 5);  call(0x1008_afe4, -0x2_9d99);         /* call 0x1008afe4 */
            ii(0x100b_4d7d, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
