...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("7f092158-e0a9-448f-ab0f-e622ae8de270")]
        public void /* sys */ Method_1019_393a()
        {
            ...
            ii(0x1019_3946, 2); if(jbd_func(0x1019_396d, 0x25)) return; /* jb 0x1019396d */
            ii(0x1019_3948, 5); if(jmpd_func(0x1019_3a13, 0xc6)) return; /* jmp 0x10193a13 */
        }
    }
}
