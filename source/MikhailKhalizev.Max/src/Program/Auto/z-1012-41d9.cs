...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_41d9()
        {
            ...
            ii(0x1012_41ef, 3); mov(eax, memd[ss, ebp + 0x18]);         /* mov eax, [ebp+0x18] */
            ii(0x1012_41f2, 1); push(eax);                              /* push eax */
            ii(0x1012_41f3, 3); mov(eax, memd[ss, ebp + 0x14]);         /* mov eax, [ebp+0x14] */
            ...
            ii(0x1012_4201, 2); if(jnz(0x1012_420c, 0x9)) goto l_0x1012_420c; /* jnz 0x1012420c */
            ii(0x1012_4203, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x1012_420a, 2); jmp(0x1012_4259, 0x4d); goto l_0x1012_4259; /* jmp 0x10124259 */
        l_0x1012_420c:
            ii(0x1012_420c, 4); cmp(memd[ss, ebp + 0x1c], 0);           /* cmp dword [ebp+0x1c], 0x0 */
            ...
            ii(0x1012_4218, 3); mov(eax, memd[ss, ebp + 0x14]);         /* mov eax, [ebp+0x14] */
            ...
            ii(0x1012_4226, 2); if(jnz(0x1012_4231, 0x9)) goto l_0x1012_4231; /* jnz 0x10124231 */
            ii(0x1012_4228, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
        ...
        l_0x1012_4233:
            ...
            ii(0x1012_4239, 3); mov(eax, memd[ss, ebp + 0x14]);         /* mov eax, [ebp+0x14] */
            ...
            ii(0x1012_4247, 2); if(jnz(0x1012_4252, 0x9)) goto l_0x1012_4252; /* jnz 0x10124252 */
            ii(0x1012_4249, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x1012_4250, 2); jmp(0x1012_4259, 0x7); goto l_0x1012_4259; /* jmp 0x10124259 */
        l_0x1012_4252:
            ii(0x1012_4252, 7); mov(memd[ss, ebp - 0x4], 0x1);          /* mov dword [ebp-0x4], 0x1 */
        l_0x1012_4259:
            ii(0x1012_4259, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
