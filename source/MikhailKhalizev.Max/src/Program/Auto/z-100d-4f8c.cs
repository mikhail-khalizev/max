...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_4f8c()
        {
            ...
            ii(0x100d_4fa4, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100d_4fa7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_4faa, 3); mov(al, memb[ds, eax + 0x8]);           /* mov al, [eax+0x8] */
            ii(0x100d_4fad, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x100d_4fb0, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
