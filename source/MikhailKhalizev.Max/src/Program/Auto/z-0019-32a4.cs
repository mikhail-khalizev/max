...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_32a4()
        {
            ...
            ii(0x19_32a7, 3);  sub(sp, 4);                             /* sub sp, 0x4 */
            ...
            ii(0x19_32b2, 3);  mov(memw[ss, bp - 4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_32b5, 3);  mov(memw[ss, bp - 2], dx);              /* mov [bp-0x2], dx */
            ii(0x19_32b8, 2);  or(dx, ax);                             /* or dx, ax */
            ii(0x19_32ba, 2);  if(jz(0x19_332a, 0x6e)) goto l_0x19_332a;/* jz 0x332a */
            ii(0x19_32bc, 3);  mov(ax, memw[ss, bp + 8]);              /* mov ax, [bp+0x8] */
            ii(0x19_32bf, 3);  or(ax, memw[ss, bp + 6]);               /* or ax, [bp+0x6] */
            ii(0x19_32c2, 2);  if(jz(0x19_332a, 0x66)) goto l_0x19_332a;/* jz 0x332a */
            ii(0x19_32c4, 3);  push(memw[ss, bp + 8]);                 /* push word [bp+0x8] */
            ii(0x19_32c7, 3);  push(memw[ss, bp + 6]);                 /* push word [bp+0x6] */
            ii(0x19_32ca, 1);  nop();                                  /* nop */
            ii(0x19_32cb, 1);  push(cs);                               /* push cs */
            ii(0x19_32cc, 3);  call(0x19_3b68, 0x899);                 /* call 0x3b68 */
            ii(0x19_32cf, 3);  add(sp, 4);                             /* add sp, 0x4 */
            ii(0x19_32d2, 2);  mov(si, ax);                            /* mov si, ax */
        l_0x19_32d4:
            ii(0x19_32d4, 3);  les(bx, memw[ss, bp - 4]);              /* les bx, [bp-0x4] */
            ii(0x19_32d7, 4);  mov(ax, memw[es, bx + 2]);              /* mov ax, [es:bx+0x2] */
            ii(0x19_32db, 3);  or(ax, memw[es, bx]);                   /* or ax, [es:bx] */
            ii(0x19_32de, 2);  if(jz(0x19_332a, 0x4a)) goto l_0x19_332a;/* jz 0x332a */
            ii(0x19_32e0, 4);  push(memw[es, bx + 2]);                 /* push word [es:bx+0x2] */
            ...
            ii(0x19_3300, 3);  push(memw[ss, bp + 8]);                 /* push word [bp+0x8] */
            ii(0x19_3303, 3);  push(memw[ss, bp + 6]);                 /* push word [bp+0x6] */
            ...
            ii(0x19_3314, 3);  les(bx, memw[ss, bp - 4]);              /* les bx, [bp-0x4] */
            ii(0x19_3317, 3);  mov(ax, memw[es, bx]);                  /* mov ax, [es:bx] */
            ii(0x19_331a, 4);  mov(dx, memw[es, bx + 2]);              /* mov dx, [es:bx+0x2] */
