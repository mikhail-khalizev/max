...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_3f3f()
        {
            ...
            ii(0x100a_3f64, 3);  lea(ebx, memd[ss, ebp - 16]);         /* lea ebx, [ebp-0x10] */
            ...
            ii(0x100a_3f7b, 3);  lea(ebx, memd[ss, ebp - 12]);         /* lea ebx, [ebp-0xc] */
            ...
            ii(0x100a_3f99, 3);  lea(ebx, memd[ds, eax - 36]);         /* lea ebx, [eax-0x24] */
        ...
        l_0x100a_3fc6:
            ii(0x100a_3fc6, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x100a_3fc9, 5);  call(0x1007_6bf8, -0x2_d3d6);         /* call 0x10076bf8 */
        l_0x100a_3fce:
            ii(0x100a_3fce, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100a_3fd0, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x100a_3fdc, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x100a_3fdf, 5);  call(0x1008_adc4, -0x1_9220);         /* call 0x1008adc4 */
            ii(0x100a_3fe4, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x100a_3fe7, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x100a_3fea, 3);  mov(edx, memd[ds, eax + 2]);          /* mov edx, [eax+0x2] */
            ii(0x100a_3fed, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x100a_3ff0, 3);  call_abs(memd[ds, edx + 16]);         /* call dword [edx+0x10] */
        ...
        l_0x100a_3ffa:
            ii(0x100a_3ffa, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x100a_3ffd, 5);  call(0x1007_6bf8, -0x2_d40a);         /* call 0x10076bf8 */
        l_0x100a_4002:
            ii(0x100a_4002, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100a_4004, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ...
            ii(0x100a_4010, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x100a_4013, 5);  call(0x100a_ab4c, 0x6b34);            /* call 0x100aab4c */
            ii(0x100a_4018, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100a_401b, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x100a_401e, 3);  mov(edx, memd[ds, eax + 2]);          /* mov edx, [eax+0x2] */
            ii(0x100a_4021, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x100a_4024, 3);  call_abs(memd[ds, edx + 12]);         /* call dword [edx+0xc] */
        ...
        l_0x100a_402c:
            ...
            ii(0x100a_4037, 3);  lea(ebx, memd[ss, ebp - 12]);         /* lea ebx, [ebp-0xc] */
        ...
        l_0x100a_4045:
            ii(0x100a_4045, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x100a_4048, 5);  call(0x1007_6bf8, -0x2_d455);         /* call 0x10076bf8 */
        l_0x100a_404d:
            ii(0x100a_404d, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100a_404f, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ...
            ii(0x100a_405b, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x100a_405e, 5);  call(0x100a_ab4c, 0x6ae9);            /* call 0x100aab4c */
            ii(0x100a_4063, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x100a_4066, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
            ii(0x100a_4069, 3);  mov(edx, memd[ds, eax + 2]);          /* mov edx, [eax+0x2] */
            ii(0x100a_406c, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
            ii(0x100a_406f, 3);  call_abs(memd[ds, edx + 12]);         /* call dword [edx+0xc] */
        ...
        l_0x100a_4077:
            ...
            ii(0x100a_407a, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x100a_407d, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100a_407f, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x100a_4082, 5);  call(0x100a_a178, 0x60f1);            /* call 0x100aa178 */
            ii(0x100a_4087, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100a_4089, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        //  ii(0x100a_4095, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
        //  ii(0x100a_4098, 5);  call(0x100a_a178, 0x60db);            /* call 0x100aa178 */
        //  ii(0x100a_409d, 2);  xor(edx, edx);                        /* xor edx, edx */
        //  ii(0x100a_409f, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        //  ii(0x100a_40a2, 5);  call(0x1008_8bbc, -0x1_b4eb);         /* call 0x10088bbc */
        l_0x100a_40a7:
            ii(0x100a_40a7, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
