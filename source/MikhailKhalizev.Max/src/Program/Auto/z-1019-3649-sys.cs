...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_3649()
        {
            ...
            ii(0x1019_3658, 3); mov(eax, memd[ss, ebp + 0x1c]);         /* mov eax, [ebp+0x1c] */
            ii(0x1019_365b, 2); shr(eax, 0x1);                          /* shr eax, 1 */
            ii(0x1019_365d, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1019_3660, 3); mov(eax, memd[ss, ebp + 0xc]);          /* mov eax, [ebp+0xc] */
            ii(0x1019_3663, 3); sub(eax, memd[ss, ebp + 0x1c]);         /* sub eax, [ebp+0x1c] */
            ii(0x1019_3666, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1019_3669, 5); mov(eax, memd[ds, Definitions.video_bytes_per_line]); /* mov eax, [0x10209c98] */
            ii(0x1019_366e, 4); cmp(memd[ss, ebp + 0x2c], 0);           /* cmp dword [ebp+0x2c], 0x0 */
            ii(0x1019_3672, 2); if(jz(0x1019_3676, 0x2)) goto l_0x1019_3676; /* jz 0x10193676 */
            ii(0x1019_3674, 2); add(eax, eax);                          /* add eax, eax */
        l_0x1019_3676:
            ii(0x1019_3676, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1019_3679, 3); sub(eax, memd[ss, ebp + 0x1c]);         /* sub eax, [ebp+0x1c] */
            ii(0x1019_367c, 3); sub(eax, memd[ss, ebp + 0x1c]);         /* sub eax, [ebp+0x1c] */
            ii(0x1019_367f, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1019_3682, 3); mov(eax, memd[ss, ebp + 0x18]);         /* mov eax, [ebp+0x18] */
            ii(0x1019_3685, 3); mul(memd[ss, ebp + 0xc]);               /* mul dword [ebp+0xc] */
            ii(0x1019_3688, 3); add(eax, memd[ss, ebp + 0x14]);         /* add eax, [ebp+0x14] */
            ii(0x1019_368b, 3); add(memd[ss, ebp + 0x8], eax);          /* add [ebp+0x8], eax */
            ii(0x1019_368e, 3); mov(eax, memd[ss, ebp + 0x14]);         /* mov eax, [ebp+0x14] */
            ii(0x1019_3691, 3); add(memd[ss, ebp + 0x24], eax);         /* add [ebp+0x24], eax */
            ii(0x1019_3694, 3); mov(eax, memd[ss, ebp + 0xc]);          /* mov eax, [ebp+0xc] */
            ii(0x1019_3697, 2); shr(eax, 0x1);                          /* shr eax, 1 */
            ii(0x1019_3699, 4); cmp(memd[ss, ebp + 0x2c], 0);           /* cmp dword [ebp+0x2c], 0x0 */
            ii(0x1019_369d, 2); if(jz(0x1019_36a7, 0x8)) goto l_0x1019_36a7; /* jz 0x101936a7 */
            ii(0x1019_369f, 3); cmp(memd[ss, ebp + 0x14], eax);         /* cmp [ebp+0x14], eax */
            ii(0x1019_36a2, 2); if(jb(0x1019_36a7, 0x3)) goto l_0x1019_36a7; /* jb 0x101936a7 */
            ii(0x1019_36a4, 3); sub(memd[ss, ebp + 0x24], eax);         /* sub [ebp+0x24], eax */
        l_0x1019_36a7:
            ii(0x1019_36a7, 3); mov(eax, memd[ss, ebp + 0x18]);         /* mov eax, [ebp+0x18] */
            ii(0x1019_36aa, 3); add(memd[ss, ebp + 0x28], eax);         /* add [ebp+0x28], eax */
            ...
            ii(0x1019_36bc, 3); mov(eax, memd[ss, ebp + 0x28]);         /* mov eax, [ebp+0x28] */
            ii(0x1019_36bf, 3); mul(memd[ss, ebp - 0x10]);              /* mul dword [ebp-0x10] */
            ii(0x1019_36c2, 3); add(eax, memd[ss, ebp + 0x24]);         /* add eax, [ebp+0x24] */
            ii(0x1019_36c5, 3); add(eax, memd[ss, ebp + 0x24]);         /* add eax, [ebp+0x24] */
            ii(0x1019_36c8, 2); add(edi, eax);                          /* add edi, eax */
            ii(0x1019_36ca, 7); test(memd[ss, ebp + 0x2c], 0x1);        /* test dword [ebp+0x2c], 0x1 */
            ii(0x1019_36d1, 2); if(jz(0x1019_36d9, 0x6)) goto l_0x1019_36d9; /* jz 0x101936d9 */
            ii(0x1019_36d3, 6); add(edi, memd[ds, Definitions.video_bytes_per_line]); /* add edi, [0x10209c98] */
        l_0x1019_36d9:
            ii(0x1019_36d9, 3); mov(esi, memd[ss, ebp + 0x8]);          /* mov esi, [ebp+0x8] */
            ii(0x1019_36dc, 3); mov(ebx, memd[ss, ebp + 0x20]);         /* mov ebx, [ebp+0x20] */
        l_0x1019_36df:
            ii(0x1019_36df, 3); mov(ecx, memd[ss, ebp - 0x8]);          /* mov ecx, [ebp-0x8] */
        ...
        l_0x1019_36eb:
            ...
            ii(0x1019_36f4, 3); mov(al, memb[ds, esi - 0x1]);           /* mov al, [esi-0x1] */
            ...
            ii(0x1019_370a, 3); add(esi, memd[ss, ebp - 0xc]);          /* add esi, [ebp-0xc] */
            ii(0x1019_370d, 3); add(edi, memd[ss, ebp - 0x14]);         /* add edi, [ebp-0x14] */
        ...
        l_0x1019_3718:
            ii(0x1019_3718, 3); mov(esi, memd[ss, ebp + 0x8]);          /* mov esi, [ebp+0x8] */
            ii(0x1019_371b, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1019_371e, 3); mul(memd[ss, ebp + 0x28]);              /* mul dword [ebp+0x28] */
            ii(0x1019_3721, 7); test(memd[ss, ebp + 0x2c], 0x1);        /* test dword [ebp+0x2c], 0x1 */
            ii(0x1019_3728, 2); if(jz(0x1019_3730, 0x6)) goto l_0x1019_3730; /* jz 0x10193730 */
            ii(0x1019_372a, 6); add(eax, memd[ds, Definitions.video_bytes_per_line]); /* add eax, [0x10209c98] */
        l_0x1019_3730:
            ii(0x1019_3730, 3); add(eax, memd[ss, ebp + 0x24]);         /* add eax, [ebp+0x24] */
            ii(0x1019_3733, 3); add(eax, memd[ss, ebp + 0x24]);         /* add eax, [ebp+0x24] */
            ...
            ii(0x1019_3741, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x1019_3754, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x1019_375d:
            ...
            ii(0x1019_3764, 3); add(eax, memd[ss, ebp - 0x14]);         /* add eax, [ebp-0x14] */
            ii(0x1019_3767, 5); mov(edx, 0);                            /* mov edx, 0x0 */
            ii(0x1019_376c, 3); div(memd[ss, ebp - 0x10]);              /* div dword [ebp-0x10] */
            ii(0x1019_376f, 3); cmp(memd[ss, ebp + 0x20], eax);         /* cmp [ebp+0x20], eax */
            ii(0x1019_3772, 2); if(jae(0x1019_3777, 0x3)) goto l_0x1019_3777; /* jae 0x10193777 */
            ii(0x1019_3774, 3); mov(eax, memd[ss, ebp + 0x20]);         /* mov eax, [ebp+0x20] */
        l_0x1019_3777:
            ii(0x1019_3777, 2); or(eax, eax);                           /* or eax, eax */
            ii(0x1019_3779, 2); if(jz(0x1019_37b2, 0x37)) goto l_0x1019_37b2; /* jz 0x101937b2 */
            ii(0x1019_377b, 3); sub(memd[ss, ebp + 0x20], eax);         /* sub [ebp+0x20], eax */
            ii(0x1019_377e, 6); lea(ebx, 0x1020_9550);                  /* lea ebx, [0x10209550] */
        l_0x1019_3784:
            ii(0x1019_3784, 3); mov(ecx, memd[ss, ebp - 0x8]);          /* mov ecx, [ebp-0x8] */
        ...
        l_0x1019_378a:
            ...
            ii(0x1019_3793, 3); mov(al, memb[ds, esi - 0x1]);           /* mov al, [esi-0x1] */
            ...
            ii(0x1019_37a9, 3); add(esi, memd[ss, ebp - 0xc]);          /* add esi, [ebp-0xc] */
            ii(0x1019_37ac, 3); add(edi, memd[ss, ebp - 0x14]);         /* add edi, [ebp-0x14] */
            ii(0x1019_37af, 1); dec(eax);                               /* dec eax */
            ii(0x1019_37b0, 2); if(jnz(0x1019_3784, -0x2e)) goto l_0x1019_3784; /* jnz 0x10193784 */
        l_0x1019_37b2:
            ii(0x1019_37b2, 3); or(eax, memd[ss, ebp + 0x20]);          /* or eax, [ebp+0x20] */
            ...
            ii(0x1019_37c6, 2); if(jns(0x1019_37cd, 0x5)) goto l_0x1019_37cd; /* jns 0x101937cd */
        ...
        l_0x1019_37da:
            ...
            ii(0x1019_37e3, 3); mov(al, memb[ds, esi - 0x1]);           /* mov al, [esi-0x1] */
        ...
        l_0x1019_37f8:
            ...
            ii(0x1019_37fd, 3); add(memd[ss, ebp - 0x4], eax);          /* add [ebp-0x4], eax */
            ...
            ii(0x1019_380e, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1019_3811, 6); call_abs(memd[ds, 0x1020_9c90]);        /* call dword [0x10209c90] */
            ii(0x1019_3817, 1); pop(eax);                               /* pop eax */
            ii(0x1019_3818, 3); mov(ecx, memd[ss, ebp - 0x8]);          /* mov ecx, [ebp-0x8] */
        ...
        l_0x1019_3829:
            ...
            ii(0x1019_3832, 3); mov(al, memb[ds, esi - 0x1]);           /* mov al, [esi-0x1] */
        ...
        l_0x1019_3847:
            ii(0x1019_3847, 3); add(esi, memd[ss, ebp - 0xc]);          /* add esi, [ebp-0xc] */
            ii(0x1019_384a, 3); add(edi, memd[ss, ebp - 0x14]);         /* add edi, [ebp-0x14] */
            ii(0x1019_384d, 3); dec(memd[ss, ebp + 0x20]);              /* dec dword [ebp+0x20] */
