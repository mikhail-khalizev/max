...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_c085()
        {
            ...
            ii(0x100c_c09c, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_c09f, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100c_c0a2, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100c_c0a5, 3); add(edx, 0x13);                         /* add edx, 0x13 */
            ii(0x100c_c0a8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_c0b8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_c0c8, 3); cmp(eax, memd[ss, ebp - 0x8]);          /* cmp eax, [ebp-0x8] */
            ii(0x100c_c0cb, 2); if(jz(0x100c_c0d6, 0x9)) goto l_0x100c_c0d6; /* jz 0x100cc0d6 */
            ii(0x100c_c0cd, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
            ii(0x100c_c0d1, 5); jmp(0x100c_c5da, 0x504); goto l_0x100c_c5da; /* jmp 0x100cc5da */
        l_0x100c_c0d6:
            ii(0x100c_c0d6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c0d9, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100c_c0dc, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x100c_c0df, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x100c_c0e2, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x100c_c0e5, 3); call_abs(memd[ds, edx + 0x78]);         /* call dword [edx+0x78] */
            ii(0x100c_c0e8, 2); test(al, al);                           /* test al, al */
            ii(0x100c_c0ea, 6); if(jz(0x100c_c1fa, 0x10a)) goto l_0x100c_c1fa; /* jz 0x100cc1fa */
            ii(0x100c_c0f0, 4); or(memb[ss, ebp - 0x10], 0x1);          /* or byte [ebp-0x10], 0x1 */
            ii(0x100c_c0f4, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x100c_c0f7, 5); call(Definitions.my_ctor_0x101b_3b58, -0x4_1058); /* call 0x1008b0a4 */
            ii(0x100c_c0fc, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100c_c0ff, 4); and(memb[ss, ebp - 0x10], -0x2 /* 0xfe */); /* and byte [ebp-0x10], 0xfe */
            ii(0x100c_c103, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c106, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100c_c109, 5); call(0x1007_6574, -0x5_5b9a);           /* call 0x10076574 */
            ii(0x100c_c10e, 4); cmp(memb[ds, eax + 0x3e], 0x3);         /* cmp byte [eax+0x3e], 0x3 */
            ...
            ii(0x100c_c122, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x100c_c125, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x100c_c128, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x100c_c12b, 4); cmp(memd[ss, ebp - 0x24], 0);           /* cmp dword [ebp-0x24], 0x0 */
            ii(0x100c_c12f, 2); if(jz(0x100c_c166, 0x35)) goto l_0x100c_c166; /* jz 0x100cc166 */
            ii(0x100c_c131, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_c143, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ii(0x100c_c146, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_c153, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x100c_c156, 5); call(0x100b_3871, -0x1_88ea);           /* call 0x100b3871 */
            ii(0x100c_c15b, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ii(0x100c_c15e, 3); mov(eax, memd[ss, ebp - 0x28]);         /* mov eax, [ebp-0x28] */
            ii(0x100c_c161, 3); mov(memd[ss, ebp - 0x2c], eax);         /* mov [ebp-0x2c], eax */
            ii(0x100c_c164, 2); jmp(0x100c_c16c, 0x6); goto l_0x100c_c16c; /* jmp 0x100cc16c */
        l_0x100c_c166:
            ii(0x100c_c166, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x100c_c169, 3); mov(memd[ss, ebp - 0x2c], eax);         /* mov [ebp-0x2c], eax */
        l_0x100c_c16c:
            ii(0x100c_c16c, 3); mov(edx, memd[ss, ebp - 0x2c]);         /* mov edx, [ebp-0x2c] */
            ii(0x100c_c16f, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x100c_c172, 5); call(0x1008_afe4, -0x4_1193);           /* call 0x1008afe4 */
            ii(0x100c_c177, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x100c_c18b, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x100c_c18f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100c_c191, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
        ...
        l_0x100c_c19e:
            ii(0x100c_c19e, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100c_c1a1, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x100c_c1a4, 5); call(0x1008_afe4, -0x4_11c5);           /* call 0x1008afe4 */
            ii(0x100c_c1a9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_c1ba, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100c_c1bd, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100c_c1fa:
            ...
            ii(0x100c_c1fc, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_c209, 2); if(jz(0x100c_c213, 0x8)) goto l_0x100c_c213; /* jz 0x100cc213 */
            ii(0x100c_c20b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c20e, 5); call(0x100c_c6df, 0x4cc);               /* call 0x100cc6df */
        l_0x100c_c213:
            ii(0x100c_c213, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100c_c215, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_c228, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c22b, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100c_c22e, 5); call(0x1007_6574, -0x5_5cbf);           /* call 0x10076574 */
            ii(0x100c_c233, 3); mov(al, memb[ds, eax + 0x4e]);          /* mov al, [eax+0x4e] */
            ...
            ii(0x100c_c23f, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100c_c242, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_c254, 2); if(jnz(0x100c_c258, 0x2)) goto l_0x100c_c258; /* jnz 0x100cc258 */
        l_0x100c_c256:
        ...
        l_0x100c_c258:
            ...
            ii(0x100c_c262, 3); mov(memd[ss, ebp - 0x30], eax);         /* mov [ebp-0x30], eax */
            ii(0x100c_c265, 3); mov(eax, memd[ss, ebp - 0x30]);         /* mov eax, [ebp-0x30] */
            ii(0x100c_c268, 3); mov(memd[ss, ebp - 0x34], eax);         /* mov [ebp-0x34], eax */
            ii(0x100c_c26b, 4); cmp(memd[ss, ebp - 0x34], 0);           /* cmp dword [ebp-0x34], 0x0 */
            ii(0x100c_c26f, 2); if(jz(0x100c_c296, 0x25)) goto l_0x100c_c296; /* jz 0x100cc296 */
            ii(0x100c_c271, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ii(0x100c_c274, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c277, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100c_c27a, 5); call(0x1007_65d0, -0x5_5caf);           /* call 0x100765d0 */
            ii(0x100c_c27f, 3); mov(ecx, memd[ss, ebp - 0x30]);         /* mov ecx, [ebp-0x30] */
            ...
            ii(0x100c_c28b, 3); mov(memd[ss, ebp - 0x38], eax);         /* mov [ebp-0x38], eax */
            ii(0x100c_c28e, 3); mov(eax, memd[ss, ebp - 0x38]);         /* mov eax, [ebp-0x38] */
            ii(0x100c_c291, 3); mov(memd[ss, ebp - 0x3c], eax);         /* mov [ebp-0x3c], eax */
            ii(0x100c_c294, 2); jmp(0x100c_c29c, 0x6); goto l_0x100c_c29c; /* jmp 0x100cc29c */
        l_0x100c_c296:
            ii(0x100c_c296, 3); mov(eax, memd[ss, ebp - 0x34]);         /* mov eax, [ebp-0x34] */
            ii(0x100c_c299, 3); mov(memd[ss, ebp - 0x3c], eax);         /* mov [ebp-0x3c], eax */
        l_0x100c_c29c:
            ii(0x100c_c29c, 3); mov(edx, memd[ss, ebp - 0x3c]);         /* mov edx, [ebp-0x3c] */
            ii(0x100c_c29f, 3); lea(eax, memd[ss, ebp - 0x40]);         /* lea eax, [ebp-0x40] */
            ii(0x100c_c2a2, 5); call(0x1008_b060, -0x4_1247);           /* call 0x1008b060 */
            ii(0x100c_c2a7, 3); lea(eax, memd[ss, ebp - 0x40]);         /* lea eax, [ebp-0x40] */
            ...
            ii(0x100c_c2bb, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x100c_c2bf, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100c_c2c1, 3); lea(eax, memd[ss, ebp - 0x40]);         /* lea eax, [ebp-0x40] */
        ...
        l_0x100c_c2ce:
            ii(0x100c_c2ce, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
            ii(0x100c_c2d2, 5); jmp(0x100c_c5da, 0x303); goto l_0x100c_c5da; /* jmp 0x100cc5da */
        l_0x100c_c2d7:
            ii(0x100c_c2d7, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c2da, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100c_c2dd, 5); call(0x1007_6574, -0x5_5d6e);           /* call 0x10076574 */
            ii(0x100c_c2e2, 4); cmp(memb[ds, eax + 0x3e], 0x3);         /* cmp byte [eax+0x3e], 0x3 */
            ...
            ii(0x100c_c2f3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c2f6, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
        ...
        l_0x100c_c341:
            ...
            ii(0x100c_c351, 3); cmp(eax, memd[ss, ebp - 0x8]);          /* cmp eax, [ebp-0x8] */
            ii(0x100c_c354, 2); if(jz(0x100c_c35b, 0x5)) goto l_0x100c_c35b; /* jz 0x100cc35b */
        l_0x100c_c356:
        ...
        l_0x100c_c35b:
            ...
            ii(0x100c_c365, 3); mov(memd[ss, ebp - 0x44], eax);         /* mov [ebp-0x44], eax */
            ii(0x100c_c368, 3); mov(eax, memd[ss, ebp - 0x44]);         /* mov eax, [ebp-0x44] */
            ii(0x100c_c36b, 3); mov(memd[ss, ebp - 0x48], eax);         /* mov [ebp-0x48], eax */
            ii(0x100c_c36e, 4); cmp(memd[ss, ebp - 0x48], 0);           /* cmp dword [ebp-0x48], 0x0 */
            ii(0x100c_c372, 2); if(jz(0x100c_c3ac, 0x38)) goto l_0x100c_c3ac; /* jz 0x100cc3ac */
            ii(0x100c_c374, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c377, 3); mov(memd[ss, ebp - 0x4c], eax);         /* mov [ebp-0x4c], eax */
            ii(0x100c_c37a, 3); mov(eax, memd[ss, ebp - 0x4c]);         /* mov eax, [ebp-0x4c] */
            ii(0x100c_c37d, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x100c_c380, 3); mov(eax, memd[ss, ebp - 0x4c]);         /* mov eax, [ebp-0x4c] */
            ii(0x100c_c383, 3); call_abs(memd[ds, edx + 0x74]);         /* call dword [edx+0x74] */
            ii(0x100c_c386, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x100c_c389, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_c396, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100c_c399, 3); mov(eax, memd[ss, ebp - 0x44]);         /* mov eax, [ebp-0x44] */
            ii(0x100c_c39c, 5); call(0x1008_bd0b, -0x4_0696);           /* call 0x1008bd0b */
            ii(0x100c_c3a1, 3); mov(memd[ss, ebp - 0x50], eax);         /* mov [ebp-0x50], eax */
            ii(0x100c_c3a4, 3); mov(eax, memd[ss, ebp - 0x50]);         /* mov eax, [ebp-0x50] */
            ii(0x100c_c3a7, 3); mov(memd[ss, ebp - 0x54], eax);         /* mov [ebp-0x54], eax */
            ii(0x100c_c3aa, 2); jmp(0x100c_c3b2, 0x6); goto l_0x100c_c3b2; /* jmp 0x100cc3b2 */
        l_0x100c_c3ac:
            ii(0x100c_c3ac, 3); mov(eax, memd[ss, ebp - 0x48]);         /* mov eax, [ebp-0x48] */
            ii(0x100c_c3af, 3); mov(memd[ss, ebp - 0x54], eax);         /* mov [ebp-0x54], eax */
        l_0x100c_c3b2:
            ii(0x100c_c3b2, 3); mov(edx, memd[ss, ebp - 0x54]);         /* mov edx, [ebp-0x54] */
            ii(0x100c_c3b5, 3); lea(eax, memd[ss, ebp - 0x58]);         /* lea eax, [ebp-0x58] */
            ii(0x100c_c3b8, 5); call(0x1008_b060, -0x4_135d);           /* call 0x1008b060 */
            ii(0x100c_c3bd, 3); lea(eax, memd[ss, ebp - 0x58]);         /* lea eax, [ebp-0x58] */
            ...
            ii(0x100c_c3d1, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x100c_c3d5, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100c_c3d7, 3); lea(eax, memd[ss, ebp - 0x58]);         /* lea eax, [ebp-0x58] */
        ...
        l_0x100c_c3e4:
            ii(0x100c_c3e4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c3e7, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100c_c3ea, 5); call(0x1007_6574, -0x5_5e7b);           /* call 0x10076574 */
            ii(0x100c_c3ef, 3); mov(ebx, memd[ds, eax + 0x1a]);         /* mov ebx, [eax+0x1a] */
            ii(0x100c_c3f2, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100c_c3f5, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c3f8, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100c_c3fb, 5); call(0x1007_6574, -0x5_5e8c);           /* call 0x10076574 */
            ii(0x100c_c400, 3); mov(edx, memd[ds, eax + 0x18]);         /* mov edx, [eax+0x18] */
            ii(0x100c_c403, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100c_c406, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_c428, 2); if(jnz(0x100c_c433, 0x9)) goto l_0x100c_c433; /* jnz 0x100cc433 */
            ii(0x100c_c42a, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
        ...
        l_0x100c_c433:
            ...
            ii(0x100c_c43e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c441, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x100c_c451, 2); if(jnz(0x100c_c455, 0x2)) goto l_0x100c_c455; /* jnz 0x100cc455 */
        l_0x100c_c453:
            ii(0x100c_c453, 2); jmp(0x100c_c45e, 0x9); goto l_0x100c_c45e; /* jmp 0x100cc45e */
        l_0x100c_c455:
            ii(0x100c_c455, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
            ii(0x100c_c459, 5); jmp(0x100c_c5da, 0x17c); goto l_0x100c_c5da; /* jmp 0x100cc5da */
        l_0x100c_c45e:
            ii(0x100c_c45e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c461, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x100c_c464, 5); call(0x1007_6574, -0x5_5ef5);           /* call 0x10076574 */
            ii(0x100c_c469, 4); test(memb[ds, eax + 0x13], 0x2);        /* test byte [eax+0x13], 0x2 */
            ii(0x100c_c46d, 6); if(jz(0x100c_c521, 0xae)) goto l_0x100c_c521; /* jz 0x100cc521 */
            ii(0x100c_c473, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_c480, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c483, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100c_c486, 5); call(0x1007_6574, -0x5_5f17);           /* call 0x10076574 */
            ii(0x100c_c48b, 4); mov(dx, memw[ds, edx + 0x1a]);          /* mov dx, [edx+0x1a] */
            ii(0x100c_c48f, 4); mov(memw[ds, eax + 0x41], dx);          /* mov [eax+0x41], dx */
            ii(0x100c_c493, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_c4a0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c4a3, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100c_c4a6, 5); call(0x1007_6574, -0x5_5f37);           /* call 0x10076574 */
            ii(0x100c_c4ab, 4); mov(dx, memw[ds, edx + 0x1c]);          /* mov dx, [edx+0x1c] */
            ii(0x100c_c4af, 4); mov(memw[ds, eax + 0x43], dx);          /* mov [eax+0x43], dx */
            ii(0x100c_c4b3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_c4c0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c4c3, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100c_c4c6, 5); call(0x1007_6574, -0x5_5f57);           /* call 0x10076574 */
            ii(0x100c_c4cb, 4); mov(dx, memw[ds, edx + 0x41]);          /* mov dx, [edx+0x41] */
            ii(0x100c_c4cf, 4); cmp(dx, memw[ds, eax + 0x1a]);          /* cmp dx, [eax+0x1a] */
            ii(0x100c_c4d3, 2); if(jnz(0x100c_c4f7, 0x22)) goto l_0x100c_c4f7; /* jnz 0x100cc4f7 */
            ii(0x100c_c4d5, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_c4e2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c4e5, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100c_c4e8, 5); call(0x1007_6574, -0x5_5f79);           /* call 0x10076574 */
            ii(0x100c_c4ed, 4); mov(dx, memw[ds, edx + 0x43]);          /* mov dx, [edx+0x43] */
            ii(0x100c_c4f1, 4); cmp(dx, memw[ds, eax + 0x1c]);          /* cmp dx, [eax+0x1c] */
            ii(0x100c_c4f5, 2); if(jz(0x100c_c4f9, 0x2)) goto l_0x100c_c4f9; /* jz 0x100cc4f9 */
        l_0x100c_c4f7:
            ii(0x100c_c4f7, 2); jmp(0x100c_c508, 0xf); goto l_0x100c_c508; /* jmp 0x100cc508 */
        l_0x100c_c4f9:
            ii(0x100c_c4f9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c4fc, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100c_c4ff, 5); call(0x1007_6574, -0x5_5f90);           /* call 0x10076574 */
            ii(0x100c_c504, 4); inc(memw[ds, eax + 0x41]);              /* inc word [eax+0x41] */
        l_0x100c_c508:
            ii(0x100c_c508, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x100c_c50a, 5); mov(edx, 0x1b);                         /* mov edx, 0x1b */
            ii(0x100c_c50f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_c51f, 2); jmp(0x100c_c529, 0x8); goto l_0x100c_c529; /* jmp 0x100cc529 */
        l_0x100c_c521:
            ii(0x100c_c521, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100c_c52e:
            ...
            ii(0x100c_c533, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c536, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100c_c539, 5); call(0x1007_65d0, -0x5_5f6e);           /* call 0x100765d0 */
            ii(0x100c_c53e, 3); mov(ecx, memd[ss, ebp - 0x8]);          /* mov ecx, [ebp-0x8] */
            ...
            ii(0x100c_c55c, 3); mov(memd[ss, ebp - 0x5c], eax);         /* mov [ebp-0x5c], eax */
            ii(0x100c_c55f, 3); mov(eax, memd[ss, ebp - 0x5c]);         /* mov eax, [ebp-0x5c] */
            ii(0x100c_c562, 3); mov(memd[ss, ebp - 0x60], eax);         /* mov [ebp-0x60], eax */
            ii(0x100c_c565, 4); cmp(memd[ss, ebp - 0x60], 0);           /* cmp dword [ebp-0x60], 0x0 */
            ...
            ii(0x100c_c571, 3); mov(ecx, memd[ss, ebp - 0x8]);          /* mov ecx, [ebp-0x8] */
            ii(0x100c_c574, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_c581, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_c58e, 3); mov(eax, memd[ss, ebp - 0x5c]);         /* mov eax, [ebp-0x5c] */
            ii(0x100c_c591, 5); call(0x100b_43b0, -0x1_81e6);           /* call 0x100b43b0 */
            ii(0x100c_c596, 3); mov(memd[ss, ebp - 0x64], eax);         /* mov [ebp-0x64], eax */
            ii(0x100c_c599, 3); mov(eax, memd[ss, ebp - 0x64]);         /* mov eax, [ebp-0x64] */
            ii(0x100c_c59c, 3); mov(memd[ss, ebp - 0x68], eax);         /* mov [ebp-0x68], eax */
            ii(0x100c_c59f, 2); jmp(0x100c_c5a7, 0x6); goto l_0x100c_c5a7; /* jmp 0x100cc5a7 */
        l_0x100c_c5a1:
            ii(0x100c_c5a1, 3); mov(eax, memd[ss, ebp - 0x60]);         /* mov eax, [ebp-0x60] */
            ii(0x100c_c5a4, 3); mov(memd[ss, ebp - 0x68], eax);         /* mov [ebp-0x68], eax */
        l_0x100c_c5a7:
            ii(0x100c_c5a7, 3); mov(edx, memd[ss, ebp - 0x68]);         /* mov edx, [ebp-0x68] */
            ii(0x100c_c5aa, 3); lea(eax, memd[ss, ebp - 0x6c]);         /* lea eax, [ebp-0x6c] */
            ii(0x100c_c5ad, 5); call(0x1008_b060, -0x4_1552);           /* call 0x1008b060 */
            ii(0x100c_c5b2, 3); lea(eax, memd[ss, ebp - 0x6c]);         /* lea eax, [ebp-0x6c] */
            ...
            ii(0x100c_c5c8, 3); lea(eax, memd[ss, ebp - 0x6c]);         /* lea eax, [ebp-0x6c] */
            ii(0x100c_c5cb, 5); call(0x1008_8b7c, -0x4_3a54);           /* call 0x10088b7c */
        l_0x100c_c5d0:
            ii(0x100c_c5d0, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x100c_c5d4, 2); jmp(0x100c_c5da, 0x4); goto l_0x100c_c5da; /* jmp 0x100cc5da */
        l_0x100c_c5d6:
            ii(0x100c_c5d6, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
        l_0x100c_c5da:
            ii(0x100c_c5da, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
