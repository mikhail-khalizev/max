...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_b1b2()
        {
            ...
            ii(0x100e_b1ca, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100e_b1cd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_b1d0, 4); cmp(memb[ds, eax + 0x1a], 0);           /* cmp byte [eax+0x1a], 0x0 */
            ...
            ii(0x100e_b1dd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_b1e0, 3); mov(memd[ds, eax + 0x36], edx);         /* mov [eax+0x36], edx */
        l_0x100e_b1e3:
            ii(0x100e_b1e3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_b1e6, 4); mov(memb[ds, eax + 0x1a], 0x1);         /* mov byte [eax+0x1a], 0x1 */
            ii(0x100e_b1ea, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_b1ed, 4); mov(memb[ds, eax + 0x2b], 0);           /* mov byte [eax+0x2b], 0x0 */
            ii(0x100e_b1f1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_b1f4, 4); mov(memb[ds, eax + 0x32], 0x1);         /* mov byte [eax+0x32], 0x1 */
            ii(0x100e_b1f8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_b1fb, 3); mov(eax, memd[ds, eax + 0x23]);         /* mov eax, [eax+0x23] */
            ii(0x100e_b1fe, 5); call(Definitions.sys_strlen, 0x8_6cc4); /* call 0x10171ec7 */
            ii(0x100e_b203, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100e_b205, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_b208, 4); mov(memw[ds, eax + 0x2c], dx);          /* mov [eax+0x2c], dx */
            ...
            ii(0x100e_b215, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
