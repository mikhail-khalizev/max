...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_b0a7()
        {
            ...
            ii(0x1010_b0bf, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_b0c2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_b0c5, 3); mov(eax, memd[ds, eax + 0xd]);          /* mov eax, [eax+0xd] */
            ii(0x1010_b0c8, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x1010_b0cb, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_b0ce, 4); imul(eax, memd[ss, ebp - 0x8], 0x14);   /* imul eax, [ebp-0x8], 0x14 */
            ...
            ii(0x1010_b0eb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_b0ee, 5); call(0x1010_a4a1, -0xc52);              /* call 0x1010a4a1 */
            ii(0x1010_b0f3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_b0f6, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1010_b0f8, 3); mov(eax, memd[ds, eax + 0x12]);         /* mov eax, [eax+0x12] */
