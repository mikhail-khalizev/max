...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("c8fa015f-6cfa-4326-ab39-79717586aaec")]
        public void Method_1013_61f9()
        {
            ii(0x1013_61f9, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x1013_61fe, 5); calld(Definitions.sys_check_available_stack_size, 0x2fb4f); /* call 0x10165d52 */
        ...
        l_0x1013_626e:
            ...
            ii(0x1013_6278, 5); calld(Definitions.sys_new_arr, 0x2fd93); /* call 0x10166010 */
            ...
            ii(0x1013_62a2, 5); calld(Definitions.sys_memset, 0x2fb39); /* call 0x10165de0 */
            ii(0x1013_62a7, 3); mov(eax, memd_a32[ss, ebp - 0x8]);      /* mov eax, [ebp-0x8] */
            ii(0x1013_62aa, 5); calld(Definitions.sys_new_arr, 0x2fd61); /* call 0x10166010 */
            ...
            ii(0x1013_62d4, 5); calld(Definitions.sys_memset, 0x2fb07); /* call 0x10165de0 */
            ii(0x1013_62d9, 3); mov(eax, memd_a32[ss, ebp - 0x8]);      /* mov eax, [ebp-0x8] */
            ii(0x1013_62dc, 5); calld(Definitions.sys_new_arr, 0x2fd2f); /* call 0x10166010 */
            ...
            ii(0x1013_6308, 5); calld(Definitions.sys_memset, 0x2fad3); /* call 0x10165de0 */
        l_0x1013_630d:
