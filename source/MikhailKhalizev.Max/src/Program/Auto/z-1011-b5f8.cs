...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_b5f8()
        {
            ...
            ii(0x1011_b610, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_b613, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_b616, 3); mov(edx, memd[ds, eax + 0x14]);         /* mov edx, [eax+0x14] */
            ii(0x1011_b619, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1011_b61c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_b62b, 2); if(jnz(0x1011_b636, 0x9)) goto l_0x1011_b636; /* jnz 0x1011b636 */
            ii(0x1011_b62d, 7); mov(memd[ss, ebp - 0x8], 0x1);          /* mov dword [ebp-0x8], 0x1 */
            ii(0x1011_b634, 2); jmp(0x1011_b63d, 0x7); goto l_0x1011_b63d; /* jmp 0x1011b63d */
        l_0x1011_b636:
            ii(0x1011_b636, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
        l_0x1011_b63d:
            ii(0x1011_b63d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_b640, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1011_b643, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
