...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("8236da91-6b05-4202-bfe7-e4a2fc0fe83b")]
        public void Method_1015_2bea()
        {
            ii(0x1015_2bea, 5); pushd(0x28);                            /* push 0x28 */
            ii(0x1015_2bef, 5); calld(Definitions.sys_check_available_stack_size, 0x1315e); /* call 0x10165d52 */
        ...
        l_0x1015_2caf:
            ...
            ii(0x1015_2cb9, 1); retd(); return;                         /* ret */
        }
    }
}
