...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_3f91()
        {
            ...
            ii(0x1011_3fa8, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1011_3fab, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1011_3fae, 7); mov(memd[ss, ebp - 12], 0);             /* mov dword [ebp-0xc], 0x0 */
        l_0x1011_3fb5:
            ii(0x1011_3fb5, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x1011_3fb9, 3); add(eax, memd[ss, ebp - 4]);            /* add eax, [ebp-0x4] */
            ii(0x1011_3fbc, 6); mov(al, memb[ds, eax + 156]);           /* mov al, [eax+0x9c] */
            ii(0x1011_3fc2, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x1011_3fc7, 3); cmp(eax, 1);                            /* cmp eax, 0x1 */
            ii(0x1011_3fca, 2); if(jz(0x1011_3fd8, 0xc)) goto l_0x1011_3fd8; /* jz 0x10113fd8 */
            ii(0x1011_3fcc, 3); inc(memd[ss, ebp - 12]);                /* inc dword [ebp-0xc] */
            ii(0x1011_3fcf, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x1011_3fd3, 3); cmp(eax, 3);                            /* cmp eax, 0x3 */
            ii(0x1011_3fd6, 2); if(jnz(0x1011_3fb5, -0x23)) goto l_0x1011_3fb5; /* jnz 0x10113fb5 */
        l_0x1011_3fd8:
            ii(0x1011_3fd8, 4); movsx(edx, memw[ss, ebp - 12]);         /* movsx edx, word [ebp-0xc] */
            ii(0x1011_3fdc, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
