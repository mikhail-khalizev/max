...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_ed71()
        {
            ...
            ii(0x100f_ed98, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x100f_ed9b, 5); call(0x1007_64b8, -0x8_88e8);           /* call 0x100764b8 */
        l_0x100f_eda0:
            ii(0x100f_eda0, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100f_eda2, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ...
            ii(0x100f_edae, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x100f_edb1, 5); call(0x1007_63a0, -0x8_8a16);           /* call 0x100763a0 */
            ii(0x100f_edb6, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100f_edb8, 3); mov(dl, memb[ds, eax + 38]);            /* mov dl, [eax+0x26] */
            ...
            ii(0x100f_edc3, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x100f_edc6, 5); call(0x1007_63a0, -0x8_8a2b);           /* call 0x100763a0 */
            ii(0x100f_edcb, 4); cmp(memb[ds, eax + 61], 0x1a);          /* cmp byte [eax+0x3d], 0x1a */
        ...
        l_0x100f_edea:
            ...
            ii(0x100f_edec, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
