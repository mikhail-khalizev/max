...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("c9767185-52b6-4185-9f9e-4448ce0c58e1")]
        public void Method_100f_ed71()
        {
            ii(0x100f_ed71, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x100f_ed76, 5); calld(Definitions.sys_check_available_stack_size, 0x6_6fd7); /* call 0x10165d52 */
            ...
            ii(0x100f_ed91, 5); calld(0x1007_6338, -0x8_8a5e);          /* call 0x10076338 */
            ii(0x100f_ed96, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100f_ed98, 3); lea(eax, ebp - 0xc);                    /* lea eax, [ebp-0xc] */
            ii(0x100f_ed9b, 5); calld(0x1007_64b8, -0x8_88e8);          /* call 0x100764b8 */
        l_0x100f_eda0:
            ii(0x100f_eda0, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100f_eda2, 3); lea(eax, ebp - 0xc);                    /* lea eax, [ebp-0xc] */
            ii(0x100f_eda5, 5); calld(0x1013_ad71, 0x3_bfc7);           /* call 0x1013ad71 */
            ...
            ii(0x100f_edb1, 5); calld(0x1007_63a0, -0x8_8a16);          /* call 0x100763a0 */
            ...
            ii(0x100f_edc6, 5); calld(0x1007_63a0, -0x8_8a2b);          /* call 0x100763a0 */
        ...
        l_0x100f_edd3:
            ...
            ii(0x100f_edd6, 5); calld(0x1007_63a0, -0x8_8a3b);          /* call 0x100763a0 */
            ii(0x100f_eddb, 5); calld(0x1015_02a0, 0x5_14c0);           /* call 0x101502a0 */
        l_0x100f_ede0:
            ii(0x100f_ede0, 3); lea(eax, ebp - 0xc);                    /* lea eax, [ebp-0xc] */
            ii(0x100f_ede3, 5); calld(0x1007_6bf8, -0x8_81f0);          /* call 0x10076bf8 */
        ...
        l_0x100f_edea:
            ...
            ii(0x100f_edef, 5); calld(0x1007_5f6c, -0x8_8e88);          /* call 0x10075f6c */
