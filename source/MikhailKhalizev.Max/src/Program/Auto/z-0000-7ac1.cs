...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x7ad1:
            ...
            ii(0x7ad5, 3);  lea(ax, memw[ss, bp - 86]);                /* lea ax, [bp-0x56] */
            ii(0x7ad8, 1);  push(ax);                                  /* push ax */
            ii(0x7ad9, 3);  call(0x8526, 0xa4a);                       /* call 0x8526 */
            ii(0x7adc, 3);  add(sp, 6);                                /* add sp, 0x6 */
            ii(0x7adf, 3);  lea(ax, memw[ss, bp - 30]);                /* lea ax, [bp-0x1e] */
            ii(0x7ae2, 3);  mov(memw[ss, bp - 26], ax);                /* mov [bp-0x1a], ax */
            ii(0x7ae5, 3);  mov(memw[ss, bp - 24], ss);                /* mov [bp-0x18], ss */
            ...
            ii(0x7af1, 3);  add(ax, memw[ss, bp - 26]);                /* add ax, [bp-0x1a] */
            ...
            ii(0x7aff, 3);  mov(memw[ss, bp - 68], ax);                /* mov [bp-0x44], ax */
            ii(0x7b02, 3);  mov(memb[ss, bp - 66], bl);                /* mov [bp-0x42], bl */
            ii(0x7b05, 4);  mov(memb[ss, bp - 58], 0xc0);              /* mov byte [bp-0x3a], 0xc0 */
            ii(0x7b09, 5);  mov(memw[ss, bp - 56], 0x8000);            /* mov word [bp-0x38], 0x8000 */
            ii(0x7b0e, 2);  mov(al, 0xf2);                             /* mov al, 0xf2 */
            ii(0x7b10, 3);  mov(memb[ss, bp - 57], al);                /* mov [bp-0x39], al */
            ii(0x7b13, 3);  mov(memb[ss, bp - 65], al);                /* mov [bp-0x41], al */
            ii(0x7b16, 4);  mov(memb[ss, bp - 17], 0x87);              /* mov byte [bp-0x11], 0x87 */
            ii(0x7b1a, 3);  mov(ax, 1);                                /* mov ax, 0x1 */
            ii(0x7b1d, 3);  mov(memw[ss, bp - 70], ax);                /* mov [bp-0x46], ax */
            ii(0x7b20, 3);  mov(memw[ss, bp - 62], ax);                /* mov [bp-0x3e], ax */
            ii(0x7b23, 3);  mov(memw[ss, bp - 14], ax);                /* mov [bp-0xe], ax */
            ii(0x7b26, 3);  lea(ax, memw[ss, bp - 86]);                /* lea ax, [bp-0x56] */
            ii(0x7b29, 3);  mov(memw[ss, bp - 26], ax);                /* mov [bp-0x1a], ax */
            ii(0x7b2c, 3);  mov(memw[ss, bp - 24], ss);                /* mov [bp-0x18], ss */
            ii(0x7b2f, 3);  mov(memw[ss, bp - 10], ax);                /* mov [bp-0xa], ax */
            ii(0x7b32, 2);  mov(ax, ss);                               /* mov ax, ss */
            ii(0x7b34, 3);  mov(memw[ss, bp - 38], ax);                /* mov [bp-0x26], ax */
            ii(0x7b37, 5);  mov(memw[ss, bp - 30], 0xfe);              /* mov word [bp-0x1e], 0xfe */
            ii(0x7b3c, 3);  lea(ax, memw[ss, bp - 38]);                /* lea ax, [bp-0x26] */
            ii(0x7b3f, 1);  push(ax);                                  /* push ax */
            ii(0x7b40, 3);  lea(cx, memw[ss, bp - 18]);                /* lea cx, [bp-0x12] */
            ...
            ii(0x7b53, 3);  mov(memw[ss, bp - 22], ax);                /* mov [bp-0x16], ax */
            ii(0x7b56, 3);  mov(memw[ss, bp - 20], dx);                /* mov [bp-0x14], dx */
            ...
            ii(0x7b68, 3);  mov(memw[ss, bp - 28], si);                /* mov [bp-0x1c], si */
            ii(0x7b6b, 4);  sub(memw[es, bx + 6], cx);                 /* sub [es:bx+0x6], cx */
            ii(0x7b6f, 5);  mov(memw[ss, bp - 30], 0xfc);              /* mov word [bp-0x1e], 0xfc */
            ii(0x7b74, 4);  mov(memb[ss, bp - 17], 0x87);              /* mov byte [bp-0x11], 0x87 */
            ii(0x7b78, 5);  mov(memw[ss, bp - 14], 1);                 /* mov word [bp-0xe], 0x1 */
            ii(0x7b7d, 3);  lea(ax, memw[ss, bp - 38]);                /* lea ax, [bp-0x26] */
            ii(0x7b80, 1);  push(ax);                                  /* push ax */
            ii(0x7b81, 3);  lea(ax, memw[ss, bp - 18]);                /* lea ax, [bp-0x12] */
            ...
            ii(0x7b8e, 3);  mov(ax, memw[ss, bp - 28]);                /* mov ax, [bp-0x1c] */
            ii(0x7b91, 3);  les(bx, memw[ss, bp - 22]);                /* les bx, [bp-0x16] */
