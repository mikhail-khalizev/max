...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_da28()
        {
            ...
            ii(0x100f_da51, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ii(0x100f_da54, 5); call(Definitions.my_ctor_0x101b_4184, -0x8_6f69); /* call 0x10076af0 */
            ii(0x100f_da59, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ii(0x100f_da5c, 5); call(Definitions.my_ctor_0x101b_4184, -0x8_6f71); /* call 0x10076af0 */
            ii(0x100f_da61, 4); mov(memb[ss, ebp - 12], 0);             /* mov byte [ebp-0xc], 0x0 */
            ...
            ii(0x100f_da86, 4); mov(memw[ss, ebp - 24], ax);            /* mov [ebp-0x18], ax */
            ...
            ii(0x100f_daa5, 4); mov(memw[ss, ebp - 22], ax);            /* mov [ebp-0x16], ax */
            ii(0x100f_daa9, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x100f_daac, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
        ...
        l_0x100f_dab1:
            ...
            ii(0x100f_dac4, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ii(0x100f_dac8, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x100f_daca, 3); mov(memd[ss, ebp - 16], edx);           /* mov [ebp-0x10], edx */
        l_0x100f_dacd:
            ii(0x100f_dacd, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ...
            ii(0x100f_dadd, 3); mov(eax, memd[ss, ebp - 22]);           /* mov eax, [ebp-0x16] */
            ii(0x100f_dae0, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x100f_dae3, 4); cmp(memb[ss, ebp - 12], 0);             /* cmp byte [ebp-0xc], 0x0 */
            ...
            ii(0x100f_daf6, 4); movsx(edx, memw[ss, ebp - 20]);         /* movsx edx, word [ebp-0x14] */
            ii(0x100f_dafa, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x100f_dafc, 3); mov(memd[ss, ebp - 20], edx);           /* mov [ebp-0x14], edx */
        l_0x100f_daff:
        ...
        l_0x100f_db01:
            ...
            ii(0x100f_db04, 3); add(memd[ss, ebp - 20], eax);           /* add [ebp-0x14], eax */
        l_0x100f_db07:
            ii(0x100f_db07, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ...
            ii(0x100f_db61, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ii(0x100f_db65, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x100f_db67, 4); mov(memw[ss, ebp - 28], ax);            /* mov [ebp-0x1c], ax */
            ...
            ii(0x100f_dbb5, 4); movsx(edx, memw[ss, ebp - 20]);         /* movsx edx, word [ebp-0x14] */
            ii(0x100f_dbb9, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x100f_dbbb, 4); mov(memw[ss, ebp - 26], ax);            /* mov [ebp-0x1a], ax */
            ii(0x100f_dbbf, 4); movsx(ebx, memw[ss, ebp - 4]);          /* movsx ebx, word [ebp-0x4] */
            ii(0x100f_dbc3, 3); lea(edx, memd[ss, ebp - 28]);           /* lea edx, [ebp-0x1c] */
            ii(0x100f_dbc6, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
        ...
        l_0x100f_dbda:
            ii(0x100f_dbda, 4); cmp(memb[ss, ebp - 12], 0);             /* cmp byte [ebp-0xc], 0x0 */
            ii(0x100f_dbde, 2); if(jnz(0x100f_dbe6, 6)) goto l_0x100f_dbe6; /* jnz 0x100fdbe6 */
            ii(0x100f_dbe0, 4); mov(memb[ss, ebp - 36], 1);             /* mov byte [ebp-0x24], 0x1 */
            ii(0x100f_dbe4, 2); jmp(0x100f_dbea, 4); goto l_0x100f_dbea; /* jmp 0x100fdbea */
        l_0x100f_dbe6:
            ii(0x100f_dbe6, 4); mov(memb[ss, ebp - 36], 0);             /* mov byte [ebp-0x24], 0x0 */
        l_0x100f_dbea:
            ii(0x100f_dbea, 3); mov(al, memb[ss, ebp - 36]);            /* mov al, [ebp-0x24] */
            ii(0x100f_dbed, 3); mov(memb[ss, ebp - 12], al);            /* mov [ebp-0xc], al */
