...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_da28()
        {
            ...
            ii(0x100f_da3f, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100f_da42, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100f_da45, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_da65, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x100f_da8a, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
        ...
        l_0x100f_dab1:
            ii(0x100f_dab1, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
        ...
        l_0x100f_dacd:
            ...
            ii(0x100f_dae9, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
        ...
        l_0x100f_daff:
            ii(0x100f_daff, 2); jmp(0x100f_db07, 0x6); goto l_0x100f_db07; /* jmp 0x100fdb07 */
        l_0x100f_db01:
            ii(0x100f_db01, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100f_db07:
            ...
            ii(0x100f_db17, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x100f_db2b, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x100f_db4d, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x100f_db6b, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x100f_db7f, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x100f_dba1, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x100f_dbbf, 4); movsx(ebx, memw[ss, ebp - 0x4]);        /* movsx ebx, word [ebp-0x4] */
        ...
        l_0x100f_dbda:
            ...
            ii(0x100f_dbde, 2); if(jnz(0x100f_dbe6, 0x6)) goto l_0x100f_dbe6; /* jnz 0x100fdbe6 */
            ii(0x100f_dbe0, 4); mov(memb[ss, ebp - 0x24], 0x1);         /* mov byte [ebp-0x24], 0x1 */
            ii(0x100f_dbe4, 2); jmp(0x100f_dbea, 0x4); goto l_0x100f_dbea; /* jmp 0x100fdbea */
        l_0x100f_dbe6:
