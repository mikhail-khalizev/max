...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_1b15()
        {
            ...
            ii(0x19_1b1f, 5); mov(memw[ss, bp - 0x6], 0);               /* mov word [bp-0x6], 0x0 */
            ii(0x19_1b24, 5); mov(memw[ss, bp - 0x4], 0x392c);          /* mov word [bp-0x4], 0x392c */
            ii(0x19_1b29, 3); mov(memw[ss, bp - 0x2], ds);              /* mov [bp-0x2], ds */
            ii(0x19_1b2c, 3); mov(ax, memw[ss, bp + 0xa]);              /* mov ax, [bp+0xa] */
            ...
            ii(0x19_1b39, 2); if(jnz(0x19_1b3e, 0x3)) goto l_0x19_1b3e; /* jnz 0x1b3e */
            ii(0x19_1b3b, 3); jmp(0x19_1bd6, 0x98); goto l_0x19_1bd6;   /* jmp 0x1bd6 */
        l_0x19_1b3e:
            ii(0x19_1b3e, 1); dec(ax);                                  /* dec ax */
            ii(0x19_1b3f, 2); if(jnz(0x19_1b44, 0x3)) goto l_0x19_1b44; /* jnz 0x1b44 */
            ii(0x19_1b41, 3); jmp(0x19_1bee, 0xaa); goto l_0x19_1bee;   /* jmp 0x1bee */
        l_0x19_1b44:
            ii(0x19_1b44, 5); mov(memw[ss, bp + 0xa], 0);               /* mov word [bp+0xa], 0x0 */
            ii(0x19_1b49, 2); jmp(0x19_1b6f, 0x24); goto l_0x19_1b6f;   /* jmp 0x1b6f */
        l_0x19_1b4b:
            ii(0x19_1b4b, 4); cmp(memw[ss, bp + 0xc], 0);               /* cmp word [bp+0xc], 0x0 */
            ii(0x19_1b4f, 2); if(jz(0x19_1b6f, 0x1e)) goto l_0x19_1b6f; /* jz 0x1b6f */
            ii(0x19_1b51, 3); push(memw[ss, bp + 0xc]);                 /* push word [bp+0xc] */
        ...
        l_0x19_1b60:
            ii(0x19_1b60, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x19_1b63, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ii(0x19_1b66, 3); call(0x19_1e1c, 0x2b3);                   /* call 0x1e1c */
            ii(0x19_1b69, 3); add(sp, 0xe);                             /* add sp, 0xe */
            ii(0x19_1b6c, 3); add(memw[ss, bp - 0x4], ax);              /* add [bp-0x4], ax */
        l_0x19_1b6f:
            ii(0x19_1b6f, 3); les(bx, memw[ss, bp + 0x12]);             /* les bx, [bp+0x12] */
            ii(0x19_1b72, 4); push(memw[es, bx + 0x2]);                 /* push word [es:bx+0x2] */
            ii(0x19_1b76, 3); push(memw[es, bx]);                       /* push word [es:bx] */
            ii(0x19_1b79, 3); push(memw[ss, bp + 0x10]);                /* push word [bp+0x10] */
            ii(0x19_1b7c, 3); push(memw[ss, bp + 0xe]);                 /* push word [bp+0xe] */
            ii(0x19_1b7f, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x19_1b82, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0x19_1b95, 3); les(bx, memw[ss, bp + 0x12]);             /* les bx, [bp+0x12] */
            ii(0x19_1b98, 4); push(memw[es, bx + 0x2]);                 /* push word [es:bx+0x2] */
            ii(0x19_1b9c, 3); push(memw[es, bx]);                       /* push word [es:bx] */
            ii(0x19_1b9f, 3); push(memw[ss, bp + 0x10]);                /* push word [bp+0x10] */
            ii(0x19_1ba2, 3); push(memw[ss, bp + 0xe]);                 /* push word [bp+0xe] */
            ii(0x19_1ba5, 3); push(memw[ss, bp + 0xc]);                 /* push word [bp+0xc] */
            ii(0x19_1ba8, 3); push(memw[ss, bp + 0xa]);                 /* push word [bp+0xa] */
            ii(0x19_1bab, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x19_1bae, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ...
            ii(0x19_1bc0, 4); call_far_ind(ds, 0x3a74);                 /* call far word [0x3a74] */
            ii(0x19_1bc4, 3); add(sp, 0x1a);                            /* add sp, 0x1a */
            ii(0x19_1bc7, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
        l_0x19_1bca:
            ii(0x19_1bca, 4); cmp(memw[ss, bp - 0x6], 0);               /* cmp word [bp-0x6], 0x0 */
            ii(0x19_1bce, 2); if(jz(0x19_1c09, 0x39)) goto l_0x19_1c09; /* jz 0x1c09 */
            ii(0x19_1bd0, 3); mov(ax, memw[ss, bp - 0x6]);              /* mov ax, [bp-0x6] */
            ii(0x19_1bd3, 1); pop(ds);                                  /* pop ds */
            ii(0x19_1bd4, 1); leave();                                  /* leave */
            ii(0x19_1bd5, 1); retf(); return;                           /* retf */
        l_0x19_1bd6:
            ii(0x19_1bd6, 4); cmp(memw[ss, bp + 0xc], 0);               /* cmp word [bp+0xc], 0x0 */
            ii(0x19_1bda, 2); if(jz(0x19_1b6f, -0x6d)) goto l_0x19_1b6f; /* jz 0x1b6f */
            ii(0x19_1bdc, 3); push(memw[ss, bp + 0xc]);                 /* push word [bp+0xc] */
        ...
        l_0x19_1bee:
            ii(0x19_1bee, 4); cmp(memw[ss, bp + 0xc], 0);               /* cmp word [bp+0xc], 0x0 */
            ii(0x19_1bf2, 2); if(jnz(0x19_1bf7, 0x3)) goto l_0x19_1bf7; /* jnz 0x1bf7 */
            ii(0x19_1bf4, 3); jmp(0x19_1b6f, -0x88); goto l_0x19_1b6f;  /* jmp 0x1b6f */
        l_0x19_1bf7:
            ii(0x19_1bf7, 3); push(memw[ss, bp + 0xc]);                 /* push word [bp+0xc] */
        ...
        l_0x19_1c09:
            ii(0x19_1c09, 3); mov(bx, memw[ss, bp + 0xa]);              /* mov bx, [bp+0xa] */
            ...
            ii(0x19_1c18, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x19_1c1b, 5); mov(memw[ss, bp - 0xa], 0x392c);          /* mov word [bp-0xa], 0x392c */
        ...
        l_0x19_1c2c:
            ii(0x19_1c2c, 3); mov(bx, memw[ss, bp - 0xa]);              /* mov bx, [bp-0xa] */
