...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_19ee()
        {
            ...
            ii(0x100f_1a06, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x100f_1a40, 7); mov(memd[ss, ebp - 0x8], 0xb);          /* mov dword [ebp-0x8], 0xb */
            ii(0x100f_1a47, 2); jmp(0x100f_1a4f, 0x6); goto l_0x100f_1a4f; /* jmp 0x100f1a4f */
        l_0x100f_1a49:
            ii(0x100f_1a49, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_1a4c, 3); dec(memd[ss, ebp - 0x8]);               /* dec dword [ebp-0x8] */
        l_0x100f_1a4f:
            ii(0x100f_1a4f, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x100f_1a5e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_1a61, 3); mov(memd[ds, eax + 0x18], edx);         /* mov [eax+0x18], edx */
            ii(0x100f_1a64, 4); imul(eax, memd[ss, ebp - 0x8], 0x14);   /* imul eax, [ebp-0x8], 0x14 */
            ii(0x100f_1a68, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x100f_1a6b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100f_1a75:
            ii(0x100f_1a75, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
