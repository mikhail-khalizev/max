...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_4984()
        {
            ...
            ii(0x17_498f, 5); mov(memw[ss, bp - 0xa], 0x8);             /* mov word [bp-0xa], 0x8 */
            ii(0x17_4994, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_4997, 3); mov(memw[ss, bp - 0xc], ax);              /* mov [bp-0xc], ax */
            ii(0x17_499a, 3); les(bx, memw[ss, bp - 0xc]);              /* les bx, [bp-0xc] */
            ii(0x17_499d, 4); mov(al, memb[es, bx + 0x6]);              /* mov al, [es:bx+0x6] */
            ii(0x17_49a1, 2); sub(ah, ah);                              /* sub ah, ah */
            ii(0x17_49a3, 2); sub(dx, dx);                              /* sub dx, dx */
            ii(0x17_49a5, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_49a8, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ...
            ii(0x17_49d4, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x17_49d7, 3); mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
            ii(0x17_49da, 2); jmp(0x17_49eb, 0xf); goto l_0x17_49eb;    /* jmp 0x49eb */
        l_0x17_49dc:
            ii(0x17_49dc, 3); mov(al, memb[ss, bp - 0x4]);              /* mov al, [bp-0x4] */
            ii(0x17_49df, 3); and(ax, 0xf);                             /* and ax, 0xf */
            ii(0x17_49e2, 3); mov(cx, memw[es, bx]);                    /* mov cx, [es:bx] */
            ii(0x17_49e5, 3); mov(memw[ss, bp - 0x8], cx);              /* mov [bp-0x8], cx */
            ii(0x17_49e8, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
        l_0x17_49eb:
            ii(0x17_49eb, 5); test(memw[ss, bp - 0x6], 0xffff);         /* test word [bp-0x6], 0xffff */
