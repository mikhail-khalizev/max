...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ sys_new()
        {
            ...
            ii(0x1016_5e02, 3); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1016_5e05, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1016_5e07, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1016_5e09, 2); if(jnz(0x1016_5e0e, 3)) goto l_0x1016_5e0e; /* jnz 0x10165e0e */
            ii(0x1016_5e0b, 3); lea(edx, memd[ds, eax + 1]);            /* lea edx, [eax+0x1] */
        l_0x1016_5e0e:
            ...
            ii(0x1016_5e25, 2); if(jz(0x1016_5e30, 9)) goto l_0x1016_5e30; /* jz 0x10165e30 */
        ...
        l_0x1016_5e30:
            ...
            ii(0x1016_5e35, 4); mov(memd[ss, esp + 4], eax);            /* mov [esp+0x4], eax */
            ii(0x1016_5e39, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1016_5e3b, 2); if(jz(0x1016_5e43, 6)) goto l_0x1016_5e43; /* jz 0x10165e43 */
            ii(0x1016_5e3d, 4); call_abs(memd[ss, esp + 4]);            /* call dword [esp+0x4] */
            ii(0x1016_5e41, 2); jmp(0x1016_5e0e, -0x35); goto l_0x1016_5e0e; /* jmp 0x10165e0e */
        l_0x1016_5e43:
            ii(0x1016_5e43, 2); mov(eax, ebx);                          /* mov eax, ebx */
            ii(0x1016_5e45, 3); add(esp, 8);                            /* add esp, 0x8 */
