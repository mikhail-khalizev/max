...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_b155()
        {
            ...
            ii(0x1010_b167, 6); sub(esp, 4);                            /* sub esp, 0x4 */
            ii(0x1010_b16d, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1010_b170, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_b173, 3); mov(edx, memd[ds, eax + 13]);           /* mov edx, [eax+0xd] */
            ...
            ii(0x1010_b183, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_b186, 5); call(0x1010_a564, -0xc27);              /* call 0x1010a564 */
            ii(0x1010_b18b, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_b18e, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1010_b190, 3); mov(eax, memd[ds, eax + 18]);           /* mov eax, [eax+0x12] */
