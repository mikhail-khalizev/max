...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_49e3()
        {
            ...
            ii(0x100b_49f9, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ...
            ii(0x100b_4a0d, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x100b_4a24, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
        ...
        l_0x100b_4a30:
            ii(0x100b_4a30, 4); mov(memb[ss, ebp - 16], 1);             /* mov byte [ebp-0x10], 0x1 */
            ii(0x100b_4a34, 2); jmp(0x100b_4a3a, 4); goto l_0x100b_4a3a; /* jmp 0x100b4a3a */
        l_0x100b_4a36:
            ii(0x100b_4a36, 4); mov(memb[ss, ebp - 16], 0);             /* mov byte [ebp-0x10], 0x0 */
        l_0x100b_4a3a:
            ii(0x100b_4a3a, 3); mov(al, memb[ss, ebp - 16]);            /* mov al, [ebp-0x10] */
            ii(0x100b_4a3d, 3); mov(memb[ss, ebp - 20], al);            /* mov [ebp-0x14], al */
            ii(0x100b_4a40, 3); mov(al, memb[ss, ebp - 20]);            /* mov al, [ebp-0x14] */
