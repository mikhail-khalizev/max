...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_8e39()
        {
            ...
            ii(0x1013_8e50, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1013_8e53, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1013_8e56, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_8e59, 5); call(0x1007_6338, -0xc_2b26);           /* call 0x10076338 */
            ii(0x1013_8e5e, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1013_8e60, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x1013_8e63, 5); call(0x1007_64b8, -0xc_29b0);           /* call 0x100764b8 */
            ii(0x1013_8e68, 2); jmp(0x1013_8e72, 8); goto l_0x1013_8e72; /* jmp 0x10138e72 */
        l_0x1013_8e6a:
            ii(0x1013_8e6a, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x1013_8e6d, 5); call(0x1007_6bf8, -0xc_227a);           /* call 0x10076bf8 */
        l_0x1013_8e72:
            ii(0x1013_8e72, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_8e74, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ...
            ii(0x1013_8e80, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x1013_8e83, 5); call(0x1007_63a0, -0xc_2ae8);           /* call 0x100763a0 */
            ii(0x1013_8e88, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_8e8a, 3); mov(dl, memb[ds, eax + 38]);            /* mov dl, [eax+0x26] */
            ii(0x1013_8e8d, 4); movsx(eax, memw[ss, ebp - 4]);          /* movsx eax, word [ebp-0x4] */
            ii(0x1013_8e91, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x1013_8e93, 2); if(jnz(0x1013_8ea2, 0xd)) goto l_0x1013_8ea2; /* jnz 0x10138ea2 */
            ii(0x1013_8e95, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
        ...
        l_0x1013_8ea4:
            ...
            ii(0x1013_8ea6, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
