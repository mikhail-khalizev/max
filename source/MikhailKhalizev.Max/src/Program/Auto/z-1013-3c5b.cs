...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_3c5b()
        {
            ...
            ii(0x1013_3c72, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_3c75, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
        l_0x1013_3c78:
            ii(0x1013_3c78, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_3c7b, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x1013_3c7e, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x1013_3c81, 3); cmp(memb[ds, eax], 0x20);               /* cmp byte [eax], 0x20 */
            ii(0x1013_3c84, 2); if(jnz(0x1013_3c8e, 0x8)) goto l_0x1013_3c8e; /* jnz 0x10133c8e */
            ii(0x1013_3c86, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_3c89, 3); inc(memw[ds, eax]);                     /* inc word [eax] */
            ii(0x1013_3c8c, 2); jmp(0x1013_3c78, -0x16); goto l_0x1013_3c78; /* jmp 0x10133c78 */
        l_0x1013_3c8e:
            ii(0x1013_3c8e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_3c91, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x1013_3c94, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x1013_3c97, 5); call(/* sys */ 0x1017_90ce, 0x4_5432);  /* call 0x101790ce */
            ii(0x1013_3c9c, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
        l_0x1013_3c9f:
            ii(0x1013_3c9f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_3ca2, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x1013_3ca5, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ...
            ii(0x1013_3cad, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_3cb0, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x1013_3cb3, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ...
            ii(0x1013_3cbf, 2); if(jnz(0x1013_3cc3, 0x2)) goto l_0x1013_3cc3; /* jnz 0x10133cc3 */
        l_0x1013_3cc1:
            ii(0x1013_3cc1, 2); jmp(0x1013_3ccb, 0x8); goto l_0x1013_3ccb; /* jmp 0x10133ccb */
        l_0x1013_3cc3:
            ii(0x1013_3cc3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
