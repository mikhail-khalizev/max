...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_edfa()
        {
            ...
            ii(0x1014_ee17, 4);  or(memb[ss, ebp - 12], 1);            /* or byte [ebp-0xc], 0x1 */
            ii(0x1014_ee1b, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
            ii(0x1014_ee1e, 5);  call(Definitions.my_ctor_0x101b_38f8, -0xd_8733);/* call 0x100766f0 */
            ii(0x1014_ee23, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x1014_ee26, 4);  and(memb[ss, ebp - 12], -2 /* 0xfe */);/* and byte [ebp-0xc], 0xfe */
            ii(0x1014_ee2a, 5);  mov(eax, 0xe1);                       /* mov eax, 0xe1 */
            ii(0x1014_ee2f, 5);  call(Definitions.sys_new, 0x1_6fcc);  /* call 0x10165e00 */
            ii(0x1014_ee34, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1014_ee37, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1014_ee3a, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1014_ee3d, 4);  cmp(memd[ss, ebp - 24], 0);           /* cmp dword [ebp-0x18], 0x0 */
            ...
            ii(0x1014_ee46, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1014_ee49, 5);  call(0x1014_8bc2, -0x628c);           /* call 0x10148bc2 */
            ii(0x1014_ee4e, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1014_ee51, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x1014_ee54, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1014_ee57, 2);  jmp(0x1014_ee5f, 6); goto l_0x1014_ee5f;/* jmp 0x1014ee5f */
        l_0x1014_ee59:
            ii(0x1014_ee59, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x1014_ee5c, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
        l_0x1014_ee5f:
            ii(0x1014_ee5f, 3);  mov(edx, memd[ss, ebp - 16]);         /* mov edx, [ebp-0x10] */
            ii(0x1014_ee62, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
            ii(0x1014_ee65, 5);  call(0x1007_6630, -0xd_883a);         /* call 0x10076630 */
            ii(0x1014_ee6a, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1014_ee6c, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
            ...
            ii(0x1014_ee7c, 3);  lea(edx, memd[ss, ebp - 36]);         /* lea edx, [ebp-0x24] */
            ...
            ii(0x1014_ee89, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
        ...
        //  ii(0x1014_ee95, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
