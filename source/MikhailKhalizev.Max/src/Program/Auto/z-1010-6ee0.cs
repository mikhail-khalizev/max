...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_6ee0()
        {
            ...
            ii(0x1010_6ef8, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_6efb, 5); mov(ebx, 0x32);                         /* mov ebx, 0x32 */
            ii(0x1010_6f00, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_6f02, 3); lea(eax, memd[ss, ebp - 0x38]);         /* lea eax, [ebp-0x38] */
            ii(0x1010_6f05, 5); call(Definitions.sys_memset, 0x5_eed6); /* call 0x10165de0 */
            ii(0x1010_6f0a, 7); mov(memd[ss, ebp - 0x28], 0x4);         /* mov dword [ebp-0x28], 0x4 */
            ii(0x1010_6f11, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_6f14, 3); and(eax, 0xf);                          /* and eax, 0xf */
            ii(0x1010_6f17, 3); mov(memd[ss, ebp - 0x34], eax);         /* mov [ebp-0x34], eax */
            ii(0x1010_6f1a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_6f1d, 3); shr(eax, 0x4);                          /* shr eax, 0x4 */
            ii(0x1010_6f20, 5); and(eax, 0xffff);                       /* and eax, 0xffff */
            ii(0x1010_6f25, 4); mov(memw[ss, ebp - 0x16], ax);          /* mov [ebp-0x16], ax */
            ii(0x1010_6f29, 3); lea(edx, memd[ss, ebp - 0x38]);         /* lea edx, [ebp-0x38] */
