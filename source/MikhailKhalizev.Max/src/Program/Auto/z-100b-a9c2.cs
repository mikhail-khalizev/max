...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_a9c2()
        {
            ...
            ii(0x100b_a9d8, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100b_a9db, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100b_a9de, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
