...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_bf76()
        {
            ...
            ii(0x100c_bf8e, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_bf91, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_bf9e, 3); mov(dl, memb[ds, eax + 0x4d]);          /* mov dl, [eax+0x4d] */
            ii(0x100c_bfa1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_bfb1, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ii(0x100c_bfb4, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100c_bfb7, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x100c_bfb9, 2); if(jl(0x100c_bfc4, 0x9)) goto l_0x100c_bfc4; /* jl 0x100cbfc4 */
            ii(0x100c_bfbb, 7); mov(memd[ss, ebp - 0x8], 0x1);          /* mov dword [ebp-0x8], 0x1 */
            ii(0x100c_bfc2, 2); jmp(0x100c_bfd7, 0x13); goto l_0x100c_bfd7; /* jmp 0x100cbfd7 */
        l_0x100c_bfc4:
            ii(0x100c_bfc4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_bfd4, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x100c_bfd7:
            ii(0x100c_bfd7, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
