...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_0c56()
        {
            ...
            ii(0x19_0c61, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ...
            ii(0x19_0c6f, 2); if(jz(0x19_0c74, 0x3)) goto l_0x19_0c74;  /* jz 0xc74 */
            ii(0x19_0c71, 3); jmp(0x19_0c7d, 0x9); goto l_0x19_0c7d;    /* jmp 0xc7d */
        l_0x19_0c74:
        ...
        l_0x19_0c7d:
            ii(0x19_0c7d, 3); mov(al, memb[ss, bp - 0x5]);              /* mov al, [bp-0x5] */
            ii(0x19_0c80, 2); sub(ah, ah);                              /* sub ah, ah */
            ii(0x19_0c82, 3); shl(ax, 0x8);                             /* shl ax, 0x8 */
            ii(0x19_0c85, 3); mov(cl, memb[ss, bp - 0x8]);              /* mov cl, [bp-0x8] */
            ii(0x19_0c88, 2); sub(ch, ch);                              /* sub ch, ch */
            ii(0x19_0c8a, 2); add(ax, cx);                              /* add ax, cx */
            ii(0x19_0c8c, 3); mov(cx, memw[ss, bp - 0xa]);              /* mov cx, [bp-0xa] */
            ii(0x19_0c8f, 3); mov(memw[ss, bp - 0x4], cx);              /* mov [bp-0x4], cx */
            ii(0x19_0c92, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ii(0x19_0c95, 4); cmp(memw[ss, bp - 0x2], 0x10);            /* cmp word [bp-0x2], 0x10 */
            ii(0x19_0c99, 2); if(jae(0x19_0c9e, 0x3)) goto l_0x19_0c9e; /* jae 0xc9e */
            ii(0x19_0c9b, 3); jmp(0x19_0cb5, 0x17); goto l_0x19_0cb5;   /* jmp 0xcb5 */
        l_0x19_0c9e:
            ii(0x19_0c9e, 2); if(jbe(0x19_0ca3, 0x3)) goto l_0x19_0ca3; /* jbe 0xca3 */
            ii(0x19_0ca0, 3); jmp(0x19_0cac, 0x9); goto l_0x19_0cac;    /* jmp 0xcac */
        l_0x19_0ca3:
            ii(0x19_0ca3, 4); cmp(memw[ss, bp - 0x4], 0);               /* cmp word [bp-0x4], 0x0 */
            ii(0x19_0ca7, 2); if(jae(0x19_0cac, 0x3)) goto l_0x19_0cac; /* jae 0xcac */
            ii(0x19_0ca9, 3); jmp(0x19_0cb5, 0x9); goto l_0x19_0cb5;    /* jmp 0xcb5 */
        l_0x19_0cac:
        ...
        l_0x19_0cb5:
            ii(0x19_0cb5, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0x19_0cb8, 3); mov(dx, memw[ss, bp - 0x2]);              /* mov dx, [bp-0x2] */
            ...
            ii(0x19_0ccb, 3); mov(memw[ss, bp + 0x8], ax);              /* mov [bp+0x8], ax */
            ii(0x19_0cce, 4); test(memb[ss, bp - 0x4], 0xf);            /* test byte [bp-0x4], 0xf */
            ii(0x19_0cd2, 2); if(jnz(0x19_0cd7, 0x3)) goto l_0x19_0cd7; /* jnz 0xcd7 */
            ii(0x19_0cd4, 3); jmp(0x19_0cfb, 0x24); goto l_0x19_0cfb;   /* jmp 0xcfb */
        l_0x19_0cd7:
            ii(0x19_0cd7, 3); mov(al, memb[ss, bp - 0x4]);              /* mov al, [bp-0x4] */
            ii(0x19_0cda, 3); and(ax, 0xf);                             /* and ax, 0xf */
            ii(0x19_0cdd, 3); add(ax, memw[ss, bp + 0x6]);              /* add ax, [bp+0x6] */
            ii(0x19_0ce0, 3); mov(memw[ss, bp - 0xe], ax);              /* mov [bp-0xe], ax */
            ii(0x19_0ce3, 3); mov(ax, memw[ss, bp - 0xe]);              /* mov ax, [bp-0xe] */
            ii(0x19_0ce6, 3); cmp(memw[ss, bp + 0x6], ax);              /* cmp [bp+0x6], ax */
            ii(0x19_0ce9, 2); if(ja(0x19_0cee, 0x3)) goto l_0x19_0cee;  /* ja 0xcee */
            ii(0x19_0ceb, 3); jmp(0x19_0cf5, 0x7); goto l_0x19_0cf5;    /* jmp 0xcf5 */
        l_0x19_0cee:
            ii(0x19_0cee, 3); inc(memw[ss, bp + 0x8]);                  /* inc word [bp+0x8] */
            ii(0x19_0cf1, 4); sub(memw[ss, bp - 0xe], 0x10);            /* sub word [bp-0xe], 0x10 */
        l_0x19_0cf5:
            ii(0x19_0cf5, 3); mov(ax, memw[ss, bp - 0xe]);              /* mov ax, [bp-0xe] */
            ii(0x19_0cf8, 3); mov(memw[ss, bp + 0x6], ax);              /* mov [bp+0x6], ax */
        l_0x19_0cfb:
            ii(0x19_0cfb, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x19_0cfe, 3); mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
