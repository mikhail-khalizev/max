...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_0bfe()
        {
            ...
            ii(0x18_0c08, 3); push(memw[ss, bp + 0xa]);                 /* push word [bp+0xa] */
            ii(0x18_0c0b, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ...
            ii(0x18_0c15, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x18_0c18, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x18_0c1b, 1); push(dx);                                 /* push dx */
            ii(0x18_0c1c, 1); push(ax);                                 /* push ax */
            ii(0x18_0c1d, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x18_0c20, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ...
            ii(0x18_0c2a, 3); sub(ax, memw[ss, bp - 0x4]);              /* sub ax, [bp-0x4] */
            ii(0x18_0c2d, 3); sbb(dx, memw[ss, bp - 0x2]);              /* sbb dx, [bp-0x2] */
            ...
            ii(0x18_0c37, 3); ret(0x8);                                 /* ret 0x8 */
        }
    }
}
