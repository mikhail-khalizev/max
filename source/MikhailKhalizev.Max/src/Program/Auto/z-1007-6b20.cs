...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_6b20()
        {
            ...
            ii(0x1007_6b38, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_6b3b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_6b3e, 3); add(eax, 0x6);                          /* add eax, 0x6 */
            ii(0x1007_6b41, 5); call(0x1007_6c68, 0x122);               /* call 0x10076c68 */
            ii(0x1007_6b46, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_6b49, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
