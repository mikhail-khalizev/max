...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_e445()
        {
            ...
            ii(0x17_e446, 3); mov(si, memw[ds, bx + 0x8]);              /* mov si, [bx+0x8] */
            ii(0x17_e449, 3); cmp(si, memw[ds, bx + 0xa]);              /* cmp si, [bx+0xa] */
            ii(0x17_e44c, 2); if(jnz(0x17_e451, 0x3)) goto l_0x17_e451; /* jnz 0xe451 */
            ii(0x17_e44e, 3); mov(si, memw[ds, bx + 0x6]);              /* mov si, [bx+0x6] */
        l_0x17_e451:
            ii(0x17_e451, 1); lodsw();                                  /* lodsw */
            ii(0x17_e452, 3); cmp(ax, 0xfffe);                          /* cmp ax, 0xfffe */
            ii(0x17_e455, 2); if(jz(0x17_e45f, 0x8)) goto l_0x17_e45f;  /* jz 0xe45f */
