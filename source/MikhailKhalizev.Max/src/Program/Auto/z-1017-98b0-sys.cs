...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_98b0()
        {
            ...
            ii(0x1017_98d8, 4); mov(ax, memw[ds, ebx + 22]);            /* mov ax, [ebx+0x16] */
            ii(0x1017_98dc, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1017_98de, 2); not(eax);                               /* not eax */
            ii(0x1017_98e0, 4); mov(dx, memw[ds, ebx + 24]);            /* mov dx, [ebx+0x18] */
            ...
            ii(0x1017_98ed, 6); cmp(memw[ds, ebx + 22], 0x100);         /* cmp word [ebx+0x16], 0x100 */
            ii(0x1017_98f3, 2); if(jnz(0x1017_98fc, 7)) goto l_0x1017_98fc; /* jnz 0x101798fc */
            ii(0x1017_98f5, 5); cmp(memw[ds, ebx + 20], 0x1a);          /* cmp word [ebx+0x14], 0x1a */
            ii(0x1017_98fa, 2); if(jz(0x1017_9900, 4)) goto l_0x1017_9900; /* jz 0x10179900 */
        l_0x1017_98fc:
            ii(0x1017_98fc, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1017_98fe, 2); jmp(0x1017_990d, 0xd); goto l_0x1017_990d; /* jmp 0x1017990d */
        l_0x1017_9900:
            ii(0x1017_9900, 3); mov(eax, memd[ds, ebx + 26]);           /* mov eax, [ebx+0x1a] */
            ii(0x1017_9903, 5); mov(memd[ds, 0x1020_9db4], eax);        /* mov [0x10209db4], eax */
            ii(0x1017_9908, 5); mov(eax, 1);                            /* mov eax, 0x1 */
        l_0x1017_990d:
            ii(0x1017_990d, 3); lea(esp, memd[ss, ebp - 8]);            /* lea esp, [ebp-0x8] */
