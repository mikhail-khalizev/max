...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_dbbd()
        {
            ...
            ii(0x1008_dbd5, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_dbd8, 3);  lea(edx, memd[ss, ebp - 16]);         /* lea edx, [ebp-0x10] */
            ii(0x1008_dbdb, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_dbeb, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_dbfd, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1008_dc0a:
            ii(0x1008_dc0a, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_dc0d, 4);  mov(memb[ds, edx + 37], 9);           /* mov byte [edx+0x25], 0x9 */
            ii(0x1008_dc11, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_dc14, 3);  mov(eax, memd[ds, edx + 17]);         /* mov eax, [edx+0x11] */
            ii(0x1008_dc17, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x1008_dc1a, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_dc1d, 3);  mov(edx, memd[ds, edx + 7]);          /* mov edx, [edx+0x7] */
        ...
        l_0x1008_dc5d:
            ii(0x1008_dc5d, 5);  mov(eax, 1);                          /* mov eax, 0x1 */
            ii(0x1008_dc62, 1);  push(eax);                            /* push eax */
            ii(0x1008_dc63, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_dc66, 3);  mov(ecx, memd[ds, eax + 33]);         /* mov ecx, [eax+0x21] */
            ii(0x1008_dc69, 3);  sar(ecx, 0x10);                       /* sar ecx, 0x10 */
            ii(0x1008_dc6c, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_dc6f, 3);  mov(ebx, memd[ds, eax + 31]);         /* mov ebx, [eax+0x1f] */
            ii(0x1008_dc72, 3);  sar(ebx, 0x10);                       /* sar ebx, 0x10 */
            ii(0x1008_dc75, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_dc78, 3);  mov(edx, memd[ds, eax + 7]);          /* mov edx, [eax+0x7] */
            ii(0x1008_dc7b, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x1008_dc7e, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_dc81, 3);  mov(eax, memd[ds, eax + 17]);         /* mov eax, [eax+0x11] */
            ...
            ii(0x1008_dc91, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_dc94, 5);  call(0x1008_df3e, 0x2a5);             /* call 0x1008df3e */
            ii(0x1008_dc99, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_dc9b, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1008_dca8:
            ...
            ii(0x1008_dcaa, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_dcb9, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_dcbc, 3);  add(eax, 0xf);                        /* add eax, 0xf */
            ii(0x1008_dcbf, 5);  call(0x1008_af28, -0x2d9c);           /* call 0x1008af28 */
            ii(0x1008_dcc4, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1008_dcc7, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1008_dcca, 3);  mov(edx, memd[ds, eax + 2]);          /* mov edx, [eax+0x2] */
            ii(0x1008_dccd, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1008_dcd0, 3);  call_abs(memd[ds, edx + 36]);         /* call dword [edx+0x24] */
            ii(0x1008_dcd3, 2);  test(al, al);                         /* test al, al */
            ii(0x1008_dcd5, 2);  if(jz(0x1008_dcd9, 2)) goto l_0x1008_dcd9;/* jz 0x1008dcd9 */
        l_0x1008_dcd7:
            ii(0x1008_dcd7, 2);  jmp(0x1008_dcf0, 0x17); goto l_0x1008_dcf0;/* jmp 0x1008dcf0 */
        l_0x1008_dcd9:
            ii(0x1008_dcd9, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_dcdc, 5);  call(0x1008_df3e, 0x25d);             /* call 0x1008df3e */
            ii(0x1008_dce1, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_dce3, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1008_dcf0:
            ii(0x1008_dcf0, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_dd00, 3);  cmp(eax, memd[ss, ebp - 4]);          /* cmp eax, [ebp-0x4] */
            ii(0x1008_dd03, 2);  if(jz(0x1008_dd1b, 0x16)) goto l_0x1008_dd1b;/* jz 0x1008dd1b */
            ii(0x1008_dd05, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_dd08, 4);  mov(memb[ds, eax + 37], 7);           /* mov byte [eax+0x25], 0x7 */
            ii(0x1008_dd0c, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_dd0e, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1008_dd1b:
            ii(0x1008_dd1b, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_dd29, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1008_dd36:
            ii(0x1008_dd36, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_dd44, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1008_dd51:
            ii(0x1008_dd51, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_dd5f, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1008_dd6c:
            ...
            ii(0x1008_dd6e, 5);  mov(ebx, 2);                          /* mov ebx, 0x2 */
            ii(0x1008_dd73, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_dd76, 3);  add(edx, 0x21);                       /* add edx, 0x21 */
            ii(0x1008_dd79, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
            ii(0x1008_dd7c, 5);  call(0x1007_5e64, -0x1_7f1d);         /* call 0x10075e64 */
            ii(0x1008_dd81, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1008_dd83, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_dd97, 5);  mov(ebx, 2);                          /* mov ebx, 0x2 */
            ii(0x1008_dd9c, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_dda9, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_ddac, 5);  call(0x100a_3671, 0x1_58c0);          /* call 0x100a3671 */
            ii(0x1008_ddb1, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_ddb4, 4);  mov(memb[ds, eax + 37], 7);           /* mov byte [eax+0x25], 0x7 */
            ii(0x1008_ddb8, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_ddba, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1008_ddc7:
            ii(0x1008_ddc7, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_ddd5, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1008_dde2:
            ...
            ii(0x1008_dded, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_ddf0, 3);  mov(eax, memd[ds, eax + 7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1008_de00, 2);  if(jnz(0x1008_de04, 2)) goto l_0x1008_de04;/* jnz 0x1008de04 */
        l_0x1008_de02:
            ii(0x1008_de02, 2);  jmp(0x1008_de13, 0xf); goto l_0x1008_de13;/* jmp 0x1008de13 */
        l_0x1008_de04:
            ii(0x1008_de04, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_de06, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1008_de13:
            ii(0x1008_de13, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1008_de16, 5);  call(0x1009_caf8, 0xecdd);            /* call 0x1009caf8 */
            ii(0x1008_de1b, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_de1e, 3);  add(edx, 0x13);                       /* add edx, 0x13 */
            ii(0x1008_de21, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x1008_de33, 3);  cmp(eax, 2);                          /* cmp eax, 0x2 */
            ii(0x1008_de36, 2);  if(jl(0x1008_de86, 0x4e)) goto l_0x1008_de86;/* jl 0x1008de86 */
            ii(0x1008_de38, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_de3b, 5);  cmp(memw[ds, eax + 19], 0x28);        /* cmp word [eax+0x13], 0x28 */
            ii(0x1008_de40, 2);  if(jz(0x1008_de84, 0x42)) goto l_0x1008_de84;/* jz 0x1008de84 */
            ii(0x1008_de42, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_de52, 3);  mov(edx, memd[ds, eax + 23]);         /* mov edx, [eax+0x17] */
            ii(0x1008_de55, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x1008_de58, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_de5b, 3);  add(eax, 0x15);                       /* add eax, 0x15 */
            ii(0x1008_de5e, 5);  call(0x1007_6574, -0x1_78ef);         /* call 0x10076574 */
            ii(0x1008_de63, 3);  mov(eax, memd[ds, eax + 80]);         /* mov eax, [eax+0x50] */
            ii(0x1008_de66, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x1008_de69, 3);  sub(edx, 2);                          /* sub edx, 0x2 */
            ii(0x1008_de6c, 2);  cmp(eax, edx);                        /* cmp eax, edx */
            ii(0x1008_de6e, 2);  if(jl(0x1008_de82, 0x12)) goto l_0x1008_de82;/* jl 0x1008de82 */
            ii(0x1008_de70, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_de73, 3);  mov(eax, memd[ds, eax + 7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1008_de80, 2);  if(jz(0x1008_de84, 2)) goto l_0x1008_de84;/* jz 0x1008de84 */
        l_0x1008_de82:
            ii(0x1008_de82, 2);  jmp(0x1008_de86, 2); goto l_0x1008_de86;/* jmp 0x1008de86 */
        l_0x1008_de84:
            ii(0x1008_de84, 2);  jmp(0x1008_de88, 2); goto l_0x1008_de88;/* jmp 0x1008de88 */
        l_0x1008_de86:
            ii(0x1008_de86, 2);  jmp(0x1008_de9f, 0x17); goto l_0x1008_de9f;/* jmp 0x1008de9f */
        l_0x1008_de88:
            ii(0x1008_de88, 5);  mov(edx, 2);                          /* mov edx, 0x2 */
            ii(0x1008_de8d, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1008_de9f:
            ii(0x1008_de9f, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x1008_dea4, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1008_deb4:
            ii(0x1008_deb4, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_deb7, 3);  add(eax, 0x15);                       /* add eax, 0x15 */
            ii(0x1008_deba, 5);  call(0x1007_6574, -0x1_794b);         /* call 0x10076574 */
            ii(0x1008_debf, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_dec2, 4);  mov(dx, memw[ds, edx + 33]);          /* mov dx, [edx+0x21] */
            ii(0x1008_dec6, 4);  mov(memw[ds, eax + 65], dx);          /* mov [eax+0x41], dx */
            ii(0x1008_deca, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_decd, 3);  add(eax, 0x15);                       /* add eax, 0x15 */
            ii(0x1008_ded0, 5);  call(0x1007_6574, -0x1_7961);         /* call 0x10076574 */
            ii(0x1008_ded5, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_ded8, 4);  mov(dx, memw[ds, edx + 35]);          /* mov dx, [edx+0x23] */
            ii(0x1008_dedc, 4);  mov(memw[ds, eax + 67], dx);          /* mov [eax+0x43], dx */
            ii(0x1008_dee0, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_dee2, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_defe, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1008_df0e:
            ii(0x1008_df0e, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_df1e, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x1008_df23, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_df26, 5);  call(0x100a_2a04, 0x1_4ad9);          /* call 0x100a2a04 */
            ii(0x1008_df2b, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_df2d, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
