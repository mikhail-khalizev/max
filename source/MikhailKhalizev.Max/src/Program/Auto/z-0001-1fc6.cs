...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0001_1fc6()
        {
            ...
            ii(0x1_1fd8, 2);  if(jb(0x1_1fe0, 6)) goto l_0x1_1fe0;      /* jb 0x1fe0 */
            ii(0x1_1fda, 4);  movzx(ebp, sp);                           /* movzx ebp, sp */
            ii(0x1_1fde, 2);  xchg(bx, bx);                             /* xchg bx, bx */
        l_0x1_1fe0:
            ii(0x1_1fe0, 4);  mov(bx, memw_a32[ss, ebp + 40]);          /* mov bx, [ebp+0x28] */
        ...
        l_0x1_1ff4:
            ...
            ii(0x1_1ff7, 2);  push(-1 /* 0xff */);                      /* push 0xffff */
            ii(0x1_1ff9, 5);  and(esi, memd_a32[ss, ebp - 4]);          /* and esi, [ebp-0x4] */
            ii(0x1_1ffe, 5);  and(edi, memd_a32[ss, ebp - 4]);          /* and edi, [ebp-0x4] */
            ii(0x1_2003, 3);  cmp(ah, 0xf);                             /* cmp ah, 0xf */
            ii(0x1_2006, 2);  if(jae(0x1_2032, 0x2a)) goto l_0x1_2032;  /* jae 0x2032 */
            ii(0x1_2008, 5);  and(memb_a32[ss, ebp + 44], -2 /* 0xfe */); /* and byte [ebp+0x2c], 0xfe */
            ii(0x1_200d, 2);  xor(bx, bx);                              /* xor bx, bx */
            ii(0x1_200f, 2);  mov(bl, ah);                              /* mov bl, ah */
            ii(0x1_2011, 2);  shl(bx, 1);                               /* shl bx, 1 */
            ii(0x1_2013, 5);  mov(si, memw[cs, bx + 17592]);            /* mov si, [cs:bx+0x44b8] */
            ii(0x1_2018, 2);  xor(ah, ah);                              /* xor ah, ah */
            ii(0x1_201a, 2);  mov(bx, ax);                              /* mov bx, ax */
            ii(0x1_201c, 4);  mov(ax, memw[cs, si - 2]);                /* mov ax, [cs:si-0x2] */
            ...
            ii(0x1_2028, 2);  shl(bx, 1);                               /* shl bx, 1 */
            ii(0x1_202a, 1);  cld();                                    /* cld */
            ii(0x1_202b, 3);  if(jmp_abs(memw[cs, bx + si])) return;    /* jmp word [cs:bx+si] */
        l_0x1_202e:
            ii(0x1_202e, 4);  if(jmp_far_ind(memw[cs, si - 6])) return; /* jmp far word [cs:si-0x6] */
        l_0x1_2032:
            ii(0x1_2032, 5);  or(memb_a32[ss, ebp + 44], 1);            /* or byte [ebp+0x2c], 0x1 */
