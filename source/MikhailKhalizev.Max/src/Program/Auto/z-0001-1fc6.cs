...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("75cc2576-ad42-4e4a-9592-5079defd7077")]
        public void Method_0001_1fc6()
        {
            ii(0x1_1fc6, 2);  pushad();                                 /* pushad */
            ii(0x1_1fc8, 1);  pushw(es);                                /* push es */
            ii(0x1_1fc9, 1);  pushw(ds);                                /* push ds */
            ...
            ii(0x1_1fd8, 2);  if(jbw(0x1_1fe0, 0x6)) goto l_0x1_1fe0;   /* jb 0x1fe0 */
        ...
        l_0x1_1fe0:
            ...
            ii(0x1_1fe7, 2);  if(jbw(0x1_1ff4, 0xb)) goto l_0x1_1ff4;   /* jb 0x1ff4 */
        ...
        l_0x1_1ff4:
            ...
            ii(0x1_1ff6, 1);  pushw(bx);                                /* push bx */
            ii(0x1_1ff7, 2);  pushw(-0x1 /* 0xff */);                   /* push 0xffff */
            ...
            ii(0x1_2006, 2);  if(jaew(0x1_2032, 0x2a)) goto l_0x1_2032; /* jae 0x2032 */
            ...
            ii(0x1_2013, 5);  mov(si, memw_a16[cs, bx + 0x44b8]);       /* mov si, [cs:bx+0x44b8] */
            ii(0x1_2018, 2);  xor(ah, ah);                              /* xor ah, ah */
            ii(0x1_201a, 2);  mov(bx, ax);                              /* mov bx, ax */
            ii(0x1_201c, 4);  mov(ax, memw_a16[cs, si - 0x2]);          /* mov ax, [cs:si-0x2] */
            ii(0x1_2020, 2);  test(al, al);                             /* test al, al */
            ii(0x1_2022, 2);  if(jsw(0x1_202e, 0xa)) goto l_0x1_202e;   /* js 0x202e */
            ii(0x1_2024, 2);  cmp(bl, ah);                              /* cmp bl, ah */
            ii(0x1_2026, 2);  if(jaew(0x1_2032, 0xa)) goto l_0x1_2032;  /* jae 0x2032 */
            ii(0x1_2028, 2);  shl(bx, 0x1);                             /* shl bx, 1 */
            ii(0x1_202a, 1);  cld();                                    /* cld */
            ii(0x1_202b, 3);  if(jmpw_abs(memw_a16[cs, bx + si])) return; /* jmp word [cs:bx+si] */
        l_0x1_202e:
            ii(0x1_202e, 4);  if(jmpw_a16_far_ind(cs, si - 0x6)) return; /* jmp far word [cs:si-0x6] */
        l_0x1_2032:
