...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_71f8()
        {
            ...
            ii(0x100a_720a, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100a_7210, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100a_7213, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x100a_7216, 3); add(edx, 0x1b);                         /* add edx, 0x1b */
            ii(0x100a_7219, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
            ii(0x100a_721c, 5); call(0x1007_6668, -0x3_0bb9);           /* call 0x10076668 */
            ii(0x100a_7221, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_7223, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_7230, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_723d, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
            ...
            ii(0x100a_724b, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
        ...
        l_0x100a_7255:
            ...
            ii(0x100a_725e, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x100a_7261, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
            ii(0x100a_7264, 5); call(0x1007_6574, -0x3_0cf5);           /* call 0x10076574 */
            ii(0x100a_7269, 5); call(0x1015_2962, 0xa_b6f4);            /* call 0x10152962 */
            ii(0x100a_726e, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
            ...
            ii(0x100a_7288, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
        ...
        l_0x100a_729c:
            ...
            ii(0x100a_729e, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
