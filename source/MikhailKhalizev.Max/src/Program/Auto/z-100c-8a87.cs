...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_8a87()
        {
            ...
            ii(0x100c_8a9f, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_8aa2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_8aa5, 4); cmp(memd[ds, eax + 0x6], 0);            /* cmp dword [eax+0x6], 0x0 */
            ii(0x100c_8aa9, 6); if(jz(0x100c_8b23, 0x74)) goto l_0x100c_8b23; /* jz 0x100c8b23 */
            ii(0x100c_8aaf, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x100c_8ab6, 2); jmp(0x100c_8abe, 0x6); goto l_0x100c_8abe; /* jmp 0x100c8abe */
        l_0x100c_8ab8:
            ii(0x100c_8ab8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_8abb, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x100c_8abe:
            ii(0x100c_8abe, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_8ac1, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100c_8ac4, 3); cmp(ax, memw[ds, edx]);                 /* cmp ax, [edx] */
            ii(0x100c_8ac7, 2); if(jge(0x100c_8af9, 0x30)) goto l_0x100c_8af9; /* jge 0x100c8af9 */
            ii(0x100c_8ac9, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100c_8acd, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100c_8ad0, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100c_8ad2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_8ad5, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x100c_8ae1, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100c_8ae5, 3); shl(edx, 0x2);                          /* shl edx, 0x2 */
            ii(0x100c_8ae8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_8aeb, 3); mov(eax, memd[ds, eax + 0x2]);          /* mov eax, [eax+0x2] */
        ...
        l_0x100c_8af9:
            ii(0x100c_8af9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_8afc, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x100c_8aff, 5); call(Definitions.sys_delete, 0x9_d460); /* call 0x10165f64 */
            ii(0x100c_8b04, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_8b07, 3); mov(eax, memd[ds, eax + 0x2]);          /* mov eax, [eax+0x2] */
            ii(0x100c_8b0a, 5); call(Definitions.sys_delete, 0x9_d455); /* call 0x10165f64 */
            ii(0x100c_8b0f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_8b12, 7); mov(memd[ds, eax + 0x6], 0);            /* mov dword [eax+0x6], 0x0 */
            ii(0x100c_8b19, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_8b1c, 7); mov(memd[ds, eax + 0x2], 0);            /* mov dword [eax+0x2], 0x0 */
        l_0x100c_8b23:
