...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_3b41()
        {
            ...
            ii(0x1016_3b64, 5); jmpd(0x1016_3c08, 0x9f); goto l_0x1016_3c08; /* jmp 0x10163c08 */
        l_0x1016_3b69:
            ...
            ii(0x1016_3b72, 5); jmpd(0x1016_3c47, 0xd0); goto l_0x1016_3c47; /* jmp 0x10163c47 */
        l_0x1016_3b77:
            ...
            ii(0x1016_3b80, 5); jmpd(0x1016_3c47, 0xc2); goto l_0x1016_3c47; /* jmp 0x10163c47 */
        l_0x1016_3b85:
            ii(0x1016_3b85, 3); mov(eax, memd_a32[ss, ebp - 0x8]);      /* mov eax, [ebp-0x8] */
            ii(0x1016_3b88, 3); add(eax, 0x12);                         /* add eax, 0x12 */
            ii(0x1016_3b8b, 3); mov(memd_a32[ss, ebp - 0x10], eax);     /* mov [ebp-0x10], eax */
            ii(0x1016_3b8e, 5); jmpd(0x1016_3c47, 0xb4); goto l_0x1016_3c47; /* jmp 0x10163c47 */
        l_0x1016_3b93:
            ii(0x1016_3b93, 3); mov(eax, memd_a32[ss, ebp - 0x8]);      /* mov eax, [ebp-0x8] */
            ii(0x1016_3b96, 3); add(eax, 0x1b);                         /* add eax, 0x1b */
            ii(0x1016_3b99, 3); mov(memd_a32[ss, ebp - 0x10], eax);     /* mov [ebp-0x10], eax */
            ii(0x1016_3b9c, 5); jmpd(0x1016_3c47, 0xa6); goto l_0x1016_3c47; /* jmp 0x10163c47 */
        l_0x1016_3ba1:
            ii(0x1016_3ba1, 3); mov(eax, memd_a32[ss, ebp - 0x8]);      /* mov eax, [ebp-0x8] */
            ii(0x1016_3ba4, 3); add(eax, 0xc);                          /* add eax, 0xc */
            ii(0x1016_3ba7, 3); mov(memd_a32[ss, ebp - 0x10], eax);     /* mov [ebp-0x10], eax */
            ii(0x1016_3baa, 5); jmpd(0x1016_3c47, 0x98); goto l_0x1016_3c47; /* jmp 0x10163c47 */
        l_0x1016_3baf:
            ii(0x1016_3baf, 3); mov(eax, memd_a32[ss, ebp - 0x8]);      /* mov eax, [ebp-0x8] */
            ii(0x1016_3bb2, 3); add(eax, 0xa);                          /* add eax, 0xa */
            ii(0x1016_3bb5, 3); mov(memd_a32[ss, ebp - 0x10], eax);     /* mov [ebp-0x10], eax */
            ii(0x1016_3bb8, 5); jmpd(0x1016_3c47, 0x8a); goto l_0x1016_3c47; /* jmp 0x10163c47 */
        l_0x1016_3bbd:
            ii(0x1016_3bbd, 3); mov(eax, memd_a32[ss, ebp - 0x8]);      /* mov eax, [ebp-0x8] */
            ii(0x1016_3bc0, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1016_3bc3, 3); mov(memd_a32[ss, ebp - 0x10], eax);     /* mov [ebp-0x10], eax */
            ii(0x1016_3bc6, 5); jmpd(0x1016_3c47, 0x7c); goto l_0x1016_3c47; /* jmp 0x10163c47 */
        l_0x1016_3bcb:
            ii(0x1016_3bcb, 3); mov(eax, memd_a32[ss, ebp - 0x8]);      /* mov eax, [ebp-0x8] */
            ii(0x1016_3bce, 3); add(eax, 0x10);                         /* add eax, 0x10 */
            ii(0x1016_3bd1, 3); mov(memd_a32[ss, ebp - 0x10], eax);     /* mov [ebp-0x10], eax */
            ii(0x1016_3bd4, 2); jmpd(0x1016_3c47, 0x71); goto l_0x1016_3c47; /* jmp 0x10163c47 */
        l_0x1016_3bd6:
            ii(0x1016_3bd6, 3); mov(eax, memd_a32[ss, ebp - 0x8]);      /* mov eax, [ebp-0x8] */
            ii(0x1016_3bd9, 3); add(eax, 0x8);                          /* add eax, 0x8 */
            ii(0x1016_3bdc, 3); mov(memd_a32[ss, ebp - 0x10], eax);     /* mov [ebp-0x10], eax */
            ii(0x1016_3bdf, 2); jmpd(0x1016_3c47, 0x66); goto l_0x1016_3c47; /* jmp 0x10163c47 */
        l_0x1016_3be1:
            ii(0x1016_3be1, 2); jmpd(0x1016_3c25, 0x42); goto l_0x1016_3c25; /* jmp 0x10163c25 */
        ...
        l_0x1016_3c08:
            ...
            ii(0x1016_3c14, 2); if(jad(0x1016_3be1, -0x35)) goto l_0x1016_3be1; /* ja 0x10163be1 */
            ...
            ii(0x1016_3c1e, 7); 
            switch (jmpd_abs_switch(memd_a32[cs, eax + 0x1016_3be4]))
            {
                case 0x1016_3b69:
                    goto l_0x1016_3b69;
                case 0x1016_3b77:
