...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_3b41()
        {
            ...
            ii(0x1016_3b58, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1016_3b5b, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x1016_3b5e, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ii(0x1016_3b61, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x1016_3b64, 5); jmp(0x1016_3c08, 0x9f); goto l_0x1016_3c08; /* jmp 0x10163c08 */
        l_0x1016_3b69:
            ii(0x1016_3b69, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_3b6c, 3); add(eax, 0xe);                          /* add eax, 0xe */
            ii(0x1016_3b6f, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1016_3b72, 5); jmp(0x1016_3c47, 0xd0); goto l_0x1016_3c47; /* jmp 0x10163c47 */
        l_0x1016_3b77:
            ii(0x1016_3b77, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_3b7a, 3); add(eax, 0x14);                         /* add eax, 0x14 */
            ii(0x1016_3b7d, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1016_3b80, 5); jmp(0x1016_3c47, 0xc2); goto l_0x1016_3c47; /* jmp 0x10163c47 */
        l_0x1016_3b85:
            ii(0x1016_3b85, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_3b88, 3); add(eax, 0x12);                         /* add eax, 0x12 */
            ii(0x1016_3b8b, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1016_3b8e, 5); jmp(0x1016_3c47, 0xb4); goto l_0x1016_3c47; /* jmp 0x10163c47 */
        l_0x1016_3b93:
            ii(0x1016_3b93, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_3b96, 3); add(eax, 0x1b);                         /* add eax, 0x1b */
            ii(0x1016_3b99, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1016_3b9c, 5); jmp(0x1016_3c47, 0xa6); goto l_0x1016_3c47; /* jmp 0x10163c47 */
        l_0x1016_3ba1:
            ii(0x1016_3ba1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_3ba4, 3); add(eax, 0xc);                          /* add eax, 0xc */
            ii(0x1016_3ba7, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1016_3baa, 5); jmp(0x1016_3c47, 0x98); goto l_0x1016_3c47; /* jmp 0x10163c47 */
        l_0x1016_3baf:
            ii(0x1016_3baf, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_3bb2, 3); add(eax, 0xa);                          /* add eax, 0xa */
            ii(0x1016_3bb5, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1016_3bb8, 5); jmp(0x1016_3c47, 0x8a); goto l_0x1016_3c47; /* jmp 0x10163c47 */
        l_0x1016_3bbd:
            ii(0x1016_3bbd, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_3bc0, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1016_3bc3, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1016_3bc6, 5); jmp(0x1016_3c47, 0x7c); goto l_0x1016_3c47; /* jmp 0x10163c47 */
        l_0x1016_3bcb:
            ii(0x1016_3bcb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_3bce, 3); add(eax, 0x10);                         /* add eax, 0x10 */
            ii(0x1016_3bd1, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1016_3bd4, 2); jmp(0x1016_3c47, 0x71); goto l_0x1016_3c47; /* jmp 0x10163c47 */
        l_0x1016_3bd6:
            ii(0x1016_3bd6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_3bd9, 3); add(eax, 0x8);                          /* add eax, 0x8 */
            ii(0x1016_3bdc, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
        ...
        l_0x1016_3c08:
            ii(0x1016_3c08, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
            ii(0x1016_3c0b, 2); dec(al);                                /* dec al */
            ii(0x1016_3c0d, 3); mov(memb[ss, ebp - 0x14], al);          /* mov [ebp-0x14], al */
            ii(0x1016_3c10, 4); cmp(memb[ss, ebp - 0x14], 0x8);         /* cmp byte [ebp-0x14], 0x8 */
            ii(0x1016_3c14, 2); if(ja(0x1016_3be1, -0x35)) goto l_0x1016_3be1; /* ja 0x10163be1 */
            ii(0x1016_3c16, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1016_3c18, 3); mov(al, memb[ss, ebp - 0x14]);          /* mov al, [ebp-0x14] */
        ...
        l_0x1016_3c25:
            ...
            ii(0x1016_3c3e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_3c41, 3); add(eax, 0xa);                          /* add eax, 0xa */
            ii(0x1016_3c44, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
        l_0x1016_3c47:
            ii(0x1016_3c47, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
