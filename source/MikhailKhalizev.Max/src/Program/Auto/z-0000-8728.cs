...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x8728, 5);    cmp(memb_a16[ds, 0xdfe], 0x1);            /* cmp byte [0xdfe], 0x1 */
            ii(0x872d, 4);    if(jnzw(0x8765, 0x34)) goto l_0x8765;     /* jnz 0x8765 */
            ...
            ii(0x873f, 3);    mov(ax, memw_a16[ds, 0xdfc]);             /* mov ax, [0xdfc] */
            ii(0x8742, 2);    or(ax, ax);                               /* or ax, ax */
            ii(0x8744, 4);    if(jzw(0x8763, 0x1b)) goto l_0x8763;      /* jz 0x8763 */
            ii(0x8748, 1);    pushw(bx);                                /* push bx */
            ii(0x8749, 4);    mov(bx, memw_a16[ds, 0xdfc]);             /* mov bx, [0xdfc] */
            ii(0x874d, 3);    mov(ax, 0x8);                             /* mov ax, 0x8 */
            ii(0x8750, 2);    mov(ds, ax);                              /* mov ds, ax */
            ii(0x8752, 4);    mov(memb_a16[ds, bx + 0x5], 0x89);        /* mov byte [bx+0x5], 0x89 */
            ii(0x8756, 2);    mov(ax, bx);                              /* mov ax, bx */
            ii(0x8758, 3);    mov(bx, 0x20);                            /* mov bx, 0x20 */
            ii(0x875b, 2);    mov(ds, bx);                              /* mov ds, bx */
            ii(0x875d, 1);    popw(bx);                                 /* pop bx */
            ii(0x875e, 3);    ltr(ax);                                  /* ltr ax */
            ii(0x8761, 2);    clts();                                   /* clts */
        l_0x8763:
            ii(0x8763, 2);    popd(eax);                                /* pop eax */
        l_0x8765:
            ii(0x8765, 3);    if(jmpw_func(0x60e7, -0x2681)) return;    /* jmp 0x60e7 */
        }
    }
}
