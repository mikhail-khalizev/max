...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_3d92()
        {
            ...
            ii(0x1016_3da9, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1016_3dac, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1016_3daf, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1016_3db2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_3db5, 5); call(0x1016_3c52, -0x168);              /* call 0x10163c52 */
            ii(0x1016_3dba, 2); test(al, al);                           /* test al, al */
            ii(0x1016_3dbc, 2); if(jnz(0x1016_3dc4, 0x6)) goto l_0x1016_3dc4; /* jnz 0x10163dc4 */
            ii(0x1016_3dbe, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1016_3dc2, 2); jmp(0x1016_3dc8, 0x4); goto l_0x1016_3dc8; /* jmp 0x10163dc8 */
        l_0x1016_3dc4:
