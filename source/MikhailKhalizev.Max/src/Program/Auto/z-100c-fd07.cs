...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_fd07()
        {
            ...
            ii(0x100c_fd1e, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100c_fd21, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x100c_fd24, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100c_fd27, 5); call(Definitions.my_2_get_count, -0x4_49c4); /* call 0x1008b368 */
            ii(0x100c_fd2c, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x100c_fd2f, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ii(0x100c_fd33, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100c_fd36, 5); call(0x1013_c0fa, 0x6_c3bf);            /* call 0x1013c0fa */
            ii(0x100c_fd3b, 7); mov(memd[ss, ebp - 16], 0);             /* mov dword [ebp-0x10], 0x0 */
            ii(0x100c_fd42, 2); jmp(0x100c_fd4a, 6); goto l_0x100c_fd4a; /* jmp 0x100cfd4a */
        l_0x100c_fd44:
            ii(0x100c_fd44, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100c_fd47, 3); inc(memd[ss, ebp - 16]);                /* inc dword [ebp-0x10] */
        l_0x100c_fd4a:
            ii(0x100c_fd4a, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100c_fd4d, 5); call(Definitions.my_2_get_count, -0x4_49ea); /* call 0x1008b368 */
            ii(0x100c_fd52, 4); cmp(ax, memw[ss, ebp - 16]);            /* cmp ax, [ebp-0x10] */
            ii(0x100c_fd56, 2); if(jle(0x100c_fd7c, 0x24)) goto l_0x100c_fd7c; /* jle 0x100cfd7c */
            ii(0x100c_fd58, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ii(0x100c_fd5c, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100c_fd5f, 5); call(0x1008_b228, -0x4_4b3c);           /* call 0x1008b228 */
            ii(0x100c_fd64, 3); mov(ax, memw[ds, eax]);                 /* mov ax, [eax] */
            ii(0x100c_fd67, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100c_fd6a, 5); mov(ebx, 2);                            /* mov ebx, 0x2 */
            ii(0x100c_fd6f, 3); lea(edx, memd[ss, ebp - 12]);           /* lea edx, [ebp-0xc] */
            ii(0x100c_fd72, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
