...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_b6c3()
        {
            ...
            ii(0x1011_b6dc, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1011_b6df, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1011_b6e2, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1011_b6e9, 2); jmp(0x1011_b6f1, 0x6); goto l_0x1011_b6f1; /* jmp 0x1011b6f1 */
        l_0x1011_b6eb:
        ...
        l_0x1011_b6f1:
            ...
            ii(0x1011_b6f4, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ...
            ii(0x1011_b700, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
