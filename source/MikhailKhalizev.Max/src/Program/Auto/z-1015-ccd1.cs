...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_ccd1()
        {
            ...
            ii(0x1015_cce9, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x1015_ccfb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_cd15, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x1015_cd22:
            ...
            ii(0x1015_cd27, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_cd2a, 5); call(0x1015_cbca, -0x165);              /* call 0x1015cbca */
            ii(0x1015_cd2f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_cd32, 3); mov(edx, memd[ds, eax + 0x31]);         /* mov edx, [eax+0x31] */
            ii(0x1015_cd35, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1015_cd38, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_cd3b, 5); call(0x1014_9b07, -0x1_3239);           /* call 0x10149b07 */
            ii(0x1015_cd40, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_cd43, 5); cmp(memw[ds, eax + 0x8], 0x1d);         /* cmp word [eax+0x8], 0x1d */
            ...
            ii(0x1015_cd4f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_cd52, 3); mov(edx, memd[ds, eax + 0x5a]);         /* mov edx, [eax+0x5a] */
            ii(0x1015_cd55, 3); sar(edx, 0x18);                         /* sar edx, 0x18 */
            ii(0x1015_cd58, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_cd5b, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
