...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_748f()
        {
            ...
            ii(0x1012_74a5, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1012_74a8, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x1012_74ab, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1012_74ae, 5); mov(edx, 0x4);                          /* mov edx, 0x4 */
            ii(0x1012_74b3, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1012_74c5, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1012_74c9, 6); imul(eax, eax, 0x247);                  /* imul eax, eax, 0x247 */
            ii(0x1012_74cf, 7); mov(memb[ds, eax + 0x101c_a490], 0x4);  /* mov byte [eax+0x101ca490], 0x4 */
            ii(0x1012_74d6, 7); mov(memb[ds, 0x101c_59c9], 0);          /* mov byte [0x101c59c9], 0x0 */
            ii(0x1012_74dd, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ii(0x1012_74e1, 2); if(jz(0x1012_7506, 0x23)) goto l_0x1012_7506; /* jz 0x10127506 */
            ii(0x1012_74e3, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
        ...
        l_0x1012_7506:
            ...
            ii(0x1012_7513, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1012_7534, 7); mov(memd[ss, ebp - 0x10], 0x3);         /* mov dword [ebp-0x10], 0x3 */
            ii(0x1012_753b, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1012_753e, 1); inc(eax);                               /* inc eax */
            ii(0x1012_753f, 4); imul(eax, memd[ss, ebp - 0xc]);         /* imul eax, [ebp-0xc] */
            ii(0x1012_7543, 5); add(eax, 0x41b);                        /* add eax, 0x41b */
            ii(0x1012_7548, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1012_754b, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1012_754e, 3); add(eax, memd[ss, ebp - 0x10]);         /* add eax, [ebp-0x10] */
            ii(0x1012_7551, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1012_7554, 5); call(0x100d_5470, -0x5_20e9);           /* call 0x100d5470 */
            ii(0x1012_7559, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x1012_755c, 4); movsx(ebx, memw[ss, ebp - 0x18]);       /* movsx ebx, word [ebp-0x18] */
            ii(0x1012_7560, 4); movsx(edx, memw[ss, ebp - 0x14]);       /* movsx edx, word [ebp-0x14] */
            ii(0x1012_7564, 5); mov(eax, 0x101c_7278);                  /* mov eax, 0x101c7278 */
            ii(0x1012_7569, 5); call(0x1013_daea, 0x1_657c);            /* call 0x1013daea */
        l_0x1012_756e:
            ii(0x1012_756e, 7); cmp(memb[ds, 0x101c_391e], 0x3);        /* cmp byte [0x101c391e], 0x3 */
        ...
        l_0x1012_759b:
            ii(0x1012_759b, 7); mov(memd[ss, ebp - 0xc], 0x4);          /* mov dword [ebp-0xc], 0x4 */
        l_0x1012_75a2:
            ii(0x1012_75a2, 3); dec(memd[ss, ebp - 0xc]);               /* dec dword [ebp-0xc] */
            ii(0x1012_75a5, 5); cmp(memw[ss, ebp - 0xc], -0x1 /* 0xff */); /* cmp word [ebp-0xc], 0xffff */
            ii(0x1012_75aa, 2); if(jz(0x1012_75d0, 0x24)) goto l_0x1012_75d0; /* jz 0x101275d0 */
            ii(0x1012_75ac, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1012_75c4, 2); if(jnz(0x1012_75ce, 0x8)) goto l_0x1012_75ce; /* jnz 0x101275ce */
