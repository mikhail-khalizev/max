...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1012_7506:
            ...
            ii(0x1012_7534, 7); mov(memd[ss, ebp - 0x10], 3);           /* mov dword [ebp-0x10], 0x3 */
        ...
        l_0x1012_759b:
            ii(0x1012_759b, 7); mov(memd[ss, ebp - 0xc], 4);            /* mov dword [ebp-0xc], 0x4 */
        l_0x1012_75a2:
            ii(0x1012_75a2, 3); dec(memd[ss, ebp - 0xc]);               /* dec dword [ebp-0xc] */
            ii(0x1012_75a5, 5); cmp(memw[ss, ebp - 0xc], -1 /* 0xff */); /* cmp word [ebp-0xc], 0xffff */
