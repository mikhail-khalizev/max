...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_1c16()
        {
            ...
            ii(0x100a_1c2c, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100a_1c2f, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100a_1c32, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ii(0x100a_1c35, 4); or(memb[ss, ebp - 0x10], 0x1);          /* or byte [ebp-0x10], 0x1 */
            ii(0x100a_1c39, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x100a_1c3c, 5); call(0x1007_64fc, -0x2_b745);           /* call 0x100764fc */
            ii(0x100a_1c41, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x100a_1c44, 4); and(memb[ss, ebp - 0x10], -0x2 /* 0xfe */); /* and byte [ebp-0x10], 0xfe */
            ii(0x100a_1c48, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_1c4a, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100a_1c59, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100a_1c5c, 3); add(eax, 0x44);                         /* add eax, 0x44 */
            ii(0x100a_1c5f, 5); call(0x1007_6574, -0x2_b6f0);           /* call 0x10076574 */
            ii(0x100a_1c64, 4); mov(ax, memw[ds, eax + 0x8]);           /* mov ax, [eax+0x8] */
            ii(0x100a_1c68, 4); cmp(ax, memw[ss, ebp - 0x8]);           /* cmp ax, [ebp-0x8] */
            ii(0x100a_1c6c, 2); if(jz(0x100a_1c70, 0x2)) goto l_0x100a_1c70; /* jz 0x100a1c70 */
        l_0x100a_1c6e:
            ii(0x100a_1c6e, 2); jmp(0x100a_1c90, 0x20); goto l_0x100a_1c90; /* jmp 0x100a1c90 */
        l_0x100a_1c70:
            ii(0x100a_1c70, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x100a_1c72, 3); mov(bl, memb[ss, ebp - 0x4]);           /* mov bl, [ebp-0x4] */
            ii(0x100a_1c75, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100a_1c78, 3); add(eax, 0x44);                         /* add eax, 0x44 */
            ii(0x100a_1c7b, 5); call(0x1007_6600, -0x2_b680);           /* call 0x10076600 */
            ii(0x100a_1c80, 3); mov(ecx, memd[ss, ebp - 0xc]);          /* mov ecx, [ebp-0xc] */
            ...
            ii(0x100a_1c8e, 2); if(jnz(0x100a_1c92, 0x2)) goto l_0x100a_1c92; /* jnz 0x100a1c92 */
        l_0x100a_1c90:
            ii(0x100a_1c90, 2); jmp(0x100a_1ca8, 0x16); goto l_0x100a_1ca8; /* jmp 0x100a1ca8 */
        l_0x100a_1c92:
            ii(0x100a_1c92, 7); mov(memd[ss, ebp - 0x1c], 0x1);         /* mov dword [ebp-0x1c], 0x1 */
            ii(0x100a_1c99, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_1c9b, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x100a_1ca8:
            ...
            ii(0x100a_1cb2, 3); lea(ebx, memd[ss, ebp - 0x14]);         /* lea ebx, [ebp-0x14] */
        ...
        l_0x100a_1cbe:
            ...
            ii(0x100a_1cc0, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x100a_1ccc, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x100a_1ccf, 5); call(0x1007_63a0, -0x2_b934);           /* call 0x100763a0 */
            ii(0x100a_1cd4, 4); mov(ax, memw[ds, eax + 0x8]);           /* mov ax, [eax+0x8] */
            ii(0x100a_1cd8, 4); cmp(ax, memw[ss, ebp - 0x8]);           /* cmp ax, [ebp-0x8] */
            ii(0x100a_1cdc, 2); if(jnz(0x100a_1cfb, 0x1d)) goto l_0x100a_1cfb; /* jnz 0x100a1cfb */
            ii(0x100a_1cde, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x100a_1ce0, 3); mov(bl, memb[ss, ebp - 0x4]);           /* mov bl, [ebp-0x4] */
            ii(0x100a_1ce3, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x100a_1ce6, 5); call(0x1007_6408, -0x2_b8e3);           /* call 0x10076408 */
            ii(0x100a_1ceb, 3); mov(ecx, memd[ss, ebp - 0xc]);          /* mov ecx, [ebp-0xc] */
            ...
            ii(0x100a_1cf9, 2); if(jnz(0x100a_1cfd, 0x2)) goto l_0x100a_1cfd; /* jnz 0x100a1cfd */
        l_0x100a_1cfb:
            ii(0x100a_1cfb, 2); jmp(0x100a_1d10, 0x13); goto l_0x100a_1d10; /* jmp 0x100a1d10 */
        l_0x100a_1cfd:
            ii(0x100a_1cfd, 7); mov(memd[ss, ebp - 0x1c], 0x1);         /* mov dword [ebp-0x1c], 0x1 */
            ii(0x100a_1d04, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_1d06, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x100a_1d10:
            ii(0x100a_1d10, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x100a_1d1a:
            ii(0x100a_1d1a, 7); mov(memd[ss, ebp - 0x1c], 0);           /* mov dword [ebp-0x1c], 0x0 */
            ii(0x100a_1d21, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_1d23, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
        ...
        //  ii(0x100a_1d2d, 2); xor(edx, edx);                          /* xor edx, edx */
        //  ii(0x100a_1d2f, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
        //  ii(0x100a_1d32, 5); call(0x1007_5f6c, -0x2_bdcb);           /* call 0x10075f6c */
        l_0x100a_1d37:
            ii(0x100a_1d37, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
