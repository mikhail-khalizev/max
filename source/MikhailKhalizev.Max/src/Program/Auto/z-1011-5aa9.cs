...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_5aa9()
        {
            ...
            ii(0x1011_5ac1, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1011_5ac4, 3); mov(memd[ss, ebp - 0xc], ebx);          /* mov [ebp-0xc], ebx */
            ii(0x1011_5ac7, 3); mov(memd[ss, ebp - 0x8], ecx);          /* mov [ebp-0x8], ecx */
            ...
            ii(0x1011_5adb, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1011_5adf, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_5ae2, 3); imul(edx, eax);                         /* imul edx, eax */
            ii(0x1011_5ae5, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1011_5ae8, 5); cmp(memw[ss, ebp + 0x18], 0);           /* cmp word [ebp+0x18], 0x0 */
            ii(0x1011_5aed, 2); if(jz(0x1011_5af8, 0x9)) goto l_0x1011_5af8; /* jz 0x10115af8 */
            ii(0x1011_5aef, 7); mov(memd[ss, ebp - 0x18], 0x4_0000);    /* mov dword [ebp-0x18], 0x40000 */
            ii(0x1011_5af6, 2); jmp(0x1011_5aff, 0x7); goto l_0x1011_5aff; /* jmp 0x10115aff */
        l_0x1011_5af8:
        ...
        l_0x1011_5b10:
            ...
            ii(0x1011_5b14, 4); movsx(ecx, memw[ss, ebp - 0x4]);        /* movsx ecx, word [ebp-0x4] */
            ii(0x1011_5b18, 4); movsx(ebx, memw[ss, ebp - 0x4]);        /* movsx ebx, word [ebp-0x4] */
            ...
            ii(0x1011_5b29, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x1011_5b2c, 6); call_abs(memd[ds, 0x101b_ddec]);        /* call dword [0x101bddec] */
            ii(0x1011_5b32, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1011_5b36, 3); imul(eax, eax, 0xa);                    /* imul eax, eax, 0xa */
            ii(0x1011_5b39, 3); add(memd[ss, ebp - 0x8], eax);          /* add [ebp-0x8], eax */
