...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_3879()
        {
            ...
            ii(0x100a_3891, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_3894, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_3896, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_38a6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_38a9, 3); add(eax, 0x6);                          /* add eax, 0x6 */
            ii(0x100a_38ac, 5); call(0x1008_af28, -0x1_8989);           /* call 0x1008af28 */
            ii(0x100a_38b1, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_38b4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_38b7, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x100a_38ba, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_38bd, 3); call_abs(memd[ds, edx + 0x34]);         /* call dword [edx+0x34] */
