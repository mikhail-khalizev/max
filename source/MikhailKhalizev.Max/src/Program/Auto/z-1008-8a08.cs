...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_8a08()
        {
            ...
            ii(0x1008_8a20, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_8a23, 5); call(0x1008_a4fc, 0x1ad4);              /* call 0x1008a4fc */
            ii(0x1008_8a28, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1008_8a2b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_8a2e, 5); call(0x100b_84c2, 0x2_fa8f);            /* call 0x100b84c2 */
            ii(0x1008_8a33, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_8a36, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
