...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("93c50cb3-c5d5-4d66-ab01-4e7ef81b6861")]
        public void Method_100f_4796()
        {
            ii(0x100f_4796, 5); pushd(0x1c);                            /* push 0x1c */
            ii(0x100f_479b, 5); calld(Definitions.sys_check_available_stack_size, 0x715b2); /* call 0x10165d52 */
            ...
            ii(0x100f_47b5, 5); calld(0x100c_fb73, -0x24c47);           /* call 0x100cfb73 */
            ii(0x100f_47ba, 5); calld(0x100f_fc13, 0xb454);             /* call 0x100ffc13 */
            ii(0x100f_47bf, 5); calld(0x1013_16c7, 0x3cf03);            /* call 0x101316c7 */
            ii(0x100f_47c4, 5); mov(eax, 0x5);                          /* mov eax, 0x5 */
            ii(0x100f_47c9, 5); calld(/* sys */ 0x1016_a24c, 0x75a7e);  /* call 0x1016a24c */
            ii(0x100f_47ce, 5); mov(eax, 0x101c_37bc);                  /* mov eax, 0x101c37bc */
            ii(0x100f_47d3, 5); calld(0x1007_6600, -0x7e1d8);           /* call 0x10076600 */
