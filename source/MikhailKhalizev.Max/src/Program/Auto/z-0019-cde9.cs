...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x19_cde9, 4); enter(0x8, 0);                            /* enter 0x8, 0x0 */
            ...
            ii(0x19_cdf9, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
            ii(0x19_cdfc, 3); mov(memw[ss, bp - 0x4], dx);              /* mov [bp-0x4], dx */
            ii(0x19_cdff, 3); les(bx, memw[ss, bp + 0x4]);              /* les bx, [bp+0x4] */
            ii(0x19_ce02, 4); mov(memb[es, bx], 0);                     /* mov byte [es:bx], 0x0 */
            ii(0x19_ce06, 3); mov(ax, memw[ss, bp + 0xa]);              /* mov ax, [bp+0xa] */
            ii(0x19_ce09, 3); or(ax, memw[ss, bp + 0x8]);               /* or ax, [bp+0x8] */
            ii(0x19_ce0c, 2); if(jz(0x19_ce6b, 0x5d)) goto l_0x19_ce6b; /* jz 0xce6b */
        l_0x19_ce0e:
            ii(0x19_ce0e, 4); sub(memw[ss, bp + 0x8], 0x1);             /* sub word [bp+0x8], 0x1 */
            ii(0x19_ce12, 4); sbb(memw[ss, bp + 0xa], 0);               /* sbb word [bp+0xa], 0x0 */
            ii(0x19_ce16, 3); mov(ax, memw[ss, bp + 0xa]);              /* mov ax, [bp+0xa] */
            ii(0x19_ce19, 3); or(ax, memw[ss, bp + 0x8]);               /* or ax, [bp+0x8] */
            ii(0x19_ce1c, 2); if(jz(0x19_ce32, 0x14)) goto l_0x19_ce32; /* jz 0xce32 */
            ii(0x19_ce1e, 3); les(bx, memw[ss, bp - 0x6]);              /* les bx, [bp-0x6] */
            ...
            ii(0x19_ce2d, 3); add(memw[ss, bp - 0x6], ax);              /* add [bp-0x6], ax */
            ii(0x19_ce30, 2); jmp(0x19_ce0e, -0x24); goto l_0x19_ce0e;  /* jmp 0xce0e */
        l_0x19_ce32:
            ii(0x19_ce32, 3); les(bx, memw[ss, bp - 0x6]);              /* les bx, [bp-0x6] */
            ii(0x19_ce35, 3); mov(al, memb[es, bx]);                    /* mov al, [es:bx] */
            ii(0x19_ce38, 2); sub(ah, ah);                              /* sub ah, ah */
            ii(0x19_ce3a, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
        ...
        l_0x19_ce43:
            ii(0x19_ce43, 3); les(bx, memw[ss, bp - 0x6]);              /* les bx, [bp-0x6] */
            ii(0x19_ce46, 3); mov(si, memw[ss, bp - 0x2]);              /* mov si, [bp-0x2] */
            ii(0x19_ce49, 4); mov(al, memb[es, bx + si + 0x1]);         /* mov al, [es:bx+si+0x1] */
            ii(0x19_ce4d, 3); les(bx, memw[ss, bp + 0x4]);              /* les bx, [bp+0x4] */
            ii(0x19_ce50, 3); mov(memb[es, bx + si], al);               /* mov [es:bx+si], al */
        l_0x19_ce53:
            ii(0x19_ce53, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0x19_ce56, 3); dec(memw[ss, bp - 0x2]);                  /* dec word [bp-0x2] */
            ii(0x19_ce59, 2); or(ax, ax);                               /* or ax, ax */
            ii(0x19_ce5b, 2); if(jnz(0x19_ce43, -0x1a)) goto l_0x19_ce43; /* jnz 0xce43 */
        l_0x19_ce5d:
            ii(0x19_ce5d, 3); les(bx, memw[ss, bp - 0x6]);              /* les bx, [bp-0x6] */
            ii(0x19_ce60, 3); mov(bl, memb[es, bx]);                    /* mov bl, [es:bx] */
            ii(0x19_ce63, 2); sub(bh, bh);                              /* sub bh, bh */
            ii(0x19_ce65, 3); les(si, memw[ss, bp + 0x4]);              /* les si, [bp+0x4] */
