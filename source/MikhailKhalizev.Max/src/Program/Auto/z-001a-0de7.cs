...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_001a_0de7()
        {
            ...
            ii(0x1a_0df1, 4); mov(memb[ss, bp - 0x1e], 0x62);           /* mov byte [bp-0x1e], 0x62 */
            ii(0x1a_0df5, 4); mov(memb[ss, bp - 0x1d], 0x70);           /* mov byte [bp-0x1d], 0x70 */
            ii(0x1a_0df9, 4); mov(memb[ss, bp - 0x1c], 0x20);           /* mov byte [bp-0x1c], 0x20 */
            ii(0x1a_0dfd, 2); push(0);                                  /* push 0x0 */
            ii(0x1a_0dff, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x1a_0e02, 2); push(0x10);                               /* push 0x10 */
            ii(0x1a_0e04, 2); push(0x4);                                /* push 0x4 */
            ii(0x1a_0e06, 3); lea(ax, memw[ss, bp - 0x1b]);             /* lea ax, [bp-0x1b] */
            ...
            ii(0x1a_0e0f, 4); mov(memb[ss, bp - 0x17], 0x3a);           /* mov byte [bp-0x17], 0x3a */
            ii(0x1a_0e13, 2); push(0);                                  /* push 0x0 */
            ii(0x1a_0e15, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x1a_0e18, 2); push(0x10);                               /* push 0x10 */
            ii(0x1a_0e1a, 2); push(0x4);                                /* push 0x4 */
            ii(0x1a_0e1c, 3); lea(ax, memw[ss, bp - 0x16]);             /* lea ax, [bp-0x16] */
            ...
            ii(0x1a_0e25, 3); lea(ax, memw[ss, bp - 0x12]);             /* lea ax, [bp-0x12] */
            ...
            ii(0x1a_0e31, 3); lea(ax, memw[ss, bp - 0x1e]);             /* lea ax, [bp-0x1e] */
            ...
            ii(0x1a_0e3f, 3); retf(0x4);                                /* retf 0x4 */
        }
    }
}
