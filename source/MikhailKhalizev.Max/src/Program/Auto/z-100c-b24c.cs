...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_b24c()
        {
            ...
            ii(0x100c_b25e, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100c_b264, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100c_b267, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100c_b26a, 5); call(0x1007_6b58, -0x5_4717);           /* call 0x10076b58 */
            ii(0x100c_b26f, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100c_b272, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
