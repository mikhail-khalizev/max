...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_2e0f()
        {
            ...
            ii(0x1010_2e21, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1010_2e27, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1010_2e2a, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_2e2d, 5); call(0x1007_6338, -0x8_cafa);           /* call 0x10076338 */
            ii(0x1010_2e32, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1010_2e34, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
            ii(0x1010_2e37, 5); call(0x1007_64b8, -0x8_c984);           /* call 0x100764b8 */
            ii(0x1010_2e3c, 2); jmp(0x1010_2e46, 8); goto l_0x1010_2e46; /* jmp 0x10102e46 */
        l_0x1010_2e3e:
            ii(0x1010_2e3e, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
            ii(0x1010_2e41, 5); call(0x1007_6bf8, -0x8_c24e);           /* call 0x10076bf8 */
        l_0x1010_2e46:
            ii(0x1010_2e46, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_2e48, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
            ...
            ii(0x1010_2e56, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
        ...
        l_0x1010_2e81:
            ii(0x1010_2e81, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_2e84, 5); call(0x1013_a6f4, 0x3_786b);            /* call 0x1013a6f4 */
            ii(0x1010_2e89, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_2e8b, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
