...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("eaed7913-859a-40e6-9707-f4763136267f")]
        public void Method_1012_26c4()
        {
            ii(0x1012_26c4, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x1012_26c9, 5); calld(Definitions.sys_check_available_stack_size, 0x43684); /* call 0x10165d52 */
            ...
            ii(0x1012_26f2, 5); calld(0x1013_d195, 0x1aa9e);            /* call 0x1013d195 */
            ...
            ii(0x1012_270b, 5); calld(0x100c_aafc, -0x57c14);           /* call 0x100caafc */
            ...
            ii(0x1012_2715, 1); retd(); return;                         /* ret */
        }
    }
}
