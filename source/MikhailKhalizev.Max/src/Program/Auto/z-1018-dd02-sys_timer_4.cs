...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ sys_timer_4()
        {
            ii(0x1018_dd02, 1); push(ebp);                              /* push ebp */
            ii(0x1018_dd03, 2); mov(ebp, esp);                          /* mov ebp, esp */
            ii(0x1018_dd05, 1); push(ebx);                              /* push ebx */
            ii(0x1018_dd06, 3); mov(ecx, memd[ss, ebp + 0x8]);          /* mov ecx, [ebp+0x8] */
        l_0x1018_dd09:
            ...
            ii(0x1018_dd1a, 7); mov(bx, memw[ds, 0x1020_9dd0]);         /* mov bx, [0x10209dd0] */
            ii(0x1018_dd21, 3); sub(bx, ax);                            /* sub bx, ax */
            ii(0x1018_dd24, 6); add(ebx, memd[ds, 0x101b_e420]);        /* add ebx, [0x101be420] */
            ii(0x1018_dd2a, 1); sti();                                  /* sti */
            ii(0x1018_dd2b, 2); sub(ebx, ecx);                          /* sub ebx, ecx */
            ii(0x1018_dd2d, 2); if(js(0x1018_dd09, -0x26)) goto l_0x1018_dd09; /* js 0x1018dd09 */
            ii(0x1018_dd2f, 2); mov(eax, ebx);                          /* mov eax, ebx */
            ii(0x1018_dd31, 1); pop(ebx);                               /* pop ebx */
            ii(0x1018_dd32, 1); leave();                                /* leave */
            ii(0x1018_dd33, 1); ret();                                  /* ret */
        }
    }
}
