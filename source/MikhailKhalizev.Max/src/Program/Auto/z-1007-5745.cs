...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_5745()
        {
            ...
            ii(0x1007_575d, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_5760, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_5763, 5); call(0x1011_9138, 0xa_39d0);            /* call 0x10119138 */
            ii(0x1007_5768, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ...
            ii(0x1007_5779, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_578a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_5799, 2); if(jz(0x1007_57a3, 0x8)) goto l_0x1007_57a3; /* jz 0x100757a3 */
            ii(0x1007_579b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_579e, 5); call(0x1012_b020, 0xb_587d);            /* call 0x1012b020 */
        l_0x1007_57a3:
            ii(0x1007_57a3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1007_57ad:
            ...
            ii(0x1007_57b4, 2); if(jz(0x1007_57be, 0x8)) goto l_0x1007_57be; /* jz 0x100757be */
            ii(0x1007_57b6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
