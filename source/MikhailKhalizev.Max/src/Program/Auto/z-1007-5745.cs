...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("eb76014a-41ea-4b82-ac9a-6e0dfced71d7")]
        public void Method_1007_5745()
        {
            ii(0x1007_5745, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x1007_574a, 5); calld(Definitions.sys_check_available_stack_size, 0xf_0603); /* call 0x10165d52 */
            ...
            ii(0x1007_5763, 5); calld(0x1011_9138, 0xa_39d0);           /* call 0x10119138 */
            ...
            ii(0x1007_577f, 5); calld(0x1013_ad11, 0xc_558d);           /* call 0x1013ad11 */
            ...
            ii(0x1007_578d, 5); calld(0x1014_f017, 0xd_9885);           /* call 0x1014f017 */
            ...
            ii(0x1007_579e, 5); calld(0x1012_b020, 0xb_587d);           /* call 0x1012b020 */
        l_0x1007_57a3:
            ii(0x1007_57a3, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1007_57a6, 5); calld(0x1014_b6bd, 0xd_5f12);           /* call 0x1014b6bd */
        ...
        l_0x1007_57ad:
            ...
            ii(0x1007_57b9, 5); calld(0x1012_ae8d, 0xb_56cf);           /* call 0x1012ae8d */
        l_0x1007_57be:
