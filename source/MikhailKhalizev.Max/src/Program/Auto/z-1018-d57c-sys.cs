...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1018_d586:
            ...
            ii(0x1018_d58c, 3); mov(ecx, memd[ds, eax + 0x4]);          /* mov ecx, [eax+0x4] */
            ii(0x1018_d58f, 2); cmp(ebx, ecx);                          /* cmp ebx, ecx */
            ii(0x1018_d591, 2); if(jz(0x1018_d597, 0x4)) goto l_0x1018_d597; /* jz 0x1018d597 */
            ii(0x1018_d593, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1018_d595, 2); jmp(0x1018_d586, -0x11); goto l_0x1018_d586; /* jmp 0x1018d586 */
        l_0x1018_d597:
            ii(0x1018_d597, 3); mov(cl, memb[ds, ecx + 0xc]);           /* mov cl, [ecx+0xc] */
            ii(0x1018_d59a, 3); or(cl, 0x3);                            /* or cl, 0x3 */
            ii(0x1018_d59d, 3); mov(memb[ds, ebx + 0xc], cl);           /* mov [ebx+0xc], cl */
