...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_0ba4()
        {
            ...
            ii(0x100e_0bac, 6);  sub(esp, 4);                          /* sub esp, 0x4 */
            ii(0x100e_0bb2, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100e_0bb5, 5);  mov(edx, 0x101c_35a8);                /* mov edx, 0x101c35a8 */
            ii(0x100e_0bba, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_0bbd, 5);  call(0x100d_4d78, -0xbe4a);           /* call 0x100d4d78 */
            ii(0x100e_0bc2, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
