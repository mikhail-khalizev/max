...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_20b7()
        {
            ...
            ii(0x1017_20c6, 3); lea(edx, memd[ds, ecx + 0x4]);          /* lea edx, [ecx+0x4] */
        ...
        l_0x1017_20ce:
            ...
            ii(0x1017_20ea, 4); mov(memb[ds, ecx + 0x5], 0x5f);         /* mov byte [ecx+0x5], 0x5f */
            ii(0x1017_20ee, 5); call(/* sys */ 0x1017_20ab, -0x48);     /* call 0x101720ab */
            ii(0x1017_20f3, 3); mov(memb[ds, ecx + 0x6], al);           /* mov [ecx+0x6], al */
            ...
            ii(0x1017_2100, 4); mov(memb[ds, ecx + 0x8], 0x2e);         /* mov byte [ecx+0x8], 0x2e */
            ii(0x1017_2104, 4); mov(memb[ds, ecx + 0x9], 0x74);         /* mov byte [ecx+0x9], 0x74 */
            ...
            ii(0x1017_2114, 3); mov(memb[ds, ecx + 0x7], al);           /* mov [ecx+0x7], al */
