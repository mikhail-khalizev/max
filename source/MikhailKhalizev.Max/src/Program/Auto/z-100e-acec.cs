...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("24e56460-b76c-4d60-a1e0-94b8757c7d3f")]
        public void Method_100e_acec()
        {
            ii(0x100e_acec, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x100e_acf1, 5); calld(Definitions.sys_check_available_stack_size, 0x7b05c); /* call 0x10165d52 */
            ...
            ii(0x100e_ad21, 1); retd(); return;                         /* ret */
        }
    }
}
