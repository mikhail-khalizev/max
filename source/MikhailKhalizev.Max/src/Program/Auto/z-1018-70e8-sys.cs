...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("63890049-d040-4d7f-bd4a-86c71486d270")]
        public void /* sys */ Method_1018_70e8()
        {
            ii(0x1018_70e8, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1018_70ea, 7); mov(bx, memw_a32[ds, 0x101b_e88c]);     /* mov bx, [0x101be88c] */
            ii(0x1018_70f1, 3); mov(ax, memw_a32[ds, ebx]);             /* mov ax, [ebx] */
            ii(0x1018_70f4, 6); mov(memw_a32[ds, 0x101b_e898], ax);     /* mov [0x101be898], ax */
