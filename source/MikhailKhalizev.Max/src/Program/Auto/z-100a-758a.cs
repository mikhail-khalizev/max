...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_758a()
        {
            ...
            ii(0x100a_75a7, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ...
            ii(0x100a_75b5, 4);  mov(memw[ss, ebp - 12], ax);          /* mov [ebp-0xc], ax */
            ii(0x100a_75b9, 2);  jmp(0x100a_75c2, 7); goto l_0x100a_75c2;/* jmp 0x100a75c2 */
        l_0x100a_75bb:
            ii(0x100a_75bb, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100a_75be, 4);  inc(memw[ss, ebp - 12]);              /* inc word [ebp-0xc] */
        l_0x100a_75c2:
            ii(0x100a_75c2, 4);  movsx(edx, memw[ss, ebp - 12]);       /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x100a_75d5, 4);  mov(memw[ss, ebp - 10], ax);          /* mov [ebp-0xa], ax */
            ii(0x100a_75d9, 2);  jmp(0x100a_75e2, 7); goto l_0x100a_75e2;/* jmp 0x100a75e2 */
        l_0x100a_75db:
            ii(0x100a_75db, 3);  mov(eax, memd[ss, ebp - 10]);         /* mov eax, [ebp-0xa] */
            ii(0x100a_75de, 4);  inc(memw[ss, ebp - 10]);              /* inc word [ebp-0xa] */
        l_0x100a_75e2:
            ii(0x100a_75e2, 4);  movsx(edx, memw[ss, ebp - 10]);       /* movsx edx, word [ebp-0xa] */
            ii(0x100a_75e6, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_75e9, 3);  cmp(edx, memd[ds, eax + 12]);         /* cmp edx, [eax+0xc] */
            ii(0x100a_75ec, 2);  if(jge(0x100a_75fe, 0x10)) goto l_0x100a_75fe;/* jge 0x100a75fe */
            ii(0x100a_75ee, 3);  lea(edx, memd[ss, ebp - 12]);         /* lea edx, [ebp-0xc] */
