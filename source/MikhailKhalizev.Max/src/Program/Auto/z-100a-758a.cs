...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_758a()
        {
            ...
            ii(0x100a_75a1, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_75a4, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ...
            ii(0x100a_75af, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_75b2, 3); mov(ax, memw[ds, eax]);                 /* mov ax, [eax] */
            ii(0x100a_75b5, 4); mov(memw[ss, ebp - 0xc], ax);           /* mov [ebp-0xc], ax */
            ii(0x100a_75b9, 2); jmp(0x100a_75c2, 0x7); goto l_0x100a_75c2; /* jmp 0x100a75c2 */
        l_0x100a_75bb:
        ...
        l_0x100a_75c2:
            ...
            ii(0x100a_75c6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_75c9, 3); cmp(edx, memd[ds, eax + 0x8]);          /* cmp edx, [eax+0x8] */
            ii(0x100a_75cc, 2); if(jge(0x100a_7600, 0x32)) goto l_0x100a_7600; /* jge 0x100a7600 */
            ii(0x100a_75ce, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_75d1, 4); mov(ax, memw[ds, eax + 0x4]);           /* mov ax, [eax+0x4] */
            ii(0x100a_75d5, 4); mov(memw[ss, ebp - 0xa], ax);           /* mov [ebp-0xa], ax */
            ii(0x100a_75d9, 2); jmp(0x100a_75e2, 0x7); goto l_0x100a_75e2; /* jmp 0x100a75e2 */
        l_0x100a_75db:
        ...
        l_0x100a_75e2:
            ...
            ii(0x100a_75e6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_75f1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
