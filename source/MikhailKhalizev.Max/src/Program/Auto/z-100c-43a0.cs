...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_43a0()
        {
            ...
            ii(0x100c_43c2, 2); if(jz(0x100c_43cd, 0x9)) goto l_0x100c_43cd; /* jz 0x100c43cd */
            ii(0x100c_43c4, 7); mov(memd[ss, ebp - 0x4], 0x2);          /* mov dword [ebp-0x4], 0x2 */
        ...
        l_0x100c_43cd:
            ...
            ii(0x100c_43d8, 2); if(jge(0x100c_43e3, 0x9)) goto l_0x100c_43e3; /* jge 0x100c43e3 */
            ii(0x100c_43da, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
        ...
        l_0x100c_43e3:
            ...
            ii(0x100c_43f0, 2); if(jge(0x100c_43fb, 0x9)) goto l_0x100c_43fb; /* jge 0x100c43fb */
            ii(0x100c_43f2, 7); mov(memd[ss, ebp - 0x4], 0x1);          /* mov dword [ebp-0x4], 0x1 */
            ii(0x100c_43f9, 2); jmp(0x100c_4402, 0x7); goto l_0x100c_4402; /* jmp 0x100c4402 */
        l_0x100c_43fb:
            ii(0x100c_43fb, 7); mov(memd[ss, ebp - 0x4], 0x2);          /* mov dword [ebp-0x4], 0x2 */
        l_0x100c_4402:
            ii(0x100c_4402, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
