...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_489a()
        {
            ...
            ii(0x17_48a6, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ...
            ii(0x17_48b2, 2); if(jnz(0x17_48b7, 0x3)) goto l_0x17_48b7; /* jnz 0x48b7 */
            ii(0x17_48b4, 3); mov(memw[ss, bp + 0x8], ax);              /* mov [bp+0x8], ax */
        l_0x17_48b7:
            ...
            ii(0x17_48cc, 3); mov(al, memb[ss, bp - 0x9]);              /* mov al, [bp-0x9] */
            ...
            ii(0x17_48e0, 3); add(cx, memw[ss, bp + 0x6]);              /* add cx, [bp+0x6] */
            ii(0x17_48e3, 3); adc(dx, memw[ss, bp + 0x8]);              /* adc dx, [bp+0x8] */
            ii(0x17_48e6, 3); mov(memw[ss, bp - 0x4], cx);              /* mov [bp-0x4], cx */
            ii(0x17_48e9, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x17_48ec, 3); mov(memw[ss, bp - 0xe], cx);              /* mov [bp-0xe], cx */
            ii(0x17_48ef, 3); mov(al, memb[ss, bp - 0x2]);              /* mov al, [bp-0x2] */
            ii(0x17_48f2, 3); mov(memb[ss, bp - 0xc], al);              /* mov [bp-0xc], al */
            ii(0x17_48f5, 3); mov(al, memb[ss, bp - 0x1]);              /* mov al, [bp-0x1] */
            ii(0x17_48f8, 2); sub(ah, ah);                              /* sub ah, ah */
            ii(0x17_48fa, 3); mov(memb[ss, bp - 0x9], al);              /* mov [bp-0x9], al */
            ...
            ii(0x17_4906, 3); mov(memw[ss, bp - 0x8], cx);              /* mov [bp-0x8], cx */
            ii(0x17_4909, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
            ...
            ii(0x17_4922, 5); or(memw[ss, bp - 0x8], 0xfff);            /* or word [bp-0x8], 0xfff */
            ii(0x17_4927, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_492a, 3); mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ii(0x17_492d, 3); sub(memw[ss, bp - 0x8], ax);              /* sub [bp-0x8], ax */
            ii(0x17_4930, 3); sbb(memw[ss, bp - 0x6], dx);              /* sbb [bp-0x6], dx */
            ii(0x17_4933, 4); cmp(memw[ss, bp - 0x6], 0);               /* cmp word [bp-0x6], 0x0 */
            ii(0x17_4937, 2); if(jnz(0x17_493f, 0x6)) goto l_0x17_493f; /* jnz 0x493f */
            ii(0x17_4939, 4); cmp(memw[ss, bp - 0x8], -0x1 /* 0xff */); /* cmp word [bp-0x8], 0xffff */
            ii(0x17_493d, 2); if(jbe(0x17_4949, 0xa)) goto l_0x17_4949; /* jbe 0x4949 */
        l_0x17_493f:
            ii(0x17_493f, 5); mov(memw[ss, bp - 0x8], 0xffff);          /* mov word [bp-0x8], 0xffff */
            ii(0x17_4944, 5); mov(memw[ss, bp - 0x6], 0);               /* mov word [bp-0x6], 0x0 */
        l_0x17_4949:
            ii(0x17_4949, 2); jmp(0x17_4958, 0xd); goto l_0x17_4958;    /* jmp 0x4958 */
        //  ii(0x17_494b, 1); nop();                                    /* nop */
        l_0x17_494c:
            ii(0x17_494c, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_494f, 3); mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ii(0x17_4952, 3); sub(memw[ss, bp - 0x8], ax);              /* sub [bp-0x8], ax */
            ii(0x17_4955, 3); sbb(memw[ss, bp - 0x6], dx);              /* sbb [bp-0x6], dx */
        l_0x17_4958:
            ii(0x17_4958, 3); mov(ax, memw[ss, bp - 0x8]);              /* mov ax, [bp-0x8] */
