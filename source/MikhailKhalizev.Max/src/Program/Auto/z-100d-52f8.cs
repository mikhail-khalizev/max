...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_52f8()
        {
            ...
            ii(0x100d_5300, 6); sub(esp, 4);                            /* sub esp, 0x4 */
            ii(0x100d_5306, 7); mov(memd[ss, ebp - 4], 0);              /* mov dword [ebp-0x4], 0x0 */
            ii(0x100d_530d, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
