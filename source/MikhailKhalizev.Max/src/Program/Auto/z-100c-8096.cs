...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_8096()
        {
            ...
            ii(0x100c_80ac, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100c_80af, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100c_80b2, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ii(0x100c_80b5, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x100c_80b8, 5); call(Definitions.my_ctor_0x101b_4184, -0x5_15cd); /* call 0x10076af0 */
        l_0x100c_80bd:
            ii(0x100c_80bd, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100c_80c0, 3); mov(edx, memd[ds, eax + 0x13]);         /* mov edx, [eax+0x13] */
            ii(0x100c_80c3, 3); sub(edx, 0x4);                          /* sub edx, 0x4 */
            ii(0x100c_80c6, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100c_80c9, 3); sub(edx, memd[ds, eax + 0xb]);          /* sub edx, [eax+0xb] */
            ...
            ii(0x100c_80da, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100c_80dd, 3); add(edx, memd[ds, eax + 0xb]);          /* add edx, [eax+0xb] */
            ii(0x100c_80e0, 4); mov(memw[ss, ebp - 0x10], dx);          /* mov [ebp-0x10], dx */
            ii(0x100c_80e4, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100c_80e7, 3); mov(edx, memd[ds, eax + 0x17]);         /* mov edx, [eax+0x17] */
            ii(0x100c_80ea, 3); sub(edx, 0x4);                          /* sub edx, 0x4 */
            ii(0x100c_80ed, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100c_80f0, 3); sub(edx, memd[ds, eax + 0xf]);          /* sub edx, [eax+0xf] */
            ...
            ii(0x100c_80ff, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100c_8102, 3); add(edx, memd[ds, eax + 0xf]);          /* add edx, [eax+0xf] */
            ii(0x100c_8105, 4); mov(memw[ss, ebp - 0xe], dx);           /* mov [ebp-0xe], dx */
            ii(0x100c_8109, 3); lea(edx, memd[ss, ebp - 0x10]);         /* lea edx, [ebp-0x10] */
            ii(0x100c_810c, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x100c_810f, 5); call(0x1007_5e64, -0x5_22b0);           /* call 0x10075e64 */
            ii(0x100c_8114, 2); mov(ecx, eax);                          /* mov ecx, eax */
            ii(0x100c_8116, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
            ii(0x100c_811a, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x100c_811f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100c_812b, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100c_812f, 3); imul(edx, edx, 0x13);                   /* imul edx, edx, 0x13 */
            ii(0x100c_8132, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100c_8135, 7); mov(memw[ds, edx + 0x101c_35bc], ax);   /* mov [edx+0x101c35bc], ax */
            ii(0x100c_813c, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100c_8140, 3); imul(edx, edx, 0x13);                   /* imul edx, edx, 0x13 */
            ii(0x100c_8143, 3); mov(eax, memd[ss, ebp - 0xe]);          /* mov eax, [ebp-0xe] */
