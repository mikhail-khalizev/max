...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_93a2()
        {
            ...
            ii(0x93a8, 4);  mov(memb[ss, bp - 13], 0x49);              /* mov byte [bp-0xd], 0x49 */
            ii(0x93ac, 3);  mov(ax, memw[ss, bp + 4]);                 /* mov ax, [bp+0x4] */
            ii(0x93af, 3);  mov(memw[ss, bp - 22], ax);                /* mov [bp-0x16], ax */
            ii(0x93b2, 3);  lea(ax, memw[ss, bp - 22]);                /* lea ax, [bp-0x16] */
            ii(0x93b5, 1);  push(ax);                                  /* push ax */
            ii(0x93b6, 3);  lea(ax, memw[ss, bp - 14]);                /* lea ax, [bp-0xe] */
