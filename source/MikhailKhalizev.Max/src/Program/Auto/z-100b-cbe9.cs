...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_cbe9()
        {
            ...
            ii(0x100b_cc00, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_cc03, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100b_cc06, 5); mov(eax, 0x101c_819c);                  /* mov eax, 0x101c819c */
            ii(0x100b_cc0b, 5); call(0x1007_6338, -0x4_68d8);           /* call 0x10076338 */
            ii(0x100b_cc10, 3); lea(ebx, memd[ss, ebp - 0x10]);         /* lea ebx, [ebp-0x10] */
            ...
            ii(0x100b_cc1c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_cc1f, 5); call(0x1007_623c, -0x4_69e8);           /* call 0x1007623c */
            ii(0x100b_cc24, 4); mov(ax, memw[ds, eax + 0x17]);          /* mov ax, [eax+0x17] */
            ii(0x100b_cc28, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100b_cc2b, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x100b_cc2e, 4); imul(eax, memd[ss, ebp - 0x14]);        /* imul eax, [ebp-0x14] */
            ii(0x100b_cc32, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100b_cc35, 2); jmp(0x100b_cc3f, 0x8); goto l_0x100b_cc3f; /* jmp 0x100bcc3f */
        l_0x100b_cc37:
            ii(0x100b_cc37, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x100b_cc3a, 5); call(0x1007_6bf8, -0x4_6047);           /* call 0x10076bf8 */
        l_0x100b_cc3f:
            ii(0x100b_cc3f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_cc41, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x100b_cc4d, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x100b_cc50, 5); call(0x1007_63a0, -0x4_68b5);           /* call 0x100763a0 */
            ii(0x100b_cc55, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_cc57, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ii(0x100b_cc5a, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100b_cc5e, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x100b_cc60, 2); if(jnz(0x100b_cc7a, 0x18)) goto l_0x100b_cc7a; /* jnz 0x100bcc7a */
            ii(0x100b_cc62, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x100b_cc65, 5); call(0x1007_63d4, -0x4_6896);           /* call 0x100763d4 */
            ii(0x100b_cc6a, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100b_cc6c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_cc6f, 5); call(0x1007_0d01, -0x4_bf73);           /* call 0x10070d01 */
            ii(0x100b_cc74, 4); cmp(ax, memw[ss, ebp - 0x14]);          /* cmp ax, [ebp-0x14] */
            ii(0x100b_cc78, 2); if(jle(0x100b_cc7c, 0x2)) goto l_0x100b_cc7c; /* jle 0x100bcc7c */
        l_0x100b_cc7a:
            ii(0x100b_cc7a, 2); jmp(0x100b_cc8c, 0x10); goto l_0x100b_cc8c; /* jmp 0x100bcc8c */
        l_0x100b_cc7c:
            ii(0x100b_cc7c, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x100b_cc80, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_cc82, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x100b_cc8e:
            ii(0x100b_cc8e, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
            ii(0x100b_cc92, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_cc94, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
        ...
        //  ii(0x100b_cca0, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
        //  ii(0x100b_cca3, 5); call(0x1007_5f6c, -0x4_6d3c);           /* call 0x10075f6c */
        l_0x100b_cca8:
            ii(0x100b_cca8, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
