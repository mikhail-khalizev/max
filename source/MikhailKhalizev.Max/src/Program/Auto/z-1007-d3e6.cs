...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_d3e6()
        {
            ...
            ii(0x1007_d3fd, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_d400, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1007_d403, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_d406, 5); call(0x1007_6338, -0x70d3);             /* call 0x10076338 */
            ii(0x1007_d40b, 3); lea(ebx, memd[ss, ebp - 0x18]);         /* lea ebx, [ebp-0x18] */
            ...
            ii(0x1007_d417, 4); or(memb[ss, ebp - 0xc], 0x1);           /* or byte [ebp-0xc], 0x1 */
            ii(0x1007_d41b, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_d41e, 5); call(Definitions.my_ctor_0x101b_3b58, 0xdc81); /* call 0x1008b0a4 */
            ii(0x1007_d423, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1007_d426, 4); and(memb[ss, ebp - 0xc], -0x2 /* 0xfe */); /* and byte [ebp-0xc], 0xfe */
            ii(0x1007_d42a, 2); jmp(0x1007_d434, 0x8); goto l_0x1007_d434; /* jmp 0x1007d434 */
        l_0x1007_d42c:
            ii(0x1007_d42c, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_d42f, 5); call(0x1007_6bf8, -0x683c);             /* call 0x10076bf8 */
        l_0x1007_d434:
            ii(0x1007_d434, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_d436, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x1007_d446, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_d449, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x1007_d460, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_d463, 5); call(0x1008_afe4, 0xdb7c);              /* call 0x1008afe4 */
            ii(0x1007_d468, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_d46b, 5); call(0x1007_63a0, -0x70d0);             /* call 0x100763a0 */
            ii(0x1007_d470, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_d472, 3); mov(dl, memb[ds, eax + 0x4d]);          /* mov dl, [eax+0x4d] */
            ii(0x1007_d475, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_d478, 5); call(0x1007_63a0, -0x70dd);             /* call 0x100763a0 */
            ii(0x1007_d47d, 5); call(0x1007_623c, -0x7246);             /* call 0x1007623c */
            ii(0x1007_d482, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ...
            ii(0x1007_d499, 2); if(jge(0x1007_d49d, 0x2)) goto l_0x1007_d49d; /* jge 0x1007d49d */
        l_0x1007_d49b:
        ...
        l_0x1007_d49d:
            ...
            ii(0x1007_d4a7, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1007_d4aa, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x1007_d4ad, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1007_d4b0, 4); cmp(memd[ss, ebp - 0x20], 0);           /* cmp dword [ebp-0x20], 0x0 */
            ii(0x1007_d4b4, 2); if(jz(0x1007_d4d3, 0x1d)) goto l_0x1007_d4d3; /* jz 0x1007d4d3 */
            ii(0x1007_d4b6, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_d4b9, 5); call(0x1007_63d4, -0x70ea);             /* call 0x100763d4 */
            ii(0x1007_d4be, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1007_d4c0, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x1007_d4c3, 5); call(Definitions.my_ctor_c15, 0x4_e3c0); /* call 0x100cb888 */
            ii(0x1007_d4c8, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x1007_d4cb, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x1007_d4ce, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ii(0x1007_d4d1, 2); jmp(0x1007_d4d9, 0x6); goto l_0x1007_d4d9; /* jmp 0x1007d4d9 */
        l_0x1007_d4d3:
            ii(0x1007_d4d3, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1007_d4d6, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
        l_0x1007_d4d9:
            ii(0x1007_d4d9, 3); mov(edx, memd[ss, ebp - 0x28]);         /* mov edx, [ebp-0x28] */
            ii(0x1007_d4dc, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x1007_d4e9:
            ii(0x1007_d4e9, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_d4ec, 5); call(0x1007_63a0, -0x7151);             /* call 0x100763a0 */
            ii(0x1007_d4f1, 5); call(0x1007_623c, -0x72ba);             /* call 0x1007623c */
            ii(0x1007_d4f6, 3); mov(eax, memd[ds, eax + 0x12]);         /* mov eax, [eax+0x12] */
            ...
            ii(0x1007_d500, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_d503, 5); call(0x1007_63a0, -0x7168);             /* call 0x100763a0 */
            ii(0x1007_d508, 3); mov(al, memb[ds, eax + 0x54]);          /* mov al, [eax+0x54] */
            ...
            ii(0x1007_d51e, 3); mov(memd[ss, ebp - 0x2c], eax);         /* mov [ebp-0x2c], eax */
            ii(0x1007_d521, 3); mov(eax, memd[ss, ebp - 0x2c]);         /* mov eax, [ebp-0x2c] */
            ii(0x1007_d524, 3); mov(memd[ss, ebp - 0x30], eax);         /* mov [ebp-0x30], eax */
            ii(0x1007_d527, 4); cmp(memd[ss, ebp - 0x30], 0);           /* cmp dword [ebp-0x30], 0x0 */
            ii(0x1007_d52b, 2); if(jz(0x1007_d54a, 0x1d)) goto l_0x1007_d54a; /* jz 0x1007d54a */
            ii(0x1007_d52d, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_d530, 5); call(0x1007_63d4, -0x7161);             /* call 0x100763d4 */
            ii(0x1007_d535, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1007_d537, 3); mov(eax, memd[ss, ebp - 0x2c]);         /* mov eax, [ebp-0x2c] */
            ii(0x1007_d53a, 5); call(Definitions.my_ctor_c16, 0x4_f8eb); /* call 0x100cce2a */
            ii(0x1007_d53f, 3); mov(memd[ss, ebp - 0x34], eax);         /* mov [ebp-0x34], eax */
            ii(0x1007_d542, 3); mov(eax, memd[ss, ebp - 0x34]);         /* mov eax, [ebp-0x34] */
            ii(0x1007_d545, 3); mov(memd[ss, ebp - 0x38], eax);         /* mov [ebp-0x38], eax */
            ii(0x1007_d548, 2); jmp(0x1007_d550, 0x6); goto l_0x1007_d550; /* jmp 0x1007d550 */
        l_0x1007_d54a:
            ii(0x1007_d54a, 3); mov(eax, memd[ss, ebp - 0x30]);         /* mov eax, [ebp-0x30] */
            ii(0x1007_d54d, 3); mov(memd[ss, ebp - 0x38], eax);         /* mov [ebp-0x38], eax */
        l_0x1007_d550:
            ii(0x1007_d550, 3); mov(edx, memd[ss, ebp - 0x38]);         /* mov edx, [ebp-0x38] */
            ii(0x1007_d553, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x1007_d560:
            ii(0x1007_d560, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_d563, 5); call(0x1007_63a0, -0x71c8);             /* call 0x100763a0 */
            ii(0x1007_d568, 6); test(memw[ds, eax + 0x12], 0x1c0);      /* test word [eax+0x12], 0x1c0 */
            ii(0x1007_d56e, 2); if(jz(0x1007_d57e, 0xe)) goto l_0x1007_d57e; /* jz 0x1007d57e */
            ii(0x1007_d570, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_d573, 5); call(0x1007_63a0, -0x71d8);             /* call 0x100763a0 */
            ii(0x1007_d578, 4); test(memb[ds, eax + 0x15], 0x10);       /* test byte [eax+0x15], 0x10 */
            ii(0x1007_d57c, 2); if(jz(0x1007_d580, 0x2)) goto l_0x1007_d580; /* jz 0x1007d580 */
        l_0x1007_d57e:
            ii(0x1007_d57e, 2); jmp(0x1007_d5b0, 0x30); goto l_0x1007_d5b0; /* jmp 0x1007d5b0 */
        l_0x1007_d580:
            ii(0x1007_d580, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_d583, 5); call(0x1007_63d4, -0x71b4);             /* call 0x100763d4 */
            ii(0x1007_d588, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1007_d58a, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_d58d, 5); call(0x1007_63a0, -0x71f2);             /* call 0x100763a0 */
            ii(0x1007_d592, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ...
            ii(0x1007_d5ae, 2); if(jnz(0x1007_d5b2, 0x2)) goto l_0x1007_d5b2; /* jnz 0x1007d5b2 */
        l_0x1007_d5b0:
        ...
        l_0x1007_d5b2:
            ...
            ii(0x1007_d5bc, 3); mov(memd[ss, ebp - 0x3c], eax);         /* mov [ebp-0x3c], eax */
            ii(0x1007_d5bf, 3); mov(eax, memd[ss, ebp - 0x3c]);         /* mov eax, [ebp-0x3c] */
            ii(0x1007_d5c2, 3); mov(memd[ss, ebp - 0x40], eax);         /* mov [ebp-0x40], eax */
            ii(0x1007_d5c5, 4); cmp(memd[ss, ebp - 0x40], 0);           /* cmp dword [ebp-0x40], 0x0 */
            ii(0x1007_d5c9, 2); if(jz(0x1007_d5e8, 0x1d)) goto l_0x1007_d5e8; /* jz 0x1007d5e8 */
            ii(0x1007_d5cb, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_d5ce, 5); call(0x1007_63d4, -0x71ff);             /* call 0x100763d4 */
            ii(0x1007_d5d3, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1007_d5d5, 3); mov(eax, memd[ss, ebp - 0x3c]);         /* mov eax, [ebp-0x3c] */
            ii(0x1007_d5d8, 5); call(Definitions.my_ctor_c18, 0x4_fd80); /* call 0x100cd35d */
            ii(0x1007_d5dd, 3); mov(memd[ss, ebp - 0x44], eax);         /* mov [ebp-0x44], eax */
            ii(0x1007_d5e0, 3); mov(eax, memd[ss, ebp - 0x44]);         /* mov eax, [ebp-0x44] */
            ii(0x1007_d5e3, 3); mov(memd[ss, ebp - 0x48], eax);         /* mov [ebp-0x48], eax */
            ii(0x1007_d5e6, 2); jmp(0x1007_d5ee, 0x6); goto l_0x1007_d5ee; /* jmp 0x1007d5ee */
        l_0x1007_d5e8:
            ii(0x1007_d5e8, 3); mov(eax, memd[ss, ebp - 0x40]);         /* mov eax, [ebp-0x40] */
            ii(0x1007_d5eb, 3); mov(memd[ss, ebp - 0x48], eax);         /* mov [ebp-0x48], eax */
        l_0x1007_d5ee:
            ii(0x1007_d5ee, 3); mov(edx, memd[ss, ebp - 0x48]);         /* mov edx, [ebp-0x48] */
            ii(0x1007_d5f1, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_d5f4, 5); call(0x1008_afe4, 0xd9eb);              /* call 0x1008afe4 */
        l_0x1007_d5f9:
            ii(0x1007_d5f9, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_d5fb, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1007_d607, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x1007_d622:
            ...
            ii(0x1007_d624, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_d627, 5); call(0x1008_8b7c, 0xb550);              /* call 0x10088b7c */
            ii(0x1007_d62c, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_d62e, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
