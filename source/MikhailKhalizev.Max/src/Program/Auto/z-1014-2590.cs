...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_2590()
        {
            ...
            ii(0x1014_25a5, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1014_25a8, 3); mov(memd[ss, ebp - 12], edx);           /* mov [ebp-0xc], edx */
            ii(0x1014_25ab, 3); mov(memd[ss, ebp - 8], ebx);            /* mov [ebp-0x8], ebx */
            ii(0x1014_25ae, 3); mov(memd[ss, ebp - 4], ecx);            /* mov [ebp-0x4], ecx */
            ii(0x1014_25b1, 4); mov(memb[ss, ebp - 20], 0);             /* mov byte [ebp-0x14], 0x0 */
            ...
            ii(0x1014_25c8, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
            ...
            ii(0x1014_25d9, 3); mov(memd[ss, ebp - 40], eax);           /* mov [ebp-0x28], eax */
            ii(0x1014_25dc, 7); mov(memd[ss, ebp - 24], 0x1bc);         /* mov dword [ebp-0x18], 0x1bc */
            ii(0x1014_25e3, 7); mov(memd[ss, ebp - 28], 0x1ed);         /* mov dword [ebp-0x1c], 0x1ed */
        ...
        l_0x1014_25ec:
            ...
            ii(0x1014_25fa, 3); mov(memd[ss, ebp - 40], eax);           /* mov [ebp-0x28], eax */
            ii(0x1014_25fd, 7); mov(memd[ss, ebp - 24], 0x1ab);         /* mov dword [ebp-0x18], 0x1ab */
            ii(0x1014_2604, 7); mov(memd[ss, ebp - 28], 0x1dd);         /* mov dword [ebp-0x1c], 0x1dd */
        ...
        l_0x1014_260d:
            ...
            ii(0x1014_2612, 3); mov(memd[ss, ebp - 40], eax);           /* mov [ebp-0x28], eax */
            ii(0x1014_2615, 7); mov(memd[ss, ebp - 24], 0x19a);         /* mov dword [ebp-0x18], 0x19a */
            ii(0x1014_261c, 7); mov(memd[ss, ebp - 28], 0x1cd);         /* mov dword [ebp-0x1c], 0x1cd */
        l_0x1014_2623:
            ...
            ii(0x1014_262c, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
            ii(0x1014_262f, 3); add(eax, memd[ss, ebp - 24]);           /* add eax, [ebp-0x18] */
            ii(0x1014_2632, 1); cwde();                                 /* cwde */
            ii(0x1014_2633, 5); call(Definitions.my_get_res_data_by_id, -0xe660); /* call 0x10133fd8 */
            ii(0x1014_2638, 3); mov(memd[ss, ebp - 36], eax);           /* mov [ebp-0x24], eax */
            ...
            ii(0x1014_264a, 3); mov(eax, memd[ss, ebp - 36]);           /* mov eax, [ebp-0x24] */
            ii(0x1014_264d, 5); call(0x100e_8f38, -0x5_971a);           /* call 0x100e8f38 */
            ii(0x1014_2652, 3); mov(memd[ss, ebp - 36], eax);           /* mov [ebp-0x24], eax */
            ii(0x1014_2655, 4); mov(memb[ss, ebp - 20], 1);             /* mov byte [ebp-0x14], 0x1 */
        l_0x1014_2659:
            ii(0x1014_2659, 2); jmp(0x1014_26ab, 0x50); goto l_0x1014_26ab; /* jmp 0x101426ab */
        l_0x1014_265b:
            ii(0x1014_265b, 4); movsx(eax, memw[ss, ebp - 32]);         /* movsx eax, word [ebp-0x20] */
            ii(0x1014_265f, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1014_2661, 6); if(jz(0x1014_2718, 0xb1)) goto l_0x1014_2718; /* jz 0x10142718 */
            ii(0x1014_2667, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
            ii(0x1014_266a, 3); add(eax, memd[ss, ebp - 28]);           /* add eax, [ebp-0x1c] */
            ...
            ii(0x1014_2674, 3); mov(memd[ss, ebp - 36], eax);           /* mov [ebp-0x24], eax */
            ...
            ii(0x1014_2696, 3); mov(memd[ss, ebp - 44], eax);           /* mov [ebp-0x2c], eax */
            ii(0x1014_2699, 3); mov(edx, memd[ss, ebp - 44]);           /* mov edx, [ebp-0x2c] */
            ii(0x1014_269c, 3); mov(eax, memd[ss, ebp - 36]);           /* mov eax, [ebp-0x24] */
            ii(0x1014_269f, 5); call(0x100e_8f38, -0x5_976c);           /* call 0x100e8f38 */
            ii(0x1014_26a4, 3); mov(memd[ss, ebp - 36], eax);           /* mov [ebp-0x24], eax */
            ii(0x1014_26a7, 4); mov(memb[ss, ebp - 20], 1);             /* mov byte [ebp-0x14], 0x1 */
        l_0x1014_26ab:
            ii(0x1014_26ab, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ...
            ii(0x1014_26db, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x1014_2702, 3); mov(eax, memd[ss, ebp - 36]);           /* mov eax, [ebp-0x24] */
            ii(0x1014_2705, 5); call(0x100e_8d1e, -0x5_99ec);           /* call 0x100e8d1e */
            ii(0x1014_270a, 4); cmp(memb[ss, ebp - 20], 0);             /* cmp byte [ebp-0x14], 0x0 */
            ii(0x1014_270e, 2); if(jz(0x1014_2718, 8)) goto l_0x1014_2718; /* jz 0x10142718 */
            ii(0x1014_2710, 3); mov(eax, memd[ss, ebp - 36]);           /* mov eax, [ebp-0x24] */
