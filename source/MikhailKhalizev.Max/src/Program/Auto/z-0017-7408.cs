...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_7408()
        {
            ...
            ii(0x17_7414, 3); mov(memw[ss, bp - 0x14], ax);             /* mov [bp-0x14], ax */
            ii(0x17_7417, 3); mov(memw[ss, bp - 0x12], ax);             /* mov [bp-0x12], ax */
            ii(0x17_741a, 5); mov(memw[ss, bp - 0x6], 0x1500);          /* mov word [bp-0x6], 0x1500 */
            ii(0x17_741f, 3); lea(ax, memw[ss, bp - 0x14]);             /* lea ax, [bp-0x14] */
            ...
            ii(0x17_7431, 2); if(jnz(0x17_7436, 0x3)) goto l_0x17_7436; /* jnz 0x7436 */
            ii(0x17_7433, 1); pop(ds);                                  /* pop ds */
            ii(0x17_7434, 1); leave();                                  /* leave */
            ii(0x17_7435, 1); retf(); return;                           /* retf */
        l_0x17_7436:
            ii(0x17_7436, 3); mov(ax, memw[ss, bp - 0x6]);              /* mov ax, [bp-0x6] */
            ii(0x17_7439, 3); mov(memw[ds, 0x1ea0], ax);                /* mov [0x1ea0], ax */
            ii(0x17_743c, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0x17_743f, 3); mov(memw[ds, 0x1e9e], ax);                /* mov [0x1e9e], ax */
            ii(0x17_7442, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0x17_7445, 3); mov(memw[ds, 0x1ea4], ax);                /* mov [0x1ea4], ax */
            ii(0x17_7448, 3); mov(ax, memw[ss, bp - 0x8]);              /* mov ax, [bp-0x8] */
