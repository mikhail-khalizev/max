...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_bf57()
        {
            ...
            ii(0x100d_bf6f, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100d_bf72, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_bf75, 4); mov(ax, memw[ds, eax + 0xc]);           /* mov ax, [eax+0xc] */
            ii(0x100d_bf79, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100d_bf7c, 4); sub(ax, memw[ds, edx + 0x4]);           /* sub ax, [edx+0x4] */
            ii(0x100d_bf80, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100d_bf83, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_bf86, 3); mov(eax, memd[ds, eax + 0x12]);         /* mov eax, [eax+0x12] */
            ii(0x100d_bf89, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100d_bf8c, 1); push(eax);                              /* push eax */
            ii(0x100d_bf8d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_bf90, 3); push(memd[ds, eax + 0x1a]);             /* push dword [eax+0x1a] */
            ii(0x100d_bf93, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_bf96, 3); mov(eax, memd[ds, eax + 0x2a]);         /* mov eax, [eax+0x2a] */
            ii(0x100d_bf99, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x100d_bf9c, 1); push(eax);                              /* push eax */
            ii(0x100d_bf9d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_bfa0, 3); mov(eax, memd[ds, eax + 0x2a]);         /* mov eax, [eax+0x2a] */
            ...
            ii(0x100d_bfa9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_bfac, 3); mov(eax, memd[ds, eax + 0x2a]);         /* mov eax, [eax+0x2a] */
            ii(0x100d_bfaf, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x100d_bfb2, 1); push(eax);                              /* push eax */
            ii(0x100d_bfb3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_bfb6, 3); mov(eax, memd[ds, eax + 0x2a]);         /* mov eax, [eax+0x2a] */
            ...
            ii(0x100d_bfc5, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x100d_bfcc, 2); jmp(0x100d_bfd4, 0x6); goto l_0x100d_bfd4; /* jmp 0x100dbfd4 */
        l_0x100d_bfce:
            ii(0x100d_bfce, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_bfd1, 3); inc(memd[ss, ebp - 0x10]);              /* inc dword [ebp-0x10] */
        l_0x100d_bfd4:
            ii(0x100d_bfd4, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_bfd7, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100d_bfda, 4); cmp(ax, memw[ds, edx + 0x28]);          /* cmp ax, [edx+0x28] */
            ii(0x100d_bfde, 2); if(jge(0x100d_bfff, 0x1f)) goto l_0x100d_bfff; /* jge 0x100dbfff */
            ii(0x100d_bfe0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_bfe3, 3); mov(eax, memd[ds, eax + 0x22]);         /* mov eax, [eax+0x22] */
            ii(0x100d_bfe6, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100d_bfe9, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x100d_bfed, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x100d_bfef, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_bffd, 2); if(jl(0x100d_c004, 0x5)) goto l_0x100d_c004; /* jl 0x100dc004 */
        l_0x100d_bfff:
            ii(0x100d_bfff, 5); jmp(0x100d_c257, 0x253); goto l_0x100d_c257; /* jmp 0x100dc257 */
        l_0x100d_c004:
            ii(0x100d_c004, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c007, 4); mov(ax, memw[ds, eax + 0x24]);          /* mov ax, [eax+0x24] */
            ii(0x100d_c00b, 3); add(eax, memd[ss, ebp - 0x10]);         /* add eax, [ebp-0x10] */
            ii(0x100d_c00e, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x100d_c011, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_c01f, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100d_c022, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x100d_c03f, 4); movsx(ebx, memw[ss, ebp - 0x1c]);       /* movsx ebx, word [ebp-0x1c] */
            ii(0x100d_c043, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100d_c046, 3); mov(edx, memd[ds, edx + 0x12]);         /* mov edx, [edx+0x12] */
            ii(0x100d_c049, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_c04c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c04f, 3); mov(eax, memd[ds, eax + 0x1a]);         /* mov eax, [eax+0x1a] */
            ii(0x100d_c052, 5); call(0x1012_b6af, 0x4_f658);            /* call 0x1012b6af */
            ii(0x100d_c057, 4); movsx(edx, memw[ss, ebp - 0x1c]);       /* movsx edx, word [ebp-0x1c] */
            ...
            ii(0x100d_c064, 6); lea(eax, memd[ss, ebp - 0xe4]);         /* lea eax, [ebp-0xe4] */
            ii(0x100d_c06a, 5); call(Definitions.sys_strcpy, 0x8_9e60); /* call 0x10165ecf */
            ii(0x100d_c06f, 7); mov(memd[ss, ebp - 0x8], 0x1);          /* mov dword [ebp-0x8], 0x1 */
            ii(0x100d_c076, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x100d_c07d, 2); jmp(0x100d_c085, 0x6); goto l_0x100d_c085; /* jmp 0x100dc085 */
        l_0x100d_c07f:
            ii(0x100d_c07f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100d_c082, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x100d_c085:
            ii(0x100d_c085, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c088, 3); mov(edx, memd[ds, eax + 0x22]);         /* mov edx, [eax+0x22] */
            ii(0x100d_c08b, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_c08e, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x100d_c092, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x100d_c094, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100d_c098, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x100d_c09a, 2); if(jge(0x100d_c0bc, 0x20)) goto l_0x100d_c0bc; /* jge 0x100dc0bc */
            ii(0x100d_c09c, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100d_c0a0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_c0ae, 4); cmp(ax, memw[ss, ebp - 0x1c]);          /* cmp ax, [ebp-0x1c] */
            ii(0x100d_c0b2, 2); if(jnz(0x100d_c0ba, 0x6)) goto l_0x100d_c0ba; /* jnz 0x100dc0ba */
            ii(0x100d_c0b4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_c0b7, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x100d_c0ba:
            ii(0x100d_c0ba, 2); jmp(0x100d_c07f, -0x3d); goto l_0x100d_c07f; /* jmp 0x100dc07f */
        l_0x100d_c0bc:
            ii(0x100d_c0bc, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x100d_c0cd, 6); lea(eax, memd[ss, ebp - 0xe8]);         /* lea eax, [ebp-0xe8] */
            ...
            ii(0x100d_c0e6, 6); lea(ebx, memd[ss, ebp - 0xe4]);         /* lea ebx, [ebp-0xe4] */
            ...
            ii(0x100d_c0f7, 6); lea(eax, memd[ss, ebp - 0xe8]);         /* lea eax, [ebp-0xe8] */
            ii(0x100d_c0fd, 5); call(Definitions.my_string_dtor, 0x6_5a28); /* call 0x10141b2a */
            ii(0x100d_c102, 4); movsx(edx, memw[ss, ebp - 0x1c]);       /* movsx edx, word [ebp-0x1c] */
            ii(0x100d_c106, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c109, 3); mov(eax, memd[ds, eax + 0x44]);         /* mov eax, [eax+0x44] */
            ii(0x100d_c10c, 5); call(0x100e_0878, 0x4767);              /* call 0x100e0878 */
            ii(0x100d_c111, 4); mov(ax, memw[ds, eax + 0x19]);          /* mov ax, [eax+0x19] */
            ii(0x100d_c115, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x100d_c118, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c11b, 4); mov(ax, memw[ds, eax + 0x24]);          /* mov ax, [eax+0x24] */
            ii(0x100d_c11f, 3); add(eax, memd[ss, ebp - 0x10]);         /* add eax, [ebp-0x10] */
            ii(0x100d_c122, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x100d_c125, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_c133, 6); mov(memd[ss, ebp - 0xec], eax);         /* mov [ebp-0xec], eax */
            ii(0x100d_c139, 4); movsx(eax, memw[ss, ebp - 0x18]);       /* movsx eax, word [ebp-0x18] */
            ii(0x100d_c13d, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100d_c13f, 6); if(jle(0x100d_c200, 0xbb)) goto l_0x100d_c200; /* jle 0x100dc200 */
            ii(0x100d_c145, 7); movsx(eax, memw[ss, ebp - 0xec]);       /* movsx eax, word [ebp-0xec] */
            ...
            ii(0x100d_c155, 6); lea(eax, memd[ss, ebp - 0xe4]);         /* lea eax, [ebp-0xe4] */
        ...
        l_0x100d_c165:
            ii(0x100d_c165, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x100d_c168, 7); cmp(ax, memw[ss, ebp - 0xec]);          /* cmp ax, [ebp-0xec] */
            ...
            ii(0x100d_c176, 6); lea(eax, memd[ss, ebp - 0xe4]);         /* lea eax, [ebp-0xe4] */
        ...
        l_0x100d_c186:
            ii(0x100d_c186, 5); cmp(memw[ss, ebp - 0x1c], 0x40);        /* cmp word [ebp-0x1c], 0x40 */
            ii(0x100d_c18b, 2); if(jnz(0x100d_c1ac, 0x1f)) goto l_0x100d_c1ac; /* jnz 0x100dc1ac */
            ii(0x100d_c18d, 7); movsx(eax, memw[ss, ebp - 0xec]);       /* movsx eax, word [ebp-0xec] */
            ...
            ii(0x100d_c19b, 6); lea(eax, memd[ss, ebp - 0x120]);        /* lea eax, [ebp-0x120] */
        ...
        l_0x100d_c1ac:
            ii(0x100d_c1ac, 5); cmp(memw[ss, ebp - 0x1c], 0x3c);        /* cmp word [ebp-0x1c], 0x3c */
            ii(0x100d_c1b1, 2); if(jnz(0x100d_c1d2, 0x1f)) goto l_0x100d_c1d2; /* jnz 0x100dc1d2 */
            ii(0x100d_c1b3, 7); movsx(eax, memw[ss, ebp - 0xec]);       /* movsx eax, word [ebp-0xec] */
            ...
            ii(0x100d_c1c1, 6); lea(eax, memd[ss, ebp - 0x120]);        /* lea eax, [ebp-0x120] */
        ...
        l_0x100d_c1d2:
            ii(0x100d_c1d2, 7); movsx(eax, memw[ss, ebp - 0xec]);       /* movsx eax, word [ebp-0xec] */
            ...
            ii(0x100d_c1e0, 6); lea(eax, memd[ss, ebp - 0x120]);        /* lea eax, [ebp-0x120] */
        ...
        l_0x100d_c1ef:
            ii(0x100d_c1ef, 6); lea(edx, memd[ss, ebp - 0x120]);        /* lea edx, [ebp-0x120] */
            ii(0x100d_c1f5, 6); lea(eax, memd[ss, ebp - 0xe4]);         /* lea eax, [ebp-0xe4] */
        ...
        l_0x100d_c200:
            ...
            ii(0x100d_c223, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x100d_c226, 3); sub(eax, 0x20);                         /* sub eax, 0x20 */
            ii(0x100d_c229, 1); cwde();                                 /* cwde */
            ii(0x100d_c22a, 1); push(eax);                              /* push eax */
            ii(0x100d_c22b, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x100d_c238, 6); lea(ebx, memd[ss, ebp - 0xe4]);         /* lea ebx, [ebp-0xe4] */
            ii(0x100d_c23e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c241, 3); mov(edx, memd[ds, eax + 0x12]);         /* mov edx, [eax+0x12] */
            ii(0x100d_c244, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_c247, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c24a, 3); mov(eax, memd[ds, eax + 0x1a]);         /* mov eax, [eax+0x1a] */
        ...
        l_0x100d_c257:
            ii(0x100d_c257, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c25a, 4); mov(dx, memw[ds, eax + 0x26]);          /* mov dx, [eax+0x26] */
            ii(0x100d_c25e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c261, 4); cmp(dx, memw[ds, eax + 0x24]);          /* cmp dx, [eax+0x24] */
            ii(0x100d_c265, 2); if(jl(0x100d_c288, 0x21)) goto l_0x100d_c288; /* jl 0x100dc288 */
            ii(0x100d_c267, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c26a, 3); mov(edx, memd[ds, eax + 0x22]);         /* mov edx, [eax+0x22] */
            ii(0x100d_c26d, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_c270, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c273, 3); mov(eax, memd[ds, eax + 0x26]);         /* mov eax, [eax+0x26] */
            ii(0x100d_c276, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100d_c279, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x100d_c27b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c27e, 3); mov(eax, memd[ds, eax + 0x24]);         /* mov eax, [eax+0x24] */
            ii(0x100d_c281, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100d_c284, 2); cmp(eax, edx);                          /* cmp eax, edx */
            ii(0x100d_c286, 2); if(jl(0x100d_c28d, 0x5)) goto l_0x100d_c28d; /* jl 0x100dc28d */
        l_0x100d_c288:
            ii(0x100d_c288, 5); jmp(0x100d_c354, 0xc7); goto l_0x100d_c354; /* jmp 0x100dc354 */
        l_0x100d_c28d:
            ii(0x100d_c28d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c290, 3); mov(edx, memd[ds, eax + 0x24]);         /* mov edx, [eax+0x24] */
            ii(0x100d_c293, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_c296, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_c2ae, 6); mov(memd[ss, ebp - 0x124], edx);        /* mov [ebp-0x124], edx */
            ii(0x100d_c2b4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c2b7, 4); mov(ax, memw[ds, eax + 0x26]);          /* mov ax, [eax+0x26] */
            ii(0x100d_c2bb, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100d_c2be, 4); sub(ax, memw[ds, edx + 0x24]);          /* sub ax, [edx+0x24] */
            ii(0x100d_c2c2, 3); shl(eax, 0x5);                          /* shl eax, 0x5 */
            ii(0x100d_c2c5, 6); mov(memd[ss, ebp - 0x128], eax);        /* mov [ebp-0x128], eax */
            ii(0x100d_c2cb, 10); mov(memd[ss, ebp - 0x12c], 0x1);       /* mov dword [ebp-0x12c], 0x1 */
            ii(0x100d_c2d5, 6); push(memd[ss, ebp - 0x12c]);            /* push dword [ebp-0x12c] */
            ii(0x100d_c2db, 6); mov(eax, memd[ss, ebp - 0x124]);        /* mov eax, [ebp-0x124] */
            ii(0x100d_c2e1, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x100d_c2e3, 3); and(eax, 0x10);                         /* and eax, 0x10 */
            ii(0x100d_c2e6, 6); mov(memd[ss, ebp - 0x130], eax);        /* mov [ebp-0x130], eax */
            ii(0x100d_c2ec, 6); push(memd[ss, ebp - 0x130]);            /* push dword [ebp-0x130] */
            ii(0x100d_c2f2, 6); mov(eax, memd[ss, ebp - 0x124]);        /* mov eax, [ebp-0x124] */
            ...
            ii(0x100d_c2fd, 10); mov(memd[ss, ebp - 0x134], 0x4_0000);  /* mov dword [ebp-0x134], 0x40000 */
            ii(0x100d_c307, 2); jmp(0x100d_c313, 0xa); goto l_0x100d_c313; /* jmp 0x100dc313 */
        l_0x100d_c309:
            ii(0x100d_c309, 10); mov(memd[ss, ebp - 0x134], 0x2_0000);  /* mov dword [ebp-0x134], 0x20000 */
        l_0x100d_c313:
            ii(0x100d_c313, 6); push(memd[ss, ebp - 0x134]);            /* push dword [ebp-0x134] */
            ii(0x100d_c319, 6); mov(eax, memd[ss, ebp - 0x128]);        /* mov eax, [ebp-0x128] */
            ...
            ii(0x100d_c32c, 7); movsx(eax, memw[ss, ebp - 0x128]);      /* movsx eax, word [ebp-0x128] */
            ii(0x100d_c333, 1); push(eax);                              /* push eax */
            ii(0x100d_c334, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x100d_c336, 1); push(eax);                              /* push eax */
            ii(0x100d_c337, 7); movsx(ecx, memw[ss, ebp - 0x128]);      /* movsx ecx, word [ebp-0x128] */
            ii(0x100d_c33e, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x100d_c340, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c343, 3); mov(edx, memd[ds, eax + 0x12]);         /* mov edx, [eax+0x12] */
            ii(0x100d_c346, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_c349, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c34c, 3); mov(eax, memd[ds, eax + 0x1a]);         /* mov eax, [eax+0x1a] */
            ii(0x100d_c34f, 5); call(0x1010_2273, 0x2_5f1f);            /* call 0x10102273 */
        l_0x100d_c354:
            ii(0x100d_c354, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c357, 3); mov(eax, memd[ds, eax + 0x22]);         /* mov eax, [eax+0x22] */
            ...
            ii(0x100d_c373, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c376, 3); mov(eax, memd[ds, eax + 0x38]);         /* mov eax, [eax+0x38] */
        ...
        l_0x100d_c380:
            ...
            ii(0x100d_c389, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c38c, 3); mov(eax, memd[ds, eax + 0x38]);         /* mov eax, [eax+0x38] */
            ii(0x100d_c38f, 5); call(0x100c_fb06, -0xc88e);             /* call 0x100cfb06 */
        l_0x100d_c394:
            ii(0x100d_c394, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c397, 3); mov(edx, memd[ds, eax + 0x22]);         /* mov edx, [eax+0x22] */
            ii(0x100d_c39a, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_c39d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c3a0, 3); mov(eax, memd[ds, eax + 0x26]);         /* mov eax, [eax+0x26] */
            ii(0x100d_c3a3, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100d_c3a6, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x100d_c3a8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_c3ca, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c3cd, 3); mov(eax, memd[ds, eax + 0x3c]);         /* mov eax, [eax+0x3c] */
        ...
        l_0x100d_c3d7:
            ...
            ii(0x100d_c3e0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c3e3, 3); mov(eax, memd[ds, eax + 0x3c]);         /* mov eax, [eax+0x3c] */
            ii(0x100d_c3e6, 5); call(0x100c_fb06, -0xc8e5);             /* call 0x100cfb06 */
        l_0x100d_c3eb:
            ii(0x100d_c3eb, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100d_c3ee, 3); add(edx, 0x4);                          /* add edx, 0x4 */
            ii(0x100d_c3f1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_c3f4, 3); mov(eax, memd[ds, eax + 0x16]);         /* mov eax, [eax+0x16] */
