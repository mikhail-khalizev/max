...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_cad1()
        {
            ...
            ii(0x100a_cae8, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_caeb, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_caee, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100a_caf1, 3); add(edx, 0x13);                         /* add edx, 0x13 */
            ii(0x100a_caf4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_cb00, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_cb03, 5); call(0x1015_26ac, 0xa_5ba4);            /* call 0x101526ac */
            ii(0x100a_cb08, 3); cmp(eax, memd[ss, ebp - 0x8]);          /* cmp eax, [ebp-0x8] */
            ii(0x100a_cb0b, 2); if(jz(0x100a_cb0f, 0x2)) goto l_0x100a_cb0f; /* jz 0x100acb0f */
        l_0x100a_cb0d:
            ii(0x100a_cb0d, 2); jmp(0x100a_cb24, 0x15); goto l_0x100a_cb24; /* jmp 0x100acb24 */
        l_0x100a_cb0f:
            ii(0x100a_cb0f, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x100a_cb14, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
