...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_9fb4()
        {
            ...
            ii(0x100c_9fcc, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_9fcf, 5); call(0x100c_af14, 0xf40);               /* call 0x100caf14 */
            ii(0x100c_9fd4, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x100c_9fd7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_9fda, 5); call(0x100c_aeac, 0xecd);               /* call 0x100caeac */
            ii(0x100c_9fdf, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_9fe2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
