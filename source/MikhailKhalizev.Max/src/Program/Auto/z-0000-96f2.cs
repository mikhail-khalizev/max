...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_96f2()
        {
            ...
            ii(0x96f8, 3);    mov(ds, memw[ss, bp + 0x4]);              /* mov ds, [bp+0x4] */
            ii(0x96fb, 3);    mov(si, memw[ss, bp + 0x6]);              /* mov si, [bp+0x6] */
            ii(0x96fe, 3);    mov(es, memw[ss, bp + 0x8]);              /* mov es, [bp+0x8] */
            ii(0x9701, 3);    mov(di, memw[ss, bp + 0xa]);              /* mov di, [bp+0xa] */
            ii(0x9704, 3);    mov(cx, memw[ss, bp + 0xc]);              /* mov cx, [bp+0xc] */
