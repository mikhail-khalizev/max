...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_bd53()
        {
            ...
            ii(0x100d_bd6a, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_bd6d, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_bd70, 7); cmp(memb[ds, 0x101c_37d2], 0);          /* cmp byte [0x101c37d2], 0x0 */
            ii(0x100d_bd77, 2); if(jz(0x100d_bd80, 0x7)) goto l_0x100d_bd80; /* jz 0x100dbd80 */
            ii(0x100d_bd79, 7); mov(memd[ss, ebp - 0x4], 0x3ea);        /* mov dword [ebp-0x4], 0x3ea */
        l_0x100d_bd80:
            ii(0x100d_bd80, 4); cmp(memd[ss, ebp - 0x4], 0);            /* cmp dword [ebp-0x4], 0x0 */
            ii(0x100d_bd84, 2); if(jle(0x100d_bd8f, 0x9)) goto l_0x100d_bd8f; /* jle 0x100dbd8f */
            ii(0x100d_bd86, 7); cmp(memd[ss, ebp - 0x4], 0x7000);       /* cmp dword [ebp-0x4], 0x7000 */
            ii(0x100d_bd8d, 2); if(jl(0x100d_bd91, 0x2)) goto l_0x100d_bd91; /* jl 0x100dbd91 */
        l_0x100d_bd8f:
            ii(0x100d_bd8f, 2); jmp(0x100d_bd9b, 0xa); goto l_0x100d_bd9b; /* jmp 0x100dbd9b */
        l_0x100d_bd91:
            ii(0x100d_bd91, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_bd94, 7); mov(memb[ds, eax + 0x39e], 0);          /* mov byte [eax+0x39e], 0x0 */
        l_0x100d_bd9b:
            ii(0x100d_bd9b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_bd9e, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
        ...
        l_0x100d_bdc1:
            ii(0x100d_bdc1, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100d_bdc4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_bdc7, 5); call(0x100d_ad31, -0x109b);             /* call 0x100dad31 */
            ii(0x100d_bdcc, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x100d_bdcf, 2); jmp(0x100d_bdfa, 0x29); goto l_0x100d_bdfa; /* jmp 0x100dbdfa */
        l_0x100d_bdd1:
            ii(0x100d_bdd1, 7); cmp(memd[ss, ebp - 0x10], 0x119);       /* cmp dword [ebp-0x10], 0x119 */
            ii(0x100d_bdd8, 2); if(jb(0x100d_bdee, 0x14)) goto l_0x100d_bdee; /* jb 0x100dbdee */
            ii(0x100d_bdda, 7); cmp(memd[ss, ebp - 0x10], 0x119);       /* cmp dword [ebp-0x10], 0x119 */
            ii(0x100d_bde1, 2); if(jbe(0x100d_bda3, -0x40)) goto l_0x100d_bda3; /* jbe 0x100dbda3 */
            ii(0x100d_bde3, 7); cmp(memd[ss, ebp - 0x10], 0x3e9);       /* cmp dword [ebp-0x10], 0x3e9 */
        ...
        l_0x100d_bdee:
            ii(0x100d_bdee, 4); cmp(memd[ss, ebp - 0x10], 0x3f);        /* cmp dword [ebp-0x10], 0x3f */
        ...
        l_0x100d_bdf6:
            ii(0x100d_bdf6, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
        l_0x100d_bdfa:
            ii(0x100d_bdfa, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
