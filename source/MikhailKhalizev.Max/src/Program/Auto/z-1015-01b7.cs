...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_01b7()
        {
            ...
            ii(0x1015_01e2, 3); mov(dl, memb[ds, edx + 77]);            /* mov dl, [edx+0x4d] */
            ii(0x1015_01e5, 2); xor(dh, dh);                            /* xor dh, dh */
            ii(0x1015_01e7, 4); mov(ax, memw[ds, eax + 10]);            /* mov ax, [eax+0xa] */
            ii(0x1015_01eb, 2); sub(eax, edx);                          /* sub eax, edx */
            ii(0x1015_01ed, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1015_01f0, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1015_01f3, 5); call(0x1015_012d, -0xcb);               /* call 0x1015012d */
            ii(0x1015_01f8, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1015_01fb, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ...
            ii(0x1015_0231, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ...
            ii(0x1015_0253, 4); movsx(eax, memw[ss, ebp - 20]);         /* movsx eax, word [ebp-0x14] */
            ...
            ii(0x1015_027b, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
        l_0x1015_027e:
            ii(0x1015_027e, 3); mov(al, memb[ss, ebp - 20]);            /* mov al, [ebp-0x14] */
            ii(0x1015_0281, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1015_0284, 3); add(memb[ds, edx + 77], al);            /* add [edx+0x4d], al */
            ii(0x1015_0287, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1015_028a, 5); call(0x1016_15c9, 0x1_133a);            /* call 0x101615c9 */
            ii(0x1015_028f, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1015_0292, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1015_0295, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
