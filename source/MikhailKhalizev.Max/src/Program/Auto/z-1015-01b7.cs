...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_01b7()
        {
            ...
            ii(0x1015_01ce, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_01d1, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1015_01d4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_01d7, 3); add(eax, 0x6c);                         /* add eax, 0x6c */
            ii(0x1015_01da, 5); call(0x1007_6730, -0xd_9aaf);           /* call 0x10076730 */
            ii(0x1015_01df, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x1015_01f0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1015_025d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_0260, 3); add(eax, 0x6c);                         /* add eax, 0x6c */
            ii(0x1015_0263, 5); call(0x1007_6730, -0xd_9b38);           /* call 0x10076730 */
            ii(0x1015_0268, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
        ...
        l_0x1015_027e:
            ...
            ii(0x1015_0281, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1015_0284, 3); add(memb[ds, edx + 0x4d], al);          /* add [edx+0x4d], al */
            ii(0x1015_0287, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
