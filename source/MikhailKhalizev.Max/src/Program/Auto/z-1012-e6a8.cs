...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_e6a8()
        {
            ...
            ii(0x1012_e6bf, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_e6c2, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1012_e6c5, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_e6c8, 3); mov(ebx, memd[ds, eax + 0x38]);         /* mov ebx, [eax+0x38] */
            ii(0x1012_e6cb, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1012_e6ce, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_e6d1, 6); mov(eax, memd[ds, eax + 0xde]);         /* mov eax, [eax+0xde] */
            ...
            ii(0x1012_e6e6, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1012_e6e9, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x1012_e6fb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_e6fe, 6); mov(eax, memd[ds, eax + 0xde]);         /* mov eax, [eax+0xde] */
            ...
            ii(0x1012_e70c, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1012_e70f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_e712, 4); mov(ax, memw[ds, eax + 0x2]);           /* mov ax, [eax+0x2] */
            ii(0x1012_e716, 4); cmp(ax, memw[ss, ebp - 0x10]);          /* cmp ax, [ebp-0x10] */
            ii(0x1012_e71a, 2); if(jl(0x1012_e76d, 0x51)) goto l_0x1012_e76d; /* jl 0x1012e76d */
            ii(0x1012_e71c, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1012_e71f, 2); mov(eax, memd[ds, edx]);                /* mov eax, [edx] */
            ii(0x1012_e721, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1012_e724, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x1012_e728, 2); sub(eax, edx);                          /* sub eax, edx */
            ii(0x1012_e72a, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1012_e72c, 4); movsx(ebx, memw[ss, ebp - 0xc]);        /* movsx ebx, word [ebp-0xc] */
            ii(0x1012_e730, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x1012_e732, 3); sar(edx, 0x1f);                         /* sar edx, 0x1f */
            ii(0x1012_e735, 2); idiv(ebx);                              /* idiv ebx */
            ii(0x1012_e737, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1012_e73a, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1012_e73d, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1012_e740, 4); cmp(ax, memw[ds, edx + 0x3a]);          /* cmp ax, [edx+0x3a] */
            ii(0x1012_e744, 2); if(jge(0x1012_e76d, 0x27)) goto l_0x1012_e76d; /* jge 0x1012e76d */
            ii(0x1012_e746, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_e749, 4); mov(ax, memw[ds, eax + 0x30]);          /* mov ax, [eax+0x30] */
            ii(0x1012_e74d, 3); add(memd[ss, ebp - 0x10], eax);         /* add [ebp-0x10], eax */
            ii(0x1012_e750, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_e753, 3); add(eax, 0x18);                         /* add eax, 0x18 */
            ii(0x1012_e756, 5); call(Definitions.my_1_get_count, -0x8_3283); /* call 0x100ab4d8 */
            ii(0x1012_e75b, 4); cmp(ax, memw[ss, ebp - 0x10]);          /* cmp ax, [ebp-0x10] */
            ii(0x1012_e75f, 2); if(jle(0x1012_e76d, 0xc)) goto l_0x1012_e76d; /* jle 0x1012e76d */
            ii(0x1012_e761, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x1012_e765, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
