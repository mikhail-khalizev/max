...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1013_e01a:
            ...
            ii(0x1013_e01d, 4); cmp(memb[ds, eax + 0xa], 2);            /* cmp byte [eax+0xa], 0x2 */
        ...
        l_0x1013_e032:
            ...
            ii(0x1013_e035, 5); cmp(memw[ss, ebp - 0x10], -1 /* 0xff */); /* cmp word [ebp-0x10], 0xffff */
        ...
        l_0x1013_e07f:
            ...
            ii(0x1013_e082, 4); cmp(memb[ds, eax + 0xa], 1);            /* cmp byte [eax+0xa], 0x1 */
            ...
            ii(0x1013_e08b, 4); cmp(memb[ds, eax + 0xa], 1);            /* cmp byte [eax+0xa], 0x1 */
        ...
        l_0x1013_e0aa:
            ...
            ii(0x1013_e0ad, 4); cmp(memb[ds, eax + 0xa], 2);            /* cmp byte [eax+0xa], 0x2 */
        ...
        l_0x1013_e0ba:
            ...
            ii(0x1013_e0bd, 5); cmp(memw[ss, ebp - 0x10], -1 /* 0xff */); /* cmp word [ebp-0x10], 0xffff */
        ...
        l_0x1013_e135:
            ...
            ii(0x1013_e138, 5); cmp(memw[ss, ebp - 0x1c], -1 /* 0xff */); /* cmp word [ebp-0x1c], 0xffff */
