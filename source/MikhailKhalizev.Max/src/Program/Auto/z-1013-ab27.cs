...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_ab27()
        {
            ...
            ii(0x1013_ab3e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_ab41, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_ab44, 7); test(memd[ss, ebp - 0x4], 0x4);         /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x1013_ab52, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1013_ab61:
            ii(0x1013_ab61, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_ab64, 7); mov(memd[ds, eax + 0x2], 0x101b_6ec4);  /* mov dword [eax+0x2], 0x101b6ec4 */
            ii(0x1013_ab6b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1013_ab75, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_ab78, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x1013_ab7b, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1013_ab7d, 2); if(jnz(0x1013_ab88, 0x9)) goto l_0x1013_ab88; /* jnz 0x1013ab88 */
            ii(0x1013_ab7f, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
        ...
        l_0x1013_ab88:
            ...
            ii(0x1013_ab9e, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
        l_0x1013_aba1:
            ii(0x1013_aba1, 7); test(memd[ss, ebp - 0x4], 0x2);         /* test dword [ebp-0x4], 0x2 */
            ii(0x1013_aba8, 2); if(jz(0x1013_abb2, 0x8)) goto l_0x1013_abb2; /* jz 0x1013abb2 */
            ii(0x1013_abaa, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_abad, 5); call(Definitions.sys_delete, 0x2_b3b2); /* call 0x10165f64 */
        l_0x1013_abb2:
            ii(0x1013_abb2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_abb5, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1013_abb8, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
