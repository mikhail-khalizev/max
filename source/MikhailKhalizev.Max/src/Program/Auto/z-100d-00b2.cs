...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_00b2()
        {
            ...
            ii(0x100d_00c9, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_00cc, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_00cf, 7); test(memd[ss, ebp - 0x4], 0x4);         /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x100d_00dd, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_00ec:
            ii(0x100d_00ec, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_00ef, 7); mov(memd[ds, eax + 0x40], 0x101b_5cbc); /* mov dword [eax+0x40], 0x101b5cbc */
            ii(0x100d_00f6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_00f9, 3); mov(eax, memd[ds, eax + 0x2a]);         /* mov eax, [eax+0x2a] */
            ii(0x100d_00fc, 5); call(Definitions.sys_free, 0x9_afc0);   /* call 0x1016b0c1 */
            ii(0x100d_0101, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100d_0103, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_0111, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_0114, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100d_0116, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_0124, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_0127, 7); test(memd[ss, ebp - 0x4], 0x2);         /* test dword [ebp-0x4], 0x2 */
            ii(0x100d_012e, 2); if(jz(0x100d_0138, 0x8)) goto l_0x100d_0138; /* jz 0x100d0138 */
            ii(0x100d_0130, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_0133, 5); call(Definitions.sys_delete, 0x9_5e2c); /* call 0x10165f64 */
        l_0x100d_0138:
            ii(0x100d_0138, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_013b, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100d_013e, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
