...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_53bf()
        {
            ...
            ii(0x1019_53d0, 7);  mov(memd[ds, esi + 28], 0x8108);      /* mov dword [esi+0x1c], 0x8108 */
            ii(0x1019_53d7, 7);  mov(memd[ds, esi + 20], 0);           /* mov dword [esi+0x14], 0x0 */
            ii(0x1019_53de, 4);  mov(ax, memw[ss, ebp + 8]);           /* mov ax, [ebp+0x8] */
            ii(0x1019_53e2, 4);  mov(memw[ds, esi + 34], ax);          /* mov [esi+0x22], ax */
