...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_19b8()
        {
            ...
            ii(0x1010_19d0, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x1010_19e1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_19ed, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_19f0, 4); cmp(memb[ds, eax + 0x3d], 0);           /* cmp byte [eax+0x3d], 0x0 */
            ii(0x1010_19f4, 2); if(jnz(0x1010_19fd, 0x7)) goto l_0x1010_19fd; /* jnz 0x101019fd */
            ii(0x1010_19f6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_19f9, 4); mov(memb[ds, eax + 0x3e], 0x2);         /* mov byte [eax+0x3e], 0x2 */
        l_0x1010_19fd:
            ...
            ii(0x1010_1a13, 2); jmp(0x1010_1a1d, 0x8); goto l_0x1010_1a1d; /* jmp 0x10101a1d */
        l_0x1010_1a15:
            ii(0x1010_1a15, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
