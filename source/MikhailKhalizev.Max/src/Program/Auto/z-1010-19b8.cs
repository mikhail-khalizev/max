...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("19d75648-e517-47b9-ba02-edd60917f0b3")]
        public void Method_1010_19b8()
        {
            ii(0x1010_19b8, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x1010_19bd, 5); calld(Definitions.sys_check_available_stack_size, 0x64390); /* call 0x10165d52 */
            ...
            ii(0x1010_19d8, 5); calld(0x1007_5fdc, -0x8ba01);           /* call 0x10075fdc */
        ...
        l_0x1010_1a1d:
            ...
            ii(0x1010_1a25, 1); retd(); return;                         /* ret */
        }
    }
}
