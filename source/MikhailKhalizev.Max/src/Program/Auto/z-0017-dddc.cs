...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_dddc()
        {
            ...
            ii(0x17_dde4, 3); mov(ax, memw[ss, bp + 0x8]);              /* mov ax, [bp+0x8] */
            ...
            ii(0x17_ddec, 3); mov(dx, memw[ss, bp + 0x6]);              /* mov dx, [bp+0x6] */
            ii(0x17_ddef, 2); neg(ax);                                  /* neg ax */
            ii(0x17_ddf1, 2); neg(dx);                                  /* neg dx */
            ii(0x17_ddf3, 3); sbb(ax, 0);                               /* sbb ax, 0x0 */
            ii(0x17_ddf6, 3); mov(memw[ss, bp + 0x8], ax);              /* mov [bp+0x8], ax */
            ii(0x17_ddf9, 3); mov(memw[ss, bp + 0x6], dx);              /* mov [bp+0x6], dx */
        l_0x17_ddfc:
            ii(0x17_ddfc, 3); mov(ax, memw[ss, bp + 0xc]);              /* mov ax, [bp+0xc] */
            ...
            ii(0x17_de04, 3); mov(dx, memw[ss, bp + 0xa]);              /* mov dx, [bp+0xa] */
            ii(0x17_de07, 2); neg(ax);                                  /* neg ax */
            ii(0x17_de09, 2); neg(dx);                                  /* neg dx */
            ii(0x17_de0b, 3); sbb(ax, 0);                               /* sbb ax, 0x0 */
            ii(0x17_de0e, 3); mov(memw[ss, bp + 0xc], ax);              /* mov [bp+0xc], ax */
            ii(0x17_de11, 3); mov(memw[ss, bp + 0xa], dx);              /* mov [bp+0xa], dx */
        l_0x17_de14:
            ii(0x17_de14, 2); or(ax, ax);                               /* or ax, ax */
            ii(0x17_de16, 2); if(jnz(0x17_de2d, 0x15)) goto l_0x17_de2d; /* jnz 0xde2d */
            ii(0x17_de18, 3); mov(cx, memw[ss, bp + 0xa]);              /* mov cx, [bp+0xa] */
            ii(0x17_de1b, 3); mov(ax, memw[ss, bp + 0x8]);              /* mov ax, [bp+0x8] */
            ii(0x17_de1e, 2); xor(dx, dx);                              /* xor dx, dx */
            ii(0x17_de20, 2); div(cx);                                  /* div cx */
            ii(0x17_de22, 2); mov(bx, ax);                              /* mov bx, ax */
            ii(0x17_de24, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
        ...
        l_0x17_de2d:
            ...
            ii(0x17_de2f, 3); mov(cx, memw[ss, bp + 0xa]);              /* mov cx, [bp+0xa] */
            ii(0x17_de32, 3); mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ii(0x17_de35, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
        l_0x17_de38:
            ...
            ii(0x17_de48, 3); mul(memw[ss, bp + 0xc]);                  /* mul word [bp+0xc] */
            ii(0x17_de4b, 1); xchg(cx, ax);                             /* xchg cx, ax */
            ii(0x17_de4c, 3); mov(ax, memw[ss, bp + 0xa]);              /* mov ax, [bp+0xa] */
            ...
            ii(0x17_de55, 3); cmp(dx, memw[ss, bp + 0x8]);              /* cmp dx, [bp+0x8] */
            ii(0x17_de58, 2); if(ja(0x17_de61, 0x7)) goto l_0x17_de61;  /* ja 0xde61 */
            ii(0x17_de5a, 2); if(jb(0x17_de62, 0x6)) goto l_0x17_de62;  /* jb 0xde62 */
            ii(0x17_de5c, 3); cmp(ax, memw[ss, bp + 0x6]);              /* cmp ax, [bp+0x6] */
            ii(0x17_de5f, 2); if(jbe(0x17_de62, 0x1)) goto l_0x17_de62; /* jbe 0xde62 */
        l_0x17_de61:
        ...
        l_0x17_de65:
            ...
            ii(0x17_de66, 2); if(jnz(0x17_de6f, 0x7)) goto l_0x17_de6f; /* jnz 0xde6f */
        ...
        l_0x17_de6f:
            ...
            ii(0x17_de73, 3); retf(0x8);                                /* retf 0x8 */
        }
    }
}
