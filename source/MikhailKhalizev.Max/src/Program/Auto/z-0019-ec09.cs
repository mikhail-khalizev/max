...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_ec09()
        {
            ...
            ii(0x19_ec1c, 2); if(jz(0x19_ec21, 0x3)) goto l_0x19_ec21;  /* jz 0xec21 */
            ii(0x19_ec1e, 3); jmp(0x19_ec27, 0x6); goto l_0x19_ec27;    /* jmp 0xec27 */
        l_0x19_ec21:
            ii(0x19_ec21, 3); mov(ax, 0);                               /* mov ax, 0x0 */
            ii(0x19_ec24, 3); jmp(0x19_ec7c, 0x55); goto l_0x19_ec7c;   /* jmp 0xec7c */
        l_0x19_ec27:
            ii(0x19_ec27, 5); mov(memw[ss, bp - 0x4], 0x53);            /* mov word [bp-0x4], 0x53 */
            ii(0x19_ec2c, 5); mov(memw[ss, bp - 0x2], 0x98);            /* mov word [bp-0x2], 0x98 */
            ii(0x19_ec31, 3); lea(ax, memw[ss, bp - 0xc]);              /* lea ax, [bp-0xc] */
            ii(0x19_ec34, 1); push(ss);                                 /* push ss */
            ii(0x19_ec35, 1); push(ax);                                 /* push ax */
            ii(0x19_ec36, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x19_ec39, 5); call_far_abs(0x80, 0x4f82);               /* call word 0x80:0x4f82 */
            ii(0x19_ec3e, 3); add(sp, 0x6);                             /* add sp, 0x6 */
            ii(0x19_ec41, 4); or(memb[ss, bp - 0x6], 0x40);             /* or byte [bp-0x6], 0x40 */
            ii(0x19_ec45, 3); mov(al, memb[ss, bp - 0x7]);              /* mov al, [bp-0x7] */
            ii(0x19_ec48, 2); and(al, 0xfa);                            /* and al, 0xfa */
            ii(0x19_ec4a, 2); or(al, 0x9a);                             /* or al, 0x9a */
            ii(0x19_ec4c, 3); mov(memb[ss, bp - 0x7], al);              /* mov [bp-0x7], al */
            ii(0x19_ec4f, 3); lea(ax, memw[ss, bp - 0xc]);              /* lea ax, [bp-0xc] */
            ii(0x19_ec52, 1); push(ss);                                 /* push ss */
            ii(0x19_ec53, 1); push(ax);                                 /* push ax */
            ii(0x19_ec54, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ...
            ii(0x19_ec64, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_ec67, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x19_ec6a, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0x19_ec6d, 3); mov(memw[ds, 0x2e04], ax);                /* mov [0x2e04], ax */
            ii(0x19_ec70, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
