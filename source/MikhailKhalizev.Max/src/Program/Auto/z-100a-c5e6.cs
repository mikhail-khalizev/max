...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_c5e6()
        {
            ...
            ii(0x100a_c5f8, 6); sub(esp, 4);                            /* sub esp, 0x4 */
            ii(0x100a_c5fe, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100a_c601, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_c603, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_c61b, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x100a_c61e, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
        ...
        l_0x100a_c62e:
            ...
            ii(0x100a_c630, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_c63d, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_c64a, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_c64d, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x100a_c650, 5); call(0x1008_afe4, -0x2_1671);           /* call 0x1008afe4 */
            ii(0x100a_c655, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
