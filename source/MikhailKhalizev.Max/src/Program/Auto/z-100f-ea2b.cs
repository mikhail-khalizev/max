...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_ea2b()
        {
            ...
            ii(0x100f_ea43, 7); mov(memd[ss, ebp - 0x4], 0x4);          /* mov dword [ebp-0x4], 0x4 */
        l_0x100f_ea4a:
            ii(0x100f_ea4a, 3); dec(memd[ss, ebp - 0x4]);               /* dec dword [ebp-0x4] */
            ii(0x100f_ea4d, 5); cmp(memw[ss, ebp - 0x4], -0x1 /* 0xff */); /* cmp word [ebp-0x4], 0xffff */
            ii(0x100f_ea52, 2); if(jz(0x100f_eaad, 0x59)) goto l_0x100f_eaad; /* jz 0x100feaad */
            ii(0x100f_ea54, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_ea6d, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_ea85, 2); if(jnz(0x100f_ea89, 0x2)) goto l_0x100f_ea89; /* jnz 0x100fea89 */
        l_0x100f_ea87:
            ii(0x100f_ea87, 2); jmp(0x100f_eaab, 0x22); goto l_0x100f_eaab; /* jmp 0x100feaab */
        l_0x100f_ea89:
            ii(0x100f_ea89, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_eaa0, 2); if(jnz(0x100f_eaab, 0x9)) goto l_0x100f_eaab; /* jnz 0x100feaab */
            ii(0x100f_eaa2, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x100f_eaa9, 2); jmp(0x100f_eab4, 0x9); goto l_0x100f_eab4; /* jmp 0x100feab4 */
        l_0x100f_eaab:
            ii(0x100f_eaab, 2); jmp(0x100f_ea4a, -0x63); goto l_0x100f_ea4a; /* jmp 0x100fea4a */
        l_0x100f_eaad:
            ii(0x100f_eaad, 7); mov(memd[ss, ebp - 0x8], 0x1);          /* mov dword [ebp-0x8], 0x1 */
        l_0x100f_eab4:
            ii(0x100f_eab4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
