...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_1ceb()
        {
            ...
            ii(0x100e_1d02, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_1d05, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100e_1d08, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_1d0b, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100e_1d0e, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100e_1d10, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100e_1d1f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100e_1d2c, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100e_1d38, 2); if(jnz(0x100e_1d3c, 0x2)) goto l_0x100e_1d3c; /* jnz 0x100e1d3c */
        l_0x100e_1d3a:
            ii(0x100e_1d3a, 2); jmp(0x100e_1d9d, 0x61); goto l_0x100e_1d9d; /* jmp 0x100e1d9d */
        l_0x100e_1d3c:
            ii(0x100e_1d3c, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100e_1d49, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100e_1d58, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100e_1d5b, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x100e_1d5d, 5); call(0x100e_3e05, 0x20a3);              /* call 0x100e3e05 */
            ii(0x100e_1d62, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100e_1d71, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100e_1d74, 5); call(0x100e_19f6, -0x383);              /* call 0x100e19f6 */
            ii(0x100e_1d79, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
