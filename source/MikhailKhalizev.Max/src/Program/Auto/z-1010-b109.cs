...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_b109()
        {
            ...
            ii(0x1010_b121, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_b124, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_b127, 3); mov(edx, memd[ds, eax + 0xd]);          /* mov edx, [eax+0xd] */
            ...
            ii(0x1010_b137, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_b13a, 5); call(0x1010_a564, -0xbdb);              /* call 0x1010a564 */
            ii(0x1010_b13f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_b142, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1010_b144, 3); mov(eax, memd[ds, eax + 0x12]);         /* mov eax, [eax+0x12] */
