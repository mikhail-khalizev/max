...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_8b42()
        {
            ...
            ii(0x100b_8b58, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100b_8b5b, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100b_8b5e, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x100b_8b61, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x100b_8b64, 3); add(edx, 0xd);                          /* add edx, 0xd */
            ii(0x100b_8b67, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x100b_8b6a, 5); call(0x1007_5e64, -0x4_2d0b);           /* call 0x10075e64 */
            ii(0x100b_8b6f, 2); mov(ecx, eax);                          /* mov ecx, eax */
            ii(0x100b_8b71, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_8b74, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x100b_8b77, 5); call(0x1007_5e64, -0x4_2d18);           /* call 0x10075e64 */
            ii(0x100b_8b7c, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x100b_8b7e, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100b_8b81, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100b_8b84, 5); call(0x100b_89ad, -0x1dc);              /* call 0x100b89ad */
            ii(0x100b_8b89, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
