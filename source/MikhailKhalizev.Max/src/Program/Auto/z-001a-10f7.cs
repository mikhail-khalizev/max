...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_001a_10f7()
        {
            ...
            ii(0x1a_1101, 5); mov(memw[ss, bp - 0x2], 0x3e00);          /* mov word [bp-0x2], 0x3e00 */
            ...
            ii(0x1a_110e, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ...
            ii(0x1a_1128, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0x1a_112b, 2); jmp(0x1a_1130, 0x3); goto l_0x1a_1130;    /* jmp 0x1130 */
        l_0x1a_112d:
            ii(0x1a_112d, 3); mov(ax, 0xffff);                          /* mov ax, 0xffff */
        l_0x1a_1130:
            ii(0x1a_1130, 1); pop(ds);                                  /* pop ds */
            ii(0x1a_1131, 1); leave();                                  /* leave */
            ii(0x1a_1132, 3); retf(0x2);                                /* retf 0x2 */
        }
    }
}
