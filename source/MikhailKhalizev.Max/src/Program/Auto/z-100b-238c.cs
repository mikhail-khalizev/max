...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_238c()
        {
            ...
            ii(0x100b_23a5, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100b_23a8, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x100b_23ab, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x100b_23ae, 3); add(edx, 0x15);                         /* add edx, 0x15 */
            ii(0x100b_23b1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_23d8, 2); jmp(0x100b_23e2, 0x8); goto l_0x100b_23e2; /* jmp 0x100b23e2 */
        l_0x100b_23da:
        ...
        l_0x100b_23e2:
            ...
            ii(0x100b_23fd, 3); cmp(eax, memd[ss, ebp - 0x4]);          /* cmp eax, [ebp-0x4] */
            ...
            ii(0x100b_2405, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_2422, 2); jmp(0x100b_2426, 0x2); goto l_0x100b_2426; /* jmp 0x100b2426 */
        l_0x100b_2424:
            ii(0x100b_2424, 2); jmp(0x100b_23da, -0x4c); goto l_0x100b_23da; /* jmp 0x100b23da */
        l_0x100b_2426:
            ii(0x100b_2426, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x100b_242b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
