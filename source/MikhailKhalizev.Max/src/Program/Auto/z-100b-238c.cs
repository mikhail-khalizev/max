...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_238c()
        {
            ...
            ii(0x100b_23a2, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100b_23a5, 3); mov(memd[ss, ebp - 8], edx);            /* mov [ebp-0x8], edx */
            ii(0x100b_23a8, 3); mov(memd[ss, ebp - 4], ebx);            /* mov [ebp-0x4], ebx */
            ii(0x100b_23ab, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ...
            ii(0x100b_23c1, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100b_23c4, 3); add(eax, 0x19);                         /* add eax, 0x19 */
            ii(0x100b_23c7, 5); call(0x100b_7c44, 0x5878);              /* call 0x100b7c44 */
            ii(0x100b_23cc, 3); lea(ebx, memd[ss, ebp - 16]);           /* lea ebx, [ebp-0x10] */
        ...
        l_0x100b_23da:
            ii(0x100b_23da, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x100b_23dd, 5); call(0x1007_6bf8, -0x3_b7ea);           /* call 0x10076bf8 */
        l_0x100b_23e2:
            ii(0x100b_23e2, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_23e4, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ...
            ii(0x100b_23f0, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
        ...
        l_0x100b_2426:
            ...
            ii(0x100b_2435, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
