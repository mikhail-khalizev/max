...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_361d()
        {
            ...
            ii(0x1012_3633, 3); mov(eax, memd[ss, ebp + 0x14]);         /* mov eax, [ebp+0x14] */
            ii(0x1012_3636, 7); cmp(memd[ds, eax + 0x84], 0);           /* cmp dword [eax+0x84], 0x0 */
            ii(0x1012_363d, 2); if(jnz(0x1012_3648, 0x9)) goto l_0x1012_3648; /* jnz 0x10123648 */
            ii(0x1012_363f, 7); mov(memd[ss, ebp - 0x8], 0x1);          /* mov dword [ebp-0x8], 0x1 */
            ii(0x1012_3646, 2); jmp(0x1012_36a2, 0x5a); goto l_0x1012_36a2; /* jmp 0x101236a2 */
        l_0x1012_3648:
            ii(0x1012_3648, 3); mov(eax, memd[ss, ebp + 0x14]);         /* mov eax, [ebp+0x14] */
            ii(0x1012_364b, 4); test(memb[ds, eax + 0x1], 0x80);        /* test byte [eax+0x1], 0x80 */
            ...
            ii(0x1012_3658, 3); mov(eax, memd[ss, ebp + 0x14]);         /* mov eax, [ebp+0x14] */
            ...
            ii(0x1012_3667, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1012_366a, 4); cmp(memd[ss, ebp - 0x4], -0x1 /* 0xff */); /* cmp dword [ebp-0x4], 0xffffffff */
            ii(0x1012_366e, 2); if(jnz(0x1012_3679, 0x9)) goto l_0x1012_3679; /* jnz 0x10123679 */
            ii(0x1012_3670, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1012_3677, 2); jmp(0x1012_36a2, 0x29); goto l_0x1012_36a2; /* jmp 0x101236a2 */
        l_0x1012_3679:
            ii(0x1012_3679, 3); mov(eax, memd[ss, ebp + 0x14]);         /* mov eax, [ebp+0x14] */
            ii(0x1012_367c, 6); mov(ebx, memd[ds, eax + 0x88]);         /* mov ebx, [eax+0x88] */
            ii(0x1012_3682, 3); mov(eax, memd[ss, ebp + 0x14]);         /* mov eax, [ebp+0x14] */
            ii(0x1012_3685, 6); mov(edx, memd[ds, eax + 0x84]);         /* mov edx, [eax+0x84] */
            ii(0x1012_368b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_368e, 5); call(/* sys */ 0x1017_d2f5, 0x5_9c62);  /* call 0x1017d2f5 */
            ii(0x1012_3693, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_3696, 5); call(/* sys */ 0x1017_d1da, 0x5_9b3f);  /* call 0x1017d1da */
        l_0x1012_369b:
            ii(0x1012_369b, 7); mov(memd[ss, ebp - 0x8], 0x1);          /* mov dword [ebp-0x8], 0x1 */
        l_0x1012_36a2:
            ii(0x1012_36a2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
