...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_e5cc()
        {
            ...
            ii(0x1007_e5e2, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1007_e5e5, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1007_e5e8, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1007_e5eb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_e5ee, 5); call(0x1007_6338, -0x82bb);             /* call 0x10076338 */
            ii(0x1007_e5f3, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1007_e5f5, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_e5f8, 5); call(0x1007_64b8, -0x8145);             /* call 0x100764b8 */
            ii(0x1007_e5fd, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1007_e600, 5); call(Definitions.my_ctor_0x101b_4184, -0x7b15); /* call 0x10076af0 */
            ii(0x1007_e605, 2); jmp(0x1007_e60f, 0x8); goto l_0x1007_e60f; /* jmp 0x1007e60f */
        l_0x1007_e607:
            ii(0x1007_e607, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_e60a, 5); call(0x1007_6bf8, -0x7a17);             /* call 0x10076bf8 */
        l_0x1007_e60f:
            ii(0x1007_e60f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_e611, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1007_e621, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_e624, 5); call(0x1007_63a0, -0x8289);             /* call 0x100763a0 */
            ii(0x1007_e629, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_e62b, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ii(0x1007_e62e, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1007_e631, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1007_e63b, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_e63e, 5); call(0x1007_63a0, -0x82a3);             /* call 0x100763a0 */
            ii(0x1007_e643, 4); cmp(memb[ds, eax + 0x3d], 0x10);        /* cmp byte [eax+0x3d], 0x10 */
            ii(0x1007_e647, 2); if(jnz(0x1007_e64b, 0x2)) goto l_0x1007_e64b; /* jnz 0x1007e64b */
        l_0x1007_e649:
            ii(0x1007_e649, 2); jmp(0x1007_e6a6, 0x5b); goto l_0x1007_e6a6; /* jmp 0x1007e6a6 */
        l_0x1007_e64b:
            ii(0x1007_e64b, 3); lea(edx, memd[ss, ebp - 0x24]);         /* lea edx, [ebp-0x24] */
            ii(0x1007_e64e, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_e651, 5); call(0x1007_63a0, -0x82b6);             /* call 0x100763a0 */
            ii(0x1007_e656, 5); call(0x1015_2532, 0xd_3ed7);            /* call 0x10152532 */
            ii(0x1007_e65b, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x1007_e65e, 4); mov(memw[ss, ebp - 0x10], ax);          /* mov [ebp-0x10], ax */
            ii(0x1007_e662, 2); jmp(0x1007_e66b, 0x7); goto l_0x1007_e66b; /* jmp 0x1007e66b */
        l_0x1007_e664:
            ii(0x1007_e664, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1007_e667, 4); inc(memw[ss, ebp - 0x10]);              /* inc word [ebp-0x10] */
        l_0x1007_e66b:
            ii(0x1007_e66b, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1007_e66f, 3); cmp(eax, memd[ss, ebp - 0x1c]);         /* cmp eax, [ebp-0x1c] */
            ii(0x1007_e672, 2); if(jge(0x1007_e6a6, 0x32)) goto l_0x1007_e6a6; /* jge 0x1007e6a6 */
            ii(0x1007_e674, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1007_e677, 4); mov(memw[ss, ebp - 0xe], ax);           /* mov [ebp-0xe], ax */
            ii(0x1007_e67b, 2); jmp(0x1007_e684, 0x7); goto l_0x1007_e684; /* jmp 0x1007e684 */
        l_0x1007_e67d:
            ii(0x1007_e67d, 3); mov(eax, memd[ss, ebp - 0xe]);          /* mov eax, [ebp-0xe] */
            ii(0x1007_e680, 4); inc(memw[ss, ebp - 0xe]);               /* inc word [ebp-0xe] */
        l_0x1007_e684:
            ii(0x1007_e684, 4); movsx(eax, memw[ss, ebp - 0xe]);        /* movsx eax, word [ebp-0xe] */
            ii(0x1007_e688, 3); cmp(eax, memd[ss, ebp - 0x18]);         /* cmp eax, [ebp-0x18] */
            ii(0x1007_e68b, 2); if(jge(0x1007_e6a4, 0x17)) goto l_0x1007_e6a4; /* jge 0x1007e6a4 */
            ii(0x1007_e68d, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1007_e691, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1007_e694, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x1007_e697, 4); movsx(edx, memw[ss, ebp - 0xe]);        /* movsx edx, word [ebp-0xe] */
        ...
        l_0x1007_e6ab:
            ...
            ii(0x1007_e6ad, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
