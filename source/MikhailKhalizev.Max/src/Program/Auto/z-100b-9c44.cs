...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_9c44()
        {
            ...
            ii(0x100b_9c61, 4); or(memb[ss, ebp - 0xc], 1);             /* or byte [ebp-0xc], 0x1 */
            ...
            ii(0x100b_9c70, 4); and(memb[ss, ebp - 0xc], -2 /* 0xfe */); /* and byte [ebp-0xc], 0xfe */
        ...
        l_0x100b_9ccf:
            ...
            ii(0x100b_9ce9, 4); cmp(memb[ds, eax + 0x3d], 2);           /* cmp byte [eax+0x3d], 0x2 */
        ...
        l_0x100b_9d0d:
            ...
            ii(0x100b_9d15, 4); cmp(memb[ds, eax + 0x3e], 1);           /* cmp byte [eax+0x3e], 0x1 */
