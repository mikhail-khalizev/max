...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_8835()
        {
            ...
            ii(0x1012_8847, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1012_884d, 3); mov(memb[ss, ebp - 4], al);             /* mov [ebp-0x4], al */
            ...
            ii(0x1012_8865, 2); if(jae(0x1012_8870, 9)) goto l_0x1012_8870; /* jae 0x10128870 */
            ii(0x1012_8867, 7); mov(memd[ss, ebp - 8], 0);              /* mov dword [ebp-0x8], 0x0 */
            ii(0x1012_886e, 2); jmp(0x1012_888b, 0x1b); goto l_0x1012_888b; /* jmp 0x1012888b */
        l_0x1012_8870:
            ii(0x1012_8870, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1012_8872, 3); mov(al, memb[ss, ebp - 4]);             /* mov al, [ebp-0x4] */
            ...
            ii(0x1012_8884, 7); mov(memd[ss, ebp - 8], 1);              /* mov dword [ebp-0x8], 0x1 */
        l_0x1012_888b:
            ii(0x1012_888b, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
