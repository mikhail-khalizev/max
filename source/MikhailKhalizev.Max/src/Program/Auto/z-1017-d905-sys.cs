...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_d905()
        {
            ...
            ii(0x1017_d913, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        ...
        l_0x1017_d92e:
            ii(0x1017_d92e, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x1017_d935, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
