...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_585f()
        {
            ...
            ii(0x1016_5877, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1016_587a, 5);  mov(eax, 5);                          /* mov eax, 0x5 */
            ii(0x1016_587f, 5);  call(/* sys */ 0x1016_a24c, 0x49c8);  /* call 0x1016a24c */
            ii(0x1016_5884, 5);  mov(ebx, 0xa);                        /* mov ebx, 0xa */
            ii(0x1016_5889, 3);  lea(edx, memd[ss, ebp - 16]);         /* lea edx, [ebp-0x10] */
            ii(0x1016_588c, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_588f, 3);  mov(eax, memd[ds, eax + 21]);         /* mov eax, [eax+0x15] */
            ...
            ii(0x1016_58a4, 3);  lea(edx, memd[ss, ebp - 24]);         /* lea edx, [ebp-0x18] */
            ii(0x1016_58a7, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_58aa, 3);  mov(ecx, memd[ds, eax + 65]);         /* mov ecx, [eax+0x41] */
            ii(0x1016_58ad, 3);  sar(ecx, 0x10);                       /* sar ecx, 0x10 */
            ii(0x1016_58b0, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_58b3, 3);  mov(eax, memd[ds, eax + 21]);         /* mov eax, [eax+0x15] */
            ...
            ii(0x1016_58c7, 3);  lea(edx, memd[ss, ebp - 32]);         /* lea edx, [ebp-0x20] */
            ii(0x1016_58ca, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_58cd, 3);  mov(eax, memd[ds, eax + 67]);         /* mov eax, [eax+0x43] */
            ii(0x1016_58d0, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x1016_58d3, 3);  mov(ecx, memd[ss, ebp - 4]);          /* mov ecx, [ebp-0x4] */
            ii(0x1016_58d6, 3);  mov(ecx, memd[ds, ecx + 21]);         /* mov ecx, [ecx+0x15] */
            ...
            ii(0x1016_58e3, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1016_58e6, 3);  add(edx, 0x23);                       /* add edx, 0x23 */
            ii(0x1016_58e9, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_58ec, 3);  mov(eax, memd[ds, eax + 100]);        /* mov eax, [eax+0x64] */
            ...
            ii(0x1016_58ff, 5);  mov(eax, 1);                          /* mov eax, 0x1 */
            ...
            ii(0x1016_5921, 3);  lea(ebx, memd[ss, ebp - 16]);         /* lea ebx, [ebp-0x10] */
            ii(0x1016_5924, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1016_5927, 3);  mov(edx, memd[ds, edx + 49]);         /* mov edx, [edx+0x31] */
            ii(0x1016_592a, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x1016_592d, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_5930, 3);  mov(eax, memd[ds, eax + 57]);         /* mov eax, [eax+0x39] */
            ii(0x1016_5933, 5);  call(0x100e_9ae5, -0x7_be53);         /* call 0x100e9ae5 */
            ii(0x1016_5938, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1016_593b, 3);  add(edx, 0x23);                       /* add edx, 0x23 */
            ii(0x1016_593e, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_5941, 3);  mov(eax, memd[ds, eax + 104]);        /* mov eax, [eax+0x68] */
            ...
            ii(0x1016_5954, 5);  mov(eax, 1);                          /* mov eax, 0x1 */
            ...
            ii(0x1016_5976, 3);  lea(ebx, memd[ss, ebp - 24]);         /* lea ebx, [ebp-0x18] */
            ii(0x1016_5979, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1016_597c, 3);  mov(edx, memd[ds, edx + 49]);         /* mov edx, [edx+0x31] */
            ii(0x1016_597f, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x1016_5982, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_5985, 3);  mov(eax, memd[ds, eax + 57]);         /* mov eax, [eax+0x39] */
            ii(0x1016_5988, 5);  call(0x100e_9ae5, -0x7_bea8);         /* call 0x100e9ae5 */
            ii(0x1016_598d, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1016_5990, 3);  add(edx, 0x23);                       /* add edx, 0x23 */
            ii(0x1016_5993, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_5996, 3);  mov(eax, memd[ds, eax + 108]);        /* mov eax, [eax+0x6c] */
            ...
            ii(0x1016_59a9, 5);  mov(eax, 1);                          /* mov eax, 0x1 */
            ...
            ii(0x1016_59cb, 3);  lea(ebx, memd[ss, ebp - 32]);         /* lea ebx, [ebp-0x20] */
            ii(0x1016_59ce, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_59d1, 3);  mov(edx, memd[ds, eax + 49]);         /* mov edx, [eax+0x31] */
            ii(0x1016_59d4, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x1016_59d7, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_59da, 3);  mov(eax, memd[ds, eax + 57]);         /* mov eax, [eax+0x39] */
            ...
            ii(0x1016_59f4, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_59f7, 3);  mov(eax, memd[ds, eax + 92]);         /* mov eax, [eax+0x5c] */
            ii(0x1016_59fa, 5);  call(0x100c_fa7c, -0x9_5f83);         /* call 0x100cfa7c */
            ii(0x1016_59ff, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_5a02, 3);  mov(eax, memd[ds, eax + 21]);         /* mov eax, [eax+0x15] */
            ii(0x1016_5a05, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x1016_5a08, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x1016_5a0a, 2);  if(jl(0x1016_5a12, 6)) goto l_0x1016_5a12;/* jl 0x10165a12 */
            ii(0x1016_5a0c, 4);  mov(memb[ss, ebp - 8], 1);            /* mov byte [ebp-0x8], 0x1 */
            ii(0x1016_5a10, 2);  jmp(0x1016_5a16, 4); goto l_0x1016_5a16;/* jmp 0x10165a16 */
        l_0x1016_5a12:
            ii(0x1016_5a12, 4);  mov(memb[ss, ebp - 8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x1016_5a16:
            ii(0x1016_5a16, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1016_5a18, 3);  mov(dl, memb[ss, ebp - 8]);           /* mov dl, [ebp-0x8] */
            ii(0x1016_5a1b, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_5a1e, 3);  mov(eax, memd[ds, eax + 92]);         /* mov eax, [eax+0x5c] */
            ...
            ii(0x1016_5a2f, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_5a32, 3);  mov(eax, memd[ds, eax + 92]);         /* mov eax, [eax+0x5c] */
            ii(0x1016_5a35, 5);  call(0x100c_fb06, -0x9_5f34);         /* call 0x100cfb06 */
            ii(0x1016_5a3a, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1016_5a3d, 3);  add(edx, 0x23);                       /* add edx, 0x23 */
            ii(0x1016_5a40, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_5a43, 3);  mov(eax, memd[ds, eax + 53]);         /* mov eax, [eax+0x35] */
