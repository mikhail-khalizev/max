...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_04dc()
        {
            ...
            ii(0x1012_04f3, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_04f6, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1012_04f9, 7); test(memd[ss, ebp - 0x4], 0x4);         /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x1012_0507, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1012_0516:
            ...
            ii(0x1012_051b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_051e, 5); call(0x100c_d916, -0x5_2c0d);           /* call 0x100cd916 */
            ii(0x1012_0523, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_0526, 7); test(memd[ss, ebp - 0x4], 0x2);         /* test dword [ebp-0x4], 0x2 */
            ii(0x1012_052d, 2); if(jz(0x1012_0537, 0x8)) goto l_0x1012_0537; /* jz 0x10120537 */
            ii(0x1012_052f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_0532, 5); call(Definitions.sys_delete, 0x4_5a2d); /* call 0x10165f64 */
        l_0x1012_0537:
            ii(0x1012_0537, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_053a, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1012_053d, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
