...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_a86b()
        {
            ...
            ii(0x1015_a881, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1015_a884, 3);  mov(memd[ss, ebp - 8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1015_a887, 3);  mov(memd[ss, ebp - 4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1015_a88a, 4);  mov(memb[ss, ebp - 16], 0);           /* mov byte [ebp-0x10], 0x0 */
            ii(0x1015_a88e, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1015_a891, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ...
            ii(0x1015_a89e, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1015_a8a1, 1);  push(eax);                            /* push eax */
            ii(0x1015_a8a2, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x1015_a8a5, 1);  push(eax);                            /* push eax */
            ii(0x1015_a8a6, 3);  lea(ecx, memd[ss, ebp - 28]);         /* lea ecx, [ebp-0x1c] */
            ...
            ii(0x1015_a8bb, 5);  cmp(memw[ss, ebp - 28], 0);           /* cmp word [ebp-0x1c], 0x0 */
            ...
            ii(0x1015_a8cc, 4);  cmp(ax, memw[ss, ebp - 20]);          /* cmp ax, [ebp-0x14] */
        ...
        l_0x1015_a8d7:
            ii(0x1015_a8d7, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
        ...
        l_0x1015_a90c:
            ...
            ii(0x1015_a919, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1015_a91c, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ii(0x1015_a91f, 2);  xor(ah, ah);                          /* xor ah, ah */
            ii(0x1015_a921, 1);  cwde();                               /* cwde */
            ii(0x1015_a922, 5);  call(0x100c_e099, -0x8_c88e);         /* call 0x100ce099 */
            ii(0x1015_a927, 3);  mov(memb[ss, ebp - 16], al);          /* mov [ebp-0x10], al */
        ...
        l_0x1015_a959:
            ...
            ii(0x1015_a962, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
        ...
        l_0x1015_a96f:
            ...
            ii(0x1015_a971, 3);  mov(al, memb[ss, ebp - 16]);          /* mov al, [ebp-0x10] */
            ii(0x1015_a974, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x1015_a977, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
