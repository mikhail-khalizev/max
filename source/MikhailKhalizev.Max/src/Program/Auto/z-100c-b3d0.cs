...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_b3d0()
        {
            ...
            ii(0x100c_b3e6, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ...
            ii(0x100c_b3f7, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100c_b3fa, 5); call(0x1013_afb8, 0x6_fbb9);            /* call 0x1013afb8 */
            ii(0x100c_b3ff, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100c_b402, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x100c_b405, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x100c_b408, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100c_b40b, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x100c_b40e, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
