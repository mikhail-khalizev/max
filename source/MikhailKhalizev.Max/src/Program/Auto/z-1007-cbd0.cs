...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_cbd0()
        {
            ...
            ii(0x1007_cbe8, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_cbeb, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1007_cbf2, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_cbf4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_cc01, 2); if(jz(0x1007_cc0c, 0x9)) goto l_0x1007_cc0c; /* jz 0x1007cc0c */
            ii(0x1007_cc03, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_cc06, 4); cmp(memb[ds, eax + 0x6], 0);            /* cmp byte [eax+0x6], 0x0 */
            ii(0x1007_cc0a, 2); if(jnz(0x1007_cc11, 0x5)) goto l_0x1007_cc11; /* jnz 0x1007cc11 */
        l_0x1007_cc0c:
            ii(0x1007_cc0c, 5); jmp(0x1007_cc91, 0x80); goto l_0x1007_cc91; /* jmp 0x1007cc91 */
        l_0x1007_cc11:
            ii(0x1007_cc11, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_cc14, 4); mov(memb[ds, eax + 0x6], 0);            /* mov byte [eax+0x6], 0x0 */
            ...
            ii(0x1007_cc24, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_cc31, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_cc4a, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
        ...
        l_0x1007_cc59:
            ...
            ii(0x1007_cc5b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_cc6a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_cc77, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ii(0x1007_cc7a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_cc7d, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ii(0x1007_cc80, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1007_cc83, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x1007_cc85, 2); if(jnz(0x1007_cc89, 0x2)) goto l_0x1007_cc89; /* jnz 0x1007cc89 */
        l_0x1007_cc87:
            ii(0x1007_cc87, 2); jmp(0x1007_cc91, 0x8); goto l_0x1007_cc91; /* jmp 0x1007cc91 */
        l_0x1007_cc89:
            ii(0x1007_cc89, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_cc8c, 5); call(0x1007_ce58, 0x1c7);               /* call 0x1007ce58 */
        l_0x1007_cc91:
            ii(0x1007_cc91, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_cc93, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_ccb9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_cccf, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1007_ccd2, 5); mov(eax, 0xa);                          /* mov eax, 0xa */
            ii(0x1007_ccd7, 5); call(Definitions.sys_new, 0xe_9124);    /* call 0x10165e00 */
            ii(0x1007_ccdc, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1007_ccdf, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1007_cce2, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1007_cce5, 4); cmp(memd[ss, ebp - 0x14], 0);           /* cmp dword [ebp-0x14], 0x0 */
            ii(0x1007_cce9, 2); if(jz(0x1007_cd01, 0x16)) goto l_0x1007_cd01; /* jz 0x1007cd01 */
            ii(0x1007_cceb, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_ccee, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1007_ccf1, 5); call(Definitions.my_ctor_c11, 0x2_6bd3); /* call 0x100a38c9 */
            ii(0x1007_ccf6, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1007_ccf9, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1007_ccfc, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1007_ccff, 2); jmp(0x1007_cd07, 0x6); goto l_0x1007_cd07; /* jmp 0x1007cd07 */
        l_0x1007_cd01:
            ii(0x1007_cd01, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1007_cd04, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
        l_0x1007_cd07:
            ii(0x1007_cd07, 3); mov(edx, memd[ss, ebp - 0x1c]);         /* mov edx, [ebp-0x1c] */
            ii(0x1007_cd0a, 5); mov(eax, 0x101c_3180);                  /* mov eax, 0x101c3180 */
            ii(0x1007_cd0f, 3); mov(ebx, memd[ss, ebp - 0xc]);          /* mov ebx, [ebp-0xc] */
        ...
        l_0x1007_cd19:
            ii(0x1007_cd19, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_cd25, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_cd28, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
            ii(0x1007_cd2b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
