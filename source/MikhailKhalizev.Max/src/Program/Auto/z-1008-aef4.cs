...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_aef4()
        {
            ...
            ii(0x1008_af06, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1008_af0c, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_af0f, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_af12, 5);  call(0x1007_6b58, -0x1_43bf);         /* call 0x10076b58 */
            ii(0x1008_af17, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_af1a, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
