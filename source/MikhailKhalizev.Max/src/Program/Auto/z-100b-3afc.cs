...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_3afc()
        {
            ...
            ii(0x100b_3b14, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_3b17, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x100b_3b1b, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
