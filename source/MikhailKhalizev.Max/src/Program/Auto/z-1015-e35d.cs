...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_e35d()
        {
            ...
            ii(0x1015_e36f, 6); sub(esp, 4);                            /* sub esp, 0x4 */
            ...
            ii(0x1015_e390, 7); mov(memd[ss, ebp - 4], 0);              /* mov dword [ebp-0x4], 0x0 */
            ii(0x1015_e397, 2); jmp(0x1015_e39f, 6); goto l_0x1015_e39f; /* jmp 0x1015e39f */
        l_0x1015_e399:
            ii(0x1015_e399, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1015_e39c, 3); inc(memd[ss, ebp - 4]);                 /* inc dword [ebp-0x4] */
        l_0x1015_e39f:
            ii(0x1015_e39f, 4); movsx(eax, memw[ss, ebp - 4]);          /* movsx eax, word [ebp-0x4] */
            ii(0x1015_e3a3, 3); cmp(eax, 5);                            /* cmp eax, 0x5 */
            ii(0x1015_e3a6, 2); if(jge(0x1015_e3bd, 0x15)) goto l_0x1015_e3bd; /* jge 0x1015e3bd */
            ii(0x1015_e3a8, 4); movsx(eax, memw[ss, ebp - 4]);          /* movsx eax, word [ebp-0x4] */
