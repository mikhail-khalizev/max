...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_394d()
        {
            ...
            ii(0x1019_394e, 3); add(esi, memd[ss, ebp - 0x18]);         /* add esi, [ebp-0x18] */
            ii(0x1019_3951, 3); add(edi, memd[ss, ebp - 0x1c]);         /* add edi, [ebp-0x1c] */
            ii(0x1019_3954, 3); add(edi, memd[ss, ebp - 0x20]);         /* add edi, [ebp-0x20] */
            ...
            ii(0x1019_3961, 3); inc(memd[ss, ebp + 0x24]);              /* inc dword [ebp+0x24] */
