...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_c832()
        {
            ...
            ii(0x18_c83c, 3); mov(ax, memw[ss, bp + 4]);                /* mov ax, [bp+0x4] */
            ...
            ii(0x18_c849, 3); mov(cx, 8);                               /* mov cx, 0x8 */
            ii(0x18_c84c, 2); mov(es, cx);                              /* mov es, cx */
            ii(0x18_c84e, 5); cmp(memb[es, bx + 5], 0);                 /* cmp byte [es:bx+0x5], 0x0 */
            ii(0x18_c853, 2); if(jz(0x18_c859, 4)) goto l_0x18_c859;    /* jz 0xc859 */
        l_0x18_c855:
            ii(0x18_c855, 2); sub(ax, ax);                              /* sub ax, ax */
            ii(0x18_c857, 1); leave();                                  /* leave */
            ii(0x18_c858, 1); ret(); return;                            /* ret */
        l_0x18_c859:
            ii(0x18_c859, 3); mov(ax, memw[ss, bp + 4]);                /* mov ax, [bp+0x4] */
