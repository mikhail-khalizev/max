...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_9155()
        {
            ...
            ii(0x1012_916c, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_916f, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ...
            ii(0x1012_918b, 7); mov(memd[ss, ebp - 0xc], 0x101c_5c21);  /* mov dword [ebp-0xc], 0x101c5c21 */
            ii(0x1012_9192, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1012_9195, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_9198, 5); call(Definitions.sys_strcpy, 0x3_cd32); /* call 0x10165ecf */
            ii(0x1012_919d, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1012_91a0, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
