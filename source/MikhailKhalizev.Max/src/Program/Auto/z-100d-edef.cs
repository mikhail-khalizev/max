...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_edef()
        {
            ...
            ii(0x100d_ee06, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_ee09, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_ee0c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_ee0f, 6); mov(eax, memd[ds, eax + 0x345]);        /* mov eax, [eax+0x345] */
            ii(0x100d_ee15, 5); call(0x100d_0149, -0xecd1);             /* call 0x100d0149 */
            ii(0x100d_ee1a, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100d_ee1d, 7); mov(memd[ss, ebp - 0xc], 0x2);          /* mov dword [ebp-0xc], 0x2 */
            ii(0x100d_ee24, 2); jmp(0x100d_ee2c, 0x6); goto l_0x100d_ee2c; /* jmp 0x100dee2c */
        l_0x100d_ee26:
            ii(0x100d_ee26, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100d_ee29, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x100d_ee2c:
            ii(0x100d_ee2c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_ee2f, 5); add(eax, 0x3b3);                        /* add eax, 0x3b3 */
            ii(0x100d_ee34, 5); call(Definitions.my_2_get_count, -0x5_3ad1); /* call 0x1008b368 */
            ii(0x100d_ee39, 4); cmp(ax, memw[ss, ebp - 0xc]);           /* cmp ax, [ebp-0xc] */
            ii(0x100d_ee3d, 2); if(jle(0x100d_ee77, 0x38)) goto l_0x100d_ee77; /* jle 0x100dee77 */
            ii(0x100d_ee3f, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100d_ee43, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_ee53, 4); cmp(ax, memw[ss, ebp - 0x10]);          /* cmp ax, [ebp-0x10] */
            ...
            ii(0x100d_ee68, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100d_ee6b, 3); imul(edx, eax);                         /* imul edx, eax */
            ii(0x100d_ee6e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_ee71, 4); sub(memw[ds, eax + 0x4f], dx);          /* sub [eax+0x4f], dx */
        l_0x100d_ee75:
