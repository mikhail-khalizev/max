...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_3fc0()
        {
            ...
            ii(0x1016_3fd1, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1016_3fd7, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1016_3fda, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1016_3fdd, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1016_3fe0, 3); add(edx, 8);                            /* add edx, 0x8 */
            ii(0x1016_3fe3, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1016_3fe6, 5); call(0x1013_bb7b, -0x2_8470);           /* call 0x1013bb7b */
            ii(0x1016_3feb, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1016_3fee, 3); add(edx, 0xa);                          /* add edx, 0xa */
            ii(0x1016_3ff1, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1016_3ff4, 5); call(0x1013_bb7b, -0x2_847e);           /* call 0x1013bb7b */
            ii(0x1016_3ff9, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1016_3ffc, 3); add(edx, 0xc);                          /* add edx, 0xc */
            ii(0x1016_3fff, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1016_4002, 5); call(0x1013_bb7b, -0x2_848c);           /* call 0x1013bb7b */
            ii(0x1016_4007, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1016_400a, 3); add(edx, 0xe);                          /* add edx, 0xe */
            ii(0x1016_400d, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1016_4010, 5); call(0x1013_bb7b, -0x2_849a);           /* call 0x1013bb7b */
            ii(0x1016_4015, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1016_4018, 3); add(edx, 0x10);                         /* add edx, 0x10 */
            ii(0x1016_401b, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1016_401e, 5); call(0x1013_bb7b, -0x2_84a8);           /* call 0x1013bb7b */
            ii(0x1016_4023, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1016_4026, 3); add(edx, 0x12);                         /* add edx, 0x12 */
            ii(0x1016_4029, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1016_402c, 5); call(0x1013_bb7b, -0x2_84b6);           /* call 0x1013bb7b */
            ii(0x1016_4031, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1016_4034, 3); add(edx, 0x14);                         /* add edx, 0x14 */
            ii(0x1016_4037, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
