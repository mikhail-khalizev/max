...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_3800()
        {
            ...
            ii(0x100f_3818, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100f_381b, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_382c, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100f_382f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_3832, 6); mov(eax, memd[ds, eax + 0x100]);        /* mov eax, [eax+0x100] */
            ...
            ii(0x100f_3860, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_3863, 6); mov(ebx, memd[ds, eax + 0x104]);        /* mov ebx, [eax+0x104] */
            ii(0x100f_3869, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100f_386c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_386f, 6); mov(edx, memd[ds, eax + 0x102]);        /* mov edx, [eax+0x102] */
            ...
            ii(0x100f_3884, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100f_38ce:
            ii(0x100f_38ce, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_38d1, 6); mov(al, memb[ds, eax + 0x111]);         /* mov al, [eax+0x111] */
            ii(0x100f_38d7, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100f_38dc, 5); call(0x100f_a7e8, 0x6f07);              /* call 0x100fa7e8 */
            ii(0x100f_38e1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_38e4, 6); mov(al, memb[ds, eax + 0x10a]);         /* mov al, [eax+0x10a] */
            ii(0x100f_38ea, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100f_38ef, 5); call(0x100f_47e4, 0xef0);               /* call 0x100f47e4 */
            ii(0x100f_38f4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_38f7, 6); mov(al, memb[ds, eax + 0x10b]);         /* mov al, [eax+0x10b] */
            ii(0x100f_38fd, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100f_3902, 5); call(0x100f_487e, 0xf77);               /* call 0x100f487e */
            ii(0x100f_3907, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_390a, 6); mov(al, memb[ds, eax + 0x10c]);         /* mov al, [eax+0x10c] */
            ii(0x100f_3910, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100f_3915, 5); call(0x100f_48cb, 0xfb1);               /* call 0x100f48cb */
            ii(0x100f_391a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_391d, 6); mov(al, memb[ds, eax + 0x10d]);         /* mov al, [eax+0x10d] */
            ii(0x100f_3923, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100f_3928, 5); call(0x100f_4965, 0x1038);              /* call 0x100f4965 */
            ii(0x100f_392d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_3930, 6); mov(al, memb[ds, eax + 0x112]);         /* mov al, [eax+0x112] */
            ii(0x100f_3936, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100f_393b, 5); call(0x100f_4918, 0xfd8);               /* call 0x100f4918 */
            ii(0x100f_3940, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_3943, 6); mov(al, memb[ds, eax + 0x108]);         /* mov al, [eax+0x108] */
            ii(0x100f_3949, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100f_394e, 5); call(0x100f_4831, 0xede);               /* call 0x100f4831 */
            ii(0x100f_3953, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_3956, 6); mov(al, memb[ds, eax + 0x109]);         /* mov al, [eax+0x109] */
            ii(0x100f_395c, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100f_3961, 5); call(0x100f_4ba0, 0x123a);              /* call 0x100f4ba0 */
            ii(0x100f_3966, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_3969, 6); mov(al, memb[ds, eax + 0x110]);         /* mov al, [eax+0x110] */
            ii(0x100f_396f, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100f_3974, 5); call(0x100f_4f55, 0x15dc);              /* call 0x100f4f55 */
            ii(0x100f_3979, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_397c, 6); mov(al, memb[ds, eax + 0x10e]);         /* mov al, [eax+0x10e] */
            ii(0x100f_3982, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100f_3987, 5); call(0x100f_49b2, 0x1026);              /* call 0x100f49b2 */
            ii(0x100f_398c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_398f, 6); mov(al, memb[ds, eax + 0x10f]);         /* mov al, [eax+0x10f] */
