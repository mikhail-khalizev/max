...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("f22aa78a-034e-4db2-afd1-f53805425827")]
        public void Method_1010_77ad()
        {
            ii(0x1010_77ad, 5); pushd(0x54);                            /* push 0x54 */
            ii(0x1010_77b2, 5); calld(Definitions.sys_check_available_stack_size, 0x5e59b); /* call 0x10165d52 */
        ...
        l_0x1010_77f3:
            ii(0x1010_77f3, 5); calld(0x1014_82f4, 0x40afc);            /* call 0x101482f4 */
            ...
            ii(0x1010_780f, 5); calld(Definitions.sys_memset, 0x5e5cc); /* call 0x10165de0 */
            ...
            ii(0x1010_783b, 5); calld(0x100e_44ba, -0x23386);           /* call 0x100e44ba */
            ii(0x1010_7840, 5); calld(0x1014_82f4, 0x40aaf);            /* call 0x101482f4 */
            ...
            ii(0x1010_7852, 1); retd(); return;                         /* ret */
        }
    }
}
