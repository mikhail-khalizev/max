...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_77ad()
        {
            ...
            ii(0x1010_77c5, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_77c8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_77cb, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1010_77cd, 3); mov(bl, memb[ds, eax + 0x48]);          /* mov bl, [eax+0x48] */
            ii(0x1010_77d0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_77d3, 4); mov(ax, memw[ds, eax + 0x28]);          /* mov ax, [eax+0x28] */
            ii(0x1010_77d7, 3); sub(eax, 0x26);                         /* sub eax, 0x26 */
            ii(0x1010_77da, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_77dc, 3); mov(dx, ax);                            /* mov dx, ax */
            ii(0x1010_77df, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_77ec, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_77ef, 4); mov(memw[ds, eax + 0x4e], dx);          /* mov [eax+0x4e], dx */
        l_0x1010_77f3:
            ...
            ii(0x1010_780c, 3); lea(eax, memd[ss, ebp - 0x38]);         /* lea eax, [ebp-0x38] */
            ii(0x1010_780f, 5); call(Definitions.sys_memset, 0x5_e5cc); /* call 0x10165de0 */
            ii(0x1010_7814, 7); mov(memd[ss, ebp - 0x28], 0x3);         /* mov dword [ebp-0x28], 0x3 */
            ii(0x1010_781b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_781e, 3); and(eax, 0xf);                          /* and eax, 0xf */
            ii(0x1010_7821, 3); mov(memd[ss, ebp - 0x34], eax);         /* mov [ebp-0x34], eax */
            ii(0x1010_7824, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_7827, 3); shr(eax, 0x4);                          /* shr eax, 0x4 */
            ii(0x1010_782a, 5); and(eax, 0xffff);                       /* and eax, 0xffff */
            ii(0x1010_782f, 4); mov(memw[ss, ebp - 0x16], ax);          /* mov [ebp-0x16], ax */
            ii(0x1010_7833, 3); lea(edx, memd[ss, ebp - 0x38]);         /* lea edx, [ebp-0x38] */
