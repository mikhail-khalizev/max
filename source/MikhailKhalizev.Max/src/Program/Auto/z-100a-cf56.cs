...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_cf56()
        {
            ...
            ii(0x100a_cf6e, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_cf71, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_cf73, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_cf86, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100a_cf89, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_cfa1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_cfa4, 4); cmp(memb[ds, eax + 0x44], 0);           /* cmp byte [eax+0x44], 0x0 */
            ii(0x100a_cfa8, 2); if(jz(0x100a_cfc1, 0x17)) goto l_0x100a_cfc1; /* jz 0x100acfc1 */
            ii(0x100a_cfaa, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_cfad, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100a_cfb0, 5); call(0x1007_6574, -0x3_6a41);           /* call 0x10076574 */
            ii(0x100a_cfb5, 3); mov(al, memb[ds, eax + 0x4e]);          /* mov al, [eax+0x4e] */
            ii(0x100a_cfb8, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100a_cfbd, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100a_cfbf, 2); if(jz(0x100a_cfc3, 0x2)) goto l_0x100a_cfc3; /* jz 0x100acfc3 */
        l_0x100a_cfc1:
            ii(0x100a_cfc1, 2); jmp(0x100a_cfcd, 0xa); goto l_0x100a_cfcd; /* jmp 0x100acfcd */
        l_0x100a_cfc3:
            ii(0x100a_cfc3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_cfc6, 5); cmp(memw[ds, eax + 0x26], -0x1 /* 0xff */); /* cmp word [eax+0x26], 0xffff */
            ii(0x100a_cfcb, 2); if(jz(0x100a_cfcf, 0x2)) goto l_0x100a_cfcf; /* jz 0x100acfcf */
        l_0x100a_cfcd:
            ii(0x100a_cfcd, 2); jmp(0x100a_cfdb, 0xc); goto l_0x100a_cfdb; /* jmp 0x100acfdb */
        l_0x100a_cfcf:
            ii(0x100a_cfcf, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_cfd1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100a_cfdb:
            ii(0x100a_cfdb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_cfde, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100a_cfe1, 5); call(0x1007_6574, -0x3_6a72);           /* call 0x10076574 */
            ii(0x100a_cfe6, 3); mov(al, memb[ds, eax + 0x4e]);          /* mov al, [eax+0x4e] */
            ...
            ii(0x100a_cff4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_d001, 2); if(jnz(0x100a_d005, 0x2)) goto l_0x100a_d005; /* jnz 0x100ad005 */
        l_0x100a_d003:
            ii(0x100a_d003, 2); jmp(0x100a_d024, 0x1f); goto l_0x100a_d024; /* jmp 0x100ad024 */
        l_0x100a_d005:
            ii(0x100a_d005, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_d008, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_d00b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_d00e, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x100a_d011, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_d01e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_d021, 3); call_abs(memd[ds, ebx + 0x44]);         /* call dword [ebx+0x44] */
        l_0x100a_d024:
