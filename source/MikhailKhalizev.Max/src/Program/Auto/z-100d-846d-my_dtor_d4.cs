...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void my_dtor_d4()
        {
            ...
            ii(0x100d_8484, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_8487, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_848a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_848d, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x100d_84ab, 2); jmp(0x100d_84b4, 0x7); goto l_0x100d_84b4; /* jmp 0x100d84b4 */
        l_0x100d_84ad:
            ii(0x100d_84ad, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
        l_0x100d_84b4:
            ii(0x100d_84b4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_84d5, 2); jmp(0x100d_84de, 0x7); goto l_0x100d_84de; /* jmp 0x100d84de */
        l_0x100d_84d7:
            ii(0x100d_84d7, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
        l_0x100d_84de:
            ii(0x100d_84de, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
