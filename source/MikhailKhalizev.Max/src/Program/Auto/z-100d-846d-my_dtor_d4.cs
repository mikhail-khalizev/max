...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void my_dtor_d4()
        {
            ...
            ii(0x100d_8490, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x100d_8493, 4);  cmp(memd[ss, ebp - 24], 0);           /* cmp dword [ebp-0x18], 0x0 */
            ii(0x100d_8497, 2);  if(jz(0x100d_84ad, 0x14)) goto l_0x100d_84ad;/* jz 0x100d84ad */
            ii(0x100d_8499, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100d_849b, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ...
            ii(0x100d_84a8, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x100d_84ab, 2);  jmp(0x100d_84b4, 7); goto l_0x100d_84b4;/* jmp 0x100d84b4 */
        l_0x100d_84ad:
            ii(0x100d_84ad, 7);  mov(memd[ss, ebp - 16], 0);           /* mov dword [ebp-0x10], 0x0 */
        l_0x100d_84b4:
            ii(0x100d_84b4, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_84b7, 3);  mov(eax, memd[ds, eax + 10]);         /* mov eax, [eax+0xa] */
            ii(0x100d_84ba, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x100d_84bd, 4);  cmp(memd[ss, ebp - 20], 0);           /* cmp dword [ebp-0x14], 0x0 */
            ii(0x100d_84c1, 2);  if(jz(0x100d_84d7, 0x14)) goto l_0x100d_84d7;/* jz 0x100d84d7 */
            ii(0x100d_84c3, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100d_84c5, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ...
            ii(0x100d_84d2, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100d_84d5, 2);  jmp(0x100d_84de, 7); goto l_0x100d_84de;/* jmp 0x100d84de */
        l_0x100d_84d7:
            ii(0x100d_84d7, 7);  mov(memd[ss, ebp - 12], 0);           /* mov dword [ebp-0xc], 0x0 */
        l_0x100d_84de:
            ii(0x100d_84de, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_84e1, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100d_84e4, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
