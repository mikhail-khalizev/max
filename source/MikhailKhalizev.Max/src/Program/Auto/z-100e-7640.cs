...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_7640()
        {
            ...
            ii(0x100e_7662, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_7665, 4); or(memb[ss, ebp - 0x4], 0x1);           /* or byte [ebp-0x4], 0x1 */
            ...
            ii(0x100e_7677, 4); and(memb[ss, ebp - 0x4], -0x2 /* 0xfe */); /* and byte [ebp-0x4], 0xfe */
        ...
        l_0x100e_768d:
            ii(0x100e_768d, 3); dec(memd[ss, ebp - 0x8]);               /* dec dword [ebp-0x8] */
            ii(0x100e_7690, 5); cmp(memw[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp word [ebp-0x8], 0xffff */
            ii(0x100e_7695, 2); if(jz(0x100e_76b4, 0x1d)) goto l_0x100e_76b4; /* jz 0x100e76b4 */
            ii(0x100e_7697, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
        ...
        l_0x100e_76b4:
            ...
            ii(0x100e_76bb, 2); if(jz(0x100e_76c2, 0x5)) goto l_0x100e_76c2; /* jz 0x100e76c2 */
