...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_f020()
        {
            ...
            ii(0x1017_f028, 6); sub(esp, 4);                            /* sub esp, 0x4 */
            ...
            ii(0x1017_f03d, 7); mov(memd[ss, ebp - 4], 0);              /* mov dword [ebp-0x4], 0x0 */
            ii(0x1017_f044, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
