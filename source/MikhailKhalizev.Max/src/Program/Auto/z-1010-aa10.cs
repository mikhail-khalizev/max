...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_aa10()
        {
            ...
            ii(0x1010_aa28, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_aa2b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_aa2e, 3); mov(al, memb[ds, eax + 0xc]);           /* mov al, [eax+0xc] */
            ...
            ii(0x1010_aa3b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_aa3e, 3); mov(al, memb[ds, eax + 0xc]);           /* mov al, [eax+0xc] */
            ii(0x1010_aa41, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x1010_aa46, 3); cmp(eax, 0x2);                          /* cmp eax, 0x2 */
            ii(0x1010_aa49, 2); if(jnz(0x1010_aa53, 0x8)) goto l_0x1010_aa53; /* jnz 0x1010aa53 */
        l_0x1010_aa4b:
            ii(0x1010_aa4b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_aa4e, 5); call(0x1010_a3fc, -0x657);              /* call 0x1010a3fc */
        l_0x1010_aa53:
            ii(0x1010_aa53, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_aa56, 5); call(0x1010_a8f7, -0x164);              /* call 0x1010a8f7 */
            ii(0x1010_aa5b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_aa5e, 5); call(0x1010_a8a7, -0x1bc);              /* call 0x1010a8a7 */
            ii(0x1010_aa63, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_aa66, 3); mov(al, memb[ds, eax + 0xc]);           /* mov al, [eax+0xc] */
            ...
            ii(0x1010_aa73, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_aa76, 3); mov(al, memb[ds, eax + 0xc]);           /* mov al, [eax+0xc] */
        ...
        l_0x1010_aa83:
            ii(0x1010_aa83, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_aa86, 5); call(0x1010_a4a1, -0x5ea);              /* call 0x1010a4a1 */
            ii(0x1010_aa8b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_aa8e, 5); call(0x1010_a564, -0x52f);              /* call 0x1010a564 */
            ii(0x1010_aa93, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_aa96, 5); call(0x1010_a69d, -0x3fe);              /* call 0x1010a69d */
        l_0x1010_aa9b:
            ii(0x1010_aa9b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_aa9e, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1010_aaa0, 3); mov(eax, memd[ds, eax + 0x12]);         /* mov eax, [eax+0x12] */
