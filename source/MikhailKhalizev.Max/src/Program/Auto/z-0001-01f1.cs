...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0001_01f1()
        {
            ...
            ii(0x1_01f6, 3);  mov(ax, memw[ds, bx + 0x2]);              /* mov ax, [bx+0x2] */
            ii(0x1_01f9, 4);  mov(memw_a32[ss, ebp + 0x18], ax);        /* mov [ebp+0x18], ax */
            ii(0x1_01fd, 3);  mov(al, memb[ds, bx + 0x4]);              /* mov al, [bx+0x4] */
            ii(0x1_0200, 3);  mov(ah, memb[ds, bx + 0x7]);              /* mov ah, [bx+0x7] */
            ii(0x1_0203, 4);  mov(memw_a32[ss, ebp + 0x1c], ax);        /* mov [ebp+0x1c], ax */
            ii(0x1_0207, 3);  if(jmp_func(0x1_0027, -0x1e3)) return;    /* jmp 0x27 */
        }
    }
}
