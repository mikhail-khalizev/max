...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_6b2c()
        {
            ...
            ii(0x17_6b38, 5);  mov(memw[ss, bp - 12], 0);              /* mov word [bp-0xc], 0x0 */
            ii(0x17_6b3d, 5);  mov(memw[ss, bp - 28], 0);              /* mov word [bp-0x1c], 0x0 */
            ...
            ii(0x17_6b61, 3);  mov(memw[ss, bp - 10], ax);             /* mov [bp-0xa], ax */
            ...
            ii(0x17_6b7a, 3);  mov(cx, memw[ss, bp - 10]);             /* mov cx, [bp-0xa] */
        ...
        l_0x17_6b88:
            ii(0x17_6b88, 3);  mov(ax, memw[ss, bp - 10]);             /* mov ax, [bp-0xa] */
            ...
            ii(0x17_6b9f, 3);  mov(memw[ss, bp - 50], ax);             /* mov [bp-0x32], ax */
            ii(0x17_6ba2, 3);  mov(memw[ss, bp - 48], dx);             /* mov [bp-0x30], dx */
            ...
            ii(0x17_6baf, 3);  mov(memw[ss, bp - 32], ax);             /* mov [bp-0x20], ax */
            ii(0x17_6bb2, 3);  mov(memw[ss, bp - 30], dx);             /* mov [bp-0x1e], dx */
            ...
            ii(0x17_6bd0, 3);  mov(ax, memw[ss, bp - 50]);             /* mov ax, [bp-0x32] */
            ii(0x17_6bd3, 3);  mov(dx, memw[ss, bp - 48]);             /* mov dx, [bp-0x30] */
            ii(0x17_6bd6, 3);  mov(memw[ss, bp - 42], ax);             /* mov [bp-0x2a], ax */
            ii(0x17_6bd9, 3);  mov(memw[ss, bp - 40], dx);             /* mov [bp-0x28], dx */
            ...
            ii(0x17_6bef, 3);  mov(memw[ss, bp - 54], ax);             /* mov [bp-0x36], ax */
            ii(0x17_6bf2, 3);  mov(memw[ss, bp - 52], dx);             /* mov [bp-0x34], dx */
            ii(0x17_6bf5, 3);  mov(memw[ss, bp - 16], ax);             /* mov [bp-0x10], ax */
            ii(0x17_6bf8, 3);  mov(memw[ss, bp - 14], dx);             /* mov [bp-0xe], dx */
            ...
            ii(0x17_6c08, 3);  mov(ax, memw[ss, bp - 10]);             /* mov ax, [bp-0xa] */
            ...
            ii(0x17_6c1e, 3);  mov(memw[ss, bp - 34], ax);             /* mov [bp-0x22], ax */
            ...
            ii(0x17_6c28, 3);  mov(memw[ss, bp - 34], ax);             /* mov [bp-0x22], ax */
        l_0x17_6c2b:
        ...
        l_0x17_6c3f:
            ii(0x17_6c3f, 3);  mov(ax, memw[ss, bp - 34]);             /* mov ax, [bp-0x22] */
            ii(0x17_6c42, 2);  sub(dx, dx);                            /* sub dx, dx */
            ii(0x17_6c44, 3);  cmp(dx, memw[ss, bp - 44]);             /* cmp dx, [bp-0x2c] */
            ...
            ii(0x17_6c4b, 3);  cmp(ax, memw[ss, bp - 46]);             /* cmp ax, [bp-0x2e] */
            ii(0x17_6c4e, 2);  if(jb(0x17_6c80, 0x30)) goto l_0x17_6c80;/* jb 0x6c80 */
        l_0x17_6c50:
            ii(0x17_6c50, 3);  les(bx, memw[ss, bp - 16]);             /* les bx, [bp-0x10] */
            ii(0x17_6c53, 3);  mov(ax, memw[es, bx]);                  /* mov ax, [es:bx] */
            ii(0x17_6c56, 3);  xor(ax, memw[ss, bp - 42]);             /* xor ax, [bp-0x2a] */
            ii(0x17_6c59, 3);  and(ah, 0xf);                           /* and ah, 0xf */
            ii(0x17_6c5c, 3);  xor(ax, memw[ss, bp - 42]);             /* xor ax, [bp-0x2a] */
            ii(0x17_6c5f, 3);  xor(dx, memw[ss, bp - 40]);             /* xor dx, [bp-0x28] */
            ...
            ii(0x17_6c72, 4);  add(memw[ss, bp - 16], 4);              /* add word [bp-0x10], 0x4 */
            ii(0x17_6c76, 4);  add(memw[ss, bp - 46], 1);              /* add word [bp-0x2e], 0x1 */
            ii(0x17_6c7a, 4);  adc(memw[ss, bp - 44], 0);              /* adc word [bp-0x2c], 0x0 */
            ii(0x17_6c7e, 2);  jmp(0x17_6c36, -0x4a); goto l_0x17_6c36;/* jmp 0x6c36 */
        l_0x17_6c80:
            ii(0x17_6c80, 2);  sub(ax, ax);                            /* sub ax, ax */
            ii(0x17_6c82, 3);  mov(memw[ss, bp - 40], ax);             /* mov [bp-0x28], ax */
            ii(0x17_6c85, 3);  mov(memw[ss, bp - 42], ax);             /* mov [bp-0x2a], ax */
            ii(0x17_6c88, 3);  mov(memw[ss, bp - 44], ax);             /* mov [bp-0x2c], ax */
            ii(0x17_6c8b, 3);  mov(memw[ss, bp - 46], ax);             /* mov [bp-0x2e], ax */
            ii(0x17_6c8e, 2);  jmp(0x17_6c98, 8); goto l_0x17_6c98;    /* jmp 0x6c98 */
        l_0x17_6c90:
            ii(0x17_6c90, 4);  add(memw[ss, bp - 46], 1);              /* add word [bp-0x2e], 0x1 */
            ii(0x17_6c94, 4);  adc(memw[ss, bp - 44], 0);              /* adc word [bp-0x2c], 0x0 */
        l_0x17_6c98:
            ...
            ii(0x17_6cb7, 3);  cmp(dx, memw[ss, bp - 44]);             /* cmp dx, [bp-0x2c] */
            ...
            ii(0x17_6cbe, 3);  cmp(ax, memw[ss, bp - 46]);             /* cmp ax, [bp-0x2e] */
            ii(0x17_6cc1, 2);  if(jbe(0x17_6d20, 0x5d)) goto l_0x17_6d20;/* jbe 0x6d20 */
        l_0x17_6cc3:
            ii(0x17_6cc3, 3);  mov(ax, memw[ss, bp - 42]);             /* mov ax, [bp-0x2a] */
            ii(0x17_6cc6, 3);  mov(dx, memw[ss, bp - 40]);             /* mov dx, [bp-0x28] */
            ...
            ii(0x17_6ce5, 3);  mov(si, memw[ss, bp - 46]);             /* mov si, [bp-0x2e] */
            ii(0x17_6ce8, 3);  shl(si, 2);                             /* shl si, 0x2 */
            ii(0x17_6ceb, 3);  add(si, memw[ss, bp - 32]);             /* add si, [bp-0x20] */
            ii(0x17_6cee, 3);  mov(es, memw[ss, bp - 30]);             /* mov es, [bp-0x1e] */
            ii(0x17_6cf1, 3);  mov(memw[ss, bp - 16], si);             /* mov [bp-0x10], si */
            ii(0x17_6cf4, 3);  mov(memw[ss, bp - 14], es);             /* mov [bp-0xe], es */
            ...
            ii(0x17_6d0a, 3);  les(bx, memw[ss, bp - 16]);             /* les bx, [bp-0x10] */
            ii(0x17_6d0d, 4);  or(memb[es, bx], 7);                    /* or byte [es:bx], 0x7 */
            ii(0x17_6d11, 4);  add(memw[ss, bp - 16], 4);              /* add word [bp-0x10], 0x4 */
            ii(0x17_6d15, 4);  add(memw[ss, bp - 42], 1);              /* add word [bp-0x2a], 0x1 */
            ii(0x17_6d19, 4);  adc(memw[ss, bp - 40], 0);              /* adc word [bp-0x28], 0x0 */
            ii(0x17_6d1d, 3);  jmp(0x17_6c90, -0x90); goto l_0x17_6c90;/* jmp 0x6c90 */
        l_0x17_6d20:
            ii(0x17_6d20, 3);  mov(ax, memw[ss, bp - 54]);             /* mov ax, [bp-0x36] */
            ii(0x17_6d23, 3);  mov(dx, memw[ss, bp - 52]);             /* mov dx, [bp-0x34] */
