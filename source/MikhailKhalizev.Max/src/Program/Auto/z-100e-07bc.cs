...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("4d545715-d540-43d8-80ce-934a16ead2cd")]
        public void Method_100e_07bc()
        {
            ii(0x100e_07bc, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x100e_07c1, 5); calld(Definitions.sys_check_available_stack_size, 0x8558c); /* call 0x10165d52 */
            ...
            ii(0x100e_07df, 5); calld(0x1013_acc5, 0x5a4e1);            /* call 0x1013acc5 */
