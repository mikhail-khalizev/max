...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1016_9780:
            ii(0x1016_9780, 4); mov(edi, memd[ds, ecx + ebx + 0x10]);   /* mov edi, [ecx+ebx+0x10] */
            ...
            ii(0x1016_978b, 7); lea(ecx, memd[ds, eax * 4 + 0]);        /* lea ecx, [eax*4] */
            ii(0x1016_9792, 2); jmp(0x1016_97a0, 0xc); goto l_0x1016_97a0; /* jmp 0x101697a0 */
        l_0x1016_9794:
            ii(0x1016_9794, 3); add(ecx, 0x4);                          /* add ecx, 0x4 */
            ii(0x1016_9797, 4); mov(esi, memd[ds, ecx + eax + 0xc]);    /* mov esi, [ecx+eax+0xc] */
            ii(0x1016_979b, 1); inc(ebx);                               /* inc ebx */
            ii(0x1016_979c, 4); mov(memd[ds, ecx + eax + 0x8], esi);    /* mov [ecx+eax+0x8], esi */
        l_0x1016_97a0:
            ii(0x1016_97a0, 3); mov(eax, memd[ds, edx + 0x68]);         /* mov eax, [edx+0x68] */
            ii(0x1016_97a3, 3); mov(ebp, memd[ds, eax + 0xc]);          /* mov ebp, [eax+0xc] */
            ii(0x1016_97a6, 2); cmp(ebx, ebp);                          /* cmp ebx, ebp */
            ii(0x1016_97a8, 2); if(jl(0x1016_9794, -0x16)) goto l_0x1016_9794; /* jl 0x10169794 */
            ii(0x1016_97aa, 3); lea(ebx, memd[ss, ebp - 0x1]);          /* lea ebx, [ebp-0x1] */
            ii(0x1016_97ad, 3); mov(memd[ds, eax + 0xc], ebx);          /* mov [eax+0xc], ebx */
            ii(0x1016_97b0, 2); jmp(0x1016_97bf, 0xd); goto l_0x1016_97bf; /* jmp 0x101697bf */
        l_0x1016_97b2:
            ii(0x1016_97b2, 3); add(ebx, 0x4);                          /* add ebx, 0x4 */
        l_0x1016_97b5:
            ii(0x1016_97b5, 3); mov(ecx, memd[ds, edx + 0x68]);         /* mov ecx, [edx+0x68] */
            ii(0x1016_97b8, 3); cmp(eax, memd[ds, ecx + 0xc]);          /* cmp eax, [ecx+0xc] */
            ii(0x1016_97bb, 2); if(jl(0x1016_9780, -0x3d)) goto l_0x1016_9780; /* jl 0x10169780 */
            ii(0x1016_97bd, 2); jmp(0x1016_97c6, 0x7); goto l_0x1016_97c6; /* jmp 0x101697c6 */
        l_0x1016_97bf:
