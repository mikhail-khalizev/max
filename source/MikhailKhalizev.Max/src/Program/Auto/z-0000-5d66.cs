...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_5d66()
        {
            ...
            ii(0x5d6f, 3);    mov(di, memw[ss, bp + 0x4]);              /* mov di, [bp+0x4] */
            ii(0x5d72, 2);    mov(bx, di);                              /* mov bx, di */
            ii(0x5d74, 3);    mov(cx, memw[ss, bp + 0x8]);              /* mov cx, [bp+0x8] */
            ii(0x5d77, 2);    if(jcxz(0x5d8e, 0x15)) goto l_0x5d8e;     /* jcxz 0x5d8e */
            ii(0x5d79, 3);    mov(al, memb[ss, bp + 0x6]);              /* mov al, [bp+0x6] */
            ii(0x5d7c, 2);    mov(ah, al);                              /* mov ah, al */
            ii(0x5d7e, 4);    test(di, 0x1);                            /* test di, 0x1 */
            ii(0x5d82, 2);    if(jz(0x5d86, 0x2)) goto l_0x5d86;        /* jz 0x5d86 */
