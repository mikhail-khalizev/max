...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_accb()
        {
            ...
            ii(0xad0e, 5);    test(memb[ds, 0x14], 2);                  /* test byte [0x14], 0x2 */
            ...
            ii(0xad20, 3);    mov(bx, 1);                               /* mov bx, 0x1 */
        ...
        l_0xad30:
            ...
            ii(0xad3a, 2);    if(jcxz(0xad3d, 1)) goto l_0xad3d;        /* jcxz 0xad3d */
        ...
        l_0xad46:
            ...
            ii(0xad74, 6);    mov(memw[ds, 0xdee], 4);                  /* mov word [0xdee], 0x4 */
        ...
        l_0xad86:
            ...
            ii(0xada8, 2);    if(jz(0xadac, 2)) goto l_0xadac;          /* jz 0xadac */
        ...
        l_0xadac:
            ...
            ii(0xadbd, 4);    if(jb(0xadc5, 4)) goto l_0xadc5;          /* jb 0xadc5 */
            ii(0xadc1, 2);    cmp(al, 2);                               /* cmp al, 0x2 */
            ii(0xadc3, 2);    if(jnz(0xae16, 0x51)) goto l_0xae16;      /* jnz 0xae16 */
        l_0xadc5:
            ii(0xadc5, 6);    test(memb[ss, 0x14], 0x10);               /* test byte [ss:0x14], 0x10 */
            ii(0xadcb, 2);    if(jnz(0xadd5, 8)) goto l_0xadd5;         /* jnz 0xadd5 */
        ...
        l_0xadd5:
            ...
            ii(0xae0a, 2);    if(jnz(0xae13, 7)) goto l_0xae13;         /* jnz 0xae13 */
        ...
        l_0xae16:
            ...
            ii(0xae1d, 3);    cmp(dx, 4);                               /* cmp dx, 0x4 */
        ...
        l_0xae2d:
            ...
            ii(0xae34, 2);    if(jb(0xae39, 3)) goto l_0xae39;          /* jb 0xae39 */
            ii(0xae36, 3);    mov(memw[ds, 0xecc], ax);                 /* mov [0xecc], ax */
        l_0xae39:
            ii(0xae39, 4);    cmp(dx, 0x300);                           /* cmp dx, 0x300 */
            ii(0xae3d, 2);    if(jbe(0xae44, 5)) goto l_0xae44;         /* jbe 0xae44 */
            ii(0xae3f, 3);    mov(dx, 0x3000);                          /* mov dx, 0x3000 */
            ii(0xae42, 2);    jmp(0xae4a, 6); goto l_0xae4a;            /* jmp 0xae4a */
        l_0xae44:
            ii(0xae44, 3);    shl(dx, 4);                               /* shl dx, 0x4 */
        ...
        l_0xae4a:
            ...
            ii(0xae52, 2);    if(jae(0xae5b, 7)) goto l_0xae5b;         /* jae 0xae5b */
        ...
        l_0xae5b:
            ...
            ii(0xae60, 2);    if(jz(0xae6a, 8)) goto l_0xae6a;          /* jz 0xae6a */
        l_0xae62:
            ii(0xae62, 3);    mov(dx, 0x2000);                          /* mov dx, 0x2000 */
            ii(0xae65, 5);    mov(memb[ds, 0xdff], 1);                  /* mov byte [0xdff], 0x1 */
        l_0xae6a:
            ...
            ii(0xae75, 3);    shl(ax, 4);                               /* shl ax, 0x4 */
