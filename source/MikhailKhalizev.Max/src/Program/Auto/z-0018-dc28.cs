...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_dc28()
        {
            ...
            ii(0x18_dc2d, 4); mov(bp, memw[ss, bx + 0x4]);              /* mov bp, [ss:bx+0x4] */
            ii(0x18_dc31, 4); mov(bx, memw[ss, bx + 0x2]);              /* mov bx, [ss:bx+0x2] */
            ...
            ii(0x18_dc41, 2); push(0x8);                                /* push 0x8 */
        ...
        l_0x18_dc50:
            ...
            ii(0x18_dc5f, 4); test(memb[ss, bp + 0x8], 0x8);            /* test byte [bp+0x8], 0x8 */
            ii(0x18_dc63, 2); if(jz(0x18_dc67, 0x2)) goto l_0x18_dc67;  /* jz 0xdc67 */
            ii(0x18_dc65, 2); mov(cx, cs);                              /* mov cx, cs */
        l_0x18_dc67:
            ii(0x18_dc67, 3); lar(ax, cx);                              /* lar ax, cx */
            ii(0x18_dc6a, 3); and(ah, 0xfe);                            /* and ah, 0xfe */
            ii(0x18_dc6d, 4); mov(memb[es, di + 0x5], ah);              /* mov [es:di+0x5], ah */
