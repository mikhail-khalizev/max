...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x19_e402, 4); enter(0x6, 0);                            /* enter 0x6, 0x0 */
            ii(0x19_e406, 1); push(di);                                 /* push di */
            ii(0x19_e407, 1); push(si);                                 /* push si */
            ii(0x19_e408, 5); mov(memw[ss, bp - 0x2], 0);               /* mov word [bp-0x2], 0x0 */
            ii(0x19_e40d, 3); jmp(0x19_e413, 0x3); goto l_0x19_e413;    /* jmp 0xe413 */
        l_0x19_e410:
            ii(0x19_e410, 3); inc(memw[ss, bp - 0x2]);                  /* inc word [bp-0x2] */
        l_0x19_e413:
            ii(0x19_e413, 4); cmp(memw[ss, bp - 0x2], 0xb);             /* cmp word [bp-0x2], 0xb */
            ii(0x19_e417, 2); if(jl(0x19_e41c, 0x3)) goto l_0x19_e41c;  /* jl 0xe41c */
        ...
        l_0x19_e41c:
            ...
            ii(0x19_e420, 3); mov(bx, memw[ss, bp - 0x2]);              /* mov bx, [bp-0x2] */
            ...
            ii(0x19_e431, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
            ii(0x19_e434, 3); mov(memw[ss, bp - 0x4], dx);              /* mov [bp-0x4], dx */
            ii(0x19_e437, 2); or(dx, ax);                               /* or dx, ax */
            ii(0x19_e439, 2); if(jnz(0x19_e43e, 0x3)) goto l_0x19_e43e; /* jnz 0xe43e */
        ...
        l_0x19_e43e:
            ...
            ii(0x19_e443, 3); cmp(ax, memw[ss, bp - 0x6]);              /* cmp ax, [bp-0x6] */
            ii(0x19_e446, 2); if(jz(0x19_e44b, 0x3)) goto l_0x19_e44b;  /* jz 0xe44b */
            ii(0x19_e448, 3); jmp(0x19_e459, 0xe); goto l_0x19_e459;    /* jmp 0xe459 */
        l_0x19_e44b:
            ii(0x19_e44b, 3); cmp(cx, memw[ss, bp - 0x4]);              /* cmp cx, [bp-0x4] */
            ii(0x19_e44e, 2); if(jz(0x19_e453, 0x3)) goto l_0x19_e453;  /* jz 0xe453 */
            ii(0x19_e450, 3); jmp(0x19_e459, 0x6); goto l_0x19_e459;    /* jmp 0xe459 */
        l_0x19_e453:
            ii(0x19_e453, 3); mov(ax, 0x1);                             /* mov ax, 0x1 */
            ii(0x19_e456, 3); jmp(0x19_e496, 0x3d); goto l_0x19_e496;   /* jmp 0xe496 */
        l_0x19_e459:
            ii(0x19_e459, 3); dec(memw[ss, bp - 0x6]);                  /* dec word [bp-0x6] */
            ii(0x19_e45c, 3); les(bx, memw[ss, bp - 0x6]);              /* les bx, [bp-0x6] */
        ...
        //  ii(0x19_e46f, 3); jmp(0x19_e48d, 0x1b); goto l_0x19_e48d;   /* jmp 0xe48d */
        l_0x19_e472:
            ii(0x19_e472, 3); sub(ax, 0x2f);                            /* sub ax, 0x2f */
            ii(0x19_e475, 2); if(jnz(0x19_e47a, 0x3)) goto l_0x19_e47a; /* jnz 0xe47a */
            ii(0x19_e477, 3); jmp(0x19_e466, -0x14); goto l_0x19_e466;  /* jmp 0xe466 */
        l_0x19_e47a:
            ii(0x19_e47a, 3); sub(ax, 0xb);                             /* sub ax, 0xb */
            ii(0x19_e47d, 2); if(jnz(0x19_e482, 0x3)) goto l_0x19_e482; /* jnz 0xe482 */
            ii(0x19_e47f, 3); jmp(0x19_e466, -0x1c); goto l_0x19_e466;  /* jmp 0xe466 */
        l_0x19_e482:
            ii(0x19_e482, 3); sub(ax, 0x22);                            /* sub ax, 0x22 */
            ii(0x19_e485, 2); if(jnz(0x19_e48a, 0x3)) goto l_0x19_e48a; /* jnz 0xe48a */
