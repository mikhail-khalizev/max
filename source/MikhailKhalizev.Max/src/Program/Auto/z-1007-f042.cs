...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_f042()
        {
            ...
            ii(0x1007_f05a, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_f05d, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x1007_f061, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
