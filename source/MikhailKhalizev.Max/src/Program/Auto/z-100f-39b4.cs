...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("756cce43-d98a-4ff7-b2da-245969412a18")]
        public void Method_100f_39b4()
        {
            ii(0x100f_39b4, 5); pushd(0x3c);                            /* push 0x3c */
            ii(0x100f_39b9, 5); calld(Definitions.sys_check_available_stack_size, 0x72394); /* call 0x10165d52 */
            ...
            ii(0x100f_39f5, 5); calld(Definitions.sys_memcpy, 0x72451); /* call 0x10165e4b */
            ii(0x100f_39fa, 3); mov(eax, memd_a32[ss, ebp - 0xc]);      /* mov eax, [ebp-0xc] */
            ii(0x100f_39fd, 5); calld(Definitions.sys_free, 0x776bf);   /* call 0x1016b0c1 */
            ...
            ii(0x100f_3a18, 5); calld(0x1013_ad71, 0x47354);            /* call 0x1013ad71 */
            ...
            ii(0x100f_3a31, 5); calld(0x1007_6600, -0x7d436);           /* call 0x10076600 */
            ii(0x100f_3a36, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100f_3a38, 5); mov(eax, 0x101c_7278);                  /* mov eax, 0x101c7278 */
            ii(0x100f_3a3d, 5); calld(0x1013_d5c0, 0x49b7e);            /* call 0x1013d5c0 */
        l_0x100f_3a42:
            ii(0x100f_3a42, 5); calld(0x1011_606c, 0x22625);            /* call 0x1011606c */
            ...
            ii(0x100f_3a55, 5); calld(0x1013_9c10, 0x461b6);            /* call 0x10139c10 */
            ...
            ii(0x100f_3a94, 5); calld(0x1010_3ff1, 0x10558);            /* call 0x10103ff1 */
            ii(0x100f_3a99, 5); mov(eax, 0x101c_39b8);                  /* mov eax, 0x101c39b8 */
            ii(0x100f_3a9e, 5); calld(0x1010_380b, 0xfd68);             /* call 0x1010380b */
            ii(0x100f_3aa3, 5); calld(0x100a_8ae1, -0x4afc7);           /* call 0x100a8ae1 */
            ii(0x100f_3aa8, 5); calld(0x1011_fce3, 0x2c236);            /* call 0x1011fce3 */
            ii(0x100f_3aad, 5); mov(eax, 0x101c_3924);                  /* mov eax, 0x101c3924 */
            ii(0x100f_3ab2, 5); calld(0x1013_a6f4, 0x46c3d);            /* call 0x1013a6f4 */
            ...
            ii(0x100f_3ac8, 5); calld(0x1013_8eb6, 0x453e9);            /* call 0x10138eb6 */
            ...
            ii(0x100f_3adf, 5); calld(0x1012_9753, 0x35c6f);            /* call 0x10129753 */
        l_0x100f_3ae4:
        ...
        l_0x100f_3aee:
            ...
            ii(0x100f_3af4, 5); calld(0x100d_533c, -0x1e7bd);           /* call 0x100d533c */
            ii(0x100f_3af9, 1); cwde();                                 /* cwde */
            ii(0x100f_3afa, 1); pushd(eax);                             /* push eax */
            ii(0x100f_3afb, 5); calld(0x100d_5360, -0x1e7a0);           /* call 0x100d5360 */
            ii(0x100f_3b00, 1); cwde();                                 /* cwde */
            ii(0x100f_3b01, 1); pushd(eax);                             /* push eax */
            ii(0x100f_3b02, 5); calld(0x100d_5384, -0x1e783);           /* call 0x100d5384 */
            ...
            ii(0x100f_3b3d, 5); calld(Definitions.sys_display_draw_0, 0x73942); /* call 0x10167484 */
        l_0x100f_3b42:
        ...
        l_0x100f_3b74:
            ...
            ii(0x100f_3b8a, 5); calld(0x1007_5fdc, -0x7dbb3);           /* call 0x10075fdc */
            ...
            ii(0x100f_3bb3, 5); calld(0x1013_cf8e, 0x493d6);            /* call 0x1013cf8e */
        ...
        l_0x100f_3bd5:
            ...
            ii(0x100f_3bdc, 5); calld(0x1013_ad71, 0x47190);            /* call 0x1013ad71 */
            ...
            ii(0x100f_3bea, 5); calld(0x1007_6600, -0x7d5ef);           /* call 0x10076600 */
        ...
        l_0x100f_3bfd:
            ...
            ii(0x100f_3c31, 1); retd(); return;                         /* ret */
        }
    }
}
