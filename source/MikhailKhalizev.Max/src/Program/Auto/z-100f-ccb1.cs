...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_ccb1()
        {
            ...
            ii(0x100f_ccc9, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100f_cccc, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x100f_ccd3, 2); jmp(0x100f_ccdb, 0x6); goto l_0x100f_ccdb; /* jmp 0x100fccdb */
        l_0x100f_ccd5:
            ii(0x100f_ccd5, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_ccd8, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x100f_ccdb:
            ii(0x100f_ccdb, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100f_cceb, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x100f_ccf2, 2); jmp(0x100f_ccfa, 0x6); goto l_0x100f_ccfa; /* jmp 0x100fccfa */
        l_0x100f_ccf4:
            ii(0x100f_ccf4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_ccf7, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x100f_ccfa:
            ii(0x100f_ccfa, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100f_cd0a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_cd0d, 1); dec(eax);                               /* dec eax */
            ii(0x100f_cd0e, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x100f_cd11, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_cd14, 1); dec(eax);                               /* dec eax */
            ii(0x100f_cd15, 1); cwde();                                 /* cwde */
            ii(0x100f_cd16, 5); call(0x100f_c58b, -0x790);              /* call 0x100fc58b */
            ii(0x100f_cd1b, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ii(0x100f_cd1f, 2); if(jge(0x100f_cd35, 0x14)) goto l_0x100f_cd35; /* jge 0x100fcd35 */
            ii(0x100f_cd21, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100f_cd25, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_cd28, 1); dec(eax);                               /* dec eax */
            ii(0x100f_cd29, 1); cwde();                                 /* cwde */
            ii(0x100f_cd2a, 5); call(0x100f_c58b, -0x7a4);              /* call 0x100fc58b */
            ii(0x100f_cd2f, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ii(0x100f_cd33, 2); if(jl(0x100f_cd37, 0x2)) goto l_0x100f_cd37; /* jl 0x100fcd37 */
        l_0x100f_cd35:
            ii(0x100f_cd35, 2); jmp(0x100f_cd4d, 0x16); goto l_0x100f_cd4d; /* jmp 0x100fcd4d */
        l_0x100f_cd37:
            ii(0x100f_cd37, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_cd3a, 1); dec(eax);                               /* dec eax */
            ii(0x100f_cd3b, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x100f_cd3e, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x100f_cd42, 5); call(0x100f_c58b, -0x7bc);              /* call 0x100fc58b */
            ii(0x100f_cd47, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ii(0x100f_cd4b, 2); if(jl(0x100f_cd4f, 0x2)) goto l_0x100f_cd4f; /* jl 0x100fcd4f */
        l_0x100f_cd4d:
            ii(0x100f_cd4d, 2); jmp(0x100f_cd62, 0x13); goto l_0x100f_cd62; /* jmp 0x100fcd62 */
        l_0x100f_cd4f:
            ii(0x100f_cd4f, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100f_cd53, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x100f_cd57, 5); call(0x100f_c58b, -0x7d1);              /* call 0x100fc58b */
            ii(0x100f_cd5c, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ii(0x100f_cd60, 2); if(jl(0x100f_cd64, 0x2)) goto l_0x100f_cd64; /* jl 0x100fcd64 */
        l_0x100f_cd62:
            ii(0x100f_cd62, 2); jmp(0x100f_cd89, 0x25); goto l_0x100f_cd89; /* jmp 0x100fcd89 */
        l_0x100f_cd64:
            ii(0x100f_cd64, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x100f_cd74, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
