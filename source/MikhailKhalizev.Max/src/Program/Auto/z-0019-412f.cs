...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_412f()
        {
            ...
            ii(0x19_4135, 3); mov(ax, memw[ss, bp + 6]);                /* mov ax, [bp+0x6] */
            ii(0x19_4138, 3); lds(bx, memw[ss, bp + 8]);                /* lds bx, [bp+0x8] */
            ii(0x19_413b, 3); mov(cx, memw[ds, bx + 16]);               /* mov cx, [bx+0x10] */
            ii(0x19_413e, 3); mov(dx, memw[ds, bx + 14]);               /* mov dx, [bx+0xe] */
            ii(0x19_4141, 3); mov(si, memw[ds, bx + 6]);                /* mov si, [bx+0x6] */
            ii(0x19_4144, 3); mov(di, memw[ds, bx + 4]);                /* mov di, [bx+0x4] */
            ii(0x19_4147, 3); mov(cx, memw[ds, bx + 2]);                /* mov cx, [bx+0x2] */
            ...
            ii(0x19_4155, 3); mov(ax, memw[ss, bp + 6]);                /* mov ax, [bp+0x6] */
            ii(0x19_4158, 3); mov(cx, memw[ds, bx + 16]);               /* mov cx, [bx+0x10] */
            ii(0x19_415b, 3); mov(bx, memw[ds, bx + 12]);               /* mov bx, [bx+0xc] */
            ii(0x19_415e, 1); pop(ds);                                  /* pop ds */
            ii(0x19_415f, 2); @int(0x21);                               /* int 0x21 */
            ii(0x19_4161, 1); push(bx);                                 /* push bx */
            ii(0x19_4162, 1); push(ds);                                 /* push ds */
            ii(0x19_4163, 3); lds(bx, memw[ss, bp + 8]);                /* lds bx, [bp+0x8] */
            ...
            ii(0x19_4171, 3); mov(memw[ds, bx + 14], dx);               /* mov [bx+0xe], dx */
            ii(0x19_4174, 3); mov(memw[ds, bx + 16], cx);               /* mov [bx+0x10], cx */
            ii(0x19_4177, 3); pop(memw[ds, bx + 12]);                   /* pop word [bx+0xc] */
            ii(0x19_417a, 3); mov(memw[ds, bx + 18], ax);               /* mov [bx+0x12], ax */
