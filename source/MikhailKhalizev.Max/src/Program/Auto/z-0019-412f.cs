...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("441f2207-9a1e-4a89-8059-f511fc39f0d6")]
        public void Method_0019_412f()
        {
            ii(0x19_412f, 1); pushw(bp);                                /* push bp */
            ii(0x19_4130, 2); mov(bp, sp);                              /* mov bp, sp */
            ii(0x19_4132, 1); pushw(si);                                /* push si */
            ii(0x19_4133, 1); pushw(di);                                /* push di */
            ii(0x19_4134, 1); pushw(ds);                                /* push ds */
            ii(0x19_4135, 3); mov(ax, memw_a16[ss, bp + 0x6]);          /* mov ax, [bp+0x6] */
            ii(0x19_4138, 3); lds(bx, ss, bp + 0x8);                    /* lds bx, [bp+0x8] */
            ii(0x19_413b, 3); mov(cx, memw_a16[ds, bx + 0x10]);         /* mov cx, [bx+0x10] */
            ii(0x19_413e, 3); mov(dx, memw_a16[ds, bx + 0xe]);          /* mov dx, [bx+0xe] */
            ii(0x19_4141, 3); mov(si, memw_a16[ds, bx + 0x6]);          /* mov si, [bx+0x6] */
            ii(0x19_4144, 3); mov(di, memw_a16[ds, bx + 0x4]);          /* mov di, [bx+0x4] */
            ii(0x19_4147, 3); mov(cx, memw_a16[ds, bx + 0x2]);          /* mov cx, [bx+0x2] */
            ii(0x19_414a, 3); callw(0x19_40cc, -0x81);                  /* call 0x40cc */
            ii(0x19_414d, 2); mov(es, cx);                              /* mov es, cx */
            ii(0x19_414f, 2); mov(cx, memw_a16[ds, bx]);                /* mov cx, [bx] */
            ii(0x19_4151, 3); callw(0x19_40cc, -0x88);                  /* call 0x40cc */
            ii(0x19_4154, 1); pushw(cx);                                /* push cx */
            ii(0x19_4155, 3); mov(ax, memw_a16[ss, bp + 0x6]);          /* mov ax, [bp+0x6] */
            ii(0x19_4158, 3); mov(cx, memw_a16[ds, bx + 0x10]);         /* mov cx, [bx+0x10] */
            ii(0x19_415b, 3); mov(bx, memw_a16[ds, bx + 0xc]);          /* mov bx, [bx+0xc] */
            ii(0x19_415e, 1); popw(ds);                                 /* pop ds */
