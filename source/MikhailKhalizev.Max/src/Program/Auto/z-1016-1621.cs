...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_1621()
        {
            ...
            ii(0x1016_1639, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1016_163c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_163f, 4); test(memb[ds, eax + 0x12], 0x1);        /* test byte [eax+0x12], 0x1 */
            ii(0x1016_1643, 2); if(jz(0x1016_1654, 0xf)) goto l_0x1016_1654; /* jz 0x10161654 */
            ii(0x1016_1645, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x1016_1654:
            ii(0x1016_1654, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_1657, 6); test(memw[ds, eax + 0x12], 0x180);      /* test word [eax+0x12], 0x180 */
            ii(0x1016_165d, 2); if(jz(0x1016_166e, 0xf)) goto l_0x1016_166e; /* jz 0x1016166e */
            ii(0x1016_165f, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x1016_166e:
            ii(0x1016_166e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_1671, 4); test(memb[ds, eax + 0x13], 0x2);        /* test byte [eax+0x13], 0x2 */
            ii(0x1016_1675, 2); if(jz(0x1016_1686, 0xf)) goto l_0x1016_1686; /* jz 0x10161686 */
            ii(0x1016_1677, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x1016_1686:
            ii(0x1016_1686, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_1689, 4); test(memb[ds, eax + 0x12], 0x40);       /* test byte [eax+0x12], 0x40 */
            ii(0x1016_168d, 2); if(jz(0x1016_169e, 0xf)) goto l_0x1016_169e; /* jz 0x1016169e */
            ii(0x1016_168f, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x1016_169e:
            ii(0x1016_169e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_16a1, 4); test(memb[ds, eax + 0x12], 0x20);       /* test byte [eax+0x12], 0x20 */
            ii(0x1016_16a5, 2); if(jz(0x1016_16b4, 0xd)) goto l_0x1016_16b4; /* jz 0x101616b4 */
            ii(0x1016_16a7, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
