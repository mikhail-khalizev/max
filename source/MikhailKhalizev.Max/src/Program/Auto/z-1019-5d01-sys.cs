...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_5d01()
        {
            ...
            ii(0x1019_5d11, 3); mov(esi, memd[ds, eax + 0x4]);          /* mov esi, [eax+0x4] */
            ii(0x1019_5d14, 3); mov(ebp, memd[ds, edi - 0x8]);          /* mov ebp, [edi-0x8] */
        l_0x1019_5d17:
            ...
            ii(0x1019_5d2b, 3); mov(edx, memd[ds, ecx + 0x4]);          /* mov edx, [ecx+0x4] */
            ii(0x1019_5d2e, 3); cmp(edx, memd[ds, ecx + 0x9]);          /* cmp edx, [ecx+0x9] */
            ...
            ii(0x1019_5d3c, 3); mov(ebx, memd[ds, eax + 0x4]);          /* mov ebx, [eax+0x4] */
            ...
            ii(0x1019_5d52, 2); if(jbe(0x1019_5d5c, 0x8)) goto l_0x1019_5d5c; /* jbe 0x10195d5c */
        ...
        l_0x1019_5d5c:
            ...
            ii(0x1019_5d5e, 3); mov(edx, memd[ds, ebx + 0x2]);          /* mov edx, [ebx+0x2] */
            ii(0x1019_5d61, 5); call(/* sys */ 0x1019_b4cc, 0x5766);    /* call 0x1019b4cc */
            ii(0x1019_5d66, 2); test(al, al);                           /* test al, al */
            ii(0x1019_5d68, 2); if(jz(0x1019_5d6f, 0x5)) goto l_0x1019_5d6f; /* jz 0x10195d6f */
            ii(0x1019_5d6a, 3); mov(esi, memd[ds, ebx + 0x6]);          /* mov esi, [ebx+0x6] */
        ...
        l_0x1019_5d74:
            ii(0x1019_5d74, 3); mov(esi, memd[ds, ebx + 0x2]);          /* mov esi, [ebx+0x2] */
        ...
        l_0x1019_5d79:
            ...
            ii(0x1019_5d7e, 2); jmp(0x1019_5d88, 0x8); goto l_0x1019_5d88; /* jmp 0x10195d88 */
        l_0x1019_5d80:
        ...
        l_0x1019_5d88:
            ...
            ii(0x1019_5d8b, 3); mov(memd[ds, ecx + 0x4], esi);          /* mov [ecx+0x4], esi */
