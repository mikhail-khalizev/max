...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_8573()
        {
            ...
            ii(0x100d_858a, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_858d, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_8590, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_8593, 3); mov(ecx, memd[ds, eax + 0xd]);          /* mov ecx, [eax+0xd] */
            ii(0x100d_8596, 3); sar(ecx, 0x10);                         /* sar ecx, 0x10 */
            ii(0x100d_8599, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_859c, 3); mov(ebx, memd[ds, eax + 0x1d]);         /* mov ebx, [eax+0x1d] */
            ii(0x100d_859f, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100d_85a2, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x100d_85a6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_85a9, 3); mov(eax, memd[ds, eax + 0xb]);          /* mov eax, [eax+0xb] */
            ii(0x100d_85ac, 3); sar(eax, 0x18);                         /* sar eax, 0x18 */
            ii(0x100d_85af, 5); call(0x100d_8248, -0x36c);              /* call 0x100d8248 */
            ii(0x100d_85b4, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100d_85b7, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
