...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_f19e()
        {
            ...
            ii(0x1009_f1b5, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_f1b8, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1009_f1bb, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1009_f1be, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_f1c1, 5); call(0x1015_2a52, 0xb_388c);            /* call 0x10152a52 */
            ii(0x1009_f1c6, 2); test(al, al);                           /* test al, al */
            ii(0x1009_f1c8, 2); if(jnz(0x1009_f1d0, 0x6)) goto l_0x1009_f1d0; /* jnz 0x1009f1d0 */
            ii(0x1009_f1ca, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
            ii(0x1009_f1ce, 2); jmp(0x1009_f1f9, 0x29); goto l_0x1009_f1f9; /* jmp 0x1009f1f9 */
        l_0x1009_f1d0:
            ii(0x1009_f1d0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_f1d3, 3); mov(al, memb[ds, eax + 0x4e]);          /* mov al, [eax+0x4e] */
            ii(0x1009_f1d6, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x1009_f1db, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1009_f1dd, 2); if(jnz(0x1009_f1e5, 0x6)) goto l_0x1009_f1e5; /* jnz 0x1009f1e5 */
            ii(0x1009_f1df, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
            ii(0x1009_f1e3, 2); jmp(0x1009_f1f9, 0x14); goto l_0x1009_f1f9; /* jmp 0x1009f1f9 */
        l_0x1009_f1e5:
            ii(0x1009_f1e5, 5); mov(ebx, 0x1);                          /* mov ebx, 0x1 */
            ii(0x1009_f1ea, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_f1ed, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_f1f0, 5); call(0x1009_d066, -0x218f);             /* call 0x1009d066 */
            ii(0x1009_f1f5, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
        l_0x1009_f1f9:
            ii(0x1009_f1f9, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
