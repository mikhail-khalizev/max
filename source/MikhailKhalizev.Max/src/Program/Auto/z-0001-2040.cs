...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x1_2040, 6);  movzx(ebx, memw_a32[ss, ebp + 20]);      /* movzx ebx, word [ebp+0x14] */
            ii(0x1_2046, 3);  mov(ax, 8);                              /* mov ax, 0x8 */
            ii(0x1_2049, 2);  mov(ds, ax);                             /* mov ds, ax */
            ii(0x1_204b, 4);  cmp(bx, memw[ds, 8]);                    /* cmp bx, [0x8] */
            ii(0x1_204f, 2);  if(jae_func(0x1_2032, -0x1f)) return;    /* jae 0x2032 */
            ii(0x1_2051, 3);  and(bx, -8 /* 0xf8 */);                  /* and bx, 0xfff8 */
            ii(0x1_2054, 2);  if(jz_func(0x1_2032, -0x24)) return;     /* jz 0x2032 */
            ii(0x1_2056, 2);  xor(cx, cx);                             /* xor cx, cx */
            ii(0x1_2058, 3);  mov(cl, memb[ds, bx + 5]);               /* mov cl, [bx+0x5] */
            ...
            ii(0x1_2067, 3);  shr(si, 3);                              /* shr si, 0x3 */
            ...
            ii(0x1_2073, 2);  if(jz(0x1_2077, 2)) goto l_0x1_2077;     /* jz 0x2077 */
        l_0x1_2075:
