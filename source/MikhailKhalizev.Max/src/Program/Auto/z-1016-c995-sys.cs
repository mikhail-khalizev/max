...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("9fe2ad5c-d3f4-4aef-8fe1-80620287d0b2")]
        public void /* sys */ Method_1016_c995()
        {
            ii(0x1016_c995, 1); pushd(edx);                             /* push edx */
            ii(0x1016_c996, 1); pushd(eax);                             /* push eax */
            ...
            ii(0x1016_c9a5, 1); popd(edx);                              /* pop edx */
            ii(0x1016_c9a6, 2); mov(esi, edx);                          /* mov esi, edx */
            ii(0x1016_c9a8, 1); cld();                                  /* cld */
        l_0x1016_c9a9:
            ii(0x1016_c9a9, 1); lodsb_a32();                            /* lodsb */
            ii(0x1016_c9aa, 2); cmp(al, 0);                             /* cmp al, 0x0 */
            ii(0x1016_c9ac, 2); if(jnzd(0x1016_c9a9, -0x5)) goto l_0x1016_c9a9; /* jnz 0x1016c9a9 */
            ...
            ii(0x1016_c9b7, 1); popd(eax);                              /* pop eax */
        }
    }
}
