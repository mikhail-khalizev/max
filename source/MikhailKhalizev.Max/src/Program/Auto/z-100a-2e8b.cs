...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_2e8b()
        {
            ...
            ii(0x100a_2ea3, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_2ea6, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x100a_2eaa, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
