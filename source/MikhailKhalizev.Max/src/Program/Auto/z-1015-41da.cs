...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_41da()
        {
            ...
            ii(0x1015_41f2, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_41f5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_41f8, 3); mov(al, memb[ds, eax + 0x5e]);          /* mov al, [eax+0x5e] */
            ...
            ii(0x1015_4209, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_420c, 5); call(0x1007_6d98, -0xd_d479);           /* call 0x10076d98 */
            ii(0x1015_4211, 2); test(al, al);                           /* test al, al */
            ii(0x1015_4213, 2); if(jnz(0x1015_4217, 0x2)) goto l_0x1015_4217; /* jnz 0x10154217 */
        l_0x1015_4215:
        ...
        l_0x1015_4217:
            ...
            ii(0x1015_4225, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1015_4228, 5); mov(eax, 0x101c_7278);                  /* mov eax, 0x101c7278 */
            ii(0x1015_422d, 5); call(0x1013_d5c0, -0x1_6c72);           /* call 0x1013d5c0 */
        l_0x1015_4232:
            ii(0x1015_4232, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_4235, 5); call(0x1014_9fa8, -0xa292);             /* call 0x10149fa8 */
            ii(0x1015_423a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_423d, 3); mov(dl, memb[ds, eax + 0x5e]);          /* mov dl, [eax+0x5e] */
            ii(0x1015_4240, 2); inc(dl);                                /* inc dl */
            ii(0x1015_4242, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_4245, 3); and(dl, 0x3f);                          /* and dl, 0x3f */
            ii(0x1015_4248, 3); mov(memb[ds, eax + 0x5e], dl);          /* mov [eax+0x5e], dl */
            ii(0x1015_424b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_424e, 3); mov(al, memb[ds, eax + 0x5e]);          /* mov al, [eax+0x5e] */
            ...
            ii(0x1015_425b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_425e, 8); sub(memw[ds, eax + 0xd9], 0x10);        /* sub word [eax+0xd9], 0x10 */
            ii(0x1015_4266, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_4269, 8); sub(memw[ds, eax + 0xdb], 0x10);        /* sub word [eax+0xdb], 0x10 */
            ii(0x1015_4271, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_4274, 5); call(0x1014_9cd1, -0xa5a8);             /* call 0x10149cd1 */
            ii(0x1015_4279, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_427c, 5); call(0x1014_9fa8, -0xa2d9);             /* call 0x10149fa8 */
            ii(0x1015_4281, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x1015_4285, 2); jmp(0x1015_4292, 0xb); goto l_0x1015_4292; /* jmp 0x10154292 */
        l_0x1015_4287:
            ii(0x1015_4287, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_428a, 4); or(memb[ds, eax + 0x14], 0x1);          /* or byte [eax+0x14], 0x1 */
            ii(0x1015_428e, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
        l_0x1015_4292:
            ii(0x1015_4292, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
