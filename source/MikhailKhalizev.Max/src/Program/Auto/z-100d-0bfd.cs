...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_0bfd()
        {
            ...
            ii(0x100d_0c14, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_0c17, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_0c1a, 7); test(memd[ss, ebp - 0x4], 0x4);         /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x100d_0c28, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_0c37:
            ii(0x100d_0c37, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_0c3a, 7); mov(memd[ds, eax + 0x40], 0x101b_5ca4); /* mov dword [eax+0x40], 0x101b5ca4 */
            ii(0x100d_0c41, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_0c44, 3); mov(eax, memd[ds, eax + 0x44]);         /* mov eax, [eax+0x44] */
            ii(0x100d_0c47, 5); call(Definitions.sys_free, 0x9_a475);   /* call 0x1016b0c1 */
            ii(0x100d_0c4c, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x100d_0c51, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_0c54, 5); call(0x100d_00b2, -0xba7);              /* call 0x100d00b2 */
            ii(0x100d_0c59, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_0c5c, 7); test(memd[ss, ebp - 0x4], 0x2);         /* test dword [ebp-0x4], 0x2 */
            ii(0x100d_0c63, 2); if(jz(0x100d_0c6d, 0x8)) goto l_0x100d_0c6d; /* jz 0x100d0c6d */
            ii(0x100d_0c65, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_0c68, 5); call(Definitions.sys_delete, 0x9_52f7); /* call 0x10165f64 */
        l_0x100d_0c6d:
            ii(0x100d_0c6d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_0c70, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100d_0c73, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
