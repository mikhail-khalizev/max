...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_4d7e()
        {
            ...
            ii(0x1019_4d85, 2); push(fs);                               /* push fs */
            ii(0x1019_4d87, 2); push(gs);                               /* push gs */
            ii(0x1019_4d89, 1); push(es);                               /* push es */
            ...
            ii(0x1019_4dcc, 1); pop(es);                                /* pop es */
            ii(0x1019_4dcd, 2); pop(gs);                                /* pop gs */
            ii(0x1019_4dcf, 2); pop(fs);                                /* pop fs */
