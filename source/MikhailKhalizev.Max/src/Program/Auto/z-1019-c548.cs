...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1019_c548()
        {
            ...
            ii(0x1019_c54d, 4); mov(ebx, memd[ss, esp + 0x1c]);         /* mov ebx, [esp+0x1c] */
            ii(0x1019_c551, 4); mov(eax, memd[ss, esp + 0x14]);         /* mov eax, [esp+0x14] */
            ii(0x1019_c555, 3); mov(memd[ss, esp], eax);                /* mov [esp], eax */
            ii(0x1019_c558, 4); mov(eax, memd[ss, esp + 0x18]);         /* mov eax, [esp+0x18] */
            ii(0x1019_c55c, 4); mov(memd[ss, esp + 0x4], eax);          /* mov [esp+0x4], eax */
            ii(0x1019_c560, 4); mov(eax, memd[ss, esp + 0x6]);          /* mov eax, [esp+0x6] */
            ...
            ii(0x1019_c575, 4); mov(edx, memd[ss, esp + 0x6]);          /* mov edx, [esp+0x6] */
            ...
            ii(0x1019_c586, 2); if(jz(0x1019_c58e, 0x6)) goto l_0x1019_c58e; /* jz 0x1019c58e */
            ii(0x1019_c588, 3); lea(eax, memd[ds, ebx + 0x1]);          /* lea eax, [ebx+0x1] */
        ...
        l_0x1019_c58e:
            ...
            ii(0x1019_c592, 5); mov(bx, memw[ss, esp + 0x2]);           /* mov bx, [esp+0x2] */
            ...
            ii(0x1019_c59f, 5); mov(dx, memw[ss, esp + 0x4]);           /* mov dx, [esp+0x4] */
            ii(0x1019_c5a4, 2); or(edx, ebx);                           /* or edx, ebx */
            ii(0x1019_c5a6, 4); mov(ebx, memd[ss, esp + 0x6]);          /* mov ebx, [esp+0x6] */
            ...
            ii(0x1019_c5b7, 2); if(jnz(0x1019_c5c1, 0x8)) goto l_0x1019_c5c1; /* jnz 0x1019c5c1 */
            ii(0x1019_c5b9, 6); mov(edx, memd[ds, 0x101b_3848]);        /* mov edx, [0x101b3848] */
            ii(0x1019_c5bf, 2); jmp(0x1019_c5c7, 0x6); goto l_0x1019_c5c7; /* jmp 0x1019c5c7 */
        l_0x1019_c5c1:
        ...
        l_0x1019_c5c7:
            ...
            ii(0x1019_c5ce, 2); jmp(0x1019_c5d2, 0x2); goto l_0x1019_c5d2; /* jmp 0x1019c5d2 */
        l_0x1019_c5d0:
