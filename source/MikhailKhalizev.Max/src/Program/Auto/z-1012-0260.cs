...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_0260()
        {
            ...
            ii(0x1012_0277, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1012_027a, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1012_027d, 7); test(memd[ss, ebp - 4], 4);             /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x1012_028b, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
        ...
        l_0x1012_029a:
            ii(0x1012_029a, 5); mov(edx, 1);                            /* mov edx, 0x1 */
            ii(0x1012_029f, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1012_02a2, 5); call(0x1013_ab27, 0x1_a880);            /* call 0x1013ab27 */
            ii(0x1012_02a7, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1012_02aa, 7); test(memd[ss, ebp - 4], 2);             /* test dword [ebp-0x4], 0x2 */
            ii(0x1012_02b1, 2); if(jz(0x1012_02bb, 8)) goto l_0x1012_02bb; /* jz 0x101202bb */
            ii(0x1012_02b3, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
