...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_a4a1()
        {
            ...
            ii(0x1010_a4c9, 7); mov(memd[ss, ebp - 0xc], 6);            /* mov dword [ebp-0xc], 0x6 */
        l_0x1010_a4d0:
            ii(0x1010_a4d0, 3); dec(memd[ss, ebp - 0xc]);               /* dec dword [ebp-0xc] */
            ii(0x1010_a4d3, 5); cmp(memw[ss, ebp - 0xc], -1 /* 0xff */); /* cmp word [ebp-0xc], 0xffff */
        ...
        l_0x1010_a50a:
            ...
            ii(0x1010_a517, 7); mov(memd[ss, ebp - 0xc], 6);            /* mov dword [ebp-0xc], 0x6 */
        l_0x1010_a51e:
            ii(0x1010_a51e, 3); dec(memd[ss, ebp - 0xc]);               /* dec dword [ebp-0xc] */
            ii(0x1010_a521, 5); cmp(memw[ss, ebp - 0xc], -1 /* 0xff */); /* cmp word [ebp-0xc], 0xffff */
