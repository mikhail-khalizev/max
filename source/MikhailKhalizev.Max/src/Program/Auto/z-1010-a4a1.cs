...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_a4a1()
        {
            ...
            ii(0x1010_a4b9, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_a4bc, 5); mov(edx, 0x4);                          /* mov edx, 0x4 */
            ii(0x1010_a4c1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_a4c4, 5); call(0x1010_a26b, -0x25e);              /* call 0x1010a26b */
            ii(0x1010_a4c9, 7); mov(memd[ss, ebp - 0xc], 0x6);          /* mov dword [ebp-0xc], 0x6 */
        l_0x1010_a4d0:
            ii(0x1010_a4d0, 3); dec(memd[ss, ebp - 0xc]);               /* dec dword [ebp-0xc] */
            ii(0x1010_a4d3, 5); cmp(memw[ss, ebp - 0xc], -0x1 /* 0xff */); /* cmp word [ebp-0xc], 0xffff */
            ...
            ii(0x1010_a4e3, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1010_a4e6, 5); call(0x1011_52c8, 0xaddd);              /* call 0x101152c8 */
            ii(0x1010_a4eb, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x1010_a4ed, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1010_a4fe, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1010_a50a:
            ...
            ii(0x1010_a514, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_a517, 7); mov(memd[ss, ebp - 0xc], 0x6);          /* mov dword [ebp-0xc], 0x6 */
        l_0x1010_a51e:
            ii(0x1010_a51e, 3); dec(memd[ss, ebp - 0xc]);               /* dec dword [ebp-0xc] */
            ii(0x1010_a521, 5); cmp(memw[ss, ebp - 0xc], -0x1 /* 0xff */); /* cmp word [ebp-0xc], 0xffff */
            ii(0x1010_a526, 2); if(jz(0x1010_a545, 0x1d)) goto l_0x1010_a545; /* jz 0x1010a545 */
            ii(0x1010_a528, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
