...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_b05e()
        {
            ...
            ii(0x1010_b076, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_b079, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_b07c, 3); mov(edx, memd[ds, eax + 0xd]);          /* mov edx, [eax+0xd] */
            ii(0x1010_b07f, 5); mov(eax, 0x4c);                         /* mov eax, 0x4c */
            ii(0x1010_b084, 5); call(0x100c_aafc, -0x4_058d);           /* call 0x100caafc */
            ii(0x1010_b089, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_b08c, 5); call(0x1010_a3fc, -0xc95);              /* call 0x1010a3fc */
            ii(0x1010_b091, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_b094, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1010_b096, 3); mov(eax, memd[ds, eax + 0x12]);         /* mov eax, [eax+0x12] */
