...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_40b6()
        {
            ...
            ii(0x1010_40cd, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_40d0, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1010_40d3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_40d6, 5); call(0x1010_3ff1, -0xea);               /* call 0x10103ff1 */
            ii(0x1010_40db, 3); lea(edx, memd[ss, ebp - 0xc]);          /* lea edx, [ebp-0xc] */
            ii(0x1010_40de, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_40e1, 5); call(0x1013_bb7b, 0x3_7a95);            /* call 0x1013bb7b */
            ii(0x1010_40e6, 5); mov(eax, 0x101b_56fc);                  /* mov eax, 0x101b56fc */
            ii(0x1010_40eb, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1010_40ee, 3); mov(ebx, memd[ds, edx + 0x2]);          /* mov ebx, [edx+0x2] */
            ...
            ii(0x1010_40ff, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1010_4102, 4); mov(memw[ss, ebp - 0x10], ax);          /* mov [ebp-0x10], ax */
            ii(0x1010_4106, 5); mov(ebx, 0x101b_56fc);                  /* mov ebx, 0x101b56fc */
            ii(0x1010_410b, 3); mov(edx, memd[ss, ebp - 0x12]);         /* mov edx, [ebp-0x12] */
            ii(0x1010_410e, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1010_4111, 3); mov(eax, memd[ss, ebp - 0x12]);         /* mov eax, [ebp-0x12] */
            ...
            ii(0x1010_4127, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1010_412a, 3); mov(memd[ds, edx + 0x2], eax);          /* mov [edx+0x2], eax */
            ii(0x1010_412d, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1010_4130, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1010_4133, 3); mov(memw[ds, edx], ax);                 /* mov [edx], ax */
            ii(0x1010_4136, 7); mov(memd[ss, ebp - 0x14], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x1010_413d, 2); jmp(0x1010_4145, 0x6); goto l_0x1010_4145; /* jmp 0x10104145 */
        l_0x1010_413f:
            ii(0x1010_413f, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1010_4142, 3); inc(memd[ss, ebp - 0x14]);              /* inc dword [ebp-0x14] */
        l_0x1010_4145:
            ii(0x1010_4145, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1010_4148, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1010_414b, 3); cmp(ax, memw[ds, edx]);                 /* cmp ax, [edx] */
            ii(0x1010_414e, 2); if(jge(0x1010_4169, 0x19)) goto l_0x1010_4169; /* jge 0x10104169 */
            ii(0x1010_4150, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1010_4153, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1010_4157, 3); imul(ebx, eax, 0xa);                    /* imul ebx, eax, 0xa */
            ii(0x1010_415a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_415d, 3); mov(eax, memd[ds, eax + 0x2]);          /* mov eax, [eax+0x2] */
