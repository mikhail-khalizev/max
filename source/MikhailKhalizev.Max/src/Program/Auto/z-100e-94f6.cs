...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_94f6()
        {
            ...
            ii(0x100e_950e, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100e_9511, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x100e_9518, 2); jmp(0x100e_9520, 0x6); goto l_0x100e_9520; /* jmp 0x100e9520 */
        l_0x100e_951a:
            ii(0x100e_951a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_951d, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x100e_9520:
            ii(0x100e_9520, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_9523, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100e_9526, 4); cmp(ax, memw[ds, edx + 0x2]);           /* cmp ax, [edx+0x2] */
            ii(0x100e_952a, 2); if(jge(0x100e_9546, 0x1a)) goto l_0x100e_9546; /* jge 0x100e9546 */
            ii(0x100e_952c, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100e_9530, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100e_9533, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100e_9535, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_9538, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
        ...
        l_0x100e_9546:
            ii(0x100e_9546, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_9549, 4); cmp(memd[ds, eax + 0x4], 0);            /* cmp dword [eax+0x4], 0x0 */
            ii(0x100e_954d, 2); if(jz(0x100e_955a, 0xb)) goto l_0x100e_955a; /* jz 0x100e955a */
            ii(0x100e_954f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_9552, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
            ii(0x100e_9555, 5); call(Definitions.sys_delete, 0x7_ca0a); /* call 0x10165f64 */
        l_0x100e_955a:
            ii(0x100e_955a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_955d, 7); mov(memd[ds, eax + 0x4], 0);            /* mov dword [eax+0x4], 0x0 */
            ii(0x100e_9564, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_9567, 6); mov(memw[ds, eax + 0x2], 0);            /* mov word [eax+0x2], 0x0 */
            ii(0x100e_956d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
