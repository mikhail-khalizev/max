...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_287d()
        {
            ...
            ii(0x1015_2895, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_2898, 4); or(memb[ss, ebp - 0x8], 0x1);           /* or byte [ebp-0x8], 0x1 */
            ii(0x1015_289c, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_289f, 5); call(0x1009_ca70, -0xb_5e34);           /* call 0x1009ca70 */
            ii(0x1015_28a4, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1015_28a7, 4); and(memb[ss, ebp - 0x8], -0x2 /* 0xfe */); /* and byte [ebp-0x8], 0xfe */
            ii(0x1015_28ab, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_28ba, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1015_28bd, 5); call(0x1008_ae70, -0xc_7a52);           /* call 0x1008ae70 */
            ii(0x1015_28c2, 2); jmp(0x1015_28cc, 0x8); goto l_0x1015_28cc; /* jmp 0x101528cc */
        l_0x1015_28c4:
            ii(0x1015_28c4, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1015_28c7, 5); call(0x1007_6bf8, -0xd_bcd4);           /* call 0x10076bf8 */
        l_0x1015_28cc:
            ii(0x1015_28cc, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_28ce, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ...
            ii(0x1015_28da, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1015_28dd, 5); call(0x1008_adf8, -0xc_7aea);           /* call 0x1008adf8 */
            ii(0x1015_28e2, 3); lea(ebx, memd[ss, ebp - 0x1c]);         /* lea ebx, [ebp-0x1c] */
        ...
        l_0x1015_28f0:
            ii(0x1015_28f0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_28f3, 5); add(eax, 0x8a);                         /* add eax, 0x8a */
            ii(0x1015_28f8, 5); call(0x1013_a6f4, -0x1_8209);           /* call 0x1013a6f4 */
            ii(0x1015_28fd, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_2900, 5); call(0x1008_aef4, -0xc_7a11);           /* call 0x1008aef4 */
            ii(0x1015_2905, 3); lea(ebx, memd[ss, ebp - 0xc]);          /* lea ebx, [ebp-0xc] */
            ...
            ii(0x1015_2911, 2); jmp(0x1015_291b, 0x8); goto l_0x1015_291b; /* jmp 0x1015291b */
        l_0x1015_2913:
            ii(0x1015_2913, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1015_2916, 5); call(0x1007_6bf8, -0xd_bd23);           /* call 0x10076bf8 */
        l_0x1015_291b:
            ii(0x1015_291b, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_291d, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ...
            ii(0x1015_2929, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1015_292c, 5); call(0x1008_adc4, -0xc_7b6d);           /* call 0x1008adc4 */
            ii(0x1015_2931, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1015_2934, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1015_2937, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x1015_293a, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1015_293d, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1015_2940, 3); call_abs(memd[ds, ebx + 0x54]);         /* call dword [ebx+0x54] */
            ii(0x1015_2943, 2); jmp(0x1015_2913, -0x32); goto l_0x1015_2913; /* jmp 0x10152913 */
        l_0x1015_2945:
            ii(0x1015_2945, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_2947, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1015_294a, 5); call(0x1008_8bbc, -0xc_9d93);           /* call 0x10088bbc */
            ii(0x1015_294f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_2951, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
