...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_79b4()
        {
            ...
            ii(0x1018_79c5, 3); mov(ds, memw[ss, ebp + 12]);            /* mov ds, [ebp+0xc] */
            ...
            ii(0x1018_79d0, 3); mov(memd[ds, edi + 12], edx);           /* mov [edi+0xc], edx */
            ii(0x1018_79d3, 3); mov(memd[ds, edi + 16], esi);           /* mov [edi+0x10], esi */
            ii(0x1018_79d6, 3); pop(memd[ds, edi + 20]);                /* pop dword [edi+0x14] */
            ii(0x1018_79d9, 2); sbb(eax, eax);                          /* sbb eax, eax */
            ii(0x1018_79db, 3); mov(memd[ds, edi + 24], eax);           /* mov [edi+0x18], eax */
