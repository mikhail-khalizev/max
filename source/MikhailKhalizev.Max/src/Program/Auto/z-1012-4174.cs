...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_4174()
        {
            ...
            ii(0x1012_419c, 2); if(jnz(0x1012_41a7, 0x9)) goto l_0x1012_41a7; /* jnz 0x101241a7 */
            ii(0x1012_419e, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
        ...
        l_0x1012_41a7:
            ...
            ii(0x1012_41bd, 2); if(jnz(0x1012_41c8, 0x9)) goto l_0x1012_41c8; /* jnz 0x101241c8 */
            ii(0x1012_41bf, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x1012_41c6, 2); jmp(0x1012_41cf, 0x7); goto l_0x1012_41cf; /* jmp 0x101241cf */
        l_0x1012_41c8:
            ii(0x1012_41c8, 7); mov(memd[ss, ebp - 0x4], 0x1);          /* mov dword [ebp-0x4], 0x1 */
        l_0x1012_41cf:
            ii(0x1012_41cf, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
