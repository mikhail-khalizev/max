...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_3525()
        {
            ...
            ii(0x1011_353d, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_3540, 7); mov(memd[ss, ebp - 0x8], 0x8);          /* mov dword [ebp-0x8], 0x8 */
            ii(0x1011_3547, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_354a, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x1011_354c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_354f, 6); mov(eax, memd[ds, eax + 0x5a5]);        /* mov eax, [eax+0x5a5] */
            ii(0x1011_3555, 5); call(0x100d_7f6c, -0x3_b5ee);           /* call 0x100d7f6c */
            ii(0x1011_355a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_355d, 3); mov(al, memb[ds, eax + 0x10]);          /* mov al, [eax+0x10] */
        ...
        l_0x1011_35b0:
            ii(0x1011_35b0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_35b3, 3); mov(al, memb[ds, eax + 0x9]);           /* mov al, [eax+0x9] */
            ...
            ii(0x1011_35c0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_35c3, 3); mov(al, memb[ds, eax + 0x9]);           /* mov al, [eax+0x9] */
        ...
        l_0x1011_35d0:
            ii(0x1011_35d0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_35d3, 7); mov(memd[ds, eax + 0x4], 0x2);          /* mov dword [eax+0x4], 0x2 */
            ii(0x1011_35da, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1011_35e7:
            ii(0x1011_35e7, 4); dec(memw[ss, ebp - 0x8]);               /* dec word [ebp-0x8] */
            ii(0x1011_35eb, 5); cmp(memw[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp word [ebp-0x8], 0xffff */
            ii(0x1011_35f0, 6); if(jz(0x1011_36b7, 0xc1)) goto l_0x1011_36b7; /* jz 0x101136b7 */
            ii(0x1011_35f6, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x1011_35f9, 2); add(al, 0x2);                           /* add al, 0x2 */
            ii(0x1011_35fb, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x1011_35fe, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1011_3600, 1); push(eax);                              /* push eax */
            ii(0x1011_3601, 5); mov(ecx, 0x14);                         /* mov ecx, 0x14 */
            ii(0x1011_3606, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1011_360a, 3); imul(eax, eax, 0x1e);                   /* imul eax, eax, 0x1e */
            ii(0x1011_360d, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ii(0x1011_3610, 6); add(ebx, 0x238);                        /* add ebx, 0x238 */
            ii(0x1011_3616, 2); add(ebx, eax);                          /* add ebx, eax */
            ii(0x1011_3618, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1011_361c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_361f, 5); call(0x1011_2c46, -0x9de);              /* call 0x10112c46 */
            ii(0x1011_3624, 5); cmp(memw[ss, ebp - 0x8], 0);            /* cmp word [ebp-0x8], 0x0 */
            ii(0x1011_3629, 2); if(jz(0x1011_3681, 0x56)) goto l_0x1011_3681; /* jz 0x10113681 */
            ii(0x1011_362b, 2); push(0x2);                              /* push 0x2 */
            ii(0x1011_362d, 4); movsx(eax, memb[ss, ebp - 0xc]);        /* movsx eax, byte [ebp-0xc] */
            ...
            ii(0x1011_363e, 4); movsx(eax, memb[ss, ebp - 0xc]);        /* movsx eax, byte [ebp-0xc] */
            ...
            ii(0x1011_364f, 4); movsx(ecx, memb[ss, ebp - 0xc]);        /* movsx ecx, byte [ebp-0xc] */
            ...
            ii(0x1011_365f, 4); movsx(eax, memb[ss, ebp - 0xc]);        /* movsx eax, byte [ebp-0xc] */
            ...
            ii(0x1011_3674, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_3677, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1011_3679, 3); mov(eax, memd[ds, eax + 0x16]);         /* mov eax, [eax+0x16] */
            ii(0x1011_367c, 5); call(/* sys */ 0x1016_a5a0, 0x5_6f1f);  /* call 0x1016a5a0 */
        l_0x1011_3681:
            ii(0x1011_3681, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1011_3685, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x1011_3687, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1011_368a, 6); mov(eax, memd[ds, eax + 0x326]);        /* mov eax, [eax+0x326] */
            ii(0x1011_3690, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1011_3693, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1011_3695, 2); if(jz(0x1011_369d, 0x6)) goto l_0x1011_369d; /* jz 0x1011369d */
            ii(0x1011_3697, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
            ii(0x1011_369b, 2); jmp(0x1011_36a1, 0x4); goto l_0x1011_36a1; /* jmp 0x101136a1 */
        l_0x1011_369d:
            ii(0x1011_369d, 4); mov(memb[ss, ebp - 0x10], 0);           /* mov byte [ebp-0x10], 0x0 */
        l_0x1011_36a1:
            ii(0x1011_36a1, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1011_36a3, 3); mov(bl, memb[ss, ebp - 0x10]);          /* mov bl, [ebp-0x10] */
            ii(0x1011_36a6, 4); movsx(edx, memb[ss, ebp - 0xc]);        /* movsx edx, byte [ebp-0xc] */
            ii(0x1011_36aa, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
