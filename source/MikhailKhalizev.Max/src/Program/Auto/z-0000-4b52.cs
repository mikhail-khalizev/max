...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_4b52()
        {
            ...
            ii(0x4b55, 3);    mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ...
            ii(0x4b64, 3);    mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x4b67, 3);    mov(memw[ss, bp + 0x4], ax);              /* mov [bp+0x4], ax */
            ii(0x4b6a, 3);    mov(ds, memw[ss, bp + 0xa]);              /* mov ds, [bp+0xa] */
            ii(0x4b6d, 3);    mov(es, memw[ss, bp + 0xc]);              /* mov es, [bp+0xc] */
