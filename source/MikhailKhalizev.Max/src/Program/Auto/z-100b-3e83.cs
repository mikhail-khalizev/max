...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_3e83()
        {
            ...
            ii(0x100b_3e9c, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100b_3e9f, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ii(0x100b_3ea2, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x100b_3ea5, 3); add(edx, 0x1b);                         /* add edx, 0x1b */
            ii(0x100b_3ea8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_3ec4, 5); call(0x100b_3ed0, 0x7);                 /* call 0x100b3ed0 */
        l_0x100b_3ec9:
