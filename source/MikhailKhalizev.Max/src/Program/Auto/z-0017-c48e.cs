...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_c48e()
        {
            ...
            ii(0x17_c498, 3); mov(ax, memw[ss, bp + 0xa]);              /* mov ax, [bp+0xa] */
            ii(0x17_c49b, 3); mov(dx, memw[ss, bp + 0xc]);              /* mov dx, [bp+0xc] */
            ...
            ii(0x17_c4bc, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_c4bf, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x17_c4c2, 2); sub(ax, ax);                              /* sub ax, ax */
            ii(0x17_c4c4, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
            ii(0x17_c4c7, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x17_c4ca, 2); jmp(0x17_c4dc, 0x10); goto l_0x17_c4dc;   /* jmp 0xc4dc */
        l_0x17_c4cc:
            ii(0x17_c4cc, 4); add(memw[ss, bp - 0x8], 0x1);             /* add word [bp-0x8], 0x1 */
            ii(0x17_c4d0, 4); adc(memw[ss, bp - 0x6], 0);               /* adc word [bp-0x6], 0x0 */
            ii(0x17_c4d4, 4); add(memw[ss, bp - 0x4], 0x1);             /* add word [bp-0x4], 0x1 */
            ii(0x17_c4d8, 4); adc(memw[ss, bp - 0x2], 0);               /* adc word [bp-0x2], 0x0 */
        l_0x17_c4dc:
            ii(0x17_c4dc, 3); mov(ax, memw[ss, bp + 0xe]);              /* mov ax, [bp+0xe] */
            ii(0x17_c4df, 3); mov(dx, memw[ss, bp + 0x10]);             /* mov dx, [bp+0x10] */
            ii(0x17_c4e2, 3); cmp(memw[ss, bp - 0x6], dx);              /* cmp [bp-0x6], dx */
            ii(0x17_c4e5, 2); if(ja(0x17_c55c, 0x75)) goto l_0x17_c55c; /* ja 0xc55c */
            ii(0x17_c4e7, 2); if(jb(0x17_c4ee, 0x5)) goto l_0x17_c4ee;  /* jb 0xc4ee */
            ii(0x17_c4e9, 3); cmp(memw[ss, bp - 0x8], ax);              /* cmp [bp-0x8], ax */
            ii(0x17_c4ec, 2); if(jae(0x17_c55c, 0x6e)) goto l_0x17_c55c; /* jae 0xc55c */
        l_0x17_c4ee:
            ii(0x17_c4ee, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x17_c4f1, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_c4f4, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0x17_c505, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x17_c508, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_c50b, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0x17_c51c, 4); and(memb[ss, bp - 0xc], -0x2 /* 0xfe */); /* and byte [bp-0xc], 0xfe */
            ii(0x17_c520, 3); mov(ax, memw[ss, bp - 0xc]);              /* mov ax, [bp-0xc] */
            ii(0x17_c523, 3); and(ah, 0xf);                             /* and ah, 0xf */
            ii(0x17_c526, 2); sub(dx, dx);                              /* sub dx, dx */
            ii(0x17_c528, 3); mov(memw[ss, bp - 0xc], ax);              /* mov [bp-0xc], ax */
            ii(0x17_c52b, 3); mov(memw[ss, bp - 0xa], dx);              /* mov [bp-0xa], dx */
            ii(0x17_c52e, 3); mov(ch, memb[ss, bp + 0x12]);             /* mov ch, [bp+0x12] */
            ii(0x17_c531, 2); shl(ch, 0x1);                             /* shl ch, 1 */
            ii(0x17_c533, 2); xor(ah, ch);                              /* xor ah, ch */
            ii(0x17_c535, 3); and(ax, 0xe00);                           /* and ax, 0xe00 */
            ii(0x17_c538, 3); xor(memw[ss, bp - 0xc], ax);              /* xor [bp-0xc], ax */
            ii(0x17_c53b, 3); xor(memw[ss, bp - 0xa], dx);              /* xor [bp-0xa], dx */
            ii(0x17_c53e, 3); push(memw[ss, bp - 0xa]);                 /* push word [bp-0xa] */
            ii(0x17_c541, 3); push(memw[ss, bp - 0xc]);                 /* push word [bp-0xc] */
            ii(0x17_c544, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_c547, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
