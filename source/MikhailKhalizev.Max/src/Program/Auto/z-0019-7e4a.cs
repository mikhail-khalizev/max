...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_7e4a()
        {
            ...
            ii(0x19_7e50, 5); mov(memw[ss, bp - 0x4], 0x332d);          /* mov word [bp-0x4], 0x332d */
            ii(0x19_7e55, 5); mov(memw[ss, bp - 0x2], 0x88);            /* mov word [bp-0x2], 0x88 */
            ii(0x19_7e5a, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0x19_7e5d, 3); mov(memw[ss, bp - 0xa], ax);              /* mov [bp-0xa], ax */
            ii(0x19_7e60, 5); mov(memw[ss, bp - 0x8], 0);               /* mov word [bp-0x8], 0x0 */
            ii(0x19_7e65, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0x19_7e68, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
            ii(0x19_7e6b, 3); mov(si, 0);                               /* mov si, 0x0 */
            ii(0x19_7e6e, 3); jmp(0x19_7e72, 0x1); goto l_0x19_7e72;    /* jmp 0x7e72 */
        l_0x19_7e71:
            ii(0x19_7e71, 1); inc(si);                                  /* inc si */
        l_0x19_7e72:
            ii(0x19_7e72, 3); cmp(si, 0xe);                             /* cmp si, 0xe */
            ii(0x19_7e75, 2); if(jle(0x19_7e7a, 0x3)) goto l_0x19_7e7a; /* jle 0x7e7a */
            ii(0x19_7e77, 3); jmp(0x19_7e96, 0x1c); goto l_0x19_7e96;   /* jmp 0x7e96 */
        l_0x19_7e7a:
            ii(0x19_7e7a, 3); cmp(si, 0x2);                             /* cmp si, 0x2 */
            ii(0x19_7e7d, 2); if(jz(0x19_7e82, 0x3)) goto l_0x19_7e82;  /* jz 0x7e82 */
            ii(0x19_7e7f, 3); jmp(0x19_7e85, 0x3); goto l_0x19_7e85;    /* jmp 0x7e85 */
        l_0x19_7e82:
            ii(0x19_7e82, 3); jmp(0x19_7e71, -0x14); goto l_0x19_7e71;  /* jmp 0x7e71 */
        l_0x19_7e85:
            ii(0x19_7e85, 3); lea(ax, memw[ss, bp - 0xa]);              /* lea ax, [bp-0xa] */
        ...
        l_0x19_7e96:
            ...
            ii(0x19_7e99, 3); jmp(0x19_7e9d, 0x1); goto l_0x19_7e9d;    /* jmp 0x7e9d */
        l_0x19_7e9c:
            ii(0x19_7e9c, 1); inc(si);                                  /* inc si */
        l_0x19_7e9d:
            ii(0x19_7e9d, 3); cmp(si, 0x3);                             /* cmp si, 0x3 */
            ii(0x19_7ea0, 2); if(jl(0x19_7ea5, 0x3)) goto l_0x19_7ea5;  /* jl 0x7ea5 */
            ii(0x19_7ea2, 3); jmp(0x19_7ebc, 0x17); goto l_0x19_7ebc;   /* jmp 0x7ebc */
        l_0x19_7ea5:
            ii(0x19_7ea5, 3); lea(ax, memw[ss, bp - 0xa]);              /* lea ax, [bp-0xa] */
