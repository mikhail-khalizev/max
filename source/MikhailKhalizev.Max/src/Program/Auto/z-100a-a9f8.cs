...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_a9f8()
        {
            ...
            ii(0x100a_aa10, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_aa13, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_aa16, 3); mov(al, memb[ds, eax + 0x1e]);          /* mov al, [eax+0x1e] */
            ii(0x100a_aa19, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x100a_aa1c, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
