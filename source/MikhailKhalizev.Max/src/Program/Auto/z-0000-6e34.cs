...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x6e34, 4);    enter(0x2, 0);                            /* enter 0x2, 0x0 */
        ...
        l_0x6e6e:
            ...
            ii(0x6e92, 5);    mov(memw[ds, bx + 0x18], 0xffff);         /* mov word [bx+0x18], 0xffff */
