...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_e96a()
        {
            ...
            ii(0x17_e976, 3); mov(memw[ss, bp - 0x18], ax);             /* mov [bp-0x18], ax */
            ii(0x17_e979, 3); mov(memw[ss, bp - 0x1a], ax);             /* mov [bp-0x1a], ax */
            ...
            ii(0x17_e985, 3); mov(al, memb[ss, bp + 0x8]);              /* mov al, [bp+0x8] */
            ii(0x17_e988, 2); mov(ah, 0xff);                            /* mov ah, 0xff */
            ii(0x17_e98a, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ii(0x17_e98d, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_e990, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x17_e993, 3); mov(ax, memw[ss, bp + 0xa]);              /* mov ax, [bp+0xa] */
            ii(0x17_e996, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ...
            ii(0x17_e9b2, 3); mov(ax, memw[ss, bp - 0x12]);             /* mov ax, [bp-0x12] */
        l_0x17_e9b5:
            ii(0x17_e9b5, 3); mov(memw[ss, bp - 0x18], ax);             /* mov [bp-0x18], ax */
        ...
        l_0x17_e9ba:
            ...
            ii(0x17_e9d6, 3); mov(al, memb[ss, bp + 0x8]);              /* mov al, [bp+0x8] */
            ii(0x17_e9d9, 3); mov(memb[ss, bp - 0x1e], al);             /* mov [bp-0x1e], al */
            ii(0x17_e9dc, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_e9df, 3); mov(memw[ss, bp - 0x20], ax);             /* mov [bp-0x20], ax */
            ii(0x17_e9e2, 3); mov(ax, memw[ss, bp + 0xa]);              /* mov ax, [bp+0xa] */
            ii(0x17_e9e5, 1); dec(ax);                                  /* dec ax */
            ii(0x17_e9e6, 3); mov(memw[ss, bp - 0x22], ax);             /* mov [bp-0x22], ax */
            ...
            ii(0x17_ea03, 2); if(jz(0x17_ea0a, 0x5)) goto l_0x17_ea0a;  /* jz 0xea0a */
            ii(0x17_ea05, 3); mov(ax, memw[ss, bp - 0x16]);             /* mov ax, [bp-0x16] */
            ii(0x17_ea08, 2); jmp(0x17_e9b5, -0x55); goto l_0x17_e9b5;  /* jmp 0xe9b5 */
        l_0x17_ea0a:
            ii(0x17_ea0a, 3); push(memw[ss, bp - 0x16]);                /* push word [bp-0x16] */
        ...
        l_0x17_ea15:
            ii(0x17_ea15, 3); mov(ax, memw[ss, bp - 0x1a]);             /* mov ax, [bp-0x1a] */
            ii(0x17_ea18, 3); mov(dx, memw[ss, bp - 0x18]);             /* mov dx, [bp-0x18] */
