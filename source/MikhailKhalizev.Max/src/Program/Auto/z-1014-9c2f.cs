...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_9c2f()
        {
            ...
            ii(0x1014_9c45, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ...
            ii(0x1014_9c51, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x1014_9c54, 4); add(memw[ds, edx + 22], ax);            /* add [edx+0x16], ax */
            ii(0x1014_9c58, 4); movsx(edx, memw[ss, ebp - 8]);          /* movsx edx, word [ebp-0x8] */
            ii(0x1014_9c5c, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1014_9c5f, 6); add(memd[ds, eax + 181], edx);          /* add [eax+0xb5], edx */
            ii(0x1014_9c65, 4); movsx(edx, memw[ss, ebp - 8]);          /* movsx edx, word [ebp-0x8] */
            ii(0x1014_9c69, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1014_9c6c, 6); add(memd[ds, eax + 189], edx);          /* add [eax+0xbd], edx */
            ii(0x1014_9c72, 4); movsx(edx, memw[ss, ebp - 8]);          /* movsx edx, word [ebp-0x8] */
            ii(0x1014_9c76, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1014_9c79, 6); add(memd[ds, eax + 197], edx);          /* add [eax+0xc5], edx */
            ii(0x1014_9c7f, 4); movsx(edx, memw[ss, ebp - 8]);          /* movsx edx, word [ebp-0x8] */
            ii(0x1014_9c83, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1014_9c86, 6); add(memd[ds, eax + 205], edx);          /* add [eax+0xcd], edx */
            ii(0x1014_9c8c, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_9c8f, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x1014_9c92, 4); add(memw[ds, edx + 24], ax);            /* add [edx+0x18], ax */
            ii(0x1014_9c96, 4); movsx(edx, memw[ss, ebp - 4]);          /* movsx edx, word [ebp-0x4] */
            ii(0x1014_9c9a, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1014_9c9d, 6); add(memd[ds, eax + 185], edx);          /* add [eax+0xb9], edx */
            ii(0x1014_9ca3, 4); movsx(edx, memw[ss, ebp - 4]);          /* movsx edx, word [ebp-0x4] */
            ii(0x1014_9ca7, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1014_9caa, 6); add(memd[ds, eax + 193], edx);          /* add [eax+0xc1], edx */
            ii(0x1014_9cb0, 4); movsx(edx, memw[ss, ebp - 4]);          /* movsx edx, word [ebp-0x4] */
            ii(0x1014_9cb4, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1014_9cb7, 6); add(memd[ds, eax + 201], edx);          /* add [eax+0xc9], edx */
            ii(0x1014_9cbd, 4); movsx(edx, memw[ss, ebp - 4]);          /* movsx edx, word [ebp-0x4] */
            ii(0x1014_9cc1, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1014_9cc4, 6); add(memd[ds, eax + 209], edx);          /* add [eax+0xd1], edx */
