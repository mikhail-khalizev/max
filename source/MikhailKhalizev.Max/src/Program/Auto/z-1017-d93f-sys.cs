...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_d93f()
        {
            ...
            ii(0x1017_d94b, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1017_d94e, 4); mov(memw[ss, ebp - 0x14], cx);          /* mov [ebp-0x14], cx */
            ii(0x1017_d952, 3); mov(memd[ss, ebp - 0x18], ebx);         /* mov [ebp-0x18], ebx */
            ii(0x1017_d955, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
        l_0x1017_d95c:
            ii(0x1017_d95c, 4); cmp(memd[ss, ebp - 0x4], 0x10);         /* cmp dword [ebp-0x4], 0x10 */
            ii(0x1017_d960, 2); if(jb(0x1017_d969, 0x7)) goto l_0x1017_d969; /* jb 0x1017d969 */
            ii(0x1017_d962, 2); jmp(0x1017_d982, 0x1e); goto l_0x1017_d982; /* jmp 0x1017d982 */
        l_0x1017_d964:
            ii(0x1017_d964, 3); inc(memd[ss, ebp - 0x4]);               /* inc dword [ebp-0x4] */
            ii(0x1017_d967, 2); jmp(0x1017_d95c, -0xd); goto l_0x1017_d95c; /* jmp 0x1017d95c */
        l_0x1017_d969:
            ii(0x1017_d969, 4); imul(eax, memd[ss, ebp - 0x4], 0x6);    /* imul eax, [ebp-0x4], 0x6 */
            ...
            ii(0x1017_d97e, 2); if(jz(0x1017_d982, 0x2)) goto l_0x1017_d982; /* jz 0x1017d982 */
        l_0x1017_d980:
            ii(0x1017_d980, 2); jmp(0x1017_d964, -0x1e); goto l_0x1017_d964; /* jmp 0x1017d964 */
        l_0x1017_d982:
            ii(0x1017_d982, 4); cmp(memd[ss, ebp - 0x4], 0x10);         /* cmp dword [ebp-0x4], 0x10 */
            ii(0x1017_d986, 2); if(jb(0x1017_d994, 0xc)) goto l_0x1017_d994; /* jb 0x1017d994 */
            ii(0x1017_d988, 7); mov(memd[ss, ebp - 0xc], 0xb);          /* mov dword [ebp-0xc], 0xb */
        ...
        l_0x1017_d994:
            ...
            ii(0x1017_d99b, 2); if(jz(0x1017_d9a2, 0x5)) goto l_0x1017_d9a2; /* jz 0x1017d9a2 */
            ii(0x1017_d99d, 5); call(/* sys */ 0x1019_4b45, 0x1_71a3);  /* call 0x10194b45 */
        l_0x1017_d9a2:
            ii(0x1017_d9a2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1017_d9a5, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1017_d9a8, 4); imul(edx, memd[ss, ebp - 0x4], 0x6);    /* imul edx, [ebp-0x4], 0x6 */
            ii(0x1017_d9ac, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1017_d9af, 7); mov(memw[ds, edx + 0x101c_069d], ax);   /* mov [edx+0x101c069d], ax */
            ii(0x1017_d9b6, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1017_d9b9, 6); mov(memd[ds, edx + 0x101c_0699], eax);  /* mov [edx+0x101c0699], eax */
            ii(0x1017_d9bf, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1017_d9c2, 3); shl(edx, 0x2);                          /* shl edx, 0x2 */
            ii(0x1017_d9c5, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x1017_d9d5, 3); div(memd[ss, ebp - 0x10]);              /* div dword [ebp-0x10] */
            ...
            ii(0x1017_d9e7, 3); div(memd[ss, ebp - 0x10]);              /* div dword [ebp-0x10] */
            ii(0x1017_d9ea, 5); call(/* sys */ 0x1017_de3a, 0x44b);     /* call 0x1017de3a */
        l_0x1017_d9ef:
            ii(0x1017_d9ef, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
        l_0x1017_d9f6:
            ii(0x1017_d9f6, 4); cmp(memd[ss, ebp - 0x4], 0x10);         /* cmp dword [ebp-0x4], 0x10 */
        ...
        l_0x1017_da01:
            ii(0x1017_da01, 3); inc(memd[ss, ebp - 0x4]);               /* inc dword [ebp-0x4] */
            ii(0x1017_da04, 2); jmp(0x1017_d9f6, -0x10); goto l_0x1017_d9f6; /* jmp 0x1017d9f6 */
        l_0x1017_da06:
            ii(0x1017_da06, 4); imul(eax, memd[ss, ebp - 0x4], 0x6);    /* imul eax, [ebp-0x4], 0x6 */
        ...
        l_0x1017_da21:
            ii(0x1017_da21, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1017_da3f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1017_da51:
            ...
            ii(0x1017_da6b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1017_da79:
            ii(0x1017_da79, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1017_da9f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1017_daa2, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1017_daa5, 6); mov(memd[ds, eax + 0x101c_0739], ebx);  /* mov [eax+0x101c0739], ebx */
        l_0x1017_daab:
            ii(0x1017_daab, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1017_dac0:
            ...
            ii(0x1017_dac7, 2); if(jz(0x1017_dace, 0x5)) goto l_0x1017_dace; /* jz 0x1017dace */
        ...
        l_0x1017_dadf:
            ii(0x1017_dadf, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1017_dae6, 3); ret(0x8);                               /* ret 0x8 */
        }
    }
}
