...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_11f7()
        {
            ...
            ii(0x100b_120c, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100b_120f, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x100b_1212, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x100b_1215, 3); mov(memd[ss, ebp - 0x4], ecx);          /* mov [ebp-0x4], ecx */
            ii(0x100b_1218, 7); mov(memd[ss, ebp - 0x18], 0);           /* mov dword [ebp-0x18], 0x0 */
            ii(0x100b_121f, 3); lea(edx, memd[ss, ebp - 0x20]);         /* lea edx, [ebp-0x20] */
            ii(0x100b_1222, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100b_1225, 5); call(0x100a_2d3d, -0xe4ed);             /* call 0x100a2d3d */
        l_0x100b_122a:
            ii(0x100b_122a, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100b_123b, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100b_123e, 5); call(0x100b_7c44, 0x6a01);              /* call 0x100b7c44 */
            ii(0x100b_1243, 3); lea(ebx, memd[ss, ebp - 0x24]);         /* lea ebx, [ebp-0x24] */
            ...
            ii(0x100b_124f, 4); or(memb[ss, ebp - 0x14], 0x1);          /* or byte [ebp-0x14], 0x1 */
            ii(0x100b_1253, 3); lea(eax, memd[ss, ebp - 0x28]);         /* lea eax, [ebp-0x28] */
            ii(0x100b_1256, 5); call(0x1008_a634, -0x2_6c27);           /* call 0x1008a634 */
            ii(0x100b_125b, 3); mov(memd[ss, ebp - 0x2c], eax);         /* mov [ebp-0x2c], eax */
            ii(0x100b_125e, 4); and(memb[ss, ebp - 0x14], -0x2 /* 0xfe */); /* and byte [ebp-0x14], 0xfe */
            ii(0x100b_1262, 2); jmp(0x100b_126c, 0x8); goto l_0x100b_126c; /* jmp 0x100b126c */
        l_0x100b_1264:
            ii(0x100b_1264, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ii(0x100b_1267, 5); call(0x1007_6bf8, -0x3_a674);           /* call 0x10076bf8 */
        l_0x100b_126c:
            ii(0x100b_126c, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_126e, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ...
            ii(0x100b_127a, 3); lea(edx, memd[ss, ebp - 0x30]);         /* lea edx, [ebp-0x30] */
            ii(0x100b_127d, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ...
            ii(0x100b_128c, 3); lea(edx, memd[ss, ebp - 0x20]);         /* lea edx, [ebp-0x20] */
            ii(0x100b_128f, 3); lea(eax, memd[ss, ebp - 0x34]);         /* lea eax, [ebp-0x34] */
            ...
            ii(0x100b_129e, 3); mov(memd[ss, ebp - 0x38], eax);         /* mov [ebp-0x38], eax */
            ii(0x100b_12a1, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_12a3, 3); lea(eax, memd[ss, ebp - 0x28]);         /* lea eax, [ebp-0x28] */
            ii(0x100b_12a6, 5); call(0x1013_ad11, 0x8_9a66);            /* call 0x1013ad11 */
            ii(0x100b_12ab, 2); test(al, al);                           /* test al, al */
            ii(0x100b_12ad, 2); if(jnz(0x100b_12b8, 0x9)) goto l_0x100b_12b8; /* jnz 0x100b12b8 */
            ii(0x100b_12af, 3); mov(eax, memd[ss, ebp - 0x38]);         /* mov eax, [ebp-0x38] */
            ii(0x100b_12b2, 4); cmp(ax, memw[ss, ebp - 0x3c]);          /* cmp ax, [ebp-0x3c] */
            ii(0x100b_12b6, 2); if(jge(0x100b_12d2, 0x1a)) goto l_0x100b_12d2; /* jge 0x100b12d2 */
        l_0x100b_12b8:
            ii(0x100b_12b8, 3); mov(eax, memd[ss, ebp - 0x38]);         /* mov eax, [ebp-0x38] */
            ii(0x100b_12bb, 3); mov(memd[ss, ebp - 0x3c], eax);         /* mov [ebp-0x3c], eax */
            ii(0x100b_12be, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ii(0x100b_12c1, 5); call(0x100b_7a48, 0x6782);              /* call 0x100b7a48 */
            ii(0x100b_12c6, 3); lea(ebx, memd[ss, ebp - 0x28]);         /* lea ebx, [ebp-0x28] */
        ...
        l_0x100b_12d4:
            ii(0x100b_12d4, 3); mov(eax, memd[ss, ebp - 0x3c]);         /* mov eax, [ebp-0x3c] */
            ii(0x100b_12d7, 3); add(memd[ss, ebp - 0x18], eax);         /* add [ebp-0x18], eax */
            ii(0x100b_12da, 3); lea(edx, memd[ss, ebp - 0x40]);         /* lea edx, [ebp-0x40] */
            ii(0x100b_12dd, 3); lea(eax, memd[ss, ebp - 0x28]);         /* lea eax, [ebp-0x28] */
            ii(0x100b_12e0, 5); call(0x1008_a520, -0x2_6dc5);           /* call 0x1008a520 */
            ii(0x100b_12e5, 5); call(0x100a_ca34, -0x48b6);             /* call 0x100aca34 */
            ii(0x100b_12ea, 3); lea(ebx, memd[ss, ebp - 0x20]);         /* lea ebx, [ebp-0x20] */
            ...
            ii(0x100b_12f6, 3); lea(eax, memd[ss, ebp - 0x28]);         /* lea eax, [ebp-0x28] */
            ii(0x100b_12f9, 5); call(0x1008_a57c, -0x2_6d82);           /* call 0x1008a57c */
            ii(0x100b_12fe, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100b_1300, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100b_1303, 5); call(0x100b_7bac, 0x68a4);              /* call 0x100b7bac */
            ii(0x100b_1308, 3); lea(eax, memd[ss, ebp - 0x28]);         /* lea eax, [ebp-0x28] */
            ii(0x100b_130b, 5); call(0x1008_a57c, -0x2_6d94);           /* call 0x1008a57c */
            ii(0x100b_1310, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ...
            ii(0x100b_131e, 3); lea(eax, memd[ss, ebp - 0x28]);         /* lea eax, [ebp-0x28] */
            ii(0x100b_1321, 5); call(0x1008_8d4c, -0x2_85da);           /* call 0x10088d4c */
            ii(0x100b_1326, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_1328, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
        ...
        l_0x100b_1335:
            ii(0x100b_1335, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_1346, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_1349, 5); call(0x100b_7c44, 0x68f6);              /* call 0x100b7c44 */
            ii(0x100b_134e, 3); lea(ebx, memd[ss, ebp - 0x44]);         /* lea ebx, [ebp-0x44] */
            ...
            ii(0x100b_135a, 4); or(memb[ss, ebp - 0x14], 0x1);          /* or byte [ebp-0x14], 0x1 */
            ii(0x100b_135e, 3); lea(eax, memd[ss, ebp - 0x48]);         /* lea eax, [ebp-0x48] */
            ii(0x100b_1361, 5); call(0x1008_a634, -0x2_6d32);           /* call 0x1008a634 */
            ii(0x100b_1366, 3); mov(memd[ss, ebp - 0x4c], eax);         /* mov [ebp-0x4c], eax */
            ii(0x100b_1369, 4); and(memb[ss, ebp - 0x14], -0x2 /* 0xfe */); /* and byte [ebp-0x14], 0xfe */
            ii(0x100b_136d, 2); jmp(0x100b_1377, 0x8); goto l_0x100b_1377; /* jmp 0x100b1377 */
        l_0x100b_136f:
            ii(0x100b_136f, 3); lea(eax, memd[ss, ebp - 0x44]);         /* lea eax, [ebp-0x44] */
            ii(0x100b_1372, 5); call(0x1007_6bf8, -0x3_a77f);           /* call 0x10076bf8 */
        l_0x100b_1377:
            ii(0x100b_1377, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_1379, 3); lea(eax, memd[ss, ebp - 0x44]);         /* lea eax, [ebp-0x44] */
            ...
            ii(0x100b_1385, 3); lea(edx, memd[ss, ebp - 0x50]);         /* lea edx, [ebp-0x50] */
            ii(0x100b_1388, 3); lea(eax, memd[ss, ebp - 0x44]);         /* lea eax, [ebp-0x44] */
            ...
            ii(0x100b_1397, 3); lea(edx, memd[ss, ebp - 0x20]);         /* lea edx, [ebp-0x20] */
            ii(0x100b_139a, 3); lea(eax, memd[ss, ebp - 0x54]);         /* lea eax, [ebp-0x54] */
            ...
            ii(0x100b_13a9, 3); mov(memd[ss, ebp - 0x58], eax);         /* mov [ebp-0x58], eax */
            ii(0x100b_13ac, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_13ae, 3); lea(eax, memd[ss, ebp - 0x48]);         /* lea eax, [ebp-0x48] */
            ii(0x100b_13b1, 5); call(0x1013_ad11, 0x8_995b);            /* call 0x1013ad11 */
            ii(0x100b_13b6, 2); test(al, al);                           /* test al, al */
            ii(0x100b_13b8, 2); if(jnz(0x100b_13c3, 0x9)) goto l_0x100b_13c3; /* jnz 0x100b13c3 */
            ii(0x100b_13ba, 3); mov(eax, memd[ss, ebp - 0x58]);         /* mov eax, [ebp-0x58] */
            ii(0x100b_13bd, 4); cmp(ax, memw[ss, ebp - 0x5c]);          /* cmp ax, [ebp-0x5c] */
            ii(0x100b_13c1, 2); if(jge(0x100b_13dd, 0x1a)) goto l_0x100b_13dd; /* jge 0x100b13dd */
        l_0x100b_13c3:
            ii(0x100b_13c3, 3); mov(eax, memd[ss, ebp - 0x58]);         /* mov eax, [ebp-0x58] */
            ii(0x100b_13c6, 3); mov(memd[ss, ebp - 0x5c], eax);         /* mov [ebp-0x5c], eax */
            ii(0x100b_13c9, 3); lea(eax, memd[ss, ebp - 0x44]);         /* lea eax, [ebp-0x44] */
            ii(0x100b_13cc, 5); call(0x100b_7a48, 0x6677);              /* call 0x100b7a48 */
            ii(0x100b_13d1, 3); lea(ebx, memd[ss, ebp - 0x48]);         /* lea ebx, [ebp-0x48] */
        ...
        l_0x100b_13df:
            ii(0x100b_13df, 3); mov(eax, memd[ss, ebp - 0x5c]);         /* mov eax, [ebp-0x5c] */
            ii(0x100b_13e2, 3); add(memd[ss, ebp - 0x18], eax);         /* add [ebp-0x18], eax */
            ii(0x100b_13e5, 3); lea(edx, memd[ss, ebp - 0x60]);         /* lea edx, [ebp-0x60] */
            ii(0x100b_13e8, 3); lea(eax, memd[ss, ebp - 0x48]);         /* lea eax, [ebp-0x48] */
        ...
        l_0x100b_142a:
            ii(0x100b_142a, 4); cmp(memd[ss, ebp - 0x4], 0);            /* cmp dword [ebp-0x4], 0x0 */
            ii(0x100b_142e, 2); if(jz(0x100b_1475, 0x45)) goto l_0x100b_1475; /* jz 0x100b1475 */
            ii(0x100b_1430, 3); lea(edx, memd[ss, ebp - 0x64]);         /* lea edx, [ebp-0x64] */
            ii(0x100b_1433, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_1436, 5); call(0x100a_ca34, -0x4a07);             /* call 0x100aca34 */
            ii(0x100b_143b, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x100b_143d, 3); lea(edx, memd[ss, ebp - 0x20]);         /* lea edx, [ebp-0x20] */
            ii(0x100b_1440, 3); lea(eax, memd[ss, ebp - 0x68]);         /* lea eax, [ebp-0x68] */
            ...
            ii(0x100b_1451, 3); lea(edx, memd[ss, ebp - 0x6c]);         /* lea edx, [ebp-0x6c] */
            ii(0x100b_1454, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_1457, 5); call(0x100b_7da0, 0x6944);              /* call 0x100b7da0 */
            ii(0x100b_145c, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x100b_145e, 3); lea(edx, memd[ss, ebp - 0x70]);         /* lea edx, [ebp-0x70] */
            ii(0x100b_1461, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_1472, 3); add(memd[ss, ebp - 0x18], eax);         /* add [ebp-0x18], eax */
        l_0x100b_1475:
            ii(0x100b_1475, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x100b_1478, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100b_147b, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
