...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_f115()
        {
            ...
            ii(0x1013_f12d, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
        l_0x1013_f130:
            ii(0x1013_f130, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1013_f138, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_f13b, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1013_f13d, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_f140, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_f143, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1013_f145, 3); mov(eax, memd[ds, eax + 0x2]);          /* mov eax, [eax+0x2] */
            ii(0x1013_f148, 5); call(Definitions.sys_delete, 0x2_6e17); /* call 0x10165f64 */
            ii(0x1013_f14d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_f150, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1013_f152, 5); call(Definitions.sys_delete, 0x2_6e0d); /* call 0x10165f64 */
            ii(0x1013_f157, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_f15a, 3); mov(edx, memd[ds, eax + 0x4]);          /* mov edx, [eax+0x4] */
            ii(0x1013_f15d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_f160, 2); mov(memd[ds, eax], edx);                /* mov [eax], edx */
            ii(0x1013_f162, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1013_f16c:
            ii(0x1013_f16c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_f16f, 7); mov(memd[ds, eax + 0x4], 0);            /* mov dword [eax+0x4], 0x0 */
