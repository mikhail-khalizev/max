...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_af44()
        {
            ...
            ii(0x1016_af53, 2); if(jle(0x1016_af84, 0x2f)) goto l_0x1016_af84; /* jle 0x1016af84 */
            ii(0x1016_af55, 2); sub(edx, esi);                          /* sub edx, esi */
            ii(0x1016_af57, 3); mov(memd[ss, esp], edx);                /* mov [esp], edx */
        l_0x1016_af5a:
            ii(0x1016_af5a, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1016_af5c, 2); test(esi, esi);                         /* test esi, esi */
            ii(0x1016_af5e, 2); if(jle(0x1016_af7a, 0x1a)) goto l_0x1016_af7a; /* jle 0x1016af7a */
        l_0x1016_af60:
        ...
        l_0x1016_af7a:
            ii(0x1016_af7a, 3); mov(edx, memd[ss, esp]);                /* mov edx, [esp] */
