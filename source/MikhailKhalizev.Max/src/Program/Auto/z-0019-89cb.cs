...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_89cb()
        {
            ...
            ii(0x19_89d1, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x19_89d4, 3); jmp(0x19_8a10, 0x39); goto l_0x19_8a10;   /* jmp 0x8a10 */
        l_0x19_89d7:
            ii(0x19_89d7, 5); mov(memw[ss, bp - 0xa], 0x9);             /* mov word [bp-0xa], 0x9 */
            ii(0x19_89dc, 5); mov(memw[ss, bp - 0xe], 0x1824);          /* mov word [bp-0xe], 0x1824 */
            ii(0x19_89e1, 3); mov(memw[ss, bp - 0xc], ds);              /* mov [bp-0xc], ds */
            ii(0x19_89e4, 3); jmp(0x19_8a2f, 0x48); goto l_0x19_8a2f;   /* jmp 0x8a2f */
        l_0x19_89e7:
            ii(0x19_89e7, 5); mov(memw[ss, bp - 0xa], 0x5);             /* mov word [bp-0xa], 0x5 */
            ii(0x19_89ec, 5); mov(memw[ss, bp - 0xe], 0x182e);          /* mov word [bp-0xe], 0x182e */
            ii(0x19_89f1, 3); mov(memw[ss, bp - 0xc], ds);              /* mov [bp-0xc], ds */
            ii(0x19_89f4, 3); jmp(0x19_8a2f, 0x38); goto l_0x19_8a2f;   /* jmp 0x8a2f */
        l_0x19_89f7:
            ii(0x19_89f7, 5); mov(memw[ss, bp - 0xa], 0x5);             /* mov word [bp-0xa], 0x5 */
            ii(0x19_89fc, 5); mov(memw[ss, bp - 0xe], 0x1834);          /* mov word [bp-0xe], 0x1834 */
            ii(0x19_8a01, 3); mov(memw[ss, bp - 0xc], ds);              /* mov [bp-0xc], ds */
        ...
        l_0x19_8a2f:
            ...
            ii(0x19_8a46, 3); mov(memw[ss, bp - 0x4], cx);              /* mov [bp-0x4], cx */
            ii(0x19_8a49, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ii(0x19_8a4c, 3); mov(ax, memw[ss, bp - 0xe]);              /* mov ax, [bp-0xe] */
            ii(0x19_8a4f, 3); mov(dx, memw[ss, bp - 0xc]);              /* mov dx, [bp-0xc] */
            ii(0x19_8a52, 3); add(ax, memw[ss, bp - 0xa]);              /* add ax, [bp-0xa] */
            ii(0x19_8a55, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x19_8a58, 3); mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
        l_0x19_8a5b:
            ii(0x19_8a5b, 3); mov(ax, memw[ss, bp - 0x8]);              /* mov ax, [bp-0x8] */
            ii(0x19_8a5e, 3); cmp(memw[ss, bp - 0xe], ax);              /* cmp [bp-0xe], ax */
        ...
        l_0x19_8a66:
            ...
            ii(0x19_8a7a, 3); jmp(0x19_8a83, 0x6); goto l_0x19_8a83;    /* jmp 0x8a83 */
        l_0x19_8a7d:
            ii(0x19_8a7d, 3); mov(ax, 0);                               /* mov ax, 0x0 */
            ii(0x19_8a80, 3); jmp(0x19_8a86, 0x3); goto l_0x19_8a86;    /* jmp 0x8a86 */
        l_0x19_8a83:
