...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("28759194-825a-4541-9753-c45f617bcd75")]
        public void Method_1012_0864()
        {
            ii(0x1012_0864, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x1012_0869, 5); calld(Definitions.sys_check_available_stack_size, 0x454e4); /* call 0x10165d52 */
            ...
            ii(0x1012_0887, 5); calld(0x1013_a2ab, 0x19a1f);            /* call 0x1013a2ab */
