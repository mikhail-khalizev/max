...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("2248dedf-50ce-44fb-b97e-ca076f7fb5d3")]
        public void Method_100f_b43c()
        {
            ii(0x100f_b43c, 5); pushd(0x4e8);                           /* push 0x4e8 */
            ii(0x100f_b441, 5); calld(Definitions.sys_check_available_stack_size, 0x6a90c); /* call 0x10165d52 */
            ...
            ii(0x100f_b465, 5); calld(0x100d_c9c9, -0x1eaa1);           /* call 0x100dc9c9 */
            ...
            ii(0x100f_b497, 5); calld(Definitions.sys_sprintf, 0x6aa65); /* call 0x10165f01 */
            ii(0x100f_b49c, 3); add(esp, 0xc);                          /* add esp, 0xc */
            ii(0x100f_b49f, 5); calld(0x100c_aa00, -0x30aa4);           /* call 0x100caa00 */
            ...
            ii(0x100f_b4bc, 5); calld(0x1011_5d23, 0x1a862);            /* call 0x10115d23 */
        l_0x100f_b4c1:
            ii(0x100f_b4c1, 6); lea(eax, ebp - 0x3f0);                  /* lea eax, [ebp-0x3f0] */
            ii(0x100f_b4c7, 5); calld(0x100d_b229, -0x202a3);           /* call 0x100db229 */
