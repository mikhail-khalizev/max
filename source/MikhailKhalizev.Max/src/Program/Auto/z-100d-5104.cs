...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_5104()
        {
            ...
            ii(0x100d_5116, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100d_511c, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100d_511f, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100d_5122, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x100d_5124, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100d_5127, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
