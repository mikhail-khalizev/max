...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_5e7b()
        {
            ...
            ii(0x100a_5e92, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_5e95, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_5e98, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_5e9b, 5); call(0x1008_aef4, -0x1_afac);           /* call 0x1008aef4 */
            ii(0x100a_5ea0, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100a_5ea2, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x100a_5ea5, 5); call(0x1008_ae70, -0x1_b03a);           /* call 0x1008ae70 */
            ii(0x100a_5eaa, 2); jmp(0x100a_5eb4, 0x8); goto l_0x100a_5eb4; /* jmp 0x100a5eb4 */
        l_0x100a_5eac:
            ii(0x100a_5eac, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x100a_5eaf, 5); call(0x1007_6bf8, -0x2_f2bc);           /* call 0x10076bf8 */
        l_0x100a_5eb4:
            ii(0x100a_5eb4, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_5eb6, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ...
            ii(0x100a_5ec2, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x100a_5ec5, 5); call(0x1008_adc4, -0x1_b106);           /* call 0x1008adc4 */
            ii(0x100a_5eca, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100a_5ecd, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100a_5ed0, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x100a_5ed3, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100a_5ed6, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100a_5ed9, 3); call_abs(memd[ds, ebx + 0x5c]);         /* call dword [ebx+0x5c] */
            ii(0x100a_5edc, 2); jmp(0x100a_5eac, -0x32); goto l_0x100a_5eac; /* jmp 0x100a5eac */
        l_0x100a_5ede:
            ii(0x100a_5ede, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_5ee0, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
