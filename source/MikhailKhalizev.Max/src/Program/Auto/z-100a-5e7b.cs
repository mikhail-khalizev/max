...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("0d3d8fe5-c65f-44d6-9d58-1ebb7328383f")]
        public void Method_100a_5e7b()
        {
            ii(0x100a_5e7b, 5); pushd(0x28);                            /* push 0x28 */
            ii(0x100a_5e80, 5); calld(Definitions.sys_check_available_stack_size, 0xb_fecd); /* call 0x10165d52 */
        ...
        l_0x100a_5eb4:
            ...
            ii(0x100a_5ec5, 5); calld(0x1008_adc4, -0x1_b106);          /* call 0x1008adc4 */
        ...
        l_0x100a_5ede:
            ...
            ii(0x100a_5ee3, 5); calld(0x1008_8bbc, -0x1_d32c);          /* call 0x10088bbc */
