...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_c894()
        {
            ...
            ii(0x1015_c8ac, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_c8af, 4); mov(memb[ss, ebp - 0x8], 0x4);          /* mov byte [ebp-0x8], 0x4 */
        l_0x1015_c8b3:
            ii(0x1015_c8b3, 3); dec(memb[ss, ebp - 0x8]);               /* dec byte [ebp-0x8] */
            ii(0x1015_c8b6, 4); cmp(memb[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp byte [ebp-0x8], 0xff */
            ii(0x1015_c8ba, 2); if(jz(0x1015_c8e7, 0x2b)) goto l_0x1015_c8e7; /* jz 0x1015c8e7 */
            ii(0x1015_c8bc, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_c8bf, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ii(0x1015_c8c2, 3); cmp(al, memb[ss, ebp - 0x8]);           /* cmp al, [ebp-0x8] */
            ii(0x1015_c8c5, 2); if(jz(0x1015_c8db, 0x14)) goto l_0x1015_c8db; /* jz 0x1015c8db */
            ii(0x1015_c8c7, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1015_c8c9, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x1015_c8cc, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1015_c8cf, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_c8d2, 5); call(0x1007_6074, -0xe_6863);           /* call 0x10076074 */
            ii(0x1015_c8d7, 2); test(al, al);                           /* test al, al */
            ii(0x1015_c8d9, 2); if(jnz(0x1015_c8dd, 0x2)) goto l_0x1015_c8dd; /* jnz 0x1015c8dd */
        l_0x1015_c8db:
            ii(0x1015_c8db, 2); jmp(0x1015_c8e5, 0x8); goto l_0x1015_c8e5; /* jmp 0x1015c8e5 */
        l_0x1015_c8dd:
            ii(0x1015_c8dd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
