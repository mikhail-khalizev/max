...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_a112()
        {
            ...
            ii(0x1013_a143, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ...
            ii(0x1013_a15a, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ...
            ii(0x1013_a16f, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
        ...
        l_0x1013_a179:
            ii(0x1013_a179, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x1013_a17c, 5);  call(0x1007_6bf8, -0xc_3589);         /* call 0x10076bf8 */
        l_0x1013_a181:
            ii(0x1013_a181, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1013_a183, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ...
            ii(0x1013_a18f, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
        ...
        l_0x1013_a1a3:
            ...
            ii(0x1013_a1a5, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x1013_a1a8, 5);  call(0x1007_5e24, -0xc_4389);         /* call 0x10075e24 */
            ii(0x1013_a1ad, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_a1b0, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1013_a1b3, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
