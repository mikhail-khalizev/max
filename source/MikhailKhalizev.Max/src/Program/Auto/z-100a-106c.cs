...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("2c2160b8-3249-477f-9d9f-68e65d92318a")]
        public void Method_100a_106c()
        {
            ii(0x100a_106c, 5); pushd(0x160);                           /* push 0x160 */
            ii(0x100a_1071, 5); calld(Definitions.sys_check_available_stack_size, 0xc4cdc); /* call 0x10165d52 */
            ...
            ii(0x100a_108d, 5); calld(0x1007_1ec5, -0x2f1cd);           /* call 0x10071ec5 */
        ...
        l_0x100a_10a3:
            ...
            ii(0x100a_10ac, 5); calld(0x1008_b268, -0x15e49);           /* call 0x1008b268 */
            ...
            ii(0x100a_10e5, 5); calld(Definitions.sys_sprintf, 0xc4e17); /* call 0x10165f01 */
            ...
            ii(0x100a_10f9, 5); calld(Definitions.sys_strcat, 0xc4e33); /* call 0x10165f31 */
        l_0x100a_10fe:
        ...
        l_0x100a_1102:
            ...
            ii(0x100a_110c, 1); retd(); return;                         /* ret */
        }
    }
}
