...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_106c()
        {
            ...
            ii(0x100a_1083, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_1086, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_1089, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100a_108d, 5); call(0x1007_1ec5, -0x2_f1cd);           /* call 0x10071ec5 */
            ii(0x100a_1092, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100a_1094, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_1097, 4); cmp(dx, memw[ds, eax + 0x2e]);          /* cmp dx, [eax+0x2e] */
            ii(0x100a_109b, 2); if(jg(0x100a_10a3, 0x6)) goto l_0x100a_10a3; /* jg 0x100a10a3 */
            ii(0x100a_109d, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
            ii(0x100a_10a1, 2); jmp(0x100a_1102, 0x5f); goto l_0x100a_1102; /* jmp 0x100a1102 */
        l_0x100a_10a3:
            ii(0x100a_10a3, 3); lea(edx, memd[ss, ebp - 0x4]);          /* lea edx, [ebp-0x4] */
            ii(0x100a_10a6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_10b7, 3); lea(edx, memd[ss, ebp - 0x4]);          /* lea edx, [ebp-0x4] */
            ii(0x100a_10ba, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_10cb, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100a_10de, 6); lea(eax, memd[ss, ebp - 0x138]);        /* lea eax, [ebp-0x138] */
            ...
            ii(0x100a_10ed, 6); lea(edx, memd[ss, ebp - 0x138]);        /* lea edx, [ebp-0x138] */
            ii(0x100a_10f3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_10f6, 3); add(eax, 0x4d);                         /* add eax, 0x4d */
            ii(0x100a_10f9, 5); call(Definitions.sys_strcat, 0xc_4e33); /* call 0x10165f31 */
        l_0x100a_10fe:
            ii(0x100a_10fe, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
        l_0x100a_1102:
            ii(0x100a_1102, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
