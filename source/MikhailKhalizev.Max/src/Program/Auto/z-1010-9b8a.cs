...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1010_9baf:
            ...
            ii(0x1010_9bb6, 8); cmp(memw[ds, 0x101c_4e4c], -0x1 /* 0xff */); /* cmp word [0x101c4e4c], 0xffff */
            ...
            ii(0x1010_9beb, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_9bee, 4); cmp(memd[ss, ebp - 0x8], 0);            /* cmp dword [ebp-0x8], 0x0 */
            ii(0x1010_9bf2, 2); if(jz(0x1010_9c08, 0x14)) goto l_0x1010_9c08; /* jz 0x10109c08 */
            ii(0x1010_9bf4, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_9bf6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1010_9c03, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_9c06, 2); jmp(0x1010_9c0f, 0x7); goto l_0x1010_9c0f; /* jmp 0x10109c0f */
        l_0x1010_9c08:
            ii(0x1010_9c08, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
        l_0x1010_9c0f:
