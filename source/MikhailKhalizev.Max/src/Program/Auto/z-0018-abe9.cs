...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_abe9()
        {
            ...
            ii(0x18_ac10, 3);  shl(bx, 3);                             /* shl bx, 0x3 */
            ...
            ii(0x18_ac1b, 5);  mov(memb[es, bx + 5], 0x8e);            /* mov byte [es:bx+0x5], 0x8e */
            ...
            ii(0x18_ac2b, 2);  push(8);                                /* push 0x8 */
            ii(0x18_ac2d, 1);  pop(ds);                                /* pop ds */
            ii(0x18_ac2e, 2);  mov(si, cx);                            /* mov si, cx */
            ii(0x18_ac30, 4);  test(memb[ds, si + 6], 0x40);           /* test byte [si+0x6], 0x40 */
            ii(0x18_ac34, 1);  pop(ds);                                /* pop ds */
            ii(0x18_ac35, 2);  if(jnz_func(0x18_ac3c, 5)) return;      /* jnz 0xac3c */
            ii(0x18_ac37, 5);  mov(memb[es, bx + 5], 0x86);            /* mov byte [es:bx+0x5], 0x86 */
        }
    }
}
