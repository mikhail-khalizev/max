...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_8f82()
        {
            ...
            ii(0x8f8c, 4);    mov(memw[ss, bp - 264], ax);              /* mov [bp-0x108], ax */
            ii(0x8f90, 5);    cmp(memb[ds, 0xf21], 0);                  /* cmp byte [0xf21], 0x0 */
            ii(0x8f95, 2);    if(jg(0x8f9e, 7)) goto l_0x8f9e;          /* jg 0x8f9e */
            ii(0x8f97, 5);    cmp(memb[ds, 0xcee], 3);                  /* cmp byte [0xcee], 0x3 */
            ii(0x8f9c, 2);    if(jge(0x8fa1, 3)) goto l_0x8fa1;         /* jge 0x8fa1 */
        l_0x8f9e:
            ii(0x8f9e, 3);    jmp(0x90c2, 0x121); goto l_0x90c2;        /* jmp 0x90c2 */
        l_0x8fa1:
            ii(0x8fa1, 3);    call(0x9edc, 0xf38);                      /* call 0x9edc */
            ii(0x8fa4, 4);    mov(memw[ss, bp - 262], ax);              /* mov [bp-0x106], ax */
            ...
            ii(0x8fb2, 4);    lea(ax, memw[ss, bp - 256]);              /* lea ax, [bp-0x100] */
            ...
            ii(0x8fc2, 2);    if(jz(0x8fcd, 9)) goto l_0x8fcd;          /* jz 0x8fcd */
            ii(0x8fc4, 4);    lea(ax, memw[ss, bp - 256]);              /* lea ax, [bp-0x100] */
        ...
        l_0x8fcd:
            ...
            ii(0x8fd4, 4);    mov(ax, memw[ss, bp - 264]);              /* mov ax, [bp-0x108] */
            ii(0x8fd8, 3);    mov(memw[ds, 0xe70], ax);                 /* mov [0xe70], ax */
            ii(0x8fdb, 3);    call(0x95e7, 0x609);                      /* call 0x95e7 */
            ii(0x8fde, 6);    mov(memw[ss, bp - 264], 0xffff);          /* mov word [bp-0x108], 0xffff */
            ...
            ii(0x900a, 5);    mov(memb[ss, bp - 260], 0);               /* mov byte [bp-0x104], 0x0 */
            ii(0x900f, 3);    mov(ax, 6);                               /* mov ax, 0x6 */
            ii(0x9012, 1);    push(ax);                                 /* push ax */
            ii(0x9013, 4);    lea(ax, memw[ss, bp - 260]);              /* lea ax, [bp-0x104] */
            ii(0x9017, 1);    push(ax);                                 /* push ax */
            ii(0x9018, 3);    call(0x95d2, 0x5b7);                      /* call 0x95d2 */
            ii(0x901b, 1);    pop(bx);                                  /* pop bx */
            ii(0x901c, 1);    pop(bx);                                  /* pop bx */
            ii(0x901d, 5);    cmp(memb[ss, bp - 260], 0x4d);            /* cmp byte [bp-0x104], 0x4d */
            ii(0x9022, 2);    if(jnz(0x902b, 7)) goto l_0x902b;         /* jnz 0x902b */
            ii(0x9024, 5);    cmp(memb[ss, bp - 259], 0x46);            /* cmp byte [bp-0x103], 0x46 */
            ii(0x9029, 2);    if(jz(0x9038, 0xd)) goto l_0x9038;        /* jz 0x9038 */
        l_0x902b:
            ii(0x902b, 3);    mov(ax, memw[ds, 0xe70]);                 /* mov ax, [0xe70] */
            ii(0x902e, 4);    mov(memw[ss, bp - 264], ax);              /* mov [bp-0x108], ax */
        ...
        l_0x9038:
            ...
            ii(0x9043, 4);    lea(cx, memw[ss, bp - 256]);              /* lea cx, [bp-0x100] */
            ...
            ii(0x905d, 4);    lea(ax, memw[ss, bp - 256]);              /* lea ax, [bp-0x100] */
        ...
        l_0x906b:
            ...
            ii(0x9072, 4);    lea(ax, memw[ss, bp - 260]);              /* lea ax, [bp-0x104] */
            ii(0x9076, 3);    mov(memw[ds, 0x1188], ax);                /* mov [0x1188], ax */
            ii(0x9079, 2);    sub(ax, ax);                              /* sub ax, ax */
            ii(0x907b, 4);    mov(memw[ss, bp - 258], ax);              /* mov [bp-0x102], ax */
            ii(0x907f, 4);    mov(memw[ss, bp - 266], ax);              /* mov [bp-0x10a], ax */
            ii(0x9083, 3);    mov(ax, 1);                               /* mov ax, 0x1 */
            ii(0x9086, 1);    push(ax);                                 /* push ax */
            ii(0x9087, 4);    lea(ax, memw[ss, bp - 266]);              /* lea ax, [bp-0x10a] */
            ii(0x908b, 1);    push(ax);                                 /* push ax */
            ii(0x908c, 3);    call(0x95d2, 0x543);                      /* call 0x95d2 */
            ii(0x908f, 1);    pop(bx);                                  /* pop bx */
            ii(0x9090, 1);    pop(bx);                                  /* pop bx */
            ii(0x9091, 5);    cmp(memw[ss, bp - 266], 0x4d);            /* cmp word [bp-0x10a], 0x4d */
            ii(0x9096, 2);    if(jnz(0x909d, 5)) goto l_0x909d;         /* jnz 0x909d */
            ii(0x9098, 3);    call(0x93c2, 0x327);                      /* call 0x93c2 */
            ii(0x909b, 2);    jmp(0x90ac, 0xf); goto l_0x90ac;          /* jmp 0x90ac */
        l_0x909d:
            ii(0x909d, 4);    push(memw[ss, bp - 262]);                 /* push word [bp-0x106] */
            ii(0x90a1, 3);    call(0x91cb, 0x127);                      /* call 0x91cb */
            ii(0x90a4, 1);    pop(bx);                                  /* pop bx */
            ii(0x90a5, 2);    or(ax, ax);                               /* or ax, ax */
            ii(0x90a7, 2);    if(jz(0x90b1, 8)) goto l_0x90b1;          /* jz 0x90b1 */
            ii(0x90a9, 3);    call(0x927b, 0x1cf);                      /* call 0x927b */
        l_0x90ac:
            ii(0x90ac, 5);    mov(memb[ds, 0xf21], 1);                  /* mov byte [0xf21], 0x1 */
        l_0x90b1:
            ii(0x90b1, 5);    cmp(memw[ss, bp - 264], 0);               /* cmp word [bp-0x108], 0x0 */
            ii(0x90b6, 2);    if(jl(0x90c2, 0xa)) goto l_0x90c2;        /* jl 0x90c2 */
            ii(0x90b8, 3);    call(0x95e7, 0x52c);                      /* call 0x95e7 */
            ii(0x90bb, 4);    mov(ax, memw[ss, bp - 264]);              /* mov ax, [bp-0x108] */
