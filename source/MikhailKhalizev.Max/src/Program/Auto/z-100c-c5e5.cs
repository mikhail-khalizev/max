...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_c5e5()
        {
            ...
            ii(0x100c_c5fd, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_c600, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100c_c602, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_c611, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_c621, 3); cmp(eax, memd[ss, ebp - 0x4]);          /* cmp eax, [ebp-0x4] */
            ii(0x100c_c624, 2); if(jz(0x100c_c628, 0x2)) goto l_0x100c_c628; /* jz 0x100cc628 */
        l_0x100c_c626:
            ii(0x100c_c626, 2); jmp(0x100c_c647, 0x1f); goto l_0x100c_c647; /* jmp 0x100cc647 */
        l_0x100c_c628:
            ii(0x100c_c628, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_c62b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_c62e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c631, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x100c_c634, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_c641, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_c644, 3); call_abs(memd[ds, ebx + 0x44]);         /* call dword [ebx+0x44] */
        l_0x100c_c647:
