...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_6462()
        {
            ...
            ii(0x1014_647a, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_647d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_6480, 4); cmp(memb[ds, eax + 0x26], 0);           /* cmp byte [eax+0x26], 0x0 */
            ii(0x1014_6484, 2); if(jnz(0x1014_64f1, 0x6b)) goto l_0x1014_64f1; /* jnz 0x101464f1 */
            ii(0x1014_6486, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_6488, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_6497, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_649a, 3); add(eax, 0x18);                         /* add eax, 0x18 */
            ii(0x1014_649d, 5); call(0x100e_0760, -0x6_5d42);           /* call 0x100e0760 */
            ii(0x1014_64a2, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_64a5, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1014_64a8, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x1014_64ab, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1014_64ae, 3); call_abs(memd[ds, edx + 0x18]);         /* call dword [edx+0x18] */
        l_0x1014_64b1:
            ii(0x1014_64b1, 3); lea(edx, memd[ss, ebp - 0x10]);         /* lea edx, [ebp-0x10] */
            ii(0x1014_64b4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_64b7, 3); mov(eax, memd[ds, eax + 0x14]);         /* mov eax, [eax+0x14] */
            ii(0x1014_64ba, 5); call(0x1014_710b, 0xc4c);               /* call 0x1014710b */
            ii(0x1014_64bf, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ...
            ii(0x1014_64d0, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1014_64d3, 5); call(0x100e_03bc, -0x6_611c);           /* call 0x100e03bc */
            ii(0x1014_64d8, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_64da, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_64e7, 2); if(jz(0x1014_64f1, 0x8)) goto l_0x1014_64f1; /* jz 0x101464f1 */
            ii(0x1014_64e9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_64ec, 5); call(0x1014_5bad, -0x944);              /* call 0x10145bad */
        l_0x1014_64f1:
            ii(0x1014_64f1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_64f4, 4); cmp(memb[ds, eax + 0x26], 0);           /* cmp byte [eax+0x26], 0x0 */
            ii(0x1014_64f8, 2); if(jnz(0x1014_6500, 0x6)) goto l_0x1014_6500; /* jnz 0x10146500 */
            ii(0x1014_64fa, 4); mov(memb[ss, ebp - 0x14], 0x1);         /* mov byte [ebp-0x14], 0x1 */
            ii(0x1014_64fe, 2); jmp(0x1014_6504, 0x4); goto l_0x1014_6504; /* jmp 0x10146504 */
        l_0x1014_6500:
            ii(0x1014_6500, 4); mov(memb[ss, ebp - 0x14], 0);           /* mov byte [ebp-0x14], 0x0 */
        l_0x1014_6504:
            ii(0x1014_6504, 3); mov(al, memb[ss, ebp - 0x14]);          /* mov al, [ebp-0x14] */
            ii(0x1014_6507, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x1014_650a, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
