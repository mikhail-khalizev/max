...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_e949()
        {
            ...
            ii(0x19_e95d, 5); mov(memw[ss, bp - 0xc], 0);               /* mov word [bp-0xc], 0x0 */
            ii(0x19_e962, 3); mov(memw[ss, bp - 0xa], ax);              /* mov [bp-0xa], ax */
            ...
            ii(0x19_e970, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x19_e973, 3); mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
        ...
        l_0x19_e98b:
            ii(0x19_e98b, 3); mov(bx, memw[ss, bp - 0xe]);              /* mov bx, [bp-0xe] */
            ...
            ii(0x19_e9a1, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_e9a4, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x19_e9a7, 2); or(dx, ax);                               /* or dx, ax */
            ii(0x19_e9a9, 2); if(jnz(0x19_e9ae, 0x3)) goto l_0x19_e9ae; /* jnz 0xe9ae */
            ii(0x19_e9ab, 3); jmp(0x19_e9ed, 0x3f); goto l_0x19_e9ed;   /* jmp 0xe9ed */
        l_0x19_e9ae:
            ii(0x19_e9ae, 3); push(memw[ss, bp + 0x10]);                /* push word [bp+0x10] */
            ii(0x19_e9b1, 3); push(memw[ss, bp + 0xe]);                 /* push word [bp+0xe] */
            ii(0x19_e9b4, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x19_e9b7, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0x19_e9c5, 2); if(jz(0x19_e9ca, 0x3)) goto l_0x19_e9ca;  /* jz 0xe9ca */
            ii(0x19_e9c7, 3); jmp(0x19_e9ed, 0x23); goto l_0x19_e9ed;   /* jmp 0xe9ed */
        l_0x19_e9ca:
            ii(0x19_e9ca, 3); push(memw[ss, bp + 0xc]);                 /* push word [bp+0xc] */
            ii(0x19_e9cd, 3); push(memw[ss, bp + 0xa]);                 /* push word [bp+0xa] */
            ...
            ii(0x19_e9e4, 3); jmp(0x19_e9ed, 0x6); goto l_0x19_e9ed;    /* jmp 0xe9ed */
        l_0x19_e9e7:
            ii(0x19_e9e7, 3); mov(ax, 0);                               /* mov ax, 0x0 */
            ii(0x19_e9ea, 3); jmp(0x19_ea61, 0x74); goto l_0x19_ea61;   /* jmp 0xea61 */
        l_0x19_e9ed:
            ii(0x19_e9ed, 3); les(bx, memw[ss, bp - 0xc]);              /* les bx, [bp-0xc] */
            ii(0x19_e9f0, 4); mov(ax, memw[es, bx + 0x42]);             /* mov ax, [es:bx+0x42] */
            ii(0x19_e9f4, 4); mov(dx, memw[es, bx + 0x44]);             /* mov dx, [es:bx+0x44] */
            ii(0x19_e9f8, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_e9fb, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
        l_0x19_e9fe:
            ii(0x19_e9fe, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0x19_ea01, 3); or(ax, memw[ss, bp - 0x4]);               /* or ax, [bp-0x4] */
            ii(0x19_ea04, 2); if(jnz(0x19_ea09, 0x3)) goto l_0x19_ea09; /* jnz 0xea09 */
            ii(0x19_ea06, 3); jmp(0x19_ea5b, 0x52); goto l_0x19_ea5b;   /* jmp 0xea5b */
        l_0x19_ea09:
            ii(0x19_ea09, 3); push(memw[ss, bp + 0x10]);                /* push word [bp+0x10] */
            ii(0x19_ea0c, 3); push(memw[ss, bp + 0xe]);                 /* push word [bp+0xe] */
            ii(0x19_ea0f, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x19_ea12, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0x19_ea20, 2); if(jz(0x19_ea25, 0x3)) goto l_0x19_ea25;  /* jz 0xea25 */
            ii(0x19_ea22, 3); jmp(0x19_ea48, 0x23); goto l_0x19_ea48;   /* jmp 0xea48 */
        l_0x19_ea25:
            ii(0x19_ea25, 3); push(memw[ss, bp + 0xc]);                 /* push word [bp+0xc] */
            ii(0x19_ea28, 3); push(memw[ss, bp + 0xa]);                 /* push word [bp+0xa] */
            ...
            ii(0x19_ea3f, 3); jmp(0x19_ea48, 0x6); goto l_0x19_ea48;    /* jmp 0xea48 */
        l_0x19_ea42:
            ii(0x19_ea42, 3); mov(ax, 0);                               /* mov ax, 0x0 */
            ii(0x19_ea45, 3); jmp(0x19_ea61, 0x19); goto l_0x19_ea61;   /* jmp 0xea61 */
        l_0x19_ea48:
            ii(0x19_ea48, 3); les(bx, memw[ss, bp - 0x4]);              /* les bx, [bp-0x4] */
            ii(0x19_ea4b, 3); mov(ax, memw[es, bx]);                    /* mov ax, [es:bx] */
            ii(0x19_ea4e, 4); mov(dx, memw[es, bx + 0x2]);              /* mov dx, [es:bx+0x2] */
            ii(0x19_ea52, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_ea55, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
