...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_31dd()
        {
            ...
            ii(0x1012_31f5, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1012_31f8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_31fb, 4); mov(memb[ds, eax + 0x31], 0);           /* mov byte [eax+0x31], 0x0 */
            ii(0x1012_31ff, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_3202, 4); mov(memb[ds, eax + 0x4b], 0);           /* mov byte [eax+0x4b], 0x0 */
        l_0x1012_3206:
            ii(0x1012_3206, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_3209, 4); cmp(memb[ds, eax + 0x31], 0);           /* cmp byte [eax+0x31], 0x0 */
            ...
            ii(0x1012_3218, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_321b, 4); cmp(memd[ss, ebp - 0x8], 0);            /* cmp dword [ebp-0x8], 0x0 */
            ii(0x1012_321f, 2); if(jle(0x1012_322a, 0x9)) goto l_0x1012_322a; /* jle 0x1012322a */
            ii(0x1012_3221, 7); cmp(memd[ss, ebp - 0x8], 0x7000);       /* cmp dword [ebp-0x8], 0x7000 */
            ii(0x1012_3228, 2); if(jl(0x1012_322c, 0x2)) goto l_0x1012_322c; /* jl 0x1012322c */
        l_0x1012_322a:
            ii(0x1012_322a, 2); jmp(0x1012_3233, 0x7); goto l_0x1012_3233; /* jmp 0x10123233 */
        l_0x1012_322c:
            ii(0x1012_322c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_322f, 4); mov(memb[ds, eax + 0x4b], 0);           /* mov byte [eax+0x4b], 0x0 */
        l_0x1012_3233:
            ii(0x1012_3233, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_3236, 6); cmp(memw[ds, eax + 0x40], 0x6cd);       /* cmp word [eax+0x40], 0x6cd */
            ...
            ii(0x1012_324e, 2); if(jz(0x1012_3257, 0x7)) goto l_0x1012_3257; /* jz 0x10123257 */
            ii(0x1012_3250, 7); mov(memd[ss, ebp - 0x8], 0x3e9);        /* mov dword [ebp-0x8], 0x3e9 */
        l_0x1012_3257:
        ...
        l_0x1012_326a:
            ii(0x1012_326a, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1012_326d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
