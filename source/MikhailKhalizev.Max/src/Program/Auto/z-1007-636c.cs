...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_636c()
        {
            ...
            ii(0x1007_637e, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1007_6384, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1007_6387, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1007_638a, 5); call(0x1007_6c30, 0x8a1);               /* call 0x10076c30 */
            ii(0x1007_638f, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1007_6392, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
