...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_0d25()
        {
            ...
            ii(0x100a_0d3a, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x100a_0d3d, 3); mov(memd[ss, ebp - 12], edx);           /* mov [ebp-0xc], edx */
            ...
            ii(0x100a_0d4c, 7); mov(memd[ss, ebp - 20], 1);             /* mov dword [ebp-0x14], 0x1 */
            ii(0x100a_0d53, 5); jmp(0x100a_0f6e, 0x216); goto l_0x100a_0f6e; /* jmp 0x100a0f6e */
        l_0x100a_0d58:
            ii(0x100a_0d58, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100a_0d5b, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x100a_0d5e, 2); jmp(0x100a_0dad, 0x4d); goto l_0x100a_0dad; /* jmp 0x100a0dad */
        l_0x100a_0d60:
            ii(0x100a_0d60, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_0d63, 3); mov(edx, memd[ds, eax + 54]);           /* mov edx, [eax+0x36] */
            ii(0x100a_0d66, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100a_0d69, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_0d6c, 3); mov(eax, memd[ds, eax + 30]);           /* mov eax, [eax+0x1e] */
            ii(0x100a_0d6f, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100a_0d72, 2); sub(edx, eax);                          /* sub edx, eax */
            ii(0x100a_0d74, 3); mov(memd[ss, ebp - 28], edx);           /* mov [ebp-0x1c], edx */
            ii(0x100a_0d77, 2); jmp(0x100a_0dcc, 0x53); goto l_0x100a_0dcc; /* jmp 0x100a0dcc */
        l_0x100a_0d79:
            ii(0x100a_0d79, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_0d7c, 3); mov(edx, memd[ds, eax + 56]);           /* mov edx, [eax+0x38] */
            ii(0x100a_0d7f, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100a_0d82, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_0d85, 3); mov(eax, memd[ds, eax + 32]);           /* mov eax, [eax+0x20] */
            ii(0x100a_0d88, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100a_0d8b, 2); sub(edx, eax);                          /* sub edx, eax */
            ii(0x100a_0d8d, 3); mov(memd[ss, ebp - 28], edx);           /* mov [ebp-0x1c], edx */
            ii(0x100a_0d90, 2); jmp(0x100a_0dcc, 0x3a); goto l_0x100a_0dcc; /* jmp 0x100a0dcc */
        l_0x100a_0d92:
            ii(0x100a_0d92, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_0d95, 3); mov(edx, memd[ds, eax + 52]);           /* mov edx, [eax+0x34] */
            ii(0x100a_0d98, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100a_0d9b, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_0d9e, 3); mov(eax, memd[ds, eax + 28]);           /* mov eax, [eax+0x1c] */
            ii(0x100a_0da1, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100a_0da4, 2); sub(edx, eax);                          /* sub edx, eax */
            ii(0x100a_0da6, 3); mov(memd[ss, ebp - 28], edx);           /* mov [ebp-0x1c], edx */
        ...
        l_0x100a_0dad:
            ii(0x100a_0dad, 4); cmp(memd[ss, ebp - 24], 0x40);          /* cmp dword [ebp-0x18], 0x40 */
            ii(0x100a_0db1, 2); if(jb(0x100a_0dc4, 0x11)) goto l_0x100a_0dc4; /* jb 0x100a0dc4 */
            ii(0x100a_0db3, 4); cmp(memd[ss, ebp - 24], 0x40);          /* cmp dword [ebp-0x18], 0x40 */
            ii(0x100a_0db7, 2); if(jbe(0x100a_0d92, -0x27)) goto l_0x100a_0d92; /* jbe 0x100a0d92 */
            ii(0x100a_0db9, 7); cmp(memd[ss, ebp - 24], 0x80);          /* cmp dword [ebp-0x18], 0x80 */
        ...
        l_0x100a_0dc4:
            ii(0x100a_0dc4, 4); cmp(memd[ss, ebp - 24], 0x20);          /* cmp dword [ebp-0x18], 0x20 */
        ...
        l_0x100a_0dcc:
            ii(0x100a_0dcc, 4); cmp(memd[ss, ebp - 28], 0);             /* cmp dword [ebp-0x1c], 0x0 */
            ii(0x100a_0dd0, 2); if(jle(0x100a_0dfe, 0x2c)) goto l_0x100a_0dfe; /* jle 0x100a0dfe */
            ii(0x100a_0dd2, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_0dd5, 3); mov(edx, memd[ds, eax + 30]);           /* mov edx, [eax+0x1e] */
            ii(0x100a_0dd8, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100a_0ddb, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_0dde, 3); mov(eax, memd[ds, eax + 32]);           /* mov eax, [eax+0x20] */
            ii(0x100a_0de1, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100a_0de4, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x100a_0de6, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_0de9, 3); mov(eax, memd[ds, eax + 28]);           /* mov eax, [eax+0x1c] */
            ii(0x100a_0dec, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100a_0def, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x100a_0df1, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_0df4, 3); mov(eax, memd[ds, eax + 64]);           /* mov eax, [eax+0x40] */
        ...
        l_0x100a_0e00:
            ii(0x100a_0e00, 3); mov(ecx, memd[ss, ebp - 12]);           /* mov ecx, [ebp-0xc] */
            ii(0x100a_0e03, 3); mov(ebx, memd[ss, ebp - 8]);            /* mov ebx, [ebp-0x8] */
            ii(0x100a_0e06, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x100a_0e09, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ...
            ii(0x100a_0e19, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x100a_0e1c, 2); jmp(0x100a_0e25, 7); goto l_0x100a_0e25; /* jmp 0x100a0e25 */
        l_0x100a_0e1e:
            ii(0x100a_0e1e, 7); mov(memd[ss, ebp - 28], 0);             /* mov dword [ebp-0x1c], 0x0 */
        l_0x100a_0e25:
            ii(0x100a_0e25, 3); mov(ebx, memd[ss, ebp - 28]);           /* mov ebx, [ebp-0x1c] */
            ii(0x100a_0e28, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x100a_0e2b, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_0e2e, 5); call(0x100a_0a0a, -0x429);              /* call 0x100a0a0a */
            ii(0x100a_0e33, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ...
            ii(0x100a_0e41, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x100a_0e44, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_0e47, 5); call(0x100a_0b47, -0x305);              /* call 0x100a0b47 */
            ii(0x100a_0e4c, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
            ii(0x100a_0e4f, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
            ...
            ii(0x100a_0e5d, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x100a_0e60, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_0e63, 5); call(0x100a_0b47, -0x321);              /* call 0x100a0b47 */
            ii(0x100a_0e68, 3); mov(memd[ss, ebp - 36], eax);           /* mov [ebp-0x24], eax */
            ii(0x100a_0e6b, 3); mov(eax, memd[ss, ebp - 36]);           /* mov eax, [ebp-0x24] */
            ...
            ii(0x100a_0e79, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x100a_0e7c, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_0e7f, 5); call(0x100a_0b47, -0x33d);              /* call 0x100a0b47 */
            ii(0x100a_0e84, 3); mov(memd[ss, ebp - 40], eax);           /* mov [ebp-0x28], eax */
            ii(0x100a_0e87, 3); mov(eax, memd[ss, ebp - 40]);           /* mov eax, [ebp-0x28] */
            ii(0x100a_0e8a, 3); sub(memd[ss, ebp - 8], eax);            /* sub [ebp-0x8], eax */
            ii(0x100a_0e8d, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
            ii(0x100a_0e90, 3); add(eax, memd[ss, ebp - 36]);           /* add eax, [ebp-0x24] */
            ii(0x100a_0e93, 3); add(eax, memd[ss, ebp - 40]);           /* add eax, [ebp-0x28] */
            ii(0x100a_0e96, 3); add(memd[ss, ebp - 28], eax);           /* add [ebp-0x1c], eax */
            ii(0x100a_0e99, 4); cmp(memd[ss, ebp - 28], 0);             /* cmp dword [ebp-0x1c], 0x0 */
        ...
        l_0x100a_0eaf:
            ii(0x100a_0eaf, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x100a_0eb2, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x100a_0eb5, 5); jmp(0x100a_0f6e, 0xb4); goto l_0x100a_0f6e; /* jmp 0x100a0f6e */
        l_0x100a_0eba:
            ii(0x100a_0eba, 3); mov(ebx, memd[ss, ebp - 28]);           /* mov ebx, [ebp-0x1c] */
            ii(0x100a_0ebd, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x100a_0ec0, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ...
            ii(0x100a_0ed0, 3); mov(ebx, memd[ss, ebp - 28]);           /* mov ebx, [ebp-0x1c] */
            ii(0x100a_0ed3, 2); neg(ebx);                               /* neg ebx */
            ii(0x100a_0ed5, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x100a_0ed8, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_0edb, 5); call(0x100a_0a0a, -0x4d6);              /* call 0x100a0a0a */
            ii(0x100a_0ee0, 5); mov(ecx, 0x40);                         /* mov ecx, 0x40 */
            ii(0x100a_0ee5, 3); mov(ebx, memd[ss, ebp - 32]);           /* mov ebx, [ebp-0x20] */
            ii(0x100a_0ee8, 5); mov(edx, 0x40);                         /* mov edx, 0x40 */
            ii(0x100a_0eed, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ...
            ii(0x100a_0f02, 3); mov(ebx, memd[ss, ebp - 36]);           /* mov ebx, [ebp-0x24] */
            ii(0x100a_0f05, 5); mov(edx, 0x80);                         /* mov edx, 0x80 */
            ii(0x100a_0f0a, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ...
            ii(0x100a_0f1f, 3); mov(ebx, memd[ss, ebp - 40]);           /* mov ebx, [ebp-0x28] */
            ii(0x100a_0f22, 5); mov(edx, 0x20);                         /* mov edx, 0x20 */
            ii(0x100a_0f27, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ...
            ii(0x100a_0f37, 3); mov(ebx, memd[ss, ebp - 32]);           /* mov ebx, [ebp-0x20] */
            ii(0x100a_0f3a, 5); mov(edx, 0x40);                         /* mov edx, 0x40 */
            ii(0x100a_0f3f, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_0f42, 5); call(0x100a_0a0a, -0x53d);              /* call 0x100a0a0a */
            ii(0x100a_0f47, 3); mov(ebx, memd[ss, ebp - 36]);           /* mov ebx, [ebp-0x24] */
            ii(0x100a_0f4a, 5); mov(edx, 0x80);                         /* mov edx, 0x80 */
            ii(0x100a_0f4f, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_0f52, 5); call(0x100a_0a0a, -0x54d);              /* call 0x100a0a0a */
            ii(0x100a_0f57, 3); mov(ebx, memd[ss, ebp - 40]);           /* mov ebx, [ebp-0x28] */
            ii(0x100a_0f5a, 5); mov(edx, 0x20);                         /* mov edx, 0x20 */
            ii(0x100a_0f5f, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_0f62, 5); call(0x100a_0a0a, -0x55d);              /* call 0x100a0a0a */
            ii(0x100a_0f67, 7); mov(memd[ss, ebp - 20], 0);             /* mov dword [ebp-0x14], 0x0 */
        l_0x100a_0f6e:
            ii(0x100a_0f6e, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
