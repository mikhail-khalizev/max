...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1015_7e83:
            ...
            ii(0x1015_7e8f, 4); test(memb[ds, eax + 0x13], 2);          /* test byte [eax+0x13], 0x2 */
        ...
        l_0x1015_7e97:
            ...
            ii(0x1015_7e9a, 4); mov(memb[ds, eax + 0x3e], 2);           /* mov byte [eax+0x3e], 0x2 */
        l_0x1015_7e9e:
        ...
        l_0x1015_7ec5:
            ...
            ii(0x1015_7ec8, 4); cmp(memb[ds, eax + 0x3d], 4);           /* cmp byte [eax+0x3d], 0x4 */
