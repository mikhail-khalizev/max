...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_4465()
        {
            ...
            ii(0x1014_447d, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_4480, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1014_4487, 2); jmp(0x1014_448f, 0x6); goto l_0x1014_448f; /* jmp 0x1014448f */
        l_0x1014_4489:
            ii(0x1014_4489, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_448c, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x1014_448f:
            ii(0x1014_448f, 4); cmp(memd[ss, ebp - 0x8], 0xb);          /* cmp dword [ebp-0x8], 0xb */
            ii(0x1014_4493, 2); if(jge(0x1014_44c7, 0x32)) goto l_0x1014_44c7; /* jge 0x101444c7 */
            ii(0x1014_4495, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_4498, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1014_449b, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1014_449e, 3); mov(eax, memd[ds, eax + 0x22]);         /* mov eax, [eax+0x22] */
            ii(0x1014_44a1, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1014_44a4, 4); cmp(memd[ss, ebp - 0x10], 0);           /* cmp dword [ebp-0x10], 0x0 */
            ii(0x1014_44a8, 2); if(jz(0x1014_44be, 0x14)) goto l_0x1014_44be; /* jz 0x101444be */
            ii(0x1014_44aa, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_44ac, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x1014_44b9, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_44bc, 2); jmp(0x1014_44c5, 0x7); goto l_0x1014_44c5; /* jmp 0x101444c5 */
        l_0x1014_44be:
            ii(0x1014_44be, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
        l_0x1014_44c5:
            ii(0x1014_44c5, 2); jmp(0x1014_4489, -0x3e); goto l_0x1014_4489; /* jmp 0x10144489 */
        l_0x1014_44c7:
            ii(0x1014_44c7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_44ca, 3); mov(eax, memd[ds, eax + 0x12]);         /* mov eax, [eax+0x12] */
            ii(0x1014_44cd, 5); call(/* sys */ 0x1016_6990, 0x2_24be);  /* call 0x10166990 */
            ii(0x1014_44d2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_44d5, 3); mov(eax, memd[ds, eax + 0x1e]);         /* mov eax, [eax+0x1e] */
