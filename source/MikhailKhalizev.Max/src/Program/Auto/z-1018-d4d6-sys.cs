...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("d9b75549-7e6e-4d0e-93bd-982ebadaf2e2")]
        public void /* sys */ Method_1018_d4d6()
        {
            ii(0x1018_d4d6, 1); pushd(ebx);                             /* push ebx */
            ii(0x1018_d4d7, 1); pushd(ecx);                             /* push ecx */
            ii(0x1018_d4d8, 1); pushd(edx);                             /* push edx */
            ii(0x1018_d4d9, 1); pushd(esi);                             /* push esi */
            ii(0x1018_d4da, 1); pushd(edi);                             /* push edi */
            ii(0x1018_d4db, 6); mov(esi, memd_a32[ds, 0x1020_a1f4]);    /* mov esi, [0x1020a1f4] */
            ii(0x1018_d4e1, 2); test(esi, esi);                         /* test esi, esi */
            ii(0x1018_d4e3, 2); if(jzd(0x1018_d4fe, 0x19)) goto l_0x1018_d4fe; /* jz 0x1018d4fe */
            ii(0x1018_d4e5, 3); mov(ecx, memd_a32[ds, esi + 0x4]);      /* mov ecx, [esi+0x4] */
            ii(0x1018_d4e8, 3); mov(edi, memd_a32[ds, ecx + 0xc]);      /* mov edi, [ecx+0xc] */
            ii(0x1018_d4eb, 2); mov(eax, memd_a32[ds, esi]);            /* mov eax, [esi] */
            ii(0x1018_d4ed, 6); and(edi, 0x4003);                       /* and edi, 0x4003 */
            ii(0x1018_d4f3, 5); mov(memd_a32[ds, 0x1020_a1f4], eax);    /* mov [0x1020a1f4], eax */
            ii(0x1018_d4f8, 4); or(di, 0x3);                            /* or di, 0x3 */
            ii(0x1018_d4fc, 2); jmpd(0x1018_d545, 0x47); goto l_0x1018_d545; /* jmp 0x1018d545 */
        l_0x1018_d4fe:
            ii(0x1018_d4fe, 5); mov(ecx, 0x101b_e5a0);                  /* mov ecx, 0x101be5a0 */
            ii(0x1018_d503, 2); jmpd(0x1018_d525, 0x20); goto l_0x1018_d525; /* jmp 0x1018d525 */
        l_0x1018_d505:
            ...
            ii(0x1018_d51b, 5); mov(edi, 0x3);                          /* mov edi, 0x3 */
            ii(0x1018_d520, 2); jmpd(0x1018_d545, 0x23); goto l_0x1018_d545; /* jmp 0x1018d545 */
        l_0x1018_d522:
        ...
        l_0x1018_d525:
            ...
            ii(0x1018_d542, 3); lea(ecx, eax + 0x8);                    /* lea ecx, [eax+0x8] */
        l_0x1018_d545:
            ...
            ii(0x1018_d55e, 6); mov(memd_a32[ds, 0x1020_b70c], esi);    /* mov [0x1020b70c], esi */
            ii(0x1018_d564, 2); mov(memd_a32[ds, esi], eax);            /* mov [esi], eax */
            ii(0x1018_d566, 2); mov(eax, ecx);                          /* mov eax, ecx */
            ii(0x1018_d568, 2); jmpd(0x1018_d576, 0xc); goto l_0x1018_d576; /* jmp 0x1018d576 */
        l_0x1018_d56a:
            ii(0x1018_d56a, 5); mov(eax, 0x5);                          /* mov eax, 0x5 */
            ii(0x1018_d56f, 5); calld(/* sys */ 0x1018_d3bf, -0x1b5);   /* call 0x1018d3bf */
            ii(0x1018_d574, 2); xor(eax, eax);                          /* xor eax, eax */
        l_0x1018_d576:
            ii(0x1018_d576, 1); popd(edi);                              /* pop edi */
            ii(0x1018_d577, 1); popd(esi);                              /* pop esi */
            ii(0x1018_d578, 1); popd(edx);                              /* pop edx */
            ii(0x1018_d579, 1); popd(ecx);                              /* pop ecx */
            ii(0x1018_d57a, 1); popd(ebx);                              /* pop ebx */
            ii(0x1018_d57b, 1); retd(); return;                         /* ret */
        }
    }
}
