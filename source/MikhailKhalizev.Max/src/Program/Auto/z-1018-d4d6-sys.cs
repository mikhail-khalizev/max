...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_d4d6()
        {
            ...
            ii(0x1018_d4e5, 3); mov(ecx, memd[ds, esi + 0x4]);          /* mov ecx, [esi+0x4] */
            ii(0x1018_d4e8, 3); mov(edi, memd[ds, ecx + 0xc]);          /* mov edi, [ecx+0xc] */
        ...
        l_0x1018_d505:
            ii(0x1018_d505, 4); test(memb[ds, ecx + 0xc], 0x3);         /* test byte [ecx+0xc], 0x3 */
        ...
        l_0x1018_d525:
            ...
            ii(0x1018_d542, 3); lea(ecx, memd[ds, eax + 0x8]);          /* lea ecx, [eax+0x8] */
        l_0x1018_d545:
            ...
            ii(0x1018_d553, 3); mov(memd[ds, ecx + 0xc], edi);          /* mov [ecx+0xc], edi */
            ii(0x1018_d556, 5); mov(eax, memd[ds, 0x1020_b70c]);        /* mov eax, [0x1020b70c] */
            ii(0x1018_d55b, 3); mov(memd[ds, esi + 0x4], ecx);          /* mov [esi+0x4], ecx */
