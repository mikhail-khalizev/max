...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_4f1b()
        {
            ...
            ii(0x1010_4f33, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_4f36, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_4f39, 7); cmp(memd[ds, eax + 0x45d], 0);          /* cmp dword [eax+0x45d], 0x0 */
            ii(0x1010_4f40, 2); if(jg(0x1010_4f48, 0x6)) goto l_0x1010_4f48; /* jg 0x10104f48 */
            ii(0x1010_4f42, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x1010_4f46, 2); jmp(0x1010_4fa0, 0x58); goto l_0x1010_4fa0; /* jmp 0x10104fa0 */
        l_0x1010_4f48:
            ii(0x1010_4f48, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_4f5c, 2); if(jle(0x1010_4f65, 0x7)) goto l_0x1010_4f65; /* jle 0x10104f65 */
            ii(0x1010_4f5e, 7); mov(memd[ss, ebp - 0xc], 0x3e8);        /* mov dword [ebp-0xc], 0x3e8 */
        l_0x1010_4f65:
            ii(0x1010_4f65, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_4f68, 6); mov(ebx, memd[ds, eax + 0x459]);        /* mov ebx, [eax+0x459] */
            ii(0x1010_4f6e, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1010_4f71, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_4f7e, 2); if(jnz(0x1010_4f86, 0x6)) goto l_0x1010_4f86; /* jnz 0x10104f86 */
            ii(0x1010_4f80, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x1010_4f84, 2); jmp(0x1010_4fa0, 0x1a); goto l_0x1010_4fa0; /* jmp 0x10104fa0 */
        l_0x1010_4f86:
            ii(0x1010_4f86, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_4f93, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_4f96, 6); sub(memd[ds, eax + 0x45d], edx);        /* sub [eax+0x45d], edx */
            ii(0x1010_4f9c, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
        l_0x1010_4fa0:
            ii(0x1010_4fa0, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
