...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_4f1b()
        {
            ...
            ii(0x1010_4f39, 7); cmp(memd[ds, eax + 1117], 0);           /* cmp dword [eax+0x45d], 0x0 */
        ...
        l_0x1010_4f48:
            ...
            ii(0x1010_4f4b, 6); mov(eax, memd[ds, eax + 1117]);         /* mov eax, [eax+0x45d] */
            ii(0x1010_4f51, 1); inc(eax);                               /* inc eax */
            ii(0x1010_4f52, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1010_4f55, 7); cmp(memd[ss, ebp - 12], 0x3e8);         /* cmp dword [ebp-0xc], 0x3e8 */
            ii(0x1010_4f5c, 2); if(jle(0x1010_4f65, 7)) goto l_0x1010_4f65; /* jle 0x10104f65 */
            ii(0x1010_4f5e, 7); mov(memd[ss, ebp - 12], 0x3e8);         /* mov dword [ebp-0xc], 0x3e8 */
        l_0x1010_4f65:
            ii(0x1010_4f65, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_4f68, 6); mov(ebx, memd[ds, eax + 1113]);         /* mov ebx, [eax+0x459] */
            ii(0x1010_4f6e, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
        ...
        l_0x1010_4f86:
            ...
            ii(0x1010_4f96, 6); sub(memd[ds, eax + 1117], edx);         /* sub [eax+0x45d], edx */
