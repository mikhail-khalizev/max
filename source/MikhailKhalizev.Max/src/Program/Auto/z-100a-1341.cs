...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_1341()
        {
            ...
            ii(0x100a_1359, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_135c, 4); or(memb[ss, ebp - 0x8], 0x1);           /* or byte [ebp-0x8], 0x1 */
            ii(0x100a_1360, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x100a_1363, 5); call(0x1007_64fc, -0x2_ae6c);           /* call 0x100764fc */
            ii(0x100a_1368, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100a_136b, 4); and(memb[ss, ebp - 0x8], -0x2 /* 0xfe */); /* and byte [ebp-0x8], 0xfe */
            ii(0x100a_136f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_1371, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_1380, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_138d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100a_1395:
            ...
            ii(0x100a_139f, 3); lea(ebx, memd[ss, ebp - 0x10]);         /* lea ebx, [ebp-0x10] */
        ...
        l_0x100a_13ab:
            ...
            ii(0x100a_13ad, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x100a_13b9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_13bc, 3); mov(eax, memd[ds, eax + 0x30]);         /* mov eax, [eax+0x30] */
            ii(0x100a_13bf, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100a_13c2, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100a_13c4, 2); if(jl(0x100a_13c8, 0x2)) goto l_0x100a_13c8; /* jl 0x100a13c8 */
        l_0x100a_13c6:
            ii(0x100a_13c6, 2); jmp(0x100a_13e4, 0x1c); goto l_0x100a_13e4; /* jmp 0x100a13e4 */
        l_0x100a_13c8:
            ii(0x100a_13c8, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x100a_13cb, 5); call(0x1007_6408, -0x2_afc8);           /* call 0x10076408 */
            ii(0x100a_13d0, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100a_13d2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_13d5, 5); call(0x100a_125d, -0x17d);              /* call 0x100a125d */
            ii(0x100a_13da, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x100a_13e4:
            ...
            ii(0x100a_13e6, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
