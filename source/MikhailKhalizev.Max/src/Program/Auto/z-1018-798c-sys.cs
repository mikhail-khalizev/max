...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_798c()
        {
            ...
            ii(0x1018_7991, 4); mov(memw[ds, edx + 0x2], ax);           /* mov [edx+0x2], ax */
            ii(0x1018_7995, 2); mov(eax, ds);                           /* mov eax, ds */
            ii(0x1018_7997, 4); mov(memw[ds, edx + 0x6], ax);           /* mov [edx+0x6], ax */
            ...
            ii(0x1018_79a2, 4); mov(memw[ds, edx + 0x4], ax);           /* mov [edx+0x4], ax */
            ii(0x1018_79a6, 2); mov(eax, fs);                           /* mov eax, fs */
            ii(0x1018_79a8, 4); mov(memw[ds, edx + 0x8], ax);           /* mov [edx+0x8], ax */
            ii(0x1018_79ac, 2); mov(eax, gs);                           /* mov eax, gs */
            ii(0x1018_79ae, 4); mov(memw[ds, edx + 0xa], ax);           /* mov [edx+0xa], ax */
