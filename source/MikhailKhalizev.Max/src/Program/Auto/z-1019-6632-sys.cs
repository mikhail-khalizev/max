...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_6632()
        {
            ...
            ii(0x1019_663e, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1019_6641, 3); mov(eax, memd[ds, edx + 0x4]);          /* mov eax, [edx+0x4] */
            ii(0x1019_6644, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1019_6647, 2); mov(eax, memd[ds, ebx]);                /* mov eax, [ebx] */
            ii(0x1019_6649, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1019_664c, 3); mov(eax, memd[ds, ebx + 0x4]);          /* mov eax, [ebx+0x4] */
            ii(0x1019_664f, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1019_6652, 3); test(cl, 0x40);                         /* test cl, 0x40 */
            ii(0x1019_6655, 2); if(jz(0x1019_665e, 0x7)) goto l_0x1019_665e; /* jz 0x1019665e */
        ...
        l_0x1019_665e:
            ...
            ii(0x1019_6661, 2); if(jz(0x1019_666a, 0x7)) goto l_0x1019_666a; /* jz 0x1019666a */
        ...
        l_0x1019_666a:
            ...
            ii(0x1019_666d, 2); if(jz(0x1019_6676, 0x7)) goto l_0x1019_6676; /* jz 0x10196676 */
        ...
        l_0x1019_6676:
            ...
            ii(0x1019_6679, 2); if(jz(0x1019_6682, 0x7)) goto l_0x1019_6682; /* jz 0x10196682 */
        ...
        l_0x1019_6682:
            ...
            ii(0x1019_6685, 2); if(jz(0x1019_668e, 0x7)) goto l_0x1019_668e; /* jz 0x1019668e */
        ...
        l_0x1019_668e:
            ...
            ii(0x1019_6691, 2); if(jz(0x1019_6698, 0x5)) goto l_0x1019_6698; /* jz 0x10196698 */
        ...
        l_0x1019_6698:
            ...
            ii(0x1019_66a4, 3); mov(memd[ss, ebp - 0x28], esi);         /* mov [ebp-0x28], esi */
            ii(0x1019_66a7, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ...
            ii(0x1019_66b7, 3); fstp(memq[ss, ebp - 0x10]);             /* fstp qword [ebp-0x10] */
        ...
        l_0x1019_66bc:
            ...
            ii(0x1019_66c3, 3); mov(memd[ss, ebp - 0x10], ecx);         /* mov [ebp-0x10], ecx */
            ii(0x1019_66c6, 3); mov(memd[ss, ebp - 0xc], ecx);          /* mov [ebp-0xc], ecx */
        ...
        l_0x1019_66cb:
            ...
            ii(0x1019_66d7, 3); mov(memd[ss, ebp - 0x10], edx);         /* mov [ebp-0x10], edx */
            ii(0x1019_66da, 3); mov(memd[ss, ebp - 0xc], ebx);          /* mov [ebp-0xc], ebx */
        ...
        l_0x1019_66df:
            ...
            ii(0x1019_66e9, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1019_66ec, 5); mov(eax, memd[ds, 0x101b_7704]);        /* mov eax, [0x101b7704] */
            ii(0x1019_66f1, 2); jmp(0x1019_66fb, 0x8); goto l_0x1019_66fb; /* jmp 0x101966fb */
        l_0x1019_66f3:
            ii(0x1019_66f3, 2); mov(eax, memd[ds, ebx]);                /* mov eax, [ebx] */
            ii(0x1019_66f5, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1019_66f8, 3); mov(eax, memd[ds, ebx + 0x4]);          /* mov eax, [ebx+0x4] */
        l_0x1019_66fb:
