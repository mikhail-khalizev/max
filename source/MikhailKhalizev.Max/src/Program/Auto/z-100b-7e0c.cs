...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_7e0c()
        {
            ...
            ii(0x100b_7e1e, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100b_7e24, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100b_7e27, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100b_7e2a, 3); add(eax, 0x20);                         /* add eax, 0x20 */
            ii(0x100b_7e2d, 5); call(0x100a_b33c, -0xcaf6);             /* call 0x100ab33c */
            ii(0x100b_7e32, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100b_7e35, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
