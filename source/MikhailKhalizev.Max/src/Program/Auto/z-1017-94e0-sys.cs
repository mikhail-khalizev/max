...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_94e0()
        {
            ...
            ii(0x1017_94e9, 3); mov(edx, memd[ds, eax + 0x4]);          /* mov edx, [eax+0x4] */
            ii(0x1017_94ec, 2); test(edx, edx);                         /* test edx, edx */
            ii(0x1017_94ee, 2); if(jz(0x1017_9501, 0x11)) goto l_0x1017_9501; /* jz 0x10179501 */
            ii(0x1017_94f0, 4); cmp(memd[ds, eax + 0xc], 0);            /* cmp dword [eax+0xc], 0x0 */
        ...
        l_0x1017_9501:
            ii(0x1017_9501, 4); cmp(memd[ds, esi + 0x8], 0);            /* cmp dword [esi+0x8], 0x0 */
            ...
            ii(0x1017_951c, 7); mov(memd[ds, esi + 0x8], 0);            /* mov dword [esi+0x8], 0x0 */
        l_0x1017_9523:
            ii(0x1017_9523, 7); mov(memd[ds, esi + 0x4], 0);            /* mov dword [esi+0x4], 0x0 */
            ii(0x1017_952a, 3); lea(esp, memd[ss, ebp - 0x10]);         /* lea esp, [ebp-0x10] */
