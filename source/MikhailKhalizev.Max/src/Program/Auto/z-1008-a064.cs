...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_a064()
        {
            ...
            ii(0x1008_a076, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1008_a07c, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1008_a07f, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1008_a082, 3); mov(al, memb[ds, eax + 2]);             /* mov al, [eax+0x2] */
            ii(0x1008_a085, 3); mov(memb[ss, ebp - 8], al);             /* mov [ebp-0x8], al */
            ii(0x1008_a088, 3); mov(al, memb[ss, ebp - 8]);             /* mov al, [ebp-0x8] */
