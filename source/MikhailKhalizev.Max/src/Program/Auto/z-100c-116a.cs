...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_116a()
        {
            ...
            ii(0x100c_1182, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_1185, 6); mov(ax, memw[ds, 0x101c_8172]);         /* mov ax, [0x101c8172] */
            ii(0x100c_118b, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100c_118e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_1191, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
            ii(0x100c_1194, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100c_1197, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_119a, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ii(0x100c_119d, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
        l_0x100c_11a0:
            ii(0x100c_11a0, 3); dec(memd[ss, ebp - 0xc]);               /* dec dword [ebp-0xc] */
            ii(0x100c_11a3, 5); cmp(memw[ss, ebp - 0xc], -0x1 /* 0xff */); /* cmp word [ebp-0xc], 0xffff */
            ...
            ii(0x100c_11ad, 4); add(memd[ss, ebp - 0x1c], 0x4);         /* add dword [ebp-0x1c], 0x4 */
            ...
            ii(0x100c_11b9, 4); add(memd[ss, ebp - 0x18], 0x4);         /* add dword [ebp-0x18], 0x4 */
            ...
            ii(0x100c_11c8, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x100c_11cb:
            ii(0x100c_11cb, 3); dec(memd[ss, ebp - 0x8]);               /* dec dword [ebp-0x8] */
            ii(0x100c_11ce, 5); cmp(memw[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp word [ebp-0x8], 0xffff */
        ...
        l_0x100c_11ef:
            ...
            ii(0x100c_11f2, 4); add(memd[ss, ebp - 0x14], 0x2);         /* add dword [ebp-0x14], 0x2 */
            ii(0x100c_11f6, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100c_11f9, 4); add(memd[ss, ebp - 0x10], 0x2);         /* add dword [ebp-0x10], 0x2 */
