...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_116a()
        {
            ...
            ii(0x100c_118b, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100c_118e, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100c_1191, 3); mov(eax, memd[ds, eax + 4]);            /* mov eax, [eax+0x4] */
            ii(0x100c_1194, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x100c_1197, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100c_119a, 3); mov(eax, memd[ds, eax + 8]);            /* mov eax, [eax+0x8] */
            ii(0x100c_119d, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
        l_0x100c_11a0:
            ii(0x100c_11a0, 3); dec(memd[ss, ebp - 12]);                /* dec dword [ebp-0xc] */
            ii(0x100c_11a3, 5); cmp(memw[ss, ebp - 12], -1 /* 0xff */); /* cmp word [ebp-0xc], 0xffff */
            ii(0x100c_11a8, 2); if(jz(0x100c_1201, 0x57)) goto l_0x100c_1201; /* jz 0x100c1201 */
            ii(0x100c_11aa, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x100c_11ad, 4); add(memd[ss, ebp - 28], 4);             /* add dword [ebp-0x1c], 0x4 */
            ii(0x100c_11b1, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x100c_11b3, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x100c_11b6, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x100c_11b9, 4); add(memd[ss, ebp - 24], 4);             /* add dword [ebp-0x18], 0x4 */
            ii(0x100c_11bd, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x100c_11bf, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
        ...
        l_0x100c_11cb:
            ...
            ii(0x100c_11d5, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ...
            ii(0x100c_11df, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x100c_11e2, 5); mov(memw[ds, eax], 0);                  /* mov word [eax], 0x0 */
            ii(0x100c_11e7, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100c_11ea, 5); mov(memw[ds, eax], 0);                  /* mov word [eax], 0x0 */
        l_0x100c_11ef:
            ii(0x100c_11ef, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x100c_11f2, 4); add(memd[ss, ebp - 20], 2);             /* add dword [ebp-0x14], 0x2 */
            ii(0x100c_11f6, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100c_11f9, 4); add(memd[ss, ebp - 16], 2);             /* add dword [ebp-0x10], 0x2 */
