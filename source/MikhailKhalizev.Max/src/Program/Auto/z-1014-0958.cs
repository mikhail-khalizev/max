...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_0958()
        {
            ...
            ii(0x1014_0970, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_0973, 5); mov(eax, 0x5);                          /* mov eax, 0x5 */
            ii(0x1014_0978, 5); call(/* sys */ 0x1016_a24c, 0x2_98cf);  /* call 0x1016a24c */
            ii(0x1014_097d, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_0980, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_0983, 3); mov(eax, memd[ds, eax + 0x2c]);         /* mov eax, [eax+0x2c] */
            ii(0x1014_0986, 5); call(0x100d_7f6c, -0x6_8a1f);           /* call 0x100d7f6c */
            ii(0x1014_098b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_098e, 4); mov(ax, memw[ds, eax + 0x26]);          /* mov ax, [eax+0x26] */
            ii(0x1014_0992, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_0995, 4); add(ax, memw[ds, edx + 0x2a]);          /* add ax, [edx+0x2a] */
            ii(0x1014_0999, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_099c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_099f, 3); add(eax, 0x1c);                         /* add eax, 0x1c */
            ii(0x1014_09a2, 5); call(Definitions.my_1_get_count, -0x9_54cf); /* call 0x100ab4d8 */
            ii(0x1014_09a7, 4); cmp(ax, memw[ss, ebp - 0xc]);           /* cmp ax, [ebp-0xc] */
            ...
            ii(0x1014_09bf, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_09c2, 3); mov(eax, memd[ds, eax + 0x34]);         /* mov eax, [eax+0x34] */
        ...
        l_0x1014_09cc:
            ...
            ii(0x1014_09e3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_09e6, 3); mov(eax, memd[ds, eax + 0x34]);         /* mov eax, [eax+0x34] */
            ii(0x1014_09e9, 5); call(0x100c_fb06, -0x7_0ee8);           /* call 0x100cfb06 */
        l_0x1014_09ee:
            ii(0x1014_09ee, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_09f1, 3); mov(eax, memd[ds, eax + 0x24]);         /* mov eax, [eax+0x24] */
            ...
            ii(0x1014_0a04, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_0a07, 3); mov(eax, memd[ds, eax + 0x30]);         /* mov eax, [eax+0x30] */
        ...
        l_0x1014_0a11:
            ...
            ii(0x1014_0a23, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_0a26, 3); mov(eax, memd[ds, eax + 0x30]);         /* mov eax, [eax+0x30] */
            ii(0x1014_0a29, 5); call(0x100c_fa7c, -0x7_0fb2);           /* call 0x100cfa7c */
        l_0x1014_0a2e:
            ii(0x1014_0a2e, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1014_0a35, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_0a38, 4); mov(ax, memw[ds, eax + 0x26]);          /* mov ax, [eax+0x26] */
            ii(0x1014_0a3c, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_0a3f, 2); jmp(0x1014_0a47, 0x6); goto l_0x1014_0a47; /* jmp 0x10140a47 */
        l_0x1014_0a41:
            ii(0x1014_0a41, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_0a44, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x1014_0a47:
            ii(0x1014_0a47, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_0a4a, 4); cmp(ax, memw[ss, ebp - 0xc]);           /* cmp ax, [ebp-0xc] */
            ii(0x1014_0a4e, 6); if(jge(0x1014_0af8, 0xa4)) goto l_0x1014_0af8; /* jge 0x10140af8 */
            ii(0x1014_0a54, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_0a57, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_0a5a, 4); cmp(ax, memw[ds, edx + 0x28]);          /* cmp ax, [edx+0x28] */
            ...
            ii(0x1014_0a66, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1014_0a6a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_0a7c, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x1014_0a80, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1014_0a8a:
            ii(0x1014_0a8a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_0a8d, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_0a90, 4); cmp(ax, memw[ds, edx + 0x28]);          /* cmp ax, [edx+0x28] */
            ...
            ii(0x1014_0a9c, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1014_0aa0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_0ab2, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x1014_0ab6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1014_0ac0:
            ...
            ii(0x1014_0ac6, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1014_0aca, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_0adc, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x1014_0ae0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1014_0ae8:
            ...
            ii(0x1014_0af0, 3); add(memd[ss, ebp - 0x10], eax);         /* add [ebp-0x10], eax */
            ii(0x1014_0af3, 5); jmp(0x1014_0a41, -0xb7); goto l_0x1014_0a41; /* jmp 0x10140a41 */
        l_0x1014_0af8:
            ii(0x1014_0af8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_0afb, 3); mov(eax, memd[ds, eax + 0x12]);         /* mov eax, [eax+0x12] */
