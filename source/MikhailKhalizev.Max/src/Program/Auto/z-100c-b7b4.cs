...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("40ca65ec-d622-4f0a-b57c-1f83066fa8b6")]
        public void Method_100c_b7b4()
        {
            ii(0x100c_b7b4, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x100c_b7b9, 5); calld(Definitions.sys_check_available_stack_size, 0x9a594); /* call 0x10165d52 */
            ...
            ii(0x100c_b7e1, 1); retd(); return;                         /* ret */
        }
    }
}
