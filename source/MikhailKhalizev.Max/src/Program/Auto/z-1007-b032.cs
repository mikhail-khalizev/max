...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_b032()
        {
            ...
            ii(0x1007_b04a, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_b04d, 7);  mov(memd[ss, ebp - 12], 0);           /* mov dword [ebp-0xc], 0x0 */
            ii(0x1007_b054, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_b061, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_b064, 5);  call(0x1007_64b8, -0x4bb1);           /* call 0x100764b8 */
            ii(0x1007_b069, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_b06c, 3);  add(eax, 0xf);                        /* add eax, 0xf */
            ii(0x1007_b06f, 5);  call(0x1008_afb4, 0xff40);            /* call 0x1008afb4 */
            ii(0x1007_b074, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1007_b077, 2);  jmp(0x1007_b081, 8); goto l_0x1007_b081;/* jmp 0x1007b081 */
        l_0x1007_b079:
            ii(0x1007_b079, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_b07c, 5);  call(0x1007_6bf8, -0x4489);           /* call 0x10076bf8 */
        l_0x1007_b081:
            ii(0x1007_b081, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_b083, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1007_b08f, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_b092, 5);  call(0x1007_63d4, -0x4cc3);           /* call 0x100763d4 */
            ii(0x1007_b097, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1007_b099, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x1007_b0a5, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_b0b7, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_b0ba, 5);  call(0x1007_63d4, -0x4ceb);           /* call 0x100763d4 */
            ii(0x1007_b0bf, 5);  call(0x1007_af7a, -0x14a);            /* call 0x1007af7a */
            ii(0x1007_b0c4, 3);  add(memd[ss, ebp - 12], eax);         /* add [ebp-0xc], eax */
        l_0x1007_b0c7:
            ii(0x1007_b0c7, 2);  jmp(0x1007_b079, -0x50); goto l_0x1007_b079;/* jmp 0x1007b079 */
        l_0x1007_b0c9:
            ii(0x1007_b0c9, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1007_b0cc, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_b0cf, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_b0d1, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
        ...
        //  ii(0x1007_b0dd, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
        //  ii(0x1007_b0e0, 5);  call(0x1007_5f6c, -0x5179);           /* call 0x10075f6c */
        l_0x1007_b0e5:
            ii(0x1007_b0e5, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
