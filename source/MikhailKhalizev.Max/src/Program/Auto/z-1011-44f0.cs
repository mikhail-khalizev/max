...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_44f0()
        {
            ...
            ii(0x1011_4508, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_450b, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1011_450e, 6); add(edx, 0x21a);                        /* add edx, 0x21a */
            ii(0x1011_4514, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_4517, 5); add(eax, 0x1a2);                        /* add eax, 0x1a2 */
            ii(0x1011_451c, 5); call(Definitions.sys_strcpy, 0x5_19ae); /* call 0x10165ecf */
            ii(0x1011_4521, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_4524, 6); mov(edx, memd[ds, eax + 0x196]);        /* mov edx, [eax+0x196] */
            ii(0x1011_452a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_452d, 6); mov(memd[ds, eax + 0x19e], edx);        /* mov [eax+0x19e], edx */
            ii(0x1011_4533, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1011_4536, 6); add(edx, 0x1a2);                        /* add edx, 0x1a2 */
            ii(0x1011_453c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_453f, 6); mov(eax, memd[ds, eax + 0x19e]);        /* mov eax, [eax+0x19e] */
            ...
            ii(0x1011_4553, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_4556, 6); mov(eax, memd[ds, eax + 0x19e]);        /* mov eax, [eax+0x19e] */
            ii(0x1011_455c, 5); call(0x100e_b5e1, -0x2_8f80);           /* call 0x100eb5e1 */
            ii(0x1011_4561, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_4564, 6); mov(eax, memd[ds, eax + 0x19e]);        /* mov eax, [eax+0x19e] */
