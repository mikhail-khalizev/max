...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_bc34()
        {
            ...
            ii(0x100c_bc4c, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_bc4f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_bc52, 5); call(0x100c_bb8b, -0xcc);               /* call 0x100cbb8b */
            ii(0x100c_bc57, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_bc5a, 5); cmp(memw[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp word [ebp-0x8], 0xffff */
            ii(0x100c_bc5f, 2); if(jz(0x100c_bc6d, 0xc)) goto l_0x100c_bc6d; /* jz 0x100cbc6d */
            ii(0x100c_bc61, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100c_bc65, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_bc68, 5); call(0x100c_bc91, 0x24);                /* call 0x100cbc91 */
        l_0x100c_bc6d:
            ii(0x100c_bc6d, 5); cmp(memw[ss, ebp - 0x8], 0x9);          /* cmp word [ebp-0x8], 0x9 */
            ii(0x100c_bc72, 2); if(jz(0x100c_bc7b, 0x7)) goto l_0x100c_bc7b; /* jz 0x100cbc7b */
            ii(0x100c_bc74, 5); cmp(memw[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp word [ebp-0x8], 0xffff */
            ii(0x100c_bc79, 2); if(jnz(0x100c_bc88, 0xd)) goto l_0x100c_bc88; /* jnz 0x100cbc88 */
        l_0x100c_bc7b:
            ii(0x100c_bc7b, 5); mov(edx, 0x3f);                         /* mov edx, 0x3f */
            ii(0x100c_bc80, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_bc83, 5); call(0x100c_bc91, 0x9);                 /* call 0x100cbc91 */
        l_0x100c_bc88:
