...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_0fe4()
        {
            ...
            ii(0x1017_0ff4, 4);  cmp(memd[ds, esi + 60], 0xa);         /* cmp dword [esi+0x3c], 0xa */
        ...
        l_0x1017_1000:
            ii(0x1017_1000, 5);  cmp(memb[ds, ebx + eax + 72], 0);     /* cmp byte [ebx+eax+0x48], 0x0 */
            ii(0x1017_1005, 2);  if(jnz(0x1017_100d, 6)) goto l_0x1017_100d;/* jnz 0x1017100d */
