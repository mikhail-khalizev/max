...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_514d()
        {
            ...
            ii(0x515a, 3);    shl(bx, 2);                               /* shl bx, 0x2 */
            ii(0x515d, 2);    mov(dx, cs);                              /* mov dx, cs */
            ii(0x515f, 4);    cmp(dx, memw[es, bx + 2]);                /* cmp dx, [es:bx+0x2] */
            ...
            ii(0x516c, 5);    lds(dx, memw[cs, 0x12c4]);                /* lds dx, [cs:0x12c4] */
            ii(0x5171, 2);    if(jz(0x5178, 5)) goto l_0x5178;          /* jz 0x5178 */
            ii(0x5173, 5);    lds(dx, memw[ss, 0xf84]);                 /* lds dx, [ss:0xf84] */
        l_0x5178:
            ii(0x5178, 1);    cli();                                    /* cli */
            ii(0x5179, 3);    mov(memw[es, bx], dx);                    /* mov [es:bx], dx */
            ii(0x517c, 4);    mov(memw[es, bx + 2], ds);                /* mov [es:bx+0x2], ds */
            ii(0x5180, 1);    sti();                                    /* sti */
        ...
        l_0x5185:
            ...
            ii(0x5187, 3);    cmp(ax, memw[ds, bx - 2]);                /* cmp ax, [bx-0x2] */
            ii(0x518a, 2);    if(jnz(0x51c7, 0x3b)) goto l_0x51c7;      /* jnz 0x51c7 */
            ii(0x518c, 3);    cmp(bx, memw[ds, bx - 4]);                /* cmp bx, [bx-0x4] */
            ii(0x518f, 2);    if(jnz(0x51c7, 0x36)) goto l_0x51c7;      /* jnz 0x51c7 */
            ii(0x5191, 3);    mov(ax, memw[ds, bx - 6]);                /* mov ax, [bx-0x6] */
            ii(0x5194, 2);    cmp(dx, ax);                              /* cmp dx, ax */
            ii(0x5196, 2);    if(jz(0x519d, 5)) goto l_0x519d;          /* jz 0x519d */
            ii(0x5198, 3);    mov(bx, memw[ds, bx - 8]);                /* mov bx, [bx-0x8] */
            ii(0x519b, 2);    jmp(0x5185, -0x18); goto l_0x5185;        /* jmp 0x5185 */
        l_0x519d:
            ii(0x519d, 4);    mov(ax, memw[cs, 0x12c4]);                /* mov ax, [cs:0x12c4] */
            ii(0x51a1, 1);    cli();                                    /* cli */
            ii(0x51a2, 3);    mov(memw[ds, bx - 8], ax);                /* mov [bx-0x8], ax */
            ii(0x51a5, 4);    mov(ax, memw[cs, 0x12c6]);                /* mov ax, [cs:0x12c6] */
            ii(0x51a9, 3);    mov(memw[ds, bx - 6], ax);                /* mov [bx-0x6], ax */
            ii(0x51ac, 1);    sti();                                    /* sti */
            ii(0x51ad, 3);    mov(ax, memw[ds, 0]);                     /* mov ax, [0x0] */
            ii(0x51b0, 2);    or(ax, ax);                               /* or ax, ax */
            ii(0x51b2, 2);    if(jnz(0x51b7, 3)) goto l_0x51b7;         /* jnz 0x51b7 */
        ...
        l_0x51b7:
            ...
            ii(0x51c1, 4);    cmp(memw[ds, 1], ax);                     /* cmp [0x1], ax */
            ii(0x51c5, 2);    if(jz(0x51ca, 3)) goto l_0x51ca;          /* jz 0x51ca */
        l_0x51c7:
        ...
        l_0x51ca:
            ...
            ii(0x51d2, 3);    mov(memw[ds, 1], ax);                     /* mov [0x1], ax */
