...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_f810()
        {
            ...
            ii(0x100d_f827, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_f82a, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_f82d, 4);  or(memb[ss, ebp - 12], 1);            /* or byte [ebp-0xc], 0x1 */
            ii(0x100d_f831, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x100d_f834, 5);  call(0x100e_0720, 0xee7);             /* call 0x100e0720 */
            ii(0x100d_f839, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100d_f83c, 4);  and(memb[ss, ebp - 12], -2 /* 0xfe */);/* and byte [ebp-0xc], 0xfe */
            ii(0x100d_f840, 5);  mov(edx, StringDefinitions.Gold5);    /* mov edx, 0x101a1ab4 */
            ii(0x100d_f845, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_f848, 5);  call(0x1014_60aa, 0x6_685d);          /* call 0x101460aa */
            ii(0x100d_f84d, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x100d_f84f, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_f852, 4);  mov(memw[ds, eax + 6], dx);           /* mov [eax+0x6], dx */
            ii(0x100d_f856, 5);  mov(ebx, StringDefinitions.BaseValues);/* mov ebx, 0x101a1ab9 */
            ii(0x100d_f85b, 3);  lea(edx, memd[ss, ebp - 24]);         /* lea edx, [ebp-0x18] */
            ii(0x100d_f85e, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_f861, 5);  call(0x1014_625c, 0x6_69f6);          /* call 0x1014625c */
            ii(0x100d_f866, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x100d_f868, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x100d_f86b, 5);  call(0x100e_06a4, 0xe34);             /* call 0x100e06a4 */
            ii(0x100d_f870, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100d_f872, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x100d_f875, 5);  call(0x100e_03fc, 0xb82);             /* call 0x100e03fc */
            ii(0x100d_f87a, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100d_f87c, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ...
            ii(0x100d_f88c, 4);  or(memb[ss, ebp - 12], 1);            /* or byte [ebp-0xc], 0x1 */
            ii(0x100d_f890, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
            ii(0x100d_f893, 5);  call(0x100e_0720, 0xe88);             /* call 0x100e0720 */
            ii(0x100d_f898, 3);  mov(memd[ss, ebp - 40], eax);         /* mov [ebp-0x28], eax */
            ii(0x100d_f89b, 4);  and(memb[ss, ebp - 12], -2 /* 0xfe */);/* and byte [ebp-0xc], 0xfe */
        l_0x100d_f89f:
            ii(0x100d_f89f, 2);  xor(ecx, ecx);                        /* xor ecx, ecx */
            ii(0x100d_f8a1, 5);  mov(ebx, StringDefinitions.Unit3);    /* mov ebx, 0x101a1ac5 */
            ii(0x100d_f8a6, 3);  lea(edx, memd[ss, ebp - 44]);         /* lea edx, [ebp-0x2c] */
            ii(0x100d_f8a9, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x100d_f8ac, 5);  call(0x100e_0648, 0xd97);             /* call 0x100e0648 */
            ii(0x100d_f8b1, 5);  call(0x1014_625c, 0x6_69a6);          /* call 0x1014625c */
            ii(0x100d_f8b6, 3);  lea(ebx, memd[ss, ebp - 36]);         /* lea ebx, [ebp-0x24] */
            ...
            ii(0x100d_f8cb, 2);  if(jz(0x100d_f8d6, 9)) goto l_0x100d_f8d6;/* jz 0x100df8d6 */
            ii(0x100d_f8cd, 7);  mov(memd[ss, ebp - 48], 1);           /* mov dword [ebp-0x30], 0x1 */
            ii(0x100d_f8d4, 2);  jmp(0x100d_f8dd, 7); goto l_0x100d_f8dd;/* jmp 0x100df8dd */
        l_0x100d_f8d6:
            ii(0x100d_f8d6, 7);  mov(memd[ss, ebp - 48], 0);           /* mov dword [ebp-0x30], 0x0 */
        l_0x100d_f8dd:
            ii(0x100d_f8dd, 3);  mov(eax, memd[ss, ebp - 48]);         /* mov eax, [ebp-0x30] */
            ii(0x100d_f8e0, 3);  mov(memd[ss, ebp - 52], eax);         /* mov [ebp-0x34], eax */
            ii(0x100d_f8e3, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100d_f8e5, 3);  lea(eax, memd[ss, ebp - 44]);         /* lea eax, [ebp-0x2c] */
            ii(0x100d_f8e8, 5);  call(0x100e_03fc, 0xb0f);             /* call 0x100e03fc */
            ii(0x100d_f8ed, 4);  cmp(memd[ss, ebp - 52], 0);           /* cmp dword [ebp-0x34], 0x0 */
            ii(0x100d_f8f1, 2);  if(jz(0x100d_f952, 0x5f)) goto l_0x100d_f952;/* jz 0x100df952 */
            ii(0x100d_f8f3, 3);  lea(ecx, memd[ss, ebp - 56]);         /* lea ecx, [ebp-0x38] */
            ...
            ii(0x100d_f900, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
            ...
            ii(0x100d_f916, 3);  lea(edx, memd[ss, ebp - 60]);         /* lea edx, [ebp-0x3c] */
            ii(0x100d_f919, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
            ...
            ii(0x100d_f92d, 4);  movsx(eax, memw[ss, ebp - 56]);       /* movsx eax, word [ebp-0x38] */
            ii(0x100d_f931, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x100d_f934, 2);  mov(ebx, eax);                        /* mov ebx, eax */
            ii(0x100d_f936, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_f939, 3);  add(eax, 8);                          /* add eax, 0x8 */
            ...
            ii(0x100d_f945, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
        ...
        l_0x100d_f952:
            ...
            ii(0x100d_f954, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
        ...
        l_0x100d_f95c:
            ...
            ii(0x100d_f992, 4);  or(memb[ss, ebp - 12], 1);            /* or byte [ebp-0xc], 0x1 */
            ii(0x100d_f996, 3);  lea(eax, memd[ss, ebp - 64]);         /* lea eax, [ebp-0x40] */
            ii(0x100d_f999, 5);  call(0x100e_0720, 0xd82);             /* call 0x100e0720 */
            ii(0x100d_f99e, 3);  mov(memd[ss, ebp - 68], eax);         /* mov [ebp-0x44], eax */
            ii(0x100d_f9a1, 4);  and(memb[ss, ebp - 12], -2 /* 0xfe */);/* and byte [ebp-0xc], 0xfe */
        l_0x100d_f9a5:
            ii(0x100d_f9a5, 2);  xor(ecx, ecx);                        /* xor ecx, ecx */
            ii(0x100d_f9a7, 5);  mov(ebx, StringDefinitions.Unit4);    /* mov ebx, 0x101a1ae5 */
            ii(0x100d_f9ac, 3);  lea(edx, memd[ss, ebp - 72]);         /* lea edx, [ebp-0x48] */
            ii(0x100d_f9af, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x100d_f9b2, 5);  call(0x100e_0648, 0xc91);             /* call 0x100e0648 */
            ii(0x100d_f9b7, 5);  call(0x1014_625c, 0x6_68a0);          /* call 0x1014625c */
            ii(0x100d_f9bc, 3);  lea(ebx, memd[ss, ebp - 64]);         /* lea ebx, [ebp-0x40] */
            ...
            ii(0x100d_f9d1, 2);  if(jz(0x100d_f9dc, 9)) goto l_0x100d_f9dc;/* jz 0x100df9dc */
            ii(0x100d_f9d3, 7);  mov(memd[ss, ebp - 76], 1);           /* mov dword [ebp-0x4c], 0x1 */
            ii(0x100d_f9da, 2);  jmp(0x100d_f9e3, 7); goto l_0x100d_f9e3;/* jmp 0x100df9e3 */
        l_0x100d_f9dc:
            ii(0x100d_f9dc, 7);  mov(memd[ss, ebp - 76], 0);           /* mov dword [ebp-0x4c], 0x0 */
        l_0x100d_f9e3:
            ii(0x100d_f9e3, 3);  mov(eax, memd[ss, ebp - 76]);         /* mov eax, [ebp-0x4c] */
            ii(0x100d_f9e6, 3);  mov(memd[ss, ebp - 80], eax);         /* mov [ebp-0x50], eax */
            ii(0x100d_f9e9, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100d_f9eb, 3);  lea(eax, memd[ss, ebp - 72]);         /* lea eax, [ebp-0x48] */
            ii(0x100d_f9ee, 5);  call(0x100e_03fc, 0xa09);             /* call 0x100e03fc */
            ii(0x100d_f9f3, 4);  cmp(memd[ss, ebp - 80], 0);           /* cmp dword [ebp-0x50], 0x0 */
            ii(0x100d_f9f7, 2);  if(jz(0x100d_fa5a, 0x61)) goto l_0x100d_fa5a;/* jz 0x100dfa5a */
            ii(0x100d_f9f9, 3);  lea(ecx, memd[ss, ebp - 84]);         /* lea ecx, [ebp-0x54] */
            ...
            ii(0x100d_fa06, 3);  lea(eax, memd[ss, ebp - 64]);         /* lea eax, [ebp-0x40] */
            ...
            ii(0x100d_fa1c, 3);  lea(edx, memd[ss, ebp - 88]);         /* lea edx, [ebp-0x58] */
            ii(0x100d_fa1f, 3);  lea(eax, memd[ss, ebp - 64]);         /* lea eax, [ebp-0x40] */
            ...
            ii(0x100d_fa33, 4);  movsx(eax, memw[ss, ebp - 84]);       /* movsx eax, word [ebp-0x54] */
            ii(0x100d_fa37, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x100d_fa3a, 2);  mov(ebx, eax);                        /* mov ebx, eax */
            ii(0x100d_fa3c, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_fa4d, 3);  lea(eax, memd[ss, ebp - 88]);         /* lea eax, [ebp-0x58] */
        ...
        l_0x100d_fa5a:
            ...
            ii(0x100d_fa5c, 3);  lea(eax, memd[ss, ebp - 64]);         /* lea eax, [ebp-0x40] */
            ii(0x100d_fa5f, 5);  call(0x100e_03fc, 0x998);             /* call 0x100e03fc */
        l_0x100d_fa64:
            ii(0x100d_fa64, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_fa67, 5);  add(eax, 0x114);                      /* add eax, 0x114 */
            ii(0x100d_fa6c, 5);  call(0x1007_6730, -0x6_9341);         /* call 0x10076730 */
            ii(0x100d_fa71, 4);  mov(memb[ds, eax + 22], 0);           /* mov byte [eax+0x16], 0x0 */
            ii(0x100d_fa75, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_fa78, 5);  add(eax, 0x288);                      /* add eax, 0x288 */
            ii(0x100d_fa7d, 5);  call(0x1007_6730, -0x6_9352);         /* call 0x10076730 */
            ii(0x100d_fa82, 4);  mov(memb[ds, eax + 22], 0);           /* mov byte [eax+0x16], 0x0 */
            ii(0x100d_fa86, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_fac9, 4);  or(memb[ss, ebp - 12], 1);            /* or byte [ebp-0xc], 0x1 */
            ii(0x100d_facd, 3);  lea(eax, memd[ss, ebp - 92]);         /* lea eax, [ebp-0x5c] */
            ii(0x100d_fad0, 5);  call(0x100e_0838, 0xd63);             /* call 0x100e0838 */
            ii(0x100d_fad5, 3);  mov(memd[ss, ebp - 96], eax);         /* mov [ebp-0x60], eax */
            ii(0x100d_fad8, 4);  and(memb[ss, ebp - 12], -2 /* 0xfe */);/* and byte [ebp-0xc], 0xfe */
        l_0x100d_fadc:
            ii(0x100d_fadc, 2);  xor(ecx, ecx);                        /* xor ecx, ecx */
            ii(0x100d_fade, 5);  mov(ebx, StringDefinitions.Complex2); /* mov ebx, 0x101a1b00 */
            ii(0x100d_fae3, 3);  lea(edx, memd[ss, ebp - 100]);        /* lea edx, [ebp-0x64] */
            ii(0x100d_fae6, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x100d_fae9, 5);  call(0x100e_0648, 0xb5a);             /* call 0x100e0648 */
            ii(0x100d_faee, 5);  call(0x1014_630a, 0x6_6817);          /* call 0x1014630a */
            ii(0x100d_faf3, 3);  lea(ebx, memd[ss, ebp - 92]);         /* lea ebx, [ebp-0x5c] */
            ...
            ii(0x100d_fb08, 2);  if(jz(0x100d_fb13, 9)) goto l_0x100d_fb13;/* jz 0x100dfb13 */
            ii(0x100d_fb0a, 7);  mov(memd[ss, ebp - 104], 1);          /* mov dword [ebp-0x68], 0x1 */
            ii(0x100d_fb11, 2);  jmp(0x100d_fb1a, 7); goto l_0x100d_fb1a;/* jmp 0x100dfb1a */
        l_0x100d_fb13:
            ii(0x100d_fb13, 7);  mov(memd[ss, ebp - 104], 0);          /* mov dword [ebp-0x68], 0x0 */
        l_0x100d_fb1a:
            ii(0x100d_fb1a, 3);  mov(eax, memd[ss, ebp - 104]);        /* mov eax, [ebp-0x68] */
            ii(0x100d_fb1d, 3);  mov(memd[ss, ebp - 108], eax);        /* mov [ebp-0x6c], eax */
            ii(0x100d_fb20, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100d_fb22, 3);  lea(eax, memd[ss, ebp - 100]);        /* lea eax, [ebp-0x64] */
            ii(0x100d_fb25, 5);  call(0x100e_03bc, 0x892);             /* call 0x100e03bc */
            ii(0x100d_fb2a, 4);  cmp(memd[ss, ebp - 108], 0);          /* cmp dword [ebp-0x6c], 0x0 */
            ii(0x100d_fb2e, 2);  if(jz(0x100d_fb58, 0x28)) goto l_0x100d_fb58;/* jz 0x100dfb58 */
            ii(0x100d_fb30, 3);  lea(eax, memd[ss, ebp - 92]);         /* lea eax, [ebp-0x5c] */
            ii(0x100d_fb33, 5);  call(0x100e_0760, 0xc28);             /* call 0x100e0760 */
            ii(0x100d_fb38, 3);  mov(memd[ss, ebp - 112], eax);        /* mov [ebp-0x70], eax */
            ii(0x100d_fb3b, 3);  mov(eax, memd[ss, ebp - 112]);        /* mov eax, [ebp-0x70] */
            ii(0x100d_fb3e, 3);  mov(edx, memd[ds, eax + 2]);          /* mov edx, [eax+0x2] */
            ii(0x100d_fb41, 3);  mov(eax, memd[ss, ebp - 112]);        /* mov eax, [ebp-0x70] */
            ii(0x100d_fb44, 3);  call_abs(memd[ds, edx + 16]);         /* call dword [edx+0x10] */
            ii(0x100d_fb47, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x100d_fb49, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_fb58:
            ...
            ii(0x100d_fb5a, 3);  lea(eax, memd[ss, ebp - 92]);         /* lea eax, [ebp-0x5c] */
            ii(0x100d_fb5d, 5);  call(0x100e_03bc, 0x85a);             /* call 0x100e03bc */
        l_0x100d_fb62:
            ii(0x100d_fb62, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100d_fb64, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
