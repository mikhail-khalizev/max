...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_d4e0()
        {
            ...
            ii(0x100c_d4f8, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_d4fb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_d508, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_d50b, 3); mov(ebx, memd[ds, eax + 0x7]);          /* mov ebx, [eax+0x7] */
            ...
            ii(0x100c_d525, 2); if(jz(0x100c_d52d, 0x6)) goto l_0x100c_d52d; /* jz 0x100cd52d */
            ii(0x100c_d527, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x100c_d52b, 2); jmp(0x100c_d567, 0x3a); goto l_0x100c_d567; /* jmp 0x100cd567 */
        l_0x100c_d52d:
            ii(0x100c_d52d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_d53a, 3); mov(dl, memb[ds, eax + 0x54]);          /* mov dl, [eax+0x54] */
            ii(0x100c_d53d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_d54d, 3); mov(eax, memd[ds, eax + 0x19]);         /* mov eax, [eax+0x19] */
            ii(0x100c_d550, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100c_d553, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x100c_d555, 2); if(jl(0x100c_d55d, 0x6)) goto l_0x100c_d55d; /* jl 0x100cd55d */
            ii(0x100c_d557, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x100c_d55b, 2); jmp(0x100c_d561, 0x4); goto l_0x100c_d561; /* jmp 0x100cd561 */
        l_0x100c_d55d:
            ii(0x100c_d55d, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
        l_0x100c_d561:
            ii(0x100c_d561, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
            ii(0x100c_d564, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
        l_0x100c_d567:
            ii(0x100c_d567, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
