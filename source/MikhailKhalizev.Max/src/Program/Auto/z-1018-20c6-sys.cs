...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("32578124-6bc5-41b0-aeac-97415d8d326b")]
        public void /* sys */ Method_1018_20c6()
        {
            ...
            ii(0x1018_20ce, 6); mov(memd_a32[ds, 0x101b_e80c], ebx);    /* mov [0x101be80c], ebx */
            ii(0x1018_20d4, 7); mov(memw_a32[ds, 0x101b_e810], es);     /* mov [0x101be810], es */
            ii(0x1018_20db, 7); cmp(memb_a32[ds, 0x101b_e58e], 0x3);    /* cmp byte [0x101be58e], 0x3 */
            ...
            ii(0x1018_20ea, 1); popd(ds);                               /* pop ds */
            ii(0x1018_20eb, 2); if(jld(0x1018_20fd, 0x10)) goto l_0x1018_20fd; /* jl 0x101820fd */
            ii(0x1018_20ed, 6); lea(edx, /* sys */ 0x1019_6bdc);        /* lea edx, [0x10196bdc] */
            ii(0x1018_20f3, 2); @int(0x21);                             /* int 0x21 */
            ii(0x1018_20f5, 1); popd(ds);                               /* pop ds */
            ii(0x1018_20f6, 5); calld(/* sys */ 0x1018_2113, 0x18);     /* call 0x10182113 */
            ii(0x1018_20fb, 2); jmpd(0x1018_2112, 0x15); goto l_0x1018_2112; /* jmp 0x10182112 */
        l_0x1018_20fd:
        ...
        l_0x1018_2112:
            ii(0x1018_2112, 1); retd(); return;                         /* ret */
        }
    }
}
