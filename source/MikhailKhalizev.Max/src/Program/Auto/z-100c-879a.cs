...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_879a()
        {
            ...
            ii(0x100c_87b2, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_87b5, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100c_87b7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_87ba, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x100c_87bd, 5); call(0x1008_afe4, -0x3_d7de);           /* call 0x1008afe4 */
            ii(0x100c_87c2, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
