...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_bac1()
        {
            ...
            ii(0x1013_bad8, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_badb, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_bade, 5); call(0x1013_c6ac, 0xbc9);               /* call 0x1013c6ac */
            ii(0x1013_bae3, 3); movsx(ebx, ax);                         /* movsx ebx, ax */
            ii(0x1013_bae6, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1013_bae9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_baec, 3); add(eax, 0x4);                          /* add eax, 0x4 */
            ii(0x1013_baef, 5); call(0x1013_c5c0, 0xacc);               /* call 0x1013c5c0 */
            ii(0x1013_baf4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_baf7, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1013_bafa, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_bafd, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x1013_bb00, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1013_bb03, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_bb06, 3); call_abs(memd[ds, ebx + 0x8]);          /* call dword [ebx+0x8] */
