...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x1_1073, 1);  push(si);                                 /* push si */
            ii(0x1_1074, 1);  push(di);                                 /* push di */
            ii(0x1_1075, 1);  push(ds);                                 /* push ds */
            ii(0x1_1076, 3);  mov(ax, 6);                               /* mov ax, 0x6 */
            ...
            ii(0x1_1083, 3);  mov(ax, memw[ds, 0x50]);                  /* mov ax, [0x50] */
        ...
        l_0x1_1091:
            ...
            ii(0x1_109b, 2);  if(jnz(0x1_10a0, 3)) goto l_0x1_10a0;     /* jnz 0x10a0 */
            ii(0x1_109d, 3);  mov(ax, 0x52b9);                          /* mov ax, 0x52b9 */
        l_0x1_10a0:
            ii(0x1_10a0, 2);  mov(memw[ds, di], ax);                    /* mov [di], ax */
            ii(0x1_10a2, 5);  mov(memw[ds, di + 2], 0);                 /* mov word [di+0x2], 0x0 */
            ii(0x1_10a7, 3);  mov(memw[ds, di + 4], cs);                /* mov [di+0x4], cs */
            ii(0x1_10aa, 2);  mov(ah, 0x40);                            /* mov ah, 0x40 */
            ii(0x1_10ac, 2);  mov(al, cl);                              /* mov al, cl */
            ii(0x1_10ae, 2);  sub(al, bl);                              /* sub al, bl */
        l_0x1_10b0:
            ii(0x1_10b0, 2);  cmp(al, 8);                               /* cmp al, 0x8 */
            ii(0x1_10b2, 2);  if(jb(0x1_10bc, 8)) goto l_0x1_10bc;      /* jb 0x10bc */
            ii(0x1_10b4, 2);  mov(al, cl);                              /* mov al, cl */
            ii(0x1_10b6, 2);  sub(al, bh);                              /* sub al, bh */
            ii(0x1_10b8, 2);  shl(ah, 1);                               /* shl ah, 1 */
            ii(0x1_10ba, 2);  if(jnz(0x1_10b0, -0xc)) goto l_0x1_10b0;  /* jnz 0x10b0 */
        l_0x1_10bc:
            ...
            ii(0x1_10cb, 2);  if(jz(0x1_10df, 0x12)) goto l_0x1_10df;   /* jz 0x10df */
            ii(0x1_10cd, 2);  test(ah, ah);                             /* test ah, ah */
            ii(0x1_10cf, 3);  mov(ax, 0x5328);                          /* mov ax, 0x5328 */
            ii(0x1_10d2, 2);  if(jnz(0x1_10d7, 3)) goto l_0x1_10d7;     /* jnz 0x10d7 */
        ...
        l_0x1_10df:
            ...
            ii(0x1_10e5, 4);  if(jnz(0x1_10fd, 0x14)) goto l_0x1_10fd;  /* jnz 0x10fd */
            ii(0x1_10e9, 3);  test(dh, 2);                              /* test dh, 0x2 */
            ii(0x1_10ec, 4);  if(jz(0x1_10f5, 5)) goto l_0x1_10f5;      /* jz 0x10f5 */
            ii(0x1_10f0, 1);  lodsw();                                  /* lodsw */
            ii(0x1_10f1, 1);  xchg(dx, ax);                             /* xchg dx, ax */
            ii(0x1_10f2, 1);  lodsw();                                  /* lodsw */
            ii(0x1_10f3, 2);  jmp(0x1_1102, 0xd); goto l_0x1_1102;      /* jmp 0x1102 */
        l_0x1_10f5:
            ii(0x1_10f5, 3);  add(ax, 0xc3c);                           /* add ax, 0xc3c */
            ii(0x1_10f8, 3);  mov(dx, 0x18);                            /* mov dx, 0x18 */
            ii(0x1_10fb, 2);  jmp(0x1_1102, 5); goto l_0x1_1102;        /* jmp 0x1102 */
        l_0x1_10fd:
        ...
        l_0x1_1102:
            ...
            ii(0x1_1114, 4);  if(jbe(0x1_1091, -0x87)) goto l_0x1_1091; /* jbe 0x1091 */
            ii(0x1_1118, 1);  push(ds);                                 /* push ds */
            ii(0x1_1119, 1);  pop(es);                                  /* pop es */
            ii(0x1_111a, 1);  pop(ds);                                  /* pop ds */
            ii(0x1_111b, 5);  test(memb[ds, 0x47], 1);                  /* test byte [0x47], 0x1 */
            ii(0x1_1120, 2);  if(jz(0x1_1139, 0x17)) goto l_0x1_1139;   /* jz 0x1139 */
            ii(0x1_1122, 3);  mov(di, 0x43f0);                          /* mov di, 0x43f0 */
            ii(0x1_1125, 3);  mov(ax, 0x52c9);                          /* mov ax, 0x52c9 */
            ii(0x1_1128, 1);  stosw();                                  /* stosw */
            ii(0x1_1129, 3);  mov(ax, 0x70);                            /* mov ax, 0x70 */
            ii(0x1_112c, 1);  stosw();                                  /* stosw */
            ii(0x1_112d, 3);  mov(di, 0x43fa);                          /* mov di, 0x43fa */
            ii(0x1_1130, 3);  mov(ax, 0xed1);                           /* mov ax, 0xed1 */
            ii(0x1_1133, 1);  stosw();                                  /* stosw */
            ii(0x1_1134, 3);  mov(ax, 0x1a83);                          /* mov ax, 0x1a83 */
            ii(0x1_1137, 2);  jmp(0x1_1141, 8); goto l_0x1_1141;        /* jmp 0x1141 */
        l_0x1_1139:
            ii(0x1_1139, 3);  cmp(bh, 0x10);                            /* cmp bh, 0x10 */
            ii(0x1_113c, 2);  if(jnz(0x1_114b, 0xd)) goto l_0x1_114b;   /* jnz 0x114b */
            ii(0x1_113e, 3);  mov(ax, 0x7d80);                          /* mov ax, 0x7d80 */
        l_0x1_1141:
            ii(0x1_1141, 3);  mov(di, 0x43ff);                          /* mov di, 0x43ff */
            ii(0x1_1144, 1);  stosw();                                  /* stosw */
            ii(0x1_1145, 1);  inc(di);                                  /* inc di */
            ii(0x1_1146, 1);  inc(di);                                  /* inc di */
            ii(0x1_1147, 3);  mov(ax, 0x70);                            /* mov ax, 0x70 */
            ii(0x1_114a, 1);  stosw();                                  /* stosw */
        l_0x1_114b:
            ii(0x1_114b, 1);  pop(di);                                  /* pop di */
            ii(0x1_114c, 1);  pop(si);                                  /* pop si */
            ii(0x1_114d, 5);  jmp_far_abs(0x18, 0x2089);                /* jmp word 0x18:0x2089 */
        }
    }
}
