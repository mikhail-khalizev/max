...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_7b68()
        {
            ...
            ii(0x100c_7b7e, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ...
            ii(0x100c_7ba3, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ii(0x100c_7ba6, 5); call(0x1008_b148, -0x3_ca63);           /* call 0x1008b148 */
            ii(0x100c_7bab, 3); push(memd[ds, eax + 12]);               /* push dword [eax+0xc] */
            ...
            ii(0x100c_7bb6, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100c_7bb9, 5); call(0x1009_02f8, -0x3_78c6);           /* call 0x100902f8 */
            ii(0x100c_7bbe, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100c_7bc1, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100c_7bc4, 7); mov(memd[ds, eax + 35], 0x101b_58ec);   /* mov dword [eax+0x23], 0x101b58ec */
            ii(0x100c_7bcb, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100c_7bce, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x100c_7bd1, 3); mov(memd[ds, edx + 39], eax);           /* mov [edx+0x27], eax */
            ii(0x100c_7bd4, 3); mov(al, memb[ss, ebp - 4]);             /* mov al, [ebp-0x4] */
            ii(0x100c_7bd7, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x100c_7bda, 3); mov(memb[ds, edx + 43], al);            /* mov [edx+0x2b], al */
            ii(0x100c_7bdd, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100c_7be0, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
            ii(0x100c_7be3, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
