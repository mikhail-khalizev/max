...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_7b68()
        {
            ...
            ii(0x100c_7b81, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100c_7b84, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ...
            ii(0x100c_7bae, 3); push(memd[ds, eax + 0x8]);              /* push dword [eax+0x8] */
            ii(0x100c_7bb1, 3); push(memd[ds, eax + 0x4]);              /* push dword [eax+0x4] */
