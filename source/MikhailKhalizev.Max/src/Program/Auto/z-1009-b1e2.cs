...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_b1e2()
        {
            ...
            ii(0x1009_b1fa, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_b1fd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_b20b, 2); if(jnz(0x1009_b213, 0x6)) goto l_0x1009_b213; /* jnz 0x1009b213 */
            ii(0x1009_b20d, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x1009_b211, 2); jmp(0x1009_b217, 0x4); goto l_0x1009_b217; /* jmp 0x1009b217 */
        l_0x1009_b213:
            ii(0x1009_b213, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x1009_b217:
            ii(0x1009_b217, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x1009_b21a, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x1009_b21d, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
