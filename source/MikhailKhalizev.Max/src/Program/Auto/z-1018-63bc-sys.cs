...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_63bc()
        {
            ...
            ii(0x1018_63cc, 2); if(jb(0x1018_63d5, 0x7)) goto l_0x1018_63d5; /* jb 0x101863d5 */
        ...
        l_0x1018_6441:
            ...
            ii(0x1018_6447, 7); lea(eax, memd[ds, edx * 4 + 0]);        /* lea eax, [edx*4] */
            ...
            ii(0x1018_6461, 3); cmp(ebx, memd[ds, edx + 0x8]);          /* cmp ebx, [edx+0x8] */
            ...
            ii(0x1018_6471, 3); mov(ebx, memd[ds, edx + 0x4]);          /* mov ebx, [edx+0x4] */
            ...
            ii(0x1018_6487, 3); mov(esi, memd[ds, edx + 0x8]);          /* mov esi, [edx+0x8] */
        ...
        l_0x1018_64a7:
            ...
            ii(0x1018_64bb, 3); cmp(eax, memd[ds, edx + 0x8]);          /* cmp eax, [edx+0x8] */
            ...
            ii(0x1018_64dd, 3); mov(ebx, memd[ds, edx + 0x4]);          /* mov ebx, [edx+0x4] */
            ...
            ii(0x1018_64ec, 3); mov(edx, memd[ds, edx + 0x4]);          /* mov edx, [edx+0x4] */
        ...
        l_0x1018_64f6:
            ...
            ii(0x1018_650a, 3); mov(ecx, memd[ds, edx + 0x4]);          /* mov ecx, [edx+0x4] */
        ...
        l_0x1018_653e:
            ii(0x1018_653e, 10); mov(memd[ds, 0x101b_e85c], 0x2);       /* mov dword [0x101be85c], 0x2 */
            ...
            ii(0x1018_655e, 4); mov(eax, memd[ds, edx + eax + 0x14]);   /* mov eax, [edx+eax+0x14] */
        ...
        l_0x1018_6567:
            ...
            ii(0x1018_656e, 2); if(jz(0x1018_6577, 0x7)) goto l_0x1018_6577; /* jz 0x10186577 */
        ...
        l_0x1018_6577:
            ii(0x1018_6577, 10); mov(memd[ds, 0x101b_e85c], 0x1);       /* mov dword [0x101be85c], 0x1 */
            ...
            ii(0x1018_6594, 3); mov(edx, memd[ds, eax + 0x10]);         /* mov edx, [eax+0x10] */
            ii(0x1018_6597, 3); mov(eax, memd[ds, eax + 0xc]);          /* mov eax, [eax+0xc] */
        ...
        l_0x1018_65c7:
            ii(0x1018_65c7, 4); mov(ax, memw[ds, eax + 0xc]);           /* mov ax, [eax+0xc] */
        ...
        l_0x1018_65d7:
            ii(0x1018_65d7, 3); mov(ebx, memd[ds, eax + 0x14]);         /* mov ebx, [eax+0x14] */
            ii(0x1018_65da, 3); mov(edx, memd[ds, eax + 0x10]);         /* mov edx, [eax+0x10] */
            ii(0x1018_65dd, 3); mov(eax, memd[ds, eax + 0xc]);          /* mov eax, [eax+0xc] */
        ...
        l_0x1018_65ea:
            ...
            ii(0x1018_6603, 3); lea(ebx, memd[ds, edx + 0x1]);          /* lea ebx, [edx+0x1] */
