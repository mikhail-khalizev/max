...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_08bd()
        {
            ...
            ii(0x1009_08d3, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1009_08d6, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1009_08d9, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1009_08dc, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1009_08e7, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1009_08ea, 3); mov(edx, memd[ds, eax + 0x27]);         /* mov edx, [eax+0x27] */
            ii(0x1009_08ed, 2); add(edx, ebx);                          /* add edx, ebx */
            ii(0x1009_08ef, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1009_0900, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
        l_0x1009_0903:
            ii(0x1009_0903, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_0906, 4); mov(ax, memw[ds, eax + 0x2]);           /* mov ax, [eax+0x2] */
            ii(0x1009_090a, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ii(0x1009_090e, 2); if(jle(0x1009_091b, 0xb)) goto l_0x1009_091b; /* jle 0x1009091b */
            ii(0x1009_0910, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1009_0913, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x1009_0916, 3); cmp(eax, 0x9);                          /* cmp eax, 0x9 */
            ii(0x1009_0919, 2); if(jz(0x1009_091d, 0x2)) goto l_0x1009_091d; /* jz 0x1009091d */
        l_0x1009_091b:
            ii(0x1009_091b, 2); jmp(0x1009_092d, 0x10); goto l_0x1009_092d; /* jmp 0x1009092d */
        l_0x1009_091d:
            ii(0x1009_091d, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1009_0920, 4); sub(memd[ss, ebp - 0x10], 0x2);         /* sub dword [ebp-0x10], 0x2 */
            ii(0x1009_0924, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_0927, 4); dec(memw[ds, eax + 0x2]);               /* dec word [eax+0x2] */
            ii(0x1009_092b, 2); jmp(0x1009_0903, -0x2a); goto l_0x1009_0903; /* jmp 0x10090903 */
        l_0x1009_092d:
            ii(0x1009_092d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_0930, 4); mov(ax, memw[ds, eax + 0x2]);           /* mov ax, [eax+0x2] */
            ii(0x1009_0934, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1009_0937, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
