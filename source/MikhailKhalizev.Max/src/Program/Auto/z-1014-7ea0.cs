...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_7ea0()
        {
            ...
            ii(0x1014_7eb2, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1014_7eb8, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1014_7ebb, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_7ebe, 5); call(0x1007_6b58, -0xd_136b);           /* call 0x10076b58 */
            ii(0x1014_7ec3, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1014_7ec6, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
