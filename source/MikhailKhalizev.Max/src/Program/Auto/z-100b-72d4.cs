...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_72d4()
        {
            ...
            ii(0x100b_72eb, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_72ee, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100b_72f1, 7); test(memd[ss, ebp - 0x4], 0x4);         /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x100b_72ff, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100b_730e:
            ...
            ii(0x100b_7310, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_731e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_7321, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_7323, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_7331, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_7334, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x100b_7339, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_733c, 5); call(0x1013_ab27, 0x8_37e6);            /* call 0x1013ab27 */
            ii(0x100b_7341, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_7344, 7); test(memd[ss, ebp - 0x4], 0x2);         /* test dword [ebp-0x4], 0x2 */
            ii(0x100b_734b, 2); if(jz(0x100b_7355, 0x8)) goto l_0x100b_7355; /* jz 0x100b7355 */
            ii(0x100b_734d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_7350, 5); call(Definitions.sys_delete, 0xa_ec0f); /* call 0x10165f64 */
        l_0x100b_7355:
            ii(0x100b_7355, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
