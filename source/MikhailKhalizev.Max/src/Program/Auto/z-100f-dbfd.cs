...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_dbfd()
        {
            ...
            ii(0x100f_dc1c, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x100f_dc23, 2); jmp(0x100f_dc2b, 0x6); goto l_0x100f_dc2b; /* jmp 0x100fdc2b */
        l_0x100f_dc25:
            ii(0x100f_dc25, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_dc28, 3); inc(memd[ss, ebp - 0x4]);               /* inc dword [ebp-0x4] */
        l_0x100f_dc2b:
            ii(0x100f_dc2b, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_dc2f, 3); cmp(eax, 0x4);                          /* cmp eax, 0x4 */
            ii(0x100f_dc32, 2); if(jge(0x100f_dc56, 0x22)) goto l_0x100f_dc56; /* jge 0x100fdc56 */
            ii(0x100f_dc34, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_dc4c, 2); if(jnz(0x100f_dc54, 0x6)) goto l_0x100f_dc54; /* jnz 0x100fdc54 */
        ...
        l_0x100f_dc56:
            ...
            ii(0x100f_dc60, 2); if(jg(0x100f_dc6b, 0x9)) goto l_0x100f_dc6b; /* jg 0x100fdc6b */
            ii(0x100f_dc62, 7); mov(memb[ds, 0x101c_388b], 0);          /* mov byte [0x101c388b], 0x0 */
            ii(0x100f_dc69, 2); jmp(0x100f_dc72, 0x7); goto l_0x100f_dc72; /* jmp 0x100fdc72 */
        l_0x100f_dc6b:
