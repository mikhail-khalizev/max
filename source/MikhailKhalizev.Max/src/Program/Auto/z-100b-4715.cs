...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_4715()
        {
            ...
            ii(0x100b_472d, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_4730, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_4732, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_4743, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100b_4757:
            ...
            ii(0x100b_4778, 3); cmp(eax, memd[ss, ebp - 0x4]);          /* cmp eax, [ebp-0x4] */
            ii(0x100b_477b, 2); if(jz(0x100b_477f, 0x2)) goto l_0x100b_477f; /* jz 0x100b477f */
        l_0x100b_477d:
            ii(0x100b_477d, 2); jmp(0x100b_4796, 0x17); goto l_0x100b_4796; /* jmp 0x100b4796 */
        l_0x100b_477f:
            ii(0x100b_477f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_4782, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x100b_4785, 5); call(0x1007_6574, -0x3_e216);           /* call 0x10076574 */
            ii(0x100b_478a, 3); mov(al, memb[ds, eax + 0x4e]);          /* mov al, [eax+0x4e] */
            ii(0x100b_478d, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100b_4792, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100b_4794, 2); if(jg(0x100b_4798, 0x2)) goto l_0x100b_4798; /* jg 0x100b4798 */
        l_0x100b_4796:
            ii(0x100b_4796, 2); jmp(0x100b_47b9, 0x21); goto l_0x100b_47b9; /* jmp 0x100b47b9 */
        l_0x100b_4798:
            ii(0x100b_4798, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_479b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_479e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_47a1, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x100b_47a4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_47b1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_47b4, 3); call_abs(memd[ds, ebx + 0x44]);         /* call dword [ebx+0x44] */
            ii(0x100b_47b7, 2); jmp(0x100b_4819, 0x60); goto l_0x100b_4819; /* jmp 0x100b4819 */
        l_0x100b_47b9:
            ii(0x100b_47b9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_47bc, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100b_47bf, 5); call(0x1007_6574, -0x3_e250);           /* call 0x10076574 */
            ii(0x100b_47c4, 4); cmp(memb[ds, eax + 0x3d], 0);           /* cmp byte [eax+0x3d], 0x0 */
            ii(0x100b_47c8, 2); if(jnz(0x100b_47df, 0x15)) goto l_0x100b_47df; /* jnz 0x100b47df */
            ii(0x100b_47ca, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_47da, 3); cmp(eax, memd[ss, ebp - 0x4]);          /* cmp eax, [ebp-0x4] */
            ii(0x100b_47dd, 2); if(jz(0x100b_47e1, 0x2)) goto l_0x100b_47e1; /* jz 0x100b47e1 */
        l_0x100b_47df:
            ii(0x100b_47df, 2); jmp(0x100b_47f8, 0x17); goto l_0x100b_47f8; /* jmp 0x100b47f8 */
        l_0x100b_47e1:
            ii(0x100b_47e1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_47e4, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100b_47e7, 5); call(0x1007_6574, -0x3_e278);           /* call 0x10076574 */
            ii(0x100b_47ec, 3); mov(al, memb[ds, eax + 0x4e]);          /* mov al, [eax+0x4e] */
            ii(0x100b_47ef, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100b_47f4, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100b_47f6, 2); if(jg(0x100b_47fa, 0x2)) goto l_0x100b_47fa; /* jg 0x100b47fa */
        l_0x100b_47f8:
            ii(0x100b_47f8, 2); jmp(0x100b_4819, 0x1f); goto l_0x100b_4819; /* jmp 0x100b4819 */
        l_0x100b_47fa:
            ii(0x100b_47fa, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_47fd, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100b_4800, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100b_4803, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x100b_4806, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_4813, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100b_4816, 3); call_abs(memd[ds, ebx + 0x44]);         /* call dword [ebx+0x44] */
        l_0x100b_4819:
