...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("784754e8-7814-4d08-86d8-7471b94e8024")]
        public void Method_100f_17e0()
        {
            ii(0x100f_17e0, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x100f_17e5, 5); calld(Definitions.sys_check_available_stack_size, 0x74568); /* call 0x10165d52 */
            ...
            ii(0x100f_17fd, 5); calld(0x1010_2b60, 0x1135e);            /* call 0x10102b60 */
            ...
            ii(0x100f_1829, 5); calld(0x1010_2b60, 0x11332);            /* call 0x10102b60 */
            ...
            ii(0x100f_1860, 5); calld(Definitions.sys_display_draw_1, 0x75c43); /* call 0x101674a8 */
            ...
            ii(0x100f_1874, 5); calld(Definitions.sys_display_draw_1, 0x75c2f); /* call 0x101674a8 */
            ii(0x100f_1879, 5); calld(/* sys */ 0x1016_b258, 0x799da);  /* call 0x1016b258 */
        l_0x100f_187e:
            ii(0x100f_187e, 5); calld(0x1014_82f4, 0x56a71);            /* call 0x101482f4 */
