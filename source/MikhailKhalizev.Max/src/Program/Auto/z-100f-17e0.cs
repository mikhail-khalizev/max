...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_17e0()
        {
            ...
            ii(0x100f_17f7, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100f_17fa, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ...
            ii(0x100f_1808, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_180b, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x100f_180d, 4); movsx(ebx, memw[ss, ebp - 0x4]);        /* movsx ebx, word [ebp-0x4] */
            ii(0x100f_1811, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
            ii(0x100f_1814, 2); sub(eax, ebx);                          /* sub eax, ebx */
            ii(0x100f_1816, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x100f_1818, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100f_1834, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_1837, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
            ii(0x100f_183a, 4); movsx(ebx, memw[ss, ebp - 0x4]);        /* movsx ebx, word [ebp-0x4] */
            ii(0x100f_183e, 3); add(ebx, memd[ds, eax + 0x4]);          /* add ebx, [eax+0x4] */
            ii(0x100f_1841, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_1844, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
            ...
            ii(0x100f_1853, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_1856, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x100f_1858, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100f_1865, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_1868, 3); mov(edx, memd[ds, eax + 0x4]);          /* mov edx, [eax+0x4] */
            ii(0x100f_186b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_186e, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
        ...
        l_0x100f_187e:
            ...
            ii(0x100f_1885, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
