...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_da4a()
        {
            ...
            ii(0x17_da54, 3); mov(bx, memw[ss, bp + 6]);                /* mov bx, [bp+0x6] */
            ...
            ii(0x17_da5e, 3); add(memw[ss, bp - 2], ax);                /* add [bp-0x2], ax */
            ii(0x17_da61, 2); cmp(cx, ax);                              /* cmp cx, ax */
            ii(0x17_da63, 2); if(ja(0x17_da6b, 6)) goto l_0x17_da6b;    /* ja 0xda6b */
        l_0x17_da65:
        ...
        l_0x17_da6b:
            ...
            ii(0x17_da6c, 3); add(sp, 8);                               /* add sp, 0x8 */
            ii(0x17_da6f, 4); cmp(memw[ss, bp - 2], 0);                 /* cmp word [bp-0x2], 0x0 */
            ii(0x17_da73, 2); if(jnz_func(0x17_da94, 0x1f)) return;     /* jnz 0xda94 */
            ii(0x17_da75, 1); sahf();                                   /* sahf */
            ii(0x17_da76, 2); if(jae(0x17_da7c, 4)) goto l_0x17_da7c;   /* jae 0xda7c */
        ...
        l_0x17_da7c:
            ...
            ii(0x17_da89, 2); if(jnz(0x17_da8e, 3)) goto l_0x17_da8e;   /* jnz 0xda8e */
