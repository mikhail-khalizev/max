...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_a18e()
        {
            ...
            ii(0x100e_a1a3, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100e_a1a6, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ...
            ii(0x100e_a1bc, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100e_a1c0, 3); cmp(eax, -0x1 /* 0xff */);              /* cmp eax, 0xffffffff */
            ii(0x100e_a1c3, 2); if(jnz(0x100e_a1cb, 0x6)) goto l_0x100e_a1cb; /* jnz 0x100ea1cb */
            ii(0x100e_a1c5, 4); mov(memb[ss, ebp - 0x14], 0x1);         /* mov byte [ebp-0x14], 0x1 */
            ii(0x100e_a1c9, 2); jmp(0x100e_a1cf, 0x4); goto l_0x100e_a1cf; /* jmp 0x100ea1cf */
        l_0x100e_a1cb:
            ii(0x100e_a1cb, 4); mov(memb[ss, ebp - 0x14], 0);           /* mov byte [ebp-0x14], 0x0 */
        l_0x100e_a1cf:
            ii(0x100e_a1cf, 3); mov(al, memb[ss, ebp - 0x14]);          /* mov al, [ebp-0x14] */
            ii(0x100e_a1d2, 3); mov(memb[ss, ebp - 0x1c], al);          /* mov [ebp-0x1c], al */
        l_0x100e_a1d5:
            ii(0x100e_a1d5, 4); cmp(memb[ss, ebp - 0x18], 0);           /* cmp byte [ebp-0x18], 0x0 */
            ...
            ii(0x100e_a213, 4); movsx(eax, memb[ss, ebp - 0x23]);       /* movsx eax, byte [ebp-0x23] */
            ii(0x100e_a217, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x100e_a219, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x100e_a21c, 3); mov(memw[ds, eax], dx);                 /* mov [eax], dx */
        l_0x100e_a21f:
            ii(0x100e_a21f, 4); mov(memb[ss, ebp - 0x1c], 0);           /* mov byte [ebp-0x1c], 0x0 */
            ii(0x100e_a223, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ii(0x100e_a226, 3); add(memb[ss, ebp - 0x23], al);          /* add [ebp-0x23], al */
            ii(0x100e_a229, 4); movsx(eax, memb[ss, ebp - 0x23]);       /* movsx eax, byte [ebp-0x23] */
            ii(0x100e_a22d, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100e_a22f, 2); if(jl(0x100e_a23a, 0x9)) goto l_0x100e_a23a; /* jl 0x100ea23a */
            ii(0x100e_a231, 4); movsx(eax, memb[ss, ebp - 0x23]);       /* movsx eax, byte [ebp-0x23] */
            ii(0x100e_a235, 3); cmp(eax, 0x1f);                         /* cmp eax, 0x1f */
            ii(0x100e_a238, 2); if(jle(0x100e_a243, 0x9)) goto l_0x100e_a243; /* jle 0x100ea243 */
        l_0x100e_a23a:
        ...
        l_0x100e_a243:
            ...
            ii(0x100e_a252, 4); movsx(eax, memb[ss, ebp - 0x23]);       /* movsx eax, byte [ebp-0x23] */
            ii(0x100e_a256, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x100e_a25a, 2); sub(eax, edx);                          /* sub eax, edx */
            ii(0x100e_a25c, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x100e_a25e, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x100e_a261, 2); mov(al, memb[ds, eax]);                 /* mov al, [eax] */
            ii(0x100e_a263, 3); mov(memb[ss, ebp - 0x22], al);          /* mov [ebp-0x22], al */
        l_0x100e_a266:
            ii(0x100e_a266, 4); movsx(edx, memb[ss, ebp - 0x23]);       /* movsx edx, byte [ebp-0x23] */
            ii(0x100e_a26a, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100e_a26e, 2); sub(edx, eax);                          /* sub edx, eax */
            ii(0x100e_a270, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x100e_a272, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x100e_a274, 3); add(eax, memd[ss, ebp + 0x10]);         /* add eax, [ebp+0x10] */
            ...
            ii(0x100e_a28f, 2); if(jz(0x100e_a293, 0x2)) goto l_0x100e_a293; /* jz 0x100ea293 */
        l_0x100e_a291:
            ii(0x100e_a291, 2); jmp(0x100e_a29b, 0x8); goto l_0x100e_a29b; /* jmp 0x100ea29b */
        l_0x100e_a293:
            ii(0x100e_a293, 3); mov(al, memb[ss, ebp - 0x22]);          /* mov al, [ebp-0x22] */
            ii(0x100e_a296, 3); inc(memb[ss, ebp - 0x22]);              /* inc byte [ebp-0x22] */
            ii(0x100e_a299, 2); jmp(0x100e_a266, -0x35); goto l_0x100e_a266; /* jmp 0x100ea266 */
        l_0x100e_a29b:
            ii(0x100e_a29b, 4); movsx(edx, memb[ss, ebp - 0x23]);       /* movsx edx, byte [ebp-0x23] */
            ii(0x100e_a29f, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100e_a2a3, 2); sub(edx, eax);                          /* sub edx, eax */
            ii(0x100e_a2a5, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x100e_a2a7, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x100e_a2a9, 3); add(eax, memd[ss, ebp + 0x10]);         /* add eax, [ebp+0x10] */
            ii(0x100e_a2ac, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x100e_a2af, 4); movsx(edx, memb[ss, ebp - 0x22]);       /* movsx edx, byte [ebp-0x22] */
            ii(0x100e_a2b3, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x100e_a2b5, 2); if(jle(0x100e_a2bb, 0x4)) goto l_0x100e_a2bb; /* jle 0x100ea2bb */
            ii(0x100e_a2b7, 4); mov(memb[ss, ebp - 0x18], 0x1);         /* mov byte [ebp-0x18], 0x1 */
        l_0x100e_a2bb:
            ii(0x100e_a2bb, 5); jmp(0x100e_a1d5, -0xeb); goto l_0x100e_a1d5; /* jmp 0x100ea1d5 */
        l_0x100e_a2c0:
            ii(0x100e_a2c0, 5); movsx(ax, memb[ss, ebp - 0x23]);        /* movsx ax, byte [ebp-0x23] */
            ii(0x100e_a2c5, 3); sub(eax, memd[ss, ebp - 0x4]);          /* sub eax, [ebp-0x4] */
            ii(0x100e_a2c8, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x100e_a2cb, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ...
            ii(0x100e_a2d3, 3); ret(0x4);                               /* ret 0x4 */
        }
    }
}
