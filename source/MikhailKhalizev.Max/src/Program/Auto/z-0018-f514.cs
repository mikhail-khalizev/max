...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("37177be2-d4c9-4f68-9cfc-4ad8e514b9b2")]
        public void Method_0018_f514()
        {
            ii(0x18_f514, 3); if(callw_up(0x18_fa00, 0x4e9)) return;    /* call 0xfa00 */
            ii(0x18_f517, 2); and(ax, bp);                              /* and ax, bp */
            ii(0x18_f519, 2); inw(ax, 0x4);                             /* in ax, 0x4 */
            ii(0x18_f51b, 2); and(ch, al);                              /* and ch, al */
            ii(0x18_f51d, 2); if(loopew_a16(0x18_f523, 0x4)) goto l_0x18_f523; /* loope 0xf523 */
            ii(0x18_f51f, 2); and(bp, ax);                              /* and bp, ax */
            ii(0x18_f521, 2); fld(memq_a16[ds, si]);                    /* fld qword [si] */
        l_0x18_f523:
            ii(0x18_f523, 2); and(al, 0xe8);                            /* and al, 0xe8 */
            ii(0x18_f525, 2); fld(memd_a16[ds, si]);                    /* fld dword [si] */
            ii(0x18_f527, 3); and(ax, 0xd5e8);                          /* and ax, 0xd5e8 */
            ii(0x18_f52a, 2); add(al, 0x26);                            /* add al, 0x26 */
            ii(0x18_f52c, 3); callw(0x18_fa00, 0x4d1);                  /* call 0xfa00 */
            ii(0x18_f52f, 1); daa();                                    /* daa */
            ii(0x18_f530, 3); callw(0x18_fa00, 0x4cd);                  /* call 0xfa00 */
            ii(0x18_f533, 2); sub(al, ch);                              /* sub al, ch */
            ii(0x18_f535, 1); leavew();                                 /* leave */
            ii(0x18_f536, 2); add(al, 0x29);                            /* add al, 0x29 */
            ii(0x18_f538, 3); callw(0x18_fa00, 0x4c5);                  /* call 0xfa00 */
            ii(0x18_f53b, 2); sub(ch, al);                              /* sub ch, al */
            ii(0x18_f53d, 3); rol(memw_a16[ds, si], 0x2b);              /* rol word [si], 0x2b */
            ii(0x18_f540, 3); callw(0x18_fa00, 0x4bd);                  /* call 0xfa00 */
            ii(0x18_f543, 2); sub(al, -0x18 /* 0xe8 */);                /* sub al, 0xe8 */
            ii(0x18_f545, 3); mov(cx, 0x2d04);                          /* mov cx, 0x2d04 */
            ii(0x18_f548, 3); callw(0x18_fa00, 0x4b5);                  /* call 0xfa00 */
            ii(0x18_f54b, 4); callw(0x18_fa00, 0x4b1);                  /* call 0xfa00 */
