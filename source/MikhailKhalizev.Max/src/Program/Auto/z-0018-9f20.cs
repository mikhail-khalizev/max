...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_9f20()
        {
            ...
            ii(0x18_9f32, 3); mov(memw[ds, bx - 0x2c], di);             /* mov [bx-0x2c], di */
            ii(0x18_9f35, 3); mov(memw[ds, bx - 0x2a], si);             /* mov [bx-0x2a], si */
            ii(0x18_9f38, 3); mov(memw[ds, bx - 0x22], dx);             /* mov [bx-0x22], dx */
            ii(0x18_9f3b, 3); mov(memw[ds, bx - 0x20], cx);             /* mov [bx-0x20], cx */
            ii(0x18_9f3e, 3); mov(memw[ds, bx - 0x1e], ax);             /* mov [bx-0x1e], ax */
            ii(0x18_9f41, 1); pop(cx);                                  /* pop cx */
            ii(0x18_9f42, 1); pop(ax);                                  /* pop ax */
            ii(0x18_9f43, 3); mov(memw[ds, bx + 0x4], cx);              /* mov [bx+0x4], cx */
            ii(0x18_9f46, 3); mov(memw[ds, bx - 0x30], cx);             /* mov [bx-0x30], cx */
            ii(0x18_9f49, 3); mov(memw[ds, bx - 0x24], ax);             /* mov [bx-0x24], ax */
            ii(0x18_9f4c, 3); mov(memw[ds, bx + 0x6], es);              /* mov [bx+0x6], es */
            ii(0x18_9f4f, 3); mov(memw[ds, bx - 0x2e], es);             /* mov [bx-0x2e], es */
            ii(0x18_9f52, 3); mov(memw[ds, bx + 0x2], ss);              /* mov [bx+0x2], ss */
            ...
            ii(0x18_9f75, 3); mov(memw[ds, bx - 0x12], cx);             /* mov [bx-0x12], cx */
            ii(0x18_9f78, 3); and(ch, 0xfd);                            /* and ch, 0xfd */
            ii(0x18_9f7b, 3); mov(al, memb[cs, si]);                    /* mov al, [cs:si] */
            ii(0x18_9f7e, 3); mov(memw[ds, bx - 0x18], cx);             /* mov [bx-0x18], cx */
            ii(0x18_9f81, 3); lea(bx, memw[ds, bx - 0x32]);             /* lea bx, [bx-0x32] */
            ...
            ii(0x18_9f92, 5); mov(memw[ds, bx + 0x1c], 0xf34);          /* mov word [bx+0x1c], 0xf34 */
