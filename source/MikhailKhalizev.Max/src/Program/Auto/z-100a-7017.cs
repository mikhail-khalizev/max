...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_7017()
        {
            ...
            ii(0x100a_702f, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100a_7032, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_7034, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_7043, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_7053, 3); cmp(eax, memd[ss, ebp - 4]);            /* cmp eax, [ebp-0x4] */
            ii(0x100a_7056, 2); if(jz(0x100a_705d, 5)) goto l_0x100a_705d; /* jz 0x100a705d */
        l_0x100a_7058:
            ii(0x100a_7058, 5); jmp(0x100a_719b, 0x13e); goto l_0x100a_719b; /* jmp 0x100a719b */
        l_0x100a_705d:
            ii(0x100a_705d, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_705f, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_706c, 2); if(jz(0x100a_7076, 8)) goto l_0x100a_7076; /* jz 0x100a7076 */
            ii(0x100a_706e, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_7071, 5); call(0x100a_6df3, -0x283);              /* call 0x100a6df3 */
        l_0x100a_7076:
            ii(0x100a_7076, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_7078, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_7087, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_7097, 3); cmp(eax, memd[ss, ebp - 4]);            /* cmp eax, [ebp-0x4] */
            ii(0x100a_709a, 2); if(jz(0x100a_70a1, 5)) goto l_0x100a_70a1; /* jz 0x100a70a1 */
        l_0x100a_709c:
            ii(0x100a_709c, 5); jmp(0x100a_719b, 0xfa); goto l_0x100a_719b; /* jmp 0x100a719b */
        l_0x100a_70a1:
            ii(0x100a_70a1, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_70a4, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100a_70a7, 5); call(0x1007_6574, -0x3_0b38);           /* call 0x10076574 */
            ii(0x100a_70ac, 3); mov(ebx, memd[ds, eax + 26]);           /* mov ebx, [eax+0x1a] */
            ii(0x100a_70af, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100a_70b2, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_70b5, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100a_70b8, 5); call(0x1007_6574, -0x3_0b49);           /* call 0x10076574 */
            ii(0x100a_70bd, 3); mov(edx, memd[ds, eax + 24]);           /* mov edx, [eax+0x18] */
            ii(0x100a_70c0, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100a_70c3, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_70e5, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100a_70e8, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100a_70eb, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100a_70ee, 4); cmp(memd[ss, ebp - 12], 0);             /* cmp dword [ebp-0xc], 0x0 */
            ...
            ii(0x100a_70fa, 3); mov(ecx, memd[ss, ebp - 4]);            /* mov ecx, [ebp-0x4] */
            ii(0x100a_70fd, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_710a, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_7117, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100a_711a, 5); call(0x100b_43b0, 0xd291);              /* call 0x100b43b0 */
            ii(0x100a_711f, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x100a_7122, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_7125, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x100a_7128, 2); jmp(0x100a_7130, 6); goto l_0x100a_7130; /* jmp 0x100a7130 */
        l_0x100a_712a:
            ii(0x100a_712a, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100a_712d, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
        l_0x100a_7130:
            ii(0x100a_7130, 3); mov(edx, memd[ss, ebp - 20]);           /* mov edx, [ebp-0x14] */
            ii(0x100a_7133, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ii(0x100a_7136, 5); call(0x1008_b060, -0x1_c0db);           /* call 0x1008b060 */
            ii(0x100a_713b, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ...
            ii(0x100a_7151, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
        ...
        l_0x100a_715b:
            ...
            ii(0x100a_7166, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_7169, 3); mov(eax, memd[ds, eax + 7]);            /* mov eax, [eax+0x7] */
        ...
        l_0x100a_717b:
            ...
            ii(0x100a_7182, 3); cmp(eax, 2);                            /* cmp eax, 0x2 */
            ii(0x100a_7185, 2); if(jnz(0x100a_7189, 2)) goto l_0x100a_7189; /* jnz 0x100a7189 */
        l_0x100a_7187:
            ii(0x100a_7187, 2); jmp(0x100a_719b, 0x12); goto l_0x100a_719b; /* jmp 0x100a719b */
        l_0x100a_7189:
            ii(0x100a_7189, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_718c, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x100a_718f, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x100a_7192, 3); mov(edx, memd[ds, eax + 2]);            /* mov edx, [eax+0x2] */
            ii(0x100a_7195, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x100a_7198, 3); call_abs(memd[ds, edx + 112]);          /* call dword [edx+0x70] */
        l_0x100a_719b:
