...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_c051()
        {
            ...
            ii(0x1008_c068, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_c06b, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1008_c06e, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ii(0x1008_c071, 3);  add(edx, 0x13);                       /* add edx, 0x13 */
            ii(0x1008_c074, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_c084, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ii(0x1008_c087, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x1008_c08a, 5);  call(0x1008_b060, -0x102f);           /* call 0x1008b060 */
            ii(0x1008_c08f, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_c092, 3);  add(eax, 0x13);                       /* add eax, 0x13 */
            ii(0x1008_c095, 5);  call(0x1007_6574, -0x1_5b26);         /* call 0x10076574 */
            ii(0x1008_c09a, 4);  mov(dx, memw[ds, eax + 82]);          /* mov dx, [eax+0x52] */
            ii(0x1008_c09e, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_c0a1, 4);  cmp(dx, memw[ds, eax + 31]);          /* cmp dx, [eax+0x1f] */
            ...
            ii(0x1008_c0b0, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ii(0x1008_c0b3, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1008_c0c5, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1008_c0dd:
            ...
            ii(0x1008_c0f8, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_c0fb, 3);  add(eax, 0xf);                        /* add eax, 0xf */
            ii(0x1008_c0fe, 5);  call(0x1008_afe4, -0x111f);           /* call 0x1008afe4 */
            ii(0x1008_c103, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
        ...
        l_0x1008_c110:
            ...
            ii(0x1008_c112, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
