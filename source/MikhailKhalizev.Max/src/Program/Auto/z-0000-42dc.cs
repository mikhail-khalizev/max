...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_42dc()
        {
            ...
            ii(0x42e9, 3);  mov(bx, memw[ss, bp + 24]);                /* mov bx, [bp+0x18] */
            ii(0x42ec, 2);  or(bx, bx);                                /* or bx, bx */
            ii(0x42ee, 2);  if(jnz(0x42f3, 3)) goto l_0x42f3;          /* jnz 0x42f3 */
            ii(0x42f0, 3);  xchg(memw[ss, bp + 28], bx);               /* xchg [bp+0x1c], bx */
        l_0x42f3:
            ii(0x42f3, 3);  mov(al, memb[cs, bx]);                     /* mov al, [cs:bx] */
            ii(0x42f6, 3);  mov(memw[ss, bp + 24], ax);                /* mov [bp+0x18], ax */
            ii(0x42f9, 3);  jmp_func(0x3841, -0xabb);                  /* jmp 0x3841 */
        }
    }
}
