...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_6be4()
        {
            ...
            ii(0x100d_6bff, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x100d_6c02, 3); mov(memd[ss, ebp - 0x4], ecx);          /* mov [ebp-0x4], ecx */
            ...
            ii(0x100d_6c48, 6); mov(memw[ds, eax + 0x2], 0);            /* mov word [eax+0x2], 0x0 */
            ii(0x100d_6c4e, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_6c51, 6); mov(memw[ds, eax + 0x4], 0);            /* mov word [eax+0x4], 0x0 */
            ...
            ii(0x100d_6c8a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_6c8d, 4); mov(ax, memw[ds, eax + 0xc]);           /* mov ax, [eax+0xc] */
            ii(0x100d_6c91, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100d_6c94, 4); sub(ax, memw[ds, edx + 0x4]);           /* sub ax, [edx+0x4] */
            ii(0x100d_6c98, 1); cwde();                                 /* cwde */
            ii(0x100d_6c99, 1); push(eax);                              /* push eax */
            ii(0x100d_6c9a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_6c9d, 4); mov(ax, memw[ds, eax + 0x8]);           /* mov ax, [eax+0x8] */
            ii(0x100d_6ca1, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100d_6ca4, 3); sub(ax, memw[ds, edx]);                 /* sub ax, [edx] */
            ii(0x100d_6ca7, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x100d_6caa, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_6cad, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x100d_6cb0, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100d_6cb3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_6cca, 2); jmp(0x100d_6cd2, 0x6); goto l_0x100d_6cd2; /* jmp 0x100d6cd2 */
        l_0x100d_6ccc:
        ...
        l_0x100d_6ce7:
            ...
            ii(0x100d_6d00, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6d03, 4); mov(ax, memw[ds, eax + 0xc]);           /* mov ax, [eax+0xc] */
            ii(0x100d_6d07, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100d_6d0a, 4); sub(ax, memw[ds, edx + 0x4]);           /* sub ax, [edx+0x4] */
            ii(0x100d_6d0e, 1); cwde();                                 /* cwde */
            ii(0x100d_6d0f, 1); push(eax);                              /* push eax */
            ii(0x100d_6d10, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6d13, 4); mov(ax, memw[ds, eax + 0x8]);           /* mov ax, [eax+0x8] */
            ii(0x100d_6d17, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100d_6d1a, 3); sub(ax, memw[ds, edx]);                 /* sub ax, [edx] */
            ii(0x100d_6d1d, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x100d_6d20, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6d23, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x100d_6d26, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100d_6d29, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_6d40, 2); jmp(0x100d_6d48, 0x6); goto l_0x100d_6d48; /* jmp 0x100d6d48 */
        l_0x100d_6d42:
        ...
        l_0x100d_6d48:
            ...
            ii(0x100d_6d4e, 3); mov(memd[ds, edx + 0x6], eax);          /* mov [edx+0x6], eax */
            ...
            ii(0x100d_6d77, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6d7a, 4); mov(ax, memw[ds, eax + 0xc]);           /* mov ax, [eax+0xc] */
            ii(0x100d_6d7e, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100d_6d81, 4); sub(ax, memw[ds, edx + 0x4]);           /* sub ax, [edx+0x4] */
            ii(0x100d_6d85, 5); add(eax, 0x6);                          /* add eax, 0x6 */
            ii(0x100d_6d8a, 1); cwde();                                 /* cwde */
            ii(0x100d_6d8b, 1); push(eax);                              /* push eax */
            ii(0x100d_6d8c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6d8f, 4); mov(ax, memw[ds, eax + 0x8]);           /* mov ax, [eax+0x8] */
            ii(0x100d_6d93, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100d_6d96, 3); sub(ax, memw[ds, edx]);                 /* sub ax, [edx] */
            ii(0x100d_6d99, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x100d_6d9c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6d9f, 4); mov(ax, memw[ds, eax + 0x4]);           /* mov ax, [eax+0x4] */
            ii(0x100d_6da3, 3); sub(eax, 0x3);                          /* sub eax, 0x3 */
            ii(0x100d_6da6, 3); movsx(ebx, ax);                         /* movsx ebx, ax */
            ii(0x100d_6da9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_6dc0, 2); jmp(0x100d_6dc8, 0x6); goto l_0x100d_6dc8; /* jmp 0x100d6dc8 */
        l_0x100d_6dc2:
        ...
        l_0x100d_6dd3:
            ...
            ii(0x100d_6dec, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6def, 4); mov(ax, memw[ds, eax + 0xc]);           /* mov ax, [eax+0xc] */
            ii(0x100d_6df3, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100d_6df6, 4); sub(ax, memw[ds, edx + 0x4]);           /* sub ax, [edx+0x4] */
            ii(0x100d_6dfa, 1); cwde();                                 /* cwde */
            ii(0x100d_6dfb, 1); push(eax);                              /* push eax */
            ii(0x100d_6dfc, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6dff, 4); mov(ax, memw[ds, eax + 0x8]);           /* mov ax, [eax+0x8] */
            ii(0x100d_6e03, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x100d_6e11, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6e14, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x100d_6e17, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100d_6e1a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_6e37, 2); jmp(0x100d_6e3f, 0x6); goto l_0x100d_6e3f; /* jmp 0x100d6e3f */
        l_0x100d_6e39:
