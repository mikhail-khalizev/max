...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_6be4()
        {
            ...
            ii(0x100d_6bf9, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x100d_6bfc, 3); mov(memd[ss, ebp - 12], edx);           /* mov [ebp-0xc], edx */
            ii(0x100d_6bff, 3); mov(memd[ss, ebp - 8], ebx);            /* mov [ebp-0x8], ebx */
            ii(0x100d_6c02, 3); mov(memd[ss, ebp - 4], ecx);            /* mov [ebp-0x4], ecx */
            ii(0x100d_6c05, 3); mov(eax, memd[ss, ebp + 16]);           /* mov eax, [ebp+0x10] */
            ii(0x100d_6c08, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x100d_6c0b, 4); mov(memw[ds, edx + 14], ax);            /* mov [edx+0xe], ax */
            ii(0x100d_6c0f, 3); mov(eax, memd[ss, ebp + 20]);           /* mov eax, [ebp+0x14] */
            ii(0x100d_6c12, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x100d_6c15, 3); mov(memd[ds, edx + 16], eax);           /* mov [edx+0x10], eax */
            ii(0x100d_6c18, 3); mov(eax, memd[ss, ebp + 24]);           /* mov eax, [ebp+0x18] */
            ii(0x100d_6c1b, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x100d_6c1e, 3); mov(memd[ds, edx + 20], eax);           /* mov [edx+0x14], eax */
            ii(0x100d_6c21, 3); mov(eax, memd[ss, ebp + 28]);           /* mov eax, [ebp+0x1c] */
            ii(0x100d_6c24, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x100d_6c27, 3); mov(memd[ds, edx + 24], eax);           /* mov [edx+0x18], eax */
            ii(0x100d_6c2a, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100d_6c2d, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x100d_6c30, 3); mov(memd[ds, edx + 32], eax);           /* mov [edx+0x20], eax */
            ii(0x100d_6c33, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100d_6c36, 7); mov(memd[ds, eax + 39], 0x101b_5f88);   /* mov dword [eax+0x27], 0x101b5f88 */
            ii(0x100d_6c3d, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100d_6c40, 5); mov(memw[ds, eax], 0);                  /* mov word [eax], 0x0 */
            ii(0x100d_6c45, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100d_6c48, 6); mov(memw[ds, eax + 2], 0);              /* mov word [eax+0x2], 0x0 */
            ii(0x100d_6c4e, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100d_6c51, 6); mov(memw[ds, eax + 4], 0);              /* mov word [eax+0x4], 0x0 */
            ii(0x100d_6c57, 3); mov(eax, memd[ss, ebp + 32]);           /* mov eax, [ebp+0x20] */
            ii(0x100d_6c5a, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x100d_6c5d, 4); mov(memw[ds, edx + 36], ax);            /* mov [edx+0x24], ax */
            ii(0x100d_6c61, 3); mov(al, memb[ss, ebp + 36]);            /* mov al, [ebp+0x24] */
            ii(0x100d_6c64, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x100d_6c67, 3); mov(memb[ds, edx + 38], al);            /* mov [edx+0x26], al */
            ii(0x100d_6c6a, 5); cmp(memw[ss, ebp + 32], 0);             /* cmp word [ebp+0x20], 0x0 */
            ...
            ii(0x100d_6c7b, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x100d_6c7e, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x100d_6c81, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x100d_6c84, 4); cmp(memd[ss, ebp - 24], 0);             /* cmp dword [ebp-0x18], 0x0 */
            ...
            ii(0x100d_6c8d, 4); mov(ax, memw[ds, eax + 12]);            /* mov ax, [eax+0xc] */
            ...
            ii(0x100d_6cb9, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x100d_6cbc, 5); call(0x100d_7bdc, 0xf1b);               /* call 0x100d7bdc */
            ii(0x100d_6cc1, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x100d_6cc4, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x100d_6cc7, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
            ii(0x100d_6cca, 2); jmp(0x100d_6cd2, 6); goto l_0x100d_6cd2; /* jmp 0x100d6cd2 */
        l_0x100d_6ccc:
            ii(0x100d_6ccc, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x100d_6ccf, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
        l_0x100d_6cd2:
            ii(0x100d_6cd2, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
            ii(0x100d_6cd5, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x100d_6cd8, 3); mov(memd[ds, edx + 10], eax);           /* mov [edx+0xa], eax */
            ii(0x100d_6cdb, 2); jmp(0x100d_6ce7, 0xa); goto l_0x100d_6ce7; /* jmp 0x100d6ce7 */
        l_0x100d_6cdd:
            ii(0x100d_6cdd, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100d_6ce0, 7); mov(memd[ds, eax + 10], 0);             /* mov dword [eax+0xa], 0x0 */
        l_0x100d_6ce7:
            ii(0x100d_6ce7, 5); mov(eax, 0xd);                          /* mov eax, 0xd */
            ii(0x100d_6cec, 5); call(Definitions.sys_new, 0x8_f10f);    /* call 0x10165e00 */
            ii(0x100d_6cf1, 3); mov(memd[ss, ebp - 36], eax);           /* mov [ebp-0x24], eax */
            ii(0x100d_6cf4, 3); mov(eax, memd[ss, ebp - 36]);           /* mov eax, [ebp-0x24] */
            ii(0x100d_6cf7, 3); mov(memd[ss, ebp - 40], eax);           /* mov [ebp-0x28], eax */
            ii(0x100d_6cfa, 4); cmp(memd[ss, ebp - 40], 0);             /* cmp dword [ebp-0x28], 0x0 */
            ...
            ii(0x100d_6d03, 4); mov(ax, memw[ds, eax + 12]);            /* mov ax, [eax+0xc] */
            ...
            ii(0x100d_6d2f, 3); mov(eax, memd[ss, ebp - 36]);           /* mov eax, [ebp-0x24] */
            ii(0x100d_6d32, 5); call(0x100d_7bdc, 0xea5);               /* call 0x100d7bdc */
            ii(0x100d_6d37, 3); mov(memd[ss, ebp - 44], eax);           /* mov [ebp-0x2c], eax */
            ii(0x100d_6d3a, 3); mov(eax, memd[ss, ebp - 44]);           /* mov eax, [ebp-0x2c] */
            ii(0x100d_6d3d, 3); mov(memd[ss, ebp - 48], eax);           /* mov [ebp-0x30], eax */
            ii(0x100d_6d40, 2); jmp(0x100d_6d48, 6); goto l_0x100d_6d48; /* jmp 0x100d6d48 */
        l_0x100d_6d42:
            ii(0x100d_6d42, 3); mov(eax, memd[ss, ebp - 40]);           /* mov eax, [ebp-0x28] */
            ii(0x100d_6d45, 3); mov(memd[ss, ebp - 48], eax);           /* mov [ebp-0x30], eax */
        l_0x100d_6d48:
            ii(0x100d_6d48, 3); mov(eax, memd[ss, ebp - 48]);           /* mov eax, [ebp-0x30] */
            ii(0x100d_6d4b, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x100d_6d4e, 3); mov(memd[ds, edx + 6], eax);            /* mov [edx+0x6], eax */
            ii(0x100d_6d51, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100d_6d54, 4); cmp(memb[ds, eax + 38], 0);             /* cmp byte [eax+0x26], 0x0 */
            ...
            ii(0x100d_6d68, 3); mov(memd[ss, ebp - 52], eax);           /* mov [ebp-0x34], eax */
            ii(0x100d_6d6b, 3); mov(eax, memd[ss, ebp - 52]);           /* mov eax, [ebp-0x34] */
            ii(0x100d_6d6e, 3); mov(memd[ss, ebp - 56], eax);           /* mov [ebp-0x38], eax */
            ii(0x100d_6d71, 4); cmp(memd[ss, ebp - 56], 0);             /* cmp dword [ebp-0x38], 0x0 */
            ...
            ii(0x100d_6d7a, 4); mov(ax, memw[ds, eax + 12]);            /* mov ax, [eax+0xc] */
            ...
            ii(0x100d_6daf, 3); mov(eax, memd[ss, ebp - 52]);           /* mov eax, [ebp-0x34] */
            ii(0x100d_6db2, 5); call(0x100c_e39d, -0x8a1a);             /* call 0x100ce39d */
            ii(0x100d_6db7, 3); mov(memd[ss, ebp - 60], eax);           /* mov [ebp-0x3c], eax */
            ii(0x100d_6dba, 3); mov(eax, memd[ss, ebp - 60]);           /* mov eax, [ebp-0x3c] */
            ii(0x100d_6dbd, 3); mov(memd[ss, ebp - 64], eax);           /* mov [ebp-0x40], eax */
            ii(0x100d_6dc0, 2); jmp(0x100d_6dc8, 6); goto l_0x100d_6dc8; /* jmp 0x100d6dc8 */
        l_0x100d_6dc2:
            ii(0x100d_6dc2, 3); mov(eax, memd[ss, ebp - 56]);           /* mov eax, [ebp-0x38] */
            ii(0x100d_6dc5, 3); mov(memd[ss, ebp - 64], eax);           /* mov [ebp-0x40], eax */
        l_0x100d_6dc8:
            ii(0x100d_6dc8, 3); mov(eax, memd[ss, ebp - 64]);           /* mov eax, [ebp-0x40] */
            ii(0x100d_6dcb, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x100d_6dce, 3); mov(memd[ds, edx + 28], eax);           /* mov [edx+0x1c], eax */
        ...
        l_0x100d_6dd3:
            ...
            ii(0x100d_6ddd, 3); mov(memd[ss, ebp - 68], eax);           /* mov [ebp-0x44], eax */
            ii(0x100d_6de0, 3); mov(eax, memd[ss, ebp - 68]);           /* mov eax, [ebp-0x44] */
            ii(0x100d_6de3, 3); mov(memd[ss, ebp - 72], eax);           /* mov [ebp-0x48], eax */
            ii(0x100d_6de6, 4); cmp(memd[ss, ebp - 72], 0);             /* cmp dword [ebp-0x48], 0x0 */
            ...
            ii(0x100d_6def, 4); mov(ax, memw[ds, eax + 12]);            /* mov ax, [eax+0xc] */
            ...
            ii(0x100d_6e26, 3); mov(eax, memd[ss, ebp - 68]);           /* mov eax, [ebp-0x44] */
            ii(0x100d_6e29, 5); call(0x100c_e39d, -0x8a91);             /* call 0x100ce39d */
            ii(0x100d_6e2e, 3); mov(memd[ss, ebp - 76], eax);           /* mov [ebp-0x4c], eax */
            ii(0x100d_6e31, 3); mov(eax, memd[ss, ebp - 76]);           /* mov eax, [ebp-0x4c] */
            ii(0x100d_6e34, 3); mov(memd[ss, ebp - 80], eax);           /* mov [ebp-0x50], eax */
            ii(0x100d_6e37, 2); jmp(0x100d_6e3f, 6); goto l_0x100d_6e3f; /* jmp 0x100d6e3f */
        l_0x100d_6e39:
            ii(0x100d_6e39, 3); mov(eax, memd[ss, ebp - 72]);           /* mov eax, [ebp-0x48] */
            ii(0x100d_6e3c, 3); mov(memd[ss, ebp - 80], eax);           /* mov [ebp-0x50], eax */
        l_0x100d_6e3f:
            ii(0x100d_6e3f, 3); mov(eax, memd[ss, ebp - 80]);           /* mov eax, [ebp-0x50] */
            ii(0x100d_6e42, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x100d_6e45, 3); mov(memd[ds, edx + 28], eax);           /* mov [edx+0x1c], eax */
        l_0x100d_6e48:
            ii(0x100d_6e48, 3); mov(edx, memd[ss, ebp + 28]);           /* mov edx, [ebp+0x1c] */
            ii(0x100d_6e4b, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100d_6e4e, 3); mov(eax, memd[ds, eax + 28]);           /* mov eax, [eax+0x1c] */
            ii(0x100d_6e51, 5); call(0x100d_5164, -0x1cf2);             /* call 0x100d5164 */
            ii(0x100d_6e56, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100d_6e59, 3); mov(memd[ss, ebp - 84], eax);           /* mov [ebp-0x54], eax */
            ii(0x100d_6e5c, 3); mov(eax, memd[ss, ebp - 84]);           /* mov eax, [ebp-0x54] */
