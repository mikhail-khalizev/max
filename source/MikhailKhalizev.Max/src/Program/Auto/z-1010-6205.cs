...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_6205()
        {
            ...
            ii(0x1010_621b, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1010_621e, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x1010_6221, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1010_6224, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ii(0x1010_6228, 5); call(0x1010_60b4, -0x179);              /* call 0x101060b4 */
            ii(0x1010_622d, 1); push(eax);                              /* push eax */
            ii(0x1010_622e, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1010_623e, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ...
            ii(0x1010_624b, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1010_625b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_625e, 1); push(eax);                              /* push eax */
            ii(0x1010_625f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1010_626b, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1010_626e, 2); jmp(0x1010_6277, 0x7); goto l_0x1010_6277; /* jmp 0x10106277 */
        l_0x1010_6270:
            ii(0x1010_6270, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
        l_0x1010_6277:
            ii(0x1010_6277, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
