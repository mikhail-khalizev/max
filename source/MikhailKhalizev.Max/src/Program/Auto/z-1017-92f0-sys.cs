...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("4a9a81f0-4eb2-420b-b28c-2765c71397a8")]
        public void /* sys */ Method_1017_92f0()
        {
            ii(0x1017_92f0, 1); pushd(edx);                             /* push edx */
            ii(0x1017_92f1, 2); mov(edx, ebx);                          /* mov edx, ebx */
            ii(0x1017_92f3, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1017_92f5, 6); mov(bl, memb_a32[ds, 0x101b_e58e]);     /* mov bl, [0x101be58e] */
            ii(0x1017_92fb, 3); cmp(ebx, 0x2);                          /* cmp ebx, 0x2 */
            ii(0x1017_92fe, 2); if(jld(0x1017_9313, 0x13)) goto l_0x1017_9313; /* jl 0x10179313 */
            ii(0x1017_9300, 3); cmp(ebx, 0x8);                          /* cmp ebx, 0x8 */
            ii(0x1017_9303, 2); if(jgd(0x1017_9313, 0xe)) goto l_0x1017_9313; /* jg 0x10179313 */
            ...
            ii(0x1017_9311, 1); popd(edx);                              /* pop edx */
            ii(0x1017_9312, 1); retd(); return;                         /* ret */
        l_0x1017_9313:
            ...
            ii(0x1017_931b, 1); popd(edx);                              /* pop edx */
            ii(0x1017_931c, 1); retd(); return;                         /* ret */
        }
    }
}
