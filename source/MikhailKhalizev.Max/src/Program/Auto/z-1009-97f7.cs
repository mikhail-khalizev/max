...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_97f7()
        {
            ...
            ii(0x1009_981d, 3); mov(eax, memd[ds, eax + 21]);           /* mov eax, [eax+0x15] */
            ...
            ii(0x1009_9867, 3); mov(edx, memd[ds, eax + 21]);           /* mov edx, [eax+0x15] */
            ...
            ii(0x1009_988f, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1009_9892, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1009_9895, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1009_9898, 4); cmp(memd[ss, ebp - 16], 0);             /* cmp dword [ebp-0x10], 0x0 */
            ...
            ii(0x1009_98ad, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ...
            ii(0x1009_98b9, 3); mov(ecx, memd[ds, eax + 21]);           /* mov ecx, [eax+0x15] */
            ...
            ii(0x1009_98c7, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1009_98ca, 5); call(0x1008_c999, -0xcf36);             /* call 0x1008c999 */
            ii(0x1009_98cf, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x1009_98d2, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x1009_98d5, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x1009_98d8, 2); jmp(0x1009_98e0, 6); goto l_0x1009_98e0; /* jmp 0x100998e0 */
        l_0x1009_98da:
            ii(0x1009_98da, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1009_98dd, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
        l_0x1009_98e0:
            ii(0x1009_98e0, 3); mov(edx, memd[ss, ebp - 28]);           /* mov edx, [ebp-0x1c] */
            ii(0x1009_98e3, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
            ii(0x1009_98e6, 5); call(0x1009_c7e0, 0x2ef5);              /* call 0x1009c7e0 */
            ii(0x1009_98eb, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
            ...
            ii(0x1009_9907, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
