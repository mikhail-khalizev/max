...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("0x18_ee98-5feb76d5")]
        public void Method_0018_ee98()
        {
            ii(0x18_ee98, 2); mov(bp, sp);                              /* mov bp, sp */
        ...
        l_0x18_ef15:
            ...
            ii(0x18_ef27, 2); if(jb(0x18_ef2d, 0x4)) goto l_0x18_ef2d;  /* jb 0xef2d */
        ...
        l_0x18_ef4a:
            ...
            ii(0x18_ef74, 3); lea(ax, memw[ds, si - 0xd]);              /* lea ax, [si-0xd] */
            ii(0x18_ef77, 4); mov(memw[es, di + 0x2a], ax);             /* mov [es:di+0x2a], ax */
            ii(0x18_ef7b, 4); mov(memw[es, di + 0x28], ax);             /* mov [es:di+0x28], ax */
            ...
            ii(0x18_efa1, 5); lea(esi, memd_a32[ss, ebp + 0x28]);       /* lea esi, [ebp+0x28] */
        ...
        l_0x18_efd2:
            ...
            ii(0x18_efd7, 5); test(memb[cs, si - 0x5], 0x20);           /* test byte [cs:si-0x5], 0x20 */
            ii(0x18_efdc, 1); pop(es);                                  /* pop es */
            ii(0x18_efdd, 1); pop(ds);                                  /* pop ds */
            ii(0x18_efde, 2); popad();                                  /* popad */
            ii(0x18_efe0, 2); if(jz(0x18_efe5, 0x3)) goto l_0x18_efe5;  /* jz 0xefe5 */
            ii(0x18_efe2, 3); ret(0x6); return;                         /* ret 0x6 */
        l_0x18_efe5:
            ii(0x18_efe5, 3); ret(0x2);                                 /* ret 0x2 */
        }
    }
}
