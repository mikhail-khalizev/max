...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_0708()
        {
            ...
            ii(0x18_0712, 5); mov(memw[ss, bp - 20], 0);                /* mov word [bp-0x14], 0x0 */
            ii(0x18_0717, 3); mov(ax, memw[ss, bp + 10]);               /* mov ax, [bp+0xa] */
            ii(0x18_071a, 3); mov(memw[ss, bp - 22], ax);               /* mov [bp-0x16], ax */
            ...
            ii(0x18_072b, 3); lea(cx, memw[ss, bp - 22]);               /* lea cx, [bp-0x16] */
