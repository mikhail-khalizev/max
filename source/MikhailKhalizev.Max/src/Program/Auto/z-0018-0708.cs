...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_0708()
        {
            ...
            ii(0x18_071d, 3); mov(ax, memw[ss, bp + 0x8]);              /* mov ax, [bp+0x8] */
            ii(0x18_0720, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x18_0723, 3); mov(al, memb[ss, bp + 0x6]);              /* mov al, [bp+0x6] */
            ii(0x18_0726, 2); mov(ah, 0x3d);                            /* mov ah, 0x3d */
            ii(0x18_0728, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ...
            ii(0x18_073b, 2); if(jz(0x18_0742, 0x5)) goto l_0x18_0742;  /* jz 0x742 */
            ii(0x18_073d, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0x18_0740, 2); jmp(0x18_0745, 0x3); goto l_0x18_0745;    /* jmp 0x745 */
        l_0x18_0742:
            ii(0x18_0742, 3); mov(ax, 0xffff);                          /* mov ax, 0xffff */
        l_0x18_0745:
            ii(0x18_0745, 1); pop(ds);                                  /* pop ds */
            ii(0x18_0746, 1); leave();                                  /* leave */
            ii(0x18_0747, 3); retf(0x6);                                /* retf 0x6 */
        }
    }
}
