...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_3729()
        {
            ...
            ii(0x100e_3740, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_3743, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100e_3746, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_3749, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x100e_374c, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100e_374f, 3);  add(eax, 0x1c);                       /* add eax, 0x1c */
            ii(0x100e_3752, 5);  call(0x1007_6338, -0x6_d41f);         /* call 0x10076338 */
            ii(0x100e_3757, 3);  lea(ebx, memd[ss, ebp - 16]);         /* lea ebx, [ebp-0x10] */
            ...
            ii(0x100e_3763, 4);  mov(memb[ss, ebp - 12], 0);           /* mov byte [ebp-0xc], 0x0 */
            ii(0x100e_3767, 2);  jmp(0x100e_3771, 8); goto l_0x100e_3771;/* jmp 0x100e3771 */
        l_0x100e_3769:
            ii(0x100e_3769, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x100e_376c, 5);  call(0x1007_6bf8, -0x6_cb79);         /* call 0x10076bf8 */
        l_0x100e_3771:
            ii(0x100e_3771, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100e_3773, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x100e_377f, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x100e_3782, 5);  call(0x1007_63d4, -0x6_d3b3);         /* call 0x100763d4 */
            ii(0x100e_3787, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x100e_3789, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ...
            ii(0x100e_3795, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x100e_3798, 5);  call(0x1007_63d4, -0x6_d3c9);         /* call 0x100763d4 */
            ii(0x100e_379d, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x100e_379f, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100e_37a2, 5);  call(0x100e_32c2, -0x4e5);            /* call 0x100e32c2 */
            ii(0x100e_37a7, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
        l_0x100e_37ab:
            ii(0x100e_37ab, 2);  jmp(0x100e_3769, -0x44); goto l_0x100e_3769;/* jmp 0x100e3769 */
        l_0x100e_37ad:
            ii(0x100e_37ad, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x100e_37b2, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100e_37b5, 5);  call(0x100e_41e7, 0xa2d);             /* call 0x100e41e7 */
            ii(0x100e_37ba, 4);  cmp(memb[ss, ebp - 12], 0);           /* cmp byte [ebp-0xc], 0x0 */
        ...
        l_0x100e_37dc:
            ...
            ii(0x100e_37de, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
