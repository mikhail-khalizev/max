...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_4853()
        {
            ...
            ii(0x1015_486b, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_486e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_4871, 6); mov(edx, memd[ds, eax + 0xd5]);         /* mov edx, [eax+0xd5] */
            ii(0x1015_4877, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1015_487a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_487d, 3); mov(eax, memd[ds, eax + 0x39]);         /* mov eax, [eax+0x39] */
            ...
            ii(0x1015_4888, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_488b, 3); mov(edx, memd[ds, eax + 0x33]);         /* mov edx, [eax+0x33] */
            ii(0x1015_488e, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1015_4891, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1015_489b:
            ii(0x1015_489b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_489e, 7); mov(ax, memw[ds, eax + 0xd7]);          /* mov ax, [eax+0xd7] */
            ii(0x1015_48a5, 1); inc(eax);                               /* inc eax */
            ii(0x1015_48a6, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1015_48a9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
