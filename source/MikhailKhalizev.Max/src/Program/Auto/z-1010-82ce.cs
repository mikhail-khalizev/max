...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_82ce()
        {
            ...
            ii(0x1010_82e5, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_82e8, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1010_82eb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_82ee, 3); movsx(edx, memw[ds, eax]);              /* movsx edx, word [eax] */
            ii(0x1010_82f1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_82f4, 2); cmp(edx, memd[ds, eax]);                /* cmp edx, [eax] */
            ii(0x1010_82f6, 2); if(jl(0x1010_8306, 0xe)) goto l_0x1010_8306; /* jl 0x10108306 */
            ii(0x1010_82f8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_82fb, 3); movsx(edx, memw[ds, eax]);              /* movsx edx, word [eax] */
            ii(0x1010_82fe, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_8301, 3); cmp(edx, memd[ds, eax + 0x8]);          /* cmp edx, [eax+0x8] */
            ii(0x1010_8304, 2); if(jl(0x1010_8308, 0x2)) goto l_0x1010_8308; /* jl 0x10108308 */
        l_0x1010_8306:
            ii(0x1010_8306, 2); jmp(0x1010_8318, 0x10); goto l_0x1010_8318; /* jmp 0x10108318 */
        l_0x1010_8308:
            ii(0x1010_8308, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_830b, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x1010_830d, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1010_8310, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_8313, 3); cmp(edx, memd[ds, eax + 0x4]);          /* cmp edx, [eax+0x4] */
            ii(0x1010_8316, 2); if(jge(0x1010_831a, 0x2)) goto l_0x1010_831a; /* jge 0x1010831a */
        l_0x1010_8318:
            ii(0x1010_8318, 2); jmp(0x1010_832a, 0x10); goto l_0x1010_832a; /* jmp 0x1010832a */
        l_0x1010_831a:
            ii(0x1010_831a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_831d, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x1010_831f, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1010_8322, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_8325, 3); cmp(edx, memd[ds, eax + 0xc]);          /* cmp edx, [eax+0xc] */
            ii(0x1010_8328, 2); if(jl(0x1010_832c, 0x2)) goto l_0x1010_832c; /* jl 0x1010832c */
        l_0x1010_832a:
            ii(0x1010_832a, 2); jmp(0x1010_8332, 0x6); goto l_0x1010_8332; /* jmp 0x10108332 */
        l_0x1010_832c:
            ii(0x1010_832c, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1010_8330, 2); jmp(0x1010_8336, 0x4); goto l_0x1010_8336; /* jmp 0x10108336 */
        l_0x1010_8332:
