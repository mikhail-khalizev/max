...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_7c55()
        {
            ...
            ii(0x7c61, 2);    if(jnz(0x7c67, 0x4)) goto l_0x7c67;       /* jnz 0x7c67 */
        l_0x7c63:
        ...
        l_0x7c67:
            ...
            ii(0x7c6a, 5);    mov(memw[ss, bp - 0x4], 0);               /* mov word [bp-0x4], 0x0 */
            ii(0x7c6f, 3);    mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
        l_0x7c72:
            ii(0x7c72, 3);    les(bx, memw[ss, bp - 0x4]);              /* les bx, [bp-0x4] */
            ii(0x7c75, 4);    cmp(memb[es, bx], 0);                     /* cmp byte [es:bx], 0x0 */
            ii(0x7c79, 2);    if(jz(0x7c63, -0x18)) goto l_0x7c63;      /* jz 0x7c63 */
            ii(0x7c7b, 3);    mov(si, memw[ss, bp + 0x4]);              /* mov si, [bp+0x4] */
            ii(0x7c7e, 2);    jmp(0x7c9c, 0x1c); goto l_0x7c9c;         /* jmp 0x7c9c */
        l_0x7c80:
            ii(0x7c80, 2);    mov(al, memb[ds, si]);                    /* mov al, [si] */
            ii(0x7c82, 3);    les(bx, memw[ss, bp - 0x4]);              /* les bx, [bp-0x4] */
            ii(0x7c85, 3);    cmp(memb[es, bx], al);                    /* cmp [es:bx], al */
            ii(0x7c88, 2);    if(jz(0x7c98, 0xe)) goto l_0x7c98;        /* jz 0x7c98 */
        l_0x7c8a:
            ii(0x7c8a, 3);    mov(bx, memw[ss, bp - 0x4]);              /* mov bx, [bp-0x4] */
            ii(0x7c8d, 3);    inc(memw[ss, bp - 0x4]);                  /* inc word [bp-0x4] */
        ...
        l_0x7c98:
            ...
            ii(0x7c99, 3);    inc(memw[ss, bp - 0x4]);                  /* inc word [bp-0x4] */
        l_0x7c9c:
            ii(0x7c9c, 3);    cmp(memb[ds, si], 0);                     /* cmp byte [si], 0x0 */
            ii(0x7c9f, 2);    if(jnz(0x7c80, -0x21)) goto l_0x7c80;     /* jnz 0x7c80 */
            ii(0x7ca1, 5);    mov(memw[ss, bp - 0x6], 0x80);            /* mov word [bp-0x6], 0x80 */
            ii(0x7ca6, 3);    mov(si, memw[ss, bp + 0x6]);              /* mov si, [bp+0x6] */
        l_0x7ca9:
            ii(0x7ca9, 3);    dec(memw[ss, bp - 0x6]);                  /* dec word [bp-0x6] */
            ii(0x7cac, 4);    cmp(memw[ss, bp - 0x6], 0);               /* cmp word [bp-0x6], 0x0 */
            ii(0x7cb0, 2);    if(jle(0x7cc3, 0x11)) goto l_0x7cc3;      /* jle 0x7cc3 */
            ii(0x7cb2, 3);    les(bx, memw[ss, bp - 0x4]);              /* les bx, [bp-0x4] */
            ii(0x7cb5, 3);    inc(memw[ss, bp - 0x4]);                  /* inc word [bp-0x4] */
            ii(0x7cb8, 3);    mov(al, memb[es, bx]);                    /* mov al, [es:bx] */
            ii(0x7cbb, 1);    inc(si);                                  /* inc si */
            ii(0x7cbc, 3);    mov(memb[ds, si - 0x1], al);              /* mov [si-0x1], al */
        ...
        l_0x7cc3:
            ...
            ii(0x7cc6, 3);    mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
        l_0x7cc9:
