...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_19a4()
        {
            ...
            ii(0x100d_19da, 3);  mov(memd[ss, ebp - 20], edx);         /* mov [ebp-0x14], edx */
            ii(0x100d_19dd, 5);  mov(ecx, 6);                          /* mov ecx, 0x6 */
            ii(0x100d_19e2, 3);  lea(edi, memd[ss, ebp - 48]);         /* lea edi, [ebp-0x30] */
            ii(0x100d_19e5, 3);  mov(esi, memd[ss, ebp - 8]);          /* mov esi, [ebp-0x8] */
            ii(0x100d_19e8, 3);  lea(esi, memd[ds, esi + 23]);         /* lea esi, [esi+0x17] */
            ii(0x100d_19eb, 2);  rep(() => movsd());                   /* rep movsd */
            ii(0x100d_19ed, 2);  movsw();                              /* movsw */
            ii(0x100d_19ef, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_19f2, 3);  mov(eax, memd[ds, eax + 37]);         /* mov eax, [eax+0x25] */
            ...
            ii(0x100d_19fe, 3);  mov(eax, memd[ds, eax + 45]);         /* mov eax, [eax+0x2d] */
            ii(0x100d_1a01, 3);  add(eax, 0xb);                        /* add eax, 0xb */
            ii(0x100d_1a04, 2);  add(eax, edx);                        /* add eax, edx */
            ii(0x100d_1a06, 3);  mov(memd[ss, ebp - 26], eax);         /* mov [ebp-0x1a], eax */
            ...
            ii(0x100d_1a27, 3);  mov(ebx, memd[ds, eax + 37]);         /* mov ebx, [eax+0x25] */
            ii(0x100d_1a2a, 3);  sar(ebx, 0x10);                       /* sar ebx, 0x10 */
            ii(0x100d_1a2d, 3);  lea(edx, memd[ss, ebp - 48]);         /* lea edx, [ebp-0x30] */
            ii(0x100d_1a30, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100d_1a33, 3);  mov(eax, memd[ds, eax + 10]);         /* mov eax, [eax+0xa] */
            ...
            ii(0x100d_1a48, 3);  mov(ecx, memd[ds, eax + 37]);         /* mov ecx, [eax+0x25] */
            ...
            ii(0x100d_1a58, 3);  mov(eax, memd[ss, ebp - 26]);         /* mov eax, [ebp-0x1a] */
            ...
            ii(0x100d_1a74, 3);  mov(ebx, memd[ds, eax + 37]);         /* mov ebx, [eax+0x25] */
            ii(0x100d_1a77, 3);  sar(ebx, 0x10);                       /* sar ebx, 0x10 */
            ii(0x100d_1a7a, 3);  lea(edx, memd[ss, ebp - 48]);         /* lea edx, [ebp-0x30] */
            ii(0x100d_1a7d, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
        ...
        l_0x100d_1a8b:
            ...
            ii(0x100d_1a94, 3);  mov(eax, memd[ds, eax + 106]);        /* mov eax, [eax+0x6a] */
            ...
            ii(0x100d_1aab, 3);  mov(eax, memd[ds, eax + 106]);        /* mov eax, [eax+0x6a] */
            ...
            ii(0x100d_1abc, 3);  mov(eax, memd[ds, eax + 49]);         /* mov eax, [eax+0x31] */
            ii(0x100d_1abf, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ...
            ii(0x100d_1add, 3);  mov(eax, memd[ds, eax + 49]);         /* mov eax, [eax+0x31] */
            ii(0x100d_1ae0, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ...
            ii(0x100d_1b10, 3);  mov(eax, memd[ds, eax + 106]);        /* mov eax, [eax+0x6a] */
            ii(0x100d_1b13, 5);  call(0x100d_4ef0, 0x33d8);            /* call 0x100d4ef0 */
            ii(0x100d_1b18, 1);  cwde();                               /* cwde */
            ii(0x100d_1b19, 3);  mov(memd[ss, ebp - 52], eax);         /* mov [ebp-0x34], eax */
            ii(0x100d_1b1c, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1b1f, 3);  mov(eax, memd[ds, eax + 45]);         /* mov eax, [eax+0x2d] */
            ii(0x100d_1b22, 3);  add(eax, memd[ss, ebp - 52]);         /* add eax, [ebp-0x34] */
        ...
        l_0x100d_1b3e:
            ...
            ii(0x100d_1b6a, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100d_1b6d, 3);  mov(ebx, memd[ds, eax + 31]);         /* mov ebx, [eax+0x1f] */
            ii(0x100d_1b70, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1b73, 3);  mov(edx, memd[ds, eax + 37]);         /* mov edx, [eax+0x25] */
            ii(0x100d_1b76, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x100d_1b79, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1b7c, 3);  mov(eax, memd[ds, eax + 45]);         /* mov eax, [eax+0x2d] */
            ii(0x100d_1b7f, 5);  call(0x100e_9ae5, 0x1_7f61);          /* call 0x100e9ae5 */
        l_0x100d_1b84:
            ii(0x100d_1b84, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1b87, 3);  mov(memd[ss, ebp - 56], eax);         /* mov [ebp-0x38], eax */
            ii(0x100d_1b8a, 3);  mov(eax, memd[ss, ebp - 56]);         /* mov eax, [ebp-0x38] */
            ii(0x100d_1b8d, 3);  mov(ebx, memd[ds, eax + 19]);         /* mov ebx, [eax+0x13] */
            ii(0x100d_1b90, 4);  movsx(edx, memw[ss, ebp - 4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x100d_1b94, 3);  mov(eax, memd[ss, ebp - 56]);         /* mov eax, [ebp-0x38] */
            ii(0x100d_1b97, 3);  call_abs(memd[ds, ebx + 16]);         /* call dword [ebx+0x10] */
            ii(0x100d_1b9a, 3);  mov(memd[ss, ebp - 60], eax);         /* mov [ebp-0x3c], eax */
            ...
            ii(0x100d_1ba6, 3);  mov(eax, memd[ds, eax + 110]);        /* mov eax, [eax+0x6e] */
            ...
            ii(0x100d_1bb7, 3);  mov(eax, memd[ds, eax + 114]);        /* mov eax, [eax+0x72] */
            ...
            ii(0x100d_1bc8, 3);  mov(eax, memd[ds, eax + 118]);        /* mov eax, [eax+0x76] */
            ...
            ii(0x100d_1bd9, 3);  mov(eax, memd[ds, eax + 122]);        /* mov eax, [eax+0x7a] */
            ...
            ii(0x100d_1bea, 3);  mov(eax, memd[ds, eax + 126]);        /* mov eax, [eax+0x7e] */
            ...
            ii(0x100d_1bfb, 6);  mov(eax, memd[ds, eax + 130]);        /* mov eax, [eax+0x82] */
            ii(0x100d_1c01, 5);  call(0x100d_7f6c, 0x6366);            /* call 0x100d7f6c */
            ii(0x100d_1c06, 3);  mov(ebx, memd[ss, ebp - 8]);          /* mov ebx, [ebp-0x8] */
            ii(0x100d_1c09, 3);  mov(ebx, memd[ds, ebx + 49]);         /* mov ebx, [ebx+0x31] */
            ii(0x100d_1c0c, 3);  mov(ebx, memd[ds, ebx + 80]);         /* mov ebx, [ebx+0x50] */
            ii(0x100d_1c0f, 3);  sar(ebx, 0x10);                       /* sar ebx, 0x10 */
            ii(0x100d_1c12, 4);  movsx(edx, memw[ss, ebp - 60]);       /* movsx edx, word [ebp-0x3c] */
            ii(0x100d_1c16, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1c19, 3);  mov(eax, memd[ds, eax + 49]);         /* mov eax, [eax+0x31] */
            ...
            ii(0x100d_1c27, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x100d_1c2a, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1c2d, 4);  mov(ax, memw[ds, eax + 56]);          /* mov ax, [eax+0x38] */
            ii(0x100d_1c31, 4);  cmp(ax, memw[ss, ebp - 16]);          /* cmp ax, [ebp-0x10] */
            ...
            ii(0x100d_1c40, 3);  mov(eax, memd[ds, eax + 98]);         /* mov eax, [eax+0x62] */
            ...
            ii(0x100d_1c4d, 3);  mov(eax, memd[ds, eax + 102]);        /* mov eax, [eax+0x66] */
            ii(0x100d_1c50, 5);  call(0x100c_fb73, -0x20e2);           /* call 0x100cfb73 */
            ii(0x100d_1c55, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_1c58, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ii(0x100d_1c5b, 4);  mov(memw[ds, edx + 56], ax);          /* mov [edx+0x38], ax */
            ii(0x100d_1c5f, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1c62, 4);  mov(ax, memw[ds, eax + 56]);          /* mov ax, [eax+0x38] */
            ii(0x100d_1c66, 3);  mov(memd[ss, ebp - 64], eax);         /* mov [ebp-0x40], eax */
        ...
        l_0x100d_1c6b:
            ...
            ii(0x100d_1c73, 3);  mov(eax, memd[ds, eax + 94]);         /* mov eax, [eax+0x5e] */
        ...
        l_0x100d_1c7d:
            ...
            ii(0x100d_1c85, 3);  mov(eax, memd[ds, eax + 98]);         /* mov eax, [eax+0x62] */
        ...
        l_0x100d_1c8f:
            ...
            ii(0x100d_1c97, 3);  mov(eax, memd[ds, eax + 102]);        /* mov eax, [eax+0x66] */
        ...
        l_0x100d_1ca3:
            ii(0x100d_1ca3, 3);  mov(eax, memd[ss, ebp - 64]);         /* mov eax, [ebp-0x40] */
            ii(0x100d_1ca6, 3);  mov(memd[ss, ebp - 68], eax);         /* mov [ebp-0x44], eax */
            ii(0x100d_1ca9, 5);  cmp(memw[ss, ebp - 68], 2);           /* cmp word [ebp-0x44], 0x2 */
            ii(0x100d_1cae, 2);  if(jb(0x100d_1cc0, 0x10)) goto l_0x100d_1cc0;/* jb 0x100d1cc0 */
            ii(0x100d_1cb0, 5);  cmp(memw[ss, ebp - 68], 2);           /* cmp word [ebp-0x44], 0x2 */
            ii(0x100d_1cb5, 2);  if(jbe(0x100d_1c7d, -0x3a)) goto l_0x100d_1c7d;/* jbe 0x100d1c7d */
            ii(0x100d_1cb7, 5);  cmp(memw[ss, ebp - 68], 4);           /* cmp word [ebp-0x44], 0x4 */
        ...
        l_0x100d_1cc0:
            ii(0x100d_1cc0, 5);  cmp(memw[ss, ebp - 68], 1);           /* cmp word [ebp-0x44], 0x1 */
        ...
        l_0x100d_1cc9:
            ...
            ii(0x100d_1ccc, 3);  mov(eax, memd[ds, eax + 54]);         /* mov eax, [eax+0x36] */
        ...
        l_0x100d_1ce1:
            ...
            ii(0x100d_1d13, 3);  mov(eax, memd[ds, eax + 45]);         /* mov eax, [eax+0x2d] */
            ii(0x100d_1d16, 2);  add(esi, eax);                        /* add esi, eax */
            ii(0x100d_1d18, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1d1b, 3);  mov(eax, memd[ds, eax + 110]);        /* mov eax, [eax+0x6e] */
            ...
            ii(0x100d_1d26, 3);  mov(memd[ss, ebp - 52], esi);         /* mov [ebp-0x34], esi */
            ii(0x100d_1d29, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1d2c, 3);  mov(esi, memd[ds, eax + 37]);         /* mov esi, [eax+0x25] */
            ii(0x100d_1d2f, 3);  sar(esi, 0x10);                       /* sar esi, 0x10 */
            ii(0x100d_1d32, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1d35, 3);  mov(eax, memd[ds, eax + 110]);        /* mov eax, [eax+0x6e] */
            ...
            ii(0x100d_1d41, 3);  mov(esi, memd[ss, ebp - 52]);         /* mov esi, [ebp-0x34] */
            ...
            ii(0x100d_1d4f, 3);  mov(eax, memd[ds, eax + 54]);         /* mov eax, [eax+0x36] */
        ...
        l_0x100d_1d64:
            ...
            ii(0x100d_1d89, 3);  mov(eax, memd[ds, eax + 49]);         /* mov eax, [eax+0x31] */
            ...
            ii(0x100d_1d97, 4);  imul(eax, memd[ss, ebp - 60]);        /* imul eax, [ebp-0x3c] */
            ii(0x100d_1d9b, 3);  movsx(edx, ax);                       /* movsx edx, ax */
            ii(0x100d_1d9e, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1da1, 3);  mov(eax, memd[ds, eax + 114]);        /* mov eax, [eax+0x72] */
            ...
            ii(0x100d_1dad, 3);  mov(esi, memd[ds, esi + 45]);         /* mov esi, [esi+0x2d] */
            ii(0x100d_1db0, 2);  add(esi, eax);                        /* add esi, eax */
            ii(0x100d_1db2, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1db5, 3);  mov(eax, memd[ds, eax + 114]);        /* mov eax, [eax+0x72] */
            ...
            ii(0x100d_1dc3, 3);  mov(eax, memd[ds, eax + 37]);         /* mov eax, [eax+0x25] */
            ii(0x100d_1dc6, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x100d_1dc9, 3);  mov(memd[ss, ebp - 52], eax);         /* mov [ebp-0x34], eax */
            ii(0x100d_1dcc, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1dcf, 3);  mov(eax, memd[ds, eax + 114]);        /* mov eax, [eax+0x72] */
            ii(0x100d_1dd2, 5);  call(0x100d_4ebc, 0x30e5);            /* call 0x100d4ebc */
            ii(0x100d_1dd7, 1);  cwde();                               /* cwde */
            ii(0x100d_1dd8, 3);  mov(edi, memd[ss, ebp - 52]);         /* mov edi, [ebp-0x34] */
            ii(0x100d_1ddb, 3);  imul(edi, eax);                       /* imul edi, eax */
            ii(0x100d_1dde, 3);  mov(memd[ss, ebp - 52], edi);         /* mov [ebp-0x34], edi */
            ii(0x100d_1de1, 3);  lea(eax, memd[ds, esi - 1]);          /* lea eax, [esi-0x1] */
            ii(0x100d_1de4, 3);  add(eax, memd[ss, ebp - 52]);         /* add eax, [ebp-0x34] */
            ii(0x100d_1de7, 5);  call(0x1012_b658, 0x5_986c);          /* call 0x1012b658 */
            ii(0x100d_1dec, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1def, 3);  mov(eax, memd[ds, eax + 49]);         /* mov eax, [eax+0x31] */
            ...
            ii(0x100d_1e07, 3);  mov(eax, memd[ds, eax + 98]);         /* mov eax, [eax+0x62] */
            ...
            ii(0x100d_1e1d, 3);  mov(eax, memd[ds, eax + 102]);        /* mov eax, [eax+0x66] */
        ...
        l_0x100d_1e2a:
            ii(0x100d_1e2a, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x100d_1e41, 3);  mov(eax, memd[ds, eax + 98]);         /* mov eax, [eax+0x62] */
        ...
        l_0x100d_1e4e:
            ...
            ii(0x100d_1e5f, 3);  mov(eax, memd[ds, eax + 98]);         /* mov eax, [eax+0x62] */
            ii(0x100d_1e62, 5);  call(0x100c_fa7c, -0x23eb);           /* call 0x100cfa7c */
            ii(0x100d_1e67, 3);  lea(ecx, memd[ss, ebp - 60]);         /* lea ecx, [ebp-0x3c] */
            ...
            ii(0x100d_1e76, 3);  mov(eax, memd[ds, eax + 49]);         /* mov eax, [eax+0x31] */
            ii(0x100d_1e79, 5);  call(0x1015_4f88, 0x8_310a);          /* call 0x10154f88 */
            ii(0x100d_1e7e, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100d_1e81, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1e84, 3);  mov(eax, memd[ds, eax + 54]);         /* mov eax, [eax+0x36] */
        ...
        l_0x100d_1e99:
            ...
            ii(0x100d_1ecb, 3);  mov(eax, memd[ds, eax + 45]);         /* mov eax, [eax+0x2d] */
            ii(0x100d_1ece, 2);  add(esi, eax);                        /* add esi, eax */
            ii(0x100d_1ed0, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1ed3, 3);  mov(eax, memd[ds, eax + 118]);        /* mov eax, [eax+0x76] */
            ...
            ii(0x100d_1ede, 3);  mov(memd[ss, ebp - 52], esi);         /* mov [ebp-0x34], esi */
            ii(0x100d_1ee1, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1ee4, 3);  mov(esi, memd[ds, eax + 37]);         /* mov esi, [eax+0x25] */
            ii(0x100d_1ee7, 3);  sar(esi, 0x10);                       /* sar esi, 0x10 */
            ii(0x100d_1eea, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1eed, 3);  mov(eax, memd[ds, eax + 118]);        /* mov eax, [eax+0x76] */
            ...
            ii(0x100d_1ef9, 3);  mov(esi, memd[ss, ebp - 52]);         /* mov esi, [ebp-0x34] */
            ...
            ii(0x100d_1f07, 3);  mov(eax, memd[ds, eax + 54]);         /* mov eax, [eax+0x36] */
        ...
        l_0x100d_1f1c:
            ...
            ii(0x100d_1f4e, 3);  mov(eax, memd[ds, eax + 45]);         /* mov eax, [eax+0x2d] */
            ii(0x100d_1f51, 2);  add(esi, eax);                        /* add esi, eax */
            ii(0x100d_1f53, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1f56, 3);  mov(eax, memd[ds, eax + 122]);        /* mov eax, [eax+0x7a] */
            ...
            ii(0x100d_1f64, 3);  mov(eax, memd[ds, eax + 37]);         /* mov eax, [eax+0x25] */
            ii(0x100d_1f67, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x100d_1f6a, 3);  mov(memd[ss, ebp - 52], eax);         /* mov [ebp-0x34], eax */
            ii(0x100d_1f6d, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1f70, 3);  mov(eax, memd[ds, eax + 122]);        /* mov eax, [eax+0x7a] */
            ii(0x100d_1f73, 5);  call(0x100d_4ebc, 0x2f44);            /* call 0x100d4ebc */
            ii(0x100d_1f78, 1);  cwde();                               /* cwde */
            ii(0x100d_1f79, 4);  imul(eax, memd[ss, ebp - 52]);        /* imul eax, [ebp-0x34] */
        ...
        l_0x100d_1f85:
            ii(0x100d_1f85, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x100d_1f9c, 3);  mov(eax, memd[ds, eax + 102]);        /* mov eax, [eax+0x66] */
        ...
        l_0x100d_1fa9:
            ...
            ii(0x100d_1fba, 3);  mov(eax, memd[ds, eax + 102]);        /* mov eax, [eax+0x66] */
            ii(0x100d_1fbd, 5);  call(0x100c_fa7c, -0x2546);           /* call 0x100cfa7c */
            ii(0x100d_1fc2, 3);  lea(ecx, memd[ss, ebp - 60]);         /* lea ecx, [ebp-0x3c] */
            ...
            ii(0x100d_1fd1, 3);  mov(eax, memd[ds, eax + 49]);         /* mov eax, [eax+0x31] */
            ii(0x100d_1fd4, 5);  call(0x1015_4f88, 0x8_2faf);          /* call 0x10154f88 */
            ii(0x100d_1fd9, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100d_1fdc, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_1fdf, 3);  mov(eax, memd[ds, eax + 54]);         /* mov eax, [eax+0x36] */
        ...
        l_0x100d_1ff4:
            ...
            ii(0x100d_2026, 3);  mov(eax, memd[ds, eax + 45]);         /* mov eax, [eax+0x2d] */
            ii(0x100d_2029, 2);  add(esi, eax);                        /* add esi, eax */
            ii(0x100d_202b, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_202e, 3);  mov(eax, memd[ds, eax + 126]);        /* mov eax, [eax+0x7e] */
            ...
            ii(0x100d_2039, 3);  mov(memd[ss, ebp - 52], esi);         /* mov [ebp-0x34], esi */
            ii(0x100d_203c, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_203f, 3);  mov(esi, memd[ds, eax + 37]);         /* mov esi, [eax+0x25] */
            ii(0x100d_2042, 3);  sar(esi, 0x10);                       /* sar esi, 0x10 */
            ii(0x100d_2045, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_2048, 3);  mov(eax, memd[ds, eax + 126]);        /* mov eax, [eax+0x7e] */
            ...
            ii(0x100d_2054, 3);  mov(esi, memd[ss, ebp - 52]);         /* mov esi, [ebp-0x34] */
            ...
            ii(0x100d_2062, 3);  mov(eax, memd[ds, eax + 54]);         /* mov eax, [eax+0x36] */
        ...
        l_0x100d_2077:
            ...
            ii(0x100d_20af, 3);  mov(eax, memd[ds, eax + 45]);         /* mov eax, [eax+0x2d] */
            ii(0x100d_20b2, 2);  add(esi, eax);                        /* add esi, eax */
            ii(0x100d_20b4, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_20b7, 6);  mov(eax, memd[ds, eax + 130]);        /* mov eax, [eax+0x82] */
            ...
            ii(0x100d_20c8, 3);  mov(eax, memd[ds, eax + 37]);         /* mov eax, [eax+0x25] */
            ii(0x100d_20cb, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x100d_20ce, 3);  mov(memd[ss, ebp - 52], eax);         /* mov [ebp-0x34], eax */
            ii(0x100d_20d1, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_20d4, 6);  mov(eax, memd[ds, eax + 130]);        /* mov eax, [eax+0x82] */
            ii(0x100d_20da, 5);  call(0x100d_4ebc, 0x2ddd);            /* call 0x100d4ebc */
            ii(0x100d_20df, 1);  cwde();                               /* cwde */
            ii(0x100d_20e0, 4);  imul(eax, memd[ss, ebp - 52]);        /* imul eax, [ebp-0x34] */
        ...
        l_0x100d_20ec:
            ...
            ii(0x100d_20ef, 3);  mov(eax, memd[ds, eax + 41]);         /* mov eax, [eax+0x29] */
