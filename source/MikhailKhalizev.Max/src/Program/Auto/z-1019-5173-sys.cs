...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("14711805-a7c8-4de7-b690-4763aab8a5c0")]
        public void /* sys */ Method_1019_5173()
        {
            ii(0x1019_5173, 1); pushd(ebp);                             /* push ebp */
            ii(0x1019_5174, 2); mov(ebp, esp);                          /* mov ebp, esp */
            ii(0x1019_5176, 1); pushd(esi);                             /* push esi */
            ii(0x1019_5177, 1); pushd(edi);                             /* push edi */
            ii(0x1019_5178, 1); pushd(ebx);                             /* push ebx */
            ii(0x1019_5179, 1); pushd(ecx);                             /* push ecx */
            ...
            ii(0x1019_5185, 2); cmp(al, 0x3);                           /* cmp al, 0x3 */
            ii(0x1019_5187, 2); if(jnzd(0x1019_519d, 0x14)) goto l_0x1019_519d; /* jnz 0x1019519d */
            ...
            ii(0x1019_5191, 3); mov(ebx, memd_a32[ss, ebp + 0x8]);      /* mov ebx, [ebp+0x8] */
        ...
        l_0x1019_519d:
            ...
            ii(0x1019_51a2, 1); popd(ecx);                              /* pop ecx */
            ii(0x1019_51a3, 1); popd(ebx);                              /* pop ebx */
            ii(0x1019_51a4, 1); popd(edi);                              /* pop edi */
            ii(0x1019_51a5, 1); popd(esi);                              /* pop esi */
            ii(0x1019_51a6, 1); popd(ebp);                              /* pop ebp */
            ii(0x1019_51a7, 1); retd(); return;                         /* ret */
        }
    }
}
