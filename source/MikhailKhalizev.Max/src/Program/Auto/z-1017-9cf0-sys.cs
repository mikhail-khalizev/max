...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_9cf0()
        {
            ...
            ii(0x1017_9cf8, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x1017_9cfb, 2); mov(esi, ebx);                          /* mov esi, ebx */
            ii(0x1017_9cfd, 2); mov(edi, ecx);                          /* mov edi, ecx */
            ii(0x1017_9cff, 7); cmp(memd[ds, 0x101b_e418], -0x1 /* 0xff */); /* cmp dword [0x101be418], 0xffffffff */
        ...
        l_0x1017_9d12:
            ii(0x1017_9d12, 7); cmp(memd[ds, 0x101b_e41c], -0x1 /* 0xff */); /* cmp dword [0x101be41c], 0xffffffff */
            ii(0x1017_9d19, 2); if(jz(0x1017_9d20, 0x5)) goto l_0x1017_9d20; /* jz 0x10179d20 */
        ...
        l_0x1017_9d47:
            ii(0x1017_9d47, 3); mov(eax, memd[ss, ebp + 0x8]);          /* mov eax, [ebp+0x8] */
            ii(0x1017_9d4a, 5); mov(memd[ds, 0x1020_9cfc], eax);        /* mov [0x10209cfc], eax */
            ii(0x1017_9d4f, 3); mov(eax, memd[ss, ebp + 0xc]);          /* mov eax, [ebp+0xc] */
            ...
            ii(0x1017_9d61, 3); lea(ebx, memd[ss, ebp - 0x78]);         /* lea ebx, [ebp-0x78] */
            ...
            ii(0x1017_9d70, 4); cmp(memd[ss, ebp - 0x50], 0);           /* cmp dword [ebp-0x50], 0x0 */
            ii(0x1017_9d74, 2); if(jnz(0x1017_9d7a, 0x4)) goto l_0x1017_9d7a; /* jnz 0x10179d7a */
        ...
        l_0x1017_9d7a:
            ...
            ii(0x1017_9db4, 2); if(jz(0x1017_9dbd, 0x7)) goto l_0x1017_9dbd; /* jz 0x10179dbd */
            ii(0x1017_9db6, 7); or(memb[ds, 0x1020_9d4d], 0x1);         /* or byte [0x10209d4d], 0x1 */
        l_0x1017_9dbd:
            ...
            ii(0x1017_9de9, 3); mov(ecx, memd[ss, ebp + 0x8]);          /* mov ecx, [ebp+0x8] */
            ii(0x1017_9dec, 6); mov(ebx, memd[ds, eax + 0x1020_bae8]);  /* mov ebx, [eax+0x1020bae8] */
            ii(0x1017_9df2, 2); test(ecx, ecx);                         /* test ecx, ecx */
            ii(0x1017_9df4, 2); if(jz(0x1017_9dfd, 0x7)) goto l_0x1017_9dfd; /* jz 0x10179dfd */
            ii(0x1017_9df6, 5); mov(eax, 0x80);                         /* mov eax, 0x80 */
            ii(0x1017_9dfb, 2); jmp(0x1017_9e02, 0x5); goto l_0x1017_9e02; /* jmp 0x10179e02 */
        l_0x1017_9dfd:
        ...
        l_0x1017_9e02:
            ...
            ii(0x1017_9e0a, 2); if(jz(0x1017_9e13, 0x7)) goto l_0x1017_9e13; /* jz 0x10179e13 */
        ...
        l_0x1017_9e3e:
            ii(0x1017_9e3e, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1017_9e41, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
