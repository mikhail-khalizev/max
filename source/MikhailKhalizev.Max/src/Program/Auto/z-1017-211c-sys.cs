...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_211c()
        {
            ...
            ii(0x1017_2128, 4);  cmp(memd[ds, eax + 12], 0);           /* cmp dword [eax+0xc], 0x0 */
        ...
        l_0x1017_2138:
            ii(0x1017_2138, 3);  mov(ah, memb[ds, eax + 13]);          /* mov ah, [eax+0xd] */
        ...
        l_0x1017_214b:
            ...
            ii(0x1017_2159, 3);  mov(ebp, memd[ds, ecx + 16]);         /* mov ebp, [ecx+0x10] */
        ...
        l_0x1017_2165:
            ...
            ii(0x1017_2169, 3);  mov(eax, memd[ds, ecx + 16]);         /* mov eax, [ecx+0x10] */
            ii(0x1017_216c, 5);  call(/* sys */ 0x1018_d6b2, 0x1_b541);/* call 0x1018d6b2 */
            ii(0x1017_2171, 2);  or(esi, eax);                         /* or esi, eax */
        l_0x1017_2173:
            ii(0x1017_2173, 4);  test(memb[ds, ecx + 12], 8);          /* test byte [ecx+0xc], 0x8 */
        ...
        l_0x1017_2188:
            ii(0x1017_2188, 4);  test(memb[ds, ecx + 13], 8);          /* test byte [ecx+0xd], 0x8 */
            ...
            ii(0x1017_2192, 3);  mov(dl, memb[ds, ecx + 25]);          /* mov dl, [ecx+0x19] */
