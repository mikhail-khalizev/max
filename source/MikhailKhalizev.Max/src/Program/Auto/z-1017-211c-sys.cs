...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1017_2138:
            ...
            ii(0x1017_2140, 2); if(jz(0x1017_214b, 0x9)) goto l_0x1017_214b; /* jz 0x1017214b */
        ...
        l_0x1017_2173:
            ii(0x1017_2173, 4); test(memb[ds, ecx + 0xc], 0x8);         /* test byte [ecx+0xc], 0x8 */
            ii(0x1017_2177, 2); if(jz(0x1017_2188, 0xf)) goto l_0x1017_2188; /* jz 0x10172188 */
            ii(0x1017_2179, 3); mov(eax, memd[ds, ecx + 0x8]);          /* mov eax, [ecx+0x8] */
            ii(0x1017_217c, 5); call(Definitions.sys_free, -0x70c0);    /* call 0x1016b0c1 */
            ii(0x1017_2181, 7); mov(memd[ds, ecx + 0x8], 0);            /* mov dword [ecx+0x8], 0x0 */
        l_0x1017_2188:
            ii(0x1017_2188, 4); test(memb[ds, ecx + 0xd], 0x8);         /* test byte [ecx+0xd], 0x8 */
