...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_d2df()
        {
            ...
            ii(0x1008_d2f7, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_d2fa, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_d2fc, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_d30b, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_d30e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_d31e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_d321, 3); add(eax, 0x15);                         /* add eax, 0x15 */
            ii(0x1008_d324, 5); call(0x1007_6574, -0x1_6db5);           /* call 0x10076574 */
            ii(0x1008_d329, 4); cmp(memb[ds, eax + 0x3e], 0x1f);        /* cmp byte [eax+0x3e], 0x1f */
            ii(0x1008_d32d, 2); if(jnz(0x1008_d337, 0x8)) goto l_0x1008_d337; /* jnz 0x1008d337 */
            ii(0x1008_d32f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1008_d339:
            ...
            ii(0x1008_d33e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
