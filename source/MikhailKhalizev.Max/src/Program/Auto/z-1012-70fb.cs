...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_70fb()
        {
            ...
            ii(0x1012_7114, 3); mov(memd[ss, ebp - 12], edx);           /* mov [ebp-0xc], edx */
            ...
            ii(0x1012_7128, 4); mov(ax, memw[ds, edx + 12]);            /* mov ax, [edx+0xc] */
            ...
            ii(0x1012_713b, 7); mov(memd[ss, ebp - 16], 0x101c_5c21);   /* mov dword [ebp-0x10], 0x101c5c21 */
            ii(0x1012_7142, 6); mov(edx, memd[ds, 0x101c_59cc]);        /* mov edx, [0x101c59cc] */
            ii(0x1012_7148, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1012_714a, 3); mov(al, memb[ds, edx + 17]);            /* mov al, [edx+0x11] */
            ii(0x1012_714d, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x1012_7150, 3); mov(memw[ds, edx], ax);                 /* mov [edx], ax */
            ii(0x1012_7153, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1012_7156, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ...
            ii(0x1012_7169, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
