...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_c936()
        {
            ...
            ii(0x1011_c94b, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1011_c94e, 3); mov(memd[ss, ebp - 12], edx);           /* mov [ebp-0xc], edx */
            ii(0x1011_c951, 3); mov(memd[ss, ebp - 8], ebx);            /* mov [ebp-0x8], ebx */
            ii(0x1011_c954, 3); mov(memd[ss, ebp - 4], ecx);            /* mov [ebp-0x4], ecx */
            ii(0x1011_c957, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ...
            ii(0x1011_c965, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x1011_c974, 4); mov(memw[ss, ebp - 20], ax);            /* mov [ebp-0x14], ax */
            ...
            ii(0x1011_c980, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x1011_c991, 4); mov(memw[ss, ebp - 18], ax);            /* mov [ebp-0x12], ax */
            ii(0x1011_c995, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x1011_c998, 4); cmp(ax, memw[ss, ebp - 18]);            /* cmp ax, [ebp-0x12] */
            ii(0x1011_c99c, 2); if(jle(0x1011_c9ad, 0xf)) goto l_0x1011_c9ad; /* jle 0x1011c9ad */
            ii(0x1011_c99e, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x1011_c9a1, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x1011_c9a3, 3); mov(edx, memd[ss, ebp - 18]);           /* mov edx, [ebp-0x12] */
            ii(0x1011_c9a6, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1011_c9a8, 3); mov(memd[ss, ebp - 24], edx);           /* mov [ebp-0x18], edx */
            ii(0x1011_c9ab, 2); jmp(0x1011_c9ba, 0xd); goto l_0x1011_c9ba; /* jmp 0x1011c9ba */
        l_0x1011_c9ad:
            ii(0x1011_c9ad, 3); mov(eax, memd[ss, ebp - 18]);           /* mov eax, [ebp-0x12] */
            ii(0x1011_c9b0, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x1011_c9b2, 3); mov(edx, memd[ss, ebp - 20]);           /* mov edx, [ebp-0x14] */
            ii(0x1011_c9b5, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1011_c9b7, 3); mov(memd[ss, ebp - 24], edx);           /* mov [ebp-0x18], edx */
        l_0x1011_c9ba:
            ii(0x1011_c9ba, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x1011_c9bd, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x1011_c9c0, 4); cmp(ax, memw[ds, edx + 12]);            /* cmp ax, [edx+0xc] */
            ii(0x1011_c9c4, 2); if(jle(0x1011_c9d0, 0xa)) goto l_0x1011_c9d0; /* jle 0x1011c9d0 */
            ii(0x1011_c9c6, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x1011_c9c9, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x1011_c9cc, 4); mov(memw[ds, edx + 12], ax);            /* mov [edx+0xc], ax */
        l_0x1011_c9d0:
            ii(0x1011_c9d0, 4); movsx(eax, memw[ss, ebp - 24]);         /* movsx eax, word [ebp-0x18] */
            ii(0x1011_c9d4, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x1011_c9d6, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x1011_c9d8, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ...
            ii(0x1011_c9e8, 4); movsx(edx, memw[ss, ebp - 24]);         /* movsx edx, word [ebp-0x18] */
            ii(0x1011_c9ec, 2); add(edx, edx);                          /* add edx, edx */
            ii(0x1011_c9ee, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ...
            ii(0x1011_c9fc, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x1011_c9ff, 3); dec(memd[ss, ebp - 24]);                /* dec dword [ebp-0x18] */
