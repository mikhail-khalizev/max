...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_b494()
        {
            ...
            ii(0x100a_b4ab, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_b4ae, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_b4b1, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100a_b4b5, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100a_b4b8, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100a_b4ba, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_b4bd, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
