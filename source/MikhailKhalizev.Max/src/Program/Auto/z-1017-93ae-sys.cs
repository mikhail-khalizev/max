...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1017_93c4:
            ii(0x1017_93c4, 4); lea(ebx, memd[ss, esp + 36]);           /* lea ebx, [esp+0x24] */
            ii(0x1017_93c8, 4); mov(memd[ss, esp + 36], edi);           /* mov [esp+0x24], edi */
            ...
            ii(0x1017_93db, 4); mov(eax, memd[ss, esp + 36]);           /* mov eax, [esp+0x24] */
