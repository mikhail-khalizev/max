...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_b9c7()
        {
            ...
            ii(0x1007_b9df, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_b9e2, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_b9e4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_b9f5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_b9f8, 3); add(eax, 0x29);                         /* add eax, 0x29 */
            ii(0x1007_b9fb, 5); call(0x1007_6630, -0x53d0);             /* call 0x10076630 */
            ii(0x1007_ba00, 3); lea(edx, memd[ss, ebp - 0x8]);          /* lea edx, [ebp-0x8] */
            ii(0x1007_ba03, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_ba13, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_ba16, 5); call(0x1007_bd04, 0x2e9);               /* call 0x1007bd04 */
            ii(0x1007_ba1b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
