...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_0448()
        {
            ...
            ii(0x1010_0460, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_0463, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_0466, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x1010_0469, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1010_046c, 5); call(0x1007_1ff5, -0x8_e47c);           /* call 0x10071ff5 */
            ii(0x1010_0471, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_0474, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_0478, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1010_047a, 2); if(jz(0x1010_048f, 0x13)) goto l_0x1010_048f; /* jz 0x1010048f */
            ii(0x1010_047c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_047f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_0481, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ...
            ii(0x1010_048d, 2); if(jz(0x1010_0494, 0x5)) goto l_0x1010_0494; /* jz 0x10100494 */
        l_0x1010_048f:
            ii(0x1010_048f, 5); jmp(0x1010_067a, 0x1e6); goto l_0x1010_067a; /* jmp 0x1010067a */
        l_0x1010_0494:
            ii(0x1010_0494, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_0497, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1010_049a, 7); mov(memd[ss, ebp - 0x14], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x1010_04a1, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1010_04a8, 3); lea(eax, memd[ss, ebp - 0x20]);         /* lea eax, [ebp-0x20] */
            ...
            ii(0x1010_04b9, 3); lea(edx, memd[ss, ebp - 0x20]);         /* lea edx, [ebp-0x20] */
            ii(0x1010_04bc, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_04bf, 5); call(0x1007_2388, -0x8_e13c);           /* call 0x10072388 */
            ii(0x1010_04c4, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1010_04c7, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1010_04ca, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1010_04d8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_04db, 2); neg(eax);                               /* neg eax */
            ii(0x1010_04dd, 5); and(eax, 0xffff);                       /* and eax, 0xffff */
            ii(0x1010_04e2, 1); push(eax);                              /* push eax */
            ii(0x1010_04e3, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
        ...
        l_0x1010_0503:
            ...
            ii(0x1010_050b, 4); mov(ax, memw[ss, ebp - 0x8]);           /* mov ax, [ebp-0x8] */
            ii(0x1010_050f, 1); push(eax);                              /* push eax */
            ii(0x1010_0510, 2); xor(ecx, ecx);                          /* xor ecx, ecx */
            ii(0x1010_0512, 4); mov(cx, memw[ss, ebp - 0x10]);          /* mov cx, [ebp-0x10] */
        ...
        l_0x1010_052a:
            ii(0x1010_052a, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1010_0531, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1010_0538, 5); mov(eax, 0x101c_819c);                  /* mov eax, 0x101c819c */
            ii(0x1010_053d, 5); call(0x1007_6338, -0x8_a20a);           /* call 0x10076338 */
            ii(0x1010_0542, 3); lea(ebx, memd[ss, ebp - 0x24]);         /* lea ebx, [ebp-0x24] */
            ...
            ii(0x1010_054e, 2); jmp(0x1010_0558, 0x8); goto l_0x1010_0558; /* jmp 0x10100558 */
        l_0x1010_0550:
            ii(0x1010_0550, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ii(0x1010_0553, 5); call(0x1007_6bf8, -0x8_9960);           /* call 0x10076bf8 */
        l_0x1010_0558:
            ii(0x1010_0558, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_055a, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ...
            ii(0x1010_056a, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ...
            ii(0x1010_0579, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_0585, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ii(0x1010_0588, 5); call(0x1007_63a0, -0x8_a1ed);           /* call 0x100763a0 */
            ii(0x1010_058d, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x1010_0590, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1010_0593, 5); call(0x1007_1ff5, -0x8_e5a3);           /* call 0x10071ff5 */
            ii(0x1010_0598, 4); mov(memw[ss, ebp - 0x18], ax);          /* mov [ebp-0x18], ax */
            ii(0x1010_059c, 4); movsx(eax, memw[ss, ebp - 0x18]);       /* movsx eax, word [ebp-0x18] */
            ii(0x1010_05a0, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1010_05a2, 2); if(jge(0x1010_05ac, 0x8)) goto l_0x1010_05ac; /* jge 0x101005ac */
            ii(0x1010_05a4, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1010_05a7, 3); sub(memd[ss, ebp - 0x8], eax);          /* sub [ebp-0x8], eax */
            ii(0x1010_05aa, 2); jmp(0x1010_05b2, 0x6); goto l_0x1010_05b2; /* jmp 0x101005b2 */
        l_0x1010_05ac:
            ii(0x1010_05ac, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1010_05af, 3); add(memd[ss, ebp - 0xc], eax);          /* add [ebp-0xc], eax */
        l_0x1010_05b2:
            ...
            ii(0x1010_05bb, 3); lea(edx, memd[ss, ebp - 0x20]);         /* lea edx, [ebp-0x20] */
            ii(0x1010_05be, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ii(0x1010_05c1, 5); call(0x1007_63d4, -0x8_a1f2);           /* call 0x100763d4 */
            ii(0x1010_05c6, 5); call(0x1007_2388, -0x8_e243);           /* call 0x10072388 */
            ii(0x1010_05cb, 4); movsx(eax, memw[ss, ebp - 0x18]);       /* movsx eax, word [ebp-0x18] */
            ii(0x1010_05cf, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1010_05d1, 2); if(jge(0x1010_05db, 0x8)) goto l_0x1010_05db; /* jge 0x101005db */
            ii(0x1010_05d3, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1010_05d6, 3); sub(memd[ss, ebp - 0x14], eax);         /* sub [ebp-0x14], eax */
            ii(0x1010_05d9, 2); jmp(0x1010_05e1, 0x6); goto l_0x1010_05e1; /* jmp 0x101005e1 */
        l_0x1010_05db:
            ii(0x1010_05db, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1010_05de, 3); add(memd[ss, ebp - 0x10], eax);         /* add [ebp-0x10], eax */
        l_0x1010_05e1:
            ii(0x1010_05e1, 5); jmp(0x1010_0550, -0x96); goto l_0x1010_0550; /* jmp 0x10100550 */
        l_0x1010_05e6:
            ii(0x1010_05e6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_05e9, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1010_0601, 4); mov(ax, memw[ss, ebp - 0xc]);           /* mov ax, [ebp-0xc] */
            ii(0x1010_0605, 1); push(eax);                              /* push eax */
            ii(0x1010_0606, 2); xor(ecx, ecx);                          /* xor ecx, ecx */
            ii(0x1010_0608, 4); mov(cx, memw[ss, ebp - 0x14]);          /* mov cx, [ebp-0x14] */
        ...
        l_0x1010_0622:
            ...
            ii(0x1010_062a, 4); mov(ax, memw[ss, ebp - 0x8]);           /* mov ax, [ebp-0x8] */
            ii(0x1010_062e, 1); push(eax);                              /* push eax */
            ii(0x1010_062f, 2); xor(ecx, ecx);                          /* xor ecx, ecx */
            ii(0x1010_0631, 4); mov(cx, memw[ss, ebp - 0x10]);          /* mov cx, [ebp-0x10] */
            ...
            ii(0x1010_0651, 4); mov(ax, memw[ss, ebp - 0xc]);           /* mov ax, [ebp-0xc] */
            ii(0x1010_0655, 1); push(eax);                              /* push eax */
            ii(0x1010_0656, 2); xor(ecx, ecx);                          /* xor ecx, ecx */
            ii(0x1010_0658, 4); mov(cx, memw[ss, ebp - 0x14]);          /* mov cx, [ebp-0x14] */
        ...
        l_0x1010_0670:
            ...
            ii(0x1010_0672, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
