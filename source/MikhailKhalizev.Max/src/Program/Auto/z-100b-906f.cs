...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_906f()
        {
            ...
            ii(0x100b_9087, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_908a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_908d, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x100b_9090, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100b_9093, 5); call(0x100b_8ffa, -0x9e);               /* call 0x100b8ffa */
            ii(0x100b_9098, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x100b_909b, 4); cmp(memb[ss, ebp - 0x8], 0x4);          /* cmp byte [ebp-0x8], 0x4 */
            ii(0x100b_909f, 2); if(jge(0x100b_90ac, 0xb)) goto l_0x100b_90ac; /* jge 0x100b90ac */
            ii(0x100b_90a1, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
        ...
        l_0x100b_90ac:
            ...
            ii(0x100b_90b3, 2); jmp(0x100b_90bb, 0x6); goto l_0x100b_90bb; /* jmp 0x100b90bb */
        l_0x100b_90b5:
        ...
        l_0x100b_90bb:
            ...
            ii(0x100b_90c4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_90db, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_90de, 5); call(0x1007_6274, -0x4_2e6f);           /* call 0x10076274 */
            ii(0x100b_90e3, 2); test(al, al);                           /* test al, al */
            ii(0x100b_90e5, 2); if(jnz(0x100b_90e9, 0x2)) goto l_0x100b_90e9; /* jnz 0x100b90e9 */
        l_0x100b_90e7:
            ii(0x100b_90e7, 2); jmp(0x100b_90eb, 0x2); goto l_0x100b_90eb; /* jmp 0x100b90eb */
        l_0x100b_90e9:
            ii(0x100b_90e9, 2); jmp(0x100b_90ed, 0x2); goto l_0x100b_90ed; /* jmp 0x100b90ed */
        l_0x100b_90eb:
        ...
        l_0x100b_90ed:
            ...
            ii(0x100b_90f4, 2); if(jge(0x100b_90fc, 0x6)) goto l_0x100b_90fc; /* jge 0x100b90fc */
            ii(0x100b_90f6, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x100b_90fa, 2); jmp(0x100b_911d, 0x21); goto l_0x100b_911d; /* jmp 0x100b911d */
        l_0x100b_90fc:
            ii(0x100b_90fc, 4); cmp(memb[ss, ebp - 0x8], 0x5);          /* cmp byte [ebp-0x8], 0x5 */
            ii(0x100b_9100, 2); if(jnz(0x100b_9111, 0xf)) goto l_0x100b_9111; /* jnz 0x100b9111 */
            ii(0x100b_9102, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_910f, 2); if(jz(0x100b_9113, 0x2)) goto l_0x100b_9113; /* jz 0x100b9113 */
        l_0x100b_9111:
            ii(0x100b_9111, 2); jmp(0x100b_9117, 0x4); goto l_0x100b_9117; /* jmp 0x100b9117 */
        l_0x100b_9113:
            ii(0x100b_9113, 4); mov(memb[ss, ebp - 0x8], 0x4);          /* mov byte [ebp-0x8], 0x4 */
        l_0x100b_9117:
            ii(0x100b_9117, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
