...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_906f()
        {
            ...
            ii(0x100b_90a4, 3); mov(memb[ss, ebp - 12], al);            /* mov [ebp-0xc], al */
            ii(0x100b_90a7, 5); jmp(0x100b_911d, 0x71); goto l_0x100b_911d; /* jmp 0x100b911d */
        l_0x100b_90ac:
            ii(0x100b_90ac, 7); mov(memd[ss, ebp - 16], 0);             /* mov dword [ebp-0x10], 0x0 */
            ii(0x100b_90b3, 2); jmp(0x100b_90bb, 6); goto l_0x100b_90bb; /* jmp 0x100b90bb */
        l_0x100b_90b5:
            ii(0x100b_90b5, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100b_90b8, 3); inc(memd[ss, ebp - 16]);                /* inc dword [ebp-0x10] */
        l_0x100b_90bb:
            ii(0x100b_90bb, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x100b_90c7, 3); mov(al, memb[ds, eax + 38]);            /* mov al, [eax+0x26] */
            ii(0x100b_90ca, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100b_90cf, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ii(0x100b_90d3, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x100b_90d5, 2); if(jz(0x100b_90e7, 0x10)) goto l_0x100b_90e7; /* jz 0x100b90e7 */
            ii(0x100b_90d7, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
        ...
        l_0x100b_90ed:
            ii(0x100b_90ed, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x100b_90f1, 3); cmp(eax, 4);                            /* cmp eax, 0x4 */
            ii(0x100b_90f4, 2); if(jge(0x100b_90fc, 6)) goto l_0x100b_90fc; /* jge 0x100b90fc */
            ii(0x100b_90f6, 4); mov(memb[ss, ebp - 12], 1);             /* mov byte [ebp-0xc], 0x1 */
        ...
        l_0x100b_90fc:
            ...
            ii(0x100b_9105, 3); mov(al, memb[ds, eax + 80]);            /* mov al, [eax+0x50] */
        ...
        l_0x100b_9117:
            ...
            ii(0x100b_911a, 3); mov(memb[ss, ebp - 12], al);            /* mov [ebp-0xc], al */
        l_0x100b_911d:
            ii(0x100b_911d, 3); mov(al, memb[ss, ebp - 12]);            /* mov al, [ebp-0xc] */
