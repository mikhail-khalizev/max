...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_d3a0()
        {
            ...
            ii(0x1010_d3b2, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1010_d3b8, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1010_d3bb, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_d3be, 4); mov(ax, memw[ds, eax + 16]);            /* mov ax, [eax+0x10] */
            ii(0x1010_d3c2, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1010_d3c5, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1010_d3c8, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1010_d3cb, 4); cmp(ax, memw[ds, edx + 14]);            /* cmp ax, [edx+0xe] */
            ii(0x1010_d3cf, 2); if(jge(0x1010_d3fe, 0x2d)) goto l_0x1010_d3fe; /* jge 0x1010d3fe */
            ii(0x1010_d3d1, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1010_d3d4, 3); mov(edx, memd[ds, edx + 10]);           /* mov edx, [edx+0xa] */
            ii(0x1010_d3d7, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1010_d3da, 5); mov(ebx, 6);                            /* mov ebx, 0x6 */
            ii(0x1010_d3df, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x1010_d3e1, 3); sar(edx, 0x1f);                         /* sar edx, 0x1f */
            ii(0x1010_d3e4, 2); idiv(ebx);                              /* idiv ebx */
            ii(0x1010_d3e6, 3); imul(eax, eax, 6);                      /* imul eax, eax, 0x6 */
            ii(0x1010_d3e9, 4); movsx(edx, memw[ss, ebp - 8]);          /* movsx edx, word [ebp-0x8] */
            ii(0x1010_d3ed, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1010_d3ef, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_d3f2, 4); mov(memw[ds, eax + 12], dx);            /* mov [eax+0xc], dx */
            ii(0x1010_d3f6, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
