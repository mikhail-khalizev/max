...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_5862()
        {
            ...
            ii(0x5872, 4);    mov(si, memw[es, bx + 0x2]);              /* mov si, [es:bx+0x2] */
            ii(0x5876, 2);    jmp(0x5879, 0x1); goto l_0x5879;          /* jmp 0x5879 */
        l_0x5878:
            ii(0x5878, 1);    dec(si);                                  /* dec si */
        l_0x5879:
            ii(0x5879, 3);    cmp(si, 0x10);                            /* cmp si, 0x10 */
            ii(0x587c, 2);    if(jl(0x5895, 0x17)) goto l_0x5895;       /* jl 0x5895 */
            ii(0x587e, 3);    mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
            ...
            ii(0x5893, 2);    jmp(0x5897, 0x2); goto l_0x5897;          /* jmp 0x5897 */
        l_0x5895:
