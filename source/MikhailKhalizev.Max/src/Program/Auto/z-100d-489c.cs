...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_489c()
        {
            ...
            ii(0x100d_48b7, 3); lea(edx, memd[ss, ebp - 20]);           /* lea edx, [ebp-0x14] */
            ii(0x100d_48ba, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100d_48bd, 3); mov(eax, memd[ds, eax + 49]);           /* mov eax, [eax+0x31] */
            ii(0x100d_48c0, 5); call(0x1015_0a5f, 0x7_c19a);            /* call 0x10150a5f */
            ii(0x100d_48c5, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x100d_48c8, 5); call(0x1009_caf8, -0x3_7dd5);           /* call 0x1009caf8 */
            ii(0x100d_48cd, 7); mov(memd[ss, ebp - 12], 0);             /* mov dword [ebp-0xc], 0x0 */
            ii(0x100d_48d4, 2); jmp(0x100d_48dc, 6); goto l_0x100d_48dc; /* jmp 0x100d48dc */
        l_0x100d_48d6:
            ii(0x100d_48d6, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100d_48d9, 3); inc(memd[ss, ebp - 12]);                /* inc dword [ebp-0xc] */
        l_0x100d_48dc:
            ...
            ii(0x100d_48e9, 4); cmp(ax, memw[ss, ebp - 12]);            /* cmp ax, [ebp-0xc] */
            ii(0x100d_48ed, 2); if(jle(0x100d_490c, 0x1d)) goto l_0x100d_490c; /* jle 0x100d490c */
            ii(0x100d_48ef, 4); movsx(edx, memw[ss, ebp - 12]);         /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x100d_4902, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
        ...
        l_0x100d_490c:
            ii(0x100d_490c, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ...
            ii(0x100d_4926, 3); mov(eax, memd[ds, eax + 49]);           /* mov eax, [eax+0x31] */
            ii(0x100d_4929, 5); call(0x1016_3053, 0x8_e725);            /* call 0x10163053 */
            ii(0x100d_492e, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100d_4931, 4); mov(memb[ds, eax + 54], 1);             /* mov byte [eax+0x36], 0x1 */
            ii(0x100d_4935, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100d_4937, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
        ...
        l_0x100d_4944:
            ...
            ii(0x100d_4946, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x100d_4949, 5); call(0x1008_b228, -0x4_9726);           /* call 0x1008b228 */
            ii(0x100d_494e, 3); mov(ax, memw[ds, eax]);                 /* mov ax, [eax] */
            ii(0x100d_4951, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x100d_4954, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x100d_4962, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x100d_4965, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100d_4968, 4); mov(memb[ds, eax + 54], 1);             /* mov byte [eax+0x36], 0x1 */
            ii(0x100d_496c, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100d_496f, 4); mov(memb[ds, eax + 53], 1);             /* mov byte [eax+0x35], 0x1 */
            ii(0x100d_4973, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100d_4976, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x100d_4979, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x100d_497c, 3); mov(ebx, memd[ds, eax + 19]);           /* mov ebx, [eax+0x13] */
            ii(0x100d_497f, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ii(0x100d_4983, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x100d_4986, 3); call_abs(memd[ds, ebx + 16]);           /* call dword [ebx+0x10] */
            ii(0x100d_4989, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100d_498b, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100d_498e, 3); mov(eax, memd[ds, eax + 49]);           /* mov eax, [eax+0x31] */
            ii(0x100d_4991, 3); mov(memb[ds, eax + 69], dl);            /* mov [eax+0x45], dl */
            ii(0x100d_4994, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100d_4997, 3); mov(edx, memd[ds, eax + 54]);           /* mov edx, [eax+0x36] */
            ii(0x100d_499a, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_499d, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100d_49a0, 3); mov(eax, memd[ds, eax + 49]);           /* mov eax, [eax+0x31] */
            ii(0x100d_49a3, 5); call(0x1009_c970, -0x3_8038);           /* call 0x1009c970 */
            ii(0x100d_49a8, 4); or(memb[ss, ebp - 8], 1);               /* or byte [ebp-0x8], 0x1 */
            ii(0x100d_49ac, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
            ii(0x100d_49af, 5); call(Definitions.my_string_ctor, 0x6_d134); /* call 0x10141ae8 */
            ii(0x100d_49b4, 3); mov(memd[ss, ebp - 36], eax);           /* mov [ebp-0x24], eax */
            ii(0x100d_49b7, 4); and(memb[ss, ebp - 8], -2 /* 0xfe */);  /* and byte [ebp-0x8], 0xfe */
            ii(0x100d_49bb, 3); lea(edi, memd[ss, ebp - 48]);           /* lea edi, [ebp-0x30] */
            ...
            ii(0x100d_49c9, 3); mov(eax, memd[ds, eax + 49]);           /* mov eax, [eax+0x31] */
            ii(0x100d_49cc, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100d_49ce, 3); mov(dl, memb[ds, eax + 69]);            /* mov dl, [eax+0x45] */
            ii(0x100d_49d1, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100d_49d4, 3); mov(eax, memd[ds, eax + 54]);           /* mov eax, [eax+0x36] */
            ...
            ii(0x100d_49df, 3); mov(ebx, memd[ds, ebx + 54]);           /* mov ebx, [ebx+0x36] */
            ...
            ii(0x100d_49f1, 3); mov(eax, memd[ds, eax + 49]);           /* mov eax, [eax+0x31] */
            ii(0x100d_49f4, 3); mov(al, memb[ds, eax + 38]);            /* mov al, [eax+0x26] */
            ii(0x100d_49f7, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100d_49fc, 6); imul(eax, eax, 0x247);                  /* imul eax, eax, 0x247 */
            ii(0x100d_4a02, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x100d_4a14, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x100d_4a17, 3); push(memd[ds, eax + 23]);               /* push dword [eax+0x17] */
            ii(0x100d_4a1a, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x100d_4a1d, 3); mov(eax, memd[ds, eax + 19]);           /* mov eax, [eax+0x13] */
            ii(0x100d_4a20, 3); sar(eax, 0x18);                         /* sar eax, 0x18 */
            ii(0x100d_4a23, 3); shl(eax, 2);                            /* shl eax, 0x2 */
            ii(0x100d_4a26, 4); push(memd[ds, eax + ebp - 48]);         /* push dword [eax+ebp-0x30] */
            ii(0x100d_4a2a, 5); mov(eax, 0xfa);                         /* mov eax, 0xfa */
            ii(0x100d_4a2f, 1); push(eax);                              /* push eax */
            ii(0x100d_4a30, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
            ...
            ii(0x100d_4a3f, 3); mov(eax, memd[ds, eax + 49]);           /* mov eax, [eax+0x31] */
            ii(0x100d_4a42, 3); mov(ebx, memd[ds, eax + 26]);           /* mov ebx, [eax+0x1a] */
            ii(0x100d_4a45, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100d_4a48, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100d_4a4b, 3); mov(eax, memd[ds, eax + 49]);           /* mov eax, [eax+0x31] */
            ii(0x100d_4a4e, 3); mov(edx, memd[ds, eax + 24]);           /* mov edx, [eax+0x18] */
            ii(0x100d_4a51, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_4a54, 3); lea(eax, memd[ss, ebp - 52]);           /* lea eax, [ebp-0x34] */
            ...
            ii(0x100d_4a61, 3); mov(ebx, memd[ds, ebx + 49]);           /* mov ebx, [ebx+0x31] */
            ii(0x100d_4a64, 5); mov(edx, 1);                            /* mov edx, 0x1 */
            ii(0x100d_4a69, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
