...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_812e()
        {
            ...
            ii(0x17_8139, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_813c, 3); mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ii(0x17_813f, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_8142, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ...
            ii(0x17_81a5, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_81a8, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
        l_0x17_81ab:
        ...
        l_0x17_81e6:
            ii(0x17_81e6, 2); push(0x2);                                /* push 0x2 */
            ...
            ii(0x17_81f5, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x17_81f8, 3); mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
            ii(0x17_81fb, 3); cmp(dx, memw[ss, bp - 0x2]);              /* cmp dx, [bp-0x2] */
            ii(0x17_81fe, 2); if(jl(0x17_8220, 0x20)) goto l_0x17_8220; /* jl 0x8220 */
            ii(0x17_8200, 2); if(jg(0x17_8207, 0x5)) goto l_0x17_8207;  /* jg 0x8207 */
            ii(0x17_8202, 3); cmp(ax, memw[ss, bp - 0x4]);              /* cmp ax, [bp-0x4] */
        ...
        l_0x17_8220:
            ii(0x17_8220, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0x17_8223, 3); mov(dx, memw[ss, bp - 0x2]);              /* mov dx, [bp-0x2] */
            ii(0x17_8226, 3); cmp(memw[ss, bp - 0x6], dx);              /* cmp [bp-0x6], dx */
            ii(0x17_8229, 2); if(jg(0x17_829e, 0x73)) goto l_0x17_829e; /* jg 0x829e */
            ii(0x17_822b, 2); if(jl(0x17_8232, 0x5)) goto l_0x17_8232;  /* jl 0x8232 */
            ii(0x17_822d, 3); cmp(memw[ss, bp - 0x8], ax);              /* cmp [bp-0x8], ax */
        ...
        l_0x17_8232:
            ...
            ii(0x17_824c, 2); push(0x1);                                /* push 0x1 */
        ...
        l_0x17_8261:
            ...
            ii(0x17_8273, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_8276, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
        ...
        l_0x17_829e:
            ii(0x17_829e, 6); mov(memw[ds, 0xa24], 0x1);                /* mov word [0xa24], 0x1 */
            ii(0x17_82a4, 2); push(0x6);                                /* push 0x6 */
        ...
        l_0x17_82e6:
            ...
            ii(0x17_8308, 4); mov(memw[es, bx + 0x4], ax);              /* mov [es:bx+0x4], ax */
            ii(0x17_830c, 4); les(bx, ds, 0x1f60);                      /* les bx, [0x1f60] */
            ii(0x17_8310, 2); sub(ax, ax);                              /* sub ax, ax */
            ii(0x17_8312, 4); mov(memw[es, bx + 0x2], ax);              /* mov [es:bx+0x2], ax */
            ...
            ii(0x17_8325, 5); mov(memw[ss, bp - 0xa], 0x1);             /* mov word [bp-0xa], 0x1 */
            ii(0x17_832a, 2); jmp(0x17_832f, 0x3); goto l_0x17_832f;    /* jmp 0x832f */
        l_0x17_832c:
        ...
        l_0x17_832f:
            ...
            ii(0x17_8371, 4); mov(memw[es, bx + si + 0x4], ax);         /* mov [es:bx+si+0x4], ax */
            ii(0x17_8375, 4); les(bx, ds, 0x1f60);                      /* les bx, [0x1f60] */
            ii(0x17_8379, 2); sub(ax, ax);                              /* sub ax, ax */
            ii(0x17_837b, 4); mov(memw[es, bx + si + 0x2], ax);         /* mov [es:bx+si+0x2], ax */
        ...
        l_0x17_8390:
            ...
            ii(0x17_8395, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x17_8398, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ...
            ii(0x17_83ac, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_83af, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
