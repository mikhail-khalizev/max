...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_2eb4()
        {
            ...
            ii(0x1007_2ecb, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_2ece, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
        l_0x1007_2ed1:
            ii(0x1007_2ed1, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_2ed3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_2edf, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_2ee2, 5); call(0x1007_63a0, 0x34b9);              /* call 0x100763a0 */
            ii(0x1007_2ee7, 4); cmp(memb[ds, eax + 0x3d], 0x10);        /* cmp byte [eax+0x3d], 0x10 */
            ii(0x1007_2eeb, 2); if(jnz(0x1007_2eff, 0x12)) goto l_0x1007_2eff; /* jnz 0x10072eff */
            ii(0x1007_2eed, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_2ef0, 5); call(0x1007_63a0, 0x34ab);              /* call 0x100763a0 */
            ii(0x1007_2ef5, 5); call(0x1007_611c, 0x3222);              /* call 0x1007611c */
            ii(0x1007_2efa, 3); cmp(eax, memd[ss, ebp - 0x8]);          /* cmp eax, [ebp-0x8] */
            ii(0x1007_2efd, 2); if(jz(0x1007_2f01, 0x2)) goto l_0x1007_2f01; /* jz 0x10072f01 */
        l_0x1007_2eff:
            ii(0x1007_2eff, 2); jmp(0x1007_2f03, 0x2); goto l_0x1007_2f03; /* jmp 0x10072f03 */
        l_0x1007_2f01:
            ii(0x1007_2f01, 2); jmp(0x1007_2f0d, 0xa); goto l_0x1007_2f0d; /* jmp 0x10072f0d */
        l_0x1007_2f03:
            ii(0x1007_2f03, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1007_2f0d:
            ...
            ii(0x1007_2f0f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_2f12, 5); call(0x1013_ad71, 0xc_7e5a);            /* call 0x1013ad71 */
            ii(0x1007_2f17, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x1007_2f1a, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
