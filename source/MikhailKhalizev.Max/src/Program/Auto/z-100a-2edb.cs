...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_2edb()
        {
            ...
            ii(0x100a_2ef3, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_2ef6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_2ef9, 3); mov(al, memb[ds, eax + 0x4d]);          /* mov al, [eax+0x4d] */
            ii(0x100a_2efc, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100a_2f01, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100a_2f03, 2); if(jg(0x100a_2f0e, 0x9)) goto l_0x100a_2f0e; /* jg 0x100a2f0e */
            ii(0x100a_2f05, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        ...
        l_0x100a_2f0e:
            ...
            ii(0x100a_2f18, 2); if(jnz(0x100a_2f23, 0x9)) goto l_0x100a_2f23; /* jnz 0x100a2f23 */
            ii(0x100a_2f1a, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x100a_2f1e, 5); jmp(0x100a_2f90, 0x6d); goto l_0x100a_2f90; /* jmp 0x100a2f90 */
        l_0x100a_2f23:
            ii(0x100a_2f23, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_2f26, 3); mov(eax, memd[ds, eax + 0x3a]);         /* mov eax, [eax+0x3a] */
            ...
            ii(0x100a_2f30, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_2f33, 3); mov(eax, memd[ds, eax + 0x3a]);         /* mov eax, [eax+0x3a] */
            ii(0x100a_2f36, 3); sar(eax, 0x18);                         /* sar eax, 0x18 */
            ii(0x100a_2f39, 3); cmp(eax, 0xc);                          /* cmp eax, 0xc */
            ii(0x100a_2f3c, 2); if(jnz(0x100a_2f44, 0x6)) goto l_0x100a_2f44; /* jnz 0x100a2f44 */
        l_0x100a_2f3e:
            ii(0x100a_2f3e, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x100a_2f42, 2); jmp(0x100a_2f90, 0x4c); goto l_0x100a_2f90; /* jmp 0x100a2f90 */
        l_0x100a_2f44:
            ii(0x100a_2f44, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_2f47, 3); mov(eax, memd[ds, eax + 0x3a]);         /* mov eax, [eax+0x3a] */
            ...
            ii(0x100a_2f52, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_2f55, 3); mov(eax, memd[ds, eax + 0x3b]);         /* mov eax, [eax+0x3b] */
            ii(0x100a_2f58, 3); sar(eax, 0x18);                         /* sar eax, 0x18 */
            ii(0x100a_2f5b, 3); cmp(eax, 0x1);                          /* cmp eax, 0x1 */
            ii(0x100a_2f5e, 2); if(jz(0x100a_2f62, 0x2)) goto l_0x100a_2f62; /* jz 0x100a2f62 */
        l_0x100a_2f60:
            ii(0x100a_2f60, 2); jmp(0x100a_2f68, 0x6); goto l_0x100a_2f68; /* jmp 0x100a2f68 */
        l_0x100a_2f62:
            ii(0x100a_2f62, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x100a_2f66, 2); jmp(0x100a_2f90, 0x28); goto l_0x100a_2f90; /* jmp 0x100a2f90 */
        l_0x100a_2f68:
            ii(0x100a_2f68, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_2f6b, 3); mov(eax, memd[ds, eax + 0x3a]);         /* mov eax, [eax+0x3a] */
            ...
            ii(0x100a_2f76, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_2f79, 3); mov(eax, memd[ds, eax + 0x3b]);         /* mov eax, [eax+0x3b] */
            ii(0x100a_2f7c, 3); sar(eax, 0x18);                         /* sar eax, 0x18 */
            ii(0x100a_2f7f, 3); cmp(eax, 0x1);                          /* cmp eax, 0x1 */
            ii(0x100a_2f82, 2); if(jz(0x100a_2f86, 0x2)) goto l_0x100a_2f86; /* jz 0x100a2f86 */
        l_0x100a_2f84:
            ii(0x100a_2f84, 2); jmp(0x100a_2f8c, 0x6); goto l_0x100a_2f8c; /* jmp 0x100a2f8c */
        l_0x100a_2f86:
            ii(0x100a_2f86, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x100a_2f8a, 2); jmp(0x100a_2f90, 0x4); goto l_0x100a_2f90; /* jmp 0x100a2f90 */
        l_0x100a_2f8c:
            ii(0x100a_2f8c, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x100a_2f90:
            ii(0x100a_2f90, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
