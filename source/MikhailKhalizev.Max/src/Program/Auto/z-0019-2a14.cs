...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_2a14()
        {
            ...
            ii(0x19_2a23, 3); mov(dx, 1);                               /* mov dx, 0x1 */
            ii(0x19_2a26, 2); cmp(al, 2);                               /* cmp al, 0x2 */
        ...
        l_0x19_2a3f:
            ...
            ii(0x19_2a42, 2); if(jnz(0x19_2a3f, -5)) goto l_0x19_2a3f;  /* jnz 0x2a3f */
        ...
        l_0x19_2a53:
            ii(0x19_2a53, 3); mov(di, 1);                               /* mov di, 0x1 */
        ...
        l_0x19_2a5d:
            ...
            ii(0x19_2a60, 2); if(jz(0x19_2a5d, -5)) goto l_0x19_2a5d;   /* jz 0x2a5d */
            ii(0x19_2a62, 2); cmp(al, 9);                               /* cmp al, 0x9 */
            ii(0x19_2a64, 2); if(jz(0x19_2a5d, -9)) goto l_0x19_2a5d;   /* jz 0x2a5d */
        ...
        l_0x19_2a70:
            ...
            ii(0x19_2a75, 2); cmp(al, 9);                               /* cmp al, 0x9 */
            ...
            ii(0x19_2a87, 2); if(jz(0x19_2a8c, 3)) goto l_0x19_2a8c;    /* jz 0x2a8c */
        ...
        l_0x19_2a8e:
            ...
            ii(0x19_2a92, 2); if(jz(0x19_2a8e, -6)) goto l_0x19_2a8e;   /* jz 0x2a8e */
            ii(0x19_2a94, 2); cmp(al, 0x22);                            /* cmp al, 0x22 */
            ii(0x19_2a96, 2); if(jz(0x19_2a9c, 4)) goto l_0x19_2a9c;    /* jz 0x2a9c */
        ...
        l_0x19_2a9c:
            ...
            ii(0x19_2a9e, 2); shr(cx, 1);                               /* shr cx, 1 */
            ii(0x19_2aa0, 2); adc(dx, cx);                              /* adc dx, cx */
            ii(0x19_2aa2, 2); test(al, 1);                              /* test al, 0x1 */
            ii(0x19_2aa4, 2); if(jnz(0x19_2a70, -0x36)) goto l_0x19_2a70; /* jnz 0x2a70 */
            ii(0x19_2aa6, 2); jmp(0x19_2aa9, 1); goto l_0x19_2aa9;      /* jmp 0x2aa9 */
        l_0x19_2aa8:
        ...
        l_0x19_2aa9:
            ...
            ii(0x19_2ab8, 2); if(jz(0x19_2abd, 3)) goto l_0x19_2abd;    /* jz 0x2abd */
        ...
        l_0x19_2abf:
            ...
            ii(0x19_2ac3, 2); if(jz(0x19_2abf, -6)) goto l_0x19_2abf;   /* jz 0x2abf */
            ii(0x19_2ac5, 2); cmp(al, 0x22);                            /* cmp al, 0x22 */
            ii(0x19_2ac7, 2); if(jz(0x19_2acd, 4)) goto l_0x19_2acd;    /* jz 0x2acd */
        ...
        l_0x19_2acd:
            ...
            ii(0x19_2acf, 2); shr(cx, 1);                               /* shr cx, 1 */
            ii(0x19_2ad1, 2); adc(dx, cx);                              /* adc dx, cx */
            ii(0x19_2ad3, 2); test(al, 1);                              /* test al, 0x1 */
        ...
        l_0x19_2ad9:
            ...
            ii(0x19_2ae2, 2); shl(di, 1);                               /* shl di, 1 */
            ii(0x19_2ae4, 2); shl(di, 1);                               /* shl di, 1 */
            ...
            ii(0x19_2b00, 4); mov(memw[ss, bx + 2], ss);                /* mov [ss:bx+0x2], ss */
            ii(0x19_2b04, 3); add(bx, 4);                               /* add bx, 0x4 */
        ...
        l_0x19_2b0b:
            ...
            ii(0x19_2b0f, 2); if(jnz(0x19_2b0b, -6)) goto l_0x19_2b0b;  /* jnz 0x2b0b */
            ii(0x19_2b11, 5); mov(ds, memw[ss, 0x3c18]);                /* mov ds, [ss:0x3c18] */
            ii(0x19_2b16, 3); mov(si, 0x81);                            /* mov si, 0x81 */
            ii(0x19_2b19, 2); jmp(0x19_2b1e, 3); goto l_0x19_2b1e;      /* jmp 0x2b1e */
        l_0x19_2b1b:
        ...
        l_0x19_2b1e:
            ...
            ii(0x19_2b21, 2); if(jz(0x19_2b1e, -5)) goto l_0x19_2b1e;   /* jz 0x2b1e */
            ii(0x19_2b23, 2); cmp(al, 9);                               /* cmp al, 0x9 */
            ii(0x19_2b25, 2); if(jz(0x19_2b1e, -9)) goto l_0x19_2b1e;   /* jz 0x2b1e */
            ii(0x19_2b27, 2); cmp(al, 0xd);                             /* cmp al, 0xd */
            ii(0x19_2b29, 2); if(jnz(0x19_2b2e, 3)) goto l_0x19_2b2e;   /* jnz 0x2b2e */
            ii(0x19_2b2b, 3); jmp(0x19_2bb2, 0x84); goto l_0x19_2bb2;   /* jmp 0x2bb2 */
        l_0x19_2b2e:
            ii(0x19_2b2e, 2); or(al, al);                               /* or al, al */
            ii(0x19_2b30, 2); if(jnz(0x19_2b35, 3)) goto l_0x19_2b35;   /* jnz 0x2b35 */
        ...
        l_0x19_2b35:
            ...
            ii(0x19_2b38, 4); mov(memw[ss, bx + 2], ss);                /* mov [ss:bx+0x2], ss */
            ii(0x19_2b3c, 3); add(bx, 4);                               /* add bx, 0x4 */
        l_0x19_2b3f:
        ...
        l_0x19_2b40:
            ...
            ii(0x19_2b45, 2); cmp(al, 9);                               /* cmp al, 0x9 */
            ...
            ii(0x19_2b57, 2); if(jz(0x19_2b5c, 3)) goto l_0x19_2b5c;    /* jz 0x2b5c */
        ...
        l_0x19_2b5e:
            ...
            ii(0x19_2b62, 2); if(jz(0x19_2b5e, -6)) goto l_0x19_2b5e;   /* jz 0x2b5e */
            ii(0x19_2b64, 2); cmp(al, 0x22);                            /* cmp al, 0x22 */
            ii(0x19_2b66, 2); if(jz(0x19_2b6e, 6)) goto l_0x19_2b6e;    /* jz 0x2b6e */
        ...
        l_0x19_2b6e:
            ...
            ii(0x19_2b70, 2); shr(cx, 1);                               /* shr cx, 1 */
            ii(0x19_2b72, 2); rep(() => stosb());                       /* rep stosb */
            ii(0x19_2b74, 2); if(jae(0x19_2b7c, 6)) goto l_0x19_2b7c;   /* jae 0x2b7c */
        ...
        l_0x19_2b7c:
            ...
            ii(0x19_2b8b, 2); if(jz(0x19_2b90, 3)) goto l_0x19_2b90;    /* jz 0x2b90 */
        ...
        l_0x19_2b92:
            ...
            ii(0x19_2b96, 2); if(jz(0x19_2b92, -6)) goto l_0x19_2b92;   /* jz 0x2b92 */
            ii(0x19_2b98, 2); cmp(al, 0x22);                            /* cmp al, 0x22 */
            ii(0x19_2b9a, 2); if(jz(0x19_2ba2, 6)) goto l_0x19_2ba2;    /* jz 0x2ba2 */
        ...
        l_0x19_2ba2:
            ...
            ii(0x19_2ba4, 2); shr(cx, 1);                               /* shr cx, 1 */
        ...
        l_0x19_2bb2:
            ...
            ii(0x19_2bb8, 5); mov(memw[ds, bx + 2], 0);                 /* mov word [bx+0x2], 0x0 */
            ii(0x19_2bbd, 4); jmp_far_ind(memw[ds, 0x3c50]);            /* jmp far word [0x3c50] */
        }
    }
}
