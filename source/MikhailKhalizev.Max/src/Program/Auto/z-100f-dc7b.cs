...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_dc7b()
        {
            ...
            ii(0x100f_dcb1, 2); jmp(0x100f_dcb8, 0x5); goto l_0x100f_dcb8; /* jmp 0x100fdcb8 */
        l_0x100f_dcb3:
            ii(0x100f_dcb3, 5); call(0x1013_6316, 0x3_865e);            /* call 0x10136316 */
        l_0x100f_dcb8:
            ii(0x100f_dcb8, 7); mov(memd[ss, ebp - 0x4], 0x4);          /* mov dword [ebp-0x4], 0x4 */
        l_0x100f_dcbf:
            ii(0x100f_dcbf, 3); dec(memd[ss, ebp - 0x4]);               /* dec dword [ebp-0x4] */
            ii(0x100f_dcc2, 5); cmp(memw[ss, ebp - 0x4], -0x1 /* 0xff */); /* cmp word [ebp-0x4], 0xffff */
            ii(0x100f_dcc7, 2); if(jz(0x100f_dd07, 0x3e)) goto l_0x100f_dd07; /* jz 0x100fdd07 */
            ii(0x100f_dcc9, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_dcda, 3); mov(memd[ss, ebp - 0x10], edx);         /* mov [ebp-0x10], edx */
            ii(0x100f_dcdd, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_dcef, 4); mov(memw[ss, ebp - 0xc], ax);           /* mov [ebp-0xc], ax */
            ii(0x100f_dcf3, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
            ii(0x100f_dcf6, 3); mov(edx, memd[ss, ebp - 0x10]);         /* mov edx, [ebp-0x10] */
            ii(0x100f_dcf9, 3); mov(memb[ds, edx + 0x28], al);          /* mov [edx+0x28], al */
            ii(0x100f_dcfc, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
        ...
        l_0x100f_dd07:
            ...
            ii(0x100f_dd16, 7); mov(memd[ss, ebp - 0x4], 0x4);          /* mov dword [ebp-0x4], 0x4 */
            ii(0x100f_dd1d, 7); mov(memb[ds, 0x101c_37da], 0x4);        /* mov byte [0x101c37da], 0x4 */
        l_0x100f_dd24:
            ii(0x100f_dd24, 3); dec(memd[ss, ebp - 0x4]);               /* dec dword [ebp-0x4] */
            ii(0x100f_dd27, 5); cmp(memw[ss, ebp - 0x4], -0x1 /* 0xff */); /* cmp word [ebp-0x4], 0xffff */
            ii(0x100f_dd2c, 2); if(jz(0x100f_dd63, 0x35)) goto l_0x100f_dd63; /* jz 0x100fdd63 */
            ii(0x100f_dd2e, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_dd48, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_dd55, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
        ...
        l_0x100f_dd63:
            ...
            ii(0x100f_dd6a, 2); if(jz(0x100f_dd75, 0x9)) goto l_0x100f_dd75; /* jz 0x100fdd75 */
            ii(0x100f_dd6c, 5); call(0x100f_c072, -0x1cff);             /* call 0x100fc072 */
            ii(0x100f_dd71, 2); test(al, al);                           /* test al, al */
            ii(0x100f_dd73, 2); if(jz(0x100f_dd77, 0x2)) goto l_0x100f_dd77; /* jz 0x100fdd77 */
        l_0x100f_dd75:
            ii(0x100f_dd75, 2); jmp(0x100f_dd83, 0xc); goto l_0x100f_dd83; /* jmp 0x100fdd83 */
        l_0x100f_dd77:
            ii(0x100f_dd77, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x100f_dd7e, 5); jmp(0x100f_dec8, 0x145); goto l_0x100f_dec8; /* jmp 0x100fdec8 */
        l_0x100f_dd83:
            ii(0x100f_dd83, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x100f_dd8a, 2); jmp(0x100f_dd92, 0x6); goto l_0x100f_dd92; /* jmp 0x100fdd92 */
        l_0x100f_dd8c:
            ii(0x100f_dd8c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_dd8f, 3); inc(memd[ss, ebp - 0x4]);               /* inc dword [ebp-0x4] */
        l_0x100f_dd92:
            ii(0x100f_dd92, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_dd96, 3); cmp(eax, 0x4);                          /* cmp eax, 0x4 */
            ii(0x100f_dd99, 2); if(jge(0x100f_ddf8, 0x5d)) goto l_0x100f_ddf8; /* jge 0x100fddf8 */
            ii(0x100f_dd9b, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_ddbf, 2); if(jnz(0x100f_ddc9, 0x8)) goto l_0x100f_ddc9; /* jnz 0x100fddc9 */
            ii(0x100f_ddc1, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
        ...
        l_0x100f_ddc9:
            ...
            ii(0x100f_ddd0, 2); if(jnz(0x100f_ddd7, 0x5)) goto l_0x100f_ddd7; /* jnz 0x100fddd7 */
            ii(0x100f_ddd2, 5); call(0x100f_b82b, -0x25ac);             /* call 0x100fb82b */
        l_0x100f_ddd7:
            ii(0x100f_ddd7, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_ddeb, 2); if(jz(0x100f_ddf6, 0x9)) goto l_0x100f_ddf6; /* jz 0x100fddf6 */
            ii(0x100f_dded, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
        ...
        l_0x100f_ddf8:
            ...
            ii(0x100f_de1a, 6); mov(memw[ss, ebp - 0x4], 0x4);          /* mov word [ebp-0x4], 0x4 */
        l_0x100f_de20:
            ii(0x100f_de20, 4); dec(memw[ss, ebp - 0x4]);               /* dec word [ebp-0x4] */
            ii(0x100f_de24, 5); cmp(memw[ss, ebp - 0x4], -0x1 /* 0xff */); /* cmp word [ebp-0x4], 0xffff */
            ii(0x100f_de29, 2); if(jz(0x100f_de5d, 0x32)) goto l_0x100f_de5d; /* jz 0x100fde5d */
            ii(0x100f_de2b, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_de4b, 2); if(jnz(0x100f_de52, 0x5)) goto l_0x100f_de52; /* jnz 0x100fde52 */
            ii(0x100f_de4d, 5); call(0x100f_b82b, -0x2627);             /* call 0x100fb82b */
        l_0x100f_de52:
            ii(0x100f_de52, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
        ...
        l_0x100f_de5d:
            ...
            ii(0x100f_dec1, 7); mov(memd[ss, ebp - 0x8], 0x1);          /* mov dword [ebp-0x8], 0x1 */
        l_0x100f_dec8:
            ii(0x100f_dec8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
