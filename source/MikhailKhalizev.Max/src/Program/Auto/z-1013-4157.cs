...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_4157()
        {
            ...
            ii(0x1013_416d, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1013_4170, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x1013_4173, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1013_4176, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1013_4184, 4); cmp(memd[ds, eax + 0x2], 0);            /* cmp dword [eax+0x2], 0x0 */
            ii(0x1013_4188, 2); if(jz(0x1013_41c6, 0x3c)) goto l_0x1013_41c6; /* jz 0x101341c6 */
            ii(0x1013_418a, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1013_4198, 3); mov(eax, memd[ds, eax + 0x2]);          /* mov eax, [eax+0x2] */
            ii(0x1013_419b, 5); call(Definitions.sys_delete, 0x3_1dc4); /* call 0x10165f64 */
            ii(0x1013_41a0, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1013_41bd, 3); mov(eax, memd[ds, eax + 0xc]);          /* mov eax, [eax+0xc] */
            ii(0x1013_41c0, 6); sub(memd[ds, 0x101c_70dc], eax);        /* sub [0x101c70dc], eax */
        l_0x1013_41c6:
            ii(0x1013_41c6, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1013_41d5, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_41d8, 3); mov(memd[ds, edx + 0x2], eax);          /* mov [edx+0x2], eax */
            ii(0x1013_41db, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
