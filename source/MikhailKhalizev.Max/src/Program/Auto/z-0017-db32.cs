...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x17_db54:
            ...
            ii(0x17_db5b, 3);  add(sp, 2);                             /* add sp, 0x2 */
            ...
            ii(0x17_db6a, 3);  push(memw[ss, bp + 6]);                 /* push word [bp+0x6] */
            ...
            ii(0x17_db73, 3);  add(sp, 6);                             /* add sp, 0x6 */
            ii(0x17_db76, 2);  or(ax, ax);                             /* or ax, ax */
            ii(0x17_db78, 2);  if(jnz(0x17_db82, 8)) goto l_0x17_db82; /* jnz 0xdb82 */
