...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("e8056ca6-df9a-4ce8-b786-9f652a6a5a27")]
        public void Method_100d_c4fb()
        {
            ii(0x100d_c4fb, 5); pushd(0x50);                            /* push 0x50 */
            ii(0x100d_c500, 5); calld(Definitions.sys_check_available_stack_size, 0x8_984d); /* call 0x10165d52 */
            ...
            ii(0x100d_c539, 5); calld(0x1009_cb74, -0x3_f9ca);          /* call 0x1009cb74 */
            ...
            ii(0x100d_c553, 5); calld(0x1009_cab0, -0x3_faa8);          /* call 0x1009cab0 */
            ...
            ii(0x100d_c57d, 5); calld(0x1009_caf8, -0x3_fa8a);          /* call 0x1009caf8 */
            ...
            ii(0x100d_c58f, 5); calld(0x1008_b2a8, -0x5_12ec);          /* call 0x1008b2a8 */
            ...
            ii(0x100d_c5a1, 5); calld(0x1008_b2a8, -0x5_12fe);          /* call 0x1008b2a8 */
            ...
            ii(0x100d_c5b3, 5); calld(0x1008_b2a8, -0x5_1310);          /* call 0x1008b2a8 */
            ii(0x100d_c5b8, 5); calld(0x1009_cb74, -0x3_fa49);          /* call 0x1009cb74 */
            ...
            ii(0x100d_c5c7, 5); calld(0x1009_cab0, -0x3_fb1c);          /* call 0x1009cab0 */
            ...
            ii(0x100d_c5dc, 5); calld(0x1008_8b04, -0x5_3add);          /* call 0x10088b04 */
            ii(0x100d_c5e1, 3); lea(eax, ebp - 0x28);                   /* lea eax, [ebp-0x28] */
            ii(0x100d_c5e4, 5); calld(Definitions.my_2_get_count, -0x5_1281); /* call 0x1008b368 */
            ii(0x100d_c5e9, 3); mov(memd_a32[ss, ebp - 0x10], eax);     /* mov [ebp-0x10], eax */
            ii(0x100d_c5ec, 3); lea(eax, ebp - 0x2c);                   /* lea eax, [ebp-0x2c] */
            ii(0x100d_c5ef, 5); calld(0x100c_aac8, -0x1_1b2c);          /* call 0x100caac8 */
            ...
            ii(0x100d_c601, 5); calld(0x100c_aa44, -0x1_1bc2);          /* call 0x100caa44 */
            ...
            ii(0x100d_c613, 5); calld(0x100c_aa44, -0x1_1bd4);          /* call 0x100caa44 */
        ...
        l_0x100d_c627:
            ...
            ii(0x100d_c63d, 5); calld(0x100c_aa44, -0x1_1bfe);          /* call 0x100caa44 */
        ...
        l_0x100d_c644:
            ...
            ii(0x100d_c659, 5); calld(0x1008_8b04, -0x5_3b5a);          /* call 0x10088b04 */
        ...
        //    ii(0x100d_c665, 5); calld(0x100e_0244, 0x3bda);             /* call 0x100e0244 */
        //    ii(0x100d_c66a, 2); xor(edx, edx);                          /* xor edx, edx */
        //    ii(0x100d_c66c, 3); lea(eax, ebp - 0x28);                   /* lea eax, [ebp-0x28] */
        //    ii(0x100d_c66f, 5); calld(0x1008_8b04, -0x5_3b70);          /* call 0x10088b04 */
        l_0x100d_c674:
