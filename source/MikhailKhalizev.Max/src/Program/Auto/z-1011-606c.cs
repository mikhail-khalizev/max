...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_606c()
        {
            ...
            ii(0x1011_6084, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1011_6087, 5); call(0x100f_a9fd, -0x1_b68f);           /* call 0x100fa9fd */
            ii(0x1011_608c, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ...
            ii(0x1011_60b9, 7); mov(memd[ds, eax + 12], 0xffff_ffff);   /* mov dword [eax+0xc], 0xffffffff */
            ii(0x1011_60c0, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1011_60c3, 3); mov(edx, memd[ds, eax + 12]);           /* mov edx, [eax+0xc] */
