...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_606c()
        {
            ...
            ii(0x1011_609e, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_60a1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_60a4, 7); mov(memd[ds, eax + 0x4], 0xffff_ffff);  /* mov dword [eax+0x4], 0xffffffff */
            ii(0x1011_60ab, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_60ae, 3); mov(edx, memd[ds, eax + 0x4]);          /* mov edx, [eax+0x4] */
            ii(0x1011_60b1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_60b4, 2); mov(memd[ds, eax], edx);                /* mov [eax], edx */
            ii(0x1011_60b6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_60b9, 7); mov(memd[ds, eax + 0xc], 0xffff_ffff);  /* mov dword [eax+0xc], 0xffffffff */
            ii(0x1011_60c0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_60c3, 3); mov(edx, memd[ds, eax + 0xc]);          /* mov edx, [eax+0xc] */
            ii(0x1011_60c6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_60c9, 3); mov(memd[ds, eax + 0x8], edx);          /* mov [eax+0x8], edx */
