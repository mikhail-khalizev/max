...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("a03334de-c1f5-442b-b68b-8127932f658d")]
        public void Method_1011_606c()
        {
            ii(0x1011_606c, 5); pushd(0x30);                            /* push 0x30 */
            ii(0x1011_6071, 5); calld(Definitions.sys_check_available_stack_size, 0x4_fcdc); /* call 0x10165d52 */
            ...
            ii(0x1011_6087, 5); calld(0x100f_a9fd, -0x1_b68f);          /* call 0x100fa9fd */
            ii(0x1011_608c, 3); lea(eax, ebp - 0x14);                   /* lea eax, [ebp-0x14] */
            ii(0x1011_608f, 5); calld(0x100f_f562, -0x1_6b32);          /* call 0x100ff562 */
            ii(0x1011_6094, 5); mov(eax, 0x2);                          /* mov eax, 0x2 */
            ii(0x1011_6099, 5); calld(0x100e_883d, -0x2_d861);          /* call 0x100e883d */
