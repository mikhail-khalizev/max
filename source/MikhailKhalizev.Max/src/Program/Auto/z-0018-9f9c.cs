...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_9f9c()
        {
            ...
            ii(0x18_9fb3, 2); if(jaew_func(0x18_9fb6, 0x1)) return;     /* jae 0x9fb6 */ /* Адрес перехода делит инструкцию в этой функции пополам. */
            ii(0x18_9fb5, 4); mov(ebx, memd_a16[ss, bp + 0x2a]);        /* mov ebx, [bp+0x2a] */
