...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_0872()
        {
            ...
            ii(0x1009_0888, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ...
            ii(0x1009_0894, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x1009_0897, 4);  mov(memw[ds, edx + 43], ax);          /* mov [edx+0x2b], ax */
            ii(0x1009_089b, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ii(0x1009_089e, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1009_08a1, 5);  call(0x1007_5e64, -0x1_aa42);         /* call 0x10075e64 */
            ii(0x1009_08a6, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1009_08a8, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1009_08ab, 5);  call(0x1009_034f, -0x561);            /* call 0x1009034f */
            ii(0x1009_08b0, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1009_08b3, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
