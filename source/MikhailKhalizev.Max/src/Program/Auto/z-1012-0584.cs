...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_0584()
        {
            ...
            ii(0x1012_059b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_059e, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1012_05a1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_05a4, 2); mov(ebx, memd[ds, eax]);                /* mov ebx, [eax] */
            ii(0x1012_05a6, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1012_05a9, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1012_05ac, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_05af, 5); call(0x1012_05bc, 0x8);                 /* call 0x101205bc */
