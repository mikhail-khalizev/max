...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_10e8()
        {
            ...
            ii(0x100b_10fe, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100b_1101, 3);  mov(memd[ss, ebp - 8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100b_1104, 3);  mov(memd[ss, ebp - 4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x100b_1107, 3);  lea(edx, memd[ss, ebp - 44]);         /* lea edx, [ebp-0x2c] */
            ii(0x100b_110a, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100b_110d, 5);  call(0x100a_2d3d, -0xe3d5);           /* call 0x100a2d3d */
            ii(0x100b_1112, 4);  or(memb[ss, ebp - 16], 1);            /* or byte [ebp-0x10], 0x1 */
            ii(0x100b_1116, 3);  lea(eax, memd[ss, ebp - 40]);         /* lea eax, [ebp-0x28] */
            ii(0x100b_1119, 5);  call(0x1008_a634, -0x2_6aea);         /* call 0x1008a634 */
            ii(0x100b_111e, 3);  mov(memd[ss, ebp - 36], eax);         /* mov [ebp-0x24], eax */
            ii(0x100b_1121, 4);  and(memb[ss, ebp - 16], -2 /* 0xfe */);/* and byte [ebp-0x10], 0xfe */
            ...
            ii(0x100b_112f, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
        ...
        l_0x100b_1139:
            ii(0x100b_1139, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x100b_113c, 5);  call(0x1007_6bf8, -0x3_a549);         /* call 0x10076bf8 */
        l_0x100b_1141:
            ii(0x100b_1141, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_1143, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ...
            ii(0x100b_114f, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x100b_1152, 5);  call(0x100b_7a14, 0x68bd);            /* call 0x100b7a14 */
            ii(0x100b_1157, 5);  call(0x100b_7d68, 0x6c0c);            /* call 0x100b7d68 */
            ii(0x100b_115c, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100b_115f, 4);  cmp(memd[ss, ebp - 28], 0);           /* cmp dword [ebp-0x1c], 0x0 */
            ii(0x100b_1163, 2);  if(jz(0x100b_11b6, 0x51)) goto l_0x100b_11b6;/* jz 0x100b11b6 */
            ii(0x100b_1165, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x100b_1168, 4);  mov(ax, memw[ds, eax + 28]);          /* mov ax, [eax+0x1c] */
            ii(0x100b_116c, 3);  sub(eax, memd[ss, ebp - 42]);         /* sub eax, [ebp-0x2a] */
            ii(0x100b_116f, 3);  movsx(edx, ax);                       /* movsx edx, ax */
            ii(0x100b_1172, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x100b_1175, 4);  mov(ax, memw[ds, eax + 26]);          /* mov ax, [eax+0x1a] */
            ii(0x100b_1179, 3);  sub(eax, memd[ss, ebp - 44]);         /* sub eax, [ebp-0x2c] */
            ii(0x100b_117c, 1);  cwde();                               /* cwde */
            ii(0x100b_117d, 5);  call(0x100a_5f65, -0xb21d);           /* call 0x100a5f65 */
            ii(0x100b_1182, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x100b_1185, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_1187, 3);  lea(eax, memd[ss, ebp - 40]);         /* lea eax, [ebp-0x28] */
            ...
            ii(0x100b_1193, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100b_1196, 4);  cmp(ax, memw[ss, ebp - 24]);          /* cmp ax, [ebp-0x18] */
            ii(0x100b_119a, 2);  if(jle(0x100b_11b6, 0x1a)) goto l_0x100b_11b6;/* jle 0x100b11b6 */
        l_0x100b_119c:
            ii(0x100b_119c, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x100b_119f, 5);  call(0x100b_7a48, 0x68a4);            /* call 0x100b7a48 */
            ii(0x100b_11a4, 3);  lea(ebx, memd[ss, ebp - 40]);         /* lea ebx, [ebp-0x28] */
            ...
            ii(0x100b_11b0, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100b_11b3, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
        l_0x100b_11b6:
            ii(0x100b_11b6, 2);  jmp(0x100b_1139, -0x7f); goto l_0x100b_1139;/* jmp 0x100b1139 */
        l_0x100b_11b8:
            ii(0x100b_11b8, 3);  lea(edx, memd[ss, ebp - 40]);         /* lea edx, [ebp-0x28] */
            ...
            ii(0x100b_11c5, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x100b_11c8, 5);  call(0x100b_7650, 0x6483);            /* call 0x100b7650 */
            ii(0x100b_11cd, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_11cf, 3);  lea(eax, memd[ss, ebp - 40]);         /* lea eax, [ebp-0x28] */
        ...
        //  ii(0x100b_11db, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
        //  ii(0x100b_11de, 5);  call(0x100b_7650, 0x646d);            /* call 0x100b7650 */
        //  ii(0x100b_11e3, 2);  xor(edx, edx);                        /* xor edx, edx */
        //  ii(0x100b_11e5, 3);  lea(eax, memd[ss, ebp - 40]);         /* lea eax, [ebp-0x28] */
