...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_7b4f()
        {
            ...
            ii(0x19_7b5d, 5); mov(memw[ss, bp - 0x8], 0);               /* mov word [bp-0x8], 0x0 */
            ii(0x19_7b62, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
            ...
            ii(0x19_7b86, 2); if(jz(0x19_7b8b, 0x3)) goto l_0x19_7b8b;  /* jz 0x7b8b */
            ii(0x19_7b88, 3); jmp(0x19_7b91, 0x6); goto l_0x19_7b91;    /* jmp 0x7b91 */
        l_0x19_7b8b:
        ...
        l_0x19_7b91:
            ...
            ii(0x19_7ba5, 2); if(jz(0x19_7baa, 0x3)) goto l_0x19_7baa;  /* jz 0x7baa */
            ii(0x19_7ba7, 3); jmp(0x19_7bb0, 0x6); goto l_0x19_7bb0;    /* jmp 0x7bb0 */
        l_0x19_7baa:
        ...
        l_0x19_7bb0:
            ...
            ii(0x19_7bce, 3); jmp(0x19_7bd2, 0x1); goto l_0x19_7bd2;    /* jmp 0x7bd2 */
        l_0x19_7bd1:
            ii(0x19_7bd1, 1); inc(si);                                  /* inc si */
        l_0x19_7bd2:
            ii(0x19_7bd2, 3); cmp(si, 0x4);                             /* cmp si, 0x4 */
            ii(0x19_7bd5, 2); if(jl(0x19_7bda, 0x3)) goto l_0x19_7bda;  /* jl 0x7bda */
        ...
        l_0x19_7bda:
            ...
            ii(0x19_7be7, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_7bea, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ...
            ii(0x19_7bfb, 5); mov(memb[es, bx + di + 0x1], 0x1);        /* mov byte [es:bx+di+0x1], 0x1 */
            ...
            ii(0x19_7c0e, 4); mov(memb[es, bx + di], 0x1);              /* mov byte [es:bx+di], 0x1 */
            ii(0x19_7c12, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ...
            ii(0x19_7c23, 4); mov(memw[es, bx + di + 0x2], ax);         /* mov [es:bx+di+0x2], ax */
            ii(0x19_7c27, 6); mov(memw[es, bx + di + 0x4], 0);          /* mov word [es:bx+di+0x4], 0x0 */
            ii(0x19_7c2d, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ...
            ii(0x19_7c3e, 4); mov(memw[es, bx + di + 0x6], ax);         /* mov [es:bx+di+0x6], ax */
            ii(0x19_7c42, 3); jmp(0x19_7bd1, -0x74); goto l_0x19_7bd1;  /* jmp 0x7bd1 */
        l_0x19_7c45:
            ii(0x19_7c45, 3); lea(ax, memw[ss, bp - 0x4]);              /* lea ax, [bp-0x4] */
            ii(0x19_7c48, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_7c4b, 3); mov(memw[ss, bp - 0x2], ss);              /* mov [bp-0x2], ss */
            ii(0x19_7c4e, 2); mov(bx, ax);                              /* mov bx, ax */
            ii(0x19_7c50, 4); mov(memw[ds, bx], 0);                     /* mov word [bx], 0x0 */
            ii(0x19_7c54, 2); push(-0x1 /* 0xff */);                    /* push 0xffff */
            ii(0x19_7c56, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x19_7c59, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ii(0x19_7c5c, 5); call_far_abs(0x80, 0x53e4);               /* call word 0x80:0x53e4 */
            ii(0x19_7c61, 3); add(sp, 0x6);                             /* add sp, 0x6 */
            ii(0x19_7c64, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_7c67, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x19_7c6a, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0x19_7c6d, 3); or(ax, memw[ss, bp - 0x4]);               /* or ax, [bp-0x4] */
            ii(0x19_7c70, 2); if(jz(0x19_7c75, 0x3)) goto l_0x19_7c75;  /* jz 0x7c75 */
            ii(0x19_7c72, 3); jmp(0x19_7c7b, 0x6); goto l_0x19_7c7b;    /* jmp 0x7c7b */
        l_0x19_7c75:
            ii(0x19_7c75, 3); mov(ax, 0);                               /* mov ax, 0x0 */
            ii(0x19_7c78, 3); jmp(0x19_7d5b, 0xe0); goto l_0x19_7d5b;   /* jmp 0x7d5b */
        l_0x19_7c7b:
            ii(0x19_7c7b, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0x19_7c7e, 4); mov(es, memw[ds, 0x3fa4]);                /* mov es, [0x3fa4] */
            ii(0x19_7c82, 4); mov(memw[es, 0], ax);                     /* mov [es:0x0], ax */
            ii(0x19_7c86, 3); lea(ax, memw[ss, bp - 0x10]);             /* lea ax, [bp-0x10] */
            ...
            ii(0x19_7c9b, 2); if(jz(0x19_7ca0, 0x3)) goto l_0x19_7ca0;  /* jz 0x7ca0 */
            ii(0x19_7c9d, 3); jmp(0x19_7ca6, 0x6); goto l_0x19_7ca6;    /* jmp 0x7ca6 */
        l_0x19_7ca0:
            ii(0x19_7ca0, 3); mov(ax, 0);                               /* mov ax, 0x0 */
            ii(0x19_7ca3, 3); jmp(0x19_7d5b, 0xb5); goto l_0x19_7d5b;   /* jmp 0x7d5b */
        l_0x19_7ca6:
            ii(0x19_7ca6, 4); or(memb[ss, bp - 0xa], 0x40);             /* or byte [bp-0xa], 0x40 */
            ii(0x19_7caa, 3); lea(ax, memw[ss, bp - 0x10]);             /* lea ax, [bp-0x10] */
            ...
            ii(0x19_7cc3, 2); if(jz(0x19_7cc8, 0x3)) goto l_0x19_7cc8;  /* jz 0x7cc8 */
            ii(0x19_7cc5, 3); jmp(0x19_7cce, 0x6); goto l_0x19_7cce;    /* jmp 0x7cce */
        l_0x19_7cc8:
        ...
        l_0x19_7cce:
            ...
            ii(0x19_7ce1, 2); if(jnz(0x19_7ce6, 0x3)) goto l_0x19_7ce6; /* jnz 0x7ce6 */
            ii(0x19_7ce3, 3); jmp(0x19_7d50, 0x6a); goto l_0x19_7d50;   /* jmp 0x7d50 */
        l_0x19_7ce6:
            ii(0x19_7ce6, 5); mov(memw[ss, bp - 0x4], 0x2718);          /* mov word [bp-0x4], 0x2718 */
            ii(0x19_7ceb, 5); mov(memw[ss, bp - 0x2], 0x88);            /* mov word [bp-0x2], 0x88 */
            ii(0x19_7cf0, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0x19_7cf3, 3); mov(memw[ss, bp - 0x12], ax);             /* mov [bp-0x12], ax */
            ii(0x19_7cf6, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0x19_7cf9, 3); mov(memw[ss, bp - 0x16], ax);             /* mov [bp-0x16], ax */
            ii(0x19_7cfc, 5); mov(memw[ss, bp - 0x14], 0);              /* mov word [bp-0x14], 0x0 */
            ii(0x19_7d01, 3); lea(ax, memw[ss, bp - 0x16]);             /* lea ax, [bp-0x16] */
            ...
            ii(0x19_7d13, 3); jmp(0x19_7d17, 0x1); goto l_0x19_7d17;    /* jmp 0x7d17 */
        l_0x19_7d16:
            ii(0x19_7d16, 1); inc(si);                                  /* inc si */
        l_0x19_7d17:
            ii(0x19_7d17, 3); cmp(si, 0x1a);                            /* cmp si, 0x1a */
            ii(0x19_7d1a, 2); if(jle(0x19_7d1f, 0x3)) goto l_0x19_7d1f; /* jle 0x7d1f */
            ii(0x19_7d1c, 3); jmp(0x19_7d30, 0x11); goto l_0x19_7d30;   /* jmp 0x7d30 */
        l_0x19_7d1f:
            ii(0x19_7d1f, 3); lea(ax, memw[ss, bp - 0x16]);             /* lea ax, [bp-0x16] */
        ...
        l_0x19_7d30:
            ...
            ii(0x19_7d33, 3); jmp(0x19_7d37, 0x1); goto l_0x19_7d37;    /* jmp 0x7d37 */
        l_0x19_7d36:
            ii(0x19_7d36, 1); inc(si);                                  /* inc si */
        l_0x19_7d37:
            ii(0x19_7d37, 3); cmp(si, 0x2e);                            /* cmp si, 0x2e */
            ii(0x19_7d3a, 2); if(jle(0x19_7d3f, 0x3)) goto l_0x19_7d3f; /* jle 0x7d3f */
            ii(0x19_7d3c, 3); jmp(0x19_7d50, 0x11); goto l_0x19_7d50;   /* jmp 0x7d50 */
        l_0x19_7d3f:
            ii(0x19_7d3f, 3); lea(ax, memw[ss, bp - 0x16]);             /* lea ax, [bp-0x16] */
