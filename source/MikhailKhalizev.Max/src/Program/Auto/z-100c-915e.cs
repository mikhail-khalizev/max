...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_915e()
        {
            ...
            ii(0x100c_9174, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ...
            ii(0x100c_9180, 3); lea(eax, memd[ss, ebp - 52]);           /* lea eax, [ebp-0x34] */
            ii(0x100c_9183, 5); call(0x1007_5e64, -0x5_3324);           /* call 0x10075e64 */
            ii(0x100c_9188, 4); mov(memb[ss, ebp - 16], 1);             /* mov byte [ebp-0x10], 0x1 */
            ...
            ii(0x100c_91b2, 7); mov(memd[ss, ebp - 24], 0);             /* mov dword [ebp-0x18], 0x0 */
            ii(0x100c_91b9, 2); jmp(0x100c_91c1, 6); goto l_0x100c_91c1; /* jmp 0x100c91c1 */
        l_0x100c_91bb:
            ii(0x100c_91bb, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x100c_91be, 3); inc(memd[ss, ebp - 24]);                /* inc dword [ebp-0x18] */
        l_0x100c_91c1:
            ii(0x100c_91c1, 4); movsx(eax, memw[ss, ebp - 24]);         /* movsx eax, word [ebp-0x18] */
            ii(0x100c_91c5, 3); cmp(eax, 4);                            /* cmp eax, 0x4 */
            ii(0x100c_91c8, 2); if(jge(0x100c_91e4, 0x1a)) goto l_0x100c_91e4; /* jge 0x100c91e4 */
            ii(0x100c_91ca, 4); movsx(eax, memw[ss, ebp - 24]);         /* movsx eax, word [ebp-0x18] */
        ...
        l_0x100c_91e4:
            ii(0x100c_91e4, 4); movsx(eax, memw[ss, ebp - 24]);         /* movsx eax, word [ebp-0x18] */
            ...
            ii(0x100c_91fb, 3); mov(memd[ss, ebp - 40], eax);           /* mov [ebp-0x28], eax */
            ii(0x100c_91fe, 3); mov(eax, memd[ss, ebp - 40]);           /* mov eax, [ebp-0x28] */
            ii(0x100c_9201, 3); mov(memd[ss, ebp - 44], eax);           /* mov [ebp-0x2c], eax */
            ii(0x100c_9204, 4); cmp(memd[ss, ebp - 44], 0);             /* cmp dword [ebp-0x2c], 0x0 */
            ii(0x100c_9208, 2); if(jz(0x100c_9221, 0x17)) goto l_0x100c_9221; /* jz 0x100c9221 */
            ii(0x100c_920a, 4); movsx(edx, memw[ss, ebp - 24]);         /* movsx edx, word [ebp-0x18] */
            ii(0x100c_920e, 3); mov(eax, memd[ss, ebp - 40]);           /* mov eax, [ebp-0x28] */
            ii(0x100c_9211, 5); call(0x100c_9677, 0x461);               /* call 0x100c9677 */
            ii(0x100c_9216, 3); mov(memd[ss, ebp - 48], eax);           /* mov [ebp-0x30], eax */
            ii(0x100c_9219, 3); mov(eax, memd[ss, ebp - 48]);           /* mov eax, [ebp-0x30] */
            ii(0x100c_921c, 3); mov(memd[ss, ebp - 56], eax);           /* mov [ebp-0x38], eax */
            ii(0x100c_921f, 2); jmp(0x100c_9227, 6); goto l_0x100c_9227; /* jmp 0x100c9227 */
        l_0x100c_9221:
            ii(0x100c_9221, 3); mov(eax, memd[ss, ebp - 44]);           /* mov eax, [ebp-0x2c] */
            ii(0x100c_9224, 3); mov(memd[ss, ebp - 56], eax);           /* mov [ebp-0x38], eax */
        l_0x100c_9227:
            ii(0x100c_9227, 3); mov(edx, memd[ss, ebp - 56]);           /* mov edx, [ebp-0x38] */
            ...
            ii(0x100c_9253, 7); mov(memd[ss, ebp - 32], 1);             /* mov dword [ebp-0x20], 0x1 */
            ii(0x100c_925a, 2); jmp(0x100c_9262, 6); goto l_0x100c_9262; /* jmp 0x100c9262 */
        l_0x100c_925c:
            ii(0x100c_925c, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
            ii(0x100c_925f, 3); inc(memd[ss, ebp - 32]);                /* inc dword [ebp-0x20] */
        l_0x100c_9262:
            ii(0x100c_9262, 4); cmp(memb[ss, ebp - 16], 0);             /* cmp byte [ebp-0x10], 0x0 */
            ii(0x100c_9266, 6); if(jz(0x100c_938a, 0x11e)) goto l_0x100c_938a; /* jz 0x100c938a */
            ii(0x100c_926c, 3); mov(eax, memd[ss, ebp - 52]);           /* mov eax, [ebp-0x34] */
            ii(0x100c_926f, 4); dec(memw[ss, ebp - 52]);                /* dec word [ebp-0x34] */
            ii(0x100c_9273, 3); mov(eax, memd[ss, ebp - 50]);           /* mov eax, [ebp-0x32] */
            ii(0x100c_9276, 4); inc(memw[ss, ebp - 50]);                /* inc word [ebp-0x32] */
            ii(0x100c_927a, 4); mov(memb[ss, ebp - 16], 0);             /* mov byte [ebp-0x10], 0x0 */
            ii(0x100c_927e, 7); mov(memd[ss, ebp - 28], 0);             /* mov dword [ebp-0x1c], 0x0 */
            ii(0x100c_9285, 2); jmp(0x100c_928b, 4); goto l_0x100c_928b; /* jmp 0x100c928b */
        l_0x100c_9287:
            ii(0x100c_9287, 4); add(memd[ss, ebp - 28], 2);             /* add dword [ebp-0x1c], 0x2 */
        l_0x100c_928b:
            ii(0x100c_928b, 4); movsx(eax, memw[ss, ebp - 28]);         /* movsx eax, word [ebp-0x1c] */
            ii(0x100c_928f, 3); cmp(eax, 8);                            /* cmp eax, 0x8 */
            ii(0x100c_9292, 6); if(jge(0x100c_9385, 0xed)) goto l_0x100c_9385; /* jge 0x100c9385 */
            ii(0x100c_9298, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
            ii(0x100c_929b, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x100c_929d, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
        l_0x100c_92a0:
            ii(0x100c_92a0, 3); dec(memd[ss, ebp - 24]);                /* dec dword [ebp-0x18] */
            ii(0x100c_92a3, 5); cmp(memw[ss, ebp - 24], -1 /* 0xff */); /* cmp word [ebp-0x18], 0xffff */
            ii(0x100c_92a8, 6); if(jz(0x100c_9380, 0xd2)) goto l_0x100c_9380; /* jz 0x100c9380 */
            ii(0x100c_92ae, 4); movsx(eax, memw[ss, ebp - 28]);         /* movsx eax, word [ebp-0x1c] */
            ...
            ii(0x100c_92bc, 3); lea(eax, memd[ss, ebp - 52]);           /* lea eax, [ebp-0x34] */
            ii(0x100c_92bf, 5); call(0x1008_b1a4, -0x3_e120);           /* call 0x1008b1a4 */
            ii(0x100c_92c4, 4); movsx(eax, memw[ss, ebp - 52]);         /* movsx eax, word [ebp-0x34] */
            ii(0x100c_92c8, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100c_92ca, 2); if(jl(0x100c_92d8, 0xc)) goto l_0x100c_92d8; /* jl 0x100c92d8 */
            ii(0x100c_92cc, 3); mov(eax, memd[ss, ebp - 52]);           /* mov eax, [ebp-0x34] */
        ...
        l_0x100c_92da:
            ii(0x100c_92da, 4); movsx(eax, memw[ss, ebp - 50]);         /* movsx eax, word [ebp-0x32] */
        ...
        l_0x100c_92e4:
            ii(0x100c_92e4, 3); mov(eax, memd[ss, ebp - 50]);           /* mov eax, [ebp-0x32] */
        ...
        l_0x100c_92f5:
            ...
            ii(0x100c_92f8, 3); lea(eax, memd[ss, ebp - 60]);           /* lea eax, [ebp-0x3c] */
            ii(0x100c_92fb, 5); call(0x1007_5e64, -0x5_349c);           /* call 0x10075e64 */
            ii(0x100c_9300, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x100c_9302, 3); lea(edx, memd[ss, ebp - 52]);           /* lea edx, [ebp-0x34] */
            ii(0x100c_9305, 3); lea(eax, memd[ss, ebp - 64]);           /* lea eax, [ebp-0x40] */
            ...
            ii(0x100c_9314, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x100c_9317, 4); movsx(eax, memw[ss, ebp - 52]);         /* movsx eax, word [ebp-0x34] */
            ii(0x100c_931b, 3); shl(eax, 2);                            /* shl eax, 0x2 */
            ii(0x100c_931e, 3); add(eax, memd[ss, ebp - 8]);            /* add eax, [ebp-0x8] */
            ii(0x100c_9321, 4); movsx(edx, memw[ss, ebp - 50]);         /* movsx edx, word [ebp-0x32] */
            ...
            ii(0x100c_932e, 3); mov(memd[ss, ebp - 36], eax);           /* mov [ebp-0x24], eax */
            ii(0x100c_9331, 4); movsx(eax, memw[ss, ebp - 36]);         /* movsx eax, word [ebp-0x24] */
            ii(0x100c_9335, 5); and(eax, 0x7fff);                       /* and eax, 0x7fff */
            ii(0x100c_933a, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100c_933c, 4); movsx(eax, memw[ss, ebp - 20]);         /* movsx eax, word [ebp-0x14] */
            ii(0x100c_9340, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x100c_9342, 2); if(jle(0x100c_937b, 0x37)) goto l_0x100c_937b; /* jle 0x100c937b */
            ii(0x100c_9344, 4); movsx(eax, memw[ss, ebp - 36]);         /* movsx eax, word [ebp-0x24] */
            ...
            ii(0x100c_9354, 4); mov(memb[ss, ebp - 16], 1);             /* mov byte [ebp-0x10], 0x1 */
        l_0x100c_9358:
            ii(0x100c_9358, 3); mov(ebx, memd[ss, ebp - 36]);           /* mov ebx, [ebp-0x24] */
            ii(0x100c_935b, 6); and(ebx, 0x8000);                       /* and ebx, 0x8000 */
            ii(0x100c_9361, 3); or(ebx, memd[ss, ebp - 20]);            /* or ebx, [ebp-0x14] */
            ii(0x100c_9364, 4); movsx(eax, memw[ss, ebp - 52]);         /* movsx eax, word [ebp-0x34] */
            ii(0x100c_9368, 3); shl(eax, 2);                            /* shl eax, 0x2 */
            ii(0x100c_936b, 3); add(eax, memd[ss, ebp - 8]);            /* add eax, [ebp-0x8] */
            ii(0x100c_936e, 4); movsx(edx, memw[ss, ebp - 50]);         /* movsx edx, word [ebp-0x32] */
