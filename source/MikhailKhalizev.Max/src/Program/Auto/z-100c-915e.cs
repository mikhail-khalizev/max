...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_915e()
        {
            ...
            ii(0x100c_9177, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100c_917a, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x100c_917d, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100c_9180, 3); lea(eax, ebp - 0x34);                   /* lea eax, [ebp-0x34] */
            ii(0x100c_9183, 5); call(0x1007_5e64, -0x5_3324);           /* call 0x10075e64 */
            ii(0x100c_9188, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
            ii(0x100c_918c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_918f, 3); movsx(edx, memw[ds, eax]);              /* movsx edx, word [eax] */
            ii(0x100c_9192, 3); shl(edx, 0x2);                          /* shl edx, 0x2 */
            ii(0x100c_9195, 3); add(edx, memd[ss, ebp - 0x8]);          /* add edx, [ebp-0x8] */
            ii(0x100c_9198, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_91b9, 2); jmp(0x100c_91c1, 0x6); goto l_0x100c_91c1; /* jmp 0x100c91c1 */
        l_0x100c_91bb:
        ...
        l_0x100c_91e4:
            ...
            ii(0x100c_921f, 2); jmp(0x100c_9227, 0x6); goto l_0x100c_9227; /* jmp 0x100c9227 */
        l_0x100c_9221:
        ...
        l_0x100c_9227:
            ...
            ii(0x100c_9234, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_9237, 3); movsx(edx, memw[ds, eax]);              /* movsx edx, word [eax] */
            ii(0x100c_923a, 3); shl(edx, 0x2);                          /* shl edx, 0x2 */
            ii(0x100c_923d, 3); add(edx, memd[ss, ebp - 0x8]);          /* add edx, [ebp-0x8] */
            ii(0x100c_9240, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_9253, 7); mov(memd[ss, ebp - 0x20], 0x1);         /* mov dword [ebp-0x20], 0x1 */
            ii(0x100c_925a, 2); jmp(0x100c_9262, 0x6); goto l_0x100c_9262; /* jmp 0x100c9262 */
        l_0x100c_925c:
        ...
        l_0x100c_9262:
            ...
            ii(0x100c_9285, 2); jmp(0x100c_928b, 0x4); goto l_0x100c_928b; /* jmp 0x100c928b */
        l_0x100c_9287:
            ii(0x100c_9287, 4); add(memd[ss, ebp - 0x1c], 0x2);         /* add dword [ebp-0x1c], 0x2 */
        l_0x100c_928b:
        ...
        l_0x100c_92a0:
            ...
            ii(0x100c_92a3, 5); cmp(memw[ss, ebp - 0x18], -0x1 /* 0xff */); /* cmp word [ebp-0x18], 0xffff */
            ...
            ii(0x100c_92d6, 2); if(jl(0x100c_92da, 0x2)) goto l_0x100c_92da; /* jl 0x100c92da */
        l_0x100c_92d8:
            ii(0x100c_92d8, 2); jmp(0x100c_92e2, 0x8); goto l_0x100c_92e2; /* jmp 0x100c92e2 */
        l_0x100c_92da:
            ii(0x100c_92da, 4); movsx(eax, memw[ss, ebp - 0x32]);       /* movsx eax, word [ebp-0x32] */
            ii(0x100c_92de, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100c_92e0, 2); if(jge(0x100c_92e4, 0x2)) goto l_0x100c_92e4; /* jge 0x100c92e4 */
        l_0x100c_92e2:
        ...
        l_0x100c_92e4:
            ...
            ii(0x100c_92ee, 2); if(jl(0x100c_92f5, 0x5)) goto l_0x100c_92f5; /* jl 0x100c92f5 */
        l_0x100c_92f0:
            ii(0x100c_92f0, 5); jmp(0x100c_937b, 0x86); goto l_0x100c_937b; /* jmp 0x100c937b */
        l_0x100c_92f5:
            ii(0x100c_92f5, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x100c_931e, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ...
            ii(0x100c_9352, 2); if(jz(0x100c_9358, 0x4)) goto l_0x100c_9358; /* jz 0x100c9358 */
            ii(0x100c_9354, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
        l_0x100c_9358:
            ...
            ii(0x100c_936b, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
