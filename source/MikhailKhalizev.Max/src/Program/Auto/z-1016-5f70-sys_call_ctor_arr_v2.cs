...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ sys_call_ctor_arr_v2()
        {
            ...
            ii(0x1016_5f89, 3); mov(eax, memd[ds, edi + 0x1]);          /* mov eax, [edi+0x1] */
            ii(0x1016_5f8c, 3); mov(edx, memd[ds, edi + 0xd]);          /* mov edx, [edi+0xd] */
            ii(0x1016_5f8f, 4); mov(memd[ss, esp + 0x20], eax);         /* mov [esp+0x20], eax */
        l_0x1016_5f93:
            ii(0x1016_5f93, 4); cmp(esi, memd[ss, esp + 0x8]);          /* cmp esi, [esp+0x8] */
            ii(0x1016_5f97, 2); if(jbe(0x1016_5fa7, 0xe)) goto l_0x1016_5fa7; /* jbe 0x10165fa7 */
            ii(0x1016_5f99, 2); mov(eax, ecx);                          /* mov eax, ecx */
            ii(0x1016_5f9b, 4); call_abs(memd[ss, esp + 0x20]);         /* call dword [esp+0x20] */
            ii(0x1016_5f9f, 4); inc(memd[ss, esp + 0x8]);               /* inc dword [esp+0x8] */
        ...
        l_0x1016_5fa7:
            ...
            ii(0x1016_5fad, 4); mov(eax, memd[ss, esp + 0xc]);          /* mov eax, [esp+0xc] */
        l_0x1016_5fb1:
