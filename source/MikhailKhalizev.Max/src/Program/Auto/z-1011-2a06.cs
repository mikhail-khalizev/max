...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_2a06()
        {
            ...
            ii(0x1011_2a1d, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_2a20, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x1011_2a23, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ...
            ii(0x1011_2a37, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_2a3a, 6); mov(memb[ds, eax + 0x50f], dl);         /* mov [eax+0x50f], dl */
            ii(0x1011_2a40, 5); mov(eax, 0x46);                         /* mov eax, 0x46 */
            ii(0x1011_2a45, 5); call(0x1007_5fdc, -0x9_ca6e);           /* call 0x10075fdc */
            ii(0x1011_2a4a, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_2a4d, 7); mov(memw[ds, edx + 0x510], ax);         /* mov [edx+0x510], ax */
            ...
            ii(0x1011_2a60, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_2a63, 7); mov(memw[ds, eax + 0x512], dx);         /* mov [eax+0x512], dx */
            ...
            ii(0x1011_2a76, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_2a79, 7); mov(memw[ds, eax + 0x515], dx);         /* mov [eax+0x515], dx */
            ...
            ii(0x1011_2a8c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_2a8f, 6); mov(memb[ds, eax + 0x514], dl);         /* mov [eax+0x514], dl */
            ii(0x1011_2a95, 6); mov(dl, memb[ds, 0x101c_3966]);         /* mov dl, [0x101c3966] */
            ii(0x1011_2a9b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_2a9e, 6); mov(memb[ds, eax + 0x51b], dl);         /* mov [eax+0x51b], dl */
            ii(0x1011_2aa4, 7); mov(dx, memw[ds, 0x101c_3968]);         /* mov dx, [0x101c3968] */
            ii(0x1011_2aab, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_2aae, 7); mov(memw[ds, eax + 0x51c], dx);         /* mov [eax+0x51c], dx */
            ...
            ii(0x1011_2ac1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_2ac4, 6); mov(memb[ds, eax + 0x517], dl);         /* mov [eax+0x517], dl */
            ...
            ii(0x1011_2ad6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_2ad9, 6); mov(memb[ds, eax + 0x518], dl);         /* mov [eax+0x518], dl */
            ...
            ii(0x1011_2aeb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_2aee, 6); mov(memb[ds, eax + 0x519], dl);         /* mov [eax+0x519], dl */
            ii(0x1011_2af4, 5); mov(eax, 0x50);                         /* mov eax, 0x50 */
            ii(0x1011_2af9, 5); call(0x1007_5fdc, -0x9_cb22);           /* call 0x10075fdc */
            ii(0x1011_2afe, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_2b01, 6); mov(memb[ds, edx + 0x51a], al);         /* mov [edx+0x51a], al */
            ii(0x1011_2b07, 5); mov(eax, 0x45);                         /* mov eax, 0x45 */
            ii(0x1011_2b0c, 5); call(0x1007_5fdc, -0x9_cb35);           /* call 0x10075fdc */
            ii(0x1011_2b11, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_2b14, 6); mov(memb[ds, edx + 0x50e], al);         /* mov [edx+0x50e], al */
            ii(0x1011_2b1a, 7); cmp(memb[ds, 0x101c_391e], 0x6);        /* cmp byte [0x101c391e], 0x6 */
            ii(0x1011_2b21, 2); if(jnz(0x1011_2b44, 0x21)) goto l_0x1011_2b44; /* jnz 0x10112b44 */
            ii(0x1011_2b23, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_2b26, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_2b28, 6); mov(dl, memb[ds, eax + 0x50e]);         /* mov dl, [eax+0x50e] */
            ii(0x1011_2b2e, 3); shl(edx, 0x2);                          /* shl edx, 0x2 */
            ii(0x1011_2b31, 6); mov(edx, memd[ds, edx + 0x101b_9794]);  /* mov edx, [edx+0x101b9794] */
            ii(0x1011_2b37, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
