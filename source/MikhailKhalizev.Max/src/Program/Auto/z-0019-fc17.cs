...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_fc17()
        {
            ...
            ii(0x19_fc20, 3); push(memw[ss, bp + 0xc]);                 /* push word [bp+0xc] */
            ii(0x19_fc23, 3); push(memw[ss, bp + 0xa]);                 /* push word [bp+0xa] */
            ii(0x19_fc26, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x19_fc29, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x19_fc2c, 3); call(0x19_fbdb, -0x54);                   /* call 0xfbdb */
            ii(0x19_fc2f, 1); pop(ds);                                  /* pop ds */
            ii(0x19_fc30, 1); leave();                                  /* leave */
            ii(0x19_fc31, 3); retf(0x8);                                /* retf 0x8 */
        }
    }
}
