...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_61a4()
        {
            ...
            ii(0x61aa, 4);  mov(memb[ss, bp - 13], 0x4c);              /* mov byte [bp-0xd], 0x4c */
            ii(0x61ae, 3);  mov(al, memb[ss, bp + 4]);                 /* mov al, [bp+0x4] */
            ii(0x61b1, 3);  mov(memb[ss, bp - 14], al);                /* mov [bp-0xe], al */
            ii(0x61b4, 3);  lea(ax, memw[ss, bp - 14]);                /* lea ax, [bp-0xe] */
