...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_c18c()
        {
            ...
            ii(0x1009_c1a3, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_c1a6, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1009_c1a9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_c1ac, 2); mov(ebx, memd[ds, eax]);                /* mov ebx, [eax] */
            ii(0x1009_c1ae, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1009_c1b1, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_c1b4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_c1b7, 5); call(0x1009_c1c4, 0x8);                 /* call 0x1009c1c4 */
