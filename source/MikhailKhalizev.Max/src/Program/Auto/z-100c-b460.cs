...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_b460()
        {
            ...
            ii(0x100c_b478, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_b47b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_b47e, 3); mov(al, memb[ds, eax + 0x1f]);          /* mov al, [eax+0x1f] */
            ii(0x100c_b481, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x100c_b484, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
