...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_a9e0()
        {
            ...
            ii(0x1017_a9e8, 3); sub(esp, 4);                            /* sub esp, 0x4 */
            ...
            ii(0x1017_aa03, 6); lea(eax, memd[ds, eax]);                /* lea eax, [eax] */
            ii(0x1017_aa09, 6); lea(edx, memd[ds, edx]);                /* lea edx, [edx] */
            ii(0x1017_aa0f, 1); nop();                                  /* nop */
        l_0x1017_aa10:
            ii(0x1017_aa10, 4); movzx(esi, memb[ds, eax + 1]);          /* movzx esi, byte [eax+0x1] */
            ii(0x1017_aa14, 4); movzx(edi, memb[ds, eax + 2]);          /* movzx edi, byte [eax+0x2] */
            ii(0x1017_aa18, 1); inc(eax);                               /* inc eax */
            ii(0x1017_aa19, 3); add(ebx, 2);                            /* add ebx, 0x2 */
            ii(0x1017_aa1c, 2); xor(ecx, ecx);                          /* xor ecx, ecx */
            ii(0x1017_aa1e, 2); sar(esi, 1);                            /* sar esi, 1 */
            ii(0x1017_aa20, 3); mov(cl, memb[ds, eax - 1]);             /* mov cl, [eax-0x1] */
            ii(0x1017_aa23, 2); sar(ecx, 1);                            /* sar ecx, 1 */
            ii(0x1017_aa25, 2); sar(edi, 1);                            /* sar edi, 1 */
            ii(0x1017_aa27, 3); shl(esi, 5);                            /* shl esi, 0x5 */
            ii(0x1017_aa2a, 3); shl(ecx, 0xa);                          /* shl ecx, 0xa */
            ii(0x1017_aa2d, 3); mov(memd[ss, ebp - 24], edi);           /* mov [ebp-0x18], edi */
            ii(0x1017_aa30, 2); or(ecx, esi);                           /* or ecx, esi */
            ii(0x1017_aa32, 3); mov(esi, memd[ss, ebp - 24]);           /* mov esi, [ebp-0x18] */
            ii(0x1017_aa35, 1); inc(eax);                               /* inc eax */
            ii(0x1017_aa36, 2); or(ecx, esi);                           /* or ecx, esi */
            ii(0x1017_aa38, 1); inc(eax);                               /* inc eax */
            ii(0x1017_aa39, 4); mov(memw[ds, ebx - 2], cx);             /* mov [ebx-0x2], cx */
            ii(0x1017_aa3d, 1); dec(edx);                               /* dec edx */
            ii(0x1017_aa3e, 2); if(jnz(0x1017_aa10, -0x30)) goto l_0x1017_aa10; /* jnz 0x1017aa10 */
        l_0x1017_aa40:
            ii(0x1017_aa40, 3); lea(esp, memd[ss, ebp - 20]);           /* lea esp, [ebp-0x14] */
