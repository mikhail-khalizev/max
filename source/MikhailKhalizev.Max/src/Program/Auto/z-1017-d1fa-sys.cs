...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_d1fa()
        {
            ...
            ii(0x1017_d209, 4); mov(memd[ss, esp + 0x8], eax);          /* mov [esp+0x8], eax */
        ...
        l_0x1017_d225:
            ...
            ii(0x1017_d227, 2); if(jnz(0x1017_d230, 0x7)) goto l_0x1017_d230; /* jnz 0x1017d230 */
        ...
        l_0x1017_d25c:
            ii(0x1017_d25c, 4); mov(memd[ss, esp + 0xc], ebx);          /* mov [esp+0xc], ebx */
            ii(0x1017_d260, 2); xor(esi, esi);                          /* xor esi, esi */
        l_0x1017_d262:
            ii(0x1017_d262, 4); mov(ecx, memd[ss, esp + 0xc]);          /* mov ecx, [esp+0xc] */
            ...
            ii(0x1017_d277, 4); mov(memd[ss, esp + 0x4], eax);          /* mov [esp+0x4], eax */
            ii(0x1017_d27b, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1017_d27d, 2); if(jge(0x1017_d286, 0x7)) goto l_0x1017_d286; /* jge 0x1017d286 */
        ...
        l_0x1017_d297:
            ...
            ii(0x1017_d2a0, 4); mov(ebp, memd[ss, esp + 0x4]);          /* mov ebp, [esp+0x4] */
        ...
        l_0x1017_d2b8:
            ...
            ii(0x1017_d2bb, 2); if(jz(0x1017_d2c6, 0x9)) goto l_0x1017_d2c6; /* jz 0x1017d2c6 */
        ...
        l_0x1017_d2c8:
            ii(0x1017_d2c8, 4); cmp(eax, memd[ss, esp + 0x10]);         /* cmp eax, [esp+0x10] */
            ii(0x1017_d2cc, 2); if(jb(0x1017_d297, -0x37)) goto l_0x1017_d297; /* jb 0x1017d297 */
            ii(0x1017_d2ce, 4); mov(ecx, memd[ss, esp + 0xc]);          /* mov ecx, [esp+0xc] */
            ii(0x1017_d2d2, 4); mov(ah, memb[ss, esp + 0x9]);           /* mov ah, [esp+0x9] */
            ii(0x1017_d2d6, 2); sub(ecx, edx);                          /* sub ecx, edx */
            ii(0x1017_d2d8, 2); add(ebp, edx);                          /* add ebp, edx */
            ii(0x1017_d2da, 4); mov(memd[ss, esp + 0xc], ecx);          /* mov [esp+0xc], ecx */
            ii(0x1017_d2de, 3); test(ah, 0x20);                         /* test ah, 0x20 */
            ii(0x1017_d2e1, 2); if(jnz(0x1017_d2eb, 0x8)) goto l_0x1017_d2eb; /* jnz 0x1017d2eb */
