...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x17_7aa0, 4); enter(0x6, 0);                            /* enter 0x6, 0x0 */
            ...
            ii(0x17_7aac, 5); mov(memw[ss, bp - 0x6], 0);               /* mov word [bp-0x6], 0x0 */
        l_0x17_7ab1:
            ii(0x17_7ab1, 4); cmp(memw[ss, bp - 0x6], 0);               /* cmp word [bp-0x6], 0x0 */
            ...
            ii(0x17_7ac5, 4); mov(dx, memw[es, bx + si + 0x2]);         /* mov dx, [es:bx+si+0x2] */
            ii(0x17_7ac9, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_7acc, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ...
            ii(0x17_7aec, 4); mov(ax, memw[es, bx + di + 0x2]);         /* mov ax, [es:bx+di+0x2] */
            ii(0x17_7af0, 3); or(ax, memw[es, bx + di]);                /* or ax, [es:bx+di] */
            ii(0x17_7af3, 2); if(jz(0x17_7afd, 0x8)) goto l_0x17_7afd;  /* jz 0x7afd */
            ii(0x17_7af5, 3); test(dl, 0x7f);                           /* test dl, 0x7f */
            ii(0x17_7af8, 2); if(jnz(0x17_7afd, 0x3)) goto l_0x17_7afd; /* jnz 0x7afd */
            ii(0x17_7afa, 3); mov(memw[ss, bp - 0x6], si);              /* mov [bp-0x6], si */
        l_0x17_7afd:
            ii(0x17_7afd, 2); or(si, si);                               /* or si, si */
            ii(0x17_7aff, 2); if(jz(0x17_7b08, 0x7)) goto l_0x17_7b08;  /* jz 0x7b08 */
        ...
        l_0x17_7b16:
            ii(0x17_7b16, 3); mov(ax, memw[ss, bp - 0x6]);              /* mov ax, [bp-0x6] */
