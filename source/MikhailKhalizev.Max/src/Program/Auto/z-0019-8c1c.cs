...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x19_8c1c, 4); enter(0x4, 0);                            /* enter 0x4, 0x0 */
            ii(0x19_8c20, 3); les(bx, memw[ss, bp + 0x4]);              /* les bx, [bp+0x4] */
            ii(0x19_8c23, 4); push(memw[es, bx + 0x2]);                 /* push word [es:bx+0x2] */
            ii(0x19_8c27, 3); push(memw[es, bx]);                       /* push word [es:bx] */
            ii(0x19_8c2a, 3); call(0x19_ff2f, 0x7302);                  /* call 0xff2f */
            ii(0x19_8c2d, 3); les(bx, memw[ss, bp + 0x4]);              /* les bx, [bp+0x4] */
            ii(0x19_8c30, 3); add(ax, memw[es, bx]);                    /* add ax, [es:bx] */
            ii(0x19_8c33, 4); mov(dx, memw[es, bx + 0x2]);              /* mov dx, [es:bx+0x2] */
            ...
            ii(0x19_8c41, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_8c44, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x19_8c47, 2); or(dx, ax);                               /* or dx, ax */
            ii(0x19_8c49, 2); if(jz(0x19_8c65, 0x1a)) goto l_0x19_8c65; /* jz 0x8c65 */
            ii(0x19_8c4b, 3); les(bx, memw[ss, bp - 0x4]);              /* les bx, [bp-0x4] */
            ii(0x19_8c4e, 5); mov(memb[es, bx + 0x19], 0);              /* mov byte [es:bx+0x19], 0x0 */
            ...
            ii(0x19_8c5b, 3); les(bx, memw[ss, bp + 0x4]);              /* les bx, [bp+0x4] */
            ii(0x19_8c5e, 3); mov(memw[es, bx], ax);                    /* mov [es:bx], ax */
            ii(0x19_8c61, 4); mov(memw[es, bx + 0x2], dx);              /* mov [es:bx+0x2], dx */
        l_0x19_8c65:
            ii(0x19_8c65, 1); leave();                                  /* leave */
            ii(0x19_8c66, 3); ret(0x4);                                 /* ret 0x4 */
        }
    }
}
