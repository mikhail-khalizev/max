...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1010_56a2:
            ...
            ii(0x1010_56a5, 4); mov(memb[ds, eax + 0x32], 1);           /* mov byte [eax+0x32], 0x1 */
        l_0x1010_56a9:
            ii(0x1010_56a9, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1010_56ac, 4); mov(memb[ds, eax + 0x31], 1);           /* mov byte [eax+0x31], 0x1 */
        ...
        l_0x1010_56b5:
            ...
            ii(0x1010_56b8, 7); xor(memb[ds, eax + 0x470], 1);          /* xor byte [eax+0x470], 0x1 */
        ...
        l_0x1010_581c:
            ...
            ii(0x1010_581f, 7); mov(memb[ds, eax + 0x461], 1);          /* mov byte [eax+0x461], 0x1 */
        ...
        l_0x1010_58e3:
            ii(0x1010_58e3, 4); mov(memb[ss, ebp - 0xc], 1);            /* mov byte [ebp-0xc], 0x1 */
