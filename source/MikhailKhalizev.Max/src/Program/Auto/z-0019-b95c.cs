...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_b95c()
        {
            ...
            ii(0x19_b961, 3); les(bx, memw[ss, bp + 4]);                /* les bx, [bp+0x4] */
            ii(0x19_b964, 4); les(si, memw[es, bx + 28]);               /* les si, [es:bx+0x1c] */
            ii(0x19_b968, 4); mov(ax, memw[es, si + 116]);              /* mov ax, [es:si+0x74] */
            ii(0x19_b96c, 4); mov(memw[ss, bp - 142], ax);              /* mov [bp-0x8e], ax */
            ii(0x19_b970, 3); mov(es, memw[ss, bp + 6]);                /* mov es, [bp+0x6] */
            ii(0x19_b973, 4); mov(ax, memw[es, bx + 40]);               /* mov ax, [es:bx+0x28] */
            ii(0x19_b977, 4); mov(dx, memw[es, bx + 42]);               /* mov dx, [es:bx+0x2a] */
            ii(0x19_b97b, 4); mov(memw[ss, bp - 140], ax);              /* mov [bp-0x8c], ax */
            ii(0x19_b97f, 4); mov(memw[ss, bp - 138], dx);              /* mov [bp-0x8a], dx */
        ...
        l_0x19_b98a:
            ii(0x19_b98a, 4); mov(ax, memw[ss, bp - 142]);              /* mov ax, [bp-0x8e] */
            ii(0x19_b98e, 4); dec(memw[ss, bp - 142]);                  /* dec word [bp-0x8e] */
            ii(0x19_b992, 2); or(ax, ax);                               /* or ax, ax */
            ii(0x19_b994, 2); if(jnz(0x19_b999, 3)) goto l_0x19_b999;   /* jnz 0xb999 */
        l_0x19_b996:
        ...
        l_0x19_b999:
            ...
            ii(0x19_b9e6, 2); if(jnz(0x19_b9ed, 5)) goto l_0x19_b9ed;   /* jnz 0xb9ed */
            ii(0x19_b9e8, 3); mov(ax, 0x514);                           /* mov ax, 0x514 */
            ii(0x19_b9eb, 2); jmp(0x19_ba41, 0x54); goto l_0x19_ba41;   /* jmp 0xba41 */
        l_0x19_b9ed:
            ii(0x19_b9ed, 3); push(memw[ss, bp + 6]);                   /* push word [bp+0x6] */
            ii(0x19_b9f0, 3); push(memw[ss, bp + 4]);                   /* push word [bp+0x4] */
            ii(0x19_b9f3, 4); lea(ax, memw[ss, bp - 130]);              /* lea ax, [bp-0x82] */
            ii(0x19_b9f7, 1); push(ss);                                 /* push ss */
            ii(0x19_b9f8, 1); push(ax);                                 /* push ax */
            ii(0x19_b9f9, 3); call(0x19_d270, 0x1874);                  /* call 0xd270 */
            ii(0x19_b9fc, 4); push(memw[ss, bp - 136]);                 /* push word [bp-0x88] */
            ii(0x19_ba00, 3); call(0x19_a14c, -0x18b7);                 /* call 0xa14c */
            ii(0x19_ba03, 4); mov(memw[ss, bp - 134], ax);              /* mov [bp-0x86], ax */
            ii(0x19_ba07, 4); mov(memw[ss, bp - 132], dx);              /* mov [bp-0x84], dx */
            ii(0x19_ba0b, 2); or(dx, ax);                               /* or dx, ax */
            ii(0x19_ba0d, 2); if(jz(0x19_ba24, 0x15)) goto l_0x19_ba24; /* jz 0xba24 */
            ii(0x19_ba0f, 4); les(bx, memw[ss, bp - 134]);              /* les bx, [bp-0x86] */
            ii(0x19_ba13, 6); test(memb[es, bx + 306], 2);              /* test byte [es:bx+0x132], 0x2 */
            ii(0x19_ba19, 2); if(jz(0x19_ba24, 9)) goto l_0x19_ba24;    /* jz 0xba24 */
            ii(0x19_ba1b, 3); les(bx, memw[ss, bp + 4]);                /* les bx, [bp+0x4] */
            ii(0x19_ba1e, 6); or(memb[es, bx + 306], 2);                /* or byte [es:bx+0x132], 0x2 */
        l_0x19_ba24:
            ii(0x19_ba24, 4); les(bx, memw[ss, bp - 140]);              /* les bx, [bp-0x8c] */
            ii(0x19_ba28, 3); mov(al, memb[es, bx]);                    /* mov al, [es:bx] */
            ii(0x19_ba2b, 2); sub(ah, ah);                              /* sub ah, ah */
            ii(0x19_ba2d, 1); inc(ax);                                  /* inc ax */
            ii(0x19_ba2e, 4); add(memw[ss, bp - 140], ax);              /* add [bp-0x8c], ax */
        l_0x19_ba32:
            ii(0x19_ba32, 4); les(bx, memw[ss, bp - 140]);              /* les bx, [bp-0x8c] */
            ii(0x19_ba36, 4); cmp(memb[es, bx], 0);                     /* cmp byte [es:bx], 0x0 */
            ii(0x19_ba3a, 2); if(jz(0x19_ba3f, 3)) goto l_0x19_ba3f;    /* jz 0xba3f */
