...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_4540()
        {
            ...
            ii(0x1019_4548, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1019_454b, 2);  mov(ecx, edx);                        /* mov ecx, edx */
            ii(0x1019_454d, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x1019_4561, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
            ii(0x1019_4564, 2);  xor(ah, ah);                          /* xor ah, ah */
            ii(0x1019_4566, 2);  xor(ebx, ebx);                        /* xor ebx, ebx */
            ii(0x1019_4568, 4);  mov(memw[ss, ebp - 52], dx);          /* mov [ebp-0x34], dx */
            ii(0x1019_456c, 3);  mov(memb[ss, ebp - 48], al);          /* mov [ebp-0x30], al */
            ii(0x1019_456f, 3);  mov(memb[ss, ebp - 47], ah);          /* mov [ebp-0x2f], ah */
            ii(0x1019_4572, 4);  mov(memw[ss, ebp - 44], bx);          /* mov [ebp-0x2c], bx */
            ii(0x1019_4576, 2);  mov(edx, ds);                         /* mov edx, ds */
            ii(0x1019_4578, 2);  mov(eax, ecx);                        /* mov eax, ecx */
            ii(0x1019_457a, 3);  lea(ebx, memd[ss, ebp - 52]);         /* lea ebx, [ebp-0x34] */
            ii(0x1019_457d, 5);  mov(eax, 0x31);                       /* mov eax, 0x31 */
            ii(0x1019_4582, 4);  mov(memw[ss, ebp - 24], dx);          /* mov [ebp-0x18], dx */
            ii(0x1019_4586, 3);  mov(memd[ss, ebp - 32], ecx);         /* mov [ebp-0x20], ecx */
            ii(0x1019_4589, 3);  lea(edx, memd[ss, ebp - 52]);         /* lea edx, [ebp-0x34] */
            ii(0x1019_458c, 3);  lea(ecx, memd[ss, ebp - 24]);         /* lea ecx, [ebp-0x18] */
            ii(0x1019_458f, 5);  call(/* sys */ 0x1016_c623, -0x2_7f71);/* call 0x1016c623 */
            ii(0x1019_4594, 4);  cmp(memd[ss, ebp - 28], 0);           /* cmp dword [ebp-0x1c], 0x0 */
            ii(0x1019_4598, 3);  setz(al);                             /* setz al */
            ii(0x1019_459b, 5);  and(eax, 0xff);                       /* and eax, 0xff */
            ii(0x1019_45a0, 3);  lea(esp, memd[ss, ebp - 8]);          /* lea esp, [ebp-0x8] */
