...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_e341()
        {
            ...
            ii(0x1013_e359, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1013_e35c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1013_e36c, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1013_e373, 2); jmp(0x1013_e37b, 0x6); goto l_0x1013_e37b; /* jmp 0x1013e37b */
        l_0x1013_e375:
            ii(0x1013_e375, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_e378, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x1013_e37b:
            ii(0x1013_e37b, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1013_e37f, 3); cmp(eax, 0xa);                          /* cmp eax, 0xa */
            ii(0x1013_e382, 2); if(jz(0x1013_e398, 0x14)) goto l_0x1013_e398; /* jz 0x1013e398 */
            ii(0x1013_e384, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
        ...
        l_0x1013_e398:
            ii(0x1013_e398, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1013_e39c, 3); cmp(eax, 0xa);                          /* cmp eax, 0xa */
            ii(0x1013_e39f, 2); if(jnz(0x1013_e3c6, 0x25)) goto l_0x1013_e3c6; /* jnz 0x1013e3c6 */
            ii(0x1013_e3a1, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1013_e3a8, 2); jmp(0x1013_e3b0, 0x6); goto l_0x1013_e3b0; /* jmp 0x1013e3b0 */
        l_0x1013_e3aa:
            ii(0x1013_e3aa, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_e3ad, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x1013_e3b0:
            ii(0x1013_e3b0, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1013_e3b4, 3); cmp(eax, 0xa);                          /* cmp eax, 0xa */
            ii(0x1013_e3b7, 2); if(jz(0x1013_e3c6, 0xd)) goto l_0x1013_e3c6; /* jz 0x1013e3c6 */
            ii(0x1013_e3b9, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1013_e3bd, 7); mov(memb[ds, eax + 0x101c_8084], 0x1);  /* mov byte [eax+0x101c8084], 0x1 */
        ...
        l_0x1013_e3c6:
            ...
            ii(0x1013_e3fb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1013_e407, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1013_e40e, 2); jmp(0x1013_e416, 0x6); goto l_0x1013_e416; /* jmp 0x1013e416 */
        l_0x1013_e410:
            ii(0x1013_e410, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_e413, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x1013_e416:
            ii(0x1013_e416, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1013_e41a, 3); cmp(eax, 0xa);                          /* cmp eax, 0xa */
            ii(0x1013_e41d, 2); if(jz(0x1013_e433, 0x14)) goto l_0x1013_e433; /* jz 0x1013e433 */
            ii(0x1013_e41f, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
        ...
        l_0x1013_e433:
            ii(0x1013_e433, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1013_e43e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_e441, 6); mov(edx, memd[ds, eax + 0xdc5]);        /* mov edx, [eax+0xdc5] */
            ii(0x1013_e447, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_e44a, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ii(0x1013_e44d, 5); call(Definitions.my_fseek, -0x4_effd);  /* call 0x100ef455 */
            ii(0x1013_e452, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_e455, 6); mov(edx, memd[ds, eax + 0xdca]);        /* mov edx, [eax+0xdca] */
            ii(0x1013_e45b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_e45e, 6); mov(memd[ds, eax + 0xdce], edx);        /* mov [eax+0xdce], edx */
            ii(0x1013_e464, 2); jmp(0x1013_e46b, 0x5); goto l_0x1013_e46b; /* jmp 0x1013e46b */
        l_0x1013_e466:
        ...
        l_0x1013_e46d:
            ...
            ii(0x1013_e46f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_e472, 6); mov(edx, memd[ds, eax + 0xdc5]);        /* mov edx, [eax+0xdc5] */
            ii(0x1013_e478, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_e47b, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ii(0x1013_e47e, 5); call(Definitions.my_fseek, -0x4_f02e);  /* call 0x100ef455 */
            ii(0x1013_e483, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_e486, 6); mov(edx, memd[ds, eax + 0xdca]);        /* mov edx, [eax+0xdca] */
            ii(0x1013_e48c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
