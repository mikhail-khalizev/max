...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_b696()
        {
            ...
            ii(0xb69a, 5);    cmp(memw[ds, 0xa12], 0x1);                /* cmp word [0xa12], 0x1 */
            ii(0xb69f, 2);    if(jl(0xb6a4, 0x3)) goto l_0xb6a4;        /* jl 0xb6a4 */
            ii(0xb6a1, 3);    jmp(0xb740, 0x9c); goto l_0xb740;         /* jmp 0xb740 */
        l_0xb6a4:
            ii(0xb6a4, 2);    sub(ax, ax);                              /* sub ax, ax */
            ii(0xb6a6, 3);    mov(memw[ss, bp - 0x10], ax);             /* mov [bp-0x10], ax */
            ii(0xb6a9, 3);    mov(memw[ss, bp - 0x12], ax);             /* mov [bp-0x12], ax */
            ...
            ii(0xb6b9, 5);    mov(memw[ss, bp - 0xe], 0xbfde);          /* mov word [bp-0xe], 0xbfde */
            ii(0xb6be, 5);    mov(memw[ss, bp - 0xc], 0x2);             /* mov word [bp-0xc], 0x2 */
            ii(0xb6c3, 2);    sub(ax, ax);                              /* sub ax, ax */
            ii(0xb6c5, 3);    mov(memw[ss, bp - 0xa], ax);              /* mov [bp-0xa], ax */
            ii(0xb6c8, 3);    mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0xb6cb, 3);    lea(ax, memw[ss, bp - 0xe]);              /* lea ax, [bp-0xe] */
        ...
        l_0xb6da:
            ii(0xb6da, 3);    mov(ax, memw[ss, bp - 0x10]);             /* mov ax, [bp-0x10] */
            ii(0xb6dd, 3);    or(ax, memw[ss, bp - 0x12]);              /* or ax, [bp-0x12] */
            ii(0xb6e0, 2);    if(jnz(0xb728, 0x46)) goto l_0xb728;      /* jnz 0xb728 */
            ii(0xb6e2, 3);    call(0x7cd4, -0x3a11);                    /* call 0x7cd4 */
            ii(0xb6e5, 3);    mov(memw[ss, bp - 0x14], ax);             /* mov [bp-0x14], ax */
            ii(0xb6e8, 3);    call(0x773a, -0x3fb1);                    /* call 0x773a */
            ii(0xb6eb, 3);    mov(ax, memw[ss, bp - 0x14]);             /* mov ax, [bp-0x14] */
            ...
            ii(0xb6f9, 3);    mov(memw[ss, bp - 0x12], ax);             /* mov [bp-0x12], ax */
            ii(0xb6fc, 3);    mov(memw[ss, bp - 0x10], dx);             /* mov [bp-0x10], dx */
            ii(0xb6ff, 2);    or(dx, ax);                               /* or dx, ax */
            ii(0xb701, 2);    if(jz(0xb725, 0x22)) goto l_0xb725;       /* jz 0xb725 */
            ii(0xb703, 3);    push(0x92);                               /* push 0x92 */
            ii(0xb706, 2);    push(-0x1 /* 0xff */);                    /* push 0xffff */
            ii(0xb708, 3);    push(memw[ss, bp - 0x10]);                /* push word [bp-0x10] */
            ...
            ii(0xb714, 3);    push(memw[ss, bp - 0x14]);                /* push word [bp-0x14] */
        ...
        l_0xb728:
            ii(0xb728, 3);    mov(ax, memw[ss, bp - 0x10]);             /* mov ax, [bp-0x10] */
            ii(0xb72b, 3);    or(ax, memw[ss, bp - 0x12]);              /* or ax, [bp-0x12] */
            ii(0xb72e, 2);    if(jz(0xb740, 0x10)) goto l_0xb740;       /* jz 0xb740 */
            ii(0xb730, 3);    mov(ax, memw[ss, bp - 0x12]);             /* mov ax, [bp-0x12] */
            ii(0xb733, 3);    mov(dx, memw[ss, bp - 0x10]);             /* mov dx, [bp-0x10] */
