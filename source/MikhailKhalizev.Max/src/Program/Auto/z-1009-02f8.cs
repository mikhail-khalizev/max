...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_02f8()
        {
            ...
            ii(0x1009_0310, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_0313, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_0316, 7); mov(memd[ds, eax + 0x23], 0x101b_466c); /* mov dword [eax+0x23], 0x101b466c */
            ii(0x1009_031d, 3); mov(al, memb[ss, ebp + 0x2c]);          /* mov al, [ebp+0x2c] */
            ii(0x1009_0320, 3); mov(edi, memd[ss, ebp - 0x4]);          /* mov edi, [ebp-0x4] */
            ii(0x1009_0323, 2); mov(memb[ds, edi], al);                 /* mov [edi], al */
            ii(0x1009_0325, 3); mov(edi, memd[ss, ebp - 0x4]);          /* mov edi, [ebp-0x4] */
            ii(0x1009_0328, 3); lea(edi, memd[ds, edi + 0x11]);         /* lea edi, [edi+0x11] */
            ii(0x1009_032b, 3); lea(esi, memd[ss, ebp + 0x1c]);         /* lea esi, [ebp+0x1c] */
            ii(0x1009_032e, 1); movsd();                                /* movsd */
            ii(0x1009_032f, 1); movsd();                                /* movsd */
            ii(0x1009_0330, 1); movsd();                                /* movsd */
            ii(0x1009_0331, 1); movsd();                                /* movsd */
            ii(0x1009_0332, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_0335, 6); mov(memw[ds, eax + 0x21], 0);           /* mov word [eax+0x21], 0x0 */
            ii(0x1009_033b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_033e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_0341, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
