...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_6cab()
        {
            ...
            ii(0x1009_6cc1, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1009_6cc4, 3); mov(memd[ss, ebp - 8], edx);            /* mov [ebp-0x8], edx */
            ii(0x1009_6cc7, 3); mov(memd[ss, ebp - 4], ebx);            /* mov [ebp-0x4], ebx */
            ii(0x1009_6cca, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x1009_6cd7, 3); lea(eax, memd[ss, ebp - 40]);           /* lea eax, [ebp-0x28] */
            ...
            ii(0x1009_6ce8, 3); lea(eax, memd[ss, ebp - 56]);           /* lea eax, [ebp-0x38] */
            ii(0x1009_6ceb, 5); call(0x1008_b148, -0xbba8);             /* call 0x1008b148 */
            ii(0x1009_6cf0, 2); jmp(0x1009_6cfa, 8); goto l_0x1009_6cfa; /* jmp 0x10096cfa */
        l_0x1009_6cf2:
            ii(0x1009_6cf2, 3); lea(eax, memd[ss, ebp - 40]);           /* lea eax, [ebp-0x28] */
            ii(0x1009_6cf5, 5); call(0x1007_6bf8, -0x2_0102);           /* call 0x10076bf8 */
        l_0x1009_6cfa:
            ii(0x1009_6cfa, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_6cfc, 3); lea(eax, memd[ss, ebp - 40]);           /* lea eax, [ebp-0x28] */
            ...
            ii(0x1009_6d08, 3); lea(eax, memd[ss, ebp - 40]);           /* lea eax, [ebp-0x28] */
            ii(0x1009_6d0b, 5); call(0x1009_c4f8, 0x57e8);              /* call 0x1009c4f8 */
            ii(0x1009_6d10, 5); call(0x1009_c4c4, 0x57af);              /* call 0x1009c4c4 */
            ii(0x1009_6d15, 3); mov(memd[ss, ebp - 60], eax);           /* mov [ebp-0x3c], eax */
            ii(0x1009_6d18, 3); lea(eax, memd[ss, ebp - 40]);           /* lea eax, [ebp-0x28] */
            ii(0x1009_6d1b, 5); call(0x1009_c4f8, 0x57d8);              /* call 0x1009c4f8 */
            ii(0x1009_6d20, 3); mov(memd[ss, ebp - 64], eax);           /* mov [ebp-0x40], eax */
            ii(0x1009_6d23, 3); mov(eax, memd[ss, ebp - 64]);           /* mov eax, [ebp-0x40] */
            ii(0x1009_6d26, 3); mov(ebx, memd[ds, eax + 2]);            /* mov ebx, [eax+0x2] */
            ii(0x1009_6d29, 3); lea(edx, memd[ss, ebp - 56]);           /* lea edx, [ebp-0x38] */
            ii(0x1009_6d2c, 3); mov(eax, memd[ss, ebp - 64]);           /* mov eax, [ebp-0x40] */
            ii(0x1009_6d2f, 3); call_abs(memd[ds, ebx + 28]);           /* call dword [ebx+0x1c] */
            ii(0x1009_6d32, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1009_6d35, 3); lea(eax, memd[ss, ebp - 56]);           /* lea eax, [ebp-0x38] */
            ...
            ii(0x1009_6d43, 3); lea(eax, memd[ss, ebp - 40]);           /* lea eax, [ebp-0x28] */
        ...
        l_0x1009_6d52:
            ...
            ii(0x1009_6d5c, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1009_6d5f, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1009_6d62, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1009_6d65, 4); cmp(memd[ss, ebp - 20], 0);             /* cmp dword [ebp-0x14], 0x0 */
            ii(0x1009_6d69, 2); if(jz(0x1009_6dab, 0x40)) goto l_0x1009_6dab; /* jz 0x10096dab */
            ii(0x1009_6d6b, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1009_6d6e, 1); push(eax);                              /* push eax */
            ii(0x1009_6d6f, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1009_6d72, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
            ...
            ii(0x1009_6d80, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1009_6d83, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x1009_6d86, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x1009_6d89, 3); mov(edx, memd[ds, eax + 2]);            /* mov edx, [eax+0x2] */
            ii(0x1009_6d8c, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x1009_6d8f, 3); call_abs(memd[ds, edx + 20]);           /* call dword [edx+0x14] */
            ii(0x1009_6d92, 3); movsx(ebx, ax);                         /* movsx ebx, ax */
            ii(0x1009_6d95, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1009_6d98, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1009_6d9b, 5); call(0x1008_c999, -0xa407);             /* call 0x1008c999 */
            ii(0x1009_6da0, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x1009_6da3, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x1009_6da6, 3); mov(memd[ss, ebp - 68], eax);           /* mov [ebp-0x44], eax */
            ii(0x1009_6da9, 2); jmp(0x1009_6db1, 6); goto l_0x1009_6db1; /* jmp 0x10096db1 */
        l_0x1009_6dab:
            ii(0x1009_6dab, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x1009_6dae, 3); mov(memd[ss, ebp - 68], eax);           /* mov [ebp-0x44], eax */
        l_0x1009_6db1:
            ii(0x1009_6db1, 3); mov(edx, memd[ss, ebp - 68]);           /* mov edx, [ebp-0x44] */
            ii(0x1009_6db4, 3); lea(eax, memd[ss, ebp - 36]);           /* lea eax, [ebp-0x24] */
            ii(0x1009_6db7, 5); call(0x1009_c7e0, 0x5a24);              /* call 0x1009c7e0 */
            ii(0x1009_6dbc, 3); lea(eax, memd[ss, ebp - 36]);           /* lea eax, [ebp-0x24] */
            ii(0x1009_6dbf, 5); call(0x1009_c73c, 0x5978);              /* call 0x1009c73c */
            ii(0x1009_6dc4, 3); mov(ebx, memd[ss, ebp - 12]);           /* mov ebx, [ebp-0xc] */
            ...
            ii(0x1009_6dd3, 3); lea(eax, memd[ss, ebp - 36]);           /* lea eax, [ebp-0x24] */
            ...
            ii(0x1009_6de9, 3); lea(eax, memd[ss, ebp - 36]);           /* lea eax, [ebp-0x24] */
            ii(0x1009_6dec, 5); call(0x1009_b9ec, 0x4bfb);              /* call 0x1009b9ec */
            ii(0x1009_6df1, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_6df3, 3); lea(eax, memd[ss, ebp - 40]);           /* lea eax, [ebp-0x28] */
