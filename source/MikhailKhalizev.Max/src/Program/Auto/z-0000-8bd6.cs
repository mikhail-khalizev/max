...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_8bd6()
        {
            ...
            ii(0x8bdc, 3);    lea(ax, memw[ss, bp - 0x34]);             /* lea ax, [bp-0x34] */
            ii(0x8bdf, 1);    push(ax);                                 /* push ax */
            ii(0x8be0, 3);    push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x8be3, 3);    push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ii(0x8be6, 3);    call(0xa481, 0x1898);                     /* call 0xa481 */
            ii(0x8be9, 3);    add(sp, 0x8);                             /* add sp, 0x8 */
            ii(0x8bec, 4);    mov(memb[ss, bp - 0x1d], 0);              /* mov byte [bp-0x1d], 0x0 */
            ii(0x8bf0, 5);    cmp(memb[ds, 0xcee], 0x4);                /* cmp byte [0xcee], 0x4 */
            ii(0x8bf5, 2);    if(jge(0x8c22, 0x2b)) goto l_0x8c22;      /* jge 0x8c22 */
            ii(0x8bf7, 3);    push(0xeee);                              /* push 0xeee */
            ii(0x8bfa, 3);    lea(ax, memw[ss, bp - 0x22]);             /* lea ax, [bp-0x22] */
            ...
            ii(0x8c07, 3);    mov(ax, memw[ss, bp - 0x8]);              /* mov ax, [bp-0x8] */
            ii(0x8c0a, 3);    mov(dx, memw[ss, bp - 0x6]);              /* mov dx, [bp-0x6] */
        ...
        l_0x8c22:
            ...
            ii(0x8c24, 3);    lea(ax, memw[ss, bp - 0x3e]);             /* lea ax, [bp-0x3e] */
            ii(0x8c27, 1);    push(ax);                                 /* push ax */
            ii(0x8c28, 3);    push(0xc8);                               /* push 0xc8 */
            ii(0x8c2b, 3);    push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ii(0x8c2e, 3);    call(0xa481, 0x1850);                     /* call 0xa481 */
            ii(0x8c31, 3);    add(sp, 0x8);                             /* add sp, 0x8 */
            ii(0x8c34, 5);    cmp(memw[ss, bp - 0x3e], 0xff2e);         /* cmp word [bp-0x3e], 0xff2e */
            ii(0x8c39, 2);    if(jnz(0x8c50, 0x15)) goto l_0x8c50;      /* jnz 0x8c50 */
            ii(0x8c3b, 4);    cmp(memb[ss, bp - 0x39], 0x24);           /* cmp byte [bp-0x39], 0x24 */
            ii(0x8c3f, 2);    if(jnz(0x8c50, 0xf)) goto l_0x8c50;       /* jnz 0x8c50 */
            ii(0x8c41, 3);    push(memw[ss, bp - 0x38]);                /* push word [bp-0x38] */
