...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_e171()
        {
            ...
            ii(0x1010_e189, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_e18c, 7); mov(memd[ss, ebp - 0x8], 0x13);         /* mov dword [ebp-0x8], 0x13 */
        l_0x1010_e193:
            ii(0x1010_e193, 3); dec(memd[ss, ebp - 0x8]);               /* dec dword [ebp-0x8] */
            ii(0x1010_e196, 5); cmp(memw[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp word [ebp-0x8], 0xffff */
            ii(0x1010_e19b, 2); if(jz(0x1010_e1e0, 0x43)) goto l_0x1010_e1e0; /* jz 0x1010e1e0 */
            ii(0x1010_e19d, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_e1a1, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_e1a4, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ...
            ii(0x1010_e1ad, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_e1b1, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_e1b4, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ...
            ii(0x1010_e1d5, 2); jmp(0x1010_e1de, 0x7); goto l_0x1010_e1de; /* jmp 0x1010e1de */
        l_0x1010_e1d7:
