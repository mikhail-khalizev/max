...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_913b()
        {
            ...
            ii(0x1017_913d, 3); sub(esp, 4);                            /* sub esp, 0x4 */
            ii(0x1017_9140, 4); lea(eax, memd[ss, esp + 24]);           /* lea eax, [esp+0x18] */
            ii(0x1017_9144, 2); mov(ebx, esp);                          /* mov ebx, esp */
            ii(0x1017_9146, 4); mov(edx, memd[ss, esp + 20]);           /* mov edx, [esp+0x14] */
            ii(0x1017_914a, 3); mov(memd[ss, esp], eax);                /* mov [esp], eax */
            ii(0x1017_914d, 4); mov(eax, memd[ss, esp + 16]);           /* mov eax, [esp+0x10] */
            ii(0x1017_9151, 5); call(/* sys */ 0x1018_7da3, 0xec4d);    /* call 0x10187da3 */
            ii(0x1017_9156, 3); add(esp, 4);                            /* add esp, 0x4 */
