...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x17_7f3a, 4); enter(0x2, 0);                            /* enter 0x2, 0x0 */
            ...
            ii(0x17_7f45, 5); mov(memw[ss, bp - 0x2], 0);               /* mov word [bp-0x2], 0x0 */
            ii(0x17_7f4a, 2); jmp(0x17_7f4f, 0x3); goto l_0x17_7f4f;    /* jmp 0x7f4f */
        l_0x17_7f4c:
            ii(0x17_7f4c, 3); inc(memw[ss, bp - 0x2]);                  /* inc word [bp-0x2] */
        l_0x17_7f4f:
            ii(0x17_7f4f, 3); mov(ax, memw[ds, 0x519e]);                /* mov ax, [0x519e] */
            ii(0x17_7f52, 3); cmp(memw[ss, bp - 0x2], ax);              /* cmp [bp-0x2], ax */
            ii(0x17_7f55, 2); if(jae(0x17_7f86, 0x2f)) goto l_0x17_7f86; /* jae 0x7f86 */
            ii(0x17_7f57, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_7f5a, 3); mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ii(0x17_7f5d, 3); mov(bx, memw[ss, bp - 0x2]);              /* mov bx, [bp-0x2] */
            ...
            ii(0x17_7f6c, 4); cmp(memw[es, bx + si + 0x2], dx);         /* cmp [es:bx+si+0x2], dx */
            ...
            ii(0x17_7f78, 4); mov(memw[es, bx + si + 0x2], ax);         /* mov [es:bx+si+0x2], ax */
