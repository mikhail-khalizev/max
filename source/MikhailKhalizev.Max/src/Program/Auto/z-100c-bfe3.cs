...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_bfe3()
        {
            ...
            ii(0x100c_bffb, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_bffe, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_c00b, 3); mov(dl, memb[ds, eax + 0x4d]);          /* mov dl, [eax+0x4d] */
            ii(0x100c_c00e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_c01e, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ii(0x100c_c021, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100c_c024, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x100c_c026, 2); if(jge(0x100c_c02e, 0x6)) goto l_0x100c_c02e; /* jge 0x100cc02e */
            ii(0x100c_c028, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x100c_c02c, 2); jmp(0x100c_c079, 0x4b); goto l_0x100c_c079; /* jmp 0x100cc079 */
        l_0x100c_c02e:
            ii(0x100c_c02e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_c031, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100c_c034, 5); call(0x1007_6574, -0x5_5ac5);           /* call 0x10076574 */
            ii(0x100c_c039, 4); cmp(memb[ds, eax + 0x3e], 0x3);         /* cmp byte [eax+0x3e], 0x3 */
            ii(0x100c_c03d, 2); if(jnz(0x100c_c069, 0x2a)) goto l_0x100c_c069; /* jnz 0x100cc069 */
            ii(0x100c_c03f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_c04c, 3); mov(dl, memb[ds, eax + 0x54]);          /* mov dl, [eax+0x54] */
            ii(0x100c_c04f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_c05f, 3); mov(eax, memd[ds, eax + 0x19]);         /* mov eax, [eax+0x19] */
            ii(0x100c_c062, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100c_c065, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x100c_c067, 2); if(jl(0x100c_c06f, 0x6)) goto l_0x100c_c06f; /* jl 0x100cc06f */
        l_0x100c_c069:
            ii(0x100c_c069, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x100c_c06d, 2); jmp(0x100c_c073, 0x4); goto l_0x100c_c073; /* jmp 0x100cc073 */
        l_0x100c_c06f:
            ii(0x100c_c06f, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
        l_0x100c_c073:
            ii(0x100c_c073, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
            ii(0x100c_c076, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
        l_0x100c_c079:
            ii(0x100c_c079, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
