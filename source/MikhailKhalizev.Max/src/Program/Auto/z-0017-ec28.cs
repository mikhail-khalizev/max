...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x17_ec2e:
            ...
            ii(0x17_ec30, 3); les(si, memw[ss, bp + 10]);               /* les si, [bp+0xa] */
            ...
            ii(0x17_ec47, 3); inc(memw[ss, bp + 6]);                    /* inc word [bp+0x6] */
            ii(0x17_ec4a, 3); inc(memw[ss, bp + 10]);                   /* inc word [bp+0xa] */
        l_0x17_ec4d:
            ii(0x17_ec4d, 3); les(bx, memw[ss, bp + 6]);                /* les bx, [bp+0x6] */
            ii(0x17_ec50, 4); cmp(memb[es, bx], 0);                     /* cmp byte [es:bx], 0x0 */
            ii(0x17_ec54, 2); if(jnz(0x17_ec2e, -0x28)) goto l_0x17_ec2e; /* jnz 0xec2e */
        l_0x17_ec56:
            ii(0x17_ec56, 3); mov(es, memw[ss, bp + 8]);                /* mov es, [bp+0x8] */
            ii(0x17_ec59, 3); mov(al, memb[es, bx]);                    /* mov al, [es:bx] */
            ii(0x17_ec5c, 3); les(bx, memw[ss, bp + 10]);               /* les bx, [bp+0xa] */
            ii(0x17_ec5f, 3); cmp(memb[es, bx], al);                    /* cmp [es:bx], al */
            ii(0x17_ec62, 2); if(jnz(0x17_ec6a, 6)) goto l_0x17_ec6a;   /* jnz 0xec6a */
            ii(0x17_ec64, 3); mov(ax, 1);                               /* mov ax, 0x1 */
