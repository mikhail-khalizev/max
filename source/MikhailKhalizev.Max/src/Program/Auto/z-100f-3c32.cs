...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_3c32()
        {
            ...
            ii(0x100f_3c83, 5); jmpd(0x100f_3ec0, 0x238); goto l_0x100f_3ec0; /* jmp 0x100f3ec0 */
        l_0x100f_3c88:
            ii(0x100f_3c88, 3); lea(edi, ebp - 0x1c);                   /* lea edi, [ebp-0x1c] */
            ii(0x100f_3c8b, 5); mov(esi, 0x101b_8ab8);                  /* mov esi, 0x101b8ab8 */
            ii(0x100f_3c90, 1); movsd_a32();                            /* movsd */
            ii(0x100f_3c91, 1); movsd_a32();                            /* movsd */
            ii(0x100f_3c92, 1); movsd_a32();                            /* movsd */
            ii(0x100f_3c93, 3); mov(eax, memd_a32[ss, ebp - 0x8]);      /* mov eax, [ebp-0x8] */
            ii(0x100f_3c96, 3); mov(eax, memd_a32[ds, eax + 0x6]);      /* mov eax, [eax+0x6] */
            ii(0x100f_3c99, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100f_3c9c, 3); imul(eax, eax, 0x33);                   /* imul eax, eax, 0x33 */
            ii(0x100f_3c9f, 6); pushd(memd_a32[ds, eax + 0x101c_81d7]); /* push dword [eax+0x101c81d7] */
            ii(0x100f_3ca5, 3); mov(eax, memd_a32[ss, ebp - 0x8]);      /* mov eax, [ebp-0x8] */
            ii(0x100f_3ca8, 3); mov(eax, memd_a32[ds, eax + 0x6]);      /* mov eax, [eax+0x6] */
            ii(0x100f_3cab, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100f_3cae, 3); imul(eax, eax, 0x33);                   /* imul eax, eax, 0x33 */
            ii(0x100f_3cb1, 6); mov(eax, memd_a32[ds, eax + 0x101c_81d3]); /* mov eax, [eax+0x101c81d3] */
            ii(0x100f_3cb7, 3); sar(eax, 0x18);                         /* sar eax, 0x18 */
            ii(0x100f_3cba, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100f_3cbd, 4); pushd(memd_a32[ds, eax + ebp - 0x1c]);  /* push dword [eax+ebp-0x1c] */
            ii(0x100f_3cc1, 6); lea(eax, ebp - 0x148);                  /* lea eax, [ebp-0x148] */
            ii(0x100f_3cc7, 1); pushd(eax);                             /* push eax */
            ii(0x100f_3cc8, 5); calld(Definitions.sys_sprintf, 0x7_2234); /* call 0x10165f01 */
            ii(0x100f_3ccd, 3); add(esp, 0xc);                          /* add esp, 0xc */
            ii(0x100f_3cd0, 3); mov(eax, memd_a32[ss, ebp - 0x8]);      /* mov eax, [ebp-0x8] */
            ii(0x100f_3cd3, 5); calld(0x1010_1103, 0xd42b);             /* call 0x10101103 */
            ii(0x100f_3cd8, 3); test(ax, ax);                           /* test ax, ax */
            ii(0x100f_3cdb, 2); if(jnzd(0x100f_3cee, 0x11)) goto l_0x100f_3cee; /* jnz 0x100f3cee */
            ii(0x100f_3cdd, 5); mov(eax, memd_a32[ds, 0x101c_3884]);    /* mov eax, [0x101c3884] */
            ii(0x100f_3ce2, 5); calld(0x1014_85ad, 0x5_48c6);           /* call 0x101485ad */
            ii(0x100f_3ce7, 5); cmp(eax, 0x1388);                       /* cmp eax, 0x1388 */
            ii(0x100f_3cec, 2); if(jad(0x100f_3cf0, 0x2)) goto l_0x100f_3cf0; /* ja 0x100f3cf0 */
        l_0x100f_3cee:
            ii(0x100f_3cee, 2); jmpd(0x100f_3d01, 0x11); goto l_0x100f_3d01; /* jmp 0x100f3d01 */
        l_0x100f_3cf0:
            ii(0x100f_3cf0, 7); mov(memd_a32[ss, ebp - 0x10], 0x40a);   /* mov dword [ebp-0x10], 0x40a */
            ii(0x100f_3cf7, 10); mov(memd_a32[ss, ebp - 0x14c], 0x40d); /* mov dword [ebp-0x14c], 0x40d */
        l_0x100f_3d01:
            ii(0x100f_3d01, 5); calld(0x1014_82f4, 0x5_45ee);           /* call 0x101482f4 */
            ii(0x100f_3d06, 5); mov(memd_a32[ds, 0x101c_3884], eax);    /* mov [0x101c3884], eax */
            ii(0x100f_3d0b, 5); jmpd(0x100f_3ee4, 0x1d4); goto l_0x100f_3ee4; /* jmp 0x100f3ee4 */
        l_0x100f_3d10:
        ...
        l_0x100f_3daf:
            ii(0x100f_3daf, 5); jmpd(0x100f_3ee4, 0x130); goto l_0x100f_3ee4; /* jmp 0x100f3ee4 */
        l_0x100f_3db4:
            ii(0x100f_3db4, 3); mov(eax, memd_a32[ss, ebp - 0x8]);      /* mov eax, [ebp-0x8] */
            ii(0x100f_3db7, 3); mov(eax, memd_a32[ds, eax + 0x6]);      /* mov eax, [eax+0x6] */
            ii(0x100f_3dba, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100f_3dbd, 3); imul(eax, eax, 0x33);                   /* imul eax, eax, 0x33 */
            ii(0x100f_3dc0, 6); pushd(memd_a32[ds, eax + 0x101c_81d7]); /* push dword [eax+0x101c81d7] */
            ii(0x100f_3dc6, 5); mov(eax, StringDefinitions.SHasBeenCaptured); /* mov eax, 0x101a24ac */
            ii(0x100f_3dcb, 1); pushd(eax);                             /* push eax */
            ii(0x100f_3dcc, 6); lea(eax, ebp - 0x148);                  /* lea eax, [ebp-0x148] */
            ii(0x100f_3dd2, 1); pushd(eax);                             /* push eax */
            ii(0x100f_3dd3, 5); calld(Definitions.sys_sprintf, 0x7_2129); /* call 0x10165f01 */
            ii(0x100f_3dd8, 3); add(esp, 0xc);                          /* add esp, 0xc */
            ii(0x100f_3ddb, 7); mov(memd_a32[ss, ebp - 0x10], 0x3d5);   /* mov dword [ebp-0x10], 0x3d5 */
            ii(0x100f_3de2, 10); mov(memd_a32[ss, ebp - 0x14c], 0x3d6); /* mov dword [ebp-0x14c], 0x3d6 */
            ii(0x100f_3dec, 5); jmpd(0x100f_3ee4, 0xf3); goto l_0x100f_3ee4; /* jmp 0x100f3ee4 */
        l_0x100f_3df1:
            ii(0x100f_3df1, 3); mov(eax, memd_a32[ss, ebp - 0x8]);      /* mov eax, [ebp-0x8] */
            ii(0x100f_3df4, 3); mov(eax, memd_a32[ds, eax + 0x6]);      /* mov eax, [eax+0x6] */
            ii(0x100f_3df7, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100f_3dfa, 3); imul(eax, eax, 0x33);                   /* imul eax, eax, 0x33 */
            ii(0x100f_3dfd, 6); pushd(memd_a32[ds, eax + 0x101c_81d7]); /* push dword [eax+0x101c81d7] */
            ii(0x100f_3e03, 5); mov(eax, StringDefinitions.SHasBeenDisabled); /* mov eax, 0x101a24c2 */
            ii(0x100f_3e08, 1); pushd(eax);                             /* push eax */
            ii(0x100f_3e09, 6); lea(eax, ebp - 0x148);                  /* lea eax, [ebp-0x148] */
            ii(0x100f_3e0f, 1); pushd(eax);                             /* push eax */
            ii(0x100f_3e10, 5); calld(Definitions.sys_sprintf, 0x7_20ec); /* call 0x10165f01 */
            ii(0x100f_3e15, 3); add(esp, 0xc);                          /* add esp, 0xc */
            ii(0x100f_3e18, 7); mov(memd_a32[ss, ebp - 0x10], 0x3db);   /* mov dword [ebp-0x10], 0x3db */
            ii(0x100f_3e1f, 10); mov(memd_a32[ss, ebp - 0x14c], 0x3dc); /* mov dword [ebp-0x14c], 0x3dc */
            ii(0x100f_3e29, 5); jmpd(0x100f_3ee4, 0xb6); goto l_0x100f_3ee4; /* jmp 0x100f3ee4 */
        l_0x100f_3e2e:
            ii(0x100f_3e2e, 3); mov(eax, memd_a32[ss, ebp - 0x8]);      /* mov eax, [ebp-0x8] */
            ii(0x100f_3e31, 3); mov(eax, memd_a32[ds, eax + 0x6]);      /* mov eax, [eax+0x6] */
            ii(0x100f_3e34, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100f_3e37, 3); imul(eax, eax, 0x33);                   /* imul eax, eax, 0x33 */
            ii(0x100f_3e3a, 6); pushd(memd_a32[ds, eax + 0x101c_81d7]); /* push dword [eax+0x101c81d7] */
            ii(0x100f_3e40, 5); mov(eax, StringDefinitions.AttemptToCaptureS); /* mov eax, 0x101a24d8 */
            ii(0x100f_3e45, 1); pushd(eax);                             /* push eax */
            ii(0x100f_3e46, 6); lea(eax, ebp - 0x148);                  /* lea eax, [ebp-0x148] */
            ii(0x100f_3e4c, 1); pushd(eax);                             /* push eax */
            ii(0x100f_3e4d, 5); calld(Definitions.sys_sprintf, 0x7_20af); /* call 0x10165f01 */
            ii(0x100f_3e52, 3); add(esp, 0xc);                          /* add esp, 0xc */
            ii(0x100f_3e55, 7); mov(memd_a32[ss, ebp - 0x10], 0x3cf);   /* mov dword [ebp-0x10], 0x3cf */
            ii(0x100f_3e5c, 10); mov(memd_a32[ss, ebp - 0x14c], 0x3d0); /* mov dword [ebp-0x14c], 0x3d0 */
            ii(0x100f_3e66, 5); jmpd(0x100f_3ee4, 0x79); goto l_0x100f_3ee4; /* jmp 0x100f3ee4 */
        l_0x100f_3e6b:
            ii(0x100f_3e6b, 3); mov(eax, memd_a32[ss, ebp - 0x8]);      /* mov eax, [ebp-0x8] */
            ii(0x100f_3e6e, 3); mov(eax, memd_a32[ds, eax + 0x6]);      /* mov eax, [eax+0x6] */
            ii(0x100f_3e71, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100f_3e74, 3); imul(eax, eax, 0x33);                   /* imul eax, eax, 0x33 */
            ii(0x100f_3e77, 6); pushd(memd_a32[ds, eax + 0x101c_81d7]); /* push dword [eax+0x101c81d7] */
            ii(0x100f_3e7d, 5); mov(eax, StringDefinitions.AttemptToDisableS); /* mov eax, 0x101a24ef */
            ii(0x100f_3e82, 1); pushd(eax);                             /* push eax */
            ii(0x100f_3e83, 6); lea(eax, ebp - 0x148);                  /* lea eax, [ebp-0x148] */
            ii(0x100f_3e89, 1); pushd(eax);                             /* push eax */
            ii(0x100f_3e8a, 5); calld(Definitions.sys_sprintf, 0x7_2072); /* call 0x10165f01 */
            ii(0x100f_3e8f, 3); add(esp, 0xc);                          /* add esp, 0xc */
            ii(0x100f_3e92, 7); mov(memd_a32[ss, ebp - 0x10], 0x3cf);   /* mov dword [ebp-0x10], 0x3cf */
            ii(0x100f_3e99, 10); mov(memd_a32[ss, ebp - 0x14c], 0x3d0); /* mov dword [ebp-0x14c], 0x3d0 */
            ii(0x100f_3ea3, 2); jmpd(0x100f_3ee4, 0x3f); goto l_0x100f_3ee4; /* jmp 0x100f3ee4 */
        l_0x100f_3ea5:
        ...
        l_0x100f_3ec0:
            ...
            ii(0x100f_3ed0, 2); if(jad(0x100f_3ea5, -0x2d)) goto l_0x100f_3ea5; /* ja 0x100f3ea5 */
            ...
            ii(0x100f_3edd, 7); 
            switch (jmpd_abs_switch(memd_a32[cs, eax + 0x100f_3ea8]))
            {
                case 0x100f_3c88:
                    goto l_0x100f_3c88;
                case 0x100f_3d10:
