...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_28a2()
        {
            ...
            ii(0x100f_28ba, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100f_28bd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100f_28c6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100f_28d4, 2); if(jnz(0x100f_28d8, 0x2)) goto l_0x100f_28d8; /* jnz 0x100f28d8 */
        l_0x100f_28d6:
            ii(0x100f_28d6, 2); jmp(0x100f_28e0, 0x8); goto l_0x100f_28e0; /* jmp 0x100f28e0 */
        l_0x100f_28d8:
            ii(0x100f_28d8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100f_28e0:
            ...
            ii(0x100f_2905, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_2908, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
        ...
        l_0x100f_291c:
            ii(0x100f_291c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_291f, 4); cmp(memb[ds, eax + 0x3d], 0x4);         /* cmp byte [eax+0x3d], 0x4 */
            ii(0x100f_2923, 2); if(jz(0x100f_292e, 0x9)) goto l_0x100f_292e; /* jz 0x100f292e */
            ii(0x100f_2925, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_2928, 4); cmp(memb[ds, eax + 0x3d], 0xb);         /* cmp byte [eax+0x3d], 0xb */
            ii(0x100f_292c, 2); if(jnz(0x100f_2930, 0x2)) goto l_0x100f_2930; /* jnz 0x100f2930 */
        l_0x100f_292e:
            ii(0x100f_292e, 2); jmp(0x100f_2939, 0x9); goto l_0x100f_2939; /* jmp 0x100f2939 */
        l_0x100f_2930:
            ii(0x100f_2930, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_2933, 4); cmp(memb[ds, eax + 0x3d], 0x15);        /* cmp byte [eax+0x3d], 0x15 */
            ii(0x100f_2937, 2); if(jnz(0x100f_293b, 0x2)) goto l_0x100f_293b; /* jnz 0x100f293b */
        l_0x100f_2939:
            ii(0x100f_2939, 2); jmp(0x100f_2944, 0x9); goto l_0x100f_2944; /* jmp 0x100f2944 */
        l_0x100f_293b:
            ii(0x100f_293b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_293e, 4); cmp(memb[ds, eax + 0x3d], 0x1f);        /* cmp byte [eax+0x3d], 0x1f */
            ii(0x100f_2942, 2); if(jnz(0x100f_294c, 0x8)) goto l_0x100f_294c; /* jnz 0x100f294c */
        l_0x100f_2944:
            ii(0x100f_2944, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
