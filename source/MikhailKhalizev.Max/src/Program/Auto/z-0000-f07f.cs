...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_f07f()
        {
            ...
            ii(0xf082, 3);    mov(bp, memw[ss, bp + 0x4]);              /* mov bp, [bp+0x4] */
            ii(0xf085, 4);    mov(bx, memw[ds, 0x996]);                 /* mov bx, [0x996] */
            ii(0xf089, 4);    mov(memb[ds, bx + 0x17], 0x49);           /* mov byte [bx+0x17], 0x49 */
            ii(0xf08d, 3);    call(0xe863, -0x82d);                     /* call 0xe863 */
            ii(0xf090, 3);    mov(al, memb[ds, bx + 0x26]);             /* mov al, [bx+0x26] */
