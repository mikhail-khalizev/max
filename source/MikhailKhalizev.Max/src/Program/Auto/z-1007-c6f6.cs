...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_c6f6()
        {
            ...
            ii(0x1007_c70d, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_c710, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1007_c713, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1007_c716, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1007_c719, 5); call(0x1008_b060, 0xe942);              /* call 0x1008b060 */
            ii(0x1007_c71e, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_c721, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1007_c72e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1007_c73d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1007_c74d, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ...
            ii(0x1007_c75b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_c75e, 4); sub(memw[ds, eax + 0x25], dx);          /* sub [eax+0x25], dx */
        l_0x1007_c762:
            ii(0x1007_c762, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_c764, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1007_c773, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_c776, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x1007_c779, 5); call(0x1008_af28, 0xe7aa);              /* call 0x1008af28 */
            ii(0x1007_c77e, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1007_c781, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1007_c784, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x1007_c787, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_c78a, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1007_c78d, 3); call_abs(memd[ds, ebx + 0x54]);         /* call dword [ebx+0x54] */
        l_0x1007_c790:
            ii(0x1007_c790, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1007_c7a6, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1007_c7a9, 5); mov(eax, 0xa);                          /* mov eax, 0xa */
            ii(0x1007_c7ae, 5); call(Definitions.sys_new, 0xe_964d);    /* call 0x10165e00 */
            ii(0x1007_c7b3, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1007_c7b6, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1007_c7b9, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1007_c7bc, 4); cmp(memd[ss, ebp - 0x1c], 0);           /* cmp dword [ebp-0x1c], 0x0 */
            ii(0x1007_c7c0, 2); if(jz(0x1007_c7d8, 0x16)) goto l_0x1007_c7d8; /* jz 0x1007c7d8 */
            ii(0x1007_c7c2, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1007_c7c5, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1007_c7c8, 5); call(0x100a_3711, 0x2_6f44);            /* call 0x100a3711 */
            ii(0x1007_c7cd, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1007_c7d0, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1007_c7d3, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x1007_c7d6, 2); jmp(0x1007_c7de, 0x6); goto l_0x1007_c7de; /* jmp 0x1007c7de */
        l_0x1007_c7d8:
            ii(0x1007_c7d8, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x1007_c7db, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
        l_0x1007_c7de:
            ii(0x1007_c7de, 3); mov(edx, memd[ss, ebp - 0x24]);         /* mov edx, [ebp-0x24] */
            ii(0x1007_c7e1, 5); mov(eax, 0x101c_3180);                  /* mov eax, 0x101c3180 */
            ii(0x1007_c7e6, 3); mov(ebx, memd[ss, ebp - 0x14]);         /* mov ebx, [ebp-0x14] */
            ii(0x1007_c7e9, 5); call(0x100a_4db6, 0x2_85c8);            /* call 0x100a4db6 */
        l_0x1007_c7ee:
            ii(0x1007_c7ee, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_c7f0, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
