...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_0f77()
        {
            ...
            ii(0x100a_0f8c, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100a_0f8f, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x100a_0f92, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x100a_0f95, 3); mov(memd[ss, ebp - 0x4], ecx);          /* mov [ebp-0x4], ecx */
            ii(0x100a_0f98, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100a_0f9b, 4); cmp(memb[ds, eax + 0x4c], 0);           /* cmp byte [eax+0x4c], 0x0 */
            ii(0x100a_0f9f, 2); if(jz(0x100a_0fb8, 0x17)) goto l_0x100a_0fb8; /* jz 0x100a0fb8 */
            ii(0x100a_0fa1, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x100a_0fa4, 3); add(edx, 0x8);                          /* add edx, 0x8 */
            ii(0x100a_0fa7, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x100a_0fb6, 2); if(jz(0x100a_0fbd, 0x5)) goto l_0x100a_0fbd; /* jz 0x100a0fbd */
        l_0x100a_0fb8:
            ii(0x100a_0fb8, 5); jmp(0x100a_1064, 0xa7); goto l_0x100a_1064; /* jmp 0x100a1064 */
        l_0x100a_0fbd:
            ii(0x100a_0fbd, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x100a_0fc0, 3); add(edx, 0x8);                          /* add edx, 0x8 */
            ii(0x100a_0fc3, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100a_0fc6, 3); add(eax, 0x48);                         /* add eax, 0x48 */
            ii(0x100a_0fc9, 5); call(0x1008_b2a8, -0x1_5d26);           /* call 0x1008b2a8 */
            ii(0x100a_0fce, 3); mov(edx, memd[ss, ebp - 0x10]);         /* mov edx, [ebp-0x10] */
            ii(0x100a_0fd1, 3); add(edx, 0x44);                         /* add edx, 0x44 */
            ii(0x100a_0fd4, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100a_0fe0, 3); mov(eax, memd[ss, ebp + 0x10]);         /* mov eax, [ebp+0x10] */
            ii(0x100a_0fe3, 1); push(eax);                              /* push eax */
            ii(0x100a_0fe4, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100a_0fe7, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
        ...
        l_0x100a_100b:
            ii(0x100a_100b, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100a_100e, 3); mov(al, memb[ds, eax + 0x4d]);          /* mov al, [eax+0x4d] */
            ...
            ii(0x100a_101f, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100a_1022, 3); add(eax, 0x4d);                         /* add eax, 0x4d */
            ii(0x100a_1025, 5); call(Definitions.sys_strcpy, 0xc_4ea5); /* call 0x10165ecf */
        l_0x100a_102a:
            ii(0x100a_102a, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100a_102d, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x100a_103c, 3); mov(eax, memd[ss, ebp + 0x10]);         /* mov eax, [ebp+0x10] */
        ...
        l_0x100a_1064:
            ...
            ii(0x100a_1069, 3); ret(0x4);                               /* ret 0x4 */
        }
    }
}
