...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x4ee9:
            ...
            ii(0x4eee, 3);    mov(bx, memw[ss, bp + 0x4]);              /* mov bx, [bp+0x4] */
            ii(0x4ef1, 3);    inc(memw[ss, bp + 0x4]);                  /* inc word [bp+0x4] */
            ii(0x4ef4, 2);    mov(memb[ds, bx], al);                    /* mov [bx], al */
        l_0x4ef6:
            ii(0x4ef6, 3);    mov(bx, memw[ss, bp + 0x6]);              /* mov bx, [bp+0x6] */
            ii(0x4ef9, 3);    inc(memw[ss, bp + 0x6]);                  /* inc word [bp+0x6] */
            ...
            ii(0x4f03, 3);    mov(bx, memw[ss, bp + 0x4]);              /* mov bx, [bp+0x4] */
