...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x17_7a54, 4); enter(0x4, 0);                            /* enter 0x4, 0x0 */
            ...
            ii(0x17_7a63, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ...
            ii(0x17_7a6f, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ...
            ii(0x17_7a7c, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0x17_7a7f, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
        ...
        l_0x17_7a84:
            ...
            ii(0x17_7a8d, 5); sub(memw[ds, 0x1fbc], 0x1);               /* sub word [0x1fbc], 0x1 */
            ii(0x17_7a92, 5); sbb(memw[ds, 0x1fbe], 0);                 /* sbb word [0x1fbe], 0x0 */
        l_0x17_7a97:
            ii(0x17_7a97, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
