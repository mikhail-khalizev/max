...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_8154()
        {
            ...
            ii(0x100c_816b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_816e, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100c_8171, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100c_8174, 3); mov(edx, memd[ds, edx + 0x17]);         /* mov edx, [edx+0x17] */
            ii(0x100c_8177, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_817a, 3); add(edx, memd[ds, eax + 0xf]);          /* add edx, [eax+0xf] */
            ...
            ii(0x100c_8189, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100c_818c, 3); mov(edx, memd[ds, edx + 0x13]);         /* mov edx, [edx+0x13] */
            ii(0x100c_818f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_8192, 3); add(edx, memd[ds, eax + 0xb]);          /* add edx, [eax+0xb] */
            ...
            ii(0x100c_81a1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_81a4, 5); call(0x1007_6aac, -0x5_16fd);           /* call 0x10076aac */
            ii(0x100c_81a9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
