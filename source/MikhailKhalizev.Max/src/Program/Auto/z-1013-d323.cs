...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_d323()
        {
            ...
            ii(0x1013_d33a, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1013_d33d, 3); mov(memb[ss, ebp - 4], dl);             /* mov [ebp-0x4], dl */
            ii(0x1013_d340, 4); cmp(memb[ss, ebp - 4], 0);              /* cmp byte [ebp-0x4], 0x0 */
            ii(0x1013_d344, 2); if(jz(0x1013_d3a1, 0x5b)) goto l_0x1013_d3a1; /* jz 0x1013d3a1 */
            ii(0x1013_d346, 7); mov(memd[ss, ebp - 12], 0x14);          /* mov dword [ebp-0xc], 0x14 */
        l_0x1013_d34d:
            ii(0x1013_d34d, 3); dec(memd[ss, ebp - 12]);                /* dec dword [ebp-0xc] */
            ii(0x1013_d350, 5); cmp(memw[ss, ebp - 12], -1 /* 0xff */); /* cmp word [ebp-0xc], 0xffff */
            ii(0x1013_d355, 2); if(jz(0x1013_d392, 0x3b)) goto l_0x1013_d392; /* jz 0x1013d392 */
            ii(0x1013_d357, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x1013_d35b, 6); imul(eax, eax, 0x91);                   /* imul eax, eax, 0x91 */
            ii(0x1013_d361, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1013_d364, 6); add(edx, 0x251);                        /* add edx, 0x251 */
            ii(0x1013_d36a, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1013_d36c, 3); mov(memd[ss, ebp - 16], edx);           /* mov [ebp-0x10], edx */
            ii(0x1013_d36f, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1013_d372, 6); cmp(memd[ds, eax], 0xffff);             /* cmp dword [eax], 0xffff */
            ii(0x1013_d378, 2); if(jz(0x1013_d383, 9)) goto l_0x1013_d383; /* jz 0x1013d383 */
            ii(0x1013_d37a, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1013_d37d, 4); cmp(memb[ds, eax + 6], 2);              /* cmp byte [eax+0x6], 0x2 */
            ii(0x1013_d381, 2); if(jle(0x1013_d385, 2)) goto l_0x1013_d385; /* jle 0x1013d385 */
        l_0x1013_d383:
            ii(0x1013_d383, 2); jmp(0x1013_d390, 0xb); goto l_0x1013_d390; /* jmp 0x1013d390 */
        l_0x1013_d385:
            ii(0x1013_d385, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x1013_d388, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
        ...
        l_0x1013_d392:
            ii(0x1013_d392, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_d395, 10); mov(memd[ds, eax + 3493], 0);          /* mov dword [eax+0xda5], 0x0 */
        ...
        l_0x1013_d3a1:
            ...
            ii(0x1013_d3bb, 3); mov(al, memb[ds, eax + 44]);            /* mov al, [eax+0x2c] */
            ii(0x1013_d3be, 3); mov(memb[ss, ebp - 20], al);            /* mov [ebp-0x14], al */
            ...
            ii(0x1013_d3d8, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x1013_d3e9, 4); movsx(ebx, memb[ss, ebp - 20]);         /* movsx ebx, byte [ebp-0x14] */
            ...
            ii(0x1013_d3f9, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
