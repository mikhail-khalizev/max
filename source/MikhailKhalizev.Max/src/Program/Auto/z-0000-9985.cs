...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x9989:
            ...
            ii(0x998c, 4);    cmp(memw[cs, di], 0x1);                   /* cmp word [cs:di], 0x1 */
            ii(0x9990, 2);    if(jz(0x9997, 0x5)) goto l_0x9997;        /* jz 0x9997 */
        ...
        l_0x9997:
            ...
            ii(0x99ad, 2);    if(jnz(0x99b4, 0x5)) goto l_0x99b4;       /* jnz 0x99b4 */
        ...
        l_0x99b4:
            ...
            ii(0x99ce, 3);    sub(ax, memw[ds, di - 0x2]);              /* sub ax, [di-0x2] */
            ii(0x99d1, 3);    sub(di, memw[ds, di - 0x4]);              /* sub di, [di-0x4] */
            ii(0x99d4, 1);    push(ss);                                 /* push ss */
            ii(0x99d5, 1);    pop(ds);                                  /* pop ds */
            ii(0x99d6, 2);    or(ax, di);                               /* or ax, di */
            ii(0x99d8, 2);    if(jz(0x99e3, 0x9)) goto l_0x99e3;        /* jz 0x99e3 */
            ii(0x99da, 5);    mov(memw[es, bx], 0x9f9);                 /* mov word [es:bx], 0x9f9 */
            ii(0x99df, 4);    mov(memw[es, bx + 0x2], ds);              /* mov [es:bx+0x2], ds */
        l_0x99e3:
