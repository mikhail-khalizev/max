...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1013_d94b:
            ...
            ii(0x1013_d96b, 7); mov(memd[ss, ebp - 0x14], 1);           /* mov dword [ebp-0x14], 0x1 */
        ...
        l_0x1013_d986:
            ...
            ii(0x1013_d9a9, 4); cmp(memb[ds, eax + 0xa], 3);            /* cmp byte [eax+0xa], 0x3 */
        ...
        l_0x1013_d9cf:
            ii(0x1013_d9cf, 7); mov(memd[ss, ebp - 0x14], 1);           /* mov dword [ebp-0x14], 0x1 */
