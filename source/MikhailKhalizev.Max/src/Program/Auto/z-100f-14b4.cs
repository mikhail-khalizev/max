...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("e83239f8-0667-46b5-9339-732300611cff")]
        public void Method_100f_14b4()
        {
            ii(0x100f_14b4, 5); pushd(0x80);                            /* push 0x80 */
            ii(0x100f_14b9, 5); calld(Definitions.sys_check_available_stack_size, 0x7_4894); /* call 0x10165d52 */
            ...
            ii(0x100f_14e2, 5); calld(Definitions.sys_new, 0x7_4919);   /* call 0x10165e00 */
            ...
            ii(0x100f_1527, 5); calld(0x100d_7bdc, -0x1_9950);          /* call 0x100d7bdc */
        ...
        l_0x100f_153d:
            ...
            ii(0x100f_1551, 5); calld(0x100d_7d74, -0x1_97e2);          /* call 0x100d7d74 */
            ii(0x100f_1556, 5); mov(eax, 0xd);                          /* mov eax, 0xd */
            ii(0x100f_155b, 5); calld(Definitions.sys_new, 0x7_48a0);   /* call 0x10165e00 */
            ...
            ii(0x100f_15a4, 5); calld(0x100d_7bdc, -0x1_99cd);          /* call 0x100d7bdc */
        ...
        l_0x100f_15ba:
            ...
            ii(0x100f_15cf, 5); calld(0x100d_7d74, -0x1_9860);          /* call 0x100d7d74 */
            ii(0x100f_15d4, 5); calld(0x1010_2b60, 0x1_1587);           /* call 0x10102b60 */
            ...
            ii(0x100f_15f8, 5); calld(0x1010_2b60, 0x1_1563);           /* call 0x10102b60 */
            ...
            ii(0x100f_162d, 5); calld(Definitions.sys_new, 0x7_47ce);   /* call 0x10165e00 */
            ...
            ii(0x100f_1659, 5); calld(Definitions.my_ctor_c17, -0x2_324f); /* call 0x100ce40f */
        ...
        l_0x100f_166f:
            ...
            ii(0x100f_1683, 5); calld(0x100d_5134, -0x1_c554);          /* call 0x100d5134 */
            ...
            ii(0x100f_1693, 5); calld(0x100d_5164, -0x1_c534);          /* call 0x100d5164 */
            ...
            ii(0x100f_16a3, 5); calld(0x100d_50d4, -0x1_c5d4);          /* call 0x100d50d4 */
            ...
            ii(0x100f_16b7, 5); calld(0x100c_f85c, -0x2_1e60);          /* call 0x100cf85c */
            ii(0x100f_16bc, 5); calld(0x100d_51e4, -0x1_c4dd);          /* call 0x100d51e4 */
            ii(0x100f_16c1, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x100f_16c3, 2); mov(bl, al);                            /* mov bl, al */
            ii(0x100f_16c5, 5); calld(0x100d_5204, -0x1_c4c6);          /* call 0x100d5204 */
            ...
            ii(0x100f_16d4, 5); calld(0x100c_fa7c, -0x2_1c5d);          /* call 0x100cfa7c */
            ii(0x100f_16d9, 5); mov(eax, 0x5);                          /* mov eax, 0x5 */
            ii(0x100f_16de, 5); calld(/* sys */ 0x1016_a24c, 0x7_8b69); /* call 0x1016a24c */
            ii(0x100f_16e3, 5); mov(eax, 0x38);                         /* mov eax, 0x38 */
            ii(0x100f_16e8, 5); calld(Definitions.sys_new, 0x7_4713);   /* call 0x10165e00 */
            ...
            ii(0x100f_1714, 5); calld(Definitions.my_ctor_c17, -0x2_330a); /* call 0x100ce40f */
        ...
        l_0x100f_172a:
            ...
            ii(0x100f_173e, 5); calld(0x100d_5134, -0x1_c60f);          /* call 0x100d5134 */
            ...
            ii(0x100f_174e, 5); calld(0x100d_5164, -0x1_c5ef);          /* call 0x100d5164 */
            ...
            ii(0x100f_175e, 5); calld(0x100d_50d4, -0x1_c68f);          /* call 0x100d50d4 */
            ii(0x100f_1763, 3); lea(eax, ebp - 0x4c);                   /* lea eax, [ebp-0x4c] */
            ii(0x100f_1766, 5); calld(0x100d_5224, -0x1_c547);          /* call 0x100d5224 */
            ii(0x100f_176b, 1); pushd(eax);                             /* push eax */
            ii(0x100f_176c, 3); lea(eax, ebp - 0x50);                   /* lea eax, [ebp-0x50] */
            ii(0x100f_176f, 5); calld(0x100d_5250, -0x1_c524);          /* call 0x100d5250 */
            ii(0x100f_1774, 1); pushd(eax);                             /* push eax */
            ii(0x100f_1775, 3); lea(eax, ebp - 0x54);                   /* lea eax, [ebp-0x54] */
            ii(0x100f_1778, 5); calld(0x100d_527c, -0x1_c501);          /* call 0x100d527c */
            ii(0x100f_177d, 1); pushd(eax);                             /* push eax */
            ii(0x100f_177e, 3); lea(eax, ebp - 0x58);                   /* lea eax, [ebp-0x58] */
            ii(0x100f_1781, 5); calld(0x100d_52a8, -0x1_c4de);          /* call 0x100d52a8 */
            ii(0x100f_1786, 1); pushd(eax);                             /* push eax */
            ii(0x100f_1787, 5); calld(0x100d_52d4, -0x1_c4b8);          /* call 0x100d52d4 */
            ii(0x100f_178c, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x100f_178f, 5); calld(0x100d_52f8, -0x1_c49c);          /* call 0x100d52f8 */
            ...
            ii(0x100f_17a2, 5); calld(0x100c_ef64, -0x2_2843);          /* call 0x100cef64 */
            ...
            ii(0x100f_17b6, 5); calld(0x100c_f85c, -0x2_1f5f);          /* call 0x100cf85c */
            ii(0x100f_17bb, 5); calld(0x100d_51e4, -0x1_c5dc);          /* call 0x100d51e4 */
            ii(0x100f_17c0, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x100f_17c2, 2); mov(bl, al);                            /* mov bl, al */
            ii(0x100f_17c4, 5); calld(0x100d_5204, -0x1_c5c5);          /* call 0x100d5204 */
            ...
            ii(0x100f_17d3, 5); calld(0x100c_fa7c, -0x2_1d5c);          /* call 0x100cfa7c */
        l_0x100f_17d8:
