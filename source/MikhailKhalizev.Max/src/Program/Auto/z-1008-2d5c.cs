...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_2d5c()
        {
            ...
            ii(0x1008_2d73, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_2d76, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1008_2d79, 4); cmp(memd[ss, ebp - 0x8], 0);            /* cmp dword [ebp-0x8], 0x0 */
            ii(0x1008_2d7d, 2); if(jz(0x1008_2d8e, 0xf)) goto l_0x1008_2d8e; /* jz 0x10082d8e */
            ii(0x1008_2d7f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_2d82, 3); mov(al, memb[ds, eax + 0x54]);          /* mov al, [eax+0x54] */
            ii(0x1008_2d85, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x1008_2d8a, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1008_2d8c, 2); if(jnz(0x1008_2d94, 0x6)) goto l_0x1008_2d94; /* jnz 0x10082d94 */
        l_0x1008_2d8e:
            ii(0x1008_2d8e, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
            ii(0x1008_2d92, 2); jmp(0x1008_2dd7, 0x43); goto l_0x1008_2dd7; /* jmp 0x10082dd7 */
        l_0x1008_2d94:
            ii(0x1008_2d94, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_2d97, 5); call(0x1015_2aa9, 0xc_fd0d);            /* call 0x10152aa9 */
            ii(0x1008_2d9c, 3); sub(eax, 0x3);                          /* sub eax, 0x3 */
            ii(0x1008_2d9f, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1008_2da2, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x1008_2dc1, 4); cmp(ax, memw[ss, ebp - 0x10]);          /* cmp ax, [ebp-0x10] */
            ii(0x1008_2dc5, 2); if(jg(0x1008_2dcd, 0x6)) goto l_0x1008_2dcd; /* jg 0x10082dcd */
            ii(0x1008_2dc7, 4); mov(memb[ss, ebp - 0x18], 0x1);         /* mov byte [ebp-0x18], 0x1 */
            ii(0x1008_2dcb, 2); jmp(0x1008_2dd1, 0x4); goto l_0x1008_2dd1; /* jmp 0x10082dd1 */
        l_0x1008_2dcd:
            ii(0x1008_2dcd, 4); mov(memb[ss, ebp - 0x18], 0);           /* mov byte [ebp-0x18], 0x0 */
        l_0x1008_2dd1:
            ii(0x1008_2dd1, 3); mov(al, memb[ss, ebp - 0x18]);          /* mov al, [ebp-0x18] */
            ii(0x1008_2dd4, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
        l_0x1008_2dd7:
            ii(0x1008_2dd7, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
