...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("2dc233f4-f463-4fca-bee1-132445b487c6")]
        public void Method_1007_6630()
        {
            ii(0x1007_6630, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x1007_6635, 5); calld(Definitions.sys_check_available_stack_size, 0xef718); /* call 0x10165d52 */
            ...
            ii(0x1007_6653, 5); calld(0x1013_ac7d, 0xc4625);            /* call 0x1013ac7d */
            ...
            ii(0x1007_6665, 1); retd(); return;                         /* ret */
        }
    }
}
