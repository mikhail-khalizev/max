...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_f25d()
        {
            ...
            ii(0x100d_f275, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100d_f278, 5); mov(ebx, 0x101b_38d0);                  /* mov ebx, 0x101b38d0 */
            ii(0x100d_f27d, 5); mov(edx, 0x5d);                         /* mov edx, 0x5d */
            ii(0x100d_f282, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100d_f285, 3); add(eax, 8);                            /* add eax, 0x8 */
            ii(0x100d_f288, 5); call(Definitions.sys_call_ctor_arr_v2, 0x8_6ce3); /* call 0x10165f70 */
            ii(0x100d_f28d, 3); sub(eax, 8);                            /* sub eax, 0x8 */
            ii(0x100d_f290, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100d_f293, 3); lea(eax, memd[ss, ebp - 4]);            /* lea eax, [ebp-0x4] */
            ii(0x100d_f296, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x100d_f299, 5); mov(ebx, 0x101b_38d0);                  /* mov ebx, 0x101b38d0 */
            ii(0x100d_f29e, 5); mov(edx, 0x5d);                         /* mov edx, 0x5d */
            ii(0x100d_f2a3, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_f2b5, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100d_f2b8, 3); lea(eax, memd[ss, ebp - 4]);            /* lea eax, [ebp-0x4] */
            ii(0x100d_f2bb, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100d_f2be, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_f2d0, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100d_f2d3, 3); lea(eax, memd[ss, ebp - 4]);            /* lea eax, [ebp-0x4] */
            ii(0x100d_f2d6, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100d_f2d9, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100d_f2dc, 6); mov(memw[ds, eax + 6], 0);              /* mov word [eax+0x6], 0x0 */
            ii(0x100d_f2e2, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100d_f2e5, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x100d_f2e8, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
