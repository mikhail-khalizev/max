...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_bced()
        {
            ...
            ii(0x100d_bd05, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100d_bd08, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_bd0b, 5); call(0x100d_ac00, -0x1110);             /* call 0x100dac00 */
            ii(0x100d_bd10, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_bd13, 3); mov(edx, memd[ds, eax + 0x4d]);         /* mov edx, [eax+0x4d] */
            ii(0x100d_bd16, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_bd19, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_bd1c, 3); mov(eax, memd[ds, eax + 0x49]);         /* mov eax, [eax+0x49] */
            ...
            ii(0x100d_bd3c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_bd3f, 3); mov(eax, memd[ds, eax + 0x49]);         /* mov eax, [eax+0x49] */
