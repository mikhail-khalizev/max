...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_b0f1()
        {
            ...
            ii(0x1007_b109, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_b10c, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_b10e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_b11d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_b120, 4); mov(ax, memw[ds, eax + 0xd]);           /* mov ax, [eax+0xd] */
            ii(0x1007_b124, 5); add(eax, 0xff);                         /* add eax, 0xff */
            ii(0x1007_b129, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_b12c, 2); jmp(0x1007_b160, 0x32); goto l_0x1007_b160; /* jmp 0x1007b160 */
        l_0x1007_b12e:
            ii(0x1007_b12e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_b131, 3); mov(ebx, memd[ds, eax + 0x7]);          /* mov ebx, [eax+0x7] */
            ii(0x1007_b134, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1007_b137, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_b154, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_b157, 4); mov(ax, memw[ds, eax + 0xd]);           /* mov ax, [eax+0xd] */
            ii(0x1007_b15b, 2); add(eax, ebx);                          /* add eax, ebx */
            ii(0x1007_b15d, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x1007_b160:
            ii(0x1007_b160, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
