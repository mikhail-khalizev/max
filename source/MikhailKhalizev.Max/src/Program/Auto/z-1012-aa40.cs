...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("e2dabf12-3277-4adc-8a3f-46d5e0263737")]
        public void Method_1012_aa40()
        {
            ii(0x1012_aa40, 5); pushd(0x1c);                            /* push 0x1c */
            ii(0x1012_aa45, 5); calld(Definitions.sys_check_available_stack_size, 0x3b308); /* call 0x10165d52 */
            ...
            ii(0x1012_aa81, 5); calld(Definitions.sys_strlen, 0x47441); /* call 0x10171ec7 */
            ...
            ii(0x1012_aabf, 5); calld(Definitions.sys_strcat, 0x3b46d); /* call 0x10165f31 */
        ...
        l_0x1012_aace:
            ...
            ii(0x1012_aad4, 1); retd(); return;                         /* ret */
        }
    }
}
