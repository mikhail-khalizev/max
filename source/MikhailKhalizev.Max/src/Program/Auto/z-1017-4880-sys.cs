...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_4880()
        {
            ...
            ii(0x1017_4884, 3); sub(esp, 4);                            /* sub esp, 0x4 */
            ...
            ii(0x1017_48d2, 2); if(jz(0x1017_48d9, 5)) goto l_0x1017_48d9; /* jz 0x101748d9 */
        ...
        l_0x1017_48d9:
            ...
            ii(0x1017_48dc, 3); mov(ch, memb[ds, eax + 2]);             /* mov ch, [eax+0x2] */
            ii(0x1017_48df, 3); test(ch, 0x60);                         /* test ch, 0x60 */
            ii(0x1017_48e2, 2); if(jnz(0x1017_48fe, 0x1a)) goto l_0x1017_48fe; /* jnz 0x101748fe */
            ii(0x1017_48e4, 3); test(ch, 2);                            /* test ch, 0x2 */
            ii(0x1017_48e7, 2); if(jz(0x1017_48fe, 0x15)) goto l_0x1017_48fe; /* jz 0x101748fe */
            ii(0x1017_48e9, 3); test(ch, 0x18);                         /* test ch, 0x18 */
            ii(0x1017_48ec, 2); if(jnz(0x1017_48f6, 8)) goto l_0x1017_48f6; /* jnz 0x101748f6 */
            ii(0x1017_48ee, 3); or(ch, 8);                              /* or ch, 0x8 */
            ii(0x1017_48f1, 3); mov(memb[ds, eax + 2], ch);             /* mov [eax+0x2], ch */
            ii(0x1017_48f4, 2); jmp(0x1017_48fe, 8); goto l_0x1017_48fe; /* jmp 0x101748fe */
        l_0x1017_48f6:
            ii(0x1017_48f6, 2); mov(cl, ch);                            /* mov cl, ch */
            ii(0x1017_48f8, 3); and(cl, 0xe7);                          /* and cl, 0xe7 */
            ii(0x1017_48fb, 3); mov(memb[ds, eax + 2], cl);             /* mov [eax+0x2], cl */
        l_0x1017_48fe:
            ii(0x1017_48fe, 3); mov(eax, memd[ss, esp]);                /* mov eax, [esp] */
            ii(0x1017_4901, 6); test(memw[ds, eax + 2], 0x180);         /* test word [eax+0x2], 0x180 */
            ...
            ii(0x1017_4910, 7); lea(ebx, memd[ds, eax * 4]);            /* lea ebx, [eax*4] */
        ...
        l_0x1017_4925:
            ii(0x1017_4925, 3); mov(dl, memb[ds, eax + 2]);             /* mov dl, [eax+0x2] */
            ...
            ii(0x1017_4934, 7); lea(ebx, memd[ds, eax * 4]);            /* lea ebx, [eax*4] */
        ...
        l_0x1017_4946:
            ...
            ii(0x1017_4952, 7); lea(ebx, memd[ds, eax * 4]);            /* lea ebx, [eax*4] */
        ...
        l_0x1017_4964:
            ...
            ii(0x1017_4970, 7); lea(ebx, memd[ds, eax * 4]);            /* lea ebx, [eax*4] */
        ...
        l_0x1017_4982:
            ...
            ii(0x1017_4989, 7); lea(ebx, memd[ds, eax * 4]);            /* lea ebx, [eax*4] */
        ...
        l_0x1017_4999:
            ...
            ii(0x1017_49aa, 3); lea(ecx, memd[ds, eax + 1]);            /* lea ecx, [eax+0x1] */
        ...
        l_0x1017_49c0:
            ...
            ii(0x1017_49c2, 3); add(esp, 4);                            /* add esp, 0x4 */
