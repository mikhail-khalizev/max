...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_7cee()
        {
            ...
            ii(0x100c_7d04, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100c_7d07, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100c_7d0a, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x100c_7d0d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_7d10, 3); movsx(edx, memw[ds, eax]);              /* movsx edx, word [eax] */
            ii(0x100c_7d13, 3); shl(edx, 0x2);                          /* shl edx, 0x2 */
            ii(0x100c_7d16, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100c_7d19, 3); mov(eax, memd[ds, eax + 0x27]);         /* mov eax, [eax+0x27] */
            ii(0x100c_7d1c, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x100c_7d1e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_7d2a, 3); mov(memd[ss, ebp - 0x10], edx);         /* mov [ebp-0x10], edx */
        l_0x100c_7d2d:
            ii(0x100c_7d2d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_7d30, 4); mov(ax, memw[ds, eax + 0x2]);           /* mov ax, [eax+0x2] */
            ii(0x100c_7d34, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ii(0x100c_7d38, 2); if(jge(0x100c_7d49, 0xf)) goto l_0x100c_7d49; /* jge 0x100c7d49 */
            ii(0x100c_7d3a, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x100c_7d47, 2); if(jnz(0x100c_7d4b, 0x2)) goto l_0x100c_7d4b; /* jnz 0x100c7d4b */
        l_0x100c_7d49:
            ii(0x100c_7d49, 2); jmp(0x100c_7d5a, 0xf); goto l_0x100c_7d5a; /* jmp 0x100c7d5a */
        l_0x100c_7d4b:
            ii(0x100c_7d4b, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100c_7d4e, 3); inc(memd[ss, ebp - 0x10]);              /* inc dword [ebp-0x10] */
            ii(0x100c_7d51, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_7d54, 4); inc(memw[ds, eax + 0x2]);               /* inc word [eax+0x2] */
            ii(0x100c_7d58, 2); jmp(0x100c_7d2d, -0x2d); goto l_0x100c_7d2d; /* jmp 0x100c7d2d */
        l_0x100c_7d5a:
            ii(0x100c_7d5a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_7d5d, 4); mov(ax, memw[ds, eax + 0x2]);           /* mov ax, [eax+0x2] */
            ii(0x100c_7d61, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100c_7d64, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
