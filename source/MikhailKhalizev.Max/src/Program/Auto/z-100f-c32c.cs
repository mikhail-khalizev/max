...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_c32c()
        {
            ...
            ii(0x100f_c344, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100f_c347, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_c34a, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x100f_c34c, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100f_c34f, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x100f_c38b, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x100f_c395, 3); lea(edx, memd[ds, eax + 0x1]);          /* lea edx, [eax+0x1] */
            ...
            ii(0x100f_c3a1, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100f_c3a4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
