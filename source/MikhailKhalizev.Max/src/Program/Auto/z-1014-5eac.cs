...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_5eac()
        {
            ...
            ii(0x1014_5ec1, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1014_5ec4, 3); mov(memd[ss, ebp - 12], edx);           /* mov [ebp-0xc], edx */
            ii(0x1014_5ec7, 3); mov(memd[ss, ebp - 8], ebx);            /* mov [ebp-0x8], ebx */
            ii(0x1014_5eca, 3); mov(memd[ss, ebp - 4], ecx);            /* mov [ebp-0x4], ecx */
            ii(0x1014_5ecd, 3); mov(ebx, memd[ss, ebp - 12]);           /* mov ebx, [ebp-0xc] */
            ii(0x1014_5ed0, 3); lea(edx, memd[ss, ebp - 32]);           /* lea edx, [ebp-0x20] */
            ii(0x1014_5ed3, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1014_5ed6, 5); call(0x1014_630a, 0x42f);               /* call 0x1014630a */
            ii(0x1014_5edb, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_5edd, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
            ...
            ii(0x1014_5ee9, 4); mov(memb[ss, ebp - 20], 0);             /* mov byte [ebp-0x14], 0x0 */
            ii(0x1014_5eed, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_5eef, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
        ...
        l_0x1014_5ef9:
            ii(0x1014_5ef9, 3); mov(ecx, memd[ss, ebp - 4]);            /* mov ecx, [ebp-0x4] */
            ii(0x1014_5efc, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
            ii(0x1014_5eff, 5); call(0x100e_0760, -0x6_57a4);           /* call 0x100e0760 */
            ii(0x1014_5f04, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x1014_5f07, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x1014_5f0a, 3); mov(ebx, memd[ds, eax + 2]);            /* mov ebx, [eax+0x2] */
            ii(0x1014_5f0d, 3); lea(edx, memd[ss, ebp - 28]);           /* lea edx, [ebp-0x1c] */
            ii(0x1014_5f10, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x1014_5f13, 3); call_abs(memd[ds, ebx + 12]);           /* call dword [ebx+0xc] */
            ii(0x1014_5f16, 5); call(Definitions.my_strobj_c_str_v2, -0xb_c753); /* call 0x100897c8 */
            ii(0x1014_5f1b, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1014_5f1d, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1014_5f20, 2); mov(ebx, ecx);                          /* mov ebx, ecx */
            ii(0x1014_5f22, 5); call(0x1014_5996, -0x591);              /* call 0x10145996 */
            ii(0x1014_5f27, 3); mov(memb[ss, ebp - 20], al);            /* mov [ebp-0x14], al */
            ii(0x1014_5f2a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_5f2c, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ii(0x1014_5f2f, 5); call(Definitions.my_string_dtor, -0x440a); /* call 0x10141b2a */
            ii(0x1014_5f34, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_5f36, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
        ...
        //  ii(0x1014_5f42, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
        //  ii(0x1014_5f45, 5); call(0x100e_03bc, -0x6_5b8e);           /* call 0x100e03bc */
        l_0x1014_5f4a:
            ii(0x1014_5f4a, 3); mov(al, memb[ss, ebp - 20]);            /* mov al, [ebp-0x14] */
