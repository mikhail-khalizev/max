...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_bf65()
        {
            ...
            ii(0x1013_bf7c, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_bf7f, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_bf82, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_bf85, 5); call(0x1013_bfc1, 0x37);                /* call 0x1013bfc1 */
            ii(0x1013_bf8a, 5); mov(edx, StringDefinitions.Wb);         /* mov edx, 0x101accf6 */
            ii(0x1013_bf8f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_bf92, 5); call(Definitions.sys_fopen, 0x3_63e3);  /* call 0x1017237a */
            ii(0x1013_bf97, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1013_bf99, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_bf9c, 2); mov(memd[ds, eax], edx);                /* mov [eax], edx */
            ii(0x1013_bf9e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_bfa1, 3); cmp(memd[ds, eax], 0);                  /* cmp dword [eax], 0x0 */
            ii(0x1013_bfa4, 2); if(jz(0x1013_bfac, 0x6)) goto l_0x1013_bfac; /* jz 0x1013bfac */
            ii(0x1013_bfa6, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1013_bfaa, 2); jmp(0x1013_bfb0, 0x4); goto l_0x1013_bfb0; /* jmp 0x1013bfb0 */
        l_0x1013_bfac:
            ii(0x1013_bfac, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
        l_0x1013_bfb0:
            ii(0x1013_bfb0, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
            ii(0x1013_bfb3, 3); mov(memb[ss, ebp - 0x10], al);          /* mov [ebp-0x10], al */
            ii(0x1013_bfb6, 3); mov(al, memb[ss, ebp - 0x10]);          /* mov al, [ebp-0x10] */
