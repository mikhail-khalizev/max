...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_4c5d()
        {
            ...
            ii(0x1019_4c69, 4);  mov(cx, memw[ss, ebp + 8]);           /* mov cx, [ebp+0x8] */
            ii(0x1019_4c6d, 4);  mov(bx, memw[ss, ebp + 10]);          /* mov bx, [ebp+0xa] */
            ii(0x1019_4c71, 4);  mov(di, memw[ss, ebp + 12]);          /* mov di, [ebp+0xc] */
            ii(0x1019_4c75, 4);  mov(si, memw[ss, ebp + 14]);          /* mov si, [ebp+0xe] */
