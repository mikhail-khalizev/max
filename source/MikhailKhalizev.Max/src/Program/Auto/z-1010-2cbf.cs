...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_2cbf()
        {
            ...
            ii(0x1010_2cd6, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1010_2cd9, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1010_2cdc, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1010_2cdf, 5); call(0x1013_a6f4, 0x3_7a10);            /* call 0x1013a6f4 */
            ii(0x1010_2ce4, 3); lea(edx, memd[ss, ebp - 12]);           /* lea edx, [ebp-0xc] */
            ii(0x1010_2ce7, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_2cea, 5); call(0x1013_bb7b, 0x3_8e8c);            /* call 0x1013bb7b */
        l_0x1010_2cef:
            ii(0x1010_2cef, 3); dec(memd[ss, ebp - 12]);                /* dec dword [ebp-0xc] */
            ii(0x1010_2cf2, 5); cmp(memw[ss, ebp - 12], -1 /* 0xff */); /* cmp word [ebp-0xc], 0xffff */
            ii(0x1010_2cf7, 6); if(jz(0x1010_2d87, 0x8a)) goto l_0x1010_2d87; /* jz 0x10102d87 */
            ii(0x1010_2cfd, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_2d00, 5); call(0x1013_bc8c, 0x3_8f87);            /* call 0x1013bc8c */
            ii(0x1010_2d05, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1010_2d08, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x1010_2d0b, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1010_2d0e, 5); call(0x1008_ab1c, -0x7_81f7);           /* call 0x1008ab1c */
            ii(0x1010_2d13, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1010_2d16, 4); test(memb[ds, eax + 19], 0x20);         /* test byte [eax+0x13], 0x20 */
            ...
            ii(0x1010_2d22, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1010_2d25, 3); mov(memd[ds, eax + 34], edx);           /* mov [eax+0x22], edx */
            ii(0x1010_2d28, 2); jmp(0x1010_2d7b, 0x51); goto l_0x1010_2d7b; /* jmp 0x10102d7b */
        l_0x1010_2d2a:
            ii(0x1010_2d2a, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1010_2d2d, 4); test(memb[ds, eax + 19], 0x10);         /* test byte [eax+0x13], 0x10 */
            ...
            ii(0x1010_2d39, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1010_2d3c, 3); mov(memd[ds, eax + 34], edx);           /* mov [eax+0x22], edx */
            ii(0x1010_2d3f, 2); jmp(0x1010_2d7b, 0x3a); goto l_0x1010_2d7b; /* jmp 0x10102d7b */
        l_0x1010_2d41:
            ii(0x1010_2d41, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1010_2d44, 4); test(memb[ds, eax + 19], 8);            /* test byte [eax+0x13], 0x8 */
            ...
            ii(0x1010_2d50, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1010_2d53, 3); mov(memd[ds, eax + 34], edx);           /* mov [eax+0x22], edx */
            ii(0x1010_2d56, 2); jmp(0x1010_2d7b, 0x23); goto l_0x1010_2d7b; /* jmp 0x10102d7b */
        l_0x1010_2d58:
            ii(0x1010_2d58, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1010_2d5b, 4); test(memb[ds, eax + 19], 4);            /* test byte [eax+0x13], 0x4 */
            ...
            ii(0x1010_2d67, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1010_2d6a, 3); mov(memd[ds, eax + 34], edx);           /* mov [eax+0x22], edx */
        ...
        l_0x1010_2d6f:
            ...
            ii(0x1010_2d75, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1010_2d78, 3); mov(memd[ds, eax + 34], edx);           /* mov [eax+0x22], edx */
        l_0x1010_2d7b:
            ii(0x1010_2d7b, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1010_2d7e, 4); mov(memb[ds, eax + 44], 0);             /* mov byte [eax+0x2c], 0x0 */
