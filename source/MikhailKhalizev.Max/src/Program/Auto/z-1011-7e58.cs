...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_7e58()
        {
            ...
            ii(0x1011_7e93, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1011_7e96, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1011_7e99, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1011_7e9c, 10); mov(memd[ds, 0x101b_af9c], 0x1);       /* mov dword [0x101baf9c], 0x1 */
            ...
            ii(0x1011_7ebf, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1011_7ec2, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x1011_7ec5, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1011_7ec8, 10); mov(memd[ds, 0x101b_af9c], 0x2);       /* mov dword [0x101baf9c], 0x2 */
            ...
            ii(0x1011_7eeb, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1011_7eee, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1011_7ef1, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_7ef4, 10); mov(memd[ds, 0x101b_af9c], 0x3);       /* mov dword [0x101baf9c], 0x3 */
            ...
            ii(0x1011_7f9c, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1011_7f9f, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1011_7fa2, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_7fa5, 10); mov(memd[ds, 0x101b_af9c], 0x4);       /* mov dword [0x101baf9c], 0x4 */
