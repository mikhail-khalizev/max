...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_fc73()
        {
            ...
            ii(0x1014_fc8a, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_fc8d, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_fc90, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_fc93, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x1014_fc96, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1014_fc99, 3); imul(eax, eax, 0x33);                   /* imul eax, eax, 0x33 */
            ii(0x1014_fc9c, 7); cmp(memb[ds, eax + 0x101c_81d5], 0x1);  /* cmp byte [eax+0x101c81d5], 0x1 */
            ii(0x1014_fca3, 6); if(jnz(0x1014_fd37, 0x8e)) goto l_0x1014_fd37; /* jnz 0x1014fd37 */
            ii(0x1014_fca9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_fcac, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1014_fcaf, 4); add(memw[ds, edx + 0x52], ax);          /* add [edx+0x52], ax */
            ii(0x1014_fcb3, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_fcb5, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_fcc4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_fcc7, 5); call(0x1007_623c, -0xd_9a90);           /* call 0x1007623c */
            ii(0x1014_fccc, 4); mov(ax, memw[ds, eax + 0x19]);          /* mov ax, [eax+0x19] */
            ii(0x1014_fcd0, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_fcd3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_fce0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_fce3, 4); add(memw[ds, edx + 0x8], ax);           /* add [edx+0x8], ax */
            ii(0x1014_fce7, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_fcea, 4); mov(ax, memw[ds, eax + 0x52]);          /* mov ax, [eax+0x52] */
            ii(0x1014_fcee, 4); cmp(ax, memw[ss, ebp - 0xc]);           /* cmp ax, [ebp-0xc] */
            ii(0x1014_fcf2, 2); if(jle(0x1014_fd37, 0x43)) goto l_0x1014_fd37; /* jle 0x1014fd37 */
            ii(0x1014_fcf4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_fcf7, 4); mov(ax, memw[ds, eax + 0x52]);          /* mov ax, [eax+0x52] */
            ii(0x1014_fcfb, 3); sub(eax, memd[ss, ebp - 0xc]);          /* sub eax, [ebp-0xc] */
            ii(0x1014_fcfe, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_fd01, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1014_fd04, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1014_fd07, 4); mov(memw[ds, edx + 0x52], ax);          /* mov [edx+0x52], ax */
            ii(0x1014_fd0b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_fd18, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_fd1b, 4); sub(memw[ds, edx + 0x8], ax);           /* sub [edx+0x8], ax */
            ii(0x1014_fd1f, 2); xor(ecx, ecx);                          /* xor ecx, ecx */
            ii(0x1014_fd21, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1014_fd23, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x1014_fd27, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
