...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_9ef7()
        {
            ...
            ii(0x9efc, 3);    mov(dx, memw[ss, bp + 0x4]);              /* mov dx, [bp+0x4] */
            ...
            ii(0x9f0b, 5);    push(memw[es, 0x2]);                      /* push word [es:0x2] */
            ...
            ii(0x9f1f, 3);    mov(ax, memw[ss, bp + 0x8]);              /* mov ax, [bp+0x8] */
            ...
            ii(0x9f2e, 3);    mov(bx, memw[ss, bp + 0x6]);              /* mov bx, [bp+0x6] */
