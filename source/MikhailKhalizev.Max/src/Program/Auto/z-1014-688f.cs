...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_688f()
        {
            ...
            ii(0x1014_68a7, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_68aa, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_68ad, 3); cmp(memd[ds, eax], 0);                  /* cmp dword [eax], 0x0 */
            ii(0x1014_68b0, 2); if(jnz(0x1014_68bb, 0x9)) goto l_0x1014_68bb; /* jnz 0x101468bb */
            ii(0x1014_68b2, 7); mov(memd[ss, ebp - 0x8], 0x64);         /* mov dword [ebp-0x8], 0x64 */
            ii(0x1014_68b9, 2); jmp(0x1014_68d6, 0x1b); goto l_0x1014_68d6; /* jmp 0x101468d6 */
        l_0x1014_68bb:
            ii(0x1014_68bb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_68cd, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ii(0x1014_68d0, 3); idiv(memd[ds, ebx + 0x20]);             /* idiv dword [ebx+0x20] */
            ii(0x1014_68d3, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x1014_68d6:
            ii(0x1014_68d6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
