...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_0b74()
        {
            ...
            ii(0x100e_0b8c, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100e_0b8f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_0b92, 3); mov(al, memb[ds, eax + 0xe]);           /* mov al, [eax+0xe] */
            ii(0x100e_0b95, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x100e_0b98, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
