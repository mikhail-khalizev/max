...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_72d4()
        {
            ...
            ii(0x1016_72f6, 3); mov(dl, memb[ds, eax + 0x4]);           /* mov dl, [eax+0x4] */
            ...
            ii(0x1016_7303, 3); mov(memb[ds, eax + 0x4], dh);           /* mov [eax+0x4], dh */
            ...
            ii(0x1016_7311, 3); lea(edx, memd[ds, eax + 0x8]);          /* lea edx, [eax+0x8] */
        ...
        l_0x1016_731b:
            ...
            ii(0x1016_7326, 4); test(memb[ds, esi + 0x4], 0x2);         /* test byte [esi+0x4], 0x2 */
        ...
        l_0x1016_7331:
            ii(0x1016_7331, 4); test(memb[ds, esi + 0x4], 0x4);         /* test byte [esi+0x4], 0x4 */
            ...
            ii(0x1016_733d, 4); test(memb[ds, edx + 0x4], 0x4);         /* test byte [edx+0x4], 0x4 */
        ...
        l_0x1016_7343:
            ...
            ii(0x1016_735c, 2); jmp(0x1016_7365, 0x7); goto l_0x1016_7365; /* jmp 0x10167365 */
        l_0x1016_735e:
            ii(0x1016_735e, 7); lea(eax, memd[ds, ecx * 4 + 0]);        /* lea eax, [ecx*4] */
        l_0x1016_7365:
        ...
        l_0x1016_7369:
            ...
            ii(0x1016_7374, 3); lea(edx, memd[ds, esi + 0x8]);          /* lea edx, [esi+0x8] */
