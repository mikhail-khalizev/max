...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_ba6a()
        {
            ...
            ii(0x1008_baa9, 3); lea(eax, memd[ss, ebp - 48]);           /* lea eax, [ebp-0x30] */
            ...
            ii(0x1008_babf, 3); mov(memd[ss, ebp - 52], edx);           /* mov [ebp-0x34], edx */
            ii(0x1008_bac2, 4); mov(memb[ss, ebp - 12], 0);             /* mov byte [ebp-0xc], 0x0 */
            ii(0x1008_bac6, 4); mov(memb[ss, ebp - 20], 0);             /* mov byte [ebp-0x14], 0x0 */
            ii(0x1008_baca, 4); mov(memb[ss, ebp - 16], 0);             /* mov byte [ebp-0x10], 0x0 */
            ii(0x1008_bace, 3); mov(eax, memd[ss, ebp - 52]);           /* mov eax, [ebp-0x34] */
            ...
            ii(0x1008_bad6, 3); mov(eax, memd[ss, ebp - 40]);           /* mov eax, [ebp-0x28] */
            ii(0x1008_bad9, 3); inc(memd[ss, ebp - 40]);                /* inc dword [ebp-0x28] */
            ii(0x1008_badc, 3); mov(eax, memd[ss, ebp - 36]);           /* mov eax, [ebp-0x24] */
            ii(0x1008_badf, 3); inc(memd[ss, ebp - 36]);                /* inc dword [ebp-0x24] */
        l_0x1008_bae2:
            ii(0x1008_bae2, 4); cmp(memd[ss, ebp - 48], 0);             /* cmp dword [ebp-0x30], 0x0 */
            ii(0x1008_bae6, 2); if(jl(0x1008_baee, 6)) goto l_0x1008_baee; /* jl 0x1008baee */
            ii(0x1008_bae8, 4); cmp(memd[ss, ebp - 44], 0);             /* cmp dword [ebp-0x2c], 0x0 */
        ...
        l_0x1008_baf0:
            ...
            ii(0x1008_baf8, 3); cmp(eax, memd[ss, ebp - 40]);           /* cmp eax, [ebp-0x28] */
        ...
        l_0x1008_baff:
            ...
            ii(0x1008_bb07, 3); cmp(eax, memd[ss, ebp - 36]);           /* cmp eax, [ebp-0x24] */
            ii(0x1008_bb0a, 2); if(jge(0x1008_bb15, 9)) goto l_0x1008_bb15; /* jge 0x1008bb15 */
        l_0x1008_bb0c:
            ii(0x1008_bb0c, 4); mov(memb[ss, ebp - 24], 0);             /* mov byte [ebp-0x18], 0x0 */
            ii(0x1008_bb10, 5); jmp(0x1008_bbe2, 0xcd); goto l_0x1008_bbe2; /* jmp 0x1008bbe2 */
        l_0x1008_bb15:
            ii(0x1008_bb15, 3); mov(eax, memd[ss, ebp - 48]);           /* mov eax, [ebp-0x30] */
            ii(0x1008_bb18, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
            ii(0x1008_bb1b, 2); jmp(0x1008_bb23, 6); goto l_0x1008_bb23; /* jmp 0x1008bb23 */
        l_0x1008_bb1d:
            ii(0x1008_bb1d, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
            ii(0x1008_bb20, 3); inc(memd[ss, ebp - 32]);                /* inc dword [ebp-0x20] */
        l_0x1008_bb23:
            ii(0x1008_bb23, 4); movsx(eax, memw[ss, ebp - 32]);         /* movsx eax, word [ebp-0x20] */
            ii(0x1008_bb27, 3); cmp(eax, memd[ss, ebp - 40]);           /* cmp eax, [ebp-0x28] */
            ii(0x1008_bb2a, 6); if(jge(0x1008_bba1, 0x71)) goto l_0x1008_bba1; /* jge 0x1008bba1 */
            ii(0x1008_bb30, 3); mov(eax, memd[ss, ebp - 44]);           /* mov eax, [ebp-0x2c] */
            ii(0x1008_bb33, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x1008_bb36, 2); jmp(0x1008_bb3e, 6); goto l_0x1008_bb3e; /* jmp 0x1008bb3e */
        l_0x1008_bb38:
            ii(0x1008_bb38, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x1008_bb3b, 3); inc(memd[ss, ebp - 28]);                /* inc dword [ebp-0x1c] */
        l_0x1008_bb3e:
            ii(0x1008_bb3e, 4); movsx(eax, memw[ss, ebp - 28]);         /* movsx eax, word [ebp-0x1c] */
            ii(0x1008_bb42, 3); cmp(eax, memd[ss, ebp - 36]);           /* cmp eax, [ebp-0x24] */
            ii(0x1008_bb45, 2); if(jge(0x1008_bb9c, 0x55)) goto l_0x1008_bb9c; /* jge 0x1008bb9c */
            ii(0x1008_bb47, 4); movsx(edx, memw[ss, ebp - 28]);         /* movsx edx, word [ebp-0x1c] */
            ii(0x1008_bb4b, 4); movsx(eax, memw[ss, ebp - 32]);         /* movsx eax, word [ebp-0x20] */
            ii(0x1008_bb4f, 5); call(0x1007_3d48, -0x1_7e0c);           /* call 0x10073d48 */
            ii(0x1008_bb54, 3); mov(memd[ss, ebp - 56], eax);           /* mov [ebp-0x38], eax */
            ii(0x1008_bb57, 2); jmp(0x1008_bb74, 0x1b); goto l_0x1008_bb74; /* jmp 0x1008bb74 */
        l_0x1008_bb59:
            ii(0x1008_bb59, 4); mov(memb[ss, ebp - 20], 1);             /* mov byte [ebp-0x14], 0x1 */
            ii(0x1008_bb5d, 2); jmp(0x1008_bb9a, 0x3b); goto l_0x1008_bb9a; /* jmp 0x1008bb9a */
        l_0x1008_bb5f:
            ii(0x1008_bb5f, 4); mov(memb[ss, ebp - 12], 1);             /* mov byte [ebp-0xc], 0x1 */
            ii(0x1008_bb63, 2); jmp(0x1008_bb9a, 0x35); goto l_0x1008_bb9a; /* jmp 0x1008bb9a */
        l_0x1008_bb65:
            ii(0x1008_bb65, 4); mov(memb[ss, ebp - 16], 1);             /* mov byte [ebp-0x10], 0x1 */
            ii(0x1008_bb69, 2); jmp(0x1008_bb9a, 0x2f); goto l_0x1008_bb9a; /* jmp 0x1008bb9a */
        l_0x1008_bb6b:
            ii(0x1008_bb6b, 4); mov(memb[ss, ebp - 24], 0);             /* mov byte [ebp-0x18], 0x0 */
            ii(0x1008_bb6f, 5); jmp(0x1008_bbe2, 0x6e); goto l_0x1008_bbe2; /* jmp 0x1008bbe2 */
        l_0x1008_bb74:
            ii(0x1008_bb74, 3); mov(eax, memd[ss, ebp - 56]);           /* mov eax, [ebp-0x38] */
            ii(0x1008_bb77, 3); mov(memd[ss, ebp - 60], eax);           /* mov [ebp-0x3c], eax */
            ii(0x1008_bb7a, 5); cmp(memw[ss, ebp - 60], 2);             /* cmp word [ebp-0x3c], 0x2 */
            ii(0x1008_bb7f, 2); if(jb(0x1008_bb91, 0x10)) goto l_0x1008_bb91; /* jb 0x1008bb91 */
            ii(0x1008_bb81, 5); cmp(memw[ss, ebp - 60], 2);             /* cmp word [ebp-0x3c], 0x2 */
            ii(0x1008_bb86, 2); if(jbe(0x1008_bb5f, -0x29)) goto l_0x1008_bb5f; /* jbe 0x1008bb5f */
            ii(0x1008_bb88, 5); cmp(memw[ss, ebp - 60], 4);             /* cmp word [ebp-0x3c], 0x4 */
        ...
        l_0x1008_bb91:
            ii(0x1008_bb91, 5); cmp(memw[ss, ebp - 60], 1);             /* cmp word [ebp-0x3c], 0x1 */
        ...
        l_0x1008_bba1:
            ii(0x1008_bba1, 3); mov(eax, memd[ss, ebp - 52]);           /* mov eax, [ebp-0x34] */
            ii(0x1008_bba4, 4); test(memb[ds, eax + 20], 1);            /* test byte [eax+0x14], 0x1 */
            ii(0x1008_bba8, 2); if(jnz(0x1008_bbb0, 6)) goto l_0x1008_bbb0; /* jnz 0x1008bbb0 */
            ii(0x1008_bbaa, 4); cmp(memb[ss, ebp - 20], 0);             /* cmp byte [ebp-0x14], 0x0 */
        ...
        l_0x1008_bbb2:
            ii(0x1008_bbb2, 4); mov(memb[ss, ebp - 24], 0);             /* mov byte [ebp-0x18], 0x0 */
            ii(0x1008_bbb6, 2); jmp(0x1008_bbe2, 0x2a); goto l_0x1008_bbe2; /* jmp 0x1008bbe2 */
        l_0x1008_bbb8:
            ii(0x1008_bbb8, 3); mov(eax, memd[ss, ebp - 52]);           /* mov eax, [ebp-0x34] */
            ii(0x1008_bbbb, 4); test(memb[ds, eax + 20], 2);            /* test byte [eax+0x14], 0x2 */
            ii(0x1008_bbbf, 2); if(jnz(0x1008_bbc7, 6)) goto l_0x1008_bbc7; /* jnz 0x1008bbc7 */
            ii(0x1008_bbc1, 4); cmp(memb[ss, ebp - 12], 0);             /* cmp byte [ebp-0xc], 0x0 */
            ii(0x1008_bbc5, 2); if(jnz(0x1008_bbd8, 0x11)) goto l_0x1008_bbd8; /* jnz 0x1008bbd8 */
        l_0x1008_bbc7:
            ii(0x1008_bbc7, 3); mov(eax, memd[ss, ebp - 52]);           /* mov eax, [ebp-0x34] */
            ii(0x1008_bbca, 4); test(memb[ds, eax + 20], 4);            /* test byte [eax+0x14], 0x4 */
            ii(0x1008_bbce, 2); if(jnz(0x1008_bbd6, 6)) goto l_0x1008_bbd6; /* jnz 0x1008bbd6 */
            ii(0x1008_bbd0, 4); cmp(memb[ss, ebp - 16], 0);             /* cmp byte [ebp-0x10], 0x0 */
        ...
        l_0x1008_bbd8:
            ii(0x1008_bbd8, 4); mov(memb[ss, ebp - 24], 2);             /* mov byte [ebp-0x18], 0x2 */
            ii(0x1008_bbdc, 2); jmp(0x1008_bbe2, 4); goto l_0x1008_bbe2; /* jmp 0x1008bbe2 */
        l_0x1008_bbde:
            ii(0x1008_bbde, 4); mov(memb[ss, ebp - 24], 1);             /* mov byte [ebp-0x18], 0x1 */
        l_0x1008_bbe2:
            ii(0x1008_bbe2, 3); mov(al, memb[ss, ebp - 24]);            /* mov al, [ebp-0x18] */
