...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_ba6a()
        {
            ...
            ii(0x1008_ba81, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_ba84, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1008_ba87, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_ba8a, 4); mov(ax, memw[ds, eax + 0x2]);           /* mov ax, [eax+0x2] */
            ii(0x1008_ba8e, 1); inc(eax);                               /* inc eax */
            ii(0x1008_ba8f, 1); cwde();                                 /* cwde */
            ii(0x1008_ba90, 1); push(eax);                              /* push eax */
            ii(0x1008_ba91, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_ba94, 3); mov(ax, memw[ds, eax]);                 /* mov ax, [eax] */
            ii(0x1008_ba97, 1); inc(eax);                               /* inc eax */
            ii(0x1008_ba98, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x1008_ba9b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_ba9e, 2); mov(ebx, memd[ds, eax]);                /* mov ebx, [eax] */
            ii(0x1008_baa0, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1008_baa3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1008_bab1, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
        ...
        l_0x1008_bae2:
            ...
            ii(0x1008_bae6, 2); if(jl(0x1008_baee, 0x6)) goto l_0x1008_baee; /* jl 0x1008baee */
            ii(0x1008_bae8, 4); cmp(memd[ss, ebp - 0x2c], 0);           /* cmp dword [ebp-0x2c], 0x0 */
            ii(0x1008_baec, 2); if(jge(0x1008_baf0, 0x2)) goto l_0x1008_baf0; /* jge 0x1008baf0 */
        l_0x1008_baee:
        ...
        l_0x1008_baf0:
            ...
            ii(0x1008_bafb, 2); if(jge(0x1008_baff, 0x2)) goto l_0x1008_baff; /* jge 0x1008baff */
        l_0x1008_bafd:
        ...
        l_0x1008_baff:
            ...
            ii(0x1008_bb0a, 2); if(jge(0x1008_bb15, 0x9)) goto l_0x1008_bb15; /* jge 0x1008bb15 */
        l_0x1008_bb0c:
        ...
        l_0x1008_bb15:
            ...
            ii(0x1008_bb1b, 2); jmp(0x1008_bb23, 0x6); goto l_0x1008_bb23; /* jmp 0x1008bb23 */
        l_0x1008_bb1d:
        ...
        l_0x1008_bb23:
            ...
            ii(0x1008_bb36, 2); jmp(0x1008_bb3e, 0x6); goto l_0x1008_bb3e; /* jmp 0x1008bb3e */
        l_0x1008_bb38:
        ...
        l_0x1008_bb59:
            ii(0x1008_bb59, 4); mov(memb[ss, ebp - 0x14], 0x1);         /* mov byte [ebp-0x14], 0x1 */
            ii(0x1008_bb5d, 2); jmp(0x1008_bb9a, 0x3b); goto l_0x1008_bb9a; /* jmp 0x1008bb9a */
        l_0x1008_bb5f:
            ii(0x1008_bb5f, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1008_bb63, 2); jmp(0x1008_bb9a, 0x35); goto l_0x1008_bb9a; /* jmp 0x1008bb9a */
        l_0x1008_bb65:
            ii(0x1008_bb65, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
        ...
        l_0x1008_bb74:
            ...
            ii(0x1008_bb7a, 5); cmp(memw[ss, ebp - 0x3c], 0x2);         /* cmp word [ebp-0x3c], 0x2 */
            ii(0x1008_bb7f, 2); if(jb(0x1008_bb91, 0x10)) goto l_0x1008_bb91; /* jb 0x1008bb91 */
            ii(0x1008_bb81, 5); cmp(memw[ss, ebp - 0x3c], 0x2);         /* cmp word [ebp-0x3c], 0x2 */
            ii(0x1008_bb86, 2); if(jbe(0x1008_bb5f, -0x29)) goto l_0x1008_bb5f; /* jbe 0x1008bb5f */
            ii(0x1008_bb88, 5); cmp(memw[ss, ebp - 0x3c], 0x4);         /* cmp word [ebp-0x3c], 0x4 */
        ...
        l_0x1008_bb91:
            ii(0x1008_bb91, 5); cmp(memw[ss, ebp - 0x3c], 0x1);         /* cmp word [ebp-0x3c], 0x1 */
        ...
        l_0x1008_bba1:
            ...
            ii(0x1008_bba4, 4); test(memb[ds, eax + 0x14], 0x1);        /* test byte [eax+0x14], 0x1 */
            ii(0x1008_bba8, 2); if(jnz(0x1008_bbb0, 0x6)) goto l_0x1008_bbb0; /* jnz 0x1008bbb0 */
            ii(0x1008_bbaa, 4); cmp(memb[ss, ebp - 0x14], 0);           /* cmp byte [ebp-0x14], 0x0 */
            ii(0x1008_bbae, 2); if(jnz(0x1008_bbb2, 0x2)) goto l_0x1008_bbb2; /* jnz 0x1008bbb2 */
        l_0x1008_bbb0:
            ii(0x1008_bbb0, 2); jmp(0x1008_bbb8, 0x6); goto l_0x1008_bbb8; /* jmp 0x1008bbb8 */
        l_0x1008_bbb2:
        ...
        l_0x1008_bbb8:
            ...
            ii(0x1008_bbbb, 4); test(memb[ds, eax + 0x14], 0x2);        /* test byte [eax+0x14], 0x2 */
            ii(0x1008_bbbf, 2); if(jnz(0x1008_bbc7, 0x6)) goto l_0x1008_bbc7; /* jnz 0x1008bbc7 */
        ...
        l_0x1008_bbc7:
            ...
            ii(0x1008_bbca, 4); test(memb[ds, eax + 0x14], 0x4);        /* test byte [eax+0x14], 0x4 */
            ii(0x1008_bbce, 2); if(jnz(0x1008_bbd6, 0x6)) goto l_0x1008_bbd6; /* jnz 0x1008bbd6 */
            ii(0x1008_bbd0, 4); cmp(memb[ss, ebp - 0x10], 0);           /* cmp byte [ebp-0x10], 0x0 */
            ii(0x1008_bbd4, 2); if(jnz(0x1008_bbd8, 0x2)) goto l_0x1008_bbd8; /* jnz 0x1008bbd8 */
        l_0x1008_bbd6:
            ii(0x1008_bbd6, 2); jmp(0x1008_bbde, 0x6); goto l_0x1008_bbde; /* jmp 0x1008bbde */
        l_0x1008_bbd8:
            ii(0x1008_bbd8, 4); mov(memb[ss, ebp - 0x18], 0x2);         /* mov byte [ebp-0x18], 0x2 */
            ii(0x1008_bbdc, 2); jmp(0x1008_bbe2, 0x4); goto l_0x1008_bbe2; /* jmp 0x1008bbe2 */
        l_0x1008_bbde:
            ii(0x1008_bbde, 4); mov(memb[ss, ebp - 0x18], 0x1);         /* mov byte [ebp-0x18], 0x1 */
        l_0x1008_bbe2:
