...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_6f04()
        {
            ...
            ii(0x1016_6f0a, 4); mov(memd[ss, esp + 0x14], eax);         /* mov [esp+0x14], eax */
            ii(0x1016_6f0e, 4); mov(memd[ss, esp + 0x4], edx);          /* mov [esp+0x4], edx */
            ii(0x1016_6f12, 4); mov(memd[ss, esp + 0x10], ebx);         /* mov [esp+0x10], ebx */
            ii(0x1016_6f16, 4); mov(memd[ss, esp + 0x1c], ecx);         /* mov [esp+0x1c], ecx */
            ...
            ii(0x1016_6f34, 4); mov(esi, memd[ss, esp + 0x3c]);         /* mov esi, [esp+0x3c] */
            ii(0x1016_6f38, 3); mov(edi, memd[ds, eax + 0x18]);         /* mov edi, [eax+0x18] */
            ii(0x1016_6f3b, 3); imul(esi, edi);                         /* imul esi, edi */
            ii(0x1016_6f3e, 4); mov(ebx, memd[ss, esp + 0x38]);         /* mov ebx, [esp+0x38] */
            ii(0x1016_6f42, 4); mov(ebp, memd[ss, esp + 0x10]);         /* mov ebp, [esp+0x10] */
            ii(0x1016_6f46, 3); mov(eax, memd[ds, eax + 0x2c]);         /* mov eax, [eax+0x2c] */
            ii(0x1016_6f49, 2); xor(ecx, ecx);                          /* xor ecx, ecx */
            ii(0x1016_6f4b, 2); add(eax, ebx);                          /* add eax, ebx */
            ii(0x1016_6f4d, 4); mov(memd[ss, esp + 0x24], ecx);         /* mov [esp+0x24], ecx */
            ...
            ii(0x1016_6f5b, 4); mov(memd[ss, esp + 0x8], eax);          /* mov [esp+0x8], eax */
            ...
            ii(0x1016_6f6a, 4); mov(memd[ss, esp + 0xc], eax);          /* mov [esp+0xc], eax */
            ...
            ii(0x1016_6f79, 4); mov(eax, memd[ss, esp + 0x1c]);         /* mov eax, [esp+0x1c] */
            ii(0x1016_6f7d, 1); dec(eax);                               /* dec eax */
            ii(0x1016_6f7e, 4); mov(memd[ss, esp + 0x18], eax);         /* mov [esp+0x18], eax */
            ii(0x1016_6f82, 2); mov(eax, ebp);                          /* mov eax, ebp */
            ii(0x1016_6f84, 1); inc(eax);                               /* inc eax */
            ii(0x1016_6f85, 3); mov(memd[ss, esp], eax);                /* mov [esp], eax */
            ii(0x1016_6f88, 4); mov(eax, memd[ss, esp + 0x4]);          /* mov eax, [esp+0x4] */
            ii(0x1016_6f8c, 4); mov(memd[ss, esp + 0x20], eax);         /* mov [esp+0x20], eax */
        l_0x1016_6f90:
            ii(0x1016_6f90, 4); mov(eax, memd[ss, esp + 0x20]);         /* mov eax, [esp+0x20] */
            ...
            ii(0x1016_6f9b, 4); mov(ebx, memd[ss, esp + 0x40]);         /* mov ebx, [esp+0x40] */
            ii(0x1016_6f9f, 4); mov(ecx, memd[ss, esp + 0x3c]);         /* mov ecx, [esp+0x3c] */
            ii(0x1016_6fa3, 1); push(ebx);                              /* push ebx */
            ii(0x1016_6fa4, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1016_6fa6, 4); mov(eax, memd[ss, esp + 0x18]);         /* mov eax, [esp+0x18] */
            ii(0x1016_6faa, 1); push(ecx);                              /* push ecx */
            ii(0x1016_6fab, 4); mov(ebx, memd[ss, esp + 0x24]);         /* mov ebx, [esp+0x24] */
            ii(0x1016_6faf, 4); mov(ecx, memd[ss, esp + 0x40]);         /* mov ecx, [esp+0x40] */
        ...
        l_0x1016_6fba:
            ii(0x1016_6fba, 5); cmp(memd[ss, esp + 0x1c], 0);           /* cmp dword [esp+0x1c], 0x0 */
            ...
            ii(0x1016_6fd2, 4); mov(ecx, memd[ss, esp + 0x1c]);         /* mov ecx, [esp+0x1c] */
            ...
            ii(0x1016_6ff6, 4); mov(eax, memd[ss, esp + 0x4]);          /* mov eax, [esp+0x4] */
            ii(0x1016_6ffa, 4); mov(edx, memd[ss, esp + 0x1c]);         /* mov edx, [esp+0x1c] */
        ...
        l_0x1016_700d:
            ii(0x1016_700d, 4); mov(eax, memd[ss, esp + 0x20]);         /* mov eax, [esp+0x20] */
            ii(0x1016_7011, 4); mov(edx, memd[ss, esp + 0x24]);         /* mov edx, [esp+0x24] */
            ii(0x1016_7015, 4); mov(ebx, memd[ss, esp + 0xc]);          /* mov ebx, [esp+0xc] */
            ii(0x1016_7019, 4); mov(ecx, memd[ss, esp + 0x3c]);         /* mov ecx, [esp+0x3c] */
            ii(0x1016_701d, 3); add(eax, 0x4);                          /* add eax, 0x4 */
            ii(0x1016_7020, 1); inc(edx);                               /* inc edx */
            ii(0x1016_7021, 2); add(esi, ebx);                          /* add esi, ebx */
            ii(0x1016_7023, 4); mov(memd[ss, esp + 0x20], eax);         /* mov [esp+0x20], eax */
            ii(0x1016_7027, 4); mov(eax, memd[ss, esp + 0x8]);          /* mov eax, [esp+0x8] */
            ii(0x1016_702b, 4); mov(memd[ss, esp + 0x24], edx);         /* mov [esp+0x24], edx */
            ii(0x1016_702f, 2); add(ecx, eax);                          /* add ecx, eax */
            ii(0x1016_7031, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x1016_7033, 4); mov(edx, memd[ss, esp + 0x10]);         /* mov edx, [esp+0x10] */
            ii(0x1016_7037, 4); mov(memd[ss, esp + 0x3c], ecx);         /* mov [esp+0x3c], ecx */
