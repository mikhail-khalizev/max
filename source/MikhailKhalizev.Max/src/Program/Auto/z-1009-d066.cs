...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_d066()
        {
            ...
            ii(0x1009_d07f, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1009_d082, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1009_d085, 5); mov(ebx, 0x3);                          /* mov ebx, 0x3 */
            ii(0x1009_d08a, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x1009_d0a0, 4); cmp(memb[ds, eax + 0x6], 0);            /* cmp byte [eax+0x6], 0x0 */
            ii(0x1009_d0a4, 2); if(jz(0x1009_d0b5, 0xf)) goto l_0x1009_d0b5; /* jz 0x1009d0b5 */
            ii(0x1009_d0a6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1009_d0b3, 2); if(jnz(0x1009_d0b7, 0x2)) goto l_0x1009_d0b7; /* jnz 0x1009d0b7 */
        l_0x1009_d0b5:
        ...
        l_0x1009_d0b7:
            ...
            ii(0x1009_d0ba, 4); mov(memb[ds, eax + 0x6], 0);            /* mov byte [eax+0x6], 0x0 */
            ...
            ii(0x1009_d0d7, 4); movsx(ecx, memw[ss, ebp - 0x4]);        /* movsx ecx, word [ebp-0x4] */
            ii(0x1009_d0db, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ...
            ii(0x1009_d0f2, 2); jmp(0x1009_d0fa, 0x6); goto l_0x1009_d0fa; /* jmp 0x1009d0fa */
        l_0x1009_d0f4:
