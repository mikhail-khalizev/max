...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_d066()
        {
            ...
            ii(0x1009_d07c, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ...
            ii(0x1009_d08d, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x1009_d09d, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x1009_d0a9, 3); mov(al, memb[ds, eax + 78]);            /* mov al, [eax+0x4e] */
        ...
        l_0x1009_d0b7:
            ii(0x1009_d0b7, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x1009_d0c8, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1009_d0cb, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1009_d0ce, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1009_d0d1, 4); cmp(memd[ss, ebp - 20], 0);             /* cmp dword [ebp-0x14], 0x0 */
            ...
            ii(0x1009_d0de, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x1009_d0e1, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1009_d0e4, 5); call(Definitions.my_ctor_c9, 0x41);     /* call 0x1009d12a */
            ii(0x1009_d0e9, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x1009_d0ec, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x1009_d0ef, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x1009_d0f2, 2); jmp(0x1009_d0fa, 6); goto l_0x1009_d0fa; /* jmp 0x1009d0fa */
        l_0x1009_d0f4:
            ii(0x1009_d0f4, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x1009_d0f7, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
        l_0x1009_d0fa:
            ii(0x1009_d0fa, 3); mov(edx, memd[ss, ebp - 28]);           /* mov edx, [ebp-0x1c] */
            ii(0x1009_d0fd, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
            ii(0x1009_d100, 5); call(0x1008_b060, -0x1_20a5);           /* call 0x1008b060 */
            ii(0x1009_d105, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
            ...
            ii(0x1009_d11b, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
