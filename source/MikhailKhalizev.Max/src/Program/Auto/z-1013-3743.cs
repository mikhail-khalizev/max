...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_3743()
        {
            ...
            ii(0x1013_3759, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1013_375c, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x1013_375f, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1013_3762, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1013_3773, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ...
            ii(0x1013_3782, 3); mov(memd[ss, ebp - 0x10], edx);         /* mov [ebp-0x10], edx */
            ii(0x1013_3785, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x1013_378d, 7); mov(memd[ss, ebp - 0x14], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x1013_3794, 5); jmp(0x1013_38b1, 0x118); goto l_0x1013_38b1; /* jmp 0x101338b1 */
        l_0x1013_3799:
            ii(0x1013_3799, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1013_379d, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1013_37b4, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1013_37b7, 5); call(0x1007_6800, -0xb_cfbc);           /* call 0x10076800 */
            ii(0x1013_37bc, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ii(0x1013_37bf, 3); mov(memb[ss, ebp - 0x18], al);          /* mov [ebp-0x18], al */
            ii(0x1013_37c2, 5); jmp(0x1013_3868, 0xa1); goto l_0x1013_3868; /* jmp 0x10133868 */
        l_0x1013_37c7:
            ii(0x1013_37c7, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1013_37ca, 5); call(0x1007_6730, -0xb_d09f);           /* call 0x10076730 */
            ii(0x1013_37cf, 4); mov(ax, memw[ds, eax + 0xe]);           /* mov ax, [eax+0xe] */
            ii(0x1013_37d3, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1013_37d6, 5); jmp(0x1013_3883, 0xa8); goto l_0x1013_3883; /* jmp 0x10133883 */
        l_0x1013_37db:
            ii(0x1013_37db, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1013_37de, 5); call(0x1007_6730, -0xb_d0b3);           /* call 0x10076730 */
            ii(0x1013_37e3, 4); mov(ax, memw[ds, eax + 0x14]);          /* mov ax, [eax+0x14] */
            ii(0x1013_37e7, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1013_37ea, 5); jmp(0x1013_3883, 0x94); goto l_0x1013_3883; /* jmp 0x10133883 */
        l_0x1013_37ef:
            ii(0x1013_37ef, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1013_37f2, 5); call(0x1007_6730, -0xb_d0c7);           /* call 0x10076730 */
            ii(0x1013_37f7, 4); mov(ax, memw[ds, eax + 0x12]);          /* mov ax, [eax+0x12] */
            ii(0x1013_37fb, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1013_37fe, 5); jmp(0x1013_3883, 0x80); goto l_0x1013_3883; /* jmp 0x10133883 */
        l_0x1013_3803:
            ii(0x1013_3803, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1013_3806, 5); call(0x1007_6730, -0xb_d0db);           /* call 0x10076730 */
            ii(0x1013_380b, 4); mov(ax, memw[ds, eax + 0xc]);           /* mov ax, [eax+0xc] */
            ii(0x1013_380f, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1013_3812, 5); jmp(0x1013_3883, 0x6c); goto l_0x1013_3883; /* jmp 0x10133883 */
        l_0x1013_3817:
            ii(0x1013_3817, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1013_381a, 5); call(0x1007_6730, -0xb_d0ef);           /* call 0x10076730 */
            ii(0x1013_381f, 4); mov(ax, memw[ds, eax + 0xa]);           /* mov ax, [eax+0xa] */
            ii(0x1013_3823, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1013_3826, 2); jmp(0x1013_3883, 0x5b); goto l_0x1013_3883; /* jmp 0x10133883 */
        l_0x1013_3828:
            ii(0x1013_3828, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1013_382b, 5); call(0x1007_6730, -0xb_d100);           /* call 0x10076730 */
            ii(0x1013_3830, 4); mov(ax, memw[ds, eax + 0x10]);          /* mov ax, [eax+0x10] */
            ii(0x1013_3834, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1013_3837, 2); jmp(0x1013_3883, 0x4a); goto l_0x1013_3883; /* jmp 0x10133883 */
        l_0x1013_3839:
            ii(0x1013_3839, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1013_383c, 5); call(0x1007_6730, -0xb_d111);           /* call 0x10076730 */
            ii(0x1013_3841, 4); mov(ax, memw[ds, eax + 0x17]);          /* mov ax, [eax+0x17] */
            ii(0x1013_3845, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
        ...
        l_0x1013_3868:
            ii(0x1013_3868, 3); mov(al, memb[ss, ebp - 0x18]);          /* mov al, [ebp-0x18] */
            ii(0x1013_386b, 3); mov(memb[ss, ebp - 0x24], al);          /* mov [ebp-0x24], al */
            ii(0x1013_386e, 4); cmp(memb[ss, ebp - 0x24], 0x6);         /* cmp byte [ebp-0x24], 0x6 */
            ii(0x1013_3872, 2); if(ja(0x1013_384a, -0x2a)) goto l_0x1013_384a; /* ja 0x1013384a */
            ii(0x1013_3874, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1013_3876, 3); mov(al, memb[ss, ebp - 0x24]);          /* mov al, [ebp-0x24] */
        ...
        l_0x1013_3883:
            ii(0x1013_3883, 4); movsx(edx, memw[ss, ebp - 0x20]);       /* movsx edx, word [ebp-0x20] */
            ii(0x1013_3887, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x1013_3898, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1013_389b, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_389d, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
        ...
        //  ii(0x1013_38a9, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
        //  ii(0x1013_38ac, 5); call(0x1007_5eec, -0xb_d9c5);           /* call 0x10075eec */
        l_0x1013_38b1:
            ii(0x1013_38b1, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
