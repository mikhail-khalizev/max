...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_81a0()
        {
            ...
            ii(0x100b_81b1, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x100b_81b7, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_81ba, 3);  mov(memb[ss, ebp - 4], dl);           /* mov [ebp-0x4], dl */
            ii(0x100b_81bd, 3);  mov(al, memb[ss, ebp - 4]);           /* mov al, [ebp-0x4] */
            ii(0x100b_81c0, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ii(0x100b_81c3, 3);  mov(memb[ds, edx + 30], al);          /* mov [edx+0x1e], al */
