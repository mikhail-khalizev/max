...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_e4a2()
        {
            ...
            ii(0x18_e4ac, 2); push(0x8);                                /* push 0x8 */
            ii(0x18_e4ae, 1); pop(ds);                                  /* pop ds */
            ii(0x18_e4af, 3); mov(dl, memb[ds, bx + 0x4]);              /* mov dl, [bx+0x4] */
            ii(0x18_e4b2, 3); mov(ax, memw[ds, bx + 0x2]);              /* mov ax, [bx+0x2] */
        ...
        l_0x18_e4c6:
            ...
            ii(0x18_e4ca, 4); test(memb[ds, bx - 0x1], 0x2);            /* test byte [bx-0x1], 0x2 */
