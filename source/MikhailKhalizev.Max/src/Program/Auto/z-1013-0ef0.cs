...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_0ef0()
        {
            ...
            ii(0x1013_0f10, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1013_0f13, 7); mov(memb[ds, 0x101b_b48d], 0);          /* mov byte [0x101bb48d], 0x0 */
            ii(0x1013_0f1a, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_0f1d, 5); call(0x1012_f003, -0x1f1f);             /* call 0x1012f003 */
            ii(0x1013_0f22, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_0f25, 4); cmp(memb[ds, eax + 23], 0);             /* cmp byte [eax+0x17], 0x0 */
            ii(0x1013_0f29, 2); if(jz(0x1013_0f34, 9)) goto l_0x1013_0f34; /* jz 0x10130f34 */
            ii(0x1013_0f2b, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_0f2e, 4); cmp(memb[ds, eax + 23], 1);             /* cmp byte [eax+0x17], 0x1 */
            ii(0x1013_0f32, 2); if(jnz(0x1013_0f41, 0xd)) goto l_0x1013_0f41; /* jnz 0x10130f41 */
        l_0x1013_0f34:
            ii(0x1013_0f34, 5); mov(edx, 1);                            /* mov edx, 0x1 */
            ii(0x1013_0f39, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
