...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_ef13()
        {
            ...
            ii(0x1009_ef29, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ...
            ii(0x1009_ef35, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ...
            ii(0x1009_ef49, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1009_ef4c, 5); call(0x1009_cc08, -0x2349);             /* call 0x1009cc08 */
            ii(0x1009_ef51, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1009_ef54, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x1009_ef57, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1009_ef5a, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1009_ef5d, 7); mov(memd[ds, eax + 2], 0x101b_4948);    /* mov dword [eax+0x2], 0x101b4948 */
            ii(0x1009_ef64, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1009_ef67, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x1009_ef6a, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
