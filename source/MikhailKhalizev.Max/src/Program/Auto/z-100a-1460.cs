...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_1460()
        {
            ...
            ii(0x100a_1476, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100a_1479, 3); mov(memd[ss, ebp - 8], edx);            /* mov [ebp-0x8], edx */
            ii(0x100a_147c, 3); mov(memb[ss, ebp - 4], bl);             /* mov [ebp-0x4], bl */
            ii(0x100a_147f, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100a_1482, 5); call(0x1007_6204, -0x2_b283);           /* call 0x10076204 */
            ii(0x100a_1487, 3); mov(ebx, memd[ss, ebp - 12]);           /* mov ebx, [ebp-0xc] */
            ii(0x100a_148a, 3); add(ebx, 2);                            /* add ebx, 0x2 */
            ...
            ii(0x100a_1498, 2); if(jz(0x100a_14a3, 9)) goto l_0x100a_14a3; /* jz 0x100a14a3 */
            ii(0x100a_149a, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100a_149d, 4); cmp(memb[ds, eax + 61], 4);             /* cmp byte [eax+0x3d], 0x4 */
            ii(0x100a_14a1, 2); if(jz(0x100a_14a5, 2)) goto l_0x100a_14a5; /* jz 0x100a14a5 */
        l_0x100a_14a3:
            ii(0x100a_14a3, 2); jmp(0x100a_14ae, 9); goto l_0x100a_14ae; /* jmp 0x100a14ae */
        l_0x100a_14a5:
            ii(0x100a_14a5, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100a_14a8, 4); cmp(memb[ds, eax + 62], 0xd);           /* cmp byte [eax+0x3e], 0xd */
            ii(0x100a_14ac, 2); if(jnz(0x100a_14b0, 2)) goto l_0x100a_14b0; /* jnz 0x100a14b0 */
        l_0x100a_14ae:
            ii(0x100a_14ae, 2); jmp(0x100a_14b9, 9); goto l_0x100a_14b9; /* jmp 0x100a14b9 */
        l_0x100a_14b0:
            ii(0x100a_14b0, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100a_14b3, 4); cmp(memb[ds, eax + 62], 0x2e);          /* cmp byte [eax+0x3e], 0x2e */
            ii(0x100a_14b7, 2); if(jnz(0x100a_14bb, 2)) goto l_0x100a_14bb; /* jnz 0x100a14bb */
        l_0x100a_14b9:
            ii(0x100a_14b9, 2); jmp(0x100a_14c4, 9); goto l_0x100a_14c4; /* jmp 0x100a14c4 */
        l_0x100a_14bb:
            ii(0x100a_14bb, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100a_14be, 4); cmp(memb[ds, eax + 62], 0x1f);          /* cmp byte [eax+0x3e], 0x1f */
            ii(0x100a_14c2, 2); if(jnz(0x100a_14c6, 2)) goto l_0x100a_14c6; /* jnz 0x100a14c6 */
        l_0x100a_14c4:
            ii(0x100a_14c4, 2); jmp(0x100a_14de, 0x18); goto l_0x100a_14de; /* jmp 0x100a14de */
        l_0x100a_14c6:
            ii(0x100a_14c6, 5); mov(edx, 1);                            /* mov edx, 0x1 */
            ii(0x100a_14cb, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100a_14ce, 3); mov(eax, memd[ds, eax + 6]);            /* mov eax, [eax+0x6] */
            ...
            ii(0x100a_14dc, 2); if(jg(0x100a_14e0, 2)) goto l_0x100a_14e0; /* jg 0x100a14e0 */
        l_0x100a_14de:
            ii(0x100a_14de, 2); jmp(0x100a_14f5, 0x15); goto l_0x100a_14f5; /* jmp 0x100a14f5 */
        l_0x100a_14e0:
            ii(0x100a_14e0, 4); cmp(memb[ss, ebp - 4], 0);              /* cmp byte [ebp-0x4], 0x0 */
            ii(0x100a_14e4, 2); if(jnz(0x100a_14f3, 0xd)) goto l_0x100a_14f3; /* jnz 0x100a14f3 */
            ii(0x100a_14e6, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100a_14e9, 3); mov(eax, memd[ds, eax + 42]);           /* mov eax, [eax+0x2a] */
            ii(0x100a_14ec, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100a_14ef, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100a_14f1, 2); if(jge(0x100a_14f5, 2)) goto l_0x100a_14f5; /* jge 0x100a14f5 */
        l_0x100a_14f3:
            ii(0x100a_14f3, 2); jmp(0x100a_14fa, 5); goto l_0x100a_14fa; /* jmp 0x100a14fa */
        l_0x100a_14f5:
            ii(0x100a_14f5, 5); jmp(0x100a_15cc, 0xd2); goto l_0x100a_15cc; /* jmp 0x100a15cc */
        l_0x100a_14fa:
            ii(0x100a_14fa, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ii(0x100a_14fd, 5); call(0x1007_20b1, -0x2_f451);           /* call 0x100720b1 */
            ii(0x100a_1502, 5); mov(ebx, 1);                            /* mov ebx, 0x1 */
            ii(0x100a_1507, 3); lea(edx, memd[ss, ebp - 24]);           /* lea edx, [ebp-0x18] */
            ii(0x100a_150a, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100a_150d, 5); call(0x1007_2388, -0x2_f18a);           /* call 0x10072388 */
            ii(0x100a_1512, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x100a_1516, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100a_1518, 2); if(jge(0x100a_1527, 0xd)) goto l_0x100a_1527; /* jge 0x100a1527 */
            ii(0x100a_151a, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100a_151d, 3); mov(eax, memd[ds, eax + 48]);           /* mov eax, [eax+0x30] */
            ii(0x100a_1520, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100a_1523, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100a_1525, 2); if(jl(0x100a_1529, 2)) goto l_0x100a_1529; /* jl 0x100a1529 */
        l_0x100a_1527:
        ...
        l_0x100a_1529:
            ...
            ii(0x100a_1539, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x100a_153c, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
        ...
        l_0x100a_1546:
            ii(0x100a_1546, 4); cmp(memb[ss, ebp - 4], 0);              /* cmp byte [ebp-0x4], 0x0 */
            ...
            ii(0x100a_155c, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x100a_155f, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
        ...
        l_0x100a_1569:
            ...
            ii(0x100a_1579, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x100a_157c, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100a_157f, 5); call(0x100a_0f77, -0x60d);              /* call 0x100a0f77 */
        l_0x100a_1584:
            ii(0x100a_1584, 3); lea(edx, memd[ss, ebp - 24]);           /* lea edx, [ebp-0x18] */
            ii(0x100a_1587, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100a_158a, 3); add(eax, 0x2a);                         /* add eax, 0x2a */
            ii(0x100a_158d, 5); call(0x100a_13f7, -0x19b);              /* call 0x100a13f7 */
            ii(0x100a_1592, 4); cmp(memb[ss, ebp - 4], 0);              /* cmp byte [ebp-0x4], 0x0 */
            ii(0x100a_1596, 2); if(jz(0x100a_15b1, 0x19)) goto l_0x100a_15b1; /* jz 0x100a15b1 */
            ii(0x100a_1598, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100a_159b, 3); mov(eax, memd[ds, eax + 6]);            /* mov eax, [eax+0x6] */
            ...
            ii(0x100a_15a9, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100a_15ac, 5); call(0x100a_110d, -0x4a4);              /* call 0x100a110d */
        l_0x100a_15b1:
            ii(0x100a_15b1, 5); mov(ebx, 0x2e);                         /* mov ebx, 0x2e */
            ii(0x100a_15b6, 5); mov(edx, 4);                            /* mov edx, 0x4 */
            ii(0x100a_15bb, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100a_15be, 5); call(0x1016_3053, 0xc_1a90);            /* call 0x10163053 */
            ii(0x100a_15c3, 7); mov(memd[ss, ebp - 28], 1);             /* mov dword [ebp-0x1c], 0x1 */
            ii(0x100a_15ca, 2); jmp(0x100a_15d3, 7); goto l_0x100a_15d3; /* jmp 0x100a15d3 */
        l_0x100a_15cc:
            ii(0x100a_15cc, 7); mov(memd[ss, ebp - 28], 0);             /* mov dword [ebp-0x1c], 0x0 */
        l_0x100a_15d3:
            ii(0x100a_15d3, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
