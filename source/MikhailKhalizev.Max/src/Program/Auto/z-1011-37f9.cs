...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_37f9()
        {
            ...
            ii(0x1011_3811, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_3814, 4); mov(memb[ss, ebp - 0x8], 0x4);          /* mov byte [ebp-0x8], 0x4 */
        l_0x1011_3818:
            ii(0x1011_3818, 3); dec(memb[ss, ebp - 0x8]);               /* dec byte [ebp-0x8] */
            ii(0x1011_381b, 4); cmp(memb[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp byte [ebp-0x8], 0xff */
            ii(0x1011_381f, 2); if(jz(0x1011_3877, 0x56)) goto l_0x1011_3877; /* jz 0x10113877 */
            ii(0x1011_3821, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ...
            ii(0x1011_382f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_383e, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ...
            ii(0x1011_3853, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ...
            ii(0x1011_386a, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
        ...
        l_0x1011_3877:
            ii(0x1011_3877, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1011_3894:
            ...
            ii(0x1011_38a6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_38a9, 3); mov(eax, memd[ds, eax + 0x5e]);         /* mov eax, [eax+0x5e] */
            ii(0x1011_38ac, 5); call(0x100c_fb06, -0x4_3dab);           /* call 0x100cfb06 */
        l_0x1011_38b1:
            ii(0x1011_38b1, 4); mov(memb[ss, ebp - 0x8], 0x2);          /* mov byte [ebp-0x8], 0x2 */
            ii(0x1011_38b5, 2); jmp(0x1011_38bd, 0x6); goto l_0x1011_38bd; /* jmp 0x101138bd */
        l_0x1011_38b7:
            ii(0x1011_38b7, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x1011_38ba, 3); inc(memb[ss, ebp - 0x8]);               /* inc byte [ebp-0x8] */
        l_0x1011_38bd:
            ii(0x1011_38bd, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1011_38bf, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x1011_38c2, 3); cmp(eax, 0xe);                          /* cmp eax, 0xe */
            ii(0x1011_38c5, 2); if(jge(0x1011_38e4, 0x1d)) goto l_0x1011_38e4; /* jge 0x101138e4 */
            ii(0x1011_38c7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_38ca, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x1011_38cc, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1011_38ce, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x1011_38d1, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1011_38d4, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
        ...
        l_0x1011_38e4:
            ii(0x1011_38e4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_38e7, 7); mov(memb[ds, eax + 0x3b0], 0);          /* mov byte [eax+0x3b0], 0x0 */
            ii(0x1011_38ee, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_38f1, 7); mov(memb[ds, eax + 0x446], 0);          /* mov byte [eax+0x446], 0x0 */
            ii(0x1011_38f8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
