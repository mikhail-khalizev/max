...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_dc8e()
        {
            ...
            ii(0x18_dc91, 4); mov(si, memw[ss, bx + 0x2]);              /* mov si, [ss:bx+0x2] */
            ...
            ii(0x18_dc9d, 4); mov(bp, memw[ss, bx + 0x4]);              /* mov bp, [ss:bx+0x4] */
            ii(0x18_dca1, 5); cmp(memb[ds, 0x2e], 0);                   /* cmp byte [0x2e], 0x0 */
            ii(0x18_dca6, 2); if(jz(0x18_dcd0, 0x28)) goto l_0x18_dcd0; /* jz 0xdcd0 */
            ii(0x18_dca8, 2); push(0x8);                                /* push 0x8 */
            ii(0x18_dcaa, 1); pop(ds);                                  /* pop ds */
            ii(0x18_dcab, 3); and(si, -0x8 /* 0xf8 */);                 /* and si, 0xfff8 */
        l_0x18_dcae:
            ii(0x18_dcae, 1); lodsw();                                  /* lodsw */
            ii(0x18_dcaf, 3); mov(memw[ss, bp + 0x4], ax);              /* mov [bp+0x4], ax */
            ii(0x18_dcb2, 1); lodsw();                                  /* lodsw */
            ii(0x18_dcb3, 3); mov(memw[ss, bp + 0], ax);                /* mov [bp], ax */
            ii(0x18_dcb6, 1); lodsw();                                  /* lodsw */
            ii(0x18_dcb7, 3); mov(memb[ss, bp + 0x2], al);              /* mov [bp+0x2], al */
            ii(0x18_dcba, 3); mov(memb[ss, bp + 0x8], ah);              /* mov [bp+0x8], ah */
            ii(0x18_dcbd, 1); lodsw();                                  /* lodsw */
            ii(0x18_dcbe, 2); and(al, 0xf0);                            /* and al, 0xf0 */
            ii(0x18_dcc0, 3); mov(memb[ss, bp + 0x9], al);              /* mov [bp+0x9], al */
            ii(0x18_dcc3, 3); mov(memb[ss, bp + 0x3], ah);              /* mov [bp+0x3], ah */
            ii(0x18_dcc6, 5); mov(memw[ss, bp + 0x6], 0);               /* mov word [bp+0x6], 0x0 */
        ...
        l_0x18_dcd0:
            ...
            ii(0x18_dcdc, 4); mov(bx, memw[ss, bx + 0x2]);              /* mov bx, [ss:bx+0x2] */
