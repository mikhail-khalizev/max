...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1019_5761:
            ...
            ii(0x1019_5797, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1019_579a, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1019_579d, 6); push(memd[ds, eax + 0x101c_0288]);      /* push dword [eax+0x101c0288] */
            ii(0x1019_57a3, 4); imul(eax, memd[ss, ebp - 0x8], 0x6);    /* imul eax, [ebp-0x8], 0x6 */
            ...
            ii(0x1019_57bd, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
        l_0x1019_57c4:
            ii(0x1019_57c4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
