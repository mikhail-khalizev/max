...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x6157:
            ...
            ii(0x616e, 4);    mov(edx, memd[ss, bp + 0x6]);             /* mov edx, [bp+0x6] */
            ii(0x6172, 3);    cmp(edi, edx);                            /* cmp edi, edx */
            ii(0x6175, 2);    if(ja(0x617a, 0x3)) goto l_0x617a;        /* ja 0x617a */
        ...
        l_0x617a:
            ...
            ii(0x6186, 4);    and(ecx, memd[ss, bp + 0xa]);             /* and ecx, [bp+0xa] */
            ii(0x618a, 4);    shr(ecx, 0x6);                            /* shr ecx, 0x6 */
            ii(0x618e, 3);    add(edi, esi);                            /* add edi, esi */
            ii(0x6191, 3);    add(ecx, esi);                            /* add ecx, esi */
            ii(0x6194, 4);    mov(memd[ss, bp + 0xa], ecx);             /* mov [bp+0xa], ecx */
            ii(0x6198, 2);    jmp(0x619e, 0x4); goto l_0x619e;          /* jmp 0x619e */
        l_0x619a:
        ...
        l_0x61be:
            ...
            ii(0x61c3, 2);    if(jz(0x61ca, 0x5)) goto l_0x61ca;        /* jz 0x61ca */
        ...
        l_0x61ca:
            ...
            ii(0x61d0, 3);    mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x61d3, 2);    if(jz(0x61db, 0x6)) goto l_0x61db;        /* jz 0x61db */
