...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_7dd4()
        {
            ...
            ii(0x1016_7de0, 2); if(jz(0x1016_7de6, 0x4)) goto l_0x1016_7de6; /* jz 0x10167de6 */
            ii(0x1016_7de2, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1016_7de4, 2); if(jnz(0x1016_7de9, 0x3)) goto l_0x1016_7de9; /* jnz 0x10167de9 */
        l_0x1016_7de6:
            ii(0x1016_7de6, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1016_7de8, 1); ret(); return;                          /* ret */
        l_0x1016_7de9:
            ii(0x1016_7de9, 3); mov(eax, memd[ds, eax + 0x2c]);         /* mov eax, [eax+0x2c] */
