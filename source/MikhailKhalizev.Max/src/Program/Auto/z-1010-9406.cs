...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_9406()
        {
            ...
            ii(0x1010_941e, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_9421, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_942a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_944b, 2); jmp(0x1010_9454, 0x7); goto l_0x1010_9454; /* jmp 0x10109454 */
        l_0x1010_944d:
            ii(0x1010_944d, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
        l_0x1010_9454:
            ii(0x1010_9454, 7); mov(memd[ss, ebp - 0x8], 0xc);          /* mov dword [ebp-0x8], 0xc */
        l_0x1010_945b:
            ii(0x1010_945b, 3); dec(memd[ss, ebp - 0x8]);               /* dec dword [ebp-0x8] */
            ii(0x1010_945e, 5); cmp(memw[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp word [ebp-0x8], 0xffff */
            ii(0x1010_9463, 2); if(jz(0x1010_94a8, 0x43)) goto l_0x1010_94a8; /* jz 0x101094a8 */
            ii(0x1010_9465, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_9469, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_946c, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ...
            ii(0x1010_9475, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_9479, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_947c, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ...
            ii(0x1010_949d, 2); jmp(0x1010_94a6, 0x7); goto l_0x1010_94a6; /* jmp 0x101094a6 */
        l_0x1010_949f:
