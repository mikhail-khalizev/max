...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_9406()
        {
            ...
            ii(0x1010_9424, 4); cmp(memd[ds, eax + 17], 0);             /* cmp dword [eax+0x11], 0x0 */
            ...
            ii(0x1010_942d, 3); mov(eax, memd[ds, eax + 17]);           /* mov eax, [eax+0x11] */
            ii(0x1010_9430, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1010_9433, 4); cmp(memd[ss, ebp - 12], 0);             /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1010_9437, 2); if(jz(0x1010_944d, 0x14)) goto l_0x1010_944d; /* jz 0x1010944d */
            ii(0x1010_9439, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_943b, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x1010_9448, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1010_944b, 2); jmp(0x1010_9454, 7); goto l_0x1010_9454; /* jmp 0x10109454 */
        l_0x1010_944d:
            ii(0x1010_944d, 7); mov(memd[ss, ebp - 16], 0);             /* mov dword [ebp-0x10], 0x0 */
        l_0x1010_9454:
        ...
        l_0x1010_945b:
            ...
            ii(0x1010_946f, 4); cmp(memd[ds, eax + 21], 0);             /* cmp dword [eax+0x15], 0x0 */
            ...
            ii(0x1010_947f, 3); mov(eax, memd[ds, eax + 21]);           /* mov eax, [eax+0x15] */
            ii(0x1010_9482, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1010_9485, 4); cmp(memd[ss, ebp - 20], 0);             /* cmp dword [ebp-0x14], 0x0 */
            ii(0x1010_9489, 2); if(jz(0x1010_949f, 0x14)) goto l_0x1010_949f; /* jz 0x1010949f */
            ii(0x1010_948b, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_948d, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ...
            ii(0x1010_949a, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x1010_949d, 2); jmp(0x1010_94a6, 7); goto l_0x1010_94a6; /* jmp 0x101094a6 */
        l_0x1010_949f:
            ii(0x1010_949f, 7); mov(memd[ss, ebp - 24], 0);             /* mov dword [ebp-0x18], 0x0 */
        l_0x1010_94a6:
