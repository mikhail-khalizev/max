...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_6a20()
        {
            ...
            ii(0x1018_6a23, 1); push(ds);                               /* push ds */
            ...
            ii(0x1018_6a3b, 6); test(memd[ds, edi], 0x1);               /* test dword [edi], 0x1 */
            ii(0x1018_6a41, 2); if(jnz(0x1018_6a62, 0x1f)) goto l_0x1018_6a62; /* jnz 0x10186a62 */
            ii(0x1018_6a43, 3); cmp(edi, memd[ds, ebx + 0xc]);          /* cmp edi, [ebx+0xc] */
            ii(0x1018_6a46, 2); if(jnz(0x1018_6a4b, 0x3)) goto l_0x1018_6a4b; /* jnz 0x10186a4b */
            ii(0x1018_6a48, 3); mov(memd[ds, ebx + 0xc], esi);          /* mov [ebx+0xc], esi */
        l_0x1018_6a4b:
            ...
            ii(0x1018_6a50, 3); mov(ebx, memd[ds, edi + 0x4]);          /* mov ebx, [edi+0x4] */
            ii(0x1018_6a53, 3); mov(edi, memd[ds, edi + 0x8]);          /* mov edi, [edi+0x8] */
            ii(0x1018_6a56, 3); mov(memd[ds, ebx + 0x8], edi);          /* mov [ebx+0x8], edi */
            ii(0x1018_6a59, 3); mov(memd[ds, edi + 0x4], ebx);          /* mov [edi+0x4], ebx */
            ii(0x1018_6a5c, 1); pop(ebx);                               /* pop ebx */
            ii(0x1018_6a5d, 3); dec(memd[ds, ebx + 0x1c]);              /* dec dword [ebx+0x1c] */
            ii(0x1018_6a60, 2); jmp(0x1018_6ade, 0x7c); goto l_0x1018_6ade; /* jmp 0x10186ade */
        l_0x1018_6a62:
            ii(0x1018_6a62, 2); mov(memd[ds, esi], eax);                /* mov [esi], eax */
            ii(0x1018_6a64, 3); mov(edi, memd[ds, ebx + 0xc]);          /* mov edi, [ebx+0xc] */
            ii(0x1018_6a67, 2); cmp(esi, edi);                          /* cmp esi, edi */
            ii(0x1018_6a69, 2); if(jae(0x1018_6a79, 0xe)) goto l_0x1018_6a79; /* jae 0x10186a79 */
            ii(0x1018_6a6b, 3); cmp(esi, memd[ds, edi + 0x4]);          /* cmp esi, [edi+0x4] */
            ii(0x1018_6a6e, 2); if(ja(0x1018_6ade, 0x6e)) goto l_0x1018_6ade; /* ja 0x10186ade */
            ii(0x1018_6a70, 3); mov(edi, memd[ds, ebx + 0x28]);         /* mov edi, [ebx+0x28] */
        ...
        l_0x1018_6a79:
            ii(0x1018_6a79, 3); mov(edi, memd[ds, edi + 0x8]);          /* mov edi, [edi+0x8] */
            ii(0x1018_6a7c, 2); cmp(esi, edi);                          /* cmp esi, edi */
            ii(0x1018_6a7e, 2); if(jb(0x1018_6ade, 0x5e)) goto l_0x1018_6ade; /* jb 0x10186ade */
            ii(0x1018_6a80, 3); lea(edi, memd[ds, ebx + 0x20]);         /* lea edi, [ebx+0x20] */
            ii(0x1018_6a83, 3); cmp(esi, memd[ds, ebx + 0x24]);         /* cmp esi, [ebx+0x24] */
            ii(0x1018_6a86, 2); if(ja(0x1018_6ade, 0x56)) goto l_0x1018_6ade; /* ja 0x10186ade */
        l_0x1018_6a88:
            ii(0x1018_6a88, 2); sub(edx, edx);                          /* sub edx, edx */
            ii(0x1018_6a8a, 3); mov(eax, memd[ds, ebx + 0x18]);         /* mov eax, [ebx+0x18] */
            ii(0x1018_6a8d, 3); mov(ecx, memd[ds, ebx + 0x1c]);         /* mov ecx, [ebx+0x1c] */
            ...
            ii(0x1018_6a98, 3); mov(edx, memd[ds, ebx + 0x18]);         /* mov edx, [ebx+0x18] */
            ii(0x1018_6a9b, 2); sub(edx, ecx);                          /* sub edx, ecx */
            ii(0x1018_6a9d, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x1018_6a9f, 2); cmp(edx, ecx);                          /* cmp edx, ecx */
            ii(0x1018_6aa1, 2); if(ja(0x1018_6aa5, 0x2)) goto l_0x1018_6aa5; /* ja 0x10186aa5 */
        ...
        l_0x1018_6aa9:
            ...
            ii(0x1018_6ab3, 2); if(jz(0x1018_6abd, 0x8)) goto l_0x1018_6abd; /* jz 0x10186abd */
        ...
        l_0x1018_6abd:
            ii(0x1018_6abd, 3); mov(edi, memd[ds, ebx + 0xc]);          /* mov edi, [ebx+0xc] */
            ii(0x1018_6ac0, 2); cmp(esi, edi);                          /* cmp esi, edi */
            ii(0x1018_6ac2, 2); if(jae(0x1018_6ac7, 0x3)) goto l_0x1018_6ac7; /* jae 0x10186ac7 */
            ii(0x1018_6ac4, 3); mov(edi, memd[ds, ebx + 0x28]);         /* mov edi, [ebx+0x28] */
        l_0x1018_6ac7:
            ii(0x1018_6ac7, 2); cmp(esi, edi);                          /* cmp esi, edi */
            ii(0x1018_6ac9, 2); if(jb(0x1018_6ade, 0x13)) goto l_0x1018_6ade; /* jb 0x10186ade */
            ii(0x1018_6acb, 3); mov(edi, memd[ds, edi + 0x8]);          /* mov edi, [edi+0x8] */
            ii(0x1018_6ace, 2); cmp(esi, edi);                          /* cmp esi, edi */
            ii(0x1018_6ad0, 2); if(jb(0x1018_6ade, 0xc)) goto l_0x1018_6ade; /* jb 0x10186ade */
            ii(0x1018_6ad2, 3); mov(edi, memd[ds, edi + 0x8]);          /* mov edi, [edi+0x8] */
            ii(0x1018_6ad5, 2); cmp(esi, edi);                          /* cmp esi, edi */
            ii(0x1018_6ad7, 2); if(jb(0x1018_6ade, 0x5)) goto l_0x1018_6ade; /* jb 0x10186ade */
            ii(0x1018_6ad9, 3); mov(edi, memd[ds, edi + 0x8]);          /* mov edi, [edi+0x8] */
            ii(0x1018_6adc, 2); jmp(0x1018_6ac7, -0x17); goto l_0x1018_6ac7; /* jmp 0x10186ac7 */
        l_0x1018_6ade:
            ii(0x1018_6ade, 3); mov(edx, memd[ds, edi + 0x4]);          /* mov edx, [edi+0x4] */
            ...
            ii(0x1018_6af1, 3); cmp(esi, memd[ds, ebx + 0xc]);          /* cmp esi, [ebx+0xc] */
            ii(0x1018_6af4, 2); if(jnz(0x1018_6af9, 0x3)) goto l_0x1018_6af9; /* jnz 0x10186af9 */
            ii(0x1018_6af6, 3); mov(memd[ds, ebx + 0xc], edi);          /* mov [ebx+0xc], edi */
        l_0x1018_6af9:
            ii(0x1018_6af9, 2); mov(esi, edi);                          /* mov esi, edi */
            ii(0x1018_6afb, 2); jmp(0x1018_6b0e, 0x11); goto l_0x1018_6b0e; /* jmp 0x10186b0e */
        l_0x1018_6afd:
            ii(0x1018_6afd, 3); inc(memd[ds, ebx + 0x1c]);              /* inc dword [ebx+0x1c] */
            ii(0x1018_6b00, 3); mov(memd[ds, esi + 0x8], edx);          /* mov [esi+0x8], edx */
            ii(0x1018_6b03, 3); mov(memd[ds, esi + 0x4], edi);          /* mov [esi+0x4], edi */
            ii(0x1018_6b06, 3); mov(memd[ds, edi + 0x8], esi);          /* mov [edi+0x8], esi */
            ii(0x1018_6b09, 2); mov(edi, edx);                          /* mov edi, edx */
            ii(0x1018_6b0b, 3); mov(memd[ds, edi + 0x4], esi);          /* mov [edi+0x4], esi */
        l_0x1018_6b0e:
            ii(0x1018_6b0e, 3); dec(memd[ds, ebx + 0x18]);              /* dec dword [ebx+0x18] */
            ii(0x1018_6b11, 3); cmp(esi, memd[ds, ebx + 0xc]);          /* cmp esi, [ebx+0xc] */
            ii(0x1018_6b14, 2); if(jae(0x1018_6b1e, 0x8)) goto l_0x1018_6b1e; /* jae 0x10186b1e */
            ii(0x1018_6b16, 3); cmp(ecx, memd[ds, ebx + 0x10]);         /* cmp ecx, [ebx+0x10] */
            ii(0x1018_6b19, 2); if(jbe(0x1018_6b1e, 0x3)) goto l_0x1018_6b1e; /* jbe 0x10186b1e */
            ii(0x1018_6b1b, 3); mov(memd[ds, ebx + 0x10], ecx);         /* mov [ebx+0x10], ecx */
        l_0x1018_6b1e:
            ii(0x1018_6b1e, 3); cmp(ecx, memd[ds, ebx + 0x14]);         /* cmp ecx, [ebx+0x14] */
            ii(0x1018_6b21, 2); if(jbe_func(0x1018_6b26, 0x3)) return;  /* jbe 0x10186b26 */
            ii(0x1018_6b23, 3); mov(memd[ds, ebx + 0x14], ecx);         /* mov [ebx+0x14], ecx */
        }
    }
}
