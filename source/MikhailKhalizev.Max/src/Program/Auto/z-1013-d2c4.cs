...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_d2c4()
        {
            ...
            ii(0x1013_d2d5, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1013_d2db, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1013_d2de, 3); mov(memb[ss, ebp - 4], dl);             /* mov [ebp-0x4], dl */
            ii(0x1013_d2e1, 4); cmp(memb[ss, ebp - 4], 0);              /* cmp byte [ebp-0x4], 0x0 */
            ii(0x1013_d2e5, 2); if(jz(0x1013_d2ff, 0x18)) goto l_0x1013_d2ff; /* jz 0x1013d2ff */
            ii(0x1013_d2e7, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_d2ea, 4); mov(dx, memw[ds, eax + 12]);            /* mov dx, [eax+0xc] */
            ii(0x1013_d2ee, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_d2f1, 4); mov(memw[ds, eax + 14], dx);            /* mov [eax+0xe], dx */
            ii(0x1013_d2f5, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
        ...
        l_0x1013_d2ff:
            ii(0x1013_d2ff, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_d302, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1013_d304, 6); mov(bl, memb[ds, eax + 3529]);          /* mov bl, [eax+0xdc9] */
            ii(0x1013_d30a, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_d30d, 3); mov(edx, memd[ds, eax + 12]);           /* mov edx, [eax+0xc] */
            ii(0x1013_d310, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1013_d313, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
