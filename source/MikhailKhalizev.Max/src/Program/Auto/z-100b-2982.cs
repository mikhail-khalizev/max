...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_2982()
        {
            ...
            ii(0x100b_299b, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100b_299e, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x100b_29a1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_29ad, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_29bb, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ...
            ii(0x100b_29c6, 2); if(jz(0x100b_29ca, 0x2)) goto l_0x100b_29ca; /* jz 0x100b29ca */
        l_0x100b_29c8:
            ii(0x100b_29c8, 2); jmp(0x100b_29dc, 0x12); goto l_0x100b_29dc; /* jmp 0x100b29dc */
        l_0x100b_29ca:
            ii(0x100b_29ca, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x100b_29cf, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100b_29dc:
            ...
            ii(0x100b_29e1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_29e4, 5); call(0x100a_297d, -0x1_006c);           /* call 0x100a297d */
            ii(0x100b_29e9, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_29eb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
