...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1016_9dc9:
            ...
            ii(0x1016_9dce, 3); mov(ebx, memd[ds, esi + 0x48]);         /* mov ebx, [esi+0x48] */
            ii(0x1016_9dd1, 2); xor(ecx, ecx);                          /* xor ecx, ecx */
            ii(0x1016_9dd3, 5); call(/* sys */ 0x1016_9b90, -0x248);    /* call 0x10169b90 */
            ii(0x1016_9dd8, 3); mov(esi, memd[ds, esi + 0x6c]);         /* mov esi, [esi+0x6c] */
        l_0x1016_9ddb:
