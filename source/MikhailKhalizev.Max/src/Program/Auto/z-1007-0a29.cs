...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_0a29()
        {
            ...
            ii(0x1007_0a87, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1007_0a8a, 7); mov(memd[ss, ebp - 0x4], 0x4);          /* mov dword [ebp-0x4], 0x4 */
        l_0x1007_0a91:
            ii(0x1007_0a91, 3); dec(memd[ss, ebp - 0x4]);               /* dec dword [ebp-0x4] */
            ii(0x1007_0a94, 5); cmp(memw[ss, ebp - 0x4], -0x1 /* 0xff */); /* cmp word [ebp-0x4], 0xffff */
            ii(0x1007_0a99, 2); if(jz(0x1007_0b08, 0x6d)) goto l_0x1007_0b08; /* jz 0x10070b08 */
            ii(0x1007_0a9b, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1007_0ab4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_0ab7, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_0ab9, 4); movsx(ebx, memw[ss, ebp - 0x4]);        /* movsx ebx, word [ebp-0x4] */
            ...
            ii(0x1007_0ad2, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ii(0x1007_0ad5, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_0ad7, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1007_0aec, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ii(0x1007_0aef, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_0af1, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
