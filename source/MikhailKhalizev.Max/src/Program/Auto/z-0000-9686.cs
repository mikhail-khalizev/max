...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_9686()
        {
            ...
            ii(0x968a, 5);    cmp(memw[ds, 0xa12], 0x1);                /* cmp word [0xa12], 0x1 */
            ii(0x968f, 2);    if(jl(0x9694, 0x3)) goto l_0x9694;        /* jl 0x9694 */
            ii(0x9691, 3);    jmp(0x9730, 0x9c); goto l_0x9730;         /* jmp 0x9730 */
        l_0x9694:
            ii(0x9694, 2);    sub(ax, ax);                              /* sub ax, ax */
            ii(0x9696, 3);    mov(memw[ss, bp - 0x10], ax);             /* mov [bp-0x10], ax */
            ii(0x9699, 3);    mov(memw[ss, bp - 0x12], ax);             /* mov [bp-0x12], ax */
            ...
            ii(0x96a9, 5);    mov(memw[ss, bp - 0xe], 0xbfde);          /* mov word [bp-0xe], 0xbfde */
            ii(0x96ae, 5);    mov(memw[ss, bp - 0xc], 0x2);             /* mov word [bp-0xc], 0x2 */
            ii(0x96b3, 2);    sub(ax, ax);                              /* sub ax, ax */
            ii(0x96b5, 3);    mov(memw[ss, bp - 0xa], ax);              /* mov [bp-0xa], ax */
            ii(0x96b8, 3);    mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x96bb, 3);    lea(ax, memw[ss, bp - 0xe]);              /* lea ax, [bp-0xe] */
        ...
        l_0x96ca:
            ii(0x96ca, 3);    mov(ax, memw[ss, bp - 0x10]);             /* mov ax, [bp-0x10] */
            ii(0x96cd, 3);    or(ax, memw[ss, bp - 0x12]);              /* or ax, [bp-0x12] */
            ii(0x96d0, 2);    if(jnz(0x9718, 0x46)) goto l_0x9718;      /* jnz 0x9718 */
            ii(0x96d2, 3);    call(0x5cc4, -0x3a11);                    /* call 0x5cc4 */
            ii(0x96d5, 3);    mov(memw[ss, bp - 0x14], ax);             /* mov [bp-0x14], ax */
            ii(0x96d8, 3);    call(0x572a, -0x3fb1);                    /* call 0x572a */
            ii(0x96db, 3);    mov(ax, memw[ss, bp - 0x14]);             /* mov ax, [bp-0x14] */
            ...
            ii(0x96e9, 3);    mov(memw[ss, bp - 0x12], ax);             /* mov [bp-0x12], ax */
            ii(0x96ec, 3);    mov(memw[ss, bp - 0x10], dx);             /* mov [bp-0x10], dx */
            ii(0x96ef, 2);    or(dx, ax);                               /* or dx, ax */
            ii(0x96f1, 2);    if(jz(0x9715, 0x22)) goto l_0x9715;       /* jz 0x9715 */
            ii(0x96f3, 3);    push(0x92);                               /* push 0x92 */
            ii(0x96f6, 2);    push(-0x1 /* 0xff */);                    /* push 0xffff */
            ii(0x96f8, 3);    push(memw[ss, bp - 0x10]);                /* push word [bp-0x10] */
            ...
            ii(0x9704, 3);    push(memw[ss, bp - 0x14]);                /* push word [bp-0x14] */
        ...
        l_0x9718:
            ii(0x9718, 3);    mov(ax, memw[ss, bp - 0x10]);             /* mov ax, [bp-0x10] */
            ii(0x971b, 3);    or(ax, memw[ss, bp - 0x12]);              /* or ax, [bp-0x12] */
            ii(0x971e, 2);    if(jz(0x9730, 0x10)) goto l_0x9730;       /* jz 0x9730 */
            ii(0x9720, 3);    mov(ax, memw[ss, bp - 0x12]);             /* mov ax, [bp-0x12] */
            ii(0x9723, 3);    mov(dx, memw[ss, bp - 0x10]);             /* mov dx, [bp-0x10] */
