...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
        l_0x18_e0ba:
            ii(0x18_e0ba, 4); mov(cx, memw[ds, 0x8]);                   /* mov cx, [0x8] */
            ii(0x18_e0be, 4); mov(bx, memw[ds, 0x2]);                   /* mov bx, [0x2] */
            ii(0x18_e0c2, 3); shl(bx, 0x3);                             /* shl bx, 0x3 */
            ii(0x18_e0c5, 6); test(memb[es, 0x14], 0x80);               /* test byte [es:0x14], 0x80 */
            ii(0x18_e0cb, 2); if(jz(0x18_e0d2, 0x5)) goto l_0x18_e0d2;  /* jz 0xe0d2 */
        ...
        l_0x18_e0e0:
            ...
            ii(0x18_e0e5, 2); if(loopne(0x18_e0e0, -0x7)) goto l_0x18_e0e0; /* loopne 0xe0e0 */
        ...
        l_0x18_e0f9:
            ...
            ii(0x18_e103, 3); xchg(memw[ds, bx + 0x4], ax);             /* xchg [bx+0x4], ax */
            ...
            ii(0x18_e10e, 3); mov(memw[ds, bx + 0x2], ax);              /* mov [bx+0x2], ax */
            ii(0x18_e111, 3); mov(memw[ds, bx + 0x6], ax);              /* mov [bx+0x6], ax */
            ii(0x18_e114, 1); dec(dx);                                  /* dec dx */
            ii(0x18_e115, 2); if(jz(0x18_e11c, 0x5)) goto l_0x18_e11c;  /* jz 0xe11c */
        ...
        l_0x18_e121:
            ii(0x18_e121, 3); mov(memw[ds, bx + 0x4], ax);              /* mov [bx+0x4], ax */
            ii(0x18_e124, 3); add(bx, 0x8);                             /* add bx, 0x8 */
            ii(0x18_e127, 2); cmp(dx, si);                              /* cmp dx, si */
            ii(0x18_e129, 2); if(jz(0x18_e130, 0x5)) goto l_0x18_e130;  /* jz 0xe130 */
        ...
        l_0x18_e13d:
            ...
            ii(0x18_e148, 2); if(jb_func(0x18_e14d, 0x3)) return;       /* jb 0xe14d */
