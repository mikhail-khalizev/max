...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_8e98()
        {
            ...
            ii(0x1010_8eb0, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_8eb3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_8eb6, 4); mov(dx, memw[ds, eax + 0xb]);           /* mov dx, [eax+0xb] */
            ii(0x1010_8eba, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_8ebd, 4); mov(memw[ds, eax + 0x9], dx);           /* mov [eax+0x9], dx */
            ii(0x1010_8ec1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_8ec4, 7); mov(memd[ds, eax + 0x4], 0x1);          /* mov dword [eax+0x4], 0x1 */
