...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_b37b()
        {
            ...
            ii(0x1012_b391, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1012_b394, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x1012_b397, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1012_b39a, 7); mov(memb[ds, 0x101c_5c1c], 0x2d);       /* mov byte [0x101c5c1c], 0x2d */
            ii(0x1012_b3a1, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_b3a4, 6); mov(memw[ds, 0x101c_5c1d], ax);         /* mov [0x101c5c1d], ax */
            ii(0x1012_b3aa, 9); mov(memw[ds, 0x101c_5c1f], 0x3);        /* mov word [0x101c5c1f], 0x3 */
            ii(0x1012_b3b3, 7); mov(memd[ss, ebp - 0x10], 0x101c_5c21); /* mov dword [ebp-0x10], 0x101c5c21 */
            ii(0x1012_b3ba, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ii(0x1012_b3bd, 3); mov(edx, memd[ss, ebp - 0x10]);         /* mov edx, [ebp-0x10] */
            ii(0x1012_b3c0, 2); mov(memb[ds, edx], al);                 /* mov [edx], al */
            ii(0x1012_b3c2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_b3c5, 3); mov(edx, memd[ss, ebp - 0x10]);         /* mov edx, [ebp-0x10] */
            ii(0x1012_b3c8, 4); mov(memw[ds, edx + 0x1], ax);           /* mov [edx+0x1], ax */
