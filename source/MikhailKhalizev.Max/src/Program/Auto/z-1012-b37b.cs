...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("1b5460cb-864e-4920-8943-cbdd9833eab7")]
        public void Method_1012_b37b()
        {
            ii(0x1012_b37b, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x1012_b380, 5); calld(Definitions.sys_check_available_stack_size, 0x3a9cd); /* call 0x10165d52 */
            ...
            ii(0x1012_b3dc, 1); retd(); return;                         /* ret */
        }
    }
}
