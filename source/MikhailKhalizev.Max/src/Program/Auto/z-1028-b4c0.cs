...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x1028_b4c0, 1); push(ds);                               /* push ds */
            ii(0x1028_b4c1, 8); mov(memw[fs, 0x1537], fs);              /* mov [fs:0x1537], fs */
            ii(0x1028_b4c9, 2); push(fs);                               /* push fs */
            ii(0x1028_b4cb, 1); pop(ds);                                /* pop ds */
            ii(0x1028_b4cc, 1); push(ebx);                              /* push ebx */
            ii(0x1028_b4cd, 4); mov(ebx, memd[ss, esp + 0xc]);          /* mov ebx, [esp+0xc] */
            ...
            ii(0x1028_b4ec, 1); pop(ds);                                /* pop ds */
