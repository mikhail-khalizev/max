...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_cbd2()
        {
            ...
            ii(0x100c_cbf9, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x100c_cbfc, 5);  call(0x1007_64b8, -0x5_6749);         /* call 0x100764b8 */
            ii(0x100c_cc01, 7);  mov(memd[ss, ebp - 12], 0);           /* mov dword [ebp-0xc], 0x0 */
            ...
            ii(0x100c_cc18, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x100c_cc27:
            ii(0x100c_cc27, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x100c_cc2a, 5);  call(0x1007_6bf8, -0x5_6037);         /* call 0x10076bf8 */
        l_0x100c_cc2f:
            ii(0x100c_cc2f, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100c_cc31, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x100c_cc41, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x100c_cc44, 5);  call(0x1007_63a0, -0x5_68a9);         /* call 0x100763a0 */
            ii(0x100c_cc49, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100c_cc4b, 3);  mov(dl, memb[ds, eax + 38]);          /* mov dl, [eax+0x26] */
            ...
            ii(0x100c_cc5b, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x100c_cc6c:
            ii(0x100c_cc6c, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x100c_cc6f, 5);  call(0x1007_63a0, -0x5_68d4);         /* call 0x100763a0 */
            ii(0x100c_cc74, 3);  mov(al, memb[ds, eax + 77]);          /* mov al, [eax+0x4d] */
        ...
        l_0x100c_cc82:
            ii(0x100c_cc82, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x100c_cc85, 5);  call(0x1007_63a0, -0x5_68ea);         /* call 0x100763a0 */
            ii(0x100c_cc8a, 4);  cmp(memb[ds, eax + 61], 0);           /* cmp byte [eax+0x3d], 0x0 */
            ii(0x100c_cc8e, 2);  if(jz(0x100c_ccb4, 0x24)) goto l_0x100c_ccb4;/* jz 0x100cccb4 */
            ii(0x100c_cc90, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x100c_cc93, 5);  call(0x1007_63a0, -0x5_68f8);         /* call 0x100763a0 */
            ii(0x100c_cc98, 4);  cmp(memb[ds, eax + 61], 2);           /* cmp byte [eax+0x3d], 0x2 */
            ii(0x100c_cc9c, 2);  if(jnz(0x100c_ccb2, 0x14)) goto l_0x100c_ccb2;/* jnz 0x100cccb2 */
            ii(0x100c_cc9e, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x100c_cca1, 5);  call(0x1007_63a0, -0x5_6906);         /* call 0x100763a0 */
            ii(0x100c_cca6, 3);  mov(al, memb[ds, eax + 78]);          /* mov al, [eax+0x4e] */
        ...
        l_0x100c_ccb8:
            ...
            ii(0x100c_ccbe, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x100c_ccd4:
            ii(0x100c_ccd4, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x100c_cce8, 3);  mov(edx, memd[ds, eax + 11]);         /* mov edx, [eax+0xb] */
            ii(0x100c_cceb, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x100c_ccee, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x100c_cd05:
            ...
            ii(0x100c_cd12, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x100c_cd15, 5);  call(0x1007_636c, -0x5_69ae);         /* call 0x1007636c */
            ii(0x100c_cd1a, 5);  call(0x100a_601a, -0x2_6d05);         /* call 0x100a601a */
            ii(0x100c_cd1f, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x100c_cd22, 4);  cmp(memd[ss, ebp - 12], 0);           /* cmp dword [ebp-0xc], 0x0 */
            ii(0x100c_cd26, 2);  if(jz(0x100c_cd31, 9)) goto l_0x100c_cd31;/* jz 0x100ccd31 */
            ii(0x100c_cd28, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
        ...
        l_0x100c_cd31:
            ii(0x100c_cd31, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100c_cd34, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_cd37, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x100c_cd3a, 5);  call(0x1007_6408, -0x5_6937);         /* call 0x10076408 */
            ii(0x100c_cd3f, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
        l_0x100c_cd42:
            ii(0x100c_cd42, 5);  jmp(0x100c_cc27, -0x120); goto l_0x100c_cc27;/* jmp 0x100ccc27 */
        l_0x100c_cd47:
            ii(0x100c_cd47, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ...
            ii(0x100c_cd57, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
