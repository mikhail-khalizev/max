...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_cbd2()
        {
            ...
            ii(0x100c_cbea, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x100c_cc08, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100c_cc25:
            ii(0x100c_cc25, 2); jmp(0x100c_cc2f, 0x8); goto l_0x100c_cc2f; /* jmp 0x100ccc2f */
        l_0x100c_cc27:
        ...
        l_0x100c_cc2f:
            ...
            ii(0x100c_cc4e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_cc51, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x100c_cc63, 5); cmp(memw[ds, eax + 0x8], 0x3f);         /* cmp word [eax+0x8], 0x3f */
            ii(0x100c_cc68, 2); if(jz(0x100c_cc6c, 0x2)) goto l_0x100c_cc6c; /* jz 0x100ccc6c */
        l_0x100c_cc6a:
        ...
        l_0x100c_cc6c:
            ...
            ii(0x100c_cc7e, 2); if(jg(0x100c_cc82, 0x2)) goto l_0x100c_cc82; /* jg 0x100ccc82 */
        l_0x100c_cc80:
        ...
        l_0x100c_cc82:
            ...
            ii(0x100c_cc98, 4); cmp(memb[ds, eax + 0x3d], 0x2);         /* cmp byte [eax+0x3d], 0x2 */
            ...
            ii(0x100c_ccb0, 2); if(jz(0x100c_ccb4, 0x2)) goto l_0x100c_ccb4; /* jz 0x100cccb4 */
        l_0x100c_ccb2:
            ii(0x100c_ccb2, 2); jmp(0x100c_ccb6, 0x2); goto l_0x100c_ccb6; /* jmp 0x100cccb6 */
        l_0x100c_ccb4:
            ii(0x100c_ccb4, 2); jmp(0x100c_ccb8, 0x2); goto l_0x100c_ccb8; /* jmp 0x100cccb8 */
        l_0x100c_ccb6:
            ii(0x100c_ccb6, 2); jmp(0x100c_cccf, 0x17); goto l_0x100c_cccf; /* jmp 0x100ccccf */
        l_0x100c_ccb8:
            ii(0x100c_ccb8, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x100c_cccd, 2); if(jnz(0x100c_ccd4, 0x5)) goto l_0x100c_ccd4; /* jnz 0x100cccd4 */
        l_0x100c_cccf:
        ...
        l_0x100c_ccd4:
            ...
            ii(0x100c_cce5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100c_cd05:
            ii(0x100c_cd05, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_cd26, 2); if(jz(0x100c_cd31, 0x9)) goto l_0x100c_cd31; /* jz 0x100ccd31 */
            ii(0x100c_cd28, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x100c_cd2b, 4); cmp(ax, memw[ss, ebp - 0x8]);           /* cmp ax, [ebp-0x8] */
        ...
        l_0x100c_cd31:
            ...
            ii(0x100c_cd34, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        ...
        l_0x100c_cd47:
            ...
            ii(0x100c_cd4a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
