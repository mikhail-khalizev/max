...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_c628()
        {
            ...
            ii(0x1010_c639, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1010_c63f, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1010_c642, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1010_c645, 5); mov(eax, 5);                            /* mov eax, 0x5 */
            ii(0x1010_c64a, 5); call(/* sys */ 0x1016_a24c, 0x5_dbfd);  /* call 0x1016a24c */
            ii(0x1010_c64f, 5); mov(eax, 1);                            /* mov eax, 0x1 */
            ii(0x1010_c654, 1); push(eax);                              /* push eax */
            ii(0x1010_c655, 5); mov(eax, 1);                            /* mov eax, 0x1 */
            ii(0x1010_c65a, 1); push(eax);                              /* push eax */
            ii(0x1010_c65b, 2); push(2);                                /* push 0x2 */
            ...
            ii(0x1010_c674, 3); mov(ebx, memd[ss, ebp - 4]);            /* mov ebx, [ebp-0x4] */
            ii(0x1010_c677, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1010_c67a, 3); mov(edx, memd[ds, eax + 14]);           /* mov edx, [eax+0xe] */
            ii(0x1010_c67d, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1010_c680, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1010_c683, 3); mov(eax, memd[ds, eax + 22]);           /* mov eax, [eax+0x16] */
