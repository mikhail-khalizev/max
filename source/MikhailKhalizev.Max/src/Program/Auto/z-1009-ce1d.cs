...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_ce1d()
        {
            ...
            ii(0x1009_ce35, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1009_ce38, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_ce48, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1009_ce4b, 3); mov(eax, memd[ds, eax + 31]);           /* mov eax, [eax+0x1f] */
            ...
            ii(0x1009_ce55, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1009_ce58, 4); inc(memw[ds, eax + 33]);                /* inc word [eax+0x21] */
            ii(0x1009_ce5c, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1009_ce5f, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1009_ce62, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1009_ce65, 3); mov(edx, memd[ds, eax + 2]);            /* mov edx, [eax+0x2] */
            ii(0x1009_ce68, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1009_ce6b, 3); call_abs(memd[ds, edx + 120]);          /* call dword [edx+0x78] */
        l_0x1009_ce6e:
            ii(0x1009_ce6e, 5); jmp(0x1009_cfd2, 0x15f); goto l_0x1009_cfd2; /* jmp 0x1009cfd2 */
        l_0x1009_ce73:
            ii(0x1009_ce73, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1009_ce76, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1009_ce79, 5); call(0x1007_6338, -0x2_6b46);           /* call 0x10076338 */
            ii(0x1009_ce7e, 3); lea(ebx, memd[ss, ebp - 12]);           /* lea ebx, [ebp-0xc] */
            ...
            ii(0x1009_ce8a, 2); jmp(0x1009_ce94, 8); goto l_0x1009_ce94; /* jmp 0x1009ce94 */
        l_0x1009_ce8c:
            ii(0x1009_ce8c, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x1009_ce8f, 5); call(0x1007_6bf8, -0x2_629c);           /* call 0x10076bf8 */
        l_0x1009_ce94:
            ii(0x1009_ce94, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_ce96, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ...
            ii(0x1009_cea6, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x1009_cea9, 5); call(0x1007_63a0, -0x2_6b0e);           /* call 0x100763a0 */
            ii(0x1009_ceae, 3); mov(al, memb[ds, eax + 78]);            /* mov al, [eax+0x4e] */
            ...
            ii(0x1009_ceba, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1009_cebd, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
        ...
        l_0x1009_ced3:
            ...
            ii(0x1009_ceed, 2); sar(eax, 1);                            /* sar eax, 1 */
            ii(0x1009_ceef, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1009_cef1, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x1009_cef4, 5); call(0x1007_63a0, -0x2_6b59);           /* call 0x100763a0 */
            ii(0x1009_cef9, 3); mov(al, memb[ds, eax + 77]);            /* mov al, [eax+0x4d] */
            ...
            ii(0x1009_cf0f, 3); cmp(eax, 1);                            /* cmp eax, 0x1 */
            ii(0x1009_cf12, 2); if(jge(0x1009_cf19, 5)) goto l_0x1009_cf19; /* jge 0x1009cf19 */
        l_0x1009_cf14:
            ii(0x1009_cf14, 5); jmp(0x1009_cf8d, 0x74); goto l_0x1009_cf8d; /* jmp 0x1009cf8d */
        l_0x1009_cf19:
            ii(0x1009_cf19, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ...
            ii(0x1009_cf30, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1009_cf33, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1009_cf36, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1009_cf39, 4); cmp(memd[ss, ebp - 20], 0);             /* cmp dword [ebp-0x14], 0x0 */
            ii(0x1009_cf3d, 2); if(jz(0x1009_cf5c, 0x1d)) goto l_0x1009_cf5c; /* jz 0x1009cf5c */
            ii(0x1009_cf3f, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x1009_cf42, 5); call(0x1007_63d4, -0x2_6b73);           /* call 0x100763d4 */
            ii(0x1009_cf47, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1009_cf49, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1009_cf4c, 5); call(Definitions.my_ctor_c15, 0x2_e937); /* call 0x100cb888 */
            ii(0x1009_cf51, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x1009_cf54, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x1009_cf57, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x1009_cf5a, 2); jmp(0x1009_cf62, 6); goto l_0x1009_cf62; /* jmp 0x1009cf62 */
        l_0x1009_cf5c:
            ii(0x1009_cf5c, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x1009_cf5f, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
        l_0x1009_cf62:
            ii(0x1009_cf62, 3); mov(edx, memd[ss, ebp - 28]);           /* mov edx, [ebp-0x1c] */
            ii(0x1009_cf65, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
            ii(0x1009_cf68, 5); call(0x1008_b060, -0x1_1f0d);           /* call 0x1008b060 */
            ii(0x1009_cf6d, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
            ...
            ii(0x1009_cf83, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
        ...
        l_0x1009_cf8d:
            ...
            ii(0x1009_cf96, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x1009_cf99, 5); call(0x1007_63d4, -0x2_6bca);           /* call 0x100763d4 */
            ii(0x1009_cf9e, 5); call(0x100a_297d, 0x59da);              /* call 0x100a297d */
            ii(0x1009_cfa3, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1009_cfa6, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ...
            ii(0x1009_cfb9, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
        ...
        l_0x1009_cfc8:
            ...
            ii(0x1009_cfca, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
