...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("5eacb317-4112-41f3-bdde-ff09f3d432a9")]
        public void Method_100c_e8e2()
        {
            ii(0x100c_e8e2, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x100c_e8e7, 5); calld(Definitions.sys_check_available_stack_size, 0x97466); /* call 0x10165d52 */
        ...
        l_0x100c_e921:
            ...
            ii(0x100c_e92c, 1); retd(); return;                         /* ret */
        }
    }
}
