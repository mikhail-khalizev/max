...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_e8e2()
        {
            ...
            ii(0x100c_e8fa, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_e8fd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_e900, 4); cmp(memd[ds, eax + 0x18], 0);           /* cmp dword [eax+0x18], 0x0 */
            ii(0x100c_e904, 2); if(jnz(0x100c_e913, 0xd)) goto l_0x100c_e913; /* jnz 0x100ce913 */
            ii(0x100c_e906, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_e909, 5); call(0x100c_e850, -0xbe);               /* call 0x100ce850 */
            ii(0x100c_e90e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_e911, 2); jmp(0x100c_e921, 0xe); goto l_0x100c_e921; /* jmp 0x100ce921 */
        l_0x100c_e913:
            ii(0x100c_e913, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_e916, 3); mov(eax, memd[ds, eax + 0x18]);         /* mov eax, [eax+0x18] */
            ii(0x100c_e919, 5); call(0x100d_4e8c, 0x656e);              /* call 0x100d4e8c */
            ii(0x100c_e91e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x100c_e921:
            ii(0x100c_e921, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
