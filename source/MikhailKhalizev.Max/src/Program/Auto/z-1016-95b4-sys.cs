...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_95b4()
        {
            ...
            ii(0x1016_95bf, 3); mov(ecx, memd[ds, edx + 0xc]);          /* mov ecx, [edx+0xc] */
            ii(0x1016_95c2, 3); mov(ebx, memd[ds, edx + 0x8]);          /* mov ebx, [edx+0x8] */
            ii(0x1016_95c5, 2); mov(eax, memd[ds, esi]);                /* mov eax, [esi] */
            ii(0x1016_95c7, 3); mov(edx, memd[ds, edx + 0x4]);          /* mov edx, [edx+0x4] */
