...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_ffd5()
        {
            ...
            ii(0x19_ffde, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x19_ffe1, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ii(0x19_ffe4, 3); push(memw[ss, bp + 0xa]);                 /* push word [bp+0xa] */
            ii(0x19_ffe7, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ...
            ii(0x19_fff4, 3); ret(0x8);                                 /* ret 0x8 */
        }
    }
}
