...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_9753()
        {
            ...
            ii(0x1012_97b6, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_97b9, 4); mov(memb[ss, ebp - 0x4], 0x1);          /* mov byte [ebp-0x4], 0x1 */
        l_0x1012_97bd:
            ii(0x1012_97bd, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ii(0x1012_97c1, 2); if(jz(0x1012_97cc, 0x9)) goto l_0x1012_97cc; /* jz 0x101297cc */
            ii(0x1012_97c3, 7); cmp(memd[ds, 0x101c_5624], 0);          /* cmp dword [0x101c5624], 0x0 */
            ii(0x1012_97ca, 2); if(jnz(0x1012_97d1, 0x5)) goto l_0x1012_97d1; /* jnz 0x101297d1 */
        l_0x1012_97cc:
        ...
        l_0x1012_97d1:
            ...
            ii(0x1012_97db, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1012_980f, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x1012_9812:
            ii(0x1012_9812, 4); mov(memb[ss, ebp - 0x4], 0);            /* mov byte [ebp-0x4], 0x0 */
            ii(0x1012_9816, 7); mov(memd[ss, ebp - 0x10], 0x4);         /* mov dword [ebp-0x10], 0x4 */
        l_0x1012_981d:
            ii(0x1012_981d, 3); dec(memd[ss, ebp - 0x10]);              /* dec dword [ebp-0x10] */
            ii(0x1012_9820, 5); cmp(memw[ss, ebp - 0x10], -0x1 /* 0xff */); /* cmp word [ebp-0x10], 0xffff */
            ...
            ii(0x1012_985a, 4); mov(memb[ss, ebp - 0x4], 0x1);          /* mov byte [ebp-0x4], 0x1 */
        ...
        l_0x1012_9882:
            ...
            ii(0x1012_988a, 2); if(jnz(0x1012_9890, 0x4)) goto l_0x1012_9890; /* jnz 0x10129890 */
            ii(0x1012_988c, 4); mov(memb[ss, ebp - 0x4], 0);            /* mov byte [ebp-0x4], 0x0 */
        l_0x1012_9890:
