...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_9753()
        {
            ...
            ii(0x1012_97ae, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
        ...
        l_0x1012_9812:
            ...
            ii(0x1012_9816, 7); mov(memd[ss, ebp - 16], 4);             /* mov dword [ebp-0x10], 0x4 */
        l_0x1012_981d:
            ii(0x1012_981d, 3); dec(memd[ss, ebp - 16]);                /* dec dword [ebp-0x10] */
            ii(0x1012_9820, 5); cmp(memw[ss, ebp - 16], -1 /* 0xff */); /* cmp word [ebp-0x10], 0xffff */
            ii(0x1012_9825, 2); if(jz(0x1012_9882, 0x5b)) goto l_0x1012_9882; /* jz 0x10129882 */
            ii(0x1012_9827, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x1012_9841, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x1012_985e, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x1012_9877, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
