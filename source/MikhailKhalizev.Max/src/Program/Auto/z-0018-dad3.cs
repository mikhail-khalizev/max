...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_dad3()
        {
            ...
            ii(0x18_dad8, 3); mov(es, memw[ss, bp + 0x4]);              /* mov es, [bp+0x4] */
            ii(0x18_dadb, 3); mov(di, memw[ss, bp + 0x6]);              /* mov di, [bp+0x6] */
            ii(0x18_dade, 3); mov(cx, memw[ss, bp + 0x8]);              /* mov cx, [bp+0x8] */
            ii(0x18_dae1, 3); mov(al, memb[ss, bp + 0xa]);              /* mov al, [bp+0xa] */
