...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_2b85()
        {
            ...
            ii(0x100c_2b9c, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_2b9f, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100c_2ba2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_2ba5, 4); cmp(memd[ds, eax + 0x67], 0);           /* cmp dword [eax+0x67], 0x0 */
            ii(0x100c_2ba9, 2); if(jnz(0x100c_2bb4, 0x9)) goto l_0x100c_2bb4; /* jnz 0x100c2bb4 */
        ...
        l_0x100c_2bb4:
            ii(0x100c_2bb4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_2bbf, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_2bc2, 3); mov(edx, memd[ds, eax + 0x67]);         /* mov edx, [eax+0x67] */
            ii(0x100c_2bc5, 2); add(edx, ebx);                          /* add edx, ebx */
            ii(0x100c_2bc7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
