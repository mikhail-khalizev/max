...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_10ef()
        {
            ...
            ii(0x100c_1106, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_1109, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
        ...
        l_0x100c_1115:
            ...
            ii(0x100c_1118, 5); cmp(memw[ss, ebp - 0x10], -0x1 /* 0xff */); /* cmp word [ebp-0x10], 0xffff */
            ii(0x100c_111d, 2); if(jz(0x100c_1162, 0x43)) goto l_0x100c_1162; /* jz 0x100c1162 */
            ii(0x100c_111f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_1122, 4); add(memd[ss, ebp - 0x4], 0x4);          /* add dword [ebp-0x4], 0x4 */
            ii(0x100c_1126, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x100c_1128, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x100c_112b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_112e, 4); add(memd[ss, ebp - 0x8], 0x4);          /* add dword [ebp-0x8], 0x4 */
        ...
        l_0x100c_1140:
            ...
            ii(0x100c_1143, 5); cmp(memw[ss, ebp - 0xc], -0x1 /* 0xff */); /* cmp word [ebp-0xc], 0xffff */
            ...
            ii(0x100c_114d, 4); add(memd[ss, ebp - 0x14], 0x2);         /* add dword [ebp-0x14], 0x2 */
            ii(0x100c_1151, 3); mov(edx, memd[ss, ebp - 0x18]);         /* mov edx, [ebp-0x18] */
            ii(0x100c_1154, 4); add(memd[ss, ebp - 0x18], 0x2);         /* add dword [ebp-0x18], 0x2 */
