...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_ab12()
        {
            ...
            ii(0xab1b, 2);    cmp(al, 3);                               /* cmp al, 0x3 */
            ...
            ii(0xab38, 2);    mov(ah, 9);                               /* mov ah, 0x9 */
            ii(0xab3a, 3);    mov(dx, 0x40);                            /* mov dx, 0x40 */
            ii(0xab3d, 3);    call_far_ind(memw[ss, bp]);               /* call far word [bp] */
            ...
            ii(0xab61, 3);    call_far_ind(memw[ss, bp]);               /* call far word [bp] */
            ii(0xab64, 2);    mov(ah, 0xa);                             /* mov ah, 0xa */
            ii(0xab66, 3);    call_far_ind(memw[ss, bp]);               /* call far word [bp] */
