...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_92a8()
        {
            ...
            ii(0x19_92c2, 3); add(sp, 6);                               /* add sp, 0x6 */
            ii(0x19_92c5, 2); or(ax, ax);                               /* or ax, ax */
            ii(0x19_92c7, 2); if(jnz(0x19_92ce, 5)) goto l_0x19_92ce;   /* jnz 0x92ce */
        l_0x19_92c9:
        ...
        l_0x19_92ce:
            ...
            ii(0x19_92f7, 2); if(jnz(0x19_92fc, 3)) goto l_0x19_92fc;   /* jnz 0x92fc */
            ii(0x19_92f9, 3); jmp(0x19_93b9, 0xbd); goto l_0x19_93b9;   /* jmp 0x93b9 */
        l_0x19_92fc:
            ii(0x19_92fc, 4); mov(memb[ss, bp - 18], 0);                /* mov byte [bp-0x12], 0x0 */
            ii(0x19_9300, 5); mov(memw[ss, bp - 24], 0xffff);           /* mov word [bp-0x18], 0xffff */
            ii(0x19_9305, 4); mov(memb[ss, bp - 19], 0x9a);             /* mov byte [bp-0x13], 0x9a */
            ii(0x19_9309, 5); mov(memw[ss, bp - 2], 0);                 /* mov word [bp-0x2], 0x0 */
        l_0x19_930e:
            ii(0x19_930e, 3); mov(ax, memw[ss, bp - 2]);                /* mov ax, [bp-0x2] */
            ...
            ii(0x19_931b, 3); mov(memw[ss, bp - 10], cx);               /* mov [bp-0xa], cx */
            ii(0x19_931e, 3); mov(memw[ss, bp - 8], ax);                /* mov [bp-0x8], ax */
            ii(0x19_9321, 5); cmp(memb[ds, 0x19f4], 0);                 /* cmp byte [0x19f4], 0x0 */
            ii(0x19_9326, 2); if(jz(0x19_932e, 6)) goto l_0x19_932e;    /* jz 0x932e */
            ii(0x19_9328, 3); or(ah, 0xc0);                             /* or ah, 0xc0 */
            ii(0x19_932b, 3); mov(memw[ss, bp - 8], ax);                /* mov [bp-0x8], ax */
        l_0x19_932e:
            ii(0x19_932e, 2); mov(ax, cx);                              /* mov ax, cx */
            ii(0x19_9330, 3); mov(memw[ss, bp - 22], ax);               /* mov [bp-0x16], ax */
            ii(0x19_9333, 3); mov(al, memb[ss, bp - 8]);                /* mov al, [bp-0x8] */
            ii(0x19_9336, 3); mov(memb[ss, bp - 20], al);               /* mov [bp-0x14], al */
            ii(0x19_9339, 3); mov(al, memb[ss, bp - 7]);                /* mov al, [bp-0x7] */
            ii(0x19_933c, 2); sub(ah, ah);                              /* sub ah, ah */
            ii(0x19_933e, 3); mov(memb[ss, bp - 17], al);               /* mov [bp-0x11], al */
            ii(0x19_9341, 3); mov(bx, memw[ss, bp - 2]);                /* mov bx, [bp-0x2] */
            ii(0x19_9344, 3); shl(bx, 3);                               /* shl bx, 0x3 */
            ...
            ii(0x19_934e, 3); lea(si, memw[ss, bp - 24]);               /* lea si, [bp-0x18] */
            ...
            ii(0x19_9358, 3); inc(memw[ss, bp - 2]);                    /* inc word [bp-0x2] */
            ii(0x19_935b, 5); cmp(memw[ss, bp - 2], 0x2000);            /* cmp word [bp-0x2], 0x2000 */
            ii(0x19_9360, 2); if(jb(0x19_930e, -0x54)) goto l_0x19_930e; /* jb 0x930e */
            ii(0x19_9362, 5); mov(memw[ss, bp - 14], 0);                /* mov word [bp-0xe], 0x0 */
            ii(0x19_9367, 5); mov(memw[ss, bp - 12], 8);                /* mov word [bp-0xc], 0x8 */
            ii(0x19_936c, 2); mov(ax, es);                              /* mov ax, es */
            ii(0x19_936e, 2); and(al, 0xf8);                            /* and al, 0xf8 */
            ii(0x19_9370, 3); mov(dx, 8);                               /* mov dx, 0x8 */
            ii(0x19_9373, 3); mov(memw[ss, bp - 6], ax);                /* mov [bp-0x6], ax */
            ii(0x19_9376, 3); mov(memw[ss, bp - 4], dx);                /* mov [bp-0x4], dx */
            ii(0x19_9379, 2); mov(es, dx);                              /* mov es, dx */
            ii(0x19_937b, 2); mov(bx, ax);                              /* mov bx, ax */
            ii(0x19_937d, 5); and(memb[es, bx + 5], -0x20 /* 0xe0 */);  /* and byte [es:bx+0x5], 0xe0 */
            ii(0x19_9382, 3); les(bx, memw[ss, bp - 6]);                /* les bx, [bp-0x6] */
            ii(0x19_9385, 5); or(memb[es, bx + 5], 2);                  /* or byte [es:bx+0x5], 0x2 */
            ii(0x19_938a, 3); les(bx, memw[ss, bp - 14]);               /* les bx, [bp-0xe] */
            ...
            ii(0x19_9396, 3); mov(si, memw[ss, bp - 14]);               /* mov si, [bp-0xe] */
            ii(0x19_9399, 1); push(ds);                                 /* push ds */
            ii(0x19_939a, 3); lea(di, memw[ds, si + 104]);              /* lea di, [si+0x68] */
        ...
        l_0x19_93b9:
            ...
            ii(0x19_93c3, 3); add(sp, 6);                               /* add sp, 0x6 */
        l_0x19_93c6:
            ii(0x19_93c6, 3); push(memw[ss, bp - 16]);                  /* push word [bp-0x10] */
