...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_dc52()
        {
            ...
            ii(0x1011_dc69, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_dc6c, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1011_dc6f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_dc72, 4); cmp(memd[ds, eax + 0x16], 0);           /* cmp dword [eax+0x16], 0x0 */
            ii(0x1011_dc76, 2); if(jz(0x1011_dca2, 0x2a)) goto l_0x1011_dca2; /* jz 0x1011dca2 */
            ii(0x1011_dc78, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_dc7b, 3); mov(eax, memd[ds, eax + 0x16]);         /* mov eax, [eax+0x16] */
            ii(0x1011_dc7e, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1011_dc81, 4); cmp(memd[ss, ebp - 0x14], 0);           /* cmp dword [ebp-0x14], 0x0 */
            ii(0x1011_dc85, 2); if(jz(0x1011_dc9b, 0x14)) goto l_0x1011_dc9b; /* jz 0x1011dc9b */
            ii(0x1011_dc87, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_dc89, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ...
            ii(0x1011_dc96, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1011_dc99, 2); jmp(0x1011_dca2, 0x7); goto l_0x1011_dca2; /* jmp 0x1011dca2 */
        l_0x1011_dc9b:
            ii(0x1011_dc9b, 7); mov(memd[ss, ebp - 0x18], 0);           /* mov dword [ebp-0x18], 0x0 */
        l_0x1011_dca2:
            ii(0x1011_dca2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_dca5, 4); cmp(memd[ds, eax + 0x1a], 0);           /* cmp dword [eax+0x1a], 0x0 */
            ii(0x1011_dca9, 2); if(jz(0x1011_dcd5, 0x2a)) goto l_0x1011_dcd5; /* jz 0x1011dcd5 */
            ii(0x1011_dcab, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_dcae, 3); mov(eax, memd[ds, eax + 0x1a]);         /* mov eax, [eax+0x1a] */
            ii(0x1011_dcb1, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1011_dcb4, 4); cmp(memd[ss, ebp - 0x1c], 0);           /* cmp dword [ebp-0x1c], 0x0 */
            ii(0x1011_dcb8, 2); if(jz(0x1011_dcce, 0x14)) goto l_0x1011_dcce; /* jz 0x1011dcce */
            ii(0x1011_dcba, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_dcbc, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ...
            ii(0x1011_dcc9, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1011_dccc, 2); jmp(0x1011_dcd5, 0x7); goto l_0x1011_dcd5; /* jmp 0x1011dcd5 */
        l_0x1011_dcce:
            ii(0x1011_dcce, 7); mov(memd[ss, ebp - 0x20], 0);           /* mov dword [ebp-0x20], 0x0 */
        l_0x1011_dcd5:
            ...
            ii(0x1011_dcde, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1011_dce5, 2); jmp(0x1011_dced, 0x6); goto l_0x1011_dced; /* jmp 0x1011dced */
        l_0x1011_dce7:
            ii(0x1011_dce7, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1011_dcea, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x1011_dced:
            ii(0x1011_dced, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1011_dcf9, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
        ...
        l_0x1011_dd1b:
            ...
            ii(0x1011_dd27, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1011_dd35, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_dd38, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_dd3a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_dd3d, 5); call(0x100b_7368, -0x6_69da);           /* call 0x100b7368 */
            ii(0x1011_dd42, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_dd45, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_dd48, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1011_dd4b, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
