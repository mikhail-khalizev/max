...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_7f4b()
        {
            ...
            ii(0x1015_7f5c, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1015_7f62, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1015_7f65, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1015_7f68, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
