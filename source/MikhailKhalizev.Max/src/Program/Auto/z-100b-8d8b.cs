...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_8d8b()
        {
            ...
            ii(0x100b_8da2, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_8da5, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100b_8da8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_8dab, 3); add(eax, 0x6);                          /* add eax, 0x6 */
            ii(0x100b_8dae, 5); call(0x1007_6600, -0x4_27b3);           /* call 0x10076600 */
            ii(0x100b_8db3, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ...
            ii(0x100b_8dbf, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_8dc2, 3); mov(edx, memd[ds, eax + 0xc]);          /* mov edx, [eax+0xc] */
            ii(0x100b_8dc5, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100b_8dc8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_8dcb, 5); call(0x1013_c0fa, 0x8_332a);            /* call 0x1013c0fa */
            ii(0x100b_8dd0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_8dd3, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_8dd5, 3); mov(dl, memb[ds, eax + 0x14]);          /* mov dl, [eax+0x14] */
            ii(0x100b_8dd8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_8ddb, 5); call(0x100c_b818, 0x1_2a38);            /* call 0x100cb818 */
            ii(0x100b_8de0, 5); mov(ebx, 0x4);                          /* mov ebx, 0x4 */
            ii(0x100b_8de5, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100b_8de8, 3); add(edx, 0x10);                         /* add edx, 0x10 */
            ii(0x100b_8deb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
