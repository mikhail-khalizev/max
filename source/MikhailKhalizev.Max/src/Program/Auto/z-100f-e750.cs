...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_e750()
        {
            ...
            ii(0x100f_e766, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100f_e769, 3);  mov(memb[ss, ebp - 8], dl);           /* mov [ebp-0x8], dl */
            ii(0x100f_e76c, 3);  mov(memb[ss, ebp - 4], bl);           /* mov [ebp-0x4], bl */
            ii(0x100f_e76f, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
            ...
            ii(0x100f_e78e, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
        ...
        l_0x100f_e7aa:
            ...
            ii(0x100f_e7b4, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x100f_e7b7, 7);  mov(memb[ds, 0x101c_391e], 0xb);      /* mov byte [0x101c391e], 0xb */
        l_0x100f_e7be:
            ii(0x100f_e7be, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
        ...
        l_0x100f_e7e5:
            ii(0x100f_e7e5, 7);  mov(memd[ss, ebp - 16], 0x2d);        /* mov dword [ebp-0x10], 0x2d */
        l_0x100f_e7ec:
            ii(0x100f_e7ec, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x100f_e7fc, 3);  mov(memb[ss, ebp - 20], al);          /* mov [ebp-0x14], al */
            ii(0x100f_e7ff, 5);  jmp_func(0x100f_e90c, 0x108);         /* jmp 0x100fe90c */
        }
    }
}
