...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_f204()
        {
            ...
            ii(0x1009_f21c, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1009_f21f, 5); mov(eax, 0x1d);                         /* mov eax, 0x1d */
            ii(0x1009_f224, 5); call(Definitions.sys_new, 0xc_6bd7);    /* call 0x10165e00 */
            ii(0x1009_f229, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1009_f22c, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1009_f22f, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1009_f232, 4); cmp(memd[ss, ebp - 16], 0);             /* cmp dword [ebp-0x10], 0x0 */
            ii(0x1009_f236, 2); if(jz(0x1009_f254, 0x1c)) goto l_0x1009_f254; /* jz 0x1009f254 */
            ii(0x1009_f238, 3); mov(ebx, memd[ss, ebp - 4]);            /* mov ebx, [ebp-0x4] */
            ii(0x1009_f23b, 3); add(ebx, 0x13);                         /* add ebx, 0x13 */
            ii(0x1009_f23e, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1009_f241, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1009_f244, 5); call(Definitions.my_ctor_c12, 0x6e23);  /* call 0x100a606c */
            ii(0x1009_f249, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1009_f24c, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x1009_f24f, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1009_f252, 2); jmp(0x1009_f25a, 6); goto l_0x1009_f25a; /* jmp 0x1009f25a */
        l_0x1009_f254:
            ii(0x1009_f254, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1009_f257, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
        l_0x1009_f25a:
            ii(0x1009_f25a, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1009_f25d, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ii(0x1009_f260, 5); call(0x1008_a914, -0x1_4951);           /* call 0x1008a914 */
            ii(0x1009_f265, 5); mov(edx, 0x39);                         /* mov edx, 0x39 */
            ii(0x1009_f26a, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ii(0x1009_f26d, 5); call(0x1008_a7dc, -0x1_4a96);           /* call 0x1008a7dc */
            ii(0x1009_f272, 5); call(0x100a_63bc, 0x7145);              /* call 0x100a63bc */
            ii(0x1009_f277, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ...
            ii(0x1009_f28d, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
