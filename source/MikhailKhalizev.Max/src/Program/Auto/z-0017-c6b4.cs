...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x17_c6b4, 4); enter(0x2, 0);                            /* enter 0x2, 0x0 */
            ii(0x17_c6b8, 1); push(ds);                                 /* push ds */
            ii(0x17_c6b9, 3); mov(ax, 0x3e68);                          /* mov ax, 0x3e68 */
            ii(0x17_c6bc, 2); mov(ds, ax);                              /* mov ds, ax */
            ii(0x17_c6be, 4); mov(memb[ss, bp - 0x2], 0x1);             /* mov byte [bp-0x2], 0x1 */
            ii(0x17_c6c2, 2); jmp(0x17_c6c7, 0x3); goto l_0x17_c6c7;    /* jmp 0xc6c7 */
        l_0x17_c6c4:
            ii(0x17_c6c4, 3); inc(memb[ss, bp - 0x2]);                  /* inc byte [bp-0x2] */
        l_0x17_c6c7:
            ii(0x17_c6c7, 4); cmp(memb[ss, bp - 0x2], 0x64);            /* cmp byte [bp-0x2], 0x64 */
            ii(0x17_c6cb, 2); if(jae(0x17_c6e8, 0x1b)) goto l_0x17_c6e8; /* jae 0xc6e8 */
            ii(0x17_c6cd, 3); mov(bl, memb[ss, bp - 0x2]);              /* mov bl, [bp-0x2] */
            ...
            ii(0x17_c6dd, 2); if(jnz(0x17_c6e6, 0x7)) goto l_0x17_c6e6; /* jnz 0xc6e6 */
            ii(0x17_c6df, 3); mov(al, memb[ss, bp - 0x2]);              /* mov al, [bp-0x2] */
