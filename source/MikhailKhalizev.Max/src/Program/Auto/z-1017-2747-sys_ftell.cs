...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ sys_ftell()
        {
            ...
            ii(0x1017_274b, 3); mov(eax, memd[ds, eax + 0x10]);         /* mov eax, [eax+0x10] */
            ...
            ii(0x1017_275a, 4); test(memb[ds, edx + 0xc], 0x80);        /* test byte [edx+0xc], 0x80 */
            ii(0x1017_275e, 2); if(jz(0x1017_276d, 0xd)) goto l_0x1017_276d; /* jz 0x1017276d */
            ii(0x1017_2760, 4); test(memb[ds, edx + 0xd], 0x10);        /* test byte [edx+0xd], 0x10 */
            ii(0x1017_2764, 2); if(jz(0x1017_276d, 0x7)) goto l_0x1017_276d; /* jz 0x1017276d */
            ii(0x1017_2766, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x1017_2768, 5); call(/* sys */ 0x1018_7160, 0x1_49f3);  /* call 0x10187160 */
        l_0x1017_276d:
            ii(0x1017_276d, 4); cmp(memd[ds, edx + 0x4], 0);            /* cmp dword [edx+0x4], 0x0 */
            ii(0x1017_2771, 2); if(jz(0x1017_2784, 0x11)) goto l_0x1017_2784; /* jz 0x10172784 */
            ii(0x1017_2773, 4); test(memb[ds, edx + 0xd], 0x10);        /* test byte [edx+0xd], 0x10 */
            ii(0x1017_2777, 2); if(jz(0x1017_2781, 0x8)) goto l_0x1017_2781; /* jz 0x10172781 */
            ii(0x1017_2779, 3); add(ebx, memd[ds, edx + 0x4]);          /* add ebx, [edx+0x4] */
        ...
        l_0x1017_2781:
            ii(0x1017_2781, 3); sub(ebx, memd[ds, edx + 0x4]);          /* sub ebx, [edx+0x4] */
        l_0x1017_2784:
