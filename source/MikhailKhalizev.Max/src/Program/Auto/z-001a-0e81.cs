...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x1a_0e81, 4); enter(0x4, 0);                            /* enter 0x4, 0x0 */
        ...
        l_0x1a_0e8d:
            ...
            ii(0x1a_0e90, 3); lea(ax, memw[ss, bp - 0x4]);              /* lea ax, [bp-0x4] */
            ii(0x1a_0e93, 1); push(ss);                                 /* push ss */
            ii(0x1a_0e94, 1); push(ax);                                 /* push ax */
            ii(0x1a_0e95, 2); push(0x4);                                /* push 0x4 */
            ii(0x1a_0e97, 3); call(0x19_fef1, -0xfa9);                  /* call 0xfef1 */
            ii(0x1a_0e9a, 3); push(memw[ss, bp + 0xc]);                 /* push word [bp+0xc] */
            ii(0x1a_0e9d, 3); les(bx, memw[ss, bp + 0x6]);              /* les bx, [bp+0x6] */
            ii(0x1a_0ea0, 4); push(memw[es, bx + 0x2]);                 /* push word [es:bx+0x2] */
            ii(0x1a_0ea4, 3); push(memw[es, bx]);                       /* push word [es:bx] */
            ii(0x1a_0ea7, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x1a_0eaa, 3); call(0x19_fef1, -0xfbc);                  /* call 0xfef1 */
            ii(0x1a_0ead, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ...
            ii(0x1a_0eb9, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ii(0x1a_0ebc, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x1a_0ebf, 3); les(bx, memw[ss, bp + 0x6]);              /* les bx, [bp+0x6] */
            ii(0x1a_0ec2, 4); push(memw[es, bx + 0x2]);                 /* push word [es:bx+0x2] */
            ...
            ii(0x1a_0ed0, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0x1a_0ed3, 3); mul(memw[ss, bp - 0x4]);                  /* mul word [bp-0x4] */
            ii(0x1a_0ed6, 3); les(bx, memw[ss, bp + 0x6]);              /* les bx, [bp+0x6] */
        ...
        l_0x1a_0edc:
            ...
            ii(0x1a_0ee4, 3); retf(0x8);                                /* retf 0x8 */
        }
    }
}
