...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_0648()
        {
            ...
            ii(0x100e_0660, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100e_0663, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100e_0666, 3); cmp(memd[ds, eax], 0);                  /* cmp dword [eax], 0x0 */
            ii(0x100e_0669, 2); if(jz(0x100e_0674, 9)) goto l_0x100e_0674; /* jz 0x100e0674 */
            ii(0x100e_066b, 7); mov(memd[ss, ebp - 8], 0);              /* mov dword [ebp-0x8], 0x0 */
        ...
        l_0x100e_0674:
            ...
            ii(0x100e_068a, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
        l_0x100e_068d:
            ii(0x100e_068d, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100e_0690, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x100e_0692, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100e_0695, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
