...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_7066()
        {
            ...
            ii(0x706c, 5);    mov(memw[ss, bp - 0x1e], 0);              /* mov word [bp-0x1e], 0x0 */
            ii(0x7071, 5);    mov(memw[ss, bp - 0x44], 0);              /* mov word [bp-0x44], 0x0 */
        l_0x7076:
            ...
            ii(0x70b5, 2);    if(jz(0x70be, 0x7)) goto l_0x70be;        /* jz 0x70be */
        ...
        l_0x70be:
            ii(0x70be, 4);    cmp(memw[ss, bp - 0x8], 0);               /* cmp word [bp-0x8], 0x0 */
            ii(0x70c2, 2);    if(jz(0x70d1, 0xd)) goto l_0x70d1;        /* jz 0x70d1 */
            ii(0x70c4, 5);    cmp(memw[ds, 0xa], 0);                    /* cmp word [0xa], 0x0 */
            ii(0x70c9, 2);    if(jnz(0x70d1, 0x6)) goto l_0x70d1;       /* jnz 0x70d1 */
            ii(0x70cb, 3);    mov(ax, memw[ss, bp - 0x8]);              /* mov ax, [bp-0x8] */
            ii(0x70ce, 3);    mov(memw[ds, 0xe], ax);                   /* mov [0xe], ax */
        l_0x70d1:
            ii(0x70d1, 3);    mov(ax, memw[ss, bp - 0xe]);              /* mov ax, [bp-0xe] */
            ii(0x70d4, 3);    mov(memw[ss, bp - 0x3e], ax);             /* mov [bp-0x3e], ax */
            ii(0x70d7, 4);    cmp(ax, memw[ds, 0x97c]);                 /* cmp ax, [0x97c] */
            ii(0x70db, 2);    if(jbe(0x70e3, 0x6)) goto l_0x70e3;       /* jbe 0x70e3 */
        ...
        l_0x70e3:
            ...
            ii(0x70e6, 3);    cmp(memw[ss, bp - 0x3e], ax);             /* cmp [bp-0x3e], ax */
            ii(0x70e9, 2);    if(jbe(0x70f1, 0x6)) goto l_0x70f1;       /* jbe 0x70f1 */
            ii(0x70eb, 6);    mov(memw[ds, 0x97c], 0xffff);             /* mov word [0x97c], 0xffff */
        l_0x70f1:
            ii(0x70f1, 3);    mov(ax, memw[ss, bp - 0xc]);              /* mov ax, [bp-0xc] */
            ii(0x70f4, 3);    mov(memw[ds, 0x11f2], ax);                /* mov [0x11f2], ax */
            ii(0x70f7, 3);    cmp(ax, 0x80);                            /* cmp ax, 0x80 */
            ii(0x70fa, 2);    if(jae(0x7102, 0x6)) goto l_0x7102;       /* jae 0x7102 */
            ii(0x70fc, 6);    mov(memw[ds, 0x11f2], 0x80);              /* mov word [0x11f2], 0x80 */
        l_0x7102:
            ii(0x7102, 4);    cmp(memw[ss, bp + 0x4], 0);               /* cmp word [bp+0x4], 0x0 */
            ii(0x7106, 2);    if(jnz(0x711f, 0x17)) goto l_0x711f;      /* jnz 0x711f */
            ii(0x7108, 3);    call(0x58aa, -0x1861);                    /* call 0x58aa */
            ii(0x710b, 3);    mov(ax, memw[ss, bp - 0x24]);             /* mov ax, [bp-0x24] */
            ii(0x710e, 3);    mov(memw[ds, 0x97c], ax);                 /* mov [0x97c], ax */
            ii(0x7111, 3);    call(0x7726, 0x612);                      /* call 0x7726 */
            ii(0x7114, 3);    mov(al, memb[ss, bp - 0xa]);              /* mov al, [bp-0xa] */
            ii(0x7117, 3);    mov(memb[ds, 0x980], al);                 /* mov [0x980], al */
            ii(0x711a, 3);    call(0x9426, 0x2309);                     /* call 0x9426 */
            ii(0x711d, 2);    jmp(0x7122, 0x3); goto l_0x7122;          /* jmp 0x7122 */
        l_0x711f:
            ii(0x711f, 3);    call(0x7726, 0x604);                      /* call 0x7726 */
        l_0x7122:
            ii(0x7122, 4);    cmp(memw[ss, bp + 0x4], 0);               /* cmp word [bp+0x4], 0x0 */
            ii(0x7126, 2);    if(jge(0x7132, 0xa)) goto l_0x7132;       /* jge 0x7132 */
            ii(0x7128, 5);    mov(memw[ss, bp + 0x4], 0);               /* mov word [bp+0x4], 0x0 */
            ii(0x712d, 5);    and(memb[ds, 0x14], -0x9 /* 0xf7 */);     /* and byte [0x14], 0xf7 */
        l_0x7132:
            ii(0x7132, 4);    test(memb[ss, bp - 0x12], 0x2);           /* test byte [bp-0x12], 0x2 */
            ii(0x7136, 2);    if(jz(0x7142, 0xa)) goto l_0x7142;        /* jz 0x7142 */
            ii(0x7138, 5);    mov(memw[ss, bp + 0x4], 0xffff);          /* mov word [bp+0x4], 0xffff */
            ii(0x713d, 5);    or(memb[ds, 0x14], 0x8);                  /* or byte [0x14], 0x8 */
        l_0x7142:
            ii(0x7142, 4);    cmp(memw[ss, bp + 0x4], 0);               /* cmp word [bp+0x4], 0x0 */
            ...
            ii(0x714d, 3);    mov(memw[ss, bp - 0x44], ax);             /* mov [bp-0x44], ax */
            ii(0x7150, 4);    test(memb[ss, bp - 0x12], 0x1);           /* test byte [bp-0x12], 0x1 */
            ii(0x7154, 2);    if(jz(0x717a, 0x24)) goto l_0x717a;       /* jz 0x717a */
            ii(0x7156, 3);    mov(ax, memw[ss, bp - 0x3e]);             /* mov ax, [bp-0x3e] */
            ii(0x7159, 1);    inc(ax);                                  /* inc ax */
            ii(0x715a, 3);    shr(ax, 0x3);                             /* shr ax, 0x3 */
            ii(0x715d, 3);    mul(memw[ss, bp + 0x4]);                  /* mul word [bp+0x4] */
            ...
            ii(0x716d, 3);    mov(bx, memw[ss, bp + 0x6]);              /* mov bx, [bp+0x6] */
            ii(0x7170, 3);    mov(memw[ds, bx + 0x8], ax);              /* mov [bx+0x8], ax */
            ii(0x7173, 2);    or(ax, ax);                               /* or ax, ax */
            ii(0x7175, 2);    if(jnz(0x717a, 0x3)) goto l_0x717a;       /* jnz 0x717a */
            ii(0x7177, 3);    jmp(0x75b9, 0x43f); goto l_0x75b9;        /* jmp 0x75b9 */
        l_0x717a:
            ii(0x717a, 3);    mov(ax, memw[ds, 0x11f2]);                /* mov ax, [0x11f2] */
            ii(0x717d, 3);    add(memw[ss, bp - 0x44], ax);             /* add [bp-0x44], ax */
            ii(0x7180, 3);    mov(ax, memw[ss, bp - 0x44]);             /* mov ax, [bp-0x44] */
            ii(0x7183, 3);    add(memw[ss, bp - 0x2e], ax);             /* add [bp-0x2e], ax */
            ii(0x7186, 3);    add(memw[ss, bp - 0x26], ax);             /* add [bp-0x26], ax */
        l_0x7189:
            ii(0x7189, 3);    mov(ax, memw[ss, bp - 0x16]);             /* mov ax, [bp-0x16] */
            ...
            ii(0x71a7, 3);    mov(ax, memw[ss, bp - 0x3e]);             /* mov ax, [bp-0x3e] */
            ...
            ii(0x71c4, 5);    mov(memw[ss, bp - 0x6], 0);               /* mov word [bp-0x6], 0x0 */
            ii(0x71c9, 5);    mov(memw[ss, bp - 0x4], 0x8);             /* mov word [bp-0x4], 0x8 */
            ii(0x71ce, 5);    mov(memw[ss, bp - 0x42], 0);              /* mov word [bp-0x42], 0x0 */
            ii(0x71d3, 5);    mov(memw[ss, bp - 0x40], 0x50);           /* mov word [bp-0x40], 0x50 */
            ii(0x71d8, 3);    mov(es, memw[ss, bp - 0x4]);              /* mov es, [bp-0x4] */
        l_0x71db:
            ii(0x71db, 5);    sub(memw[ds, 0x11ee], 0x8);               /* sub word [0x11ee], 0x8 */
            ii(0x71e0, 4);    mov(bx, memw[ds, 0x11ee]);                /* mov bx, [0x11ee] */
            ii(0x71e4, 3);    and(bl, 0xf8);                            /* and bl, 0xf8 */
            ii(0x71e7, 3);    add(bx, memw[ss, bp - 0x6]);              /* add bx, [bp-0x6] */
            ii(0x71ea, 5);    cmp(memb[es, bx + 0x5], 0);               /* cmp byte [es:bx+0x5], 0x0 */
            ii(0x71ef, 2);    if(jz(0x71db, -0x16)) goto l_0x71db;      /* jz 0x71db */
            ii(0x71f1, 3);    mov(ax, memw[ds, 0x11f2]);                /* mov ax, [0x11f2] */
            ii(0x71f4, 3);    mov(memw[ss, bp - 0x18], ax);             /* mov [bp-0x18], ax */
        l_0x71f7:
            ii(0x71f7, 3);    mov(ax, memw[ss, bp - 0x18]);             /* mov ax, [bp-0x18] */
            ii(0x71fa, 3);    mov(memw[ss, bp - 0x1c], ax);             /* mov [bp-0x1c], ax */
            ii(0x71fd, 2);    and(al, 0xf8);                            /* and al, 0xf8 */
            ii(0x71ff, 3);    add(ax, memw[ss, bp - 0x6]);              /* add ax, [bp-0x6] */
            ii(0x7202, 3);    mov(dx, memw[ss, bp - 0x4]);              /* mov dx, [bp-0x4] */
            ...
            ii(0x7223, 3);    mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ii(0x7226, 2);    or(ax, ax);                               /* or ax, ax */
            ii(0x7228, 2);    if(jnz(0x722d, 0x3)) goto l_0x722d;       /* jnz 0x722d */
        ...
        l_0x722d:
            ...
            ii(0x7233, 3);    mov(memw[ss, bp - 0x4a], ax);             /* mov [bp-0x4a], ax */
            ii(0x7236, 2);    sub(di, di);                              /* sub di, di */
            ii(0x7238, 2);    or(si, si);                               /* or si, si */
            ii(0x723a, 2);    if(jz(0x7243, 0x7)) goto l_0x7243;        /* jz 0x7243 */
        ...
        l_0x7243:
            ...
            ii(0x7248, 2);    if(jz(0x724c, 0x2)) goto l_0x724c;        /* jz 0x724c */
            ii(0x724a, 2);    sub(si, si);                              /* sub si, si */
        l_0x724c:
            ii(0x724c, 3);    cmp(memw[ss, bp - 0x4a], di);             /* cmp [bp-0x4a], di */
            ii(0x724f, 2);    if(jbe(0x7254, 0x3)) goto l_0x7254;       /* jbe 0x7254 */
            ii(0x7251, 3);    mov(di, memw[ss, bp - 0x4a]);             /* mov di, [bp-0x4a] */
        l_0x7254:
            ...
            ii(0x725e, 2);    if(jnz(0x7263, 0x3)) goto l_0x7263;       /* jnz 0x7263 */
            ii(0x7260, 3);    jmp(0x7368, 0x105); goto l_0x7368;        /* jmp 0x7368 */
        l_0x7263:
            ii(0x7263, 5);    test(memb[ds, 0x11eb], 0x80);             /* test byte [0x11eb], 0x80 */
            ii(0x7268, 2);    if(jnz(0x726d, 0x3)) goto l_0x726d;       /* jnz 0x726d */
            ii(0x726a, 3);    jmp(0x734b, 0xde); goto l_0x734b;         /* jmp 0x734b */
        l_0x726d:
            ii(0x726d, 3);    mov(ax, memw[ss, bp - 0x2e]);             /* mov ax, [bp-0x2e] */
            ii(0x7270, 3);    cmp(memw[ss, bp - 0x18], ax);             /* cmp [bp-0x18], ax */
            ii(0x7273, 2);    if(jz(0x727e, 0x9)) goto l_0x727e;        /* jz 0x727e */
            ii(0x7275, 3);    mov(al, memb[ss, bp - 0x2]);              /* mov al, [bp-0x2] */
            ii(0x7278, 2);    and(al, 0x18);                            /* and al, 0x18 */
            ii(0x727a, 2);    cmp(al, 0x18);                            /* cmp al, 0x18 */
            ii(0x727c, 2);    if(jnz(0x7285, 0x7)) goto l_0x7285;       /* jnz 0x7285 */
        l_0x727e:
            ii(0x727e, 5);    mov(memw[ss, bp - 0x20], 0x7);            /* mov word [bp-0x20], 0x7 */
            ii(0x7283, 2);    jmp(0x728e, 0x9); goto l_0x728e;          /* jmp 0x728e */
        l_0x7285:
            ii(0x7285, 5);    mov(memw[ss, bp - 0x20], 0);              /* mov word [bp-0x20], 0x0 */
            ii(0x728a, 4);    or(memb[ss, bp - 0x2], 0x60);             /* or byte [bp-0x2], 0x60 */
        l_0x728e:
            ii(0x728e, 3);    call(0x4f61, -0x2330);                    /* call 0x4f61 */
            ii(0x7291, 3);    mov(ax, memw[ss, bp - 0x20]);             /* mov ax, [bp-0x20] */
            ii(0x7294, 2);    add(ax, di);                              /* add ax, di */
            ii(0x7296, 3);    mov(memw[ss, bp - 0x1a], ax);             /* mov [bp-0x1a], ax */
            ii(0x7299, 3);    cmp(ax, 0x8);                             /* cmp ax, 0x8 */
            ii(0x729c, 2);    if(jae(0x72a3, 0x5)) goto l_0x72a3;       /* jae 0x72a3 */
            ii(0x729e, 5);    mov(memw[ss, bp - 0x1a], 0x8);            /* mov word [bp-0x1a], 0x8 */
        l_0x72a3:
            ii(0x72a3, 3);    push(memw[ss, bp - 0x1a]);                /* push word [bp-0x1a] */
            ...
            ii(0x72b1, 3);    mov(memw[ss, bp - 0x1a], ax);             /* mov [bp-0x1a], ax */
            ii(0x72b4, 2);    or(ax, ax);                               /* or ax, ax */
            ii(0x72b6, 2);    if(jnz(0x72be, 0x6)) goto l_0x72be;       /* jnz 0x72be */
            ii(0x72b8, 2);    push(0x3);                                /* push 0x3 */
            ii(0x72ba, 3);    call(0x604d, -0x1270);                    /* call 0x604d */
            ii(0x72bd, 1);    pop(bx);                                  /* pop bx */
        l_0x72be:
            ii(0x72be, 3);    mov(ax, memw[ds, 0x1202]);                /* mov ax, [0x1202] */
            ii(0x72c1, 3);    add(ax, memw[ss, bp - 0x20]);             /* add ax, [bp-0x20] */
            ii(0x72c4, 3);    mov(cx, memw[ss, bp - 0x20]);             /* mov cx, [bp-0x20] */
            ...
            ii(0x72d4, 3);    mov(memw[ss, bp - 0x1c], cx);             /* mov [bp-0x1c], cx */
            ii(0x72d7, 4);    cmp(cx, memw[ds, 0x97c]);                 /* cmp cx, [0x97c] */
            ii(0x72db, 2);    if(jb(0x72e3, 0x6)) goto l_0x72e3;        /* jb 0x72e3 */
        l_0x72dd:
            ii(0x72dd, 2);    push(0x4);                                /* push 0x4 */
            ii(0x72df, 3);    call(0x604d, -0x1295);                    /* call 0x604d */
            ii(0x72e2, 1);    pop(bx);                                  /* pop bx */
        l_0x72e3:
            ii(0x72e3, 3);    push(memw[ss, bp - 0x1c]);                /* push word [bp-0x1c] */
            ii(0x72e6, 3);    push(memw[ss, bp - 0x18]);                /* push word [bp-0x18] */
            ...
            ii(0x72f6, 2);    if(jg(0x72fe, 0x6)) goto l_0x72fe;        /* jg 0x72fe */
            ii(0x72f8, 2);    push(0x5);                                /* push 0x5 */
            ii(0x72fa, 3);    call(0x9dbd, 0x2ac0);                     /* call 0x9dbd */
            ii(0x72fd, 1);    pop(bx);                                  /* pop bx */
        l_0x72fe:
            ii(0x72fe, 3);    call(0x572a, -0x1bd7);                    /* call 0x572a */
            ii(0x7301, 3);    mov(bx, memw[ss, bp - 0x1c]);             /* mov bx, [bp-0x1c] */
            ii(0x7304, 3);    and(bl, 0xf8);                            /* and bl, 0xf8 */
            ii(0x7307, 3);    add(bx, memw[ss, bp - 0x6]);              /* add bx, [bp-0x6] */
            ii(0x730a, 3);    mov(es, memw[ss, bp - 0x4]);              /* mov es, [bp-0x4] */
            ii(0x730d, 5);    cmp(memb[es, bx + 0x5], 0);               /* cmp byte [es:bx+0x5], 0x0 */
            ii(0x7312, 2);    if(jz(0x7319, 0x5)) goto l_0x7319;        /* jz 0x7319 */
            ii(0x7314, 3);    call(0x4f61, -0x23b6);                    /* call 0x4f61 */
            ii(0x7317, 2);    jmp(0x72dd, -0x3c); goto l_0x72dd;        /* jmp 0x72dd */
        l_0x7319:
            ii(0x7319, 4);    cmp(memw[ss, bp - 0x20], 0);              /* cmp word [bp-0x20], 0x0 */
            ii(0x731d, 2);    if(jz(0x7346, 0x27)) goto l_0x7346;       /* jz 0x7346 */
            ii(0x731f, 3);    mov(ax, memw[ss, bp - 0x2e]);             /* mov ax, [bp-0x2e] */
            ii(0x7322, 3);    cmp(memw[ss, bp - 0x18], ax);             /* cmp [bp-0x18], ax */
            ii(0x7325, 2);    if(jnz(0x732d, 0x6)) goto l_0x732d;       /* jnz 0x732d */
            ii(0x7327, 3);    mov(ax, memw[ss, bp - 0x1c]);             /* mov ax, [bp-0x1c] */
            ii(0x732a, 3);    mov(memw[ss, bp - 0x2e], ax);             /* mov [bp-0x2e], ax */
        l_0x732d:
            ii(0x732d, 3);    mov(ax, memw[ss, bp - 0x26]);             /* mov ax, [bp-0x26] */
            ii(0x7330, 3);    cmp(memw[ss, bp - 0x18], ax);             /* cmp [bp-0x18], ax */
            ii(0x7333, 2);    if(jnz(0x733b, 0x6)) goto l_0x733b;       /* jnz 0x733b */
            ii(0x7335, 3);    mov(ax, memw[ss, bp - 0x1c]);             /* mov ax, [bp-0x1c] */
            ii(0x7338, 3);    mov(memw[ss, bp - 0x26], ax);             /* mov [bp-0x26], ax */
        l_0x733b:
            ii(0x733b, 3);    push(memw[ss, bp - 0x1a]);                /* push word [bp-0x1a] */
            ii(0x733e, 3);    push(memw[ss, bp - 0x1c]);                /* push word [bp-0x1c] */
            ii(0x7341, 3);    call(0x5c21, -0x1723);                    /* call 0x5c21 */
            ii(0x7344, 1);    pop(bx);                                  /* pop bx */
            ii(0x7345, 1);    pop(bx);                                  /* pop bx */
        l_0x7346:
            ii(0x7346, 3);    inc(memw[ss, bp - 0x1e]);                 /* inc word [bp-0x1e] */
        ...
        l_0x734b:
            ...
            ii(0x735d, 2);    if(jnz(0x7368, 0x9)) goto l_0x7368;       /* jnz 0x7368 */
            ii(0x735f, 3);    call(0x4f61, -0x2401);                    /* call 0x4f61 */
            ii(0x7362, 2);    push(0x6);                                /* push 0x6 */
        ...
        l_0x7368:
            ...
            ii(0x7380, 3);    mov(bx, memw[ss, bp - 0x1c]);             /* mov bx, [bp-0x1c] */
            ii(0x7383, 3);    shr(bx, 0x3);                             /* shr bx, 0x3 */
            ii(0x7386, 3);    add(bx, memw[ss, bp - 0x42]);             /* add bx, [bp-0x42] */
            ii(0x7389, 3);    mov(es, memw[ss, bp - 0x40]);             /* mov es, [bp-0x40] */
            ii(0x738c, 4);    mov(memb[es, bx], 0x1);                   /* mov byte [es:bx], 0x1 */
        l_0x7390:
            ii(0x7390, 5);    test(memb[ds, 0x11eb], 0x40);             /* test byte [0x11eb], 0x40 */
            ii(0x7395, 2);    if(jz(0x73a7, 0x10)) goto l_0x73a7;       /* jz 0x73a7 */
            ii(0x7397, 3);    mov(bx, memw[ss, bp - 0x1c]);             /* mov bx, [bp-0x1c] */
            ii(0x739a, 3);    shr(bx, 0x3);                             /* shr bx, 0x3 */
            ii(0x739d, 3);    add(bx, memw[ss, bp - 0x42]);             /* add bx, [bp-0x42] */
            ii(0x73a0, 3);    mov(es, memw[ss, bp - 0x40]);             /* mov es, [bp-0x40] */
            ii(0x73a3, 4);    or(memb[es, bx], 0x2);                    /* or byte [es:bx], 0x2 */
        l_0x73a7:
            ...
            ii(0x73cc, 3);    mov(ax, memw[ss, bp - 0x1c]);             /* mov ax, [bp-0x1c] */
            ii(0x73cf, 2);    and(al, 0xf8);                            /* and al, 0xf8 */
            ii(0x73d1, 3);    add(ax, memw[ss, bp - 0x6]);              /* add ax, [bp-0x6] */
            ii(0x73d4, 3);    mov(dx, memw[ss, bp - 0x4]);              /* mov dx, [bp-0x4] */
        ...
        l_0x73fd:
            ...
            ii(0x7411, 3);    push(memw[ss, bp - 0x1c]);                /* push word [bp-0x1c] */
            ii(0x7414, 3);    call(0x5c17, -0x1800);                    /* call 0x5c17 */
            ii(0x7417, 3);    add(sp, 0x8);                             /* add sp, 0x8 */
        l_0x741a:
            ii(0x741a, 3);    mov(al, memb[ss, bp - 0x2]);              /* mov al, [bp-0x2] */
            ii(0x741d, 3);    mov(memb[ds, 0x11e9], al);                /* mov [0x11e9], al */
            ii(0x7420, 3);    mov(bx, memw[ss, bp - 0x1c]);             /* mov bx, [bp-0x1c] */
            ii(0x7423, 3);    and(bl, 0xf8);                            /* and bl, 0xf8 */
            ii(0x7426, 3);    add(bx, memw[ss, bp - 0x6]);              /* add bx, [bp-0x6] */
            ii(0x7429, 3);    mov(es, memw[ss, bp - 0x4]);              /* mov es, [bp-0x4] */
            ii(0x742c, 4);    mov(memb[es, bx + 0x5], al);              /* mov [es:bx+0x5], al */
            ii(0x7430, 3);    mov(ax, memw[ss, bp - 0x18]);             /* mov ax, [bp-0x18] */
            ii(0x7433, 3);    cmp(memw[ss, bp - 0x1c], ax);             /* cmp [bp-0x1c], ax */
            ii(0x7436, 2);    if(jz(0x744f, 0x17)) goto l_0x744f;       /* jz 0x744f */
            ii(0x7438, 2);    and(al, 0xf8);                            /* and al, 0xf8 */
            ii(0x743a, 3);    add(ax, memw[ss, bp - 0x6]);              /* add ax, [bp-0x6] */
            ii(0x743d, 3);    mov(dx, memw[ss, bp - 0x4]);              /* mov dx, [bp-0x4] */
        ...
        l_0x744f:
            ...
            ii(0x7452, 4);    add(memw[ss, bp - 0x18], 0x8);            /* add word [bp-0x18], 0x8 */
            ii(0x7456, 3);    cmp(memw[ss, bp - 0x18], ax);             /* cmp [bp-0x18], ax */
            ii(0x7459, 2);    if(ja(0x745e, 0x3)) goto l_0x745e;        /* ja 0x745e */
        ...
        l_0x746e:
            ...
            ii(0x7476, 3);    mov(bx, memw[ss, bp + 0x6]);              /* mov bx, [bp+0x6] */
            ii(0x7479, 3);    mov(memw[ds, bx + 0xe], ax);              /* mov [bx+0xe], ax */
            ii(0x747c, 3);    mov(ax, memw[ss, bp - 0x2e]);             /* mov ax, [bp-0x2e] */
            ii(0x747f, 3);    mov(memw[ds, bx + 0x2], ax);              /* mov [bx+0x2], ax */
            ii(0x7482, 3);    mov(ax, memw[ss, bp - 0x26]);             /* mov ax, [bp-0x26] */
            ii(0x7485, 3);    mov(memw[ds, bx + 0x22], ax);             /* mov [bx+0x22], ax */
            ii(0x7488, 3);    mov(ax, memw[ss, bp - 0x28]);             /* mov ax, [bp-0x28] */
            ii(0x748b, 3);    mov(memw[ds, bx + 0x1e], ax);             /* mov [bx+0x1e], ax */
            ii(0x748e, 3);    mov(ax, memw[ds, 0x11f2]);                /* mov ax, [0x11f2] */
            ii(0x7491, 3);    mov(memw[ds, bx + 0xa], ax);              /* mov [bx+0xa], ax */
            ii(0x7494, 3);    mov(ax, memw[ss, bp - 0x18]);             /* mov ax, [bp-0x18] */
            ii(0x7497, 3);    sub(ax, 0x18);                            /* sub ax, 0x18 */
            ii(0x749a, 3);    mov(memw[ds, bx + 0x8], ax);              /* mov [bx+0x8], ax */
            ii(0x749d, 3);    call(0x4f61, -0x253f);                    /* call 0x4f61 */
            ii(0x74a0, 3);    push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x74a3, 3);    push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ii(0x74a6, 3);    call(0x6d44, -0x765);                     /* call 0x6d44 */
            ii(0x74a9, 1);    pop(bx);                                  /* pop bx */
            ii(0x74aa, 1);    pop(bx);                                  /* pop bx */
            ii(0x74ab, 4);    cmp(memw[ss, bp + 0x4], 0);               /* cmp word [bp+0x4], 0x0 */
        ...
        l_0x74cc:
            ii(0x74cc, 4);    sub(memw[ss, bp - 0x18], 0x8);            /* sub word [bp-0x18], 0x8 */
            ii(0x74d0, 4);    cmp(memw[ss, bp - 0x2a], 0);              /* cmp word [bp-0x2a], 0x0 */
            ii(0x74d4, 2);    if(jz(0x7527, 0x51)) goto l_0x7527;       /* jz 0x7527 */
            ii(0x74d6, 3);    call(0x572a, -0x1daf);                    /* call 0x572a */
            ii(0x74d9, 2);    push(0x1);                                /* push 0x1 */
            ii(0x74db, 3);    call(0x5006, -0x24d8);                    /* call 0x5006 */
            ii(0x74de, 1);    pop(bx);                                  /* pop bx */
            ii(0x74df, 4);    cmp(memw[ss, bp - 0x44], 0);              /* cmp word [bp-0x44], 0x0 */
            ii(0x74e3, 2);    if(jz(0x750a, 0x25)) goto l_0x750a;       /* jz 0x750a */
            ii(0x74e5, 3);    push(memw[ss, bp - 0x44]);                /* push word [bp-0x44] */
            ii(0x74e8, 3);    push(memw[ss, bp - 0x18]);                /* push word [bp-0x18] */
            ii(0x74eb, 3);    mov(ax, memw[ss, bp - 0x44]);             /* mov ax, [bp-0x44] */
            ii(0x74ee, 3);    add(memw[ss, bp - 0x2a], ax);             /* add [bp-0x2a], ax */
            ii(0x74f1, 3);    push(memw[ss, bp - 0x2a]);                /* push word [bp-0x2a] */
        ...
        l_0x74fc:
            ii(0x74fc, 3);    push(memw[ss, bp - 0x18]);                /* push word [bp-0x18] */
            ii(0x74ff, 3);    push(memw[ss, bp - 0x2a]);                /* push word [bp-0x2a] */
        ...
        l_0x750a:
            ii(0x750a, 3);    dec(memw[ss, bp - 0x1e]);                 /* dec word [bp-0x1e] */
            ii(0x750d, 2);    if(jns(0x74fc, -0x13)) goto l_0x74fc;     /* jns 0x74fc */
            ii(0x750f, 3);    push(memw[ss, bp - 0x2a]);                /* push word [bp-0x2a] */
            ii(0x7512, 3);    call(0x5826, -0x1cef);                    /* call 0x5826 */
            ii(0x7515, 1);    pop(bx);                                  /* pop bx */
            ii(0x7516, 3);    mov(ax, memw[ss, bp - 0x2a]);             /* mov ax, [bp-0x2a] */
            ii(0x7519, 3);    sub(ax, 0x8);                             /* sub ax, 0x8 */
            ii(0x751c, 3);    mov(bx, memw[ss, bp + 0x6]);              /* mov bx, [bp+0x6] */
            ii(0x751f, 3);    mov(memw[ds, bx + 0x8], ax);              /* mov [bx+0x8], ax */
            ii(0x7522, 3);    call(0x4f61, -0x25c4);                    /* call 0x4f61 */
            ii(0x7525, 2);    jmp(0x756c, 0x45); goto l_0x756c;         /* jmp 0x756c */
        l_0x7527:
            ii(0x7527, 4);    cmp(memw[ss, bp - 0x44], 0);              /* cmp word [bp-0x44], 0x0 */
            ii(0x752b, 2);    if(jz(0x7538, 0xb)) goto l_0x7538;        /* jz 0x7538 */
            ii(0x752d, 3);    push(memw[ss, bp - 0x44]);                /* push word [bp-0x44] */
            ii(0x7530, 3);    push(memw[ss, bp - 0x18]);                /* push word [bp-0x18] */
            ii(0x7533, 3);    call(0x78c1, 0x38b);                      /* call 0x78c1 */
            ii(0x7536, 1);    pop(bx);                                  /* pop bx */
            ii(0x7537, 1);    pop(bx);                                  /* pop bx */
        l_0x7538:
            ii(0x7538, 4);    cmp(memw[ss, bp - 0x1e], 0);              /* cmp word [bp-0x1e], 0x0 */
            ii(0x753c, 2);    if(jle(0x756c, 0x2e)) goto l_0x756c;      /* jle 0x756c */
            ii(0x753e, 3);    push(memw[ss, bp - 0x18]);                /* push word [bp-0x18] */
            ...
            ii(0x754c, 2);    if(jz(0x7554, 0x6)) goto l_0x7554;        /* jz 0x7554 */
            ii(0x754e, 2);    push(0x7);                                /* push 0x7 */
        ...
        l_0x755d:
            ii(0x755d, 3);    push(memw[ss, bp - 0x18]);                /* push word [bp-0x18] */
            ii(0x7560, 3);    call(0x7a3d, 0x4da);                      /* call 0x7a3d */
            ii(0x7563, 1);    pop(bx);                                  /* pop bx */
            ii(0x7564, 3);    call(0x9d53, 0x27ec);                     /* call 0x9d53 */
        l_0x7567:
            ii(0x7567, 3);    dec(memw[ss, bp - 0x1e]);                 /* dec word [bp-0x1e] */
            ii(0x756a, 2);    if(jns(0x755d, -0xf)) goto l_0x755d;      /* jns 0x755d */
        l_0x756c:
            ii(0x756c, 4);    cmp(memw[ss, bp - 0x1e], 0);              /* cmp word [bp-0x1e], 0x0 */
            ii(0x7570, 2);    if(jl(0x7578, 0x6)) goto l_0x7578;        /* jl 0x7578 */
            ii(0x7572, 4);    test(memb[ss, bp - 0x12], 0x1);           /* test byte [bp-0x12], 0x1 */
            ii(0x7576, 2);    if(jz(0x7585, 0xd)) goto l_0x7585;        /* jz 0x7585 */
        l_0x7578:
            ii(0x7578, 4);    cmp(memw[ss, bp - 0x2a], 0);              /* cmp word [bp-0x2a], 0x0 */
            ii(0x757c, 2);    if(jnz(0x7585, 0x7)) goto l_0x7585;       /* jnz 0x7585 */
            ii(0x757e, 3);    push(memw[ss, bp - 0x18]);                /* push word [bp-0x18] */
            ii(0x7581, 3);    call(0x7b02, 0x57e);                      /* call 0x7b02 */
            ii(0x7584, 1);    pop(bx);                                  /* pop bx */
        l_0x7585:
            ii(0x7585, 3);    mov(ax, 0x28);                            /* mov ax, 0x28 */
            ii(0x7588, 3);    mov(bx, memw[ss, bp + 0x6]);              /* mov bx, [bp+0x6] */
            ii(0x758b, 3);    mov(memw[ds, bx + 0x4], ax);              /* mov [bx+0x4], ax */
            ii(0x758e, 3);    mov(memw[ds, bx + 0x6], ax);              /* mov [bx+0x6], ax */
            ii(0x7591, 5);    mov(memw[ds, bx + 0x26], 0x200);          /* mov word [bx+0x26], 0x200 */
            ii(0x7596, 4);    cmp(memw[ss, bp + 0x4], 0);               /* cmp word [bp+0x4], 0x0 */
            ...
            ii(0x75aa, 3);    mov(memw[ss, bp - 0x48], cx);             /* mov [bp-0x48], cx */
            ii(0x75ad, 3);    mov(memw[ss, bp - 0x46], dx);             /* mov [bp-0x46], dx */
