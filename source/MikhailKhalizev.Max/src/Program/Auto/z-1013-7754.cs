...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_7754()
        {
            ...
            ii(0x1013_7769, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1013_776c, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x1013_776f, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1013_7772, 3); mov(memd[ss, ebp - 0x8], ecx);          /* mov [ebp-0x8], ecx */
            ii(0x1013_7775, 3); mov(eax, memd[ss, ebp + 0x10]);         /* mov eax, [ebp+0x10] */
            ii(0x1013_7778, 5); call(/* sys */ 0x1016_a24c, 0x3_2acf);  /* call 0x1016a24c */
            ii(0x1013_777d, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1013_7781, 5); call(Definitions.my_get_res_data_by_id_malloc, -0x359b); /* call 0x101341eb */
            ii(0x1013_7786, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1013_7789, 3); mov(edx, memd[ss, ebp - 0x14]);         /* mov edx, [ebp-0x14] */
            ii(0x1013_778c, 3); mov(eax, memd[ds, edx + 0x4]);          /* mov eax, [edx+0x4] */
            ii(0x1013_778f, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1013_7792, 3); mov(ebx, memd[ss, ebp - 0xc]);          /* mov ebx, [ebp-0xc] */
            ii(0x1013_7795, 3); imul(ebx, eax);                         /* imul ebx, eax */
            ii(0x1013_7798, 3); mov(edx, memd[ss, ebp - 0x14]);         /* mov edx, [ebp-0x14] */
            ii(0x1013_779b, 3); mov(eax, memd[ds, edx + 0x2]);          /* mov eax, [edx+0x2] */
            ii(0x1013_779e, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1013_77a1, 2); add(eax, ebx);                          /* add eax, ebx */
            ii(0x1013_77a3, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1013_77a6, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_77a9, 1); push(eax);                              /* push eax */
            ii(0x1013_77aa, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1013_77ad, 3); add(eax, memd[ss, ebp - 0x18]);         /* add eax, [ebp-0x18] */
            ii(0x1013_77b0, 1); push(eax);                              /* push eax */
            ii(0x1013_77b1, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1013_77b4, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x1013_77b7, 1); push(eax);                              /* push eax */
            ii(0x1013_77b8, 3); mov(edx, memd[ss, ebp - 0x14]);         /* mov edx, [ebp-0x14] */
            ...
            ii(0x1013_77c1, 3); mov(edx, memd[ss, ebp - 0x14]);         /* mov edx, [ebp-0x14] */
            ii(0x1013_77c4, 3); movsx(eax, memw[ds, edx]);              /* movsx eax, word [edx] */
            ii(0x1013_77c7, 1); push(eax);                              /* push eax */
            ii(0x1013_77c8, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ...
            ii(0x1013_77d7, 3); mov(edx, memd[ss, ebp - 0x14]);         /* mov edx, [ebp-0x14] */
            ...
            ii(0x1013_77f0, 4); imul(eax, memd[ss, ebp - 0xc]);         /* imul eax, [ebp-0xc] */
            ii(0x1013_77f4, 3); add(memd[ss, ebp - 0x18], eax);         /* add [ebp-0x18], eax */
            ii(0x1013_77f7, 4); cmp(memd[ss, ebp + 0x10], 0x2);         /* cmp dword [ebp+0x10], 0x2 */
            ii(0x1013_77fb, 2); if(jnz(0x1013_781c, 0x1f)) goto l_0x1013_781c; /* jnz 0x1013781c */
            ii(0x1013_77fd, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_7800, 6); call_abs(memd[ds, 0x101b_ddf4]);        /* call dword [0x101bddf4] */
            ii(0x1013_7806, 3); mov(edx, memd[ss, ebp - 0x14]);         /* mov edx, [ebp-0x14] */
            ...
            ii(0x1013_7817, 3); add(memd[ss, ebp - 0x18], eax);         /* add [ebp-0x18], eax */
            ii(0x1013_781a, 2); jmp(0x1013_7820, 0x4); goto l_0x1013_7820; /* jmp 0x10137820 */
        l_0x1013_781c:
            ii(0x1013_781c, 4); add(memd[ss, ebp - 0x18], 0x5);         /* add dword [ebp-0x18], 0x5 */
        l_0x1013_7820:
            ii(0x1013_7820, 2); push(0x2);                              /* push 0x2 */
            ii(0x1013_7822, 3); mov(ecx, memd[ss, ebp - 0xc]);          /* mov ecx, [ebp-0xc] */
            ii(0x1013_7825, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1013_7828, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x1013_782b, 3); lea(ebx, memd[ds, eax - 0xa]);          /* lea ebx, [eax-0xa] */
            ii(0x1013_782e, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1013_7831, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1013_7834, 3); add(eax, memd[ss, ebp - 0x18]);         /* add eax, [ebp-0x18] */
            ii(0x1013_7837, 6); call_abs(memd[ds, 0x101b_ddec]);        /* call dword [0x101bddec] */
            ii(0x1013_783d, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ...
            ii(0x1013_784a, 3); ret(0x4);                               /* ret 0x4 */
        }
    }
}
