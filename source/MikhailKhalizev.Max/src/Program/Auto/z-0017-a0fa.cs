...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x17_a160:
            ...
            ii(0x17_a1b1, 5); and(memb[es, bx + 0x2c], -2 /* 0xfe */);  /* and byte [es:bx+0x2c], 0xfe */
        ...
        l_0x17_a24d:
            ...
            ii(0x17_a250, 4); add(memw[ss, bp - 0x1e], 2);              /* add word [bp-0x1e], 0x2 */
            ii(0x17_a254, 3); mov(memw[es, bx], si);                    /* mov [es:bx], si */
            ii(0x17_a257, 4); add(memw[ss, bp - 0x16], 1);              /* add word [bp-0x16], 0x1 */
        ...
        l_0x17_a262:
            ...
            ii(0x17_a277, 5); or(memb[es, bx + 0x2c], 1);               /* or byte [es:bx+0x2c], 0x1 */
        l_0x17_a27c:
