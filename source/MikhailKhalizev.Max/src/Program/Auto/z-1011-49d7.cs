...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_49d7()
        {
            ...
            ii(0x1011_49ef, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_49f2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_4a19, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1011_4a1c, 3); mov(al, memb[ds, edx + 0x11]);          /* mov al, [edx+0x11] */
            ii(0x1011_4a1f, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_4a22, 5); mov(eax, 0x3d);                         /* mov eax, 0x3d */
            ii(0x1011_4a27, 5); call(0x1007_5fdc, -0x9_ea50);           /* call 0x10075fdc */
            ii(0x1011_4a2c, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1011_4a2f, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
            ii(0x1011_4a32, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1011_4a35, 6); mov(memb[ds, edx + 0x598], al);         /* mov [edx+0x598], al */
            ...
            ii(0x1011_4a44, 6); lea(ebx, memd[ss, ebp - 0xbc]);         /* lea ebx, [ebp-0xbc] */
            ii(0x1011_4a4a, 5); mov(edx, 0x9);                          /* mov edx, 0x9 */
            ii(0x1011_4a4f, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1011_4a53, 5); call(0x1013_9ade, 0x2_5086);            /* call 0x10139ade */
            ii(0x1011_4a58, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_4a5b, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_4a5d, 6); mov(dl, memb[ds, eax + 0x50f]);         /* mov dl, [eax+0x50f] */
            ii(0x1011_4a63, 5); mov(eax, 0x49);                         /* mov eax, 0x49 */
            ii(0x1011_4a68, 5); call(0x100c_aafc, -0x4_9f71);           /* call 0x100caafc */
            ii(0x1011_4a6d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_4a70, 6); mov(edx, memd[ds, eax + 0x50e]);        /* mov edx, [eax+0x50e] */
            ...
            ii(0x1011_4a83, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_4a86, 6); mov(edx, memd[ds, eax + 0x510]);        /* mov edx, [eax+0x510] */
            ...
            ii(0x1011_4a99, 10); mov(memd[ss, ebp - 0xc0], 0x4);        /* mov dword [ebp-0xc0], 0x4 */
        l_0x1011_4aa3:
            ii(0x1011_4aa3, 6); dec(memd[ss, ebp - 0xc0]);              /* dec dword [ebp-0xc0] */
            ii(0x1011_4aa9, 8); cmp(memw[ss, ebp - 0xc0], -0x1 /* 0xff */); /* cmp word [ebp-0xc0], 0xffff */
            ii(0x1011_4ab1, 2); if(jz(0x1011_4ad5, 0x22)) goto l_0x1011_4ad5; /* jz 0x10114ad5 */
            ii(0x1011_4ab3, 7); movsx(eax, memw[ss, ebp - 0xc0]);       /* movsx eax, word [ebp-0xc0] */
            ii(0x1011_4aba, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_4abc, 4); mov(dl, memb[ds, eax + ebp - 0x1b]);    /* mov dl, [eax+ebp-0x1b] */
            ii(0x1011_4ac0, 7); movsx(eax, memw[ss, ebp - 0xc0]);       /* movsx eax, word [ebp-0xc0] */
            ii(0x1011_4ac7, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x1011_4ac9, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1011_4acc, 7); mov(memw[ds, eax + 0x4e4], dx);         /* mov [eax+0x4e4], dx */
            ii(0x1011_4ad3, 2); jmp(0x1011_4aa3, -0x32); goto l_0x1011_4aa3; /* jmp 0x10114aa3 */
        l_0x1011_4ad5:
            ii(0x1011_4ad5, 5); mov(edx, 0xa);                          /* mov edx, 0xa */
            ii(0x1011_4ada, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_4add, 5); call(0x1011_2a06, -0x20dc);             /* call 0x10112a06 */
            ii(0x1011_4ae2, 6); lea(edx, memd[ss, ebp - 0xbc]);         /* lea edx, [ebp-0xbc] */
            ii(0x1011_4ae8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_4aeb, 5); call(0x1011_46da, -0x416);              /* call 0x101146da */
            ii(0x1011_4af0, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x1011_4af5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_4af8, 5); call(0x1011_3aca, -0x1033);             /* call 0x10113aca */
            ii(0x1011_4afd, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1011_4b01, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_4b04, 5); call(0x1011_3d56, -0xdb3);              /* call 0x10113d56 */
            ii(0x1011_4b09, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1011_4b13:
            ...
            ii(0x1011_4b18, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
