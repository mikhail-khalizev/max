...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_74e8()
        {
            ...
            ii(0x100b_74ff, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100b_7502, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x100b_7505, 7); test(memd[ss, ebp - 4], 4);             /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x100b_7513, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
        ...
        l_0x100b_7522:
            ...
            ii(0x100b_7524, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_7532, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100b_7535, 5); mov(edx, 1);                            /* mov edx, 0x1 */
            ii(0x100b_753a, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100b_753d, 5); call(0x100b_7468, -0xda);               /* call 0x100b7468 */
            ii(0x100b_7542, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100b_7545, 7); test(memd[ss, ebp - 4], 2);             /* test dword [ebp-0x4], 0x2 */
            ii(0x100b_754c, 2); if(jz(0x100b_7556, 8)) goto l_0x100b_7556; /* jz 0x100b7556 */
            ii(0x100b_754e, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100b_7551, 5); call(Definitions.sys_delete, 0xa_ea0e); /* call 0x10165f64 */
        l_0x100b_7556:
            ii(0x100b_7556, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100b_7559, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100b_755c, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
