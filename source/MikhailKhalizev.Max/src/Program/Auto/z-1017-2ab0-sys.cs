...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("e66866e3-cc7f-4c21-92e0-461abbd7be25")]
        public void /* sys */ Method_1017_2ab0()
        {
            ii(0x1017_2ab0, 1); pushd(ebx);                             /* push ebx */
            ii(0x1017_2ab1, 1); pushd(ecx);                             /* push ecx */
            ii(0x1017_2ab2, 1); pushd(edx);                             /* push edx */
            ii(0x1017_2ab3, 7); cmp(memb_a32[ds, 0x101b_e1e0], 0);      /* cmp byte [0x101be1e0], 0x0 */
            ii(0x1017_2aba, 6); if(jnzd(0x1017_2b91, 0xd1)) goto l_0x1017_2b91; /* jnz 0x10172b91 */
            ...
            ii(0x1017_2acc, 5); calld(/* sys */ 0x1018_24f4, 0xfa23);   /* call 0x101824f4 */
            ...
            ii(0x1017_2add, 5); calld(/* sys */ 0x1018_24f4, 0xfa12);   /* call 0x101824f4 */
            ...
            ii(0x1017_2aee, 5); calld(/* sys */ 0x1018_24f4, 0xfa01);   /* call 0x101824f4 */
            ...
            ii(0x1017_2aff, 5); calld(/* sys */ 0x1018_24f4, 0xf9f0);   /* call 0x101824f4 */
            ...
            ii(0x1017_2b10, 5); calld(/* sys */ 0x1018_24f4, 0xf9df);   /* call 0x101824f4 */
            ...
            ii(0x1017_2b21, 5); calld(/* sys */ 0x1018_24f4, 0xf9ce);   /* call 0x101824f4 */
            ...
            ii(0x1017_2b32, 5); calld(/* sys */ 0x1018_24f4, 0xf9bd);   /* call 0x101824f4 */
            ...
            ii(0x1017_2b4b, 5); calld(/* sys */ 0x1018_24f4, 0xf9a4);   /* call 0x101824f4 */
            ...
            ii(0x1017_2b5b, 5); calld(/* sys */ 0x1017_92be, 0x675e);   /* call 0x101792be */
            ii(0x1017_2b60, 7); mov(memw_a32[ds, 0x1020_954a], dx);     /* mov [0x1020954a], dx */
            ii(0x1017_2b67, 5); mov(memd_a32[ds, 0x1020_9546], eax);    /* mov [0x10209546], eax */
            ii(0x1017_2b6c, 5); mov(eax, 0x9);                          /* mov eax, 0x9 */
            ii(0x1017_2b71, 2); mov(dl, 0x1);                           /* mov dl, 0x1 */
            ii(0x1017_2b73, 5); calld(/* sys */ 0x1017_92f0, 0x6778);   /* call 0x101792f0 */
            ii(0x1017_2b78, 6); mov(memb_a32[ds, 0x101b_e1e0], dl);     /* mov [0x101be1e0], dl */
            ii(0x1017_2b7e, 5); calld(/* sys */ 0x1017_2bf0, 0x6d);     /* call 0x10172bf0 */
            ii(0x1017_2b83, 1); sti();                                  /* sti */
            ii(0x1017_2b84, 1); cld();                                  /* cld */
            ii(0x1017_2b85, 5); calld(/* sys */ 0x1017_8d8c, 0x6202);   /* call 0x10178d8c */
            ii(0x1017_2b8a, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1017_2b8c, 5); calld(/* sys */ 0x1017_2cb8, 0x127);    /* call 0x10172cb8 */
        l_0x1017_2b91:
            ii(0x1017_2b91, 1); popd(edx);                              /* pop edx */
            ii(0x1017_2b92, 1); popd(ecx);                              /* pop ecx */
            ii(0x1017_2b93, 1); popd(ebx);                              /* pop ebx */
            ii(0x1017_2b94, 1); retd(); return;                         /* ret */
        }
    }
}
