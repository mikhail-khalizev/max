...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_2abd()
        {
            ...
            ii(0x100c_2ad4, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_2ad7, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100c_2ada, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_2add, 4); cmp(memd[ds, eax + 0x67], 0);           /* cmp dword [eax+0x67], 0x0 */
            ii(0x100c_2ae1, 2); if(jz(0x100c_2b09, 0x26)) goto l_0x100c_2b09; /* jz 0x100c2b09 */
            ii(0x100c_2ae3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_2aee, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_2af1, 3); mov(edx, memd[ds, eax + 0x67]);         /* mov edx, [eax+0x67] */
            ii(0x100c_2af4, 2); add(edx, ebx);                          /* add edx, ebx */
            ii(0x100c_2af6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_2b07, 2); if(jl(0x100c_2b0b, 0x2)) goto l_0x100c_2b0b; /* jl 0x100c2b0b */
        l_0x100c_2b09:
            ii(0x100c_2b09, 2); jmp(0x100c_2b2d, 0x22); goto l_0x100c_2b2d; /* jmp 0x100c2b2d */
        l_0x100c_2b0b:
            ii(0x100c_2b0b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_2b16, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_2b19, 3); mov(edx, memd[ds, eax + 0x67]);         /* mov edx, [eax+0x67] */
            ii(0x100c_2b1c, 2); add(edx, ebx);                          /* add edx, ebx */
            ii(0x100c_2b1e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
