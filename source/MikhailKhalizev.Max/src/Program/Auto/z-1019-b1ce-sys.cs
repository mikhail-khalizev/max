...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_b1ce()
        {
            ...
            ii(0x1019_b1dd, 3); mov(al, memb[ss, ebp + 0]);             /* mov al, [ebp] */
            ii(0x1019_b1e0, 3); cmp(eax, 0x3a);                         /* cmp eax, 0x3a */
            ii(0x1019_b1e3, 2); if(jnz(0x1019_b1e6, 0x1)) goto l_0x1019_b1e6; /* jnz 0x1019b1e6 */
            ii(0x1019_b1e5, 1); inc(ebp);                               /* inc ebp */
        l_0x1019_b1e6:
            ii(0x1019_b1e6, 2); mov(esi, ebp);                          /* mov esi, ebp */
        l_0x1019_b1e8:
            ii(0x1019_b1e8, 3); mov(dl, memb[ss, ebp + 0]);             /* mov dl, [ebp] */
            ...
            ii(0x1019_b205, 2); if(jl(0x1019_b20c, 0x5)) goto l_0x1019_b20c; /* jl 0x1019b20c */
            ii(0x1019_b207, 3); cmp(eax, 0x39);                         /* cmp eax, 0x39 */
            ii(0x1019_b20a, 2); if(jle(0x1019_b20f, 0x3)) goto l_0x1019_b20f; /* jle 0x1019b20f */
        l_0x1019_b20c:
        ...
        l_0x1019_b20f:
            ...
            ii(0x1019_b21a, 2); if(jle(0x1019_b224, 0x8)) goto l_0x1019_b224; /* jle 0x1019b224 */
        ...
        l_0x1019_b224:
            ...
            ii(0x1019_b22c, 1); push(es);                               /* push es */
            ...
            ii(0x1019_b241, 1); pop(es);                                /* pop es */
            ...
            ii(0x1019_b258, 2); if(jnz(0x1019_b261, 0x7)) goto l_0x1019_b261; /* jnz 0x1019b261 */
            ii(0x1019_b25a, 5); mov(ecx, 0x1);                          /* mov ecx, 0x1 */
            ii(0x1019_b25f, 2); jmp(0x1019_b266, 0x5); goto l_0x1019_b266; /* jmp 0x1019b266 */
        l_0x1019_b261:
            ii(0x1019_b261, 3); cmp(eax, 0x2b);                         /* cmp eax, 0x2b */
            ii(0x1019_b264, 2); if(jnz(0x1019_b268, 0x2)) goto l_0x1019_b268; /* jnz 0x1019b268 */
        l_0x1019_b266:
            ii(0x1019_b266, 2); mov(ebp, edx);                          /* mov ebp, edx */
        l_0x1019_b268:
            ii(0x1019_b268, 3); mov(al, memb[ss, ebp + 0]);             /* mov al, [ebp] */
            ...
            ii(0x1019_b289, 4); mov(memd[ss, esp + 0x4], esi);          /* mov [esp+0x4], esi */
            ii(0x1019_b28d, 4); mov(memd[ss, esp + 0x8], esi);          /* mov [esp+0x8], esi */
        ...
        l_0x1019_b2c0:
            ...
            ii(0x1019_b2e7, 2); if(jz(0x1019_b2ed, 0x4)) goto l_0x1019_b2ed; /* jz 0x1019b2ed */
