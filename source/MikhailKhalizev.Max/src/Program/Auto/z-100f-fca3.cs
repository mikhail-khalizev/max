...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_fca3()
        {
            ...
            ii(0x100f_fcb9, 3);  mov(memb[ss, ebp - 4], al);           /* mov [ebp-0x4], al */
            ii(0x100f_fcbc, 3);  mov(memd[ss, ebp - 12], edx);         /* mov [ebp-0xc], edx */
            ii(0x100f_fcbf, 3);  mov(memd[ss, ebp - 8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x100f_fcc2, 4);  movsx(eax, memb[ss, ebp - 4]);        /* movsx eax, byte [ebp-0x4] */
            ii(0x100f_fcc6, 5);  call(0x100e_883d, -0x1_748e);         /* call 0x100e883d */
            ii(0x100f_fccb, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x100f_fcce, 3);  mov(al, memb[ss, ebp - 4]);           /* mov al, [ebp-0x4] */
            ii(0x100f_fcd1, 3);  mov(memb[ss, ebp - 16], al);          /* mov [ebp-0x10], al */
            ii(0x100f_fcd4, 2);  jmp(0x100f_fd2a, 0x54); goto l_0x100f_fd2a;/* jmp 0x100ffd2a */
        l_0x100f_fcd6:
            ii(0x100f_fcd6, 3);  mov(edx, memd[ss, ebp - 20]);         /* mov edx, [ebp-0x14] */
        ...
        l_0x100f_fce5:
            ii(0x100f_fce5, 3);  mov(edx, memd[ss, ebp - 20]);         /* mov edx, [ebp-0x14] */
        ...
        l_0x100f_fcf4:
            ii(0x100f_fcf4, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x100f_fcf8, 1);  push(eax);                            /* push eax */
            ii(0x100f_fcf9, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100f_fcfc, 3);  mov(ecx, memd[ds, eax + 14]);         /* mov ecx, [eax+0xe] */
            ii(0x100f_fcff, 3);  sar(ecx, 0x10);                       /* sar ecx, 0x10 */
            ii(0x100f_fd02, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100f_fd05, 3);  mov(eax, memd[ds, eax + 12]);         /* mov eax, [eax+0xc] */
            ii(0x100f_fd08, 3);  mov(edx, memd[ss, ebp - 20]);         /* mov edx, [ebp-0x14] */
            ii(0x100f_fd0b, 3);  sub(eax, memd[ds, edx + 4]);          /* sub eax, [edx+0x4] */
            ii(0x100f_fd0e, 2);  mov(ebx, eax);                        /* mov ebx, eax */
            ii(0x100f_fd10, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100f_fd13, 3);  mov(eax, memd[ds, eax + 8]);          /* mov eax, [eax+0x8] */
            ii(0x100f_fd16, 3);  mov(edx, memd[ss, ebp - 20]);         /* mov edx, [ebp-0x14] */
            ii(0x100f_fd19, 2);  sub(eax, memd[ds, edx]);              /* sub eax, [edx] */
            ii(0x100f_fd1b, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x100f_fd1d, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100f_fd20, 3);  mov(eax, memd[ds, eax + 22]);         /* mov eax, [eax+0x16] */
        ...
        l_0x100f_fd2a:
            ii(0x100f_fd2a, 3);  mov(al, memb[ss, ebp - 16]);          /* mov al, [ebp-0x10] */
            ii(0x100f_fd2d, 3);  mov(memb[ss, ebp - 24], al);          /* mov [ebp-0x18], al */
            ii(0x100f_fd30, 4);  cmp(memb[ss, ebp - 24], 6);           /* cmp byte [ebp-0x18], 0x6 */
            ii(0x100f_fd34, 2);  if(jb(0x100f_fd44, 0xe)) goto l_0x100f_fd44;/* jb 0x100ffd44 */
            ii(0x100f_fd36, 4);  cmp(memb[ss, ebp - 24], 6);           /* cmp byte [ebp-0x18], 0x6 */
            ii(0x100f_fd3a, 2);  if(jbe(0x100f_fcd6, -0x66)) goto l_0x100f_fcd6;/* jbe 0x100ffcd6 */
            ii(0x100f_fd3c, 4);  cmp(memb[ss, ebp - 24], 9);           /* cmp byte [ebp-0x18], 0x9 */
        ...
        l_0x100f_fd46:
            ii(0x100f_fd46, 5);  cmp(memw[ss, ebp - 8], 0);            /* cmp word [ebp-0x8], 0x0 */
            ii(0x100f_fd4b, 2);  if(jz(0x100f_fd5b, 0xe)) goto l_0x100f_fd5b;/* jz 0x100ffd5b */
            ii(0x100f_fd4d, 3);  mov(edx, memd[ss, ebp - 20]);         /* mov edx, [ebp-0x14] */
            ii(0x100f_fd50, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100f_fd53, 3);  mov(eax, memd[ds, eax + 18]);         /* mov eax, [eax+0x12] */
