...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x100f_fd2a:
            ...
            ii(0x100f_fd30, 4); cmp(memb[ss, ebp - 0x18], 6);           /* cmp byte [ebp-0x18], 0x6 */
            ii(0x100f_fd34, 2); if(jb(0x100f_fd44, 0xe)) goto l_0x100f_fd44; /* jb 0x100ffd44 */
            ii(0x100f_fd36, 4); cmp(memb[ss, ebp - 0x18], 6);           /* cmp byte [ebp-0x18], 0x6 */
            ii(0x100f_fd3a, 2); if(jbe(0x100f_fcd6, -0x66)) goto l_0x100f_fcd6; /* jbe 0x100ffcd6 */
            ii(0x100f_fd3c, 4); cmp(memb[ss, ebp - 0x18], 9);           /* cmp byte [ebp-0x18], 0x9 */
