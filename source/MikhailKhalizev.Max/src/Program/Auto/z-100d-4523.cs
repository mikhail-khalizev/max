...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_4523()
        {
            ...
            ii(0x100d_4535, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x100d_453b, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100d_453e, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_4541, 6);  mov(eax, memd[ds, eax + 141]);        /* mov eax, [eax+0x8d] */
            ii(0x100d_4547, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_454a, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_454d, 3);  mov(edx, memd[ds, eax + 64]);         /* mov edx, [eax+0x40] */
            ii(0x100d_4550, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_4553, 3);  call_abs(memd[ds, edx + 8]);          /* call dword [edx+0x8] */
            ii(0x100d_4556, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_4568, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_456b, 3);  mov(edx, memd[ds, eax + 62]);         /* mov edx, [eax+0x3e] */
            ii(0x100d_456e, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_4571, 6);  mov(memd[ds, eax + 145], edx);        /* mov [eax+0x91], edx */
        l_0x100d_4577:
