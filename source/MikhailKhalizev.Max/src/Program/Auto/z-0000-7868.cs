...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_7868()
        {
            ...
            ii(0x787c, 3);    mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ii(0x787f, 5);    test(memb[es, bx + 0x4], 0xf0);           /* test byte [es:bx+0x4], 0xf0 */
            ii(0x7884, 2);    if(jnz(0x788a, 0x4)) goto l_0x788a;       /* jnz 0x788a */
        ...
        l_0x788a:
            ...
            ii(0x78a3, 3);    mov(ch, memb[ss, bp - 0x2]);              /* mov ch, [bp-0x2] */
