...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_a1c1()
        {
            ...
            ii(0x19_a1c4, 3);  push(memw[ss, bp + 6]);                 /* push word [bp+0x6] */
            ii(0x19_a1c7, 3);  push(memw[ss, bp + 4]);                 /* push word [bp+0x4] */
            ...
            ii(0x19_a1dc, 3);  push(memw[ss, bp + 6]);                 /* push word [bp+0x6] */
            ii(0x19_a1df, 3);  push(memw[ss, bp + 4]);                 /* push word [bp+0x4] */
            ii(0x19_a1e2, 4);  call_far_ind(memw[ds, 0x329c]);         /* call far word [0x329c] */
            ii(0x19_a1e6, 1);  pop(bx);                                /* pop bx */
            ii(0x19_a1e7, 1);  pop(bx);                                /* pop bx */
            ii(0x19_a1e8, 2);  jmp(0x19_a1f3, 9); goto l_0x19_a1f3;    /* jmp 0xa1f3 */
        l_0x19_a1ea:
            ii(0x19_a1ea, 3);  push(memw[ss, bp + 6]);                 /* push word [bp+0x6] */
            ii(0x19_a1ed, 3);  push(memw[ss, bp + 4]);                 /* push word [bp+0x4] */
            ii(0x19_a1f0, 3);  call(0x19_c9e7, 0x27f4);                /* call 0xc9e7 */
        l_0x19_a1f3:
            ii(0x19_a1f3, 1);  leave();                                /* leave */
            ii(0x19_a1f4, 3);  ret(4);                                 /* ret 0x4 */
        }
    }
}
