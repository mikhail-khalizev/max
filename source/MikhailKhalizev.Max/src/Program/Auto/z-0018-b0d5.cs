...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x18_b0ec:
            ...
            ii(0x18_b0ed, 4);  cmp(memb[ss, bp + 22], 0);              /* cmp byte [bp+0x16], 0x0 */
            ii(0x18_b0f1, 2);  if(jz(0x18_b0ff, 0xc)) goto l_0x18_b0ff;/* jz 0xb0ff */
            ii(0x18_b0f3, 5);  mov(memw[ss, bp + 22], 1);              /* mov word [bp+0x16], 0x1 */
            ii(0x18_b0f8, 4);  or(memb[ss, bp + 38], 1);               /* or byte [bp+0x26], 0x1 */
        ...
        l_0x18_b0ff:
            ...
            ii(0x18_b116, 3);  mov(memw[ds, bx + 16], di);             /* mov [bx+0x10], di */
            ii(0x18_b119, 3);  mov(si, memw[ss, bp + 16]);             /* mov si, [bp+0x10] */
            ...
            ii(0x18_b129, 4);  lea(di, memw[ds, bx + 144]);            /* lea di, [bx+0x90] */
            ii(0x18_b12d, 5);  lds(si, memw[es, bx + 134]);            /* lds si, [es:bx+0x86] */
        ...
        l_0x18_b13b:
            ...
            ii(0x18_b140, 5);  lds(si, memw[es, bx + 138]);            /* lds si, [es:bx+0x8a] */
        ...
        l_0x18_b14e:
            ...
            ii(0x18_b154, 5);  lds(si, memw[es, bx + 130]);            /* lds si, [es:bx+0x82] */
        ...
        l_0x18_b169:
            ...
            ii(0x18_b172, 5);  xchg(memw[es, bx + 128], ax);           /* xchg [es:bx+0x80], ax */
        ...
        l_0x18_b27c:
            ...
            ii(0x18_b297, 3);  jmp_func(0x18_b03d, -0x25d);            /* jmp 0xb03d */
        }
    }
}
