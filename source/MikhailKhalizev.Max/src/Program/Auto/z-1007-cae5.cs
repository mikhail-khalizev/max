...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_cae5()
        {
            ...
            ii(0x1007_cafd, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_cb00, 4); mov(memb[ss, ebp - 0x8], 0x6);          /* mov byte [ebp-0x8], 0x6 */
            ii(0x1007_cb04, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
