...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_3a68()
        {
            ...
            ii(0x1010_3a7f, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_3a82, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1010_3a85, 4); or(memb[ss, ebp - 0xc], 0x1);           /* or byte [ebp-0xc], 0x1 */
            ii(0x1010_3a89, 3); lea(eax, memd[ss, ebp - 0x28]);         /* lea eax, [ebp-0x28] */
            ii(0x1010_3a8c, 5); call(0x100e_0720, -0x2_3371);           /* call 0x100e0720 */
            ii(0x1010_3a91, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x1010_3a94, 4); and(memb[ss, ebp - 0xc], -0x2 /* 0xfe */); /* and byte [ebp-0xc], 0xfe */
            ii(0x1010_3a98, 4); or(memb[ss, ebp - 0xc], 0x1);           /* or byte [ebp-0xc], 0x1 */
            ii(0x1010_3a9c, 3); lea(eax, memd[ss, ebp - 0x20]);         /* lea eax, [ebp-0x20] */
            ii(0x1010_3a9f, 5); call(0x100e_0720, -0x2_3384);           /* call 0x100e0720 */
            ii(0x1010_3aa4, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1010_3aa7, 4); and(memb[ss, ebp - 0xc], -0x2 /* 0xfe */); /* and byte [ebp-0xc], 0xfe */
            ii(0x1010_3aab, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_3aae, 5); call(0x1010_380b, -0x2a8);              /* call 0x1010380b */
            ii(0x1010_3ab3, 5); mov(edx, 0x101b_63ec);                  /* mov edx, 0x101b63ec */
            ii(0x1010_3ab8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_3abb, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
            ...
            ii(0x1010_3acd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_3ad0, 5); call(0x1014_60aa, 0x4_25d5);            /* call 0x101460aa */
            ii(0x1010_3ad5, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1010_3ad7, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_3ada, 3); mov(memw[ds, eax], dx);                 /* mov [eax], dx */
            ii(0x1010_3add, 5); mov(edx, StringDefinitions.XShift);     /* mov edx, 0x101a31ef */
            ii(0x1010_3ae2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_3ae5, 5); call(0x1014_60aa, 0x4_25c0);            /* call 0x101460aa */
            ii(0x1010_3aea, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1010_3aed, 4); mov(memw[ds, edx + 0x2], ax);           /* mov [edx+0x2], ax */
            ii(0x1010_3af1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_3af4, 3); mov(ax, memw[ds, eax]);                 /* mov ax, [eax] */
            ii(0x1010_3af7, 4); mov(memw[ss, ebp - 0x14], ax);          /* mov [ebp-0x14], ax */
            ii(0x1010_3afb, 5); mov(ebx, 0x101b_63ec);                  /* mov ebx, 0x101b63ec */
            ii(0x1010_3b00, 3); mov(edx, memd[ss, ebp - 0x16]);         /* mov edx, [ebp-0x16] */
            ii(0x1010_3b03, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1010_3b06, 3); mov(eax, memd[ss, ebp - 0x16]);         /* mov eax, [ebp-0x16] */
            ...
            ii(0x1010_3b1c, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1010_3b1f, 3); mov(memd[ds, edx + 0x4], eax);          /* mov [edx+0x4], eax */
        l_0x1010_3b22:
            ii(0x1010_3b22, 2); xor(ecx, ecx);                          /* xor ecx, ecx */
            ii(0x1010_3b24, 5); mov(ebx, StringDefinitions.Entry);      /* mov ebx, 0x101a31f7 */
            ii(0x1010_3b29, 3); lea(edx, memd[ss, ebp - 0x18]);         /* lea edx, [ebp-0x18] */
            ii(0x1010_3b2c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_3b2f, 5); call(0x1014_625c, 0x4_2728);            /* call 0x1014625c */
            ii(0x1010_3b34, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1010_3b36, 3); lea(eax, memd[ss, ebp - 0x28]);         /* lea eax, [ebp-0x28] */
            ...
            ii(0x1010_3b47, 2); if(jz(0x1010_3b52, 0x9)) goto l_0x1010_3b52; /* jz 0x10103b52 */
            ii(0x1010_3b49, 7); mov(memd[ss, ebp - 0x2c], 0x1);         /* mov dword [ebp-0x2c], 0x1 */
            ii(0x1010_3b50, 2); jmp(0x1010_3b59, 0x7); goto l_0x1010_3b59; /* jmp 0x10103b59 */
        l_0x1010_3b52:
            ii(0x1010_3b52, 7); mov(memd[ss, ebp - 0x2c], 0);           /* mov dword [ebp-0x2c], 0x0 */
        l_0x1010_3b59:
            ii(0x1010_3b59, 3); mov(eax, memd[ss, ebp - 0x2c]);         /* mov eax, [ebp-0x2c] */
            ii(0x1010_3b5c, 3); mov(memd[ss, ebp - 0x30], eax);         /* mov [ebp-0x30], eax */
            ii(0x1010_3b5f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_3b61, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1010_3b64, 5); call(0x100e_03fc, -0x2_376d);           /* call 0x100e03fc */
            ii(0x1010_3b69, 4); cmp(memd[ss, ebp - 0x30], 0);           /* cmp dword [ebp-0x30], 0x0 */
        ...
        l_0x1010_3b88:
            ...
            ii(0x1010_3bb4, 2); if(jz(0x1010_3bbf, 0x9)) goto l_0x1010_3bbf; /* jz 0x10103bbf */
            ii(0x1010_3bb6, 7); mov(memd[ss, ebp - 0x38], 0x1);         /* mov dword [ebp-0x38], 0x1 */
            ii(0x1010_3bbd, 2); jmp(0x1010_3bc6, 0x7); goto l_0x1010_3bc6; /* jmp 0x10103bc6 */
        l_0x1010_3bbf:
            ii(0x1010_3bbf, 7); mov(memd[ss, ebp - 0x38], 0);           /* mov dword [ebp-0x38], 0x0 */
        l_0x1010_3bc6:
            ii(0x1010_3bc6, 3); mov(eax, memd[ss, ebp - 0x38]);         /* mov eax, [ebp-0x38] */
            ii(0x1010_3bc9, 3); mov(memd[ss, ebp - 0x3c], eax);         /* mov [ebp-0x3c], eax */
            ii(0x1010_3bcc, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_3bce, 3); lea(eax, memd[ss, ebp - 0x34]);         /* lea eax, [ebp-0x34] */
            ii(0x1010_3bd1, 5); call(0x100e_03fc, -0x2_37da);           /* call 0x100e03fc */
            ii(0x1010_3bd6, 4); cmp(memd[ss, ebp - 0x3c], 0);           /* cmp dword [ebp-0x3c], 0x0 */
            ...
            ii(0x1010_3be6, 3); mov(memd[ss, ebp - 0x40], eax);         /* mov [ebp-0x40], eax */
            ii(0x1010_3be9, 3); mov(eax, memd[ss, ebp - 0x40]);         /* mov eax, [ebp-0x40] */
            ii(0x1010_3bec, 3); mov(memd[ss, ebp - 0x44], eax);         /* mov [ebp-0x44], eax */
            ii(0x1010_3bef, 4); cmp(memd[ss, ebp - 0x44], 0);           /* cmp dword [ebp-0x44], 0x0 */
            ...
            ii(0x1010_3bf9, 3); mov(eax, memd[ss, ebp - 0x40]);         /* mov eax, [ebp-0x40] */
            ii(0x1010_3bfc, 5); call(0x1010_3069, -0xb98);              /* call 0x10103069 */
            ii(0x1010_3c01, 3); mov(memd[ss, ebp - 0x48], eax);         /* mov [ebp-0x48], eax */
            ii(0x1010_3c04, 3); mov(eax, memd[ss, ebp - 0x48]);         /* mov eax, [ebp-0x48] */
            ii(0x1010_3c07, 3); mov(memd[ss, ebp - 0x4c], eax);         /* mov [ebp-0x4c], eax */
            ii(0x1010_3c0a, 2); jmp(0x1010_3c12, 0x6); goto l_0x1010_3c12; /* jmp 0x10103c12 */
        l_0x1010_3c0c:
            ii(0x1010_3c0c, 3); mov(eax, memd[ss, ebp - 0x44]);         /* mov eax, [ebp-0x44] */
            ii(0x1010_3c0f, 3); mov(memd[ss, ebp - 0x4c], eax);         /* mov [ebp-0x4c], eax */
        l_0x1010_3c12:
            ii(0x1010_3c12, 3); mov(eax, memd[ss, ebp - 0x4c]);         /* mov eax, [ebp-0x4c] */
            ii(0x1010_3c15, 3); mov(memd[ss, ebp - 0x50], eax);         /* mov [ebp-0x50], eax */
            ii(0x1010_3c18, 3); lea(eax, memd[ss, ebp - 0x20]);         /* lea eax, [ebp-0x20] */
            ii(0x1010_3c1b, 5); call(0x1010_48c0, 0xca0);               /* call 0x101048c0 */
            ii(0x1010_3c20, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1010_3c22, 3); mov(eax, memd[ss, ebp - 0x50]);         /* mov eax, [ebp-0x50] */
            ii(0x1010_3c25, 5); call(0x1010_3182, -0xaa8);              /* call 0x10103182 */
            ii(0x1010_3c2a, 3); mov(edx, memd[ss, ebp - 0x50]);         /* mov edx, [ebp-0x50] */
            ii(0x1010_3c2d, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1010_3c31, 3); imul(ebx, eax, 0xa);                    /* imul ebx, eax, 0xa */
            ii(0x1010_3c34, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_3c37, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
        ...
        l_0x1010_3c4b:
            ...
            ii(0x1010_3c4d, 3); lea(eax, memd[ss, ebp - 0x20]);         /* lea eax, [ebp-0x20] */
            ii(0x1010_3c50, 5); call(0x100e_03fc, -0x2_3859);           /* call 0x100e03fc */
            ii(0x1010_3c55, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_3c57, 3); lea(eax, memd[ss, ebp - 0x28]);         /* lea eax, [ebp-0x28] */
