...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_92fd()
        {
            ...
            ii(0x100a_9315, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_9318, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x100a_931f, 2); jmp(0x100a_9327, 0x6); goto l_0x100a_9327; /* jmp 0x100a9327 */
        l_0x100a_9321:
            ii(0x100a_9321, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_9324, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x100a_9327:
            ii(0x100a_9327, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100a_932b, 3); cmp(eax, 0x4);                          /* cmp eax, 0x4 */
            ii(0x100a_932e, 2); if(jge(0x100a_938c, 0x5c)) goto l_0x100a_938c; /* jge 0x100a938c */
            ii(0x100a_9330, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_9333, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ii(0x100a_9336, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100a_933b, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100a_933f, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x100a_9341, 2); if(jz(0x100a_935d, 0x1a)) goto l_0x100a_935d; /* jz 0x100a935d */
            ii(0x100a_9343, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x100a_935b, 2); if(jz(0x100a_935f, 0x2)) goto l_0x100a_935f; /* jz 0x100a935f */
        l_0x100a_935d:
            ii(0x100a_935d, 2); jmp(0x100a_936f, 0x10); goto l_0x100a_936f; /* jmp 0x100a936f */
        l_0x100a_935f:
            ii(0x100a_935f, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100a_9363, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_9366, 5); call(0x1007_6074, -0x3_32f7);           /* call 0x10076074 */
            ii(0x100a_936b, 2); test(al, al);                           /* test al, al */
            ii(0x100a_936d, 2); if(jnz(0x100a_9371, 0x2)) goto l_0x100a_9371; /* jnz 0x100a9371 */
        l_0x100a_936f:
            ii(0x100a_936f, 2); jmp(0x100a_938a, 0x19); goto l_0x100a_938a; /* jmp 0x100a938a */
        l_0x100a_9371:
            ii(0x100a_9371, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100a_9374, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
