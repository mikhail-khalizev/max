...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_4b19()
        {
            ...
            ii(0x1012_4b31, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1012_4b34, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1012_4b36, 5); call(0x100e_883d, -0x3_c2fe);           /* call 0x100e883d */
            ii(0x1012_4b3b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ...
            ii(0x1012_4b4d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1012_4b5e:
            ...
            ii(0x1012_4b74, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1012_4b8b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_4b8e, 3); mov(edx, memd[ds, eax + 0x16]);         /* mov edx, [eax+0x16] */
            ii(0x1012_4b91, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
