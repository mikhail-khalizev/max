...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_8f13()
        {
            ...
            ii(0x100b_8f25, 6); sub(esp, 4);                            /* sub esp, 0x4 */
            ii(0x100b_8f2b, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100b_8f2e, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100b_8f31, 3); add(eax, 6);                            /* add eax, 0x6 */
            ii(0x100b_8f34, 5); call(0x1007_6574, -0x4_29c5);           /* call 0x10076574 */
            ii(0x100b_8f39, 4); mov(dx, memw[ds, eax + 26]);            /* mov dx, [eax+0x1a] */
            ii(0x100b_8f3d, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100b_8f40, 4); mov(memw[ds, eax + 16], dx);            /* mov [eax+0x10], dx */
            ii(0x100b_8f44, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100b_8f47, 3); add(eax, 6);                            /* add eax, 0x6 */
            ii(0x100b_8f4a, 5); call(0x1007_6574, -0x4_29db);           /* call 0x10076574 */
            ii(0x100b_8f4f, 4); mov(dx, memw[ds, eax + 28]);            /* mov dx, [eax+0x1c] */
            ii(0x100b_8f53, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100b_8f56, 4); mov(memw[ds, eax + 18], dx);            /* mov [eax+0x12], dx */
