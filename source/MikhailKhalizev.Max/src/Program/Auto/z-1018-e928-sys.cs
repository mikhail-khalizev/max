...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("6473ef8c-83a4-4afe-b20a-4a27b9f7032a")]
        public void /* sys */ Method_1018_e928()
        {
            ii(0x1018_e928, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1018_e92a, 2); mov(al, memb_a32[ds, esi]);             /* mov al, [esi] */
            ii(0x1018_e92c, 1); inc(esi);                               /* inc esi */
            ii(0x1018_e92d, 8); mov(ax, memw_a32[ds, eax * 2 + 0x101b_eed0]); /* mov ax, [eax*2+0x101beed0] */
