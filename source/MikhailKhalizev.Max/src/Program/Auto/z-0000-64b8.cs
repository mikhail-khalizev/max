...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        //  ii(0x6515, 1);    Недостижимый (и не декодированный) код.
        //    ii(0x6516, 1);    pushw(bp);                                /* push bp */
        ...
        //    ii(0x651f, 3);    mov(di, memw_a16[ss, bp + 0x4]);          /* mov di, [bp+0x4] */
        //    ii(0x6522, 2);    mov(bx, di);                              /* mov bx, di */
        //    ii(0x6524, 3);    mov(cx, memw_a16[ss, bp + 0x8]);          /* mov cx, [bp+0x8] */
        //    ii(0x6527, 2);    if(jcxzw(0x653e, 0x15)) goto l_0x653e;    /* jcxz 0x653e */
        //    ii(0x6529, 3);    mov(al, memb_a16[ss, bp + 0x6]);          /* mov al, [bp+0x6] */
        //    ii(0x652c, 2);    mov(ah, al);                              /* mov ah, al */
        //    ii(0x652e, 4);    test(di, 0x1);                            /* test di, 0x1 */
        //    ii(0x6532, 2);    if(jzw(0x6536, 0x2)) goto l_0x6536;       /* jz 0x6536 */
        //    ii(0x6534, 1);    stosb_a16();                              /* stosb */
        //    ii(0x6535, 1);    dec(cx);                                  /* dec cx */
        l_0x6536:
            ii(0x6536, 2);    shr(cx, 0x1);                             /* shr cx, 1 */
            ii(0x6538, 2);    rep_a16(() => stosw_a16());               /* rep stosw */
            ii(0x653a, 2);    adc(cx, cx);                              /* adc cx, cx */
            ii(0x653c, 2);    rep_a16(() => stosb_a16());               /* rep stosb */
        l_0x653e:
            ii(0x653e, 2);    mov(di, dx);                              /* mov di, dx */
            ii(0x6540, 1);    xchg(bx, ax);                             /* xchg bx, ax */
            ii(0x6541, 1);    popw(bp);                                 /* pop bp */
            ii(0x6542, 1);    retw(); return;                           /* ret */
        }
    }
}
