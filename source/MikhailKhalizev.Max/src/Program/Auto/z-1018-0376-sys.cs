...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_0376()
        {
            ...
            ii(0x1018_0383, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ...
            ii(0x1018_038f, 7); imul(eax, memd[ss, ebp - 12], 0xc0);    /* imul eax, [ebp-0xc], 0xc0 */
            ...
            ii(0x1018_03a3, 5); and(memb[gs, eax + 49], 0x7f);          /* and byte [gs:eax+0x31], 0x7f */
            ii(0x1018_03a8, 7); imul(eax, memd[ss, ebp - 12], 0xc0);    /* imul eax, [ebp-0xc], 0xc0 */
            ...
            ii(0x1018_03bc, 7); mov(memw[gs, eax + 52], 0);             /* mov word [gs:eax+0x34], 0x0 */
