...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_0376()
        {
            ...
            ii(0x1018_0386, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1018_0389, 4); cmp(memd[ss, ebp - 0x8], 0x20);         /* cmp dword [ebp-0x8], 0x20 */
        ...
        l_0x1018_03cc:
            ii(0x1018_03cc, 7); mov(memd[ss, ebp - 0x4], 0xa);          /* mov dword [ebp-0x4], 0xa */
        l_0x1018_03d3:
            ii(0x1018_03d3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
