...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_b6e0()
        {
            ...
            ii(0x1018_b6fa, 3); mov(ebx, memd[ds, eax + 0x4]);          /* mov ebx, [eax+0x4] */
            ii(0x1018_b6fd, 2); test(ebx, ebx);                         /* test ebx, ebx */
            ii(0x1018_b6ff, 2); if(jnz(0x1018_b708, 0x7)) goto l_0x1018_b708; /* jnz 0x1018b708 */
        ...
        l_0x1018_b70f:
            ...
            ii(0x1018_b721, 4); mov(memd[ss, esp + 0x4], eax);          /* mov [esp+0x4], eax */
            ii(0x1018_b725, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1018_b727, 2); if(jz(0x1018_b737, 0xe)) goto l_0x1018_b737; /* jz 0x1018b737 */
            ii(0x1018_b729, 2); if(jge(0x1018_b730, 0x5)) goto l_0x1018_b730; /* jge 0x1018b730 */
            ii(0x1018_b72b, 3); lea(ebx, memd[ds, ecx - 0x1]);          /* lea ebx, [ecx-0x1] */
            ii(0x1018_b72e, 2); jmp(0x1018_b733, 0x3); goto l_0x1018_b733; /* jmp 0x1018b733 */
        l_0x1018_b730:
            ii(0x1018_b730, 3); lea(esi, memd[ds, ecx + 0x1]);          /* lea esi, [ecx+0x1] */
        l_0x1018_b733:
            ii(0x1018_b733, 2); cmp(ebx, esi);                          /* cmp ebx, esi */
            ii(0x1018_b735, 2); if(jge(0x1018_b70f, -0x28)) goto l_0x1018_b70f; /* jge 0x1018b70f */
        l_0x1018_b737:
            ii(0x1018_b737, 4); mov(esi, memd[ss, esp + 0x4]);          /* mov esi, [esp+0x4] */
            ii(0x1018_b73b, 2); test(esi, esi);                         /* test esi, esi */
            ii(0x1018_b73d, 2); if(jnz(0x1018_b748, 0x9)) goto l_0x1018_b748; /* jnz 0x1018b748 */
        ...
        l_0x1018_b748:
            ii(0x1018_b748, 2); if(jge(0x1018_b74f, 0x5)) goto l_0x1018_b74f; /* jge 0x1018b74f */
            ii(0x1018_b74a, 3); mov(eax, memd[ss, esp]);                /* mov eax, [esp] */
            ii(0x1018_b74d, 2); jmp(0x1018_b753, 0x4); goto l_0x1018_b753; /* jmp 0x1018b753 */
        l_0x1018_b74f:
