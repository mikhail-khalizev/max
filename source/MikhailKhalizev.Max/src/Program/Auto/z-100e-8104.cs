...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("6802da35-987b-4c16-890d-5c3f44396f0d")]
        public void Method_100e_8104()
        {
            ii(0x100e_8104, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x100e_8109, 5); calld(Definitions.sys_check_available_stack_size, 0x7dc44); /* call 0x10165d52 */
            ...
            ii(0x100e_8129, 5); calld(0x1013_b0a5, 0x52f77);            /* call 0x1013b0a5 */
            ...
            ii(0x100e_8141, 1); retd(); return;                         /* ret */
        }
    }
}
