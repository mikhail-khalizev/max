...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_513e()
        {
            ...
            ii(0x1019_5145, 2); push(fs);                               /* push fs */
            ii(0x1019_5147, 2); push(gs);                               /* push gs */
            ii(0x1019_5149, 1); push(es);                               /* push es */
        ...
        l_0x1019_5168:
            ii(0x1019_5168, 1); pop(es);                                /* pop es */
            ii(0x1019_5169, 2); pop(gs);                                /* pop gs */
            ii(0x1019_516b, 2); pop(fs);                                /* pop fs */
