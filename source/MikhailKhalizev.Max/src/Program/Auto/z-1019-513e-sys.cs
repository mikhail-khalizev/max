...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("0b691f58-452e-4bae-8eda-d76d33f0c7da")]
        public void /* sys */ Method_1019_513e()
        {
            ii(0x1019_513e, 1); pushd(ebp);                             /* push ebp */
            ii(0x1019_513f, 2); mov(ebp, esp);                          /* mov ebp, esp */
            ii(0x1019_5141, 1); pushd(esi);                             /* push esi */
            ii(0x1019_5142, 1); pushd(edi);                             /* push edi */
            ii(0x1019_5143, 1); pushd(ebx);                             /* push ebx */
            ii(0x1019_5144, 1); pushd(ecx);                             /* push ecx */
            ...
            ii(0x1019_5152, 2); if(jnzd(0x1019_5168, 0x14)) goto l_0x1019_5168; /* jnz 0x10195168 */
            ...
            ii(0x1019_515c, 3); mov(ebx, memd_a32[ss, ebp + 0x8]);      /* mov ebx, [ebp+0x8] */
        ...
        l_0x1019_5168:
            ...
            ii(0x1019_516d, 1); popd(ecx);                              /* pop ecx */
            ii(0x1019_516e, 1); popd(ebx);                              /* pop ebx */
            ii(0x1019_516f, 1); popd(edi);                              /* pop edi */
            ii(0x1019_5170, 1); popd(esi);                              /* pop esi */
            ii(0x1019_5171, 1); popd(ebp);                              /* pop ebp */
            ii(0x1019_5172, 1); retd(); return;                         /* ret */
        }
    }
}
