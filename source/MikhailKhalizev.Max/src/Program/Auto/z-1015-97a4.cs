...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_97a4()
        {
            ...
            ii(0x1015_97bb, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_97be, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1015_97c1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_97d4, 4); cmp(memb[ds, eax + 0x57], 0x8);         /* cmp byte [eax+0x57], 0x8 */
            ii(0x1015_97d8, 2); if(jnz(0x1015_97e3, 0x9)) goto l_0x1015_97e3; /* jnz 0x101597e3 */
            ii(0x1015_97da, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_97dd, 4); mov(memb[ds, eax + 0x57], 0);           /* mov byte [eax+0x57], 0x0 */
            ii(0x1015_97e1, 2); jmp(0x1015_97ea, 0x7); goto l_0x1015_97ea; /* jmp 0x101597ea */
        l_0x1015_97e3:
            ii(0x1015_97e3, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_97e6, 4); mov(memb[ds, eax + 0x57], 0x8);         /* mov byte [eax+0x57], 0x8 */
        l_0x1015_97ea:
