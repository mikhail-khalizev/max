...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_97a4()
        {
            ...
            ii(0x1015_97c4, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1015_97c7, 5); mov(eax, 1);                            /* mov eax, 0x1 */
            ii(0x1015_97cc, 5); call(0x100f_448c, -0x6_5345);           /* call 0x100f448c */
            ii(0x1015_97d1, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1015_97d4, 4); cmp(memb[ds, eax + 87], 8);             /* cmp byte [eax+0x57], 0x8 */
            ii(0x1015_97d8, 2); if(jnz(0x1015_97e3, 9)) goto l_0x1015_97e3; /* jnz 0x101597e3 */
            ii(0x1015_97da, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1015_97dd, 4); mov(memb[ds, eax + 87], 0);             /* mov byte [eax+0x57], 0x0 */
            ii(0x1015_97e1, 2); jmp(0x1015_97ea, 7); goto l_0x1015_97ea; /* jmp 0x101597ea */
        l_0x1015_97e3:
            ii(0x1015_97e3, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1015_97e6, 4); mov(memb[ds, eax + 87], 8);             /* mov byte [eax+0x57], 0x8 */
        l_0x1015_97ea:
