...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_07fa()
        {
            ...
            ii(0x1009_0811, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_0814, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ...
            ii(0x1009_083e, 3); push(memd[ds, eax + 0x4]);              /* push dword [eax+0x4] */
            ii(0x1009_0841, 2); push(memd[ds, eax]);                    /* push dword [eax] */
            ii(0x1009_0843, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_0846, 5); call(0x1009_02f8, -0x553);              /* call 0x100902f8 */
            ii(0x1009_084b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_084e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_0851, 7); mov(memd[ds, eax + 0x23], 0x101b_4658); /* mov dword [eax+0x23], 0x101b4658 */
            ii(0x1009_0858, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_085b, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1009_085e, 3); mov(memd[ds, edx + 0x27], eax);         /* mov [edx+0x27], eax */
            ii(0x1009_0861, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_0864, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1009_0867, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
