...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_09a6()
        {
            ...
            ii(0x1015_09be, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_09c1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_09c4, 4); test(memb[ds, eax + 0x13], 0x2);        /* test byte [eax+0x13], 0x2 */
            ii(0x1015_09c8, 2); if(jz(0x1015_09ef, 0x25)) goto l_0x1015_09ef; /* jz 0x101509ef */
            ii(0x1015_09ca, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_09e3, 4); mov(dx, memw[ds, ebx + 0x8]);           /* mov dx, [ebx+0x8] */
            ii(0x1015_09e7, 3); imul(edx, eax);                         /* imul edx, eax */
            ii(0x1015_09ea, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1015_09ed, 2); jmp(0x1015_0a53, 0x64); goto l_0x1015_0a53; /* jmp 0x10150a53 */
        l_0x1015_09ef:
            ii(0x1015_09ef, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_09f2, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1015_09fd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_0a00, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
        ...
        l_0x1015_0a0b:
            ii(0x1015_0a0b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_0a24, 4); mov(dx, memw[ds, ebx + 0x8]);           /* mov dx, [ebx+0x8] */
            ii(0x1015_0a28, 3); imul(edx, eax);                         /* imul edx, eax */
            ii(0x1015_0a2b, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1015_0a2e, 2); jmp(0x1015_0a53, 0x23); goto l_0x1015_0a53; /* jmp 0x10150a53 */
        l_0x1015_0a30:
            ii(0x1015_0a30, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_0a49, 4); mov(dx, memw[ds, ebx + 0x8]);           /* mov dx, [ebx+0x8] */
            ii(0x1015_0a4d, 3); imul(edx, eax);                         /* imul edx, eax */
            ii(0x1015_0a50, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
        l_0x1015_0a53:
            ii(0x1015_0a53, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
