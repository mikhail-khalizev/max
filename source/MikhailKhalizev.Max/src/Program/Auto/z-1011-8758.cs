...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_8758()
        {
            ...
            ii(0x1011_8770, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_8773, 7); mov(memb[ds, 0x101c_391b], 0x1);        /* mov byte [0x101c391b], 0x1 */
            ii(0x1011_877a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_877d, 4); mov(ax, memw[ds, eax + 0x1a]);          /* mov ax, [eax+0x1a] */
            ii(0x1011_8781, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1011_8784, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_8787, 4); mov(ax, memw[ds, eax + 0x1c]);          /* mov ax, [eax+0x1c] */
            ii(0x1011_878b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_878e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_8791, 4); test(memb[ds, eax + 0x12], 0x20);       /* test byte [eax+0x12], 0x20 */
            ii(0x1011_8795, 2); if(jz(0x1011_87d7, 0x40)) goto l_0x1011_87d7; /* jz 0x101187d7 */
            ii(0x1011_8797, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_879a, 5); call(0x1007_611c, -0xa_2683);           /* call 0x1007611c */
            ii(0x1011_879f, 3); lea(ebx, memd[ss, ebp - 0x10]);         /* lea ebx, [ebp-0x10] */
            ...
            ii(0x1011_87ab, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
            ii(0x1011_87af, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x1011_87b3, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1011_87b6, 5); call(0x1007_6574, -0xa_2247);           /* call 0x10076574 */
            ii(0x1011_87bb, 5); call(0x1014_eb48, 0x3_6388);            /* call 0x1014eb48 */
            ii(0x1011_87c0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_87c3, 5); call(0x1015_f2cc, 0x4_6b04);            /* call 0x1015f2cc */
            ii(0x1011_87c8, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_87ca, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1011_87d7:
            ii(0x1011_87d7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_87da, 5); call(0x1015_48ba, 0x3_c0db);            /* call 0x101548ba */
            ii(0x1011_87df, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_87ef, 4); cmp(ax, memw[ss, ebp - 0xc]);           /* cmp ax, [ebp-0xc] */
            ii(0x1011_87f3, 2); if(jnz(0x1011_880b, 0x16)) goto l_0x1011_880b; /* jnz 0x1011880b */
            ii(0x1011_87f5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_8805, 4); cmp(ax, memw[ss, ebp - 0x8]);           /* cmp ax, [ebp-0x8] */
            ii(0x1011_8809, 2); if(jz(0x1011_883f, 0x34)) goto l_0x1011_883f; /* jz 0x1011883f */
        l_0x1011_880b:
            ii(0x1011_880b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_880e, 4); mov(memb[ds, eax + 0x3e], 0x1);         /* mov byte [eax+0x3e], 0x1 */
            ii(0x1011_8812, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_8815, 5); call(0x1011_9138, 0x91e);               /* call 0x10119138 */
            ii(0x1011_881a, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ...
            ii(0x1011_8832, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1011_883f:
            ...
            ii(0x1011_8841, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_8850, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1011_8853, 5); call(0x1012_0d24, 0x84cc);              /* call 0x10120d24 */
            ii(0x1011_8858, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1011_885a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_8867, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1011_886a, 5); call(0x1012_030c, 0x7a9d);              /* call 0x1012030c */
        l_0x1011_886f:
            ii(0x1011_886f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_887f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_8882, 5); cmp(memw[ds, eax + 0x8], 0x4e);         /* cmp word [eax+0x8], 0x4e */
            ii(0x1011_8887, 2); if(jnz(0x1011_8895, 0xc)) goto l_0x1011_8895; /* jnz 0x10118895 */
            ii(0x1011_8889, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_888c, 5); call(0x1007_611c, -0xa_2775);           /* call 0x1007611c */
            ii(0x1011_8891, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1011_8893, 2); if(jnz(0x1011_8897, 0x2)) goto l_0x1011_8897; /* jnz 0x10118897 */
        l_0x1011_8895:
            ii(0x1011_8895, 2); jmp(0x1011_88f3, 0x5c); goto l_0x1011_88f3; /* jmp 0x101188f3 */
        l_0x1011_8897:
            ii(0x1011_8897, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_889a, 5); call(0x1007_623c, -0xa_2663);           /* call 0x1007623c */
            ii(0x1011_889f, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1011_88a2, 4); mov(dx, memw[ds, edx + 0x52]);          /* mov dx, [edx+0x52] */
            ii(0x1011_88a6, 4); cmp(dx, memw[ds, eax + 0x19]);          /* cmp dx, [eax+0x19] */
            ii(0x1011_88aa, 2); if(jl(0x1011_88b8, 0xc)) goto l_0x1011_88b8; /* jl 0x101188b8 */
            ii(0x1011_88ac, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_88ae, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1011_88b8:
            ii(0x1011_88b8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_88c7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_88ca, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ii(0x1011_88cd, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1011_88cf, 3); movsx(ebx, ax);                         /* movsx ebx, ax */
            ii(0x1011_88d2, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1011_88d6, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1011_88e3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_88e6, 4); mov(memb[ds, eax + 0x3d], 0xf);         /* mov byte [eax+0x3d], 0xf */
            ii(0x1011_88ea, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_88ed, 4); mov(memb[ds, eax + 0x3e], 0);           /* mov byte [eax+0x3e], 0x0 */
        ...
        l_0x1011_88f3:
            ...
            ii(0x1011_88fc, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
