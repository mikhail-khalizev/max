...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_809f()
        {
            ...
            ii(0x100d_80b4, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100d_80b7, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x100d_80ba, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x100d_80bd, 3); mov(memd[ss, ebp - 0x4], ecx);          /* mov [ebp-0x4], ecx */
            ii(0x100d_80c0, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100d_80c3, 3); mov(eax, memd[ds, eax + 0xe]);          /* mov eax, [eax+0xe] */
            ii(0x100d_80c6, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100d_80c9, 1); push(eax);                              /* push eax */
            ii(0x100d_80ca, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100d_80cd, 3); mov(eax, memd[ds, eax + 0xe]);          /* mov eax, [eax+0xe] */
            ii(0x100d_80d0, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100d_80d3, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x100d_80d7, 3); imul(edx, eax);                         /* imul edx, eax */
            ii(0x100d_80da, 2); mov(ebx, edx);                          /* mov ebx, edx */
            ii(0x100d_80dc, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100d_80e0, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100d_80e3, 3); mov(eax, memd[ds, eax + 0x16]);         /* mov eax, [eax+0x16] */
            ii(0x100d_80e6, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x100d_80e8, 2); add(eax, ebx);                          /* add eax, ebx */
            ii(0x100d_80ea, 1); push(eax);                              /* push eax */
            ii(0x100d_80eb, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_80ee, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x100d_80f1, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100d_80f4, 1); push(eax);                              /* push eax */
            ii(0x100d_80f5, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_80f8, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ii(0x100d_80fb, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100d_80fe, 1); push(eax);                              /* push eax */
            ii(0x100d_80ff, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_8102, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x100d_8105, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100d_8108, 1); push(eax);                              /* push eax */
            ii(0x100d_8109, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
