...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("06cf94f4-6c7c-4647-8ee4-564a2c44837a")]
        public void Method_1007_6574()
        {
            ii(0x1007_6574, 5); pushd(0x28);                            /* push 0x28 */
            ii(0x1007_6579, 5); calld(Definitions.sys_check_available_stack_size, 0xef7d4); /* call 0x10165d52 */
        ...
        l_0x1007_65a0:
            ...
            ii(0x1007_65a5, 5); mov(ebx, 0x101a_0040);                  /* mov ebx, 0x101a0040 */ /* "smartptr.h" */
            ii(0x1007_65aa, 5); mov(edx, 0x101a_004b);                  /* mov edx, 0x101a004b */ /* "ptr != 0" */
            ii(0x1007_65af, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1007_65b1, 5); calld(Definitions.sys_assert, 0xef7dc); /* call 0x10165d92 */
