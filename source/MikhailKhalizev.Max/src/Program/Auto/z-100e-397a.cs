...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_397a()
        {
            ...
            ii(0x100e_3991, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_3994, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100e_3997, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_399a, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100e_399d, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100e_39a0, 4); mov(dx, memw[ds, eax + 0x28]);          /* mov dx, [eax+0x28] */
            ii(0x100e_39a4, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100e_39a7, 4); sub(memw[ds, eax + 0x26], dx);          /* sub [eax+0x26], dx */
            ii(0x100e_39ab, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100e_39ae, 3); mov(eax, memd[ds, eax + 0x24]);         /* mov eax, [eax+0x24] */
            ii(0x100e_39b1, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100e_39b4, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100e_39b6, 2); if(jge(0x100e_39c1, 0x9)) goto l_0x100e_39c1; /* jge 0x100e39c1 */
            ii(0x100e_39b8, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100e_39bb, 6); mov(memw[ds, eax + 0x26], 0);           /* mov word [eax+0x26], 0x0 */
        l_0x100e_39c1:
            ii(0x100e_39c1, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x100e_39c6, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
