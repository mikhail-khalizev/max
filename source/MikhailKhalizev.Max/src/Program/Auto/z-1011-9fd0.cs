...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_9fd0()
        {
            ...
            ii(0x1011_9fe7, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1011_9fea, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1011_9fed, 7); test(memd[ss, ebp - 4], 4);             /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x1011_9ffb, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
        ...
        l_0x1011_a00a:
            ii(0x1011_a00a, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1011_a00d, 7); mov(memd[ds, eax + 2], 0x101b_6924);    /* mov dword [eax+0x2], 0x101b6924 */
            ii(0x1011_a014, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_a016, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x1011_a024, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1011_a027, 5); mov(edx, 1);                            /* mov edx, 0x1 */
            ii(0x1011_a02c, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1011_a02f, 5); call(0x1012_02cc, 0x6298);              /* call 0x101202cc */
            ii(0x1011_a034, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1011_a037, 7); test(memd[ss, ebp - 4], 2);             /* test dword [ebp-0x4], 0x2 */
            ii(0x1011_a03e, 2); if(jz(0x1011_a048, 8)) goto l_0x1011_a048; /* jz 0x1011a048 */
            ii(0x1011_a040, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1011_a043, 5); call(Definitions.sys_delete, 0x4_bf1c); /* call 0x10165f64 */
        l_0x1011_a048:
            ii(0x1011_a048, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1011_a04b, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1011_a04e, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
