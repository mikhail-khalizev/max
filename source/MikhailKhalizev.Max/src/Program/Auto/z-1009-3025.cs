...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_3025()
        {
            ...
            ii(0x1009_3037, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1009_303d, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1009_3040, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1009_3043, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1009_3046, 5); call(0x1013_a794, 0xa_7749);            /* call 0x1013a794 */
            ii(0x1009_304b, 3); lea(edx, memd[ds, eax - 6]);            /* lea edx, [eax-0x6] */
            ii(0x1009_304e, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_305e, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1009_3061, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
