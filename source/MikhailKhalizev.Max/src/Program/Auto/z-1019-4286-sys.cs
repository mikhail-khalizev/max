...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x1019_4286, 1); push(ebp);                              /* push ebp */
            ii(0x1019_4287, 2); mov(ebp, esp);                          /* mov ebp, esp */
            ii(0x1019_4289, 1); push(ebx);                              /* push ebx */
            ii(0x1019_428a, 5); mov(edx, 0x3da);                        /* mov edx, 0x3da */
        l_0x1019_428f:
            ii(0x1019_428f, 1); inb(al, dx);                            /* in al, dx */
            ii(0x1019_4290, 2); test(al, 8);                            /* test al, 0x8 */
            ii(0x1019_4292, 2); if(jnz(0x1019_428f, -5)) goto l_0x1019_428f; /* jnz 0x1019428f */
        l_0x1019_4294:
            ii(0x1019_4294, 1); inb(al, dx);                            /* in al, dx */
            ii(0x1019_4295, 2); test(al, 8);                            /* test al, 0x8 */
            ii(0x1019_4297, 2); if(jz(0x1019_4294, -5)) goto l_0x1019_4294; /* jz 0x10194294 */
            ...
            ii(0x1019_42b3, 4); and(memb[ss, ebp + 8], -0x40 /* 0xc0 */); /* and byte [ebp+0x8], 0xc0 */
            ii(0x1019_42b7, 3); or(al, memb[ss, ebp + 8]);              /* or al, [ebp+0x8] */
            ...
            ii(0x1019_42cc, 3); mov(ebx, memd[ss, ebp + 0xc]);          /* mov ebx, [ebp+0xc] */
            ...
            ii(0x1019_42e0, 2); mov(al, 3);                             /* mov al, 0x3 */
            ...
            ii(0x1019_42ea, 2); mov(al, 3);                             /* mov al, 0x3 */
            ii(0x1019_42ec, 3); or(ah, 0x80);                           /* or ah, 0x80 */
            ii(0x1019_42ef, 2); outw(dx, ax);                           /* out dx, ax */
            ii(0x1019_42f1, 2); mov(al, 6);                             /* mov al, 0x6 */
            ii(0x1019_42f3, 3); mov(ah, memb[ds, ebx + 6]);             /* mov ah, [ebx+0x6] */
            ii(0x1019_42f6, 2); outw(dx, ax);                           /* out dx, ax */
            ii(0x1019_42f8, 2); mov(al, 7);                             /* mov al, 0x7 */
            ...
            ii(0x1019_4302, 2); mov(al, 7);                             /* mov al, 0x7 */
            ii(0x1019_4304, 3); and(ah, 0x10);                          /* and ah, 0x10 */
            ii(0x1019_4307, 3); or(ah, memb[ds, ebx + 7]);              /* or ah, [ebx+0x7] */
            ii(0x1019_430a, 2); outw(dx, ax);                           /* out dx, ax */
            ii(0x1019_430c, 2); mov(al, 9);                             /* mov al, 0x9 */
            ...
            ii(0x1019_4316, 2); mov(al, 9);                             /* mov al, 0x9 */
            ii(0x1019_4318, 3); and(ah, 0x40);                          /* and ah, 0x40 */
            ii(0x1019_431b, 3); or(ah, memb[ds, ebx + 9]);              /* or ah, [ebx+0x9] */
            ii(0x1019_431e, 2); outw(dx, ax);                           /* out dx, ax */
            ii(0x1019_4320, 2); mov(al, 0x10);                          /* mov al, 0x10 */
            ii(0x1019_4322, 3); mov(ah, memb[ds, ebx + 0x10]);          /* mov ah, [ebx+0x10] */
