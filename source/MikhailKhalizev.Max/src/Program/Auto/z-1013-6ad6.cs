...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("a809ea49-2db2-4905-b868-c8251e317451")]
        public void Method_1013_6ad6()
        {
            ii(0x1013_6ad6, 5); pushd(0x64);                            /* push 0x64 */
            ii(0x1013_6adb, 5); calld(Definitions.sys_check_available_stack_size, 0x2f272); /* call 0x10165d52 */
            ...
            ii(0x1013_6af6, 5); calld(Definitions.sys_new, 0x2f305);    /* call 0x10165e00 */
            ...
            ii(0x1013_6b32, 5); calld(0x100d_7bdc, -0x5ef5b);           /* call 0x100d7bdc */
        ...
        l_0x1013_6b48:
            ...
            ii(0x1013_6b5b, 5); calld(/* sys */ 0x1016_7dd4, 0x31274);  /* call 0x10167dd4 */
            ...
            ii(0x1013_6b68, 5); calld(/* sys */ 0x1016_7e3c, 0x312cf);  /* call 0x10167e3c */
            ...
            ii(0x1013_6b77, 5); calld(0x100d_7d74, -0x5ee08);           /* call 0x100d7d74 */
            ...
            ii(0x1013_6b82, 5); calld(/* sys */ 0x1016_965c, 0x32ad5);  /* call 0x1016965c */
            ii(0x1013_6b87, 3); lea(edx, ebp - 0x44);                   /* lea edx, [ebp-0x44] */
            ii(0x1013_6b8a, 3); mov(eax, memd_a32[ss, ebp - 0x1c]);     /* mov eax, [ebp-0x1c] */
            ii(0x1013_6b8d, 5); calld(0x100d_7f6c, -0x5ec26);           /* call 0x100d7f6c */
            ...
            ii(0x1013_6ba3, 5); calld(Definitions.my_dtor_d3, -0x5ee75); /* call 0x100d7d33 */
            ii(0x1013_6ba8, 5); calld(Definitions.sys_delete, 0x2f3b7); /* call 0x10165f64 */
        ...
        l_0x1013_6bb9:
            ...
            ii(0x1013_6bbf, 5); calld(Definitions.sys_delete, 0x2f3a0); /* call 0x10165f64 */
            ...
            ii(0x1013_6bca, 5); calld(Definitions.sys_delete, 0x2f395); /* call 0x10165f64 */
            ...
            ii(0x1013_6be3, 5); calld(Definitions.my_dtor_d6, -0x4bb11); /* call 0x100eb0d7 */
            ii(0x1013_6be8, 5); calld(Definitions.sys_delete, 0x2f377); /* call 0x10165f64 */
