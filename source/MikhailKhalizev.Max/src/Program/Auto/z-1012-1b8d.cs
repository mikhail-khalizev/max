...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_1b8d()
        {
            ...
            ii(0x1012_1ba2, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1012_1ba5, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x1012_1ba8, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1012_1bab, 3); mov(memd[ss, ebp - 0x4], ecx);          /* mov [ebp-0x4], ecx */
            ii(0x1012_1bae, 5); mov(edx, 0x101c_4e54);                  /* mov edx, 0x101c4e54 */
            ii(0x1012_1bb3, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1012_1bb6, 5); call(0x100d_4d78, -0x4_ce43);           /* call 0x100d4d78 */
            ii(0x1012_1bbb, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1012_1bc8, 3); mov(memb[ss, ebp - 0x18], al);          /* mov [ebp-0x18], al */
            ii(0x1012_1bcb, 3); mov(al, memb[ss, ebp - 0x18]);          /* mov al, [ebp-0x18] */
            ii(0x1012_1bce, 3); mov(memb[ss, ebp - 0x14], al);          /* mov [ebp-0x14], al */
            ii(0x1012_1bd1, 5); jmp(0x1012_1ca0, 0xca); goto l_0x1012_1ca0; /* jmp 0x10121ca0 */
        l_0x1012_1bd6:
            ii(0x1012_1bd6, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1012_1be3, 6); lea(eax, memd[ss, ebp - 0xd8]);         /* lea eax, [ebp-0xd8] */
            ...
            ii(0x1012_1bf3, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
        ...
        l_0x1012_1c00:
            ii(0x1012_1c00, 4); movsx(eax, memb[ss, ebp - 0x18]);       /* movsx eax, byte [ebp-0x18] */
            ...
            ii(0x1012_1c12, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1012_1c1f, 6); lea(eax, memd[ss, ebp - 0xd8]);         /* lea eax, [ebp-0xd8] */
        ...
        l_0x1012_1c33:
            ii(0x1012_1c33, 4); movsx(eax, memb[ss, ebp - 0x18]);       /* movsx eax, byte [ebp-0x18] */
            ...
            ii(0x1012_1c45, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1012_1c52, 6); lea(eax, memd[ss, ebp - 0xd8]);         /* lea eax, [ebp-0xd8] */
        ...
        l_0x1012_1c66:
            ...
            ii(0x1012_1c80, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1012_1c8d, 6); lea(eax, memd[ss, ebp - 0xd8]);         /* lea eax, [ebp-0xd8] */
        ...
        l_0x1012_1ca0:
            ii(0x1012_1ca0, 3); mov(al, memb[ss, ebp - 0x14]);          /* mov al, [ebp-0x14] */
            ii(0x1012_1ca3, 6); mov(memb[ss, ebp - 0xdc], al);          /* mov [ebp-0xdc], al */
            ii(0x1012_1ca9, 7); cmp(memb[ss, ebp - 0xdc], 0x49);        /* cmp byte [ebp-0xdc], 0x49 */
            ii(0x1012_1cb0, 2); if(jb(0x1012_1ce2, 0x30)) goto l_0x1012_1ce2; /* jb 0x10121ce2 */
            ii(0x1012_1cb2, 7); cmp(memb[ss, ebp - 0xdc], 0x49);        /* cmp byte [ebp-0xdc], 0x49 */
            ii(0x1012_1cb9, 6); if(jbe(0x1012_1c00, -0xbf)) goto l_0x1012_1c00; /* jbe 0x10121c00 */
            ii(0x1012_1cbf, 7); cmp(memb[ss, ebp - 0xdc], 0x4b);        /* cmp byte [ebp-0xdc], 0x4b */
            ii(0x1012_1cc6, 2); if(jb(0x1012_1ce0, 0x18)) goto l_0x1012_1ce0; /* jb 0x10121ce0 */
            ii(0x1012_1cc8, 7); cmp(memb[ss, ebp - 0xdc], 0x4b);        /* cmp byte [ebp-0xdc], 0x4b */
            ii(0x1012_1ccf, 2); if(jbe(0x1012_1c66, -0x6b)) goto l_0x1012_1c66; /* jbe 0x10121c66 */
            ii(0x1012_1cd1, 7); cmp(memb[ss, ebp - 0xdc], 0x4c);        /* cmp byte [ebp-0xdc], 0x4c */
        ...
        l_0x1012_1ce2:
            ii(0x1012_1ce2, 7); cmp(memb[ss, ebp - 0xdc], 0x36);        /* cmp byte [ebp-0xdc], 0x36 */
        ...
        l_0x1012_1cf1:
            ii(0x1012_1cf1, 3); lea(edx, memd[ss, ebp - 0x1c]);         /* lea edx, [ebp-0x1c] */
            ii(0x1012_1cf4, 6); lea(eax, memd[ss, ebp - 0xe0]);         /* lea eax, [ebp-0xe0] */
            ...
            ii(0x1012_1d0f, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1012_1d12, 3); mov(eax, memd[ds, eax + 0x25]);         /* mov eax, [eax+0x25] */
            ii(0x1012_1d15, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1012_1d18, 1); push(eax);                              /* push eax */
            ii(0x1012_1d19, 4); movsx(ecx, memw[ss, ebp - 0x4]);        /* movsx ecx, word [ebp-0x4] */
            ii(0x1012_1d1d, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
            ii(0x1012_1d21, 6); lea(edx, memd[ss, ebp - 0xd8]);         /* lea edx, [ebp-0xd8] */
            ii(0x1012_1d27, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
