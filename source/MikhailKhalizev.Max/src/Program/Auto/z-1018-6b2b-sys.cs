...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_6b2b()
        {
            ...
            ii(0x1018_6b36, 2); if(jnz(0x1018_6b41, 0x9)) goto l_0x1018_6b41; /* jnz 0x10186b41 */
            ii(0x1018_6b38, 3); mov(edx, memd[ds, edx + 0x8]);          /* mov edx, [edx+0x8] */
        ...
        l_0x1018_6b41:
            ...
            ii(0x1018_6b47, 2); if(jnz(0x1018_6b51, 0x8)) goto l_0x1018_6b51; /* jnz 0x10186b51 */
        ...
        l_0x1018_6b51:
            ...
            ii(0x1018_6b59, 2); if(jnz(0x1018_6b64, 0x9)) goto l_0x1018_6b64; /* jnz 0x10186b64 */
            ii(0x1018_6b5b, 3); mov(edx, memd[ds, esi + 0x8]);          /* mov edx, [esi+0x8] */
            ii(0x1018_6b5e, 6); mov(memd[ds, 0x101b_de0c], edx);        /* mov [0x101bde0c], edx */
        l_0x1018_6b64:
            ii(0x1018_6b64, 3); mov(edx, memd[ds, eax + 0x4]);          /* mov edx, [eax+0x4] */
            ii(0x1018_6b67, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ii(0x1018_6b6a, 2); test(edx, edx);                         /* test edx, edx */
            ii(0x1018_6b6c, 2); if(jz(0x1018_6b71, 0x3)) goto l_0x1018_6b71; /* jz 0x10186b71 */
            ii(0x1018_6b6e, 3); mov(memd[ds, edx + 0x8], eax);          /* mov [edx+0x8], eax */
        l_0x1018_6b71:
            ii(0x1018_6b71, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1018_6b73, 2); if(jz(0x1018_6b78, 0x3)) goto l_0x1018_6b78; /* jz 0x10186b78 */
            ii(0x1018_6b75, 3); mov(memd[ds, eax + 0x4], edx);          /* mov [eax+0x4], edx */
        l_0x1018_6b78:
