...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_0ebb()
        {
            ...
            ii(0x100b_0ed1, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100b_0ed4, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100b_0ed7, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ii(0x100b_0eda, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ii(0x100b_0ede, 2); if(jnz(0x100b_0f06, 0x26)) goto l_0x100b_0f06; /* jnz 0x100b0f06 */
            ii(0x100b_0ee0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_0ee3, 3); mov(al, memb[ds, eax + 0x4e]);          /* mov al, [eax+0x4e] */
            ii(0x100b_0ee6, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100b_0eeb, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100b_0eed, 2); if(jle(0x100b_0ef5, 0x6)) goto l_0x100b_0ef5; /* jle 0x100b0ef5 */
            ii(0x100b_0eef, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
            ii(0x100b_0ef3, 2); jmp(0x100b_0ef9, 0x4); goto l_0x100b_0ef9; /* jmp 0x100b0ef9 */
        l_0x100b_0ef5:
            ii(0x100b_0ef5, 4); mov(memb[ss, ebp - 0x10], 0);           /* mov byte [ebp-0x10], 0x0 */
        l_0x100b_0ef9:
            ii(0x100b_0ef9, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_0efb, 3); mov(dl, memb[ss, ebp - 0x10]);          /* mov dl, [ebp-0x10] */
            ii(0x100b_0efe, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
