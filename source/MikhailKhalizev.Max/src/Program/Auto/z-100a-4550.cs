...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_4550()
        {
            ...
            ii(0x100a_4561, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100a_4567, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100a_456a, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x100a_456d, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x100a_4570, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
