...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_1565()
        {
            ...
            ii(0x1015_157d, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_1580, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_158e, 2); if(jle(0x1015_1599, 0x9)) goto l_0x1015_1599; /* jle 0x10151599 */
            ii(0x1015_1590, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
        ...
        l_0x1015_1599:
            ...
            ii(0x1015_15af, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
        l_0x1015_15b2:
            ii(0x1015_15b2, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_15b4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_15c2, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_15c5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_15c8, 4); test(memb[ds, eax + 0x13], 0x2);        /* test byte [eax+0x13], 0x2 */
            ii(0x1015_15cc, 6); if(jz(0x1015_16c9, 0xf7)) goto l_0x1015_16c9; /* jz 0x101516c9 */
            ii(0x1015_15d2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_15df, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_15e2, 5); call(0x1015_14ef, -0xf8);               /* call 0x101514ef */
            ii(0x1015_15e7, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1015_15ea, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_15ed, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x1015_15f0, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1015_15f3, 5); call(0x1007_1e00, -0xd_f7f8);           /* call 0x10071e00 */
            ii(0x1015_15f8, 4); sub(memw[ds, ebx + 0x8], ax);           /* sub [ebx+0x8], ax */
            ii(0x1015_15fc, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_1609, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_160c, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x1015_160f, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1015_1612, 5); call(0x1007_1f2e, -0xd_f6e9);           /* call 0x10071f2e */
            ii(0x1015_1617, 4); sub(memw[ds, ebx + 0xe], ax);           /* sub [ebx+0xe], ax */
            ii(0x1015_161b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_1628, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_162b, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x1015_162e, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1015_1631, 5); call(0x1007_1ff5, -0xd_f641);           /* call 0x10071ff5 */
            ii(0x1015_1636, 4); sub(memw[ds, ebx + 0x10], ax);          /* sub [ebx+0x10], ax */
            ii(0x1015_163a, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ii(0x1015_163d, 4); mov(memb[ds, ebx + 0x3e], 0x1);         /* mov byte [ebx+0x3e], 0x1 */
            ii(0x1015_1641, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_1644, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_1646, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ...
            ii(0x1015_165e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_166b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_166e, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ii(0x1015_1671, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1015_1673, 1); cwde();                                 /* cwde */
            ii(0x1015_1674, 5); call(0x1010_11ff, -0x5_047a);           /* call 0x101011ff */
        l_0x1015_1679:
            ii(0x1015_1679, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_167c, 4); mov(ax, memw[ds, eax + 0x33]);          /* mov ax, [eax+0x33] */
            ii(0x1015_1680, 1); inc(eax);                               /* inc eax */
            ii(0x1015_1681, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1015_1684, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_1687, 5); call(0x1014_9b07, -0x7b85);             /* call 0x10149b07 */
            ii(0x1015_168c, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1015_16ba, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x1015_16c9:
            ii(0x1015_16c9, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1015_16cd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_16d0, 5); call(0x1015_1399, -0x33c);              /* call 0x10151399 */
            ii(0x1015_16d5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_16d8, 5); call(0x1015_48ba, 0x31dd);              /* call 0x101548ba */
            ii(0x1015_16dd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_16e0, 4); mov(memb[ds, eax + 0x5e], 0);           /* mov byte [eax+0x5e], 0x0 */
            ii(0x1015_16e4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_16e7, 4); mov(memb[ds, eax + 0x3e], 0xb);         /* mov byte [eax+0x3e], 0xb */
            ii(0x1015_16eb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_16ee, 5); cmp(memw[ds, eax + 0x8], 0x31);         /* cmp word [eax+0x8], 0x31 */
            ...
            ii(0x1015_16ff, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1015_1709:
            ii(0x1015_1709, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1015_170d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_1710, 5); call(0x1015_1172, -0x5a3);              /* call 0x10151172 */
            ii(0x1015_1715, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_1718, 7); mov(ax, memw[ds, eax + 0xd5]);          /* mov ax, [eax+0xd5] */
            ii(0x1015_171f, 5); add(eax, 0x10);                         /* add eax, 0x10 */
            ii(0x1015_1724, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1015_1727, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_172a, 5); call(0x1014_9b07, -0x7c28);             /* call 0x10149b07 */
        l_0x1015_172f:
            ii(0x1015_172f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
