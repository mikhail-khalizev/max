...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_98f1()
        {
            ...
            ii(0x1014_9908, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_990b, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_990e, 4);  cmp(memd[ss, ebp - 8], 0);            /* cmp dword [ebp-0x8], 0x0 */
            ii(0x1014_9912, 2);  if(jz(0x1014_991d, 9)) goto l_0x1014_991d;/* jz 0x1014991d */
            ii(0x1014_9914, 7);  mov(memd[ss, ebp - 12], 0);           /* mov dword [ebp-0xc], 0x0 */
        ...
        l_0x1014_991d:
            ...
            ii(0x1014_9933, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
        l_0x1014_9936:
            ii(0x1014_9936, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_9939, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1014_993c, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1014_9940, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x1014_9942, 2);  if(jl(0x1014_994f, 0xb)) goto l_0x1014_994f;/* jl 0x1014994f */
            ii(0x1014_9944, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_9947, 3);  mov(edx, memd[ss, ebp - 16]);         /* mov edx, [ebp-0x10] */
            ii(0x1014_994a, 3);  cmp(ax, memw[ds, edx]);               /* cmp ax, [edx] */
            ii(0x1014_994d, 2);  if(jl(0x1014_9951, 2)) goto l_0x1014_9951;/* jl 0x10149951 */
        l_0x1014_994f:
            ii(0x1014_994f, 2);  jmp(0x1014_995a, 9); goto l_0x1014_995a;/* jmp 0x1014995a */
        l_0x1014_9951:
            ii(0x1014_9951, 7);  mov(memd[ss, ebp - 20], 0);           /* mov dword [ebp-0x14], 0x0 */
        ...
        l_0x1014_995a:
            ...
            ii(0x1014_9970, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
        l_0x1014_9973:
            ii(0x1014_9973, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1014_9977, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x1014_997a, 3);  add(eax, memd[ss, ebp - 16]);         /* add eax, [ebp-0x10] */
            ii(0x1014_997d, 3);  mov(eax, memd[ds, eax + 2]);          /* mov eax, [eax+0x2] */
            ii(0x1014_9980, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1014_9983, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_9986, 3);  add(eax, memd[ss, ebp - 24]);         /* add eax, [ebp-0x18] */
            ii(0x1014_9989, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1014_998c, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
