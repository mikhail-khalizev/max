...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_ab2f()
        {
            ...
            ii(0x1012_ab66, 7); mov(memd[ss, ebp - 0x8], 0x101c_5c21);  /* mov dword [ebp-0x8], 0x101c5c21 */
            ii(0x1012_ab6d, 5); mov(eax, memd[ds, 0x101c_59cc]);        /* mov eax, [0x101c59cc] */
            ii(0x1012_ab72, 4); mov(dx, memw[ds, eax + 0x14]);          /* mov dx, [eax+0x14] */
            ii(0x1012_ab76, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1012_ab86, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_ab89, 4); mov(memw[ds, eax + 0x2], dx);           /* mov [eax+0x2], dx */
            ...
            ii(0x1012_ab9d, 2); if(jnz(0x1012_aba5, 0x6)) goto l_0x1012_aba5; /* jnz 0x1012aba5 */
            ii(0x1012_ab9f, 4); mov(memb[ss, ebp - 0x4], 0x1);          /* mov byte [ebp-0x4], 0x1 */
            ii(0x1012_aba3, 2); jmp(0x1012_aba9, 0x4); goto l_0x1012_aba9; /* jmp 0x1012aba9 */
        l_0x1012_aba5:
            ii(0x1012_aba5, 4); mov(memb[ss, ebp - 0x4], 0);            /* mov byte [ebp-0x4], 0x0 */
        l_0x1012_aba9:
            ii(0x1012_aba9, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ii(0x1012_abac, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1012_abaf, 3); mov(memb[ds, edx + 0x4], al);           /* mov [edx+0x4], al */
            ii(0x1012_abb2, 5); mov(eax, memd[ds, 0x101c_59cc]);        /* mov eax, [0x101c59cc] */
            ii(0x1012_abb7, 6); lea(edx, eax + 0x21a);                  /* lea edx, [eax+0x21a] */
            ii(0x1012_abbd, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
