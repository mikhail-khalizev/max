...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_03d0()
        {
            ...
            ii(0x1015_03e8, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_03eb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_03ee, 5); call(0x1015_14ef, 0x10fc);              /* call 0x101514ef */
            ii(0x1015_03f3, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1015_03f6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_03f9, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x1015_03fc, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1015_03ff, 5); call(0x1007_1e00, -0xd_e604);           /* call 0x10071e00 */
            ii(0x1015_0404, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_0407, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
