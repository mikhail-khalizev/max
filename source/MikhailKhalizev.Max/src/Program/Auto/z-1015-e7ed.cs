...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_e7ed()
        {
            ...
            ii(0x1015_e805, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_e808, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_e818, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_e81b, 5); call(0x1007_611c, -0xe_8704);           /* call 0x1007611c */
            ii(0x1015_e820, 3); lea(ebx, memd[ss, ebp - 0x8]);          /* lea ebx, [ebp-0x8] */
            ...
            ii(0x1015_e82c, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1015_e82f, 5); call(0x1007_6574, -0xe_82c0);           /* call 0x10076574 */
            ii(0x1015_e834, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1015_e844, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1015_e847, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_e84a, 4); mov(memb[ds, eax + 0x3d], 0);           /* mov byte [eax+0x3d], 0x0 */
            ii(0x1015_e84e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_e851, 4); mov(memb[ds, eax + 0x3e], 0x1);         /* mov byte [eax+0x3e], 0x1 */
            ii(0x1015_e855, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_e857, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_e85a, 5); call(0x1008_a998, -0xd_3ec7);           /* call 0x1008a998 */
            ii(0x1015_e85f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_e86b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_e86e, 5); call(0x1015_26ac, -0xc1c7);             /* call 0x101526ac */
            ii(0x1015_e873, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1015_e876, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1015_e879, 3); mov(ecx, memd[ds, eax + 0x2]);          /* mov ecx, [eax+0x2] */
            ii(0x1015_e87c, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1015_e87f, 5); call(0x1007_65d0, -0xe_82b4);           /* call 0x100765d0 */
            ii(0x1015_e884, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x1015_e886, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1015_e889, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1015_e88c, 3); call_abs(memd[ds, ecx + 0x60]);         /* call dword [ecx+0x60] */
        l_0x1015_e88f:
            ii(0x1015_e88f, 5); mov(edx, 0x101c_37bc);                  /* mov edx, 0x101c37bc */
            ii(0x1015_e894, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_e8a0, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1015_e8a3, 5); call(0x1007_6574, -0xe_8334);           /* call 0x10076574 */
            ii(0x1015_e8a8, 3); mov(al, memb[ds, eax + 0x27]);          /* mov al, [eax+0x27] */
            ii(0x1015_e8ab, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x1015_e8b0, 1); push(eax);                              /* push eax */
            ii(0x1015_e8b1, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_e8b4, 3); push(memd[ds, eax + 0x17]);             /* push dword [eax+0x17] */
            ...
            ii(0x1015_e8bd, 6); lea(eax, memd[ss, ebp - 0x1a0]);        /* lea eax, [ebp-0x1a0] */
            ...
            ii(0x1015_e8e2, 6); lea(eax, memd[ss, ebp - 0x1a0]);        /* lea eax, [ebp-0x1a0] */
            ii(0x1015_e8e8, 5); call(0x1011_5d23, -0x4_8bca);           /* call 0x10115d23 */
        l_0x1015_e8ed:
            ii(0x1015_e8ed, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_e8ef, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
