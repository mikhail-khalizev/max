...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_8426()
        {
            ...
            ii(0x842c, 3);    lea(ax, memw[ss, bp - 0x34]);             /* lea ax, [bp-0x34] */
            ii(0x842f, 1);    push(ax);                                 /* push ax */
            ii(0x8430, 3);    push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x8433, 3);    push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ii(0x8436, 3);    call(0x9cd1, 0x1898);                     /* call 0x9cd1 */
            ii(0x8439, 3);    add(sp, 0x8);                             /* add sp, 0x8 */
            ii(0x843c, 4);    mov(memb[ss, bp - 0x1d], 0);              /* mov byte [bp-0x1d], 0x0 */
            ii(0x8440, 5);    cmp(memb[ds, 0xcee], 0x4);                /* cmp byte [0xcee], 0x4 */
            ii(0x8445, 2);    if(jge(0x8472, 0x2b)) goto l_0x8472;      /* jge 0x8472 */
            ii(0x8447, 3);    push(0xeee);                              /* push 0xeee */
            ii(0x844a, 3);    lea(ax, memw[ss, bp - 0x22]);             /* lea ax, [bp-0x22] */
            ...
            ii(0x8457, 3);    mov(ax, memw[ss, bp - 0x8]);              /* mov ax, [bp-0x8] */
            ii(0x845a, 3);    mov(dx, memw[ss, bp - 0x6]);              /* mov dx, [bp-0x6] */
        ...
        l_0x8472:
            ...
            ii(0x8474, 3);    lea(ax, memw[ss, bp - 0x3e]);             /* lea ax, [bp-0x3e] */
            ii(0x8477, 1);    push(ax);                                 /* push ax */
            ii(0x8478, 3);    push(0xc8);                               /* push 0xc8 */
            ii(0x847b, 3);    push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ii(0x847e, 3);    call(0x9cd1, 0x1850);                     /* call 0x9cd1 */
            ii(0x8481, 3);    add(sp, 0x8);                             /* add sp, 0x8 */
            ii(0x8484, 5);    cmp(memw[ss, bp - 0x3e], 0xff2e);         /* cmp word [bp-0x3e], 0xff2e */
            ii(0x8489, 2);    if(jnz(0x84a0, 0x15)) goto l_0x84a0;      /* jnz 0x84a0 */
            ii(0x848b, 4);    cmp(memb[ss, bp - 0x39], 0x24);           /* cmp byte [bp-0x39], 0x24 */
            ii(0x848f, 2);    if(jnz(0x84a0, 0xf)) goto l_0x84a0;       /* jnz 0x84a0 */
            ii(0x8491, 3);    push(memw[ss, bp - 0x38]);                /* push word [bp-0x38] */
