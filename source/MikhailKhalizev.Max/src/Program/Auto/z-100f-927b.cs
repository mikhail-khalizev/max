...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("ee7e4c8a-324c-45f8-90f8-4a5a8e036b06")]
        public void Method_100f_927b()
        {
            ...
            ii(0x100f_9290, 3); mov(memd_a32[ss, ebp - 0x10], eax);     /* mov [ebp-0x10], eax */
            ii(0x100f_9293, 3); mov(memd_a32[ss, ebp - 0xc], edx);      /* mov [ebp-0xc], edx */
            ii(0x100f_9296, 3); mov(memd_a32[ss, ebp - 0x8], ebx);      /* mov [ebp-0x8], ebx */
            ii(0x100f_9299, 3); mov(memd_a32[ss, ebp - 0x4], ecx);      /* mov [ebp-0x4], ecx */
            ii(0x100f_929c, 3); mov(eax, memd_a32[ss, ebp - 0x10]);     /* mov eax, [ebp-0x10] */
            ii(0x100f_929f, 3); cmp(eax, memd_a32[ss, ebp - 0xc]);      /* cmp eax, [ebp-0xc] */
            ii(0x100f_92a2, 2); if(jnzd(0x100f_92e4, 0x40)) goto l_0x100f_92e4; /* jnz 0x100f92e4 */
            ...
            ii(0x100f_92bd, 2); if(jzd(0x100f_92c5, 0x6)) goto l_0x100f_92c5; /* jz 0x100f92c5 */
            ii(0x100f_92bf, 4); cmp(memd_a32[ss, ebp - 0xc], 0);        /* cmp dword [ebp-0xc], 0x0 */
            ii(0x100f_92c3, 2); if(jnzd(0x100f_92c7, 0x2)) goto l_0x100f_92c7; /* jnz 0x100f92c7 */
        l_0x100f_92c5:
            ii(0x100f_92c5, 2); jmpd(0x100f_92e2, 0x1b); goto l_0x100f_92e2; /* jmp 0x100f92e2 */
        l_0x100f_92c7:
        ...
        l_0x100f_92e2:
            ii(0x100f_92e2, 2); jmpd(0x100f_92f8, 0x14); goto l_0x100f_92f8; /* jmp 0x100f92f8 */
        l_0x100f_92e4:
            ii(0x100f_92e4, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x100f_92e6, 5); calld(0x100f_448c, -0x4e5f);            /* call 0x100f448c */
            ii(0x100f_92eb, 5); calld(0x100f_f5c1, 0x62d1);             /* call 0x100ff5c1 */
            ii(0x100f_92f0, 3); mov(eax, memd_a32[ss, ebp - 0xc]);      /* mov eax, [ebp-0xc] */
            ii(0x100f_92f3, 5); calld(0x100f_f637, 0x633f);             /* call 0x100ff637 */
        l_0x100f_92f8:
            ii(0x100f_92f8, 2); mov(esp, ebp);                          /* mov esp, ebp */
            ii(0x100f_92fa, 1); popd(ebp);                              /* pop ebp */
            ii(0x100f_92fb, 1); popd(edi);                              /* pop edi */
            ii(0x100f_92fc, 1); popd(esi);                              /* pop esi */
            ii(0x100f_92fd, 1); retd(); return;                         /* ret */
        }
    }
}
