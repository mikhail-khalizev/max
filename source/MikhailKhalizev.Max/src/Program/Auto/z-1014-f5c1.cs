...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_f5c1()
        {
            ...
            ii(0x1014_f5d9, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_f5dc, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_f5df, 4); cmp(memb[ds, eax + 0x3d], 0x2);         /* cmp byte [eax+0x3d], 0x2 */
            ii(0x1014_f5e3, 2); if(jnz(0x1014_f5f6, 0x11)) goto l_0x1014_f5f6; /* jnz 0x1014f5f6 */
            ii(0x1014_f5e5, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_f5e7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_f5f4, 2); if(jz(0x1014_f5f8, 0x2)) goto l_0x1014_f5f8; /* jz 0x1014f5f8 */
        l_0x1014_f5f6:
            ii(0x1014_f5f6, 2); jmp(0x1014_f62b, 0x33); goto l_0x1014_f62b; /* jmp 0x1014f62b */
        l_0x1014_f5f8:
            ii(0x1014_f5f8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_f5fb, 4); cmp(memb[ds, eax + 0x3e], 0x5);         /* cmp byte [eax+0x3e], 0x5 */
            ii(0x1014_f5ff, 2); if(jz(0x1014_f60a, 0x9)) goto l_0x1014_f60a; /* jz 0x1014f60a */
            ii(0x1014_f601, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_f604, 4); cmp(memb[ds, eax + 0x3e], 0x6);         /* cmp byte [eax+0x3e], 0x6 */
            ii(0x1014_f608, 2); if(jnz(0x1014_f60c, 0x2)) goto l_0x1014_f60c; /* jnz 0x1014f60c */
        l_0x1014_f60a:
            ii(0x1014_f60a, 2); jmp(0x1014_f60e, 0x2); goto l_0x1014_f60e; /* jmp 0x1014f60e */
        l_0x1014_f60c:
            ii(0x1014_f60c, 2); jmp(0x1014_f62b, 0x1d); goto l_0x1014_f62b; /* jmp 0x1014f62b */
        l_0x1014_f60e:
            ii(0x1014_f60e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_f611, 3); add(eax, 0x65);                         /* add eax, 0x65 */
            ii(0x1014_f614, 5); call(0x1007_69d8, -0xd_8c41);           /* call 0x100769d8 */
            ii(0x1014_f619, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_f61c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_f61f, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x1014_f622, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_f625, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_f628, 3); call_abs(memd[ds, ebx + 0x20]);         /* call dword [ebx+0x20] */
        l_0x1014_f62b:
