...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_89fc()
        {
            ...
            ii(0x1009_8a14, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_8a17, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_8a1a, 3); mov(eax, memd[ds, eax + 0x1a]);         /* mov eax, [eax+0x1a] */
            ii(0x1009_8a1d, 3); sar(eax, 0x18);                         /* sar eax, 0x18 */
            ii(0x1009_8a20, 3); cmp(eax, 0x3);                          /* cmp eax, 0x3 */
            ii(0x1009_8a23, 2); if(jl(0x1009_8a2b, 0x6)) goto l_0x1009_8a2b; /* jl 0x10098a2b */
            ii(0x1009_8a25, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x1009_8a29, 2); jmp(0x1009_8a2f, 0x4); goto l_0x1009_8a2f; /* jmp 0x10098a2f */
        l_0x1009_8a2b:
            ii(0x1009_8a2b, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x1009_8a2f:
            ii(0x1009_8a2f, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x1009_8a32, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x1009_8a35, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
