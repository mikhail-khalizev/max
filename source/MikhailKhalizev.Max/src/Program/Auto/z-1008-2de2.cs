...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_2de2()
        {
            ...
            ii(0x1008_2df8, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1008_2dfb, 3);  mov(memd[ss, ebp - 8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1008_2dfe, 3);  mov(memd[ss, ebp - 4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1008_2e01, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1008_2e04, 3);  add(eax, 0x20);                       /* add eax, 0x20 */
            ii(0x1008_2e07, 5);  call(0x1008_9d08, 0x6efc);            /* call 0x10089d08 */
            ii(0x1008_2e0c, 3);  lea(ebx, memd[ss, ebp - 36]);         /* lea ebx, [ebp-0x24] */
            ...
            ii(0x1008_2e18, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x1008_2e1b, 5);  call(Definitions.my_ctor_0x101b_4184, -0xc330);/* call 0x10076af0 */
            ii(0x1008_2e20, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_2e23, 5);  mov(memw[ds, eax], 0);                /* mov word [eax], 0x0 */
            ii(0x1008_2e28, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_2e2b, 5);  mov(memw[ds, eax], 0);                /* mov word [eax], 0x0 */
            ii(0x1008_2e30, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_2e32, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x1008_2e43, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
        ...
        l_0x1008_2e50:
            ii(0x1008_2e50, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x1008_2e60, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x1008_2e63, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
            ii(0x1008_2e66, 4);  mov(ax, memw[ds, eax + 26]);          /* mov ax, [eax+0x1a] */
            ii(0x1008_2e6a, 4);  mov(memw[ss, ebp - 24], ax);          /* mov [ebp-0x18], ax */
            ii(0x1008_2e6e, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
            ii(0x1008_2e71, 4);  mov(ax, memw[ds, eax + 28]);          /* mov ax, [eax+0x1c] */
            ii(0x1008_2e75, 4);  mov(memw[ss, ebp - 22], ax);          /* mov [ebp-0x16], ax */
            ii(0x1008_2e79, 2);  jmp(0x1008_2e83, 8); goto l_0x1008_2e83;/* jmp 0x10082e83 */
        l_0x1008_2e7b:
            ii(0x1008_2e7b, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
            ii(0x1008_2e7e, 5);  call(0x1007_6bf8, -0xc28b);           /* call 0x10076bf8 */
        l_0x1008_2e83:
            ii(0x1008_2e83, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_2e85, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
            ...
            ii(0x1008_2e95, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
            ii(0x1008_2e98, 5);  call(0x1008_9acc, 0x6c2f);            /* call 0x10089acc */
            ii(0x1008_2e9d, 5);  call(0x1008_9f70, 0x70ce);            /* call 0x10089f70 */
            ii(0x1008_2ea2, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x1008_2ea5, 4);  cmp(memd[ss, ebp - 32], 0);           /* cmp dword [ebp-0x20], 0x0 */
            ii(0x1008_2ea9, 6);  if(jz(0x1008_2f52, 0xa3)) goto l_0x1008_2f52;/* jz 0x10082f52 */
            ii(0x1008_2eaf, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
            ii(0x1008_2eb2, 5);  call(0x1007_623c, -0xcc7b);           /* call 0x1007623c */
            ii(0x1008_2eb7, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1008_2eba, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x1008_2ebd, 3);  mov(eax, memd[ds, eax + 12]);         /* mov eax, [eax+0xc] */
            ...
            ii(0x1008_2ecb, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
            ii(0x1008_2ece, 5);  call(0x1008_9b34, 0x6c61);            /* call 0x10089b34 */
            ii(0x1008_2ed3, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1008_2ed5, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x1008_2ee4, 3);  lea(edx, memd[ss, ebp - 24]);         /* lea edx, [ebp-0x18] */
            ii(0x1008_2ee7, 3);  lea(eax, memd[ss, ebp - 40]);         /* lea eax, [ebp-0x28] */
            ii(0x1008_2eea, 5);  call(0x1007_5e64, -0xd08b);           /* call 0x10075e64 */
            ii(0x1008_2eef, 3);  mov(ebx, memd[ss, ebp - 32]);         /* mov ebx, [ebp-0x20] */
        ...
        l_0x1008_2eff:
            ...
            ii(0x1008_2f04, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
            ii(0x1008_2f07, 3);  mov(eax, memd[ds, eax + 6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1008_2f16, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x1008_2f19, 3);  mov(edx, memd[ds, eax + 16]);         /* mov edx, [eax+0x10] */
            ii(0x1008_2f1c, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x1008_2f1f, 1);  inc(edx);                             /* inc edx */
            ii(0x1008_2f20, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1008_2f2d, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_2f30, 3);  mov(memw[ds, eax], dx);               /* mov [eax], dx */
            ii(0x1008_2f33, 2);  jmp(0x1008_2f52, 0x1d); goto l_0x1008_2f52;/* jmp 0x10082f52 */
        l_0x1008_2f35:
            ii(0x1008_2f35, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x1008_2f38, 3);  mov(edx, memd[ds, eax + 16]);         /* mov edx, [eax+0x10] */
            ii(0x1008_2f3b, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x1008_2f3e, 1);  inc(edx);                             /* inc edx */
            ii(0x1008_2f3f, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_2f4c, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1008_2f57:
            ...
            ii(0x1008_2f5c, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x1008_2f5f, 3);  mov(edx, memd[ds, edx + 7]);          /* mov edx, [edx+0x7] */
            ...
            ii(0x1008_2f7b, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_2f7e, 3);  mov(ax, memw[ds, eax]);               /* mov ax, [eax] */
            ii(0x1008_2f81, 4);  sub(ax, memw[ds, edx + 23]);          /* sub ax, [edx+0x17] */
            ii(0x1008_2f85, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1008_2f88, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x1008_2f8b, 4);  test(memb[ds, edx + 59], 1);          /* test byte [edx+0x3b], 0x1 */
            ii(0x1008_2f8f, 2);  if(jz(0x1008_2fc0, 0x2f)) goto l_0x1008_2fc0;/* jz 0x10082fc0 */
            ii(0x1008_2f91, 5);  mov(edx, 0x3a);                       /* mov edx, 0x3a */
            ii(0x1008_2f96, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1008_2f99, 3);  mov(eax, memd[ds, eax + 7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1008_2fb1, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_2fb4, 3);  mov(dx, memw[ds, edx]);               /* mov dx, [edx] */
            ii(0x1008_2fb7, 4);  sub(dx, memw[ds, eax + 23]);          /* sub dx, [eax+0x17] */
            ii(0x1008_2fbb, 3);  mov(memd[ss, ebp - 20], edx);         /* mov [ebp-0x14], edx */
            ii(0x1008_2fbe, 2);  jmp(0x1008_2fed, 0x2d); goto l_0x1008_2fed;/* jmp 0x10082fed */
        l_0x1008_2fc0:
            ii(0x1008_2fc0, 5);  mov(edx, 0x44);                       /* mov edx, 0x44 */
            ii(0x1008_2fc5, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1008_2fc8, 3);  mov(eax, memd[ds, eax + 7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1008_2fe0, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_2fe3, 3);  mov(dx, memw[ds, edx]);               /* mov dx, [edx] */
            ii(0x1008_2fe6, 4);  sub(dx, memw[ds, eax + 23]);          /* sub dx, [eax+0x17] */
            ii(0x1008_2fea, 3);  mov(memd[ss, ebp - 20], edx);         /* mov [ebp-0x14], edx */
        l_0x1008_2fed:
            ii(0x1008_2fed, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1008_2ff1, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x1008_2ff3, 2);  if(jle(0x1008_2ffd, 8)) goto l_0x1008_2ffd;/* jle 0x10082ffd */
            ii(0x1008_2ff5, 4);  movsx(eax, memw[ss, ebp - 20]);       /* movsx eax, word [ebp-0x14] */
        ...
        l_0x1008_2ffd:
            ...
            ii(0x1008_2fff, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
        ...
        l_0x1008_3009:
            ii(0x1008_3009, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ii(0x1008_300d, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1008_3011, 5);  call(Definitions.my_min, 0x676e);     /* call 0x10089784 */
            ii(0x1008_3016, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1008_3019, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1008_301c, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ii(0x1008_301f, 3);  sub(memw[ds, edx], ax);               /* sub [edx], ax */
            ii(0x1008_3022, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1008_3025, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_3028, 3);  sub(memw[ds, edx], ax);               /* sub [edx], ax */
            ii(0x1008_302b, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_302d, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
