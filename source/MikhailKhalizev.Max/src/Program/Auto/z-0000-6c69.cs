...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_6c69()
        {
            ...
            ii(0x6c6f, 4);    mov(memb[ss, bp - 0xd], 0x1a);            /* mov byte [bp-0xd], 0x1a */
            ii(0x6c73, 5);    mov(memw[ss, bp - 0x8], 0x80);            /* mov word [bp-0x8], 0x80 */
            ii(0x6c78, 3);    mov(ax, memw[ds, 0xcec]);                 /* mov ax, [0xcec] */
            ii(0x6c7b, 3);    mov(memw[ss, bp - 0x10], ax);             /* mov [bp-0x10], ax */
            ii(0x6c7e, 3);    lea(ax, memw[ss, bp - 0x16]);             /* lea ax, [bp-0x16] */
            ii(0x6c81, 1);    push(ax);                                 /* push ax */
            ii(0x6c82, 3);    lea(ax, memw[ss, bp - 0xe]);              /* lea ax, [bp-0xe] */
            ...
            ii(0x6c94, 5);    cmp(memb[ds, 0x980], 0x1);                /* cmp byte [0x980], 0x1 */
            ii(0x6c99, 2);    if(jz(0x6ca5, 0xa)) goto l_0x6ca5;        /* jz 0x6ca5 */
            ii(0x6c9b, 5);    cmp(memb[ds, 0x980], 0x3);                /* cmp byte [0x980], 0x3 */
            ii(0x6ca0, 2);    if(jz(0x6ca5, 0x3)) goto l_0x6ca5;        /* jz 0x6ca5 */
            ii(0x6ca2, 3);    call(0x9686, 0x29e1);                     /* call 0x9686 */
        l_0x6ca5:
            ii(0x6ca5, 5);    mov(memw[ss, bp - 0x18], 0x2d40);         /* mov word [bp-0x18], 0x2d40 */
            ...
            ii(0x6cb6, 2);    if(jnz(0x6cbd, 0x5)) goto l_0x6cbd;       /* jnz 0x6cbd */
            ii(0x6cb8, 5);    mov(memw[ss, bp - 0x18], 0x29bc);         /* mov word [bp-0x18], 0x29bc */
        l_0x6cbd:
            ii(0x6cbd, 5);    test(memb[ds, 0x14], 0x8);                /* test byte [0x14], 0x8 */
            ii(0x6cc2, 2);    if(jz(0x6cc9, 0x5)) goto l_0x6cc9;        /* jz 0x6cc9 */
            ii(0x6cc4, 5);    mov(memw[ss, bp - 0x18], 0x627f);         /* mov word [bp-0x18], 0x627f */
        l_0x6cc9:
            ii(0x6cc9, 5);    cmp(memw[ds, 0xe6e], 0);                  /* cmp word [0xe6e], 0x0 */
            ii(0x6cce, 2);    if(jz(0x6cd9, 0x9)) goto l_0x6cd9;        /* jz 0x6cd9 */
            ii(0x6cd0, 3);    mov(ax, memw[ss, bp - 0x18]);             /* mov ax, [bp-0x18] */
            ii(0x6cd3, 4);    cmp(memw[ds, 0xe6e], ax);                 /* cmp [0xe6e], ax */
            ii(0x6cd7, 2);    if(jbe(0x6ce8, 0xf)) goto l_0x6ce8;       /* jbe 0x6ce8 */
        l_0x6cd9:
            ii(0x6cd9, 3);    mov(ax, memw[ss, bp - 0x18]);             /* mov ax, [bp-0x18] */
            ii(0x6cdc, 3);    mov(memw[ds, 0xe6e], ax);                 /* mov [0xe6e], ax */
            ii(0x6cdf, 1);    push(ax);                                 /* push ax */
            ii(0x6ce0, 3);    push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
