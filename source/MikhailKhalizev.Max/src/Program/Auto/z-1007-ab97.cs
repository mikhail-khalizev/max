...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_ab97()
        {
            ...
            ii(0x1007_abae, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_abb1, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1007_abb4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_abb7, 5); call(0x1015_09a6, 0xd_5dea);            /* call 0x101509a6 */
            ii(0x1007_abbc, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1007_abbe, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_abc1, 4); sub(memw[ds, eax + 0x21], dx);          /* sub [eax+0x21], dx */
            ii(0x1007_abc5, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_abc8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
