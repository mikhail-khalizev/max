...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_e850()
        {
            ...
            ii(0x100c_e868, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_e86b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_e86e, 4); cmp(memd[ds, eax + 0x10], 0);           /* cmp dword [eax+0x10], 0x0 */
            ii(0x100c_e872, 2); if(jnz(0x100c_e87d, 0x9)) goto l_0x100c_e87d; /* jnz 0x100ce87d */
            ii(0x100c_e874, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x100c_e87b, 2); jmp(0x100c_e88b, 0xe); goto l_0x100c_e88b; /* jmp 0x100ce88b */
        l_0x100c_e87d:
            ii(0x100c_e87d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_e880, 3); mov(eax, memd[ds, eax + 0x10]);         /* mov eax, [eax+0x10] */
            ii(0x100c_e883, 5); call(0x100d_4e8c, 0x6604);              /* call 0x100d4e8c */
            ii(0x100c_e888, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x100c_e88b:
            ii(0x100c_e88b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
