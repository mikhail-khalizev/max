...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_a877()
        {
            ...
            ii(0x1009_a88f, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_a892, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_a894, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_a897, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x1009_a89a, 5); call(0x1008_afe4, -0xf8bb);             /* call 0x1008afe4 */
            ii(0x1009_a89f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
