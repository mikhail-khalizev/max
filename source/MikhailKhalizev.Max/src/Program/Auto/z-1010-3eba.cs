...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_3eba()
        {
            ...
            ii(0x1010_3ed1, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_3ed4, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1010_3ed7, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_3eda, 3);  movsx(ebx, memw[ds, eax]);            /* movsx ebx, word [eax] */
            ii(0x1010_3edd, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1010_3edf, 4);  mov(dx, memw[ss, ebp - 4]);           /* mov dx, [ebp-0x4] */
            ii(0x1010_3ee3, 2);  mov(eax, edx);                        /* mov eax, edx */
            ii(0x1010_3ee5, 3);  sar(edx, 0x1f);                       /* sar edx, 0x1f */
            ii(0x1010_3ee8, 2);  idiv(ebx);                            /* idiv ebx */
            ii(0x1010_3eea, 3);  mov(memd[ss, ebp - 12], edx);         /* mov [ebp-0xc], edx */
            ii(0x1010_3eed, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x1010_3ef1, 3);  imul(ebx, eax, 0xa);                  /* imul ebx, eax, 0xa */
            ii(0x1010_3ef4, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ii(0x1010_3ef7, 3);  mov(eax, memd[ds, edx + 2]);          /* mov eax, [edx+0x2] */
            ...
            ii(0x1010_3f03, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1010_3f06, 5);  call(0x1007_64b8, -0x8_da53);         /* call 0x100764b8 */
        l_0x1010_3f0b:
            ii(0x1010_3f0b, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1010_3f0d, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1010_3f43:
            ii(0x1010_3f43, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1010_3f4d:
            ii(0x1010_3f4d, 7);  mov(memd[ss, ebp - 20], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x1010_3f54, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1010_3f56, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        //  ii(0x1010_3f62, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        //  ii(0x1010_3f65, 5);  call(0x1007_5f6c, -0x8_dffe);         /* call 0x10075f6c */
        l_0x1010_3f6a:
            ii(0x1010_3f6a, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
