...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_f7cf()
        {
            ...
            ii(0x1015_f7e7, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_f7ea, 3); lea(edx, ebp - 0x10);                   /* lea edx, [ebp-0x10] */
            ii(0x1015_f7ed, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_f802, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_f805, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_f810, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1015_f821, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_f824, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1015_f839, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_f846, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_f858, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_f861, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_f873, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_f876, 4); cmp(dx, memw[ds, eax + 0x1c]);          /* cmp dx, [eax+0x1c] */
            ii(0x1015_f87a, 2); if(jz(0x1015_f87e, 0x2)) goto l_0x1015_f87e; /* jz 0x1015f87e */
        l_0x1015_f87c:
            ii(0x1015_f87c, 2); jmp(0x1015_f895, 0x17); goto l_0x1015_f895; /* jmp 0x1015f895 */
        l_0x1015_f87e:
            ii(0x1015_f87e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1015_f895:
            ii(0x1015_f895, 5); cmp(memw[ss, ebp - 0x8], 0xc);          /* cmp word [ebp-0x8], 0xc */
            ii(0x1015_f89a, 2); if(jz(0x1015_f8a3, 0x7)) goto l_0x1015_f8a3; /* jz 0x1015f8a3 */
            ii(0x1015_f89c, 5); cmp(memw[ss, ebp - 0x8], 0x15);         /* cmp word [ebp-0x8], 0x15 */
            ii(0x1015_f8a1, 2); if(jnz(0x1015_f8a5, 0x2)) goto l_0x1015_f8a5; /* jnz 0x1015f8a5 */
        l_0x1015_f8a3:
            ii(0x1015_f8a3, 2); jmp(0x1015_f8ac, 0x7); goto l_0x1015_f8ac; /* jmp 0x1015f8ac */
        l_0x1015_f8a5:
            ii(0x1015_f8a5, 5); cmp(memw[ss, ebp - 0x8], 0x27);         /* cmp word [ebp-0x8], 0x27 */
            ii(0x1015_f8aa, 2); if(jnz(0x1015_f8ae, 0x2)) goto l_0x1015_f8ae; /* jnz 0x1015f8ae */
        l_0x1015_f8ac:
            ii(0x1015_f8ac, 2); jmp(0x1015_f8b5, 0x7); goto l_0x1015_f8b5; /* jmp 0x1015f8b5 */
        l_0x1015_f8ae:
            ii(0x1015_f8ae, 5); cmp(memw[ss, ebp - 0x8], 0x21);         /* cmp word [ebp-0x8], 0x21 */
            ii(0x1015_f8b3, 2); if(jnz(0x1015_f8b7, 0x2)) goto l_0x1015_f8b7; /* jnz 0x1015f8b7 */
        l_0x1015_f8b5:
            ii(0x1015_f8b5, 2); jmp(0x1015_f8bd, 0x6); goto l_0x1015_f8bd; /* jmp 0x1015f8bd */
        l_0x1015_f8b7:
            ii(0x1015_f8b7, 4); mov(memb[ss, ebp - 0x14], 0x1);         /* mov byte [ebp-0x14], 0x1 */
            ii(0x1015_f8bb, 2); jmp(0x1015_f8c1, 0x4); goto l_0x1015_f8c1; /* jmp 0x1015f8c1 */
        l_0x1015_f8bd:
        ...
        l_0x1015_f8c1:
            ...
            ii(0x1015_f8cc, 5); cmp(memw[ss, ebp - 0x8], 0xc);          /* cmp word [ebp-0x8], 0xc */
            ii(0x1015_f8d1, 2); if(jz(0x1015_f8da, 0x7)) goto l_0x1015_f8da; /* jz 0x1015f8da */
            ii(0x1015_f8d3, 5); cmp(memw[ss, ebp - 0x8], 0x15);         /* cmp word [ebp-0x8], 0x15 */
            ii(0x1015_f8d8, 2); if(jnz(0x1015_f8dc, 0x2)) goto l_0x1015_f8dc; /* jnz 0x1015f8dc */
        l_0x1015_f8da:
            ii(0x1015_f8da, 2); jmp(0x1015_f8e3, 0x7); goto l_0x1015_f8e3; /* jmp 0x1015f8e3 */
        l_0x1015_f8dc:
            ii(0x1015_f8dc, 5); cmp(memw[ss, ebp - 0x8], 0x27);         /* cmp word [ebp-0x8], 0x27 */
            ii(0x1015_f8e1, 2); if(jnz(0x1015_f8e5, 0x2)) goto l_0x1015_f8e5; /* jnz 0x1015f8e5 */
        l_0x1015_f8e3:
            ii(0x1015_f8e3, 2); jmp(0x1015_f8ec, 0x7); goto l_0x1015_f8ec; /* jmp 0x1015f8ec */
        l_0x1015_f8e5:
            ii(0x1015_f8e5, 5); cmp(memw[ss, ebp - 0x8], 0x21);         /* cmp word [ebp-0x8], 0x21 */
            ii(0x1015_f8ea, 2); if(jnz(0x1015_f8ee, 0x2)) goto l_0x1015_f8ee; /* jnz 0x1015f8ee */
        l_0x1015_f8ec:
            ii(0x1015_f8ec, 2); jmp(0x1015_f8f4, 0x6); goto l_0x1015_f8f4; /* jmp 0x1015f8f4 */
        l_0x1015_f8ee:
            ii(0x1015_f8ee, 4); mov(memb[ss, ebp - 0x18], 0x1);         /* mov byte [ebp-0x18], 0x1 */
            ii(0x1015_f8f2, 2); jmp(0x1015_f8f8, 0x4); goto l_0x1015_f8f8; /* jmp 0x1015f8f8 */
        l_0x1015_f8f4:
        ...
        l_0x1015_f8f8:
            ...
            ii(0x1015_f902, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_f905, 3); mov(edx, memd[ds, eax + 0x1a]);         /* mov edx, [eax+0x1a] */
            ii(0x1015_f908, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1015_f90b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_f919, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_f91c, 4); mov(memb[ds, eax + 0x3e], 0x5);         /* mov byte [eax+0x3e], 0x5 */
