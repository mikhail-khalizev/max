...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_e19e()
        {
            ...
            ii(0x100b_e1b6, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x100b_e1bd, 2); jmp(0x100b_e1c5, 0x6); goto l_0x100b_e1c5; /* jmp 0x100be1c5 */
        l_0x100b_e1bf:
            ii(0x100b_e1bf, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_e1c2, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x100b_e1c5:
            ii(0x100b_e1c5, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100b_e1c9, 3); cmp(eax, 0x4);                          /* cmp eax, 0x4 */
            ii(0x100b_e1cc, 2); if(jge(0x100b_e20a, 0x3c)) goto l_0x100b_e20a; /* jge 0x100be20a */
            ii(0x100b_e1ce, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x100b_e1e8, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x100b_e200, 2); if(jnz(0x100b_e208, 0x6)) goto l_0x100b_e208; /* jnz 0x100be208 */
        l_0x100b_e202:
            ii(0x100b_e202, 4); mov(memb[ss, ebp - 0x4], 0);            /* mov byte [ebp-0x4], 0x0 */
            ii(0x100b_e206, 2); jmp(0x100b_e20e, 0x6); goto l_0x100b_e20e; /* jmp 0x100be20e */
        l_0x100b_e208:
            ii(0x100b_e208, 2); jmp(0x100b_e1bf, -0x4b); goto l_0x100b_e1bf; /* jmp 0x100be1bf */
        l_0x100b_e20a:
            ii(0x100b_e20a, 4); mov(memb[ss, ebp - 0x4], 0x1);          /* mov byte [ebp-0x4], 0x1 */
        l_0x100b_e20e:
            ii(0x100b_e20e, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
