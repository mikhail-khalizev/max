...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_5fc8()
        {
            ...
            ii(0x100b_5fdf, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_5fe2, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100b_5fe5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_5fe8, 5); cmp(memw[ds, eax + 0x8], 0x4e);         /* cmp word [eax+0x8], 0x4e */
            ii(0x100b_5fed, 2); if(jz(0x100b_5ff9, 0xa)) goto l_0x100b_5ff9; /* jz 0x100b5ff9 */
            ii(0x100b_5fef, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_5ff2, 5); cmp(memw[ds, eax + 0x8], 0x48);         /* cmp word [eax+0x8], 0x48 */
            ii(0x100b_5ff7, 2); if(jnz(0x100b_5ffb, 0x2)) goto l_0x100b_5ffb; /* jnz 0x100b5ffb */
        l_0x100b_5ff9:
            ii(0x100b_5ff9, 2); jmp(0x100b_6005, 0xa); goto l_0x100b_6005; /* jmp 0x100b6005 */
        l_0x100b_5ffb:
            ii(0x100b_5ffb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_5ffe, 5); cmp(memw[ds, eax + 0x8], 0x41);         /* cmp word [eax+0x8], 0x41 */
            ii(0x100b_6003, 2); if(jnz(0x100b_602f, 0x2a)) goto l_0x100b_602f; /* jnz 0x100b602f */
        l_0x100b_6005:
            ii(0x100b_6005, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_6008, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_600b, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100b_600e, 5); call(0x1008_ab1c, -0x2_b4f7);           /* call 0x1008ab1c */
            ii(0x100b_6013, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100b_6016, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_6027, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
