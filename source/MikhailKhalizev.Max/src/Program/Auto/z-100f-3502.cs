...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("79962228-81c0-443e-95cd-6a76fec2a718")]
        public void Method_100f_3502()
        {
            ii(0x100f_3502, 5); pushd(0x38);                            /* push 0x38 */
            ii(0x100f_3507, 5); calld(Definitions.sys_check_available_stack_size, 0x72846); /* call 0x10165d52 */
        ...
        l_0x100f_3543:
            ...
            ii(0x100f_3550, 5); calld(0x1014_82f4, 0x54d9f);            /* call 0x101482f4 */
            ...
            ii(0x100f_3596, 5); calld(Definitions.sys_display_draw_1, 0x73f0d); /* call 0x101674a8 */
            ...
            ii(0x100f_35cb, 5); calld(Definitions.sys_display_draw_1, 0x73ed8); /* call 0x101674a8 */
        l_0x100f_35d0:
            ii(0x100f_35d0, 5); calld(/* sys */ 0x1016_b258, 0x77c83);  /* call 0x1016b258 */
        l_0x100f_35d5:
            ii(0x100f_35d5, 5); calld(0x1014_82f4, 0x54d1a);            /* call 0x101482f4 */
