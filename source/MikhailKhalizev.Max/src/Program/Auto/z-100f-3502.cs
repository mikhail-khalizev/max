...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_3502()
        {
            ...
            ii(0x100f_3524, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100f_3527, 5); mov(eax, 0x38);                         /* mov eax, 0x38 */
            ii(0x100f_352c, 5); call(0x100e_883d, -0xacf4);             /* call 0x100e883d */
            ii(0x100f_3531, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100f_3534, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x100f_353b, 2); jmp(0x100f_3543, 0x6); goto l_0x100f_3543; /* jmp 0x100f3543 */
        l_0x100f_353d:
            ii(0x100f_353d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_3540, 3); inc(memd[ss, ebp - 0x4]);               /* inc dword [ebp-0x4] */
        l_0x100f_3543:
            ii(0x100f_3543, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_3555, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x100f_3558, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_355b, 5); add(eax, 0x2fe);                        /* add eax, 0x2fe */
            ii(0x100f_3560, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100f_3563, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_3566, 5); add(eax, 0x303);                        /* add eax, 0x303 */
            ii(0x100f_356b, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ...
            ii(0x100f_3579, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_357c, 3); mov(ebx, memd[ds, eax + 0x4]);          /* mov ebx, [eax+0x4] */
            ii(0x100f_357f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_3582, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x100f_3584, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x100f_3588, 5); call(0x100e_8ef1, -0xa69c);             /* call 0x100e8ef1 */
            ii(0x100f_358d, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x100f_3590, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_3593, 3); mov(eax, memd[ds, eax + 0x12]);         /* mov eax, [eax+0x12] */
            ii(0x100f_3596, 5); call(Definitions.sys_display_draw_1, 0x7_3f0d); /* call 0x101674a8 */
            ii(0x100f_359b, 6); cmp(memw[ss, ebp - 0x14], 0x306);       /* cmp word [ebp-0x14], 0x306 */
            ...
            ii(0x100f_35ae, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_35b1, 3); mov(ebx, memd[ds, eax + 0x4]);          /* mov ebx, [eax+0x4] */
            ii(0x100f_35b4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_35b7, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x100f_35b9, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ii(0x100f_35bd, 5); call(0x100e_8ef1, -0xa6d1);             /* call 0x100e8ef1 */
            ii(0x100f_35c2, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100f_35c5, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_35c8, 3); mov(eax, memd[ds, eax + 0x12]);         /* mov eax, [eax+0x12] */
        ...
        l_0x100f_35d5:
            ...
            ii(0x100f_35da, 3); sub(eax, memd[ss, ebp - 0x18]);         /* sub eax, [ebp-0x18] */
