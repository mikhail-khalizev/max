...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1008_0a99:
            ...
            ii(0x1008_0ab6, 4); mov(memb[ss, ebp - 0xc], 1);            /* mov byte [ebp-0xc], 0x1 */
            ii(0x1008_0aba, 2); jmp(0x1008_0ac0, 4); goto l_0x1008_0ac0; /* jmp 0x10080ac0 */
        l_0x1008_0abc:
            ii(0x1008_0abc, 4); mov(memb[ss, ebp - 0x10], 1);           /* mov byte [ebp-0x10], 0x1 */
        l_0x1008_0ac0:
        ...
        l_0x1008_0ace:
            ii(0x1008_0ace, 4); mov(memb[ss, ebp - 0x18], 1);           /* mov byte [ebp-0x18], 0x1 */
