...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x18_b5b6, 2); cmp(al, 4);                               /* cmp al, 0x4 */
            ii(0x18_b5b8, 2); if(jae_func(0x18_b5b2, -8)) return;       /* jae 0xb5b2 */
            ...
            ii(0x18_b5c6, 2); cmp(al, 2);                               /* cmp al, 0x2 */
            ii(0x18_b5c8, 2); if(jb(0x18_b5cc, 2)) goto l_0x18_b5cc;    /* jb 0xb5cc */
            ii(0x18_b5ca, 2); shl(cx, 1);                               /* shl cx, 1 */
        l_0x18_b5cc:
            ii(0x18_b5cc, 3); mov(es, memw[ss, bp + 2]);                /* mov es, [bp+0x2] */
