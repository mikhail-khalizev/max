...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_4b08()
        {
            ...
            ii(0x1016_4b20, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1016_4b23, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_4b26, 9); mov(memw[ds, eax + 0xa3], 0);           /* mov word [eax+0xa3], 0x0 */
