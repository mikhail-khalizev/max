...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ sys_display_copy_to_video_memory_1()
        {
            ...
            ii(0x1018_ce06, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ...
            ii(0x1018_ce20, 3); add(memd[ss, ebp + 0x8], eax);          /* add [ebp+0x8], eax */
            ...
            ii(0x1018_ce3d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1018_ce40, 3); mov(edx, memd[ss, ebp - 0x10]);         /* mov edx, [ebp-0x10] */
            ii(0x1018_ce43, 3); mov(esi, memd[ss, ebp + 0x8]);          /* mov esi, [ebp+0x8] */
        ...
        l_0x1018_ce5a:
            ii(0x1018_ce5a, 3); mov(esi, memd[ss, ebp + 0x8]);          /* mov esi, [ebp+0x8] */
            ...
            ii(0x1018_ce71, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x1018_ce84, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x1018_ce8d:
            ...
            ii(0x1018_cea5, 2); if(jae(0x1018_ceaa, 0x3)) goto l_0x1018_ceaa; /* jae 0x1018ceaa */
        ...
        l_0x1018_ceaa:
            ...
            ii(0x1018_ceb1, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
        ...
        l_0x1018_cec3:
            ...
            ii(0x1018_ced0, 2); if(jns(0x1018_ced7, 0x5)) goto l_0x1018_ced7; /* jns 0x1018ced7 */
        ...
        l_0x1018_ced7:
            ...
            ii(0x1018_cedf, 3); add(memd[ss, ebp - 0x4], eax);          /* add [ebp-0x4], eax */
            ...
            ii(0x1018_cef0, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1018_cf01, 3); add(esi, memd[ss, ebp - 0x8]);          /* add esi, [ebp-0x8] */
