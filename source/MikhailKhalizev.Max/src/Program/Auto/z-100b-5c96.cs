...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_5c96()
        {
            ...
            ii(0x100b_5cac, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100b_5caf, 3); mov(memd[ss, ebp - 8], edx);            /* mov [ebp-0x8], edx */
            ii(0x100b_5cb2, 3); mov(memd[ss, ebp - 4], ebx);            /* mov [ebp-0x4], ebx */
            ii(0x100b_5cb5, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100b_5cb8, 5); call(0x1007_6338, -0x3_f985);           /* call 0x10076338 */
            ii(0x100b_5cbd, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100b_5cbf, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x100b_5cc2, 5); call(0x1007_64b8, -0x3_f80f);           /* call 0x100764b8 */
            ii(0x100b_5cc7, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x100b_5cca, 5); call(Definitions.my_ctor_0x101b_4184, -0x3_f1df); /* call 0x10076af0 */
            ii(0x100b_5ccf, 2); jmp(0x100b_5cd9, 8); goto l_0x100b_5cd9; /* jmp 0x100b5cd9 */
        l_0x100b_5cd1:
            ii(0x100b_5cd1, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x100b_5cd4, 5); call(0x1007_6bf8, -0x3_f0e1);           /* call 0x10076bf8 */
        l_0x100b_5cd9:
            ii(0x100b_5cd9, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_5cdb, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ...
            ii(0x100b_5ceb, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x100b_5cee, 5); call(0x1007_63a0, -0x3_f953);           /* call 0x100763a0 */
            ii(0x100b_5cf3, 4); cmp(memb[ds, eax + 61], 0x10);          /* cmp byte [eax+0x3d], 0x10 */
            ii(0x100b_5cf7, 2); if(jz(0x100b_5d12, 0x19)) goto l_0x100b_5d12; /* jz 0x100b5d12 */
            ii(0x100b_5cf9, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x100b_5cfc, 5); call(0x1007_6408, -0x3_f8f9);           /* call 0x10076408 */
            ii(0x100b_5d01, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100b_5d03, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x100b_5d10, 2); if(jnz(0x100b_5d14, 2)) goto l_0x100b_5d14; /* jnz 0x100b5d14 */
        l_0x100b_5d12:
            ii(0x100b_5d12, 2); jmp(0x100b_5d6f, 0x5b); goto l_0x100b_5d6f; /* jmp 0x100b5d6f */
        l_0x100b_5d14:
            ii(0x100b_5d14, 3); lea(edx, memd[ss, ebp - 36]);           /* lea edx, [ebp-0x24] */
            ii(0x100b_5d17, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x100b_5d1a, 5); call(0x1007_63a0, -0x3_f97f);           /* call 0x100763a0 */
            ii(0x100b_5d1f, 5); call(0x1015_2532, 0x9_c80e);            /* call 0x10152532 */
            ii(0x100b_5d24, 3); mov(eax, memd[ss, ebp - 36]);           /* mov eax, [ebp-0x24] */
            ii(0x100b_5d27, 4); mov(memw[ss, ebp - 16], ax);            /* mov [ebp-0x10], ax */
            ii(0x100b_5d2b, 2); jmp(0x100b_5d34, 7); goto l_0x100b_5d34; /* jmp 0x100b5d34 */
        l_0x100b_5d2d:
            ii(0x100b_5d2d, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100b_5d30, 4); inc(memw[ss, ebp - 16]);                /* inc word [ebp-0x10] */
        l_0x100b_5d34:
            ii(0x100b_5d34, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x100b_5d38, 3); cmp(eax, memd[ss, ebp - 28]);           /* cmp eax, [ebp-0x1c] */
            ii(0x100b_5d3b, 2); if(jge(0x100b_5d6f, 0x32)) goto l_0x100b_5d6f; /* jge 0x100b5d6f */
            ii(0x100b_5d3d, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
            ii(0x100b_5d40, 4); mov(memw[ss, ebp - 14], ax);            /* mov [ebp-0xe], ax */
            ii(0x100b_5d44, 2); jmp(0x100b_5d4d, 7); goto l_0x100b_5d4d; /* jmp 0x100b5d4d */
        l_0x100b_5d46:
            ii(0x100b_5d46, 3); mov(eax, memd[ss, ebp - 14]);           /* mov eax, [ebp-0xe] */
            ii(0x100b_5d49, 4); inc(memw[ss, ebp - 14]);                /* inc word [ebp-0xe] */
        l_0x100b_5d4d:
            ii(0x100b_5d4d, 4); movsx(eax, memw[ss, ebp - 14]);         /* movsx eax, word [ebp-0xe] */
            ii(0x100b_5d51, 3); cmp(eax, memd[ss, ebp - 24]);           /* cmp eax, [ebp-0x18] */
            ii(0x100b_5d54, 2); if(jge(0x100b_5d6d, 0x17)) goto l_0x100b_5d6d; /* jge 0x100b5d6d */
            ii(0x100b_5d56, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x100b_5d5a, 3); shl(eax, 2);                            /* shl eax, 0x2 */
            ii(0x100b_5d5d, 3); add(eax, memd[ss, ebp - 8]);            /* add eax, [ebp-0x8] */
            ii(0x100b_5d60, 4); movsx(edx, memw[ss, ebp - 14]);         /* movsx edx, word [ebp-0xe] */
        ...
        l_0x100b_5d74:
            ...
            ii(0x100b_5d76, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
