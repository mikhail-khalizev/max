...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_b58f()
        {
            ...
            ii(0x100e_b5d0, 3); mov(eax, memd[ds, eax + 18]);           /* mov eax, [eax+0x12] */
