...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("ebe7112d-78b3-4c63-b355-e910b304bd82")]
        public void Method_100e_b58f()
        {
            ii(0x100e_b58f, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x100e_b594, 5); calld(Definitions.sys_check_available_stack_size, 0x7_a7b9); /* call 0x10165d52 */
            ...
            ii(0x100e_b5bc, 5); calld(0x100d_7f6c, -0x1_3655);          /* call 0x100d7f6c */
            ...
            ii(0x100e_b5d3, 5); calld(Definitions.sys_display_draw_1, 0x7_bed0); /* call 0x101674a8 */
