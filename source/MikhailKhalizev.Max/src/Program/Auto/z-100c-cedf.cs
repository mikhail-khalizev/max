...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_cedf()
        {
            ...
            ii(0x100c_cef7, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_cefa, 4); mov(memb[ss, ebp - 0x8], 0x21);         /* mov byte [ebp-0x8], 0x21 */
            ii(0x100c_cefe, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
