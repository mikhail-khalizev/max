...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_1483()
        {
            ...
            ii(0x1018_1497, 7); mov(memd[ds, ebx + 0x4], 0);            /* mov dword [ebx+0x4], 0x0 */
        ...
        l_0x1018_14b0:
            ii(0x1018_14b0, 4); imul(ecx, memd[ds, ebx + 0x4], 0xa);    /* imul ecx, [ebx+0x4], 0xa */
            ...
            ii(0x1018_14c0, 3); mov(memd[ds, ebx + 0x4], ecx);          /* mov [ebx+0x4], ecx */
        ...
        l_0x1018_14d1:
            ...
            ii(0x1018_14e1, 3); mov(edx, memd[ds, edx - 0x4]);          /* mov edx, [edx-0x4] */
            ii(0x1018_14e4, 3); mov(memd[ds, ebx + 0x4], edx);          /* mov [ebx+0x4], edx */
            ...
            ii(0x1018_14f5, 3); mov(memd[ds, ebx + 0x4], edi);          /* mov [ebx+0x4], edi */
            ii(0x1018_14f8, 3); mov(memb[ds, ebx + 0x14], dl);          /* mov [ebx+0x14], dl */
        l_0x1018_14fb:
            ii(0x1018_14fb, 1); inc(eax);                               /* inc eax */
        l_0x1018_14fc:
            ii(0x1018_14fc, 7); mov(memd[ds, ebx + 0x8], 0xffff_ffff);  /* mov dword [ebx+0x8], 0xffffffff */
            ...
            ii(0x1018_150d, 7); mov(memd[ds, ebx + 0x8], 0);            /* mov dword [ebx+0x8], 0x0 */
            ...
            ii(0x1018_1524, 3); mov(edx, memd[ds, edx - 0x4]);          /* mov edx, [edx-0x4] */
            ii(0x1018_1527, 3); mov(memd[ds, ebx + 0x8], edx);          /* mov [ebx+0x8], edx */
            ii(0x1018_152a, 2); test(edx, edx);                         /* test edx, edx */
            ii(0x1018_152c, 2); if(jge(0x1018_1535, 0x7)) goto l_0x1018_1535; /* jge 0x10181535 */
            ii(0x1018_152e, 7); mov(memd[ds, ebx + 0x8], 0xffff_ffff);  /* mov dword [ebx+0x8], 0xffffffff */
        l_0x1018_1535:
