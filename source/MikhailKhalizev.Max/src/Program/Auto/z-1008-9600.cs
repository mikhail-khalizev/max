...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("7f5e8bef-2650-4dd4-a194-eb588e1391a9")]
        public void Method_1008_9600()
        {
            ii(0x1008_9600, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x1008_9605, 5); calld(Definitions.sys_check_available_stack_size, 0xd_c748); /* call 0x10165d52 */
            ...
            ii(0x1008_9625, 5); calld(Definitions.my_dtor_0x101b_6edc, 0xb_161b); /* call 0x1013ac45 */
