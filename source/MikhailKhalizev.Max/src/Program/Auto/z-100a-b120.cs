...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_b120()
        {
            ...
            ii(0x100a_b136, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100a_b139, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100a_b13c, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ii(0x100a_b13f, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ii(0x100a_b143, 2); if(jz(0x100a_b153, 0xe)) goto l_0x100a_b153; /* jz 0x100ab153 */
            ii(0x100a_b145, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_b148, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x100a_b14b, 6); or(memd[ds, edx + 0xdd], eax);          /* or [edx+0xdd], eax */
            ii(0x100a_b151, 2); jmp(0x100a_b161, 0xe); goto l_0x100a_b161; /* jmp 0x100ab161 */
        l_0x100a_b153:
            ii(0x100a_b153, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100a_b156, 2); not(edx);                               /* not edx */
            ii(0x100a_b158, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100a_b15b, 6); and(memd[ds, eax + 0xdd], edx);         /* and [eax+0xdd], edx */
        l_0x100a_b161:
