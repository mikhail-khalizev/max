...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_aec1()
        {
            ...
            ii(0xaec8, 5);    or(memb[ds, 0xa16], 0x1);                 /* or byte [0xa16], 0x1 */
            ii(0xaecd, 5);    test(memb[ds, 0x11d2], 0x1);              /* test byte [0x11d2], 0x1 */
            ii(0xaed2, 2);    if(jnz(0xaeda, 0x6)) goto l_0xaeda;       /* jnz 0xaeda */
        ...
        l_0xaeda:
            ...
            ii(0xaf19, 2);    if(jz_func(0xaf23, 0x8)) return;          /* jz 0xaf23 */
        }
    }
}
