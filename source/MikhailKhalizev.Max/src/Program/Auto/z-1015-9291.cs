...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_9291()
        {
            ...
            ii(0x1015_92a8, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_92ab, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1015_92ae, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_92b1, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1015_92b4, 5); mov(eax, 0x1);                          /* mov eax, 0x1 */
            ii(0x1015_92b9, 5); call(0x100f_448c, -0x6_4e32);           /* call 0x100f448c */
            ii(0x1015_92be, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_92c1, 4); cmp(memb[ds, eax + 0x3d], 0x4);         /* cmp byte [eax+0x3d], 0x4 */
            ii(0x1015_92c5, 2); if(jnz(0x1015_92d9, 0x12)) goto l_0x1015_92d9; /* jnz 0x101592d9 */
            ii(0x1015_92c7, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_92ca, 5); call(0x100f_3f62, -0x6_536d);           /* call 0x100f3f62 */
            ii(0x1015_92cf, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
        ...
        l_0x1015_92d9:
            ...
            ii(0x1015_92de, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1015_92ea, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_92ed, 5); call(0x1010_19b8, -0x5_793a);           /* call 0x101019b8 */
            ii(0x1015_92f2, 2); jmp(0x1015_92fc, 0x8); goto l_0x1015_92fc; /* jmp 0x101592fc */
        l_0x1015_92f4:
            ii(0x1015_92f4, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
