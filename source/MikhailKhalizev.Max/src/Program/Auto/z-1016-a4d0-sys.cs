...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1016_a4e9:
            ...
            ii(0x1016_a4f3, 2); if(jge(0x1016_a4fd, 0x8)) goto l_0x1016_a4fd; /* jge 0x1016a4fd */
            ii(0x1016_a4f5, 3); mov(edx, memd[ds, esi + edx * 8]);      /* mov edx, [esi+edx*8] */
            ii(0x1016_a4f8, 3); add(edx, memd[ds, edi + 0x8]);          /* add edx, [edi+0x8] */
            ii(0x1016_a4fb, 2); add(ecx, edx);                          /* add ecx, edx */
        l_0x1016_a4fd:
            ii(0x1016_a4fd, 3); mov(bh, memb[ds, eax + 0x1]);           /* mov bh, [eax+0x1] */
