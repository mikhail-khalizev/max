...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_5242()
        {
            ...
            ii(0x17_5258, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_525b, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x17_525e, 2); or(dx, ax);                               /* or dx, ax */
            ii(0x17_5260, 2); if(jnz(0x17_5268, 0x6)) goto l_0x17_5268; /* jnz 0x5268 */
        ...
        l_0x17_5268:
            ...
            ii(0x17_526c, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ...
            ii(0x17_5278, 3); mov(memw[ss, bp - 0x20], ax);             /* mov [bp-0x20], ax */
            ii(0x17_527b, 3); mov(memw[ss, bp - 0x1e], dx);             /* mov [bp-0x1e], dx */
            ...
            ii(0x17_5286, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_5289, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0x17_52a7, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_52aa, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
        ...
        l_0x17_52d4:
            ...
            ii(0x17_52e0, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_52e3, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x17_52e6, 2); or(dx, ax);                               /* or dx, ax */
            ii(0x17_52e8, 2); if(jnz(0x17_52f0, 0x6)) goto l_0x17_52f0; /* jnz 0x52f0 */
        ...
        l_0x17_52f0:
            ...
            ii(0x17_52fb, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x17_52fe, 3); mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
            ii(0x17_5301, 2); or(dx, ax);                               /* or dx, ax */
            ii(0x17_5303, 2); if(jz(0x17_531a, 0x15)) goto l_0x17_531a; /* jz 0x531a */
            ii(0x17_5305, 3); call_far_ind(ss, bp - 0x8);               /* call far word [bp-0x8] */
            ...
            ii(0x17_5313, 2); if(jge(0x17_531a, 0x5)) goto l_0x17_531a; /* jge 0x531a */
            ii(0x17_5315, 5); mov(memb[ds, 0x5], 0x1);                  /* mov byte [0x5], 0x1 */
        l_0x17_531a:
            ii(0x17_531a, 1); push(ds);                                 /* push ds */
            ii(0x17_531b, 3); push(0x2f1);                              /* push 0x2f1 */
            ii(0x17_531e, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_5321, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0x17_533b, 4); call_far_ind(ds, 0x1fdc);                 /* call far word [0x1fdc] */
            ii(0x17_533f, 2); or(ax, ax);                               /* or ax, ax */
            ii(0x17_5341, 2); if(jz(0x17_534a, 0x7)) goto l_0x17_534a;  /* jz 0x534a */
        ...
        l_0x17_534a:
            ...
            ii(0x17_534e, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_5351, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0x17_5369, 2); if(jnz(0x17_5372, 0x7)) goto l_0x17_5372; /* jnz 0x5372 */
        ...
        l_0x17_5372:
            ...
            ii(0x17_5376, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_5379, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0x17_5391, 2); if(jnz(0x17_539a, 0x7)) goto l_0x17_539a; /* jnz 0x539a */
        ...
        l_0x17_539a:
            ...
            ii(0x17_539e, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_53a1, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0x17_53b9, 2); if(jnz(0x17_53c2, 0x7)) goto l_0x17_53c2; /* jnz 0x53c2 */
        ...
        l_0x17_53c2:
            ...
            ii(0x17_53c6, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_53c9, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0x17_53d4, 3); mov(memw[ss, bp - 0x2a], ax);             /* mov [bp-0x2a], ax */
            ii(0x17_53d7, 3); mov(memw[ss, bp - 0x28], dx);             /* mov [bp-0x28], dx */
            ...
            ii(0x17_53ec, 3); mov(memw[ss, bp - 0x26], ax);             /* mov [bp-0x26], ax */
            ii(0x17_53ef, 3); mov(memw[ss, bp - 0x24], dx);             /* mov [bp-0x24], dx */
            ii(0x17_53f2, 2); mov(ax, dx);                              /* mov ax, dx */
            ii(0x17_53f4, 3); or(ax, memw[ss, bp - 0x26]);              /* or ax, [bp-0x26] */
            ii(0x17_53f7, 2); if(jz(0x17_544a, 0x51)) goto l_0x17_544a; /* jz 0x544a */
            ii(0x17_53f9, 2); mov(ax, dx);                              /* mov ax, dx */
            ii(0x17_53fb, 3); mov(memw[ss, bp - 0x22], ax);             /* mov [bp-0x22], ax */
            ii(0x17_53fe, 3); mov(ax, memw[ss, bp - 0x20]);             /* mov ax, [bp-0x20] */
            ii(0x17_5401, 3); mov(dx, memw[ss, bp - 0x1e]);             /* mov dx, [bp-0x1e] */
            ii(0x17_5404, 3); les(bx, memw[ss, bp - 0x26]);             /* les bx, [bp-0x26] */
            ii(0x17_5407, 3); mov(memw[es, bx], ax);                    /* mov [es:bx], ax */
            ii(0x17_540a, 4); mov(memw[es, bx + 0x2], dx);              /* mov [es:bx+0x2], dx */
            ii(0x17_540e, 5); mov(memw[ss, bp - 0x26], 0x468e);         /* mov word [bp-0x26], 0x468e */
            ii(0x17_5413, 5); mov(memw[ss, bp - 0x24], 0x3e58);         /* mov word [bp-0x24], 0x3e58 */
            ii(0x17_5418, 3); mov(ax, memw[ss, bp - 0x22]);             /* mov ax, [bp-0x22] */
            ii(0x17_541b, 3); mov(memw[ss, bp - 0x24], ax);             /* mov [bp-0x24], ax */
            ii(0x17_541e, 3); mov(ax, memw[ss, bp - 0x2a]);             /* mov ax, [bp-0x2a] */
            ii(0x17_5421, 3); mov(dx, memw[ss, bp - 0x28]);             /* mov dx, [bp-0x28] */
            ii(0x17_5424, 3); les(bx, memw[ss, bp - 0x26]);             /* les bx, [bp-0x26] */
            ii(0x17_5427, 3); mov(memw[es, bx], ax);                    /* mov [es:bx], ax */
            ii(0x17_542a, 4); mov(memw[es, bx + 0x2], dx);              /* mov [es:bx+0x2], dx */
            ii(0x17_542e, 3); push(memw[ss, bp - 0x24]);                /* push word [bp-0x24] */
            ii(0x17_5431, 3); push(memw[ss, bp - 0x26]);                /* push word [bp-0x26] */
        ...
        l_0x17_544a:
            ii(0x17_544a, 3); mov(ax, memw[ss, bp - 0x20]);             /* mov ax, [bp-0x20] */
            ii(0x17_544d, 3); mov(dx, memw[ss, bp - 0x1e]);             /* mov dx, [bp-0x1e] */
        ...
        l_0x17_5457:
            ...
            ii(0x17_545d, 3); mov(memw[ss, bp - 0x1a], ax);             /* mov [bp-0x1a], ax */
            ii(0x17_5460, 3); mov(memw[ss, bp - 0x1c], ax);             /* mov [bp-0x1c], ax */
            ii(0x17_5463, 5); mov(memw[ss, bp - 0xa], 0xff00);          /* mov word [bp-0xa], 0xff00 */
            ii(0x17_5468, 5); mov(memw[ss, bp - 0xe], 0xe00);           /* mov word [bp-0xe], 0xe00 */
            ii(0x17_546d, 3); lea(ax, memw[ss, bp - 0x1c]);             /* lea ax, [bp-0x1c] */
            ii(0x17_5470, 1); push(ss);                                 /* push ss */
            ii(0x17_5471, 1); push(ax);                                 /* push ax */
            ii(0x17_5472, 2); push(-0x1 /* 0xff */);                    /* push 0xffff */
            ...
            ii(0x17_547c, 3); mov(bx, memw[ss, bp - 0xa]);              /* mov bx, [bp-0xa] */
            ii(0x17_547f, 3); mov(cx, memw[ss, bp - 0xe]);              /* mov cx, [bp-0xe] */
            ...
            ii(0x17_548c, 4); mov(ax, memw[es, bx + 0x4]);              /* mov ax, [es:bx+0x4] */
            ii(0x17_5490, 4); mov(dx, memw[es, bx + 0x6]);              /* mov dx, [es:bx+0x6] */
