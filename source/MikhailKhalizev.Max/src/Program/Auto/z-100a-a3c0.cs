...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("c6b7db63-72a7-47d9-88a9-70fd292d5e2b")]
        public void Method_100a_a3c0()
        {
            ii(0x100a_a3c0, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x100a_a3c5, 5); calld(Definitions.sys_check_available_stack_size, 0xb_b988); /* call 0x10165d52 */
            ...
            ii(0x100a_a3ee, 5); calld(Definitions.sys_call_dtor_arr, 0xb_bbc5); /* call 0x10165fb8 */
            ii(0x100a_a3f3, 5); calld(Definitions.sys_delete_arr, 0xb_bbe0); /* call 0x10165fd8 */
        ...
        l_0x100a_a3fa:
            ...
            ii(0x100a_a402, 5); calld(0x100c_d916, 0x2_350f);           /* call 0x100cd916 */
            ...
            ii(0x100a_a416, 5); calld(Definitions.sys_delete, 0xb_bb49); /* call 0x10165f64 */
        l_0x100a_a41b:
