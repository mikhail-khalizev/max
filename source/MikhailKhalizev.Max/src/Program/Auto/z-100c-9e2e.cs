...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_9e2e()
        {
            ...
            ii(0x100c_9e44, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100c_9e47, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100c_9e4a, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ii(0x100c_9e4d, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ii(0x100c_9e51, 6); if(jz(0x100c_9faa, 0x153)) goto l_0x100c_9faa; /* jz 0x100c9faa */
            ii(0x100c_9e57, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_9e5a, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ...
            ii(0x100c_9e78, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100c_9e7b, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100c_9e7e, 5); call(0x100c_9b42, -0x341);              /* call 0x100c9b42 */
        l_0x100c_9e83:
            ii(0x100c_9e83, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_9e86, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ...
            ii(0x100c_9eaa, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100c_9ead, 3); mov(al, memb[ds, edx + 0x4d]);          /* mov al, [edx+0x4d] */
            ii(0x100c_9eb0, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100c_9eb3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_9ecc, 4); movsx(ebx, memb[ss, ebp - 0x4]);        /* movsx ebx, byte [ebp-0x4] */
            ii(0x100c_9ed0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_9ed3, 3); mov(edx, memd[ds, eax + 0x6]);          /* mov edx, [eax+0x6] */
            ii(0x100c_9ed6, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100c_9ed9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_9edc, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ...
            ii(0x100c_9ef6, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100c_9ef9, 2); jmp(0x100c_9f27, 0x2c); goto l_0x100c_9f27; /* jmp 0x100c9f27 */
        l_0x100c_9efb:
            ii(0x100c_9efb, 5); mov(ecx, 0x1);                          /* mov ecx, 0x1 */
            ii(0x100c_9f00, 4); movsx(ebx, memb[ss, ebp - 0x4]);        /* movsx ebx, byte [ebp-0x4] */
            ii(0x100c_9f04, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100c_9f07, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_9f0a, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ...
            ii(0x100c_9f24, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
        l_0x100c_9f27:
            ii(0x100c_9f27, 4); cmp(memd[ss, ebp - 0x14], 0);           /* cmp dword [ebp-0x14], 0x0 */
            ii(0x100c_9f2b, 6); if(jz(0x100c_9faa, 0x79)) goto l_0x100c_9faa; /* jz 0x100c9faa */
            ii(0x100c_9f31, 4); cmp(memb[ss, ebp - 0x4], 0x3);          /* cmp byte [ebp-0x4], 0x3 */
            ii(0x100c_9f35, 2); if(jnz(0x100c_9f3e, 0x7)) goto l_0x100c_9f3e; /* jnz 0x100c9f3e */
            ii(0x100c_9f37, 7); mov(memd[ss, ebp - 0x10], 0x1);         /* mov dword [ebp-0x10], 0x1 */
        l_0x100c_9f3e:
            ii(0x100c_9f3e, 7); mov(memd[ss, ebp - 0x18], 0);           /* mov dword [ebp-0x18], 0x0 */
            ii(0x100c_9f45, 2); jmp(0x100c_9f4d, 0x6); goto l_0x100c_9f4d; /* jmp 0x100c9f4d */
        l_0x100c_9f47:
            ii(0x100c_9f47, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x100c_9f4a, 3); inc(memd[ss, ebp - 0x18]);              /* inc dword [ebp-0x18] */
        l_0x100c_9f4d:
            ii(0x100c_9f4d, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ...
            ii(0x100c_9f59, 4); movsx(eax, memw[ss, ebp - 0x18]);       /* movsx eax, word [ebp-0x18] */
            ii(0x100c_9f5d, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100c_9f60, 3); add(eax, memd[ss, ebp - 0x14]);         /* add eax, [ebp-0x14] */
            ii(0x100c_9f63, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x100c_9f65, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100c_9f68, 4); movsx(eax, memw[ss, ebp - 0x18]);       /* movsx eax, word [ebp-0x18] */
            ii(0x100c_9f6c, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100c_9f6f, 3); add(eax, memd[ss, ebp - 0xc]);          /* add eax, [ebp-0xc] */
            ii(0x100c_9f72, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x100c_9f74, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x100c_9f77, 6); mov(ax, memw[ds, 0x101c_8174]);         /* mov ax, [0x101c8174] */
            ii(0x100c_9f7d, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
        l_0x100c_9f80:
            ii(0x100c_9f80, 3); dec(memd[ss, ebp - 0x24]);              /* dec dword [ebp-0x24] */
            ii(0x100c_9f83, 5); cmp(memw[ss, ebp - 0x24], -0x1 /* 0xff */); /* cmp word [ebp-0x24], 0xffff */
            ii(0x100c_9f88, 2); if(jz(0x100c_9fa8, 0x1e)) goto l_0x100c_9fa8; /* jz 0x100c9fa8 */
            ii(0x100c_9f8a, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x100c_9f8d, 4); add(memd[ss, ebp - 0x1c], 0x2);         /* add dword [ebp-0x1c], 0x2 */
            ii(0x100c_9f91, 3); mov(ax, memw[ds, eax]);                 /* mov ax, [eax] */
            ii(0x100c_9f94, 4); cmp(ax, memw[ss, ebp - 0x10]);          /* cmp ax, [ebp-0x10] */
            ii(0x100c_9f98, 2); if(jl(0x100c_9fa0, 0x6)) goto l_0x100c_9fa0; /* jl 0x100c9fa0 */
            ii(0x100c_9f9a, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x100c_9f9d, 3); mov(memb[ds, eax], 0);                  /* mov byte [eax], 0x0 */
        l_0x100c_9fa0:
            ii(0x100c_9fa0, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x100c_9fa3, 3); inc(memd[ss, ebp - 0x20]);              /* inc dword [ebp-0x20] */
