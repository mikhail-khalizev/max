...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_2256()
        {
            ...
            ii(0x1007_226d, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_2270, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1007_2273, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_2276, 5); call(0x1007_20e6, -0x195);              /* call 0x100720e6 */
            ii(0x1007_227b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_227e, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1007_228d, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x1007_2290, 2); jmp(0x1007_22d2, 0x40); goto l_0x1007_22d2; /* jmp 0x100722d2 */
        l_0x1007_2292:
            ii(0x1007_2292, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_2295, 5); call(0x1007_623c, 0x3fa2);              /* call 0x1007623c */
            ii(0x1007_229a, 4); mov(dx, memw[ds, eax + 0x19]);          /* mov dx, [eax+0x19] */
            ii(0x1007_229e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_22a1, 4); add(memw[ds, eax + 0x2], dx);           /* add [eax+0x2], dx */
            ii(0x1007_22a5, 2); jmp(0x1007_22f4, 0x4d); goto l_0x1007_22f4; /* jmp 0x100722f4 */
        l_0x1007_22a7:
            ii(0x1007_22a7, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_22aa, 5); call(0x1007_623c, 0x3f8d);              /* call 0x1007623c */
            ii(0x1007_22af, 4); mov(dx, memw[ds, eax + 0x19]);          /* mov dx, [eax+0x19] */
            ii(0x1007_22b3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_22b6, 4); add(memw[ds, eax + 0x4], dx);           /* add [eax+0x4], dx */
            ii(0x1007_22ba, 2); jmp(0x1007_22f4, 0x38); goto l_0x1007_22f4; /* jmp 0x100722f4 */
        l_0x1007_22bc:
            ii(0x1007_22bc, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_22bf, 5); call(0x1007_623c, 0x3f78);              /* call 0x1007623c */
            ii(0x1007_22c4, 4); mov(dx, memw[ds, eax + 0x19]);          /* mov dx, [eax+0x19] */
            ii(0x1007_22c8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1007_22d2:
            ii(0x1007_22d2, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
            ii(0x1007_22d5, 3); mov(memb[ss, ebp - 0x14], al);          /* mov [ebp-0x14], al */
            ii(0x1007_22d8, 4); cmp(memb[ss, ebp - 0x14], 0x2);         /* cmp byte [ebp-0x14], 0x2 */
            ii(0x1007_22dc, 2); if(jb(0x1007_22ec, 0xe)) goto l_0x1007_22ec; /* jb 0x100722ec */
            ii(0x1007_22de, 4); cmp(memb[ss, ebp - 0x14], 0x2);         /* cmp byte [ebp-0x14], 0x2 */
            ii(0x1007_22e2, 2); if(jbe(0x1007_22a7, -0x3d)) goto l_0x1007_22a7; /* jbe 0x100722a7 */
            ii(0x1007_22e4, 4); cmp(memb[ss, ebp - 0x14], 0x3);         /* cmp byte [ebp-0x14], 0x3 */
        ...
        l_0x1007_22ec:
            ii(0x1007_22ec, 4); cmp(memb[ss, ebp - 0x14], 0x1);         /* cmp byte [ebp-0x14], 0x1 */
        ...
        l_0x1007_22f4:
            ii(0x1007_22f4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_22f7, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1007_22fa, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
