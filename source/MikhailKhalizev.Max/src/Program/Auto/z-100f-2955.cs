...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_2955()
        {
            ...
            ii(0x100f_2981, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100f_2984, 4); cmp(memd[ss, ebp - 0x8], 0);            /* cmp dword [ebp-0x8], 0x0 */
            ii(0x100f_2988, 2); if(jz(0x100f_299e, 0x14)) goto l_0x100f_299e; /* jz 0x100f299e */
            ii(0x100f_298a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100f_298c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100f_2999, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100f_299c, 2); jmp(0x100f_29a5, 0x7); goto l_0x100f_29a5; /* jmp 0x100f29a5 */
        l_0x100f_299e:
            ii(0x100f_299e, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
        l_0x100f_29a5:
            ...
            ii(0x100f_29b4, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x100f_29bb, 2); jmp(0x100f_29c3, 0x6); goto l_0x100f_29c3; /* jmp 0x100f29c3 */
        l_0x100f_29bd:
            ii(0x100f_29bd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_29c0, 3); inc(memd[ss, ebp - 0x4]);               /* inc dword [ebp-0x4] */
        l_0x100f_29c3:
            ii(0x100f_29c3, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_29c7, 3); cmp(eax, 0x6);                          /* cmp eax, 0x6 */
            ii(0x100f_29ca, 6); if(jae(0x100f_2a58, 0x88)) goto l_0x100f_2a58; /* jae 0x100f2a58 */
            ii(0x100f_29d0, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_29dd, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100f_29e0, 4); cmp(memd[ss, ebp - 0x10], 0);           /* cmp dword [ebp-0x10], 0x0 */
            ii(0x100f_29e4, 2); if(jz(0x100f_29fa, 0x14)) goto l_0x100f_29fa; /* jz 0x100f29fa */
            ii(0x100f_29e6, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100f_29e8, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x100f_29f5, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100f_29f8, 2); jmp(0x100f_2a01, 0x7); goto l_0x100f_2a01; /* jmp 0x100f2a01 */
        l_0x100f_29fa:
            ii(0x100f_29fa, 7); mov(memd[ss, ebp - 0x14], 0);           /* mov dword [ebp-0x14], 0x0 */
        l_0x100f_2a01:
            ii(0x100f_2a01, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_2a11, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_2a1e, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x100f_2a21, 4); cmp(memd[ss, ebp - 0x18], 0);           /* cmp dword [ebp-0x18], 0x0 */
            ii(0x100f_2a25, 2); if(jz(0x100f_2a3b, 0x14)) goto l_0x100f_2a3b; /* jz 0x100f2a3b */
            ii(0x100f_2a27, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100f_2a29, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ...
            ii(0x100f_2a36, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100f_2a39, 2); jmp(0x100f_2a42, 0x7); goto l_0x100f_2a42; /* jmp 0x100f2a42 */
        l_0x100f_2a3b:
            ii(0x100f_2a3b, 7); mov(memd[ss, ebp - 0x1c], 0);           /* mov dword [ebp-0x1c], 0x0 */
        l_0x100f_2a42:
            ii(0x100f_2a42, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
