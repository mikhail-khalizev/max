...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void my_string_release()
        {
            ...
            ii(0x1014_2434, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_2437, 4); cmp(memd[ss, ebp - 0x4], 0);            /* cmp dword [ebp-0x4], 0x0 */
            ii(0x1014_243b, 2); if(jz(0x1014_245b, 0x1e)) goto l_0x1014_245b; /* jz 0x1014245b */
            ii(0x1014_243d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_2440, 3); dec(memd[ds, eax + 0x8]);               /* dec dword [eax+0x8] */
            ii(0x1014_2443, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_2446, 4); cmp(memd[ds, eax + 0x8], 0);            /* cmp dword [eax+0x8], 0x0 */
            ii(0x1014_244a, 2); if(jnz(0x1014_245b, 0xf)) goto l_0x1014_245b; /* jnz 0x1014245b */
            ii(0x1014_244c, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_244e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
