...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_fd3f()
        {
            ...
            ii(0x1014_fd57, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_fd5a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_fd5d, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x1014_fd60, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1014_fd63, 3); imul(eax, eax, 0x33);                   /* imul eax, eax, 0x33 */
            ii(0x1014_fd66, 7); cmp(memb[ds, eax + 0x101c_81d5], 0x2);  /* cmp byte [eax+0x101c81d5], 0x2 */
            ii(0x1014_fd6d, 2); if(jz(0x1014_fd78, 0x9)) goto l_0x1014_fd78; /* jz 0x1014fd78 */
            ii(0x1014_fd6f, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1014_fd76, 2); jmp(0x1014_fdc1, 0x49); goto l_0x1014_fdc1; /* jmp 0x1014fdc1 */
        l_0x1014_fd78:
            ii(0x1014_fd78, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_fd7a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_fd89, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_fd8c, 4); mov(ax, memw[ds, eax + 0x52]);          /* mov ax, [eax+0x52] */
            ii(0x1014_fd90, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_fd93, 2); jmp(0x1014_fdc1, 0x2c); goto l_0x1014_fdc1; /* jmp 0x1014fdc1 */
        l_0x1014_fd95:
            ii(0x1014_fd95, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_fd98, 5); call(0x1007_20b1, -0xd_dcec);           /* call 0x100720b1 */
            ii(0x1014_fd9d, 3); lea(eax, memd[ss, ebp - 0x20]);         /* lea eax, [ebp-0x20] */
            ii(0x1014_fda0, 5); call(0x1007_20b1, -0xd_dcf4);           /* call 0x100720b1 */
            ii(0x1014_fda5, 3); lea(ebx, memd[ss, ebp - 0x20]);         /* lea ebx, [ebp-0x20] */
            ii(0x1014_fda8, 3); lea(edx, memd[ss, ebp - 0x14]);         /* lea edx, [ebp-0x14] */
            ii(0x1014_fdab, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_fdbb, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1014_fdbe, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x1014_fdc1:
            ii(0x1014_fdc1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
