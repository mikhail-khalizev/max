...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_fc9e()
        {
            ...
            ii(0xfca8, 3);    cmp(memw[ss, bp + 0x6], dx);              /* cmp [bp+0x6], dx */
            ii(0xfcab, 2);    if(jb(0xfccc, 0x1f)) goto l_0xfccc;       /* jb 0xfccc */
            ii(0xfcad, 2);    if(ja(0xfcb4, 0x5)) goto l_0xfcb4;        /* ja 0xfcb4 */
            ii(0xfcaf, 3);    cmp(memw[ss, bp + 0x4], ax);              /* cmp [bp+0x4], ax */
        ...
        l_0xfcb4:
            ...
            ii(0xfcbb, 3);    cmp(memw[ss, bp + 0x6], dx);              /* cmp [bp+0x6], dx */
            ii(0xfcbe, 2);    if(ja(0xfccc, 0xc)) goto l_0xfccc;        /* ja 0xfccc */
            ii(0xfcc0, 2);    if(jb(0xfcc7, 0x5)) goto l_0xfcc7;        /* jb 0xfcc7 */
            ii(0xfcc2, 3);    cmp(memw[ss, bp + 0x4], ax);              /* cmp [bp+0x4], ax */
            ii(0xfcc5, 2);    if(ja(0xfccc, 0x5)) goto l_0xfccc;        /* ja 0xfccc */
        l_0xfcc7:
            ii(0xfcc7, 3);    mov(ax, 0x1);                             /* mov ax, 0x1 */
            ii(0xfcca, 2);    jmp(0xfcce, 0x2); goto l_0xfcce;          /* jmp 0xfcce */
        l_0xfccc:
            ii(0xfccc, 2);    sub(ax, ax);                              /* sub ax, ax */
        l_0xfcce:
            ii(0xfcce, 1);    leave();                                  /* leave */
            ii(0xfccf, 3);    ret(0x4);                                 /* ret 0x4 */
        }
    }
}
