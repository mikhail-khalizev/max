...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_3033()
        {
            ...
            ii(0x100f_3038, 5); calld(Definitions.sys_check_available_stack_size, 0x72d15); /* call 0x10165d52 */
            ...
            ii(0x100f_3076, 5); calld(/* sys */ 0x1016_7df0, 0x74d75);  /* call 0x10167df0 */
            ...
            ii(0x100f_3081, 5); calld(/* sys */ 0x1016_7dd4, 0x74d4e);  /* call 0x10167dd4 */
            ...
            ii(0x100f_30b9, 5); calld(Definitions.sys_new, 0x72d42);    /* call 0x10165e00 */
            ...
            ii(0x100f_30e9, 5); calld(0x100d_7bdc, -0x1b512);           /* call 0x100d7bdc */
        ...
        l_0x100f_30ff:
            ...
            ii(0x100f_310f, 5); calld(0x100d_7d74, -0x1b3a0);           /* call 0x100d7d74 */
        l_0x100f_3114:
            ii(0x100f_3114, 3); lea(edx, ebp - 0x34);                   /* lea edx, [ebp-0x34] */
            ii(0x100f_3117, 5); mov(eax, memd_a32[ds, 0x101c_39ac]);    /* mov eax, [0x101c39ac] */
            ii(0x100f_311c, 5); calld(0x100d_7f6c, -0x1b1b5);           /* call 0x100d7f6c */
            ii(0x100f_3121, 5); mov(eax, 0x5);                          /* mov eax, 0x5 */
            ii(0x100f_3126, 5); calld(/* sys */ 0x1016_a24c, 0x77121);  /* call 0x1016a24c */
            ...
            ii(0x100f_3169, 5); calld(Definitions.sys_display_draw_1, 0x7433a); /* call 0x101674a8 */
