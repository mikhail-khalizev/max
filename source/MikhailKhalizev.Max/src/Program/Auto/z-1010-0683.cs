...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_0683()
        {
            ...
            ii(0x1010_069b, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x1010_06b1, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_06b4, 5); jmp(0x1010_0732, 0x79); goto l_0x1010_0732; /* jmp 0x10100732 */
        l_0x1010_06b9:
            ii(0x1010_06b9, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1010_06c0, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1010_06c7, 2); jmp(0x1010_06cf, 0x6); goto l_0x1010_06cf; /* jmp 0x101006cf */
        l_0x1010_06c9:
        ...
        l_0x1010_06cf:
            ...
            ii(0x1010_0709, 2); if(jnz(0x1010_070d, 0x2)) goto l_0x1010_070d; /* jnz 0x1010070d */
        l_0x1010_070b:
            ii(0x1010_070b, 2); jmp(0x1010_0730, 0x23); goto l_0x1010_0730; /* jmp 0x10100730 */
        l_0x1010_070d:
            ii(0x1010_070d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_0724, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_0728, 5); call(0x1007_6e7c, -0x8_98b1);           /* call 0x10076e7c */
            ii(0x1010_072d, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x1010_0730:
            ii(0x1010_0730, 2); jmp(0x1010_06c9, -0x69); goto l_0x1010_06c9; /* jmp 0x101006c9 */
        l_0x1010_0732:
            ii(0x1010_0732, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_0736, 3); cmp(eax, 0x1);                          /* cmp eax, 0x1 */
            ii(0x1010_0739, 2); if(jge(0x1010_0742, 0x7)) goto l_0x1010_0742; /* jge 0x10100742 */
            ii(0x1010_073b, 7); mov(memd[ss, ebp - 0x8], 0xa);          /* mov dword [ebp-0x8], 0xa */
        l_0x1010_0742:
            ii(0x1010_0742, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x1010_075d, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1010_0767, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x1010_078b, 4); mov(ax, memw[ss, ebp - 0x8]);           /* mov ax, [ebp-0x8] */
            ii(0x1010_078f, 1); push(eax);                              /* push eax */
            ii(0x1010_0790, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
