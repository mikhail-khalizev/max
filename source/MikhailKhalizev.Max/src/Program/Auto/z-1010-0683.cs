...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1010_06b9:
            ...
            ii(0x1010_06c0, 7);  mov(memd[ss, ebp - 16], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1010_06c7, 2);  jmp(0x1010_06cf, 6); goto l_0x1010_06cf;/* jmp 0x101006cf */
        l_0x1010_06c9:
            ii(0x1010_06c9, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1010_06cc, 3);  inc(memd[ss, ebp - 16]);              /* inc dword [ebp-0x10] */
        l_0x1010_06cf:
            ii(0x1010_06cf, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1010_06d3, 3);  cmp(eax, 4);                          /* cmp eax, 0x4 */
            ii(0x1010_06d6, 2);  if(jge(0x1010_0732, 0x5a)) goto l_0x1010_0732;/* jge 0x10100732 */
            ii(0x1010_06d8, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x1010_06f1, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
        ...
        l_0x1010_070d:
            ...
            ii(0x1010_0710, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
        ...
        l_0x1010_0742:
            ...
            ii(0x1010_0755, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1010_0758, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1010_0762, 4);  mov(ax, memw[ds, edx + 82]);          /* mov ax, [edx+0x52] */
            ...
            ii(0x1010_076c, 4);  mov(cx, memw[ds, edx + 82]);          /* mov cx, [edx+0x52] */
            ...
            ii(0x1010_0784, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1010_0795, 3);  mov(cl, memb[ds, edx + 38]);          /* mov cl, [edx+0x26] */
