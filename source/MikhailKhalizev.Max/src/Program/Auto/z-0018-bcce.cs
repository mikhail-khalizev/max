...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_bcce()
        {
            ...
            ii(0x18_bcd8, 3); cmp(memw[ss, bp + 0x6], dx);              /* cmp [bp+0x6], dx */
            ii(0x18_bcdb, 2); if(jb(0x18_bcfc, 0x1f)) goto l_0x18_bcfc; /* jb 0xbcfc */
            ii(0x18_bcdd, 2); if(ja(0x18_bce4, 0x5)) goto l_0x18_bce4;  /* ja 0xbce4 */
            ii(0x18_bcdf, 3); cmp(memw[ss, bp + 0x4], ax);              /* cmp [bp+0x4], ax */
        ...
        l_0x18_bce4:
            ...
            ii(0x18_bceb, 3); cmp(memw[ss, bp + 0x6], dx);              /* cmp [bp+0x6], dx */
            ii(0x18_bcee, 2); if(ja(0x18_bcfc, 0xc)) goto l_0x18_bcfc;  /* ja 0xbcfc */
            ii(0x18_bcf0, 2); if(jb(0x18_bcf7, 0x5)) goto l_0x18_bcf7;  /* jb 0xbcf7 */
            ii(0x18_bcf2, 3); cmp(memw[ss, bp + 0x4], ax);              /* cmp [bp+0x4], ax */
            ii(0x18_bcf5, 2); if(ja(0x18_bcfc, 0x5)) goto l_0x18_bcfc;  /* ja 0xbcfc */
        l_0x18_bcf7:
            ii(0x18_bcf7, 3); mov(ax, 0x1);                             /* mov ax, 0x1 */
            ii(0x18_bcfa, 2); jmp(0x18_bcfe, 0x2); goto l_0x18_bcfe;    /* jmp 0xbcfe */
        l_0x18_bcfc:
            ii(0x18_bcfc, 2); sub(ax, ax);                              /* sub ax, ax */
        l_0x18_bcfe:
            ii(0x18_bcfe, 1); leave();                                  /* leave */
            ii(0x18_bcff, 3); ret(0x4);                                 /* ret 0x4 */
        }
    }
}
