...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_d619()
        {
            ...
            ii(0x18_d61e, 3); mov(si, memw[ss, bp + 0x4]);              /* mov si, [bp+0x4] */
        ...
        l_0x18_d62e:
            ...
            ii(0x18_d63c, 4); test(memb[ss, bp - 0x2], 0x10);           /* test byte [bp-0x2], 0x10 */
            ii(0x18_d640, 2); if(jz(0x18_d662, 0x20)) goto l_0x18_d662; /* jz 0xd662 */
            ii(0x18_d642, 3); mov(ax, memw[ss, bp - 0xa]);              /* mov ax, [bp-0xa] */
            ii(0x18_d645, 3); mov(dx, memw[ss, bp - 0x8]);              /* mov dx, [bp-0x8] */
            ii(0x18_d648, 3); sub(ax, memw[ss, bp + 0x6]);              /* sub ax, [bp+0x6] */
            ii(0x18_d64b, 3); sbb(dx, memw[ss, bp + 0x8]);              /* sbb dx, [bp+0x8] */
            ...
            ii(0x18_d657, 2); if(jb(0x18_d65d, 0x4)) goto l_0x18_d65d;  /* jb 0xd65d */
            ii(0x18_d659, 2); cmp(ax, cx);                              /* cmp ax, cx */
            ii(0x18_d65b, 2); if(ja(0x18_d662, 0x5)) goto l_0x18_d662;  /* ja 0xd662 */
        l_0x18_d65d:
