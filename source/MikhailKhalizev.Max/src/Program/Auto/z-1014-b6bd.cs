...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_b6bd()
        {
            ...
            ii(0x1014_b6d5, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_b6d8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b6db, 4); cmp(memd[ds, eax + 0x7e], 0);           /* cmp dword [eax+0x7e], 0x0 */
            ii(0x1014_b6df, 2); if(jz(0x1014_b6f3, 0x12)) goto l_0x1014_b6f3; /* jz 0x1014b6f3 */
            ii(0x1014_b6e1, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_b6e4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b6e7, 3); mov(eax, memd[ds, eax + 0x7e]);         /* mov eax, [eax+0x7e] */
            ii(0x1014_b6ea, 5); call(0x1008_aab4, -0xc_0c3b);           /* call 0x1008aab4 */
            ii(0x1014_b6ef, 2); test(al, al);                           /* test al, al */
            ii(0x1014_b6f1, 2); if(jnz(0x1014_b6f8, 0x5)) goto l_0x1014_b6f8; /* jnz 0x1014b6f8 */
        l_0x1014_b6f3:
            ii(0x1014_b6f3, 5); jmp(0x1014_b775, 0x7d); goto l_0x1014_b775; /* jmp 0x1014b775 */
        l_0x1014_b6f8:
            ii(0x1014_b6f8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b6fb, 3); mov(eax, memd[ds, eax + 0x7e]);         /* mov eax, [eax+0x7e] */
            ...
            ii(0x1014_b708, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b70b, 3); mov(eax, memd[ds, eax + 0x7e]);         /* mov eax, [eax+0x7e] */
            ii(0x1014_b70e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_b711, 4); cmp(memd[ss, ebp - 0x8], 0);            /* cmp dword [ebp-0x8], 0x0 */
            ii(0x1014_b715, 2); if(jz(0x1014_b72b, 0x14)) goto l_0x1014_b72b; /* jz 0x1014b72b */
            ii(0x1014_b717, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_b719, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_b726, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_b729, 2); jmp(0x1014_b732, 0x7); goto l_0x1014_b732; /* jmp 0x1014b732 */
        l_0x1014_b72b:
            ii(0x1014_b72b, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
        l_0x1014_b732:
            ii(0x1014_b732, 2); jmp(0x1014_b764, 0x30); goto l_0x1014_b764; /* jmp 0x1014b764 */
        l_0x1014_b734:
            ii(0x1014_b734, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b737, 3); mov(eax, memd[ds, eax + 0x7e]);         /* mov eax, [eax+0x7e] */
            ...
            ii(0x1014_b745, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b748, 3); mov(eax, memd[ds, eax + 0x7e]);         /* mov eax, [eax+0x7e] */
            ...
            ii(0x1014_b75a, 2); jmp(0x1014_b764, 0x8); goto l_0x1014_b764; /* jmp 0x1014b764 */
        l_0x1014_b75c:
            ii(0x1014_b75c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b75f, 5); call(0x1007_5a79, -0xd_5ceb);           /* call 0x10075a79 */
        l_0x1014_b764:
            ii(0x1014_b764, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b767, 7); mov(memd[ds, eax + 0x7e], 0);           /* mov dword [eax+0x7e], 0x0 */
            ii(0x1014_b76e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b771, 4); mov(memb[ds, eax + 0x4f], 0);           /* mov byte [eax+0x4f], 0x0 */
        l_0x1014_b775:
