...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_4812()
        {
            ...
            ii(0x481c, 3);    mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
            ii(0x481f, 2);    push(0x8);                                /* push 0x8 */
            ii(0x4821, 1);    pop(es);                                  /* pop es */
            ii(0x4822, 4);    mov(memw[es, 0x62], ax);                  /* mov [es:0x62], ax */
            ii(0x4826, 3);    mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ...
            ii(0x4835, 3);    mov(si, memw[ss, bp + 0x8]);              /* mov si, [bp+0x8] */
            ii(0x4838, 3);    mov(cx, memw[ss, bp + 0xa]);              /* mov cx, [bp+0xa] */
            ii(0x483b, 1);    cld();                                    /* cld */
