...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("fd5c46f8-030f-44c0-a744-945cb2f8f9ee")]
        public void Method_100f_7844()
        {
            ii(0x100f_7844, 5); pushd(0x40);                            /* push 0x40 */
            ii(0x100f_7849, 5); calld(Definitions.sys_check_available_stack_size, 0x6e504); /* call 0x10165d52 */
            ...
            ii(0x100f_7868, 5); calld(0x1007_64fc, -0x81371);           /* call 0x100764fc */
            ...
            ii(0x100f_787b, 5); calld(0x1007_6998, -0x80ee8);           /* call 0x10076998 */
            ...
            ii(0x100f_789b, 5); calld(0x1007_5eac, -0x819f4);           /* call 0x10075eac */
            ii(0x100f_78a0, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100f_78a2, 3); lea(eax, ebp - 0x24);                   /* lea eax, [ebp-0x24] */
            ii(0x100f_78a5, 5); calld(0x1007_5f6c, -0x8193e);           /* call 0x10075f6c */
        ...
        l_0x100f_78af:
            ...
            ii(0x100f_78ca, 5); calld(0x1007_6204, -0x816cb);           /* call 0x10076204 */
            ...
            ii(0x100f_78d6, 5); calld(0x100a_b2a8, -0x4c633);           /* call 0x100ab2a8 */
            ii(0x100f_78db, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100f_78dd, 3); lea(eax, ebp - 0x14);                   /* lea eax, [ebp-0x14] */
            ii(0x100f_78e0, 5); calld(0x1013_ad11, 0x4342c);            /* call 0x1013ad11 */
            ...
            ii(0x100f_7901, 5); calld(0x1007_5eac, -0x81a5a);           /* call 0x10075eac */
            ii(0x100f_7906, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100f_7908, 3); lea(eax, ebp - 0x24);                   /* lea eax, [ebp-0x24] */
            ii(0x100f_790b, 5); calld(0x1007_5f6c, -0x819a4);           /* call 0x10075f6c */
        ...
        l_0x100f_7915:
            ...
            ii(0x100f_791a, 5); calld(0x1007_6338, -0x815e7);           /* call 0x10076338 */
            ...
            ii(0x100f_7926, 5); calld(0x1007_643c, -0x814ef);           /* call 0x1007643c */
        l_0x100f_792b:
            ii(0x100f_792b, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100f_792d, 3); lea(eax, ebp - 0x24);                   /* lea eax, [ebp-0x24] */
            ii(0x100f_7930, 5); calld(0x1013_ad71, 0x4343c);            /* call 0x1013ad71 */
            ...
            ii(0x100f_793c, 5); calld(0x1007_63a0, -0x815a1);           /* call 0x100763a0 */
            ii(0x100f_7941, 5); calld(0x1007_6204, -0x81742);           /* call 0x10076204 */
            ...
            ii(0x100f_794d, 5); calld(0x1007_6e00, -0x80b52);           /* call 0x10076e00 */
            ...
            ii(0x100f_7961, 5); calld(0x1007_6408, -0x8155e);           /* call 0x10076408 */
        ...
        l_0x100f_7971:
            ...
            ii(0x100f_797d, 5); calld(0x1007_5eac, -0x81ad6);           /* call 0x10075eac */
            ii(0x100f_7982, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100f_7984, 3); lea(eax, ebp - 0x24);                   /* lea eax, [ebp-0x24] */
            ii(0x100f_7987, 5); calld(0x1007_5f6c, -0x81a20);           /* call 0x10075f6c */
        ...
        l_0x100f_798e:
            ...
            ii(0x100f_7991, 5); calld(0x1007_6bf8, -0x80d9e);           /* call 0x10076bf8 */
        ...
        l_0x100f_7998:
            ...
            ii(0x100f_79a4, 5); calld(0x1007_5eac, -0x81afd);           /* call 0x10075eac */
            ii(0x100f_79a9, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100f_79ab, 3); lea(eax, ebp - 0x24);                   /* lea eax, [ebp-0x24] */
            ii(0x100f_79ae, 5); calld(0x1007_5f6c, -0x81a47);           /* call 0x10075f6c */
