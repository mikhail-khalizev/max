...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_b874()
        {
            ...
            ii(0x1008_b8a5, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1008_b8ac, 2); jmp(0x1008_b8b6, 0x8); goto l_0x1008_b8b6; /* jmp 0x1008b8b6 */
        l_0x1008_b8ae:
            ii(0x1008_b8ae, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1008_b8b1, 5); call(0x1007_6bf8, -0x1_4cbe);           /* call 0x10076bf8 */
        l_0x1008_b8b6:
            ii(0x1008_b8b6, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_b8b8, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ...
            ii(0x1008_b8c4, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1008_b8c7, 5); call(0x1007_63a0, -0x1_552c);           /* call 0x100763a0 */
            ii(0x1008_b8cc, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_b8ce, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ii(0x1008_b8d1, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1008_b8d5, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x1008_b8d7, 2); if(jnz(0x1008_b8f7, 0x1e)) goto l_0x1008_b8f7; /* jnz 0x1008b8f7 */
            ii(0x1008_b8d9, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1008_b8dc, 5); call(0x1007_63a0, -0x1_5541);           /* call 0x100763a0 */
            ii(0x1008_b8e1, 5); cmp(memw[ds, eax + 0x8], 0x7);          /* cmp word [eax+0x8], 0x7 */
            ii(0x1008_b8e6, 2); if(jnz(0x1008_b8f7, 0xf)) goto l_0x1008_b8f7; /* jnz 0x1008b8f7 */
            ii(0x1008_b8e8, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1008_b8eb, 5); call(0x1007_63a0, -0x1_5550);           /* call 0x100763a0 */
            ii(0x1008_b8f0, 4); mov(ax, memw[ds, eax + 0x52]);          /* mov ax, [eax+0x52] */
            ii(0x1008_b8f4, 3); add(memd[ss, ebp - 0x10], eax);         /* add [ebp-0x10], eax */
        l_0x1008_b8f7:
            ii(0x1008_b8f7, 2); jmp(0x1008_b8ae, -0x4b); goto l_0x1008_b8ae; /* jmp 0x1008b8ae */
        l_0x1008_b8f9:
            ii(0x1008_b8f9, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1008_b8fd, 3); cmp(eax, 0xa);                          /* cmp eax, 0xa */
            ii(0x1008_b900, 2); if(jge(0x1008_b908, 0x6)) goto l_0x1008_b908; /* jge 0x1008b908 */
            ii(0x1008_b902, 4); mov(memb[ss, ebp - 0x14], 0x1);         /* mov byte [ebp-0x14], 0x1 */
            ii(0x1008_b906, 2); jmp(0x1008_b90c, 0x4); goto l_0x1008_b90c; /* jmp 0x1008b90c */
        l_0x1008_b908:
            ii(0x1008_b908, 4); mov(memb[ss, ebp - 0x14], 0);           /* mov byte [ebp-0x14], 0x0 */
        l_0x1008_b90c:
            ii(0x1008_b90c, 3); mov(al, memb[ss, ebp - 0x14]);          /* mov al, [ebp-0x14] */
            ii(0x1008_b90f, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x1008_b912, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_b914, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
        ...
        //  ii(0x1008_b920, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
        //  ii(0x1008_b923, 5); call(0x1007_5f6c, -0x1_59bc);           /* call 0x10075f6c */
        l_0x1008_b928:
            ii(0x1008_b928, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
