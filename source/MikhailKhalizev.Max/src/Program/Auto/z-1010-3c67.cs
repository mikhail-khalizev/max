...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_3c67()
        {
            ...
            ii(0x1010_3c7e, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1010_3c81, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1010_3c84, 4); or(memb[ss, ebp - 12], 1);              /* or byte [ebp-0xc], 0x1 */
            ii(0x1010_3c88, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ii(0x1010_3c8b, 5); call(0x1010_45d4, 0x944);               /* call 0x101045d4 */
            ii(0x1010_3c90, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1010_3c93, 4); and(memb[ss, ebp - 12], -2 /* 0xfe */); /* and byte [ebp-0xc], 0xfe */
            ii(0x1010_3c97, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x1010_3ca2, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_3ca5, 5); call(0x1014_74f5, 0x4_384b);            /* call 0x101474f5 */
            ii(0x1010_3caa, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x1010_3cb7, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_3cba, 5); call(0x1014_74f5, 0x4_3836);            /* call 0x101474f5 */
            ii(0x1010_3cbf, 7); mov(memd[ss, ebp - 16], 0);             /* mov dword [ebp-0x10], 0x0 */
            ii(0x1010_3cc6, 2); jmp(0x1010_3cce, 6); goto l_0x1010_3cce; /* jmp 0x10103cce */
        l_0x1010_3cc8:
            ii(0x1010_3cc8, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1010_3ccb, 3); inc(memd[ss, ebp - 16]);                /* inc dword [ebp-0x10] */
        l_0x1010_3cce:
            ii(0x1010_3cce, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1010_3cd1, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1010_3cd4, 3); cmp(ax, memw[ds, edx]);                 /* cmp ax, [edx] */
            ii(0x1010_3cd7, 6); if(jge(0x1010_3d82, 0xa5)) goto l_0x1010_3d82; /* jge 0x10103d82 */
            ii(0x1010_3cdd, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x1010_3ce1, 3); imul(edx, eax, 0xa);                    /* imul edx, eax, 0xa */
            ii(0x1010_3ce4, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1010_3ce7, 3); mov(eax, memd[ds, eax + 4]);            /* mov eax, [eax+0x4] */
            ...
            ii(0x1010_3cff, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_3d02, 5); call(0x1014_73de, 0x4_36d7);            /* call 0x101473de */
            ii(0x1010_3d07, 4); movsx(ebx, memw[ss, ebp - 16]);         /* movsx ebx, word [ebp-0x10] */
            ii(0x1010_3d0b, 5); mov(edx, StringDefinitions.Index6);     /* mov edx, 0x101a3220 */
            ii(0x1010_3d10, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_3d13, 5); call(0x1014_74f5, 0x4_37dd);            /* call 0x101474f5 */
            ii(0x1010_3d18, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x1010_3d1c, 3); imul(edx, eax, 0xa);                    /* imul edx, eax, 0xa */
            ii(0x1010_3d1f, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1010_3d22, 3); mov(eax, memd[ds, eax + 4]);            /* mov eax, [eax+0x4] */
            ...
            ii(0x1010_3d2e, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ii(0x1010_3d31, 5); call(0x1010_4514, 0x7de);               /* call 0x10104514 */
            ii(0x1010_3d36, 2); jmp(0x1010_3d40, 8); goto l_0x1010_3d40; /* jmp 0x10103d40 */
        l_0x1010_3d38:
            ii(0x1010_3d38, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ii(0x1010_3d3b, 5); call(0x1007_6bf8, -0x8_d148);           /* call 0x10076bf8 */
        l_0x1010_3d40:
            ii(0x1010_3d40, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_3d42, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ...
            ii(0x1010_3d53, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_3d56, 5); call(0x1014_73de, 0x4_3683);            /* call 0x101473de */
            ii(0x1010_3d5b, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1010_3d5e, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ii(0x1010_3d61, 5); call(0x1010_44b0, 0x74a);               /* call 0x101044b0 */
            ii(0x1010_3d66, 5); call(0x1010_31e1, -0xb8a);              /* call 0x101031e1 */
            ii(0x1010_3d6b, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
        ...
        l_0x1010_3d75:
            ii(0x1010_3d75, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
        ...
        l_0x1010_3d82:
            ...
            ii(0x1010_3d84, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
