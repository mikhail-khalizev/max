...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_2e4d()
        {
            ...
            ii(0x100a_2e5f, 6); sub(esp, 4);                            /* sub esp, 0x4 */
            ii(0x100a_2e65, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100a_2e68, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_2e6a, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_2e6d, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x100a_2e70, 5); call(0x1008_afe4, -0x1_7e91);           /* call 0x1008afe4 */
            ii(0x100a_2e75, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
