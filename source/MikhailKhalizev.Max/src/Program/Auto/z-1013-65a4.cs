...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("2c477f53-b4dc-4106-8292-b1c43c71cd90")]
        public void Method_1013_65a4()
        {
            ii(0x1013_65a4, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x1013_65a9, 5); calld(Definitions.sys_check_available_stack_size, 0x2f7a4); /* call 0x10165d52 */
            ...
            ii(0x1013_65d4, 1); retd(); return;                         /* ret */
        }
    }
}
