...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_998a()
        {
            ...
            ii(0x17_99a1, 5); mov(memw[ss, bp - 16], 0x24);             /* mov word [bp-0x10], 0x24 */
            ii(0x17_99a6, 3); les(bx, memw[ss, bp + 6]);                /* les bx, [bp+0x6] */
            ii(0x17_99a9, 4); mov(ax, memw[es, bx + 4]);                /* mov ax, [es:bx+0x4] */
            ii(0x17_99ad, 4); mov(dx, memw[es, bx + 6]);                /* mov dx, [es:bx+0x6] */
            ...
            ii(0x17_99bd, 4); mov(ax, memw[es, bx + 2]);                /* mov ax, [es:bx+0x2] */
            ...
            ii(0x17_99cc, 3); add(sp, 4);                               /* add sp, 0x4 */
            ii(0x17_99cf, 2); add(ax, di);                              /* add ax, di */
            ii(0x17_99d1, 2); adc(dx, si);                              /* adc dx, si */
            ii(0x17_99d3, 3); mov(memw[ss, bp - 14], ax);               /* mov [bp-0xe], ax */
            ii(0x17_99d6, 3); mov(memw[ss, bp - 12], dx);               /* mov [bp-0xc], dx */
            ...
            ii(0x17_99e0, 3); add(sp, 6);                               /* add sp, 0x6 */
            ii(0x17_99e3, 3); mov(memw[ss, bp - 10], ax);               /* mov [bp-0xa], ax */
            ii(0x17_99e6, 3); mov(memw[ss, bp - 8], dx);                /* mov [bp-0x8], dx */
            ii(0x17_99e9, 4); mov(memb[ss, bp - 6], 1);                 /* mov byte [bp-0x6], 0x1 */
            ii(0x17_99ed, 2); jmp(0x17_99fe, 0xf); goto l_0x17_99fe;    /* jmp 0x99fe */
        //  ii(0x17_99ef, 1); nop();                                    /* nop */
        l_0x17_99f0:
            ii(0x17_99f0, 4); mov(ax, memw[es, bx + 2]);                /* mov ax, [es:bx+0x2] */
            ii(0x17_99f4, 3); mov(memw[ss, bp - 10], cx);               /* mov [bp-0xa], cx */
            ii(0x17_99f7, 3); mov(memw[ss, bp - 8], ax);                /* mov [bp-0x8], ax */
            ii(0x17_99fa, 4); mov(memb[ss, bp - 6], 0);                 /* mov byte [bp-0x6], 0x0 */
        l_0x17_99fe:
            ii(0x17_99fe, 5); mov(memw[ss, bp - 4], 0x1fa8);            /* mov word [bp-0x4], 0x1fa8 */
            ii(0x17_9a03, 3); mov(memw[ss, bp - 2], ds);                /* mov [bp-0x2], ds */
        l_0x17_9a06:
            ii(0x17_9a06, 3); mov(ax, memw[ss, bp - 16]);               /* mov ax, [bp-0x10] */
            ii(0x17_9a09, 3); dec(memw[ss, bp - 16]);                   /* dec word [bp-0x10] */
            ii(0x17_9a0c, 2); or(ax, ax);                               /* or ax, ax */
            ii(0x17_9a0e, 2); if(jz(0x17_9a24, 0x14)) goto l_0x17_9a24; /* jz 0x9a24 */
            ii(0x17_9a10, 3); les(bx, memw[ss, bp - 4]);                /* les bx, [bp-0x4] */
            ii(0x17_9a13, 3); inc(memw[ss, bp - 4]);                    /* inc word [bp-0x4] */
            ii(0x17_9a16, 3); mov(al, memb[es, bx]);                    /* mov al, [es:bx] */
            ii(0x17_9a19, 3); les(bx, memw[ss, bp - 10]);               /* les bx, [bp-0xa] */
            ii(0x17_9a1c, 3); inc(memw[ss, bp - 10]);                   /* inc word [bp-0xa] */
            ii(0x17_9a1f, 3); mov(memb[es, bx], al);                    /* mov [es:bx], al */
            ii(0x17_9a22, 2); jmp(0x17_9a06, -0x1e); goto l_0x17_9a06;  /* jmp 0x9a06 */
        l_0x17_9a24:
            ii(0x17_9a24, 4); cmp(memb[ss, bp - 6], 0);                 /* cmp byte [bp-0x6], 0x0 */
            ii(0x17_9a28, 2); if(jz(0x17_9a38, 0xe)) goto l_0x17_9a38;  /* jz 0x9a38 */
            ii(0x17_9a2a, 3); push(memw[ss, bp - 8]);                   /* push word [bp-0x8] */
            ii(0x17_9a2d, 3); push(memw[ss, bp - 10]);                  /* push word [bp-0xa] */
            ii(0x17_9a30, 1); nop();                                    /* nop */
            ii(0x17_9a31, 1); push(cs);                                 /* push cs */
            ii(0x17_9a32, 3); call(0x17_e758, 0x4d23);                  /* call 0xe758 */
            ii(0x17_9a35, 3); add(sp, 4);                               /* add sp, 0x4 */
        l_0x17_9a38:
            ii(0x17_9a38, 3); les(bx, memw[ss, bp + 6]);                /* les bx, [bp+0x6] */
            ii(0x17_9a3b, 5); and(memb[es, bx + 44], -2 /* 0xfe */);    /* and byte [es:bx+0x2c], 0xfe */
