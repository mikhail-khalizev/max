...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("67aa4931-abc5-4302-8a78-86617683795f")]
        public void Method_100c_4004()
        {
            ...
            ii(0x100c_4010, 2); jad_func(0x100c_3fdd, -0x35);           /* ja 0x100c3fdd */
            ...
            ii(0x100c_401a, 7); jmpd_abs(memd_a32[cs, eax + 0x100c_3fe0]); return; /* jmp dword [cs:eax+0x100c3fe0] */
        }
    }
}
