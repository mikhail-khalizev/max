...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x17_4a4e, 4); enter(0x2, 0);                            /* enter 0x2, 0x0 */
            ...
            ii(0x17_4a59, 3); mov(si, memw[ss, bp + 0x6]);              /* mov si, [bp+0x6] */
            ...
            ii(0x17_4a65, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ii(0x17_4a68, 2); or(ax, ax);                               /* or ax, ax */
            ii(0x17_4a6a, 2); if(jz(0x17_4a74, 0x8)) goto l_0x17_4a74;  /* jz 0x4a74 */
            ii(0x17_4a6c, 2); mov(bx, ax);                              /* mov bx, ax */
            ii(0x17_4a6e, 4); cmp(memb[ds, bx + si - 0x1], 0x5c);       /* cmp byte [bx+si-0x1], 0x5c */
        ...
        l_0x17_4a80:
            ...
            ii(0x17_4a93, 2); if(jz(0x17_4a9e, 0x9)) goto l_0x17_4a9e;  /* jz 0x4a9e */
