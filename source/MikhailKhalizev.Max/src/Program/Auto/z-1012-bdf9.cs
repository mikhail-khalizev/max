...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_bdf9()
        {
            ...
            ii(0x1012_be0f, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1012_be12, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1012_be15, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1012_be18, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_be1b, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x1012_be1e, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1012_be21, 5); call(0x1007_1f2e, -0xb_9ef8);           /* call 0x10071f2e */
            ii(0x1012_be26, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1012_be29, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1012_be2d, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1012_be2f, 2); if(jz(0x1012_be44, 0x13)) goto l_0x1012_be44; /* jz 0x1012be44 */
            ii(0x1012_be31, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_be34, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1012_be36, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ...
            ii(0x1012_be42, 2); if(jz(0x1012_be46, 0x2)) goto l_0x1012_be46; /* jz 0x1012be46 */
        l_0x1012_be44:
            ii(0x1012_be44, 2); jmp(0x1012_be59, 0x13); goto l_0x1012_be59; /* jmp 0x1012be59 */
        l_0x1012_be46:
            ii(0x1012_be46, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_be49, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1012_be57, 2); if(jz(0x1012_be5e, 0x5)) goto l_0x1012_be5e; /* jz 0x1012be5e */
        l_0x1012_be59:
            ii(0x1012_be59, 5); jmp(0x1012_c081, 0x223); goto l_0x1012_c081; /* jmp 0x1012c081 */
        l_0x1012_be5e:
            ii(0x1012_be5e, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1012_be61, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1012_be64, 7); mov(memd[ss, ebp - 0x1c], 0);           /* mov dword [ebp-0x1c], 0x0 */
            ii(0x1012_be6b, 7); mov(memd[ss, ebp - 0x14], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x1012_be72, 3); lea(eax, memd[ss, ebp - 0x28]);         /* lea eax, [ebp-0x28] */
            ...
            ii(0x1012_be83, 3); lea(edx, memd[ss, ebp - 0x28]);         /* lea edx, [ebp-0x28] */
            ii(0x1012_be86, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_be89, 5); call(0x1007_2388, -0xb_9b06);           /* call 0x10072388 */
            ii(0x1012_be8e, 3); mov(eax, memd[ss, ebp - 0x22]);         /* mov eax, [ebp-0x22] */
            ii(0x1012_be91, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1012_be94, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x1012_bea5, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1012_bea8, 2); neg(eax);                               /* neg eax */
            ii(0x1012_beaa, 1); cwde();                                 /* cwde */
            ii(0x1012_beab, 1); push(eax);                              /* push eax */
            ii(0x1012_beac, 4); movsx(eax, memw[ss, ebp - 0x18]);       /* movsx eax, word [ebp-0x18] */
            ...
            ii(0x1012_bec2, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ii(0x1012_bec5, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
        ...
        l_0x1012_bed4:
            ...
            ii(0x1012_bedd, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1012_bee1, 1); push(eax);                              /* push eax */
            ii(0x1012_bee2, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ...
            ii(0x1012_befa, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ii(0x1012_befd, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
        ...
        l_0x1012_bf0a:
            ii(0x1012_bf0a, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1012_bf11, 7); mov(memd[ss, ebp - 0x18], 0);           /* mov dword [ebp-0x18], 0x0 */
            ii(0x1012_bf18, 5); mov(eax, 0x101c_819c);                  /* mov eax, 0x101c819c */
            ii(0x1012_bf1d, 5); call(0x1007_6338, -0xb_5bea);           /* call 0x10076338 */
            ii(0x1012_bf22, 3); lea(ebx, memd[ss, ebp - 0x2c]);         /* lea ebx, [ebp-0x2c] */
            ...
            ii(0x1012_bf2e, 2); jmp(0x1012_bf38, 0x8); goto l_0x1012_bf38; /* jmp 0x1012bf38 */
        l_0x1012_bf30:
            ii(0x1012_bf30, 3); lea(eax, memd[ss, ebp - 0x2c]);         /* lea eax, [ebp-0x2c] */
            ii(0x1012_bf33, 5); call(0x1007_6bf8, -0xb_5340);           /* call 0x10076bf8 */
        l_0x1012_bf38:
            ii(0x1012_bf38, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1012_bf3a, 3); lea(eax, memd[ss, ebp - 0x2c]);         /* lea eax, [ebp-0x2c] */
            ...
            ii(0x1012_bf4a, 3); lea(eax, memd[ss, ebp - 0x2c]);         /* lea eax, [ebp-0x2c] */
            ...
            ii(0x1012_bf59, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1012_bf65, 3); lea(eax, memd[ss, ebp - 0x2c]);         /* lea eax, [ebp-0x2c] */
            ii(0x1012_bf68, 5); call(0x1007_63a0, -0xb_5bcd);           /* call 0x100763a0 */
            ii(0x1012_bf6d, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x1012_bf70, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1012_bf73, 5); call(0x1007_1f2e, -0xb_a04a);           /* call 0x10071f2e */
            ii(0x1012_bf78, 4); mov(memw[ss, ebp - 0x22], ax);          /* mov [ebp-0x22], ax */
            ii(0x1012_bf7c, 4); movsx(eax, memw[ss, ebp - 0x22]);       /* movsx eax, word [ebp-0x22] */
            ii(0x1012_bf80, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1012_bf82, 2); if(jge(0x1012_bf8c, 0x8)) goto l_0x1012_bf8c; /* jge 0x1012bf8c */
            ii(0x1012_bf84, 3); mov(eax, memd[ss, ebp - 0x22]);         /* mov eax, [ebp-0x22] */
            ii(0x1012_bf87, 3); sub(memd[ss, ebp - 0x10], eax);         /* sub [ebp-0x10], eax */
            ii(0x1012_bf8a, 2); jmp(0x1012_bf92, 0x6); goto l_0x1012_bf92; /* jmp 0x1012bf92 */
        l_0x1012_bf8c:
            ii(0x1012_bf8c, 3); mov(eax, memd[ss, ebp - 0x22]);         /* mov eax, [ebp-0x22] */
            ii(0x1012_bf8f, 3); add(memd[ss, ebp - 0x14], eax);         /* add [ebp-0x14], eax */
        l_0x1012_bf92:
            ...
            ii(0x1012_bf9b, 3); lea(edx, memd[ss, ebp - 0x28]);         /* lea edx, [ebp-0x28] */
            ii(0x1012_bf9e, 3); lea(eax, memd[ss, ebp - 0x2c]);         /* lea eax, [ebp-0x2c] */
            ii(0x1012_bfa1, 5); call(0x1007_63d4, -0xb_5bd2);           /* call 0x100763d4 */
            ii(0x1012_bfa6, 5); call(0x1007_2388, -0xb_9c23);           /* call 0x10072388 */
            ii(0x1012_bfab, 4); movsx(eax, memw[ss, ebp - 0x22]);       /* movsx eax, word [ebp-0x22] */
            ii(0x1012_bfaf, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1012_bfb1, 2); if(jge(0x1012_bfbb, 0x8)) goto l_0x1012_bfbb; /* jge 0x1012bfbb */
            ii(0x1012_bfb3, 3); mov(eax, memd[ss, ebp - 0x22]);         /* mov eax, [ebp-0x22] */
            ii(0x1012_bfb6, 3); sub(memd[ss, ebp - 0x1c], eax);         /* sub [ebp-0x1c], eax */
            ii(0x1012_bfb9, 2); jmp(0x1012_bfc1, 0x6); goto l_0x1012_bfc1; /* jmp 0x1012bfc1 */
        l_0x1012_bfbb:
            ii(0x1012_bfbb, 3); mov(eax, memd[ss, ebp - 0x22]);         /* mov eax, [ebp-0x22] */
            ii(0x1012_bfbe, 3); add(memd[ss, ebp - 0x18], eax);         /* add [ebp-0x18], eax */
        l_0x1012_bfc1:
            ii(0x1012_bfc1, 5); jmp(0x1012_bf30, -0x96); goto l_0x1012_bf30; /* jmp 0x1012bf30 */
        l_0x1012_bfc6:
            ii(0x1012_bfc6, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_bfc9, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1012_bfe2, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1012_bfe6, 1); push(eax);                              /* push eax */
            ii(0x1012_bfe7, 4); movsx(eax, memw[ss, ebp - 0x1c]);       /* movsx eax, word [ebp-0x1c] */
            ...
            ii(0x1012_bffd, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ii(0x1012_c000, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
        ...
        l_0x1012_c00f:
            ...
            ii(0x1012_c018, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1012_c01c, 1); push(eax);                              /* push eax */
            ii(0x1012_c01d, 4); movsx(eax, memw[ss, ebp - 0x18]);       /* movsx eax, word [ebp-0x18] */
            ...
            ii(0x1012_c033, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ii(0x1012_c036, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x1012_c04c, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1012_c050, 1); push(eax);                              /* push eax */
            ii(0x1012_c051, 4); movsx(eax, memw[ss, ebp - 0x1c]);       /* movsx eax, word [ebp-0x1c] */
            ...
            ii(0x1012_c067, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ii(0x1012_c06a, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
        ...
        l_0x1012_c077:
            ...
            ii(0x1012_c079, 3); lea(eax, memd[ss, ebp - 0x2c]);         /* lea eax, [ebp-0x2c] */
