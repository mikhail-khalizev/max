...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_fef0()
        {
            ...
            ii(0x18_fef5, 3); mov(bx, memw[ss, bp + 6]);                /* mov bx, [bp+0x6] */
            ii(0x18_fef8, 3); mov(ax, 0x202);                           /* mov ax, 0x202 */
            ii(0x18_fefb, 2); or(bh, bh);                               /* or bh, bh */
            ii(0x18_fefd, 4); if(jnz(0x18_ff04, 3)) goto l_0x18_ff04;   /* jnz 0xff04 */
            ii(0x18_ff01, 3); add(ax, 2);                               /* add ax, 0x2 */
        l_0x18_ff04:
            ...
            ii(0x18_ff0d, 3); shl(di, 3);                               /* shl di, 0x3 */
            ii(0x18_ff10, 4); add(di, 0x142);                           /* add di, 0x142 */
            ii(0x18_ff14, 3); mov(memw[ds, di + 4], cx);                /* mov [di+0x4], cx */
            ii(0x18_ff17, 3); mov(memd[ds, di], edx);                   /* mov [di], edx */
            ii(0x18_ff1a, 4); mov(memb[ds, di + 6], 0x8e);              /* mov byte [di+0x6], 0x8e */
            ii(0x18_ff1e, 4); cmp(memw[ss, bp + 8], 0);                 /* cmp word [bp+0x8], 0x0 */
        ...
        l_0x18_ff63:
            ...
            ii(0x18_ff65, 3); mov(ax, 6);                               /* mov ax, 0x6 */
        ...
        l_0x18_ff6d:
            ...
            ii(0x18_ff77, 4); if(jae(0x18_ff7d, 2)) goto l_0x18_ff7d;   /* jae 0xff7d */
