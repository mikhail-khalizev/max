...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_0adc()
        {
            ...
            ii(0x100d_0af4, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100d_0af7, 7); mov(memd[ss, ebp - 0x8], 0x101c_35b0);  /* mov dword [ebp-0x8], 0x101c35b0 */
            ii(0x100d_0afe, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
