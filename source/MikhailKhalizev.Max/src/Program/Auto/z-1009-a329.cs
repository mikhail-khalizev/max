...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_a329()
        {
            ...
            ii(0x1009_a33b, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1009_a341, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1009_a344, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_a346, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_a355, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1009_a358, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1009_a35b, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1009_a35e, 3); mov(edx, memd[ds, eax + 2]);            /* mov edx, [eax+0x2] */
            ii(0x1009_a361, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1009_a364, 3); call_abs(memd[ds, edx + 112]);          /* call dword [edx+0x70] */
        l_0x1009_a367:
