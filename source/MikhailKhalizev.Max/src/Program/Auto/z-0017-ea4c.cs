...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_ea4c()
        {
            ...
            ii(0x17_ea90, 3); les(bx, memw[ss, bp - 0x4]);              /* les bx, [bp-0x4] */
            ...
            ii(0x17_eaa6, 3); les(bx, memw[ss, bp - 0x4]);              /* les bx, [bp-0x4] */
            ii(0x17_eaa9, 5); mov(memw[es, bx + 0x7f0], ax);            /* mov [es:bx+0x7f0], ax */
            ii(0x17_eaae, 3); les(bx, memw[ss, bp - 0x4]);              /* les bx, [bp-0x4] */
