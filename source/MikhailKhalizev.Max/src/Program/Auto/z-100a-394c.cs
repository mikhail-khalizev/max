...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_394c()
        {
            ...
            ii(0x100a_3963, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_3966, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_3969, 7); test(memd[ss, ebp - 0x4], 0x4);         /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x100a_3977, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100a_3986:
            ii(0x100a_3986, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_3989, 7); mov(memd[ds, eax + 0x2], 0x101b_4f24);  /* mov dword [eax+0x2], 0x101b4f24 */
            ii(0x100a_3990, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_3992, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_39a0, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_39a3, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x100a_39a8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_39ab, 5); call(0x100a_36c9, -0x2e7);              /* call 0x100a36c9 */
            ii(0x100a_39b0, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_39b3, 7); test(memd[ss, ebp - 0x4], 0x2);         /* test dword [ebp-0x4], 0x2 */
            ii(0x100a_39ba, 2); if(jz(0x100a_39c4, 0x8)) goto l_0x100a_39c4; /* jz 0x100a39c4 */
            ii(0x100a_39bc, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_39bf, 5); call(Definitions.sys_delete, 0xc_25a0); /* call 0x10165f64 */
        l_0x100a_39c4:
            ii(0x100a_39c4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
