...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_b2c2()
        {
            ...
            ii(0xb2cb, 2);  cmp(al, 3);                                /* cmp al, 0x3 */
            ...
            ii(0xb2e8, 2);  mov(ah, 9);                                /* mov ah, 0x9 */
            ii(0xb2ea, 3);  mov(dx, 0x40);                             /* mov dx, 0x40 */
            ii(0xb2ed, 3);  call_far_ind(memw[ss, bp]);                /* call far word [bp] */
            ...
            ii(0xb311, 3);  call_far_ind(memw[ss, bp]);                /* call far word [bp] */
            ii(0xb314, 2);  mov(ah, 0xa);                              /* mov ah, 0xa */
            ii(0xb316, 3);  call_far_ind(memw[ss, bp]);                /* call far word [bp] */
