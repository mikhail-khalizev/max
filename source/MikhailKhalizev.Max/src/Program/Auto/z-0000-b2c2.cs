...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_b2c2()
        {
            ...
            ii(0xb2ed, 3);    call_far_ind(ss, bp + 0);                 /* call far word [bp] */
            ...
            ii(0xb300, 3);    call_far_ind(ss, bp + 0);                 /* call far word [bp] */
            ...
            ii(0xb311, 3);    call_far_ind(ss, bp + 0);                 /* call far word [bp] */
            ii(0xb314, 2);    mov(ah, 0xa);                             /* mov ah, 0xa */
            ii(0xb316, 3);    call_far_ind(ss, bp + 0);                 /* call far word [bp] */
