...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_a1bd()
        {
            ...
            ii(0xa1ca, 4);    push(memw[ds, 0x2]);                      /* push word [0x2] */
            ii(0xa1ce, 4);    push(memw[ds, 0x4]);                      /* push word [0x4] */
            ii(0xa1d2, 5);    mov(memw[ss, 0xf7a], sp);                 /* mov [ss:0xf7a], sp */
            ii(0xa1d7, 3);    mov(cx, 0x14);                            /* mov cx, 0x14 */
        l_0xa1da:
            ii(0xa1da, 1);    push(ax);                                 /* push ax */
            ii(0xa1db, 2);    if(loop(0xa1da, -0x3)) goto l_0xa1da;     /* loop 0xa1da */
            ...
            ii(0xa1ee, 6);    mov(memw[ds, 0x1], 0x6485);               /* mov word [0x1], 0x6485 */
            ii(0xa1f4, 4);    mov(memw[ds, 0x3], cs);                   /* mov [0x3], cs */
            ii(0xa1f8, 2);    mov(al, 0x9);                             /* mov al, 0x9 */
            ii(0xa1fa, 2);    outb(0x71, al);                           /* out 0x71, al */
            ii(0xa1fc, 6);    lgdt(ss, 0x8c8);                          /* lgdt [ss:0x8c8] */
            ii(0xa202, 6);    lidt(ss, 0x8d0);                          /* lidt [ss:0x8d0] */
