...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_93c8()
        {
            ...
            ii(0x17_93dc, 4); mov(memw[es, di + 113], ax);              /* mov [es:di+0x71], ax */
            ii(0x17_93e0, 2); mov(bx, ax);                              /* mov bx, ax */
            ii(0x17_93e2, 3); mov(ax, 8);                               /* mov ax, 0x8 */
            ii(0x17_93e5, 2); mov(es, ax);                              /* mov es, ax */
            ii(0x17_93e7, 5); mov(memb[es, bx + 5], 0x93);              /* mov byte [es:bx+0x5], 0x93 */
            ...
            ii(0x17_93f8, 4); mov(memw[es, di + 115], bx);              /* mov [es:di+0x73], bx */
            ii(0x17_93fc, 3); mov(ax, 8);                               /* mov ax, 0x8 */
            ii(0x17_93ff, 2); mov(es, ax);                              /* mov es, ax */
            ii(0x17_9401, 5); mov(memb[es, bx + 5], 0x93);              /* mov byte [es:bx+0x5], 0x93 */
            ii(0x17_9406, 1); push(ds);                                 /* push ds */
            ii(0x17_9407, 1); pop(es);                                  /* pop es */
            ii(0x17_9408, 3); mov(di, 0x50c4);                          /* mov di, 0x50c4 */
            ii(0x17_940b, 4); mov(ds, memw[es, di + 115]);              /* mov ds, [es:di+0x73] */
            ...
            ii(0x17_941a, 4); mov(ds, memw[es, di + 115]);              /* mov ds, [es:di+0x73] */
            ii(0x17_941e, 4); mov(es, memw[es, di + 113]);              /* mov es, [es:di+0x71] */
            ii(0x17_9422, 2); xor(di, di);                              /* xor di, di */
            ii(0x17_9424, 2); xor(si, si);                              /* xor si, si */
            ii(0x17_9426, 8); and(memd[ds, si + 36], 0xfffe_fcff);      /* and dword [si+0x24], 0xfffefcff */
            ii(0x17_942e, 3); mov(ebx, cr2);                            /* mov ebx, cr2 */
            ii(0x17_9431, 4); mov(memd[ds, si + 52], ebx);              /* mov [si+0x34], ebx */
            ii(0x17_9435, 8); mov(memd[ds, si + 56], 0xffc);            /* mov dword [si+0x38], 0xffc */
            ii(0x17_943d, 4); mov(ax, memw[es, di + 84]);               /* mov ax, [es:di+0x54] */
            ii(0x17_9441, 3); mov(memw[ds, si + 84], ax);               /* mov [si+0x54], ax */
            ii(0x17_9444, 4); mov(ax, memw[es, di + 80]);               /* mov ax, [es:di+0x50] */
            ii(0x17_9448, 3); mov(memw[ds, si + 80], ax);               /* mov [si+0x50], ax */
            ii(0x17_944b, 3); mov(memw[ds, si + 76], cs);               /* mov [si+0x4c], cs */
            ii(0x17_944e, 8); mov(memd[ds, si + 32], 0x4cd9);           /* mov dword [si+0x20], 0x4cd9 */
            ...
            ii(0x17_945f, 9); mov(memd[es, di + 104], 0);               /* mov dword [es:di+0x68], 0x0 */
            ii(0x17_9468, 4); mov(ax, memw[es, di + 80]);               /* mov ax, [es:di+0x50] */
            ...
            ii(0x17_9481, 5); mov(memd[es, di + 104], eax);             /* mov [es:di+0x68], eax */
            ii(0x17_9486, 5); mov(eax, memd[es, di + 56]);              /* mov eax, [es:di+0x38] */
        ...
        l_0x17_9498:
            ...
            ii(0x17_949d, 6); mov(memw[es, di + 90], 0);                /* mov word [es:di+0x5a], 0x0 */
            ii(0x17_94a3, 2); xor(cl, cl);                              /* xor cl, cl */
            ii(0x17_94a5, 5); cmp(memb[ds, 0xb2], 1);                   /* cmp byte [0xb2], 0x1 */
        ...
        l_0x17_94b9:
            ...
            ii(0x17_94be, 4); if(jz(0x17_94ca, 8)) goto l_0x17_94ca;    /* jz 0x94ca */
            ii(0x17_94c2, 6); mov(memw[es, di + 90], 0xffff);           /* mov word [es:di+0x5a], 0xffff */
            ii(0x17_94c8, 2); mov(cl, 1);                               /* mov cl, 0x1 */
        l_0x17_94ca:
            ii(0x17_94ca, 3); mov(ax, 8);                               /* mov ax, 0x8 */
            ii(0x17_94cd, 2); mov(ds, ax);                              /* mov ds, ax */
            ii(0x17_94cf, 4); mov(bx, memw[es, di + 115]);              /* mov bx, [es:di+0x73] */
            ii(0x17_94d3, 4); mov(memb[ds, bx + 5], 0x8b);              /* mov byte [bx+0x5], 0x8b */
            ii(0x17_94d7, 4); mov(bx, memw[es, di + 113]);              /* mov bx, [es:di+0x71] */
            ii(0x17_94db, 4); mov(memb[ds, bx + 5], 0x8b);              /* mov byte [bx+0x5], 0x8b */
            ...
            ii(0x17_94eb, 3); cmp(cl, 1);                               /* cmp cl, 0x1 */
            ii(0x17_94ee, 4); if(jz(0x17_94f4, 2)) goto l_0x17_94f4;    /* jz 0x94f4 */
