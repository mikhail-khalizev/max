...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_8f63()
        {
            ...
            ii(0x100b_8f7b, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_8f7e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_8f81, 4); cmp(memb[ds, eax + 0x14], 0);           /* cmp byte [eax+0x14], 0x0 */
            ii(0x100b_8f85, 2); if(jnz(0x100b_8fa4, 0x1d)) goto l_0x100b_8fa4; /* jnz 0x100b8fa4 */
            ii(0x100b_8f87, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_8f8a, 3); mov(edx, memd[ds, eax + 0xc]);          /* mov edx, [eax+0xc] */
            ii(0x100b_8f8d, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100b_8f90, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100b_8fa4:
            ii(0x100b_8fa4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_8fa7, 3); add(eax, 0x6);                          /* add eax, 0x6 */
            ii(0x100b_8faa, 5); call(0x1007_6574, -0x4_2a3b);           /* call 0x10076574 */
            ii(0x100b_8faf, 4); mov(dx, memw[ds, eax + 0x1a]);          /* mov dx, [eax+0x1a] */
            ii(0x100b_8fb3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_8fb6, 4); mov(memw[ds, eax + 0x10], dx);          /* mov [eax+0x10], dx */
            ii(0x100b_8fba, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_8fbd, 3); add(eax, 0x6);                          /* add eax, 0x6 */
            ii(0x100b_8fc0, 5); call(0x1007_6574, -0x4_2a51);           /* call 0x10076574 */
            ii(0x100b_8fc5, 4); mov(dx, memw[ds, eax + 0x1c]);          /* mov dx, [eax+0x1c] */
            ii(0x100b_8fc9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_8fcc, 4); mov(memw[ds, eax + 0x12], dx);          /* mov [eax+0x12], dx */
            ii(0x100b_8fd0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_8fd3, 3); mov(edx, memd[ds, eax + 0xc]);          /* mov edx, [eax+0xc] */
            ii(0x100b_8fd6, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100b_8fd9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_8feb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_8fee, 3); mov(memb[ds, eax + 0x14], dl);          /* mov [eax+0x14], dl */
        l_0x100b_8ff1:
