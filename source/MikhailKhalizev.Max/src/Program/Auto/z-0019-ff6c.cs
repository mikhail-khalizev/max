...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_ff6c()
        {
            ...
            ii(0x19_ff75, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x19_ff78, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ii(0x19_ff7b, 3); push(memw[ss, bp + 0xa]);                 /* push word [bp+0xa] */
            ii(0x19_ff7e, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ...
            ii(0x19_ff8b, 3); ret(0x8);                                 /* ret 0x8 */
        }
    }
}
