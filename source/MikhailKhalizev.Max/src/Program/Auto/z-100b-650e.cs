...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_650e()
        {
            ...
            ii(0x100b_6526, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_6529, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_652c, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100b_652f, 5); call(0x1007_6338, -0x4_01fc);           /* call 0x10076338 */
            ii(0x100b_6534, 3); lea(ebx, memd[ss, ebp - 0x8]);          /* lea ebx, [ebp-0x8] */
            ...
            ii(0x100b_6540, 2); jmp(0x100b_654a, 0x8); goto l_0x100b_654a; /* jmp 0x100b654a */
        l_0x100b_6542:
            ii(0x100b_6542, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x100b_6545, 5); call(0x1007_6bf8, -0x3_f952);           /* call 0x10076bf8 */
        l_0x100b_654a:
            ii(0x100b_654a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_654c, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x100b_6558, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_655b, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100b_655e, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100b_6561, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x100b_6564, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x100b_6567, 5); call(0x1007_63d4, -0x4_0198);           /* call 0x100763d4 */
            ii(0x100b_656c, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100b_656e, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100b_6571, 3); call_abs(memd[ds, ebx + 0x44]);         /* call dword [ebx+0x44] */
            ...
            ii(0x100b_657a, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
        ...
        l_0x100b_6586:
            ...
            ii(0x100b_6588, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
