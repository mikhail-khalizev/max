...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_9226()
        {
            ...
            ii(0x1015_9249, 7); mov(memd[ss, ebp - 20], 0x31);          /* mov dword [ebp-0x14], 0x31 */
            ii(0x1015_9250, 5); mov(eax, StringDefinitions.Repair3);    /* mov eax, 0x101b259f */
            ii(0x1015_9255, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1015_9258, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1015_925b, 4); cmp(memb[ds, eax + 87], 4);             /* cmp byte [eax+0x57], 0x4 */
            ii(0x1015_925f, 2); if(jnz(0x1015_9267, 6)) goto l_0x1015_9267; /* jnz 0x10159267 */
            ii(0x1015_9261, 4); mov(memb[ss, ebp - 12], 1);             /* mov byte [ebp-0xc], 0x1 */
            ii(0x1015_9265, 2); jmp(0x1015_926b, 4); goto l_0x1015_926b; /* jmp 0x1015926b */
        l_0x1015_9267:
            ii(0x1015_9267, 4); mov(memb[ss, ebp - 12], 0);             /* mov byte [ebp-0xc], 0x0 */
        l_0x1015_926b:
            ii(0x1015_926b, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_926d, 3); mov(dl, memb[ss, ebp - 12]);            /* mov dl, [ebp-0xc] */
            ii(0x1015_9270, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1015_9273, 3); mov(ecx, memd[ss, ebp - 20]);           /* mov ecx, [ebp-0x14] */
            ii(0x1015_9276, 3); mov(ebx, memd[ss, ebp - 16]);           /* mov ebx, [ebp-0x10] */
