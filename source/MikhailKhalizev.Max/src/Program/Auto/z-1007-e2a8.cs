...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_e2a8()
        {
            ...
            ii(0x1007_e2c0, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_e2c3, 4); mov(memb[ss, ebp - 0x8], 0xd);          /* mov byte [ebp-0x8], 0xd */
            ii(0x1007_e2c7, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
