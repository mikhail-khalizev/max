...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_de3c()
        {
            ...
            ii(0x1011_de53, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_de56, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1011_de59, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_de5c, 3); add(eax, 0x4);                          /* add eax, 0x4 */
            ii(0x1011_de5f, 5); call(0x1012_0894, 0x2a30);              /* call 0x10120894 */
            ii(0x1011_de64, 3); lea(ebx, memd[ss, ebp - 0xc]);          /* lea ebx, [ebp-0xc] */
            ...
            ii(0x1011_de70, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1011_de77, 2); jmp(0x1011_de81, 0x8); goto l_0x1011_de81; /* jmp 0x1011de81 */
        l_0x1011_de79:
            ii(0x1011_de79, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1011_de7c, 5); call(0x1007_6bf8, -0xa_7289);           /* call 0x10076bf8 */
        l_0x1011_de81:
            ii(0x1011_de81, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_de83, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ...
            ii(0x1011_de8f, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ...
            ii(0x1011_dea0, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ...
            ii(0x1011_deaf, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ii(0x1011_deb2, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1011_deb6, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x1011_deb8, 2); if(jz(0x1011_debc, 0x2)) goto l_0x1011_debc; /* jz 0x1011debc */
        l_0x1011_deba:
            ii(0x1011_deba, 2); jmp(0x1011_dec2, 0x6); goto l_0x1011_dec2; /* jmp 0x1011dec2 */
        l_0x1011_debc:
            ii(0x1011_debc, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1011_debf, 3); inc(memd[ss, ebp - 0x10]);              /* inc dword [ebp-0x10] */
        l_0x1011_dec2:
            ii(0x1011_dec2, 2); jmp(0x1011_de79, -0x4b); goto l_0x1011_de79; /* jmp 0x1011de79 */
        l_0x1011_dec4:
            ii(0x1011_dec4, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_dec6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1011_ded2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1011_dee1, 2); if(jnz(0x1011_dee5, 0x2)) goto l_0x1011_dee5; /* jnz 0x1011dee5 */
        l_0x1011_dee3:
            ii(0x1011_dee3, 2); jmp(0x1011_deff, 0x1a); goto l_0x1011_deff; /* jmp 0x1011deff */
        l_0x1011_dee5:
            ii(0x1011_dee5, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1011_def4, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ii(0x1011_def7, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1011_defb, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x1011_defd, 2); if(jz(0x1011_df01, 0x2)) goto l_0x1011_df01; /* jz 0x1011df01 */
        l_0x1011_deff:
            ii(0x1011_deff, 2); jmp(0x1011_df07, 0x6); goto l_0x1011_df07; /* jmp 0x1011df07 */
        l_0x1011_df01:
            ii(0x1011_df01, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1011_df04, 3); inc(memd[ss, ebp - 0x10]);              /* inc dword [ebp-0x10] */
        l_0x1011_df07:
            ii(0x1011_df07, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1011_df0a, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1011_df0d, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_df0f, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
        ...
        //  ii(0x1011_df1b, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
        //  ii(0x1011_df1e, 5); call(0x1012_0464, 0x2541);              /* call 0x10120464 */
        l_0x1011_df23:
            ii(0x1011_df23, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
