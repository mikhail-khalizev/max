...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_eaed()
        {
            ...
            ii(0x17_eaf3, 3); lds(bx, memw[ss, bp + 0x8]);              /* lds bx, [bp+0x8] */
            ii(0x17_eaf6, 3); mov(dx, memw[ds, bx + 0xe]);              /* mov dx, [bx+0xe] */
            ii(0x17_eaf9, 3); mov(si, memw[ds, bx + 0x6]);              /* mov si, [bx+0x6] */
            ii(0x17_eafc, 3); mov(di, memw[ds, bx + 0x4]);              /* mov di, [bx+0x4] */
            ii(0x17_eaff, 3); mov(cx, memw[ds, bx + 0x2]);              /* mov cx, [bx+0x2] */
            ...
            ii(0x17_eb0d, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_eb10, 3); mov(cx, memw[ds, bx + 0x10]);             /* mov cx, [bx+0x10] */
            ii(0x17_eb13, 3); mov(bx, memw[ds, bx + 0xc]);              /* mov bx, [bx+0xc] */
            ii(0x17_eb16, 1); pop(ds);                                  /* pop ds */
            ii(0x17_eb17, 2); @int(0x21);                               /* int 0x21 */
            ii(0x17_eb19, 1); push(bx);                                 /* push bx */
            ii(0x17_eb1a, 1); push(ds);                                 /* push ds */
            ii(0x17_eb1b, 3); lds(bx, memw[ss, bp + 0x8]);              /* lds bx, [bp+0x8] */
        }
    }
}
