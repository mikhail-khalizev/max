...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("903b105e-e226-4225-aad7-b46cf142f738")]
        public void Method_100a_9f78()
        {
            ii(0x100a_9f78, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x100a_9f7d, 5); calld(Definitions.sys_check_available_stack_size, 0xbbdd0); /* call 0x10165d52 */
            ...
            ii(0x100a_9fae, 1); retd(); return;                         /* ret */
        }
    }
}
