...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_af46()
        {
            ...
            ii(0x17_af7a, 3); mov(memw[ss, bp - 18], ax);               /* mov [bp-0x12], ax */
            ii(0x17_af7d, 3); mov(memw[ss, bp - 16], dx);               /* mov [bp-0x10], dx */
            ...
            ii(0x17_af8c, 3); mov(memw[ss, bp - 18], ax);               /* mov [bp-0x12], ax */
            ii(0x17_af8f, 3); mov(memw[ss, bp - 16], dx);               /* mov [bp-0x10], dx */
        l_0x17_af92:
            ii(0x17_af92, 4); mov(ax, memw[es, bx + 20]);               /* mov ax, [es:bx+0x14] */
            ii(0x17_af96, 2); sub(cx, cx);                              /* sub cx, cx */
            ii(0x17_af98, 4); add(cx, memw[es, bx + 28]);               /* add cx, [es:bx+0x1c] */
        ...
        l_0x17_afac:
            ii(0x17_afac, 3); add(cx, memw[ss, bp - 18]);               /* add cx, [bp-0x12] */
        ...
        l_0x17_afc2:
            ...
            ii(0x17_afe8, 3); mov(memw[ss, bp - 10], ax);               /* mov [bp-0xa], ax */
            ii(0x17_afeb, 3); mov(memw[ss, bp - 12], ax);               /* mov [bp-0xc], ax */
            ii(0x17_afee, 2); jmp(0x17_b000, 0x10); goto l_0x17_b000;   /* jmp 0xb000 */
        l_0x17_aff0:
            ii(0x17_aff0, 4); add(memw[ss, bp - 12], 1);                /* add word [bp-0xc], 0x1 */
            ii(0x17_aff4, 4); adc(memw[ss, bp - 10], 0);                /* adc word [bp-0xa], 0x0 */
            ii(0x17_aff8, 4); add(memw[ss, bp - 8], 1);                 /* add word [bp-0x8], 0x1 */
            ii(0x17_affc, 4); adc(memw[ss, bp - 6], 0);                 /* adc word [bp-0x6], 0x0 */
        l_0x17_b000:
            ii(0x17_b000, 3); mov(ax, memw[ss, bp - 12]);               /* mov ax, [bp-0xc] */
            ii(0x17_b003, 3); mov(dx, memw[ss, bp - 10]);               /* mov dx, [bp-0xa] */
            ii(0x17_b006, 3); cmp(memw[ss, bp - 16], dx);               /* cmp [bp-0x10], dx */
            ...
            ii(0x17_b00d, 3); cmp(memw[ss, bp - 18], ax);               /* cmp [bp-0x12], ax */
        ...
        l_0x17_b012:
            ...
            ii(0x17_b020, 3); mov(memw[ss, bp - 14], ax);               /* mov [bp-0xe], ax */
        ...
        l_0x17_b034:
            ...
            ii(0x17_b037, 5); and(memb[es, bx + 44], -2 /* 0xfe */);    /* and byte [es:bx+0x2c], 0xfe */
