...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_af46()
        {
            ...
            ii(0x17_af50, 3); les(bx, memw[ss, bp + 0x6]);              /* les bx, [bp+0x6] */
            ii(0x17_af53, 4); mov(dx, memw[es, bx + 0x8]);              /* mov dx, [es:bx+0x8] */
            ii(0x17_af57, 2); sub(ax, ax);                              /* sub ax, ax */
            ii(0x17_af59, 4); mov(cx, memw[es, bx + 0x4]);              /* mov cx, [es:bx+0x4] */
        ...
        l_0x17_af92:
            ...
            ii(0x17_af9f, 3); mov(memw[ss, bp - 0x4], cx);              /* mov [bp-0x4], cx */
            ii(0x17_afa2, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
        ...
        l_0x17_afac:
            ...
            ii(0x17_afb7, 2); if(ja(0x17_afbf, 0x6)) goto l_0x17_afbf;  /* ja 0xafbf */
            ii(0x17_afb9, 4); cmp(cx, memw[ds, 0x4fd8]);                /* cmp cx, [0x4fd8] */
            ii(0x17_afbd, 2); if(jbe(0x17_afc2, 0x3)) goto l_0x17_afc2; /* jbe 0xafc2 */
        l_0x17_afbf:
            ii(0x17_afbf, 1); pop(ds);                                  /* pop ds */
            ii(0x17_afc0, 1); leave();                                  /* leave */
            ii(0x17_afc1, 1); retf(); return;                           /* retf */
        l_0x17_afc2:
            ii(0x17_afc2, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0x17_afc5, 3); mov(dx, memw[ss, bp - 0x2]);              /* mov dx, [bp-0x2] */
            ...
            ii(0x17_afe0, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x17_afe3, 3); mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
        ...
        l_0x17_aff0:
            ii(0x17_aff0, 4); add(memw[ss, bp - 0xc], 0x1);             /* add word [bp-0xc], 0x1 */
            ii(0x17_aff4, 4); adc(memw[ss, bp - 0xa], 0);               /* adc word [bp-0xa], 0x0 */
            ii(0x17_aff8, 4); add(memw[ss, bp - 0x8], 0x1);             /* add word [bp-0x8], 0x1 */
            ii(0x17_affc, 4); adc(memw[ss, bp - 0x6], 0);               /* adc word [bp-0x6], 0x0 */
        l_0x17_b000:
            ...
            ii(0x17_b00b, 2); if(ja(0x17_b012, 0x5)) goto l_0x17_b012;  /* ja 0xb012 */
            ii(0x17_b00d, 3); cmp(memw[ss, bp - 0x12], ax);             /* cmp [bp-0x12], ax */
            ii(0x17_b010, 2); if(jbe(0x17_b034, 0x22)) goto l_0x17_b034; /* jbe 0xb034 */
        l_0x17_b012:
            ii(0x17_b012, 3); push(memw[ss, bp - 0x6]);                 /* push word [bp-0x6] */
            ii(0x17_b015, 3); push(memw[ss, bp - 0x8]);                 /* push word [bp-0x8] */
            ...
            ii(0x17_b026, 2); if(jz(0x17_b031, 0x9)) goto l_0x17_b031;  /* jz 0xb031 */
        ...
        l_0x17_b034:
            ii(0x17_b034, 3); les(bx, memw[ss, bp + 0x6]);              /* les bx, [bp+0x6] */
            ii(0x17_b037, 5); and(memb[es, bx + 0x2c], -0x2 /* 0xfe */); /* and byte [es:bx+0x2c], 0xfe */
