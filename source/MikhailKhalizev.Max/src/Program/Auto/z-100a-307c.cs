...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_307c()
        {
            ...
            ii(0x100a_3092, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100a_3095, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100a_3098, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
