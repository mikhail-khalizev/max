...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_effa()
        {
            ...
            ii(0x17_f00f, 3); mov(ax, memw[ss, bp + 0x8]);              /* mov ax, [bp+0x8] */
            ii(0x17_f012, 3); mov(memw[ss, bp - 0x10], ax);             /* mov [bp-0x10], ax */
            ii(0x17_f015, 3); push(memw[ss, bp + 0xa]);                 /* push word [bp+0xa] */
            ii(0x17_f018, 2); push(0);                                  /* push 0x0 */
            ii(0x17_f01a, 3); lea(ax, memw[ss, bp - 0x14]);             /* lea ax, [bp-0x14] */
            ii(0x17_f01d, 1); push(ss);                                 /* push ss */
            ii(0x17_f01e, 1); push(ax);                                 /* push ax */
            ii(0x17_f01f, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
        ...
        l_0x17_f02e:
            ...
            ii(0x17_f031, 3); mov(memw[ss, bp - 0x1a], ax);             /* mov [bp-0x1a], ax */
            ii(0x17_f034, 5); mov(memw[ss, bp - 0x1c], 0);              /* mov word [bp-0x1c], 0x0 */
            ii(0x17_f039, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_f03c, 2); and(al, 0xf8);                            /* and al, 0xf8 */
            ii(0x17_f03e, 3); add(ax, memw[ss, bp - 0x1c]);             /* add ax, [bp-0x1c] */
            ii(0x17_f041, 3); mov(dx, memw[ss, bp - 0x1a]);             /* mov dx, [bp-0x1a] */
            ii(0x17_f044, 3); mov(memw[ss, bp - 0x18], ax);             /* mov [bp-0x18], ax */
            ii(0x17_f047, 3); mov(memw[ss, bp - 0x16], dx);             /* mov [bp-0x16], dx */
            ii(0x17_f04a, 3); les(bx, memw[ss, bp + 0x8]);              /* les bx, [bp+0x8] */
            ...
            ii(0x17_f059, 3); les(bx, memw[ss, bp - 0x18]);             /* les bx, [bp-0x18] */
            ii(0x17_f05c, 5); cmp(memb[es, bx + 0x5], 0x1);             /* cmp byte [es:bx+0x5], 0x1 */
            ii(0x17_f061, 2); sbb(ax, ax);                              /* sbb ax, ax */
            ii(0x17_f063, 1); inc(ax);                                  /* inc ax */
        l_0x17_f064:
            ii(0x17_f064, 3); mov(memw[ss, bp + 0x6], ax);              /* mov [bp+0x6], ax */
