...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_3bc5()
        {
            ...
            ii(0x1013_3be7, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x1013_3c03, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1013_3c06, 5);  call(Definitions.sys_strncpy, 0x3_e2d5);/* call 0x10171ee0 */
            ii(0x1013_3c0b, 7);  mov(memd[ss, ebp - 20], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x1013_3c12, 2);  jmp(0x1013_3c1a, 6); goto l_0x1013_3c1a;/* jmp 0x10133c1a */
        l_0x1013_3c14:
            ii(0x1013_3c14, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1013_3c17, 3);  inc(memd[ss, ebp - 20]);              /* inc dword [ebp-0x14] */
        l_0x1013_3c1a:
            ii(0x1013_3c1a, 4);  movsx(eax, memw[ss, ebp - 20]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1013_3c1e, 5);  cmp(eax, 0x787);                      /* cmp eax, 0x787 */
            ii(0x1013_3c23, 2);  if(jge(0x1013_3c48, 0x23)) goto l_0x1013_3c48;/* jge 0x10133c48 */
            ii(0x1013_3c25, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ii(0x1013_3c29, 3);  shl(edx, 2);                          /* shl edx, 0x2 */
            ii(0x1013_3c2c, 6);  mov(edx, memd[ds, edx + 0x101b_b520]);/* mov edx, [edx+0x101bb520] */
            ii(0x1013_3c32, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x1013_3c3e, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1013_3c41, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
        ...
        l_0x1013_3c48:
            ii(0x1013_3c48, 7);  mov(memd[ss, ebp - 24], 0xffff_ffff); /* mov dword [ebp-0x18], 0xffffffff */
        l_0x1013_3c4f:
            ii(0x1013_3c4f, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
