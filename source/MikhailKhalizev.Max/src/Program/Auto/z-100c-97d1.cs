...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_97d1()
        {
            ...
            ii(0x100c_97e9, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_97ec, 4); mov(memb[ss, ebp - 0x8], 0x2e);         /* mov byte [ebp-0x8], 0x2e */
            ii(0x100c_97f0, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
