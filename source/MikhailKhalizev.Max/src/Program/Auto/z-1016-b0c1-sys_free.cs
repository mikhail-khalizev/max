...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ sys_free()
        {
            ...
            ii(0x1016_b0d8, 2); if(jz(0x1016_b0e3, 0x9)) goto l_0x1016_b0e3; /* jz 0x1016b0e3 */
            ii(0x1016_b0da, 2); cmp(ecx, eax);                          /* cmp ecx, eax */
            ii(0x1016_b0dc, 2); if(ja(0x1016_b0e3, 0x5)) goto l_0x1016_b0e3; /* ja 0x1016b0e3 */
            ii(0x1016_b0de, 3); cmp(eax, memd[ds, ecx + 0x8]);          /* cmp eax, [ecx+0x8] */
        ...
        l_0x1016_b0eb:
            ...
            ii(0x1016_b0ed, 2); if(ja(0x1016_b0f3, 0x4)) goto l_0x1016_b0f3; /* ja 0x1016b0f3 */
            ii(0x1016_b0ef, 2); cmp(esi, ebx);                          /* cmp esi, ebx */
            ii(0x1016_b0f1, 2); if(jb(0x1016_b0fd, 0xa)) goto l_0x1016_b0fd; /* jb 0x1016b0fd */
        l_0x1016_b0f3:
            ii(0x1016_b0f3, 3); mov(ecx, memd[ds, ecx + 0x8]);          /* mov ecx, [ecx+0x8] */
        l_0x1016_b0f6:
            ii(0x1016_b0f6, 3); mov(ebx, memd[ds, ecx + 0x8]);          /* mov ebx, [ecx+0x8] */
        ...
        l_0x1016_b0fd:
            ...
            ii(0x1016_b128, 3); mov(edx, memd[ds, ecx + 0x14]);         /* mov edx, [ecx+0x14] */
            ii(0x1016_b12b, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x1016_b12d, 2); if(jbe(0x1016_b135, 0x6)) goto l_0x1016_b135; /* jbe 0x1016b135 */
