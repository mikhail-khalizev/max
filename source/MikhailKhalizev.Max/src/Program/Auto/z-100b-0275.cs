...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_0275()
        {
            ...
            ii(0x100b_0287, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100b_028d, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100b_0290, 4); mov(memb[ss, ebp - 8], 0xe);            /* mov byte [ebp-0x8], 0xe */
            ii(0x100b_0294, 3); mov(al, memb[ss, ebp - 8]);             /* mov al, [ebp-0x8] */
