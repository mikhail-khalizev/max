...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1019_c649()
        {
            ...
            ii(0x1019_c64f, 3); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1019_c652, 3); lea(eax, memd[ss, ebp - 20]);           /* lea eax, [ebp-0x14] */
            ii(0x1019_c655, 1); push(eax);                              /* push eax */
            ii(0x1019_c656, 3); mov(edx, memd[ss, ebp + 12]);           /* mov edx, [ebp+0xc] */
            ii(0x1019_c659, 1); push(edx);                              /* push edx */
            ii(0x1019_c65a, 3); mov(ebx, memd[ss, ebp + 8]);            /* mov ebx, [ebp+0x8] */
            ...
            ii(0x1019_c66c, 3); fld(memq[ss, ebp - 20]);                /* fld qword [ebp-0x14] */
            ii(0x1019_c66f, 6); fadd(memq[ds, 0x101b_3850]);            /* fadd qword [0x101b3850] */
            ii(0x1019_c675, 3); fstp(memq[ss, ebp - 20]);               /* fstp qword [ebp-0x14] */
        l_0x1019_c678:
            ii(0x1019_c678, 3); fld(memq[ss, ebp - 20]);                /* fld qword [ebp-0x14] */
            ii(0x1019_c67b, 3); lea(esp, memd[ss, ebp - 12]);           /* lea esp, [ebp-0xc] */
            ...
            ii(0x1019_c682, 3); ret(8);                                 /* ret 0x8 */
        }
    }
}
