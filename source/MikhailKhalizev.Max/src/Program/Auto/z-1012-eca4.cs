...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_eca4()
        {
            ...
            ii(0x1012_ecbc, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x1012_ecd7, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1012_ecda, 5); call(0x1013_1b6c, 0x2e8d);              /* call 0x10131b6c */
            ii(0x1012_ecdf, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ...
            ii(0x1012_ecfd, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1012_ed00, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1012_ed15, 2); jmp(0x1012_ed1f, 0x8); goto l_0x1012_ed1f; /* jmp 0x1012ed1f */
        l_0x1012_ed17:
            ii(0x1012_ed17, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1012_ed1a, 5); call(0x1007_6bf8, -0xb_8127);           /* call 0x10076bf8 */
        l_0x1012_ed1f:
            ii(0x1012_ed1f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1012_ed21, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x1012_ed31, 3); lea(ecx, memd[ss, ebp - 0x10]);         /* lea ecx, [ebp-0x10] */
            ii(0x1012_ed34, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_ed37, 6); mov(eax, memd[ds, eax + 0xde]);         /* mov eax, [eax+0xde] */
            ...
            ii(0x1012_ed4d, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x1012_ed5f, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1012_ed62, 4); cmp(memd[ss, ebp - 0x1c], 0);           /* cmp dword [ebp-0x1c], 0x0 */
            ii(0x1012_ed66, 6); if(jz(0x1012_efab, 0x23f)) goto l_0x1012_efab; /* jz 0x1012efab */
            ii(0x1012_ed6c, 4); cmp(memb[ss, ebp - 0x8], 0);            /* cmp byte [ebp-0x8], 0x0 */
            ...
            ii(0x1012_ed78, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1012_ed7b, 5); mov(eax, 0xe);                          /* mov eax, 0xe */
            ii(0x1012_ed80, 5); call(Definitions.sys_new, 0x3_707b);    /* call 0x10165e00 */
            ii(0x1012_ed85, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x1012_ed88, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x1012_ed8b, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ii(0x1012_ed8e, 4); cmp(memd[ss, ebp - 0x28], 0);           /* cmp dword [ebp-0x28], 0x0 */
            ...
            ii(0x1012_ed99, 3); lea(eax, memd[ss, ebp - 0x2c]);         /* lea eax, [ebp-0x2c] */
            ...
            ii(0x1012_eda3, 3); mov(ecx, memd[ss, ebp - 0x24]);         /* mov ecx, [ebp-0x24] */
            ...
            ii(0x1012_edaf, 3); mov(memd[ss, ebp - 0x30], eax);         /* mov [ebp-0x30], eax */
            ii(0x1012_edb2, 3); mov(eax, memd[ss, ebp - 0x30]);         /* mov eax, [ebp-0x30] */
            ii(0x1012_edb5, 3); mov(memd[ss, ebp - 0x34], eax);         /* mov [ebp-0x34], eax */
            ii(0x1012_edb8, 2); jmp(0x1012_edc0, 0x6); goto l_0x1012_edc0; /* jmp 0x1012edc0 */
        l_0x1012_edba:
            ii(0x1012_edba, 3); mov(eax, memd[ss, ebp - 0x28]);         /* mov eax, [ebp-0x28] */
            ii(0x1012_edbd, 3); mov(memd[ss, ebp - 0x34], eax);         /* mov [ebp-0x34], eax */
        l_0x1012_edc0:
            ii(0x1012_edc0, 3); mov(edx, memd[ss, ebp - 0x34]);         /* mov edx, [ebp-0x34] */
            ii(0x1012_edc3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_edc6, 3); add(eax, 0x26);                         /* add eax, 0x26 */
            ii(0x1012_edc9, 3); mov(ebx, memd[ss, ebp - 0x20]);         /* mov ebx, [ebp-0x20] */
            ii(0x1012_edcc, 5); call(0x1013_18c0, 0x2aef);              /* call 0x101318c0 */
            ii(0x1012_edd1, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1012_edd3, 3); lea(eax, memd[ss, ebp - 0x2c]);         /* lea eax, [ebp-0x2c] */
            ii(0x1012_edd6, 5); call(Definitions.my_string_dtor, 0x1_2d4f); /* call 0x10141b2a */
        l_0x1012_eddb:
            ii(0x1012_eddb, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x1012_eddf, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1012_ede6, 2); jmp(0x1012_edee, 0x6); goto l_0x1012_edee; /* jmp 0x1012edee */
        l_0x1012_ede8:
            ii(0x1012_ede8, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_edeb, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x1012_edee:
            ii(0x1012_edee, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1012_edf2, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x1012_ee03, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x1012_ee11, 3); mov(memd[ss, ebp - 0x38], eax);         /* mov [ebp-0x38], eax */
            ii(0x1012_ee14, 5); mov(eax, 0xe);                          /* mov eax, 0xe */
            ii(0x1012_ee19, 5); call(Definitions.sys_new, 0x3_6fe2);    /* call 0x10165e00 */
            ii(0x1012_ee1e, 3); mov(memd[ss, ebp - 0x3c], eax);         /* mov [ebp-0x3c], eax */
            ii(0x1012_ee21, 3); mov(eax, memd[ss, ebp - 0x3c]);         /* mov eax, [ebp-0x3c] */
            ii(0x1012_ee24, 3); mov(memd[ss, ebp - 0x40], eax);         /* mov [ebp-0x40], eax */
            ii(0x1012_ee27, 4); cmp(memd[ss, ebp - 0x40], 0);           /* cmp dword [ebp-0x40], 0x0 */
            ...
            ii(0x1012_ee32, 3); lea(eax, memd[ss, ebp - 0x44]);         /* lea eax, [ebp-0x44] */
            ...
            ii(0x1012_ee3c, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1012_ee3f, 5); call(0x1013_1b38, 0x2cf4);              /* call 0x10131b38 */
            ii(0x1012_ee44, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1012_ee46, 3); mov(eax, memd[ss, ebp - 0x3c]);         /* mov eax, [ebp-0x3c] */
            ii(0x1012_ee49, 5); call(0x1013_1716, 0x28c8);              /* call 0x10131716 */
            ii(0x1012_ee4e, 3); mov(memd[ss, ebp - 0x48], eax);         /* mov [ebp-0x48], eax */
            ii(0x1012_ee51, 3); mov(eax, memd[ss, ebp - 0x48]);         /* mov eax, [ebp-0x48] */
            ii(0x1012_ee54, 3); mov(memd[ss, ebp - 0x4c], eax);         /* mov [ebp-0x4c], eax */
            ii(0x1012_ee57, 2); jmp(0x1012_ee5f, 0x6); goto l_0x1012_ee5f; /* jmp 0x1012ee5f */
        l_0x1012_ee59:
            ii(0x1012_ee59, 3); mov(eax, memd[ss, ebp - 0x40]);         /* mov eax, [ebp-0x40] */
            ii(0x1012_ee5c, 3); mov(memd[ss, ebp - 0x4c], eax);         /* mov [ebp-0x4c], eax */
        l_0x1012_ee5f:
            ii(0x1012_ee5f, 3); mov(edx, memd[ss, ebp - 0x4c]);         /* mov edx, [ebp-0x4c] */
            ii(0x1012_ee62, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_ee65, 3); add(eax, 0x26);                         /* add eax, 0x26 */
            ii(0x1012_ee68, 3); mov(ebx, memd[ss, ebp - 0x38]);         /* mov ebx, [ebp-0x38] */
            ii(0x1012_ee6b, 5); call(0x1013_18c0, 0x2a50);              /* call 0x101318c0 */
            ii(0x1012_ee70, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1012_ee72, 3); lea(eax, memd[ss, ebp - 0x44]);         /* lea eax, [ebp-0x44] */
        ...
        l_0x1012_ee7f:
            ii(0x1012_ee7f, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x1012_ee86, 2); jmp(0x1012_ee8e, 0x6); goto l_0x1012_ee8e; /* jmp 0x1012ee8e */
        l_0x1012_ee88:
            ii(0x1012_ee88, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_ee8b, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x1012_ee8e:
            ii(0x1012_ee8e, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_ee91, 4); cmp(ax, memw[ss, ebp - 0x10]);          /* cmp ax, [ebp-0x10] */
            ...
            ii(0x1012_ee9d, 3); mov(memd[ss, ebp - 0x50], eax);         /* mov [ebp-0x50], eax */
            ii(0x1012_eea0, 5); mov(eax, 0xe);                          /* mov eax, 0xe */
            ii(0x1012_eea5, 5); call(Definitions.sys_new, 0x3_6f56);    /* call 0x10165e00 */
            ii(0x1012_eeaa, 3); mov(memd[ss, ebp - 0x54], eax);         /* mov [ebp-0x54], eax */
            ii(0x1012_eead, 3); mov(eax, memd[ss, ebp - 0x54]);         /* mov eax, [ebp-0x54] */
            ii(0x1012_eeb0, 3); mov(memd[ss, ebp - 0x58], eax);         /* mov [ebp-0x58], eax */
            ii(0x1012_eeb3, 4); cmp(memd[ss, ebp - 0x58], 0);           /* cmp dword [ebp-0x58], 0x0 */
            ii(0x1012_eeb7, 2); if(jz(0x1012_eee2, 0x29)) goto l_0x1012_eee2; /* jz 0x1012eee2 */
            ii(0x1012_eeb9, 4); movsx(ebx, memw[ss, ebp - 0xc]);        /* movsx ebx, word [ebp-0xc] */
            ii(0x1012_eebd, 3); shl(ebx, 0x2);                          /* shl ebx, 0x2 */
            ii(0x1012_eec0, 3); add(ebx, memd[ss, ebp - 0x1c]);         /* add ebx, [ebp-0x1c] */
            ii(0x1012_eec3, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1012_eec6, 5); call(0x1013_1b38, 0x2c6d);              /* call 0x10131b38 */
            ii(0x1012_eecb, 3); mov(ecx, memd[ss, ebp - 0x54]);         /* mov ecx, [ebp-0x54] */
            ...
            ii(0x1012_eed7, 3); mov(memd[ss, ebp - 0x5c], eax);         /* mov [ebp-0x5c], eax */
            ii(0x1012_eeda, 3); mov(eax, memd[ss, ebp - 0x5c]);         /* mov eax, [ebp-0x5c] */
            ii(0x1012_eedd, 3); mov(memd[ss, ebp - 0x60], eax);         /* mov [ebp-0x60], eax */
            ii(0x1012_eee0, 2); jmp(0x1012_eee8, 0x6); goto l_0x1012_eee8; /* jmp 0x1012eee8 */
        l_0x1012_eee2:
            ii(0x1012_eee2, 3); mov(eax, memd[ss, ebp - 0x58]);         /* mov eax, [ebp-0x58] */
            ii(0x1012_eee5, 3); mov(memd[ss, ebp - 0x60], eax);         /* mov [ebp-0x60], eax */
        l_0x1012_eee8:
            ii(0x1012_eee8, 3); mov(edx, memd[ss, ebp - 0x60]);         /* mov edx, [ebp-0x60] */
            ii(0x1012_eeeb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_eeee, 3); add(eax, 0x26);                         /* add eax, 0x26 */
            ii(0x1012_eef1, 3); mov(ebx, memd[ss, ebp - 0x50]);         /* mov ebx, [ebp-0x50] */
        ...
        l_0x1012_eefb:
            ii(0x1012_eefb, 4); movsx(edx, memw[ss, ebp - 0x14]);       /* movsx edx, word [ebp-0x14] */
            ii(0x1012_eeff, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x1012_ef0e, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x1012_ef12, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x1012_ef14, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1012_ef17, 2); jmp(0x1012_ef1f, 0x6); goto l_0x1012_ef1f; /* jmp 0x1012ef1f */
        l_0x1012_ef19:
            ii(0x1012_ef19, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_ef1c, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x1012_ef1f:
            ii(0x1012_ef1f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_ef22, 4); cmp(ax, memw[ss, ebp - 0x14]);          /* cmp ax, [ebp-0x14] */
            ...
            ii(0x1012_ef2e, 3); mov(memd[ss, ebp - 0x64], eax);         /* mov [ebp-0x64], eax */
            ii(0x1012_ef31, 5); mov(eax, 0xe);                          /* mov eax, 0xe */
            ii(0x1012_ef36, 5); call(Definitions.sys_new, 0x3_6ec5);    /* call 0x10165e00 */
            ii(0x1012_ef3b, 3); mov(memd[ss, ebp - 0x68], eax);         /* mov [ebp-0x68], eax */
            ii(0x1012_ef3e, 3); mov(eax, memd[ss, ebp - 0x68]);         /* mov eax, [ebp-0x68] */
            ii(0x1012_ef41, 3); mov(memd[ss, ebp - 0x6c], eax);         /* mov [ebp-0x6c], eax */
            ii(0x1012_ef44, 4); cmp(memd[ss, ebp - 0x6c], 0);           /* cmp dword [ebp-0x6c], 0x0 */
            ...
            ii(0x1012_ef4f, 3); lea(eax, memd[ss, ebp - 0x70]);         /* lea eax, [ebp-0x70] */
            ...
            ii(0x1012_ef59, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1012_ef5c, 5); call(0x1013_1b38, 0x2bd7);              /* call 0x10131b38 */
            ii(0x1012_ef61, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1012_ef63, 3); mov(eax, memd[ss, ebp - 0x68]);         /* mov eax, [ebp-0x68] */
            ii(0x1012_ef66, 5); call(0x1013_1716, 0x27ab);              /* call 0x10131716 */
            ii(0x1012_ef6b, 3); mov(memd[ss, ebp - 0x74], eax);         /* mov [ebp-0x74], eax */
            ii(0x1012_ef6e, 3); mov(eax, memd[ss, ebp - 0x74]);         /* mov eax, [ebp-0x74] */
            ii(0x1012_ef71, 3); mov(memd[ss, ebp - 0x78], eax);         /* mov [ebp-0x78], eax */
            ii(0x1012_ef74, 2); jmp(0x1012_ef7c, 0x6); goto l_0x1012_ef7c; /* jmp 0x1012ef7c */
        l_0x1012_ef76:
            ii(0x1012_ef76, 3); mov(eax, memd[ss, ebp - 0x6c]);         /* mov eax, [ebp-0x6c] */
            ii(0x1012_ef79, 3); mov(memd[ss, ebp - 0x78], eax);         /* mov [ebp-0x78], eax */
        l_0x1012_ef7c:
            ii(0x1012_ef7c, 3); mov(edx, memd[ss, ebp - 0x78]);         /* mov edx, [ebp-0x78] */
            ii(0x1012_ef7f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_ef82, 3); add(eax, 0x26);                         /* add eax, 0x26 */
            ii(0x1012_ef85, 3); mov(ebx, memd[ss, ebp - 0x64]);         /* mov ebx, [ebp-0x64] */
            ii(0x1012_ef88, 5); call(0x1013_18c0, 0x2933);              /* call 0x101318c0 */
            ii(0x1012_ef8d, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1012_ef8f, 3); lea(eax, memd[ss, ebp - 0x70]);         /* lea eax, [ebp-0x70] */
        ...
        l_0x1012_ef99:
            ...
            ii(0x1012_ef9e, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
        ...
        l_0x1012_efb0:
            ii(0x1012_efb0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1012_efbd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_efc0, 4); mov(bx, memw[ds, eax + 0x3e]);          /* mov bx, [eax+0x3e] */
            ii(0x1012_efc4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_efc7, 2); sub(edx, ebx);                          /* sub edx, ebx */
            ii(0x1012_efc9, 4); mov(memw[ds, eax + 0x34], dx);          /* mov [eax+0x34], dx */
            ii(0x1012_efcd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_efd0, 3); mov(eax, memd[ds, eax + 0x32]);         /* mov eax, [eax+0x32] */
            ii(0x1012_efd3, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1012_efd6, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1012_efd8, 2); if(jge(0x1012_efe3, 0x9)) goto l_0x1012_efe3; /* jge 0x1012efe3 */
            ii(0x1012_efda, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_efdd, 6); mov(memw[ds, eax + 0x34], 0);           /* mov word [eax+0x34], 0x0 */
        l_0x1012_efe3:
            ii(0x1012_efe3, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1012_efe5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1012_eff2, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
