...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_ad58()
        {
            ...
            ii(0x1008_ad70, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_ad73, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_ad76, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x1008_ad79, 5); call(0x1008_afb4, 0x236);               /* call 0x1008afb4 */
            ii(0x1008_ad7e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_ad81, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
