...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_bc54()
        {
            ...
            ii(0x100a_bc6b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_bc6e, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_bc71, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_bc73, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_bc87, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100a_bc91:
            ii(0x100a_bc91, 3); lea(edx, memd[ss, ebp - 0x10]);         /* lea edx, [ebp-0x10] */
            ii(0x100a_bc94, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_bca9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_bcac, 5); call(Definitions.sys_strcpy, 0xb_a21e); /* call 0x10165ecf */
            ii(0x100a_bcb1, 4); movsx(eax, memw[ss, ebp - 0xe]);        /* movsx eax, word [ebp-0xe] */
            ii(0x100a_bcb5, 1); inc(eax);                               /* inc eax */
            ii(0x100a_bcb6, 1); push(eax);                              /* push eax */
            ii(0x100a_bcb7, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x100a_bcc3, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ...
            ii(0x100a_bccf, 3); lea(edx, memd[ss, ebp - 0x24]);         /* lea edx, [ebp-0x24] */
            ii(0x100a_bcd2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_bcd5, 5); call(Definitions.sys_strcat, 0xb_a257); /* call 0x10165f31 */
        l_0x100a_bcda:
            ii(0x100a_bcda, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_bcdd, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100a_bce0, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
