...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_e3ad()
        {
            ...
            ii(0x1009_e3c4, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_e3c7, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1009_e3ca, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1009_e3cd, 3); add(edx, 0x13);                         /* add edx, 0x13 */
            ii(0x1009_e3d0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_e3d3, 5); call(0x1007_6d98, -0x2_7640);           /* call 0x10076d98 */
            ii(0x1009_e3d8, 2); test(al, al);                           /* test al, al */
            ii(0x1009_e3da, 2); if(jz(0x1009_e3e4, 0x8)) goto l_0x1009_e3e4; /* jz 0x1009e3e4 */
            ii(0x1009_e3dc, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
