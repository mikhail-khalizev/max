...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_7e98()
        {
            ...
            ii(0x17_7ea6, 3); mov(si, memw[ss, bp + 0x6]);              /* mov si, [bp+0x6] */
        ...
        l_0x17_7ec2:
            ii(0x17_7ec2, 5); sub(memw[ds, 0x1fb0], 0x1);               /* sub word [0x1fb0], 0x1 */
            ii(0x17_7ec7, 5); sbb(memw[ds, 0x1fb2], 0);                 /* sbb word [0x1fb2], 0x0 */
            ii(0x17_7ecc, 5); sub(memw[ds, 0x1fb8], 0x1);               /* sub word [0x1fb8], 0x1 */
