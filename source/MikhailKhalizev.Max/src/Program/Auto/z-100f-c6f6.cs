...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_c6f6()
        {
            ...
            ii(0x100f_c70b, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100f_c70e, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x100f_c711, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x100f_c714, 3); mov(memd[ss, ebp - 0x4], ecx);          /* mov [ebp-0x4], ecx */
            ii(0x100f_c717, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_c71a, 3); movsx(ebx, memw[ds, eax]);              /* movsx ebx, word [eax] */
            ii(0x100f_c71d, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x100f_c763, 3); mov(edx, memd[ss, ebp - 0x10]);         /* mov edx, [ebp-0x10] */
            ...
            ii(0x100f_c76d, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x100f_c770, 4); mov(memw[ds, edx + 0x2], ax);           /* mov [edx+0x2], ax */
            ii(0x100f_c774, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_c777, 4); mov(ax, memw[ds, eax + 0x2]);           /* mov ax, [eax+0x2] */
            ii(0x100f_c77b, 3); sub(eax, 0x4);                          /* sub eax, 0x4 */
            ii(0x100f_c77e, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100f_c781, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ii(0x100f_c785, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100f_c787, 2); if(jge(0x100f_c790, 0x7)) goto l_0x100f_c790; /* jge 0x100fc790 */
            ii(0x100f_c789, 7); mov(memd[ss, ebp - 0x14], 0);           /* mov dword [ebp-0x14], 0x0 */
        l_0x100f_c790:
            ii(0x100f_c790, 4); movsx(edx, memw[ss, ebp - 0x14]);       /* movsx edx, word [ebp-0x14] */
            ...
            ii(0x100f_c7a1, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x100f_c7ab, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100f_c7ae, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_c7b1, 3); mov(ax, memw[ds, eax]);                 /* mov ax, [eax] */
            ii(0x100f_c7b4, 3); sub(eax, 0x4);                          /* sub eax, 0x4 */
            ii(0x100f_c7b7, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x100f_c7ba, 4); movsx(eax, memw[ss, ebp - 0x18]);       /* movsx eax, word [ebp-0x18] */
            ii(0x100f_c7be, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100f_c7c0, 2); if(jge(0x100f_c7c9, 0x7)) goto l_0x100f_c7c9; /* jge 0x100fc7c9 */
            ii(0x100f_c7c2, 7); mov(memd[ss, ebp - 0x18], 0);           /* mov dword [ebp-0x18], 0x0 */
        l_0x100f_c7c9:
            ii(0x100f_c7c9, 4); movsx(edx, memw[ss, ebp - 0x18]);       /* movsx edx, word [ebp-0x18] */
            ...
            ii(0x100f_c7da, 3); mov(edx, memd[ss, ebp - 0x10]);         /* mov edx, [ebp-0x10] */
            ii(0x100f_c7dd, 3); movsx(eax, memw[ds, edx]);              /* movsx eax, word [edx] */
            ii(0x100f_c7e0, 2); add(eax, ebx);                          /* add eax, ebx */
            ii(0x100f_c7e2, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x100f_c7e5, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_c7e8, 4); mov(ax, memw[ds, eax + 0x2]);           /* mov ax, [eax+0x2] */
            ii(0x100f_c7ec, 5); add(eax, 0x5);                          /* add eax, 0x5 */
            ii(0x100f_c7f1, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100f_c7f4, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x100f_c7f7, 7); cmp(ax, memw[ds, 0x101c_8174]);         /* cmp ax, [0x101c8174] */
            ii(0x100f_c7fe, 2); if(jle(0x100f_c809, 0x9)) goto l_0x100f_c809; /* jle 0x100fc809 */
            ii(0x100f_c800, 6); mov(ax, memw[ds, 0x101c_8174]);         /* mov ax, [0x101c8174] */
            ii(0x100f_c806, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
        l_0x100f_c809:
            ii(0x100f_c809, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_c80c, 3); mov(ax, memw[ds, eax]);                 /* mov ax, [eax] */
            ii(0x100f_c80f, 5); add(eax, 0x5);                          /* add eax, 0x5 */
            ii(0x100f_c814, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x100f_c817, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x100f_c81a, 7); cmp(ax, memw[ds, 0x101c_8172]);         /* cmp ax, [0x101c8172] */
            ii(0x100f_c821, 2); if(jle(0x100f_c82c, 0x9)) goto l_0x100f_c82c; /* jle 0x100fc82c */
            ii(0x100f_c823, 6); mov(ax, memw[ds, 0x101c_8172]);         /* mov ax, [0x101c8172] */
            ii(0x100f_c829, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
        l_0x100f_c82c:
            ii(0x100f_c82c, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100f_c83f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100f_c859, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x100f_c85c, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100f_c866, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100f_c872, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_c875, 3); add(eax, memd[ss, ebp - 0x24]);         /* add eax, [ebp-0x24] */
            ii(0x100f_c878, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x100f_c87b, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
            ii(0x100f_c87f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_c882, 4); mov(ax, memw[ds, eax + 0x2]);           /* mov ax, [eax+0x2] */
            ii(0x100f_c886, 1); dec(eax);                               /* dec eax */
            ii(0x100f_c887, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x100f_c88a, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100f_c897, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x100f_c89a:
            ii(0x100f_c89a, 5); mov(eax, memd[ds, 0x101c_8172]);        /* mov eax, [0x101c8172] */
            ii(0x100f_c89f, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100f_c8a2, 4); movsx(edx, memw[ss, ebp - 0x28]);       /* movsx edx, word [ebp-0x28] */
            ...
            ii(0x100f_c8ab, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_c8ae, 3); add(eax, memd[ss, ebp - 0x24]);         /* add eax, [ebp-0x24] */
            ii(0x100f_c8b1, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x100f_c8b4, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
            ii(0x100f_c8b8, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_c8bb, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x100f_c8bd, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100f_c8c0, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100f_c8cd, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x100f_c8d0:
            ii(0x100f_c8d0, 6); mov(edx, memd[ds, 0x101c_8170]);        /* mov edx, [0x101c8170] */
            ii(0x100f_c8d6, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100f_c8d9, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100f_c8e4, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100f_c8f0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_c8f3, 3); add(eax, memd[ss, ebp - 0x24]);         /* add eax, [ebp-0x24] */
            ii(0x100f_c8f6, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x100f_c8f9, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
            ii(0x100f_c8fd, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_c900, 4); mov(ax, memw[ds, eax + 0x2]);           /* mov ax, [eax+0x2] */
            ii(0x100f_c904, 1); dec(eax);                               /* dec eax */
            ii(0x100f_c905, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x100f_c908, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_c90b, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x100f_c90e, 5); call(0x100f_c68c, -0x287);              /* call 0x100fc68c */
            ii(0x100f_c913, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x100f_c916:
            ii(0x100f_c916, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x100f_c92b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_c92e, 3); add(eax, memd[ss, ebp - 0x24]);         /* add eax, [ebp-0x24] */
            ii(0x100f_c931, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x100f_c934, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
            ii(0x100f_c938, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_c93b, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x100f_c93d, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100f_c940, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_c943, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x100f_c946, 5); call(0x100f_c68c, -0x2bf);              /* call 0x100fc68c */
            ii(0x100f_c94b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x100f_c94e:
            ii(0x100f_c94e, 4); imul(eax, memd[ss, ebp - 0x8], 0x64);   /* imul eax, [ebp-0x8], 0x64 */
            ii(0x100f_c952, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100f_c955, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x100f_c958, 3); mov(memd[ss, ebp - 0x2c], eax);         /* mov [ebp-0x2c], eax */
            ii(0x100f_c95b, 2); jmp(0x100f_c961, 0x4); goto l_0x100f_c961; /* jmp 0x100fc961 */
        l_0x100f_c95d:
            ii(0x100f_c95d, 4); add(memd[ss, ebp - 0x2c], 0x2);         /* add dword [ebp-0x2c], 0x2 */
        l_0x100f_c961:
            ii(0x100f_c961, 3); mov(eax, memd[ss, ebp - 0x2c]);         /* mov eax, [ebp-0x2c] */
            ii(0x100f_c964, 4); cmp(ax, memw[ss, ebp - 0x20]);          /* cmp ax, [ebp-0x20] */
            ii(0x100f_c968, 6); if(jge(0x100f_ca49, 0xdb)) goto l_0x100f_ca49; /* jge 0x100fca49 */
            ii(0x100f_c96e, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x100f_c971, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ii(0x100f_c974, 2); jmp(0x100f_c97a, 0x4); goto l_0x100f_c97a; /* jmp 0x100fc97a */
        l_0x100f_c976:
            ii(0x100f_c976, 4); add(memd[ss, ebp - 0x28], 0x2);         /* add dword [ebp-0x28], 0x2 */
        l_0x100f_c97a:
            ii(0x100f_c97a, 3); mov(eax, memd[ss, ebp - 0x28]);         /* mov eax, [ebp-0x28] */
            ii(0x100f_c97d, 4); cmp(ax, memw[ss, ebp - 0x1c]);          /* cmp ax, [ebp-0x1c] */
            ii(0x100f_c981, 6); if(jge(0x100f_ca44, 0xbd)) goto l_0x100f_ca44; /* jge 0x100fca44 */
            ii(0x100f_c987, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_c98a, 4); mov(ax, memw[ds, eax + 0x2]);           /* mov ax, [eax+0x2] */
            ii(0x100f_c98e, 3); sub(eax, memd[ss, ebp - 0x28]);         /* sub eax, [ebp-0x28] */
            ii(0x100f_c991, 1); cwde();                                 /* cwde */
            ii(0x100f_c992, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x100f_c995, 3); mov(dx, memw[ds, edx]);                 /* mov dx, [edx] */
            ii(0x100f_c998, 3); sub(edx, memd[ss, ebp - 0x2c]);         /* sub edx, [ebp-0x2c] */
            ...
            ii(0x100f_c9ad, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100f_c9b0, 3); mov(ebx, memd[ds, eax + 0x10]);         /* mov ebx, [eax+0x10] */
            ...
            ii(0x100f_c9c0, 3); mov(memd[ss, ebp - 0x30], eax);         /* mov [ebp-0x30], eax */
            ii(0x100f_c9c3, 4); movsx(edx, memw[ss, ebp - 0x30]);       /* movsx edx, word [ebp-0x30] */
            ii(0x100f_c9c7, 4); movsx(eax, memw[ss, ebp - 0x30]);       /* movsx eax, word [ebp-0x30] */
            ii(0x100f_c9cb, 3); imul(edx, eax);                         /* imul edx, eax */
            ii(0x100f_c9ce, 2); mov(ebx, edx);                          /* mov ebx, edx */
            ii(0x100f_c9d0, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100f_c9d4, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x100f_c9d6, 3); sar(edx, 0x1f);                         /* sar edx, 0x1f */
            ii(0x100f_c9d9, 2); idiv(ebx);                              /* idiv ebx */
            ii(0x100f_c9db, 3); mov(memd[ss, ebp - 0x34], eax);         /* mov [ebp-0x34], eax */
            ii(0x100f_c9de, 4); movsx(edx, memw[ss, ebp - 0x28]);       /* movsx edx, word [ebp-0x28] */
            ...
            ii(0x100f_c9ed, 4); movsx(edx, memw[ss, ebp - 0x2c]);       /* movsx edx, word [ebp-0x2c] */
            ...
            ii(0x100f_ca0a, 4); movsx(edx, memw[ss, ebp - 0x34]);       /* movsx edx, word [ebp-0x34] */
            ii(0x100f_ca0e, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x100f_ca10, 2); if(jle(0x100f_ca3f, 0x2d)) goto l_0x100f_ca3f; /* jle 0x100fca3f */
            ii(0x100f_ca12, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100f_ca15, 4); mov(bx, memw[ds, eax + 0x4]);           /* mov bx, [eax+0x4] */
            ii(0x100f_ca19, 3); add(ebx, memd[ss, ebp - 0x34]);         /* add ebx, [ebp-0x34] */
            ii(0x100f_ca1c, 4); movsx(eax, memw[ss, ebp - 0x28]);       /* movsx eax, word [ebp-0x28] */
            ...
            ii(0x100f_ca2c, 4); movsx(edx, memw[ss, ebp - 0x2c]);       /* movsx edx, word [ebp-0x2c] */
