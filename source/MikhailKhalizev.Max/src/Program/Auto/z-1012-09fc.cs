...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_09fc()
        {
            ...
            ii(0x1012_0a14, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1012_0a17, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_0a1a, 3); mov(al, memb[ds, eax + 0x14]);          /* mov al, [eax+0x14] */
            ii(0x1012_0a1d, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x1012_0a20, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
