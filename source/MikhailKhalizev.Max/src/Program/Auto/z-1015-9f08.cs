...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_9f08()
        {
            ...
            ii(0x1015_9f1f, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_9f22, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1015_9f25, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_9f28, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1015_9f2b, 4); or(memb[ss, ebp - 0xc], 0x1);           /* or byte [ebp-0xc], 0x1 */
            ii(0x1015_9f2f, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1015_9f32, 5); call(Definitions.my_ctor_0x101b_38f8, -0xe_3847); /* call 0x100766f0 */
            ii(0x1015_9f37, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1015_9f3a, 4); and(memb[ss, ebp - 0xc], -0x2 /* 0xfe */); /* and byte [ebp-0xc], 0xfe */
            ii(0x1015_9f3e, 5); mov(eax, 0x1);                          /* mov eax, 0x1 */
            ii(0x1015_9f43, 5); call(0x100f_448c, -0x6_5abc);           /* call 0x100f448c */
            ii(0x1015_9f48, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1015_9f4b, 4); cmp(memb[ds, eax + 0x3d], 0xb);         /* cmp byte [eax+0x3d], 0xb */
            ii(0x1015_9f4f, 2); if(jnz(0x1015_9f70, 0x1f)) goto l_0x1015_9f70; /* jnz 0x10159f70 */
            ii(0x1015_9f51, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1015_9f54, 5); call(0x100f_3f62, -0x6_5ff7);           /* call 0x100f3f62 */
            ii(0x1015_9f59, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1015_9f5c, 5); call(0x100f_fa70, -0x5_a4f1);           /* call 0x100ffa70 */
            ii(0x1015_9f61, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_9f63, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x1015_9f70:
            ii(0x1015_9f70, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1015_9f73, 3); mov(ebx, memd[ds, eax + 0x1a]);         /* mov ebx, [eax+0x1a] */
            ii(0x1015_9f76, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1015_9f79, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1015_9f7c, 3); mov(edx, memd[ds, eax + 0x18]);         /* mov edx, [eax+0x18] */
            ii(0x1015_9f7f, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1015_9f82, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1015_9f85, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ...
            ii(0x1015_9f92, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1015_9f95, 5); call(0x1007_6630, -0xe_396a);           /* call 0x10076630 */
            ii(0x1015_9f9a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_9f9c, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x1015_9fd0:
            ii(0x1015_9fd0, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1015_9fd3, 5); call(0x1007_6600, -0xe_39d8);           /* call 0x10076600 */
            ii(0x1015_9fd8, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1015_9fda, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1015_9fdd, 5); call(0x1008_a998, -0xc_f64a);           /* call 0x1008a998 */
            ii(0x1015_9fe2, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1015_9fe5, 5); call(0x1007_6574, -0xe_3a76);           /* call 0x10076574 */
            ii(0x1015_9fea, 4); test(memb[ds, eax + 0x12], 0x10);       /* test byte [eax+0x12], 0x10 */
            ii(0x1015_9fee, 2); if(jz(0x1015_9ff9, 0x9)) goto l_0x1015_9ff9; /* jz 0x10159ff9 */
            ii(0x1015_9ff0, 7); mov(memd[ss, ebp - 0x1c], 0x4);         /* mov dword [ebp-0x1c], 0x4 */
            ii(0x1015_9ff7, 2); jmp(0x1015_a000, 0x7); goto l_0x1015_a000; /* jmp 0x1015a000 */
        l_0x1015_9ff9:
            ii(0x1015_9ff9, 7); mov(memd[ss, ebp - 0x1c], 0x1);         /* mov dword [ebp-0x1c], 0x1 */
        l_0x1015_a000:
            ii(0x1015_a000, 3); mov(al, memb[ss, ebp - 0x1c]);          /* mov al, [ebp-0x1c] */
            ii(0x1015_a003, 3); mov(edx, memd[ss, ebp - 0x18]);         /* mov edx, [ebp-0x18] */
            ii(0x1015_a006, 3); mov(memb[ds, edx + 0x45], al);          /* mov [edx+0x45], al */
            ii(0x1015_a009, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1015_a00b, 5); mov(edx, 0xb);                          /* mov edx, 0xb */
            ii(0x1015_a010, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1015_a013, 5); call(0x1016_3053, 0x903b);              /* call 0x10163053 */
            ii(0x1015_a018, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1015_a01b, 5); call(0x1010_094d, -0x5_96d3);           /* call 0x1010094d */
            ii(0x1015_a020, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1015_a023, 5); call(0x1010_19b8, -0x5_8670);           /* call 0x101019b8 */
            ii(0x1015_a028, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1015_a02b, 3); mov(al, memb[ds, eax + 0x45]);          /* mov al, [eax+0x45] */
            ...
            ii(0x1015_a03a, 6); lea(eax, memd[ss, ebp - 0x1ac]);        /* lea eax, [ebp-0x1ac] */
            ...
            ii(0x1015_a049, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1015_a04c, 3); mov(ebx, memd[ds, eax + 0x1a]);         /* mov ebx, [eax+0x1a] */
            ii(0x1015_a04f, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1015_a052, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1015_a055, 3); mov(edx, memd[ds, eax + 0x18]);         /* mov edx, [eax+0x18] */
            ii(0x1015_a058, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1015_a05b, 6); lea(eax, memd[ss, ebp - 0x1b0]);        /* lea eax, [ebp-0x1b0] */
            ii(0x1015_a061, 5); call(0x1007_6aac, -0xe_35ba);           /* call 0x10076aac */
            ii(0x1015_a066, 2); mov(ecx, memd[ds, eax]);                /* mov ecx, [eax] */
            ii(0x1015_a068, 3); mov(ebx, memd[ss, ebp - 0x18]);         /* mov ebx, [ebp-0x18] */
            ii(0x1015_a06b, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_a06d, 6); lea(eax, memd[ss, ebp - 0x1ac]);        /* lea eax, [ebp-0x1ac] */
            ii(0x1015_a073, 5); call(0x1011_5b60, -0x4_4518);           /* call 0x10115b60 */
        l_0x1015_a078:
            ii(0x1015_a078, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_a07a, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
