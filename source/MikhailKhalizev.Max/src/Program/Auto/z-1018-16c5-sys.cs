...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_16c5()
        {
            ...
            ii(0x1018_16c8, 3); sub(esp, 4);                            /* sub esp, 0x4 */
            ...
            ii(0x1018_16d8, 3); lea(ecx, memd[ds, eax + 1]);            /* lea ecx, [eax+0x1] */
            ii(0x1018_16db, 3); mov(memb[ds, eax], 0x2d);               /* mov byte [eax], 0x2d */
            ii(0x1018_16de, 3); mov(memd[ss, esp], edx);                /* mov [esp], edx */
        l_0x1018_16e1:
            ii(0x1018_16e1, 4); cmp(memd[ds, esi + 8], -1 /* 0xff */);  /* cmp dword [esi+0x8], 0xffffffff */
            ii(0x1018_16e5, 2); if(jnz(0x1018_16ee, 7)) goto l_0x1018_16ee; /* jnz 0x101816ee */
            ii(0x1018_16e7, 7); mov(memd[ds, esi + 8], 4);              /* mov dword [esi+0x8], 0x4 */
        l_0x1018_16ee:
            ii(0x1018_16ee, 5); mov(ebx, 0xa);                          /* mov ebx, 0xa */
            ii(0x1018_16f3, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1018_16f5, 2); mov(edx, ecx);                          /* mov edx, ecx */
            ii(0x1018_16f7, 5); mov(ax, memw[ss, esp + 2]);             /* mov ax, [esp+0x2] */
        ...
        l_0x1018_1703:
            ...
            ii(0x1018_1705, 3); lea(edx, memd[ds, ecx + 1]);            /* lea edx, [ecx+0x1] */
            ii(0x1018_1708, 2); test(ah, ah);                           /* test ah, ah */
            ii(0x1018_170a, 2); if(jz(0x1018_1710, 4)) goto l_0x1018_1710; /* jz 0x10181710 */
            ii(0x1018_170c, 2); mov(ecx, edx);                          /* mov ecx, edx */
            ii(0x1018_170e, 2); jmp(0x1018_1703, -0xd); goto l_0x1018_1703; /* jmp 0x10181703 */
        l_0x1018_1710:
            ii(0x1018_1710, 4); cmp(memd[ds, esi + 8], 0);              /* cmp dword [esi+0x8], 0x0 */
        ...
        l_0x1018_171f:
            ...
            ii(0x1018_1721, 5); mov(memw[ss, esp + 2], dx);             /* mov [esp+0x2], dx */
            ...
            ii(0x1018_172f, 4); mov(dl, memb[ss, esp + 2]);             /* mov dl, [esp+0x2] */
        ...
        l_0x1018_173a:
            ii(0x1018_173a, 3); cmp(eax, memd[ds, esi + 8]);            /* cmp eax, [esi+0x8] */
        ...
        l_0x1018_1755:
            ...
            ii(0x1018_1759, 3); lea(ecx, memd[ds, ebx + 1]);            /* lea ecx, [ebx+0x1] */
        ...
        l_0x1018_175f:
            ...
            ii(0x1018_1763, 3); lea(eax, memd[ds, ecx + 1]);            /* lea eax, [ecx+0x1] */
            ii(0x1018_1766, 3); cmp(edx, 0x30);                         /* cmp edx, 0x30 */
            ii(0x1018_1769, 2); if(jnz(0x1018_176f, 4)) goto l_0x1018_176f; /* jnz 0x1018176f */
        ...
        l_0x1018_176f:
            ...
            ii(0x1018_1777, 3); lea(ecx, memd[ds, eax + 1]);            /* lea ecx, [eax+0x1] */
        ...
        l_0x1018_177d:
            ...
            ii(0x1018_1784, 2); if(jnz(0x1018_1789, 3)) goto l_0x1018_1789; /* jnz 0x10181789 */
        ...
        l_0x1018_1792:
            ...
            ii(0x1018_179a, 2); if(jnz(0x1018_179d, 1)) goto l_0x1018_179d; /* jnz 0x1018179d */
        ...
        l_0x1018_179d:
            ...
            ii(0x1018_17a4, 2); if(jz(0x1018_17ae, 8)) goto l_0x1018_17ae; /* jz 0x101817ae */
            ii(0x1018_17a6, 2); mov(dl, al);                            /* mov dl, al */
            ii(0x1018_17a8, 2); inc(dl);                                /* inc dl */
            ii(0x1018_17aa, 2); mov(memb[ds, ecx], dl);                 /* mov [ecx], dl */
            ii(0x1018_17ac, 2); jmp(0x1018_17b3, 5); goto l_0x1018_17b3; /* jmp 0x101817b3 */
        l_0x1018_17ae:
        ...
        l_0x1018_17b3:
            ii(0x1018_17b3, 3); add(esp, 4);                            /* add esp, 0x4 */
