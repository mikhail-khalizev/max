...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_af58()
        {
            ...
            ii(0x18_af86, 3);  mov(memw[ss, bp + 18], ax);             /* mov [bp+0x12], ax */
            ii(0x18_af89, 3);  mov(ax, memw[ds, 0x10fc]);              /* mov ax, [0x10fc] */
            ii(0x18_af8c, 3);  mov(memw[ss, bp + 20], ax);             /* mov [bp+0x14], ax */
            ii(0x18_af8f, 3);  mov(al, memb[ds, 0x10fe]);              /* mov al, [0x10fe] */
            ii(0x18_af92, 3);  mov(memb[ss, bp + 22], al);             /* mov [bp+0x16], al */
        ...
        l_0x18_af9b:
            ...
            ii(0x18_af9e, 3);  mov(ax, memw[ds, bx + 18]);             /* mov ax, [bx+0x12] */
            ii(0x18_afa1, 3);  mov(memw[ds, 0x10fa], ax);              /* mov [0x10fa], ax */
            ii(0x18_afa4, 3);  mov(ax, memw[ds, bx + 20]);             /* mov ax, [bx+0x14] */
            ii(0x18_afa7, 3);  mov(memw[ds, 0x10fc], ax);              /* mov [0x10fc], ax */
            ii(0x18_afaa, 3);  mov(al, memb[ds, bx + 22]);             /* mov al, [bx+0x16] */
            ii(0x18_afad, 3);  mov(memb[ds, 0x10fe], al);              /* mov [0x10fe], al */
            ii(0x18_afb0, 3);  jmp_func(0x18_a81f, -0x794);            /* jmp 0xa81f */
        }
    }
}
