...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_9a00()
        {
            ...
            ii(0x1017_9a31, 5); mov(ax, memw[gs, eax + 48]);            /* mov ax, [gs:eax+0x30] */
            ii(0x1017_9a36, 4); mov(memw[ss, ebp - 20], ax);            /* mov [ebp-0x14], ax */
        ...
        l_0x1017_9a47:
            ii(0x1017_9a47, 6); lea(ebx, memd[ss, ebp - 152]);          /* lea ebx, [ebp-0x98] */
            ...
            ii(0x1017_9a5d, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ...
            ii(0x1017_9a76, 3); mov(memd[ss, ebp - 44], eax);           /* mov [ebp-0x2c], eax */
            ii(0x1017_9a79, 6); mov(eax, memd[ds, edx + 0x1020_b718]);  /* mov eax, [edx+0x1020b718] */
            ii(0x1017_9a7f, 4); mov(edx, memd[gs, eax + 76]);           /* mov edx, [gs:eax+0x4c] */
            ii(0x1017_9a83, 3); mov(memd[ss, ebp - 36], edx);           /* mov [ebp-0x24], edx */
            ii(0x1017_9a86, 3); mov(edx, memd[ss, ebp - 44]);           /* mov edx, [ebp-0x2c] */
            ii(0x1017_9a89, 5); movsx(eax, memw[gs, eax + 58]);         /* movsx eax, word [gs:eax+0x3a] */
            ii(0x1017_9a8e, 1); push(edx);                              /* push edx */
            ii(0x1017_9a8f, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
            ii(0x1017_9a92, 5); call(/* sys */ 0x1018_dd5b, 0x1_42c4);  /* call 0x1018dd5b */
            ii(0x1017_9a97, 3); add(esp, 4);                            /* add esp, 0x4 */
            ii(0x1017_9a9a, 3); mov(ebx, memd[ss, ebp - 44]);           /* mov ebx, [ebp-0x2c] */
            ii(0x1017_9a9d, 1); push(ebx);                              /* push ebx */
            ii(0x1017_9a9e, 3); mov(memd[ss, ebp - 40], eax);           /* mov [ebp-0x28], eax */
            ii(0x1017_9aa1, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x1017_9aa4, 5); call(/* sys */ 0x1018_dd5b, 0x1_42b2);  /* call 0x1018dd5b */
            ii(0x1017_9aa9, 3); mov(ecx, memd[ss, ebp - 40]);           /* mov ecx, [ebp-0x28] */
            ...
            ii(0x1017_9ab3, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
        l_0x1017_9ab6:
            ii(0x1017_9ab6, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x1017_9ab9, 3); mov(edx, memd[ss, ebp - 28]);           /* mov edx, [ebp-0x1c] */
            ii(0x1017_9abc, 3); mov(ebx, memd[ss, ebp - 32]);           /* mov ebx, [ebp-0x20] */
        ...
        l_0x1017_9acb:
            ii(0x1017_9acb, 3); mov(ecx, memd[ss, ebp - 24]);           /* mov ecx, [ebp-0x18] */
        ...
        l_0x1017_9ad1:
            ...
            ii(0x1017_9ad5, 4); test(memb[ss, ebp - 19], 4);            /* test byte [ebp-0x13], 0x4 */
        ...
        l_0x1017_9b2a:
            ...
            ii(0x1017_9b47, 6); cmp(memw[gs, edx + 54], 3);             /* cmp word [gs:edx+0x36], 0x3 */
            ii(0x1017_9b4d, 2); if(jz(0x1017_9b57, 8)) goto l_0x1017_9b57; /* jz 0x10179b57 */
            ii(0x1017_9b4f, 4); cmp(memd[ss, ebp - 112], 0);            /* cmp dword [ebp-0x70], 0x0 */
            ii(0x1017_9b53, 2); if(jz(0x1017_9b57, 2)) goto l_0x1017_9b57; /* jz 0x10179b57 */
            ii(0x1017_9b55, 2); shr(eax, 1);                            /* shr eax, 1 */
        l_0x1017_9b57:
            ii(0x1017_9b57, 3); mov(esi, memd[ss, ebp - 36]);           /* mov esi, [ebp-0x24] */
            ...
            ii(0x1017_9b60, 3); lea(esp, memd[ss, ebp - 16]);           /* lea esp, [ebp-0x10] */
        ...
        l_0x1017_9b6f:
            ii(0x1017_9b6f, 3); lea(esp, memd[ss, ebp - 16]);           /* lea esp, [ebp-0x10] */
