...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_9a00()
        {
            ...
            ii(0x1017_9a11, 7); lea(edx, memd[ds, eax * 4 + 0]);        /* lea edx, [eax*4] */
            ii(0x1017_9a18, 2); sub(edx, eax);                          /* sub edx, eax */
            ii(0x1017_9a1a, 7); lea(eax, memd[ds, edi * 4 + 0]);        /* lea eax, [edi*4] */
            ...
            ii(0x1017_9a3e, 2); if(jnz(0x1017_9a47, 0x7)) goto l_0x1017_9a47; /* jnz 0x10179a47 */
        ...
        l_0x1017_9a47:
            ...
            ii(0x1017_9ab1, 2); if(jbe(0x1017_9ab6, 0x3)) goto l_0x1017_9ab6; /* jbe 0x10179ab6 */
        ...
        l_0x1017_9ab6:
            ...
            ii(0x1017_9ac5, 2); if(ja(0x1017_9acb, 0x4)) goto l_0x1017_9acb; /* ja 0x10179acb */
            ii(0x1017_9ac7, 2); mov(edx, ebx);                          /* mov edx, ebx */
            ii(0x1017_9ac9, 2); jmp(0x1017_9ad1, 0x6); goto l_0x1017_9ad1; /* jmp 0x10179ad1 */
        l_0x1017_9acb:
        ...
        l_0x1017_9ad1:
            ...
            ii(0x1017_9ad5, 4); test(memb[ss, ebp - 0x13], 0x4);        /* test byte [ebp-0x13], 0x4 */
            ii(0x1017_9ad9, 2); if(jz(0x1017_9b00, 0x25)) goto l_0x1017_9b00; /* jz 0x10179b00 */
            ii(0x1017_9adb, 7); lea(ebx, memd[ds, esi * 4 + 0]);        /* lea ebx, [esi*4] */
            ii(0x1017_9ae2, 7); lea(edx, memd[ds, edi * 4 + 0]);        /* lea edx, [edi*4] */
        ...
        l_0x1017_9b00:
            ...
            ii(0x1017_9b04, 2); if(jz(0x1017_9b0e, 0x8)) goto l_0x1017_9b0e; /* jz 0x10179b0e */
            ii(0x1017_9b06, 4); cmp(memd[ss, ebp - 0x74], 0x8);         /* cmp dword [ebp-0x74], 0x8 */
            ii(0x1017_9b0a, 2); if(jnz(0x1017_9b0e, 0x2)) goto l_0x1017_9b0e; /* jnz 0x10179b0e */
            ii(0x1017_9b0c, 2); add(eax, eax);                          /* add eax, eax */
        l_0x1017_9b0e:
            ii(0x1017_9b0e, 4); test(memb[ss, ebp - 0x14], 0x20);       /* test byte [ebp-0x14], 0x20 */
            ii(0x1017_9b12, 2); if(jz(0x1017_9b1c, 0x8)) goto l_0x1017_9b1c; /* jz 0x10179b1c */
            ii(0x1017_9b14, 4); cmp(memd[ss, ebp - 0x74], 0x10);        /* cmp dword [ebp-0x74], 0x10 */
            ii(0x1017_9b18, 2); if(jnz(0x1017_9b1c, 0x2)) goto l_0x1017_9b1c; /* jnz 0x10179b1c */
            ii(0x1017_9b1a, 2); shr(eax, 0x1);                          /* shr eax, 1 */
        l_0x1017_9b1c:
            ii(0x1017_9b1c, 4); test(memb[ss, ebp - 0x14], 0x10);       /* test byte [ebp-0x14], 0x10 */
            ii(0x1017_9b20, 2); if(jz(0x1017_9b2a, 0x8)) goto l_0x1017_9b2a; /* jz 0x10179b2a */
            ii(0x1017_9b22, 4); cmp(memd[ss, ebp - 0x70], 0);           /* cmp dword [ebp-0x70], 0x0 */
            ii(0x1017_9b26, 2); if(jnz(0x1017_9b2a, 0x2)) goto l_0x1017_9b2a; /* jnz 0x10179b2a */
            ii(0x1017_9b28, 2); add(eax, eax);                          /* add eax, eax */
        l_0x1017_9b2a:
            ii(0x1017_9b2a, 7); lea(edx, memd[ds, esi * 4 + 0]);        /* lea edx, [esi*4] */
            ii(0x1017_9b31, 2); sub(edx, esi);                          /* sub edx, esi */
            ii(0x1017_9b33, 7); lea(esi, memd[ds, edi * 4 + 0]);        /* lea esi, [edi*4] */
            ...
            ii(0x1017_9b47, 6); cmp(memw[gs, edx + 0x36], 0x3);         /* cmp word [gs:edx+0x36], 0x3 */
            ii(0x1017_9b4d, 2); if(jz(0x1017_9b57, 0x8)) goto l_0x1017_9b57; /* jz 0x10179b57 */
            ii(0x1017_9b4f, 4); cmp(memd[ss, ebp - 0x70], 0);           /* cmp dword [ebp-0x70], 0x0 */
            ii(0x1017_9b53, 2); if(jz(0x1017_9b57, 0x2)) goto l_0x1017_9b57; /* jz 0x10179b57 */
