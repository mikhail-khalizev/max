...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_a2ab()
        {
            ...
            ii(0x1013_a2c2, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1013_a2c5, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1013_a2c8, 5); mov(eax, 0x12);                         /* mov eax, 0x12 */
            ii(0x1013_a2cd, 5); call(Definitions.sys_new, 0x2_bb2e);    /* call 0x10165e00 */
            ii(0x1013_a2d2, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1013_a2d5, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1013_a2d8, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1013_a2db, 4); cmp(memd[ss, ebp - 20], 0);             /* cmp dword [ebp-0x14], 0x0 */
            ii(0x1013_a2df, 2); if(jz(0x1013_a2f7, 0x16)) goto l_0x1013_a2f7; /* jz 0x1013a2f7 */
            ii(0x1013_a2e1, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1013_a2e4, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1013_a2e7, 5); call(0x1013_9eb4, -0x438);              /* call 0x10139eb4 */
            ii(0x1013_a2ec, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x1013_a2ef, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x1013_a2f2, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1013_a2f5, 2); jmp(0x1013_a2fd, 6); goto l_0x1013_a2fd; /* jmp 0x1013a2fd */
        l_0x1013_a2f7:
            ii(0x1013_a2f7, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x1013_a2fa, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
        l_0x1013_a2fd:
            ii(0x1013_a2fd, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x1013_a300, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ii(0x1013_a303, 5); call(0x1007_6d14, -0xc_35f4);           /* call 0x10076d14 */
            ii(0x1013_a308, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_a30b, 3); inc(memw[ds, eax]);                     /* inc word [eax] */
            ii(0x1013_a30e, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_a310, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_a313, 3); add(eax, 6);                            /* add eax, 0x6 */
            ...
            ii(0x1013_a31f, 3); lea(edx, memd[ss, ebp - 28]);           /* lea edx, [ebp-0x1c] */
            ii(0x1013_a322, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_a325, 3); add(eax, 2);                            /* add eax, 0x2 */
        ...
        l_0x1013_a32f:
            ii(0x1013_a32f, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ii(0x1013_a332, 5); call(0x1007_6c68, -0xc_36cf);           /* call 0x10076c68 */
            ii(0x1013_a337, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1013_a339, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_a33c, 3); add(eax, 6);                            /* add eax, 0x6 */
            ii(0x1013_a33f, 5); call(0x1013_aa3c, 0x6f8);               /* call 0x1013aa3c */
            ii(0x1013_a344, 5); call(0x1013_9f45, -0x404);              /* call 0x10139f45 */
        l_0x1013_a349:
            ii(0x1013_a349, 3); lea(edx, memd[ss, ebp - 28]);           /* lea edx, [ebp-0x1c] */
            ii(0x1013_a34c, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_a34f, 3); add(eax, 6);                            /* add eax, 0x6 */
            ii(0x1013_a352, 5); call(0x1013_aa70, 0x719);               /* call 0x1013aa70 */
            ii(0x1013_a357, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_a359, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
