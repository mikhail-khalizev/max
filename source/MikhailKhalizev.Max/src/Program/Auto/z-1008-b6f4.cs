...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_b6f4()
        {
            ...
            ii(0x1008_b70c, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x1008_b71b, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ...
            ii(0x1008_b72d, 3); lea(ebx, memd[ss, ebp - 0x10]);         /* lea ebx, [ebp-0x10] */
            ...
            ii(0x1008_b739, 7); mov(memd[ss, ebp - 0x14], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x1008_b740, 2); jmp(0x1008_b74a, 0x8); goto l_0x1008_b74a; /* jmp 0x1008b74a */
        l_0x1008_b742:
            ii(0x1008_b742, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1008_b745, 5); call(0x1007_6bf8, -0x1_4b52);           /* call 0x10076bf8 */
        l_0x1008_b74a:
            ii(0x1008_b74a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_b74c, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
        ...
        l_0x1008_b7aa:
            ii(0x1008_b7aa, 2); jmp(0x1008_b7b4, 0x8); goto l_0x1008_b7b4; /* jmp 0x1008b7b4 */
        l_0x1008_b7ac:
            ii(0x1008_b7ac, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1008_b7af, 5); call(0x1007_6bf8, -0x1_4bbc);           /* call 0x10076bf8 */
        l_0x1008_b7b4:
            ii(0x1008_b7b4, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_b7b6, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x1008_b7c2, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1008_b7c5, 5); call(0x1008_adc4, -0xa06);              /* call 0x1008adc4 */
            ii(0x1008_b7ca, 5); call(0x1008_ad90, -0xa3f);              /* call 0x1008ad90 */
            ii(0x1008_b7cf, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ii(0x1008_b7d3, 2); if(jnz(0x1008_b7f0, 0x1b)) goto l_0x1008_b7f0; /* jnz 0x1008b7f0 */
            ii(0x1008_b7d5, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1008_b7d8, 5); call(0x1008_adc4, -0xa19);              /* call 0x1008adc4 */
            ii(0x1008_b7dd, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1008_b7e0, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1008_b7e3, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x1008_b7e6, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1008_b7e9, 3); call_abs(memd[ds, edx + 0x20]);         /* call dword [edx+0x20] */
            ii(0x1008_b7ec, 2); cmp(al, 0x9);                           /* cmp al, 0x9 */
            ii(0x1008_b7ee, 2); if(jz(0x1008_b7f2, 0x2)) goto l_0x1008_b7f2; /* jz 0x1008b7f2 */
        l_0x1008_b7f0:
            ii(0x1008_b7f0, 2); jmp(0x1008_b824, 0x32); goto l_0x1008_b824; /* jmp 0x1008b824 */
        l_0x1008_b7f2:
            ii(0x1008_b7f2, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1008_b7f5, 5); call(0x1008_adf8, -0xa02);              /* call 0x1008adf8 */
            ii(0x1008_b7fa, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1008_b7fd, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x1008_b800, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1008_b803, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1008_b806, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x1008_b809, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1008_b80c, 3); call_abs(memd[ds, edx + 0x70]);         /* call dword [edx+0x70] */
            ii(0x1008_b80f, 2); test(al, al);                           /* test al, al */
            ii(0x1008_b811, 2); if(jz(0x1008_b824, 0x11)) goto l_0x1008_b824; /* jz 0x1008b824 */
            ii(0x1008_b813, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ...
            ii(0x1008_b821, 3); add(memd[ss, ebp - 0x14], eax);         /* add [ebp-0x14], eax */
        l_0x1008_b824:
            ii(0x1008_b824, 2); jmp(0x1008_b7ac, -0x7a); goto l_0x1008_b7ac; /* jmp 0x1008b7ac */
        l_0x1008_b826:
            ii(0x1008_b826, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1008_b82a, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1008_b82c, 2); if(jle(0x1008_b834, 0x6)) goto l_0x1008_b834; /* jle 0x1008b834 */
            ii(0x1008_b82e, 4); mov(memb[ss, ebp - 0x24], 0x1);         /* mov byte [ebp-0x24], 0x1 */
            ii(0x1008_b832, 2); jmp(0x1008_b838, 0x4); goto l_0x1008_b838; /* jmp 0x1008b838 */
        l_0x1008_b834:
            ii(0x1008_b834, 4); mov(memb[ss, ebp - 0x24], 0);           /* mov byte [ebp-0x24], 0x0 */
        l_0x1008_b838:
            ii(0x1008_b838, 3); mov(al, memb[ss, ebp - 0x24]);          /* mov al, [ebp-0x24] */
            ii(0x1008_b83b, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x1008_b83e, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_b840, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1008_b843, 5); call(0x1008_8bbc, -0x2c8c);             /* call 0x10088bbc */
            ii(0x1008_b848, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_b84a, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
        ...
        //  ii(0x1008_b856, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
        //  ii(0x1008_b859, 5); call(0x1008_8bbc, -0x2ca2);             /* call 0x10088bbc */
        //  ii(0x1008_b85e, 2); xor(edx, edx);                          /* xor edx, edx */
        //  ii(0x1008_b860, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
        //  ii(0x1008_b863, 5); call(0x1007_5f6c, -0x1_58fc);           /* call 0x10075f6c */
        l_0x1008_b868:
            ii(0x1008_b868, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
