...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_0a2a()
        {
            ...
            ii(0x1008_0a3c, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1008_0a42, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1008_0a45, 4); mov(memb[ss, ebp - 8], 0x1a);           /* mov byte [ebp-0x8], 0x1a */
            ii(0x1008_0a49, 3); mov(al, memb[ss, ebp - 8]);             /* mov al, [ebp-0x8] */
