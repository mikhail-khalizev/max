...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void my_strobj_ctor_strobj()
        {
            ...
            ii(0x1014_182d, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_1830, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_1833, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_1836, 5); call(Definitions.my_strobj_get_len, -0x5_6917); /* call 0x100eaf24 */
            ii(0x1014_183b, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1014_183d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_1840, 4); mov(memw[ds, eax + 0x6], dx);           /* mov [eax+0x6], dx */
            ii(0x1014_1844, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_1847, 5); call(Definitions.my_strobj_get_size, 0xd10); /* call 0x1014255c */
            ii(0x1014_184c, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1014_184e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_1851, 4); mov(memw[ds, eax + 0x4], dx);           /* mov [eax+0x4], dx */
            ii(0x1014_1855, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_1858, 3); mov(eax, memd[ds, eax + 0x2]);          /* mov eax, [eax+0x2] */
            ...
            ii(0x1014_1866, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_1869, 2); mov(memd[ds, eax], edx);                /* mov [eax], edx */
            ii(0x1014_186b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_186e, 5); call(Definitions.my_strobj_c_str, -0xb_8077); /* call 0x100897fc */
            ii(0x1014_1873, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1014_1875, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_1878, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1014_187a, 5); call(Definitions.sys_strcpy, 0x2_4650); /* call 0x10165ecf */
            ii(0x1014_187f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_1882, 7); mov(memd[ds, eax + 0x8], 0x1);          /* mov dword [eax+0x8], 0x1 */
            ii(0x1014_1889, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_188c, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_188f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
