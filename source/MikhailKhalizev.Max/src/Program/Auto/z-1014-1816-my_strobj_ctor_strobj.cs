...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("f97400e2-7e72-4284-bfcc-93a2d6417fa2")]
        public void my_strobj_ctor_strobj()
        {
            ii(0x1014_1816, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x1014_181b, 5); calld(Definitions.sys_check_available_stack_size, 0x2_4532); /* call 0x10165d52 */
            ...
            ii(0x1014_1836, 5); calld(Definitions.my_strobj_get_len, -0x5_6917); /* call 0x100eaf24 */
            ...
            ii(0x1014_185f, 5); calld(Definitions.sys_new_arr, 0x2_47ac); /* call 0x10166010 */
            ...
            ii(0x1014_186e, 5); calld(Definitions.my_strobj_c_str, -0xb_8077); /* call 0x100897fc */
            ...
            ii(0x1014_187a, 5); calld(Definitions.sys_strcpy, 0x2_4650); /* call 0x10165ecf */
