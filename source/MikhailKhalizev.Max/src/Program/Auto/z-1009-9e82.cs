...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_9e82()
        {
            ...
            ii(0x1009_9e9a, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_9e9d, 4); mov(memb[ss, ebp - 0x8], 0x13);         /* mov byte [ebp-0x8], 0x13 */
            ii(0x1009_9ea1, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
