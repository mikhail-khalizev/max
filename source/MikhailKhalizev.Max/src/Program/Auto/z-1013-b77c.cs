...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_b77c()
        {
            ...
            ii(0x1013_b797, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1013_b79a, 3); mov(memd[ss, ebp - 0x4], ecx);          /* mov [ebp-0x4], ecx */
            ...
            ii(0x1013_b7d7, 7); mov(memd[ds, eax + 0x2], 0x101b_6f20);  /* mov dword [eax+0x2], 0x101b6f20 */
