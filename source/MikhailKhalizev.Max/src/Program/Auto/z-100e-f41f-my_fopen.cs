...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("a1a9d0dc-7b3e-4a9e-9203-ee71bdfca35e")]
        public void my_fopen()
        {
            ii(0x100e_f41f, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x100e_f424, 5); calld(Definitions.sys_check_available_stack_size, 0x76929); /* call 0x10165d52 */
            ...
            ii(0x100e_f442, 5); calld(Definitions.sys_fopen, 0x82f33);  /* call 0x1017237a */
