...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_bafc()
        {
            ...
            ii(0x100f_bb17, 7); mov(memd[ss, ebp - 0x10], 4);           /* mov dword [ebp-0x10], 0x4 */
            ii(0x100f_bb1e, 4); mov(memb[ss, ebp - 8], 0);              /* mov byte [ebp-0x8], 0x0 */
        l_0x100f_bb22:
            ii(0x100f_bb22, 3); dec(memd[ss, ebp - 0x10]);              /* dec dword [ebp-0x10] */
            ii(0x100f_bb25, 5); cmp(memw[ss, ebp - 0x10], -1 /* 0xff */); /* cmp word [ebp-0x10], 0xffff */
        ...
        l_0x100f_bbba:
            ...
            ii(0x100f_bbc0, 4); cmp(memb[ss, ebp - 0x18], 2);           /* cmp byte [ebp-0x18], 0x2 */
            ii(0x100f_bbc4, 2); if(jb(0x100f_bbd4, 0xe)) goto l_0x100f_bbd4; /* jb 0x100fbbd4 */
            ii(0x100f_bbc6, 4); cmp(memb[ss, ebp - 0x18], 2);           /* cmp byte [ebp-0x18], 0x2 */
            ii(0x100f_bbca, 2); if(jbe(0x100f_bb6a, -0x62)) goto l_0x100f_bb6a; /* jbe 0x100fbb6a */
            ii(0x100f_bbcc, 4); cmp(memb[ss, ebp - 0x18], 3);           /* cmp byte [ebp-0x18], 0x3 */
