...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("613a4aff-f0f7-4f30-a6fc-d96eff3f30b8")]
        public void Method_100f_bafc()
        {
            ii(0x100f_bafc, 5); pushd(0x34);                            /* push 0x34 */
            ii(0x100f_bb01, 5); calld(Definitions.sys_check_available_stack_size, 0x6a24c); /* call 0x10165d52 */
        ...
        l_0x100f_bbdb:
            ...
            ii(0x100f_bbec, 1); retd(); return;                         /* ret */
        }
    }
}
