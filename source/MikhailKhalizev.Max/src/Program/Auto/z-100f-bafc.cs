...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_bafc()
        {
            ...
            ii(0x100f_bb14, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100f_bb17, 7); mov(memd[ss, ebp - 0x10], 0x4);         /* mov dword [ebp-0x10], 0x4 */
            ii(0x100f_bb1e, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x100f_bb22:
            ii(0x100f_bb22, 3); dec(memd[ss, ebp - 0x10]);              /* dec dword [ebp-0x10] */
            ii(0x100f_bb25, 5); cmp(memw[ss, ebp - 0x10], -0x1 /* 0xff */); /* cmp word [ebp-0x10], 0xffff */
            ii(0x100f_bb2a, 6); if(jz(0x100f_bbdb, 0xab)) goto l_0x100f_bbdb; /* jz 0x100fbbdb */
            ii(0x100f_bb30, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100f_bb33, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ii(0x100f_bb37, 2); if(jz(0x100f_bb53, 0x1a)) goto l_0x100f_bb53; /* jz 0x100fbb53 */
            ii(0x100f_bb39, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x100f_bb51, 2); if(jz(0x100f_bb58, 0x5)) goto l_0x100f_bb58; /* jz 0x100fbb58 */
        l_0x100f_bb53:
            ii(0x100f_bb53, 5); jmp(0x100f_bbd6, 0x7e); goto l_0x100f_bbd6; /* jmp 0x100fbbd6 */
        l_0x100f_bb58:
            ii(0x100f_bb58, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x100f_bb5c, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_bb60, 5); call(0x100f_b9d3, -0x192);              /* call 0x100fb9d3 */
            ii(0x100f_bb65, 3); mov(memb[ss, ebp - 0x14], al);          /* mov [ebp-0x14], al */
            ii(0x100f_bb68, 2); jmp(0x100f_bbba, 0x50); goto l_0x100f_bbba; /* jmp 0x100fbbba */
        l_0x100f_bb6a:
            ii(0x100f_bb6a, 4); cmp(memb[ss, ebp - 0x8], 0);            /* cmp byte [ebp-0x8], 0x0 */
            ii(0x100f_bb6e, 2); if(jnz(0x100f_bb74, 0x4)) goto l_0x100f_bb74; /* jnz 0x100fbb74 */
            ii(0x100f_bb70, 4); mov(memb[ss, ebp - 0x8], 0x2);          /* mov byte [ebp-0x8], 0x2 */
        l_0x100f_bb74:
            ii(0x100f_bb74, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x100f_bb84, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x100f_bb88, 3); imul(eax, eax, 0x13);                   /* imul eax, eax, 0x13 */
            ii(0x100f_bb8b, 7); cmp(memb[ds, eax + 0x101c_35c6], 0x1);  /* cmp byte [eax+0x101c35c6], 0x1 */
            ii(0x100f_bb92, 2); if(jnz(0x100f_bba2, 0xe)) goto l_0x100f_bba2; /* jnz 0x100fbba2 */
        l_0x100f_bb94:
            ii(0x100f_bb94, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x100f_bb98, 3); imul(eax, eax, 0x13);                   /* imul eax, eax, 0x13 */
            ii(0x100f_bb9b, 7); mov(memb[ds, eax + 0x101c_35c6], 0x2);  /* mov byte [eax+0x101c35c6], 0x2 */
        l_0x100f_bba2:
            ii(0x100f_bba2, 2); jmp(0x100f_bbd6, 0x32); goto l_0x100f_bbd6; /* jmp 0x100fbbd6 */
        l_0x100f_bba4:
            ii(0x100f_bba4, 4); mov(memb[ss, ebp - 0x8], 0x3);          /* mov byte [ebp-0x8], 0x3 */
            ii(0x100f_bba8, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x100f_bbac, 3); imul(eax, eax, 0x13);                   /* imul eax, eax, 0x13 */
            ii(0x100f_bbaf, 7); mov(memb[ds, eax + 0x101c_35c6], 0x3);  /* mov byte [eax+0x101c35c6], 0x3 */
        ...
        l_0x100f_bbba:
            ii(0x100f_bbba, 3); mov(al, memb[ss, ebp - 0x14]);          /* mov al, [ebp-0x14] */
            ii(0x100f_bbbd, 3); mov(memb[ss, ebp - 0x18], al);          /* mov [ebp-0x18], al */
            ii(0x100f_bbc0, 4); cmp(memb[ss, ebp - 0x18], 0x2);         /* cmp byte [ebp-0x18], 0x2 */
            ii(0x100f_bbc4, 2); if(jb(0x100f_bbd4, 0xe)) goto l_0x100f_bbd4; /* jb 0x100fbbd4 */
            ii(0x100f_bbc6, 4); cmp(memb[ss, ebp - 0x18], 0x2);         /* cmp byte [ebp-0x18], 0x2 */
            ii(0x100f_bbca, 2); if(jbe(0x100f_bb6a, -0x62)) goto l_0x100f_bb6a; /* jbe 0x100fbb6a */
            ii(0x100f_bbcc, 4); cmp(memb[ss, ebp - 0x18], 0x3);         /* cmp byte [ebp-0x18], 0x3 */
        ...
        l_0x100f_bbdb:
            ii(0x100f_bbdb, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x100f_bbde, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x100f_bbe1, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
