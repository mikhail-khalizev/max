...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_d9dc()
        {
            ...
            ii(0x1018_d9fd, 4); mov(memd[ss, esp + 8], eax);            /* mov [esp+0x8], eax */
            ii(0x1018_da01, 2); sub(ecx, edx);                          /* sub ecx, edx */
            ii(0x1018_da03, 3); shl(eax, 2);                            /* shl eax, 0x2 */
            ii(0x1018_da06, 1); inc(ecx);                               /* inc ecx */
            ii(0x1018_da07, 4); mov(memd[ss, esp + 4], eax);            /* mov [esp+0x4], eax */
            ii(0x1018_da0b, 3); add(eax, 4);                            /* add eax, 0x4 */
            ...
            ii(0x1018_da4d, 3); lea(edx, memd[ds, ecx + 4]);            /* lea edx, [ecx+0x4] */
            ii(0x1018_da50, 2); mov(memd[ds, ecx], eax);                /* mov [ecx], eax */
            ii(0x1018_da52, 2); mov(eax, ebp);                          /* mov eax, ebp */
            ii(0x1018_da54, 4); mov(esi, memd[ss, esp + 4]);            /* mov esi, [esp+0x4] */
            ...
            ii(0x1018_da63, 4); mov(eax, memd[ss, esp + 8]);            /* mov eax, [esp+0x8] */
        ...
        l_0x1018_da80:
            ii(0x1018_da80, 4); mov(eax, memd[ss, esp + 8]);            /* mov eax, [esp+0x8] */
