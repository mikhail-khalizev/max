...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_6752()
        {
            ...
            ii(0x1010_6769, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_676c, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1010_676f, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1010_6773, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_6776, 6); push(memd[ds, eax + 0x101b_8fdc]);      /* push dword [eax+0x101b8fdc] */
            ii(0x1010_677c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1010_6792, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1010_67a4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_67a7, 5); add(eax, 0xac);                         /* add eax, 0xac */
            ii(0x1010_67ac, 1); push(eax);                              /* push eax */
            ii(0x1010_67ad, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1010_67bd, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_67c0, 5); add(eax, 0xac);                         /* add eax, 0xac */
            ii(0x1010_67c5, 5); call(/* sys */ 0x1017_90ce, 0x7_2904);  /* call 0x101790ce */
            ii(0x1010_67ca, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1010_67cd, 2); jmp(0x1010_67d6, 0x7); goto l_0x1010_67d6; /* jmp 0x101067d6 */
        l_0x1010_67cf:
            ii(0x1010_67cf, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
        l_0x1010_67d6:
            ii(0x1010_67d6, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
