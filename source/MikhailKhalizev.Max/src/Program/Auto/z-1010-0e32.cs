...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("28323994-1fbe-40a3-81e5-155829ab23da")]
        public void Method_1010_0e32()
        {
            ii(0x1010_0e32, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x1010_0e37, 5); calld(Definitions.sys_check_available_stack_size, 0x6_4f16); /* call 0x10165d52 */
        ...
        l_0x1010_0e8f:
            ...
            ii(0x1010_0e98, 5); calld(0x100e_42e4, -0x1_cbb9);          /* call 0x100e42e4 */
            ii(0x1010_0e9d, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x1010_0ea2, 5); calld(0x1012_8835, 0x2_798e);           /* call 0x10128835 */
            ii(0x1010_0ea7, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1010_0ea9, 2); if(jzd(0x1010_0eb0, 0x5)) goto l_0x1010_0eb0; /* jz 0x10100eb0 */
            ii(0x1010_0eab, 5); calld(0x1016_2cb8, 0x6_1e08);           /* call 0x10162cb8 */
        l_0x1010_0eb0:
            ii(0x1010_0eb0, 2); jmpd(0x1010_0ec3, 0x11); goto l_0x1010_0ec3; /* jmp 0x10100ec3 */
        l_0x1010_0eb2:
            ii(0x1010_0eb2, 5); calld(0x1014_82f4, 0x4_743d);           /* call 0x101482f4 */
        ...
        l_0x1010_0ec3:
            ii(0x1010_0ec3, 5); calld(0x1016_2a8b, 0x6_1bc3);           /* call 0x10162a8b */
            ii(0x1010_0ec8, 5); calld(0x1011_fdcd, 0x1_ef00);           /* call 0x1011fdcd */
            ii(0x1010_0ecd, 5); calld(0x100a_9502, -0x5_79d0);          /* call 0x100a9502 */
        l_0x1010_0ed2:
        ...
        l_0x1010_0eeb:
            ...
            ii(0x1010_0ef1, 5); calld(0x100e_a903, -0x1_65f3);          /* call 0x100ea903 */
        l_0x1010_0ef6:
