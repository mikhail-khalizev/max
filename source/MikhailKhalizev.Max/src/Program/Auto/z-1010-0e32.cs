...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_0e32()
        {
            ...
            ii(0x1010_0e49, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x1010_0e4c, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x1010_0e4f, 4); cmp(memb[ss, ebp - 0x8], 0);            /* cmp byte [ebp-0x8], 0x0 */
            ii(0x1010_0e53, 2); if(jz(0x1010_0e5e, 0x9)) goto l_0x1010_0e5e; /* jz 0x10100e5e */
            ii(0x1010_0e55, 7); cmp(memb[ds, 0x101c_391e], 0x3);        /* cmp byte [0x101c391e], 0x3 */
            ii(0x1010_0e5c, 2); if(jnz(0x1010_0e60, 0x2)) goto l_0x1010_0e60; /* jnz 0x10100e60 */
        l_0x1010_0e5e:
            ii(0x1010_0e5e, 2); jmp(0x1010_0e69, 0x9); goto l_0x1010_0e69; /* jmp 0x10100e69 */
        l_0x1010_0e60:
            ii(0x1010_0e60, 7); cmp(memb[ds, 0x101c_391e], 0x7);        /* cmp byte [0x101c391e], 0x7 */
            ii(0x1010_0e67, 2); if(jnz(0x1010_0e6b, 0x2)) goto l_0x1010_0e6b; /* jnz 0x10100e6b */
        l_0x1010_0e69:
            ii(0x1010_0e69, 2); jmp(0x1010_0e74, 0x9); goto l_0x1010_0e74; /* jmp 0x10100e74 */
        l_0x1010_0e6b:
        ...
        l_0x1010_0e8f:
            ...
            ii(0x1010_0ea9, 2); if(jz(0x1010_0eb0, 0x5)) goto l_0x1010_0eb0; /* jz 0x10100eb0 */
        ...
        l_0x1010_0ed2:
            ...
            ii(0x1010_0ee2, 2); if(jz(0x1010_0eeb, 0x7)) goto l_0x1010_0eeb; /* jz 0x10100eeb */
            ii(0x1010_0ee4, 7); mov(memb[ds, 0x101c_37d2], 0x1);        /* mov byte [0x101c37d2], 0x1 */
        l_0x1010_0eeb:
            ii(0x1010_0eeb, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ii(0x1010_0eef, 2); if(jz(0x1010_0ef6, 0x5)) goto l_0x1010_0ef6; /* jz 0x10100ef6 */
