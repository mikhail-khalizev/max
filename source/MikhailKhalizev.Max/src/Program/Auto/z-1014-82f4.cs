...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("cd836706-349c-40a5-9c86-15607d25b833")]
        public void Method_1014_82f4()
        {
            ii(0x1014_82f4, 5); pushd(0x28);                            /* push 0x28 */
            ii(0x1014_82f9, 5); calld(Definitions.sys_check_available_stack_size, 0x1da54); /* call 0x10165d52 */
        ...
        l_0x1014_831e:
            ii(0x1014_831e, 5); calld(/* sys */ 0x1018_0fda, 0x38cb7);  /* call 0x10180fda */
            ii(0x1014_8323, 5); mov(edx, 0x80);                         /* mov edx, 0x80 */
            ii(0x1014_8328, 5); mov(eax, 0x43);                         /* mov eax, 0x43 */
            ii(0x1014_832d, 5); calld(/* sys */ 0x1018_0fc8, 0x38c96);  /* call 0x10180fc8 */
            ii(0x1014_8332, 5); mov(eax, 0x42);                         /* mov eax, 0x42 */
            ii(0x1014_8337, 5); calld(/* sys */ 0x1018_0fd2, 0x38c96);  /* call 0x10180fd2 */
            ii(0x1014_833c, 3); mov(memd_a32[ss, ebp - 0x8], eax);      /* mov [ebp-0x8], eax */
            ii(0x1014_833f, 5); mov(eax, 0x42);                         /* mov eax, 0x42 */
            ii(0x1014_8344, 5); calld(/* sys */ 0x1018_0fd2, 0x38c89);  /* call 0x10180fd2 */
            ...
            ii(0x1014_8367, 5); calld(/* sys */ 0x1018_0fdc, 0x38c70);  /* call 0x10180fdc */
