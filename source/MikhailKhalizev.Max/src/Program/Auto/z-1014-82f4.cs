...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1014_831e:
            ii(0x1014_831e, 5); calld(Definitions.sys_cli, 0x3_8cb7);   /* call 0x10180fda */
            ii(0x1014_8323, 5); mov(edx, 0x80);                         /* mov edx, 0x80 */
            ii(0x1014_8328, 5); mov(eax, 0x43);                         /* mov eax, 0x43 */
            ii(0x1014_832d, 5); calld(Definitions.sys_write_port, 0x3_8c96); /* call 0x10180fc8 */
            ii(0x1014_8332, 5); mov(eax, 0x42);                         /* mov eax, 0x42 */
            ii(0x1014_8337, 5); calld(Definitions.sys_read_port, 0x3_8c96); /* call 0x10180fd2 */
            ii(0x1014_833c, 3); mov(memd_a32[ss, ebp - 0x8], eax);      /* mov [ebp-0x8], eax */
            ii(0x1014_833f, 5); mov(eax, 0x42);                         /* mov eax, 0x42 */
            ii(0x1014_8344, 5); calld(Definitions.sys_read_port, 0x3_8c89); /* call 0x10180fd2 */
            ...
            ii(0x1014_8367, 5); calld(Definitions.sys_sti, 0x3_8c70);   /* call 0x10180fdc */
