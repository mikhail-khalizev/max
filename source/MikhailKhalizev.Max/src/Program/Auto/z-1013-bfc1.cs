...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_bfc1()
        {
            ...
            ii(0x1013_bfd9, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1013_bfdc, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_bfdf, 3); add(eax, 0x4);                          /* add eax, 0x4 */
            ii(0x1013_bfe2, 5); call(0x1013_c724, 0x73d);               /* call 0x1013c724 */
            ii(0x1013_bfe7, 3); lea(ebx, memd[ss, ebp - 0x8]);          /* lea ebx, [ebp-0x8] */
            ...
            ii(0x1013_bff3, 2); jmp(0x1013_bffd, 0x8); goto l_0x1013_bffd; /* jmp 0x1013bffd */
        l_0x1013_bff5:
            ii(0x1013_bff5, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1013_bff8, 5); call(0x1007_6bf8, -0xc_5405);           /* call 0x10076bf8 */
        l_0x1013_bffd:
            ii(0x1013_bffd, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_bfff, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x1013_c00d, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
        ...
        l_0x1013_c01c:
            ii(0x1013_c01c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_c01f, 3); add(eax, 0x4);                          /* add eax, 0x4 */
            ii(0x1013_c022, 5); call(0x1013_a6f4, -0x1933);             /* call 0x1013a6f4 */
            ii(0x1013_c027, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
