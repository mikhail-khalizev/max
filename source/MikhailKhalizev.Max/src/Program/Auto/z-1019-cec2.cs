...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1019_cec2()
        {
            ...
            ii(0x1019_ceda, 4); mov(memd[ss, esp + 0x4], eax);          /* mov [esp+0x4], eax */
            ii(0x1019_cede, 5); test(eax, 0x7fff_ffff);                 /* test eax, 0x7fffffff */
            ii(0x1019_cee3, 2); if(jnz(0x1019_cee9, 0x4)) goto l_0x1019_cee9; /* jnz 0x1019cee9 */
            ii(0x1019_cee5, 2); test(ecx, ecx);                         /* test ecx, ecx */
            ii(0x1019_cee7, 2); if(jz(0x1019_cf1e, 0x35)) goto l_0x1019_cf1e; /* jz 0x1019cf1e */
        l_0x1019_cee9:
            ii(0x1019_cee9, 4); mov(edx, memd[ss, esp + 0x6]);          /* mov edx, [esp+0x6] */
            ii(0x1019_ceed, 6); and(edx, 0x7ff0);                       /* and edx, 0x7ff0 */
            ii(0x1019_cef3, 4); mov(ebx, memd[ss, esp + 0x6]);          /* mov ebx, [esp+0x6] */
            ...
            ii(0x1019_cf08, 5); mov(memw[ss, esp + 0x6], bx);           /* mov [esp+0x6], bx */
            ii(0x1019_cf0d, 6); or(ecx, 0x3fe0);                        /* or ecx, 0x3fe0 */
            ii(0x1019_cf13, 6); sub(edx, 0x3fe);                        /* sub edx, 0x3fe */
            ii(0x1019_cf19, 5); mov(memw[ss, esp + 0x6], cx);           /* mov [esp+0x6], cx */
        l_0x1019_cf1e:
