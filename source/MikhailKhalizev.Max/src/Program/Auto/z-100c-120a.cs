...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_120a()
        {
            ...
            ii(0x100c_1223, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100c_1226, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ...
            ii(0x100c_1236, 2); if(jz(0x100c_1241, 0x9)) goto l_0x100c_1241; /* jz 0x100c1241 */
            ...
            ii(0x100c_123f, 2); if(jnz(0x100c_1243, 0x2)) goto l_0x100c_1243; /* jnz 0x100c1243 */
        l_0x100c_1241:
            ii(0x100c_1241, 2); jmp(0x100c_124c, 0x9); goto l_0x100c_124c; /* jmp 0x100c124c */
        l_0x100c_1243:
            ...
            ii(0x100c_124a, 2); if(jnz(0x100c_124e, 0x2)) goto l_0x100c_124e; /* jnz 0x100c124e */
        l_0x100c_124c:
        ...
        l_0x100c_124e:
            ...
            ii(0x100c_125b, 2); if(jg(0x100c_125f, 0x2)) goto l_0x100c_125f; /* jg 0x100c125f */
        l_0x100c_125d:
            ii(0x100c_125d, 2); jmp(0x100c_1275, 0x16); goto l_0x100c_1275; /* jmp 0x100c1275 */
        l_0x100c_125f:
            ii(0x100c_125f, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100c_1263, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100c_1266, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x100c_1273, 2); if(jnz(0x100c_127b, 0x6)) goto l_0x100c_127b; /* jnz 0x100c127b */
        l_0x100c_1275:
        ...
        l_0x100c_127b:
            ...
            ii(0x100c_127e, 5); cmp(memw[ds, eax + 0x8], 0x29);         /* cmp word [eax+0x8], 0x29 */
            ...
            ii(0x100c_1288, 5); cmp(memw[ds, eax + 0x8], 0x2a);         /* cmp word [eax+0x8], 0x2a */
            ii(0x100c_128d, 2); if(jnz(0x100c_1295, 0x6)) goto l_0x100c_1295; /* jnz 0x100c1295 */
        l_0x100c_128f:
        ...
        l_0x100c_1295:
            ...
            ii(0x100c_1298, 5); cmp(memw[ds, eax + 0x8], 0x42);         /* cmp word [eax+0x8], 0x42 */
            ...
            ii(0x100c_12a2, 5); cmp(memw[ds, eax + 0x8], 0x47);         /* cmp word [eax+0x8], 0x47 */
            ii(0x100c_12a7, 2); if(jnz(0x100c_12bf, 0x16)) goto l_0x100c_12bf; /* jnz 0x100c12bf */
        l_0x100c_12a9:
            ii(0x100c_12a9, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ...
            ii(0x100c_12b7, 2); if(jnz(0x100c_12bf, 0x6)) goto l_0x100c_12bf; /* jnz 0x100c12bf */
            ii(0x100c_12b9, 4); mov(memb[ss, ebp - 0x10], 0);           /* mov byte [ebp-0x10], 0x0 */
            ii(0x100c_12bd, 2); jmp(0x100c_12c3, 0x4); goto l_0x100c_12c3; /* jmp 0x100c12c3 */
        l_0x100c_12bf:
            ii(0x100c_12bf, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
        l_0x100c_12c3:
