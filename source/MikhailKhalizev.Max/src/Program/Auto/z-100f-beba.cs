...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x100f_beba, 4); cmp(memb[ss, ebp - 0x8], 0x4);          /* cmp byte [ebp-0x8], 0x4 */
            ...
            ii(0x100f_bee0, 3); mov(eax, memd[ss, ebp - 0x38]);         /* mov eax, [ebp-0x38] */
            ii(0x100f_bee3, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ii(0x100f_bee6, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x100f_bee9, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x100f_beec, 4); mov(memb[ss, ebp - 0x8], 0x2);          /* mov byte [ebp-0x8], 0x2 */
            ii(0x100f_bef0, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x100f_bef4, 2); jmp(0x100f_bf07, 0x11); goto l_0x100f_bf07; /* jmp 0x100fbf07 */
        l_0x100f_bef6:
            ii(0x100f_bef6, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
            ii(0x100f_befa, 7); cmp(memd[ds, 0x101c_5624], 0);          /* cmp dword [0x101c5624], 0x0 */
            ii(0x100f_bf01, 2); if(jnz(0x100f_bf07, 0x4)) goto l_0x100f_bf07; /* jnz 0x100fbf07 */
            ii(0x100f_bf03, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x100f_bf07:
