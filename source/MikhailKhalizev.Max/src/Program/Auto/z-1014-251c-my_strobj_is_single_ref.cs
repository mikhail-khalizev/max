...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void my_strobj_is_single_ref()
        {
            ...
            ii(0x1014_2534, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_2537, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_253a, 4); cmp(memd[ds, eax + 0x8], 0x1);          /* cmp dword [eax+0x8], 0x1 */
            ii(0x1014_253e, 2); if(jnz(0x1014_2546, 0x6)) goto l_0x1014_2546; /* jnz 0x10142546 */
            ii(0x1014_2540, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x1014_2544, 2); jmp(0x1014_254a, 0x4); goto l_0x1014_254a; /* jmp 0x1014254a */
        l_0x1014_2546:
            ii(0x1014_2546, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x1014_254a:
            ii(0x1014_254a, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x1014_254d, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x1014_2550, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
