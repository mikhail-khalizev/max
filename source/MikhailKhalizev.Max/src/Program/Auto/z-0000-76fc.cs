...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_76fc()
        {
            ...
            ii(0x7700, 4);    mov(memb[ss, bp - 13], 0x48);             /* mov byte [bp-0xd], 0x48 */
            ii(0x7704, 3);    mov(ax, memw[ss, bp + 4]);                /* mov ax, [bp+0x4] */
            ii(0x7707, 3);    mov(memw[ss, bp - 12], ax);               /* mov [bp-0xc], ax */
            ii(0x770a, 3);    lea(ax, memw[ss, bp - 14]);               /* lea ax, [bp-0xe] */
            ...
            ii(0x7714, 4);    test(memb[ss, bp - 2], 1);                /* test byte [bp-0x2], 0x1 */
            ii(0x7718, 2);    if(jz(0x771f, 5)) goto l_0x771f;          /* jz 0x771f */
            ii(0x771a, 2);    sub(ax, ax);                              /* sub ax, ax */
            ii(0x771c, 1);    cwd();                                    /* cwd */
            ii(0x771d, 1);    leave();                                  /* leave */
            ii(0x771e, 1);    ret(); return;                            /* ret */
        l_0x771f:
            ii(0x771f, 3);    mov(ax, memw[ss, bp - 14]);               /* mov ax, [bp-0xe] */
