...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_2c50()
        {
            ...
            ii(0x1010_2c81, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1010_2c84, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1010_2c87, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_2c8a, 10); mov(memd[ds, 0x101b_8aec], 0x1);       /* mov dword [0x101b8aec], 0x1 */
            ...
            ii(0x1010_2ca3, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1010_2ca6, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1010_2ca9, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_2cac, 10); mov(memd[ds, 0x101b_8aec], 0x2);       /* mov dword [0x101b8aec], 0x2 */
