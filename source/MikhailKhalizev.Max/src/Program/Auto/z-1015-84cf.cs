...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1015_850f:
            ii(0x1015_850f, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
            ii(0x1015_8512, 3); mov(edx, memd[ss, ebp - 0x10]);         /* mov edx, [ebp-0x10] */
            ii(0x1015_8515, 3); mov(memb[ds, edx + 0x56], al);          /* mov [edx+0x56], al */
            ii(0x1015_8518, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1015_851b, 4); mov(memb[ds, eax + 0x57], 0);           /* mov byte [eax+0x57], 0x0 */
            ii(0x1015_851f, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1015_8522, 4); mov(memb[ds, eax + 0x55], 0);           /* mov byte [eax+0x55], 0x0 */
