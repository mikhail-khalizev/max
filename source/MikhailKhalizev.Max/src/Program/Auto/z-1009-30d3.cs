...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_30d3()
        {
            ...
            ii(0x1009_30eb, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_30ee, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x1009_30f2, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
