...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_81ee()
        {
            ...
            ii(0x81f4, 3);    push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ii(0x81f7, 3);    call(0xc373, 0x4179);                     /* call 0xc373 */
            ii(0x81fa, 1);    pop(bx);                                  /* pop bx */
            ii(0x81fb, 3);    mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ii(0x81fe, 1);    inc(ax);                                  /* inc ax */
            ii(0x81ff, 2);    if(jz(0x8206, 0x5)) goto l_0x8206;        /* jz 0x8206 */
            ii(0x8201, 3);    mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0x8204, 2);    jmp(0x8208, 0x2); goto l_0x8208;          /* jmp 0x8208 */
        l_0x8206:
