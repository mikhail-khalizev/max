...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_c860()
        {
            ...
            ii(0x19_c865, 6); mov(memw[ss, bp - 178], 0);               /* mov word [bp-0xb2], 0x0 */
            ii(0x19_c86b, 3); mov(ax, memw[ss, bp + 8]);                /* mov ax, [bp+0x8] */
            ii(0x19_c86e, 3); mov(dx, memw[ss, bp + 10]);               /* mov dx, [bp+0xa] */
            ii(0x19_c871, 4); mov(memw[ss, bp - 156], ax);              /* mov [bp-0x9c], ax */
            ii(0x19_c875, 4); mov(memw[ss, bp - 154], dx);              /* mov [bp-0x9a], dx */
            ii(0x19_c879, 3); push(memw[ss, bp + 16]);                  /* push word [bp+0x10] */
            ii(0x19_c87c, 3); push(memw[ss, bp + 14]);                  /* push word [bp+0xe] */
            ii(0x19_c87f, 3); push(memw[ss, bp + 12]);                  /* push word [bp+0xc] */
            ii(0x19_c882, 3); lea(ax, memw[ss, bp - 128]);              /* lea ax, [bp-0x80] */
            ii(0x19_c885, 1); push(ss);                                 /* push ss */
            ii(0x19_c886, 1); push(ax);                                 /* push ax */
            ii(0x19_c887, 3); call(0x19_c5ce, -0x2bc);                  /* call 0xc5ce */
            ii(0x19_c88a, 4); cmp(memw[ss, bp + 12], -7 /* 0xf9 */);    /* cmp word [bp+0xc], 0xfff9 */
            ii(0x19_c88e, 2); if(jnz(0x19_c898, 8)) goto l_0x19_c898;   /* jnz 0xc898 */
            ii(0x19_c890, 6); mov(memw[ss, bp - 178], 0);               /* mov word [bp-0xb2], 0x0 */
            ii(0x19_c896, 2); jmp(0x19_c8de, 0x46); goto l_0x19_c8de;   /* jmp 0xc8de */
        l_0x19_c898:
            ii(0x19_c898, 4); cmp(memw[ss, bp + 12], 0);                /* cmp word [bp+0xc], 0x0 */
            ii(0x19_c89c, 2); if(jl(0x19_c8da, 0x3c)) goto l_0x19_c8da; /* jl 0xc8da */
            ii(0x19_c89e, 3); mov(ax, memw[ss, bp + 16]);               /* mov ax, [bp+0x10] */
            ii(0x19_c8a1, 3); or(ax, memw[ss, bp + 14]);                /* or ax, [bp+0xe] */
            ii(0x19_c8a4, 2); if(jz(0x19_c8bc, 0x16)) goto l_0x19_c8bc; /* jz 0xc8bc */
            ii(0x19_c8a6, 4); imul(bx, memw[ss, bp + 12], 0x18);        /* imul bx, [bp+0xc], 0x18 */
            ii(0x19_c8aa, 3); les(si, memw[ss, bp + 14]);               /* les si, [bp+0xe] */
            ii(0x19_c8ad, 2); mov(ax, bx);                              /* mov ax, bx */
            ii(0x19_c8af, 4); les(bx, memw[es, si + 60]);               /* les bx, [es:si+0x3c] */
        ...
        l_0x19_c8bc:
            ii(0x19_c8bc, 3); mov(ax, memw[ss, bp + 16]);               /* mov ax, [bp+0x10] */
            ii(0x19_c8bf, 3); or(ax, memw[ss, bp + 14]);                /* or ax, [bp+0xe] */
            ii(0x19_c8c2, 2); if(jz(0x19_c8de, 0x1a)) goto l_0x19_c8de; /* jz 0xc8de */
            ii(0x19_c8c4, 4); imul(bx, memw[ss, bp + 12], 0x18);        /* imul bx, [bp+0xc], 0x18 */
            ii(0x19_c8c8, 3); les(si, memw[ss, bp + 14]);               /* les si, [bp+0xe] */
            ii(0x19_c8cb, 2); mov(ax, bx);                              /* mov ax, bx */
            ii(0x19_c8cd, 4); les(bx, memw[es, si + 60]);               /* les bx, [es:si+0x3c] */
        ...
        l_0x19_c8da:
            ii(0x19_c8da, 4); inc(memw[ss, bp - 178]);                  /* inc word [bp-0xb2] */
        l_0x19_c8de:
            ii(0x19_c8de, 3); les(bx, memw[ss, bp + 14]);               /* les bx, [bp+0xe] */
            ii(0x19_c8e1, 5); cmp(memw[es, bx + 92], 0);                /* cmp word [es:bx+0x5c], 0x0 */
        ...
        l_0x19_c8ec:
            ii(0x19_c8ec, 5); cmp(memw[ss, bp - 178], 1);               /* cmp word [bp-0xb2], 0x1 */
        ...
        l_0x19_c8f8:
            ii(0x19_c8f8, 4); mov(memw[ss, bp - 178], ax);              /* mov [bp-0xb2], ax */
            ii(0x19_c8fc, 1); push(ax);                                 /* push ax */
            ii(0x19_c8fd, 3); lea(ax, memw[ss, bp - 128]);              /* lea ax, [bp-0x80] */
            ii(0x19_c900, 1); push(ss);                                 /* push ss */
            ii(0x19_c901, 1); push(ax);                                 /* push ax */
            ii(0x19_c902, 3); push(memw[ss, bp + 10]);                  /* push word [bp+0xa] */
            ii(0x19_c905, 3); push(memw[ss, bp + 8]);                   /* push word [bp+0x8] */
            ii(0x19_c908, 4); lea(ax, memw[ss, bp - 148]);              /* lea ax, [bp-0x94] */
            ii(0x19_c90c, 1); push(ss);                                 /* push ss */
            ii(0x19_c90d, 1); push(ax);                                 /* push ax */
            ii(0x19_c90e, 3); call(0x19_c684, -0x28d);                  /* call 0xc684 */
            ii(0x19_c911, 4); mov(memw[ss, bp - 144], ax);              /* mov [bp-0x90], ax */
            ii(0x19_c915, 4); mov(memw[ss, bp - 142], dx);              /* mov [bp-0x8e], dx */
            ii(0x19_c919, 2); mov(ax, dx);                              /* mov ax, dx */
            ii(0x19_c91b, 4); or(ax, memw[ss, bp - 144]);               /* or ax, [bp-0x90] */
            ii(0x19_c91f, 2); if(jz(0x19_c945, 0x24)) goto l_0x19_c945; /* jz 0xc945 */
            ii(0x19_c921, 4); mov(ax, memw[ss, bp - 148]);              /* mov ax, [bp-0x94] */
            ii(0x19_c925, 4); mov(dx, memw[ss, bp - 146]);              /* mov dx, [bp-0x92] */
            ii(0x19_c929, 3); les(bx, memw[ss, bp + 4]);                /* les bx, [bp+0x4] */
            ii(0x19_c92c, 4); mov(memw[es, bx + 8], ax);                /* mov [es:bx+0x8], ax */
            ii(0x19_c930, 4); mov(memw[es, bx + 10], dx);               /* mov [es:bx+0xa], dx */
            ii(0x19_c934, 4); mov(ax, memw[ss, bp - 144]);              /* mov ax, [bp-0x90] */
            ii(0x19_c938, 4); mov(dx, memw[ss, bp - 142]);              /* mov dx, [bp-0x8e] */
