...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_ee06()
        {
            ...
            ii(0x100a_ee1e, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_ee21, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_ee32, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_ee5a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_ee77, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_eeaf, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x100a_eebd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_eec0, 3); mov(ebx, memd[ds, eax + 0x16]);         /* mov ebx, [eax+0x16] */
            ii(0x100a_eec3, 3); sar(ebx, 0x18);                         /* sar ebx, 0x18 */
            ii(0x100a_eec6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_eed3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_eed6, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
        ...
        l_0x100a_eef1:
            ii(0x100a_eef1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_ef06, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100a_ef09, 4); cmp(memb[ds, edx + 0x19], 0x3);         /* cmp byte [edx+0x19], 0x3 */
            ii(0x100a_ef0d, 2); if(jnz(0x100a_ef16, 0x7)) goto l_0x100a_ef16; /* jnz 0x100aef16 */
            ii(0x100a_ef0f, 7); mov(memd[ss, ebp - 0x18], 0x1);         /* mov dword [ebp-0x18], 0x1 */
        l_0x100a_ef16:
            ii(0x100a_ef16, 7); mov(memd[ss, ebp - 0x10], 0x1);         /* mov dword [ebp-0x10], 0x1 */
            ii(0x100a_ef1d, 2); jmp(0x100a_ef25, 0x6); goto l_0x100a_ef25; /* jmp 0x100aef25 */
        l_0x100a_ef1f:
            ii(0x100a_ef1f, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100a_ef22, 3); inc(memd[ss, ebp - 0x10]);              /* inc dword [ebp-0x10] */
        l_0x100a_ef25:
            ii(0x100a_ef25, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_ef3e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_ef74, 2); if(jge(0x100a_ef78, 0x2)) goto l_0x100a_ef78; /* jge 0x100aef78 */
        l_0x100a_ef76:
            ii(0x100a_ef76, 2); jmp(0x100a_ef91, 0x19); goto l_0x100a_ef91; /* jmp 0x100aef91 */
        l_0x100a_ef78:
            ii(0x100a_ef78, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_ef7b, 3); add(eax, 0x2c);                         /* add eax, 0x2c */
            ii(0x100a_ef7e, 5); call(0x1009_cb94, -0x1_23ef);           /* call 0x1009cb94 */
            ii(0x100a_ef83, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100a_ef91:
            ...
            ii(0x100a_efbc, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_efbf, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_efc8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100a_efd9:
            ...
            ii(0x100a_efe5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100a_eff6:
            ...
            ii(0x100a_eff9, 5); cmp(memw[ss, ebp - 0x10], -0x1 /* 0xff */); /* cmp word [ebp-0x10], 0xffff */
            ii(0x100a_effe, 2); if(jz(0x100a_f00f, 0xf)) goto l_0x100a_f00f; /* jz 0x100af00f */
            ii(0x100a_f000, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_f002, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
