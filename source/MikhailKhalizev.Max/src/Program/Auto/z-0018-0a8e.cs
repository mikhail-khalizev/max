...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x18_0a8e, 4); enter(0x8, 0);                            /* enter 0x8, 0x0 */
            ...
            ii(0x18_0a9a, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x18_0a9d, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ii(0x18_0aa0, 3); call(0x18_0a56, -0x4d);                   /* call 0xa56 */
            ii(0x18_0aa3, 2); or(ax, ax);                               /* or ax, ax */
            ii(0x18_0aa5, 2); if(jnz(0x18_0aac, 0x5)) goto l_0x18_0aac; /* jnz 0xaac */
        ...
        l_0x18_0aac:
            ...
            ii(0x18_0ab3, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
        ...
        l_0x18_0ac4:
            ...
            ii(0x18_0ac9, 3); mov(bx, memw[ss, bp - 0x2]);              /* mov bx, [bp-0x2] */
            ...
            ii(0x18_0ae4, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x18_0ae7, 3); mov(ax, memw[ss, bp - 0x8]);              /* mov ax, [bp-0x8] */
        l_0x18_0aea:
            ii(0x18_0aea, 1); pop(ds);                                  /* pop ds */
            ii(0x18_0aeb, 1); pop(si);                                  /* pop si */
            ii(0x18_0aec, 1); pop(di);                                  /* pop di */
            ii(0x18_0aed, 1); leave();                                  /* leave */
            ii(0x18_0aee, 3); ret(0x4);                                 /* ret 0x4 */
        }
    }
}
