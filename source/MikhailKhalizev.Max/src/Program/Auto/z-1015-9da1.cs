...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_9da1()
        {
            ...
            ii(0x1015_9db8, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_9dbb, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1015_9dbe, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_9dc1, 4); cmp(memb[ds, eax + 0x3d], 0x8);         /* cmp byte [eax+0x3d], 0x8 */
            ...
            ii(0x1015_9dd9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1015_9de3:
            ...
            ii(0x1015_9df5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_9e0f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_9e12, 5); call(0x1015_7ccf, -0x2148);             /* call 0x10157ccf */
        l_0x1015_9e17:
            ii(0x1015_9e17, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1015_9e1a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
