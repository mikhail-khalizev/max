...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_d921()
        {
            ...
            ii(0x1015_d938, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_d93b, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1015_d93e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_d941, 5); call(0x1007_6338, -0xe_760e);           /* call 0x10076338 */
            ii(0x1015_d946, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1015_d948, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ii(0x1015_d94b, 5); call(0x1007_64b8, -0xe_7498);           /* call 0x100764b8 */
        l_0x1015_d950:
            ii(0x1015_d950, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_d952, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x1015_d95e, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1015_d961, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x1015_d972, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1015_d976, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_d978, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1015_d982:
            ii(0x1015_d982, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1015_d98c:
            ii(0x1015_d98c, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
            ii(0x1015_d990, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_d992, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
        ...
        //  ii(0x1015_d99c, 2); xor(edx, edx);                          /* xor edx, edx */
        //  ii(0x1015_d99e, 3); lea(eax, memd[ss, ebp - 0x10]);         /* lea eax, [ebp-0x10] */
        //  ii(0x1015_d9a1, 5); call(0x1007_5f6c, -0xe_7a3a);           /* call 0x10075f6c */
        l_0x1015_d9a6:
            ii(0x1015_d9a6, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
