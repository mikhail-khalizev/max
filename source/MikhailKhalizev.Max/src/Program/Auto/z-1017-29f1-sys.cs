...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_29f1()
        {
            ...
            ii(0x1017_29f8, 4); test(memb[ds, edx + 0xc], 0x2);         /* test byte [edx+0xc], 0x2 */
            ...
            ii(0x1017_2a08, 4); or(memb[ds, edx + 0xc], 0x20);          /* or byte [edx+0xc], 0x20 */
        l_0x1017_2a0c:
        ...
        l_0x1017_2a16:
            ii(0x1017_2a16, 4); cmp(memd[ds, edx + 0x8], 0);            /* cmp dword [edx+0x8], 0x0 */
            ii(0x1017_2a1a, 2); if(jnz(0x1017_2a23, 0x7)) goto l_0x1017_2a23; /* jnz 0x10172a23 */
        ...
        l_0x1017_2a23:
            ...
            ii(0x1017_2a2d, 3); mov(al, memb[ds, edx + 0xc]);           /* mov al, [edx+0xc] */
            ...
            ii(0x1017_2a39, 4); or(memb[ds, edx + 0xd], 0x10);          /* or byte [edx+0xd], 0x10 */
            ...
            ii(0x1017_2a45, 3); mov(edi, memd[ds, edx + 0x4]);          /* mov edi, [edx+0x4] */
            ii(0x1017_2a48, 2); mov(memd[ds, edx], esi);                /* mov [edx], esi */
            ii(0x1017_2a4a, 1); inc(edi);                               /* inc edi */
            ii(0x1017_2a4b, 3); mov(ebp, memd[ds, edx + 0x14]);         /* mov ebp, [edx+0x14] */
            ii(0x1017_2a4e, 3); mov(memd[ds, edx + 0x4], edi);          /* mov [edx+0x4], edi */
        ...
        l_0x1017_2a60:
            ii(0x1017_2a60, 4); or(memb[ds, edx + 0xd], 0x10);          /* or byte [edx+0xd], 0x10 */
            ...
            ii(0x1017_2a6b, 3); mov(esi, memd[ds, edx + 0x4]);          /* mov esi, [edx+0x4] */
            ii(0x1017_2a6e, 2); mov(memd[ds, edx], eax);                /* mov [edx], eax */
            ii(0x1017_2a70, 1); inc(esi);                               /* inc esi */
            ii(0x1017_2a71, 3); mov(edi, memd[ds, edx + 0xc]);          /* mov edi, [edx+0xc] */
            ii(0x1017_2a74, 3); mov(memd[ds, edx + 0x4], esi);          /* mov [edx+0x4], esi */
            ii(0x1017_2a77, 2); test(ecx, edi);                         /* test ecx, edi */
            ii(0x1017_2a79, 2); if(jnz(0x1017_2a80, 0x5)) goto l_0x1017_2a80; /* jnz 0x10172a80 */
            ii(0x1017_2a7b, 3); cmp(esi, memd[ds, edx + 0x14]);         /* cmp esi, [edx+0x14] */
