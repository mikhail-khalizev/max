...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_78de()
        {
            ...
            ii(0x1011_78f5, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_78f8, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1011_78fb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_78fe, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ii(0x1011_7901, 5); call(Definitions.sys_strlen, 0x5_a5c1); /* call 0x10171ec7 */
            ii(0x1011_7906, 1); inc(eax);                               /* inc eax */
            ii(0x1011_7907, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1011_790a, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x1011_790e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_7911, 5); call(0x1013_c0fa, 0x2_47e4);            /* call 0x1013c0fa */
            ii(0x1011_7916, 4); movsx(ebx, memw[ss, ebp - 0xc]);        /* movsx ebx, word [ebp-0xc] */
            ii(0x1011_791a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_791d, 3); mov(edx, memd[ds, eax + 0x8]);          /* mov edx, [eax+0x8] */
            ii(0x1011_7920, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_7923, 5); call(0x1013_c055, 0x2_472d);            /* call 0x1013c055 */
            ii(0x1011_7928, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_792b, 3); add(eax, 0xc);                          /* add eax, 0xc */
            ii(0x1011_792e, 5); call(0x1007_6600, -0xa_1333);           /* call 0x10076600 */
            ii(0x1011_7933, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ...
            ii(0x1011_7944, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_7947, 3); add(edx, 0x10);                         /* add edx, 0x10 */
            ii(0x1011_794a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_794d, 5); call(0x1013_c055, 0x2_4703);            /* call 0x1013c055 */
            ii(0x1011_7952, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_7955, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_7957, 3); mov(dl, memb[ds, eax + 0x14]);          /* mov dl, [eax+0x14] */
            ii(0x1011_795a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_795d, 5); call(0x100c_b818, -0x4_c14a);           /* call 0x100cb818 */
            ii(0x1011_7962, 5); mov(ebx, 0x2);                          /* mov ebx, 0x2 */
            ii(0x1011_7967, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_796a, 3); add(edx, 0x6);                          /* add edx, 0x6 */
            ii(0x1011_796d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
