...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("e1d975f5-59f2-4f2d-bbf0-79f2b00cdbf9")]
        public void Method_0000_9aa7()
        {
            ii(0x9aa7, 1);    pushw(bp);                                /* push bp */
            ii(0x9aa8, 1);    cli();                                    /* cli */
            ii(0x9aa9, 3);    callw(0x41d9, -0x58d3);                   /* call 0x41d9 */
            ...
            ii(0x9ac3, 4);    mov(memw_a16[ds, 0x469], cs);             /* mov [0x469], cs */
            ii(0x9ac7, 6);    mov(memw_a16[ds, 0x467], 0x6506);         /* mov word [0x467], 0x6506 */
            ii(0x9acd, 2);    mov(al, 0xa);                             /* mov al, 0xa */
            ii(0x9acf, 2);    outb(0x71, al);                           /* out 0x71, al */
            ii(0x9ad1, 5);    mov(memw_a16[ss, 0xf7a], sp);             /* mov [ss:0xf7a], sp */
            ii(0x9ad6, 6);    lgdtw_a16(ss, 0x8c8);                     /* lgdt [ss:0x8c8] */
            ii(0x9adc, 6);    lidtw_a16(ss, 0x8d0);                     /* lidt [ss:0x8d0] */
            ii(0x9ae2, 3);    smsw(ax);                                 /* smsw ax */
            ii(0x9ae5, 2);    or(al, 0x1);                              /* or al, 0x1 */
            ii(0x9ae7, 3);    lmsw(ax);                                 /* lmsw ax */
            ii(0x9aea, 5);    if(jmpw_far_abs(0x18, 0x64ff)) return;    /* jmp word 0x18:0x64ff */
        }
    }
}
