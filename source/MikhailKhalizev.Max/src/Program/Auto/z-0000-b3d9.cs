...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0xb3e2:
            ...
            ii(0xb3e6, 4);    mov(cx, memw[es, di + 4]);                /* mov cx, [es:di+0x4] */
            ii(0xb3ea, 2);    @int(0x31);                               /* int 0x31 */
            ii(0xb3ec, 3);    add(di, 6);                               /* add di, 0x6 */
        ...
        l_0xb3fb:
            ...
            ii(0xb3ff, 4);    mov(cx, memw[es, di + 4]);                /* mov cx, [es:di+0x4] */
            ii(0xb403, 2);    @int(0x31);                               /* int 0x31 */
            ii(0xb405, 3);    add(di, 6);                               /* add di, 0x6 */
