...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_70d3()
        {
            ...
            ii(0x100b_70e9, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100b_70ec, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100b_70ef, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x100b_70f2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_70fe, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_7101, 5); call(0x1015_26ac, 0x9_b5a6);            /* call 0x101526ac */
            ii(0x100b_7106, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100b_7109, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100b_710c, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x100b_710f, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100b_7112, 3); call_abs(memd[ds, edx + 0x20]);         /* call dword [edx+0x20] */
            ii(0x100b_7115, 2); cmp(al, 0x17);                          /* cmp al, 0x17 */
            ii(0x100b_7117, 2); if(jz(0x100b_711b, 0x2)) goto l_0x100b_711b; /* jz 0x100b711b */
        l_0x100b_7119:
            ii(0x100b_7119, 2); jmp(0x100b_712d, 0x12); goto l_0x100b_712d; /* jmp 0x100b712d */
        l_0x100b_711b:
            ii(0x100b_711b, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x100b_7120, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100b_712d:
            ...
            ii(0x100b_7136, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_7139, 5); call(0x100a_297d, -0x1_47c1);           /* call 0x100a297d */
            ii(0x100b_713e, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x100b_7143, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
