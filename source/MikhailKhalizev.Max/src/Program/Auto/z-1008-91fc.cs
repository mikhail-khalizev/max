...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_91fc()
        {
            ...
            ii(0x1008_9213, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_9216, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1008_9219, 7);  test(memd[ss, ebp - 4], 4);           /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x1008_9227, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1008_9236:
            ...
            ii(0x1008_9238, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1008_9246, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_9249, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x1008_924e, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_9251, 5);  call(0x100a_284c, 0x1_95f6);          /* call 0x100a284c */
            ii(0x1008_9256, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_9259, 7);  test(memd[ss, ebp - 4], 2);           /* test dword [ebp-0x4], 0x2 */
            ii(0x1008_9260, 2);  if(jz(0x1008_926a, 8)) goto l_0x1008_926a;/* jz 0x1008926a */
            ii(0x1008_9262, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_9265, 5);  call(Definitions.sys_delete, 0xd_ccfa);/* call 0x10165f64 */
        l_0x1008_926a:
            ii(0x1008_926a, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_926d, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1008_9270, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
