...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_3137()
        {
            ...
            ii(0x100b_314e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_3151, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100b_3154, 5); mov(edx, StringDefinitions.RetreatFromDanger); /* mov edx, 0x101a10cd */
            ii(0x100b_3159, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_315c, 5); call(Definitions.sys_strcpy, 0xb_2d6e); /* call 0x10165ecf */
            ii(0x100b_3161, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
