...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_1028()
        {
            ...
            ii(0x1017_1057, 3); mov(dl, memb[ds, esi + 0x1]);           /* mov dl, [esi+0x1] */
            ii(0x1017_105a, 1); inc(esi);                               /* inc esi */
            ii(0x1017_105b, 3); cmp(dl, 0x5c);                          /* cmp dl, 0x5c */
            ii(0x1017_105e, 2); if(jnz(0x1017_1061, 0x1)) goto l_0x1017_1061; /* jnz 0x10171061 */
        ...
        l_0x1017_1061:
            ...
            ii(0x1017_106d, 3); lea(ebx, memd[ds, ecx - 0x1]);          /* lea ebx, [ecx-0x1] */
        ...
        l_0x1017_1076:
            ...
            ii(0x1017_107a, 2); if(jge(0x1017_1081, 0x5)) goto l_0x1017_1081; /* jge 0x10171081 */
            ii(0x1017_107c, 2); jmp(0x1017_1086, 0x8); goto l_0x1017_1086; /* jmp 0x10171086 */
        l_0x1017_107e:
        ...
        l_0x1017_1086:
            ...
            ii(0x1017_109f, 2); jmp(0x1017_10a3, 0x2); goto l_0x1017_10a3; /* jmp 0x101710a3 */
        l_0x1017_10a1:
        ...
        l_0x1017_10a3:
            ...
            ii(0x1017_10ab, 3); lea(eax, memd[ds, edi + 0x1]);          /* lea eax, [edi+0x1] */
            ii(0x1017_10ae, 3); mov(memd[ss, esp], eax);                /* mov [esp], eax */
            ii(0x1017_10b1, 7); lea(eax, memd[ds, ecx * 8 + 0]);        /* lea eax, [ecx*8] */
            ...
            ii(0x1017_10c3, 4); mov(memd[ss, esp + 0x4], eax);          /* mov [esp+0x4], eax */
            ii(0x1017_10c7, 3); mov(eax, memd[ds, edx + 0x38]);         /* mov eax, [edx+0x38] */
            ii(0x1017_10ca, 4); add(eax, memd[ss, esp + 0x4]);          /* add eax, [esp+0x4] */
            ...
            ii(0x1017_10df, 2); if(jl(0x1017_10e4, 0x3)) goto l_0x1017_10e4; /* jl 0x101710e4 */
            ii(0x1017_10e1, 3); mov(memb[ds, edi], 0x5c);               /* mov byte [edi], 0x5c */
        l_0x1017_10e4:
            ii(0x1017_10e4, 7); lea(ebx, memd[ds, ecx * 8 + 0]);        /* lea ebx, [ecx*8] */
            ii(0x1017_10eb, 6); mov(esi, memd[ds, 0x101b_e1c0]);        /* mov esi, [0x101be1c0] */
            ii(0x1017_10f1, 2); add(ebx, ecx);                          /* add ebx, ecx */
            ii(0x1017_10f3, 3); mov(eax, memd[ds, esi + 0x38]);         /* mov eax, [esi+0x38] */
            ii(0x1017_10f6, 3); shl(ebx, 0x2);                          /* shl ebx, 0x2 */
            ii(0x1017_10f9, 4); mov(eax, memd[ds, ebx + eax + 0x20]);   /* mov eax, [ebx+eax+0x20] */
            ii(0x1017_10fd, 2); mov(edi, ebp);                          /* mov edi, ebp */
            ii(0x1017_10ff, 4); mov(esi, memd[ds, eax + edx * 8 + 0x4]); /* mov esi, [eax+edx*8+0x4] */
        ...
        l_0x1017_110b:
            ...
            ii(0x1017_110d, 2); if(jl(0x1017_1113, 0x4)) goto l_0x1017_1113; /* jl 0x10171113 */
