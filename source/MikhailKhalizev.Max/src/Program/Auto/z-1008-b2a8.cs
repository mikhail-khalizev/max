...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_b2a8()
        {
            ...
            ii(0x1008_b2b9, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1008_b2bf, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_b2c2, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1008_b2c5, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_b2c8, 5);  call(0x1008_b410, 0x143);             /* call 0x1008b410 */
            ii(0x1008_b2cd, 3);  add(eax, 6);                          /* add eax, 0x6 */
            ii(0x1008_b2d0, 5);  call(Definitions.my_3_get_count, 0x1ab);/* call 0x1008b480 */
            ii(0x1008_b2d5, 3);  movsx(ebx, ax);                       /* movsx ebx, ax */
            ii(0x1008_b2d8, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_b2db, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_b2de, 5);  call(0x1008_b2ec, 9);                 /* call 0x1008b2ec */
