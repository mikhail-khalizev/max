...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_0c0d()
        {
            ...
            ii(0x1009_0c24, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_0c27, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1009_0c2a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1009_0c39:
            ...
            ii(0x1009_0c3c, 5); cmp(memw[ss, ebp - 0xc], -0x1 /* 0xff */); /* cmp word [ebp-0xc], 0xffff */
            ...
            ii(0x1009_0c46, 4); add(memd[ss, ebp - 0x10], 0x4);         /* add dword [ebp-0x10], 0x4 */
        ...
        l_0x1009_0c53:
            ii(0x1009_0c53, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
