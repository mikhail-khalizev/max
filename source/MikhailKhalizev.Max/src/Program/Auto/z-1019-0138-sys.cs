...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("a587ee3a-af1b-4dde-a9b4-8121bcc8a554")]
        public void /* sys */ Method_1019_0138()
        {
            ii(0x1019_0138, 6); mov(edx, memd_a32[ds, 0x1020_9cd0]);    /* mov edx, [0x10209cd0] */
            ii(0x1019_013e, 2); mov(eax, memd_a32[ds, esi]);            /* mov eax, [esi] */
            ...
            ii(0x1019_014b, 2); mov(memd_a32[ds, edi], ebx);            /* mov [edi], ebx */
            ii(0x1019_014d, 3); mov(memd_a32[ds, edx + edi], ebx);      /* mov [edx+edi], ebx */
            ...
            ii(0x1019_015e, 3); mov(memd_a32[ds, edi + 0x4], ebx);      /* mov [edi+0x4], ebx */
            ii(0x1019_0161, 4); mov(memd_a32[ds, edx + edi + 0x4], ebx); /* mov [edx+edi+0x4], ebx */
            ii(0x1019_0165, 3); lea(edi, edi + edx * 2);                /* lea edi, [edi+edx*2] */
            ii(0x1019_0168, 3); mov(eax, memd_a32[ds, esi + 0x4]);      /* mov eax, [esi+0x4] */
            ...
            ii(0x1019_0176, 2); mov(memd_a32[ds, edi], ebx);            /* mov [edi], ebx */
            ii(0x1019_0178, 3); mov(memd_a32[ds, edx + edi], ebx);      /* mov [edx+edi], ebx */
            ...
            ii(0x1019_0189, 3); mov(memd_a32[ds, edi + 0x4], ebx);      /* mov [edi+0x4], ebx */
            ii(0x1019_018c, 4); mov(memd_a32[ds, edx + edi + 0x4], ebx); /* mov [edx+edi+0x4], ebx */
            ii(0x1019_0190, 3); lea(edi, edi + edx * 2);                /* lea edi, [edi+edx*2] */
            ii(0x1019_0193, 3); mov(eax, memd_a32[ds, esi + 0x8]);      /* mov eax, [esi+0x8] */
            ...
            ii(0x1019_01a1, 2); mov(memd_a32[ds, edi], ebx);            /* mov [edi], ebx */
            ii(0x1019_01a3, 3); mov(memd_a32[ds, edx + edi], ebx);      /* mov [edx+edi], ebx */
            ...
            ii(0x1019_01b4, 3); mov(memd_a32[ds, edi + 0x4], ebx);      /* mov [edi+0x4], ebx */
            ii(0x1019_01b7, 4); mov(memd_a32[ds, edx + edi + 0x4], ebx); /* mov [edx+edi+0x4], ebx */
            ii(0x1019_01bb, 3); lea(edi, edi + edx * 2);                /* lea edi, [edi+edx*2] */
            ii(0x1019_01be, 3); mov(eax, memd_a32[ds, esi + 0xc]);      /* mov eax, [esi+0xc] */
            ...
            ii(0x1019_01cc, 2); mov(memd_a32[ds, edi], ebx);            /* mov [edi], ebx */
            ii(0x1019_01ce, 3); mov(memd_a32[ds, edx + edi], ebx);      /* mov [edx+edi], ebx */
            ...
            ii(0x1019_01df, 3); mov(memd_a32[ds, edi + 0x4], ebx);      /* mov [edi+0x4], ebx */
            ii(0x1019_01e2, 4); mov(memd_a32[ds, edx + edi + 0x4], ebx); /* mov [edx+edi+0x4], ebx */
            ii(0x1019_01e6, 2); add(edi, edx);                          /* add edi, edx */
            ii(0x1019_01e8, 3); sub(edi, memd_a32[ss, ebp - 0x10]);     /* sub edi, [ebp-0x10] */
            ii(0x1019_01eb, 3); add(esi, 0x10);                         /* add esi, 0x10 */
            ii(0x1019_01ee, 1); retd(); return;                         /* ret */
        }
    }
}
