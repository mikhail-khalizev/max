...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_fb48()
        {
            ...
            ii(0x1014_fb60, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_fb63, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_fb66, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x1014_fb69, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1014_fb6c, 3); imul(eax, eax, 0x33);                   /* imul eax, eax, 0x33 */
            ii(0x1014_fb6f, 7); cmp(memb[ds, eax + 0x101c_81d5], 0x1);  /* cmp byte [eax+0x101c81d5], 0x1 */
            ii(0x1014_fb76, 2); if(jz(0x1014_fb81, 0x9)) goto l_0x1014_fb81; /* jz 0x1014fb81 */
            ii(0x1014_fb78, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1014_fb7f, 2); jmp(0x1014_fbca, 0x49); goto l_0x1014_fbca; /* jmp 0x1014fbca */
        l_0x1014_fb81:
            ii(0x1014_fb81, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_fb83, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_fb92, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_fb95, 4); mov(ax, memw[ds, eax + 0x52]);          /* mov ax, [eax+0x52] */
            ii(0x1014_fb99, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_fb9c, 2); jmp(0x1014_fbca, 0x2c); goto l_0x1014_fbca; /* jmp 0x1014fbca */
        l_0x1014_fb9e:
            ii(0x1014_fb9e, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_fba1, 5); call(0x1007_20b1, -0xd_daf5);           /* call 0x100720b1 */
            ii(0x1014_fba6, 3); lea(eax, memd[ss, ebp - 0x20]);         /* lea eax, [ebp-0x20] */
            ii(0x1014_fba9, 5); call(0x1007_20b1, -0xd_dafd);           /* call 0x100720b1 */
            ii(0x1014_fbae, 3); lea(ebx, memd[ss, ebp - 0x20]);         /* lea ebx, [ebp-0x20] */
            ii(0x1014_fbb1, 3); lea(edx, memd[ss, ebp - 0x14]);         /* lea edx, [ebp-0x14] */
            ii(0x1014_fbb4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_fbc4, 3); mov(eax, memd[ss, ebp - 0x12]);         /* mov eax, [ebp-0x12] */
            ii(0x1014_fbc7, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x1014_fbca:
            ii(0x1014_fbca, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
