...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_6584()
        {
            ...
            ii(0x658b, 5);    cmp(memb[ds, 0xcee], 3);                  /* cmp byte [0xcee], 0x3 */
            ...
            ii(0x6598, 2);    if(jb(0x659e, 4)) goto l_0x659e;          /* jb 0x659e */
            ii(0x659a, 2);    mov(al, 5);                               /* mov al, 0x5 */
            ii(0x659c, 2);    jmp(0x65a4, 6); goto l_0x65a4;            /* jmp 0x65a4 */
        l_0x659e:
            ii(0x659e, 2);    cmp(al, 0x13);                            /* cmp al, 0x13 */
            ii(0x65a0, 2);    if(jbe(0x65a4, 2)) goto l_0x65a4;         /* jbe 0x65a4 */
        l_0x65a2:
        ...
        l_0x65ad:
            ...
            ii(0x65af, 2);    jmp(0x65a8, -9); goto l_0x65a8;           /* jmp 0x65a8 */
        }
    }
}
