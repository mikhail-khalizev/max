...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_e265()
        {
            ...
            ii(0x18_e271, 6); cmp(memb[es, 0x2f], 0x3);                 /* cmp byte [es:0x2f], 0x3 */
            ...
            ii(0x18_e289, 3); mov(dl, memb[ds, bx + 0x6]);              /* mov dl, [bx+0x6] */
            ii(0x18_e28c, 3); and(dl, 0x70);                            /* and dl, 0x70 */
            ii(0x18_e28f, 4); test(cx, 0xfff0);                         /* test cx, 0xfff0 */
            ii(0x18_e293, 2); if(jz(0x18_e29c, 0x7)) goto l_0x18_e29c;  /* jz 0xe29c */
        ...
        l_0x18_e29c:
            ...
            ii(0x18_e2a4, 3); mov(memb[ds, bx + 0x6], al);              /* mov [bx+0x6], al */
