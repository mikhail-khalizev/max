...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_873d()
        {
            ...
            ii(0x100a_8755, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ...
            ii(0x100a_876e, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ii(0x100a_8771, 5); call(0x1008_b148, -0x1_d62e);           /* call 0x1008b148 */
            ii(0x100a_8776, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x100a_8779, 5); call(Definitions.my_ctor_0x101b_4184, -0x3_1c8e); /* call 0x10076af0 */
            ii(0x100a_877e, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_8781, 4); mov(memb[ds, eax + 19], 2);             /* mov byte [eax+0x13], 0x2 */
        l_0x100a_8785:
            ii(0x100a_8785, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_8793, 2); if(jle(0x100a_879e, 9)) goto l_0x100a_879e; /* jle 0x100a879e */
            ii(0x100a_8795, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_8798, 4); cmp(memb[ds, eax + 19], 2);             /* cmp byte [eax+0x13], 0x2 */
            ii(0x100a_879c, 2); if(jz(0x100a_87a0, 2)) goto l_0x100a_87a0; /* jz 0x100a87a0 */
        l_0x100a_879e:
        ...
        l_0x100a_87b8:
            ...
            ii(0x100a_87d3, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_87d6, 3); add(eax, 0x1e);                         /* add eax, 0x1e */
            ii(0x100a_87d9, 5); call(0x100c_db14, 0x2_5336);            /* call 0x100cdb14 */
            ii(0x100a_87de, 3); lea(edx, memd[ss, ebp - 36]);           /* lea edx, [ebp-0x24] */
            ii(0x100a_87e1, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_87e4, 3); add(eax, 0x3e);                         /* add eax, 0x3e */
            ii(0x100a_87e7, 5); call(0x100a_aa64, 0x2278);              /* call 0x100aaa64 */
            ii(0x100a_87ec, 7); mov(memd[ss, ebp - 8], 0);              /* mov dword [ebp-0x8], 0x0 */
            ii(0x100a_87f3, 2); jmp(0x100a_87fb, 6); goto l_0x100a_87fb; /* jmp 0x100a87fb */
        l_0x100a_87f5:
            ii(0x100a_87f5, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100a_87f8, 3); inc(memd[ss, ebp - 8]);                 /* inc dword [ebp-0x8] */
        l_0x100a_87fb:
            ii(0x100a_87fb, 4); movsx(eax, memw[ss, ebp - 8]);          /* movsx eax, word [ebp-0x8] */
            ii(0x100a_87ff, 3); cmp(eax, 8);                            /* cmp eax, 0x8 */
            ii(0x100a_8802, 2); if(jge(0x100a_880d, 9)) goto l_0x100a_880d; /* jge 0x100a880d */
            ii(0x100a_8804, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_8807, 4); cmp(memb[ds, eax + 19], 2);             /* cmp byte [eax+0x13], 0x2 */
            ii(0x100a_880b, 2); if(jz(0x100a_880f, 2)) goto l_0x100a_880f; /* jz 0x100a880f */
        l_0x100a_880d:
            ii(0x100a_880d, 2); jmp(0x100a_8879, 0x6a); goto l_0x100a_8879; /* jmp 0x100a8879 */
        l_0x100a_880f:
            ii(0x100a_880f, 3); lea(edx, memd[ss, ebp - 36]);           /* lea edx, [ebp-0x24] */
            ii(0x100a_8812, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x100a_8815, 5); call(0x1008_8b44, -0x1_fcd6);           /* call 0x10088b44 */
            ii(0x100a_881a, 4); movsx(eax, memw[ss, ebp - 8]);          /* movsx eax, word [ebp-0x8] */
            ii(0x100a_881e, 3); shl(eax, 2);                            /* shl eax, 0x2 */
            ii(0x100a_8821, 5); mov(edx, 0x101c_5348);                  /* mov edx, 0x101c5348 */
            ii(0x100a_8826, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x100a_8828, 3); lea(eax, memd[ss, ebp - 12]);           /* lea eax, [ebp-0xc] */
            ii(0x100a_882b, 5); call(0x1008_b1a4, -0x1_d68c);           /* call 0x1008b1a4 */
            ii(0x100a_8830, 3); lea(edx, memd[ss, ebp - 12]);           /* lea edx, [ebp-0xc] */
            ii(0x100a_8833, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ...
            ii(0x100a_883f, 3); lea(edx, memd[ss, ebp - 12]);           /* lea edx, [ebp-0xc] */
            ii(0x100a_8842, 3); lea(eax, memd[ss, ebp - 40]);           /* lea eax, [ebp-0x28] */
            ii(0x100a_8845, 5); call(0x1007_5e64, -0x3_29e6);           /* call 0x10075e64 */
            ii(0x100a_884a, 3); mov(ebx, memd[ss, ebp - 4]);            /* mov ebx, [ebp-0x4] */
            ...
            ii(0x100a_8858, 2); if(jnz(0x100a_885c, 2)) goto l_0x100a_885c; /* jnz 0x100a885c */
        l_0x100a_885a:
            ii(0x100a_885a, 2); jmp(0x100a_8874, 0x18); goto l_0x100a_8874; /* jmp 0x100a8874 */
        l_0x100a_885c:
            ii(0x100a_885c, 3); lea(edx, memd[ss, ebp - 12]);           /* lea edx, [ebp-0xc] */
            ii(0x100a_885f, 3); lea(eax, memd[ss, ebp - 44]);           /* lea eax, [ebp-0x2c] */
            ii(0x100a_8862, 5); call(0x1007_5e64, -0x3_2a03);           /* call 0x10075e64 */
            ii(0x100a_8867, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x100a_8869, 3); lea(edx, memd[ss, ebp - 36]);           /* lea edx, [ebp-0x24] */
            ii(0x100a_886c, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
        ...
        l_0x100a_887e:
            ii(0x100a_887e, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_888e, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_8891, 3); add(eax, 0x3e);                         /* add eax, 0x3e */
            ii(0x100a_8894, 5); call(0x1009_cb94, -0xbd05);             /* call 0x1009cb94 */
            ii(0x100a_8899, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_889c, 4); cmp(memb[ds, eax + 19], 2);             /* cmp byte [eax+0x13], 0x2 */
            ii(0x100a_88a0, 2); if(jnz(0x100a_88a9, 7)) goto l_0x100a_88a9; /* jnz 0x100a88a9 */
            ii(0x100a_88a2, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_88a5, 4); mov(memb[ds, eax + 19], 0);             /* mov byte [eax+0x13], 0x0 */
        l_0x100a_88a9:
            ii(0x100a_88a9, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_88ac, 4); cmp(memb[ds, eax + 19], 2);             /* cmp byte [eax+0x13], 0x2 */
            ...
            ii(0x100a_88bb, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
