...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_744d()
        {
            ...
            ii(0x1010_7468, 7); mov(memd[ss, ebp - 12], 4);             /* mov dword [ebp-0xc], 0x4 */
            ii(0x1010_746f, 2); jmp(0x1010_7477, 6); goto l_0x1010_7477; /* jmp 0x10107477 */
        l_0x1010_7471:
            ii(0x1010_7471, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1010_7474, 3); inc(memd[ss, ebp - 12]);                /* inc dword [ebp-0xc] */
        l_0x1010_7477:
            ii(0x1010_7477, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x1010_747b, 3); cmp(eax, 0x20);                         /* cmp eax, 0x20 */
            ii(0x1010_747e, 2); if(jge(0x1010_74db, 0x5b)) goto l_0x1010_74db; /* jge 0x101074db */
            ii(0x1010_7480, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1010_7497, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1010_74ad, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1010_74c2, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
        ...
        l_0x1010_74e2:
            ...
            ii(0x1010_754d, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ...
            ii(0x1010_7573, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x1010_7576, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x1010_7579, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x1010_757c, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1010_757e, 4); mov(ax, memw[ss, ebp - 28]);            /* mov ax, [ebp-0x1c] */
            ii(0x1010_7582, 3); add(eax, memd[ss, ebp - 20]);           /* add eax, [ebp-0x14] */
            ...
            ii(0x1010_7591, 3); sub(eax, memd[ss, ebp - 20]);           /* sub eax, [ebp-0x14] */
            ii(0x1010_7594, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x1010_7597, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1010_7599, 4); mov(bx, memw[ss, ebp - 28]);            /* mov bx, [ebp-0x1c] */
            ...
            ii(0x1010_75aa, 3); add(edx, memd[ss, ebp - 20]);           /* add edx, [ebp-0x14] */
            ...
            ii(0x1010_75b7, 4); mov(bx, memw[ss, ebp - 24]);            /* mov bx, [ebp-0x18] */
            ii(0x1010_75bb, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1010_75bd, 4); mov(ax, memw[ss, ebp - 28]);            /* mov ax, [ebp-0x1c] */
            ...
            ii(0x1010_75d2, 4); mov(ax, memw[ss, ebp - 28]);            /* mov ax, [ebp-0x1c] */
        ...
        l_0x1010_75e0:
            ...
            ii(0x1010_75e2, 4); mov(bx, memw[ss, ebp - 28]);            /* mov bx, [ebp-0x1c] */
            ...
            ii(0x1010_75f3, 3); add(edx, memd[ss, ebp - 20]);           /* add edx, [ebp-0x14] */
        ...
        l_0x1010_76d3:
            ...
            ii(0x1010_76d5, 4); mov(ax, memw[ss, ebp - 24]);            /* mov ax, [ebp-0x18] */
            ii(0x1010_76d9, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
        ...
        l_0x1010_7744:
            ii(0x1010_7744, 7); mov(memd[ss, ebp - 16], 0);             /* mov dword [ebp-0x10], 0x0 */
        l_0x1010_774b:
            ii(0x1010_774b, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
