...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_d366()
        {
            ...
            ii(0x1009_d37e, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_d381, 4); mov(memb[ss, ebp - 0x8], 0x27);         /* mov byte [ebp-0x8], 0x27 */
            ii(0x1009_d385, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
