...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_a0b0()
        {
            ...
            ii(0x100a_a0c8, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100a_a0cb, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_a0ce, 5); call(0x1013_aaa8, 0x9_09d5);            /* call 0x1013aaa8 */
            ii(0x100a_a0d3, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100a_a0d6, 3); lea(eax, memd[ss, ebp - 4]);            /* lea eax, [ebp-0x4] */
            ii(0x100a_a0d9, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100a_a0dc, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_a0df, 7); mov(memd[ds, eax + 2], 0x101b_4f44);    /* mov dword [eax+0x2], 0x101b4f44 */
            ii(0x100a_a0e6, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_a0e9, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100a_a0ec, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
