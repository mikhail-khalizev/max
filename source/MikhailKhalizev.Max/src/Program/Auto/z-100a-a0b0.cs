...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("16ea1cc5-8c5b-48bb-942c-6879b48d158a")]
        public void Method_100a_a0b0()
        {
            ii(0x100a_a0b0, 5); pushd(0x28);                            /* push 0x28 */
            ii(0x100a_a0b5, 5); calld(Definitions.sys_check_available_stack_size, 0xbbc98); /* call 0x10165d52 */
            ...
            ii(0x100a_a0ce, 5); calld(0x1013_aaa8, 0x909d5);            /* call 0x1013aaa8 */
