...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_7004()
        {
            ...
            ii(0x100e_701c, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100e_701f, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_7022, 5);  cmp(memw[ds, eax + 8], 0x1d);         /* cmp word [eax+0x8], 0x1d */
            ii(0x100e_7027, 2);  if(jnz(0x100e_709b, 0x72)) goto l_0x100e_709b;/* jnz 0x100e709b */
            ii(0x100e_7029, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_702c, 4);  cmp(memb[ds, eax + 61], 7);           /* cmp byte [eax+0x3d], 0x7 */
            ii(0x100e_7030, 2);  if(jnz(0x100e_705a, 0x28)) goto l_0x100e_705a;/* jnz 0x100e705a */
            ii(0x100e_7032, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_7035, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ii(0x100e_7038, 5);  and(eax, 0xff);                       /* and eax, 0xff */
            ii(0x100e_703d, 6);  imul(edx, eax, 0x247);                /* imul edx, eax, 0x247 */
            ii(0x100e_7043, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_7046, 3);  mov(eax, memd[ds, eax + 90]);         /* mov eax, [eax+0x5a] */
            ...
            ii(0x100e_7058, 2);  if(jz(0x100e_705c, 2)) goto l_0x100e_705c;/* jz 0x100e705c */
        l_0x100e_705a:
            ii(0x100e_705a, 2);  jmp(0x100e_709b, 0x3f); goto l_0x100e_709b;/* jmp 0x100e709b */
        l_0x100e_705c:
            ii(0x100e_705c, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_705f, 3);  mov(eax, memd[ds, eax + 90]);         /* mov eax, [eax+0x5a] */
            ii(0x100e_7062, 3);  sar(eax, 0x18);                       /* sar eax, 0x18 */
            ii(0x100e_7065, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ...
            ii(0x100e_7074, 6);  lea(eax, memd[ss, ebp - 404]);        /* lea eax, [ebp-0x194] */
            ...
            ii(0x100e_7088, 6);  lea(edx, memd[ss, ebp - 404]);        /* lea edx, [ebp-0x194] */
            ii(0x100e_708e, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100e_709b:
            ii(0x100e_709b, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_709e, 4);  cmp(memb[ds, eax + 62], 0x1f);        /* cmp byte [eax+0x3e], 0x1f */
            ii(0x100e_70a2, 6);  if(jnz(0x100e_7134, 0x8c)) goto l_0x100e_7134;/* jnz 0x100e7134 */
            ii(0x100e_70a8, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_70ab, 5);  call(0x1007_611c, -0x7_0f94);         /* call 0x1007611c */
            ii(0x100e_70b0, 6);  mov(memd[ss, ebp - 408], eax);        /* mov [ebp-0x198], eax */
            ii(0x100e_70b6, 6);  lea(edi, memd[ss, ebp - 420]);        /* lea edi, [ebp-0x1a4] */
            ...
            ii(0x100e_70c4, 6);  mov(eax, memd[ss, ebp - 408]);        /* mov eax, [ebp-0x198] */
            ii(0x100e_70ca, 3);  mov(eax, memd[ds, eax + 6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x100e_70d9, 6);  mov(eax, memd[ss, ebp - 408]);        /* mov eax, [ebp-0x198] */
            ii(0x100e_70df, 3);  mov(eax, memd[ds, eax + 6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x100e_70f1, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x100e_70f4, 7);  push(memd[ds, eax + ebp - 420]);      /* push dword [eax+ebp-0x1a4] */
            ii(0x100e_70fb, 6);  lea(eax, memd[ss, ebp - 404]);        /* lea eax, [ebp-0x194] */
            ...
            ii(0x100e_710a, 6);  mov(eax, memd[ss, ebp - 408]);        /* mov eax, [ebp-0x198] */
            ii(0x100e_7110, 4);  test(memb[ds, eax + 19], 2);          /* test byte [eax+0x13], 0x2 */
            ii(0x100e_7114, 2);  if(jz(0x100e_711f, 9)) goto l_0x100e_711f;/* jz 0x100e711f */
            ii(0x100e_7116, 6);  mov(eax, memd[ss, ebp - 408]);        /* mov eax, [ebp-0x198] */
            ii(0x100e_711c, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
        l_0x100e_711f:
            ii(0x100e_711f, 5);  mov(ebx, 0x1_001f);                   /* mov ebx, 0x1001f */
            ii(0x100e_7124, 6);  lea(edx, memd[ss, ebp - 404]);        /* lea edx, [ebp-0x194] */
            ii(0x100e_712a, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100e_7134:
            ...
            ii(0x100e_713b, 2);  if(jz(0x100e_7146, 9)) goto l_0x100e_7146;/* jz 0x100e7146 */
            ii(0x100e_713d, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_7140, 4);  test(memb[ds, eax + 20], 0x40);       /* test byte [eax+0x14], 0x40 */
            ii(0x100e_7144, 2);  if(jnz(0x100e_7148, 2)) goto l_0x100e_7148;/* jnz 0x100e7148 */
        l_0x100e_7146:
            ii(0x100e_7146, 2);  jmp(0x100e_7152, 0xa); goto l_0x100e_7152;/* jmp 0x100e7152 */
        l_0x100e_7148:
            ii(0x100e_7148, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_714b, 5);  cmp(memw[ds, eax + 8], 0xf);          /* cmp word [eax+0x8], 0xf */
            ii(0x100e_7150, 2);  if(jnz(0x100e_7154, 2)) goto l_0x100e_7154;/* jnz 0x100e7154 */
        l_0x100e_7152:
            ii(0x100e_7152, 2);  jmp(0x100e_715e, 0xa); goto l_0x100e_715e;/* jmp 0x100e715e */
        l_0x100e_7154:
            ii(0x100e_7154, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_7157, 5);  cmp(memw[ds, eax + 8], 0x10);         /* cmp word [eax+0x8], 0x10 */
            ii(0x100e_715c, 2);  if(jnz(0x100e_7160, 2)) goto l_0x100e_7160;/* jnz 0x100e7160 */
        l_0x100e_715e:
            ii(0x100e_715e, 2);  jmp(0x100e_7181, 0x21); goto l_0x100e_7181;/* jmp 0x100e7181 */
        l_0x100e_7160:
            ii(0x100e_7160, 6);  lea(edx, memd[ss, ebp - 404]);        /* lea edx, [ebp-0x194] */
            ii(0x100e_7166, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_7169, 5);  call(0x1014_fa43, 0x6_88d5);          /* call 0x1014fa43 */
            ii(0x100e_716e, 5);  mov(ebx, 0x1_0004);                   /* mov ebx, 0x10004 */
            ii(0x100e_7173, 6);  lea(edx, memd[ss, ebp - 404]);        /* lea edx, [ebp-0x194] */
            ii(0x100e_7179, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
