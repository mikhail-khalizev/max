...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_c560()
        {
            ...
            ii(0x1018_c56a, 3); mov(memd[ss, ebp - 16], edx);           /* mov [ebp-0x10], edx */
            ii(0x1018_c56d, 3); mov(memd[ss, ebp - 12], ebx);           /* mov [ebp-0xc], ebx */
            ii(0x1018_c570, 3); mov(memd[ss, ebp - 20], ecx);           /* mov [ebp-0x14], ecx */
            ...
            ii(0x1018_c580, 3); lea(eax, memd[ss, ebp - 72]);           /* lea eax, [ebp-0x48] */
            ...
            ii(0x1018_c593, 4); mov(memw[ss, ebp - 48], si);            /* mov [ebp-0x30], si */
            ii(0x1018_c597, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1018_c599, 3); mov(memb[ss, ebp - 43], ah);            /* mov [ebp-0x2b], ah */
            ii(0x1018_c59c, 3); mov(memb[ss, ebp - 44], dl);            /* mov [ebp-0x2c], dl */
            ii(0x1018_c59f, 6); mov(ax, memw[ds, 0x1020_b708]);         /* mov ax, [0x1020b708] */
            ii(0x1018_c5a5, 5); mov(edx, 0x800);                        /* mov edx, 0x800 */
            ii(0x1018_c5aa, 4); mov(memw[ss, ebp - 24], ax);            /* mov [ebp-0x18], ax */
            ii(0x1018_c5ae, 4); mov(memw[ss, ebp - 26], dx);            /* mov [ebp-0x1a], dx */
            ii(0x1018_c5b2, 4); mov(memw[ss, ebp - 38], ax);            /* mov [ebp-0x26], ax */
            ii(0x1018_c5b6, 5); mov(eax, 0x10);                         /* mov eax, 0x10 */
            ii(0x1018_c5bb, 3); lea(edx, memd[ss, ebp - 72]);           /* lea edx, [ebp-0x48] */
            ii(0x1018_c5be, 4); mov(memw[ss, ebp - 72], bx);            /* mov [ebp-0x48], bx */
            ...
            ii(0x1018_c5cb, 5); cmp(memw[ss, ebp - 44], 0x4f);          /* cmp word [ebp-0x2c], 0x4f */
        ...
        l_0x1018_c5d6:
            ...
            ii(0x1018_c5db, 3); mov(edi, memd[ss, ebp - 16]);           /* mov edi, [ebp-0x10] */
            ii(0x1018_c5de, 6); mov(esi, memd[ds, 0x1020_b700]);        /* mov esi, [0x1020b700] */
            ii(0x1018_c5e4, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1018_c5e7, 2); rep(() => movsd());                     /* rep movsd */
            ii(0x1018_c5e9, 3); mov(eax, memd[ds, eax + 12]);           /* mov eax, [eax+0xc] */
            ii(0x1018_c5ec, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x1018_c5ef, 5); call(/* sys */ 0x1019_43d0, 0x7ddc);    /* call 0x101943d0 */
            ii(0x1018_c5f4, 3); mov(memd[ds, edx + 12], eax);           /* mov [edx+0xc], eax */
            ...
            ii(0x1018_c600, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x1018_c603, 5); call(/* sys */ 0x1019_43d0, 0x7dc8);    /* call 0x101943d0 */
            ii(0x1018_c608, 2); mov(memd[ds, edx], eax);                /* mov [edx], eax */
            ii(0x1018_c60a, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x1018_c60d, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1018_c60f, 4); mov(ax, memw[ds, edx + 10]);            /* mov ax, [edx+0xa] */
            ii(0x1018_c613, 3); shl(eax, 0x10);                         /* shl eax, 0x10 */
            ii(0x1018_c616, 3); mov(edx, memd[ss, ebp - 20]);           /* mov edx, [ebp-0x14] */
