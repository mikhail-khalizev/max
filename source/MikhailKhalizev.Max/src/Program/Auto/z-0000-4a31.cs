...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("8a157dd3-0d80-4e92-9b83-08c89aebc50f")]
        public void Method_0000_4a31()
        {
            ii(0x4a31, 4);    mov(bx, memw_a16[ds, 0x8b2]);             /* mov bx, [0x8b2] */
            ii(0x4a35, 4);    cmp(bx, 0x80);                            /* cmp bx, 0x80 */
            ii(0x4a39, 2);    if(jbw(0x4a86, 0x4b)) goto l_0x4a86;      /* jb 0x4a86 */
            ii(0x4a3b, 3);    mov(ax, memw_a16[ds, 0x8aa]);             /* mov ax, [0x8aa] */
            ii(0x4a3e, 3);    cmp(ax, 0x80);                            /* cmp ax, 0x80 */
            ii(0x4a41, 2);    if(jbw(0x4a86, 0x43)) goto l_0x4a86;      /* jb 0x4a86 */
            ii(0x4a43, 3);    callw(0x3880, -0x11c6);                   /* call 0x3880 */
            ...
            ii(0x4a51, 2);    if(jnzw(0x4a83, 0x30)) goto l_0x4a83;     /* jnz 0x4a83 */
            ...
            ii(0x4a5e, 2);    if(jnzw(0x4a83, 0x23)) goto l_0x4a83;     /* jnz 0x4a83 */
