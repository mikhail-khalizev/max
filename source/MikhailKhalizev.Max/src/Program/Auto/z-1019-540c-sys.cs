...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_540c()
        {
            ...
            ii(0x1019_5413, 2); push(fs);                               /* push fs */
            ii(0x1019_5415, 2); push(gs);                               /* push gs */
            ii(0x1019_5417, 1); push(es);                               /* push es */
            ii(0x1019_5418, 4); mov(ax, 0x800);                         /* mov ax, 0x800 */
            ii(0x1019_541c, 4); mov(bx, memw[ss, ebp + 0xa]);           /* mov bx, [ebp+0xa] */
            ii(0x1019_5420, 4); mov(cx, memw[ss, ebp + 0x8]);           /* mov cx, [ebp+0x8] */
            ii(0x1019_5424, 4); mov(si, 0);                             /* mov si, 0x0 */
            ii(0x1019_5428, 4); mov(di, 0x4000);                        /* mov di, 0x4000 */
            ii(0x1019_542c, 2); @int(0x31);                             /* int 0x31 */
            ii(0x1019_542e, 4); mov(memw[ss, ebp - 0x8], cx);           /* mov [ebp-0x8], cx */
            ii(0x1019_5432, 4); mov(memw[ss, ebp - 0x6], bx);           /* mov [ebp-0x6], bx */
            ii(0x1019_5436, 4); mov(ax, 0);                             /* mov ax, 0x0 */
            ii(0x1019_543a, 4); mov(cx, 0x1);                           /* mov cx, 0x1 */
            ii(0x1019_543e, 2); @int(0x31);                             /* int 0x31 */
            ii(0x1019_5440, 4); mov(memw[ss, ebp - 0x4], ax);           /* mov [ebp-0x4], ax */
            ii(0x1019_5444, 4); mov(ax, 0x7);                           /* mov ax, 0x7 */
            ii(0x1019_5448, 4); mov(bx, memw[ss, ebp - 0x4]);           /* mov bx, [ebp-0x4] */
            ii(0x1019_544c, 4); mov(cx, memw[ss, ebp - 0x6]);           /* mov cx, [ebp-0x6] */
            ii(0x1019_5450, 4); mov(dx, memw[ss, ebp - 0x8]);           /* mov dx, [ebp-0x8] */
            ii(0x1019_5454, 2); @int(0x31);                             /* int 0x31 */
            ii(0x1019_5456, 4); mov(ax, 0x8);                           /* mov ax, 0x8 */
            ii(0x1019_545a, 4); mov(bx, memw[ss, ebp - 0x4]);           /* mov bx, [ebp-0x4] */
            ...
            ii(0x1019_5477, 4); mov(bx, memw[ss, ebp - 0x4]);           /* mov bx, [ebp-0x4] */
            ii(0x1019_547b, 2); @int(0x31);                             /* int 0x31 */
            ii(0x1019_547d, 4); mov(ax, memw[ss, ebp - 0x4]);           /* mov ax, [ebp-0x4] */
            ii(0x1019_5481, 1); pop(es);                                /* pop es */
            ii(0x1019_5482, 2); pop(gs);                                /* pop gs */
            ii(0x1019_5484, 2); pop(fs);                                /* pop fs */
