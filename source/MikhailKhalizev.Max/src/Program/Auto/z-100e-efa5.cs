...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_efa5()
        {
            ...
            ii(0x100e_efbb, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ...
            ii(0x100e_efca, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x100e_efcd, 7);  mov(memd[ss, ebp - 20], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x100e_efd4, 7);  mov(memd[ss, ebp - 24], 0);           /* mov dword [ebp-0x18], 0x0 */
            ii(0x100e_efdb, 7);  mov(memd[ss, ebp - 28], 0);           /* mov dword [ebp-0x1c], 0x0 */
            ii(0x100e_efe2, 7);  mov(memd[ss, ebp - 32], 0);           /* mov dword [ebp-0x20], 0x0 */
            ...
            ii(0x100e_efef, 4);  movsx(edx, memw[ss, ebp - 12]);       /* movsx edx, word [ebp-0xc] */
        ...
        l_0x100e_f000:
            ...
            ii(0x100e_f007, 4);  mov(memb[ss, ebp - 36], 1);           /* mov byte [ebp-0x24], 0x1 */
            ii(0x100e_f00b, 5);  jmp(0x100e_f2dc, 0x2cc); goto l_0x100e_f2dc;/* jmp 0x100ef2dc */
        l_0x100e_f010:
            ii(0x100e_f010, 7);  mov(memd[ss, ebp - 40], 0);           /* mov dword [ebp-0x28], 0x0 */
            ii(0x100e_f017, 2);  jmp(0x100e_f01f, 6); goto l_0x100e_f01f;/* jmp 0x100ef01f */
        l_0x100e_f019:
            ii(0x100e_f019, 3);  mov(eax, memd[ss, ebp - 40]);         /* mov eax, [ebp-0x28] */
            ii(0x100e_f01c, 3);  inc(memd[ss, ebp - 40]);              /* inc dword [ebp-0x28] */
        l_0x100e_f01f:
            ii(0x100e_f01f, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ii(0x100e_f023, 3);  cmp(eax, 4);                          /* cmp eax, 0x4 */
            ii(0x100e_f026, 6);  if(jge(0x100e_f0d0, 0xa4)) goto l_0x100e_f0d0;/* jge 0x100ef0d0 */
            ii(0x100e_f02c, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ...
            ii(0x100e_f049, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100e_f04c, 3);  inc(memd[ss, ebp - 20]);              /* inc dword [ebp-0x14] */
            ii(0x100e_f04f, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ...
            ii(0x100e_f069, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
            ii(0x100e_f06c, 3);  inc(memd[ss, ebp - 32]);              /* inc dword [ebp-0x20] */
        l_0x100e_f06f:
            ii(0x100e_f06f, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ...
            ii(0x100e_f07c, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
        ...
        l_0x100e_f098:
            ii(0x100e_f098, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ...
            ii(0x100e_f0b2, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x100e_f0b5, 3);  inc(memd[ss, ebp - 28]);              /* inc dword [ebp-0x1c] */
        l_0x100e_f0b8:
            ii(0x100e_f0b8, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x100e_f0bb, 3);  inc(memd[ss, ebp - 24]);              /* inc dword [ebp-0x18] */
            ii(0x100e_f0be, 3);  movsx(edx, ax);                       /* movsx edx, ax */
            ii(0x100e_f0c1, 2);  add(edx, edx);                        /* add edx, edx */
            ii(0x100e_f0c3, 3);  mov(eax, memd[ss, ebp - 40]);         /* mov eax, [ebp-0x28] */
            ii(0x100e_f0c6, 5);  mov(memw[ds, edx + ebp - 48], ax);    /* mov [edx+ebp-0x30], ax */
        l_0x100e_f0cb:
            ii(0x100e_f0cb, 5);  jmp(0x100e_f019, -0xb7); goto l_0x100e_f019;/* jmp 0x100ef019 */
        l_0x100e_f0d0:
            ii(0x100e_f0d0, 4);  movsx(edx, memw[ss, ebp - 12]);       /* movsx edx, word [ebp-0xc] */
            ii(0x100e_f0d4, 2);  xor(eax, eax);                        /* xor eax, eax */
            ii(0x100e_f0d6, 5);  call(0x100e_cd4d, -0x238e);           /* call 0x100ecd4d */
            ii(0x100e_f0db, 3);  mov(memb[ss, ebp - 52], al);          /* mov [ebp-0x34], al */
            ii(0x100e_f0de, 4);  cmp(memb[ss, ebp - 52], 2);           /* cmp byte [ebp-0x34], 0x2 */
            ii(0x100e_f0e2, 2);  if(jz(0x100e_f0ea, 6)) goto l_0x100e_f0ea;/* jz 0x100ef0ea */
            ii(0x100e_f0e4, 4);  cmp(memb[ss, ebp - 52], 3);           /* cmp byte [ebp-0x34], 0x3 */
            ii(0x100e_f0e8, 2);  if(jnz(0x100e_f108, 0x1e)) goto l_0x100e_f108;/* jnz 0x100ef108 */
        l_0x100e_f0ea:
            ii(0x100e_f0ea, 5);  mov(ecx, 1);                          /* mov ecx, 0x1 */
            ii(0x100e_f0ef, 4);  movsx(ebx, memw[ss, ebp - 12]);       /* movsx ebx, word [ebp-0xc] */
            ii(0x100e_f0f3, 4);  movsx(edx, memw[ss, ebp - 24]);       /* movsx edx, word [ebp-0x18] */
            ii(0x100e_f0f7, 3);  lea(eax, memd[ss, ebp - 48]);         /* lea eax, [ebp-0x30] */
            ii(0x100e_f0fa, 5);  call(0x100e_e881, -0x87e);            /* call 0x100ee881 */
            ii(0x100e_f0ff, 4);  mov(memb[ss, ebp - 36], 1);           /* mov byte [ebp-0x24], 0x1 */
            ii(0x100e_f103, 5);  jmp(0x100e_f2dc, 0x1d4); goto l_0x100e_f2dc;/* jmp 0x100ef2dc */
        l_0x100e_f108:
            ii(0x100e_f108, 4);  cmp(memb[ss, ebp - 52], 1);           /* cmp byte [ebp-0x34], 0x1 */
            ii(0x100e_f10c, 2);  if(jz(0x100e_f140, 0x32)) goto l_0x100e_f140;/* jz 0x100ef140 */
            ii(0x100e_f10e, 4);  movsx(eax, memw[ss, ebp - 24]);       /* movsx eax, word [ebp-0x18] */
            ii(0x100e_f112, 3);  cmp(eax, 1);                          /* cmp eax, 0x1 */
            ii(0x100e_f115, 2);  if(jnz(0x100e_f120, 9)) goto l_0x100e_f120;/* jnz 0x100ef120 */
            ii(0x100e_f117, 4);  movsx(eax, memw[ss, ebp - 20]);       /* movsx eax, word [ebp-0x14] */
        ...
        l_0x100e_f122:
            ...
            ii(0x100e_f127, 4);  movsx(ebx, memw[ss, ebp - 12]);       /* movsx ebx, word [ebp-0xc] */
            ii(0x100e_f12b, 4);  movsx(edx, memw[ss, ebp - 24]);       /* movsx edx, word [ebp-0x18] */
            ii(0x100e_f12f, 3);  lea(eax, memd[ss, ebp - 48]);         /* lea eax, [ebp-0x30] */
            ii(0x100e_f132, 5);  call(0x100e_e881, -0x8b6);            /* call 0x100ee881 */
            ii(0x100e_f137, 4);  mov(memb[ss, ebp - 36], 1);           /* mov byte [ebp-0x24], 0x1 */
            ii(0x100e_f13b, 5);  jmp(0x100e_f2dc, 0x19c); goto l_0x100e_f2dc;/* jmp 0x100ef2dc */
        l_0x100e_f140:
            ii(0x100e_f140, 4);  movsx(eax, memw[ss, ebp - 24]);       /* movsx eax, word [ebp-0x18] */
            ii(0x100e_f144, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x100e_f146, 2);  if(jz(0x100e_f159, 0x11)) goto l_0x100e_f159;/* jz 0x100ef159 */
            ii(0x100e_f148, 5);  cmp(memw[ss, ebp - 28], 0);           /* cmp word [ebp-0x1c], 0x0 */
            ii(0x100e_f14d, 2);  if(jnz(0x100e_f157, 8)) goto l_0x100e_f157;/* jnz 0x100ef157 */
            ii(0x100e_f14f, 4);  movsx(eax, memw[ss, ebp - 32]);       /* movsx eax, word [ebp-0x20] */
        ...
        l_0x100e_f159:
            ...
            ii(0x100e_f15e, 4);  movsx(ebx, memw[ss, ebp - 12]);       /* movsx ebx, word [ebp-0xc] */
            ii(0x100e_f162, 4);  movsx(edx, memw[ss, ebp - 24]);       /* movsx edx, word [ebp-0x18] */
            ii(0x100e_f166, 3);  lea(eax, memd[ss, ebp - 48]);         /* lea eax, [ebp-0x30] */
            ii(0x100e_f169, 5);  call(0x100e_e881, -0x8ed);            /* call 0x100ee881 */
            ii(0x100e_f16e, 4);  mov(memb[ss, ebp - 36], 1);           /* mov byte [ebp-0x24], 0x1 */
        ...
        l_0x100e_f177:
            ...
            ii(0x100e_f183, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ii(0x100e_f187, 4);  movsx(edx, memw[ss, ebp - 12]);       /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x100e_f192, 4);  movsx(eax, memw[ss, ebp - 32]);       /* movsx eax, word [ebp-0x20] */
        ...
        l_0x100e_f1a8:
            ii(0x100e_f1a8, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100e_f1ab, 4);  cmp(ax, memw[ss, ebp - 16]);          /* cmp ax, [ebp-0x10] */
            ii(0x100e_f1af, 2);  if(jl(0x100e_f1cf, 0x1e)) goto l_0x100e_f1cf;/* jl 0x100ef1cf */
            ii(0x100e_f1b1, 5);  mov(ecx, 1);                          /* mov ecx, 0x1 */
            ii(0x100e_f1b6, 4);  movsx(ebx, memw[ss, ebp - 12]);       /* movsx ebx, word [ebp-0xc] */
            ii(0x100e_f1ba, 4);  movsx(edx, memw[ss, ebp - 24]);       /* movsx edx, word [ebp-0x18] */
            ii(0x100e_f1be, 3);  lea(eax, memd[ss, ebp - 48]);         /* lea eax, [ebp-0x30] */
            ii(0x100e_f1c1, 5);  call(0x100e_e881, -0x945);            /* call 0x100ee881 */
            ii(0x100e_f1c6, 4);  mov(memb[ss, ebp - 36], 1);           /* mov byte [ebp-0x24], 0x1 */
        ...
        l_0x100e_f1d4:
            ii(0x100e_f1d4, 7);  mov(memd[ss, ebp - 40], 0);           /* mov dword [ebp-0x28], 0x0 */
            ii(0x100e_f1db, 2);  jmp(0x100e_f1e3, 6); goto l_0x100e_f1e3;/* jmp 0x100ef1e3 */
        l_0x100e_f1dd:
            ii(0x100e_f1dd, 3);  mov(eax, memd[ss, ebp - 40]);         /* mov eax, [ebp-0x28] */
            ii(0x100e_f1e0, 3);  inc(memd[ss, ebp - 40]);              /* inc dword [ebp-0x28] */
        l_0x100e_f1e3:
            ii(0x100e_f1e3, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ii(0x100e_f1e7, 3);  cmp(eax, 4);                          /* cmp eax, 0x4 */
            ii(0x100e_f1ea, 2);  if(jge(0x100e_f23d, 0x51)) goto l_0x100e_f23d;/* jge 0x100ef23d */
            ii(0x100e_f1ec, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ...
            ii(0x100e_f205, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ii(0x100e_f209, 6);  imul(eax, eax, 0x247);                /* imul eax, eax, 0x247 */
            ii(0x100e_f20f, 4);  movsx(edx, memw[ss, ebp - 16]);       /* movsx edx, word [ebp-0x10] */
        ...
        l_0x100e_f21d:
            ...
            ii(0x100e_f222, 4);  movsx(ebx, memw[ss, ebp - 12]);       /* movsx ebx, word [ebp-0xc] */
            ii(0x100e_f226, 4);  movsx(edx, memw[ss, ebp - 24]);       /* movsx edx, word [ebp-0x18] */
            ii(0x100e_f22a, 3);  lea(eax, memd[ss, ebp - 48]);         /* lea eax, [ebp-0x30] */
            ii(0x100e_f22d, 5);  call(0x100e_e881, -0x9b1);            /* call 0x100ee881 */
            ii(0x100e_f232, 4);  mov(memb[ss, ebp - 36], 1);           /* mov byte [ebp-0x24], 0x1 */
        ...
        l_0x100e_f23d:
            ii(0x100e_f23d, 4);  cmp(memb[ss, ebp - 52], 0);           /* cmp byte [ebp-0x34], 0x0 */
            ii(0x100e_f241, 6);  if(jnz(0x100e_f2d8, 0x91)) goto l_0x100e_f2d8;/* jnz 0x100ef2d8 */
            ii(0x100e_f247, 7);  mov(memd[ss, ebp - 40], 0);           /* mov dword [ebp-0x28], 0x0 */
            ii(0x100e_f24e, 2);  jmp(0x100e_f256, 6); goto l_0x100e_f256;/* jmp 0x100ef256 */
        l_0x100e_f250:
            ii(0x100e_f250, 3);  mov(eax, memd[ss, ebp - 40]);         /* mov eax, [ebp-0x28] */
            ii(0x100e_f253, 3);  inc(memd[ss, ebp - 40]);              /* inc dword [ebp-0x28] */
        l_0x100e_f256:
            ii(0x100e_f256, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ii(0x100e_f25a, 3);  cmp(eax, 4);                          /* cmp eax, 0x4 */
            ii(0x100e_f25d, 6);  if(jge(0x100e_f2d8, 0x75)) goto l_0x100e_f2d8;/* jge 0x100ef2d8 */
            ii(0x100e_f263, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ...
            ii(0x100e_f27d, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
        ...
        l_0x100e_f28c:
            ...
            ii(0x100e_f291, 3);  mov(memb[ss, ebp - 56], al);          /* mov [ebp-0x38], al */
            ii(0x100e_f294, 5);  mov(al, memb[ds, 0x101c_5624]);       /* mov al, [0x101c5624] */
            ii(0x100e_f299, 3);  mov(memb[ss, ebp - 60], al);          /* mov [ebp-0x3c], al */
            ii(0x100e_f29c, 2);  xor(ecx, ecx);                        /* xor ecx, ecx */
            ii(0x100e_f29e, 4);  movsx(ebx, memw[ss, ebp - 12]);       /* movsx ebx, word [ebp-0xc] */
            ii(0x100e_f2a2, 4);  movsx(edx, memw[ss, ebp - 24]);       /* movsx edx, word [ebp-0x18] */
            ii(0x100e_f2a6, 3);  lea(eax, memd[ss, ebp - 48]);         /* lea eax, [ebp-0x30] */
            ii(0x100e_f2a9, 5);  call(0x100e_e881, -0xa2d);            /* call 0x100ee881 */
            ii(0x100e_f2ae, 4);  cmp(memb[ss, ebp - 60], 0);           /* cmp byte [ebp-0x3c], 0x0 */
            ii(0x100e_f2b2, 2);  if(jz(0x100e_f2ba, 6)) goto l_0x100e_f2ba;/* jz 0x100ef2ba */
            ii(0x100e_f2b4, 4);  mov(memb[ss, ebp - 36], 1);           /* mov byte [ebp-0x24], 0x1 */
            ii(0x100e_f2b8, 2);  jmp(0x100e_f2dc, 0x22); goto l_0x100e_f2dc;/* jmp 0x100ef2dc */
        l_0x100e_f2ba:
            ii(0x100e_f2ba, 3);  mov(al, memb[ss, ebp - 56]);          /* mov al, [ebp-0x38] */
            ii(0x100e_f2bd, 5);  mov(memb[ds, 0x101c_391e], al);       /* mov [0x101c391e], al */
            ii(0x100e_f2c2, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
        ...
        l_0x100e_f2d8:
            ii(0x100e_f2d8, 4);  mov(memb[ss, ebp - 36], 0);           /* mov byte [ebp-0x24], 0x0 */
        l_0x100e_f2dc:
            ii(0x100e_f2dc, 3);  mov(al, memb[ss, ebp - 36]);          /* mov al, [ebp-0x24] */
