...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_efa5()
        {
            ...
            ii(0x100e_efbe, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100e_efc1, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ...
            ii(0x100e_efe9, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ...
            ii(0x100e_eff3, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100e_eff7, 2); sub(edx, eax);                          /* sub edx, eax */
            ii(0x100e_eff9, 3); cmp(edx, 0x5);                          /* cmp edx, 0x5 */
            ii(0x100e_effc, 2); if(jge(0x100e_f000, 0x2)) goto l_0x100e_f000; /* jge 0x100ef000 */
        l_0x100e_effe:
            ii(0x100e_effe, 2); jmp(0x100e_f010, 0x10); goto l_0x100e_f010; /* jmp 0x100ef010 */
        l_0x100e_f000:
            ii(0x100e_f000, 7); mov(memb[ds, 0x101c_391e], 0x3);        /* mov byte [0x101c391e], 0x3 */
            ii(0x100e_f007, 4); mov(memb[ss, ebp - 0x24], 0x1);         /* mov byte [ebp-0x24], 0x1 */
        ...
        l_0x100e_f010:
            ...
            ii(0x100e_f017, 2); jmp(0x100e_f01f, 0x6); goto l_0x100e_f01f; /* jmp 0x100ef01f */
        l_0x100e_f019:
        ...
        l_0x100e_f01f:
            ...
            ii(0x100e_f067, 2); if(jz(0x100e_f06f, 0x6)) goto l_0x100e_f06f; /* jz 0x100ef06f */
        ...
        l_0x100e_f06f:
            ...
            ii(0x100e_f094, 2); if(jnz(0x100e_f098, 0x2)) goto l_0x100e_f098; /* jnz 0x100ef098 */
        l_0x100e_f096:
        ...
        l_0x100e_f098:
            ...
            ii(0x100e_f0b0, 2); if(jz(0x100e_f0b8, 0x6)) goto l_0x100e_f0b8; /* jz 0x100ef0b8 */
        ...
        l_0x100e_f0d0:
            ...
            ii(0x100e_f0de, 4); cmp(memb[ss, ebp - 0x34], 0x2);         /* cmp byte [ebp-0x34], 0x2 */
            ii(0x100e_f0e2, 2); if(jz(0x100e_f0ea, 0x6)) goto l_0x100e_f0ea; /* jz 0x100ef0ea */
            ii(0x100e_f0e4, 4); cmp(memb[ss, ebp - 0x34], 0x3);         /* cmp byte [ebp-0x34], 0x3 */
        ...
        l_0x100e_f0ea:
            ...
            ii(0x100e_f0ff, 4); mov(memb[ss, ebp - 0x24], 0x1);         /* mov byte [ebp-0x24], 0x1 */
            ii(0x100e_f103, 5); jmp(0x100e_f2dc, 0x1d4); goto l_0x100e_f2dc; /* jmp 0x100ef2dc */
        l_0x100e_f108:
            ii(0x100e_f108, 4); cmp(memb[ss, ebp - 0x34], 0x1);         /* cmp byte [ebp-0x34], 0x1 */
            ...
            ii(0x100e_f115, 2); if(jnz(0x100e_f120, 0x9)) goto l_0x100e_f120; /* jnz 0x100ef120 */
            ii(0x100e_f117, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ii(0x100e_f11b, 3); cmp(eax, 0x1);                          /* cmp eax, 0x1 */
            ii(0x100e_f11e, 2); if(jg(0x100e_f122, 0x2)) goto l_0x100e_f122; /* jg 0x100ef122 */
        l_0x100e_f120:
        ...
        l_0x100e_f122:
            ...
            ii(0x100e_f137, 4); mov(memb[ss, ebp - 0x24], 0x1);         /* mov byte [ebp-0x24], 0x1 */
        ...
        l_0x100e_f140:
            ...
            ii(0x100e_f14d, 2); if(jnz(0x100e_f157, 0x8)) goto l_0x100e_f157; /* jnz 0x100ef157 */
            ii(0x100e_f14f, 4); movsx(eax, memw[ss, ebp - 0x20]);       /* movsx eax, word [ebp-0x20] */
            ii(0x100e_f153, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100e_f155, 2); if(jg(0x100e_f159, 0x2)) goto l_0x100e_f159; /* jg 0x100ef159 */
        l_0x100e_f157:
        ...
        l_0x100e_f159:
            ...
            ii(0x100e_f16e, 4); mov(memb[ss, ebp - 0x24], 0x1);         /* mov byte [ebp-0x24], 0x1 */
        ...
        l_0x100e_f177:
            ...
            ii(0x100e_f190, 2); if(jnz(0x100e_f19a, 0x8)) goto l_0x100e_f19a; /* jnz 0x100ef19a */
            ii(0x100e_f192, 4); movsx(eax, memw[ss, ebp - 0x20]);       /* movsx eax, word [ebp-0x20] */
            ii(0x100e_f196, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100e_f198, 2); if(jg(0x100e_f19c, 0x2)) goto l_0x100e_f19c; /* jg 0x100ef19c */
        l_0x100e_f19a:
        ...
        l_0x100e_f1a8:
            ...
            ii(0x100e_f1c6, 4); mov(memb[ss, ebp - 0x24], 0x1);         /* mov byte [ebp-0x24], 0x1 */
        ...
        l_0x100e_f1d4:
            ...
            ii(0x100e_f1db, 2); jmp(0x100e_f1e3, 0x6); goto l_0x100e_f1e3; /* jmp 0x100ef1e3 */
        l_0x100e_f1dd:
        ...
        l_0x100e_f1e3:
            ...
            ii(0x100e_f219, 2); if(jle(0x100e_f21d, 0x2)) goto l_0x100e_f21d; /* jle 0x100ef21d */
        l_0x100e_f21b:
        ...
        l_0x100e_f21d:
            ...
            ii(0x100e_f232, 4); mov(memb[ss, ebp - 0x24], 0x1);         /* mov byte [ebp-0x24], 0x1 */
        ...
        l_0x100e_f23d:
            ...
            ii(0x100e_f24e, 2); jmp(0x100e_f256, 0x6); goto l_0x100e_f256; /* jmp 0x100ef256 */
        l_0x100e_f250:
        ...
        l_0x100e_f256:
            ...
            ii(0x100e_f288, 2); if(jz(0x100e_f28c, 0x2)) goto l_0x100e_f28c; /* jz 0x100ef28c */
        l_0x100e_f28a:
        ...
        l_0x100e_f28c:
            ...
            ii(0x100e_f2b2, 2); if(jz(0x100e_f2ba, 0x6)) goto l_0x100e_f2ba; /* jz 0x100ef2ba */
            ii(0x100e_f2b4, 4); mov(memb[ss, ebp - 0x24], 0x1);         /* mov byte [ebp-0x24], 0x1 */
        ...
        l_0x100e_f2ba:
            ...
            ii(0x100e_f2cc, 7); mov(memb[ds, eax + 0x101c_a490], 0x4);  /* mov byte [eax+0x101ca490], 0x4 */
        l_0x100e_f2d3:
