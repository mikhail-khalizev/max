...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_48cc()
        {
            ...
            ii(0x1014_48e4, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1014_48e7, 4); or(memb[ss, ebp - 12], 1);              /* or byte [ebp-0xc], 0x1 */
            ii(0x1014_48eb, 6); lea(eax, memd[ss, ebp - 432]);          /* lea eax, [ebp-0x1b0] */
            ii(0x1014_48f1, 5); call(0x1014_4da8, 0x4b2);               /* call 0x10144da8 */
            ii(0x1014_48f6, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1014_48f9, 4); and(memb[ss, ebp - 12], -2 /* 0xfe */); /* and byte [ebp-0xc], 0xfe */
            ii(0x1014_48fd, 4); mov(memb[ss, ebp - 8], 0);              /* mov byte [ebp-0x8], 0x0 */
            ii(0x1014_4901, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1014_4904, 6); lea(eax, memd[ss, ebp - 432]);          /* lea eax, [ebp-0x1b0] */
            ...
            ii(0x1014_4915, 6); lea(eax, memd[ss, ebp - 432]);          /* lea eax, [ebp-0x1b0] */
        ...
        l_0x1014_4925:
            ii(0x1014_4925, 7); mov(memd[ss, ebp - 16], 0);             /* mov dword [ebp-0x10], 0x0 */
        l_0x1014_492c:
            ii(0x1014_492c, 4); cmp(memd[ss, ebp - 16], 0);             /* cmp dword [ebp-0x10], 0x0 */
            ...
            ii(0x1014_493b, 6); mov(memd[ss, ebp - 436], eax);          /* mov [ebp-0x1b4], eax */
            ii(0x1014_4941, 7); cmp(memd[ss, ebp - 436], 0);            /* cmp dword [ebp-0x1b4], 0x0 */
            ii(0x1014_4948, 2); if(jle(0x1014_4956, 0xc)) goto l_0x1014_4956; /* jle 0x10144956 */
            ii(0x1014_494a, 10); cmp(memd[ss, ebp - 436], 0x7000);      /* cmp dword [ebp-0x1b4], 0x7000 */
            ii(0x1014_4954, 2); if(jl(0x1014_4958, 2)) goto l_0x1014_4958; /* jl 0x10144958 */
        l_0x1014_4956:
            ii(0x1014_4956, 2); jmp(0x1014_495c, 4); goto l_0x1014_495c; /* jmp 0x1014495c */
        l_0x1014_4958:
            ii(0x1014_4958, 4); mov(memb[ss, ebp - 8], 0);              /* mov byte [ebp-0x8], 0x0 */
        l_0x1014_495c:
            ii(0x1014_495c, 7); cmp(memb[ds, 0x101c_37d2], 0);          /* cmp byte [0x101c37d2], 0x0 */
            ii(0x1014_4963, 2); if(jnz(0x1014_496e, 9)) goto l_0x1014_496e; /* jnz 0x1014496e */
            ii(0x1014_4965, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1014_4968, 4); cmp(memb[ds, eax + 61], 0x1a);          /* cmp byte [eax+0x3d], 0x1a */
            ii(0x1014_496c, 2); if(jnz(0x1014_4978, 0xa)) goto l_0x1014_4978; /* jnz 0x10144978 */
        l_0x1014_496e:
            ii(0x1014_496e, 10); mov(memd[ss, ebp - 436], 0xd);         /* mov dword [ebp-0x1b4], 0xd */
        l_0x1014_4978:
            ii(0x1014_4978, 6); mov(eax, memd[ss, ebp - 436]);          /* mov eax, [ebp-0x1b4] */
            ii(0x1014_497e, 6); mov(memd[ss, ebp - 440], eax);          /* mov [ebp-0x1b8], eax */
        ...
        l_0x1014_49ad:
            ii(0x1014_49ad, 7); mov(memd[ss, ebp - 16], 1);             /* mov dword [ebp-0x10], 0x1 */
            ii(0x1014_49b4, 5); jmp(0x1014_4c9f, 0x2e6); goto l_0x1014_4c9f; /* jmp 0x10144c9f */
        l_0x1014_49b9:
            ii(0x1014_49b9, 5); cmp(memw[ss, ebp - 84], 0);             /* cmp word [ebp-0x54], 0x0 */
            ii(0x1014_49be, 2); if(jz(0x1014_49c9, 9)) goto l_0x1014_49c9; /* jz 0x101449c9 */
            ii(0x1014_49c0, 3); mov(eax, memd[ss, ebp - 92]);           /* mov eax, [ebp-0x5c] */
            ii(0x1014_49c3, 4); cmp(ax, memw[ss, ebp - 80]);            /* cmp ax, [ebp-0x50] */
            ii(0x1014_49c7, 2); if(jl(0x1014_49cb, 2)) goto l_0x1014_49cb; /* jl 0x101449cb */
        l_0x1014_49c9:
            ii(0x1014_49c9, 2); jmp(0x1014_49f7, 0x2c); goto l_0x1014_49f7; /* jmp 0x101449f7 */
        l_0x1014_49cb:
            ii(0x1014_49cb, 5); mov(ecx, 0x80);                         /* mov ecx, 0x80 */
            ii(0x1014_49d0, 5); mov(ebx, 1);                            /* mov ebx, 0x1 */
            ii(0x1014_49d5, 5); mov(edx, 0x80);                         /* mov edx, 0x80 */
            ii(0x1014_49da, 6); lea(eax, memd[ss, ebp - 354]);          /* lea eax, [ebp-0x162] */
            ...
            ii(0x1014_49ec, 6); lea(eax, memd[ss, ebp - 432]);          /* lea eax, [ebp-0x1b0] */
        ...
        l_0x1014_49fc:
            ii(0x1014_49fc, 5); cmp(memw[ss, ebp - 92], 0);             /* cmp word [ebp-0x5c], 0x0 */
            ii(0x1014_4a01, 2); if(jz(0x1014_4a2d, 0x2a)) goto l_0x1014_4a2d; /* jz 0x10144a2d */
            ii(0x1014_4a03, 5); mov(ebx, 1);                            /* mov ebx, 0x1 */
            ii(0x1014_4a08, 5); mov(edx, 0x80);                         /* mov edx, 0x80 */
            ii(0x1014_4a0d, 6); lea(eax, memd[ss, ebp - 354]);          /* lea eax, [ebp-0x162] */
            ...
            ii(0x1014_4a22, 6); lea(eax, memd[ss, ebp - 432]);          /* lea eax, [ebp-0x1b0] */
        ...
        l_0x1014_4a32:
            ii(0x1014_4a32, 6); lea(eax, memd[ss, ebp - 432]);          /* lea eax, [ebp-0x1b0] */
        ...
        l_0x1014_4a42:
            ii(0x1014_4a42, 5); cmp(memw[ss, ebp - 84], 0);             /* cmp word [ebp-0x54], 0x0 */
            ii(0x1014_4a47, 2); if(jz(0x1014_4a52, 9)) goto l_0x1014_4a52; /* jz 0x10144a52 */
            ii(0x1014_4a49, 3); mov(eax, memd[ss, ebp - 90]);           /* mov eax, [ebp-0x5a] */
            ii(0x1014_4a4c, 4); cmp(ax, memw[ss, ebp - 78]);            /* cmp ax, [ebp-0x4e] */
            ii(0x1014_4a50, 2); if(jl(0x1014_4a54, 2)) goto l_0x1014_4a54; /* jl 0x10144a54 */
        l_0x1014_4a52:
            ii(0x1014_4a52, 2); jmp(0x1014_4a80, 0x2c); goto l_0x1014_4a80; /* jmp 0x10144a80 */
        l_0x1014_4a54:
            ii(0x1014_4a54, 5); mov(ecx, 0x20);                         /* mov ecx, 0x20 */
            ii(0x1014_4a59, 5); mov(ebx, 1);                            /* mov ebx, 0x1 */
            ii(0x1014_4a5e, 5); mov(edx, 0x20);                         /* mov edx, 0x20 */
            ii(0x1014_4a63, 6); lea(eax, memd[ss, ebp - 354]);          /* lea eax, [ebp-0x162] */
            ...
            ii(0x1014_4a75, 6); lea(eax, memd[ss, ebp - 432]);          /* lea eax, [ebp-0x1b0] */
        ...
        l_0x1014_4a85:
            ii(0x1014_4a85, 5); cmp(memw[ss, ebp - 90], 0);             /* cmp word [ebp-0x5a], 0x0 */
            ii(0x1014_4a8a, 2); if(jz(0x1014_4ab6, 0x2a)) goto l_0x1014_4ab6; /* jz 0x10144ab6 */
            ii(0x1014_4a8c, 5); mov(ebx, 1);                            /* mov ebx, 0x1 */
            ii(0x1014_4a91, 5); mov(edx, 0x20);                         /* mov edx, 0x20 */
            ii(0x1014_4a96, 6); lea(eax, memd[ss, ebp - 354]);          /* lea eax, [ebp-0x162] */
            ...
            ii(0x1014_4aab, 6); lea(eax, memd[ss, ebp - 432]);          /* lea eax, [ebp-0x1b0] */
        ...
        l_0x1014_4abb:
            ii(0x1014_4abb, 6); lea(eax, memd[ss, ebp - 432]);          /* lea eax, [ebp-0x1b0] */
        ...
        l_0x1014_4acb:
            ii(0x1014_4acb, 5); cmp(memw[ss, ebp - 84], 0);             /* cmp word [ebp-0x54], 0x0 */
            ii(0x1014_4ad0, 2); if(jz(0x1014_4adb, 9)) goto l_0x1014_4adb; /* jz 0x10144adb */
            ii(0x1014_4ad2, 3); mov(eax, memd[ss, ebp - 94]);           /* mov eax, [ebp-0x5e] */
            ii(0x1014_4ad5, 4); cmp(ax, memw[ss, ebp - 82]);            /* cmp ax, [ebp-0x52] */
            ii(0x1014_4ad9, 2); if(jl(0x1014_4add, 2)) goto l_0x1014_4add; /* jl 0x10144add */
        l_0x1014_4adb:
            ii(0x1014_4adb, 2); jmp(0x1014_4b09, 0x2c); goto l_0x1014_4b09; /* jmp 0x10144b09 */
        l_0x1014_4add:
            ii(0x1014_4add, 5); mov(ecx, 0x40);                         /* mov ecx, 0x40 */
            ii(0x1014_4ae2, 5); mov(ebx, 1);                            /* mov ebx, 0x1 */
            ii(0x1014_4ae7, 5); mov(edx, 0x40);                         /* mov edx, 0x40 */
            ii(0x1014_4aec, 6); lea(eax, memd[ss, ebp - 354]);          /* lea eax, [ebp-0x162] */
            ...
            ii(0x1014_4afe, 6); lea(eax, memd[ss, ebp - 432]);          /* lea eax, [ebp-0x1b0] */
        ...
        l_0x1014_4b0e:
            ii(0x1014_4b0e, 5); cmp(memw[ss, ebp - 94], 0);             /* cmp word [ebp-0x5e], 0x0 */
            ii(0x1014_4b13, 2); if(jz(0x1014_4b3f, 0x2a)) goto l_0x1014_4b3f; /* jz 0x10144b3f */
            ii(0x1014_4b15, 5); mov(ebx, 1);                            /* mov ebx, 0x1 */
            ii(0x1014_4b1a, 5); mov(edx, 0x40);                         /* mov edx, 0x40 */
            ii(0x1014_4b1f, 6); lea(eax, memd[ss, ebp - 354]);          /* lea eax, [ebp-0x162] */
            ...
            ii(0x1014_4b34, 6); lea(eax, memd[ss, ebp - 432]);          /* lea eax, [ebp-0x1b0] */
        ...
        l_0x1014_4b44:
            ii(0x1014_4b44, 6); lea(eax, memd[ss, ebp - 432]);          /* lea eax, [ebp-0x1b0] */
        ...
        l_0x1014_4b54:
            ii(0x1014_4b54, 10); cmp(memd[ss, ebp - 436], 0x7000);      /* cmp dword [ebp-0x1b4], 0x7000 */
            ii(0x1014_4b5e, 2); if(jl(0x1014_4b89, 0x29)) goto l_0x1014_4b89; /* jl 0x10144b89 */
            ii(0x1014_4b60, 10); add(memd[ss, ebp - 436], 0xffff_9000); /* add dword [ebp-0x1b4], 0xffff9000 */
            ii(0x1014_4b6a, 4); cmp(memb[ss, ebp - 8], 0);              /* cmp byte [ebp-0x8], 0x0 */
            ii(0x1014_4b6e, 2); if(jnz(0x1014_4b85, 0x15)) goto l_0x1014_4b85; /* jnz 0x10144b85 */
            ii(0x1014_4b70, 6); mov(eax, memd[ss, ebp - 436]);          /* mov eax, [ebp-0x1b4] */
            ii(0x1014_4b76, 3); shl(eax, 2);                            /* shl eax, 0x2 */
            ii(0x1014_4b79, 7); mov(eax, memd[ds, eax + ebp - 398]);    /* mov eax, [eax+ebp-0x18e] */
            ii(0x1014_4b80, 5); call(0x100c_fbbe, -0x7_4fc7);           /* call 0x100cfbbe */
        l_0x1014_4b85:
            ii(0x1014_4b85, 4); mov(memb[ss, ebp - 8], 1);              /* mov byte [ebp-0x8], 0x1 */
        l_0x1014_4b89:
            ii(0x1014_4b89, 5); jmp(0x1014_4c9f, 0x111); goto l_0x1014_4c9f; /* jmp 0x10144c9f */
        l_0x1014_4b8e:
            ii(0x1014_4b8e, 10); cmp(memd[ss, ebp - 440], 0x3ea);       /* cmp dword [ebp-0x1b8], 0x3ea */
            ii(0x1014_4b98, 6); if(jb(0x1014_4c26, 0x88)) goto l_0x1014_4c26; /* jb 0x10144c26 */
            ii(0x1014_4b9e, 10); cmp(memd[ss, ebp - 440], 0x3ea);       /* cmp dword [ebp-0x1b8], 0x3ea */
            ii(0x1014_4ba8, 6); if(jbe(0x1014_49fc, -0x1b2)) goto l_0x1014_49fc; /* jbe 0x101449fc */
            ii(0x1014_4bae, 10); cmp(memd[ss, ebp - 440], 0x3ee);       /* cmp dword [ebp-0x1b8], 0x3ee */
            ii(0x1014_4bb8, 2); if(jb(0x1014_4c00, 0x46)) goto l_0x1014_4c00; /* jb 0x10144c00 */
            ii(0x1014_4bba, 10); cmp(memd[ss, ebp - 440], 0x3ee);       /* cmp dword [ebp-0x1b8], 0x3ee */
            ii(0x1014_4bc4, 6); if(jbe(0x1014_4abb, -0x10f)) goto l_0x1014_4abb; /* jbe 0x10144abb */
            ii(0x1014_4bca, 10); cmp(memd[ss, ebp - 440], 0x3f0);       /* cmp dword [ebp-0x1b8], 0x3f0 */
            ii(0x1014_4bd4, 2); if(jb(0x1014_4bfb, 0x25)) goto l_0x1014_4bfb; /* jb 0x10144bfb */
            ii(0x1014_4bd6, 10); cmp(memd[ss, ebp - 440], 0x3f0);       /* cmp dword [ebp-0x1b8], 0x3f0 */
            ii(0x1014_4be0, 6); if(jbe(0x1014_4b0e, -0xd8)) goto l_0x1014_4b0e; /* jbe 0x10144b0e */
            ii(0x1014_4be6, 10); cmp(memd[ss, ebp - 440], 0x3f1);       /* cmp dword [ebp-0x1b8], 0x3f1 */
        ...
        l_0x1014_4c00:
            ii(0x1014_4c00, 10); cmp(memd[ss, ebp - 440], 0x3ec);       /* cmp dword [ebp-0x1b8], 0x3ec */
            ii(0x1014_4c0a, 2); if(jb(0x1014_4c21, 0x15)) goto l_0x1014_4c21; /* jb 0x10144c21 */
            ii(0x1014_4c0c, 10); cmp(memd[ss, ebp - 440], 0x3ec);       /* cmp dword [ebp-0x1b8], 0x3ec */
        ...
        l_0x1014_4c26:
            ii(0x1014_4c26, 7); cmp(memd[ss, ebp - 440], 0x3f);         /* cmp dword [ebp-0x1b8], 0x3f */
            ii(0x1014_4c2d, 2); if(jb(0x1014_4c72, 0x43)) goto l_0x1014_4c72; /* jb 0x10144c72 */
            ii(0x1014_4c2f, 7); cmp(memd[ss, ebp - 440], 0x3f);         /* cmp dword [ebp-0x1b8], 0x3f */
            ii(0x1014_4c36, 6); if(jbe(0x1014_4993, -0x2a9)) goto l_0x1014_4993; /* jbe 0x10144993 */
            ii(0x1014_4c3c, 10); cmp(memd[ss, ebp - 440], 0x3e8);       /* cmp dword [ebp-0x1b8], 0x3e8 */
            ii(0x1014_4c46, 2); if(jb(0x1014_4c5d, 0x15)) goto l_0x1014_4c5d; /* jb 0x10144c5d */
            ii(0x1014_4c48, 10); cmp(memd[ss, ebp - 440], 0x3e8);       /* cmp dword [ebp-0x1b8], 0x3e8 */
        ...
        l_0x1014_4c5d:
            ii(0x1014_4c5d, 10); cmp(memd[ss, ebp - 440], 0x119);       /* cmp dword [ebp-0x1b8], 0x119 */
        ...
        l_0x1014_4c72:
            ii(0x1014_4c72, 7); cmp(memd[ss, ebp - 440], 0xd);          /* cmp dword [ebp-0x1b8], 0xd */
            ii(0x1014_4c79, 2); if(jb(0x1014_4c9a, 0x1f)) goto l_0x1014_4c9a; /* jb 0x10144c9a */
            ii(0x1014_4c7b, 7); cmp(memd[ss, ebp - 440], 0xd);          /* cmp dword [ebp-0x1b8], 0xd */
            ii(0x1014_4c82, 6); if(jbe(0x1014_49ad, -0x2db)) goto l_0x1014_49ad; /* jbe 0x101449ad */
            ii(0x1014_4c88, 7); cmp(memd[ss, ebp - 440], 0x1b);         /* cmp dword [ebp-0x1b8], 0x1b */
        ...
        l_0x1014_4cb4:
            ii(0x1014_4cb4, 6); lea(eax, memd[ss, ebp - 432]);          /* lea eax, [ebp-0x1b0] */
