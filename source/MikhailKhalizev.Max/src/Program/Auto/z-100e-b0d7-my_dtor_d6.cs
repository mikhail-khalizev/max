...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void my_dtor_d6()
        {
            ...
            ii(0x100e_b0ee, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_b0f1, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100e_b0f4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_b0f7, 5); call(0x100e_b226, 0x12a);               /* call 0x100eb226 */
            ii(0x100e_b0fc, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_b0ff, 3); mov(eax, memd[ds, eax + 0x1b]);         /* mov eax, [eax+0x1b] */
            ii(0x100e_b102, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100e_b105, 4); cmp(memd[ss, ebp - 0x10], 0);           /* cmp dword [ebp-0x10], 0x0 */
            ii(0x100e_b109, 2); if(jz(0x100e_b11f, 0x14)) goto l_0x100e_b11f; /* jz 0x100eb11f */
            ii(0x100e_b10b, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100e_b10d, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x100e_b11a, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100e_b11d, 2); jmp(0x100e_b126, 0x7); goto l_0x100e_b126; /* jmp 0x100eb126 */
        l_0x100e_b11f:
            ii(0x100e_b11f, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
        l_0x100e_b126:
            ii(0x100e_b126, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_b129, 3); mov(eax, memd[ds, eax + 0x23]);         /* mov eax, [eax+0x23] */
            ii(0x100e_b12c, 5); call(Definitions.sys_delete, 0x7_ae33); /* call 0x10165f64 */
            ii(0x100e_b131, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_b134, 3); mov(eax, memd[ds, eax + 0x27]);         /* mov eax, [eax+0x27] */
            ii(0x100e_b137, 5); call(Definitions.sys_delete, 0x7_ae28); /* call 0x10165f64 */
            ii(0x100e_b13c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_b13f, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100e_b142, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
