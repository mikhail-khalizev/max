...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x100e_5e51:
            ...
            ii(0x100e_5e8d, 4); test(memb[ds, eax + 0x14], 1);          /* test byte [eax+0x14], 0x1 */
        ...
        l_0x100e_5ec9:
            ...
            ii(0x100e_5edf, 4); test(memb[ds, eax + 0x12], 2);          /* test byte [eax+0x12], 0x2 */
        ...
        l_0x100e_5f42:
            ...
            ii(0x100e_5f58, 4); test(memb[ds, eax + 0x14], 1);          /* test byte [eax+0x14], 0x1 */
