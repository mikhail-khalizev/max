...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_2600()
        {
            ...
            ii(0x1007_2617, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_261a, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1007_261d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1007_263b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_263e, 5); call(0x1015_03d0, 0xd_dd8d);            /* call 0x101503d0 */
            ii(0x1007_2643, 4); imul(eax, memd[ss, ebp - 0x4]);         /* imul eax, [ebp-0x4] */
            ii(0x1007_2647, 4); add(memw[ds, edx + 0x8], ax);           /* add [edx+0x8], ax */
            ...
            ii(0x1007_2655, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_2658, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x1007_265b, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1007_265e, 5); call(0x1007_1ec5, -0x79e);              /* call 0x10071ec5 */
            ii(0x1007_2663, 4); imul(eax, memd[ss, ebp - 0x4]);         /* imul eax, [ebp-0x4] */
            ...
            ii(0x1007_2675, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_2678, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x1007_267b, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1007_267e, 5); call(0x1007_1f2e, -0x755);              /* call 0x10071f2e */
            ii(0x1007_2683, 4); imul(eax, memd[ss, ebp - 0x4]);         /* imul eax, [ebp-0x4] */
            ...
            ii(0x1007_2695, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_2698, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x1007_269b, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1007_269e, 5); call(0x1007_1ff5, -0x6ae);              /* call 0x10071ff5 */
            ii(0x1007_26a3, 4); imul(eax, memd[ss, ebp - 0x4]);         /* imul eax, [ebp-0x4] */
            ...
            ii(0x1007_26b5, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_26b8, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ii(0x1007_26bb, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1007_26be, 5); call(0x1007_2073, -0x650);              /* call 0x10072073 */
            ii(0x1007_26c3, 4); imul(eax, memd[ss, ebp - 0x4]);         /* imul eax, [ebp-0x4] */
