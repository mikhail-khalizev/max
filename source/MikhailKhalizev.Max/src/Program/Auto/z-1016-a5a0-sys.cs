...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_a5a0()
        {
            ...
            ii(0x1016_a5a6, 4); mov(memd[ss, esp + 0x4], eax);          /* mov [esp+0x4], eax */
            ...
            ii(0x1016_a5bc, 7); lea(esi, memd[ds, eax * 2 + 0]);        /* lea esi, [eax*2] */
            ii(0x1016_a5c3, 2); test(ebx, ebx);                         /* test ebx, ebx */
            ii(0x1016_a5c5, 2); if(jge(0x1016_a5ce, 0x7)) goto l_0x1016_a5ce; /* jge 0x1016a5ce */
            ii(0x1016_a5c7, 5); mov(eax, 0xffff_ffff);                  /* mov eax, 0xffffffff */
            ii(0x1016_a5cc, 2); jmp(0x1016_a5d6, 0x8); goto l_0x1016_a5d6; /* jmp 0x1016a5d6 */
        l_0x1016_a5ce:
        ...
        l_0x1016_a5d6:
            ...
            ii(0x1016_a5e7, 7); lea(edi, memd[ds, eax * 2 + 0]);        /* lea edi, [eax*2] */
            ii(0x1016_a5ee, 2); test(ebx, ebx);                         /* test ebx, ebx */
            ii(0x1016_a5f0, 2); if(jge(0x1016_a5f9, 0x7)) goto l_0x1016_a5f9; /* jge 0x1016a5f9 */
            ii(0x1016_a5f2, 5); mov(eax, 0xffff_ffff);                  /* mov eax, 0xffffffff */
            ii(0x1016_a5f7, 2); jmp(0x1016_a601, 0x8); goto l_0x1016_a601; /* jmp 0x1016a601 */
        l_0x1016_a5f9:
            ii(0x1016_a5f9, 3); setg(al);                               /* setg al */
            ii(0x1016_a5fc, 5); and(eax, 0xff);                         /* and eax, 0xff */
        l_0x1016_a601:
            ii(0x1016_a601, 4); mov(memd[ss, esp + 0x8], eax);          /* mov [esp+0x8], eax */
        ...
        l_0x1016_a617:
            ...
            ii(0x1016_a61d, 4); mov(ecx, memd[ss, esp + 0x4]);          /* mov ecx, [esp+0x4] */
            ...
            ii(0x1016_a629, 3); mov(memb[ss, ebp + 0], cl);             /* mov [ebp], cl */
            ...
            ii(0x1016_a634, 2); if(jl(0x1016_a63e, 0x8)) goto l_0x1016_a63e; /* jl 0x1016a63e */
            ii(0x1016_a636, 4); mov(ecx, memd[ss, esp + 0x8]);          /* mov ecx, [esp+0x8] */
        ...
        l_0x1016_a652:
            ...
            ii(0x1016_a658, 4); mov(ecx, memd[ss, esp + 0x4]);          /* mov ecx, [esp+0x4] */
            ...
            ii(0x1016_a664, 3); mov(memb[ss, ebp + 0], cl);             /* mov [ebp], cl */
            ...
            ii(0x1016_a66f, 2); if(jl(0x1016_a679, 0x8)) goto l_0x1016_a679; /* jl 0x1016a679 */
        ...
        l_0x1016_a679:
            ii(0x1016_a679, 4); mov(ebp, memd[ss, esp + 0x8]);          /* mov ebp, [esp+0x8] */
