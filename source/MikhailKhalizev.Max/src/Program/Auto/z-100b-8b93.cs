...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_8b93()
        {
            ...
            ii(0x100b_8baa, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100b_8bad, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x100b_8bb0, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100b_8bb3, 3); mov(edx, memd[ds, eax + 5]);            /* mov edx, [eax+0x5] */
            ii(0x100b_8bb6, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100b_8bb9, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100b_8bbc, 5); call(0x1011_d8e9, 0x6_4d28);            /* call 0x1011d8e9 */
            ii(0x100b_8bc1, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100b_8bc4, 3); add(eax, 9);                            /* add eax, 0x9 */
            ii(0x100b_8bc7, 5); call(0x100a_b33c, -0xd890);             /* call 0x100ab33c */
            ii(0x100b_8bcc, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x100b_8bce, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x100b_8bd1, 3); add(edx, 0xd);                          /* add edx, 0xd */
            ii(0x100b_8bd4, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x100b_8bd7, 5); call(0x1007_5e64, -0x4_2d78);           /* call 0x10075e64 */
            ii(0x100b_8bdc, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100b_8bde, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
