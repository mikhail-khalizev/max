...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x19_d9ad, 4);  mov(ebx, memd[ss, bp + 10]);            /* mov ebx, [bp+0xa] */
            ii(0x19_d9b1, 5);  movzx(ecx, memw[ss, bp + 14]);          /* movzx ecx, word [bp+0xe] */
            ii(0x19_d9b6, 1);  push(es);                               /* push es */
            ii(0x19_d9b7, 2);  push(esi);                              /* push esi */
            ii(0x19_d9b9, 4);  mov(esi, memd[ss, bp + 6]);             /* mov esi, [bp+0x6] */
            ii(0x19_d9bd, 3);  les(dx, memw[ss, bp + 16]);             /* les dx, [bp+0x10] */
