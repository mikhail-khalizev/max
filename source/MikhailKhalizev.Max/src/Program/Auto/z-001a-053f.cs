...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_001a_053f()
        {
            ...
            ii(0x1a_054b, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ii(0x1a_054e, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ...
            ii(0x1a_0560, 3); push(memw[ss, bp + 0xe]);                 /* push word [bp+0xe] */
            ii(0x1a_0563, 3); push(memw[ss, bp + 0xc]);                 /* push word [bp+0xc] */
            ii(0x1a_0566, 3); push(memw[ss, bp + 0xa]);                 /* push word [bp+0xa] */
            ii(0x1a_0569, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x1a_056c, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
        ...
        l_0x1a_0579:
            ...
            ii(0x1a_0582, 3); lea(ax, memw[ss, bp - 0x4]);              /* lea ax, [bp-0x4] */
            ii(0x1a_0585, 1); push(ss);                                 /* push ss */
            ii(0x1a_0586, 1); push(ax);                                 /* push ax */
            ii(0x1a_0587, 3); push(memw[ss, bp + 0xa]);                 /* push word [bp+0xa] */
            ii(0x1a_058a, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x1a_058d, 3); push(memw[ss, bp + 0xe]);                 /* push word [bp+0xe] */
            ii(0x1a_0590, 3); push(memw[ss, bp + 0xc]);                 /* push word [bp+0xc] */
            ii(0x1a_0593, 4); call_far_ind(ds, 0x32a8);                 /* call far word [0x32a8] */
            ii(0x1a_0597, 3); add(sp, 0xc);                             /* add sp, 0xc */
            ii(0x1a_059a, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0x1a_059d, 3); mov(dx, memw[ss, bp - 0x2]);              /* mov dx, [bp-0x2] */
            ii(0x1a_05a0, 2); jmp(0x1a_0605, 0x63); goto l_0x1a_0605;   /* jmp 0x605 */
        l_0x1a_05a2:
            ii(0x1a_05a2, 3); push(memw[ss, bp + 0xe]);                 /* push word [bp+0xe] */
            ii(0x1a_05a5, 3); push(memw[ss, bp + 0xc]);                 /* push word [bp+0xc] */
            ii(0x1a_05a8, 1); push(cs);                                 /* push cs */
            ii(0x1a_05a9, 3); call(0x1a_0409, -0x1a3);                  /* call 0x409 */
            ii(0x1a_05ac, 4); mov(memw[ss, bp - 0x88], ax);             /* mov [bp-0x88], ax */
            ii(0x1a_05b0, 4); mov(memw[ss, bp - 0x86], dx);             /* mov [bp-0x86], dx */
            ii(0x1a_05b4, 2); or(dx, ax);                               /* or dx, ax */
            ii(0x1a_05b6, 2); if(jz(0x1a_0602, 0x4a)) goto l_0x1a_0602; /* jz 0x602 */
            ii(0x1a_05b8, 4); lea(ax, memw[ss, bp - 0x84]);             /* lea ax, [bp-0x84] */
            ii(0x1a_05bc, 1); push(ss);                                 /* push ss */
            ii(0x1a_05bd, 1); push(ax);                                 /* push ax */
            ii(0x1a_05be, 4); push(memw[ss, bp - 0x86]);                /* push word [bp-0x86] */
            ii(0x1a_05c2, 4); push(memw[ss, bp - 0x88]);                /* push word [bp-0x88] */
            ...
            ii(0x1a_05d2, 4); lea(ax, memw[ss, bp - 0xa8]);             /* lea ax, [bp-0xa8] */
            ii(0x1a_05d6, 1); push(ss);                                 /* push ss */
            ii(0x1a_05d7, 1); push(ax);                                 /* push ax */
            ii(0x1a_05d8, 3); push(memw[ss, bp + 0xa]);                 /* push word [bp+0xa] */
            ii(0x1a_05db, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ...
            ii(0x1a_05ea, 4); lea(ax, memw[ss, bp - 0x84]);             /* lea ax, [bp-0x84] */
            ii(0x1a_05ee, 1); push(ss);                                 /* push ss */
            ii(0x1a_05ef, 1); push(ax);                                 /* push ax */
            ii(0x1a_05f0, 4); lea(ax, memw[ss, bp - 0xa8]);             /* lea ax, [bp-0xa8] */
            ...
            ii(0x1a_05fb, 2); if(jz(0x1a_0602, 0x5)) goto l_0x1a_0602;  /* jz 0x602 */
            ii(0x1a_05fd, 3); mov(ax, 0x1);                             /* mov ax, 0x1 */
            ii(0x1a_0600, 2); jmp(0x1a_0604, 0x2); goto l_0x1a_0604;    /* jmp 0x604 */
        l_0x1a_0602:
