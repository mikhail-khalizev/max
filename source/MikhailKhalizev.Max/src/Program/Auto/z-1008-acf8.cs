...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_acf8()
        {
            ...
            ii(0x1008_ad10, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_ad13, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_ad16, 3); mov(al, memb[ds, eax + 0x7]);           /* mov al, [eax+0x7] */
            ii(0x1008_ad19, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x1008_ad1c, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
