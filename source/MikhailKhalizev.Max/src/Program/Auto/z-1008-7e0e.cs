...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_7e0e()
        {
            ...
            ii(0x1008_7e20, 6); sub(esp, 4);                            /* sub esp, 0x4 */
            ii(0x1008_7e26, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1008_7e29, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1008_7e2c, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_7e3c, 5); mov(edx, 1);                            /* mov edx, 0x1 */
            ii(0x1008_7e41, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
