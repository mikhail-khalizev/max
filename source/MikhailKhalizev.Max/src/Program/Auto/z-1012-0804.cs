...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("70773673-feeb-42cd-82ae-96933566d806")]
        public void Method_1012_0804()
        {
            ii(0x1012_0804, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x1012_0809, 5); calld(Definitions.sys_check_available_stack_size, 0x45544); /* call 0x10165d52 */
            ...
            ii(0x1012_0827, 5); calld(0x1013_a5af, 0x19d83);            /* call 0x1013a5af */
            ...
            ii(0x1012_0833, 1); retd(); return;                         /* ret */
        }
    }
}
