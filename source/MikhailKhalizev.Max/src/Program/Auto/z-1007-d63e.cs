...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_d63e()
        {
            ...
            ii(0x1007_d65b, 7);  mov(memd[ss, ebp - 12], 0);           /* mov dword [ebp-0xc], 0x0 */
            ii(0x1007_d662, 2);  jmp(0x1007_d66a, 6); goto l_0x1007_d66a;/* jmp 0x1007d66a */
        l_0x1007_d664:
            ii(0x1007_d664, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1007_d667, 3);  inc(memd[ss, ebp - 12]);              /* inc dword [ebp-0xc] */
        l_0x1007_d66a:
            ...
            ii(0x1007_d675, 4);  cmp(ax, memw[ss, ebp - 12]);          /* cmp ax, [ebp-0xc] */
            ii(0x1007_d679, 2);  if(jle(0x1007_d6b3, 0x38)) goto l_0x1007_d6b3;/* jle 0x1007d6b3 */
            ii(0x1007_d67b, 4);  movsx(edx, memw[ss, ebp - 12]);       /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x1007_d692, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1007_d695, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x1007_d6a5, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
