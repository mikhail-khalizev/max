...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_8d56()
        {
            ...
            ii(0x8d5c, 3);    cmp(memw[ss, bp + 0x4], ax);              /* cmp [bp+0x4], ax */
            ii(0x8d5f, 2);    if(jae(0x8d75, 0x14)) goto l_0x8d75;      /* jae 0x8d75 */
            ii(0x8d61, 3);    push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x8d64, 2);    push(-0x1 /* 0xff */);                    /* push 0xffff */
            ii(0x8d66, 2);    push(0);                                  /* push 0x0 */
            ii(0x8d68, 3);    push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ii(0x8d6b, 3);    mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
