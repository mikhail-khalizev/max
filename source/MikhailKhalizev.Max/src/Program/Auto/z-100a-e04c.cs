...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_e04c()
        {
            ...
            ii(0x100a_e064, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_e067, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_e06a, 4); cmp(memb[ds, eax + 0x46], 0);           /* cmp byte [eax+0x46], 0x0 */
            ii(0x100a_e06e, 2); if(jz(0x100a_e07c, 0xc)) goto l_0x100a_e07c; /* jz 0x100ae07c */
            ii(0x100a_e070, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_e072, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100a_e07c:
            ii(0x100a_e07c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_e07f, 4); cmp(memb[ds, eax + 0x47], 0);           /* cmp byte [eax+0x47], 0x0 */
            ii(0x100a_e083, 2); if(jnz(0x100a_e094, 0xf)) goto l_0x100a_e094; /* jnz 0x100ae094 */
            ii(0x100a_e085, 5); mov(edx, 0x2);                          /* mov edx, 0x2 */
            ii(0x100a_e08a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100a_e094:
            ii(0x100a_e094, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_e097, 3); add(eax, 0x2c);                         /* add eax, 0x2c */
            ii(0x100a_e09a, 5); call(0x1009_cb94, -0x1_150b);           /* call 0x1009cb94 */
            ii(0x100a_e09f, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100a_e0a2, 3); add(edx, 0x22);                         /* add edx, 0x22 */
            ii(0x100a_e0a5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_e0a8, 3); add(eax, 0x1e);                         /* add eax, 0x1e */
            ii(0x100a_e0ab, 5); call(0x1008_8b44, -0x2_556c);           /* call 0x10088b44 */
            ii(0x100a_e0b0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_e0b3, 6); mov(memw[ds, eax + 0x26], 0xffff);      /* mov word [eax+0x26], 0xffff */
            ii(0x100a_e0b9, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_e0bb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
