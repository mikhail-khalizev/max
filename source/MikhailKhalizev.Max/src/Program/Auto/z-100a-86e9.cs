...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_86e9()
        {
            ...
            ii(0x100a_8701, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_8704, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_8707, 3); mov(eax, memd[ds, eax + 0x10]);         /* mov eax, [eax+0x10] */
            ...
            ii(0x100a_8711, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_8714, 3); mov(eax, memd[ds, eax + 0x10]);         /* mov eax, [eax+0x10] */
            ii(0x100a_8717, 3); sar(eax, 0x18);                         /* sar eax, 0x18 */
            ii(0x100a_871a, 3); cmp(eax, 0x4);                          /* cmp eax, 0x4 */
            ii(0x100a_871d, 2); if(jnz(0x100a_8721, 0x2)) goto l_0x100a_8721; /* jnz 0x100a8721 */
        l_0x100a_871f:
            ii(0x100a_871f, 2); jmp(0x100a_8727, 0x6); goto l_0x100a_8727; /* jmp 0x100a8727 */
        l_0x100a_8721:
            ii(0x100a_8721, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x100a_8725, 2); jmp(0x100a_872b, 0x4); goto l_0x100a_872b; /* jmp 0x100a872b */
        l_0x100a_8727:
            ii(0x100a_8727, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x100a_872b:
            ii(0x100a_872b, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x100a_872e, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x100a_8731, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
