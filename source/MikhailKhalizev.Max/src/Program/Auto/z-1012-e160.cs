...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_e160()
        {
            ...
            ii(0x1012_e178, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1012_e17b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_e17e, 3); add(eax, 0x18);                         /* add eax, 0x18 */
            ii(0x1012_e181, 5); call(Definitions.my_1_get_count, -0x8_2cae); /* call 0x100ab4d8 */
            ii(0x1012_e186, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x1012_e189:
            ii(0x1012_e189, 3); dec(memd[ss, ebp - 0x8]);               /* dec dword [ebp-0x8] */
            ii(0x1012_e18c, 5); cmp(memw[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp word [ebp-0x8], 0xffff */
            ...
            ii(0x1012_e198, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1012_e19c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1012_e1b0, 2); if(jz(0x1012_e1ba, 0x8)) goto l_0x1012_e1ba; /* jz 0x1012e1ba */
            ii(0x1012_e1b2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_e1b5, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1012_e1b8, 2); jmp(0x1012_e1c3, 0x9); goto l_0x1012_e1c3; /* jmp 0x1012e1c3 */
        l_0x1012_e1ba:
