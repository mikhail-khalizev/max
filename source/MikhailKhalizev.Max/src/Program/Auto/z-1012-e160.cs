...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("a48523f1-c8b1-4a54-98d6-66e1954d3616")]
        public void Method_1012_e160()
        {
            ii(0x1012_e160, 5); pushd(0x28);                            /* push 0x28 */
            ii(0x1012_e165, 5); calld(Definitions.sys_check_available_stack_size, 0x37be8); /* call 0x10165d52 */
            ...
            ii(0x1012_e181, 5); calld(Definitions.my_1_get_count, -0x82cae); /* call 0x100ab4d8 */
        ...
        l_0x1012_e189:
            ...
            ii(0x1012_e1a2, 5); calld(0x100e_8634, -0x45b73);           /* call 0x100e8634 */
            ii(0x1012_e1a7, 2); mov(edx, ebx);                          /* mov edx, ebx */
            ii(0x1012_e1a9, 5); calld(0x1007_6d98, -0xb7416);           /* call 0x10076d98 */
        ...
        l_0x1012_e1c3:
            ...
            ii(0x1012_e1ce, 1); retd(); return;                         /* ret */
        }
    }
}
