...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_9f38()
        {
            ...
            ii(0x100a_9f4f, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100a_9f52, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x100a_9f55, 5); mov(edx, 1);                            /* mov edx, 0x1 */
            ii(0x100a_9f5a, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100a_9f5d, 5); call(Definitions.my_dtor_0x101b_6edc, 0x9_0ce3); /* call 0x1013ac45 */
            ii(0x100a_9f62, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100a_9f65, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100a_9f68, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100a_9f6b, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
