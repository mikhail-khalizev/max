...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0xddaa:
            ...
            ii(0xddb2, 3);    mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0xddb5, 3);    mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
            ii(0xddb8, 4);    cmp(dx, memw[ds, 0x9e]);                  /* cmp dx, [0x9e] */
            ii(0xddbc, 2);    if(ja(0xddd4, 0x16)) goto l_0xddd4;       /* ja 0xddd4 */
            ii(0xddbe, 2);    if(jb(0xddc6, 0x6)) goto l_0xddc6;        /* jb 0xddc6 */
            ii(0xddc0, 4);    cmp(ax, memw[ds, 0x9c]);                  /* cmp ax, [0x9c] */
            ii(0xddc4, 2);    if(jae(0xddd4, 0xe)) goto l_0xddd4;       /* jae 0xddd4 */
        l_0xddc6:
            ii(0xddc6, 4);    cmp(memw[ss, bp + 0x6], 0);               /* cmp word [bp+0x6], 0x0 */
            ii(0xddca, 2);    if(jg(0xddd9, 0xd)) goto l_0xddd9;        /* jg 0xddd9 */
            ii(0xddcc, 2);    if(jl(0xddd4, 0x6)) goto l_0xddd4;        /* jl 0xddd4 */
            ii(0xddce, 4);    cmp(memw[ss, bp + 0x4], 0);               /* cmp word [bp+0x4], 0x0 */
            ii(0xddd2, 2);    if(jnz(0xddd9, 0x5)) goto l_0xddd9;       /* jnz 0xddd9 */
        l_0xddd4:
        ...
        l_0xddd9:
            ...
            ii(0xdddb, 3);    push(memw[ss, bp - 0x6]);                 /* push word [bp-0x6] */
            ii(0xddde, 3);    push(memw[ss, bp - 0x8]);                 /* push word [bp-0x8] */
            ii(0xdde1, 3);    call(0xfb11, 0x1d2d);                     /* call 0xfb11 */
            ii(0xdde4, 3);    add(sp, 0x6);                             /* add sp, 0x6 */
            ii(0xdde7, 3);    mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0xddea, 3);    mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
        l_0xdded:
            ii(0xdded, 3);    mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0xddf0, 3);    or(ax, memw[ss, bp - 0x4]);               /* or ax, [bp-0x4] */
            ii(0xddf3, 2);    if(jnz(0xddf8, 0x3)) goto l_0xddf8;       /* jnz 0xddf8 */
            ii(0xddf5, 3);    jmp(0xdf55, 0x15d); goto l_0xdf55;        /* jmp 0xdf55 */
        l_0xddf8:
            ii(0xddf8, 2);    push(0x4);                                /* push 0x4 */
            ii(0xddfa, 3);    push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0xddfd, 3);    push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0xde0c, 3);    cmp(dx, memw[ss, bp + 0x6]);              /* cmp dx, [bp+0x6] */
            ii(0xde0f, 2);    if(jge(0xde14, 0x3)) goto l_0xde14;       /* jge 0xde14 */
            ii(0xde11, 3);    jmp(0xdef2, 0xde); goto l_0xdef2;         /* jmp 0xdef2 */
        l_0xde14:
            ii(0xde14, 2);    if(jg(0xde1e, 0x8)) goto l_0xde1e;        /* jg 0xde1e */
            ii(0xde16, 3);    cmp(ax, memw[ss, bp + 0x4]);              /* cmp ax, [bp+0x4] */
            ii(0xde19, 2);    if(jae(0xde1e, 0x3)) goto l_0xde1e;       /* jae 0xde1e */
        ...
        l_0xde1e:
            ...
            ii(0xde2c, 3);    mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
            ii(0xde2f, 3);    mov(dx, memw[ss, bp + 0x6]);              /* mov dx, [bp+0x6] */
            ii(0xde32, 3);    add(ax, memw[ss, bp - 0x4]);              /* add ax, [bp-0x4] */
            ii(0xde35, 3);    adc(dx, memw[ss, bp - 0x2]);              /* adc dx, [bp-0x2] */
            ii(0xde38, 1);    push(dx);                                 /* push dx */
            ii(0xde39, 1);    push(ax);                                 /* push ax */
            ii(0xde3a, 3);    push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0xde3d, 3);    push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0xde4b, 2);    if(jle(0xde51, 0x4)) goto l_0xde51;       /* jle 0xde51 */
            ii(0xde4d, 1);    sti();                                    /* sti */
            ii(0xde4e, 3);    jmp(0xdd9f, -0xb2); goto l_0xdd9f;        /* jmp 0xdd9f */
        l_0xde51:
            ii(0xde51, 2);    or(ax, ax);                               /* or ax, ax */
            ii(0xde53, 2);    if(jge(0xde58, 0x3)) goto l_0xde58;       /* jge 0xde58 */
        ...
        l_0xde58:
            ...
            ii(0xde5e, 3);    cmp(memw[ss, bp + 0x4], ax);              /* cmp [bp+0x4], ax */
            ii(0xde61, 2);    if(jnz(0xde68, 0x5)) goto l_0xde68;       /* jnz 0xde68 */
            ii(0xde63, 3);    cmp(memw[ss, bp + 0x6], dx);              /* cmp [bp+0x6], dx */
            ii(0xde66, 2);    if(jz(0xde9c, 0x34)) goto l_0xde9c;       /* jz 0xde9c */
        l_0xde68:
            ii(0xde68, 3);    sub(ax, memw[ss, bp + 0x4]);              /* sub ax, [bp+0x4] */
            ii(0xde6b, 3);    sbb(dx, memw[ss, bp + 0x6]);              /* sbb dx, [bp+0x6] */
            ii(0xde6e, 1);    push(dx);                                 /* push dx */
            ii(0xde6f, 1);    push(ax);                                 /* push ax */
            ii(0xde70, 2);    push(0x4);                                /* push 0x4 */
            ii(0xde72, 3);    mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
            ii(0xde75, 3);    mov(dx, memw[ss, bp + 0x6]);              /* mov dx, [bp+0x6] */
            ii(0xde78, 3);    add(ax, memw[ss, bp - 0x4]);              /* add ax, [bp-0x4] */
            ii(0xde7b, 3);    adc(dx, memw[ss, bp - 0x2]);              /* adc dx, [bp-0x2] */
            ii(0xde7e, 1);    push(dx);                                 /* push dx */
            ii(0xde7f, 1);    push(ax);                                 /* push ax */
            ii(0xde80, 2);    push(0);                                  /* push 0x0 */
            ii(0xde82, 3);    push(memw[ss, bp - 0x6]);                 /* push word [bp-0x6] */
            ii(0xde85, 3);    push(memw[ss, bp - 0x8]);                 /* push word [bp-0x8] */
            ii(0xde88, 3);    call(0xfb27, 0x1c9c);                     /* call 0xfb27 */
            ii(0xde8b, 3);    add(sp, 0xa);                             /* add sp, 0xa */
            ii(0xde8e, 3);    mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0xde91, 3);    mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
        ...
        l_0xde9c:
            ...
            ii(0xde9e, 3);    push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0xdea1, 3);    push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0xdeae, 3);    push(memw[ss, bp - 0x6]);                 /* push word [bp-0x6] */
            ii(0xdeb1, 3);    push(memw[ss, bp - 0x8]);                 /* push word [bp-0x8] */
            ii(0xdeb4, 3);    call(0xfb27, 0x1c70);                     /* call 0xfb27 */
            ii(0xdeb7, 3);    add(sp, 0xa);                             /* add sp, 0xa */
            ii(0xdeba, 3);    mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0xdebd, 3);    mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
            ii(0xdec0, 2);    or(dx, ax);                               /* or dx, ax */
            ii(0xdec2, 2);    if(jz(0xded5, 0x11)) goto l_0xded5;       /* jz 0xded5 */
            ii(0xdec4, 3);    push(memw[ss, bp - 0x6]);                 /* push word [bp-0x6] */
            ii(0xdec7, 1);    push(ax);                                 /* push ax */
            ii(0xdec8, 3);    call(0xdc8e, -0x23d);                     /* call 0xdc8e */
            ii(0xdecb, 2);    or(ax, ax);                               /* or ax, ax */
            ii(0xdecd, 2);    if(jnz(0xded5, 0x6)) goto l_0xded5;       /* jnz 0xded5 */
            ii(0xdecf, 2);    push(0x1d);                               /* push 0x1d */
            ii(0xded1, 3);    call(0xf985, 0x1ab1);                     /* call 0xf985 */
            ii(0xded4, 1);    pop(bx);                                  /* pop bx */
        l_0xded5:
            ii(0xded5, 3);    mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
            ii(0xded8, 3);    mov(dx, memw[ss, bp + 0x6]);              /* mov dx, [bp+0x6] */
            ...
            ii(0xdee9, 1);    sti();                                    /* sti */
            ii(0xdeea, 3);    mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0xdeed, 3);    mov(dx, memw[ss, bp - 0x2]);              /* mov dx, [bp-0x2] */
        ...
        l_0xdef2:
            ...
            ii(0xdef8, 2);    if(jb(0xdf00, 0x6)) goto l_0xdf00;        /* jb 0xdf00 */
            ii(0xdefa, 4);    cmp(memw[ds, 0x11fa], ax);                /* cmp [0x11fa], ax */
            ii(0xdefe, 2);    if(jae(0xdf07, 0x7)) goto l_0xdf07;       /* jae 0xdf07 */
        l_0xdf00:
        ...
        l_0xdf07:
            ...
            ii(0xdf09, 3);    mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0xdf0c, 3);    mov(dx, memw[ss, bp - 0x2]);              /* mov dx, [bp-0x2] */
            ii(0xdf0f, 3);    mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0xdf12, 3);    mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
            ...
            ii(0xdf1d, 3);    mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0xdf20, 3);    mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0xdf23, 2);    or(dx, ax);                               /* or dx, ax */
            ii(0xdf25, 2);    if(jnz(0xdf2a, 0x3)) goto l_0xdf2a;       /* jnz 0xdf2a */
            ii(0xdf27, 3);    jmp(0xdded, -0x13d); goto l_0xdded;       /* jmp 0xdded */
        l_0xdf2a:
            ii(0xdf2a, 3);    mov(ax, memw[ss, bp - 0x8]);              /* mov ax, [bp-0x8] */
            ii(0xdf2d, 3);    mov(dx, memw[ss, bp - 0x6]);              /* mov dx, [bp-0x6] */
            ii(0xdf30, 3);    cmp(memw[ss, bp - 0x2], dx);              /* cmp [bp-0x2], dx */
            ii(0xdf33, 2);    if(jb(0xdf4c, 0x17)) goto l_0xdf4c;       /* jb 0xdf4c */
            ii(0xdf35, 2);    if(ja(0xdf3c, 0x5)) goto l_0xdf3c;        /* ja 0xdf3c */
            ii(0xdf37, 3);    cmp(memw[ss, bp - 0x4], ax);              /* cmp [bp-0x4], ax */
            ii(0xdf3a, 2);    if(jb(0xdf4c, 0x10)) goto l_0xdf4c;       /* jb 0xdf4c */
        l_0xdf3c:
            ii(0xdf3c, 3);    push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0xdf3f, 3);    push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ii(0xdf42, 3);    call(0xdc8e, -0x2b7);                     /* call 0xdc8e */
            ii(0xdf45, 2);    or(ax, ax);                               /* or ax, ax */
            ii(0xdf47, 2);    if(jz(0xdf4c, 0x3)) goto l_0xdf4c;        /* jz 0xdf4c */
        ...
        l_0xdf55:
            ...
            ii(0xdf5b, 2);    if(jnz(0xdf60, 0x3)) goto l_0xdf60;       /* jnz 0xdf60 */
        ...
        l_0xdf60:
            ...
            ii(0xdf68, 2);    if(jz(0xdf6d, 0x3)) goto l_0xdf6d;        /* jz 0xdf6d */
        ...
        l_0xdf6d:
            ...
            ii(0xdf86, 3);    push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0xdf89, 3);    push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
        ...
        l_0xdfa3:
            ...
            ii(0xdfbc, 2);    if(jz(0xdfc1, 0x3)) goto l_0xdfc1;        /* jz 0xdfc1 */
