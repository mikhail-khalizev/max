...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_5d94()
        {
            ...
            ii(0x1019_5d95, 3); mov(edx, memd[ds, eax + 0x8]);          /* mov edx, [eax+0x8] */
            ii(0x1019_5d98, 2); test(edx, edx);                         /* test edx, edx */
            ii(0x1019_5d9a, 2); if(jz(0x1019_5da0, 0x4)) goto l_0x1019_5da0; /* jz 0x10195da0 */
            ii(0x1019_5d9c, 4); mov(memb[ds, edx + 0x1c], 0x3);         /* mov byte [edx+0x1c], 0x3 */
        l_0x1019_5da0:
            ii(0x1019_5da0, 4); or(memb[ds, eax + 0x4], 0x1);           /* or byte [eax+0x4], 0x1 */
