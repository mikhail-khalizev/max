...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_9572()
        {
            ...
            ii(0x1015_9589, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_958c, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1015_958f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_9592, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1015_9595, 5); mov(eax, 0x1);                          /* mov eax, 0x1 */
            ii(0x1015_959a, 5); call(0x100f_448c, -0x6_5113);           /* call 0x100f448c */
            ii(0x1015_959f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_95a2, 5); call(0x1015_2387, -0x7220);             /* call 0x10152387 */
            ii(0x1015_95a7, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
