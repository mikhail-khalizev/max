...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_ac00()
        {
            ...
            ii(0x100d_ac18, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100d_ac1b, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x100d_ac22, 2); jmp(0x100d_ac2a, 0x6); goto l_0x100d_ac2a; /* jmp 0x100dac2a */
        l_0x100d_ac24:
            ii(0x100d_ac24, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_ac27, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x100d_ac2a:
            ii(0x100d_ac2a, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100d_ac2e, 3); cmp(eax, 0x5d);                         /* cmp eax, 0x5d */
            ii(0x100d_ac31, 6); if(jge(0x100d_ad04, 0xcd)) goto l_0x100d_ad04; /* jge 0x100dad04 */
            ii(0x100d_ac37, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100d_ac3b, 3); shl(edx, 0x2);                          /* shl edx, 0x2 */
            ii(0x100d_ac3e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_ac4f, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100d_ac53, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100d_ac56, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x100d_ac58, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_ac72, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100d_ac76, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100d_ac79, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100d_ac7b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_ac91, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100d_ac95, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100d_ac98, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ...
            ii(0x100d_acad, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100d_acb1, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100d_acb4, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x100d_acc6, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100d_acca, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_accd, 3); mov(eax, memd[ds, eax + 0x49]);         /* mov eax, [eax+0x49] */
            ...
            ii(0x100d_aced, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100d_acf1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_acf4, 3); mov(eax, memd[ds, eax + 0x49]);         /* mov eax, [eax+0x49] */
        ...
        l_0x100d_ad04:
            ii(0x100d_ad04, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_ad07, 3); mov(eax, memd[ds, eax + 0x49]);         /* mov eax, [eax+0x49] */
            ii(0x100d_ad0a, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100d_ad0d, 6); imul(eax, eax, 0x247);                  /* imul eax, eax, 0x247 */
            ii(0x100d_ad13, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100d_ad16, 4); mov(dx, memw[ds, edx + 0x4d]);          /* mov dx, [edx+0x4d] */
            ii(0x100d_ad1a, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ii(0x100d_ad1d, 4); sub(dx, memw[ds, ebx + 0x4f]);          /* sub dx, [ebx+0x4f] */
