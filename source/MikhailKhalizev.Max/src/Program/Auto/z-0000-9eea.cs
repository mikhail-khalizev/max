...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_9eea()
        {
            ...
            ii(0x9f04, 3);    mov(memw[ss, bp - 2], cx);                /* mov [bp-0x2], cx */
            ii(0x9f07, 3);    mov(di, memw[ss, bp + 4]);                /* mov di, [bp+0x4] */
            ...
            ii(0x9f18, 3);    sub(dx, memw[ss, bp - 2]);                /* sub dx, [bp-0x2] */
            ii(0x9f1b, 2);    if(jbe(0x9f42, 0x25)) goto l_0x9f42;      /* jbe 0x9f42 */
            ii(0x9f1d, 2);    mov(di, bx);                              /* mov di, bx */
        l_0x9f1f:
            ii(0x9f1f, 3);    mov(si, memw[ss, bp + 6]);                /* mov si, [bp+0x6] */
            ...
            ii(0x9f2f, 3);    mov(cx, memw[ss, bp - 2]);                /* mov cx, [bp-0x2] */
            ii(0x9f32, 2);    if(jcxz(0x9f38, 4)) goto l_0x9f38;        /* jcxz 0x9f38 */
            ii(0x9f34, 2);    repe(() => cmpsb());                      /* repe cmpsb */
            ii(0x9f36, 2);    if(jnz(0x9f1f, -0x19)) goto l_0x9f1f;     /* jnz 0x9f1f */
        l_0x9f38:
            ii(0x9f38, 3);    lea(ax, memw[ds, bx - 1]);                /* lea ax, [bx-0x1] */
            ii(0x9f3b, 2);    jmp(0x9f44, 7); goto l_0x9f44;            /* jmp 0x9f44 */
        l_0x9f3d:
            ii(0x9f3d, 3);    mov(ax, memw[ss, bp + 4]);                /* mov ax, [bp+0x4] */
            ii(0x9f40, 2);    jmp(0x9f44, 2); goto l_0x9f44;            /* jmp 0x9f44 */
        l_0x9f42:
