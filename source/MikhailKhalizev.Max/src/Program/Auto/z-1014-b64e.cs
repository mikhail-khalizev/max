...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_b64e()
        {
            ...
            ii(0x1014_b665, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_b668, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_b66b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b66e, 5); call(0x1007_61d4, -0xd_549f);           /* call 0x100761d4 */
            ii(0x1014_b673, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1014_b675, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_b678, 3); mov(memd[ds, eax + 0x7e], edx);         /* mov [eax+0x7e], edx */
            ii(0x1014_b67b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_b67e, 4); cmp(memd[ds, eax + 0x7e], 0);           /* cmp dword [eax+0x7e], 0x0 */
            ii(0x1014_b682, 2); if(jnz(0x1014_b6a7, 0x23)) goto l_0x1014_b6a7; /* jnz 0x1014b6a7 */
            ii(0x1014_b684, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b687, 5); call(0x1014_b5ef, -0x9d);               /* call 0x1014b5ef */
            ii(0x1014_b68c, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_b68f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b692, 5); call(0x1014_b64e, -0x49);               /* call 0x1014b64e */
            ii(0x1014_b697, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_b69a, 5); call(0x1007_61d4, -0xd_54cb);           /* call 0x100761d4 */
            ii(0x1014_b69f, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1014_b6a1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_b6a4, 3); mov(memd[ds, eax + 0x7e], edx);         /* mov [eax+0x7e], edx */
        l_0x1014_b6a7:
            ii(0x1014_b6a7, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1014_b6aa, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_b6ad, 3); mov(eax, memd[ds, eax + 0x7e]);         /* mov eax, [eax+0x7e] */
