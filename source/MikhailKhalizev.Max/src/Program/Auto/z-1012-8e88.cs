...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_8e88()
        {
            ...
            ii(0x1012_8e9d, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1012_8ea0, 3); mov(memd[ss, ebp - 0x10], edx);         /* mov [ebp-0x10], edx */
            ii(0x1012_8ea3, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1012_8ea6, 3); mov(memd[ss, ebp - 0x8], ecx);          /* mov [ebp-0x8], ecx */
            ii(0x1012_8ea9, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1012_8eac, 4); mov(memw[ss, ebp - 0x18], ax);          /* mov [ebp-0x18], ax */
            ii(0x1012_8eb0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_8eb3, 4); mov(memw[ss, ebp - 0x16], ax);          /* mov [ebp-0x16], ax */
            ii(0x1012_8eb7, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_8eba, 4); mov(memw[ss, ebp - 0x14], ax);          /* mov [ebp-0x14], ax */
            ii(0x1012_8ebe, 3); mov(eax, memd[ss, ebp + 0x10]);         /* mov eax, [ebp+0x10] */
            ii(0x1012_8ec1, 4); mov(memw[ss, ebp - 0x12], ax);          /* mov [ebp-0x12], ax */
            ii(0x1012_8ec5, 7); mov(memb[ds, 0x101c_5c1c], 0x15);       /* mov byte [0x101c5c1c], 0x15 */
            ii(0x1012_8ecc, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_8ecf, 6); mov(memw[ds, 0x101c_5c1d], ax);         /* mov [0x101c5c1d], ax */
            ii(0x1012_8ed5, 9); mov(memw[ds, 0x101c_5c1f], 0x8);        /* mov word [0x101c5c1f], 0x8 */
            ii(0x1012_8ede, 5); mov(ebx, 0x8);                          /* mov ebx, 0x8 */
            ii(0x1012_8ee3, 3); lea(edx, memd[ss, ebp - 0x18]);         /* lea edx, [ebp-0x18] */
            ...
            ii(0x1012_8eff, 3); ret(0x4);                               /* ret 0x4 */
        }
    }
}
