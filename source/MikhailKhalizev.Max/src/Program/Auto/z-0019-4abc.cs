...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_4abc()
        {
            ...
            ii(0x19_4ac8, 3); mov(memw[ss, bp - 0x18], ax);             /* mov [bp-0x18], ax */
            ii(0x19_4acb, 3); mov(memw[ss, bp - 0x1a], ax);             /* mov [bp-0x1a], ax */
            ...
            ii(0x19_4ad7, 3); mov(al, memb[ss, bp + 0x8]);              /* mov al, [bp+0x8] */
            ii(0x19_4ada, 2); mov(ah, 0xff);                            /* mov ah, 0xff */
            ii(0x19_4adc, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ii(0x19_4adf, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x19_4ae2, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x19_4ae5, 3); mov(ax, memw[ss, bp + 0xa]);              /* mov ax, [bp+0xa] */
            ii(0x19_4ae8, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_4aeb, 5); mov(memw[ss, bp - 0x6], 0xa00);           /* mov word [bp-0x6], 0xa00 */
            ii(0x19_4af0, 2); push(0);                                  /* push 0x0 */
            ii(0x19_4af2, 2); push(0);                                  /* push 0x0 */
            ii(0x19_4af4, 3); lea(ax, memw[ss, bp - 0x14]);             /* lea ax, [bp-0x14] */
            ii(0x19_4af7, 1); push(ss);                                 /* push ss */
            ii(0x19_4af8, 1); push(ax);                                 /* push ax */
            ii(0x19_4af9, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ...
            ii(0x19_4b04, 3); mov(ax, memw[ss, bp - 0x12]);             /* mov ax, [bp-0x12] */
        l_0x19_4b07:
            ii(0x19_4b07, 3); mov(memw[ss, bp - 0x18], ax);             /* mov [bp-0x18], ax */
        ...
        l_0x19_4b0c:
            ...
            ii(0x19_4b11, 3); mov(memw[ss, bp - 0x16], ax);             /* mov [bp-0x16], ax */
            ii(0x19_4b14, 2); or(ax, ax);                               /* or ax, ax */
            ii(0x19_4b16, 2); if(jz(0x19_4b67, 0x4f)) goto l_0x19_4b67; /* jz 0x4b67 */
            ii(0x19_4b18, 3); lea(ax, memw[ss, bp - 0x22]);             /* lea ax, [bp-0x22] */
            ii(0x19_4b1b, 1); push(ss);                                 /* push ss */
            ii(0x19_4b1c, 1); push(ax);                                 /* push ax */
            ii(0x19_4b1d, 3); push(memw[ss, bp - 0x16]);                /* push word [bp-0x16] */
            ...
            ii(0x19_4b28, 3); mov(al, memb[ss, bp + 0x8]);              /* mov al, [bp+0x8] */
            ii(0x19_4b2b, 3); mov(memb[ss, bp - 0x1e], al);             /* mov [bp-0x1e], al */
            ii(0x19_4b2e, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x19_4b31, 3); mov(memw[ss, bp - 0x20], ax);             /* mov [bp-0x20], ax */
            ii(0x19_4b34, 3); mov(ax, memw[ss, bp + 0xa]);              /* mov ax, [bp+0xa] */
            ii(0x19_4b37, 1); dec(ax);                                  /* dec ax */
            ii(0x19_4b38, 3); mov(memw[ss, bp - 0x22], ax);             /* mov [bp-0x22], ax */
            ii(0x19_4b3b, 3); mov(ax, memw[ss, bp + 0x8]);              /* mov ax, [bp+0x8] */
            ii(0x19_4b3e, 2); sub(al, al);                              /* sub al, al */
            ii(0x19_4b40, 3); or(memw[ss, bp - 0x1c], ax);              /* or [bp-0x1c], ax */
            ii(0x19_4b43, 3); lea(ax, memw[ss, bp - 0x22]);             /* lea ax, [bp-0x22] */
            ii(0x19_4b46, 1); push(ss);                                 /* push ss */
            ii(0x19_4b47, 1); push(ax);                                 /* push ax */
            ii(0x19_4b48, 3); push(memw[ss, bp - 0x16]);                /* push word [bp-0x16] */
            ...
            ii(0x19_4b55, 2); if(jz(0x19_4b5c, 0x5)) goto l_0x19_4b5c;  /* jz 0x4b5c */
            ii(0x19_4b57, 3); mov(ax, memw[ss, bp - 0x16]);             /* mov ax, [bp-0x16] */
            ii(0x19_4b5a, 2); jmp(0x19_4b07, -0x55); goto l_0x19_4b07;  /* jmp 0x4b07 */
        l_0x19_4b5c:
            ii(0x19_4b5c, 3); push(memw[ss, bp - 0x16]);                /* push word [bp-0x16] */
        ...
        l_0x19_4b67:
            ii(0x19_4b67, 3); mov(ax, memw[ss, bp - 0x1a]);             /* mov ax, [bp-0x1a] */
            ii(0x19_4b6a, 3); mov(dx, memw[ss, bp - 0x18]);             /* mov dx, [bp-0x18] */
