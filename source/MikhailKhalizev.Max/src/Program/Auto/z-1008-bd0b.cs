...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_bd0b()
        {
            ...
            ii(0x1008_bd26, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1008_bd29, 3); mov(memd[ss, ebp - 0x4], ecx);          /* mov [ebp-0x4], ecx */
            ii(0x1008_bd2c, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ...
            ii(0x1008_bd46, 7); mov(memd[ds, eax + 0x2], 0x101b_476c);  /* mov dword [eax+0x2], 0x101b476c */
            ii(0x1008_bd4d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
