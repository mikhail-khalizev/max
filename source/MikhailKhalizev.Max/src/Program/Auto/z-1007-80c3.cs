...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_80c3()
        {
            ...
            ii(0x1007_80d8, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1007_80db, 3); mov(memd[ss, ebp - 12], edx);           /* mov [ebp-0xc], edx */
            ...
            ii(0x1007_80e8, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x1007_80eb, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1007_80ee, 3); mov(al, memb[ds, eax + 38]);            /* mov al, [eax+0x26] */
            ...
            ii(0x1007_8108, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1007_810b, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1007_810d, 3); mov(al, memb[ss, ebp + 16]);            /* mov al, [ebp+0x10] */
            ii(0x1007_8110, 1); push(eax);                              /* push eax */
            ii(0x1007_8111, 4); movsx(eax, memw[ss, ebp - 20]);         /* movsx eax, word [ebp-0x14] */
            ...
            ii(0x1007_811e, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x1007_8121, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1007_8124, 5); call(0x1007_7ff6, -0x133);              /* call 0x10077ff6 */
            ii(0x1007_8129, 3); mov(memb[ss, ebp - 24], al);            /* mov [ebp-0x18], al */
            ii(0x1007_812c, 3); mov(al, memb[ss, ebp - 24]);            /* mov al, [ebp-0x18] */
