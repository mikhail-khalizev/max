...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("25eceebc-c031-4886-b207-0ce91f76a714")]
        public void Method_100f_bfde()
        {
            ii(0x100f_bfde, 5); pushd(0x30);                            /* push 0x30 */
            ii(0x100f_bfe3, 5); calld(Definitions.sys_check_available_stack_size, 0x6_9d6a); /* call 0x10165d52 */
            ...
            ii(0x100f_c000, 5); calld(Definitions.my_string_ctor, 0x4_5ae3); /* call 0x10141ae8 */
            ...
            ii(0x100f_c01c, 5); calld(0x1014_21cb, 0x4_61aa);           /* call 0x101421cb */
            ii(0x100f_c021, 5); mov(edx, StringDefinitions.Control27);  /* mov edx, 0x101a2965 */
            ii(0x100f_c026, 3); lea(eax, ebp - 0xc);                    /* lea eax, [ebp-0xc] */
            ii(0x100f_c029, 5); calld(Definitions.my_string_append_char_ptr, 0x4_5d11); /* call 0x10141d3f */
            ...
            ii(0x100f_c036, 5); calld(Definitions.my_string_append_char_ptr, 0x4_5d04); /* call 0x10141d3f */
            ii(0x100f_c03b, 5); calld(0x100c_aa00, -0x3_1640);          /* call 0x100caa00 */
            ...
            ii(0x100f_c055, 5); calld(Definitions.my_strobj_c_str_v2, -0x7_2892); /* call 0x100897c8 */
            ii(0x100f_c05a, 5); calld(0x1011_5d23, 0x1_9cc4);           /* call 0x10115d23 */
            ii(0x100f_c05f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100f_c061, 3); lea(eax, ebp - 0xc);                    /* lea eax, [ebp-0xc] */
            ii(0x100f_c064, 5); calld(Definitions.my_string_dtor, 0x4_5ac1); /* call 0x10141b2a */
