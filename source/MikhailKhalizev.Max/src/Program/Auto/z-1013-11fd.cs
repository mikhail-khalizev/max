...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_11fd()
        {
            ...
            ii(0x1013_1214, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1013_1217, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1013_121a, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_121d, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1013_1220, 7); mov(memb[ds, 0x101c_61b1], 0);          /* mov byte [0x101c61b1], 0x0 */
            ii(0x1013_1227, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_122a, 5); call(0x1012_f003, -0x222c);             /* call 0x1012f003 */
            ii(0x1013_122f, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_1232, 4); cmp(memb[ds, eax + 23], 0);             /* cmp byte [eax+0x17], 0x0 */
            ii(0x1013_1236, 2); if(jz(0x1013_1241, 9)) goto l_0x1013_1241; /* jz 0x10131241 */
            ii(0x1013_1238, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_123b, 4); cmp(memb[ds, eax + 23], 1);             /* cmp byte [eax+0x17], 0x1 */
            ii(0x1013_123f, 2); if(jnz(0x1013_124e, 0xd)) goto l_0x1013_124e; /* jnz 0x1013124e */
        l_0x1013_1241:
            ii(0x1013_1241, 5); mov(edx, 1);                            /* mov edx, 0x1 */
            ii(0x1013_1246, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
