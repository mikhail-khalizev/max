...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1007_1f51:
            ii(0x1007_1f51, 7); mov(memd[ss, ebp - 12], 1);             /* mov dword [ebp-0xc], 0x1 */
            ii(0x1007_1f58, 5); jmp(0x1007_1fe9, 0x8c); goto l_0x1007_1fe9; /* jmp 0x10071fe9 */
        l_0x1007_1f5d:
            ii(0x1007_1f5d, 7); mov(memd[ss, ebp - 12], 0xffff_ffff);   /* mov dword [ebp-0xc], 0xffffffff */
            ii(0x1007_1f64, 5); jmp(0x1007_1fe9, 0x80); goto l_0x1007_1fe9; /* jmp 0x10071fe9 */
        l_0x1007_1f69:
            ii(0x1007_1f69, 7); mov(memd[ss, ebp - 12], 0xffff_fffa);   /* mov dword [ebp-0xc], 0xfffffffa */
        ...
        l_0x1007_1f7a:
            ...
            ii(0x1007_1f7d, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1007_1f80, 5); cmp(memw[ss, ebp - 16], 0x17);          /* cmp word [ebp-0x10], 0x17 */
            ii(0x1007_1f85, 2); if(jb(0x1007_1fbe, 0x37)) goto l_0x1007_1fbe; /* jb 0x10071fbe */
            ii(0x1007_1f87, 5); cmp(memw[ss, ebp - 16], 0x19);          /* cmp word [ebp-0x10], 0x19 */
            ii(0x1007_1f8c, 2); if(jbe(0x1007_1f51, -0x3d)) goto l_0x1007_1f51; /* jbe 0x10071f51 */
            ii(0x1007_1f8e, 5); cmp(memw[ss, ebp - 16], 0x1d);          /* cmp word [ebp-0x10], 0x1d */
            ii(0x1007_1f93, 2); if(jb(0x1007_1fb5, 0x20)) goto l_0x1007_1fb5; /* jb 0x10071fb5 */
            ii(0x1007_1f95, 5); cmp(memw[ss, ebp - 16], 0x1e);          /* cmp word [ebp-0x10], 0x1e */
            ii(0x1007_1f9a, 2); if(jbe(0x1007_1f51, -0x4b)) goto l_0x1007_1f51; /* jbe 0x10071f51 */
            ii(0x1007_1f9c, 5); cmp(memw[ss, ebp - 16], 0x20);          /* cmp word [ebp-0x10], 0x20 */
            ii(0x1007_1fa1, 2); if(jb(0x1007_1fb3, 0x10)) goto l_0x1007_1fb3; /* jb 0x10071fb3 */
            ii(0x1007_1fa3, 5); cmp(memw[ss, ebp - 16], 0x20);          /* cmp word [ebp-0x10], 0x20 */
            ii(0x1007_1fa8, 2); if(jbe(0x1007_1f51, -0x59)) goto l_0x1007_1f51; /* jbe 0x10071f51 */
            ii(0x1007_1faa, 5); cmp(memw[ss, ebp - 16], 0x28);          /* cmp word [ebp-0x10], 0x28 */
        ...
        l_0x1007_1fb5:
            ii(0x1007_1fb5, 5); cmp(memw[ss, ebp - 16], 0x1b);          /* cmp word [ebp-0x10], 0x1b */
        ...
        l_0x1007_1fbe:
            ii(0x1007_1fbe, 5); cmp(memw[ss, ebp - 16], 1);             /* cmp word [ebp-0x10], 0x1 */
            ii(0x1007_1fc3, 2); if(jb(0x1007_1fd5, 0x10)) goto l_0x1007_1fd5; /* jb 0x10071fd5 */
            ii(0x1007_1fc5, 5); cmp(memw[ss, ebp - 16], 1);             /* cmp word [ebp-0x10], 0x1 */
            ii(0x1007_1fca, 2); if(jbe(0x1007_1f69, -0x63)) goto l_0x1007_1f69; /* jbe 0x10071f69 */
            ii(0x1007_1fcc, 5); cmp(memw[ss, ebp - 16], 2);             /* cmp word [ebp-0x10], 0x2 */
        ...
        l_0x1007_1fd5:
            ii(0x1007_1fd5, 5); cmp(memw[ss, ebp - 16], 0);             /* cmp word [ebp-0x10], 0x0 */
        ...
        l_0x1007_1fe2:
            ii(0x1007_1fe2, 7); mov(memd[ss, ebp - 12], 0);             /* mov dword [ebp-0xc], 0x0 */
        l_0x1007_1fe9:
            ii(0x1007_1fe9, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
