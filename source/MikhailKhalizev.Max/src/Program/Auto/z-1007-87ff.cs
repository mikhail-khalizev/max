...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("d81bf65c-f8cd-47c5-9416-4ae60cea3b77")]
        public void Method_1007_87ff()
        {
            ii(0x1007_87ff, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x1007_8804, 5); calld(Definitions.sys_check_available_stack_size, 0xed549); /* call 0x10165d52 */
            ...
            ii(0x1007_881d, 5); calld(0x1008_aa80, 0x1225e);            /* call 0x1008aa80 */
            ...
            ii(0x1007_8832, 5); calld(0x1008_a9d0, 0x12199);            /* call 0x1008a9d0 */
            ...
            ii(0x1007_883f, 1); retd(); return;                         /* ret */
        }
    }
}
