...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_be16()
        {
            ...
            ii(0x17_be22, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ii(0x17_be25, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_be28, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x17_be2b, 1); push(cs);                                 /* push cs */
            ii(0x17_be2c, 3); call(0x17_c79c, 0x96d);                   /* call 0xc79c */
            ii(0x17_be2f, 3); add(sp, 0x2);                             /* add sp, 0x2 */
            ii(0x17_be32, 3); mov(memw[ss, bp - 0xc], ax);              /* mov [bp-0xc], ax */
            ii(0x17_be35, 3); mov(memw[ss, bp - 0xa], dx);              /* mov [bp-0xa], dx */
            ii(0x17_be38, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x17_be3b, 3); mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
            ii(0x17_be3e, 3); cmp(ax, 0xffff);                          /* cmp ax, 0xffff */
            ii(0x17_be41, 2); if(jnz(0x17_be4a, 0x7)) goto l_0x17_be4a; /* jnz 0xbe4a */
            ii(0x17_be43, 2); cmp(dx, ax);                              /* cmp dx, ax */
            ii(0x17_be45, 2); if(jnz(0x17_be4a, 0x3)) goto l_0x17_be4a; /* jnz 0xbe4a */
            ii(0x17_be47, 3); jmp(0x17_bee8, 0x9e); goto l_0x17_bee8;   /* jmp 0xbee8 */
        l_0x17_be4a:
            ii(0x17_be4a, 3); push(memw[ss, bp - 0xa]);                 /* push word [bp-0xa] */
            ii(0x17_be4d, 3); push(memw[ss, bp - 0xc]);                 /* push word [bp-0xc] */
            ii(0x17_be50, 4); add(memw[ss, bp - 0xc], 0x1);             /* add word [bp-0xc], 0x1 */
            ii(0x17_be54, 4); adc(memw[ss, bp - 0xa], 0);               /* adc word [bp-0xa], 0x0 */
            ...
            ii(0x17_be66, 3); cmp(ax, memw[ss, bp + 0x6]);              /* cmp ax, [bp+0x6] */
            ii(0x17_be69, 2); if(jnz(0x17_be76, 0xb)) goto l_0x17_be76; /* jnz 0xbe76 */
            ii(0x17_be6b, 4); add(memw[ss, bp - 0x4], 0x1);             /* add word [bp-0x4], 0x1 */
            ii(0x17_be6f, 4); adc(memw[ss, bp - 0x2], 0);               /* adc word [bp-0x2], 0x0 */
            ii(0x17_be73, 2); jmp(0x17_be4a, -0x2b); goto l_0x17_be4a;  /* jmp 0xbe4a */
        //  ii(0x17_be75, 1); nop();                                    /* nop */
        l_0x17_be76:
            ii(0x17_be76, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_be79, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ii(0x17_be7c, 3); push(memw[ss, bp - 0x6]);                 /* push word [bp-0x6] */
            ii(0x17_be7f, 3); push(memw[ss, bp - 0x8]);                 /* push word [bp-0x8] */
            ii(0x17_be82, 1); push(cs);                                 /* push cs */
            ii(0x17_be83, 3); call(0x17_c560, 0x6da);                   /* call 0xc560 */
            ii(0x17_be86, 3); add(sp, 0x8);                             /* add sp, 0x8 */
            ii(0x17_be89, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0x17_be8c, 3); mov(dx, memw[ss, bp - 0x2]);              /* mov dx, [bp-0x2] */
            ...
            ii(0x17_bea7, 3); mov(ax, memw[ss, bp - 0x8]);              /* mov ax, [bp-0x8] */
            ii(0x17_beaa, 3); mov(dx, memw[ss, bp - 0x6]);              /* mov dx, [bp-0x6] */
            ...
            ii(0x17_becd, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_bed0, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
