...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_2a6d()
        {
            ...
            ii(0x100c_2a84, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_2a87, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100c_2a8a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_2a93, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_2a9e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_2aa1, 3); mov(edx, memd[ds, eax + 0x63]);         /* mov edx, [eax+0x63] */
            ii(0x100c_2aa4, 2); add(edx, ebx);                          /* add edx, ebx */
            ii(0x100c_2aa6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_2ab2, 3); or(memb[ds, eax], 0x1);                 /* or byte [eax], 0x1 */
        l_0x100c_2ab5:
