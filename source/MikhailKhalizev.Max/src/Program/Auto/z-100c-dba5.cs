...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_dba5()
        {
            ...
            ii(0x100c_dbbc, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_dbbf, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100c_dbc2, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x100c_dbc9, 2); jmp(0x100c_dbd1, 0x6); goto l_0x100c_dbd1; /* jmp 0x100cdbd1 */
        l_0x100c_dbcb:
            ii(0x100c_dbcb, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100c_dbce, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x100c_dbd1:
            ii(0x100c_dbd1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_dbd4, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x100c_dbd6, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100c_dbd9, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100c_dbdd, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x100c_dbdf, 2); if(jge(0x100c_dc14, 0x33)) goto l_0x100c_dc14; /* jge 0x100cdc14 */
            ii(0x100c_dbe1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_dbe4, 3); movsx(ebx, memw[ds, eax]);              /* movsx ebx, word [eax] */
            ii(0x100c_dbe7, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_dbea, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x100c_dbed, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100c_dbf1, 3); imul(edx, eax);                         /* imul edx, eax */
            ii(0x100c_dbf4, 2); mov(ecx, edx);                          /* mov ecx, edx */
            ii(0x100c_dbf6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_dbf9, 3); mov(edx, memd[ds, eax + 0x8]);          /* mov edx, [eax+0x8] */
            ii(0x100c_dbfc, 2); add(edx, ecx);                          /* add edx, ecx */
            ii(0x100c_dbfe, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_dc01, 5); call(/* sys */ 0x1016_61c4, 0x9_85be);  /* call 0x101661c4 */
            ii(0x100c_dc06, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100c_dc08, 2); if(jnz(0x100c_dc12, 0x8)) goto l_0x100c_dc12; /* jnz 0x100cdc12 */
            ii(0x100c_dc0a, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100c_dc0d, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100c_dc10, 2); jmp(0x100c_dc1b, 0x9); goto l_0x100c_dc1b; /* jmp 0x100cdc1b */
        l_0x100c_dc12:
            ii(0x100c_dc12, 2); jmp(0x100c_dbcb, -0x49); goto l_0x100c_dbcb; /* jmp 0x100cdbcb */
        l_0x100c_dc14:
            ii(0x100c_dc14, 7); mov(memd[ss, ebp - 0x10], 0xffff_ffff); /* mov dword [ebp-0x10], 0xffffffff */
        l_0x100c_dc1b:
            ii(0x100c_dc1b, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
