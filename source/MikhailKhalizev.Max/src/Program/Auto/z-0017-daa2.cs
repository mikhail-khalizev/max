...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x17_daa2, 3); mov(cx, memw[ss, bp + 0xa]);              /* mov cx, [bp+0xa] */
            ii(0x17_daa5, 2); or(cx, cx);                               /* or cx, cx */
            ii(0x17_daa7, 2); if(jnz(0x17_daae, 0x5)) goto l_0x17_daae; /* jnz 0xdaae */
            ii(0x17_daa9, 2); mov(ax, cx);                              /* mov ax, cx */
            ii(0x17_daab, 3); if(jmp_func(0x17_d8bb, -0x1f3)) return;   /* jmp 0xd8bb */
        l_0x17_daae:
            ii(0x17_daae, 3); mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ii(0x17_dab1, 2); mov(ah, 0x40);                            /* mov ah, 0x40 */
            ii(0x17_dab3, 2); @int(0x21);                               /* int 0x21 */
            ii(0x17_dab5, 2); if(jae(0x17_dabb, 0x4)) goto l_0x17_dabb; /* jae 0xdabb */
        ...
        l_0x17_dabb:
            ...
            ii(0x17_dacb, 2); if(jnz(0x17_dad0, 0x3)) goto l_0x17_dad0; /* jnz 0xdad0 */
        ...
        l_0x17_dad0:
            ...
            ii(0x17_dad4, 2); if(jmp_func(0x17_da9f, -0x37)) return;    /* jmp 0xda9f */
        }
    }
}
