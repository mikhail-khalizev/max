...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x1019_396d, 3); mov(ecx, memd[ss, ebp + 0x14]);         /* mov ecx, [ebp+0x14] */
            ii(0x1019_3970, 5); mov(eax, 0);                            /* mov eax, 0x0 */
            ii(0x1019_3975, 2); jmp(0x1019_397d, 0x6); goto l_0x1019_397d; /* jmp 0x1019397d */
        l_0x1019_3977:
        ...
        l_0x1019_39a7:
            ...
            ii(0x1019_39b9, 2); if(jmp_func(0x1019_394d, -0x6e)) return; /* jmp 0x1019394d */
        }
    }
}
