...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_d111()
        {
            ...
            ii(0x1013_d129, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1013_d12c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1013_d134, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1013_d137, 6); mov(memw[ds, edx + 0xc], 0xffff);       /* mov word [edx+0xc], 0xffff */
            ii(0x1013_d13d, 2); mov(eax, ds);                           /* mov eax, ds */
            ii(0x1013_d13f, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1013_d142, 3); mov(edx, memd[ds, edx + 0x12]);         /* mov edx, [edx+0x12] */
            ii(0x1013_d145, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ...
            ii(0x1013_d151, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1013_d154, 2); mov(edx, memd[ds, edx]);                /* mov edx, [edx] */
            ii(0x1013_d156, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_d159, 5); call(0x1013_ce3f, -0x31f);              /* call 0x1013ce3f */
            ii(0x1013_d15e, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1013_d161, 6); mov(memd[ds, edx], 0);                  /* mov dword [edx], 0x0 */
            ii(0x1013_d167, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1013_d16a, 4); cmp(memd[ds, edx + 0x8], 0);            /* cmp dword [edx+0x8], 0x0 */
            ii(0x1013_d16e, 2); if(jz(0x1013_d17b, 0xb)) goto l_0x1013_d17b; /* jz 0x1013d17b */
            ii(0x1013_d170, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_d173, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ii(0x1013_d176, 5); call(Definitions.sys_fclose, 0x3_4eee); /* call 0x10172069 */
        l_0x1013_d17b:
            ii(0x1013_d17b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_d17e, 7); mov(memd[ds, eax + 0x8], 0);            /* mov dword [eax+0x8], 0x0 */
            ii(0x1013_d185, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
