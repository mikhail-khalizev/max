...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_efac()
        {
            ...
            ii(0x1009_efc4, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_efc7, 4); mov(memb[ss, ebp - 0x8], 0xf);          /* mov byte [ebp-0x8], 0xf */
            ii(0x1009_efcb, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
