...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_4fa2()
        {
            ...
            ii(0x100f_4fba, 3); mov(memb[ss, ebp - 0x4], al);           /* mov [ebp-0x4], al */
            ...
            ii(0x100f_4fc9, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100f_4fcc, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x100f_5009, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ii(0x100f_500d, 2); if(jnz(0x100f_5015, 0x6)) goto l_0x100f_5015; /* jnz 0x100f5015 */
            ii(0x100f_500f, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x100f_5013, 2); jmp(0x100f_5019, 0x4); goto l_0x100f_5019; /* jmp 0x100f5019 */
        l_0x100f_5015:
            ii(0x100f_5015, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x100f_5019:
            ii(0x100f_5019, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100f_501b, 3); mov(dl, memb[ss, ebp - 0x8]);           /* mov dl, [ebp-0x8] */
