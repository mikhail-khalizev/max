...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_7e58()
        {
            ...
            ii(0x1016_7e64, 2); if(jz(0x1016_7e6a, 0x4)) goto l_0x1016_7e6a; /* jz 0x10167e6a */
            ii(0x1016_7e66, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1016_7e68, 2); if(jnz(0x1016_7e70, 0x6)) goto l_0x1016_7e70; /* jnz 0x10167e70 */
        l_0x1016_7e6a:
            ii(0x1016_7e6a, 5); mov(eax, 0xffff_ffff);                  /* mov eax, 0xffffffff */
            ii(0x1016_7e6f, 1); ret(); return;                          /* ret */
        l_0x1016_7e70:
            ii(0x1016_7e70, 3); mov(eax, memd[ds, eax + 0x1c]);         /* mov eax, [eax+0x1c] */
