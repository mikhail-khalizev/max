...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_e446()
        {
            ...
            ii(0x1007_e45b, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1007_e45e, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x1007_e461, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1007_e464, 3); mov(memd[ss, ebp - 0x8], ecx);          /* mov [ebp-0x8], ecx */
            ii(0x1007_e467, 5); mov(eax, 0x101c_819c);                  /* mov eax, 0x101c819c */
            ii(0x1007_e46c, 5); call(0x1007_6338, -0x8139);             /* call 0x10076338 */
            ii(0x1007_e471, 3); lea(ecx, memd[ss, ebp - 0x14]);         /* lea ecx, [ebp-0x14] */
            ...
            ii(0x1007_e47d, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x1007_e49b, 3); lea(eax, memd[ss, ebp - 0x28]);         /* lea eax, [ebp-0x28] */
            ii(0x1007_e49e, 5); call(0x1008_b148, 0xcca5);              /* call 0x1008b148 */
            ii(0x1007_e4a3, 2); jmp(0x1007_e4ad, 0x8); goto l_0x1007_e4ad; /* jmp 0x1007e4ad */
        l_0x1007_e4a5:
            ii(0x1007_e4a5, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_e4a8, 5); call(0x1007_6bf8, -0x78b5);             /* call 0x10076bf8 */
        l_0x1007_e4ad:
            ii(0x1007_e4ad, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_e4af, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1007_e4bf, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_e4c2, 5); call(0x1007_63a0, -0x8127);             /* call 0x100763a0 */
            ii(0x1007_e4c7, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_e4c9, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ii(0x1007_e4cc, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1007_e4cf, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1007_e4d9, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_e4dc, 5); call(0x1007_63a0, -0x8141);             /* call 0x100763a0 */
            ii(0x1007_e4e1, 4); mov(ax, memw[ds, eax + 0x8]);           /* mov ax, [eax+0x8] */
            ii(0x1007_e4e5, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ii(0x1007_e4e9, 2); if(jz(0x1007_e4f0, 0x5)) goto l_0x1007_e4f0; /* jz 0x1007e4f0 */
        l_0x1007_e4eb:
            ii(0x1007_e4eb, 5); jmp(0x1007_e5b7, 0xc7); goto l_0x1007_e5b7; /* jmp 0x1007e5b7 */
        l_0x1007_e4f0:
            ii(0x1007_e4f0, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_e4f3, 5); call(0x1007_63a0, -0x8158);             /* call 0x100763a0 */
            ii(0x1007_e4f8, 4); mov(ax, memw[ds, eax + 0x1a]);          /* mov ax, [eax+0x1a] */
            ii(0x1007_e4fc, 3); sub(eax, 0x2);                          /* sub eax, 0x2 */
            ii(0x1007_e4ff, 4); mov(memw[ss, ebp - 0x18], ax);          /* mov [ebp-0x18], ax */
            ii(0x1007_e503, 2); jmp(0x1007_e50c, 0x7); goto l_0x1007_e50c; /* jmp 0x1007e50c */
        l_0x1007_e505:
            ii(0x1007_e505, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1007_e508, 4); inc(memw[ss, ebp - 0x18]);              /* inc word [ebp-0x18] */
        l_0x1007_e50c:
            ii(0x1007_e50c, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_e50f, 5); call(0x1007_63a0, -0x8174);             /* call 0x100763a0 */
            ii(0x1007_e514, 3); mov(eax, memd[ds, eax + 0x18]);         /* mov eax, [eax+0x18] */
            ii(0x1007_e517, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1007_e51a, 4); movsx(edx, memw[ss, ebp - 0x18]);       /* movsx edx, word [ebp-0x18] */
            ...
            ii(0x1007_e529, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_e52c, 5); call(0x1007_63a0, -0x8191);             /* call 0x100763a0 */
            ii(0x1007_e531, 4); mov(ax, memw[ds, eax + 0x1c]);          /* mov ax, [eax+0x1c] */
            ii(0x1007_e535, 3); sub(eax, 0x2);                          /* sub eax, 0x2 */
            ii(0x1007_e538, 4); mov(memw[ss, ebp - 0x16], ax);          /* mov [ebp-0x16], ax */
            ii(0x1007_e53c, 2); jmp(0x1007_e545, 0x7); goto l_0x1007_e545; /* jmp 0x1007e545 */
        l_0x1007_e53e:
            ii(0x1007_e53e, 3); mov(eax, memd[ss, ebp - 0x16]);         /* mov eax, [ebp-0x16] */
            ii(0x1007_e541, 4); inc(memw[ss, ebp - 0x16]);              /* inc word [ebp-0x16] */
        l_0x1007_e545:
            ii(0x1007_e545, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x1007_e548, 5); call(0x1007_63a0, -0x81ad);             /* call 0x100763a0 */
            ii(0x1007_e54d, 3); mov(eax, memd[ds, eax + 0x1a]);         /* mov eax, [eax+0x1a] */
            ii(0x1007_e550, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1007_e553, 4); movsx(edx, memw[ss, ebp - 0x16]);       /* movsx edx, word [ebp-0x16] */
            ...
            ii(0x1007_e55e, 3); lea(edx, memd[ss, ebp - 0x18]);         /* lea edx, [ebp-0x18] */
            ii(0x1007_e561, 3); lea(eax, memd[ss, ebp - 0x28]);         /* lea eax, [ebp-0x28] */
            ...
            ii(0x1007_e56d, 3); lea(edx, memd[ss, ebp - 0x18]);         /* lea edx, [ebp-0x18] */
            ii(0x1007_e570, 3); lea(eax, memd[ss, ebp - 0x2c]);         /* lea eax, [ebp-0x2c] */
            ii(0x1007_e573, 5); call(0x1007_5e64, -0x8714);             /* call 0x10075e64 */
            ii(0x1007_e578, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x1007_e57a, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1007_e57d, 3); lea(eax, memd[ss, ebp - 0x30]);         /* lea eax, [ebp-0x30] */
            ...
            ii(0x1007_e59c, 4); movsx(eax, memw[ss, ebp - 0x18]);       /* movsx eax, word [ebp-0x18] */
            ii(0x1007_e5a0, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1007_e5a3, 3); add(eax, memd[ss, ebp - 0xc]);          /* add eax, [ebp-0xc] */
            ii(0x1007_e5a6, 4); movsx(edx, memw[ss, ebp - 0x16]);       /* movsx edx, word [ebp-0x16] */
        ...
        l_0x1007_e5bc:
            ...
            ii(0x1007_e5be, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
