...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_6f3f()
        {
            ...
            ii(0x1010_6f57, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_6f5a, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1010_6f61, 2); jmp(0x1010_6f69, 0x6); goto l_0x1010_6f69; /* jmp 0x10106f69 */
        l_0x1010_6f63:
            ii(0x1010_6f63, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_6f66, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x1010_6f69:
            ii(0x1010_6f69, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1010_6f77, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x1010_6f85, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_6f88, 5); call(/* sys */ 0x1016_61c4, 0x5_f237);  /* call 0x101661c4 */
            ii(0x1010_6f8d, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1010_6f8f, 2); if(jnz(0x1010_6f99, 0x8)) goto l_0x1010_6f99; /* jnz 0x10106f99 */
            ii(0x1010_6f91, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_6f94, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1010_6f97, 2); jmp(0x1010_6fa2, 0x9); goto l_0x1010_6fa2; /* jmp 0x10106fa2 */
        l_0x1010_6f99:
