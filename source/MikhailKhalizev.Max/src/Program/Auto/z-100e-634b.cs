...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_634b()
        {
            ...
            ii(0x100e_6363, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100e_6366, 7); cmp(memd[ds, 0x101c_38c0], 0x8);        /* cmp dword [0x101c38c0], 0x8 */
            ...
            ii(0x100e_637d, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100e_6380, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_6383, 4); test(memb[ds, eax + 0x12], 0x10);       /* test byte [eax+0x12], 0x10 */
            ii(0x100e_6387, 2); if(jz(0x100e_6392, 0x9)) goto l_0x100e_6392; /* jz 0x100e6392 */
            ii(0x100e_6389, 7); mov(memd[ss, ebp - 0xc], 0x40);         /* mov dword [ebp-0xc], 0x40 */
            ii(0x100e_6390, 2); jmp(0x100e_6399, 0x7); goto l_0x100e_6399; /* jmp 0x100e6399 */
        l_0x100e_6392:
            ii(0x100e_6392, 7); mov(memd[ss, ebp - 0xc], 0x20);         /* mov dword [ebp-0xc], 0x20 */
        l_0x100e_6399:
            ii(0x100e_6399, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x100e_63ab, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100e_63ae, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100e_63b1, 3); mov(edx, memd[ds, edx + 0x14]);         /* mov edx, [edx+0x14] */
            ...
            ii(0x100e_63d0, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100e_63d4, 1); inc(eax);                               /* inc eax */
            ii(0x100e_63d5, 2); sub(eax, edx);                          /* sub eax, edx */
            ii(0x100e_63d7, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100e_63da, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_63dd, 3); mov(edx, memd[ds, eax + 0x16]);         /* mov edx, [eax+0x16] */
            ...
            ii(0x100e_63fc, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100e_6400, 1); inc(eax);                               /* inc eax */
            ii(0x100e_6401, 2); sub(eax, edx);                          /* sub eax, edx */
            ii(0x100e_6403, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_6406, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100e_6409, 4); test(memb[ds, edx + 0x12], 0x10);       /* test byte [edx+0x12], 0x10 */
            ii(0x100e_640d, 2); if(jz(0x100e_6418, 0x9)) goto l_0x100e_6418; /* jz 0x100e6418 */
            ii(0x100e_640f, 7); mov(memd[ss, ebp - 0x10], 0x80);        /* mov dword [ebp-0x10], 0x80 */
            ii(0x100e_6416, 2); jmp(0x100e_641f, 0x7); goto l_0x100e_641f; /* jmp 0x100e641f */
        l_0x100e_6418:
            ii(0x100e_6418, 7); mov(memd[ss, ebp - 0x10], 0x40);        /* mov dword [ebp-0x10], 0x40 */
        l_0x100e_641f:
            ii(0x100e_641f, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x100e_6434, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ...
            ii(0x100e_6441, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ...
            ii(0x100e_6453, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x100e_6456, 5); call(0x100e_8f38, 0x2add);              /* call 0x100e8f38 */
            ii(0x100e_645b, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
        l_0x100e_645e:
            ii(0x100e_645e, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x100e_6461, 1); push(eax);                              /* push eax */
            ii(0x100e_6462, 5); mov(ecx, 0x1);                          /* mov ecx, 0x1 */
            ii(0x100e_6467, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100e_646a, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x100e_646d, 3); movsx(ebx, ax);                         /* movsx ebx, ax */
            ii(0x100e_6470, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100e_6473, 3); add(eax, memd[ss, ebp - 0x14]);         /* add eax, [ebp-0x14] */
            ii(0x100e_6476, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x100e_6479, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ...
            ii(0x100e_6488, 2); if(jz(0x100e_6492, 0x8)) goto l_0x100e_6492; /* jz 0x100e6492 */
            ii(0x100e_648a, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
