...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_4ff3()
        {
            ...
            ii(0x1019_4fff, 5); mov(eax, 1);                            /* mov eax, 0x1 */
            ii(0x1019_5004, 4); lfs(edi, memd[ss, ebp + 16]);           /* lfs edi, [ebp+0x10] */
            ii(0x1019_5008, 3); call_far_ind(memd[ss, ebp + 8]);        /* call far dword [ebp+0x8] */
