...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_49c5()
        {
            ...
            ii(0x1015_49dc, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_49df, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1015_49e2, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1015_49e4, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x1015_49f0, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ii(0x1015_49f4, 6); if(jz(0x1015_4b83, 0x189)) goto l_0x1015_4b83; /* jz 0x10154b83 */
            ii(0x1015_49fa, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_49fd, 5); call(0x1011_fe27, -0x3_4bdb);           /* call 0x1011fe27 */
            ii(0x1015_4a02, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1015_4a05, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1015_4a73, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1015_4a7e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1015_4aa0, 2); if(jz(0x1015_4aa8, 0x6)) goto l_0x1015_4aa8; /* jz 0x10154aa8 */
            ii(0x1015_4aa2, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
            ii(0x1015_4aa6, 2); jmp(0x1015_4aac, 0x4); goto l_0x1015_4aac; /* jmp 0x10154aac */
        l_0x1015_4aa8:
            ii(0x1015_4aa8, 4); mov(memb[ss, ebp - 0x10], 0);           /* mov byte [ebp-0x10], 0x0 */
        l_0x1015_4aac:
            ii(0x1015_4aac, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_4aaf, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1015_4ab1, 3); mov(dl, memb[ds, eax + 0x26]);          /* mov dl, [eax+0x26] */
            ii(0x1015_4ab4, 3); add(edx, memd[ss, ebp - 0x8]);          /* add edx, [ebp-0x8] */
            ii(0x1015_4ab7, 3); mov(al, memb[ss, ebp - 0x10]);          /* mov al, [ebp-0x10] */
            ii(0x1015_4aba, 6); mov(memb[ds, edx + 0xab], al);          /* mov [edx+0xab], al */
            ii(0x1015_4ac0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1015_4ae3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_4ae6, 3); and(memd[ds, eax + 0x12], edx);         /* and [eax+0x12], edx */
            ii(0x1015_4ae9, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ii(0x1015_4aec, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1015_4aef, 3); mov(memb[ds, edx + 0x26], al);          /* mov [edx+0x26], al */
            ii(0x1015_4af2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_4af5, 4); mov(memb[ds, eax + 0x5c], 0);           /* mov byte [eax+0x5c], 0x0 */
            ii(0x1015_4af9, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1015_4b0e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_4b11, 3); or(memd[ds, eax + 0x12], edx);          /* or [eax+0x12], edx */
            ii(0x1015_4b14, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1015_4b24, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x1015_4b27, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_4b2a, 3); mov(memd[ds, eax + 0x22], edx);         /* mov [eax+0x22], edx */
            ii(0x1015_4b2d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1015_4b36, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_4b39, 5); call(0x1014_f08b, -0x5ab3);             /* call 0x1014f08b */
            ii(0x1015_4b3e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_4b41, 4); mov(memb[ds, eax + 0x58], 0);           /* mov byte [eax+0x58], 0x0 */
        l_0x1015_4b45:
            ii(0x1015_4b45, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x1015_4b4a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_4b4d, 5); call(0x1007_1838, -0xe_331a);           /* call 0x10071838 */
            ii(0x1015_4b52, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1015_4b56, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x1015_4b59, 7); mov(memb[ds, eax + 0xab], 0x1);         /* mov byte [eax+0xab], 0x1 */
            ii(0x1015_4b60, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1015_4b6c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_4b6f, 5); call(0x100a_9060, -0xa_bb14);           /* call 0x100a9060 */
            ii(0x1015_4b74, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_4b77, 5); call(0x1014_9fa8, -0xabd4);             /* call 0x10149fa8 */
            ii(0x1015_4b7c, 7); mov(memb[ds, 0x101c_391b], 0x1);        /* mov byte [0x101c391b], 0x1 */
        l_0x1015_4b83:
