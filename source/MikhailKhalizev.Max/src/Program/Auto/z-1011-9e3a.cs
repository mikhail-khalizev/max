...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_9e3a()
        {
            ...
            ii(0x1011_9e51, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_9e54, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1011_9e57, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1011_9e5b, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1011_9e5d, 2); if(jnz(0x1011_9e7f, 0x20)) goto l_0x1011_9e7f; /* jnz 0x10119e7f */
            ii(0x1011_9e5f, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
        ...
        l_0x1011_9e73:
            ii(0x1011_9e73, 7); mov(memd[ss, ebp - 0xc], 0x4);          /* mov dword [ebp-0xc], 0x4 */
            ii(0x1011_9e7a, 5); jmp(0x1011_9edb, 0x5c); goto l_0x1011_9edb; /* jmp 0x10119edb */
        l_0x1011_9e7f:
            ii(0x1011_9e7f, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1011_9e83, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1011_9e85, 2); if(jle(0x1011_9eb2, 0x2b)) goto l_0x1011_9eb2; /* jle 0x10119eb2 */
            ii(0x1011_9e87, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1011_9e8b, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1011_9e8d, 2); if(jge(0x1011_9e98, 0x9)) goto l_0x1011_9e98; /* jge 0x10119e98 */
            ii(0x1011_9e8f, 7); mov(memd[ss, ebp - 0xc], 0x1);          /* mov dword [ebp-0xc], 0x1 */
            ii(0x1011_9e96, 2); jmp(0x1011_9edb, 0x43); goto l_0x1011_9edb; /* jmp 0x10119edb */
        l_0x1011_9e98:
            ii(0x1011_9e98, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1011_9e9c, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1011_9e9e, 2); if(jnz(0x1011_9ea9, 0x9)) goto l_0x1011_9ea9; /* jnz 0x10119ea9 */
            ii(0x1011_9ea0, 7); mov(memd[ss, ebp - 0xc], 0x2);          /* mov dword [ebp-0xc], 0x2 */
            ii(0x1011_9ea7, 2); jmp(0x1011_9edb, 0x32); goto l_0x1011_9edb; /* jmp 0x10119edb */
        l_0x1011_9ea9:
            ii(0x1011_9ea9, 7); mov(memd[ss, ebp - 0xc], 0x3);          /* mov dword [ebp-0xc], 0x3 */
            ii(0x1011_9eb0, 2); jmp(0x1011_9edb, 0x29); goto l_0x1011_9edb; /* jmp 0x10119edb */
        l_0x1011_9eb2:
            ii(0x1011_9eb2, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1011_9eb6, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1011_9eb8, 2); if(jle(0x1011_9ec3, 0x9)) goto l_0x1011_9ec3; /* jle 0x10119ec3 */
            ii(0x1011_9eba, 7); mov(memd[ss, ebp - 0xc], 0x5);          /* mov dword [ebp-0xc], 0x5 */
            ii(0x1011_9ec1, 2); jmp(0x1011_9edb, 0x18); goto l_0x1011_9edb; /* jmp 0x10119edb */
        l_0x1011_9ec3:
            ii(0x1011_9ec3, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1011_9ec7, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1011_9ec9, 2); if(jnz(0x1011_9ed4, 0x9)) goto l_0x1011_9ed4; /* jnz 0x10119ed4 */
            ii(0x1011_9ecb, 7); mov(memd[ss, ebp - 0xc], 0x6);          /* mov dword [ebp-0xc], 0x6 */
            ii(0x1011_9ed2, 2); jmp(0x1011_9edb, 0x7); goto l_0x1011_9edb; /* jmp 0x10119edb */
        l_0x1011_9ed4:
            ii(0x1011_9ed4, 7); mov(memd[ss, ebp - 0xc], 0x7);          /* mov dword [ebp-0xc], 0x7 */
        l_0x1011_9edb:
