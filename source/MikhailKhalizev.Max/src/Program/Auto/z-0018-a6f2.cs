...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_a6f2()
        {
            ...
            ii(0x18_a6ff, 4); test(memb[ds, bx - 0x2], 0x1);            /* test byte [bx-0x2], 0x1 */
            ii(0x18_a703, 2); if(jz(0x18_a71b, 0x16)) goto l_0x18_a71b; /* jz 0xa71b */
            ii(0x18_a705, 3); mov(cx, memw[ss, bp + 0x10]);             /* mov cx, [bp+0x10] */
            ii(0x18_a708, 3); mov(dx, memw[ss, bp + 0x14]);             /* mov dx, [bp+0x14] */
            ii(0x18_a70b, 3); xchg(memw[ds, bx - 0x4], cx);             /* xchg [bx-0x4], cx */
            ii(0x18_a70e, 3); xchg(memw[ds, bx - 0x6], dx);             /* xchg [bx-0x6], dx */
            ii(0x18_a711, 3); mov(memw[ss, bp + 0x14], dx);             /* mov [bp+0x14], dx */
            ii(0x18_a714, 3); mov(memw[ss, bp + 0x10], cx);             /* mov [bp+0x10], cx */
            ii(0x18_a717, 4); or(memb[ds, bx - 0x2], -0x80 /* 0x80 */); /* or byte [bx-0x2], 0x80 */
        l_0x18_a71b:
