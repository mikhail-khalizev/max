...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_fb74()
        {
            ...
            ii(0x100d_fb8b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_fb8e, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_fb91, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_fb94, 3); mov(ebx, memd[ds, eax + 0x4]);          /* mov ebx, [eax+0x4] */
            ii(0x100d_fb97, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100d_fb9a, 5); mov(edx, StringDefinitions.Gold6);      /* mov edx, 0x101a1b08 */
            ii(0x100d_fb9f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_fbac, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_fbaf, 5); call(0x1014_73de, 0x6_782a);            /* call 0x101473de */
            ii(0x100d_fbb4, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x100d_fbbb, 2); jmp(0x100d_fbc3, 0x6); goto l_0x100d_fbc3; /* jmp 0x100dfbc3 */
        l_0x100d_fbbd:
            ii(0x100d_fbbd, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_fbc0, 3); inc(memd[ss, ebp - 0x10]);              /* inc dword [ebp-0x10] */
        l_0x100d_fbc3:
            ii(0x100d_fbc3, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x100d_fbd1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_fbd4, 5); call(0x1014_73de, 0x6_7805);            /* call 0x101473de */
            ii(0x100d_fbd9, 4); movsx(ecx, memw[ss, ebp - 0x10]);       /* movsx ecx, word [ebp-0x10] */
            ...
            ii(0x100d_fbe7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_fbea, 5); call(0x1014_76e3, 0x6_7af4);            /* call 0x101476e3 */
            ii(0x100d_fbef, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x100d_fbf3, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100d_fbf6, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x100d_fc08, 3); mov(ecx, memd[ss, ebp - 0x4]);          /* mov ecx, [ebp-0x4] */
            ...
            ii(0x100d_fc14, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100d_fc1e:
            ii(0x100d_fc1e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_fc2b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_fc2e, 5); call(0x1014_73de, 0x6_77ab);            /* call 0x101473de */
            ii(0x100d_fc33, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x100d_fc3a, 2); jmp(0x100d_fc42, 0x6); goto l_0x100d_fc42; /* jmp 0x100dfc42 */
        l_0x100d_fc3c:
            ii(0x100d_fc3c, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_fc3f, 3); inc(memd[ss, ebp - 0x10]);              /* inc dword [ebp-0x10] */
        l_0x100d_fc42:
            ii(0x100d_fc42, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x100d_fc50, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_fc53, 5); call(0x1014_73de, 0x6_7786);            /* call 0x101473de */
            ii(0x100d_fc58, 4); movsx(ecx, memw[ss, ebp - 0x10]);       /* movsx ecx, word [ebp-0x10] */
            ...
            ii(0x100d_fc66, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_fc69, 5); call(0x1014_76e3, 0x6_7a75);            /* call 0x101476e3 */
            ii(0x100d_fc6e, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x100d_fc72, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100d_fc75, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x100d_fc8a, 3); mov(ecx, memd[ss, ebp - 0x4]);          /* mov ecx, [ebp-0x4] */
            ...
            ii(0x100d_fc96, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100d_fca0:
            ii(0x100d_fca0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_fca3, 5); call(0x1014_7446, 0x6_779e);            /* call 0x10147446 */
            ii(0x100d_fca8, 4); or(memb[ss, ebp - 0xc], 0x1);           /* or byte [ebp-0xc], 0x1 */
            ii(0x100d_fcac, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x100d_fcaf, 5); call(0x100e_0608, 0x954);               /* call 0x100e0608 */
            ii(0x100d_fcb4, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100d_fcb7, 4); and(memb[ss, ebp - 0xc], -0x2 /* 0xfe */); /* and byte [ebp-0xc], 0xfe */
            ii(0x100d_fcbb, 5); mov(edx, StringDefinitions.Complexes2); /* mov edx, 0x101a1b4a */
            ii(0x100d_fcc0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_fcc3, 5); call(0x1014_73de, 0x6_7716);            /* call 0x101473de */
            ii(0x100d_fcc8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_fccb, 5); add(eax, 0x2f0);                        /* add eax, 0x2f0 */
            ii(0x100d_fcd0, 5); call(0x100e_0cf0, 0x101b);              /* call 0x100e0cf0 */
            ii(0x100d_fcd5, 3); lea(ebx, memd[ss, ebp - 0x18]);         /* lea ebx, [ebp-0x18] */
            ...
            ii(0x100d_fce1, 2); jmp(0x100d_fceb, 0x8); goto l_0x100d_fceb; /* jmp 0x100dfceb */
        l_0x100d_fce3:
            ii(0x100d_fce3, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x100d_fce6, 5); call(0x1007_6bf8, -0x6_90f3);           /* call 0x10076bf8 */
        l_0x100d_fceb:
            ii(0x100d_fceb, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100d_fced, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x100d_fcf9, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x100d_fd08, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100d_fd12:
            ii(0x100d_fd12, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_fd15, 5); call(0x1014_7446, 0x6_772c);            /* call 0x10147446 */
            ii(0x100d_fd1a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100d_fd1c, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
