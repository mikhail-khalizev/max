...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_b16c()
        {
            ...
            ii(0x1007_b183, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_b186, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1007_b189, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_b18b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1007_b19a, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_b19d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_b1a0, 5); call(0x100a_2ce8, 0x2_7b43);            /* call 0x100a2ce8 */
            ii(0x1007_b1a5, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1007_b1a8, 2); jmp(0x1007_b1f6, 0x4c); goto l_0x1007_b1f6; /* jmp 0x1007b1f6 */
        l_0x1007_b1aa:
            ii(0x1007_b1aa, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1007_b1bb, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_b1be, 2); mov(memd[ds, edx], eax);                /* mov [edx], eax */
            ii(0x1007_b1c0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1007_b1d1, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_b1d4, 3); mov(memd[ds, edx + 0x4], eax);          /* mov [edx+0x4], eax */
            ii(0x1007_b1d7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_b1da, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1007_b1dc, 1); inc(eax);                               /* inc eax */
            ii(0x1007_b1dd, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_b1e0, 3); mov(memd[ds, edx + 0x8], eax);          /* mov [edx+0x8], eax */
            ii(0x1007_b1e3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_b1e6, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
            ii(0x1007_b1e9, 1); inc(eax);                               /* inc eax */
            ii(0x1007_b1ea, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_b1ed, 3); mov(memd[ds, edx + 0xc], eax);          /* mov [edx+0xc], eax */
            ii(0x1007_b1f0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_b1f3, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
        l_0x1007_b1f6:
            ii(0x1007_b1f6, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
