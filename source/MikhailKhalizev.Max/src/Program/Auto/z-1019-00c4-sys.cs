...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_00c4()
        {
            ...
            ii(0x1019_00ce, 3); mov(eax, memd[ds, esi + 0x4]);          /* mov eax, [esi+0x4] */
            ii(0x1019_00d1, 3); mov(memd[ds, edi + 0x4], eax);          /* mov [edi+0x4], eax */
            ii(0x1019_00d4, 2); add(edi, edx);                          /* add edi, edx */
            ii(0x1019_00d6, 3); mov(eax, memd[ds, esi + 0x8]);          /* mov eax, [esi+0x8] */
            ii(0x1019_00d9, 2); mov(memd[ds, edi], eax);                /* mov [edi], eax */
            ii(0x1019_00db, 3); mov(eax, memd[ds, esi + 0xc]);          /* mov eax, [esi+0xc] */
            ii(0x1019_00de, 3); mov(memd[ds, edi + 0x4], eax);          /* mov [edi+0x4], eax */
            ...
            ii(0x1019_00eb, 3); mov(memd[ds, edi + 0x4], eax);          /* mov [edi+0x4], eax */
            ...
            ii(0x1019_00f8, 3); mov(memd[ds, edi + 0x4], eax);          /* mov [edi+0x4], eax */
            ...
            ii(0x1019_0105, 3); mov(memd[ds, edi + 0x4], eax);          /* mov [edi+0x4], eax */
            ...
            ii(0x1019_0112, 3); mov(memd[ds, edi + 0x4], eax);          /* mov [edi+0x4], eax */
            ...
            ii(0x1019_011f, 3); mov(memd[ds, edi + 0x4], eax);          /* mov [edi+0x4], eax */
            ...
            ii(0x1019_012c, 3); mov(memd[ds, edi + 0x4], eax);          /* mov [edi+0x4], eax */
