...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_4e9a()
        {
            ...
            ii(0x17_4ea4, 5); mov(memw[ss, bp - 4], 0x2e20);            /* mov word [bp-0x4], 0x2e20 */
            ii(0x17_4ea9, 5); mov(memw[ss, bp - 2], 0x3e58);            /* mov word [bp-0x2], 0x3e58 */
            ...
            ii(0x17_4ed0, 3); add(sp, 2);                               /* add sp, 0x2 */
            ii(0x17_4ed3, 3); mov(ax, 1);                               /* mov ax, 0x1 */
