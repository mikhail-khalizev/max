...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_bd2f()
        {
            ...
            ii(0x1010_bd47, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_bd4a, 5); call(0x1010_b713, -0x63c);              /* call 0x1010b713 */
            ii(0x1010_bd4f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_bd52, 3); mov(al, memb[ds, eax + 0xc]);           /* mov al, [eax+0xc] */
        ...
        l_0x1010_bd7f:
            ii(0x1010_bd7f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_bd82, 7); mov(memd[ds, eax + 0x4], 0x1);          /* mov dword [eax+0x4], 0x1 */
