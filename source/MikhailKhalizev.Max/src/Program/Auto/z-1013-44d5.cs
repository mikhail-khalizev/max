...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_44d5()
        {
            ...
            ii(0x1013_44f2, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x1013_44f9, 2); jmp(0x1013_4501, 0x6); goto l_0x1013_4501; /* jmp 0x10134501 */
        l_0x1013_44fb:
            ii(0x1013_44fb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_44fe, 3); inc(memd[ss, ebp - 0x4]);               /* inc dword [ebp-0x4] */
        l_0x1013_4501:
            ii(0x1013_4501, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1013_4505, 5); cmp(eax, 0x38e);                        /* cmp eax, 0x38e */
            ii(0x1013_450a, 2); if(jge(0x1013_454e, 0x42)) goto l_0x1013_454e; /* jge 0x1013454e */
            ii(0x1013_450c, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1013_451a, 4); cmp(memd[ds, eax + 0x2], 0);            /* cmp dword [eax+0x2], 0x0 */
            ii(0x1013_451e, 2); if(jz(0x1013_454c, 0x2c)) goto l_0x1013_454c; /* jz 0x1013454c */
            ii(0x1013_4520, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ...
            ii(0x1013_452e, 3); mov(eax, memd[ds, eax + 0x2]);          /* mov eax, [eax+0x2] */
            ii(0x1013_4531, 5); call(Definitions.sys_delete, 0x3_1a2e); /* call 0x10165f64 */
            ii(0x1013_4536, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1013_4545, 7); mov(memd[ds, eax + 0x2], 0);            /* mov dword [eax+0x2], 0x0 */
        l_0x1013_454c:
            ii(0x1013_454c, 2); jmp(0x1013_44fb, -0x53); goto l_0x1013_44fb; /* jmp 0x101344fb */
        l_0x1013_454e:
            ii(0x1013_454e, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x1013_4555, 2); jmp(0x1013_455d, 0x6); goto l_0x1013_455d; /* jmp 0x1013455d */
        l_0x1013_4557:
            ii(0x1013_4557, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_455a, 3); inc(memd[ss, ebp - 0x4]);               /* inc dword [ebp-0x4] */
        l_0x1013_455d:
            ii(0x1013_455d, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1013_4561, 3); cmp(eax, 0x5d);                         /* cmp eax, 0x5d */
            ii(0x1013_4564, 2); if(jge(0x1013_459b, 0x35)) goto l_0x1013_459b; /* jge 0x1013459b */
            ii(0x1013_4566, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1013_4577, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1013_4588, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
