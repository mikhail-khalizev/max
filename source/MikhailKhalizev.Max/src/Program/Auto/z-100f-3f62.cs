...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_3f62()
        {
            ...
            ii(0x100f_3f7a, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
        l_0x100f_3f7d:
            ii(0x100f_3f7d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_3f80, 4); cmp(memb[ds, eax + 0x3e], 0x6);         /* cmp byte [eax+0x3e], 0x6 */
            ii(0x100f_3f84, 2); if(jnz(0x100f_3f8f, 0x9)) goto l_0x100f_3f8f; /* jnz 0x100f3f8f */
        ...
        l_0x100f_3f8f:
            ...
            ii(0x100f_3f94, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_3f97, 4); cmp(memb[ds, eax + 0x3e], 0x19);        /* cmp byte [eax+0x3e], 0x19 */
            ...
            ii(0x100f_3fc8, 2); if(jz(0x100f_3fd3, 0x9)) goto l_0x100f_3fd3; /* jz 0x100f3fd3 */
            ii(0x100f_3fca, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
        ...
        l_0x100f_3fd3:
            ...
            ii(0x100f_3fe9, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x100f_3fec:
            ...
            ii(0x100f_4007, 3); lea(edx, memd[ss, ebp - 0xc]);          /* lea edx, [ebp-0xc] */
            ii(0x100f_400a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100f_4019, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x100f_401c, 5); call(0x1008_8b04, -0x6_b51d);           /* call 0x10088b04 */
            ii(0x100f_4021, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_4024, 3); mov(dl, memb[ds, eax + 0x3f]);          /* mov dl, [eax+0x3f] */
            ii(0x100f_4027, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_402a, 3); mov(memb[ds, eax + 0x3d], dl);          /* mov [eax+0x3d], dl */
            ii(0x100f_402d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_4030, 3); mov(dl, memb[ds, eax + 0x40]);          /* mov dl, [eax+0x40] */
            ii(0x100f_4033, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_4036, 3); mov(memb[ds, eax + 0x3e], dl);          /* mov [eax+0x3e], dl */
            ii(0x100f_4039, 2); jmp(0x100f_4095, 0x5a); goto l_0x100f_4095; /* jmp 0x100f4095 */
        l_0x100f_403b:
            ii(0x100f_403b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_403e, 4); mov(dx, memw[ds, eax + 0x1a]);          /* mov dx, [eax+0x1a] */
            ii(0x100f_4042, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_4045, 4); mov(memw[ds, eax + 0x41], dx);          /* mov [eax+0x41], dx */
            ii(0x100f_4049, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_404c, 4); mov(dx, memw[ds, eax + 0x1c]);          /* mov dx, [eax+0x1c] */
            ii(0x100f_4050, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_4053, 4); mov(memw[ds, eax + 0x43], dx);          /* mov [eax+0x43], dx */
            ii(0x100f_4057, 5); mov(ebx, 0xd);                          /* mov ebx, 0xd */
            ii(0x100f_405c, 5); mov(edx, 0x4);                          /* mov edx, 0x4 */
            ii(0x100f_4061, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_4064, 5); call(0x1016_3053, 0x6_efea);            /* call 0x10163053 */
            ii(0x100f_4069, 5); mov(edx, 0x101c_37bc);                  /* mov edx, 0x101c37bc */
            ii(0x100f_406e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
