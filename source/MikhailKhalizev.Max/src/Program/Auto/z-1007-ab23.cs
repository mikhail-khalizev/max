...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_ab23()
        {
            ...
            ii(0x1007_ab3a, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_ab3d, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1007_ab40, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_ab43, 3); mov(al, memb[ds, eax + 0x4e]);          /* mov al, [eax+0x4e] */
            ...
            ii(0x1007_ab4f, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1007_ab52, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_ab55, 5); call(0x1015_2a52, 0xd_7ef8);            /* call 0x10152a52 */
            ii(0x1007_ab5a, 2); test(al, al);                           /* test al, al */
            ii(0x1007_ab5c, 2); if(jnz(0x1007_ab64, 0x6)) goto l_0x1007_ab64; /* jnz 0x1007ab64 */
        l_0x1007_ab5e:
            ii(0x1007_ab5e, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
        ...
        l_0x1007_ab64:
            ...
            ii(0x1007_ab69, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1007_ab6c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_ab6f, 5); call(0x1007_8d4a, -0x1e2a);             /* call 0x10078d4a */
            ii(0x1007_ab74, 2); test(al, al);                           /* test al, al */
            ii(0x1007_ab76, 2); if(jz(0x1007_ab7e, 0x6)) goto l_0x1007_ab7e; /* jz 0x1007ab7e */
            ii(0x1007_ab78, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1007_ab7c, 2); jmp(0x1007_ab8c, 0xe); goto l_0x1007_ab8c; /* jmp 0x1007ab8c */
        l_0x1007_ab7e:
            ii(0x1007_ab7e, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_ab81, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_ab84, 5); call(0x1007_aa70, -0x119);              /* call 0x1007aa70 */
            ii(0x1007_ab89, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
        l_0x1007_ab8c:
            ii(0x1007_ab8c, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
