...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_d8e9()
        {
            ...
            ii(0x1011_d900, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_d903, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1011_d906, 5); cmp(memw[ss, ebp - 0x4], -0x1 /* 0xff */); /* cmp word [ebp-0x4], 0xffff */
            ii(0x1011_d90b, 2); if(jnz(0x1011_d91c, 0xf)) goto l_0x1011_d91c; /* jnz 0x1011d91c */
            ii(0x1011_d90d, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_d90f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1011_d91c:
            ...
            ii(0x1011_d926, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1011_d929, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1011_d92c, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1011_d92f, 4); cmp(memd[ss, ebp - 0x10], 0);           /* cmp dword [ebp-0x10], 0x0 */
            ...
            ii(0x1011_d941, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_d944, 3); add(eax, 0x6);                          /* add eax, 0x6 */
            ii(0x1011_d947, 5); call(0x1007_6574, -0xa_73d8);           /* call 0x10076574 */
            ii(0x1011_d94c, 3); mov(al, memb[ds, eax + 0x26]);          /* mov al, [eax+0x26] */
            ii(0x1011_d94f, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1011_d951, 3); movsx(ebx, ax);                         /* movsx ebx, ax */
            ii(0x1011_d954, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x1011_d958, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1011_d95b, 5); call(0x1014_9237, 0x2_b8d7);            /* call 0x10149237 */
            ii(0x1011_d960, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1011_d963, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1011_d966, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1011_d969, 2); jmp(0x1011_d971, 0x6); goto l_0x1011_d971; /* jmp 0x1011d971 */
        l_0x1011_d96b:
            ii(0x1011_d96b, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1011_d96e, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
        l_0x1011_d971:
            ii(0x1011_d971, 3); mov(edx, memd[ss, ebp - 0x18]);         /* mov edx, [ebp-0x18] */
            ii(0x1011_d974, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
