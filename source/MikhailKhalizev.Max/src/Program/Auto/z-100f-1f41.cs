...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_1f41()
        {
            ...
            ii(0x100f_1f69, 7); mov(memd[ss, ebp - 0x10], 2);           /* mov dword [ebp-0x10], 0x2 */
            ii(0x100f_1f70, 2); jmp(0x100f_1f79, 7); goto l_0x100f_1f79; /* jmp 0x100f1f79 */
        l_0x100f_1f72:
            ii(0x100f_1f72, 7); mov(memd[ss, ebp - 0x10], 1);           /* mov dword [ebp-0x10], 0x1 */
        l_0x100f_1f79:
        ...
        l_0x100f_1fcf:
            ii(0x100f_1fcf, 7); mov(memd[ss, ebp - 0x14], 1);           /* mov dword [ebp-0x14], 0x1 */
