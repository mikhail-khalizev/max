...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_61bb()
        {
            ...
            ii(0x1010_61d2, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_61d5, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x1010_61d8, 4); cmp(memb[ss, ebp - 0x4], 0x76);         /* cmp byte [ebp-0x4], 0x76 */
            ii(0x1010_61dc, 2); if(jge(0x1010_61f3, 0x15)) goto l_0x1010_61f3; /* jge 0x101061f3 */
            ii(0x1010_61de, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ii(0x1010_61e2, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_61e5, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x1010_61e8, 6); mov(eax, memd[ds, eax + 0xac]);         /* mov eax, [eax+0xac] */
            ii(0x1010_61ee, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1010_61f1, 2); jmp(0x1010_61fa, 0x7); goto l_0x1010_61fa; /* jmp 0x101061fa */
        l_0x1010_61f3:
