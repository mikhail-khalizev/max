...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_a9fd()
        {
            ...
            ii(0x100f_aa15, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100f_aa18, 5); mov(eax, 0x2);                          /* mov eax, 0x2 */
            ii(0x100f_aa1d, 5); call(0x100e_883d, -0x1_21e5);           /* call 0x100e883d */
            ii(0x100f_aa22, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100f_aa25, 6); mov(edx, memd[ds, 0x101c_38ec]);        /* mov edx, [0x101c38ec] */
            ii(0x100f_aa2b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100f_aa43, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100f_aa46, 3); mov(memd[ds, edx + 0x4], eax);          /* mov [edx+0x4], eax */
            ii(0x100f_aa49, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_aa4c, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ii(0x100f_aa4f, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x100f_aa61, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_aa64, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x100f_aa66, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_aa69, 2); add(ebx, edx);                          /* add ebx, edx */
            ii(0x100f_aa6b, 3); mov(memd[ds, eax + 0x8], ebx);          /* mov [eax+0x8], ebx */
            ii(0x100f_aa6e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_aa71, 3); mov(eax, memd[ds, eax + 0xc]);          /* mov eax, [eax+0xc] */
            ii(0x100f_aa74, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100f_aa77, 3); sub(eax, memd[ds, edx + 0x4]);          /* sub eax, [edx+0x4] */
            ...
            ii(0x100f_aa87, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_aa8a, 3); mov(edx, memd[ds, eax + 0x4]);          /* mov edx, [eax+0x4] */
            ii(0x100f_aa8d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_aa90, 2); add(ebx, edx);                          /* add ebx, edx */
            ii(0x100f_aa92, 3); mov(memd[ds, eax + 0xc], ebx);          /* mov [eax+0xc], ebx */
