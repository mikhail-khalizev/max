...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_ca4f()
        {
            ...
            ii(0x100f_ca67, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100f_ca6a, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100f_ca6d, 3); mov(ax, memw[ds, eax]);                 /* mov ax, [eax] */
            ii(0x100f_ca70, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100f_ca73, 2); jmp(0x100f_ca79, 4); goto l_0x100f_ca79; /* jmp 0x100fca79 */
        l_0x100f_ca75:
            ii(0x100f_ca75, 4); add(memd[ss, ebp - 12], 2);             /* add dword [ebp-0xc], 0x2 */
        l_0x100f_ca79:
            ii(0x100f_ca79, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x100f_ca85, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100f_ca88, 4); mov(ax, memw[ds, eax + 2]);             /* mov ax, [eax+0x2] */
            ii(0x100f_ca8c, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100f_ca8f, 2); jmp(0x100f_ca95, 4); goto l_0x100f_ca95; /* jmp 0x100fca95 */
        l_0x100f_ca91:
            ii(0x100f_ca91, 4); add(memd[ss, ebp - 8], 2);              /* add dword [ebp-0x8], 0x2 */
        l_0x100f_ca95:
            ii(0x100f_ca95, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x100f_caa1, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100f_caa4, 3); add(eax, 6);                            /* add eax, 0x6 */
            ii(0x100f_caa7, 5); call(0x100f_c32c, -0x780);              /* call 0x100fc32c */
            ii(0x100f_caac, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100f_caae, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100f_cab1, 4); mov(bx, memw[ds, eax + 4]);             /* mov bx, [eax+0x4] */
            ii(0x100f_cab5, 2); add(ebx, edx);                          /* add ebx, edx */
            ii(0x100f_cab7, 4); movsx(eax, memw[ss, ebp - 8]);          /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x100f_cac7, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
