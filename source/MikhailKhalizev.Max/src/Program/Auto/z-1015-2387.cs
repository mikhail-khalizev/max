...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_2387()
        {
            ...
            ii(0x1015_23a5, 4); cmp(memb[ds, eax + 61], 0x15);          /* cmp byte [eax+0x3d], 0x15 */
            ...
            ii(0x1015_23ae, 4); cmp(memb[ds, eax + 61], 0x1f);          /* cmp byte [eax+0x3d], 0x1f */
        ...
        l_0x1015_23b6:
            ...
            ii(0x1015_23b9, 3); mov(al, memb[ds, eax + 38]);            /* mov al, [eax+0x26] */
            ...
            ii(0x1015_23d4, 3); mov(memb[ds, eax + 69], dl);            /* mov [eax+0x45], dl */
        l_0x1015_23d7:
            ii(0x1015_23d7, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1015_23da, 4); mov(memb[ds, eax + 61], 0);             /* mov byte [eax+0x3d], 0x0 */
            ii(0x1015_23de, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1015_23e1, 4); mov(memb[ds, eax + 62], 1);             /* mov byte [eax+0x3e], 0x1 */
