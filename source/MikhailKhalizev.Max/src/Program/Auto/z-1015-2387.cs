...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_2387()
        {
            ...
            ii(0x1015_239f, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_23a2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_23a5, 4); cmp(memb[ds, eax + 0x3d], 0x15);        /* cmp byte [eax+0x3d], 0x15 */
            ii(0x1015_23a9, 2); if(jz(0x1015_23b4, 0x9)) goto l_0x1015_23b4; /* jz 0x101523b4 */
            ii(0x1015_23ab, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_23ae, 4); cmp(memb[ds, eax + 0x3d], 0x1f);        /* cmp byte [eax+0x3d], 0x1f */
            ii(0x1015_23b2, 2); if(jnz(0x1015_23b6, 0x2)) goto l_0x1015_23b6; /* jnz 0x101523b6 */
        l_0x1015_23b4:
            ii(0x1015_23b4, 2); jmp(0x1015_23d7, 0x21); goto l_0x1015_23d7; /* jmp 0x101523d7 */
        l_0x1015_23b6:
            ii(0x1015_23b6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_23c1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_23d1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_23d4, 3); mov(memb[ds, eax + 0x45], dl);          /* mov [eax+0x45], dl */
        l_0x1015_23d7:
            ii(0x1015_23d7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_23da, 4); mov(memb[ds, eax + 0x3d], 0);           /* mov byte [eax+0x3d], 0x0 */
            ii(0x1015_23de, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_23e1, 4); mov(memb[ds, eax + 0x3e], 0x1);         /* mov byte [eax+0x3e], 0x1 */
            ii(0x1015_23e5, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1015_23e7, 5); mov(edx, 0x4);                          /* mov edx, 0x4 */
            ii(0x1015_23ec, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
