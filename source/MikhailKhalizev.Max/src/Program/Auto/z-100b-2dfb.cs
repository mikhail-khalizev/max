...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_2dfb()
        {
            ...
            ii(0x100b_2e11, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100b_2e14, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100b_2e17, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ii(0x100b_2e1a, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100b_2e1d, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100b_2e20, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ii(0x100b_2e24, 2); if(jnz(0x100b_2e4e, 0x28)) goto l_0x100b_2e4e; /* jnz 0x100b2e4e */
            ii(0x100b_2e26, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_2e29, 3); mov(al, memb[ds, eax + 0x4e]);          /* mov al, [eax+0x4e] */
            ii(0x100b_2e2c, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x100b_2e31, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100b_2e33, 2); if(jle(0x100b_2e3b, 0x6)) goto l_0x100b_2e3b; /* jle 0x100b2e3b */
            ii(0x100b_2e35, 4); mov(memb[ss, ebp - 0x14], 0x1);         /* mov byte [ebp-0x14], 0x1 */
            ii(0x100b_2e39, 2); jmp(0x100b_2e3f, 0x4); goto l_0x100b_2e3f; /* jmp 0x100b2e3f */
        l_0x100b_2e3b:
            ii(0x100b_2e3b, 4); mov(memb[ss, ebp - 0x14], 0);           /* mov byte [ebp-0x14], 0x0 */
        l_0x100b_2e3f:
            ii(0x100b_2e3f, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_2e41, 3); mov(dl, memb[ss, ebp - 0x14]);          /* mov dl, [ebp-0x14] */
            ii(0x100b_2e44, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100b_2e4e:
            ii(0x100b_2e4e, 4); cmp(memb[ss, ebp - 0x4], 0x2);          /* cmp byte [ebp-0x4], 0x2 */
            ii(0x100b_2e52, 2); if(jnz(0x100b_2e71, 0x1d)) goto l_0x100b_2e71; /* jnz 0x100b2e71 */
            ii(0x100b_2e54, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x100b_2e61, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100b_2e64, 5); call(0x100b_1814, -0x1655);             /* call 0x100b1814 */
            ii(0x100b_2e69, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
