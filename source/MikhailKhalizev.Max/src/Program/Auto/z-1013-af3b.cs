...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("7719f740-fc81-4b68-b089-c764dcb10db3")]
        public void Method_1013_af3b()
        {
            ii(0x1013_af3b, 5); pushd(0x38);                            /* push 0x38 */
            ii(0x1013_af40, 5); calld(Definitions.sys_check_available_stack_size, 0x2_ae0d); /* call 0x10165d52 */
            ...
            ii(0x1013_af5f, 5); calld(Definitions.sys_new, 0x2_ae9c);   /* call 0x10165e00 */
