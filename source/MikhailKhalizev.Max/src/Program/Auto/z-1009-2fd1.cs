...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_2fd1()
        {
            ...
            ii(0x1009_2fe9, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_2fec, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_2fef, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1009_2ff2, 5); call(0x1013_a6f4, 0xa_76fd);            /* call 0x1013a6f4 */
            ii(0x1009_2ff7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_3004, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_3007, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x1009_300a, 5); call(0x1008_afe4, -0x802b);             /* call 0x1008afe4 */
            ii(0x1009_300f, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
