...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_fc13()
        {
            ...
            ii(0x100f_fc4e, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x100f_fc55, 2); jmp(0x100f_fc5d, 0x6); goto l_0x100f_fc5d; /* jmp 0x100ffc5d */
        l_0x100f_fc57:
            ii(0x100f_fc57, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_fc5a, 3); inc(memd[ss, ebp - 0x4]);               /* inc dword [ebp-0x4] */
        l_0x100f_fc5d:
            ii(0x100f_fc5d, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_fc61, 3); cmp(eax, 0x18);                         /* cmp eax, 0x18 */
            ii(0x100f_fc64, 2); if(jae(0x100f_fc93, 0x2d)) goto l_0x100f_fc93; /* jae 0x100ffc93 */
            ii(0x100f_fc66, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_fc7f, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
