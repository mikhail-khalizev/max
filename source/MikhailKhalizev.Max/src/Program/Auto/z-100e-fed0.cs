...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x100f_0042:
            ii(0x100f_0042, 5); cmp(memw[ss, ebp - 0x20], 4);           /* cmp word [ebp-0x20], 0x4 */
            ii(0x100f_0047, 2); if(jb(0x100f_0061, 0x18)) goto l_0x100f_0061; /* jb 0x100f0061 */
            ii(0x100f_0049, 5); cmp(memw[ss, ebp - 0x20], 4);           /* cmp word [ebp-0x20], 0x4 */
            ii(0x100f_004e, 6); if(jbe(0x100e_ffcd, -0x87)) goto l_0x100e_ffcd; /* jbe 0x100effcd */
            ii(0x100f_0054, 5); cmp(memw[ss, ebp - 0x20], 7);           /* cmp word [ebp-0x20], 0x7 */
