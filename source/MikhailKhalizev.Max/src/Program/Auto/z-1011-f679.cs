...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("14be85a8-2d85-4a25-aded-7bb78fb6d700")]
        public void Method_1011_f679()
        {
            ii(0x1011_f679, 5); pushd(0xd4);                            /* push 0xd4 */
            ii(0x1011_f67e, 5); calld(Definitions.sys_check_available_stack_size, 0x4_66cf); /* call 0x10165d52 */
            ...
            ii(0x1011_f69a, 5); calld(0x1007_6b90, -0xa_8b0f);          /* call 0x10076b90 */
            ...
            ii(0x1011_f6ca, 5); calld(0x100b_7fa4, -0x6_772b);          /* call 0x100b7fa4 */
            ...
            ii(0x1011_f6e9, 5); calld(0x100b_7f18, -0x6_77d6);          /* call 0x100b7f18 */
            ii(0x1011_f6ee, 5); calld(Definitions.my__get_unit, -0x6_76d7); /* call 0x100b801c */
            ii(0x1011_f6f3, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1011_f6f5, 3); lea(eax, ebp - 0x54);                   /* lea eax, [ebp-0x54] */
            ii(0x1011_f6f8, 5); calld(0x1007_66ac, -0xa_9051);          /* call 0x100766ac */
            ii(0x1011_f6fd, 3); lea(edx, ebp - 0x50);                   /* lea edx, [ebp-0x50] */
            ii(0x1011_f700, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1011_f703, 5); calld(0x100b_7f18, -0x6_77f0);          /* call 0x100b7f18 */
            ii(0x1011_f708, 5); calld(0x100b_808c, -0x6_7681);          /* call 0x100b808c */
            ii(0x1011_f70d, 3); lea(eax, ebp - 0x54);                   /* lea eax, [ebp-0x54] */
            ii(0x1011_f710, 5); calld(0x1007_6574, -0xa_91a1);          /* call 0x10076574 */
            ...
            ii(0x1011_f71e, 5); calld(0x1007_6574, -0xa_91af);          /* call 0x10076574 */
            ...
            ii(0x1011_f72c, 5); calld(0x1007_6aac, -0xa_8c85);          /* call 0x10076aac */
            ii(0x1011_f731, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1011_f734, 5); calld(0x100b_7f18, -0x6_7821);          /* call 0x100b7f18 */
            ...
            ii(0x1011_f751, 5); calld(0x100b_7fa4, -0x6_77b2);          /* call 0x100b7fa4 */
            ii(0x1011_f756, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_f758, 3); lea(eax, ebp - 0x54);                   /* lea eax, [ebp-0x54] */
            ii(0x1011_f75b, 5); calld(0x1007_5f2c, -0xa_9834);          /* call 0x10075f2c */
        ...
        l_0x1011_f76f:
            ii(0x1011_f76f, 5); calld(0x1014_82f4, 0x2_8b80);           /* call 0x101482f4 */
        ...
        l_0x1011_f7d7:
            ...
            ii(0x1011_f7e6, 5); calld(0x1007_5f2c, -0xa_98bf);          /* call 0x10075f2c */
        ...
        l_0x1011_f7fa:
            ...
            ii(0x1011_f800, 5); calld(0x1007_5e64, -0xa_99a1);          /* call 0x10075e64 */
            ...
            ii(0x1011_f80d, 5); calld(0x1007_5e64, -0xa_99ae);          /* call 0x10075e64 */
            ii(0x1011_f812, 2); mov(edx, ebx);                          /* mov edx, ebx */
            ii(0x1011_f814, 5); calld(0x1007_0c51, -0xa_ebc8);          /* call 0x10070c51 */
            ...
            ii(0x1011_f82a, 5); calld(0x100b_7f18, -0x6_7917);          /* call 0x100b7f18 */
            ...
            ii(0x1011_f843, 5); calld(0x1007_65d0, -0xa_9278);          /* call 0x100765d0 */
            ii(0x1011_f848, 5); calld(0x1007_510b, -0xa_a742);          /* call 0x1007510b */
        ...
        l_0x1011_f85c:
            ...
            ii(0x1011_f85f, 5); calld(0x100b_7f18, -0x6_794c);          /* call 0x100b7f18 */
            ...
            ii(0x1011_f878, 5); calld(0x1007_6574, -0xa_9309);          /* call 0x10076574 */
            ...
            ii(0x1011_f888, 5); calld(0x1007_6574, -0xa_9319);          /* call 0x10076574 */
            ii(0x1011_f88d, 3); mov(eax, memd_a32[ds, eax + 0x6]);      /* mov eax, [eax+0x6] */
            ii(0x1011_f890, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1011_f893, 5); calld(0x1007_02b9, -0xa_f5df);          /* call 0x100702b9 */
            ...
            ii(0x1011_f8a5, 5); calld(0x100b_7f18, -0x6_7992);          /* call 0x100b7f18 */
            ii(0x1011_f8aa, 5); calld(0x100b_80c4, -0x6_77eb);          /* call 0x100b80c4 */
            ...
            ii(0x1011_f8b8, 5); calld(0x1007_5e64, -0xa_9a59);          /* call 0x10075e64 */
            ii(0x1011_f8bd, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1011_f8bf, 3); lea(eax, ebp - 0x54);                   /* lea eax, [ebp-0x54] */
            ii(0x1011_f8c2, 5); calld(0x1008_abbc, -0x9_4d0b);          /* call 0x1008abbc */
            ii(0x1011_f8c7, 5); calld(0x100a_90f9, -0x7_67d3);          /* call 0x100a90f9 */
        ...
        l_0x1011_f8eb:
            ...
            ii(0x1011_f8f0, 5); calld(Definitions.sys_new, 0x4_650b);   /* call 0x10165e00 */
        ...
        l_0x1011_f925:
            ...
            ii(0x1011_f92b, 5); calld(0x100a_b3b0, -0x7_4580);          /* call 0x100ab3b0 */
            ...
            ii(0x1011_f945, 5); calld(0x100a_b2e0, -0x7_466a);          /* call 0x100ab2e0 */
            ii(0x1011_f94a, 5); calld(0x1011_aca3, -0x4cac);            /* call 0x1011aca3 */
            ii(0x1011_f94f, 3); lea(eax, ebp - 0x74);                   /* lea eax, [ebp-0x74] */
            ii(0x1011_f952, 5); calld(0x100a_b33c, -0x7_461b);          /* call 0x100ab33c */
            ...
            ii(0x1011_f968, 5); calld(0x100a_9f38, -0x7_5a35);          /* call 0x100a9f38 */
        l_0x1011_f96d:
            ii(0x1011_f96d, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_f96f, 3); lea(eax, ebp - 0x54);                   /* lea eax, [ebp-0x54] */
            ii(0x1011_f972, 5); calld(0x1007_5f2c, -0xa_9a4b);          /* call 0x10075f2c */
        ...
        l_0x1011_f986:
            ...
            ii(0x1011_f989, 5); calld(0x1007_65d0, -0xa_93be);          /* call 0x100765d0 */
            ...
            ii(0x1011_f9ab, 5); calld(0x1007_5f2c, -0xa_9a84);          /* call 0x10075f2c */
        ...
        l_0x1011_f9bf:
            ...
            ii(0x1011_f9c2, 5); calld(0x100b_7f18, -0x6_7aaf);          /* call 0x100b7f18 */
            ii(0x1011_f9c7, 5); calld(0x100b_8054, -0x6_7978);          /* call 0x100b8054 */
            ...
            ii(0x1011_f9d3, 5); calld(0x100b_7f18, -0x6_7ac0);          /* call 0x100b7f18 */
            ii(0x1011_f9d8, 5); calld(0x100b_8054, -0x6_7989);          /* call 0x100b8054 */
        ...
        l_0x1011_f9f0:
            ...
            ii(0x1011_fa1f, 5); calld(0x1007_5e64, -0xa_9bc0);          /* call 0x10075e64 */
            ii(0x1011_fa24, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1011_fa26, 6); lea(eax, ebp - 0xa8);                   /* lea eax, [ebp-0xa8] */
            ii(0x1011_fa2c, 5); calld(0x1009_034f, -0x8_f6e2);          /* call 0x1009034f */
            ...
            ii(0x1011_fa55, 5); calld(0x100b_7368, -0x6_86f2);          /* call 0x100b7368 */
            ...
            ii(0x1011_fa6f, 5); calld(0x1007_5f2c, -0xa_9b48);          /* call 0x10075f2c */
        ...
        l_0x1011_fa83:
            ...
            ii(0x1011_fa88, 5); calld(Definitions.sys_new, 0x4_6373);   /* call 0x10165e00 */
            ...
            ii(0x1011_faa7, 5); calld(0x1007_5e64, -0xa_9c48);          /* call 0x10075e64 */
            ...
            ii(0x1011_fab4, 5); calld(0x1007_5e64, -0xa_9c55);          /* call 0x10075e64 */
        ...
        l_0x1011_fada:
            ...
            ii(0x1011_faeb, 5); calld(Definitions.sys_new, 0x4_6310);   /* call 0x10165e00 */
            ...
            ii(0x1011_fb0a, 5); calld(0x1007_5e64, -0xa_9cab);          /* call 0x10075e64 */
            ...
            ii(0x1011_fb17, 5); calld(0x1007_5e64, -0xa_9cb8);          /* call 0x10075e64 */
        ...
        l_0x1011_fb3d:
            ...
            ii(0x1011_fb54, 5); calld(0x1007_5e64, -0xa_9cf5);          /* call 0x10075e64 */
            ...
            ii(0x1011_fb6e, 5); calld(0x1007_5e64, -0xa_9d0f);          /* call 0x10075e64 */
            ...
            ii(0x1011_fb85, 5); calld(0x1007_5f2c, -0xa_9c5e);          /* call 0x10075f2c */
