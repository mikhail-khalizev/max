...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_51b4()
        {
            ...
            ii(0x1012_51cb, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1012_51ce, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1012_51d1, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1012_51d3, 4); mov(ax, memw[ss, ebp - 0x4]);           /* mov ax, [ebp-0x4] */
            ii(0x1012_51d7, 5); call(0x1012_4fa5, -0x237);              /* call 0x10124fa5 */
            ii(0x1012_51dc, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1012_51df, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x1012_51e3, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1012_51e5, 2); if(jnz(0x1012_51f3, 0xc)) goto l_0x1012_51f3; /* jnz 0x101251f3 */
            ii(0x1012_51e7, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
        ...
        l_0x1012_51f3:
            ...
            ii(0x1012_5200, 3); idiv(memd[ss, ebp - 0x8]);              /* idiv dword [ebp-0x8] */
            ii(0x1012_5203, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ...
            ii(0x1012_5217, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_521a, 6); mov(memw[ds, 0x101b_b45c], ax);         /* mov [0x101bb45c], ax */
            ii(0x1012_5220, 7); mov(memd[ss, ebp - 0x2c], 0x204);       /* mov dword [ebp-0x2c], 0x204 */
            ii(0x1012_5227, 5); mov(al, memb[ds, 0x101b_b45a]);         /* mov al, [0x101bb45a] */
            ii(0x1012_522c, 3); mov(memb[ss, ebp - 0x28], al);          /* mov [ebp-0x28], al */
            ii(0x1012_522f, 3); lea(ebx, memd[ss, ebp - 0x2c]);         /* lea ebx, [ebp-0x2c] */
            ii(0x1012_5232, 3); lea(edx, memd[ss, ebp - 0x2c]);         /* lea edx, [ebp-0x2c] */
            ii(0x1012_5235, 5); mov(eax, 0x31);                         /* mov eax, 0x31 */
            ii(0x1012_523a, 5); call(/* sys */ 0x1016_c606, 0x4_73c7);  /* call 0x1016c606 */
            ii(0x1012_523f, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x1012_5242, 6); mov(memw[ds, 0x101c_59ac], ax);         /* mov [0x101c59ac], ax */
            ii(0x1012_5248, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1012_524b, 5); mov(memd[ds, 0x101c_59a8], eax);        /* mov [0x101c59a8], eax */
            ii(0x1012_5250, 7); mov(memd[ss, ebp - 0x2c], 0x200);       /* mov dword [ebp-0x2c], 0x200 */
            ii(0x1012_5257, 5); mov(al, memb[ds, 0x101b_b45a]);         /* mov al, [0x101bb45a] */
            ii(0x1012_525c, 3); mov(memb[ss, ebp - 0x28], al);          /* mov [ebp-0x28], al */
            ii(0x1012_525f, 3); lea(ebx, memd[ss, ebp - 0x2c]);         /* lea ebx, [ebp-0x2c] */
            ii(0x1012_5262, 3); lea(edx, memd[ss, ebp - 0x2c]);         /* lea edx, [ebp-0x2c] */
            ii(0x1012_5265, 5); mov(eax, 0x31);                         /* mov eax, 0x31 */
            ii(0x1012_526a, 5); call(/* sys */ 0x1016_c606, 0x4_7397);  /* call 0x1016c606 */
            ii(0x1012_526f, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x1012_5272, 6); mov(memw[ds, 0x101c_59a4], ax);         /* mov [0x101c59a4], ax */
            ii(0x1012_5278, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1012_527b, 6); mov(memw[ds, 0x101c_59a6], ax);         /* mov [0x101c59a6], ax */
            ii(0x1012_5281, 3); mov(memw[ss, ebp - 0x30], ds);          /* mov [ebp-0x30], ds */
            ii(0x1012_5284, 7); mov(memd[ss, ebp - 0x34], 0x1019_f135); /* mov dword [ebp-0x34], 0x1019f135 */
            ii(0x1012_528b, 3); mov(memw[ss, ebp - 0x38], ds);          /* mov [ebp-0x38], ds */
            ii(0x1012_528e, 7); mov(memd[ss, ebp - 0x3c], 0x101b_b45c); /* mov dword [ebp-0x3c], 0x101bb45c */
            ii(0x1012_5295, 3); mov(ecx, memd[ss, ebp - 0x34]);         /* mov ecx, [ebp-0x34] */
            ii(0x1012_5298, 3); mov(eax, memd[ss, ebp - 0x38]);         /* mov eax, [ebp-0x38] */
            ii(0x1012_529b, 3); mov(ebx, memd[ss, ebp - 0x3c]);         /* mov ebx, [ebp-0x3c] */
            ...
            ii(0x1012_52a6, 4); mov(memw[ss, ebp - 0x30], ax);          /* mov [ebp-0x30], ax */
            ii(0x1012_52aa, 3); mov(memd[ss, ebp - 0x34], ebx);         /* mov [ebp-0x34], ebx */
            ii(0x1012_52ad, 7); mov(dx, memw[ds, 0x101b_b45c]);         /* mov dx, [0x101bb45c] */
            ii(0x1012_52b4, 4); lgs(eax, memd[ss, ebp - 0x34]);         /* lgs eax, [ebp-0x34] */
            ii(0x1012_52b8, 4); mov(memw[gs, eax], dx);                 /* mov [gs:eax], dx */
            ii(0x1012_52bc, 3); mov(memw[ss, ebp - 0x30], ds);          /* mov [ebp-0x30], ds */
            ii(0x1012_52bf, 7); mov(memd[ss, ebp - 0x34], 0x1019_f14d); /* mov dword [ebp-0x34], 0x1019f14d */
            ii(0x1012_52c6, 3); mov(ecx, memd[ss, ebp - 0x34]);         /* mov ecx, [ebp-0x34] */
            ii(0x1012_52c9, 3); mov(eax, memd[ss, ebp - 0x38]);         /* mov eax, [ebp-0x38] */
            ii(0x1012_52cc, 3); mov(ebx, memd[ss, ebp - 0x3c]);         /* mov ebx, [ebp-0x3c] */
            ...
            ii(0x1012_52d7, 4); mov(memw[ss, ebp - 0x30], ax);          /* mov [ebp-0x30], ax */
            ii(0x1012_52db, 3); mov(memd[ss, ebp - 0x34], ebx);         /* mov [ebp-0x34], ebx */
            ii(0x1012_52de, 4); lgs(eax, memd[ss, ebp - 0x34]);         /* lgs eax, [ebp-0x34] */
            ii(0x1012_52e2, 6); mov(memw[gs, eax], 0x2cc);              /* mov word [gs:eax], 0x2cc */
            ii(0x1012_52e8, 3); mov(memw[ss, ebp - 0x30], ds);          /* mov [ebp-0x30], ds */
            ii(0x1012_52eb, 7); mov(memd[ss, ebp - 0x34], 0x1019_f151); /* mov dword [ebp-0x34], 0x1019f151 */
            ii(0x1012_52f2, 3); mov(ecx, memd[ss, ebp - 0x34]);         /* mov ecx, [ebp-0x34] */
            ii(0x1012_52f5, 3); mov(eax, memd[ss, ebp - 0x38]);         /* mov eax, [ebp-0x38] */
            ii(0x1012_52f8, 3); mov(ebx, memd[ss, ebp - 0x3c]);         /* mov ebx, [ebp-0x3c] */
            ...
            ii(0x1012_5303, 4); mov(memw[ss, ebp - 0x30], ax);          /* mov [ebp-0x30], ax */
            ii(0x1012_5307, 3); mov(memd[ss, ebp - 0x34], ebx);         /* mov [ebp-0x34], ebx */
            ii(0x1012_530a, 4); lgs(eax, memd[ss, ebp - 0x34]);         /* lgs eax, [ebp-0x34] */
            ii(0x1012_530e, 6); mov(memw[gs, eax], 0x133);              /* mov word [gs:eax], 0x133 */
            ii(0x1012_5314, 3); mov(memw[ss, ebp - 0x30], ds);          /* mov [ebp-0x30], ds */
            ii(0x1012_5317, 7); mov(memd[ss, ebp - 0x34], 0x1019_f156); /* mov dword [ebp-0x34], 0x1019f156 */
            ii(0x1012_531e, 3); mov(ecx, memd[ss, ebp - 0x34]);         /* mov ecx, [ebp-0x34] */
            ii(0x1012_5321, 3); mov(eax, memd[ss, ebp - 0x38]);         /* mov eax, [ebp-0x38] */
            ii(0x1012_5324, 3); mov(ebx, memd[ss, ebp - 0x3c]);         /* mov ebx, [ebp-0x3c] */
            ...
            ii(0x1012_532f, 4); mov(memw[ss, ebp - 0x30], ax);          /* mov [ebp-0x30], ax */
            ii(0x1012_5333, 3); mov(memd[ss, ebp - 0x34], ebx);         /* mov [ebp-0x34], ebx */
            ii(0x1012_5336, 4); lgs(eax, memd[ss, ebp - 0x34]);         /* lgs eax, [ebp-0x34] */
            ii(0x1012_533a, 6); mov(memw[gs, eax], 0x400);              /* mov word [gs:eax], 0x400 */
            ii(0x1012_5340, 3); mov(memw[ss, ebp - 0x30], ds);          /* mov [ebp-0x30], ds */
            ii(0x1012_5343, 7); mov(memd[ss, ebp - 0x34], 0x1019_f15a); /* mov dword [ebp-0x34], 0x1019f15a */
            ii(0x1012_534a, 3); mov(ecx, memd[ss, ebp - 0x34]);         /* mov ecx, [ebp-0x34] */
            ii(0x1012_534d, 3); mov(eax, memd[ss, ebp - 0x38]);         /* mov eax, [ebp-0x38] */
            ii(0x1012_5350, 3); mov(ebx, memd[ss, ebp - 0x3c]);         /* mov ebx, [ebp-0x3c] */
            ...
            ii(0x1012_535b, 4); mov(memw[ss, ebp - 0x30], ax);          /* mov [ebp-0x30], ax */
            ii(0x1012_535f, 3); mov(memd[ss, ebp - 0x34], ebx);         /* mov [ebp-0x34], ebx */
            ii(0x1012_5362, 4); lgs(eax, memd[ss, ebp - 0x34]);         /* lgs eax, [ebp-0x34] */
            ...
            ii(0x1012_539b, 3); mov(memd[ss, ebp - 0x40], eax);         /* mov [ebp-0x40], eax */
            ii(0x1012_539e, 4); cmp(memd[ss, ebp - 0x40], 0);           /* cmp dword [ebp-0x40], 0x0 */
            ii(0x1012_53a2, 2); if(jnz(0x1012_53b0, 0xc)) goto l_0x1012_53b0; /* jnz 0x101253b0 */
            ii(0x1012_53a4, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
        ...
        l_0x1012_53b0:
            ...
            ii(0x1012_53c3, 3); mov(esi, memd[ss, ebp - 0x40]);         /* mov esi, [ebp-0x40] */
            ...
            ii(0x1012_53f2, 3); mov(ebx, memd[ss, ebp - 0x40]);         /* mov ebx, [ebp-0x40] */
            ...
            ii(0x1012_5404, 3); mov(memw[ss, ebp - 0x38], cs);          /* mov [ebp-0x38], cs */
            ii(0x1012_5407, 7); mov(memd[ss, ebp - 0x3c], 0x100c_dc26); /* mov dword [ebp-0x3c], 0x100cdc26 */
            ii(0x1012_540e, 5); mov(eax, 0x1019_f15e);                  /* mov eax, 0x1019f15e */
            ii(0x1012_5413, 3); mov(ebx, memd[ss, ebp - 0x40]);         /* mov ebx, [ebp-0x40] */
            ...
            ii(0x1012_542c, 3); mov(ebx, memd[ss, ebp - 0x40]);         /* mov ebx, [ebp-0x40] */
            ...
            ii(0x1012_5447, 3); add(eax, memd[ss, ebp - 0x40]);         /* add eax, [ebp-0x40] */
            ...
            ii(0x1012_545f, 3); add(edx, memd[ss, ebp - 0x40]);         /* add edx, [ebp-0x40] */
            ...
            ii(0x1012_5478, 3); mov(edx, memd[ss, ebp - 0x40]);         /* mov edx, [ebp-0x40] */
            ...
            ii(0x1012_5493, 3); mov(edx, memd[ss, ebp - 0x40]);         /* mov edx, [ebp-0x40] */
            ...
            ii(0x1012_54b2, 3); add(edx, memd[ss, ebp - 0x40]);         /* add edx, [ebp-0x40] */
            ...
            ii(0x1012_54cf, 3); mov(edx, memd[ss, ebp - 0x40]);         /* mov edx, [ebp-0x40] */
            ...
            ii(0x1012_54eb, 7); mov(memd[ss, ebp - 0x2c], 0x205);       /* mov dword [ebp-0x2c], 0x205 */
            ii(0x1012_54f2, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1012_54f4, 5); mov(al, memb[ds, 0x101b_b45a]);         /* mov al, [0x101bb45a] */
            ii(0x1012_54f9, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ii(0x1012_54fc, 3); mov(eax, memd[ss, ebp - 0x38]);         /* mov eax, [ebp-0x38] */
            ii(0x1012_54ff, 3); mov(ebx, memd[ss, ebp - 0x3c]);         /* mov ebx, [ebp-0x3c] */
            ...
            ii(0x1012_550b, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x1012_550e, 3); mov(eax, memd[ss, ebp - 0x3c]);         /* mov eax, [ebp-0x3c] */
            ii(0x1012_5511, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1012_5514, 3); lea(ebx, memd[ss, ebp - 0x2c]);         /* lea ebx, [ebp-0x2c] */
            ii(0x1012_5517, 3); lea(edx, memd[ss, ebp - 0x2c]);         /* lea edx, [ebp-0x2c] */
            ii(0x1012_551a, 5); mov(eax, 0x31);                         /* mov eax, 0x31 */
            ii(0x1012_551f, 5); call(/* sys */ 0x1016_c606, 0x4_70e2);  /* call 0x1016c606 */
            ii(0x1012_5524, 7); mov(memd[ss, ebp - 0x2c], 0x600);       /* mov dword [ebp-0x2c], 0x600 */
            ...
            ii(0x1012_5535, 3); mov(memd[ss, ebp - 0x28], edx);         /* mov [ebp-0x28], edx */
            ...
            ii(0x1012_5545, 3); mov(memd[ss, ebp - 0x24], edx);         /* mov [ebp-0x24], edx */
            ii(0x1012_5548, 7); mov(memd[ss, ebp - 0x1c], 0);           /* mov dword [ebp-0x1c], 0x0 */
            ii(0x1012_554f, 5); mov(eax, memd[ds, 0x100c_ddd5]);        /* mov eax, [0x100cddd5] */
            ii(0x1012_5554, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x1012_5557, 3); lea(ebx, memd[ss, ebp - 0x2c]);         /* lea ebx, [ebp-0x2c] */
            ii(0x1012_555a, 3); lea(edx, memd[ss, ebp - 0x2c]);         /* lea edx, [ebp-0x2c] */
            ii(0x1012_555d, 5); mov(eax, 0x31);                         /* mov eax, 0x31 */
            ii(0x1012_5562, 5); call(/* sys */ 0x1016_c606, 0x4_709f);  /* call 0x1016c606 */
            ii(0x1012_5567, 7); mov(memd[ss, ebp - 0x2c], 0x600);       /* mov dword [ebp-0x2c], 0x600 */
            ii(0x1012_556e, 5); mov(eax, 0x101b_b45c);                  /* mov eax, 0x101bb45c */
            ii(0x1012_5573, 3); shr(eax, 0x10);                         /* shr eax, 0x10 */
            ii(0x1012_5576, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ii(0x1012_5579, 5); mov(eax, 0x101b_b45c);                  /* mov eax, 0x101bb45c */
            ii(0x1012_557e, 5); and(eax, 0xffff);                       /* and eax, 0xffff */
            ii(0x1012_5583, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x1012_5586, 7); mov(memd[ss, ebp - 0x1c], 0);           /* mov dword [ebp-0x1c], 0x0 */
            ii(0x1012_558d, 7); mov(memd[ss, ebp - 0x18], 0x2);         /* mov dword [ebp-0x18], 0x2 */
            ii(0x1012_5594, 3); lea(ebx, memd[ss, ebp - 0x2c]);         /* lea ebx, [ebp-0x2c] */
            ii(0x1012_5597, 3); lea(edx, memd[ss, ebp - 0x2c]);         /* lea edx, [ebp-0x2c] */
            ii(0x1012_559a, 5); mov(eax, 0x31);                         /* mov eax, 0x31 */
            ii(0x1012_559f, 5); call(/* sys */ 0x1016_c606, 0x4_7062);  /* call 0x1016c606 */
            ii(0x1012_55a4, 7); mov(memd[ss, ebp - 0x2c], 0x201);       /* mov dword [ebp-0x2c], 0x201 */
            ii(0x1012_55ab, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1012_55ad, 5); mov(al, memb[ds, 0x101b_b45a]);         /* mov al, [0x101bb45a] */
            ii(0x1012_55b2, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ii(0x1012_55b5, 3); mov(eax, memd[ss, ebp - 0x40]);         /* mov eax, [ebp-0x40] */
            ii(0x1012_55b8, 3); shr(eax, 0x4);                          /* shr eax, 0x4 */
            ii(0x1012_55bb, 5); and(eax, 0xffff);                       /* and eax, 0xffff */
            ii(0x1012_55c0, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x1012_55c3, 3); mov(eax, memd[ss, ebp - 0x40]);         /* mov eax, [ebp-0x40] */
            ii(0x1012_55c6, 3); and(eax, 0xf);                          /* and eax, 0xf */
            ii(0x1012_55c9, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1012_55cc, 3); lea(ebx, memd[ss, ebp - 0x2c]);         /* lea ebx, [ebp-0x2c] */
            ii(0x1012_55cf, 3); lea(edx, memd[ss, ebp - 0x2c]);         /* lea edx, [ebp-0x2c] */
            ...
            ii(0x1012_55f6, 3); lea(edx, memd[ds, eax + 0x2]);          /* lea edx, [eax+0x2] */
            ...
            ii(0x1012_561d, 3); lea(edx, memd[ds, eax + 0x4]);          /* lea edx, [eax+0x4] */
            ...
            ii(0x1012_5644, 3); lea(edx, memd[ds, eax + 0x6]);          /* lea edx, [eax+0x6] */
            ...
            ii(0x1012_5657, 3); lea(edx, memd[ds, eax + 0x7]);          /* lea edx, [eax+0x7] */
            ...
            ii(0x1012_568d, 3); lea(edx, memd[ds, eax + 0x1]);          /* lea edx, [eax+0x1] */
            ...
            ii(0x1012_56ce, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1012_56e0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1012_5732, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x1012_5746, 7); mov(memd[ss, ebp - 0x44], 0);           /* mov dword [ebp-0x44], 0x0 */
            ii(0x1012_574d, 2); jmp(0x1012_5755, 0x6); goto l_0x1012_5755; /* jmp 0x10125755 */
        l_0x1012_574f:
            ii(0x1012_574f, 3); mov(eax, memd[ss, ebp - 0x44]);         /* mov eax, [ebp-0x44] */
            ii(0x1012_5752, 3); inc(memd[ss, ebp - 0x44]);              /* inc dword [ebp-0x44] */
        l_0x1012_5755:
            ii(0x1012_5755, 4); movsx(eax, memw[ss, ebp - 0x44]);       /* movsx eax, word [ebp-0x44] */
            ...
            ii(0x1012_5772, 3); lea(edx, memd[ds, eax + 0x5]);          /* lea edx, [eax+0x5] */
        ...
        l_0x1012_5787:
            ...
            ii(0x1012_57af, 3); lea(edx, memd[ds, eax + 0x5]);          /* lea edx, [eax+0x5] */
            ...
            ii(0x1012_57f5, 4); mov(ax, memw[ss, ebp - 0x4]);           /* mov ax, [ebp-0x4] */
            ii(0x1012_57f9, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
        l_0x1012_57fc:
            ii(0x1012_57fc, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
