...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_61f0()
        {
            ...
            ii(0x19_6206, 4); sub(memw[ss, bp + 0x6], 0x1);             /* sub word [bp+0x6], 0x1 */
            ii(0x19_620a, 4); sbb(memw[ss, bp + 0x8], 0);               /* sbb word [bp+0x8], 0x0 */
            ii(0x19_620e, 4); cmp(memw[ss, bp + 0x8], 0x10);            /* cmp word [bp+0x8], 0x10 */
            ii(0x19_6212, 2); if(jbe(0x19_6217, 0x3)) goto l_0x19_6217; /* jbe 0x6217 */
            ii(0x19_6214, 3); jmp(0x19_622c, 0x15); goto l_0x19_622c;   /* jmp 0x622c */
        l_0x19_6217:
            ii(0x19_6217, 2); if(jae(0x19_621c, 0x3)) goto l_0x19_621c; /* jae 0x621c */
            ii(0x19_6219, 3); jmp(0x19_6225, 0x9); goto l_0x19_6225;    /* jmp 0x6225 */
        l_0x19_621c:
            ii(0x19_621c, 4); cmp(memw[ss, bp + 0x6], 0);               /* cmp word [bp+0x6], 0x0 */
            ii(0x19_6220, 2); if(jb(0x19_6225, 0x3)) goto l_0x19_6225;  /* jb 0x6225 */
            ii(0x19_6222, 3); jmp(0x19_622c, 0x7); goto l_0x19_622c;    /* jmp 0x622c */
        l_0x19_6225:
            ii(0x19_6225, 4); and(memb[ss, bp - 0x2], 0x7f);            /* and byte [bp-0x2], 0x7f */
        ...
        l_0x19_623b:
            ii(0x19_623b, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x19_623e, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x19_6241, 3); mov(al, memb[ss, bp + 0x8]);              /* mov al, [bp+0x8] */
            ii(0x19_6244, 3); xor(al, memb[ss, bp - 0x2]);              /* xor al, [bp-0x2] */
            ii(0x19_6247, 2); and(al, 0xf);                             /* and al, 0xf */
            ii(0x19_6249, 3); xor(memb[ss, bp - 0x2], al);              /* xor [bp-0x2], al */
            ii(0x19_624c, 3); mov(ax, memw[ss, bp + 0xa]);              /* mov ax, [bp+0xa] */
            ii(0x19_624f, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
            ii(0x19_6252, 3); mov(al, memb[ss, bp + 0xc]);              /* mov al, [bp+0xc] */
            ii(0x19_6255, 3); mov(memb[ss, bp - 0x4], al);              /* mov [bp-0x4], al */
