...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_c405()
        {
            ...
            ii(0x100d_c41c, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100d_c41f, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100d_c422, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ...
            ii(0x100d_c450, 3); lea(edx, memd[ds, eax + 0x12]);         /* lea edx, [eax+0x12] */
            ...
            ii(0x100d_c45f, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100d_c462, 5); mov(edx, 0x3d);                         /* mov edx, 0x3d */
            ii(0x100d_c467, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100d_c47d, 4); mov(ax, memw[ds, eax + 0x8]);           /* mov ax, [eax+0x8] */
            ii(0x100d_c481, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100d_c484, 5); mov(edx, 0x31);                         /* mov edx, 0x31 */
            ii(0x100d_c489, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100d_c49f, 4); mov(ax, memw[ds, eax + 0x8]);           /* mov ax, [eax+0x8] */
            ii(0x100d_c4a3, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
        l_0x100d_c4a6:
            ii(0x100d_c4a6, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x100d_c4a9, 4); cmp(ax, memw[ss, ebp - 0xc]);           /* cmp ax, [ebp-0xc] */
            ii(0x100d_c4ad, 2); if(jl(0x100d_c4f3, 0x44)) goto l_0x100d_c4f3; /* jl 0x100dc4f3 */
            ii(0x100d_c4af, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x100d_c4b2, 4); cmp(ax, memw[ss, ebp - 0xc]);           /* cmp ax, [ebp-0xc] */
            ii(0x100d_c4b6, 2); if(jl(0x100d_c4d0, 0x18)) goto l_0x100d_c4d0; /* jl 0x100dc4d0 */
            ii(0x100d_c4b8, 7); mov(memd[ss, ebp - 0x18], 0x3d);        /* mov dword [ebp-0x18], 0x3d */
            ii(0x100d_c4bf, 3); lea(edx, memd[ss, ebp - 0x18]);         /* lea edx, [ebp-0x18] */
            ii(0x100d_c4c2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_c4c5, 5); call(0x1008_b2a8, -0x5_1222);           /* call 0x1008b2a8 */
            ii(0x100d_c4ca, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100d_c4cd, 3); sub(memd[ss, ebp - 0x14], eax);         /* sub [ebp-0x14], eax */
        l_0x100d_c4d0:
            ii(0x100d_c4d0, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x100d_c4d3, 4); cmp(ax, memw[ss, ebp - 0x10]);          /* cmp ax, [ebp-0x10] */
            ii(0x100d_c4d7, 2); if(jl(0x100d_c4f1, 0x18)) goto l_0x100d_c4f1; /* jl 0x100dc4f1 */
            ii(0x100d_c4d9, 7); mov(memd[ss, ebp - 0x1c], 0x31);        /* mov dword [ebp-0x1c], 0x31 */
            ii(0x100d_c4e0, 3); lea(edx, memd[ss, ebp - 0x1c]);         /* lea edx, [ebp-0x1c] */
            ii(0x100d_c4e3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_c4e6, 5); call(0x1008_b2a8, -0x5_1243);           /* call 0x1008b2a8 */
            ii(0x100d_c4eb, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_c4ee, 3); sub(memd[ss, ebp - 0x14], eax);         /* sub [ebp-0x14], eax */
        l_0x100d_c4f1:
