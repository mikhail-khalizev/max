...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_d16b()
        {
            ...
            ii(0x17_d17b, 2); if(jnz(0x17_d184, 0x7)) goto l_0x17_d184; /* jnz 0xd184 */
        ...
        l_0x17_d192:
            ...
            ii(0x17_d1aa, 2); jmp(0x17_d1ae, 0x2); goto l_0x17_d1ae;    /* jmp 0xd1ae */
        ...
        l_0x17_d1ae:
            ...
            ii(0x17_d1bd, 3); mov(bx, memw[ss, bp + 0x8]);              /* mov bx, [bp+0x8] */
            ii(0x17_d1c0, 2); push(memw[ds, bx]);                       /* push word [bx] */
            ii(0x17_d1c2, 3); push(memw[ds, bx + 0x2]);                 /* push word [bx+0x2] */
            ii(0x17_d1c5, 3); push(memw[ds, bx + 0x4]);                 /* push word [bx+0x4] */
            ii(0x17_d1c8, 3); mov(dx, memw[ds, bx + 0x6]);              /* mov dx, [bx+0x6] */
            ii(0x17_d1cb, 3); mov(si, memw[ds, bx + 0x8]);              /* mov si, [bx+0x8] */
            ii(0x17_d1ce, 3); mov(di, memw[ds, bx + 0xa]);              /* mov di, [bx+0xa] */
            ii(0x17_d1d1, 3); mov(bx, memw[ss, bp + 0xc]);              /* mov bx, [bp+0xc] */
        ...
        l_0x17_d1df:
            ...
            ii(0x17_d1e5, 2); if(jz(0x17_d1e9, 0x2)) goto l_0x17_d1e9;  /* jz 0xd1e9 */
            ii(0x17_d1e7, 2); mov(ax, cx);                              /* mov ax, cx */
        l_0x17_d1e9:
            ii(0x17_d1e9, 2); mov(es, ax);                              /* mov es, ax */
            ii(0x17_d1eb, 3); mov(al, memb[ss, bp + 0x6]);              /* mov al, [bp+0x6] */
            ii(0x17_d1ee, 1); cli();                                    /* cli */
            ii(0x17_d1ef, 3); mov(cx, memw[ds, bx + 0x6]);              /* mov cx, [bx+0x6] */
        ...
        l_0x17_d203:
            ...
            ii(0x17_d209, 2); if(jz(0x17_d20d, 0x2)) goto l_0x17_d20d;  /* jz 0xd20d */
        ...
        l_0x17_d20d:
            ...
            ii(0x17_d21d, 3); mov(bx, memw[ss, bp + 0xa]);              /* mov bx, [bp+0xa] */
            ii(0x17_d220, 2); mov(memw[ds, bx], ax);                    /* mov [bx], ax */
            ii(0x17_d222, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ii(0x17_d225, 1); pop(ax);                                  /* pop ax */
            ii(0x17_d226, 3); and(ax, 0x1);                             /* and ax, 0x1 */
            ii(0x17_d229, 3); mov(memw[ds, bx + 0xc], ax);              /* mov [bx+0xc], ax */
            ii(0x17_d22c, 3); mov(memw[ds, bx + 0x4], cx);              /* mov [bx+0x4], cx */
            ii(0x17_d22f, 3); mov(memw[ds, bx + 0x6], dx);              /* mov [bx+0x6], dx */
            ii(0x17_d232, 3); mov(memw[ds, bx + 0x8], si);              /* mov [bx+0x8], si */
            ii(0x17_d235, 3); mov(memw[ds, bx + 0xa], di);              /* mov [bx+0xa], di */
            ii(0x17_d238, 3); pop(memw[ds, bx + 0x2]);                  /* pop word [bx+0x2] */
            ii(0x17_d23b, 3); mov(bx, memw[ss, bp + 0xc]);              /* mov bx, [bp+0xc] */
            ii(0x17_d23e, 2); mov(memw[ds, bx], es);                    /* mov [bx], es */
            ii(0x17_d240, 1); pop(cx);                                  /* pop cx */
            ii(0x17_d241, 3); mov(memw[ds, bx + 0x6], cx);              /* mov [bx+0x6], cx */
            ii(0x17_d244, 1); pop(ax);                                  /* pop ax */
            ii(0x17_d245, 1); pop(cx);                                  /* pop cx */
            ii(0x17_d246, 3); test(ch, 0x2);                            /* test ch, 0x2 */
            ii(0x17_d249, 2); if(jz(0x17_d24c, 0x1)) goto l_0x17_d24c;  /* jz 0xd24c */
