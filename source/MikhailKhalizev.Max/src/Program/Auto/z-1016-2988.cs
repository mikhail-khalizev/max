...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("6da72a0e-a228-4fc0-a7d3-e3f0a0537d27")]
        public void Method_1016_2988()
        {
            ...
            ii(0x1016_2992, 6); if(jad_func(0x1016_2903, -0x95)) return; /* ja 0x10162903 */
            ...
            ii(0x1016_29a0, 7); if(jmpd_abs(memd_a32[cs, eax + 0x1016_2908])) return; /* jmp dword [cs:eax+0x10162908] */
        }
    }
}
