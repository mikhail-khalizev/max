...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_ca8e()
        {
            ...
            ii(0x18_caa1, 6); mov(memw[es, bx + 22], 1);                /* mov word [es:bx+0x16], 0x1 */
            ii(0x18_caa7, 4); mov(di, memw[es, bx + 16]);               /* mov di, [es:bx+0x10] */
            ...
            ii(0x18_cac2, 3); lea(cx, memw[ss, bp - 24]);               /* lea cx, [bp-0x18] */
            ...
            ii(0x18_cad0, 4); test(memb[ss, bp - 16], 0x10);            /* test byte [bp-0x10], 0x10 */
        ...
        l_0x18_cad9:
            ii(0x18_cad9, 3); push(memw[ss, bp - 20]);                  /* push word [bp-0x14] */
            ii(0x18_cadc, 3); call(0x18_daf7, 0x1018);                  /* call 0xdaf7 */
            ii(0x18_cadf, 1); pop(bx);                                  /* pop bx */
            ii(0x18_cae0, 2); mov(si, ax);                              /* mov si, ax */
            ii(0x18_cae2, 3); push(memw[ss, bp - 22]);                  /* push word [bp-0x16] */
            ii(0x18_cae5, 3); push(memw[ss, bp - 24]);                  /* push word [bp-0x18] */
            ii(0x18_cae8, 3); call(0x18_dbbc, 0x10d1);                  /* call 0xdbbc */
            ii(0x18_caeb, 1); pop(bx);                                  /* pop bx */
            ii(0x18_caec, 1); pop(bx);                                  /* pop bx */
            ii(0x18_caed, 3); mov(memw[ss, bp - 14], ax);               /* mov [bp-0xe], ax */
            ii(0x18_caf0, 3); mov(memw[ss, bp - 12], dx);               /* mov [bp-0xc], dx */
            ii(0x18_caf3, 3); mov(memw[ss, bp - 10], ax);               /* mov [bp-0xa], ax */
        ...
        l_0x18_cb14:
            ...
            ii(0x18_cb17, 6); mov(memw[es, bx + 22], 8);                /* mov word [es:bx+0x16], 0x8 */
            ii(0x18_cb1d, 6); mov(memw[es, bx + 16], 0);                /* mov word [es:bx+0x10], 0x0 */
            ii(0x18_cb23, 3); mov(ax, memw[ss, bp - 8]);                /* mov ax, [bp-0x8] */
            ii(0x18_cb26, 3); or(ax, memw[ss, bp - 10]);                /* or ax, [bp-0xa] */
        ...
        l_0x18_cb32:
            ii(0x18_cb32, 4); cmp(memw[ss, bp - 22], 0x10);             /* cmp word [bp-0x16], 0x10 */
        ...
        l_0x18_cb3b:
            ...
            ii(0x18_cb4d, 3); mov(memw[ss, bp - 10], ax);               /* mov [bp-0xa], ax */
            ii(0x18_cb50, 3); mov(memw[ss, bp - 8], dx);                /* mov [bp-0x8], dx */
            ii(0x18_cb53, 2); mov(ax, dx);                              /* mov ax, dx */
            ii(0x18_cb55, 3); or(ax, memw[ss, bp - 10]);                /* or ax, [bp-0xa] */
        ...
        l_0x18_cb5d:
            ...
            ii(0x18_cb71, 3); add(ax, memw[ss, bp - 14]);               /* add ax, [bp-0xe] */
            ii(0x18_cb74, 3); adc(dx, memw[ss, bp - 12]);               /* adc dx, [bp-0xc] */
        ...
        l_0x18_cb83:
            ...
            ii(0x18_cb89, 3); push(memw[ss, bp - 12]);                  /* push word [bp-0xc] */
            ii(0x18_cb8c, 3); push(memw[ss, bp - 14]);                  /* push word [bp-0xe] */
        ...
        l_0x18_cb9c:
            ...
            ii(0x18_cba4, 3); mov(memw[ss, bp - 10], ax);               /* mov [bp-0xa], ax */
            ...
            ii(0x18_cbb9, 3); mov(memw[ds, bx + 16], di);               /* mov [bx+0x10], di */
            ...
            ii(0x18_cbc3, 3); mov(memw[ss, bp - 10], ax);               /* mov [bp-0xa], ax */
            ii(0x18_cbc6, 3); mov(memw[ss, bp - 8], dx);                /* mov [bp-0x8], dx */
            ii(0x18_cbc9, 2); mov(ax, dx);                              /* mov ax, dx */
            ii(0x18_cbcb, 3); or(ax, memw[ss, bp - 10]);                /* or ax, [bp-0xa] */
        ...
        l_0x18_cbd3:
            ...
            ii(0x18_cbe6, 3); push(memw[ss, bp - 10]);                  /* push word [bp-0xa] */
            ii(0x18_cbe9, 3); call(0x18_d9ca, 0xdde);                   /* call 0xd9ca */
            ii(0x18_cbec, 3); add(sp, 6);                               /* add sp, 0x6 */
            ii(0x18_cbef, 4); cmp(memw[ss, bp - 22], 0x10);             /* cmp word [bp-0x16], 0x10 */
            ...
            ii(0x18_cbf8, 3); push(memw[ss, bp - 12]);                  /* push word [bp-0xc] */
            ii(0x18_cbfb, 3); push(memw[ss, bp - 14]);                  /* push word [bp-0xe] */
        l_0x18_cbfe:
        ...
        l_0x18_cc06:
            ...
            ii(0x18_cc0a, 5); mov(memw[ds, bx + 22], 0x4900);           /* mov word [bx+0x16], 0x4900 */
            ii(0x18_cc0f, 3); mov(ax, memw[ss, bp - 14]);               /* mov ax, [bp-0xe] */
        ...
        l_0x18_cc1e:
            ...
            ii(0x18_cc25, 3); mov(memw[ss, bp - 10], ax);               /* mov [bp-0xa], ax */
            ii(0x18_cc28, 3); mov(memw[ss, bp - 8], dx);                /* mov [bp-0x8], dx */
            ii(0x18_cc2b, 2); mov(ax, dx);                              /* mov ax, dx */
            ii(0x18_cc2d, 3); or(ax, memw[ss, bp - 10]);                /* or ax, [bp-0xa] */
        ...
        l_0x18_cc3f:
            ...
            ii(0x18_cc45, 3); mov(memw[ss, bp - 20], ax);               /* mov [bp-0x14], ax */
            ii(0x18_cc48, 3); mov(ax, memw[ss, bp - 24]);               /* mov ax, [bp-0x18] */
            ii(0x18_cc4b, 3); mov(dx, memw[ss, bp - 22]);               /* mov dx, [bp-0x16] */
            ii(0x18_cc4e, 3); mov(memw[ss, bp - 14], ax);               /* mov [bp-0xe], ax */
            ii(0x18_cc51, 3); mov(memw[ss, bp - 12], dx);               /* mov [bp-0xc], dx */
            ii(0x18_cc54, 3); mov(ax, memw[ss, bp - 10]);               /* mov ax, [bp-0xa] */
            ii(0x18_cc57, 3); shl(ax, 4);                               /* shl ax, 0x4 */
            ii(0x18_cc5a, 3); mov(memw[ss, bp - 24], ax);               /* mov [bp-0x18], ax */
            ii(0x18_cc5d, 3); mov(ax, memw[ss, bp - 8]);                /* mov ax, [bp-0x8] */
            ii(0x18_cc60, 3); shl(ax, 4);                               /* shl ax, 0x4 */
            ii(0x18_cc63, 3); mov(cx, memw[ss, bp - 10]);               /* mov cx, [bp-0xa] */
            ii(0x18_cc66, 3); shr(cx, 0xc);                             /* shr cx, 0xc */
            ii(0x18_cc69, 2); add(ax, cx);                              /* add ax, cx */
            ii(0x18_cc6b, 3); mov(memw[ss, bp - 22], ax);               /* mov [bp-0x16], ax */
            ii(0x18_cc6e, 3); lea(ax, memw[ss, bp - 24]);               /* lea ax, [bp-0x18] */
            ...
            ii(0x18_cc8c, 3); push(memw[ss, bp - 22]);                  /* push word [bp-0x16] */
            ii(0x18_cc8f, 3); push(memw[ss, bp - 24]);                  /* push word [bp-0x18] */
            ...
            ii(0x18_cc9b, 3); push(memw[ss, bp - 12]);                  /* push word [bp-0xc] */
            ii(0x18_cc9e, 3); push(memw[ss, bp - 14]);                  /* push word [bp-0xe] */
            ii(0x18_cca1, 3); push(memw[ss, bp - 2]);                   /* push word [bp-0x2] */
            ii(0x18_cca4, 3); mov(memw[ss, bp - 26], cx);               /* mov [bp-0x1a], cx */
            ...
            ii(0x18_cccf, 3); push(memw[ss, bp - 26]);                  /* push word [bp-0x1a] */
        ...
        l_0x18_ccdb:
            ...
            ii(0x18_ccde, 5); and(memb[es, bx + 38], -2 /* 0xfe */);    /* and byte [es:bx+0x26], 0xfe */
            ii(0x18_cce3, 4); mov(memw[es, bx + 16], di);               /* mov [es:bx+0x10], di */
