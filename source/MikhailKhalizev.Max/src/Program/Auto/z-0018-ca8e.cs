...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_ca8e()
        {
            ...
            ii(0x18_ca9a, 4); mov(memb[ss, bp - 0x6], 0);               /* mov byte [bp-0x6], 0x0 */
            ii(0x18_ca9e, 3); les(bx, memw[ss, bp + 0x4]);              /* les bx, [bp+0x4] */
            ii(0x18_caa1, 6); mov(memw[es, bx + 0x16], 0x1);            /* mov word [es:bx+0x16], 0x1 */
            ...
            ii(0x18_cab5, 4); mov(ax, memw[es, bx + 0x6]);              /* mov ax, [es:bx+0x6] */
            ii(0x18_cab9, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ...
            ii(0x18_cace, 2); if(jz(0x18_cad6, 0x6)) goto l_0x18_cad6;  /* jz 0xcad6 */
            ii(0x18_cad0, 4); test(memb[ss, bp - 0x10], 0x10);          /* test byte [bp-0x10], 0x10 */
            ii(0x18_cad4, 2); if(jnz(0x18_cad9, 0x3)) goto l_0x18_cad9; /* jnz 0xcad9 */
        l_0x18_cad6:
        ...
        l_0x18_cad9:
            ...
            ii(0x18_caf6, 3); mov(memw[ss, bp - 0x8], dx);              /* mov [bp-0x8], dx */
            ii(0x18_caf9, 2); or(dx, ax);                               /* or dx, ax */
            ii(0x18_cafb, 2); if(jz(0x18_cb14, 0x17)) goto l_0x18_cb14; /* jz 0xcb14 */
            ii(0x18_cafd, 3); mov(bx, memw[ss, bp - 0x2]);              /* mov bx, [bp-0x2] */
            ...
            ii(0x18_cb0b, 4); test(memb[es, bx], 0x1);                  /* test byte [es:bx], 0x1 */
            ii(0x18_cb0f, 2); if(jnz(0x18_cb14, 0x3)) goto l_0x18_cb14; /* jnz 0xcb14 */
            ii(0x18_cb11, 3); jmp(0x18_ccf3, 0x1df); goto l_0x18_ccf3;  /* jmp 0xccf3 */
        l_0x18_cb14:
            ii(0x18_cb14, 3); les(bx, memw[ss, bp + 0x4]);              /* les bx, [bp+0x4] */
            ii(0x18_cb17, 6); mov(memw[es, bx + 0x16], 0x8);            /* mov word [es:bx+0x16], 0x8 */
            ii(0x18_cb1d, 6); mov(memw[es, bx + 0x10], 0);              /* mov word [es:bx+0x10], 0x0 */
            ii(0x18_cb23, 3); mov(ax, memw[ss, bp - 0x8]);              /* mov ax, [bp-0x8] */
            ii(0x18_cb26, 3); or(ax, memw[ss, bp - 0xa]);               /* or ax, [bp-0xa] */
            ii(0x18_cb29, 2); if(jnz(0x18_cb32, 0x7)) goto l_0x18_cb32; /* jnz 0xcb32 */
            ii(0x18_cb2b, 5); cmp(memb[ds, 0x980], 0x3);                /* cmp byte [0x980], 0x3 */
            ii(0x18_cb30, 2); if(jl(0x18_cb3b, 0x9)) goto l_0x18_cb3b;  /* jl 0xcb3b */
        l_0x18_cb32:
            ii(0x18_cb32, 4); cmp(memw[ss, bp - 0x16], 0x10);           /* cmp word [bp-0x16], 0x10 */
            ii(0x18_cb36, 2); if(jae(0x18_cb3b, 0x3)) goto l_0x18_cb3b; /* jae 0xcb3b */
        ...
        l_0x18_cb3b:
            ...
            ii(0x18_cb3f, 5); cmp(memb[ds, 0x980], 0x3);                /* cmp byte [0x980], 0x3 */
            ii(0x18_cb44, 2); if(jl(0x18_cb5d, 0x17)) goto l_0x18_cb5d; /* jl 0xcb5d */
            ii(0x18_cb46, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ...
            ii(0x18_cb50, 3); mov(memw[ss, bp - 0x8], dx);              /* mov [bp-0x8], dx */
        ...
        l_0x18_cb7c:
            ...
            ii(0x18_cb7e, 2); if(jb(0x18_cb83, 0x3)) goto l_0x18_cb83;  /* jb 0xcb83 */
        ...
        l_0x18_cb83:
            ...
            ii(0x18_cb97, 2); if(jz(0x18_cb9c, 0x3)) goto l_0x18_cb9c;  /* jz 0xcb9c */
        ...
        l_0x18_cb9c:
            ...
            ii(0x18_cba7, 3); mov(memw[ss, bp - 0x8], dx);              /* mov [bp-0x8], dx */
            ii(0x18_cbaa, 2); or(dx, ax);                               /* or dx, ax */
            ii(0x18_cbac, 2); if(jnz(0x18_cbd3, 0x25)) goto l_0x18_cbd3; /* jnz 0xcbd3 */
            ii(0x18_cbae, 5); cmp(memb[ds, 0x980], 0x2);                /* cmp byte [0x980], 0x2 */
            ...
            ii(0x18_cbbc, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ...
            ii(0x18_cbc6, 3); mov(memw[ss, bp - 0x8], dx);              /* mov [bp-0x8], dx */
            ii(0x18_cbc9, 2); mov(ax, dx);                              /* mov ax, dx */
            ii(0x18_cbcb, 3); or(ax, memw[ss, bp - 0xa]);               /* or ax, [bp-0xa] */
            ii(0x18_cbce, 2); if(jnz(0x18_cbd3, 0x3)) goto l_0x18_cbd3; /* jnz 0xcbd3 */
        l_0x18_cbd0:
        ...
        l_0x18_cbd3:
            ...
            ii(0x18_cbdd, 3); inc(memb[ss, bp - 0x6]);                  /* inc byte [bp-0x6] */
            ii(0x18_cbe0, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x18_cbe3, 3); push(memw[ss, bp - 0x8]);                 /* push word [bp-0x8] */
        ...
        l_0x18_cc06:
            ...
            ii(0x18_cc12, 3); mov(memw[ds, bx + 0x6], ax);              /* mov [bx+0x6], ax */
            ii(0x18_cc15, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
        ...
        l_0x18_cc1e:
            ii(0x18_cc1e, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ...
            ii(0x18_cc28, 3); mov(memw[ss, bp - 0x8], dx);              /* mov [bp-0x8], dx */
            ...
            ii(0x18_cc32, 5); cmp(memb[ds, 0x980], 0x3);                /* cmp byte [0x980], 0x3 */
            ii(0x18_cc37, 2); if(jl(0x18_cc3c, 0x3)) goto l_0x18_cc3c;  /* jl 0xcc3c */
        ...
        l_0x18_cc3f:
            ...
            ii(0x18_cc5d, 3); mov(ax, memw[ss, bp - 0x8]);              /* mov ax, [bp-0x8] */
            ...
            ii(0x18_cc88, 4); or(memb[es, bx], 0x1);                    /* or byte [es:bx], 0x1 */
            ...
            ii(0x18_cca1, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ...
            ii(0x18_ccb7, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ...
            ii(0x18_ccd2, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x18_ccd5, 3); call(0x18_dad3, 0xdfb);                   /* call 0xdad3 */
            ii(0x18_ccd8, 3); add(sp, 0x8);                             /* add sp, 0x8 */
        l_0x18_ccdb:
            ii(0x18_ccdb, 3); les(bx, memw[ss, bp + 0x4]);              /* les bx, [bp+0x4] */
            ii(0x18_ccde, 5); and(memb[es, bx + 0x26], -0x2 /* 0xfe */); /* and byte [es:bx+0x26], 0xfe */
            ii(0x18_cce3, 4); mov(memw[es, bx + 0x10], di);             /* mov [es:bx+0x10], di */
            ii(0x18_cce7, 4); cmp(memb[ss, bp - 0x6], 0);               /* cmp byte [bp-0x6], 0x0 */
            ii(0x18_cceb, 2); if(jz(0x18_ccf3, 0x6)) goto l_0x18_ccf3;  /* jz 0xccf3 */
            ii(0x18_cced, 2); push(0x1);                                /* push 0x1 */
