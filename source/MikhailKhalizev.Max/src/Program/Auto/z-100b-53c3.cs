...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_53c3()
        {
            ...
            ii(0x100b_53db, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_53de, 4); mov(memb[ss, ebp - 0x8], 0x18);         /* mov byte [ebp-0x8], 0x18 */
            ii(0x100b_53e2, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
