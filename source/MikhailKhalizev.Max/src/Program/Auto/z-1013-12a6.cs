...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_12a6()
        {
            ...
            ii(0x1013_12bd, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_12c0, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_12c3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_12c6, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1013_12c9, 7); mov(memb[ds, 0x101c_61b2], 0);          /* mov byte [0x101c61b2], 0x0 */
            ii(0x1013_12d0, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_12d3, 5); call(0x1012_f003, -0x22d5);             /* call 0x1012f003 */
            ii(0x1013_12d8, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_12db, 4); cmp(memb[ds, eax + 0x17], 0);           /* cmp byte [eax+0x17], 0x0 */
            ii(0x1013_12df, 2); if(jnz(0x1013_12ee, 0xd)) goto l_0x1013_12ee; /* jnz 0x101312ee */
            ii(0x1013_12e1, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x1013_12e6, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
