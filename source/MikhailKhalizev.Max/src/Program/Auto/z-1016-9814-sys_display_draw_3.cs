...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ sys_display_draw_3()
        {
            ...
            ii(0x1016_9821, 2); if(jnz(0x1016_982a, 0x7)) goto l_0x1016_982a; /* jnz 0x1016982a */
        ...
        l_0x1016_9841:
            ii(0x1016_9841, 3); mov(dl, memb[ds, eax + 0x4]);           /* mov dl, [eax+0x4] */
            ...
            ii(0x1016_9850, 3); mov(memb[ds, eax + 0x4], dh);           /* mov [eax+0x4], dh */
            ii(0x1016_9853, 5); mov(ecx, 0x1);                          /* mov ecx, 0x1 */
            ii(0x1016_9858, 3); mov(ebx, memd[ds, eax + 0x48]);         /* mov ebx, [eax+0x48] */
            ii(0x1016_985b, 4); mov(edx, memd[ss, esp + 0x4]);          /* mov edx, [esp+0x4] */
