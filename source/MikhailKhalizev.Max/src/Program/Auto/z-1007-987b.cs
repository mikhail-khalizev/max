...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_987b()
        {
            ...
            ii(0x1007_988d, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x1007_9893, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1007_9896, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1007_9899, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x1007_989c, 5); call(0x1013_a794, 0xc_0ef3);            /* call 0x1013a794 */
            ii(0x1007_98a1, 3); sub(eax, 6);                            /* sub eax, 0x6 */
            ii(0x1007_98a4, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1007_98a7, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
