...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_309a()
        {
            ...
            ii(0x1016_30b0, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1016_30b3, 3); mov(memd[ss, ebp - 8], edx);            /* mov [ebp-0x8], edx */
            ii(0x1016_30b6, 3); mov(memd[ss, ebp - 4], ebx);            /* mov [ebp-0x4], ebx */
            ii(0x1016_30b9, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1016_30bc, 4); mov(ax, memw[ds, eax + 26]);            /* mov ax, [eax+0x1a] */
            ...
            ii(0x1016_30c6, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1016_30c9, 4); mov(ax, memw[ds, eax + 28]);            /* mov ax, [eax+0x1c] */
        ...
        l_0x1016_30d3:
            ii(0x1016_30d3, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x1016_30e3, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1016_30e6, 5); call(0x1015_bd55, -0x7396);             /* call 0x1015bd55 */
            ii(0x1016_30eb, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
