...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_47a3()
        {
            ...
            ii(0x1011_47bb, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_47be, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_47df, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_47e2, 6); mov(memb[ds, eax + 0x50e], dl);         /* mov [eax+0x50e], dl */
            ii(0x1011_47e8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_47ff, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_4831, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_4834, 5); call(0x1011_2a06, -0x1e33);             /* call 0x10112a06 */
            ii(0x1011_4839, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_483b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_4850, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_4853, 5); call(0x1011_4119, -0x73f);              /* call 0x10114119 */
        l_0x1011_4858:
            ii(0x1011_4858, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_485a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
