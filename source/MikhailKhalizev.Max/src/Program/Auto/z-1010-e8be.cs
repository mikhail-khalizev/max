...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_e8be()
        {
            ...
            ii(0x1010_e8d5, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_e8d8, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x1010_e8db, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1010_e8df, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1010_e8e1, 3); mov(bl, memb[ss, ebp - 0xc]);           /* mov bl, [ebp-0xc] */
            ii(0x1010_e8e4, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_e8e6, 3); mov(dl, memb[ss, ebp - 0x4]);           /* mov dl, [ebp-0x4] */
            ii(0x1010_e8e9, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1010_e8f6, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
        ...
        l_0x1010_e906:
            ...
            ii(0x1010_e913, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
        l_0x1010_e917:
            ii(0x1010_e917, 5); call(0x1012_9cc6, 0x1_b3aa);            /* call 0x10129cc6 */
            ii(0x1010_e91c, 4); cmp(memb[ss, ebp - 0xc], 0);            /* cmp byte [ebp-0xc], 0x0 */
            ii(0x1010_e920, 2); if(jnz(0x1010_e92b, 0x9)) goto l_0x1010_e92b; /* jnz 0x1010e92b */
            ii(0x1010_e922, 7); mov(memd[ss, ebp - 0x10], 0x1);         /* mov dword [ebp-0x10], 0x1 */
            ii(0x1010_e929, 2); jmp(0x1010_e932, 0x7); goto l_0x1010_e932; /* jmp 0x1010e932 */
        l_0x1010_e92b:
            ii(0x1010_e92b, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
        l_0x1010_e932:
            ii(0x1010_e932, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1010_e935, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1010_e938, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
