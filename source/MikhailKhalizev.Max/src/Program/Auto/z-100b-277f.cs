...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x100b_27c3:
            ii(0x100b_27c3, 3); lea(edx, memd[ss, ebp - 16]);           /* lea edx, [ebp-0x10] */
            ...
            ii(0x100b_27d6, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x100b_280b, 4); movsx(edx, memw[ss, ebp - 14]);         /* movsx edx, word [ebp-0xe] */
            ii(0x100b_280f, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x100b_2813, 5); call(0x1007_388b, -0x3_ef8d);           /* call 0x1007388b */
            ii(0x100b_2818, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100b_281b, 4); cmp(memd[ss, ebp - 12], 0);             /* cmp dword [ebp-0xc], 0x0 */
            ...
            ii(0x100b_282f, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x100b_2832, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x100b_2835, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x100b_2838, 4); cmp(memd[ss, ebp - 24], 0);             /* cmp dword [ebp-0x18], 0x0 */
            ...
            ii(0x100b_2844, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x100b_2847, 5); call(0x100a_73d7, -0xb475);             /* call 0x100a73d7 */
            ii(0x100b_284c, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x100b_284f, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x100b_2852, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
            ii(0x100b_2855, 2); jmp(0x100b_285d, 6); goto l_0x100b_285d; /* jmp 0x100b285d */
        l_0x100b_2857:
            ii(0x100b_2857, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x100b_285a, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
        l_0x100b_285d:
            ii(0x100b_285d, 3); mov(edx, memd[ss, ebp - 32]);           /* mov edx, [ebp-0x20] */
            ii(0x100b_2860, 3); lea(eax, memd[ss, ebp - 36]);           /* lea eax, [ebp-0x24] */
            ii(0x100b_2863, 5); call(0x100b_815c, 0x58f4);              /* call 0x100b815c */
            ii(0x100b_2868, 3); lea(edx, memd[ss, ebp - 16]);           /* lea edx, [ebp-0x10] */
            ii(0x100b_286b, 3); lea(eax, memd[ss, ebp - 36]);           /* lea eax, [ebp-0x24] */
            ii(0x100b_286e, 5); call(0x100a_a824, -0x804f);             /* call 0x100aa824 */
            ii(0x100b_2873, 5); call(0x100a_7557, -0xb321);             /* call 0x100a7557 */
            ii(0x100b_2878, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x100b_2884, 3); lea(eax, memd[ss, ebp - 36]);           /* lea eax, [ebp-0x24] */
        ...
        l_0x100b_28a9:
            ...
            ii(0x100b_28ab, 3); lea(eax, memd[ss, ebp - 36]);           /* lea eax, [ebp-0x24] */
        ...
        l_0x100b_28b8:
            ...
            ii(0x100b_28c5, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100b_28c8, 4); mov(memw[ds, edx + 65], ax);            /* mov [edx+0x41], ax */
            ...
            ii(0x100b_28d9, 3); mov(eax, memd[ss, ebp - 14]);           /* mov eax, [ebp-0xe] */
            ii(0x100b_28dc, 4); mov(memw[ds, edx + 67], ax);            /* mov [edx+0x43], ax */
        ...
        l_0x100b_2913:
            ii(0x100b_2913, 7); mov(memd[ss, ebp - 40], 0);             /* mov dword [ebp-0x28], 0x0 */
        ...
        l_0x100b_291c:
            ...
            ii(0x100b_2932, 3); mov(memd[ss, ebp - 40], eax);           /* mov [ebp-0x28], eax */
        l_0x100b_2935:
