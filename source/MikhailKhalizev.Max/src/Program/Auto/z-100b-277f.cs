...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_277f()
        {
            ...
            ii(0x100b_2796, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_2799, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ...
            ii(0x100b_27a7, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_27aa, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x100b_27ba, 2); if(jnz(0x100b_27be, 0x2)) goto l_0x100b_27be; /* jnz 0x100b27be */
        l_0x100b_27bc:
            ii(0x100b_27bc, 2); jmp(0x100b_27c3, 0x5); goto l_0x100b_27c3; /* jmp 0x100b27c3 */
        l_0x100b_27be:
        ...
        l_0x100b_27c3:
            ...
            ii(0x100b_27c6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_27e2, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100b_27e5, 3); add(edx, 0x15);                         /* add edx, 0x15 */
            ii(0x100b_27e8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_2802, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_2805, 3); mov(ebx, memd[ds, eax + 0x7]);          /* mov ebx, [eax+0x7] */
            ...
            ii(0x100b_283e, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ii(0x100b_2841, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ...
            ii(0x100b_2855, 2); jmp(0x100b_285d, 0x6); goto l_0x100b_285d; /* jmp 0x100b285d */
        l_0x100b_2857:
        ...
        l_0x100b_285d:
            ...
            ii(0x100b_288e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_2891, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
        ...
        l_0x100b_28b8:
            ii(0x100b_28b8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_28cc, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_28e0, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_28e3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_28fe, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_2901, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x100b_2911, 2); if(jnz(0x100b_291c, 0x9)) goto l_0x100b_291c; /* jnz 0x100b291c */
        l_0x100b_2913:
        ...
        l_0x100b_2935:
            ii(0x100b_2935, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_2938, 3); add(eax, 0x15);                         /* add eax, 0x15 */
            ii(0x100b_293b, 5); call(0x1007_6574, -0x3_c3cc);           /* call 0x10076574 */
            ii(0x100b_2940, 5); cmp(memw[ds, eax + 0x8], 0x4e);         /* cmp word [eax+0x8], 0x4e */
            ...
            ii(0x100b_294e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100b_2960:
            ...
            ii(0x100b_296a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
