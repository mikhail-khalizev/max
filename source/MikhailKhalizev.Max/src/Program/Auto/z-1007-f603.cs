...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_f603()
        {
            ...
            ii(0x1007_f619, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1007_f61c, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1007_f61f, 3); mov(memb[ss, ebp - 0x4], bl);           /* mov [ebp-0x4], bl */
            ii(0x1007_f622, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1007_f625, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1007_f628, 4); cmp(memb[ss, ebp - 0x4], 0x2);          /* cmp byte [ebp-0x4], 0x2 */
            ii(0x1007_f62c, 2); if(jnz(0x1007_f64a, 0x1c)) goto l_0x1007_f64a; /* jnz 0x1007f64a */
            ii(0x1007_f62e, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1007_f631, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1007_f634, 3); add(eax, 0x22);                         /* add eax, 0x22 */
            ii(0x1007_f637, 5); call(0x1008_ab1c, 0xb4e0);              /* call 0x1008ab1c */
            ii(0x1007_f63c, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1007_f63f, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1007_f642, 3); add(eax, 0x18);                         /* add eax, 0x18 */
            ii(0x1007_f645, 5); call(0x1008_aab4, 0xb46a);              /* call 0x1008aab4 */
        l_0x1007_f64a:
            ii(0x1007_f64a, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
