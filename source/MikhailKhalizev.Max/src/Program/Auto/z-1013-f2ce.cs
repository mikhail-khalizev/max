...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_f2ce()
        {
            ...
            ii(0x1013_f2dd, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
        ...
        l_0x1013_f2ea:
            ii(0x1013_f2ea, 8); cmp(memw[ds, 0x101c_7284], -0x1 /* 0xff */); /* cmp word [0x101c7284], 0xffff */
            ...
            ii(0x1013_f2ff, 2); if(jz(0x1013_f30a, 0x9)) goto l_0x1013_f30a; /* jz 0x1013f30a */
        ...
        l_0x1013_f323:
            ...
            ii(0x1013_f32d, 2); if(jnz(0x1013_f338, 0x9)) goto l_0x1013_f338; /* jnz 0x1013f338 */
            ii(0x1013_f32f, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
        ...
        l_0x1013_f338:
            ...
            ii(0x1013_f34e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x1013_f351:
            ...
            ii(0x1013_f36c, 3); cmp(eax, 0x9);                          /* cmp eax, 0x9 */
            ii(0x1013_f36f, 2); if(jl(0x1013_f378, 0x7)) goto l_0x1013_f378; /* jl 0x1013f378 */
        ...
        l_0x1013_f378:
            ...
            ii(0x1013_f38a, 3); cmp(eax, 0x1);                          /* cmp eax, 0x1 */
        ...
        l_0x1013_f3d2:
            ...
            ii(0x1013_f3da, 7); mov(memb[ds, 0x101c_728f], 0x1);        /* mov byte [0x101c728f], 0x1 */
        l_0x1013_f3e1:
            ii(0x1013_f3e1, 7); mov(memb[ds, 0x101c_728e], 0x1);        /* mov byte [0x101c728e], 0x1 */
        l_0x1013_f3e8:
        ...
        l_0x1013_f3ec:
            ii(0x1013_f3ec, 4); cmp(memd[ss, ebp - 0x4], 0);            /* cmp dword [ebp-0x4], 0x0 */
            ii(0x1013_f3f0, 6); if(jbe(0x1013_f2ea, -0x10c)) goto l_0x1013_f2ea; /* jbe 0x1013f2ea */
            ii(0x1013_f3f6, 4); cmp(memd[ss, ebp - 0x4], 0x2);          /* cmp dword [ebp-0x4], 0x2 */
