...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_f5bf()
        {
            ...
            ii(0x1007_f5d6, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_f5d9, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1007_f5dc, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_f5df, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1007_f5ec, 2); if(jz(0x1007_f5f4, 0x6)) goto l_0x1007_f5f4; /* jz 0x1007f5f4 */
            ii(0x1007_f5ee, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
            ii(0x1007_f5f2, 2); jmp(0x1007_f5f8, 0x4); goto l_0x1007_f5f8; /* jmp 0x1007f5f8 */
        l_0x1007_f5f4:
            ii(0x1007_f5f4, 4); mov(memb[ss, ebp - 0xc], 0x2);          /* mov byte [ebp-0xc], 0x2 */
        l_0x1007_f5f8:
            ii(0x1007_f5f8, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
