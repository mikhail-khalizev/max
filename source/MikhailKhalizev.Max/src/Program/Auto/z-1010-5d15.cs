...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_5d15()
        {
            ...
            ii(0x1010_5d2d, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_5d30, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_5d33, 10); mov(memd[ds, eax + 0x84], 0);          /* mov dword [eax+0x84], 0x0 */
            ii(0x1010_5d3d, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1010_5d44, 2); jmp(0x1010_5d4c, 0x6); goto l_0x1010_5d4c; /* jmp 0x10105d4c */
        l_0x1010_5d46:
            ii(0x1010_5d46, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_5d49, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x1010_5d4c:
            ii(0x1010_5d4c, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_5d50, 3); cmp(eax, 0x76);                         /* cmp eax, 0x76 */
            ii(0x1010_5d53, 2); if(jge(0x1010_5d6b, 0x16)) goto l_0x1010_5d6b; /* jge 0x10105d6b */
            ii(0x1010_5d55, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_5d59, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_5d5c, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1010_5d5f, 10); mov(memd[ds, eax + 0xac], 0);          /* mov dword [eax+0xac], 0x0 */
            ii(0x1010_5d69, 2); jmp(0x1010_5d46, -0x25); goto l_0x1010_5d46; /* jmp 0x10105d46 */
        l_0x1010_5d6b:
            ii(0x1010_5d6b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_5d6e, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1010_5d71, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
