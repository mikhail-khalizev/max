...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x19_3fbd:
            ...
            ii(0x19_3fcd, 2); if(jbe(0x19_3fd2, 0x3)) goto l_0x19_3fd2; /* jbe 0x3fd2 */
        ...
        l_0x19_3fd2:
            ...
            ii(0x19_3fda, 3); mov(memw[ds, bx + 0x2], ax);              /* mov [bx+0x2], ax */
            ii(0x19_3fdd, 2); mov(ax, dx);                              /* mov ax, dx */
            ii(0x19_3fdf, 3); call(0x19_3fea, 0x8);                     /* call 0x3fea */
            ii(0x19_3fe2, 3); call(0x19_401e, 0x39);                    /* call 0x401e */
            ii(0x19_3fe5, 1); clc();                                    /* clc */
            ii(0x19_3fe6, 2); jmp(0x19_3fe9, 0x1); goto l_0x19_3fe9;    /* jmp 0x3fe9 */
