...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_ade2()
        {
            ...
            ii(0x1007_adfa, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_adfd, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_adff, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_ae0c, 2); if(jz(0x1007_ae14, 0x6)) goto l_0x1007_ae14; /* jz 0x1007ae14 */
            ii(0x1007_ae0e, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x1007_ae12, 2); jmp(0x1007_ae27, 0x13); goto l_0x1007_ae27; /* jmp 0x1007ae27 */
        l_0x1007_ae14:
            ii(0x1007_ae14, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_ae24, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
        l_0x1007_ae27:
            ii(0x1007_ae27, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
