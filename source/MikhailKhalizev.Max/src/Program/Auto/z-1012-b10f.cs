...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_b10f()
        {
            ...
            ii(0x1012_b127, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1012_b12a, 7); mov(memb[ds, 0x101c_5c1c], 0x1d);       /* mov byte [0x101c5c1c], 0x1d */
            ii(0x1012_b131, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_b134, 6); mov(memw[ds, 0x101c_5c1d], ax);         /* mov [0x101c5c1d], ax */
            ii(0x1012_b13a, 9); mov(memw[ds, 0x101c_5c1f], 0x6);        /* mov word [0x101c5c1f], 0x6 */
