...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_f634()
        {
            ...
            ii(0x1010_f64c, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_f64f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_f652, 4); mov(ax, memw[ds, eax + 0xc]);           /* mov ax, [eax+0xc] */
            ii(0x1010_f656, 6); sub(eax, 0x7d0);                        /* sub eax, 0x7d0 */
            ii(0x1010_f65c, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_f65f, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_f663, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_f666, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1010_f669, 6); mov(eax, memd[ds, eax + 0x1d9]);        /* mov eax, [eax+0x1d9] */
            ii(0x1010_f66f, 5); call(0x100c_fbbe, -0x3_fab6);           /* call 0x100cfbbe */
            ii(0x1010_f674, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_f677, 6); mov(eax, memd[ds, eax + 0x227]);        /* mov eax, [eax+0x227] */
            ii(0x1010_f67d, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1010_f680, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x1010_f689, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1010_f68d, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_f690, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1010_f693, 6); mov(edx, memd[ds, eax + 0x201]);        /* mov edx, [eax+0x201] */
            ii(0x1010_f699, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_f69c, 3); mov(eax, memd[ds, eax + 0x15]);         /* mov eax, [eax+0x15] */
            ii(0x1010_f69f, 5); call(0x100e_b14d, -0x2_4557);           /* call 0x100eb14d */
            ii(0x1010_f6a4, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x1010_f6a9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1010_f6b3:
            ...
            ii(0x1010_f6b5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
