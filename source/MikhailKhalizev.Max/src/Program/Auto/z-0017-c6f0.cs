...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_c6f0()
        {
            ...
            ii(0x17_c6fc, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
            ii(0x17_c6ff, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ii(0x17_c702, 2); jmp(0x17_c707, 0x3); goto l_0x17_c707;    /* jmp 0xc707 */
        l_0x17_c704:
            ii(0x17_c704, 3); inc(memw[ss, bp - 0x2]);                  /* inc word [bp-0x2] */
        l_0x17_c707:
            ii(0x17_c707, 5); cmp(memw[ss, bp - 0x2], 0x400);           /* cmp word [bp-0x2], 0x400 */
            ii(0x17_c70c, 2); if(jae(0x17_c760, 0x52)) goto l_0x17_c760; /* jae 0xc760 */
            ii(0x17_c70e, 3); mov(bx, memw[ss, bp - 0x2]);              /* mov bx, [bp-0x2] */
            ii(0x17_c711, 2); shl(bx, 0x1);                             /* shl bx, 1 */
            ii(0x17_c713, 4); mov(ax, memw[ds, bx + 0xaca]);            /* mov ax, [bx+0xaca] */
            ii(0x17_c717, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_c71a, 3); cmp(ax, 0xffff);                          /* cmp ax, 0xffff */
            ii(0x17_c71d, 2); if(jz(0x17_c75e, 0x3f)) goto l_0x17_c75e; /* jz 0xc75e */
            ii(0x17_c71f, 5); mov(memw[ss, bp - 0x8], 0);               /* mov word [bp-0x8], 0x0 */
            ii(0x17_c724, 2); jmp(0x17_c729, 0x3); goto l_0x17_c729;    /* jmp 0xc729 */
        l_0x17_c726:
            ii(0x17_c726, 3); inc(memw[ss, bp - 0x8]);                  /* inc word [bp-0x8] */
        l_0x17_c729:
            ii(0x17_c729, 4); cmp(memw[ss, bp - 0x8], 0x10);            /* cmp word [bp-0x8], 0x10 */
            ii(0x17_c72d, 2); if(jae(0x17_c75e, 0x2f)) goto l_0x17_c75e; /* jae 0xc75e */
            ii(0x17_c72f, 3); mov(cl, memb[ss, bp - 0x8]);              /* mov cl, [bp-0x8] */
            ii(0x17_c732, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ...
            ii(0x17_c740, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
            ii(0x17_c743, 3); mov(bx, memw[ss, bp - 0x2]);              /* mov bx, [bp-0x2] */
            ii(0x17_c746, 2); shl(bx, 0x1);                             /* shl bx, 1 */
            ii(0x17_c748, 4); or(memw[ds, bx + 0xaca], ax);             /* or [bx+0xaca], ax */
            ii(0x17_c74c, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0x17_c74f, 3); shl(ax, 0x4);                             /* shl ax, 0x4 */
            ii(0x17_c752, 3); add(ax, memw[ss, bp - 0x8]);              /* add ax, [bp-0x8] */
