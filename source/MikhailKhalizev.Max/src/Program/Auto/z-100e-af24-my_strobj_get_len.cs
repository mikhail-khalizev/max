...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("89e37453-55c8-4184-9822-eab6f22ba0ff")]
        public void my_strobj_get_len()
        {
            ii(0x100e_af24, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x100e_af29, 5); calld(Definitions.sys_check_available_stack_size, 0x7ae24); /* call 0x10165d52 */
            ...
            ii(0x100e_af54, 1); retd(); return;                         /* ret */
        }
    }
}
