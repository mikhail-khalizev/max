...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_7152()
        {
            ...
            ii(0x100b_716a, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_716d, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100b_717b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_717e, 6); test(memw[ss, ebp - 0x8], 0x200);       /* test word [ebp-0x8], 0x200 */
            ii(0x100b_7184, 2); if(jz(0x100b_71ac, 0x26)) goto l_0x100b_71ac; /* jz 0x100b71ac */
            ii(0x100b_7186, 6); test(memw[ss, ebp - 0x8], 0x1);         /* test word [ebp-0x8], 0x1 */
        ...
        l_0x100b_71ac:
            ii(0x100b_71ac, 6); test(memw[ss, ebp - 0x8], 0x40);        /* test word [ebp-0x8], 0x40 */
