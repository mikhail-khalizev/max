...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_3fc4()
        {
            ...
            ii(0x100e_3fdc, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100e_3fdf, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100e_3ff4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100e_400a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100e_4034:
            ...
            ii(0x100e_4048, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100e_4061, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100e_406e:
            ...
            ii(0x100e_4080, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100e_408b:
            ...
            ii(0x100e_40c4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100e_40d6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100e_40e6:
            ii(0x100e_40e6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100e_4101, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_4104, 3); mov(eax, memd[ds, eax + 0x4c]);         /* mov eax, [eax+0x4c] */
            ii(0x100e_4107, 5); call(0x100c_fa7c, -0x1_4690);           /* call 0x100cfa7c */
        l_0x100e_410c:
            ii(0x100e_410c, 2); jmp(0x100e_4116, 0x8); goto l_0x100e_4116; /* jmp 0x100e4116 */
        l_0x100e_410e:
        ...
        l_0x100e_4116:
            ...
            ii(0x100e_412e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_4131, 5); call(0x100e_2f04, -0x1232);             /* call 0x100e2f04 */
            ii(0x100e_4136, 2); test(al, al);                           /* test al, al */
            ii(0x100e_4138, 2); if(jz(0x100e_413e, 0x4)) goto l_0x100e_413e; /* jz 0x100e413e */
            ii(0x100e_413a, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
        l_0x100e_413e:
            ...
            ii(0x100e_4148, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_414b, 5); call(0x100e_2f92, -0x11be);             /* call 0x100e2f92 */
            ii(0x100e_4150, 2); test(al, al);                           /* test al, al */
            ii(0x100e_4152, 2); if(jz(0x100e_4158, 0x4)) goto l_0x100e_4158; /* jz 0x100e4158 */
            ii(0x100e_4154, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
        l_0x100e_4158:
            ...
            ii(0x100e_4162, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_4165, 5); call(0x100e_3020, -0x114a);             /* call 0x100e3020 */
            ii(0x100e_416a, 2); test(al, al);                           /* test al, al */
            ii(0x100e_416c, 2); if(jz(0x100e_4172, 0x4)) goto l_0x100e_4172; /* jz 0x100e4172 */
            ii(0x100e_416e, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
        l_0x100e_4172:
            ii(0x100e_4172, 2); jmp(0x100e_410e, -0x66); goto l_0x100e_410e; /* jmp 0x100e410e */
        l_0x100e_4174:
            ii(0x100e_4174, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100e_4189:
            ...
            ii(0x100e_4194, 3); mov(dl, memb[ss, ebp - 0x8]);           /* mov dl, [ebp-0x8] */
            ii(0x100e_4197, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100e_41b0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100e_41c9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
