...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_4e37()
        {
            ...
            ii(0x4e3e, 4);    cmp(memw[ss, bp + 0x4], 0);               /* cmp word [bp+0x4], 0x0 */
            ii(0x4e42, 2);    if(jz(0x4e53, 0xf)) goto l_0x4e53;        /* jz 0x4e53 */
            ii(0x4e44, 3);    push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
        ...
        l_0x4e72:
            ...
            ii(0x4e75, 4);    mov(memb[ss, bp - 0x2], 0);               /* mov byte [bp-0x2], 0x0 */
            ii(0x4e79, 3);    lea(ax, memw[ss, bp - 0x6]);              /* lea ax, [bp-0x6] */
            ii(0x4e7c, 1);    push(ax);                                 /* push ax */
            ii(0x4e7d, 3);    call(0x4a87, -0x3f9);                     /* call 0x4a87 */
            ii(0x4e80, 1);    pop(bx);                                  /* pop bx */
            ii(0x4e81, 4);    cmp(memw[ss, bp + 0x4], 0);               /* cmp word [bp+0x4], 0x0 */
            ii(0x4e85, 2);    if(jz(0x4e8f, 0x8)) goto l_0x4e8f;        /* jz 0x4e8f */
