...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_15c9()
        {
            ...
            ii(0x1016_15e1, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1016_15e4, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1016_15e6, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1016_15e9, 3); mov(al, memb[ds, edx + 0x26]);          /* mov al, [edx+0x26] */
            ii(0x1016_15ec, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1016_15ef, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_15f2, 5); call(0x1007_623c, -0xe_b3bb);           /* call 0x1007623c */
            ii(0x1016_15f7, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1016_15fa, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_15fd, 4); cmp(memb[ds, eax + 0x4d], 0);           /* cmp byte [eax+0x4d], 0x0 */
            ii(0x1016_1601, 2); if(jnz(0x1016_1618, 0x15)) goto l_0x1016_1618; /* jnz 0x10161618 */
            ii(0x1016_1603, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_1606, 4); mov(memb[ds, eax + 0x60], 0);           /* mov byte [eax+0x60], 0x0 */
            ii(0x1016_160a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_160d, 4); mov(memb[ds, eax + 0x61], 0);           /* mov byte [eax+0x61], 0x0 */
            ii(0x1016_1611, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_1614, 4); mov(memb[ds, eax + 0x62], 0);           /* mov byte [eax+0x62], 0x0 */
        l_0x1016_1618:
