...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_b31a()
        {
            ...
            ii(0x1012_b330, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1012_b333, 3); mov(memb[ss, ebp - 4], dl);             /* mov [ebp-0x4], dl */
            ii(0x1012_b336, 3); mov(memd[ss, ebp - 12], ebx);           /* mov [ebp-0xc], ebx */
            ii(0x1012_b339, 7); mov(memb[ds, 0x101c_5c1c], 0x2e);       /* mov byte [0x101c5c1c], 0x2e */
            ii(0x1012_b340, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1012_b343, 6); mov(memw[ds, 0x101c_5c1d], ax);         /* mov [0x101c5c1d], ax */
            ii(0x1012_b349, 9); mov(memw[ds, 0x101c_5c1f], 5);          /* mov word [0x101c5c1f], 0x5 */
            ii(0x1012_b352, 7); mov(memd[ss, ebp - 16], 0x101c_5c21);   /* mov dword [ebp-0x10], 0x101c5c21 */
            ii(0x1012_b359, 3); mov(al, memb[ss, ebp - 4]);             /* mov al, [ebp-0x4] */
            ii(0x1012_b35c, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x1012_b35f, 2); mov(memb[ds, edx], al);                 /* mov [edx], al */
            ii(0x1012_b361, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1012_b364, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x1012_b367, 3); mov(memd[ds, edx + 1], eax);            /* mov [edx+0x1], eax */
            ii(0x1012_b36a, 5); mov(eax, 4);                            /* mov eax, 0x4 */
