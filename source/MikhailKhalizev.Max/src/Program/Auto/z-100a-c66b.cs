...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_c66b()
        {
            ...
            ii(0x100a_c682, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_c685, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x100a_c688, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_c68b, 5); cmp(memw[ds, eax + 0x26], 0x41);        /* cmp word [eax+0x26], 0x41 */
            ii(0x100a_c690, 2); if(jnz(0x100a_c698, 0x6)) goto l_0x100a_c698; /* jnz 0x100ac698 */
            ii(0x100a_c692, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ii(0x100a_c696, 2); if(jz(0x100a_c69a, 0x2)) goto l_0x100a_c69a; /* jz 0x100ac69a */
        l_0x100a_c698:
            ii(0x100a_c698, 2); jmp(0x100a_c6a9, 0xf); goto l_0x100a_c6a9; /* jmp 0x100ac6a9 */
        l_0x100a_c69a:
            ii(0x100a_c69a, 5); mov(edx, 0x4e);                         /* mov edx, 0x4e */
            ii(0x100a_c69f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_c6a2, 5); call(0x100a_d86c, 0x11c5);              /* call 0x100ad86c */
            ii(0x100a_c6a7, 2); jmp(0x100a_c6b2, 0x9); goto l_0x100a_c6b2; /* jmp 0x100ac6b2 */
        l_0x100a_c6a9:
            ii(0x100a_c6a9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
