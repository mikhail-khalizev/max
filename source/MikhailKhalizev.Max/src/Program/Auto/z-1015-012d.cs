...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_012d()
        {
            ...
            ii(0x1015_0145, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_0148, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_014b, 3); add(eax, 0x6c);                         /* add eax, 0x6c */
            ii(0x1015_014e, 5); call(0x1007_6730, -0xd_9a23);           /* call 0x10076730 */
            ii(0x1015_0153, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1015_0156, 3); mov(dl, memb[ds, edx + 0x4d]);          /* mov dl, [edx+0x4d] */
            ii(0x1015_0159, 2); xor(dh, dh);                            /* xor dh, dh */
            ii(0x1015_015b, 4); mov(ax, memw[ds, eax + 0xa]);           /* mov ax, [eax+0xa] */
            ii(0x1015_015f, 2); sub(eax, edx);                          /* sub eax, edx */
            ii(0x1015_0161, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_0164, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_0167, 3); add(eax, 0x6c);                         /* add eax, 0x6c */
            ii(0x1015_016a, 5); call(0x1007_6730, -0xd_9a3f);           /* call 0x10076730 */
            ii(0x1015_016f, 3); mov(edx, memd[ds, eax + 0x8]);          /* mov edx, [eax+0x8] */
            ii(0x1015_0172, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1015_0175, 3); shl(edx, 0x2);                          /* shl edx, 0x2 */
            ii(0x1015_0178, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_017b, 5); call(0x1015_09a6, 0x826);               /* call 0x101509a6 */
            ii(0x1015_0180, 1); cwde();                                 /* cwde */
            ii(0x1015_0181, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
            ii(0x1015_0185, 3); imul(eax, ebx);                         /* imul eax, ebx */
            ii(0x1015_0188, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1015_018a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_018d, 3); add(eax, 0x6c);                         /* add eax, 0x6c */
            ii(0x1015_0190, 5); call(0x1007_6730, -0xd_9a65);           /* call 0x10076730 */
            ii(0x1015_0195, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ...
            ii(0x1015_01a8, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1015_01ab, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
