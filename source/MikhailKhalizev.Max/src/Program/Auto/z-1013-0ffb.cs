...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_0ffb()
        {
            ...
            ii(0x1013_1012, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_1015, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_1018, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_101b, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1013_101e, 7); mov(memb[ds, 0x101b_b48f], 0x1);        /* mov byte [0x101bb48f], 0x1 */
            ii(0x1013_1025, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_1028, 5); call(0x1012_f003, -0x202a);             /* call 0x1012f003 */
            ii(0x1013_102d, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_1030, 4); cmp(memb[ds, eax + 0x17], 0);           /* cmp byte [eax+0x17], 0x0 */
            ii(0x1013_1034, 2); if(jz(0x1013_103f, 0x9)) goto l_0x1013_103f; /* jz 0x1013103f */
            ii(0x1013_1036, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1013_1039, 4); cmp(memb[ds, eax + 0x17], 0x1);         /* cmp byte [eax+0x17], 0x1 */
            ii(0x1013_103d, 2); if(jnz(0x1013_104c, 0xd)) goto l_0x1013_104c; /* jnz 0x1013104c */
        l_0x1013_103f:
            ii(0x1013_103f, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x1013_1044, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
