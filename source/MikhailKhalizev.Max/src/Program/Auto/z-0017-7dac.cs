...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_7dac()
        {
            ...
            ii(0x17_7db8, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_7dbb, 3); mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ...
            ii(0x17_7ddc, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x17_7ddf, 3); mov(dx, memw[ss, bp + 0x8]);              /* mov dx, [bp+0x8] */
            ii(0x17_7de2, 3); sub(ax, 0);                               /* sub ax, 0x0 */
            ii(0x17_7de5, 3); sbb(dx, 0x1);                             /* sbb dx, 0x1 */
            ii(0x17_7de8, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x17_7deb, 3); mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
            ...
            ii(0x17_7e02, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_7e05, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ...
            ii(0x17_7e1d, 4); mov(dx, memw[es, bx + si + 0x2]);         /* mov dx, [es:bx+si+0x2] */
            ...
            ii(0x17_7e3d, 3); xor(ax, memw[ss, bp - 0x4]);              /* xor ax, [bp-0x4] */
            ...
            ii(0x17_7e49, 3); mov(memw[ss, bp - 0x4], cx);              /* mov [bp-0x4], cx */
            ii(0x17_7e4c, 3); mov(memw[ss, bp - 0x2], si);              /* mov [bp-0x2], si */
            ii(0x17_7e4f, 4); or(memb[ss, bp - 0x4], 0x1);              /* or byte [bp-0x4], 0x1 */
            ii(0x17_7e53, 4); and(memb[ss, bp - 0x4], -0x19 /* 0xe7 */); /* and byte [bp-0x4], 0xe7 */
            ii(0x17_7e57, 1); push(si);                                 /* push si */
            ii(0x17_7e58, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
