...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_fd84()
        {
            ...
            ii(0x100c_fd9b, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100c_fd9e, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x100c_fda1, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x100c_fda4, 5); call(0x1009_caf8, -0x3_32b1);           /* call 0x1009caf8 */
        l_0x100c_fda9:
            ii(0x100c_fda9, 3); lea(ecx, memd[ss, ebp - 12]);           /* lea ecx, [ebp-0xc] */
            ...
            ii(0x100c_fdb6, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_fdc2, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100c_fdc5, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x100c_fdc8, 3); lea(edx, memd[ss, ebp - 16]);           /* lea edx, [ebp-0x10] */
            ii(0x100c_fdcb, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
