...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_8b4a()
        {
            ...
            ii(0x100a_8b62, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_8b65, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x100a_8b6c, 2); jmp(0x100a_8b74, 0x6); goto l_0x100a_8b74; /* jmp 0x100a8b74 */
        l_0x100a_8b6e:
            ii(0x100a_8b6e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_8b71, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x100a_8b74:
            ii(0x100a_8b74, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100a_8b78, 3); cmp(eax, 0x4);                          /* cmp eax, 0x4 */
            ii(0x100a_8b7b, 2); if(jge(0x100a_8bb4, 0x37)) goto l_0x100a_8bb4; /* jge 0x100a8bb4 */
            ii(0x100a_8b7d, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x100a_8b9c, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
