...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("d5ad46bd-be39-4916-8fcc-7cf65ccbe96e")]
        public void Method_100d_f329()
        {
            ii(0x100d_f329, 5); pushd(0x30);                            /* push 0x30 */
            ii(0x100d_f32e, 5); calld(Definitions.sys_check_available_stack_size, 0x86a1f); /* call 0x10165d52 */
        ...
        l_0x100d_f372:
            ...
            ii(0x100d_f375, 5); calld(0x1007_6bf8, -0x68782);           /* call 0x10076bf8 */
        l_0x100d_f37a:
            ii(0x100d_f37a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100d_f37c, 3); lea(eax, ebp - 0x10);                   /* lea eax, [ebp-0x10] */
            ii(0x100d_f37f, 5); calld(0x1013_ad71, 0x5b9ed);            /* call 0x1013ad71 */
        ...
        l_0x100d_f3d1:
            ...
            ii(0x100d_f3db, 1); retd(); return;                         /* ret */
        }
    }
}
