...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_b520()
        {
            ...
            ii(0x100c_b532, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100c_b538, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100c_b53b, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100c_b53e, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x100c_b540, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100c_b543, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
