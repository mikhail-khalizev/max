...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_88e9()
        {
            ...
            ii(0x1012_8901, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1012_8904, 7); mov(memb[ds, 0x101c_5c1c], 0x8);        /* mov byte [0x101c5c1c], 0x8 */
            ii(0x1012_890b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_890e, 5); call(0x1007_6154, -0xb_27bf);           /* call 0x10076154 */
            ii(0x1012_8913, 6); mov(memw[ds, 0x101c_5c1d], ax);         /* mov [0x101c5c1d], ax */
            ii(0x1012_8919, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_891c, 3); mov(ebx, memd[ds, eax + 0x3a]);         /* mov ebx, [eax+0x3a] */
            ...
            ii(0x1012_892a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
