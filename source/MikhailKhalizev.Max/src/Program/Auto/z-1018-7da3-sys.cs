...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_7da3()
        {
            ...
            ii(0x1018_7da9, 3); mov(ebp, memd[ds, eax + 0xc]);          /* mov ebp, [eax+0xc] */
            ii(0x1018_7dac, 3); mov(ah, memb[ds, eax + 0xc]);           /* mov ah, [eax+0xc] */
            ii(0x1018_7daf, 3); mov(ecx, memd[ds, esi + 0x8]);          /* mov ecx, [esi+0x8] */
            ii(0x1018_7db2, 3); and(ah, 0xcf);                          /* and ah, 0xcf */
            ii(0x1018_7db5, 3); and(ebp, 0x30);                         /* and ebp, 0x30 */
            ii(0x1018_7db8, 3); mov(memb[ds, esi + 0xc], ah);           /* mov [esi+0xc], ah */
            ii(0x1018_7dbb, 2); test(ecx, ecx);                         /* test ecx, ecx */
            ii(0x1018_7dbd, 2); if(jnz(0x1018_7dc6, 0x7)) goto l_0x1018_7dc6; /* jnz 0x10187dc6 */
            ii(0x1018_7dbf, 2); mov(eax, esi);                          /* mov eax, esi */
            ii(0x1018_7dc1, 5); call(/* sys */ 0x1018_d3ee, 0x5628);    /* call 0x1018d3ee */
        l_0x1018_7dc6:
            ii(0x1018_7dc6, 3); mov(cl, memb[ds, esi + 0xd]);           /* mov cl, [esi+0xd] */
            ...
            ii(0x1018_7dde, 3); mov(memb[ds, esi + 0xd], al);           /* mov [esi+0xd], al */
        l_0x1018_7de1:
            ...
            ii(0x1018_7df3, 3); mov(ah, memb[ds, esi + 0xd]);           /* mov ah, [esi+0xd] */
            ...
            ii(0x1018_7e00, 3); mov(memb[ds, esi + 0xd], bl);           /* mov [esi+0xd], bl */
            ii(0x1018_7e03, 5); call(/* sys */ 0x1018_d5d9, 0x57d1);    /* call 0x1018d5d9 */
        l_0x1018_7e08:
            ii(0x1018_7e08, 4); test(memb[ds, esi + 0xc], 0x20);        /* test byte [esi+0xc], 0x20 */
            ii(0x1018_7e0c, 2); if(jz(0x1018_7e13, 0x5)) goto l_0x1018_7e13; /* jz 0x10187e13 */
            ii(0x1018_7e0e, 5); mov(edx, 0xffff_ffff);                  /* mov edx, 0xffffffff */
        l_0x1018_7e13:
            ii(0x1018_7e13, 3); mov(edi, memd[ds, esi + 0xc]);          /* mov edi, [esi+0xc] */
            ii(0x1018_7e16, 2); or(edi, ebp);                           /* or edi, ebp */
            ii(0x1018_7e18, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x1018_7e1a, 3); mov(memd[ds, esi + 0xc], edi);          /* mov [esi+0xc], edi */
