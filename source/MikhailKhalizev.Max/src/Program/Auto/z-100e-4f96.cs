...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_4f96()
        {
            ...
            ii(0x100e_4fb1, 3); lea(edi, memd[ss, ebp - 32]);           /* lea edi, [ebp-0x20] */
            ...
            ii(0x100e_4fc8, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
            ...
            ii(0x100e_4fd8, 3); mov(memd[ss, ebp - 32], eax);           /* mov [ebp-0x20], eax */
        l_0x100e_4fdb:
            ii(0x100e_4fdb, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ...
            ii(0x100e_4feb, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
        l_0x100e_4fee:
            ii(0x100e_4fee, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ...
            ii(0x100e_4fff, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
        l_0x100e_5002:
            ii(0x100e_5002, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ...
            ii(0x100e_5013, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
        l_0x100e_5016:
            ii(0x100e_5016, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x100e_5019, 3); cmp(eax, memd[ss, ebp - 32]);           /* cmp eax, [ebp-0x20] */
            ii(0x100e_501c, 2); if(jle(0x100e_5026, 8)) goto l_0x100e_5026; /* jle 0x100e5026 */
            ii(0x100e_501e, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x100e_5021, 3); cmp(eax, memd[ss, ebp - 28]);           /* cmp eax, [ebp-0x1c] */
        ...
        l_0x100e_502b:
            ...
            ii(0x100e_5035, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
        l_0x100e_5038:
            ii(0x100e_5038, 3); dec(memd[ss, ebp - 16]);                /* dec dword [ebp-0x10] */
            ii(0x100e_503b, 5); cmp(memw[ss, ebp - 16], -1 /* 0xff */); /* cmp word [ebp-0x10], 0xffff */
            ii(0x100e_5040, 6); if(jz(0x100e_5212, 0x1cc)) goto l_0x100e_5212; /* jz 0x100e5212 */
            ii(0x100e_5046, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x100e_5058, 4); cmp(ax, memw[ss, ebp - 16]);            /* cmp ax, [ebp-0x10] */
        ...
        l_0x100e_5060:
            ii(0x100e_5060, 7); mov(memd[ss, ebp - 36], 0);             /* mov dword [ebp-0x24], 0x0 */
        ...
        l_0x100e_5069:
            ...
            ii(0x100e_507f, 3); mov(memd[ss, ebp - 36], eax);           /* mov [ebp-0x24], eax */
        l_0x100e_5082:
            ii(0x100e_5082, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ii(0x100e_5086, 5); mov(eax, 0x101c_3620);                  /* mov eax, 0x101c3620 */
            ii(0x100e_508b, 5); call(0x100e_84b8, 0x3428);              /* call 0x100e84b8 */
            ii(0x100e_5090, 3); lea(edi, memd[ss, ebp - 52]);           /* lea edi, [ebp-0x34] */
            ...
            ii(0x100e_5099, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x100e_509c, 3); cmp(eax, memd[ss, ebp - 52]);           /* cmp eax, [ebp-0x34] */
            ii(0x100e_509f, 2); if(jle(0x100e_50a9, 8)) goto l_0x100e_50a9; /* jle 0x100e50a9 */
            ii(0x100e_50a1, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
            ii(0x100e_50a4, 3); cmp(eax, memd[ss, ebp - 44]);           /* cmp eax, [ebp-0x2c] */
        ...
        l_0x100e_50ab:
            ii(0x100e_50ab, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x100e_50ae, 3); cmp(eax, memd[ss, ebp - 48]);           /* cmp eax, [ebp-0x30] */
        ...
        l_0x100e_50b5:
            ii(0x100e_50b5, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x100e_50b8, 3); cmp(eax, memd[ss, ebp - 40]);           /* cmp eax, [ebp-0x28] */
        ...
        l_0x100e_50c2:
            ii(0x100e_50c2, 4); movsx(ecx, memw[ss, ebp - 44]);         /* movsx ecx, word [ebp-0x2c] */
            ii(0x100e_50c6, 4); movsx(ebx, memw[ss, ebp - 52]);         /* movsx ebx, word [ebp-0x34] */
            ii(0x100e_50ca, 4); movsx(edx, memw[ss, ebp - 24]);         /* movsx edx, word [ebp-0x18] */
            ii(0x100e_50ce, 4); movsx(eax, memw[ss, ebp - 32]);         /* movsx eax, word [ebp-0x20] */
            ii(0x100e_50d2, 5); call(0x100e_4cfc, -0x3db);              /* call 0x100e4cfc */
            ii(0x100e_50d7, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100e_50da, 4); movsx(ecx, memw[ss, ebp - 40]);         /* movsx ecx, word [ebp-0x28] */
            ii(0x100e_50de, 4); movsx(ebx, memw[ss, ebp - 48]);         /* movsx ebx, word [ebp-0x30] */
            ii(0x100e_50e2, 4); movsx(edx, memw[ss, ebp - 20]);         /* movsx edx, word [ebp-0x14] */
            ii(0x100e_50e6, 4); movsx(eax, memw[ss, ebp - 28]);         /* movsx eax, word [ebp-0x1c] */
            ii(0x100e_50ea, 5); call(0x100e_4cfc, -0x3f3);              /* call 0x100e4cfc */
            ii(0x100e_50ef, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100e_50f2, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
        ...
        l_0x100e_5109:
            ii(0x100e_5109, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
        ...
        l_0x100e_511d:
            ii(0x100e_511d, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
        ...
        l_0x100e_5130:
            ii(0x100e_5130, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x100e_5134, 3); cmp(eax, 3);                            /* cmp eax, 0x3 */
            ii(0x100e_5137, 2); if(jz(0x100e_5156, 0x1d)) goto l_0x100e_5156; /* jz 0x100e5156 */
            ii(0x100e_5139, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
        ...
        l_0x100e_5156:
            ...
            ii(0x100e_5166, 3); sub(eax, memd[ss, ebp - 12]);           /* sub eax, [ebp-0xc] */
            ii(0x100e_5169, 3); movsx(ebx, ax);                         /* movsx ebx, ax */
            ii(0x100e_516c, 3); lea(esi, memd[ss, ebp - 32]);           /* lea esi, [ebp-0x20] */
            ii(0x100e_516f, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x100e_5184, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ii(0x100e_5188, 5); mov(eax, 0x101c_3620);                  /* mov eax, 0x101c3620 */
            ii(0x100e_518d, 5); call(0x100e_84b8, 0x3326);              /* call 0x100e84b8 */
            ii(0x100e_5192, 3); lea(edi, memd[ss, ebp - 52]);           /* lea edi, [ebp-0x34] */
            ...
            ii(0x100e_519b, 3); mov(eax, memd[ss, ebp - 44]);           /* mov eax, [ebp-0x2c] */
            ii(0x100e_519e, 3); cmp(eax, memd[ss, ebp - 52]);           /* cmp eax, [ebp-0x34] */
            ii(0x100e_51a1, 2); if(jle(0x100e_51ab, 8)) goto l_0x100e_51ab; /* jle 0x100e51ab */
            ii(0x100e_51a3, 3); mov(eax, memd[ss, ebp - 40]);           /* mov eax, [ebp-0x28] */
            ii(0x100e_51a6, 3); cmp(eax, memd[ss, ebp - 48]);           /* cmp eax, [ebp-0x30] */
            ii(0x100e_51a9, 2); if(jg(0x100e_51b9, 0xe)) goto l_0x100e_51b9; /* jg 0x100e51b9 */
        l_0x100e_51ab:
            ii(0x100e_51ab, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
        ...
        l_0x100e_51bb:
            ...
            ii(0x100e_51bf, 4); movsx(ebx, memw[ss, ebp - 12]);         /* movsx ebx, word [ebp-0xc] */
            ii(0x100e_51c3, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x100e_51d3, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
            ii(0x100e_51d6, 5); call(0x100e_4d79, -0x462);              /* call 0x100e4d79 */
            ii(0x100e_51db, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x100e_51de, 3); cmp(eax, memd[ss, ebp - 32]);           /* cmp eax, [ebp-0x20] */
            ii(0x100e_51e1, 2); if(jle(0x100e_51eb, 8)) goto l_0x100e_51eb; /* jle 0x100e51eb */
            ii(0x100e_51e3, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x100e_51e6, 3); cmp(eax, memd[ss, ebp - 28]);           /* cmp eax, [ebp-0x1c] */
        ...
        l_0x100e_51f0:
            ...
            ii(0x100e_51fa, 4); cmp(ax, memw[ss, ebp - 16]);            /* cmp ax, [ebp-0x10] */
            ...
            ii(0x100e_520a, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
        l_0x100e_520d:
        ...
        l_0x100e_5212:
            ...
            ii(0x100e_521c, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
        l_0x100e_521f:
            ii(0x100e_521f, 3); dec(memd[ss, ebp - 16]);                /* dec dword [ebp-0x10] */
            ii(0x100e_5222, 5); cmp(memw[ss, ebp - 16], -1 /* 0xff */); /* cmp word [ebp-0x10], 0xffff */
            ii(0x100e_5227, 6); if(jz(0x100e_534f, 0x122)) goto l_0x100e_534f; /* jz 0x100e534f */
            ii(0x100e_522d, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x100e_523f, 4); cmp(ax, memw[ss, ebp - 16]);            /* cmp ax, [ebp-0x10] */
        ...
        l_0x100e_5247:
            ii(0x100e_5247, 7); mov(memd[ss, ebp - 56], 0);             /* mov dword [ebp-0x38], 0x0 */
        ...
        l_0x100e_5250:
            ...
            ii(0x100e_5266, 3); mov(memd[ss, ebp - 56], eax);           /* mov [ebp-0x38], eax */
        l_0x100e_5269:
            ii(0x100e_5269, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ii(0x100e_526d, 5); mov(eax, 0x101c_3620);                  /* mov eax, 0x101c3620 */
            ii(0x100e_5272, 5); call(0x100e_84b8, 0x3241);              /* call 0x100e84b8 */
            ii(0x100e_5277, 3); lea(edi, memd[ss, ebp - 52]);           /* lea edi, [ebp-0x34] */
            ...
            ii(0x100e_5280, 3); mov(eax, memd[ss, ebp - 32]);           /* mov eax, [ebp-0x20] */
            ii(0x100e_5283, 3); cmp(eax, memd[ss, ebp - 52]);           /* cmp eax, [ebp-0x34] */
            ii(0x100e_5286, 2); if(jnz(0x100e_5290, 8)) goto l_0x100e_5290; /* jnz 0x100e5290 */
            ii(0x100e_5288, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x100e_528b, 3); cmp(eax, memd[ss, ebp - 44]);           /* cmp eax, [ebp-0x2c] */
        ...
        l_0x100e_5292:
            ii(0x100e_5292, 3); mov(eax, memd[ss, ebp - 48]);           /* mov eax, [ebp-0x30] */
            ii(0x100e_5295, 3); cmp(eax, memd[ss, ebp - 20]);           /* cmp eax, [ebp-0x14] */
            ii(0x100e_5298, 2); if(jz(0x100e_52a2, 8)) goto l_0x100e_52a2; /* jz 0x100e52a2 */
            ii(0x100e_529a, 3); mov(eax, memd[ss, ebp - 40]);           /* mov eax, [ebp-0x28] */
            ii(0x100e_529d, 3); cmp(eax, memd[ss, ebp - 28]);           /* cmp eax, [ebp-0x1c] */
        ...
        l_0x100e_52a6:
            ii(0x100e_52a6, 3); mov(edx, memd[ss, ebp - 28]);           /* mov edx, [ebp-0x1c] */
            ii(0x100e_52a9, 3); mov(eax, memd[ss, ebp - 48]);           /* mov eax, [ebp-0x30] */
            ii(0x100e_52ac, 5); call(Definitions.my_min, -0x5_bb2d);    /* call 0x10089784 */
            ii(0x100e_52b1, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x100e_52b3, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x100e_52c4, 3); mov(edx, memd[ss, ebp - 20]);           /* mov edx, [ebp-0x14] */
            ii(0x100e_52c7, 3); mov(eax, memd[ss, ebp - 40]);           /* mov eax, [ebp-0x28] */
            ii(0x100e_52ca, 5); call(0x1007_6e7c, -0x6_e453);           /* call 0x10076e7c */
            ii(0x100e_52cf, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x100e_52d1, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ii(0x100e_52d5, 5); mov(eax, 0x101c_3620);                  /* mov eax, 0x101c3620 */
            ii(0x100e_52da, 5); call(0x100e_84b8, 0x31d9);              /* call 0x100e84b8 */
            ii(0x100e_52df, 3); mov(memd[ds, eax + 12], ebx);           /* mov [eax+0xc], ebx */
            ii(0x100e_52e2, 5); jmp(0x100e_535c, 0x75); goto l_0x100e_535c; /* jmp 0x100e535c */
        l_0x100e_52e7:
            ii(0x100e_52e7, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x100e_52ea, 3); cmp(eax, memd[ss, ebp - 48]);           /* cmp eax, [ebp-0x30] */
            ii(0x100e_52ed, 2); if(jnz(0x100e_52f7, 8)) goto l_0x100e_52f7; /* jnz 0x100e52f7 */
            ii(0x100e_52ef, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x100e_52f2, 3); cmp(eax, memd[ss, ebp - 40]);           /* cmp eax, [ebp-0x28] */
        ...
        l_0x100e_52f9:
            ii(0x100e_52f9, 3); mov(eax, memd[ss, ebp - 52]);           /* mov eax, [ebp-0x34] */
            ii(0x100e_52fc, 3); cmp(eax, memd[ss, ebp - 24]);           /* cmp eax, [ebp-0x18] */
            ii(0x100e_52ff, 2); if(jz(0x100e_5309, 8)) goto l_0x100e_5309; /* jz 0x100e5309 */
            ii(0x100e_5301, 3); mov(eax, memd[ss, ebp - 44]);           /* mov eax, [ebp-0x2c] */
            ii(0x100e_5304, 3); cmp(eax, memd[ss, ebp - 32]);           /* cmp eax, [ebp-0x20] */
        ...
        l_0x100e_530d:
            ii(0x100e_530d, 3); mov(edx, memd[ss, ebp - 32]);           /* mov edx, [ebp-0x20] */
            ii(0x100e_5310, 3); mov(eax, memd[ss, ebp - 52]);           /* mov eax, [ebp-0x34] */
            ii(0x100e_5313, 5); call(Definitions.my_min, -0x5_bb94);    /* call 0x10089784 */
            ii(0x100e_5318, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x100e_531a, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x100e_532a, 3); mov(edx, memd[ss, ebp - 24]);           /* mov edx, [ebp-0x18] */
            ii(0x100e_532d, 3); mov(eax, memd[ss, ebp - 44]);           /* mov eax, [ebp-0x2c] */
            ii(0x100e_5330, 5); call(0x1007_6e7c, -0x6_e4b9);           /* call 0x10076e7c */
            ii(0x100e_5335, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x100e_5337, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
        ...
        l_0x100e_534f:
            ii(0x100e_534f, 3); lea(edx, memd[ss, ebp - 32]);           /* lea edx, [ebp-0x20] */
