...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_a3fc()
        {
            ...
            ii(0x1010_a414, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_a417, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x1010_a41c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_a43b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_a480, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_a483, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x1010_a485, 3); mov(edx, memd[ds, edx + 0xe]);          /* mov edx, [edx+0xe] */
            ii(0x1010_a488, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1010_a48b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_a48e, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1010_a490, 3); mov(eax, memd[ds, eax + 0x16]);         /* mov eax, [eax+0x16] */
