...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_e939()
        {
            ...
            ii(0x1009_e94f, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1009_e952, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1009_e955, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1009_e958, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_e96b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_e983, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1009_e986, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1009_e9a2, 2); if(jz(0x1009_e9aa, 0x6)) goto l_0x1009_e9aa; /* jz 0x1009e9aa */
            ii(0x1009_e9a4, 4); mov(memb[ss, ebp - 0x10], 0x1);         /* mov byte [ebp-0x10], 0x1 */
            ii(0x1009_e9a8, 2); jmp(0x1009_e9ae, 0x4); goto l_0x1009_e9ae; /* jmp 0x1009e9ae */
        l_0x1009_e9aa:
            ii(0x1009_e9aa, 4); mov(memb[ss, ebp - 0x10], 0);           /* mov byte [ebp-0x10], 0x0 */
        l_0x1009_e9ae:
            ii(0x1009_e9ae, 3); mov(al, memb[ss, ebp - 0x10]);          /* mov al, [ebp-0x10] */
            ii(0x1009_e9b1, 3); mov(memb[ss, ebp - 0x14], al);          /* mov [ebp-0x14], al */
            ii(0x1009_e9b4, 3); mov(al, memb[ss, ebp - 0x14]);          /* mov al, [ebp-0x14] */
