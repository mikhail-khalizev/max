...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_468c()
        {
            ...
            ii(0x1013_46bc, 7); mov(memd[ss, ebp - 0x14], 0);           /* mov dword [ebp-0x14], 0x0 */
        ...
        l_0x1013_46c8:
            ...
            ii(0x1013_46d4, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1013_46d7, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x1013_4793, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x1013_479a, 2); jmp(0x1013_47a2, 0x6); goto l_0x1013_47a2; /* jmp 0x101347a2 */
        l_0x1013_479c:
            ii(0x1013_479c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_479f, 3); inc(memd[ss, ebp - 0x4]);               /* inc dword [ebp-0x4] */
        l_0x1013_47a2:
            ii(0x1013_47a2, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1013_47a6, 5); cmp(eax, 0x100);                        /* cmp eax, 0x100 */
            ii(0x1013_47ab, 2); if(jge(0x1013_47fd, 0x50)) goto l_0x1013_47fd; /* jge 0x101347fd */
            ii(0x1013_47ad, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x1013_47b1, 5); mov(eax, memd[ds, 0x101c_70b0]);        /* mov eax, [0x101c70b0] */
            ii(0x1013_47b6, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1013_47b8, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ii(0x1013_47bb, 2); mov(memb[ds, edx], al);                 /* mov [edx], al */
            ii(0x1013_47bd, 4); movsx(ebx, memw[ss, ebp - 0x4]);        /* movsx ebx, word [ebp-0x4] */
            ...
            ii(0x1013_47cc, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ...
            ii(0x1013_47db, 4); movsx(ebx, memw[ss, ebp - 0x4]);        /* movsx ebx, word [ebp-0x4] */
            ...
            ii(0x1013_47eb, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
        ...
        l_0x1013_47fd:
            ii(0x1013_47fd, 6); mov(memw[ss, ebp - 0x4], 0);            /* mov word [ebp-0x4], 0x0 */
            ii(0x1013_4803, 7); mov(memd[ss, ebp - 0x8], 0x20);         /* mov dword [ebp-0x8], 0x20 */
            ii(0x1013_480a, 2); jmp(0x1013_4819, 0xd); goto l_0x1013_4819; /* jmp 0x10134819 */
        l_0x1013_480c:
            ii(0x1013_480c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_480f, 4); inc(memw[ss, ebp - 0x4]);               /* inc word [ebp-0x4] */
            ii(0x1013_4813, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_4816, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x1013_4819:
            ii(0x1013_4819, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1013_481d, 3); cmp(eax, 0x18);                         /* cmp eax, 0x18 */
            ii(0x1013_4820, 6); if(jge(0x1013_48cd, 0xa7)) goto l_0x1013_48cd; /* jge 0x101348cd */
            ii(0x1013_4826, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1013_482a, 3); cmp(eax, 0x8);                          /* cmp eax, 0x8 */
            ii(0x1013_482d, 2); if(jnz(0x1013_4833, 0x4)) goto l_0x1013_4833; /* jnz 0x10134833 */
            ii(0x1013_482f, 4); add(memd[ss, ebp - 0x8], 0x8);          /* add dword [ebp-0x8], 0x8 */
        l_0x1013_4833:
            ii(0x1013_4833, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_4836, 5); and(eax, 0x7);                          /* and eax, 0x7 */
            ii(0x1013_483b, 1); cwde();                                 /* cwde */
            ii(0x1013_483c, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x1013_4850, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_4853, 5); and(eax, 0x7);                          /* and eax, 0x7 */
            ii(0x1013_4858, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1013_485b, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1013_486f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_4872, 5); and(eax, 0x7);                          /* and eax, 0x7 */
            ii(0x1013_4877, 1); cwde();                                 /* cwde */
            ii(0x1013_4878, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
            ...
            ii(0x1013_488c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_488f, 5); and(eax, 0x7);                          /* and eax, 0x7 */
            ii(0x1013_4894, 1); cwde();                                 /* cwde */
            ii(0x1013_4895, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
            ...
            ii(0x1013_48a9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_48ac, 5); and(eax, 0x7);                          /* and eax, 0x7 */
            ii(0x1013_48b1, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1013_48b4, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
        ...
        l_0x1013_48cd:
            ...
            ii(0x1013_48d7, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1013_48da, 6); mov(memw[ss, ebp - 0x4], 0);            /* mov word [ebp-0x4], 0x0 */
            ii(0x1013_48e0, 2); jmp(0x1013_48e9, 0x7); goto l_0x1013_48e9; /* jmp 0x101348e9 */
        l_0x1013_48e2:
            ii(0x1013_48e2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_48e5, 4); inc(memw[ss, ebp - 0x4]);               /* inc word [ebp-0x4] */
        l_0x1013_48e9:
            ii(0x1013_48e9, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1013_48ed, 5); cmp(eax, 0x100);                        /* cmp eax, 0x100 */
            ii(0x1013_48f2, 2); if(jge(0x1013_4901, 0xd)) goto l_0x1013_4901; /* jge 0x10134901 */
            ii(0x1013_48f4, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1013_48f7, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
            ii(0x1013_48fa, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
        ...
        l_0x1013_4901:
            ...
            ii(0x1013_4960, 7); mov(memd[ss, ebp - 0x14], 0x1);         /* mov dword [ebp-0x14], 0x1 */
        l_0x1013_4967:
            ii(0x1013_4967, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
