...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_9285()
        {
            ...
            ii(0x100b_929d, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_92a0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_92a3, 4); cmp(memd[ds, eax + 0x4], 0);            /* cmp dword [eax+0x4], 0x0 */
            ii(0x100b_92a7, 2); if(jz(0x100b_92c1, 0x18)) goto l_0x100b_92c1; /* jz 0x100b92c1 */
            ii(0x100b_92a9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_92ac, 4); mov(ax, memw[ds, eax + 0xc]);           /* mov ax, [eax+0xc] */
            ii(0x100b_92b0, 7); cmp(ax, memw[ds, 0x101c_8172]);         /* cmp ax, [0x101c8172] */
            ii(0x100b_92b7, 2); if(jz(0x100b_92c1, 0x8)) goto l_0x100b_92c1; /* jz 0x100b92c1 */
            ii(0x100b_92b9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_92bc, 5); call(0x100b_91b9, -0x108);              /* call 0x100b91b9 */
        l_0x100b_92c1:
            ii(0x100b_92c1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_92c4, 4); cmp(memd[ds, eax + 0x4], 0);            /* cmp dword [eax+0x4], 0x0 */
            ...
            ii(0x100b_92d5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_92d8, 4); mov(memw[ds, eax + 0xc], dx);           /* mov [eax+0xc], dx */
            ...
            ii(0x100b_92ee, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_92f1, 3); mov(memd[ds, eax + 0x4], edx);          /* mov [eax+0x4], edx */
            ...
            ii(0x100b_9306, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_9309, 3); mov(memd[ds, eax + 0x8], edx);          /* mov [eax+0x8], edx */
            ii(0x100b_930c, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x100b_9313, 2); jmp(0x100b_931b, 0x6); goto l_0x100b_931b; /* jmp 0x100b931b */
        l_0x100b_9315:
            ii(0x100b_9315, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_9318, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x100b_931b:
            ii(0x100b_931b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_9338, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100b_933c, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100b_933f, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x100b_9341, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_9344, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
            ...
            ii(0x100b_935c, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100b_9360, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100b_9363, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x100b_9365, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_9368, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
        ...
        l_0x100b_9371:
            ii(0x100b_9371, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x100b_9378, 2); jmp(0x100b_9380, 0x6); goto l_0x100b_9380; /* jmp 0x100b9380 */
        l_0x100b_937a:
            ii(0x100b_937a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_937d, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x100b_9380:
            ii(0x100b_9380, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_9399, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100b_939d, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100b_93a0, 2); mov(ecx, eax);                          /* mov ecx, eax */
            ii(0x100b_93a2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_93a5, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
            ...
            ii(0x100b_93be, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100b_93c2, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100b_93c5, 2); mov(ecx, eax);                          /* mov ecx, eax */
            ii(0x100b_93c7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_93ca, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
