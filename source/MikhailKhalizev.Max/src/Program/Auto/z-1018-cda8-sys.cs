...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1018_cdc3:
            ...
            ii(0x1018_cdd5, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1018_cdd8, 2); jmp(0x1018_cddf, 0x5); goto l_0x1018_cddf; /* jmp 0x1018cddf */
        l_0x1018_cdda:
            ii(0x1018_cdda, 5); mov(eax, 0);                            /* mov eax, 0x0 */
        l_0x1018_cddf:
            ii(0x1018_cddf, 2); or(eax, eax);                           /* or eax, eax */
            ii(0x1018_cde1, 2); if(jz(0x1018_cdea, 0x7)) goto l_0x1018_cdea; /* jz 0x1018cdea */
            ii(0x1018_cde3, 5); mov(eax, 0x4f);                         /* mov eax, 0x4f */
            ii(0x1018_cde8, 2); jmp(0x1018_cdef, 0x5); goto l_0x1018_cdef; /* jmp 0x1018cdef */
        l_0x1018_cdea:
