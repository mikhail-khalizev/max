...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_dfd1()
        {
            ...
            ii(0x1010_dfe7, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1010_dfea, 3); mov(memd[ss, ebp - 8], edx);            /* mov [ebp-0x8], edx */
            ii(0x1010_dfed, 3); mov(memb[ss, ebp - 4], bl);             /* mov [ebp-0x4], bl */
            ii(0x1010_dff0, 3); mov(al, memb[ss, ebp - 8]);             /* mov al, [ebp-0x8] */
            ...
            ii(0x1010_dffe, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1010_e001, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x1010_e005, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1010_e007, 2); if(jge(0x1010_e010, 7)) goto l_0x1010_e010; /* jge 0x1010e010 */
            ii(0x1010_e009, 7); mov(memd[ss, ebp - 16], 2);             /* mov dword [ebp-0x10], 0x2 */
        l_0x1010_e010:
            ii(0x1010_e010, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1010_e013, 3); shl(eax, 2);                            /* shl eax, 0x2 */
            ii(0x1010_e016, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1010_e019, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1010_e01b, 3); mov(memd[ss, ebp - 20], edx);           /* mov [ebp-0x14], edx */
            ii(0x1010_e01e, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1010_e020, 3); mov(dl, memb[ss, ebp - 4]);             /* mov dl, [ebp-0x4] */
            ii(0x1010_e023, 4); movsx(eax, memw[ss, ebp - 20]);         /* movsx eax, word [ebp-0x14] */
            ii(0x1010_e027, 3); shl(eax, 2);                            /* shl eax, 0x2 */
            ii(0x1010_e02a, 3); add(eax, memd[ss, ebp - 12]);           /* add eax, [ebp-0xc] */
            ii(0x1010_e02d, 3); mov(eax, memd[ds, eax + 20]);           /* mov eax, [eax+0x14] */
