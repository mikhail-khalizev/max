...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_c6ba()
        {
            ...
            ii(0x100a_c6d2, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100a_c6d5, 4); mov(memb[ss, ebp - 8], 1);              /* mov byte [ebp-0x8], 0x1 */
            ii(0x100a_c6d9, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x100a_c6dc, 3); add(edx, 0x28);                         /* add edx, 0x28 */
            ii(0x100a_c6df, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ...
            ii(0x100a_c6fd, 3); lea(eax, memd[ss, ebp - 44]);           /* lea eax, [ebp-0x2c] */
            ii(0x100a_c700, 5); call(0x1008_b148, -0x2_15bd);           /* call 0x1008b148 */
            ii(0x100a_c705, 5); mov(eax, 2);                            /* mov eax, 0x2 */
            ii(0x100a_c70a, 1); push(eax);                              /* push eax */
            ii(0x100a_c70b, 4); movsx(ecx, memw[ss, ebp - 26]);         /* movsx ecx, word [ebp-0x1a] */
            ii(0x100a_c70f, 4); movsx(ebx, memw[ss, ebp - 28]);         /* movsx ebx, word [ebp-0x1c] */
            ii(0x100a_c713, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_c716, 3); mov(edx, memd[ds, eax + 7]);            /* mov edx, [eax+0x7] */
            ii(0x100a_c719, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100a_c71c, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_c71f, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100a_c722, 5); call(0x1007_6574, -0x3_61b3);           /* call 0x10076574 */
            ii(0x100a_c727, 3); mov(eax, memd[ds, eax + 6]);            /* mov eax, [eax+0x6] */
            ...
            ii(0x100a_c737, 5); mov(ecx, 1);                            /* mov ecx, 0x1 */
            ii(0x100a_c73c, 5); mov(ebx, 2);                            /* mov ebx, 0x2 */
            ii(0x100a_c741, 3); lea(edx, memd[ss, ebp - 28]);           /* lea edx, [ebp-0x1c] */
            ii(0x100a_c744, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ii(0x100a_c747, 5); call(0x1007_5e64, -0x3_68e8);           /* call 0x10075e64 */
            ii(0x100a_c74c, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100a_c74e, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_c760, 2); if(jz(0x100a_c764, 2)) goto l_0x100a_c764; /* jz 0x100ac764 */
        l_0x100a_c762:
            ii(0x100a_c762, 2); jmp(0x100a_c77a, 0x16); goto l_0x100a_c77a; /* jmp 0x100ac77a */
        l_0x100a_c764:
            ii(0x100a_c764, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x100a_c767, 3); add(edx, 0x28);                         /* add edx, 0x28 */
            ii(0x100a_c76a, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
        ...
        l_0x100a_c77a:
            ii(0x100a_c77a, 7); mov(memd[ss, ebp - 20], 2);             /* mov dword [ebp-0x14], 0x2 */
            ii(0x100a_c781, 2); jmp(0x100a_c787, 4); goto l_0x100a_c787; /* jmp 0x100ac787 */
        l_0x100a_c783:
            ii(0x100a_c783, 4); add(memd[ss, ebp - 20], 2);             /* add dword [ebp-0x14], 0x2 */
        l_0x100a_c787:
            ii(0x100a_c787, 4); cmp(memb[ss, ebp - 8], 0);              /* cmp byte [ebp-0x8], 0x0 */
            ii(0x100a_c78b, 6); if(jz(0x100a_c895, 0x104)) goto l_0x100a_c895; /* jz 0x100ac895 */
            ii(0x100a_c791, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x100a_c794, 4); dec(memw[ss, ebp - 28]);                /* dec word [ebp-0x1c] */
            ii(0x100a_c798, 3); mov(eax, memd[ss, ebp - 26]);           /* mov eax, [ebp-0x1a] */
            ii(0x100a_c79b, 4); inc(memw[ss, ebp - 26]);                /* inc word [ebp-0x1a] */
            ii(0x100a_c79f, 4); mov(memb[ss, ebp - 8], 0);              /* mov byte [ebp-0x8], 0x0 */
            ii(0x100a_c7a3, 7); mov(memd[ss, ebp - 12], 0);             /* mov dword [ebp-0xc], 0x0 */
            ii(0x100a_c7aa, 2); jmp(0x100a_c7b0, 4); goto l_0x100a_c7b0; /* jmp 0x100ac7b0 */
        l_0x100a_c7ac:
            ii(0x100a_c7ac, 4); add(memd[ss, ebp - 12], 2);             /* add dword [ebp-0xc], 0x2 */
        l_0x100a_c7b0:
            ii(0x100a_c7b0, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
            ii(0x100a_c7b4, 3); cmp(eax, 8);                            /* cmp eax, 0x8 */
            ii(0x100a_c7b7, 6); if(jge(0x100a_c890, 0xd3)) goto l_0x100a_c890; /* jge 0x100ac890 */
            ii(0x100a_c7bd, 7); mov(memd[ss, ebp - 16], 0);             /* mov dword [ebp-0x10], 0x0 */
            ii(0x100a_c7c4, 2); jmp(0x100a_c7cc, 6); goto l_0x100a_c7cc; /* jmp 0x100ac7cc */
        l_0x100a_c7c6:
            ii(0x100a_c7c6, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_c7c9, 3); inc(memd[ss, ebp - 16]);                /* inc dword [ebp-0x10] */
        l_0x100a_c7cc:
            ii(0x100a_c7cc, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_c7cf, 4); cmp(ax, memw[ss, ebp - 20]);            /* cmp ax, [ebp-0x14] */
            ii(0x100a_c7d3, 6); if(jge(0x100a_c88b, 0xb2)) goto l_0x100a_c88b; /* jge 0x100ac88b */
            ii(0x100a_c7d9, 4); movsx(edx, memw[ss, ebp - 12]);         /* movsx edx, word [ebp-0xc] */
            ii(0x100a_c7dd, 3); shl(edx, 2);                            /* shl edx, 0x2 */
            ii(0x100a_c7e0, 5); mov(eax, 0x101c_5348);                  /* mov eax, 0x101c5348 */
            ii(0x100a_c7e5, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x100a_c7e7, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ii(0x100a_c7ea, 5); call(0x1008_b1a4, -0x2_164b);           /* call 0x1008b1a4 */
            ii(0x100a_c7ef, 3); lea(edx, memd[ss, ebp - 28]);           /* lea edx, [ebp-0x1c] */
            ii(0x100a_c7f2, 3); lea(eax, memd[ss, ebp - 44]);           /* lea eax, [ebp-0x2c] */
            ...
            ii(0x100a_c802, 4); mov(memb[ss, ebp - 8], 1);              /* mov byte [ebp-0x8], 0x1 */
            ii(0x100a_c806, 5); mov(eax, 1);                            /* mov eax, 0x1 */
            ii(0x100a_c80b, 1); push(eax);                              /* push eax */
            ii(0x100a_c80c, 4); movsx(ecx, memw[ss, ebp - 26]);         /* movsx ecx, word [ebp-0x1a] */
            ii(0x100a_c810, 4); movsx(ebx, memw[ss, ebp - 28]);         /* movsx ebx, word [ebp-0x1c] */
            ii(0x100a_c814, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_c817, 3); mov(edx, memd[ds, eax + 7]);            /* mov edx, [eax+0x7] */
            ii(0x100a_c81a, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100a_c81d, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_c820, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100a_c823, 5); call(0x1007_6574, -0x3_62b4);           /* call 0x10076574 */
            ii(0x100a_c828, 3); mov(eax, memd[ds, eax + 6]);            /* mov eax, [eax+0x6] */
            ...
            ii(0x100a_c838, 5); mov(ecx, 1);                            /* mov ecx, 0x1 */
            ii(0x100a_c83d, 5); mov(ebx, 2);                            /* mov ebx, 0x2 */
            ii(0x100a_c842, 3); lea(edx, memd[ss, ebp - 28]);           /* lea edx, [ebp-0x1c] */
            ii(0x100a_c845, 3); lea(eax, memd[ss, ebp - 48]);           /* lea eax, [ebp-0x30] */
            ii(0x100a_c848, 5); call(0x1007_5e64, -0x3_69e9);           /* call 0x10075e64 */
            ii(0x100a_c84d, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100a_c84f, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_c861, 2); if(jz(0x100a_c865, 2)) goto l_0x100a_c865; /* jz 0x100ac865 */
        l_0x100a_c863:
            ii(0x100a_c863, 2); jmp(0x100a_c886, 0x21); goto l_0x100a_c886; /* jmp 0x100ac886 */
        l_0x100a_c865:
            ii(0x100a_c865, 3); lea(edx, memd[ss, ebp - 28]);           /* lea edx, [ebp-0x1c] */
            ii(0x100a_c868, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100a_c86b, 3); add(eax, 0x28);                         /* add eax, 0x28 */
            ii(0x100a_c86e, 5); call(0x1008_8b44, -0x2_3d2f);           /* call 0x10088b44 */
            ii(0x100a_c873, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x100a_c876, 3); add(edx, 0x28);                         /* add edx, 0x28 */
            ii(0x100a_c879, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
