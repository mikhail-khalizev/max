...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_4fac()
        {
            ...
            ii(0x1010_4fc4, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
        l_0x1010_4fc7:
            ii(0x1010_4fc7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_4fca, 5); call(0x1010_4f1b, -0xb4);               /* call 0x10104f1b */
            ii(0x1010_4fcf, 2); test(al, al);                           /* test al, al */
            ii(0x1010_4fd1, 2); if(jnz(0x1010_4fd9, 0x6)) goto l_0x1010_4fd9; /* jnz 0x10104fd9 */
            ii(0x1010_4fd3, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x1010_4fd7, 2); jmp(0x1010_5005, 0x2c); goto l_0x1010_5005; /* jmp 0x10105005 */
        l_0x1010_4fd9:
            ii(0x1010_4fd9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_4fdc, 6); mov(edx, memd[ds, eax + 0x454]);        /* mov edx, [eax+0x454] */
            ...
            ii(0x1010_4fee, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_4ffb, 2); if(jz(0x1010_5003, 0x6)) goto l_0x1010_5003; /* jz 0x10105003 */
            ii(0x1010_4ffd, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x1010_5001, 2); jmp(0x1010_5005, 0x2); goto l_0x1010_5005; /* jmp 0x10105005 */
        l_0x1010_5003:
            ii(0x1010_5003, 2); jmp(0x1010_4fc7, -0x3e); goto l_0x1010_4fc7; /* jmp 0x10104fc7 */
        l_0x1010_5005:
            ii(0x1010_5005, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
