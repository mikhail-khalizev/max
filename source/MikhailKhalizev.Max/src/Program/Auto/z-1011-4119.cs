...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_4119()
        {
            ...
            ii(0x1011_413c, 3); mov(memb[ds, edx + 18], al);            /* mov [edx+0x12], al */
            ii(0x1011_413f, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1011_4142, 6); mov(al, memb[ds, eax + 1311]);          /* mov al, [eax+0x51f] */
            ...
            ii(0x1011_4151, 7); mov(memd[ss, ebp - 12], 4);             /* mov dword [ebp-0xc], 0x4 */
        l_0x1011_4158:
            ii(0x1011_4158, 3); dec(memd[ss, ebp - 12]);                /* dec dword [ebp-0xc] */
            ii(0x1011_415b, 5); cmp(memw[ss, ebp - 12], -1 /* 0xff */); /* cmp word [ebp-0xc], 0xffff */
            ii(0x1011_4160, 2); if(jz(0x1011_4177, 0x15)) goto l_0x1011_4177; /* jz 0x10114177 */
            ii(0x1011_4162, 4); movsx(edx, memw[ss, ebp - 12]);         /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x1011_416e, 7); mov(memw[ds, edx + 1252], ax);          /* mov [edx+0x4e4], ax */
