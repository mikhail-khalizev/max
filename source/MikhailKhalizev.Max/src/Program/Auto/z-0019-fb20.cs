...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_fb20()
        {
            ...
            ii(0x19_fb29, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x19_fb2c, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ii(0x19_fb2f, 3); call(0x19_fae5, -0x4d);                   /* call 0xfae5 */
            ii(0x19_fb32, 2); or(ax, ax);                               /* or ax, ax */
            ii(0x19_fb34, 2); if(jz(0x19_fb3b, 0x5)) goto l_0x19_fb3b;  /* jz 0xfb3b */
            ii(0x19_fb36, 3); mov(ax, 0x1);                             /* mov ax, 0x1 */
            ii(0x19_fb39, 2); jmp(0x19_fb44, 0x9); goto l_0x19_fb44;    /* jmp 0xfb44 */
        l_0x19_fb3b:
            ii(0x19_fb3b, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x19_fb3e, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ii(0x19_fb41, 3); call(0x19_fa6b, -0xd9);                   /* call 0xfa6b */
        l_0x19_fb44:
            ii(0x19_fb44, 1); pop(ds);                                  /* pop ds */
            ii(0x19_fb45, 1); leave();                                  /* leave */
            ii(0x19_fb46, 3); ret(0x4);                                 /* ret 0x4 */
        }
    }
}
