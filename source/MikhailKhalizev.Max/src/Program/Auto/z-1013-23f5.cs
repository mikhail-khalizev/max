...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_23f5()
        {
            ...
            ii(0x1013_240d, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x1013_241d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1013_242a, 2); if(jle(0x1013_2432, 0x6)) goto l_0x1013_2432; /* jle 0x10132432 */
            ii(0x1013_242c, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1013_2430, 2); jmp(0x1013_2436, 0x4); goto l_0x1013_2436; /* jmp 0x10132436 */
        l_0x1013_2432:
        ...
        l_0x1013_2436:
            ...
            ii(0x1013_243b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_243e, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1013_2456, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_2459, 3); mov(eax, memd[ds, eax + 0x3]);          /* mov eax, [eax+0x3] */
            ii(0x1013_245c, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1013_245f, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1013_2461, 2); if(jle(0x1013_2469, 0x6)) goto l_0x1013_2469; /* jle 0x10132469 */
            ii(0x1013_2463, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x1013_2467, 2); jmp(0x1013_246d, 0x4); goto l_0x1013_246d; /* jmp 0x1013246d */
        l_0x1013_2469:
            ii(0x1013_2469, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x1013_246d:
            ii(0x1013_246d, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_246f, 3); mov(dl, memb[ss, ebp - 0x8]);           /* mov dl, [ebp-0x8] */
            ii(0x1013_2472, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
