...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_23f5()
        {
            ...
            ii(0x1013_241a, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ...
            ii(0x1013_242c, 4); mov(memb[ss, ebp - 12], 1);             /* mov byte [ebp-0xc], 0x1 */
            ii(0x1013_2430, 2); jmp(0x1013_2436, 4); goto l_0x1013_2436; /* jmp 0x10132436 */
        l_0x1013_2432:
            ii(0x1013_2432, 4); mov(memb[ss, ebp - 12], 0);             /* mov byte [ebp-0xc], 0x0 */
        l_0x1013_2436:
            ii(0x1013_2436, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_2438, 3); mov(dl, memb[ss, ebp - 12]);            /* mov dl, [ebp-0xc] */
            ii(0x1013_243b, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_243e, 3); mov(eax, memd[ds, eax + 7]);            /* mov eax, [eax+0x7] */
            ii(0x1013_2441, 3); mov(ebx, memd[ss, ebp - 20]);           /* mov ebx, [ebp-0x14] */
            ...
            ii(0x1013_2453, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
        ...
        l_0x1013_246d:
            ...
            ii(0x1013_2475, 3); mov(eax, memd[ds, eax + 11]);           /* mov eax, [eax+0xb] */
            ii(0x1013_2478, 3); mov(ebx, memd[ss, ebp - 16]);           /* mov ebx, [ebp-0x10] */
