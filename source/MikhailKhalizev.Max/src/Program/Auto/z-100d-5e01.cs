...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_5e01()
        {
            ...
            ii(0x100d_5e18, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_5e1b, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_5e1e, 4); cmp(memd[ss, ebp - 0x4], 0);            /* cmp dword [ebp-0x4], 0x0 */
            ii(0x100d_5e22, 2); if(jle(0x100d_5e2d, 0x9)) goto l_0x100d_5e2d; /* jle 0x100d5e2d */
            ii(0x100d_5e24, 7); cmp(memd[ss, ebp - 0x4], 0x7000);       /* cmp dword [ebp-0x4], 0x7000 */
            ii(0x100d_5e2b, 2); if(jl(0x100d_5e2f, 0x2)) goto l_0x100d_5e2f; /* jl 0x100d5e2f */
        l_0x100d_5e2d:
            ii(0x100d_5e2d, 2); jmp(0x100d_5e39, 0xa); goto l_0x100d_5e39; /* jmp 0x100d5e39 */
        l_0x100d_5e2f:
            ii(0x100d_5e2f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_5e32, 7); mov(memb[ds, eax + 0x90], 0);           /* mov byte [eax+0x90], 0x0 */
        l_0x100d_5e39:
            ii(0x100d_5e39, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100d_5e6b:
            ii(0x100d_5e6b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_5e7d, 2); jmp(0x100d_5e85, 0x6); goto l_0x100d_5e85; /* jmp 0x100d5e85 */
        l_0x100d_5e7f:
        ...
        l_0x100d_5e85:
            ...
            ii(0x100d_5e95, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ...
            ii(0x100d_5ebc, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ii(0x100d_5ebf, 3); add(ebx, 0x52);                         /* add ebx, 0x52 */
            ii(0x100d_5ec2, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x100d_5ec6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_5f21:
            ii(0x100d_5f21, 7); cmp(memd[ss, ebp - 0x4], 0x7000);       /* cmp dword [ebp-0x4], 0x7000 */
            ii(0x100d_5f28, 2); if(jl(0x100d_5f83, 0x59)) goto l_0x100d_5f83; /* jl 0x100d5f83 */
            ii(0x100d_5f2a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_5f36, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_5f39, 7); mov(memb[ds, eax + 0x90], 0x1);         /* mov byte [eax+0x90], 0x1 */
            ii(0x100d_5f40, 7); add(memd[ss, ebp - 0x4], 0xffff_9000);  /* add dword [ebp-0x4], 0xffff9000 */
            ii(0x100d_5f47, 4); cmp(memd[ss, ebp - 0x4], 0xd);          /* cmp dword [ebp-0x4], 0xd */
            ii(0x100d_5f4b, 2); if(jnz(0x100d_5f5a, 0xd)) goto l_0x100d_5f5a; /* jnz 0x100d5f5a */
            ii(0x100d_5f4d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_5f5a:
            ii(0x100d_5f5a, 7); cmp(memd[ss, ebp - 0x4], 0x3e8);        /* cmp dword [ebp-0x4], 0x3e8 */
            ii(0x100d_5f61, 2); if(jnz(0x100d_5f70, 0xd)) goto l_0x100d_5f70; /* jnz 0x100d5f70 */
            ii(0x100d_5f63, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_5f70:
            ii(0x100d_5f70, 4); cmp(memd[ss, ebp - 0x4], 0x1b);         /* cmp dword [ebp-0x4], 0x1b */
            ii(0x100d_5f74, 2); if(jnz(0x100d_5f81, 0xb)) goto l_0x100d_5f81; /* jnz 0x100d5f81 */
            ii(0x100d_5f76, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_5f83:
            ii(0x100d_5f83, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100d_5f86, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_5fff:
            ii(0x100d_5fff, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
