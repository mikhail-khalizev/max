...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x100d_5e2f:
            ...
            ii(0x100d_5e32, 7);  mov(memb[ds, eax + 144], 0);          /* mov byte [eax+0x90], 0x0 */
        l_0x100d_5e39:
            ii(0x100d_5e39, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_5e3c, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
        ...
        l_0x100d_5e6b:
            ...
            ii(0x100d_5e6e, 3);  mov(eax, memd[ds, eax + 78]);         /* mov eax, [eax+0x4e] */
            ii(0x100d_5e71, 5);  call(0x100e_b68a, 0x1_5814);          /* call 0x100eb68a */
            ii(0x100d_5e76, 7);  mov(memd[ss, ebp - 16], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x100d_5e7d, 2);  jmp(0x100d_5e85, 6); goto l_0x100d_5e85;/* jmp 0x100d5e85 */
        l_0x100d_5e7f:
            ii(0x100d_5e7f, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_5e82, 3);  inc(memd[ss, ebp - 16]);              /* inc dword [ebp-0x10] */
        l_0x100d_5e85:
            ii(0x100d_5e85, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ii(0x100d_5e89, 3);  cmp(eax, 4);                          /* cmp eax, 0x4 */
            ii(0x100d_5e8c, 2);  if(jge(0x100d_5ed9, 0x4b)) goto l_0x100d_5ed9;/* jge 0x100d5ed9 */
            ii(0x100d_5e8e, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ii(0x100d_5e92, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x100d_5e95, 3);  add(eax, memd[ss, ebp - 8]);          /* add eax, [ebp-0x8] */
            ii(0x100d_5e98, 3);  mov(eax, memd[ds, eax + 62]);         /* mov eax, [eax+0x3e] */
            ii(0x100d_5e9b, 5);  call(0x100d_5104, -0xd9c);            /* call 0x100d5104 */
            ii(0x100d_5ea0, 5);  call(/* sys */ 0x1016_8de8, 0x9_2f43);/* call 0x10168de8 */
            ii(0x100d_5ea5, 4);  movsx(edx, memw[ss, ebp - 16]);       /* movsx edx, word [ebp-0x10] */
            ii(0x100d_5ea9, 6);  mov(memb[ds, edx + 0x101c_3934], al); /* mov [edx+0x101c3934], al */
            ii(0x100d_5eaf, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x100d_5ec2, 4);  movsx(edx, memw[ss, ebp - 16]);       /* movsx edx, word [ebp-0x10] */
            ii(0x100d_5ec6, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_5ec9, 6);  mov(eax, memd[ds, eax + 140]);        /* mov eax, [eax+0x8c] */
        ...
        l_0x100d_5ee9:
            ...
            ii(0x100d_5eec, 3);  mov(eax, memd[ds, eax + 78]);         /* mov eax, [eax+0x4e] */
            ii(0x100d_5eef, 5);  call(0x100e_b226, 0x1_5332);          /* call 0x100eb226 */
            ii(0x100d_5ef4, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_5ef7, 4);  mov(memb[ds, eax + 49], 1);           /* mov byte [eax+0x31], 0x1 */
        ...
        l_0x100d_5f00:
            ...
            ii(0x100d_5f09, 6);  mov(eax, memd[ds, eax - 3942]);       /* mov eax, [eax-0xf66] */
        ...
        l_0x100d_5f21:
            ...
            ii(0x100d_5f2d, 7);  cmp(memb[ds, eax + 144], 0);          /* cmp byte [eax+0x90], 0x0 */
            ...
            ii(0x100d_5f39, 7);  mov(memb[ds, eax + 144], 1);          /* mov byte [eax+0x90], 0x1 */
            ...
            ii(0x100d_5f50, 3);  mov(eax, memd[ds, eax + 54]);         /* mov eax, [eax+0x36] */
        ...
        l_0x100d_5f5a:
            ...
            ii(0x100d_5f66, 3);  mov(eax, memd[ds, eax + 58]);         /* mov eax, [eax+0x3a] */
        ...
        l_0x100d_5f70:
            ...
            ii(0x100d_5f79, 3);  mov(eax, memd[ds, eax + 50]);         /* mov eax, [eax+0x32] */
        ...
        l_0x100d_5f83:
            ...
            ii(0x100d_5f89, 3);  mov(eax, memd[ds, eax + 78]);         /* mov eax, [eax+0x4e] */
        ...
        l_0x100d_5f93:
            ii(0x100d_5f93, 7);  cmp(memd[ss, ebp - 20], 0x119);       /* cmp dword [ebp-0x14], 0x119 */
            ii(0x100d_5f9a, 2);  if(jb(0x100d_5fdb, 0x3f)) goto l_0x100d_5fdb;/* jb 0x100d5fdb */
            ii(0x100d_5f9c, 7);  cmp(memd[ss, ebp - 20], 0x119);       /* cmp dword [ebp-0x14], 0x119 */
            ii(0x100d_5fa3, 6);  if(jbe(0x100d_5e44, -0x165)) goto l_0x100d_5e44;/* jbe 0x100d5e44 */
            ii(0x100d_5fa9, 7);  cmp(memd[ss, ebp - 20], 0x3e8);       /* cmp dword [ebp-0x14], 0x3e8 */
            ii(0x100d_5fb0, 2);  if(jb(0x100d_5fd6, 0x24)) goto l_0x100d_5fd6;/* jb 0x100d5fd6 */
            ii(0x100d_5fb2, 7);  cmp(memd[ss, ebp - 20], 0x3e8);       /* cmp dword [ebp-0x14], 0x3e8 */
        ...
        l_0x100d_5fdb:
            ii(0x100d_5fdb, 4);  cmp(memd[ss, ebp - 20], 0xd);         /* cmp dword [ebp-0x14], 0xd */
            ii(0x100d_5fdf, 2);  if(jb(0x100d_5ffa, 0x19)) goto l_0x100d_5ffa;/* jb 0x100d5ffa */
            ii(0x100d_5fe1, 4);  cmp(memd[ss, ebp - 20], 0xd);         /* cmp dword [ebp-0x14], 0xd */
            ii(0x100d_5fe5, 6);  if(jbe(0x100d_5e6b, -0x180)) goto l_0x100d_5e6b;/* jbe 0x100d5e6b */
            ii(0x100d_5feb, 4);  cmp(memd[ss, ebp - 20], 0x1b);        /* cmp dword [ebp-0x14], 0x1b */
        ...
        l_0x100d_5fff:
            ii(0x100d_5fff, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
            ii(0x100d_6003, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
