...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1019_5ca9:
            ...
            ii(0x1019_5cc0, 3); mov(ebx, memd[ds, eax + 0x4]);          /* mov ebx, [eax+0x4] */
            ii(0x1019_5cc3, 3); mov(ax, memw[ds, ebx]);                 /* mov ax, [ebx] */
            ii(0x1019_5cc6, 4); cmp(ax, 0x1);                           /* cmp ax, 0x1 */
            ii(0x1019_5cca, 2); if(jb(0x1019_5cd4, 0x8)) goto l_0x1019_5cd4; /* jb 0x10195cd4 */
        ...
        l_0x1019_5cd4:
            ii(0x1019_5cd4, 3); mov(memd[ds, esi + 0x4], ecx);          /* mov [esi+0x4], ecx */
        }
    }
}
