...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_1256()
        {
            ...
            ii(0x1013_126d, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_1270, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_1273, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_1276, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1013_1279, 7);  mov(memb[ds, 0x101c_61b2], 1);        /* mov byte [0x101c61b2], 0x1 */
            ii(0x1013_1280, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1013_1283, 5);  call(0x1012_f003, -0x2285);           /* call 0x1012f003 */
            ii(0x1013_1288, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1013_128b, 4);  cmp(memb[ds, eax + 23], 0);           /* cmp byte [eax+0x17], 0x0 */
            ii(0x1013_128f, 2);  if(jnz(0x1013_129e, 0xd)) goto l_0x1013_129e;/* jnz 0x1013129e */
            ii(0x1013_1291, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x1013_1296, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
