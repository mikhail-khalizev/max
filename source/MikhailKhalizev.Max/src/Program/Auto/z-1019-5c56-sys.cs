...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_5c56()
        {
            ...
            ii(0x1019_5c59, 3); mov(ebx, memd[ds, edx + 0x8]);          /* mov ebx, [edx+0x8] */
            ii(0x1019_5c5c, 7); mov(memd[ds, eax + 0x9], 0);            /* mov dword [eax+0x9], 0x0 */
            ii(0x1019_5c63, 3); mov(memd[ds, eax + 0x4], ebx);          /* mov [eax+0x4], ebx */
            ii(0x1019_5c66, 3); mov(ebx, memd[ds, edx + 0x4]);          /* mov ebx, [edx+0x4] */
            ...
            ii(0x1019_5c72, 3); call_abs(memd[ds, ebx + 0x8]);          /* call dword [ebx+0x8] */
