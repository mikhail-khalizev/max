...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("d91521d8-c2e5-4a35-99cb-f2cc16c4f7cf")]
        public void /* sys */ Method_1019_5ce9()
        {
            ...
            ii(0x1019_5cfa, 2); jmpd_func(0x1019_5ca0, -0x5c); return;  /* jmp 0x10195ca0 */
        l_0x1019_5cfc:
            ii(0x1019_5cfc, 3); mov(ecx, memd_a32[ds, ebx + 0xa]);      /* mov ecx, [ebx+0xa] */
            ii(0x1019_5cff, 2); jmpd_func(0x1019_5ca0, -0x61); return;  /* jmp 0x10195ca0 */
        }
    }
}
