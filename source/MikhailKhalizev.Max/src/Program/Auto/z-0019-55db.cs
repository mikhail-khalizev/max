...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x19_55db, 4); enter(0x4, 0);                            /* enter 0x4, 0x0 */
            ...
            ii(0x19_55e9, 2); if(jnz(0x19_55ee, 0x3)) goto l_0x19_55ee; /* jnz 0x55ee */
            ii(0x19_55eb, 3); jmp(0x19_55f1, 0x3); goto l_0x19_55f1;    /* jmp 0x55f1 */
        l_0x19_55ee:
        ...
        l_0x19_55f1:
            ...
            ii(0x19_55f9, 5); mov(memw[ss, bp - 0x4], 0);               /* mov word [bp-0x4], 0x0 */
            ii(0x19_55fe, 3); mov(memw[ss, bp - 0x2], ax);              /* mov [bp-0x2], ax */
            ii(0x19_5601, 3); push(0x780);                              /* push 0x780 */
            ii(0x19_5604, 1); push(ds);                                 /* push ds */
            ii(0x19_5605, 3); push(0x40f0);                             /* push 0x40f0 */
            ii(0x19_5608, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x19_560b, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
