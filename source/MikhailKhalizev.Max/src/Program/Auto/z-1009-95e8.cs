...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_95e8()
        {
            ...
            ii(0x1009_95ff, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_9602, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1009_9605, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1009_9608, 3); add(edx, 0x15);                         /* add edx, 0x15 */
            ii(0x1009_960b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_9617, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_961a, 4); cmp(memb[ds, eax + 0x1d], 0x3);         /* cmp byte [eax+0x1d], 0x3 */
            ii(0x1009_961e, 2); if(jg(0x1009_9627, 0x7)) goto l_0x1009_9627; /* jg 0x10099627 */
            ii(0x1009_9620, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_9623, 4); mov(memb[ds, eax + 0x1d], 0);           /* mov byte [eax+0x1d], 0x0 */
        l_0x1009_9627:
            ii(0x1009_9627, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_9629, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
