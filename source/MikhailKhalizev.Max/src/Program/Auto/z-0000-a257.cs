...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0xa257, 1);    push(bp);                                 /* push bp */
            ii(0xa258, 1);    cli();                                    /* cli */
            ii(0xa259, 3);    call(0x4989, -0x58d3);                    /* call 0x4989 */
            ...
            ii(0xa273, 4);    mov(memw[ds, 0x469], cs);                 /* mov [0x469], cs */
            ii(0xa277, 6);    mov(memw[ds, 0x467], 0x6506);             /* mov word [0x467], 0x6506 */
