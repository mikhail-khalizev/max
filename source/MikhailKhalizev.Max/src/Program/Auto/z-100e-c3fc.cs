...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_c3fc()
        {
            ...
            ii(0x100e_c414, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100e_c417, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100e_c425, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_c428, 6); test(memw[ss, ebp - 0x8], 0x200);       /* test word [ebp-0x8], 0x200 */
            ii(0x100e_c42e, 2); if(jz(0x100e_c456, 0x26)) goto l_0x100e_c456; /* jz 0x100ec456 */
            ii(0x100e_c430, 6); test(memw[ss, ebp - 0x8], 0x1);         /* test word [ebp-0x8], 0x1 */
        ...
        l_0x100e_c456:
            ii(0x100e_c456, 6); test(memw[ss, ebp - 0x8], 0x40);        /* test word [ebp-0x8], 0x40 */
