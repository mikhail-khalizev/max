...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_9ff0()
        {
            ...
            ii(0x100c_a008, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_a00b, 5); call(0x100c_a9dc, 0x9cc);               /* call 0x100ca9dc */
            ii(0x100c_a010, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x100c_a013, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_a016, 5); call(0x100c_a974, 0x959);               /* call 0x100ca974 */
            ii(0x100c_a01b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_a01e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
