...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_e3f4()
        {
            ...
            ii(0x17_e3f6, 4); test(memb[ds, bx + 0x2], 0x4);            /* test byte [bx+0x2], 0x4 */
            ii(0x17_e3fa, 2); if(jz(0x17_e40b, 0xf)) goto l_0x17_e40b;  /* jz 0xe40b */
            ii(0x17_e3fc, 1); dec(dx);                                  /* dec dx */
            ii(0x17_e3fd, 3); mov(si, memw[ds, bx + 0x4]);              /* mov si, [bx+0x4] */
            ii(0x17_e400, 1); dec(si);                                  /* dec si */
            ii(0x17_e401, 2); cmp(dx, si);                              /* cmp dx, si */
            ii(0x17_e403, 2); if(jb(0x17_e40a, 0x5)) goto l_0x17_e40a;  /* jb 0xe40a */
            ii(0x17_e405, 3); cmp(memw[ds, bx - 0x2], dx);              /* cmp [bx-0x2], dx */
        ...
        l_0x17_e40b:
            ...
            ii(0x17_e415, 2); if(jnz(0x17_e41a, 0x3)) goto l_0x17_e41a; /* jnz 0xe41a */
            ii(0x17_e417, 3); mov(ax, 0x1000);                          /* mov ax, 0x1000 */
        l_0x17_e41a:
            ii(0x17_e41a, 4); test(memb[ds, bx + 0x2], 0x4);            /* test byte [bx+0x2], 0x4 */
        ...
        l_0x17_e42a:
            ...
            ii(0x17_e436, 4); test(memb[ds, bx + 0x2], 0x4);            /* test byte [bx+0x2], 0x4 */
            ii(0x17_e43a, 2); if(jz(0x17_e440, 0x4)) goto l_0x17_e440;  /* jz 0xe440 */
            ii(0x17_e43c, 1); dec(dx);                                  /* dec dx */
            ii(0x17_e43d, 3); mov(memw[ds, bx - 0x2], dx);              /* mov [bx-0x2], dx */
        l_0x17_e440:
            ii(0x17_e440, 1); clc();                                    /* clc */
            ii(0x17_e441, 2); jmp(0x17_e444, 0x1); goto l_0x17_e444;    /* jmp 0xe444 */
