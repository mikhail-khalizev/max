...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_79ec()
        {
            ...
            ii(0x1018_7a05, 3);  mov(edx, memd[ds, edi + 12]);         /* mov edx, [edi+0xc] */
            ii(0x1018_7a08, 3);  mov(esi, memd[ds, edi + 16]);         /* mov esi, [edi+0x10] */
            ii(0x1018_7a0b, 3);  mov(edi, memd[ds, edi + 20]);         /* mov edi, [edi+0x14] */
