...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_79ec()
        {
            ...
            ii(0x1018_79f9, 4); mov(bp, memw[ds, ebx + 0x6]);           /* mov bp, [ebx+0x6] */
            ii(0x1018_79fd, 2); mov(eax, memd[ds, edi]);                /* mov eax, [edi] */
            ii(0x1018_79ff, 3); mov(ebx, memd[ds, edi + 0x4]);          /* mov ebx, [edi+0x4] */
            ii(0x1018_7a02, 3); mov(ecx, memd[ds, edi + 0x8]);          /* mov ecx, [edi+0x8] */
