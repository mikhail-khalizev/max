...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_a88b()
        {
            ...
            ii(0x100d_a8a2, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_a8a5, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_a8a8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_a8ab, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100d_a8ae, 4); mov(memw[ds, edx + 0x59], ax);          /* mov [edx+0x59], ax */
            ii(0x100d_a8b2, 5); cmp(memw[ss, ebp - 0x4], -0x1 /* 0xff */); /* cmp word [ebp-0x4], 0xffff */
            ii(0x100d_a8b7, 2); if(jnz(0x100d_a8c2, 0x9)) goto l_0x100d_a8c2; /* jnz 0x100da8c2 */
        ...
        l_0x100d_a8c2:
            ii(0x100d_a8c2, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
        ...
        l_0x100d_a8d3:
            ...
            ii(0x100d_a8ec, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_a8ef, 3); mov(ebx, memd[ds, eax + 0x25]);         /* mov ebx, [eax+0x25] */
            ii(0x100d_a8f2, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100d_a8f5, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
        ...
        l_0x100d_a90e:
            ...
            ii(0x100d_a910, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_a923, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_a945, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_a948, 3); mov(ebx, memd[ds, eax + 0x25]);         /* mov ebx, [eax+0x25] */
            ii(0x100d_a94b, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100d_a94e, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100d_a951, 3); add(edx, 0x31);                         /* add edx, 0x31 */
            ii(0x100d_a954, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_a957, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ii(0x100d_a95a, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100d_a95d, 5); call(0x100f_04d8, 0x1_5b76);            /* call 0x100f04d8 */
        l_0x100d_a962:
            ii(0x100d_a962, 5); cmp(memw[ss, ebp - 0x4], -0x1 /* 0xff */); /* cmp word [ebp-0x4], 0xffff */
            ii(0x100d_a967, 2); if(jz(0x100d_a972, 0x9)) goto l_0x100d_a972; /* jz 0x100da972 */
            ii(0x100d_a969, 7); cmp(memb[ds, 0x101b_7ed0], 0);          /* cmp byte [0x101b7ed0], 0x0 */
            ii(0x100d_a970, 2); if(jnz(0x100d_a974, 0x2)) goto l_0x100d_a974; /* jnz 0x100da974 */
        l_0x100d_a972:
        ...
        l_0x100d_a974:
            ...
            ii(0x100d_a9a0, 4); movsx(ebx, memw[ss, ebp - 0x4]);        /* movsx ebx, word [ebp-0x4] */
            ...
            ii(0x100d_a9ad, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_a9b0, 3); mov(edx, memd[ds, eax + 0x25]);         /* mov edx, [eax+0x25] */
            ii(0x100d_a9b3, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_a9b6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_a9c1:
            ...
            ii(0x100d_a9c8, 2); jmp(0x100d_a9d0, 0x6); goto l_0x100d_a9d0; /* jmp 0x100da9d0 */
        l_0x100d_a9ca:
        ...
        l_0x100d_a9d0:
            ...
            ii(0x100d_a9d3, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x100d_a9e3, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ...
            ii(0x100d_aa07, 2); jmp(0x100d_aa10, 0x7); goto l_0x100d_aa10; /* jmp 0x100daa10 */
        l_0x100d_aa09:
        ...
        l_0x100d_aa10:
            ...
            ii(0x100d_aa17, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
        ...
        l_0x100d_aa26:
            ii(0x100d_aa26, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_aa29, 6); mov(memw[ds, eax + 0x51], 0);           /* mov word [eax+0x51], 0x0 */
            ii(0x100d_aa2f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_aa3f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_aa42, 4); mov(memw[ds, eax + 0x53], dx);          /* mov [eax+0x53], dx */
            ii(0x100d_aa46, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100d_aa49, 3); add(edx, 0x17);                         /* add edx, 0x17 */
            ii(0x100d_aa4c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_aa4f, 6); mov(eax, memd[ds, eax + 0x3ab]);        /* mov eax, [eax+0x3ab] */
            ii(0x100d_aa55, 5); call(0x100d_7f6c, -0x2aee);             /* call 0x100d7f6c */
            ii(0x100d_aa5a, 5); cmp(memw[ss, ebp - 0x4], -0x1 /* 0xff */); /* cmp word [ebp-0x4], 0xffff */
            ii(0x100d_aa5f, 2); if(jz(0x100d_aa6e, 0xd)) goto l_0x100d_aa6e; /* jz 0x100daa6e */
            ii(0x100d_aa61, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100d_aa65, 5); call(0x100c_dec2, -0xcba8);             /* call 0x100cdec2 */
            ii(0x100d_aa6a, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100d_aa6c, 2); if(jnz(0x100d_aa70, 0x2)) goto l_0x100d_aa70; /* jnz 0x100daa70 */
        l_0x100d_aa6e:
            ii(0x100d_aa6e, 2); jmp(0x100d_aaac, 0x3c); goto l_0x100d_aaac; /* jmp 0x100daaac */
        l_0x100d_aa70:
            ii(0x100d_aa70, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x100d_aa74, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_aa77, 5); call(0x100d_9f38, -0xb44);              /* call 0x100d9f38 */
            ii(0x100d_aa7c, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x100d_aa80, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_aa83, 5); call(0x100d_a14b, -0x93d);              /* call 0x100da14b */
            ii(0x100d_aa88, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x100d_aa8c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_aa8f, 5); call(0x100d_a20d, -0x887);              /* call 0x100da20d */
            ii(0x100d_aa94, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x100d_aa98, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_aa9b, 5); call(0x100d_a2b3, -0x7ed);              /* call 0x100da2b3 */
            ii(0x100d_aaa0, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x100d_aaa4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_aaa7, 5); call(0x100d_a407, -0x6a5);              /* call 0x100da407 */
        l_0x100d_aaac:
            ii(0x100d_aaac, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_aab8, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
