...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_a88b()
        {
            ...
            ii(0x100d_a8ae, 4);  mov(memw[ds, edx + 89], ax);          /* mov [edx+0x59], ax */
            ...
            ii(0x100d_a8b9, 7);  mov(memd[ss, ebp - 16], 0);           /* mov dword [ebp-0x10], 0x0 */
        ...
        l_0x100d_a8c2:
            ...
            ii(0x100d_a8d0, 3);  mov(memd[ss, ebp - 16], edx);         /* mov [ebp-0x10], edx */
        l_0x100d_a8d3:
            ii(0x100d_a8d3, 4);  cmp(memd[ss, ebp - 16], 0);           /* cmp dword [ebp-0x10], 0x0 */
            ...
            ii(0x100d_a8ef, 3);  mov(ebx, memd[ds, eax + 37]);         /* mov ebx, [eax+0x25] */
            ...
            ii(0x100d_a8fb, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_a8fe, 3);  mov(eax, memd[ds, eax + 10]);         /* mov eax, [eax+0xa] */
        ...
        l_0x100d_a90e:
            ...
            ii(0x100d_a913, 3);  mov(ecx, memd[ds, eax + 37]);         /* mov ecx, [eax+0x25] */
            ...
            ii(0x100d_a926, 3);  mov(eax, memd[ds, eax + 71]);         /* mov eax, [eax+0x47] */
            ii(0x100d_a929, 5);  call(/* sys */ 0x1016_ad78, 0x9_044a);/* call 0x1016ad78 */
            ii(0x100d_a92e, 4);  cmp(memd[ss, ebp - 16], 0);           /* cmp dword [ebp-0x10], 0x0 */
            ...
            ii(0x100d_a948, 3);  mov(ebx, memd[ds, eax + 37]);         /* mov ebx, [eax+0x25] */
            ...
            ii(0x100d_a954, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
        ...
        l_0x100d_a974:
            ...
            ii(0x100d_a9b0, 3);  mov(edx, memd[ds, eax + 37]);         /* mov edx, [eax+0x25] */
            ii(0x100d_a9b3, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x100d_a9b6, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_a9b9, 3);  mov(eax, memd[ds, eax + 71]);         /* mov eax, [eax+0x47] */
            ii(0x100d_a9bc, 5);  call(0x100e_9ae5, 0xf124);            /* call 0x100e9ae5 */
        l_0x100d_a9c1:
            ii(0x100d_a9c1, 7);  mov(memd[ss, ebp - 12], 0);           /* mov dword [ebp-0xc], 0x0 */
            ii(0x100d_a9c8, 2);  jmp(0x100d_a9d0, 6); goto l_0x100d_a9d0;/* jmp 0x100da9d0 */
        l_0x100d_a9ca:
            ii(0x100d_a9ca, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100d_a9cd, 3);  inc(memd[ss, ebp - 12]);              /* inc dword [ebp-0xc] */
        l_0x100d_a9d0:
            ii(0x100d_a9d0, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100d_a9d3, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ii(0x100d_a9d6, 4);  cmp(ax, memw[ds, edx + 81]);          /* cmp ax, [edx+0x51] */
            ii(0x100d_a9da, 2);  if(jge(0x100d_aa26, 0x4a)) goto l_0x100d_aa26;/* jge 0x100daa26 */
            ii(0x100d_a9dc, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x100d_a9e0, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x100d_a9e3, 3);  add(eax, memd[ss, ebp - 8]);          /* add eax, [ebp-0x8] */
            ii(0x100d_a9e6, 6);  mov(eax, memd[ds, eax + 885]);        /* mov eax, [eax+0x375] */
            ii(0x100d_a9ec, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x100d_a9ef, 4);  cmp(memd[ss, ebp - 20], 0);           /* cmp dword [ebp-0x14], 0x0 */
            ii(0x100d_a9f3, 2);  if(jz(0x100d_aa09, 0x14)) goto l_0x100d_aa09;/* jz 0x100daa09 */
            ii(0x100d_a9f5, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100d_a9f7, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ...
            ii(0x100d_aa04, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x100d_aa07, 2);  jmp(0x100d_aa10, 7); goto l_0x100d_aa10;/* jmp 0x100daa10 */
        l_0x100d_aa09:
            ii(0x100d_aa09, 7);  mov(memd[ss, ebp - 24], 0);           /* mov dword [ebp-0x18], 0x0 */
        l_0x100d_aa10:
            ii(0x100d_aa10, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x100d_aa14, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x100d_aa17, 3);  add(eax, memd[ss, ebp - 8]);          /* add eax, [ebp-0x8] */
            ii(0x100d_aa1a, 10);  mov(memd[ds, eax + 885], 0);         /* mov dword [eax+0x375], 0x0 */
        ...
        l_0x100d_aa26:
            ...
            ii(0x100d_aa29, 6);  mov(memw[ds, eax + 81], 0);           /* mov word [eax+0x51], 0x0 */
            ii(0x100d_aa2f, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_aa32, 6);  mov(eax, memd[ds, eax + 931]);        /* mov eax, [eax+0x3a3] */
            ...
            ii(0x100d_aa42, 4);  mov(memw[ds, eax + 83], dx);          /* mov [eax+0x53], dx */
            ...
            ii(0x100d_aa4f, 6);  mov(eax, memd[ds, eax + 939]);        /* mov eax, [eax+0x3ab] */
        ...
        l_0x100d_aaac:
            ...
            ii(0x100d_aaaf, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100d_aab2, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x100d_aab5, 3);  mov(ebx, memd[ds, eax + 19]);         /* mov ebx, [eax+0x13] */
            ii(0x100d_aab8, 4);  movsx(edx, memw[ss, ebp - 4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x100d_aabc, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x100d_aabf, 3);  call_abs(memd[ds, ebx + 24]);         /* call dword [ebx+0x18] */
