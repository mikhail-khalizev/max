...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("1a1141b1-0d2c-4ce4-978a-6e2decee59bd")]
        public void Method_100e_b14d()
        {
            ii(0x100e_b14d, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x100e_b152, 5); calld(Definitions.sys_check_available_stack_size, 0x7abfb); /* call 0x10165d52 */
            ...
            ii(0x100e_b173, 5); calld(Definitions.sys_strcpy, 0x7ad57); /* call 0x10165ecf */
            ...
            ii(0x100e_b17f, 1); retd(); return;                         /* ret */
        }
    }
}
