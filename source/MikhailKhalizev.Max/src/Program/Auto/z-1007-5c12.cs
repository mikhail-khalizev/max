...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_5c12()
        {
            ...
            ii(0x1007_5c3d, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1007_5c40, 4);  or(memb[ss, ebp - 8], 1);             /* or byte [ebp-0x8], 0x1 */
            ii(0x1007_5c44, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1007_5c47, 5);  call(0x1007_64fc, 0x8b0);             /* call 0x100764fc */
            ii(0x1007_5c4c, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1007_5c4f, 4);  and(memb[ss, ebp - 8], -2 /* 0xfe */);/* and byte [ebp-0x8], 0xfe */
            ii(0x1007_5c53, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1007_5c56, 5);  call(0x1007_6338, 0x6dd);             /* call 0x10076338 */
            ii(0x1007_5c5b, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1007_5c5d, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1007_5c67:
            ii(0x1007_5c67, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1007_5c6a, 5);  call(0x1007_6bf8, 0xf89);             /* call 0x10076bf8 */
        l_0x1007_5c6f:
            ii(0x1007_5c6f, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_5c71, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x1007_5c81, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1007_5c84, 5);  call(0x1007_63a0, 0x717);             /* call 0x100763a0 */
            ii(0x1007_5c89, 4);  mov(memb[ds, eax + 61], 0);           /* mov byte [eax+0x3d], 0x0 */
            ii(0x1007_5c8d, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1007_5c90, 5);  call(0x1007_63a0, 0x70b);             /* call 0x100763a0 */
            ii(0x1007_5c95, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1007_5c97, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1007_5c9a, 5);  call(0x1007_63a0, 0x701);             /* call 0x100763a0 */
            ii(0x1007_5c9f, 4);  mov(dx, memw[ds, edx + 26]);          /* mov dx, [edx+0x1a] */
            ii(0x1007_5ca3, 4);  mov(memw[ds, eax + 65], dx);          /* mov [eax+0x41], dx */
            ii(0x1007_5ca7, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1007_5caa, 5);  call(0x1007_63a0, 0x6f1);             /* call 0x100763a0 */
            ii(0x1007_5caf, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1007_5cb1, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1007_5cb4, 5);  call(0x1007_63a0, 0x6e7);             /* call 0x100763a0 */
            ii(0x1007_5cb9, 4);  mov(dx, memw[ds, edx + 28]);          /* mov dx, [edx+0x1c] */
            ii(0x1007_5cbd, 4);  mov(memw[ds, eax + 67], dx);          /* mov [eax+0x43], dx */
            ii(0x1007_5cc1, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1007_5cc4, 5);  call(0x1007_63a0, 0x6d7);             /* call 0x100763a0 */
            ii(0x1007_5cc9, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1007_5ccb, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1007_5cce, 5);  call(0x1007_63a0, 0x6cd);             /* call 0x100763a0 */
            ii(0x1007_5cd3, 4);  mov(dx, memw[ds, edx + 26]);          /* mov dx, [edx+0x1a] */
            ii(0x1007_5cd7, 4);  mov(memw[ds, eax + 30], dx);          /* mov [eax+0x1e], dx */
            ii(0x1007_5cdb, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1007_5cde, 5);  call(0x1007_63a0, 0x6bd);             /* call 0x100763a0 */
            ii(0x1007_5ce3, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1007_5ce5, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1007_5ce8, 5);  call(0x1007_63a0, 0x6b3);             /* call 0x100763a0 */
            ii(0x1007_5ced, 4);  mov(dx, memw[ds, edx + 28]);          /* mov dx, [edx+0x1c] */
            ii(0x1007_5cf1, 4);  mov(memw[ds, eax + 32], dx);          /* mov [eax+0x20], dx */
            ii(0x1007_5cf5, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_5cf7, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x1007_5d10, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1007_5d22:
            ...
            ii(0x1007_5d24, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
