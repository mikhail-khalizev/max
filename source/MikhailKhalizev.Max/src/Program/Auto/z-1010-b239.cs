...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_b239()
        {
            ...
            ii(0x1010_b251, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_b254, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_b257, 3); mov(eax, memd[ds, eax + 0xd]);          /* mov eax, [eax+0xd] */
            ii(0x1010_b25a, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_b25d, 5); jmp(0x1010_b2e4, 0x82); goto l_0x1010_b2e4; /* jmp 0x1010b2e4 */
        l_0x1010_b262:
            ii(0x1010_b262, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1010_b269, 7); mov(memd[ss, ebp - 0xc], 0x64);         /* mov dword [ebp-0xc], 0x64 */
            ii(0x1010_b270, 5); jmp(0x1010_b300, 0x8b); goto l_0x1010_b300; /* jmp 0x1010b300 */
        l_0x1010_b275:
            ii(0x1010_b275, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1010_b27c, 7); mov(memd[ss, ebp - 0xc], 0xc8);         /* mov dword [ebp-0xc], 0xc8 */
            ii(0x1010_b283, 5); jmp(0x1010_b300, 0x78); goto l_0x1010_b300; /* jmp 0x1010b300 */
        l_0x1010_b288:
            ii(0x1010_b288, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1010_b28f, 7); mov(memd[ss, ebp - 0xc], 0x190);        /* mov dword [ebp-0xc], 0x190 */
            ii(0x1010_b296, 2); jmp(0x1010_b300, 0x68); goto l_0x1010_b300; /* jmp 0x1010b300 */
        l_0x1010_b298:
            ii(0x1010_b298, 7); mov(memd[ss, ebp - 0x10], 0x1);         /* mov dword [ebp-0x10], 0x1 */
            ii(0x1010_b29f, 7); mov(memd[ss, ebp - 0xc], 0xc8);         /* mov dword [ebp-0xc], 0xc8 */
            ii(0x1010_b2a6, 2); jmp(0x1010_b300, 0x58); goto l_0x1010_b300; /* jmp 0x1010b300 */
        l_0x1010_b2a8:
            ii(0x1010_b2a8, 7); mov(memd[ss, ebp - 0x10], 0x1);         /* mov dword [ebp-0x10], 0x1 */
            ii(0x1010_b2af, 7); mov(memd[ss, ebp - 0xc], 0x190);        /* mov dword [ebp-0xc], 0x190 */
            ii(0x1010_b2b6, 2); jmp(0x1010_b300, 0x48); goto l_0x1010_b300; /* jmp 0x1010b300 */
        l_0x1010_b2b8:
            ii(0x1010_b2b8, 7); mov(memd[ss, ebp - 0x10], 0x1);         /* mov dword [ebp-0x10], 0x1 */
            ii(0x1010_b2bf, 7); mov(memd[ss, ebp - 0xc], 0x320);        /* mov dword [ebp-0xc], 0x320 */
        ...
        l_0x1010_b2e4:
            ii(0x1010_b2e4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_b2e7, 3); sub(eax, 0x28);                         /* sub eax, 0x28 */
            ii(0x1010_b2ea, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1010_b2ed, 4); cmp(memd[ss, ebp - 0x14], 0x5);         /* cmp dword [ebp-0x14], 0x5 */
            ii(0x1010_b2f1, 2); if(ja(0x1010_b2c8, -0x2b)) goto l_0x1010_b2c8; /* ja 0x1010b2c8 */
            ii(0x1010_b2f3, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
