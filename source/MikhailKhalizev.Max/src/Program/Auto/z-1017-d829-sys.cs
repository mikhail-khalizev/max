...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_d829()
        {
            ...
            ii(0x1017_d836, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1017_d839, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x1017_d83c, 4); test(memb[ss, ebp - 0xc], 0x2);         /* test byte [ebp-0xc], 0x2 */
            ii(0x1017_d840, 2); if(jz(0x1017_d84b, 0x9)) goto l_0x1017_d84b; /* jz 0x1017d84b */
            ii(0x1017_d842, 7); mov(memb[ds, 0x101c_1a58], 0x1);        /* mov byte [0x101c1a58], 0x1 */
            ii(0x1017_d849, 2); jmp(0x1017_d852, 0x7); goto l_0x1017_d852; /* jmp 0x1017d852 */
        l_0x1017_d84b:
            ii(0x1017_d84b, 7); mov(memb[ds, 0x101c_1a58], 0);          /* mov byte [0x101c1a58], 0x0 */
        l_0x1017_d852:
            ii(0x1017_d852, 4); test(memb[ss, ebp - 0xc], 0x1);         /* test byte [ebp-0xc], 0x1 */
            ii(0x1017_d856, 2); if(jnz(0x1017_d884, 0x2c)) goto l_0x1017_d884; /* jnz 0x1017d884 */
            ii(0x1017_d858, 7); mov(memb[ds, 0x101c_1a54], 0x1);        /* mov byte [0x101c1a54], 0x1 */
            ...
            ii(0x1017_d882, 2); jmp(0x1017_d88b, 0x7); goto l_0x1017_d88b; /* jmp 0x1017d88b */
        l_0x1017_d884:
            ii(0x1017_d884, 7); mov(memb[ds, 0x101c_1a54], 0);          /* mov byte [0x101c1a54], 0x0 */
        l_0x1017_d88b:
            ii(0x1017_d88b, 4); cmp(memd[ss, ebp - 0x10], 0);           /* cmp dword [ebp-0x10], 0x0 */
            ii(0x1017_d88f, 2); if(jz(0x1017_d897, 0x6)) goto l_0x1017_d897; /* jz 0x1017d897 */
            ii(0x1017_d891, 4); test(memb[ss, ebp - 0xc], 0x1);         /* test byte [ebp-0xc], 0x1 */
            ii(0x1017_d895, 2); if(jz(0x1017_d899, 0x2)) goto l_0x1017_d899; /* jz 0x1017d899 */
        l_0x1017_d897:
            ii(0x1017_d897, 2); jmp(0x1017_d8eb, 0x52); goto l_0x1017_d8eb; /* jmp 0x1017d8eb */
        l_0x1017_d899:
            ii(0x1017_d899, 7); cmp(memd[ss, ebp - 0x10], 0xff00);      /* cmp dword [ebp-0x10], 0xff00 */
        ...
        l_0x1017_d8b8:
            ...
            ii(0x1017_d8bf, 3); div(memd[ss, ebp - 0x10]);              /* div dword [ebp-0x10] */
            ii(0x1017_d8c2, 5); call(/* sys */ 0x1017_de3a, 0x573);     /* call 0x1017de3a */
            ii(0x1017_d8c7, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
        ...
        l_0x1017_d8f5:
            ii(0x1017_d8f5, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1017_d8fc, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
