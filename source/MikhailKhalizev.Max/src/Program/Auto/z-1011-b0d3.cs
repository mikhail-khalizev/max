...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_b0d3()
        {
            ...
            ii(0x1011_b11a, 3); lea(edx, memd[ss, ebp - 12]);           /* lea edx, [ebp-0xc] */
        ...
        l_0x1011_b130:
            ii(0x1011_b130, 3); dec(memd[ss, ebp - 12]);                /* dec dword [ebp-0xc] */
            ii(0x1011_b133, 5); cmp(memw[ss, ebp - 12], -1 /* 0xff */); /* cmp word [ebp-0xc], 0xffff */
            ii(0x1011_b138, 2); if(jz(0x1011_b15a, 0x20)) goto l_0x1011_b15a; /* jz 0x1011b15a */
            ii(0x1011_b13a, 5); mov(ebx, 2);                            /* mov ebx, 0x2 */
            ii(0x1011_b13f, 3); lea(edx, memd[ss, ebp - 16]);           /* lea edx, [ebp-0x10] */
            ii(0x1011_b142, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1011_b145, 5); call(0x1013_ba86, 0x2_093c);            /* call 0x1013ba86 */
            ii(0x1011_b14a, 3); lea(edx, memd[ss, ebp - 16]);           /* lea edx, [ebp-0x10] */
