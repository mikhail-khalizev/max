...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_b0d3()
        {
            ...
            ii(0x1011_b0ea, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_b0ed, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1011_b0f0, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_b0f3, 3); add(edx, 0x8);                          /* add edx, 0x8 */
            ii(0x1011_b0f6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_b0f9, 5); call(0x1013_bb7b, 0x2_0a7d);            /* call 0x1013bb7b */
            ii(0x1011_b0fe, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_b101, 3); add(edx, 0xa);                          /* add edx, 0xa */
            ii(0x1011_b104, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_b107, 5); call(0x1013_bb7b, 0x2_0a6f);            /* call 0x1013bb7b */
            ii(0x1011_b10c, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
