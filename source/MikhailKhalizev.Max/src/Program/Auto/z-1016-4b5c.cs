...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_4b5c()
        {
            ...
            ii(0x1016_4b71, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ...
            ii(0x1016_4b99, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1016_4b9c, 5); call(0x1007_6204, -0xe_e99d);           /* call 0x10076204 */
            ii(0x1016_4ba1, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1016_4ba3, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
        ...
        l_0x1016_4baf:
            ii(0x1016_4baf, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1016_4bb2, 4); mov(dx, memw[ds, eax + 0x52]);          /* mov dx, [eax+0x52] */
            ii(0x1016_4bb6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1016_4bb9, 3); mov(memw[ds, eax], dx);                 /* mov [eax], dx */
            ii(0x1016_4bbc, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1016_4bbf, 5); call(0x1007_623c, -0xe_e988);           /* call 0x1007623c */
            ii(0x1016_4bc4, 4); mov(dx, memw[ds, eax + 0x19]);          /* mov dx, [eax+0x19] */
            ii(0x1016_4bc8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1016_4bd3:
            ...
            ii(0x1016_4be6, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1016_4be9, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1016_4bf8, 3); mov(memb[ss, ebp - 0x2c], al);          /* mov [ebp-0x2c], al */
            ii(0x1016_4bfb, 2); jmp(0x1016_4c3b, 0x3e); goto l_0x1016_4c3b; /* jmp 0x10164c3b */
        l_0x1016_4bfd:
            ii(0x1016_4bfd, 3); mov(eax, memd[ss, ebp - 0x1a]);         /* mov eax, [ebp-0x1a] */
            ii(0x1016_4c00, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1016_4c03, 3); mov(memw[ds, edx], ax);                 /* mov [edx], ax */
            ii(0x1016_4c06, 3); mov(eax, memd[ss, ebp - 0x26]);         /* mov eax, [ebp-0x26] */
            ii(0x1016_4c09, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1016_4c0c, 3); mov(memw[ds, edx], ax);                 /* mov [edx], ax */
            ii(0x1016_4c0f, 2); jmp(0x1016_4c5d, 0x4c); goto l_0x1016_4c5d; /* jmp 0x10164c5d */
        l_0x1016_4c11:
            ii(0x1016_4c11, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1016_4c14, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1016_4c17, 3); mov(memw[ds, edx], ax);                 /* mov [edx], ax */
            ii(0x1016_4c1a, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x1016_4c1d, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1016_4c20, 3); mov(memw[ds, edx], ax);                 /* mov [edx], ax */
            ii(0x1016_4c23, 2); jmp(0x1016_4c5d, 0x38); goto l_0x1016_4c5d; /* jmp 0x10164c5d */
        l_0x1016_4c25:
            ii(0x1016_4c25, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x1016_4c28, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1016_4c2b, 3); mov(memw[ds, edx], ax);                 /* mov [edx], ax */
            ii(0x1016_4c2e, 3); mov(eax, memd[ss, ebp - 0x28]);         /* mov eax, [ebp-0x28] */
            ii(0x1016_4c31, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x1016_4c3b:
            ii(0x1016_4c3b, 3); mov(al, memb[ss, ebp - 0x2c]);          /* mov al, [ebp-0x2c] */
            ii(0x1016_4c3e, 3); mov(memb[ss, ebp - 0x30], al);          /* mov [ebp-0x30], al */
            ii(0x1016_4c41, 4); cmp(memb[ss, ebp - 0x30], 0x2);         /* cmp byte [ebp-0x30], 0x2 */
            ii(0x1016_4c45, 2); if(jb(0x1016_4c55, 0xe)) goto l_0x1016_4c55; /* jb 0x10164c55 */
            ii(0x1016_4c47, 4); cmp(memb[ss, ebp - 0x30], 0x2);         /* cmp byte [ebp-0x30], 0x2 */
            ii(0x1016_4c4b, 2); if(jbe(0x1016_4c11, -0x3c)) goto l_0x1016_4c11; /* jbe 0x10164c11 */
            ii(0x1016_4c4d, 4); cmp(memb[ss, ebp - 0x30], 0x3);         /* cmp byte [ebp-0x30], 0x3 */
        ...
        l_0x1016_4c55:
            ii(0x1016_4c55, 4); cmp(memb[ss, ebp - 0x30], 0x1);         /* cmp byte [ebp-0x30], 0x1 */
