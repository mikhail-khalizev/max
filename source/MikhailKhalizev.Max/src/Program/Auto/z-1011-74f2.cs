...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_74f2()
        {
            ...
            ii(0x1011_7513, 3); lea(eax, memd[ss, ebp - 72]);           /* lea eax, [ebp-0x48] */
            ...
            ii(0x1011_7522, 3); lea(eax, memd[ss, ebp - 72]);           /* lea eax, [ebp-0x48] */
            ii(0x1011_7525, 5); call(0x1011_73eb, -0x13f);              /* call 0x101173eb */
            ii(0x1011_752a, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1011_752d, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_752f, 3); lea(eax, memd[ss, ebp - 72]);           /* lea eax, [ebp-0x48] */
        ...
        //  ii(0x1011_753b, 3); lea(eax, memd[ss, ebp - 72]);           /* lea eax, [ebp-0x48] */
        //  ii(0x1011_753e, 5); call(0x1011_7319, -0x22a);              /* call 0x10117319 */
        l_0x1011_7543:
            ii(0x1011_7543, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
