...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("6ae4c039-80c7-42c5-9e6a-f6bbfb060fe8")]
        public void Method_100e_d2dc()
        {
            ...
            ii(0x100e_d2e8, 2); jad_func(0x100e_d29d, -0x4d);           /* ja 0x100ed29d */
            ...
            ii(0x100e_d2f3, 7); jmpd_abs(memd_a32[cs, eax + 0x100e_d2a0]); return; /* jmp dword [cs:eax+0x100ed2a0] */
        }
    }
}
