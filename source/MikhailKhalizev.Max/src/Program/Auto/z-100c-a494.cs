...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_a494()
        {
            ...
            ii(0x100c_a4ab, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_a4ae, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100c_a4b1, 7); test(memd[ss, ebp - 0x4], 0x4);         /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x100c_a4bf, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100c_a4ce:
            ...
            ii(0x100c_a4d0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_a4de, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_a4e1, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x100c_a4e6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_a4e9, 5); call(0x1013_ab27, 0x7_0639);            /* call 0x1013ab27 */
            ii(0x100c_a4ee, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_a4f1, 7); test(memd[ss, ebp - 0x4], 0x2);         /* test dword [ebp-0x4], 0x2 */
            ii(0x100c_a4f8, 2); if(jz(0x100c_a502, 0x8)) goto l_0x100c_a502; /* jz 0x100ca502 */
            ii(0x100c_a4fa, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_a4fd, 5); call(Definitions.sys_delete, 0x9_ba62); /* call 0x10165f64 */
        l_0x100c_a502:
            ii(0x100c_a502, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
