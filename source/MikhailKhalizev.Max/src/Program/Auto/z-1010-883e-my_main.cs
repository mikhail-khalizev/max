...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void my_main()
        {
            ii(0x1010_883e, 5); push(0x20);                             /* push 0x20 */
            ii(0x1010_8843, 5); call(Definitions.sys_check_available_stack_size, 0x5_d50a); /* call 0x10165d52 */
            ii(0x1010_8848, 1); push(ebx);                              /* push ebx */
            ii(0x1010_8849, 1); push(ecx);                              /* push ecx */
            ii(0x1010_884a, 1); push(esi);                              /* push esi */
            ...
            ii(0x1010_8873, 2); if(jnz(0x1010_8884, 0xf)) goto l_0x1010_8884; /* jnz 0x10108884 */
            ii(0x1010_8875, 5); mov(edx, 0xbb8);                        /* mov edx, 0xbb8 */
            ii(0x1010_887a, 5); mov(eax, 0x6e7);                        /* mov eax, 0x6e7 */
            ii(0x1010_887f, 5); call(0x1010_8794, -0xf0);               /* call 0x10108794 */
        l_0x1010_8884:
            ...
            ii(0x1010_8890, 5); call(0x1013_cf8e, 0x3_46f9);            /* call 0x1013cf8e */
            ii(0x1010_8895, 5); mov(edx, 0xbb8);                        /* mov edx, 0xbb8 */
            ii(0x1010_889a, 5); mov(eax, 0x6e8);                        /* mov eax, 0x6e8 */
            ii(0x1010_889f, 5); call(0x1010_8794, -0x110);              /* call 0x10108794 */
            ii(0x1010_88a4, 5); call(0x1011_1e00, 0x9557);              /* call 0x10111e00 */
            ii(0x1010_88a9, 2); mov(esp, ebp);                          /* mov esp, ebp */
            ii(0x1010_88ab, 1); pop(ebp);                               /* pop ebp */
            ii(0x1010_88ac, 1); pop(edi);                               /* pop edi */
            ii(0x1010_88ad, 1); pop(esi);                               /* pop esi */
            ii(0x1010_88ae, 1); pop(ecx);                               /* pop ecx */
            ii(0x1010_88af, 1); pop(ebx);                               /* pop ebx */
            ii(0x1010_88b0, 1); ret();                                  /* ret */
        }
    }
}
