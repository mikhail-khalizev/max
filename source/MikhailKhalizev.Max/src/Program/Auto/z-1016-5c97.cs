...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_5c97()
        {
            ...
            ii(0x1016_5caf, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1016_5cb2, 4);  or(memb[ss, ebp - 8], 1);             /* or byte [ebp-0x8], 0x1 */
            ii(0x1016_5cb6, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1016_5cb9, 6);  lea(eax, memd[ss, ebp - 132]);        /* lea eax, [ebp-0x84] */
            ii(0x1016_5cbf, 5);  call(0x1016_4c63, -0x1061);           /* call 0x10164c63 */
            ii(0x1016_5cc4, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1016_5cc7, 4);  and(memb[ss, ebp - 8], -2 /* 0xfe */);/* and byte [ebp-0x8], 0xfe */
            ii(0x1016_5ccb, 6);  lea(eax, memd[ss, ebp - 132]);        /* lea eax, [ebp-0x84] */
            ii(0x1016_5cd1, 5);  call(0x1016_5bda, -0xfc);             /* call 0x10165bda */
            ii(0x1016_5cd6, 3);  mov(eax, memd[ss, ebp - 109]);        /* mov eax, [ebp-0x6d] */
            ii(0x1016_5cd9, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1016_5cdc, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1016_5cde, 6);  lea(eax, memd[ss, ebp - 132]);        /* lea eax, [ebp-0x84] */
        ...
        //  ii(0x1016_5ced, 6);  lea(eax, memd[ss, ebp - 132]);        /* lea eax, [ebp-0x84] */
        //  ii(0x1016_5cf3, 5);  call(0x1016_564c, -0x6ac);            /* call 0x1016564c */
        l_0x1016_5cf8:
            ii(0x1016_5cf8, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
