...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_fed2()
        {
            ...
            ii(0x19_fedb, 3); push(memw[ss, bp + 10]);                  /* push word [bp+0xa] */
            ii(0x19_fede, 3); push(memw[ss, bp + 8]);                   /* push word [bp+0x8] */
            ii(0x19_fee1, 3); push(memw[ss, bp + 6]);                   /* push word [bp+0x6] */
            ii(0x19_fee4, 3); push(memw[ss, bp + 4]);                   /* push word [bp+0x4] */
