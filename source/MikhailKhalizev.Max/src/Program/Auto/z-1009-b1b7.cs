...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_b1b7()
        {
            ...
            ii(0x1009_b1cf, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_b1d2, 4); mov(memb[ss, ebp - 0x8], 0x28);         /* mov byte [ebp-0x8], 0x28 */
            ii(0x1009_b1d6, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
