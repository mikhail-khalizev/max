...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1018_d40e:
            ...
            ii(0x1018_d413, 7); mov(memd[ds, edx + 20], 1);             /* mov dword [edx+0x14], 0x1 */
            ii(0x1018_d41a, 2); jmp(0x1018_d423, 7); goto l_0x1018_d423; /* jmp 0x1018d423 */
        l_0x1018_d41c:
            ii(0x1018_d41c, 7); mov(memd[ds, edx + 20], 0x1000);        /* mov dword [edx+0x14], 0x1000 */
        l_0x1018_d423:
            ii(0x1018_d423, 3); mov(eax, memd[ds, edx + 20]);           /* mov eax, [edx+0x14] */
            ...
            ii(0x1018_d432, 3); mov(cl, memb[ds, edx + 13]);            /* mov cl, [edx+0xd] */
            ii(0x1018_d435, 7); mov(memd[ds, edx + 20], 1);             /* mov dword [edx+0x14], 0x1 */
            ii(0x1018_d43c, 3); and(cl, 0xf8);                          /* and cl, 0xf8 */
            ii(0x1018_d43f, 3); lea(eax, memd[ds, edx + 24]);           /* lea eax, [edx+0x18] */
            ii(0x1018_d442, 3); mov(memb[ds, edx + 13], cl);            /* mov [edx+0xd], cl */
            ...
            ii(0x1018_d44d, 3); mov(memb[ds, edx + 13], ch);            /* mov [edx+0xd], ch */
            ii(0x1018_d450, 2); jmp(0x1018_d456, 4); goto l_0x1018_d456; /* jmp 0x1018d456 */
        l_0x1018_d452:
            ii(0x1018_d452, 4); or(memb[ds, edx + 12], 8);              /* or byte [edx+0xc], 0x8 */
        l_0x1018_d456:
