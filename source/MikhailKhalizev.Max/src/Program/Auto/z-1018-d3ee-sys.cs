...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_d3ee()
        {
            ...
            ii(0x1018_d403, 2); if(jz(0x1018_d40e, 0x9)) goto l_0x1018_d40e; /* jz 0x1018d40e */
        ...
        l_0x1018_d40e:
            ...
            ii(0x1018_d411, 2); if(jz(0x1018_d41c, 0x9)) goto l_0x1018_d41c; /* jz 0x1018d41c */
            ii(0x1018_d413, 7); mov(memd[ds, edx + 0x14], 0x1);         /* mov dword [edx+0x14], 0x1 */
            ii(0x1018_d41a, 2); jmp(0x1018_d423, 0x7); goto l_0x1018_d423; /* jmp 0x1018d423 */
        l_0x1018_d41c:
        ...
        l_0x1018_d423:
            ...
            ii(0x1018_d42b, 3); mov(memd[ds, edx + 0x8], eax);          /* mov [edx+0x8], eax */
            ...
            ii(0x1018_d435, 7); mov(memd[ds, edx + 0x14], 0x1);         /* mov dword [edx+0x14], 0x1 */
            ...
            ii(0x1018_d447, 3); mov(memd[ds, edx + 0x8], eax);          /* mov [edx+0x8], eax */
            ii(0x1018_d44a, 3); or(ch, 0x4);                            /* or ch, 0x4 */
            ii(0x1018_d44d, 3); mov(memb[ds, edx + 0xd], ch);           /* mov [edx+0xd], ch */
            ii(0x1018_d450, 2); jmp(0x1018_d456, 0x4); goto l_0x1018_d456; /* jmp 0x1018d456 */
        l_0x1018_d452:
            ii(0x1018_d452, 4); or(memb[ds, edx + 0xc], 0x8);           /* or byte [edx+0xc], 0x8 */
        l_0x1018_d456:
            ii(0x1018_d456, 3); mov(eax, memd[ds, edx + 0x8]);          /* mov eax, [edx+0x8] */
            ii(0x1018_d459, 7); mov(memd[ds, edx + 0x4], 0);            /* mov dword [edx+0x4], 0x0 */
