...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_2d1d()
        {
            ...
            ii(0x100e_2d34, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_2d37, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100e_2d3a, 7); test(memd[ss, ebp - 0x4], 0x4);         /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x100e_2d48, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100e_2d57:
            ii(0x100e_2d57, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_2d5a, 7); mov(memd[ds, eax + 0x13], 0x101b_6060); /* mov dword [eax+0x13], 0x101b6060 */
            ii(0x100e_2d61, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_2d64, 5); call(0x100e_3b27, 0xdbe);               /* call 0x100e3b27 */
            ii(0x100e_2d69, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100e_2d6b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100e_2d79, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_2d7c, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100e_2d7e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100e_2d8c, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_2d8f, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x100e_2d94, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_2d97, 5); call(0x100d_6999, -0xc403);             /* call 0x100d6999 */
            ii(0x100e_2d9c, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_2d9f, 7); test(memd[ss, ebp - 0x4], 0x2);         /* test dword [ebp-0x4], 0x2 */
            ii(0x100e_2da6, 2); if(jz(0x100e_2db0, 0x8)) goto l_0x100e_2db0; /* jz 0x100e2db0 */
            ii(0x100e_2da8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_2dab, 5); call(Definitions.sys_delete, 0x8_31b4); /* call 0x10165f64 */
        l_0x100e_2db0:
            ii(0x100e_2db0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_2db3, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100e_2db6, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
