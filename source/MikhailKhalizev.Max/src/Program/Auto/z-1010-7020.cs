...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_7020()
        {
            ...
            ii(0x1010_7036, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1010_7039, 3);  mov(memd[ss, ebp - 8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1010_703c, 3);  mov(memb[ss, ebp - 4], bl);           /* mov [ebp-0x4], bl */
            ii(0x1010_703f, 9);  mov(memw[ds, 0x101c_59b6], 0);        /* mov word [0x101c59b6], 0x0 */
        l_0x1010_7048:
            ii(0x1010_7048, 3);  dec(memd[ss, ebp - 8]);               /* dec dword [ebp-0x8] */
            ii(0x1010_704b, 5);  cmp(memw[ss, ebp - 8], -1 /* 0xff */);/* cmp word [ebp-0x8], 0xffff */
            ii(0x1010_7050, 2);  if(jz(0x1010_7066, 0x14)) goto l_0x1010_7066;/* jz 0x10107066 */
            ii(0x1010_7052, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1010_7055, 3);  inc(memd[ss, ebp - 12]);              /* inc dword [ebp-0xc] */
        ...
        l_0x1010_7066:
            ...
            ii(0x1010_7068, 3);  mov(al, memb[ss, ebp - 4]);           /* mov al, [ebp-0x4] */
            ii(0x1010_706b, 5);  call(0x100c_ddb2, -0x3_92be);         /* call 0x100cddb2 */
            ii(0x1010_7070, 6);  mov(ax, memw[ds, 0x101c_59b6]);       /* mov ax, [0x101c59b6] */
            ii(0x1010_7076, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1010_7079, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
