...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x56a0:
            ...
            ii(0x56a4, 4);  cmp(memw[ds, bx + 24], 0x21);              /* cmp word [bx+0x18], 0x21 */
            ii(0x56a8, 2);  if(jnz(0x56b3, 9)) goto l_0x56b3;          /* jnz 0x56b3 */
            ii(0x56aa, 3);  mov(al, memb[ds, bx + 22]);                /* mov al, [bx+0x16] */
            ii(0x56ad, 1);  cbw();                                     /* cbw */
        ...
        l_0x56b3:
            ...
            ii(0x56bd, 4);  cmp(memw[ds, bx + 24], 0);                 /* cmp word [bx+0x18], 0x0 */
        ...
        l_0x56c6:
            ...
            ii(0x56d2, 4);  cmp(memw[ds, bx + 24], 0xd);               /* cmp word [bx+0x18], 0xd */
        ...
        l_0x56dd:
            ii(0x56dd, 4);  cmp(memw[ds, bx + 24], 6);                 /* cmp word [bx+0x18], 0x6 */
        ...
        l_0x56ec:
            ii(0x56ec, 4);  cmp(memw[ds, bx + 24], 0xe);               /* cmp word [bx+0x18], 0xe */
        ...
        l_0x5707:
            ii(0x5707, 3);  push(memw[ds, bx + 24]);                   /* push word [bx+0x18] */
        ...
        l_0x5736:
            ...
            ii(0x574a, 3);  push(memw[ds, bx + 34]);                   /* push word [bx+0x22] */
            ...
            ii(0x5761, 3);  push(memw[ds, bx + 30]);                   /* push word [bx+0x1e] */
            ...
            ii(0x5770, 3);  push(memw[ds, bx + 34]);                   /* push word [bx+0x22] */
        ...
        l_0x5787:
            ...
            ii(0x578e, 3);  push(memw[ds, bx + 26]);                   /* push word [bx+0x1a] */
            ...
            ii(0x57d1, 3);  push(memw[ds, bx + 22]);                   /* push word [bx+0x16] */
            ...
            ii(0x57e1, 3);  push(memw[ds, bx + 16]);                   /* push word [bx+0x10] */
            ...
            ii(0x57f1, 3);  push(memw[ds, bx + 20]);                   /* push word [bx+0x14] */
            ...
            ii(0x5801, 3);  push(memw[ds, bx + 18]);                   /* push word [bx+0x12] */
            ...
            ii(0x5811, 3);  push(memw[ds, bx + 14]);                   /* push word [bx+0xe] */
            ...
            ii(0x5821, 3);  push(memw[ds, bx + 12]);                   /* push word [bx+0xc] */
            ...
            ii(0x5831, 3);  push(memw[ds, bx + 10]);                   /* push word [bx+0xa] */
