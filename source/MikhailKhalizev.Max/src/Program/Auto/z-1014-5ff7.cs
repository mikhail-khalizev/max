...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_5ff7()
        {
            ...
            ii(0x1014_600e, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_6011, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_6014, 3);  mov(ebx, memd[ss, ebp - 4]);          /* mov ebx, [ebp-0x4] */
            ii(0x1014_6017, 3);  lea(edx, memd[ss, ebp - 24]);         /* lea edx, [ebp-0x18] */
            ii(0x1014_601a, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_601d, 5);  call(0x1014_630a, 0x2e8);             /* call 0x1014630a */
            ii(0x1014_6022, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1014_6024, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x1014_6030, 4);  mov(memb[ss, ebp - 12], 0);           /* mov byte [ebp-0xc], 0x0 */
            ii(0x1014_6034, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1014_6036, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        ...
        l_0x1014_6040:
            ...
            ii(0x1014_6045, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x1014_6048, 5);  call(0x100e_0760, -0x6_58ed);         /* call 0x100e0760 */
            ii(0x1014_604d, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1014_6050, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1014_6053, 3);  mov(ebx, memd[ds, eax + 2]);          /* mov ebx, [eax+0x2] */
            ii(0x1014_6056, 3);  lea(edx, memd[ss, ebp - 20]);         /* lea edx, [ebp-0x14] */
            ii(0x1014_6059, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1014_605c, 3);  call_abs(memd[ds, ebx + 12]);         /* call dword [ebx+0xc] */
            ...
            ii(0x1014_606d, 2);  if(jnz(0x1014_6075, 6)) goto l_0x1014_6075;/* jnz 0x10146075 */
            ii(0x1014_606f, 4);  mov(memb[ss, ebp - 28], 1);           /* mov byte [ebp-0x1c], 0x1 */
            ii(0x1014_6073, 2);  jmp(0x1014_6079, 4); goto l_0x1014_6079;/* jmp 0x10146079 */
        l_0x1014_6075:
            ii(0x1014_6075, 4);  mov(memb[ss, ebp - 28], 0);           /* mov byte [ebp-0x1c], 0x0 */
        l_0x1014_6079:
            ii(0x1014_6079, 3);  mov(al, memb[ss, ebp - 28]);          /* mov al, [ebp-0x1c] */
            ii(0x1014_607c, 3);  mov(memb[ss, ebp - 12], al);          /* mov [ebp-0xc], al */
            ii(0x1014_607f, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1014_6081, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_6084, 5);  call(Definitions.my_string_dtor, -0x455f);/* call 0x10141b2a */
            ii(0x1014_6089, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1014_608b, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        ...
        //  ii(0x1014_6097, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        //  ii(0x1014_609a, 5);  call(0x100e_03bc, -0x6_5ce3);         /* call 0x100e03bc */
        l_0x1014_609f:
            ii(0x1014_609f, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
