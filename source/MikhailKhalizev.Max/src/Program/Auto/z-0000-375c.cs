...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x3766:
            ii(0x3766, 4);  mov(memw[ds, bx + 198], ax);               /* mov [bx+0xc6], ax */
            ii(0x376a, 6);  mov(memw[ds, bx + 196], 0x8e00);           /* mov word [bx+0xc4], 0x8e00 */
            ii(0x3770, 6);  mov(memw[ds, bx + 194], 0x70);             /* mov word [bx+0xc2], 0x70 */
            ii(0x3776, 4);  mov(memw[ds, bx + 192], dx);               /* mov [bx+0xc0], dx */
            ii(0x377a, 3);  add(dx, 4);                                /* add dx, 0x4 */
            ii(0x377d, 3);  add(bx, 8);                                /* add bx, 0x8 */
        ...
        l_0x378a:
            ii(0x378a, 4);  mov(memw[ds, bx + 192], dx);               /* mov [bx+0xc0], dx */
            ii(0x378e, 4);  add(dx, 0x1c);                             /* add dx, 0x1c */
            ii(0x3792, 3);  add(bx, 8);                                /* add bx, 0x8 */
        ...
        l_0x37d4:
            ...
            ii(0x37d7, 5);  test(memb[ds, 0x47], 1);                   /* test byte [0x47], 0x1 */
            ...
            ii(0x37f8, 3);  add(bl, 5);                                /* add bl, 0x5 */
            ii(0x37fb, 2);  xor(bh, bh);                               /* xor bh, bh */
            ii(0x37fd, 3);  shl(bx, 3);                                /* shl bx, 0x3 */
            ii(0x3800, 6);  mov(memw[ds, bx + 192], 0x556);            /* mov word [bx+0xc0], 0x556 */
        l_0x3806:
            ...
            ii(0x3815, 2);  if(jz(0x3819, 2)) goto l_0x3819;           /* jz 0x3819 */
        ...
        l_0x3819:
            ...
            ii(0x382a, 2);  if(jz(0x3832, 6)) goto l_0x3832;           /* jz 0x3832 */
            ii(0x382c, 2);  cmp(al, 0xb);                              /* cmp al, 0xb */
            ii(0x382e, 2);  if(jz(0x3832, 2)) goto l_0x3832;           /* jz 0x3832 */
