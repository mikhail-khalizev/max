...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_e19c()
        {
            ...
            ii(0x1009_e1b4, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_e1b7, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_e1b9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_e1cc, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_e1cf, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_e1e3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_e1e6, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x1009_e1e9, 5); call(0x1007_6574, -0x2_7c7a);           /* call 0x10076574 */
            ii(0x1009_e1ee, 3); mov(al, memb[ds, eax + 0x4e]);          /* mov al, [eax+0x4e] */
        ...
        l_0x1009_e1fa:
            ii(0x1009_e1fa, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1009_e207:
            ii(0x1009_e207, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_e20a, 4); cmp(memb[ds, eax + 0x3e], 0);           /* cmp byte [eax+0x3e], 0x0 */
            ii(0x1009_e20e, 2); if(jnz(0x1009_e25d, 0x4d)) goto l_0x1009_e25d; /* jnz 0x1009e25d */
            ii(0x1009_e210, 5); mov(ebx, 0x3);                          /* mov ebx, 0x3 */
            ii(0x1009_e215, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_e218, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x1009_e21b, 5); call(0x1007_65d0, -0x2_7c50);           /* call 0x100765d0 */
            ii(0x1009_e220, 3); mov(ecx, memd[ss, ebp - 0x4]);          /* mov ecx, [ebp-0x4] */
            ...
            ii(0x1009_e230, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1009_e23d:
            ...
            ii(0x1009_e242, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_e254, 2); if(jz(0x1009_e25d, 0x7)) goto l_0x1009_e25d; /* jz 0x1009e25d */
            ii(0x1009_e256, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_e259, 4); mov(memb[ds, eax + 0x3e], 0x1);         /* mov byte [eax+0x3e], 0x1 */
        l_0x1009_e25d:
            ii(0x1009_e25d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_e260, 4); cmp(memb[ds, eax + 0x3e], 0);           /* cmp byte [eax+0x3e], 0x0 */
            ii(0x1009_e264, 2); if(jz(0x1009_e2a3, 0x3d)) goto l_0x1009_e2a3; /* jz 0x1009e2a3 */
            ii(0x1009_e266, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_e269, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x1009_e26c, 5); call(0x1007_6574, -0x2_7cfd);           /* call 0x10076574 */
            ii(0x1009_e271, 4); mov(dx, memw[ds, eax + 0x1a]);          /* mov dx, [eax+0x1a] */
            ii(0x1009_e275, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_e278, 4); cmp(dx, memw[ds, eax + 0x17]);          /* cmp dx, [eax+0x17] */
            ii(0x1009_e27c, 2); if(jnz(0x1009_e296, 0x18)) goto l_0x1009_e296; /* jnz 0x1009e296 */
            ii(0x1009_e27e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_e281, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x1009_e284, 5); call(0x1007_6574, -0x2_7d15);           /* call 0x10076574 */
            ii(0x1009_e289, 4); mov(dx, memw[ds, eax + 0x1c]);          /* mov dx, [eax+0x1c] */
            ii(0x1009_e28d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_e290, 4); cmp(dx, memw[ds, eax + 0x19]);          /* cmp dx, [eax+0x19] */
            ii(0x1009_e294, 2); if(jz(0x1009_e2a3, 0xd)) goto l_0x1009_e2a3; /* jz 0x1009e2a3 */
        l_0x1009_e296:
            ii(0x1009_e296, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1009_e2a3:
            ii(0x1009_e2a3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_e2a6, 3); mov(eax, memd[ds, eax + 0x1f]);         /* mov eax, [eax+0x1f] */
            ii(0x1009_e2a9, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1009_e2ac, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1009_e2af, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1009_e2b2, 4); mov(dx, memw[ds, eax + 0x23]);          /* mov dx, [eax+0x23] */
            ii(0x1009_e2b6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_e2b9, 4); cmp(dx, memw[ds, eax + 0x2f]);          /* cmp dx, [eax+0x2f] */
            ii(0x1009_e2bd, 2); if(jnz(0x1009_e2db, 0x1c)) goto l_0x1009_e2db; /* jnz 0x1009e2db */
            ii(0x1009_e2bf, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_e2c2, 3); mov(eax, memd[ds, eax + 0x1f]);         /* mov eax, [eax+0x1f] */
            ii(0x1009_e2c5, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1009_e2c8, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1009_e2cb, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1009_e2ce, 4); mov(dx, memw[ds, eax + 0x25]);          /* mov dx, [eax+0x25] */
            ii(0x1009_e2d2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_e2d5, 4); cmp(dx, memw[ds, eax + 0x31]);          /* cmp dx, [eax+0x31] */
            ii(0x1009_e2d9, 2); if(jz(0x1009_e2fd, 0x22)) goto l_0x1009_e2fd; /* jz 0x1009e2fd */
        l_0x1009_e2db:
            ii(0x1009_e2db, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_e2de, 4); mov(dx, memw[ds, eax + 0x23]);          /* mov dx, [eax+0x23] */
            ii(0x1009_e2e2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_e2e5, 4); cmp(dx, memw[ds, eax + 0x27]);          /* cmp dx, [eax+0x27] */
            ii(0x1009_e2e9, 2); if(jnz(0x1009_e2fb, 0x10)) goto l_0x1009_e2fb; /* jnz 0x1009e2fb */
            ii(0x1009_e2eb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_e2ee, 4); mov(dx, memw[ds, eax + 0x25]);          /* mov dx, [eax+0x25] */
            ii(0x1009_e2f2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_e2f5, 4); cmp(dx, memw[ds, eax + 0x29]);          /* cmp dx, [eax+0x29] */
            ii(0x1009_e2f9, 2); if(jz(0x1009_e2fd, 0x2)) goto l_0x1009_e2fd; /* jz 0x1009e2fd */
        l_0x1009_e2fb:
            ii(0x1009_e2fb, 2); jmp(0x1009_e2ff, 0x2); goto l_0x1009_e2ff; /* jmp 0x1009e2ff */
        l_0x1009_e2fd:
            ii(0x1009_e2fd, 2); jmp(0x1009_e30b, 0xc); goto l_0x1009_e30b; /* jmp 0x1009e30b */
        l_0x1009_e2ff:
            ii(0x1009_e2ff, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_e302, 5); call(0x1009_d691, -0xc76);              /* call 0x1009d691 */
            ii(0x1009_e307, 2); test(al, al);                           /* test al, al */
            ii(0x1009_e309, 2); if(jnz(0x1009_e313, 0x8)) goto l_0x1009_e313; /* jnz 0x1009e313 */
        l_0x1009_e30b:
            ii(0x1009_e30b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
