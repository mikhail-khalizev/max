...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("5f610467-9fc4-414b-8718-edec0aeaa3d5")]
        public void Method_1010_8905()
        {
            ii(0x1010_8905, 5); pushd(0x34);                            /* push 0x34 */
            ii(0x1010_890a, 5); calld(Definitions.sys_check_available_stack_size, 0x5d443); /* call 0x10165d52 */
            ...
            ii(0x1010_8932, 5); calld(/* sys */ 0x1017_9230, 0x708f9);  /* call 0x10179230 */
            ii(0x1010_8937, 3); lea(edx, ebp - 0x14);                   /* lea edx, [ebp-0x14] */
            ii(0x1010_893a, 3); mov(eax, memd_a32[ss, ebp - 0xc]);      /* mov eax, [ebp-0xc] */
            ii(0x1010_893d, 5); calld(/* sys */ 0x1017_9244, 0x70902);  /* call 0x10179244 */
            ii(0x1010_8942, 3); lea(eax, ebp - 0x18);                   /* lea eax, [ebp-0x18] */
            ii(0x1010_8945, 5); calld(/* sys */ 0x1017_9230, 0x708e6);  /* call 0x10179230 */
        l_0x1010_894a:
            ...
            ii(0x1010_8957, 5); calld(/* sys */ 0x1017_9368, 0x70a0c);  /* call 0x10179368 */
            ...
            ii(0x1010_896c, 5); calld(/* sys */ 0x1017_9244, 0x708d3);  /* call 0x10179244 */
        l_0x1010_8971:
        ...
        l_0x1010_8993:
            ...
            ii(0x1010_8999, 5); calld(/* sys */ 0x1017_9244, 0x708a6);  /* call 0x10179244 */
