...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("5e2a9fb2-b32c-49af-bec1-492fd19473d8")]
        public void Method_1011_7d58()
        {
            ii(0x1011_7d58, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x1011_7d5d, 5); calld(Definitions.sys_check_available_stack_size, 0x4dff0); /* call 0x10165d52 */
            ...
            ii(0x1011_7d7b, 5); calld(0x1007_6c98, -0xa10e8);           /* call 0x10076c98 */
            ...
            ii(0x1011_7d8d, 1); retd(); return;                         /* ret */
        }
    }
}
