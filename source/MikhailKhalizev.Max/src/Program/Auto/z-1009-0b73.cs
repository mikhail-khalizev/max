...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_0b73()
        {
            ...
            ii(0x1009_0b9e, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1009_0ba1, 6); mov(ax, memw[ds, 0x101c_8172]);         /* mov ax, [0x101c8172] */
            ii(0x1009_0ba7, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1009_0baa, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1009_0bad, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
        l_0x1009_0bb0:
            ...
            ii(0x1009_0bc9, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x1009_0bcc, 4); add(memd[ss, ebp - 12], 4);             /* add dword [ebp-0xc], 0x4 */
        ...
        l_0x1009_0bd4:
            ...
            ii(0x1009_0bf0, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x1009_0bf3, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1009_0bf6, 5); call(0x1009_0aaa, -0x151);              /* call 0x10090aaa */
            ii(0x1009_0bfb, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1009_0bfe, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1009_0c01, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
