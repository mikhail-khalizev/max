...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_b85e()
        {
            ...
            ii(0x19_b89b, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_b89e, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ...
            ii(0x19_b8c3, 3); add(ax, memw[ss, bp - 0x8]);              /* add ax, [bp-0x8] */
            ii(0x19_b8c6, 3); adc(dx, memw[ss, bp - 0x6]);              /* adc dx, [bp-0x6] */
            ...
            ii(0x19_b8d0, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_b8d3, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ...
            ii(0x19_b8e6, 2); if(jz(0x19_b8ed, 0x5)) goto l_0x19_b8ed;  /* jz 0xb8ed */
        ...
        l_0x19_b8ed:
            ...
            ii(0x19_b8f9, 2); if(jz(0x19_b902, 0x7)) goto l_0x19_b902;  /* jz 0xb902 */
        ...
        l_0x19_b902:
            ii(0x19_b902, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0x19_b905, 3); mov(dx, memw[ss, bp - 0x2]);              /* mov dx, [bp-0x2] */
            ...
            ii(0x19_b925, 2); jmp(0x19_b92a, 0x3); goto l_0x19_b92a;    /* jmp 0xb92a */
        l_0x19_b927:
            ii(0x19_b927, 3); mov(ax, 0x514);                           /* mov ax, 0x514 */
        l_0x19_b92a:
            ii(0x19_b92a, 1); leave();                                  /* leave */
            ii(0x19_b92b, 3); ret(0x4);                                 /* ret 0x4 */
        }
    }
}
