...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_b85e()
        {
            ...
            ii(0x19_b867, 4);  mov(memw[es, bx + 112], ax);            /* mov [es:bx+0x70], ax */
            ii(0x19_b86b, 4);  mov(memw[es, bx + 110], ax);            /* mov [es:bx+0x6e], ax */
            ii(0x19_b86f, 2);  sub(al, al);                            /* sub al, al */
            ii(0x19_b871, 5);  mov(memb[es, bx + 179], al);            /* mov [es:bx+0xb3], al */
            ii(0x19_b876, 5);  mov(memb[es, bx + 178], al);            /* mov [es:bx+0xb2], al */
            ii(0x19_b87b, 5);  mov(ax, memw[es, bx + 180]);            /* mov ax, [es:bx+0xb4] */
            ii(0x19_b880, 3);  mov(memw[ss, bp - 76], ax);             /* mov [bp-0x4c], ax */
            ii(0x19_b883, 5);  mov(cx, memw[es, bx + 182]);            /* mov cx, [es:bx+0xb6] */
            ii(0x19_b888, 5);  mov(dx, memw[es, bx + 184]);            /* mov dx, [es:bx+0xb8] */
            ii(0x19_b88d, 3);  mov(memw[ss, bp - 72], cx);             /* mov [bp-0x48], cx */
            ii(0x19_b890, 3);  mov(memw[ss, bp - 70], dx);             /* mov [bp-0x46], dx */
            ...
            ii(0x19_b8a1, 3);  push(memw[ss, bp - 76]);                /* push word [bp-0x4c] */
            ii(0x19_b8a4, 3);  lea(ax, memw[ss, bp - 68]);             /* lea ax, [bp-0x44] */
            ...
            ii(0x19_b8b3, 5);  cmp(memw[ss, bp - 68], 0x5a4d);         /* cmp word [bp-0x44], 0x5a4d */
            ii(0x19_b8b8, 2);  if(jnz(0x19_b8ed, 0x33)) goto l_0x19_b8ed;/* jnz 0xb8ed */
            ii(0x19_b8ba, 3);  push(memw[ss, bp - 76]);                /* push word [bp-0x4c] */
            ii(0x19_b8bd, 3);  mov(ax, memw[ss, bp - 72]);             /* mov ax, [bp-0x48] */
            ii(0x19_b8c0, 3);  mov(dx, memw[ss, bp - 70]);             /* mov dx, [bp-0x46] */
            ...
            ii(0x19_b8d6, 3);  push(memw[ss, bp - 76]);                /* push word [bp-0x4c] */
            ii(0x19_b8d9, 3);  lea(ax, memw[ss, bp - 68]);             /* lea ax, [bp-0x44] */
        ...
        l_0x19_b8ed:
            ii(0x19_b8ed, 5);  cmp(memw[ss, bp - 68], 0x454e);         /* cmp word [bp-0x44], 0x454e */
            ii(0x19_b8f2, 2);  if(jz(0x19_b902, 0xe)) goto l_0x19_b902;/* jz 0xb902 */
            ii(0x19_b8f4, 5);  cmp(memw[ss, bp - 68], 0x454c);         /* cmp word [bp-0x44], 0x454c */
            ii(0x19_b8f9, 2);  if(jz(0x19_b902, 7)) goto l_0x19_b902;  /* jz 0xb902 */
            ii(0x19_b8fb, 5);  cmp(memw[ss, bp - 68], 0x584c);         /* cmp word [bp-0x44], 0x584c */
        ...
        l_0x19_b902:
            ...
            ii(0x19_b90b, 4);  mov(memw[es, bx + 110], ax);            /* mov [es:bx+0x6e], ax */
            ii(0x19_b90f, 4);  mov(memw[es, bx + 112], dx);            /* mov [es:bx+0x70], dx */
            ii(0x19_b913, 3);  mov(al, memb[ss, bp - 68]);             /* mov al, [bp-0x44] */
            ii(0x19_b916, 5);  mov(memb[es, bx + 178], al);            /* mov [es:bx+0xb2], al */
            ii(0x19_b91b, 3);  mov(al, memb[ss, bp - 67]);             /* mov al, [bp-0x43] */
            ii(0x19_b91e, 5);  mov(memb[es, bx + 179], al);            /* mov [es:bx+0xb3], al */
