...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_b280()
        {
            ...
            ii(0x1016_b285, 3);  cmp(eax, -1 /* 0xff */);              /* cmp eax, 0xffffffff */
            ...
            ii(0x1016_b294, 2);  if(jnz(0x1016_b29f, 9)) goto l_0x1016_b29f;/* jnz 0x1016b29f */
        ...
        l_0x1016_b29f:
            ...
            ii(0x1016_b2a5, 2);  if(jnz(0x1016_b2b0, 9)) goto l_0x1016_b2b0;/* jnz 0x1016b2b0 */
        ...
        l_0x1016_b2b0:
            ...
            ii(0x1016_b2bf, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x1016_b2c2, 2);  sub(eax, ebx);                        /* sub eax, ebx */
            ii(0x1016_b2c4, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ...
            ii(0x1016_b2d2, 3);  lea(edx, memd[ds, eax + 8]);          /* lea edx, [eax+0x8] */
            ii(0x1016_b2d5, 3);  add(eax, 4);                          /* add eax, 0x4 */
        ...
        l_0x1016_b2fb:
            ii(0x1016_b2fb, 7);  cmp(memd[ds, 0x101c_fb6c], -1 /* 0xff */);/* cmp dword [0x101cfb6c], 0xffffffff */
            ii(0x1016_b302, 2);  if(jnz(0x1016_b30c, 8)) goto l_0x1016_b30c;/* jnz 0x1016b30c */
