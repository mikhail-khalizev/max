...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_bf06()
        {
            ...
            ii(0x1010_bf1e, 3); mov(memb[ss, ebp - 0x4], al);           /* mov [ebp-0x4], al */
            ii(0x1010_bf21, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x1010_bf25, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
        ...
        l_0x1010_bf39:
            ii(0x1010_bf39, 7); cmp(memb[ds, 0x101c_5630], 0x1);        /* cmp byte [0x101c5630], 0x1 */
            ii(0x1010_bf40, 2); if(jnz(0x1010_bf47, 0x5)) goto l_0x1010_bf47; /* jnz 0x1010bf47 */
        ...
        l_0x1010_bf47:
            ...
            ii(0x1010_bf65, 2); if(jl(0x1010_bf69, 0x2)) goto l_0x1010_bf69; /* jl 0x1010bf69 */
        l_0x1010_bf67:
            ii(0x1010_bf67, 2); jmp(0x1010_bf6d, 0x4); goto l_0x1010_bf6d; /* jmp 0x1010bf6d */
        l_0x1010_bf69:
            ii(0x1010_bf69, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x1010_bf6d:
            ...
            ii(0x1010_bf90, 2); if(jz(0x1010_bf9b, 0x9)) goto l_0x1010_bf9b; /* jz 0x1010bf9b */
        ...
        l_0x1010_bf9b:
            ...
            ii(0x1010_bfa2, 2); if(jnz(0x1010_bfad, 0x9)) goto l_0x1010_bfad; /* jnz 0x1010bfad */
            ii(0x1010_bfa4, 7); mov(memb[ss, ebp - 0x39c], 0x1);        /* mov byte [ebp-0x39c], 0x1 */
            ii(0x1010_bfab, 2); jmp(0x1010_bfb4, 0x7); goto l_0x1010_bfb4; /* jmp 0x1010bfb4 */
        l_0x1010_bfad:
        ...
        l_0x1010_c062:
            ...
            ii(0x1010_c078, 4); cmp(memb[ss, ebp - 0x8], 0);            /* cmp byte [ebp-0x8], 0x0 */
        ...
        l_0x1010_c093:
            ii(0x1010_c093, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ...
            ii(0x1010_c0b5, 2); jmp(0x1010_c0bc, 0x5); goto l_0x1010_c0bc; /* jmp 0x1010c0bc */
        l_0x1010_c0b7:
        ...
        l_0x1010_c0bc:
            ...
            ii(0x1010_c0c3, 2); if(jnz(0x1010_c0ce, 0x9)) goto l_0x1010_c0ce; /* jnz 0x1010c0ce */
            ii(0x1010_c0c5, 7); cmp(memd[ss, ebp - 0x390], 0);          /* cmp dword [ebp-0x390], 0x0 */
            ii(0x1010_c0cc, 2); if(jz(0x1010_c0d0, 0x2)) goto l_0x1010_c0d0; /* jz 0x1010c0d0 */
        l_0x1010_c0ce:
            ii(0x1010_c0ce, 2); jmp(0x1010_c0d5, 0x5); goto l_0x1010_c0d5; /* jmp 0x1010c0d5 */
        l_0x1010_c0d0:
