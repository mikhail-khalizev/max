...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("ca678ac0-18c5-4b77-b919-6836fe875dde")]
        public void Method_100e_d710()
        {
            ...
            ii(0x100e_d71c, 6); if(jad_func(0x100e_d68c, -0x96)) return; /* ja 0x100ed68c */
            ...
            ii(0x100e_d72b, 7); if(jmpd_abs(memd_a32[cs, eax + 0x100e_d6ec])) return; /* jmp dword [cs:eax+0x100ed6ec] */
        }
    }
}
