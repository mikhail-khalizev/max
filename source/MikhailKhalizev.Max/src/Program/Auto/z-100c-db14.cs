...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_db14()
        {
            ...
            ii(0x100c_db2b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_db2e, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100c_db31, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_db34, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x100c_db37, 4); cmp(ax, memw[ds, edx + 0x2]);           /* cmp ax, [edx+0x2] */
            ii(0x100c_db3b, 2); if(jge(0x100c_db9d, 0x60)) goto l_0x100c_db9d; /* jge 0x100cdb9d */
            ii(0x100c_db3d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_db40, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x100c_db42, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x100c_db45, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ...
            ii(0x100c_db4e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_db51, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x100c_db53, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100c_db56, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100c_db5a, 2); sub(edx, eax);                          /* sub edx, eax */
            ii(0x100c_db5c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_db66, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x100c_db6a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_db74, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_db77, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ii(0x100c_db7a, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x100c_db7c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_db7f, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x100c_db82, 4); movsx(ecx, memw[ss, ebp - 0x4]);        /* movsx ecx, word [ebp-0x4] */
            ii(0x100c_db86, 3); imul(ecx, eax);                         /* imul ecx, eax */
            ii(0x100c_db89, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_db8c, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ii(0x100c_db8f, 2); add(eax, ecx);                          /* add eax, ecx */
            ii(0x100c_db91, 5); call(Definitions.sys_memcpy, 0x9_82b5); /* call 0x10165e4b */
        l_0x100c_db96:
            ii(0x100c_db96, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_db99, 4); dec(memw[ds, eax + 0x2]);               /* dec word [eax+0x2] */
        l_0x100c_db9d:
