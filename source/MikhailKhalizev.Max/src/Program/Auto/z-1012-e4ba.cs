...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_e4ba()
        {
            ...
            ii(0x1012_e4d2, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1012_e4d5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1012_e4e7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1012_e4f6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1012_e502, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_e505, 2); jmp(0x1012_e51f, 0x18); goto l_0x1012_e51f; /* jmp 0x1012e51f */
        l_0x1012_e507:
            ii(0x1012_e507, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1012_e514, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_e517, 5); call(0x1012_e2a7, -0x275);              /* call 0x1012e2a7 */
            ii(0x1012_e51c, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x1012_e51f:
            ii(0x1012_e51f, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1012_e523, 3); cmp(eax, 0x2);                          /* cmp eax, 0x2 */
            ii(0x1012_e526, 2); if(jl(0x1012_e54b, 0x23)) goto l_0x1012_e54b; /* jl 0x1012e54b */
            ii(0x1012_e528, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_e52b, 3); sub(eax, 0x2);                          /* sub eax, 0x2 */
            ii(0x1012_e52e, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1012_e531, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1012_e543, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
