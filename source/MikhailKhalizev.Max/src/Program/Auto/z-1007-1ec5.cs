...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_1ec5()
        {
            ...
            ii(0x1007_1edd, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_1ee0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_1ee3, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_1ee6, 2); jmp(0x1007_1efc, 0x14); goto l_0x1007_1efc; /* jmp 0x10071efc */
        l_0x1007_1ee8:
            ii(0x1007_1ee8, 7); mov(memd[ss, ebp - 0xc], 0x6);          /* mov dword [ebp-0xc], 0x6 */
            ii(0x1007_1eef, 2); jmp(0x1007_1f22, 0x31); goto l_0x1007_1f22; /* jmp 0x10071f22 */
        l_0x1007_1ef1:
            ii(0x1007_1ef1, 7); mov(memd[ss, ebp - 0xc], 0x2);          /* mov dword [ebp-0xc], 0x2 */
        ...
        l_0x1007_1efc:
            ii(0x1007_1efc, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_1eff, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1007_1f02, 5); cmp(memw[ss, ebp - 0x10], 0x1);         /* cmp word [ebp-0x10], 0x1 */
            ii(0x1007_1f07, 2); if(jb(0x1007_1f19, 0x10)) goto l_0x1007_1f19; /* jb 0x10071f19 */
            ii(0x1007_1f09, 5); cmp(memw[ss, ebp - 0x10], 0x1);         /* cmp word [ebp-0x10], 0x1 */
            ii(0x1007_1f0e, 2); if(jbe(0x1007_1ee8, -0x28)) goto l_0x1007_1ee8; /* jbe 0x10071ee8 */
            ii(0x1007_1f10, 5); cmp(memw[ss, ebp - 0x10], 0x2);         /* cmp word [ebp-0x10], 0x2 */
        ...
        l_0x1007_1f1b:
            ii(0x1007_1f1b, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
        l_0x1007_1f22:
            ii(0x1007_1f22, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
