...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_4826()
        {
            ...
            ii(0x1012_483e, 3); mov(memb[ss, ebp - 0x4], al);           /* mov [ebp-0x4], al */
            ii(0x1012_4841, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1012_4848, 2); jmp(0x1012_4850, 0x6); goto l_0x1012_4850; /* jmp 0x10124850 */
        l_0x1012_484a:
            ii(0x1012_484a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_484d, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x1012_4850:
            ii(0x1012_4850, 4); cmp(memd[ss, ebp - 0x8], 0x10);         /* cmp dword [ebp-0x8], 0x10 */
            ...
            ii(0x1012_485b, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ...
            ii(0x1012_4864, 3); mov(al, memb[ss, ebp - 0x4]);           /* mov al, [ebp-0x4] */
            ii(0x1012_4867, 5); call(Definitions.sys_tolower, 0x4_e229); /* call 0x10172a95 */
            ii(0x1012_486c, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x1012_486e, 2); if(jnz(0x1012_4878, 0x8)) goto l_0x1012_4878; /* jnz 0x10124878 */
            ii(0x1012_4870, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_4873, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1012_4876, 2); jmp(0x1012_4881, 0x9); goto l_0x1012_4881; /* jmp 0x10124881 */
        l_0x1012_4878:
