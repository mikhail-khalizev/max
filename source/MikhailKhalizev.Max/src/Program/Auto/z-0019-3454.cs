...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_3454()
        {
            ...
            ii(0x19_345d, 3); les(di, memw[ss, bp + 0xa]);              /* les di, [bp+0xa] */
            ...
            ii(0x19_346f, 3); mov(memw[ss, bp - 0x2], cx);              /* mov [bp-0x2], cx */
            ii(0x19_3472, 3); les(di, memw[ss, bp + 0x6]);              /* les di, [bp+0x6] */
            ...
            ii(0x19_3483, 3); sub(dx, memw[ss, bp - 0x2]);              /* sub dx, [bp-0x2] */
            ii(0x19_3486, 2); if(jbe(0x19_34b1, 0x29)) goto l_0x19_34b1; /* jbe 0x34b1 */
            ii(0x19_3488, 2); mov(di, bx);                              /* mov di, bx */
        l_0x19_348a:
            ii(0x19_348a, 3); mov(si, memw[ss, bp + 0xa]);              /* mov si, [bp+0xa] */
            ...
            ii(0x19_349a, 3); mov(cx, memw[ss, bp - 0x2]);              /* mov cx, [bp-0x2] */
            ii(0x19_349d, 2); if(jcxz(0x19_34a3, 0x4)) goto l_0x19_34a3; /* jcxz 0x34a3 */
            ii(0x19_349f, 2); repe(() => cmpsb());                      /* repe cmpsb */
            ii(0x19_34a1, 2); if(jnz(0x19_348a, -0x19)) goto l_0x19_348a; /* jnz 0x348a */
        l_0x19_34a3:
            ii(0x19_34a3, 3); lea(ax, memw[ds, bx - 0x1]);              /* lea ax, [bx-0x1] */
            ii(0x19_34a6, 2); mov(dx, es);                              /* mov dx, es */
            ii(0x19_34a8, 2); jmp(0x19_34b4, 0xa); goto l_0x19_34b4;    /* jmp 0x34b4 */
        l_0x19_34aa:
            ii(0x19_34aa, 3); les(ax, memw[ss, bp + 0x6]);              /* les ax, [bp+0x6] */
            ii(0x19_34ad, 2); mov(dx, es);                              /* mov dx, es */
            ii(0x19_34af, 2); jmp(0x19_34b4, 0x3); goto l_0x19_34b4;    /* jmp 0x34b4 */
        l_0x19_34b1:
