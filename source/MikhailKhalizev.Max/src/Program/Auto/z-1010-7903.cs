...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_7903()
        {
            ...
            ii(0x1010_7932, 3);  lea(eax, memd[ss, ebp - 52]);         /* lea eax, [ebp-0x34] */
            ...
            ii(0x1010_7942, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x1010_7945, 7);  mov(memd[ss, ebp - 36], 1);           /* mov dword [ebp-0x24], 0x1 */
            ii(0x1010_794c, 3);  lea(edx, memd[ss, ebp - 52]);         /* lea edx, [ebp-0x34] */
        ...
        l_0x1010_7959:
            ...
            ii(0x1010_797e, 4);  mov(memb[ss, ebp - 56], 0);           /* mov byte [ebp-0x38], 0x0 */
            ii(0x1010_7982, 2);  jmp(0x1010_798a, 6); goto l_0x1010_798a;/* jmp 0x1010798a */
        l_0x1010_7984:
            ii(0x1010_7984, 3);  mov(al, memb[ss, ebp - 56]);          /* mov al, [ebp-0x38] */
            ii(0x1010_7987, 3);  inc(memb[ss, ebp - 56]);              /* inc byte [ebp-0x38] */
        l_0x1010_798a:
            ii(0x1010_798a, 2);  xor(eax, eax);                        /* xor eax, eax */
            ii(0x1010_798c, 3);  mov(al, memb[ss, ebp - 56]);          /* mov al, [ebp-0x38] */
            ...
            ii(0x1010_7996, 3);  mov(al, memb[ss, ebp - 56]);          /* mov al, [ebp-0x38] */
            ...
            ii(0x1010_79a9, 3);  mov(al, memb[ss, ebp - 56]);          /* mov al, [ebp-0x38] */
