...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_17f4()
        {
            ...
            ii(0x1008_180c, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_180f, 4); mov(memb[ss, ebp - 0x8], 0x2);          /* mov byte [ebp-0x8], 0x2 */
            ii(0x1008_1813, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
