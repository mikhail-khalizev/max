...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_e566()
        {
            ...
            ii(0x1015_e57e, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_e581, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_e591, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_e59d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_e5a0, 4); mov(memb[ds, eax + 0x3d], 0x10);        /* mov byte [eax+0x3d], 0x10 */
            ii(0x1015_e5a4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_e5a7, 4); mov(memb[ds, eax + 0x3e], 0x3);         /* mov byte [eax+0x3e], 0x3 */
            ii(0x1015_e5ab, 5); mov(edx, 0x21);                         /* mov edx, 0x21 */
            ii(0x1015_e5b0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1015_e5ba:
            ii(0x1015_e5ba, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_e5bd, 5); call(0x1016_1621, 0x305f);              /* call 0x10161621 */
            ii(0x1015_e5c2, 5); call(0x1015_50bc, -0x950b);             /* call 0x101550bc */
            ii(0x1015_e5c7, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ...
            ii(0x1015_e5d3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_e5d6, 4); mov(memb[ds, eax + 0x3d], 0);           /* mov byte [eax+0x3d], 0x0 */
            ii(0x1015_e5da, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_e5dd, 4); mov(memb[ds, eax + 0x3e], 0x1);         /* mov byte [eax+0x3e], 0x1 */
        l_0x1015_e5e1:
            ...
            ii(0x1015_e5eb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_e5ee, 5); call(0x1007_6074, -0xe_857f);           /* call 0x10076074 */
            ii(0x1015_e5f3, 2); test(al, al);                           /* test al, al */
            ii(0x1015_e5f5, 2); if(jnz(0x1015_e600, 0x9)) goto l_0x1015_e600; /* jnz 0x1015e600 */
            ii(0x1015_e5f7, 7); cmp(memb[ds, 0x101c_3980], 0);          /* cmp byte [0x101c3980], 0x0 */
            ii(0x1015_e5fe, 2); if(jz(0x1015_e608, 0x8)) goto l_0x1015_e608; /* jz 0x1015e608 */
        l_0x1015_e600:
            ii(0x1015_e600, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
