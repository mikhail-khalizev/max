...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("0bc085d1-65ed-4f7c-beb3-9661a00b1df1")]
        public void Method_100b_e21a()
        {
            ii(0x100b_e21a, 5); pushd(0x2c);                            /* push 0x2c */
            ii(0x100b_e21f, 5); calld(Definitions.sys_check_available_stack_size, 0xa7b2e); /* call 0x10165d52 */
            ...
            ii(0x100b_e23c, 5); calld(0x1007_64fc, -0x47d45);           /* call 0x100764fc */
            ...
            ii(0x100b_e24d, 5); calld(0x1007_6338, -0x47f1a);           /* call 0x10076338 */
            ii(0x100b_e252, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100b_e254, 3); lea(eax, ebp - 0x10);                   /* lea eax, [ebp-0x10] */
            ii(0x100b_e257, 5); calld(0x1007_643c, -0x47e20);           /* call 0x1007643c */
        ...
        l_0x100b_e25e:
            ...
            ii(0x100b_e261, 5); calld(0x1007_6bf8, -0x4766e);           /* call 0x10076bf8 */
        l_0x100b_e266:
            ii(0x100b_e266, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_e268, 3); lea(eax, ebp - 0x10);                   /* lea eax, [ebp-0x10] */
            ii(0x100b_e26b, 5); calld(0x1013_ad71, 0x7cb01);            /* call 0x1013ad71 */
            ...
            ii(0x100b_e27b, 5); calld(0x1007_63a0, -0x47ee0);           /* call 0x100763a0 */
            ...
            ii(0x100b_e292, 5); calld(0x1007_63a0, -0x47ef7);           /* call 0x100763a0 */
            ii(0x100b_e297, 5); calld(0x1015_26ac, 0x94410);            /* call 0x101526ac */
        ...
        l_0x100b_e2a5:
            ...
            ii(0x100b_e2a8, 5); calld(0x1007_63a0, -0x47f0d);           /* call 0x100763a0 */
            ii(0x100b_e2ad, 5); calld(0x1007_623c, -0x48076);           /* call 0x1007623c */
            ...
            ii(0x100b_e2bf, 5); calld(0x1007_63a0, -0x47f24);           /* call 0x100763a0 */
        ...
        l_0x100b_e2cd:
            ...
            ii(0x100b_e2d0, 5); calld(0x1007_63a0, -0x47f35);           /* call 0x100763a0 */
        ...
        l_0x100b_e2de:
            ...
            ii(0x100b_e2e1, 5); calld(0x1007_63a0, -0x47f46);           /* call 0x100763a0 */
        ...
        l_0x100b_e2ef:
            ...
            ii(0x100b_e2f2, 5); calld(0x1007_63a0, -0x47f57);           /* call 0x100763a0 */
        ...
        l_0x100b_e300:
            ...
            ii(0x100b_e303, 5); calld(0x1007_63a0, -0x47f68);           /* call 0x100763a0 */
        ...
        l_0x100b_e313:
            ii(0x100b_e313, 5); calld(0x1008_a79c, -0x33b7c);           /* call 0x1008a79c */
            ...
            ii(0x100b_e31f, 5); calld(0x1007_63d4, -0x47f50);           /* call 0x100763d4 */
            ii(0x100b_e324, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100b_e326, 5); mov(eax, 0x101c_3180);                  /* mov eax, 0x101c3180 */
            ii(0x100b_e32b, 5); calld(0x100a_53ac, -0x18f84);           /* call 0x100a53ac */
        l_0x100b_e330:
        ...
        l_0x100b_e335:
            ...
            ii(0x100b_e33a, 5); calld(0x1007_6338, -0x48007);           /* call 0x10076338 */
            ...
            ii(0x100b_e346, 5); calld(0x1007_643c, -0x47f0f);           /* call 0x1007643c */
        ...
        l_0x100b_e34d:
            ...
            ii(0x100b_e350, 5); calld(0x1007_6bf8, -0x4775d);           /* call 0x10076bf8 */
        l_0x100b_e355:
            ii(0x100b_e355, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_e357, 3); lea(eax, ebp - 0x10);                   /* lea eax, [ebp-0x10] */
            ii(0x100b_e35a, 5); calld(0x1013_ad71, 0x7ca12);            /* call 0x1013ad71 */
            ...
            ii(0x100b_e366, 5); calld(0x1007_63a0, -0x47fcb);           /* call 0x100763a0 */
            ...
            ii(0x100b_e37d, 5); calld(0x1007_63a0, -0x47fe2);           /* call 0x100763a0 */
            ii(0x100b_e382, 5); calld(0x1015_26ac, 0x94325);            /* call 0x101526ac */
        ...
        l_0x100b_e38d:
            ii(0x100b_e38d, 5); calld(0x1008_a79c, -0x33bf6);           /* call 0x1008a79c */
            ...
            ii(0x100b_e399, 5); calld(0x1007_63d4, -0x47fca);           /* call 0x100763d4 */
            ii(0x100b_e39e, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100b_e3a0, 5); mov(eax, 0x101c_3180);                  /* mov eax, 0x101c3180 */
            ii(0x100b_e3a5, 5); calld(0x100a_53ac, -0x18ffe);           /* call 0x100a53ac */
        l_0x100b_e3aa:
        ...
        l_0x100b_e3ac:
            ...
            ii(0x100b_e3b1, 5); calld(0x1007_6338, -0x4807e);           /* call 0x10076338 */
            ...
            ii(0x100b_e3bd, 5); calld(0x1007_643c, -0x47f86);           /* call 0x1007643c */
        ...
        l_0x100b_e3c4:
            ...
            ii(0x100b_e3c7, 5); calld(0x1007_6bf8, -0x477d4);           /* call 0x10076bf8 */
        l_0x100b_e3cc:
            ii(0x100b_e3cc, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100b_e3ce, 3); lea(eax, ebp - 0x10);                   /* lea eax, [ebp-0x10] */
            ii(0x100b_e3d1, 5); calld(0x1013_ad71, 0x7c99b);            /* call 0x1013ad71 */
            ...
            ii(0x100b_e3dd, 5); calld(0x1007_63a0, -0x48042);           /* call 0x100763a0 */
            ...
            ii(0x100b_e3f4, 5); calld(0x1007_63a0, -0x48059);           /* call 0x100763a0 */
            ii(0x100b_e3f9, 5); calld(0x1015_26ac, 0x942ae);            /* call 0x101526ac */
        ...
        l_0x100b_e404:
            ii(0x100b_e404, 5); calld(0x1008_a79c, -0x33c6d);           /* call 0x1008a79c */
            ...
            ii(0x100b_e410, 5); calld(0x1007_63d4, -0x48041);           /* call 0x100763d4 */
            ii(0x100b_e415, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100b_e417, 5); mov(eax, 0x101c_3180);                  /* mov eax, 0x101c3180 */
            ii(0x100b_e41c, 5); calld(0x100a_53ac, -0x19075);           /* call 0x100a53ac */
        l_0x100b_e421:
        ...
        l_0x100b_e423:
            ...
            ii(0x100b_e428, 5); calld(0x1007_5f6c, -0x484c1);           /* call 0x10075f6c */
