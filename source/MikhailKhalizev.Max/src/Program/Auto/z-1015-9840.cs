...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_9840()
        {
            ...
            ii(0x1015_9875, 4); cmp(memb[ds, eax + 0x57], 9);           /* cmp byte [eax+0x57], 0x9 */
            ii(0x1015_9879, 2); if(jnz(0x1015_9881, 6)) goto l_0x1015_9881; /* jnz 0x10159881 */
            ii(0x1015_987b, 4); mov(memb[ss, ebp - 0xc], 1);            /* mov byte [ebp-0xc], 0x1 */
        ...
        l_0x1015_9885:
            ...
            ii(0x1015_98b0, 4); cmp(memb[ds, eax + 0x57], 8);           /* cmp byte [eax+0x57], 0x8 */
            ii(0x1015_98b4, 2); if(jnz(0x1015_98bc, 6)) goto l_0x1015_98bc; /* jnz 0x101598bc */
            ii(0x1015_98b6, 4); mov(memb[ss, ebp - 0x10], 1);           /* mov byte [ebp-0x10], 0x1 */
