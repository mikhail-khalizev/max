...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_8813()
        {
            ...
            ii(0x100c_8825, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100c_882b, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100c_882e, 7); mov(memd[ss, ebp - 8], 4);              /* mov dword [ebp-0x8], 0x4 */
            ii(0x100c_8835, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
