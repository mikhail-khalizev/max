...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_c8d7()
        {
            ...
            ii(0x100e_c8ee, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_c8f1, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ...
            ii(0x100e_c900, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x100e_c903, 5);  call(0x1007_64b8, -0x7_6450);         /* call 0x100764b8 */
            ii(0x100e_c908, 7);  mov(memd[ss, ebp - 16], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x100e_c90f, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x100e_c912, 5);  call(0x1007_20b1, -0x7_a866);         /* call 0x100720b1 */
            ii(0x100e_c917, 2);  jmp(0x100e_c921, 8); goto l_0x100e_c921;/* jmp 0x100ec921 */
        l_0x100e_c919:
            ii(0x100e_c919, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x100e_c91c, 5);  call(0x1007_6bf8, -0x7_5d29);         /* call 0x10076bf8 */
        l_0x100e_c921:
            ii(0x100e_c921, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100e_c923, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ...
            ii(0x100e_c933, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x100e_c936, 5);  call(0x1007_63a0, -0x7_659b);         /* call 0x100763a0 */
            ii(0x100e_c93b, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100e_c93d, 3);  mov(dl, memb[ds, eax + 38]);          /* mov dl, [eax+0x26] */
            ii(0x100e_c940, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x100e_c955, 3);  lea(edx, memd[ss, ebp - 28]);         /* lea edx, [ebp-0x1c] */
            ii(0x100e_c958, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x100e_c95b, 5);  call(0x1007_63d4, -0x7_658c);         /* call 0x100763d4 */
            ii(0x100e_c960, 5);  call(0x1007_2388, -0x7_a5dd);         /* call 0x10072388 */
            ii(0x100e_c965, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_c968, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x100e_c96b, 2);  jmp(0x100e_c99f, 0x32); goto l_0x100e_c99f;/* jmp 0x100ec99f */
        l_0x100e_c96d:
            ii(0x100e_c96d, 4);  movsx(eax, memw[ss, ebp - 26]);       /* movsx eax, word [ebp-0x1a] */
            ii(0x100e_c971, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x100e_c973, 2);  if(jge(0x100e_c97b, 6)) goto l_0x100e_c97b;/* jge 0x100ec97b */
            ii(0x100e_c975, 3);  mov(eax, memd[ss, ebp - 26]);         /* mov eax, [ebp-0x1a] */
            ii(0x100e_c978, 3);  sub(memd[ss, ebp - 16], eax);         /* sub [ebp-0x10], eax */
        l_0x100e_c97b:
            ii(0x100e_c97b, 2);  jmp(0x100e_c9c6, 0x49); goto l_0x100e_c9c6;/* jmp 0x100ec9c6 */
        l_0x100e_c97d:
            ii(0x100e_c97d, 4);  movsx(eax, memw[ss, ebp - 24]);       /* movsx eax, word [ebp-0x18] */
            ii(0x100e_c981, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x100e_c983, 2);  if(jge(0x100e_c98b, 6)) goto l_0x100e_c98b;/* jge 0x100ec98b */
            ii(0x100e_c985, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x100e_c988, 3);  sub(memd[ss, ebp - 16], eax);         /* sub [ebp-0x10], eax */
        l_0x100e_c98b:
            ii(0x100e_c98b, 2);  jmp(0x100e_c9c6, 0x39); goto l_0x100e_c9c6;/* jmp 0x100ec9c6 */
        l_0x100e_c98d:
            ii(0x100e_c98d, 4);  movsx(eax, memw[ss, ebp - 28]);       /* movsx eax, word [ebp-0x1c] */
            ii(0x100e_c991, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x100e_c993, 2);  if(jge(0x100e_c99b, 6)) goto l_0x100e_c99b;/* jge 0x100ec99b */
            ii(0x100e_c995, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x100e_c998, 3);  sub(memd[ss, ebp - 16], eax);         /* sub [ebp-0x10], eax */
        l_0x100e_c99b:
        ...
        l_0x100e_c99f:
            ii(0x100e_c99f, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
            ii(0x100e_c9a2, 3);  mov(memd[ss, ebp - 36], eax);         /* mov [ebp-0x24], eax */
            ii(0x100e_c9a5, 5);  cmp(memw[ss, ebp - 36], 0x40);        /* cmp word [ebp-0x24], 0x40 */
            ii(0x100e_c9aa, 2);  if(jb(0x100e_c9bd, 0x11)) goto l_0x100e_c9bd;/* jb 0x100ec9bd */
            ii(0x100e_c9ac, 5);  cmp(memw[ss, ebp - 36], 0x40);        /* cmp word [ebp-0x24], 0x40 */
            ii(0x100e_c9b1, 2);  if(jbe(0x100e_c98d, -0x26)) goto l_0x100e_c98d;/* jbe 0x100ec98d */
            ii(0x100e_c9b3, 6);  cmp(memw[ss, ebp - 36], 0x80);        /* cmp word [ebp-0x24], 0x80 */
        ...
        l_0x100e_c9bd:
            ii(0x100e_c9bd, 5);  cmp(memw[ss, ebp - 36], 0x20);        /* cmp word [ebp-0x24], 0x20 */
        ...
        l_0x100e_c9cb:
            ii(0x100e_c9cb, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100e_c9ce, 3);  mov(memd[ss, ebp - 40], eax);         /* mov [ebp-0x28], eax */
            ii(0x100e_c9d1, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100e_c9d3, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
        ...
        //  ii(0x100e_c9df, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
        //  ii(0x100e_c9e2, 5);  call(0x1007_5f6c, -0x7_6a7b);         /* call 0x10075f6c */
        l_0x100e_c9e7:
            ii(0x100e_c9e7, 3);  mov(eax, memd[ss, ebp - 40]);         /* mov eax, [ebp-0x28] */
