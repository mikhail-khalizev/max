...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_b325()
        {
            ...
            ii(0x1013_b33d, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1013_b340, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1013_b347, 2); jmp(0x1013_b34f, 0x6); goto l_0x1013_b34f; /* jmp 0x1013b34f */
        l_0x1013_b349:
            ii(0x1013_b349, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_b34c, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x1013_b34f:
            ii(0x1013_b34f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_b352, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1013_b355, 4); cmp(ax, memw[ds, edx + 0x4]);           /* cmp ax, [edx+0x4] */
            ii(0x1013_b359, 2); if(jge(0x1013_b387, 0x2c)) goto l_0x1013_b387; /* jge 0x1013b387 */
            ii(0x1013_b35b, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x1013_b35e, 5); call(Definitions.my_ctor_0x101b_6edc, -0xc_451f); /* call 0x10076e44 */
            ii(0x1013_b363, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1013_b365, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1013_b369, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1013_b36c, 2); mov(ebx, eax);                          /* mov ebx, eax */
            ii(0x1013_b36e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_b371, 3); mov(eax, memd[ds, eax + 0x6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x1013_b37d, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
        ...
        l_0x1013_b387:
            ii(0x1013_b387, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_b38a, 6); mov(memw[ds, eax + 0x4], 0);            /* mov word [eax+0x4], 0x0 */
