...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_9141()
        {
            ...
            ii(0x9148, 5);    mov(memw[ss, bp - 0x2], 0);               /* mov word [bp-0x2], 0x0 */
        l_0x914d:
            ii(0x914d, 3);    call(0x90c6, -0x8a);                      /* call 0x90c6 */
            ii(0x9150, 2);    mov(si, ax);                              /* mov si, ax */
            ii(0x9152, 3);    cmp(si, 0xa);                             /* cmp si, 0xa */
            ii(0x9155, 2);    if(jnz(0x915c, 0x5)) goto l_0x915c;       /* jnz 0x915c */
        ...
        l_0x915c:
            ...
            ii(0x915f, 2);    if(jnz(0x9166, 0x5)) goto l_0x9166;       /* jnz 0x9166 */
