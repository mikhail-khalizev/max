...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_fa43()
        {
            ...
            ii(0x1014_fa5a, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_fa5d, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_fa60, 3); lea(edx, memd[ss, ebp - 0x30]);         /* lea edx, [ebp-0x30] */
            ii(0x1014_fa63, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_fa66, 5); call(0x1014_f9cf, -0x9c);               /* call 0x1014f9cf */
            ii(0x1014_fa6b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_fa7e, 3); lea(eax, memd[ss, ebp - 0x44]);         /* lea eax, [ebp-0x44] */
            ii(0x1014_fa81, 5); call(0x1014_f905, -0x181);              /* call 0x1014f905 */
            ii(0x1014_fa86, 5); mov(edx, StringDefinitions.Mk);         /* mov edx, 0x101adde3 */
            ii(0x1014_fa8b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_fa8e, 5); call(Definitions.sys_strcpy, 0x1_643c); /* call 0x10165ecf */
            ii(0x1014_fa93, 3); lea(edx, memd[ss, ebp - 0x44]);         /* lea edx, [ebp-0x44] */
            ii(0x1014_fa96, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_faa3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_faa6, 5); call(Definitions.sys_strcat, 0x1_6486); /* call 0x10165f31 */
            ii(0x1014_faab, 3); lea(edx, memd[ss, ebp - 0x30]);         /* lea edx, [ebp-0x30] */
            ii(0x1014_faae, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
