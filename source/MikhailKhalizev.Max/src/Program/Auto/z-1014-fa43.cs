...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("a994b695-f992-4045-804d-df8284c67b57")]
        public void Method_1014_fa43()
        {
            ii(0x1014_fa43, 5); pushd(0x5c);                            /* push 0x5c */
            ii(0x1014_fa48, 5); calld(Definitions.sys_check_available_stack_size, 0x1_6305); /* call 0x10165d52 */
            ...
            ii(0x1014_fa71, 5); calld(0x1007_6730, -0xd_9346);          /* call 0x10076730 */
            ii(0x1014_fa76, 5); calld(0x100e_f36c, -0x6_070f);          /* call 0x100ef36c */
            ...
            ii(0x1014_fa8e, 5); calld(Definitions.sys_strcpy, 0x1_643c); /* call 0x10165ecf */
            ii(0x1014_fa93, 3); lea(edx, ebp - 0x44);                   /* lea edx, [ebp-0x44] */
            ii(0x1014_fa96, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1014_fa99, 5); calld(Definitions.sys_strcat, 0x1_6493); /* call 0x10165f31 */
            ...
            ii(0x1014_faa6, 5); calld(Definitions.sys_strcat, 0x1_6486); /* call 0x10165f31 */
            ii(0x1014_faab, 3); lea(edx, ebp - 0x30);                   /* lea edx, [ebp-0x30] */
            ii(0x1014_faae, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1014_fab1, 5); calld(Definitions.sys_strcat, 0x1_647b); /* call 0x10165f31 */
