...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_55e7()
        {
            ...
            ii(0x55ee, 4);    cmp(memw[ss, bp + 0x4], 0);               /* cmp word [bp+0x4], 0x0 */
            ii(0x55f2, 2);    if(jz(0x5603, 0xf)) goto l_0x5603;        /* jz 0x5603 */
            ii(0x55f4, 3);    push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
        ...
        l_0x5622:
            ...
            ii(0x5631, 4);    cmp(memw[ss, bp + 0x4], 0);               /* cmp word [bp+0x4], 0x0 */
            ii(0x5635, 2);    if(jz(0x563f, 0x8)) goto l_0x563f;        /* jz 0x563f */
