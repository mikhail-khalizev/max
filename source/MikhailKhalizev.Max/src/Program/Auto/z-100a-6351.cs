...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_6351()
        {
            ...
            ii(0x100a_6369, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_636c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_637e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_638b, 2); if(jz(0x100a_6393, 0x6)) goto l_0x100a_6393; /* jz 0x100a6393 */
        l_0x100a_638d:
            ii(0x100a_638d, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x100a_6391, 2); jmp(0x100a_63b0, 0x1d); goto l_0x100a_63b0; /* jmp 0x100a63b0 */
        l_0x100a_6393:
            ii(0x100a_6393, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_6396, 3); add(eax, 0xf);                          /* add eax, 0xf */
            ii(0x100a_6399, 5); call(0x1008_af28, -0x1_b476);           /* call 0x1008af28 */
            ii(0x100a_639e, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100a_63a1, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100a_63a4, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x100a_63a7, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100a_63aa, 3); call_abs(memd[ds, edx + 0x24]);         /* call dword [edx+0x24] */
            ii(0x100a_63ad, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
        l_0x100a_63b0:
            ii(0x100a_63b0, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
