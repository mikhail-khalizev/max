...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_add8()
        {
            ...
            ii(0x1009_adef, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_adf2, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1009_adf5, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1009_adf8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_adfb, 5); call(0x1015_2a52, 0xb_7c52);            /* call 0x10152a52 */
            ii(0x1009_ae00, 2); test(al, al);                           /* test al, al */
            ii(0x1009_ae02, 2); if(jnz(0x1009_ae0d, 0x9)) goto l_0x1009_ae0d; /* jnz 0x1009ae0d */
            ii(0x1009_ae04, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
            ii(0x1009_ae08, 5); jmp(0x1009_afee, 0x1e1); goto l_0x1009_afee; /* jmp 0x1009afee */
        l_0x1009_ae0d:
            ii(0x1009_ae0d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_ae23, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_ae26, 5); call(0x1016_3053, 0xc_8228);            /* call 0x10163053 */
            ii(0x1009_ae2b, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1009_ae2f, 5); jmp(0x1009_afee, 0x1ba); goto l_0x1009_afee; /* jmp 0x1009afee */
        l_0x1009_ae34:
            ii(0x1009_ae34, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_ae36, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1009_ae45, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_ae48, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1009_ae4b, 5); call(0x1007_6574, -0x2_48dc);           /* call 0x10076574 */
            ii(0x1009_ae50, 3); mov(al, memb[ds, eax + 0x4d]);          /* mov al, [eax+0x4d] */
        ...
        l_0x1009_ae5c:
            ii(0x1009_ae5c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_ae5f, 5); call(0x1009_a476, -0x9ee);              /* call 0x1009a476 */
            ii(0x1009_ae64, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1009_ae68, 5); jmp(0x1009_afee, 0x181); goto l_0x1009_afee; /* jmp 0x1009afee */
        l_0x1009_ae6d:
            ii(0x1009_ae6d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_ae70, 5); call(0x1007_623c, -0x2_4c39);           /* call 0x1007623c */
            ii(0x1009_ae75, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_ae78, 4); mov(dx, memw[ds, edx + 0x52]);          /* mov dx, [edx+0x52] */
            ii(0x1009_ae7c, 4); cmp(dx, memw[ds, eax + 0x19]);          /* cmp dx, [eax+0x19] */
            ii(0x1009_ae80, 2); if(jnz(0x1009_ae95, 0x13)) goto l_0x1009_ae95; /* jnz 0x1009ae95 */
            ii(0x1009_ae82, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_ae85, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_ae88, 5); call(0x1009_a57f, -0x90e);              /* call 0x1009a57f */
            ii(0x1009_ae8d, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x1009_ae90, 5); jmp(0x1009_afee, 0x159); goto l_0x1009_afee; /* jmp 0x1009afee */
        l_0x1009_ae95:
            ii(0x1009_ae95, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_ae98, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1009_ae9b, 5); call(0x1007_6574, -0x2_492c);           /* call 0x10076574 */
            ii(0x1009_aea0, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_aea3, 4); mov(dx, memw[ds, edx + 0x1a]);          /* mov dx, [edx+0x1a] */
            ii(0x1009_aea7, 4); cmp(dx, memw[ds, eax + 0x1a]);          /* cmp dx, [eax+0x1a] */
            ii(0x1009_aeab, 2); if(jnz(0x1009_aec5, 0x18)) goto l_0x1009_aec5; /* jnz 0x1009aec5 */
            ii(0x1009_aead, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_aeb0, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1009_aeb3, 5); call(0x1007_6574, -0x2_4944);           /* call 0x10076574 */
            ii(0x1009_aeb8, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_aebb, 4); mov(dx, memw[ds, edx + 0x1c]);          /* mov dx, [edx+0x1c] */
            ii(0x1009_aebf, 4); cmp(dx, memw[ds, eax + 0x1c]);          /* cmp dx, [eax+0x1c] */
            ii(0x1009_aec3, 2); if(jz(0x1009_aec7, 0x2)) goto l_0x1009_aec7; /* jz 0x1009aec7 */
        l_0x1009_aec5:
        ...
        l_0x1009_aec7:
            ...
            ii(0x1009_aed2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_aed5, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
        ...
        l_0x1009_aee7:
            ...
            ii(0x1009_aef1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_aef4, 5); call(0x1016_3053, 0xc_815a);            /* call 0x10163053 */
            ii(0x1009_aef9, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_aefb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_aefe, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1009_af01, 5); call(0x1007_6630, -0x2_48d6);           /* call 0x10076630 */
        l_0x1009_af06:
            ii(0x1009_af06, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1009_af0a, 5); jmp(0x1009_afee, 0xdf); goto l_0x1009_afee; /* jmp 0x1009afee */
        l_0x1009_af0f:
            ii(0x1009_af0f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_af12, 3); mov(al, memb[ds, eax + 0x4e]);          /* mov al, [eax+0x4e] */
            ii(0x1009_af15, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x1009_af1a, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1009_af1c, 2); if(jnz(0x1009_af27, 0x9)) goto l_0x1009_af27; /* jnz 0x1009af27 */
            ii(0x1009_af1e, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
            ii(0x1009_af22, 5); jmp(0x1009_afee, 0xc7); goto l_0x1009_afee; /* jmp 0x1009afee */
        l_0x1009_af27:
            ii(0x1009_af27, 5); mov(ebx, 0x3);                          /* mov ebx, 0x3 */
            ii(0x1009_af2c, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_af2f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_af32, 5); call(0x100a_3671, 0x873a);              /* call 0x100a3671 */
            ii(0x1009_af37, 2); test(al, al);                           /* test al, al */
            ii(0x1009_af39, 2); if(jz(0x1009_af44, 0x9)) goto l_0x1009_af44; /* jz 0x1009af44 */
            ii(0x1009_af3b, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
        ...
        l_0x1009_af44:
            ...
            ii(0x1009_af4e, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x1009_af51, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1009_af54, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1009_af57, 4); cmp(memd[ss, ebp - 0x10], 0);           /* cmp dword [ebp-0x10], 0x0 */
            ...
            ii(0x1009_af63, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_af66, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1009_af69, 5); call(0x1007_6574, -0x2_49fa);           /* call 0x10076574 */
            ii(0x1009_af6e, 3); mov(ebx, memd[ds, eax + 0x1a]);         /* mov ebx, [eax+0x1a] */
            ii(0x1009_af71, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1009_af74, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_af77, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1009_af7a, 5); call(0x1007_6574, -0x2_4a0b);           /* call 0x10076574 */
            ii(0x1009_af7f, 3); mov(edx, memd[ds, eax + 0x18]);         /* mov edx, [eax+0x18] */
            ii(0x1009_af82, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1009_af85, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x1009_af96, 3); mov(ebx, memd[ss, ebp - 0x8]);          /* mov ebx, [ebp-0x8] */
            ii(0x1009_af99, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1009_af9c, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1009_af9f, 5); call(0x100a_c220, 0x1_127c);            /* call 0x100ac220 */
            ii(0x1009_afa4, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1009_afa7, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1009_afaa, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x1009_afad, 2); jmp(0x1009_afb5, 0x6); goto l_0x1009_afb5; /* jmp 0x1009afb5 */
        l_0x1009_afaf:
            ii(0x1009_afaf, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1009_afb2, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
        l_0x1009_afb5:
            ii(0x1009_afb5, 3); mov(edx, memd[ss, ebp - 0x24]);         /* mov edx, [ebp-0x24] */
            ii(0x1009_afb8, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ii(0x1009_afbb, 5); call(0x1008_b060, -0xff60);             /* call 0x1008b060 */
            ii(0x1009_afc0, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1009_afd4, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1009_afd8, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_afda, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
        ...
        //  ii(0x1009_afe6, 3); lea(eax, memd[ss, ebp - 0x1c]);         /* lea eax, [ebp-0x1c] */
        //  ii(0x1009_afe9, 5); call(0x1008_8b7c, -0x1_2472);           /* call 0x10088b7c */
        l_0x1009_afee:
            ii(0x1009_afee, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
