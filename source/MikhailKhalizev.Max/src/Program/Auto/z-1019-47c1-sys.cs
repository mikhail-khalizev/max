...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_47c1()
        {
            ...
            ii(0x1019_47d1, 2); if(jae(0x1019_47d8, 0x5)) goto l_0x1019_47d8; /* jae 0x101947d8 */
            ii(0x1019_47d3, 5); mov(eax, 0xffff_ffff);                  /* mov eax, 0xffffffff */
        l_0x1019_47d8:
            ii(0x1019_47d8, 3); cmp(eax, 0xc);                          /* cmp eax, 0xc */
            ii(0x1019_47db, 2); if(jae(0x1019_47e2, 0x5)) goto l_0x1019_47e2; /* jae 0x101947e2 */
            ii(0x1019_47dd, 5); mov(eax, 0xc);                          /* mov eax, 0xc */
        l_0x1019_47e2:
            ii(0x1019_47e2, 3); lea(edx, edi - 0x4);                    /* lea edx, [edi-0x4] */
            ii(0x1019_47e5, 4); mov(memd[ss, esp + 0x4], edx);          /* mov [esp+0x4], edx */
            ...
            ii(0x1019_47f6, 4); mov(ebx, memd[ss, esp + 0x4]);          /* mov ebx, [esp+0x4] */
        ...
        l_0x1019_4811:
            ...
            ii(0x1019_481d, 3); mov(eax, memd[ds, ebx + 0x8]);          /* mov eax, [ebx+0x8] */
            ii(0x1019_4820, 4); mov(memd[ss, esp + 0x8], eax);          /* mov [esp+0x8], eax */
            ii(0x1019_4824, 3); mov(eax, memd[ds, ebx + 0x4]);          /* mov eax, [ebx+0x4] */
            ii(0x1019_4827, 2); mov(edx, ds);                           /* mov edx, ds */
            ii(0x1019_4829, 4); mov(memd[ss, esp + 0xc], eax);          /* mov [esp+0xc], eax */
        ...
        l_0x1019_4840:
            ...
            ii(0x1019_4842, 2); if(ja(0x1019_4848, 0x4)) goto l_0x1019_4848; /* ja 0x10194848 */
            ii(0x1019_4844, 2); cmp(edi, edx);                          /* cmp edi, edx */
            ii(0x1019_4846, 2); if(jb(0x1019_4852, 0xa)) goto l_0x1019_4852; /* jb 0x10194852 */
        l_0x1019_4848:
            ii(0x1019_4848, 3); mov(esi, memd[ds, esi + 0x8]);          /* mov esi, [esi+0x8] */
        l_0x1019_484b:
            ii(0x1019_484b, 3); mov(edx, memd[ds, esi + 0x8]);          /* mov edx, [esi+0x8] */
            ii(0x1019_484e, 2); test(edx, edx);                         /* test edx, edx */
            ii(0x1019_4850, 2); if(jnz(0x1019_4840, -0x12)) goto l_0x1019_4840; /* jnz 0x10194840 */
        l_0x1019_4852:
            ii(0x1019_4852, 3); mov(edx, memd[ds, esi + 0xc]);          /* mov edx, [esi+0xc] */
            ii(0x1019_4855, 2); cmp(ebx, edx);                          /* cmp ebx, edx */
            ii(0x1019_4857, 2); if(jnz(0x1019_485f, 0x6)) goto l_0x1019_485f; /* jnz 0x1019485f */
            ii(0x1019_4859, 3); mov(eax, memd[ds, edx + 0x4]);          /* mov eax, [edx+0x4] */
            ii(0x1019_485c, 3); mov(memd[ds, esi + 0xc], eax);          /* mov [esi+0xc], eax */
        l_0x1019_485f:
        ...
        l_0x1019_486e:
            ii(0x1019_486e, 4); mov(eax, memd[ss, esp + 0xc]);          /* mov eax, [esp+0xc] */
            ii(0x1019_4872, 4); mov(edx, memd[ss, esp + 0x8]);          /* mov edx, [esp+0x8] */
            ii(0x1019_4876, 3); mov(memd[ds, eax + 0x8], edx);          /* mov [eax+0x8], edx */
            ii(0x1019_4879, 2); mov(eax, edx);                          /* mov eax, edx */
            ii(0x1019_487b, 4); mov(edx, memd[ss, esp + 0xc]);          /* mov edx, [esp+0xc] */
            ii(0x1019_487f, 3); mov(memd[ds, eax + 0x4], edx);          /* mov [eax+0x4], edx */
            ii(0x1019_4882, 4); mov(eax, memd[ss, esp + 0x4]);          /* mov eax, [esp+0x4] */
            ii(0x1019_4886, 2); add(memd[ds, eax], ebp);                /* add [eax], ebp */
            ii(0x1019_4888, 3); mov(eax, memd[ds, esi + 0x1c]);         /* mov eax, [esi+0x1c] */
            ii(0x1019_488b, 1); dec(eax);                               /* dec eax */
            ii(0x1019_488c, 2); xor(dl, dl);                            /* xor dl, dl */
            ii(0x1019_488e, 3); mov(memd[ds, esi + 0x1c], eax);         /* mov [esi+0x1c], eax */
        ...
        l_0x1019_48a2:
            ...
            ii(0x1019_48a6, 4); mov(eax, memd[ss, esp + 0xc]);          /* mov eax, [esp+0xc] */
            ii(0x1019_48aa, 3); mov(memd[ds, ebx + 0x4], eax);          /* mov [ebx+0x4], eax */
            ii(0x1019_48ad, 4); mov(eax, memd[ss, esp + 0x8]);          /* mov eax, [esp+0x8] */
            ii(0x1019_48b1, 3); mov(memd[ds, ebx + 0x8], eax);          /* mov [ebx+0x8], eax */
            ii(0x1019_48b4, 4); mov(eax, memd[ss, esp + 0xc]);          /* mov eax, [esp+0xc] */
            ii(0x1019_48b8, 3); mov(memd[ds, eax + 0x8], ebx);          /* mov [eax+0x8], ebx */
            ii(0x1019_48bb, 4); mov(eax, memd[ss, esp + 0x8]);          /* mov eax, [esp+0x8] */
            ii(0x1019_48bf, 3); mov(memd[ds, eax + 0x4], ebx);          /* mov [eax+0x4], ebx */
            ii(0x1019_48c2, 4); mov(edx, memd[ss, esp + 0x4]);          /* mov edx, [esp+0x4] */
        ...
        l_0x1019_48ef:
            ...
            ii(0x1019_48f8, 4); mov(ecx, memd[ss, esp + 0x4]);          /* mov ecx, [esp+0x4] */
            ...
            ii(0x1019_490c, 4); mov(memd[ss, esp + 0x4], ebx);          /* mov [esp+0x4], ebx */
        ...
        l_0x1019_4924:
            ...
            ii(0x1019_4926, 2); if(ja(0x1019_492c, 0x4)) goto l_0x1019_492c; /* ja 0x1019492c */
            ii(0x1019_4928, 2); cmp(edi, ecx);                          /* cmp edi, ecx */
            ii(0x1019_492a, 2); if(jb(0x1019_4936, 0xa)) goto l_0x1019_4936; /* jb 0x10194936 */
        l_0x1019_492c:
            ii(0x1019_492c, 3); mov(esi, memd[ds, esi + 0x8]);          /* mov esi, [esi+0x8] */
        l_0x1019_492f:
            ii(0x1019_492f, 3); mov(ecx, memd[ds, esi + 0x8]);          /* mov ecx, [esi+0x8] */
            ii(0x1019_4932, 2); test(ecx, ecx);                         /* test ecx, ecx */
            ii(0x1019_4934, 2); if(jnz(0x1019_4924, -0x12)) goto l_0x1019_4924; /* jnz 0x10194924 */
        l_0x1019_4936:
            ii(0x1019_4936, 3); inc(memd[ds, esi + 0x18]);              /* inc dword [esi+0x18] */
            ii(0x1019_4939, 4); mov(eax, memd[ss, esp + 0x4]);          /* mov eax, [esp+0x4] */
