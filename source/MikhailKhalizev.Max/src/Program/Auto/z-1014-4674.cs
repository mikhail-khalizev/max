...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_4674()
        {
            ...
            ii(0x1014_468b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_468e, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_4691, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_4694, 3); mov(eax, memd[ds, eax + 0x3e]);         /* mov eax, [eax+0x3e] */
            ii(0x1014_4697, 5); call(0x100c_fbbe, -0x7_4ade);           /* call 0x100cfbbe */
            ii(0x1014_469c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_469f, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1014_46a2, 7); add(memw[ds, edx + 0x156], ax);         /* add [edx+0x156], ax */
            ii(0x1014_46a9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_46ac, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1014_46af, 7); sub(memw[ds, edx + 0x15c], ax);         /* sub [edx+0x15c], ax */
            ii(0x1014_46b6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_46c3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_46c6, 4); add(memw[ds, edx + 0xa], ax);           /* add [edx+0xa], ax */
            ii(0x1014_46ca, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
