...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_a922()
        {
            ...
            ii(0x18_a925, 2); if(jae(0x18_a92f, 0x8)) goto l_0x18_a92f; /* jae 0xa92f */
            ii(0x18_a927, 3); call(0x18_a893, -0x97);                   /* call 0xa893 */
            ii(0x18_a92a, 3); mov(ax, memw[ds, bx + 0x16]);             /* mov ax, [bx+0x16] */
            ii(0x18_a92d, 2); jmp(0x18_a999, 0x6a); goto l_0x18_a999;   /* jmp 0xa999 */
        l_0x18_a92f:
            ii(0x18_a92f, 3); mov(dx, memw[ss, bp + 0x14]);             /* mov dx, [bp+0x14] */
            ii(0x18_a932, 3); mov(di, memw[ss, bp + 0x12]);             /* mov di, [bp+0x12] */
            ii(0x18_a935, 3); mov(ax, memw[ds, 0xa]);                   /* mov ax, [0xa] */
            ii(0x18_a938, 3); mov(memw[ds, bx + 0x12], ax);             /* mov [bx+0x12], ax */
            ii(0x18_a93b, 3); mov(es, memw[ss, bp + 0x4]);              /* mov es, [bp+0x4] */
        l_0x18_a93e:
            ii(0x18_a93e, 1); sti();                                    /* sti */
            ii(0x18_a93f, 2); mov(cx, dx);                              /* mov cx, dx */
            ii(0x18_a941, 4); cmp(cx, memw[ds, 0xe]);                   /* cmp cx, [0xe] */
            ii(0x18_a945, 2); if(jbe(0x18_a94b, 0x4)) goto l_0x18_a94b; /* jbe 0xa94b */
            ii(0x18_a947, 4); mov(cx, memw[ds, 0xe]);                   /* mov cx, [0xe] */
        l_0x18_a94b:
            ii(0x18_a94b, 3); mov(memw[ds, bx + 0x14], cx);             /* mov [bx+0x14], cx */
            ii(0x18_a94e, 3); mov(ax, memw[ss, bp + 0x16]);             /* mov ax, [bp+0x16] */
            ii(0x18_a951, 3); mov(memw[ds, bx + 0x16], ax);             /* mov [bx+0x16], ax */
            ...
            ii(0x18_a95a, 3); mov(ax, memw[ds, bx + 0x16]);             /* mov ax, [bx+0x16] */
            ii(0x18_a95d, 4); test(memb[ds, bx + 0x26], 0x1);           /* test byte [bx+0x26], 0x1 */
        ...
        l_0x18_a982:
            ...
            ii(0x18_a98e, 2); if(jz(0x18_a994, 0x4)) goto l_0x18_a994;  /* jz 0xa994 */
            ii(0x18_a990, 2); cmp(ax, cx);                              /* cmp ax, cx */
            ii(0x18_a992, 2); if(jz(0x18_a93e, -0x56)) goto l_0x18_a93e; /* jz 0xa93e */
        l_0x18_a994:
            ii(0x18_a994, 3); mov(ax, memw[ss, bp + 0x14]);             /* mov ax, [bp+0x14] */
            ii(0x18_a997, 2); sub(ax, dx);                              /* sub ax, dx */
        l_0x18_a999:
            ii(0x18_a999, 3); mov(memw[ss, bp + 0x16], ax);             /* mov [bp+0x16], ax */
