...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_9426()
        {
            ...
            ii(0x9434, 4);  les(bx, memw[ds, 0xa0]);                   /* les bx, [0xa0] */
            ii(0x9438, 4);  mov(cx, memw[es, bx + 12]);                /* mov cx, [es:bx+0xc] */
            ii(0x943c, 4);  mov(si, memw[es, bx + 14]);                /* mov si, [es:bx+0xe] */
            ii(0x9440, 3);  add(cx, 1);                                /* add cx, 0x1 */
            ii(0x9443, 3);  adc(si, 0);                                /* adc si, 0x0 */
            ii(0x9446, 2);  cmp(si, dx);                               /* cmp si, dx */
            ii(0x9448, 2);  if(jg(0x9456, 0xc)) goto l_0x9456;         /* jg 0x9456 */
            ii(0x944a, 2);  if(jl(0x9450, 4)) goto l_0x9450;           /* jl 0x9450 */
            ii(0x944c, 2);  cmp(cx, ax);                               /* cmp cx, ax */
            ii(0x944e, 2);  if(jae(0x9456, 6)) goto l_0x9456;          /* jae 0x9456 */
        l_0x9450:
        ...
        l_0x9456:
            ...
            ii(0x9464, 3);  mov(memw[ss, bp - 2], ax);                 /* mov [bp-0x2], ax */
            ii(0x9467, 2);  shl(ax, 1);                                /* shl ax, 1 */
            ii(0x9469, 1);  push(ax);                                  /* push ax */
            ii(0x946a, 3);  call(0x4f7d, -0x44f0);                     /* call 0x4f7d */
            ii(0x946d, 1);  pop(bx);                                   /* pop bx */
            ii(0x946e, 3);  mov(memw[ss, bp - 10], ax);                /* mov [bp-0xa], ax */
            ii(0x9471, 3);  mov(ax, memw[ss, bp - 2]);                 /* mov ax, [bp-0x2] */
            ii(0x9474, 3);  add(ax, memw[ss, bp - 10]);                /* add ax, [bp-0xa] */
            ii(0x9477, 1);  push(ax);                                  /* push ax */
            ii(0x9478, 5);  cmp(memb[ds, 0x981], 0);                   /* cmp byte [0x981], 0x0 */
            ii(0x947d, 2);  if(jz(0x9484, 5)) goto l_0x9484;           /* jz 0x9484 */
            ii(0x947f, 3);  mov(ax, 0x395c);                           /* mov ax, 0x395c */
            ii(0x9482, 2);  jmp(0x9487, 3); goto l_0x9487;             /* jmp 0x9487 */
        l_0x9484:
            ii(0x9484, 3);  mov(ax, 0x38af);                           /* mov ax, 0x38af */
        l_0x9487:
            ii(0x9487, 2);  call_abs(ax);                              /* call ax */
            ii(0x9489, 1);  pop(bx);                                   /* pop bx */
            ii(0x948a, 2);  mov(cl, 4);                                /* mov cl, 0x4 */
            ...
            ii(0x94a2, 2);  if(jnz(0x94aa, 6)) goto l_0x94aa;          /* jnz 0x94aa */
        ...
        l_0x94aa:
            ...
            ii(0x94b0, 4);  shl(memw[ss, bp - 10], 4);                 /* shl word [bp-0xa], 0x4 */
            ii(0x94b4, 3);  mov(ax, memw[ss, bp - 10]);                /* mov ax, [bp-0xa] */
            ii(0x94b7, 1);  dec(ax);                                   /* dec ax */
            ii(0x94b8, 3);  mov(memw[ds, 0x910], ax);                  /* mov [0x910], ax */
            ii(0x94bb, 3);  mov(ax, memw[ss, bp - 2]);                 /* mov ax, [bp-0x2] */
            ii(0x94be, 2);  sub(dx, dx);                               /* sub dx, dx */
            ii(0x94c0, 2);  mov(cl, 4);                                /* mov cl, 0x4 */
            ...
            ii(0x9524, 3);  add(sp, 6);                                /* add sp, 0x6 */
            ...
            ii(0x9567, 3);  add(ax, 8);                                /* add ax, 0x8 */
            ...
            ii(0x9572, 3);  add(sp, 8);                                /* add sp, 0x8 */
            ...
            ii(0x95b7, 2);  if(jnz(0x95bf, 6)) goto l_0x95bf;          /* jnz 0x95bf */
        ...
        l_0x95bf:
            ...
            ii(0x95c2, 3);  add(ax, 8);                                /* add ax, 0x8 */
            ii(0x95c5, 3);  shl(ax, 3);                                /* shl ax, 0x3 */
            ii(0x95c8, 3);  mov(memw[ds, 0xa9c], ax);                  /* mov [0xa9c], ax */
            ii(0x95cb, 3);  add(ax, 8);                                /* add ax, 0x8 */
            ii(0x95ce, 3);  mov(memw[ds, 0xc14], ax);                  /* mov [0xc14], ax */
            ii(0x95d1, 2);  jmp(0x95e6, 0x13); goto l_0x95e6;          /* jmp 0x95e6 */
        l_0x95d3:
            ii(0x95d3, 2);  push(-1 /* 0xff */);                       /* push 0xffff */
            ii(0x95d5, 3);  push(0xe000);                              /* push 0xe000 */
            ii(0x95d8, 3);  mov(ax, memw[ss, bp - 4]);                 /* mov ax, [bp-0x4] */
            ii(0x95db, 4);  add(ax, memw[ds, 0xf54]);                  /* add ax, [0xf54] */
            ii(0x95df, 1);  push(ax);                                  /* push ax */
            ii(0x95e0, 3);  call(0x5a9b, -0x3b48);                     /* call 0x5a9b */
            ii(0x95e3, 3);  add(sp, 6);                                /* add sp, 0x6 */
        l_0x95e6:
            ii(0x95e6, 3);  dec(memw[ss, bp - 4]);                     /* dec word [bp-0x4] */
            ii(0x95e9, 2);  if(jns(0x95d3, -0x18)) goto l_0x95d3;      /* jns 0x95d3 */
            ii(0x95eb, 5);  shl(memw[ds, 0xf54], 3);                   /* shl word [0xf54], 0x3 */
            ii(0x95f0, 5);  cmp(memb[ds, 0x2f], 3);                    /* cmp byte [0x2f], 0x3 */
            ii(0x95f5, 2);  if(jl(0x9628, 0x31)) goto l_0x9628;        /* jl 0x9628 */
            ii(0x95f7, 3);  mov(ax, 3);                                /* mov ax, 0x3 */
            ii(0x95fa, 3);  mov(memw[ss, bp - 4], ax);                 /* mov [bp-0x4], ax */
        ...
        l_0x960b:
            ii(0x960b, 2);  push(-1 /* 0xff */);                       /* push 0xffff */
            ii(0x960d, 3);  push(0xd000);                              /* push 0xd000 */
            ii(0x9610, 3);  mov(ax, memw[ss, bp - 4]);                 /* mov ax, [bp-0x4] */
            ii(0x9613, 4);  add(ax, memw[ds, 0xa87]);                  /* add ax, [0xa87] */
            ii(0x9617, 1);  push(ax);                                  /* push ax */
            ii(0x9618, 3);  call(0x5a9b, -0x3b80);                     /* call 0x5a9b */
            ii(0x961b, 3);  add(sp, 6);                                /* add sp, 0x6 */
        l_0x961e:
            ii(0x961e, 3);  dec(memw[ss, bp - 4]);                     /* dec word [bp-0x4] */
            ii(0x9621, 2);  if(jns(0x960b, -0x18)) goto l_0x960b;      /* jns 0x960b */
            ii(0x9623, 5);  shl(memw[ds, 0xa87], 3);                   /* shl word [0xa87], 0x3 */
        l_0x9628:
            ...
            ii(0x963d, 2);  if(jnz(0x9648, 9)) goto l_0x9648;          /* jnz 0x9648 */
            ii(0x963f, 4);  cmp(memw[ds, 0xae], dx);                   /* cmp [0xae], dx */
            ii(0x9643, 2);  if(jnz(0x9648, 3)) goto l_0x9648;          /* jnz 0x9648 */
        ...
        l_0x9648:
            ...
            ii(0x964f, 2);  push(3);                                   /* push 0x3 */
            ii(0x9651, 3);  call(0x796c, -0x1ce8);                     /* call 0x796c */
            ii(0x9654, 1);  pop(bx);                                   /* pop bx */
            ii(0x9655, 3);  mov(memw[ss, bp - 4], ax);                 /* mov [bp-0x4], ax */
            ii(0x9658, 2);  or(ax, ax);                                /* or ax, ax */
            ii(0x965a, 2);  if(jnz(0x9662, 6)) goto l_0x9662;          /* jnz 0x9662 */
        ...
        l_0x9662:
            ...
            ii(0x9667, 3);  mov(ax, memw[ss, bp - 4]);                 /* mov ax, [bp-0x4] */
            ii(0x966a, 3);  shl(ax, 3);                                /* shl ax, 0x3 */
            ...
            ii(0x967f, 3);  add(sp, 8);                                /* add sp, 0x8 */
        l_0x9682:
