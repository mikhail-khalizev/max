...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_5256()
        {
            ...
            ii(0x1014_526e, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_5271, 5); mov(edx, StringDefinitions.ExpectingANumber); /* mov edx, 0x101acfa7 */
            ii(0x1014_5276, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_5279, 5); call(0x1014_5151, -0x12d);              /* call 0x10145151 */
            ii(0x1014_527e, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1014_5285, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
