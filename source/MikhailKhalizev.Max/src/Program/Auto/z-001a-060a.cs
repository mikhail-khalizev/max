...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_001a_060a()
        {
            ...
            ii(0x1a_061a, 3); mov(memw[ss, bp - 0xc], bx);              /* mov [bp-0xc], bx */
        ...
        l_0x1a_0638:
            ...
            ii(0x1a_0640, 3); mov(memw[ss, bp - 0x4], dx);              /* mov [bp-0x4], dx */
            ii(0x1a_0643, 3); mov(memw[ss, bp - 0x2], cx);              /* mov [bp-0x2], cx */
            ii(0x1a_0646, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0x1a_0649, 3); or(ax, memw[ss, bp - 0x4]);               /* or ax, [bp-0x4] */
            ii(0x1a_064c, 2); if(jz(0x1a_06c1, 0x73)) goto l_0x1a_06c1; /* jz 0x6c1 */
            ii(0x1a_064e, 3); push(0x100);                              /* push 0x100 */
            ii(0x1a_0651, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x1a_0654, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ii(0x1a_0657, 5); call_far_abs(0x80, 0x56e0);               /* call word 0x80:0x56e0 */
            ii(0x1a_065c, 3); add(sp, 0x6);                             /* add sp, 0x6 */
            ii(0x1a_065f, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x1a_0662, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x1a_0665, 2); or(dx, ax);                               /* or dx, ax */
            ii(0x1a_0667, 2); if(jz(0x1a_06c1, 0x58)) goto l_0x1a_06c1; /* jz 0x6c1 */
            ii(0x1a_0669, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x1a_066c, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ii(0x1a_066f, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x1a_0672, 1); push(ax);                                 /* push ax */
            ii(0x1a_0673, 3); call(0x19_ff6c, -0x70a);                  /* call 0xff6c */
            ii(0x1a_0676, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x1a_0679, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ii(0x1a_067c, 5); call_far_abs(0x80, 0x4f60);               /* call word 0x80:0x4f60 */
            ii(0x1a_0681, 1); pop(bx);                                  /* pop bx */
            ii(0x1a_0682, 1); pop(bx);                                  /* pop bx */
            ii(0x1a_0683, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x1a_0686, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ii(0x1a_0689, 3); call(0x19_ff2f, -0x75d);                  /* call 0xff2f */
            ii(0x1a_068c, 3); add(ax, memw[ss, bp + 0x4]);              /* add ax, [bp+0x4] */
            ii(0x1a_068f, 3); mov(dx, memw[ss, bp + 0x6]);              /* mov dx, [bp+0x6] */
            ii(0x1a_0692, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
        ...
        l_0x1a_06b3:
            ii(0x1a_06b3, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0x1a_06b6, 3); mov(dx, memw[ss, bp - 0x2]);              /* mov dx, [bp-0x2] */
            ii(0x1a_06b9, 3); dec(memw[ss, bp - 0x4]);                  /* dec word [bp-0x4] */
            ii(0x1a_06bc, 3); cmp(memw[ss, bp + 0x4], ax);              /* cmp [bp+0x4], ax */
            ii(0x1a_06bf, 2); if(jb(0x1a_069a, -0x27)) goto l_0x1a_069a; /* jb 0x69a */
        l_0x1a_06c1:
            ii(0x1a_06c1, 1); leave();                                  /* leave */
            ii(0x1a_06c2, 3); ret(0x4);                                 /* ret 0x4 */
        }
    }
}
