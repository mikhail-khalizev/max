...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("b32ac556-c473-4748-9bc7-116a9d427a9f")]
        public void Method_1014_9fa8()
        {
            ii(0x1014_9fa8, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x1014_9fad, 5); calld(Definitions.sys_check_available_stack_size, 0x1bda0); /* call 0x10165d52 */
            ...
            ii(0x1014_9fcb, 5); calld(0x100f_f562, -0x4aa6e);           /* call 0x100ff562 */
            ii(0x1014_9fd0, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x1014_9fd3, 5); add(eax, 0xb5);                         /* add eax, 0xb5 */
            ii(0x1014_9fd8, 5); calld(0x100f_f562, -0x4aa7b);           /* call 0x100ff562 */
