...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_9fa8()
        {
            ...
            ii(0x1014_9fc0, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_9fc3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_9fc6, 5); add(eax, 0xc5);                         /* add eax, 0xc5 */
            ii(0x1014_9fcb, 5); call(0x100f_f562, -0x4_aa6e);           /* call 0x100ff562 */
            ii(0x1014_9fd0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
