...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_25a8()
        {
            ...
            ii(0x1015_25c0, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_25c3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_25c6, 6); mov(al, memb[ds, eax + 0xa5]);          /* mov al, [eax+0xa5] */
            ii(0x1015_25cc, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x1015_25cf, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_25d2, 7); mov(memb[ds, eax + 0xa5], 0);           /* mov byte [eax+0xa5], 0x0 */
        l_0x1015_25d9:
            ii(0x1015_25d9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_25dc, 4); cmp(memb[ds, eax + 0x3d], 0);           /* cmp byte [eax+0x3d], 0x0 */
        ...
        l_0x1015_25f0:
            ii(0x1015_25f0, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x1015_25f3, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1015_25f6, 6); mov(memb[ds, edx + 0xa5], al);          /* mov [edx+0xa5], al */
