...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("c78fdca1-72f6-4e72-bd33-544f0d1d6b87")]
        public void Method_1010_eda6()
        {
            ii(0x1010_eda6, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x1010_edab, 5); calld(Definitions.sys_check_available_stack_size, 0x56fa2); /* call 0x10165d52 */
            ...
            ii(0x1010_edd6, 5); calld(0x100e_8ef1, -0x25eea);           /* call 0x100e8ef1 */
            ...
            ii(0x1010_edf0, 5); calld(0x100e_8ef1, -0x25f04);           /* call 0x100e8ef1 */
