...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void my__get_unit()
        {
            ...
            ii(0x100b_8034, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_8037, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_803a, 3); add(eax, 0x6);                          /* add eax, 0x6 */
            ii(0x100b_803d, 5); call(0x1007_65d0, -0x4_1a72);           /* call 0x100765d0 */
            ii(0x100b_8042, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_8045, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
