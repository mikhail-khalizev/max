...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_eea8()
        {
            ...
            ii(0x1014_eebf, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_eec2, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x1014_eec5, 5); mov(edx, 0x101c_37bc);                  /* mov edx, 0x101c37bc */
            ii(0x1014_eeca, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_eed6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_eed9, 5); call(0x1010_094d, -0x4_e591);           /* call 0x1010094d */
            ii(0x1014_eede, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1014_ef01:
            ...
            ii(0x1014_ef31, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1014_ef3b:
            ii(0x1014_ef3b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_ef3e, 5); cmp(memw[ds, eax + 0x8], 0x42);         /* cmp word [eax+0x8], 0x42 */
            ii(0x1014_ef43, 2); if(jnz(0x1014_ef60, 0x1b)) goto l_0x1014_ef60; /* jnz 0x1014ef60 */
            ii(0x1014_ef45, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_ef50, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_ef53, 5); call(0x1014_9ab7, -0x54a1);             /* call 0x10149ab7 */
            ii(0x1014_ef58, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1014_ef60:
            ...
            ii(0x1014_ef6a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_ef7b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_ef7e, 5); call(0x1007_6d98, -0xd_81eb);           /* call 0x10076d98 */
            ii(0x1014_ef83, 2); test(al, al);                           /* test al, al */
            ii(0x1014_ef85, 2); if(jnz(0x1014_ef90, 0x9)) goto l_0x1014_ef90; /* jnz 0x1014ef90 */
            ii(0x1014_ef87, 7); cmp(memb[ds, 0x101c_3889], 0);          /* cmp byte [0x101c3889], 0x0 */
            ii(0x1014_ef8e, 2); if(jz(0x1014_ef92, 0x2)) goto l_0x1014_ef92; /* jz 0x1014ef92 */
        l_0x1014_ef90:
            ii(0x1014_ef90, 2); jmp(0x1014_ef9b, 0x9); goto l_0x1014_ef9b; /* jmp 0x1014ef9b */
        l_0x1014_ef92:
            ii(0x1014_ef92, 7); cmp(memb[ds, 0x101c_388a], 0);          /* cmp byte [0x101c388a], 0x0 */
            ii(0x1014_ef99, 2); if(jz(0x1014_efa0, 0x5)) goto l_0x1014_efa0; /* jz 0x1014efa0 */
        l_0x1014_ef9b:
            ii(0x1014_ef9b, 5); call(0x100f_f5c1, -0x4_f9df);           /* call 0x100ff5c1 */
        l_0x1014_efa0:
            ii(0x1014_efa0, 7); mov(memb[ds, 0x101c_391b], 0x1);        /* mov byte [0x101c391b], 0x1 */
        l_0x1014_efa7:
            ii(0x1014_efa7, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_efaa, 5); call(0x1015_24a1, 0x34f2);              /* call 0x101524a1 */
            ii(0x1014_efaf, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_efb2, 5); call(0x1015_48ba, 0x5903);              /* call 0x101548ba */
            ii(0x1014_efb7, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_efba, 5); cmp(memw[ds, eax + 0x8], 0x38);         /* cmp word [eax+0x8], 0x38 */
            ii(0x1014_efbf, 2); if(jz(0x1014_efcb, 0xa)) goto l_0x1014_efcb; /* jz 0x1014efcb */
            ii(0x1014_efc1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_efc4, 5); cmp(memw[ds, eax + 0x8], 0x4a);         /* cmp word [eax+0x8], 0x4a */
            ii(0x1014_efc9, 2); if(jnz(0x1014_efd3, 0x8)) goto l_0x1014_efd3; /* jnz 0x1014efd3 */
        l_0x1014_efcb:
            ii(0x1014_efcb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_efce, 5); call(0x100a_92fd, -0xa_5cd6);           /* call 0x100a92fd */
        l_0x1014_efd3:
            ii(0x1014_efd3, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ...
            ii(0x1014_efe5, 2); if(jz(0x1014_efe9, 0x2)) goto l_0x1014_efe9; /* jz 0x1014efe9 */
        l_0x1014_efe7:
            ii(0x1014_efe7, 2); jmp(0x1014_f00f, 0x26); goto l_0x1014_f00f; /* jmp 0x1014f00f */
        l_0x1014_efe9:
            ii(0x1014_efe9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_efec, 4); mov(memb[ds, eax + 0x59], 0x1);         /* mov byte [eax+0x59], 0x1 */
            ii(0x1014_eff0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_eff3, 5); call(0x1015_c802, 0xd80a);              /* call 0x1015c802 */
            ii(0x1014_eff8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_f005, 2); if(jz(0x1014_f00f, 0x8)) goto l_0x1014_f00f; /* jz 0x1014f00f */
            ii(0x1014_f007, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
