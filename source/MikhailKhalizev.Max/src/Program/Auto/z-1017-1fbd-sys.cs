...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_1fbd()
        {
            ...
            ii(0x1017_1fc3, 4); cmp(memd[ds, eax + 0x8], 0);            /* cmp dword [eax+0x8], 0x0 */
            ii(0x1017_1fc7, 2); if(jnz(0x1017_1fce, 0x5)) goto l_0x1017_1fce; /* jnz 0x10171fce */
            ii(0x1017_1fc9, 5); call(/* sys */ 0x1018_d3ee, 0x1_b420);  /* call 0x1018d3ee */
        l_0x1017_1fce:
            ii(0x1017_1fce, 3); mov(ah, memb[ds, ecx + 0xd]);           /* mov ah, [ecx+0xd] */
        ...
        l_0x1017_1fe5:
            ...
            ii(0x1017_201c, 7); mov(memd[ds, ecx + 0x4], 0x1);          /* mov dword [ecx+0x4], 0x1 */
            ii(0x1017_2023, 2); jmp(0x1017_2042, 0x1d); goto l_0x1017_2042; /* jmp 0x10172042 */
        l_0x1017_2025:
            ii(0x1017_2025, 4); test(memb[ds, ecx + 0xd], 0x4);         /* test byte [ecx+0xd], 0x4 */
            ii(0x1017_2029, 2); if(jz(0x1017_2032, 0x7)) goto l_0x1017_2032; /* jz 0x10172032 */
            ii(0x1017_202b, 5); mov(ebx, 0x1);                          /* mov ebx, 0x1 */
            ii(0x1017_2030, 2); jmp(0x1017_2035, 0x3); goto l_0x1017_2035; /* jmp 0x10172035 */
        l_0x1017_2032:
            ii(0x1017_2032, 3); mov(ebx, memd[ds, ecx + 0x14]);         /* mov ebx, [ecx+0x14] */
        l_0x1017_2035:
            ii(0x1017_2035, 2); mov(edx, memd[ds, ecx]);                /* mov edx, [ecx] */
            ii(0x1017_2037, 3); mov(eax, memd[ds, ecx + 0x10]);         /* mov eax, [ecx+0x10] */
            ii(0x1017_203a, 5); call(/* sys */ 0x1018_d4b6, 0x1_b477);  /* call 0x1018d4b6 */
            ii(0x1017_203f, 3); mov(memd[ds, ecx + 0x4], eax);          /* mov [ecx+0x4], eax */
        l_0x1017_2042:
            ii(0x1017_2042, 3); mov(esi, memd[ds, ecx + 0x4]);          /* mov esi, [ecx+0x4] */
            ii(0x1017_2045, 2); test(esi, esi);                         /* test esi, esi */
            ii(0x1017_2047, 2); if(jg(0x1017_2061, 0x18)) goto l_0x1017_2061; /* jg 0x10172061 */
            ii(0x1017_2049, 2); if(jnz(0x1017_2051, 0x6)) goto l_0x1017_2051; /* jnz 0x10172051 */
            ii(0x1017_204b, 4); or(memb[ds, ecx + 0xc], 0x10);          /* or byte [ecx+0xc], 0x10 */
            ii(0x1017_204f, 2); jmp(0x1017_2061, 0x10); goto l_0x1017_2061; /* jmp 0x10172061 */
        l_0x1017_2051:
            ii(0x1017_2051, 3); mov(bh, memb[ds, ecx + 0xc]);           /* mov bh, [ecx+0xc] */
            ii(0x1017_2054, 7); mov(memd[ds, ecx + 0x4], 0);            /* mov dword [ecx+0x4], 0x0 */
            ii(0x1017_205b, 3); or(bh, 0x20);                           /* or bh, 0x20 */
            ii(0x1017_205e, 3); mov(memb[ds, ecx + 0xc], bh);           /* mov [ecx+0xc], bh */
        l_0x1017_2061:
            ii(0x1017_2061, 3); mov(eax, memd[ds, ecx + 0x4]);          /* mov eax, [ecx+0x4] */
