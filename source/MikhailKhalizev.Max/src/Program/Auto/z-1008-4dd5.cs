...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_4dd5()
        {
            ...
            ii(0x1008_4ded, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1008_4df0, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_4df2, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_4e01, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
        ...
        l_0x1008_4e2f:
            ...
            ii(0x1008_4e46, 3); lea(eax, memd[ss, ebp - 36]);           /* lea eax, [ebp-0x24] */
            ii(0x1008_4e49, 5); call(Definitions.my_ctor_0x101b_4184, -0xe35e); /* call 0x10076af0 */
            ii(0x1008_4e4e, 4); mov(memb[ss, ebp - 8], 0);              /* mov byte [ebp-0x8], 0x0 */
            ii(0x1008_4e52, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1008_4e55, 3); add(edx, 0x32);                         /* add edx, 0x32 */
            ii(0x1008_4e58, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
            ii(0x1008_4e5b, 5); call(0x1007_6668, -0xe7f8);             /* call 0x10076668 */
            ii(0x1008_4e60, 4); or(memb[ss, ebp - 12], 1);              /* or byte [ebp-0xc], 0x1 */
            ii(0x1008_4e64, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ii(0x1008_4e67, 5); call(0x1007_64fc, -0xe970);             /* call 0x100764fc */
            ii(0x1008_4e6c, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x1008_4e6f, 4); and(memb[ss, ebp - 12], -2 /* 0xfe */); /* and byte [ebp-0xc], 0xfe */
            ii(0x1008_4e73, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1008_4e76, 4); mov(memb[ds, eax + 70], 0);             /* mov byte [eax+0x46], 0x0 */
            ii(0x1008_4e7a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_4e7c, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_4e8b, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
        ...
        l_0x1008_4e9f:
            ii(0x1008_4e9f, 6); mov(memw[ss, ebp - 36], 0);             /* mov word [ebp-0x24], 0x0 */
            ii(0x1008_4ea5, 6); mov(memw[ss, ebp - 34], 0);             /* mov word [ebp-0x22], 0x0 */
            ii(0x1008_4eab, 2); jmp(0x1008_4eeb, 0x3e); goto l_0x1008_4eeb; /* jmp 0x10084eeb */
        l_0x1008_4ead:
            ii(0x1008_4ead, 3); lea(edx, memd[ss, ebp - 48]);           /* lea edx, [ebp-0x30] */
            ii(0x1008_4eb0, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_4ec2, 3); lea(eax, memd[ss, ebp - 36]);           /* lea eax, [ebp-0x24] */
            ii(0x1008_4ec5, 5); call(0x1008_8b44, 0x3c7a);              /* call 0x10088b44 */
            ii(0x1008_4eca, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1008_4ecd, 3); mov(edx, memd[ds, eax + 7]);            /* mov edx, [eax+0x7] */
            ii(0x1008_4ed0, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1008_4ed3, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_4ee8, 3); mov(memb[ss, ebp - 8], al);             /* mov [ebp-0x8], al */
        l_0x1008_4eeb:
            ii(0x1008_4eeb, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1008_4eee, 3); add(edx, 0x3e);                         /* add edx, 0x3e */
            ii(0x1008_4ef1, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1008_4ef4, 3); add(eax, 0x32);                         /* add eax, 0x32 */
            ii(0x1008_4ef7, 5); call(0x1008_ac18, 0x5d1c);              /* call 0x1008ac18 */
            ii(0x1008_4efc, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1008_4eff, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_4f0c, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_4f1b, 3); lea(edx, memd[ss, ebp - 36]);           /* lea edx, [ebp-0x24] */
            ii(0x1008_4f1e, 3); lea(eax, memd[ss, ebp - 52]);           /* lea eax, [ebp-0x34] */
            ii(0x1008_4f21, 5); call(0x1007_5e64, -0xf0c2);             /* call 0x10075e64 */
            ii(0x1008_4f26, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1008_4f28, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_4f3a, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
        l_0x1008_4f3d:
            ii(0x1008_4f3d, 2); jmp(0x1008_4f47, 8); goto l_0x1008_4f47; /* jmp 0x10084f47 */
        l_0x1008_4f3f:
            ii(0x1008_4f3f, 3); lea(eax, memd[ss, ebp - 40]);           /* lea eax, [ebp-0x28] */
            ii(0x1008_4f42, 5); call(0x1007_6bf8, -0xe34f);             /* call 0x10076bf8 */
        l_0x1008_4f47:
            ii(0x1008_4f47, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_4f49, 3); lea(eax, memd[ss, ebp - 40]);           /* lea eax, [ebp-0x28] */
            ...
            ii(0x1008_4f59, 3); lea(eax, memd[ss, ebp - 40]);           /* lea eax, [ebp-0x28] */
            ...
            ii(0x1008_4f68, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ii(0x1008_4f6b, 5); call(0x1007_643c, -0xeb34);             /* call 0x1007643c */
            ii(0x1008_4f70, 2); jmp(0x1008_4f7a, 8); goto l_0x1008_4f7a; /* jmp 0x10084f7a */
        l_0x1008_4f72:
            ii(0x1008_4f72, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ii(0x1008_4f75, 5); call(0x1007_6bf8, -0xe382);             /* call 0x10076bf8 */
        l_0x1008_4f7a:
            ii(0x1008_4f7a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_4f7c, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1008_4f8c, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ii(0x1008_4f8f, 5); call(0x1007_63d4, -0xebc0);             /* call 0x100763d4 */
            ii(0x1008_4f94, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1008_4f96, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_4fa2, 3); lea(edx, memd[ss, ebp - 36]);           /* lea edx, [ebp-0x24] */
            ii(0x1008_4fa5, 3); lea(eax, memd[ss, ebp - 56]);           /* lea eax, [ebp-0x38] */
            ii(0x1008_4fa8, 5); call(0x1007_5e64, -0xf149);             /* call 0x10075e64 */
            ii(0x1008_4fad, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1008_4faf, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ii(0x1008_4fb2, 5); call(0x1007_63d4, -0xebe3);             /* call 0x100763d4 */
            ii(0x1008_4fb7, 5); call(0x1007_0ca1, -0x1_431b);           /* call 0x10070ca1 */
            ii(0x1008_4fbc, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1008_4fbf, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_4fc1, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_4fce, 2); if(jnz(0x1008_4fd9, 9)) goto l_0x1008_4fd9; /* jnz 0x10084fd9 */
            ii(0x1008_4fd0, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1008_4fd3, 4); cmp(ax, memw[ss, ebp - 20]);            /* cmp ax, [ebp-0x14] */
            ii(0x1008_4fd7, 2); if(jle(0x1008_500b, 0x32)) goto l_0x1008_500b; /* jle 0x1008500b */
        l_0x1008_4fd9:
            ii(0x1008_4fd9, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ii(0x1008_4fdc, 5); call(0x1007_63d4, -0xec0d);             /* call 0x100763d4 */
            ii(0x1008_4fe1, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1008_4fe3, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1008_4fe6, 3); add(eax, 0x32);                         /* add eax, 0x32 */
            ii(0x1008_4fe9, 5); call(0x1007_6630, -0xe9be);             /* call 0x10076630 */
            ii(0x1008_4fee, 3); lea(eax, memd[ss, ebp - 40]);           /* lea eax, [ebp-0x28] */
            ii(0x1008_4ff1, 5); call(0x1008_9b34, 0x4b3e);              /* call 0x10089b34 */
            ii(0x1008_4ff6, 3); mov(ebx, memd[ss, ebp - 4]);            /* mov ebx, [ebp-0x4] */
            ...
            ii(0x1008_5005, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x1008_5008, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
        l_0x1008_500b:
        ...
        l_0x1008_5015:
            ...
            ii(0x1008_5017, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_502a, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1008_502d, 3); add(eax, 0x20);                         /* add eax, 0x20 */
            ii(0x1008_5030, 5); call(0x1008_9d08, 0x4cd3);              /* call 0x10089d08 */
            ii(0x1008_5035, 3); lea(ebx, memd[ss, ebp - 40]);           /* lea ebx, [ebp-0x28] */
            ...
            ii(0x1008_5041, 2); jmp(0x1008_504b, 8); goto l_0x1008_504b; /* jmp 0x1008504b */
        l_0x1008_5043:
            ii(0x1008_5043, 3); lea(eax, memd[ss, ebp - 40]);           /* lea eax, [ebp-0x28] */
            ii(0x1008_5046, 5); call(0x1007_6bf8, -0xe453);             /* call 0x10076bf8 */
        l_0x1008_504b:
            ii(0x1008_504b, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_504d, 3); lea(eax, memd[ss, ebp - 40]);           /* lea eax, [ebp-0x28] */
            ...
            ii(0x1008_505d, 3); lea(eax, memd[ss, ebp - 40]);           /* lea eax, [ebp-0x28] */
            ...
            ii(0x1008_506c, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ii(0x1008_506f, 5); call(0x1007_643c, -0xec38);             /* call 0x1007643c */
            ii(0x1008_5074, 2); jmp(0x1008_507e, 8); goto l_0x1008_507e; /* jmp 0x1008507e */
        l_0x1008_5076:
            ii(0x1008_5076, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ii(0x1008_5079, 5); call(0x1007_6bf8, -0xe486);             /* call 0x10076bf8 */
        l_0x1008_507e:
            ii(0x1008_507e, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_5080, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1008_508c, 3); lea(edx, memd[ss, ebp - 36]);           /* lea edx, [ebp-0x24] */
            ii(0x1008_508f, 3); lea(eax, memd[ss, ebp - 60]);           /* lea eax, [ebp-0x3c] */
            ii(0x1008_5092, 5); call(0x1007_5e64, -0xf233);             /* call 0x10075e64 */
            ii(0x1008_5097, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1008_5099, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ii(0x1008_509c, 5); call(0x1007_63d4, -0xeccd);             /* call 0x100763d4 */
            ii(0x1008_50a1, 5); call(0x1007_0ca1, -0x1_4405);           /* call 0x10070ca1 */
            ii(0x1008_50a6, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1008_50a9, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_50ab, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_50b8, 2); if(jnz(0x1008_50c3, 9)) goto l_0x1008_50c3; /* jnz 0x100850c3 */
            ii(0x1008_50ba, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1008_50bd, 4); cmp(ax, memw[ss, ebp - 20]);            /* cmp ax, [ebp-0x14] */
            ii(0x1008_50c1, 2); if(jle(0x1008_50f5, 0x32)) goto l_0x1008_50f5; /* jle 0x100850f5 */
        l_0x1008_50c3:
            ii(0x1008_50c3, 3); lea(eax, memd[ss, ebp - 28]);           /* lea eax, [ebp-0x1c] */
            ii(0x1008_50c6, 5); call(0x1007_63d4, -0xecf7);             /* call 0x100763d4 */
            ii(0x1008_50cb, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1008_50cd, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1008_50d0, 3); add(eax, 0x32);                         /* add eax, 0x32 */
            ii(0x1008_50d3, 5); call(0x1007_6630, -0xeaa8);             /* call 0x10076630 */
            ii(0x1008_50d8, 3); lea(eax, memd[ss, ebp - 40]);           /* lea eax, [ebp-0x28] */
            ii(0x1008_50db, 5); call(0x1008_9b34, 0x4a54);              /* call 0x10089b34 */
            ii(0x1008_50e0, 3); mov(ebx, memd[ss, ebp - 4]);            /* mov ebx, [ebp-0x4] */
            ...
            ii(0x1008_50ef, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x1008_50f2, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
        l_0x1008_50f5:
        ...
        l_0x1008_50ff:
            ...
            ii(0x1008_5101, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
            ...
            ii(0x1008_510d, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1008_5110, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
        ...
        l_0x1008_511d:
            ...
            ii(0x1008_511f, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_512e, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1008_5131, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
