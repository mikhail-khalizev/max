...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_95b4()
        {
            ...
            ii(0x100e_95cc, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100e_95cf, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x100e_95d6, 2); jmp(0x100e_95de, 0x6); goto l_0x100e_95de; /* jmp 0x100e95de */
        l_0x100e_95d8:
            ii(0x100e_95d8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_95db, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x100e_95de:
            ii(0x100e_95de, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_95e1, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100e_95e4, 4); cmp(ax, memw[ds, edx + 0x2]);           /* cmp ax, [edx+0x2] */
            ii(0x100e_95e8, 2); if(jge(0x100e_9604, 0x1a)) goto l_0x100e_9604; /* jge 0x100e9604 */
            ii(0x100e_95ea, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100e_95ee, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100e_95f1, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100e_95f3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_95f6, 3); mov(eax, memd[ds, eax + 0x4]);          /* mov eax, [eax+0x4] */
