...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_b934()
        {
            ...
            ii(0x1008_b94b, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_b94e, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1008_b951, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1008_b965, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1008_b97a, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1008_b97d, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1008_b995, 4); movsx(edx, memw[ss, ebp - 0x10]);       /* movsx edx, word [ebp-0x10] */
            ii(0x1008_b999, 2); test(edx, eax);                         /* test edx, eax */
            ii(0x1008_b99b, 2); if(jz(0x1008_b9ab, 0xe)) goto l_0x1008_b9ab; /* jz 0x1008b9ab */
            ii(0x1008_b99d, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1008_b9a0, 5); and(eax, 0x1f);                         /* and eax, 0x1f */
            ii(0x1008_b9a5, 4); cmp(ax, 0x8);                           /* cmp ax, 0x8 */
            ii(0x1008_b9a9, 2); if(jge(0x1008_b9ad, 0x2)) goto l_0x1008_b9ad; /* jge 0x1008b9ad */
        l_0x1008_b9ab:
            ii(0x1008_b9ab, 2); jmp(0x1008_b9b3, 0x6); goto l_0x1008_b9b3; /* jmp 0x1008b9b3 */
        l_0x1008_b9ad:
            ii(0x1008_b9ad, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1008_b9b1, 2); jmp(0x1008_b9b7, 0x4); goto l_0x1008_b9b7; /* jmp 0x1008b9b7 */
        l_0x1008_b9b3:
            ii(0x1008_b9b3, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
        l_0x1008_b9b7:
            ii(0x1008_b9b7, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
