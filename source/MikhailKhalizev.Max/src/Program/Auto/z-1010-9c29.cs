...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("92667e40-bc93-4291-8e40-78c441b43e20")]
        public void Method_1010_9c29()
        {
            ii(0x1010_9c29, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x1010_9c2e, 5); calld(Definitions.sys_check_available_stack_size, 0x5c11f); /* call 0x10165d52 */
        ...
        l_0x1010_9c53:
            ...
            ii(0x1010_9c5d, 5); calld(0x100d_51e4, -0x34a7e);           /* call 0x100d51e4 */
            ii(0x1010_9c62, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1010_9c64, 2); mov(bl, al);                            /* mov bl, al */
            ii(0x1010_9c66, 5); calld(0x100d_5204, -0x34a67);           /* call 0x100d5204 */
            ...
            ii(0x1010_9c80, 5); calld(0x100c_fa7c, -0x3a209);           /* call 0x100cfa7c */
