...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("a2777af4-38cf-405f-93a6-95067a691e99")]
        public void Method_100e_c26f()
        {
            ii(0x100e_c26f, 5); pushd(0x2c);                            /* push 0x2c */
            ii(0x100e_c274, 5); calld(Definitions.sys_check_available_stack_size, 0x7_9ad9); /* call 0x10165d52 */
            ...
            ii(0x100e_c28f, 5); calld(0x1007_6338, -0x7_5f5c);          /* call 0x10076338 */
            ii(0x100e_c294, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100e_c296, 3); lea(eax, ebp - 0x14);                   /* lea eax, [ebp-0x14] */
            ii(0x100e_c299, 5); calld(0x1007_64b8, -0x7_5de6);          /* call 0x100764b8 */
        ...
        l_0x100e_c2a7:
            ...
            ii(0x100e_c2aa, 5); calld(0x1007_6bf8, -0x7_56b7);          /* call 0x10076bf8 */
        l_0x100e_c2af:
            ii(0x100e_c2af, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100e_c2b1, 3); lea(eax, ebp - 0x14);                   /* lea eax, [ebp-0x14] */
            ii(0x100e_c2b4, 5); calld(0x1013_ad71, 0x4_eab8);           /* call 0x1013ad71 */
            ...
            ii(0x100e_c2c0, 5); calld(0x1007_63a0, -0x7_5f25);          /* call 0x100763a0 */
            ...
            ii(0x100e_c2d5, 5); calld(0x1007_63a0, -0x7_5f3a);          /* call 0x100763a0 */
            ii(0x100e_c2da, 5); calld(0x1015_09a6, 0x6_46c7);           /* call 0x101509a6 */
        ...
        l_0x100e_c2e4:
            ...
            ii(0x100e_c2ef, 5); calld(0x1007_5f6c, -0x7_6388);          /* call 0x10075f6c */
            ii(0x100e_c2f4, 2); jmpd(0x100e_c300, 0xa); goto l_0x100e_c300; /* jmp 0x100ec300 */
        //    ii(0x100e_c2f6, 2); xor(edx, edx);                          /* xor edx, edx */
        //    ii(0x100e_c2f8, 3); lea(eax, ebp - 0x14);                   /* lea eax, [ebp-0x14] */
        //    ii(0x100e_c2fb, 5); calld(0x1007_5f6c, -0x7_6394);          /* call 0x10075f6c */
        l_0x100e_c300:
