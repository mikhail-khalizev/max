...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_63d4()
        {
            ...
            ii(0x1012_63f3, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ...
            ii(0x1012_642a, 7); mov(memb[ds, 0x101c_59c4], 0x1);        /* mov byte [0x101c59c4], 0x1 */
            ...
            ii(0x1012_6446, 7); mov(memb[ds, 0x101c_59c9], 0x1);        /* mov byte [0x101c59c9], 0x1 */
            ii(0x1012_644d, 7); mov(memb[ds, 0x101c_609e], 0);          /* mov byte [0x101c609e], 0x0 */
            ii(0x1012_6454, 7); mov(memd[ss, ebp - 0x4], 0x4);          /* mov dword [ebp-0x4], 0x4 */
        l_0x1012_645b:
            ii(0x1012_645b, 3); dec(memd[ss, ebp - 0x4]);               /* dec dword [ebp-0x4] */
            ii(0x1012_645e, 5); cmp(memw[ss, ebp - 0x4], -0x1 /* 0xff */); /* cmp word [ebp-0x4], 0xffff */
            ii(0x1012_6463, 2); if(jz(0x1012_64c6, 0x61)) goto l_0x1012_64c6; /* jz 0x101264c6 */
            ii(0x1012_6465, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1012_6469, 7); mov(memb[ds, eax + 0x101c_59c0], 0);    /* mov byte [eax+0x101c59c0], 0x0 */
            ii(0x1012_6470, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1012_6474, 7); mov(memb[ds, eax + 0x101c_59d0], 0);    /* mov byte [eax+0x101c59d0], 0x0 */
            ii(0x1012_647b, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1012_647f, 7); mov(memb[ds, eax + 0x101c_59d4], 0);    /* mov byte [eax+0x101c59d4], 0x0 */
            ii(0x1012_6486, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1012_648a, 7); mov(memb[ds, eax + 0x101c_59d8], 0);    /* mov byte [eax+0x101c59d8], 0x0 */
            ii(0x1012_6491, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1012_6495, 7); mov(memb[ds, eax + 0x101c_59dc], 0);    /* mov byte [eax+0x101c59dc], 0x0 */
            ii(0x1012_649c, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1012_64b1, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
        ...
        l_0x1012_64c6:
            ...
            ii(0x1012_64cf, 7); mov(memd[ss, ebp - 0x4], 0x20);         /* mov dword [ebp-0x4], 0x20 */
        l_0x1012_64d6:
            ii(0x1012_64d6, 3); dec(memd[ss, ebp - 0x4]);               /* dec dword [ebp-0x4] */
            ii(0x1012_64d9, 5); cmp(memw[ss, ebp - 0x4], -0x1 /* 0xff */); /* cmp word [ebp-0x4], 0xffff */
            ii(0x1012_64de, 6); if(jz(0x1012_66a6, 0x1c2)) goto l_0x1012_66a6; /* jz 0x101266a6 */
            ii(0x1012_64e4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_64e7, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1012_64ea, 5); jmp(0x1012_6680, 0x191); goto l_0x1012_6680; /* jmp 0x10126680 */
        l_0x1012_64ef:
            ii(0x1012_64ef, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1012_6500, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
        ...
        l_0x1012_6516:
            ii(0x1012_6516, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1012_6527, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
        ...
        l_0x1012_653d:
            ii(0x1012_653d, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1012_654e, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
        ...
        l_0x1012_6564:
            ii(0x1012_6564, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1012_6575, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
        ...
        l_0x1012_658b:
            ii(0x1012_658b, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1012_659c, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
        ...
        l_0x1012_65b2:
            ...
            ii(0x1012_65e2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_65e5, 3); mov(edx, memd[ds, eax + 0x16]);         /* mov edx, [eax+0x16] */
            ii(0x1012_65e8, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1012_6680:
            ii(0x1012_6680, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_6683, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1012_6686, 5); cmp(memw[ss, ebp - 0x10], 0x1f);        /* cmp word [ebp-0x10], 0x1f */
            ii(0x1012_668b, 6); if(ja(0x1012_65b2, -0xdf)) goto l_0x1012_65b2; /* ja 0x101265b2 */
            ii(0x1012_6691, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1012_6693, 4); mov(ax, memw[ss, ebp - 0x10]);          /* mov ax, [ebp-0x10] */
        ...
        l_0x1012_66d6:
            ...
            ii(0x1012_6706, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_6709, 3); mov(edx, memd[ds, eax + 0x16]);         /* mov edx, [eax+0x16] */
            ii(0x1012_670c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
