...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_f518()
        {
            ...
            ii(0x1016_f51c, 4); test(memb[ds, edx + 0x4], 0x4);         /* test byte [edx+0x4], 0x4 */
            ii(0x1016_f520, 2); if(jz(0x1016_f52a, 0x8)) goto l_0x1016_f52a; /* jz 0x1016f52a */
            ii(0x1016_f522, 3); mov(edx, memd[ds, edx + 0xc]);          /* mov edx, [edx+0xc] */
