...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_bf68()
        {
            ...
            ii(0x100a_bf80, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_bf83, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_bf86, 4); cmp(memb[ds, eax + 0x1e], 0);           /* cmp byte [eax+0x1e], 0x0 */
            ii(0x100a_bf8a, 2); if(jz(0x100a_bf9d, 0x11)) goto l_0x100a_bf9d; /* jz 0x100abf9d */
            ii(0x100a_bf8c, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_bf8e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_bf9b, 2); if(jnz(0x100a_bf9f, 0x2)) goto l_0x100a_bf9f; /* jnz 0x100abf9f */
        l_0x100a_bf9d:
            ii(0x100a_bf9d, 2); jmp(0x100a_bfeb, 0x4c); goto l_0x100a_bfeb; /* jmp 0x100abfeb */
        l_0x100a_bf9f:
            ii(0x100a_bf9f, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100a_bfa2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_bfcd, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100a_bfda, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_bfdd, 3); add(eax, 0x6);                          /* add eax, 0x6 */
            ii(0x100a_bfe0, 5); call(0x1007_6630, -0x3_59b5);           /* call 0x10076630 */
            ii(0x100a_bfe5, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x100a_bfe9, 2); jmp(0x100a_bfef, 0x4); goto l_0x100a_bfef; /* jmp 0x100abfef */
        l_0x100a_bfeb:
            ii(0x100a_bfeb, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x100a_bfef:
            ii(0x100a_bfef, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
