...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_2d1f()
        {
            ...
            ii(0x100c_2d34, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100c_2d37, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100c_2d3a, 3); mov(memd[ss, ebp - 0xc], ebx);          /* mov [ebp-0xc], ebx */
            ii(0x100c_2d3d, 3); mov(memd[ss, ebp - 0x4], ecx);          /* mov [ebp-0x4], ecx */
            ii(0x100c_2d40, 4); movsx(ebx, memw[ss, ebp - 0xc]);        /* movsx ebx, word [ebp-0xc] */
            ii(0x100c_2d44, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100c_2d48, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x100c_2d66, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ii(0x100c_2d69, 5); call(0x1008_b148, -0x3_7c26);           /* call 0x1008b148 */
            ii(0x100c_2d6e, 7); mov(memd[ss, ebp - 0x28], 0);           /* mov dword [ebp-0x28], 0x0 */
            ii(0x100c_2d75, 2); jmp(0x100c_2d7b, 0x4); goto l_0x100c_2d7b; /* jmp 0x100c2d7b */
        l_0x100c_2d77:
            ii(0x100c_2d77, 4); add(memd[ss, ebp - 0x28], 0x2);         /* add dword [ebp-0x28], 0x2 */
        l_0x100c_2d7b:
            ii(0x100c_2d7b, 4); movsx(eax, memw[ss, ebp - 0x28]);       /* movsx eax, word [ebp-0x28] */
            ii(0x100c_2d7f, 3); cmp(eax, 0x8);                          /* cmp eax, 0x8 */
            ii(0x100c_2d82, 6); if(jge(0x100c_2e39, 0xb1)) goto l_0x100c_2e39; /* jge 0x100c2e39 */
            ii(0x100c_2d88, 7); mov(memd[ss, ebp - 0x2c], 0);           /* mov dword [ebp-0x2c], 0x0 */
            ii(0x100c_2d8f, 2); jmp(0x100c_2d97, 0x6); goto l_0x100c_2d97; /* jmp 0x100c2d97 */
        l_0x100c_2d91:
            ii(0x100c_2d91, 3); mov(eax, memd[ss, ebp - 0x2c]);         /* mov eax, [ebp-0x2c] */
            ii(0x100c_2d94, 3); inc(memd[ss, ebp - 0x2c]);              /* inc dword [ebp-0x2c] */
        l_0x100c_2d97:
            ii(0x100c_2d97, 3); mov(eax, memd[ss, ebp - 0x2c]);         /* mov eax, [ebp-0x2c] */
            ii(0x100c_2d9a, 4); cmp(ax, memw[ss, ebp - 0x4]);           /* cmp ax, [ebp-0x4] */
            ii(0x100c_2d9e, 6); if(jge(0x100c_2e34, 0x90)) goto l_0x100c_2e34; /* jge 0x100c2e34 */
            ii(0x100c_2da4, 4); movsx(edx, memw[ss, ebp - 0x28]);       /* movsx edx, word [ebp-0x28] */
            ...
            ii(0x100c_2db2, 3); lea(eax, memd[ss, ebp - 0x14]);         /* lea eax, [ebp-0x14] */
            ii(0x100c_2db5, 5); call(0x1008_b1a4, -0x3_7c16);           /* call 0x1008b1a4 */
            ii(0x100c_2dba, 3); lea(edx, memd[ss, ebp - 0x14]);         /* lea edx, [ebp-0x14] */
            ii(0x100c_2dbd, 3); lea(eax, memd[ss, ebp - 0x24]);         /* lea eax, [ebp-0x24] */
            ...
            ii(0x100c_2dc9, 4); movsx(edx, memw[ss, ebp - 0x14]);       /* movsx edx, word [ebp-0x14] */
            ii(0x100c_2dcd, 3); shl(edx, 0x2);                          /* shl edx, 0x2 */
            ii(0x100c_2dd0, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100c_2dd3, 3); mov(eax, memd[ds, eax + 0x67]);         /* mov eax, [eax+0x67] */
            ii(0x100c_2dd6, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x100c_2dd8, 4); movsx(edx, memw[ss, ebp - 0x12]);       /* movsx edx, word [ebp-0x12] */
            ...
            ii(0x100c_2de4, 3); mov(memd[ss, ebp - 0x30], eax);         /* mov [ebp-0x30], eax */
            ii(0x100c_2de7, 4); movsx(eax, memw[ss, ebp - 0x30]);       /* movsx eax, word [ebp-0x30] */
            ii(0x100c_2deb, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x100c_2ded, 2); if(jl(0x100c_2e2f, 0x40)) goto l_0x100c_2e2f; /* jl 0x100c2e2f */
            ii(0x100c_2def, 4); movsx(eax, memw[ss, ebp + 0x10]);       /* movsx eax, word [ebp+0x10] */
            ii(0x100c_2df3, 4); movsx(edx, memw[ss, ebp - 0x30]);       /* movsx edx, word [ebp-0x30] */
            ii(0x100c_2df7, 2); sub(eax, edx);                          /* sub eax, edx */
            ii(0x100c_2df9, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100c_2dfb, 4); movsx(eax, memw[ss, ebp + 0x14]);       /* movsx eax, word [ebp+0x14] */
            ...
            ii(0x100c_2e0e, 4); movsx(edx, memw[ss, ebp - 0x30]);       /* movsx edx, word [ebp-0x30] */
            ii(0x100c_2e12, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x100c_2e14, 2); mov(bl, al);                            /* mov bl, al */
            ii(0x100c_2e16, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ii(0x100c_2e1a, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100c_2e1d, 3); mov(edx, memd[ss, ebp - 0x10]);         /* mov edx, [ebp-0x10] */
            ii(0x100c_2e20, 3); mov(edx, memd[ds, edx + 0x67]);         /* mov edx, [edx+0x67] */
            ii(0x100c_2e23, 2); add(eax, edx);                          /* add eax, edx */
            ii(0x100c_2e25, 4); movsx(edx, memw[ss, ebp - 0x12]);       /* movsx edx, word [ebp-0x12] */
        ...
        l_0x100c_2e39:
            ...
            ii(0x100c_2e3e, 3); ret(0x8);                               /* ret 0x8 */
        }
    }
}
