...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_8f09()
        {
            ...
            ii(0x1015_8f20, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_8f23, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1015_8f26, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_8f29, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1015_8f2c, 5); mov(eax, 0x1);                          /* mov eax, 0x1 */
            ii(0x1015_8f31, 5); call(0x100f_448c, -0x6_4aaa);           /* call 0x100f448c */
            ii(0x1015_8f36, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_8f39, 4); cmp(memb[ds, eax + 0x57], 0x6);         /* cmp byte [eax+0x57], 0x6 */
            ii(0x1015_8f3d, 2); if(jnz(0x1015_8f48, 0x9)) goto l_0x1015_8f48; /* jnz 0x10158f48 */
            ii(0x1015_8f3f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_8f42, 4); mov(memb[ds, eax + 0x57], 0);           /* mov byte [eax+0x57], 0x0 */
            ii(0x1015_8f46, 2); jmp(0x1015_8f4f, 0x7); goto l_0x1015_8f4f; /* jmp 0x10158f4f */
        l_0x1015_8f48:
            ii(0x1015_8f48, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1015_8f4b, 4); mov(memb[ds, eax + 0x57], 0x6);         /* mov byte [eax+0x57], 0x6 */
        l_0x1015_8f4f:
