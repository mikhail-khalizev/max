...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_c975()
        {
            ...
            ii(0x19_c98c, 5); add(memw[ds, 0x2160], 0x1);               /* add word [0x2160], 0x1 */
        ...
        l_0x19_c9aa:
            ii(0x19_c9aa, 3); push(memw[ss, bp + 0xe]);                 /* push word [bp+0xe] */
            ii(0x19_c9ad, 3); push(memw[ss, bp + 0xc]);                 /* push word [bp+0xc] */
            ii(0x19_c9b0, 3); push(memw[ss, bp + 0xa]);                 /* push word [bp+0xa] */
            ii(0x19_c9b3, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x19_c9b6, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ...
            ii(0x19_c9c8, 3); mov(memw[ss, bp - 0xa], ax);              /* mov [bp-0xa], ax */
            ii(0x19_c9cb, 3); mov(memw[ss, bp - 0x8], dx);              /* mov [bp-0x8], dx */
            ii(0x19_c9ce, 3); mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
            ii(0x19_c9d1, 3); mov(dx, memw[ss, bp + 0x6]);              /* mov dx, [bp+0x6] */
            ii(0x19_c9d4, 4); mov(memw[ds, si + 0x2168], ax);           /* mov [si+0x2168], ax */
            ii(0x19_c9d8, 4); mov(memw[ds, si + 0x216a], dx);           /* mov [si+0x216a], dx */
            ii(0x19_c9dc, 3); mov(ax, memw[ss, bp - 0xa]);              /* mov ax, [bp-0xa] */
            ii(0x19_c9df, 3); mov(dx, memw[ss, bp - 0x8]);              /* mov dx, [bp-0x8] */
        l_0x19_c9e2:
