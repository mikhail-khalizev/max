...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_5ab1()
        {
            ...
            ii(0x5ab6, 4);    cmp(memw[ss, bp + 0x4], 0);               /* cmp word [bp+0x4], 0x0 */
            ii(0x5aba, 2);    if(jnz(0x5ac1, 0x5)) goto l_0x5ac1;       /* jnz 0x5ac1 */
        ...
        l_0x5ac1:
            ...
            ii(0x5ae7, 3);    mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x5aea, 3);    mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ...
            ii(0x5b4d, 3);    mov(cx, memw[ss, bp + 0x4]);              /* mov cx, [bp+0x4] */
            ii(0x5b50, 4);    sub(memw[es, bx + 0x4], cx);              /* sub [es:bx+0x4], cx */
            ii(0x5b54, 4);    mov(si, memw[es, bx + 0x6]);              /* mov si, [es:bx+0x6] */
            ii(0x5b58, 3);    mov(memw[ss, bp - 0x1c], si);             /* mov [bp-0x1c], si */
            ii(0x5b5b, 4);    sub(memw[es, bx + 0x6], cx);              /* sub [es:bx+0x6], cx */
            ii(0x5b5f, 5);    mov(memw[ss, bp - 0x1e], 0xfc);           /* mov word [bp-0x1e], 0xfc */
            ii(0x5b64, 4);    mov(memb[ss, bp - 0x11], 0x87);           /* mov byte [bp-0x11], 0x87 */
            ii(0x5b68, 5);    mov(memw[ss, bp - 0xe], 0x1);             /* mov word [bp-0xe], 0x1 */
            ...
            ii(0x5b84, 4);    sub(ax, memw[es, bx + 0x6]);              /* sub ax, [es:bx+0x6] */
            ii(0x5b88, 3);    mov(memw[ss, bp + 0x4], ax);              /* mov [bp+0x4], ax */
