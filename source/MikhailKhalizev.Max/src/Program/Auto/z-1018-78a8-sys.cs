...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_78a8()
        {
            ...
            ii(0x1018_78c2, 4); fld(memq[ss, esp + 0x8]);               /* fld qword [esp+0x8] */
            ii(0x1018_78c6, 5); call(/* sys */ 0x1018_7823, -0xa8);     /* call 0x10187823 */
            ii(0x1018_78cb, 1); pop(eax);                               /* pop eax */
            ii(0x1018_78cc, 3); ret(0x8); return;                       /* ret 0x8 */
        l_0x1018_78cf:
            ...
            ii(0x1018_78e9, 3); ret(0x8); return;                       /* ret 0x8 */
        l_0x1018_78ec:
            ii(0x1018_78ec, 4); fdiv(memq[ss, esp + 0x8]);              /* fdiv qword [esp+0x8] */
            ii(0x1018_78f0, 1); pop(eax);                               /* pop eax */
            ii(0x1018_78f1, 3); ret(0x8);                               /* ret 0x8 */
        }
    }
}
