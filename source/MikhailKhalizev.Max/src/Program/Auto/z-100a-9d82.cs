...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_9d82()
        {
            ...
            ii(0x100a_9da4, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_9da7, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
            ii(0x100a_9dae, 2); jmp(0x100a_9db6, 0x6); goto l_0x100a_9db6; /* jmp 0x100a9db6 */
        l_0x100a_9db0:
            ii(0x100a_9db0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_9db3, 3); inc(memd[ss, ebp - 0x4]);               /* inc dword [ebp-0x4] */
        l_0x100a_9db6:
            ii(0x100a_9db6, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100a_9dba, 3); cmp(eax, 0x4);                          /* cmp eax, 0x4 */
            ii(0x100a_9dbd, 2); if(jge(0x100a_9df4, 0x35)) goto l_0x100a_9df4; /* jge 0x100a9df4 */
            ii(0x100a_9dbf, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100a_9dd9, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100a_9def, 3); add(memd[ss, ebp - 0x8], eax);          /* add [ebp-0x8], eax */
        l_0x100a_9df2:
            ii(0x100a_9df2, 2); jmp(0x100a_9db0, -0x44); goto l_0x100a_9db0; /* jmp 0x100a9db0 */
        l_0x100a_9df4:
            ii(0x100a_9df4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_9df7, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100a_9dfa, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
