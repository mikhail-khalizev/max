...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_9e06()
        {
            ...
            ii(0x100a_9e1e, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x100a_9e21, 5); mov(eax, 0x2d);                         /* mov eax, 0x2d */
            ii(0x100a_9e26, 5); call(Definitions.sys_new, 0xb_bfd5);    /* call 0x10165e00 */
            ii(0x100a_9e2b, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x100a_9e2e, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100a_9e31, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x100a_9e34, 4); cmp(memd[ss, ebp - 16], 0);             /* cmp dword [ebp-0x10], 0x0 */
            ii(0x100a_9e38, 2); if(jz(0x100a_9e50, 0x16)) goto l_0x100a_9e50; /* jz 0x100a9e50 */
            ii(0x100a_9e3a, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x100a_9e3d, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x100a_9e40, 5); call(0x1009_f304, -0xab41);             /* call 0x1009f304 */
            ii(0x100a_9e45, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x100a_9e48, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x100a_9e4b, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100a_9e4e, 2); jmp(0x100a_9e56, 6); goto l_0x100a_9e56; /* jmp 0x100a9e56 */
        l_0x100a_9e50:
            ii(0x100a_9e50, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x100a_9e53, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
        l_0x100a_9e56:
            ii(0x100a_9e56, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x100a_9e59, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ii(0x100a_9e5c, 5); call(0x1008_b060, -0x1_ee01);           /* call 0x1008b060 */
            ii(0x100a_9e61, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
            ...
            ii(0x100a_9e77, 3); lea(eax, memd[ss, ebp - 24]);           /* lea eax, [ebp-0x18] */
