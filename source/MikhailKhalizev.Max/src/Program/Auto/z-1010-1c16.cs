...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_1c16()
        {
            ...
            ii(0x1010_1c2c, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1010_1c2f, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1010_1c32, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1010_1c35, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_1c38, 3); dec(memw[ds, eax]);                     /* dec word [eax] */
            ii(0x1010_1c3b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_1c3e, 5); add(memw[ds, eax + 0x2], 0x2);          /* add word [eax+0x2], 0x2 */
            ii(0x1010_1c43, 7); mov(memd[ss, ebp - 0x14], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x1010_1c4a, 2); jmp(0x1010_1c50, 0x4); goto l_0x1010_1c50; /* jmp 0x10101c50 */
        l_0x1010_1c4c:
            ii(0x1010_1c4c, 4); add(memd[ss, ebp - 0x14], 0x2);         /* add dword [ebp-0x14], 0x2 */
        l_0x1010_1c50:
            ii(0x1010_1c50, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1010_1c54, 3); cmp(eax, 0x8);                          /* cmp eax, 0x8 */
            ii(0x1010_1c57, 6); if(jge(0x1010_1cdc, 0x7f)) goto l_0x1010_1cdc; /* jge 0x10101cdc */
            ii(0x1010_1c5d, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1010_1c64, 2); jmp(0x1010_1c6c, 0x6); goto l_0x1010_1c6c; /* jmp 0x10101c6c */
        l_0x1010_1c66:
            ii(0x1010_1c66, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1010_1c69, 3); inc(memd[ss, ebp - 0x10]);              /* inc dword [ebp-0x10] */
        l_0x1010_1c6c:
            ii(0x1010_1c6c, 4); movsx(eax, memw[ss, ebp - 0x10]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1010_1c70, 3); cmp(eax, 0x2);                          /* cmp eax, 0x2 */
            ii(0x1010_1c73, 2); if(jge(0x1010_1cc1, 0x4c)) goto l_0x1010_1cc1; /* jge 0x10101cc1 */
            ii(0x1010_1c75, 4); movsx(edx, memw[ss, ebp - 0x14]);       /* movsx edx, word [ebp-0x14] */
            ...
            ii(0x1010_1c83, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1010_1c91, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_1c94, 2); mov(ecx, memd[ds, eax]);                /* mov ecx, [eax] */
            ii(0x1010_1c96, 3); sar(ecx, 0x10);                         /* sar ecx, 0x10 */
            ii(0x1010_1c99, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_1c9c, 3); movsx(ebx, memw[ds, eax]);              /* movsx ebx, word [eax] */
            ii(0x1010_1c9f, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ...
            ii(0x1010_1cb2, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1010_1cb5, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
        ...
        l_0x1010_1cc1:
            ii(0x1010_1cc1, 4); movsx(eax, memw[ss, ebp - 0x14]);       /* movsx eax, word [ebp-0x14] */
            ...
            ii(0x1010_1ccf, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1010_1cdc:
            ii(0x1010_1cdc, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_1cdf, 4); dec(memw[ds, eax + 0x2]);               /* dec word [eax+0x2] */
            ii(0x1010_1ce3, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1010_1ce6, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1010_1ce9, 5); call(0x1007_5e64, -0x8_be8a);           /* call 0x10075e64 */
        l_0x1010_1cee:
            ii(0x1010_1cee, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
