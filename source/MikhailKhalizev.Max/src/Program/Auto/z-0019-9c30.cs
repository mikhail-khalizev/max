...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_9c30()
        {
            ...
            ii(0x19_9c36, 3); mov(memw[ss, bp - 0xa], ax);              /* mov [bp-0xa], ax */
            ii(0x19_9c39, 3); mov(memw[ss, bp - 0xc], ax);              /* mov [bp-0xc], ax */
            ii(0x19_9c3c, 4); mov(es, memw[ds, 0x3fbe]);                /* mov es, [0x3fbe] */
            ii(0x19_9c40, 4); mov(ax, memw[es, 0x3b84]);                /* mov ax, [es:0x3b84] */
            ii(0x19_9c44, 5); mov(memw[ss, bp - 0x8], 0);               /* mov word [bp-0x8], 0x0 */
            ii(0x19_9c49, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
            ii(0x19_9c4c, 5); mov(memw[ss, bp - 0x10], 0);              /* mov word [bp-0x10], 0x0 */
            ii(0x19_9c51, 2); push(-0x1 /* 0xff */);                    /* push 0xffff */
            ii(0x19_9c53, 2); push(-0x1 /* 0xff */);                    /* push 0xffff */
            ...
            ii(0x19_9c62, 2); if(jnz(0x19_9c6a, 0x6)) goto l_0x19_9c6a; /* jnz 0x9c6a */
        l_0x19_9c64:
        ...
        l_0x19_9c6a:
            ...
            ii(0x19_9c73, 5); cmp(memb[ds, 0x19f4], 0x1);               /* cmp byte [0x19f4], 0x1 */
            ii(0x19_9c78, 2); if(jnz(0x19_9c7d, 0x3)) goto l_0x19_9c7d; /* jnz 0x9c7d */
            ii(0x19_9c7a, 3); inc(memw[ss, bp - 0x10]);                 /* inc word [bp-0x10] */
        l_0x19_9c7d:
            ii(0x19_9c7d, 4); cmp(memw[ss, bp - 0x10], 0);              /* cmp word [bp-0x10], 0x0 */
            ii(0x19_9c81, 2); if(jnz(0x19_9cde, 0x5b)) goto l_0x19_9cde; /* jnz 0x9cde */
            ii(0x19_9c83, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x19_9c86, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x19_9c89, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ii(0x19_9c8c, 3); call(0x19_c7eb, 0x2b5c);                  /* call 0xc7eb */
            ii(0x19_9c8f, 3); mov(memw[ss, bp - 0xc], ax);              /* mov [bp-0xc], ax */
            ii(0x19_9c92, 3); mov(memw[ss, bp - 0xa], dx);              /* mov [bp-0xa], dx */
            ii(0x19_9c95, 2); mov(ax, dx);                              /* mov ax, dx */
            ii(0x19_9c97, 3); or(ax, memw[ss, bp - 0xc]);               /* or ax, [bp-0xc] */
            ii(0x19_9c9a, 2); if(jz(0x19_9cd5, 0x39)) goto l_0x19_9cd5; /* jz 0x9cd5 */
            ii(0x19_9c9c, 1); push(dx);                                 /* push dx */
            ii(0x19_9c9d, 3); push(memw[ss, bp - 0xc]);                 /* push word [bp-0xc] */
            ...
            ii(0x19_9cab, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ...
            ii(0x19_9cc7, 3); push(memw[ss, bp - 0xa]);                 /* push word [bp-0xa] */
            ii(0x19_9cca, 3); push(memw[ss, bp - 0xc]);                 /* push word [bp-0xc] */
        ...
        l_0x19_9cd5:
            ii(0x19_9cd5, 3); mov(ax, memw[ss, bp - 0xc]);              /* mov ax, [bp-0xc] */
            ii(0x19_9cd8, 3); mov(dx, memw[ss, bp - 0xa]);              /* mov dx, [bp-0xa] */
            ii(0x19_9cdb, 3); jmp(0x19_9db4, 0xd6); goto l_0x19_9db4;   /* jmp 0x9db4 */
        l_0x19_9cde:
            ii(0x19_9cde, 2); push(0x1);                                /* push 0x1 */
            ii(0x19_9ce0, 3); lea(ax, memw[ss, bp - 0x4]);              /* lea ax, [bp-0x4] */
            ii(0x19_9ce3, 1); push(ss);                                 /* push ss */
            ii(0x19_9ce4, 1); push(ax);                                 /* push ax */
            ii(0x19_9ce5, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x19_9ce8, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x19_9ceb, 3); call(0x19_9bb6, -0x138);                  /* call 0x9bb6 */
            ii(0x19_9cee, 3); mov(memw[ss, bp - 0xe], ax);              /* mov [bp-0xe], ax */
            ii(0x19_9cf1, 2); or(ax, ax);                               /* or ax, ax */
            ii(0x19_9cf3, 2); if(jge(0x19_9cf8, 0x3)) goto l_0x19_9cf8; /* jge 0x9cf8 */
            ii(0x19_9cf5, 3); jmp(0x19_9c64, -0x94); goto l_0x19_9c64;  /* jmp 0x9c64 */
        l_0x19_9cf8:
            ii(0x19_9cf8, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0x19_9cfb, 3); mov(memw[ds, 0x1f22], ax);                /* mov [0x1f22], ax */
            ii(0x19_9cfe, 4); cmp(memw[ss, bp - 0xe], 0);               /* cmp word [bp-0xe], 0x0 */
            ii(0x19_9d02, 2); if(jle(0x19_9d3e, 0x3a)) goto l_0x19_9d3e; /* jle 0x9d3e */
            ii(0x19_9d04, 2); push(0x2);                                /* push 0x2 */
            ii(0x19_9d06, 3); lea(ax, memw[ss, bp - 0x4]);              /* lea ax, [bp-0x4] */
            ...
            ii(0x19_9d16, 2); push(0x9);                                /* push 0x9 */
            ii(0x19_9d18, 3); lea(ax, memw[ss, bp - 0x4]);              /* lea ax, [bp-0x4] */
            ii(0x19_9d1b, 1); push(ss);                                 /* push ss */
            ii(0x19_9d1c, 1); push(ax);                                 /* push ax */
            ii(0x19_9d1d, 3); lea(ax, memw[ss, bp - 0x32]);             /* lea ax, [bp-0x32] */
            ii(0x19_9d20, 1); push(ss);                                 /* push ss */
            ii(0x19_9d21, 1); push(ax);                                 /* push ax */
            ii(0x19_9d22, 3); call(0x19_9bb6, -0x16f);                  /* call 0x9bb6 */
            ii(0x19_9d25, 3); mov(ax, memw[ss, bp - 0x1c]);             /* mov ax, [bp-0x1c] */
            ii(0x19_9d28, 5); mov(memw[ss, bp - 0xc], 0);               /* mov word [bp-0xc], 0x0 */
            ii(0x19_9d2d, 3); mov(memw[ss, bp - 0xa], ax);              /* mov [bp-0xa], ax */
            ii(0x19_9d30, 3); mov(ax, memw[ss, bp - 0x22]);             /* mov ax, [bp-0x22] */
        ...
        l_0x19_9d3e:
            ...
            ii(0x19_9d59, 2); push(0x5);                                /* push 0x5 */
            ii(0x19_9d5b, 3); lea(ax, memw[ss, bp - 0x4]);              /* lea ax, [bp-0x4] */
            ii(0x19_9d5e, 1); push(ss);                                 /* push ss */
            ii(0x19_9d5f, 1); push(ax);                                 /* push ax */
            ii(0x19_9d60, 2); push(0);                                  /* push 0x0 */
            ii(0x19_9d62, 2); push(0x1);                                /* push 0x1 */
            ii(0x19_9d64, 3); call(0x19_9bb6, -0x1b1);                  /* call 0x9bb6 */
            ii(0x19_9d67, 3); mov(memw[ds, 0x2b9c], ax);                /* mov [0x2b9c], ax */
            ii(0x19_9d6a, 3); mov(ax, memw[ss, bp - 0xa]);              /* mov ax, [bp-0xa] */
            ii(0x19_9d6d, 3); or(ax, memw[ss, bp - 0xc]);               /* or ax, [bp-0xc] */
            ...
            ii(0x19_9d79, 3); mov(ax, memw[ss, bp - 0xa]);              /* mov ax, [bp-0xa] */
            ii(0x19_9d7c, 3); mov(memw[ss, bp - 0x1c], ax);             /* mov [bp-0x1c], ax */
            ii(0x19_9d7f, 3); mov(ax, memw[ds, 0x2b9c]);                /* mov ax, [0x2b9c] */
            ii(0x19_9d82, 3); mov(memw[ss, bp - 0x22], ax);             /* mov [bp-0x22], ax */
            ii(0x19_9d85, 2); push(0x6);                                /* push 0x6 */
            ii(0x19_9d87, 3); lea(ax, memw[ss, bp - 0x4]);              /* lea ax, [bp-0x4] */
            ii(0x19_9d8a, 1); push(ss);                                 /* push ss */
            ii(0x19_9d8b, 1); push(ax);                                 /* push ax */
            ii(0x19_9d8c, 3); push(memw[ss, bp - 0xa]);                 /* push word [bp-0xa] */
            ii(0x19_9d8f, 3); push(memw[ss, bp - 0xc]);                 /* push word [bp-0xc] */
            ii(0x19_9d92, 3); call(0x19_9bb6, -0x1df);                  /* call 0x9bb6 */
            ii(0x19_9d95, 2); push(0x8);                                /* push 0x8 */
            ii(0x19_9d97, 3); lea(ax, memw[ss, bp - 0x4]);              /* lea ax, [bp-0x4] */
            ii(0x19_9d9a, 1); push(ss);                                 /* push ss */
            ii(0x19_9d9b, 1); push(ax);                                 /* push ax */
            ii(0x19_9d9c, 3); lea(ax, memw[ss, bp - 0x32]);             /* lea ax, [bp-0x32] */
            ii(0x19_9d9f, 1); push(ss);                                 /* push ss */
            ii(0x19_9da0, 1); push(ax);                                 /* push ax */
            ii(0x19_9da1, 2); jmp(0x19_9dae, 0xb); goto l_0x19_9dae;    /* jmp 0x9dae */
        l_0x19_9da3:
            ii(0x19_9da3, 2); push(0x4);                                /* push 0x4 */
            ii(0x19_9da5, 3); lea(ax, memw[ss, bp - 0x4]);              /* lea ax, [bp-0x4] */
        ...
        l_0x19_9db4:
            ...
            ii(0x19_9db5, 3); ret(0x6);                                 /* ret 0x6 */
        }
    }
}
