...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_34d7()
        {
            ...
            ii(0x1007_34ef, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_34f2, 4); or(memb[ss, ebp - 0x8], 0x1);           /* or byte [ebp-0x8], 0x1 */
            ii(0x1007_34f6, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_34f9, 5); call(0x1007_64fc, 0x2ffe);              /* call 0x100764fc */
            ii(0x1007_34fe, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1007_3501, 4); and(memb[ss, ebp - 0x8], -0x2 /* 0xfe */); /* and byte [ebp-0x8], 0xfe */
            ii(0x1007_3505, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_3508, 5); cmp(memw[ds, eax + 0x8], 0xa);          /* cmp word [eax+0x8], 0xa */
            ...
            ii(0x1007_3519, 3); lea(ebx, memd[ss, ebp - 0x18]);         /* lea ebx, [ebp-0x18] */
        ...
        l_0x1007_3527:
            ...
            ii(0x1007_3531, 3); lea(ebx, memd[ss, ebp - 0x18]);         /* lea ebx, [ebp-0x18] */
        ...
        l_0x1007_353d:
            ii(0x1007_353d, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
        l_0x1007_3544:
            ii(0x1007_3544, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_3546, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x1007_3552, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_3555, 5); call(0x1007_63a0, 0x2e46);              /* call 0x100763a0 */
            ii(0x1007_355a, 4); cmp(memb[ds, eax + 0x3d], 0x10);        /* cmp byte [eax+0x3d], 0x10 */
            ii(0x1007_355e, 2); if(jnz(0x1007_3572, 0x12)) goto l_0x1007_3572; /* jnz 0x10073572 */
            ii(0x1007_3560, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
            ii(0x1007_3563, 5); call(0x1007_63a0, 0x2e38);              /* call 0x100763a0 */
            ii(0x1007_3568, 5); call(0x1007_611c, 0x2baf);              /* call 0x1007611c */
            ii(0x1007_356d, 3); cmp(eax, memd[ss, ebp - 0x4]);          /* cmp eax, [ebp-0x4] */
            ii(0x1007_3570, 2); if(jz(0x1007_3574, 0x2)) goto l_0x1007_3574; /* jz 0x10073574 */
        l_0x1007_3572:
            ii(0x1007_3572, 2); jmp(0x1007_357a, 0x6); goto l_0x1007_357a; /* jmp 0x1007357a */
        l_0x1007_3574:
            ii(0x1007_3574, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1007_3577, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x1007_357a:
            ii(0x1007_357a, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
        ...
        l_0x1007_3584:
            ii(0x1007_3584, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1007_3587, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1007_358a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_358c, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
        ...
        //  ii(0x1007_3598, 3); lea(eax, memd[ss, ebp - 0x18]);         /* lea eax, [ebp-0x18] */
        //  ii(0x1007_359b, 5); call(0x1007_5f6c, 0x29cc);              /* call 0x10075f6c */
        l_0x1007_35a0:
            ii(0x1007_35a0, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
