...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_2f25()
        {
            ...
            ii(0x1007_2f42, 4); or(memb[ss, ebp - 12], 1);              /* or byte [ebp-0xc], 0x1 */
            ii(0x1007_2f46, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x1007_2f49, 5); call(0x1007_64fc, 0x35ae);              /* call 0x100764fc */
            ii(0x1007_2f4e, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1007_2f51, 4); and(memb[ss, ebp - 12], -2 /* 0xfe */); /* and byte [ebp-0xc], 0xfe */
            ...
            ii(0x1007_2f5f, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
        ...
        l_0x1007_2f69:
            ii(0x1007_2f69, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x1007_2f6c, 5); call(0x1007_6bf8, 0x3c87);              /* call 0x10076bf8 */
        l_0x1007_2f71:
            ii(0x1007_2f71, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_2f73, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ...
            ii(0x1007_2f83, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x1007_2f86, 5); call(0x1007_63a0, 0x3415);              /* call 0x100763a0 */
            ii(0x1007_2f8b, 5); call(0x1007_6188, 0x31f8);              /* call 0x10076188 */
            ii(0x1007_2f90, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x1007_2f93, 4); cmp(memd[ss, ebp - 24], 0);             /* cmp dword [ebp-0x18], 0x0 */
            ii(0x1007_2f97, 2); if(jz(0x1007_2fcc, 0x33)) goto l_0x1007_2fcc; /* jz 0x10072fcc */
            ii(0x1007_2f99, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x1007_2f9c, 5); call(0x1007_63a0, 0x33ff);              /* call 0x100763a0 */
            ii(0x1007_2fa1, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_2fa3, 3); mov(dl, memb[ds, eax + 38]);            /* mov dl, [eax+0x26] */
            ...
            ii(0x1007_2fae, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x1007_2fb1, 5); call(0x1007_6408, 0x3452);              /* call 0x10076408 */
            ii(0x1007_2fb6, 3); cmp(eax, memd[ss, ebp - 24]);           /* cmp eax, [ebp-0x18] */
        ...
        l_0x1007_2fbd:
            ...
            ii(0x1007_2fbf, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
        ...
        l_0x1007_2fcc:
            ii(0x1007_2fcc, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x1007_2fcf, 5); call(0x1007_63a0, 0x33cc);              /* call 0x100763a0 */
            ii(0x1007_2fd4, 4); cmp(memb[ds, eax + 61], 2);             /* cmp byte [eax+0x3d], 0x2 */
            ii(0x1007_2fd8, 2); if(jz(0x1007_2fe8, 0xe)) goto l_0x1007_2fe8; /* jz 0x10072fe8 */
            ii(0x1007_2fda, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x1007_2fdd, 5); call(0x1007_63a0, 0x33be);              /* call 0x100763a0 */
            ii(0x1007_2fe2, 4); cmp(memb[ds, eax + 61], 0x1b);          /* cmp byte [eax+0x3d], 0x1b */
        ...
        l_0x1007_2fea:
            ii(0x1007_2fea, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x1007_2fed, 5); call(0x1007_63a0, 0x33ae);              /* call 0x100763a0 */
            ii(0x1007_2ff2, 4); cmp(memb[ds, eax + 61], 0x1e);          /* cmp byte [eax+0x3d], 0x1e */
            ii(0x1007_2ff6, 2); if(jnz(0x1007_3006, 0xe)) goto l_0x1007_3006; /* jnz 0x10073006 */
        l_0x1007_2ff8:
            ii(0x1007_2ff8, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x1007_2ffb, 5); call(0x1007_63a0, 0x33a0);              /* call 0x100763a0 */
            ii(0x1007_3000, 4); cmp(memb[ds, eax + 62], 1);             /* cmp byte [eax+0x3e], 0x1 */
        ...
        l_0x1007_3008:
            ii(0x1007_3008, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x1007_300b, 5); call(0x1007_63a0, 0x3390);              /* call 0x100763a0 */
            ii(0x1007_3010, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_3012, 3); mov(dl, memb[ds, eax + 38]);            /* mov dl, [eax+0x26] */
        ...
        l_0x1007_301f:
            ii(0x1007_301f, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x1007_3022, 5); call(0x1007_63a0, 0x3379);              /* call 0x100763a0 */
            ii(0x1007_3027, 4); cmp(memb[ds, eax + 78], 0);             /* cmp byte [eax+0x4e], 0x0 */
        ...
        l_0x1007_302f:
            ii(0x1007_302f, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x1007_3032, 5); call(0x1007_63a0, 0x3369);              /* call 0x100763a0 */
            ii(0x1007_3037, 3); mov(al, memb[ds, eax + 96]);            /* mov al, [eax+0x60] */
        ...
        l_0x1007_3046:
            ...
            ii(0x1007_3048, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x1007_304b, 5); call(0x1007_63a0, 0x3350);              /* call 0x100763a0 */
            ii(0x1007_3050, 3); mov(edx, memd[ds, eax + 58]);           /* mov edx, [eax+0x3a] */
            ii(0x1007_3053, 3); sar(edx, 0x18);                         /* sar edx, 0x18 */
            ii(0x1007_3056, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
        ...
        l_0x1007_3068:
            ...
            ii(0x1007_306a, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
