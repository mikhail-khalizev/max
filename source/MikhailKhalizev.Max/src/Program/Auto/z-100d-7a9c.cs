...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("8e31e5ae-e7c2-47ee-a96b-8a40d38af4fc")]
        public void Method_100d_7a9c()
        {
            ii(0x100d_7a9c, 5); pushd(0x34);                            /* push 0x34 */
            ii(0x100d_7aa1, 5); calld(Definitions.sys_check_available_stack_size, 0x8e2ac); /* call 0x10165d52 */
            ...
            ii(0x100d_7ac4, 5); calld(0x1007_64fc, -0x615cd);           /* call 0x100764fc */
            ...
            ii(0x100d_7af3, 5); calld(0x1007_6338, -0x617c0);           /* call 0x10076338 */
            ii(0x100d_7af8, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100d_7afa, 3); lea(eax, ebp - 0x18);                   /* lea eax, [ebp-0x18] */
            ii(0x100d_7afd, 5); calld(0x1007_643c, -0x616c6);           /* call 0x1007643c */
        ...
        l_0x100d_7b04:
            ...
            ii(0x100d_7b07, 5); calld(0x1007_6bf8, -0x60f14);           /* call 0x10076bf8 */
        l_0x100d_7b0c:
            ii(0x100d_7b0c, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100d_7b0e, 3); lea(eax, ebp - 0x18);                   /* lea eax, [ebp-0x18] */
            ii(0x100d_7b11, 5); calld(0x1013_ad71, 0x6325b);            /* call 0x1013ad71 */
        ...
        l_0x100d_7b3b:
            ...
            ii(0x100d_7b3e, 5); calld(0x1007_63a0, -0x617a3);           /* call 0x100763a0 */
            ii(0x100d_7b43, 5); calld(0x1007_6204, -0x61944);           /* call 0x10076204 */
            ...
            ii(0x100d_7b54, 5); calld(0x1007_63a0, -0x617b9);           /* call 0x100763a0 */
        ...
        l_0x100d_7b6d:
            ...
            ii(0x100d_7b73, 5); calld(0x1007_6408, -0x61770);           /* call 0x10076408 */
        ...
        l_0x100d_7b7f:
            ...
            ii(0x100d_7b85, 5); calld(0x1007_6408, -0x61782);           /* call 0x10076408 */
        ...
        l_0x100d_7b91:
            ...
            ii(0x100d_7b97, 5); calld(0x1007_6408, -0x61794);           /* call 0x10076408 */
        ...
        l_0x100d_7bcc:
            ...
            ii(0x100d_7bd1, 5); calld(0x1007_5f6c, -0x61c6a);           /* call 0x10075f6c */
            ...
            ii(0x100d_7bdb, 1); retd(); return;                         /* ret */
        }
    }
}
