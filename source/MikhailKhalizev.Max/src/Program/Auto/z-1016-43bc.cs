...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_43bc()
        {
            ...
            ii(0x1016_43d4, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1016_43d7, 5); call(0x1016_4980, 0x5a4);               /* call 0x10164980 */
            ii(0x1016_43dc, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1016_43df, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1016_43e2, 5); call(0x1016_4918, 0x531);               /* call 0x10164918 */
            ii(0x1016_43e7, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1016_43ea, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
