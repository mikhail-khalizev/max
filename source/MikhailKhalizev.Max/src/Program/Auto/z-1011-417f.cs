...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_417f()
        {
            ...
            ii(0x1011_4196, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_4199, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x1011_419c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_419f, 7); cmp(memb[ds, eax + 0x51f], 0);          /* cmp byte [eax+0x51f], 0x0 */
            ii(0x1011_41a6, 6); if(jz(0x1011_4362, 0x1b6)) goto l_0x1011_4362; /* jz 0x10114362 */
            ii(0x1011_41ac, 4); cmp(memb[ss, ebp - 0x4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ii(0x1011_41b0, 2); if(jnz(0x1011_41c2, 0x10)) goto l_0x1011_41c2; /* jnz 0x101141c2 */
            ii(0x1011_41b2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_41b5, 7); cmp(memb[ds, eax + 0x51e], 0);          /* cmp byte [eax+0x51e], 0x0 */
        ...
        l_0x1011_41c2:
            ...
            ii(0x1011_41da, 6); lea(ebx, memd[ss, ebp - 0xb8]);         /* lea ebx, [ebp-0xb8] */
            ii(0x1011_41e0, 5); mov(edx, 0x4);                          /* mov edx, 0x4 */
            ii(0x1011_41e5, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_41e8, 6); mov(al, memb[ds, eax + 0x598]);         /* mov al, [eax+0x598] */
            ii(0x1011_41ee, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1011_41f0, 1); cwde();                                 /* cwde */
            ii(0x1011_41f1, 5); call(0x1013_9ade, 0x2_58e8);            /* call 0x10139ade */
            ii(0x1011_41f6, 3); mov(eax, memd[ss, ebp - 0x12]);         /* mov eax, [ebp-0x12] */
            ii(0x1011_41f9, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_41fc, 6); cmp(eax, memd[ds, edx + 0x599]);        /* cmp eax, [edx+0x599] */
            ...
            ii(0x1011_421c, 6); lea(ebx, memd[ss, ebp - 0xb8]);         /* lea ebx, [ebp-0xb8] */
            ii(0x1011_4222, 5); mov(edx, 0x9);                          /* mov edx, 0x9 */
            ii(0x1011_4227, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_422a, 6); mov(al, memb[ds, eax + 0x598]);         /* mov al, [eax+0x598] */
            ii(0x1011_4230, 2); xor(ah, ah);                            /* xor ah, ah */
            ii(0x1011_4232, 1); cwde();                                 /* cwde */
            ii(0x1011_4233, 5); call(0x1013_9ade, 0x2_58a6);            /* call 0x10139ade */
        l_0x1011_4238:
            ii(0x1011_4238, 3); mov(eax, memd[ss, ebp - 0x12]);         /* mov eax, [ebp-0x12] */
            ii(0x1011_423b, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_423e, 6); cmp(eax, memd[ds, edx + 0x599]);        /* cmp eax, [edx+0x599] */
            ii(0x1011_4244, 6); if(jnz(0x1011_432d, 0xe3)) goto l_0x1011_432d; /* jnz 0x1011432d */
            ii(0x1011_424a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_424d, 4); mov(memb[ds, eax + 0x13], 0);           /* mov byte [eax+0x13], 0x0 */
            ii(0x1011_4251, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_4254, 7); cmp(memb[ds, eax + 0x51e], 0);          /* cmp byte [eax+0x51e], 0x0 */
            ii(0x1011_425b, 2); if(jz(0x1011_4292, 0x35)) goto l_0x1011_4292; /* jz 0x10114292 */
            ii(0x1011_425d, 7); mov(memb[ss, ebp - 0xbc], 0x4);         /* mov byte [ebp-0xbc], 0x4 */
        l_0x1011_4264:
            ii(0x1011_4264, 6); dec(memb[ss, ebp - 0xbc]);              /* dec byte [ebp-0xbc] */
            ii(0x1011_426a, 7); cmp(memb[ss, ebp - 0xbc], -0x1 /* 0xff */); /* cmp byte [ebp-0xbc], 0xff */
            ii(0x1011_4271, 2); if(jz(0x1011_4288, 0x15)) goto l_0x1011_4288; /* jz 0x10114288 */
            ii(0x1011_4273, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1011_4275, 6); mov(al, memb[ss, ebp - 0xbc]);          /* mov al, [ebp-0xbc] */
            ii(0x1011_427b, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x1011_427e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1011_4288:
            ii(0x1011_4288, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_428b, 7); mov(memb[ds, eax + 0x51e], 0);          /* mov byte [eax+0x51e], 0x0 */
        l_0x1011_4292:
            ii(0x1011_4292, 7); mov(memb[ss, ebp - 0xbc], 0x4);         /* mov byte [ebp-0xbc], 0x4 */
        l_0x1011_4299:
            ii(0x1011_4299, 6); dec(memb[ss, ebp - 0xbc]);              /* dec byte [ebp-0xbc] */
            ii(0x1011_429f, 7); cmp(memb[ss, ebp - 0xbc], -0x1 /* 0xff */); /* cmp byte [ebp-0xbc], 0xff */
            ii(0x1011_42a6, 2); if(jz(0x1011_42cc, 0x24)) goto l_0x1011_42cc; /* jz 0x101142cc */
            ii(0x1011_42a8, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1011_42aa, 6); mov(al, memb[ss, ebp - 0xbc]);          /* mov al, [ebp-0xbc] */
            ii(0x1011_42b0, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_42b2, 4); mov(dl, memb[ds, eax + ebp - 0x17]);    /* mov dl, [eax+ebp-0x17] */
            ii(0x1011_42b6, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1011_42b8, 6); mov(al, memb[ss, ebp - 0xbc]);          /* mov al, [ebp-0xbc] */
            ii(0x1011_42be, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x1011_42c0, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x1011_42c3, 7); mov(memw[ds, eax + 0x4e4], dx);         /* mov [eax+0x4e4], dx */
        ...
        l_0x1011_42cc:
            ...
            ii(0x1011_42db, 6); lea(edx, memd[ss, ebp - 0xb8]);         /* lea edx, [ebp-0xb8] */
            ii(0x1011_42e1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1011_42eb:
            ...
            ii(0x1011_42ed, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_42f0, 3); mov(al, memb[ds, edx + 0x11]);          /* mov al, [edx+0x11] */
            ii(0x1011_42f3, 6); mov(memd[ss, ebp - 0xc0], eax);         /* mov [ebp-0xc0], eax */
            ii(0x1011_42f9, 7); movsx(edx, memw[ss, ebp - 0xc0]);       /* movsx edx, word [ebp-0xc0] */
            ii(0x1011_4300, 6); cmp(edx, 0xff);                         /* cmp edx, 0xff */
            ii(0x1011_4306, 2); if(jnz(0x1011_4312, 0xa)) goto l_0x1011_4312; /* jnz 0x10114312 */
            ii(0x1011_4308, 10); mov(memd[ss, ebp - 0xc0], 0);          /* mov dword [ebp-0xc0], 0x0 */
        l_0x1011_4312:
            ii(0x1011_4312, 7); movsx(edx, memw[ss, ebp - 0xc0]);       /* movsx edx, word [ebp-0xc0] */
            ii(0x1011_4319, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_431c, 5); call(0x1011_3d56, -0x5cb);              /* call 0x10113d56 */
        l_0x1011_4321:
            ii(0x1011_4321, 10); mov(memd[ss, ebp - 0xc4], 0x1);        /* mov dword [ebp-0xc4], 0x1 */
        ...
        l_0x1011_432d:
            ...
            ii(0x1011_4352, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_4355, 4); mov(memb[ds, eax + 0x13], 0x1);         /* mov byte [eax+0x13], 0x1 */
            ii(0x1011_4359, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_435c, 4); mov(memb[ds, eax + 0xb], 0);            /* mov byte [eax+0xb], 0x0 */
        l_0x1011_4360:
        ...
        l_0x1011_4362:
            ...
            ii(0x1011_436f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_4372, 5); call(0x1011_4119, -0x25e);              /* call 0x10114119 */
            ii(0x1011_4377, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_437a, 4); mov(memb[ds, eax + 0x13], 0);           /* mov byte [eax+0x13], 0x0 */
        l_0x1011_437e:
            ii(0x1011_437e, 10); mov(memd[ss, ebp - 0xc4], 0);          /* mov dword [ebp-0xc4], 0x0 */
        l_0x1011_4388:
            ii(0x1011_4388, 6); mov(eax, memd[ss, ebp - 0xc4]);         /* mov eax, [ebp-0xc4] */
