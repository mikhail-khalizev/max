...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_bbe8()
        {
            ...
            ii(0x1016_bbf1, 4);  mov(ebx, memd[ss, esp + 16]);         /* mov ebx, [esp+0x10] */
            ii(0x1016_bbf5, 2);  mov(edx, ecx);                        /* mov edx, ecx */
            ii(0x1016_bbf7, 2);  xor(eax, eax);                        /* xor eax, eax */
            ii(0x1016_bbf9, 4);  mov(al, memb[ss, esp + 28]);          /* mov al, [esp+0x1c] */
            ii(0x1016_bbfd, 1);  push(eax);                            /* push eax */
            ii(0x1016_bbfe, 4);  mov(ecx, memd[ss, esp + 28]);         /* mov ecx, [esp+0x1c] */
            ii(0x1016_bc02, 1);  push(ecx);                            /* push ecx */
            ii(0x1016_bc03, 4);  mov(eax, memd[ss, esp + 28]);         /* mov eax, [esp+0x1c] */
            ...
            ii(0x1016_bc19, 3);  cmp(eax, -1 /* 0xff */);              /* cmp eax, 0xffffffff */
            ii(0x1016_bc1c, 2);  if(jz(0x1016_bc45, 0x27)) goto l_0x1016_bc45;/* jz 0x1016bc45 */
            ii(0x1016_bc1e, 4);  mov(eax, memd[ss, esp + 32]);         /* mov eax, [esp+0x20] */
