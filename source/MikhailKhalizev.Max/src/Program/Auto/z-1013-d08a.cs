...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_d08a()
        {
            ...
            ii(0x1013_d0a2, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1013_d0a5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_d0a8, 5); call(0x1013_d111, 0x64);                /* call 0x1013d111 */
            ii(0x1013_d0ad, 7); mov(memd[ss, ebp - 0x8], 0x14);         /* mov dword [ebp-0x8], 0x14 */
        l_0x1013_d0b4:
            ii(0x1013_d0b4, 3); dec(memd[ss, ebp - 0x8]);               /* dec dword [ebp-0x8] */
            ii(0x1013_d0b7, 5); cmp(memw[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp word [ebp-0x8], 0xffff */
            ii(0x1013_d0bc, 2); if(jz(0x1013_d0ee, 0x30)) goto l_0x1013_d0ee; /* jz 0x1013d0ee */
            ii(0x1013_d0be, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1013_d0c2, 6); imul(eax, eax, 0x91);                   /* imul eax, eax, 0x91 */
            ii(0x1013_d0c8, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1013_d0cb, 6); add(edx, 0x251);                        /* add edx, 0x251 */
            ii(0x1013_d0d1, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1013_d0d3, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x1013_d0d6, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1013_d0e1, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1013_d0e4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1013_d0ee:
            ii(0x1013_d0ee, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_d0f1, 4); mov(memb[ds, eax + 0x20], 0);           /* mov byte [eax+0x20], 0x0 */
            ii(0x1013_d0f5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_d0f8, 7); mov(memd[ds, eax + 0x4], 0);            /* mov dword [eax+0x4], 0x0 */
            ii(0x1013_d0ff, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_d102, 6); mov(memw[ds, eax + 0x10], 0xffff);      /* mov word [eax+0x10], 0xffff */
