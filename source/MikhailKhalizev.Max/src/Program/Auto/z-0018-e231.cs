...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_e231()
        {
            ...
            ii(0x18_e236, 3); mov(ax, memw[ds, bx + 0x2]);              /* mov ax, [bx+0x2] */
            ii(0x18_e239, 4); mov(memw_a32[ss, ebp + 0x18], ax);        /* mov [ebp+0x18], ax */
            ii(0x18_e23d, 3); mov(al, memb[ds, bx + 0x4]);              /* mov al, [bx+0x4] */
            ii(0x18_e240, 3); mov(ah, memb[ds, bx + 0x7]);              /* mov ah, [bx+0x7] */
