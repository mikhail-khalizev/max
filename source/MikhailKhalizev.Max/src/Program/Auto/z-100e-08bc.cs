...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("5374769f-82b8-426d-97df-70ebc7d91bcc")]
        public void Method_100e_08bc()
        {
            ii(0x100e_08bc, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x100e_08c1, 5); calld(Definitions.sys_check_available_stack_size, 0x8548c); /* call 0x10165d52 */
            ...
            ii(0x100e_08e0, 5); calld(0x1008_b410, -0x554d5);           /* call 0x1008b410 */
            ii(0x100e_08e5, 3); add(eax, 0x6);                          /* add eax, 0x6 */
            ii(0x100e_08e8, 5); calld(0x1008_b440, -0x554ad);           /* call 0x1008b440 */
