...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_ce23()
        {
            ...
            ii(0x1008_ce3b, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_ce3e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_ce41, 3); mov(eax, memd[ds, eax + 0x22]);         /* mov eax, [eax+0x22] */
            ii(0x1008_ce44, 3); sar(eax, 0x18);                         /* sar eax, 0x18 */
            ii(0x1008_ce47, 3); cmp(eax, 0x9);                          /* cmp eax, 0x9 */
            ii(0x1008_ce4a, 2); if(jl(0x1008_ce52, 0x6)) goto l_0x1008_ce52; /* jl 0x1008ce52 */
            ii(0x1008_ce4c, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x1008_ce50, 2); jmp(0x1008_ce56, 0x4); goto l_0x1008_ce56; /* jmp 0x1008ce56 */
        l_0x1008_ce52:
            ii(0x1008_ce52, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x1008_ce56:
            ii(0x1008_ce56, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
            ii(0x1008_ce59, 3); mov(memb[ss, ebp - 0xc], al);           /* mov [ebp-0xc], al */
            ii(0x1008_ce5c, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
