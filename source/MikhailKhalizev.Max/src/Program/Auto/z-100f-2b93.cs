...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_2b93()
        {
            ...
            ii(0x100f_2baa, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100f_2bad, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100f_2bb0, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_2bb3, 5);  call(Definitions.sys_strlen, 0x7_f30f);/* call 0x10171ec7 */
            ii(0x100f_2bb8, 3);  lea(ebx, memd[ds, eax + 1]);          /* lea ebx, [eax+0x1] */
            ii(0x100f_2bbb, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x100f_2bbe, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_2bc1, 5);  call(Definitions.sys_strlen, 0x7_f301);/* call 0x10171ec7 */
            ii(0x100f_2bc6, 3);  add(eax, memd[ss, ebp - 4]);          /* add eax, [ebp-0x4] */
            ii(0x100f_2bc9, 5);  call(/* sys */ 0x1016_6177, 0x7_35a9);/* call 0x10166177 */
            ii(0x100f_2bce, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100f_2bd1, 5);  call(Definitions.sys_strlen, 0x7_f2f1);/* call 0x10171ec7 */
            ii(0x100f_2bd6, 2);  mov(ebx, eax);                        /* mov ebx, eax */
            ii(0x100f_2bd8, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ii(0x100f_2bdb, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_2bde, 5);  call(Definitions.sys_memcpy, 0x7_3268);/* call 0x10165e4b */
            ii(0x100f_2be3, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_2be6, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100f_2be9, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
