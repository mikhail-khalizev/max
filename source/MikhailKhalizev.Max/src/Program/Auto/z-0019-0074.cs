...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("aed6e647-890f-46e0-afd0-1e9dd2a560f4")]
        public void Method_0019_0074()
        {
            ii(0x19_0074, 4); enterw(0, 0);                             /* enter 0x0, 0x0 */
            ii(0x19_0078, 1); pushw(si);                                /* push si */
            ii(0x19_0079, 1); pushw(di);                                /* push di */
            ii(0x19_007a, 1); pushw(ds);                                /* push ds */
            ii(0x19_007b, 5); movzx(edi, memw_a16[ss, bp + 0x6]);       /* movzx edi, word [bp+0x6] */
            ii(0x19_0080, 5); movzx(esi, memw_a16[ss, bp + 0x8]);       /* movzx esi, word [bp+0x8] */
            ...
            ii(0x19_0096, 4); if(jzw(0x19_0120, 0x86)) goto l_0x19_0120; /* jz 0x120 */
        ...
        //  ii(0x19_010a, 22); Недостижимый (и не декодированный) код.
        l_0x19_0120:
