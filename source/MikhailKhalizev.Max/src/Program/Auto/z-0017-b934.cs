...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_b934()
        {
            ...
            ii(0x17_b960, 6); mov(memw[es, bx + 0x20], 0x8025);         /* mov word [es:bx+0x20], 0x8025 */
            ii(0x17_b966, 6); mov(memw[es, bx + 0x22], 0);              /* mov word [es:bx+0x22], 0x0 */
            ii(0x17_b96c, 5); or(memb[es, bx + 0x2c], 0x1);             /* or byte [es:bx+0x2c], 0x1 */
        ...
        l_0x17_b97d:
            ...
            ii(0x17_b982, 2); if(ja(0x17_b988, 0x4)) goto l_0x17_b988;  /* ja 0xb988 */
            ii(0x17_b984, 2); or(cx, cx);                               /* or cx, cx */
            ii(0x17_b986, 2); if(jz(0x17_b9a2, 0x1a)) goto l_0x17_b9a2; /* jz 0xb9a2 */
        l_0x17_b988:
            ii(0x17_b988, 3); mov(es, memw[ss, bp + 0x8]);              /* mov es, [bp+0x8] */
            ii(0x17_b98b, 6); mov(memw[es, bx + 0x20], 0x8025);         /* mov word [es:bx+0x20], 0x8025 */
            ii(0x17_b991, 6); mov(memw[es, bx + 0x22], 0);              /* mov word [es:bx+0x22], 0x0 */
            ii(0x17_b997, 5); or(memb[es, bx + 0x2c], 0x1);             /* or byte [es:bx+0x2c], 0x1 */
        ...
        l_0x17_b9a2:
            ...
            ii(0x17_b9a4, 3); mov(dx, memw[ss, bp - 0xc]);              /* mov dx, [bp-0xc] */
            ...
            ii(0x17_b9c2, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
            ii(0x17_b9c5, 2); sub(ax, ax);                              /* sub ax, ax */
            ii(0x17_b9c7, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x17_b9ca, 3); mov(memw[ss, bp - 0xa], ax);              /* mov [bp-0xa], ax */
            ii(0x17_b9cd, 2); jmp(0x17_b9d8, 0x9); goto l_0x17_b9d8;    /* jmp 0xb9d8 */
        //  ii(0x17_b9cf, 1); nop();                                    /* nop */
        l_0x17_b9d0:
            ii(0x17_b9d0, 4); add(memw[ss, bp - 0xa], 0x1);             /* add word [bp-0xa], 0x1 */
            ii(0x17_b9d4, 4); adc(memw[ss, bp - 0x8], 0);               /* adc word [bp-0x8], 0x0 */
        l_0x17_b9d8:
            ii(0x17_b9d8, 4); cmp(memw[ss, bp - 0x8], 0);               /* cmp word [bp-0x8], 0x0 */
            ii(0x17_b9dc, 2); if(jz(0x17_b9e1, 0x3)) goto l_0x17_b9e1;  /* jz 0xb9e1 */
            ii(0x17_b9de, 3); jmp(0x17_bad0, 0xef); goto l_0x17_bad0;   /* jmp 0xbad0 */
        l_0x17_b9e1:
            ii(0x17_b9e1, 4); cmp(memw[ss, bp - 0xa], 0x14);            /* cmp word [bp-0xa], 0x14 */
            ii(0x17_b9e5, 2); if(jb(0x17_b9ea, 0x3)) goto l_0x17_b9ea;  /* jb 0xb9ea */
            ii(0x17_b9e7, 3); jmp(0x17_bad0, 0xe6); goto l_0x17_bad0;   /* jmp 0xbad0 */
        l_0x17_b9ea:
            ii(0x17_b9ea, 3); mov(ax, memw[ss, bp - 0x6]);              /* mov ax, [bp-0x6] */
            ii(0x17_b9ed, 3); mov(bx, memw[ss, bp - 0xa]);              /* mov bx, [bp-0xa] */
            ii(0x17_b9f0, 3); shl(bx, 0x2);                             /* shl bx, 0x2 */
            ii(0x17_b9f3, 4); cmp(memw[ds, bx + 0x12ca], ax);           /* cmp [bx+0x12ca], ax */
            ii(0x17_b9f7, 2); if(jz(0x17_b9fc, 0x3)) goto l_0x17_b9fc;  /* jz 0xb9fc */
        ...
        l_0x17_ba06:
            ...
            ii(0x17_ba63, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_ba66, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x17_ba69, 4); mov(ax, memw[ds, si + 0x12cc]);           /* mov ax, [si+0x12cc] */
            ii(0x17_ba6d, 1); cwd();                                    /* cwd */
            ii(0x17_ba6e, 3); mov(memw[ss, bp - 0x12], ax);             /* mov [bp-0x12], ax */
            ii(0x17_ba71, 3); mov(memw[ss, bp - 0x10], dx);             /* mov [bp-0x10], dx */
            ii(0x17_ba74, 2); jmp(0x17_ba81, 0xb); goto l_0x17_ba81;    /* jmp 0xba81 */
        l_0x17_ba76:
            ii(0x17_ba76, 4); sub(memw[ss, bp - 0x12], 0x1);            /* sub word [bp-0x12], 0x1 */
            ii(0x17_ba7a, 4); sbb(memw[ss, bp - 0x10], 0);              /* sbb word [bp-0x10], 0x0 */
            ii(0x17_ba7e, 3); inc(memw[ss, bp - 0x6]);                  /* inc word [bp-0x6] */
        l_0x17_ba81:
            ii(0x17_ba81, 4); cmp(memw[ss, bp - 0x10], 0);              /* cmp word [bp-0x10], 0x0 */
            ii(0x17_ba85, 2); if(jnz(0x17_ba8d, 0x6)) goto l_0x17_ba8d; /* jnz 0xba8d */
            ii(0x17_ba87, 4); cmp(memw[ss, bp - 0x12], 0);              /* cmp word [bp-0x12], 0x0 */
        ...
        l_0x17_ba8d:
            ...
            ii(0x17_baa3, 6); mov(memw[es, bx + si + 0x2], 0);          /* mov word [es:bx+si+0x2], 0x0 */
            ii(0x17_baa9, 4); and(memb[es, bx + si], -0x7 /* 0xf9 */);  /* and byte [es:bx+si], 0xf9 */
            ii(0x17_baad, 2); jmp(0x17_ba76, -0x39); goto l_0x17_ba76;  /* jmp 0xba76 */
        //  ii(0x17_baaf, 1); nop();                                    /* nop */
        l_0x17_bab0:
            ii(0x17_bab0, 3); push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ii(0x17_bab3, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
