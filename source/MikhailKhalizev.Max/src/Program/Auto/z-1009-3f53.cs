...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_3f53()
        {
            ...
            ii(0x1009_3f7f, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1009_3f82, 4); movsx(eax, memw[ss, ebp - 12]);         /* movsx eax, word [ebp-0xc] */
        ...
        l_0x1009_3f90:
            ii(0x1009_3f90, 7); mov(memd[ss, ebp - 16], 0);             /* mov dword [ebp-0x10], 0x0 */
            ii(0x1009_3f97, 2); jmp(0x1009_3f9f, 6); goto l_0x1009_3f9f; /* jmp 0x10093f9f */
        l_0x1009_3f99:
            ii(0x1009_3f99, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1009_3f9c, 3); inc(memd[ss, ebp - 16]);                /* inc dword [ebp-0x10] */
        l_0x1009_3f9f:
            ii(0x1009_3f9f, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x1009_3fa3, 3); cmp(eax, 4);                            /* cmp eax, 0x4 */
            ii(0x1009_3fa6, 2); if(jge(0x1009_3fe1, 0x39)) goto l_0x1009_3fe1; /* jge 0x10093fe1 */
            ii(0x1009_3fa8, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x1009_3fc1, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x1009_3fc5, 6); imul(eax, eax, 0x247);                  /* imul eax, eax, 0x247 */
            ii(0x1009_3fcb, 4); movsx(edx, memw[ss, ebp - 12]);         /* movsx edx, word [ebp-0xc] */
