...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_3b40()
        {
            ...
            ii(0x100a_3b52, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x100a_3b58, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_3b5b, 7);  mov(memd[ss, ebp - 8], 2);            /* mov dword [ebp-0x8], 0x2 */
            ii(0x100a_3b62, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
