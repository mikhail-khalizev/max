...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_486b()
        {
            ...
            ii(0x1011_4883, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_4886, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_4889, 4); mov(memb[ds, eax + 0xb], 0x2);          /* mov byte [eax+0xb], 0x2 */
            ii(0x1011_488d, 5); call(0x1012_ab2f, 0x1_629d);            /* call 0x1012ab2f */
            ii(0x1011_4892, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
