...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("c1616f12-1ff4-46fb-a156-9ed9bd7261d6")]
        ...
        l_0x1018_e8dc:
            ...
            ii(0x1018_e8e7, 2); if(jsd(0x1018_e90f, 0x26)) goto l_0x1018_e90f; /* js 0x1018e90f */
            ii(0x1018_e8e9, 3); mov(ebx, memd_a32[ss, ebp + 0x8]);      /* mov ebx, [ebp+0x8] */
            ii(0x1018_e8ec, 2); mov(al, memb_a32[ds, ebx]);             /* mov al, [ebx] */
            ii(0x1018_e8ee, 1); inc(ebx);                               /* inc ebx */
            ii(0x1018_e8ef, 3); mov(memd_a32[ss, ebp + 0x8], ebx);      /* mov [ebp+0x8], ebx */
            ...
            ii(0x1018_e8fc, 5); pushd(/* sys */ 0x1018_e8e4);           /* push 0x1018e8e4 */
            ii(0x1018_e901, 7); pushd(memd_a32[ds, ebx * 4 + 0x101b_f910]); /* push dword [ebx*4+0x101bf910] */
            ii(0x1018_e908, 7); if(jmpd_abs(memd_a32[ds, eax * 4 + 0x101b_f910])) return; /* jmp dword [eax*4+0x101bf910] */
        l_0x1018_e90f:
            ii(0x1018_e90f, 3); add(edi, memd_a32[ss, ebp - 0x8]);      /* add edi, [ebp-0x8] */
            ii(0x1018_e912, 3); dec(memd_a32[ss, ebp + 0x1c]);          /* dec dword [ebp+0x1c] */
            ii(0x1018_e915, 2); if(jnzd(0x1018_e8dc, -0x3b)) goto l_0x1018_e8dc; /* jnz 0x1018e8dc */
            ii(0x1018_e917, 1); popd(ebx);                              /* pop ebx */
            ii(0x1018_e918, 1); popd(edi);                              /* pop edi */
            ii(0x1018_e919, 1); popd(esi);                              /* pop esi */
            ii(0x1018_e91a, 1); leaved();                               /* leave */
            ii(0x1018_e91b, 1); retd(); return;                         /* ret */
        }
    }
}
