...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_e840()
        {
            ...
            ii(0x1018_e85a, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1018_e85d, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1018_e85f, 6); mov(bl, memb[ds, 0x1020_9dd2]);         /* mov bl, [0x10209dd2] */
            ii(0x1018_e865, 3); mov(eax, memd[ss, ebp + 16]);           /* mov eax, [ebp+0x10] */
            ii(0x1018_e868, 3); shl(eax, 3);                            /* shl eax, 0x3 */
            ii(0x1018_e86b, 5); mov(memd[ds, 0x1020_9ce0], eax);        /* mov [0x10209ce0], eax */
            ii(0x1018_e870, 3); mov(eax, memd[ss, ebp + 24]);           /* mov eax, [ebp+0x18] */
            ii(0x1018_e873, 3); shl(eax, 3);                            /* shl eax, 0x3 */
            ii(0x1018_e876, 5); mov(memd[ds, 0x1020_9cdc], eax);        /* mov [0x10209cdc], eax */
            ii(0x1018_e87b, 3); mov(eax, memd[ss, ebp + 20]);           /* mov eax, [ebp+0x14] */
            ii(0x1018_e87e, 3); shl(eax, 3);                            /* shl eax, 0x3 */
            ii(0x1018_e881, 2); mul(ebx);                               /* mul ebx */
            ii(0x1018_e883, 5); mov(memd[ds, 0x1020_9ce4], eax);        /* mov [0x10209ce4], eax */
            ii(0x1018_e888, 3); mov(eax, memd[ss, ebp + 28]);           /* mov eax, [ebp+0x1c] */
            ii(0x1018_e88b, 3); shl(eax, 3);                            /* shl eax, 0x3 */
            ...
            ii(0x1018_e8a0, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1018_e8a3, 5); mov(eax, memd[ds, 0x1020_9cc8]);        /* mov eax, [0x10209cc8] */
            ii(0x1018_e8a8, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1018_e8ab, 4); cmp(memd[ss, ebp + 16], 0);             /* cmp dword [ebp+0x10], 0x0 */
            ii(0x1018_e8af, 2); if(jnz(0x1018_e8b7, 6)) goto l_0x1018_e8b7; /* jnz 0x1018e8b7 */
            ii(0x1018_e8b1, 4); cmp(memd[ss, ebp + 20], 0);             /* cmp dword [ebp+0x14], 0x0 */
        ...
        l_0x1018_e8b7:
            ...
            ii(0x1018_e8c8, 3); add(memd[ss, ebp - 4], eax);            /* add [ebp-0x4], eax */
        l_0x1018_e8cb:
            ii(0x1018_e8cb, 5); mov(eax, memd[ds, 0x1020_9cec]);        /* mov eax, [0x10209cec] */
            ii(0x1018_e8d0, 3); sub(eax, 8);                            /* sub eax, 0x8 */
            ii(0x1018_e8d3, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1018_e8d6, 3); mov(esi, memd[ss, ebp + 12]);           /* mov esi, [ebp+0xc] */
            ii(0x1018_e8d9, 3); mov(edi, memd[ss, ebp - 4]);            /* mov edi, [ebp-0x4] */
        l_0x1018_e8dc:
            ...
            ii(0x1018_e8ef, 3); mov(memd[ss, ebp + 8], ebx);            /* mov [ebp+0x8], ebx */
            ii(0x1018_e8f2, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1018_e8f4, 2); mov(bl, al);                            /* mov bl, al */
            ii(0x1018_e8f6, 3); shr(bl, 4);                             /* shr bl, 0x4 */
