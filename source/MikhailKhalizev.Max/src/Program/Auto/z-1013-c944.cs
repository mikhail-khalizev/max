...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_c944()
        {
            ...
            ii(0x1013_c95c, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1013_c95f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_c962, 4); mov(memb[ds, eax + 0x20], 0);           /* mov byte [eax+0x20], 0x0 */
            ii(0x1013_c966, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_c969, 10); mov(memd[ds, eax + 0xda9], 0xffff);    /* mov dword [eax+0xda9], 0xffff */
            ii(0x1013_c973, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_c976, 7); mov(memd[ds, eax + 0x4], 0);            /* mov dword [eax+0x4], 0x0 */
            ii(0x1013_c97d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_c980, 6); mov(memw[ds, eax + 0x10], 0xffff);      /* mov word [eax+0x10], 0xffff */
            ii(0x1013_c986, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_c989, 6); mov(memd[ds, eax], 0);                  /* mov dword [eax], 0x0 */
            ii(0x1013_c98f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_c992, 7); mov(memd[ds, eax + 0x8], 0);            /* mov dword [eax+0x8], 0x0 */
            ii(0x1013_c999, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_c99c, 6); mov(memw[ds, eax + 0xc], 0xffff);       /* mov word [eax+0xc], 0xffff */
            ii(0x1013_c9a2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_c9a5, 6); mov(memw[ds, eax + 0xe], 0xffff);       /* mov word [eax+0xe], 0xffff */
            ii(0x1013_c9ab, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_c9ae, 10); mov(memd[ds, eax + 0xdc5], 0);         /* mov dword [eax+0xdc5], 0x0 */
            ii(0x1013_c9b8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_c9bb, 10); mov(memd[ds, eax + 0xdca], 0);         /* mov dword [eax+0xdca], 0x0 */
            ii(0x1013_c9c5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_c9c8, 10); mov(memd[ds, eax + 0xdce], 0);         /* mov dword [eax+0xdce], 0x0 */
            ii(0x1013_c9d2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_c9d5, 4); mov(memb[ds, eax + 0x16], 0);           /* mov byte [eax+0x16], 0x0 */
            ii(0x1013_c9d9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_c9dc, 4); mov(memb[ds, eax + 0x17], 0);           /* mov byte [eax+0x17], 0x0 */
            ii(0x1013_c9e0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_c9e3, 7); mov(memd[ds, eax + 0x1c], 0xffff);      /* mov dword [eax+0x1c], 0xffff */
            ii(0x1013_c9ea, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_c9ed, 10); mov(memd[ds, eax + 0xda5], 0);         /* mov dword [eax+0xda5], 0x0 */
            ii(0x1013_c9f7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_c9fa, 10); mov(memd[ds, eax + 0xdad], 0);         /* mov dword [eax+0xdad], 0x0 */
            ii(0x1013_ca04, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_ca07, 7); mov(memb[ds, eax + 0xdd2], 0);          /* mov byte [eax+0xdd2], 0x0 */
            ii(0x1013_ca0e, 7); mov(memd[ss, ebp - 0x8], 0x14);         /* mov dword [ebp-0x8], 0x14 */
        l_0x1013_ca15:
            ii(0x1013_ca15, 3); dec(memd[ss, ebp - 0x8]);               /* dec dword [ebp-0x8] */
            ii(0x1013_ca18, 5); cmp(memw[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp word [ebp-0x8], 0xffff */
            ii(0x1013_ca1d, 2); if(jz(0x1013_ca5c, 0x3d)) goto l_0x1013_ca5c; /* jz 0x1013ca5c */
            ii(0x1013_ca1f, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1013_ca23, 6); imul(eax, eax, 0x91);                   /* imul eax, eax, 0x91 */
            ii(0x1013_ca29, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ...
            ii(0x1013_ca3d, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1013_ca41, 6); imul(eax, eax, 0x91);                   /* imul eax, eax, 0x91 */
            ii(0x1013_ca47, 3); mov(ecx, memd[ss, ebp - 0x4]);          /* mov ecx, [ebp-0x4] */
        ...
        l_0x1013_ca5c:
            ii(0x1013_ca5c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
