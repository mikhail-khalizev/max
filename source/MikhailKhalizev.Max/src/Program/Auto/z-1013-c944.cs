...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_c944()
        {
            ...
            ii(0x1013_c962, 4); mov(memb[ds, eax + 32], 0);             /* mov byte [eax+0x20], 0x0 */
            ii(0x1013_c966, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_c969, 10); mov(memd[ds, eax + 3497], 0xffff);     /* mov dword [eax+0xda9], 0xffff */
            ...
            ii(0x1013_c980, 6); mov(memw[ds, eax + 16], 0xffff);        /* mov word [eax+0x10], 0xffff */
            ...
            ii(0x1013_c99c, 6); mov(memw[ds, eax + 12], 0xffff);        /* mov word [eax+0xc], 0xffff */
            ii(0x1013_c9a2, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_c9a5, 6); mov(memw[ds, eax + 14], 0xffff);        /* mov word [eax+0xe], 0xffff */
            ii(0x1013_c9ab, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_c9ae, 10); mov(memd[ds, eax + 3525], 0);          /* mov dword [eax+0xdc5], 0x0 */
            ii(0x1013_c9b8, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_c9bb, 10); mov(memd[ds, eax + 3530], 0);          /* mov dword [eax+0xdca], 0x0 */
            ii(0x1013_c9c5, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_c9c8, 10); mov(memd[ds, eax + 3534], 0);          /* mov dword [eax+0xdce], 0x0 */
            ii(0x1013_c9d2, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_c9d5, 4); mov(memb[ds, eax + 22], 0);             /* mov byte [eax+0x16], 0x0 */
            ii(0x1013_c9d9, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_c9dc, 4); mov(memb[ds, eax + 23], 0);             /* mov byte [eax+0x17], 0x0 */
            ii(0x1013_c9e0, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_c9e3, 7); mov(memd[ds, eax + 28], 0xffff);        /* mov dword [eax+0x1c], 0xffff */
            ii(0x1013_c9ea, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_c9ed, 10); mov(memd[ds, eax + 3493], 0);          /* mov dword [eax+0xda5], 0x0 */
            ii(0x1013_c9f7, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_c9fa, 10); mov(memd[ds, eax + 3501], 0);          /* mov dword [eax+0xdad], 0x0 */
            ii(0x1013_ca04, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_ca07, 7); mov(memb[ds, eax + 3538], 0);           /* mov byte [eax+0xdd2], 0x0 */
        ...
        l_0x1013_ca15:
            ...
            ii(0x1013_ca2c, 10); mov(memd[ds, eax + 593], 0xffff);      /* mov dword [eax+0x251], 0xffff */
        ...
        l_0x1013_ca5c:
            ...
            ii(0x1013_ca5f, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1013_ca62, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
