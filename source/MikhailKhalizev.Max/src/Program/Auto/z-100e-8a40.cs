...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("f2e99471-e620-4f16-9a2b-b7861c8f82fe")]
        public void Method_100e_8a40()
        {
            ii(0x100e_8a40, 5); pushd(0x2c);                            /* push 0x2c */
            ii(0x100e_8a45, 5); calld(Definitions.sys_check_available_stack_size, 0x7_d308); /* call 0x10165d52 */
            ...
            ii(0x100e_8a66, 5); calld(/* sys */ 0x1016_cc1c, 0x8_41b1); /* call 0x1016cc1c */
        ...
        l_0x100e_8aa7:
            ...
            ii(0x100e_8aaa, 5); calld(Definitions.sys_display_apply_palette, 0x8_410d); /* call 0x1016cbbc */
            ...
            ii(0x100e_8ac6, 5); calld(Definitions.sys_memcpy, 0x7_d380); /* call 0x10165e4b */
            ii(0x100e_8acb, 5); mov(eax, memd_a32[ds, Definitions.ptr_to_pallete]); /* mov eax, [0x101c9464] */
            ii(0x100e_8ad0, 5); calld(/* sys */ 0x1016_d2cc, 0x8_47f7); /* call 0x1016d2cc */
