...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("79004a2d-ccf7-43e1-aa84-d50f5a320b5b")]
        public void Method_100a_aad4()
        {
            ii(0x100a_aad4, 5); pushd(0x28);                            /* push 0x28 */
            ii(0x100a_aad9, 5); calld(Definitions.sys_check_available_stack_size, 0xbb274); /* call 0x10165d52 */
            ...
            ii(0x100a_aafd, 5); calld(0x100c_d7e8, 0x22ce6);            /* call 0x100cd7e8 */
            ...
            ii(0x100a_ab25, 1); retd(); return;                         /* ret */
        }
    }
}
