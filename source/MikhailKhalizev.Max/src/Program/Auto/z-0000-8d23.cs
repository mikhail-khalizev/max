...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x8d46:
            ii(0x8d46, 4);    mov(memb[ss, bp - 13], 0x52);             /* mov byte [bp-0xd], 0x52 */
            ii(0x8d4a, 3);    lea(ax, memw[ss, bp - 22]);               /* lea ax, [bp-0x16] */
            ii(0x8d4d, 1);    push(ax);                                 /* push ax */
            ii(0x8d4e, 3);    lea(cx, memw[ss, bp - 14]);               /* lea cx, [bp-0xe] */
            ...
            ii(0x8d59, 3);    mov(ax, memw[ss, bp - 12]);               /* mov ax, [bp-0xc] */
            ii(0x8d5c, 2);    add(ax, si);                              /* add ax, si */
            ii(0x8d5e, 3);    mov(memw[ss, bp - 26], ax);               /* mov [bp-0x1a], ax */
            ii(0x8d61, 3);    mov(ax, memw[ss, bp - 22]);               /* mov ax, [bp-0x16] */
            ii(0x8d64, 3);    mov(memw[ss, bp - 24], ax);               /* mov [bp-0x18], ax */
        ...
        l_0x8d6c:
            ...
            ii(0x8d6f, 3);    push(memw[ss, bp - 26]);                  /* push word [bp-0x1a] */
        ...
        l_0x8d7c:
            ii(0x8d7c, 3);    les(bx, memw[ss, bp - 26]);               /* les bx, [bp-0x1a] */
            ii(0x8d7f, 3);    mov(ax, memw[es, bx]);                    /* mov ax, [es:bx] */
            ii(0x8d82, 4);    mov(dx, memw[es, bx + 2]);                /* mov dx, [es:bx+0x2] */
            ii(0x8d86, 3);    mov(memw[ss, bp - 26], ax);               /* mov [bp-0x1a], ax */
            ii(0x8d89, 3);    mov(memw[ss, bp - 24], dx);               /* mov [bp-0x18], dx */
