...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_8d23()
        {
            ...
            ii(0x8d2b, 5);    cmp(memb[ds, 0xcee], 0x2);                /* cmp byte [0xcee], 0x2 */
            ii(0x8d30, 2);    if(jnz(0x8d35, 0x3)) goto l_0x8d35;       /* jnz 0x8d35 */
            ii(0x8d32, 3);    mov(si, 0x17);                            /* mov si, 0x17 */
        l_0x8d35:
            ii(0x8d35, 5);    cmp(memb[ds, 0xcee], 0x3);                /* cmp byte [0xcee], 0x3 */
            ii(0x8d3a, 2);    if(jnz(0x8d46, 0xa)) goto l_0x8d46;       /* jnz 0x8d46 */
            ii(0x8d3c, 5);    cmp(memb[ds, 0xcef], 0);                  /* cmp byte [0xcef], 0x0 */
            ii(0x8d41, 2);    if(jnz(0x8d46, 0x3)) goto l_0x8d46;       /* jnz 0x8d46 */
        ...
        l_0x8d6c:
            ...
            ii(0x8d73, 3);    call_abs(memw[ss, bp + 0x4]);             /* call word [bp+0x4] */
        ...
        l_0x8d7c:
            ...
            ii(0x8d82, 4);    mov(dx, memw[es, bx + 0x2]);              /* mov dx, [es:bx+0x2] */
