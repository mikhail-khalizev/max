...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_38f6()
        {
            ...
            ii(0x1019_38f8, 3); mov(ecx, memd[ss, ebp + 0x18]);         /* mov ecx, [ebp+0x18] */
            ...
            ii(0x1019_3902, 3); mul(memd[ss, ebp + 0x24]);              /* mul dword [ebp+0x24] */
            ii(0x1019_3905, 3); add(eax, memd[ss, ebp + 0x20]);         /* add eax, [ebp+0x20] */
            ...
            ii(0x1019_3913, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ...
            ii(0x1019_392f, 3); mov(edx, memd[ss, ebp - 0x28]);         /* mov edx, [ebp-0x28] */
