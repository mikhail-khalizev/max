...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_5880()
        {
            ...
            ii(0x1011_5892, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ...
            ii(0x1011_58a7, 5); mov(edx, 4);                            /* mov edx, 0x4 */
            ...
            ii(0x1011_58b6, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1011_58b9, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1011_58bc, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1011_58bf, 10); mov(memd[ds, 0x101b_af84], 1);         /* mov dword [0x101baf84], 0x1 */
