...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_1680()
        {
            ...
            ii(0x1017_168f, 7); mov(memd[ss, esp + 0x108], ecx);        /* mov [esp+0x108], ecx */
            ...
            ii(0x1017_169f, 7); lea(ecx, memd[ss, esp + 0x100]);        /* lea ecx, [esp+0x100] */
            ii(0x1017_16a6, 7); lea(ebx, memd[ss, esp + 0x104]);        /* lea ebx, [esp+0x104] */
        ...
        l_0x1017_16ba:
            ...
            ii(0x1017_16c7, 2); if(jz(0x1017_16d2, 0x9)) goto l_0x1017_16d2; /* jz 0x101716d2 */
        ...
        l_0x1017_16dc:
            ii(0x1017_16dc, 4); mov(al, memb[ss, esp + 0x2]);           /* mov al, [esp+0x2] */
            ...
            ii(0x1017_16e8, 7); mov(eax, memd[ss, esp + 0x104]);        /* mov eax, [esp+0x104] */
            ii(0x1017_16ef, 7); mov(memd[ss, esp + 0x10c], ebx);        /* mov [esp+0x10c], ebx */
            ii(0x1017_16f6, 2); jmp(0x1017_1715, 0x1d); goto l_0x1017_1715; /* jmp 0x10171715 */
        l_0x1017_16f8:
            ii(0x1017_16f8, 4); mov(al, memb[ss, esp + 0x3]);           /* mov al, [esp+0x3] */
            ...
            ii(0x1017_1707, 7); mov(eax, memd[ss, esp + 0x100]);        /* mov eax, [esp+0x100] */
            ii(0x1017_170e, 7); mov(memd[ss, esp + 0x10c], edx);        /* mov [esp+0x10c], edx */
        l_0x1017_1715:
            ii(0x1017_1715, 7); mov(memd[ss, esp + 0x114], eax);        /* mov [esp+0x114], eax */
        l_0x1017_171c:
            ii(0x1017_171c, 4); mov(al, memb[ss, esp + 0x2]);           /* mov al, [esp+0x2] */
            ii(0x1017_1720, 2); and(al, 0x5);                           /* and al, 0x5 */
            ii(0x1017_1722, 2); cmp(al, 0x5);                           /* cmp al, 0x5 */
            ii(0x1017_1724, 2); if(jnz(0x1017_172f, 0x9)) goto l_0x1017_172f; /* jnz 0x1017172f */
            ii(0x1017_1726, 7); mov(ebx, memd[ss, esp + 0x104]);        /* mov ebx, [esp+0x104] */
            ii(0x1017_172d, 2); jmp(0x1017_174c, 0x1d); goto l_0x1017_174c; /* jmp 0x1017174c */
        l_0x1017_172f:
            ii(0x1017_172f, 4); mov(al, memb[ss, esp + 0x3]);           /* mov al, [esp+0x3] */
            ...
            ii(0x1017_173e, 7); mov(ebx, memd[ss, esp + 0x100]);        /* mov ebx, [esp+0x100] */
            ii(0x1017_1745, 2); jmp(0x1017_174e, 0x7); goto l_0x1017_174e; /* jmp 0x1017174e */
        l_0x1017_1747:
            ii(0x1017_1747, 5); mov(ebx, 0xa_0000);                     /* mov ebx, 0xa0000 */
        l_0x1017_174c:
            ii(0x1017_174c, 2); xor(ecx, ecx);                          /* xor ecx, ecx */
        l_0x1017_174e:
            ii(0x1017_174e, 4); test(memb[ss, esp], 0x2);               /* test byte [esp], 0x2 */
            ii(0x1017_1752, 2); if(jz(0x1017_175b, 0x7)) goto l_0x1017_175b; /* jz 0x1017175b */
            ii(0x1017_1754, 2); xor(edi, edi);                          /* xor edi, edi */
            ii(0x1017_1756, 5); mov(di, memw[ss, esp + 0x12]);          /* mov di, [esp+0x12] */
        l_0x1017_175b:
            ii(0x1017_175b, 7); mov(eax, memd[ss, esp + 0x108]);        /* mov eax, [esp+0x108] */
            ...
            ii(0x1017_177d, 7); mov(memd[ss, esp + 0x110], eax);        /* mov [esp+0x110], eax */
            ii(0x1017_1784, 2); mov(al, 0x9);                           /* mov al, 0x9 */
            ii(0x1017_1786, 1); outb(dx, al);                           /* out dx, al */
            ii(0x1017_1787, 7); mov(al, memb[ss, esp + 0x110]);         /* mov al, [esp+0x110] */
        ...
        l_0x1017_179a:
            ...
            ii(0x1017_17a1, 5); mov(ax, memw[ss, esp + 0x4]);           /* mov ax, [esp+0x4] */
            ...
            ii(0x1017_17ad, 5); mov(ax, memw[ss, esp + 0xe]);           /* mov ax, [esp+0xe] */
            ii(0x1017_17b2, 3); shl(eax, 0xa);                          /* shl eax, 0xa */
            ii(0x1017_17b5, 1); push(eax);                              /* push eax */
            ii(0x1017_17b6, 7); mov(ebp, memd[ss, esp + 0x120]);        /* mov ebp, [esp+0x120] */
            ii(0x1017_17bd, 1); push(ebp);                              /* push ebp */
            ii(0x1017_17be, 7); mov(eax, memd[ss, esp + 0x11c]);        /* mov eax, [esp+0x11c] */
            ii(0x1017_17c5, 4); mov(memd[ss, esp + 0x1c], edx);         /* mov [esp+0x1c], edx */
            ...
            ii(0x1017_17d2, 5); mov(bx, memw[ss, esp + 0x28]);          /* mov bx, [esp+0x28] */
