...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_7105()
        {
            ...
            ii(0x1018_7113, 6); mov(ax, memw[ds, 0x101b_e88e]);         /* mov ax, [0x101be88e] */
            ii(0x1018_7119, 3); sub(ax, dx);                            /* sub ax, dx */
            ii(0x1018_711c, 7); mul(memw[ds, 0x101b_e890]);             /* mul word [0x101be890] */
            ii(0x1018_7123, 7); div(memw[ds, 0x101b_e896]);             /* div word [0x101be896] */
            ii(0x1018_712a, 3); xor(dx, dx);                            /* xor dx, dx */
            ii(0x1018_712d, 7); div(memw[ds, 0x101b_e896]);             /* div word [0x101be896] */
            ii(0x1018_7134, 5); cmp(dx, 0x1f4);                         /* cmp dx, 0x1f4 */
            ii(0x1018_7139, 2); if(jb(0x1018_713d, 0x2)) goto l_0x1018_713d; /* jb 0x1018713d */
        ...
        l_0x1018_713d:
            ...
            ii(0x1018_7144, 7); mov(bx, memw[ds, 0x101b_e88c]);         /* mov bx, [0x101be88c] */
            ii(0x1018_714b, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1018_714d, 3); mov(ax, memw[ds, ebx]);                 /* mov ax, [ebx] */
            ii(0x1018_7150, 7); sub(ax, memw[ds, 0x101b_e898]);         /* sub ax, [0x101be898] */
            ii(0x1018_7157, 6); mul(memd[ds, 0x101b_e892]);             /* mul dword [0x101be892] */
            ii(0x1018_715d, 2); add(eax, ecx);                          /* add eax, ecx */
            ii(0x1018_715f, 1); ret();                                  /* ret */
        }
    }
}
