...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_88df()
        {
            ...
            ii(0x88e5, 5);    mov(memw[ss, bp - 0x4], 0xffe0);          /* mov word [bp-0x4], 0xffe0 */
            ii(0x88ea, 5);    mov(memw[ss, bp - 0x2], 0xf000);          /* mov word [bp-0x2], 0xf000 */
            ii(0x88ef, 3);    mov(ax, memw[ds, 0x9c]);                  /* mov ax, [0x9c] */
            ii(0x88f2, 4);    mov(dx, memw[ds, 0x9e]);                  /* mov dx, [0x9e] */
            ii(0x88f6, 3);    mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x88f9, 3);    mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
            ...
            ii(0x8903, 5);    mov(memw[ss, bp - 0x8], 0);               /* mov word [bp-0x8], 0x0 */
            ii(0x8908, 5);    mov(memw[ss, bp - 0x6], 0x1);             /* mov word [bp-0x6], 0x1 */
        l_0x890d:
            ii(0x890d, 3);    mov(ax, memw[ds, 0xf0c]);                 /* mov ax, [0xf0c] */
            ii(0x8910, 4);    mov(dx, memw[ds, 0xf0e]);                 /* mov dx, [0xf0e] */
            ii(0x8914, 3);    les(bx, memw[ss, bp - 0x4]);              /* les bx, [bp-0x4] */
            ii(0x8917, 4);    cmp(memw[es, bx + 0xa], ax);              /* cmp [es:bx+0xa], ax */
            ii(0x891b, 2);    if(jnz(0x894d, 0x30)) goto l_0x894d;      /* jnz 0x894d */
            ii(0x891d, 4);    cmp(memw[es, bx + 0xc], dx);              /* cmp [es:bx+0xc], dx */
            ii(0x8921, 2);    if(jnz(0x894d, 0x2a)) goto l_0x894d;      /* jnz 0x894d */
            ii(0x8923, 3);    mov(ax, memw[ds, 0xf11]);                 /* mov ax, [0xf11] */
            ii(0x8926, 4);    cmp(memw[es, bx + 0xe], ax);              /* cmp [es:bx+0xe], ax */
            ...
            ii(0x8934, 3);    mov(ax, memw[ss, bp - 0x8]);              /* mov ax, [bp-0x8] */
            ii(0x8937, 3);    mov(dx, memw[ss, bp - 0x6]);              /* mov dx, [bp-0x6] */
            ...
            ii(0x894b, 2);    if(jb(0x8952, 0x5)) goto l_0x8952;        /* jb 0x8952 */
        l_0x894d:
            ii(0x894d, 2);    sub(ax, ax);                              /* sub ax, ax */
            ii(0x894f, 1);    cwd();                                    /* cwd */
            ii(0x8950, 2);    jmp(0x89cc, 0x7a); goto l_0x89cc;         /* jmp 0x89cc */
        l_0x8952:
            ii(0x8952, 3);    les(bx, memw[ss, bp - 0x4]);              /* les bx, [bp-0x4] */
            ii(0x8955, 3);    mov(ax, memw[es, bx]);                    /* mov ax, [es:bx] */
            ii(0x8958, 3);    mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x895b, 3);    mov(memw[ds, 0x11ec], ax);                /* mov [0x11ec], ax */
            ii(0x895e, 2);    mov(bx, ax);                              /* mov bx, ax */
            ii(0x8960, 4);    cmp(memw[es, bx], -0x1 /* 0xff */);       /* cmp word [es:bx], 0xffff */
            ii(0x8964, 2);    if(jz(0x894d, -0x19)) goto l_0x894d;      /* jz 0x894d */
            ii(0x8966, 4);    mov(ax, memw[es, bx + 0x4]);              /* mov ax, [es:bx+0x4] */
            ii(0x896a, 4);    cmp(memw[es, bx + 0x2], ax);              /* cmp [es:bx+0x2], ax */
            ii(0x896e, 2);    if(jb(0x894d, -0x23)) goto l_0x894d;      /* jb 0x894d */
            ii(0x8970, 4);    cmp(ax, memw[es, bx + 0x6]);              /* cmp ax, [es:bx+0x6] */
            ii(0x8974, 2);    if(jae(0x894d, -0x29)) goto l_0x894d;     /* jae 0x894d */
            ii(0x8976, 3);    mov(memw[ss, bp - 0xa], ax);              /* mov [bp-0xa], ax */
            ii(0x8979, 3);    mov(bx, memw[ss, bp + 0x4]);              /* mov bx, [bp+0x4] */
            ...
            ii(0x8983, 3);    mov(bx, memw[ss, bp - 0x4]);              /* mov bx, [bp-0x4] */
            ii(0x8986, 4);    mov(ax, memw[es, bx + 0x6]);              /* mov ax, [es:bx+0x6] */
            ...
            ii(0x89a6, 3);    sub(si, memw[ss, bp - 0xa]);              /* sub si, [bp-0xa] */
            ...
            ii(0x89b7, 3);    push(memw[ss, bp - 0xa]);                 /* push word [bp-0xa] */
            ...
            ii(0x89c2, 3);    les(bx, memw[ss, bp - 0x4]);              /* les bx, [bp-0x4] */
            ii(0x89c5, 4);    mov(ax, memw[es, bx + 0x6]);              /* mov ax, [es:bx+0x6] */
