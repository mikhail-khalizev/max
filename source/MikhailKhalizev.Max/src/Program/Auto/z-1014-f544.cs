...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_f544()
        {
            ...
            ii(0x1014_f55c, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_f55f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_f562, 4); cmp(memb[ds, eax + 0x3d], 0x4);         /* cmp byte [eax+0x3d], 0x4 */
            ii(0x1014_f566, 2); if(jz(0x1014_f571, 0x9)) goto l_0x1014_f571; /* jz 0x1014f571 */
            ii(0x1014_f568, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_f56b, 4); cmp(memb[ds, eax + 0x3d], 0xb);         /* cmp byte [eax+0x3d], 0xb */
            ii(0x1014_f56f, 2); if(jnz(0x1014_f573, 0x2)) goto l_0x1014_f573; /* jnz 0x1014f573 */
        l_0x1014_f571:
            ii(0x1014_f571, 2); jmp(0x1014_f594, 0x21); goto l_0x1014_f594; /* jmp 0x1014f594 */
        l_0x1014_f573:
            ii(0x1014_f573, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_f576, 4); test(memb[ds, eax + 0x13], 0x2);        /* test byte [eax+0x13], 0x2 */
            ii(0x1014_f57a, 2); if(jz(0x1014_f586, 0xa)) goto l_0x1014_f586; /* jz 0x1014f586 */
            ii(0x1014_f57c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_f57f, 5); cmp(memw[ds, eax + 0x8], 0x29);         /* cmp word [eax+0x8], 0x29 */
            ii(0x1014_f584, 2); if(jnz(0x1014_f588, 0x2)) goto l_0x1014_f588; /* jnz 0x1014f588 */
        l_0x1014_f586:
            ii(0x1014_f586, 2); jmp(0x1014_f592, 0xa); goto l_0x1014_f592; /* jmp 0x1014f592 */
        l_0x1014_f588:
            ii(0x1014_f588, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_f58b, 5); cmp(memw[ds, eax + 0x8], 0x2a);         /* cmp word [eax+0x8], 0x2a */
            ii(0x1014_f590, 2); if(jnz(0x1014_f594, 0x2)) goto l_0x1014_f594; /* jnz 0x1014f594 */
        l_0x1014_f592:
            ii(0x1014_f592, 2); jmp(0x1014_f596, 0x2); goto l_0x1014_f596; /* jmp 0x1014f596 */
        l_0x1014_f594:
            ii(0x1014_f594, 2); jmp(0x1014_f5b8, 0x22); goto l_0x1014_f5b8; /* jmp 0x1014f5b8 */
        l_0x1014_f596:
            ii(0x1014_f596, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_f599, 4); test(memb[ds, eax + 0x14], 0x40);       /* test byte [eax+0x14], 0x40 */
            ...
            ii(0x1014_f5b0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
