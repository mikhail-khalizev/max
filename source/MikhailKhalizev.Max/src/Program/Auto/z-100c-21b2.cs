...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_21b2()
        {
            ...
            ii(0x100c_21c9, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_21cc, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100c_21cf, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_21d2, 3); add(eax, 0x16);                         /* add eax, 0x16 */
            ii(0x100c_21d5, 5); call(0x1007_6574, -0x4_bc66);           /* call 0x10076574 */
            ii(0x100c_21da, 4); test(memb[ds, eax + 0x12], 0x40);       /* test byte [eax+0x12], 0x40 */
            ii(0x100c_21de, 6); if(jz(0x100c_226f, 0x8b)) goto l_0x100c_226f; /* jz 0x100c226f */
            ii(0x100c_21e4, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100c_21e6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_21ff, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x100c_2202, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100c_2205, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100c_2208, 4); cmp(memd[ss, ebp - 0x10], 0);           /* cmp dword [ebp-0x10], 0x0 */
            ii(0x100c_220c, 2); if(jz(0x100c_222c, 0x1e)) goto l_0x100c_222c; /* jz 0x100c222c */
            ii(0x100c_220e, 5); mov(ebx, 0x40);                         /* mov ebx, 0x40 */
            ii(0x100c_2213, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_2216, 3); movsx(edx, memw[ds, eax]);              /* movsx edx, word [eax] */
            ii(0x100c_2219, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100c_221c, 5); call(Definitions.my_ctor_c13, -0x1_abd2); /* call 0x100a764f */
            ii(0x100c_2221, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x100c_2224, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x100c_2227, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
            ii(0x100c_222a, 2); jmp(0x100c_2232, 0x6); goto l_0x100c_2232; /* jmp 0x100c2232 */
        l_0x100c_222c:
            ii(0x100c_222c, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100c_222f, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
        l_0x100c_2232:
            ii(0x100c_2232, 3); mov(edx, memd[ss, ebp - 0x18]);         /* mov edx, [ebp-0x18] */
            ii(0x100c_2235, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_2238, 3); add(eax, 0x15);                         /* add eax, 0x15 */
            ii(0x100c_223b, 5); call(0x100c_b550, 0x9310);              /* call 0x100cb550 */
            ii(0x100c_2240, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100c_2257:
            ii(0x100c_2257, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100c_225a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100c_226f:
            ...
            ii(0x100c_2271, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100c_228a, 3); mov(memd[ss, ebp - 0x1c], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100c_228d, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x100c_2290, 3); mov(memd[ss, ebp - 0x20], eax);         /* mov [ebp-0x20], eax */
            ii(0x100c_2293, 4); cmp(memd[ss, ebp - 0x20], 0);           /* cmp dword [ebp-0x20], 0x0 */
            ii(0x100c_2297, 2); if(jz(0x100c_22b7, 0x1e)) goto l_0x100c_22b7; /* jz 0x100c22b7 */
            ii(0x100c_2299, 5); mov(ebx, 0x180);                        /* mov ebx, 0x180 */
            ii(0x100c_229e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_22a1, 3); movsx(edx, memw[ds, eax]);              /* movsx edx, word [eax] */
            ii(0x100c_22a4, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x100c_22a7, 5); call(Definitions.my_ctor_c13, -0x1_ac5d); /* call 0x100a764f */
            ii(0x100c_22ac, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x100c_22af, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x100c_22b2, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
            ii(0x100c_22b5, 2); jmp(0x100c_22bd, 0x6); goto l_0x100c_22bd; /* jmp 0x100c22bd */
        l_0x100c_22b7:
            ii(0x100c_22b7, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x100c_22ba, 3); mov(memd[ss, ebp - 0x28], eax);         /* mov [ebp-0x28], eax */
        l_0x100c_22bd:
            ii(0x100c_22bd, 3); mov(edx, memd[ss, ebp - 0x28]);         /* mov edx, [ebp-0x28] */
            ii(0x100c_22c0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_22c3, 3); add(eax, 0x11);                         /* add eax, 0x11 */
            ii(0x100c_22c6, 5); call(0x100c_b550, 0x9285);              /* call 0x100cb550 */
            ii(0x100c_22cb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100c_22e2:
            ii(0x100c_22e2, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100c_22e5, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
