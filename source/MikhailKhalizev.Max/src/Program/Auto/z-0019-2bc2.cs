...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_2bc2()
        {
            ...
            ii(0x19_2bd4, 3); mov(memw[ss, bp - 0x2], es);              /* mov [bp-0x2], es */
            ...
            ii(0x19_2bea, 2); if(jz(0x19_2bf2, 0x6)) goto l_0x19_2bf2;  /* jz 0x2bf2 */
        l_0x19_2bec:
            ii(0x19_2bec, 2); repne(() => scasb());                     /* repne scasb */
            ii(0x19_2bee, 1); inc(si);                                  /* inc si */
            ii(0x19_2bef, 1); scasb();                                  /* scasb */
            ii(0x19_2bf0, 2); if(jnz(0x19_2bec, -0x6)) goto l_0x19_2bec; /* jnz 0x2bec */
        l_0x19_2bf2:
            ...
            ii(0x19_2c12, 3); mov(memw[ss, bp - 0x4], dx);              /* mov [bp-0x4], dx */
        ...
        l_0x19_2c3f:
            ii(0x19_2c3f, 3); mov(ds, memw[ss, bp - 0x4]);              /* mov ds, [bp-0x4] */
            ii(0x19_2c42, 2); mov(memw[ds, bx], di);                    /* mov [bx], di */
            ii(0x19_2c44, 3); mov(memw[ds, bx + 0x2], es);              /* mov [bx+0x2], es */
            ii(0x19_2c47, 3); add(bx, 0x4);                             /* add bx, 0x4 */
        l_0x19_2c4a:
            ii(0x19_2c4a, 3); mov(ds, memw[ss, bp - 0x2]);              /* mov ds, [bp-0x2] */
        l_0x19_2c4d:
            ii(0x19_2c4d, 1); lodsb();                                  /* lodsb */
            ii(0x19_2c4e, 1); stosb();                                  /* stosb */
            ii(0x19_2c4f, 2); or(al, al);                               /* or al, al */
            ii(0x19_2c51, 2); if(jnz(0x19_2c4d, -0x6)) goto l_0x19_2c4d; /* jnz 0x2c4d */
            ii(0x19_2c53, 2); if(loop(0x19_2c22, -0x33)) goto l_0x19_2c22; /* loop 0x2c22 */
        l_0x19_2c55:
            ii(0x19_2c55, 3); mov(ds, memw[ss, bp - 0x4]);              /* mov ds, [bp-0x4] */
            ii(0x19_2c58, 2); mov(memw[ds, bx], cx);                    /* mov [bx], cx */
            ii(0x19_2c5a, 3); mov(memw[ds, bx + 0x2], cx);              /* mov [bx+0x2], cx */
