...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_ad2f()
        {
            ...
            ii(0x1012_ad4c, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_ad4f, 5); call(0x1012_72a5, -0x3aaf);             /* call 0x101272a5 */
            ii(0x1012_ad54, 3); mov(memb[ss, ebp - 0x4], al);           /* mov [ebp-0x4], al */
            ii(0x1012_ad57, 7); mov(memb[ds, 0x101c_5630], 0x2);        /* mov byte [0x101c5630], 0x2 */
            ...
            ii(0x1012_ad6c, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x1012_ad8a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1012_ad93:
            ...
            ii(0x1012_ad9b, 3); cmp(al, memb[ss, ebp - 0x4]);           /* cmp al, [ebp-0x4] */
        ...
        l_0x1012_adb1:
            ...
            ii(0x1012_adba, 2); jmp(0x1012_adc2, 0x6); goto l_0x1012_adc2; /* jmp 0x1012adc2 */
        l_0x1012_adbc:
        ...
        l_0x1012_adc2:
            ...
            ii(0x1012_adec, 7); mov(memb[ds, eax + 0x101c_40b0], 0x1);  /* mov byte [eax+0x101c40b0], 0x1 */
        l_0x1012_adf3:
        ...
        l_0x1012_adf5:
            ...
            ii(0x1012_adfa, 4); mov(memb[ds, eax + 0xa], 0x1);          /* mov byte [eax+0xa], 0x1 */
        l_0x1012_adfe:
