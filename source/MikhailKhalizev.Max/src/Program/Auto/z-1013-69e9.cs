...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_69e9()
        {
            ...
            ii(0x1013_6a00, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_6a03, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_6a06, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x1013_6a0a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_6a0d, 3); mov(eax, memd[ds, eax + 0x31]);         /* mov eax, [eax+0x31] */
            ii(0x1013_6a10, 5); call(0x100d_6f2d, -0x5_fae8);           /* call 0x100d6f2d */
            ii(0x1013_6a15, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_6a18, 3); mov(eax, memd[ds, eax + 0x31]);         /* mov eax, [eax+0x31] */
            ii(0x1013_6a1b, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1013_6a1e, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1013_6a21, 3); mov(edx, memd[ds, eax + 0x27]);         /* mov edx, [eax+0x27] */
            ii(0x1013_6a24, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1013_6a27, 3); call_abs(memd[ds, edx + 0x8]);          /* call dword [edx+0x8] */
            ii(0x1013_6a2a, 4); imul(edx, memd[ss, ebp - 0x4], 0x70);   /* imul edx, [ebp-0x4], 0x70 */
            ...
            ii(0x1013_6a3a, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1013_6a3d, 4); cmp(memd[ss, ebp - 0xc], 0x70);         /* cmp dword [ebp-0xc], 0x70 */
            ii(0x1013_6a41, 2); if(jle(0x1013_6a4a, 0x7)) goto l_0x1013_6a4a; /* jle 0x10136a4a */
            ii(0x1013_6a43, 7); mov(memd[ss, ebp - 0xc], 0x70);         /* mov dword [ebp-0xc], 0x70 */
        l_0x1013_6a4a:
            ii(0x1013_6a4a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_6a4d, 3); mov(eax, memd[ds, eax + 0x25]);         /* mov eax, [eax+0x25] */
            ii(0x1013_6a50, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1013_6a53, 1); push(eax);                              /* push eax */
            ii(0x1013_6a54, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_6a57, 3); mov(eax, memd[ds, eax + 0x25]);         /* mov eax, [eax+0x25] */
            ii(0x1013_6a5a, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1013_6a5d, 3); imul(edx, eax, 0x15);                   /* imul edx, eax, 0x15 */
            ii(0x1013_6a60, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_6a63, 3); mov(eax, memd[ds, eax + 0x2d]);         /* mov eax, [eax+0x2d] */
            ...
            ii(0x1013_6a6e, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1013_6a82, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1013_6a85, 3); add(edx, 0x17);                         /* add edx, 0x17 */
            ii(0x1013_6a88, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_6a8b, 3); mov(eax, memd[ds, eax + 0x29]);         /* mov eax, [eax+0x29] */
