...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1008_d0ea:
            ...
            ii(0x1008_d0fb, 4); cmp(memb[ds, eax + 0x25], 1);           /* cmp byte [eax+0x25], 0x1 */
        ...
        l_0x1008_d1b6:
            ...
            ii(0x1008_d1e3, 4); cmp(memb[ds, eax + 0x25], 9);           /* cmp byte [eax+0x25], 0x9 */
            ...
            ii(0x1008_d1ec, 4); mov(memb[ds, eax + 0x25], 4);           /* mov byte [eax+0x25], 0x4 */
