...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_0da4()
        {
            ...
            ii(0x1010_0dca, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1010_0dcd, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1010_0ddf, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1010_0de2, 4); cmp(memd[ss, ebp - 0x8], 0);            /* cmp dword [ebp-0x8], 0x0 */
            ii(0x1010_0de6, 2); if(jz(0x1010_0e1f, 0x37)) goto l_0x1010_0e1f; /* jz 0x10100e1f */
            ii(0x1010_0de8, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1010_0deb, 5); mov(memd[ds, 0x101c_396c], eax);        /* mov [0x101c396c], eax */
            ii(0x1010_0df0, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1010_0e0f, 7); mov(memb[ds, 0x101c_37d2], 0x1);        /* mov byte [0x101c37d2], 0x1 */
        l_0x1010_0e16:
            ii(0x1010_0e16, 7); mov(memd[ss, ebp - 0x4], 0x1);          /* mov dword [ebp-0x4], 0x1 */
            ii(0x1010_0e1d, 2); jmp(0x1010_0e26, 0x7); goto l_0x1010_0e26; /* jmp 0x10100e26 */
        l_0x1010_0e1f:
            ii(0x1010_0e1f, 7); mov(memd[ss, ebp - 0x4], 0);            /* mov dword [ebp-0x4], 0x0 */
        l_0x1010_0e26:
            ii(0x1010_0e26, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
