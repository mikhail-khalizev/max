...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_5f9e()
        {
            ...
            ii(0x1011_5fc0, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1011_5fc3, 6); mov(ax, memw[ds, 0x101c_52b4]);         /* mov ax, [0x101c52b4] */
            ii(0x1011_5fc9, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1011_5fcc, 7); mov(memd[ss, ebp - 12], 0);             /* mov dword [ebp-0xc], 0x0 */
        ...
        l_0x1011_5fd5:
            ...
            ii(0x1011_5fdb, 7); add(memd[ss, ebp - 12], 0x280);         /* add dword [ebp-0xc], 0x280 */
        l_0x1011_5fe2:
        ...
        l_0x1011_5ff9:
            ...
            ii(0x1011_6009, 3); add(edx, memd[ss, ebp - 12]);           /* add edx, [ebp-0xc] */
            ii(0x1011_600c, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1011_600f, 3); mov(eax, memd[ds, eax + 22]);           /* mov eax, [eax+0x16] */
            ...
            ii(0x1011_6027, 3); add(ebx, memd[ss, ebp - 12]);           /* add ebx, [ebp-0xc] */
            ii(0x1011_602a, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1011_602d, 3); mov(eax, memd[ds, eax + 22]);           /* mov eax, [eax+0x16] */
        ...
        l_0x1011_603a:
            ...
            ii(0x1011_6058, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1011_605b, 3); mov(eax, memd[ds, eax + 22]);           /* mov eax, [eax+0x16] */
