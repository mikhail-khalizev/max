...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_b2f4()
        {
            ...
            ii(0x100c_b30c, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_b30f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_b312, 3); mov(al, memb[ds, eax + 0x6]);           /* mov al, [eax+0x6] */
            ii(0x100c_b315, 3); mov(memb[ss, ebp - 0x8], al);           /* mov [ebp-0x8], al */
            ii(0x100c_b318, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
