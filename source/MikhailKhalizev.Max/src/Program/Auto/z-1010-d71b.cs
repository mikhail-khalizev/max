...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_d71b()
        {
            ...
            ii(0x1010_d733, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x1010_d73f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_d742, 2); mov(memd[ds, eax], edx);                /* mov [eax], edx */
            ii(0x1010_d744, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_d747, 7); mov(memd[ds, eax + 0x4], 0);            /* mov dword [eax+0x4], 0x0 */
            ii(0x1010_d74e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_d751, 7); mov(memd[ds, eax + 0x8], 0);            /* mov dword [eax+0x8], 0x0 */
            ii(0x1010_d758, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_d75b, 7); mov(memd[ds, eax + 0x1c], 0);           /* mov dword [eax+0x1c], 0x0 */
            ii(0x1010_d762, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_d765, 7); mov(memd[ds, eax + 0x14], 0);           /* mov dword [eax+0x14], 0x0 */
            ii(0x1010_d76c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_d76f, 7); mov(memd[ds, eax + 0x18], 0);           /* mov dword [eax+0x18], 0x0 */
            ...
            ii(0x1010_d782, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_d785, 4); mov(memw[ds, eax + 0xc], dx);           /* mov [eax+0xc], dx */
            ii(0x1010_d789, 5); call(/* sys */ 0x1016_be34, 0x5_e6a6);  /* call 0x1016be34 */
            ii(0x1010_d78e, 7); mov(memd[ss, ebp - 0x8], 0xc);          /* mov dword [ebp-0x8], 0xc */
        l_0x1010_d795:
            ii(0x1010_d795, 3); dec(memd[ss, ebp - 0x8]);               /* dec dword [ebp-0x8] */
            ii(0x1010_d798, 5); cmp(memw[ss, ebp - 0x8], -0x1 /* 0xff */); /* cmp word [ebp-0x8], 0xffff */
            ii(0x1010_d79d, 2); if(jz(0x1010_d7ad, 0xe)) goto l_0x1010_d7ad; /* jz 0x1010d7ad */
            ii(0x1010_d79f, 4); movsx(edx, memb[ss, ebp - 0x8]);        /* movsx edx, byte [ebp-0x8] */
            ii(0x1010_d7a3, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1010_d7ad:
            ...
            ii(0x1010_d7c0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_d7c3, 2); mov(eax, memd[ds, eax]);                /* mov eax, [eax] */
            ii(0x1010_d7c5, 3); mov(ebx, memd[ds, eax + 0xe]);          /* mov ebx, [eax+0xe] */
            ii(0x1010_d7c8, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x1010_d7cb, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1010_d7dc, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_d7df, 5); call(0x1010_ca8c, -0xd58);              /* call 0x1010ca8c */
            ii(0x1010_d7e4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
