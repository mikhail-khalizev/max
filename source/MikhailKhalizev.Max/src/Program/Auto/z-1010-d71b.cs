...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("99175994-51cf-4fa0-8e25-781ec6411dab")]
        public void Method_1010_d71b()
        {
            ii(0x1010_d71b, 5); pushd(0x30);                            /* push 0x30 */
            ii(0x1010_d720, 5); calld(Definitions.sys_check_available_stack_size, 0x5_862d); /* call 0x10165d52 */
            ...
            ii(0x1010_d738, 5); calld(0x100e_883d, -0x2_4f00);          /* call 0x100e883d */
            ...
            ii(0x1010_d77b, 5); calld(0x1007_5fdc, -0x9_77a4);          /* call 0x10075fdc */
            ...
            ii(0x1010_d789, 5); calld(/* sys */ 0x1016_be34, 0x5_e6a6); /* call 0x1016be34 */
        ...
        l_0x1010_d7ad:
            ii(0x1010_d7ad, 5); calld(0x100d_533c, -0x3_8476);          /* call 0x100d533c */
            ii(0x1010_d7b2, 1); cwde();                                 /* cwde */
            ii(0x1010_d7b3, 1); pushd(eax);                             /* push eax */
            ii(0x1010_d7b4, 5); calld(0x100d_5360, -0x3_8459);          /* call 0x100d5360 */
            ...
            ii(0x1010_d7d5, 5); calld(0x100e_8c51, -0x2_4b89);          /* call 0x100e8c51 */
            ...
            ii(0x1010_d7ec, 5); calld(/* sys */ 0x1016_bcc4, 0x5_e4d3); /* call 0x1016bcc4 */
