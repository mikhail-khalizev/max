...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_31ef()
        {
            ...
            ii(0x1008_321d, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1008_3220, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x1008_3224, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x1008_3226, 2);  if(jl(0x1008_3237, 0xf)) goto l_0x1008_3237;/* jl 0x10083237 */
            ii(0x1008_3228, 4);  movsx(edx, memw[ss, ebp - 12]);       /* movsx edx, word [ebp-0xc] */
        ...
        l_0x1008_325c:
            ...
            ii(0x1008_328b, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1008_328e, 5);  mov(eax, 0xa);                        /* mov eax, 0xa */
            ii(0x1008_3293, 5);  call(Definitions.sys_new, 0xe_2b68);  /* call 0x10165e00 */
            ii(0x1008_3298, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1008_329b, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1008_329e, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1008_32a1, 4);  cmp(memd[ss, ebp - 24], 0);           /* cmp dword [ebp-0x18], 0x0 */
            ...
            ii(0x1008_32aa, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1008_32ad, 5);  call(0x100a_3711, 0x2_045f);          /* call 0x100a3711 */
            ii(0x1008_32b2, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1008_32b5, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x1008_32b8, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x1008_32bb, 2);  jmp(0x1008_32c3, 6); goto l_0x1008_32c3;/* jmp 0x100832c3 */
        l_0x1008_32bd:
            ii(0x1008_32bd, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x1008_32c0, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
        l_0x1008_32c3:
            ii(0x1008_32c3, 3);  mov(edx, memd[ss, ebp - 32]);         /* mov edx, [ebp-0x20] */
            ii(0x1008_32c6, 5);  mov(eax, 0x101c_3180);                /* mov eax, 0x101c3180 */
            ii(0x1008_32cb, 3);  mov(ebx, memd[ss, ebp - 16]);         /* mov ebx, [ebp-0x10] */
        ...
        l_0x1008_32d3:
            ...
            ii(0x1008_32eb, 6);  mov(memw[ds, eax + 30], 0);           /* mov word [eax+0x1e], 0x0 */
            ...
            ii(0x1008_32fc, 6);  mov(memw[ds, eax + 32], 0);           /* mov word [eax+0x20], 0x0 */
