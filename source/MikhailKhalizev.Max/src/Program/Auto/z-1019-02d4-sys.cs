...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_02d4()
        {
            ...
            ii(0x1019_02ee, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1019_02f1, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1019_02f3, 6); mov(bl, memb[ds, 0x1020_9dd2]);         /* mov bl, [0x10209dd2] */
            ii(0x1019_02f9, 3); mov(eax, memd[ss, ebp + 16]);           /* mov eax, [ebp+0x10] */
            ii(0x1019_02fc, 3); shl(eax, 3);                            /* shl eax, 0x3 */
            ii(0x1019_02ff, 5); mov(memd[ds, 0x1020_9ce0], eax);        /* mov [0x10209ce0], eax */
            ii(0x1019_0304, 3); mov(eax, memd[ss, ebp + 24]);           /* mov eax, [ebp+0x18] */
            ii(0x1019_0307, 3); shl(eax, 3);                            /* shl eax, 0x3 */
            ii(0x1019_030a, 5); mov(memd[ds, 0x1020_9cdc], eax);        /* mov [0x10209cdc], eax */
            ii(0x1019_030f, 3); mov(eax, memd[ss, ebp + 20]);           /* mov eax, [ebp+0x14] */
            ii(0x1019_0312, 3); shl(eax, 3);                            /* shl eax, 0x3 */
            ii(0x1019_0315, 2); mul(ebx);                               /* mul ebx */
            ii(0x1019_0317, 5); mov(memd[ds, 0x1020_9ce4], eax);        /* mov [0x10209ce4], eax */
            ii(0x1019_031c, 3); mov(eax, memd[ss, ebp + 28]);           /* mov eax, [ebp+0x1c] */
            ii(0x1019_031f, 3); shl(eax, 3);                            /* shl eax, 0x3 */
            ...
            ii(0x1019_0334, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1019_0337, 5); mov(eax, memd[ds, 0x1020_9cc8]);        /* mov eax, [0x10209cc8] */
            ii(0x1019_033c, 3); mov(memd[ss, ebp - 4], eax);            /* mov [ebp-0x4], eax */
            ii(0x1019_033f, 4); cmp(memd[ss, ebp + 16], 0);             /* cmp dword [ebp+0x10], 0x0 */
            ii(0x1019_0343, 2); if(jnz(0x1019_034b, 6)) goto l_0x1019_034b; /* jnz 0x1019034b */
            ii(0x1019_0345, 4); cmp(memd[ss, ebp + 20], 0);             /* cmp dword [ebp+0x14], 0x0 */
        ...
        l_0x1019_034b:
            ...
            ii(0x1019_035c, 3); add(memd[ss, ebp - 4], eax);            /* add [ebp-0x4], eax */
        l_0x1019_035f:
            ii(0x1019_035f, 5); mov(eax, memd[ds, 0x1020_9cd0]);        /* mov eax, [0x10209cd0] */
            ii(0x1019_0364, 3); shl(eax, 2);                            /* shl eax, 0x2 */
            ii(0x1019_0367, 6); sub(eax, memd[ds, 0x1020_9cdc]);        /* sub eax, [0x10209cdc] */
            ii(0x1019_036d, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1019_0370, 6); shr(memd[ds, 0x1020_9cd4], 1);          /* shr dword [0x10209cd4], 1 */
            ii(0x1019_0376, 5); mov(eax, memd[ds, 0x1020_9cd0]);        /* mov eax, [0x10209cd0] */
            ii(0x1019_037b, 4); lea(eax, memd[ds, eax + eax * 2 - 8]);  /* lea eax, [eax+eax*2-0x8] */
            ii(0x1019_037f, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1019_0382, 3); mov(esi, memd[ss, ebp + 12]);           /* mov esi, [ebp+0xc] */
            ii(0x1019_0385, 3); mov(edi, memd[ss, ebp - 4]);            /* mov edi, [ebp-0x4] */
        l_0x1019_0388:
            ii(0x1019_0388, 3); mov(eax, memd[ss, ebp + 24]);           /* mov eax, [ebp+0x18] */
            ii(0x1019_038b, 2); shr(eax, 1);                            /* shr eax, 1 */
            ii(0x1019_038d, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1019_0390, 3); dec(memd[ss, ebp - 20]);                /* dec dword [ebp-0x14] */
            ii(0x1019_0393, 2); if(js(0x1019_03bb, 0x26)) goto l_0x1019_03bb; /* js 0x101903bb */
            ii(0x1019_0395, 3); mov(ebx, memd[ss, ebp + 8]);            /* mov ebx, [ebp+0x8] */
            ii(0x1019_0398, 2); mov(al, memb[ds, ebx]);                 /* mov al, [ebx] */
            ii(0x1019_039a, 1); inc(ebx);                               /* inc ebx */
            ii(0x1019_039b, 3); mov(memd[ss, ebp + 8], ebx);            /* mov [ebp+0x8], ebx */
            ii(0x1019_039e, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1019_03a0, 2); mov(bl, al);                            /* mov bl, al */
            ii(0x1019_03a2, 3); shr(bl, 4);                             /* shr bl, 0x4 */
        ...
        l_0x1019_03bb:
            ii(0x1019_03bb, 3); add(edi, memd[ss, ebp - 8]);            /* add edi, [ebp-0x8] */
            ii(0x1019_03be, 3); dec(memd[ss, ebp + 28]);                /* dec dword [ebp+0x1c] */
