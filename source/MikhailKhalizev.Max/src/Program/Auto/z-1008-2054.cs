...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_2054()
        {
            ...
            ii(0x1008_206c, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_206f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_2072, 7); mov(memd[ds, eax + 0x3a], 0x1c0);       /* mov dword [eax+0x3a], 0x1c0 */
            ii(0x1008_2079, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_207b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_2094, 3); mov(ebx, memd[ss, ebp - 0x4]);          /* mov ebx, [ebp-0x4] */
            ii(0x1008_2097, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_2099, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_20b5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
