...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_3cae()
        {
            ...
            ii(0x1019_3cc3, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ...
            ii(0x1019_3cd5, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1019_3cd8, 3); imul(eax, eax, 0x7);                    /* imul eax, eax, 0x7 */
            ii(0x1019_3cdb, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1019_3cde, 3); add(eax, memd[ss, ebp - 0x8]);          /* add eax, [ebp-0x8] */
            ii(0x1019_3ce1, 3); sub(eax, memd[ss, ebp - 0x4]);          /* sub eax, [ebp-0x4] */
            ...
            ii(0x1019_3cfe, 3); sub(eax, memd[ss, ebp - 0x4]);          /* sub eax, [ebp-0x4] */
            ...
            ii(0x1019_3d08, 3); add(eax, memd[ss, ebp - 0x4]);          /* add eax, [ebp-0x4] */
            ii(0x1019_3d0b, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x1019_3d0e, 4); cmp(memd[ss, ebp + 0x8], 0);            /* cmp dword [ebp+0x8], 0x0 */
            ii(0x1019_3d12, 2); if(jz(0x1019_3d1c, 0x8)) goto l_0x1019_3d1c; /* jz 0x10193d1c */
            ii(0x1019_3d14, 6); mov(esi, memd[ds, 0x1020_9cd8]);        /* mov esi, [0x10209cd8] */
            ii(0x1019_3d1a, 2); jmp(0x1019_3d22, 0x6); goto l_0x1019_3d22; /* jmp 0x10193d22 */
        l_0x1019_3d1c:
        ...
        l_0x1019_3d22:
            ...
            ii(0x1019_3d38, 4); and(memd[ss, ebp + 0x20], -0x4 /* 0xfc */); /* and dword [ebp+0x20], 0xfffffffc */
