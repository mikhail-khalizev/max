...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_3cae()
        {
            ...
            ii(0x1019_3cbd, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ...
            ii(0x1019_3cdb, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1019_3cde, 3);  add(eax, memd[ss, ebp - 8]);          /* add eax, [ebp-0x8] */
            ii(0x1019_3ce1, 3);  sub(eax, memd[ss, ebp - 4]);          /* sub eax, [ebp-0x4] */
            ii(0x1019_3ce4, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1019_3ce7, 5);  mov(eax, memd[ds, Definitions.video_bytes_per_line]);/* mov eax, [0x10209c98] */
            ii(0x1019_3cec, 2);  mul(ebx);                             /* mul ebx */
            ii(0x1019_3cee, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1019_3cf1, 3);  imul(eax, eax, 7);                    /* imul eax, eax, 0x7 */
            ii(0x1019_3cf4, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1019_3cf7, 1);  dec(eax);                             /* dec eax */
            ii(0x1019_3cf8, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1019_3cfb, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1019_3cfe, 3);  sub(eax, memd[ss, ebp - 4]);          /* sub eax, [ebp-0x4] */
            ii(0x1019_3d01, 1);  inc(eax);                             /* inc eax */
            ii(0x1019_3d02, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x1019_3d05, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x1019_3d08, 3);  add(eax, memd[ss, ebp - 4]);          /* add eax, [ebp-0x4] */
            ii(0x1019_3d0b, 3);  mov(memd[ss, ebp - 36], eax);         /* mov [ebp-0x24], eax */
        ...
        l_0x1019_3d22:
            ii(0x1019_3d22, 3);  mov(eax, memd[ss, ebp + 16]);         /* mov eax, [ebp+0x10] */
            ...
            ii(0x1019_3d30, 3);  mov(eax, memd[ss, ebp + 12]);         /* mov eax, [ebp+0xc] */
            ii(0x1019_3d33, 3);  shl(eax, 4);                          /* shl eax, 0x4 */
            ii(0x1019_3d36, 2);  add(esi, eax);                        /* add esi, eax */
            ii(0x1019_3d38, 4);  and(memd[ss, ebp + 32], -4 /* 0xfc */);/* and dword [ebp+0x20], 0xfffffffc */
            ii(0x1019_3d3c, 3);  mov(ebx, memd[ss, ebp + 28]);         /* mov ebx, [ebp+0x1c] */
