...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_f012()
        {
            ...
            ii(0x1009_f02a, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_f02d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1009_f03a, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1009_f03d, 5); call(0x1007_64b8, -0x2_8b8a);           /* call 0x100764b8 */
            ii(0x1009_f042, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_f044, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x1009_f050, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_f053, 3); mov(eax, memd[ds, eax + 0x1f]);         /* mov eax, [eax+0x1f] */
            ii(0x1009_f056, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1009_f059, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1009_f05b, 2); if(jz(0x1009_f062, 0x5)) goto l_0x1009_f062; /* jz 0x1009f062 */
        l_0x1009_f05d:
        ...
        l_0x1009_f062:
            ...
            ii(0x1009_f069, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1009_f06c, 5); call(0x1007_63d4, -0x2_8c9d);           /* call 0x100763d4 */
            ii(0x1009_f071, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1009_f073, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_f076, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1009_f08e, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1009_f091, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_f094, 3); mov(eax, memd[ds, eax + 0x7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1009_f0ac, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1009_f0af, 7); mov(memd[ss, ebp - 0x14], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x1009_f0b6, 4); cmp(memd[ss, ebp - 0xc], 0);            /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1009_f0ba, 2); if(jz(0x1009_f0c2, 0x6)) goto l_0x1009_f0c2; /* jz 0x1009f0c2 */
            ii(0x1009_f0bc, 4); cmp(memd[ss, ebp - 0x10], 0);           /* cmp dword [ebp-0x10], 0x0 */
            ii(0x1009_f0c0, 2); if(jnz(0x1009_f0c7, 0x5)) goto l_0x1009_f0c7; /* jnz 0x1009f0c7 */
        l_0x1009_f0c2:
            ii(0x1009_f0c2, 5); jmp(0x1009_f183, 0xbc); goto l_0x1009_f183; /* jmp 0x1009f183 */
        l_0x1009_f0c7:
            ii(0x1009_f0c7, 7); mov(memd[ss, ebp - 0x18], 0);           /* mov dword [ebp-0x18], 0x0 */
            ii(0x1009_f0ce, 2); jmp(0x1009_f0d6, 0x6); goto l_0x1009_f0d6; /* jmp 0x1009f0d6 */
        l_0x1009_f0d0:
            ii(0x1009_f0d0, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ii(0x1009_f0d3, 3); inc(memd[ss, ebp - 0x18]);              /* inc dword [ebp-0x18] */
        l_0x1009_f0d6:
            ii(0x1009_f0d6, 3); mov(eax, memd[ss, ebp - 0x18]);         /* mov eax, [ebp-0x18] */
            ...
            ii(0x1009_f0e2, 7); mov(memd[ss, ebp - 0x1c], 0);           /* mov dword [ebp-0x1c], 0x0 */
            ii(0x1009_f0e9, 2); jmp(0x1009_f0f1, 0x6); goto l_0x1009_f0f1; /* jmp 0x1009f0f1 */
        l_0x1009_f0eb:
            ii(0x1009_f0eb, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ii(0x1009_f0ee, 3); inc(memd[ss, ebp - 0x1c]);              /* inc dword [ebp-0x1c] */
        l_0x1009_f0f1:
            ii(0x1009_f0f1, 3); mov(eax, memd[ss, ebp - 0x1c]);         /* mov eax, [ebp-0x1c] */
            ...
            ii(0x1009_f0fd, 4); movsx(eax, memw[ss, ebp - 0x18]);       /* movsx eax, word [ebp-0x18] */
            ii(0x1009_f101, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1009_f104, 3); add(eax, memd[ss, ebp - 0x10]);         /* add eax, [ebp-0x10] */
            ii(0x1009_f107, 4); movsx(edx, memw[ss, ebp - 0x1c]);       /* movsx edx, word [ebp-0x1c] */
            ...
            ii(0x1009_f116, 4); movsx(eax, memw[ss, ebp - 0x18]);       /* movsx eax, word [ebp-0x18] */
            ii(0x1009_f11a, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1009_f11d, 3); add(eax, memd[ss, ebp - 0xc]);          /* add eax, [ebp-0xc] */
            ii(0x1009_f120, 4); movsx(edx, memw[ss, ebp - 0x1c]);       /* movsx edx, word [ebp-0x1c] */
            ...
            ii(0x1009_f12f, 2); if(jle(0x1009_f133, 0x2)) goto l_0x1009_f133; /* jle 0x1009f133 */
        l_0x1009_f131:
            ii(0x1009_f131, 2); jmp(0x1009_f139, 0x6); goto l_0x1009_f139; /* jmp 0x1009f139 */
        l_0x1009_f133:
            ii(0x1009_f133, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1009_f136, 3); inc(memd[ss, ebp - 0x14]);              /* inc dword [ebp-0x14] */
        l_0x1009_f139:
        ...
        l_0x1009_f13d:
            ii(0x1009_f13d, 3); fild(memw[ss, ebp - 0x14]);             /* fild word [ebp-0x14] */
            ...
            ii(0x1009_f150, 3); fistp(memd[ss, ebp - 0x20]);            /* fistp dword [ebp-0x20] */
            ii(0x1009_f153, 3); mov(eax, memd[ss, ebp - 0x20]);         /* mov eax, [ebp-0x20] */
            ii(0x1009_f156, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1009_f159, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_f15c, 3); add(eax, 0x17);                         /* add eax, 0x17 */
            ii(0x1009_f15f, 5); call(0x1007_6b90, -0x2_85d4);           /* call 0x10076b90 */
            ii(0x1009_f164, 4); cmp(ax, memw[ss, ebp - 0x14]);          /* cmp ax, [ebp-0x14] */
            ii(0x1009_f168, 2); if(jge(0x1009_f183, 0x19)) goto l_0x1009_f183; /* jge 0x1009f183 */
            ii(0x1009_f16a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_f16d, 4); inc(memw[ds, eax + 0x21]);              /* inc word [eax+0x21] */
            ii(0x1009_f171, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_f174, 3); mov(memd[ss, ebp - 0x24], eax);         /* mov [ebp-0x24], eax */
            ii(0x1009_f177, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x1009_f17a, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x1009_f17d, 3); mov(eax, memd[ss, ebp - 0x24]);         /* mov eax, [ebp-0x24] */
            ii(0x1009_f180, 3); call_abs(memd[ds, edx + 0x78]);         /* call dword [edx+0x78] */
        l_0x1009_f183:
            ii(0x1009_f183, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_f186, 5); call(0x1009_cd8f, -0x23fc);             /* call 0x1009cd8f */
            ii(0x1009_f18b, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1009_f18d, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
