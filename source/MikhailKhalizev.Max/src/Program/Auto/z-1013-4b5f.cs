...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("735d6e5a-a1f3-465d-ade9-a45ec0dfdc39")]
        public void Method_1013_4b5f()
        {
            ii(0x1013_4b5f, 5); pushd(0x8c);                            /* push 0x8c */
            ii(0x1013_4b64, 5); calld(Definitions.sys_check_available_stack_size, 0x311e9); /* call 0x10165d52 */
            ...
            ii(0x1013_4b7c, 5); calld(Definitions.sys_new_arr, 0x3148f); /* call 0x10166010 */
        ...
        l_0x1013_4bd4:
            ...
            ii(0x1013_4be5, 5); calld(Definitions.sys_strcpy, 0x312e5); /* call 0x10165ecf */
            ii(0x1013_4bea, 5); mov(edx, 0x101a_89fc);                  /* mov edx, 0x101a89fc */ /* "patches.res" */
            ii(0x1013_4bef, 3); lea(eax, ebp - 0x70);                   /* lea eax, [ebp-0x70] */
            ii(0x1013_4bf2, 5); calld(Definitions.sys_strcat, 0x3133a); /* call 0x10165f31 */
        ...
        l_0x1013_4c1b:
            ...
            ii(0x1013_4c23, 5); calld(Definitions.sys_strcpy, 0x312a7); /* call 0x10165ecf */
            ii(0x1013_4c28, 5); mov(edx, 0x101a_8a08);                  /* mov edx, 0x101a8a08 */ /* "max.res" */
            ii(0x1013_4c2d, 3); lea(eax, ebp - 0x70);                   /* lea eax, [ebp-0x70] */
            ii(0x1013_4c30, 5); calld(Definitions.sys_strcat, 0x312fc); /* call 0x10165f31 */
        ...
        l_0x1013_4c51:
            ...
            ii(0x1013_4c56, 5); calld(Definitions.sys_new_arr, 0x313b5); /* call 0x10166010 */
        ...
        l_0x1013_4c72:
            ...
            ii(0x1013_4c77, 5); calld(Definitions.sys_new_arr, 0x31394); /* call 0x10166010 */
        ...
        l_0x1013_4c93:
            ...
            ii(0x1013_4c98, 5); calld(Definitions.sys_new_arr, 0x31373); /* call 0x10166010 */
        ...
        l_0x1013_4cc0:
            ii(0x1013_4cc0, 5); calld(0x1012_124a, -0x13a7b);           /* call 0x1012124a */
        ...
        l_0x1013_4cd4:
            ...
            ii(0x1013_4cf9, 5); calld(0x100e_90e1, -0x4bc1d);           /* call 0x100e90e1 */
