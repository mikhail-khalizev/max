...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_7e50()
        {
            ...
            ii(0x7e5b, 2);    if(jnzw(0x7e60, 0x3)) goto l_0x7e60;      /* jnz 0x56a0 */
            ii(0x7e5d, 3);    callw(0x71f1, -0xc6f);                    /* call 0x4a31 */
        l_0x7e60:
            ii(0x7e60, 4);    mov(bx, memw_a16[ds, 0x996]);             /* mov bx, [0x996] */
            ii(0x7e64, 4);    cmp(memw_a16[ds, bx + 0x18], 0x21);       /* cmp word [bx+0x18], 0x21 */
            ii(0x7e68, 2);    if(jnzw(0x7e73, 0x9)) goto l_0x7e73;      /* jnz 0x56b3 */
            ii(0x7e6a, 3);    mov(al, memb_a16[ds, bx + 0x16]);         /* mov al, [bx+0x16] */
            ii(0x7e6d, 1);    cbw();                                    /* cbw */
            ii(0x7e6e, 1);    pushw(ax);                                /* push ax */
            ii(0x7e6f, 3);    callw(0x5de2, -0x2090);                   /* call 0x3622 */
            ii(0x7e72, 1);    popw(bx);                                 /* pop bx */
        l_0x7e73:
            ii(0x7e73, 3);    callw(0x6f77, -0xeff);                    /* call 0x47b7 */
            ii(0x7e76, 3);    callw(0x7588, -0x8f1);                    /* call 0x4dc8 */
            ii(0x7e79, 4);    mov(bx, memw_a16[ds, 0x996]);             /* mov bx, [0x996] */
            ii(0x7e7d, 4);    cmp(memw_a16[ds, bx + 0x18], 0);          /* cmp word [bx+0x18], 0x0 */
            ii(0x7e81, 2);    if(jgew(0x7e86, 0x3)) goto l_0x7e86;      /* jge 0x56c6 */
            ii(0x7e83, 3);    jmpw(0x8017, 0x191); goto l_0x8017;       /* jmp 0x5857 */
        l_0x7e86:
            ii(0x7e86, 3);    mov(ax, 0xc4e);                           /* mov ax, 0xc4e */
            ii(0x7e89, 1);    pushw(ax);                                /* push ax */
            ii(0x7e8a, 3);    callw(0x7247, -0xc46);                    /* call 0x4a87 */
            ...
            ii(0x7e96, 2);    if(jnzw(0x7e9d, 0x5)) goto l_0x7e9d;      /* jnz 0x56dd */
            ii(0x7e98, 3);    mov(ax, 0xc5b);                           /* mov ax, 0xc5b */
            ii(0x7e9b, 2);    jmpw(0x7ea6, 0x9); goto l_0x7ea6;         /* jmp 0x56e6 */
        l_0x7e9d:
            ii(0x7e9d, 4);    cmp(memw_a16[ds, bx + 0x18], 0x6);        /* cmp word [bx+0x18], 0x6 */
            ii(0x7ea1, 2);    if(jnzw(0x7eac, 0x9)) goto l_0x7eac;      /* jnz 0x56ec */
            ii(0x7ea3, 3);    mov(ax, 0xc74);                           /* mov ax, 0xc74 */
        l_0x7ea6:
            ii(0x7ea6, 1);    pushw(ax);                                /* push ax */
            ii(0x7ea7, 3);    callw(0x7247, -0xc63);                    /* call 0x4a87 */
            ii(0x7eaa, 2);    jmpw(0x7ed2, 0x26); goto l_0x7ed2;        /* jmp 0x5712 */
        l_0x7eac:
            ii(0x7eac, 4);    cmp(memw_a16[ds, bx + 0x18], 0xe);        /* cmp word [bx+0x18], 0xe */
            ii(0x7eb0, 2);    if(jnzw(0x7ec7, 0x15)) goto l_0x7ec7;     /* jnz 0x5707 */
            ii(0x7eb2, 4);    pushw(memw_a16[ds, 0xd32]);               /* push word [0xd32] */
            ii(0x7eb6, 3);    mov(ax, 0xc83);                           /* mov ax, 0xc83 */
            ii(0x7eb9, 1);    pushw(ax);                                /* push ax */
            ii(0x7eba, 3);    callw(0x75f7, -0x8c6);                    /* call 0x4e37 */
        ...
        l_0x7ef6:
            ...
            ii(0x7f27, 3);    callw(0x75f7, -0x933);                    /* call 0x4e37 */
        ...
        l_0x7f47:
            ...
            ii(0x7f55, 3);    callw(0x75f7, -0x961);                    /* call 0x4e37 */
            ...
            ii(0x7f65, 3);    callw(0x75f7, -0x971);                    /* call 0x4e37 */
            ...
            ii(0x7f75, 3);    callw(0x75f7, -0x981);                    /* call 0x4e37 */
            ...
            ii(0x7f85, 3);    callw(0x75f7, -0x991);                    /* call 0x4e37 */
            ii(0x7f88, 1);    popw(bx);                                 /* pop bx */
            ii(0x7f89, 1);    popw(bx);                                 /* pop bx */
            ii(0x7f8a, 3);    callw(0x7588, -0xa05);                    /* call 0x4dc8 */
            ...
            ii(0x7f98, 3);    callw(0x75f7, -0x9a4);                    /* call 0x4e37 */
            ...
            ii(0x7fa8, 3);    callw(0x75f7, -0x9b4);                    /* call 0x4e37 */
            ...
            ii(0x7fb8, 3);    callw(0x75f7, -0x9c4);                    /* call 0x4e37 */
            ...
            ii(0x7fc8, 3);    callw(0x75f7, -0x9d4);                    /* call 0x4e37 */
            ...
            ii(0x7fd8, 3);    callw(0x75f7, -0x9e4);                    /* call 0x4e37 */
            ...
            ii(0x7fe8, 3);    callw(0x75f7, -0x9f4);                    /* call 0x4e37 */
            ...
            ii(0x7ff8, 3);    callw(0x75f7, -0xa04);                    /* call 0x4e37 */
            ...
            ii(0x8008, 3);    callw(0x75f7, -0xa14);                    /* call 0x4e37 */
            ii(0x800b, 1);    popw(bx);                                 /* pop bx */
            ii(0x800c, 1);    popw(bx);                                 /* pop bx */
            ii(0x800d, 5);    test(memb_a16[ds, 0x15], 0x80);           /* test byte [0x15], 0x80 */
            ii(0x8012, 2);    if(jzw(0x8017, 0x3)) goto l_0x8017;       /* jz 0x5857 */
            ii(0x8014, 3);    callw(0x702a, -0xfed);                    /* call 0x486a */
        l_0x8017:
            ii(0x8017, 3);    mov(ax, 0xffff);                          /* mov ax, 0xffff */
            ii(0x801a, 1);    pushw(ax);                                /* push ax */
            ii(0x801b, 3);    callw(0x5de2, -0x223c);                   /* call 0x3622 */
