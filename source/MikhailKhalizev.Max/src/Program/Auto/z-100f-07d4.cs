...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x100f_07d4, 5); push(0x34);                             /* push 0x34 */
            ii(0x100f_07d9, 5); call(Definitions.sys_check_available_stack_size, 0x7_5574); /* call 0x10165d52 */
            ii(0x100f_07de, 1); push(esi);                              /* push esi */
            ii(0x100f_07df, 1); push(edi);                              /* push edi */
            ...
            ii(0x100f_0815, 5); call(Definitions.sys_printf, 0x7_be22); /* call 0x1016c63c */
            ii(0x100f_081a, 3); add(esp, 0x14);                         /* add esp, 0x14 */
            ii(0x100f_081d, 5); mov(eax, 0xa);                          /* mov eax, 0xa */
            ii(0x100f_0822, 5); call(Definitions.sys_exit, 0x7_be38);   /* call 0x1016c65f */
            ii(0x100f_0827, 2); mov(esp, ebp);                          /* mov esp, ebp */
            ii(0x100f_0829, 1); pop(ebp);                               /* pop ebp */
            ii(0x100f_082a, 1); pop(edi);                               /* pop edi */
            ii(0x100f_082b, 1); pop(esi);                               /* pop esi */
            ii(0x100f_082c, 1); ret();                                  /* ret */
        }
    }
}
