...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("7399c204-1184-46f4-9d7c-3f1cfbbd6b65")]
        public void Method_100c_a02c()
        {
            ii(0x100c_a02c, 5); pushd(0x24);                            /* push 0x24 */
            ii(0x100c_a031, 5); calld(Definitions.sys_check_available_stack_size, 0x9_bd1c); /* call 0x10165d52 */
            ...
            ii(0x100c_a047, 5); calld(0x1008_b3ec, -0x3_ec60);          /* call 0x1008b3ec */
            ii(0x100c_a04c, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x100c_a04f, 3); mov(eax, memd_a32[ss, ebp - 0x4]);      /* mov eax, [ebp-0x4] */
            ii(0x100c_a052, 5); calld(0x1008_b1e4, -0x3_ee73);          /* call 0x1008b1e4 */
