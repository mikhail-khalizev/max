...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_a02c()
        {
            ...
            ii(0x100c_a044, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_a047, 5); call(0x1008_b3ec, -0x3_ec60);           /* call 0x1008b3ec */
            ii(0x100c_a04c, 3); movsx(edx, ax);                         /* movsx edx, ax */
            ii(0x100c_a04f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_a052, 5); call(0x1008_b1e4, -0x3_ee73);           /* call 0x1008b1e4 */
            ii(0x100c_a057, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_a05a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
