...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("5a22476c-abdf-4467-8ea0-56540abe6c14")]
        ...
        l_0x91d3:
            ...
            ii(0x91de, 3);    jmpw(0x9262, 0x81); goto l_0x9262;        /* jmp 0x9262 */
        l_0x91e1:
        ...
        l_0x91e9:
            ...
            ii(0x91eb, 2);    jmpw(0x91d3, -0x1a); goto l_0x91d3;       /* jmp 0x91d3 */
        l_0x91ed:
            ii(0x91ed, 3);    callw(0x90c6, -0x12a);                    /* call 0x90c6 */
            ii(0x91f0, 3);    cmp(ax, 0x52);                            /* cmp ax, 0x52 */
            ii(0x91f3, 2);    jmpw(0x91e9, -0xc); goto l_0x91e9;        /* jmp 0x91e9 */
        l_0x91f5:
        ...
        l_0x9210:
            ...
            ii(0x9213, 2);    jmpw(0x9275, 0x60); goto l_0x9275;        /* jmp 0x9275 */
        l_0x9215:
        ...
        l_0x921a:
            ...
            ii(0x921c, 2);    jmpw(0x9275, 0x57); goto l_0x9275;        /* jmp 0x9275 */
        l_0x921e:
            ...
            ii(0x922b, 2);    jmpw(0x922e, 0x1); goto l_0x922e;         /* jmp 0x922e */
        l_0x922d:
        ...
        l_0x922e:
            ...
            ii(0x9255, 3);    jmpw(0x91d3, -0x85); goto l_0x91d3;       /* jmp 0x91d3 */
        l_0x9258:
            ii(0x9258, 2);    jmpw(0x921a, -0x40); goto l_0x921a;       /* jmp 0x921a */
        l_0x925a:
            ii(0x925a, 3);    cmp(si, -0x2 /* 0xfe */);                 /* cmp si, 0xfffe */
            ii(0x925d, 2);    if(jnzw(0x9201, -0x5e)) goto l_0x9201;    /* jnz 0x9201 */
            ii(0x925f, 3);    jmpw(0x91d3, -0x8f); goto l_0x91d3;       /* jmp 0x91d3 */
        l_0x9262:
