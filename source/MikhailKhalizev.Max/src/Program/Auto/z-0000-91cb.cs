...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x91d3:
            ...
            ii(0x91dc, 2);    if(jnz(0x91e1, 0x3)) goto l_0x91e1;       /* jnz 0x91e1 */
            ii(0x91de, 3);    jmp(0x9262, 0x81); goto l_0x9262;         /* jmp 0x9262 */
        l_0x91e1:
            ii(0x91e1, 3);    sub(ax, 0xa);                             /* sub ax, 0xa */
            ii(0x91e4, 2);    if(jz(0x91ed, 0x7)) goto l_0x91ed;        /* jz 0x91ed */
        ...
        l_0x9201:
            ...
            ii(0x9206, 3);    cmp(si, memw[ss, bp + 0x4]);              /* cmp si, [bp+0x4] */
            ii(0x9209, 2);    if(jz(0x9210, 0x5)) goto l_0x9210;        /* jz 0x9210 */
            ii(0x920b, 3);    cmp(si, -0x3 /* 0xfd */);                 /* cmp si, 0xfffd */
            ii(0x920e, 2);    if(jnz(0x9215, 0x5)) goto l_0x9215;       /* jnz 0x9215 */
        l_0x9210:
        ...
        l_0x9215:
            ...
            ii(0x9218, 2);    if(jnz(0x921e, 0x4)) goto l_0x921e;       /* jnz 0x921e */
        l_0x921a:
        ...
        l_0x921e:
            ...
            ii(0x922b, 2);    jmp(0x922e, 0x1); goto l_0x922e;          /* jmp 0x922e */
        l_0x922d:
        ...
        l_0x922e:
            ...
            ii(0x923e, 5);    mov(memw[ds, bx + 0x2], 0);               /* mov word [bx+0x2], 0x0 */
            ...
            ii(0x9253, 2);    if(jl(0x9258, 0x3)) goto l_0x9258;        /* jl 0x9258 */
        ...
        l_0x9262:
            ...
            ii(0x926a, 2);    if(jnz(0x926f, 0x3)) goto l_0x926f;       /* jnz 0x926f */
