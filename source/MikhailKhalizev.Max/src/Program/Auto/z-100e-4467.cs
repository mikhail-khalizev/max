...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("e038b72c-251b-4dd4-a93c-0a0730dee0e0")]
        public void Method_100e_4467()
        {
            ii(0x100e_4467, 5); pushd(0x3c);                            /* push 0x3c */
            ii(0x100e_446c, 5); calld(Definitions.sys_check_available_stack_size, 0x818e1); /* call 0x10165d52 */
            ...
            ii(0x100e_448c, 5); calld(Definitions.sys_memset, 0x8194f); /* call 0x10165de0 */
            ...
            ii(0x100e_44ac, 5); calld(/* sys */ 0x1016_c606, 0x88155);  /* call 0x1016c606 */
