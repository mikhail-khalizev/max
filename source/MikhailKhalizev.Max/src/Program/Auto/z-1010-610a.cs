...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_610a()
        {
            ...
            ii(0x1010_6120, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1010_6123, 3); mov(memb[ss, ebp - 0x4], dl);           /* mov [ebp-0x4], dl */
            ii(0x1010_6126, 3); mov(memd[ss, ebp - 0x8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1010_6129, 4); cmp(memb[ss, ebp - 0x4], 0x76);         /* cmp byte [ebp-0x4], 0x76 */
            ii(0x1010_612d, 6); if(jge(0x1010_61aa, 0x77)) goto l_0x1010_61aa; /* jge 0x101061aa */
            ii(0x1010_6133, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ii(0x1010_6137, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_613a, 3); add(eax, memd[ss, ebp - 0xc]);          /* add eax, [ebp-0xc] */
            ii(0x1010_613d, 6); mov(eax, memd[ds, eax + 0xac]);         /* mov eax, [eax+0xac] */
            ii(0x1010_6143, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x1010_6146, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ii(0x1010_614a, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x1010_614d, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1010_6150, 2); add(edx, eax);                          /* add edx, eax */
            ii(0x1010_6152, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_6155, 6); mov(memd[ds, edx + 0xac], eax);         /* mov [edx+0xac], eax */
            ii(0x1010_615b, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ii(0x1010_615f, 5); call(0x1010_60b4, -0xb0);               /* call 0x101060b4 */
            ii(0x1010_6164, 1); push(eax);                              /* push eax */
            ii(0x1010_6165, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1010_6175, 4); movsx(eax, memb[ss, ebp - 0x4]);        /* movsx eax, byte [ebp-0x4] */
            ...
            ii(0x1010_6182, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1010_6192, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_6195, 1); push(eax);                              /* push eax */
            ii(0x1010_6196, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
        ...
        l_0x1010_61a2:
            ii(0x1010_61a2, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x1010_61a5, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1010_61a8, 2); jmp(0x1010_61b1, 0x7); goto l_0x1010_61b1; /* jmp 0x101061b1 */
        l_0x1010_61aa:
            ii(0x1010_61aa, 7); mov(memd[ss, ebp - 0x14], 0);           /* mov dword [ebp-0x14], 0x0 */
        l_0x1010_61b1:
            ii(0x1010_61b1, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
