...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_68a8()
        {
            ...
            ii(0x1018_68f4, 8);  /* jmp dword [cs:eax*4+0x10186898] */
        ...
        l_0x1018_68fc:
            ii(0x1018_68fc, 3);  lea(edx, memd[ds, ecx + 12]);         /* lea edx, [ecx+0xc] */
            ...
            ii(0x1018_690f, 3);  lea(edx, memd[ds, ecx + 16]);         /* lea edx, [ecx+0x10] */
            ...
            ii(0x1018_691e, 3);  lea(edx, memd[ds, ecx + 20]);         /* lea edx, [ecx+0x14] */
        ...
        l_0x1018_692f:
            ii(0x1018_692f, 3);  lea(edx, memd[ds, ecx + 12]);         /* lea edx, [ecx+0xc] */
        ...
        l_0x1018_6940:
            ii(0x1018_6940, 3);  lea(edx, memd[ds, ecx + 12]);         /* lea edx, [ecx+0xc] */
            ...
            ii(0x1018_694f, 3);  lea(edx, memd[ds, ecx + 16]);         /* lea edx, [ecx+0x10] */
            ...
            ii(0x1018_695e, 3);  lea(edx, memd[ds, ecx + 20]);         /* lea edx, [ecx+0x14] */
