...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_063e()
        {
            ...
            ii(0x1008_0655, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_0658, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1008_065b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_065e, 5); call(0x1007_f76b, -0xef8);              /* call 0x1007f76b */
            ii(0x1008_0663, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1008_0667, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
