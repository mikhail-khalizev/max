...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_ba3d()
        {
            ...
            ii(0x1011_ba55, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_ba58, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1011_ba5a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1011_ba5c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_ba5f, 5); call(0x1011_80b5, -0x39af);             /* call 0x101180b5 */
            ii(0x1011_ba64, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_ba67, 3); lea(eax, memd[ss, ebp - 0x4]);          /* lea eax, [ebp-0x4] */
            ii(0x1011_ba6a, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_ba6d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_ba70, 7); mov(memd[ds, eax + 0x2], 0x101b_68dc);  /* mov dword [eax+0x2], 0x101b68dc */
            ii(0x1011_ba77, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_ba7a, 6); mov(memw[ds, eax + 0x16], 0x1);         /* mov word [eax+0x16], 0x1 */
            ii(0x1011_ba80, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_ba83, 6); mov(memw[ds, eax + 0x18], 0x1);         /* mov word [eax+0x18], 0x1 */
            ii(0x1011_ba89, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_ba8c, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1011_ba8f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
