...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0xf678:
            ii(0xf678, 5);    mov(memw[ss, bp - 20], 3);                /* mov word [bp-0x14], 0x3 */
        l_0xf67d:
            ...
            ii(0xf694, 3);    mov(memw[ss, bp - 12], ax);               /* mov [bp-0xc], ax */
            ii(0xf697, 3);    mov(memw[ss, bp - 10], dx);               /* mov [bp-0xa], dx */
            ii(0xf69a, 5);    mov(memw[ss, bp - 14], 3);                /* mov word [bp-0xe], 0x3 */
        l_0xf69f:
        ...
        l_0xf6b5:
            ...
            ii(0xf6bb, 3);    mov(memw[ss, bp - 12], ax);               /* mov [bp-0xc], ax */
            ii(0xf6be, 3);    mov(memw[ss, bp - 10], dx);               /* mov [bp-0xa], dx */
        l_0xf6c1:
            ii(0xf6c1, 4);    cmp(memw[ss, bp - 10], 0);                /* cmp word [bp-0xa], 0x0 */
            ii(0xf6c5, 2);    if(jg(0xf6cf, 8)) goto l_0xf6cf;          /* jg 0xf6cf */
            ii(0xf6c7, 2);    if(jl(0xf658, -0x71)) goto l_0xf658;      /* jl 0xf658 */
            ii(0xf6c9, 4);    cmp(memw[ss, bp - 12], 0);                /* cmp word [bp-0xc], 0x0 */
            ii(0xf6cd, 2);    if(jz(0xf658, -0x77)) goto l_0xf658;      /* jz 0xf658 */
        l_0xf6cf:
            ii(0xf6cf, 3);    push(memw[ss, bp - 10]);                  /* push word [bp-0xa] */
            ii(0xf6d2, 3);    push(memw[ss, bp - 12]);                  /* push word [bp-0xc] */
            ...
            ii(0xf6eb, 3);    dec(memw[ss, bp - 14]);                   /* dec word [bp-0xe] */
            ii(0xf6ee, 2);    if(jns(0xf6f3, 3)) goto l_0xf6f3;         /* jns 0xf6f3 */
            ii(0xf6f0, 3);    jmp(0xf658, -0x9b); goto l_0xf658;        /* jmp 0xf658 */
        l_0xf6f3:
            ii(0xf6f3, 3);    sar(memw[ss, bp - 10], 1);                /* sar word [bp-0xa], 1 */
            ii(0xf6f6, 3);    rcr(memw[ss, bp - 12], 1);                /* rcr word [bp-0xc], 1 */
        ...
        l_0xf6fb:
            ...
            ii(0xf704, 3);    mov(memw[ss, bp - 18], ax);               /* mov [bp-0x12], ax */
            ii(0xf707, 3);    mov(memw[ss, bp - 16], dx);               /* mov [bp-0x10], dx */
            ii(0xf70a, 1);    cli();                                    /* cli */
            ii(0xf70b, 3);    mov(ax, memw[ss, bp - 18]);               /* mov ax, [bp-0x12] */
            ii(0xf70e, 3);    mov(dx, memw[ss, bp - 16]);               /* mov dx, [bp-0x10] */
        ...
        l_0xf728:
            ...
            ii(0xf735, 3);    mov(ax, memw[ss, bp - 18]);               /* mov ax, [bp-0x12] */
            ii(0xf738, 3);    mov(dx, memw[ss, bp - 16]);               /* mov dx, [bp-0x10] */
            ...
            ii(0xf758, 3);    push(memw[ss, bp - 16]);                  /* push word [bp-0x10] */
            ii(0xf75b, 3);    push(memw[ss, bp - 18]);                  /* push word [bp-0x12] */
            ii(0xf75e, 3);    call(0xfb27, 0x3c6);                      /* call 0xfb27 */
            ii(0xf761, 3);    add(sp, 0xa);                             /* add sp, 0xa */
            ii(0xf764, 4);    add(memw[ss, bp - 18], 1);                /* add word [bp-0x12], 0x1 */
            ii(0xf768, 4);    adc(memw[ss, bp - 16], 0);                /* adc word [bp-0x10], 0x0 */
            ii(0xf76c, 4);    sub(memw[ss, bp - 12], 0x10);             /* sub word [bp-0xc], 0x10 */
            ii(0xf770, 4);    sbb(memw[ss, bp - 10], 0);                /* sbb word [bp-0xa], 0x0 */
        l_0xf774:
            ii(0xf774, 3);    push(memw[ss, bp - 10]);                  /* push word [bp-0xa] */
            ii(0xf777, 3);    push(memw[ss, bp - 12]);                  /* push word [bp-0xc] */
            ii(0xf77a, 3);    call(0xfb7c, 0x3ff);                      /* call 0xfb7c */
            ii(0xf77d, 1);    pop(bx);                                  /* pop bx */
            ii(0xf77e, 1);    pop(bx);                                  /* pop bx */
            ii(0xf77f, 3);    add(ax, memw[ss, bp - 18]);               /* add ax, [bp-0x12] */
            ii(0xf782, 3);    adc(dx, memw[ss, bp - 16]);               /* adc dx, [bp-0x10] */
        ...
        l_0xf7a0:
            ii(0xf7a0, 3);    push(memw[ss, bp - 10]);                  /* push word [bp-0xa] */
            ii(0xf7a3, 3);    push(memw[ss, bp - 12]);                  /* push word [bp-0xc] */
            ...
            ii(0xf7ad, 3);    push(memw[ss, bp - 16]);                  /* push word [bp-0x10] */
            ii(0xf7b0, 3);    push(memw[ss, bp - 18]);                  /* push word [bp-0x12] */
            ...
            ii(0xf7c8, 3);    push(memw[ss, bp - 16]);                  /* push word [bp-0x10] */
            ii(0xf7cb, 3);    push(memw[ss, bp - 18]);                  /* push word [bp-0x12] */
        ...
        l_0xf7d1:
            ...
            ii(0xf7d8, 3);    mov(ax, memw[ss, bp - 12]);               /* mov ax, [bp-0xc] */
            ii(0xf7db, 3);    mov(dx, memw[ss, bp - 10]);               /* mov dx, [bp-0xa] */
            ii(0xf7de, 4);    add(memw[ds, 0xaa8], ax);                 /* add [0xaa8], ax */
            ii(0xf7e2, 4);    adc(memw[ds, 0xaaa], dx);                 /* adc [0xaaa], dx */
        l_0xf7e6:
            ii(0xf7e6, 3);    dec(memw[ss, bp - 20]);                   /* dec word [bp-0x14] */
            ii(0xf7e9, 4);    cmp(memw[ss, bp - 20], 0);                /* cmp word [bp-0x14], 0x0 */
