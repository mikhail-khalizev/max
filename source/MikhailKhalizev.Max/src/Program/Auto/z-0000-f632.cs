...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_f632()
        {
            ...
            ii(0xf64b, 3);    mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0xf64e, 3);    mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0xf651, 5);    cmp(memb[ds, 0x2e], 0xb);                 /* cmp byte [0x2e], 0xb */
            ii(0xf656, 2);    if(jnz(0xf661, 0x9)) goto l_0xf661;       /* jnz 0xf661 */
        l_0xf658:
        ...
        l_0xf661:
            ii(0xf661, 3);    mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0xf664, 3);    mov(dx, memw[ss, bp - 0x2]);              /* mov dx, [bp-0x2] */
        ...
        l_0xf678:
            ii(0xf678, 5);    mov(memw[ss, bp - 0x14], 0x3);            /* mov word [bp-0x14], 0x3 */
        l_0xf67d:
            ii(0xf67d, 3);    mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
            ii(0xf680, 3);    mov(dx, memw[ss, bp + 0x6]);              /* mov dx, [bp+0x6] */
            ...
            ii(0xf69a, 5);    mov(memw[ss, bp - 0xe], 0x3);             /* mov word [bp-0xe], 0x3 */
        l_0xf69f:
            ii(0xf69f, 4);    call_abs(memw[ds, 0xaa4]);                /* call word [0xaa4] */
            ii(0xf6a3, 3);    mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0xf6a6, 3);    mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
            ii(0xf6a9, 3);    cmp(dx, memw[ss, bp - 0xa]);              /* cmp dx, [bp-0xa] */
            ii(0xf6ac, 2);    if(jg(0xf6c1, 0x13)) goto l_0xf6c1;       /* jg 0xf6c1 */
            ii(0xf6ae, 2);    if(jl(0xf6b5, 0x5)) goto l_0xf6b5;        /* jl 0xf6b5 */
            ii(0xf6b0, 3);    cmp(ax, memw[ss, bp - 0xc]);              /* cmp ax, [bp-0xc] */
            ii(0xf6b3, 2);    if(jae(0xf6c1, 0xc)) goto l_0xf6c1;       /* jae 0xf6c1 */
        l_0xf6b5:
            ii(0xf6b5, 4);    cmp(memw[ss, bp + 0x8], 0);               /* cmp word [bp+0x8], 0x0 */
        ...
        l_0xf6c1:
            ...
            ii(0xf6c5, 2);    if(jg(0xf6cf, 0x8)) goto l_0xf6cf;        /* jg 0xf6cf */
        ...
        l_0xf6cf:
            ...
            ii(0xf6db, 3);    mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0xf6de, 3);    mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0xf6e1, 2);    or(dx, ax);                               /* or dx, ax */
            ii(0xf6e3, 2);    if(jnz(0xf6fb, 0x16)) goto l_0xf6fb;      /* jnz 0xf6fb */
            ii(0xf6e5, 4);    cmp(memw[ss, bp + 0x8], 0);               /* cmp word [bp+0x8], 0x0 */
            ii(0xf6e9, 2);    if(jz(0xf6f3, 0x8)) goto l_0xf6f3;        /* jz 0xf6f3 */
            ii(0xf6eb, 3);    dec(memw[ss, bp - 0xe]);                  /* dec word [bp-0xe] */
            ii(0xf6ee, 2);    if(jns(0xf6f3, 0x3)) goto l_0xf6f3;       /* jns 0xf6f3 */
            ii(0xf6f0, 3);    jmp(0xf658, -0x9b); goto l_0xf658;        /* jmp 0xf658 */
        l_0xf6f3:
            ii(0xf6f3, 3);    sar(memw[ss, bp - 0xa], 0x1);             /* sar word [bp-0xa], 1 */
            ii(0xf6f6, 3);    rcr(memw[ss, bp - 0xc], 0x1);             /* rcr word [bp-0xc], 1 */
            ii(0xf6f9, 2);    jmp(0xf69f, -0x5c); goto l_0xf69f;        /* jmp 0xf69f */
        l_0xf6fb:
            ii(0xf6fb, 3);    push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ...
            ii(0xf717, 2);    if(jb(0xf71f, 0x6)) goto l_0xf71f;        /* jb 0xf71f */
            ii(0xf719, 4);    cmp(memw[ds, 0x98], ax);                  /* cmp [0x98], ax */
            ii(0xf71d, 2);    if(ja(0xf728, 0x9)) goto l_0xf728;        /* ja 0xf728 */
        l_0xf71f:
        ...
        l_0xf728:
            ...
            ii(0xf72f, 3);    mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0xf732, 3);    mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
            ...
            ii(0xf742, 3);    push(memw[ss, bp - 0x6]);                 /* push word [bp-0x6] */
            ii(0xf745, 3);    push(memw[ss, bp - 0x8]);                 /* push word [bp-0x8] */
            ...
            ii(0xf764, 4);    add(memw[ss, bp - 0x12], 0x1);            /* add word [bp-0x12], 0x1 */
        ...
        l_0xf774:
            ...
            ii(0xf785, 3);    mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0xf788, 3);    mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0xf78b, 4);    cmp(memw[ds, 0x9e], dx);                  /* cmp [0x9e], dx */
            ii(0xf78f, 2);    if(ja(0xf7a0, 0xf)) goto l_0xf7a0;        /* ja 0xf7a0 */
            ii(0xf791, 2);    if(jb(0xf799, 0x6)) goto l_0xf799;        /* jb 0xf799 */
            ii(0xf793, 4);    cmp(memw[ds, 0x9c], ax);                  /* cmp [0x9c], ax */
            ii(0xf797, 2);    if(jae(0xf7a0, 0x7)) goto l_0xf7a0;       /* jae 0xf7a0 */
        l_0xf799:
        ...
        l_0xf7e6:
            ...
            ii(0xf7ed, 2);    if(jg(0xf7f2, 0x3)) goto l_0xf7f2;        /* jg 0xf7f2 */
