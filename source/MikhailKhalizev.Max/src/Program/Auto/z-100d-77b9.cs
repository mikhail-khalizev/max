...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_77b9()
        {
            ...
            ii(0x100d_77ca, 6); sub(esp, 8);                            /* sub esp, 0x8 */
            ii(0x100d_77d0, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x100d_77d3, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x100d_77d6, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x100d_77d9, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x100d_77dc, 4); mov(memw[ds, edx + 45], ax);            /* mov [edx+0x2d], ax */
