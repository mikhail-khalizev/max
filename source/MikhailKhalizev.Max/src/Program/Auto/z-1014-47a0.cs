...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_47a0()
        {
            ...
            ii(0x1014_47b7, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_47ba, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_47bd, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_47c0, 3); mov(eax, memd[ds, eax + 0x42]);         /* mov eax, [eax+0x42] */
            ii(0x1014_47c3, 5); call(0x100c_fbbe, -0x7_4c0a);           /* call 0x100cfbbe */
            ii(0x1014_47c8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_47cb, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1014_47ce, 7); add(memw[ds, edx + 0x152], ax);         /* add [edx+0x152], ax */
            ii(0x1014_47d5, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_47d8, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1014_47db, 7); sub(memw[ds, edx + 0x15c], ax);         /* sub [edx+0x15c], ax */
            ii(0x1014_47e2, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1014_47ef, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_47f2, 4); add(memw[ds, edx + 0xc], ax);           /* add [edx+0xc], ax */
            ii(0x1014_47f6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
