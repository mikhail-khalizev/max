...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_a7de()
        {
            ...
            ii(0x18_a800, 3); mov(memw[ds, bx + 0x22], ss);             /* mov [bx+0x22], ss */
            ii(0x18_a803, 3); mov(memw[ds, bx + 0x26], bp);             /* mov [bx+0x26], bp */
            ...
            ii(0x18_a817, 5); if(jmp_abs(memw[cs, di + 0x66a])) return; /* jmp word [cs:di+0x66a] */
        l_0x18_a81c:
            ...
            ii(0x18_a824, 3); lea(di, memw[ss, bp + 0x8]);              /* lea di, [bp+0x8] */
            ii(0x18_a827, 3); lea(si, memw[ds, bx + 0x8]);              /* lea si, [bx+0x8] */
        ...
        l_0x18_a840:
            ii(0x18_a840, 3); lea(sp, memw[ss, bp - 0x4]);              /* lea sp, [bp-0x4] */
