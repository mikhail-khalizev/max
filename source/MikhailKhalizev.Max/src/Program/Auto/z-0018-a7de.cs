...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("ecf56cb1-5b89-4f90-9839-f8666fe83163")]
        public void Method_0018_a7de()
        {
            ii(0x18_a7de, 1); cli();                                    /* cli */
            ii(0x18_a7df, 1); pushw(di);                                /* push di */
            ii(0x18_a7e0, 4); sub(di, 0x180);                           /* sub di, 0x180 */
            ii(0x18_a7e4, 2); mov(bp, sp);                              /* mov bp, sp */
            ii(0x18_a7e6, 2); mov(si, sp);                              /* mov si, sp */
            ii(0x18_a7e8, 1); pushw(cx);                                /* push cx */
            ii(0x18_a7e9, 5); pushw(memw_a16[es, 0xf52]);               /* push word [es:0xf52] */
            ii(0x18_a7ee, 2); mov(bx, di);                              /* mov bx, di */
            ii(0x18_a7f0, 1); cld();                                    /* cld */
            ii(0x18_a7f1, 3); mov(cx, 0xc);                             /* mov cx, 0xc */
            ii(0x18_a7f4, 2); rep_a16(() => movsw_a16());               /* rep movsw */
            ii(0x18_a7f6, 2); mov(ds, dx);                              /* mov ds, dx */
            ii(0x18_a7f8, 4); mov(memw_a16[ds, 0x99e], bx);             /* mov [0x99e], bx */
            ii(0x18_a7fc, 4); mov(memw_a16[ds, 0x996], bx);             /* mov [0x996], bx */
            ii(0x18_a800, 3); mov(memw_a16[ds, bx + 0x22], ss);         /* mov [bx+0x22], ss */
            ii(0x18_a803, 3); mov(memw_a16[ds, bx + 0x26], bp);         /* mov [bx+0x26], bp */
            ii(0x18_a806, 2); inc(ah);                                  /* inc ah */
            ii(0x18_a808, 3); cmp(ah, 0x68);                            /* cmp ah, 0x68 */
            ii(0x18_a80b, 2); if(jaw(0x18_a81c, 0xf)) goto l_0x18_a81c; /* ja 0xa81c */
            ii(0x18_a80d, 2); xor(al, al);                              /* xor al, al */
            ii(0x18_a80f, 2); xchg(ah, al);                             /* xchg ah, al */
            ii(0x18_a811, 3); mov(memw_a16[ds, 0x97e], ax);             /* mov [0x97e], ax */
            ii(0x18_a814, 2); shl(ax, 0x1);                             /* shl ax, 1 */
            ii(0x18_a816, 1); xchg(di, ax);                             /* xchg di, ax */
            ii(0x18_a817, 5); if(jmpw_abs(memw_a16[cs, di + 0x66a])) return; /* jmp word [cs:di+0x66a] */
        l_0x18_a81c:
