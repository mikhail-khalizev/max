...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_5dd0()
        {
            ...
            ii(0x1018_5ddc, 4); lea(ebx, memd[ss, esp + 64]);           /* lea ebx, [esp+0x40] */
            ii(0x1018_5de0, 4); mov(memd[ss, esp + 80], edx);           /* mov [esp+0x50], edx */
            ...
            ii(0x1018_5e06, 4); mov(eax, memd[ss, esp + 68]);           /* mov eax, [esp+0x44] */
            ii(0x1018_5e0a, 1); dec(eax);                               /* dec eax */
            ii(0x1018_5e0b, 4); mov(memd[ss, esp + 12], eax);           /* mov [esp+0xc], eax */
            ii(0x1018_5e0f, 2); mov(eax, memd[ds, esi]);                /* mov eax, [esi] */
            ii(0x1018_5e11, 4); mov(memd[ss, esp + 16], eax);           /* mov [esp+0x10], eax */
            ii(0x1018_5e15, 4); mov(eax, memd[ss, esp + 68]);           /* mov eax, [esp+0x44] */
            ii(0x1018_5e19, 4); mov(memd[ss, esp + 20], eax);           /* mov [esp+0x14], eax */
            ii(0x1018_5e1d, 4); mov(eax, memd[ss, esp + 64]);           /* mov eax, [esp+0x40] */
            ii(0x1018_5e21, 1); dec(eax);                               /* dec eax */
            ii(0x1018_5e22, 4); mov(memd[ss, esp + 24], eax);           /* mov [esp+0x18], eax */
            ii(0x1018_5e26, 4); mov(eax, memd[ss, esp + 76]);           /* mov eax, [esp+0x4c] */
            ii(0x1018_5e2a, 4); mov(memd[ss, esp + 28], eax);           /* mov [esp+0x1c], eax */
            ii(0x1018_5e2e, 4); mov(eax, memd[ss, esp + 72]);           /* mov eax, [esp+0x48] */
            ii(0x1018_5e32, 1); inc(eax);                               /* inc eax */
            ii(0x1018_5e33, 4); mov(memd[ss, esp + 32], eax);           /* mov [esp+0x20], eax */
            ii(0x1018_5e37, 4); mov(eax, memd[ss, esp + 68]);           /* mov eax, [esp+0x44] */
            ii(0x1018_5e3b, 4); mov(memd[ss, esp + 36], eax);           /* mov [esp+0x24], eax */
            ii(0x1018_5e3f, 3); mov(eax, memd[ds, esi + 8]);            /* mov eax, [esi+0x8] */
            ii(0x1018_5e42, 4); mov(memd[ss, esp + 40], eax);           /* mov [esp+0x28], eax */
            ii(0x1018_5e46, 4); mov(eax, memd[ss, esp + 76]);           /* mov eax, [esp+0x4c] */
            ii(0x1018_5e4a, 4); mov(memd[ss, esp + 44], eax);           /* mov [esp+0x2c], eax */
            ii(0x1018_5e4e, 2); mov(eax, memd[ds, esi]);                /* mov eax, [esi] */
            ii(0x1018_5e50, 4); mov(memd[ss, esp + 48], eax);           /* mov [esp+0x30], eax */
            ii(0x1018_5e54, 4); mov(eax, memd[ss, esp + 76]);           /* mov eax, [esp+0x4c] */
            ii(0x1018_5e58, 1); inc(eax);                               /* inc eax */
            ii(0x1018_5e59, 4); mov(memd[ss, esp + 52], eax);           /* mov [esp+0x34], eax */
            ii(0x1018_5e5d, 3); mov(eax, memd[ds, esi + 8]);            /* mov eax, [esi+0x8] */
            ii(0x1018_5e60, 4); mov(memd[ss, esp + 56], eax);           /* mov [esp+0x38], eax */
            ii(0x1018_5e64, 4); lea(ebx, memd[ss, esp + 80]);           /* lea ebx, [esp+0x50] */
            ii(0x1018_5e68, 3); mov(eax, memd[ds, esi + 12]);           /* mov eax, [esi+0xc] */
            ii(0x1018_5e6b, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1018_5e6d, 4); mov(memd[ss, esp + 60], eax);           /* mov [esp+0x3c], eax */
        l_0x1018_5e71:
            ...
            ii(0x1018_5e7e, 4); cmp(eax, memd[ss, esp + edx + 12]);     /* cmp eax, [esp+edx+0xc] */
            ...
            ii(0x1018_5e9a, 7); mov(memd[ds, eax + 16], 0);             /* mov dword [eax+0x10], 0x0 */
        ...
        l_0x1018_5eb0:
            ...
            ii(0x1018_5eb5, 4); mov(memd[ss, esp + 80], eax);           /* mov [esp+0x50], eax */
            ...
            ii(0x1018_5ec3, 4); mov(eax, memd[ss, esp + 80]);           /* mov eax, [esp+0x50] */
            ii(0x1018_5ec7, 7); mov(memd[ds, eax + 16], 0);             /* mov dword [eax+0x10], 0x0 */
        l_0x1018_5ece:
            ii(0x1018_5ece, 4); mov(eax, memd[ss, esp + 80]);           /* mov eax, [esp+0x50] */
        l_0x1018_5ed2:
