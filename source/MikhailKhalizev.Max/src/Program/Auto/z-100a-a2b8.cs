...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_a2b8()
        {
            ...
            ii(0x100a_a2cf, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_a2d2, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_a2d5, 7); test(memd[ss, ebp - 0x4], 0x4);         /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x100a_a2e3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100a_a2f2:
            ...
            ii(0x100a_a2f4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_a302, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_a305, 5); mov(edx, 0x1);                          /* mov edx, 0x1 */
            ii(0x100a_a30a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_a30d, 5); call(0x100a_36c9, -0x6c49);             /* call 0x100a36c9 */
            ii(0x100a_a312, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_a315, 7); test(memd[ss, ebp - 0x4], 0x2);         /* test dword [ebp-0x4], 0x2 */
            ii(0x100a_a31c, 2); if(jz(0x100a_a326, 0x8)) goto l_0x100a_a326; /* jz 0x100aa326 */
            ii(0x100a_a31e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_a321, 5); call(Definitions.sys_delete, 0xb_bc3e); /* call 0x10165f64 */
        l_0x100a_a326:
            ii(0x100a_a326, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
