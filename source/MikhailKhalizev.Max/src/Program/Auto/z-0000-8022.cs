...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_8022()
        {
            ...
            ii(0x802c, 2);    if(jzw(0x8055, 0x27)) goto l_0x8055;      /* jz 0x8055 */
            ii(0x802e, 4);    les(bx, ds, 0xed4);                       /* les bx, [0xed4] */
            ii(0x8032, 4);    mov(si, memw_a16[es, bx + 0x2]);          /* mov si, [es:bx+0x2] */
            ii(0x8036, 2);    jmpw(0x8039, 0x1); goto l_0x8039;         /* jmp 0x8039 */
        l_0x8038:
            ii(0x8038, 1);    dec(si);                                  /* dec si */
        l_0x8039:
            ii(0x8039, 3);    cmp(si, 0x10);                            /* cmp si, 0x10 */
            ii(0x803c, 2);    if(jlw(0x8055, 0x17)) goto l_0x8055;      /* jl 0x8055 */
            ...
            ii(0x8048, 2);    if(jnzw(0x8038, -0x12)) goto l_0x8038;    /* jnz 0x8038 */
            ...
            ii(0x8053, 2);    jmpw(0x8057, 0x2); goto l_0x8057;         /* jmp 0x8057 */
        l_0x8055:
