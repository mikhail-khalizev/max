...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_6d29()
        {
            ...
            ii(0x100a_6d40, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_6d43, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_6d46, 5);  mov(eax, 0x101c_819c);                /* mov eax, 0x101c819c */
            ii(0x100a_6d4b, 5);  call(0x1007_6338, -0x3_0a18);         /* call 0x10076338 */
            ii(0x100a_6d50, 3);  lea(ebx, memd[ss, ebp - 20]);         /* lea ebx, [ebp-0x14] */
            ...
            ii(0x100a_6d5c, 7);  mov(memd[ss, ebp - 16], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x100a_6d63, 2);  jmp(0x100a_6d6d, 8); goto l_0x100a_6d6d;/* jmp 0x100a6d6d */
        l_0x100a_6d65:
            ii(0x100a_6d65, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x100a_6d68, 5);  call(0x1007_6bf8, -0x3_0175);         /* call 0x10076bf8 */
        l_0x100a_6d6d:
            ii(0x100a_6d6d, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100a_6d6f, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x100a_6d9a, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x100a_6d9d, 5);  call(0x1007_636c, -0x3_0a36);         /* call 0x1007636c */
            ii(0x100a_6da2, 5);  call(0x100a_601a, -0xd8d);            /* call 0x100a601a */
            ii(0x100a_6da7, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100a_6daa, 4);  cmp(memd[ss, ebp - 16], 0);           /* cmp dword [ebp-0x10], 0x0 */
            ii(0x100a_6dae, 2);  if(jz(0x100a_6db9, 9)) goto l_0x100a_6db9;/* jz 0x100a6db9 */
            ii(0x100a_6db0, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x100a_6db3, 4);  cmp(ax, memw[ss, ebp - 12]);          /* cmp ax, [ebp-0xc] */
            ii(0x100a_6db7, 2);  if(jge(0x100a_6dca, 0x11)) goto l_0x100a_6dca;/* jge 0x100a6dca */
        l_0x100a_6db9:
            ii(0x100a_6db9, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x100a_6dbc, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100a_6dbf, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x100a_6dc2, 5);  call(0x1007_6408, -0x3_09bf);         /* call 0x10076408 */
            ii(0x100a_6dc7, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
        l_0x100a_6dca:
            ii(0x100a_6dca, 2);  jmp(0x100a_6d65, -0x67); goto l_0x100a_6d65;/* jmp 0x100a6d65 */
        l_0x100a_6dcc:
            ii(0x100a_6dcc, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100a_6dcf, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x100a_6dd2, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100a_6dd4, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
        ...
        //  ii(0x100a_6de0, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
        //  ii(0x100a_6de3, 5);  call(0x1007_5f6c, -0x3_0e7c);         /* call 0x10075f6c */
        l_0x100a_6de8:
            ii(0x100a_6de8, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
