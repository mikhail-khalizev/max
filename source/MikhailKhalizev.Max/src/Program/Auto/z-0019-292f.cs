...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        //  ii(0x19_2939, 3);  mov(cx, 1);                             /* mov cx, 0x1 */
        ...
        //  ii(0x19_2946, 2);  jmp(0x19_2950, 8); goto l_0x19_2950;    /* jmp 0x2950 */
        ...
        l_0x19_2950:
            ...
            ii(0x19_296d, 2);  if(jnz(0x19_2973, 4)) goto l_0x19_2973; /* jnz 0x2973 */
        ...
        l_0x19_2973:
            ...
            ii(0x19_2994, 4);  cmp(memw[ss, bp + 6], 0);               /* cmp word [bp+0x6], 0x0 */
            ii(0x19_2998, 2);  if(jnz(0x19_299f, 5)) goto l_0x19_299f; /* jnz 0x299f */
            ii(0x19_299a, 5);  mov(memw[ss, bp + 6], 0xff);            /* mov word [bp+0x6], 0xff */
        l_0x19_299f:
            ii(0x19_299f, 3);  call(0x19_29b2, 0x10);                  /* call 0x29b2 */
            ii(0x19_29a2, 1);  pop(ax);                                /* pop ax */
            ii(0x19_29a3, 2);  or(ah, ah);                             /* or ah, ah */
            ii(0x19_29a5, 2);  if(jnz(0x19_29ae, 7)) goto l_0x19_29ae; /* jnz 0x29ae */
            ii(0x19_29a7, 3);  mov(ax, memw[ss, bp + 6]);              /* mov ax, [bp+0x6] */
