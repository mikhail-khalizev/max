...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_292f()
        {
            ...
            ii(0x19_2934, 2); jmpw(0x19_2950, 0x1a); goto l_0x19_2950;  /* jmp 0x2950 */
        //  ii(0x19_2936, 1); pushw(bp);                                /* push bp */
        //  ii(0x19_2937, 2); mov(bp, sp);                              /* mov bp, sp */
        //  ii(0x19_2939, 3); mov(cx, 0x1);                             /* mov cx, 0x1 */
        //  ii(0x19_293c, 2); jmpw(0x19_2950, 0x12); goto l_0x19_2950;  /* jmp 0x2950 */
        //  ii(0x19_293e, 1); pushw(bp);                                /* push bp */
        //  ii(0x19_293f, 2); mov(bp, sp);                              /* mov bp, sp */
        //  ii(0x19_2941, 1); pushw(si);                                /* push si */
        //  ii(0x19_2942, 1); pushw(di);                                /* push di */
        //  ii(0x19_2943, 3); mov(cx, 0x100);                           /* mov cx, 0x100 */
        //  ii(0x19_2946, 2); jmpw(0x19_2950, 0x8); goto l_0x19_2950;   /* jmp 0x2950 */
        //  ii(0x19_2948, 1); pushw(bp);                                /* push bp */
        //  ii(0x19_2949, 2); mov(bp, sp);                              /* mov bp, sp */
        //  ii(0x19_294b, 1); pushw(si);                                /* push si */
        //  ii(0x19_294c, 1); pushw(di);                                /* push di */
