...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("89272f84-2914-4fb0-ba6c-40d91c2a1f87")]
        public void Method_100e_d68c()
        {
            ...
            ii(0x100e_d6a8, 5); jmpd_func(0x100e_d760, 0xb3); return;   /* jmp 0x100ed760 */
        l_0x100e_d6ad:
        ...
        l_0x100e_d6af:
            ...
            ii(0x100e_d6c3, 5); jmpd_func(0x100e_d760, 0x98); return;   /* jmp 0x100ed760 */
        l_0x100e_d6c8:
            ...
            ii(0x100e_d6dc, 5); jmpd_func(0x100e_d760, 0x7f); return;   /* jmp 0x100ed760 */
        l_0x100e_d6e1:
            ii(0x100e_d6e1, 4); mov(memb_a32[ss, ebp - 0xc], 0x1);      /* mov byte [ebp-0xc], 0x1 */
            ii(0x100e_d6e5, 5); jmpd_func(0x100e_d760, 0x76); return;   /* jmp 0x100ed760 */
        }
    }
}
