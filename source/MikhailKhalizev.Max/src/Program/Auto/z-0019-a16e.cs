...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x19_a16e, 4); enter(0x2, 0);                            /* enter 0x2, 0x0 */
            ii(0x19_a172, 1); push(si);                                 /* push si */
            ii(0x19_a173, 5); mov(memw[ss, bp - 0x2], 0);               /* mov word [bp-0x2], 0x0 */
            ii(0x19_a178, 2); jmp(0x19_a17d, 0x3); goto l_0x19_a17d;    /* jmp 0xa17d */
        l_0x19_a17a:
            ii(0x19_a17a, 3); inc(memw[ss, bp - 0x2]);                  /* inc word [bp-0x2] */
        l_0x19_a17d:
            ii(0x19_a17d, 4); cmp(memw[ss, bp - 0x2], 0x10);            /* cmp word [bp-0x2], 0x10 */
            ...
            ii(0x19_a18b, 3); mov(si, memw[ss, bp - 0x2]);              /* mov si, [bp-0x2] */
            ...
            ii(0x19_a1a3, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x19_a1a6, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
