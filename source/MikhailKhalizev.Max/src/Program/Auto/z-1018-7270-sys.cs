...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x1018_7270, 4); fld(memt[ss, esp + 16]);                /* fld tword [esp+0x10] */
        ...
        l_0x1018_72a2:
            ii(0x1018_72a2, 4); mov(eax, memd[ss, esp + 12]);           /* mov eax, [esp+0xc] */
            ...
            ii(0x1018_72b4, 4); fnstcw(memw[ss, esp + 28]);             /* fnstcw word [esp+0x1c] */
            ii(0x1018_72b8, 4); mov(eax, memd[ss, esp + 28]);           /* mov eax, [esp+0x1c] */
            ii(0x1018_72bc, 5); or(eax, 0x33f);                         /* or eax, 0x33f */
            ii(0x1018_72c1, 5); and(eax, 0xf3ff);                       /* and eax, 0xf3ff */
            ii(0x1018_72c6, 4); mov(memd[ss, esp + 32], eax);           /* mov [esp+0x20], eax */
            ii(0x1018_72ca, 4); fldcw(memw[ss, esp + 32]);              /* fldcw word [esp+0x20] */
            ii(0x1018_72ce, 4); mov(eax, memd[ss, esp + 24]);           /* mov eax, [esp+0x18] */
            ...
            ii(0x1018_72ec, 4); fldcw(memw[ss, esp + 28]);              /* fldcw word [esp+0x1c] */
        ...
        l_0x1018_72f3:
            ...
            ii(0x1018_7303, 4); fldcw(memw[ss, esp + 28]);              /* fldcw word [esp+0x1c] */
        ...
        l_0x1018_7317:
            ii(0x1018_7317, 4); mov(eax, memd[ss, esp + 12]);           /* mov eax, [esp+0xc] */
            ii(0x1018_731b, 5); and(eax, 0x7fff);                       /* and eax, 0x7fff */
            ii(0x1018_7320, 2); if(jnz(0x1018_7314, -0xe)) goto l_0x1018_7314; /* jnz 0x10187314 */
            ii(0x1018_7322, 4); fnstcw(memw[ss, esp + 28]);             /* fnstcw word [esp+0x1c] */
            ii(0x1018_7326, 4); mov(eax, memd[ss, esp + 28]);           /* mov eax, [esp+0x1c] */
            ii(0x1018_732a, 5); or(eax, 0x33f);                         /* or eax, 0x33f */
            ii(0x1018_732f, 5); and(eax, 0xf3ff);                       /* and eax, 0xf3ff */
            ii(0x1018_7334, 4); mov(memd[ss, esp + 32], eax);           /* mov [esp+0x20], eax */
            ii(0x1018_7338, 4); fldcw(memw[ss, esp + 32]);              /* fldcw word [esp+0x20] */
            ii(0x1018_733c, 4); mov(eax, memd[ss, esp + 24]);           /* mov eax, [esp+0x18] */
            ...
            ii(0x1018_734e, 4); mov(eax, memd[ss, esp + 20]);           /* mov eax, [esp+0x14] */
        ...
        l_0x1018_7358:
            ii(0x1018_7358, 4); mov(eax, memd[ss, esp + 20]);           /* mov eax, [esp+0x14] */
        ...
        l_0x1018_7360:
            ...
            ii(0x1018_7370, 4); fld(memt[ss, esp + 16]);                /* fld tword [esp+0x10] */
            ii(0x1018_7374, 2); fxch(ST(0), ST(1));                     /* fxch st0, st1 */
            ii(0x1018_7376, 1); wait();                                 /* wait */
            ii(0x1018_7377, 4); fldcw(memw[ss, esp + 28]);              /* fldcw word [esp+0x1c] */
            ii(0x1018_737b, 5); jmp(0x1018_7278, -0x108); goto l_0x1018_7278; /* jmp 0x10187278 */
        l_0x1018_7380:
            ii(0x1018_7380, 4); fldcw(memw[ss, esp + 28]);              /* fldcw word [esp+0x1c] */
