...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_4678()
        {
            ...
            ii(0x19_4682, 3); mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ii(0x19_4685, 1); dec(ax);                                  /* dec ax */
            ii(0x19_4686, 3); shr(ax, 0x4);                             /* shr ax, 0x4 */
            ii(0x19_4689, 1); inc(ax);                                  /* inc ax */
            ii(0x19_468a, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x19_468d, 2); sub(ax, ax);                              /* sub ax, ax */
            ii(0x19_468f, 3); mov(memw[ss, bp - 0x16], ax);             /* mov [bp-0x16], ax */
            ii(0x19_4692, 3); mov(memw[ss, bp - 0x18], ax);             /* mov [bp-0x18], ax */
            ii(0x19_4695, 1); push(ax);                                 /* push ax */
            ii(0x19_4696, 1); push(ax);                                 /* push ax */
            ii(0x19_4697, 3); lea(ax, memw[ss, bp - 0x14]);             /* lea ax, [bp-0x14] */
            ...
            ii(0x19_46a9, 2); if(jz(0x19_46b1, 0x6)) goto l_0x19_46b1;  /* jz 0x46b1 */
            ii(0x19_46ab, 3); mov(ax, memw[ss, bp - 0x2]);              /* mov ax, [bp-0x2] */
            ii(0x19_46ae, 3); mov(memw[ss, bp - 0x16], ax);             /* mov [bp-0x16], ax */
        l_0x19_46b1:
            ii(0x19_46b1, 3); mov(ax, memw[ss, bp - 0x18]);             /* mov ax, [bp-0x18] */
            ii(0x19_46b4, 3); mov(dx, memw[ss, bp - 0x16]);             /* mov dx, [bp-0x16] */
