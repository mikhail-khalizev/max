...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_466f()
        {
            ...
            ii(0x1011_4687, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_468a, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_468d, 5); call(0x1011_3b89, -0xb09);              /* call 0x10113b89 */
            ii(0x1011_4692, 7); cmp(memb[ds, 0x101c_391e], 0x6);        /* cmp byte [0x101c391e], 0x6 */
        ...
        l_0x1011_46b1:
            ...
            ii(0x1011_46ba, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_46c9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
