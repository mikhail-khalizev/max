...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1008_e1e9:
            ii(0x1008_e1e9, 4);  or(memb[ss, ebp - 12], 1);            /* or byte [ebp-0xc], 0x1 */
            ii(0x1008_e1ed, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1008_e1f0, 5);  call(0x1007_64fc, -0x1_7cf9);         /* call 0x100764fc */
            ii(0x1008_e1f5, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1008_e1f8, 4);  and(memb[ss, ebp - 12], -2 /* 0xfe */);/* and byte [ebp-0xc], 0xfe */
            ii(0x1008_e1fc, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_e1ff, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x1008_e202, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
            ii(0x1008_e205, 3);  mov(ebx, memd[ds, eax + 2]);          /* mov ebx, [eax+0x2] */
            ii(0x1008_e208, 3);  lea(edx, memd[ss, ebp - 48]);         /* lea edx, [ebp-0x30] */
            ii(0x1008_e20b, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
            ii(0x1008_e20e, 3);  call_abs(memd[ds, ebx + 28]);         /* call dword [ebx+0x1c] */
            ii(0x1008_e211, 3);  mov(eax, memd[ss, ebp - 48]);         /* mov eax, [ebp-0x30] */
            ii(0x1008_e214, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1008_e217, 2);  jmp(0x1008_e21f, 6); goto l_0x1008_e21f;/* jmp 0x1008e21f */
        l_0x1008_e219:
            ii(0x1008_e219, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1008_e21c, 3);  inc(memd[ss, ebp - 20]);              /* inc dword [ebp-0x14] */
        l_0x1008_e21f:
            ii(0x1008_e21f, 4);  movsx(eax, memw[ss, ebp - 20]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1008_e223, 3);  cmp(eax, memd[ss, ebp - 40]);         /* cmp eax, [ebp-0x28] */
            ii(0x1008_e226, 6);  if(jge(0x1008_e356, 0x12a)) goto l_0x1008_e356;/* jge 0x1008e356 */
            ii(0x1008_e22c, 3);  mov(eax, memd[ss, ebp - 44]);         /* mov eax, [ebp-0x2c] */
            ii(0x1008_e22f, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1008_e232, 2);  jmp(0x1008_e23a, 6); goto l_0x1008_e23a;/* jmp 0x1008e23a */
        l_0x1008_e234:
            ii(0x1008_e234, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1008_e237, 3);  inc(memd[ss, ebp - 16]);              /* inc dword [ebp-0x10] */
        l_0x1008_e23a:
            ii(0x1008_e23a, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1008_e23e, 3);  cmp(eax, memd[ss, ebp - 36]);         /* cmp eax, [ebp-0x24] */
            ii(0x1008_e241, 6);  if(jge(0x1008_e351, 0x10a)) goto l_0x1008_e351;/* jge 0x1008e351 */
            ii(0x1008_e247, 4);  movsx(ebx, memw[ss, ebp - 16]);       /* movsx ebx, word [ebp-0x10] */
            ii(0x1008_e24b, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ...
            ii(0x1008_e25b, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
        ...
        l_0x1008_e265:
            ii(0x1008_e265, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1008_e268, 5);  call(0x1007_6bf8, -0x1_7675);         /* call 0x10076bf8 */
        l_0x1008_e26d:
            ii(0x1008_e26d, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_e26f, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1008_e27b, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1008_e27e, 5);  call(0x1007_63a0, -0x1_7ee3);         /* call 0x100763a0 */
            ii(0x1008_e283, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_e285, 3);  mov(dl, memb[ds, eax + 38]);          /* mov dl, [eax+0x26] */
            ...
            ii(0x1008_e295, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1008_e2a4, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
        ...
        l_0x1008_e2bb:
            ...
            ii(0x1008_e2bd, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1008_e2d7, 3);  mov(memd[ss, ebp - 52], eax);         /* mov [ebp-0x34], eax */
            ii(0x1008_e2da, 3);  mov(eax, memd[ss, ebp - 52]);         /* mov eax, [ebp-0x34] */
            ii(0x1008_e2dd, 3);  mov(memd[ss, ebp - 56], eax);         /* mov [ebp-0x38], eax */
            ii(0x1008_e2e0, 4);  cmp(memd[ss, ebp - 56], 0);           /* cmp dword [ebp-0x38], 0x0 */
            ii(0x1008_e2e4, 2);  if(jz(0x1008_e306, 0x20)) goto l_0x1008_e306;/* jz 0x1008e306 */
            ii(0x1008_e2e6, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1008_e2f3, 3);  mov(eax, memd[ss, ebp - 52]);         /* mov eax, [ebp-0x34] */
            ii(0x1008_e2f6, 5);  call(0x1009_abbe, 0xc8c3);            /* call 0x1009abbe */
            ii(0x1008_e2fb, 3);  mov(memd[ss, ebp - 60], eax);         /* mov [ebp-0x3c], eax */
            ii(0x1008_e2fe, 3);  mov(eax, memd[ss, ebp - 60]);         /* mov eax, [ebp-0x3c] */
            ii(0x1008_e301, 3);  mov(memd[ss, ebp - 64], eax);         /* mov [ebp-0x40], eax */
            ii(0x1008_e304, 2);  jmp(0x1008_e30c, 6); goto l_0x1008_e30c;/* jmp 0x1008e30c */
        l_0x1008_e306:
            ii(0x1008_e306, 3);  mov(eax, memd[ss, ebp - 56]);         /* mov eax, [ebp-0x38] */
            ii(0x1008_e309, 3);  mov(memd[ss, ebp - 64], eax);         /* mov [ebp-0x40], eax */
        l_0x1008_e30c:
            ii(0x1008_e30c, 3);  mov(edx, memd[ss, ebp - 64]);         /* mov edx, [ebp-0x40] */
            ii(0x1008_e30f, 3);  lea(eax, memd[ss, ebp - 68]);         /* lea eax, [ebp-0x44] */
            ii(0x1008_e312, 5);  call(0x1008_b060, -0x32b7);           /* call 0x1008b060 */
            ii(0x1008_e317, 3);  lea(eax, memd[ss, ebp - 68]);         /* lea eax, [ebp-0x44] */
            ...
            ii(0x1008_e32c, 3);  lea(eax, memd[ss, ebp - 68]);         /* lea eax, [ebp-0x44] */
            ...
            ii(0x1008_e344, 3);  lea(eax, memd[ss, ebp - 68]);         /* lea eax, [ebp-0x44] */
        ...
        l_0x1008_e356:
            ...
            ii(0x1008_e36c, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
        ...
        l_0x1008_e376:
            ...
            ii(0x1008_e37c, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
        ...
        //  ii(0x1008_e388, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
