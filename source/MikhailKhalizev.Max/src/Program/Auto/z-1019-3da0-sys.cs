...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_3da0()
        {
            ...
            ii(0x1019_3da1, 3); add(esi, memd[ss, ebp - 0x18]);         /* add esi, [ebp-0x18] */
            ii(0x1019_3da4, 3); add(edi, memd[ss, ebp - 0x1c]);         /* add edi, [ebp-0x1c] */
            ii(0x1019_3da7, 3); add(edi, memd[ss, ebp - 0x20]);         /* add edi, [ebp-0x20] */
            ...
            ii(0x1019_3db4, 3); inc(memd[ss, ebp + 0x24]);              /* inc dword [ebp+0x24] */
