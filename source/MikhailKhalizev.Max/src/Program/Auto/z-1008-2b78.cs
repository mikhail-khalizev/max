...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_2b78()
        {
            ...
            ii(0x1008_2b8f, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_2b92, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1008_2b95, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_2b97, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1008_2ba6, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_2ba9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_2bac, 5); call(0x1008_2abe, -0xf3);               /* call 0x10082abe */
            ii(0x1008_2bb1, 2); test(al, al);                           /* test al, al */
            ii(0x1008_2bb3, 2); if(jnz(0x1008_2bb7, 0x2)) goto l_0x1008_2bb7; /* jnz 0x10082bb7 */
        l_0x1008_2bb5:
            ii(0x1008_2bb5, 2); jmp(0x1008_2bbd, 0x6); goto l_0x1008_2bbd; /* jmp 0x10082bbd */
        l_0x1008_2bb7:
            ii(0x1008_2bb7, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1008_2bbb, 2); jmp(0x1008_2bc1, 0x4); goto l_0x1008_2bc1; /* jmp 0x10082bc1 */
        l_0x1008_2bbd:
