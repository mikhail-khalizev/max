...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_fbdb()
        {
            ...
            ii(0x19_fbe8, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x19_fbeb, 5); call_far_abs(0x80, 0x55dc);               /* call word 0x80:0x55dc */
            ii(0x19_fbf0, 1); pop(bx);                                  /* pop bx */
            ii(0x19_fbf1, 1); pop(bx);                                  /* pop bx */
            ii(0x19_fbf2, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_fbf5, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x19_fbf8, 1); push(dx);                                 /* push dx */
            ii(0x19_fbf9, 1); push(ax);                                 /* push ax */
            ii(0x19_fbfa, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ii(0x19_fbfd, 3); push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ii(0x19_fc00, 5); call_far_abs(0x80, 0x55dc);               /* call word 0x80:0x55dc */
            ii(0x19_fc05, 1); pop(bx);                                  /* pop bx */
            ii(0x19_fc06, 1); pop(bx);                                  /* pop bx */
            ii(0x19_fc07, 3); sub(ax, memw[ss, bp - 0x4]);              /* sub ax, [bp-0x4] */
            ii(0x19_fc0a, 3); sbb(dx, memw[ss, bp - 0x2]);              /* sbb dx, [bp-0x2] */
            ...
            ii(0x19_fc14, 3); ret(0x8);                                 /* ret 0x8 */
        }
    }
}
