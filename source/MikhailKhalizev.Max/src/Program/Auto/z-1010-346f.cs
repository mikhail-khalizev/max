...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_346f()
        {
            ...
            ii(0x1010_3485, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
        ...
        l_0x1010_34ad:
            ...
            ii(0x1010_34b0, 4); mov(ax, memw[ds, eax + 26]);            /* mov ax, [eax+0x1a] */
            ii(0x1010_34b4, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1010_34b7, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1010_34ba, 4); mov(ax, memw[ds, eax + 28]);            /* mov ax, [eax+0x1c] */
            ii(0x1010_34be, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ...
            ii(0x1010_34c7, 4); movsx(ecx, memw[ss, ebp - 20]);         /* movsx ecx, word [ebp-0x14] */
            ii(0x1010_34cb, 4); movsx(ebx, memw[ss, ebp - 16]);         /* movsx ebx, word [ebp-0x10] */
            ii(0x1010_34cf, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1010_34d2, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1010_34d5, 5); call(0x1010_330b, -0x1cf);              /* call 0x1010330b */
            ii(0x1010_34da, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1010_34dd, 4); test(memb[ds, eax + 18], 0x10);         /* test byte [eax+0x12], 0x10 */
            ...
            ii(0x1010_34e9, 4); movsx(ecx, memw[ss, ebp - 20]);         /* movsx ecx, word [ebp-0x14] */
            ii(0x1010_34ed, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ...
            ii(0x1010_34f7, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x1010_3505, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x1010_3508, 1); inc(eax);                               /* inc eax */
            ii(0x1010_3509, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x1010_350c, 4); movsx(ebx, memw[ss, ebp - 16]);         /* movsx ebx, word [ebp-0x10] */
            ii(0x1010_3510, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1010_3513, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ...
            ii(0x1010_3521, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x1010_3524, 1); inc(eax);                               /* inc eax */
            ii(0x1010_3525, 3); movsx(ecx, ax);                         /* movsx ecx, ax */
            ii(0x1010_3528, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ...
            ii(0x1010_3532, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
