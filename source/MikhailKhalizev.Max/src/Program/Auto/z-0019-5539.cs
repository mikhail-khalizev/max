...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_5539()
        {
            ...
            ii(0x19_555f, 3); push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x19_5562, 3); push(memw[ss, bp + 0x6]);                 /* push word [bp+0x6] */
            ...
            ii(0x19_5582, 2); if(jnz(0x19_5587, 0x3)) goto l_0x19_5587; /* jnz 0x5587 */
            ii(0x19_5584, 3); jmp(0x19_5590, 0x9); goto l_0x19_5590;    /* jmp 0x5590 */
        l_0x19_5587:
            ii(0x19_5587, 3); mov(ax, 0x1);                             /* mov ax, 0x1 */
            ii(0x19_558a, 3); jmp(0x19_5596, 0x9); goto l_0x19_5596;    /* jmp 0x5596 */
        //  ii(0x19_558d, 3); jmp(0x19_5596, 0x6); goto l_0x19_5596;    /* jmp 0x5596 */
        l_0x19_5590:
        ...
        l_0x19_5596:
            ...
            ii(0x19_5599, 3); ret(0x6);                                 /* ret 0x6 */
        }
    }
}
