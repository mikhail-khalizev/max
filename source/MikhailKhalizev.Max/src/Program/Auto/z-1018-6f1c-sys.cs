...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_6f1c()
        {
            ...
            ii(0x1018_6f29, 3); cmp(eax, 1);                            /* cmp eax, 0x1 */
            ii(0x1018_6f2c, 2); if(jnz(0x1018_6f37, 9)) goto l_0x1018_6f37; /* jnz 0x10186f37 */
        ...
        l_0x1018_6f37:
            ...
            ii(0x1018_6f3e, 3); cmp(eax, 9);                            /* cmp eax, 0x9 */
        ...
        l_0x1018_6f50:
            ...
            ii(0x1018_6f57, 2); if(jnz(0x1018_6f60, 7)) goto l_0x1018_6f60; /* jnz 0x10186f60 */
        l_0x1018_6f59:
            ii(0x1018_6f59, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1018_6f5b, 5); jmp(0x1018_705f, 0xff); goto l_0x1018_705f; /* jmp 0x1018705f */
        l_0x1018_6f60:
            ii(0x1018_6f60, 7); cmp(memd[ds, 0x101b_e560], -2 /* 0xfe */); /* cmp dword [0x101be560], 0xfffffffe */
            ...
            ii(0x1018_6f7f, 3); cmp(eax, 2);                            /* cmp eax, 0x2 */
            ii(0x1018_6f82, 2); if(jl(0x1018_6fa0, 0x1c)) goto l_0x1018_6fa0; /* jl 0x10186fa0 */
            ii(0x1018_6f84, 3); cmp(eax, 8);                            /* cmp eax, 0x8 */
        ...
        l_0x1018_6fa0:
            ...
            ii(0x1018_6fad, 2); if(jae(0x1018_6fb4, 5)) goto l_0x1018_6fb4; /* jae 0x10186fb4 */
        ...
        l_0x1018_6fb4:
            ...
            ii(0x1018_6fd0, 3); lea(eax, memd[ds, edx - 4]);            /* lea eax, [edx-0x4] */
        ...
        l_0x1018_6fe2:
            ii(0x1018_6fe2, 3); mov(ebp, memd[ds, edx + 8]);            /* mov ebp, [edx+0x8] */
            ...
            ii(0x1018_6feb, 2); if(ja(0x1018_6ff1, 4)) goto l_0x1018_6ff1; /* ja 0x10186ff1 */
            ii(0x1018_6fed, 2); cmp(ebx, ebp);                          /* cmp ebx, ebp */
            ii(0x1018_6fef, 2); if(jb(0x1018_6ff8, 7)) goto l_0x1018_6ff8; /* jb 0x10186ff8 */
        l_0x1018_6ff1:
            ii(0x1018_6ff1, 3); mov(edx, memd[ds, edx + 8]);            /* mov edx, [edx+0x8] */
        l_0x1018_6ff4:
        ...
        l_0x1018_6ff8:
            ...
            ii(0x1018_6ffe, 3); lea(ecx, memd[ds, ebx - 4]);            /* lea ecx, [ebx-0x4] */
            ...
            ii(0x1018_700a, 3); add(esi, 4);                            /* add esi, 0x4 */
            ...
            ii(0x1018_7017, 3); lea(ecx, memd[ds, eax + ebp]);          /* lea ecx, [eax+ebp] */
        ...
        l_0x1018_7041:
            ...
            ii(0x1018_7044, 2); or(al, 1);                              /* or al, 0x1 */
            ii(0x1018_7046, 2); mov(memd[ds, ebx], eax);                /* mov [ebx], eax */
            ii(0x1018_7048, 3); inc(memd[ds, edx + 24]);                /* inc dword [edx+0x18] */
            ii(0x1018_704b, 3); lea(eax, memd[ds, ebx + 4]);            /* lea eax, [ebx+0x4] */
            ii(0x1018_704e, 7); mov(memd[ds, edx + 20], 0xffff_ffff);   /* mov dword [edx+0x14], 0xffffffff */
            ii(0x1018_7055, 5); call(Definitions.sys_free, -0x1_bf99);  /* call 0x1016b0c1 */
            ii(0x1018_705a, 5); mov(eax, 1);                            /* mov eax, 0x1 */
        l_0x1018_705f:
            ii(0x1018_705f, 3); add(esp, 4);                            /* add esp, 0x4 */
