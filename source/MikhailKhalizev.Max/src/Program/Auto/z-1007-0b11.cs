...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_0b11()
        {
            ...
            ii(0x1007_0b29, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_0b2c, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_0b35, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_0b46, 2); if(jz(0x1007_0b51, 0x9)) goto l_0x1007_0b51; /* jz 0x10070b51 */
        l_0x1007_0b48:
            ii(0x1007_0b48, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1007_0b4f, 2); jmp(0x1007_0b71, 0x20); goto l_0x1007_0b71; /* jmp 0x10070b71 */
        l_0x1007_0b51:
            ii(0x1007_0b51, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_0b54, 5); cmp(memw[ds, eax + 0x8], 0x39);         /* cmp word [eax+0x8], 0x39 */
            ii(0x1007_0b59, 2); if(jnz(0x1007_0b64, 0x9)) goto l_0x1007_0b64; /* jnz 0x10070b64 */
            ii(0x1007_0b5b, 7); mov(memd[ss, ebp - 0xc], 0x1);          /* mov dword [ebp-0xc], 0x1 */
            ii(0x1007_0b62, 2); jmp(0x1007_0b6b, 0x7); goto l_0x1007_0b6b; /* jmp 0x10070b6b */
        l_0x1007_0b64:
            ii(0x1007_0b64, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
        l_0x1007_0b6b:
            ii(0x1007_0b6b, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1007_0b6e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x1007_0b71:
            ii(0x1007_0b71, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
