...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_73c8()
        {
            ...
            ii(0x1016_73ee, 3); lea(esi, memd[ds, esi + 0x8]);          /* lea esi, [esi+0x8] */
            ...
            ii(0x1016_73f7, 2); if(jge(0x1016_73fb, 0x2)) goto l_0x1016_73fb; /* jge 0x101673fb */
            ii(0x1016_73f9, 2); xor(edx, edx);                          /* xor edx, edx */
        l_0x1016_73fb:
            ii(0x1016_73fb, 2); test(ebx, ebx);                         /* test ebx, ebx */
            ii(0x1016_73fd, 2); if(jge(0x1016_7401, 0x2)) goto l_0x1016_7401; /* jge 0x10167401 */
            ii(0x1016_73ff, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
        l_0x1016_7401:
            ii(0x1016_7401, 4); test(memb[ds, eax + 0x5], 0x1);         /* test byte [eax+0x5], 0x1 */
            ii(0x1016_7405, 2); if(jz(0x1016_740a, 0x3)) goto l_0x1016_740a; /* jz 0x1016740a */
            ii(0x1016_7407, 3); add(edx, 0x2);                          /* add edx, 0x2 */
        l_0x1016_740a:
            ii(0x1016_740a, 3); mov(esi, memd[ds, eax + 0x18]);         /* mov esi, [eax+0x18] */
            ...
            ii(0x1016_7418, 2); if(jle(0x1016_7420, 0x6)) goto l_0x1016_7420; /* jle 0x10167420 */
            ii(0x1016_741a, 2); mov(edx, edi);                          /* mov edx, edi */
            ii(0x1016_741c, 3); sub(edx, memd[ds, eax + 0x18]);         /* sub edx, [eax+0x18] */
            ii(0x1016_741f, 1); inc(edx);                               /* inc edx */
        l_0x1016_7420:
            ii(0x1016_7420, 3); mov(esi, memd[ds, eax + 0x1c]);         /* mov esi, [eax+0x1c] */
            ...
            ii(0x1016_742e, 2); if(jle(0x1016_7436, 0x6)) goto l_0x1016_7436; /* jle 0x10167436 */
            ii(0x1016_7430, 2); mov(ebx, ecx);                          /* mov ebx, ecx */
            ii(0x1016_7432, 3); sub(ebx, memd[ds, eax + 0x1c]);         /* sub ebx, [eax+0x1c] */
            ii(0x1016_7435, 1); inc(ebx);                               /* inc ebx */
        l_0x1016_7436:
            ii(0x1016_7436, 4); test(memb[ds, eax + 0x5], 0x1);         /* test byte [eax+0x5], 0x1 */
            ii(0x1016_743a, 2); if(jz(0x1016_743f, 0x3)) goto l_0x1016_743f; /* jz 0x1016743f */
            ii(0x1016_743c, 3); and(dl, 0xfc);                          /* and dl, 0xfc */
        l_0x1016_743f:
            ii(0x1016_743f, 3); mov(edi, memd[ds, eax + 0x18]);         /* mov edi, [eax+0x18] */
            ii(0x1016_7442, 3); mov(ebp, memd[ds, eax + 0x1c]);         /* mov ebp, [eax+0x1c] */
            ii(0x1016_7445, 3); mov(memd[ds, eax + 0x8], edx);          /* mov [eax+0x8], edx */
            ii(0x1016_7448, 2); add(edx, edi);                          /* add edx, edi */
            ii(0x1016_744a, 3); mov(memd[ds, eax + 0xc], ebx);          /* mov [eax+0xc], ebx */
            ii(0x1016_744d, 1); dec(edx);                               /* dec edx */
            ii(0x1016_744e, 2); add(ebx, ebp);                          /* add ebx, ebp */
            ii(0x1016_7450, 3); mov(memd[ds, eax + 0x10], edx);         /* mov [eax+0x10], edx */
            ii(0x1016_7453, 1); dec(ebx);                               /* dec ebx */
            ii(0x1016_7454, 3); mov(dl, memb[ds, eax + 0x4]);           /* mov dl, [eax+0x4] */
            ii(0x1016_7457, 3); mov(memd[ds, eax + 0x14], ebx);         /* mov [eax+0x14], ebx */
            ii(0x1016_745a, 3); test(dl, 0x8);                          /* test dl, 0x8 */
            ii(0x1016_745d, 2); if(jnz(0x1016_747b, 0x1c)) goto l_0x1016_747b; /* jnz 0x1016747b */
            ii(0x1016_745f, 3); lea(edx, memd[ds, eax + 0x8]);          /* lea edx, [eax+0x8] */
            ...
            ii(0x1016_7470, 2); if(jz(0x1016_747b, 0x9)) goto l_0x1016_747b; /* jz 0x1016747b */
