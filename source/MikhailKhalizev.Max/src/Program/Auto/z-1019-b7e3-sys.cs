...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_b7e3()
        {
            ...
            ii(0x1019_b7f1, 3); mov(edx, memd[ds, ebx + 0x4]);          /* mov edx, [ebx+0x4] */
            ii(0x1019_b7f4, 2); mov(eax, memd[ds, ebx]);                /* mov eax, [ebx] */
            ii(0x1019_b7f6, 5); call(/* sys */ 0x1019_b79b, -0x60);     /* call 0x1019b79b */
            ii(0x1019_b7fb, 3); cmp(memd[ds, ebx], 0x1);                /* cmp dword [ebx], 0x1 */
            ii(0x1019_b7fe, 2); if(jnz(0x1019_b807, 0x7)) goto l_0x1019_b807; /* jnz 0x1019b807 */
            ii(0x1019_b800, 5); call(/* sys */ 0x1018_d3ba, -0xe44b);   /* call 0x1018d3ba */
            ii(0x1019_b805, 2); jmp(0x1019_b80c, 0x5); goto l_0x1019_b80c; /* jmp 0x1019b80c */
        l_0x1019_b807:
