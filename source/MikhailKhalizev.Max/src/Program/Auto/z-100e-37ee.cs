...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_37ee()
        {
            ...
            ii(0x100e_3805, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_3808, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100e_380b, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_380e, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x100e_3811, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100e_3814, 3);  add(eax, 0x1c);                       /* add eax, 0x1c */
            ii(0x100e_3817, 5);  call(0x1007_6338, -0x6_d4e4);         /* call 0x10076338 */
            ii(0x100e_381c, 3);  lea(ebx, memd[ss, ebp - 16]);         /* lea ebx, [ebp-0x10] */
            ...
            ii(0x100e_3828, 4);  mov(memb[ss, ebp - 12], 0);           /* mov byte [ebp-0xc], 0x0 */
            ii(0x100e_382c, 2);  jmp(0x100e_3836, 8); goto l_0x100e_3836;/* jmp 0x100e3836 */
        l_0x100e_382e:
            ii(0x100e_382e, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x100e_3831, 5);  call(0x1007_6bf8, -0x6_cc3e);         /* call 0x10076bf8 */
        l_0x100e_3836:
            ii(0x100e_3836, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100e_3838, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x100e_3844, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x100e_3847, 5);  call(0x1007_63d4, -0x6_d478);         /* call 0x100763d4 */
            ii(0x100e_384c, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x100e_384e, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ...
            ii(0x100e_385a, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x100e_385d, 5);  call(0x1007_63d4, -0x6_d48e);         /* call 0x100763d4 */
            ii(0x100e_3862, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x100e_3864, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100e_3867, 5);  call(0x100e_3347, -0x525);            /* call 0x100e3347 */
            ii(0x100e_386c, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
        l_0x100e_3870:
            ii(0x100e_3870, 2);  jmp(0x100e_382e, -0x44); goto l_0x100e_382e;/* jmp 0x100e382e */
        l_0x100e_3872:
            ii(0x100e_3872, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x100e_3877, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100e_387a, 5);  call(0x100e_41e7, 0x968);             /* call 0x100e41e7 */
            ii(0x100e_387f, 4);  cmp(memb[ss, ebp - 12], 0);           /* cmp byte [ebp-0xc], 0x0 */
        ...
        l_0x100e_38a1:
            ...
            ii(0x100e_38a3, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
