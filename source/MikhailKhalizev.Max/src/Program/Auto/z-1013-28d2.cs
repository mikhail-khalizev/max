...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_28d2()
        {
            ...
            ii(0x1013_28e9, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1013_28ec, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1013_28ef, 5); mov(ebx, 0x26);                         /* mov ebx, 0x26 */
            ii(0x1013_28f4, 5); mov(edx, 0x6d5);                        /* mov edx, 0x6d5 */
            ii(0x1013_28f9, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_28fc, 5); call(0x100d_68a3, -0x5_c05e);           /* call 0x100d68a3 */
            ii(0x1013_2901, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1013_2904, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
            ii(0x1013_2907, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1013_290a, 5); mov(ebx, 0x101b_6c5c);                  /* mov ebx, 0x101b6c5c */
            ii(0x1013_290f, 5); mov(edx, 8);                            /* mov edx, 0x8 */
            ii(0x1013_2914, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ...
            ii(0x1013_2922, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1013_2925, 3); lea(eax, memd[ss, ebp - 8]);            /* lea eax, [ebp-0x8] */
            ii(0x1013_2928, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x1013_292b, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_292e, 7); mov(memd[ds, eax + 19], 0x101b_6c70);   /* mov dword [eax+0x13], 0x101b6c70 */
            ii(0x1013_2935, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1013_2938, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1013_293b, 4); mov(memw[ds, edx + 23], ax);            /* mov [edx+0x17], ax */
            ii(0x1013_293f, 5); mov(eax, 1);                            /* mov eax, 0x1 */
            ...
            ii(0x1013_2957, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_295a, 5); call(0x100d_6adf, -0x5_be80);           /* call 0x100d6adf */
            ii(0x1013_295f, 3); lea(edx, memd[ss, ebp - 52]);           /* lea edx, [ebp-0x34] */
            ii(0x1013_2962, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_2965, 5); call(0x100d_6a11, -0x5_bf59);           /* call 0x100d6a11 */
            ii(0x1013_296a, 5); mov(eax, 5);                            /* mov eax, 0x5 */
            ...
            ii(0x1013_297f, 5); mov(eax, 1);                            /* mov eax, 0x1 */
            ii(0x1013_2984, 1); push(eax);                              /* push eax */
            ii(0x1013_2985, 2); push(2);                                /* push 0x2 */
            ...
            ii(0x1013_29a3, 4); movsx(edx, memw[ss, ebp - 36]);         /* movsx edx, word [ebp-0x24] */
            ii(0x1013_29a7, 3); mov(eax, memd[ss, ebp - 30]);           /* mov eax, [ebp-0x1e] */
            ii(0x1013_29aa, 5); call(0x100e_9ae5, -0x4_8eca);           /* call 0x100e9ae5 */
            ii(0x1013_29af, 5); mov(eax, 1);                            /* mov eax, 0x1 */
            ii(0x1013_29b4, 5); call(/* sys */ 0x1016_a24c, 0x3_7893);  /* call 0x1016a24c */
            ii(0x1013_29b9, 3); lea(eax, memd[ss, ebp - 56]);           /* lea eax, [ebp-0x38] */
            ii(0x1013_29bc, 5); call(0x1013_1cb4, -0xd0d);              /* call 0x10131cb4 */
            ii(0x1013_29c1, 1); push(eax);                              /* push eax */
            ii(0x1013_29c2, 5); mov(eax, 1);                            /* mov eax, 0x1 */
            ...
            ii(0x1013_29dd, 3); lea(eax, memd[ss, ebp - 52]);           /* lea eax, [ebp-0x34] */
            ii(0x1013_29e0, 5); call(0x100e_a99a, -0x4_804b);           /* call 0x100ea99a */
            ii(0x1013_29e5, 3); lea(eax, memd[ss, ebp - 60]);           /* lea eax, [ebp-0x3c] */
            ii(0x1013_29e8, 5); call(0x1013_1cb4, -0xd39);              /* call 0x10131cb4 */
            ii(0x1013_29ed, 1); push(eax);                              /* push eax */
            ii(0x1013_29ee, 5); mov(eax, 1);                            /* mov eax, 0x1 */
            ...
            ii(0x1013_2a09, 3); lea(eax, memd[ss, ebp - 52]);           /* lea eax, [ebp-0x34] */
            ii(0x1013_2a0c, 5); call(0x100e_a99a, -0x4_8077);           /* call 0x100ea99a */
            ii(0x1013_2a11, 3); lea(eax, memd[ss, ebp - 64]);           /* lea eax, [ebp-0x40] */
            ii(0x1013_2a14, 5); call(0x1013_1cb4, -0xd65);              /* call 0x10131cb4 */
            ii(0x1013_2a19, 1); push(eax);                              /* push eax */
            ii(0x1013_2a1a, 5); mov(eax, 1);                            /* mov eax, 0x1 */
            ...
            ii(0x1013_2a35, 3); lea(eax, memd[ss, ebp - 52]);           /* lea eax, [ebp-0x34] */
            ii(0x1013_2a38, 5); call(0x100e_a99a, -0x4_80a3);           /* call 0x100ea99a */
            ii(0x1013_2a3d, 5); mov(eax, 5);                            /* mov eax, 0x5 */
            ...
            ii(0x1013_2a51, 3); mov(memd[ss, ebp - 68], eax);           /* mov [ebp-0x44], eax */
            ii(0x1013_2a54, 3); mov(eax, memd[ss, ebp - 68]);           /* mov eax, [ebp-0x44] */
            ii(0x1013_2a57, 3); mov(memd[ss, ebp - 72], eax);           /* mov [ebp-0x48], eax */
            ii(0x1013_2a5a, 4); cmp(memd[ss, ebp - 72], 0);             /* cmp dword [ebp-0x48], 0x0 */
            ...
            ii(0x1013_2a75, 3); mov(eax, memd[ss, ebp - 68]);           /* mov eax, [ebp-0x44] */
            ii(0x1013_2a78, 5); call(Definitions.my_ctor_c17, -0x6_466e); /* call 0x100ce40f */
            ii(0x1013_2a7d, 3); mov(memd[ss, ebp - 76], eax);           /* mov [ebp-0x4c], eax */
            ii(0x1013_2a80, 3); mov(eax, memd[ss, ebp - 76]);           /* mov eax, [ebp-0x4c] */
            ii(0x1013_2a83, 3); mov(memd[ss, ebp - 80], eax);           /* mov [ebp-0x50], eax */
            ii(0x1013_2a86, 2); jmp(0x1013_2a8e, 6); goto l_0x1013_2a8e; /* jmp 0x10132a8e */
        l_0x1013_2a88:
            ii(0x1013_2a88, 3); mov(eax, memd[ss, ebp - 72]);           /* mov eax, [ebp-0x48] */
            ii(0x1013_2a8b, 3); mov(memd[ss, ebp - 80], eax);           /* mov [ebp-0x50], eax */
        l_0x1013_2a8e:
            ii(0x1013_2a8e, 3); mov(eax, memd[ss, ebp - 80]);           /* mov eax, [ebp-0x50] */
            ii(0x1013_2a91, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1013_2a94, 3); mov(memd[ds, edx + 30], eax);           /* mov [edx+0x1e], eax */
            ii(0x1013_2a97, 3); mov(edx, memd[ss, ebp - 34]);           /* mov edx, [ebp-0x22] */
            ii(0x1013_2a9a, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_2a9d, 3); mov(eax, memd[ds, eax + 30]);           /* mov eax, [eax+0x1e] */
            ii(0x1013_2aa0, 5); call(0x100c_e92d, -0x6_4178);           /* call 0x100ce92d */
            ii(0x1013_2aa5, 3); lea(eax, memd[ss, ebp - 84]);           /* lea eax, [ebp-0x54] */
            ii(0x1013_2aa8, 5); call(0x100d_5224, -0x5_d889);           /* call 0x100d5224 */
            ii(0x1013_2aad, 1); push(eax);                              /* push eax */
            ii(0x1013_2aae, 3); lea(eax, memd[ss, ebp - 88]);           /* lea eax, [ebp-0x58] */
            ii(0x1013_2ab1, 5); call(0x100d_5250, -0x5_d866);           /* call 0x100d5250 */
            ii(0x1013_2ab6, 1); push(eax);                              /* push eax */
            ii(0x1013_2ab7, 3); lea(eax, memd[ss, ebp - 92]);           /* lea eax, [ebp-0x5c] */
            ii(0x1013_2aba, 5); call(0x100d_527c, -0x5_d843);           /* call 0x100d527c */
            ii(0x1013_2abf, 1); push(eax);                              /* push eax */
            ii(0x1013_2ac0, 3); lea(eax, memd[ss, ebp - 96]);           /* lea eax, [ebp-0x60] */
            ...
            ii(0x1013_2ade, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_2ae1, 3); mov(eax, memd[ds, eax + 30]);           /* mov eax, [eax+0x1e] */
            ii(0x1013_2ae4, 5); call(0x100c_ef64, -0x6_3b85);           /* call 0x100cef64 */
            ii(0x1013_2ae9, 3); mov(ebx, memd[ss, ebp - 8]);            /* mov ebx, [ebp-0x8] */
            ii(0x1013_2aec, 5); mov(edx, 0x1013_319e);                  /* mov edx, 0x1013319e */
            ii(0x1013_2af1, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_2af4, 3); mov(eax, memd[ds, eax + 30]);           /* mov eax, [eax+0x1e] */
            ii(0x1013_2af7, 5); call(0x100c_f824, -0x6_32d8);           /* call 0x100cf824 */
            ii(0x1013_2afc, 3); mov(edx, memd[ss, ebp - 34]);           /* mov edx, [ebp-0x22] */
            ii(0x1013_2aff, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_2b02, 3); mov(eax, memd[ds, eax + 30]);           /* mov eax, [eax+0x1e] */
            ...
            ii(0x1013_2b14, 3); mov(memd[ss, ebp - 100], eax);          /* mov [ebp-0x64], eax */
            ii(0x1013_2b17, 3); mov(eax, memd[ss, ebp - 100]);          /* mov eax, [ebp-0x64] */
            ii(0x1013_2b1a, 3); mov(memd[ss, ebp - 104], eax);          /* mov [ebp-0x68], eax */
            ii(0x1013_2b1d, 4); cmp(memd[ss, ebp - 104], 0);            /* cmp dword [ebp-0x68], 0x0 */
            ...
            ii(0x1013_2b38, 3); mov(eax, memd[ss, ebp - 100]);          /* mov eax, [ebp-0x64] */
            ii(0x1013_2b3b, 5); call(Definitions.my_ctor_c17, -0x6_4731); /* call 0x100ce40f */
            ii(0x1013_2b40, 3); mov(memd[ss, ebp - 108], eax);          /* mov [ebp-0x6c], eax */
            ii(0x1013_2b43, 3); mov(eax, memd[ss, ebp - 108]);          /* mov eax, [ebp-0x6c] */
            ii(0x1013_2b46, 3); mov(memd[ss, ebp - 112], eax);          /* mov [ebp-0x70], eax */
            ii(0x1013_2b49, 2); jmp(0x1013_2b51, 6); goto l_0x1013_2b51; /* jmp 0x10132b51 */
        l_0x1013_2b4b:
            ii(0x1013_2b4b, 3); mov(eax, memd[ss, ebp - 104]);          /* mov eax, [ebp-0x68] */
            ii(0x1013_2b4e, 3); mov(memd[ss, ebp - 112], eax);          /* mov [ebp-0x70], eax */
        l_0x1013_2b51:
            ii(0x1013_2b51, 3); mov(eax, memd[ss, ebp - 112]);          /* mov eax, [ebp-0x70] */
            ii(0x1013_2b54, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1013_2b57, 3); mov(memd[ds, edx + 38], eax);           /* mov [edx+0x26], eax */
            ii(0x1013_2b5a, 3); mov(ebx, memd[ss, ebp - 8]);            /* mov ebx, [ebp-0x8] */
            ii(0x1013_2b5d, 5); mov(edx, 0x1013_315b);                  /* mov edx, 0x1013315b */
            ii(0x1013_2b62, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_2b65, 3); mov(eax, memd[ds, eax + 38]);           /* mov eax, [eax+0x26] */
            ii(0x1013_2b68, 5); call(0x100c_f824, -0x6_3349);           /* call 0x100cf824 */
            ii(0x1013_2b6d, 3); mov(edx, memd[ss, ebp - 34]);           /* mov edx, [ebp-0x22] */
            ii(0x1013_2b70, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_2b73, 3); mov(eax, memd[ds, eax + 38]);           /* mov eax, [eax+0x26] */
            ...
            ii(0x1013_2b85, 3); mov(memd[ss, ebp - 116], eax);          /* mov [ebp-0x74], eax */
            ii(0x1013_2b88, 3); mov(eax, memd[ss, ebp - 116]);          /* mov eax, [ebp-0x74] */
            ii(0x1013_2b8b, 3); mov(memd[ss, ebp - 120], eax);          /* mov [ebp-0x78], eax */
            ii(0x1013_2b8e, 4); cmp(memd[ss, ebp - 120], 0);            /* cmp dword [ebp-0x78], 0x0 */
            ...
            ii(0x1013_2ba9, 3); mov(eax, memd[ss, ebp - 116]);          /* mov eax, [ebp-0x74] */
            ii(0x1013_2bac, 5); call(Definitions.my_ctor_c17, -0x6_47a2); /* call 0x100ce40f */
            ii(0x1013_2bb1, 3); mov(memd[ss, ebp - 124], eax);          /* mov [ebp-0x7c], eax */
            ii(0x1013_2bb4, 3); mov(eax, memd[ss, ebp - 124]);          /* mov eax, [ebp-0x7c] */
            ii(0x1013_2bb7, 3); mov(memd[ss, ebp - 128], eax);          /* mov [ebp-0x80], eax */
            ii(0x1013_2bba, 2); jmp(0x1013_2bc2, 6); goto l_0x1013_2bc2; /* jmp 0x10132bc2 */
        l_0x1013_2bbc:
            ii(0x1013_2bbc, 3); mov(eax, memd[ss, ebp - 120]);          /* mov eax, [ebp-0x78] */
            ii(0x1013_2bbf, 3); mov(memd[ss, ebp - 128], eax);          /* mov [ebp-0x80], eax */
        l_0x1013_2bc2:
            ii(0x1013_2bc2, 3); mov(eax, memd[ss, ebp - 128]);          /* mov eax, [ebp-0x80] */
            ii(0x1013_2bc5, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1013_2bc8, 3); mov(memd[ds, edx + 34], eax);           /* mov [edx+0x22], eax */
            ii(0x1013_2bcb, 3); mov(edx, memd[ss, ebp - 34]);           /* mov edx, [ebp-0x22] */
            ii(0x1013_2bce, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_2bd1, 3); mov(eax, memd[ds, eax + 34]);           /* mov eax, [eax+0x22] */
            ii(0x1013_2bd4, 5); call(0x100c_e92d, -0x6_42ac);           /* call 0x100ce92d */
            ii(0x1013_2bd9, 6); lea(eax, memd[ss, ebp - 132]);          /* lea eax, [ebp-0x84] */
            ii(0x1013_2bdf, 5); call(0x100d_5224, -0x5_d9c0);           /* call 0x100d5224 */
            ii(0x1013_2be4, 1); push(eax);                              /* push eax */
            ii(0x1013_2be5, 6); lea(eax, memd[ss, ebp - 136]);          /* lea eax, [ebp-0x88] */
            ii(0x1013_2beb, 5); call(0x100d_5250, -0x5_d9a0);           /* call 0x100d5250 */
            ii(0x1013_2bf0, 1); push(eax);                              /* push eax */
            ii(0x1013_2bf1, 6); lea(eax, memd[ss, ebp - 140]);          /* lea eax, [ebp-0x8c] */
            ii(0x1013_2bf7, 5); call(0x100d_527c, -0x5_d980);           /* call 0x100d527c */
            ii(0x1013_2bfc, 1); push(eax);                              /* push eax */
            ii(0x1013_2bfd, 6); lea(eax, memd[ss, ebp - 144]);          /* lea eax, [ebp-0x90] */
            ...
            ii(0x1013_2c1e, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_2c21, 3); mov(eax, memd[ds, eax + 34]);           /* mov eax, [eax+0x22] */
            ii(0x1013_2c24, 5); call(0x100c_ef64, -0x6_3cc5);           /* call 0x100cef64 */
            ii(0x1013_2c29, 3); mov(ebx, memd[ss, ebp - 8]);            /* mov ebx, [ebp-0x8] */
            ii(0x1013_2c2c, 5); mov(edx, 0x1013_2f81);                  /* mov edx, 0x10132f81 */
            ii(0x1013_2c31, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_2c34, 3); mov(eax, memd[ds, eax + 34]);           /* mov eax, [eax+0x22] */
            ii(0x1013_2c37, 5); call(0x100c_f824, -0x6_3418);           /* call 0x100cf824 */
            ii(0x1013_2c3c, 3); mov(edx, memd[ss, ebp - 34]);           /* mov edx, [ebp-0x22] */
            ii(0x1013_2c3f, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_2c42, 3); mov(eax, memd[ds, eax + 34]);           /* mov eax, [eax+0x22] */
            ii(0x1013_2c45, 5); call(0x100c_f85c, -0x6_33ee);           /* call 0x100cf85c */
            ii(0x1013_2c4a, 4); or(memb[ss, ebp - 12], 1);              /* or byte [ebp-0xc], 0x1 */
            ii(0x1013_2c4e, 6); lea(eax, memd[ss, ebp - 148]);          /* lea eax, [ebp-0x94] */
            ii(0x1013_2c54, 5); call(0x1007_64fc, -0xb_c75d);           /* call 0x100764fc */
            ii(0x1013_2c59, 6); mov(memd[ss, ebp - 152], eax);          /* mov [ebp-0x98], eax */
            ii(0x1013_2c5f, 4); and(memb[ss, ebp - 12], -2 /* 0xfe */); /* and byte [ebp-0xc], 0xfe */
            ii(0x1013_2c63, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_2c66, 6); mov(memw[ds, eax + 25], 0);             /* mov word [eax+0x19], 0x0 */
            ii(0x1013_2c6c, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_2c6f, 6); mov(memw[ds, eax + 27], 0);             /* mov word [eax+0x1b], 0x0 */
            ii(0x1013_2c75, 5); mov(ebx, 0x10);                         /* mov ebx, 0x10 */
            ii(0x1013_2c7a, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_2c7c, 6); lea(eax, memd[ss, ebp - 168]);          /* lea eax, [ebp-0xa8] */
            ...
            ii(0x1013_2c91, 6); lea(ebx, memd[ss, ebp - 148]);          /* lea ebx, [ebp-0x94] */
        ...
        l_0x1013_2ca2:
            ii(0x1013_2ca2, 6); lea(eax, memd[ss, ebp - 148]);          /* lea eax, [ebp-0x94] */
            ii(0x1013_2ca8, 5); call(0x1007_6bf8, -0xb_c0b5);           /* call 0x10076bf8 */
        l_0x1013_2cad:
            ii(0x1013_2cad, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_2caf, 6); lea(eax, memd[ss, ebp - 148]);          /* lea eax, [ebp-0x94] */
            ...
            ii(0x1013_2cbe, 6); lea(eax, memd[ss, ebp - 148]);          /* lea eax, [ebp-0x94] */
            ii(0x1013_2cc4, 5); call(0x1007_63a0, -0xb_c929);           /* call 0x100763a0 */
            ii(0x1013_2cc9, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_2ccb, 3); mov(dl, memb[ds, eax + 38]);            /* mov dl, [eax+0x26] */
            ii(0x1013_2cce, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_2cd1, 3); mov(eax, memd[ds, eax + 21]);           /* mov eax, [eax+0x15] */
            ...
            ii(0x1013_2cdb, 6); lea(eax, memd[ss, ebp - 148]);          /* lea eax, [ebp-0x94] */
            ii(0x1013_2ce1, 5); call(0x1007_63a0, -0xb_c946);           /* call 0x100763a0 */
            ii(0x1013_2ce6, 5); cmp(memw[ds, eax + 8], 0x1d);           /* cmp word [eax+0x8], 0x1d */
            ii(0x1013_2ceb, 2); if(jz(0x1013_2cef, 2)) goto l_0x1013_2cef; /* jz 0x10132cef */
        l_0x1013_2ced:
            ii(0x1013_2ced, 2); jmp(0x1013_2d00, 0x11); goto l_0x1013_2d00; /* jmp 0x10132d00 */
        l_0x1013_2cef:
            ii(0x1013_2cef, 6); lea(eax, memd[ss, ebp - 148]);          /* lea eax, [ebp-0x94] */
            ii(0x1013_2cf5, 5); call(0x1007_63a0, -0xb_c95a);           /* call 0x100763a0 */
            ii(0x1013_2cfa, 4); cmp(memb[ds, eax + 61], 7);             /* cmp byte [eax+0x3d], 0x7 */
            ii(0x1013_2cfe, 2); if(jz(0x1013_2d02, 2)) goto l_0x1013_2d02; /* jz 0x10132d02 */
        l_0x1013_2d00:
            ii(0x1013_2d00, 2); jmp(0x1013_2d24, 0x22); goto l_0x1013_2d24; /* jmp 0x10132d24 */
        l_0x1013_2d02:
            ii(0x1013_2d02, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_2d05, 4); inc(memw[ds, eax + 27]);                /* inc word [eax+0x1b] */
            ii(0x1013_2d09, 6); lea(eax, memd[ss, ebp - 148]);          /* lea eax, [ebp-0x94] */
            ii(0x1013_2d0f, 5); call(0x1007_63a0, -0xb_c974);           /* call 0x100763a0 */
            ii(0x1013_2d14, 3); mov(eax, memd[ds, eax + 90]);           /* mov eax, [eax+0x5a] */
            ii(0x1013_2d17, 3); sar(eax, 0x18);                         /* sar eax, 0x18 */
            ii(0x1013_2d1a, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x1013_2d1c, 8); inc(memw[ds, eax + ebp - 168]);         /* inc word [eax+ebp-0xa8] */
        l_0x1013_2d24:
            ii(0x1013_2d24, 5); jmp(0x1013_2ca2, -0x87); goto l_0x1013_2ca2; /* jmp 0x10132ca2 */
        l_0x1013_2d29:
            ii(0x1013_2d29, 7); mov(memd[ss, ebp - 16], 0);             /* mov dword [ebp-0x10], 0x0 */
            ii(0x1013_2d30, 2); jmp(0x1013_2d38, 6); goto l_0x1013_2d38; /* jmp 0x10132d38 */
        l_0x1013_2d32:
            ii(0x1013_2d32, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
            ii(0x1013_2d35, 3); inc(memd[ss, ebp - 16]);                /* inc dword [ebp-0x10] */
        l_0x1013_2d38:
            ii(0x1013_2d38, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x1013_2d3c, 3); cmp(eax, 8);                            /* cmp eax, 0x8 */
            ii(0x1013_2d3f, 2); if(jge(0x1013_2d6e, 0x2d)) goto l_0x1013_2d6e; /* jge 0x10132d6e */
            ii(0x1013_2d41, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x1013_2d45, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x1013_2d47, 7); mov(ecx, memd[ds, eax + ebp - 170]);    /* mov ecx, [eax+ebp-0xaa] */
            ii(0x1013_2d4e, 3); sar(ecx, 0x10);                         /* sar ecx, 0x10 */
            ii(0x1013_2d51, 4); movsx(ebx, memb[ss, ebp - 16]);         /* movsx ebx, byte [ebp-0x10] */
            ii(0x1013_2d55, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1013_2d58, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x1013_2d5c, 3); imul(eax, eax, 0x1f);                   /* imul eax, eax, 0x1f */
            ii(0x1013_2d5f, 3); mov(esi, memd[ss, ebp - 8]);            /* mov esi, [ebp-0x8] */
        ...
        l_0x1013_2d6e:
            ii(0x1013_2d6e, 3); mov(eax, memd[ss, ebp - 34]);           /* mov eax, [ebp-0x22] */
            ii(0x1013_2d71, 5); call(Definitions.sys_display_draw_0, 0x3_470e); /* call 0x10167484 */
            ii(0x1013_2d76, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_2d78, 6); lea(eax, memd[ss, ebp - 148]);          /* lea eax, [ebp-0x94] */
            ii(0x1013_2d7e, 5); call(0x1007_5f6c, -0xb_ce17);           /* call 0x10075f6c */
            ii(0x1013_2d83, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1013_2d86, 6); mov(memd[ss, ebp - 172], eax);          /* mov [ebp-0xac], eax */
            ii(0x1013_2d8c, 6); mov(eax, memd[ss, ebp - 172]);          /* mov eax, [ebp-0xac] */
