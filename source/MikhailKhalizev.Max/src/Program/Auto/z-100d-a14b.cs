...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_a14b()
        {
            ...
            ii(0x100d_a162, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_a165, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_a168, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100d_a16c, 3); shl(eax, 0x2);                          /* shl eax, 0x2 */
            ii(0x100d_a16f, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100d_a171, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_a180, 3); mov(eax, memd[ds, eax + 0x17]);         /* mov eax, [eax+0x17] */
            ...
            ii(0x100d_a18e, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_a191, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
        ...
        l_0x100d_a1a0:
            ii(0x100d_a1a0, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100d_a1a3, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100d_a1a6, 5); cmp(memw[ss, ebp - 0x10], 0x3c);        /* cmp word [ebp-0x10], 0x3c */
            ii(0x100d_a1ab, 2); if(jb(0x100d_a1d4, 0x27)) goto l_0x100d_a1d4; /* jb 0x100da1d4 */
            ii(0x100d_a1ad, 5); cmp(memw[ss, ebp - 0x10], 0x3c);        /* cmp word [ebp-0x10], 0x3c */
            ii(0x100d_a1b2, 2); if(jbe(0x100d_a196, -0x1e)) goto l_0x100d_a196; /* jbe 0x100da196 */
            ii(0x100d_a1b4, 5); cmp(memw[ss, ebp - 0x10], 0x40);        /* cmp word [ebp-0x10], 0x40 */
            ii(0x100d_a1b9, 2); if(jb(0x100d_a1cb, 0x10)) goto l_0x100d_a1cb; /* jb 0x100da1cb */
            ii(0x100d_a1bb, 5); cmp(memw[ss, ebp - 0x10], 0x40);        /* cmp word [ebp-0x10], 0x40 */
            ii(0x100d_a1c0, 2); if(jbe(0x100d_a196, -0x2c)) goto l_0x100d_a196; /* jbe 0x100da196 */
            ii(0x100d_a1c2, 5); cmp(memw[ss, ebp - 0x10], 0x4b);        /* cmp word [ebp-0x10], 0x4b */
        ...
        l_0x100d_a1cb:
            ii(0x100d_a1cb, 5); cmp(memw[ss, ebp - 0x10], 0x3d);        /* cmp word [ebp-0x10], 0x3d */
        ...
        l_0x100d_a1d4:
            ii(0x100d_a1d4, 5); cmp(memw[ss, ebp - 0x10], 0x31);        /* cmp word [ebp-0x10], 0x31 */
            ii(0x100d_a1d9, 2); if(jb(0x100d_a1eb, 0x10)) goto l_0x100d_a1eb; /* jb 0x100da1eb */
            ii(0x100d_a1db, 5); cmp(memw[ss, ebp - 0x10], 0x31);        /* cmp word [ebp-0x10], 0x31 */
            ii(0x100d_a1e0, 2); if(jbe(0x100d_a196, -0x4c)) goto l_0x100d_a196; /* jbe 0x100da196 */
            ii(0x100d_a1e2, 5); cmp(memw[ss, ebp - 0x10], 0x3b);        /* cmp word [ebp-0x10], 0x3b */
        ...
        l_0x100d_a1eb:
            ii(0x100d_a1eb, 5); cmp(memw[ss, ebp - 0x10], 0x6);         /* cmp word [ebp-0x10], 0x6 */
            ii(0x100d_a1f0, 2); if(jb(0x100d_a1fb, 0x9)) goto l_0x100d_a1fb; /* jb 0x100da1fb */
            ii(0x100d_a1f2, 5); cmp(memw[ss, ebp - 0x10], 0x8);         /* cmp word [ebp-0x10], 0x8 */
        ...
        l_0x100d_a1fd:
            ii(0x100d_a1fd, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_a200, 5); add(memw[ds, eax + 0x53], 0x13);        /* add word [eax+0x53], 0x13 */
        l_0x100d_a205:
