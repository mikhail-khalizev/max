...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_a86a()
        {
            ...
            ii(0x1014_a882, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_a885, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_a888, 5); add(eax, 0x94);                         /* add eax, 0x94 */
            ii(0x1014_a88d, 5); call(0x1008_aef4, -0xb_f99e);           /* call 0x1008aef4 */
            ii(0x1014_a892, 3); lea(ebx, memd[ss, ebp - 0x8]);          /* lea ebx, [ebp-0x8] */
            ...
            ii(0x1014_a89e, 2); jmp(0x1014_a8a8, 0x8); goto l_0x1014_a8a8; /* jmp 0x1014a8a8 */
        l_0x1014_a8a0:
            ii(0x1014_a8a0, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1014_a8a3, 5); call(0x1007_6bf8, -0xd_3cb0);           /* call 0x10076bf8 */
        l_0x1014_a8a8:
            ii(0x1014_a8a8, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1014_a8aa, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x1014_a8b6, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1014_a8b9, 5); call(0x1008_adc4, -0xb_fafa);           /* call 0x1008adc4 */
            ii(0x1014_a8be, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1014_a8c1, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1014_a8c4, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x1014_a8c7, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_a8ca, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1014_a8cd, 3); call_abs(memd[ds, ebx + 0x54]);         /* call dword [ebx+0x54] */
            ii(0x1014_a8d0, 2); jmp(0x1014_a8a0, -0x32); goto l_0x1014_a8a0; /* jmp 0x1014a8a0 */
        l_0x1014_a8d2:
            ii(0x1014_a8d2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_a8e1, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
