...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_edfc()
        {
            ...
            ii(0x100f_ee14, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100f_ee17, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_ee1b, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ...
            ii(0x100f_ee39, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_ee3d, 5); call(0x100f_ecf6, -0x14c);              /* call 0x100fecf6 */
            ii(0x100f_ee42, 5); mov(edx, 0x101c_819c);                  /* mov edx, 0x101c819c */
            ii(0x100f_ee47, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_ee4b, 5); call(0x100f_ecf6, -0x15a);              /* call 0x100fecf6 */
            ii(0x100f_ee50, 5); mov(edx, 0x101c_81a8);                  /* mov edx, 0x101c81a8 */
            ii(0x100f_ee55, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_ee59, 5); call(0x100f_ecf6, -0x168);              /* call 0x100fecf6 */
            ii(0x100f_ee5e, 5); mov(edx, 0x101c_8184);                  /* mov edx, 0x101c8184 */
            ii(0x100f_ee63, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_ee67, 5); call(0x100f_ed71, -0xfb);               /* call 0x100fed71 */
            ii(0x100f_ee6c, 5); mov(edx, 0x101c_819c);                  /* mov edx, 0x101c819c */
            ii(0x100f_ee71, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_ee75, 5); call(0x100f_ed71, -0x109);              /* call 0x100fed71 */
            ii(0x100f_ee7a, 5); mov(edx, 0x101c_81a8);                  /* mov edx, 0x101c81a8 */
            ii(0x100f_ee7f, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_ee83, 5); call(0x100f_ed71, -0x117);              /* call 0x100fed71 */
            ii(0x100f_ee88, 4); mov(memb[ss, ebp - 0x8], 0x8);          /* mov byte [ebp-0x8], 0x8 */
            ii(0x100f_ee8c, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x100f_ee90, 2); jmp(0x100f_ee95, 0x3); goto l_0x100f_ee95; /* jmp 0x100fee95 */
        l_0x100f_ee92:
            ii(0x100f_ee92, 3); inc(memb[ss, ebp - 0x8]);               /* inc byte [ebp-0x8] */
        l_0x100f_ee95:
            ii(0x100f_ee95, 4); cmp(memb[ss, ebp - 0x8], 0x8);          /* cmp byte [ebp-0x8], 0x8 */
            ii(0x100f_ee99, 2); if(jge(0x100f_eee3, 0x48)) goto l_0x100f_eee3; /* jge 0x100feee3 */
            ii(0x100f_ee9b, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_eeac, 4); movsx(eax, memb[ss, ebp - 0x8]);        /* movsx eax, byte [ebp-0x8] */
            ...
            ii(0x100f_eebb, 3); mov(memd[ss, ebp - 0xc], edx);          /* mov [ebp-0xc], edx */
            ii(0x100f_eebe, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_eec1, 4); cmp(memd[ds, eax + 0x8], 0);            /* cmp dword [eax+0x8], 0x0 */
            ii(0x100f_eec5, 2); if(jz(0x100f_eed0, 0x9)) goto l_0x100f_eed0; /* jz 0x100feed0 */
            ii(0x100f_eec7, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_eeca, 4); cmp(memd[ds, eax + 0x4], 0);            /* cmp dword [eax+0x4], 0x0 */
            ii(0x100f_eece, 2); if(jz(0x100f_eed2, 0x2)) goto l_0x100f_eed2; /* jz 0x100feed2 */
        l_0x100f_eed0:
            ii(0x100f_eed0, 2); jmp(0x100f_eee1, 0xf); goto l_0x100f_eee1; /* jmp 0x100feee1 */
        l_0x100f_eed2:
            ii(0x100f_eed2, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x100f_eed4, 4); movsx(edx, memb[ss, ebp - 0x8]);        /* movsx edx, byte [ebp-0x8] */
            ii(0x100f_eed8, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
