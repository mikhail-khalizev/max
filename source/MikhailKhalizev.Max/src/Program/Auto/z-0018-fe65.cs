...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x18_fe65, 4); enter(0, 0);                              /* enter 0x0, 0x0 */
            ...
            ii(0x18_fe73, 4); mov(memd[ds, 0xa42], eax);                /* mov [0xa42], eax */
            ii(0x18_fe77, 4); mov(memd[ds, 0xa46], eax);                /* mov [0xa46], eax */
            ii(0x18_fe7b, 1); push(ds);                                 /* push ds */
        ...
        l_0x18_fe8e:
            ...
            ii(0x18_fe94, 3); call(0x18_fef0, 0x59);                    /* call 0xfef0 */
            ii(0x18_fe97, 2); or(ax, ax);                               /* or ax, ax */
            ii(0x18_fe99, 1); pop(si);                                  /* pop si */
            ii(0x18_fe9a, 1); pop(ax);                                  /* pop ax */
            ii(0x18_fe9b, 4); if(jz(0x18_feb9, 0x1a)) goto l_0x18_feb9; /* jz 0xfeb9 */
            ii(0x18_fe9f, 1); inc(si);                                  /* inc si */
            ii(0x18_fea0, 4); cmp(si, 0x120);                           /* cmp si, 0x120 */
            ii(0x18_fea4, 2); if(jb(0x18_fe8e, -0x18)) goto l_0x18_fe8e; /* jb 0xfe8e */
        ...
        l_0x18_febb:
            ...
            ii(0x18_febc, 1); pop(bp);                                  /* pop bp */
            ii(0x18_febd, 1); retf();                                   /* retf */
        }
    }
}
