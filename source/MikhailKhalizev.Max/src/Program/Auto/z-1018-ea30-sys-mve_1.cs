...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ mve_1()
        {
            ...
            ii(0x1018_ea49, 3); mov(al, memb[ds, esi + 0x2]);           /* mov al, [esi+0x2] */
            ii(0x1018_ea4c, 3); mov(ebx, memd[ds, ecx + eax * 4]);      /* mov ebx, [ecx+eax*4] */
            ii(0x1018_ea4f, 2); mov(memb[ds, edx], bl);                 /* mov [edx], bl */
            ii(0x1018_ea51, 3); mov(memb[ds, edx + 0x6], bh);           /* mov [edx+0x6], bh */
            ...
            ii(0x1018_ea5d, 3); mov(al, memb[ds, esi + 0x3]);           /* mov al, [esi+0x3] */
            ...
            ii(0x1018_ea72, 3); mov(al, memb[ds, esi + 0x4]);           /* mov al, [esi+0x4] */
            ...
            ii(0x1018_ea87, 3); mov(al, memb[ds, esi + 0x5]);           /* mov al, [esi+0x5] */
            ...
            ii(0x1018_ea9f, 3); mov(al, memb[ds, esi + 0x6]);           /* mov al, [esi+0x6] */
            ii(0x1018_eaa2, 3); mov(ebx, memd[ds, ecx + eax * 4]);      /* mov ebx, [ecx+eax*4] */
            ii(0x1018_eaa5, 2); mov(memb[ds, edx], bl);                 /* mov [edx], bl */
            ii(0x1018_eaa7, 3); mov(memb[ds, edx + 0x6], bh);           /* mov [edx+0x6], bh */
            ...
            ii(0x1018_eab3, 3); mov(al, memb[ds, esi + 0x7]);           /* mov al, [esi+0x7] */
            ...
            ii(0x1018_eac8, 3); mov(al, memb[ds, esi + 0x8]);           /* mov al, [esi+0x8] */
            ...
            ii(0x1018_eadd, 3); mov(al, memb[ds, esi + 0x9]);           /* mov al, [esi+0x9] */
            ...
            ii(0x1018_eb0b, 2); if(jmp_func(0x1018_eb10, 0x3)) return;  /* jmp 0x1018eb10 */
        }
    }
}
