...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ mve_1()
        {
            ...
            ii(0x1018_ea57, 3);  mov(memb[ds, edx + 11], bl);          /* mov [edx+0xb], bl */
            ii(0x1018_ea5a, 3);  mov(memb[ds, edx + 17], bh);          /* mov [edx+0x11], bh */
            ii(0x1018_ea5d, 3);  mov(al, memb[ds, esi + 3]);           /* mov al, [esi+0x3] */
            ii(0x1018_ea60, 3);  mov(ebx, memd[ds, ecx + eax * 4]);    /* mov ebx, [ecx+eax*4] */
            ii(0x1018_ea63, 3);  mov(memb[ds, edx + 25], bl);          /* mov [edx+0x19], bl */
            ii(0x1018_ea66, 3);  mov(memb[ds, edx + 31], bh);          /* mov [edx+0x1f], bh */
            ii(0x1018_ea69, 3);  shr(ebx, 0x10);                       /* shr ebx, 0x10 */
            ii(0x1018_ea6c, 3);  mov(memb[ds, edx + 36], bl);          /* mov [edx+0x24], bl */
            ii(0x1018_ea6f, 3);  mov(memb[ds, edx + 42], bh);          /* mov [edx+0x2a], bh */
            ii(0x1018_ea72, 3);  mov(al, memb[ds, esi + 4]);           /* mov al, [esi+0x4] */
            ii(0x1018_ea75, 3);  mov(ebx, memd[ds, ecx + eax * 4]);    /* mov ebx, [ecx+eax*4] */
            ii(0x1018_ea78, 3);  mov(memb[ds, edx + 50], bl);          /* mov [edx+0x32], bl */
            ii(0x1018_ea7b, 3);  mov(memb[ds, edx + 56], bh);          /* mov [edx+0x38], bh */
            ii(0x1018_ea7e, 3);  shr(ebx, 0x10);                       /* shr ebx, 0x10 */
            ii(0x1018_ea81, 3);  mov(memb[ds, edx + 61], bl);          /* mov [edx+0x3d], bl */
            ii(0x1018_ea84, 3);  mov(memb[ds, edx + 67], bh);          /* mov [edx+0x43], bh */
            ii(0x1018_ea87, 3);  mov(al, memb[ds, esi + 5]);           /* mov al, [esi+0x5] */
            ii(0x1018_ea8a, 3);  mov(ebx, memd[ds, ecx + eax * 4]);    /* mov ebx, [ecx+eax*4] */
            ii(0x1018_ea8d, 3);  mov(memb[ds, edx + 75], bl);          /* mov [edx+0x4b], bl */
            ii(0x1018_ea90, 3);  mov(memb[ds, edx + 81], bh);          /* mov [edx+0x51], bh */
            ii(0x1018_ea93, 3);  shr(ebx, 0x10);                       /* shr ebx, 0x10 */
            ii(0x1018_ea96, 3);  mov(memb[ds, edx + 86], bl);          /* mov [edx+0x56], bl */
            ii(0x1018_ea99, 3);  mov(memb[ds, edx + 92], bh);          /* mov [edx+0x5c], bh */
            ii(0x1018_ea9c, 3);  lea(edx, memd[ds, edx + 100]);        /* lea edx, [edx+0x64] */
            ...
            ii(0x1018_eaad, 3);  mov(memb[ds, edx + 11], bl);          /* mov [edx+0xb], bl */
            ii(0x1018_eab0, 3);  mov(memb[ds, edx + 17], bh);          /* mov [edx+0x11], bh */
            ii(0x1018_eab3, 3);  mov(al, memb[ds, esi + 7]);           /* mov al, [esi+0x7] */
            ii(0x1018_eab6, 3);  mov(ebx, memd[ds, ecx + eax * 4]);    /* mov ebx, [ecx+eax*4] */
            ii(0x1018_eab9, 3);  mov(memb[ds, edx + 25], bl);          /* mov [edx+0x19], bl */
            ii(0x1018_eabc, 3);  mov(memb[ds, edx + 31], bh);          /* mov [edx+0x1f], bh */
            ii(0x1018_eabf, 3);  shr(ebx, 0x10);                       /* shr ebx, 0x10 */
            ii(0x1018_eac2, 3);  mov(memb[ds, edx + 36], bl);          /* mov [edx+0x24], bl */
            ii(0x1018_eac5, 3);  mov(memb[ds, edx + 42], bh);          /* mov [edx+0x2a], bh */
            ii(0x1018_eac8, 3);  mov(al, memb[ds, esi + 8]);           /* mov al, [esi+0x8] */
            ii(0x1018_eacb, 3);  mov(ebx, memd[ds, ecx + eax * 4]);    /* mov ebx, [ecx+eax*4] */
            ii(0x1018_eace, 3);  mov(memb[ds, edx + 50], bl);          /* mov [edx+0x32], bl */
            ii(0x1018_ead1, 3);  mov(memb[ds, edx + 56], bh);          /* mov [edx+0x38], bh */
            ii(0x1018_ead4, 3);  shr(ebx, 0x10);                       /* shr ebx, 0x10 */
            ii(0x1018_ead7, 3);  mov(memb[ds, edx + 61], bl);          /* mov [edx+0x3d], bl */
            ii(0x1018_eada, 3);  mov(memb[ds, edx + 67], bh);          /* mov [edx+0x43], bh */
            ii(0x1018_eadd, 3);  mov(al, memb[ds, esi + 9]);           /* mov al, [esi+0x9] */
            ii(0x1018_eae0, 3);  mov(ebx, memd[ds, ecx + eax * 4]);    /* mov ebx, [ecx+eax*4] */
            ii(0x1018_eae3, 3);  mov(memb[ds, edx + 75], bl);          /* mov [edx+0x4b], bl */
            ii(0x1018_eae6, 3);  mov(memb[ds, edx + 81], bh);          /* mov [edx+0x51], bh */
            ii(0x1018_eae9, 3);  shr(ebx, 0x10);                       /* shr ebx, 0x10 */
            ii(0x1018_eaec, 3);  mov(memb[ds, edx + 86], bl);          /* mov [edx+0x56], bl */
            ii(0x1018_eaef, 3);  mov(memb[ds, edx + 92], bh);          /* mov [edx+0x5c], bh */
            ...
            ii(0x1018_eb0b, 2);  jmp_func(0x1018_eb10, 3);             /* jmp 0x1018eb10 */
        }
    }
}
