...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_6e86()
        {
            ...
            ii(0x1010_6e98, 6);  sub(esp, 4);                          /* sub esp, 0x4 */
            ii(0x1010_6e9e, 5);  call(/* sys */ 0x1016_c3f0, 0x6_554d);/* call 0x1016c3f0 */
            ii(0x1010_6ea3, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1010_6ea6, 4);  cmp(memd[ss, ebp - 4], 0);            /* cmp dword [ebp-0x4], 0x0 */
            ii(0x1010_6eaa, 2);  if(jnz(0x1010_6eb6, 0xa)) goto l_0x1010_6eb6;/* jnz 0x10106eb6 */
            ii(0x1010_6eac, 5);  mov(eax, 2);                          /* mov eax, 0x2 */
