...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("2eb009ff-3fcb-4bbe-afae-6c36f7a29c17")]
        public void Method_1010_6e86()
        {
            ii(0x1010_6e86, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x1010_6e8b, 5); calld(Definitions.sys_check_available_stack_size, 0x5eec2); /* call 0x10165d52 */
            ...
            ii(0x1010_6e9e, 5); calld(/* sys */ 0x1016_c3f0, 0x6554d);  /* call 0x1016c3f0 */
            ...
            ii(0x1010_6eb1, 5); calld(0x100e_f3a0, -0x17b16);           /* call 0x100ef3a0 */
        l_0x1010_6eb6:
