...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_b040()
        {
            ...
            ii(0x17_b04b, 3); les(bx, memw[ss, bp + 0x6]);              /* les bx, [bp+0x6] */
            ii(0x17_b04e, 4); mov(ax, memw[es, bx + 0x8]);              /* mov ax, [es:bx+0x8] */
            ii(0x17_b052, 2); sub(cx, cx);                              /* sub cx, cx */
            ii(0x17_b054, 4); mov(dx, memw[es, bx + 0x4]);              /* mov dx, [es:bx+0x4] */
            ii(0x17_b058, 2); add(cx, dx);                              /* add cx, dx */
            ii(0x17_b05a, 3); adc(ax, 0);                               /* adc ax, 0x0 */
            ii(0x17_b05d, 3); mov(memw[ss, bp - 0x1e], cx);             /* mov [bp-0x1e], cx */
            ii(0x17_b060, 3); mov(memw[ss, bp - 0x1c], ax);             /* mov [bp-0x1c], ax */
            ...
            ii(0x17_b085, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_b088, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ...
            ii(0x17_b097, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_b09a, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
        l_0x17_b09d:
            ii(0x17_b09d, 3); mov(bx, memw[ss, bp + 0x6]);              /* mov bx, [bp+0x6] */
            ii(0x17_b0a0, 4); mov(ax, memw[es, bx + 0x14]);             /* mov ax, [es:bx+0x14] */
            ii(0x17_b0a4, 2); sub(cx, cx);                              /* sub cx, cx */
            ii(0x17_b0a6, 4); add(cx, memw[es, bx + 0x1c]);             /* add cx, [es:bx+0x1c] */
            ii(0x17_b0aa, 3); adc(ax, 0);                               /* adc ax, 0x0 */
            ii(0x17_b0ad, 3); mov(memw[ss, bp - 0x8], cx);              /* mov [bp-0x8], cx */
            ii(0x17_b0b0, 3); mov(memw[ss, bp - 0x6], ax);              /* mov [bp-0x6], ax */
            ii(0x17_b0b3, 1); push(ax);                                 /* push ax */
            ii(0x17_b0b4, 1); push(cx);                                 /* push cx */
            ii(0x17_b0b5, 1); push(dx);                                 /* push dx */
            ii(0x17_b0b6, 3); push(memw[ss, bp - 0x4]);                 /* push word [bp-0x4] */
            ...
            ii(0x17_b0c5, 5); cmp(memw[ss, bp - 0x6], 0x1000);          /* cmp word [bp-0x6], 0x1000 */
        ...
        l_0x17_b0ce:
            ii(0x17_b0ce, 3); mov(ax, memw[ss, bp - 0x8]);              /* mov ax, [bp-0x8] */
            ii(0x17_b0d1, 3); mov(dx, memw[ss, bp - 0x6]);              /* mov dx, [bp-0x6] */
            ii(0x17_b0d4, 3); add(ax, memw[ss, bp - 0x1e]);             /* add ax, [bp-0x1e] */
            ii(0x17_b0d7, 3); adc(dx, memw[ss, bp - 0x1c]);             /* adc dx, [bp-0x1c] */
            ii(0x17_b0da, 4); cmp(dx, memw[ds, 0x4fda]);                /* cmp dx, [0x4fda] */
            ii(0x17_b0de, 2); if(jb(0x17_b100, 0x20)) goto l_0x17_b100; /* jb 0xb100 */
            ii(0x17_b0e0, 2); if(ja(0x17_b0e8, 0x6)) goto l_0x17_b0e8;  /* ja 0xb0e8 */
            ii(0x17_b0e2, 4); cmp(ax, memw[ds, 0x4fd8]);                /* cmp ax, [0x4fd8] */
            ii(0x17_b0e6, 2); if(jbe(0x17_b100, 0x18)) goto l_0x17_b100; /* jbe 0xb100 */
        l_0x17_b0e8:
            ii(0x17_b0e8, 3); les(bx, memw[ss, bp + 0x6]);              /* les bx, [bp+0x6] */
            ii(0x17_b0eb, 5); or(memb[es, bx + 0x2c], 0x1);             /* or byte [es:bx+0x2c], 0x1 */
            ii(0x17_b0f0, 6); mov(memw[es, bx + 0x20], 0x8025);         /* mov word [es:bx+0x20], 0x8025 */
            ii(0x17_b0f6, 6); mov(memw[es, bx + 0x22], 0);              /* mov word [es:bx+0x22], 0x0 */
            ii(0x17_b0fc, 1); pop(ds);                                  /* pop ds */
            ii(0x17_b0fd, 1); pop(si);                                  /* pop si */
            ii(0x17_b0fe, 1); leave();                                  /* leave */
            ii(0x17_b0ff, 1); retf(); return;                           /* retf */
        l_0x17_b100:
            ii(0x17_b100, 3); mov(ax, memw[ss, bp - 0x8]);              /* mov ax, [bp-0x8] */
            ii(0x17_b103, 3); mov(dx, memw[ss, bp - 0x6]);              /* mov dx, [bp-0x6] */
            ...
            ii(0x17_b125, 3); mov(memw[ss, bp - 0x14], ax);             /* mov [bp-0x14], ax */
            ii(0x17_b128, 3); mov(memw[ss, bp - 0x12], dx);             /* mov [bp-0x12], dx */
            ii(0x17_b12b, 2); sub(ax, ax);                              /* sub ax, ax */
            ii(0x17_b12d, 3); mov(memw[ss, bp - 0x16], ax);             /* mov [bp-0x16], ax */
            ii(0x17_b130, 3); mov(memw[ss, bp - 0x18], ax);             /* mov [bp-0x18], ax */
            ii(0x17_b133, 2); jmp(0x17_b146, 0x11); goto l_0x17_b146;   /* jmp 0xb146 */
        //  ii(0x17_b135, 1); nop();                                    /* nop */
        l_0x17_b136:
            ii(0x17_b136, 4); add(memw[ss, bp - 0x18], 0x1);            /* add word [bp-0x18], 0x1 */
            ii(0x17_b13a, 4); adc(memw[ss, bp - 0x16], 0);              /* adc word [bp-0x16], 0x0 */
            ii(0x17_b13e, 4); add(memw[ss, bp - 0x14], 0x1);            /* add word [bp-0x14], 0x1 */
            ii(0x17_b142, 4); adc(memw[ss, bp - 0x12], 0);              /* adc word [bp-0x12], 0x0 */
        l_0x17_b146:
            ii(0x17_b146, 3); mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0x17_b149, 3); mov(dx, memw[ss, bp - 0x2]);              /* mov dx, [bp-0x2] */
            ii(0x17_b14c, 3); cmp(memw[ss, bp - 0x16], dx);             /* cmp [bp-0x16], dx */
            ii(0x17_b14f, 2); if(jbe(0x17_b154, 0x3)) goto l_0x17_b154; /* jbe 0xb154 */
            ii(0x17_b151, 3); jmp(0x17_b200, 0xac); goto l_0x17_b200;   /* jmp 0xb200 */
        l_0x17_b154:
            ii(0x17_b154, 2); if(jb(0x17_b15e, 0x8)) goto l_0x17_b15e;  /* jb 0xb15e */
            ii(0x17_b156, 3); cmp(memw[ss, bp - 0x18], ax);             /* cmp [bp-0x18], ax */
            ii(0x17_b159, 2); if(jb(0x17_b15e, 0x3)) goto l_0x17_b15e;  /* jb 0xb15e */
            ii(0x17_b15b, 3); jmp(0x17_b200, 0xa2); goto l_0x17_b200;   /* jmp 0xb200 */
        l_0x17_b15e:
            ii(0x17_b15e, 3); mov(ax, memw[ss, bp - 0x14]);             /* mov ax, [bp-0x14] */
            ii(0x17_b161, 3); mov(dx, memw[ss, bp - 0x12]);             /* mov dx, [bp-0x12] */
            ii(0x17_b164, 3); add(ax, 0);                               /* add ax, 0x0 */
            ii(0x17_b167, 3); adc(dx, 0x1);                             /* adc dx, 0x1 */
            ii(0x17_b16a, 3); mov(memw[ss, bp - 0x10], ax);             /* mov [bp-0x10], ax */
            ii(0x17_b16d, 3); mov(memw[ss, bp - 0xe], dx);              /* mov [bp-0xe], dx */
            ii(0x17_b170, 3); push(memw[ss, bp - 0x12]);                /* push word [bp-0x12] */
            ii(0x17_b173, 3); push(memw[ss, bp - 0x14]);                /* push word [bp-0x14] */
            ...
            ii(0x17_b184, 3); mov(memw[ss, bp - 0x20], ax);             /* mov [bp-0x20], ax */
            ...
            ii(0x17_b19d, 3); push(memw[ss, bp - 0x12]);                /* push word [bp-0x12] */
            ii(0x17_b1a0, 3); push(memw[ss, bp - 0x14]);                /* push word [bp-0x14] */
            ...
            ii(0x17_b1b1, 3); mov(memw[ss, bp - 0xc], ax);              /* mov [bp-0xc], ax */
            ii(0x17_b1b4, 3); mov(memw[ss, bp - 0xa], dx);              /* mov [bp-0xa], dx */
            ii(0x17_b1b7, 4); test(memb[ss, bp - 0xc], 0x1);            /* test byte [bp-0xc], 0x1 */
            ii(0x17_b1bb, 2); if(jz(0x17_b1e2, 0x25)) goto l_0x17_b1e2; /* jz 0xb1e2 */
            ii(0x17_b1bd, 3); push(memw[ss, bp - 0xe]);                 /* push word [bp-0xe] */
            ii(0x17_b1c0, 3); push(memw[ss, bp - 0x10]);                /* push word [bp-0x10] */
            ...
            ii(0x17_b1cb, 3); mov(memw[ss, bp - 0x1a], ax);             /* mov [bp-0x1a], ax */
            ...
            ii(0x17_b1d9, 2); if(jnz(0x17_b1e2, 0x7)) goto l_0x17_b1e2; /* jnz 0xb1e2 */
            ii(0x17_b1db, 3); mov(memb[es, bx + si], al);               /* mov [es:bx+si], al */
            ii(0x17_b1de, 4); and(memb[ss, bp - 0xc], -0x21 /* 0xdf */); /* and byte [bp-0xc], 0xdf */
        l_0x17_b1e2:
            ii(0x17_b1e2, 2); jmp(0x17_b1fc, 0x18); goto l_0x17_b1fc;   /* jmp 0xb1fc */
        l_0x17_b1e4:
            ii(0x17_b1e4, 3); les(bx, memw[ss, bp + 0x6]);              /* les bx, [bp+0x6] */
            ii(0x17_b1e7, 5); or(memb[es, bx + 0x2c], 0x1);             /* or byte [es:bx+0x2c], 0x1 */
            ii(0x17_b1ec, 6); mov(memw[es, bx + 0x20], 0x8025);         /* mov word [es:bx+0x20], 0x8025 */
            ii(0x17_b1f2, 6); mov(memw[es, bx + 0x22], 0);              /* mov word [es:bx+0x22], 0x0 */
        ...
        l_0x17_b200:
            ii(0x17_b200, 3); les(bx, memw[ss, bp + 0x6]);              /* les bx, [bp+0x6] */
            ii(0x17_b203, 5); and(memb[es, bx + 0x2c], -0x2 /* 0xfe */); /* and byte [es:bx+0x2c], 0xfe */
