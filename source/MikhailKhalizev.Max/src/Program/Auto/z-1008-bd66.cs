...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_bd66()
        {
            ...
            ii(0x1008_bd7e, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_bd81, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1008_bd83, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_bd92, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_bda3, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x1008_bda6, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1008_bda9, 3); call_abs(memd[ds, edx + 0x14]);         /* call dword [edx+0x14] */
            ii(0x1008_bdac, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_bdaf, 2); jmp(0x1008_bdbb, 0xa); goto l_0x1008_bdbb; /* jmp 0x1008bdbb */
        l_0x1008_bdb1:
            ii(0x1008_bdb1, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_bdb4, 4); mov(ax, memw[ds, eax + 0xd]);           /* mov ax, [eax+0xd] */
            ii(0x1008_bdb8, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
        l_0x1008_bdbb:
            ii(0x1008_bdbb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
