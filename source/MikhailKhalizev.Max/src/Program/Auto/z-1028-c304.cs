...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1028_c304()
        {
            ...
            ii(0x1028_c312, 4);  movzx(eax, memw[ds, esi + 50]);       /* movzx eax, word [esi+0x32] */
            ...
            ii(0x1028_c32e, 3);  shr(ecx, 2);                          /* shr ecx, 0x2 */
            ii(0x1028_c331, 6);  mov(memd[ds, 0x1344], ecx);           /* mov [0x1344], ecx */
            ii(0x1028_c337, 3);  lds(esi, memd[ds, esi + 8]);          /* lds esi, [esi+0x8] */
        ...
        l_0x1028_c34b:
            ...
            ii(0x1028_c34e, 3);  add(esi, 2);                          /* add esi, 0x2 */
            ...
            ii(0x1028_c362, 2);  if(jl(0x1028_c36b, 7)) goto l_0x1028_c36b;/* jl 0x1028c36b */
            ii(0x1028_c364, 5);  mov(eax, 0x8000);                     /* mov eax, 0x8000 */
            ii(0x1028_c369, 2);  jmp(0x1028_c370, 5); goto l_0x1028_c370;/* jmp 0x1028c370 */
        l_0x1028_c36b:
            ii(0x1028_c36b, 5);  mov(eax, 0x7fff);                     /* mov eax, 0x7fff */
        l_0x1028_c370:
            ii(0x1028_c370, 4);  mov(memw[es, edi], ax);               /* mov [es:edi], ax */
            ii(0x1028_c374, 3);  add(edi, 2);                          /* add edi, 0x2 */
            ii(0x1028_c377, 3);  movzx(eax, memw[ds, esi]);            /* movzx eax, word [esi] */
            ii(0x1028_c37a, 3);  add(esi, 2);                          /* add esi, 0x2 */
            ...
            ii(0x1028_c38e, 2);  if(jl(0x1028_c397, 7)) goto l_0x1028_c397;/* jl 0x1028c397 */
            ii(0x1028_c390, 5);  mov(eax, 0x8000);                     /* mov eax, 0x8000 */
            ii(0x1028_c395, 2);  jmp(0x1028_c39c, 5); goto l_0x1028_c39c;/* jmp 0x1028c39c */
        l_0x1028_c397:
            ii(0x1028_c397, 5);  mov(eax, 0x7fff);                     /* mov eax, 0x7fff */
        l_0x1028_c39c:
            ii(0x1028_c39c, 4);  mov(memw[es, edi], ax);               /* mov [es:edi], ax */
            ii(0x1028_c3a0, 3);  add(edi, 2);                          /* add edi, 0x2 */
            ii(0x1028_c3a3, 8);  sub(memd[fs, 0x1344], 1);             /* sub dword [fs:0x1344], 0x1 */
        ...
        l_0x1028_c3b1:
            ...
            ii(0x1028_c3b7, 3);  shr(eax, 2);                          /* shr eax, 0x2 */
        ...
        l_0x1028_c3cd:
            ...
            ii(0x1028_c3d0, 3);  add(esi, 2);                          /* add esi, 0x2 */
            ...
            ii(0x1028_c3e4, 2);  if(jl(0x1028_c3ed, 7)) goto l_0x1028_c3ed;/* jl 0x1028c3ed */
            ii(0x1028_c3e6, 5);  mov(eax, 0x8000);                     /* mov eax, 0x8000 */
            ii(0x1028_c3eb, 2);  jmp(0x1028_c3f2, 5); goto l_0x1028_c3f2;/* jmp 0x1028c3f2 */
        l_0x1028_c3ed:
            ii(0x1028_c3ed, 5);  mov(eax, 0x7fff);                     /* mov eax, 0x7fff */
        l_0x1028_c3f2:
            ii(0x1028_c3f2, 4);  mov(memw[es, edi], ax);               /* mov [es:edi], ax */
            ii(0x1028_c3f6, 3);  add(edi, 2);                          /* add edi, 0x2 */
            ii(0x1028_c3f9, 3);  movzx(eax, memw[ds, esi]);            /* movzx eax, word [esi] */
            ii(0x1028_c3fc, 3);  add(esi, 2);                          /* add esi, 0x2 */
            ...
            ii(0x1028_c410, 2);  if(jl(0x1028_c419, 7)) goto l_0x1028_c419;/* jl 0x1028c419 */
            ii(0x1028_c412, 5);  mov(eax, 0x8000);                     /* mov eax, 0x8000 */
            ii(0x1028_c417, 2);  jmp(0x1028_c41e, 5); goto l_0x1028_c41e;/* jmp 0x1028c41e */
        l_0x1028_c419:
            ii(0x1028_c419, 5);  mov(eax, 0x7fff);                     /* mov eax, 0x7fff */
        l_0x1028_c41e:
            ii(0x1028_c41e, 4);  mov(memw[es, edi], ax);               /* mov [es:edi], ax */
            ii(0x1028_c422, 3);  add(edi, 2);                          /* add edi, 0x2 */
            ii(0x1028_c425, 8);  sub(memd[fs, 0x134c], 1);             /* sub dword [fs:0x134c], 0x1 */
