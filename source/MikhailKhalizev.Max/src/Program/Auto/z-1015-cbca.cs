...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_cbca()
        {
            ...
            ii(0x1015_cbe1, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_cbe4, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1015_cbe7, 4); movsx(edx, memw[ss, ebp - 0x4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x1015_cbeb, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_cbee, 5); call(0x1007_2600, -0xe_a5f3);           /* call 0x10072600 */
            ii(0x1015_cbf3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_cbf6, 4); mov(memb[ds, eax + 0x3e], 0x1);         /* mov byte [eax+0x3e], 0x1 */
            ii(0x1015_cbfa, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1015_cc22, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_cc25, 5); call(0x1007_6204, -0xe_6a26);           /* call 0x10076204 */
            ii(0x1015_cc2a, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1015_cc2c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1015_cc44, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_cc47, 5); call(0x1007_6074, -0xe_6bd8);           /* call 0x10076074 */
            ii(0x1015_cc4c, 2); test(al, al);                           /* test al, al */
            ii(0x1015_cc4e, 2); if(jz(0x1015_cc58, 0x8)) goto l_0x1015_cc58; /* jz 0x1015cc58 */
            ii(0x1015_cc50, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_cc53, 5); call(0x1014_9fa8, -0x1_2cb0);           /* call 0x10149fa8 */
        l_0x1015_cc58:
            ii(0x1015_cc58, 5); mov(edx, 0x101c_37bc);                  /* mov edx, 0x101c37bc */
            ii(0x1015_cc5d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_cc60, 5); call(0x1007_6d98, -0xe_5ecd);           /* call 0x10076d98 */
            ii(0x1015_cc65, 2); test(al, al);                           /* test al, al */
            ii(0x1015_cc67, 2); if(jz(0x1015_cc71, 0x8)) goto l_0x1015_cc71; /* jz 0x1015cc71 */
            ii(0x1015_cc69, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1015_cc73:
            ...
            ii(0x1015_cc78, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1015_cc84, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_cc87, 5); call(0x1010_094d, -0x5_c33f);           /* call 0x1010094d */
            ii(0x1015_cc8c, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1015_cca9, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_ccac, 5); call(0x1007_6204, -0xe_6aad);           /* call 0x10076204 */
            ii(0x1015_ccb1, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1015_ccb3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1015_ccc1:
            ii(0x1015_ccc1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
