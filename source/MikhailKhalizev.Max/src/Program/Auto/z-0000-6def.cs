...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x6def, 4);    enter(0x2, 0);                            /* enter 0x2, 0x0 */
            ii(0x6df3, 5);    mov(memw[ss, bp - 0x2], 0x2);             /* mov word [bp-0x2], 0x2 */
        l_0x6df8:
            ...
            ii(0x6e05, 3);    push(memw[ss, bp + 0x8]);                 /* push word [bp+0x8] */
            ii(0x6e08, 3);    push(memw[ss, bp + 0x4]);                 /* push word [bp+0x4] */
            ii(0x6e0b, 3);    call(0x9d82, 0x2f74);                     /* call 0x9d82 */
            ii(0x6e0e, 1);    pop(bx);                                  /* pop bx */
            ii(0x6e0f, 1);    pop(bx);                                  /* pop bx */
            ii(0x6e10, 3);    cmp(ax, memw[ss, bp + 0x8]);              /* cmp ax, [bp+0x8] */
            ii(0x6e13, 2);    if(jnz(0x6e62, 0x4d)) goto l_0x6e62;      /* jnz 0x6e62 */
            ii(0x6e15, 3);    mov(bx, memw[ss, bp + 0x4]);              /* mov bx, [bp+0x4] */
            ii(0x6e18, 3);    cmp(memb[ds, bx], 0x4d);                  /* cmp byte [bx], 0x4d */
            ii(0x6e1b, 2);    if(jnz(0x6e33, 0x16)) goto l_0x6e33;      /* jnz 0x6e33 */
            ii(0x6e1d, 4);    cmp(memb[ds, bx + 0x1], 0x46);            /* cmp byte [bx+0x1], 0x46 */
            ii(0x6e21, 2);    if(jnz(0x6e33, 0x10)) goto l_0x6e33;      /* jnz 0x6e33 */
            ii(0x6e23, 3);    mov(ax, memw[ds, bx + 0x2]);              /* mov ax, [bx+0x2] */
            ii(0x6e26, 3);    mov(dx, memw[ds, bx + 0x4]);              /* mov dx, [bx+0x4] */
        l_0x6e29:
        ...
        l_0x6e33:
            ...
            ii(0x6e38, 4);    cmp(memb[ds, bx + 0x1], 0x5a);            /* cmp byte [bx+0x1], 0x5a */
            ii(0x6e3c, 2);    if(jnz(0x6e45, 0x7)) goto l_0x6e45;       /* jnz 0x6e45 */
        ...
        l_0x6e45:
            ...
            ii(0x6e4a, 4);    cmp(memb[ds, bx + 0x1], 0x57);            /* cmp byte [bx+0x1], 0x57 */
            ii(0x6e4e, 2);    if(jnz(0x6e55, 0x5)) goto l_0x6e55;       /* jnz 0x6e55 */
        ...
        l_0x6e55:
            ...
            ii(0x6e59, 3);    dec(memw[ss, bp - 0x2]);                  /* dec word [bp-0x2] */
        l_0x6e5c:
            ii(0x6e5c, 4);    cmp(memw[ss, bp - 0x2], 0);               /* cmp word [bp-0x2], 0x0 */
            ii(0x6e60, 2);    if(jge(0x6df8, -0x6a)) goto l_0x6df8;     /* jge 0x6df8 */
        l_0x6e62:
            ii(0x6e62, 4);    cmp(memw[ss, bp + 0x6], 0);               /* cmp word [bp+0x6], 0x0 */
            ii(0x6e66, 2);    if(jz(0x6e6e, 0x6)) goto l_0x6e6e;        /* jz 0x6e6e */
            ii(0x6e68, 2);    push(-0x2 /* 0xfe */);                    /* push 0xfffe */
