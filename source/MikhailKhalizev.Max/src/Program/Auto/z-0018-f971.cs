...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("3248effb-e8b9-47b0-bddc-84185f8bd570")]
        public void Method_0018_f971()
        {
            ii(0x18_f971, 4); mov(memw_a16[ds, 0xa4e], ss);             /* mov [0xa4e], ss */
            ii(0x18_f975, 5); mov(memd_a16[ds, 0xa4a], esp);            /* mov [0xa4a], esp */
            ii(0x18_f97a, 2); mov(si, ds);                              /* mov si, ds */
            ii(0x18_f97c, 2); mov(ss, si);                              /* mov ss, si */
            ii(0x18_f97e, 5); mov(esp, memd_a16[ds, 0xa46]);            /* mov esp, [0xa46] */
            ...
            ii(0x18_f99c, 1); pushw(ax);                                /* push ax */
            ...
            ii(0x18_f9a7, 2); pushw(gs);                                /* push gs */
            ii(0x18_f9a9, 2); pushw(fs);                                /* push fs */
            ii(0x18_f9ab, 1); pushw(es);                                /* push es */
            ii(0x18_f9ac, 4); pushw(memw_a32[ds, esi + 0x4]);           /* push word [esi+0x4] */
            ii(0x18_f9b0, 1); pushw(ds);                                /* push ds */
            ii(0x18_f9b1, 2); mov(ax, ss);                              /* mov ax, ss */
            ii(0x18_f9b3, 2); mov(ds, ax);                              /* mov ds, ax */
            ii(0x18_f9b5, 4); pushw(memw_a16[ds, 0xa42]);               /* push word [0xa42] */
            ii(0x18_f9b9, 4); movzx(ebp, sp);                           /* movzx ebp, sp */
            ii(0x18_f9bd, 3); mov(al, memb_a16[cs, bx]);                /* mov al, [cs:bx] */
            ...
            ii(0x18_f9d0, 5); mov(memd_a16[ds, 0xa42], ebp);            /* mov [0xa42], ebp */
            ii(0x18_f9d5, 1); pushw(ss);                                /* push ss */
            ii(0x18_f9d6, 1); pushw(bp);                                /* push bp */
            ii(0x18_f9d7, 5); callw_far_abs(0x88, 0x34ac);              /* call word 0x88:0x34ac */
        }
    }
}
