...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_f971()
        {
            ...
            ii(0x18_f983, 5);  lds(esi, memd[ds, 0xa4a]);              /* lds esi, [0xa4a] */
            ii(0x18_f988, 5);  push(memd_a32[ds, esi + 20]);           /* push dword [esi+0x14] */
            ii(0x18_f98d, 5);  push(memd_a32[ds, esi + 16]);           /* push dword [esi+0x10] */
            ii(0x18_f992, 5);  push(memd_a32[ds, esi + 12]);           /* push dword [esi+0xc] */
            ii(0x18_f997, 5);  push(memd_a32[ds, esi + 8]);            /* push dword [esi+0x8] */
            ii(0x18_f99c, 1);  push(ax);                               /* push ax */
            ii(0x18_f99d, 2);  pushad();                               /* pushad */
            ii(0x18_f99f, 4);  mov(edx, memd_a32[ds, esi]);            /* mov edx, [esi] */
            ii(0x18_f9a3, 4);  mov(bx, memw_a32[ds, esi + 6]);         /* mov bx, [esi+0x6] */
            ii(0x18_f9a7, 2);  push(gs);                               /* push gs */
            ii(0x18_f9a9, 2);  push(fs);                               /* push fs */
            ii(0x18_f9ab, 1);  push(es);                               /* push es */
            ii(0x18_f9ac, 4);  push(memw_a32[ds, esi + 4]);            /* push word [esi+0x4] */
            ...
            ii(0x18_f9c2, 4);  mov(memw_a32[ss, ebp + 44], ax);        /* mov [ebp+0x2c], ax */
            ii(0x18_f9c6, 5);  mov(memd_a32[ss, ebp + 24], esi);       /* mov [ebp+0x18], esi */
            ii(0x18_f9cb, 5);  mov(memd_a32[ss, ebp + 16], edx);       /* mov [ebp+0x10], edx */
