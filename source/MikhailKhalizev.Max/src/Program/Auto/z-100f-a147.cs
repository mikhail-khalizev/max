...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_a147()
        {
            ...
            ii(0x100f_a166, 4); mov(memb[ds, eax + 0x56], 0);           /* mov byte [eax+0x56], 0x0 */
            ii(0x100f_a16a, 5); mov(eax, 0x101c_37bc);                  /* mov eax, 0x101c37bc */
            ii(0x100f_a16f, 5); call(0x1007_6574, -0x8_3c00);           /* call 0x10076574 */
            ii(0x100f_a174, 4); mov(memb[ds, eax + 0x55], 0);           /* mov byte [eax+0x55], 0x0 */
        l_0x100f_a178:
            ii(0x100f_a178, 4); cmp(memd[ss, ebp - 0x10], 0);           /* cmp dword [ebp-0x10], 0x0 */
            ii(0x100f_a17c, 2); if(jz(0x100f_a18b, 0xd)) goto l_0x100f_a18b; /* jz 0x100fa18b */
            ii(0x100f_a17e, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
        ...
        l_0x100f_a18b:
            ...
            ii(0x100f_a19b, 3); mov(edx, memd[ss, ebp - 0x18]);         /* mov edx, [ebp-0x18] */
            ...
            ii(0x100f_a1aa, 2); if(jnz(0x100f_a1b2, 0x6)) goto l_0x100f_a1b2; /* jnz 0x100fa1b2 */
        l_0x100f_a1ac:
            ii(0x100f_a1ac, 4); cmp(memd[ss, ebp - 0x18], 0);           /* cmp dword [ebp-0x18], 0x0 */
        ...
        l_0x100f_a1b2:
            ...
            ii(0x100f_a1bb, 3); mov(edx, memd[ss, ebp - 0x18]);         /* mov edx, [ebp-0x18] */
            ...
            ii(0x100f_a1ca, 2); if(jz(0x100f_a1d3, 0x7)) goto l_0x100f_a1d3; /* jz 0x100fa1d3 */
        ...
        l_0x100f_a1d3:
            ii(0x100f_a1d3, 3); mov(edx, memd[ss, ebp - 0x18]);         /* mov edx, [ebp-0x18] */
        ...
        l_0x100f_a1e2:
            ii(0x100f_a1e2, 3); mov(edx, memd[ss, ebp - 0x18]);         /* mov edx, [ebp-0x18] */
            ...
            ii(0x100f_a205, 3); mov(edx, memd[ss, ebp - 0x18]);         /* mov edx, [ebp-0x18] */
