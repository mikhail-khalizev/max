...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_cbc4()
        {
            ...
            ii(0x1009_cbdb, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_cbde, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1009_cbe1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_cbe4, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x1009_cbe6, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_cbe9, 2); cmp(edx, memd[ds, eax]);                /* cmp edx, [eax] */
            ii(0x1009_cbeb, 2); if(jz(0x1009_cbf3, 0x6)) goto l_0x1009_cbf3; /* jz 0x1009cbf3 */
            ii(0x1009_cbed, 4); mov(memb[ss, ebp - 0xc], 0x1);          /* mov byte [ebp-0xc], 0x1 */
            ii(0x1009_cbf1, 2); jmp(0x1009_cbf7, 0x4); goto l_0x1009_cbf7; /* jmp 0x1009cbf7 */
        l_0x1009_cbf3:
            ii(0x1009_cbf3, 4); mov(memb[ss, ebp - 0xc], 0);            /* mov byte [ebp-0xc], 0x0 */
        l_0x1009_cbf7:
            ii(0x1009_cbf7, 3); mov(al, memb[ss, ebp - 0xc]);           /* mov al, [ebp-0xc] */
            ii(0x1009_cbfa, 3); mov(memb[ss, ebp - 0x10], al);          /* mov [ebp-0x10], al */
            ii(0x1009_cbfd, 3); mov(al, memb[ss, ebp - 0x10]);          /* mov al, [ebp-0x10] */
