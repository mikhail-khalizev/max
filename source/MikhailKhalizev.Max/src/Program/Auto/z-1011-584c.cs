...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("24df1f0b-3877-49fb-a868-b6b631c2c662")]
        public void Method_1011_584c()
        {
            ii(0x1011_584c, 5); pushd(0x20);                            /* push 0x20 */
            ii(0x1011_5851, 5); calld(Definitions.sys_check_available_stack_size, 0x5_04fc); /* call 0x10165d52 */
            ...
            ii(0x1011_5867, 5); calld(0x100e_88bd, -0x2_cfaf);          /* call 0x100e88bd */
