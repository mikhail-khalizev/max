...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_3761()
        {
            ...
            ii(0x1011_3779, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_377c, 5); mov(ebx, 0x1);                          /* mov ebx, 0x1 */
            ii(0x1011_3781, 5); mov(edx, 0x14);                         /* mov edx, 0x14 */
            ii(0x1011_3786, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_3798, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_379b, 5); call(0x1011_285d, -0xf43);              /* call 0x1011285d */
            ii(0x1011_37a0, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_37a3, 4); cmp(memb[ds, eax + 0x8], 0);            /* cmp byte [eax+0x8], 0x0 */
            ii(0x1011_37a7, 2); if(jz(0x1011_37c4, 0x1b)) goto l_0x1011_37c4; /* jz 0x101137c4 */
            ii(0x1011_37a9, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1011_37ba, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1011_37c4:
            ii(0x1011_37c4, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_37c7, 3); mov(al, memb[ds, eax + 0xb]);           /* mov al, [eax+0xb] */
            ii(0x1011_37ca, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x1011_37cf, 3); cmp(eax, 0x1);                          /* cmp eax, 0x1 */
            ii(0x1011_37d2, 2); if(jnz(0x1011_37da, 0x6)) goto l_0x1011_37da; /* jnz 0x101137da */
            ii(0x1011_37d4, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x1011_37d8, 2); jmp(0x1011_37de, 0x4); goto l_0x1011_37de; /* jmp 0x101137de */
        l_0x1011_37da:
            ii(0x1011_37da, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x1011_37de:
            ii(0x1011_37de, 2); xor(ebx, ebx);                          /* xor ebx, ebx */
            ii(0x1011_37e0, 3); mov(bl, memb[ss, ebp - 0x8]);           /* mov bl, [ebp-0x8] */
            ii(0x1011_37e3, 5); mov(edx, 0x16);                         /* mov edx, 0x16 */
            ii(0x1011_37e8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
