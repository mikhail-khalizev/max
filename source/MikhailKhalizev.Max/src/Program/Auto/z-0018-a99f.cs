...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_a99f()
        {
            ...
            ii(0x18_a9a2, 2); if(jae(0x18_a9ac, 8)) goto l_0x18_a9ac;   /* jae 0xa9ac */
            ii(0x18_a9a4, 3); call(0x18_a893, -0x114);                  /* call 0xa893 */
            ii(0x18_a9a7, 3); mov(ax, memw[ds, bx + 22]);               /* mov ax, [bx+0x16] */
            ii(0x18_a9aa, 2); jmp(0x18_aa14, 0x68); goto l_0x18_aa14;   /* jmp 0xaa14 */
        l_0x18_a9ac:
            ii(0x18_a9ac, 3); mov(dx, memw[ss, bp + 20]);               /* mov dx, [bp+0x14] */
            ii(0x18_a9af, 3); mov(si, memw[ss, bp + 18]);               /* mov si, [bp+0x12] */
        l_0x18_a9b2:
            ii(0x18_a9b2, 1); sti();                                    /* sti */
            ii(0x18_a9b3, 4); mov(di, memw[ds, 0xa]);                   /* mov di, [0xa] */
            ii(0x18_a9b7, 3); mov(memw[ds, bx + 18], di);               /* mov [bx+0x12], di */
            ii(0x18_a9ba, 2); mov(cx, dx);                              /* mov cx, dx */
            ii(0x18_a9bc, 4); cmp(cx, memw[ds, 0xe]);                   /* cmp cx, [0xe] */
            ii(0x18_a9c0, 2); if(jbe(0x18_a9c6, 4)) goto l_0x18_a9c6;   /* jbe 0xa9c6 */
            ii(0x18_a9c2, 4); mov(cx, memw[ds, 0xe]);                   /* mov cx, [0xe] */
        l_0x18_a9c6:
            ii(0x18_a9c6, 3); mov(memw[ds, bx + 20], cx);               /* mov [bx+0x14], cx */
            ii(0x18_a9c9, 3); mov(ax, memw[ss, bp + 22]);               /* mov ax, [bp+0x16] */
            ii(0x18_a9cc, 3); mov(memw[ds, bx + 22], ax);               /* mov [bx+0x16], ax */
            ii(0x18_a9cf, 1); push(cx);                                 /* push cx */
            ii(0x18_a9d0, 1); push(ds);                                 /* push ds */
            ii(0x18_a9d1, 3); mov(ds, memw[ss, bp + 4]);                /* mov ds, [bp+0x4] */
