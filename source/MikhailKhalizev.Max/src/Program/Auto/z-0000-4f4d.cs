...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x4f55:
            ii(0x4f55, 3);    mov(memw[ss, bp - 0x4], bx);              /* mov [bp-0x4], bx */
            ii(0x4f58, 3);    inc(memw[ss, bp + 0x6]);                  /* inc word [bp+0x6] */
            ii(0x4f5b, 2);    mov(al, memb[ds, bx]);                    /* mov al, [bx] */
            ii(0x4f5d, 3);    mov(bx, memw[ss, bp + 0x4]);              /* mov bx, [bp+0x4] */
            ii(0x4f60, 3);    inc(memw[ss, bp + 0x4]);                  /* inc word [bp+0x4] */
            ii(0x4f63, 2);    cmp(memb[ds, bx], al);                    /* cmp [bx], al */
            ii(0x4f65, 2);    if(jz(0x4f6b, 0x4)) goto l_0x4f6b;        /* jz 0x4f6b */
            ii(0x4f67, 2);    sub(ax, ax);                              /* sub ax, ax */
            ii(0x4f69, 2);    jmp(0x4f76, 0xb); goto l_0x4f76;          /* jmp 0x4f76 */
        l_0x4f6b:
            ii(0x4f6b, 3);    mov(bx, memw[ss, bp + 0x6]);              /* mov bx, [bp+0x6] */
