...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_124a()
        {
            ...
            ii(0x1012_1262, 7); mov(memd[ss, ebp - 0x8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1012_1269, 2); jmp(0x1012_1271, 0x6); goto l_0x1012_1271; /* jmp 0x10121271 */
        l_0x1012_126b:
            ii(0x1012_126b, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_126e, 3); inc(memd[ss, ebp - 0x8]);               /* inc dword [ebp-0x8] */
        l_0x1012_1271:
            ii(0x1012_1271, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1012_1275, 3); cmp(eax, 0x1e);                         /* cmp eax, 0x1e */
            ii(0x1012_1278, 6); if(jge(0x1012_139d, 0x11f)) goto l_0x1012_139d; /* jge 0x1012139d */
            ii(0x1012_127e, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1012_1282, 2); add(eax, eax);                          /* add eax, eax */
            ii(0x1012_1284, 7); mov(ax, memw[ds, eax + 0x101b_afe4]);   /* mov ax, [eax+0x101bafe4] */
            ii(0x1012_128b, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1012_128e, 4); movsx(eax, memw[ss, ebp - 0x4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1012_129a, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x1012_12bd, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1012_12d2, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1012_12e2, 3); mov(edx, memd[ds, eax + 0x2]);          /* mov edx, [eax+0x2] */
            ii(0x1012_12e5, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1012_12e8, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1012_12f8, 3); mov(edx, memd[ds, eax + 0x4]);          /* mov edx, [eax+0x4] */
            ii(0x1012_12fb, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1012_12fe, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1012_130b, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1012_130f, 3); imul(eax, eax, 0x16);                   /* imul eax, eax, 0x16 */
            ii(0x1012_1312, 9); mov(memw[ds, eax + 0x101c_539c], 0x1);  /* mov word [eax+0x101c539c], 0x1 */
            ii(0x1012_131b, 4); movsx(eax, memw[ss, ebp - 0x8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1012_131f, 3); imul(eax, eax, 0x16);                   /* imul eax, eax, 0x16 */
            ii(0x1012_1322, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x1012_1339, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1012_133d, 3); imul(edx, edx, 0x16);                   /* imul edx, edx, 0x16 */
            ii(0x1012_1340, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
            ...
            ii(0x1012_135c, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x1012_136a, 4); movsx(ebx, memw[ss, ebp - 0x8]);        /* movsx ebx, word [ebp-0x8] */
            ii(0x1012_136e, 3); imul(ebx, ebx, 0x16);                   /* imul ebx, ebx, 0x16 */
            ii(0x1012_1371, 4); movsx(edx, memw[ss, ebp - 0x8]);        /* movsx edx, word [ebp-0x8] */
