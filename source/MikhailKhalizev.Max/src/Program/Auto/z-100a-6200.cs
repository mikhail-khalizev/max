...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_6200()
        {
            ...
            ii(0x100a_6217, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_621a, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_621d, 5); mov(edx, StringDefinitions.ObtainUnits); /* mov edx, 0x101a0c3a */
            ii(0x100a_6222, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_6225, 5); call(Definitions.sys_strcpy, 0xb_fca5); /* call 0x10165ecf */
            ii(0x100a_622a, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_623f, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_6242, 5); call(Definitions.sys_strcat, 0xb_fcea); /* call 0x10165f31 */
        l_0x100a_6247:
            ii(0x100a_6247, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
            ii(0x100a_624e, 2); jmp(0x100a_6256, 0x6); goto l_0x100a_6256; /* jmp 0x100a6256 */
        l_0x100a_6250:
            ii(0x100a_6250, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100a_6253, 3); inc(memd[ss, ebp - 0xc]);               /* inc dword [ebp-0xc] */
        l_0x100a_6256:
            ii(0x100a_6256, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_6259, 3); add(eax, 0x13);                         /* add eax, 0x13 */
            ii(0x100a_625c, 5); call(Definitions.my_2_get_count, -0x1_aef9); /* call 0x1008b368 */
            ii(0x100a_6261, 4); cmp(ax, memw[ss, ebp - 0xc]);           /* cmp ax, [ebp-0xc] */
            ii(0x100a_6265, 2); if(jle(0x100a_6270, 0x9)) goto l_0x100a_6270; /* jle 0x100a6270 */
            ii(0x100a_6267, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x100a_626b, 3); cmp(eax, 0x3);                          /* cmp eax, 0x3 */
            ii(0x100a_626e, 2); if(jl(0x100a_6272, 0x2)) goto l_0x100a_6272; /* jl 0x100a6272 */
        l_0x100a_6270:
            ii(0x100a_6270, 2); jmp(0x100a_62c4, 0x52); goto l_0x100a_62c4; /* jmp 0x100a62c4 */
        l_0x100a_6272:
            ii(0x100a_6272, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100a_6276, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_628d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_6290, 5); call(Definitions.sys_strcat, 0xb_fc9c); /* call 0x10165f31 */
            ii(0x100a_6295, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_62a1, 4); movsx(edx, memw[ss, ebp - 0xc]);        /* movsx edx, word [ebp-0xc] */
            ii(0x100a_62a5, 1); dec(eax);                               /* dec eax */
            ii(0x100a_62a6, 2); cmp(edx, eax);                          /* cmp edx, eax */
            ii(0x100a_62a8, 2); if(jge(0x100a_62b3, 0x9)) goto l_0x100a_62b3; /* jge 0x100a62b3 */
            ii(0x100a_62aa, 4); movsx(eax, memw[ss, ebp - 0xc]);        /* movsx eax, word [ebp-0xc] */
            ii(0x100a_62ae, 3); cmp(eax, 0x2);                          /* cmp eax, 0x2 */
            ii(0x100a_62b1, 2); if(jl(0x100a_62b5, 0x2)) goto l_0x100a_62b5; /* jl 0x100a62b5 */
        l_0x100a_62b3:
        ...
        l_0x100a_62b5:
            ...
            ii(0x100a_62ba, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100a_62c4:
            ii(0x100a_62c4, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100a_62da, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_62dd, 5); call(Definitions.sys_strcat, 0xb_fc4f); /* call 0x10165f31 */
        l_0x100a_62e2:
            ii(0x100a_62e2, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_62e5, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100a_62e8, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
