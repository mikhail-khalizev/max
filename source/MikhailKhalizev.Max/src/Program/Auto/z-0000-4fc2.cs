...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_4fc2()
        {
            ...
            ii(0x4fcc, 3);    mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
            ii(0x4fcf, 2);    push(0x8);                                /* push 0x8 */
            ii(0x4fd1, 1);    pop(es);                                  /* pop es */
            ii(0x4fd2, 4);    mov(memw[es, 0x62], ax);                  /* mov [es:0x62], ax */
            ii(0x4fd6, 3);    mov(ax, memw[ss, bp + 0x6]);              /* mov ax, [bp+0x6] */
            ...
            ii(0x4fe5, 3);    mov(si, memw[ss, bp + 0x8]);              /* mov si, [bp+0x8] */
            ii(0x4fe8, 3);    mov(cx, memw[ss, bp + 0xa]);              /* mov cx, [bp+0xa] */
            ii(0x4feb, 1);    cld();                                    /* cld */
