...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("17d94513-5745-4198-ae3b-893fdf63e046")]
        public void Method_0000_4fc2()
        {
            ii(0x4fc2, 1);    pushw(bp);                                /* push bp */
            ii(0x4fc3, 2);    mov(bp, sp);                              /* mov bp, sp */
            ii(0x4fc5, 1);    pushw(si);                                /* push si */
            ii(0x4fc6, 1);    pushw(di);                                /* push di */
            ii(0x4fc7, 3);    callw(0x4030, -0xf9a);                    /* call 0x4030 */
