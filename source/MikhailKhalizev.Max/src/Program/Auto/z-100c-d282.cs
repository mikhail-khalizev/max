...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_d282()
        {
            ...
            ii(0x100c_d2aa, 3);  mov(dl, memb[ds, eax + 84]);          /* mov dl, [eax+0x54] */
            ...
            ii(0x100c_d2bd, 3);  mov(eax, memd[ds, eax + 25]);         /* mov eax, [eax+0x19] */
        ...
        l_0x100c_d2d1:
            ...
            ii(0x100c_d2d4, 3);  mov(memb[ss, ebp - 12], al);          /* mov [ebp-0xc], al */
            ii(0x100c_d2d7, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
