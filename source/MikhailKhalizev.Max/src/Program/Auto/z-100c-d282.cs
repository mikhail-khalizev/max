...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_d282()
        {
            ...
            ii(0x100c_d29a, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_d29d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_d2ad, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100c_d2c5, 2); if(jnz(0x100c_d2cd, 0x6)) goto l_0x100c_d2cd; /* jnz 0x100cd2cd */
            ii(0x100c_d2c7, 4); mov(memb[ss, ebp - 0x8], 0x1);          /* mov byte [ebp-0x8], 0x1 */
            ii(0x100c_d2cb, 2); jmp(0x100c_d2d1, 0x4); goto l_0x100c_d2d1; /* jmp 0x100cd2d1 */
        l_0x100c_d2cd:
            ii(0x100c_d2cd, 4); mov(memb[ss, ebp - 0x8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x100c_d2d1:
            ii(0x100c_d2d1, 3); mov(al, memb[ss, ebp - 0x8]);           /* mov al, [ebp-0x8] */
