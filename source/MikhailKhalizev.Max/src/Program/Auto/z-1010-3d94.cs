...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_3d94()
        {
            ...
            ii(0x1010_3dab, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1010_3dae, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1010_3db1, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_3db4, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ii(0x1010_3db7, 3); mov(memw[ds, edx], ax);                 /* mov [edx], ax */
            ii(0x1010_3dba, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
            ii(0x1010_3dbd, 4); mov(memw[ss, ebp - 12], ax);            /* mov [ebp-0xc], ax */
            ii(0x1010_3dc1, 5); mov(ebx, 0x101b_56fc);                  /* mov ebx, 0x101b56fc */
            ii(0x1010_3dc6, 3); mov(edx, memd[ss, ebp - 14]);           /* mov edx, [ebp-0xe] */
            ii(0x1010_3dc9, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x1010_3dcc, 3); mov(eax, memd[ss, ebp - 14]);           /* mov eax, [ebp-0xe] */
            ii(0x1010_3dcf, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1010_3dd2, 3); imul(eax, eax, 0xa);                    /* imul eax, eax, 0xa */
            ii(0x1010_3dd5, 3); add(eax, 4);                            /* add eax, 0x4 */
            ...
            ii(0x1010_3de4, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1010_3de7, 3); mov(memd[ds, eax + 2], edx);            /* mov [eax+0x2], edx */
            ii(0x1010_3dea, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1010_3ded, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1010_3df0, 3); mov(eax, memd[ss, ebp - 16]);           /* mov eax, [ebp-0x10] */
