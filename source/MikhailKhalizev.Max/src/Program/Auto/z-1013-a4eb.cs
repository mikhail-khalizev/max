...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_a4eb()
        {
            ...
            ii(0x1013_a501, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1013_a504, 3); mov(memd[ss, ebp - 8], edx);            /* mov [ebp-0x8], edx */
            ii(0x1013_a507, 3); mov(memd[ss, ebp - 4], ebx);            /* mov [ebp-0x4], ebx */
            ii(0x1013_a50a, 4); cmp(memd[ss, ebp - 8], 0);              /* cmp dword [ebp-0x8], 0x0 */
            ii(0x1013_a50e, 2); if(jnz(0x1013_a520, 0x10)) goto l_0x1013_a520; /* jnz 0x1013a520 */
            ii(0x1013_a510, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1013_a513, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
        ...
        l_0x1013_a520:
            ...
            ii(0x1013_a52a, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1013_a52d, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x1013_a530, 3); mov(memd[ss, ebp - 24], eax);           /* mov [ebp-0x18], eax */
            ii(0x1013_a533, 4); cmp(memd[ss, ebp - 24], 0);             /* cmp dword [ebp-0x18], 0x0 */
            ii(0x1013_a537, 2); if(jz(0x1013_a54f, 0x16)) goto l_0x1013_a54f; /* jz 0x1013a54f */
            ii(0x1013_a539, 3); mov(edx, memd[ss, ebp - 4]);            /* mov edx, [ebp-0x4] */
            ii(0x1013_a53c, 3); mov(eax, memd[ss, ebp - 20]);           /* mov eax, [ebp-0x14] */
            ii(0x1013_a53f, 5); call(0x1013_9eb4, -0x690);              /* call 0x10139eb4 */
            ii(0x1013_a544, 3); mov(memd[ss, ebp - 28], eax);           /* mov [ebp-0x1c], eax */
            ii(0x1013_a547, 3); mov(eax, memd[ss, ebp - 28]);           /* mov eax, [ebp-0x1c] */
            ii(0x1013_a54a, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1013_a54d, 2); jmp(0x1013_a555, 6); goto l_0x1013_a555; /* jmp 0x1013a555 */
        l_0x1013_a54f:
            ii(0x1013_a54f, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x1013_a552, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
        l_0x1013_a555:
            ii(0x1013_a555, 3); mov(edx, memd[ss, ebp - 16]);           /* mov edx, [ebp-0x10] */
            ii(0x1013_a558, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
            ii(0x1013_a55b, 5); call(0x1007_6d14, -0xc_384c);           /* call 0x10076d14 */
            ii(0x1013_a560, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_a563, 3); inc(memw[ds, eax]);                     /* inc word [eax] */
            ii(0x1013_a566, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
            ii(0x1013_a569, 5); call(0x1007_6c68, -0xc_3906);           /* call 0x10076c68 */
            ii(0x1013_a56e, 3); mov(ebx, memd[ss, ebp - 8]);            /* mov ebx, [ebp-0x8] */
            ...
            ii(0x1013_a57c, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
            ...
            ii(0x1013_a590, 3); lea(edx, memd[ss, ebp - 32]);           /* lea edx, [ebp-0x20] */
            ii(0x1013_a593, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1013_a596, 3); add(eax, 6);                            /* add eax, 0x6 */
            ii(0x1013_a599, 5); call(0x1013_aa70, 0x4d2);               /* call 0x1013aa70 */
        l_0x1013_a59e:
            ii(0x1013_a59e, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1013_a5a0, 3); lea(eax, memd[ss, ebp - 32]);           /* lea eax, [ebp-0x20] */
