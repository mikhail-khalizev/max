...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1016_b3e8:
            ii(0x1016_b3e8, 3); cmp(edx, memd[ds, eax + 0x4]);          /* cmp edx, [eax+0x4] */
        ...
        l_0x1016_b3fd:
            ii(0x1016_b3fd, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
        ...
        l_0x1016_b404:
            ...
            ii(0x1016_b418, 3); mov(memd[ds, eax + 0x4], edx);          /* mov [eax+0x4], edx */
            ...
            ii(0x1016_b426, 3); mov(memd[ds, eax + 0x8], edx);          /* mov [eax+0x8], edx */
        l_0x1016_b429:
