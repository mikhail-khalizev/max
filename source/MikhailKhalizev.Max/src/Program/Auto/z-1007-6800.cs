...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("fb0a8238-e8ce-4828-97c0-4e9e883e3bc7")]
        public void Method_1007_6800()
        {
            ii(0x1007_6800, 5); pushd(0x28);                            /* push 0x28 */
            ii(0x1007_6805, 5); calld(Definitions.sys_check_available_stack_size, 0xef548); /* call 0x10165d52 */
            ...
            ii(0x1007_6823, 5); calld(0x1013_abc3, 0xc439b);            /* call 0x1013abc3 */
            ...
            ii(0x1007_6841, 1); retd(); return;                         /* ret */
        }
    }
}
