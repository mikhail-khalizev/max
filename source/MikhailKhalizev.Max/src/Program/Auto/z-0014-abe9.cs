...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0014_abe9()
        {
            ...
            ii(0x14_abf8, 2); jzw_func(0x14_abe4, -0x16);               /* jz 0xabe4 */
            ii(0x14_abfa, 2); mov(di, bx);                              /* mov di, bx */
            ii(0x14_abfc, 5); cmp(memb_a16[ds, 0x2e], 0);               /* cmp byte [0x2e], 0x0 */
            ii(0x14_ac01, 2); jzw_func(0x14_abe7, -0x1c);               /* jz 0xabe7 */
            ...
            ii(0x14_ac16, 2); jbew_func(0x14_ac3c, 0x24);               /* jbe 0xac3c */
            ...
            ii(0x14_ac23, 2); jzw_func(0x14_ac3c, 0x17);                /* jz 0xac3c */
            ii(0x14_ac25, 3); cmp(cx, 0x70);                            /* cmp cx, 0x70 */
            ii(0x14_ac28, 2); jzw_func(0x14_ac3c, 0x12);                /* jz 0xac3c */
            ...
            ii(0x14_ac35, 2); jnzw_func(0x14_ac3c, 0x5);                /* jnz 0xac3c */
