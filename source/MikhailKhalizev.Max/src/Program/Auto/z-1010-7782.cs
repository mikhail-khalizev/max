...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_7782()
        {
            ...
            ii(0x1010_7794, 6);  sub(esp, 4);                          /* sub esp, 0x4 */
            ii(0x1010_779a, 7);  mov(memd[ss, ebp - 4], 0x101c_4da0);  /* mov dword [ebp-0x4], 0x101c4da0 */
            ii(0x1010_77a1, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
