...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_5ef0()
        {
            ...
            ii(0x100a_5f07, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_5f0a, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_5f0d, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_5f10, 5); call(0x1008_aef4, -0x1_b021);           /* call 0x1008aef4 */
            ii(0x100a_5f15, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x100a_5f17, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x100a_5f1a, 5); call(0x1008_ae70, -0x1_b0af);           /* call 0x1008ae70 */
            ii(0x100a_5f1f, 2); jmp(0x100a_5f29, 0x8); goto l_0x100a_5f29; /* jmp 0x100a5f29 */
        l_0x100a_5f21:
            ii(0x100a_5f21, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x100a_5f24, 5); call(0x1007_6bf8, -0x2_f331);           /* call 0x10076bf8 */
        l_0x100a_5f29:
            ii(0x100a_5f29, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_5f2b, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ...
            ii(0x100a_5f37, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
            ii(0x100a_5f3a, 5); call(0x1008_adc4, -0x1_b17b);           /* call 0x1008adc4 */
            ii(0x100a_5f3f, 3); mov(memd[ss, ebp - 0x10], eax);         /* mov [ebp-0x10], eax */
            ii(0x100a_5f42, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100a_5f45, 3); mov(ebx, memd[ds, eax + 0x2]);          /* mov ebx, [eax+0x2] */
            ii(0x100a_5f48, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100a_5f4b, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
            ii(0x100a_5f4e, 3); call_abs(memd[ds, ebx + 0x64]);         /* call dword [ebx+0x64] */
            ii(0x100a_5f51, 2); jmp(0x100a_5f21, -0x32); goto l_0x100a_5f21; /* jmp 0x100a5f21 */
        l_0x100a_5f53:
            ii(0x100a_5f53, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x100a_5f55, 3); lea(eax, memd[ss, ebp - 0xc]);          /* lea eax, [ebp-0xc] */
