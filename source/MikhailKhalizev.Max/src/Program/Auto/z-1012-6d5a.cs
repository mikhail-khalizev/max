...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_6d5a()
        {
            ...
            ii(0x1012_6d7c, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1012_6d7f, 5); mov(eax, 0x47);                         /* mov eax, 0x47 */
            ii(0x1012_6d84, 5); call(0x1007_5fdc, -0xb_0dad);           /* call 0x10075fdc */
            ii(0x1012_6d89, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_6d8c, 7); mov(memd[ss, ebp - 0xc], 0x101c_59f5);  /* mov dword [ebp-0xc], 0x101c59f5 */
            ii(0x1012_6d93, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_6d96, 3); mov(al, memb[ds, eax + 0x4]);           /* mov al, [eax+0x4] */
            ...
            ii(0x1012_6db0, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_6db3, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1012_6db5, 3); mov(dl, memb[ds, eax + 0x5]);           /* mov dl, [eax+0x5] */
            ii(0x1012_6db8, 5); mov(eax, 0x2);                          /* mov eax, 0x2 */
            ii(0x1012_6dbd, 5); call(0x100c_aafc, -0x5_c2c6);           /* call 0x100caafc */
            ii(0x1012_6dc2, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_6dc5, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1012_6dc7, 3); mov(dl, memb[ds, eax + 0x6]);           /* mov dl, [eax+0x6] */
            ii(0x1012_6dca, 5); mov(eax, 0x4);                          /* mov eax, 0x4 */
            ii(0x1012_6dcf, 5); call(0x100c_aafc, -0x5_c2d8);           /* call 0x100caafc */
            ii(0x1012_6dd4, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_6dd7, 3); mov(al, memb[ds, eax + 0x7]);           /* mov al, [eax+0x7] */
            ...
            ii(0x1012_6df1, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6df4, 3); mov(edx, memd[ds, edx + 0x9]);          /* mov edx, [edx+0x9] */
            ...
            ii(0x1012_6e04, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6e07, 3); mov(edx, memd[ds, edx + 0xb]);          /* mov edx, [edx+0xb] */
            ...
            ii(0x1012_6e17, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6e1a, 3); mov(edx, memd[ds, edx + 0xd]);          /* mov edx, [edx+0xd] */
            ...
            ii(0x1012_6e2a, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_6e2d, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1012_6e2f, 3); mov(dl, memb[ds, eax + 0x8]);           /* mov dl, [eax+0x8] */
            ii(0x1012_6e32, 5); mov(eax, 0x8);                          /* mov eax, 0x8 */
            ii(0x1012_6e37, 5); call(0x100c_aafc, -0x5_c340);           /* call 0x100caafc */
            ii(0x1012_6e3c, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6e3f, 3); mov(edx, memd[ds, edx + 0xf]);          /* mov edx, [edx+0xf] */
            ...
            ii(0x1012_6e4f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_6e52, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1012_6e54, 3); mov(dl, memb[ds, eax + 0x9]);           /* mov dl, [eax+0x9] */
            ii(0x1012_6e57, 5); mov(eax, 0x3);                          /* mov eax, 0x3 */
            ii(0x1012_6e5c, 5); call(0x100c_aafc, -0x5_c365);           /* call 0x100caafc */
            ii(0x1012_6e61, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_6e64, 3); mov(al, memb[ds, eax + 0xa]);           /* mov al, [eax+0xa] */
            ...
            ii(0x1012_6e7e, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6e81, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1012_6e83, 3); mov(al, memb[ds, edx + 0x13]);          /* mov al, [edx+0x13] */
            ii(0x1012_6e86, 6); mov(memw[ds, 0x101c_3966], ax);         /* mov [0x101c3966], ax */
            ii(0x1012_6e8c, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_6e8f, 4); mov(ax, memw[ds, eax + 0x14]);          /* mov ax, [eax+0x14] */
            ii(0x1012_6e93, 6); mov(memw[ds, 0x101c_3968], ax);         /* mov [0x101c3968], ax */
            ii(0x1012_6e99, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6e9c, 3); mov(edx, memd[ds, edx + 0x14]);         /* mov edx, [edx+0x14] */
            ...
            ii(0x1012_6eac, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6eaf, 3); mov(edx, memd[ds, edx + 0x16]);         /* mov edx, [edx+0x16] */
            ...
            ii(0x1012_6ebf, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6ec2, 3); mov(edx, memd[ds, edx + 0x18]);         /* mov edx, [edx+0x18] */
            ...
            ii(0x1012_6ed2, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6ed5, 3); mov(edx, memd[ds, edx + 0x1a]);         /* mov edx, [edx+0x1a] */
            ...
            ii(0x1012_6ee5, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6ee8, 3); mov(edx, memd[ds, edx + 0x1c]);         /* mov edx, [edx+0x1c] */
            ...
            ii(0x1012_6ef8, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6efb, 3); mov(edx, memd[ds, edx + 0x1e]);         /* mov edx, [edx+0x1e] */
            ...
            ii(0x1012_6f0b, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6f0e, 3); mov(edx, memd[ds, edx + 0x20]);         /* mov edx, [edx+0x20] */
            ...
            ii(0x1012_6f1e, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6f21, 3); mov(edx, memd[ds, edx + 0x22]);         /* mov edx, [edx+0x22] */
            ...
            ii(0x1012_6f31, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6f34, 3); mov(edx, memd[ds, edx + 0x24]);         /* mov edx, [edx+0x24] */
            ...
            ii(0x1012_6f44, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6f47, 3); mov(edx, memd[ds, edx + 0x26]);         /* mov edx, [edx+0x26] */
            ...
            ii(0x1012_6f57, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6f5a, 3); mov(edx, memd[ds, edx + 0x28]);         /* mov edx, [edx+0x28] */
            ...
            ii(0x1012_6f6a, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6f6d, 3); mov(edx, memd[ds, edx + 0x2a]);         /* mov edx, [edx+0x2a] */
            ...
            ii(0x1012_6f7d, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6f80, 3); mov(edx, memd[ds, edx + 0x2c]);         /* mov edx, [edx+0x2c] */
            ...
            ii(0x1012_6f90, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6f93, 3); mov(edx, memd[ds, edx + 0x2e]);         /* mov edx, [edx+0x2e] */
            ...
            ii(0x1012_6fa3, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6fa6, 3); mov(edx, memd[ds, edx + 0x30]);         /* mov edx, [edx+0x30] */
            ...
            ii(0x1012_6fb6, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6fb9, 3); mov(edx, memd[ds, edx + 0x32]);         /* mov edx, [edx+0x32] */
            ...
            ii(0x1012_6fc9, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_6fcc, 3); mov(edx, memd[ds, edx + 0x34]);         /* mov edx, [edx+0x34] */
            ...
            ii(0x1012_6fdc, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_6fdf, 3); mov(edx, memd[ds, eax + 0x36]);         /* mov edx, [eax+0x36] */
            ...
            ii(0x1012_6fef, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_6ff2, 3); mov(edx, memd[ds, eax + 0x38]);         /* mov edx, [eax+0x38] */
            ...
            ii(0x1012_7002, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_7005, 3); mov(edx, memd[ds, eax + 0x3a]);         /* mov edx, [eax+0x3a] */
            ...
            ii(0x1012_7015, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_7018, 3); mov(edx, memd[ds, eax + 0x3c]);         /* mov edx, [eax+0x3c] */
            ...
            ii(0x1012_7028, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_702b, 3); mov(edx, memd[ds, eax + 0x3e]);         /* mov edx, [eax+0x3e] */
            ...
            ii(0x1012_703b, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_703e, 3); mov(edx, memd[ds, eax + 0x40]);         /* mov edx, [eax+0x40] */
        ...
        l_0x1012_7099:
            ...
            ii(0x1012_709f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_70a2, 3); cmp(dl, memb[ds, eax + 0x5]);           /* cmp dl, [eax+0x5] */
            ii(0x1012_70a5, 2); if(jz(0x1012_70b7, 0x10)) goto l_0x1012_70b7; /* jz 0x101270b7 */
            ii(0x1012_70a7, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1012_70aa, 3); mov(al, memb[ds, eax + 0x5]);           /* mov al, [eax+0x5] */
            ii(0x1012_70ad, 5); and(eax, 0xff);                         /* and eax, 0xff */
            ii(0x1012_70b2, 5); call(0x1007_1cca, -0xb_53ed);           /* call 0x10071cca */
        l_0x1012_70b7:
            ii(0x1012_70b7, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1012_70ba, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_70bd, 4); cmp(ax, memw[ds, edx + 0xb]);           /* cmp ax, [edx+0xb] */
            ii(0x1012_70c1, 2); if(jnz(0x1012_70cf, 0xc)) goto l_0x1012_70cf; /* jnz 0x101270cf */
            ii(0x1012_70c3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_70c6, 3); mov(edx, memd[ss, ebp - 0xc]);          /* mov edx, [ebp-0xc] */
            ii(0x1012_70c9, 4); cmp(ax, memw[ds, edx + 0xd]);           /* cmp ax, [edx+0xd] */
