...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x100e_7dc4:
            ...
            ii(0x100e_7dc9, 5); mov(ebx, 0x101a_1e3a);                  /* mov ebx, 0x101a1e3a */ /* "drawmap.cpp" */
            ii(0x100e_7dce, 5); mov(edx, 0x101a_1e46);                  /* mov edx, 0x101a1e46 */ /* "rect.ulx >= 0 && rect.uly >= 0 && rect.lrx < 640 && rect.lry < 480" */
        ...
        l_0x100e_7df8:
            ...
            ii(0x100e_7dfd, 5); mov(ebx, 0x101a_1e89);                  /* mov ebx, 0x101a1e89 */ /* "drawmap.cpp" */
            ii(0x100e_7e02, 5); mov(edx, 0x101a_1e95);                  /* mov edx, 0x101a1e95 */ /* "rect.ulx <= rect.lrx && rect.uly <= rect.lry" */
