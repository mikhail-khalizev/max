...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_4fae()
        {
            ...
            ii(0x17_4fc0, 3); mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x17_4fc3, 3); mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x17_4fc6, 3); mov(memw[ss, bp - 0xc], ax);              /* mov [bp-0xc], ax */
            ii(0x17_4fc9, 3); mov(memw[ss, bp - 0xa], dx);              /* mov [bp-0xa], dx */
            ...
            ii(0x17_4ffc, 3); mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x17_4fff, 3); mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
            ii(0x17_5002, 2); mov(ax, dx);                              /* mov ax, dx */
            ii(0x17_5004, 3); or(ax, memw[ss, bp - 0x8]);               /* or ax, [bp-0x8] */
        ...
        l_0x17_501e:
            ...
            ii(0x17_5026, 3); push(memw[ss, bp - 0x8]);                 /* push word [bp-0x8] */
            ...
            ii(0x17_504d, 4); mov(memw[es, bx + 0x1c], ax);             /* mov [es:bx+0x1c], ax */
            ii(0x17_5051, 4); mov(memw[es, bx + 0x1e], dx);             /* mov [es:bx+0x1e], dx */
        ...
        l_0x17_5061:
            ...
            ii(0x17_5066, 3); les(bx, memw[ss, bp - 0x8]);              /* les bx, [bp-0x8] */
            ii(0x17_5069, 4); mov(memw[es, bx + 0x1c], ax);             /* mov [es:bx+0x1c], ax */
            ii(0x17_506d, 4); mov(memw[es, bx + 0x1e], dx);             /* mov [es:bx+0x1e], dx */
            ii(0x17_5071, 3); push(memw[ss, bp - 0x6]);                 /* push word [bp-0x6] */
            ii(0x17_5074, 3); push(memw[ss, bp - 0x8]);                 /* push word [bp-0x8] */
            ii(0x17_5077, 1); push(cs);                                 /* push cs */
            ii(0x17_5078, 3); call(0x17_54b4, 0x439);                   /* call 0x54b4 */
            ii(0x17_507b, 3); add(sp, 0x4);                             /* add sp, 0x4 */
            ii(0x17_507e, 3); push(memw[ss, bp - 0x6]);                 /* push word [bp-0x6] */
            ii(0x17_5081, 1); push(cs);                                 /* push cs */
            ii(0x17_5082, 3); call(0x17_55f0, 0x56b);                   /* call 0x55f0 */
            ii(0x17_5085, 3); add(sp, 0x2);                             /* add sp, 0x2 */
            ii(0x17_5088, 3); mov(ax, memw[ss, bp - 0x6]);              /* mov ax, [bp-0x6] */
            ii(0x17_508b, 3); les(bx, memw[ss, bp - 0x4]);              /* les bx, [bp-0x4] */
            ii(0x17_508e, 4); mov(memw[es, bx + 0x2], ax);              /* mov [es:bx+0x2], ax */
            ii(0x17_5092, 4); mov(al, memb[es, bx + 0x5]);              /* mov al, [es:bx+0x5] */
            ii(0x17_5096, 2); and(al, 0xe5);                            /* and al, 0xe5 */
            ii(0x17_5098, 2); or(al, 0x5);                              /* or al, 0x5 */
            ii(0x17_509a, 4); mov(memb[es, bx + 0x5], al);              /* mov [es:bx+0x5], al */
            ii(0x17_509e, 5); and(memb[es, bx + 0x5], -0x61 /* 0x9f */); /* and byte [es:bx+0x5], 0x9f */
            ii(0x17_50a3, 5); or(memb[es, bx + 0x5], -0x80 /* 0x80 */); /* or byte [es:bx+0x5], 0x80 */
