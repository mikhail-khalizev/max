...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_c302()
        {
            ...
            ii(0x1012_c318, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1012_c31b, 3); mov(memd[ss, ebp - 8], edx);            /* mov [ebp-0x8], edx */
            ii(0x1012_c31e, 3); mov(memd[ss, ebp - 4], ebx);            /* mov [ebp-0x4], ebx */
            ii(0x1012_c321, 5); mov(eax, memd[ds, 0x101c_3964]);        /* mov eax, [0x101c3964] */
            ii(0x1012_c326, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1012_c329, 3); cmp(eax, 1);                            /* cmp eax, 0x1 */
            ...
            ii(0x1012_c334, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
            ii(0x1012_c337, 5); jmp(0x1012_c3b5, 0x79); goto l_0x1012_c3b5; /* jmp 0x1012c3b5 */
        l_0x1012_c33c:
            ii(0x1012_c33c, 7); mov(memd[ss, ebp - 16], 0);             /* mov dword [ebp-0x10], 0x0 */
            ii(0x1012_c343, 7); mov(memd[ss, ebp - 24], 0);             /* mov dword [ebp-0x18], 0x0 */
            ii(0x1012_c34a, 2); jmp(0x1012_c352, 6); goto l_0x1012_c352; /* jmp 0x1012c352 */
        l_0x1012_c34c:
            ii(0x1012_c34c, 3); mov(eax, memd[ss, ebp - 24]);           /* mov eax, [ebp-0x18] */
            ii(0x1012_c34f, 3); inc(memd[ss, ebp - 24]);                /* inc dword [ebp-0x18] */
        l_0x1012_c352:
            ii(0x1012_c352, 4); movsx(eax, memw[ss, ebp - 24]);         /* movsx eax, word [ebp-0x18] */
            ii(0x1012_c356, 3); cmp(eax, 4);                            /* cmp eax, 0x4 */
            ii(0x1012_c359, 2); if(jge(0x1012_c3b5, 0x5a)) goto l_0x1012_c3b5; /* jge 0x1012c3b5 */
            ii(0x1012_c35b, 4); movsx(eax, memw[ss, ebp - 24]);         /* movsx eax, word [ebp-0x18] */
            ...
            ii(0x1012_c374, 4); movsx(eax, memw[ss, ebp - 24]);         /* movsx eax, word [ebp-0x18] */
            ...
            ii(0x1012_c389, 3); cmp(eax, 4);                            /* cmp eax, 0x4 */
            ii(0x1012_c38c, 2); if(jnz(0x1012_c390, 2)) goto l_0x1012_c390; /* jnz 0x1012c390 */
        l_0x1012_c38e:
            ii(0x1012_c38e, 2); jmp(0x1012_c3b3, 0x23); goto l_0x1012_c3b3; /* jmp 0x1012c3b3 */
        l_0x1012_c390:
            ii(0x1012_c390, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
            ii(0x1012_c393, 3); mov(al, memb[ds, eax + 38]);            /* mov al, [eax+0x26] */
            ...
            ii(0x1012_c3a7, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x1012_c3ab, 5); call(0x1007_6e7c, -0xb_5534);           /* call 0x10076e7c */
            ii(0x1012_c3b0, 3); mov(memd[ss, ebp - 16], eax);           /* mov [ebp-0x10], eax */
        l_0x1012_c3b3:
            ii(0x1012_c3b3, 2); jmp(0x1012_c34c, -0x69); goto l_0x1012_c34c; /* jmp 0x1012c34c */
        l_0x1012_c3b5:
            ii(0x1012_c3b5, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x1012_c3b9, 3); cmp(eax, 1);                            /* cmp eax, 0x1 */
            ii(0x1012_c3bc, 2); if(jge(0x1012_c3c5, 7)) goto l_0x1012_c3c5; /* jge 0x1012c3c5 */
            ii(0x1012_c3be, 7); mov(memd[ss, ebp - 16], 0xa);           /* mov dword [ebp-0x10], 0xa */
        l_0x1012_c3c5:
            ii(0x1012_c3c5, 4); movsx(edx, memw[ss, ebp - 16]);         /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x1012_c3d8, 3); mov(memd[ss, ebp - 20], eax);           /* mov [ebp-0x14], eax */
            ii(0x1012_c3db, 2); xor(eax, eax);                          /* xor eax, eax */
            ii(0x1012_c3dd, 1); push(eax);                              /* push eax */
            ii(0x1012_c3de, 4); movsx(eax, memw[ss, ebp - 20]);         /* movsx eax, word [ebp-0x14] */
            ii(0x1012_c3e2, 1); push(eax);                              /* push eax */
            ii(0x1012_c3e3, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x1012_c3e6, 3); mov(eax, memd[ds, edx + 80]);           /* mov eax, [edx+0x50] */
            ii(0x1012_c3e9, 3); sar(eax, 0x10);                         /* sar eax, 0x10 */
            ii(0x1012_c3ec, 1); push(eax);                              /* push eax */
            ii(0x1012_c3ed, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x1012_c3f0, 3); mov(eax, memd[ds, edx + 80]);           /* mov eax, [edx+0x50] */
            ...
            ii(0x1012_c403, 5); mov(ecx, 1);                            /* mov ecx, 0x1 */
            ii(0x1012_c408, 3); mov(ebx, memd[ss, ebp - 4]);            /* mov ebx, [ebp-0x4] */
            ii(0x1012_c40b, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
            ...
            ii(0x1012_c41b, 4); movsx(eax, memw[ss, ebp - 20]);         /* movsx eax, word [ebp-0x14] */
            ii(0x1012_c41f, 1); push(eax);                              /* push eax */
            ii(0x1012_c420, 4); movsx(eax, memw[ss, ebp - 16]);         /* movsx eax, word [ebp-0x10] */
            ii(0x1012_c424, 1); push(eax);                              /* push eax */
            ii(0x1012_c425, 3); mov(edx, memd[ss, ebp - 12]);           /* mov edx, [ebp-0xc] */
            ii(0x1012_c428, 3); mov(dl, memb[ds, edx + 38]);            /* mov dl, [edx+0x26] */
            ...
            ii(0x1012_c44d, 5); mov(ecx, 2);                            /* mov ecx, 0x2 */
            ii(0x1012_c452, 3); mov(ebx, memd[ss, ebp - 4]);            /* mov ebx, [ebp-0x4] */
            ii(0x1012_c455, 3); mov(edx, memd[ss, ebp - 8]);            /* mov edx, [ebp-0x8] */
