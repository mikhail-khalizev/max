...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x91a3:
            ii(0x91a3, 3);    mov(memw[ss, bp - 0x2], bx);              /* mov [bp-0x2], bx */
            ii(0x91a6, 3);    inc(memw[ss, bp + 0x4]);                  /* inc word [bp+0x4] */
            ii(0x91a9, 3);    call(0x90c6, -0xe6);                      /* call 0x90c6 */
            ii(0x91ac, 3);    mov(bx, memw[ss, bp - 0x2]);              /* mov bx, [bp-0x2] */
            ii(0x91af, 2);    mov(cx, ax);                              /* mov cx, ax */
            ii(0x91b1, 2);    mov(al, memb[ds, bx]);                    /* mov al, [bx] */
            ii(0x91b3, 1);    cbw();                                    /* cbw */
            ii(0x91b4, 2);    cmp(cx, ax);                              /* cmp cx, ax */
            ii(0x91b6, 2);    if(jz(0x91bc, 0x4)) goto l_0x91bc;        /* jz 0x91bc */
            ii(0x91b8, 2);    sub(ax, ax);                              /* sub ax, ax */
            ii(0x91ba, 2);    jmp(0x91c7, 0xb); goto l_0x91c7;          /* jmp 0x91c7 */
        l_0x91bc:
            ii(0x91bc, 3);    mov(bx, memw[ss, bp + 0x4]);              /* mov bx, [bp+0x4] */
