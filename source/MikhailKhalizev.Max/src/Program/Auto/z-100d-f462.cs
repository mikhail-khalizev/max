...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_f462()
        {
            ...
            ii(0x100d_f481, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
            ii(0x100d_f484, 5);  call(0x100e_0608, 0x117f);            /* call 0x100e0608 */
            ii(0x100d_f489, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x100d_f48c, 4);  and(memb[ss, ebp - 8], -2 /* 0xfe */);/* and byte [ebp-0x8], 0xfe */
            ii(0x100d_f490, 7);  mov(memd[ss, ebp - 12], 1);           /* mov dword [ebp-0xc], 0x1 */
            ...
            ii(0x100d_f4a6, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
        ...
        l_0x100d_f4b0:
            ii(0x100d_f4b0, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
            ii(0x100d_f4b3, 5);  call(0x1007_6bf8, -0x6_88c0);         /* call 0x10076bf8 */
        l_0x100d_f4b8:
            ii(0x100d_f4b8, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100d_f4ba, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
        ...
        l_0x100d_f4db:
            ii(0x100d_f4db, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100d_f4de, 3);  inc(memd[ss, ebp - 12]);              /* inc dword [ebp-0xc] */
        ...
        l_0x100d_f4e3:
            ...
            ii(0x100d_f4ed, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x100d_f4f0, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_f4f3, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x100d_f4f6, 4);  cmp(memd[ss, ebp - 20], 0);           /* cmp dword [ebp-0x14], 0x0 */
            ii(0x100d_f4fa, 2);  if(jz(0x100d_f513, 0x17)) goto l_0x100d_f513;/* jz 0x100df513 */
            ii(0x100d_f4fc, 4);  movsx(edx, memw[ss, ebp - 12]);       /* movsx edx, word [ebp-0xc] */
            ii(0x100d_f500, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100d_f503, 5);  call(0x1016_3dd9, 0x8_48d1);          /* call 0x10163dd9 */
            ii(0x100d_f508, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x100d_f50b, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x100d_f50e, 3);  mov(memd[ss, ebp - 44], eax);         /* mov [ebp-0x2c], eax */
            ii(0x100d_f511, 2);  jmp(0x100d_f519, 6); goto l_0x100d_f519;/* jmp 0x100df519 */
        l_0x100d_f513:
            ii(0x100d_f513, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100d_f516, 3);  mov(memd[ss, ebp - 44], eax);         /* mov [ebp-0x2c], eax */
        l_0x100d_f519:
            ii(0x100d_f519, 3);  mov(eax, memd[ss, ebp - 44]);         /* mov eax, [ebp-0x2c] */
            ii(0x100d_f51c, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100d_f51f, 3);  mov(ebx, memd[ss, ebp - 28]);         /* mov ebx, [ebp-0x1c] */
            ii(0x100d_f522, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
            ...
            ii(0x100d_f539, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x100d_f53c, 3);  mov(memd[ss, ebp - 40], eax);         /* mov [ebp-0x28], eax */
            ii(0x100d_f53f, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100d_f541, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
        ...
        //  ii(0x100d_f54d, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
        //  ii(0x100d_f550, 5);  call(0x100e_043c, 0xee7);             /* call 0x100e043c */
        l_0x100d_f555:
            ii(0x100d_f555, 3);  mov(eax, memd[ss, ebp - 40]);         /* mov eax, [ebp-0x28] */
