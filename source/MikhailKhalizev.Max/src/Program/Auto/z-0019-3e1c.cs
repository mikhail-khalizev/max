...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_3e1c()
        {
            ...
            ii(0x19_3e1d, 3); mov(si, memw[ds, bx + 0x8]);              /* mov si, [bx+0x8] */
            ii(0x19_3e20, 3); cmp(si, memw[ds, bx + 0xa]);              /* cmp si, [bx+0xa] */
            ii(0x19_3e23, 2); if(jnz(0x19_3e28, 0x3)) goto l_0x19_3e28; /* jnz 0x3e28 */
            ii(0x19_3e25, 3); mov(si, memw[ds, bx + 0x6]);              /* mov si, [bx+0x6] */
        l_0x19_3e28:
            ii(0x19_3e28, 1); lodsw();                                  /* lodsw */
            ii(0x19_3e29, 3); cmp(ax, 0xfffe);                          /* cmp ax, 0xfffe */
            ii(0x19_3e2c, 2); if(jz(0x19_3e36, 0x8)) goto l_0x19_3e36;  /* jz 0x3e36 */
