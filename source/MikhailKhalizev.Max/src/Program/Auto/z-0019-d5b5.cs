...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_d5b5()
        {
            ...
            ii(0x19_d5cc, 3); mov(memw[ss, bp - 0xa], dx);              /* mov [bp-0xa], dx */
            ii(0x19_d5cf, 2); or(dx, ax);                               /* or dx, ax */
            ii(0x19_d5d1, 2); if(jnz(0x19_d5d6, 0x3)) goto l_0x19_d5d6; /* jnz 0xd5d6 */
        ...
        l_0x19_d5d6:
            ...
            ii(0x19_d5ea, 3); mov(memw[ss, bp - 0x46], ax);             /* mov [bp-0x46], ax */
            ii(0x19_d5ed, 3); mov(memw[ss, bp - 0x44], dx);             /* mov [bp-0x44], dx */
            ii(0x19_d5f0, 3); mov(memw[ss, bp - 0x4a], ax);             /* mov [bp-0x4a], ax */
            ii(0x19_d5f3, 3); mov(memw[ss, bp - 0x48], dx);             /* mov [bp-0x48], dx */
            ...
            ii(0x19_d625, 3); mov(dx, memw[ss, bp - 0x44]);             /* mov dx, [bp-0x44] */
            ii(0x19_d628, 3); add(ax, 0xff8);                           /* add ax, 0xff8 */
            ii(0x19_d62b, 3); adc(dx, 0);                               /* adc dx, 0x0 */
            ii(0x19_d62e, 3); mov(memw[ss, bp - 0x46], ax);             /* mov [bp-0x46], ax */
            ii(0x19_d631, 3); mov(memw[ss, bp - 0x44], dx);             /* mov [bp-0x44], dx */
            ii(0x19_d634, 3); mov(ax, memw[ds, 0x19ea]);                /* mov ax, [0x19ea] */
            ii(0x19_d637, 4); mov(dx, memw[ds, 0x19ec]);                /* mov dx, [0x19ec] */
            ii(0x19_d63b, 3); sub(memw[ss, bp - 0x46], ax);             /* sub [bp-0x46], ax */
            ii(0x19_d63e, 3); sbb(memw[ss, bp - 0x44], dx);             /* sbb [bp-0x44], dx */
            ii(0x19_d641, 1); push(es);                                 /* push es */
            ii(0x19_d642, 1); push(bx);                                 /* push bx */
            ii(0x19_d643, 3); call(0x19_df78, 0x932);                   /* call 0xdf78 */
            ii(0x19_d646, 3); mov(ax, memw[ss, bp - 0x46]);             /* mov ax, [bp-0x46] */
            ii(0x19_d649, 3); mov(dx, memw[ss, bp - 0x44]);             /* mov dx, [bp-0x44] */
            ...
            ii(0x19_d672, 3); push(memw[ss, bp - 0xa]);                 /* push word [bp-0xa] */
            ii(0x19_d675, 3); push(memw[ss, bp - 0xc]);                 /* push word [bp-0xc] */
            ii(0x19_d678, 4); push(memw[ds, 0x19e4]);                   /* push word [0x19e4] */
            ii(0x19_d67c, 3); mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
            ii(0x19_d67f, 3); mov(dx, memw[ss, bp + 0x6]);              /* mov dx, [bp+0x6] */
        ...
        l_0x19_d695:
            ii(0x19_d695, 3); push(memw[ss, bp - 0xa]);                 /* push word [bp-0xa] */
            ii(0x19_d698, 3); push(memw[ss, bp - 0xc]);                 /* push word [bp-0xc] */
            ii(0x19_d69b, 4); push(memw[ds, 0x19e4]);                   /* push word [0x19e4] */
            ii(0x19_d69f, 3); mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
            ii(0x19_d6a2, 3); mov(dx, memw[ss, bp + 0x6]);              /* mov dx, [bp+0x6] */
            ...
            ii(0x19_d6ba, 3); push(memw[ss, bp - 0xa]);                 /* push word [bp-0xa] */
            ii(0x19_d6bd, 3); push(memw[ss, bp - 0xc]);                 /* push word [bp-0xc] */
        ...
        l_0x19_d6c8:
            ii(0x19_d6c8, 3); push(memw[ss, bp - 0x48]);                /* push word [bp-0x48] */
            ii(0x19_d6cb, 3); push(memw[ss, bp - 0x4a]);                /* push word [bp-0x4a] */
            ii(0x19_d6ce, 3); call(0x19_a1c1, -0x3510);                 /* call 0xa1c1 */
        l_0x19_d6d1:
            ii(0x19_d6d1, 1); pop(si);                                  /* pop si */
            ii(0x19_d6d2, 1); leave();                                  /* leave */
            ii(0x19_d6d3, 3); ret(0x4);                                 /* ret 0x4 */
        }
    }
}
