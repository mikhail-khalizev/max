...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_29b0()
        {
            ...
            ii(0x1016_29d5, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
            ii(0x1016_29d8, 5); call(0x1007_64b8, -0xe_c525);           /* call 0x100764b8 */
        l_0x1016_29dd:
            ii(0x1016_29dd, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1016_29df, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
        ...
        l_0x1016_2a02:
            ...
            ii(0x1016_2a04, 3); lea(eax, memd[ss, ebp - 0x8]);          /* lea eax, [ebp-0x8] */
