...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_811c()
        {
            ...
            ii(0x100d_8134, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100d_8137, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100d_8140, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_8143, 3); mov(edx, memd[ds, eax + 0x6]);          /* mov edx, [eax+0x6] */
            ii(0x100d_8146, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_8149, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_814c, 3); mov(eax, memd[ds, eax + 0x8]);          /* mov eax, [eax+0x8] */
            ...
            ii(0x100d_815a, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_815d, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_8160, 3); mov(edx, memd[ds, eax + 0x6]);          /* mov edx, [eax+0x6] */
            ii(0x100d_8163, 3); sar(edx, 0x10);                         /* sar edx, 0x10 */
            ii(0x100d_8166, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_8169, 3); mov(ebx, memd[ds, eax + 0x8]);          /* mov ebx, [eax+0x8] */
            ii(0x100d_816c, 3); sar(ebx, 0x10);                         /* sar ebx, 0x10 */
            ii(0x100d_816f, 3); imul(ebx, edx);                         /* imul ebx, edx */
            ii(0x100d_8172, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_8175, 2); mov(edx, memd[ds, eax]);                /* mov edx, [eax] */
            ii(0x100d_8177, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_817a, 5); call(Definitions.sys_memcpy, 0x8_dccc); /* call 0x10165e4b */
            ii(0x100d_817f, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_8182, 3); mov(edx, memd[ss, ebp - 0x4]);          /* mov edx, [ebp-0x4] */
            ii(0x100d_8185, 2); mov(memd[ds, edx], eax);                /* mov [edx], eax */
            ii(0x100d_8187, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100d_818a, 4); mov(memb[ds, eax + 0xc], 0x1);          /* mov byte [eax+0xc], 0x1 */
        l_0x100d_818e:
