...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0001_1642()
        {
            ...
            ii(0x1_165b, 3);  mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x1_165e, 3);  mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x1_1661, 5);  cmp(memb[ds, 0x2e], 0xb);                 /* cmp byte [0x2e], 0xb */
            ii(0x1_1666, 2);  if(jnz(0x1_1671, 0x9)) goto l_0x1_1671;   /* jnz 0x1671 */
        l_0x1_1668:
        ...
        l_0x1_1671:
            ii(0x1_1671, 3);  mov(ax, memw[ss, bp - 0x4]);              /* mov ax, [bp-0x4] */
            ii(0x1_1674, 3);  mov(dx, memw[ss, bp - 0x2]);              /* mov dx, [bp-0x2] */
        ...
        l_0x1_1688:
            ii(0x1_1688, 5);  mov(memw[ss, bp - 0x14], 0x3);            /* mov word [bp-0x14], 0x3 */
        l_0x1_168d:
            ii(0x1_168d, 3);  mov(ax, memw[ss, bp + 0x4]);              /* mov ax, [bp+0x4] */
            ii(0x1_1690, 3);  mov(dx, memw[ss, bp + 0x6]);              /* mov dx, [bp+0x6] */
            ...
            ii(0x1_16a4, 3);  mov(memw[ss, bp - 0xc], ax);              /* mov [bp-0xc], ax */
            ii(0x1_16a7, 3);  mov(memw[ss, bp - 0xa], dx);              /* mov [bp-0xa], dx */
            ii(0x1_16aa, 5);  mov(memw[ss, bp - 0xe], 0x3);             /* mov word [bp-0xe], 0x3 */
        l_0x1_16af:
            ii(0x1_16af, 4);  call_abs(memw[ds, 0xaa4]);                /* call word [0xaa4] */
            ii(0x1_16b3, 3);  mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x1_16b6, 3);  mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
            ii(0x1_16b9, 3);  cmp(dx, memw[ss, bp - 0xa]);              /* cmp dx, [bp-0xa] */
            ii(0x1_16bc, 2);  if(jg(0x1_16d1, 0x13)) goto l_0x1_16d1;   /* jg 0x16d1 */
            ii(0x1_16be, 2);  if(jl(0x1_16c5, 0x5)) goto l_0x1_16c5;    /* jl 0x16c5 */
            ii(0x1_16c0, 3);  cmp(ax, memw[ss, bp - 0xc]);              /* cmp ax, [bp-0xc] */
            ii(0x1_16c3, 2);  if(jae(0x1_16d1, 0xc)) goto l_0x1_16d1;   /* jae 0x16d1 */
        l_0x1_16c5:
            ii(0x1_16c5, 4);  cmp(memw[ss, bp + 0x8], 0);               /* cmp word [bp+0x8], 0x0 */
            ii(0x1_16c9, 2);  if(jnz(0x1_1668, -0x63)) goto l_0x1_1668; /* jnz 0x1668 */
            ii(0x1_16cb, 3);  mov(memw[ss, bp - 0xc], ax);              /* mov [bp-0xc], ax */
            ii(0x1_16ce, 3);  mov(memw[ss, bp - 0xa], dx);              /* mov [bp-0xa], dx */
        l_0x1_16d1:
            ii(0x1_16d1, 4);  cmp(memw[ss, bp - 0xa], 0);               /* cmp word [bp-0xa], 0x0 */
            ii(0x1_16d5, 2);  if(jg(0x1_16df, 0x8)) goto l_0x1_16df;    /* jg 0x16df */
            ii(0x1_16d7, 2);  if(jl(0x1_1668, -0x71)) goto l_0x1_1668;  /* jl 0x1668 */
            ii(0x1_16d9, 4);  cmp(memw[ss, bp - 0xc], 0);               /* cmp word [bp-0xc], 0x0 */
            ii(0x1_16dd, 2);  if(jz(0x1_1668, -0x77)) goto l_0x1_1668;  /* jz 0x1668 */
        l_0x1_16df:
            ii(0x1_16df, 3);  push(memw[ss, bp - 0xa]);                 /* push word [bp-0xa] */
            ii(0x1_16e2, 3);  push(memw[ss, bp - 0xc]);                 /* push word [bp-0xc] */
            ii(0x1_16e5, 4);  call_abs(memw[ds, 0xaa6]);                /* call word [0xaa6] */
            ii(0x1_16e9, 1);  pop(bx);                                  /* pop bx */
            ii(0x1_16ea, 1);  pop(bx);                                  /* pop bx */
            ii(0x1_16eb, 3);  mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x1_16ee, 3);  mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x1_16f1, 2);  or(dx, ax);                               /* or dx, ax */
            ii(0x1_16f3, 2);  if(jnz(0x1_170b, 0x16)) goto l_0x1_170b;  /* jnz 0x170b */
            ii(0x1_16f5, 4);  cmp(memw[ss, bp + 0x8], 0);               /* cmp word [bp+0x8], 0x0 */
            ii(0x1_16f9, 2);  if(jz(0x1_1703, 0x8)) goto l_0x1_1703;    /* jz 0x1703 */
            ii(0x1_16fb, 3);  dec(memw[ss, bp - 0xe]);                  /* dec word [bp-0xe] */
            ii(0x1_16fe, 2);  if(jns(0x1_1703, 0x3)) goto l_0x1_1703;   /* jns 0x1703 */
            ii(0x1_1700, 3);  jmp(0x1_1668, -0x9b); goto l_0x1_1668;    /* jmp 0x1668 */
        l_0x1_1703:
            ii(0x1_1703, 3);  sar(memw[ss, bp - 0xa], 0x1);             /* sar word [bp-0xa], 1 */
            ii(0x1_1706, 3);  rcr(memw[ss, bp - 0xc], 0x1);             /* rcr word [bp-0xc], 1 */
            ii(0x1_1709, 2);  jmp(0x1_16af, -0x5c); goto l_0x1_16af;    /* jmp 0x16af */
        l_0x1_170b:
            ii(0x1_170b, 3);  push(memw[ss, bp - 0x2]);                 /* push word [bp-0x2] */
            ...
            ii(0x1_1714, 3);  mov(memw[ss, bp - 0x12], ax);             /* mov [bp-0x12], ax */
            ii(0x1_1717, 3);  mov(memw[ss, bp - 0x10], dx);             /* mov [bp-0x10], dx */
            ii(0x1_171a, 1);  cli();                                    /* cli */
            ii(0x1_171b, 3);  mov(ax, memw[ss, bp - 0x12]);             /* mov ax, [bp-0x12] */
            ii(0x1_171e, 3);  mov(dx, memw[ss, bp - 0x10]);             /* mov dx, [bp-0x10] */
            ii(0x1_1721, 4);  cmp(memw[ds, 0x9a], dx);                  /* cmp [0x9a], dx */
            ii(0x1_1725, 2);  if(ja(0x1_1738, 0x11)) goto l_0x1_1738;   /* ja 0x1738 */
            ii(0x1_1727, 2);  if(jb(0x1_172f, 0x6)) goto l_0x1_172f;    /* jb 0x172f */
            ii(0x1_1729, 4);  cmp(memw[ds, 0x98], ax);                  /* cmp [0x98], ax */
            ii(0x1_172d, 2);  if(ja(0x1_1738, 0x9)) goto l_0x1_1738;    /* ja 0x1738 */
        l_0x1_172f:
        ...
        l_0x1_1738:
            ...
            ii(0x1_173f, 3);  mov(memw[ss, bp - 0x8], ax);              /* mov [bp-0x8], ax */
            ii(0x1_1742, 3);  mov(memw[ss, bp - 0x6], dx);              /* mov [bp-0x6], dx */
            ii(0x1_1745, 3);  mov(ax, memw[ss, bp - 0x12]);             /* mov ax, [bp-0x12] */
            ii(0x1_1748, 3);  mov(dx, memw[ss, bp - 0x10]);             /* mov dx, [bp-0x10] */
            ii(0x1_174b, 3);  mov(memw[ds, 0x98], ax);                  /* mov [0x98], ax */
            ii(0x1_174e, 4);  mov(memw[ds, 0x9a], dx);                  /* mov [0x9a], dx */
            ii(0x1_1752, 3);  push(memw[ss, bp - 0x6]);                 /* push word [bp-0x6] */
            ii(0x1_1755, 3);  push(memw[ss, bp - 0x8]);                 /* push word [bp-0x8] */
            ...
            ii(0x1_1766, 2);  push(0x4);                                /* push 0x4 */
            ii(0x1_1768, 3);  push(memw[ss, bp - 0x10]);                /* push word [bp-0x10] */
            ii(0x1_176b, 3);  push(memw[ss, bp - 0x12]);                /* push word [bp-0x12] */
            ii(0x1_176e, 3);  call(0x1_1b37, 0x3c6);                    /* call 0x1b37 */
            ii(0x1_1771, 3);  add(sp, 0xa);                             /* add sp, 0xa */
            ii(0x1_1774, 4);  add(memw[ss, bp - 0x12], 0x1);            /* add word [bp-0x12], 0x1 */
            ii(0x1_1778, 4);  adc(memw[ss, bp - 0x10], 0);              /* adc word [bp-0x10], 0x0 */
            ii(0x1_177c, 4);  sub(memw[ss, bp - 0xc], 0x10);            /* sub word [bp-0xc], 0x10 */
            ii(0x1_1780, 4);  sbb(memw[ss, bp - 0xa], 0);               /* sbb word [bp-0xa], 0x0 */
        l_0x1_1784:
            ii(0x1_1784, 3);  push(memw[ss, bp - 0xa]);                 /* push word [bp-0xa] */
            ii(0x1_1787, 3);  push(memw[ss, bp - 0xc]);                 /* push word [bp-0xc] */
            ii(0x1_178a, 3);  call(0x1_1b8c, 0x3ff);                    /* call 0x1b8c */
            ii(0x1_178d, 1);  pop(bx);                                  /* pop bx */
            ii(0x1_178e, 1);  pop(bx);                                  /* pop bx */
            ii(0x1_178f, 3);  add(ax, memw[ss, bp - 0x12]);             /* add ax, [bp-0x12] */
            ii(0x1_1792, 3);  adc(dx, memw[ss, bp - 0x10]);             /* adc dx, [bp-0x10] */
            ii(0x1_1795, 3);  mov(memw[ss, bp - 0x4], ax);              /* mov [bp-0x4], ax */
            ii(0x1_1798, 3);  mov(memw[ss, bp - 0x2], dx);              /* mov [bp-0x2], dx */
            ii(0x1_179b, 4);  cmp(memw[ds, 0x9e], dx);                  /* cmp [0x9e], dx */
            ii(0x1_179f, 2);  if(ja(0x1_17b0, 0xf)) goto l_0x1_17b0;    /* ja 0x17b0 */
            ii(0x1_17a1, 2);  if(jb(0x1_17a9, 0x6)) goto l_0x1_17a9;    /* jb 0x17a9 */
            ii(0x1_17a3, 4);  cmp(memw[ds, 0x9c], ax);                  /* cmp [0x9c], ax */
            ii(0x1_17a7, 2);  if(jae(0x1_17b0, 0x7)) goto l_0x1_17b0;   /* jae 0x17b0 */
        l_0x1_17a9:
            ii(0x1_17a9, 3);  mov(memw[ds, 0x9c], ax);                  /* mov [0x9c], ax */
            ii(0x1_17ac, 4);  mov(memw[ds, 0x9e], dx);                  /* mov [0x9e], dx */
        l_0x1_17b0:
            ii(0x1_17b0, 3);  push(memw[ss, bp - 0xa]);                 /* push word [bp-0xa] */
            ii(0x1_17b3, 3);  push(memw[ss, bp - 0xc]);                 /* push word [bp-0xc] */
            ...
            ii(0x1_17bd, 3);  push(memw[ss, bp - 0x10]);                /* push word [bp-0x10] */
            ii(0x1_17c0, 3);  push(memw[ss, bp - 0x12]);                /* push word [bp-0x12] */
            ...
            ii(0x1_17d8, 3);  push(memw[ss, bp - 0x10]);                /* push word [bp-0x10] */
            ii(0x1_17db, 3);  push(memw[ss, bp - 0x12]);                /* push word [bp-0x12] */
        ...
        l_0x1_17e1:
            ...
            ii(0x1_17e8, 3);  mov(ax, memw[ss, bp - 0xc]);              /* mov ax, [bp-0xc] */
            ii(0x1_17eb, 3);  mov(dx, memw[ss, bp - 0xa]);              /* mov dx, [bp-0xa] */
            ii(0x1_17ee, 4);  add(memw[ds, 0xaa8], ax);                 /* add [0xaa8], ax */
            ii(0x1_17f2, 4);  adc(memw[ds, 0xaaa], dx);                 /* adc [0xaaa], dx */
        l_0x1_17f6:
            ii(0x1_17f6, 3);  dec(memw[ss, bp - 0x14]);                 /* dec word [bp-0x14] */
            ii(0x1_17f9, 4);  cmp(memw[ss, bp - 0x14], 0);              /* cmp word [bp-0x14], 0x0 */
            ii(0x1_17fd, 2);  if(jg(0x1_1802, 0x3)) goto l_0x1_1802;    /* jg 0x1802 */
