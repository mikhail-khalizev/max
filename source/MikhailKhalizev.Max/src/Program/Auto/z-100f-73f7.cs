...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_73f7()
        {
            ...
            ii(0x100f_740f, 3); mov(memd[ss, ebp - 0x4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100f_7412, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100f_741b, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x100f_741e, 4); test(memb[ds, eax + 0x14], 0x1);        /* test byte [eax+0x14], 0x1 */
            ii(0x100f_7422, 2); if(jnz(0x100f_742d, 0x9)) goto l_0x100f_742d; /* jnz 0x100f742d */
            ii(0x100f_7424, 7); mov(memd[ss, ebp - 0xc], 0x1);          /* mov dword [ebp-0xc], 0x1 */
            ii(0x100f_742b, 2); jmp(0x100f_7434, 0x7); goto l_0x100f_7434; /* jmp 0x100f7434 */
        l_0x100f_742d:
            ii(0x100f_742d, 7); mov(memd[ss, ebp - 0xc], 0);            /* mov dword [ebp-0xc], 0x0 */
        l_0x100f_7434:
            ii(0x100f_7434, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x100f_7437, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100f_743a, 2); jmp(0x100f_7443, 0x7); goto l_0x100f_7443; /* jmp 0x100f7443 */
        l_0x100f_743c:
            ii(0x100f_743c, 7); mov(memd[ss, ebp - 0x8], 0x1);          /* mov dword [ebp-0x8], 0x1 */
        l_0x100f_7443:
            ii(0x100f_7443, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
