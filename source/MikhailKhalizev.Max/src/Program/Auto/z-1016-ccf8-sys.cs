...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("0x1016_ccf8-320bf49b")]
        public void /* sys */ Method_1016_ccf8()
        {
            ...
            ii(0x1016_cd19, 6);  mov(memb[ds, edx + 0x101c_fce2], cl); /* mov [edx+0x101cfce2], cl */
            ii(0x1016_cd1f, 2);  mov(al, ah);                          /* mov al, ah */
            ii(0x1016_cd21, 5);  and(eax, 0xff);                       /* and eax, 0xff */
            ii(0x1016_cd26, 6);  mov(ah, memb[ds, eax + 0x101c_ffe0]); /* mov ah, [eax+0x101cffe0] */
            ii(0x1016_cd2c, 6);  and(ebx, 0xff);                       /* and ebx, 0xff */
            ii(0x1016_cd32, 6);  mov(bl, memb[ds, ebx + 0x101c_ffe0]); /* mov bl, [ebx+0x101cffe0] */
            ii(0x1016_cd38, 6);  and(ecx, 0xff);                       /* and ecx, 0xff */
            ii(0x1016_cd3e, 3);  mov(al, memb[ss, esp]);               /* mov al, [esp] */
            ii(0x1016_cd41, 5);  mov(edx, 0x3c8);                      /* mov edx, 0x3c8 */
            ii(0x1016_cd46, 6);  mov(cl, memb[ds, ecx + 0x101c_ffe0]); /* mov cl, [ecx+0x101cffe0] */
