...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_d987()
        {
            ...
            ii(0x1011_d9c0, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x1011_d9c3, 5);  call(0x1008_b148, -0x9_2880);         /* call 0x1008b148 */
            ii(0x1011_d9c8, 3);  push(memd[ds, eax + 12]);             /* push dword [eax+0xc] */
            ...
            ii(0x1011_d9e1, 7);  mov(memd[ds, eax + 35], 0x101b_68bc); /* mov dword [eax+0x23], 0x101b68bc */
            ii(0x1011_d9e8, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_d9eb, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_d9ee, 3);  mov(memd[ds, edx + 39], eax);         /* mov [edx+0x27], eax */
            ii(0x1011_d9f1, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_d9f4, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1011_d9f7, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
