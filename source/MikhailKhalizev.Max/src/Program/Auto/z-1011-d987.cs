...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_d987()
        {
            ...
            ii(0x1011_d99e, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_d9a1, 3); mov(memd[ss, ebp - 0x4], edx);          /* mov [ebp-0x4], edx */
            ...
            ii(0x1011_d9cb, 3); push(memd[ds, eax + 0x8]);              /* push dword [eax+0x8] */
            ii(0x1011_d9ce, 3); push(memd[ds, eax + 0x4]);              /* push dword [eax+0x4] */
            ii(0x1011_d9d1, 2); push(memd[ds, eax]);                    /* push dword [eax] */
            ii(0x1011_d9d3, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_d9d6, 5); call(0x1009_02f8, -0x8_d6e3);           /* call 0x100902f8 */
            ii(0x1011_d9db, 3); mov(memd[ss, ebp - 0x8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_d9de, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_d9e1, 7); mov(memd[ds, eax + 0x23], 0x101b_68bc); /* mov dword [eax+0x23], 0x101b68bc */
            ii(0x1011_d9e8, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_d9eb, 3); mov(edx, memd[ss, ebp - 0x8]);          /* mov edx, [ebp-0x8] */
            ii(0x1011_d9ee, 3); mov(memd[ds, edx + 0x27], eax);         /* mov [edx+0x27], eax */
            ii(0x1011_d9f1, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
