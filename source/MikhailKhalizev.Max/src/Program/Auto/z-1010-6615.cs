...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_6615()
        {
            ...
            ii(0x1010_662b, 3); mov(memd[ss, ebp - 0xc], eax);          /* mov [ebp-0xc], eax */
            ii(0x1010_662e, 3); mov(memd[ss, ebp - 0x8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1010_6631, 3); mov(memd[ss, ebp - 0x4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1010_6634, 2); push(0x14);                             /* push 0x14 */
            ii(0x1010_6636, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1010_6639, 5); add(eax, 0xac);                         /* add eax, 0xac */
            ii(0x1010_663e, 1); push(eax);                              /* push eax */
            ii(0x1010_663f, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1010_6653, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ii(0x1010_6656, 5); add(eax, 0xac);                         /* add eax, 0xac */
            ii(0x1010_665b, 3); mov(memd[ss, ebp - 0x14], eax);         /* mov [ebp-0x14], eax */
            ii(0x1010_665e, 3); mov(eax, memd[ss, ebp - 0xc]);          /* mov eax, [ebp-0xc] */
            ...
            ii(0x1010_666f, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1010_6676, 5); jmp(0x1010_670b, 0x90); goto l_0x1010_670b; /* jmp 0x1010670b */
        l_0x1010_667b:
            ii(0x1010_667b, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1010_667e, 5); call(/* sys */ 0x1017_90ce, 0x7_2a4b);  /* call 0x101790ce */
            ii(0x1010_6683, 2); mov(edx, eax);                          /* mov edx, eax */
            ii(0x1010_6685, 3); mov(eax, memd[ss, ebp - 0x4]);          /* mov eax, [ebp-0x4] */
            ii(0x1010_6688, 3); mov(memw[ds, eax], dx);                 /* mov [eax], dx */
        l_0x1010_668b:
            ii(0x1010_668b, 3); mov(eax, memd[ss, ebp - 0x14]);         /* mov eax, [ebp-0x14] */
            ii(0x1010_668e, 3); inc(memd[ss, ebp - 0x14]);              /* inc dword [ebp-0x14] */
            ...
            ii(0x1010_6696, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_6699, 5); mov(memw[ds, eax], 0);                  /* mov word [eax], 0x0 */
        l_0x1010_669e:
            ii(0x1010_669e, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1010_66a9, 3); mov(edx, memd[ss, ebp - 0x14]);         /* mov edx, [ebp-0x14] */
            ii(0x1010_66ac, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1010_66c2, 2); if(jnz(0x1010_66c6, 0x2)) goto l_0x1010_66c6; /* jnz 0x101066c6 */
        l_0x1010_66c4:
            ii(0x1010_66c4, 2); jmp(0x1010_66ce, 0x8); goto l_0x1010_66ce; /* jmp 0x101066ce */
        l_0x1010_66c6:
            ii(0x1010_66c6, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_66c9, 3); inc(memw[ds, eax]);                     /* inc word [eax] */
            ii(0x1010_66cc, 2); jmp(0x1010_669e, -0x30); goto l_0x1010_669e; /* jmp 0x1010669e */
        l_0x1010_66ce:
            ii(0x1010_66ce, 3); mov(eax, memd[ss, ebp - 0x8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_66d1, 3); movsx(eax, memw[ds, eax]);              /* movsx eax, word [eax] */
            ii(0x1010_66d4, 3); cmp(eax, 0xd);                          /* cmp eax, 0xd */
            ii(0x1010_66d7, 2); if(jae(0x1010_66e2, 0x9)) goto l_0x1010_66e2; /* jae 0x101066e2 */
            ii(0x1010_66d9, 7); mov(memd[ss, ebp - 0x18], 0);           /* mov dword [ebp-0x18], 0x0 */
        ...
        l_0x1010_66e2:
            ...
            ii(0x1010_66f8, 3); mov(memd[ss, ebp - 0x18], eax);         /* mov [ebp-0x18], eax */
        l_0x1010_66fb:
            ii(0x1010_66fb, 7); mov(memd[ss, ebp - 0x10], 0x1);         /* mov dword [ebp-0x10], 0x1 */
            ii(0x1010_6702, 2); jmp(0x1010_670b, 0x7); goto l_0x1010_670b; /* jmp 0x1010670b */
        l_0x1010_6704:
            ii(0x1010_6704, 7); mov(memd[ss, ebp - 0x10], 0);           /* mov dword [ebp-0x10], 0x0 */
        l_0x1010_670b:
            ii(0x1010_670b, 3); mov(eax, memd[ss, ebp - 0x10]);         /* mov eax, [ebp-0x10] */
