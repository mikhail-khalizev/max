...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_5034()
        {
            ...
            ii(0x1007_504b, 3); mov(memd[ss, ebp - 8], eax);            /* mov [ebp-0x8], eax */
            ii(0x1007_504e, 3); mov(memd[ss, ebp - 4], edx);            /* mov [ebp-0x4], edx */
            ii(0x1007_5051, 4); movsx(eax, memw[ss, ebp - 8]);          /* movsx eax, word [ebp-0x8] */
            ii(0x1007_5055, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1007_5057, 2); if(jl(0x1007_5065, 0xc)) goto l_0x1007_5065; /* jl 0x10075065 */
            ii(0x1007_5059, 3); mov(eax, memd[ss, ebp - 8]);            /* mov eax, [ebp-0x8] */
            ii(0x1007_505c, 7); cmp(ax, memw[ds, 0x101c_8172]);         /* cmp ax, [0x101c8172] */
            ii(0x1007_5063, 2); if(jl(0x1007_5067, 2)) goto l_0x1007_5067; /* jl 0x10075067 */
        l_0x1007_5065:
            ii(0x1007_5065, 2); jmp(0x1007_506f, 8); goto l_0x1007_506f; /* jmp 0x1007506f */
        l_0x1007_5067:
            ii(0x1007_5067, 4); movsx(eax, memw[ss, ebp - 4]);          /* movsx eax, word [ebp-0x4] */
            ii(0x1007_506b, 2); test(eax, eax);                         /* test eax, eax */
            ii(0x1007_506d, 2); if(jge(0x1007_5071, 2)) goto l_0x1007_5071; /* jge 0x10075071 */
        l_0x1007_506f:
            ii(0x1007_506f, 2); jmp(0x1007_507d, 0xc); goto l_0x1007_507d; /* jmp 0x1007507d */
        l_0x1007_5071:
            ii(0x1007_5071, 3); mov(eax, memd[ss, ebp - 4]);            /* mov eax, [ebp-0x4] */
        ...
        l_0x1007_507d:
            ii(0x1007_507d, 7); mov(memd[ss, ebp - 12], 0);             /* mov dword [ebp-0xc], 0x0 */
            ii(0x1007_5084, 5); jmp(0x1007_5100, 0x77); goto l_0x1007_5100; /* jmp 0x10075100 */
        l_0x1007_5089:
            ii(0x1007_5089, 4); movsx(ebx, memw[ss, ebp - 4]);          /* movsx ebx, word [ebp-0x4] */
            ii(0x1007_508d, 4); movsx(edx, memw[ss, ebp - 8]);          /* movsx edx, word [ebp-0x8] */
            ...
            ii(0x1007_509d, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x1007_50a0, 5); call(0x1007_64b8, 0x1413);              /* call 0x100764b8 */
        l_0x1007_50a5:
            ii(0x1007_50a5, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_50a7, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ...
            ii(0x1007_50b3, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x1007_50b6, 5); call(0x1007_63a0, 0x12e5);              /* call 0x100763a0 */
            ii(0x1007_50bb, 5); cmp(memw[ds, eax + 8], 0x27);           /* cmp word [eax+0x8], 0x27 */
            ii(0x1007_50c0, 2); if(jnz(0x1007_50d9, 0x17)) goto l_0x1007_50d9; /* jnz 0x100750d9 */
            ii(0x1007_50c2, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
            ii(0x1007_50c5, 5); call(0x1007_6408, 0x133e);              /* call 0x10076408 */
            ii(0x1007_50ca, 3); mov(memd[ss, ebp - 12], eax);           /* mov [ebp-0xc], eax */
            ii(0x1007_50cd, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_50cf, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
        ...
        l_0x1007_50d9:
            ii(0x1007_50d9, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
        ...
        l_0x1007_50e3:
            ii(0x1007_50e3, 7); mov(memd[ss, ebp - 12], 0);             /* mov dword [ebp-0xc], 0x0 */
            ii(0x1007_50ea, 2); xor(edx, edx);                          /* xor edx, edx */
            ii(0x1007_50ec, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
        ...
        //  ii(0x1007_50f8, 3); lea(eax, memd[ss, ebp - 16]);           /* lea eax, [ebp-0x10] */
        //  ii(0x1007_50fb, 5); call(0x1007_5f6c, 0xe6c);               /* call 0x10075f6c */
        l_0x1007_5100:
            ii(0x1007_5100, 3); mov(eax, memd[ss, ebp - 12]);           /* mov eax, [ebp-0xc] */
