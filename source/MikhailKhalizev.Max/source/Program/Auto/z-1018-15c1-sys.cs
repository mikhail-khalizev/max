...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_15c1()
        {
            ...
            ii(0x1018_15c5, 4);  mov(memb[ds, edx + 20], 0);           /* mov byte [edx+0x14], 0x0 */
        l_0x1018_15c9:
            ...
            ii(0x1018_15d0, 2);  if(jnz(0x1018_15d8, 6)) goto l_0x1018_15d8;/* jnz 0x101815d8 */
            ii(0x1018_15d2, 4);  or(memb[ds, edx + 20], 8);            /* or byte [edx+0x14], 0x8 */
            ii(0x1018_15d6, 2);  jmp(0x1018_1618, 0x40); goto l_0x1018_1618;/* jmp 0x10181618 */
        l_0x1018_15d8:
            ii(0x1018_15d8, 3);  cmp(eax, 0x23);                       /* cmp eax, 0x23 */
            ii(0x1018_15db, 2);  if(jnz(0x1018_15e3, 6)) goto l_0x1018_15e3;/* jnz 0x101815e3 */
            ii(0x1018_15dd, 4);  or(memb[ds, edx + 20], 1);            /* or byte [edx+0x14], 0x1 */
        ...
        l_0x1018_15e3:
            ...
            ii(0x1018_15e8, 3);  mov(cl, memb[ds, edx + 20]);          /* mov cl, [edx+0x14] */
            ii(0x1018_15eb, 3);  or(cl, 4);                            /* or cl, 0x4 */
            ii(0x1018_15ee, 2);  mov(ch, cl);                          /* mov ch, cl */
            ii(0x1018_15f0, 3);  and(ch, 0xfd);                        /* and ch, 0xfd */
            ii(0x1018_15f3, 3);  mov(memb[ds, edx + 20], ch);          /* mov [edx+0x14], ch */
        ...
        l_0x1018_15f8:
            ...
            ii(0x1018_15fd, 3);  mov(al, memb[ds, edx + 20]);          /* mov al, [edx+0x14] */
            ii(0x1018_1600, 2);  and(al, 4);                           /* and al, 0x4 */
            ii(0x1018_1602, 5);  and(eax, 0xff);                       /* and eax, 0xff */
            ii(0x1018_1607, 2);  if(jnz(0x1018_1618, 0xf)) goto l_0x1018_1618;/* jnz 0x10181618 */
            ii(0x1018_1609, 4);  or(memb[ds, edx + 20], 2);            /* or byte [edx+0x14], 0x2 */
            ii(0x1018_160d, 2);  jmp(0x1018_1618, 9); goto l_0x1018_1618;/* jmp 0x10181618 */
        l_0x1018_160f:
            ii(0x1018_160f, 3);  cmp(eax, 0x30);                       /* cmp eax, 0x30 */
            ii(0x1018_1612, 2);  if(jnz(0x1018_161b, 7)) goto l_0x1018_161b;/* jnz 0x1018161b */
            ii(0x1018_1614, 4);  mov(memb[ds, edx + 22], 0x30);        /* mov byte [edx+0x16], 0x30 */
        l_0x1018_1618:
