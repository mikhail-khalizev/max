...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ sys_printf()
        {
            ...
            ii(0x1016_c63e, 3);  sub(esp, 4);                          /* sub esp, 0x4 */
            ii(0x1016_c641, 4);  lea(eax, memd[ss, esp + 20]);         /* lea eax, [esp+0x14] */
            ii(0x1016_c645, 2);  mov(ebx, esp);                        /* mov ebx, esp */
            ii(0x1016_c647, 4);  mov(edx, memd[ss, esp + 16]);         /* mov edx, [esp+0x10] */
            ...
            ii(0x1016_c658, 3);  add(esp, 4);                          /* add esp, 0x4 */
