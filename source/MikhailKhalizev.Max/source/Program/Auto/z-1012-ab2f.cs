...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_ab2f()
        {
            ...
            ii(0x1012_ab53, 4);  mov(ax, memw[ds, eax + 12]);          /* mov ax, [eax+0xc] */
            ...
            ii(0x1012_ab72, 4);  mov(dx, memw[ds, eax + 20]);          /* mov dx, [eax+0x14] */
            ...
            ii(0x1012_ab83, 3);  mov(dl, memb[ds, eax + 17]);          /* mov dl, [eax+0x11] */
            ...
            ii(0x1012_ab92, 3);  mov(al, memb[ds, eax + 11]);          /* mov al, [eax+0xb] */
        ...
        l_0x1012_aba9:
            ...
            ii(0x1012_abb7, 6);  lea(edx, memd[ds, eax + 538]);        /* lea edx, [eax+0x21a] */
