...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_7f88()
        {
            ...
            ii(0x1014_7f9a, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1014_7fa0, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_7fa3, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_7fa6, 3);  add(eax, 6);                          /* add eax, 0x6 */
            ii(0x1014_7fa9, 5);  call(Definitions.my_strobj_c_str_v2, -0xb_e7e6);/* call 0x100897c8 */
            ii(0x1014_7fae, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_7fb1, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
