...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_8d74()
        {
            ...
            ii(0x1013_8d8a, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1013_8d8d, 3);  mov(memd[ss, ebp - 8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1013_8d90, 3);  mov(memd[ss, ebp - 4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1013_8d93, 7);  mov(memd[ss, ebp - 16], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1013_8d9a, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_8d9d, 3);  dec(memd[ss, ebp - 8]);               /* dec dword [ebp-0x8] */
            ii(0x1013_8da0, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1013_8da4, 3);  cmp(eax, 1);                          /* cmp eax, 0x1 */
            ii(0x1013_8da7, 2);  if(jnz(0x1013_8dbb, 0x12)) goto l_0x1013_8dbb;/* jnz 0x10138dbb */
            ii(0x1013_8da9, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1013_8dad, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x1013_8db0, 6);  mov(eax, memd[ds, eax + 0x101b_d36c]);/* mov eax, [eax+0x101bd36c] */
            ii(0x1013_8db6, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1013_8db9, 2);  jmp(0x1013_8e1e, 0x63); goto l_0x1013_8e1e;/* jmp 0x10138e1e */
        l_0x1013_8dbb:
            ii(0x1013_8dbb, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1013_8dbf, 3);  cmp(eax, 8);                          /* cmp eax, 0x8 */
            ii(0x1013_8dc2, 2);  if(jnz(0x1013_8dd6, 0x12)) goto l_0x1013_8dd6;/* jnz 0x10138dd6 */
            ii(0x1013_8dc4, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1013_8dc8, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x1013_8dcb, 6);  mov(eax, memd[ds, eax + 0x101b_d3a8]);/* mov eax, [eax+0x101bd3a8] */
            ii(0x1013_8dd1, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1013_8dd4, 2);  jmp(0x1013_8e1e, 0x48); goto l_0x1013_8e1e;/* jmp 0x10138e1e */
        l_0x1013_8dd6:
            ii(0x1013_8dd6, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1013_8dda, 3);  cmp(eax, 2);                          /* cmp eax, 0x2 */
            ii(0x1013_8ddd, 2);  if(jnz(0x1013_8df1, 0x12)) goto l_0x1013_8df1;/* jnz 0x10138df1 */
            ii(0x1013_8ddf, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1013_8de3, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x1013_8de6, 6);  mov(eax, memd[ds, eax + 0x101b_d408]);/* mov eax, [eax+0x101bd408] */
            ii(0x1013_8dec, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1013_8def, 2);  jmp(0x1013_8e1e, 0x2d); goto l_0x1013_8e1e;/* jmp 0x10138e1e */
        l_0x1013_8df1:
            ii(0x1013_8df1, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1013_8df5, 3);  cmp(eax, 9);                          /* cmp eax, 0x9 */
            ii(0x1013_8df8, 2);  if(jnz(0x1013_8e1e, 0x24)) goto l_0x1013_8e1e;/* jnz 0x10138e1e */
            ii(0x1013_8dfa, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1013_8e0c, 3);  lea(eax, memd[ss, ebp - 68]);         /* lea eax, [ebp-0x44] */
            ...
            ii(0x1013_8e18, 3);  lea(eax, memd[ss, ebp - 68]);         /* lea eax, [ebp-0x44] */
            ii(0x1013_8e1b, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
        l_0x1013_8e1e:
            ii(0x1013_8e1e, 4);  cmp(memd[ss, ebp - 16], 0);           /* cmp dword [ebp-0x10], 0x0 */
            ii(0x1013_8e22, 2);  if(jz(0x1013_8e32, 0xe)) goto l_0x1013_8e32;/* jz 0x10138e32 */
            ii(0x1013_8e24, 3);  mov(edx, memd[ss, ebp - 16]);         /* mov edx, [ebp-0x10] */
            ii(0x1013_8e27, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1013_8e2a, 3);  add(eax, 3);                          /* add eax, 0x3 */
