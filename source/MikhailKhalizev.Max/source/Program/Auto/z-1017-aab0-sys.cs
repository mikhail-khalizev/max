...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_aab0()
        {
            ...
            ii(0x1017_aab8, 3);  mov(memd[ss, ebp - 52], eax);         /* mov [ebp-0x34], eax */
            ii(0x1017_aabb, 2);  mov(esi, edx);                        /* mov esi, edx */
            ii(0x1017_aabd, 3);  mov(memd[ss, ebp - 64], ebx);         /* mov [ebp-0x40], ebx */
            ii(0x1017_aac0, 3);  mov(memd[ss, ebp - 48], ecx);         /* mov [ebp-0x30], ecx */
            ii(0x1017_aac3, 7);  mov(memd[ss, ebp - 68], 0x1020_9750); /* mov dword [ebp-0x44], 0x10209750 */
            ...
            ii(0x1017_aad8, 3);  mov(memd[ss, ebp - 36], eax);         /* mov [ebp-0x24], eax */
            ...
            ii(0x1017_aae7, 3);  mov(ebx, memd[ss, ebp - 52]);         /* mov ebx, [ebp-0x34] */
            ii(0x1017_aaea, 3);  mov(memd[ss, ebp - 44], eax);         /* mov [ebp-0x2c], eax */
            ...
            ii(0x1017_aafa, 3);  mov(memd[ss, ebp - 60], edx);         /* mov [ebp-0x3c], edx */
            ii(0x1017_aafd, 3);  shl(eax, 6);                          /* shl eax, 0x6 */
            ii(0x1017_ab00, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1017_ab02, 2);  sub(eax, esi);                        /* sub eax, esi */
            ii(0x1017_ab04, 3);  mov(memd[ss, ebp - 12], edx);         /* mov [ebp-0xc], edx */
            ii(0x1017_ab07, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
        l_0x1017_ab0a:
            ii(0x1017_ab0a, 4);  cmp(memd[ss, ebp - 64], 0);           /* cmp dword [ebp-0x40], 0x0 */
            ii(0x1017_ab0e, 2);  if(jle(0x1017_ab61, 0x51)) goto l_0x1017_ab61;/* jle 0x1017ab61 */
            ii(0x1017_ab10, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1017_ab13, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1017_ab15, 3);  mov(ecx, memd[ss, ebp - 36]);         /* mov ecx, [ebp-0x24] */
            ii(0x1017_ab18, 3);  sar(edx, 0x1f);                       /* sar edx, 0x1f */
            ii(0x1017_ab1b, 2);  idiv(ecx);                            /* idiv ecx */
            ii(0x1017_ab1d, 3);  mov(esi, memd[ss, ebp - 60]);         /* mov esi, [ebp-0x3c] */
            ii(0x1017_ab20, 2);  xor(ebx, ebx);                        /* xor ebx, ebx */
            ii(0x1017_ab22, 5);  mov(ecx, 0x1020_9750);                /* mov ecx, 0x10209750 */
            ii(0x1017_ab27, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x1017_ab2a, 3);  mov(eax, memd[ss, ebp - 64]);         /* mov eax, [ebp-0x40] */
        ...
        l_0x1017_ab32:
            ...
            ii(0x1017_ab34, 3);  mov(al, memb[ss, ebp - 32]);          /* mov al, [ebp-0x20] */
        ...
        l_0x1017_ab61:
            ii(0x1017_ab61, 3);  mov(eax, memd[ss, ebp - 44]);         /* mov eax, [ebp-0x2c] */
            ii(0x1017_ab64, 3);  mov(ebx, memd[ss, ebp - 60]);         /* mov ebx, [ebp-0x3c] */
            ii(0x1017_ab67, 3);  mov(ecx, memd[ss, ebp - 12]);         /* mov ecx, [ebp-0xc] */
            ii(0x1017_ab6a, 3);  mov(esi, memd[ss, ebp - 28]);         /* mov esi, [ebp-0x1c] */
            ii(0x1017_ab6d, 2);  add(ebx, eax);                        /* add ebx, eax */
            ii(0x1017_ab6f, 3);  add(ecx, 0x3f);                       /* add ecx, 0x3f */
            ii(0x1017_ab72, 3);  mov(memd[ss, ebp - 60], ebx);         /* mov [ebp-0x3c], ebx */
            ii(0x1017_ab75, 3);  mov(memd[ss, ebp - 12], ecx);         /* mov [ebp-0xc], ecx */
        ...
        l_0x1017_ab7c:
            ...
            ii(0x1017_ab8a, 3);  mov(edx, memd[ss, ebp + 12]);         /* mov edx, [ebp+0xc] */
            ii(0x1017_ab8d, 3);  mov(memd[ss, ebp - 40], eax);         /* mov [ebp-0x28], eax */
            ...
            ii(0x1017_ab9c, 3);  mov(ebx, memd[ss, ebp - 48]);         /* mov ebx, [ebp-0x30] */
            ii(0x1017_ab9f, 3);  mov(memd[ss, ebp - 72], eax);         /* mov [ebp-0x48], eax */
            ...
            ii(0x1017_abad, 3);  mov(memd[ss, ebp - 20], edx);         /* mov [ebp-0x14], edx */
            ii(0x1017_abb0, 2);  xor(eax, eax);                        /* xor eax, eax */
            ii(0x1017_abb2, 3);  mov(edx, memd[ss, ebp + 8]);          /* mov edx, [ebp+0x8] */
            ii(0x1017_abb5, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1017_abb8, 2);  mov(eax, edx);                        /* mov eax, edx */
            ii(0x1017_abba, 3);  shl(eax, 6);                          /* shl eax, 0x6 */
            ii(0x1017_abbd, 3);  mov(edi, memd[ss, ebp + 12]);         /* mov edi, [ebp+0xc] */
            ii(0x1017_abc0, 2);  sub(eax, edx);                        /* sub eax, edx */
            ii(0x1017_abc2, 1);  dec(edi);                             /* dec edi */
            ii(0x1017_abc3, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
        l_0x1017_abc6:
            ii(0x1017_abc6, 4);  cmp(memd[ss, ebp + 12], 0);           /* cmp dword [ebp+0xc], 0x0 */
            ii(0x1017_abca, 2);  if(jle(0x1017_ac19, 0x4d)) goto l_0x1017_ac19;/* jle 0x1017ac19 */
            ii(0x1017_abcc, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1017_abcf, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1017_abd1, 3);  mov(ebx, memd[ss, ebp - 40]);         /* mov ebx, [ebp-0x28] */
            ii(0x1017_abd4, 3);  sar(edx, 0x1f);                       /* sar edx, 0x1f */
            ii(0x1017_abd7, 2);  idiv(ebx);                            /* idiv ebx */
            ii(0x1017_abd9, 3);  mov(ecx, memd[ss, ebp - 68]);         /* mov ecx, [ebp-0x44] */
            ii(0x1017_abdc, 3);  add(ecx, memd[ss, ebp - 20]);         /* add ecx, [ebp-0x14] */
            ii(0x1017_abdf, 3);  mov(memd[ss, ebp - 56], eax);         /* mov [ebp-0x38], eax */
            ii(0x1017_abe2, 3);  mov(eax, memd[ss, ebp + 12]);         /* mov eax, [ebp+0xc] */
        ...
        l_0x1017_abea:
            ...
            ii(0x1017_abec, 3);  mov(al, memb[ss, ebp - 56]);          /* mov al, [ebp-0x38] */
        ...
        l_0x1017_ac19:
            ii(0x1017_ac19, 3);  mov(eax, memd[ss, ebp - 72]);         /* mov eax, [ebp-0x48] */
            ii(0x1017_ac1c, 3);  mov(edx, memd[ss, ebp - 20]);         /* mov edx, [ebp-0x14] */
            ii(0x1017_ac1f, 3);  mov(ebx, memd[ss, ebp - 16]);         /* mov ebx, [ebp-0x10] */
            ii(0x1017_ac22, 3);  mov(ecx, memd[ss, ebp - 24]);         /* mov ecx, [ebp-0x18] */
            ii(0x1017_ac25, 2);  add(edx, eax);                        /* add edx, eax */
            ii(0x1017_ac27, 3);  add(ebx, 0x3f);                       /* add ebx, 0x3f */
            ii(0x1017_ac2a, 3);  mov(memd[ss, ebp - 20], edx);         /* mov [ebp-0x14], edx */
            ii(0x1017_ac2d, 3);  mov(memd[ss, ebp - 16], ebx);         /* mov [ebp-0x10], ebx */
