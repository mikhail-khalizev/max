...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_20df()
        {
            ...
            ii(0x100c_20f4, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x100c_20f7, 3);  mov(memd[ss, ebp - 12], edx);         /* mov [ebp-0xc], edx */
            ii(0x100c_20fa, 3);  mov(memd[ss, ebp - 8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x100c_20fd, 3);  mov(memb[ss, ebp - 4], cl);           /* mov [ebp-0x4], cl */
            ii(0x100c_2100, 4);  cmp(memb[ss, ebp - 4], 0);            /* cmp byte [ebp-0x4], 0x0 */
            ii(0x100c_2104, 2);  if(jnz(0x100c_2112, 0xc)) goto l_0x100c_2112;/* jnz 0x100c2112 */
            ii(0x100c_2106, 7);  mov(memd[ss, ebp - 24], 0);           /* mov dword [ebp-0x18], 0x0 */
            ii(0x100c_210d, 5);  jmp(0x100c_21a7, 0x95); goto l_0x100c_21a7;/* jmp 0x100c21a7 */
        l_0x100c_2112:
            ii(0x100c_2112, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100c_2115, 5);  call(0x100b_906f, -0x90ab);           /* call 0x100b906f */
            ii(0x100c_211a, 3);  mov(memb[ss, ebp - 20], al);          /* mov [ebp-0x14], al */
            ii(0x100c_211d, 2);  xor(ecx, ecx);                        /* xor ecx, ecx */
            ii(0x100c_211f, 3);  mov(cl, memb[ss, ebp + 16]);          /* mov cl, [ebp+0x10] */
            ii(0x100c_2122, 4);  movsx(ebx, memb[ss, ebp - 4]);        /* movsx ebx, byte [ebp-0x4] */
            ii(0x100c_2126, 4);  movsx(edx, memb[ss, ebp - 20]);       /* movsx edx, byte [ebp-0x14] */
            ii(0x100c_212a, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100c_212d, 5);  call(0x100c_12cd, -0xe65);            /* call 0x100c12cd */
            ii(0x100c_2132, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100c_2135, 4);  cmp(memd[ss, ebp - 28], 0);           /* cmp dword [ebp-0x1c], 0x0 */
            ii(0x100c_2139, 2);  if(jnz(0x100c_2144, 9)) goto l_0x100c_2144;/* jnz 0x100c2144 */
            ii(0x100c_213b, 7);  mov(memd[ss, ebp - 24], 0);           /* mov dword [ebp-0x18], 0x0 */
            ii(0x100c_2142, 2);  jmp(0x100c_21a7, 0x63); goto l_0x100c_21a7;/* jmp 0x100c21a7 */
        l_0x100c_2144:
            ii(0x100c_2144, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ii(0x100c_2147, 3);  movsx(eax, memw[ds, edx]);            /* movsx eax, word [edx] */
            ii(0x100c_214a, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x100c_214d, 2);  mov(ebx, eax);                        /* mov ebx, eax */
            ii(0x100c_214f, 3);  mov(edx, memd[ss, ebp - 28]);         /* mov edx, [ebp-0x1c] */
            ii(0x100c_2152, 3);  mov(eax, memd[ds, edx + 8]);          /* mov eax, [edx+0x8] */
            ii(0x100c_2155, 2);  add(eax, ebx);                        /* add eax, ebx */
            ii(0x100c_2157, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x100c_2165, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100c_2168, 5);  call(0x1007_623c, -0x4_bf31);         /* call 0x1007623c */
            ii(0x100c_216d, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x100c_216f, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x100c_2172, 4);  mov(ax, memw[ds, eax + 14]);          /* mov ax, [eax+0xe] */
            ii(0x100c_2176, 4);  sub(ax, memw[ds, edx + 12]);          /* sub ax, [edx+0xc] */
            ii(0x100c_217a, 3);  mov(bx, memw[ds, ebx]);               /* mov bx, [ebx] */
            ii(0x100c_217d, 3);  imul(ebx, eax);                       /* imul ebx, eax */
            ii(0x100c_2180, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_2183, 3);  movsx(eax, memw[ds, eax]);            /* movsx eax, word [eax] */
            ii(0x100c_2186, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x100c_2189, 3);  mov(edx, memd[ss, ebp - 28]);         /* mov edx, [ebp-0x1c] */
            ii(0x100c_218c, 3);  mov(edx, memd[ds, edx + 4]);          /* mov edx, [edx+0x4] */
            ii(0x100c_218f, 2);  add(eax, edx);                        /* add eax, edx */
            ii(0x100c_2191, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ...
            ii(0x100c_21a4, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
        l_0x100c_21a7:
            ii(0x100c_21a7, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ...
            ii(0x100c_21af, 3);  ret(4);                               /* ret 0x4 */
        }
    }
}
