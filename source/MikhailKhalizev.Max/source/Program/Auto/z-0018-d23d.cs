...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_d23d()
        {
            ...
            ii(0x18_d242, 2);  push(1);                                /* push 0x1 */
            ...
            ii(0x18_d24e, 3);  mov(ax, memw[ss, bp + 8]);              /* mov ax, [bp+0x8] */
            ii(0x18_d251, 1);  dec(ax);                                /* dec ax */
            ii(0x18_d252, 3);  mov(memw[ss, bp - 6], ax);              /* mov [bp-0x6], ax */
            ii(0x18_d255, 3);  mov(ax, memw[ss, bp + 4]);              /* mov ax, [bp+0x4] */
            ii(0x18_d258, 3);  mov(dx, memw[ss, bp + 6]);              /* mov dx, [bp+0x6] */
            ii(0x18_d25b, 3);  mov(memw[ss, bp - 10], ax);             /* mov [bp-0xa], ax */
            ii(0x18_d25e, 3);  mov(memw[ss, bp - 8], dx);              /* mov [bp-0x8], dx */
            ii(0x18_d261, 4);  mov(memb[ss, bp - 2], 0x92);            /* mov byte [bp-0x2], 0x92 */
            ii(0x18_d265, 5);  mov(memw[ss, bp - 4], 0);               /* mov word [bp-0x4], 0x0 */
            ii(0x18_d26a, 4);  mov(memb[ss, bp - 1], 0);               /* mov byte [bp-0x1], 0x0 */
            ii(0x18_d26e, 3);  lea(ax, memw[ss, bp - 10]);             /* lea ax, [bp-0xa] */
