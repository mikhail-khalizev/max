...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_b3dd()
        {
            ...
            ii(0x1012_b3f4, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_b3f7, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1012_b3fa, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1012_b3fe, 6);  inc(memb[ds, eax + 0x101c_59d4]);     /* inc byte [eax+0x101c59d4] */
            ii(0x1012_b404, 4);  movsx(ebx, memw[ss, ebp - 4]);        /* movsx ebx, word [ebp-0x4] */
            ii(0x1012_b408, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1012_b40c, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1012_b40e, 6);  mov(dl, memb[ds, eax + 0x101c_59d4]); /* mov dl, [eax+0x101c59d4] */
            ii(0x1012_b414, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1012_b418, 5);  call(0x1012_b37b, -0xa2);             /* call 0x1012b37b */
            ii(0x1012_b41d, 5);  call(0x1014_82f4, 0x1_ced2);          /* call 0x101482f4 */
            ii(0x1012_b422, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1012_b425, 5);  call(0x1014_82f4, 0x1_ceca);          /* call 0x101482f4 */
            ii(0x1012_b42a, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1012_b42d, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
        l_0x1012_b431:
            ii(0x1012_b431, 4);  cmp(memb[ss, ebp - 12], 0);           /* cmp byte [ebp-0xc], 0x0 */
            ii(0x1012_b435, 2);  if(jz(0x1012_b440, 9)) goto l_0x1012_b440;/* jz 0x1012b440 */
            ii(0x1012_b437, 7);  cmp(memd[ds, 0x101c_5624], 0);        /* cmp dword [0x101c5624], 0x0 */
            ii(0x1012_b43e, 2);  if(jnz(0x1012_b445, 5)) goto l_0x1012_b445;/* jnz 0x1012b445 */
        l_0x1012_b440:
            ii(0x1012_b440, 5);  jmp(0x1012_b4ff, 0xba); goto l_0x1012_b4ff;/* jmp 0x1012b4ff */
        l_0x1012_b445:
            ii(0x1012_b445, 5);  mov(eax, 1);                          /* mov eax, 0x1 */
            ii(0x1012_b44a, 5);  call(0x1012_8835, -0x2c1a);           /* call 0x10128835 */
            ii(0x1012_b44f, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ...
            ii(0x1012_b45e, 4);  movsx(ebx, memw[ss, ebp - 4]);        /* movsx ebx, word [ebp-0x4] */
            ii(0x1012_b462, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1012_b466, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1012_b468, 6);  mov(dl, memb[ds, eax + 0x101c_59d4]); /* mov dl, [eax+0x101c59d4] */
            ii(0x1012_b46e, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1012_b472, 5);  call(0x1012_b37b, -0xfc);             /* call 0x1012b37b */
            ii(0x1012_b477, 5);  call(0x1014_82f4, 0x1_ce78);          /* call 0x101482f4 */
            ii(0x1012_b47c, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
        l_0x1012_b47f:
            ii(0x1012_b47f, 4);  mov(memb[ss, ebp - 12], 0);           /* mov byte [ebp-0xc], 0x0 */
            ii(0x1012_b483, 7);  mov(memd[ss, ebp - 28], 4);           /* mov dword [ebp-0x1c], 0x4 */
        l_0x1012_b48a:
            ii(0x1012_b48a, 3);  dec(memd[ss, ebp - 28]);              /* dec dword [ebp-0x1c] */
            ii(0x1012_b48d, 5);  cmp(memw[ss, ebp - 28], -1 /* 0xff */);/* cmp word [ebp-0x1c], 0xffff */
            ii(0x1012_b492, 2);  if(jz(0x1012_b4ec, 0x58)) goto l_0x1012_b4ec;/* jz 0x1012b4ec */
            ii(0x1012_b494, 4);  movsx(eax, memw[ss, ebp - 28]);       /* movsx eax, word [ebp-0x1c] */
            ...
            ii(0x1012_b4a9, 3);  cmp(eax, 3);                          /* cmp eax, 0x3 */
            ii(0x1012_b4ac, 2);  if(jnz(0x1012_b4ea, 0x3c)) goto l_0x1012_b4ea;/* jnz 0x1012b4ea */
            ii(0x1012_b4ae, 4);  movsx(edx, memw[ss, ebp - 28]);       /* movsx edx, word [ebp-0x1c] */
            ii(0x1012_b4b2, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x1012_b4c4, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
            ii(0x1012_b4c8, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ...
            ii(0x1012_b4d7, 5);  mov(ebx, 4);                          /* mov ebx, 0x4 */
            ii(0x1012_b4dc, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x1012_b4e1, 4);  movsx(eax, memw[ss, ebp - 28]);       /* movsx eax, word [ebp-0x1c] */
        ...
        l_0x1012_b4ec:
            ...
            ii(0x1012_b4f4, 2);  if(jnz(0x1012_b4fa, 4)) goto l_0x1012_b4fa;/* jnz 0x1012b4fa */
            ii(0x1012_b4f6, 4);  mov(memb[ss, ebp - 12], 0);           /* mov byte [ebp-0xc], 0x0 */
        l_0x1012_b4fa:
            ii(0x1012_b4fa, 5);  jmp(0x1012_b431, -0xce); goto l_0x1012_b431;/* jmp 0x1012b431 */
        l_0x1012_b4ff:
            ii(0x1012_b4ff, 7);  mov(memd[ss, ebp - 16], 4);           /* mov dword [ebp-0x10], 0x4 */
        l_0x1012_b506:
            ii(0x1012_b506, 3);  dec(memd[ss, ebp - 16]);              /* dec dword [ebp-0x10] */
            ii(0x1012_b509, 5);  cmp(memw[ss, ebp - 16], -1 /* 0xff */);/* cmp word [ebp-0x10], 0xffff */
            ii(0x1012_b50e, 2);  if(jz(0x1012_b553, 0x43)) goto l_0x1012_b553;/* jz 0x1012b553 */
            ii(0x1012_b510, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x1012_b525, 3);  cmp(eax, 3);                          /* cmp eax, 0x3 */
            ii(0x1012_b528, 2);  if(jnz(0x1012_b551, 0x27)) goto l_0x1012_b551;/* jnz 0x1012b551 */
            ii(0x1012_b52a, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1012_b52e, 2);  add(eax, eax);                        /* add eax, eax */
            ii(0x1012_b530, 7);  mov(ax, memw[ds, eax + 0x101c_59e4]); /* mov ax, [eax+0x101c59e4] */
            ii(0x1012_b537, 4);  cmp(ax, memw[ss, ebp - 4]);           /* cmp ax, [ebp-0x4] */
            ii(0x1012_b53b, 2);  if(jz(0x1012_b546, 9)) goto l_0x1012_b546;/* jz 0x1012b546 */
            ii(0x1012_b53d, 7);  cmp(memd[ds, 0x101c_5624], 0);        /* cmp dword [0x101c5624], 0x0 */
            ii(0x1012_b544, 2);  if(jnz(0x1012_b548, 2)) goto l_0x1012_b548;/* jnz 0x1012b548 */
        l_0x1012_b546:
            ii(0x1012_b546, 2);  jmp(0x1012_b551, 9); goto l_0x1012_b551;/* jmp 0x1012b551 */
        l_0x1012_b548:
            ii(0x1012_b548, 7);  mov(memd[ss, ebp - 32], 0);           /* mov dword [ebp-0x20], 0x0 */
            ii(0x1012_b54f, 2);  jmp(0x1012_b55a, 9); goto l_0x1012_b55a;/* jmp 0x1012b55a */
        l_0x1012_b551:
            ii(0x1012_b551, 2);  jmp(0x1012_b506, -0x4d); goto l_0x1012_b506;/* jmp 0x1012b506 */
        l_0x1012_b553:
            ii(0x1012_b553, 7);  mov(memd[ss, ebp - 32], 1);           /* mov dword [ebp-0x20], 0x1 */
        l_0x1012_b55a:
            ii(0x1012_b55a, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
