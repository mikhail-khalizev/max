...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x6907:
            ...
            ii(0x691a, 4);  shl(edi, 6);                               /* shl edi, 0x6 */
            ii(0x691e, 4);  mov(edx, memd[ss, bp + 6]);                /* mov edx, [bp+0x6] */
            ii(0x6922, 3);  cmp(edi, edx);                             /* cmp edi, edx */
            ii(0x6925, 2);  if(ja(0x692a, 3)) goto l_0x692a;           /* ja 0x692a */
        ...
        l_0x694e:
            ...
            ii(0x6958, 3);  test(dh, 4);                               /* test dh, 0x4 */
        ...
        l_0x696e:
            ...
            ii(0x6973, 2);  if(jz(0x697a, 5)) goto l_0x697a;           /* jz 0x697a */
        ...
        l_0x697a:
            ...
            ii(0x6980, 3);  mov(memw[ss, bp - 4], ax);                 /* mov [bp-0x4], ax */
            ii(0x6983, 2);  if(jz(0x698b, 6)) goto l_0x698b;           /* jz 0x698b */
