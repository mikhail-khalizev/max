...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_9b20()
        {
            ...
            ii(0x1015_9b37, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_9b3a, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1015_9b3d, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_9b40, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1015_9b43, 5);  mov(eax, 1);                          /* mov eax, 0x1 */
            ii(0x1015_9b48, 5);  call(0x100f_448c, -0x6_56c1);         /* call 0x100f448c */
            ii(0x1015_9b4d, 5);  call(0x100f_fc13, -0x5_9f3f);         /* call 0x100ffc13 */
            ii(0x1015_9b52, 4);  or(memb[ss, ebp - 12], 1);            /* or byte [ebp-0xc], 0x1 */
            ii(0x1015_9b56, 3);  mov(edx, memd[ss, ebp - 20]);         /* mov edx, [ebp-0x14] */
            ii(0x1015_9b59, 3);  lea(eax, memd[ss, ebp - 128]);        /* lea eax, [ebp-0x80] */
            ii(0x1015_9b5c, 5);  call(0x100e_1f02, -0x7_7c5f);         /* call 0x100e1f02 */
            ii(0x1015_9b61, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1015_9b64, 4);  and(memb[ss, ebp - 12], -2 /* 0xfe */);/* and byte [ebp-0xc], 0xfe */
            ii(0x1015_9b68, 3);  lea(eax, memd[ss, ebp - 128]);        /* lea eax, [ebp-0x80] */
            ii(0x1015_9b6b, 5);  call(0x100e_2dc1, -0x7_6daf);         /* call 0x100e2dc1 */
            ii(0x1015_9b70, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1015_9b72, 3);  lea(eax, memd[ss, ebp - 128]);        /* lea eax, [ebp-0x80] */
