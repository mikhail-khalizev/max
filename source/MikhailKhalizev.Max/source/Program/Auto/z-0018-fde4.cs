...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_fde4()
        {
            ...
            ii(0x18_fdf4, 5);  lea(ebp, memd_a32[ss, ebp + 14]);       /* lea ebp, [ebp+0xe] */
            ii(0x18_fdf9, 5);  movzx(esi, memw[ss, bp + 8]);           /* movzx esi, word [bp+0x8] */
            ii(0x18_fdfe, 3);  mov(memw[ds, si + 6], es);              /* mov [si+0x6], es */
            ii(0x18_fe01, 3);  mov(memw[ds, si + 8], fs);              /* mov [si+0x8], fs */
            ii(0x18_fe04, 3);  mov(memw[ds, si + 10], gs);             /* mov [si+0xa], gs */
            ii(0x18_fe07, 4);  mov(memd[ds, si + 28], ebx);            /* mov [si+0x1c], ebx */
            ii(0x18_fe0b, 4);  mov(memd[ds, si + 36], ecx);            /* mov [si+0x24], ecx */
            ii(0x18_fe0f, 4);  mov(memd[ds, si + 32], edx);            /* mov [si+0x20], edx */
            ii(0x18_fe13, 4);  mov(memd[ds, si + 12], edi);            /* mov [si+0xc], edi */
            ii(0x18_fe17, 4);  xchg(memd[ds, si + 40], eax);           /* xchg [si+0x28], eax */
            ii(0x18_fe1b, 3);  cmp(ah, 9);                             /* cmp ah, 0x9 */
            ii(0x18_fe1e, 4);  if(jnz(0x18_fe48, 0x26)) goto l_0x18_fe48;/* jnz 0xfe48 */
            ii(0x18_fe22, 4);  cmp(memw[ds, si + 44], 0x31);           /* cmp word [si+0x2c], 0x31 */
            ...
            ii(0x18_fe42, 2);  shl(al, 1);                             /* shl al, 1 */
            ii(0x18_fe44, 2);  or(bh, al);                             /* or bh, al */
            ii(0x18_fe46, 2);  push(ebx);                              /* push ebx */
        l_0x18_fe48:
            ii(0x18_fe48, 2);  pop(ebx);                               /* pop ebx */
            ii(0x18_fe4a, 3);  mov(al, memb[ds, si + 59]);             /* mov al, [si+0x3b] */
            ii(0x18_fe4d, 2);  and(al, 5);                             /* and al, 0x5 */
            ii(0x18_fe4f, 2);  or(bh, al);                             /* or bh, al */
            ii(0x18_fe51, 4);  mov(memd[ds, si + 58], ebx);            /* mov [si+0x3a], ebx */
            ii(0x18_fe55, 3);  pop(memw[ds, si + 4]);                  /* pop word [si+0x4] */
            ii(0x18_fe58, 4);  pop(memd[ds, si + 20]);                 /* pop dword [si+0x14] */
            ii(0x18_fe5c, 4);  pop(memd[ds, si + 16]);                 /* pop dword [si+0x10] */
