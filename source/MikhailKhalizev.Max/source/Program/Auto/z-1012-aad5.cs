...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_aad5()
        {
            ...
            ii(0x1012_aaeb, 3);  mov(memb[ss, ebp - 4], al);           /* mov [ebp-0x4], al */
            ii(0x1012_aaee, 3);  mov(memd[ss, ebp - 12], edx);         /* mov [ebp-0xc], edx */
            ii(0x1012_aaf1, 3);  mov(memd[ss, ebp - 8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1012_aaf4, 3);  mov(al, memb[ss, ebp - 4]);           /* mov al, [ebp-0x4] */
            ii(0x1012_aaf7, 5);  mov(memb[ds, 0x101c_5c1c], al);       /* mov [0x101c5c1c], al */
            ii(0x1012_aafc, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1012_aaff, 6);  mov(memw[ds, 0x101c_5c1d], ax);       /* mov [0x101c5c1d], ax */
            ii(0x1012_ab05, 9);  mov(memw[ds, 0x101c_5c1f], 6);        /* mov word [0x101c5c1f], 0x6 */
            ii(0x1012_ab0e, 7);  mov(memd[ss, ebp - 16], 0x101c_5c21); /* mov dword [ebp-0x10], 0x101c5c21 */
            ii(0x1012_ab15, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_ab18, 3);  mov(edx, memd[ss, ebp - 16]);         /* mov edx, [ebp-0x10] */
            ii(0x1012_ab1b, 3);  mov(memw[ds, edx], ax);               /* mov [edx], ax */
            ii(0x1012_ab1e, 5);  mov(eax, 5);                          /* mov eax, 0x5 */
