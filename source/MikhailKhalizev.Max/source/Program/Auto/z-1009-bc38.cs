...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_bc38()
        {
            ...
            ii(0x1009_bc4f, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_bc52, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1009_bc55, 7);  test(memd[ss, ebp - 4], 4);           /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x1009_bc63, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1009_bc72:
            ii(0x1009_bc72, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x1009_bc77, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_bc7a, 5);  call(0x1009_b998, -0x2e7);            /* call 0x1009b998 */
            ii(0x1009_bc7f, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_bc82, 7);  test(memd[ss, ebp - 4], 2);           /* test dword [ebp-0x4], 0x2 */
            ii(0x1009_bc89, 2);  if(jz(0x1009_bc93, 8)) goto l_0x1009_bc93;/* jz 0x1009bc93 */
            ii(0x1009_bc8b, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_bc8e, 5);  call(Definitions.sys_delete, 0xc_a2d1);/* call 0x10165f64 */
        l_0x1009_bc93:
            ii(0x1009_bc93, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_bc96, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1009_bc99, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
