...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_5aa9()
        {
            ...
            ii(0x1011_5abe, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1011_5ac1, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1011_5ac4, 3);  mov(memd[ss, ebp - 12], ebx);         /* mov [ebp-0xc], ebx */
            ii(0x1011_5ac7, 3);  mov(memd[ss, ebp - 8], ecx);          /* mov [ebp-0x8], ecx */
            ii(0x1011_5aca, 7);  mov(memd[ss, ebp - 20], 0);           /* mov dword [ebp-0x14], 0x0 */
            ...
            ii(0x1011_5ae8, 5);  cmp(memw[ss, ebp + 24], 0);           /* cmp word [ebp+0x18], 0x0 */
            ii(0x1011_5aed, 2);  if(jz(0x1011_5af8, 9)) goto l_0x1011_5af8;/* jz 0x10115af8 */
            ii(0x1011_5aef, 7);  mov(memd[ss, ebp - 24], 0x4_0000);    /* mov dword [ebp-0x18], 0x40000 */
            ii(0x1011_5af6, 2);  jmp(0x1011_5aff, 7); goto l_0x1011_5aff;/* jmp 0x10115aff */
        l_0x1011_5af8:
            ii(0x1011_5af8, 7);  mov(memd[ss, ebp - 24], 0);           /* mov dword [ebp-0x18], 0x0 */
        l_0x1011_5aff:
            ii(0x1011_5aff, 4);  movsx(eax, memw[ss, ebp + 20]);       /* movsx eax, word [ebp+0x14] */
            ii(0x1011_5b03, 5);  add(eax, 0x1_0000);                   /* add eax, 0x10000 */
            ii(0x1011_5b08, 3);  mov(edx, memd[ss, ebp - 24]);         /* mov edx, [ebp-0x18] */
            ii(0x1011_5b0b, 2);  add(edx, eax);                        /* add edx, eax */
            ii(0x1011_5b0d, 3);  mov(memd[ss, ebp - 28], edx);         /* mov [ebp-0x1c], edx */
        l_0x1011_5b10:
            ii(0x1011_5b10, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ...
            ii(0x1011_5b1c, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ii(0x1011_5b20, 3);  add(edx, memd[ss, ebp + 16]);         /* add edx, [ebp+0x10] */
            ii(0x1011_5b23, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1011_5b26, 3);  add(eax, memd[ss, ebp - 12]);         /* add eax, [ebp-0xc] */
            ...
            ii(0x1011_5b3c, 4);  movsx(eax, memw[ss, ebp - 20]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1011_5b40, 3);  add(eax, memd[ss, ebp + 16]);         /* add eax, [ebp+0x10] */
            ii(0x1011_5b43, 5);  call(Definitions.sys_strlen, 0x5_c37f);/* call 0x10171ec7 */
            ii(0x1011_5b48, 1);  inc(eax);                             /* inc eax */
            ii(0x1011_5b49, 3);  add(memd[ss, ebp - 20], eax);         /* add [ebp-0x14], eax */
            ii(0x1011_5b4c, 4);  movsx(eax, memw[ss, ebp - 20]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1011_5b50, 3);  add(eax, memd[ss, ebp + 16]);         /* add eax, [ebp+0x10] */
