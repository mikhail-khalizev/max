...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_acc7()
        {
            ...
            ii(0x1009_acd9, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1009_acdf, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_ace2, 4);  mov(memb[ss, ebp - 8], 0x22);         /* mov byte [ebp-0x8], 0x22 */
            ii(0x1009_ace6, 3);  mov(al, memb[ss, ebp - 8]);           /* mov al, [ebp-0x8] */
