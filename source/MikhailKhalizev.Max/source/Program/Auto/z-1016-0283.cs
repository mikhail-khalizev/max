...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1016_0283()
        {
            ...
            ii(0x1016_02b1, 4);  cmp(memb[ds, eax + 62], 0);           /* cmp byte [eax+0x3e], 0x0 */
            ...
            ii(0x1016_02ca, 4);  mov(memb[ds, eax + 62], 5);           /* mov byte [eax+0x3e], 0x5 */
            ...
            ii(0x1016_02da, 4);  test(memb[ds, eax + 18], 0x40);       /* test byte [eax+0x12], 0x40 */
        ...
        l_0x1016_02f3:
            ...
            ii(0x1016_02f6, 4);  cmp(memb[ds, eax + 62], 5);           /* cmp byte [eax+0x3e], 0x5 */
            ii(0x1016_02fa, 2);  if(jnz(0x1016_0305, 9)) goto l_0x1016_0305;/* jnz 0x10160305 */
            ii(0x1016_02fc, 7);  mov(memd[ss, ebp - 12], 1);           /* mov dword [ebp-0xc], 0x1 */
            ii(0x1016_0303, 2);  jmp(0x1016_030c, 7); goto l_0x1016_030c;/* jmp 0x1016030c */
        l_0x1016_0305:
            ii(0x1016_0305, 7);  mov(memd[ss, ebp - 12], 0);           /* mov dword [ebp-0xc], 0x0 */
        l_0x1016_030c:
            ii(0x1016_030c, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
