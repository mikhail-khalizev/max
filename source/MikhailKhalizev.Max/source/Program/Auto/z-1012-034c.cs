...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_034c()
        {
            ...
            ii(0x1012_0363, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_0366, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1012_0369, 7);  test(memd[ss, ebp - 4], 4);           /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x1012_0377, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1012_0386:
            ii(0x1012_0386, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x1012_038b, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_038e, 5);  call(0x1012_02cc, -0xc7);             /* call 0x101202cc */
            ii(0x1012_0393, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_0396, 7);  test(memd[ss, ebp - 4], 2);           /* test dword [ebp-0x4], 0x2 */
            ii(0x1012_039d, 2);  if(jz(0x1012_03a7, 8)) goto l_0x1012_03a7;/* jz 0x101203a7 */
            ii(0x1012_039f, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_03a2, 5);  call(Definitions.sys_delete, 0x4_5bbd);/* call 0x10165f64 */
        l_0x1012_03a7:
            ii(0x1012_03a7, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1012_03aa, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1012_03ad, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
