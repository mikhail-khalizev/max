...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_adf8()
        {
            ...
            ii(0x1008_ae0a, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1008_ae10, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_ae13, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_ae16, 5);  call(0x1007_6c30, -0x1_41eb);         /* call 0x10076c30 */
            ii(0x1008_ae1b, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_ae1e, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
