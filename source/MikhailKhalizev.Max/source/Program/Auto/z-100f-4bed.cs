...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x100f_4c40:
            ...
            ii(0x100f_4c58, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100f_4c5b, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_4c5f, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ...
            ii(0x100f_4c7d, 3);  lea(eax, memd[ss, ebp - 104]);        /* lea eax, [ebp-0x68] */
            ...
            ii(0x100f_4c8e, 3);  lea(eax, memd[ss, ebp - 104]);        /* lea eax, [ebp-0x68] */
            ii(0x100f_4c91, 5);  call(Definitions.my_fopen, -0x5877);  /* call 0x100ef41f */
            ii(0x100f_4c96, 3);  mov(memd[ss, ebp - 108], eax);        /* mov [ebp-0x6c], eax */
            ii(0x100f_4c99, 4);  cmp(memd[ss, ebp - 108], 0);          /* cmp dword [ebp-0x6c], 0x0 */
            ii(0x100f_4c9d, 6);  if(jz(0x100f_4db1, 0x10e)) goto l_0x100f_4db1;/* jz 0x100f4db1 */
            ii(0x100f_4ca3, 5);  mov(ebx, 2);                          /* mov ebx, 0x2 */
            ii(0x100f_4ca8, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100f_4caa, 3);  mov(eax, memd[ss, ebp - 108]);        /* mov eax, [ebp-0x6c] */
            ii(0x100f_4cad, 5);  call(Definitions.my_fseek, -0x585d);  /* call 0x100ef455 */
            ii(0x100f_4cb2, 3);  mov(eax, memd[ss, ebp - 108]);        /* mov eax, [ebp-0x6c] */
            ii(0x100f_4cb5, 5);  call(Definitions.sys_ftell, 0x7_da8d);/* call 0x10172747 */
            ii(0x100f_4cba, 3);  mov(memd[ss, ebp - 116], eax);        /* mov [ebp-0x74], eax */
            ii(0x100f_4cbd, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_4cc1, 3);  cmp(eax, 1);                          /* cmp eax, 0x1 */
            ...
            ii(0x100f_4cce, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x100f_4cd1, 6);  mov(eax, memd[ds, eax + 0x101b_d368]);/* mov eax, [eax+0x101bd368] */
            ii(0x100f_4cd7, 3);  mov(memd[ss, ebp - 120], eax);        /* mov [ebp-0x78], eax */
            ii(0x100f_4cda, 2);  jmp(0x100f_4d0f, 0x33); goto l_0x100f_4d0f;/* jmp 0x100f4d0f */
        l_0x100f_4cdc:
            ii(0x100f_4cdc, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_4ce0, 3);  cmp(eax, 8);                          /* cmp eax, 0x8 */
            ...
            ii(0x100f_4ced, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x100f_4cf0, 6);  mov(eax, memd[ds, eax + 0x101b_d3a4]);/* mov eax, [eax+0x101bd3a4] */
            ii(0x100f_4cf6, 3);  mov(memd[ss, ebp - 120], eax);        /* mov [ebp-0x78], eax */
        ...
        l_0x100f_4cfb:
            ...
            ii(0x100f_4d03, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x100f_4d06, 6);  mov(eax, memd[ds, eax + 0x101b_d404]);/* mov eax, [eax+0x101bd404] */
            ii(0x100f_4d0c, 3);  mov(memd[ss, ebp - 120], eax);        /* mov [ebp-0x78], eax */
        l_0x100f_4d0f:
            ii(0x100f_4d0f, 3);  mov(eax, memd[ss, ebp - 120]);        /* mov eax, [ebp-0x78] */
            ii(0x100f_4d12, 5);  call(Definitions.sys_strlen, 0x7_d1b0);/* call 0x10171ec7 */
            ii(0x100f_4d17, 5);  add(eax, 2);                          /* add eax, 0x2 */
            ii(0x100f_4d1c, 3);  mov(memd[ss, ebp - 112], eax);        /* mov [ebp-0x70], eax */
            ii(0x100f_4d1f, 4);  movsx(eax, memw[ss, ebp - 112]);      /* movsx eax, word [ebp-0x70] */
            ii(0x100f_4d23, 3);  add(eax, memd[ss, ebp - 116]);        /* add eax, [ebp-0x74] */
            ii(0x100f_4d26, 3);  add(eax, 5);                          /* add eax, 0x5 */
            ii(0x100f_4d29, 5);  call(Definitions.sys_new_arr, 0x7_12e2);/* call 0x10166010 */
            ii(0x100f_4d2e, 3);  mov(memd[ss, ebp - 124], eax);        /* mov [ebp-0x7c], eax */
            ii(0x100f_4d31, 4);  movsx(eax, memw[ss, ebp - 112]);      /* movsx eax, word [ebp-0x70] */
            ii(0x100f_4d35, 3);  add(eax, memd[ss, ebp - 116]);        /* add eax, [ebp-0x74] */
            ii(0x100f_4d38, 3);  lea(ebx, memd[ds, eax + 5]);          /* lea ebx, [eax+0x5] */
            ii(0x100f_4d3b, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100f_4d3d, 3);  mov(eax, memd[ss, ebp - 124]);        /* mov eax, [ebp-0x7c] */
            ii(0x100f_4d40, 5);  call(Definitions.sys_memset, 0x7_109b);/* call 0x10165de0 */
            ii(0x100f_4d45, 3);  mov(edx, memd[ss, ebp - 120]);        /* mov edx, [ebp-0x78] */
            ii(0x100f_4d48, 3);  mov(eax, memd[ss, ebp - 124]);        /* mov eax, [ebp-0x7c] */
            ...
            ii(0x100f_4d55, 3);  mov(eax, memd[ss, ebp - 124]);        /* mov eax, [ebp-0x7c] */
            ...
            ii(0x100f_4d61, 3);  mov(eax, memd[ss, ebp - 108]);        /* mov eax, [ebp-0x6c] */
            ii(0x100f_4d64, 5);  call(Definitions.my_fseek, -0x5914);  /* call 0x100ef455 */
            ii(0x100f_4d69, 3);  mov(ecx, memd[ss, ebp - 108]);        /* mov ecx, [ebp-0x6c] */
            ii(0x100f_4d6c, 3);  mov(ebx, memd[ss, ebp - 116]);        /* mov ebx, [ebp-0x74] */
            ii(0x100f_4d6f, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x100f_4d74, 4);  movsx(eax, memw[ss, ebp - 112]);      /* movsx eax, word [ebp-0x70] */
            ii(0x100f_4d78, 3);  add(eax, memd[ss, ebp - 124]);        /* add eax, [ebp-0x7c] */
            ...
            ii(0x100f_4d92, 5);  mov(ebx, 1);                          /* mov ebx, 0x1 */
            ii(0x100f_4d97, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100f_4d99, 3);  mov(eax, memd[ss, ebp - 124]);        /* mov eax, [ebp-0x7c] */
            ii(0x100f_4d9c, 5);  call(0x1011_5d23, 0x2_0f82);          /* call 0x10115d23 */
            ii(0x100f_4da1, 3);  mov(eax, memd[ss, ebp - 124]);        /* mov eax, [ebp-0x7c] */
            ii(0x100f_4da4, 5);  call(Definitions.sys_delete, 0x7_11bb);/* call 0x10165f64 */
            ii(0x100f_4da9, 3);  mov(eax, memd[ss, ebp - 108]);        /* mov eax, [ebp-0x6c] */
