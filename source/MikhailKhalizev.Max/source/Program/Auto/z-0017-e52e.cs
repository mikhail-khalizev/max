...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_e52e()
        {
            ...
            ii(0x17_e534, 3);  mov(si, memw[ds, bx + 8]);              /* mov si, [bx+0x8] */
            ii(0x17_e537, 3);  mov(bx, memw[ds, bx + 10]);             /* mov bx, [bx+0xa] */
        ...
        l_0x17_e53e:
            ...
            ii(0x17_e541, 2);  test(al, 1);                            /* test al, 0x1 */
            ii(0x17_e543, 2);  if(jnz(0x17_e587, 0x42)) goto l_0x17_e587;/* jnz 0xe587 */
            ii(0x17_e545, 1);  push(bx);                               /* push bx */
            ii(0x17_e546, 3);  mov(si, memw[ds, bx + 6]);              /* mov si, [bx+0x6] */
            ii(0x17_e549, 3);  mov(bx, memw[ds, bx + 8]);              /* mov bx, [bx+0x8] */
        ...
        l_0x17_e556:
            ii(0x17_e556, 3);  lea(dx, memw[ds, si - 2]);              /* lea dx, [si-0x2] */
        ...
        l_0x17_e561:
            ...
            ii(0x17_e562, 2);  test(al, 1);                            /* test al, 0x1 */
        ...
        l_0x17_e587:
            ii(0x17_e587, 3);  mov(ax, memw[ds, bx + 6]);              /* mov ax, [bx+0x6] */
            ii(0x17_e58a, 3);  mov(memw[ds, bx + 8], ax);              /* mov [bx+0x8], ax */
            ii(0x17_e58d, 1);  stc();                                  /* stc */
            ii(0x17_e58e, 2);  jmp(0x17_e5a9, 0x19); goto l_0x17_e5a9; /* jmp 0xe5a9 */
        l_0x17_e590:
            ii(0x17_e590, 1);  pop(bx);                                /* pop bx */
            ii(0x17_e591, 3);  mov(memw[ds, si - 2], cx);              /* mov [si-0x2], cx */
            ii(0x17_e594, 2);  if(jz(0x17_e59f, 9)) goto l_0x17_e59f;  /* jz 0xe59f */
        ...
        l_0x17_e59f:
            ...
            ii(0x17_e5a1, 3);  mov(memw[ds, bx + 8], di);              /* mov [bx+0x8], di */
