...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x19_1dbf, 4);  enter(6, 0);                            /* enter 0x6, 0x0 */
            ii(0x19_1dc3, 3);  mov(ax, 0x3adc);                        /* mov ax, 0x3adc */
            ii(0x19_1dc6, 3);  mov(memw[ss, bp - 4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_1dc9, 3);  mov(memw[ss, bp - 2], ds);              /* mov [bp-0x2], ds */
            ii(0x19_1dcc, 4);  cmp(memw[ss, bp + 10], 0);              /* cmp word [bp+0xa], 0x0 */
            ii(0x19_1dd0, 2);  if(jz(0x19_1de4, 0x12)) goto l_0x19_1de4;/* jz 0x1de4 */
            ii(0x19_1dd2, 3);  push(memw[ss, bp + 8]);                 /* push word [bp+0x8] */
            ii(0x19_1dd5, 1);  push(ds);                               /* push ds */
            ii(0x19_1dd6, 1);  push(ax);                               /* push ax */
            ii(0x19_1dd7, 3);  push(memw[ss, bp + 6]);                 /* push word [bp+0x6] */
            ii(0x19_1dda, 3);  push(memw[ss, bp + 4]);                 /* push word [bp+0x4] */
        ...
        l_0x19_1de4:
            ii(0x19_1de4, 3);  push(memw[ss, bp + 8]);                 /* push word [bp+0x8] */
            ii(0x19_1de7, 1);  push(ds);                               /* push ds */
            ii(0x19_1de8, 3);  push(0x3adc);                           /* push 0x3adc */
            ii(0x19_1deb, 3);  push(memw[ss, bp + 6]);                 /* push word [bp+0x6] */
            ii(0x19_1dee, 3);  push(memw[ss, bp + 4]);                 /* push word [bp+0x4] */
        ...
        l_0x19_1dfb:
            ...
            ii(0x19_1dfd, 2);  if(jl(0x19_1e08, 9)) goto l_0x19_1e08;  /* jl 0x1e08 */
            ii(0x19_1dff, 2);  cmp(al, 0x66);                          /* cmp al, 0x66 */
            ii(0x19_1e01, 2);  if(jg(0x19_1e08, 5)) goto l_0x19_1e08;  /* jg 0x1e08 */
            ii(0x19_1e03, 2);  sub(al, 0x20);                          /* sub al, 0x20 */
            ii(0x19_1e05, 3);  mov(memb[es, bx], al);                  /* mov [es:bx], al */
        l_0x19_1e08:
            ii(0x19_1e08, 3);  inc(memw[ss, bp - 4]);                  /* inc word [bp-0x4] */
        l_0x19_1e0b:
            ii(0x19_1e0b, 3);  les(bx, memw[ss, bp - 4]);              /* les bx, [bp-0x4] */
