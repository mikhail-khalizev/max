...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_a850()
        {
            ...
            ii(0x1017_a855, 3);  mov(ebx, memd[ss, ebp + 8]);          /* mov ebx, [ebp+0x8] */
            ii(0x1017_a858, 3);  mov(edx, memd[ss, ebp + 16]);         /* mov edx, [ebp+0x10] */
            ii(0x1017_a85b, 3);  mov(ecx, memd[ss, ebp + 28]);         /* mov ecx, [ebp+0x1c] */
            ii(0x1017_a85e, 3);  mov(eax, memd[ss, ebp + 32]);         /* mov eax, [ebp+0x20] */
            ...
            ii(0x1017_a875, 3);  mov(edi, memd[ss, ebp + 40]);         /* mov edi, [ebp+0x28] */
            ii(0x1017_a878, 1);  push(edi);                            /* push edi */
            ii(0x1017_a879, 3);  mov(esi, memd[ss, ebp + 36]);         /* mov esi, [ebp+0x24] */
            ii(0x1017_a87c, 1);  push(esi);                            /* push esi */
            ii(0x1017_a87d, 1);  push(eax);                            /* push eax */
            ii(0x1017_a87e, 1);  push(ecx);                            /* push ecx */
            ii(0x1017_a87f, 3);  mov(edi, memd[ss, ebp + 24]);         /* mov edi, [ebp+0x18] */
            ii(0x1017_a882, 1);  push(edi);                            /* push edi */
            ii(0x1017_a883, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ii(0x1017_a886, 1);  push(eax);                            /* push eax */
            ii(0x1017_a887, 1);  push(edx);                            /* push edx */
            ii(0x1017_a888, 3);  mov(edx, memd[ss, ebp + 12]);         /* mov edx, [ebp+0xc] */
        ...
        l_0x1017_a894:
            ...
            ii(0x1017_a896, 3);  mov(esi, memd[ss, ebp + 40]);         /* mov esi, [ebp+0x28] */
            ii(0x1017_a899, 1);  push(esi);                            /* push esi */
            ii(0x1017_a89a, 3);  mov(edi, memd[ss, ebp + 36]);         /* mov edi, [ebp+0x24] */
            ii(0x1017_a89d, 1);  push(edi);                            /* push edi */
            ii(0x1017_a89e, 1);  push(eax);                            /* push eax */
            ii(0x1017_a89f, 1);  push(ecx);                            /* push ecx */
            ii(0x1017_a8a0, 3);  mov(eax, memd[ss, ebp + 24]);         /* mov eax, [ebp+0x18] */
            ii(0x1017_a8a3, 1);  push(eax);                            /* push eax */
            ii(0x1017_a8a4, 3);  mov(ecx, memd[ss, ebp + 20]);         /* mov ecx, [ebp+0x14] */
            ii(0x1017_a8a7, 1);  push(ecx);                            /* push ecx */
            ii(0x1017_a8a8, 1);  push(edx);                            /* push edx */
            ii(0x1017_a8a9, 3);  mov(esi, memd[ss, ebp + 12]);         /* mov esi, [ebp+0xc] */
        ...
        l_0x1017_a8b3:
            ...
            ii(0x1017_a8b6, 3);  lea(esp, memd[ss, ebp - 8]);          /* lea esp, [ebp-0x8] */
