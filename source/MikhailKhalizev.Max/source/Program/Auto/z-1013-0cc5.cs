...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_0cc5()
        {
            ...
            ii(0x1013_0ce5, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1013_0ce8, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1013_0ceb, 4);  cmp(memb[ds, eax + 23], 0);           /* cmp byte [eax+0x17], 0x0 */
            ii(0x1013_0cef, 2);  if(jz(0x1013_0d05, 0x14)) goto l_0x1013_0d05;/* jz 0x10130d05 */
            ii(0x1013_0cf1, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1013_0cf4, 4);  mov(memb[ds, eax + 23], 0);           /* mov byte [eax+0x17], 0x0 */
            ii(0x1013_0cf8, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x1013_0cfd, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
