...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_aa9e()
        {
            ...
            ii(0x100f_aabd, 2);  if(jz(0x100f_aac8, 9)) goto l_0x100f_aac8;/* jz 0x100faac8 */
            ii(0x100f_aabf, 7);  cmp(memb[ds, 0x101c_3888], 0);        /* cmp byte [0x101c3888], 0x0 */
            ii(0x100f_aac6, 2);  if(jz(0x100f_aacd, 5)) goto l_0x100f_aacd;/* jz 0x100faacd */
        l_0x100f_aac8:
        ...
        l_0x100f_aacd:
            ...
            ii(0x100f_aad2, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ...
            ii(0x100f_ab07, 5);  mov(eax, 2);                          /* mov eax, 0x2 */
        ...
        l_0x100f_ab3d:
            ...
            ii(0x100f_ab58, 7);  cmp(memb[ds, 0x101c_391e], 7);        /* cmp byte [0x101c391e], 0x7 */
            ii(0x100f_ab5f, 2);  if(jz(0x100f_ab6a, 9)) goto l_0x100f_ab6a;/* jz 0x100fab6a */
            ii(0x100f_ab61, 7);  cmp(memb[ds, 0x101c_391e], 0xc);      /* cmp byte [0x101c391e], 0xc */
            ii(0x100f_ab68, 2);  if(jnz(0x100f_ab6c, 2)) goto l_0x100f_ab6c;/* jnz 0x100fab6c */
        l_0x100f_ab6a:
            ii(0x100f_ab6a, 2);  jmp(0x100f_ab75, 9); goto l_0x100f_ab75;/* jmp 0x100fab75 */
        l_0x100f_ab6c:
            ii(0x100f_ab6c, 7);  cmp(memb[ds, 0x101c_391e], 0xd);      /* cmp byte [0x101c391e], 0xd */
            ii(0x100f_ab73, 2);  if(jnz(0x100f_ab7e, 9)) goto l_0x100f_ab7e;/* jnz 0x100fab7e */
        l_0x100f_ab75:
        ...
        l_0x100f_ab7e:
            ...
            ii(0x100f_ab88, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100f_ab8b, 5);  push(0x280);                          /* push 0x280 */
            ii(0x100f_ab90, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_ab93, 3);  push(memd[ds, eax + 22]);             /* push dword [eax+0x16] */
        ...
        l_0x100f_abaa:
            ...
            ii(0x100f_ac04, 3);  mov(memd[ss, ebp - 36], eax);         /* mov [ebp-0x24], eax */
            ii(0x100f_ac07, 5);  mov(eax, memd[ds, 0x101c_389a]);      /* mov eax, [0x101c389a] */
            ii(0x100f_ac0c, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x100f_ac0f, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x100f_ac12, 3);  sub(eax, memd[ds, edx + 4]);          /* sub eax, [edx+0x4] */
            ...
            ii(0x100f_ac25, 3);  mov(memd[ss, ebp - 40], eax);         /* mov [ebp-0x28], eax */
            ii(0x100f_ac28, 4);  movsx(edx, memw[ss, ebp - 36]);       /* movsx edx, word [ebp-0x24] */
            ...
            ii(0x100f_ac3e, 4);  movsx(edx, memw[ss, ebp - 40]);       /* movsx edx, word [ebp-0x28] */
            ...
            ii(0x100f_ac54, 4);  movsx(edx, memw[ss, ebp - 36]);       /* movsx edx, word [ebp-0x24] */
            ...
            ii(0x100f_ac6a, 4);  movsx(edx, memw[ss, ebp - 40]);       /* movsx edx, word [ebp-0x28] */
            ...
            ii(0x100f_ac80, 3);  mov(edx, memd[ss, ebp - 32]);         /* mov edx, [ebp-0x20] */
            ...
            ii(0x100f_ac8d, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x100f_ac90, 3);  mov(edx, memd[ss, ebp - 28]);         /* mov edx, [ebp-0x1c] */
            ...
            ii(0x100f_ac9d, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100f_aca0, 3);  mov(edx, memd[ss, ebp - 24]);         /* mov edx, [ebp-0x18] */
            ...
            ii(0x100f_acad, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x100f_acb0, 3);  mov(edx, memd[ss, ebp - 20]);         /* mov edx, [ebp-0x14] */
            ...
            ii(0x100f_acbd, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x100f_acc0, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
        ...
        l_0x100f_accf:
            ...
            ii(0x100f_acd4, 3);  mov(memb[ss, ebp - 16], al);          /* mov [ebp-0x10], al */
            ii(0x100f_acd7, 4);  cmp(memb[ss, ebp - 16], 0);           /* cmp byte [ebp-0x10], 0x0 */
            ii(0x100f_acdb, 2);  if(jz(0x100f_acff, 0x22)) goto l_0x100f_acff;/* jz 0x100facff */
            ii(0x100f_acdd, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
            ii(0x100f_ace0, 5);  call(0x100f_a9fd, -0x2e8);            /* call 0x100fa9fd */
            ii(0x100f_ace5, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
            ...
            ii(0x100f_acf1, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
            ii(0x100f_acf4, 5);  call(0x100f_f562, 0x4869);            /* call 0x100ff562 */
            ii(0x100f_acf9, 2);  jmp(0x100f_acff, 4); goto l_0x100f_acff;/* jmp 0x100facff */
        l_0x100f_acfb:
            ii(0x100f_acfb, 4);  mov(memb[ss, ebp - 16], 0);           /* mov byte [ebp-0x10], 0x0 */
        l_0x100f_acff:
            ii(0x100f_acff, 4);  or(memb[ss, ebp - 4], 1);             /* or byte [ebp-0x4], 0x1 */
            ii(0x100f_ad03, 3);  lea(eax, memd[ss, ebp - 76]);         /* lea eax, [ebp-0x4c] */
            ii(0x100f_ad06, 5);  call(0x100e_7e34, -0x1_2ed7);         /* call 0x100e7e34 */
            ii(0x100f_ad0b, 3);  mov(memd[ss, ebp - 80], eax);         /* mov [ebp-0x50], eax */
            ii(0x100f_ad0e, 4);  and(memb[ss, ebp - 4], -2 /* 0xfe */);/* and byte [ebp-0x4], 0xfe */
            ii(0x100f_ad12, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100f_ad14, 6);  mov(dl, memb[ds, 0x101c_388d]);       /* mov dl, [0x101c388d] */
            ii(0x100f_ad1a, 3);  lea(eax, memd[ss, ebp - 76]);         /* lea eax, [ebp-0x4c] */
            ...
            ii(0x100f_ad2c, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100f_ad2f, 7);  cmp(memb[ds, 0x101c_388b], 0);        /* cmp byte [0x101c388b], 0x0 */
            ii(0x100f_ad36, 2);  if(jz(0x100f_ad41, 9)) goto l_0x100f_ad41;/* jz 0x100fad41 */
            ii(0x100f_ad38, 7);  cmp(memb[ds, 0x101c_391e], 0xb);      /* cmp byte [0x101c391e], 0xb */
            ii(0x100f_ad3f, 2);  if(jz(0x100f_ad43, 2)) goto l_0x100f_ad43;/* jz 0x100fad43 */
        l_0x100f_ad41:
        ...
        l_0x100f_ad43:
            ...
            ii(0x100f_ad4e, 2);  if(jnz(0x100f_ad52, 2)) goto l_0x100f_ad52;/* jnz 0x100fad52 */
        l_0x100f_ad50:
        ...
        l_0x100f_ad52:
            ...
            ii(0x100f_ad74, 3);  lea(eax, memd[ss, ebp - 76]);         /* lea eax, [ebp-0x4c] */
        ...
        l_0x100f_ad81:
            ...
            ii(0x100f_ad92, 7);  xor(memb[ds, 0x101b_8745], -1 /* 0xff */);/* xor byte [0x101b8745], 0xff */
            ii(0x100f_ad99, 7);  mov(memb[ds, 0x101b_8746], 5);        /* mov byte [0x101b8746], 0x5 */
        l_0x100f_ada0:
            ...
            ii(0x100f_adac, 2);  if(jnz(0x100f_adb7, 9)) goto l_0x100f_adb7;/* jnz 0x100fadb7 */
            ii(0x100f_adae, 7);  cmp(memb[ds, 0x101c_3912], 0);        /* cmp byte [0x101c3912], 0x0 */
            ii(0x100f_adb5, 2);  if(jz(0x100f_adbf, 8)) goto l_0x100f_adbf;/* jz 0x100fadbf */
        l_0x100f_adb7:
            ii(0x100f_adb7, 3);  lea(eax, memd[ss, ebp - 76]);         /* lea eax, [ebp-0x4c] */
        ...
        l_0x100f_adbf:
            ...
            ii(0x100f_ade2, 3);  lea(ebx, memd[ss, ebp - 84]);         /* lea ebx, [ebp-0x54] */
            ...
            ii(0x100f_adf8, 4);  cmp(memb[ds, eax + 62], 1);           /* cmp byte [eax+0x3e], 0x1 */
            ...
            ii(0x100f_ae08, 4);  cmp(memb[ds, eax + 62], 0x1d);        /* cmp byte [eax+0x3e], 0x1d */
            ii(0x100f_ae0c, 2);  if(jnz(0x100f_ae10, 2)) goto l_0x100f_ae10;/* jnz 0x100fae10 */
        l_0x100f_ae0e:
        ...
        l_0x100f_ae10:
            ...
            ii(0x100f_ae1a, 4);  cmp(memb[ds, eax + 62], 2);           /* cmp byte [eax+0x3e], 0x2 */
            ii(0x100f_ae1e, 2);  if(jnz(0x100f_ae22, 2)) goto l_0x100f_ae22;/* jnz 0x100fae22 */
        l_0x100f_ae20:
        ...
        l_0x100f_ae22:
            ...
            ii(0x100f_ae2c, 4);  cmp(memb[ds, eax + 61], 4);           /* cmp byte [eax+0x3d], 0x4 */
        ...
        l_0x100f_ae32:
            ...
            ii(0x100f_ae4d, 2);  if(jnz(0x100f_ae54, 5)) goto l_0x100f_ae54;/* jnz 0x100fae54 */
        l_0x100f_ae4f:
        ...
        l_0x100f_ae54:
            ...
            ii(0x100f_ae5e, 3);  mov(memd[ss, ebp - 88], eax);         /* mov [ebp-0x58], eax */
            ii(0x100f_ae61, 3);  mov(eax, memd[ss, ebp - 88]);         /* mov eax, [ebp-0x58] */
            ii(0x100f_ae64, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100f_ae66, 3);  mov(dl, memb[ds, eax + 38]);          /* mov dl, [eax+0x26] */
            ...
            ii(0x100f_ae76, 3);  mov(eax, memd[ss, ebp - 88]);         /* mov eax, [ebp-0x58] */
            ...
            ii(0x100f_ae83, 2);  if(jnz(0x100f_ae87, 2)) goto l_0x100f_ae87;/* jnz 0x100fae87 */
        l_0x100f_ae85:
            ii(0x100f_ae85, 2);  jmp(0x100f_aea7, 0x20); goto l_0x100f_aea7;/* jmp 0x100faea7 */
        l_0x100f_ae87:
            ii(0x100f_ae87, 3);  mov(eax, memd[ss, ebp - 88]);         /* mov eax, [ebp-0x58] */
            ii(0x100f_ae8a, 3);  add(eax, 0x65);                       /* add eax, 0x65 */
            ii(0x100f_ae8d, 5);  call(0x1007_69d8, -0x8_44ba);         /* call 0x100769d8 */
            ii(0x100f_ae92, 3);  mov(memd[ss, ebp - 92], eax);         /* mov [ebp-0x5c], eax */
            ii(0x100f_ae95, 3);  mov(eax, memd[ss, ebp - 92]);         /* mov eax, [ebp-0x5c] */
            ii(0x100f_ae98, 3);  mov(ecx, memd[ds, eax + 2]);          /* mov ecx, [eax+0x2] */
            ii(0x100f_ae9b, 3);  mov(ebx, memd[ss, ebp - 12]);         /* mov ebx, [ebp-0xc] */
            ii(0x100f_ae9e, 3);  mov(edx, memd[ss, ebp - 88]);         /* mov edx, [ebp-0x58] */
            ii(0x100f_aea1, 3);  mov(eax, memd[ss, ebp - 92]);         /* mov eax, [ebp-0x5c] */
            ii(0x100f_aea4, 3);  call_abs(memd[ds, ecx + 52]);         /* call dword [ecx+0x34] */
        l_0x100f_aea7:
            ...
            ii(0x100f_aeb0, 7);  mov(memd[ss, ebp - 96], 1);           /* mov dword [ebp-0x60], 0x1 */
            ii(0x100f_aeb7, 3);  mov(eax, memd[ss, ebp - 88]);         /* mov eax, [ebp-0x58] */
            ii(0x100f_aeba, 3);  mov(eax, memd[ds, eax + 6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x100f_aec7, 2);  if(jz(0x100f_aed0, 7)) goto l_0x100f_aed0;/* jz 0x100faed0 */
            ii(0x100f_aec9, 7);  mov(memd[ss, ebp - 96], 5);           /* mov dword [ebp-0x60], 0x5 */
        l_0x100f_aed0:
            ii(0x100f_aed0, 4);  movsx(ecx, memw[ss, ebp - 96]);       /* movsx ecx, word [ebp-0x60] */
            ii(0x100f_aed4, 3);  lea(eax, memd[ss, ebp - 84]);         /* lea eax, [ebp-0x54] */
            ii(0x100f_aed7, 5);  call(0x1007_6730, -0x8_47ac);         /* call 0x10076730 */
            ii(0x100f_aedc, 3);  mov(ebx, memd[ds, eax + 16]);         /* mov ebx, [eax+0x10] */
            ii(0x100f_aedf, 3);  sar(ebx, 0x10);                       /* sar ebx, 0x10 */
            ii(0x100f_aee2, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x100f_aee5, 3);  mov(eax, memd[ss, ebp - 88]);         /* mov eax, [ebp-0x58] */
        ...
        l_0x100f_aeed:
            ...
            ii(0x100f_aef6, 5);  mov(ecx, 4);                          /* mov ecx, 0x4 */
            ii(0x100f_aefb, 3);  lea(eax, memd[ss, ebp - 84]);         /* lea eax, [ebp-0x54] */
            ii(0x100f_aefe, 5);  call(0x1007_6730, -0x8_47d3);         /* call 0x10076730 */
            ii(0x100f_af03, 3);  mov(ebx, memd[ds, eax + 21]);         /* mov ebx, [eax+0x15] */
            ii(0x100f_af06, 3);  sar(ebx, 0x10);                       /* sar ebx, 0x10 */
            ii(0x100f_af09, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x100f_af0c, 3);  mov(eax, memd[ss, ebp - 88]);         /* mov eax, [ebp-0x58] */
        ...
        l_0x100f_af14:
            ...
            ii(0x100f_af30, 2);  if(jnz(0x100f_af34, 2)) goto l_0x100f_af34;/* jnz 0x100faf34 */
        l_0x100f_af32:
        ...
        l_0x100f_af34:
            ...
            ii(0x100f_af41, 2);  if(jnz(0x100f_af48, 5)) goto l_0x100f_af48;/* jnz 0x100faf48 */
        l_0x100f_af43:
        ...
        l_0x100f_af48:
            ...
            ii(0x100f_af52, 3);  lea(ebx, memd[ss, ebp - 100]);        /* lea ebx, [ebp-0x64] */
        ...
        l_0x100f_af5e:
            ...
            ii(0x100f_af60, 3);  lea(eax, memd[ss, ebp - 100]);        /* lea eax, [ebp-0x64] */
            ...
            ii(0x100f_af70, 3);  lea(eax, memd[ss, ebp - 100]);        /* lea eax, [ebp-0x64] */
            ii(0x100f_af73, 5);  call(0x1007_63a0, -0x8_4bd8);         /* call 0x100763a0 */
            ii(0x100f_af78, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100f_af7a, 3);  mov(dl, memb[ds, eax + 38]);          /* mov dl, [eax+0x26] */
            ...
            ii(0x100f_af88, 3);  lea(eax, memd[ss, ebp - 100]);        /* lea eax, [ebp-0x64] */
            ii(0x100f_af8b, 5);  call(0x1007_63a0, -0x8_4bf0);         /* call 0x100763a0 */
            ii(0x100f_af90, 4);  cmp(memb[ds, eax + 62], 1);           /* cmp byte [eax+0x3e], 0x1 */
            ii(0x100f_af94, 2);  if(jz(0x100f_afa4, 0xe)) goto l_0x100f_afa4;/* jz 0x100fafa4 */
            ii(0x100f_af96, 3);  lea(eax, memd[ss, ebp - 100]);        /* lea eax, [ebp-0x64] */
            ii(0x100f_af99, 5);  call(0x1007_63a0, -0x8_4bfe);         /* call 0x100763a0 */
            ii(0x100f_af9e, 4);  cmp(memb[ds, eax + 62], 2);           /* cmp byte [eax+0x3e], 0x2 */
            ii(0x100f_afa2, 2);  if(jnz(0x100f_afa6, 2)) goto l_0x100f_afa6;/* jnz 0x100fafa6 */
        l_0x100f_afa4:
            ii(0x100f_afa4, 2);  jmp(0x100f_afa8, 2); goto l_0x100f_afa8;/* jmp 0x100fafa8 */
        l_0x100f_afa6:
        ...
        l_0x100f_afa8:
            ...
            ii(0x100f_afb2, 3);  lea(eax, memd[ss, ebp - 100]);        /* lea eax, [ebp-0x64] */
            ...
            ii(0x100f_afc1, 2);  if(jnz(0x100f_afc8, 5)) goto l_0x100f_afc8;/* jnz 0x100fafc8 */
        l_0x100f_afc3:
            ii(0x100f_afc3, 5);  jmp(0x100f_b05b, 0x93); goto l_0x100f_b05b;/* jmp 0x100fb05b */
        l_0x100f_afc8:
            ii(0x100f_afc8, 3);  lea(eax, memd[ss, ebp - 100]);        /* lea eax, [ebp-0x64] */
            ...
            ii(0x100f_afd7, 3);  lea(eax, memd[ss, ebp - 84]);         /* lea eax, [ebp-0x54] */
            ...
            ii(0x100f_afe8, 7);  mov(memd[ss, ebp - 104], 1);          /* mov dword [ebp-0x68], 0x1 */
            ii(0x100f_afef, 3);  lea(eax, memd[ss, ebp - 100]);        /* lea eax, [ebp-0x64] */
            ii(0x100f_aff2, 5);  call(0x1007_63a0, -0x8_4c57);         /* call 0x100763a0 */
            ii(0x100f_aff7, 3);  mov(eax, memd[ds, eax + 6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x100f_b004, 2);  if(jz(0x100f_b00d, 7)) goto l_0x100f_b00d;/* jz 0x100fb00d */
            ii(0x100f_b006, 7);  mov(memd[ss, ebp - 104], 5);          /* mov dword [ebp-0x68], 0x5 */
        l_0x100f_b00d:
            ii(0x100f_b00d, 4);  movsx(ecx, memw[ss, ebp - 104]);      /* movsx ecx, word [ebp-0x68] */
            ii(0x100f_b011, 3);  lea(eax, memd[ss, ebp - 84]);         /* lea eax, [ebp-0x54] */
            ii(0x100f_b014, 5);  call(0x1007_6730, -0x8_48e9);         /* call 0x10076730 */
            ii(0x100f_b019, 3);  mov(ebx, memd[ds, eax + 16]);         /* mov ebx, [eax+0x10] */
            ii(0x100f_b01c, 3);  sar(ebx, 0x10);                       /* sar ebx, 0x10 */
            ii(0x100f_b01f, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x100f_b022, 3);  lea(eax, memd[ss, ebp - 100]);        /* lea eax, [ebp-0x64] */
        ...
        l_0x100f_b02f:
            ...
            ii(0x100f_b038, 5);  mov(ecx, 4);                          /* mov ecx, 0x4 */
            ii(0x100f_b03d, 3);  lea(eax, memd[ss, ebp - 84]);         /* lea eax, [ebp-0x54] */
            ii(0x100f_b040, 5);  call(0x1007_6730, -0x8_4915);         /* call 0x10076730 */
            ii(0x100f_b045, 3);  mov(ebx, memd[ds, eax + 21]);         /* mov ebx, [eax+0x15] */
            ii(0x100f_b048, 3);  sar(ebx, 0x10);                       /* sar ebx, 0x10 */
            ii(0x100f_b04b, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x100f_b04e, 3);  lea(eax, memd[ss, ebp - 100]);        /* lea eax, [ebp-0x64] */
            ii(0x100f_b051, 5);  call(0x1007_6408, -0x8_4c4e);         /* call 0x10076408 */
            ii(0x100f_b056, 5);  call(0x100f_a87b, -0x7e0);            /* call 0x100fa87b */
        l_0x100f_b05b:
            ii(0x100f_b05b, 3);  lea(eax, memd[ss, ebp - 100]);        /* lea eax, [ebp-0x64] */
        ...
        l_0x100f_b068:
            ...
            ii(0x100f_b06a, 3);  lea(eax, memd[ss, ebp - 100]);        /* lea eax, [ebp-0x64] */
            ii(0x100f_b06d, 5);  call(0x1007_5f6c, -0x8_5106);         /* call 0x10075f6c */
        l_0x100f_b072:
            ii(0x100f_b072, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100f_b074, 3);  lea(eax, memd[ss, ebp - 84]);         /* lea eax, [ebp-0x54] */
            ii(0x100f_b077, 5);  call(0x1007_5eec, -0x8_5190);         /* call 0x10075eec */
        l_0x100f_b07c:
            ii(0x100f_b07c, 4);  cmp(memb[ss, ebp - 16], 0);           /* cmp byte [ebp-0x10], 0x0 */
            ii(0x100f_b080, 2);  if(jz(0x100f_b087, 5)) goto l_0x100f_b087;/* jz 0x100fb087 */
            ii(0x100f_b082, 5);  call(0x1011_5f9e, 0x1_af17);          /* call 0x10115f9e */
        l_0x100f_b087:
            ii(0x100f_b087, 7);  cmp(memb[ds, 0x101c_38a2], 2);        /* cmp byte [0x101c38a2], 0x2 */
            ...
            ii(0x100f_b0b3, 3);  mov(memd[ss, ebp - 108], eax);        /* mov [ebp-0x6c], eax */
            ...
            ii(0x100f_b0d5, 3);  mov(memd[ss, ebp - 112], eax);        /* mov [ebp-0x70], eax */
            ...
            ii(0x100f_b0f7, 3);  mov(memd[ss, ebp - 116], eax);        /* mov [ebp-0x74], eax */
            ...
            ii(0x100f_b119, 3);  mov(memd[ss, ebp - 120], eax);        /* mov [ebp-0x78], eax */
            ...
            ii(0x100f_b134, 2);  if(jge(0x100f_b138, 2)) goto l_0x100f_b138;/* jge 0x100fb138 */
        l_0x100f_b136:
        ...
        l_0x100f_b138:
            ...
            ii(0x100f_b143, 2);  if(jle(0x100f_b147, 2)) goto l_0x100f_b147;/* jle 0x100fb147 */
        l_0x100f_b145:
        ...
        l_0x100f_b147:
            ...
            ii(0x100f_b152, 2);  if(jge(0x100f_b159, 5)) goto l_0x100f_b159;/* jge 0x100fb159 */
        l_0x100f_b154:
            ii(0x100f_b154, 5);  jmp(0x100f_b2b5, 0x15c); goto l_0x100f_b2b5;/* jmp 0x100fb2b5 */
        l_0x100f_b159:
            ii(0x100f_b159, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100f_b15b, 4);  movsx(eax, memw[ss, ebp - 108]);      /* movsx eax, word [ebp-0x6c] */
            ii(0x100f_b15f, 5);  call(0x1007_6e7c, -0x8_42e8);         /* call 0x10076e7c */
            ii(0x100f_b164, 3);  mov(memd[ss, ebp - 124], eax);        /* mov [ebp-0x7c], eax */
            ii(0x100f_b167, 5);  mov(eax, memd[ds, 0x101b_8746]);      /* mov eax, [0x101b8746] */
            ii(0x100f_b16c, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x100f_b16f, 3);  lea(edx, memd[ds, eax - 1]);          /* lea edx, [eax-0x1] */
            ii(0x100f_b172, 4);  movsx(eax, memw[ss, ebp - 116]);      /* movsx eax, word [ebp-0x74] */
            ii(0x100f_b176, 5);  call(Definitions.my_min, -0x7_19f7);  /* call 0x10089784 */
            ii(0x100f_b17b, 3);  mov(memd[ss, ebp - 128], eax);        /* mov [ebp-0x80], eax */
            ii(0x100f_b17e, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100f_b180, 4);  movsx(eax, memw[ss, ebp - 112]);      /* movsx eax, word [ebp-0x70] */
            ii(0x100f_b184, 5);  call(0x1007_6e7c, -0x8_430d);         /* call 0x10076e7c */
            ii(0x100f_b189, 6);  mov(memd[ss, ebp - 132], eax);        /* mov [ebp-0x84], eax */
            ii(0x100f_b18f, 5);  mov(eax, memd[ds, 0x101b_8748]);      /* mov eax, [0x101b8748] */
            ii(0x100f_b194, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x100f_b197, 3);  lea(edx, memd[ds, eax - 1]);          /* lea edx, [eax-0x1] */
            ii(0x100f_b19a, 4);  movsx(eax, memw[ss, ebp - 120]);      /* movsx eax, word [ebp-0x78] */
            ii(0x100f_b19e, 5);  call(Definitions.my_min, -0x7_1a1f);  /* call 0x10089784 */
            ii(0x100f_b1a3, 6);  mov(memd[ss, ebp - 136], eax);        /* mov [ebp-0x88], eax */
            ...
            ii(0x100f_b1c1, 2);  if(jle(0x100f_b1c5, 2)) goto l_0x100f_b1c5;/* jle 0x100fb1c5 */
        l_0x100f_b1c3:
            ii(0x100f_b1c3, 2);  jmp(0x100f_b1e9, 0x24); goto l_0x100f_b1e9;/* jmp 0x100fb1e9 */
        l_0x100f_b1c5:
            ii(0x100f_b1c5, 2);  push(4);                              /* push 0x4 */
            ii(0x100f_b1c7, 4);  movsx(eax, memw[ss, ebp - 112]);      /* movsx eax, word [ebp-0x70] */
            ii(0x100f_b1cb, 1);  push(eax);                            /* push eax */
            ii(0x100f_b1cc, 4);  movsx(eax, memw[ss, ebp - 128]);      /* movsx eax, word [ebp-0x80] */
            ii(0x100f_b1d0, 1);  push(eax);                            /* push eax */
            ii(0x100f_b1d1, 4);  movsx(ecx, memw[ss, ebp - 112]);      /* movsx ecx, word [ebp-0x70] */
            ii(0x100f_b1d5, 4);  movsx(ebx, memw[ss, ebp - 124]);      /* movsx ebx, word [ebp-0x7c] */
            ii(0x100f_b1d9, 5);  mov(edx, 0x280);                      /* mov edx, 0x280 */
            ii(0x100f_b1de, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_b1e1, 3);  mov(eax, memd[ds, eax + 22]);         /* mov eax, [eax+0x16] */
        ...
        l_0x100f_b1e9:
            ...
            ii(0x100f_b201, 2);  if(jle(0x100f_b205, 2)) goto l_0x100f_b205;/* jle 0x100fb205 */
        l_0x100f_b203:
            ii(0x100f_b203, 2);  jmp(0x100f_b22f, 0x2a); goto l_0x100f_b22f;/* jmp 0x100fb22f */
        l_0x100f_b205:
            ii(0x100f_b205, 2);  push(4);                              /* push 0x4 */
            ii(0x100f_b207, 7);  movsx(eax, memw[ss, ebp - 136]);      /* movsx eax, word [ebp-0x88] */
            ii(0x100f_b20e, 1);  push(eax);                            /* push eax */
            ii(0x100f_b20f, 4);  movsx(eax, memw[ss, ebp - 116]);      /* movsx eax, word [ebp-0x74] */
            ii(0x100f_b213, 1);  push(eax);                            /* push eax */
            ii(0x100f_b214, 7);  movsx(ecx, memw[ss, ebp - 132]);      /* movsx ecx, word [ebp-0x84] */
            ii(0x100f_b21b, 4);  movsx(ebx, memw[ss, ebp - 116]);      /* movsx ebx, word [ebp-0x74] */
            ii(0x100f_b21f, 5);  mov(edx, 0x280);                      /* mov edx, 0x280 */
            ii(0x100f_b224, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_b227, 3);  mov(eax, memd[ds, eax + 22]);         /* mov eax, [eax+0x16] */
        ...
        l_0x100f_b22f:
            ...
            ii(0x100f_b247, 2);  if(jle(0x100f_b24b, 2)) goto l_0x100f_b24b;/* jle 0x100fb24b */
        l_0x100f_b249:
            ii(0x100f_b249, 2);  jmp(0x100f_b26f, 0x24); goto l_0x100f_b26f;/* jmp 0x100fb26f */
        l_0x100f_b24b:
            ii(0x100f_b24b, 2);  push(4);                              /* push 0x4 */
            ii(0x100f_b24d, 4);  movsx(eax, memw[ss, ebp - 120]);      /* movsx eax, word [ebp-0x78] */
            ii(0x100f_b251, 1);  push(eax);                            /* push eax */
            ii(0x100f_b252, 4);  movsx(eax, memw[ss, ebp - 128]);      /* movsx eax, word [ebp-0x80] */
            ii(0x100f_b256, 1);  push(eax);                            /* push eax */
            ii(0x100f_b257, 4);  movsx(ecx, memw[ss, ebp - 120]);      /* movsx ecx, word [ebp-0x78] */
            ii(0x100f_b25b, 4);  movsx(ebx, memw[ss, ebp - 124]);      /* movsx ebx, word [ebp-0x7c] */
            ii(0x100f_b25f, 5);  mov(edx, 0x280);                      /* mov edx, 0x280 */
            ii(0x100f_b264, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_b267, 3);  mov(eax, memd[ds, eax + 22]);         /* mov eax, [eax+0x16] */
        ...
        l_0x100f_b26f:
            ...
            ii(0x100f_b287, 2);  if(jle(0x100f_b28b, 2)) goto l_0x100f_b28b;/* jle 0x100fb28b */
        l_0x100f_b289:
            ii(0x100f_b289, 2);  jmp(0x100f_b2b5, 0x2a); goto l_0x100f_b2b5;/* jmp 0x100fb2b5 */
        l_0x100f_b28b:
            ii(0x100f_b28b, 2);  push(4);                              /* push 0x4 */
            ii(0x100f_b28d, 7);  movsx(eax, memw[ss, ebp - 136]);      /* movsx eax, word [ebp-0x88] */
            ii(0x100f_b294, 1);  push(eax);                            /* push eax */
            ii(0x100f_b295, 4);  movsx(eax, memw[ss, ebp - 108]);      /* movsx eax, word [ebp-0x6c] */
            ii(0x100f_b299, 1);  push(eax);                            /* push eax */
            ii(0x100f_b29a, 7);  movsx(ecx, memw[ss, ebp - 132]);      /* movsx ecx, word [ebp-0x84] */
            ii(0x100f_b2a1, 4);  movsx(ebx, memw[ss, ebp - 108]);      /* movsx ebx, word [ebp-0x6c] */
            ii(0x100f_b2a5, 5);  mov(edx, 0x280);                      /* mov edx, 0x280 */
            ii(0x100f_b2aa, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_b2ad, 3);  mov(eax, memd[ds, eax + 22]);         /* mov eax, [eax+0x16] */
        ...
        l_0x100f_b2b5:
            ...
            ii(0x100f_b2e2, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100f_b2e5, 2);  push(1);                              /* push 0x1 */
            ...
            ii(0x100f_b310, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_b313, 3);  mov(eax, memd[ds, eax + 22]);         /* mov eax, [eax+0x16] */
            ...
            ii(0x100f_b32d, 6);  mov(memd[ss, ebp - 140], eax);        /* mov [ebp-0x8c], eax */
            ii(0x100f_b333, 6);  mov(edx, memd[ds, 0x101c_38e4]);      /* mov edx, [0x101c38e4] */
            ii(0x100f_b339, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x100f_b33c, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_b33f, 3);  mov(eax, memd[ds, eax + 22]);         /* mov eax, [eax+0x16] */
            ...
            ii(0x100f_b354, 6);  mov(memd[ss, ebp - 144], edx);        /* mov [ebp-0x90], edx */
            ii(0x100f_b35a, 10);  mov(memd[ss, ebp - 148], 0x38);      /* mov dword [ebp-0x94], 0x38 */
        l_0x100f_b364:
            ii(0x100f_b364, 6);  dec(memd[ss, ebp - 148]);             /* dec dword [ebp-0x94] */
            ii(0x100f_b36a, 8);  cmp(memw[ss, ebp - 148], -1 /* 0xff */);/* cmp word [ebp-0x94], 0xffff */
            ii(0x100f_b372, 6);  if(jz(0x100f_b3f5, 0x7d)) goto l_0x100f_b3f5;/* jz 0x100fb3f5 */
            ii(0x100f_b378, 10);  mov(memd[ss, ebp - 152], 0x38);      /* mov dword [ebp-0x98], 0x38 */
        l_0x100f_b382:
            ii(0x100f_b382, 6);  dec(memd[ss, ebp - 152]);             /* dec dword [ebp-0x98] */
            ii(0x100f_b388, 8);  cmp(memw[ss, ebp - 152], -1 /* 0xff */);/* cmp word [ebp-0x98], 0xffff */
            ii(0x100f_b390, 2);  if(jz(0x100f_b3c6, 0x34)) goto l_0x100f_b3c6;/* jz 0x100fb3c6 */
            ii(0x100f_b392, 6);  mov(edx, memd[ss, ebp - 140]);        /* mov edx, [ebp-0x8c] */
            ii(0x100f_b398, 6);  inc(memd[ss, ebp - 140]);             /* inc dword [ebp-0x8c] */
            ii(0x100f_b39e, 6);  mov(eax, memd[ss, ebp - 144]);        /* mov eax, [ebp-0x90] */
            ii(0x100f_b3a4, 2);  mov(al, memb[ds, eax]);               /* mov al, [eax] */
            ii(0x100f_b3a6, 2);  mov(memb[ds, edx], al);               /* mov [edx], al */
            ii(0x100f_b3a8, 6);  mov(eax, memd[ss, ebp - 144]);        /* mov eax, [ebp-0x90] */
            ii(0x100f_b3ae, 6);  inc(memd[ss, ebp - 144]);             /* inc dword [ebp-0x90] */
            ii(0x100f_b3b4, 6);  mov(edx, memd[ss, ebp - 140]);        /* mov edx, [ebp-0x8c] */
            ii(0x100f_b3ba, 6);  inc(memd[ss, ebp - 140]);             /* inc dword [ebp-0x8c] */
        ...
        l_0x100f_b3c6:
            ...
            ii(0x100f_b3cb, 6);  mov(edx, memd[ss, ebp - 140]);        /* mov edx, [ebp-0x8c] */
            ii(0x100f_b3d1, 3);  sub(edx, 0x70);                       /* sub edx, 0x70 */
            ii(0x100f_b3d4, 6);  mov(eax, memd[ss, ebp - 140]);        /* mov eax, [ebp-0x8c] */
            ii(0x100f_b3da, 5);  call(Definitions.sys_memcpy, 0x6_aa6c);/* call 0x10165e4b */
            ii(0x100f_b3df, 10);  add(memd[ss, ebp - 144], 0x248);     /* add dword [ebp-0x90], 0x248 */
            ii(0x100f_b3e9, 7);  add(memd[ss, ebp - 140], 0x70);       /* add dword [ebp-0x8c], 0x70 */
            ii(0x100f_b3f0, 5);  jmp(0x100f_b364, -0x91); goto l_0x100f_b364;/* jmp 0x100fb364 */
        l_0x100f_b3f5:
            ii(0x100f_b3f5, 5);  push(0x280);                          /* push 0x280 */
            ii(0x100f_b3fa, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_b3fd, 3);  push(memd[ds, eax + 22]);             /* push dword [eax+0x16] */
        ...
        l_0x100f_b414:
            ii(0x100f_b414, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x100f_b417, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_b41a, 3);  mov(eax, memd[ds, eax + 18]);         /* mov eax, [eax+0x12] */
        ...
        l_0x100f_b429:
            ...
            ii(0x100f_b42b, 3);  lea(eax, memd[ss, ebp - 76]);         /* lea eax, [ebp-0x4c] */
