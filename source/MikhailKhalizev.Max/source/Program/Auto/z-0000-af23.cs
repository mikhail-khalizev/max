...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_af23()
        {
            ...
            ii(0xaf2c, 2);  if(jae(0xaf31, 3)) goto l_0xaf31;          /* jae 0xaf31 */
        ...
        l_0xaf31:
            ...
            ii(0xaf44, 2);  if(jz(0xaf4c, 6)) goto l_0xaf4c;           /* jz 0xaf4c */
        ...
        l_0xaf4c:
            ...
            ii(0xaf64, 2);  if(jnz(0xaf6e, 8)) goto l_0xaf6e;          /* jnz 0xaf6e */
            ii(0xaf66, 3);  cmp(ax, 0x4000);                           /* cmp ax, 0x4000 */
            ii(0xaf69, 2);  if(jb(0xaf6e, 3)) goto l_0xaf6e;           /* jb 0xaf6e */
            ii(0xaf6b, 3);  mov(ax, 0x4000);                           /* mov ax, 0x4000 */
        l_0xaf6e:
            ii(0xaf6e, 3);  mov(memw[ds, 0xece], ax);                  /* mov [0xece], ax */
            ii(0xaf71, 5);  test(memb[ds, 0x47], 1);                   /* test byte [0x47], 0x1 */
            ii(0xaf76, 2);  if(jz(0xaf7d, 5)) goto l_0xaf7d;           /* jz 0xaf7d */
        ...
        l_0xaf7d:
            ...
            ii(0xaf89, 3);  shr(cx, 3);                                /* shr cx, 0x3 */
            ...
            ii(0xaf98, 3);  shr(si, 6);                                /* shr si, 0x6 */
        ...
        l_0xafa3:
            ...
            ii(0xafab, 3);  mov(ax, 1);                                /* mov ax, 0x1 */
