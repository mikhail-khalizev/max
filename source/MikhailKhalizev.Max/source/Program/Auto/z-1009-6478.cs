...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_6478()
        {
            ...
            ii(0x1009_648e, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1009_6491, 3);  mov(memd[ss, ebp - 8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1009_6494, 3);  mov(memd[ss, ebp - 4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1009_6497, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x1009_64a4, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x1009_64a7, 5);  call(0x1007_64b8, -0x1_fff4);         /* call 0x100764b8 */
            ii(0x1009_64ac, 5);  mov(edx, 5);                          /* mov edx, 0x5 */
            ii(0x1009_64b1, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1009_64b4, 3);  mov(eax, memd[ds, eax + 7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x1009_64cb, 4);  mov(ax, memw[ds, eax + 23]);          /* mov ax, [eax+0x17] */
            ii(0x1009_64cf, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1009_64d2, 2);  jmp(0x1009_64dc, 8); goto l_0x1009_64dc;/* jmp 0x100964dc */
        l_0x1009_64d4:
            ii(0x1009_64d4, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x1009_64d7, 5);  call(0x1007_6bf8, -0x1_f8e4);         /* call 0x10076bf8 */
        l_0x1009_64dc:
            ii(0x1009_64dc, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1009_64de, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x1009_653f, 2);  sar(eax, 1);                          /* sar eax, 1 */
            ii(0x1009_6541, 3);  movsx(ebx, ax);                       /* movsx ebx, ax */
            ii(0x1009_6544, 3);  lea(edx, memd[ss, ebp - 28]);         /* lea edx, [ebp-0x1c] */
            ii(0x1009_6547, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x1009_654a, 5);  call(0x1007_5e64, -0x2_06eb);         /* call 0x10075e64 */
            ii(0x1009_654f, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1009_6551, 3);  lea(eax, memd[ss, ebp - 48]);         /* lea eax, [ebp-0x30] */
            ii(0x1009_6554, 5);  call(0x100a_95c1, 0x1_3068);          /* call 0x100a95c1 */
        l_0x1009_6559:
            ii(0x1009_6559, 3);  lea(eax, memd[ss, ebp - 48]);         /* lea eax, [ebp-0x30] */
            ii(0x1009_655c, 5);  call(0x1008_9860, -0xcd01);           /* call 0x10089860 */
            ii(0x1009_6561, 1);  cwde();                               /* cwde */
            ii(0x1009_6562, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x1009_6565, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ii(0x1009_6568, 2);  add(edx, eax);                        /* add edx, eax */
            ii(0x1009_656a, 3);  lea(eax, memd[ss, ebp - 48]);         /* lea eax, [ebp-0x30] */
            ...
            ii(0x1009_657c, 3);  lea(eax, memd[ss, ebp - 48]);         /* lea eax, [ebp-0x30] */
        ...
        l_0x1009_658d:
            ii(0x1009_658d, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1009_6590, 3);  add(eax, 0x21);                       /* add eax, 0x21 */
            ii(0x1009_6593, 5);  call(0x1009_c6c8, 0x6130);            /* call 0x1009c6c8 */
            ii(0x1009_6598, 3);  lea(ebx, memd[ss, ebp - 20]);         /* lea ebx, [ebp-0x14] */
            ...
            ii(0x1009_65a4, 2);  jmp(0x1009_65ae, 8); goto l_0x1009_65ae;/* jmp 0x100965ae */
        l_0x1009_65a6:
            ii(0x1009_65a6, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1009_65a9, 5);  call(0x1007_6bf8, -0x1_f9b6);         /* call 0x10076bf8 */
        l_0x1009_65ae:
            ii(0x1009_65ae, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1009_65b0, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1009_65c0, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1009_65c3, 5);  call(0x1009_c4f8, 0x5f30);            /* call 0x1009c4f8 */
            ii(0x1009_65c8, 5);  call(0x1009_c4c4, 0x5ef7);            /* call 0x1009c4c4 */
            ii(0x1009_65cd, 4);  cmp(ax, 5);                           /* cmp ax, 0x5 */
            ii(0x1009_65d1, 2);  if(jnz(0x1009_65e0, 0xd)) goto l_0x1009_65e0;/* jnz 0x100965e0 */
            ii(0x1009_65d3, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1009_65d6, 5);  call(0x1009_c52c, 0x5f51);            /* call 0x1009c52c */
            ii(0x1009_65db, 3);  cmp(eax, memd[ss, ebp - 4]);          /* cmp eax, [ebp-0x4] */
            ii(0x1009_65de, 2);  if(jnz(0x1009_65e2, 2)) goto l_0x1009_65e2;/* jnz 0x100965e2 */
        l_0x1009_65e0:
            ii(0x1009_65e0, 2);  jmp(0x1009_6646, 0x64); goto l_0x1009_6646;/* jmp 0x10096646 */
        l_0x1009_65e2:
            ii(0x1009_65e2, 3);  lea(edx, memd[ss, ebp - 52]);         /* lea edx, [ebp-0x34] */
            ii(0x1009_65e5, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1009_65e8, 5);  call(0x1009_c4f8, 0x5f0b);            /* call 0x1009c4f8 */
            ii(0x1009_65ed, 5);  call(0x100a_2d3d, 0xc74b);            /* call 0x100a2d3d */
            ii(0x1009_65f2, 4);  movsx(edx, memw[ss, ebp - 16]);       /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x1009_65fd, 2);  sar(eax, 1);                          /* sar eax, 1 */
            ii(0x1009_65ff, 3);  movsx(ebx, ax);                       /* movsx ebx, ax */
            ii(0x1009_6602, 3);  lea(edx, memd[ss, ebp - 52]);         /* lea edx, [ebp-0x34] */
            ii(0x1009_6605, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
            ii(0x1009_6608, 5);  call(0x1007_5e64, -0x2_07a9);         /* call 0x10075e64 */
            ii(0x1009_660d, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1009_660f, 3);  lea(eax, memd[ss, ebp - 72]);         /* lea eax, [ebp-0x48] */
            ii(0x1009_6612, 5);  call(0x100a_95c1, 0x1_2faa);          /* call 0x100a95c1 */
        l_0x1009_6617:
            ii(0x1009_6617, 3);  lea(eax, memd[ss, ebp - 72]);         /* lea eax, [ebp-0x48] */
            ii(0x1009_661a, 5);  call(0x1008_9860, -0xcdbf);           /* call 0x10089860 */
            ii(0x1009_661f, 1);  cwde();                               /* cwde */
            ii(0x1009_6620, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x1009_6623, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ii(0x1009_6626, 2);  add(edx, eax);                        /* add edx, eax */
            ii(0x1009_6628, 3);  lea(eax, memd[ss, ebp - 72]);         /* lea eax, [ebp-0x48] */
            ...
            ii(0x1009_663a, 3);  lea(eax, memd[ss, ebp - 72]);         /* lea eax, [ebp-0x48] */
        ...
        l_0x1009_664b:
            ...
            ii(0x1009_664d, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1009_6650, 5);  call(0x1009_ba6c, 0x5417);            /* call 0x1009ba6c */
            ii(0x1009_6655, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1009_6657, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
