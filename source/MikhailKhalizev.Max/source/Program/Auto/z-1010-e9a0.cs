...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_e9a0()
        {
            ...
            ii(0x1010_e9bb, 7);  mov(memd[ss, ebp - 40], 0x101b_ac94); /* mov dword [ebp-0x28], 0x101bac94 */
            ...
            ii(0x1010_e9d6, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x1010_e9d9, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x1010_e9dc, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x1010_e9df, 4);  cmp(memd[ss, ebp - 32], 0);           /* cmp dword [ebp-0x20], 0x0 */
            ii(0x1010_e9e3, 2);  if(jz(0x1010_ea1b, 0x36)) goto l_0x1010_ea1b;/* jz 0x1010ea1b */
            ii(0x1010_e9e5, 3);  mov(eax, memd[ss, ebp - 40]);         /* mov eax, [ebp-0x28] */
            ...
            ii(0x1010_e9ee, 3);  mov(eax, memd[ss, ebp - 40]);         /* mov eax, [ebp-0x28] */
            ii(0x1010_e9f1, 3);  movsx(ecx, memw[ds, eax]);            /* movsx ecx, word [eax] */
            ii(0x1010_e9f4, 3);  mov(eax, memd[ss, ebp - 40]);         /* mov eax, [ebp-0x28] */
            ...
            ii(0x1010_e9ff, 3);  mov(eax, memd[ss, ebp - 40]);         /* mov eax, [ebp-0x28] */
            ii(0x1010_ea02, 3);  mov(edx, memd[ds, eax + 6]);          /* mov edx, [eax+0x6] */
            ii(0x1010_ea05, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x1010_ea08, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x1010_ea0b, 5);  call(Definitions.my_ctor_c17, -0x4_0601);/* call 0x100ce40f */
            ii(0x1010_ea10, 3);  mov(memd[ss, ebp - 36], eax);         /* mov [ebp-0x24], eax */
            ii(0x1010_ea13, 3);  mov(eax, memd[ss, ebp - 36]);         /* mov eax, [ebp-0x24] */
            ii(0x1010_ea16, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1010_ea19, 2);  jmp(0x1010_ea21, 6); goto l_0x1010_ea21;/* jmp 0x1010ea21 */
        l_0x1010_ea1b:
            ii(0x1010_ea1b, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
            ii(0x1010_ea1e, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
        l_0x1010_ea21:
            ii(0x1010_ea21, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ...
            ii(0x1010_ea5d, 3);  mov(eax, memd[ss, ebp - 40]);         /* mov eax, [ebp-0x28] */
            ii(0x1010_ea60, 3);  mov(edx, memd[ds, eax + 10]);         /* mov edx, [eax+0xa] */
            ...
            ii(0x1010_ea97, 3);  mov(eax, memd[ss, ebp - 40]);         /* mov eax, [ebp-0x28] */
            ii(0x1010_ea9a, 3);  mov(edx, memd[ds, eax + 20]);         /* mov edx, [eax+0x14] */
            ...
            ii(0x1010_eaaf, 3);  mov(edx, memd[ds, eax + 18]);         /* mov edx, [eax+0x12] */
