...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_1cf1()
        {
            ...
            ii(0x1018_1cf6, 7);  mov(memd[ds, edx + 16], 2);           /* mov dword [edx+0x10], 0x2 */
            ii(0x1018_1cfd, 3);  mov(memd[ds, edx + 20], ebx);         /* mov [edx+0x14], ebx */
            ii(0x1018_1d00, 3);  mov(edx, memd[ds, ebx + 9]);          /* mov edx, [ebx+0x9] */
            ii(0x1018_1d03, 7);  mov(memd[ds, eax + 28], 0);           /* mov dword [eax+0x1c], 0x0 */
            ii(0x1018_1d0a, 3);  mov(memd[ds, eax + 24], edx);         /* mov [eax+0x18], edx */
            ii(0x1018_1d0d, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1018_1d0f, 3);  mov(memd[ds, eax + 12], ecx);         /* mov [eax+0xc], ecx */
            ii(0x1018_1d12, 3);  add(edx, 0x10);                       /* add edx, 0x10 */
            ii(0x1018_1d15, 2);  xor(ebx, ebx);                        /* xor ebx, ebx */
            ii(0x1018_1d17, 3);  mov(memd[ds, eax + 4], edx);          /* mov [eax+0x4], edx */
