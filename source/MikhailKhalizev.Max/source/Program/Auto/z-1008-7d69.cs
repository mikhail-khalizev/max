...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_7d69()
        {
            ...
            ii(0x1008_7d7b, 6);  sub(esp, 4);                          /* sub esp, 0x4 */
            ii(0x1008_7d81, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_7d84, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_7d86, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_7d97, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_7d9a, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_7daa, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1008_7dba:
            ...
            ii(0x1008_7dbc, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_7dcb, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_7dce, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1008_7dde:
            ...
            ii(0x1008_7de0, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_7ded, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_7df0, 3);  add(eax, 0x17);                       /* add eax, 0x17 */
            ii(0x1008_7df3, 5);  call(0x1007_6630, -0x1_17c8);         /* call 0x10076630 */
            ii(0x1008_7df8, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
