...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x1016_c1f0, 1);  push(esi);                            /* push esi */
            ii(0x1016_c1f1, 1);  push(ebp);                            /* push ebp */
            ii(0x1016_c1f2, 2);  mov(esi, eax);                        /* mov esi, eax */
            ii(0x1016_c1f4, 7);  cmp(memd[ds, 0x101c_fbe8], 0);        /* cmp dword [0x101cfbe8], 0x0 */
            ii(0x1016_c1fb, 2);  if(jz(0x1016_c256, 0x59)) goto l_0x1016_c256;/* jz 0x1016c256 */
            ii(0x1016_c1fd, 5);  mov(eax, memd[ds, 0x101c_fbd4]);      /* mov eax, [0x101cfbd4] */
            ii(0x1016_c202, 6);  mov(ebp, memd[ds, 0x101c_fbfc]);      /* mov ebp, [0x101cfbfc] */
            ...
            ii(0x1016_c212, 5);  mov(eax, memd[ds, 0x101c_fbd4]);      /* mov eax, [0x101cfbd4] */
            ...
            ii(0x1016_c223, 6);  mov(ebp, memd[ds, 0x101c_fbf8]);      /* mov ebp, [0x101cfbf8] */
            ii(0x1016_c229, 2);  and(esi, eax);                        /* and esi, eax */
            ii(0x1016_c22b, 5);  mov(eax, memd[ds, 0x101c_fbd0]);      /* mov eax, [0x101cfbd0] */
            ...
            ii(0x1016_c240, 5);  mov(eax, memd[ds, 0x101c_fbd0]);      /* mov eax, [0x101cfbd0] */
            ...
            ii(0x1016_c253, 1);  pop(ebp);                             /* pop ebp */
            ii(0x1016_c254, 1);  pop(esi);                             /* pop esi */
            ii(0x1016_c255, 1);  ret(); return;                        /* ret */
        l_0x1016_c256:
            ii(0x1016_c256, 2);  xor(eax, eax);                        /* xor eax, eax */
            ii(0x1016_c258, 1);  pop(ebp);                             /* pop ebp */
            ii(0x1016_c259, 1);  pop(esi);                             /* pop esi */
            ii(0x1016_c25a, 1);  ret();                                /* ret */
        }
    }
}
