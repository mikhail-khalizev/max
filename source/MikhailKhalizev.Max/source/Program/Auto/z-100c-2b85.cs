...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_2b85()
        {
            ...
            ii(0x100c_2ba5, 4);  cmp(memd[ds, eax + 103], 0);          /* cmp dword [eax+0x67], 0x0 */
            ii(0x100c_2ba9, 2);  if(jnz(0x100c_2bb4, 9)) goto l_0x100c_2bb4;/* jnz 0x100c2bb4 */
            ii(0x100c_2bab, 7);  mov(memd[ss, ebp - 12], 0);           /* mov dword [ebp-0xc], 0x0 */
        ...
        l_0x100c_2bb4:
            ...
            ii(0x100c_2bc2, 3);  mov(edx, memd[ds, eax + 103]);        /* mov edx, [eax+0x67] */
            ...
            ii(0x100c_2bd7, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
        l_0x100c_2bda:
            ii(0x100c_2bda, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
