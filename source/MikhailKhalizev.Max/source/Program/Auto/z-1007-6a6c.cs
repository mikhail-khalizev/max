...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_6a6c()
        {
            ...
            ii(0x1007_6a7d, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1007_6a83, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_6a86, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1007_6a89, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_6a8c, 3);  mov(dx, memw[ds, eax]);               /* mov dx, [eax] */
            ii(0x1007_6a8f, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_6a92, 3);  sub(memw[ds, eax], dx);               /* sub [eax], dx */
            ii(0x1007_6a95, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_6a98, 4);  mov(dx, memw[ds, eax + 2]);           /* mov dx, [eax+0x2] */
            ii(0x1007_6a9c, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_6a9f, 4);  sub(memw[ds, eax + 2], dx);           /* sub [eax+0x2], dx */
