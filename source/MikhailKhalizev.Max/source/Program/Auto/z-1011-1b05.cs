...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_1b05()
        {
            ...
            ii(0x1011_1b1d, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_1b20, 7);  mov(memd[ss, ebp - 20], 0xa);         /* mov dword [ebp-0x14], 0xa */
            ii(0x1011_1b27, 7);  mov(memd[ss, ebp - 16], 0x1d5);       /* mov dword [ebp-0x10], 0x1d5 */
            ii(0x1011_1b2e, 7);  mov(memd[ss, ebp - 12], 0x276);       /* mov dword [ebp-0xc], 0x276 */
            ii(0x1011_1b35, 7);  mov(memd[ss, ebp - 8], 0x1df);        /* mov dword [ebp-0x8], 0x1df */
            ii(0x1011_1b3c, 5);  mov(eax, 5);                          /* mov eax, 0x5 */
            ...
            ii(0x1011_1b49, 5);  mov(eax, 1);                          /* mov eax, 0x1 */
            ii(0x1011_1b4e, 1);  push(eax);                            /* push eax */
            ii(0x1011_1b4f, 2);  push(0);                              /* push 0x0 */
            ii(0x1011_1b51, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1011_1b54, 3);  sub(eax, memd[ss, ebp - 16]);         /* sub eax, [ebp-0x10] */
            ii(0x1011_1b57, 1);  cwde();                               /* cwde */
            ii(0x1011_1b58, 1);  push(eax);                            /* push eax */
            ii(0x1011_1b59, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1011_1b5c, 3);  sub(eax, memd[ss, ebp - 20]);         /* sub eax, [ebp-0x14] */
            ii(0x1011_1b5f, 1);  cwde();                               /* cwde */
            ii(0x1011_1b60, 1);  push(eax);                            /* push eax */
            ii(0x1011_1b61, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1011_1b65, 1);  push(eax);                            /* push eax */
            ii(0x1011_1b66, 4);  movsx(ecx, memw[ss, ebp - 20]);       /* movsx ecx, word [ebp-0x14] */
            ii(0x1011_1b6a, 5);  mov(ebx, StringDefinitions.Copyright1996InterplayProductionsV104);/* mov ebx, 0x101a46db */
            ii(0x1011_1b6f, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_1b72, 3);  mov(edx, memd[ds, eax + 14]);         /* mov edx, [eax+0xe] */
            ii(0x1011_1b75, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x1011_1b78, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_1b7b, 3);  mov(eax, memd[ds, eax + 22]);         /* mov eax, [eax+0x16] */
