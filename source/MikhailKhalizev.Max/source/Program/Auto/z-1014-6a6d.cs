...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_6a6d()
        {
            ...
            ii(0x1014_6a85, 4);  or(memb[ss, ebp - 4], 1);             /* or byte [ebp-0x4], 0x1 */
            ii(0x1014_6a89, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_6a8c, 5);  call(Definitions.my_string_ctor, -0x4fa9);/* call 0x10141ae8 */
            ii(0x1014_6a91, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1014_6a94, 4);  and(memb[ss, ebp - 4], -2 /* 0xfe */);/* and byte [ebp-0x4], 0xfe */
            ii(0x1014_6a98, 3);  lea(eax, memd[ss, ebp + 36]);         /* lea eax, [ebp+0x24] */
            ii(0x1014_6a9b, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1014_6a9e, 3);  lea(ecx, memd[ss, ebp - 12]);         /* lea ecx, [ebp-0xc] */
            ii(0x1014_6aa1, 3);  mov(ebx, memd[ss, ebp + 32]);         /* mov ebx, [ebp+0x20] */
            ii(0x1014_6aa4, 5);  mov(edx, 0x12c);                      /* mov edx, 0x12c */
            ii(0x1014_6aa9, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_6aac, 5);  call(0x1014_20d7, -0x49da);           /* call 0x101420d7 */
            ii(0x1014_6ab1, 7);  mov(memd[ss, ebp - 12], 0);           /* mov dword [ebp-0xc], 0x0 */
            ...
            ii(0x1014_6ac9, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1014_6acc, 5);  mov(edi, 1);                          /* mov edi, 0x1 */
            ii(0x1014_6ad1, 7);  mov(memd[ss, ebp - 28], 2);           /* mov dword [ebp-0x1c], 0x2 */
            ii(0x1014_6ad8, 3);  mov(eax, memd[ss, ebp + 28]);         /* mov eax, [ebp+0x1c] */
            ii(0x1014_6adb, 3);  mov(eax, memd[ds, eax + 24]);         /* mov eax, [eax+0x18] */
            ii(0x1014_6ade, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x1014_6ae1, 1);  push(eax);                            /* push eax */
            ii(0x1014_6ae2, 3);  mov(ecx, memd[ss, ebp + 28]);         /* mov ecx, [ebp+0x1c] */
            ii(0x1014_6ae5, 3);  mov(ecx, memd[ds, ecx + 22]);         /* mov ecx, [ecx+0x16] */
            ii(0x1014_6ae8, 3);  mov(eax, memd[ss, ebp + 28]);         /* mov eax, [ebp+0x1c] */
            ...
            ii(0x1014_6af5, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_6af8, 5);  call(Definitions.my_strobj_c_str_v2, -0xb_d335);/* call 0x100897c8 */
            ii(0x1014_6afd, 3);  lea(esi, memd[ss, ebp - 8]);          /* lea esi, [ebp-0x8] */
