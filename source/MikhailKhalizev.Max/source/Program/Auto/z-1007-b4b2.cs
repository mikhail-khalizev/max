...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_b4b2()
        {
            ...
            ii(0x1007_b4ca, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1007_b4cd, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_b4cf, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_b4de, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1007_b4ee, 3);  mov(al, memb[ds, eax + 77]);          /* mov al, [eax+0x4d] */
            ii(0x1007_b4f1, 5);  and(eax, 0xff);                       /* and eax, 0xff */
            ii(0x1007_b4f6, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x1007_b4f8, 2);  if(jg(0x1007_b500, 6)) goto l_0x1007_b500;/* jg 0x1007b500 */
        l_0x1007_b4fa:
            ii(0x1007_b4fa, 4);  mov(memb[ss, ebp - 8], 1);            /* mov byte [ebp-0x8], 0x1 */
            ii(0x1007_b4fe, 2);  jmp(0x1007_b504, 4); goto l_0x1007_b504;/* jmp 0x1007b504 */
        l_0x1007_b500:
            ii(0x1007_b500, 4);  mov(memb[ss, ebp - 8], 0);            /* mov byte [ebp-0x8], 0x0 */
        l_0x1007_b504:
            ii(0x1007_b504, 3);  mov(al, memb[ss, ebp - 8]);           /* mov al, [ebp-0x8] */
            ii(0x1007_b507, 3);  mov(memb[ss, ebp - 12], al);          /* mov [ebp-0xc], al */
            ii(0x1007_b50a, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
