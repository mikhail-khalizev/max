...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_f78c()
        {
            ...
            ii(0x1014_f7a4, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_f7a7, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_f7aa, 3);  mov(edx, memd[ds, eax + 6]);          /* mov edx, [eax+0x6] */
            ii(0x1014_f7ad, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x1014_f7b0, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_f7b3, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ...
            ii(0x1014_f7cf, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x1014_f7d2, 5);  call(0x1007_6800, -0xd_8fd7);         /* call 0x10076800 */
            ii(0x1014_f7d7, 3);  lea(edx, memd[ss, ebp - 8]);          /* lea edx, [ebp-0x8] */
            ii(0x1014_f7da, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_f7dd, 5);  call(0x1014_edfa, -0x9e8);            /* call 0x1014edfa */
            ii(0x1014_f7e2, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x1014_f7e5, 5);  call(0x1007_6730, -0xd_90ba);         /* call 0x10076730 */
            ii(0x1014_f7ea, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1014_f7ec, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_f7ef, 3);  add(eax, 0x6c);                       /* add eax, 0x6c */
            ii(0x1014_f7f2, 5);  call(0x1007_6730, -0xd_90c7);         /* call 0x10076730 */
            ii(0x1014_f7f7, 3);  mov(dl, memb[ds, edx + 10]);          /* mov dl, [edx+0xa] */
            ii(0x1014_f7fa, 3);  sub(dl, memb[ds, eax + 10]);          /* sub dl, [eax+0xa] */
            ii(0x1014_f7fd, 2);  mov(al, dl);                          /* mov al, dl */
            ii(0x1014_f7ff, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_f802, 3);  add(memb[ds, edx + 77], al);          /* add [edx+0x4d], al */
            ii(0x1014_f805, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_f808, 5);  call(0x1016_15c9, 0x1_1dbc);          /* call 0x101615c9 */
            ii(0x1014_f80d, 3);  lea(edx, memd[ss, ebp - 12]);         /* lea edx, [ebp-0xc] */
            ii(0x1014_f810, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_f813, 3);  add(eax, 0x6c);                       /* add eax, 0x6c */
            ii(0x1014_f816, 5);  call(0x1015_5280, 0x5a65);            /* call 0x10155280 */
            ii(0x1014_f81b, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x1014_f820, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_f830, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x1014_f835, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_f838, 5);  call(0x1007_1838, -0xd_e005);         /* call 0x10071838 */
            ii(0x1014_f83d, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1014_f83f, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x1014_f84e, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
            ii(0x1014_f851, 5);  call(0x1007_5f2c, -0xd_992a);         /* call 0x10075f2c */
            ii(0x1014_f856, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1014_f858, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
