...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_e702()
        {
            ...
            ii(0x18_e716, 3);  mov(memw[ds, bx + 2], ss);              /* mov [bx+0x2], ss */
            ii(0x18_e719, 4);  mov(memd[ds, bx + 12], ebp);            /* mov [bx+0xc], ebp */
            ii(0x18_e71d, 3);  mov(memw[ds, bx + 6], es);              /* mov [bx+0x6], es */
            ii(0x18_e720, 4);  mov(memd[ds, bx + 8], edi);             /* mov [bx+0x8], edi */
            ii(0x18_e724, 5);  mov(memw[ds, bx + 34], 0xffff);         /* mov word [bx+0x22], 0xffff */
            ii(0x18_e729, 5);  mov(cx, memw_a32[es, edi + 48]);        /* mov cx, [es:edi+0x30] */
            ...
            ii(0x18_e739, 7);  movzx(edi, memw_a32[es, edi + 46]);     /* movzx edi, word [es:edi+0x2e] */
        ...
        l_0x18_e757:
            ii(0x18_e757, 6);  movzx(ecx, memw_a32[ss, ebp + 28]);     /* movzx ecx, word [ebp+0x1c] */
            ...
            ii(0x18_e768, 2);  push(esi);                              /* push esi */
            ii(0x18_e76a, 1);  std();                                  /* std */
            ii(0x18_e76b, 5);  lea(esi, memd_a32[ss, ebp + 47]);       /* lea esi, [ebp+0x2f] */
            ...
            ii(0x18_e77b, 2);  pop(esi);                               /* pop esi */
        l_0x18_e77d:
            ii(0x18_e77d, 3);  lea(di, memw[ds, di - 50]);             /* lea di, [di-0x32] */
