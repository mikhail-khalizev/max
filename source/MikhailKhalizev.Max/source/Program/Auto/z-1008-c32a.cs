...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_c32a()
        {
            ...
            ii(0x1008_c33c, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1008_c342, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_c345, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_c347, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1008_c37d:
            ii(0x1008_c37d, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_c380, 3);  add(eax, 0x13);                       /* add eax, 0x13 */
            ii(0x1008_c383, 5);  call(0x1007_6574, -0x1_5e14);         /* call 0x10076574 */
            ii(0x1008_c388, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_c38b, 4);  mov(dx, memw[ds, edx + 31]);          /* mov dx, [edx+0x1f] */
            ii(0x1008_c38f, 4);  cmp(dx, memw[ds, eax + 82]);          /* cmp dx, [eax+0x52] */
            ii(0x1008_c393, 2);  if(jg(0x1008_c3b6, 0x21)) goto l_0x1008_c3b6;/* jg 0x1008c3b6 */
            ii(0x1008_c395, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_c398, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_c39b, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_c39e, 3);  mov(ebx, memd[ds, eax + 2]);          /* mov ebx, [eax+0x2] */
            ii(0x1008_c3a1, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_c3ae, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_c3b1, 3);  call_abs(memd[ds, ebx + 88]);         /* call dword [ebx+0x58] */
            ii(0x1008_c3b4, 2);  jmp(0x1008_c405, 0x4f); goto l_0x1008_c405;/* jmp 0x1008c405 */
        l_0x1008_c3b6:
            ii(0x1008_c3b6, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1008_c3b8, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_c3c7, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_c3d7, 3);  cmp(eax, memd[ss, ebp - 4]);          /* cmp eax, [ebp-0x4] */
            ii(0x1008_c3da, 2);  if(jz(0x1008_c3de, 2)) goto l_0x1008_c3de;/* jz 0x1008c3de */
        l_0x1008_c3dc:
            ii(0x1008_c3dc, 2);  jmp(0x1008_c3f3, 0x15); goto l_0x1008_c3f3;/* jmp 0x1008c3f3 */
        l_0x1008_c3de:
            ii(0x1008_c3de, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_c3e1, 3);  add(eax, 0x1b);                       /* add eax, 0x1b */
            ii(0x1008_c3e4, 5);  call(0x1007_6574, -0x1_5e75);         /* call 0x10076574 */
            ii(0x1008_c3e9, 3);  mov(eax, memd[ds, eax + 80]);         /* mov eax, [eax+0x50] */
            ii(0x1008_c3ec, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x1008_c3ef, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x1008_c3f1, 2);  if(jle(0x1008_c3f5, 2)) goto l_0x1008_c3f5;/* jle 0x1008c3f5 */
        l_0x1008_c3f3:
            ii(0x1008_c3f3, 2);  jmp(0x1008_c3fd, 8); goto l_0x1008_c3fd;/* jmp 0x1008c3fd */
        l_0x1008_c3f5:
            ii(0x1008_c3f5, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_c3f8, 5);  call(0x100a_71f8, 0x1_adfb);          /* call 0x100a71f8 */
        l_0x1008_c3fd:
            ii(0x1008_c3fd, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
