...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_5155()
        {
            ...
            ii(0x100a_516c, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_516f, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_5172, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_5175, 5);  call(0x1008_aef4, -0x1_a286);         /* call 0x1008aef4 */
            ii(0x100a_517a, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x100a_517c, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x100a_517f, 5);  call(0x1008_ae70, -0x1_a314);         /* call 0x1008ae70 */
            ii(0x100a_5184, 2);  jmp(0x100a_518e, 8); goto l_0x100a_518e;/* jmp 0x100a518e */
        l_0x100a_5186:
            ii(0x100a_5186, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ii(0x100a_5189, 5);  call(0x1007_6bf8, -0x2_e596);         /* call 0x10076bf8 */
        l_0x100a_518e:
            ii(0x100a_518e, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100a_5190, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
            ...
            ii(0x100a_51b8, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
        ...
        l_0x100a_51c7:
            ...
            ii(0x100a_51c9, 3);  lea(eax, memd[ss, ebp - 12]);         /* lea eax, [ebp-0xc] */
