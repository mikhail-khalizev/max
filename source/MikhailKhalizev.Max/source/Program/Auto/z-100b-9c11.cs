...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_9c11()
        {
            ...
            ii(0x100b_9c22, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x100b_9c28, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_9c2b, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100b_9c2e, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_9c31, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
