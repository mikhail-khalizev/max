...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_e8c5()
        {
            ...
            ii(0x1007_e8ec, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
            ii(0x1007_e8ef, 5);  call(0x1007_64b8, -0x843c);           /* call 0x100764b8 */
            ii(0x1007_e8f4, 4);  or(memb[ss, ebp - 8], 1);             /* or byte [ebp-0x8], 0x1 */
            ii(0x1007_e8f8, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
            ii(0x1007_e8fb, 5);  call(0x1008_a958, 0xc058);            /* call 0x1008a958 */
            ii(0x1007_e900, 3);  mov(memd[ss, ebp - 52], eax);         /* mov [ebp-0x34], eax */
            ...
            ii(0x1007_e90e, 6);  lea(eax, memd[ss, ebp - 248]);        /* lea eax, [ebp-0xf8] */
            ...
            ii(0x1007_e934, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1007_e937, 7);  mov(memd[ss, ebp - 36], 0);           /* mov dword [ebp-0x24], 0x0 */
            ii(0x1007_e93e, 2);  jmp(0x1007_e946, 6); goto l_0x1007_e946;/* jmp 0x1007e946 */
        l_0x1007_e940:
            ii(0x1007_e940, 3);  mov(eax, memd[ss, ebp - 36]);         /* mov eax, [ebp-0x24] */
            ii(0x1007_e943, 3);  inc(memd[ss, ebp - 36]);              /* inc dword [ebp-0x24] */
        l_0x1007_e946:
            ii(0x1007_e946, 4);  movsx(eax, memw[ss, ebp - 36]);       /* movsx eax, word [ebp-0x24] */
            ...
            ii(0x1007_e952, 4);  movsx(eax, memw[ss, ebp - 36]);       /* movsx eax, word [ebp-0x24] */
        ...
        l_0x1007_e968:
            ...
            ii(0x1007_e972, 3);  mov(memd[ss, ebp - 40], eax);         /* mov [ebp-0x28], eax */
            ii(0x1007_e975, 3);  mov(eax, memd[ss, ebp - 40]);         /* mov eax, [ebp-0x28] */
            ii(0x1007_e978, 3);  mov(memd[ss, ebp - 44], eax);         /* mov [ebp-0x2c], eax */
            ii(0x1007_e97b, 4);  cmp(memd[ss, ebp - 44], 0);           /* cmp dword [ebp-0x2c], 0x0 */
            ...
            ii(0x1007_e98a, 3);  mov(eax, memd[ss, ebp - 40]);         /* mov eax, [ebp-0x28] */
            ii(0x1007_e98d, 5);  call(Definitions.my_ctor_c12, 0x2_76da);/* call 0x100a606c */
            ii(0x1007_e992, 3);  mov(memd[ss, ebp - 48], eax);         /* mov [ebp-0x30], eax */
            ii(0x1007_e995, 3);  mov(eax, memd[ss, ebp - 48]);         /* mov eax, [ebp-0x30] */
            ii(0x1007_e998, 6);  mov(memd[ss, ebp - 252], eax);        /* mov [ebp-0xfc], eax */
            ii(0x1007_e99e, 2);  jmp(0x1007_e9a9, 9); goto l_0x1007_e9a9;/* jmp 0x1007e9a9 */
        l_0x1007_e9a0:
            ii(0x1007_e9a0, 3);  mov(eax, memd[ss, ebp - 44]);         /* mov eax, [ebp-0x2c] */
            ii(0x1007_e9a3, 6);  mov(memd[ss, ebp - 252], eax);        /* mov [ebp-0xfc], eax */
        l_0x1007_e9a9:
            ii(0x1007_e9a9, 6);  mov(edx, memd[ss, ebp - 252]);        /* mov edx, [ebp-0xfc] */
            ii(0x1007_e9af, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
            ii(0x1007_e9b2, 5);  call(0x1008_a898, 0xbee1);            /* call 0x1008a898 */
            ii(0x1007_e9b7, 7);  mov(memd[ss, ebp - 20], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x1007_e9be, 7);  mov(memd[ss, ebp - 16], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1007_e9c5, 2);  jmp(0x1007_e9cf, 8); goto l_0x1007_e9cf;/* jmp 0x1007e9cf */
        l_0x1007_e9c7:
            ii(0x1007_e9c7, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
            ii(0x1007_e9ca, 5);  call(0x1007_6bf8, -0x7dd7);           /* call 0x10076bf8 */
        l_0x1007_e9cf:
            ii(0x1007_e9cf, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_e9d1, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
            ...
            ii(0x1007_e9dd, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
            ii(0x1007_e9e0, 5);  call(0x1007_63a0, -0x8645);           /* call 0x100763a0 */
            ii(0x1007_e9e5, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_e9e7, 3);  mov(dl, memb[ds, eax + 38]);          /* mov dl, [eax+0x26] */
            ...
            ii(0x1007_e9f7, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
            ii(0x1007_e9fa, 5);  call(0x1007_63a0, -0x865f);           /* call 0x100763a0 */
            ii(0x1007_e9ff, 4);  test(memb[ds, eax + 18], 0x10);       /* test byte [eax+0x12], 0x10 */
        ...
        l_0x1007_ea07:
            ii(0x1007_ea07, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
        ...
        l_0x1007_ea3c:
            ...
            ii(0x1007_ea46, 3);  lea(ebx, memd[ss, ebp - 60]);         /* lea ebx, [ebp-0x3c] */
        ...
        l_0x1007_ea54:
            ii(0x1007_ea54, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
            ii(0x1007_ea57, 5);  call(0x1007_6bf8, -0x7e64);           /* call 0x10076bf8 */
        l_0x1007_ea5c:
            ii(0x1007_ea5c, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_ea5e, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
            ...
            ii(0x1007_ea6a, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
            ii(0x1007_ea6d, 5);  call(0x1007_63a0, -0x86d2);           /* call 0x100763a0 */
            ii(0x1007_ea72, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_ea74, 3);  mov(dl, memb[ds, eax + 38]);          /* mov dl, [eax+0x26] */
            ...
            ii(0x1007_ea84, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
            ...
            ii(0x1007_ea94, 8);  inc(memw[ds, eax + ebp - 248]);       /* inc word [eax+ebp-0xf8] */
        l_0x1007_ea9c:
            ii(0x1007_ea9c, 2);  jmp(0x1007_ea54, -0x4a); goto l_0x1007_ea54;/* jmp 0x1007ea54 */
        l_0x1007_ea9e:
            ii(0x1007_ea9e, 6);  mov(eax, memd[ss, ebp - 194]);        /* mov eax, [ebp-0xc2] */
            ii(0x1007_eaa4, 7);  inc(memw[ss, ebp - 194]);             /* inc word [ebp-0xc2] */
            ii(0x1007_eaab, 6);  mov(eax, memd[ss, ebp - 198]);        /* mov eax, [ebp-0xc6] */
            ii(0x1007_eab1, 7);  inc(memw[ss, ebp - 198]);             /* inc word [ebp-0xc6] */
            ii(0x1007_eab8, 6);  mov(eax, memd[ss, ebp - 200]);        /* mov eax, [ebp-0xc8] */
            ii(0x1007_eabe, 7);  inc(memw[ss, ebp - 200]);             /* inc word [ebp-0xc8] */
            ii(0x1007_eac5, 6);  mov(eax, memd[ss, ebp - 202]);        /* mov eax, [ebp-0xca] */
            ii(0x1007_eacb, 7);  inc(memw[ss, ebp - 202]);             /* inc word [ebp-0xca] */
            ii(0x1007_ead2, 6);  mov(eax, memd[ss, ebp - 184]);        /* mov eax, [ebp-0xb8] */
            ii(0x1007_ead8, 7);  inc(memw[ss, ebp - 184]);             /* inc word [ebp-0xb8] */
            ii(0x1007_eadf, 7);  mov(memd[ss, ebp - 36], 0);           /* mov dword [ebp-0x24], 0x0 */
            ii(0x1007_eae6, 2);  jmp(0x1007_eaee, 6); goto l_0x1007_eaee;/* jmp 0x1007eaee */
        l_0x1007_eae8:
            ii(0x1007_eae8, 3);  mov(eax, memd[ss, ebp - 36]);         /* mov eax, [ebp-0x24] */
            ii(0x1007_eaeb, 3);  inc(memd[ss, ebp - 36]);              /* inc dword [ebp-0x24] */
        l_0x1007_eaee:
            ii(0x1007_eaee, 4);  movsx(eax, memw[ss, ebp - 36]);       /* movsx eax, word [ebp-0x24] */
            ii(0x1007_eaf2, 3);  cmp(eax, 8);                          /* cmp eax, 0x8 */
            ii(0x1007_eaf5, 2);  if(jge(0x1007_eb13, 0x1c)) goto l_0x1007_eb13;/* jge 0x1007eb13 */
            ii(0x1007_eaf7, 6);  lea(edx, memd[ss, ebp - 248]);        /* lea edx, [ebp-0xf8] */
            ii(0x1007_eafd, 4);  movsx(eax, memw[ss, ebp - 36]);       /* movsx eax, word [ebp-0x24] */
        ...
        l_0x1007_eb13:
            ii(0x1007_eb13, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ii(0x1007_eb17, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x1007_eb25, 7);  mov(memd[ss, ebp - 32], 0);           /* mov dword [ebp-0x20], 0x0 */
            ii(0x1007_eb2c, 5);  mov(eax, 0x101c_81a8);                /* mov eax, 0x101c81a8 */
            ii(0x1007_eb31, 5);  call(0x1007_6338, -0x87fe);           /* call 0x10076338 */
            ii(0x1007_eb36, 3);  lea(ebx, memd[ss, ebp - 60]);         /* lea ebx, [ebp-0x3c] */
        ...
        l_0x1007_eb44:
            ii(0x1007_eb44, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
            ii(0x1007_eb47, 5);  call(0x1007_6bf8, -0x7f54);           /* call 0x10076bf8 */
        l_0x1007_eb4c:
            ii(0x1007_eb4c, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_eb4e, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
        ...
        l_0x1007_eb88:
            ii(0x1007_eb88, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
            ii(0x1007_eb8b, 5);  call(0x1007_63a0, -0x87f0);           /* call 0x100763a0 */
            ii(0x1007_eb90, 5);  call(0x1015_09a6, 0xd_1e11);          /* call 0x101509a6 */
            ii(0x1007_eb95, 3);  add(memd[ss, ebp - 32], eax);         /* add [ebp-0x20], eax */
        l_0x1007_eb98:
            ii(0x1007_eb98, 2);  jmp(0x1007_eb44, -0x56); goto l_0x1007_eb44;/* jmp 0x1007eb44 */
        l_0x1007_eb9a:
            ii(0x1007_eb9a, 6);  lea(ecx, memd[ss, ebp - 248]);        /* lea ecx, [ebp-0xf8] */
            ii(0x1007_eba0, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
            ii(0x1007_eba3, 5);  call(0x1008_a838, 0xbc90);            /* call 0x1008a838 */
            ii(0x1007_eba8, 2);  mov(ebx, eax);                        /* mov ebx, eax */
            ii(0x1007_ebaa, 4);  movsx(eax, memw[ss, ebp - 32]);       /* movsx eax, word [ebp-0x20] */
            ii(0x1007_ebae, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ii(0x1007_ebb2, 3);  imul(edx, eax);                       /* imul edx, eax */
            ii(0x1007_ebb5, 4);  movsx(eax, memw[ss, ebp - 20]);       /* movsx eax, word [ebp-0x14] */
            ii(0x1007_ebb9, 4);  movsx(esi, memw[ss, ebp - 16]);       /* movsx esi, word [ebp-0x10] */
            ...
            ii(0x1007_ebd4, 6);  lea(ecx, memd[ss, ebp - 248]);        /* lea ecx, [ebp-0xf8] */
            ii(0x1007_ebda, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
            ii(0x1007_ebdd, 5);  call(0x1008_a838, 0xbc56);            /* call 0x1008a838 */
            ii(0x1007_ebe2, 2);  mov(ebx, eax);                        /* mov ebx, eax */
            ii(0x1007_ebe4, 4);  movsx(eax, memw[ss, ebp - 32]);       /* movsx eax, word [ebp-0x20] */
            ii(0x1007_ebe8, 4);  movsx(edx, memw[ss, ebp - 16]);       /* movsx edx, word [ebp-0x10] */
            ii(0x1007_ebec, 3);  imul(edx, eax);                       /* imul edx, eax */
            ii(0x1007_ebef, 4);  movsx(esi, memw[ss, ebp - 20]);       /* movsx esi, word [ebp-0x14] */
            ii(0x1007_ebf3, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
        ...
        l_0x1007_ec10:
            ii(0x1007_ec10, 7);  mov(memd[ss, ebp - 20], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x1007_ec17, 7);  mov(memd[ss, ebp - 16], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1007_ec1e, 7);  mov(memd[ss, ebp - 28], 0);           /* mov dword [ebp-0x1c], 0x0 */
            ii(0x1007_ec25, 7);  mov(memd[ss, ebp - 12], 0);           /* mov dword [ebp-0xc], 0x0 */
            ii(0x1007_ec2c, 5);  mov(eax, 0x101c_8184);                /* mov eax, 0x101c8184 */
            ii(0x1007_ec31, 5);  call(0x1007_6338, -0x88fe);           /* call 0x10076338 */
            ii(0x1007_ec36, 3);  lea(ebx, memd[ss, ebp - 60]);         /* lea ebx, [ebp-0x3c] */
        ...
        l_0x1007_ec44:
            ii(0x1007_ec44, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
            ii(0x1007_ec47, 5);  call(0x1007_6bf8, -0x8054);           /* call 0x10076bf8 */
        l_0x1007_ec4c:
            ii(0x1007_ec4c, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_ec4e, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
        ...
        l_0x1007_ec8f:
            ii(0x1007_ec8f, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
        ...
        l_0x1007_ed06:
            ...
            ii(0x1007_ed25, 6);  lea(ecx, memd[ss, ebp - 248]);        /* lea ecx, [ebp-0xf8] */
            ii(0x1007_ed2b, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
            ii(0x1007_ed2e, 5);  call(0x1008_a838, 0xbb05);            /* call 0x1008a838 */
            ii(0x1007_ed33, 2);  mov(ebx, eax);                        /* mov ebx, eax */
            ii(0x1007_ed35, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ...
            ii(0x1007_ed50, 6);  lea(ecx, memd[ss, ebp - 248]);        /* lea ecx, [ebp-0xf8] */
            ii(0x1007_ed56, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
            ii(0x1007_ed59, 5);  call(0x1008_a838, 0xbada);            /* call 0x1008a838 */
            ii(0x1007_ed5e, 2);  mov(ebx, eax);                        /* mov ebx, eax */
            ii(0x1007_ed60, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ...
            ii(0x1007_ed7b, 6);  lea(ecx, memd[ss, ebp - 248]);        /* lea ecx, [ebp-0xf8] */
            ii(0x1007_ed81, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
            ii(0x1007_ed84, 5);  call(0x1008_a838, 0xbaaf);            /* call 0x1008a838 */
            ii(0x1007_ed89, 2);  mov(ebx, eax);                        /* mov ebx, eax */
            ii(0x1007_ed8b, 4);  movsx(edx, memw[ss, ebp - 12]);       /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x1007_ed9a, 6);  lea(ecx, memd[ss, ebp - 248]);        /* lea ecx, [ebp-0xf8] */
            ii(0x1007_eda0, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
            ii(0x1007_eda3, 5);  call(0x1008_a838, 0xba90);            /* call 0x1008a838 */
            ii(0x1007_eda8, 2);  mov(ebx, eax);                        /* mov ebx, eax */
            ii(0x1007_edaa, 4);  movsx(edx, memw[ss, ebp - 16]);       /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x1007_edc7, 6);  lea(ecx, memd[ss, ebp - 248]);        /* lea ecx, [ebp-0xf8] */
            ii(0x1007_edcd, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
            ii(0x1007_edd0, 5);  call(0x1008_a838, 0xba63);            /* call 0x1008a838 */
            ii(0x1007_edd5, 2);  mov(ebx, eax);                        /* mov ebx, eax */
            ii(0x1007_edd7, 4);  movsx(edx, memw[ss, ebp - 16]);       /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x1007_edf4, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
            ...
            ii(0x1007_ee0a, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
            ii(0x1007_ee0d, 5);  call(0x1008_8cbc, 0x9eaa);            /* call 0x10088cbc */
            ii(0x1007_ee12, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_ee14, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
