...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_522f()
        {
            ...
            ii(0x523f, 3);  mov(memb[ds, 0x11e8], al);                 /* mov [0x11e8], al */
            ii(0x5242, 2);  sub(ax, ax);                               /* sub ax, ax */
            ii(0x5244, 3);  mov(memw[ds, 0x11ea], ax);                 /* mov [0x11ea], ax */
            ii(0x5247, 3);  mov(memw[ds, 0x11e6], ax);                 /* mov [0x11e6], ax */
            ii(0x524a, 3);  mov(memw[ds, 0x11e4], ax);                 /* mov [0x11e4], ax */
        ...
        l_0x524f:
            ...
            ii(0x525f, 4);  adc(dx, memw[ds, 0x990]);                  /* adc dx, [0x990] */
