...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_e7ae()
        {
            ...
            ii(0xe7d0, 3);  mov(memw[ds, bx + 34], ss);                /* mov [bx+0x22], ss */
            ii(0xe7d3, 3);  mov(memw[ds, bx + 38], bp);                /* mov [bx+0x26], bp */
            ...
            ii(0xe7e4, 2);  shl(ax, 1);                                /* shl ax, 1 */
            ii(0xe7e6, 1);  xchg(di, ax);                              /* xchg di, ax */
            ii(0xe7e7, 5);  if(jmp_abs(memw[cs, di + 1642])) return;   /* jmp word [cs:di+0x66a] */
        l_0xe7ec:
            ii(0xe7ec, 3);  call(0xe863, 0x74);                        /* call 0xe863 */
            ii(0xe7ef, 2);  mov(ax, ss);                               /* mov ax, ss */
            ii(0xe7f1, 2);  mov(es, ax);                               /* mov es, ax */
            ii(0xe7f3, 1);  cld();                                     /* cld */
            ii(0xe7f4, 3);  lea(di, memw[ss, bp + 8]);                 /* lea di, [bp+0x8] */
            ii(0xe7f7, 3);  lea(si, memw[ds, bx + 8]);                 /* lea si, [bx+0x8] */
            ii(0xe7fa, 3);  mov(cx, 8);                                /* mov cx, 0x8 */
            ii(0xe7fd, 2);  rep(() => movsw());                        /* rep movsw */
            ii(0xe7ff, 3);  mov(ax, memw[ds, bx + 38]);                /* mov ax, [bx+0x26] */
            ii(0xe802, 3);  and(ah, 0xe);                              /* and ah, 0xe */
            ii(0xe805, 3);  mov(memw[ss, bp + 38], ax);                /* mov [bp+0x26], ax */
            ii(0xe808, 5);  test(memw[ss, bp + 38], 0x200);            /* test word [bp+0x26], 0x200 */
            ii(0xe80d, 2);  if(jz(0xe810, 1)) goto l_0xe810;           /* jz 0xe810 */
            ii(0xe80f, 1);  sti();                                     /* sti */
        l_0xe810:
            ii(0xe810, 3);  lea(sp, memw[ss, bp - 4]);                 /* lea sp, [bp-0x4] */
            ...
            ii(0xe824, 3);  add(sp, 6);                                /* add sp, 0x6 */
