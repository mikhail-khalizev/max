...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x18_a3d4, 4);  or(memb[ss, bp + 38], 1);               /* or byte [bp+0x26], 0x1 */
            ii(0x18_a3d8, 2);  xor(di, di);                            /* xor di, di */
            ii(0x18_a3da, 4);  mov(memw[ds, 0x38], di);                /* mov [0x38], di */
            ii(0x18_a3de, 3);  mov(di, memw[ss, bp + 18]);             /* mov di, [bp+0x12] */
            ...
            ii(0x18_a3ee, 5);  if(call_abs_up(memw[cs, di + 3120])) return;/* call word [cs:di+0xc30] */
