...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_84a4()
        {
            ...
            ii(0x84ca, 3);  lea(ax, memw[ss, bp - 12]);                /* lea ax, [bp-0xc] */
        ...
        l_0x84f8:
            ...
            ii(0x84ff, 3);  cmp(memw[ss, bp - 10], dx);                /* cmp [bp-0xa], dx */
            ii(0x8502, 2);  if(ja(0x8518, 0x14)) goto l_0x8518;        /* ja 0x8518 */
            ii(0x8504, 2);  if(jb(0x850b, 5)) goto l_0x850b;           /* jb 0x850b */
            ii(0x8506, 3);  cmp(memw[ss, bp - 12], ax);                /* cmp [bp-0xc], ax */
            ii(0x8509, 2);  if(jae(0x8518, 0xd)) goto l_0x8518;        /* jae 0x8518 */
        l_0x850b:
            ii(0x850b, 3);  mov(ax, memw[ss, bp - 12]);                /* mov ax, [bp-0xc] */
            ii(0x850e, 3);  mov(dx, memw[ss, bp - 10]);                /* mov dx, [bp-0xa] */
