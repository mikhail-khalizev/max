...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_8574()
        {
            ...
            ii(0x1014_8586, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1014_858c, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_858f, 5);  call(0x1014_82f4, -0x2a0);            /* call 0x101482f4 */
            ii(0x1014_8594, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
        l_0x1014_8597:
            ii(0x1014_8597, 5);  call(0x1014_82f4, -0x2a8);            /* call 0x101482f4 */
            ii(0x1014_859c, 3);  sub(eax, memd[ss, ebp - 8]);          /* sub eax, [ebp-0x8] */
            ii(0x1014_859f, 3);  cmp(eax, memd[ss, ebp - 4]);          /* cmp eax, [ebp-0x4] */
