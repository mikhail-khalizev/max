...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_3c73()
        {
            ...
            ii(0x1012_3c90, 4);  cmp(memd[ss, ebp + 32], 0);           /* cmp dword [ebp+0x20], 0x0 */
            ii(0x1012_3c94, 2);  if(jz(0x1012_3ca4, 0xe)) goto l_0x1012_3ca4;/* jz 0x10123ca4 */
            ii(0x1012_3c96, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ii(0x1012_3c99, 6);  mov(eax, memd[ds, eax + 160]);        /* mov eax, [eax+0xa0] */
            ii(0x1012_3c9f, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1012_3ca2, 2);  jmp(0x1012_3cb0, 0xc); goto l_0x1012_3cb0;/* jmp 0x10123cb0 */
        l_0x1012_3ca4:
            ii(0x1012_3ca4, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ii(0x1012_3ca7, 6);  mov(eax, memd[ds, eax + 168]);        /* mov eax, [eax+0xa8] */
            ii(0x1012_3cad, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
        l_0x1012_3cb0:
            ii(0x1012_3cb0, 3);  mov(eax, memd[ss, ebp + 24]);         /* mov eax, [ebp+0x18] */
            ii(0x1012_3cb3, 3);  add(eax, memd[ss, ebp - 4]);          /* add eax, [ebp-0x4] */
            ii(0x1012_3cb6, 3);  mov(memb[ds, eax], 0);                /* mov byte [eax], 0x0 */
            ii(0x1012_3cb9, 4);  cmp(memd[ss, ebp - 12], 0);           /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1012_3cbd, 2);  if(jz(0x1012_3cc7, 8)) goto l_0x1012_3cc7;/* jz 0x10123cc7 */
            ii(0x1012_3cbf, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
        ...
        l_0x1012_3cc9:
            ii(0x1012_3cc9, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
        ...
        l_0x1012_3cd8:
            ii(0x1012_3cd8, 7);  mov(memd[ss, ebp - 16], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1012_3cdf, 5);  jmp(0x1012_3d78, 0x94); goto l_0x1012_3d78;/* jmp 0x10123d78 */
        l_0x1012_3ce4:
            ii(0x1012_3ce4, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ii(0x1012_3ce7, 6);  mov(edx, memd[ds, eax + 132]);        /* mov edx, [eax+0x84] */
            ii(0x1012_3ced, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ii(0x1012_3cf0, 6);  mov(eax, memd[ds, eax + 136]);        /* mov eax, [eax+0x88] */
        ...
        l_0x1012_3d02:
            ii(0x1012_3d02, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x1012_3d0a, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1012_3d0d, 3);  inc(memd[ss, ebp - 12]);              /* inc dword [ebp-0xc] */
            ii(0x1012_3d10, 2);  jmp(0x1012_3d02, -0x10); goto l_0x1012_3d02;/* jmp 0x10123d02 */
        l_0x1012_3d12:
            ii(0x1012_3d12, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x1012_3d21, 3);  mov(eax, memd[ss, ebp + 28]);         /* mov eax, [ebp+0x1c] */
        ...
        l_0x1012_3d2c:
            ii(0x1012_3d2c, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1012_3d2f, 3);  inc(memd[ss, ebp - 12]);              /* inc dword [ebp-0xc] */
            ii(0x1012_3d32, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1012_3d35, 3);  inc(memd[ss, ebp - 4]);               /* inc dword [ebp-0x4] */
            ii(0x1012_3d38, 3);  add(edx, memd[ss, ebp + 24]);         /* add edx, [ebp+0x18] */
        ...
        l_0x1012_3d41:
            ii(0x1012_3d41, 3);  mov(eax, memd[ss, ebp + 24]);         /* mov eax, [ebp+0x18] */
            ii(0x1012_3d44, 3);  add(eax, memd[ss, ebp - 4]);          /* add eax, [ebp-0x4] */
            ii(0x1012_3d47, 3);  mov(memb[ds, eax], 0);                /* mov byte [eax], 0x0 */
            ii(0x1012_3d4a, 4);  add(memd[ss, ebp - 12], 2);           /* add dword [ebp-0xc], 0x2 */
            ii(0x1012_3d4e, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x1012_3d56, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ii(0x1012_3d59, 10);  mov(memd[ds, eax + 168], 0);         /* mov dword [eax+0xa8], 0x0 */
            ii(0x1012_3d63, 2);  jmp(0x1012_3d71, 0xc); goto l_0x1012_3d71;/* jmp 0x10123d71 */
        l_0x1012_3d65:
            ii(0x1012_3d65, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1012_3d68, 3);  mov(edx, memd[ss, ebp + 20]);         /* mov edx, [ebp+0x14] */
            ii(0x1012_3d6b, 6);  mov(memd[ds, edx + 168], eax);        /* mov [edx+0xa8], eax */
        l_0x1012_3d71:
            ii(0x1012_3d71, 7);  mov(memd[ss, ebp - 16], 1);           /* mov dword [ebp-0x10], 0x1 */
        l_0x1012_3d78:
            ii(0x1012_3d78, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
