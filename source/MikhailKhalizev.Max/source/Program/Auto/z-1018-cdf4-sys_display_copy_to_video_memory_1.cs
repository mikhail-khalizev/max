...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ sys_display_copy_to_video_memory_1()
        {
            ...
            ii(0x1018_ce00, 3);  mov(eax, memd[ss, ebp + 12]);         /* mov eax, [ebp+0xc] */
            ii(0x1018_ce03, 3);  sub(eax, memd[ss, ebp + 28]);         /* sub eax, [ebp+0x1c] */
            ii(0x1018_ce06, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1018_ce09, 5);  mov(eax, memd[ds, 0x1020_88f8]);      /* mov eax, [0x102088f8] */
            ii(0x1018_ce0e, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1018_ce11, 3);  sub(eax, memd[ss, ebp + 28]);         /* sub eax, [ebp+0x1c] */
            ii(0x1018_ce14, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1018_ce17, 3);  mov(eax, memd[ss, ebp + 24]);         /* mov eax, [ebp+0x18] */
            ii(0x1018_ce1a, 3);  mul(memd[ss, ebp + 12]);              /* mul dword [ebp+0xc] */
            ii(0x1018_ce1d, 3);  add(eax, memd[ss, ebp + 20]);         /* add eax, [ebp+0x14] */
            ...
            ii(0x1018_ce32, 3);  mov(eax, memd[ss, ebp + 40]);         /* mov eax, [ebp+0x28] */
            ii(0x1018_ce35, 3);  mul(memd[ss, ebp - 12]);              /* mul dword [ebp-0xc] */
            ii(0x1018_ce38, 3);  add(eax, memd[ss, ebp + 36]);         /* add eax, [ebp+0x24] */
            ii(0x1018_ce3b, 2);  add(edi, eax);                        /* add edi, eax */
            ii(0x1018_ce3d, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1018_ce40, 3);  mov(edx, memd[ss, ebp - 16]);         /* mov edx, [ebp-0x10] */
            ii(0x1018_ce43, 3);  mov(esi, memd[ss, ebp + 8]);          /* mov esi, [ebp+0x8] */
            ii(0x1018_ce46, 3);  mov(ebx, memd[ss, ebp + 32]);         /* mov ebx, [ebp+0x20] */
        l_0x1018_ce49:
            ii(0x1018_ce49, 3);  mov(ecx, memd[ss, ebp + 28]);         /* mov ecx, [ebp+0x1c] */
        ...
        l_0x1018_ce5a:
            ...
            ii(0x1018_ce5d, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1018_ce60, 3);  mul(memd[ss, ebp + 40]);              /* mul dword [ebp+0x28] */
            ii(0x1018_ce63, 3);  add(eax, memd[ss, ebp + 36]);         /* add eax, [ebp+0x24] */
        ...
        l_0x1018_ce8d:
            ...
            ii(0x1018_ce94, 3);  add(eax, memd[ss, ebp - 12]);         /* add eax, [ebp-0xc] */
            ii(0x1018_ce97, 3);  sub(eax, memd[ss, ebp + 28]);         /* sub eax, [ebp+0x1c] */
            ii(0x1018_ce9a, 5);  mov(edx, 0);                          /* mov edx, 0x0 */
            ii(0x1018_ce9f, 3);  div(memd[ss, ebp - 12]);              /* div dword [ebp-0xc] */
            ii(0x1018_cea2, 3);  cmp(memd[ss, ebp + 32], eax);         /* cmp [ebp+0x20], eax */
            ii(0x1018_cea5, 2);  if(jae(0x1018_ceaa, 3)) goto l_0x1018_ceaa;/* jae 0x1018ceaa */
            ii(0x1018_cea7, 3);  mov(eax, memd[ss, ebp + 32]);         /* mov eax, [ebp+0x20] */
        l_0x1018_ceaa:
            ii(0x1018_ceaa, 2);  or(eax, eax);                         /* or eax, eax */
            ii(0x1018_ceac, 2);  if(jz(0x1018_cec3, 0x15)) goto l_0x1018_cec3;/* jz 0x1018cec3 */
            ii(0x1018_ceae, 3);  sub(memd[ss, ebp + 32], eax);         /* sub [ebp+0x20], eax */
            ii(0x1018_ceb1, 3);  mov(ebx, memd[ss, ebp - 8]);          /* mov ebx, [ebp-0x8] */
            ii(0x1018_ceb4, 3);  mov(edx, memd[ss, ebp - 16]);         /* mov edx, [ebp-0x10] */
        l_0x1018_ceb7:
            ii(0x1018_ceb7, 3);  mov(ecx, memd[ss, ebp + 28]);         /* mov ecx, [ebp+0x1c] */
        ...
        l_0x1018_cec3:
            ii(0x1018_cec3, 3);  or(eax, memd[ss, ebp + 32]);          /* or eax, [ebp+0x20] */
        ...
        l_0x1018_ced7:
            ...
            ii(0x1018_cefa, 3);  mov(ecx, memd[ss, ebp + 28]);         /* mov ecx, [ebp+0x1c] */
            ...
            ii(0x1018_cf04, 3);  add(edi, memd[ss, ebp - 16]);         /* add edi, [ebp-0x10] */
            ii(0x1018_cf07, 3);  dec(memd[ss, ebp + 32]);              /* dec dword [ebp+0x20] */
