...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_34d4()
        {
            ...
            ii(0x1014_34eb, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_34ee, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_34f1, 4);  or(memb[ss, ebp - 12], 1);            /* or byte [ebp-0xc], 0x1 */
            ii(0x1014_34f5, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_34f8, 5);  call(0x1007_64fc, -0xc_d001);         /* call 0x100764fc */
            ii(0x1014_34fd, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1014_3500, 4);  and(memb[ss, ebp - 12], -2 /* 0xfe */);/* and byte [ebp-0xc], 0xfe */
            ii(0x1014_3504, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_3518, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_351b, 5);  call(0x1007_643c, -0xc_d0e4);         /* call 0x1007643c */
        l_0x1014_3520:
            ii(0x1014_3520, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1014_3522, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1014_3532, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_3535, 5);  call(0x1007_63a0, -0xc_d19a);         /* call 0x100763a0 */
            ii(0x1014_353a, 5);  call(0x1007_6204, -0xc_d33b);         /* call 0x10076204 */
            ii(0x1014_353f, 3);  cmp(eax, memd[ss, ebp - 8]);          /* cmp eax, [ebp-0x8] */
            ii(0x1014_3542, 2);  if(jnz(0x1014_3552, 0xe)) goto l_0x1014_3552;/* jnz 0x10143552 */
            ii(0x1014_3544, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_3547, 5);  call(0x1007_63a0, -0xc_d1ac);         /* call 0x100763a0 */
            ii(0x1014_354c, 4);  cmp(memb[ds, eax + 61], 8);           /* cmp byte [eax+0x3d], 0x8 */
            ii(0x1014_3550, 2);  if(jnz(0x1014_3554, 2)) goto l_0x1014_3554;/* jnz 0x10143554 */
        l_0x1014_3552:
            ii(0x1014_3552, 2);  jmp(0x1014_3562, 0xe); goto l_0x1014_3562;/* jmp 0x10143562 */
        l_0x1014_3554:
            ii(0x1014_3554, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_3557, 5);  call(0x1007_63a0, -0xc_d1bc);         /* call 0x100763a0 */
            ii(0x1014_355c, 4);  cmp(memb[ds, eax + 61], 0x1a);        /* cmp byte [eax+0x3d], 0x1a */
            ii(0x1014_3560, 2);  if(jnz(0x1014_3564, 2)) goto l_0x1014_3564;/* jnz 0x10143564 */
        l_0x1014_3562:
            ii(0x1014_3562, 2);  jmp(0x1014_3572, 0xe); goto l_0x1014_3572;/* jmp 0x10143572 */
        l_0x1014_3564:
            ii(0x1014_3564, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_3567, 5);  call(0x1007_63a0, -0xc_d1cc);         /* call 0x100763a0 */
            ii(0x1014_356c, 4);  cmp(memb[ds, eax + 61], 0x10);        /* cmp byte [eax+0x3d], 0x10 */
            ii(0x1014_3570, 2);  if(jnz(0x1014_3577, 5)) goto l_0x1014_3577;/* jnz 0x10143577 */
        l_0x1014_3572:
            ii(0x1014_3572, 5);  jmp(0x1014_35f7, 0x80); goto l_0x1014_35f7;/* jmp 0x101435f7 */
        l_0x1014_3577:
            ii(0x1014_3577, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ...
            ii(0x1014_3588, 3);  lea(edx, memd[ss, ebp - 32]);         /* lea edx, [ebp-0x20] */
            ii(0x1014_358b, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_358e, 5);  call(0x1007_6408, -0xc_d18b);         /* call 0x10076408 */
            ii(0x1014_3593, 5);  call(0x1007_2388, -0xd_1210);         /* call 0x10072388 */
            ii(0x1014_3598, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_359b, 5);  call(0x1007_63a0, -0xc_d200);         /* call 0x100763a0 */
            ii(0x1014_35a0, 5);  cmp(memw[ds, eax + 8], 0x28);         /* cmp word [eax+0x8], 0x28 */
            ii(0x1014_35a5, 2);  if(jnz(0x1014_35da, 0x33)) goto l_0x1014_35da;/* jnz 0x101435da */
            ii(0x1014_35a7, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_35aa, 5);  call(0x1007_63a0, -0xc_d20f);         /* call 0x100763a0 */
            ii(0x1014_35af, 3);  mov(al, memb[ds, eax + 73]);          /* mov al, [eax+0x49] */
            ii(0x1014_35b2, 2);  xor(ah, ah);                          /* xor ah, ah */
            ii(0x1014_35b4, 4);  sub(memw[ss, ebp - 32], ax);          /* sub [ebp-0x20], ax */
            ii(0x1014_35b8, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_35bb, 5);  call(0x1007_63a0, -0xc_d220);         /* call 0x100763a0 */
            ii(0x1014_35c0, 3);  mov(al, memb[ds, eax + 71]);          /* mov al, [eax+0x47] */
            ii(0x1014_35c3, 2);  xor(ah, ah);                          /* xor ah, ah */
            ii(0x1014_35c5, 4);  sub(memw[ss, ebp - 30], ax);          /* sub [ebp-0x1e], ax */
            ii(0x1014_35c9, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_35cc, 5);  call(0x1007_63a0, -0xc_d231);         /* call 0x100763a0 */
            ii(0x1014_35d1, 3);  mov(al, memb[ds, eax + 72]);          /* mov al, [eax+0x48] */
            ii(0x1014_35d4, 2);  xor(ah, ah);                          /* xor ah, ah */
            ii(0x1014_35d6, 4);  sub(memw[ss, ebp - 28], ax);          /* sub [ebp-0x1c], ax */
        l_0x1014_35da:
            ii(0x1014_35da, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
            ii(0x1014_35dd, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_35e0, 3);  sub(memw[ds, edx], ax);               /* sub [edx], ax */
            ii(0x1014_35e3, 3);  mov(eax, memd[ss, ebp - 30]);         /* mov eax, [ebp-0x1e] */
            ii(0x1014_35e6, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_35e9, 4);  sub(memw[ds, edx + 2], ax);           /* sub [edx+0x2], ax */
            ii(0x1014_35ed, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x1014_35f0, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_35f3, 4);  sub(memw[ds, edx + 4], ax);           /* sub [edx+0x4], ax */
        l_0x1014_35f7:
            ii(0x1014_35f7, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x1014_3604:
            ...
            ii(0x1014_3606, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
