...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_bd66()
        {
            ...
            ii(0x1008_bd9d, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1008_bda0, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1008_bda3, 3);  mov(edx, memd[ds, eax + 2]);          /* mov edx, [eax+0x2] */
            ii(0x1008_bda6, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1008_bda9, 3);  call_abs(memd[ds, edx + 20]);         /* call dword [edx+0x14] */
        ...
        l_0x1008_bdb1:
            ...
            ii(0x1008_bdb4, 4);  mov(ax, memw[ds, eax + 13]);          /* mov ax, [eax+0xd] */
