...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void my_play_video_company()
        {
            ...
            ii(0x1011_5811, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1011_5817, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ...
            ii(0x1011_5828, 2);  if(jnz(0x1011_5833, 9)) goto l_0x1011_5833;/* jnz 0x10115833 */
            ii(0x1011_582a, 7);  mov(memd[ss, ebp - 4], 1);            /* mov dword [ebp-0x4], 0x1 */
            ii(0x1011_5831, 2);  jmp(0x1011_583a, 7); goto l_0x1011_583a;/* jmp 0x1011583a */
        l_0x1011_5833:
            ii(0x1011_5833, 7);  mov(memd[ss, ebp - 4], 0);            /* mov dword [ebp-0x4], 0x0 */
        l_0x1011_583a:
            ii(0x1011_583a, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_583d, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_5840, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
