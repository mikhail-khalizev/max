...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_3997()
        {
            ...
            ii(0x1015_39af, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_39b2, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_39b5, 5);  cmp(memw[ds, eax + 8], 0x38);         /* cmp word [eax+0x8], 0x38 */
            ii(0x1015_39ba, 2);  if(jz(0x1015_39c6, 0xa)) goto l_0x1015_39c6;/* jz 0x101539c6 */
            ii(0x1015_39bc, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_39bf, 5);  cmp(memw[ds, eax + 8], 0x4a);         /* cmp word [eax+0x8], 0x4a */
            ii(0x1015_39c4, 2);  if(jnz(0x1015_39d3, 0xd)) goto l_0x1015_39d3;/* jnz 0x101539d3 */
        l_0x1015_39c6:
            ii(0x1015_39c6, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_39c9, 3);  mov(eax, memd[ds, eax + 80]);         /* mov eax, [eax+0x50] */
            ii(0x1015_39cc, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x1015_39cf, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x1015_39d1, 2);  if(jnz(0x1015_39d8, 5)) goto l_0x1015_39d8;/* jnz 0x101539d8 */
        l_0x1015_39d3:
            ii(0x1015_39d3, 5);  jmp(0x1015_3c3f, 0x267); goto l_0x1015_3c3f;/* jmp 0x10153c3f */
        l_0x1015_39d8:
            ii(0x1015_39d8, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_39db, 5);  cmp(memw[ds, eax + 8], 0x4a);         /* cmp word [eax+0x8], 0x4a */
            ii(0x1015_39e0, 2);  if(jnz(0x1015_39eb, 9)) goto l_0x1015_39eb;/* jnz 0x101539eb */
            ii(0x1015_39e2, 7);  mov(memd[ss, ebp - 36], 0x2a);        /* mov dword [ebp-0x24], 0x2a */
            ii(0x1015_39e9, 2);  jmp(0x1015_39f2, 7); goto l_0x1015_39f2;/* jmp 0x101539f2 */
        l_0x1015_39eb:
            ii(0x1015_39eb, 7);  mov(memd[ss, ebp - 36], 0x29);        /* mov dword [ebp-0x24], 0x29 */
        l_0x1015_39f2:
            ii(0x1015_39f2, 3);  mov(eax, memd[ss, ebp - 36]);         /* mov eax, [ebp-0x24] */
            ii(0x1015_39f5, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1015_39f8, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_39fb, 3);  mov(ebx, memd[ds, eax + 26]);         /* mov ebx, [eax+0x1a] */
            ii(0x1015_39fe, 3);  sar(ebx, 0x10);                       /* sar ebx, 0x10 */
            ii(0x1015_3a01, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_3a04, 3);  mov(edx, memd[ds, eax + 24]);         /* mov edx, [eax+0x18] */
            ...
            ii(0x1015_3a16, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_3a19, 5);  call(0x1007_64b8, -0xd_d566);         /* call 0x100764b8 */
        l_0x1015_3a1e:
            ii(0x1015_3a1e, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1015_3a20, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1015_3a2c, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_3a2f, 5);  call(0x1007_63a0, -0xd_d694);         /* call 0x100763a0 */
            ii(0x1015_3a34, 4);  mov(ax, memw[ds, eax + 8]);           /* mov ax, [eax+0x8] */
            ii(0x1015_3a38, 4);  cmp(ax, memw[ss, ebp - 12]);          /* cmp ax, [ebp-0xc] */
            ii(0x1015_3a3c, 2);  if(jnz(0x1015_3a40, 2)) goto l_0x1015_3a40;/* jnz 0x10153a40 */
        l_0x1015_3a3e:
            ii(0x1015_3a3e, 2);  jmp(0x1015_3a4a, 0xa); goto l_0x1015_3a4a;/* jmp 0x10153a4a */
        l_0x1015_3a40:
            ii(0x1015_3a40, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
        ...
        l_0x1015_3a4a:
            ...
            ii(0x1015_3a4c, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1015_3a5a, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
        ...
        l_0x1015_3a67:
            ii(0x1015_3a67, 4);  or(memb[ss, ebp - 8], 1);             /* or byte [ebp-0x8], 0x1 */
            ii(0x1015_3a6b, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x1015_3a6e, 5);  call(Definitions.my_ctor_0x101b_38f8, -0xd_d383);/* call 0x100766f0 */
            ii(0x1015_3a73, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1015_3a76, 4);  and(memb[ss, ebp - 8], -2 /* 0xfe */);/* and byte [ebp-0x8], 0xfe */
            ii(0x1015_3a7a, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ...
            ii(0x1015_3a9b, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_3a9e, 3);  mov(eax, memd[ds, eax + 26]);         /* mov eax, [eax+0x1a] */
            ii(0x1015_3aa1, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x1015_3aa4, 1);  push(eax);                            /* push eax */
            ii(0x1015_3aa5, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_3aa8, 3);  mov(eax, memd[ds, eax + 24]);         /* mov eax, [eax+0x18] */
            ii(0x1015_3aab, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x1015_3aae, 1);  push(eax);                            /* push eax */
            ii(0x1015_3aaf, 2);  xor(ecx, ecx);                        /* xor ecx, ecx */
            ii(0x1015_3ab1, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_3ab4, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ii(0x1015_3ab7, 2);  xor(ah, ah);                          /* xor ah, ah */
            ii(0x1015_3ab9, 3);  movsx(ebx, ax);                       /* movsx ebx, ax */
            ii(0x1015_3abc, 4);  movsx(edx, memw[ss, ebp - 12]);       /* movsx edx, word [ebp-0xc] */
            ii(0x1015_3ac0, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1015_3ac3, 5);  call(0x1015_a2da, 0x6812);            /* call 0x1015a2da */
            ii(0x1015_3ac8, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1015_3aca, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x1015_3acd, 5);  call(0x1008_ac18, -0xc_8eba);         /* call 0x1008ac18 */
            ii(0x1015_3ad2, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1015_3ad4, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1015_3ad7, 5);  call(0x1007_5f2c, -0xd_dbb0);         /* call 0x10075f2c */
            ii(0x1015_3adc, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1015_3ade, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_3ae1, 3);  mov(eax, memd[ds, eax + 24]);         /* mov eax, [eax+0x18] */
            ...
            ii(0x1015_3aed, 3);  mov(memd[ss, ebp - 52], eax);         /* mov [ebp-0x34], eax */
            ii(0x1015_3af0, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1015_3af2, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_3af5, 3);  mov(eax, memd[ds, eax + 26]);         /* mov eax, [eax+0x1a] */
            ...
            ii(0x1015_3b01, 3);  mov(memd[ss, ebp - 48], eax);         /* mov [ebp-0x30], eax */
            ii(0x1015_3b04, 6);  mov(edx, memd[ds, 0x101c_8170]);      /* mov edx, [0x101c8170] */
            ii(0x1015_3b0a, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x1015_3b0d, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_3b10, 3);  mov(eax, memd[ds, eax + 24]);         /* mov eax, [eax+0x18] */
            ii(0x1015_3b13, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x1015_3b16, 3);  add(eax, 2);                          /* add eax, 0x2 */
            ii(0x1015_3b19, 5);  call(Definitions.my_min, -0xc_a39a);  /* call 0x10089784 */
            ii(0x1015_3b1e, 3);  mov(memd[ss, ebp - 44], eax);         /* mov [ebp-0x2c], eax */
            ii(0x1015_3b21, 6);  mov(edx, memd[ds, 0x101c_8172]);      /* mov edx, [0x101c8172] */
            ii(0x1015_3b27, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x1015_3b2a, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_3b2d, 3);  mov(eax, memd[ds, eax + 26]);         /* mov eax, [eax+0x1a] */
            ii(0x1015_3b30, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x1015_3b33, 3);  add(eax, 2);                          /* add eax, 0x2 */
            ii(0x1015_3b36, 5);  call(Definitions.my_min, -0xc_a3b7);  /* call 0x10089784 */
            ii(0x1015_3b3b, 3);  mov(memd[ss, ebp - 40], eax);         /* mov [ebp-0x28], eax */
            ii(0x1015_3b3e, 3);  mov(eax, memd[ss, ebp - 52]);         /* mov eax, [ebp-0x34] */
            ii(0x1015_3b41, 4);  mov(memw[ss, ebp - 32], ax);          /* mov [ebp-0x20], ax */
            ii(0x1015_3b45, 2);  jmp(0x1015_3b4e, 7); goto l_0x1015_3b4e;/* jmp 0x10153b4e */
        l_0x1015_3b47:
            ii(0x1015_3b47, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
            ii(0x1015_3b4a, 4);  inc(memw[ss, ebp - 32]);              /* inc word [ebp-0x20] */
        l_0x1015_3b4e:
            ii(0x1015_3b4e, 4);  movsx(eax, memw[ss, ebp - 32]);       /* movsx eax, word [ebp-0x20] */
            ii(0x1015_3b52, 3);  cmp(eax, memd[ss, ebp - 44]);         /* cmp eax, [ebp-0x2c] */
            ii(0x1015_3b55, 6);  if(jge(0x1015_3bdd, 0x82)) goto l_0x1015_3bdd;/* jge 0x10153bdd */
            ii(0x1015_3b5b, 3);  mov(eax, memd[ss, ebp - 48]);         /* mov eax, [ebp-0x30] */
            ii(0x1015_3b5e, 4);  mov(memw[ss, ebp - 30], ax);          /* mov [ebp-0x1e], ax */
            ii(0x1015_3b62, 2);  jmp(0x1015_3b6b, 7); goto l_0x1015_3b6b;/* jmp 0x10153b6b */
        l_0x1015_3b64:
            ii(0x1015_3b64, 3);  mov(eax, memd[ss, ebp - 30]);         /* mov eax, [ebp-0x1e] */
            ii(0x1015_3b67, 4);  inc(memw[ss, ebp - 30]);              /* inc word [ebp-0x1e] */
        l_0x1015_3b6b:
            ii(0x1015_3b6b, 4);  movsx(eax, memw[ss, ebp - 30]);       /* movsx eax, word [ebp-0x1e] */
            ii(0x1015_3b6f, 3);  cmp(eax, memd[ss, ebp - 40]);         /* cmp eax, [ebp-0x28] */
            ii(0x1015_3b72, 2);  if(jge(0x1015_3bd8, 0x64)) goto l_0x1015_3bd8;/* jge 0x10153bd8 */
            ii(0x1015_3b74, 4);  movsx(ebx, memw[ss, ebp - 30]);       /* movsx ebx, word [ebp-0x1e] */
            ii(0x1015_3b78, 4);  movsx(edx, memw[ss, ebp - 32]);       /* movsx edx, word [ebp-0x20] */
            ...
            ii(0x1015_3b88, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_3b8b, 5);  call(0x1007_643c, -0xd_d754);         /* call 0x1007643c */
            ii(0x1015_3b90, 2);  jmp(0x1015_3b9a, 8); goto l_0x1015_3b9a;/* jmp 0x10153b9a */
        l_0x1015_3b92:
            ii(0x1015_3b92, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_3b95, 5);  call(0x1007_6bf8, -0xd_cfa2);         /* call 0x10076bf8 */
        l_0x1015_3b9a:
            ii(0x1015_3b9a, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1015_3b9c, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x1015_3ba8, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_3bab, 5);  call(0x1007_63a0, -0xd_d810);         /* call 0x100763a0 */
            ii(0x1015_3bb0, 5);  cmp(memw[ds, eax + 8], 0x39);         /* cmp word [eax+0x8], 0x39 */
            ii(0x1015_3bb5, 2);  if(jnz(0x1015_3bd4, 0x1d)) goto l_0x1015_3bd4;/* jnz 0x10153bd4 */
            ii(0x1015_3bb7, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_3bba, 5);  call(0x1007_63a0, -0xd_d81f);         /* call 0x100763a0 */
            ii(0x1015_3bbf, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ii(0x1015_3bc2, 2);  xor(ah, ah);                          /* xor ah, ah */
            ii(0x1015_3bc4, 3);  movsx(edx, ax);                       /* movsx edx, ax */
            ii(0x1015_3bc7, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
        ...
        l_0x1015_3bdd:
            ii(0x1015_3bdd, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_3be0, 4);  dec(memw[ds, eax + 82]);              /* dec word [eax+0x52] */
            ii(0x1015_3be4, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_3be7, 3);  mov(eax, memd[ds, eax + 80]);         /* mov eax, [eax+0x50] */
            ...
            ii(0x1015_3bf1, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_3bf4, 7);  mov(memb[ds, eax + 166], 0);          /* mov byte [eax+0xa6], 0x0 */
        l_0x1015_3bfb:
            ii(0x1015_3bfb, 5);  mov(edx, 0x101c_37bc);                /* mov edx, 0x101c37bc */
            ii(0x1015_3c00, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1015_3c0c, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_3c0f, 5);  call(0x1010_094d, -0x5_32c7);         /* call 0x1010094d */
            ii(0x1015_3c14, 5);  mov(ecx, 1);                          /* mov ecx, 0x1 */
            ii(0x1015_3c19, 5);  mov(ebx, 0xf);                        /* mov ebx, 0xf */
            ii(0x1015_3c1e, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
        ...
        l_0x1015_3c2b:
            ...
            ii(0x1015_3c2d, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x1015_3c30, 5);  call(0x1007_5f2c, -0xd_dd09);         /* call 0x10075f2c */
            ii(0x1015_3c35, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1015_3c37, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
