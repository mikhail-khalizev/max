...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_f8d5()
        {
            ...
            ii(0x100a_f8ea, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x100a_f8ed, 3);  mov(memd[ss, ebp - 12], edx);         /* mov [ebp-0xc], edx */
            ii(0x100a_f8f0, 3);  mov(memd[ss, ebp - 8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x100a_f8f3, 3);  mov(memd[ss, ebp - 4], ecx);          /* mov [ebp-0x4], ecx */
            ii(0x100a_f8f6, 3);  mov(edx, memd[ss, ebp - 16]);         /* mov edx, [ebp-0x10] */
            ii(0x100a_f8f9, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x100a_f8fc, 5);  call(0x1008_a5f0, -0x2_5311);         /* call 0x1008a5f0 */
            ii(0x100a_f901, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100a_f904, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x100a_f907, 3);  lea(edx, memd[ss, ebp - 20]);         /* lea edx, [ebp-0x14] */
            ii(0x100a_f90a, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x100a_f92a, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x100a_f937:
            ...
            ii(0x100a_f942, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x100a_f951, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x100a_f95e:
            ii(0x100a_f95e, 3);  lea(edx, memd[ss, ebp - 28]);         /* lea edx, [ebp-0x1c] */
            ii(0x100a_f961, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x100a_f964, 5);  call(0x100b_7e0c, 0x84a3);            /* call 0x100b7e0c */
            ii(0x100a_f969, 5);  call(0x100b_8204, 0x8896);            /* call 0x100b8204 */
            ii(0x100a_f96e, 3);  lea(edx, memd[ss, ebp - 32]);         /* lea edx, [ebp-0x20] */
            ii(0x100a_f971, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_f974, 5);  call(0x100b_8204, 0x888b);            /* call 0x100b8204 */
            ii(0x100a_f979, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x100a_f989, 3);  mov(ebx, memd[ds, eax + 26]);         /* mov ebx, [eax+0x1a] */
            ii(0x100a_f98c, 3);  sar(ebx, 0x10);                       /* sar ebx, 0x10 */
            ii(0x100a_f98f, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x100a_f99f, 3);  mov(edx, memd[ds, eax + 24]);         /* mov edx, [eax+0x18] */
            ii(0x100a_f9a2, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x100a_f9a5, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
            ii(0x100a_f9a8, 5);  call(0x1007_6aac, -0x3_8f01);         /* call 0x10076aac */
            ii(0x100a_f9ad, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x100a_f9b0, 5);  call(0x100b_82bc, 0x8907);            /* call 0x100b82bc */
            ii(0x100a_f9b5, 3);  mov(memd[ss, ebp - 40], eax);         /* mov [ebp-0x28], eax */
            ii(0x100a_f9b8, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ii(0x100a_f9bc, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x100a_f9be, 2);  if(jle(0x100a_f9c9, 9)) goto l_0x100a_f9c9;/* jle 0x100af9c9 */
            ii(0x100a_f9c0, 7);  mov(memd[ss, ebp - 44], 0);           /* mov dword [ebp-0x2c], 0x0 */
        ...
        l_0x100a_f9c9:
            ...
            ii(0x100a_f9df, 3);  mov(memd[ss, ebp - 44], eax);         /* mov [ebp-0x2c], eax */
        l_0x100a_f9e2:
            ii(0x100a_f9e2, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x100a_f9e5, 5);  call(0x100b_82bc, 0x88d2);            /* call 0x100b82bc */
            ii(0x100a_f9ea, 4);  cmp(ax, memw[ss, ebp - 40]);          /* cmp ax, [ebp-0x28] */
            ii(0x100a_f9ee, 2);  if(jge(0x100a_f9fb, 0xb)) goto l_0x100a_f9fb;/* jge 0x100af9fb */
            ii(0x100a_f9f0, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x100a_f9f3, 5);  call(0x100b_82bc, 0x88c4);            /* call 0x100b82bc */
            ii(0x100a_f9f8, 3);  mov(memd[ss, ebp - 40], eax);         /* mov [ebp-0x28], eax */
        l_0x100a_f9fb:
            ii(0x100a_f9fb, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ii(0x100a_f9ff, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x100a_fa01, 2);  if(jle(0x100a_fa0c, 9)) goto l_0x100a_fa0c;/* jle 0x100afa0c */
            ii(0x100a_fa03, 7);  mov(memd[ss, ebp - 48], 0);           /* mov dword [ebp-0x30], 0x0 */
        ...
        l_0x100a_fa0c:
            ...
            ii(0x100a_fa22, 3);  mov(memd[ss, ebp - 48], eax);         /* mov [ebp-0x30], eax */
        l_0x100a_fa25:
            ii(0x100a_fa25, 7);  mov(memd[ss, ebp - 52], 0);           /* mov dword [ebp-0x34], 0x0 */
            ii(0x100a_fa2c, 2);  jmp(0x100a_fa34, 6); goto l_0x100a_fa34;/* jmp 0x100afa34 */
        l_0x100a_fa2e:
            ii(0x100a_fa2e, 3);  mov(eax, memd[ss, ebp - 52]);         /* mov eax, [ebp-0x34] */
            ii(0x100a_fa31, 3);  inc(memd[ss, ebp - 52]);              /* inc dword [ebp-0x34] */
        l_0x100a_fa34:
            ii(0x100a_fa34, 3);  mov(eax, memd[ss, ebp - 52]);         /* mov eax, [ebp-0x34] */
            ii(0x100a_fa37, 4);  cmp(ax, memw[ss, ebp - 40]);          /* cmp ax, [ebp-0x28] */
            ii(0x100a_fa3b, 2);  if(jge(0x100a_faac, 0x6f)) goto l_0x100a_faac;/* jge 0x100afaac */
            ii(0x100a_fa3d, 4);  movsx(edx, memw[ss, ebp - 52]);       /* movsx edx, word [ebp-0x34] */
            ii(0x100a_fa41, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x100a_fa44, 5);  call(0x100b_827c, 0x8833);            /* call 0x100b827c */
            ii(0x100a_fa49, 4);  movsx(ax, memb[ds, eax]);             /* movsx ax, byte [eax] */
            ii(0x100a_fa4d, 4);  add(memw[ss, ebp - 36], ax);          /* add [ebp-0x24], ax */
            ii(0x100a_fa51, 4);  movsx(edx, memw[ss, ebp - 52]);       /* movsx edx, word [ebp-0x34] */
            ii(0x100a_fa55, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x100a_fa58, 5);  call(0x100b_827c, 0x881f);            /* call 0x100b827c */
            ii(0x100a_fa5d, 5);  movsx(ax, memb[ds, eax + 1]);         /* movsx ax, byte [eax+0x1] */
            ii(0x100a_fa62, 4);  add(memw[ss, ebp - 34], ax);          /* add [ebp-0x22], ax */
            ii(0x100a_fa66, 4);  movsx(edx, memw[ss, ebp - 52]);       /* movsx edx, word [ebp-0x34] */
            ii(0x100a_fa6a, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x100a_fa6d, 5);  call(0x100b_827c, 0x880a);            /* call 0x100b827c */
            ii(0x100a_fa72, 2);  mov(ebx, eax);                        /* mov ebx, eax */
            ii(0x100a_fa74, 4);  movsx(edx, memw[ss, ebp - 52]);       /* movsx edx, word [ebp-0x34] */
            ii(0x100a_fa78, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ...
            ii(0x100a_fa86, 4);  movsx(edx, memw[ss, ebp - 52]);       /* movsx edx, word [ebp-0x34] */
            ii(0x100a_fa8a, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x100a_fa8d, 5);  call(0x100b_827c, 0x87ea);            /* call 0x100b827c */
            ii(0x100a_fa92, 2);  mov(ebx, eax);                        /* mov ebx, eax */
            ii(0x100a_fa94, 4);  movsx(edx, memw[ss, ebp - 52]);       /* movsx edx, word [ebp-0x34] */
            ii(0x100a_fa98, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
        ...
        l_0x100a_faac:
            ii(0x100a_faac, 3);  lea(edx, memd[ss, ebp - 36]);         /* lea edx, [ebp-0x24] */
            ii(0x100a_faaf, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x100a_fabf, 3);  mov(eax, memd[ss, ebp - 52]);         /* mov eax, [ebp-0x34] */
            ii(0x100a_fac2, 4);  cmp(ax, memw[ss, ebp - 40]);          /* cmp ax, [ebp-0x28] */
            ...
            ii(0x100a_facb, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x100a_fadd:
            ...
            ii(0x100a_fae7, 3);  mov(memd[ss, ebp - 56], eax);         /* mov [ebp-0x38], eax */
            ii(0x100a_faea, 3);  mov(eax, memd[ss, ebp - 56]);         /* mov eax, [ebp-0x38] */
            ii(0x100a_faed, 3);  mov(memd[ss, ebp - 60], eax);         /* mov [ebp-0x3c], eax */
            ii(0x100a_faf0, 4);  cmp(memd[ss, ebp - 60], 0);           /* cmp dword [ebp-0x3c], 0x0 */
            ii(0x100a_faf4, 2);  if(jz(0x100a_fb11, 0x1b)) goto l_0x100a_fb11;/* jz 0x100afb11 */
            ii(0x100a_faf6, 4);  movsx(ebx, memw[ss, ebp - 34]);       /* movsx ebx, word [ebp-0x22] */
            ii(0x100a_fafa, 4);  movsx(edx, memw[ss, ebp - 36]);       /* movsx edx, word [ebp-0x24] */
            ii(0x100a_fafe, 3);  mov(eax, memd[ss, ebp - 56]);         /* mov eax, [ebp-0x38] */
            ii(0x100a_fb01, 5);  call(Definitions.my_ctor_c20, 0x6_a450);/* call 0x10119f56 */
            ii(0x100a_fb06, 3);  mov(memd[ss, ebp - 64], eax);         /* mov [ebp-0x40], eax */
            ii(0x100a_fb09, 3);  mov(eax, memd[ss, ebp - 64]);         /* mov eax, [ebp-0x40] */
            ii(0x100a_fb0c, 3);  mov(memd[ss, ebp - 68], eax);         /* mov [ebp-0x44], eax */
            ii(0x100a_fb0f, 2);  jmp(0x100a_fb17, 6); goto l_0x100a_fb17;/* jmp 0x100afb17 */
        l_0x100a_fb11:
            ii(0x100a_fb11, 3);  mov(eax, memd[ss, ebp - 60]);         /* mov eax, [ebp-0x3c] */
            ii(0x100a_fb14, 3);  mov(memd[ss, ebp - 68], eax);         /* mov [ebp-0x44], eax */
        l_0x100a_fb17:
            ii(0x100a_fb17, 3);  mov(edx, memd[ss, ebp - 68]);         /* mov edx, [ebp-0x44] */
            ii(0x100a_fb1a, 3);  lea(eax, memd[ss, ebp - 72]);         /* lea eax, [ebp-0x48] */
            ii(0x100a_fb1d, 5);  call(0x100a_b3b0, -0x4772);           /* call 0x100ab3b0 */
            ii(0x100a_fb22, 7);  mov(memd[ss, ebp - 76], 0);           /* mov dword [ebp-0x4c], 0x0 */
            ii(0x100a_fb29, 2);  jmp(0x100a_fb31, 6); goto l_0x100a_fb31;/* jmp 0x100afb31 */
        l_0x100a_fb2b:
            ii(0x100a_fb2b, 3);  mov(eax, memd[ss, ebp - 76]);         /* mov eax, [ebp-0x4c] */
            ii(0x100a_fb2e, 3);  inc(memd[ss, ebp - 76]);              /* inc dword [ebp-0x4c] */
        l_0x100a_fb31:
            ii(0x100a_fb31, 3);  mov(eax, memd[ss, ebp - 76]);         /* mov eax, [ebp-0x4c] */
            ii(0x100a_fb34, 4);  cmp(ax, memw[ss, ebp - 52]);          /* cmp ax, [ebp-0x34] */
            ii(0x100a_fb38, 2);  if(jg(0x100a_fb70, 0x36)) goto l_0x100a_fb70;/* jg 0x100afb70 */
            ii(0x100a_fb3a, 4);  movsx(edx, memw[ss, ebp - 76]);       /* movsx edx, word [ebp-0x4c] */
            ii(0x100a_fb3e, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x100a_fb4e, 4);  movsx(edx, memw[ss, ebp - 76]);       /* movsx edx, word [ebp-0x4c] */
            ii(0x100a_fb52, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x100a_fb61, 3);  lea(eax, memd[ss, ebp - 72]);         /* lea eax, [ebp-0x48] */
        ...
        l_0x100a_fb70:
            ii(0x100a_fb70, 3);  lea(eax, memd[ss, ebp - 72]);         /* lea eax, [ebp-0x48] */
            ii(0x100a_fb73, 5);  call(0x100a_b33c, -0x483c);           /* call 0x100ab33c */
            ii(0x100a_fb78, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x100a_fb7a, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
