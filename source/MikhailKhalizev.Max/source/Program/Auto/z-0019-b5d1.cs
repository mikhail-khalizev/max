...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_b5d1()
        {
            ...
            ii(0x19_b5de, 4);  push(memw[es, bx + 100]);               /* push word [es:bx+0x64] */
            ii(0x19_b5e2, 4);  push(memw[es, bx + 98]);                /* push word [es:bx+0x62] */
            ii(0x19_b5e6, 3);  call(0x19_c975, 0x138c);                /* call 0xc975 */
            ii(0x19_b5e9, 3);  mov(memw[ss, bp - 28], dx);             /* mov [bp-0x1c], dx */
        ...
        l_0x19_b5f5:
            ...
            ii(0x19_b5f9, 3);  push(memw[ss, bp - 28]);                /* push word [bp-0x1c] */
