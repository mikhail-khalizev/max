...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_ad2f()
        {
            ...
            ii(0x1012_ad63, 4);  mov(memb[ds, eax + 15], 0);           /* mov byte [eax+0xf], 0x0 */
        ...
        l_0x1012_ad93:
            ...
            ii(0x1012_ad98, 3);  mov(al, memb[ds, eax + 15]);          /* mov al, [eax+0xf] */
        ...
        l_0x1012_adb1:
            ...
            ii(0x1012_adb6, 4);  mov(memb[ss, ebp - 12], 0);           /* mov byte [ebp-0xc], 0x0 */
            ii(0x1012_adba, 2);  jmp(0x1012_adc2, 6); goto l_0x1012_adc2;/* jmp 0x1012adc2 */
        l_0x1012_adbc:
            ii(0x1012_adbc, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
            ii(0x1012_adbf, 3);  inc(memb[ss, ebp - 12]);              /* inc byte [ebp-0xc] */
        l_0x1012_adc2:
            ii(0x1012_adc2, 2);  xor(eax, eax);                        /* xor eax, eax */
            ii(0x1012_adc4, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
            ...
            ii(0x1012_adce, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
            ...
            ii(0x1012_ade9, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
        ...
        l_0x1012_adf5:
            ...
            ii(0x1012_adfa, 4);  mov(memb[ds, eax + 10], 1);           /* mov byte [eax+0xa], 0x1 */
        l_0x1012_adfe:
