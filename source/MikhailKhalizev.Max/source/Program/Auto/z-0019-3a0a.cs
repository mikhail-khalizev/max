...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_3a0a()
        {
            ...
            ii(0x19_3a12, 3);  les(di, memw[ss, bp + 6]);              /* les di, [bp+0x6] */
            ii(0x19_3a15, 2);  xor(ax, ax);                            /* xor ax, ax */
            ii(0x19_3a17, 3);  mov(cx, 0xffff);                        /* mov cx, 0xffff */
            ii(0x19_3a1a, 2);  repne(() => scasb());                   /* repne scasb */
            ii(0x19_3a1c, 3);  lea(si, memw[ds, di - 1]);              /* lea si, [di-0x1] */
            ii(0x19_3a1f, 3);  les(di, memw[ss, bp + 10]);             /* les di, [bp+0xa] */
            ...
            ii(0x19_3a2f, 3);  mov(es, memw[ss, bp + 8]);              /* mov es, [bp+0x8] */
            ii(0x19_3a32, 2);  xchg(si, di);                           /* xchg si, di */
            ii(0x19_3a34, 3);  mov(ax, memw[ss, bp + 6]);              /* mov ax, [bp+0x6] */
            ii(0x19_3a37, 4);  test(si, 1);                            /* test si, 0x1 */
            ii(0x19_3a3b, 2);  if(jz(0x19_3a3f, 2)) goto l_0x19_3a3f;  /* jz 0x3a3f */
            ii(0x19_3a3d, 1);  movsb();                                /* movsb */
            ii(0x19_3a3e, 1);  dec(cx);                                /* dec cx */
        l_0x19_3a3f:
            ii(0x19_3a3f, 2);  shr(cx, 1);                             /* shr cx, 1 */
