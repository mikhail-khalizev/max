...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_c6c8()
        {
            ...
            ii(0x1009_c6da, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1009_c6e0, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_c6e3, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_c6e6, 5);  call(0x1007_6b58, -0x2_5b93);         /* call 0x10076b58 */
            ii(0x1009_c6eb, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_c6ee, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
