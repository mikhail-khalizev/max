...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_a481()
        {
            ...
            ii(0xa48a, 4);  mov(cx, memw[ss, bx + 8]);                 /* mov cx, [ss:bx+0x8] */
            ii(0xa48e, 4);  mov(di, memw[ss, bx + 6]);                 /* mov di, [ss:bx+0x6] */
            ii(0xa492, 4);  mov(si, memw[ss, bx + 4]);                 /* mov si, [ss:bx+0x4] */
            ii(0xa496, 4);  mov(ds, memw[ss, bx + 2]);                 /* mov ds, [ss:bx+0x2] */
            ii(0xa49a, 1);  cld();                                     /* cld */
