...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_97c3()
        {
            ...
            ii(0x97d0, 5);  mov(memw[ss, bp - 14], 0x4201);            /* mov word [bp-0xe], 0x4201 */
            ii(0x97d5, 3);  mov(ax, memw[ds, 0xe70]);                  /* mov ax, [0xe70] */
            ii(0x97d8, 3);  mov(memw[ss, bp - 12], ax);                /* mov [bp-0xc], ax */
            ii(0x97db, 2);  sub(ax, ax);                               /* sub ax, ax */
            ii(0x97dd, 3);  mov(memw[ss, bp - 8], ax);                 /* mov [bp-0x8], ax */
            ii(0x97e0, 3);  mov(memw[ss, bp - 10], ax);                /* mov [bp-0xa], ax */
            ii(0x97e3, 3);  lea(ax, memw[ss, bp - 14]);                /* lea ax, [bp-0xe] */
            ...
            ii(0x97f4, 3);  mov(cx, memw[ss, bp - 14]);                /* mov cx, [bp-0xe] */
            ii(0x97f7, 3);  and(ch, 1);                                /* and ch, 0x1 */
            ii(0x97fa, 2);  sub(ax, cx);                               /* sub ax, cx */
            ii(0x97fc, 3);  mov(memw[ss, bp - 10], ax);                /* mov [bp-0xa], ax */
            ii(0x97ff, 4);  mov(memb[ss, bp - 13], 0x3f);              /* mov byte [bp-0xd], 0x3f */
            ...
            ii(0x980c, 3);  lea(ax, memw[ss, bp - 14]);                /* lea ax, [bp-0xe] */
            ...
            ii(0x981c, 5);  mov(memw[ss, bp - 14], 0);                 /* mov word [bp-0xe], 0x0 */
        l_0x9821:
            ii(0x9821, 3);  mov(ax, memw[ss, bp - 14]);                /* mov ax, [bp-0xe] */
            ...
            ii(0x9834, 3);  mov(ax, memw[ss, bp - 14]);                /* mov ax, [bp-0xe] */
