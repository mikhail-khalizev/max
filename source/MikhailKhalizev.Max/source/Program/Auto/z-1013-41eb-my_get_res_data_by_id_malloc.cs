...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void my_get_res_data_by_id_malloc()
        {
            ...
            ii(0x1013_420f, 7);  mov(memd[ss, ebp - 16], 0);           /* mov dword [ebp-0x10], 0x0 */
        ...
        l_0x1013_421b:
            ...
            ii(0x1013_4226, 7);  mov(memd[ss, ebp - 20], 0);           /* mov dword [ebp-0x14], 0x0 */
        ...
        l_0x1013_422f:
            ...
            ii(0x1013_4245, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
        l_0x1013_4248:
            ...
            ii(0x1013_4259, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1013_425c, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1013_4265, 7);  mov(memd[ss, ebp - 16], 0);           /* mov dword [ebp-0x10], 0x0 */
        ...
        l_0x1013_4271:
            ...
            ii(0x1013_4288, 4);  movsx(edx, memw[ss, ebp - 12]);       /* movsx edx, word [ebp-0xc] */
            ...
            ii(0x1013_42ac, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1013_42bb, 3);  mov(eax, memd[ds, eax + 12]);         /* mov eax, [eax+0xc] */
            ii(0x1013_42be, 1);  inc(eax);                             /* inc eax */
            ii(0x1013_42bf, 5);  call(Definitions.sys_new_arr, 0x3_1d4c);/* call 0x10166010 */
            ii(0x1013_42c4, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1013_42c7, 4);  cmp(memd[ss, ebp - 24], 0);           /* cmp dword [ebp-0x18], 0x0 */
        ...
        l_0x1013_42d7:
            ...
            ii(0x1013_42ea, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1013_42f9, 3);  mov(edx, memd[ds, eax + 12]);         /* mov edx, [eax+0xc] */
            ii(0x1013_42fc, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
        ...
        l_0x1013_4312:
            ii(0x1013_4312, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x1013_4321, 3);  mov(edx, memd[ss, ebp - 24]);         /* mov edx, [ebp-0x18] */
            ii(0x1013_4324, 3);  add(edx, memd[ds, eax + 12]);         /* add edx, [eax+0xc] */
            ii(0x1013_4327, 2);  mov(eax, edx);                        /* mov eax, edx */
            ii(0x1013_4329, 3);  mov(memb[ds, eax], 0);                /* mov byte [eax], 0x0 */
            ii(0x1013_432c, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x1013_432f, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
        l_0x1013_4332:
            ii(0x1013_4332, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
