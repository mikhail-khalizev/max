...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_2023()
        {
            ...
            ii(0x1015_203a, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1015_203d, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1015_2040, 4);  mov(memb[ss, ebp - 12], 0);           /* mov byte [ebp-0xc], 0x0 */
            ii(0x1015_2044, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1015_2046, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1015_2055, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_2058, 3);  mov(eax, memd[ds, eax + 80]);         /* mov eax, [eax+0x50] */
            ...
            ii(0x1015_2062, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_2065, 4);  dec(memw[ds, eax + 82]);              /* dec word [eax+0x52] */
            ii(0x1015_2069, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
        l_0x1015_206d:
            ii(0x1015_206d, 2);  jmp(0x1015_20ba, 0x4b); goto l_0x1015_20ba;/* jmp 0x101520ba */
        l_0x1015_206f:
            ii(0x1015_206f, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x1015_2072, 5);  call(0x1007_20b1, -0xd_ffc6);         /* call 0x100720b1 */
            ii(0x1015_2077, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
            ii(0x1015_207a, 5);  call(0x1007_20b1, -0xd_ffce);         /* call 0x100720b1 */
            ii(0x1015_207f, 3);  lea(ebx, memd[ss, ebp - 36]);         /* lea ebx, [ebp-0x24] */
            ii(0x1015_2082, 3);  lea(edx, memd[ss, ebp - 24]);         /* lea edx, [ebp-0x18] */
            ii(0x1015_2085, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1015_2095, 4);  movsx(eax, memw[ss, ebp - 22]);       /* movsx eax, word [ebp-0x16] */
            ii(0x1015_2099, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x1015_209b, 2);  if(jle(0x1015_20ba, 0x1d)) goto l_0x1015_20ba;/* jle 0x101520ba */
            ii(0x1015_209d, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
            ...
            ii(0x1015_20aa, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1015_20ba:
            ii(0x1015_20ba, 4);  cmp(memb[ss, ebp - 12], 0);           /* cmp byte [ebp-0xc], 0x0 */
            ...
            ii(0x1015_20c5, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1015_20d1, 5);  mov(ecx, 1);                          /* mov ecx, 0x1 */
            ii(0x1015_20d6, 5);  mov(ebx, 0xf);                        /* mov ebx, 0xf */
            ii(0x1015_20db, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ii(0x1015_20de, 5);  mov(eax, 0x101c_7278);                /* mov eax, 0x101c7278 */
            ii(0x1015_20e3, 5);  call(0x1013_d5c0, -0x1_4b28);         /* call 0x1013d5c0 */
        l_0x1015_20e8:
            ii(0x1015_20e8, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_20eb, 3);  add(eax, 0x6c);                       /* add eax, 0x6c */
            ii(0x1015_20ee, 5);  call(0x1007_6730, -0xd_b9c3);         /* call 0x10076730 */
            ii(0x1015_20f3, 3);  mov(dl, memb[ds, eax + 27]);          /* mov dl, [eax+0x1b] */
            ii(0x1015_20f6, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_20f9, 3);  mov(memb[ds, eax + 84], dl);          /* mov [eax+0x54], dl */
        l_0x1015_20fc:
            ii(0x1015_20fc, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_20ff, 5);  call(0x1014_f08b, -0x3079);           /* call 0x1014f08b */
            ii(0x1015_2104, 5);  mov(edx, 0x101c_37bc);                /* mov edx, 0x101c37bc */
            ii(0x1015_2109, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_210c, 5);  call(0x1007_6d98, -0xd_b379);         /* call 0x10076d98 */
            ii(0x1015_2111, 2);  test(al, al);                         /* test al, al */
            ii(0x1015_2113, 2);  if(jz(0x1015_211d, 8)) goto l_0x1015_211d;/* jz 0x1015211d */
            ii(0x1015_2115, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
