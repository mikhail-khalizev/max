...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_b51c()
        {
            ...
            ii(0x1009_b534, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1009_b537, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_b53a, 3);  add(eax, 0x13);                       /* add eax, 0x13 */
            ii(0x1009_b53d, 5);  call(0x1007_6338, -0x2_520a);         /* call 0x10076338 */
            ii(0x1009_b542, 3);  lea(ebx, memd[ss, ebp - 8]);          /* lea ebx, [ebp-0x8] */
            ...
            ii(0x1009_b54e, 2);  jmp(0x1009_b558, 8); goto l_0x1009_b558;/* jmp 0x1009b558 */
        l_0x1009_b550:
            ii(0x1009_b550, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
            ii(0x1009_b553, 5);  call(0x1007_6bf8, -0x2_4960);         /* call 0x10076bf8 */
        l_0x1009_b558:
            ii(0x1009_b558, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1009_b55a, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
            ...
            ii(0x1009_b566, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1009_b569, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1009_b56c, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1009_b56f, 3);  mov(ebx, memd[ds, eax + 2]);          /* mov ebx, [eax+0x2] */
            ii(0x1009_b572, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
            ii(0x1009_b575, 5);  call(0x1007_63d4, -0x2_51a6);         /* call 0x100763d4 */
            ii(0x1009_b57a, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1009_b57c, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1009_b57f, 3);  call_abs(memd[ds, ebx + 68]);         /* call dword [ebx+0x44] */
            ...
            ii(0x1009_b588, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
        ...
        l_0x1009_b594:
            ...
            ii(0x1009_b596, 3);  lea(eax, memd[ss, ebp - 8]);          /* lea eax, [ebp-0x8] */
