...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_1cb4()
        {
            ...
            ii(0x1013_1cbc, 6);  sub(esp, 4);                          /* sub esp, 0x4 */
            ii(0x1013_1cc2, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1013_1cc5, 5);  mov(edx, 0x101c_3678);                /* mov edx, 0x101c3678 */
            ii(0x1013_1cca, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_1ccd, 5);  call(0x100d_4d78, -0x5_cf5a);         /* call 0x100d4d78 */
            ii(0x1013_1cd2, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
