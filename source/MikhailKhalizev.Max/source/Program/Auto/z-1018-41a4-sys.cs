...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_41a4()
        {
            ...
            ii(0x1018_41aa, 4);  mov(memd[ss, esp + 52], eax);         /* mov [esp+0x34], eax */
            ii(0x1018_41ae, 4);  mov(memd[ss, esp + 56], edx);         /* mov [esp+0x38], edx */
            ii(0x1018_41b2, 4);  mov(memd[ss, esp + 44], ebx);         /* mov [esp+0x2c], ebx */
            ii(0x1018_41b6, 4);  mov(memd[ss, esp + 36], ecx);         /* mov [esp+0x24], ecx */
            ii(0x1018_41ba, 5);  mov(edx, 0xffff_ffff);                /* mov edx, 0xffffffff */
            ii(0x1018_41bf, 4);  mov(ebx, memd[ss, esp + 92]);         /* mov ebx, [esp+0x5c] */
            ii(0x1018_41c3, 4);  mov(memd[ss, esp + 32], edx);         /* mov [esp+0x20], edx */
            ...
            ii(0x1018_41d8, 3);  mov(eax, memd[ds, eax + 44]);         /* mov eax, [eax+0x2c] */
            ii(0x1018_41db, 4);  mov(edx, memd[ss, esp + 96]);         /* mov edx, [esp+0x60] */
            ii(0x1018_41df, 4);  mov(memd[ss, esp + 24], eax);         /* mov [esp+0x18], eax */
            ii(0x1018_41e3, 7);  lea(eax, memd[ds, edx * 8]);          /* lea eax, [edx*8] */
            ii(0x1018_41ea, 2);  add(eax, edx);                        /* add eax, edx */
            ii(0x1018_41ec, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x1018_41ef, 3);  lea(edx, memd[ds, ebx + eax]);        /* lea edx, [ebx+eax] */
            ii(0x1018_41f2, 3);  mov(eax, memd[ds, edx + 24]);         /* mov eax, [edx+0x18] */
            ii(0x1018_41f5, 4);  mov(memd[ss, esp + 8], eax);          /* mov [esp+0x8], eax */
            ii(0x1018_41f9, 3);  mov(eax, memd[ds, edx + 28]);         /* mov eax, [edx+0x1c] */
            ii(0x1018_41fc, 4);  mov(memd[ss, esp + 4], eax);          /* mov [esp+0x4], eax */
            ii(0x1018_4200, 3);  mov(ebx, memd[ds, edx + 36]);         /* mov ebx, [edx+0x24] */
            ii(0x1018_4203, 2);  sub(ebx, eax);                        /* sub ebx, eax */
            ii(0x1018_4205, 4);  mov(eax, memd[ss, esp + 92]);         /* mov eax, [esp+0x5c] */
            ii(0x1018_4209, 4);  mov(ecx, memd[ss, esp + 8]);          /* mov ecx, [esp+0x8] */
            ii(0x1018_420d, 3);  mov(edi, memd[ds, edx + 32]);         /* mov edi, [edx+0x20] */
            ...
            ii(0x1018_421b, 4);  mov(eax, memd[ss, esp + 92]);         /* mov eax, [esp+0x5c] */
            ii(0x1018_421f, 1);  inc(edi);                             /* inc edi */
            ii(0x1018_4220, 6);  mov(dl, memb[ds, eax + 565]);         /* mov dl, [eax+0x235] */
            ...
            ii(0x1018_422c, 6);  mov(eax, memd[ds, eax + 564]);        /* mov eax, [eax+0x234] */
            ...
            ii(0x1018_4246, 4);  mov(eax, memd[ss, esp + 92]);         /* mov eax, [esp+0x5c] */
            ii(0x1018_424a, 6);  mov(eax, memd[ds, eax + 564]);        /* mov eax, [eax+0x234] */
            ii(0x1018_4250, 3);  xor(ax, ax);                          /* xor ax, ax */
            ii(0x1018_4253, 2);  or(eax, edx);                         /* or eax, edx */
            ii(0x1018_4255, 2);  jmp(0x1018_425d, 6); goto l_0x1018_425d;/* jmp 0x1018425d */
        l_0x1018_4257:
            ii(0x1018_4257, 6);  mov(eax, memd[ds, eax + 564]);        /* mov eax, [eax+0x234] */
        l_0x1018_425d:
            ii(0x1018_425d, 4);  mov(memd[ss, esp + 16], eax);         /* mov [esp+0x10], eax */
            ii(0x1018_4261, 4);  mov(eax, memd[ss, esp + 92]);         /* mov eax, [esp+0x5c] */
            ii(0x1018_4265, 7);  test(memb[ds, eax + 569], 0xff);      /* test byte [eax+0x239], 0xff */
            ii(0x1018_426c, 2);  if(jz(0x1018_429c, 0x2e)) goto l_0x1018_429c;/* jz 0x1018429c */
            ii(0x1018_426e, 6);  mov(eax, memd[ds, eax + 568]);        /* mov eax, [eax+0x238] */
            ...
            ii(0x1018_4286, 4);  mov(edx, memd[ss, esp + 92]);         /* mov edx, [esp+0x5c] */
            ii(0x1018_428a, 6);  mov(edx, memd[ds, edx + 568]);        /* mov edx, [edx+0x238] */
            ii(0x1018_4290, 3);  xor(dx, dx);                          /* xor dx, dx */
            ii(0x1018_4293, 5);  and(eax, 0xff);                       /* and eax, 0xff */
            ii(0x1018_4298, 2);  or(eax, edx);                         /* or eax, edx */
            ii(0x1018_429a, 2);  jmp(0x1018_42a2, 6); goto l_0x1018_42a2;/* jmp 0x101842a2 */
        l_0x1018_429c:
            ii(0x1018_429c, 6);  mov(eax, memd[ds, eax + 568]);        /* mov eax, [eax+0x238] */
        l_0x1018_42a2:
            ii(0x1018_42a2, 4);  mov(edx, memd[ss, esp + 24]);         /* mov edx, [esp+0x18] */
            ii(0x1018_42a6, 4);  mov(memd[ss, esp + 12], eax);         /* mov [esp+0xc], eax */
            ii(0x1018_42aa, 1);  push(eax);                            /* push eax */
            ii(0x1018_42ab, 4);  add(edx, memd[ss, esp + 12]);         /* add edx, [esp+0xc] */
            ii(0x1018_42af, 4);  mov(eax, memd[ss, esp + 8]);          /* mov eax, [esp+0x8] */
            ii(0x1018_42b3, 3);  imul(eax, ecx);                       /* imul eax, ecx */
            ii(0x1018_42b6, 4);  mov(ebp, memd[ss, esp + 20]);         /* mov ebp, [esp+0x14] */
            ...
            ii(0x1018_42c4, 4);  mov(edx, memd[ss, esp + 96]);         /* mov edx, [esp+0x60] */
            ii(0x1018_42c8, 7);  lea(eax, memd[ds, edx * 8]);          /* lea eax, [edx*8] */
            ii(0x1018_42cf, 2);  add(eax, edx);                        /* add eax, edx */
            ii(0x1018_42d1, 4);  mov(edx, memd[ss, esp + 92]);         /* mov edx, [esp+0x5c] */
            ii(0x1018_42d5, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x1018_42d8, 3);  add(edx, 0x18);                       /* add edx, 0x18 */
            ii(0x1018_42db, 2);  add(edx, eax);                        /* add edx, eax */
            ii(0x1018_42dd, 4);  mov(eax, memd[ss, esp + 92]);         /* mov eax, [esp+0x5c] */
        ...
        l_0x1018_42e8:
            ii(0x1018_42e8, 4);  mov(eax, memd[ss, esp + 52]);         /* mov eax, [esp+0x34] */
            ii(0x1018_42ec, 4);  mov(edx, memd[ss, esp + 56]);         /* mov edx, [esp+0x38] */
            ii(0x1018_42f0, 5);  call(/* sys */ 0x1016_7dac, -0x1_c549);/* call 0x10167dac */
            ii(0x1018_42f5, 3);  mov(ebx, memd[ds, eax + 44]);         /* mov ebx, [eax+0x2c] */
            ii(0x1018_42f8, 4);  mov(eax, memd[ss, esp + 56]);         /* mov eax, [esp+0x38] */
            ii(0x1018_42fc, 2);  mov(ecx, memd[ds, edx]);              /* mov ecx, [edx] */
            ii(0x1018_42fe, 3);  mov(eax, memd[ds, eax + 8]);          /* mov eax, [eax+0x8] */
            ii(0x1018_4301, 2);  sub(eax, ecx);                        /* sub eax, ecx */
            ii(0x1018_4303, 1);  inc(eax);                             /* inc eax */
            ii(0x1018_4304, 3);  mov(edi, memd[ds, edx + 4]);          /* mov edi, [edx+0x4] */
            ii(0x1018_4307, 4);  mov(memd[ss, esp + 40], eax);         /* mov [esp+0x28], eax */
            ii(0x1018_430b, 3);  mov(eax, memd[ds, edx + 12]);         /* mov eax, [edx+0xc] */
            ii(0x1018_430e, 2);  sub(eax, edi);                        /* sub eax, edi */
            ii(0x1018_4310, 5);  mov(ebp, 0xffff_fffc);                /* mov ebp, 0xfffffffc */
            ii(0x1018_4315, 3);  lea(ecx, memd[ds, eax + 1]);          /* lea ecx, [eax+0x1] */
            ii(0x1018_4318, 4);  lea(edx, memd[ss, esp + 4]);          /* lea edx, [esp+0x4] */
            ii(0x1018_431c, 4);  lea(eax, memd[ss, esp + 8]);          /* lea eax, [esp+0x8] */
            ii(0x1018_4320, 5);  mov(edi, 4);                          /* mov edi, 0x4 */
        ...
        l_0x1018_432a:
            ...
            ii(0x1018_432f, 4);  mov(memd[ss, esp + 60], eax);         /* mov [esp+0x3c], eax */
            ii(0x1018_4333, 3);  cmp(eax, -1 /* 0xff */);              /* cmp eax, 0xffffffff */
            ii(0x1018_4336, 2);  if(jnz(0x1018_4375, 0x3d)) goto l_0x1018_4375;/* jnz 0x10184375 */
            ii(0x1018_4338, 4);  lea(edx, memd[ss, esp + 12]);         /* lea edx, [esp+0xc] */
            ii(0x1018_433c, 4);  lea(eax, memd[ss, esp + 16]);         /* lea eax, [esp+0x10] */
            ii(0x1018_4340, 5);  call(/* sys */ 0x1016_c298, -0x1_80ad);/* call 0x1016c298 */
            ii(0x1018_4345, 4);  mov(eax, memd[ss, esp + 8]);          /* mov eax, [esp+0x8] */
            ii(0x1018_4349, 4);  mov(edx, memd[ss, esp + 16]);         /* mov edx, [esp+0x10] */
            ...
            ii(0x1018_4353, 4);  mov(eax, memd[ss, esp + 8]);          /* mov eax, [esp+0x8] */
            ...
            ii(0x1018_435d, 4);  mov(eax, memd[ss, esp + 4]);          /* mov eax, [esp+0x4] */
            ii(0x1018_4361, 4);  mov(edx, memd[ss, esp + 12]);         /* mov edx, [esp+0xc] */
            ...
            ii(0x1018_436b, 4);  mov(eax, memd[ss, esp + 4]);          /* mov eax, [esp+0x4] */
        ...
        l_0x1018_4375:
            ii(0x1018_4375, 4);  mov(eax, memd[ss, esp + 40]);         /* mov eax, [esp+0x28] */
            ii(0x1018_4379, 3);  add(ebx, 2);                          /* add ebx, 0x2 */
            ii(0x1018_437c, 3);  sub(eax, 4);                          /* sub eax, 0x4 */
            ii(0x1018_437f, 3);  sub(ecx, 0x10);                       /* sub ecx, 0x10 */
            ii(0x1018_4382, 4);  mov(memd[ss, esp + 48], eax);         /* mov [esp+0x30], eax */
            ii(0x1018_4386, 4);  mov(eax, memd[ss, esp + 36]);         /* mov eax, [esp+0x24] */
            ii(0x1018_438a, 3);  mov(memd[ss, esp], ebx);              /* mov [esp], ebx */
            ii(0x1018_438d, 1);  dec(eax);                             /* dec eax */
            ii(0x1018_438e, 4);  mov(memd[ss, esp + 28], ecx);         /* mov [esp+0x1c], ecx */
            ii(0x1018_4392, 4);  mov(memd[ss, esp + 64], eax);         /* mov [esp+0x40], eax */
        l_0x1018_4396:
            ii(0x1018_4396, 4);  lea(edx, memd[ss, esp + 12]);         /* lea edx, [esp+0xc] */
            ii(0x1018_439a, 4);  lea(eax, memd[ss, esp + 16]);         /* lea eax, [esp+0x10] */
            ii(0x1018_439e, 4);  mov(ebx, memd[ss, esp + 60]);         /* mov ebx, [esp+0x3c] */
            ii(0x1018_43a2, 5);  call(/* sys */ 0x1016_c298, -0x1_810f);/* call 0x1016c298 */
            ii(0x1018_43a7, 3);  cmp(ebx, -2 /* 0xfe */);              /* cmp ebx, 0xfffffffe */
            ii(0x1018_43aa, 6);  if(jnz(0x1018_442b, 0x7b)) goto l_0x1018_442b;/* jnz 0x1018442b */
            ii(0x1018_43b0, 4);  mov(ecx, memd[ss, esp + 92]);         /* mov ecx, [esp+0x5c] */
            ii(0x1018_43b4, 2);  test(ecx, ecx);                       /* test ecx, ecx */
            ii(0x1018_43b6, 6);  if(jz(0x1018_442b, 0x6f)) goto l_0x1018_442b;/* jz 0x1018442b */
            ii(0x1018_43bc, 4);  mov(ebx, memd[ss, esp + 92]);         /* mov ebx, [esp+0x5c] */
            ii(0x1018_43c0, 4);  mov(edx, memd[ss, esp + 92]);         /* mov edx, [esp+0x5c] */
            ii(0x1018_43c4, 4);  mov(eax, memd[ss, esp + 92]);         /* mov eax, [esp+0x5c] */
            ii(0x1018_43c8, 3);  mov(ecx, memd[ds, ecx + 16]);         /* mov ecx, [ecx+0x10] */
            ii(0x1018_43cb, 3);  mov(ebx, memd[ds, ebx + 12]);         /* mov ebx, [ebx+0xc] */
            ii(0x1018_43ce, 3);  mov(edx, memd[ds, edx + 8]);          /* mov edx, [edx+0x8] */
            ii(0x1018_43d1, 3);  mov(eax, memd[ds, eax + 4]);          /* mov eax, [eax+0x4] */
            ...
            ii(0x1018_43dd, 4);  mov(eax, memd[ss, esp + 92]);         /* mov eax, [esp+0x5c] */
            ii(0x1018_43e1, 3);  mov(edi, memd[ds, eax + 20]);         /* mov edi, [eax+0x14] */
        ...
        l_0x1018_43ec:
            ii(0x1018_43ec, 3);  mov(ecx, memd[ds, edi + 36]);         /* mov ecx, [edi+0x24] */
            ii(0x1018_43ef, 3);  mov(ebx, memd[ds, edi + 32]);         /* mov ebx, [edi+0x20] */
            ii(0x1018_43f2, 3);  mov(edx, memd[ds, edi + 28]);         /* mov edx, [edi+0x1c] */
            ii(0x1018_43f5, 3);  mov(eax, memd[ds, edi + 24]);         /* mov eax, [edi+0x18] */
            ...
            ii(0x1018_4401, 4);  mov(eax, memd[ss, esp + 92]);         /* mov eax, [esp+0x5c] */
            ii(0x1018_4405, 1);  inc(ebp);                             /* inc ebp */
            ii(0x1018_4406, 3);  mov(edx, memd[ds, eax + 20]);         /* mov edx, [eax+0x14] */
        ...
        l_0x1018_4410:
            ii(0x1018_4410, 4);  mov(eax, memd[ss, esp + 92]);         /* mov eax, [esp+0x5c] */
            ii(0x1018_4414, 3);  cmp(ebp, memd[ds, eax + 20]);         /* cmp ebp, [eax+0x14] */
            ii(0x1018_4417, 2);  if(jge(0x1018_442b, 0x12)) goto l_0x1018_442b;/* jge 0x1018442b */
            ii(0x1018_4419, 4);  cmp(ebp, memd[ss, esp + 96]);         /* cmp ebp, [esp+0x60] */
        ...
        l_0x1018_442b:
            ...
            ii(0x1018_4439, 2);  test(al, 1);                          /* test al, 0x1 */
            ...
            ii(0x1018_4442, 2);  test(al, 4);                          /* test al, 0x4 */
            ii(0x1018_4444, 2);  if(jnz(0x1018_4475, 0x2f)) goto l_0x1018_4475;/* jnz 0x10184475 */
        l_0x1018_4446:
            ii(0x1018_4446, 4);  mov(ecx, memd[ss, esp + 56]);         /* mov ecx, [esp+0x38] */
            ii(0x1018_444a, 4);  mov(ebx, memd[ss, esp + 56]);         /* mov ebx, [esp+0x38] */
            ii(0x1018_444e, 4);  mov(edx, memd[ss, esp + 56]);         /* mov edx, [esp+0x38] */
            ii(0x1018_4452, 4);  mov(eax, memd[ss, esp + 56]);         /* mov eax, [esp+0x38] */
            ii(0x1018_4456, 3);  mov(ecx, memd[ds, ecx + 12]);         /* mov ecx, [ecx+0xc] */
            ii(0x1018_4459, 3);  mov(ebx, memd[ds, ebx + 8]);          /* mov ebx, [ebx+0x8] */
            ii(0x1018_445c, 3);  mov(edx, memd[ds, edx + 4]);          /* mov edx, [edx+0x4] */
            ii(0x1018_445f, 2);  mov(eax, memd[ds, eax]);              /* mov eax, [eax] */
            ii(0x1018_4461, 3);  sub(ecx, 9);                          /* sub ecx, 0x9 */
            ii(0x1018_4464, 3);  add(edx, 8);                          /* add edx, 0x8 */
        ...
        l_0x1018_4475:
            ii(0x1018_4475, 4);  mov(edi, memd[ss, esp + 60]);         /* mov edi, [esp+0x3c] */
        ...
        l_0x1018_4488:
            ...
            ii(0x1018_4499, 5);  cmp(memd[ss, esp + 92], 0);           /* cmp dword [esp+0x5c], 0x0 */
            ii(0x1018_449e, 6);  if(jz(0x1018_45e7, 0x143)) goto l_0x1018_45e7;/* jz 0x101845e7 */
            ii(0x1018_44a4, 4);  mov(ecx, memd[ss, esp + 96]);         /* mov ecx, [esp+0x60] */
            ...
            ii(0x1018_44b5, 3);  lea(esi, memd[ds, ecx - 1]);          /* lea esi, [ecx-0x1] */
        ...
        l_0x1018_44c1:
            ...
            ii(0x1018_44c9, 4);  mov(ebp, memd[ss, esp + 92]);         /* mov ebp, [esp+0x5c] */
            ii(0x1018_44cd, 2);  test(ebp, ebp);                       /* test ebp, ebp */
            ii(0x1018_44cf, 6);  if(jz(0x1018_45e7, 0x112)) goto l_0x1018_45e7;/* jz 0x101845e7 */
            ii(0x1018_44d5, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ii(0x1018_44d8, 4);  mov(edx, memd[ss, esp + 96]);         /* mov edx, [esp+0x60] */
            ...
            ii(0x1018_44ea, 3);  lea(esi, memd[ds, edx + 1]);          /* lea esi, [edx+0x1] */
        ...
        l_0x1018_44f6:
            ii(0x1018_44f6, 4);  mov(ebx, memd[ss, esp + 44]);         /* mov ebx, [esp+0x2c] */
            ii(0x1018_44fa, 7);  lea(eax, memd[ds, esi * 4]);          /* lea eax, [esi*4] */
        ...
        l_0x1018_450d:
            ...
            ii(0x1018_4511, 3);  mov(edx, memd[ds, eax - 4]);          /* mov edx, [eax-0x4] */
            ii(0x1018_4514, 3);  sub(eax, 4);                          /* sub eax, 0x4 */
        ...
        l_0x1018_451e:
            ii(0x1018_451e, 8);  mov(memd[ss, esp + 60], 0xffff_fffd); /* mov dword [esp+0x3c], 0xfffffffd */
        ...
        l_0x1018_452b:
            ...
            ii(0x1018_4533, 4);  mov(edi, memd[ss, esp + 64]);         /* mov edi, [esp+0x40] */
        l_0x1018_4537:
            ii(0x1018_4537, 2);  cmp(esi, edi);                        /* cmp esi, edi */
            ii(0x1018_4539, 2);  if(jge(0x1018_4548, 0xd)) goto l_0x1018_4548;/* jge 0x10184548 */
            ii(0x1018_453b, 3);  mov(edx, memd[ds, eax + 4]);          /* mov edx, [eax+0x4] */
            ii(0x1018_453e, 3);  add(eax, 4);                          /* add eax, 0x4 */
        ...
        l_0x1018_4548:
            ii(0x1018_4548, 8);  mov(memd[ss, esp + 60], 0xffff_fffd); /* mov dword [esp+0x3c], 0xfffffffd */
            ii(0x1018_4550, 5);  jmp(0x1018_45e7, 0x92); goto l_0x1018_45e7;/* jmp 0x101845e7 */
        l_0x1018_4555:
            ii(0x1018_4555, 4);  mov(eax, memd[ss, esp + 16]);         /* mov eax, [esp+0x10] */
            ii(0x1018_4559, 4);  cmp(eax, memd[ss, esp + 8]);          /* cmp eax, [esp+0x8] */
            ii(0x1018_455d, 2);  if(jnz(0x1018_456d, 0xe)) goto l_0x1018_456d;/* jnz 0x1018456d */
            ii(0x1018_455f, 4);  mov(eax, memd[ss, esp + 12]);         /* mov eax, [esp+0xc] */
            ii(0x1018_4563, 4);  cmp(eax, memd[ss, esp + 4]);          /* cmp eax, [esp+0x4] */
            ii(0x1018_4567, 6);  if(jz(0x1018_45e7, 0x7a)) goto l_0x1018_45e7;/* jz 0x101845e7 */
        l_0x1018_456d:
            ii(0x1018_456d, 4);  mov(eax, memd[ss, esp + 56]);         /* mov eax, [esp+0x38] */
            ii(0x1018_4571, 3);  mov(ecx, memd[ds, eax + 12]);         /* mov ecx, [eax+0xc] */
            ii(0x1018_4574, 3);  mov(ebx, memd[ds, eax + 8]);          /* mov ebx, [eax+0x8] */
            ii(0x1018_4577, 3);  mov(edx, memd[ds, eax + 4]);          /* mov edx, [eax+0x4] */
            ii(0x1018_457a, 3);  sub(ecx, 9);                          /* sub ecx, 0x9 */
            ii(0x1018_457d, 3);  add(edx, 8);                          /* add edx, 0x8 */
            ...
            ii(0x1018_458b, 4);  mov(eax, memd[ss, esp + 56]);         /* mov eax, [esp+0x38] */
            ii(0x1018_458f, 4);  mov(edx, memd[ss, esp + 12]);         /* mov edx, [esp+0xc] */
            ii(0x1018_4593, 3);  sub(edx, memd[ds, eax + 4]);          /* sub edx, [eax+0x4] */
            ii(0x1018_4596, 6);  call_abs(memd[ds, 0x101b_ddf0]);      /* call dword [0x101bddf0] */
            ii(0x1018_459c, 3);  sub(edx, 8);                          /* sub edx, 0x8 */
            ...
            ii(0x1018_45a8, 4);  mov(ecx, memd[ss, esp + 32]);         /* mov ecx, [esp+0x20] */
            ii(0x1018_45ac, 4);  mov(memd[ss, esp + 60], eax);         /* mov [esp+0x3c], eax */
            ii(0x1018_45b0, 2);  cmp(eax, ecx);                        /* cmp eax, ecx */
            ii(0x1018_45b2, 2);  if(jz(0x1018_45d7, 0x23)) goto l_0x1018_45d7;/* jz 0x101845d7 */
            ii(0x1018_45b4, 4);  mov(esi, memd[ss, esp + 44]);         /* mov esi, [esp+0x2c] */
            ii(0x1018_45b8, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ...
            ii(0x1018_45c2, 2);  if(jz(0x1018_45ca, 6)) goto l_0x1018_45ca;/* jz 0x101845ca */
            ii(0x1018_45c4, 4);  mov(esi, memd[ss, esp + 60]);         /* mov esi, [esp+0x3c] */
            ii(0x1018_45c8, 2);  jmp(0x1018_45cf, 5); goto l_0x1018_45cf;/* jmp 0x101845cf */
        l_0x1018_45ca:
            ii(0x1018_45ca, 5);  mov(esi, 0xffff_ffff);                /* mov esi, 0xffffffff */
        l_0x1018_45cf:
            ii(0x1018_45cf, 8);  mov(memd[ss, esp + 60], 0xffff_fffd); /* mov dword [esp+0x3c], 0xfffffffd */
        l_0x1018_45d7:
            ii(0x1018_45d7, 4);  mov(eax, memd[ss, esp + 16]);         /* mov eax, [esp+0x10] */
            ii(0x1018_45db, 4);  mov(memd[ss, esp + 8], eax);          /* mov [esp+0x8], eax */
            ii(0x1018_45df, 4);  mov(eax, memd[ss, esp + 12]);         /* mov eax, [esp+0xc] */
            ii(0x1018_45e3, 4);  mov(memd[ss, esp + 4], eax);          /* mov [esp+0x4], eax */
        l_0x1018_45e7:
            ii(0x1018_45e7, 5);  cmp(memd[ss, esp + 60], -3 /* 0xfd */);/* cmp dword [esp+0x3c], 0xfffffffd */
            ii(0x1018_45ec, 2);  if(jnz(0x1018_4666, 0x78)) goto l_0x1018_4666;/* jnz 0x10184666 */
            ii(0x1018_45ee, 4);  mov(ebx, memd[ss, esp + 88]);         /* mov ebx, [esp+0x58] */
            ii(0x1018_45f2, 4);  mov(ecx, memd[ss, esp + 28]);         /* mov ecx, [esp+0x1c] */
            ii(0x1018_45f6, 5);  mov(edx, 2);                          /* mov edx, 0x2 */
            ii(0x1018_45fb, 1);  push(ebx);                            /* push ebx */
            ii(0x1018_45fc, 4);  mov(eax, memd[ss, esp + 56]);         /* mov eax, [esp+0x38] */
            ii(0x1018_4600, 5);  mov(ebx, 8);                          /* mov ebx, 0x8 */
            ii(0x1018_4605, 1);  push(ecx);                            /* push ecx */
            ii(0x1018_4606, 4);  mov(ecx, memd[ss, esp + 56]);         /* mov ecx, [esp+0x38] */
            ii(0x1018_460a, 4);  mov(edi, memd[ss, esp + 92]);         /* mov edi, [esp+0x5c] */
            ii(0x1018_460e, 5);  call(/* sys */ 0x1016_71f0, -0x1_d423);/* call 0x101671f0 */
            ii(0x1018_4613, 1);  push(edi);                            /* push edi */
            ii(0x1018_4614, 2);  push(8);                              /* push 0x8 */
            ii(0x1018_4616, 4);  mov(ecx, memd[ss, esp + 56]);         /* mov ecx, [esp+0x38] */
            ii(0x1018_461a, 4);  mov(ebx, memd[ss, esp + 44]);         /* mov ebx, [esp+0x2c] */
            ii(0x1018_461e, 2);  push(2);                              /* push 0x2 */
            ii(0x1018_4620, 4);  mov(edx, memd[ss, esp + 56]);         /* mov edx, [esp+0x38] */
            ii(0x1018_4624, 4);  mov(eax, memd[ss, esp + 64]);         /* mov eax, [esp+0x40] */
            ii(0x1018_4628, 5);  call(/* sys */ 0x1016_6f04, -0x1_d729);/* call 0x10166f04 */
            ii(0x1018_462d, 3);  cmp(esi, -1 /* 0xff */);              /* cmp esi, 0xffffffff */
            ...
            ii(0x1018_4643, 4);  mov(ebp, memd[ss, esp + 40]);         /* mov ebp, [esp+0x28] */
            ii(0x1018_4647, 3);  add(eax, 8);                          /* add eax, 0x8 */
            ...
            ii(0x1018_4654, 4);  mov(edx, memd[ss, esp + 48]);         /* mov edx, [esp+0x30] */
            ii(0x1018_4658, 5);  call(/* sys */ 0x1016_af44, -0x1_9719);/* call 0x1016af44 */
        l_0x1018_465d:
            ii(0x1018_465d, 4);  mov(eax, memd[ss, esp + 52]);         /* mov eax, [esp+0x34] */
        ...
        l_0x1018_4666:
            ...
            ii(0x1018_466b, 4);  mov(memd[ss, esp + 60], eax);         /* mov [esp+0x3c], eax */
            ii(0x1018_466f, 5);  jmp(0x1018_4396, -0x2de); goto l_0x1018_4396;/* jmp 0x10184396 */
        l_0x1018_4674:
            ii(0x1018_4674, 4);  mov(eax, memd[ss, esp + 52]);         /* mov eax, [esp+0x34] */
            ii(0x1018_4678, 4);  mov(ebx, memd[ss, esp + 92]);         /* mov ebx, [esp+0x5c] */
            ...
            ii(0x1018_4690, 3);  mov(eax, memd[ds, eax + 44]);         /* mov eax, [eax+0x2c] */
            ii(0x1018_4693, 4);  mov(edx, memd[ss, esp + 96]);         /* mov edx, [esp+0x60] */
            ii(0x1018_4697, 4);  mov(memd[ss, esp + 20], eax);         /* mov [esp+0x14], eax */
            ii(0x1018_469b, 7);  lea(eax, memd[ds, edx * 8]);          /* lea eax, [edx*8] */
            ii(0x1018_46a2, 2);  add(eax, edx);                        /* add eax, edx */
            ii(0x1018_46a4, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x1018_46a7, 3);  lea(edx, memd[ds, ebx + eax]);        /* lea edx, [ebx+eax] */
            ii(0x1018_46aa, 3);  mov(eax, memd[ds, edx + 24]);         /* mov eax, [edx+0x18] */
            ii(0x1018_46ad, 4);  mov(memd[ss, esp + 8], eax);          /* mov [esp+0x8], eax */
            ii(0x1018_46b1, 3);  mov(eax, memd[ds, edx + 28]);         /* mov eax, [edx+0x1c] */
            ii(0x1018_46b4, 4);  mov(memd[ss, esp + 4], eax);          /* mov [esp+0x4], eax */
            ii(0x1018_46b8, 3);  mov(ebx, memd[ds, edx + 36]);         /* mov ebx, [edx+0x24] */
            ii(0x1018_46bb, 2);  sub(ebx, eax);                        /* sub ebx, eax */
            ii(0x1018_46bd, 4);  mov(eax, memd[ss, esp + 92]);         /* mov eax, [esp+0x5c] */
            ii(0x1018_46c1, 4);  mov(ecx, memd[ss, esp + 8]);          /* mov ecx, [esp+0x8] */
            ii(0x1018_46c5, 3);  mov(edi, memd[ds, edx + 32]);         /* mov edi, [edx+0x20] */
            ...
            ii(0x1018_46d3, 4);  mov(eax, memd[ss, esp + 92]);         /* mov eax, [esp+0x5c] */
            ii(0x1018_46d7, 1);  inc(edi);                             /* inc edi */
            ii(0x1018_46d8, 6);  mov(dl, memb[ds, eax + 565]);         /* mov dl, [eax+0x235] */
            ...
            ii(0x1018_46e4, 6);  mov(eax, memd[ds, eax + 564]);        /* mov eax, [eax+0x234] */
            ...
            ii(0x1018_46fe, 4);  mov(eax, memd[ss, esp + 92]);         /* mov eax, [esp+0x5c] */
            ii(0x1018_4702, 6);  mov(eax, memd[ds, eax + 564]);        /* mov eax, [eax+0x234] */
            ii(0x1018_4708, 3);  xor(ax, ax);                          /* xor ax, ax */
            ii(0x1018_470b, 2);  or(eax, edx);                         /* or eax, edx */
            ii(0x1018_470d, 2);  jmp(0x1018_4715, 6); goto l_0x1018_4715;/* jmp 0x10184715 */
        l_0x1018_470f:
            ii(0x1018_470f, 6);  mov(eax, memd[ds, eax + 564]);        /* mov eax, [eax+0x234] */
        l_0x1018_4715:
            ii(0x1018_4715, 4);  mov(memd[ss, esp + 16], eax);         /* mov [esp+0x10], eax */
            ii(0x1018_4719, 4);  mov(eax, memd[ss, esp + 92]);         /* mov eax, [esp+0x5c] */
            ii(0x1018_471d, 7);  test(memb[ds, eax + 569], 0xff);      /* test byte [eax+0x239], 0xff */
            ii(0x1018_4724, 2);  if(jz(0x1018_4754, 0x2e)) goto l_0x1018_4754;/* jz 0x10184754 */
            ii(0x1018_4726, 6);  mov(eax, memd[ds, eax + 568]);        /* mov eax, [eax+0x238] */
            ...
            ii(0x1018_473e, 4);  mov(edx, memd[ss, esp + 92]);         /* mov edx, [esp+0x5c] */
            ii(0x1018_4742, 6);  mov(edx, memd[ds, edx + 568]);        /* mov edx, [edx+0x238] */
            ii(0x1018_4748, 3);  xor(dx, dx);                          /* xor dx, dx */
            ii(0x1018_474b, 5);  and(eax, 0xff);                       /* and eax, 0xff */
            ii(0x1018_4750, 2);  or(eax, edx);                         /* or eax, edx */
            ii(0x1018_4752, 2);  jmp(0x1018_475a, 6); goto l_0x1018_475a;/* jmp 0x1018475a */
        l_0x1018_4754:
            ii(0x1018_4754, 6);  mov(eax, memd[ds, eax + 568]);        /* mov eax, [eax+0x238] */
        l_0x1018_475a:
            ii(0x1018_475a, 4);  mov(edx, memd[ss, esp + 20]);         /* mov edx, [esp+0x14] */
            ii(0x1018_475e, 4);  mov(memd[ss, esp + 12], eax);         /* mov [esp+0xc], eax */
            ii(0x1018_4762, 1);  push(eax);                            /* push eax */
            ii(0x1018_4763, 4);  add(edx, memd[ss, esp + 12]);         /* add edx, [esp+0xc] */
            ii(0x1018_4767, 4);  mov(eax, memd[ss, esp + 8]);          /* mov eax, [esp+0x8] */
            ii(0x1018_476b, 3);  imul(eax, ecx);                       /* imul eax, ecx */
            ii(0x1018_476e, 4);  mov(ebp, memd[ss, esp + 20]);         /* mov ebp, [esp+0x14] */
            ...
            ii(0x1018_477c, 4);  mov(edx, memd[ss, esp + 96]);         /* mov edx, [esp+0x60] */
            ii(0x1018_4780, 7);  lea(eax, memd[ds, edx * 8]);          /* lea eax, [edx*8] */
            ii(0x1018_4787, 2);  add(eax, edx);                        /* add eax, edx */
            ii(0x1018_4789, 4);  mov(edx, memd[ss, esp + 92]);         /* mov edx, [esp+0x5c] */
            ii(0x1018_478d, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x1018_4790, 3);  add(edx, 0x18);                       /* add edx, 0x18 */
            ii(0x1018_4793, 2);  add(edx, eax);                        /* add edx, eax */
            ii(0x1018_4795, 4);  mov(eax, memd[ss, esp + 92]);         /* mov eax, [esp+0x5c] */
