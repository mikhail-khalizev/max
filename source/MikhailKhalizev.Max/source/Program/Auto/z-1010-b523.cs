...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1010_b523()
        {
            ...
            ii(0x1010_b543, 7);  cmp(memd[ds, eax + 833], 0);          /* cmp dword [eax+0x341], 0x0 */
            ...
            ii(0x1010_b559, 6);  mov(edx, memd[ds, eax + 867]);        /* mov edx, [eax+0x363] */
        ...
        l_0x1010_b585:
            ...
            ii(0x1010_b588, 6);  mov(eax, memd[ds, eax + 833]);        /* mov eax, [eax+0x341] */
            ii(0x1010_b58e, 5);  call(0x100e_b226, -0x2_036d);         /* call 0x100eb226 */
            ii(0x1010_b593, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_b596, 7);  cmp(memd[ds, eax + 833], 0);          /* cmp dword [eax+0x341], 0x0 */
            ...
            ii(0x1010_b5a2, 6);  mov(eax, memd[ds, eax + 833]);        /* mov eax, [eax+0x341] */
            ii(0x1010_b5a8, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1010_b5ab, 4);  cmp(memd[ss, ebp - 12], 0);           /* cmp dword [ebp-0xc], 0x0 */
            ii(0x1010_b5af, 2);  if(jz(0x1010_b5c5, 0x14)) goto l_0x1010_b5c5;/* jz 0x1010b5c5 */
            ii(0x1010_b5b1, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1010_b5b3, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x1010_b5c0, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1010_b5c3, 2);  jmp(0x1010_b5cc, 7); goto l_0x1010_b5cc;/* jmp 0x1010b5cc */
        l_0x1010_b5c5:
            ii(0x1010_b5c5, 7);  mov(memd[ss, ebp - 16], 0);           /* mov dword [ebp-0x10], 0x0 */
        l_0x1010_b5cc:
            ii(0x1010_b5cc, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_b5cf, 10);  mov(memd[ds, eax + 833], 0);         /* mov dword [eax+0x341], 0x0 */
        l_0x1010_b5d9:
            ii(0x1010_b5d9, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1010_b5dc, 10);  mov(memd[ds, eax + 867], 0);         /* mov dword [eax+0x363], 0x0 */
            ...
            ii(0x1010_b5f3, 3);  mov(eax, memd[ds, eax + 18]);         /* mov eax, [eax+0x12] */
