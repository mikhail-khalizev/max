...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_aa64()
        {
            ...
            ii(0x100a_aa75, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x100a_aa7b, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_aa7e, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100a_aa81, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_aa84, 2);  mov(ebx, memd[ds, eax]);              /* mov ebx, [eax] */
            ii(0x100a_aa86, 3);  sar(ebx, 0x10);                       /* sar ebx, 0x10 */
            ii(0x100a_aa89, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x100a_aa8c, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_aa8f, 5);  call(0x100a_aa9c, 8);                 /* call 0x100aaa9c */
