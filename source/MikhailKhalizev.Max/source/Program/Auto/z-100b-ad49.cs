...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_ad49()
        {
            ...
            ii(0x100b_ad6e, 3);  lea(ebx, memd[ss, ebp - 20]);         /* lea ebx, [ebp-0x14] */
        ...
        l_0x100b_adac:
            ii(0x100b_adac, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x100b_adaf, 5);  call(0x1007_6bf8, -0x4_41bc);         /* call 0x10076bf8 */
        l_0x100b_adb4:
            ii(0x100b_adb4, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_adb6, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x100b_adc6, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x100b_addd, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x100b_ade0, 5);  call(0x1008_adc4, -0x3_0021);         /* call 0x1008adc4 */
            ii(0x100b_ade5, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x100b_ade8, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x100b_adeb, 3);  mov(edx, memd[ds, eax + 2]);          /* mov edx, [eax+0x2] */
            ii(0x100b_adee, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x100b_adf1, 3);  call_abs(memd[ds, edx + 32]);         /* call dword [edx+0x20] */
        ...
        l_0x100b_adfd:
            ...
            ii(0x100b_ae04, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x100b_ae07, 5);  call(0x1008_adc4, -0x3_0048);         /* call 0x1008adc4 */
            ii(0x100b_ae0c, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100b_ae0f, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x100b_ae12, 3);  mov(edx, memd[ds, eax + 2]);          /* mov edx, [eax+0x2] */
            ii(0x100b_ae15, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x100b_ae18, 3);  call_abs(memd[ds, edx + 20]);         /* call dword [edx+0x14] */
            ii(0x100b_ae1b, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
        l_0x100b_ae1e:
        ...
        l_0x100b_ae43:
            ii(0x100b_ae43, 4);  movsx(edx, memw[ss, ebp - 16]);       /* movsx edx, word [ebp-0x10] */
        ...
        l_0x100b_ae6f:
            ...
            ii(0x100b_ae78, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x100b_ae7b, 5);  call(0x1008_adc4, -0x3_00bc);         /* call 0x1008adc4 */
            ii(0x100b_ae80, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x100b_ae83, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
            ii(0x100b_ae86, 3);  mov(edx, memd[ds, eax + 2]);          /* mov edx, [eax+0x2] */
            ii(0x100b_ae89, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
            ii(0x100b_ae8c, 3);  call_abs(memd[ds, edx + 72]);         /* call dword [edx+0x48] */
        ...
        l_0x100b_ae94:
            ...
            ii(0x100b_aeb0, 3);  mov(memd[ss, ebp - 36], eax);         /* mov [ebp-0x24], eax */
            ii(0x100b_aeb3, 3);  mov(eax, memd[ss, ebp - 36]);         /* mov eax, [ebp-0x24] */
            ii(0x100b_aeb6, 3);  mov(edx, memd[ds, eax + 2]);          /* mov edx, [eax+0x2] */
            ii(0x100b_aeb9, 3);  mov(eax, memd[ss, ebp - 36]);         /* mov eax, [ebp-0x24] */
            ii(0x100b_aebc, 3);  call_abs(memd[ds, edx + 72]);         /* call dword [edx+0x48] */
        l_0x100b_aebf:
            ii(0x100b_aebf, 7);  mov(memd[ss, ebp - 12], 2);           /* mov dword [ebp-0xc], 0x2 */
            ii(0x100b_aec6, 2);  jmp(0x100b_aece, 6); goto l_0x100b_aece;/* jmp 0x100baece */
        l_0x100b_aec8:
            ii(0x100b_aec8, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100b_aecb, 3);  dec(memd[ss, ebp - 12]);              /* dec dword [ebp-0xc] */
        l_0x100b_aece:
            ii(0x100b_aece, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x100b_aed7, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x100b_aee9, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
        ...
        l_0x100b_aeff:
            ii(0x100b_aeff, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x100b_af22:
            ...
            ii(0x100b_af24, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
