...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_b063()
        {
            ...
            ii(0x1012_b075, 6);  sub(esp, 4);                          /* sub esp, 0x4 */
            ii(0x1012_b07b, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1012_b07e, 7);  mov(memb[ds, 0x101c_5c1c], 0x32);     /* mov byte [0x101c5c1c], 0x32 */
            ii(0x1012_b085, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1012_b09c, 5);  mov(eax, 4);                          /* mov eax, 0x4 */
