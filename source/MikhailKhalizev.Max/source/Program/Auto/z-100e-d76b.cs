...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_d76b()
        {
            ...
            ii(0x100e_d780, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x100e_d783, 3);  mov(memd[ss, ebp - 12], edx);         /* mov [ebp-0xc], edx */
            ii(0x100e_d786, 3);  mov(memd[ss, ebp - 8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x100e_d789, 3);  mov(memd[ss, ebp - 4], ecx);          /* mov [ebp-0x4], ecx */
            ii(0x100e_d78c, 4);  movsx(eax, memw[ss, ebp + 20]);       /* movsx eax, word [ebp+0x14] */
            ii(0x100e_d790, 3);  cmp(eax, 1);                          /* cmp eax, 0x1 */
            ii(0x100e_d793, 2);  if(jnz(0x100e_d7a6, 0x11)) goto l_0x100e_d7a6;/* jnz 0x100ed7a6 */
            ii(0x100e_d795, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100e_d798, 6);  call_abs(memd[ds, 0x101b_ddf4]);      /* call dword [0x101bddf4] */
            ii(0x100e_d79e, 4);  movsx(edx, memw[ss, ebp + 16]);       /* movsx edx, word [ebp+0x10] */
            ii(0x100e_d7a2, 2);  cmp(eax, edx);                        /* cmp eax, edx */
            ii(0x100e_d7a4, 2);  if(jl(0x100e_d7a8, 2)) goto l_0x100e_d7a8;/* jl 0x100ed7a8 */
        l_0x100e_d7a6:
            ii(0x100e_d7a6, 2);  jmp(0x100e_d7bd, 0x15); goto l_0x100e_d7bd;/* jmp 0x100ed7bd */
        l_0x100e_d7a8:
            ii(0x100e_d7a8, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100e_d7ab, 6);  call_abs(memd[ds, 0x101b_ddf4]);      /* call dword [0x101bddf4] */
            ii(0x100e_d7b1, 3);  mov(edx, memd[ss, ebp + 16]);         /* mov edx, [ebp+0x10] */
            ii(0x100e_d7b4, 2);  sub(edx, eax);                        /* sub edx, eax */
            ii(0x100e_d7b6, 2);  mov(eax, edx);                        /* mov eax, edx */
            ii(0x100e_d7b8, 3);  add(memd[ss, ebp - 8], eax);          /* add [ebp-0x8], eax */
            ii(0x100e_d7bb, 2);  jmp(0x100e_d7fa, 0x3d); goto l_0x100e_d7fa;/* jmp 0x100ed7fa */
        l_0x100e_d7bd:
            ii(0x100e_d7bd, 4);  movsx(eax, memw[ss, ebp + 20]);       /* movsx eax, word [ebp+0x14] */
            ii(0x100e_d7c1, 3);  cmp(eax, 2);                          /* cmp eax, 0x2 */
            ii(0x100e_d7c4, 2);  if(jnz(0x100e_d7d7, 0x11)) goto l_0x100e_d7d7;/* jnz 0x100ed7d7 */
            ii(0x100e_d7c6, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100e_d7c9, 6);  call_abs(memd[ds, 0x101b_ddf4]);      /* call dword [0x101bddf4] */
            ii(0x100e_d7cf, 4);  movsx(edx, memw[ss, ebp + 16]);       /* movsx edx, word [ebp+0x10] */
            ii(0x100e_d7d3, 2);  cmp(eax, edx);                        /* cmp eax, edx */
            ii(0x100e_d7d5, 2);  if(jl(0x100e_d7d9, 2)) goto l_0x100e_d7d9;/* jl 0x100ed7d9 */
        l_0x100e_d7d7:
            ii(0x100e_d7d7, 2);  jmp(0x100e_d7fa, 0x21); goto l_0x100e_d7fa;/* jmp 0x100ed7fa */
        l_0x100e_d7d9:
            ii(0x100e_d7d9, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100e_d7dc, 6);  call_abs(memd[ds, 0x101b_ddf4]);      /* call dword [0x101bddf4] */
            ii(0x100e_d7e2, 4);  movsx(edx, memw[ss, ebp + 16]);       /* movsx edx, word [ebp+0x10] */
            ...
            ii(0x100e_d7ef, 2);  sar(eax, 1);                          /* sar eax, 1 */
            ii(0x100e_d7f1, 4);  movsx(edx, memw[ss, ebp - 8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100e_d7f5, 2);  add(edx, eax);                        /* add edx, eax */
            ii(0x100e_d7f7, 3);  mov(memd[ss, ebp - 8], edx);          /* mov [ebp-0x8], edx */
        l_0x100e_d7fa:
            ii(0x100e_d7fa, 7);  mov(memd[ss, ebp - 20], 0);           /* mov dword [ebp-0x14], 0x0 */
            ii(0x100e_d801, 4);  mov(memb[ss, ebp - 23], 0);           /* mov byte [ebp-0x17], 0x0 */
            ii(0x100e_d805, 5);  call(0x1014_82f4, 0x5_aaea);          /* call 0x101482f4 */
            ii(0x100e_d80a, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
            ii(0x100e_d80d, 5);  call(0x1014_82f4, 0x5_aae2);          /* call 0x101482f4 */
            ii(0x100e_d812, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
        ...
        l_0x100e_d82e:
            ii(0x100e_d82e, 4);  movsx(eax, memw[ss, ebp - 20]);       /* movsx eax, word [ebp-0x14] */
            ii(0x100e_d832, 3);  add(eax, memd[ss, ebp - 12]);         /* add eax, [ebp-0xc] */
            ...
            ii(0x100e_d83e, 2);  if(jz(0x100e_d848, 8)) goto l_0x100e_d848;/* jz 0x100ed848 */
            ii(0x100e_d840, 4);  movsx(eax, memw[ss, ebp + 16]);       /* movsx eax, word [ebp+0x10] */
            ii(0x100e_d844, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x100e_d846, 2);  if(jg(0x100e_d84d, 5)) goto l_0x100e_d84d;/* jg 0x100ed84d */
        l_0x100e_d848:
            ii(0x100e_d848, 5);  jmp(0x100e_d948, 0xfb); goto l_0x100e_d948;/* jmp 0x100ed948 */
        l_0x100e_d84d:
            ii(0x100e_d84d, 4);  movsx(eax, memw[ss, ebp - 20]);       /* movsx eax, word [ebp-0x14] */
            ii(0x100e_d851, 3);  add(eax, memd[ss, ebp - 12]);         /* add eax, [ebp-0xc] */
            ii(0x100e_d854, 2);  mov(al, memb[ds, eax]);               /* mov al, [eax] */
            ii(0x100e_d856, 3);  mov(memb[ss, ebp - 24], al);          /* mov [ebp-0x18], al */
            ii(0x100e_d859, 5);  mov(edx, 0x101c_367c);                /* mov edx, 0x101c367c */
            ii(0x100e_d85e, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
            ...
            ii(0x100e_d86a, 4);  movsx(eax, memw[ss, ebp + 16]);       /* movsx eax, word [ebp+0x10] */
            ii(0x100e_d86e, 1);  push(eax);                            /* push eax */
            ii(0x100e_d86f, 4);  movsx(ecx, memw[ss, ebp - 4]);        /* movsx ecx, word [ebp-0x4] */
            ii(0x100e_d873, 4);  movsx(ebx, memw[ss, ebp - 8]);        /* movsx ebx, word [ebp-0x8] */
            ii(0x100e_d877, 3);  lea(edx, memd[ss, ebp - 24]);         /* lea edx, [ebp-0x18] */
            ii(0x100e_d87a, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100e_d87d, 5);  call(0x100e_a99a, -0x2ee8);           /* call 0x100ea99a */
            ii(0x100e_d882, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x100e_d885, 6);  call_abs(memd[ds, 0x101b_ddf4]);      /* call dword [0x101bddf4] */
            ii(0x100e_d88b, 3);  sub(memd[ss, ebp + 16], eax);         /* sub [ebp+0x10], eax */
            ii(0x100e_d88e, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100e_d892, 3);  mov(memd[ss, ebp - 52], eax);         /* mov [ebp-0x34], eax */
            ii(0x100e_d895, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100e_d899, 3);  mov(memd[ss, ebp - 48], eax);         /* mov [ebp-0x30], eax */
            ii(0x100e_d89c, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x100e_d89f, 6);  call_abs(memd[ds, 0x101b_ddf4]);      /* call dword [0x101bddf4] */
            ii(0x100e_d8a5, 4);  movsx(edx, memw[ss, ebp - 8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100e_d8a9, 2);  add(edx, eax);                        /* add edx, eax */
            ii(0x100e_d8ab, 3);  mov(memd[ss, ebp - 44], edx);         /* mov [ebp-0x2c], edx */
            ii(0x100e_d8ae, 6);  call_abs(memd[ds, 0x101b_ddf0]);      /* call dword [0x101bddf0] */
            ii(0x100e_d8b4, 4);  movsx(edx, memw[ss, ebp - 4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x100e_d8b8, 2);  add(edx, eax);                        /* add edx, eax */
            ii(0x100e_d8ba, 3);  mov(memd[ss, ebp - 40], edx);         /* mov [ebp-0x28], edx */
            ii(0x100e_d8bd, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x100e_d8c0, 6);  call_abs(memd[ds, 0x101b_ddf4]);      /* call dword [0x101bddf4] */
            ii(0x100e_d8c6, 3);  add(memd[ss, ebp - 8], eax);          /* add [ebp-0x8], eax */
            ii(0x100e_d8c9, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100e_d8cc, 3);  inc(memd[ss, ebp - 20]);              /* inc dword [ebp-0x14] */
            ii(0x100e_d8cf, 3);  lea(edx, memd[ss, ebp - 52]);         /* lea edx, [ebp-0x34] */
            ii(0x100e_d8d2, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100e_d8d5, 3);  mov(eax, memd[ds, eax + 18]);         /* mov eax, [eax+0x12] */
            ...
            ii(0x100e_d8e7, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
            ...
            ii(0x100e_d910, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
        l_0x100e_d913:
            ii(0x100e_d913, 5);  mov(eax, memd[ds, 0x101b_8672]);      /* mov eax, [0x101b8672] */
            ii(0x100e_d918, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x100e_d91b, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ii(0x100e_d91f, 3);  imul(edx, eax);                       /* imul edx, eax */
            ii(0x100e_d922, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ...
            ii(0x100e_d933, 3);  cmp(eax, -1 /* 0xff */);              /* cmp eax, 0xffffffff */
            ii(0x100e_d936, 2);  if(jz(0x100e_d941, 9)) goto l_0x100e_d941;/* jz 0x100ed941 */
        ...
        l_0x100e_d948:
            ...
            ii(0x100e_d94d, 3);  ret(8);                               /* ret 0x8 */
        }
    }
}
