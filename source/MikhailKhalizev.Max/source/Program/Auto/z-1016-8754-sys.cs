...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_8754()
        {
            ...
            ii(0x1016_875a, 4);  mov(memd[ss, esp + 16], eax);         /* mov [esp+0x10], eax */
            ii(0x1016_875e, 4);  mov(memd[ss, esp + 40], edx);         /* mov [esp+0x28], edx */
            ii(0x1016_8762, 4);  mov(memd[ss, esp + 44], ebx);         /* mov [esp+0x2c], ebx */
            ...
            ii(0x1016_8774, 4);  mov(memd[ss, esp + 48], eax);         /* mov [esp+0x30], eax */
            ii(0x1016_8778, 4);  mov(memd[ss, esp + 36], eax);         /* mov [esp+0x24], eax */
        ...
        l_0x1016_878e:
            ii(0x1016_878e, 4);  mov(eax, memd[ss, esp + 84]);         /* mov eax, [esp+0x54] */
            ii(0x1016_8792, 6);  call_abs(memd[ds, 0x101b_ddf4]);      /* call dword [0x101bddf4] */ /* Вызов '0x1016_a4d0'. */
            ii(0x1016_8798, 3);  lea(esi, memd[ds, eax + 16]);         /* lea esi, [eax+0x10] */
        ...
        l_0x1016_87c4:
            ...
            ii(0x1016_87cb, 4);  mov(memd[ss, esp + 32], eax);         /* mov [esp+0x20], eax */
            ii(0x1016_87cf, 4);  mov(memd[ss, esp + 52], eax);         /* mov [esp+0x34], eax */
        ...
        l_0x1016_87ec:
            ii(0x1016_87ec, 4);  mov(eax, memd[ss, esp + 48]);         /* mov eax, [esp+0x30] */
            ii(0x1016_87f0, 7);  cmp(memd[ds, eax + 32], 0x100);       /* cmp dword [eax+0x20], 0x100 */
            ...
            ii(0x1016_8802, 4);  mov(ebx, memd[ss, esp + 44]);         /* mov ebx, [esp+0x2c] */
            ii(0x1016_8806, 3);  mov(eax, memd[ds, eax + 40]);         /* mov eax, [eax+0x28] */
            ii(0x1016_8809, 2);  add(eax, ebx);                        /* add eax, ebx */
            ii(0x1016_880b, 1);  inc(eax);                             /* inc eax */
            ii(0x1016_880c, 1);  push(eax);                            /* push eax */
            ii(0x1016_880d, 4);  mov(eax, memd[ss, esp + 52]);         /* mov eax, [esp+0x34] */
            ii(0x1016_8811, 4);  mov(ecx, memd[ss, esp + 44]);         /* mov ecx, [esp+0x2c] */
            ii(0x1016_8815, 3);  mov(eax, memd[ds, eax + 36]);         /* mov eax, [eax+0x24] */
            ...
            ii(0x1016_882f, 4);  mov(eax, memd[ss, esp + 48]);         /* mov eax, [esp+0x30] */
            ii(0x1016_8833, 4);  mov(edx, memd[ss, esp + 44]);         /* mov edx, [esp+0x2c] */
            ii(0x1016_8837, 3);  mov(eax, memd[ds, eax + 40]);         /* mov eax, [eax+0x28] */
            ii(0x1016_883a, 2);  add(eax, edx);                        /* add eax, edx */
            ii(0x1016_883c, 1);  push(eax);                            /* push eax */
            ii(0x1016_883d, 4);  mov(eax, memd[ss, esp + 52]);         /* mov eax, [esp+0x34] */
            ii(0x1016_8841, 4);  mov(ebx, memd[ss, esp + 44]);         /* mov ebx, [esp+0x2c] */
            ii(0x1016_8845, 3);  mov(eax, memd[ds, eax + 36]);         /* mov eax, [eax+0x24] */
            ...
            ii(0x1016_8856, 4);  mov(eax, memd[ss, esp + 44]);         /* mov eax, [esp+0x2c] */
        ...
        l_0x1016_8863:
            ii(0x1016_8863, 4);  mov(eax, memd[ss, esp + 36]);         /* mov eax, [esp+0x24] */
            ii(0x1016_8867, 2);  mov(ebx, edi);                        /* mov ebx, edi */
            ii(0x1016_8869, 3);  mov(ecx, memd[ds, eax + 32]);         /* mov ecx, [eax+0x20] */
            ...
            ii(0x1016_8878, 4);  mov(eax, memd[ss, esp + 36]);         /* mov eax, [esp+0x24] */
            ii(0x1016_887c, 2);  mov(ecx, esi);                        /* mov ecx, esi */
            ii(0x1016_887e, 3);  mov(edx, memd[ds, eax + 32]);         /* mov edx, [eax+0x20] */
            ii(0x1016_8881, 2);  mov(ebx, edi);                        /* mov ebx, edi */
            ii(0x1016_8883, 1);  push(edx);                            /* push edx */
            ii(0x1016_8884, 4);  mov(eax, memd[ss, esp + 56]);         /* mov eax, [esp+0x38] */
        ...
        l_0x1016_888f:
            ...
            ii(0x1016_88c4, 4);  mov(edx, memd[ss, esp + 88]);         /* mov edx, [esp+0x58] */
            ...
            ii(0x1016_88f8, 4);  mov(memd[ss, esp + 28], eax);         /* mov [esp+0x1c], eax */
            ...
            ii(0x1016_8902, 4);  mov(memd[ss, esp + 16], eax);         /* mov [esp+0x10], eax */
            ...
            ii(0x1016_893a, 4);  mov(memd[ss, esp + 36], eax);         /* mov [esp+0x24], eax */
            ...
            ii(0x1016_8944, 4);  mov(memd[ss, esp + 36], eax);         /* mov [esp+0x24], eax */
            ...
            ii(0x1016_895f, 4);  mov(memd[ss, esp + 12], eax);         /* mov [esp+0xc], eax */
            ...
            ii(0x1016_8969, 4);  mov(memd[ss, esp + 20], eax);         /* mov [esp+0x14], eax */
            ...
            ii(0x1016_898c, 4);  mov(edx, memd[ss, esp + 52]);         /* mov edx, [esp+0x34] */
            ...
            ii(0x1016_89a1, 4);  mov(edx, memd[ss, esp + 88]);         /* mov edx, [esp+0x58] */
            ...
            ii(0x1016_89cd, 4);  mov(ebx, memd[ss, esp + 28]);         /* mov ebx, [esp+0x1c] */
            ii(0x1016_89d1, 1);  push(ebx);                            /* push ebx */
            ii(0x1016_89d2, 4);  mov(ecx, memd[ss, esp + 16]);         /* mov ecx, [esp+0x10] */
            ii(0x1016_89d6, 2);  mov(edx, esi);                        /* mov edx, esi */
            ii(0x1016_89d8, 1);  push(ecx);                            /* push ecx */
            ii(0x1016_89d9, 5);  mov(ecx, 2);                          /* mov ecx, 0x2 */
            ii(0x1016_89de, 4);  mov(eax, memd[ss, esp + 68]);         /* mov eax, [esp+0x44] */
            ...
            ii(0x1016_8a0b, 4);  mov(eax, memd[ss, esp + 36]);         /* mov eax, [esp+0x24] */
            ii(0x1016_8a0f, 5);  mov(ecx, 1);                          /* mov ecx, 0x1 */
            ii(0x1016_8a14, 1);  push(eax);                            /* push eax */
            ii(0x1016_8a15, 4);  mov(edx, memd[ss, esp + 36]);         /* mov edx, [esp+0x24] */
            ii(0x1016_8a19, 2);  mov(ebx, ecx);                        /* mov ebx, ecx */
            ii(0x1016_8a1b, 1);  push(edx);                            /* push edx */
            ii(0x1016_8a1c, 4);  mov(eax, memd[ss, esp + 68]);         /* mov eax, [esp+0x44] */
            ...
            ii(0x1016_8a2f, 4);  mov(ebx, memd[ss, esp + 12]);         /* mov ebx, [esp+0xc] */
            ii(0x1016_8a33, 4);  mov(ecx, memd[ss, esp + 16]);         /* mov ecx, [esp+0x10] */
            ii(0x1016_8a37, 1);  push(ebx);                            /* push ebx */
            ii(0x1016_8a38, 2);  mov(edx, esi);                        /* mov edx, esi */
            ii(0x1016_8a3a, 4);  mov(eax, memd[ss, esp + 60]);         /* mov eax, [esp+0x3c] */
            ...
            ii(0x1016_8a4a, 4);  mov(eax, memd[ss, esp + 56]);         /* mov eax, [esp+0x38] */
            ii(0x1016_8a4e, 1);  push(eax);                            /* push eax */
            ii(0x1016_8a4f, 1);  push(ebp);                            /* push ebp */
            ii(0x1016_8a50, 4);  mov(edx, memd[ss, esp + 100]);        /* mov edx, [esp+0x64] */
            ii(0x1016_8a54, 1);  push(edx);                            /* push edx */
            ii(0x1016_8a55, 4);  mov(ebx, memd[ss, esp + 96]);         /* mov ebx, [esp+0x60] */
            ii(0x1016_8a59, 1);  push(ebx);                            /* push ebx */
            ii(0x1016_8a5a, 4);  mov(ecx, memd[ss, esp + 96]);         /* mov ecx, [esp+0x60] */
            ii(0x1016_8a5e, 1);  push(ecx);                            /* push ecx */
            ii(0x1016_8a5f, 4);  mov(eax, memd[ss, esp + 96]);         /* mov eax, [esp+0x60] */
            ii(0x1016_8a63, 1);  push(eax);                            /* push eax */
            ii(0x1016_8a64, 4);  mov(edx, memd[ss, esp + 28]);         /* mov edx, [esp+0x1c] */
            ii(0x1016_8a68, 1);  push(edx);                            /* push edx */
            ii(0x1016_8a69, 4);  mov(ebx, memd[ss, esp + 76]);         /* mov ebx, [esp+0x4c] */
            ii(0x1016_8a6d, 2);  mov(ecx, esi);                        /* mov ecx, esi */
            ii(0x1016_8a6f, 1);  push(edi);                            /* push edi */
            ii(0x1016_8a70, 4);  mov(eax, memd[ss, esp + 52]);         /* mov eax, [esp+0x34] */
            ii(0x1016_8a74, 4);  mov(edx, memd[ss, esp + 76]);         /* mov edx, [esp+0x4c] */
            ...
            ii(0x1016_8a8a, 4);  mov(eax, memd[ss, esp + 52]);         /* mov eax, [esp+0x34] */
        ...
        l_0x1016_8aa1:
            ...
            ii(0x1016_8aa3, 4);  mov(edx, memd[ss, esp + 40]);         /* mov edx, [esp+0x28] */
            ii(0x1016_8aa7, 3);  mov(ebx, memd[ds, eax + 48]);         /* mov ebx, [eax+0x30] */
