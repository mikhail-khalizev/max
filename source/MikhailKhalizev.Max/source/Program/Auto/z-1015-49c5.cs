...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_49c5()
        {
            ...
            ii(0x1015_49e7, 3);  mov(al, memb[ds, edx + 38]);          /* mov al, [edx+0x26] */
            ii(0x1015_49ea, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1015_49ed, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x1015_4a0a, 3);  mov(bl, memb[ds, eax + 38]);          /* mov bl, [eax+0x26] */
            ...
            ii(0x1015_4a62, 3);  mov(edx, memd[ds, eax + 26]);         /* mov edx, [eax+0x1a] */
            ...
            ii(0x1015_4a76, 3);  mov(eax, memd[ds, eax + 24]);         /* mov eax, [eax+0x18] */
            ...
            ii(0x1015_4a81, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ...
            ii(0x1015_4aa2, 4);  mov(memb[ss, ebp - 16], 1);           /* mov byte [ebp-0x10], 0x1 */
            ii(0x1015_4aa6, 2);  jmp(0x1015_4aac, 4); goto l_0x1015_4aac;/* jmp 0x10154aac */
        l_0x1015_4aa8:
            ii(0x1015_4aa8, 4);  mov(memb[ss, ebp - 16], 0);           /* mov byte [ebp-0x10], 0x0 */
        l_0x1015_4aac:
            ii(0x1015_4aac, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_4aaf, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1015_4ab1, 3);  mov(dl, memb[ds, eax + 38]);          /* mov dl, [eax+0x26] */
            ii(0x1015_4ab4, 3);  add(edx, memd[ss, ebp - 8]);          /* add edx, [ebp-0x8] */
            ii(0x1015_4ab7, 3);  mov(al, memb[ss, ebp - 16]);          /* mov al, [ebp-0x10] */
            ii(0x1015_4aba, 6);  mov(memb[ds, edx + 171], al);         /* mov [edx+0xab], al */
            ii(0x1015_4ac0, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_4ac3, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ...
            ii(0x1015_4ae6, 3);  and(memd[ds, eax + 18], edx);         /* and [eax+0x12], edx */
            ii(0x1015_4ae9, 3);  mov(al, memb[ss, ebp - 4]);           /* mov al, [ebp-0x4] */
            ii(0x1015_4aec, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ii(0x1015_4aef, 3);  mov(memb[ds, edx + 38], al);          /* mov [edx+0x26], al */
            ii(0x1015_4af2, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_4af5, 4);  mov(memb[ds, eax + 92], 0);           /* mov byte [eax+0x5c], 0x0 */
            ...
            ii(0x1015_4b11, 3);  or(memd[ds, eax + 18], edx);          /* or [eax+0x12], edx */
            ...
            ii(0x1015_4b2a, 3);  mov(memd[ds, eax + 34], edx);         /* mov [eax+0x22], edx */
            ii(0x1015_4b2d, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_4b30, 4);  cmp(memb[ds, eax + 61], 0x1a);        /* cmp byte [eax+0x3d], 0x1a */
            ...
            ii(0x1015_4b41, 4);  mov(memb[ds, eax + 88], 0);           /* mov byte [eax+0x58], 0x0 */
        l_0x1015_4b45:
            ...
            ii(0x1015_4b59, 7);  mov(memb[ds, eax + 171], 1);          /* mov byte [eax+0xab], 0x1 */
            ii(0x1015_4b60, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1015_4b63, 5);  call(0x100a_8d5f, -0xa_be09);         /* call 0x100a8d5f */
            ii(0x1015_4b68, 4);  movsx(edx, memw[ss, ebp - 12]);       /* movsx edx, word [ebp-0xc] */
