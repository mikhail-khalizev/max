...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x18_afbb, 5);  test(memb[ds, 0x15], 1);                /* test byte [0x15], 0x1 */
            ii(0x18_afc0, 2);  if(jnz_func(0x18_af98, -0x2a)) return;  /* jnz 0xaf98 */
            ii(0x18_afc2, 5);  cmp(memb[ds, 0x34], 0x15);              /* cmp byte [0x34], 0x15 */
            ii(0x18_afc7, 2);  if(jnz_func(0x18_af98, -0x31)) return;  /* jnz 0xaf98 */
            ii(0x18_afc9, 3);  call(0x18_a8bf, -0x70d);                /* call 0xa8bf */
            ii(0x18_afcc, 2);  push(0x40);                             /* push 0x40 */
            ii(0x18_afce, 1);  pop(es);                                /* pop es */
            ii(0x18_afcf, 5);  mov(bx, memw[es, 0x6e]);                /* mov bx, [es:0x6e] */
            ii(0x18_afd4, 3);  mov(ax, 0x16);                          /* mov ax, 0x16 */
            ii(0x18_afd7, 2);  mul(bx);                                /* mul bx */
            ii(0x18_afd9, 3);  mov(cx, 3);                             /* mov cx, 0x3 */
            ii(0x18_afdc, 2);  div(cx);                                /* div cx */
            ii(0x18_afde, 5);  mov(cx, memw[es, 0x6c]);                /* mov cx, [es:0x6c] */
            ii(0x18_afe3, 3);  shr(cx, 0xd);                           /* shr cx, 0xd */
            ii(0x18_afe6, 2);  add(cx, ax);                            /* add cx, ax */
            ii(0x18_afe8, 4);  mov(ax, memw[es, 0x6c]);                /* mov ax, [es:0x6c] */
            ...
            ii(0x18_b011, 2);  jmp_func(0x18_af95, -0x7e);             /* jmp 0xaf95 */
        }
    }
}
