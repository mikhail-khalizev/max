...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_3e05()
        {
            ...
            ii(0x100e_3e22, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x100e_3e25, 5);  call(0x1007_20b1, -0x7_1d79);         /* call 0x100720b1 */
            ii(0x100e_3e2a, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x100e_3e2d, 5);  call(0x1007_20b1, -0x7_1d81);         /* call 0x100720b1 */
            ii(0x100e_3e32, 3);  lea(edx, memd[ss, ebp - 60]);         /* lea edx, [ebp-0x3c] */
            ii(0x100e_3e35, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_3e38, 5);  call(0x100d_6a11, -0xd42c);           /* call 0x100d6a11 */
            ii(0x100e_3e3d, 3);  lea(ebx, memd[ss, ebp - 32]);         /* lea ebx, [ebp-0x20] */
            ii(0x100e_3e40, 3);  lea(edx, memd[ss, ebp - 20]);         /* lea edx, [ebp-0x14] */
            ...
            ii(0x100e_3e58, 3);  lea(edx, memd[ss, ebp - 60]);         /* lea edx, [ebp-0x3c] */
            ii(0x100e_3e5b, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_3e5e, 3);  mov(eax, memd[ds, eax + 68]);         /* mov eax, [eax+0x44] */
            ii(0x100e_3e61, 5);  call(0x100d_7f6c, -0xbefa);           /* call 0x100d7f6c */
            ii(0x100e_3e66, 3);  lea(edx, memd[ss, ebp - 60]);         /* lea edx, [ebp-0x3c] */
            ii(0x100e_3e69, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_3e6c, 3);  mov(eax, memd[ds, eax + 72]);         /* mov eax, [eax+0x48] */
            ii(0x100e_3e6f, 5);  call(0x100d_7f6c, -0xbf08);           /* call 0x100d7f6c */
            ii(0x100e_3e74, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_3e77, 3);  mov(eax, memd[ds, eax + 68]);         /* mov eax, [eax+0x44] */
            ii(0x100e_3e7a, 5);  call(0x100d_4f24, -0xef5b);           /* call 0x100d4f24 */
            ii(0x100e_3e7f, 3);  mov(memd[ss, ebp - 64], eax);         /* mov [ebp-0x40], eax */
            ii(0x100e_3e82, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_3e85, 3);  mov(eax, memd[ds, eax + 40]);         /* mov eax, [eax+0x28] */
            ...
            ii(0x100e_3e8f, 7);  mov(memd[ss, ebp - 64], 0);           /* mov dword [ebp-0x40], 0x0 */
            ii(0x100e_3e96, 2);  jmp(0x100e_3eb6, 0x1e); goto l_0x100e_3eb6;/* jmp 0x100e3eb6 */
        l_0x100e_3e98:
            ii(0x100e_3e98, 4);  movsx(eax, memw[ss, ebp - 18]);       /* movsx eax, word [ebp-0x12] */
            ii(0x100e_3e9c, 4);  movsx(edx, memw[ss, ebp - 64]);       /* movsx edx, word [ebp-0x40] */
            ii(0x100e_3ea0, 3);  imul(edx, eax);                       /* imul edx, eax */
            ii(0x100e_3ea3, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_3ea6, 3);  mov(ebx, memd[ds, eax + 40]);         /* mov ebx, [eax+0x28] */
        ...
        l_0x100e_3eb6:
            ...
            ii(0x100e_3f04, 3);  mov(eax, memd[ds, eax + 68]);         /* mov eax, [eax+0x44] */
            ii(0x100e_3f07, 5);  call(0x100d_4f58, -0xefb4);           /* call 0x100d4f58 */
            ii(0x100e_3f0c, 3);  movsx(ecx, ax);                       /* movsx ecx, ax */
            ii(0x100e_3f0f, 4);  movsx(ebx, memw[ss, ebp - 64]);       /* movsx ebx, word [ebp-0x40] */
            ii(0x100e_3f13, 4);  movsx(edx, memw[ss, ebp - 44]);       /* movsx edx, word [ebp-0x2c] */
            ii(0x100e_3f17, 3);  mov(eax, memd[ss, ebp - 68]);         /* mov eax, [ebp-0x44] */
            ...
            ii(0x100e_3f29, 4);  movsx(eax, memw[ss, ebp - 18]);       /* movsx eax, word [ebp-0x12] */
            ...
            ii(0x100e_3f34, 3);  lea(eax, memd[ss, ebp - 120]);        /* lea eax, [ebp-0x78] */
            ...
            ii(0x100e_3f59, 3);  mov(eax, memd[ds, eax + 72]);         /* mov eax, [eax+0x48] */
            ...
            ii(0x100e_3f66, 3);  mov(eax, memd[ds, eax + 72]);         /* mov eax, [eax+0x48] */
            ...
            ii(0x100e_3f73, 3);  mov(eax, memd[ds, eax + 72]);         /* mov eax, [eax+0x48] */
            ...
            ii(0x100e_3f80, 3);  mov(eax, memd[ds, eax + 72]);         /* mov eax, [eax+0x48] */
            ii(0x100e_3f83, 5);  call(0x100d_4ef0, -0xf098);           /* call 0x100d4ef0 */
            ii(0x100e_3f88, 3);  movsx(ecx, ax);                       /* movsx ecx, ax */
            ii(0x100e_3f8b, 3);  lea(ebx, memd[ss, ebp - 120]);        /* lea ebx, [ebp-0x78] */
            ii(0x100e_3f8e, 4);  movsx(edx, memw[ss, ebp - 44]);       /* movsx edx, word [ebp-0x2c] */
            ii(0x100e_3f92, 3);  mov(eax, memd[ss, ebp - 38]);         /* mov eax, [ebp-0x26] */
            ...
            ii(0x100e_3fa0, 3);  mov(edx, memd[ss, ebp - 42]);         /* mov edx, [ebp-0x2a] */
            ii(0x100e_3fa3, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_3fa6, 3);  mov(eax, memd[ds, eax + 68]);         /* mov eax, [eax+0x44] */
            ii(0x100e_3fa9, 5);  call(0x100d_820d, -0xbda1);           /* call 0x100d820d */
            ii(0x100e_3fae, 3);  mov(edx, memd[ss, ebp - 42]);         /* mov edx, [ebp-0x2a] */
            ii(0x100e_3fb1, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_3fb4, 3);  mov(eax, memd[ds, eax + 72]);         /* mov eax, [eax+0x48] */
