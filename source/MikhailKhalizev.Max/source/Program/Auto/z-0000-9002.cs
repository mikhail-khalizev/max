...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x9002, 4);  enter(4, 0);                               /* enter 0x4, 0x0 */
            ii(0x9006, 5);  test(memb[ds, 0x47], 2);                   /* test byte [0x47], 0x2 */
            ii(0x900b, 2);  if(jz(0x9085, 0x78)) goto l_0x9085;        /* jz 0x9085 */
            ii(0x900d, 5);  mov(memw[ss, bp - 4], 0xa000);             /* mov word [bp-0x4], 0xa000 */
            ii(0x9012, 5);  mov(memw[ss, bp - 2], 0xf);                /* mov word [bp-0x2], 0xf */
        l_0x9017:
            ii(0x9017, 4);  cmp(memw[ss, bp - 2], 0xf);                /* cmp word [bp-0x2], 0xf */
            ii(0x901b, 2);  if(jg(0x906e, 0x51)) goto l_0x906e;        /* jg 0x906e */
            ii(0x901d, 2);  if(jl(0x9025, 6)) goto l_0x9025;           /* jl 0x9025 */
            ii(0x901f, 4);  cmp(memw[ss, bp - 4], -1 /* 0xff */);      /* cmp word [bp-0x4], 0xffff */
            ii(0x9023, 2);  if(jae(0x906e, 0x49)) goto l_0x906e;       /* jae 0x906e */
        l_0x9025:
            ii(0x9025, 3);  push(memw[ss, bp - 2]);                    /* push word [bp-0x2] */
            ii(0x9028, 3);  push(memw[ss, bp - 4]);                    /* push word [bp-0x4] */
            ...
            ii(0x9034, 3);  mov(ax, memw[ss, bp - 4]);                 /* mov ax, [bp-0x4] */
            ii(0x9037, 3);  mov(dx, memw[ss, bp - 2]);                 /* mov dx, [bp-0x2] */
            ...
            ii(0x9050, 3);  mov(ax, memw[ss, bp - 4]);                 /* mov ax, [bp-0x4] */
            ii(0x9053, 3);  mov(dx, memw[ss, bp - 2]);                 /* mov dx, [bp-0x2] */
            ii(0x9056, 2);  mov(cl, 4);                                /* mov cl, 0x4 */
            ...
            ii(0x9060, 3);  add(sp, 8);                                /* add sp, 0x8 */
            ii(0x9063, 5);  add(memw[ss, bp - 4], 0x400);              /* add word [bp-0x4], 0x400 */
            ii(0x9068, 4);  adc(memw[ss, bp - 2], 0);                  /* adc word [bp-0x2], 0x0 */
            ii(0x906c, 2);  jmp(0x9017, -0x57); goto l_0x9017;         /* jmp 0x9017 */
        l_0x906e:
            ii(0x906e, 3);  mov(ax, memw[ss, bp - 4]);                 /* mov ax, [bp-0x4] */
            ii(0x9071, 3);  add(ah, 0x60);                             /* add ah, 0x60 */
            ii(0x9074, 3);  mov(bx, memw[ss, bp + 4]);                 /* mov bx, [bp+0x4] */
            ii(0x9077, 2);  mov(memw[ds, bx], ax);                     /* mov [bx], ax */
            ii(0x9079, 2);  or(ax, ax);                                /* or ax, ax */
            ii(0x907b, 2);  if(jz(0x9085, 8)) goto l_0x9085;           /* jz 0x9085 */
        ...
        l_0x9085:
            ii(0x9085, 5);  and(memb[ds, 0x47], -3 /* 0xfd */);        /* and byte [0x47], 0xfd */
