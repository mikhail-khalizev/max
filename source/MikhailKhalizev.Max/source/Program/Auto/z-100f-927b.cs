...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_927b()
        {
            ...
            ii(0x100f_9290, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x100f_9293, 3);  mov(memd[ss, ebp - 12], edx);         /* mov [ebp-0xc], edx */
            ii(0x100f_9296, 3);  mov(memd[ss, ebp - 8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x100f_9299, 3);  mov(memd[ss, ebp - 4], ecx);          /* mov [ebp-0x4], ecx */
            ii(0x100f_929c, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100f_929f, 3);  cmp(eax, memd[ss, ebp - 12]);         /* cmp eax, [ebp-0xc] */
            ii(0x100f_92a2, 2);  if(jnz(0x100f_92e4, 0x40)) goto l_0x100f_92e4;/* jnz 0x100f92e4 */
            ii(0x100f_92a4, 4);  movsx(ebx, memw[ss, ebp - 4]);        /* movsx ebx, word [ebp-0x4] */
            ii(0x100f_92a8, 4);  movsx(edx, memw[ss, ebp - 8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100f_92ac, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100f_92af, 5);  call(0x1007_284b, -0x8_6a69);         /* call 0x1007284b */
            ii(0x100f_92b4, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100f_92b7, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100f_92ba, 3);  cmp(eax, memd[ss, ebp - 12]);         /* cmp eax, [ebp-0xc] */
            ii(0x100f_92bd, 2);  if(jz(0x100f_92c5, 6)) goto l_0x100f_92c5;/* jz 0x100f92c5 */
            ii(0x100f_92bf, 4);  cmp(memd[ss, ebp - 12], 0);           /* cmp dword [ebp-0xc], 0x0 */
            ii(0x100f_92c3, 2);  if(jnz(0x100f_92c7, 2)) goto l_0x100f_92c7;/* jnz 0x100f92c7 */
        l_0x100f_92c5:
        ...
        l_0x100f_92c7:
            ...
            ii(0x100f_92d1, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x100f_92e0, 2);  if(jnz(0x100f_92e4, 2)) goto l_0x100f_92e4;/* jnz 0x100f92e4 */
        l_0x100f_92e2:
        ...
        l_0x100f_92e4:
            ...
            ii(0x100f_92f0, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
