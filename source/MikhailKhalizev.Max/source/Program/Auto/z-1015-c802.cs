...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_c802()
        {
            ...
            ii(0x1015_c814, 6);  sub(esp, 4);                          /* sub esp, 0x4 */
            ii(0x1015_c81a, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_c81d, 5);  mov(eax, 3);                          /* mov eax, 0x3 */
            ...
            ii(0x1015_c82b, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1015_c82e, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1015_c831, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ...
            ii(0x1015_c848, 7);  mov(memb[ds, 0x101c_8170], 1);        /* mov byte [0x101c8170], 0x1 */
        l_0x1015_c84f:
