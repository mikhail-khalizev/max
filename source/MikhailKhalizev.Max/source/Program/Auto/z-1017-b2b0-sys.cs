...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_b2b0()
        {
            ...
            ii(0x1017_b2be, 3);  mov(memd[ss, ebp - 36], eax);         /* mov [ebp-0x24], eax */
            ii(0x1017_b2c1, 3);  mov(ah, memb[ss, ebp - 35]);          /* mov ah, [ebp-0x23] */
            ii(0x1017_b2c4, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1017_b2c6, 2);  xor(esi, esi);                        /* xor esi, esi */
            ii(0x1017_b2c8, 3);  mov(memd[ss, ebp - 28], edx);         /* mov [ebp-0x1c], edx */
            ii(0x1017_b2cb, 3);  test(ah, 0x80);                       /* test ah, 0x80 */
            ii(0x1017_b2ce, 2);  if(jz(0x1017_b2e4, 0x14)) goto l_0x1017_b2e4;/* jz 0x1017b2e4 */
            ii(0x1017_b2d0, 3);  mov(ecx, memd[ss, ebp - 36]);         /* mov ecx, [ebp-0x24] */
            ii(0x1017_b2d3, 5);  mov(ebx, 1);                          /* mov ebx, 0x1 */
            ii(0x1017_b2d8, 6);  and(ecx, 0x7fff);                     /* and ecx, 0x7fff */
            ii(0x1017_b2de, 3);  mov(memd[ss, ebp - 28], ebx);         /* mov [ebp-0x1c], ebx */
            ii(0x1017_b2e1, 3);  mov(memd[ss, ebp - 36], ecx);         /* mov [ebp-0x24], ecx */
        l_0x1017_b2e4:
            ii(0x1017_b2e4, 3);  mov(edi, memd[ss, ebp - 36]);         /* mov edi, [ebp-0x24] */
            ...
            ii(0x1017_b31b, 3);  mov(memd[ss, ebp - 36], eax);         /* mov [ebp-0x24], eax */
        ...
        l_0x1017_b323:
            ...
            ii(0x1017_b368, 3);  mov(memd[ss, ebp - 36], edi);         /* mov [ebp-0x24], edi */
        ...
        l_0x1017_b36d:
            ...
            ii(0x1017_b37c, 7);  cmp(memd[ss, ebp - 36], 0x100);       /* cmp dword [ebp-0x24], 0x100 */
            ...
            ii(0x1017_b3c6, 3);  mov(memd[ss, ebp - 36], ecx);         /* mov [ebp-0x24], ecx */
            ii(0x1017_b3c9, 2);  jmp(0x1017_b3db, 0x10); goto l_0x1017_b3db;/* jmp 0x1017b3db */
        l_0x1017_b3cb:
            ii(0x1017_b3cb, 3);  lea(eax, memd[ss, ebp - 36]);         /* lea eax, [ebp-0x24] */
        ...
        l_0x1017_b3db:
            ii(0x1017_b3db, 3);  mov(eax, memd[ss, ebp - 36]);         /* mov eax, [ebp-0x24] */
            ii(0x1017_b3de, 6);  lea(edx, memd[ss, ebp - 300]);        /* lea edx, [ebp-0x12c] */
            ii(0x1017_b3e4, 3);  lea(ebx, memd[ss, ebp - 40]);         /* lea ebx, [ebp-0x28] */
            ii(0x1017_b3e7, 3);  lea(ecx, memd[ss, ebp - 44]);         /* lea ecx, [ebp-0x2c] */
            ...
            ii(0x1017_b3f7, 6);  mov(al, memb[ss, ebp - 298]);         /* mov al, [ebp-0x12a] */
            ii(0x1017_b3fd, 2);  and(al, 5);                           /* and al, 0x5 */
            ii(0x1017_b3ff, 2);  cmp(al, 5);                           /* cmp al, 0x5 */
            ii(0x1017_b401, 2);  if(jnz(0x1017_b40d, 0xa)) goto l_0x1017_b40d;/* jnz 0x1017b40d */
            ii(0x1017_b403, 2);  xor(ecx, ecx);                        /* xor ecx, ecx */
            ii(0x1017_b405, 3);  mov(edi, memd[ss, ebp - 40]);         /* mov edi, [ebp-0x28] */
            ii(0x1017_b408, 3);  mov(memd[ss, ebp - 24], ecx);         /* mov [ebp-0x18], ecx */
            ii(0x1017_b40b, 2);  jmp(0x1017_b437, 0x2a); goto l_0x1017_b437;/* jmp 0x1017b437 */
        l_0x1017_b40d:
            ii(0x1017_b40d, 6);  mov(al, memb[ss, ebp - 297]);         /* mov al, [ebp-0x129] */
            ii(0x1017_b413, 2);  and(al, 5);                           /* and al, 0x5 */
            ii(0x1017_b415, 2);  cmp(al, 5);                           /* cmp al, 0x5 */
            ii(0x1017_b417, 2);  if(jnz(0x1017_b426, 0xd)) goto l_0x1017_b426;/* jnz 0x1017b426 */
            ii(0x1017_b419, 5);  mov(ebx, 1);                          /* mov ebx, 0x1 */
            ii(0x1017_b41e, 3);  mov(edi, memd[ss, ebp - 44]);         /* mov edi, [ebp-0x2c] */
            ii(0x1017_b421, 3);  mov(memd[ss, ebp - 24], ebx);         /* mov [ebp-0x18], ebx */
        ...
        l_0x1017_b426:
            ...
            ii(0x1017_b432, 3);  mov(memd[ss, ebp - 24], edx);         /* mov [ebp-0x18], edx */
            ii(0x1017_b435, 2);  mov(edi, eax);                        /* mov edi, eax */
        l_0x1017_b437:
            ii(0x1017_b437, 7);  test(memb[ss, ebp - 300], 2);         /* test byte [ebp-0x12c], 0x2 */
            ...
            ii(0x1017_b444, 7);  mov(cx, memw[ss, ebp - 282]);         /* mov cx, [ebp-0x11a] */
            ii(0x1017_b44b, 7);  mov(bx, memw[ss, ebp - 280]);         /* mov bx, [ebp-0x118] */
            ii(0x1017_b452, 2);  jmp(0x1017_b4a7, 0x53); goto l_0x1017_b4a7;/* jmp 0x1017b4a7 */
        l_0x1017_b454:
            ii(0x1017_b454, 3);  mov(eax, memd[ss, ebp - 36]);         /* mov eax, [ebp-0x24] */
            ii(0x1017_b457, 5);  sub(eax, 0x100);                      /* sub eax, 0x100 */
            ii(0x1017_b45c, 3);  cmp(eax, 7);                          /* cmp eax, 0x7 */
            ii(0x1017_b45f, 6);  if(ja(0x1017_b55c, 0xf7)) goto l_0x1017_b55c;/* ja 0x1017b55c */
            ii(0x1017_b465, 8);  /* jmp dword [cs:eax*4+0x1017b290] */
        ...
        l_0x1017_b4a7:
            ...
            ii(0x1017_b4a9, 2);  if(jz(0x1017_b4ad, 2)) goto l_0x1017_b4ad;/* jz 0x1017b4ad */
            ii(0x1017_b4ab, 2);  mov(ebx, esi);                        /* mov ebx, esi */
        l_0x1017_b4ad:
            ii(0x1017_b4ad, 4);  cmp(memd[ss, ebp - 28], 0);           /* cmp dword [ebp-0x1c], 0x0 */
            ii(0x1017_b4b1, 2);  if(jz(0x1017_b4e6, 0x33)) goto l_0x1017_b4e6;/* jz 0x1017b4e6 */
            ii(0x1017_b4b3, 5);  mov(edx, 0x3d4);                      /* mov edx, 0x3d4 */
            ii(0x1017_b4b8, 2);  mov(al, 9);                           /* mov al, 0x9 */
            ...
            ii(0x1017_b4c3, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x1017_b4c6, 4);  test(memb[ss, ebp - 32], 0x80);       /* test byte [ebp-0x20], 0x80 */
            ii(0x1017_b4ca, 2);  if(jnz(0x1017_b4e6, 0x1a)) goto l_0x1017_b4e6;/* jnz 0x1017b4e6 */
            ii(0x1017_b4cc, 5);  mov(edx, 0x3d4);                      /* mov edx, 0x3d4 */
            ii(0x1017_b4d1, 2);  mov(al, 9);                           /* mov al, 0x9 */
            ii(0x1017_b4d3, 1);  outb(dx, al);                         /* out dx, al */
            ii(0x1017_b4d4, 3);  mov(al, memb[ss, ebp - 32]);          /* mov al, [ebp-0x20] */
            ...
            ii(0x1017_b4e4, 2);  shr(ebx, 1);                          /* shr ebx, 1 */
        l_0x1017_b4e6:
            ii(0x1017_b4e6, 10);  mov(memd[ss, ebp - 288], /* sys */ 0x1018_cda8);/* mov dword [ebp-0x120], 0x1018cda8 */
            ii(0x1017_b4f0, 7);  test(memb[ss, ebp - 300], 2);         /* test byte [ebp-0x12c], 0x2 */
            ii(0x1017_b4f7, 2);  if(jz(0x1017_b510, 0x17)) goto l_0x1017_b510;/* jz 0x1017b510 */
            ii(0x1017_b4f9, 6);  mov(ah, memb[ss, ebp - 275]);         /* mov ah, [ebp-0x113] */
            ii(0x1017_b4ff, 3);  cmp(ah, 0xf);                         /* cmp ah, 0xf */
            ii(0x1017_b502, 2);  if(jz(0x1017_b509, 5)) goto l_0x1017_b509;/* jz 0x1017b509 */
            ii(0x1017_b504, 3);  cmp(ah, 0x10);                        /* cmp ah, 0x10 */
            ii(0x1017_b507, 2);  if(jnz(0x1017_b510, 7)) goto l_0x1017_b510;/* jnz 0x1017b510 */
        l_0x1017_b509:
            ii(0x1017_b509, 5);  mov(eax, 1);                          /* mov eax, 0x1 */
            ii(0x1017_b50e, 2);  jmp(0x1017_b512, 2); goto l_0x1017_b512;/* jmp 0x1017b512 */
        l_0x1017_b510:
            ii(0x1017_b510, 2);  xor(eax, eax);                        /* xor eax, eax */
        l_0x1017_b512:
            ii(0x1017_b512, 1);  push(eax);                            /* push eax */
            ii(0x1017_b513, 2);  xor(eax, eax);                        /* xor eax, eax */
            ii(0x1017_b515, 6);  mov(edx, memd[ss, ebp - 288]);        /* mov edx, [ebp-0x120] */
            ii(0x1017_b51b, 7);  mov(ax, memw[ss, ebp - 296]);         /* mov ax, [ebp-0x128] */
            ...
            ii(0x1017_b54a, 5);  mov(eax, 1);                          /* mov eax, 0x1 */
            ii(0x1017_b54f, 3);  add(esp, 0x24);                       /* add esp, 0x24 */
            ii(0x1017_b552, 3);  lea(esp, memd[ss, ebp - 20]);         /* lea esp, [ebp-0x14] */
        ...
        l_0x1017_b55c:
            ...
            ii(0x1017_b55e, 3);  lea(esp, memd[ss, ebp - 20]);         /* lea esp, [ebp-0x14] */
