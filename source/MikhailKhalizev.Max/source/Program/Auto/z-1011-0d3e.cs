...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_0d3e()
        {
            ...
            ii(0x1011_0d50, 6);  sub(esp, 4);                          /* sub esp, 0x4 */
            ii(0x1011_0d56, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_0d59, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_0d5c, 7);  mov(memd[ds, eax + 8], 1);            /* mov dword [eax+0x8], 0x1 */
