...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0018_b5fc()
        {
            ...
            ii(0x18_b617, 3);  mov(ax, memw[ss, bp + 22]);             /* mov ax, [bp+0x16] */
            ...
            ii(0x18_b622, 3);  mov(si, memw[ss, bp + 16]);             /* mov si, [bp+0x10] */
            ii(0x18_b625, 3);  call(0x18_b55c, -0xcc);                 /* call 0xb55c */
            ii(0x18_b628, 3);  mov(ax, memw[ss, bp + 22]);             /* mov ax, [bp+0x16] */
            ii(0x18_b62b, 3);  mov(cx, memw[ss, bp + 20]);             /* mov cx, [bp+0x14] */
        ...
        l_0x18_b637:
            ii(0x18_b637, 3);  mov(memw[ss, bp + 22], ax);             /* mov [bp+0x16], ax */
        ...
        l_0x18_b642:
            ...
            ii(0x18_b643, 3);  mov(cx, memw[ss, bp + 20]);             /* mov cx, [bp+0x14] */
            ...
            ii(0x18_b655, 3);  mov(si, memw[ss, bp + 16]);             /* mov si, [bp+0x10] */
