...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_aaa8()
        {
            ...
            ii(0x1013_aaba, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1013_aac0, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1013_aac3, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_aac6, 7);  mov(memd[ds, eax + 2], 0x101b_6ec4);  /* mov dword [eax+0x2], 0x101b6ec4 */
            ii(0x1013_aacd, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_aad0, 5);  mov(memw[ds, eax], 0);                /* mov word [eax], 0x0 */
            ii(0x1013_aad5, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1013_aad8, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_aadb, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
