...
namespace MikhailKhalizev.Max.Program
{
    ...
    {
        [MethodInfo("0x4033-b1e8c28e")]
        public void Method_0000_4033()
        {
            ii(0x4033, 1);  pusha();                                   /* pusha */
            ii(0x4034, 4);  call_abs(memw[ds, 0x9c0]);                 /* call word [0x9c0] */
            ...
            ii(0x404a, 4);  or(ax, memw[ds, 0x40]);                    /* or ax, [0x40] */
            ii(0x404e, 3);  lmsw(ax);                                  /* lmsw ax */
            ii(0x4051, 4);  jmp_abs(memw[ds, 0x9c2]);                  /* jmp word [0x9c2] */
        }
    }
}
