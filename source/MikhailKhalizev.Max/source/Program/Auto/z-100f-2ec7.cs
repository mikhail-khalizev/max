...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_2ec7()
        {
            ...
            ii(0x100f_2edf, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100f_2ee2, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_2ef3, 3);  mov(memd[ss, ebp - 12], edx);         /* mov [ebp-0xc], edx */
            ii(0x100f_2ef6, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_2f06, 6);  lea(eax, memd[ss, ebp - 200]);        /* lea eax, [ebp-0xc8] */
            ii(0x100f_2f0c, 5);  call(Definitions.sys_memset, 0x7_2ecf);/* call 0x10165de0 */
            ii(0x100f_2f11, 6);  lea(ebx, memd[ss, ebp - 200]);        /* lea ebx, [ebp-0xc8] */
            ii(0x100f_2f17, 5);  mov(edx, 0x101c_8178);                /* mov edx, 0x101c8178 */
            ii(0x100f_2f1c, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_2f20, 5);  call(0x100f_2a6f, -0x4b6);            /* call 0x100f2a6f */
            ii(0x100f_2f25, 6);  lea(ebx, memd[ss, ebp - 200]);        /* lea ebx, [ebp-0xc8] */
            ii(0x100f_2f2b, 5);  mov(edx, 0x101c_8184);                /* mov edx, 0x101c8184 */
            ii(0x100f_2f30, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_2f34, 5);  call(0x100f_2a6f, -0x4ca);            /* call 0x100f2a6f */
            ii(0x100f_2f39, 6);  lea(ebx, memd[ss, ebp - 200]);        /* lea ebx, [ebp-0xc8] */
            ii(0x100f_2f3f, 5);  mov(edx, 0x101c_819c);                /* mov edx, 0x101c819c */
            ii(0x100f_2f44, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_2f48, 5);  call(0x100f_2a6f, -0x4de);            /* call 0x100f2a6f */
            ii(0x100f_2f4d, 6);  lea(ebx, memd[ss, ebp - 200]);        /* lea ebx, [ebp-0xc8] */
            ii(0x100f_2f53, 5);  mov(edx, 0x101c_81a8);                /* mov edx, 0x101c81a8 */
            ii(0x100f_2f58, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x100f_2f5c, 5);  call(0x100f_2a6f, -0x4f2);            /* call 0x100f2a6f */
            ii(0x100f_2f61, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x100f_2f76, 3);  cmp(eax, 1);                          /* cmp eax, 0x1 */
            ii(0x100f_2f79, 2);  if(jz(0x100f_2f8a, 0xf)) goto l_0x100f_2f8a;/* jz 0x100f2f8a */
            ii(0x100f_2f7b, 4);  movsx(edx, memw[ss, ebp - 4]);        /* movsx edx, word [ebp-0x4] */
        ...
        l_0x100f_2f8a:
            ii(0x100f_2f8a, 6);  lea(eax, memd[ss, ebp - 200]);        /* lea eax, [ebp-0xc8] */
            ii(0x100f_2f90, 5);  call(0x100f_2bf4, -0x3a1);            /* call 0x100f2bf4 */
        l_0x100f_2f95:
            ii(0x100f_2f95, 4);  or(memb[ss, ebp - 8], 1);             /* or byte [ebp-0x8], 0x1 */
            ii(0x100f_2f99, 6);  lea(eax, memd[ss, ebp - 204]);        /* lea eax, [ebp-0xcc] */
            ii(0x100f_2f9f, 5);  call(0x100e_0608, -0x1_299c);         /* call 0x100e0608 */
            ii(0x100f_2fa4, 6);  mov(memd[ss, ebp - 208], eax);        /* mov [ebp-0xd0], eax */
            ii(0x100f_2faa, 4);  and(memb[ss, ebp - 8], -2 /* 0xfe */);/* and byte [ebp-0x8], 0xfe */
            ii(0x100f_2fae, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_2fb1, 6);  mov(eax, memd[ds, eax + 250]);        /* mov eax, [eax+0xfa] */
            ii(0x100f_2fb7, 5);  call(0x1010_2c18, 0xfc5c);            /* call 0x10102c18 */
            ii(0x100f_2fbc, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x100f_2fbe, 6);  lea(eax, memd[ss, ebp - 204]);        /* lea eax, [ebp-0xcc] */
        ...
        l_0x100f_2fcb:
            ii(0x100f_2fcb, 6);  lea(eax, memd[ss, ebp - 204]);        /* lea eax, [ebp-0xcc] */
            ii(0x100f_2fd1, 5);  call(0x1007_6bf8, -0x7_c3de);         /* call 0x10076bf8 */
        l_0x100f_2fd6:
            ii(0x100f_2fd6, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100f_2fd8, 6);  lea(eax, memd[ss, ebp - 204]);        /* lea eax, [ebp-0xcc] */
        ...
        l_0x100f_3016:
            ii(0x100f_3016, 7);  mov(memb[ds, 0x101c_391e], 8);        /* mov byte [0x101c391e], 0x8 */
            ii(0x100f_301d, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100f_301f, 6);  lea(eax, memd[ss, ebp - 204]);        /* lea eax, [ebp-0xcc] */
