...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1017_2596:
            ...
            ii(0x1017_259b, 2);  if(jnz(0x1017_25a4, 7)) goto l_0x1017_25a4;/* jnz 0x101725a4 */
            ii(0x1017_259d, 2);  mov(eax, ebx);                        /* mov eax, ebx */
            ii(0x1017_259f, 5);  jmp(0x1017_2740, 0x19c); goto l_0x1017_2740;/* jmp 0x10172740 */
        l_0x1017_25a4:
            ii(0x1017_25a4, 4);  cmp(memd[ds, ecx + 8], 0);            /* cmp dword [ecx+0x8], 0x0 */
            ii(0x1017_25a8, 2);  if(jnz(0x1017_25b1, 7)) goto l_0x1017_25b1;/* jnz 0x101725b1 */
        ...
        l_0x1017_25b1:
            ...
            ii(0x1017_25b3, 3);  mov(dl, memb[ss, ebp + 12]);          /* mov dl, [ebp+0xc] */
            ii(0x1017_25b6, 4);  mov(memd[ss, esp + 8], esi);          /* mov [esp+0x8], esi */
            ii(0x1017_25ba, 3);  test(dl, 0x40);                       /* test dl, 0x40 */
            ii(0x1017_25bd, 6);  if(jz(0x1017_26c1, 0xfe)) goto l_0x1017_26c1;/* jz 0x101726c1 */
            ii(0x1017_25c3, 4);  mov(memd[ss, esp + 12], ebx);         /* mov [esp+0xc], ebx */
        l_0x1017_25c7:
            ii(0x1017_25c7, 3);  mov(edx, memd[ss, ebp + 4]);          /* mov edx, [ebp+0x4] */
            ii(0x1017_25ca, 2);  test(edx, edx);                       /* test edx, edx */
            ii(0x1017_25cc, 2);  if(jz(0x1017_2622, 0x54)) goto l_0x1017_2622;/* jz 0x10172622 */
            ii(0x1017_25ce, 4);  mov(ebx, memd[ss, esp + 12]);         /* mov ebx, [esp+0xc] */
            ii(0x1017_25d2, 2);  cmp(edx, ebx);                        /* cmp edx, ebx */
            ii(0x1017_25d4, 2);  if(jbe(0x1017_25d8, 2)) goto l_0x1017_25d8;/* jbe 0x101725d8 */
            ii(0x1017_25d6, 2);  mov(edx, ebx);                        /* mov edx, ebx */
        l_0x1017_25d8:
            ii(0x1017_25d8, 4);  mov(edi, memd[ss, esp + 4]);          /* mov edi, [esp+0x4] */
            ii(0x1017_25dc, 2);  mov(ecx, edx);                        /* mov ecx, edx */
            ii(0x1017_25de, 3);  mov(esi, memd[ss, ebp]);              /* mov esi, [ebp] */
            ii(0x1017_25e1, 4);  mov(ebx, memd[ss, esp + 8]);          /* mov ebx, [esp+0x8] */
            ...
            ii(0x1017_25ed, 3);  shr(ecx, 2);                          /* shr ecx, 0x2 */
            ii(0x1017_25f0, 2);  repne(() => movsd());                 /* repne movsd */
            ii(0x1017_25f2, 2);  mov(cl, al);                          /* mov cl, al */
            ii(0x1017_25f4, 3);  and(cl, 3);                           /* and cl, 0x3 */
            ii(0x1017_25f7, 2);  repne(() => movsb());                 /* repne movsb */
            ii(0x1017_25f9, 1);  pop(edi);                             /* pop edi */
            ii(0x1017_25fa, 1);  popd(es);                             /* pop es */
            ii(0x1017_25fb, 4);  mov(eax, memd[ss, esp + 12]);         /* mov eax, [esp+0xc] */
            ii(0x1017_25ff, 3);  mov(ecx, memd[ss, ebp]);              /* mov ecx, [ebp] */
            ii(0x1017_2602, 3);  lea(esi, memd[ds, edi + edx]);        /* lea esi, [edi+edx] */
            ii(0x1017_2605, 2);  add(ebx, edx);                        /* add ebx, edx */
            ii(0x1017_2607, 4);  mov(memd[ss, esp + 4], esi);          /* mov [esp+0x4], esi */
            ii(0x1017_260b, 4);  mov(memd[ss, esp + 8], ebx);          /* mov [esp+0x8], ebx */
            ii(0x1017_260f, 3);  mov(edi, memd[ss, ebp + 4]);          /* mov edi, [ebp+0x4] */
            ii(0x1017_2612, 2);  add(ecx, edx);                        /* add ecx, edx */
            ii(0x1017_2614, 2);  sub(eax, edx);                        /* sub eax, edx */
            ii(0x1017_2616, 2);  sub(edi, edx);                        /* sub edi, edx */
            ii(0x1017_2618, 3);  mov(memd[ss, ebp], ecx);              /* mov [ebp], ecx */
            ii(0x1017_261b, 4);  mov(memd[ss, esp + 12], eax);         /* mov [esp+0xc], eax */
            ii(0x1017_261f, 3);  mov(memd[ss, ebp + 4], edi);          /* mov [ebp+0x4], edi */
        l_0x1017_2622:
            ii(0x1017_2622, 4);  mov(ecx, memd[ss, esp + 12]);         /* mov ecx, [esp+0xc] */
            ii(0x1017_2626, 2);  test(ecx, ecx);                       /* test ecx, ecx */
            ii(0x1017_2628, 6);  if(jz(0x1017_2735, 0x107)) goto l_0x1017_2735;/* jz 0x10172735 */
            ii(0x1017_262e, 3);  cmp(ecx, memd[ss, ebp + 20]);         /* cmp ecx, [ebp+0x14] */
            ii(0x1017_2631, 2);  if(jae(0x1017_263d, 0xa)) goto l_0x1017_263d;/* jae 0x1017263d */
            ii(0x1017_2633, 4);  test(memb[ss, ebp + 13], 4);          /* test byte [ebp+0xd], 0x4 */
            ii(0x1017_2637, 6);  if(jz(0x1017_26ad, 0x70)) goto l_0x1017_26ad;/* jz 0x101726ad */
        l_0x1017_263d:
            ii(0x1017_263d, 7);  mov(memd[ss, ebp + 4], 0);            /* mov dword [ebp+0x4], 0x0 */
            ii(0x1017_2644, 4);  mov(ebx, memd[ss, esp + 12]);         /* mov ebx, [esp+0xc] */
            ii(0x1017_2648, 3);  mov(eax, memd[ss, ebp + 8]);          /* mov eax, [ebp+0x8] */
            ii(0x1017_264b, 3);  mov(cl, memb[ss, ebp + 13]);          /* mov cl, [ebp+0xd] */
            ii(0x1017_264e, 3);  mov(memd[ss, ebp], eax);              /* mov [ebp], eax */
            ii(0x1017_2651, 3);  test(cl, 4);                          /* test cl, 0x4 */
            ii(0x1017_2654, 2);  if(jnz(0x1017_2663, 0xd)) goto l_0x1017_2663;/* jnz 0x10172663 */
            ii(0x1017_2656, 6);  cmp(ebx, 0x200);                      /* cmp ebx, 0x200 */
            ii(0x1017_265c, 2);  if(jbe(0x1017_2663, 5)) goto l_0x1017_2663;/* jbe 0x10172663 */
            ii(0x1017_265e, 2);  xor(bl, bl);                          /* xor bl, bl */
            ii(0x1017_2660, 3);  and(bh, 0xfe);                        /* and bh, 0xfe */
        l_0x1017_2663:
            ii(0x1017_2663, 4);  mov(edx, memd[ss, esp + 4]);          /* mov edx, [esp+0x4] */
            ii(0x1017_2667, 3);  mov(eax, memd[ss, ebp + 16]);         /* mov eax, [ebp+0x10] */
            ii(0x1017_266a, 5);  call(/* sys */ 0x1018_d4b6, 0x1_ae47);/* call 0x1018d4b6 */
            ii(0x1017_266f, 3);  cmp(eax, -1 /* 0xff */);              /* cmp eax, 0xffffffff */
            ii(0x1017_2672, 2);  if(jnz(0x1017_267d, 9)) goto l_0x1017_267d;/* jnz 0x1017267d */
            ii(0x1017_2674, 4);  or(memb[ss, ebp + 12], 0x20);         /* or byte [ebp+0xc], 0x20 */
            ii(0x1017_2678, 5);  jmp(0x1017_2735, 0xb8); goto l_0x1017_2735;/* jmp 0x10172735 */
        l_0x1017_267d:
            ii(0x1017_267d, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x1017_267f, 2);  if(jnz(0x1017_268a, 9)) goto l_0x1017_268a;/* jnz 0x1017268a */
        l_0x1017_2681:
            ii(0x1017_2681, 4);  or(memb[ss, ebp + 12], 0x10);         /* or byte [ebp+0xc], 0x10 */
            ii(0x1017_2685, 5);  jmp(0x1017_2735, 0xab); goto l_0x1017_2735;/* jmp 0x10172735 */
        l_0x1017_268a:
            ii(0x1017_268a, 4);  mov(edx, memd[ss, esp + 4]);          /* mov edx, [esp+0x4] */
            ii(0x1017_268e, 4);  mov(ebx, memd[ss, esp + 12]);         /* mov ebx, [esp+0xc] */
            ii(0x1017_2692, 4);  mov(ecx, memd[ss, esp + 8]);          /* mov ecx, [esp+0x8] */
            ii(0x1017_2696, 2);  add(edx, eax);                        /* add edx, eax */
            ii(0x1017_2698, 2);  sub(ebx, eax);                        /* sub ebx, eax */
            ii(0x1017_269a, 2);  add(ecx, eax);                        /* add ecx, eax */
            ii(0x1017_269c, 4);  mov(memd[ss, esp + 4], edx);          /* mov [esp+0x4], edx */
            ii(0x1017_26a0, 4);  mov(memd[ss, esp + 12], ebx);         /* mov [esp+0xc], ebx */
            ii(0x1017_26a4, 4);  mov(memd[ss, esp + 8], ecx);          /* mov [esp+0x8], ecx */
        ...
        l_0x1017_26c1:
            ii(0x1017_26c1, 4);  mov(edx, memd[ss, esp + 4]);          /* mov edx, [esp+0x4] */
            ii(0x1017_26c5, 2);  add(ebx, edx);                        /* add ebx, edx */
        l_0x1017_26c7:
            ii(0x1017_26c7, 4);  cmp(memd[ss, ebp + 4], 0);            /* cmp dword [ebp+0x4], 0x0 */
        ...
        l_0x1017_26d8:
            ii(0x1017_26d8, 3);  mov(ecx, memd[ss, ebp + 4]);          /* mov ecx, [ebp+0x4] */
            ii(0x1017_26db, 3);  mov(eax, memd[ss, ebp]);              /* mov eax, [ebp] */
            ii(0x1017_26de, 1);  dec(ecx);                             /* dec ecx */
            ii(0x1017_26df, 3);  lea(esi, memd[ds, eax + 1]);          /* lea esi, [eax+0x1] */
            ii(0x1017_26e2, 3);  mov(memd[ss, ebp + 4], ecx);          /* mov [ebp+0x4], ecx */
            ii(0x1017_26e5, 3);  mov(memd[ss, ebp], esi);              /* mov [ebp], esi */
            ...
            ii(0x1017_26f4, 4);  cmp(memd[ss, ebp + 4], 0);            /* cmp dword [ebp+0x4], 0x0 */
        ...
        l_0x1017_2705:
            ii(0x1017_2705, 3);  mov(edi, memd[ss, ebp + 4]);          /* mov edi, [ebp+0x4] */
            ii(0x1017_2708, 3);  mov(eax, memd[ss, ebp]);              /* mov eax, [ebp] */
            ii(0x1017_270b, 1);  dec(edi);                             /* dec edi */
            ii(0x1017_270c, 3);  lea(esi, memd[ds, eax + 1]);          /* lea esi, [eax+0x1] */
            ii(0x1017_270f, 3);  mov(memd[ss, ebp + 4], edi);          /* mov [ebp+0x4], edi */
            ii(0x1017_2712, 3);  mov(memd[ss, ebp], esi);              /* mov [ebp], esi */
