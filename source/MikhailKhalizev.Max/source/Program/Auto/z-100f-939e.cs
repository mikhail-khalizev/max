...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100f_939e()
        {
            ...
            ii(0x100f_93b3, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x100f_93b6, 3);  mov(memd[ss, ebp - 12], edx);         /* mov [ebp-0xc], edx */
            ii(0x100f_93b9, 3);  mov(memd[ss, ebp - 8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x100f_93bc, 3);  mov(memd[ss, ebp - 4], ecx);          /* mov [ebp-0x4], ecx */
            ii(0x100f_93bf, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100f_93c2, 3);  cmp(eax, memd[ss, ebp - 12]);         /* cmp eax, [ebp-0xc] */
            ii(0x100f_93c5, 6);  if(jnz(0x100f_944f, 0x84)) goto l_0x100f_944f;/* jnz 0x100f944f */
            ii(0x100f_93cb, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100f_93ce, 5);  call(0x1014_b6bd, 0x5_22ea);          /* call 0x1014b6bd */
            ii(0x100f_93d3, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x100f_93e2, 2);  if(jz(0x100f_93ed, 9)) goto l_0x100f_93ed;/* jz 0x100f93ed */
        ...
        l_0x100f_93ed:
            ii(0x100f_93ed, 7);  cmp(memb[ds, 0x101c_391e], 9);        /* cmp byte [0x101c391e], 0x9 */
            ...
            ii(0x100f_93fd, 3);  cmp(eax, 1);                          /* cmp eax, 0x1 */
            ii(0x100f_9400, 2);  if(jnz(0x100f_940e, 0xc)) goto l_0x100f_940e;/* jnz 0x100f940e */
        l_0x100f_9402:
            ii(0x100f_9402, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
        ...
        l_0x100f_940e:
            ii(0x100f_940e, 4);  movsx(ebx, memw[ss, ebp - 4]);        /* movsx ebx, word [ebp-0x4] */
            ii(0x100f_9412, 4);  movsx(edx, memw[ss, ebp - 8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x100f_9416, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100f_9419, 5);  call(0x1007_284b, -0x8_6bd3);         /* call 0x1007284b */
            ii(0x100f_941e, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100f_9421, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100f_9424, 3);  cmp(eax, memd[ss, ebp - 12]);         /* cmp eax, [ebp-0xc] */
            ii(0x100f_9427, 2);  if(jz(0x100f_942f, 6)) goto l_0x100f_942f;/* jz 0x100f942f */
            ii(0x100f_9429, 4);  cmp(memd[ss, ebp - 12], 0);           /* cmp dword [ebp-0xc], 0x0 */
            ii(0x100f_942d, 2);  if(jnz(0x100f_9431, 2)) goto l_0x100f_9431;/* jnz 0x100f9431 */
        l_0x100f_942f:
            ii(0x100f_942f, 2);  jmp(0x100f_944d, 0x1c); goto l_0x100f_944d;/* jmp 0x100f944d */
        l_0x100f_9431:
            ii(0x100f_9431, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100f_9434, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ii(0x100f_9437, 2);  xor(ah, ah);                          /* xor ah, ah */
            ii(0x100f_9439, 3);  movsx(edx, ax);                       /* movsx edx, ax */
            ii(0x100f_943c, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x100f_944b, 2);  if(jnz(0x100f_944f, 2)) goto l_0x100f_944f;/* jnz 0x100f944f */
        l_0x100f_944d:
            ii(0x100f_944d, 2);  jmp(0x100f_945f, 0x10); goto l_0x100f_945f;/* jmp 0x100f945f */
        l_0x100f_944f:
            ii(0x100f_944f, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_9452, 5);  call(0x1014_b6bd, 0x5_2266);          /* call 0x1014b6bd */
            ii(0x100f_9457, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
