...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_4cb4()
        {
            ...
            ii(0x100e_4cc6, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ...
            ii(0x100e_4ce0, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_4ce3, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100e_4ce6, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100e_4ce9, 10);  mov(memd[ds, 0x101b_7f34], 1);       /* mov dword [0x101b7f34], 0x1 */
