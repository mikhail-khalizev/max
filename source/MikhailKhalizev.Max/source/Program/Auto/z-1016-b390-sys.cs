...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1016_b3b5:
            ...
            ii(0x1016_b3b7, 3);  mov(ebx, memd[ds, edx + 8]);          /* mov ebx, [edx+0x8] */
            ii(0x1016_b3ba, 3);  test(ah, 1);                          /* test ah, 0x1 */
            ...
            ii(0x1016_b3c8, 2);  jmp(0x1016_b3d0, 6); goto l_0x1016_b3d0;/* jmp 0x1016b3d0 */
        l_0x1016_b3ca:
            ii(0x1016_b3ca, 3);  call_abs(memd[ds, edx + 4]);          /* call dword [edx+0x4] */
            ii(0x1016_b3cd, 3);  lea(ecx, memd[ds, edx + 8]);          /* lea ecx, [edx+0x8] */
        l_0x1016_b3d0:
