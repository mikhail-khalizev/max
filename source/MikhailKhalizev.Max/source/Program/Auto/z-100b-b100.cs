...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_b100()
        {
            ...
            ii(0x100b_b118, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_b11b, 4);  mov(memb[ss, ebp - 8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x100b_b11f, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_b132, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x100b_b135, 7);  mov(memd[ss, ebp - 12], 1);           /* mov dword [ebp-0xc], 0x1 */
            ii(0x100b_b13c, 2);  jmp(0x100b_b144, 6); goto l_0x100b_b144;/* jmp 0x100bb144 */
        l_0x100b_b13e:
            ii(0x100b_b13e, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100b_b141, 3);  inc(memd[ss, ebp - 12]);              /* inc dword [ebp-0xc] */
        l_0x100b_b144:
            ii(0x100b_b144, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x100b_b148, 3);  cmp(eax, 6);                          /* cmp eax, 0x6 */
            ii(0x100b_b14b, 6);  if(jg(0x100b_b1eb, 0x9a)) goto l_0x100b_b1eb;/* jg 0x100bb1eb */
            ii(0x100b_b151, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_b154, 3);  movsx(eax, memw[ds, eax]);            /* movsx eax, word [eax] */
            ii(0x100b_b157, 6);  imul(edx, eax, 0x247);                /* imul edx, eax, 0x247 */
            ii(0x100b_b15d, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ...
            ii(0x100b_b16d, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x100b_b170, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x100b_b174, 3);  cmp(eax, 2);                          /* cmp eax, 0x2 */
            ii(0x100b_b177, 2);  if(jnz(0x100b_b187, 0xe)) goto l_0x100b_b187;/* jnz 0x100bb187 */
            ii(0x100b_b179, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100b_b17c, 2);  cwd();                                /* cwd */
            ii(0x100b_b17e, 3);  sub(ax, dx);                          /* sub ax, dx */
            ii(0x100b_b181, 3);  sar(ax, 1);                           /* sar ax, 1 */
            ii(0x100b_b184, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
        l_0x100b_b187:
            ii(0x100b_b187, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x100b_b18b, 3);  cmp(eax, 1);                          /* cmp eax, 0x1 */
            ii(0x100b_b18e, 2);  if(jnz(0x100b_b1c5, 0x35)) goto l_0x100b_b1c5;/* jnz 0x100bb1c5 */
            ii(0x100b_b190, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_b193, 3);  movsx(edx, memw[ds, eax]);            /* movsx edx, word [eax] */
            ii(0x100b_b196, 6);  imul(edx, edx, 0x247);                /* imul edx, edx, 0x247 */
            ii(0x100b_b19c, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x100b_b1a0, 3);  imul(eax, eax, 0xc);                  /* imul eax, eax, 0xc */
            ii(0x100b_b1a3, 2);  add(eax, edx);                        /* add eax, edx */
            ii(0x100b_b1a5, 5);  mov(ebx, 5);                          /* mov ebx, 0x5 */
            ...
            ii(0x100b_b1b4, 5);  mov(eax, 5);                          /* mov eax, 0x5 */
            ii(0x100b_b1b9, 2);  sub(eax, edx);                        /* sub eax, edx */
            ii(0x100b_b1bb, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ii(0x100b_b1bf, 3);  imul(eax, edx);                       /* imul eax, edx */
            ii(0x100b_b1c2, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
        l_0x100b_b1c5:
            ii(0x100b_b1c5, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x100b_b1c9, 3);  cmp(eax, 5);                          /* cmp eax, 0x5 */
            ii(0x100b_b1cc, 2);  if(jnz(0x100b_b1d1, 3)) goto l_0x100b_b1d1;/* jnz 0x100bb1d1 */
            ii(0x100b_b1ce, 3);  shl(memd[ss, ebp - 20], 1);           /* shl dword [ebp-0x14], 1 */
        l_0x100b_b1d1:
            ii(0x100b_b1d1, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100b_b1d4, 4);  cmp(ax, memw[ss, ebp - 16]);          /* cmp ax, [ebp-0x10] */
            ii(0x100b_b1d8, 2);  if(jge(0x100b_b1e6, 0xc)) goto l_0x100b_b1e6;/* jge 0x100bb1e6 */
            ii(0x100b_b1da, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
            ii(0x100b_b1dd, 3);  mov(memb[ss, ebp - 8], al);           /* mov [ebp-0x8], al */
            ii(0x100b_b1e0, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100b_b1e3, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
        l_0x100b_b1e6:
        ...
        l_0x100b_b1eb:
            ...
            ii(0x100b_b1f5, 3);  lea(ebx, memd[ss, ebp - 24]);         /* lea ebx, [ebp-0x18] */
            ...
            ii(0x100b_b201, 2);  jmp(0x100b_b20b, 8); goto l_0x100b_b20b;/* jmp 0x100bb20b */
        l_0x100b_b203:
            ii(0x100b_b203, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x100b_b206, 5);  call(0x1007_6bf8, -0x4_4613);         /* call 0x10076bf8 */
        l_0x100b_b20b:
            ii(0x100b_b20b, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_b20d, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ...
            ii(0x100b_b21d, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x100b_b220, 5);  call(0x1007_63a0, -0x4_4e85);         /* call 0x100763a0 */
            ii(0x100b_b225, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_b227, 3);  mov(dl, memb[ds, eax + 38]);          /* mov dl, [eax+0x26] */
            ii(0x100b_b22a, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_b234, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x100b_b237, 5);  call(0x1007_63a0, -0x4_4e9c);         /* call 0x100763a0 */
            ii(0x100b_b23c, 5);  cmp(memw[ds, eax + 8], 0x1d);         /* cmp word [eax+0x8], 0x1d */
            ii(0x100b_b241, 2);  if(jz(0x100b_b245, 2)) goto l_0x100b_b245;/* jz 0x100bb245 */
        l_0x100b_b243:
            ii(0x100b_b243, 2);  jmp(0x100b_b253, 0xe); goto l_0x100b_b253;/* jmp 0x100bb253 */
        l_0x100b_b245:
            ii(0x100b_b245, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x100b_b248, 5);  call(0x1007_63a0, -0x4_4ead);         /* call 0x100763a0 */
            ii(0x100b_b24d, 4);  cmp(memb[ds, eax + 61], 7);           /* cmp byte [eax+0x3d], 0x7 */
            ii(0x100b_b251, 2);  if(jz(0x100b_b255, 2)) goto l_0x100b_b255;/* jz 0x100bb255 */
        l_0x100b_b253:
            ii(0x100b_b253, 2);  jmp(0x100b_b263, 0xe); goto l_0x100b_b263;/* jmp 0x100bb263 */
        l_0x100b_b255:
            ii(0x100b_b255, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x100b_b258, 5);  call(0x1007_63a0, -0x4_4ebd);         /* call 0x100763a0 */
            ii(0x100b_b25d, 4);  cmp(memb[ds, eax + 62], 0);           /* cmp byte [eax+0x3e], 0x0 */
            ii(0x100b_b261, 2);  if(jnz(0x100b_b265, 2)) goto l_0x100b_b265;/* jnz 0x100bb265 */
        l_0x100b_b263:
            ii(0x100b_b263, 2);  jmp(0x100b_b275, 0x10); goto l_0x100b_b275;/* jmp 0x100bb275 */
        l_0x100b_b265:
            ii(0x100b_b265, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x100b_b268, 5);  call(0x1007_63a0, -0x4_4ecd);         /* call 0x100763a0 */
            ii(0x100b_b26d, 3);  mov(al, memb[ds, eax + 93]);          /* mov al, [eax+0x5d] */
            ii(0x100b_b270, 3);  cmp(al, memb[ss, ebp - 8]);           /* cmp al, [ebp-0x8] */
            ii(0x100b_b273, 2);  if(jnz(0x100b_b277, 2)) goto l_0x100b_b277;/* jnz 0x100bb277 */
        l_0x100b_b275:
        ...
        l_0x100b_b277:
            ...
            ii(0x100b_b27c, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x100b_b27f, 5);  call(0x1007_63a0, -0x4_4ee4);         /* call 0x100763a0 */
            ii(0x100b_b284, 3);  mov(edx, memd[ds, eax + 90]);         /* mov edx, [eax+0x5a] */
            ii(0x100b_b287, 3);  sar(edx, 0x18);                       /* sar edx, 0x18 */
            ii(0x100b_b28a, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_b28d, 3);  movsx(eax, memw[ds, eax]);            /* movsx eax, word [eax] */
            ii(0x100b_b290, 5);  call(0x1013_322d, 0x7_7f98);          /* call 0x1013322d */
            ii(0x100b_b295, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x100b_b298, 5);  call(0x1007_63a0, -0x4_4efd);         /* call 0x100763a0 */
            ii(0x100b_b29d, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x100b_b29f, 3);  mov(al, memb[ss, ebp - 8]);           /* mov al, [ebp-0x8] */
            ii(0x100b_b2a2, 3);  mov(memb[ds, edx + 93], al);          /* mov [edx+0x5d], al */
            ii(0x100b_b2a5, 5);  mov(ebx, 1);                          /* mov ebx, 0x1 */
            ii(0x100b_b2aa, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
            ii(0x100b_b2ad, 5);  call(0x1007_63a0, -0x4_4f12);         /* call 0x100763a0 */
            ii(0x100b_b2b2, 3);  mov(edx, memd[ds, eax + 90]);         /* mov edx, [eax+0x5a] */
            ii(0x100b_b2b5, 3);  sar(edx, 0x18);                       /* sar edx, 0x18 */
            ii(0x100b_b2b8, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100b_b2c8:
            ...
            ii(0x100b_b2d1, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100b_b2dc:
            ...
            ii(0x100b_b2de, 3);  lea(eax, memd[ss, ebp - 24]);         /* lea eax, [ebp-0x18] */
