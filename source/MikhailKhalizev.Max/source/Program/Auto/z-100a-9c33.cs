...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_9c33()
        {
            ...
            ii(0x100a_9c45, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x100a_9c4b, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_9c4e, 5);  call(0x100a_8ae1, -0x1172);           /* call 0x100a8ae1 */
            ii(0x100a_9c53, 7);  mov(memd[ss, ebp - 8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x100a_9c5a, 2);  jmp(0x100a_9c62, 6); goto l_0x100a_9c62;/* jmp 0x100a9c62 */
        l_0x100a_9c5c:
            ii(0x100a_9c5c, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100a_9c5f, 3);  inc(memd[ss, ebp - 8]);               /* inc dword [ebp-0x8] */
        l_0x100a_9c62:
            ii(0x100a_9c62, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100a_9c66, 3);  cmp(eax, 4);                          /* cmp eax, 0x4 */
            ii(0x100a_9c69, 2);  if(jge(0x100a_9ca0, 0x35)) goto l_0x100a_9ca0;/* jge 0x100a9ca0 */
            ii(0x100a_9c6b, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ...
            ii(0x100a_9c80, 3);  cmp(eax, 2);                          /* cmp eax, 0x2 */
            ii(0x100a_9c83, 2);  if(jnz(0x100a_9c9e, 0x19)) goto l_0x100a_9c9e;/* jnz 0x100a9c9e */
            ii(0x100a_9c85, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x100a_9c88, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
