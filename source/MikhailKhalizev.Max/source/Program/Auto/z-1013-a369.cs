...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_a369()
        {
            ...
            ii(0x1013_a380, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1013_a383, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1013_a386, 5);  mov(eax, 0x12);                       /* mov eax, 0x12 */
            ii(0x1013_a38b, 5);  call(Definitions.sys_new, 0x2_ba70);  /* call 0x10165e00 */
            ii(0x1013_a390, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1013_a393, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1013_a396, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1013_a399, 4);  cmp(memd[ss, ebp - 20], 0);           /* cmp dword [ebp-0x14], 0x0 */
            ii(0x1013_a39d, 2);  if(jz(0x1013_a3b5, 0x16)) goto l_0x1013_a3b5;/* jz 0x1013a3b5 */
            ii(0x1013_a39f, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1013_a3a2, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1013_a3a5, 5);  call(0x1013_9eb4, -0x4f6);            /* call 0x10139eb4 */
            ii(0x1013_a3aa, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1013_a3ad, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x1013_a3b0, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1013_a3b3, 2);  jmp(0x1013_a3bb, 6); goto l_0x1013_a3bb;/* jmp 0x1013a3bb */
        l_0x1013_a3b5:
            ii(0x1013_a3b5, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1013_a3b8, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
        l_0x1013_a3bb:
            ii(0x1013_a3bb, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x1013_a3be, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1013_a3c1, 5);  call(0x1007_6d14, -0xc_36b2);         /* call 0x10076d14 */
            ii(0x1013_a3c6, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_a3c9, 3);  inc(memw[ds, eax]);                   /* inc word [eax] */
            ii(0x1013_a3cc, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1013_a3ce, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_a3d1, 3);  add(eax, 2);                          /* add eax, 0x2 */
            ...
            ii(0x1013_a3dd, 3);  lea(edx, memd[ss, ebp - 28]);         /* lea edx, [ebp-0x1c] */
            ii(0x1013_a3e0, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_a3e3, 3);  add(eax, 6);                          /* add eax, 0x6 */
        ...
        l_0x1013_a3ed:
            ii(0x1013_a3ed, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1013_a3f0, 5);  call(0x1007_6c68, -0xc_378d);         /* call 0x10076c68 */
            ii(0x1013_a3f5, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1013_a3f7, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_a3fa, 3);  add(eax, 2);                          /* add eax, 0x2 */
            ii(0x1013_a3fd, 5);  call(0x1013_aa3c, 0x63a);             /* call 0x1013aa3c */
            ii(0x1013_a402, 5);  call(0x1013_9fbe, -0x449);            /* call 0x10139fbe */
        l_0x1013_a407:
            ii(0x1013_a407, 3);  lea(edx, memd[ss, ebp - 28]);         /* lea edx, [ebp-0x1c] */
            ii(0x1013_a40a, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1013_a40d, 3);  add(eax, 2);                          /* add eax, 0x2 */
            ii(0x1013_a410, 5);  call(0x1013_aa70, 0x65b);             /* call 0x1013aa70 */
            ii(0x1013_a415, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1013_a417, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
