...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_2e41()
        {
            ...
            ii(0x100c_2e61, 4);  cmp(memd[ds, eax + 103], 0);          /* cmp dword [eax+0x67], 0x0 */
            ...
            ii(0x100c_2e6e, 3);  mov(ebx, memd[ds, ebx + 26]);         /* mov ebx, [ebx+0x1a] */
            ii(0x100c_2e71, 3);  sar(ebx, 0x10);                       /* sar ebx, 0x10 */
            ii(0x100c_2e74, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_2e77, 3);  mov(edx, memd[ds, eax + 24]);         /* mov edx, [eax+0x18] */
            ii(0x100c_2e7a, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x100c_2e7d, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x100c_2e8d, 4);  mov(ax, memw[ds, eax + 14]);          /* mov ax, [eax+0xe] */
            ii(0x100c_2e91, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100c_2e94, 5);  mov(eax, 7);                          /* mov eax, 0x7 */
            ii(0x100c_2e99, 1);  push(eax);                            /* push eax */
            ii(0x100c_2e9a, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x100c_2e9e, 1);  push(eax);                            /* push eax */
            ii(0x100c_2e9f, 5);  mov(ecx, 2);                          /* mov ecx, 0x2 */
            ii(0x100c_2ea4, 3);  mov(eax, memd[ss, ebp - 14]);         /* mov eax, [ebp-0xe] */
            ii(0x100c_2ea7, 1);  inc(eax);                             /* inc eax */
            ii(0x100c_2ea8, 3);  movsx(ebx, ax);                       /* movsx ebx, ax */
            ii(0x100c_2eab, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x100c_2ec0, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x100c_2ec4, 1);  push(eax);                            /* push eax */
            ii(0x100c_2ec5, 5);  mov(ecx, 4);                          /* mov ecx, 0x4 */
            ii(0x100c_2eca, 3);  mov(eax, memd[ss, ebp - 14]);         /* mov eax, [ebp-0xe] */
            ii(0x100c_2ecd, 5);  add(eax, 2);                          /* add eax, 0x2 */
            ii(0x100c_2ed2, 3);  movsx(ebx, ax);                       /* movsx ebx, ax */
            ii(0x100c_2ed5, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x100c_2eec, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x100c_2ef0, 1);  push(eax);                            /* push eax */
            ii(0x100c_2ef1, 5);  mov(ecx, 6);                          /* mov ecx, 0x6 */
            ii(0x100c_2ef6, 3);  mov(eax, memd[ss, ebp - 14]);         /* mov eax, [ebp-0xe] */
            ii(0x100c_2ef9, 5);  add(eax, 3);                          /* add eax, 0x3 */
            ii(0x100c_2efe, 3);  movsx(ebx, ax);                       /* movsx ebx, ax */
            ii(0x100c_2f01, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x100c_2f18, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x100c_2f1c, 1);  push(eax);                            /* push eax */
            ii(0x100c_2f1d, 5);  mov(ecx, 8);                          /* mov ecx, 0x8 */
            ii(0x100c_2f22, 3);  mov(eax, memd[ss, ebp - 14]);         /* mov eax, [ebp-0xe] */
            ii(0x100c_2f25, 5);  add(eax, 4);                          /* add eax, 0x4 */
            ii(0x100c_2f2a, 3);  movsx(ebx, ax);                       /* movsx ebx, ax */
            ii(0x100c_2f2d, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x100c_2f59, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x100c_2f5c, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100c_2f5f, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x100c_2f62, 4);  cmp(memd[ss, ebp - 24], 0);           /* cmp dword [ebp-0x18], 0x0 */
            ii(0x100c_2f66, 2);  if(jz(0x100c_2f8e, 0x26)) goto l_0x100c_2f8e;/* jz 0x100c2f8e */
            ii(0x100c_2f68, 3);  lea(edx, memd[ss, ebp - 16]);         /* lea edx, [ebp-0x10] */
            ii(0x100c_2f6b, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ...
            ii(0x100c_2f7b, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100c_2f7e, 5);  call(0x1009_ef13, -0x2_4070);         /* call 0x1009ef13 */
            ii(0x100c_2f83, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x100c_2f86, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
            ii(0x100c_2f89, 3);  mov(memd[ss, ebp - 36], eax);         /* mov [ebp-0x24], eax */
            ii(0x100c_2f8c, 2);  jmp(0x100c_2f94, 6); goto l_0x100c_2f94;/* jmp 0x100c2f94 */
        l_0x100c_2f8e:
            ii(0x100c_2f8e, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x100c_2f91, 3);  mov(memd[ss, ebp - 36], eax);         /* mov [ebp-0x24], eax */
        l_0x100c_2f94:
            ii(0x100c_2f94, 3);  mov(edx, memd[ss, ebp - 36]);         /* mov edx, [ebp-0x24] */
