...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_a7b8()
        {
            ...
            ii(0x100c_a7cf, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_a7d2, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100c_a7d5, 7);  test(memd[ss, ebp - 4], 4);           /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x100c_a7e3, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100c_a7f2:
            ii(0x100c_a7f2, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x100c_a7f7, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_a7fa, 5);  call(0x100a_284c, -0x2_7fb3);         /* call 0x100a284c */
            ii(0x100c_a7ff, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_a802, 7);  test(memd[ss, ebp - 4], 2);           /* test dword [ebp-0x4], 0x2 */
            ii(0x100c_a809, 2);  if(jz(0x100c_a813, 8)) goto l_0x100c_a813;/* jz 0x100ca813 */
            ii(0x100c_a80b, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_a80e, 5);  call(Definitions.sys_delete, 0x9_b751);/* call 0x10165f64 */
        l_0x100c_a813:
            ii(0x100c_a813, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100c_a816, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100c_a819, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
