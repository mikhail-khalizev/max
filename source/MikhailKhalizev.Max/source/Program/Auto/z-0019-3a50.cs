...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_3a50()
        {
            ...
            ii(0x19_3a6b, 3);  mov(memw[ss, bp - 2], cx);              /* mov [bp-0x2], cx */
            ii(0x19_3a6e, 3);  les(di, memw[ss, bp + 6]);              /* les di, [bp+0x6] */
        ...
        l_0x19_3a86:
            ...
            ii(0x19_3a96, 3);  mov(cx, memw[ss, bp - 2]);              /* mov cx, [bp-0x2] */
            ii(0x19_3a99, 2);  if(jcxz(0x19_3a9f, 4)) goto l_0x19_3a9f;/* jcxz 0x3a9f */
            ii(0x19_3a9b, 2);  repe(() => cmpsb());                    /* repe cmpsb */
            ii(0x19_3a9d, 2);  if(jnz(0x19_3a86, -0x19)) goto l_0x19_3a86;/* jnz 0x3a86 */
        l_0x19_3a9f:
            ii(0x19_3a9f, 3);  lea(ax, memw[ds, bx - 1]);              /* lea ax, [bx-0x1] */
            ii(0x19_3aa2, 2);  mov(dx, es);                            /* mov dx, es */
            ii(0x19_3aa4, 2);  jmp(0x19_3ab0, 0xa); goto l_0x19_3ab0;  /* jmp 0x3ab0 */
        l_0x19_3aa6:
            ii(0x19_3aa6, 3);  les(ax, memw[ss, bp + 6]);              /* les ax, [bp+0x6] */
            ii(0x19_3aa9, 2);  mov(dx, es);                            /* mov dx, es */
            ii(0x19_3aab, 2);  jmp(0x19_3ab0, 3); goto l_0x19_3ab0;    /* jmp 0x3ab0 */
        l_0x19_3aad:
