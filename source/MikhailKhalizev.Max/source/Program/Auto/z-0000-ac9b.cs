...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_ac9b()
        {
            ...
            ii(0xaca6, 3);  mov(cx, memw[ds, si + 2]);                 /* mov cx, [si+0x2] */
            ...
            ii(0xacb6, 2);  if(jnz(0xacbf, 7)) goto l_0xacbf;          /* jnz 0xacbf */
            ii(0xacb8, 4);  mov(memw[ds, si], 0x7750);                 /* mov word [si], 0x7750 */
            ii(0xacbc, 3);  mov(memw[ds, si + 2], cs);                 /* mov [si+0x2], cs */
        l_0xacbf:
            ii(0xacbf, 2);  @int(0x67);                                /* int 0x67 */
            ii(0xacc1, 3);  pop(memw[ds, si + 2]);                     /* pop word [si+0x2] */
