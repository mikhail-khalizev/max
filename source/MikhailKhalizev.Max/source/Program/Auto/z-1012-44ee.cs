...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1012_44ee()
        {
            ...
            ii(0x1012_4504, 3);  mov(eax, memd[ss, ebp + 24]);         /* mov eax, [ebp+0x18] */
            ii(0x1012_4507, 1);  push(eax);                            /* push eax */
            ii(0x1012_4508, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ...
            ii(0x1012_4518, 3);  mov(eax, memd[ss, ebp + 28]);         /* mov eax, [ebp+0x1c] */
            ii(0x1012_451b, 1);  push(eax);                            /* push eax */
            ii(0x1012_451c, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ...
            ii(0x1012_4528, 7);  mov(memd[ss, ebp - 12], 1);           /* mov dword [ebp-0xc], 0x1 */
            ii(0x1012_452f, 5);  jmp(0x1012_4627, 0xf3); goto l_0x1012_4627;/* jmp 0x10124627 */
        l_0x1012_4534:
            ii(0x1012_4534, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ii(0x1012_4537, 6);  mov(eax, memd[ds, eax + 144]);        /* mov eax, [eax+0x90] */
            ii(0x1012_453d, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1012_4540, 3);  mov(eax, memd[ss, ebp + 28]);         /* mov eax, [ebp+0x1c] */
            ii(0x1012_4543, 5);  call(Definitions.sys_strlen, 0x4_d97f);/* call 0x10171ec7 */
            ii(0x1012_4548, 3);  mov(edx, memd[ss, ebp + 32]);         /* mov edx, [ebp+0x20] */
            ...
            ii(0x1012_4553, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ii(0x1012_4556, 6);  mov(edx, memd[ds, eax + 136]);        /* mov edx, [eax+0x88] */
            ii(0x1012_455c, 3);  add(edx, memd[ss, ebp - 4]);          /* add edx, [ebp-0x4] */
            ii(0x1012_455f, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ii(0x1012_4562, 6);  cmp(edx, memd[ds, eax + 140]);        /* cmp edx, [eax+0x8c] */
            ii(0x1012_4568, 2);  if(jbe(0x1012_4576, 0xc)) goto l_0x1012_4576;/* jbe 0x10124576 */
            ii(0x1012_456a, 7);  mov(memd[ss, ebp - 12], 0);           /* mov dword [ebp-0xc], 0x0 */
            ii(0x1012_4571, 5);  jmp(0x1012_4627, 0xb1); goto l_0x1012_4627;/* jmp 0x10124627 */
        l_0x1012_4576:
            ii(0x1012_4576, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ii(0x1012_4579, 6);  mov(edx, memd[ds, eax + 132]);        /* mov edx, [eax+0x84] */
            ii(0x1012_457f, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ii(0x1012_4582, 6);  add(edx, memd[ds, eax + 136]);        /* add edx, [eax+0x88] */
        ...
        l_0x1012_459b:
            ii(0x1012_459b, 3);  mov(eax, memd[ss, ebp + 24]);         /* mov eax, [ebp+0x18] */
            ...
            ii(0x1012_45a3, 3);  mov(edx, memd[ss, ebp + 24]);         /* mov edx, [ebp+0x18] */
            ii(0x1012_45a6, 3);  inc(memd[ss, ebp + 24]);              /* inc dword [ebp+0x18] */
            ...
            ii(0x1012_45b3, 3);  mov(eax, memd[ss, ebp + 32]);         /* mov eax, [ebp+0x20] */
            ii(0x1012_45b6, 3);  dec(memd[ss, ebp + 32]);              /* dec dword [ebp+0x20] */
            ii(0x1012_45b9, 2);  jmp(0x1012_459b, -0x20); goto l_0x1012_459b;/* jmp 0x1012459b */
        l_0x1012_45bb:
            ii(0x1012_45bb, 3);  dec(memd[ss, ebp + 32]);              /* dec dword [ebp+0x20] */
            ii(0x1012_45be, 4);  cmp(memd[ss, ebp + 32], -1 /* 0xff */);/* cmp dword [ebp+0x20], 0xffffffff */
        ...
        l_0x1012_45e1:
            ii(0x1012_45e1, 3);  mov(eax, memd[ss, ebp + 28]);         /* mov eax, [ebp+0x1c] */
            ...
            ii(0x1012_45e9, 3);  mov(eax, memd[ss, ebp + 28]);         /* mov eax, [ebp+0x1c] */
            ii(0x1012_45ec, 3);  inc(memd[ss, ebp + 28]);              /* inc dword [ebp+0x1c] */
        ...
        l_0x1012_45fb:
            ...
            ii(0x1012_4610, 3);  mov(edx, memd[ss, ebp + 20]);         /* mov edx, [ebp+0x14] */
            ii(0x1012_4613, 6);  add(memd[ds, edx + 136], eax);        /* add [edx+0x88], eax */
            ii(0x1012_4619, 3);  mov(eax, memd[ss, ebp + 20]);         /* mov eax, [ebp+0x14] */
            ii(0x1012_461c, 4);  or(memb[ds, eax + 1], -0x80 /* 0x80 */);/* or byte [eax+0x1], 0x80 */
            ii(0x1012_4620, 7);  mov(memd[ss, ebp - 12], 1);           /* mov dword [ebp-0xc], 0x1 */
        l_0x1012_4627:
            ii(0x1012_4627, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
