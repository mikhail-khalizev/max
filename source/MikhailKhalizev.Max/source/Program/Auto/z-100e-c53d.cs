...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_c53d()
        {
            ...
            ii(0x100e_c555, 3);  mov(memd[ss, ebp - 12], edx);         /* mov [ebp-0xc], edx */
            ii(0x100e_c558, 3);  mov(memd[ss, ebp - 16], ebx);         /* mov [ebp-0x10], ebx */
            ...
            ii(0x100e_c56a, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x100e_c56d, 5);  call(0x1007_64b8, -0x7_60ba);         /* call 0x100764b8 */
            ii(0x100e_c572, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100e_c575, 5);  mov(memw[ds, eax], 0);                /* mov word [eax], 0x0 */
            ii(0x100e_c57a, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
        ...
        l_0x100e_c58c:
            ii(0x100e_c58c, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x100e_c58f, 5);  call(0x1007_6bf8, -0x7_599c);         /* call 0x10076bf8 */
        l_0x100e_c594:
            ii(0x100e_c594, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100e_c596, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x100e_c5a6, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x100e_c5a9, 5);  call(0x1007_63a0, -0x7_620e);         /* call 0x100763a0 */
            ii(0x100e_c5ae, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100e_c5b0, 3);  mov(dl, memb[ds, eax + 38]);          /* mov dl, [eax+0x26] */
            ...
            ii(0x100e_c5bb, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x100e_c5cc:
            ii(0x100e_c5cc, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x100e_c5cf, 5);  call(0x1007_63a0, -0x7_6234);         /* call 0x100763a0 */
            ii(0x100e_c5d4, 4);  cmp(memb[ds, eax + 61], 7);           /* cmp byte [eax+0x3d], 0x7 */
        ...
        l_0x100e_c5dc:
            ii(0x100e_c5dc, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x100e_c5df, 5);  call(0x1007_63a0, -0x7_6244);         /* call 0x100763a0 */
            ii(0x100e_c5e4, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100e_c5e6, 3);  mov(dl, memb[ds, eax + 74]);          /* mov dl, [eax+0x4a] */
            ii(0x100e_c5e9, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100e_c5ec, 3);  add(memw[ds, eax], dx);               /* add [eax], dx */
            ii(0x100e_c5ef, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x100e_c5f2, 5);  call(0x1007_63a0, -0x7_6257);         /* call 0x100763a0 */
            ii(0x100e_c5f7, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100e_c5f9, 3);  mov(dl, memb[ds, eax + 76]);          /* mov dl, [eax+0x4c] */
            ii(0x100e_c5fc, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100e_c5ff, 3);  add(memw[ds, eax], dx);               /* add [eax], dx */
            ii(0x100e_c602, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x100e_c605, 5);  call(0x1007_63a0, -0x7_626a);         /* call 0x100763a0 */
            ii(0x100e_c60a, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100e_c60c, 3);  mov(dl, memb[ds, eax + 75]);          /* mov dl, [eax+0x4b] */
        ...
        l_0x100e_c61a:
            ...
            ii(0x100e_c61c, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
