...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_f824()
        {
            ...
            ii(0x100c_f83a, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ...
            ii(0x100c_f846, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x100c_f849, 3);  mov(memd[ds, edx + 45], eax);         /* mov [edx+0x2d], eax */
            ii(0x100c_f84c, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_f84f, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x100c_f852, 3);  mov(memd[ds, edx + 32], eax);         /* mov [edx+0x20], eax */
