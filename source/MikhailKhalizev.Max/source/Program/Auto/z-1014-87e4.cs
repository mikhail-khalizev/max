...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_87e4()
        {
            ...
            ii(0x1014_87fb, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_87fe, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_8801, 7);  test(memd[ss, ebp - 4], 4);           /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x1014_880f, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1014_881e:
            ii(0x1014_881e, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x1014_8823, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_8826, 5);  call(0x1014_8750, -0xdb);             /* call 0x10148750 */
            ii(0x1014_882b, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_882e, 7);  test(memd[ss, ebp - 4], 2);           /* test dword [ebp-0x4], 0x2 */
            ii(0x1014_8835, 2);  if(jz(0x1014_883f, 8)) goto l_0x1014_883f;/* jz 0x1014883f */
            ii(0x1014_8837, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_883a, 5);  call(Definitions.sys_delete, 0x1_d725);/* call 0x10165f64 */
        l_0x1014_883f:
            ii(0x1014_883f, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1014_8842, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1014_8845, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
