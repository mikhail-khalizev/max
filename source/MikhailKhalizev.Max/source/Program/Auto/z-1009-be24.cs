...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_be24()
        {
            ...
            ii(0x1009_be3b, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_be3e, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1009_be41, 7);  test(memd[ss, ebp - 4], 4);           /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x1009_be4f, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x1009_be5e:
            ...
            ii(0x1009_be60, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1009_be6e, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_be71, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x1009_be76, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_be79, 5);  call(0x100a_284c, 0x69ce);            /* call 0x100a284c */
            ii(0x1009_be7e, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1009_be81, 7);  test(memd[ss, ebp - 4], 2);           /* test dword [ebp-0x4], 0x2 */
            ii(0x1009_be88, 2);  if(jz(0x1009_be92, 8)) goto l_0x1009_be92;/* jz 0x1009be92 */
            ii(0x1009_be8a, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_be8d, 5);  call(Definitions.sys_delete, 0xc_a0d2);/* call 0x10165f64 */
        l_0x1009_be92:
            ii(0x1009_be92, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1009_be95, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1009_be98, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
