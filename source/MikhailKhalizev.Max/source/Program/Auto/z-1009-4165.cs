...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_4165()
        {
            ...
            ii(0x1009_417a, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1009_417d, 3);  mov(memd[ss, ebp - 12], edx);         /* mov [ebp-0xc], edx */
            ...
            ii(0x1009_4193, 4);  mov(memb[ss, ebp - 20], 0);           /* mov byte [ebp-0x14], 0x0 */
        ...
        l_0x1009_4199:
            ...
            ii(0x1009_41a1, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1009_41a4, 5);  call(0x1009_3e27, -0x382);            /* call 0x10093e27 */
            ii(0x1009_41a9, 2);  xor(ah, ah);                          /* xor ah, ah */
            ii(0x1009_41ab, 3);  sub(memd[ss, ebp - 12], eax);         /* sub [ebp-0xc], eax */
            ii(0x1009_41ae, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x1009_41b2, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x1009_41b4, 2);  if(jg(0x1009_41bc, 6)) goto l_0x1009_41bc;/* jg 0x100941bc */
            ii(0x1009_41b6, 4);  mov(memb[ss, ebp - 20], 0);           /* mov byte [ebp-0x14], 0x0 */
            ii(0x1009_41ba, 2);  jmp(0x1009_41e9, 0x2d); goto l_0x1009_41e9;/* jmp 0x100941e9 */
        l_0x1009_41bc:
            ii(0x1009_41bc, 3);  dec(memd[ss, ebp - 12]);              /* dec dword [ebp-0xc] */
            ii(0x1009_41bf, 5);  cmp(memw[ss, ebp - 12], -1 /* 0xff */);/* cmp word [ebp-0xc], 0xffff */
            ...
            ii(0x1009_41ca, 3);  mov(ebx, memd[ss, ebp - 16]);         /* mov ebx, [ebp-0x10] */
            ii(0x1009_41cd, 4);  movsx(edx, memw[ss, ebp - 8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1009_41d1, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x1009_41dd, 4);  mov(memb[ss, ebp - 20], 1);           /* mov byte [ebp-0x14], 0x1 */
        ...
        l_0x1009_41e5:
            ii(0x1009_41e5, 4);  mov(memb[ss, ebp - 20], 0);           /* mov byte [ebp-0x14], 0x0 */
        l_0x1009_41e9:
            ii(0x1009_41e9, 3);  mov(al, memb[ss, ebp - 20]);          /* mov al, [ebp-0x14] */
