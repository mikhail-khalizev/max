...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_0b54()
        {
            ...
            ii(0x100b_0b6b, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_0b6e, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100b_0b71, 5);  mov(edx, StringDefinitions.TransportUnits);/* mov edx, 0x101a0f5b */
            ii(0x100b_0b76, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_0b79, 5);  call(Definitions.sys_strcpy, 0xb_5351);/* call 0x10165ecf */
            ii(0x100b_0b7e, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_0b80, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_0b91, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_0b9e, 2);  if(jnz(0x100b_0ba2, 2)) goto l_0x100b_0ba2;/* jnz 0x100b0ba2 */
        l_0x100b_0ba0:
            ii(0x100b_0ba0, 2);  jmp(0x100b_0bcb, 0x29); goto l_0x100b_0bcb;/* jmp 0x100b0bcb */
        l_0x100b_0ba2:
            ii(0x100b_0ba2, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_0ba5, 3);  mov(eax, memd[ds, eax + 17]);         /* mov eax, [eax+0x11] */
            ...
            ii(0x100b_0bba, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100b_0bcb:
            ...
            ii(0x100b_0bcd, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_0bdc, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100b_0bf0:
            ...
            ii(0x100b_0bf5, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100b_0c02:
            ii(0x100b_0c02, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_0c12, 4);  cmp(memb[ds, eax + 61], 0x10);        /* cmp byte [eax+0x3d], 0x10 */
            ii(0x100b_0c16, 2);  if(jz(0x100b_0c7b, 0x63)) goto l_0x100b_0c7b;/* jz 0x100b0c7b */
            ii(0x100b_0c18, 3);  lea(edx, memd[ss, ebp - 52]);         /* lea edx, [ebp-0x34] */
            ii(0x100b_0c1b, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_0c30, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_0c40, 3);  mov(eax, memd[ds, eax + 26]);         /* mov eax, [eax+0x1a] */
            ii(0x100b_0c43, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x100b_0c46, 1);  inc(eax);                             /* inc eax */
            ii(0x100b_0c47, 1);  push(eax);                            /* push eax */
            ii(0x100b_0c48, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_0c58, 3);  mov(eax, memd[ds, eax + 24]);         /* mov eax, [eax+0x18] */
            ii(0x100b_0c5b, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x100b_0c5e, 1);  inc(eax);                             /* inc eax */
            ii(0x100b_0c5f, 1);  push(eax);                            /* push eax */
            ii(0x100b_0c60, 3);  lea(eax, memd[ss, ebp - 52]);         /* lea eax, [ebp-0x34] */
            ...
            ii(0x100b_0c6a, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100b_0c7b:
            ...
            ii(0x100b_0c7d, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_0c8c, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_0c8f, 3);  add(eax, 0x15);                       /* add eax, 0x15 */
            ii(0x100b_0c92, 5);  call(0x1007_6574, -0x3_a723);         /* call 0x10076574 */
            ii(0x100b_0c97, 3);  mov(eax, memd[ds, eax + 80]);         /* mov eax, [eax+0x50] */
            ii(0x100b_0c9a, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x100b_0c9d, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x100b_0c9f, 2);  if(jg(0x100b_0ca3, 2)) goto l_0x100b_0ca3;/* jg 0x100b0ca3 */
        l_0x100b_0ca1:
            ii(0x100b_0ca1, 2);  jmp(0x100b_0d03, 0x60); goto l_0x100b_0d03;/* jmp 0x100b0d03 */
        l_0x100b_0ca3:
            ii(0x100b_0ca3, 3);  lea(edx, memd[ss, ebp - 92]);         /* lea edx, [ebp-0x5c] */
            ii(0x100b_0ca6, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_0cbb, 3);  lea(edx, memd[ss, ebp - 96]);         /* lea edx, [ebp-0x60] */
            ii(0x100b_0cbe, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_0cd5, 3);  lea(edx, memd[ss, ebp - 100]);        /* lea edx, [ebp-0x64] */
            ii(0x100b_0cd8, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_0ced, 3);  lea(eax, memd[ss, ebp - 92]);         /* lea eax, [ebp-0x5c] */
            ...
            ii(0x100b_0cf7, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x100b_0d03:
            ii(0x100b_0d03, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_0d06, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100b_0d09, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
