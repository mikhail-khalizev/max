...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_ff36()
        {
            ...
            ii(0x1014_ff4e, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_ff51, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_ff54, 3);  mov(eax, memd[ds, eax + 6]);          /* mov eax, [eax+0x6] */
            ii(0x1014_ff57, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x1014_ff5a, 3);  imul(eax, eax, 0x33);                 /* imul eax, eax, 0x33 */
            ii(0x1014_ff5d, 7);  cmp(memb[ds, eax + 0x101c_81d5], 3);  /* cmp byte [eax+0x101c81d5], 0x3 */
            ii(0x1014_ff64, 2);  if(jz(0x1014_ff6f, 9)) goto l_0x1014_ff6f;/* jz 0x1014ff6f */
            ii(0x1014_ff66, 7);  mov(memd[ss, ebp - 8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1014_ff6d, 2);  jmp(0x1014_ffb8, 0x49); goto l_0x1014_ffb8;/* jmp 0x1014ffb8 */
        l_0x1014_ff6f:
            ii(0x1014_ff6f, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1014_ff71, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_ff80, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_ff83, 4);  mov(ax, memw[ds, eax + 82]);          /* mov ax, [eax+0x52] */
            ii(0x1014_ff87, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_ff8a, 2);  jmp(0x1014_ffb8, 0x2c); goto l_0x1014_ffb8;/* jmp 0x1014ffb8 */
        l_0x1014_ff8c:
            ii(0x1014_ff8c, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_ff8f, 5);  call(0x1007_20b1, -0xd_dee3);         /* call 0x100720b1 */
            ii(0x1014_ff94, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x1014_ff97, 5);  call(0x1007_20b1, -0xd_deeb);         /* call 0x100720b1 */
            ii(0x1014_ff9c, 3);  lea(ebx, memd[ss, ebp - 32]);         /* lea ebx, [ebp-0x20] */
            ii(0x1014_ff9f, 3);  lea(edx, memd[ss, ebp - 20]);         /* lea edx, [ebp-0x14] */
            ii(0x1014_ffa2, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1014_ffb2, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1014_ffb5, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
        l_0x1014_ffb8:
            ii(0x1014_ffb8, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
