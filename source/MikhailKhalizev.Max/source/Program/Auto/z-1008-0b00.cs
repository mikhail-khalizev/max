...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_0b00()
        {
            ...
            ii(0x1008_0b11, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1008_0b17, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1008_0b1a, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1008_0b1d, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1008_0b20, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_0b23, 3);  add(eax, 0x13);                       /* add eax, 0x13 */
            ii(0x1008_0b26, 5);  call(0x1008_ab1c, 0x9ff1);            /* call 0x1008ab1c */
            ii(0x1008_0b2b, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ii(0x1008_0b2e, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_0b31, 5);  call(0x1015_27ed, 0xd_1cb7);          /* call 0x101527ed */
            ii(0x1008_0b36, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_0b39, 5);  cmp(memw[ds, eax + 8], 0x38);         /* cmp word [eax+0x8], 0x38 */
            ii(0x1008_0b3e, 2);  if(jnz(0x1008_0b4b, 0xb)) goto l_0x1008_0b4b;/* jnz 0x10080b4b */
            ii(0x1008_0b40, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_0b43, 6);  mov(memw[ds, eax + 29], 0);           /* mov word [eax+0x1d], 0x0 */
            ii(0x1008_0b49, 2);  jmp(0x1008_0b54, 9); goto l_0x1008_0b54;/* jmp 0x10080b54 */
        l_0x1008_0b4b:
            ii(0x1008_0b4b, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_0b4e, 6);  mov(memw[ds, eax + 31], 0);           /* mov word [eax+0x1f], 0x0 */
        l_0x1008_0b54:
            ...
            ii(0x1008_0b5d, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
