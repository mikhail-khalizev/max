...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_7960()
        {
            ...
            ii(0x100b_7977, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_797a, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100b_797d, 7);  test(memd[ss, ebp - 4], 4);           /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x100b_798b, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100b_799a:
            ...
            ii(0x100b_799c, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_79aa, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_79ad, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x100b_79b2, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_79b5, 5);  call(0x100a_284c, -0x1_516e);         /* call 0x100a284c */
            ii(0x100b_79ba, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_79bd, 7);  test(memd[ss, ebp - 4], 2);           /* test dword [ebp-0x4], 0x2 */
            ii(0x100b_79c4, 2);  if(jz(0x100b_79ce, 8)) goto l_0x100b_79ce;/* jz 0x100b79ce */
            ii(0x100b_79c6, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_79c9, 5);  call(Definitions.sys_delete, 0xa_e596);/* call 0x10165f64 */
        l_0x100b_79ce:
            ii(0x100b_79ce, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_79d1, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100b_79d4, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
