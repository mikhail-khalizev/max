...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0017_a0da()
        {
            ...
            ii(0x17_a0e6, 6);  mov(memw[es, bx + 32], 0x8001);         /* mov word [es:bx+0x20], 0x8001 */
            ii(0x17_a0ec, 6);  mov(memw[es, bx + 34], 0);              /* mov word [es:bx+0x22], 0x0 */
            ii(0x17_a0f2, 5);  or(memb[es, bx + 44], 1);               /* or byte [es:bx+0x2c], 0x1 */
