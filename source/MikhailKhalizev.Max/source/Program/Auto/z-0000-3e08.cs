...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x3e28:
            ...
            ii(0x3e2e, 4);  test(di, 2);                               /* test di, 0x2 */
            ii(0x3e32, 2);  if(jnz(0x3e28, -0xc)) goto l_0x3e28;       /* jnz 0x3e28 */
            ii(0x3e34, 6);  cmp(memw[es, di - 4], 0x12cc);             /* cmp word [es:di-0x4], 0x12cc */
            ii(0x3e3a, 2);  if(jz(0x3e28, -0x14)) goto l_0x3e28;       /* jz 0x3e28 */
            ii(0x3e3c, 6);  cmp(memw[es, di - 4], 0x14d8);             /* cmp word [es:di-0x4], 0x14d8 */
            ii(0x3e42, 2);  if(jz(0x3e28, -0x1c)) goto l_0x3e28;       /* jz 0x3e28 */
            ii(0x3e44, 4);  mov(memw[es, di - 4], bx);                 /* mov [es:di-0x4], bx */
            ii(0x3e48, 4);  mov(memw[es, di - 2], dx);                 /* mov [es:di-0x2], dx */
        ...
        l_0x3e4e:
            ...
            ii(0x3e54, 2);  if(jnz(0x3e5d, 7)) goto l_0x3e5d;          /* jnz 0x3e5d */
        ...
        l_0x3e5d:
            ...
            ii(0x3e62, 2);  if(jz(0x3e67, 3)) goto l_0x3e67;           /* jz 0x3e67 */
        ...
        l_0x3e72:
            ...
            ii(0x3e77, 2);  if(jnz(0x3e7e, 5)) goto l_0x3e7e;          /* jnz 0x3e7e */
        ...
        l_0x3e7e:
            ...
            ii(0x3e90, 2);  if(jl(0x3e98, 6)) goto l_0x3e98;           /* jl 0x3e98 */
            ii(0x3e92, 6);  mov(memw[ds, 0xadc], 0);                   /* mov word [0xadc], 0x0 */
        l_0x3e98:
            ii(0x3e98, 5);  cmp(memb[ds, 0x2e], 2);                    /* cmp byte [0x2e], 0x2 */
            ii(0x3e9d, 2);  if(jle(0x3eb2, 0x13)) goto l_0x3eb2;       /* jle 0x3eb2 */
            ii(0x3e9f, 5);  test(memb[ds, 0x47], 1);                   /* test byte [0x47], 0x1 */
        ...
        l_0x3eb2:
            ...
            ii(0x3eda, 3);  mov(cx, 5);                                /* mov cx, 0x5 */
        ...
        l_0x3f00:
            ii(0x3f00, 5);  cmp(memb[ds, 0x2f], 3);                    /* cmp byte [0x2f], 0x3 */
            ii(0x3f05, 2);  if(jb(0x3f0b, 4)) goto l_0x3f0b;           /* jb 0x3f0b */
