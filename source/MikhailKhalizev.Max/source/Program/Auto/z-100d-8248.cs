...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_8248()
        {
            ...
            ii(0x100d_825d, 3);  mov(memb[ss, ebp - 4], al);           /* mov [ebp-0x4], al */
            ii(0x100d_8260, 3);  mov(memd[ss, ebp - 12], edx);         /* mov [ebp-0xc], edx */
            ii(0x100d_8263, 3);  mov(memd[ss, ebp - 16], ebx);         /* mov [ebp-0x10], ebx */
            ii(0x100d_8266, 3);  mov(memd[ss, ebp - 8], ecx);          /* mov [ebp-0x8], ecx */
            ii(0x100d_8269, 4);  movsx(edx, memw[ss, ebp - 12]);       /* movsx edx, word [ebp-0xc] */
            ii(0x100d_826d, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ii(0x100d_8271, 2);  sub(edx, eax);                        /* sub edx, eax */
            ii(0x100d_8273, 3);  mov(memd[ss, ebp - 20], edx);         /* mov [ebp-0x14], edx */
            ii(0x100d_8276, 3);  fild(memd[ss, ebp - 20]);             /* fild dword [ebp-0x14] */
            ii(0x100d_8279, 3);  fstp(memq[ss, ebp - 28]);             /* fstp qword [ebp-0x1c] */
            ii(0x100d_827c, 4);  cmp(memb[ss, ebp - 4], 9);            /* cmp byte [ebp-0x4], 0x9 */
            ii(0x100d_8280, 2);  if(jnz(0x100d_82b3, 0x31)) goto l_0x100d_82b3;/* jnz 0x100d82b3 */
            ii(0x100d_8282, 4);  movsx(eax, memb[ss, ebp - 4]);        /* movsx eax, byte [ebp-0x4] */
            ii(0x100d_8286, 2);  add(eax, eax);                        /* add eax, eax */
            ii(0x100d_8288, 6);  fild(memw[ds, eax + 0x101b_7eb8]);    /* fild word [eax+0x101b7eb8] */
            ii(0x100d_828e, 3);  fild(memw[ss, ebp - 8]);              /* fild word [ebp-0x8] */
            ii(0x100d_8291, 3);  fdiv(memq[ss, ebp - 28]);             /* fdiv qword [ebp-0x1c] */
            ...
            ii(0x100d_82a8, 3);  fistp(memd[ss, ebp - 20]);            /* fistp dword [ebp-0x14] */
            ii(0x100d_82ab, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100d_82ae, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
            ii(0x100d_82b1, 2);  jmp(0x100d_82f4, 0x41); goto l_0x100d_82f4;/* jmp 0x100d82f4 */
        l_0x100d_82b3:
            ii(0x100d_82b3, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x100d_82b7, 3);  cmp(eax, 1);                          /* cmp eax, 0x1 */
            ii(0x100d_82ba, 2);  if(jge(0x100d_82c5, 9)) goto l_0x100d_82c5;/* jge 0x100d82c5 */
            ii(0x100d_82bc, 7);  mov(memd[ss, ebp - 32], 0);           /* mov dword [ebp-0x20], 0x0 */
            ii(0x100d_82c3, 2);  jmp(0x100d_82f4, 0x2f); goto l_0x100d_82f4;/* jmp 0x100d82f4 */
        l_0x100d_82c5:
            ii(0x100d_82c5, 4);  movsx(eax, memb[ss, ebp - 4]);        /* movsx eax, byte [ebp-0x4] */
            ii(0x100d_82c9, 2);  add(eax, eax);                        /* add eax, eax */
            ii(0x100d_82cb, 6);  fild(memw[ds, eax + 0x101b_7eb8]);    /* fild word [eax+0x101b7eb8] */
            ii(0x100d_82d1, 3);  fild(memw[ss, ebp - 8]);              /* fild word [ebp-0x8] */
            ii(0x100d_82d4, 3);  fdivr(memq[ss, ebp - 28]);            /* fdivr qword [ebp-0x1c] */
            ...
            ii(0x100d_82eb, 3);  fistp(memd[ss, ebp - 20]);            /* fistp dword [ebp-0x14] */
            ii(0x100d_82ee, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100d_82f1, 3);  mov(memd[ss, ebp - 32], eax);         /* mov [ebp-0x20], eax */
        l_0x100d_82f4:
            ii(0x100d_82f4, 3);  mov(eax, memd[ss, ebp - 32]);         /* mov eax, [ebp-0x20] */
