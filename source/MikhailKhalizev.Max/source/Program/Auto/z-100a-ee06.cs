...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_ee06()
        {
            ...
            ii(0x100a_ee2c, 3);  mov(ebx, memd[ds, eax + 26]);         /* mov ebx, [eax+0x1a] */
            ...
            ii(0x100a_ee3d, 3);  mov(edx, memd[ds, eax + 24]);         /* mov edx, [eax+0x18] */
            ii(0x100a_ee40, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x100a_ee43, 3);  lea(eax, memd[ss, ebp - 44]);         /* lea eax, [ebp-0x2c] */
            ii(0x100a_ee46, 5);  call(0x1007_6aac, -0x3_839f);         /* call 0x10076aac */
            ii(0x100a_ee4b, 3);  lea(eax, memd[ss, ebp - 40]);         /* lea eax, [ebp-0x28] */
            ii(0x100a_ee4e, 5);  call(Definitions.my_ctor_0x101b_4184, -0x3_8363);/* call 0x10076af0 */
            ii(0x100a_ee53, 7);  mov(memd[ss, ebp - 36], 0);           /* mov dword [ebp-0x24], 0x0 */
            ...
            ii(0x100a_ee6e, 7);  mov(memd[ss, ebp - 20], 0);           /* mov dword [ebp-0x14], 0x0 */
            ...
            ii(0x100a_ee84, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x100a_ee87, 5);  call(0x1007_5e64, -0x3_9028);         /* call 0x10075e64 */
            ii(0x100a_ee8c, 2);  mov(ebx, eax);                        /* mov ebx, eax */
            ii(0x100a_ee8e, 3);  lea(edx, memd[ss, ebp - 44]);         /* lea edx, [ebp-0x2c] */
            ii(0x100a_ee91, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ...
            ii(0x100a_eeac, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100a_eeaf, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x100a_eeb2, 4);  cmp(memb[ds, edx + 25], 0);           /* cmp byte [edx+0x19], 0x0 */
            ...
            ii(0x100a_eec0, 3);  mov(ebx, memd[ds, eax + 22]);         /* mov ebx, [eax+0x16] */
            ...
            ii(0x100a_eeee, 3);  mov(memd[ss, ebp - 36], eax);         /* mov [ebp-0x24], eax */
        l_0x100a_eef1:
            ...
            ii(0x100a_ef00, 3);  mov(al, memb[ds, edx + 77]);          /* mov al, [edx+0x4d] */
            ii(0x100a_ef03, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x100a_ef06, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x100a_ef09, 4);  cmp(memb[ds, edx + 25], 3);           /* cmp byte [edx+0x19], 0x3 */
            ii(0x100a_ef0d, 2);  if(jnz(0x100a_ef16, 7)) goto l_0x100a_ef16;/* jnz 0x100aef16 */
            ii(0x100a_ef0f, 7);  mov(memd[ss, ebp - 24], 1);           /* mov dword [ebp-0x18], 0x1 */
        l_0x100a_ef16:
            ii(0x100a_ef16, 7);  mov(memd[ss, ebp - 16], 1);           /* mov dword [ebp-0x10], 0x1 */
            ii(0x100a_ef1d, 2);  jmp(0x100a_ef25, 6); goto l_0x100a_ef25;/* jmp 0x100aef25 */
        l_0x100a_ef1f:
            ii(0x100a_ef1f, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100a_ef22, 3);  inc(memd[ss, ebp - 16]);              /* inc dword [ebp-0x10] */
        l_0x100a_ef25:
            ...
            ii(0x100a_ef30, 4);  cmp(ax, memw[ss, ebp - 16]);          /* cmp ax, [ebp-0x10] */
            ii(0x100a_ef34, 6);  if(jle(0x100a_efd9, 0x9f)) goto l_0x100a_efd9;/* jle 0x100aefd9 */
            ii(0x100a_ef3a, 4);  movsx(edx, memw[ss, ebp - 16]);       /* movsx edx, word [ebp-0x10] */
            ...
            ii(0x100a_ef4b, 3);  lea(eax, memd[ss, ebp - 40]);         /* lea eax, [ebp-0x28] */
            ii(0x100a_ef4e, 5);  call(0x1008_8b44, -0x2_640f);         /* call 0x10088b44 */
            ii(0x100a_ef53, 4);  cmp(memd[ss, ebp - 36], 0);           /* cmp dword [ebp-0x24], 0x0 */
            ii(0x100a_ef57, 2);  if(jz(0x100a_ef76, 0x1d)) goto l_0x100a_ef76;/* jz 0x100aef76 */
            ii(0x100a_ef59, 4);  movsx(eax, memw[ss, ebp - 40]);       /* movsx eax, word [ebp-0x28] */
            ii(0x100a_ef5d, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x100a_ef60, 3);  add(eax, memd[ss, ebp - 36]);         /* add eax, [ebp-0x24] */
            ii(0x100a_ef63, 4);  movsx(edx, memw[ss, ebp - 38]);       /* movsx edx, word [ebp-0x26] */
            ...
            ii(0x100a_ef70, 4);  cmp(ax, memw[ss, ebp - 24]);          /* cmp ax, [ebp-0x18] */
        ...
        l_0x100a_ef78:
            ...
            ii(0x100a_ef86, 6);  mov(memw[ds, eax + 38], 0xffff);      /* mov word [eax+0x26], 0xffff */
            ii(0x100a_ef8c, 5);  jmp(0x100a_f00f, 0x7e); goto l_0x100a_f00f;/* jmp 0x100af00f */
        l_0x100a_ef91:
            ii(0x100a_ef91, 3);  lea(edx, memd[ss, ebp - 40]);         /* lea edx, [ebp-0x28] */
            ii(0x100a_ef94, 3);  lea(eax, memd[ss, ebp - 48]);         /* lea eax, [ebp-0x30] */
            ii(0x100a_ef97, 5);  call(0x1007_5e64, -0x3_9138);         /* call 0x10075e64 */
            ii(0x100a_ef9c, 2);  mov(ebx, eax);                        /* mov ebx, eax */
            ii(0x100a_ef9e, 3);  lea(edx, memd[ss, ebp - 44]);         /* lea edx, [ebp-0x2c] */
            ii(0x100a_efa1, 3);  lea(eax, memd[ss, ebp - 52]);         /* lea eax, [ebp-0x34] */
            ...
            ii(0x100a_efc2, 4);  cmp(ax, memw[ss, ebp - 12]);          /* cmp ax, [ebp-0xc] */
            ...
            ii(0x100a_efcb, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100a_efce, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x100a_efd1, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
        l_0x100a_efd4:
            ii(0x100a_efd4, 5);  jmp(0x100a_ef1f, -0xba); goto l_0x100a_ef1f;/* jmp 0x100aef1f */
        l_0x100a_efd9:
            ii(0x100a_efd9, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x100a_efdd, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x100a_efdf, 2);  if(jnz(0x100a_eff0, 0xf)) goto l_0x100a_eff0;/* jnz 0x100aeff0 */
            ii(0x100a_efe1, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
        ...
        l_0x100a_eff0:
            ii(0x100a_eff0, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x100a_eff3, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
        l_0x100a_eff6:
            ii(0x100a_eff6, 3);  dec(memd[ss, ebp - 16]);              /* dec dword [ebp-0x10] */
            ii(0x100a_eff9, 5);  cmp(memw[ss, ebp - 16], -1 /* 0xff */);/* cmp word [ebp-0x10], 0xffff */
