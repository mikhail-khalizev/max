...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_9661()
        {
            ...
            ii(0x19_9673, 5);  mov(memw[ss, bp - 40], 0);              /* mov word [bp-0x28], 0x0 */
            ii(0x19_9678, 3);  mov(memw[ss, bp - 38], ax);             /* mov [bp-0x26], ax */
            ii(0x19_967b, 5);  cmp(memb[ds, 0x1a02], 0);               /* cmp byte [0x1a02], 0x0 */
            ii(0x19_9680, 2);  if(jz(0x19_9689, 7)) goto l_0x19_9689;  /* jz 0x9689 */
        l_0x19_9682:
        ...
        l_0x19_9689:
            ...
            ii(0x19_969c, 2);  if(jnz(0x19_96a1, 3)) goto l_0x19_96a1; /* jnz 0x96a1 */
        ...
        l_0x19_96a1:
            ...
            ii(0x19_96be, 3);  mov(memw[ss, bp - 4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_96c1, 3);  mov(memw[ss, bp - 2], dx);              /* mov [bp-0x2], dx */
            ii(0x19_96c4, 2);  or(dx, ax);                             /* or dx, ax */
            ii(0x19_96c6, 2);  if(jnz(0x19_96cb, 3)) goto l_0x19_96cb; /* jnz 0x96cb */
            ii(0x19_96c8, 3);  jmp(0x19_97fe, 0x133); goto l_0x19_97fe;/* jmp 0x97fe */
        l_0x19_96cb:
            ii(0x19_96cb, 3);  les(bx, memw[ss, bp - 40]);             /* les bx, [bp-0x28] */
            ii(0x19_96ce, 5);  test(memb[es, bx + 71], 0x80);          /* test byte [es:bx+0x47], 0x80 */
        ...
        l_0x19_96e4:
            ii(0x19_96e4, 2);  push(1);                                /* push 0x1 */
        ...
        l_0x19_96f7:
            ...
            ii(0x19_9707, 3);  mov(memw[ss, bp - 8], ax);              /* mov [bp-0x8], ax */
            ii(0x19_970a, 3);  mov(memw[ss, bp - 6], dx);              /* mov [bp-0x6], dx */
            ...
            ii(0x19_9715, 3);  call_far_ind(memw[ss, bp - 8]);         /* call far word [bp-0x8] */
            ...
            ii(0x19_971f, 3);  add(sp, 8);                             /* add sp, 0x8 */
            ii(0x19_9722, 2);  or(dx, ax);                             /* or dx, ax */
            ii(0x19_9724, 2);  if(jz(0x19_972b, 5)) goto l_0x19_972b;  /* jz 0x972b */
            ii(0x19_9726, 5);  mov(memb[ds, 0x19f5], 0);               /* mov byte [0x19f5], 0x0 */
        l_0x19_972b:
            ii(0x19_972b, 5);  cmp(memb[ds, 0x19f5], 0);               /* cmp byte [0x19f5], 0x0 */
            ii(0x19_9730, 2);  if(jnz(0x19_9735, 3)) goto l_0x19_9735; /* jnz 0x9735 */
        ...
        l_0x19_9735:
            ...
            ii(0x19_9739, 3);  push(memw[ss, bp - 2]);                 /* push word [bp-0x2] */
            ii(0x19_973c, 3);  push(memw[ss, bp - 4]);                 /* push word [bp-0x4] */
            ii(0x19_973f, 5);  call_far_abs(0x80, 0x5a20);             /* call word 0x80:0x5a20 */
            ii(0x19_9744, 3);  add(sp, 8);                             /* add sp, 0x8 */
            ...
            ii(0x19_9754, 2);  if(jnz(0x19_9759, 3)) goto l_0x19_9759; /* jnz 0x9759 */
        ...
        l_0x19_9759:
            ...
            ii(0x19_975d, 3);  push(memw[ss, bp - 2]);                 /* push word [bp-0x2] */
            ii(0x19_9760, 3);  push(memw[ss, bp - 4]);                 /* push word [bp-0x4] */
            ii(0x19_9763, 5);  call_far_abs(0x80, 0x5a20);             /* call word 0x80:0x5a20 */
            ii(0x19_9768, 3);  add(sp, 8);                             /* add sp, 0x8 */
            ...
            ii(0x19_977e, 3);  push(memw[ss, bp - 2]);                 /* push word [bp-0x2] */
            ii(0x19_9781, 3);  push(memw[ss, bp - 4]);                 /* push word [bp-0x4] */
            ii(0x19_9784, 5);  call_far_abs(0x80, 0x5a20);             /* call word 0x80:0x5a20 */
            ii(0x19_9789, 3);  add(sp, 8);                             /* add sp, 0x8 */
            ...
            ii(0x19_97a6, 3);  add(sp, 6);                             /* add sp, 0x6 */
            ...
            ii(0x19_97bb, 3);  add(sp, 6);                             /* add sp, 0x6 */
            ...
            ii(0x19_97cf, 4);  call_far_ind(memw[ds, 0x1a10]);         /* call far word [0x1a10] */
            ii(0x19_97d3, 3);  add(sp, 8);                             /* add sp, 0x8 */
            ...
            ii(0x19_97e6, 3);  add(sp, 8);                             /* add sp, 0x8 */
            ii(0x19_97e9, 5);  mov(memb[ds, 0x19f4], 1);               /* mov byte [0x19f4], 0x1 */
        ...
        l_0x19_97f0:
            ...
            ii(0x19_97f9, 5);  mov(memb[ds, 0x19f4], 2);               /* mov byte [0x19f4], 0x2 */
        l_0x19_97fe:
            ...
            ii(0x19_9816, 2);  if(jnz(0x19_9821, 9)) goto l_0x19_9821; /* jnz 0x9821 */
        l_0x19_9818:
            ii(0x19_9818, 3);  call(0x19_8bea, -0xc31);                /* call 0x8bea */
            ii(0x19_981b, 3);  mov(ax, 1);                             /* mov ax, 0x1 */
        ...
        l_0x19_9821:
            ...
            ii(0x19_982c, 3);  add(sp, 6);                             /* add sp, 0x6 */
            ...
            ii(0x19_983c, 5);  mov(memb[ds, 0x19f3], 2);               /* mov byte [0x19f3], 0x2 */
        ...
        l_0x19_9855:
            ...
            ii(0x19_9860, 3);  add(sp, 6);                             /* add sp, 0x6 */
            ii(0x19_9863, 2);  or(ax, ax);                             /* or ax, ax */
            ii(0x19_9865, 2);  if(jz(0x19_986c, 5)) goto l_0x19_986c;  /* jz 0x986c */
            ii(0x19_9867, 5);  mov(memb[ds, 0x1a03], 1);               /* mov byte [0x1a03], 0x1 */
        l_0x19_986c:
            ...
            ii(0x19_9883, 2);  if(jz(0x19_988a, 5)) goto l_0x19_988a;  /* jz 0x988a */
            ii(0x19_9885, 3);  mov(ax, 0x1cab);                        /* mov ax, 0x1cab */
            ii(0x19_9888, 2);  jmp(0x19_988d, 3); goto l_0x19_988d;    /* jmp 0x988d */
        l_0x19_988a:
        ...
        l_0x19_98b1:
            ...
            ii(0x19_98b6, 2);  if(jnz(0x19_98bb, 3)) goto l_0x19_98bb; /* jnz 0x98bb */
