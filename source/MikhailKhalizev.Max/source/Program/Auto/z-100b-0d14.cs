...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_0d14()
        {
            ...
            ii(0x100b_0d2b, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100b_0d2e, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100b_0d31, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_0d33, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_0d42, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_0d45, 3);  add(eax, 0x15);                       /* add eax, 0x15 */
            ii(0x100b_0d48, 5);  call(0x1007_6574, -0x3_a7d9);         /* call 0x10076574 */
            ii(0x100b_0d4d, 3);  mov(edx, memd[ds, eax + 24]);         /* mov edx, [eax+0x18] */
            ii(0x100b_0d50, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x100b_0d53, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_0d56, 2);  mov(memd[ds, eax], edx);              /* mov [eax], edx */
            ii(0x100b_0d58, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100b_0d5b, 3);  add(eax, 0x15);                       /* add eax, 0x15 */
            ii(0x100b_0d5e, 5);  call(0x1007_6574, -0x3_a7ef);         /* call 0x10076574 */
            ii(0x100b_0d63, 3);  mov(edx, memd[ds, eax + 26]);         /* mov edx, [eax+0x1a] */
            ii(0x100b_0d66, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x100b_0d69, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_0d6c, 3);  mov(memd[ds, eax + 4], edx);          /* mov [eax+0x4], edx */
            ii(0x100b_0d6f, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_0d72, 2);  mov(eax, memd[ds, eax]);              /* mov eax, [eax] */
            ii(0x100b_0d74, 1);  inc(eax);                             /* inc eax */
            ii(0x100b_0d75, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_0d78, 3);  mov(memd[ds, edx + 8], eax);          /* mov [edx+0x8], eax */
            ii(0x100b_0d7b, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_0d7e, 3);  mov(eax, memd[ds, eax + 4]);          /* mov eax, [eax+0x4] */
            ii(0x100b_0d81, 1);  inc(eax);                             /* inc eax */
            ii(0x100b_0d82, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_0d85, 3);  mov(memd[ds, edx + 12], eax);         /* mov [edx+0xc], eax */
            ii(0x100b_0d88, 2);  jmp(0x100b_0ded, 0x63); goto l_0x100b_0ded;/* jmp 0x100b0ded */
        l_0x100b_0d8a:
            ii(0x100b_0d8a, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_0d8c, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_0d9b, 3);  lea(edx, memd[ss, ebp - 16]);         /* lea edx, [ebp-0x10] */
            ii(0x100b_0d9e, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_0db1, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_0db4, 2);  mov(memd[ds, eax], edx);              /* mov [eax], edx */
            ii(0x100b_0db6, 3);  lea(edx, memd[ss, ebp - 20]);         /* lea edx, [ebp-0x14] */
            ii(0x100b_0db9, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100b_0dce, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_0dd1, 3);  mov(memd[ds, eax + 4], edx);          /* mov [eax+0x4], edx */
            ii(0x100b_0dd4, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_0dd7, 2);  mov(eax, memd[ds, eax]);              /* mov eax, [eax] */
            ii(0x100b_0dd9, 1);  inc(eax);                             /* inc eax */
            ii(0x100b_0dda, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_0ddd, 3);  mov(memd[ds, edx + 8], eax);          /* mov [edx+0x8], eax */
            ii(0x100b_0de0, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_0de3, 3);  mov(eax, memd[ds, eax + 4]);          /* mov eax, [eax+0x4] */
            ii(0x100b_0de6, 1);  inc(eax);                             /* inc eax */
            ii(0x100b_0de7, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_0dea, 3);  mov(memd[ds, edx + 12], eax);         /* mov [edx+0xc], eax */
        l_0x100b_0ded:
            ii(0x100b_0ded, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_0df0, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100b_0df3, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
