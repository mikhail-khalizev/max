...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_9502()
        {
            ...
            ii(0x100a_9533, 9);  mov(memw[ds, 0x101c_31c0], 2);        /* mov word [0x101c31c0], 0x2 */
        ...
        l_0x100a_9541:
            ...
            ii(0x100a_9549, 3);  cmp(eax, 2);                          /* cmp eax, 0x2 */
            ii(0x100a_954c, 2);  if(jnz(0x100a_9563, 0x15)) goto l_0x100a_9563;/* jnz 0x100a9563 */
            ii(0x100a_954e, 9);  mov(memw[ds, 0x101c_31c0], 1);        /* mov word [0x101c31c0], 0x1 */
        ...
        l_0x100a_9563:
            ...
            ii(0x100a_956c, 9);  mov(memw[ds, 0x101c_31c0], 1);        /* mov word [0x101c31c0], 0x1 */
