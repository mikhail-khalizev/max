...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1017_8d8c()
        {
            ...
            ii(0x1017_8d91, 2);  mov(ah, 2);                           /* mov ah, 0x2 */
            ii(0x1017_8d93, 2);  mov(ebx, esp);                        /* mov ebx, esp */
            ii(0x1017_8d95, 4);  lea(edx, memd[ss, esp + 28]);         /* lea edx, [esp+0x1c] */
            ii(0x1017_8d99, 4);  mov(memb[ss, esp + 29], ah);          /* mov [esp+0x1d], ah */
            ...
            ii(0x1017_8dab, 2);  if(jz(0x1017_8db4, 7)) goto l_0x1017_8db4;/* jz 0x10178db4 */
            ii(0x1017_8dad, 7);  or(memb[ds, 0x101b_e1f2], 2);         /* or byte [0x101be1f2], 0x2 */
        l_0x1017_8db4:
            ii(0x1017_8db4, 4);  test(memb[ss, esp], 0x20);            /* test byte [esp], 0x20 */
            ii(0x1017_8db8, 2);  if(jz(0x1017_8dc1, 7)) goto l_0x1017_8dc1;/* jz 0x10178dc1 */
            ii(0x1017_8dba, 7);  or(memb[ds, 0x101b_e1f2], 1);         /* or byte [0x101be1f2], 0x1 */
        l_0x1017_8dc1:
            ii(0x1017_8dc1, 4);  test(memb[ss, esp], 0x10);            /* test byte [esp], 0x10 */
            ii(0x1017_8dc5, 2);  if(jz(0x1017_8dce, 7)) goto l_0x1017_8dce;/* jz 0x10178dce */
            ii(0x1017_8dc7, 7);  or(memb[ds, 0x101b_e1f2], 4);         /* or byte [0x101be1f2], 0x4 */
        l_0x1017_8dce:
