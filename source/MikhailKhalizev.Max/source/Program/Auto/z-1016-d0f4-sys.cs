...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1016_d0f4()
        {
            ...
            ii(0x1016_d103, 2);  if(jz(0x1016_d10b, 6)) goto l_0x1016_d10b;/* jz 0x1016d10b */
        ...
        l_0x1016_d10b:
            ...
            ii(0x1016_d11f, 2);  jmp(0x1016_d126, 5); goto l_0x1016_d126;/* jmp 0x1016d126 */
        l_0x1016_d121:
            ii(0x1016_d121, 5);  mov(eax, 0xffff_ffff);                /* mov eax, 0xffffffff */
        l_0x1016_d126:
            ii(0x1016_d126, 2);  mov(ecx, eax);                        /* mov ecx, eax */
            ii(0x1016_d128, 3);  cmp(eax, -1 /* 0xff */);              /* cmp eax, 0xffffffff */
        ...
        l_0x1016_d143:
            ...
            ii(0x1016_d14c, 5);  mov(ebx, 1);                          /* mov ebx, 0x1 */
            ii(0x1016_d151, 4);  lea(edx, memd[ss, esp + 8]);          /* lea edx, [esp+0x8] */
        ...
        l_0x1016_d15d:
            ...
            ii(0x1016_d166, 5);  mov(ebx, 1);                          /* mov ebx, 0x1 */
            ii(0x1016_d16b, 4);  lea(edx, memd[ss, esp + 4]);          /* lea edx, [esp+0x4] */
        ...
        l_0x1016_d177:
            ...
            ii(0x1016_d180, 5);  mov(ebx, 1);                          /* mov ebx, 0x1 */
            ii(0x1016_d185, 4);  lea(edx, memd[ss, esp + 12]);         /* lea edx, [esp+0xc] */
            ii(0x1016_d189, 2);  mov(eax, ecx);                        /* mov eax, ecx */
            ii(0x1016_d18b, 6);  call_abs(memd[ds, 0x1020_857c]);      /* call dword [0x1020857c] */
        l_0x1016_d191:
            ii(0x1016_d191, 5);  cmp(memb[ss, esp + 8], 0x3f);         /* cmp byte [esp+0x8], 0x3f */
            ii(0x1016_d196, 2);  if(ja(0x1016_d1a6, 0xe)) goto l_0x1016_d1a6;/* ja 0x1016d1a6 */
            ii(0x1016_d198, 5);  cmp(memb[ss, esp + 4], 0x3f);         /* cmp byte [esp+0x4], 0x3f */
            ii(0x1016_d19d, 2);  if(ja(0x1016_d1a6, 7)) goto l_0x1016_d1a6;/* ja 0x1016d1a6 */
            ii(0x1016_d19f, 5);  cmp(memb[ss, esp + 12], 0x3f);        /* cmp byte [esp+0xc], 0x3f */
            ii(0x1016_d1a4, 2);  if(jbe(0x1016_d1bc, 0x16)) goto l_0x1016_d1bc;/* jbe 0x1016d1bc */
        l_0x1016_d1a6:
            ii(0x1016_d1a6, 2);  xor(bh, bh);                          /* xor bh, bh */
            ii(0x1016_d1a8, 4);  mov(memb[ss, esp + 8], bh);           /* mov [esp+0x8], bh */
            ii(0x1016_d1ac, 4);  mov(memb[ss, esp + 4], bh);           /* mov [esp+0x4], bh */
            ii(0x1016_d1b0, 4);  mov(memb[ss, esp + 12], bh);          /* mov [esp+0xc], bh */
            ii(0x1016_d1b4, 6);  mov(memb[ds, esi + 0x101d_0420], bh); /* mov [esi+0x101d0420], bh */
            ii(0x1016_d1ba, 2);  jmp(0x1016_d1c3, 7); goto l_0x1016_d1c3;/* jmp 0x1016d1c3 */
        l_0x1016_d1bc:
            ii(0x1016_d1bc, 7);  mov(memb[ds, esi + 0x101d_0420], 1);  /* mov byte [esi+0x101d0420], 0x1 */
        l_0x1016_d1c3:
            ii(0x1016_d1c3, 3);  add(edi, 3);                          /* add edi, 0x3 */
            ii(0x1016_d1c6, 4);  mov(al, memb[ss, esp + 8]);           /* mov al, [esp+0x8] */
            ii(0x1016_d1ca, 6);  mov(memb[ds, edi + 0x101b_debd], al); /* mov [edi+0x101bdebd], al */
            ii(0x1016_d1d0, 4);  mov(al, memb[ss, esp + 4]);           /* mov al, [esp+0x4] */
            ii(0x1016_d1d4, 6);  mov(memb[ds, edi + 0x101b_debe], al); /* mov [edi+0x101bdebe], al */
            ii(0x1016_d1da, 4);  mov(al, memb[ss, esp + 12]);          /* mov al, [esp+0xc] */
        ...
        l_0x1016_d20c:
            ...
            ii(0x1016_d21b, 5);  mov(ebx, 4);                          /* mov ebx, 0x4 */
        ...
        l_0x1016_d29d:
            ...
            ii(0x1016_d2a9, 2);  if(jz(0x1016_d2b3, 8)) goto l_0x1016_d2b3;/* jz 0x1016d2b3 */
            ii(0x1016_d2ab, 2);  mov(eax, ecx);                        /* mov eax, ecx */
            ii(0x1016_d2ad, 6);  call_abs(memd[ds, 0x1020_8578]);      /* call dword [0x10208578] */
        l_0x1016_d2b3:
            ii(0x1016_d2b3, 5);  mov(eax, 1);                          /* mov eax, 0x1 */
        l_0x1016_d2b8:
