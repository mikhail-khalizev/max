...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_8294()
        {
            ...
            ii(0x1014_82a6, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ...
            ii(0x1014_82ca, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1014_82cd, 5);  mov(eax, 0x42);                       /* mov eax, 0x42 */
            ii(0x1014_82d2, 5);  call(Definitions.sys_read_port, 0x3_8cfb);/* call 0x10180fd2 */
            ii(0x1014_82d7, 3);  shl(eax, 8);                          /* shl eax, 0x8 */
            ii(0x1014_82da, 3);  add(memd[ss, ebp - 4], eax);          /* add [ebp-0x4], eax */
            ii(0x1014_82dd, 5);  call(Definitions.sys_sti, 0x3_8cfa);  /* call 0x10180fdc */
            ii(0x1014_82e2, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_82e5, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_82e8, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
