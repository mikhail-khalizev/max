...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_2f04()
        {
            ...
            ii(0x100e_2f1b, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100e_2f1e, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100e_2f21, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_2f24, 5);  call(0x1007_623c, -0x6_cced);         /* call 0x1007623c */
            ii(0x100e_2f29, 3);  mov(edx, memd[ds, eax + 25]);         /* mov edx, [eax+0x19] */
            ii(0x100e_2f2c, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x100e_2f2f, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_2f32, 3);  mov(al, memb[ds, eax + 84]);          /* mov al, [eax+0x54] */
            ii(0x100e_2f35, 5);  and(eax, 0xff);                       /* and eax, 0xff */
            ii(0x100e_2f3a, 2);  cmp(eax, edx);                        /* cmp eax, edx */
            ii(0x100e_2f3c, 2);  if(jl(0x100e_2f44, 6)) goto l_0x100e_2f44;/* jl 0x100e2f44 */
            ii(0x100e_2f3e, 4);  mov(memb[ss, ebp - 12], 0);           /* mov byte [ebp-0xc], 0x0 */
            ii(0x100e_2f42, 2);  jmp(0x100e_2f87, 0x43); goto l_0x100e_2f87;/* jmp 0x100e2f87 */
        l_0x100e_2f44:
            ii(0x100e_2f44, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x100e_2f47, 5);  call(0x1007_20b1, -0x7_0e9b);         /* call 0x100720b1 */
            ii(0x100e_2f4c, 3);  lea(eax, memd[ss, ebp - 40]);         /* lea eax, [ebp-0x28] */
            ii(0x100e_2f4f, 5);  call(0x1007_20b1, -0x7_0ea3);         /* call 0x100720b1 */
            ii(0x100e_2f54, 3);  lea(ebx, memd[ss, ebp - 40]);         /* lea ebx, [ebp-0x28] */
            ii(0x100e_2f57, 3);  lea(edx, memd[ss, ebp - 28]);         /* lea edx, [ebp-0x1c] */
            ii(0x100e_2f5a, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100e_2f6f, 4);  movsx(eax, memw[ss, ebp - 26]);       /* movsx eax, word [ebp-0x1a] */
            ii(0x100e_2f73, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x100e_2f75, 2);  if(jle(0x100e_2f7d, 6)) goto l_0x100e_2f7d;/* jle 0x100e2f7d */
            ii(0x100e_2f77, 4);  mov(memb[ss, ebp - 16], 1);           /* mov byte [ebp-0x10], 0x1 */
            ii(0x100e_2f7b, 2);  jmp(0x100e_2f81, 4); goto l_0x100e_2f81;/* jmp 0x100e2f81 */
        l_0x100e_2f7d:
            ii(0x100e_2f7d, 4);  mov(memb[ss, ebp - 16], 0);           /* mov byte [ebp-0x10], 0x0 */
        l_0x100e_2f81:
            ii(0x100e_2f81, 3);  mov(al, memb[ss, ebp - 16]);          /* mov al, [ebp-0x10] */
            ii(0x100e_2f84, 3);  mov(memb[ss, ebp - 12], al);          /* mov [ebp-0xc], al */
        l_0x100e_2f87:
            ii(0x100e_2f87, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
