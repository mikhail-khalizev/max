...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_82da()
        {
            ...
            ii(0x1013_82ec, 6);  sub(esp, 4);                          /* sub esp, 0x4 */
            ii(0x1013_82f2, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1013_82f5, 4);  movsx(edx, memw[ss, ebp - 4]);        /* movsx edx, word [ebp-0x4] */
