...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x19_9b84, 4);  enter(4, 0);                            /* enter 0x4, 0x0 */
            ...
            ii(0x19_9b9c, 3);  mov(memw[ss, bp - 4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_9b9f, 3);  mov(memw[ss, bp - 2], dx);              /* mov [bp-0x2], dx */
            ii(0x19_9ba2, 1);  push(dx);                               /* push dx */
            ii(0x19_9ba3, 1);  push(ax);                               /* push ax */
            ii(0x19_9ba4, 3);  call(0x19_fa6b, 0x5ec4);                /* call 0xfa6b */
            ii(0x19_9ba7, 3);  mov(ax, memw[ss, bp - 2]);              /* mov ax, [bp-0x2] */
