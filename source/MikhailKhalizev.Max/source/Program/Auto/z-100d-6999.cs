...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100d_6999()
        {
            ...
            ii(0x100d_69b0, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100d_69b3, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x100d_69b6, 7);  test(memd[ss, ebp - 4], 4);           /* test dword [ebp-0x4], 0x4 */
            ...
            ii(0x100d_69c4, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
        ...
        l_0x100d_69d3:
            ii(0x100d_69d3, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_69d6, 7);  mov(memd[ds, eax + 19], 0x101b_5f98); /* mov dword [eax+0x13], 0x101b5f98 */
            ii(0x100d_69dd, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x100d_69e5, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_69e8, 2);  mov(eax, memd[ds, eax]);              /* mov eax, [eax] */
            ii(0x100d_69ea, 5);  call(/* sys */ 0x1016_6990, 0x8_ffa1);/* call 0x10166990 */
        l_0x100d_69ef:
            ii(0x100d_69ef, 7);  test(memd[ss, ebp - 4], 2);           /* test dword [ebp-0x4], 0x2 */
            ii(0x100d_69f6, 2);  if(jz(0x100d_6a00, 8)) goto l_0x100d_6a00;/* jz 0x100d6a00 */
            ii(0x100d_69f8, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_69fb, 5);  call(Definitions.sys_delete, 0x8_f564);/* call 0x10165f64 */
        l_0x100d_6a00:
            ii(0x100d_6a00, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x100d_6a03, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100d_6a06, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
