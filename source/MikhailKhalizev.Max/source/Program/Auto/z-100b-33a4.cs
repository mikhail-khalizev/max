...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100b_33a4()
        {
            ...
            ii(0x100b_33bc, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100b_33bf, 2);  xor(ecx, ecx);                        /* xor ecx, ecx */
            ii(0x100b_33c1, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_33c4, 3);  mov(ebx, memd[ds, edx + 30]);         /* mov ebx, [edx+0x1e] */
            ii(0x100b_33c7, 3);  sar(ebx, 0x18);                       /* sar ebx, 0x18 */
            ii(0x100b_33ca, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_33d7, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_33da, 3);  mov(eax, memd[ds, eax + 7]);          /* mov eax, [eax+0x7] */
            ...
            ii(0x100b_33f2, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ...
            ii(0x100b_340b, 3);  lea(eax, memd[ss, ebp - 40]);         /* lea eax, [ebp-0x28] */
            ii(0x100b_340e, 5);  call(0x1008_b148, -0x2_82cb);         /* call 0x1008b148 */
            ii(0x100b_3413, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_3422, 3);  mov(al, memb[ds, edx + 77]);          /* mov al, [edx+0x4d] */
            ii(0x100b_3425, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x100b_3428, 4);  or(memb[ss, ebp - 8], 1);             /* or byte [ebp-0x8], 0x1 */
            ...
            ii(0x100b_3435, 5);  mov(ebx, 1);                          /* mov ebx, 0x1 */
            ii(0x100b_343a, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_3447, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
            ii(0x100b_344a, 5);  call(0x1011_fec1, 0x6_ca72);          /* call 0x1011fec1 */
            ii(0x100b_344f, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x100b_3452, 4);  and(memb[ss, ebp - 8], -2 /* 0xfe */);/* and byte [ebp-0x8], 0xfe */
            ii(0x100b_3456, 7);  mov(memd[ss, ebp - 12], 0);           /* mov dword [ebp-0xc], 0x0 */
            ii(0x100b_345d, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_3460, 4);  cmp(memb[ds, eax + 33], 3);           /* cmp byte [eax+0x21], 0x3 */
            ii(0x100b_3464, 2);  if(jnz(0x100b_346d, 7)) goto l_0x100b_346d;/* jnz 0x100b346d */
            ii(0x100b_3466, 7);  mov(memd[ss, ebp - 16], 1);           /* mov dword [ebp-0x10], 0x1 */
        l_0x100b_346d:
            ii(0x100b_346d, 4);  cmp(memd[ss, ebp - 24], 0);           /* cmp dword [ebp-0x18], 0x0 */
            ii(0x100b_3471, 2);  if(jnz(0x100b_348a, 0x17)) goto l_0x100b_348a;/* jnz 0x100b348a */
            ii(0x100b_3473, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_3476, 5);  call(0x100b_375b, 0x2e0);             /* call 0x100b375b */
            ii(0x100b_347b, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_347d, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
        ...
        l_0x100b_348a:
            ...
            ii(0x100b_349d, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x100b_34a1, 3);  cmp(eax, 0x14);                       /* cmp eax, 0x14 */
            ii(0x100b_34a4, 6);  if(jge(0x100b_36e0, 0x236)) goto l_0x100b_36e0;/* jge 0x100b36e0 */
        l_0x100b_34aa:
            ii(0x100b_34aa, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_34ad, 4);  inc(memw[ds, eax + 31]);              /* inc word [eax+0x1f] */
            ii(0x100b_34b1, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_34b4, 4);  mov(dx, memw[ds, eax + 31]);          /* mov dx, [eax+0x1f] */
            ii(0x100b_34b8, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_34bb, 4);  cmp(dx, memw[ds, eax + 23]);          /* cmp dx, [eax+0x17] */
            ii(0x100b_34bf, 6);  if(jl(0x100b_356f, 0xaa)) goto l_0x100b_356f;/* jl 0x100b356f */
            ii(0x100b_34c5, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_34c8, 5);  add(memw[ds, eax + 29], 2);           /* add word [eax+0x1d], 0x2 */
            ii(0x100b_34cd, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_34d0, 3);  mov(eax, memd[ds, eax + 27]);         /* mov eax, [eax+0x1b] */
            ii(0x100b_34d3, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x100b_34d6, 3);  cmp(eax, 8);                          /* cmp eax, 0x8 */
            ii(0x100b_34d9, 6);  if(jl(0x100b_3566, 0x87)) goto l_0x100b_3566;/* jl 0x100b3566 */
            ii(0x100b_34df, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_34e2, 5);  add(memw[ds, eax + 23], 2);           /* add word [eax+0x17], 0x2 */
            ii(0x100b_34e7, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_34ea, 4);  cmp(memb[ds, eax + 34], 0);           /* cmp byte [eax+0x22], 0x0 */
            ii(0x100b_34ee, 2);  if(jz(0x100b_3517, 0x27)) goto l_0x100b_3517;/* jz 0x100b3517 */
            ii(0x100b_34f0, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_3500, 3);  mov(eax, memd[ds, eax + 14]);         /* mov eax, [eax+0xe] */
            ...
            ii(0x100b_350a, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_350d, 3);  mov(eax, memd[ds, eax + 21]);         /* mov eax, [eax+0x15] */
        ...
        l_0x100b_3517:
            ii(0x100b_3517, 5);  mov(ebx, 1);                          /* mov ebx, 0x1 */
            ii(0x100b_351c, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x100b_3521, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_3531, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_3534, 5);  call(0x100b_375b, 0x222);             /* call 0x100b375b */
            ii(0x100b_3539, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_353b, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
        ...
        l_0x100b_3548:
            ii(0x100b_3548, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_354b, 4);  dec(memw[ds, eax + 25]);              /* dec word [eax+0x19] */
            ii(0x100b_354f, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_3552, 4);  inc(memw[ds, eax + 27]);              /* inc word [eax+0x1b] */
            ii(0x100b_3556, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_3559, 6);  mov(memw[ds, eax + 29], 0);           /* mov word [eax+0x1d], 0x0 */
            ii(0x100b_355f, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_3562, 4);  mov(memb[ds, eax + 34], 0);           /* mov byte [eax+0x22], 0x0 */
        l_0x100b_3566:
            ii(0x100b_3566, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_3569, 6);  mov(memw[ds, eax + 31], 0);           /* mov word [eax+0x1f], 0x0 */
        l_0x100b_356f:
            ii(0x100b_356f, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_3572, 3);  mov(eax, memd[ds, eax + 27]);         /* mov eax, [eax+0x1b] */
            ii(0x100b_3575, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x100b_3578, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x100b_357b, 5);  mov(edx, 0x101c_5348);                /* mov edx, 0x101c5348 */
            ii(0x100b_3580, 2);  add(edx, eax);                        /* add edx, eax */
            ii(0x100b_3582, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_3585, 3);  add(eax, 0x19);                       /* add eax, 0x19 */
            ii(0x100b_3588, 5);  call(0x1008_b1a4, -0x2_83e9);         /* call 0x1008b1a4 */
            ii(0x100b_358d, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100b_3590, 3);  inc(memd[ss, ebp - 12]);              /* inc dword [ebp-0xc] */
            ii(0x100b_3593, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_3596, 3);  add(edx, 0x19);                       /* add edx, 0x19 */
            ii(0x100b_3599, 3);  lea(eax, memd[ss, ebp - 40]);         /* lea eax, [ebp-0x28] */
            ...
            ii(0x100b_35a9, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_35ac, 4);  mov(memb[ds, eax + 34], 1);           /* mov byte [eax+0x22], 0x1 */
            ii(0x100b_35b0, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_35b3, 3);  mov(eax, memd[ds, eax + 23]);         /* mov eax, [eax+0x17] */
            ii(0x100b_35b6, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x100b_35b9, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x100b_35bc, 3);  mov(edx, memd[ss, ebp - 24]);         /* mov edx, [ebp-0x18] */
            ii(0x100b_35bf, 2);  add(edx, eax);                        /* add edx, eax */
            ii(0x100b_35c1, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_35c4, 3);  mov(eax, memd[ds, eax + 25]);         /* mov eax, [eax+0x19] */
            ...
            ii(0x100b_35d3, 4);  cmp(ax, memw[ss, ebp - 16]);          /* cmp ax, [ebp-0x10] */
            ii(0x100b_35d7, 2);  if(jge(0x100b_3615, 0x3c)) goto l_0x100b_3615;/* jge 0x100b3615 */
            ii(0x100b_35d9, 5);  mov(eax, 2);                          /* mov eax, 0x2 */
            ii(0x100b_35de, 1);  push(eax);                            /* push eax */
            ii(0x100b_35df, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_35e2, 3);  mov(ecx, memd[ds, eax + 25]);         /* mov ecx, [eax+0x19] */
            ii(0x100b_35e5, 3);  sar(ecx, 0x10);                       /* sar ecx, 0x10 */
            ii(0x100b_35e8, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_35eb, 3);  mov(ebx, memd[ds, eax + 23]);         /* mov ebx, [eax+0x17] */
            ii(0x100b_35ee, 3);  sar(ebx, 0x10);                       /* sar ebx, 0x10 */
            ii(0x100b_35f1, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_35f4, 3);  mov(edx, memd[ds, edx + 7]);          /* mov edx, [edx+0x7] */
            ii(0x100b_35f7, 3);  sar(edx, 0x10);                       /* sar edx, 0x10 */
            ii(0x100b_35fa, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_35fd, 3);  add(eax, 0x13);                       /* add eax, 0x13 */
            ii(0x100b_3600, 5);  call(0x1007_6574, -0x3_d091);         /* call 0x10076574 */
            ii(0x100b_3605, 3);  mov(eax, memd[ds, eax + 6]);          /* mov eax, [eax+0x6] */
            ...
            ii(0x100b_3613, 2);  if(jnz(0x100b_3617, 2)) goto l_0x100b_3617;/* jnz 0x100b3617 */
        l_0x100b_3615:
            ii(0x100b_3615, 2);  jmp(0x100b_3633, 0x1c); goto l_0x100b_3633;/* jmp 0x100b3633 */
        l_0x100b_3617:
            ii(0x100b_3617, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_361a, 3);  add(edx, 0x19);                       /* add edx, 0x19 */
            ii(0x100b_361d, 3);  lea(eax, memd[ss, ebp - 60]);         /* lea eax, [ebp-0x3c] */
            ii(0x100b_3620, 5);  call(0x1007_5e64, -0x3_d7c1);         /* call 0x10075e64 */
            ii(0x100b_3625, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x100b_3627, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
            ii(0x100b_362a, 5);  call(0x1011_ff4c, 0x6_c91d);          /* call 0x1011ff4c */
            ii(0x100b_362f, 2);  test(al, al);                         /* test al, al */
            ii(0x100b_3631, 2);  if(jnz(0x100b_3638, 5)) goto l_0x100b_3638;/* jnz 0x100b3638 */
        l_0x100b_3633:
        ...
        l_0x100b_3638:
            ...
            ii(0x100b_3642, 3);  mov(memd[ss, ebp - 64], eax);         /* mov [ebp-0x40], eax */
            ii(0x100b_3645, 3);  mov(eax, memd[ss, ebp - 64]);         /* mov eax, [ebp-0x40] */
            ii(0x100b_3648, 3);  mov(memd[ss, ebp - 68], eax);         /* mov [ebp-0x44], eax */
            ii(0x100b_364b, 4);  cmp(memd[ss, ebp - 68], 0);           /* cmp dword [ebp-0x44], 0x0 */
            ...
            ii(0x100b_3657, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x100b_365a, 3);  add(edx, 0x19);                       /* add edx, 0x19 */
            ii(0x100b_365d, 3);  lea(eax, memd[ss, ebp - 72]);         /* lea eax, [ebp-0x48] */
            ...
            ii(0x100b_366b, 3);  mov(ebx, memd[ss, ebp - 4]);          /* mov ebx, [ebp-0x4] */
            ii(0x100b_366e, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x100b_367b, 3);  mov(eax, memd[ss, ebp - 64]);         /* mov eax, [ebp-0x40] */
            ii(0x100b_367e, 5);  call(0x100a_c220, -0x7463);           /* call 0x100ac220 */
            ii(0x100b_3683, 3);  mov(memd[ss, ebp - 76], eax);         /* mov [ebp-0x4c], eax */
            ii(0x100b_3686, 3);  mov(eax, memd[ss, ebp - 76]);         /* mov eax, [ebp-0x4c] */
            ii(0x100b_3689, 3);  mov(memd[ss, ebp - 80], eax);         /* mov [ebp-0x50], eax */
            ii(0x100b_368c, 2);  jmp(0x100b_3694, 6); goto l_0x100b_3694;/* jmp 0x100b3694 */
        l_0x100b_368e:
            ii(0x100b_368e, 3);  mov(eax, memd[ss, ebp - 68]);         /* mov eax, [ebp-0x44] */
            ii(0x100b_3691, 3);  mov(memd[ss, ebp - 80], eax);         /* mov [ebp-0x50], eax */
        l_0x100b_3694:
            ii(0x100b_3694, 3);  mov(edx, memd[ss, ebp - 80]);         /* mov edx, [ebp-0x50] */
            ii(0x100b_3697, 3);  lea(eax, memd[ss, ebp - 84]);         /* lea eax, [ebp-0x54] */
            ii(0x100b_369a, 5);  call(0x1008_a5f0, -0x2_90af);         /* call 0x1008a5f0 */
            ii(0x100b_369f, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x100b_36a4, 3);  lea(eax, memd[ss, ebp - 84]);         /* lea eax, [ebp-0x54] */
            ii(0x100b_36a7, 5);  call(0x1008_a520, -0x2_918c);         /* call 0x1008a520 */
            ii(0x100b_36ac, 5);  call(0x1008_a6a4, -0x2_900d);         /* call 0x1008a6a4 */
            ii(0x100b_36b1, 3);  lea(eax, memd[ss, ebp - 84]);         /* lea eax, [ebp-0x54] */
            ...
            ii(0x100b_36c7, 3);  lea(eax, memd[ss, ebp - 84]);         /* lea eax, [ebp-0x54] */
            ii(0x100b_36ca, 5);  call(0x1008_8d4c, -0x2_a983);         /* call 0x10088d4c */
            ii(0x100b_36cf, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_36d1, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
        ...
        l_0x100b_36e0:
            ii(0x100b_36e0, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x100b_36e5, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100b_36e8, 5);  call(0x100a_28ff, -0x1_0dee);         /* call 0x100a28ff */
            ii(0x100b_36ed, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100b_36ef, 3);  lea(eax, memd[ss, ebp - 56]);         /* lea eax, [ebp-0x38] */
