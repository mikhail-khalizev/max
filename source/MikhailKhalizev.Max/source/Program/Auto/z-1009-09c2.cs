...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1009_09c2()
        {
            ...
            ii(0x1009_09d8, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ...
            ii(0x1009_09ec, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1009_09ef, 3);  mov(edx, memd[ds, eax + 39]);         /* mov edx, [eax+0x27] */
            ...
            ii(0x1009_0a02, 3);  mov(memd[ss, ebp - 20], edx);         /* mov [ebp-0x14], edx */
        l_0x1009_0a05:
            ...
            ii(0x1009_0a12, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
        ...
        l_0x1009_0a1f:
            ii(0x1009_0a1f, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1009_0a22, 4);  add(memd[ss, ebp - 20], 2);           /* add dword [ebp-0x14], 0x2 */
        ...
        l_0x1009_0a2f:
            ...
            ii(0x1009_0a36, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1009_0a39, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
