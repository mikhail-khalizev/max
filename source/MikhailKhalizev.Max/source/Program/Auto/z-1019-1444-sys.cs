...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1019_1444()
        {
            ...
            ii(0x1019_148c, 3);  mov(eax, memd[ss, ebp + 28]);         /* mov eax, [ebp+0x1c] */
            ...
            ii(0x1019_14af, 4);  cmp(memd[ss, ebp + 16], 0);           /* cmp dword [ebp+0x10], 0x0 */
            ii(0x1019_14b3, 2);  if(jnz(0x1019_14bb, 6)) goto l_0x1019_14bb;/* jnz 0x101914bb */
            ii(0x1019_14b5, 4);  cmp(memd[ss, ebp + 20], 0);           /* cmp dword [ebp+0x14], 0x0 */
        ...
        l_0x1019_14cf:
            ...
            ii(0x1019_14d7, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1019_14da, 3);  mov(esi, memd[ss, ebp + 12]);         /* mov esi, [ebp+0xc] */
            ...
            ii(0x1019_14e7, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1019_14ea, 3);  add(esi, 2);                          /* add esi, 0x2 */
        l_0x1019_14ed:
            ii(0x1019_14ed, 3);  mov(eax, memd[ss, ebp + 24]);         /* mov eax, [ebp+0x18] */
            ii(0x1019_14f0, 2);  shr(eax, 1);                          /* shr eax, 1 */
            ii(0x1019_14f2, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1019_14f5, 3);  mov(eax, eax);                        /* mov eax, eax */
            ii(0x1019_14f8, 3);  dec(memd[ss, ebp - 20]);              /* dec dword [ebp-0x14] */
        ...
        l_0x1019_1523:
            ...
            ii(0x1019_1526, 3);  dec(memd[ss, ebp + 28]);              /* dec dword [ebp+0x1c] */
