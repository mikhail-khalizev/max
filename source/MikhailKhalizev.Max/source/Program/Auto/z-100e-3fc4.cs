...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100e_3fc4()
        {
            ...
            ii(0x100e_3fec, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x100e_3fef, 5);  call(0x1007_64b8, -0x6_db3c);         /* call 0x100764b8 */
            ii(0x100e_3ff4, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_3ff7, 3);  mov(eax, memd[ds, eax + 36]);         /* mov eax, [eax+0x24] */
            ...
            ii(0x100e_400d, 3);  mov(eax, memd[ds, eax + 96]);         /* mov eax, [eax+0x60] */
        ...
        l_0x100e_4034:
            ...
            ii(0x100e_4064, 3);  mov(eax, memd[ds, eax + 100]);        /* mov eax, [eax+0x64] */
        ...
        l_0x100e_406e:
            ...
            ii(0x100e_4083, 3);  mov(eax, memd[ds, eax + 100]);        /* mov eax, [eax+0x64] */
        ...
        l_0x100e_408b:
            ...
            ii(0x100e_40a0, 3);  mov(eax, memd[ds, eax + 104]);        /* mov eax, [eax+0x68] */
            ii(0x100e_40a3, 5);  call(0x100c_fa7c, -0x1_462c);         /* call 0x100cfa7c */
            ii(0x100e_40a8, 4);  mov(memb[ss, ebp - 8], 0);            /* mov byte [ebp-0x8], 0x0 */
            ii(0x100e_40ac, 4);  mov(memb[ss, ebp - 12], 0);           /* mov byte [ebp-0xc], 0x0 */
            ii(0x100e_40b0, 4);  mov(memb[ss, ebp - 16], 0);           /* mov byte [ebp-0x10], 0x0 */
            ...
            ii(0x100e_40c7, 4);  cmp(memd[ds, eax + 76], 0);           /* cmp dword [eax+0x4c], 0x0 */
            ...
            ii(0x100e_40d9, 3);  mov(eax, memd[ds, eax + 76]);         /* mov eax, [eax+0x4c] */
        ...
        l_0x100e_40e6:
            ...
            ii(0x100e_40e9, 4);  cmp(memd[ds, eax + 76], 0);           /* cmp dword [eax+0x4c], 0x0 */
            ...
            ii(0x100e_4104, 3);  mov(eax, memd[ds, eax + 76]);         /* mov eax, [eax+0x4c] */
        ...
        l_0x100e_410e:
            ii(0x100e_410e, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x100e_4111, 5);  call(0x1007_6bf8, -0x6_d51e);         /* call 0x10076bf8 */
        l_0x100e_4116:
            ii(0x100e_4116, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100e_4118, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x100e_4124, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x100e_413e:
            ii(0x100e_413e, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x100e_4154, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
        l_0x100e_4158:
            ii(0x100e_4158, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x100e_416e, 4);  mov(memb[ss, ebp - 16], 1);           /* mov byte [ebp-0x10], 0x1 */
        l_0x100e_4172:
        ...
        l_0x100e_4174:
            ...
            ii(0x100e_4177, 4);  cmp(memd[ds, eax + 80], 0);           /* cmp dword [eax+0x50], 0x0 */
            ii(0x100e_417b, 2);  if(jnz(0x100e_4189, 0xc)) goto l_0x100e_4189;/* jnz 0x100e4189 */
            ii(0x100e_417d, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100e_417f, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x100e_4189:
            ...
            ii(0x100e_419a, 3);  mov(eax, memd[ds, eax + 80]);         /* mov eax, [eax+0x50] */
            ...
            ii(0x100e_41ad, 3);  mov(dl, memb[ss, ebp - 12]);          /* mov dl, [ebp-0xc] */
            ii(0x100e_41b0, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_41b3, 3);  mov(eax, memd[ds, eax + 84]);         /* mov eax, [eax+0x54] */
            ...
            ii(0x100e_41c6, 3);  mov(dl, memb[ss, ebp - 16]);          /* mov dl, [ebp-0x10] */
            ii(0x100e_41c9, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100e_41cc, 3);  mov(eax, memd[ds, eax + 88]);         /* mov eax, [eax+0x58] */
            ii(0x100e_41cf, 5);  call(0x100c_fa7c, -0x1_4758);         /* call 0x100cfa7c */
            ii(0x100e_41d4, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x100e_41d6, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
