...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x19_5451, 4);  enter(4, 0);                            /* enter 0x4, 0x0 */
            ...
            ii(0x19_5461, 3);  push(memw[ss, bp + 8]);                 /* push word [bp+0x8] */
            ii(0x19_5464, 3);  push(memw[ss, bp + 6]);                 /* push word [bp+0x6] */
            ...
            ii(0x19_5473, 3);  add(sp, 4);                             /* add sp, 0x4 */
            ii(0x19_5476, 3);  mov(memw[ss, bp - 4], ax);              /* mov [bp-0x4], ax */
            ii(0x19_5479, 3);  mov(memw[ss, bp - 2], dx);              /* mov [bp-0x2], dx */
            ii(0x19_547c, 2);  or(dx, ax);                             /* or dx, ax */
            ii(0x19_547e, 2);  if(jnz(0x19_5483, 3)) goto l_0x19_5483; /* jnz 0x5483 */
