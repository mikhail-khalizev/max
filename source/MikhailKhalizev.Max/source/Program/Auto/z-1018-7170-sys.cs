...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void /* sys */ Method_1018_7170()
        {
            ...
            ii(0x1018_7177, 3);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1018_717a, 2);  xor(eax, eax);                        /* xor eax, eax */
            ii(0x1018_717c, 3);  mov(al, memb[ss, ebp + 24]);          /* mov al, [ebp+0x18] */
            ii(0x1018_717f, 3);  cmp(eax, 1);                          /* cmp eax, 0x1 */
            ...
            ii(0x1018_718a, 3);  fcomp(memq[ss, ebp + 16]);            /* fcomp qword [ebp+0x10] */
            ...
            ii(0x1018_7194, 3);  mov(memd[ss, ebp - 24], ecx);         /* mov [ebp-0x18], ecx */
            ii(0x1018_7197, 3);  mov(memd[ss, ebp - 20], ecx);         /* mov [ebp-0x14], ecx */
            ii(0x1018_719a, 2);  jmp(0x1018_71eb, 0x4f); goto l_0x1018_71eb;/* jmp 0x101871eb */
        l_0x1018_719c:
            ii(0x1018_719c, 2);  if(jbe(0x1018_71a5, 7)) goto l_0x1018_71a5;/* jbe 0x101871a5 */
        ...
        l_0x1018_71b3:
            ...
            ii(0x1018_71b5, 3);  fcomp(memq[ss, ebp + 16]);            /* fcomp qword [ebp+0x10] */
            ...
            ii(0x1018_71bf, 3);  mov(memd[ss, ebp - 24], edx);         /* mov [ebp-0x18], edx */
            ii(0x1018_71c2, 3);  mov(memd[ss, ebp - 20], edx);         /* mov [ebp-0x14], edx */
            ii(0x1018_71c5, 2);  jmp(0x1018_71eb, 0x24); goto l_0x1018_71eb;/* jmp 0x101871eb */
        l_0x1018_71c7:
            ii(0x1018_71c7, 2);  fldz();                               /* fldz */
            ii(0x1018_71c9, 3);  fcomp(memq[ss, ebp + 8]);             /* fcomp qword [ebp+0x8] */
            ii(0x1018_71cc, 2);  fnstsw(ax);                           /* fnstsw ax */
            ii(0x1018_71ce, 1);  sahf();                               /* sahf */
            ii(0x1018_71cf, 2);  if(jae(0x1018_71d8, 7)) goto l_0x1018_71d8;/* jae 0x101871d8 */
            ii(0x1018_71d1, 5);  mov(eax, 0x8107);                     /* mov eax, 0x8107 */
            ii(0x1018_71d6, 2);  jmp(0x1018_71dd, 5); goto l_0x1018_71dd;/* jmp 0x101871dd */
        l_0x1018_71d8:
            ii(0x1018_71d8, 5);  mov(eax, 0x1107);                     /* mov eax, 0x1107 */
        l_0x1018_71dd:
            ii(0x1018_71dd, 3);  lea(ebx, memd[ss, ebp + 16]);         /* lea ebx, [ebp+0x10] */
            ii(0x1018_71e0, 3);  lea(edx, memd[ss, ebp + 8]);          /* lea edx, [ebp+0x8] */
            ii(0x1018_71e3, 5);  call(/* sys */ 0x1019_6632, 0xf44a);  /* call 0x10196632 */
            ii(0x1018_71e8, 3);  fstp(memq[ss, ebp - 24]);             /* fstp qword [ebp-0x18] */
        l_0x1018_71eb:
            ii(0x1018_71eb, 3);  fld(memq[ss, ebp - 24]);              /* fld qword [ebp-0x18] */
            ii(0x1018_71ee, 3);  lea(esp, memd[ss, ebp - 16]);         /* lea esp, [ebp-0x10] */
