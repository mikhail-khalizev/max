...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x100f_097b:
            ...
            ii(0x100f_0987, 3);  mov(dl, memb[ds, eax + 38]);          /* mov dl, [eax+0x26] */
        ...
        l_0x100f_09b9:
            ...
            ii(0x100f_09c3, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ...
            ii(0x100f_09da, 3);  lea(edx, memd[ss, ebp - 52]);         /* lea edx, [ebp-0x34] */
            ...
            ii(0x100f_09f6, 3);  lea(eax, memd[ss, ebp - 52]);         /* lea eax, [ebp-0x34] */
            ...
            ii(0x100f_0a0e, 3);  mov(memd[ss, ebp - 68], edx);         /* mov [ebp-0x44], edx */
            ii(0x100f_0a11, 7);  mov(memd[ss, ebp - 64], 0);           /* mov dword [ebp-0x40], 0x0 */
            ii(0x100f_0a18, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_0a1b, 3);  mov(eax, memd[ds, eax + 8]);          /* mov eax, [eax+0x8] */
            ii(0x100f_0a1e, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x100f_0a21, 2);  sub(eax, memd[ds, edx]);              /* sub eax, [edx] */
            ii(0x100f_0a23, 3);  mov(memd[ss, ebp - 60], eax);         /* mov [ebp-0x3c], eax */
            ii(0x100f_0a26, 6);  call_abs(memd[ds, 0x101b_ddf0]);      /* call dword [0x101bddf0] */
            ii(0x100f_0a2c, 3);  mov(memd[ss, ebp - 56], eax);         /* mov [ebp-0x38], eax */
            ii(0x100f_0a2f, 3);  lea(ebx, memd[ss, ebp - 68]);         /* lea ebx, [ebp-0x44] */
            ii(0x100f_0a32, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ...
            ii(0x100f_0a49, 3);  mov(memd[ss, ebp - 72], eax);         /* mov [ebp-0x48], eax */
            ii(0x100f_0a4c, 3);  mov(eax, memd[ss, ebp - 72]);         /* mov eax, [ebp-0x48] */
            ii(0x100f_0a4f, 3);  mov(memd[ss, ebp - 76], eax);         /* mov [ebp-0x4c], eax */
            ii(0x100f_0a52, 4);  cmp(memd[ss, ebp - 76], 0);           /* cmp dword [ebp-0x4c], 0x0 */
            ...
            ii(0x100f_0a6c, 3);  mov(eax, memd[ss, ebp - 60]);         /* mov eax, [ebp-0x3c] */
            ii(0x100f_0a6f, 3);  sub(eax, memd[ss, ebp - 68]);         /* sub eax, [ebp-0x44] */
            ...
            ii(0x100f_0a77, 4);  movsx(eax, memw[ss, ebp - 68]);       /* movsx eax, word [ebp-0x44] */
            ...
            ii(0x100f_0a86, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x100f_0a89, 3);  mov(eax, memd[ss, ebp - 72]);         /* mov eax, [ebp-0x48] */
            ii(0x100f_0a8c, 5);  call(0x100e_af58, -0x5b39);           /* call 0x100eaf58 */
            ii(0x100f_0a91, 3);  mov(memd[ss, ebp - 80], eax);         /* mov [ebp-0x50], eax */
            ii(0x100f_0a94, 3);  mov(eax, memd[ss, ebp - 80]);         /* mov eax, [ebp-0x50] */
            ii(0x100f_0a97, 3);  mov(memd[ss, ebp - 84], eax);         /* mov [ebp-0x54], eax */
            ii(0x100f_0a9a, 2);  jmp(0x100f_0aa2, 6); goto l_0x100f_0aa2;/* jmp 0x100f0aa2 */
        l_0x100f_0a9c:
            ii(0x100f_0a9c, 3);  mov(eax, memd[ss, ebp - 76]);         /* mov eax, [ebp-0x4c] */
            ii(0x100f_0a9f, 3);  mov(memd[ss, ebp - 84], eax);         /* mov [ebp-0x54], eax */
        l_0x100f_0aa2:
            ii(0x100f_0aa2, 3);  mov(eax, memd[ss, ebp - 84]);         /* mov eax, [ebp-0x54] */
            ...
            ii(0x100f_0ab6, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_0ab9, 3);  mov(ecx, memd[ds, eax + 14]);         /* mov ecx, [eax+0xe] */
            ii(0x100f_0abc, 3);  sar(ecx, 0x10);                       /* sar ecx, 0x10 */
            ii(0x100f_0abf, 3);  mov(ebx, memd[ss, ebp - 60]);         /* mov ebx, [ebp-0x3c] */
            ii(0x100f_0ac2, 3);  sub(ebx, memd[ss, ebp - 68]);         /* sub ebx, [ebp-0x44] */
            ii(0x100f_0ac5, 5);  mov(edx, 0x101c_3944);                /* mov edx, 0x101c3944 */
            ii(0x100f_0aca, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_0acd, 3);  mov(eax, memd[ds, eax + 22]);         /* mov eax, [eax+0x16] */
            ii(0x100f_0ad0, 3);  add(eax, memd[ss, ebp - 68]);         /* add eax, [ebp-0x44] */
            ...
            ii(0x100f_0ae3, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_0ae6, 2);  mov(eax, memd[ds, eax]);              /* mov eax, [eax] */
            ii(0x100f_0ae8, 3);  add(memd[ss, ebp - 68], eax);         /* add [ebp-0x44], eax */
            ii(0x100f_0aeb, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_0aee, 3);  mov(eax, memd[ds, eax + 4]);          /* mov eax, [eax+0x4] */
            ii(0x100f_0af1, 3);  add(memd[ss, ebp - 64], eax);         /* add [ebp-0x40], eax */
            ii(0x100f_0af4, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_0af7, 2);  mov(eax, memd[ds, eax]);              /* mov eax, [eax] */
            ii(0x100f_0af9, 3);  add(memd[ss, ebp - 60], eax);         /* add [ebp-0x3c], eax */
            ii(0x100f_0afc, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_0aff, 3);  mov(eax, memd[ds, eax + 4]);          /* mov eax, [eax+0x4] */
            ii(0x100f_0b02, 3);  add(memd[ss, ebp - 56], eax);         /* add [ebp-0x38], eax */
            ii(0x100f_0b05, 3);  lea(edx, memd[ss, ebp - 68]);         /* lea edx, [ebp-0x44] */
            ii(0x100f_0b08, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100f_0b0b, 3);  mov(eax, memd[ds, eax + 18]);         /* mov eax, [eax+0x12] */
