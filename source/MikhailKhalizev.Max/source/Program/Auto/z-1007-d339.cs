...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_d339()
        {
            ...
            ii(0x1007_d350, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1007_d353, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1007_d356, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_d359, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_d35c, 5);  call(0x1007_62cc, -0x7095);           /* call 0x100762cc */
            ii(0x1007_d361, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x1007_d363, 2);  if(jnz(0x1007_d36b, 6)) goto l_0x1007_d36b;/* jnz 0x1007d36b */
            ii(0x1007_d365, 4);  mov(memb[ss, ebp - 12], 0);           /* mov byte [ebp-0xc], 0x0 */
            ii(0x1007_d369, 2);  jmp(0x1007_d38b, 0x20); goto l_0x1007_d38b;/* jmp 0x1007d38b */
        l_0x1007_d36b:
            ii(0x1007_d36b, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_d36e, 5);  call(0x1015_09a6, 0xd_3633);          /* call 0x101509a6 */
            ii(0x1007_d373, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1007_d375, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_d378, 4);  sub(memw[ds, eax + 18], dx);          /* sub [eax+0x12], dx */
            ii(0x1007_d37c, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_d37f, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1007_d382, 5);  call(0x1008_aab4, 0xd72d);            /* call 0x1008aab4 */
            ii(0x1007_d387, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
        l_0x1007_d38b:
            ii(0x1007_d38b, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
