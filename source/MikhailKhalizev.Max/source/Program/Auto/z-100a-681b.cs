...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_681b()
        {
            ...
            ii(0x100a_682d, 6);  sub(esp, 4);                          /* sub esp, 0x4 */
            ii(0x100a_6833, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_6836, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_6839, 4);  cmp(memb[ds, eax + 28], 0);           /* cmp byte [eax+0x1c], 0x0 */
            ii(0x100a_683d, 2);  if(jz(0x100a_685a, 0x1b)) goto l_0x100a_685a;/* jz 0x100a685a */
            ii(0x100a_683f, 5);  mov(edx, 1);                          /* mov edx, 0x1 */
            ii(0x100a_6844, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_6847, 5);  call(0x100a_28ff, -0x3f4d);           /* call 0x100a28ff */
            ii(0x100a_684c, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_684f, 4);  mov(memb[ds, eax + 27], 1);           /* mov byte [eax+0x1b], 0x1 */
            ii(0x100a_6853, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_6856, 4);  mov(memb[ds, eax + 28], 0);           /* mov byte [eax+0x1c], 0x0 */
        l_0x100a_685a:
