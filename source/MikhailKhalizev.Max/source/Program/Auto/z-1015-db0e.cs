...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1015_db0e()
        {
            ...
            ii(0x1015_db26, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1015_db29, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1015_db3e, 3);  cmp(eax, 4);                          /* cmp eax, 0x4 */
            ii(0x1015_db41, 2);  if(jz(0x1015_db5c, 0x19)) goto l_0x1015_db5c;/* jz 0x1015db5c */
            ii(0x1015_db43, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1015_db5a, 2);  if(jnz(0x1015_db65, 9)) goto l_0x1015_db65;/* jnz 0x1015db65 */
        l_0x1015_db5c:
            ii(0x1015_db5c, 4);  mov(memb[ss, ebp - 12], 0);           /* mov byte [ebp-0xc], 0x0 */
            ii(0x1015_db60, 5);  jmp(0x1015_de25, 0x2c0); goto l_0x1015_de25;/* jmp 0x1015de25 */
        l_0x1015_db65:
            ii(0x1015_db65, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1015_db67, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1015_db6b, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ...
            ii(0x1015_db82, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ii(0x1015_db86, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ...
            ii(0x1015_db95, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1015_db98, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1015_db9b, 5);  call(0x1007_60e4, -0xe_7abc);         /* call 0x100760e4 */
            ii(0x1015_dba0, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1015_dba3, 3);  mov(ebx, memd[ss, ebp - 24]);         /* mov ebx, [ebp-0x18] */
            ii(0x1015_dba6, 3);  mov(edx, memd[ss, ebp - 20]);         /* mov edx, [ebp-0x14] */
            ii(0x1015_dba9, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1015_dbac, 5);  call(0x1015_d9b1, -0x200);            /* call 0x1015d9b1 */
            ii(0x1015_dbb1, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x1015_dbb4, 3);  mov(edx, memd[ss, ebp - 20]);         /* mov edx, [ebp-0x14] */
            ii(0x1015_dbb7, 4);  mov(memw[ds, edx + 65], ax);          /* mov [edx+0x41], ax */
            ii(0x1015_dbbb, 3);  mov(eax, memd[ss, ebp - 26]);         /* mov eax, [ebp-0x1a] */
            ii(0x1015_dbbe, 3);  mov(edx, memd[ss, ebp - 20]);         /* mov edx, [ebp-0x14] */
            ii(0x1015_dbc1, 4);  mov(memw[ds, edx + 67], ax);          /* mov [edx+0x43], ax */
            ii(0x1015_dbc5, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1015_dbc8, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ...
            ii(0x1015_dbe1, 3);  cmp(eax, 2);                          /* cmp eax, 0x2 */
            ii(0x1015_dbe4, 2);  if(jnz(0x1015_dbf4, 0xe)) goto l_0x1015_dbf4;/* jnz 0x1015dbf4 */
            ii(0x1015_dbe6, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1015_dbe9, 5);  call(0x1007_623c, -0xe_79b2);         /* call 0x1007623c */
            ii(0x1015_dbee, 4);  cmp(memb[ds, eax + 22], 0);           /* cmp byte [eax+0x16], 0x0 */
            ii(0x1015_dbf2, 2);  if(jnz(0x1015_dbf6, 2)) goto l_0x1015_dbf6;/* jnz 0x1015dbf6 */
        l_0x1015_dbf4:
            ii(0x1015_dbf4, 2);  jmp(0x1015_dc06, 0x10); goto l_0x1015_dc06;/* jmp 0x1015dc06 */
        l_0x1015_dbf6:
            ii(0x1015_dbf6, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1015_dbf9, 3);  mov(al, memb[ds, eax + 80]);          /* mov al, [eax+0x50] */
            ii(0x1015_dbfc, 5);  and(eax, 0xff);                       /* and eax, 0xff */
            ii(0x1015_dc01, 3);  cmp(eax, 1);                          /* cmp eax, 0x1 */
            ii(0x1015_dc04, 2);  if(jz(0x1015_dc08, 2)) goto l_0x1015_dc08;/* jz 0x1015dc08 */
        l_0x1015_dc06:
            ii(0x1015_dc06, 2);  jmp(0x1015_dc19, 0x11); goto l_0x1015_dc19;/* jmp 0x1015dc19 */
        l_0x1015_dc08:
            ii(0x1015_dc08, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1015_dc0b, 4);  mov(memb[ds, eax + 61], 0);           /* mov byte [eax+0x3d], 0x0 */
            ii(0x1015_dc0f, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1015_dc11, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1015_dc14, 5);  call(0x1007_60ac, -0xe_7b6d);         /* call 0x100760ac */
        l_0x1015_dc19:
            ii(0x1015_dc19, 2);  xor(ebx, ebx);                        /* xor ebx, ebx */
            ii(0x1015_dc1b, 5);  mov(edx, 3);                          /* mov edx, 0x3 */
            ii(0x1015_dc20, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1015_dc23, 5);  call(0x1016_3053, 0x542b);            /* call 0x10163053 */
            ii(0x1015_dc28, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1015_dc2b, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1015_dc2d, 3);  mov(dl, memb[ds, eax + 38]);          /* mov dl, [eax+0x26] */
        ...
        l_0x1015_dc79:
            ...
            ii(0x1015_dc7e, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1015_dc81, 5);  call(0x1007_6d98, -0xe_6eee);         /* call 0x10076d98 */
            ii(0x1015_dc86, 2);  test(al, al);                         /* test al, al */
            ii(0x1015_dc88, 2);  if(jz(0x1015_dc92, 8)) goto l_0x1015_dc92;/* jz 0x1015dc92 */
            ii(0x1015_dc8a, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1015_dc8d, 5);  call(0x1010_094d, -0x5_d345);         /* call 0x1010094d */
        l_0x1015_dc92:
            ii(0x1015_dc92, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
            ii(0x1015_dc96, 5);  jmp(0x1015_de25, 0x18a); goto l_0x1015_de25;/* jmp 0x1015de25 */
        l_0x1015_dc9b:
            ii(0x1015_dc9b, 7);  mov(memd[ss, ebp - 16], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1015_dca2, 2);  jmp(0x1015_dcaa, 6); goto l_0x1015_dcaa;/* jmp 0x1015dcaa */
        l_0x1015_dca4:
            ii(0x1015_dca4, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1015_dca7, 3);  inc(memd[ss, ebp - 16]);              /* inc dword [ebp-0x10] */
        l_0x1015_dcaa:
            ii(0x1015_dcaa, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ii(0x1015_dcae, 3);  cmp(eax, 4);                          /* cmp eax, 0x4 */
            ii(0x1015_dcb1, 6);  if(jge(0x1015_de21, 0x16a)) goto l_0x1015_de21;/* jge 0x1015de21 */
            ii(0x1015_dcb7, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1015_dcba, 4);  cmp(ax, memw[ss, ebp - 4]);           /* cmp ax, [ebp-0x4] */
            ii(0x1015_dcbe, 6);  if(jz(0x1015_de1c, 0x158)) goto l_0x1015_de1c;/* jz 0x1015de1c */
            ii(0x1015_dcc4, 4);  or(memb[ss, ebp - 8], 1);             /* or byte [ebp-0x8], 0x1 */
            ii(0x1015_dcc8, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x1015_dccb, 5);  call(0x1007_64fc, -0xe_77d4);         /* call 0x100764fc */
            ii(0x1015_dcd0, 3);  mov(memd[ss, ebp - 36], eax);         /* mov [ebp-0x24], eax */
            ii(0x1015_dcd3, 4);  and(memb[ss, ebp - 8], -2 /* 0xfe */);/* and byte [ebp-0x8], 0xfe */
            ii(0x1015_dcd7, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x1015_dcec, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x1015_dcef, 5);  call(0x1007_643c, -0xe_78b8);         /* call 0x1007643c */
            ii(0x1015_dcf4, 2);  jmp(0x1015_dcfe, 8); goto l_0x1015_dcfe;/* jmp 0x1015dcfe */
        l_0x1015_dcf6:
            ii(0x1015_dcf6, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x1015_dcf9, 5);  call(0x1007_6bf8, -0xe_7106);         /* call 0x10076bf8 */
        l_0x1015_dcfe:
            ii(0x1015_dcfe, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1015_dd00, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ...
            ii(0x1015_dd0c, 4);  movsx(edx, memw[ss, ebp - 4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x1015_dd10, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ...
            ii(0x1015_dd21, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x1015_dd24, 5);  call(0x1007_6408, -0xe_7921);         /* call 0x10076408 */
            ii(0x1015_dd29, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1015_dd2b, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
            ...
            ii(0x1015_dd40, 2);  if(jnz(0x1015_dd44, 2)) goto l_0x1015_dd44;/* jnz 0x1015dd44 */
        l_0x1015_dd42:
            ii(0x1015_dd42, 2);  jmp(0x1015_dd57, 0x13); goto l_0x1015_dd57;/* jmp 0x1015dd57 */
        l_0x1015_dd44:
            ii(0x1015_dd44, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
            ii(0x1015_dd48, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1015_dd4a, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
        ...
        l_0x1015_dd59:
            ii(0x1015_dd59, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x1015_dd6e, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x1015_dd71, 5);  call(0x1007_643c, -0xe_793a);         /* call 0x1007643c */
            ii(0x1015_dd76, 2);  jmp(0x1015_dd80, 8); goto l_0x1015_dd80;/* jmp 0x1015dd80 */
        l_0x1015_dd78:
            ii(0x1015_dd78, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x1015_dd7b, 5);  call(0x1007_6bf8, -0xe_7188);         /* call 0x10076bf8 */
        l_0x1015_dd80:
            ii(0x1015_dd80, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1015_dd82, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ...
            ii(0x1015_dd92, 4);  movsx(edx, memw[ss, ebp - 4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x1015_dd96, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ...
            ii(0x1015_ddac, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x1015_ddaf, 5);  call(0x1007_6408, -0xe_79ac);         /* call 0x10076408 */
            ii(0x1015_ddb4, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1015_ddb6, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
        ...
        l_0x1015_dde1:
            ...
            ii(0x1015_dde6, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x1015_dde9, 5);  call(0x1007_6408, -0xe_79e6);         /* call 0x10076408 */
            ii(0x1015_ddee, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1015_ddf0, 4);  movsx(eax, memw[ss, ebp - 4]);        /* movsx eax, word [ebp-0x4] */
        ...
        l_0x1015_ddfd:
            ii(0x1015_ddfd, 4);  mov(memb[ss, ebp - 12], 1);           /* mov byte [ebp-0xc], 0x1 */
            ii(0x1015_de01, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1015_de03, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
        ...
        l_0x1015_de12:
            ...
            ii(0x1015_de14, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
        ...
        l_0x1015_de21:
            ii(0x1015_de21, 4);  mov(memb[ss, ebp - 12], 0);           /* mov byte [ebp-0xc], 0x0 */
        l_0x1015_de25:
            ii(0x1015_de25, 3);  mov(al, memb[ss, ebp - 12]);          /* mov al, [ebp-0xc] */
