...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_b6c3()
        {
            ...
            ii(0x1011_b6d9, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1011_b6dc, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1011_b6df, 3);  mov(memd[ss, ebp - 8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1011_b6e2, 7);  mov(memd[ss, ebp - 16], 0);           /* mov dword [ebp-0x10], 0x0 */
            ii(0x1011_b6e9, 2);  jmp(0x1011_b6f1, 6); goto l_0x1011_b6f1;/* jmp 0x1011b6f1 */
        l_0x1011_b6eb:
            ii(0x1011_b6eb, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1011_b6ee, 3);  inc(memd[ss, ebp - 16]);              /* inc dword [ebp-0x10] */
        l_0x1011_b6f1:
            ii(0x1011_b6f1, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x1011_b6fa, 4);  movsx(eax, memw[ss, ebp - 16]);       /* movsx eax, word [ebp-0x10] */
            ...
            ii(0x1011_b705, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
