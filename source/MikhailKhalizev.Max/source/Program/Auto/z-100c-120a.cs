...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_120a()
        {
            ...
            ii(0x100c_1220, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x100c_1223, 3);  mov(memd[ss, ebp - 8], edx);          /* mov [ebp-0x8], edx */
            ii(0x100c_1226, 3);  mov(memd[ss, ebp - 4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x100c_1229, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100c_122c, 3);  mov(al, memb[ds, eax + 84]);          /* mov al, [eax+0x54] */
            ...
            ii(0x100c_1238, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100c_123b, 4);  cmp(memb[ds, eax + 61], 0x1a);        /* cmp byte [eax+0x3d], 0x1a */
        ...
        l_0x100c_1243:
            ii(0x100c_1243, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100c_1246, 4);  cmp(memb[ds, eax + 61], 0x10);        /* cmp byte [eax+0x3d], 0x10 */
        ...
        l_0x100c_124e:
            ii(0x100c_124e, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x100c_1251, 3);  mov(al, memb[ds, eax + 77]);          /* mov al, [eax+0x4d] */
        ...
        l_0x100c_125f:
            ...
            ii(0x100c_1263, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
        ...
        l_0x100c_1275:
            ii(0x100c_1275, 4);  mov(memb[ss, ebp - 16], 0);           /* mov byte [ebp-0x10], 0x0 */
            ii(0x100c_1279, 2);  jmp(0x100c_12c3, 0x48); goto l_0x100c_12c3;/* jmp 0x100c12c3 */
        l_0x100c_127b:
            ii(0x100c_127b, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x100c_1285, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
        ...
        l_0x100c_128f:
            ii(0x100c_128f, 4);  mov(memb[ss, ebp - 16], 0);           /* mov byte [ebp-0x10], 0x0 */
            ii(0x100c_1293, 2);  jmp(0x100c_12c3, 0x2e); goto l_0x100c_12c3;/* jmp 0x100c12c3 */
        l_0x100c_1295:
            ii(0x100c_1295, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x100c_129f, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
        ...
        l_0x100c_12a9:
            ...
            ii(0x100c_12ad, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ...
            ii(0x100c_12b9, 4);  mov(memb[ss, ebp - 16], 0);           /* mov byte [ebp-0x10], 0x0 */
            ii(0x100c_12bd, 2);  jmp(0x100c_12c3, 4); goto l_0x100c_12c3;/* jmp 0x100c12c3 */
        l_0x100c_12bf:
            ii(0x100c_12bf, 4);  mov(memb[ss, ebp - 16], 1);           /* mov byte [ebp-0x10], 0x1 */
        l_0x100c_12c3:
            ii(0x100c_12c3, 3);  mov(al, memb[ss, ebp - 16]);          /* mov al, [ebp-0x10] */
