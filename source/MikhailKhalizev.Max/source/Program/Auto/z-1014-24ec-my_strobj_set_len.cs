...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void my_strobj_set_len()
        {
            ...
            ii(0x1014_24fd, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1014_2503, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1014_2506, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_2509, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1014_250c, 3);  mov(edx, memd[ss, ebp - 8]);          /* mov edx, [ebp-0x8] */
            ii(0x1014_250f, 4);  mov(memw[ds, edx + 6], ax);           /* mov [edx+0x6], ax */
