...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0019_1767()
        {
            ...
            ii(0x19_1770, 3);  push(memw[ss, bp + 8]);                 /* push word [bp+0x8] */
            ii(0x19_1773, 3);  push(memw[ss, bp + 6]);                 /* push word [bp+0x6] */
            ii(0x19_1776, 4);  call_far_ind(memw[ds, 0x38c0]);         /* call far word [0x38c0] */
            ii(0x19_177a, 1);  pop(ds);                                /* pop ds */
            ii(0x19_177b, 1);  leave();                                /* leave */
            ii(0x19_177c, 3);  retf(4);                                /* retf 0x4 */
        }
    }
}
