...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_851a()
        {
            ...
            ii(0x8520, 3);  lea(ax, memw[ss, bp - 22]);                /* lea ax, [bp-0x16] */
            ...
            ii(0x852b, 3);  add(sp, 8);                                /* add sp, 0x8 */
            ii(0x852e, 3);  push(0xef4);                               /* push 0xef4 */
            ii(0x8531, 3);  lea(ax, memw[ss, bp - 22]);                /* lea ax, [bp-0x16] */
            ...
            ii(0x853e, 2);  push(4);                                   /* push 0x4 */
            ii(0x8540, 3);  lea(ax, memw[ss, bp - 4]);                 /* lea ax, [bp-0x4] */
            ...
            ii(0x854b, 3);  add(sp, 8);                                /* add sp, 0x8 */
            ii(0x854e, 3);  mov(ax, memw[ss, bp - 4]);                 /* mov ax, [bp-0x4] */
            ii(0x8551, 3);  sub(ax, memw[ss, bp - 2]);                 /* sub ax, [bp-0x2] */
            ii(0x8554, 3);  add(ah, 4);                                /* add ah, 0x4 */
            ii(0x8557, 2);  sub(dx, dx);                               /* sub dx, dx */
            ii(0x8559, 3);  add(ax, 1);                                /* add ax, 0x1 */
            ii(0x855c, 2);  adc(dx, dx);                               /* adc dx, dx */
            ii(0x855e, 2);  mov(cl, 6);                                /* mov cl, 0x6 */
            ...
            ii(0x856a, 3);  mov(ax, 1);                                /* mov ax, 0x1 */
