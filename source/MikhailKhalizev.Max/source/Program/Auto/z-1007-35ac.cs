...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1007_35ac()
        {
            ...
            ii(0x1007_35cb, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1007_35ce, 5);  call(0x1007_64fc, 0x2f29);            /* call 0x100764fc */
            ii(0x1007_35d3, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ...
            ii(0x1007_35e6, 6);  mov(memw[ds, eax + 10], 0);           /* mov word [eax+0xa], 0x0 */
            ii(0x1007_35ec, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_35ef, 6);  mov(memw[ds, eax + 12], 0);           /* mov word [eax+0xc], 0x0 */
            ii(0x1007_35f5, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_35f8, 6);  mov(memw[ds, eax + 14], 0);           /* mov word [eax+0xe], 0x0 */
            ii(0x1007_35fe, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1007_3601, 6);  mov(memw[ds, eax + 16], 0);           /* mov word [eax+0x10], 0x0 */
            ...
            ii(0x1007_3613, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
        ...
        l_0x1007_361d:
            ii(0x1007_361d, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1007_3620, 5);  call(0x1007_6bf8, 0x35d3);            /* call 0x10076bf8 */
        l_0x1007_3625:
            ii(0x1007_3625, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_3627, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x1007_3637, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ...
            ii(0x1007_3649, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1007_364c, 5);  call(0x1007_20b1, -0x15a0);           /* call 0x100720b1 */
            ii(0x1007_3651, 3);  lea(eax, memd[ss, ebp - 40]);         /* lea eax, [ebp-0x28] */
            ...
            ii(0x1007_3662, 3);  lea(edx, memd[ss, ebp - 28]);         /* lea edx, [ebp-0x1c] */
            ii(0x1007_3665, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1007_3668, 5);  call(0x1007_6408, 0x2d9b);            /* call 0x10076408 */
            ii(0x1007_366d, 5);  call(0x1007_2388, -0x12ea);           /* call 0x10072388 */
            ii(0x1007_3672, 3);  lea(edx, memd[ss, ebp - 40]);         /* lea edx, [ebp-0x28] */
            ii(0x1007_3675, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
            ii(0x1007_3678, 5);  call(0x1007_6408, 0x2d8b);            /* call 0x10076408 */
            ii(0x1007_367d, 5);  call(0x1007_21b6, -0x14cc);           /* call 0x100721b6 */
            ii(0x1007_3682, 3);  lea(ebx, memd[ss, ebp - 28]);         /* lea ebx, [ebp-0x1c] */
            ...
            ii(0x1007_368e, 3);  mov(eax, memd[ss, ebp - 26]);         /* mov eax, [ebp-0x1a] */
            ii(0x1007_3691, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_3694, 4);  add(memw[ds, edx + 8], ax);           /* add [edx+0x8], ax */
            ii(0x1007_3698, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x1007_369b, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_369e, 4);  add(memw[ds, edx + 10], ax);          /* add [edx+0xa], ax */
            ii(0x1007_36a2, 3);  mov(eax, memd[ss, ebp - 28]);         /* mov eax, [ebp-0x1c] */
            ii(0x1007_36a5, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_36a8, 4);  add(memw[ds, edx + 12], ax);          /* add [edx+0xc], ax */
            ii(0x1007_36ac, 3);  mov(eax, memd[ss, ebp - 22]);         /* mov eax, [ebp-0x16] */
            ii(0x1007_36af, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_36b2, 4);  add(memw[ds, edx + 14], ax);          /* add [edx+0xe], ax */
            ii(0x1007_36b6, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1007_36b9, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1007_36bc, 4);  add(memw[ds, edx + 16], ax);          /* add [edx+0x10], ax */
        l_0x1007_36c0:
            ii(0x1007_36c0, 5);  jmp(0x1007_361d, -0xa8); goto l_0x1007_361d;/* jmp 0x1007361d */
        l_0x1007_36c5:
            ii(0x1007_36c5, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1007_36c7, 3);  lea(eax, memd[ss, ebp - 16]);         /* lea eax, [ebp-0x10] */
