...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_5972()
        {
            ...
            ii(0x5982, 2);  mov(cl, 4);                                /* mov cl, 0x4 */
            ii(0x5984, 2);  shl(ax, cl);                               /* shl ax, cl */
            ii(0x5986, 1);  dec(ax);                                   /* dec ax */
            ii(0x5987, 4);  mov(memw[ss, 0xce6], ax);                  /* mov [ss:0xce6], ax */
            ii(0x598b, 5);  mov(memw[ss, 0xcdc], sp);                  /* mov [ss:0xcdc], sp */
            ii(0x5990, 3);  mov(si, 0x10ca);                           /* mov si, 0x10ca */
            ii(0x5993, 1);  inc(si);                                   /* inc si */
            ii(0x5994, 4);  mov(memw[ds, 2], si);                      /* mov [0x2], si */
            ...
            ii(0x59a2, 5);  mov(memw[ss, 0xcec], ds);                  /* mov [ss:0xcec], ds */
            ii(0x59a7, 1);  push(ss);                                  /* push ss */
            ii(0x59a8, 1);  pop(es);                                   /* pop es */
            ii(0x59a9, 1);  cld();                                     /* cld */
            ...
            ii(0x59b4, 2);  rep(() => stosb());                        /* rep stosb */
            ii(0x59b6, 1);  push(ss);                                  /* push ss */
            ii(0x59b7, 1);  pop(ds);                                   /* pop ds */
            ii(0x59b8, 2);  mov(ah, 0x30);                             /* mov ah, 0x30 */
            ii(0x59ba, 2);  @int(0x21);                                /* int 0x21 */
            ii(0x59bc, 3);  mov(memw[ds, 0xcee], ax);                  /* mov [0xcee], ax */
            ii(0x59bf, 3);  mov(bx, 4);                                /* mov bx, 0x4 */
        l_0x59c2:
        ...
        l_0x59d3:
            ...
            ii(0x59d6, 3);  call(0x5a50, 0x77);                        /* call 0x5a50 */
            ii(0x59d9, 2);  xor(bp, bp);                               /* xor bp, bp */
            ii(0x59db, 1);  push(ss);                                  /* push ss */
            ii(0x59dc, 1);  pop(ds);                                   /* pop ds */
            ii(0x59dd, 4);  push(memw[ds, 0xcf6]);                     /* push word [0xcf6] */
            ii(0x59e1, 4);  push(memw[ds, 0xcf4]);                     /* push word [0xcf4] */
            ii(0x59e5, 4);  push(memw[ds, 0xcf2]);                     /* push word [0xcf2] */
            ii(0x59e9, 3);  call(0x638c, 0x9a0);                       /* call 0x638c */
            ii(0x59ec, 1);  ret();                                     /* ret */
        }
    }
}
