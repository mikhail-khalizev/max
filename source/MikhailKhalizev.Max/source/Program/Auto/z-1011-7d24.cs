...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_7d24()
        {
            ...
            ii(0x1011_7d36, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x1011_7d3c, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1011_7d3f, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_7d42, 5);  call(0x1007_6c30, -0xa_1117);         /* call 0x10076c30 */
            ii(0x1011_7d47, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x1011_7d4a, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
