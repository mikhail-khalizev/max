...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        l_0x1011_3877:
            ...
            ii(0x1011_387a, 4);  cmp(memd[ds, eax + 90], 0);           /* cmp dword [eax+0x5a], 0x0 */
            ...
            ii(0x1011_388c, 3);  mov(eax, memd[ds, eax + 90]);         /* mov eax, [eax+0x5a] */
            ii(0x1011_388f, 5);  call(0x100c_fb06, -0x4_3d8e);         /* call 0x100cfb06 */
        l_0x1011_3894:
            ii(0x1011_3894, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_3897, 4);  cmp(memd[ds, eax + 94], 0);           /* cmp dword [eax+0x5e], 0x0 */
            ...
            ii(0x1011_38a9, 3);  mov(eax, memd[ds, eax + 94]);         /* mov eax, [eax+0x5e] */
        ...
        l_0x1011_38bd:
            ...
            ii(0x1011_38d7, 6);  mov(eax, memd[ds, eax + 1437]);       /* mov eax, [eax+0x59d] */
        ...
        l_0x1011_38e4:
            ...
            ii(0x1011_38e7, 7);  mov(memb[ds, eax + 944], 0);          /* mov byte [eax+0x3b0], 0x0 */
            ii(0x1011_38ee, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_38f1, 7);  mov(memb[ds, eax + 1094], 0);         /* mov byte [eax+0x446], 0x0 */
            ii(0x1011_38f8, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_38fb, 9);  mov(memw[ds, eax + 1493], 0xffff);    /* mov word [eax+0x5d5], 0xffff */
