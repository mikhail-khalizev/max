...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100c_b000()
        {
            ...
            ii(0x100c_b012, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x100c_b018, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100c_b01b, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100c_b01e, 5);  call(0x1007_6b58, -0x5_44cb);         /* call 0x10076b58 */
            ii(0x100c_b023, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100c_b026, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
