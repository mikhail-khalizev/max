...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_0000_6fd2()
        {
            ...
            ii(0x6fdc, 3);  mov(ax, memw[ss, bp + 4]);                 /* mov ax, [bp+0x4] */
            ii(0x6fdf, 2);  push(8);                                   /* push 0x8 */
            ii(0x6fe1, 1);  pop(es);                                   /* pop es */
            ii(0x6fe2, 4);  mov(memw[es, 0x62], ax);                   /* mov [es:0x62], ax */
            ii(0x6fe6, 3);  mov(ax, memw[ss, bp + 6]);                 /* mov ax, [bp+0x6] */
            ...
            ii(0x6ff5, 3);  mov(si, memw[ss, bp + 8]);                 /* mov si, [bp+0x8] */
            ii(0x6ff8, 3);  mov(cx, memw[ss, bp + 10]);                /* mov cx, [bp+0xa] */
            ii(0x6ffb, 1);  cld();                                     /* cld */
            ii(0x6ffc, 2);  shr(cx, 1);                                /* shr cx, 1 */
            ii(0x6ffe, 2);  rep(() => movsw());                        /* rep movsw */
            ii(0x7000, 2);  rcl(cx, 1);                                /* rcl cx, 1 */
            ii(0x7002, 2);  rep(() => movsb());                        /* rep movsb */
            ii(0x7004, 2);  push(8);                                   /* push 0x8 */
