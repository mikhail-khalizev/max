...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        {
            ii(0x8728, 5);  cmp(memb[ds, 0xdfe], 1);                   /* cmp byte [0xdfe], 0x1 */
            ...
            ii(0x874d, 3);  mov(ax, 8);                                /* mov ax, 0x8 */
            ii(0x8750, 2);  mov(ds, ax);                               /* mov ds, ax */
            ii(0x8752, 4);  mov(memb[ds, bx + 5], 0x89);               /* mov byte [bx+0x5], 0x89 */
        ...
        l_0x8765:
            ii(0x8765, 3);  jmp_func(0x60e7, -0x2681);                 /* jmp 0x60e7 */
        }
    }
}
