...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1013_f4b0()
        {
            ...
            ii(0x1013_f4c5, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1013_f4c8, 3);  mov(memd[ss, ebp - 8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1013_f4cb, 3);  mov(memd[ss, ebp - 12], ebx);         /* mov [ebp-0xc], ebx */
            ...
            ii(0x1013_f4f8, 3);  add(eax, memd[ss, ebp - 16]);         /* add eax, [ebp-0x10] */
            ii(0x1013_f4fb, 3);  add(eax, 0x18);                       /* add eax, 0x18 */
            ii(0x1013_f4fe, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1013_f501, 5);  cmp(memw[ss, ebp + 16], 0);           /* cmp word [ebp+0x10], 0x0 */
            ...
            ii(0x1013_f513, 4);  movsx(edx, memw[ss, ebp + 16]);       /* movsx edx, word [ebp+0x10] */
            ii(0x1013_f517, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
        ...
        l_0x1013_f51f:
            ...
            ii(0x1013_f52d, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x1013_f530, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
            ii(0x1013_f533, 3);  add(eax, 4);                          /* add eax, 0x4 */
            ii(0x1013_f536, 6);  call_abs(memd[ds, 0x101b_ddec]);      /* call dword [0x101bddec] */
            ii(0x1013_f53c, 4);  cmp(memb[ss, ebp + 20], 0);           /* cmp byte [ebp+0x14], 0x0 */
            ...
            ii(0x1013_f55c, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
