...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1019_cca5()
        {
            ...
            ii(0x1019_ccab, 3);  mov(eax, memd[ss, ebp + 16]);         /* mov eax, [ebp+0x10] */
            ii(0x1019_ccae, 3);  and(eax, 0x1f);                       /* and eax, 0x1f */
            ii(0x1019_ccb1, 3);  cmp(eax, 8);                          /* cmp eax, 0x8 */
            ii(0x1019_ccb4, 2);  if(jz(0x1019_ccce, 0x18)) goto l_0x1019_ccce;/* jz 0x1019ccce */
            ii(0x1019_ccb6, 3);  mov(edx, memd[ss, ebp + 12]);         /* mov edx, [ebp+0xc] */
            ii(0x1019_ccb9, 3);  mov(ebx, memd[ss, ebp + 8]);          /* mov ebx, [ebp+0x8] */
            ...
            ii(0x1019_ccc6, 2);  if(jnz(0x1019_ccce, 6)) goto l_0x1019_ccce;/* jnz 0x1019ccce */
            ii(0x1019_ccc8, 4);  or(ax, 0x1080);                       /* or ax, 0x1080 */
            ii(0x1019_cccc, 2);  jmp(0x1019_ccd2, 4); goto l_0x1019_ccd2;/* jmp 0x1019ccd2 */
        l_0x1019_ccce:
            ii(0x1019_ccce, 4);  or(ax, 0x1040);                       /* or ax, 0x1040 */
        l_0x1019_ccd2:
            ii(0x1019_ccd2, 3);  lea(edx, memd[ss, ebp + 8]);          /* lea edx, [ebp+0x8] */
