...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_eb48()
        {
            ...
            ii(0x1014_eb5e, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1014_eb61, 3);  mov(memd[ss, ebp - 8], edx);          /* mov [ebp-0x8], edx */
            ii(0x1014_eb64, 3);  mov(memd[ss, ebp - 4], ebx);          /* mov [ebp-0x4], ebx */
            ii(0x1014_eb67, 5);  mov(ecx, 1);                          /* mov ecx, 0x1 */
            ii(0x1014_eb6c, 4);  movsx(ebx, memw[ss, ebp - 4]);        /* movsx ebx, word [ebp-0x4] */
            ii(0x1014_eb70, 4);  movsx(edx, memw[ss, ebp - 8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1014_eb74, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_eb77, 5);  call(0x1007_4c30, -0xd_9f4c);         /* call 0x10074c30 */
            ii(0x1014_eb7c, 3);  lea(ebx, memd[ss, ebp - 20]);         /* lea ebx, [ebp-0x14] */
            ...
            ii(0x1014_eb88, 7);  mov(memd[ss, ebp - 24], 0);           /* mov dword [ebp-0x18], 0x0 */
            ii(0x1014_eb8f, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1014_eb91, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1014_eba1, 4);  movsx(ebx, memw[ss, ebp - 4]);        /* movsx ebx, word [ebp-0x4] */
            ii(0x1014_eba5, 4);  movsx(edx, memw[ss, ebp - 8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1014_eba9, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_ebac, 5);  call(0x1007_4f1e, -0xd_9c93);         /* call 0x10074f1e */
            ii(0x1014_ebb1, 3);  lea(ebx, memd[ss, ebp - 20]);         /* lea ebx, [ebp-0x14] */
            ...
            ii(0x1014_ebbf, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1014_ebcb, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ii(0x1014_ebce, 5);  call(0x1007_6574, -0xd_865f);         /* call 0x10076574 */
            ii(0x1014_ebd3, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1014_ebd5, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_ebd8, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ii(0x1014_ebdb, 5);  and(eax, 0xff);                       /* and eax, 0xff */
            ii(0x1014_ebe0, 2);  add(edx, eax);                        /* add edx, eax */
            ii(0x1014_ebe2, 7);  mov(memb[ds, edx + 171], 1);          /* mov byte [edx+0xab], 0x1 */
        ...
        l_0x1014_ebee:
            ...
            ii(0x1014_ebf3, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_ebf6, 3);  mov(al, memb[ds, eax + 38]);          /* mov al, [eax+0x26] */
            ii(0x1014_ebf9, 2);  xor(ah, ah);                          /* xor ah, ah */
            ii(0x1014_ebfb, 3);  movsx(ebx, ax);                       /* movsx ebx, ax */
            ii(0x1014_ebfe, 4);  movsx(edx, memw[ss, ebp - 4]);        /* movsx edx, word [ebp-0x4] */
            ii(0x1014_ec02, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1014_ec06, 5);  call(0x1007_388b, -0xd_b380);         /* call 0x1007388b */
            ii(0x1014_ec0b, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1014_ec0e, 4);  cmp(memd[ss, ebp - 24], 0);           /* cmp dword [ebp-0x18], 0x0 */
            ii(0x1014_ec12, 2);  if(jnz(0x1014_ec1e, 0xa)) goto l_0x1014_ec1e;/* jnz 0x1014ec1e */
            ii(0x1014_ec14, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_ec17, 5);  cmp(memw[ds, eax + 8], 0x23);         /* cmp word [eax+0x8], 0x23 */
            ii(0x1014_ec1c, 2);  if(jnz(0x1014_ec20, 2)) goto l_0x1014_ec20;/* jnz 0x1014ec20 */
        l_0x1014_ec1e:
            ii(0x1014_ec1e, 2);  jmp(0x1014_ec2a, 0xa); goto l_0x1014_ec2a;/* jmp 0x1014ec2a */
        l_0x1014_ec20:
            ii(0x1014_ec20, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_ec23, 5);  cmp(memw[ds, eax + 8], 0x37);         /* cmp word [eax+0x8], 0x37 */
            ii(0x1014_ec28, 2);  if(jnz(0x1014_ec2c, 2)) goto l_0x1014_ec2c;/* jnz 0x1014ec2c */
        l_0x1014_ec2a:
            ii(0x1014_ec2a, 2);  jmp(0x1014_ec36, 0xa); goto l_0x1014_ec36;/* jmp 0x1014ec36 */
        l_0x1014_ec2c:
            ii(0x1014_ec2c, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_ec2f, 5);  cmp(memw[ds, eax + 8], 0x44);         /* cmp word [eax+0x8], 0x44 */
            ii(0x1014_ec34, 2);  if(jnz(0x1014_ec3b, 5)) goto l_0x1014_ec3b;/* jnz 0x1014ec3b */
        l_0x1014_ec36:
        ...
        l_0x1014_ec3b:
            ...
            ii(0x1014_ec98, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
        ...
        l_0x1014_ecae:
            ...
            ii(0x1014_ecbc, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
        ...
        l_0x1014_ecd0:
            ...
            ii(0x1014_ecd2, 3);  lea(eax, memd[ss, ebp - 28]);         /* lea eax, [ebp-0x1c] */
            ii(0x1014_ecd5, 5);  call(0x1007_5f2c, -0xd_8dae);         /* call 0x10075f2c */
        l_0x1014_ecda:
            ii(0x1014_ecda, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_ecdd, 4);  test(memb[ds, eax + 18], 0x20);       /* test byte [eax+0x12], 0x20 */
            ii(0x1014_ece1, 2);  if(jz(0x1014_ecfd, 0x1a)) goto l_0x1014_ecfd;/* jz 0x1014ecfd */
            ii(0x1014_ece3, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x1014_ece6, 3);  mov(dl, memb[ds, edx + 41]);          /* mov dl, [edx+0x29] */
            ...
            ii(0x1014_ecf6, 2);  sar(eax, 1);                          /* sar eax, 1 */
            ii(0x1014_ecf8, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1014_ecfb, 2);  jmp(0x1014_ed21, 0x24); goto l_0x1014_ed21;/* jmp 0x1014ed21 */
        l_0x1014_ecfd:
            ii(0x1014_ecfd, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_ed00, 3);  mov(edx, memd[ss, ebp - 4]);          /* mov edx, [ebp-0x4] */
            ii(0x1014_ed03, 4);  sub(dx, memw[ds, eax + 28]);          /* sub dx, [eax+0x1c] */
            ii(0x1014_ed07, 2);  mov(eax, edx);                        /* mov eax, edx */
            ii(0x1014_ed09, 3);  movsx(edx, ax);                       /* movsx edx, ax */
            ii(0x1014_ed0c, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_ed0f, 3);  mov(ebx, memd[ss, ebp - 8]);          /* mov ebx, [ebp-0x8] */
            ii(0x1014_ed12, 4);  sub(bx, memw[ds, eax + 26]);          /* sub bx, [eax+0x1a] */
            ...
            ii(0x1014_ed1e, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
        l_0x1014_ed21:
            ii(0x1014_ed21, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_ed24, 5);  call(0x1014_1698, -0xd691);           /* call 0x10141698 */
            ii(0x1014_ed29, 5);  cmp(memw[ds, eax + 29], 0);           /* cmp word [eax+0x1d], 0x0 */
            ...
            ii(0x1014_ed35, 4);  movsx(ebx, memw[ss, ebp - 4]);        /* movsx ebx, word [ebp-0x4] */
            ii(0x1014_ed39, 4);  movsx(edx, memw[ss, ebp - 8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1014_ed3d, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_ed40, 5);  call(0x1014_e9e0, -0x365);            /* call 0x1014e9e0 */
            ii(0x1014_ed45, 5);  mov(ecx, 0x101c_819c);                /* mov ecx, 0x101c819c */
            ii(0x1014_ed4a, 4);  movsx(ebx, memw[ss, ebp - 4]);        /* movsx ebx, word [ebp-0x4] */
            ii(0x1014_ed4e, 4);  movsx(edx, memw[ss, ebp - 8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1014_ed52, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_ed55, 5);  call(0x1014_e9e0, -0x37a);            /* call 0x1014e9e0 */
            ii(0x1014_ed5a, 5);  mov(ecx, 0x101c_8184);                /* mov ecx, 0x101c8184 */
            ii(0x1014_ed5f, 4);  movsx(ebx, memw[ss, ebp - 4]);        /* movsx ebx, word [ebp-0x4] */
            ii(0x1014_ed63, 4);  movsx(edx, memw[ss, ebp - 8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1014_ed67, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
        ...
        l_0x1014_ed71:
            ...
            ii(0x1014_ed73, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
            ...
            ii(0x1014_ed7f, 4);  movsx(ecx, memw[ss, ebp - 16]);       /* movsx ecx, word [ebp-0x10] */
            ii(0x1014_ed83, 2);  xor(ebx, ebx);                        /* xor ebx, ebx */
            ii(0x1014_ed85, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x1014_ed88, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
        ...
        l_0x1014_ed97:
            ii(0x1014_ed97, 4);  cmp(memd[ss, ebp - 24], 0);           /* cmp dword [ebp-0x18], 0x0 */
            ii(0x1014_ed9b, 2);  if(jz(0x1014_edc0, 0x23)) goto l_0x1014_edc0;/* jz 0x1014edc0 */
            ii(0x1014_ed9d, 4);  movsx(ebx, memw[ss, ebp - 4]);        /* movsx ebx, word [ebp-0x4] */
            ii(0x1014_eda1, 4);  movsx(edx, memw[ss, ebp - 8]);        /* movsx edx, word [ebp-0x8] */
            ii(0x1014_eda5, 3);  lea(eax, memd[ss, ebp - 32]);         /* lea eax, [ebp-0x20] */
            ii(0x1014_eda8, 5);  call(0x1007_6aac, -0xd_8301);         /* call 0x10076aac */
            ii(0x1014_edad, 3);  mov(edx, memd[ss, ebp - 24]);         /* mov edx, [ebp-0x18] */
            ii(0x1014_edb0, 3);  mov(ecx, memd[ss, ebp - 12]);         /* mov ecx, [ebp-0xc] */
            ...
            ii(0x1014_edbe, 2);  if(jnz(0x1014_edc2, 2)) goto l_0x1014_edc2;/* jnz 0x1014edc2 */
        l_0x1014_edc0:
            ii(0x1014_edc0, 2);  jmp(0x1014_edd3, 0x11); goto l_0x1014_edd3;/* jmp 0x1014edd3 */
        l_0x1014_edc2:
            ii(0x1014_edc2, 4);  movsx(ecx, memw[ss, ebp - 16]);       /* movsx ecx, word [ebp-0x10] */
            ii(0x1014_edc6, 2);  xor(ebx, ebx);                        /* xor ebx, ebx */
            ii(0x1014_edc8, 3);  mov(edx, memd[ss, ebp - 12]);         /* mov edx, [ebp-0xc] */
            ii(0x1014_edcb, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x1014_edce, 5);  call(0x1014_a8f2, -0x44e1);           /* call 0x1014a8f2 */
        l_0x1014_edd3:
            ii(0x1014_edd3, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_edd6, 3);  mov(al, memb[ds, eax + 80]);          /* mov al, [eax+0x50] */
            ii(0x1014_edd9, 5);  and(eax, 0xff);                       /* and eax, 0xff */
            ii(0x1014_edde, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x1014_ede0, 2);  if(jnz(0x1014_ede9, 7)) goto l_0x1014_ede9;/* jnz 0x1014ede9 */
            ii(0x1014_ede2, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_ede5, 4);  mov(memb[ds, eax + 85], 0);           /* mov byte [eax+0x55], 0x0 */
        l_0x1014_ede9:
            ii(0x1014_ede9, 2);  xor(edx, edx);                        /* xor edx, edx */
            ii(0x1014_edeb, 3);  lea(eax, memd[ss, ebp - 20]);         /* lea eax, [ebp-0x14] */
