...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1008_bbed()
        {
            ...
            ii(0x1008_bc05, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x1008_bc08, 7);  mov(dx, memw[ds, 0x101c_8172]);       /* mov dx, [0x101c8172] */
            ii(0x1008_bc0f, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_bc12, 4);  mov(memw[ds, eax + 4], dx);           /* mov [eax+0x4], dx */
            ii(0x1008_bc16, 5);  mov(eax, memd[ds, 0x101c_8170]);      /* mov eax, [0x101c8170] */
            ii(0x1008_bc1b, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x1008_bc1e, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x1008_bc21, 5);  call(Definitions.sys_new_arr, 0xd_a3ea);/* call 0x10166010 */
            ii(0x1008_bc26, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1008_bc28, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_bc2b, 2);  mov(memd[ds, eax], edx);              /* mov [eax], edx */
            ii(0x1008_bc2d, 7);  mov(memd[ss, ebp - 8], 0);            /* mov dword [ebp-0x8], 0x0 */
            ii(0x1008_bc34, 2);  jmp(0x1008_bc3c, 6); goto l_0x1008_bc3c;/* jmp 0x1008bc3c */
        l_0x1008_bc36:
            ii(0x1008_bc36, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ii(0x1008_bc39, 3);  inc(memd[ss, ebp - 8]);               /* inc dword [ebp-0x8] */
        l_0x1008_bc3c:
            ii(0x1008_bc3c, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
            ...
            ii(0x1008_bc57, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1008_bc5b, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x1008_bc5e, 2);  mov(edx, eax);                        /* mov edx, eax */
            ii(0x1008_bc60, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ...
            ii(0x1008_bc74, 4);  movsx(eax, memw[ss, ebp - 8]);        /* movsx eax, word [ebp-0x8] */
            ii(0x1008_bc78, 3);  shl(eax, 2);                          /* shl eax, 0x2 */
            ii(0x1008_bc7b, 2);  mov(ecx, eax);                        /* mov ecx, eax */
            ii(0x1008_bc7d, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
        ...
        l_0x1008_bc8d:
            ii(0x1008_bc8d, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1008_bc90, 3);  mov(memd[ss, ebp - 12], eax);         /* mov [ebp-0xc], eax */
            ii(0x1008_bc93, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
