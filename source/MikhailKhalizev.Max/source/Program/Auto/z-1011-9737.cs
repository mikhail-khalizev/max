...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1011_9737()
        {
            ...
            ii(0x1011_974c, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1011_974f, 3);  mov(memd[ss, ebp - 12], edx);         /* mov [ebp-0xc], edx */
        ...
        l_0x1011_976e:
            ...
            ii(0x1011_9784, 3);  mov(memd[ss, ebp - 20], eax);         /* mov [ebp-0x14], eax */
            ii(0x1011_9787, 4);  movsx(eax, memw[ss, ebp - 20]);       /* movsx eax, word [ebp-0x14] */
            ...
            ii(0x1011_979d, 3);  mov(memd[ss, ebp - 24], eax);         /* mov [ebp-0x18], eax */
            ii(0x1011_97a0, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x1011_97a3, 4);  mov(ax, memw[ds, eax + 2]);           /* mov ax, [eax+0x2] */
            ii(0x1011_97a7, 4);  cmp(ax, memw[ss, ebp - 20]);          /* cmp ax, [ebp-0x14] */
            ii(0x1011_97ab, 6);  if(jg(0x1011_98a1, 0xf0)) goto l_0x1011_98a1;/* jg 0x101198a1 */
            ii(0x1011_97b1, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x1011_97b4, 3);  movsx(ebx, memw[ds, eax]);            /* movsx ebx, word [eax] */
            ii(0x1011_97b7, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ...
            ii(0x1011_97dc, 3);  mov(edx, memd[ss, ebp - 24]);         /* mov edx, [ebp-0x18] */
            ii(0x1011_97df, 2);  mov(ebx, memd[ds, edx]);              /* mov ebx, [edx] */
            ii(0x1011_97e1, 3);  sar(ebx, 0x10);                       /* sar ebx, 0x10 */
            ii(0x1011_97e4, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ...
            ii(0x1011_9808, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ...
            ii(0x1011_9824, 3);  mov(edx, memd[ss, ebp - 24]);         /* mov edx, [ebp-0x18] */
            ...
            ii(0x1011_9833, 4);  movsx(edx, memw[ss, ebp - 20]);       /* movsx edx, word [ebp-0x14] */
            ...
            ii(0x1011_9842, 4);  movsx(edx, memw[ss, ebp - 12]);       /* movsx edx, word [ebp-0xc] */
            ii(0x1011_9846, 2);  add(edx, eax);                        /* add edx, eax */
            ii(0x1011_9848, 3);  mov(memd[ss, ebp - 12], edx);         /* mov [ebp-0xc], edx */
            ii(0x1011_984b, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x1011_984e, 3);  mov(memd[ss, ebp - 28], eax);         /* mov [ebp-0x1c], eax */
        l_0x1011_9851:
            ii(0x1011_9851, 3);  dec(memd[ss, ebp - 28]);              /* dec dword [ebp-0x1c] */
            ii(0x1011_9854, 5);  cmp(memw[ss, ebp - 28], -1 /* 0xff */);/* cmp word [ebp-0x1c], 0xffff */
            ii(0x1011_9859, 2);  if(jz(0x1011_98a1, 0x46)) goto l_0x1011_98a1;/* jz 0x101198a1 */
            ii(0x1011_985b, 4);  movsx(eax, memw[ss, ebp - 12]);       /* movsx eax, word [ebp-0xc] */
            ii(0x1011_985f, 2);  test(eax, eax);                       /* test eax, eax */
            ii(0x1011_9861, 2);  if(jl(0x1011_987b, 0x18)) goto l_0x1011_987b;/* jl 0x1011987b */
            ii(0x1011_9863, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x1011_9866, 3);  movsx(eax, memw[ds, eax]);            /* movsx eax, word [eax] */
            ii(0x1011_9869, 4);  movsx(edx, memw[ss, ebp - 12]);       /* movsx edx, word [ebp-0xc] */
        ...
        l_0x1011_987d:
            ii(0x1011_987d, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x1011_988a, 4);  movsx(edx, memw[ss, ebp - 12]);       /* movsx edx, word [ebp-0xc] */
            ii(0x1011_988e, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x1011_9891, 5);  call(0x100e_8d1e, -0x3_0b78);         /* call 0x100e8d1e */
        l_0x1011_9896:
            ii(0x1011_9896, 3);  mov(eax, memd[ss, ebp - 24]);         /* mov eax, [ebp-0x18] */
            ii(0x1011_9899, 3);  mov(ax, memw[ds, eax]);               /* mov ax, [eax] */
            ii(0x1011_989c, 3);  add(memd[ss, ebp - 12], eax);         /* add [ebp-0xc], eax */
