...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_1014_002d()
        {
            ...
            ii(0x1014_0042, 3);  mov(memd[ss, ebp - 16], eax);         /* mov [ebp-0x10], eax */
            ii(0x1014_0045, 3);  mov(memd[ss, ebp - 4], edx);          /* mov [ebp-0x4], edx */
            ii(0x1014_0048, 3);  mov(memd[ss, ebp - 8], ebx);          /* mov [ebp-0x8], ebx */
            ii(0x1014_004b, 3);  mov(memd[ss, ebp - 12], ecx);         /* mov [ebp-0xc], ecx */
            ii(0x1014_004e, 5);  mov(eax, 1);                          /* mov eax, 0x1 */
            ii(0x1014_0053, 1);  push(eax);                            /* push eax */
            ii(0x1014_0054, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_0057, 3);  mov(eax, memd[ds, eax + 14]);         /* mov eax, [eax+0xe] */
            ii(0x1014_005a, 3);  sar(eax, 0x10);                       /* sar eax, 0x10 */
            ii(0x1014_005d, 1);  push(eax);                            /* push eax */
            ii(0x1014_005e, 4);  movsx(ecx, memw[ss, ebp + 16]);       /* movsx ecx, word [ebp+0x10] */
            ...
            ii(0x1014_006b, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ii(0x1014_006e, 5);  call(0x1013_f4b0, -0xbc3);            /* call 0x1013f4b0 */
            ii(0x1014_0073, 3);  mov(eax, memd[ss, ebp - 12]);         /* mov eax, [ebp-0xc] */
            ii(0x1014_0076, 3);  mov(eax, memd[ds, eax + 14]);         /* mov eax, [eax+0xe] */
            ...
            ii(0x1014_0080, 3);  mov(eax, memd[ds, eax + 14]);         /* mov eax, [eax+0xe] */
            ...
            ii(0x1014_0092, 3);  mov(eax, memd[ss, ebp + 16]);         /* mov eax, [ebp+0x10] */
            ...
            ii(0x1014_009f, 3);  mov(eax, memd[ss, ebp - 16]);         /* mov eax, [ebp-0x10] */
            ...
            ii(0x1014_00b1, 3);  mov(edx, memd[ss, ebp - 16]);         /* mov edx, [ebp-0x10] */
            ii(0x1014_00b4, 2);  add(edx, eax);                        /* add edx, eax */
            ii(0x1014_00b6, 3);  mov(memd[ss, ebp - 20], edx);         /* mov [ebp-0x14], edx */
            ii(0x1014_00b9, 3);  mov(eax, memd[ss, ebp - 20]);         /* mov eax, [ebp-0x14] */
