...
namespace MikhailKhalizev.Max.Program
{
    public partial class RawProgram
    {
        ...
        public void Method_100a_ab4c()
        {
            ...
            ii(0x100a_ab5e, 6);  sub(esp, 8);                          /* sub esp, 0x8 */
            ii(0x100a_ab64, 3);  mov(memd[ss, ebp - 4], eax);          /* mov [ebp-0x4], eax */
            ii(0x100a_ab67, 3);  mov(eax, memd[ss, ebp - 4]);          /* mov eax, [ebp-0x4] */
            ii(0x100a_ab6a, 5);  call(0x1007_6c30, -0x3_3f3f);         /* call 0x10076c30 */
            ii(0x100a_ab6f, 3);  mov(memd[ss, ebp - 8], eax);          /* mov [ebp-0x8], eax */
            ii(0x100a_ab72, 3);  mov(eax, memd[ss, ebp - 8]);          /* mov eax, [ebp-0x8] */
