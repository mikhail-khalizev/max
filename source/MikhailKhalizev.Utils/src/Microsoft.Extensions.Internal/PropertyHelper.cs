...
namespace MikhailKhalizev.Utils.Microsoft.Extensions.Internal
{
    public class PropertyHelper
    {
        ...
        /// </returns>
        public static PropertyHelper[] GetProperties(object instance) => GetProperties(instance.GetType());
        ...
        /// </returns>
        public static PropertyHelper[] GetProperties(Type type) => GetProperties(type, CreateInstance, PropertiesCache);
        ...
        /// </returns>
        public static PropertyHelper[] GetVisibleProperties(object instance) => GetVisibleProperties(instance.GetType(),
        ...
        private static bool IsInterestingProperty(PropertyInfo property) => property.GetIndexParameters().Length == 0 &&
